-- ARKHER SYSTEM R.0098 :: Remote Event Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0098"
	S.key = "arkher.net.remoteevent.time_sync"
	S.name = "Remote Event Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Remote Event"
	S.aspect = "Time Sync"
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remoteevent.replication" }
	S.tags = { "r", "remoteevent", "netclock", "net" }
	S.description = "Remote Event Time Sync: offset estimation, outlier rejection and jitter buffering for the Remote Event subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.remoteevent.time_sync", tickRate = 40, bufferDelay = 0.080, maxSamples = 18 })
		inst.system = S
		inst.ctx = ctx
