-- ARKHER SYSTEM O.0292 :: UI Sound Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0292"
	S.key = "arkher.audio.uisound.music_sequencer"
	S.name = "UI Sound Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "UI Sound"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.uisound.spatialization" }
	S.tags = { "o", "uisound", "sequencer", "audio" }
	S.description = "UI Sound Music Sequencer: musical time, sections, stems, cues and quantized transitions for the UI Sound subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.uisound.music_sequencer", bpm = 130, beatsPerBar = 4, intensity = 0.42 })
		inst.system = S
		inst.ctx = ctx
