-- ARKHER SYSTEM Z.0396 :: Thermal Aware Simulation Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0396"
	S.key = "arkher.origin.thermalaware.governance_policy"
	S.name = "Thermal Aware Simulation Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.signal_composition" }
	S.tags = { "z", "thermalaware", "policy", "origin" }
	S.description = "Thermal Aware Simulation Governance Policy: ordered rules governing when the technology may act for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.thermalaware.governance_policy", algorithm = "roundrobin", starvationGuard = 24 })
		inst.system = S
		inst.ctx = ctx
