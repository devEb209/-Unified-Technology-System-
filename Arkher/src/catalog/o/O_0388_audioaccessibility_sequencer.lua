-- ARKHER SYSTEM O.0388 :: Accessibility Audio Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0388"
	S.key = "arkher.audio.audioaccessibility.music_sequencer"
	S.name = "Accessibility Audio Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audioaccessibility.spatialization" }
	S.tags = { "o", "audioaccessibility", "sequencer", "audio" }
	S.description = "Accessibility Audio Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Accessibility Audio subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.audioaccessibility.music_sequencer", bpm = 100, beatsPerBar = 4, intensity = 0.55 })
		inst.system = S
		inst.ctx = ctx
