-- ARKHER SYSTEM T.0597 :: Deployment Reasoning Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0597"
	S.key = "arkher.ai.deploymentreasoning.working_memory"
	S.name = "Deployment Reasoning Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.deploymentreasoning.outcome_prediction" }
	S.tags = { "t", "deploymentreasoning", "memory", "ai" }
	S.description = "Deployment Reasoning Working Memory: decaying, consolidating recall of what the agent learned for the Deployment Reasoning subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.deploymentreasoning.working_memory", capacity = 34, decayRate = 0.030, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
