-- ARKHER SYSTEM H.0214 :: Fixed Timestep Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0214"
	S.key = "arkher.physics.fixedstep.constraint_solver"
	S.name = "Fixed Timestep Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.fixedstep.contact_generation" }
	S.tags = { "h", "fixedstep", "constraint", "physics" }
	S.description = "Fixed Timestep Constraint Solver: sequential impulses, friction, joints and warm starting for the Fixed Timestep subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.fixedstep.constraint_solver", iterations = 13, baumgarte = 0.29, warmStart = true })
		inst.system = S
		inst.ctx = ctx
