-- ARKHER SYSTEM H.0487 :: Ball Joint Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0487"
	S.key = "arkher.physics.balljoint.result_cache"
	S.name = "Ball Joint Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Ball Joint"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.balljoint.simulation_policy" }
	S.tags = { "h", "balljoint", "cache", "physics" }
	S.description = "Ball Joint Result Cache: reuse of expensive simulation and query results for the Ball Joint subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.balljoint.result_cache", policy = "ttl", capacity = 468, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
