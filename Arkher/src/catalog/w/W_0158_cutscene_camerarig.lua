-- ARKHER SYSTEM W.0158 :: Cutscene Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0158"
	S.key = "arkher.cine.cutscene.camera_rig"
	S.name = "Cutscene Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Cutscene"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cutscene.sequence_timeline" }
	S.tags = { "w", "cutscene", "camerarig", "cine" }
	S.description = "Cutscene Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Cutscene subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.cutscene.camera_rig", fov = 0.98, focus = 6.0, aperture = 5.4, smoothing = 10.0, distance = 8, height = 4 })
		inst.system = S
		inst.ctx = ctx
