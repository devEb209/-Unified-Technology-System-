-- ARKHER SYSTEM T.0687 :: AI Debug Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0687"
	S.key = "arkher.ai.aidebug.intent_understanding"
	S.name = "AI Debug Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "aidebug", "intent", "ai" }
	S.description = "AI Debug Intent Understanding: natural language turned into an actionable, scored intent for the AI Debug subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.aidebug.intent_understanding", minConfidence = 0.41 })
		inst.system = S
		inst.ctx = ctx
