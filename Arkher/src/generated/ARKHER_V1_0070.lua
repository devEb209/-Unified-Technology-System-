...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Cascadeur — CORE Stack #0070", size=Vector2.new(640, 420), pos=UDim2.fromOffset(210, 230), parent=parent, icon="✦"})
