-- ARKHER SYSTEM Z.0928 :: Universal Interop Layer Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0928"
	S.key = "arkher.origin.interop.semantic_graph"
	S.name = "Universal Interop Layer Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.interop.world_architect" }
	S.tags = { "z", "interop", "knowledge", "origin" }
	S.description = "Universal Interop Layer Semantic Graph: typed entities and inferred relations of the technology itself for the Universal Interop Layer subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.interop.semantic_graph", dims = 40 })
		inst.system = S
		inst.ctx = ctx
