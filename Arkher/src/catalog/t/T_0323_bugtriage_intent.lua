-- ARKHER SYSTEM T.0323 :: Bug Triage Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0323"
	S.key = "arkher.ai.bugtriage.intent_understanding"
	S.name = "Bug Triage Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "bugtriage", "intent", "ai" }
	S.description = "Bug Triage Intent Understanding: natural language turned into an actionable, scored intent for the Bug Triage subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.bugtriage.intent_understanding", minConfidence = 0.43 })
		inst.system = S
		inst.ctx = ctx
