-- ARKHER SYSTEM VB.0594 :: Horizon Span Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0594"
	S.key = "arkher.conttime.horizonspan.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.horizonspan.persistent_state" }
	S.tags = { "vb", "horizonspan", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.horizonspan.coherence_guard", window = 130, threshold = 0.10 })
		inst.system = S
		inst.ctx = ctx
