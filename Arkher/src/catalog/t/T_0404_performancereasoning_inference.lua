-- ARKHER SYSTEM T.0404 :: Performance Reasoning Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0404"
	S.key = "arkher.ai.performancereasoning.model_inference"
	S.name = "Performance Reasoning Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.performancereasoning.action_planner" }
	S.tags = { "t", "performancereasoning", "inference", "ai" }
	S.description = "Performance Reasoning Model Inference: quantized inference with batching and budget for the Performance Reasoning subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.performancereasoning.model_inference", seed = 88848 })
		inst.system = S
		inst.ctx = ctx
