-- ARKHER SYSTEM W.0186 :: Dialogue Scene Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0186"
	S.key = "arkher.cine.dialoguescene.playback_orchestrator"
	S.name = "Dialogue Scene Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dialoguescene.cut_policy" }
	S.tags = { "w", "dialoguescene", "orchestrator", "cine" }
	S.description = "Dialogue Scene Playback Orchestrator: the state machine that drives a cinematic from start to end for the Dialogue Scene subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.dialoguescene.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
