-- ARKHER SYSTEM VD.0066 :: Sparse Page Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0066"
	S.key = "arkher.contsim.sparsepage.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.sparsepage.persistent_state" }
	S.tags = { "vd", "sparsepage", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.sparsepage.coherence_guard", window = 67, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
