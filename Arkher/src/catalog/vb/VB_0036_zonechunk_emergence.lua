-- ARKHER SYSTEM VB.0036 :: Zone Chunk Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0036"
	S.key = "arkher.conttime.zonechunk.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.zonechunk.reality_continuum" }
	S.tags = { "vb", "zonechunk", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.zonechunk.emergence_continuum", windowSize = 7, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
