-- ARKHER SYSTEM L.0204 :: Predation State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0204"
	S.key = "arkher.sim.predation.state_codec"
	S.name = "Predation State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.predation.history_ledger" }
	S.tags = { "l", "predation", "codec", "sim" }
	S.description = "Predation State Codec: persistence, diffing and checksum of the world state for the Predation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.predation.state_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
