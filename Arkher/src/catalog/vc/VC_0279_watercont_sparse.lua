-- ARKHER SYSTEM VC.0279 :: Water Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0279"
	S.key = "arkher.contneural.watercont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.watercont.epoch_clock" }
	S.tags = { "vc", "watercont", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.watercont.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
