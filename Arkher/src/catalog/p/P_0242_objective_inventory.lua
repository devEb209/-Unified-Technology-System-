-- ARKHER SYSTEM P.0242 :: Objective Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0242"
	S.key = "arkher.play.objective.inventory"
	S.name = "Objective Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Objective"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.objective.attributes" }
	S.tags = { "p", "objective", "inventory", "play" }
	S.description = "Objective Inventory: slots, stacking, weight, equipment and crafting for the Objective subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.objective.inventory", slots = 16, maxWeight = 50 })
		inst.system = S
		inst.ctx = ctx
