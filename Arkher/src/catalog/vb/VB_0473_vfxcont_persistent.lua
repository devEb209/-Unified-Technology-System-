-- ARKHER SYSTEM VB.0473 :: VFX Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0473"
	S.key = "arkher.conttime.vfxcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vfxcont.multi-scale_fidelity" }
	S.tags = { "vb", "vfxcont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.vfxcont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
