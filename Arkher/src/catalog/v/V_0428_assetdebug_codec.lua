-- ARKHER SYSTEM V.0428 :: Asset Debug Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0428"
	S.key = "arkher.asset.assetdebug.compression_codec"
	S.name = "Asset Debug Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetdebug.streaming_residency" }
	S.tags = { "v", "assetdebug", "codec", "asset" }
	S.description = "Asset Debug Compression Codec: compact encoding, diffing and checksum of asset payloads for the Asset Debug subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.assetdebug.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
