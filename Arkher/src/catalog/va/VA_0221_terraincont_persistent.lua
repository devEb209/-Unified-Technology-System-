-- ARKHER SYSTEM VA.0221 :: Terrain Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0221"
	S.key = "arkher.contworld.terraincont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.terraincont.multi-scale_fidelity" }
	S.tags = { "va", "terraincont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.terraincont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
