-- ARKHER SYSTEM VD.0167 :: Coherence Seam Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0167"
	S.key = "arkher.contsim.coherenceseam.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.coherenceseam.simulation_fabric" }
	S.tags = { "vd", "coherenceseam", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.coherenceseam.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
