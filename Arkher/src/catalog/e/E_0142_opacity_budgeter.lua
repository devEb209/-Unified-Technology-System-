-- ARKHER SYSTEM E.0142 :: Opacity Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0142"
	S.key = "arkher.material.opacity.parameter_budget"
	S.name = "Opacity Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Opacity"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.opacity.variant_registry" }
	S.tags = { "e", "opacity", "budgeter", "material" }
	S.description = "Opacity Parameter Budget: texel and layer budget allocation for the Opacity subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.opacity.parameter_budget", total = 327, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
