-- ARKHER SYSTEM K.0293 :: Scent Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0293"
	S.key = "arkher.npc.scent.thinking_budget"
	S.name = "Scent Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.scent.daily_schedule" }
	S.tags = { "k", "scent", "budgeter", "npc" }
	S.description = "Scent Thinking Budget: allocation of per-frame thinking time across NPCs for the Scent subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.scent.thinking_budget", total = 258, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
