-- ARKHER SYSTEM V.0246 :: Localization Asset Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0246"
	S.key = "arkher.asset.localizationasset.content_cache"
	S.name = "Localization Asset Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.localizationasset.dependency_graph" }
	S.tags = { "v", "localizationasset", "cache", "asset" }
	S.description = "Localization Asset Content Cache: reuse of already cooked results for the Localization Asset subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.localizationasset.content_cache", policy = "lfu", capacity = 491, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
