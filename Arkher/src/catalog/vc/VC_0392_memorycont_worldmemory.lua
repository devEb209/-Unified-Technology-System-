-- ARKHER SYSTEM VC.0392 :: Memory Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0392"
	S.key = "arkher.contneural.memorycont.world_memory_stream"
	S.name = "Memory Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memorycont.neural_field" }
	S.tags = { "vc", "memorycont", "worldmemory", "contneural" }
	S.description = "Memory Continuum World Memory Stream: world memory continuum over epochs for the Memory Continuum subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.memorycont.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
