-- ARKHER SYSTEM F.0276 :: Tonemapping Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0276"
	S.key = "arkher.render.tonemap.render_policy"
	S.name = "Tonemapping Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Tonemapping"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.tonemap.draw_budget" }
	S.tags = { "f", "tonemap", "policy", "render" }
	S.description = "Tonemapping Render Policy: device tier rules for the frame for the Tonemapping subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.tonemap.render_policy", algorithm = "lottery", starvationGuard = 19 })
		inst.system = S
		inst.ctx = ctx
