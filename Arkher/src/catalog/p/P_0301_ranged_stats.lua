-- ARKHER SYSTEM P.0301 :: Ranged Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0301"
	S.key = "arkher.play.ranged.attributes"
	S.name = "Ranged Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ranged"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "ranged", "stats", "play" }
	S.description = "Ranged Attributes: base values, layered modifiers and derived statistics for the Ranged subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.ranged.attributes" })
		inst.system = S
		inst.ctx = ctx
