-- ARKHER SYSTEM E.0032 :: Albedo Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0032"
	S.key = "arkher.material.albedo.layer_composition"
	S.name = "Albedo Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Albedo"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.albedo.definition" }
	S.tags = { "e", "albedo", "composer", "material" }
	S.description = "Albedo Layer Composition: ordered layer composition with blend rules for the Albedo subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.albedo.layer_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
