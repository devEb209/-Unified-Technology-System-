-- ARKHER SYSTEM VC.0145 :: Persistence Segment Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0145"
	S.key = "arkher.contneural.persistsegment.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "persistsegment", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.persistsegment.infinite_grid", cellSize = 64, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
