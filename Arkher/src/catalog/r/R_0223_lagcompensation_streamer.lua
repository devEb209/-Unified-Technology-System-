-- ARKHER SYSTEM R.0223 :: Lag Compensation Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0223"
	S.key = "arkher.net.lagcompensation.interest_streaming"
	S.name = "Lag Compensation Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.lagcompensation.serialization_codec" }
	S.tags = { "r", "lagcompensation", "streamer", "net" }
	S.description = "Lag Compensation Interest Streaming: distance-driven residency of replicated content for the Lag Compensation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.lagcompensation.interest_streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
