-- ARKHER SYSTEM R.0308 :: Cross Server Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0308"
	S.key = "arkher.net.crossserver.rate_guard"
	S.name = "Cross Server Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Cross Server"
	S.aspect = "Rate Guard"
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.crossserver.interest_streaming" }
	S.tags = { "r", "crossserver", "guard", "net" }
	S.description = "Cross Server Rate Guard: token-bucket protection against floods and abuse for the Cross Server subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.crossserver.rate_guard", algorithm = "leaky", capacity = 143, refillPerSec = 28, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
