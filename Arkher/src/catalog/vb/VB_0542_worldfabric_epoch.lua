-- ARKHER SYSTEM VB.0542 :: World Fabric Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0542"
	S.key = "arkher.conttime.worldfabric.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldfabric.infinite_grid" }
	S.tags = { "vb", "worldfabric", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.worldfabric.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
