-- ARKHER SYSTEM VB.0159 :: Coherence Seam Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0159"
	S.key = "arkher.conttime.coherenceseam.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.coherenceseam.epoch_clock" }
	S.tags = { "vb", "coherenceseam", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.coherenceseam.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
