-- ARKHER SYSTEM VD.0544 :: World Fabric Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0544"
	S.key = "arkher.contsim.worldfabric.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldfabric.sparse_residency" }
	S.tags = { "vd", "worldfabric", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.worldfabric.multi-scale_fidelity", levels = 4, baseTriangles = 90000 })
		inst.system = S
		inst.ctx = ctx
