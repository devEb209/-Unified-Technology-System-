-- ARKHER SYSTEM R.0006 :: Session Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0006"
	S.key = "arkher.net.session.serialization_codec"
	S.name = "Session Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Session"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.session.bandwidth_budget" }
	S.tags = { "r", "session", "codec", "net" }
	S.description = "Session Serialization Codec: compact encoding, diffing and checksum of payloads for the Session subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.session.serialization_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
