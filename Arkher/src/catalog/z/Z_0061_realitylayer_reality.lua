-- ARKHER SYSTEM Z.0061 :: Reality Layer Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0061"
	S.key = "arkher.origin.realitylayer.reality_layering"
	S.name = "Reality Layer Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "realitylayer", "reality", "origin" }
	S.description = "Reality Layer Reality Layering: stacked authored, simulated, proposed and player realities for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.realitylayer.reality_layering" })
		inst.system = S
		inst.ctx = ctx
