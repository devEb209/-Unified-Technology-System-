-- ARKHER SYSTEM K.0433 :: Pathfinding Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0433"
	S.key = "arkher.npc.pathfinding.thinking_budget"
	S.name = "Pathfinding Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.pathfinding.daily_schedule" }
	S.tags = { "k", "pathfinding", "budgeter", "npc" }
	S.description = "Pathfinding Thinking Budget: allocation of per-frame thinking time across NPCs for the Pathfinding subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.pathfinding.thinking_budget", total = 75, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
