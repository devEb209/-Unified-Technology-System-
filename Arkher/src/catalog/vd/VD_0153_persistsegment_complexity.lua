-- ARKHER SYSTEM VD.0153 :: Persistence Segment Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0153"
	S.key = "arkher.contsim.persistsegment.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.persistsegment.world_memory_stream" }
	S.tags = { "vd", "persistsegment", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.persistsegment.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
