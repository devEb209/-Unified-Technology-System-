-- ARKHER SYSTEM J.0194 :: Armor Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0194"
	S.key = "arkher.character.armor.appearance_composer"
	S.name = "Armor Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.armor.locomotion" }
	S.tags = { "j", "armor", "composer", "character" }
	S.description = "Armor Appearance Composer: composition of appearance slots into a look for the Armor subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.armor.appearance_composer", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
	...
	function inst.dominantLayer()
		...
		function inst.integrate(engine)
			...
			inst.engine = engine
			if engine.bus then
				engine.bus:subscribe("arkher.character.armor.*", function(payload) inst.lastSignal = payload end)
			end
