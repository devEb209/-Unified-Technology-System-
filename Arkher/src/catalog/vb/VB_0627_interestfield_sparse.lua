-- ARKHER SYSTEM VB.0627 :: Interest Field Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0627"
	S.key = "arkher.conttime.interestfield.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.interestfield.epoch_clock" }
	S.tags = { "vb", "interestfield", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.interestfield.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
