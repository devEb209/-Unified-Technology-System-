-- ARKHER SYSTEM VB.0548 :: World Fabric World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0548"
	S.key = "arkher.conttime.worldfabric.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldfabric.neural_field" }
	S.tags = { "vb", "worldfabric", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.worldfabric.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
