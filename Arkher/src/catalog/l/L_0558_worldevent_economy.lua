-- ARKHER SYSTEM L.0558 :: World Event Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0558"
	S.key = "arkher.sim.worldevent.economy"
	S.name = "World Event Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldevent.ecology" }
	S.tags = { "l", "worldevent", "economy", "sim" }
	S.description = "World Event Economy: stock, production, demand, price discovery and trade for the World Event subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.worldevent.economy", elasticity = 0.21 })
		inst.system = S
		inst.ctx = ctx
