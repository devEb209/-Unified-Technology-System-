-- ARKHER SYSTEM Z.0605 :: Predictive Streaming World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0605"
	S.key = "arkher.origin.predictivestreaming.world_memory"
	S.name = "Predictive Streaming World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictivestreaming.autonomous_pipeline" }
	S.tags = { "z", "predictivestreaming", "worldmemory", "origin" }
	S.description = "Predictive Streaming World Memory: epoch-stamped persistent history with compaction and checkpoints for the Predictive Streaming subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.predictivestreaming.world_memory", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
