-- ARKHER SYSTEM L.0229 :: Weather Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0229"
	S.key = "arkher.sim.weather.society"
	S.name = "Weather Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.weather.economy" }
	S.tags = { "l", "weather", "society", "sim" }
	S.description = "Weather Society: relations, factions, reputation and cohesion of the region for the Weather subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.weather.society", decayRate = 0.009, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
