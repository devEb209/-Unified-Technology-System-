-- ARKHER SYSTEM G.0325 :: Model Distillation Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0325"
	S.key = "arkher.neural.distillation.temporal_history"
	S.name = "Model Distillation Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.distillation.feature_extraction" }
	S.tags = { "g", "distillation", "temporal", "neural" }
	S.description = "Model Distillation Temporal History: history buffers reused across frames for the Model Distillation subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.distillation.temporal_history", feedback = 0.81, phase = 8 })
		inst.system = S
		inst.ctx = ctx
