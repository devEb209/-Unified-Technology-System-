-- ARKHER SYSTEM K.0540 :: Dialogue Behaviour Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0540"
	S.key = "arkher.npc.dialoguebehaviour.goal_planner"
	S.name = "Dialogue Behaviour Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dialoguebehaviour.utility_reasoning" }
	S.tags = { "k", "dialoguebehaviour", "planner", "npc" }
	S.description = "Dialogue Behaviour Goal Planner: backward GOAP planning to reach a goal state for the Dialogue Behaviour subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.dialoguebehaviour.goal_planner", maxDepth = 11 })
		inst.system = S
		inst.ctx = ctx
