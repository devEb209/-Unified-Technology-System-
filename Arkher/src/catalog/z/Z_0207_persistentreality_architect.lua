-- ARKHER SYSTEM Z.0207 :: Persistent Reality State World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0207"
	S.key = "arkher.origin.persistentreality.world_architect"
	S.name = "Persistent Reality State World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.emergence_detection" }
	S.tags = { "z", "persistentreality", "architect", "origin" }
	S.description = "Persistent Reality State World Architect: hierarchical world composition with conserved budgets for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.persistentreality.world_architect", budget = 1300, seed = 99097 })
		inst.system = S
		inst.ctx = ctx
