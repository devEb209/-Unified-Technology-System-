-- ARKHER SYSTEM J.0027 :: Body Proportions Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0027"
	S.key = "arkher.character.proportions.physical_response"
	S.name = "Body Proportions Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.proportions.look_and_reach" }
	S.tags = { "j", "proportions", "ragdoll", "character" }
	S.description = "Body Proportions Physical Response: physical reaction, ragdoll and recovery for the Body Proportions subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.proportions.physical_response", blendSpeed = 5.50 })
		inst.system = S
		inst.ctx = ctx
