-- ARKHER SYSTEM F.0429 :: Occlusion Culling Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0429"
	S.key = "arkher.render.occlusion.draw_budget"
	S.name = "Occlusion Culling Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.occlusion.adaptive_resolution" }
	S.tags = { "f", "occlusion", "budgeter", "render" }
	S.description = "Occlusion Culling Draw Budget: draw call and triangle budget allocation for the Occlusion Culling subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.occlusion.draw_budget", total = 417, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
