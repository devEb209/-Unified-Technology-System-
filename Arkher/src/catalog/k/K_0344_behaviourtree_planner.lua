-- ARKHER SYSTEM K.0344 :: Behaviour Tree Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0344"
	S.key = "arkher.npc.behaviourtree.goal_planner"
	S.name = "Behaviour Tree Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourtree.utility_reasoning" }
	S.tags = { "k", "behaviourtree", "planner", "npc" }
	S.description = "Behaviour Tree Goal Planner: backward GOAP planning to reach a goal state for the Behaviour Tree subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.behaviourtree.goal_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
