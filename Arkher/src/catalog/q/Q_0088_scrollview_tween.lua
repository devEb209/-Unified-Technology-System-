-- ARKHER SYSTEM Q.0088 :: Scroll View Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0088"
	S.key = "arkher.ui.scrollview.transition"
	S.name = "Scroll View Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Scroll View"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.scrollview.input_mapping" }
	S.tags = { "q", "scrollview", "tween", "ui" }
	S.description = "Scroll View Transition: eased, delayed, looped and sequenced motion for the Scroll View subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.scrollview.transition", timeScale = 0.98 })
		inst.system = S
		inst.ctx = ctx
