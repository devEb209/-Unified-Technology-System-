-- ARKHER SYSTEM H.0301 :: Capsule Collider Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0301"
	S.key = "arkher.physics.capsulecollider.vehicle"
	S.name = "Capsule Collider Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.capsulecollider.character_motion" }
	S.tags = { "h", "capsulecollider", "vehicle", "physics" }
	S.description = "Capsule Collider Vehicle: suspension, drivetrain, steering and tire friction for the Capsule Collider subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.capsulecollider.vehicle", mass = 2100, wheelbase = 2.40, track = 1.60, maxRpm = 5800 })
		inst.system = S
		inst.ctx = ctx
