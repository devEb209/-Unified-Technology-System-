-- ARKHER SYSTEM T.0237 :: Quest Generation Learning Analysis
...
return function(A)
	...
	local S = {}
	S.id = "T.0237"
	S.key = "arkher.ai.questgeneration.learning_analysis"
	S.name = "Quest Generation Learning Analysis"
	S.category = "T"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.questgeneration.model_inference" }
	S.tags = { "t", "questgeneration", "analyzer", "ai" }
	S.description = "Quest Generation Learning Analysis: trend, anomaly and improvement analysis of the agent for the Quest Generation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ai.questgeneration.learning_analysis", window = 207, buckets = 19, threshold = 4.90 })
		inst.system = S
		inst.ctx = ctx
