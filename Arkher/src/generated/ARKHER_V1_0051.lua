--!strict
-- Terragen Sky — ANIMATION Node_Flow #0051
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Terragen Sky — ANIMATION Node_Flow #0051", size=Vector2.new(600, 440), pos=UDim2.fromOffset(363, 167), parent=parent, icon="☀"})
