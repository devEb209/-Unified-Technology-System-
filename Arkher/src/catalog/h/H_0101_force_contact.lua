-- ARKHER SYSTEM H.0101 :: Force Accumulator Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0101"
	S.key = "arkher.physics.force.contact_generation"
	S.name = "Force Accumulator Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.force.collision_shape" }
	S.tags = { "h", "force", "contact", "physics" }
	S.description = "Force Accumulator Contact Generation: narrow-phase manifolds with normal, depth and point for the Force Accumulator subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.force.contact_generation", slop = 0.0090, maxManifolds = 151 })
		inst.system = S
		inst.ctx = ctx
