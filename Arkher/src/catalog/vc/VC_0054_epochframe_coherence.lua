-- ARKHER SYSTEM VC.0054 :: Epoch Frame Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0054"
	S.key = "arkher.contneural.epochframe.coherence_guard"
	S.name = "Epoch Frame Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.epochframe.persistent_state" }
	S.tags = { "vc", "epochframe", "coherence", "contneural" }
	S.description = "Epoch Frame Coherence Guard: seam coherence and drift supervision for the Epoch Frame subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.epochframe.coherence_guard", window = 91, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
