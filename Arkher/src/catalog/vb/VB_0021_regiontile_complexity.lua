-- ARKHER SYSTEM VB.0021 :: Region Tile Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0021"
	S.key = "arkher.conttime.regiontile.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.regiontile.world_memory_stream" }
	S.tags = { "vb", "regiontile", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.regiontile.complexity_budget", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
