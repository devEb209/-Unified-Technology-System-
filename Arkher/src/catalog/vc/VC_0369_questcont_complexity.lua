-- ARKHER SYSTEM VC.0369 :: Quest Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0369"
	S.key = "arkher.contneural.questcont.complexity_budget"
	S.name = "Quest Continuum Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.questcont.world_memory_stream" }
	S.tags = { "vc", "questcont", "complexity", "contneural" }
	S.description = "Quest Continuum Complexity Budget: complexity budgeting for the continuum for the Quest Continuum subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.questcont.complexity_budget", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
