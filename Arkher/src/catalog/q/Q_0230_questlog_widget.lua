-- ARKHER SYSTEM Q.0230 :: Quest Log Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0230"
	S.key = "arkher.ui.questlog.widget_tree"
	S.name = "Quest Log Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Quest Log"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.questlog.responsive_layout" }
	S.tags = { "q", "questlog", "widget", "ui" }
	S.description = "Quest Log Widget Tree: retained widget nodes, properties, bindings and rendering for the Quest Log subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.questlog.widget_tree", theme = "light", scale = 1.10 })
		inst.system = S
		inst.ctx = ctx
