-- ARKHER SYSTEM I.0361 :: Hit Reaction Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0361"
	S.key = "arkher.anim.hitreaction.pose_cache"
	S.name = "Hit Reaction Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Hit Reaction"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.hitreaction.playback_pipeline" }
	S.tags = { "i", "hitreaction", "cache", "anim" }
	S.description = "Hit Reaction Pose Cache: reuse of sampled poses across frames and instances for the Hit Reaction subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.hitreaction.pose_cache", policy = "lru", capacity = 223, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
