-- ARKHER SYSTEM L.0364 :: Trade Route Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0364"
	S.key = "arkher.sim.traderoute.society"
	S.name = "Trade Route Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.traderoute.economy" }
	S.tags = { "l", "traderoute", "society", "sim" }
	S.description = "Trade Route Society: relations, factions, reputation and cohesion of the region for the Trade Route subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.traderoute.society", decayRate = 0.008, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
