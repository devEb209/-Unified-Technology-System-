-- ARKHER SYSTEM H.0366 :: Collision Layer Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0366"
	S.key = "arkher.physics.collisionlayer.collision_shape"
	S.name = "Collision Layer Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionlayer.body_dynamics" }
	S.tags = { "h", "collisionlayer", "collider", "physics" }
	S.description = "Collision Layer Collision Shape: shape bounds, support mapping and closest points for the Collision Layer subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.collisionlayer.collision_shape", shape = "box", radius = 0.80, height = 1.60, layer = "default" })
		inst.system = S
		inst.ctx = ctx
