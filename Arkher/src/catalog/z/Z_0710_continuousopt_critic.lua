-- ARKHER SYSTEM Z.0710 :: Continuous Self Optimization Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0710"
	S.key = "arkher.origin.continuousopt.self_critique"
	S.name = "Continuous Self Optimization Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.intent_bridge" }
	S.tags = { "z", "continuousopt", "critic", "origin" }
	S.description = "Continuous Self Optimization Self Critique: weighted judgement of the technology's own output for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.continuousopt.self_critique", passMark = 0.76, reviseMark = 0.46, seed = 78006 })
		inst.system = S
		inst.ctx = ctx
