-- ARKHER SYSTEM L.0024 :: Region Fidelity State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0024"
	S.key = "arkher.sim.regionfidelity.state_codec"
	S.name = "Region Fidelity State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.regionfidelity.history_ledger" }
	S.tags = { "l", "regionfidelity", "codec", "sim" }
	S.description = "Region Fidelity State Codec: persistence, diffing and checksum of the world state for the Region Fidelity subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.regionfidelity.state_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
