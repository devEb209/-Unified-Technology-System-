-- ARKHER SYSTEM L.0272 :: Day Night Cycle Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0272"
	S.key = "arkher.sim.daynight.ecology"
	S.name = "Day Night Cycle Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.daynight.simulation_core" }
	S.tags = { "l", "daynight", "ecology", "sim" }
	S.description = "Day Night Cycle Ecology: populations, predation, harvesting and carrying capacity for the Day Night Cycle subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.daynight.ecology" })
		inst.system = S
		inst.ctx = ctx
