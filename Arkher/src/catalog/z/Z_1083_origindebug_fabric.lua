-- ARKHER SYSTEM Z.1083 :: Original Tech Debug Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.1083"
	S.key = "arkher.origin.origindebug.simulation_fabric"
	S.name = "Original Tech Debug Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.origindebug.complexity_governance" }
	S.tags = { "z", "origindebug", "fabric", "origin" }
	S.description = "Original Tech Debug Simulation Fabric: every simulation domain stepped under one budgeted clock for the Original Tech Debug subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.origindebug.simulation_fabric", budgetMs = 1.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
