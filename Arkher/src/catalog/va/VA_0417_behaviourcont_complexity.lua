-- ARKHER SYSTEM VA.0417 :: Behaviour Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0417"
	S.key = "arkher.contworld.behaviourcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.behaviourcont.world_memory_stream" }
	S.tags = { "va", "behaviourcont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.behaviourcont.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
