-- ARKHER SYSTEM H.0384 :: Collision Filter Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0384"
	S.key = "arkher.physics.collisionfilter.character_motion"
	S.name = "Collision Filter Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionfilter.query" }
	S.tags = { "h", "collisionfilter", "charmotor", "physics" }
	S.description = "Collision Filter Character Motion: capsule move-and-slide with slopes, steps and jumps for the Collision Filter subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.collisionfilter.character_motion", radius = 0.39, height = 1.64, maxSpeed = 4.40, jumpHeight = 1.60, stepOffset = 0.29 })
		inst.system = S
		inst.ctx = ctx
