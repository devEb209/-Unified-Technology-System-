-- ARKHER SYSTEM F.0570 :: UI Rendering Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0570"
	S.key = "arkher.render.uirender.render_policy"
	S.name = "UI Rendering Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "UI Rendering"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.uirender.draw_budget" }
	S.tags = { "f", "uirender", "policy", "render" }
	S.description = "UI Rendering Render Policy: device tier rules for the frame for the UI Rendering subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.uirender.render_policy", algorithm = "roundrobin", starvationGuard = 48 })
		inst.system = S
		inst.ctx = ctx
