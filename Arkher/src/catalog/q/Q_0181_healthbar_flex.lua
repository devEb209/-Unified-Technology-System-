-- ARKHER SYSTEM Q.0181 :: Health Bar Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0181"
	S.key = "arkher.ui.healthbar.responsive_layout"
	S.name = "Health Bar Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Health Bar"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "healthbar", "flex", "ui" }
	S.description = "Health Bar Responsive Layout: flex solving with safe areas, weights and breakpoints for the Health Bar subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.healthbar.responsive_layout", width = 510, height = 964, scale = 1.12 })
		inst.system = S
		inst.ctx = ctx
