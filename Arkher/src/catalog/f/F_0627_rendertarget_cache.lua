-- ARKHER SYSTEM F.0627 :: Render Target Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0627"
	S.key = "arkher.render.rendertarget.pass_cache"
	S.name = "Render Target Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.rendertarget.render_policy" }
	S.tags = { "f", "rendertarget", "cache", "render" }
	S.description = "Render Target Pass Cache: reuse of pass results across frames for the Render Target subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.rendertarget.pass_cache", policy = "lfu", capacity = 270, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
