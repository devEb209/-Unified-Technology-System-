-- ARKHER SYSTEM VB.0282 :: Water Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0282"
	S.key = "arkher.conttime.watercont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.watercont.persistent_state" }
	S.tags = { "vb", "watercont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.watercont.coherence_guard", window = 60, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
