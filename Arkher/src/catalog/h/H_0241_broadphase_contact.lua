-- ARKHER SYSTEM H.0241 :: Broadphase Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0241"
	S.key = "arkher.physics.broadphase.contact_generation"
	S.name = "Broadphase Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Broadphase"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.broadphase.collision_shape" }
	S.tags = { "h", "broadphase", "contact", "physics" }
	S.description = "Broadphase Contact Generation: narrow-phase manifolds with normal, depth and point for the Broadphase subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.broadphase.contact_generation", slop = 0.0090, maxManifolds = 419 })
		inst.system = S
		inst.ctx = ctx
