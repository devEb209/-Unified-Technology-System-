-- ARKHER SYSTEM L.0421 :: Law Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0421"
	S.key = "arkher.sim.law.simulation_core"
	S.name = "Law Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "law", "simulation", "sim" }
	S.description = "Law Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Law subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.law.simulation_core", fullRadius = 320, reducedRadius = 1300, budget = 55 })
		inst.system = S
		inst.ctx = ctx
