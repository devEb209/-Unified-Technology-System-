-- ARKHER SYSTEM F.0460 :: Frustum Culling Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0460"
	S.key = "arkher.render.frustum.frame_analysis"
	S.name = "Frustum Culling Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.frustum.pass_cache" }
	S.tags = { "f", "frustum", "analyzer", "render" }
	S.description = "Frustum Culling Frame Analysis: per-pass cost analysis and outlier detection for the Frustum Culling subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.frustum.frame_analysis", window = 115, buckets = 19, threshold = 3.70 })
		inst.system = S
		inst.ctx = ctx
