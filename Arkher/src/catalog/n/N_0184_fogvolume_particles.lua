-- ARKHER SYSTEM N.0184 :: Fog Volume Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0184"
	S.key = "arkher.vfx.fogvolume.particle_simulation"
	S.name = "Fog Volume Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fog Volume"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fogvolume.emission" }
	S.tags = { "n", "fogvolume", "particles", "vfx" }
	S.description = "Fog Volume Particle Simulation: pooled integration of position, velocity, colour and life for the Fog Volume subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.fogvolume.particle_simulation", capacity = 256, drag = 0.15, bounce = 0.20, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
