-- ARKHER SYSTEM V.0080 :: Animation Clip Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0080"
	S.key = "arkher.asset.animationclip.compression_codec"
	S.name = "Animation Clip Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.animationclip.streaming_residency" }
	S.tags = { "v", "animationclip", "codec", "asset" }
	S.description = "Animation Clip Compression Codec: compact encoding, diffing and checksum of asset payloads for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.animationclip.compression_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
