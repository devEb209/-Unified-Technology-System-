-- ARKHER SYSTEM VD.0533 :: Pipeline Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0533"
	S.key = "arkher.contsim.pipelinecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.pipelinecont.multi-scale_fidelity" }
	S.tags = { "vd", "pipelinecont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.pipelinecont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
