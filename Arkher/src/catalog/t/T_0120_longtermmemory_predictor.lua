-- ARKHER SYSTEM T.0120 :: Long Term Memory Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0120"
	S.key = "arkher.ai.longtermmemory.outcome_prediction"
	S.name = "Long Term Memory Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.longtermmemory.decision_policy" }
	S.tags = { "t", "longtermmemory", "predictor", "ai" }
	S.description = "Long Term Memory Outcome Prediction: forecasting the result before the work is done for the Long Term Memory subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.longtermmemory.outcome_prediction", method = "ema", alpha = 0.28, window = 74 })
		inst.system = S
		inst.ctx = ctx
