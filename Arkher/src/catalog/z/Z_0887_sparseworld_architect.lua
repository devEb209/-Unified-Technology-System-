-- ARKHER SYSTEM Z.0887 :: Sparse World Representation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0887"
	S.key = "arkher.origin.sparseworld.world_architect"
	S.name = "Sparse World Representation World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.emergence_detection" }
	S.tags = { "z", "sparseworld", "architect", "origin" }
	S.description = "Sparse World Representation World Architect: hierarchical world composition with conserved budgets for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.sparseworld.world_architect", budget = 600, seed = 3900 })
		inst.system = S
		inst.ctx = ctx
