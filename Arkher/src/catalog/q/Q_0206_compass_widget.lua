-- ARKHER SYSTEM Q.0206 :: Compass Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0206"
	S.key = "arkher.ui.compass.widget_tree"
	S.name = "Compass Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Compass"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.compass.responsive_layout" }
	S.tags = { "q", "compass", "widget", "ui" }
	S.description = "Compass Widget Tree: retained widget nodes, properties, bindings and rendering for the Compass subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.compass.widget_tree", theme = "dark", scale = 1.22 })
		inst.system = S
		inst.ctx = ctx
