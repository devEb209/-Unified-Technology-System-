-- ARKHER SYSTEM R.0353 :: Network Debug Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0353"
	S.key = "arkher.net.networkdebug.bandwidth_budget"
	S.name = "Network Debug Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.networkdebug.transport_graph" }
	S.tags = { "r", "networkdebug", "budgeter", "net" }
	S.description = "Network Debug Bandwidth Budget: bytes per second shared between competing streams for the Network Debug subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.networkdebug.bandwidth_budget", total = 188, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
