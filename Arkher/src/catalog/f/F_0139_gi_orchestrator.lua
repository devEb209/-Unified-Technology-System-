-- ARKHER SYSTEM F.0139 :: Global Illumination Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0139"
	S.key = "arkher.render.gi.orchestration"
	S.name = "Global Illumination Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.gi.frame_analysis" }
	S.tags = { "f", "gi", "orchestrator", "render" }
	S.description = "Global Illumination Orchestration: frame lifecycle orchestration for the Global Illumination subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.gi.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
