...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="OpenLandMap — CORE Stack #0280", size=Vector2.new(640, 420), pos=UDim2.fromOffset(140, 160), parent=parent, icon="◨"})
