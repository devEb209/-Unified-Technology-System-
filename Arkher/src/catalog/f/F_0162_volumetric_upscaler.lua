-- ARKHER SYSTEM F.0162 :: Volumetric Light Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0162"
	S.key = "arkher.render.volumetric.adaptive_resolution"
	S.name = "Volumetric Light Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.volumetric.temporal_resolve" }
	S.tags = { "f", "volumetric", "upscaler", "render" }
	S.description = "Volumetric Light Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Volumetric Light subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.volumetric.adaptive_resolution", targetMs = 12.10, index = 4, sharpness = 0.53 })
		inst.system = S
		inst.ctx = ctx
