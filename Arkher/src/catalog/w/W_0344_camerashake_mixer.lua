-- ARKHER SYSTEM W.0344 :: Camera Shake Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0344"
	S.key = "arkher.cine.camerashake.cinematic_mix"
	S.name = "Camera Shake Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Camera Shake"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.camerashake.motion_tween" }
	S.tags = { "w", "camerashake", "mixer", "cine" }
	S.description = "Camera Shake Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.camerashake.cinematic_mix", maxVoices = 56 })
		inst.system = S
		inst.ctx = ctx
