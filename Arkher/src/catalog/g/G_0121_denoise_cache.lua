-- ARKHER SYSTEM G.0121 :: Denoising Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0121"
	S.key = "arkher.neural.denoise.result_cache"
	S.name = "Denoising Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.denoise.compute_budget" }
	S.tags = { "g", "denoise", "cache", "neural" }
	S.description = "Denoising Result Cache: cached inference results keyed by input for the Denoising subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.denoise.result_cache", policy = "lfu", capacity = 176, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
