-- ARKHER SYSTEM VD.0236 :: City Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0236"
	S.key = "arkher.contsim.citycont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.citycont.neural_field" }
	S.tags = { "vd", "citycont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.citycont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
