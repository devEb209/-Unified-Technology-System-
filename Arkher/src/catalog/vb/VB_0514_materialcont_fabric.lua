-- ARKHER SYSTEM VB.0514 :: Material Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0514"
	S.key = "arkher.conttime.materialcont.simulation_fabric"
	S.name = "Material Continuum Simulation Fabric"
	S.category = "VB"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.materialcont.complexity_budget" }
	S.tags = { "vb", "materialcont", "fabric", "conttime" }
	S.description = "Material Continuum Simulation Fabric: fabric stepping the continuum domains for the Material Continuum subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.materialcont.simulation_fabric", budgetMs = 4.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
