-- ARKHER SYSTEM W.0355 :: Subtitle Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0355"
	S.key = "arkher.cine.subtitle.motion_tween"
	S.name = "Subtitle Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Subtitle"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.subtitle.playback_orchestrator" }
	S.tags = { "w", "subtitle", "tween", "cine" }
	S.description = "Subtitle Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Subtitle subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.subtitle.motion_tween", timeScale = 1.03 })
		inst.system = S
		inst.ctx = ctx
