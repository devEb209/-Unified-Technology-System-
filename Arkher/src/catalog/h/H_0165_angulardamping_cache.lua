-- ARKHER SYSTEM H.0165 :: Angular Damping Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0165"
	S.key = "arkher.physics.angulardamping.result_cache"
	S.name = "Angular Damping Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.angulardamping.simulation_policy" }
	S.tags = { "h", "angulardamping", "cache", "physics" }
	S.description = "Angular Damping Result Cache: reuse of expensive simulation and query results for the Angular Damping subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.angulardamping.result_cache", policy = "lfu", capacity = 225, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
