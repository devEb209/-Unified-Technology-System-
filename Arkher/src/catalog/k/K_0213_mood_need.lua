-- ARKHER SYSTEM K.0213 :: Mood Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0213"
	S.key = "arkher.npc.mood.drive_system"
	S.name = "Mood Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.mood.memory" }
	S.tags = { "k", "mood", "need", "npc" }
	S.description = "Mood Drive System: drives that decay, turn urgent and get satisfied for the Mood subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.mood.drive_system" })
		inst.system = S
		inst.ctx = ctx
