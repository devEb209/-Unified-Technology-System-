-- ARKHER SYSTEM VD.0137 :: Fidelity Band Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0137"
	S.key = "arkher.contsim.fidelityband.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.fidelityband.multi-scale_fidelity" }
	S.tags = { "vd", "fidelityband", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.fidelityband.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
