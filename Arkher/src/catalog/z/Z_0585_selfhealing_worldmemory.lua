-- ARKHER SYSTEM Z.0585 :: Self Healing Systems World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0585"
	S.key = "arkher.origin.selfhealing.world_memory"
	S.name = "Self Healing Systems World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfhealing.autonomous_pipeline" }
	S.tags = { "z", "selfhealing", "worldmemory", "origin" }
	S.description = "Self Healing Systems World Memory: epoch-stamped persistent history with compaction and checkpoints for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.selfhealing.world_memory", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
