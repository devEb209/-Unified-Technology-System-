-- ARKHER SYSTEM K.0511 :: Flee Behaviour Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0511"
	S.key = "arkher.npc.fleebehaviour.utility_reasoning"
	S.name = "Flee Behaviour Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.fleebehaviour.reactive_behaviour" }
	S.tags = { "k", "fleebehaviour", "utility", "npc" }
	S.description = "Flee Behaviour Utility Reasoning: scored option selection with response curves for the Flee Behaviour subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.fleebehaviour.utility_reasoning", momentum = 0.04 })
		inst.system = S
		inst.ctx = ctx
