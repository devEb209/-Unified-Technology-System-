-- ARKHER SYSTEM L.0287 :: Water Cycle Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0287"
	S.key = "arkher.sim.watercycle.ecology"
	S.name = "Water Cycle Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.watercycle.simulation_core" }
	S.tags = { "l", "watercycle", "ecology", "sim" }
	S.description = "Water Cycle Ecology: populations, predation, harvesting and carrying capacity for the Water Cycle subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.watercycle.ecology" })
		inst.system = S
		inst.ctx = ctx
