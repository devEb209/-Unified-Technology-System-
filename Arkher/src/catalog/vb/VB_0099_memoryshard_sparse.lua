-- ARKHER SYSTEM VB.0099 :: Memory Shard Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0099"
	S.key = "arkher.conttime.memoryshard.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memoryshard.epoch_clock" }
	S.tags = { "vb", "memoryshard", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.memoryshard.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
