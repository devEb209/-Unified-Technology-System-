-- ARKHER SYSTEM VA.0087 :: Residency Window Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0087"
	S.key = "arkher.contworld.residencywindow.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.residencywindow.epoch_clock" }
	S.tags = { "va", "residencywindow", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.residencywindow.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
