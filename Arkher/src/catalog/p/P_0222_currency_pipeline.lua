-- ARKHER SYSTEM P.0222 :: Currency Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0222"
	S.key = "arkher.play.currency.rule_pipeline"
	S.name = "Currency Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Currency"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.currency.state_machine" }
	S.tags = { "p", "currency", "pipeline", "play" }
	S.description = "Currency Rule Pipeline: ordered rules applied to every gameplay event for the Currency subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.currency.rule_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
