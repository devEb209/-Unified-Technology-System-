-- ARKHER SYSTEM G.0021 :: Temporal Reconstruction Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0021"
	S.key = "arkher.neural.temporalrecon.quality_predictor"
	S.name = "Temporal Reconstruction Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.temporalrecon.weight_codec" }
	S.tags = { "g", "temporalrecon", "predictor", "neural" }
	S.description = "Temporal Reconstruction Quality Predictor: predicted quality and cost of a setting for the Temporal Reconstruction subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.temporalrecon.quality_predictor", method = "markov", alpha = 0.47, window = 85 })
		inst.system = S
		inst.ctx = ctx
