-- ARKHER SYSTEM F.0606 :: Frame Capture Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0606"
	S.key = "arkher.render.framecapture.geometry_virtualization"
	S.name = "Frame Capture Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framecapture.visibility_set" }
	S.tags = { "f", "framecapture", "impostor", "render" }
	S.description = "Frame Capture Geometry Virtualization: impostor and HLOD synthesis under a budget for the Frame Capture subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.framecapture.geometry_virtualization", atlasSlots = 80, viewCount = 8, errorThreshold = 1.90 })
		inst.system = S
		inst.ctx = ctx
