-- ARKHER SYSTEM H.0618 :: Character Controller Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0618"
	S.key = "arkher.physics.charactercontroller.collision_shape"
	S.name = "Character Controller Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.charactercontroller.body_dynamics" }
	S.tags = { "h", "charactercontroller", "collider", "physics" }
	S.description = "Character Controller Collision Shape: shape bounds, support mapping and closest points for the Character Controller subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.charactercontroller.collision_shape", shape = "capsule", radius = 1.50, height = 2.30, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
