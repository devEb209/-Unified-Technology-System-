-- ARKHER SYSTEM E.0099 :: Height Displacement Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0099"
	S.key = "arkher.material.displacement.compression_codec"
	S.name = "Height Displacement Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.displacement.streaming" }
	S.tags = { "e", "displacement", "codec", "material" }
	S.description = "Height Displacement Compression Codec: serialization and compression of material data for the Height Displacement subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.displacement.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
