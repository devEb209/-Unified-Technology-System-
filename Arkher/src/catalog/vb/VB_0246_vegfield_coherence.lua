-- ARKHER SYSTEM VB.0246 :: Vegetation Field Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0246"
	S.key = "arkher.conttime.vegfield.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vegfield.persistent_state" }
	S.tags = { "vb", "vegfield", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.vegfield.coherence_guard", window = 119, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
