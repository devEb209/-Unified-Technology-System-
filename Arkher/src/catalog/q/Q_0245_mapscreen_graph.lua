-- ARKHER SYSTEM Q.0245 :: Map Screen Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0245"
	S.key = "arkher.ui.mapscreen.navigation_graph"
	S.name = "Map Screen Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Map Screen"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.mapscreen.transition" }
	S.tags = { "q", "mapscreen", "graph", "ui" }
	S.description = "Map Screen Navigation Graph: screens, routes and shortest path between them for the Map Screen subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.mapscreen.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
