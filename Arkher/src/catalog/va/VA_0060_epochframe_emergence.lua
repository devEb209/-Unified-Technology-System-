-- ARKHER SYSTEM VA.0060 :: Epoch Frame Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0060"
	S.key = "arkher.contworld.epochframe.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.epochframe.reality_continuum" }
	S.tags = { "va", "epochframe", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.epochframe.emergence_continuum", windowSize = 4, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
