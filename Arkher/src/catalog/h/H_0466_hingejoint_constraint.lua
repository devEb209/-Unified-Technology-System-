-- ARKHER SYSTEM H.0466 :: Hinge Joint Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0466"
	S.key = "arkher.physics.hingejoint.constraint_solver"
	S.name = "Hinge Joint Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Hinge Joint"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.hingejoint.contact_generation" }
	S.tags = { "h", "hingejoint", "constraint", "physics" }
	S.description = "Hinge Joint Constraint Solver: sequential impulses, friction, joints and warm starting for the Hinge Joint subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.hingejoint.constraint_solver", iterations = 8, baumgarte = 0.14, warmStart = true })
		inst.system = S
		inst.ctx = ctx
