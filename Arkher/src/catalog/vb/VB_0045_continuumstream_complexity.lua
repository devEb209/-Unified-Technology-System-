-- ARKHER SYSTEM VB.0045 :: Continuum Stream Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0045"
	S.key = "arkher.conttime.continuumstream.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.continuumstream.world_memory_stream" }
	S.tags = { "vb", "continuumstream", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.continuumstream.complexity_budget", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
