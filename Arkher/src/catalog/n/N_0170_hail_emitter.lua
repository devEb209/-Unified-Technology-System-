-- ARKHER SYSTEM N.0170 :: Hail Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0170"
	S.key = "arkher.vfx.hail.emission"
	S.name = "Hail Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Hail"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "hail", "emitter", "vfx" }
	S.description = "Hail Emission: shaped, rate and burst emission of new particles for the Hail subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.hail.emission", shape = "box", rate = 46, speed = 5.60, life = 3.40, budget = 256, seed = 47306 })
		inst.system = S
		inst.ctx = ctx
