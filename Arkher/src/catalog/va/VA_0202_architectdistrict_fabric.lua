-- ARKHER SYSTEM VA.0202 :: Architect District Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0202"
	S.key = "arkher.contworld.architectdistrict.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.architectdistrict.complexity_budget" }
	S.tags = { "va", "architectdistrict", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.architectdistrict.simulation_fabric", budgetMs = 3.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
