-- ARKHER SYSTEM F.0190 :: Sky Model Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0190"
	S.key = "arkher.render.sky.adaptive_resolution"
	S.name = "Sky Model Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sky Model"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sky.temporal_resolve" }
	S.tags = { "f", "sky", "upscaler", "render" }
	S.description = "Sky Model Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Sky Model subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.sky.adaptive_resolution", targetMs = 11.10, index = 3, sharpness = 0.34 })
		inst.system = S
		inst.ctx = ctx
