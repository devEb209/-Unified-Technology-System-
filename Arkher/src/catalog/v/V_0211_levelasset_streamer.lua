-- ARKHER SYSTEM V.0211 :: Level Asset Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0211"
	S.key = "arkher.asset.levelasset.streaming_residency"
	S.name = "Level Asset Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.levelasset.content_cache" }
	S.tags = { "v", "levelasset", "streamer", "asset" }
	S.description = "Level Asset Streaming Residency: distance-driven load and unload of asset payloads for the Level Asset subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.levelasset.streaming_residency", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
