-- ARKHER SYSTEM L.0496 :: War Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0496"
	S.key = "arkher.sim.war.simulation_core"
	S.name = "War Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "war", "simulation", "sim" }
	S.description = "War Simulation Core: observer-driven fidelity, catch-up and aggregate state for the War subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.war.simulation_core", fullRadius = 160, reducedRadius = 700, budget = 81 })
		inst.system = S
		inst.ctx = ctx
