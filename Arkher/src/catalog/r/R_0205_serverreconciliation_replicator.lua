-- ARKHER SYSTEM R.0205 :: Server Reconciliation Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0205"
	S.key = "arkher.net.serverreconciliation.replication"
	S.name = "Server Reconciliation Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "serverreconciliation", "replicator", "net" }
	S.description = "Server Reconciliation Replication: authoritative entity state, interest and delta snapshots for the Server Reconciliation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.serverreconciliation.replication", mtu = 1200, interestRadius = 200, fullEvery = 90 })
		inst.system = S
		inst.ctx = ctx
