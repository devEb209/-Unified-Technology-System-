-- ARKHER SYSTEM Z.0972 :: Generation Migration Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0972"
	S.key = "arkher.origin.generationmigration.predictive_optimization"
	S.name = "Generation Migration Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.adaptive_workflow" }
	S.tags = { "z", "generationmigration", "predictor", "origin" }
	S.description = "Generation Migration Predictive Optimization: forecast-driven optimization before the cost is paid for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.generationmigration.predictive_optimization", method = "markov", alpha = 0.16, window = 70 })
		inst.system = S
		inst.ctx = ctx
