-- ARKHER SYSTEM VD.0573 :: Mobile Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0573"
	S.key = "arkher.contsim.mobilecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.mobilecont.world_memory_stream" }
	S.tags = { "vd", "mobilecont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.mobilecont.complexity_budget", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
