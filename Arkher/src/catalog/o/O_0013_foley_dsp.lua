-- ARKHER SYSTEM O.0013 :: Foley DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0013"
	S.key = "arkher.audio.foley.dsp_chain"
	S.name = "Foley DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Foley"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "foley", "dsp", "audio" }
	S.description = "Foley DSP Chain: biquad filtering, delay, envelope and soft clipping for the Foley subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.foley.dsp_chain", sampleRate = 22050, filter = "bandpass", cutoff = 4500, q = 0.640 })
		inst.system = S
		inst.ctx = ctx
