-- ARKHER SYSTEM R.0097 :: Remote Event Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0097"
	S.key = "arkher.net.remoteevent.replication"
	S.name = "Remote Event Replication"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Remote Event"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "remoteevent", "replicator", "net" }
	S.description = "Remote Event Replication: authoritative entity state, interest and delta snapshots for the Remote Event subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.remoteevent.replication", mtu = 750, interestRadius = 160, fullEvery = 45 })
		inst.system = S
		inst.ctx = ctx
