-- ARKHER SYSTEM Z.0076 :: Reality Layer Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0076"
	S.key = "arkher.origin.realitylayer.governance_policy"
	S.name = "Reality Layer Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.signal_composition" }
	S.tags = { "z", "realitylayer", "policy", "origin" }
	S.description = "Reality Layer Governance Policy: ordered rules governing when the technology may act for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.realitylayer.governance_policy", algorithm = "wfq", starvationGuard = 26 })
		inst.system = S
		inst.ctx = ctx
