-- ARKHER SYSTEM O.0039 :: Impact Sound Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0039"
	S.key = "arkher.audio.impactsound.spatialization"
	S.name = "Impact Sound Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Impact Sound"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.impactsound.mixer_bus" }
	S.tags = { "o", "impactsound", "spatialaudio", "audio" }
	S.description = "Impact Sound Spatialization: distance attenuation, panning, occlusion and doppler for the Impact Sound subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.impactsound.spatialization", model = "exponential", refDistance = 5, maxDistance = 80, rolloff = 1.10, maxVoices = 20 })
		inst.system = S
		inst.ctx = ctx
