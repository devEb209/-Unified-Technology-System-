-- ARKHER SYSTEM L.0169 :: Livestock Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0169"
	S.key = "arkher.sim.livestock.society"
	S.name = "Livestock Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livestock.economy" }
	S.tags = { "l", "livestock", "society", "sim" }
	S.description = "Livestock Society: relations, factions, reputation and cohesion of the region for the Livestock subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.livestock.society", decayRate = 0.013, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
