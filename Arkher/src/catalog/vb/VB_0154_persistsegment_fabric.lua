-- ARKHER SYSTEM VB.0154 :: Persistence Segment Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0154"
	S.key = "arkher.conttime.persistsegment.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.persistsegment.complexity_budget" }
	S.tags = { "vb", "persistsegment", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.persistsegment.simulation_fabric", budgetMs = 1.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
