-- ARKHER SYSTEM J.0175 :: Clothing Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0175"
	S.key = "arkher.character.clothing.streaming"
	S.name = "Clothing Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.clothing.budget_governor" }
	S.tags = { "j", "clothing", "streamer", "character" }
	S.description = "Clothing Streaming: distance-driven residency of character data for the Clothing subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.clothing.streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
