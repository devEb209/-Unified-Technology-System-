-- ARKHER SYSTEM J.0101 :: Lip Sync Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0101"
	S.key = "arkher.character.lipsync.motion_set"
	S.name = "Lip Sync Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.lipsync.rig_definition" }
	S.tags = { "j", "lipsync", "clip", "character" }
	S.description = "Lip Sync Motion Set: the clips a character owns and how they sample for the Lip Sync subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.lipsync.motion_set", duration = 0.80, loop = true })
		inst.system = S
		inst.ctx = ctx
