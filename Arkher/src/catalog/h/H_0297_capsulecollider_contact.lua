-- ARKHER SYSTEM H.0297 :: Capsule Collider Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0297"
	S.key = "arkher.physics.capsulecollider.contact_generation"
	S.name = "Capsule Collider Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.capsulecollider.collision_shape" }
	S.tags = { "h", "capsulecollider", "contact", "physics" }
	S.description = "Capsule Collider Contact Generation: narrow-phase manifolds with normal, depth and point for the Capsule Collider subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.capsulecollider.contact_generation", slop = 0.0090, maxManifolds = 358 })
		inst.system = S
		inst.ctx = ctx
