-- ARKHER SYSTEM K.0620 :: Reputation Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0620"
	S.key = "arkher.npc.reputation.emotion"
	S.name = "Reputation Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.reputation.drive_system" }
	S.tags = { "k", "reputation", "emotion", "npc" }
	S.description = "Reputation Emotion: appraisal of events into valence, arousal and mood for the Reputation subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.reputation.emotion", inertia = 0.79, decayRate = 0.44, baselineArousal = 0.14 })
		inst.system = S
		inst.ctx = ctx
