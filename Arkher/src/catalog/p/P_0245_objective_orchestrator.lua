-- ARKHER SYSTEM P.0245 :: Objective State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0245"
	S.key = "arkher.play.objective.state_machine"
	S.name = "Objective State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Objective"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.objective.combat_resolution" }
	S.tags = { "p", "objective", "orchestrator", "play" }
	S.description = "Objective State Machine: the phase machine that drives this gameplay loop for the Objective subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.objective.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
