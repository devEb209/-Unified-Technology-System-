-- ARKHER SYSTEM I.0160 :: Additive Layer Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0160"
	S.key = "arkher.anim.additivelayer.inverse_kinematics"
	S.name = "Additive Layer Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.additivelayer.layered_blending" }
	S.tags = { "i", "additivelayer", "ik", "anim" }
	S.description = "Additive Layer Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Additive Layer subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.additivelayer.inverse_kinematics", iterations = 13, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
