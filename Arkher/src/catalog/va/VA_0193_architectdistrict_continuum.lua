-- ARKHER SYSTEM VA.0193 :: Architect District Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0193"
	S.key = "arkher.contworld.architectdistrict.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "architectdistrict", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.architectdistrict.infinite_grid", cellSize = 160, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
