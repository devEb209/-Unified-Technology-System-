-- ARKHER SYSTEM K.0580 :: Idle Behaviour Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0580"
	S.key = "arkher.npc.idlebehaviour.reactive_behaviour"
	S.name = "Idle Behaviour Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.idlebehaviour.perception" }
	S.tags = { "k", "idlebehaviour", "behaviortree", "npc" }
	S.description = "Idle Behaviour Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Idle Behaviour subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.idlebehaviour.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
