-- ARKHER SYSTEM N.0074 :: Debris Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0074"
	S.key = "arkher.vfx.debris.result_cache"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.debris.spawn_budget" }
	S.tags = { "n", "debris", "cache", "vfx" }
	S.description = "Debris Result Cache: reuse of expensive effect evaluations for the Debris subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.debris.result_cache", policy = "lfu", capacity = 220, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
