-- ARKHER SYSTEM Z.0224 :: Emergent Society Framework Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0224"
	S.key = "arkher.origin.emergentsociety.autonomous_pipeline"
	S.name = "Emergent Society Framework Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentsociety.simulation_fabric" }
	S.tags = { "z", "emergentsociety", "autopipeline", "origin" }
	S.description = "Emergent Society Framework Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.emergentsociety.autonomous_pipeline", maxIterations = 8 })
		inst.system = S
		inst.ctx = ctx
