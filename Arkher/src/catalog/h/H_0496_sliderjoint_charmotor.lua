-- ARKHER SYSTEM H.0496 :: Slider Joint Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0496"
	S.key = "arkher.physics.sliderjoint.character_motion"
	S.name = "Slider Joint Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Slider Joint"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sliderjoint.query" }
	S.tags = { "h", "sliderjoint", "charmotor", "physics" }
	S.description = "Slider Joint Character Motion: capsule move-and-slide with slopes, steps and jumps for the Slider Joint subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.sliderjoint.character_motion", radius = 0.50, height = 1.75, maxSpeed = 5.50, jumpHeight = 1.50, stepOffset = 0.40 })
		inst.system = S
		inst.ctx = ctx
