-- ARKHER SYSTEM E.0250 :: Triplanar Projection Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0250"
	S.key = "arkher.material.triplanar.quality_policy"
	S.name = "Triplanar Projection Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.triplanar.compression_codec" }
	S.tags = { "e", "triplanar", "policy", "material" }
	S.description = "Triplanar Projection Quality Policy: device tier rules for the surface for the Triplanar Projection subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.triplanar.quality_policy", algorithm = "edf", starvationGuard = 53 })
		inst.system = S
		inst.ctx = ctx
