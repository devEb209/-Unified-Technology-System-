-- ARKHER SYSTEM G.0483 :: Evaluation Harness Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0483"
	S.key = "arkher.neural.evalharness.quality_predictor"
	S.name = "Evaluation Harness Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.evalharness.weight_codec" }
	S.tags = { "g", "evalharness", "predictor", "neural" }
	S.description = "Evaluation Harness Quality Predictor: predicted quality and cost of a setting for the Evaluation Harness subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.evalharness.quality_predictor", method = "markov", alpha = 0.18, window = 112 })
		inst.system = S
		inst.ctx = ctx
