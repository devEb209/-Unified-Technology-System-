-- ARKHER SYSTEM Q.0125 :: Tooltip Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0125"
	S.key = "arkher.ui.tooltip.navigation_graph"
	S.name = "Tooltip Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tooltip"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.tooltip.transition" }
	S.tags = { "q", "tooltip", "graph", "ui" }
	S.description = "Tooltip Navigation Graph: screens, routes and shortest path between them for the Tooltip subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.tooltip.navigation_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
