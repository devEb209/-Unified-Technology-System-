-- ARKHER SYSTEM L.0005 :: Living World Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0005"
	S.key = "arkher.sim.livingworld.calendar"
	S.name = "Living World Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livingworld.society" }
	S.tags = { "l", "livingworld", "schedule", "sim" }
	S.description = "Living World Calendar: hours, days and seasons driving the region for the Living World subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.livingworld.calendar", startHour = 8 })
		inst.system = S
		inst.ctx = ctx
