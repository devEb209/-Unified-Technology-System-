-- ARKHER SYSTEM P.0428 :: Party Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0428"
	S.key = "arkher.play.party.balance_analysis"
	S.name = "Party Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Party"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.party.event_ledger" }
	S.tags = { "p", "party", "analyzer", "play" }
	S.description = "Party Balance Analysis: distribution, outlier and pacing analysis for the Party subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.party.balance_analysis", window = 72, buckets = 8, threshold = 4.40 })
		inst.system = S
		inst.ctx = ctx
