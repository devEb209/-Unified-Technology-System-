-- ARKHER SYSTEM Z.0043 :: Singularity World Architect Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0043"
	S.key = "arkher.origin.worldarchitect.simulation_fabric"
	S.name = "Singularity World Architect Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.complexity_governance" }
	S.tags = { "z", "worldarchitect", "fabric", "origin" }
	S.description = "Singularity World Architect Simulation Fabric: every simulation domain stepped under one budgeted clock for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.worldarchitect.simulation_fabric", budgetMs = 2.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
