-- ARKHER SYSTEM K.0481 :: Follow Behaviour Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0481"
	S.key = "arkher.npc.followbehaviour.perception"
	S.name = "Follow Behaviour Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.followbehaviour.emotion" }
	S.tags = { "k", "followbehaviour", "perception", "npc" }
	S.description = "Follow Behaviour Perception: sight, hearing and bounded attention for the Follow Behaviour subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.followbehaviour.perception", sightRange = 50, hearingRange = 16, attentionSlots = 4, fov = 1.650 })
		inst.system = S
		inst.ctx = ctx
