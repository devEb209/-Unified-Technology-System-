-- ARKHER SYSTEM F.0178 :: Atmosphere Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0178"
	S.key = "arkher.render.atmosphere.render_policy"
	S.name = "Atmosphere Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Atmosphere"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.atmosphere.draw_budget" }
	S.tags = { "f", "atmosphere", "policy", "render" }
	S.description = "Atmosphere Render Policy: device tier rules for the frame for the Atmosphere subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.atmosphere.render_policy", algorithm = "lottery", starvationGuard = 27 })
		inst.system = S
		inst.ctx = ctx
