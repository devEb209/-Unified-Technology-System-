-- ARKHER SYSTEM O.0279 :: Transition Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0279"
	S.key = "arkher.audio.audiotransition.spatialization"
	S.name = "Transition Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Transition"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiotransition.mixer_bus" }
	S.tags = { "o", "audiotransition", "spatialaudio", "audio" }
	S.description = "Transition Spatialization: distance attenuation, panning, occlusion and doppler for the Transition subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.audiotransition.spatialization", model = "exponential", refDistance = 5, maxDistance = 200, rolloff = 0.96, maxVoices = 20 })
		inst.system = S
		inst.ctx = ctx
