-- ARKHER SYSTEM Z.1017 :: Capability Discovery Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.1017"
	S.key = "arkher.origin.capabilitydiscovery.behaviour_analysis"
	S.name = "Capability Discovery Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.governance_policy" }
	S.tags = { "z", "capabilitydiscovery", "analyzer", "origin" }
	S.description = "Capability Discovery Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.capabilitydiscovery.behaviour_analysis", window = 234, buckets = 18, threshold = 3.60 })
		inst.system = S
		inst.ctx = ctx
