-- ARKHER SYSTEM I.0315 :: Spine Bend Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0315"
	S.key = "arkher.anim.spinebend.layered_blending"
	S.name = "Spine Bend Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Spine Bend"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.spinebend.clip_sampling" }
	S.tags = { "i", "spinebend", "animator", "anim" }
	S.description = "Spine Bend Layered Blending: layers, crossfades, masks and blend trees for the Spine Bend subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.spinebend.layered_blending", budget = 11 })
		inst.system = S
		inst.ctx = ctx
