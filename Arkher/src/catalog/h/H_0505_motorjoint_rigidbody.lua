-- ARKHER SYSTEM H.0505 :: Motorized Joint Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0505"
	S.key = "arkher.physics.motorjoint.body_dynamics"
	S.name = "Motorized Joint Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "motorjoint", "rigidbody", "physics" }
	S.description = "Motorized Joint Body Dynamics: integration, impulses, damping and sleeping of a body for the Motorized Joint subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.motorjoint.body_dynamics", mass = 14.00, radius = 0.95, restitution = 0.53, friction = 0.43, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
