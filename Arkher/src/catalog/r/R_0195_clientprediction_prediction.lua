-- ARKHER SYSTEM R.0195 :: Client Prediction Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0195"
	S.key = "arkher.net.clientprediction.prediction_and_reconciliation"
	S.name = "Client Prediction Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.clientprediction.time_sync" }
	S.tags = { "r", "clientprediction", "prediction", "net" }
	S.description = "Client Prediction Prediction And Reconciliation: client simulation, correction and input replay for the Client Prediction subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.clientprediction.prediction_and_reconciliation", errorThreshold = 0.060, smoothing = 14.0, maxInputs = 140 })
		inst.system = S
		inst.ctx = ctx
