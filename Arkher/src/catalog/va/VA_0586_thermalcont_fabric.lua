-- ARKHER SYSTEM VA.0586 :: Thermal Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0586"
	S.key = "arkher.contworld.thermalcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.thermalcont.complexity_budget" }
	S.tags = { "va", "thermalcont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.thermalcont.simulation_fabric", budgetMs = 4.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
