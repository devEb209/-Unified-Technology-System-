-- ARKHER SYSTEM Z.0802 :: Perceptual Budgeting Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0802"
	S.key = "arkher.origin.perceptualbudget.complexity_governance"
	S.name = "Perceptual Budgeting Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.perceptualbudget.reality_layering" }
	S.tags = { "z", "perceptualbudget", "complexity", "origin" }
	S.description = "Perceptual Budgeting Complexity Governance: measured scene cost turned into per-subsystem directives for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.perceptualbudget.complexity_governance", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
