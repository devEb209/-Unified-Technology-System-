-- ARKHER SYSTEM J.0236 :: Body Type Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0236"
	S.key = "arkher.character.bodytype.physical_response"
	S.name = "Body Type Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.bodytype.look_and_reach" }
	S.tags = { "j", "bodytype", "ragdoll", "character" }
	S.description = "Body Type Physical Response: physical reaction, ragdoll and recovery for the Body Type subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.bodytype.physical_response", blendSpeed = 4.60 })
		inst.system = S
		inst.ctx = ctx
