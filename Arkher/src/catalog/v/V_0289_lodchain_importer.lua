-- ARKHER SYSTEM V.0289 :: LOD Chain Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0289"
	S.key = "arkher.asset.lodchain.import"
	S.name = "LOD Chain Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "lodchain", "importer", "asset" }
	S.description = "LOD Chain Import: validation, normalization, hashing and deduplication of incoming content for the LOD Chain subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.lodchain.import", unitScale = 1.50 })
		inst.system = S
		inst.ctx = ctx
