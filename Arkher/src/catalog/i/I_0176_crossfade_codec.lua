-- ARKHER SYSTEM I.0176 :: Crossfade Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0176"
	S.key = "arkher.anim.crossfade.compression_codec"
	S.name = "Crossfade Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Crossfade"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crossfade.retarget_graph" }
	S.tags = { "i", "crossfade", "codec", "anim" }
	S.description = "Crossfade Compression Codec: curve compression and quantized transport for the Crossfade subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.crossfade.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
