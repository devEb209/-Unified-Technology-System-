-- ARKHER SYSTEM R.0170 :: Interpolation Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0170"
	S.key = "arkher.net.interpolation.time_sync"
	S.name = "Interpolation Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.interpolation.replication" }
	S.tags = { "r", "interpolation", "netclock", "net" }
	S.description = "Interpolation Time Sync: offset estimation, outlier rejection and jitter buffering for the Interpolation subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.interpolation.time_sync", tickRate = 50, bufferDelay = 0.070, maxSamples = 15 })
		inst.system = S
		inst.ctx = ctx
