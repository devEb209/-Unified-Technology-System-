-- ARKHER SYSTEM L.0220 :: Vegetation Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0220"
	S.key = "arkher.sim.vegetation.streaming"
	S.name = "Vegetation Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.vegetation.state_codec" }
	S.tags = { "l", "vegetation", "streamer", "sim" }
	S.description = "Vegetation Streaming: distance-driven residency of simulated regions for the Vegetation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.vegetation.streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
