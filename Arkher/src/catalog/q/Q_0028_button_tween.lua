-- ARKHER SYSTEM Q.0028 :: Button Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0028"
	S.key = "arkher.ui.button.transition"
	S.name = "Button Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Button"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.button.input_mapping" }
	S.tags = { "q", "button", "tween", "ui" }
	S.description = "Button Transition: eased, delayed, looped and sequenced motion for the Button subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.button.transition", timeScale = 1.01 })
		inst.system = S
		inst.ctx = ctx
