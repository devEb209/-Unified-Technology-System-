-- ARKHER SYSTEM J.0283 :: Character Physics Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0283"
	S.key = "arkher.character.characterphysics.variant_registry"
	S.name = "Character Physics Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterphysics.appearance_composer" }
	S.tags = { "j", "characterphysics", "registry", "character" }
	S.description = "Character Physics Variant Registry: named character variants and their lifecycle for the Character Physics subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.characterphysics.variant_registry" })
		inst.system = S
		inst.ctx = ctx
