-- ARKHER SYSTEM VB.0095 :: Residency Window Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0095"
	S.key = "arkher.conttime.residencywindow.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.residencywindow.simulation_fabric" }
	S.tags = { "vb", "residencywindow", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.residencywindow.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
