-- ARKHER SYSTEM L.0385 :: Caravan Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0385"
	S.key = "arkher.sim.caravan.streaming"
	S.name = "Caravan Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.caravan.state_codec" }
	S.tags = { "l", "caravan", "streamer", "sim" }
	S.description = "Caravan Streaming: distance-driven residency of simulated regions for the Caravan subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.caravan.streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
