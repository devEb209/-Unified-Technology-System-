-- ARKHER SYSTEM O.0177 :: City Audio Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0177"
	S.key = "arkher.audio.cityaudio.playback_policy"
	S.name = "City Audio Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "City Audio"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.cityaudio.compression_codec" }
	S.tags = { "o", "cityaudio", "policy", "audio" }
	S.description = "City Audio Playback Policy: rules choosing what may be heard right now for the City Audio subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.cityaudio.playback_policy", algorithm = "wfq", starvationGuard = 46 })
		inst.system = S
		inst.ctx = ctx
