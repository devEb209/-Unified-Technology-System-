-- ARKHER SYSTEM O.0254 :: Exploration Music Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0254"
	S.key = "arkher.audio.explorationmusic.mixer_bus"
	S.name = "Exploration Music Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.explorationmusic.dsp_chain" }
	S.tags = { "o", "explorationmusic", "mixer", "audio" }
	S.description = "Exploration Music Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Exploration Music subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.explorationmusic.mixer_bus", maxVoices = 48 })
		inst.system = S
		inst.ctx = ctx
