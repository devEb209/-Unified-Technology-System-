-- ARKHER SYSTEM Z.0878 :: Multi Scale Simulation Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0878"
	S.key = "arkher.origin.multiscale.budget_governor"
	S.name = "Multi Scale Simulation Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.behaviour_analysis" }
	S.tags = { "z", "multiscale", "budgeter", "origin" }
	S.description = "Multi Scale Simulation Budget Governor: allocation of a scarce resource across the technology's consumers for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.multiscale.budget_governor", total = 455, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
