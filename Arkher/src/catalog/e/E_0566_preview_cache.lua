-- ARKHER SYSTEM E.0566 :: Material Preview Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0566"
	S.key = "arkher.material.preview.instance_cache"
	S.name = "Material Preview Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.preview.quality_policy" }
	S.tags = { "e", "preview", "cache", "material" }
	S.description = "Material Preview Instance Cache: resolved-parameter cache keyed by context for the Material Preview subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.preview.instance_cache", policy = "ttl", capacity = 431, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
