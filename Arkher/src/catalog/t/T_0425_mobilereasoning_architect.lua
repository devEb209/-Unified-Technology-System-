-- ARKHER SYSTEM T.0425 :: Mobile Reasoning World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0425"
	S.key = "arkher.ai.mobilereasoning.world_architect"
	S.name = "Mobile Reasoning World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.mobilereasoning.self_critique" }
	S.tags = { "t", "mobilereasoning", "architect", "ai" }
	S.description = "Mobile Reasoning World Architect: composition of a whole world plan with conserved budgets for the Mobile Reasoning subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.mobilereasoning.world_architect", budget = 700, seed = 91231 })
		inst.system = S
		inst.ctx = ctx
