-- ARKHER SYSTEM J.0014 :: Character Rig Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0014"
	S.key = "arkher.character.characterrig.blend_controller"
	S.name = "Character Rig Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterrig.motion_set" }
	S.tags = { "j", "characterrig", "animator", "character" }
	S.description = "Character Rig Blend Controller: layered playback driving the character for the Character Rig subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.characterrig.blend_controller", budget = 4 })
		inst.system = S
		inst.ctx = ctx
