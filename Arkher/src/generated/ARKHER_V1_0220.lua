...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="OpenWeather — CORE Stack #0220", size=Vector2.new(640, 420), pos=UDim2.fromOffset(160, 180), parent=parent, icon="⬣"})
