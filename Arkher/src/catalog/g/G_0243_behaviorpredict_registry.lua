-- ARKHER SYSTEM G.0243 :: Behaviour Prediction Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0243"
	S.key = "arkher.neural.behaviorpredict.model_registry"
	S.name = "Behaviour Prediction Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.behaviorpredict.reconstruction" }
	S.tags = { "g", "behaviorpredict", "registry", "neural" }
	S.description = "Behaviour Prediction Model Registry: named models and their lifecycle for the Behaviour Prediction subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.behaviorpredict.model_registry" })
		inst.system = S
		inst.ctx = ctx
