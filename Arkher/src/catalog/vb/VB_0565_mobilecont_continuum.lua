-- ARKHER SYSTEM VB.0565 :: Mobile Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0565"
	S.key = "arkher.conttime.mobilecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "mobilecont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.mobilecont.infinite_grid", cellSize = 160, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
