-- ARKHER SYSTEM VC.0542 :: World Fabric Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0542"
	S.key = "arkher.contneural.worldfabric.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldfabric.infinite_grid" }
	S.tags = { "vc", "worldfabric", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.worldfabric.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
