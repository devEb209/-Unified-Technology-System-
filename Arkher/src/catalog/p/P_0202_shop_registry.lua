-- ARKHER SYSTEM P.0202 :: Shop Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0202"
	S.key = "arkher.play.shop.content_registry"
	S.name = "Shop Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Shop"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.shop.difficulty_controller" }
	S.tags = { "p", "shop", "registry", "play" }
	S.description = "Shop Content Registry: catalogue of the definitions this loop instantiates for the Shop subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.shop.content_registry" })
		inst.system = S
		inst.ctx = ctx
