-- ARKHER SYSTEM Z.0080 :: Reality Layer Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0080"
	S.key = "arkher.origin.realitylayer.orchestration"
	S.name = "Reality Layer Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.residency_streaming" }
	S.tags = { "z", "realitylayer", "orchestrator", "origin" }
	S.description = "Reality Layer Orchestration: lifecycle and phase orchestration of the technology for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.realitylayer.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
