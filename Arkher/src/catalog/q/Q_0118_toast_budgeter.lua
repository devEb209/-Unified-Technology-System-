-- ARKHER SYSTEM Q.0118 :: Toast Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0118"
	S.key = "arkher.ui.toast.frame_budget"
	S.name = "Toast Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Toast"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.toast.accessibility_policy" }
	S.tags = { "q", "toast", "budgeter", "ui" }
	S.description = "Toast Frame Budget: per-frame layout and draw budget for the interface for the Toast subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.toast.frame_budget", total = 292, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
