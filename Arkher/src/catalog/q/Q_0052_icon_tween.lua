-- ARKHER SYSTEM Q.0052 :: Icon Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0052"
	S.key = "arkher.ui.icon.transition"
	S.name = "Icon Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Icon"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.icon.input_mapping" }
	S.tags = { "q", "icon", "tween", "ui" }
	S.description = "Icon Transition: eased, delayed, looped and sequenced motion for the Icon subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.icon.transition", timeScale = 0.95 })
		inst.system = S
		inst.ctx = ctx
