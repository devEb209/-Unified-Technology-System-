-- ARKHER SYSTEM G.0093 :: Ghosting Suppression Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0093"
	S.key = "arkher.neural.ghosting.result_cache"
	S.name = "Ghosting Suppression Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ghosting.compute_budget" }
	S.tags = { "g", "ghosting", "cache", "neural" }
	S.description = "Ghosting Suppression Result Cache: cached inference results keyed by input for the Ghosting Suppression subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.ghosting.result_cache", policy = "lfu", capacity = 311, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
