-- ARKHER SYSTEM VD.0157 :: Coherence Seam Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0157"
	S.key = "arkher.contsim.coherenceseam.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "coherenceseam", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.coherenceseam.infinite_grid", cellSize = 160, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
