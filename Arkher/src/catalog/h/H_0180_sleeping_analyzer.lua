-- ARKHER SYSTEM H.0180 :: Sleeping Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0180"
	S.key = "arkher.physics.sleeping.analysis"
	S.name = "Sleeping Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Sleeping"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sleeping.result_cache" }
	S.tags = { "h", "sleeping", "analyzer", "physics" }
	S.description = "Sleeping Analysis: energy, jitter and cost analysis of the simulation for the Sleeping subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.sleeping.analysis", window = 231, buckets = 19, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
