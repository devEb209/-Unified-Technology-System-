-- ARKHER SYSTEM E.0457 :: Procedural Texture Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0457"
	S.key = "arkher.material.proctex.parameter_budget"
	S.name = "Procedural Texture Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.proctex.variant_registry" }
	S.tags = { "e", "proctex", "budgeter", "material" }
	S.description = "Procedural Texture Parameter Budget: texel and layer budget allocation for the Procedural Texture subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.proctex.parameter_budget", total = 378, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
