-- ARKHER SYSTEM F.0240 :: Reflection Probe View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0240"
	S.key = "arkher.render.reflectionprobe.view_and_culling"
	S.name = "Reflection Probe View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.reflectionprobe.frame_graph" }
	S.tags = { "f", "reflectionprobe", "camera", "render" }
	S.description = "Reflection Probe View And Culling: view state, frustum culling and screen-size LOD for the Reflection Probe subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.reflectionprobe.view_and_culling", width = 1340, height = 1260, fov = 1.0900, far = 1800 })
		inst.system = S
		inst.ctx = ctx
