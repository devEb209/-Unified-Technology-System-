-- ARKHER SYSTEM Q.0323 :: Gamepad Focus Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0323"
	S.key = "arkher.ui.gamepadfocus.usability_analysis"
	S.name = "Gamepad Focus Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.gamepadfocus.frame_budget" }
	S.tags = { "q", "gamepadfocus", "analyzer", "ui" }
	S.description = "Gamepad Focus Usability Analysis: reachability, latency and abandonment analysis for the Gamepad Focus subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.gamepadfocus.usability_analysis", window = 188, buckets = 8, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
