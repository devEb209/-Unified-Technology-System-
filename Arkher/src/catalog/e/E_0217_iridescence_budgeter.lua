-- ARKHER SYSTEM E.0217 :: Iridescence Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0217"
	S.key = "arkher.material.iridescence.parameter_budget"
	S.name = "Iridescence Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Iridescence"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.iridescence.variant_registry" }
	S.tags = { "e", "iridescence", "budgeter", "material" }
	S.description = "Iridescence Parameter Budget: texel and layer budget allocation for the Iridescence subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.iridescence.parameter_budget", total = 156, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
