-- ARKHER SYSTEM E.0583 :: Material Validation Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0583"
	S.key = "arkher.material.validation.authoring_pipeline"
	S.name = "Material Validation Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.validation.analysis" }
	S.tags = { "e", "validation", "pipeline", "material" }
	S.description = "Material Validation Authoring Pipeline: ordered authoring and bake stages for the Material Validation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.validation.authoring_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
