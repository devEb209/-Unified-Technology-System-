-- ARKHER SYSTEM VC.0257 :: Road Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0257"
	S.key = "arkher.contneural.roadcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.roadcont.multi-scale_fidelity" }
	S.tags = { "vc", "roadcont", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.roadcont.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
