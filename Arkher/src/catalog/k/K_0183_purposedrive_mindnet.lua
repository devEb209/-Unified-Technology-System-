-- ARKHER SYSTEM K.0183 :: Purpose Drive Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0183"
	S.key = "arkher.npc.purposedrive.mind_network"
	S.name = "Purpose Drive Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "purposedrive", "mindnet", "npc" }
	S.description = "Purpose Drive Mind Network: the learned policy that turns perception into a decision for the Purpose Drive subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.purposedrive.mind_network", inputs = 9, hidden = 5, seed = 66231, learningRate = 0.055, exploration = 0.055 })
		inst.system = S
		inst.ctx = ctx
