-- ARKHER SYSTEM K.0340 :: Behaviour Tree Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0340"
	S.key = "arkher.npc.behaviourtree.emotion"
	S.name = "Behaviour Tree Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourtree.drive_system" }
	S.tags = { "k", "behaviourtree", "emotion", "npc" }
	S.description = "Behaviour Tree Emotion: appraisal of events into valence, arousal and mood for the Behaviour Tree subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.behaviourtree.emotion", inertia = 0.90, decayRate = 0.25, baselineArousal = 0.25 })
		inst.system = S
		inst.ctx = ctx
