-- ARKHER SYSTEM O.0381 :: Mix Snapshot Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0381"
	S.key = "arkher.audio.mixsnapshot.playback_policy"
	S.name = "Mix Snapshot Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mix Snapshot"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mixsnapshot.compression_codec" }
	S.tags = { "o", "mixsnapshot", "policy", "audio" }
	S.description = "Mix Snapshot Playback Policy: rules choosing what may be heard right now for the Mix Snapshot subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.mixsnapshot.playback_policy", algorithm = "roundrobin", starvationGuard = 36 })
		inst.system = S
		inst.ctx = ctx
