-- ARKHER SYSTEM F.0359 :: Temporal Accumulation Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0359"
	S.key = "arkher.render.temporalaccum.draw_budget"
	S.name = "Temporal Accumulation Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.temporalaccum.adaptive_resolution" }
	S.tags = { "f", "temporalaccum", "budgeter", "render" }
	S.description = "Temporal Accumulation Draw Budget: draw call and triangle budget allocation for the Temporal Accumulation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.temporalaccum.draw_budget", total = 130, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
