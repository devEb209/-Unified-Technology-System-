-- ARKHER SYSTEM VC.0504 :: Rendering Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0504"
	S.key = "arkher.contneural.rendercont.emergence_continuum"
	S.name = "Rendering Continuum Emergence Continuum"
	S.category = "VC"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.rendercont.reality_continuum" }
	S.tags = { "vc", "rendercont", "emergence", "contneural" }
	S.description = "Rendering Continuum Emergence Continuum: emergence detection over the continuum for the Rendering Continuum subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.rendercont.emergence_continuum", windowSize = 6, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
