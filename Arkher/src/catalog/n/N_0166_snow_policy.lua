-- ARKHER SYSTEM N.0166 :: Snow Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0166"
	S.key = "arkher.vfx.snow.quality_policy"
	S.name = "Snow Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Snow"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.snow.result_cache" }
	S.tags = { "n", "snow", "policy", "vfx" }
	S.description = "Snow Quality Policy: distance and device driven fidelity bands for the Snow subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.snow.quality_policy", algorithm = "edf", starvationGuard = 33 })
		inst.system = S
		inst.ctx = ctx
