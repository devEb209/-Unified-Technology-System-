-- ARKHER SYSTEM R.0158 :: Snapshot Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0158"
	S.key = "arkher.net.snapshot.time_sync"
	S.name = "Snapshot Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Snapshot"
	S.aspect = "Time Sync"
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.snapshot.replication" }
	S.tags = { "r", "snapshot", "netclock", "net" }
	S.description = "Snapshot Time Sync: offset estimation, outlier rejection and jitter buffering for the Snapshot subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.snapshot.time_sync", tickRate = 50, bufferDelay = 0.110, maxSamples = 15 })
		inst.system = S
		inst.ctx = ctx
