-- ARKHER SYSTEM VC.0445 :: Animation Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0445"
	S.key = "arkher.contneural.animcont.infinite_grid"
	S.name = "Animation Continuum Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "animcont", "continuum", "contneural" }
	S.description = "Animation Continuum Infinite Grid: seamless paging of the infinite world grid for the Animation Continuum subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.animcont.infinite_grid", cellSize = 192, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
