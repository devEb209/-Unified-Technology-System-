-- ARKHER SYSTEM Z.0342 :: Device Aware Fidelity Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0342"
	S.key = "arkher.origin.deviceaware.complexity_governance"
	S.name = "Device Aware Fidelity Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.reality_layering" }
	S.tags = { "z", "deviceaware", "complexity", "origin" }
	S.description = "Device Aware Fidelity Complexity Governance: measured scene cost turned into per-subsystem directives for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.deviceaware.complexity_governance", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
