-- ARKHER SYSTEM P.0346 :: Cooldown Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0346"
	S.key = "arkher.play.cooldown.content_registry"
	S.name = "Cooldown Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Cooldown"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.cooldown.difficulty_controller" }
	S.tags = { "p", "cooldown", "registry", "play" }
	S.description = "Cooldown Content Registry: catalogue of the definitions this loop instantiates for the Cooldown subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.cooldown.content_registry" })
		inst.system = S
		inst.ctx = ctx
