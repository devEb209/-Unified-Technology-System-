-- ARKHER SYSTEM T.0234 :: Quest Generation Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0234"
	S.key = "arkher.ai.questgeneration.utility_selection"
	S.name = "Quest Generation Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.questgeneration.working_memory" }
	S.tags = { "t", "questgeneration", "utility", "ai" }
	S.description = "Quest Generation Utility Selection: scored choice between competing courses of action for the Quest Generation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.questgeneration.utility_selection", momentum = 0.09 })
		inst.system = S
		inst.ctx = ctx
