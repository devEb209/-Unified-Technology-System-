-- ARKHER SYSTEM Z.0987 :: Engine Self Model World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0987"
	S.key = "arkher.origin.engineselfmodel.world_architect"
	S.name = "Engine Self Model World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.engineselfmodel.emergence_detection" }
	S.tags = { "z", "engineselfmodel", "architect", "origin" }
	S.description = "Engine Self Model World Architect: hierarchical world composition with conserved budgets for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.engineselfmodel.world_architect", budget = 1400, seed = 49308 })
		inst.system = S
		inst.ctx = ctx
