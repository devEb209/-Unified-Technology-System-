-- ARKHER SYSTEM P.0440 :: Matchmaking Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0440"
	S.key = "arkher.play.matchmaking.balance_analysis"
	S.name = "Matchmaking Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Matchmaking"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.matchmaking.event_ledger" }
	S.tags = { "p", "matchmaking", "analyzer", "play" }
	S.description = "Matchmaking Balance Analysis: distribution, outlier and pacing analysis for the Matchmaking subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.matchmaking.balance_analysis", window = 228, buckets = 16, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
