-- ARKHER SYSTEM VD.0055 :: Epoch Frame Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0055"
	S.key = "arkher.contsim.epochframe.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.epochframe.coherence_guard" }
	S.tags = { "vd", "epochframe", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.epochframe.neural_field", dims = 20, hidden = 16, seed = 63410 })
		inst.system = S
		inst.ctx = ctx
