-- ARKHER SYSTEM V.0261 :: Video Asset Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0261"
	S.key = "arkher.asset.videoasset.size_budget"
	S.name = "Video Asset Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.videoasset.compression_codec" }
	S.tags = { "v", "videoasset", "budgeter", "asset" }
	S.description = "Video Asset Size Budget: byte budget shared between competing asset classes for the Video Asset subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.videoasset.size_budget", total = 85, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
