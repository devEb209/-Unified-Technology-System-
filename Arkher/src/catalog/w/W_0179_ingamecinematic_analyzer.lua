-- ARKHER SYSTEM W.0179 :: In Game Cinematic Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0179"
	S.key = "arkher.cine.ingamecinematic.sequence_analysis"
	S.name = "In Game Cinematic Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.ingamecinematic.frame_budget" }
	S.tags = { "w", "ingamecinematic", "analyzer", "cine" }
	S.description = "In Game Cinematic Sequence Analysis: pacing, coverage and cut-rhythm analysis for the In Game Cinematic subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.ingamecinematic.sequence_analysis", window = 123, buckets = 19, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
