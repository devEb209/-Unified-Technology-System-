-- ARKHER SYSTEM Z.0485 :: Cultural Evolution World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0485"
	S.key = "arkher.origin.culturalevolution.world_memory"
	S.name = "Cultural Evolution World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.autonomous_pipeline" }
	S.tags = { "z", "culturalevolution", "worldmemory", "origin" }
	S.description = "Cultural Evolution World Memory: epoch-stamped persistent history with compaction and checkpoints for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.culturalevolution.world_memory", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
