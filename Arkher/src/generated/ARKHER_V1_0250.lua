...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Creation2 — CORE Stack #0250", size=Vector2.new(640, 420), pos=UDim2.fromOffset(150, 170), parent=parent, icon="⬡"})
