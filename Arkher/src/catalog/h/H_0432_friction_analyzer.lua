-- ARKHER SYSTEM H.0432 :: Friction Model Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0432"
	S.key = "arkher.physics.friction.analysis"
	S.name = "Friction Model Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.friction.result_cache" }
	S.tags = { "h", "friction", "analyzer", "physics" }
	S.description = "Friction Model Analysis: energy, jitter and cost analysis of the simulation for the Friction Model subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.friction.analysis", window = 114, buckets = 14, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
