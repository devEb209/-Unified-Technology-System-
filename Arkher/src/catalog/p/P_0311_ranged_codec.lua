-- ARKHER SYSTEM P.0311 :: Ranged Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0311"
	S.key = "arkher.play.ranged.save_codec"
	S.name = "Ranged Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ranged"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ranged.content_registry" }
	S.tags = { "p", "ranged", "codec", "play" }
	S.description = "Ranged Save Codec: persistence, diffing and checksum of gameplay state for the Ranged subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.ranged.save_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
