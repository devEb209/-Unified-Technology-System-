-- ARKHER SYSTEM T.0222 :: Character Generation Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0222"
	S.key = "arkher.ai.charactergeneration.model_inference"
	S.name = "Character Generation Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.charactergeneration.action_planner" }
	S.tags = { "t", "charactergeneration", "inference", "ai" }
	S.description = "Character Generation Model Inference: quantized inference with batching and budget for the Character Generation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.charactergeneration.model_inference", seed = 23947 })
		inst.system = S
		inst.ctx = ctx
