...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Google Maps — CORE Mixer #0132", size=Vector2.new(600, 460), pos=UDim2.fromOffset(216, 244), parent=parent, icon="⬢"})
