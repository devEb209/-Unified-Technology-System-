-- ARKHER SYSTEM F.0669 :: VR Stereo Path Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0669"
	S.key = "arkher.render.vrpath.pass_cache"
	S.name = "VR Stereo Path Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.vrpath.render_policy" }
	S.tags = { "f", "vrpath", "cache", "render" }
	S.description = "VR Stereo Path Pass Cache: reuse of pass results across frames for the VR Stereo Path subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.vrpath.pass_cache", policy = "ttl", capacity = 337, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
