-- ARKHER SYSTEM I.0193 :: Blend Tree Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0193"
	S.key = "arkher.anim.blendtree.quality_policy"
	S.name = "Blend Tree Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Blend Tree"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.blendtree.pose_cache" }
	S.tags = { "i", "blendtree", "policy", "anim" }
	S.description = "Blend Tree Quality Policy: device tier rules for rate, bones and solvers for the Blend Tree subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.blendtree.quality_policy", algorithm = "lottery", starvationGuard = 23 })
		inst.system = S
		inst.ctx = ctx
