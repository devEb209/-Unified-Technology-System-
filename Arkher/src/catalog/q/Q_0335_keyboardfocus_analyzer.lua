-- ARKHER SYSTEM Q.0335 :: Keyboard Focus Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0335"
	S.key = "arkher.ui.keyboardfocus.usability_analysis"
	S.name = "Keyboard Focus Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.keyboardfocus.frame_budget" }
	S.tags = { "q", "keyboardfocus", "analyzer", "ui" }
	S.description = "Keyboard Focus Usability Analysis: reachability, latency and abandonment analysis for the Keyboard Focus subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.keyboardfocus.usability_analysis", window = 92, buckets = 8, threshold = 4.40 })
		inst.system = S
		inst.ctx = ctx
