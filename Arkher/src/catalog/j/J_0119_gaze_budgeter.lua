-- ARKHER SYSTEM J.0119 :: Gaze Behaviour Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0119"
	S.key = "arkher.character.gaze.budget_governor"
	S.name = "Gaze Behaviour Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gaze.variant_registry" }
	S.tags = { "j", "gaze", "budgeter", "character" }
	S.description = "Gaze Behaviour Budget Governor: per-character cost allocation in a crowd for the Gaze Behaviour subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.gaze.budget_governor", total = 270, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
