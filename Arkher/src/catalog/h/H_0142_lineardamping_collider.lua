-- ARKHER SYSTEM H.0142 :: Linear Damping Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0142"
	S.key = "arkher.physics.lineardamping.collision_shape"
	S.name = "Linear Damping Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.lineardamping.body_dynamics" }
	S.tags = { "h", "lineardamping", "collider", "physics" }
	S.description = "Linear Damping Collision Shape: shape bounds, support mapping and closest points for the Linear Damping subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.lineardamping.collision_shape", shape = "box", radius = 1.10, height = 1.90, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
