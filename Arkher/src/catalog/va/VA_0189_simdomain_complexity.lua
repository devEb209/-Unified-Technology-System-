-- ARKHER SYSTEM VA.0189 :: Simulation Domain Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0189"
	S.key = "arkher.contworld.simdomain.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.simdomain.world_memory_stream" }
	S.tags = { "va", "simdomain", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.simdomain.complexity_budget", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
