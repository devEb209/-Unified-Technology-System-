-- ARKHER SYSTEM N.0145 :: Rain Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0145"
	S.key = "arkher.vfx.rain.particle_simulation"
	S.name = "Rain Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Rain"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.rain.emission" }
	S.tags = { "n", "rain", "particles", "vfx" }
	S.description = "Rain Particle Simulation: pooled integration of position, velocity, colour and life for the Rain subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.rain.particle_simulation", capacity = 448, drag = 0.14, bounce = 0.19, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
