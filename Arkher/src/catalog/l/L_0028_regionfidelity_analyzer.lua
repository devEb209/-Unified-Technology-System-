-- ARKHER SYSTEM L.0028 :: Region Fidelity Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0028"
	S.key = "arkher.sim.regionfidelity.analysis"
	S.name = "Region Fidelity Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.regionfidelity.aggregate_cache" }
	S.tags = { "l", "regionfidelity", "analyzer", "sim" }
	S.description = "Region Fidelity Analysis: trend, anomaly and stability analysis of the world for the Region Fidelity subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.regionfidelity.analysis", window = 182, buckets = 10, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
