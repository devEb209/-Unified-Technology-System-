-- ARKHER SYSTEM K.0011 :: NPC Brain Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0011"
	S.key = "arkher.npc.npcbrain.social_relations"
	S.name = "NPC Brain Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcbrain.crowd_steering" }
	S.tags = { "k", "npcbrain", "society", "npc" }
	S.description = "NPC Brain Social Relations: affinity, factions, reputation and gossip for the NPC Brain subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.npcbrain.social_relations", decayRate = 0.012, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
