-- ARKHER SYSTEM VB.0433 :: Physics Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0433"
	S.key = "arkher.conttime.physicscont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "physicscont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.physicscont.infinite_grid", cellSize = 64, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
