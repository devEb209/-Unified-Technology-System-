-- ARKHER SYSTEM V.0076 :: Animation Clip Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0076"
	S.key = "arkher.asset.animationclip.asset_registry"
	S.name = "Animation Clip Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.animationclip.cook_pipeline" }
	S.tags = { "v", "animationclip", "registry", "asset" }
	S.description = "Animation Clip Asset Registry: catalogue of every asset, its tags and its metadata for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.animationclip.asset_registry" })
		inst.system = S
		inst.ctx = ctx
