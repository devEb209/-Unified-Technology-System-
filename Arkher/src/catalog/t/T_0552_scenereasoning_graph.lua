-- ARKHER SYSTEM T.0552 :: Scene Reasoning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0552"
	S.key = "arkher.ai.scenereasoning.reasoning_graph"
	S.name = "Scene Reasoning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.scenereasoning.world_architect" }
	S.tags = { "t", "scenereasoning", "graph", "ai" }
	S.description = "Scene Reasoning Reasoning Graph: relationship modelling and shortest-path reasoning for the Scene Reasoning subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.scenereasoning.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
