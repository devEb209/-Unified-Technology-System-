-- ARKHER SYSTEM O.0152 :: Water Audio Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0152"
	S.key = "arkher.audio.wateraudio.compression_codec"
	S.name = "Water Audio Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Water Audio"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.wateraudio.asset_registry" }
	S.tags = { "o", "wateraudio", "codec", "audio" }
	S.description = "Water Audio Compression Codec: payload encoding of audio state and events for the Water Audio subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.wateraudio.compression_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
