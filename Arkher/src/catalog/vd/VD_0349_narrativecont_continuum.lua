-- ARKHER SYSTEM VD.0349 :: Narrative Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0349"
	S.key = "arkher.contsim.narrativecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "narrativecont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.narrativecont.infinite_grid", cellSize = 128, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
