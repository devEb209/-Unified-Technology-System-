-- ARKHER SYSTEM H.0698 :: Overlap Query Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0698"
	S.key = "arkher.physics.overlap.analysis"
	S.name = "Overlap Query Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.overlap.result_cache" }
	S.tags = { "h", "overlap", "analyzer", "physics" }
	S.description = "Overlap Query Analysis: energy, jitter and cost analysis of the simulation for the Overlap Query subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.overlap.analysis", window = 131, buckets = 19, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
