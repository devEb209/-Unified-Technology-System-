-- ARKHER SYSTEM Q.0297 :: Gesture Accessibility Policy
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0297"
	S.key = "arkher.ui.gesture.accessibility_policy"
	S.name = "Gesture Accessibility Policy"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Gesture"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.gesture.interaction_ledger" }
	S.tags = { "q", "gesture", "policy", "ui" }
	S.description = "Gesture Accessibility Policy: rules enforcing contrast, target size and motion limits for the Gesture subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ui.gesture.accessibility_policy", algorithm = "edf", starvationGuard = 57 })
		inst.system = S
		inst.ctx = ctx
