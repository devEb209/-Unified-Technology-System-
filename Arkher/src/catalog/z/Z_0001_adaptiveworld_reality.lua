-- ARKHER SYSTEM Z.0001 :: Adaptive World Intelligence Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0001"
	S.key = "arkher.origin.adaptiveworld.reality_layering"
	S.name = "Adaptive World Intelligence Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "adaptiveworld", "reality", "origin" }
	S.description = "Adaptive World Intelligence Reality Layering: stacked authored, simulated, proposed and player realities for the Adaptive World Intelligence subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.adaptiveworld.reality_layering" })
		inst.system = S
		inst.ctx = ctx
