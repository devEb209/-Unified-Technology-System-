-- ARKHER SYSTEM V.0272 :: Lightmap Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0272"
	S.key = "arkher.asset.lightmap.compression_codec"
	S.name = "Lightmap Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lightmap.streaming_residency" }
	S.tags = { "v", "lightmap", "codec", "asset" }
	S.description = "Lightmap Compression Codec: compact encoding, diffing and checksum of asset payloads for the Lightmap subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.lightmap.compression_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
