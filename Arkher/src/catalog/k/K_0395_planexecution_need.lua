-- ARKHER SYSTEM K.0395 :: Plan Execution Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0395"
	S.key = "arkher.npc.planexecution.drive_system"
	S.name = "Plan Execution Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.planexecution.memory" }
	S.tags = { "k", "planexecution", "need", "npc" }
	S.description = "Plan Execution Drive System: drives that decay, turn urgent and get satisfied for the Plan Execution subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.planexecution.drive_system" })
		inst.system = S
		inst.ctx = ctx
