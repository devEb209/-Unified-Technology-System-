-- ARKHER SYSTEM Z.0129 :: Dynamic Complexity Manager Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0129"
	S.key = "arkher.origin.complexitymanager.intent_bridge"
	S.name = "Dynamic Complexity Manager Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.semantic_graph" }
	S.tags = { "z", "complexitymanager", "intent", "origin" }
	S.description = "Dynamic Complexity Manager Intent Bridge: natural language control surface for the technology for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.complexitymanager.intent_bridge", minConfidence = 0.41 })
		inst.system = S
		inst.ctx = ctx
