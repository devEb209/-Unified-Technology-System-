-- ARKHER SYSTEM VC.0593 :: Horizon Span Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0593"
	S.key = "arkher.contneural.horizonspan.persistent_state"
	S.name = "Horizon Span Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.horizonspan.multi-scale_fidelity" }
	S.tags = { "vc", "horizonspan", "persistent", "contneural" }
	S.description = "Horizon Span Persistent State: epoch-stamped persistent history and rollback for the Horizon Span subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.horizonspan.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
