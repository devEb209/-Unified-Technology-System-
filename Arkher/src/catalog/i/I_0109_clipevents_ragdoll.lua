-- ARKHER SYSTEM I.0109 :: Clip Events Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0109"
	S.key = "arkher.anim.clipevents.physical_blend"
	S.name = "Clip Events Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Events"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clipevents.inverse_kinematics" }
	S.tags = { "i", "clipevents", "ragdoll", "anim" }
	S.description = "Clip Events Physical Blend: physical bones blended against the animated pose for the Clip Events subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.clipevents.physical_blend", blendSpeed = 4.00 })
		inst.system = S
		inst.ctx = ctx
