-- ARKHER SYSTEM F.0363 :: Temporal Accumulation Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0363"
	S.key = "arkher.render.temporalaccum.orchestration"
	S.name = "Temporal Accumulation Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.temporalaccum.frame_analysis" }
	S.tags = { "f", "temporalaccum", "orchestrator", "render" }
	S.description = "Temporal Accumulation Orchestration: frame lifecycle orchestration for the Temporal Accumulation subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.temporalaccum.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
