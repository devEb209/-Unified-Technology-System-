-- ARKHER SYSTEM E.0126 :: Emissive Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0126"
	S.key = "arkher.material.emissive.variant_registry"
	S.name = "Emissive Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Emissive"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.emissive.procedural_detail" }
	S.tags = { "e", "emissive", "registry", "material" }
	S.description = "Emissive Variant Registry: named variants and their lifecycle for the Emissive subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.emissive.variant_registry" })
		inst.system = S
		inst.ctx = ctx
