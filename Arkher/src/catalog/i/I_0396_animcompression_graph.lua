-- ARKHER SYSTEM I.0396 :: Animation Compression Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0396"
	S.key = "arkher.anim.animcompression.retarget_graph"
	S.name = "Animation Compression Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animcompression.physical_blend" }
	S.tags = { "i", "animcompression", "graph", "anim" }
	S.description = "Animation Compression Retarget Graph: bone mapping and retarget path resolution for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.animcompression.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
