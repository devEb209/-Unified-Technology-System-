-- ARKHER SYSTEM K.0533 :: Dialogue Behaviour Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0533"
	S.key = "arkher.npc.dialoguebehaviour.mind_network"
	S.name = "Dialogue Behaviour Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "dialoguebehaviour", "mindnet", "npc" }
	S.description = "Dialogue Behaviour Mind Network: the learned policy that turns perception into a decision for the Dialogue Behaviour subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.dialoguebehaviour.mind_network", inputs = 7, hidden = 4, seed = 20345, learningRate = 0.075, exploration = 0.025 })
		inst.system = S
		inst.ctx = ctx
