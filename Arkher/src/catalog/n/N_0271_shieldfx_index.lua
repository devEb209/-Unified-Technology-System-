-- ARKHER SYSTEM N.0271 :: Shield Effect Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0271"
	S.key = "arkher.vfx.shieldfx.spatial_index"
	S.name = "Shield Effect Spatial Index"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.shieldfx.quality_policy" }
	S.tags = { "n", "shieldfx", "index", "vfx" }
	S.description = "Shield Effect Spatial Index: spatial acceleration of effect queries and culling for the Shield Effect subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.shieldfx.spatial_index", mode = "hash", cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
