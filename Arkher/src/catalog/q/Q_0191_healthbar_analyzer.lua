-- ARKHER SYSTEM Q.0191 :: Health Bar Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0191"
	S.key = "arkher.ui.healthbar.usability_analysis"
	S.name = "Health Bar Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Health Bar"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.healthbar.frame_budget" }
	S.tags = { "q", "healthbar", "analyzer", "ui" }
	S.description = "Health Bar Usability Analysis: reachability, latency and abandonment analysis for the Health Bar subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.healthbar.usability_analysis", window = 176, buckets = 8, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
