-- ARKHER SYSTEM L.0422 :: Law Ecology
...
return function(A)
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.law.simulation_core" }
	S.tags = { "l", "law", "ecology", "sim" }
	S.description = "Law Ecology: populations, predation, harvesting and carrying capacity for the Law subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.law.ecology" })
		inst.system = S
		inst.ctx = ctx
