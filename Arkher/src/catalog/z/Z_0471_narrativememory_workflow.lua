-- ARKHER SYSTEM Z.0471 :: Narrative Memory Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0471"
	S.key = "arkher.origin.narrativememory.adaptive_workflow"
	S.name = "Narrative Memory Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.self_critique" }
	S.tags = { "z", "narrativememory", "workflow", "origin" }
	S.description = "Narrative Memory Adaptive Workflow: verified, retryable, reversible execution plans for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.narrativememory.adaptive_workflow", maxRetries = 2, budget = 80 })
		inst.system = S
		inst.ctx = ctx
