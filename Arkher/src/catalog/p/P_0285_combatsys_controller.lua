-- ARKHER SYSTEM P.0285 :: Combat Difficulty Controller
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0285"
	S.key = "arkher.play.combatsys.difficulty_controller"
	S.name = "Combat Difficulty Controller"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Combat"
	...
	S.kit = "controller"
	S.version = "1.0.0"
	S.deps = { "arkher.play.combatsys.balance_analysis" }
	S.tags = { "p", "combatsys", "controller", "play" }
	S.description = "Combat Difficulty Controller: closed-loop tuning toward a target challenge for the Combat subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("controller", { id = "arkher.play.combatsys.difficulty_controller", mode = "hysteresis", target = 0.590, kp = 0.440, ki = 0.090, kd = 0.050, min = 0.05, max = 1.0, initial = 0.49, deadband = 0.01 })
		inst.system = S
		inst.ctx = ctx
