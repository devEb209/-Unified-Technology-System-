-- ARKHER SYSTEM Z.0039 :: Predictive Optimization Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0039"
	S.key = "arkher.origin.predictiveopt.residency_streaming"
	S.name = "Predictive Optimization Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.budget_governor" }
	S.tags = { "z", "predictiveopt", "streamer", "origin" }
	S.description = "Predictive Optimization Residency Streaming: distance-driven residency of the technology's workload for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.predictiveopt.residency_streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
