-- ARKHER SYSTEM VC.0621 :: Occupancy Map Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0621"
	S.key = "arkher.contneural.occupancymap.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.occupancymap.world_memory_stream" }
	S.tags = { "vc", "occupancymap", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.occupancymap.complexity_budget", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
