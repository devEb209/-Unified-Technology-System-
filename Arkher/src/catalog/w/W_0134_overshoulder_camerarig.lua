-- ARKHER SYSTEM W.0134 :: Over The Shoulder Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0134"
	S.key = "arkher.cine.overshoulder.camera_rig"
	S.name = "Over The Shoulder Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.overshoulder.sequence_timeline" }
	S.tags = { "w", "overshoulder", "camerarig", "cine" }
	S.description = "Over The Shoulder Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Over The Shoulder subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.overshoulder.camera_rig", fov = 1.40, focus = 14.0, aperture = 2.4, smoothing = 12.0, distance = 16, height = 4 })
		inst.system = S
		inst.ctx = ctx
