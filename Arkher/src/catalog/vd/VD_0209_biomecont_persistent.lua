-- ARKHER SYSTEM VD.0209 :: Biome Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0209"
	S.key = "arkher.contsim.biomecont.persistent_state"
	S.name = "Biome Continuum Persistent State"
	S.category = "VD"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.biomecont.multi-scale_fidelity" }
	S.tags = { "vd", "biomecont", "persistent", "contsim" }
	S.description = "Biome Continuum Persistent State: epoch-stamped persistent history and rollback for the Biome Continuum subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.biomecont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
