-- ARKHER SYSTEM Q.0195 :: Minimap Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0195"
	S.key = "arkher.ui.minimap.input_mapping"
	S.name = "Minimap Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Minimap"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.minimap.widget_tree" }
	S.tags = { "q", "minimap", "inputmap", "ui" }
	S.description = "Minimap Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Minimap subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.minimap.input_mapping", device = "keyboard", holdTime = 0.31, deadzone = 0.21 })
		inst.system = S
		inst.ctx = ctx
