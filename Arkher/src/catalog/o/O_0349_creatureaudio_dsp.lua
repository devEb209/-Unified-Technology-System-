-- ARKHER SYSTEM O.0349 :: Creature Audio DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0349"
	S.key = "arkher.audio.creatureaudio.dsp_chain"
	S.name = "Creature Audio DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "creatureaudio", "dsp", "audio" }
	S.description = "Creature Audio DSP Chain: biquad filtering, delay, envelope and soft clipping for the Creature Audio subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.creatureaudio.dsp_chain", sampleRate = 22050, filter = "lowpass", cutoff = 300, q = 0.500 })
		inst.system = S
		inst.ctx = ctx
