-- ARKHER SYSTEM J.0326 :: Character Debug Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0326"
	S.key = "arkher.character.characterdebug.appearance_composer"
	S.name = "Character Debug Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterdebug.locomotion" }
	S.tags = { "j", "characterdebug", "composer", "character" }
	S.description = "Character Debug Appearance Composer: composition of appearance slots into a look for the Character Debug subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.characterdebug.appearance_composer", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
