-- ARKHER SYSTEM K.0327 :: Curiosity Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0327"
	S.key = "arkher.npc.curiosity.perception"
	S.name = "Curiosity Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.curiosity.emotion" }
	S.tags = { "k", "curiosity", "perception", "npc" }
	S.description = "Curiosity Perception: sight, hearing and bounded attention for the Curiosity subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.curiosity.perception", sightRange = 45, hearingRange = 20, attentionSlots = 3, fov = 1.880 })
		inst.system = S
		inst.ctx = ctx
