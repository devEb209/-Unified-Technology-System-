-- ARKHER SYSTEM G.0299 :: Model Registry Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0299"
	S.key = "arkher.neural.modelregistry.model_registry"
	S.name = "Model Registry Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelregistry.reconstruction" }
	S.tags = { "g", "modelregistry", "registry", "neural" }
	S.description = "Model Registry Model Registry: named models and their lifecycle for the Model Registry subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.modelregistry.model_registry" })
		inst.system = S
		inst.ctx = ctx
