-- ARKHER SYSTEM J.0223 :: Character Variant Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0223"
	S.key = "arkher.character.charvariant.blend_controller"
	S.name = "Character Variant Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.charvariant.motion_set" }
	S.tags = { "j", "charvariant", "animator", "character" }
	S.description = "Character Variant Blend Controller: layered playback driving the character for the Character Variant subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.charvariant.blend_controller", budget = 4 })
		inst.system = S
		inst.ctx = ctx
