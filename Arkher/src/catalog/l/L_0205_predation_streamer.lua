-- ARKHER SYSTEM L.0205 :: Predation Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0205"
	S.key = "arkher.sim.predation.streaming"
	S.name = "Predation Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.predation.state_codec" }
	S.tags = { "l", "predation", "streamer", "sim" }
	S.description = "Predation Streaming: distance-driven residency of simulated regions for the Predation subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.predation.streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
