-- ARKHER SYSTEM G.0225 :: Animation Compression Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0225"
	S.key = "arkher.neural.animcompress.inference_core"
	S.name = "Animation Compression Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "animcompress", "inference", "neural" }
	S.description = "Animation Compression Inference Core: dense network forward pass and training for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.animcompress.inference_core", seed = 8186 })
		inst.system = S
		inst.ctx = ctx
