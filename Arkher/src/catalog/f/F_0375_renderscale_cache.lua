-- ARKHER SYSTEM F.0375 :: Render Scale Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0375"
	S.key = "arkher.render.renderscale.pass_cache"
	S.name = "Render Scale Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Render Scale"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.renderscale.render_policy" }
	S.tags = { "f", "renderscale", "cache", "render" }
	S.description = "Render Scale Pass Cache: reuse of pass results across frames for the Render Scale subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.renderscale.pass_cache", policy = "lru", capacity = 103, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
