-- ARKHER SYSTEM O.0199 :: Reverb Zone Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0199"
	S.key = "arkher.audio.reverbzone.asset_registry"
	S.name = "Reverb Zone Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Reverb Zone"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.reverbzone.streaming" }
	S.tags = { "o", "reverbzone", "registry", "audio" }
	S.description = "Reverb Zone Asset Registry: catalogue of sounds, variations and metadata for the Reverb Zone subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.reverbzone.asset_registry" })
		inst.system = S
		inst.ctx = ctx
