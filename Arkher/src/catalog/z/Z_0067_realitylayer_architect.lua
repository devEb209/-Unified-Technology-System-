-- ARKHER SYSTEM Z.0067 :: Reality Layer World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0067"
	S.key = "arkher.origin.realitylayer.world_architect"
	S.name = "Reality Layer World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.emergence_detection" }
	S.tags = { "z", "realitylayer", "architect", "origin" }
	S.description = "Reality Layer World Architect: hierarchical world composition with conserved budgets for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.realitylayer.world_architect", budget = 1300, seed = 21357 })
		inst.system = S
		inst.ctx = ctx
