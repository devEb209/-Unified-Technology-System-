-- ARKHER SYSTEM Z.0865 :: Multi Scale Simulation World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0865"
	S.key = "arkher.origin.multiscale.world_memory"
	S.name = "Multi Scale Simulation World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.autonomous_pipeline" }
	S.tags = { "z", "multiscale", "worldmemory", "origin" }
	S.description = "Multi Scale Simulation World Memory: epoch-stamped persistent history with compaction and checkpoints for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.multiscale.world_memory", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
