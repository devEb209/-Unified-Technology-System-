-- ARKHER SYSTEM K.0343 :: Behaviour Tree Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0343"
	S.key = "arkher.npc.behaviourtree.utility_reasoning"
	S.name = "Behaviour Tree Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourtree.reactive_behaviour" }
	S.tags = { "k", "behaviourtree", "utility", "npc" }
	S.description = "Behaviour Tree Utility Reasoning: scored option selection with response curves for the Behaviour Tree subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.behaviourtree.utility_reasoning", momentum = 0.17 })
		inst.system = S
		inst.ctx = ctx
