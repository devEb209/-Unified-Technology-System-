-- ARKHER SYSTEM VC.0181 :: Simulation Domain Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0181"
	S.key = "arkher.contneural.simdomain.infinite_grid"
	S.name = "Simulation Domain Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "simdomain", "continuum", "contneural" }
	S.description = "Simulation Domain Infinite Grid: seamless paging of the infinite world grid for the Simulation Domain subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.simdomain.infinite_grid", cellSize = 64, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
