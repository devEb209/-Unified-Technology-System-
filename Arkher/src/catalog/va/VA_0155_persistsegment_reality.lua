-- ARKHER SYSTEM VA.0155 :: Persistence Segment Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0155"
	S.key = "arkher.contworld.persistsegment.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.persistsegment.simulation_fabric" }
	S.tags = { "va", "persistsegment", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.persistsegment.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
