-- ARKHER SYSTEM Q.0316 :: Gamepad Focus Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0316"
	S.key = "arkher.ui.gamepadfocus.transition"
	S.name = "Gamepad Focus Transition"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.gamepadfocus.input_mapping" }
	S.tags = { "q", "gamepadfocus", "tween", "ui" }
	S.description = "Gamepad Focus Transition: eased, delayed, looped and sequenced motion for the Gamepad Focus subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.gamepadfocus.transition", timeScale = 0.93 })
		inst.system = S
		inst.ctx = ctx
