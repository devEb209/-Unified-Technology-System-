-- ARKHER SYSTEM R.0328 :: Matchmaking Transport Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0328"
	S.key = "arkher.net.matchmakingtransport.transport_graph"
	S.name = "Matchmaking Transport Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.matchmakingtransport.prediction_and_reconciliation" }
	S.tags = { "r", "matchmakingtransport", "network", "net" }
	S.description = "Matchmaking Transport Transport Graph: topology, capacity and routing between endpoints for the Matchmaking Transport subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.matchmakingtransport.transport_graph" })
		inst.system = S
		inst.ctx = ctx
