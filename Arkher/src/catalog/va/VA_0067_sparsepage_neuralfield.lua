-- ARKHER SYSTEM VA.0067 :: Sparse Page Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0067"
	S.key = "arkher.contworld.sparsepage.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.sparsepage.coherence_guard" }
	S.tags = { "va", "sparsepage", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.sparsepage.neural_field", dims = 20, hidden = 16, seed = 81990 })
		inst.system = S
		inst.ctx = ctx
