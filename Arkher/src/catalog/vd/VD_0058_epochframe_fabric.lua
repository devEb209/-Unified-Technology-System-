-- ARKHER SYSTEM VD.0058 :: Epoch Frame Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0058"
	S.key = "arkher.contsim.epochframe.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.epochframe.complexity_budget" }
	S.tags = { "vd", "epochframe", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.epochframe.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
