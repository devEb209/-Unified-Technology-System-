-- ARKHER SYSTEM L.0362 :: Trade Route Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0362"
	S.key = "arkher.sim.traderoute.ecology"
	S.name = "Trade Route Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.traderoute.simulation_core" }
	S.tags = { "l", "traderoute", "ecology", "sim" }
	S.description = "Trade Route Ecology: populations, predation, harvesting and carrying capacity for the Trade Route subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.traderoute.ecology" })
		inst.system = S
		inst.ctx = ctx
