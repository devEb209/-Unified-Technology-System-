-- ARKHER SYSTEM V.0327 :: Bundle Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0327"
	S.key = "arkher.asset.bundle.cook_pipeline"
	S.name = "Bundle Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.bundle.bundling" }
	S.tags = { "v", "bundle", "pipeline", "asset" }
	S.description = "Bundle Cook Pipeline: staged cooking with isolation and retries for the Bundle subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.bundle.cook_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
