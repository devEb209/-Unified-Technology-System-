-- ARKHER SYSTEM VA.0617 :: Occupancy Map Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0617"
	S.key = "arkher.contworld.occupancymap.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.occupancymap.multi-scale_fidelity" }
	S.tags = { "va", "occupancymap", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.occupancymap.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
