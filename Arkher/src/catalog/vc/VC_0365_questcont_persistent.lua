-- ARKHER SYSTEM VC.0365 :: Quest Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0365"
	S.key = "arkher.contneural.questcont.persistent_state"
	S.name = "Quest Continuum Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.questcont.multi-scale_fidelity" }
	S.tags = { "vc", "questcont", "persistent", "contneural" }
	S.description = "Quest Continuum Persistent State: epoch-stamped persistent history and rollback for the Quest Continuum subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.questcont.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
