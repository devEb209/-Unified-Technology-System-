-- ARKHER SYSTEM VA.0363 :: Quest Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0363"
	S.key = "arkher.contworld.questcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.questcont.epoch_clock" }
	S.tags = { "va", "questcont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.questcont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
