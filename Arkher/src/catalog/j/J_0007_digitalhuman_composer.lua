-- ARKHER SYSTEM J.0007 :: Digital Human Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0007"
	S.key = "arkher.character.digitalhuman.appearance_composer"
	S.name = "Digital Human Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.digitalhuman.locomotion" }
	S.tags = { "j", "digitalhuman", "composer", "character" }
	S.description = "Digital Human Appearance Composer: composition of appearance slots into a look for the Digital Human subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.digitalhuman.appearance_composer", mode = "add" })
		inst.system = S
		inst.ctx = ctx
