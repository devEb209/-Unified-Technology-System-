-- ARKHER SYSTEM K.0423 :: Pathfinding Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0423"
	S.key = "arkher.npc.pathfinding.drive_system"
	S.name = "Pathfinding Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.pathfinding.memory" }
	S.tags = { "k", "pathfinding", "need", "npc" }
	S.description = "Pathfinding Drive System: drives that decay, turn urgent and get satisfied for the Pathfinding subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.pathfinding.drive_system" })
		inst.system = S
		inst.ctx = ctx
