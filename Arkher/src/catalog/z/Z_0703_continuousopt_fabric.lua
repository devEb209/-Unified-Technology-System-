-- ARKHER SYSTEM Z.0703 :: Continuous Self Optimization Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0703"
	S.key = "arkher.origin.continuousopt.simulation_fabric"
	S.name = "Continuous Self Optimization Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.complexity_governance" }
	S.tags = { "z", "continuousopt", "fabric", "origin" }
	S.description = "Continuous Self Optimization Simulation Fabric: every simulation domain stepped under one budgeted clock for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.continuousopt.simulation_fabric", budgetMs = 3.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
