-- ARKHER SYSTEM T.0505 :: Render Reasoning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0505"
	S.key = "arkher.ai.renderreasoning.intent_understanding"
	S.name = "Render Reasoning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "renderreasoning", "intent", "ai" }
	S.description = "Render Reasoning Intent Understanding: natural language turned into an actionable, scored intent for the Render Reasoning subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.renderreasoning.intent_understanding", minConfidence = 0.31 })
		inst.system = S
		inst.ctx = ctx
