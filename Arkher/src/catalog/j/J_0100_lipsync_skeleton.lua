-- ARKHER SYSTEM J.0100 :: Lip Sync Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0100"
	S.key = "arkher.character.lipsync.rig_definition"
	S.name = "Lip Sync Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "lipsync", "skeleton", "character" }
	S.description = "Lip Sync Rig Definition: character rig definition and bone budget for the Lip Sync subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.lipsync.rig_definition" })
		inst.system = S
		inst.ctx = ctx
