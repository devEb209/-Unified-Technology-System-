-- ARKHER SYSTEM E.0116 :: Ambient Occlusion Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0116"
	S.key = "arkher.material.ao.instance_cache"
	S.name = "Ambient Occlusion Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.ao.quality_policy" }
	S.tags = { "e", "ao", "cache", "material" }
	S.description = "Ambient Occlusion Instance Cache: resolved-parameter cache keyed by context for the Ambient Occlusion subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.ao.instance_cache", policy = "lru", capacity = 105, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
