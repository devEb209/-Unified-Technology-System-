-- ARKHER SYSTEM P.0220 :: Currency Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0220"
	S.key = "arkher.play.currency.combat_resolution"
	S.name = "Currency Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Currency"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.currency.objectives" }
	S.tags = { "p", "currency", "combat", "play" }
	S.description = "Currency Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Currency subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.currency.combat_resolution", seed = 20602, armourK = 100, critMultiplier = 2.50 })
		inst.system = S
		inst.ctx = ctx
