-- ARKHER SYSTEM H.0620 :: Character Controller Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0620"
	S.key = "arkher.physics.charactercontroller.constraint_solver"
	S.name = "Character Controller Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.charactercontroller.contact_generation" }
	S.tags = { "h", "charactercontroller", "constraint", "physics" }
	S.description = "Character Controller Constraint Solver: sequential impulses, friction, joints and warm starting for the Character Controller subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.charactercontroller.constraint_solver", iterations = 10, baumgarte = 0.16, warmStart = true })
		inst.system = S
		inst.ctx = ctx
