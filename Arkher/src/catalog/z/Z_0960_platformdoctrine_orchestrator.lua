-- ARKHER SYSTEM Z.0960 :: Platform Abstraction Doctrine Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0960"
	S.key = "arkher.origin.platformdoctrine.orchestration"
	S.name = "Platform Abstraction Doctrine Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.platformdoctrine.residency_streaming" }
	S.tags = { "z", "platformdoctrine", "orchestrator", "origin" }
	S.description = "Platform Abstraction Doctrine Orchestration: lifecycle and phase orchestration of the technology for the Platform Abstraction Doctrine subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.platformdoctrine.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
