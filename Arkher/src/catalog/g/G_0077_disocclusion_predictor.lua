-- ARKHER SYSTEM G.0077 :: Disocclusion Handling Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0077"
	S.key = "arkher.neural.disocclusion.quality_predictor"
	S.name = "Disocclusion Handling Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.disocclusion.weight_codec" }
	S.tags = { "g", "disocclusion", "predictor", "neural" }
	S.description = "Disocclusion Handling Quality Predictor: predicted quality and cost of a setting for the Disocclusion Handling subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.disocclusion.quality_predictor", method = "linear", alpha = 0.33, window = 39 })
		inst.system = S
		inst.ctx = ctx
