-- ARKHER SYSTEM VB.0223 :: Terrain Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0223"
	S.key = "arkher.conttime.terraincont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.terraincont.coherence_guard" }
	S.tags = { "vb", "terraincont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.terraincont.neural_field", dims = 24, hidden = 20, seed = 23711 })
		inst.system = S
		inst.ctx = ctx
