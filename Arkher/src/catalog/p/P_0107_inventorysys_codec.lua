-- ARKHER SYSTEM P.0107 :: Inventory Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0107"
	S.key = "arkher.play.inventorysys.save_codec"
	S.name = "Inventory Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Inventory"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.inventorysys.content_registry" }
	S.tags = { "p", "inventorysys", "codec", "play" }
	S.description = "Inventory Save Codec: persistence, diffing and checksum of gameplay state for the Inventory subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.inventorysys.save_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
