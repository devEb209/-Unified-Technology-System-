-- ARKHER SYSTEM VC.0249 :: Vegetation Field Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0249"
	S.key = "arkher.contneural.vegfield.complexity_budget"
	S.name = "Vegetation Field Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vegfield.world_memory_stream" }
	S.tags = { "vc", "vegfield", "complexity", "contneural" }
	S.description = "Vegetation Field Complexity Budget: complexity budgeting for the continuum for the Vegetation Field subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.vegfield.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
