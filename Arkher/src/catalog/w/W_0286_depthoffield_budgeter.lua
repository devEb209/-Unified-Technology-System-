-- ARKHER SYSTEM W.0286 :: Depth Of Field Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0286"
	S.key = "arkher.cine.depthoffield.frame_budget"
	S.name = "Depth Of Field Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.depthoffield.event_ledger" }
	S.tags = { "w", "depthoffield", "budgeter", "cine" }
	S.description = "Depth Of Field Frame Budget: per-frame cost budget for the cinematic systems for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.depthoffield.frame_budget", total = 205, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
