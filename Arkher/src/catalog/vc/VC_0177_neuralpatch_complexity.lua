-- ARKHER SYSTEM VC.0177 :: Neural Patch Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0177"
	S.key = "arkher.contneural.neuralpatch.complexity_budget"
	S.name = "Neural Patch Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.neuralpatch.world_memory_stream" }
	S.tags = { "vc", "neuralpatch", "complexity", "contneural" }
	S.description = "Neural Patch Complexity Budget: complexity budgeting for the continuum for the Neural Patch subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.neuralpatch.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
