-- ARKHER SYSTEM Z.0595 :: Self Healing Systems Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0595"
	S.key = "arkher.origin.selfhealing.signal_composition"
	S.name = "Self Healing Systems Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfhealing.telemetry_ledger" }
	S.tags = { "z", "selfhealing", "composer", "origin" }
	S.description = "Self Healing Systems Signal Composition: blending of the technology's input signals into one output for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.selfhealing.signal_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
