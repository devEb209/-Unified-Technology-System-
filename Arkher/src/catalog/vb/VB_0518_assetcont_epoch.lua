-- ARKHER SYSTEM VB.0518 :: Asset Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0518"
	S.key = "arkher.conttime.assetcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.assetcont.infinite_grid" }
	S.tags = { "vb", "assetcont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.assetcont.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
