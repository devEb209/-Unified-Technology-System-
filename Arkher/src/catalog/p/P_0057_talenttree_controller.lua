-- ARKHER SYSTEM P.0057 :: Talent Tree Difficulty Controller
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0057"
	S.key = "arkher.play.talenttree.difficulty_controller"
	S.name = "Talent Tree Difficulty Controller"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Talent Tree"
	...
	S.kit = "controller"
	S.version = "1.0.0"
	S.deps = { "arkher.play.talenttree.balance_analysis" }
	S.tags = { "p", "talenttree", "controller", "play" }
	S.description = "Talent Tree Difficulty Controller: closed-loop tuning toward a target challenge for the Talent Tree subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("controller", { id = "arkher.play.talenttree.difficulty_controller", mode = "pid", target = 0.600, kp = 0.350, ki = 0.090, kd = 0.010, min = 0.05, max = 1.0, initial = 0.50, deadband = 0.01 })
		inst.system = S
		inst.ctx = ctx
