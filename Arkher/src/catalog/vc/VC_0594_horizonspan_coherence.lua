-- ARKHER SYSTEM VC.0594 :: Horizon Span Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0594"
	S.key = "arkher.contneural.horizonspan.coherence_guard"
	S.name = "Horizon Span Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.horizonspan.persistent_state" }
	S.tags = { "vc", "horizonspan", "coherence", "contneural" }
	S.description = "Horizon Span Coherence Guard: seam coherence and drift supervision for the Horizon Span subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.horizonspan.coherence_guard", window = 80, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
