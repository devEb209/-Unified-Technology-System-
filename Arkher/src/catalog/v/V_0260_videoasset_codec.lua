-- ARKHER SYSTEM V.0260 :: Video Asset Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0260"
	S.key = "arkher.asset.videoasset.compression_codec"
	S.name = "Video Asset Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.videoasset.streaming_residency" }
	S.tags = { "v", "videoasset", "codec", "asset" }
	S.description = "Video Asset Compression Codec: compact encoding, diffing and checksum of asset payloads for the Video Asset subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.videoasset.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
