-- ARKHER SYSTEM P.0054 :: Talent Tree Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0054"
	S.key = "arkher.play.talenttree.rule_pipeline"
	S.name = "Talent Tree Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Talent Tree"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.talenttree.state_machine" }
	S.tags = { "p", "talenttree", "pipeline", "play" }
	S.description = "Talent Tree Rule Pipeline: ordered rules applied to every gameplay event for the Talent Tree subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.talenttree.rule_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
