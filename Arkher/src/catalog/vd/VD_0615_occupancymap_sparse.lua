-- ARKHER SYSTEM VD.0615 :: Occupancy Map Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0615"
	S.key = "arkher.contsim.occupancymap.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.occupancymap.epoch_clock" }
	S.tags = { "vd", "occupancymap", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.occupancymap.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
