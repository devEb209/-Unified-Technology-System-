-- ARKHER SYSTEM O.0402 :: Mobile Audio Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0402"
	S.key = "arkher.audio.mobileaudio.streaming"
	S.name = "Mobile Audio Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mobile Audio"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mobileaudio.voice_budget" }
	S.tags = { "o", "mobileaudio", "streamer", "audio" }
	S.description = "Mobile Audio Streaming: distance-driven residency of audio assets for the Mobile Audio subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.mobileaudio.streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
