-- ARKHER SYSTEM E.0459 :: Procedural Texture Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0459"
	S.key = "arkher.material.proctex.compression_codec"
	S.name = "Procedural Texture Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.proctex.streaming" }
	S.tags = { "e", "proctex", "codec", "material" }
	S.description = "Procedural Texture Compression Codec: serialization and compression of material data for the Procedural Texture subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.proctex.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
