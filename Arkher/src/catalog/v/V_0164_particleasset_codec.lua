-- ARKHER SYSTEM V.0164 :: Particle Asset Compression Codec
...
-- Kit: codec (compact encoding, diffing and checksum of asset payloads)
--@arkher-module
return function(A)
	...
	local S = {}
	S.id = "V.0164"
	S.key = "arkher.asset.particleasset.compression_codec"
	S.name = "Particle Asset Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.particleasset.streaming_residency" }
	S.tags = { "v", "particleasset", "codec", "asset" }
	S.description = "Particle Asset Compression Codec: compact encoding, diffing and checksum of asset payloads for the Particle Asset subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.particleasset.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
