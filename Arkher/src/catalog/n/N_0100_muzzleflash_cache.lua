-- ARKHER SYSTEM N.0100 :: Muzzle Flash Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0100"
	S.key = "arkher.vfx.muzzleflash.result_cache"
	S.name = "Muzzle Flash Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Muzzle Flash"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.muzzleflash.spawn_budget" }
	S.tags = { "n", "muzzleflash", "cache", "vfx" }
	S.description = "Muzzle Flash Result Cache: reuse of expensive effect evaluations for the Muzzle Flash subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.muzzleflash.result_cache", policy = "lru", capacity = 338, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
