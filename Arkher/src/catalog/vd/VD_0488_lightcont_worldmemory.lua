-- ARKHER SYSTEM VD.0488 :: Lighting Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0488"
	S.key = "arkher.contsim.lightcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lightcont.neural_field" }
	S.tags = { "vd", "lightcont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.lightcont.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
