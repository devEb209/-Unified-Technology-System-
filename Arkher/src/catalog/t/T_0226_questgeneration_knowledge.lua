-- ARKHER SYSTEM T.0226 :: Quest Generation Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0226"
	S.key = "arkher.ai.questgeneration.semantic_knowledge"
	S.name = "Quest Generation Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.questgeneration.intent_understanding" }
	S.tags = { "t", "questgeneration", "knowledge", "ai" }
	S.description = "Quest Generation Semantic Knowledge: typed entities, weighted relations and inferred closure for the Quest Generation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.questgeneration.semantic_knowledge", dims = 32 })
		inst.system = S
		inst.ctx = ctx
