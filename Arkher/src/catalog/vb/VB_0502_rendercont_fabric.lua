-- ARKHER SYSTEM VB.0502 :: Rendering Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0502"
	S.key = "arkher.conttime.rendercont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.rendercont.complexity_budget" }
	S.tags = { "vb", "rendercont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.rendercont.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
