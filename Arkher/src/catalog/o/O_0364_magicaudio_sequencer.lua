-- ARKHER SYSTEM O.0364 :: Magic Audio Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0364"
	S.key = "arkher.audio.magicaudio.music_sequencer"
	S.name = "Magic Audio Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Magic Audio"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.magicaudio.spatialization" }
	S.tags = { "o", "magicaudio", "sequencer", "audio" }
	S.description = "Magic Audio Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Magic Audio subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.magicaudio.music_sequencer", bpm = 90, beatsPerBar = 4, intensity = 0.30 })
		inst.system = S
		inst.ctx = ctx
