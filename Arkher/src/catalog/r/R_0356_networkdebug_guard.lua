-- ARKHER SYSTEM R.0356 :: Network Debug Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0356"
	S.key = "arkher.net.networkdebug.rate_guard"
	S.name = "Network Debug Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.networkdebug.interest_streaming" }
	S.tags = { "r", "networkdebug", "guard", "net" }
	S.description = "Network Debug Rate Guard: token-bucket protection against floods and abuse for the Network Debug subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.networkdebug.rate_guard", algorithm = "token", capacity = 160, refillPerSec = 5, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
