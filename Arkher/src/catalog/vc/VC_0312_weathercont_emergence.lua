-- ARKHER SYSTEM VC.0312 :: Weather Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0312"
	S.key = "arkher.contneural.weathercont.emergence_continuum"
	S.name = "Weather Continuum Emergence Continuum"
	S.category = "VC"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.weathercont.reality_continuum" }
	S.tags = { "vc", "weathercont", "emergence", "contneural" }
	S.description = "Weather Continuum Emergence Continuum: emergence detection over the continuum for the Weather Continuum subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.weathercont.emergence_continuum", windowSize = 7, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
