-- ARKHER SYSTEM VD.0362 :: Quest Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0362"
	S.key = "arkher.contsim.questcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.questcont.infinite_grid" }
	S.tags = { "vd", "questcont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.questcont.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
