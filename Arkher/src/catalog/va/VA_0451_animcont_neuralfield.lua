-- ARKHER SYSTEM VA.0451 :: Animation Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0451"
	S.key = "arkher.contworld.animcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.animcont.coherence_guard" }
	S.tags = { "va", "animcont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.animcont.neural_field", dims = 16, hidden = 12, seed = 54793 })
		inst.system = S
		inst.ctx = ctx
