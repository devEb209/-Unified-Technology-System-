-- ARKHER SYSTEM G.0368 :: Feature Cache Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0368"
	S.key = "arkher.neural.featurecache.reconstruction"
	S.name = "Feature Cache Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.featurecache.temporal_history" }
	S.tags = { "g", "featurecache", "upscaler", "neural" }
	S.description = "Feature Cache Reconstruction: resolution ladder and image reconstruction for the Feature Cache subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.featurecache.reconstruction", targetMs = 16.10, index = 5, sharpness = 0.39 })
		inst.system = S
		inst.ctx = ctx
