-- ARKHER SYSTEM L.0109 :: Settlement Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0109"
	S.key = "arkher.sim.settlement.society"
	S.name = "Settlement Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.settlement.economy" }
	S.tags = { "l", "settlement", "society", "sim" }
	S.description = "Settlement Society: relations, factions, reputation and cohesion of the region for the Settlement subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.settlement.society", decayRate = 0.009, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
