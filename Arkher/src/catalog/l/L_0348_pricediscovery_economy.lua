-- ARKHER SYSTEM L.0348 :: Price Discovery Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0348"
	S.key = "arkher.sim.pricediscovery.economy"
	S.name = "Price Discovery Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.pricediscovery.ecology" }
	S.tags = { "l", "pricediscovery", "economy", "sim" }
	S.description = "Price Discovery Economy: stock, production, demand, price discovery and trade for the Price Discovery subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.pricediscovery.economy", elasticity = 0.18 })
		inst.system = S
		inst.ctx = ctx
