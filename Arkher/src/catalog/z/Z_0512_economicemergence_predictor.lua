-- ARKHER SYSTEM Z.0512 :: Economic Emergence Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0512"
	S.key = "arkher.origin.economicemergence.predictive_optimization"
	S.name = "Economic Emergence Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.economicemergence.adaptive_workflow" }
	S.tags = { "z", "economicemergence", "predictor", "origin" }
	S.description = "Economic Emergence Predictive Optimization: forecast-driven optimization before the cost is paid for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.economicemergence.predictive_optimization", method = "linear", alpha = 0.39, window = 45 })
		inst.system = S
		inst.ctx = ctx
