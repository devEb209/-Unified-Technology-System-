-- ARKHER SYSTEM N.0047 :: Explosion Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0047"
	S.key = "arkher.vfx.explosion.spawn_budget"
	S.name = "Explosion Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Explosion"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.explosion.effect_composition" }
	S.tags = { "n", "explosion", "budgeter", "vfx" }
	S.description = "Explosion Spawn Budget: global particle budget shared by every live effect for the Explosion subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.explosion.spawn_budget", total = 446, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
