-- ARKHER SYSTEM VC.0131 :: Spatial Slice Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0131"
	S.key = "arkher.contneural.spatialslice.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.spatialslice.simulation_fabric" }
	S.tags = { "vc", "spatialslice", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.spatialslice.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
