-- ARKHER SYSTEM VD.0250 :: Vegetation Field Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0250"
	S.key = "arkher.contsim.vegfield.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vegfield.complexity_budget" }
	S.tags = { "vd", "vegfield", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.vegfield.simulation_fabric", budgetMs = 1.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
