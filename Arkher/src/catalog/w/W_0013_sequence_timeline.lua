-- ARKHER SYSTEM W.0013 :: Sequence Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0013"
	S.key = "arkher.cine.sequence.sequence_timeline"
	S.name = "Sequence Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Sequence"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "sequence", "timeline", "cine" }
	S.description = "Sequence Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Sequence subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.sequence.sequence_timeline", duration = 7.0, rate = 1.07 })
		inst.system = S
		inst.ctx = ctx
