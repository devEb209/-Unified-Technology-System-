-- ARKHER SYSTEM V.0421 :: Asset Debug Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0421"
	S.key = "arkher.asset.assetdebug.import"
	S.name = "Asset Debug Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "assetdebug", "importer", "asset" }
	S.description = "Asset Debug Import: validation, normalization, hashing and deduplication of incoming content for the Asset Debug subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.assetdebug.import", unitScale = 1.50 })
		inst.system = S
		inst.ctx = ctx
