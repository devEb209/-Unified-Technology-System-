-- ARKHER SYSTEM VB.0299 :: Climate Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0299"
	S.key = "arkher.conttime.climatecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.climatecont.simulation_fabric" }
	S.tags = { "vb", "climatecont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.climatecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
