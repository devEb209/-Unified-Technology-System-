-- ARKHER SYSTEM E.0356 :: Snow Cover Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0356"
	S.key = "arkher.material.snowcover.instance_cache"
	S.name = "Snow Cover Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Snow Cover"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.snowcover.quality_policy" }
	S.tags = { "e", "snowcover", "cache", "material" }
	S.description = "Snow Cover Instance Cache: resolved-parameter cache keyed by context for the Snow Cover subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.snowcover.instance_cache", policy = "ttl", capacity = 490, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
