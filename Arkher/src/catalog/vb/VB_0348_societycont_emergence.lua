-- ARKHER SYSTEM VB.0348 :: Society Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0348"
	S.key = "arkher.conttime.societycont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.societycont.reality_continuum" }
	S.tags = { "vb", "societycont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.societycont.emergence_continuum", windowSize = 7, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
