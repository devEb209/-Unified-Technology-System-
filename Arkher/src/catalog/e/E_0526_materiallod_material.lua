-- ARKHER SYSTEM E.0526 :: Material LOD Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0526"
	S.key = "arkher.material.materiallod.definition"
	S.name = "Material LOD Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Material LOD"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "materiallod", "material", "material" }
	S.description = "Material LOD Definition: layered PBR definition resolved into parameters for the Material LOD subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.materiallod.definition", texelBudget = 786432 })
		inst.system = S
		inst.ctx = ctx
