-- ARKHER SYSTEM Z.0750 :: World Compression Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0750"
	S.key = "arkher.origin.worldcompression.self_critique"
	S.name = "World Compression Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.intent_bridge" }
	S.tags = { "z", "worldcompression", "critic", "origin" }
	S.description = "World Compression Self Critique: weighted judgement of the technology's own output for the World Compression subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.worldcompression.self_critique", passMark = 0.79, reviseMark = 0.44, seed = 8184 })
		inst.system = S
		inst.ctx = ctx
