-- ARKHER SYSTEM P.0126 :: Loot Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0126"
	S.key = "arkher.play.loot.rule_pipeline"
	S.name = "Loot Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Loot"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.loot.state_machine" }
	S.tags = { "p", "loot", "pipeline", "play" }
	S.description = "Loot Rule Pipeline: ordered rules applied to every gameplay event for the Loot subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.loot.rule_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
