-- ARKHER SYSTEM R.0245 :: Area Of Interest Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0245"
	S.key = "arkher.net.areaofinterest.bandwidth_budget"
	S.name = "Area Of Interest Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.areaofinterest.transport_graph" }
	S.tags = { "r", "areaofinterest", "budgeter", "net" }
	S.description = "Area Of Interest Bandwidth Budget: bytes per second shared between competing streams for the Area Of Interest subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.areaofinterest.bandwidth_budget", total = 296, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
