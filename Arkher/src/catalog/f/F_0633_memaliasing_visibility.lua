-- ARKHER SYSTEM F.0633 :: Memory Aliasing Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0633"
	S.key = "arkher.render.memaliasing.visibility_set"
	S.name = "Memory Aliasing Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.memaliasing.view_and_culling" }
	S.tags = { "f", "memaliasing", "visibility", "render" }
	S.description = "Memory Aliasing Visibility Set: cell, portal and occluder visibility for the Memory Aliasing subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.memaliasing.visibility_set", maxDepth = 4 })
		inst.system = S
		inst.ctx = ctx
