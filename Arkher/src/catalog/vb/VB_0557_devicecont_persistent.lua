-- ARKHER SYSTEM VB.0557 :: Device Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0557"
	S.key = "arkher.conttime.devicecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.devicecont.multi-scale_fidelity" }
	S.tags = { "vb", "devicecont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.devicecont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
