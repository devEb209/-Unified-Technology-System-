-- ARKHER SYSTEM Z.0052 :: Singularity World Architect Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0052"
	S.key = "arkher.origin.worldarchitect.predictive_optimization"
	S.name = "Singularity World Architect Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.adaptive_workflow" }
	S.tags = { "z", "worldarchitect", "predictor", "origin" }
	S.description = "Singularity World Architect Predictive Optimization: forecast-driven optimization before the cost is paid for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.worldarchitect.predictive_optimization", method = "ema", alpha = 0.32, window = 62 })
		inst.system = S
		inst.ctx = ctx
