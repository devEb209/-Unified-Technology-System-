-- ARKHER SYSTEM Z.1049 :: Emergent Quest Generation Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.1049"
	S.key = "arkher.origin.emergentquest.intent_bridge"
	S.name = "Emergent Quest Generation Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentquest.semantic_graph" }
	S.tags = { "z", "emergentquest", "intent", "origin" }
	S.description = "Emergent Quest Generation Intent Bridge: natural language control surface for the technology for the Emergent Quest Generation subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.emergentquest.intent_bridge", minConfidence = 0.42 })
		inst.system = S
		inst.ctx = ctx
