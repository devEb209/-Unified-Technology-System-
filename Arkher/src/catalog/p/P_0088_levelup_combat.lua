-- ARKHER SYSTEM P.0088 :: Level Up Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0088"
	S.key = "arkher.play.levelup.combat_resolution"
	S.name = "Level Up Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Level Up"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.levelup.objectives" }
	S.tags = { "p", "levelup", "combat", "play" }
	S.description = "Level Up Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Level Up subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.levelup.combat_resolution", seed = 94300, armourK = 120, critMultiplier = 1.90 })
		inst.system = S
		inst.ctx = ctx
