-- ARKHER SYSTEM J.0031 :: Body Proportions Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0031"
	S.key = "arkher.character.proportions.budget_governor"
	S.name = "Body Proportions Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.proportions.variant_registry" }
	S.tags = { "j", "proportions", "budgeter", "character" }
	S.description = "Body Proportions Budget Governor: per-character cost allocation in a crowd for the Body Proportions subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.proportions.budget_governor", total = 170, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
