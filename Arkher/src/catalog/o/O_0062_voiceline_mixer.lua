-- ARKHER SYSTEM O.0062 :: Voice Line Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0062"
	S.key = "arkher.audio.voiceline.mixer_bus"
	S.name = "Voice Line Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Voice Line"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.voiceline.dsp_chain" }
	S.tags = { "o", "voiceline", "mixer", "audio" }
	S.description = "Voice Line Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Voice Line subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.voiceline.mixer_bus", maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
