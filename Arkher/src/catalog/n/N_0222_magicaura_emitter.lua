-- ARKHER SYSTEM N.0222 :: Magic Aura Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0222"
	S.key = "arkher.vfx.magicaura.emission"
	S.name = "Magic Aura Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Magic Aura"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "magicaura", "emitter", "vfx" }
	S.description = "Magic Aura Emission: shaped, rate and burst emission of new particles for the Magic Aura subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.magicaura.emission", shape = "point", rate = 23, speed = 3.30, life = 1.10, budget = 320, seed = 66003 })
		inst.system = S
		inst.ctx = ctx
