-- ARKHER SYSTEM Z.1040 :: Autonomous Balancing Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.1040"
	S.key = "arkher.origin.autobalancing.orchestration"
	S.name = "Autonomous Balancing Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autobalancing.residency_streaming" }
	S.tags = { "z", "autobalancing", "orchestrator", "origin" }
	S.description = "Autonomous Balancing Orchestration: lifecycle and phase orchestration of the technology for the Autonomous Balancing subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.autobalancing.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
