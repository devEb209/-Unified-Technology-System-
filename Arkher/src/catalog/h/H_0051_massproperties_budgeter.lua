-- ARKHER SYSTEM H.0051 :: Mass Properties Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0051"
	S.key = "arkher.physics.massproperties.budget_governor"
	S.name = "Mass Properties Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.massproperties.broadphase_index" }
	S.tags = { "h", "massproperties", "budgeter", "physics" }
	S.description = "Mass Properties Budget Governor: simulation time budget allocation across islands for the Mass Properties subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.massproperties.budget_governor", total = 348, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
