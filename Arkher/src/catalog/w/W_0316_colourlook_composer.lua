-- ARKHER SYSTEM W.0316 :: Colour Look Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0316"
	S.key = "arkher.cine.colourlook.shot_composition"
	S.name = "Colour Look Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Colour Look"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.colourlook.colour_grade" }
	S.tags = { "w", "colourlook", "composer", "cine" }
	S.description = "Colour Look Shot Composition: blending of the signals that make up the final shot for the Colour Look subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.colourlook.shot_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
