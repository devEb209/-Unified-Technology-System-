-- ARKHER SYSTEM F.0584 :: Debug Visualization Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0584"
	S.key = "arkher.render.debugvis.render_policy"
	S.name = "Debug Visualization Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.debugvis.draw_budget" }
	S.tags = { "f", "debugvis", "policy", "render" }
	S.description = "Debug Visualization Render Policy: device tier rules for the frame for the Debug Visualization subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.debugvis.render_policy", algorithm = "edf", starvationGuard = 17 })
		inst.system = S
		inst.ctx = ctx
