-- ARKHER SYSTEM F.0019 :: Depth Prepass Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0019"
	S.key = "arkher.render.depthprepass.lighting_rig"
	S.name = "Depth Prepass Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.depthprepass.geometry_virtualization" }
	S.tags = { "f", "depthprepass", "lightrig", "render" }
	S.description = "Depth Prepass Lighting Rig: light clustering, importance and cascades for the Depth Prepass subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.depthprepass.lighting_rig", maxActive = 10 })
		inst.system = S
		inst.ctx = ctx
