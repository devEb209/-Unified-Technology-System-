-- ARKHER SYSTEM VA.0632 :: Interest Field World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0632"
	S.key = "arkher.contworld.interestfield.world_memory_stream"
	S.name = "Interest Field World Memory Stream"
	S.category = "VA"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.interestfield.neural_field" }
	S.tags = { "va", "interestfield", "worldmemory", "contworld" }
	S.description = "Interest Field World Memory Stream: world memory continuum over epochs for the Interest Field subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.interestfield.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
