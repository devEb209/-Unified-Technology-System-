-- ARKHER SYSTEM L.0366 :: Trade Route Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0366"
	S.key = "arkher.sim.traderoute.region_graph"
	S.name = "Trade Route Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.traderoute.calendar" }
	S.tags = { "l", "traderoute", "graph", "sim" }
	S.description = "Trade Route Region Graph: connectivity, components and shortest path between places for the Trade Route subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.traderoute.region_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
