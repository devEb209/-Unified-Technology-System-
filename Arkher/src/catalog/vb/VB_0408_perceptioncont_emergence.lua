-- ARKHER SYSTEM VB.0408 :: Perception Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0408"
	S.key = "arkher.conttime.perceptioncont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.perceptioncont.reality_continuum" }
	S.tags = { "vb", "perceptioncont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.perceptioncont.emergence_continuum", windowSize = 5, threshold = 1.60, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
