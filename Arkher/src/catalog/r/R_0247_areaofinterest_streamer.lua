-- ARKHER SYSTEM R.0247 :: Area Of Interest Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0247"
	S.key = "arkher.net.areaofinterest.interest_streaming"
	S.name = "Area Of Interest Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.areaofinterest.serialization_codec" }
	S.tags = { "r", "areaofinterest", "streamer", "net" }
	S.description = "Area Of Interest Interest Streaming: distance-driven residency of replicated content for the Area Of Interest subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.areaofinterest.interest_streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
