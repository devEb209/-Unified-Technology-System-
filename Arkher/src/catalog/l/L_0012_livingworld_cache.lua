-- ARKHER SYSTEM L.0012 :: Living World Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0012"
	S.key = "arkher.sim.livingworld.aggregate_cache"
	S.name = "Living World Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livingworld.fidelity_policy" }
	S.tags = { "l", "livingworld", "cache", "sim" }
	S.description = "Living World Aggregate Cache: reuse of expensive aggregate computations for the Living World subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.livingworld.aggregate_cache", policy = "lfu", capacity = 115, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
