-- ARKHER SYSTEM K.0450 :: Crowd Flow Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0450"
	S.key = "arkher.npc.crowdflow.memory"
	S.name = "Crowd Flow Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.crowdflow.mind_network" }
	S.tags = { "k", "crowdflow", "memory", "npc" }
	S.description = "Crowd Flow Memory: episodic memory with decay, recall and consolidation for the Crowd Flow subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.crowdflow.memory", capacity = 47, decayRate = 0.045, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
