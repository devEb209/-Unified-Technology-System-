-- ARKHER SYSTEM O.0135 :: Rain Audio Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0135"
	S.key = "arkher.audio.rainaudio.spatialization"
	S.name = "Rain Audio Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Rain Audio"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.rainaudio.mixer_bus" }
	S.tags = { "o", "rainaudio", "spatialaudio", "audio" }
	S.description = "Rain Audio Spatialization: distance attenuation, panning, occlusion and doppler for the Rain Audio subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.rainaudio.spatialization", model = "linear", refDistance = 4, maxDistance = 220, rolloff = 0.87, maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
