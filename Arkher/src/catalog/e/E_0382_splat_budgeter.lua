-- ARKHER SYSTEM E.0382 :: Terrain Splat Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0382"
	S.key = "arkher.material.splat.parameter_budget"
	S.name = "Terrain Splat Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.splat.variant_registry" }
	S.tags = { "e", "splat", "budgeter", "material" }
	S.description = "Terrain Splat Parameter Budget: texel and layer budget allocation for the Terrain Splat subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.splat.parameter_budget", total = 99, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
