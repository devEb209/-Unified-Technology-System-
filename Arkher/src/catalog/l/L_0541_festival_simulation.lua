-- ARKHER SYSTEM L.0541 :: Festival Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0541"
	S.key = "arkher.sim.festival.simulation_core"
	S.name = "Festival Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "festival", "simulation", "sim" }
	S.description = "Festival Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Festival subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.festival.simulation_core", fullRadius = 320, reducedRadius = 1300, budget = 79 })
		inst.system = S
		inst.ctx = ctx
