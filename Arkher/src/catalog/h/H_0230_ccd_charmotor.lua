-- ARKHER SYSTEM H.0230 :: Continuous Detection Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0230"
	S.key = "arkher.physics.ccd.character_motion"
	S.name = "Continuous Detection Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.ccd.query" }
	S.tags = { "h", "ccd", "charmotor", "physics" }
	S.description = "Continuous Detection Character Motion: capsule move-and-slide with slopes, steps and jumps for the Continuous Detection subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.ccd.character_motion", radius = 0.49, height = 1.94, maxSpeed = 7.40, jumpHeight = 2.20, stepOffset = 0.29 })
		inst.system = S
		inst.ctx = ctx
