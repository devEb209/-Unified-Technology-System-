-- ARKHER SYSTEM Z.0346 :: Device Aware Fidelity Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0346"
	S.key = "arkher.origin.deviceaware.emergence_detection"
	S.name = "Device Aware Fidelity Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.world_memory" }
	S.tags = { "z", "deviceaware", "emergence", "origin" }
	S.description = "Device Aware Fidelity Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.deviceaware.emergence_detection", windowSize = 7, threshold = 1.60, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
