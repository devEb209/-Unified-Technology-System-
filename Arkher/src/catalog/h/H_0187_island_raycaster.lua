-- ARKHER SYSTEM H.0187 :: Island Solver Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0187"
	S.key = "arkher.physics.island.query"
	S.name = "Island Solver Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.island.constraint_solver" }
	S.tags = { "h", "island", "raycaster", "physics" }
	S.description = "Island Solver Query: rays, sweeps and overlaps against the simulation for the Island Solver subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.island.query", cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
