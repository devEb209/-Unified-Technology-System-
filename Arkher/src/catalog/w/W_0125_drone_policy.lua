-- ARKHER SYSTEM W.0125 :: Drone Shot Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0125"
	S.key = "arkher.cine.drone.cut_policy"
	S.name = "Drone Shot Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Drone Shot"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.drone.shot_composition" }
	S.tags = { "w", "drone", "policy", "cine" }
	S.description = "Drone Shot Cut Policy: rules deciding when the sequence cuts and to what for the Drone Shot subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.drone.cut_policy", algorithm = "roundrobin", starvationGuard = 24 })
		inst.system = S
		inst.ctx = ctx
