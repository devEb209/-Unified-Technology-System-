-- ARKHER SYSTEM VD.0193 :: Architect District Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0193"
	S.key = "arkher.contsim.architectdistrict.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "architectdistrict", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.architectdistrict.infinite_grid", cellSize = 160, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
