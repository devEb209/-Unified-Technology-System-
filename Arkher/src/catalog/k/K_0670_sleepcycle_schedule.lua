-- ARKHER SYSTEM K.0670 :: Sleep Cycle Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0670"
	S.key = "arkher.npc.sleepcycle.daily_schedule"
	S.name = "Sleep Cycle Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.sleepcycle.social_relations" }
	S.tags = { "k", "sleepcycle", "schedule", "npc" }
	S.description = "Sleep Cycle Daily Schedule: hour-by-hour routine with priority interruptions for the Sleep Cycle subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.sleepcycle.daily_schedule", startHour = 8 })
		inst.system = S
		inst.ctx = ctx
