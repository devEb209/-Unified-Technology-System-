-- ARKHER SYSTEM VD.0329 :: Economy Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0329"
	S.key = "arkher.contsim.economycont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.economycont.multi-scale_fidelity" }
	S.tags = { "vd", "economycont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.economycont.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
