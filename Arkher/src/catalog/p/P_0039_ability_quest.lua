-- ARKHER SYSTEM P.0039 :: Ability Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0039"
	S.key = "arkher.play.ability.objectives"
	S.name = "Ability Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ability"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ability.inventory" }
	S.tags = { "p", "ability", "quest", "play" }
	S.description = "Ability Objectives: objectives, prerequisites, progress and rewards for the Ability subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.ability.objectives" })
		inst.system = S
		inst.ctx = ctx
