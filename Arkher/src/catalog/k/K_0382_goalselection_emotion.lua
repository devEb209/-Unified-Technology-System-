-- ARKHER SYSTEM K.0382 :: Goal Selection Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0382"
	S.key = "arkher.npc.goalselection.emotion"
	S.name = "Goal Selection Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.goalselection.drive_system" }
	S.tags = { "k", "goalselection", "emotion", "npc" }
	S.description = "Goal Selection Emotion: appraisal of events into valence, arousal and mood for the Goal Selection subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.goalselection.emotion", inertia = 0.91, decayRate = 0.36, baselineArousal = 0.26 })
		inst.system = S
		inst.ctx = ctx
