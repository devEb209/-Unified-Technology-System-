-- ARKHER SYSTEM E.0188 :: Anisotropy Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0188"
	S.key = "arkher.material.anisotropy.streaming"
	S.name = "Anisotropy Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Anisotropy"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.anisotropy.parameter_budget" }
	S.tags = { "e", "anisotropy", "streamer", "material" }
	S.description = "Anisotropy Streaming: residency and demand-driven texture streaming for the Anisotropy subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.anisotropy.streaming", radius = 320, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
