-- ARKHER SYSTEM F.0135 :: Global Illumination Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0135"
	S.key = "arkher.render.gi.draw_budget"
	S.name = "Global Illumination Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.gi.adaptive_resolution" }
	S.tags = { "f", "gi", "budgeter", "render" }
	S.description = "Global Illumination Draw Budget: draw call and triangle budget allocation for the Global Illumination subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.gi.draw_budget", total = 445, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
