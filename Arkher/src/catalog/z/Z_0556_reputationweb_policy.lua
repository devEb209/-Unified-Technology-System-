-- ARKHER SYSTEM Z.0556 :: Reputation Web Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0556"
	S.key = "arkher.origin.reputationweb.governance_policy"
	S.name = "Reputation Web Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.signal_composition" }
	S.tags = { "z", "reputationweb", "policy", "origin" }
	S.description = "Reputation Web Governance Policy: ordered rules governing when the technology may act for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.reputationweb.governance_policy", algorithm = "lottery", starvationGuard = 55 })
		inst.system = S
		inst.ctx = ctx
