-- ARKHER SYSTEM J.0243 :: Aging Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0243"
	S.key = "arkher.character.aging.rig_definition"
	S.name = "Aging Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "aging", "skeleton", "character" }
	S.description = "Aging Rig Definition: character rig definition and bone budget for the Aging subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.aging.rig_definition" })
		inst.system = S
		inst.ctx = ctx
