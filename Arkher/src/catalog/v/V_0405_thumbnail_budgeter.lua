-- ARKHER SYSTEM V.0405 :: Thumbnail Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0405"
	S.key = "arkher.asset.thumbnail.size_budget"
	S.name = "Thumbnail Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.thumbnail.compression_codec" }
	S.tags = { "v", "thumbnail", "budgeter", "asset" }
	S.description = "Thumbnail Size Budget: byte budget shared between competing asset classes for the Thumbnail subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.thumbnail.size_budget", total = 302, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
