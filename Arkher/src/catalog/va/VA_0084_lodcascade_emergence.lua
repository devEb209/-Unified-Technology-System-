-- ARKHER SYSTEM VA.0084 :: LOD Cascade Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0084"
	S.key = "arkher.contworld.lodcascade.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lodcascade.reality_continuum" }
	S.tags = { "va", "lodcascade", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.lodcascade.emergence_continuum", windowSize = 5, threshold = 1.40, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
