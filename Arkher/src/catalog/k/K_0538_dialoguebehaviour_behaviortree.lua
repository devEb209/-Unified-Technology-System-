-- ARKHER SYSTEM K.0538 :: Dialogue Behaviour Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0538"
	S.key = "arkher.npc.dialoguebehaviour.reactive_behaviour"
	S.name = "Dialogue Behaviour Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dialoguebehaviour.perception" }
	S.tags = { "k", "dialoguebehaviour", "behaviortree", "npc" }
	S.description = "Dialogue Behaviour Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Dialogue Behaviour subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.dialoguebehaviour.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
