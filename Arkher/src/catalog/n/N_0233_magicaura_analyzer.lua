-- ARKHER SYSTEM N.0233 :: Magic Aura Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0233"
	S.key = "arkher.vfx.magicaura.analysis"
	S.name = "Magic Aura Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Magic Aura"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.magicaura.spatial_index" }
	S.tags = { "n", "magicaura", "analyzer", "vfx" }
	S.description = "Magic Aura Analysis: cost, overdraw and stability analysis of the effect for the Magic Aura subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.magicaura.analysis", window = 161, buckets = 17, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
