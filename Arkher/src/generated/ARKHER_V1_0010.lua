--!strict
-- SpeedTree Atlas — CORE Stack #0010
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="SpeedTree Atlas — CORE Stack #0010", size=Vector2.new(640, 420), pos=UDim2.fromOffset(230, 250), parent=parent, icon="≡"})
