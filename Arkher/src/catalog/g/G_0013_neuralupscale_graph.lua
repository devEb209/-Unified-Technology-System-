-- ARKHER SYSTEM G.0013 :: Neural Upscaling Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0013"
	S.key = "arkher.neural.neuralupscale.sampling_graph"
	S.name = "Neural Upscaling Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuralupscale.training_ledger" }
	S.tags = { "g", "neuralupscale", "graph", "neural" }
	S.description = "Neural Upscaling Sampling Graph: dependency graph of sampling stages for the Neural Upscaling subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.neuralupscale.sampling_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
