-- ARKHER SYSTEM J.0171 :: Clothing Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0171"
	S.key = "arkher.character.clothing.locomotion"
	S.name = "Clothing Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.clothing.physical_response" }
	S.tags = { "j", "clothing", "charmotor", "character" }
	S.description = "Clothing Locomotion: capsule locomotion driving the character for the Clothing subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.clothing.locomotion", radius = 0.36, height = 1.61, maxSpeed = 4.10, jumpHeight = 1.30, stepOffset = 0.26 })
		inst.system = S
		inst.ctx = ctx
