-- ARKHER SYSTEM O.0058 :: Explosion Sound Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0058"
	S.key = "arkher.audio.explosionsound.analysis"
	S.name = "Explosion Sound Analysis"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.explosionsound.playback_policy" }
	S.tags = { "o", "explosionsound", "analyzer", "audio" }
	S.description = "Explosion Sound Analysis: loudness, headroom and masking analysis for the Explosion Sound subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.explosionsound.analysis", window = 148, buckets = 12, threshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
