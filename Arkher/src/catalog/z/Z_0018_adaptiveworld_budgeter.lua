-- ARKHER SYSTEM Z.0018 :: Adaptive World Intelligence Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0018"
	S.key = "arkher.origin.adaptiveworld.budget_governor"
	S.name = "Adaptive World Intelligence Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.adaptiveworld.behaviour_analysis" }
	S.tags = { "z", "adaptiveworld", "budgeter", "origin" }
	S.description = "Adaptive World Intelligence Budget Governor: allocation of a scarce resource across the technology's consumers for the Adaptive World Intelligence subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.adaptiveworld.budget_governor", total = 72, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
