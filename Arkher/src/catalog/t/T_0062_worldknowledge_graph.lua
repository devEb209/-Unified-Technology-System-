-- ARKHER SYSTEM T.0062 :: World Knowledge Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0062"
	S.key = "arkher.ai.worldknowledge.reasoning_graph"
	S.name = "World Knowledge Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.worldknowledge.world_architect" }
	S.tags = { "t", "worldknowledge", "graph", "ai" }
	S.description = "World Knowledge Reasoning Graph: relationship modelling and shortest-path reasoning for the World Knowledge subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.worldknowledge.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
