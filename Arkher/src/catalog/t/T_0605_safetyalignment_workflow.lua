-- ARKHER SYSTEM T.0605 :: Safety Alignment Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0605"
	S.key = "arkher.ai.safetyalignment.plan_workflow"
	S.name = "Safety Alignment Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.safetyalignment.semantic_knowledge" }
	S.tags = { "t", "safetyalignment", "workflow", "ai" }
	S.description = "Safety Alignment Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Safety Alignment subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.safetyalignment.plan_workflow", maxRetries = 2, budget = 80 })
		inst.system = S
		inst.ctx = ctx
