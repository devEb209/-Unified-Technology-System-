-- ARKHER SYSTEM VC.0043 :: Continuum Stream Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0043"
	S.key = "arkher.contneural.continuumstream.neural_field"
	S.name = "Continuum Stream Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.continuumstream.coherence_guard" }
	S.tags = { "vc", "continuumstream", "neuralfield", "contneural" }
	S.description = "Continuum Stream Neural Field: neural field encoding and reconstruction for the Continuum Stream subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.continuumstream.neural_field", dims = 12, hidden = 8, seed = 38956 })
		inst.system = S
		inst.ctx = ctx
