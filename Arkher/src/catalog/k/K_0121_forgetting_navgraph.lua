-- ARKHER SYSTEM K.0121 :: Forgetting Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0121"
	S.key = "arkher.npc.forgetting.navigation"
	S.name = "Forgetting Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.forgetting.goal_planner" }
	S.tags = { "k", "forgetting", "navgraph", "npc" }
	S.description = "Forgetting Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Forgetting subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.forgetting.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
