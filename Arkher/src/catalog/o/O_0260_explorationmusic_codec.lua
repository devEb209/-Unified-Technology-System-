-- ARKHER SYSTEM O.0260 :: Exploration Music Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0260"
	S.key = "arkher.audio.explorationmusic.compression_codec"
	S.name = "Exploration Music Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.explorationmusic.asset_registry" }
	S.tags = { "o", "explorationmusic", "codec", "audio" }
	S.description = "Exploration Music Compression Codec: payload encoding of audio state and events for the Exploration Music subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.explorationmusic.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
