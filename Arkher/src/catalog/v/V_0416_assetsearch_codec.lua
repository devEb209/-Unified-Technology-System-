-- ARKHER SYSTEM V.0416 :: Asset Search Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0416"
	S.key = "arkher.asset.assetsearch.compression_codec"
	S.name = "Asset Search Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetsearch.streaming_residency" }
	S.tags = { "v", "assetsearch", "codec", "asset" }
	S.description = "Asset Search Compression Codec: compact encoding, diffing and checksum of asset payloads for the Asset Search subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.assetsearch.compression_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
