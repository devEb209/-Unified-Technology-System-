-- ARKHER SYSTEM L.0134 :: Village Life Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0134"
	S.key = "arkher.sim.villagelife.forecast"
	S.name = "Village Life Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.villagelife.analysis" }
	S.tags = { "l", "villagelife", "predictor", "sim" }
	S.description = "Village Life Forecast: prediction of the region's next state for the Village Life subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.villagelife.forecast", method = "markov", alpha = 0.37, window = 115 })
		inst.system = S
		inst.ctx = ctx
