-- ARKHER SYSTEM VC.0636 :: Interest Field Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0636"
	S.key = "arkher.contneural.interestfield.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.interestfield.reality_continuum" }
	S.tags = { "vc", "interestfield", "emergence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.interestfield.emergence_continuum", windowSize = 4, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
