-- ARKHER SYSTEM Q.0027 :: Button Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0027"
	S.key = "arkher.ui.button.input_mapping"
	S.name = "Button Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Button"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.button.widget_tree" }
	S.tags = { "q", "button", "inputmap", "ui" }
	S.description = "Button Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Button subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.button.input_mapping", device = "keyboard", holdTime = 0.39, deadzone = 0.24 })
		inst.system = S
		inst.ctx = ctx
