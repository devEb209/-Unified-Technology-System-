-- ARKHER SYSTEM I.0400 :: Animation Compression Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0400"
	S.key = "arkher.anim.animcompression.pose_cache"
	S.name = "Animation Compression Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animcompression.playback_pipeline" }
	S.tags = { "i", "animcompression", "cache", "anim" }
	S.description = "Animation Compression Pose Cache: reuse of sampled poses across frames and instances for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.animcompression.pose_cache", policy = "lru", capacity = 104, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
