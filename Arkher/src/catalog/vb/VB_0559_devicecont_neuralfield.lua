-- ARKHER SYSTEM VB.0559 :: Device Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0559"
	S.key = "arkher.conttime.devicecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.devicecont.coherence_guard" }
	S.tags = { "vb", "devicecont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.devicecont.neural_field", dims = 24, hidden = 20, seed = 87275 })
		inst.system = S
		inst.ctx = ctx
