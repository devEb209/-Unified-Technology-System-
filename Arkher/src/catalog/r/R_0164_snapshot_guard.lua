-- ARKHER SYSTEM R.0164 :: Snapshot Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0164"
	S.key = "arkher.net.snapshot.rate_guard"
	S.name = "Snapshot Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Snapshot"
	S.aspect = "Rate Guard"
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.snapshot.interest_streaming" }
	S.tags = { "r", "snapshot", "guard", "net" }
	S.description = "Snapshot Rate Guard: token-bucket protection against floods and abuse for the Snapshot subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.snapshot.rate_guard", algorithm = "sliding", capacity = 31, refillPerSec = 36, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
