-- ARKHER SYSTEM H.0662 :: Raycast Query Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0662"
	S.key = "arkher.physics.raycast.constraint_solver"
	S.name = "Raycast Query Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.raycast.contact_generation" }
	S.tags = { "h", "raycast", "constraint", "physics" }
	S.description = "Raycast Query Constraint Solver: sequential impulses, friction, joints and warm starting for the Raycast Query subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.raycast.constraint_solver", iterations = 11, baumgarte = 0.17, warmStart = true })
		inst.system = S
		inst.ctx = ctx
