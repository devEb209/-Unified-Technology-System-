-- ARKHER SYSTEM J.0191 :: Armor Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0191"
	S.key = "arkher.character.armor.look_and_reach"
	S.name = "Armor Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.armor.blend_controller" }
	S.tags = { "j", "armor", "ik", "character" }
	S.description = "Armor Look And Reach: look-at, reach and foot placement for the character for the Armor subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.armor.look_and_reach", iterations = 10, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
