-- ARKHER SYSTEM VB.0576 :: Mobile Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0576"
	S.key = "arkher.conttime.mobilecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.mobilecont.reality_continuum" }
	S.tags = { "vb", "mobilecont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.mobilecont.emergence_continuum", windowSize = 6, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
