-- ARKHER SYSTEM Z.0042 :: Singularity World Architect Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0042"
	S.key = "arkher.origin.worldarchitect.complexity_governance"
	S.name = "Singularity World Architect Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.reality_layering" }
	S.tags = { "z", "worldarchitect", "complexity", "origin" }
	S.description = "Singularity World Architect Complexity Governance: measured scene cost turned into per-subsystem directives for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.worldarchitect.complexity_governance", targetMs = 19.0 })
		inst.system = S
		inst.ctx = ctx
