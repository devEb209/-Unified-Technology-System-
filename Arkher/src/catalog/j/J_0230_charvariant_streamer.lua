-- ARKHER SYSTEM J.0230 :: Character Variant Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0230"
	S.key = "arkher.character.charvariant.streaming"
	S.name = "Character Variant Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.charvariant.budget_governor" }
	S.tags = { "j", "charvariant", "streamer", "character" }
	S.description = "Character Variant Streaming: distance-driven residency of character data for the Character Variant subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.charvariant.streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
