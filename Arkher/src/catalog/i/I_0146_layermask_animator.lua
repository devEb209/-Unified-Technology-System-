-- ARKHER SYSTEM I.0146 :: Layer Mask Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0146"
	S.key = "arkher.anim.layermask.layered_blending"
	S.name = "Layer Mask Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Layer Mask"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.layermask.clip_sampling" }
	S.tags = { "i", "layermask", "animator", "anim" }
	S.description = "Layer Mask Layered Blending: layers, crossfades, masks and blend trees for the Layer Mask subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.layermask.layered_blending", budget = 15 })
		inst.system = S
		inst.ctx = ctx
