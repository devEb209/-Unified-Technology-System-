-- ARKHER SYSTEM O.0220 :: Music Bed Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0220"
	S.key = "arkher.audio.musicbed.music_sequencer"
	S.name = "Music Bed Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Music Bed"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.musicbed.spatialization" }
	S.tags = { "o", "musicbed", "sequencer", "audio" }
	S.description = "Music Bed Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Music Bed subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.musicbed.music_sequencer", bpm = 150, beatsPerBar = 4, intensity = 0.44 })
		inst.system = S
		inst.ctx = ctx
