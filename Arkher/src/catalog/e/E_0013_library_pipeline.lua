-- ARKHER SYSTEM E.0013 :: Material Library Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0013"
	S.key = "arkher.material.library.authoring_pipeline"
	S.name = "Material Library Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.library.analysis" }
	S.tags = { "e", "library", "pipeline", "material" }
	S.description = "Material Library Authoring Pipeline: ordered authoring and bake stages for the Material Library subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.library.authoring_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
