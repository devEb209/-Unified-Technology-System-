-- ARKHER SYSTEM H.0246 :: Broadphase Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0246"
	S.key = "arkher.physics.broadphase.broadphase_index"
	S.name = "Broadphase Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Broadphase"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.broadphase.vehicle" }
	S.tags = { "h", "broadphase", "index", "physics" }
	S.description = "Broadphase Broadphase Index: spatial acceleration of candidate pair finding for the Broadphase subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.broadphase.broadphase_index", mode = "hash", cellSize = 48 })
		inst.system = S
		inst.ctx = ctx
