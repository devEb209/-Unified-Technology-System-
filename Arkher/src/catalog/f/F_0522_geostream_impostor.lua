-- ARKHER SYSTEM F.0522 :: Geometry Streaming Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0522"
	S.key = "arkher.render.geostream.geometry_virtualization"
	S.name = "Geometry Streaming Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.geostream.visibility_set" }
	S.tags = { "f", "geostream", "impostor", "render" }
	S.description = "Geometry Streaming Geometry Virtualization: impostor and HLOD synthesis under a budget for the Geometry Streaming subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.geostream.geometry_virtualization", atlasSlots = 96, viewCount = 8, errorThreshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
