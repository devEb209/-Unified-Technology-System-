-- ARKHER SYSTEM T.0239 :: Dialogue Generation Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0239"
	S.key = "arkher.ai.dialoguegeneration.intent_understanding"
	S.name = "Dialogue Generation Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "dialoguegeneration", "intent", "ai" }
	S.description = "Dialogue Generation Intent Understanding: natural language turned into an actionable, scored intent for the Dialogue Generation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.dialoguegeneration.intent_understanding", minConfidence = 0.36 })
		inst.system = S
		inst.ctx = ctx
