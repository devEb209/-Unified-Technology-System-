-- ARKHER SYSTEM Z.0303 :: Causality Ledger Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0303"
	S.key = "arkher.origin.causality.simulation_fabric"
	S.name = "Causality Ledger Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.complexity_governance" }
	S.tags = { "z", "causality", "fabric", "origin" }
	S.description = "Causality Ledger Simulation Fabric: every simulation domain stepped under one budgeted clock for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.causality.simulation_fabric", budgetMs = 2.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
