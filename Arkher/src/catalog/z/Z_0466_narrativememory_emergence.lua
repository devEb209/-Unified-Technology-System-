-- ARKHER SYSTEM Z.0466 :: Narrative Memory Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0466"
	S.key = "arkher.origin.narrativememory.emergence_detection"
	S.name = "Narrative Memory Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.world_memory" }
	S.tags = { "z", "narrativememory", "emergence", "origin" }
	S.description = "Narrative Memory Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.narrativememory.emergence_detection", windowSize = 7, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
