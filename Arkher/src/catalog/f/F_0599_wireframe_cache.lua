-- ARKHER SYSTEM F.0599 :: Wireframe Overlay Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0599"
	S.key = "arkher.render.wireframe.pass_cache"
	S.name = "Wireframe Overlay Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.wireframe.render_policy" }
	S.tags = { "f", "wireframe", "cache", "render" }
	S.description = "Wireframe Overlay Pass Cache: reuse of pass results across frames for the Wireframe Overlay subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.wireframe.pass_cache", policy = "lru", capacity = 207, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
