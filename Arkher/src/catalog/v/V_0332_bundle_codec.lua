-- ARKHER SYSTEM V.0332 :: Bundle Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0332"
	S.key = "arkher.asset.bundle.compression_codec"
	S.name = "Bundle Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.bundle.streaming_residency" }
	S.tags = { "v", "bundle", "codec", "asset" }
	S.description = "Bundle Compression Codec: compact encoding, diffing and checksum of asset payloads for the Bundle subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.bundle.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
