-- ARKHER SYSTEM VB.0404 :: Perception Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0404"
	S.key = "arkher.conttime.perceptioncont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.perceptioncont.neural_field" }
	S.tags = { "vb", "perceptioncont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.perceptioncont.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
