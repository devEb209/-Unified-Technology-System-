-- ARKHER SYSTEM K.0359 :: Behaviour State Machine Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0359"
	S.key = "arkher.npc.behaviourstate.navigation"
	S.name = "Behaviour State Machine Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourstate.goal_planner" }
	S.tags = { "k", "behaviourstate", "navgraph", "npc" }
	S.description = "Behaviour State Machine Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Behaviour State Machine subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.behaviourstate.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
