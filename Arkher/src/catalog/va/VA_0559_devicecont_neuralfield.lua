-- ARKHER SYSTEM VA.0559 :: Device Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0559"
	S.key = "arkher.contworld.devicecont.neural_field"
	S.name = "Device Continuum Neural Field"
	S.category = "VA"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.devicecont.coherence_guard" }
	S.tags = { "va", "devicecont", "neuralfield", "contworld" }
	S.description = "Device Continuum Neural Field: neural field encoding and reconstruction for the Device Continuum subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.devicecont.neural_field", dims = 20, hidden = 16, seed = 68910 })
		inst.system = S
		inst.ctx = ctx
