-- ARKHER SYSTEM P.0354 :: Threat Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0354"
	S.key = "arkher.play.threat.rule_pipeline"
	S.name = "Threat Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Threat"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.threat.state_machine" }
	S.tags = { "p", "threat", "pipeline", "play" }
	S.description = "Threat Rule Pipeline: ordered rules applied to every gameplay event for the Threat subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.threat.rule_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
