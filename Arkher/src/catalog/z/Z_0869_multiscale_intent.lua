-- ARKHER SYSTEM Z.0869 :: Multi Scale Simulation Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0869"
	S.key = "arkher.origin.multiscale.intent_bridge"
	S.name = "Multi Scale Simulation Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.semantic_graph" }
	S.tags = { "z", "multiscale", "intent", "origin" }
	S.description = "Multi Scale Simulation Intent Bridge: natural language control surface for the technology for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.multiscale.intent_bridge", minConfidence = 0.43 })
		inst.system = S
		inst.ctx = ctx
