-- ARKHER SYSTEM E.0265 :: UV Mapping Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0265"
	S.key = "arkher.material.uvmap.quality_policy"
	S.name = "UV Mapping Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "UV Mapping"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.uvmap.compression_codec" }
	S.tags = { "e", "uvmap", "policy", "material" }
	S.description = "UV Mapping Quality Policy: device tier rules for the surface for the UV Mapping subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.uvmap.quality_policy", algorithm = "roundrobin", starvationGuard = 36 })
		inst.system = S
		inst.ctx = ctx
