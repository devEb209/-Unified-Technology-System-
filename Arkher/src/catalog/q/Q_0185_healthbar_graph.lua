-- ARKHER SYSTEM Q.0185 :: Health Bar Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0185"
	S.key = "arkher.ui.healthbar.navigation_graph"
	S.name = "Health Bar Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Health Bar"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.healthbar.transition" }
	S.tags = { "q", "healthbar", "graph", "ui" }
	S.description = "Health Bar Navigation Graph: screens, routes and shortest path between them for the Health Bar subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.healthbar.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
