-- ARKHER SYSTEM K.0499 :: Patrol Route Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0499"
	S.key = "arkher.npc.patrolroute.navigation"
	S.name = "Patrol Route Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.patrolroute.goal_planner" }
	S.tags = { "k", "patrolroute", "navgraph", "npc" }
	S.description = "Patrol Route Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Patrol Route subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.patrolroute.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
