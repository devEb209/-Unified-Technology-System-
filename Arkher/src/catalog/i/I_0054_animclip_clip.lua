-- ARKHER SYSTEM I.0054 :: Animation Clip Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0054"
	S.key = "arkher.anim.animclip.clip_sampling"
	S.name = "Animation Clip Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animclip.skeleton" }
	S.tags = { "i", "animclip", "clip", "anim" }
	S.description = "Animation Clip Clip Sampling: keyframe tracks sampled, retimed and evented for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.animclip.clip_sampling", duration = 2.10, loop = true })
		inst.system = S
		inst.ctx = ctx
