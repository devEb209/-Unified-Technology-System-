-- ARKHER SYSTEM VA.0386 :: Memory Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0386"
	S.key = "arkher.contworld.memorycont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memorycont.infinite_grid" }
	S.tags = { "va", "memorycont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.memorycont.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
