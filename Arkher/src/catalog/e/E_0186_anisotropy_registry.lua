-- ARKHER SYSTEM E.0186 :: Anisotropy Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0186"
	S.key = "arkher.material.anisotropy.variant_registry"
	S.name = "Anisotropy Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Anisotropy"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.anisotropy.procedural_detail" }
	S.tags = { "e", "anisotropy", "registry", "material" }
	S.description = "Anisotropy Variant Registry: named variants and their lifecycle for the Anisotropy subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.anisotropy.variant_registry" })
		inst.system = S
		inst.ctx = ctx
