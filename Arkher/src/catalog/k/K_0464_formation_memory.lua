-- ARKHER SYSTEM K.0464 :: Formation Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0464"
	S.key = "arkher.npc.formation.memory"
	S.name = "Formation Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.formation.mind_network" }
	S.tags = { "k", "formation", "memory", "npc" }
	S.description = "Formation Memory: episodic memory with decay, recall and consolidation for the Formation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.formation.memory", capacity = 55, decayRate = 0.065, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
