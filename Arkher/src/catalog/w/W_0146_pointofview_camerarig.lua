-- ARKHER SYSTEM W.0146 :: Point Of View Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0146"
	S.key = "arkher.cine.pointofview.camera_rig"
	S.name = "Point Of View Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.pointofview.sequence_timeline" }
	S.tags = { "w", "pointofview", "camerarig", "cine" }
	S.description = "Point Of View Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Point Of View subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.pointofview.camera_rig", fov = 1.12, focus = 14.0, aperture = 6.4, smoothing = 12.0, distance = 16, height = 6 })
		inst.system = S
		inst.ctx = ctx
