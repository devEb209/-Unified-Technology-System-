-- ARKHER SYSTEM J.0276 :: Character Physics Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0276"
	S.key = "arkher.character.characterphysics.rig_definition"
	S.name = "Character Physics Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "characterphysics", "skeleton", "character" }
	S.description = "Character Physics Rig Definition: character rig definition and bone budget for the Character Physics subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.characterphysics.rig_definition" })
		inst.system = S
		inst.ctx = ctx
