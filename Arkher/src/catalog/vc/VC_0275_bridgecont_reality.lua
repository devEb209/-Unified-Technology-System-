-- ARKHER SYSTEM VC.0275 :: Bridge Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0275"
	S.key = "arkher.contneural.bridgecont.reality_continuum"
	S.name = "Bridge Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.bridgecont.simulation_fabric" }
	S.tags = { "vc", "bridgecont", "reality", "contneural" }
	S.description = "Bridge Continuum Reality Continuum: stacked reality layers of the continuum for the Bridge Continuum subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.bridgecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
