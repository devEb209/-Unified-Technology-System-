-- ARKHER SYSTEM P.0390 :: Score Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0390"
	S.key = "arkher.play.score.rule_pipeline"
	S.name = "Score Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Score"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.score.state_machine" }
	S.tags = { "p", "score", "pipeline", "play" }
	S.description = "Score Rule Pipeline: ordered rules applied to every gameplay event for the Score subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.score.rule_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
