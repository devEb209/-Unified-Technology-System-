-- ARKHER SYSTEM VB.0185 :: Simulation Domain Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0185"
	S.key = "arkher.conttime.simdomain.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.simdomain.multi-scale_fidelity" }
	S.tags = { "vb", "simdomain", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.simdomain.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
