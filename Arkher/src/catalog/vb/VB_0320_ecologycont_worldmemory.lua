-- ARKHER SYSTEM VB.0320 :: Ecology Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0320"
	S.key = "arkher.conttime.ecologycont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.ecologycont.neural_field" }
	S.tags = { "vb", "ecologycont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.ecologycont.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
