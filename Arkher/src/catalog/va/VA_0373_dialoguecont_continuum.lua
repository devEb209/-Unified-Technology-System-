-- ARKHER SYSTEM VA.0373 :: Dialogue Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0373"
	S.key = "arkher.contworld.dialoguecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "dialoguecont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.dialoguecont.infinite_grid", cellSize = 192, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
