-- ARKHER SYSTEM F.0274 :: Tonemapping Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0274"
	S.key = "arkher.render.tonemap.adaptive_resolution"
	S.name = "Tonemapping Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Tonemapping"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.tonemap.temporal_resolve" }
	S.tags = { "f", "tonemap", "upscaler", "render" }
	S.description = "Tonemapping Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Tonemapping subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.tonemap.adaptive_resolution", targetMs = 13.10, index = 5, sharpness = 0.50 })
		inst.system = S
		inst.ctx = ctx
