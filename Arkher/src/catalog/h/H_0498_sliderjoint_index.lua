-- ARKHER SYSTEM H.0498 :: Slider Joint Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0498"
	S.key = "arkher.physics.sliderjoint.broadphase_index"
	S.name = "Slider Joint Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Slider Joint"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sliderjoint.vehicle" }
	S.tags = { "h", "sliderjoint", "index", "physics" }
	S.description = "Slider Joint Broadphase Index: spatial acceleration of candidate pair finding for the Slider Joint subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.sliderjoint.broadphase_index", mode = "hash", cellSize = 56 })
		inst.system = S
		inst.ctx = ctx
