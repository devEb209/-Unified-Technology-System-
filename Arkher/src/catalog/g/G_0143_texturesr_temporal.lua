-- ARKHER SYSTEM G.0143 :: Texture Super Resolution Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0143"
	S.key = "arkher.neural.texturesr.temporal_history"
	S.name = "Texture Super Resolution Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.texturesr.feature_extraction" }
	S.tags = { "g", "texturesr", "temporal", "neural" }
	S.description = "Texture Super Resolution Temporal History: history buffers reused across frames for the Texture Super Resolution subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.texturesr.temporal_history", feedback = 0.88, phase = 8 })
		inst.system = S
		inst.ctx = ctx
