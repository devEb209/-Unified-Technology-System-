-- ARKHER SYSTEM W.0212 :: Montage Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0212"
	S.key = "arkher.cine.montage.cinematic_mix"
	S.name = "Montage Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Montage"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.montage.motion_tween" }
	S.tags = { "w", "montage", "mixer", "cine" }
	S.description = "Montage Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Montage subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.montage.cinematic_mix", maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
