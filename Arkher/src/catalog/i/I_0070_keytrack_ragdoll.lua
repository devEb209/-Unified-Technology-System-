-- ARKHER SYSTEM I.0070 :: Keyframe Track Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0070"
	S.key = "arkher.anim.keytrack.physical_blend"
	S.name = "Keyframe Track Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.keytrack.inverse_kinematics" }
	S.tags = { "i", "keytrack", "ragdoll", "anim" }
	S.description = "Keyframe Track Physical Blend: physical bones blended against the animated pose for the Keyframe Track subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.keytrack.physical_blend", blendSpeed = 3.10 })
		inst.system = S
		inst.ctx = ctx
