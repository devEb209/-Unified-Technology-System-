-- ARKHER SYSTEM E.0079 :: Normal Detail Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0079"
	S.key = "arkher.material.normaldetail.texture_sampling"
	S.name = "Normal Detail Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.normaldetail.shading_graph" }
	S.tags = { "e", "normaldetail", "sampler", "material" }
	S.description = "Normal Detail Texture Sampling: atlas packing, mip chain and filtered sampling for the Normal Detail subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.normaldetail.texture_sampling", atlasSize = 192, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
