-- ARKHER SYSTEM T.0528 :: Audio Reasoning Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0528"
	S.key = "arkher.ai.audioreasoning.utility_selection"
	S.name = "Audio Reasoning Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.audioreasoning.working_memory" }
	S.tags = { "t", "audioreasoning", "utility", "ai" }
	S.description = "Audio Reasoning Utility Selection: scored choice between competing courses of action for the Audio Reasoning subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.audioreasoning.utility_selection", momentum = 0.02 })
		inst.system = S
		inst.ctx = ctx
