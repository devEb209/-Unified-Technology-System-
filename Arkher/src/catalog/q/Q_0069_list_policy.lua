-- ARKHER SYSTEM Q.0069 :: List Accessibility Policy
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0069"
	S.key = "arkher.ui.list.accessibility_policy"
	S.name = "List Accessibility Policy"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "List"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.list.interaction_ledger" }
	S.tags = { "q", "list", "policy", "ui" }
	S.description = "List Accessibility Policy: rules enforcing contrast, target size and motion limits for the List subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ui.list.accessibility_policy", algorithm = "lottery", starvationGuard = 31 })
		inst.system = S
		inst.ctx = ctx
