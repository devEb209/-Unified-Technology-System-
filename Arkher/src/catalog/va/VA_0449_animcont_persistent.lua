-- ARKHER SYSTEM VA.0449 :: Animation Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0449"
	S.key = "arkher.contworld.animcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.animcont.multi-scale_fidelity" }
	S.tags = { "va", "animcont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.animcont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
