-- ARKHER SYSTEM N.0101 :: Muzzle Flash Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0101"
	S.key = "arkher.vfx.muzzleflash.quality_policy"
	S.name = "Muzzle Flash Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Muzzle Flash"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.muzzleflash.result_cache" }
	S.tags = { "n", "muzzleflash", "policy", "vfx" }
	S.description = "Muzzle Flash Quality Policy: distance and device driven fidelity bands for the Muzzle Flash subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.muzzleflash.quality_policy", algorithm = "roundrobin", starvationGuard = 56 })
		inst.system = S
		inst.ctx = ctx
