-- ARKHER SYSTEM VC.0260 :: Road Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0260"
	S.key = "arkher.contneural.roadcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.roadcont.neural_field" }
	S.tags = { "vc", "roadcont", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.roadcont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
