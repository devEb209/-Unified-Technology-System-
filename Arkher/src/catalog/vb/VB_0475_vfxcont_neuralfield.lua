-- ARKHER SYSTEM VB.0475 :: VFX Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0475"
	S.key = "arkher.conttime.vfxcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vfxcont.coherence_guard" }
	S.tags = { "vb", "vfxcont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.vfxcont.neural_field", dims = 12, hidden = 8, seed = 68928 })
		inst.system = S
		inst.ctx = ctx
