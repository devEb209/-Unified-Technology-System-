-- ARKHER SYSTEM VD.0631 :: Interest Field Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0631"
	S.key = "arkher.contsim.interestfield.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.interestfield.coherence_guard" }
	S.tags = { "vd", "interestfield", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.interestfield.neural_field", dims = 20, hidden = 16, seed = 28842 })
		inst.system = S
		inst.ctx = ctx
