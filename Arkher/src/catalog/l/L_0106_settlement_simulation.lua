-- ARKHER SYSTEM L.0106 :: Settlement Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0106"
	S.key = "arkher.sim.settlement.simulation_core"
	S.name = "Settlement Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "settlement", "simulation", "sim" }
	S.description = "Settlement Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Settlement subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.settlement.simulation_core", fullRadius = 280, reducedRadius = 800, budget = 90 })
		inst.system = S
		inst.ctx = ctx
