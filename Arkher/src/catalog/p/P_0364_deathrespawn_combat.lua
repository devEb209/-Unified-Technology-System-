-- ARKHER SYSTEM P.0364 :: Death And Respawn Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0364"
	S.key = "arkher.play.deathrespawn.combat_resolution"
	S.name = "Death And Respawn Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.deathrespawn.objectives" }
	S.tags = { "p", "deathrespawn", "combat", "play" }
	S.description = "Death And Respawn Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Death And Respawn subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.deathrespawn.combat_resolution", seed = 72659, armourK = 110, critMultiplier = 2.60 })
		inst.system = S
		inst.ctx = ctx
