-- ARKHER SYSTEM VA.0199 :: Architect District Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0199"
	S.key = "arkher.contworld.architectdistrict.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.architectdistrict.coherence_guard" }
	S.tags = { "va", "architectdistrict", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.architectdistrict.neural_field", dims = 12, hidden = 8, seed = 57680 })
		inst.system = S
		inst.ctx = ctx
