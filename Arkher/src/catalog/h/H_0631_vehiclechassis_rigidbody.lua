-- ARKHER SYSTEM H.0631 :: Vehicle Chassis Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0631"
	S.key = "arkher.physics.vehiclechassis.body_dynamics"
	S.name = "Vehicle Chassis Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "vehiclechassis", "rigidbody", "physics" }
	S.description = "Vehicle Chassis Body Dynamics: integration, impulses, damping and sleeping of a body for the Vehicle Chassis subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.vehiclechassis.body_dynamics", mass = 12.00, radius = 0.85, restitution = 0.11, friction = 0.71, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
