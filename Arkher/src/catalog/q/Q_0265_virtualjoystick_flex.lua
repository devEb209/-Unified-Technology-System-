-- ARKHER SYSTEM Q.0265 :: Virtual Joystick Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0265"
	S.key = "arkher.ui.virtualjoystick.responsive_layout"
	S.name = "Virtual Joystick Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "virtualjoystick", "flex", "ui" }
	S.description = "Virtual Joystick Responsive Layout: flex solving with safe areas, weights and breakpoints for the Virtual Joystick subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.virtualjoystick.responsive_layout", width = 570, height = 964, scale = 0.97 })
		inst.system = S
		inst.ctx = ctx
