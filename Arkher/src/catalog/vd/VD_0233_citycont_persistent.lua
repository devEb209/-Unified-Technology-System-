-- ARKHER SYSTEM VD.0233 :: City Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0233"
	S.key = "arkher.contsim.citycont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.citycont.multi-scale_fidelity" }
	S.tags = { "vd", "citycont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.citycont.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
