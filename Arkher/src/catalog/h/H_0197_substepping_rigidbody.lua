-- ARKHER SYSTEM H.0197 :: Substepping Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0197"
	S.key = "arkher.physics.substepping.body_dynamics"
	S.name = "Substepping Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Substepping"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "substepping", "rigidbody", "physics" }
	S.description = "Substepping Body Dynamics: integration, impulses, damping and sleeping of a body for the Substepping subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.substepping.body_dynamics", mass = 38.00, radius = 1.15, restitution = 0.37, friction = 0.57, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
