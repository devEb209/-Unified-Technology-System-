-- ARKHER SYSTEM N.0309 :: Status Effect Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0309"
	S.key = "arkher.vfx.statusfx.quality_policy"
	S.name = "Status Effect Quality Policy"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.statusfx.result_cache" }
	S.tags = { "n", "statusfx", "policy", "vfx" }
	S.description = "Status Effect Quality Policy: distance and device driven fidelity bands for the Status Effect subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.statusfx.quality_policy", algorithm = "lottery", starvationGuard = 63 })
		inst.system = S
		inst.ctx = ctx
