-- ARKHER SYSTEM Z.0088 :: Semantic World Graph Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0088"
	S.key = "arkher.origin.semanticworld.semantic_graph"
	S.name = "Semantic World Graph Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticworld.world_architect" }
	S.tags = { "z", "semanticworld", "knowledge", "origin" }
	S.description = "Semantic World Graph Semantic Graph: typed entities and inferred relations of the technology itself for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.semanticworld.semantic_graph", dims = 40 })
		inst.system = S
		inst.ctx = ctx
