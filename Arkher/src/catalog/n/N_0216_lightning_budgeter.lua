-- ARKHER SYSTEM N.0216 :: Lightning Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0216"
	S.key = "arkher.vfx.lightning.spawn_budget"
	S.name = "Lightning Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Lightning"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.lightning.effect_composition" }
	S.tags = { "n", "lightning", "budgeter", "vfx" }
	S.description = "Lightning Spawn Budget: global particle budget shared by every live effect for the Lightning subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.lightning.spawn_budget", total = 87, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
