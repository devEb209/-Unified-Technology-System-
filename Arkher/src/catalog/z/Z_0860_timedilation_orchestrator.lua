-- ARKHER SYSTEM Z.0860 :: Simulation Time Dilation Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0860"
	S.key = "arkher.origin.timedilation.orchestration"
	S.name = "Simulation Time Dilation Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.residency_streaming" }
	S.tags = { "z", "timedilation", "orchestrator", "origin" }
	S.description = "Simulation Time Dilation Orchestration: lifecycle and phase orchestration of the technology for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.timedilation.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
