-- ARKHER SYSTEM H.0619 :: Character Controller Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0619"
	S.key = "arkher.physics.charactercontroller.contact_generation"
	S.name = "Character Controller Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.charactercontroller.collision_shape" }
	S.tags = { "h", "charactercontroller", "contact", "physics" }
	S.description = "Character Controller Contact Generation: narrow-phase manifolds with normal, depth and point for the Character Controller subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.charactercontroller.contact_generation", slop = 0.0090, maxManifolds = 231 })
		inst.system = S
		inst.ctx = ctx
