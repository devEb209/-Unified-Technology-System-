-- ARKHER SYSTEM K.0207 :: Emotional State Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0207"
	S.key = "arkher.npc.emotionalstate.social_relations"
	S.name = "Emotional State Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.emotionalstate.crowd_steering" }
	S.tags = { "k", "emotionalstate", "society", "npc" }
	S.description = "Emotional State Social Relations: affinity, factions, reputation and gossip for the Emotional State subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.emotionalstate.social_relations", decayRate = 0.006, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
