-- ARKHER SYSTEM N.0025 :: Smoke Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0025"
	S.key = "arkher.vfx.smoke.analysis"
	S.name = "Smoke Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Smoke"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.smoke.spatial_index" }
	S.tags = { "n", "smoke", "analyzer", "vfx" }
	S.description = "Smoke Analysis: cost, overdraw and stability analysis of the effect for the Smoke subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.smoke.analysis", window = 55, buckets = 15, threshold = 2.70 })
		inst.system = S
		inst.ctx = ctx
