-- ARKHER SYSTEM L.0339 :: Market State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0339"
	S.key = "arkher.sim.market.state_codec"
	S.name = "Market State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.market.history_ledger" }
	S.tags = { "l", "market", "codec", "sim" }
	S.description = "Market State Codec: persistence, diffing and checksum of the world state for the Market subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.market.state_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
