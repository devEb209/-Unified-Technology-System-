-- ARKHER SYSTEM Z.0696 :: Auto Test Synthesis Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0696"
	S.key = "arkher.origin.autotest.governance_policy"
	S.name = "Auto Test Synthesis Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autotest.signal_composition" }
	S.tags = { "z", "autotest", "policy", "origin" }
	S.description = "Auto Test Synthesis Governance Policy: ordered rules governing when the technology may act for the Auto Test Synthesis subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.autotest.governance_policy", algorithm = "wfq", starvationGuard = 26 })
		inst.system = S
		inst.ctx = ctx
