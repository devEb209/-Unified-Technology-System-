-- ARKHER SYSTEM T.0652 :: Human Handoff Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0652"
	S.key = "arkher.ai.humanhandoff.outcome_prediction"
	S.name = "Human Handoff Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.humanhandoff.decision_policy" }
	S.tags = { "t", "humanhandoff", "predictor", "ai" }
	S.description = "Human Handoff Outcome Prediction: forecasting the result before the work is done for the Human Handoff subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.humanhandoff.outcome_prediction", method = "ema", alpha = 0.23, window = 77 })
		inst.system = S
		inst.ctx = ctx
