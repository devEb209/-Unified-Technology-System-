-- ARKHER SYSTEM Z.1039 :: Autonomous Balancing Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.1039"
	S.key = "arkher.origin.autobalancing.residency_streaming"
	S.name = "Autonomous Balancing Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autobalancing.budget_governor" }
	S.tags = { "z", "autobalancing", "streamer", "origin" }
	S.description = "Autonomous Balancing Residency Streaming: distance-driven residency of the technology's workload for the Autonomous Balancing subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.autobalancing.residency_streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
