-- ARKHER SYSTEM VB.0379 :: Dialogue Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0379"
	S.key = "arkher.conttime.dialoguecont.neural_field"
	S.name = "Dialogue Continuum Neural Field"
	S.category = "VB"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.dialoguecont.coherence_guard" }
	S.tags = { "vb", "dialoguecont", "neuralfield", "conttime" }
	S.description = "Dialogue Continuum Neural Field: neural field encoding and reconstruction for the Dialogue Continuum subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.dialoguecont.neural_field", dims = 16, hidden = 12, seed = 96025 })
		inst.system = S
		inst.ctx = ctx
