-- ARKHER SYSTEM I.0030 :: Bind Pose Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0030"
	S.key = "arkher.anim.bindpose.inverse_kinematics"
	S.name = "Bind Pose Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bind Pose"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bindpose.layered_blending" }
	S.tags = { "i", "bindpose", "ik", "anim" }
	S.description = "Bind Pose Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Bind Pose subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.bindpose.inverse_kinematics", iterations = 7, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
