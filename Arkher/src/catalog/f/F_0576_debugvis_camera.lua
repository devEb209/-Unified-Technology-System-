-- ARKHER SYSTEM F.0576 :: Debug Visualization View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0576"
	S.key = "arkher.render.debugvis.view_and_culling"
	S.name = "Debug Visualization View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.debugvis.frame_graph" }
	S.tags = { "f", "debugvis", "camera", "render" }
	S.description = "Debug Visualization View And Culling: view state, frustum culling and screen-size LOD for the Debug Visualization subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.debugvis.view_and_culling", width = 956, height = 1260, fov = 1.2100, far = 1800 })
		inst.system = S
		inst.ctx = ctx
