...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="SpeedTree Atlas — CORE Map #0198", size=Vector2.new(600, 480), pos=UDim2.fromOffset(274, 326), parent=parent, icon="⬢"})
