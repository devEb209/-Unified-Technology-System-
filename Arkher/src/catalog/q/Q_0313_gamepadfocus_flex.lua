-- ARKHER SYSTEM Q.0313 :: Gamepad Focus Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0313"
	S.key = "arkher.ui.gamepadfocus.responsive_layout"
	S.name = "Gamepad Focus Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "gamepadfocus", "flex", "ui" }
	S.description = "Gamepad Focus Responsive Layout: flex solving with safe areas, weights and breakpoints for the Gamepad Focus subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.gamepadfocus.responsive_layout", width = 450, height = 1084, scale = 1.14 })
		inst.system = S
		inst.ctx = ctx
