-- ARKHER SYSTEM F.0398 :: Draw Call Batching Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0398"
	S.key = "arkher.render.batching.probe_volume"
	S.name = "Draw Call Batching Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.batching.lighting_rig" }
	S.tags = { "f", "batching", "probe", "render" }
	S.description = "Draw Call Batching Probe Volume: irradiance probes encoded in spherical harmonics for the Draw Call Batching subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.batching.probe_volume", spacing = 40 })
		inst.system = S
		inst.ctx = ctx
