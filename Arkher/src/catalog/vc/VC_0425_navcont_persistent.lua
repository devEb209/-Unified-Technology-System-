-- ARKHER SYSTEM VC.0425 :: Navigation Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0425"
	S.key = "arkher.contneural.navcont.persistent_state"
	S.name = "Navigation Continuum Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.navcont.multi-scale_fidelity" }
	S.tags = { "vc", "navcont", "persistent", "contneural" }
	S.description = "Navigation Continuum Persistent State: epoch-stamped persistent history and rollback for the Navigation Continuum subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.navcont.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
