-- ARKHER SYSTEM O.0304 :: Notification Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0304"
	S.key = "arkher.audio.notification.music_sequencer"
	S.name = "Notification Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Notification"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.notification.spatialization" }
	S.tags = { "o", "notification", "sequencer", "audio" }
	S.description = "Notification Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Notification subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.notification.music_sequencer", bpm = 90, beatsPerBar = 4, intensity = 0.62 })
		inst.system = S
		inst.ctx = ctx
