-- ARKHER SYSTEM L.0179 :: Livestock Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0179"
	S.key = "arkher.sim.livestock.forecast"
	S.name = "Livestock Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livestock.analysis" }
	S.tags = { "l", "livestock", "predictor", "sim" }
	S.description = "Livestock Forecast: prediction of the region's next state for the Livestock subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.livestock.forecast", method = "ema", alpha = 0.13, window = 83 })
		inst.system = S
		inst.ctx = ctx
