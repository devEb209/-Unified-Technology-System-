-- ARKHER SYSTEM F.0513 :: Mesh LOD Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0513"
	S.key = "arkher.render.meshlod.draw_budget"
	S.name = "Mesh LOD Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Mesh LOD"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.meshlod.adaptive_resolution" }
	S.tags = { "f", "meshlod", "budgeter", "render" }
	S.description = "Mesh LOD Draw Budget: draw call and triangle budget allocation for the Mesh LOD subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.meshlod.draw_budget", total = 329, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
