-- ARKHER SYSTEM VD.0219 :: Terrain Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0219"
	S.key = "arkher.contsim.terraincont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.terraincont.epoch_clock" }
	S.tags = { "vd", "terraincont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.terraincont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
