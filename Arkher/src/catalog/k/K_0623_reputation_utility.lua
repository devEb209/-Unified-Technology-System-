-- ARKHER SYSTEM K.0623 :: Reputation Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0623"
	S.key = "arkher.npc.reputation.utility_reasoning"
	S.name = "Reputation Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.reputation.reactive_behaviour" }
	S.tags = { "k", "reputation", "utility", "npc" }
	S.description = "Reputation Utility Reasoning: scored option selection with response curves for the Reputation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.reputation.utility_reasoning", momentum = 0.02 })
		inst.system = S
		inst.ctx = ctx
