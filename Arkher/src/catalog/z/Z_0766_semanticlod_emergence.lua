-- ARKHER SYSTEM Z.0766 :: Semantic LOD Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0766"
	S.key = "arkher.origin.semanticlod.emergence_detection"
	S.name = "Semantic LOD Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticlod.world_memory" }
	S.tags = { "z", "semanticlod", "emergence", "origin" }
	S.description = "Semantic LOD Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Semantic LOD subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.semanticlod.emergence_detection", windowSize = 6, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
