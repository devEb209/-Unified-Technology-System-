-- ARKHER SYSTEM VD.0495 :: Rendering Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0495"
	S.key = "arkher.contsim.rendercont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.rendercont.epoch_clock" }
	S.tags = { "vd", "rendercont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.rendercont.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
