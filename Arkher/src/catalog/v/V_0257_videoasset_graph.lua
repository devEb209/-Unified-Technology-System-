-- ARKHER SYSTEM V.0257 :: Video Asset Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0257"
	S.key = "arkher.asset.videoasset.dependency_graph"
	S.name = "Video Asset Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.videoasset.asset_registry" }
	S.tags = { "v", "videoasset", "graph", "asset" }
	S.description = "Video Asset Dependency Graph: what references what, and in which order it must be built for the Video Asset subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.videoasset.dependency_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
