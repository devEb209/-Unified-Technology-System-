-- ARKHER SYSTEM VB.0323 :: Ecology Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0323"
	S.key = "arkher.conttime.ecologycont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.ecologycont.simulation_fabric" }
	S.tags = { "vb", "ecologycont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.ecologycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
