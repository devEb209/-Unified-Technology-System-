-- ARKHER SYSTEM Q.0398 :: UI Debug Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0398"
	S.key = "arkher.ui.uidebug.widget_tree"
	S.name = "UI Debug Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "UI Debug"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uidebug.responsive_layout" }
	S.tags = { "q", "uidebug", "widget", "ui" }
	S.description = "UI Debug Widget Tree: retained widget nodes, properties, bindings and rendering for the UI Debug subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.uidebug.widget_tree", theme = "highcontrast", scale = 1.05 })
		inst.system = S
		inst.ctx = ctx
