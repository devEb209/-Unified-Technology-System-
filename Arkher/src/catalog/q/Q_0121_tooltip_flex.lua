-- ARKHER SYSTEM Q.0121 :: Tooltip Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0121"
	S.key = "arkher.ui.tooltip.responsive_layout"
	S.name = "Tooltip Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tooltip"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "tooltip", "flex", "ui" }
	S.description = "Tooltip Responsive Layout: flex solving with safe areas, weights and breakpoints for the Tooltip subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.tooltip.responsive_layout", width = 450, height = 904, scale = 0.91 })
		inst.system = S
		inst.ctx = ctx
