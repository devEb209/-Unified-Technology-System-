-- ARKHER SYSTEM VD.0123 :: Spatial Slice Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0123"
	S.key = "arkher.contsim.spatialslice.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.spatialslice.epoch_clock" }
	S.tags = { "vd", "spatialslice", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.spatialslice.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
