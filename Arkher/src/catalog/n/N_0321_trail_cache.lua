-- ARKHER SYSTEM N.0321 :: Trail Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0321"
	S.key = "arkher.vfx.trail.result_cache"
	S.name = "Trail Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Trail"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.trail.spawn_budget" }
	S.tags = { "n", "trail", "cache", "vfx" }
	S.description = "Trail Result Cache: reuse of expensive effect evaluations for the Trail subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.trail.result_cache", policy = "lfu", capacity = 145, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
