-- ARKHER SYSTEM E.0553 :: Physical Response Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0553"
	S.key = "arkher.material.physicalresponse.authoring_pipeline"
	S.name = "Physical Response Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.physicalresponse.analysis" }
	S.tags = { "e", "physicalresponse", "pipeline", "material" }
	S.description = "Physical Response Authoring Pipeline: ordered authoring and bake stages for the Physical Response subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.physicalresponse.authoring_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
