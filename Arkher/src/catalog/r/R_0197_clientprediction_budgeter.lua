-- ARKHER SYSTEM R.0197 :: Client Prediction Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0197"
	S.key = "arkher.net.clientprediction.bandwidth_budget"
	S.name = "Client Prediction Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.clientprediction.transport_graph" }
	S.tags = { "r", "clientprediction", "budgeter", "net" }
	S.description = "Client Prediction Bandwidth Budget: bytes per second shared between competing streams for the Client Prediction subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.clientprediction.bandwidth_budget", total = 305, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
