-- ARKHER SYSTEM J.0008 :: Digital Human Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0008"
	S.key = "arkher.character.digitalhuman.variant_registry"
	S.name = "Digital Human Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.digitalhuman.appearance_composer" }
	S.tags = { "j", "digitalhuman", "registry", "character" }
	S.description = "Digital Human Variant Registry: named character variants and their lifecycle for the Digital Human subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.digitalhuman.variant_registry" })
		inst.system = S
		inst.ctx = ctx
