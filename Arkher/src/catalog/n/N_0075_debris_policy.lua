-- ARKHER SYSTEM N.0075 :: Debris Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0075"
	S.key = "arkher.vfx.debris.quality_policy"
	S.name = "Debris Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Debris"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.debris.result_cache" }
	S.tags = { "n", "debris", "policy", "vfx" }
	S.description = "Debris Quality Policy: distance and device driven fidelity bands for the Debris subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.debris.quality_policy", algorithm = "lottery", starvationGuard = 35 })
		inst.system = S
		inst.ctx = ctx
