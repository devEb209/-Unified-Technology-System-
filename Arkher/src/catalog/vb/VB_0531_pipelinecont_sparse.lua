-- ARKHER SYSTEM VB.0531 :: Pipeline Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0531"
	S.key = "arkher.conttime.pipelinecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.pipelinecont.epoch_clock" }
	S.tags = { "vb", "pipelinecont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.pipelinecont.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
