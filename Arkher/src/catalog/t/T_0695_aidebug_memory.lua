-- ARKHER SYSTEM T.0695 :: AI Debug Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0695"
	S.key = "arkher.ai.aidebug.working_memory"
	S.name = "AI Debug Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.aidebug.outcome_prediction" }
	S.tags = { "t", "aidebug", "memory", "ai" }
	S.description = "AI Debug Working Memory: decaying, consolidating recall of what the agent learned for the AI Debug subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.aidebug.working_memory", capacity = 108, decayRate = 0.040, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
