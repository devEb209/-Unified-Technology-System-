-- ARKHER SYSTEM P.0119 :: Equipment Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0119"
	S.key = "arkher.play.equipment.save_codec"
	S.name = "Equipment Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Equipment"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.equipment.content_registry" }
	S.tags = { "p", "equipment", "codec", "play" }
	S.description = "Equipment Save Codec: persistence, diffing and checksum of gameplay state for the Equipment subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.equipment.save_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
