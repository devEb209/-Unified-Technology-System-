-- ARKHER SYSTEM I.0425 :: Animation LOD Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0425"
	S.key = "arkher.anim.animlod.playback_pipeline"
	S.name = "Animation LOD Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlod.event_ledger" }
	S.tags = { "i", "animlod", "pipeline", "anim" }
	S.description = "Animation LOD Playback Pipeline: ordered sample, blend, ik and output stages for the Animation LOD subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.animlod.playback_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
