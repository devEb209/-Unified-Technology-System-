-- ARKHER SYSTEM E.0551 :: Physical Response Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0551"
	S.key = "arkher.material.physicalresponse.instance_cache"
	S.name = "Physical Response Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.physicalresponse.quality_policy" }
	S.tags = { "e", "physicalresponse", "cache", "material" }
	S.description = "Physical Response Instance Cache: resolved-parameter cache keyed by context for the Physical Response subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.physicalresponse.instance_cache", policy = "ttl", capacity = 431, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
