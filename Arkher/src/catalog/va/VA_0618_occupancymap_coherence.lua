-- ARKHER SYSTEM VA.0618 :: Occupancy Map Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0618"
	S.key = "arkher.contworld.occupancymap.coherence_guard"
	S.name = "Occupancy Map Coherence Guard"
	S.category = "VA"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.occupancymap.persistent_state" }
	S.tags = { "va", "occupancymap", "coherence", "contworld" }
	S.description = "Occupancy Map Coherence Guard: seam coherence and drift supervision for the Occupancy Map subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.occupancymap.coherence_guard", window = 88, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
