-- ARKHER SYSTEM H.0068 :: Inertia Tensor Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0068"
	S.key = "arkher.physics.inertia.analysis"
	S.name = "Inertia Tensor Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.inertia.result_cache" }
	S.tags = { "h", "inertia", "analyzer", "physics" }
	S.description = "Inertia Tensor Analysis: energy, jitter and cost analysis of the simulation for the Inertia Tensor subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.inertia.analysis", window = 146, buckets = 14, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
