-- ARKHER SYSTEM R.0277 :: Anti Cheat Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0277"
	S.key = "arkher.net.anticheat.replication"
	S.name = "Anti Cheat Replication"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Anti Cheat"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "anticheat", "replicator", "net" }
	S.description = "Anti Cheat Replication: authoritative entity state, interest and delta snapshots for the Anti Cheat subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.anticheat.replication", mtu = 1650, interestRadius = 400, fullEvery = 105 })
		inst.system = S
		inst.ctx = ctx
