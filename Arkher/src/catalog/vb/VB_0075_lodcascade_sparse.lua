-- ARKHER SYSTEM VB.0075 :: LOD Cascade Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0075"
	S.key = "arkher.conttime.lodcascade.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lodcascade.epoch_clock" }
	S.tags = { "vb", "lodcascade", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.lodcascade.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
