-- ARKHER SYSTEM G.0369 :: Feature Cache Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0369"
	S.key = "arkher.neural.featurecache.model_registry"
	S.name = "Feature Cache Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.featurecache.reconstruction" }
	S.tags = { "g", "featurecache", "registry", "neural" }
	S.description = "Feature Cache Model Registry: named models and their lifecycle for the Feature Cache subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.featurecache.model_registry" })
		inst.system = S
		inst.ctx = ctx
