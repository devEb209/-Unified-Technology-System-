-- ARKHER SYSTEM L.0032 :: Offscreen Simulation Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0032"
	S.key = "arkher.sim.offscreensim.ecology"
	S.name = "Offscreen Simulation Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.offscreensim.simulation_core" }
	S.tags = { "l", "offscreensim", "ecology", "sim" }
	S.description = "Offscreen Simulation Ecology: populations, predation, harvesting and carrying capacity for the Offscreen Simulation subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.offscreensim.ecology" })
		inst.system = S
		inst.ctx = ctx
