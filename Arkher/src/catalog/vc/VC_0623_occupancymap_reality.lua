-- ARKHER SYSTEM VC.0623 :: Occupancy Map Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0623"
	S.key = "arkher.contneural.occupancymap.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.occupancymap.simulation_fabric" }
	S.tags = { "vc", "occupancymap", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.occupancymap.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
