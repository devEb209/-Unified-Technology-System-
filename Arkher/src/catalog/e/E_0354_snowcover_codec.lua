-- ARKHER SYSTEM E.0354 :: Snow Cover Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0354"
	S.key = "arkher.material.snowcover.compression_codec"
	S.name = "Snow Cover Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Snow Cover"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.snowcover.streaming" }
	S.tags = { "e", "snowcover", "codec", "material" }
	S.description = "Snow Cover Compression Codec: serialization and compression of material data for the Snow Cover subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.snowcover.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
