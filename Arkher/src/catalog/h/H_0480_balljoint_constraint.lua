-- ARKHER SYSTEM H.0480 :: Ball Joint Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0480"
	S.key = "arkher.physics.balljoint.constraint_solver"
	S.name = "Ball Joint Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Ball Joint"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.balljoint.contact_generation" }
	S.tags = { "h", "balljoint", "constraint", "physics" }
	S.description = "Ball Joint Constraint Solver: sequential impulses, friction, joints and warm starting for the Ball Joint subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.balljoint.constraint_solver", iterations = 7, baumgarte = 0.13, warmStart = true })
		inst.system = S
		inst.ctx = ctx
