-- ARKHER SYSTEM N.0138 :: Waterfall Mist Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0138"
	S.key = "arkher.vfx.mist.spawn_budget"
	S.name = "Waterfall Mist Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.mist.effect_composition" }
	S.tags = { "n", "mist", "budgeter", "vfx" }
	S.description = "Waterfall Mist Spawn Budget: global particle budget shared by every live effect for the Waterfall Mist subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.mist.spawn_budget", total = 82, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
