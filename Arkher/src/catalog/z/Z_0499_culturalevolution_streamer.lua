-- ARKHER SYSTEM Z.0499 :: Cultural Evolution Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0499"
	S.key = "arkher.origin.culturalevolution.residency_streaming"
	S.name = "Cultural Evolution Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.budget_governor" }
	S.tags = { "z", "culturalevolution", "streamer", "origin" }
	S.description = "Cultural Evolution Residency Streaming: distance-driven residency of the technology's workload for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.culturalevolution.residency_streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
