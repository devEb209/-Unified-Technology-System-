-- ARKHER SYSTEM VA.0139 :: Fidelity Band Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0139"
	S.key = "arkher.contworld.fidelityband.neural_field"
	S.name = "Fidelity Band Neural Field"
	S.category = "VA"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.fidelityband.coherence_guard" }
	S.tags = { "va", "fidelityband", "neuralfield", "contworld" }
	S.description = "Fidelity Band Neural Field: neural field encoding and reconstruction for the Fidelity Band subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.fidelityband.neural_field", dims = 20, hidden = 16, seed = 14538 })
		inst.system = S
		inst.ctx = ctx
