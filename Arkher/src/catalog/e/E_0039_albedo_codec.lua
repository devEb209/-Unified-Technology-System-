-- ARKHER SYSTEM E.0039 :: Albedo Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0039"
	S.key = "arkher.material.albedo.compression_codec"
	S.name = "Albedo Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Albedo"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.albedo.streaming" }
	S.tags = { "e", "albedo", "codec", "material" }
	S.description = "Albedo Compression Codec: serialization and compression of material data for the Albedo subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.albedo.compression_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
