-- ARKHER SYSTEM V.0322 :: Texture Atlas Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0322"
	S.key = "arkher.asset.atlas.validation_guard"
	S.name = "Texture Atlas Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.atlas.size_budget" }
	S.tags = { "v", "atlas", "guard", "asset" }
	S.description = "Texture Atlas Validation Guard: rate limiting and capability checks on the import path for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.atlas.validation_guard", algorithm = "leaky", capacity = 26, refillPerSec = 31, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
