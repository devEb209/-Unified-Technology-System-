-- ARKHER SYSTEM VB.0503 :: Rendering Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0503"
	S.key = "arkher.conttime.rendercont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.rendercont.simulation_fabric" }
	S.tags = { "vb", "rendercont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.rendercont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
