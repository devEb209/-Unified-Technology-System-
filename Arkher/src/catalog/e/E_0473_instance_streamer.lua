-- ARKHER SYSTEM E.0473 :: Material Instance Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0473"
	S.key = "arkher.material.instance.streaming"
	S.name = "Material Instance Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.instance.parameter_budget" }
	S.tags = { "e", "instance", "streamer", "material" }
	S.description = "Material Instance Streaming: residency and demand-driven texture streaming for the Material Instance subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.instance.streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
