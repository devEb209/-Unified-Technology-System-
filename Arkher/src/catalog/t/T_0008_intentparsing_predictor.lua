-- ARKHER SYSTEM T.0008 :: Intent Parsing Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0008"
	S.key = "arkher.ai.intentparsing.outcome_prediction"
	S.name = "Intent Parsing Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.intentparsing.decision_policy" }
	S.tags = { "t", "intentparsing", "predictor", "ai" }
	S.description = "Intent Parsing Outcome Prediction: forecasting the result before the work is done for the Intent Parsing subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.intentparsing.outcome_prediction", method = "ema", alpha = 0.44, window = 98 })
		inst.system = S
		inst.ctx = ctx
