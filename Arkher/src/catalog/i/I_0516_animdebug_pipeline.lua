-- ARKHER SYSTEM I.0516 :: Animation Debug Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0516"
	S.key = "arkher.anim.animdebug.playback_pipeline"
	S.name = "Animation Debug Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animdebug.event_ledger" }
	S.tags = { "i", "animdebug", "pipeline", "anim" }
	S.description = "Animation Debug Playback Pipeline: ordered sample, blend, ik and output stages for the Animation Debug subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.animdebug.playback_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
