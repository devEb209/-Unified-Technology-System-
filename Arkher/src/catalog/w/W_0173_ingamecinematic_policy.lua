-- ARKHER SYSTEM W.0173 :: In Game Cinematic Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0173"
	S.key = "arkher.cine.ingamecinematic.cut_policy"
	S.name = "In Game Cinematic Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.ingamecinematic.shot_composition" }
	S.tags = { "w", "ingamecinematic", "policy", "cine" }
	S.description = "In Game Cinematic Cut Policy: rules deciding when the sequence cuts and to what for the In Game Cinematic subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.ingamecinematic.cut_policy", algorithm = "edf", starvationGuard = 57 })
		inst.system = S
		inst.ctx = ctx
