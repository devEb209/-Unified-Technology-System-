-- ARKHER SYSTEM L.0404 :: Wealth Distribution Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0404"
	S.key = "arkher.sim.wealth.forecast"
	S.name = "Wealth Distribution Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wealth.analysis" }
	S.tags = { "l", "wealth", "predictor", "sim" }
	S.description = "Wealth Distribution Forecast: prediction of the region's next state for the Wealth Distribution subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.wealth.forecast", method = "linear", alpha = 0.33, window = 111 })
		inst.system = S
		inst.ctx = ctx
