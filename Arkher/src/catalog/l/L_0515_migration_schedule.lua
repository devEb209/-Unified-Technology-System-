-- ARKHER SYSTEM L.0515 :: Migration Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0515"
	S.key = "arkher.sim.migration.calendar"
	S.name = "Migration Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.migration.society" }
	S.tags = { "l", "migration", "schedule", "sim" }
	S.description = "Migration Calendar: hours, days and seasons driving the region for the Migration subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.migration.calendar", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
