-- ARKHER SYSTEM O.0301 :: Notification DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0301"
	S.key = "arkher.audio.notification.dsp_chain"
	S.name = "Notification DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Notification"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "notification", "dsp", "audio" }
	S.description = "Notification DSP Chain: biquad filtering, delay, envelope and soft clipping for the Notification subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.notification.dsp_chain", sampleRate = 22050, filter = "highpass", cutoff = 5400, q = 0.870 })
		inst.system = S
		inst.ctx = ctx
