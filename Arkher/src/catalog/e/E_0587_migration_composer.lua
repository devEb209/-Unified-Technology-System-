-- ARKHER SYSTEM E.0587 :: Material Migration Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0587"
	S.key = "arkher.material.migration.layer_composition"
	S.name = "Material Migration Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.migration.definition" }
	S.tags = { "e", "migration", "composer", "material" }
	S.description = "Material Migration Layer Composition: ordered layer composition with blend rules for the Material Migration subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.migration.layer_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
