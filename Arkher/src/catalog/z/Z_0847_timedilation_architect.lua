-- ARKHER SYSTEM Z.0847 :: Simulation Time Dilation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0847"
	S.key = "arkher.origin.timedilation.world_architect"
	S.name = "Simulation Time Dilation World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.emergence_detection" }
	S.tags = { "z", "timedilation", "architect", "origin" }
	S.description = "Simulation Time Dilation World Architect: hierarchical world composition with conserved budgets for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.timedilation.world_architect", budget = 700, seed = 43051 })
		inst.system = S
		inst.ctx = ctx
