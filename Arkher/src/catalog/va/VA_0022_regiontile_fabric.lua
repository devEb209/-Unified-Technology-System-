-- ARKHER SYSTEM VA.0022 :: Region Tile Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0022"
	S.key = "arkher.contworld.regiontile.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.regiontile.complexity_budget" }
	S.tags = { "va", "regiontile", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.regiontile.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
