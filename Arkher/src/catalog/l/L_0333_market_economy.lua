-- ARKHER SYSTEM L.0333 :: Market Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0333"
	S.key = "arkher.sim.market.economy"
	S.name = "Market Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.market.ecology" }
	S.tags = { "l", "market", "economy", "sim" }
	S.description = "Market Economy: stock, production, demand, price discovery and trade for the Market subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.market.economy", elasticity = 0.16 })
		inst.system = S
		inst.ctx = ctx
