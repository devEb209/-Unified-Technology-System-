-- ARKHER SYSTEM I.0171 :: Crossfade Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0171"
	S.key = "arkher.anim.crossfade.clip_sampling"
	S.name = "Crossfade Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Crossfade"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crossfade.skeleton" }
	S.tags = { "i", "crossfade", "clip", "anim" }
	S.description = "Crossfade Clip Sampling: keyframe tracks sampled, retimed and evented for the Crossfade subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.crossfade.clip_sampling", duration = 3.10, loop = true })
		inst.system = S
		inst.ctx = ctx
