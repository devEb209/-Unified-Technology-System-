-- ARKHER SYSTEM Z.0167 :: Self Analyzing Project World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0167"
	S.key = "arkher.origin.selfanalyzing.world_architect"
	S.name = "Self Analyzing Project World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.emergence_detection" }
	S.tags = { "z", "selfanalyzing", "architect", "origin" }
	S.description = "Self Analyzing Project World Architect: hierarchical world composition with conserved budgets for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.selfanalyzing.world_architect", budget = 800, seed = 25662 })
		inst.system = S
		inst.ctx = ctx
