-- ARKHER SYSTEM Z.0721 :: Knowledge Distillation Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0721"
	S.key = "arkher.origin.distillation.reality_layering"
	S.name = "Knowledge Distillation Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "distillation", "reality", "origin" }
	S.description = "Knowledge Distillation Reality Layering: stacked authored, simulated, proposed and player realities for the Knowledge Distillation subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.distillation.reality_layering" })
		inst.system = S
		inst.ctx = ctx
