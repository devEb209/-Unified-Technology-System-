-- ARKHER SYSTEM VC.0039 :: Continuum Stream Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0039"
	S.key = "arkher.contneural.continuumstream.sparse_residency"
	S.name = "Continuum Stream Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.continuumstream.epoch_clock" }
	S.tags = { "vc", "continuumstream", "sparse", "contneural" }
	S.description = "Continuum Stream Sparse Residency: sparse page residency with eviction and compression for the Continuum Stream subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.continuumstream.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
