-- ARKHER SYSTEM VB.0147 :: Persistence Segment Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0147"
	S.key = "arkher.conttime.persistsegment.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.persistsegment.epoch_clock" }
	S.tags = { "vb", "persistsegment", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.persistsegment.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
