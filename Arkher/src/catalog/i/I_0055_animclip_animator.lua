-- ARKHER SYSTEM I.0055 :: Animation Clip Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0055"
	S.key = "arkher.anim.animclip.layered_blending"
	S.name = "Animation Clip Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animclip.clip_sampling" }
	S.tags = { "i", "animclip", "animator", "anim" }
	S.description = "Animation Clip Layered Blending: layers, crossfades, masks and blend trees for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.animclip.layered_blending", budget = 6 })
		inst.system = S
		inst.ctx = ctx
