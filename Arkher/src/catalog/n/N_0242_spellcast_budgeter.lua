-- ARKHER SYSTEM N.0242 :: Spell Cast Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0242"
	S.key = "arkher.vfx.spellcast.spawn_budget"
	S.name = "Spell Cast Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spell Cast"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spellcast.effect_composition" }
	S.tags = { "n", "spellcast", "budgeter", "vfx" }
	S.description = "Spell Cast Spawn Budget: global particle budget shared by every live effect for the Spell Cast subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.spellcast.spawn_budget", total = 171, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
