-- ARKHER SYSTEM O.0081 :: Dialogue Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0081"
	S.key = "arkher.audio.dialogue.playback_policy"
	S.name = "Dialogue Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Dialogue"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.dialogue.compression_codec" }
	S.tags = { "o", "dialogue", "policy", "audio" }
	S.description = "Dialogue Playback Policy: rules choosing what may be heard right now for the Dialogue subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.dialogue.playback_policy", algorithm = "roundrobin", starvationGuard = 20 })
		inst.system = S
		inst.ctx = ctx
