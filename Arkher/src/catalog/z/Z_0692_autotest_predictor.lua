-- ARKHER SYSTEM Z.0692 :: Auto Test Synthesis Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0692"
	S.key = "arkher.origin.autotest.predictive_optimization"
	S.name = "Auto Test Synthesis Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autotest.adaptive_workflow" }
	S.tags = { "z", "autotest", "predictor", "origin" }
	S.description = "Auto Test Synthesis Predictive Optimization: forecast-driven optimization before the cost is paid for the Auto Test Synthesis subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.autotest.predictive_optimization", method = "markov", alpha = 0.27, window = 121 })
		inst.system = S
		inst.ctx = ctx
