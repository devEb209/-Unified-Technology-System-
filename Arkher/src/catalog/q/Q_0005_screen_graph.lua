-- ARKHER SYSTEM Q.0005 :: Screen Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0005"
	S.key = "arkher.ui.screen.navigation_graph"
	S.name = "Screen Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Screen"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.screen.transition" }
	S.tags = { "q", "screen", "graph", "ui" }
	S.description = "Screen Navigation Graph: screens, routes and shortest path between them for the Screen subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.screen.navigation_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
