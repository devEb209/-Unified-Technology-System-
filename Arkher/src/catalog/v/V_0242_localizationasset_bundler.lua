-- ARKHER SYSTEM V.0242 :: Localization Asset Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0242"
	S.key = "arkher.asset.localizationasset.bundling"
	S.name = "Localization Asset Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.localizationasset.import" }
	S.tags = { "v", "localizationasset", "bundler", "asset" }
	S.description = "Localization Asset Bundling: size-bounded packing, manifests and delta patches for the Localization Asset subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.localizationasset.bundling", maxBundleBytes = 655360 })
		inst.system = S
		inst.ctx = ctx
