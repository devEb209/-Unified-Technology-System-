-- ARKHER SYSTEM G.0091 :: Ghosting Suppression Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0091"
	S.key = "arkher.neural.ghosting.quality_predictor"
	S.name = "Ghosting Suppression Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ghosting.weight_codec" }
	S.tags = { "g", "ghosting", "predictor", "neural" }
	S.description = "Ghosting Suppression Quality Predictor: predicted quality and cost of a setting for the Ghosting Suppression subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.ghosting.quality_predictor", method = "ema", alpha = 0.44, window = 50 })
		inst.system = S
		inst.ctx = ctx
