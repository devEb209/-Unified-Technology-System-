-- ARKHER SYSTEM T.0373 :: Review Critic Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0373"
	S.key = "arkher.ai.reviewcritic.working_memory"
	S.name = "Review Critic Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.reviewcritic.outcome_prediction" }
	S.tags = { "t", "reviewcritic", "memory", "ai" }
	S.description = "Review Critic Working Memory: decaying, consolidating recall of what the agent learned for the Review Critic subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.reviewcritic.working_memory", capacity = 84, decayRate = 0.040, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
