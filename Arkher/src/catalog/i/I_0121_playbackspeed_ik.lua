-- ARKHER SYSTEM I.0121 :: Playback Speed Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0121"
	S.key = "arkher.anim.playbackspeed.inverse_kinematics"
	S.name = "Playback Speed Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.playbackspeed.layered_blending" }
	S.tags = { "i", "playbackspeed", "ik", "anim" }
	S.description = "Playback Speed Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Playback Speed subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.playbackspeed.inverse_kinematics", iterations = 15, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
