-- ARKHER SYSTEM Q.0340 :: Safe Area Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0340"
	S.key = "arkher.ui.safearea.transition"
	S.name = "Safe Area Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Safe Area"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.safearea.input_mapping" }
	S.tags = { "q", "safearea", "tween", "ui" }
	S.description = "Safe Area Transition: eased, delayed, looped and sequenced motion for the Safe Area subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.safearea.transition", timeScale = 1.14 })
		inst.system = S
		inst.ctx = ctx
