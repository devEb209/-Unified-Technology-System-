-- ARKHER SYSTEM VB.0112 :: Temporal Slice Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0112"
	S.key = "arkher.conttime.temporalslice.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.temporalslice.sparse_residency" }
	S.tags = { "vb", "temporalslice", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.temporalslice.multi-scale_fidelity", levels = 5, baseTriangles = 135000 })
		inst.system = S
		inst.ctx = ctx
