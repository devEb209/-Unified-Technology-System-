-- ARKHER SYSTEM Z.0463 :: Narrative Memory Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0463"
	S.key = "arkher.origin.narrativememory.simulation_fabric"
	S.name = "Narrative Memory Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.complexity_governance" }
	S.tags = { "z", "narrativememory", "fabric", "origin" }
	S.description = "Narrative Memory Simulation Fabric: every simulation domain stepped under one budgeted clock for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.narrativememory.simulation_fabric", budgetMs = 1.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
