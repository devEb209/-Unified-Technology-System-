-- ARKHER SYSTEM K.0354 :: Behaviour State Machine Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0354"
	S.key = "arkher.npc.behaviourstate.emotion"
	S.name = "Behaviour State Machine Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourstate.drive_system" }
	S.tags = { "k", "behaviourstate", "emotion", "npc" }
	S.description = "Behaviour State Machine Emotion: appraisal of events into valence, arousal and mood for the Behaviour State Machine subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.behaviourstate.emotion", inertia = 0.83, decayRate = 0.48, baselineArousal = 0.18 })
		inst.system = S
		inst.ctx = ctx
