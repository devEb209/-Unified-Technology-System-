-- ARKHER SYSTEM K.0204 :: Emotional State Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0204"
	S.key = "arkher.npc.emotionalstate.goal_planner"
	S.name = "Emotional State Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.emotionalstate.utility_reasoning" }
	S.tags = { "k", "emotionalstate", "planner", "npc" }
	S.description = "Emotional State Goal Planner: backward GOAP planning to reach a goal state for the Emotional State subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.emotionalstate.goal_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
