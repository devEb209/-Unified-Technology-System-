-- ARKHER SYSTEM VD.0415 :: Behaviour Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0415"
	S.key = "arkher.contsim.behaviourcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.behaviourcont.coherence_guard" }
	S.tags = { "vd", "behaviourcont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.behaviourcont.neural_field", dims = 16, hidden = 12, seed = 97005 })
		inst.system = S
		inst.ctx = ctx
