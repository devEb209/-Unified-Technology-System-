-- ARKHER SYSTEM R.0030 :: Handshake Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0030"
	S.key = "arkher.net.handshake.serialization_codec"
	S.name = "Handshake Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Handshake"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.handshake.bandwidth_budget" }
	S.tags = { "r", "handshake", "codec", "net" }
	S.description = "Handshake Serialization Codec: compact encoding, diffing and checksum of payloads for the Handshake subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.handshake.serialization_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
