-- ARKHER SYSTEM E.0486 :: Material Variant Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0486"
	S.key = "arkher.material.variant.variant_registry"
	S.name = "Material Variant Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.variant.procedural_detail" }
	S.tags = { "e", "variant", "registry", "material" }
	S.description = "Material Variant Variant Registry: named variants and their lifecycle for the Material Variant subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.variant.variant_registry" })
		inst.system = S
		inst.ctx = ctx
