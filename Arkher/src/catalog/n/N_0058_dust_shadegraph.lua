-- ARKHER SYSTEM N.0058 :: Dust Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0058"
	S.key = "arkher.vfx.dust.effect_graph"
	S.name = "Dust Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Dust"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.dust.curve_authoring" }
	S.tags = { "n", "dust", "shadegraph", "vfx" }
	S.description = "Dust Effect Graph: node graph describing how the effect is shaded for the Dust subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.dust.effect_graph" })
		inst.system = S
		inst.ctx = ctx
