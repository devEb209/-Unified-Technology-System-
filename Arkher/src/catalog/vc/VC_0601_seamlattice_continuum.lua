-- ARKHER SYSTEM VC.0601 :: Seam Lattice Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0601"
	S.key = "arkher.contneural.seamlattice.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "seamlattice", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.seamlattice.infinite_grid", cellSize = 128, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
