-- ARKHER SYSTEM L.0352 :: Price Discovery Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0352"
	S.key = "arkher.sim.pricediscovery.route_network"
	S.name = "Price Discovery Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.pricediscovery.region_graph" }
	S.tags = { "l", "pricediscovery", "network", "sim" }
	S.description = "Price Discovery Route Network: roads, rivers and routes between settlements for the Price Discovery subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.pricediscovery.route_network" })
		inst.system = S
		inst.ctx = ctx
