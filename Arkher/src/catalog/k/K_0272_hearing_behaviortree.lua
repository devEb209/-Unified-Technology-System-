-- ARKHER SYSTEM K.0272 :: Hearing Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0272"
	S.key = "arkher.npc.hearing.reactive_behaviour"
	S.name = "Hearing Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hearing.perception" }
	S.tags = { "k", "hearing", "behaviortree", "npc" }
	S.description = "Hearing Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Hearing subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.hearing.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
