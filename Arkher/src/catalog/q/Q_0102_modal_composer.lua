-- ARKHER SYSTEM Q.0102 :: Modal Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0102"
	S.key = "arkher.ui.modal.theme_composition"
	S.name = "Modal Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Modal"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.modal.navigation_graph" }
	S.tags = { "q", "modal", "composer", "ui" }
	S.description = "Modal Theme Composition: blending of theme signals into the final appearance for the Modal subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.modal.theme_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
