-- ARKHER SYSTEM Z.1021 :: Autonomous Balancing Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.1021"
	S.key = "arkher.origin.autobalancing.reality_layering"
	S.name = "Autonomous Balancing Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "autobalancing", "reality", "origin" }
	S.description = "Autonomous Balancing Reality Layering: stacked authored, simulated, proposed and player realities for the Autonomous Balancing subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.autobalancing.reality_layering" })
		inst.system = S
		inst.ctx = ctx
