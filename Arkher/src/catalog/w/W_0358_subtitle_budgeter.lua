-- ARKHER SYSTEM W.0358 :: Subtitle Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0358"
	S.key = "arkher.cine.subtitle.frame_budget"
	S.name = "Subtitle Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Subtitle"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.subtitle.event_ledger" }
	S.tags = { "w", "subtitle", "budgeter", "cine" }
	S.description = "Subtitle Frame Budget: per-frame cost budget for the cinematic systems for the Subtitle subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.subtitle.frame_budget", total = 258, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
