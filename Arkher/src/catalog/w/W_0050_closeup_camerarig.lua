-- ARKHER SYSTEM W.0050 :: Close Up Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0050"
	S.key = "arkher.cine.closeup.camera_rig"
	S.name = "Close Up Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Close Up"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.closeup.sequence_timeline" }
	S.tags = { "w", "closeup", "camerarig", "cine" }
	S.description = "Close Up Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Close Up subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.closeup.camera_rig", fov = 1.30, focus = 14.0, aperture = 3.4, smoothing = 6.0, distance = 16, height = 6 })
		inst.system = S
		inst.ctx = ctx
