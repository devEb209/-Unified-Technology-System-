-- ARKHER SYSTEM V.0034 :: Texture Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0034"
	S.key = "arkher.asset.textureasset.validation_guard"
	S.name = "Texture Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.textureasset.size_budget" }
	S.tags = { "v", "textureasset", "guard", "asset" }
	S.description = "Texture Validation Guard: rate limiting and capability checks on the import path for the Texture subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.textureasset.validation_guard", algorithm = "sliding", capacity = 49, refillPerSec = 54, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
