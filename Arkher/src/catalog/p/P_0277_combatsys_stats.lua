-- ARKHER SYSTEM P.0277 :: Combat Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0277"
	S.key = "arkher.play.combatsys.attributes"
	S.name = "Combat Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Combat"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "combatsys", "stats", "play" }
	S.description = "Combat Attributes: base values, layered modifiers and derived statistics for the Combat subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.combatsys.attributes" })
		inst.system = S
		inst.ctx = ctx
