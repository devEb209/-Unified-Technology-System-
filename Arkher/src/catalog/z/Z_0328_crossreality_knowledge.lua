-- ARKHER SYSTEM Z.0328 :: Cross Reality Sync Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0328"
	S.key = "arkher.origin.crossreality.semantic_graph"
	S.name = "Cross Reality Sync Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.world_architect" }
	S.tags = { "z", "crossreality", "knowledge", "origin" }
	S.description = "Cross Reality Sync Semantic Graph: typed entities and inferred relations of the technology itself for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.crossreality.semantic_graph", dims = 24 })
		inst.system = S
		inst.ctx = ctx
