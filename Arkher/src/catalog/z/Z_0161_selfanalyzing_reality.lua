-- ARKHER SYSTEM Z.0161 :: Self Analyzing Project Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0161"
	S.key = "arkher.origin.selfanalyzing.reality_layering"
	S.name = "Self Analyzing Project Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "selfanalyzing", "reality", "origin" }
	S.description = "Self Analyzing Project Reality Layering: stacked authored, simulated, proposed and player realities for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.selfanalyzing.reality_layering" })
		inst.system = S
		inst.ctx = ctx
