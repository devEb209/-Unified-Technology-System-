-- ARKHER SYSTEM VA.0377 :: Dialogue Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0377"
	S.key = "arkher.contworld.dialoguecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.dialoguecont.multi-scale_fidelity" }
	S.tags = { "va", "dialoguecont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.dialoguecont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
