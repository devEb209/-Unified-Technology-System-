-- ARKHER SYSTEM VA.0497 :: Rendering Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0497"
	S.key = "arkher.contworld.rendercont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.rendercont.multi-scale_fidelity" }
	S.tags = { "va", "rendercont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.rendercont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
