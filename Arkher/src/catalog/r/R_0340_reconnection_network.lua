-- ARKHER SYSTEM R.0340 :: Reconnection Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0340"
	S.key = "arkher.net.reconnection.transport_graph"
	S.name = "Reconnection Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Reconnection"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reconnection.prediction_and_reconciliation" }
	S.tags = { "r", "reconnection", "network", "net" }
	S.description = "Reconnection Transport Graph: topology, capacity and routing between endpoints for the Reconnection subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.reconnection.transport_graph" })
		inst.system = S
		inst.ctx = ctx
