-- ARKHER SYSTEM H.0305 :: Capsule Collider Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0305"
	S.key = "arkher.physics.capsulecollider.result_cache"
	S.name = "Capsule Collider Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.capsulecollider.simulation_policy" }
	S.tags = { "h", "capsulecollider", "cache", "physics" }
	S.description = "Capsule Collider Result Cache: reuse of expensive simulation and query results for the Capsule Collider subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.capsulecollider.result_cache", policy = "ttl", capacity = 321, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
