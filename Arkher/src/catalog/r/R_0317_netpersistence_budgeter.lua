-- ARKHER SYSTEM R.0317 :: Data Persistence Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0317"
	S.key = "arkher.net.netpersistence.bandwidth_budget"
	S.name = "Data Persistence Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netpersistence.transport_graph" }
	S.tags = { "r", "netpersistence", "budgeter", "net" }
	S.description = "Data Persistence Bandwidth Budget: bytes per second shared between competing streams for the Data Persistence subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.netpersistence.bandwidth_budget", total = 153, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
