-- ARKHER SYSTEM W.0325 :: Exposure Ramp Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0325"
	S.key = "arkher.cine.exposureramp.sequence_timeline"
	S.name = "Exposure Ramp Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "exposureramp", "timeline", "cine" }
	S.description = "Exposure Ramp Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Exposure Ramp subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.exposureramp.sequence_timeline", duration = 5.0, rate = 0.97 })
		inst.system = S
		inst.ctx = ctx
