-- ARKHER SYSTEM F.0493 :: HLOD Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0493"
	S.key = "arkher.render.hlod.visibility_set"
	S.name = "HLOD Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "HLOD"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.hlod.view_and_culling" }
	S.tags = { "f", "hlod", "visibility", "render" }
	S.description = "HLOD Visibility Set: cell, portal and occluder visibility for the HLOD subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.hlod.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
