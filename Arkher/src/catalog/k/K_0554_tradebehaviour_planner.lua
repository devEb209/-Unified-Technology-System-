-- ARKHER SYSTEM K.0554 :: Trade Behaviour Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0554"
	S.key = "arkher.npc.tradebehaviour.goal_planner"
	S.name = "Trade Behaviour Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.tradebehaviour.utility_reasoning" }
	S.tags = { "k", "tradebehaviour", "planner", "npc" }
	S.description = "Trade Behaviour Goal Planner: backward GOAP planning to reach a goal state for the Trade Behaviour subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.tradebehaviour.goal_planner", maxDepth = 11 })
		inst.system = S
		inst.ctx = ctx
