-- ARKHER SYSTEM K.0659 :: Sleep Cycle Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0659"
	S.key = "arkher.npc.sleepcycle.mind_network"
	S.name = "Sleep Cycle Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "sleepcycle", "mindnet", "npc" }
	S.description = "Sleep Cycle Mind Network: the learned policy that turns perception into a decision for the Sleep Cycle subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.sleepcycle.mind_network", inputs = 8, hidden = 8, seed = 61254, learningRate = 0.070, exploration = 0.050 })
		inst.system = S
		inst.ctx = ctx
