-- ARKHER SYSTEM N.0061 :: Dust Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0061"
	S.key = "arkher.vfx.dust.result_cache"
	S.name = "Dust Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Dust"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.dust.spawn_budget" }
	S.tags = { "n", "dust", "cache", "vfx" }
	S.description = "Dust Result Cache: reuse of expensive effect evaluations for the Dust subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.dust.result_cache", policy = "lru", capacity = 347, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
