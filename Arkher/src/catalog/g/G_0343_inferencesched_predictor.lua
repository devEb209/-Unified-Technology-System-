-- ARKHER SYSTEM G.0343 :: Inference Scheduler Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0343"
	S.key = "arkher.neural.inferencesched.quality_predictor"
	S.name = "Inference Scheduler Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.inferencesched.weight_codec" }
	S.tags = { "g", "inferencesched", "predictor", "neural" }
	S.description = "Inference Scheduler Quality Predictor: predicted quality and cost of a setting for the Inference Scheduler subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.inferencesched.quality_predictor", method = "linear", alpha = 0.43, window = 57 })
		inst.system = S
		inst.ctx = ctx
