-- ARKHER SYSTEM VB.0529 :: Pipeline Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0529"
	S.key = "arkher.conttime.pipelinecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "pipelinecont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.pipelinecont.infinite_grid", cellSize = 224, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
