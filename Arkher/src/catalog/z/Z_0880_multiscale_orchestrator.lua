-- ARKHER SYSTEM Z.0880 :: Multi Scale Simulation Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0880"
	S.key = "arkher.origin.multiscale.orchestration"
	S.name = "Multi Scale Simulation Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.residency_streaming" }
	S.tags = { "z", "multiscale", "orchestrator", "origin" }
	S.description = "Multi Scale Simulation Orchestration: lifecycle and phase orchestration of the technology for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.multiscale.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
