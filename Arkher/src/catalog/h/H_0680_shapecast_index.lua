-- ARKHER SYSTEM H.0680 :: Shapecast Query Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0680"
	S.key = "arkher.physics.shapecast.broadphase_index"
	S.name = "Shapecast Query Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.shapecast.vehicle" }
	S.tags = { "h", "shapecast", "index", "physics" }
	S.description = "Shapecast Query Broadphase Index: spatial acceleration of candidate pair finding for the Shapecast Query subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.shapecast.broadphase_index", mode = "hash", cellSize = 72 })
		inst.system = S
		inst.ctx = ctx
