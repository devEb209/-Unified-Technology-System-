-- ARKHER SYSTEM VC.0288 :: Water Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0288"
	S.key = "arkher.contneural.watercont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.watercont.reality_continuum" }
	S.tags = { "vc", "watercont", "emergence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.watercont.emergence_continuum", windowSize = 6, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
