-- ARKHER SYSTEM I.0069 :: Keyframe Track Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0069"
	S.key = "arkher.anim.keytrack.inverse_kinematics"
	S.name = "Keyframe Track Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.keytrack.layered_blending" }
	S.tags = { "i", "keytrack", "ik", "anim" }
	S.description = "Keyframe Track Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Keyframe Track subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.keytrack.inverse_kinematics", iterations = 8, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
