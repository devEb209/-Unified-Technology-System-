-- ARKHER SYSTEM G.0018 :: Temporal Reconstruction Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0018"
	S.key = "arkher.neural.temporalrecon.reconstruction"
	S.name = "Temporal Reconstruction Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.temporalrecon.temporal_history" }
	S.tags = { "g", "temporalrecon", "upscaler", "neural" }
	S.description = "Temporal Reconstruction Reconstruction: resolution ladder and image reconstruction for the Temporal Reconstruction subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.temporalrecon.reconstruction", targetMs = 13.10, index = 5, sharpness = 0.58 })
		inst.system = S
		inst.ctx = ctx
