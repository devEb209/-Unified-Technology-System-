-- ARKHER SYSTEM F.0438 :: Portal Culling Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0438"
	S.key = "arkher.render.portal.geometry_virtualization"
	S.name = "Portal Culling Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.portal.visibility_set" }
	S.tags = { "f", "portal", "impostor", "render" }
	S.description = "Portal Culling Geometry Virtualization: impostor and HLOD synthesis under a budget for the Portal Culling subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.portal.geometry_virtualization", atlasSlots = 112, viewCount = 8, errorThreshold = 2.10 })
		inst.system = S
		inst.ctx = ctx
