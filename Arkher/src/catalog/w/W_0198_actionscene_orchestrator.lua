-- ARKHER SYSTEM W.0198 :: Action Scene Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0198"
	S.key = "arkher.cine.actionscene.playback_orchestrator"
	S.name = "Action Scene Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Action Scene"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.actionscene.cut_policy" }
	S.tags = { "w", "actionscene", "orchestrator", "cine" }
	S.description = "Action Scene Playback Orchestrator: the state machine that drives a cinematic from start to end for the Action Scene subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.actionscene.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
