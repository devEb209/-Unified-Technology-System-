-- ARKHER SYSTEM G.0200 :: Ambient Occlusion Prediction Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0200"
	S.key = "arkher.neural.aopredict.reconstruction"
	S.name = "Ambient Occlusion Prediction Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.aopredict.temporal_history" }
	S.tags = { "g", "aopredict", "upscaler", "neural" }
	S.description = "Ambient Occlusion Prediction Reconstruction: resolution ladder and image reconstruction for the Ambient Occlusion Prediction subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.aopredict.reconstruction", targetMs = 11.10, index = 3, sharpness = 0.40 })
		inst.system = S
		inst.ctx = ctx
