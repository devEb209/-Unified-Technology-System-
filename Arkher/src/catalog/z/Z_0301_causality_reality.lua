-- ARKHER SYSTEM Z.0301 :: Causality Ledger Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0301"
	S.key = "arkher.origin.causality.reality_layering"
	S.name = "Causality Ledger Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "causality", "reality", "origin" }
	S.description = "Causality Ledger Reality Layering: stacked authored, simulated, proposed and player realities for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.causality.reality_layering" })
		inst.system = S
		inst.ctx = ctx
