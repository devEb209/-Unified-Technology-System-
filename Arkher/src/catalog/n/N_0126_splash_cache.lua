-- ARKHER SYSTEM N.0126 :: Water Splash Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0126"
	S.key = "arkher.vfx.splash.result_cache"
	S.name = "Water Splash Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Water Splash"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.splash.spawn_budget" }
	S.tags = { "n", "splash", "cache", "vfx" }
	S.description = "Water Splash Result Cache: reuse of expensive effect evaluations for the Water Splash subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.splash.result_cache", policy = "lfu", capacity = 430, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
