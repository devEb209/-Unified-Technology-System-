-- ARKHER SYSTEM L.0561 :: World Event Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0561"
	S.key = "arkher.sim.worldevent.region_graph"
	S.name = "World Event Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldevent.calendar" }
	S.tags = { "l", "worldevent", "graph", "sim" }
	S.description = "World Event Region Graph: connectivity, components and shortest path between places for the World Event subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.worldevent.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
