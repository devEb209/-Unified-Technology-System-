-- ARKHER SYSTEM K.0634 :: Gossip Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0634"
	S.key = "arkher.npc.gossip.emotion"
	S.name = "Gossip Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.gossip.drive_system" }
	S.tags = { "k", "gossip", "emotion", "npc" }
	S.description = "Gossip Emotion: appraisal of events into valence, arousal and mood for the Gossip subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.gossip.emotion", inertia = 0.94, decayRate = 0.29, baselineArousal = 0.29 })
		inst.system = S
		inst.ctx = ctx
