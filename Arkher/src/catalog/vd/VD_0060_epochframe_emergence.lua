-- ARKHER SYSTEM VD.0060 :: Epoch Frame Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0060"
	S.key = "arkher.contsim.epochframe.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.epochframe.reality_continuum" }
	S.tags = { "vd", "epochframe", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.epochframe.emergence_continuum", windowSize = 6, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
