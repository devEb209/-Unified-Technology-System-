-- ARKHER SYSTEM P.0157 :: Gathering Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0157"
	S.key = "arkher.play.gathering.attributes"
	S.name = "Gathering Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Gathering"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "gathering", "stats", "play" }
	S.description = "Gathering Attributes: base values, layered modifiers and derived statistics for the Gathering subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.gathering.attributes" })
		inst.system = S
		inst.ctx = ctx
