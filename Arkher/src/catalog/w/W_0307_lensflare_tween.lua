-- ARKHER SYSTEM W.0307 :: Lens Flare Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0307"
	S.key = "arkher.cine.lensflare.motion_tween"
	S.name = "Lens Flare Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Lens Flare"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.lensflare.playback_orchestrator" }
	S.tags = { "w", "lensflare", "tween", "cine" }
	S.description = "Lens Flare Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Lens Flare subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.lensflare.motion_tween", timeScale = 1.09 })
		inst.system = S
		inst.ctx = ctx
