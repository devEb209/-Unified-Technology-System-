-- ARKHER SYSTEM W.0016 :: Sequence Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0016"
	S.key = "arkher.cine.sequence.shot_composition"
	S.name = "Sequence Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Sequence"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.sequence.colour_grade" }
	S.tags = { "w", "sequence", "composer", "cine" }
	S.description = "Sequence Shot Composition: blending of the signals that make up the final shot for the Sequence subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.sequence.shot_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
