-- ARKHER SYSTEM V.0333 :: Bundle Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0333"
	S.key = "arkher.asset.bundle.size_budget"
	S.name = "Bundle Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.bundle.compression_codec" }
	S.tags = { "v", "bundle", "budgeter", "asset" }
	S.description = "Bundle Size Budget: byte budget shared between competing asset classes for the Bundle subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.bundle.size_budget", total = 78, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
