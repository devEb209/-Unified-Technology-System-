-- ARKHER SYSTEM VB.0024 :: Region Tile Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0024"
	S.key = "arkher.conttime.regiontile.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.regiontile.reality_continuum" }
	S.tags = { "vb", "regiontile", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.regiontile.emergence_continuum", windowSize = 7, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
