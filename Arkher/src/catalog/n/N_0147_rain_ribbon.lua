-- ARKHER SYSTEM N.0147 :: Rain Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0147"
	S.key = "arkher.vfx.rain.ribbon_and_trail"
	S.name = "Rain Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Rain"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.rain.force_field" }
	S.tags = { "n", "rain", "ribbon", "vfx" }
	S.description = "Rain Ribbon And Trail: trail points, tapering, beams and decimation for the Rain subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.rain.ribbon_and_trail", maxPoints = 48, lifetime = 0.50, minDistance = 0.10, width = 0.60 })
		inst.system = S
		inst.ctx = ctx
