-- ARKHER SYSTEM G.0251 :: Behaviour Prediction Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0251"
	S.key = "arkher.neural.behaviorpredict.sampling_graph"
	S.name = "Behaviour Prediction Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.behaviorpredict.training_ledger" }
	S.tags = { "g", "behaviorpredict", "graph", "neural" }
	S.description = "Behaviour Prediction Sampling Graph: dependency graph of sampling stages for the Behaviour Prediction subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.behaviorpredict.sampling_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
