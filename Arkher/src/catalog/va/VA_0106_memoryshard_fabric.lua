-- ARKHER SYSTEM VA.0106 :: Memory Shard Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0106"
	S.key = "arkher.contworld.memoryshard.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memoryshard.complexity_budget" }
	S.tags = { "va", "memoryshard", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.memoryshard.simulation_fabric", budgetMs = 3.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
