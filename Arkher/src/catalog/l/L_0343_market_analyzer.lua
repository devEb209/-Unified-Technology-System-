-- ARKHER SYSTEM L.0343 :: Market Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0343"
	S.key = "arkher.sim.market.analysis"
	S.name = "Market Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.market.aggregate_cache" }
	S.tags = { "l", "market", "analyzer", "sim" }
	S.description = "Market Analysis: trend, anomaly and stability analysis of the world for the Market subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.market.analysis", window = 121, buckets = 13, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
