-- ARKHER SYSTEM Q.0292 :: Gesture Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0292"
	S.key = "arkher.ui.gesture.transition"
	S.name = "Gesture Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Gesture"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.gesture.input_mapping" }
	S.tags = { "q", "gesture", "tween", "ui" }
	S.description = "Gesture Transition: eased, delayed, looped and sequenced motion for the Gesture subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.gesture.transition", timeScale = 0.93 })
		inst.system = S
		inst.ctx = ctx
