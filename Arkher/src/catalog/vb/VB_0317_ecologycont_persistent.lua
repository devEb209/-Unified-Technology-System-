-- ARKHER SYSTEM VB.0317 :: Ecology Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0317"
	S.key = "arkher.conttime.ecologycont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.ecologycont.multi-scale_fidelity" }
	S.tags = { "vb", "ecologycont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.ecologycont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
