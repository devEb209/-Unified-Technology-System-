-- ARKHER SYSTEM VA.0407 :: Perception Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0407"
	S.key = "arkher.contworld.perceptioncont.reality_continuum"
	S.name = "Perception Continuum Reality Continuum"
	S.category = "VA"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.perceptioncont.simulation_fabric" }
	S.tags = { "va", "perceptioncont", "reality", "contworld" }
	S.description = "Perception Continuum Reality Continuum: stacked reality layers of the continuum for the Perception Continuum subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.perceptioncont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
