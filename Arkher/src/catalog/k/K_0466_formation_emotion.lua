-- ARKHER SYSTEM K.0466 :: Formation Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0466"
	S.key = "arkher.npc.formation.emotion"
	S.name = "Formation Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.formation.drive_system" }
	S.tags = { "k", "formation", "emotion", "npc" }
	S.description = "Formation Emotion: appraisal of events into valence, arousal and mood for the Formation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.formation.emotion", inertia = 0.88, decayRate = 0.43, baselineArousal = 0.23 })
		inst.system = S
		inst.ctx = ctx
