-- ARKHER SYSTEM J.0289 :: Character LOD Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0289"
	S.key = "arkher.character.characterlod.blend_controller"
	S.name = "Character LOD Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterlod.motion_set" }
	S.tags = { "j", "characterlod", "animator", "character" }
	S.description = "Character LOD Blend Controller: layered playback driving the character for the Character LOD subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.characterlod.blend_controller", budget = 8 })
		inst.system = S
		inst.ctx = ctx
