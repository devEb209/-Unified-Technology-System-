-- ARKHER SYSTEM N.0348 :: Beam Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0348"
	S.key = "arkher.vfx.beam.quality_policy"
	S.name = "Beam Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Beam"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.beam.result_cache" }
	S.tags = { "n", "beam", "policy", "vfx" }
	S.description = "Beam Quality Policy: distance and device driven fidelity bands for the Beam subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.beam.quality_policy", algorithm = "roundrobin", starvationGuard = 44 })
		inst.system = S
		inst.ctx = ctx
