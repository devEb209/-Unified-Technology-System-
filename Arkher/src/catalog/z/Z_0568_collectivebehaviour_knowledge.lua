-- ARKHER SYSTEM Z.0568 :: Collective Behaviour Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0568"
	S.key = "arkher.origin.collectivebehaviour.semantic_graph"
	S.name = "Collective Behaviour Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.collectivebehaviour.world_architect" }
	S.tags = { "z", "collectivebehaviour", "knowledge", "origin" }
	S.description = "Collective Behaviour Semantic Graph: typed entities and inferred relations of the technology itself for the Collective Behaviour subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.collectivebehaviour.semantic_graph", dims = 48 })
		inst.system = S
		inst.ctx = ctx
