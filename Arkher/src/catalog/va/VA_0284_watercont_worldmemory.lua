-- ARKHER SYSTEM VA.0284 :: Water Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0284"
	S.key = "arkher.contworld.watercont.world_memory_stream"
	S.name = "Water Continuum World Memory Stream"
	S.category = "VA"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.watercont.neural_field" }
	S.tags = { "va", "watercont", "worldmemory", "contworld" }
	S.description = "Water Continuum World Memory Stream: world memory continuum over epochs for the Water Continuum subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.watercont.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
