-- ARKHER SYSTEM K.0678 :: NPC LOD Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0678"
	S.key = "arkher.npc.npclod.reactive_behaviour"
	S.name = "NPC LOD Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npclod.perception" }
	S.tags = { "k", "npclod", "behaviortree", "npc" }
	S.description = "NPC LOD Reactive Behaviour: sequences, selectors, decorators and cooldowns for the NPC LOD subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.npclod.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
