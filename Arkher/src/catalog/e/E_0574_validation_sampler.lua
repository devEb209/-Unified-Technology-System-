-- ARKHER SYSTEM E.0574 :: Material Validation Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0574"
	S.key = "arkher.material.validation.texture_sampling"
	S.name = "Material Validation Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.validation.shading_graph" }
	S.tags = { "e", "validation", "sampler", "material" }
	S.description = "Material Validation Texture Sampling: atlas packing, mip chain and filtered sampling for the Material Validation subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.validation.texture_sampling", atlasSize = 256, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
