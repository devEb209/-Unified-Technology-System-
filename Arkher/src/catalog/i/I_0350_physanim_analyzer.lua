-- ARKHER SYSTEM I.0350 :: Physical Animation Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0350"
	S.key = "arkher.anim.physanim.analysis"
	S.name = "Physical Animation Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.physanim.quality_policy" }
	S.tags = { "i", "physanim", "analyzer", "anim" }
	S.description = "Physical Animation Analysis: pop, drift and cost analysis of playback for the Physical Animation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.physanim.analysis", window = 196, buckets = 8, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
