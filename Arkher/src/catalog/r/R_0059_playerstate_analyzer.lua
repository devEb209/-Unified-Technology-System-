-- ARKHER SYSTEM R.0059 :: Player State Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0059"
	S.key = "arkher.net.playerstate.latency_analysis"
	S.name = "Player State Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Player State"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.playerstate.audit_ledger" }
	S.tags = { "r", "playerstate", "analyzer", "net" }
	S.description = "Player State Latency Analysis: round trip, jitter and loss analysis for the Player State subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.playerstate.latency_analysis", window = 151, buckets = 19, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
