-- ARKHER SYSTEM VB.0596 :: Horizon Span World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0596"
	S.key = "arkher.conttime.horizonspan.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.horizonspan.neural_field" }
	S.tags = { "vb", "horizonspan", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.horizonspan.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
