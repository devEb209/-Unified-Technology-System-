-- ARKHER SYSTEM I.0243 :: Locomotion Blend Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0243"
	S.key = "arkher.anim.locomotionblend.playback_pipeline"
	S.name = "Locomotion Blend Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.locomotionblend.event_ledger" }
	S.tags = { "i", "locomotionblend", "pipeline", "anim" }
	S.description = "Locomotion Blend Playback Pipeline: ordered sample, blend, ik and output stages for the Locomotion Blend subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.locomotionblend.playback_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
