-- ARKHER SYSTEM VD.0538 :: Pipeline Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0538"
	S.key = "arkher.contsim.pipelinecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.pipelinecont.complexity_budget" }
	S.tags = { "vd", "pipelinecont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.pipelinecont.simulation_fabric", budgetMs = 1.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
