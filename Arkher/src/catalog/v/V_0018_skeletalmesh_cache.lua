-- ARKHER SYSTEM V.0018 :: Skeletal Mesh Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0018"
	S.key = "arkher.asset.skeletalmesh.content_cache"
	S.name = "Skeletal Mesh Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.skeletalmesh.dependency_graph" }
	S.tags = { "v", "skeletalmesh", "cache", "asset" }
	S.description = "Skeletal Mesh Content Cache: reuse of already cooked results for the Skeletal Mesh subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.skeletalmesh.content_cache", policy = "lru", capacity = 103, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
