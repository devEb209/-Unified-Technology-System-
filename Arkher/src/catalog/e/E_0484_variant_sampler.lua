-- ARKHER SYSTEM E.0484 :: Material Variant Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0484"
	S.key = "arkher.material.variant.texture_sampling"
	S.name = "Material Variant Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.variant.shading_graph" }
	S.tags = { "e", "variant", "sampler", "material" }
	S.description = "Material Variant Texture Sampling: atlas packing, mip chain and filtered sampling for the Material Variant subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.variant.texture_sampling", atlasSize = 320, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
