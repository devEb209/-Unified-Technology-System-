-- ARKHER SYSTEM VD.0406 :: Perception Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0406"
	S.key = "arkher.contsim.perceptioncont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.perceptioncont.complexity_budget" }
	S.tags = { "vd", "perceptioncont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.perceptioncont.simulation_fabric", budgetMs = 2.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
