-- ARKHER SYSTEM K.0245 :: Temperament Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0245"
	S.key = "arkher.npc.temperament.utility_reasoning"
	S.name = "Temperament Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.temperament.reactive_behaviour" }
	S.tags = { "k", "temperament", "utility", "npc" }
	S.description = "Temperament Utility Reasoning: scored option selection with response curves for the Temperament subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.temperament.utility_reasoning", momentum = 0.07 })
		inst.system = S
		inst.ctx = ctx
