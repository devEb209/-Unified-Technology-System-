-- ARKHER SYSTEM N.0133 :: Waterfall Mist Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0133"
	S.key = "arkher.vfx.mist.force_field"
	S.name = "Waterfall Mist Force Field"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.mist.particle_simulation" }
	S.tags = { "n", "mist", "forcefield", "vfx" }
	S.description = "Waterfall Mist Force Field: wind, attraction, vortex, drag and curl turbulence for the Waterfall Mist subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.mist.force_field", seed = 53520 })
		inst.system = S
		inst.ctx = ctx
