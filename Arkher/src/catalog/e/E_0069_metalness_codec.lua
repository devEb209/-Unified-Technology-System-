-- ARKHER SYSTEM E.0069 :: Metalness Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0069"
	S.key = "arkher.material.metalness.compression_codec"
	S.name = "Metalness Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Metalness"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.metalness.streaming" }
	S.tags = { "e", "metalness", "codec", "material" }
	S.description = "Metalness Compression Codec: serialization and compression of material data for the Metalness subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.metalness.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
