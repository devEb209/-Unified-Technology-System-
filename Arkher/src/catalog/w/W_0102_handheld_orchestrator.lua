-- ARKHER SYSTEM W.0102 :: Handheld Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0102"
	S.key = "arkher.cine.handheld.playback_orchestrator"
	S.name = "Handheld Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Handheld"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.handheld.cut_policy" }
	S.tags = { "w", "handheld", "orchestrator", "cine" }
	S.description = "Handheld Playback Orchestrator: the state machine that drives a cinematic from start to end for the Handheld subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.handheld.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
