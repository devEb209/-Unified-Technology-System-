-- ARKHER SYSTEM VD.0473 :: VFX Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0473"
	S.key = "arkher.contsim.vfxcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vfxcont.multi-scale_fidelity" }
	S.tags = { "vd", "vfxcont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.vfxcont.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
