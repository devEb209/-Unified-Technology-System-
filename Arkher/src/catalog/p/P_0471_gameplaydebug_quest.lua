-- ARKHER SYSTEM P.0471 :: Gameplay Debug Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0471"
	S.key = "arkher.play.gameplaydebug.objectives"
	S.name = "Gameplay Debug Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.gameplaydebug.inventory" }
	S.tags = { "p", "gameplaydebug", "quest", "play" }
	S.description = "Gameplay Debug Objectives: objectives, prerequisites, progress and rewards for the Gameplay Debug subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.gameplaydebug.objectives" })
		inst.system = S
		inst.ctx = ctx
