-- ARKHER SYSTEM L.0430 :: Law Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0430"
	S.key = "arkher.sim.law.streaming"
	S.name = "Law Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.law.state_codec" }
	S.tags = { "l", "law", "streamer", "sim" }
	S.description = "Law Streaming: distance-driven residency of simulated regions for the Law subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.law.streaming", radius = 280, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
