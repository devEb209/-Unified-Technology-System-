-- ARKHER SYSTEM W.0271 :: Letterbox Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0271"
	S.key = "arkher.cine.letterbox.motion_tween"
	S.name = "Letterbox Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Letterbox"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.letterbox.playback_orchestrator" }
	S.tags = { "w", "letterbox", "tween", "cine" }
	S.description = "Letterbox Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Letterbox subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.letterbox.motion_tween", timeScale = 0.92 })
		inst.system = S
		inst.ctx = ctx
