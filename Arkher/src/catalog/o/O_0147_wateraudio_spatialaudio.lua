-- ARKHER SYSTEM O.0147 :: Water Audio Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0147"
	S.key = "arkher.audio.wateraudio.spatialization"
	S.name = "Water Audio Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Water Audio"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.wateraudio.mixer_bus" }
	S.tags = { "o", "wateraudio", "spatialaudio", "audio" }
	S.description = "Water Audio Spatialization: distance attenuation, panning, occlusion and doppler for the Water Audio subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.wateraudio.spatialization", model = "exponential", refDistance = 5, maxDistance = 240, rolloff = 1.08, maxVoices = 20 })
		inst.system = S
		inst.ctx = ctx
