-- ARKHER SYSTEM H.0482 :: Ball Joint Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0482"
	S.key = "arkher.physics.balljoint.character_motion"
	S.name = "Ball Joint Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Ball Joint"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.balljoint.query" }
	S.tags = { "h", "balljoint", "charmotor", "physics" }
	S.description = "Ball Joint Character Motion: capsule move-and-slide with slopes, steps and jumps for the Ball Joint subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.balljoint.character_motion", radius = 0.48, height = 1.93, maxSpeed = 7.30, jumpHeight = 2.10, stepOffset = 0.28 })
		inst.system = S
		inst.ctx = ctx
