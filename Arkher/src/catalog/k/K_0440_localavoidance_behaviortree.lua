-- ARKHER SYSTEM K.0440 :: Local Avoidance Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0440"
	S.key = "arkher.npc.localavoidance.reactive_behaviour"
	S.name = "Local Avoidance Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.localavoidance.perception" }
	S.tags = { "k", "localavoidance", "behaviortree", "npc" }
	S.description = "Local Avoidance Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Local Avoidance subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.localavoidance.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
