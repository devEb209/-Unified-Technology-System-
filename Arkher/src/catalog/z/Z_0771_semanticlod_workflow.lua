-- ARKHER SYSTEM Z.0771 :: Semantic LOD Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0771"
	S.key = "arkher.origin.semanticlod.adaptive_workflow"
	S.name = "Semantic LOD Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticlod.self_critique" }
	S.tags = { "z", "semanticlod", "workflow", "origin" }
	S.description = "Semantic LOD Adaptive Workflow: verified, retryable, reversible execution plans for the Semantic LOD subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.semanticlod.adaptive_workflow", maxRetries = 1, budget = 100 })
		inst.system = S
		inst.ctx = ctx
