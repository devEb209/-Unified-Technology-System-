-- ARKHER SYSTEM E.0400 :: Texture Atlas Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0400"
	S.key = "arkher.material.atlas.quality_policy"
	S.name = "Texture Atlas Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.atlas.compression_codec" }
	S.tags = { "e", "atlas", "policy", "material" }
	S.description = "Texture Atlas Quality Policy: device tier rules for the surface for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.atlas.quality_policy", algorithm = "wfq", starvationGuard = 34 })
		inst.system = S
		inst.ctx = ctx
