-- ARKHER SYSTEM VB.0242 :: Vegetation Field Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0242"
	S.key = "arkher.conttime.vegfield.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vegfield.infinite_grid" }
	S.tags = { "vb", "vegfield", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.vegfield.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
