-- ARKHER SYSTEM V.0165 :: Particle Asset Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0165"
	S.key = "arkher.asset.particleasset.size_budget"
	S.name = "Particle Asset Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.particleasset.compression_codec" }
	S.tags = { "v", "particleasset", "budgeter", "asset" }
	S.description = "Particle Asset Size Budget: byte budget shared between competing asset classes for the Particle Asset subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.particleasset.size_budget", total = 202, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
