-- ARKHER SYSTEM VA.0266 :: Bridge Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0266"
	S.key = "arkher.contworld.bridgecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.bridgecont.infinite_grid" }
	S.tags = { "va", "bridgecont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.bridgecont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
