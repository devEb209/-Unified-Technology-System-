-- ARKHER SYSTEM W.0283 :: Depth Of Field Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0283"
	S.key = "arkher.cine.depthoffield.motion_tween"
	S.name = "Depth Of Field Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.depthoffield.playback_orchestrator" }
	S.tags = { "w", "depthoffield", "tween", "cine" }
	S.description = "Depth Of Field Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.depthoffield.motion_tween", timeScale = 1.06 })
		inst.system = S
		inst.ctx = ctx
