-- ARKHER SYSTEM H.0467 :: Hinge Joint Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0467"
	S.key = "arkher.physics.hingejoint.query"
	S.name = "Hinge Joint Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Hinge Joint"
	S.aspect = "Query"
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.hingejoint.constraint_solver" }
	S.tags = { "h", "hingejoint", "raycaster", "physics" }
	S.description = "Hinge Joint Query: rays, sweeps and overlaps against the simulation for the Hinge Joint subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.hingejoint.query", cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
