-- ARKHER SYSTEM VB.0132 :: Spatial Slice Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0132"
	S.key = "arkher.conttime.spatialslice.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.spatialslice.reality_continuum" }
	S.tags = { "vb", "spatialslice", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.spatialslice.emergence_continuum", windowSize = 6, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
