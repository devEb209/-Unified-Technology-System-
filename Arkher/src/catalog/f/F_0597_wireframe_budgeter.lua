-- ARKHER SYSTEM F.0597 :: Wireframe Overlay Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0597"
	S.key = "arkher.render.wireframe.draw_budget"
	S.name = "Wireframe Overlay Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.wireframe.adaptive_resolution" }
	S.tags = { "f", "wireframe", "budgeter", "render" }
	S.description = "Wireframe Overlay Draw Budget: draw call and triangle budget allocation for the Wireframe Overlay subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.wireframe.draw_budget", total = 137, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
