-- ARKHER SYSTEM K.0234 :: Personality Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0234"
	S.key = "arkher.npc.personality.crowd_steering"
	S.name = "Personality Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.personality.navigation" }
	S.tags = { "k", "personality", "crowd", "npc" }
	S.description = "Personality Crowd Steering: local avoidance, cohesion and arrival at scale for the Personality subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.personality.crowd_steering", radius = 0.80, maxSpeed = 5.80, cellSize = 10 })
		inst.system = S
		inst.ctx = ctx
