-- ARKHER SYSTEM R.0064 :: Entity Replication Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0064"
	S.key = "arkher.net.entityreplication.transport_graph"
	S.name = "Entity Replication Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.entityreplication.prediction_and_reconciliation" }
	S.tags = { "r", "entityreplication", "network", "net" }
	S.description = "Entity Replication Transport Graph: topology, capacity and routing between endpoints for the Entity Replication subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.entityreplication.transport_graph" })
		inst.system = S
		inst.ctx = ctx
