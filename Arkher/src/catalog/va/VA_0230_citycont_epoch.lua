-- ARKHER SYSTEM VA.0230 :: City Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0230"
	S.key = "arkher.contworld.citycont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.citycont.infinite_grid" }
	S.tags = { "va", "citycont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.citycont.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
