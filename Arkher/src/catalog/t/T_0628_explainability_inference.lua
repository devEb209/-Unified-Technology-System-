-- ARKHER SYSTEM T.0628 :: Explainability Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0628"
	S.key = "arkher.ai.explainability.model_inference"
	S.name = "Explainability Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.explainability.action_planner" }
	S.tags = { "t", "explainability", "inference", "ai" }
	S.description = "Explainability Model Inference: quantized inference with batching and budget for the Explainability subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.explainability.model_inference", seed = 41733 })
		inst.system = S
		inst.ctx = ctx
