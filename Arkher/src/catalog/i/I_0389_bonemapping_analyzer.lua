-- ARKHER SYSTEM I.0389 :: Bone Mapping Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0389"
	S.key = "arkher.anim.bonemapping.analysis"
	S.name = "Bone Mapping Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bone Mapping"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonemapping.quality_policy" }
	S.tags = { "i", "bonemapping", "analyzer", "anim" }
	S.description = "Bone Mapping Analysis: pop, drift and cost analysis of playback for the Bone Mapping subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.bonemapping.analysis", window = 176, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
