--!strict
-- RAGE ImGui — ANIMATION Stack #0155
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="RAGE ImGui — ANIMATION Stack #0155", size=Vector2.new(680, 420), pos=UDim2.fromOffset(115, 115), parent=parent, icon="◉"})
