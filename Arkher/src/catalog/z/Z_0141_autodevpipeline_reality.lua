-- ARKHER SYSTEM Z.0141 :: Autonomous Development Pipeline Reality Layering
...
-- Kit: reality (stacked authored, simulated, proposed and player realities)
--@arkher-module
return function(A)
	...
	local S = {}
	S.id = "Z.0141"
	S.key = "arkher.origin.autodevpipeline.reality_layering"
	S.name = "Autonomous Development Pipeline Reality Layering"
	S.category = "Z"
	S.family = "ARKHER ORIGINAL TECHNOLOGIES"
	S.area = "Autonomous Development Pipeline"
	S.aspect = "Reality Layering"
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "autodevpipeline", "reality", "origin" }
	S.description = "Autonomous Development Pipeline Reality Layering: stacked authored, simulated, proposed and player realities for the Autonomous Development Pipeline subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.autodevpipeline.reality_layering" })
		inst.system = S
		inst.ctx = ctx
