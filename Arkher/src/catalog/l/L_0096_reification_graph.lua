-- ARKHER SYSTEM L.0096 :: Reification Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0096"
	S.key = "arkher.sim.reification.region_graph"
	S.name = "Reification Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.reification.calendar" }
	S.tags = { "l", "reification", "graph", "sim" }
	S.description = "Reification Region Graph: connectivity, components and shortest path between places for the Reification subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.reification.region_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
