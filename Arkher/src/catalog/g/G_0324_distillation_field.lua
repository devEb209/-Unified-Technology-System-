-- ARKHER SYSTEM G.0324 :: Model Distillation Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0324"
	S.key = "arkher.neural.distillation.feature_extraction"
	S.name = "Model Distillation Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.distillation.inference_core" }
	S.tags = { "g", "distillation", "field", "neural" }
	S.description = "Model Distillation Feature Extraction: signal features feeding the model for the Model Distillation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.distillation.feature_extraction", seed = 41908, frequency = 0.0110, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
