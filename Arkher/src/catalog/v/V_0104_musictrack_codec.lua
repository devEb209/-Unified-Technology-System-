-- ARKHER SYSTEM V.0104 :: Music Track Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0104"
	S.key = "arkher.asset.musictrack.compression_codec"
	S.name = "Music Track Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.musictrack.streaming_residency" }
	S.tags = { "v", "musictrack", "codec", "asset" }
	S.description = "Music Track Compression Codec: compact encoding, diffing and checksum of asset payloads for the Music Track subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.musictrack.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
