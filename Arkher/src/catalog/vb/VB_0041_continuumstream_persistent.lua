-- ARKHER SYSTEM VB.0041 :: Continuum Stream Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0041"
	S.key = "arkher.conttime.continuumstream.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.continuumstream.multi-scale_fidelity" }
	S.tags = { "vb", "continuumstream", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.continuumstream.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
