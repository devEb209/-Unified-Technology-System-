-- ARKHER SYSTEM N.0407 :: Wind Gust Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0407"
	S.key = "arkher.vfx.windgust.ribbon_and_trail"
	S.name = "Wind Gust Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Wind Gust"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.windgust.force_field" }
	S.tags = { "n", "windgust", "ribbon", "vfx" }
	S.description = "Wind Gust Ribbon And Trail: trail points, tapering, beams and decimation for the Wind Gust subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.windgust.ribbon_and_trail", maxPoints = 32, lifetime = 0.50, minDistance = 0.10, width = 1.00 })
		inst.system = S
		inst.ctx = ctx
