-- ARKHER SYSTEM VC.0219 :: Terrain Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0219"
	S.key = "arkher.contneural.terraincont.sparse_residency"
	S.name = "Terrain Continuum Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.terraincont.epoch_clock" }
	S.tags = { "vc", "terraincont", "sparse", "contneural" }
	S.description = "Terrain Continuum Sparse Residency: sparse page residency with eviction and compression for the Terrain Continuum subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.terraincont.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
