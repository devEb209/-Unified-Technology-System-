-- ARKHER SYSTEM VC.0241 :: Vegetation Field Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0241"
	S.key = "arkher.contneural.vegfield.infinite_grid"
	S.name = "Vegetation Field Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "vegfield", "continuum", "contneural" }
	S.description = "Vegetation Field Infinite Grid: seamless paging of the infinite world grid for the Vegetation Field subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.vegfield.infinite_grid", cellSize = 224, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
