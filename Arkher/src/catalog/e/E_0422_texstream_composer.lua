-- ARKHER SYSTEM E.0422 :: Texture Streaming Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0422"
	S.key = "arkher.material.texstream.layer_composition"
	S.name = "Texture Streaming Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.texstream.definition" }
	S.tags = { "e", "texstream", "composer", "material" }
	S.description = "Texture Streaming Layer Composition: ordered layer composition with blend rules for the Texture Streaming subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.texstream.layer_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
