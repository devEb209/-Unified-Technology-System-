-- ARKHER SYSTEM T.0598 :: Deployment Reasoning Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0598"
	S.key = "arkher.ai.deploymentreasoning.utility_selection"
	S.name = "Deployment Reasoning Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.deploymentreasoning.working_memory" }
	S.tags = { "t", "deploymentreasoning", "utility", "ai" }
	S.description = "Deployment Reasoning Utility Selection: scored choice between competing courses of action for the Deployment Reasoning subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.deploymentreasoning.utility_selection", momentum = 0.16 })
		inst.system = S
		inst.ctx = ctx
