-- ARKHER SYSTEM T.0567 :: Pipeline Automation Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0567"
	S.key = "arkher.ai.pipelineautomation.decision_policy"
	S.name = "Pipeline Automation Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.pipelineautomation.reasoning_graph" }
	S.tags = { "t", "pipelineautomation", "policy", "ai" }
	S.description = "Pipeline Automation Decision Policy: ordered rules deciding what the agent does next for the Pipeline Automation subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.pipelineautomation.decision_policy", algorithm = "lottery", starvationGuard = 47 })
		inst.system = S
		inst.ctx = ctx
