-- ARKHER SYSTEM L.0174 :: Livestock State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0174"
	S.key = "arkher.sim.livestock.state_codec"
	S.name = "Livestock State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livestock.history_ledger" }
	S.tags = { "l", "livestock", "codec", "sim" }
	S.description = "Livestock State Codec: persistence, diffing and checksum of the world state for the Livestock subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.livestock.state_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
