-- ARKHER SYSTEM N.0408 :: Wind Gust Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0408"
	S.key = "arkher.vfx.windgust.curve_authoring"
	S.name = "Wind Gust Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Wind Gust"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.windgust.ribbon_and_trail" }
	S.tags = { "n", "windgust", "spline", "vfx" }
	S.description = "Wind Gust Curve Authoring: authored curves driving the effect over its life for the Wind Gust subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.windgust.curve_authoring", tension = 0.52, closed = false })
		inst.system = S
		inst.ctx = ctx
