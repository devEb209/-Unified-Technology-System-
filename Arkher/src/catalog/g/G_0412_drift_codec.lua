-- ARKHER SYSTEM G.0412 :: Drift Detection Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0412"
	S.key = "arkher.neural.drift.weight_codec"
	S.name = "Drift Detection Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.drift.model_registry" }
	S.tags = { "g", "drift", "codec", "neural" }
	S.description = "Drift Detection Weight Codec: weight serialization and quantized transport for the Drift Detection subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.drift.weight_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
