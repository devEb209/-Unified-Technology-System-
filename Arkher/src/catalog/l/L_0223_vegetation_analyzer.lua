-- ARKHER SYSTEM L.0223 :: Vegetation Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0223"
	S.key = "arkher.sim.vegetation.analysis"
	S.name = "Vegetation Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.vegetation.aggregate_cache" }
	S.tags = { "l", "vegetation", "analyzer", "sim" }
	S.description = "Vegetation Analysis: trend, anomaly and stability analysis of the world for the Vegetation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.vegetation.analysis", window = 81, buckets = 9, threshold = 3.30 })
		inst.system = S
		inst.ctx = ctx
