-- ARKHER SYSTEM T.0688 :: AI Debug Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0688"
	S.key = "arkher.ai.aidebug.semantic_knowledge"
	S.name = "AI Debug Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.aidebug.intent_understanding" }
	S.tags = { "t", "aidebug", "knowledge", "ai" }
	S.description = "AI Debug Semantic Knowledge: typed entities, weighted relations and inferred closure for the AI Debug subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.aidebug.semantic_knowledge", dims = 24 })
		inst.system = S
		inst.ctx = ctx
