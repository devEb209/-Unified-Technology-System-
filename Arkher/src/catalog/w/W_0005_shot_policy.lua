-- ARKHER SYSTEM W.0005 :: Shot Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0005"
	S.key = "arkher.cine.shot.cut_policy"
	S.name = "Shot Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Shot"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.shot.shot_composition" }
	S.tags = { "w", "shot", "policy", "cine" }
	S.description = "Shot Cut Policy: rules deciding when the sequence cuts and to what for the Shot subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.shot.cut_policy", algorithm = "edf", starvationGuard = 53 })
		inst.system = S
		inst.ctx = ctx
