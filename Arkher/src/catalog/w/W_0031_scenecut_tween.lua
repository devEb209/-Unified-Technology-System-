-- ARKHER SYSTEM W.0031 :: Scene Cut Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0031"
	S.key = "arkher.cine.scenecut.motion_tween"
	S.name = "Scene Cut Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Scene Cut"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.scenecut.playback_orchestrator" }
	S.tags = { "w", "scenecut", "tween", "cine" }
	S.description = "Scene Cut Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Scene Cut subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.scenecut.motion_tween", timeScale = 0.94 })
		inst.system = S
		inst.ctx = ctx
