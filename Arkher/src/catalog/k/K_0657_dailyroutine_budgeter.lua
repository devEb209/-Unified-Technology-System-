-- ARKHER SYSTEM K.0657 :: Daily Routine Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0657"
	S.key = "arkher.npc.dailyroutine.thinking_budget"
	S.name = "Daily Routine Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dailyroutine.daily_schedule" }
	S.tags = { "k", "dailyroutine", "budgeter", "npc" }
	S.description = "Daily Routine Thinking Budget: allocation of per-frame thinking time across NPCs for the Daily Routine subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.dailyroutine.thinking_budget", total = 198, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
