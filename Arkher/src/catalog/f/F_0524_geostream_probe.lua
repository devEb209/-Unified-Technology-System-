-- ARKHER SYSTEM F.0524 :: Geometry Streaming Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0524"
	S.key = "arkher.render.geostream.probe_volume"
	S.name = "Geometry Streaming Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.geostream.lighting_rig" }
	S.tags = { "f", "geostream", "probe", "render" }
	S.description = "Geometry Streaming Probe Volume: irradiance probes encoded in spherical harmonics for the Geometry Streaming subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.geostream.probe_volume", spacing = 24 })
		inst.system = S
		inst.ctx = ctx
