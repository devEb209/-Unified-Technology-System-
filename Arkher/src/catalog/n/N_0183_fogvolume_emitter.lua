-- ARKHER SYSTEM N.0183 :: Fog Volume Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0183"
	S.key = "arkher.vfx.fogvolume.emission"
	S.name = "Fog Volume Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fog Volume"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "fogvolume", "emitter", "vfx" }
	S.description = "Fog Volume Emission: shaped, rate and burst emission of new particles for the Fog Volume subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.fogvolume.emission", shape = "sphere", rate = 73, speed = 6.30, life = 3.10, budget = 192, seed = 71153 })
		inst.system = S
		inst.ctx = ctx
