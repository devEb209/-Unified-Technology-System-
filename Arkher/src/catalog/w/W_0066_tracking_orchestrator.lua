-- ARKHER SYSTEM W.0066 :: Tracking Shot Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0066"
	S.key = "arkher.cine.tracking.playback_orchestrator"
	S.name = "Tracking Shot Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.tracking.cut_policy" }
	S.tags = { "w", "tracking", "orchestrator", "cine" }
	S.description = "Tracking Shot Playback Orchestrator: the state machine that drives a cinematic from start to end for the Tracking Shot subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.tracking.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
