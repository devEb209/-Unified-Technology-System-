-- ARKHER SYSTEM VB.0148 :: Persistence Segment Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0148"
	S.key = "arkher.conttime.persistsegment.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.persistsegment.sparse_residency" }
	S.tags = { "vb", "persistsegment", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.persistsegment.multi-scale_fidelity", levels = 4, baseTriangles = 135000 })
		inst.system = S
		inst.ctx = ctx
