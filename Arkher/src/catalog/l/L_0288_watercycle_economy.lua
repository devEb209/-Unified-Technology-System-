-- ARKHER SYSTEM L.0288 :: Water Cycle Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0288"
	S.key = "arkher.sim.watercycle.economy"
	S.name = "Water Cycle Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.watercycle.ecology" }
	S.tags = { "l", "watercycle", "economy", "sim" }
	S.description = "Water Cycle Economy: stock, production, demand, price discovery and trade for the Water Cycle subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.watercycle.economy", elasticity = 0.26 })
		inst.system = S
		inst.ctx = ctx
