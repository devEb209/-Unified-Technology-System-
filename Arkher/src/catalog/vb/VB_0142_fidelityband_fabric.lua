-- ARKHER SYSTEM VB.0142 :: Fidelity Band Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0142"
	S.key = "arkher.conttime.fidelityband.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.fidelityband.complexity_budget" }
	S.tags = { "vb", "fidelityband", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.fidelityband.simulation_fabric", budgetMs = 1.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
