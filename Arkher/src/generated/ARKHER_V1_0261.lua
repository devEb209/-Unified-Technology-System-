--!strict
-- Fairlight — ANIMATION Node_Flow #0261
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Fairlight — ANIMATION Node_Flow #0261", size=Vector2.new(600, 440), pos=UDim2.fromOffset(293, 97), parent=parent, icon="⤢"})
