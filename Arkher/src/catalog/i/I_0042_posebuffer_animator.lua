-- ARKHER SYSTEM I.0042 :: Pose Buffer Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0042"
	S.key = "arkher.anim.posebuffer.layered_blending"
	S.name = "Pose Buffer Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Pose Buffer"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.posebuffer.clip_sampling" }
	S.tags = { "i", "posebuffer", "animator", "anim" }
	S.description = "Pose Buffer Layered Blending: layers, crossfades, masks and blend trees for the Pose Buffer subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.posebuffer.layered_blending", budget = 12 })
		inst.system = S
		inst.ctx = ctx
