-- ARKHER SYSTEM L.0152 :: Agriculture Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0152"
	S.key = "arkher.sim.agriculture.ecology"
	S.name = "Agriculture Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.agriculture.simulation_core" }
	S.tags = { "l", "agriculture", "ecology", "sim" }
	S.description = "Agriculture Ecology: populations, predation, harvesting and carrying capacity for the Agriculture subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.agriculture.ecology" })
		inst.system = S
		inst.ctx = ctx
