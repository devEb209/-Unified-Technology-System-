-- ARKHER SYSTEM F.0472 :: Distance Culling Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0472"
	S.key = "arkher.render.distanceculling.render_policy"
	S.name = "Distance Culling Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.distanceculling.draw_budget" }
	S.tags = { "f", "distanceculling", "policy", "render" }
	S.description = "Distance Culling Render Policy: device tier rules for the frame for the Distance Culling subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.distanceculling.render_policy", algorithm = "lottery", starvationGuard = 59 })
		inst.system = S
		inst.ctx = ctx
