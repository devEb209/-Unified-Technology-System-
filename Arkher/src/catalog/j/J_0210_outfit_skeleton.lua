-- ARKHER SYSTEM J.0210 :: Outfit Composition Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0210"
	S.key = "arkher.character.outfit.rig_definition"
	S.name = "Outfit Composition Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "outfit", "skeleton", "character" }
	S.description = "Outfit Composition Rig Definition: character rig definition and bone budget for the Outfit Composition subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.outfit.rig_definition" })
		inst.system = S
		inst.ctx = ctx
