-- ARKHER SYSTEM VA.0560 :: Device Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0560"
	S.key = "arkher.contworld.devicecont.world_memory_stream"
	S.name = "Device Continuum World Memory Stream"
	S.category = "VA"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.devicecont.neural_field" }
	S.tags = { "va", "devicecont", "worldmemory", "contworld" }
	S.description = "Device Continuum World Memory Stream: world memory continuum over epochs for the Device Continuum subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.devicecont.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
