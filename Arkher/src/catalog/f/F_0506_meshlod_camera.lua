-- ARKHER SYSTEM F.0506 :: Mesh LOD View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0506"
	S.key = "arkher.render.meshlod.view_and_culling"
	S.name = "Mesh LOD View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Mesh LOD"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.meshlod.frame_graph" }
	S.tags = { "f", "meshlod", "camera", "render" }
	S.description = "Mesh LOD View And Culling: view state, frustum culling and screen-size LOD for the Mesh LOD subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.meshlod.view_and_culling", width = 828, height = 1080, fov = 1.0000, far = 2000 })
		inst.system = S
		inst.ctx = ctx
