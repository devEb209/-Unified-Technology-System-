-- ARKHER SYSTEM G.0267 :: Quality Estimation Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0267"
	S.key = "arkher.neural.qualityestimate.inference_core"
	S.name = "Quality Estimation Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "qualityestimate", "inference", "neural" }
	S.description = "Quality Estimation Inference Core: dense network forward pass and training for the Quality Estimation subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.qualityestimate.inference_core", seed = 32226 })
		inst.system = S
		inst.ctx = ctx
