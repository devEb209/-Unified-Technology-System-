-- ARKHER SYSTEM K.0023 :: Neural Policy Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0023"
	S.key = "arkher.npc.neuralpolicy.navigation"
	S.name = "Neural Policy Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.neuralpolicy.goal_planner" }
	S.tags = { "k", "neuralpolicy", "navgraph", "npc" }
	S.description = "Neural Policy Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Neural Policy subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.neuralpolicy.navigation", width = 24, height = 24, cellSize = 2 })
		inst.system = S
		inst.ctx = ctx
