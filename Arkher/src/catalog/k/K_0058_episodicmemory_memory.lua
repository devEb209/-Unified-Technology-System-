-- ARKHER SYSTEM K.0058 :: Episodic Memory Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0058"
	S.key = "arkher.npc.episodicmemory.memory"
	S.name = "Episodic Memory Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.episodicmemory.mind_network" }
	S.tags = { "k", "episodicmemory", "memory", "npc" }
	S.description = "Episodic Memory Memory: episodic memory with decay, recall and consolidation for the Episodic Memory subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.episodicmemory.memory", capacity = 94, decayRate = 0.050, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
