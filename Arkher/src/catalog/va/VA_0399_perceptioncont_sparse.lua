-- ARKHER SYSTEM VA.0399 :: Perception Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0399"
	S.key = "arkher.contworld.perceptioncont.sparse_residency"
	S.name = "Perception Continuum Sparse Residency"
	S.category = "VA"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.perceptioncont.epoch_clock" }
	S.tags = { "va", "perceptioncont", "sparse", "contworld" }
	S.description = "Perception Continuum Sparse Residency: sparse page residency with eviction and compression for the Perception Continuum subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.perceptioncont.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
