-- ARKHER SYSTEM F.0033 :: Opaque Pass Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0033"
	S.key = "arkher.render.opaquepass.lighting_rig"
	S.name = "Opaque Pass Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Opaque Pass"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.opaquepass.geometry_virtualization" }
	S.tags = { "f", "opaquepass", "lightrig", "render" }
	S.description = "Opaque Pass Lighting Rig: light clustering, importance and cascades for the Opaque Pass subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.opaquepass.lighting_rig", maxActive = 7 })
		inst.system = S
		inst.ctx = ctx
