-- ARKHER SYSTEM VC.0603 :: Seam Lattice Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0603"
	S.key = "arkher.contneural.seamlattice.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.seamlattice.epoch_clock" }
	S.tags = { "vc", "seamlattice", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.seamlattice.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
