-- ARKHER SYSTEM F.0348 :: Antialiasing Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0348"
	S.key = "arkher.render.antialiasing.frame_analysis"
	S.name = "Antialiasing Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Antialiasing"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.antialiasing.pass_cache" }
	S.tags = { "f", "antialiasing", "analyzer", "render" }
	S.description = "Antialiasing Frame Analysis: per-pass cost analysis and outlier detection for the Antialiasing subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.antialiasing.frame_analysis", window = 151, buckets = 11, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
