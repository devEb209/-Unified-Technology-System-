-- ARKHER SYSTEM V.0378 :: Cook Target Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0378"
	S.key = "arkher.asset.cooktarget.content_cache"
	S.name = "Cook Target Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.cooktarget.dependency_graph" }
	S.tags = { "v", "cooktarget", "cache", "asset" }
	S.description = "Cook Target Content Cache: reuse of already cooked results for the Cook Target subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.cooktarget.content_cache", policy = "lru", capacity = 333, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
