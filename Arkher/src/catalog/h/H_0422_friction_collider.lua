-- ARKHER SYSTEM H.0422 :: Friction Model Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0422"
	S.key = "arkher.physics.friction.collision_shape"
	S.name = "Friction Model Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.friction.body_dynamics" }
	S.tags = { "h", "friction", "collider", "physics" }
	S.description = "Friction Model Collision Shape: shape bounds, support mapping and closest points for the Friction Model subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.friction.collision_shape", shape = "capsule", radius = 0.60, height = 1.40, layer = "character" })
		inst.system = S
		inst.ctx = ctx
