-- ARKHER SYSTEM K.0330 :: Curiosity Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0330"
	S.key = "arkher.npc.curiosity.goal_planner"
	S.name = "Curiosity Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.curiosity.utility_reasoning" }
	S.tags = { "k", "curiosity", "planner", "npc" }
	S.description = "Curiosity Goal Planner: backward GOAP planning to reach a goal state for the Curiosity subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.curiosity.goal_planner", maxDepth = 9 })
		inst.system = S
		inst.ctx = ctx
