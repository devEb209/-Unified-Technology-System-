-- ARKHER SYSTEM VA.0273 :: Bridge Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0273"
	S.key = "arkher.contworld.bridgecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.bridgecont.world_memory_stream" }
	S.tags = { "va", "bridgecont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.bridgecont.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
