-- ARKHER SYSTEM E.0581 :: Material Validation Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0581"
	S.key = "arkher.material.validation.instance_cache"
	S.name = "Material Validation Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.validation.quality_policy" }
	S.tags = { "e", "validation", "cache", "material" }
	S.description = "Material Validation Instance Cache: resolved-parameter cache keyed by context for the Material Validation subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.validation.instance_cache", policy = "ttl", capacity = 245, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
