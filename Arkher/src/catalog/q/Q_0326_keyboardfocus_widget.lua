-- ARKHER SYSTEM Q.0326 :: Keyboard Focus Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0326"
	S.key = "arkher.ui.keyboardfocus.widget_tree"
	S.name = "Keyboard Focus Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.keyboardfocus.responsive_layout" }
	S.tags = { "q", "keyboardfocus", "widget", "ui" }
	S.description = "Keyboard Focus Widget Tree: retained widget nodes, properties, bindings and rendering for the Keyboard Focus subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.keyboardfocus.widget_tree", theme = "light", scale = 1.08 })
		inst.system = S
		inst.ctx = ctx
