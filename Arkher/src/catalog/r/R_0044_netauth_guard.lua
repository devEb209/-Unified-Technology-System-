-- ARKHER SYSTEM R.0044 :: Authentication Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0044"
	S.key = "arkher.net.netauth.rate_guard"
	S.name = "Authentication Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netauth.interest_streaming" }
	S.tags = { "r", "netauth", "guard", "net" }
	S.description = "Authentication Rate Guard: token-bucket protection against floods and abuse for the Authentication subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.netauth.rate_guard", algorithm = "token", capacity = 83, refillPerSec = 8, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
