-- ARKHER SYSTEM P.0102 :: Inventory Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0102"
	S.key = "arkher.play.inventorysys.rule_pipeline"
	S.name = "Inventory Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Inventory"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.inventorysys.state_machine" }
	S.tags = { "p", "inventorysys", "pipeline", "play" }
	S.description = "Inventory Rule Pipeline: ordered rules applied to every gameplay event for the Inventory subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.inventorysys.rule_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
