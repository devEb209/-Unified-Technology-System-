-- ARKHER SYSTEM W.0164 :: Cutscene Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0164"
	S.key = "arkher.cine.cutscene.cinematic_mix"
	S.name = "Cutscene Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Cutscene"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cutscene.motion_tween" }
	S.tags = { "w", "cutscene", "mixer", "cine" }
	S.description = "Cutscene Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Cutscene subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.cutscene.cinematic_mix", maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
