-- ARKHER SYSTEM F.0381 :: Sharpening Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0381"
	S.key = "arkher.render.sharpening.visibility_set"
	S.name = "Sharpening Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sharpening"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sharpening.view_and_culling" }
	S.tags = { "f", "sharpening", "visibility", "render" }
	S.description = "Sharpening Visibility Set: cell, portal and occluder visibility for the Sharpening subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.sharpening.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
