-- ARKHER SYSTEM E.0573 :: Material Validation Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0573"
	S.key = "arkher.material.validation.shading_graph"
	S.name = "Material Validation Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.validation.layer_composition" }
	S.tags = { "e", "validation", "shadegraph", "material" }
	S.description = "Material Validation Shading Graph: node graph evaluated and compiled to Luau for the Material Validation subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.validation.shading_graph" })
		inst.system = S
		inst.ctx = ctx
