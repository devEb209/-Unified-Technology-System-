-- ARKHER SYSTEM V.0117 :: Voice Line Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0117"
	S.key = "arkher.asset.voiceline.size_budget"
	S.name = "Voice Line Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.voiceline.compression_codec" }
	S.tags = { "v", "voiceline", "budgeter", "asset" }
	S.description = "Voice Line Size Budget: byte budget shared between competing asset classes for the Voice Line subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.voiceline.size_budget", total = 196, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
