-- ARKHER SYSTEM F.0323 :: Motion Blur Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0323"
	S.key = "arkher.render.motionblur.frame_graph"
	S.name = "Motion Blur Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Motion Blur"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "motionblur", "framegraph", "render" }
	S.description = "Motion Blur Frame Graph: declared passes, culling, ordering and aliasing for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.motionblur.frame_graph", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
