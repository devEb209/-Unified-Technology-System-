-- ARKHER SYSTEM T.0055 :: Goal Reasoning Learning Analysis
...
return function(A)
	...
	local S = {}
	S.id = "T.0055"
	S.key = "arkher.ai.goalreasoning.learning_analysis"
	S.name = "Goal Reasoning Learning Analysis"
	S.category = "T"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.goalreasoning.model_inference" }
	S.tags = { "t", "goalreasoning", "analyzer", "ai" }
	S.description = "Goal Reasoning Learning Analysis: trend, anomaly and improvement analysis of the agent for the Goal Reasoning subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ai.goalreasoning.learning_analysis", window = 120, buckets = 8, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
