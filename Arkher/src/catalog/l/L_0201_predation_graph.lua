-- ARKHER SYSTEM L.0201 :: Predation Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0201"
	S.key = "arkher.sim.predation.region_graph"
	S.name = "Predation Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.predation.calendar" }
	S.tags = { "l", "predation", "graph", "sim" }
	S.description = "Predation Region Graph: connectivity, components and shortest path between places for the Predation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.predation.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
