-- ARKHER SYSTEM VA.0123 :: Spatial Slice Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0123"
	S.key = "arkher.contworld.spatialslice.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.spatialslice.epoch_clock" }
	S.tags = { "va", "spatialslice", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.spatialslice.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
