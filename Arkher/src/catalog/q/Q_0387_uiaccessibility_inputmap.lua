-- ARKHER SYSTEM Q.0387 :: Accessibility Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0387"
	S.key = "arkher.ui.uiaccessibility.input_mapping"
	S.name = "Accessibility Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uiaccessibility.widget_tree" }
	S.tags = { "q", "uiaccessibility", "inputmap", "ui" }
	S.description = "Accessibility Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Accessibility subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.uiaccessibility.input_mapping", device = "gamepad", holdTime = 0.38, deadzone = 0.23 })
		inst.system = S
		inst.ctx = ctx
