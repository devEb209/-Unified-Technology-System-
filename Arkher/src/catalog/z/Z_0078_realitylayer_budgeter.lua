-- ARKHER SYSTEM Z.0078 :: Reality Layer Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0078"
	S.key = "arkher.origin.realitylayer.budget_governor"
	S.name = "Reality Layer Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.behaviour_analysis" }
	S.tags = { "z", "realitylayer", "budgeter", "origin" }
	S.description = "Reality Layer Budget Governor: allocation of a scarce resource across the technology's consumers for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.realitylayer.budget_governor", total = 334, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
