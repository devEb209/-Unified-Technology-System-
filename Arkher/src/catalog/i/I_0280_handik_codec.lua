-- ARKHER SYSTEM I.0280 :: Hand Placement IK Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0280"
	S.key = "arkher.anim.handik.compression_codec"
	S.name = "Hand Placement IK Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.handik.retarget_graph" }
	S.tags = { "i", "handik", "codec", "anim" }
	S.description = "Hand Placement IK Compression Codec: curve compression and quantized transport for the Hand Placement IK subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.handik.compression_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
