-- ARKHER SYSTEM VB.0257 :: Road Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0257"
	S.key = "arkher.conttime.roadcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.roadcont.multi-scale_fidelity" }
	S.tags = { "vb", "roadcont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.roadcont.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
