-- ARKHER SYSTEM VD.0124 :: Spatial Slice Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0124"
	S.key = "arkher.contsim.spatialslice.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.spatialslice.sparse_residency" }
	S.tags = { "vd", "spatialslice", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.spatialslice.multi-scale_fidelity", levels = 6, baseTriangles = 75000 })
		inst.system = S
		inst.ctx = ctx
