-- ARKHER SYSTEM VC.0459 :: Audio Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0459"
	S.key = "arkher.contneural.audiocont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.audiocont.epoch_clock" }
	S.tags = { "vc", "audiocont", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.audiocont.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
