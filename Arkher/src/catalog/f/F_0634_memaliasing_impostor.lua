-- ARKHER SYSTEM F.0634 :: Memory Aliasing Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0634"
	S.key = "arkher.render.memaliasing.geometry_virtualization"
	S.name = "Memory Aliasing Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.memaliasing.visibility_set" }
	S.tags = { "f", "memaliasing", "impostor", "render" }
	S.description = "Memory Aliasing Geometry Virtualization: impostor and HLOD synthesis under a budget for the Memory Aliasing subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.memaliasing.geometry_virtualization", atlasSlots = 80, viewCount = 8, errorThreshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
