--!strict
-- Unity6 URP — ANIMATION Mixer #0007
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Unity6 URP — ANIMATION Mixer #0007", size=Vector2.new(640, 460), pos=UDim2.fromOffset(191, 199), parent=parent, icon="🎬"})
...
Components.Slider(right, "Rate", 0,3000,600, function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_Rate"..7, v) end end)
