-- ARKHER SYSTEM H.0304 :: Capsule Collider Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0304"
	S.key = "arkher.physics.capsulecollider.simulation_policy"
	S.name = "Capsule Collider Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.capsulecollider.budget_governor" }
	S.tags = { "h", "capsulecollider", "policy", "physics" }
	S.description = "Capsule Collider Simulation Policy: device tier rules for substeps, iterations and sleep for the Capsule Collider subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.capsulecollider.simulation_policy", algorithm = "lottery", starvationGuard = 35 })
		inst.system = S
		inst.ctx = ctx
