-- ARKHER SYSTEM P.0442 :: Matchmaking Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0442"
	S.key = "arkher.play.matchmaking.content_registry"
	S.name = "Matchmaking Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Matchmaking"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.matchmaking.difficulty_controller" }
	S.tags = { "p", "matchmaking", "registry", "play" }
	S.description = "Matchmaking Content Registry: catalogue of the definitions this loop instantiates for the Matchmaking subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.matchmaking.content_registry" })
		inst.system = S
		inst.ctx = ctx
