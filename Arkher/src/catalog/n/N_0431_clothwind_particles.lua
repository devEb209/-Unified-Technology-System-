-- ARKHER SYSTEM N.0431 :: Cloth Wind Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0431"
	S.key = "arkher.vfx.clothwind.particle_simulation"
	S.name = "Cloth Wind Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloth Wind"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.clothwind.emission" }
	S.tags = { "n", "clothwind", "particles", "vfx" }
	S.description = "Cloth Wind Particle Simulation: pooled integration of position, velocity, colour and life for the Cloth Wind subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.clothwind.particle_simulation", capacity = 128, drag = 0.21, bounce = 0.36, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
