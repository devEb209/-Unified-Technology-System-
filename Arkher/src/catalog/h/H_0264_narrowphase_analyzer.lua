-- ARKHER SYSTEM H.0264 :: Narrowphase Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0264"
	S.key = "arkher.physics.narrowphase.analysis"
	S.name = "Narrowphase Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Narrowphase"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.narrowphase.result_cache" }
	S.tags = { "h", "narrowphase", "analyzer", "physics" }
	S.description = "Narrowphase Analysis: energy, jitter and cost analysis of the simulation for the Narrowphase subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.narrowphase.analysis", window = 104, buckets = 12, threshold = 3.60 })
		inst.system = S
		inst.ctx = ctx
