-- ARKHER SYSTEM H.0161 :: Angular Damping Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0161"
	S.key = "arkher.physics.angulardamping.vehicle"
	S.name = "Angular Damping Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.angulardamping.character_motion" }
	S.tags = { "h", "angulardamping", "vehicle", "physics" }
	S.description = "Angular Damping Vehicle: suspension, drivetrain, steering and tire friction for the Angular Damping subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.angulardamping.vehicle", mass = 2100, wheelbase = 3.00, track = 1.80, maxRpm = 6400 })
		inst.system = S
		inst.ctx = ctx
