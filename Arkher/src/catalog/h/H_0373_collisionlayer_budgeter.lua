-- ARKHER SYSTEM H.0373 :: Collision Layer Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0373"
	S.key = "arkher.physics.collisionlayer.budget_governor"
	S.name = "Collision Layer Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionlayer.broadphase_index" }
	S.tags = { "h", "collisionlayer", "budgeter", "physics" }
	S.description = "Collision Layer Budget Governor: simulation time budget allocation across islands for the Collision Layer subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.collisionlayer.budget_governor", total = 334, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
