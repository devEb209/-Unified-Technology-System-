-- ARKHER SYSTEM W.0038 :: Establishing Shot Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0038"
	S.key = "arkher.cine.establishing.camera_rig"
	S.name = "Establishing Shot Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.establishing.sequence_timeline" }
	S.tags = { "w", "establishing", "camerarig", "cine" }
	S.description = "Establishing Shot Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Establishing Shot subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.establishing.camera_rig", fov = 0.95, focus = 7.0, aperture = 3.9, smoothing = 7.0, distance = 9, height = 7 })
		inst.system = S
		inst.ctx = ctx
