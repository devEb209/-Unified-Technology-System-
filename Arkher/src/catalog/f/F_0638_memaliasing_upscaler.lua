-- ARKHER SYSTEM F.0638 :: Memory Aliasing Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0638"
	S.key = "arkher.render.memaliasing.adaptive_resolution"
	S.name = "Memory Aliasing Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.memaliasing.temporal_resolve" }
	S.tags = { "f", "memaliasing", "upscaler", "render" }
	S.description = "Memory Aliasing Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Memory Aliasing subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.memaliasing.adaptive_resolution", targetMs = 12.10, index = 4, sharpness = 0.29 })
		inst.system = S
		inst.ctx = ctx
