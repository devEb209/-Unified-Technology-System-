-- ARKHER SYSTEM Z.0575 :: Collective Behaviour Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0575"
	S.key = "arkher.origin.collectivebehaviour.signal_composition"
	S.name = "Collective Behaviour Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.collectivebehaviour.telemetry_ledger" }
	S.tags = { "z", "collectivebehaviour", "composer", "origin" }
	S.description = "Collective Behaviour Signal Composition: blending of the technology's input signals into one output for the Collective Behaviour subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.collectivebehaviour.signal_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
