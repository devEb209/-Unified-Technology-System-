-- ARKHER SYSTEM VB.0281 :: Water Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0281"
	S.key = "arkher.conttime.watercont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.watercont.multi-scale_fidelity" }
	S.tags = { "vb", "watercont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.watercont.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
