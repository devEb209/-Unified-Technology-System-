-- ARKHER SYSTEM VC.0391 :: Memory Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0391"
	S.key = "arkher.contneural.memorycont.neural_field"
	S.name = "Memory Continuum Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memorycont.coherence_guard" }
	S.tags = { "vc", "memorycont", "neuralfield", "contneural" }
	S.description = "Memory Continuum Neural Field: neural field encoding and reconstruction for the Memory Continuum subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.memorycont.neural_field", dims = 12, hidden = 8, seed = 80680 })
		inst.system = S
		inst.ctx = ctx
