-- ARKHER SYSTEM VA.0465 :: Audio Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0465"
	S.key = "arkher.contworld.audiocont.complexity_budget"
	S.name = "Audio Continuum Complexity Budget"
	S.category = "VA"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.audiocont.world_memory_stream" }
	S.tags = { "va", "audiocont", "complexity", "contworld" }
	S.description = "Audio Continuum Complexity Budget: complexity budgeting for the continuum for the Audio Continuum subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.audiocont.complexity_budget", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
