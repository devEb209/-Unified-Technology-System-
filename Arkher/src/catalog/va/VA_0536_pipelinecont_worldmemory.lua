-- ARKHER SYSTEM VA.0536 :: Pipeline Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0536"
	S.key = "arkher.contworld.pipelinecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.pipelinecont.neural_field" }
	S.tags = { "va", "pipelinecont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.pipelinecont.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
