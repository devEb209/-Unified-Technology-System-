-- ARKHER SYSTEM H.0470 :: Hinge Joint Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0470"
	S.key = "arkher.physics.hingejoint.broadphase_index"
	S.name = "Hinge Joint Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Hinge Joint"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.hingejoint.vehicle" }
	S.tags = { "h", "hingejoint", "index", "physics" }
	S.description = "Hinge Joint Broadphase Index: spatial acceleration of candidate pair finding for the Hinge Joint subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.hingejoint.broadphase_index", mode = "hash", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
