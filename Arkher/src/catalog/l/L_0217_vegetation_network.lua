-- ARKHER SYSTEM L.0217 :: Vegetation Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0217"
	S.key = "arkher.sim.vegetation.route_network"
	S.name = "Vegetation Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.vegetation.region_graph" }
	S.tags = { "l", "vegetation", "network", "sim" }
	S.description = "Vegetation Route Network: roads, rivers and routes between settlements for the Vegetation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.vegetation.route_network" })
		inst.system = S
		inst.ctx = ctx
