-- ARKHER SYSTEM N.0232 :: Magic Aura Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0232"
	S.key = "arkher.vfx.magicaura.spatial_index"
	S.name = "Magic Aura Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Magic Aura"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.magicaura.quality_policy" }
	S.tags = { "n", "magicaura", "index", "vfx" }
	S.description = "Magic Aura Spatial Index: spatial acceleration of effect queries and culling for the Magic Aura subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.magicaura.spatial_index", mode = "hash", cellSize = 64 })
		inst.system = S
		inst.ctx = ctx
