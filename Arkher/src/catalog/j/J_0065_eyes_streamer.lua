-- ARKHER SYSTEM J.0065 :: Eyes Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0065"
	S.key = "arkher.character.eyes.streaming"
	S.name = "Eyes Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.eyes.budget_governor" }
	S.tags = { "j", "eyes", "streamer", "character" }
	S.description = "Eyes Streaming: distance-driven residency of character data for the Eyes subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.eyes.streaming", radius = 320, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
