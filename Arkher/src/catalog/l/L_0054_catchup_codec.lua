-- ARKHER SYSTEM L.0054 :: Catch Up State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0054"
	S.key = "arkher.sim.catchup.state_codec"
	S.name = "Catch Up State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.catchup.history_ledger" }
	S.tags = { "l", "catchup", "codec", "sim" }
	S.description = "Catch Up State Codec: persistence, diffing and checksum of the world state for the Catch Up subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.catchup.state_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
