-- ARKHER SYSTEM VB.0233 :: City Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0233"
	S.key = "arkher.conttime.citycont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.citycont.multi-scale_fidelity" }
	S.tags = { "vb", "citycont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.citycont.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
