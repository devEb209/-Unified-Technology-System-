-- ARKHER SYSTEM Z.0804 :: Perceptual Budgeting Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0804"
	S.key = "arkher.origin.perceptualbudget.autonomous_pipeline"
	S.name = "Perceptual Budgeting Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.perceptualbudget.simulation_fabric" }
	S.tags = { "z", "perceptualbudget", "autopipeline", "origin" }
	S.description = "Perceptual Budgeting Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.perceptualbudget.autonomous_pipeline", maxIterations = 8 })
		inst.system = S
		inst.ctx = ctx
