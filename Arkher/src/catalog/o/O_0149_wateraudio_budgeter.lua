-- ARKHER SYSTEM O.0149 :: Water Audio Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0149"
	S.key = "arkher.audio.wateraudio.voice_budget"
	S.name = "Water Audio Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Water Audio"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.wateraudio.music_sequencer" }
	S.tags = { "o", "wateraudio", "budgeter", "audio" }
	S.description = "Water Audio Voice Budget: voice slots allocated by priority and audibility for the Water Audio subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.wateraudio.voice_budget", total = 201, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
