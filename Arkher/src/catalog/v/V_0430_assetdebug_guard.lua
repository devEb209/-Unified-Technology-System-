-- ARKHER SYSTEM V.0430 :: Asset Debug Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0430"
	S.key = "arkher.asset.assetdebug.validation_guard"
	S.name = "Asset Debug Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetdebug.size_budget" }
	S.tags = { "v", "assetdebug", "guard", "asset" }
	S.description = "Asset Debug Validation Guard: rate limiting and capability checks on the import path for the Asset Debug subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.assetdebug.validation_guard", algorithm = "leaky", capacity = 66, refillPerSec = 31, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
