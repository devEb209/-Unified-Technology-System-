-- ARKHER SYSTEM N.0004 :: Spark Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0004"
	S.key = "arkher.vfx.spark.ribbon_and_trail"
	S.name = "Spark Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spark"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spark.force_field" }
	S.tags = { "n", "spark", "ribbon", "vfx" }
	S.description = "Spark Ribbon And Trail: trail points, tapering, beams and decimation for the Spark subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.spark.ribbon_and_trail", maxPoints = 16, lifetime = 0.90, minDistance = 0.30, width = 0.20 })
		inst.system = S
		inst.ctx = ctx
