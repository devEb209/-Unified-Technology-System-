-- ARKHER SYSTEM G.0425 :: Confidence Gating Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0425"
	S.key = "arkher.neural.confidence.model_registry"
	S.name = "Confidence Gating Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.confidence.reconstruction" }
	S.tags = { "g", "confidence", "registry", "neural" }
	S.description = "Confidence Gating Model Registry: named models and their lifecycle for the Confidence Gating subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.confidence.model_registry" })
		inst.system = S
		inst.ctx = ctx
