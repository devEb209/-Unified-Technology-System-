-- ARKHER SYSTEM VC.0584 :: Thermal Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0584"
	S.key = "arkher.contneural.thermalcont.world_memory_stream"
	S.name = "Thermal Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.thermalcont.neural_field" }
	S.tags = { "vc", "thermalcont", "worldmemory", "contneural" }
	S.description = "Thermal Continuum World Memory Stream: world memory continuum over epochs for the Thermal Continuum subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.thermalcont.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
