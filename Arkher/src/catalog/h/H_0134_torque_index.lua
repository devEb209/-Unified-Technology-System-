-- ARKHER SYSTEM H.0134 :: Torque Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0134"
	S.key = "arkher.physics.torque.broadphase_index"
	S.name = "Torque Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Torque"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.torque.vehicle" }
	S.tags = { "h", "torque", "index", "physics" }
	S.description = "Torque Broadphase Index: spatial acceleration of candidate pair finding for the Torque subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.torque.broadphase_index", mode = "hash", cellSize = 32 })
		inst.system = S
		inst.ctx = ctx
