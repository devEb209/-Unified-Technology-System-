-- ARKHER SYSTEM V.0050 :: Material Asset Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0050"
	S.key = "arkher.asset.materialasset.bundling"
	S.name = "Material Asset Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.materialasset.import" }
	S.tags = { "v", "materialasset", "bundler", "asset" }
	S.description = "Material Asset Bundling: size-bounded packing, manifests and delta patches for the Material Asset subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.materialasset.bundling", maxBundleBytes = 262144 })
		inst.system = S
		inst.ctx = ctx
