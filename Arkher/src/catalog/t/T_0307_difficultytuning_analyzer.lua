-- ARKHER SYSTEM T.0307 :: Difficulty Tuning Learning Analysis
...
return function(A)
	...
	local S = {}
	S.id = "T.0307"
	S.key = "arkher.ai.difficultytuning.learning_analysis"
	S.name = "Difficulty Tuning Learning Analysis"
	S.category = "T"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.difficultytuning.model_inference" }
	S.tags = { "t", "difficultytuning", "analyzer", "ai" }
	S.description = "Difficulty Tuning Learning Analysis: trend, anomaly and improvement analysis of the agent for the Difficulty Tuning subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ai.difficultytuning.learning_analysis", window = 202, buckets = 18, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
