-- ARKHER SYSTEM VD.0534 :: Pipeline Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0534"
	S.key = "arkher.contsim.pipelinecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.pipelinecont.persistent_state" }
	S.tags = { "vd", "pipelinecont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.pipelinecont.coherence_guard", window = 97, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
