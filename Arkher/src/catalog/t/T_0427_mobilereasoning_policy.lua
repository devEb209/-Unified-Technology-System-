-- ARKHER SYSTEM T.0427 :: Mobile Reasoning Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0427"
	S.key = "arkher.ai.mobilereasoning.decision_policy"
	S.name = "Mobile Reasoning Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.mobilereasoning.reasoning_graph" }
	S.tags = { "t", "mobilereasoning", "policy", "ai" }
	S.description = "Mobile Reasoning Decision Policy: ordered rules deciding what the agent does next for the Mobile Reasoning subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.mobilereasoning.decision_policy", algorithm = "lottery", starvationGuard = 47 })
		inst.system = S
		inst.ctx = ctx
