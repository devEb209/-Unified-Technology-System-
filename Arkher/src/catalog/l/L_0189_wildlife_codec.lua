-- ARKHER SYSTEM L.0189 :: Wildlife State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0189"
	S.key = "arkher.sim.wildlife.state_codec"
	S.name = "Wildlife State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wildlife.history_ledger" }
	S.tags = { "l", "wildlife", "codec", "sim" }
	S.description = "Wildlife State Codec: persistence, diffing and checksum of the world state for the Wildlife subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.wildlife.state_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
