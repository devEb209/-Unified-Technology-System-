-- ARKHER SYSTEM J.0302 :: Crowd Instance Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0302"
	S.key = "arkher.character.crowdinstance.physical_response"
	S.name = "Crowd Instance Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.crowdinstance.look_and_reach" }
	S.tags = { "j", "crowdinstance", "ragdoll", "character" }
	S.description = "Crowd Instance Physical Response: physical reaction, ragdoll and recovery for the Crowd Instance subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.crowdinstance.physical_response", blendSpeed = 5.80 })
		inst.system = S
		inst.ctx = ctx
