-- ARKHER SYSTEM R.0255 :: Bandwidth Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0255"
	S.key = "arkher.net.bandwidth.prediction_and_reconciliation"
	S.name = "Bandwidth Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Bandwidth"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.bandwidth.time_sync" }
	S.tags = { "r", "bandwidth", "prediction", "net" }
	S.description = "Bandwidth Prediction And Reconciliation: client simulation, correction and input replay for the Bandwidth subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.bandwidth.prediction_and_reconciliation", errorThreshold = 0.045, smoothing = 11.0, maxInputs = 120 })
		inst.system = S
		inst.ctx = ctx
