-- ARKHER SYSTEM T.0445 :: Player Modelling Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0445"
	S.key = "arkher.ai.playermodelling.action_planner"
	S.name = "Player Modelling Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.playermodelling.utility_selection" }
	S.tags = { "t", "playermodelling", "planner", "ai" }
	S.description = "Player Modelling Action Planner: goal-oriented action planning over preconditions for the Player Modelling subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.playermodelling.action_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
