-- ARKHER SYSTEM G.0118 :: Denoising Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0118"
	S.key = "arkher.neural.denoise.weight_codec"
	S.name = "Denoising Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.denoise.model_registry" }
	S.tags = { "g", "denoise", "codec", "neural" }
	S.description = "Denoising Weight Codec: weight serialization and quantized transport for the Denoising subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.denoise.weight_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
