-- ARKHER SYSTEM G.0358 :: Batch Inference Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0358"
	S.key = "arkher.neural.batchinference.compute_budget"
	S.name = "Batch Inference Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.batchinference.quality_predictor" }
	S.tags = { "g", "batchinference", "budgeter", "neural" }
	S.description = "Batch Inference Compute Budget: inference time budget allocation for the Batch Inference subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.batchinference.compute_budget", total = 98, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
