--!strict
-- Google Maps — ANIMATION Stack #0085
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Google Maps — ANIMATION Stack #0085", size=Vector2.new(640, 420), pos=UDim2.fromOffset(405, 225), parent=parent, icon="⬡"})
