-- ARKHER SYSTEM E.0052 :: Roughness Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0052"
	S.key = "arkher.material.roughness.parameter_budget"
	S.name = "Roughness Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Roughness"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.roughness.variant_registry" }
	S.tags = { "e", "roughness", "budgeter", "material" }
	S.description = "Roughness Parameter Budget: texel and layer budget allocation for the Roughness subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.roughness.parameter_budget", total = 379, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
