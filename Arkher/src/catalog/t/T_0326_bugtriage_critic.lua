-- ARKHER SYSTEM T.0326 :: Bug Triage Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0326"
	S.key = "arkher.ai.bugtriage.self_critique"
	S.name = "Bug Triage Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.bugtriage.plan_workflow" }
	S.tags = { "t", "bugtriage", "critic", "ai" }
	S.description = "Bug Triage Self Critique: weighted evaluation of the result against declared criteria for the Bug Triage subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.bugtriage.self_critique", passMark = 0.70, reviseMark = 0.40, seed = 65670 })
		inst.system = S
		inst.ctx = ctx
