-- ARKHER SYSTEM K.0351 :: Behaviour State Machine Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0351"
	S.key = "arkher.npc.behaviourstate.mind_network"
	S.name = "Behaviour State Machine Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "behaviourstate", "mindnet", "npc" }
	S.description = "Behaviour State Machine Mind Network: the learned policy that turns perception into a decision for the Behaviour State Machine subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.behaviourstate.mind_network", inputs = 6, hidden = 6, seed = 66452, learningRate = 0.060, exploration = 0.040 })
		inst.system = S
		inst.ctx = ctx
