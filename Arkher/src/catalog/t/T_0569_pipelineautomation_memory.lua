-- ARKHER SYSTEM T.0569 :: Pipeline Automation Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0569"
	S.key = "arkher.ai.pipelineautomation.working_memory"
	S.name = "Pipeline Automation Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.pipelineautomation.outcome_prediction" }
	S.tags = { "t", "pipelineautomation", "memory", "ai" }
	S.description = "Pipeline Automation Working Memory: decaying, consolidating recall of what the agent learned for the Pipeline Automation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.pipelineautomation.working_memory", capacity = 83, decayRate = 0.055, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
