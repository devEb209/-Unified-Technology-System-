-- ARKHER SYSTEM L.0359 :: Price Discovery Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0359"
	S.key = "arkher.sim.pricediscovery.forecast"
	S.name = "Price Discovery Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.pricediscovery.analysis" }
	S.tags = { "l", "pricediscovery", "predictor", "sim" }
	S.description = "Price Discovery Forecast: prediction of the region's next state for the Price Discovery subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.pricediscovery.forecast", method = "linear", alpha = 0.39, window = 69 })
		inst.system = S
		inst.ctx = ctx
