-- ARKHER SYSTEM Z.0858 :: Simulation Time Dilation Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0858"
	S.key = "arkher.origin.timedilation.budget_governor"
	S.name = "Simulation Time Dilation Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.behaviour_analysis" }
	S.tags = { "z", "timedilation", "budgeter", "origin" }
	S.description = "Simulation Time Dilation Budget Governor: allocation of a scarce resource across the technology's consumers for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.timedilation.budget_governor", total = 364, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
