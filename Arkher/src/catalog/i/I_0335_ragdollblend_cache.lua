-- ARKHER SYSTEM I.0335 :: Ragdoll Blend Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0335"
	S.key = "arkher.anim.ragdollblend.pose_cache"
	S.name = "Ragdoll Blend Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.ragdollblend.playback_pipeline" }
	S.tags = { "i", "ragdollblend", "cache", "anim" }
	S.description = "Ragdoll Blend Pose Cache: reuse of sampled poses across frames and instances for the Ragdoll Blend subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.ragdollblend.pose_cache", policy = "lfu", capacity = 398, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
