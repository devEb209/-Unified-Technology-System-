-- ARKHER SYSTEM K.0525 :: Combat Behaviour Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0525"
	S.key = "arkher.npc.combatbehaviour.utility_reasoning"
	S.name = "Combat Behaviour Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.combatbehaviour.reactive_behaviour" }
	S.tags = { "k", "combatbehaviour", "utility", "npc" }
	S.description = "Combat Behaviour Utility Reasoning: scored option selection with response curves for the Combat Behaviour subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.combatbehaviour.utility_reasoning", momentum = 0.10 })
		inst.system = S
		inst.ctx = ctx
