-- ARKHER SYSTEM Z.0687 :: Auto Test Synthesis World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0687"
	S.key = "arkher.origin.autotest.world_architect"
	S.name = "Auto Test Synthesis World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autotest.emergence_detection" }
	S.tags = { "z", "autotest", "architect", "origin" }
	S.description = "Auto Test Synthesis World Architect: hierarchical world composition with conserved budgets for the Auto Test Synthesis subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.autotest.world_architect", budget = 1400, seed = 93488 })
		inst.system = S
		inst.ctx = ctx
