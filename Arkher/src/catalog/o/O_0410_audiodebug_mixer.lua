-- ARKHER SYSTEM O.0410 :: Audio Debug Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0410"
	S.key = "arkher.audio.audiodebug.mixer_bus"
	S.name = "Audio Debug Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Audio Debug"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiodebug.dsp_chain" }
	S.tags = { "o", "audiodebug", "mixer", "audio" }
	S.description = "Audio Debug Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Audio Debug subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.audiodebug.mixer_bus", maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
