-- ARKHER SYSTEM Z.0861 :: Multi Scale Simulation Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0861"
	S.key = "arkher.origin.multiscale.reality_layering"
	S.name = "Multi Scale Simulation Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "multiscale", "reality", "origin" }
	S.description = "Multi Scale Simulation Reality Layering: stacked authored, simulated, proposed and player realities for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.multiscale.reality_layering" })
		inst.system = S
		inst.ctx = ctx
