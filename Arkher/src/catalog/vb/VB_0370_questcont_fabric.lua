-- ARKHER SYSTEM VB.0370 :: Quest Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0370"
	S.key = "arkher.conttime.questcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.questcont.complexity_budget" }
	S.tags = { "vb", "questcont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.questcont.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
