-- ARKHER SYSTEM N.0513 :: Effect Debug Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0513"
	S.key = "arkher.vfx.fxdebug.effect_graph"
	S.name = "Effect Debug Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Effect Debug"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fxdebug.curve_authoring" }
	S.tags = { "n", "fxdebug", "shadegraph", "vfx" }
	S.description = "Effect Debug Effect Graph: node graph describing how the effect is shaded for the Effect Debug subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.fxdebug.effect_graph" })
		inst.system = S
		inst.ctx = ctx
