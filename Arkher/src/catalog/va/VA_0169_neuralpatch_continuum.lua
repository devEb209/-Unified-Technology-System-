-- ARKHER SYSTEM VA.0169 :: Neural Patch Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0169"
	S.key = "arkher.contworld.neuralpatch.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "neuralpatch", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.neuralpatch.infinite_grid", cellSize = 128, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
