-- ARKHER SYSTEM F.0316 :: Depth Of Field Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0316"
	S.key = "arkher.render.dof.adaptive_resolution"
	S.name = "Depth Of Field Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.dof.temporal_resolve" }
	S.tags = { "f", "dof", "upscaler", "render" }
	S.description = "Depth Of Field Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.dof.adaptive_resolution", targetMs = 14.10, index = 3, sharpness = 0.41 })
		inst.system = S
		inst.ctx = ctx
