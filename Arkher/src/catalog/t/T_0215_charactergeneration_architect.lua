-- ARKHER SYSTEM T.0215 :: Character Generation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0215"
	S.key = "arkher.ai.charactergeneration.world_architect"
	S.name = "Character Generation World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.charactergeneration.self_critique" }
	S.tags = { "t", "charactergeneration", "architect", "ai" }
	S.description = "Character Generation World Architect: composition of a whole world plan with conserved budgets for the Character Generation subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.charactergeneration.world_architect", budget = 1500, seed = 49509 })
		inst.system = S
		inst.ctx = ctx
