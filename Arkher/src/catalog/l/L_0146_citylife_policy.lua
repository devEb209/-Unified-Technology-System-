-- ARKHER SYSTEM L.0146 :: City Life Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0146"
	S.key = "arkher.sim.citylife.fidelity_policy"
	S.name = "City Life Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.citylife.streaming" }
	S.tags = { "l", "citylife", "policy", "sim" }
	S.description = "City Life Fidelity Policy: rules that pick full, cohort or statistical simulation for the City Life subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.citylife.fidelity_policy", algorithm = "roundrobin", starvationGuard = 24 })
		inst.system = S
		inst.ctx = ctx
