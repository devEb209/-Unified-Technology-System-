-- ARKHER SYSTEM F.0507 :: Mesh LOD Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0507"
	S.key = "arkher.render.meshlod.visibility_set"
	S.name = "Mesh LOD Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Mesh LOD"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.meshlod.view_and_culling" }
	S.tags = { "f", "meshlod", "visibility", "render" }
	S.description = "Mesh LOD Visibility Set: cell, portal and occluder visibility for the Mesh LOD subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.meshlod.visibility_set", maxDepth = 4 })
		inst.system = S
		inst.ctx = ctx
