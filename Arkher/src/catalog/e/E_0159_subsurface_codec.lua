-- ARKHER SYSTEM E.0159 :: Subsurface Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0159"
	S.key = "arkher.material.subsurface.compression_codec"
	S.name = "Subsurface Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Subsurface"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.subsurface.streaming" }
	S.tags = { "e", "subsurface", "codec", "material" }
	S.description = "Subsurface Compression Codec: serialization and compression of material data for the Subsurface subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.subsurface.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
