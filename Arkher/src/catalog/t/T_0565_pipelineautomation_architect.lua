-- ARKHER SYSTEM T.0565 :: Pipeline Automation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0565"
	S.key = "arkher.ai.pipelineautomation.world_architect"
	S.name = "Pipeline Automation World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.pipelineautomation.self_critique" }
	S.tags = { "t", "pipelineautomation", "architect", "ai" }
	S.description = "Pipeline Automation World Architect: composition of a whole world plan with conserved budgets for the Pipeline Automation subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.pipelineautomation.world_architect", budget = 1200, seed = 37946 })
		inst.system = S
		inst.ctx = ctx
