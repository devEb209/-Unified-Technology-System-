-- ARKHER SYSTEM J.0109 :: Lip Sync Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0109"
	S.key = "arkher.character.lipsync.streaming"
	S.name = "Lip Sync Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.lipsync.budget_governor" }
	S.tags = { "j", "lipsync", "streamer", "character" }
	S.description = "Lip Sync Streaming: distance-driven residency of character data for the Lip Sync subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.lipsync.streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
