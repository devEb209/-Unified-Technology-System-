-- ARKHER SYSTEM VD.0459 :: Audio Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0459"
	S.key = "arkher.contsim.audiocont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.audiocont.epoch_clock" }
	S.tags = { "vd", "audiocont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.audiocont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
