-- ARKHER SYSTEM K.0115 :: Forgetting Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0115"
	S.key = "arkher.npc.forgetting.drive_system"
	S.name = "Forgetting Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.forgetting.memory" }
	S.tags = { "k", "forgetting", "need", "npc" }
	S.description = "Forgetting Drive System: drives that decay, turn urgent and get satisfied for the Forgetting subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.forgetting.drive_system" })
		inst.system = S
		inst.ctx = ctx
