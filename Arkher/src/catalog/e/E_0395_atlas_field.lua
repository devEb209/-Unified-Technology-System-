-- ARKHER SYSTEM E.0395 :: Texture Atlas Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0395"
	S.key = "arkher.material.atlas.procedural_detail"
	S.name = "Texture Atlas Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.atlas.texture_sampling" }
	S.tags = { "e", "atlas", "field", "material" }
	S.description = "Texture Atlas Procedural Detail: coherent noise detail driving the surface for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.atlas.procedural_detail", seed = 59447, frequency = 0.0057, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
