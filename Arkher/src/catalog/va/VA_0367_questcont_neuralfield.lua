-- ARKHER SYSTEM VA.0367 :: Quest Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0367"
	S.key = "arkher.contworld.questcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.questcont.coherence_guard" }
	S.tags = { "va", "questcont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.questcont.neural_field", dims = 16, hidden = 12, seed = 36369 })
		inst.system = S
		inst.ctx = ctx
