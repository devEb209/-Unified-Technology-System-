-- ARKHER SYSTEM T.0503 :: Physics Reasoning Learning Analysis
...
return function(A)
	...
	local S = {}
	S.id = "T.0503"
	S.key = "arkher.ai.physicsreasoning.learning_analysis"
	S.name = "Physics Reasoning Learning Analysis"
	S.category = "T"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.physicsreasoning.model_inference" }
	S.tags = { "t", "physicsreasoning", "analyzer", "ai" }
	S.description = "Physics Reasoning Learning Analysis: trend, anomaly and improvement analysis of the agent for the Physics Reasoning subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ai.physicsreasoning.learning_analysis", window = 86, buckets = 10, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
