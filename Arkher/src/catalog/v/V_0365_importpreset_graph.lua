-- ARKHER SYSTEM V.0365 :: Import Preset Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0365"
	S.key = "arkher.asset.importpreset.dependency_graph"
	S.name = "Import Preset Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.importpreset.asset_registry" }
	S.tags = { "v", "importpreset", "graph", "asset" }
	S.description = "Import Preset Dependency Graph: what references what, and in which order it must be built for the Import Preset subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.importpreset.dependency_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
