-- ARKHER SYSTEM T.0116 :: Long Term Memory Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0116"
	S.key = "arkher.ai.longtermmemory.self_critique"
	S.name = "Long Term Memory Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.longtermmemory.plan_workflow" }
	S.tags = { "t", "longtermmemory", "critic", "ai" }
	S.description = "Long Term Memory Self Critique: weighted evaluation of the result against declared criteria for the Long Term Memory subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.longtermmemory.self_critique", passMark = 0.72, reviseMark = 0.42, seed = 22502 })
		inst.system = S
		inst.ctx = ctx
