-- ARKHER SYSTEM VD.0012 :: World Grid Cell Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0012"
	S.key = "arkher.contsim.worldcell.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldcell.reality_continuum" }
	S.tags = { "vd", "worldcell", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.worldcell.emergence_continuum", windowSize = 5, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
