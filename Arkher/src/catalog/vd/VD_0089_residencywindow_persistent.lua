-- ARKHER SYSTEM VD.0089 :: Residency Window Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0089"
	S.key = "arkher.contsim.residencywindow.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.residencywindow.multi-scale_fidelity" }
	S.tags = { "vd", "residencywindow", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.residencywindow.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
