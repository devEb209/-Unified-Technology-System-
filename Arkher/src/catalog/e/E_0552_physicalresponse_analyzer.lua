-- ARKHER SYSTEM E.0552 :: Physical Response Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0552"
	S.key = "arkher.material.physicalresponse.analysis"
	S.name = "Physical Response Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.physicalresponse.instance_cache" }
	S.tags = { "e", "physicalresponse", "analyzer", "material" }
	S.description = "Physical Response Analysis: cost, redundancy and outlier analysis for the Physical Response subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.physicalresponse.analysis", window = 206, buckets = 18, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
