-- ARKHER SYSTEM VC.0245 :: Vegetation Field Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0245"
	S.key = "arkher.contneural.vegfield.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vegfield.multi-scale_fidelity" }
	S.tags = { "vc", "vegfield", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.vegfield.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
