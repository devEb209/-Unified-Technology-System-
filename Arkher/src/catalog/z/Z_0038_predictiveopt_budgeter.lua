-- ARKHER SYSTEM Z.0038 :: Predictive Optimization Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0038"
	S.key = "arkher.origin.predictiveopt.budget_governor"
	S.name = "Predictive Optimization Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.behaviour_analysis" }
	S.tags = { "z", "predictiveopt", "budgeter", "origin" }
	S.description = "Predictive Optimization Budget Governor: allocation of a scarce resource across the technology's consumers for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.predictiveopt.budget_governor", total = 78, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
