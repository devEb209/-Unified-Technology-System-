-- ARKHER SYSTEM H.0314 :: Mesh Collider Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0314"
	S.key = "arkher.physics.meshcollider.character_motion"
	S.name = "Mesh Collider Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.meshcollider.query" }
	S.tags = { "h", "meshcollider", "charmotor", "physics" }
	S.description = "Mesh Collider Character Motion: capsule move-and-slide with slopes, steps and jumps for the Mesh Collider subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.meshcollider.character_motion", radius = 0.52, height = 1.77, maxSpeed = 9.70, jumpHeight = 2.10, stepOffset = 0.52 })
		inst.system = S
		inst.ctx = ctx
