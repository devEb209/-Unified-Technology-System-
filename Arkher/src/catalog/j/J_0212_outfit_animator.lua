-- ARKHER SYSTEM J.0212 :: Outfit Composition Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0212"
	S.key = "arkher.character.outfit.blend_controller"
	S.name = "Outfit Composition Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.outfit.motion_set" }
	S.tags = { "j", "outfit", "animator", "character" }
	S.description = "Outfit Composition Blend Controller: layered playback driving the character for the Outfit Composition subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.outfit.blend_controller", budget = 7 })
		inst.system = S
		inst.ctx = ctx
