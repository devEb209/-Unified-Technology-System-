-- ARKHER SYSTEM E.0381 :: Terrain Splat Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0381"
	S.key = "arkher.material.splat.variant_registry"
	S.name = "Terrain Splat Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.splat.procedural_detail" }
	S.tags = { "e", "splat", "registry", "material" }
	S.description = "Terrain Splat Variant Registry: named variants and their lifecycle for the Terrain Splat subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.splat.variant_registry" })
		inst.system = S
		inst.ctx = ctx
