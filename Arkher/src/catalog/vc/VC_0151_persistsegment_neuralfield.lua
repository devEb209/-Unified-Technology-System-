-- ARKHER SYSTEM VC.0151 :: Persistence Segment Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0151"
	S.key = "arkher.contneural.persistsegment.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.persistsegment.coherence_guard" }
	S.tags = { "vc", "persistsegment", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.persistsegment.neural_field", dims = 12, hidden = 8, seed = 40496 })
		inst.system = S
		inst.ctx = ctx
