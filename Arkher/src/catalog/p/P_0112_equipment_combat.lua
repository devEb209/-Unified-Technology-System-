-- ARKHER SYSTEM P.0112 :: Equipment Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0112"
	S.key = "arkher.play.equipment.combat_resolution"
	S.name = "Equipment Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Equipment"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.equipment.objectives" }
	S.tags = { "p", "equipment", "combat", "play" }
	S.description = "Equipment Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Equipment subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.equipment.combat_resolution", seed = 82494, armourK = 140, critMultiplier = 2.10 })
		inst.system = S
		inst.ctx = ctx
