-- ARKHER SYSTEM VA.0062 :: Sparse Page Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0062"
	S.key = "arkher.contworld.sparsepage.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.sparsepage.infinite_grid" }
	S.tags = { "va", "sparsepage", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.sparsepage.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
