-- ARKHER SYSTEM N.0373 :: Projectile Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0373"
	S.key = "arkher.vfx.projectile.result_cache"
	S.name = "Projectile Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Projectile"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.projectile.spawn_budget" }
	S.tags = { "n", "projectile", "cache", "vfx" }
	S.description = "Projectile Result Cache: reuse of expensive effect evaluations for the Projectile subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.projectile.result_cache", policy = "lru", capacity = 332, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
