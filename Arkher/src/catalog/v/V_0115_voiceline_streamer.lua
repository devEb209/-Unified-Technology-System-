-- ARKHER SYSTEM V.0115 :: Voice Line Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0115"
	S.key = "arkher.asset.voiceline.streaming_residency"
	S.name = "Voice Line Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.voiceline.content_cache" }
	S.tags = { "v", "voiceline", "streamer", "asset" }
	S.description = "Voice Line Streaming Residency: distance-driven load and unload of asset payloads for the Voice Line subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.voiceline.streaming_residency", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
