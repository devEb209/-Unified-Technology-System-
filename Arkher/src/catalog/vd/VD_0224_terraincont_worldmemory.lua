-- ARKHER SYSTEM VD.0224 :: Terrain Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0224"
	S.key = "arkher.contsim.terraincont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.terraincont.neural_field" }
	S.tags = { "vd", "terraincont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.terraincont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
