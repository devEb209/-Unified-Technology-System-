-- ARKHER SYSTEM J.0081 :: Facial Rig Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0081"
	S.key = "arkher.character.facialrig.look_and_reach"
	S.name = "Facial Rig Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.facialrig.blend_controller" }
	S.tags = { "j", "facialrig", "ik", "character" }
	S.description = "Facial Rig Look And Reach: look-at, reach and foot placement for the character for the Facial Rig subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.facialrig.look_and_reach", iterations = 9, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
