-- ARKHER SYSTEM P.0066 :: Progression Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0066"
	S.key = "arkher.play.progression.rule_pipeline"
	S.name = "Progression Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Progression"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.progression.state_machine" }
	S.tags = { "p", "progression", "pipeline", "play" }
	S.description = "Progression Rule Pipeline: ordered rules applied to every gameplay event for the Progression subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.progression.rule_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
