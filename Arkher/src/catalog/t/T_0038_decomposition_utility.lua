-- ARKHER SYSTEM T.0038 :: Task Decomposition Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0038"
	S.key = "arkher.ai.decomposition.utility_selection"
	S.name = "Task Decomposition Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.decomposition.working_memory" }
	S.tags = { "t", "decomposition", "utility", "ai" }
	S.description = "Task Decomposition Utility Selection: scored choice between competing courses of action for the Task Decomposition subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.decomposition.utility_selection", momentum = 0.19 })
		inst.system = S
		inst.ctx = ctx
