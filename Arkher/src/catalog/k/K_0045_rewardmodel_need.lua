-- ARKHER SYSTEM K.0045 :: Reward Model Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0045"
	S.key = "arkher.npc.rewardmodel.drive_system"
	S.name = "Reward Model Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.rewardmodel.memory" }
	S.tags = { "k", "rewardmodel", "need", "npc" }
	S.description = "Reward Model Drive System: drives that decay, turn urgent and get satisfied for the Reward Model subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.rewardmodel.drive_system" })
		inst.system = S
		inst.ctx = ctx
