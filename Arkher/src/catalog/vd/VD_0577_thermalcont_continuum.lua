-- ARKHER SYSTEM VD.0577 :: Thermal Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0577"
	S.key = "arkher.contsim.thermalcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "thermalcont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.thermalcont.infinite_grid", cellSize = 64, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
