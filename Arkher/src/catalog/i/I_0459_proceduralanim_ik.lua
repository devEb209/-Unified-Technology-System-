-- ARKHER SYSTEM I.0459 :: Procedural Animation Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0459"
	S.key = "arkher.anim.proceduralanim.inverse_kinematics"
	S.name = "Procedural Animation Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.proceduralanim.layered_blending" }
	S.tags = { "i", "proceduralanim", "ik", "anim" }
	S.description = "Procedural Animation Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Procedural Animation subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.proceduralanim.inverse_kinematics", iterations = 7, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
