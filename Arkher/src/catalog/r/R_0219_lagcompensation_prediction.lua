-- ARKHER SYSTEM R.0219 :: Lag Compensation Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0219"
	S.key = "arkher.net.lagcompensation.prediction_and_reconciliation"
	S.name = "Lag Compensation Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.lagcompensation.time_sync" }
	S.tags = { "r", "lagcompensation", "prediction", "net" }
	S.description = "Lag Compensation Prediction And Reconciliation: client simulation, correction and input replay for the Lag Compensation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.lagcompensation.prediction_and_reconciliation", errorThreshold = 0.030, smoothing = 8.0, maxInputs = 100 })
		inst.system = S
		inst.ctx = ctx
