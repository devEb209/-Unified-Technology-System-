-- ARKHER SYSTEM VC.0531 :: Pipeline Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0531"
	S.key = "arkher.contneural.pipelinecont.sparse_residency"
	S.name = "Pipeline Continuum Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.pipelinecont.epoch_clock" }
	S.tags = { "vc", "pipelinecont", "sparse", "contneural" }
	S.description = "Pipeline Continuum Sparse Residency: sparse page residency with eviction and compression for the Pipeline Continuum subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.pipelinecont.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
