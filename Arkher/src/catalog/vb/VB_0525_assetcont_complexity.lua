-- ARKHER SYSTEM VB.0525 :: Asset Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0525"
	S.key = "arkher.conttime.assetcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.assetcont.world_memory_stream" }
	S.tags = { "vb", "assetcont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.assetcont.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
