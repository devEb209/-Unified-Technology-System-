-- ARKHER SYSTEM H.0003 :: Rigid Body Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0003"
	S.key = "arkher.physics.rigidbody.contact_generation"
	S.name = "Rigid Body Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Rigid Body"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rigidbody.collision_shape" }
	S.tags = { "h", "rigidbody", "contact", "physics" }
	S.description = "Rigid Body Contact Generation: narrow-phase manifolds with normal, depth and point for the Rigid Body subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.rigidbody.contact_generation", slop = 0.0080, maxManifolds = 329 })
		inst.system = S
		inst.ctx = ctx
