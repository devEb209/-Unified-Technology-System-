-- ARKHER SYSTEM Z.0956 :: Platform Abstraction Doctrine Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0956"
	S.key = "arkher.origin.platformdoctrine.governance_policy"
	S.name = "Platform Abstraction Doctrine Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.platformdoctrine.signal_composition" }
	S.tags = { "z", "platformdoctrine", "policy", "origin" }
	S.description = "Platform Abstraction Doctrine Governance Policy: ordered rules governing when the technology may act for the Platform Abstraction Doctrine subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.platformdoctrine.governance_policy", algorithm = "wfq", starvationGuard = 34 })
		inst.system = S
		inst.ctx = ctx
