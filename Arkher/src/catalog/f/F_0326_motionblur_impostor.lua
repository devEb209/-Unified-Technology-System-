-- ARKHER SYSTEM F.0326 :: Motion Blur Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0326"
	S.key = "arkher.render.motionblur.geometry_virtualization"
	S.name = "Motion Blur Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Motion Blur"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.motionblur.visibility_set" }
	S.tags = { "f", "motionblur", "impostor", "render" }
	S.description = "Motion Blur Geometry Virtualization: impostor and HLOD synthesis under a budget for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.motionblur.geometry_virtualization", atlasSlots = 112, viewCount = 8, errorThreshold = 2.10 })
		inst.system = S
		inst.ctx = ctx
