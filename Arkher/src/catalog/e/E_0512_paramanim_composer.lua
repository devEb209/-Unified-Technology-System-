-- ARKHER SYSTEM E.0512 :: Parameter Animation Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0512"
	S.key = "arkher.material.paramanim.layer_composition"
	S.name = "Parameter Animation Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.paramanim.definition" }
	S.tags = { "e", "paramanim", "composer", "material" }
	S.description = "Parameter Animation Layer Composition: ordered layer composition with blend rules for the Parameter Animation subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.paramanim.layer_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
