-- ARKHER SYSTEM J.0318 :: Character Streaming Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0318"
	S.key = "arkher.character.characterstreaming.streaming"
	S.name = "Character Streaming Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterstreaming.budget_governor" }
	S.tags = { "j", "characterstreaming", "streamer", "character" }
	S.description = "Character Streaming Streaming: distance-driven residency of character data for the Character Streaming subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.characterstreaming.streaming", radius = 280, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
