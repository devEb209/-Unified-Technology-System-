-- ARKHER SYSTEM Z.0323 :: Cross Reality Sync Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0323"
	S.key = "arkher.origin.crossreality.simulation_fabric"
	S.name = "Cross Reality Sync Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.complexity_governance" }
	S.tags = { "z", "crossreality", "fabric", "origin" }
	S.description = "Cross Reality Sync Simulation Fabric: every simulation domain stepped under one budgeted clock for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.crossreality.simulation_fabric", budgetMs = 3.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
