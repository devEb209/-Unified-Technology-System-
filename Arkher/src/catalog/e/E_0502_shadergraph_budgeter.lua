-- ARKHER SYSTEM E.0502 :: Shader Graph Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0502"
	S.key = "arkher.material.shadergraph.parameter_budget"
	S.name = "Shader Graph Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Shader Graph"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.shadergraph.variant_registry" }
	S.tags = { "e", "shadergraph", "budgeter", "material" }
	S.description = "Shader Graph Parameter Budget: texel and layer budget allocation for the Shader Graph subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.shadergraph.parameter_budget", total = 110, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
