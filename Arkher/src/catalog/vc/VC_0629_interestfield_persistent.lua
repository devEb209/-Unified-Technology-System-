-- ARKHER SYSTEM VC.0629 :: Interest Field Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0629"
	S.key = "arkher.contneural.interestfield.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.interestfield.multi-scale_fidelity" }
	S.tags = { "vc", "interestfield", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.interestfield.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
