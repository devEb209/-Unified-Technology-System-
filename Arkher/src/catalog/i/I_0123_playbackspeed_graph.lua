-- ARKHER SYSTEM I.0123 :: Playback Speed Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0123"
	S.key = "arkher.anim.playbackspeed.retarget_graph"
	S.name = "Playback Speed Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.playbackspeed.physical_blend" }
	S.tags = { "i", "playbackspeed", "graph", "anim" }
	S.description = "Playback Speed Retarget Graph: bone mapping and retarget path resolution for the Playback Speed subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.playbackspeed.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
