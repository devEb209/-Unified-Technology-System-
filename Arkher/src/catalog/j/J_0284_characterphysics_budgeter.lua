-- ARKHER SYSTEM J.0284 :: Character Physics Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0284"
	S.key = "arkher.character.characterphysics.budget_governor"
	S.name = "Character Physics Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterphysics.variant_registry" }
	S.tags = { "j", "characterphysics", "budgeter", "character" }
	S.description = "Character Physics Budget Governor: per-character cost allocation in a crowd for the Character Physics subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.characterphysics.budget_governor", total = 92, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
