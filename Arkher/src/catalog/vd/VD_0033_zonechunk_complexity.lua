-- ARKHER SYSTEM VD.0033 :: Zone Chunk Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0033"
	S.key = "arkher.contsim.zonechunk.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.zonechunk.world_memory_stream" }
	S.tags = { "vd", "zonechunk", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.zonechunk.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
