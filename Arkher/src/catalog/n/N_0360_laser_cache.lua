-- ARKHER SYSTEM N.0360 :: Laser Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0360"
	S.key = "arkher.vfx.laser.result_cache"
	S.name = "Laser Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Laser"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.laser.spawn_budget" }
	S.tags = { "n", "laser", "cache", "vfx" }
	S.description = "Laser Result Cache: reuse of expensive effect evaluations for the Laser subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.laser.result_cache", policy = "lfu", capacity = 349, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
