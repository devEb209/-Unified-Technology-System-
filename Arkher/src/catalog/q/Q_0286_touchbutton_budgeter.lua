-- ARKHER SYSTEM Q.0286 :: Touch Button Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0286"
	S.key = "arkher.ui.touchbutton.frame_budget"
	S.name = "Touch Button Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Touch Button"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.touchbutton.accessibility_policy" }
	S.tags = { "q", "touchbutton", "budgeter", "ui" }
	S.description = "Touch Button Frame Budget: per-frame layout and draw budget for the interface for the Touch Button subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.touchbutton.frame_budget", total = 445, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
