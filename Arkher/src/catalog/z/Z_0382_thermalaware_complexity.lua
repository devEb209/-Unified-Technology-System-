-- ARKHER SYSTEM Z.0382 :: Thermal Aware Simulation Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0382"
	S.key = "arkher.origin.thermalaware.complexity_governance"
	S.name = "Thermal Aware Simulation Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.reality_layering" }
	S.tags = { "z", "thermalaware", "complexity", "origin" }
	S.description = "Thermal Aware Simulation Complexity Governance: measured scene cost turned into per-subsystem directives for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.thermalaware.complexity_governance", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
