-- ARKHER SYSTEM VA.0262 :: Road Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0262"
	S.key = "arkher.contworld.roadcont.simulation_fabric"
	S.name = "Road Continuum Simulation Fabric"
	S.category = "VA"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.roadcont.complexity_budget" }
	S.tags = { "va", "roadcont", "fabric", "contworld" }
	S.description = "Road Continuum Simulation Fabric: fabric stepping the continuum domains for the Road Continuum subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.roadcont.simulation_fabric", budgetMs = 4.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
