-- ARKHER SYSTEM J.0149 :: Posture Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0149"
	S.key = "arkher.character.posture.locomotion"
	S.name = "Posture Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.posture.physical_response" }
	S.tags = { "j", "posture", "charmotor", "character" }
	S.description = "Posture Locomotion: capsule locomotion driving the character for the Posture subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.posture.locomotion", radius = 0.50, height = 1.95, maxSpeed = 9.50, jumpHeight = 1.90, stepOffset = 0.50 })
		inst.system = S
		inst.ctx = ctx
