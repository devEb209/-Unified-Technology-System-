-- ARKHER SYSTEM N.0214 :: Lightning Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0214"
	S.key = "arkher.vfx.lightning.effect_graph"
	S.name = "Lightning Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Lightning"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.lightning.curve_authoring" }
	S.tags = { "n", "lightning", "shadegraph", "vfx" }
	S.description = "Lightning Effect Graph: node graph describing how the effect is shaded for the Lightning subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.lightning.effect_graph" })
		inst.system = S
		inst.ctx = ctx
