-- ARKHER SYSTEM H.0613 :: Explosion Force Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0613"
	S.key = "arkher.physics.explosion.result_cache"
	S.name = "Explosion Force Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.explosion.simulation_policy" }
	S.tags = { "h", "explosion", "cache", "physics" }
	S.description = "Explosion Force Result Cache: reuse of expensive simulation and query results for the Explosion Force subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.explosion.result_cache", policy = "ttl", capacity = 212, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
