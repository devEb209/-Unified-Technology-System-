-- ARKHER SYSTEM G.0387 :: Deterministic Seeding Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0387"
	S.key = "arkher.neural.detseed.result_cache"
	S.name = "Deterministic Seeding Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detseed.compute_budget" }
	S.tags = { "g", "detseed", "cache", "neural" }
	S.description = "Deterministic Seeding Result Cache: cached inference results keyed by input for the Deterministic Seeding subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.detseed.result_cache", policy = "lru", capacity = 452, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
