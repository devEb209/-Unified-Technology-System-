-- ARKHER SYSTEM H.0423 :: Friction Model Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0423"
	S.key = "arkher.physics.friction.contact_generation"
	S.name = "Friction Model Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.friction.collision_shape" }
	S.tags = { "h", "friction", "contact", "physics" }
	S.description = "Friction Model Contact Generation: narrow-phase manifolds with normal, depth and point for the Friction Model subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.friction.contact_generation", slop = 0.0050, maxManifolds = 176 })
		inst.system = S
		inst.ctx = ctx
