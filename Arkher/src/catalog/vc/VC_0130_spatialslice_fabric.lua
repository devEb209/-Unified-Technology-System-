-- ARKHER SYSTEM VC.0130 :: Spatial Slice Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0130"
	S.key = "arkher.contneural.spatialslice.simulation_fabric"
	S.name = "Spatial Slice Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.spatialslice.complexity_budget" }
	S.tags = { "vc", "spatialslice", "fabric", "contneural" }
	S.description = "Spatial Slice Simulation Fabric: fabric stepping the continuum domains for the Spatial Slice subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.spatialslice.simulation_fabric", budgetMs = 1.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
