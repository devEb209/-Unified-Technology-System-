-- ARKHER SYSTEM K.0566 :: Work Behaviour Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0566"
	S.key = "arkher.npc.workbehaviour.reactive_behaviour"
	S.name = "Work Behaviour Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workbehaviour.perception" }
	S.tags = { "k", "workbehaviour", "behaviortree", "npc" }
	S.description = "Work Behaviour Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Work Behaviour subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.workbehaviour.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
