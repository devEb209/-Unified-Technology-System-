-- ARKHER SYSTEM K.0145 :: Rest Drive Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0145"
	S.key = "arkher.npc.restdrive.perception"
	S.name = "Rest Drive Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.restdrive.emotion" }
	S.tags = { "k", "restdrive", "perception", "npc" }
	S.description = "Rest Drive Perception: sight, hearing and bounded attention for the Rest Drive subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.restdrive.perception", sightRange = 25, hearingRange = 28, attentionSlots = 3, fov = 1.920 })
		inst.system = S
		inst.ctx = ctx
