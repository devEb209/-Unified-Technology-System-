-- ARKHER SYSTEM F.0184 :: Sky Model View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0184"
	S.key = "arkher.render.sky.view_and_culling"
	S.name = "Sky Model View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sky Model"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sky.frame_graph" }
	S.tags = { "f", "sky", "camera", "render" }
	S.description = "Sky Model View And Culling: view state, frustum culling and screen-size LOD for the Sky Model subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.sky.view_and_culling", width = 956, height = 900, fov = 0.9100, far = 1400 })
		inst.system = S
		inst.ctx = ctx
