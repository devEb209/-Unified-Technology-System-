-- ARKHER SYSTEM E.0220 :: Iridescence Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0220"
	S.key = "arkher.material.iridescence.quality_policy"
	S.name = "Iridescence Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Iridescence"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.iridescence.compression_codec" }
	S.tags = { "e", "iridescence", "policy", "material" }
	S.description = "Iridescence Quality Policy: device tier rules for the surface for the Iridescence subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.iridescence.quality_policy", algorithm = "lottery", starvationGuard = 43 })
		inst.system = S
		inst.ctx = ctx
