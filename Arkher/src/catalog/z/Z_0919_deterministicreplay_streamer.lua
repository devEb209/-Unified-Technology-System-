-- ARKHER SYSTEM Z.0919 :: Deterministic Replay Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0919"
	S.key = "arkher.origin.deterministicreplay.residency_streaming"
	S.name = "Deterministic Replay Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deterministicreplay.budget_governor" }
	S.tags = { "z", "deterministicreplay", "streamer", "origin" }
	S.description = "Deterministic Replay Residency Streaming: distance-driven residency of the technology's workload for the Deterministic Replay subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.deterministicreplay.residency_streaming", radius = 280, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
