-- ARKHER SYSTEM F.0026 :: Depth Prepass Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0026"
	S.key = "arkher.render.depthprepass.frame_analysis"
	S.name = "Depth Prepass Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.depthprepass.pass_cache" }
	S.tags = { "f", "depthprepass", "analyzer", "render" }
	S.description = "Depth Prepass Frame Analysis: per-pass cost analysis and outlier detection for the Depth Prepass subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.depthprepass.frame_analysis", window = 228, buckets = 16, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
