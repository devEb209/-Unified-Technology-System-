-- ARKHER SYSTEM Z.0879 :: Multi Scale Simulation Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0879"
	S.key = "arkher.origin.multiscale.residency_streaming"
	S.name = "Multi Scale Simulation Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.budget_governor" }
	S.tags = { "z", "multiscale", "streamer", "origin" }
	S.description = "Multi Scale Simulation Residency Streaming: distance-driven residency of the technology's workload for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.multiscale.residency_streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
