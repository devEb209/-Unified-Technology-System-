-- ARKHER SYSTEM K.0583 :: Idle Behaviour Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0583"
	S.key = "arkher.npc.idlebehaviour.navigation"
	S.name = "Idle Behaviour Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.idlebehaviour.goal_planner" }
	S.tags = { "k", "idlebehaviour", "navgraph", "npc" }
	S.description = "Idle Behaviour Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Idle Behaviour subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.idlebehaviour.navigation", width = 40, height = 40, cellSize = 4 })
		inst.system = S
		inst.ctx = ctx
