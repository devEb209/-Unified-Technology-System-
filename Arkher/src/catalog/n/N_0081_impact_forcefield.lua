-- ARKHER SYSTEM N.0081 :: Impact Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0081"
	S.key = "arkher.vfx.impact.force_field"
	S.name = "Impact Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Impact"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.impact.particle_simulation" }
	S.tags = { "n", "impact", "forcefield", "vfx" }
	S.description = "Impact Force Field: wind, attraction, vortex, drag and curl turbulence for the Impact subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.impact.force_field", seed = 1476 })
		inst.system = S
		inst.ctx = ctx
