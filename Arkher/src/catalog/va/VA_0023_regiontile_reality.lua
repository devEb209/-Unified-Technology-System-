-- ARKHER SYSTEM VA.0023 :: Region Tile Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0023"
	S.key = "arkher.contworld.regiontile.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.regiontile.simulation_fabric" }
	S.tags = { "va", "regiontile", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.regiontile.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
