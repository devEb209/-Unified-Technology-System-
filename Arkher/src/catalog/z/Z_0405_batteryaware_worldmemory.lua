-- ARKHER SYSTEM Z.0405 :: Battery Aware Pipeline World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0405"
	S.key = "arkher.origin.batteryaware.world_memory"
	S.name = "Battery Aware Pipeline World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.batteryaware.autonomous_pipeline" }
	S.tags = { "z", "batteryaware", "worldmemory", "origin" }
	S.description = "Battery Aware Pipeline World Memory: epoch-stamped persistent history with compaction and checkpoints for the Battery Aware Pipeline subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.batteryaware.world_memory", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
