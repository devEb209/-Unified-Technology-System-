-- ARKHER SYSTEM I.0127 :: Playback Speed Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0127"
	S.key = "arkher.anim.playbackspeed.pose_cache"
	S.name = "Playback Speed Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.playbackspeed.playback_pipeline" }
	S.tags = { "i", "playbackspeed", "cache", "anim" }
	S.description = "Playback Speed Pose Cache: reuse of sampled poses across frames and instances for the Playback Speed subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.playbackspeed.pose_cache", policy = "ttl", capacity = 286, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
