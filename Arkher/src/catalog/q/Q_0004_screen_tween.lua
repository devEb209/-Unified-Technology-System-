-- ARKHER SYSTEM Q.0004 :: Screen Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0004"
	S.key = "arkher.ui.screen.transition"
	S.name = "Screen Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Screen"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.screen.input_mapping" }
	S.tags = { "q", "screen", "tween", "ui" }
	S.description = "Screen Transition: eased, delayed, looped and sequenced motion for the Screen subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.screen.transition", timeScale = 0.90 })
		inst.system = S
		inst.ctx = ctx
