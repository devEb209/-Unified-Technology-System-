-- ARKHER SYSTEM Z.0362 :: Mobile First Governor Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0362"
	S.key = "arkher.origin.mobilefirst.complexity_governance"
	S.name = "Mobile First Governor Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.reality_layering" }
	S.tags = { "z", "mobilefirst", "complexity", "origin" }
	S.description = "Mobile First Governor Complexity Governance: measured scene cost turned into per-subsystem directives for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.mobilefirst.complexity_governance", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
