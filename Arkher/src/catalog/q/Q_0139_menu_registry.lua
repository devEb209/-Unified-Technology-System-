-- ARKHER SYSTEM Q.0139 :: Menu Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0139"
	S.key = "arkher.ui.menu.localization_registry"
	S.name = "Menu Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Menu"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.menu.theme_composition" }
	S.tags = { "q", "menu", "registry", "ui" }
	S.description = "Menu Localization Registry: catalogue of strings, plurals and locale metadata for the Menu subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.menu.localization_registry" })
		inst.system = S
		inst.ctx = ctx
