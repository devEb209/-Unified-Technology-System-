-- ARKHER SYSTEM VA.0298 :: Climate Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0298"
	S.key = "arkher.contworld.climatecont.simulation_fabric"
	S.name = "Climate Continuum Simulation Fabric"
	S.category = "VA"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.climatecont.complexity_budget" }
	S.tags = { "va", "climatecont", "fabric", "contworld" }
	S.description = "Climate Continuum Simulation Fabric: fabric stepping the continuum domains for the Climate Continuum subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.climatecont.simulation_fabric", budgetMs = 4.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
