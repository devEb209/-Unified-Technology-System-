-- ARKHER SYSTEM H.0282 :: Box Collider Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0282"
	S.key = "arkher.physics.boxcollider.collision_shape"
	S.name = "Box Collider Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Box Collider"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.boxcollider.body_dynamics" }
	S.tags = { "h", "boxcollider", "collider", "physics" }
	S.description = "Box Collider Collision Shape: shape bounds, support mapping and closest points for the Box Collider subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.boxcollider.collision_shape", shape = "box", radius = 0.50, height = 1.30, layer = "world" })
		inst.system = S
		inst.ctx = ctx
