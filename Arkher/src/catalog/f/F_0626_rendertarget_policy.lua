-- ARKHER SYSTEM F.0626 :: Render Target Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0626"
	S.key = "arkher.render.rendertarget.render_policy"
	S.name = "Render Target Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.rendertarget.draw_budget" }
	S.tags = { "f", "rendertarget", "policy", "render" }
	S.description = "Render Target Render Policy: device tier rules for the frame for the Render Target subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.rendertarget.render_policy", algorithm = "edf", starvationGuard = 29 })
		inst.system = S
		inst.ctx = ctx
