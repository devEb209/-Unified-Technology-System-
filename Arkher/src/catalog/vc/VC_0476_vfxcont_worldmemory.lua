-- ARKHER SYSTEM VC.0476 :: VFX Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0476"
	S.key = "arkher.contneural.vfxcont.world_memory_stream"
	S.name = "VFX Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vfxcont.neural_field" }
	S.tags = { "vc", "vfxcont", "worldmemory", "contneural" }
	S.description = "VFX Continuum World Memory Stream: world memory continuum over epochs for the VFX Continuum subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.vfxcont.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
