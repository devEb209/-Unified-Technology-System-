-- ARKHER SYSTEM N.0289 :: Buff Effect Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0289"
	S.key = "arkher.vfx.bufffx.force_field"
	S.name = "Buff Effect Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Buff Effect"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.bufffx.particle_simulation" }
	S.tags = { "n", "bufffx", "forcefield", "vfx" }
	S.description = "Buff Effect Force Field: wind, attraction, vortex, drag and curl turbulence for the Buff Effect subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.bufffx.force_field", seed = 81637 })
		inst.system = S
		inst.ctx = ctx
