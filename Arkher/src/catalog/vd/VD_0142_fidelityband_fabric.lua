-- ARKHER SYSTEM VD.0142 :: Fidelity Band Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0142"
	S.key = "arkher.contsim.fidelityband.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.fidelityband.complexity_budget" }
	S.tags = { "vd", "fidelityband", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.fidelityband.simulation_fabric", budgetMs = 1.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
