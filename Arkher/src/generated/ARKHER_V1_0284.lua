--!strict
-- 3dsMax Stack — CORE Profiler #0284
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="3dsMax Stack — CORE Profiler #0284", size=Vector2.new(680, 500), pos=UDim2.fromOffset(192, 228), parent=parent, icon="↻"})
