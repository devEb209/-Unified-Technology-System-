-- ARKHER SYSTEM H.0057 :: Inertia Tensor Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0057"
	S.key = "arkher.physics.inertia.body_dynamics"
	S.name = "Inertia Tensor Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "inertia", "rigidbody", "physics" }
	S.description = "Inertia Tensor Body Dynamics: integration, impulses, damping and sleeping of a body for the Inertia Tensor subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.inertia.body_dynamics", mass = 13.00, radius = 0.90, restitution = 0.32, friction = 0.42, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
