-- ARKHER SYSTEM P.0443 :: Matchmaking Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0443"
	S.key = "arkher.play.matchmaking.save_codec"
	S.name = "Matchmaking Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Matchmaking"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.matchmaking.content_registry" }
	S.tags = { "p", "matchmaking", "codec", "play" }
	S.description = "Matchmaking Save Codec: persistence, diffing and checksum of gameplay state for the Matchmaking subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.matchmaking.save_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
