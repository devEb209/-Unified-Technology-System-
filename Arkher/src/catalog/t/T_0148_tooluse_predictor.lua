-- ARKHER SYSTEM T.0148 :: Tool Use Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0148"
	S.key = "arkher.ai.tooluse.outcome_prediction"
	S.name = "Tool Use Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.tooluse.decision_policy" }
	S.tags = { "t", "tooluse", "predictor", "ai" }
	S.description = "Tool Use Outcome Prediction: forecasting the result before the work is done for the Tool Use subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.tooluse.outcome_prediction", method = "ema", alpha = 0.32, window = 86 })
		inst.system = S
		inst.ctx = ctx
