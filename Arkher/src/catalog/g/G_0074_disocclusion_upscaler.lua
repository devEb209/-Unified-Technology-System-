-- ARKHER SYSTEM G.0074 :: Disocclusion Handling Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0074"
	S.key = "arkher.neural.disocclusion.reconstruction"
	S.name = "Disocclusion Handling Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.disocclusion.temporal_history" }
	S.tags = { "g", "disocclusion", "upscaler", "neural" }
	S.description = "Disocclusion Handling Reconstruction: resolution ladder and image reconstruction for the Disocclusion Handling subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.disocclusion.reconstruction", targetMs = 13.10, index = 5, sharpness = 0.56 })
		inst.system = S
		inst.ctx = ctx
