-- ARKHER SYSTEM VB.0501 :: Rendering Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0501"
	S.key = "arkher.conttime.rendercont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.rendercont.world_memory_stream" }
	S.tags = { "vb", "rendercont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.rendercont.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
