-- ARKHER SYSTEM N.0088 :: Impact Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0088"
	S.key = "arkher.vfx.impact.quality_policy"
	S.name = "Impact Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Impact"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.impact.result_cache" }
	S.tags = { "n", "impact", "policy", "vfx" }
	S.description = "Impact Quality Policy: distance and device driven fidelity bands for the Impact subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.impact.quality_policy", algorithm = "roundrobin", starvationGuard = 36 })
		inst.system = S
		inst.ctx = ctx
