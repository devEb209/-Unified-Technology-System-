-- ARKHER SYSTEM Z.0971 :: Generation Migration Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0971"
	S.key = "arkher.origin.generationmigration.adaptive_workflow"
	S.name = "Generation Migration Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.self_critique" }
	S.tags = { "z", "generationmigration", "workflow", "origin" }
	S.description = "Generation Migration Adaptive Workflow: verified, retryable, reversible execution plans for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.generationmigration.adaptive_workflow", maxRetries = 3, budget = 60 })
		inst.system = S
		inst.ctx = ctx
