-- ARKHER SYSTEM L.0489 :: Diplomacy State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0489"
	S.key = "arkher.sim.diplomacy.state_codec"
	S.name = "Diplomacy State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.diplomacy.history_ledger" }
	S.tags = { "l", "diplomacy", "codec", "sim" }
	S.description = "Diplomacy State Codec: persistence, diffing and checksum of the world state for the Diplomacy subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.diplomacy.state_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
