-- ARKHER SYSTEM Z.0335 :: Cross Reality Sync Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0335"
	S.key = "arkher.origin.crossreality.signal_composition"
	S.name = "Cross Reality Sync Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.telemetry_ledger" }
	S.tags = { "z", "crossreality", "composer", "origin" }
	S.description = "Cross Reality Sync Signal Composition: blending of the technology's input signals into one output for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.crossreality.signal_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
