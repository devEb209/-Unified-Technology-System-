-- ARKHER SYSTEM R.0125 :: Reliable Channel Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0125"
	S.key = "arkher.net.reliablechannel.bandwidth_budget"
	S.name = "Reliable Channel Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reliablechannel.transport_graph" }
	S.tags = { "r", "reliablechannel", "budgeter", "net" }
	S.description = "Reliable Channel Bandwidth Budget: bytes per second shared between competing streams for the Reliable Channel subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.reliablechannel.bandwidth_budget", total = 375, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
