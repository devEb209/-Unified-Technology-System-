-- ARKHER SYSTEM V.0267 :: Lightmap Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0267"
	S.key = "arkher.asset.lightmap.cook_pipeline"
	S.name = "Lightmap Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lightmap.bundling" }
	S.tags = { "v", "lightmap", "pipeline", "asset" }
	S.description = "Lightmap Cook Pipeline: staged cooking with isolation and retries for the Lightmap subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.lightmap.cook_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
