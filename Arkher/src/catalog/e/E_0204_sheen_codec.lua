-- ARKHER SYSTEM E.0204 :: Sheen Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0204"
	S.key = "arkher.material.sheen.compression_codec"
	S.name = "Sheen Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Sheen"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.sheen.streaming" }
	S.tags = { "e", "sheen", "codec", "material" }
	S.description = "Sheen Compression Codec: serialization and compression of material data for the Sheen subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.sheen.compression_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
