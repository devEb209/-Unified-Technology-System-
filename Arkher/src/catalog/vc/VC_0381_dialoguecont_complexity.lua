-- ARKHER SYSTEM VC.0381 :: Dialogue Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0381"
	S.key = "arkher.contneural.dialoguecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.dialoguecont.world_memory_stream" }
	S.tags = { "vc", "dialoguecont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.dialoguecont.complexity_budget", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
