-- ARKHER SYSTEM T.0090 :: Semantic Search Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0090"
	S.key = "arkher.ai.semanticsearch.reasoning_graph"
	S.name = "Semantic Search Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.semanticsearch.world_architect" }
	S.tags = { "t", "semanticsearch", "graph", "ai" }
	S.description = "Semantic Search Reasoning Graph: relationship modelling and shortest-path reasoning for the Semantic Search subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.semanticsearch.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
