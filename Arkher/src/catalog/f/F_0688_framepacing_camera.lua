-- ARKHER SYSTEM F.0688 :: Frame Pacing View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0688"
	S.key = "arkher.render.framepacing.view_and_culling"
	S.name = "Frame Pacing View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Frame Pacing"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepacing.frame_graph" }
	S.tags = { "f", "framepacing", "camera", "render" }
	S.description = "Frame Pacing View And Culling: view state, frustum culling and screen-size LOD for the Frame Pacing subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.framepacing.view_and_culling", width = 956, height = 1080, fov = 0.9600, far = 1600 })
		inst.system = S
		inst.ctx = ctx
