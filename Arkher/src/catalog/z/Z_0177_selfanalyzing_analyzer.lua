-- ARKHER SYSTEM Z.0177 :: Self Analyzing Project Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0177"
	S.key = "arkher.origin.selfanalyzing.behaviour_analysis"
	S.name = "Self Analyzing Project Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.governance_policy" }
	S.tags = { "z", "selfanalyzing", "analyzer", "origin" }
	S.description = "Self Analyzing Project Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.selfanalyzing.behaviour_analysis", window = 63, buckets = 15, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
