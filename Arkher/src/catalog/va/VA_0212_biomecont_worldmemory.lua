-- ARKHER SYSTEM VA.0212 :: Biome Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0212"
	S.key = "arkher.contworld.biomecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.biomecont.neural_field" }
	S.tags = { "va", "biomecont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.biomecont.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
