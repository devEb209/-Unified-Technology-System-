-- ARKHER SYSTEM VA.0115 :: Temporal Slice Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0115"
	S.key = "arkher.contworld.temporalslice.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.temporalslice.coherence_guard" }
	S.tags = { "va", "temporalslice", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.temporalslice.neural_field", dims = 16, hidden = 12, seed = 73905 })
		inst.system = S
		inst.ctx = ctx
