-- ARKHER SYSTEM N.0316 :: Trail Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0316"
	S.key = "arkher.vfx.trail.ribbon_and_trail"
	S.name = "Trail Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Trail"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.trail.force_field" }
	S.tags = { "n", "trail", "ribbon", "vfx" }
	S.description = "Trail Ribbon And Trail: trail points, tapering, beams and decimation for the Trail subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.trail.ribbon_and_trail", maxPoints = 56, lifetime = 1.40, minDistance = 0.55, width = 0.70 })
		inst.system = S
		inst.ctx = ctx
