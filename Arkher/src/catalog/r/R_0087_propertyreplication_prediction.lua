-- ARKHER SYSTEM R.0087 :: Property Replication Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0087"
	S.key = "arkher.net.propertyreplication.prediction_and_reconciliation"
	S.name = "Property Replication Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.propertyreplication.time_sync" }
	S.tags = { "r", "propertyreplication", "prediction", "net" }
	S.description = "Property Replication Prediction And Reconciliation: client simulation, correction and input replay for the Property Replication subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.propertyreplication.prediction_and_reconciliation", errorThreshold = 0.060, smoothing = 14.0, maxInputs = 60 })
		inst.system = S
		inst.ctx = ctx
