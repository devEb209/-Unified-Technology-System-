-- ARKHER SYSTEM VC.0322 :: Ecology Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0322"
	S.key = "arkher.contneural.ecologycont.simulation_fabric"
	S.name = "Ecology Continuum Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.ecologycont.complexity_budget" }
	S.tags = { "vc", "ecologycont", "fabric", "contneural" }
	S.description = "Ecology Continuum Simulation Fabric: fabric stepping the continuum domains for the Ecology Continuum subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.ecologycont.simulation_fabric", budgetMs = 2.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
