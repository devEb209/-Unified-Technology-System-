-- ARKHER SYSTEM R.0067 :: Entity Replication Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0067"
	S.key = "arkher.net.entityreplication.interest_streaming"
	S.name = "Entity Replication Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.entityreplication.serialization_codec" }
	S.tags = { "r", "entityreplication", "streamer", "net" }
	S.description = "Entity Replication Interest Streaming: distance-driven residency of replicated content for the Entity Replication subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.entityreplication.interest_streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
