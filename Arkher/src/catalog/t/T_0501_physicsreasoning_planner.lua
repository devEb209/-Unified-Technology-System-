-- ARKHER SYSTEM T.0501 :: Physics Reasoning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0501"
	S.key = "arkher.ai.physicsreasoning.action_planner"
	S.name = "Physics Reasoning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.physicsreasoning.utility_selection" }
	S.tags = { "t", "physicsreasoning", "planner", "ai" }
	S.description = "Physics Reasoning Action Planner: goal-oriented action planning over preconditions for the Physics Reasoning subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.physicsreasoning.action_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
