-- ARKHER SYSTEM VD.0384 :: Dialogue Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0384"
	S.key = "arkher.contsim.dialoguecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.dialoguecont.reality_continuum" }
	S.tags = { "vd", "dialoguecont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.dialoguecont.emergence_continuum", windowSize = 4, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
