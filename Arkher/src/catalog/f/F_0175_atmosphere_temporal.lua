-- ARKHER SYSTEM F.0175 :: Atmosphere Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0175"
	S.key = "arkher.render.atmosphere.temporal_resolve"
	S.name = "Atmosphere Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Atmosphere"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.atmosphere.probe_volume" }
	S.tags = { "f", "atmosphere", "temporal", "render" }
	S.description = "Atmosphere Temporal Resolve: history reprojection with neighbourhood clamping for the Atmosphere subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.atmosphere.temporal_resolve", feedback = 0.81, phase = 8 })
		inst.system = S
		inst.ctx = ctx
