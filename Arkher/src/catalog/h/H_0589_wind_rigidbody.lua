-- ARKHER SYSTEM H.0589 :: Wind Force Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0589"
	S.key = "arkher.physics.wind.body_dynamics"
	S.name = "Wind Force Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Wind Force"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "wind", "rigidbody", "physics" }
	S.description = "Wind Force Body Dynamics: integration, impulses, damping and sleeping of a body for the Wind Force subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.wind.body_dynamics", mass = 6.00, radius = 0.55, restitution = 0.45, friction = 0.35, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
