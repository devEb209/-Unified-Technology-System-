-- ARKHER SYSTEM K.0453 :: Crowd Flow Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0453"
	S.key = "arkher.npc.crowdflow.perception"
	S.name = "Crowd Flow Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.crowdflow.emotion" }
	S.tags = { "k", "crowdflow", "perception", "npc" }
	S.description = "Crowd Flow Perception: sight, hearing and bounded attention for the Crowd Flow subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.crowdflow.perception", sightRange = 25, hearingRange = 12, attentionSlots = 3, fov = 1.840 })
		inst.system = S
		inst.ctx = ctx
