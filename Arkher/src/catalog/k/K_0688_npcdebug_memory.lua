-- ARKHER SYSTEM K.0688 :: NPC Debug Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0688"
	S.key = "arkher.npc.npcdebug.memory"
	S.name = "NPC Debug Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcdebug.mind_network" }
	S.tags = { "k", "npcdebug", "memory", "npc" }
	S.description = "NPC Debug Memory: episodic memory with decay, recall and consolidation for the NPC Debug subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.npcdebug.memory", capacity = 107, decayRate = 0.055, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
