-- ARKHER SYSTEM VA.0371 :: Quest Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0371"
	S.key = "arkher.contworld.questcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.questcont.simulation_fabric" }
	S.tags = { "va", "questcont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.questcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
