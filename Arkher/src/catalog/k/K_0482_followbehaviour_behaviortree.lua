-- ARKHER SYSTEM K.0482 :: Follow Behaviour Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0482"
	S.key = "arkher.npc.followbehaviour.reactive_behaviour"
	S.name = "Follow Behaviour Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.followbehaviour.perception" }
	S.tags = { "k", "followbehaviour", "behaviortree", "npc" }
	S.description = "Follow Behaviour Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Follow Behaviour subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.followbehaviour.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
