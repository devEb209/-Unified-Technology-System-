-- ARKHER SYSTEM I.0291 :: Look At IK Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0291"
	S.key = "arkher.anim.lookatik.physical_blend"
	S.name = "Look At IK Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Look At IK"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.lookatik.inverse_kinematics" }
	S.tags = { "i", "lookatik", "ragdoll", "anim" }
	S.description = "Look At IK Physical Blend: physical bones blended against the animated pose for the Look At IK subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.lookatik.physical_blend", blendSpeed = 3.00 })
		inst.system = S
		inst.ctx = ctx
