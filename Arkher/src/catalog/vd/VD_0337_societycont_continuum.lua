-- ARKHER SYSTEM VD.0337 :: Society Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0337"
	S.key = "arkher.contsim.societycont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "societycont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.societycont.infinite_grid", cellSize = 96, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
