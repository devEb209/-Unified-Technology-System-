-- ARKHER SYSTEM Q.0214 :: Compass Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0214"
	S.key = "arkher.ui.compass.frame_budget"
	S.name = "Compass Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Compass"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.compass.accessibility_policy" }
	S.tags = { "q", "compass", "budgeter", "ui" }
	S.description = "Compass Frame Budget: per-frame layout and draw budget for the interface for the Compass subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.compass.frame_budget", total = 116, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
