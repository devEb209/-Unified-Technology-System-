-- ARKHER SYSTEM K.0459 :: Crowd Flow Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0459"
	S.key = "arkher.npc.crowdflow.social_relations"
	S.name = "Crowd Flow Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.crowdflow.crowd_steering" }
	S.tags = { "k", "crowdflow", "society", "npc" }
	S.description = "Crowd Flow Social Relations: affinity, factions, reputation and gossip for the Crowd Flow subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.crowdflow.social_relations", decayRate = 0.007, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
