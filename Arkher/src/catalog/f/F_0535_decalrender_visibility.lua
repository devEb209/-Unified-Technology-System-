-- ARKHER SYSTEM F.0535 :: Decal Rendering Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0535"
	S.key = "arkher.render.decalrender.visibility_set"
	S.name = "Decal Rendering Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.decalrender.view_and_culling" }
	S.tags = { "f", "decalrender", "visibility", "render" }
	S.description = "Decal Rendering Visibility Set: cell, portal and occluder visibility for the Decal Rendering subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.decalrender.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
