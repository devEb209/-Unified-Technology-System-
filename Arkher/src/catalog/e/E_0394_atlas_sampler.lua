-- ARKHER SYSTEM E.0394 :: Texture Atlas Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0394"
	S.key = "arkher.material.atlas.texture_sampling"
	S.name = "Texture Atlas Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.atlas.shading_graph" }
	S.tags = { "e", "atlas", "sampler", "material" }
	S.description = "Texture Atlas Texture Sampling: atlas packing, mip chain and filtered sampling for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.atlas.texture_sampling", atlasSize = 128, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
