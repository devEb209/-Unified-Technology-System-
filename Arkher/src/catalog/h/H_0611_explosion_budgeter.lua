-- ARKHER SYSTEM H.0611 :: Explosion Force Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0611"
	S.key = "arkher.physics.explosion.budget_governor"
	S.name = "Explosion Force Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.explosion.broadphase_index" }
	S.tags = { "h", "explosion", "budgeter", "physics" }
	S.description = "Explosion Force Budget Governor: simulation time budget allocation across islands for the Explosion Force subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.explosion.budget_governor", total = 325, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
