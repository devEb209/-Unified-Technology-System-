-- ARKHER SYSTEM VB.0192 :: Simulation Domain Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0192"
	S.key = "arkher.conttime.simdomain.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.simdomain.reality_continuum" }
	S.tags = { "vb", "simdomain", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.simdomain.emergence_continuum", windowSize = 5, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
