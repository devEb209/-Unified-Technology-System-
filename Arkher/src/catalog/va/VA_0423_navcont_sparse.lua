-- ARKHER SYSTEM VA.0423 :: Navigation Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0423"
	S.key = "arkher.contworld.navcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.navcont.epoch_clock" }
	S.tags = { "va", "navcont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.navcont.sparse_residency", capacity = 256, pageBytes = 3072 })
		inst.system = S
		inst.ctx = ctx
