-- ARKHER SYSTEM V.0064 :: Shader Asset Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0064"
	S.key = "arkher.asset.shaderasset.asset_registry"
	S.name = "Shader Asset Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.shaderasset.cook_pipeline" }
	S.tags = { "v", "shaderasset", "registry", "asset" }
	S.description = "Shader Asset Asset Registry: catalogue of every asset, its tags and its metadata for the Shader Asset subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.shaderasset.asset_registry" })
		inst.system = S
		inst.ctx = ctx
