-- ARKHER SYSTEM W.0068 :: Tracking Shot Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0068"
	S.key = "arkher.cine.tracking.cinematic_mix"
	S.name = "Tracking Shot Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.tracking.motion_tween" }
	S.tags = { "w", "tracking", "mixer", "cine" }
	S.description = "Tracking Shot Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Tracking Shot subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.tracking.cinematic_mix", maxVoices = 48 })
		inst.system = S
		inst.ctx = ctx
