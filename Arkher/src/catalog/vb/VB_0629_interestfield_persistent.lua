-- ARKHER SYSTEM VB.0629 :: Interest Field Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0629"
	S.key = "arkher.conttime.interestfield.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.interestfield.multi-scale_fidelity" }
	S.tags = { "vb", "interestfield", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.interestfield.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
