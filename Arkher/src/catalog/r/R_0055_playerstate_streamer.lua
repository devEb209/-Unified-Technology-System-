-- ARKHER SYSTEM R.0055 :: Player State Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0055"
	S.key = "arkher.net.playerstate.interest_streaming"
	S.name = "Player State Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Player State"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.playerstate.serialization_codec" }
	S.tags = { "r", "playerstate", "streamer", "net" }
	S.description = "Player State Interest Streaming: distance-driven residency of replicated content for the Player State subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.playerstate.interest_streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
