-- ARKHER SYSTEM P.0135 :: Rarity Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0135"
	S.key = "arkher.play.rarity.objectives"
	S.name = "Rarity Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Rarity"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.rarity.inventory" }
	S.tags = { "p", "rarity", "quest", "play" }
	S.description = "Rarity Objectives: objectives, prerequisites, progress and rewards for the Rarity subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.rarity.objectives" })
		inst.system = S
		inst.ctx = ctx
