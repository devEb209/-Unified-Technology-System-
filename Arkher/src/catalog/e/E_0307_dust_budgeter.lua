-- ARKHER SYSTEM E.0307 :: Dust Accumulation Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0307"
	S.key = "arkher.material.dust.parameter_budget"
	S.name = "Dust Accumulation Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.dust.variant_registry" }
	S.tags = { "e", "dust", "budgeter", "material" }
	S.description = "Dust Accumulation Parameter Budget: texel and layer budget allocation for the Dust Accumulation subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.dust.parameter_budget", total = 200, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
