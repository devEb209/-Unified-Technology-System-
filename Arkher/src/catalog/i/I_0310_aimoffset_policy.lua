-- ARKHER SYSTEM I.0310 :: Aim Offset Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0310"
	S.key = "arkher.anim.aimoffset.quality_policy"
	S.name = "Aim Offset Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Aim Offset"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.aimoffset.pose_cache" }
	S.tags = { "i", "aimoffset", "policy", "anim" }
	S.description = "Aim Offset Quality Policy: device tier rules for rate, bones and solvers for the Aim Offset subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.aimoffset.quality_policy", algorithm = "lottery", starvationGuard = 59 })
		inst.system = S
		inst.ctx = ctx
