-- ARKHER SYSTEM VC.0049 :: Epoch Frame Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0049"
	S.key = "arkher.contneural.epochframe.infinite_grid"
	S.name = "Epoch Frame Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "epochframe", "continuum", "contneural" }
	S.description = "Epoch Frame Infinite Grid: seamless paging of the infinite world grid for the Epoch Frame subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.epochframe.infinite_grid", cellSize = 64, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
