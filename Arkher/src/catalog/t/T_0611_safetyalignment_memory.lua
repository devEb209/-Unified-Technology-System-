-- ARKHER SYSTEM T.0611 :: Safety Alignment Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0611"
	S.key = "arkher.ai.safetyalignment.working_memory"
	S.name = "Safety Alignment Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.safetyalignment.outcome_prediction" }
	S.tags = { "t", "safetyalignment", "memory", "ai" }
	S.description = "Safety Alignment Working Memory: decaying, consolidating recall of what the agent learned for the Safety Alignment subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.safetyalignment.working_memory", capacity = 85, decayRate = 0.055, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
