-- ARKHER SYSTEM Z.0811 :: Perceptual Budgeting Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0811"
	S.key = "arkher.origin.perceptualbudget.adaptive_workflow"
	S.name = "Perceptual Budgeting Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.perceptualbudget.self_critique" }
	S.tags = { "z", "perceptualbudget", "workflow", "origin" }
	S.description = "Perceptual Budgeting Adaptive Workflow: verified, retryable, reversible execution plans for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.perceptualbudget.adaptive_workflow", maxRetries = 1, budget = 40 })
		inst.system = S
		inst.ctx = ctx
