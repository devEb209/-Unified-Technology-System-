-- ARKHER SYSTEM R.0065 :: Entity Replication Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0065"
	S.key = "arkher.net.entityreplication.bandwidth_budget"
	S.name = "Entity Replication Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.entityreplication.transport_graph" }
	S.tags = { "r", "entityreplication", "budgeter", "net" }
	S.description = "Entity Replication Bandwidth Budget: bytes per second shared between competing streams for the Entity Replication subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.entityreplication.bandwidth_budget", total = 436, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
