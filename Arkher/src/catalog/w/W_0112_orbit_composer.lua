-- ARKHER SYSTEM W.0112 :: Orbit Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0112"
	S.key = "arkher.cine.orbit.shot_composition"
	S.name = "Orbit Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Orbit"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.orbit.colour_grade" }
	S.tags = { "w", "orbit", "composer", "cine" }
	S.description = "Orbit Shot Composition: blending of the signals that make up the final shot for the Orbit subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.orbit.shot_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
