-- ARKHER SYSTEM J.0016 :: Character Rig Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0016"
	S.key = "arkher.character.characterrig.physical_response"
	S.name = "Character Rig Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterrig.look_and_reach" }
	S.tags = { "j", "characterrig", "ragdoll", "character" }
	S.description = "Character Rig Physical Response: physical reaction, ragdoll and recovery for the Character Rig subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.characterrig.physical_response", blendSpeed = 2.70 })
		inst.system = S
		inst.ctx = ctx
