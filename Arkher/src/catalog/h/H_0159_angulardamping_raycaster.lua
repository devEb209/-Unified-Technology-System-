-- ARKHER SYSTEM H.0159 :: Angular Damping Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0159"
	S.key = "arkher.physics.angulardamping.query"
	S.name = "Angular Damping Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.angulardamping.constraint_solver" }
	S.tags = { "h", "angulardamping", "raycaster", "physics" }
	S.description = "Angular Damping Query: rays, sweeps and overlaps against the simulation for the Angular Damping subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.angulardamping.query", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
