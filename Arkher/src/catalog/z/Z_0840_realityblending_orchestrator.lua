-- ARKHER SYSTEM Z.0840 :: Reality Blending Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0840"
	S.key = "arkher.origin.realityblending.orchestration"
	S.name = "Reality Blending Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.residency_streaming" }
	S.tags = { "z", "realityblending", "orchestrator", "origin" }
	S.description = "Reality Blending Orchestration: lifecycle and phase orchestration of the technology for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.realityblending.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
