-- ARKHER SYSTEM L.0592 :: World Persistence Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0592"
	S.key = "arkher.sim.worldpersistence.route_network"
	S.name = "World Persistence Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldpersistence.region_graph" }
	S.tags = { "l", "worldpersistence", "network", "sim" }
	S.description = "World Persistence Route Network: roads, rivers and routes between settlements for the World Persistence subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.worldpersistence.route_network" })
		inst.system = S
		inst.ctx = ctx
