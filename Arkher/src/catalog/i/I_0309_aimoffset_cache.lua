-- ARKHER SYSTEM I.0309 :: Aim Offset Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0309"
	S.key = "arkher.anim.aimoffset.pose_cache"
	S.name = "Aim Offset Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Aim Offset"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.aimoffset.playback_pipeline" }
	S.tags = { "i", "aimoffset", "cache", "anim" }
	S.description = "Aim Offset Pose Cache: reuse of sampled poses across frames and instances for the Aim Offset subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.aimoffset.pose_cache", policy = "lru", capacity = 507, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
