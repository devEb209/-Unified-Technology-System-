-- ARKHER SYSTEM J.0221 :: Character Variant Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0221"
	S.key = "arkher.character.charvariant.rig_definition"
	S.name = "Character Variant Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "charvariant", "skeleton", "character" }
	S.description = "Character Variant Rig Definition: character rig definition and bone budget for the Character Variant subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.charvariant.rig_definition" })
		inst.system = S
		inst.ctx = ctx
