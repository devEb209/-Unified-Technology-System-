-- ARKHER SYSTEM K.0612 :: Faction Membership Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0612"
	S.key = "arkher.npc.factionmembership.crowd_steering"
	S.name = "Faction Membership Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.factionmembership.navigation" }
	S.tags = { "k", "factionmembership", "crowd", "npc" }
	S.description = "Faction Membership Crowd Steering: local avoidance, cohesion and arrival at scale for the Faction Membership subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.factionmembership.crowd_steering", radius = 0.80, maxSpeed = 3.80, cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
