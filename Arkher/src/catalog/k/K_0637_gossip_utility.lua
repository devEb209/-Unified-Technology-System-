-- ARKHER SYSTEM K.0637 :: Gossip Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0637"
	S.key = "arkher.npc.gossip.utility_reasoning"
	S.name = "Gossip Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.gossip.reactive_behaviour" }
	S.tags = { "k", "gossip", "utility", "npc" }
	S.description = "Gossip Utility Reasoning: scored option selection with response curves for the Gossip subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.gossip.utility_reasoning", momentum = 0.15 })
		inst.system = S
		inst.ctx = ctx
