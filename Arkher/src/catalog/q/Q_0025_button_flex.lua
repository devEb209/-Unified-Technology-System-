-- ARKHER SYSTEM Q.0025 :: Button Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0025"
	S.key = "arkher.ui.button.responsive_layout"
	S.name = "Button Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Button"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "button", "flex", "ui" }
	S.description = "Button Responsive Layout: flex solving with safe areas, weights and breakpoints for the Button subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.button.responsive_layout", width = 510, height = 844, scale = 1.10 })
		inst.system = S
		inst.ctx = ctx
