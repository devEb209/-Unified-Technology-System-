...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="NASA SRTM — CORE Node_Flow #0166", size=Vector2.new(640, 440), pos=UDim2.fromOffset(258, 302), parent=parent, icon="◐"})
