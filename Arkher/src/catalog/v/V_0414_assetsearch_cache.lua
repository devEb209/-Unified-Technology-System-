-- ARKHER SYSTEM V.0414 :: Asset Search Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0414"
	S.key = "arkher.asset.assetsearch.content_cache"
	S.name = "Asset Search Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetsearch.dependency_graph" }
	S.tags = { "v", "assetsearch", "cache", "asset" }
	S.description = "Asset Search Content Cache: reuse of already cooked results for the Asset Search subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.assetsearch.content_cache", policy = "lru", capacity = 120, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
