-- ARKHER SYSTEM Z.0612 :: Predictive Streaming Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0612"
	S.key = "arkher.origin.predictivestreaming.predictive_optimization"
	S.name = "Predictive Streaming Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictivestreaming.adaptive_workflow" }
	S.tags = { "z", "predictivestreaming", "predictor", "origin" }
	S.description = "Predictive Streaming Predictive Optimization: forecast-driven optimization before the cost is paid for the Predictive Streaming subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.predictivestreaming.predictive_optimization", method = "markov", alpha = 0.39, window = 85 })
		inst.system = S
		inst.ctx = ctx
