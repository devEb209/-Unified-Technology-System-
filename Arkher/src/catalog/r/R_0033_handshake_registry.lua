-- ARKHER SYSTEM R.0033 :: Handshake Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0033"
	S.key = "arkher.net.handshake.session_registry"
	S.name = "Handshake Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Handshake"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.handshake.rate_guard" }
	S.tags = { "r", "handshake", "registry", "net" }
	S.description = "Handshake Session Registry: catalogue of sessions, players and their metadata for the Handshake subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.handshake.session_registry" })
		inst.system = S
		inst.ctx = ctx
