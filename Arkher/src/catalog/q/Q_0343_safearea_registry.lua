-- ARKHER SYSTEM Q.0343 :: Safe Area Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0343"
	S.key = "arkher.ui.safearea.localization_registry"
	S.name = "Safe Area Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Safe Area"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.safearea.theme_composition" }
	S.tags = { "q", "safearea", "registry", "ui" }
	S.description = "Safe Area Localization Registry: catalogue of strings, plurals and locale metadata for the Safe Area subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.safearea.localization_registry" })
		inst.system = S
		inst.ctx = ctx
