-- ARKHER SYSTEM Z.0123 :: Dynamic Complexity Manager Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0123"
	S.key = "arkher.origin.complexitymanager.simulation_fabric"
	S.name = "Dynamic Complexity Manager Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.complexity_governance" }
	S.tags = { "z", "complexitymanager", "fabric", "origin" }
	S.description = "Dynamic Complexity Manager Simulation Fabric: every simulation domain stepped under one budgeted clock for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.complexitymanager.simulation_fabric", budgetMs = 1.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
