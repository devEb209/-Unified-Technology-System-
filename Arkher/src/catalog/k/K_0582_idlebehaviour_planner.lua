-- ARKHER SYSTEM K.0582 :: Idle Behaviour Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0582"
	S.key = "arkher.npc.idlebehaviour.goal_planner"
	S.name = "Idle Behaviour Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.idlebehaviour.utility_reasoning" }
	S.tags = { "k", "idlebehaviour", "planner", "npc" }
	S.description = "Idle Behaviour Goal Planner: backward GOAP planning to reach a goal state for the Idle Behaviour subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.idlebehaviour.goal_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
