-- ARKHER SYSTEM W.0209 :: Montage Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0209"
	S.key = "arkher.cine.montage.cut_policy"
	S.name = "Montage Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Montage"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.montage.shot_composition" }
	S.tags = { "w", "montage", "policy", "cine" }
	S.description = "Montage Cut Policy: rules deciding when the sequence cuts and to what for the Montage subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.montage.cut_policy", algorithm = "lottery", starvationGuard = 23 })
		inst.system = S
		inst.ctx = ctx
