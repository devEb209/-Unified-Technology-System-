-- ARKHER SYSTEM VA.0314 :: Ecology Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0314"
	S.key = "arkher.contworld.ecologycont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.ecologycont.infinite_grid" }
	S.tags = { "va", "ecologycont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.ecologycont.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
