-- ARKHER SYSTEM J.0324 :: Character Debug Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0324"
	S.key = "arkher.character.characterdebug.physical_response"
	S.name = "Character Debug Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterdebug.look_and_reach" }
	S.tags = { "j", "characterdebug", "ragdoll", "character" }
	S.description = "Character Debug Physical Response: physical reaction, ragdoll and recovery for the Character Debug subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.characterdebug.physical_response", blendSpeed = 5.20 })
		inst.system = S
		inst.ctx = ctx
