-- ARKHER SYSTEM I.0217 :: Transition Rule Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0217"
	S.key = "arkher.anim.transitionrule.playback_pipeline"
	S.name = "Transition Rule Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.transitionrule.event_ledger" }
	S.tags = { "i", "transitionrule", "pipeline", "anim" }
	S.description = "Transition Rule Playback Pipeline: ordered sample, blend, ik and output stages for the Transition Rule subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.transitionrule.playback_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
