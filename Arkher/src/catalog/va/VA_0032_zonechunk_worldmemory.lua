-- ARKHER SYSTEM VA.0032 :: Zone Chunk World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0032"
	S.key = "arkher.contworld.zonechunk.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.zonechunk.neural_field" }
	S.tags = { "va", "zonechunk", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.zonechunk.world_memory_stream", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
