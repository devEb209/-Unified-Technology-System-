-- ARKHER SYSTEM VB.0321 :: Ecology Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0321"
	S.key = "arkher.conttime.ecologycont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.ecologycont.world_memory_stream" }
	S.tags = { "vb", "ecologycont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.ecologycont.complexity_budget", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
