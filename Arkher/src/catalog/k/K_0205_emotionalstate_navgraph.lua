-- ARKHER SYSTEM K.0205 :: Emotional State Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0205"
	S.key = "arkher.npc.emotionalstate.navigation"
	S.name = "Emotional State Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.emotionalstate.goal_planner" }
	S.tags = { "k", "emotionalstate", "navgraph", "npc" }
	S.description = "Emotional State Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Emotional State subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.emotionalstate.navigation", width = 48, height = 48, cellSize = 5 })
		inst.system = S
		inst.ctx = ctx
