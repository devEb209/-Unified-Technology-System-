-- ARKHER SYSTEM G.0115 :: Denoising Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0115"
	S.key = "arkher.neural.denoise.temporal_history"
	S.name = "Denoising Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.denoise.feature_extraction" }
	S.tags = { "g", "denoise", "temporal", "neural" }
	S.description = "Denoising Temporal History: history buffers reused across frames for the Denoising subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.denoise.temporal_history", feedback = 0.89, phase = 8 })
		inst.system = S
		inst.ctx = ctx
