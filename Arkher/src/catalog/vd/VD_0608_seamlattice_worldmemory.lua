-- ARKHER SYSTEM VD.0608 :: Seam Lattice World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0608"
	S.key = "arkher.contsim.seamlattice.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.seamlattice.neural_field" }
	S.tags = { "vd", "seamlattice", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.seamlattice.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
