-- ARKHER SYSTEM N.0365 :: Projectile Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0365"
	S.key = "arkher.vfx.projectile.emission"
	S.name = "Projectile Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Projectile"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "projectile", "emitter", "vfx" }
	S.description = "Projectile Emission: shaped, rate and burst emission of new particles for the Projectile subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.projectile.emission", shape = "box", rate = 78, speed = 4.80, life = 3.60, budget = 256, seed = 12298 })
		inst.system = S
		inst.ctx = ctx
