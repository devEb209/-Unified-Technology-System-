-- ARKHER SYSTEM Z.0455 :: Player Absence Simulation Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0455"
	S.key = "arkher.origin.playerabsence.signal_composition"
	S.name = "Player Absence Simulation Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.telemetry_ledger" }
	S.tags = { "z", "playerabsence", "composer", "origin" }
	S.description = "Player Absence Simulation Signal Composition: blending of the technology's input signals into one output for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.playerabsence.signal_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
