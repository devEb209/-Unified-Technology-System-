-- ARKHER SYSTEM Z.0029 :: Predictive Optimization Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0029"
	S.key = "arkher.origin.predictiveopt.intent_bridge"
	S.name = "Predictive Optimization Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.semantic_graph" }
	S.tags = { "z", "predictiveopt", "intent", "origin" }
	S.description = "Predictive Optimization Intent Bridge: natural language control surface for the technology for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.predictiveopt.intent_bridge", minConfidence = 0.41 })
		inst.system = S
		inst.ctx = ctx
