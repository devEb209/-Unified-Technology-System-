-- ARKHER SYSTEM E.0455 :: Procedural Texture Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0455"
	S.key = "arkher.material.proctex.procedural_detail"
	S.name = "Procedural Texture Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.proctex.texture_sampling" }
	S.tags = { "e", "proctex", "field", "material" }
	S.description = "Procedural Texture Procedural Detail: coherent noise detail driving the surface for the Procedural Texture subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.proctex.procedural_detail", seed = 22213, frequency = 0.0072, octaves = 4, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
