-- ARKHER SYSTEM V.0056 :: Material Asset Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0056"
	S.key = "arkher.asset.materialasset.compression_codec"
	S.name = "Material Asset Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.materialasset.streaming_residency" }
	S.tags = { "v", "materialasset", "codec", "asset" }
	S.description = "Material Asset Compression Codec: compact encoding, diffing and checksum of asset payloads for the Material Asset subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.materialasset.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
