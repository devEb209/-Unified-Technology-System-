-- ARKHER SYSTEM VC.0595 :: Horizon Span Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0595"
	S.key = "arkher.contneural.horizonspan.neural_field"
	S.name = "Horizon Span Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.horizonspan.coherence_guard" }
	S.tags = { "vc", "horizonspan", "neuralfield", "contneural" }
	S.description = "Horizon Span Neural Field: neural field encoding and reconstruction for the Horizon Span subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.horizonspan.neural_field", dims = 12, hidden = 8, seed = 92900 })
		inst.system = S
		inst.ctx = ctx
