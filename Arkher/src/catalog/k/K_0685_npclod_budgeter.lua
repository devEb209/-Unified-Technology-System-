-- ARKHER SYSTEM K.0685 :: NPC LOD Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0685"
	S.key = "arkher.npc.npclod.thinking_budget"
	S.name = "NPC LOD Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npclod.daily_schedule" }
	S.tags = { "k", "npclod", "budgeter", "npc" }
	S.description = "NPC LOD Thinking Budget: allocation of per-frame thinking time across NPCs for the NPC LOD subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.npclod.thinking_budget", total = 257, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
