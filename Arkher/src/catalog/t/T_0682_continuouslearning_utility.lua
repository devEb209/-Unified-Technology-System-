-- ARKHER SYSTEM T.0682 :: Continuous Learning Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0682"
	S.key = "arkher.ai.continuouslearning.utility_selection"
	S.name = "Continuous Learning Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.continuouslearning.working_memory" }
	S.tags = { "t", "continuouslearning", "utility", "ai" }
	S.description = "Continuous Learning Utility Selection: scored choice between competing courses of action for the Continuous Learning subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.continuouslearning.utility_selection", momentum = 0.04 })
		inst.system = S
		inst.ctx = ctx
