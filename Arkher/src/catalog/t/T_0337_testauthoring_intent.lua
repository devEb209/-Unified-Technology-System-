-- ARKHER SYSTEM T.0337 :: Test Authoring Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0337"
	S.key = "arkher.ai.testauthoring.intent_understanding"
	S.name = "Test Authoring Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "testauthoring", "intent", "ai" }
	S.description = "Test Authoring Intent Understanding: natural language turned into an actionable, scored intent for the Test Authoring subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.testauthoring.intent_understanding", minConfidence = 0.34 })
		inst.system = S
		inst.ctx = ctx
