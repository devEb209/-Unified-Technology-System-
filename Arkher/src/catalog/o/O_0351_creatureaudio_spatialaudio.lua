-- ARKHER SYSTEM O.0351 :: Creature Audio Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0351"
	S.key = "arkher.audio.creatureaudio.spatialization"
	S.name = "Creature Audio Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.creatureaudio.mixer_bus" }
	S.tags = { "o", "creatureaudio", "spatialaudio", "audio" }
	S.description = "Creature Audio Spatialization: distance attenuation, panning, occlusion and doppler for the Creature Audio subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.creatureaudio.spatialization", model = "linear", refDistance = 4, maxDistance = 100, rolloff = 1.01, maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
