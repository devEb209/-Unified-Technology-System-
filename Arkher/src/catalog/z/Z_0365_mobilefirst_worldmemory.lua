-- ARKHER SYSTEM Z.0365 :: Mobile First Governor World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0365"
	S.key = "arkher.origin.mobilefirst.world_memory"
	S.name = "Mobile First Governor World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.autonomous_pipeline" }
	S.tags = { "z", "mobilefirst", "worldmemory", "origin" }
	S.description = "Mobile First Governor World Memory: epoch-stamped persistent history with compaction and checkpoints for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.mobilefirst.world_memory", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
