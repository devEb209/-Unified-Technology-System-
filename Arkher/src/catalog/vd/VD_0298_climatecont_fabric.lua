-- ARKHER SYSTEM VD.0298 :: Climate Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0298"
	S.key = "arkher.contsim.climatecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.climatecont.complexity_budget" }
	S.tags = { "vd", "climatecont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.climatecont.simulation_fabric", budgetMs = 4.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
