-- ARKHER SYSTEM R.0131 :: Reliable Channel Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0131"
	S.key = "arkher.net.reliablechannel.latency_analysis"
	S.name = "Reliable Channel Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reliablechannel.audit_ledger" }
	S.tags = { "r", "reliablechannel", "analyzer", "net" }
	S.description = "Reliable Channel Latency Analysis: round trip, jitter and loss analysis for the Reliable Channel subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.reliablechannel.latency_analysis", window = 141, buckets = 13, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
