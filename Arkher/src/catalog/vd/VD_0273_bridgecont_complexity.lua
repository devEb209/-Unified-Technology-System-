-- ARKHER SYSTEM VD.0273 :: Bridge Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0273"
	S.key = "arkher.contsim.bridgecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.bridgecont.world_memory_stream" }
	S.tags = { "vd", "bridgecont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.bridgecont.complexity_budget", targetMs = 19.0 })
		inst.system = S
		inst.ctx = ctx
