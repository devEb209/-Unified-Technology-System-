-- ARKHER SYSTEM VC.0443 :: Physics Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0443"
	S.key = "arkher.contneural.physicscont.reality_continuum"
	S.name = "Physics Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.physicscont.simulation_fabric" }
	S.tags = { "vc", "physicscont", "reality", "contneural" }
	S.description = "Physics Continuum Reality Continuum: stacked reality layers of the continuum for the Physics Continuum subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.physicscont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
