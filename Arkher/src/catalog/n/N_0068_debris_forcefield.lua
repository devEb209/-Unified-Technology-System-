-- ARKHER SYSTEM N.0068 :: Debris Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0068"
	S.key = "arkher.vfx.debris.force_field"
	S.name = "Debris Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Debris"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.debris.particle_simulation" }
	S.tags = { "n", "debris", "forcefield", "vfx" }
	S.description = "Debris Force Field: wind, attraction, vortex, drag and curl turbulence for the Debris subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.debris.force_field", seed = 19020 })
		inst.system = S
		inst.ctx = ctx
