-- ARKHER SYSTEM E.0563 :: Material Preview Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0563"
	S.key = "arkher.material.preview.streaming"
	S.name = "Material Preview Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.preview.parameter_budget" }
	S.tags = { "e", "preview", "streamer", "material" }
	S.description = "Material Preview Streaming: residency and demand-driven texture streaming for the Material Preview subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.preview.streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
