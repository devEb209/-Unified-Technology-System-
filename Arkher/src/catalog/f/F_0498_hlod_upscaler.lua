-- ARKHER SYSTEM F.0498 :: HLOD Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0498"
	S.key = "arkher.render.hlod.adaptive_resolution"
	S.name = "HLOD Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "HLOD"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.hlod.temporal_resolve" }
	S.tags = { "f", "hlod", "upscaler", "render" }
	S.description = "HLOD Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the HLOD subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.hlod.adaptive_resolution", targetMs = 11.10, index = 3, sharpness = 0.54 })
		inst.system = S
		inst.ctx = ctx
