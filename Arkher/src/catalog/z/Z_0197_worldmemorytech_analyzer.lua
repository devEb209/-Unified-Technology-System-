-- ARKHER SYSTEM Z.0197 :: World Memory Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0197"
	S.key = "arkher.origin.worldmemorytech.behaviour_analysis"
	S.name = "World Memory Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldmemorytech.governance_policy" }
	S.tags = { "z", "worldmemorytech", "analyzer", "origin" }
	S.description = "World Memory Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the World Memory subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.worldmemorytech.behaviour_analysis", window = 81, buckets = 13, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
