-- ARKHER SYSTEM G.0440 :: Model Versioning Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0440"
	S.key = "arkher.neural.modelversion.weight_codec"
	S.name = "Model Versioning Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelversion.model_registry" }
	S.tags = { "g", "modelversion", "codec", "neural" }
	S.description = "Model Versioning Weight Codec: weight serialization and quantized transport for the Model Versioning subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.modelversion.weight_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
