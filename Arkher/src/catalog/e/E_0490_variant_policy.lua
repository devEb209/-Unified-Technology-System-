-- ARKHER SYSTEM E.0490 :: Material Variant Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0490"
	S.key = "arkher.material.variant.quality_policy"
	S.name = "Material Variant Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.variant.compression_codec" }
	S.tags = { "e", "variant", "policy", "material" }
	S.description = "Material Variant Quality Policy: device tier rules for the surface for the Material Variant subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.variant.quality_policy", algorithm = "roundrobin", starvationGuard = 24 })
		inst.system = S
		inst.ctx = ctx
