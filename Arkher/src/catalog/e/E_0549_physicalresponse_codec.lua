-- ARKHER SYSTEM E.0549 :: Physical Response Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0549"
	S.key = "arkher.material.physicalresponse.compression_codec"
	S.name = "Physical Response Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.physicalresponse.streaming" }
	S.tags = { "e", "physicalresponse", "codec", "material" }
	S.description = "Physical Response Compression Codec: serialization and compression of material data for the Physical Response subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.physicalresponse.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
