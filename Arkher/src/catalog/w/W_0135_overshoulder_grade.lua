-- ARKHER SYSTEM W.0135 :: Over The Shoulder Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0135"
	S.key = "arkher.cine.overshoulder.colour_grade"
	S.name = "Over The Shoulder Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.overshoulder.camera_rig" }
	S.tags = { "w", "overshoulder", "grade", "cine" }
	S.description = "Over The Shoulder Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Over The Shoulder subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.overshoulder.colour_grade", exposure = 0.14, contrast = 1.19, saturation = 0.99, toneMap = "reinhard" })
		inst.system = S
		inst.ctx = ctx
