-- ARKHER SYSTEM Z.0519 :: Economic Emergence Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0519"
	S.key = "arkher.origin.economicemergence.residency_streaming"
	S.name = "Economic Emergence Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.economicemergence.budget_governor" }
	S.tags = { "z", "economicemergence", "streamer", "origin" }
	S.description = "Economic Emergence Residency Streaming: distance-driven residency of the technology's workload for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.economicemergence.residency_streaming", radius = 320, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
