-- ARKHER SYSTEM V.0141 :: Icon Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0141"
	S.key = "arkher.asset.iconasset.size_budget"
	S.name = "Icon Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.iconasset.compression_codec" }
	S.tags = { "v", "iconasset", "budgeter", "asset" }
	S.description = "Icon Size Budget: byte budget shared between competing asset classes for the Icon subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.iconasset.size_budget", total = 310, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
