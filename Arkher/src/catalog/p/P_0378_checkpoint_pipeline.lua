-- ARKHER SYSTEM P.0378 :: Checkpoint Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0378"
	S.key = "arkher.play.checkpoint.rule_pipeline"
	S.name = "Checkpoint Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Checkpoint"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.checkpoint.state_machine" }
	S.tags = { "p", "checkpoint", "pipeline", "play" }
	S.description = "Checkpoint Rule Pipeline: ordered rules applied to every gameplay event for the Checkpoint subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.checkpoint.rule_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
