-- ARKHER SYSTEM K.0366 :: Utility Selection Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0366"
	S.key = "arkher.npc.utilityselection.memory"
	S.name = "Utility Selection Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.utilityselection.mind_network" }
	S.tags = { "k", "utilityselection", "memory", "npc" }
	S.description = "Utility Selection Memory: episodic memory with decay, recall and consolidation for the Utility Selection subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.utilityselection.memory", capacity = 110, decayRate = 0.050, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
