-- ARKHER SYSTEM N.0056 :: Dust Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0056"
	S.key = "arkher.vfx.dust.ribbon_and_trail"
	S.name = "Dust Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Dust"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.dust.force_field" }
	S.tags = { "n", "dust", "ribbon", "vfx" }
	S.description = "Dust Ribbon And Trail: trail points, tapering, beams and decimation for the Dust subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.dust.ribbon_and_trail", maxPoints = 48, lifetime = 2.10, minDistance = 0.40, width = 0.60 })
		inst.system = S
		inst.ctx = ctx
