-- ARKHER SYSTEM V.0106 :: Music Track Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0106"
	S.key = "arkher.asset.musictrack.validation_guard"
	S.name = "Music Track Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.musictrack.size_budget" }
	S.tags = { "v", "musictrack", "guard", "asset" }
	S.description = "Music Track Validation Guard: rate limiting and capability checks on the import path for the Music Track subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.musictrack.validation_guard", algorithm = "leaky", capacity = 56, refillPerSec = 61, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
