-- ARKHER SYSTEM O.0121 :: Wind Audio DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0121"
	S.key = "arkher.audio.windaudio.dsp_chain"
	S.name = "Wind Audio DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Wind Audio"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "windaudio", "dsp", "audio" }
	S.description = "Wind Audio DSP Chain: biquad filtering, delay, envelope and soft clipping for the Wind Audio subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.windaudio.dsp_chain", sampleRate = 22050, filter = "notch", cutoff = 6000, q = 0.890 })
		inst.system = S
		inst.ctx = ctx
