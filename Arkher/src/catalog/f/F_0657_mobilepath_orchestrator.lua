-- ARKHER SYSTEM F.0657 :: Mobile Fast Path Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0657"
	S.key = "arkher.render.mobilepath.orchestration"
	S.name = "Mobile Fast Path Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.mobilepath.frame_analysis" }
	S.tags = { "f", "mobilepath", "orchestrator", "render" }
	S.description = "Mobile Fast Path Orchestration: frame lifecycle orchestration for the Mobile Fast Path subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.mobilepath.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
