-- ARKHER SYSTEM F.0681 :: Console Path Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0681"
	S.key = "arkher.render.consolepath.draw_budget"
	S.name = "Console Path Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Console Path"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.consolepath.adaptive_resolution" }
	S.tags = { "f", "consolepath", "budgeter", "render" }
	S.description = "Console Path Draw Budget: draw call and triangle budget allocation for the Console Path subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.consolepath.draw_budget", total = 456, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
