-- ARKHER SYSTEM E.0109 :: Ambient Occlusion Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0109"
	S.key = "arkher.material.ao.texture_sampling"
	S.name = "Ambient Occlusion Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.ao.shading_graph" }
	S.tags = { "e", "ao", "sampler", "material" }
	S.description = "Ambient Occlusion Texture Sampling: atlas packing, mip chain and filtered sampling for the Ambient Occlusion subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.ao.texture_sampling", atlasSize = 256, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
