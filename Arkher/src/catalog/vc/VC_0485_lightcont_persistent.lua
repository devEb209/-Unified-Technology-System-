-- ARKHER SYSTEM VC.0485 :: Lighting Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0485"
	S.key = "arkher.contneural.lightcont.persistent_state"
	S.name = "Lighting Continuum Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lightcont.multi-scale_fidelity" }
	S.tags = { "vc", "lightcont", "persistent", "contneural" }
	S.description = "Lighting Continuum Persistent State: epoch-stamped persistent history and rollback for the Lighting Continuum subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.lightcont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
