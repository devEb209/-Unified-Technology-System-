-- ARKHER SYSTEM VA.0574 :: Mobile Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0574"
	S.key = "arkher.contworld.mobilecont.simulation_fabric"
	S.name = "Mobile Continuum Simulation Fabric"
	S.category = "VA"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.mobilecont.complexity_budget" }
	S.tags = { "va", "mobilecont", "fabric", "contworld" }
	S.description = "Mobile Continuum Simulation Fabric: fabric stepping the continuum domains for the Mobile Continuum subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.mobilecont.simulation_fabric", budgetMs = 3.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
