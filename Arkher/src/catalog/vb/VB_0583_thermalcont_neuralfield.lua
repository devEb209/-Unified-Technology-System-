-- ARKHER SYSTEM VB.0583 :: Thermal Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0583"
	S.key = "arkher.conttime.thermalcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.thermalcont.coherence_guard" }
	S.tags = { "vb", "thermalcont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.thermalcont.neural_field", dims = 16, hidden = 12, seed = 24493 })
		inst.system = S
		inst.ctx = ctx
