-- ARKHER SYSTEM E.0410 :: Mip Policy Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0410"
	S.key = "arkher.material.mippolicy.procedural_detail"
	S.name = "Mip Policy Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Mip Policy"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.mippolicy.texture_sampling" }
	S.tags = { "e", "mippolicy", "field", "material" }
	S.description = "Mip Policy Procedural Detail: coherent noise detail driving the surface for the Mip Policy subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.mippolicy.procedural_detail", seed = 60707, frequency = 0.0107, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
