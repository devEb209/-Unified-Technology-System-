-- ARKHER SYSTEM E.0148 :: Opacity Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0148"
	S.key = "arkher.material.opacity.authoring_pipeline"
	S.name = "Opacity Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Opacity"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.opacity.analysis" }
	S.tags = { "e", "opacity", "pipeline", "material" }
	S.description = "Opacity Authoring Pipeline: ordered authoring and bake stages for the Opacity subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.opacity.authoring_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
