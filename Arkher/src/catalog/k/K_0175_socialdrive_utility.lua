-- ARKHER SYSTEM K.0175 :: Social Drive Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0175"
	S.key = "arkher.npc.socialdrive.utility_reasoning"
	S.name = "Social Drive Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.socialdrive.reactive_behaviour" }
	S.tags = { "k", "socialdrive", "utility", "npc" }
	S.description = "Social Drive Utility Reasoning: scored option selection with response curves for the Social Drive subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.socialdrive.utility_reasoning", momentum = 0.18 })
		inst.system = S
		inst.ctx = ctx
