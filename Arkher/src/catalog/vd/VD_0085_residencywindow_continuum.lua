-- ARKHER SYSTEM VD.0085 :: Residency Window Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0085"
	S.key = "arkher.contsim.residencywindow.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "residencywindow", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.residencywindow.infinite_grid", cellSize = 64, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
