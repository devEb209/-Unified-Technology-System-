-- ARKHER SYSTEM H.0113 :: Impulse Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0113"
	S.key = "arkher.physics.impulse.body_dynamics"
	S.name = "Impulse Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Impulse"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "impulse", "rigidbody", "physics" }
	S.description = "Impulse Body Dynamics: integration, impulses, damping and sleeping of a body for the Impulse subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.impulse.body_dynamics", mass = 23.00, radius = 0.40, restitution = 0.02, friction = 0.42, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
