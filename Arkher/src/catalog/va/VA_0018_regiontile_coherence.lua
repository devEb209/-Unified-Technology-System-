-- ARKHER SYSTEM VA.0018 :: Region Tile Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0018"
	S.key = "arkher.contworld.regiontile.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.regiontile.persistent_state" }
	S.tags = { "va", "regiontile", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.regiontile.coherence_guard", window = 88, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
