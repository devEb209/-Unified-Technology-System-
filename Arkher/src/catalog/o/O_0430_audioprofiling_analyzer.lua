-- ARKHER SYSTEM O.0430 :: Audio Profiling Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0430"
	S.key = "arkher.audio.audioprofiling.analysis"
	S.name = "Audio Profiling Analysis"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audioprofiling.playback_policy" }
	S.tags = { "o", "audioprofiling", "analyzer", "audio" }
	S.description = "Audio Profiling Analysis: loudness, headroom and masking analysis for the Audio Profiling subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.audioprofiling.analysis", window = 225, buckets = 9, threshold = 2.70 })
		inst.system = S
		inst.ctx = ctx
