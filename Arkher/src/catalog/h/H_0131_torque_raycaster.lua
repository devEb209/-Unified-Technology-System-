-- ARKHER SYSTEM H.0131 :: Torque Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0131"
	S.key = "arkher.physics.torque.query"
	S.name = "Torque Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Torque"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.torque.constraint_solver" }
	S.tags = { "h", "torque", "raycaster", "physics" }
	S.description = "Torque Query: rays, sweeps and overlaps against the simulation for the Torque subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.torque.query", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
