-- ARKHER SYSTEM VC.0213 :: Biome Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0213"
	S.key = "arkher.contneural.biomecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.biomecont.world_memory_stream" }
	S.tags = { "vc", "biomecont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.biomecont.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
