-- ARKHER SYSTEM J.0106 :: Lip Sync Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0106"
	S.key = "arkher.character.lipsync.appearance_composer"
	S.name = "Lip Sync Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.lipsync.locomotion" }
	S.tags = { "j", "lipsync", "composer", "character" }
	S.description = "Lip Sync Appearance Composer: composition of appearance slots into a look for the Lip Sync subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.lipsync.appearance_composer", mode = "max" })
		inst.system = S
		inst.ctx = ctx
