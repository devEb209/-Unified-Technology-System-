--!strict
-- ESA WorldCover — CORE Node_Flow #0206
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="ESA WorldCover — CORE Node_Flow #0206", size=Vector2.new(680, 440), pos=UDim2.fromOffset(378, 202), parent=parent, icon="⬢"})
