-- ARKHER SYSTEM VC.0501 :: Rendering Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0501"
	S.key = "arkher.contneural.rendercont.complexity_budget"
	S.name = "Rendering Continuum Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.rendercont.world_memory_stream" }
	S.tags = { "vc", "rendercont", "complexity", "contneural" }
	S.description = "Rendering Continuum Complexity Budget: complexity budgeting for the continuum for the Rendering Continuum subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.rendercont.complexity_budget", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
