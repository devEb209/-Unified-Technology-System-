-- ARKHER SYSTEM J.0311 :: Character Streaming Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0311"
	S.key = "arkher.character.characterstreaming.blend_controller"
	S.name = "Character Streaming Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterstreaming.motion_set" }
	S.tags = { "j", "characterstreaming", "animator", "character" }
	S.description = "Character Streaming Blend Controller: layered playback driving the character for the Character Streaming subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.characterstreaming.blend_controller", budget = 14 })
		inst.system = S
		inst.ctx = ctx
