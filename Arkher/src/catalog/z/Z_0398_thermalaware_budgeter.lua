-- ARKHER SYSTEM Z.0398 :: Thermal Aware Simulation Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0398"
	S.key = "arkher.origin.thermalaware.budget_governor"
	S.name = "Thermal Aware Simulation Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.behaviour_analysis" }
	S.tags = { "z", "thermalaware", "budgeter", "origin" }
	S.description = "Thermal Aware Simulation Budget Governor: allocation of a scarce resource across the technology's consumers for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.thermalaware.budget_governor", total = 72, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
