-- ARKHER SYSTEM P.0246 :: Objective Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0246"
	S.key = "arkher.play.objective.rule_pipeline"
	S.name = "Objective Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Objective"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.objective.state_machine" }
	S.tags = { "p", "objective", "pipeline", "play" }
	S.description = "Objective Rule Pipeline: ordered rules applied to every gameplay event for the Objective subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.objective.rule_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
