-- ARKHER SYSTEM Z.0070 :: Reality Layer Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0070"
	S.key = "arkher.origin.realitylayer.self_critique"
	S.name = "Reality Layer Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.intent_bridge" }
	S.tags = { "z", "realitylayer", "critic", "origin" }
	S.description = "Reality Layer Self Critique: weighted judgement of the technology's own output for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.realitylayer.self_critique", passMark = 0.70, reviseMark = 0.45, seed = 27825 })
		inst.system = S
		inst.ctx = ctx
