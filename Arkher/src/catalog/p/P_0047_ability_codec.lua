-- ARKHER SYSTEM P.0047 :: Ability Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0047"
	S.key = "arkher.play.ability.save_codec"
	S.name = "Ability Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ability"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ability.content_registry" }
	S.tags = { "p", "ability", "codec", "play" }
	S.description = "Ability Save Codec: persistence, diffing and checksum of gameplay state for the Ability subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.ability.save_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
