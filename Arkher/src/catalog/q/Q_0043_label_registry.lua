-- ARKHER SYSTEM Q.0043 :: Label Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0043"
	S.key = "arkher.ui.label.localization_registry"
	S.name = "Label Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Label"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.label.theme_composition" }
	S.tags = { "q", "label", "registry", "ui" }
	S.description = "Label Localization Registry: catalogue of strings, plurals and locale metadata for the Label subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.label.localization_registry" })
		inst.system = S
		inst.ctx = ctx
