-- ARKHER SYSTEM V.0352 :: Manifest Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0352"
	S.key = "arkher.asset.assetmanifest.asset_registry"
	S.name = "Manifest Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetmanifest.cook_pipeline" }
	S.tags = { "v", "assetmanifest", "registry", "asset" }
	S.description = "Manifest Asset Registry: catalogue of every asset, its tags and its metadata for the Manifest subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.assetmanifest.asset_registry" })
		inst.system = S
		inst.ctx = ctx
