-- ARKHER SYSTEM VA.0159 :: Coherence Seam Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0159"
	S.key = "arkher.contworld.coherenceseam.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.coherenceseam.epoch_clock" }
	S.tags = { "va", "coherenceseam", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.coherenceseam.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
