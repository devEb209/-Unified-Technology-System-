-- ARKHER SYSTEM Z.0477 :: Narrative Memory Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0477"
	S.key = "arkher.origin.narrativememory.behaviour_analysis"
	S.name = "Narrative Memory Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.governance_policy" }
	S.tags = { "z", "narrativememory", "analyzer", "origin" }
	S.description = "Narrative Memory Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.narrativememory.behaviour_analysis", window = 166, buckets = 10, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
