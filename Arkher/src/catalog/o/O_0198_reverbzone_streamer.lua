-- ARKHER SYSTEM O.0198 :: Reverb Zone Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0198"
	S.key = "arkher.audio.reverbzone.streaming"
	S.name = "Reverb Zone Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Reverb Zone"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.reverbzone.voice_budget" }
	S.tags = { "o", "reverbzone", "streamer", "audio" }
	S.description = "Reverb Zone Streaming: distance-driven residency of audio assets for the Reverb Zone subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.reverbzone.streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
