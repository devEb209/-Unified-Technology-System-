-- ARKHER SYSTEM VA.0394 :: Memory Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0394"
	S.key = "arkher.contworld.memorycont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memorycont.complexity_budget" }
	S.tags = { "va", "memorycont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.memorycont.simulation_fabric", budgetMs = 1.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
