-- ARKHER SYSTEM H.0124 :: Impulse Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0124"
	S.key = "arkher.physics.impulse.analysis"
	S.name = "Impulse Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Impulse"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.impulse.result_cache" }
	S.tags = { "h", "impulse", "analyzer", "physics" }
	S.description = "Impulse Analysis: energy, jitter and cost analysis of the simulation for the Impulse subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.impulse.analysis", window = 210, buckets = 10, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
