-- ARKHER SYSTEM T.0137 :: Skill Library Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0137"
	S.key = "arkher.ai.skilllibrary.action_planner"
	S.name = "Skill Library Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.skilllibrary.utility_selection" }
	S.tags = { "t", "skilllibrary", "planner", "ai" }
	S.description = "Skill Library Action Planner: goal-oriented action planning over preconditions for the Skill Library subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.skilllibrary.action_planner", maxDepth = 8 })
		inst.system = S
		inst.ctx = ctx
