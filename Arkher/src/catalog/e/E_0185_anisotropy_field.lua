-- ARKHER SYSTEM E.0185 :: Anisotropy Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0185"
	S.key = "arkher.material.anisotropy.procedural_detail"
	S.name = "Anisotropy Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Anisotropy"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.anisotropy.texture_sampling" }
	S.tags = { "e", "anisotropy", "field", "material" }
	S.description = "Anisotropy Procedural Detail: coherent noise detail driving the surface for the Anisotropy subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.anisotropy.procedural_detail", seed = 18017, frequency = 0.0083, octaves = 4, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
