-- ARKHER SYSTEM VB.0432 :: Navigation Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0432"
	S.key = "arkher.conttime.navcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.navcont.reality_continuum" }
	S.tags = { "vb", "navcont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.navcont.emergence_continuum", windowSize = 4, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
