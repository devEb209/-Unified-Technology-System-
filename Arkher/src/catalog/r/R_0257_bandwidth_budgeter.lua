-- ARKHER SYSTEM R.0257 :: Bandwidth Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0257"
	S.key = "arkher.net.bandwidth.bandwidth_budget"
	S.name = "Bandwidth Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Bandwidth"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.bandwidth.transport_graph" }
	S.tags = { "r", "bandwidth", "budgeter", "net" }
	S.description = "Bandwidth Bandwidth Budget: bytes per second shared between competing streams for the Bandwidth subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.bandwidth.bandwidth_budget", total = 197, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
