-- ARKHER SYSTEM K.0135 :: Hunger Drive Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0135"
	S.key = "arkher.npc.hungerdrive.navigation"
	S.name = "Hunger Drive Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hungerdrive.goal_planner" }
	S.tags = { "k", "hungerdrive", "navgraph", "npc" }
	S.description = "Hunger Drive Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Hunger Drive subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.hungerdrive.navigation", width = 48, height = 48, cellSize = 5 })
		inst.system = S
		inst.ctx = ctx
