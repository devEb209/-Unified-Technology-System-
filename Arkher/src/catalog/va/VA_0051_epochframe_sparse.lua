-- ARKHER SYSTEM VA.0051 :: Epoch Frame Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0051"
	S.key = "arkher.contworld.epochframe.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.epochframe.epoch_clock" }
	S.tags = { "va", "epochframe", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.epochframe.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
