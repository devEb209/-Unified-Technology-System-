-- ARKHER SYSTEM Z.0506 :: Economic Emergence Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0506"
	S.key = "arkher.origin.economicemergence.emergence_detection"
	S.name = "Economic Emergence Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.economicemergence.world_memory" }
	S.tags = { "z", "economicemergence", "emergence", "origin" }
	S.description = "Economic Emergence Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.economicemergence.emergence_detection", windowSize = 5, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
