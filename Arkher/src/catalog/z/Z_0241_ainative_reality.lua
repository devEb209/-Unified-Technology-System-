-- ARKHER SYSTEM Z.0241 :: AI Native Engine Architecture Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0241"
	S.key = "arkher.origin.ainative.reality_layering"
	S.name = "AI Native Engine Architecture Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "ainative", "reality", "origin" }
	S.description = "AI Native Engine Architecture Reality Layering: stacked authored, simulated, proposed and player realities for the AI Native Engine Architecture subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.ainative.reality_layering" })
		inst.system = S
		inst.ctx = ctx
