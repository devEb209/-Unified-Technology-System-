-- ARKHER SYSTEM E.0102 :: Height Displacement Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0102"
	S.key = "arkher.material.displacement.analysis"
	S.name = "Height Displacement Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.displacement.instance_cache" }
	S.tags = { "e", "displacement", "analyzer", "material" }
	S.description = "Height Displacement Analysis: cost, redundancy and outlier analysis for the Height Displacement subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.displacement.analysis", window = 236, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
