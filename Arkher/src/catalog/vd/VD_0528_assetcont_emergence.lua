-- ARKHER SYSTEM VD.0528 :: Asset Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0528"
	S.key = "arkher.contsim.assetcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.assetcont.reality_continuum" }
	S.tags = { "vd", "assetcont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.assetcont.emergence_continuum", windowSize = 6, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
