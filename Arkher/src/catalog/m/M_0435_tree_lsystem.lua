-- ARKHER SYSTEM M.0435 :: Tree Grammar
...
return function(A)
	...
	local S = {}
	S.id = "M.0435"
	S.key = "arkher.proc.tree.grammar"
	S.name = "Tree Grammar"
	S.category = "M"
	S.family = "PROCEDURAL"
	S.area = "Tree"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "m", "tree", "lsystem", "proc" }
	S.description = "Tree Grammar: rewriting grammar interpreted into geometry for the Tree subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lsystem", { id = "arkher.proc.tree.grammar", axiom = "F", angle = 36, step = 6.0 })
		inst.system = S
		inst.ctx = ctx
