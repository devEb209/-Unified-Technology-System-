-- ARKHER SYSTEM Z.0975 :: Generation Migration Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0975"
	S.key = "arkher.origin.generationmigration.signal_composition"
	S.name = "Generation Migration Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.telemetry_ledger" }
	S.tags = { "z", "generationmigration", "composer", "origin" }
	S.description = "Generation Migration Signal Composition: blending of the technology's input signals into one output for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.generationmigration.signal_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
