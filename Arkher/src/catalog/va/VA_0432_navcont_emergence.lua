-- ARKHER SYSTEM VA.0432 :: Navigation Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0432"
	S.key = "arkher.contworld.navcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.navcont.reality_continuum" }
	S.tags = { "va", "navcont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.navcont.emergence_continuum", windowSize = 5, threshold = 1.40, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
