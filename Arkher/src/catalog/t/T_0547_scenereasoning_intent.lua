-- ARKHER SYSTEM T.0547 :: Scene Reasoning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0547"
	S.key = "arkher.ai.scenereasoning.intent_understanding"
	S.name = "Scene Reasoning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "scenereasoning", "intent", "ai" }
	S.description = "Scene Reasoning Intent Understanding: natural language turned into an actionable, scored intent for the Scene Reasoning subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.scenereasoning.intent_understanding", minConfidence = 0.34 })
		inst.system = S
		inst.ctx = ctx
