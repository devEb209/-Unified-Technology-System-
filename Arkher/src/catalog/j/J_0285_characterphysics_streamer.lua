-- ARKHER SYSTEM J.0285 :: Character Physics Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0285"
	S.key = "arkher.character.characterphysics.streaming"
	S.name = "Character Physics Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterphysics.budget_governor" }
	S.tags = { "j", "characterphysics", "streamer", "character" }
	S.description = "Character Physics Streaming: distance-driven residency of character data for the Character Physics subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.characterphysics.streaming", radius = 280, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
