-- ARKHER SYSTEM K.0304 :: Attention Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0304"
	S.key = "arkher.npc.attention.crowd_steering"
	S.name = "Attention Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.attention.navigation" }
	S.tags = { "k", "attention", "crowd", "npc" }
	S.description = "Attention Crowd Steering: local avoidance, cohesion and arrival at scale for the Attention subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.attention.crowd_steering", radius = 0.80, maxSpeed = 5.80, cellSize = 10 })
		inst.system = S
		inst.ctx = ctx
