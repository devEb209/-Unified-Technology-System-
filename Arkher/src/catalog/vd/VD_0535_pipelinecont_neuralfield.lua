-- ARKHER SYSTEM VD.0535 :: Pipeline Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0535"
	S.key = "arkher.contsim.pipelinecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.pipelinecont.coherence_guard" }
	S.tags = { "vd", "pipelinecont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.pipelinecont.neural_field", dims = 12, hidden = 8, seed = 37516 })
		inst.system = S
		inst.ctx = ctx
