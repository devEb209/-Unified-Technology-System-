-- ARKHER SYSTEM H.0243 :: Broadphase Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0243"
	S.key = "arkher.physics.broadphase.query"
	S.name = "Broadphase Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Broadphase"
	S.aspect = "Query"
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.broadphase.constraint_solver" }
	S.tags = { "h", "broadphase", "raycaster", "physics" }
	S.description = "Broadphase Query: rays, sweeps and overlaps against the simulation for the Broadphase subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.broadphase.query", cellSize = 32 })
		inst.system = S
		inst.ctx = ctx
