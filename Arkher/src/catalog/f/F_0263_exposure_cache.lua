-- ARKHER SYSTEM F.0263 :: Exposure Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0263"
	S.key = "arkher.render.exposure.pass_cache"
	S.name = "Exposure Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Exposure"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.exposure.render_policy" }
	S.tags = { "f", "exposure", "cache", "render" }
	S.description = "Exposure Pass Cache: reuse of pass results across frames for the Exposure subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.exposure.pass_cache", policy = "lru", capacity = 75, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
