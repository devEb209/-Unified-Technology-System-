-- ARKHER SYSTEM G.0500 :: Neural Debug Heuristic Policy
...
return function(A)
	...
	local S = {}
	S.id = "G.0500"
	S.key = "arkher.neural.neuraldebug.heuristic_policy"
	S.name = "Neural Debug Heuristic Policy"
	S.category = "G"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuraldebug.result_cache" }
	S.tags = { "g", "neuraldebug", "policy", "neural" }
	S.description = "Neural Debug Heuristic Policy: rule fallback when the model is unavailable for the Neural Debug subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.neural.neuraldebug.heuristic_policy", algorithm = "edf", starvationGuard = 25 })
		inst.system = S
		inst.ctx = ctx
