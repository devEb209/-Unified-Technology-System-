-- ARKHER SYSTEM I.0124 :: Playback Speed Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0124"
	S.key = "arkher.anim.playbackspeed.compression_codec"
	S.name = "Playback Speed Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.playbackspeed.retarget_graph" }
	S.tags = { "i", "playbackspeed", "codec", "anim" }
	S.description = "Playback Speed Compression Codec: curve compression and quantized transport for the Playback Speed subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.playbackspeed.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
