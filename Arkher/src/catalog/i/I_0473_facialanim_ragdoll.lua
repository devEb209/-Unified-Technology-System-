-- ARKHER SYSTEM I.0473 :: Facial Animation Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0473"
	S.key = "arkher.anim.facialanim.physical_blend"
	S.name = "Facial Animation Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.facialanim.inverse_kinematics" }
	S.tags = { "i", "facialanim", "ragdoll", "anim" }
	S.description = "Facial Animation Physical Blend: physical bones blended against the animated pose for the Facial Animation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.facialanim.physical_blend", blendSpeed = 3.30 })
		inst.system = S
		inst.ctx = ctx
