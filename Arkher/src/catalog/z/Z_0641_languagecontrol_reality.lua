-- ARKHER SYSTEM Z.0641 :: Natural Language Engine Control Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0641"
	S.key = "arkher.origin.languagecontrol.reality_layering"
	S.name = "Natural Language Engine Control Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "languagecontrol", "reality", "origin" }
	S.description = "Natural Language Engine Control Reality Layering: stacked authored, simulated, proposed and player realities for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.languagecontrol.reality_layering" })
		inst.system = S
		inst.ctx = ctx
