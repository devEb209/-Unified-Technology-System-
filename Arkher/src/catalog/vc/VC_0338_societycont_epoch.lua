-- ARKHER SYSTEM VC.0338 :: Society Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0338"
	S.key = "arkher.contneural.societycont.epoch_clock"
	S.name = "Society Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.societycont.infinite_grid" }
	S.tags = { "vc", "societycont", "epoch", "contneural" }
	S.description = "Society Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Society Continuum subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.societycont.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
