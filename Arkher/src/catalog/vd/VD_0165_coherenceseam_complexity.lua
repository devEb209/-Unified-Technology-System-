-- ARKHER SYSTEM VD.0165 :: Coherence Seam Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0165"
	S.key = "arkher.contsim.coherenceseam.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.coherenceseam.world_memory_stream" }
	S.tags = { "vd", "coherenceseam", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.coherenceseam.complexity_budget", targetMs = 19.0 })
		inst.system = S
		inst.ctx = ctx
