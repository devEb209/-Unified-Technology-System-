-- ARKHER SYSTEM L.0216 :: Vegetation Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0216"
	S.key = "arkher.sim.vegetation.region_graph"
	S.name = "Vegetation Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.vegetation.calendar" }
	S.tags = { "l", "vegetation", "graph", "sim" }
	S.description = "Vegetation Region Graph: connectivity, components and shortest path between places for the Vegetation subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.vegetation.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
