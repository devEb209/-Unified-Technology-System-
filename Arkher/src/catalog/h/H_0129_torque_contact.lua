-- ARKHER SYSTEM H.0129 :: Torque Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0129"
	S.key = "arkher.physics.torque.contact_generation"
	S.name = "Torque Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Torque"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.torque.collision_shape" }
	S.tags = { "h", "torque", "contact", "physics" }
	S.description = "Torque Contact Generation: narrow-phase manifolds with normal, depth and point for the Torque subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.torque.contact_generation", slop = 0.0080, maxManifolds = 154 })
		inst.system = S
		inst.ctx = ctx
