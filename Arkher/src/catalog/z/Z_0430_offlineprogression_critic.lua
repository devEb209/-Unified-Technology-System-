-- ARKHER SYSTEM Z.0430 :: Offline World Progression Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0430"
	S.key = "arkher.origin.offlineprogression.self_critique"
	S.name = "Offline World Progression Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.intent_bridge" }
	S.tags = { "z", "offlineprogression", "critic", "origin" }
	S.description = "Offline World Progression Self Critique: weighted judgement of the technology's own output for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.offlineprogression.self_critique", passMark = 0.79, reviseMark = 0.49, seed = 63609 })
		inst.system = S
		inst.ctx = ctx
