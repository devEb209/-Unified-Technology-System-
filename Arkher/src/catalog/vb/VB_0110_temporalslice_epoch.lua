-- ARKHER SYSTEM VB.0110 :: Temporal Slice Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0110"
	S.key = "arkher.conttime.temporalslice.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.temporalslice.infinite_grid" }
	S.tags = { "vb", "temporalslice", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.temporalslice.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
