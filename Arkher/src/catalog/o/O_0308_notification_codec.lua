-- ARKHER SYSTEM O.0308 :: Notification Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0308"
	S.key = "arkher.audio.notification.compression_codec"
	S.name = "Notification Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Notification"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.notification.asset_registry" }
	S.tags = { "o", "notification", "codec", "audio" }
	S.description = "Notification Compression Codec: payload encoding of audio state and events for the Notification subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.notification.compression_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
