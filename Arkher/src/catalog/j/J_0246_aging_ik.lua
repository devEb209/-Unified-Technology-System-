-- ARKHER SYSTEM J.0246 :: Aging Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0246"
	S.key = "arkher.character.aging.look_and_reach"
	S.name = "Aging Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.aging.blend_controller" }
	S.tags = { "j", "aging", "ik", "character" }
	S.description = "Aging Look And Reach: look-at, reach and foot placement for the character for the Aging subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.aging.look_and_reach", iterations = 15, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
