-- ARKHER SYSTEM P.0193 :: Shop Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0193"
	S.key = "arkher.play.shop.attributes"
	S.name = "Shop Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Shop"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "shop", "stats", "play" }
	S.description = "Shop Attributes: base values, layered modifiers and derived statistics for the Shop subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.shop.attributes" })
		inst.system = S
		inst.ctx = ctx
