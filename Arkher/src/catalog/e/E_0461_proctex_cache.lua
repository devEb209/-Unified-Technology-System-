-- ARKHER SYSTEM E.0461 :: Procedural Texture Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0461"
	S.key = "arkher.material.proctex.instance_cache"
	S.name = "Procedural Texture Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.proctex.quality_policy" }
	S.tags = { "e", "proctex", "cache", "material" }
	S.description = "Procedural Texture Instance Cache: resolved-parameter cache keyed by context for the Procedural Texture subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.proctex.instance_cache", policy = "lru", capacity = 379, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
