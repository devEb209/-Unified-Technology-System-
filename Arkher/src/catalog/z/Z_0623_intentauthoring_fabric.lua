-- ARKHER SYSTEM Z.0623 :: Intent Driven Authoring Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0623"
	S.key = "arkher.origin.intentauthoring.simulation_fabric"
	S.name = "Intent Driven Authoring Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.complexity_governance" }
	S.tags = { "z", "intentauthoring", "fabric", "origin" }
	S.description = "Intent Driven Authoring Simulation Fabric: every simulation domain stepped under one budgeted clock for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.intentauthoring.simulation_fabric", budgetMs = 4.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
