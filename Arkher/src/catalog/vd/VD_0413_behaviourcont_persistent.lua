-- ARKHER SYSTEM VD.0413 :: Behaviour Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0413"
	S.key = "arkher.contsim.behaviourcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.behaviourcont.multi-scale_fidelity" }
	S.tags = { "vd", "behaviourcont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.behaviourcont.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
