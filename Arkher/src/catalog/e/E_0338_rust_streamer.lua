-- ARKHER SYSTEM E.0338 :: Rust Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0338"
	S.key = "arkher.material.rust.streaming"
	S.name = "Rust Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Rust"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.rust.parameter_budget" }
	S.tags = { "e", "rust", "streamer", "material" }
	S.description = "Rust Streaming: residency and demand-driven texture streaming for the Rust subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.rust.streaming", radius = 280, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
