-- ARKHER SYSTEM F.0367 :: Render Scale Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0367"
	S.key = "arkher.render.renderscale.visibility_set"
	S.name = "Render Scale Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Render Scale"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.renderscale.view_and_culling" }
	S.tags = { "f", "renderscale", "visibility", "render" }
	S.description = "Render Scale Visibility Set: cell, portal and occluder visibility for the Render Scale subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.renderscale.visibility_set", maxDepth = 2 })
		inst.system = S
		inst.ctx = ctx
