-- ARKHER SYSTEM F.0318 :: Depth Of Field Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0318"
	S.key = "arkher.render.dof.render_policy"
	S.name = "Depth Of Field Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.dof.draw_budget" }
	S.tags = { "f", "dof", "policy", "render" }
	S.description = "Depth Of Field Render Policy: device tier rules for the frame for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.dof.render_policy", algorithm = "edf", starvationGuard = 21 })
		inst.system = S
		inst.ctx = ctx
