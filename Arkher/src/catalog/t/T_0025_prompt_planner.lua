-- ARKHER SYSTEM T.0025 :: Prompt Understanding Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0025"
	S.key = "arkher.ai.prompt.action_planner"
	S.name = "Prompt Understanding Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.prompt.utility_selection" }
	S.tags = { "t", "prompt", "planner", "ai" }
	S.description = "Prompt Understanding Action Planner: goal-oriented action planning over preconditions for the Prompt Understanding subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.prompt.action_planner", maxDepth = 10 })
		inst.system = S
		inst.ctx = ctx
