-- ARKHER SYSTEM L.0013 :: Living World Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0013"
	S.key = "arkher.sim.livingworld.analysis"
	S.name = "Living World Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livingworld.aggregate_cache" }
	S.tags = { "l", "livingworld", "analyzer", "sim" }
	S.description = "Living World Analysis: trend, anomaly and stability analysis of the world for the Living World subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.livingworld.analysis", window = 222, buckets = 10, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
