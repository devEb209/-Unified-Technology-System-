-- ARKHER SYSTEM Z.1042 :: Emergent Quest Generation Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.1042"
	S.key = "arkher.origin.emergentquest.complexity_governance"
	S.name = "Emergent Quest Generation Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentquest.reality_layering" }
	S.tags = { "z", "emergentquest", "complexity", "origin" }
	S.description = "Emergent Quest Generation Complexity Governance: measured scene cost turned into per-subsystem directives for the Emergent Quest Generation subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.emergentquest.complexity_governance", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
