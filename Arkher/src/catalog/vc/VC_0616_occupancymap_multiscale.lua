-- ARKHER SYSTEM VC.0616 :: Occupancy Map Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VC.0616"
	S.key = "arkher.contneural.occupancymap.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.occupancymap.sparse_residency" }
	S.tags = { "vc", "occupancymap", "multiscale", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contneural.occupancymap.multi-scale_fidelity", levels = 4, baseTriangles = 90000 })
		inst.system = S
		inst.ctx = ctx
