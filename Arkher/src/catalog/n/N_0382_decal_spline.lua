-- ARKHER SYSTEM N.0382 :: Decal Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0382"
	S.key = "arkher.vfx.decal.curve_authoring"
	S.name = "Decal Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Decal"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.decal.ribbon_and_trail" }
	S.tags = { "n", "decal", "spline", "vfx" }
	S.description = "Decal Curve Authoring: authored curves driving the effect over its life for the Decal subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.decal.curve_authoring", tension = 0.72, closed = false })
		inst.system = S
		inst.ctx = ctx
