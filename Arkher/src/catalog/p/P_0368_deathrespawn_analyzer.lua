-- ARKHER SYSTEM P.0368 :: Death And Respawn Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0368"
	S.key = "arkher.play.deathrespawn.balance_analysis"
	S.name = "Death And Respawn Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.deathrespawn.event_ledger" }
	S.tags = { "p", "deathrespawn", "analyzer", "play" }
	S.description = "Death And Respawn Balance Analysis: distribution, outlier and pacing analysis for the Death And Respawn subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.deathrespawn.balance_analysis", window = 218, buckets = 10, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
