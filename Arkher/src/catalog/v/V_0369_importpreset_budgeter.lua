-- ARKHER SYSTEM V.0369 :: Import Preset Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0369"
	S.key = "arkher.asset.importpreset.size_budget"
	S.name = "Import Preset Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.importpreset.compression_codec" }
	S.tags = { "v", "importpreset", "budgeter", "asset" }
	S.description = "Import Preset Size Budget: byte budget shared between competing asset classes for the Import Preset subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.importpreset.size_budget", total = 235, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
