-- ARKHER SYSTEM K.0089 :: Working Memory Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0089"
	S.key = "arkher.npc.workingmemory.perception"
	S.name = "Working Memory Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workingmemory.emotion" }
	S.tags = { "k", "workingmemory", "perception", "npc" }
	S.description = "Working Memory Perception: sight, hearing and bounded attention for the Working Memory subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.workingmemory.perception", sightRange = 25, hearingRange = 20, attentionSlots = 3, fov = 1.680 })
		inst.system = S
		inst.ctx = ctx
