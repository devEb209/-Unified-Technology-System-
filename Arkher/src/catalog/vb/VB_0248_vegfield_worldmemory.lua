-- ARKHER SYSTEM VB.0248 :: Vegetation Field World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0248"
	S.key = "arkher.conttime.vegfield.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vegfield.neural_field" }
	S.tags = { "vb", "vegfield", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.vegfield.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
