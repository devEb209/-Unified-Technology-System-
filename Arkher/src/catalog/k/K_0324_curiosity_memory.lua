-- ARKHER SYSTEM K.0324 :: Curiosity Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0324"
	S.key = "arkher.npc.curiosity.memory"
	S.name = "Curiosity Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.curiosity.mind_network" }
	S.tags = { "k", "curiosity", "memory", "npc" }
	S.description = "Curiosity Memory: episodic memory with decay, recall and consolidation for the Curiosity subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.curiosity.memory", capacity = 84, decayRate = 0.030, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
