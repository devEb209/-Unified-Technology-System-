-- ARKHER SYSTEM L.0346 :: Price Discovery Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0346"
	S.key = "arkher.sim.pricediscovery.simulation_core"
	S.name = "Price Discovery Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "pricediscovery", "simulation", "sim" }
	S.description = "Price Discovery Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Price Discovery subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.pricediscovery.simulation_core", fullRadius = 240, reducedRadius = 1100, budget = 77 })
		inst.system = S
		inst.ctx = ctx
