-- ARKHER SYSTEM F.0245 :: Reflection Probe Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0245"
	S.key = "arkher.render.reflectionprobe.temporal_resolve"
	S.name = "Reflection Probe Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.reflectionprobe.probe_volume" }
	S.tags = { "f", "reflectionprobe", "temporal", "render" }
	S.description = "Reflection Probe Temporal Resolve: history reprojection with neighbourhood clamping for the Reflection Probe subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.reflectionprobe.temporal_resolve", feedback = 0.90, phase = 8 })
		inst.system = S
		inst.ctx = ctx
