-- ARKHER SYSTEM VA.0188 :: Simulation Domain World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0188"
	S.key = "arkher.contworld.simdomain.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.simdomain.neural_field" }
	S.tags = { "va", "simdomain", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.simdomain.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
