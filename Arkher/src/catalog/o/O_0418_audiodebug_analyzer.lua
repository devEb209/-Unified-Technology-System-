-- ARKHER SYSTEM O.0418 :: Audio Debug Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0418"
	S.key = "arkher.audio.audiodebug.analysis"
	S.name = "Audio Debug Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Audio Debug"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiodebug.playback_policy" }
	S.tags = { "o", "audiodebug", "analyzer", "audio" }
	S.description = "Audio Debug Analysis: loudness, headroom and masking analysis for the Audio Debug subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.audiodebug.analysis", window = 140, buckets = 12, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
