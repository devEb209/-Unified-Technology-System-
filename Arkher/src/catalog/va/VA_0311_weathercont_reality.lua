-- ARKHER SYSTEM VA.0311 :: Weather Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0311"
	S.key = "arkher.contworld.weathercont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.weathercont.simulation_fabric" }
	S.tags = { "va", "weathercont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.weathercont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
