-- ARKHER SYSTEM O.0195 :: Reverb Zone Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0195"
	S.key = "arkher.audio.reverbzone.spatialization"
	S.name = "Reverb Zone Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Reverb Zone"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.reverbzone.mixer_bus" }
	S.tags = { "o", "reverbzone", "spatialaudio", "audio" }
	S.description = "Reverb Zone Spatialization: distance attenuation, panning, occlusion and doppler for the Reverb Zone subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.reverbzone.spatialization", model = "inverse", refDistance = 6, maxDistance = 220, rolloff = 0.87, maxVoices = 24 })
		inst.system = S
		inst.ctx = ctx
