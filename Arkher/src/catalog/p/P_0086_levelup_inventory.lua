-- ARKHER SYSTEM P.0086 :: Level Up Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0086"
	S.key = "arkher.play.levelup.inventory"
	S.name = "Level Up Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Level Up"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.levelup.attributes" }
	S.tags = { "p", "levelup", "inventory", "play" }
	S.description = "Level Up Inventory: slots, stacking, weight, equipment and crafting for the Level Up subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.levelup.inventory", slots = 40, maxWeight = 110 })
		inst.system = S
		inst.ctx = ctx
