-- ARKHER SYSTEM VC.0202 :: Architect District Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0202"
	S.key = "arkher.contneural.architectdistrict.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.architectdistrict.complexity_budget" }
	S.tags = { "vc", "architectdistrict", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.architectdistrict.simulation_fabric", budgetMs = 2.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
