-- ARKHER SYSTEM Z.0198 :: World Memory Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0198"
	S.key = "arkher.origin.worldmemorytech.budget_governor"
	S.name = "World Memory Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldmemorytech.behaviour_analysis" }
	S.tags = { "z", "worldmemorytech", "budgeter", "origin" }
	S.description = "World Memory Budget Governor: allocation of a scarce resource across the technology's consumers for the World Memory subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.worldmemorytech.budget_governor", total = 152, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
