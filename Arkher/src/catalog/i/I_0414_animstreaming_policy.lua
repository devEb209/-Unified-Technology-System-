-- ARKHER SYSTEM I.0414 :: Animation Streaming Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0414"
	S.key = "arkher.anim.animstreaming.quality_policy"
	S.name = "Animation Streaming Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstreaming.pose_cache" }
	S.tags = { "i", "animstreaming", "policy", "anim" }
	S.description = "Animation Streaming Quality Policy: device tier rules for rate, bones and solvers for the Animation Streaming subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.animstreaming.quality_policy", algorithm = "edf", starvationGuard = 25 })
		inst.system = S
		inst.ctx = ctx
