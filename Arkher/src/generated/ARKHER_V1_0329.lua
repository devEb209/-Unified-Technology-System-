--!strict
-- Roblox Studio — ANIMATION Profiler #0329
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Roblox Studio — ANIMATION Profiler #0329", size=Vector2.new(680, 500), pos=UDim2.fromOffset(377, 213), parent=parent, icon="☷"})
