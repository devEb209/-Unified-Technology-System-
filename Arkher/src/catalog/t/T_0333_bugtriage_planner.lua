-- ARKHER SYSTEM T.0333 :: Bug Triage Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0333"
	S.key = "arkher.ai.bugtriage.action_planner"
	S.name = "Bug Triage Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.bugtriage.utility_selection" }
	S.tags = { "t", "bugtriage", "planner", "ai" }
	S.description = "Bug Triage Action Planner: goal-oriented action planning over preconditions for the Bug Triage subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.bugtriage.action_planner", maxDepth = 9 })
		inst.system = S
		inst.ctx = ctx
