-- ARKHER SYSTEM G.0165 :: Geometry Detail Prediction Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0165"
	S.key = "arkher.neural.geodetail.error_analysis"
	S.name = "Geometry Detail Prediction Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.geodetail.heuristic_policy" }
	S.tags = { "g", "geodetail", "analyzer", "neural" }
	S.description = "Geometry Detail Prediction Error Analysis: residual and drift analysis for the Geometry Detail Prediction subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.geodetail.error_analysis", window = 172, buckets = 16, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
