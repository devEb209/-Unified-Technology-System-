-- ARKHER SYSTEM L.0423 :: Law Economy
...
return function(A)
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.law.ecology" }
	S.tags = { "l", "law", "economy", "sim" }
	S.description = "Law Economy: stock, production, demand, price discovery and trade for the Law subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.law.economy", elasticity = 0.32 })
		inst.system = S
		inst.ctx = ctx
