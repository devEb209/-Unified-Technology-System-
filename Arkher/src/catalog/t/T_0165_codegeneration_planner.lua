-- ARKHER SYSTEM T.0165 :: Code Generation Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0165"
	S.key = "arkher.ai.codegeneration.action_planner"
	S.name = "Code Generation Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.codegeneration.utility_selection" }
	S.tags = { "t", "codegeneration", "planner", "ai" }
	S.description = "Code Generation Action Planner: goal-oriented action planning over preconditions for the Code Generation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.codegeneration.action_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
