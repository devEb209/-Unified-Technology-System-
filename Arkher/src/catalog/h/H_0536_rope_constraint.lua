-- ARKHER SYSTEM H.0536 :: Rope Simulation Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0536"
	S.key = "arkher.physics.rope.constraint_solver"
	S.name = "Rope Simulation Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rope.contact_generation" }
	S.tags = { "h", "rope", "constraint", "physics" }
	S.description = "Rope Simulation Constraint Solver: sequential impulses, friction, joints and warm starting for the Rope Simulation subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.rope.constraint_solver", iterations = 13, baumgarte = 0.19, warmStart = true })
		inst.system = S
		inst.ctx = ctx
