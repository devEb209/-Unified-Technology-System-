-- ARKHER SYSTEM E.0169 :: Clear Coat Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0169"
	S.key = "arkher.material.clearcoat.texture_sampling"
	S.name = "Clear Coat Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Clear Coat"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.clearcoat.shading_graph" }
	S.tags = { "e", "clearcoat", "sampler", "material" }
	S.description = "Clear Coat Texture Sampling: atlas packing, mip chain and filtered sampling for the Clear Coat subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.clearcoat.texture_sampling", atlasSize = 320, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
