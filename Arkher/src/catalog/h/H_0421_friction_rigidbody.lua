-- ARKHER SYSTEM H.0421 :: Friction Model Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0421"
	S.key = "arkher.physics.friction.body_dynamics"
	S.name = "Friction Model Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "friction", "rigidbody", "physics" }
	S.description = "Friction Model Body Dynamics: integration, impulses, damping and sleeping of a body for the Friction Model subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.friction.body_dynamics", mass = 34.00, radius = 0.95, restitution = 0.33, friction = 0.53, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
