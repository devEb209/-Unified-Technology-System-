-- ARKHER SYSTEM T.0621 :: Explainability World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0621"
	S.key = "arkher.ai.explainability.world_architect"
	S.name = "Explainability World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.explainability.self_critique" }
	S.tags = { "t", "explainability", "architect", "ai" }
	S.description = "Explainability World Architect: composition of a whole world plan with conserved budgets for the Explainability subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.explainability.world_architect", budget = 600, seed = 14770 })
		inst.system = S
		inst.ctx = ctx
