-- ARKHER SYSTEM E.0442 :: Detail Tiling Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0442"
	S.key = "arkher.material.detailtile.parameter_budget"
	S.name = "Detail Tiling Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.detailtile.variant_registry" }
	S.tags = { "e", "detailtile", "budgeter", "material" }
	S.description = "Detail Tiling Parameter Budget: texel and layer budget allocation for the Detail Tiling subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.detailtile.parameter_budget", total = 60, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
