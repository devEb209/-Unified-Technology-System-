-- ARKHER SYSTEM VB.0071 :: Sparse Page Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0071"
	S.key = "arkher.conttime.sparsepage.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.sparsepage.simulation_fabric" }
	S.tags = { "vb", "sparsepage", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.sparsepage.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
