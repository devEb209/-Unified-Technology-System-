-- ARKHER SYSTEM G.0041 :: Spatial Reconstruction Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0041"
	S.key = "arkher.neural.spatialrecon.sampling_graph"
	S.name = "Spatial Reconstruction Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.spatialrecon.training_ledger" }
	S.tags = { "g", "spatialrecon", "graph", "neural" }
	S.description = "Spatial Reconstruction Sampling Graph: dependency graph of sampling stages for the Spatial Reconstruction subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.spatialrecon.sampling_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
