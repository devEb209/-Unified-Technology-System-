-- ARKHER SYSTEM Q.0208 :: Compass Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0208"
	S.key = "arkher.ui.compass.transition"
	S.name = "Compass Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Compass"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.compass.input_mapping" }
	S.tags = { "q", "compass", "tween", "ui" }
	S.description = "Compass Transition: eased, delayed, looped and sequenced motion for the Compass subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.compass.transition", timeScale = 1.08 })
		inst.system = S
		inst.ctx = ctx
