-- ARKHER SYSTEM VD.0214 :: Biome Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0214"
	S.key = "arkher.contsim.biomecont.simulation_fabric"
	S.name = "Biome Continuum Simulation Fabric"
	S.category = "VD"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.biomecont.complexity_budget" }
	S.tags = { "vd", "biomecont", "fabric", "contsim" }
	S.description = "Biome Continuum Simulation Fabric: fabric stepping the continuum domains for the Biome Continuum subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.biomecont.simulation_fabric", budgetMs = 2.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
