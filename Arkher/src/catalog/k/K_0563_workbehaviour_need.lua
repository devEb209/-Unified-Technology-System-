-- ARKHER SYSTEM K.0563 :: Work Behaviour Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0563"
	S.key = "arkher.npc.workbehaviour.drive_system"
	S.name = "Work Behaviour Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workbehaviour.memory" }
	S.tags = { "k", "workbehaviour", "need", "npc" }
	S.description = "Work Behaviour Drive System: drives that decay, turn urgent and get satisfied for the Work Behaviour subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.workbehaviour.drive_system" })
		inst.system = S
		inst.ctx = ctx
