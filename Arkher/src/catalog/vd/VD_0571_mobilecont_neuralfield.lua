-- ARKHER SYSTEM VD.0571 :: Mobile Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0571"
	S.key = "arkher.contsim.mobilecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.mobilecont.coherence_guard" }
	S.tags = { "vd", "mobilecont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.mobilecont.neural_field", dims = 16, hidden = 12, seed = 10249 })
		inst.system = S
		inst.ctx = ctx
