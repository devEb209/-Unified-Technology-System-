-- ARKHER SYSTEM N.0160 :: Snow Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0160"
	S.key = "arkher.vfx.snow.ribbon_and_trail"
	S.name = "Snow Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Snow"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.snow.force_field" }
	S.tags = { "n", "snow", "ribbon", "vfx" }
	S.description = "Snow Ribbon And Trail: trail points, tapering, beams and decimation for the Snow subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.snow.ribbon_and_trail", maxPoints = 16, lifetime = 0.70, minDistance = 0.20, width = 0.80 })
		inst.system = S
		inst.ctx = ctx
