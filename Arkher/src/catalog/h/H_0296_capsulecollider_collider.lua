-- ARKHER SYSTEM H.0296 :: Capsule Collider Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0296"
	S.key = "arkher.physics.capsulecollider.collision_shape"
	S.name = "Capsule Collider Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.capsulecollider.body_dynamics" }
	S.tags = { "h", "capsulecollider", "collider", "physics" }
	S.description = "Capsule Collider Collision Shape: shape bounds, support mapping and closest points for the Capsule Collider subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.capsulecollider.collision_shape", shape = "capsule", radius = 2.40, height = 2.00, layer = "default" })
		inst.system = S
		inst.ctx = ctx
