-- ARKHER SYSTEM VD.0063 :: Sparse Page Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0063"
	S.key = "arkher.contsim.sparsepage.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.sparsepage.epoch_clock" }
	S.tags = { "vd", "sparsepage", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.sparsepage.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
