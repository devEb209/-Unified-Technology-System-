-- ARKHER SYSTEM E.0385 :: Terrain Splat Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0385"
	S.key = "arkher.material.splat.quality_policy"
	S.name = "Terrain Splat Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.splat.compression_codec" }
	S.tags = { "e", "splat", "policy", "material" }
	S.description = "Terrain Splat Quality Policy: device tier rules for the surface for the Terrain Splat subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.splat.quality_policy", algorithm = "roundrobin", starvationGuard = 20 })
		inst.system = S
		inst.ctx = ctx
