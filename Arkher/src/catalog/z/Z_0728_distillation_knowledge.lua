-- ARKHER SYSTEM Z.0728 :: Knowledge Distillation Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0728"
	S.key = "arkher.origin.distillation.semantic_graph"
	S.name = "Knowledge Distillation Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.distillation.world_architect" }
	S.tags = { "z", "distillation", "knowledge", "origin" }
	S.description = "Knowledge Distillation Semantic Graph: typed entities and inferred relations of the technology itself for the Knowledge Distillation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.distillation.semantic_graph", dims = 40 })
		inst.system = S
		inst.ctx = ctx
