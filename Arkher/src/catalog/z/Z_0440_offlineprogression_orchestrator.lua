-- ARKHER SYSTEM Z.0440 :: Offline World Progression Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0440"
	S.key = "arkher.origin.offlineprogression.orchestration"
	S.name = "Offline World Progression Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.residency_streaming" }
	S.tags = { "z", "offlineprogression", "orchestrator", "origin" }
	S.description = "Offline World Progression Orchestration: lifecycle and phase orchestration of the technology for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.offlineprogression.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
