-- ARKHER SYSTEM VB.0466 :: Audio Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0466"
	S.key = "arkher.conttime.audiocont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.audiocont.complexity_budget" }
	S.tags = { "vb", "audiocont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.audiocont.simulation_fabric", budgetMs = 2.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
