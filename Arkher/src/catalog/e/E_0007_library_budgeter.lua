-- ARKHER SYSTEM E.0007 :: Material Library Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0007"
	S.key = "arkher.material.library.parameter_budget"
	S.name = "Material Library Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.library.variant_registry" }
	S.tags = { "e", "library", "budgeter", "material" }
	S.description = "Material Library Parameter Budget: texel and layer budget allocation for the Material Library subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.library.parameter_budget", total = 140, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
