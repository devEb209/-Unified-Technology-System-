-- ARKHER SYSTEM L.0125 :: Village Life Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0125"
	S.key = "arkher.sim.villagelife.calendar"
	S.name = "Village Life Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.villagelife.society" }
	S.tags = { "l", "villagelife", "schedule", "sim" }
	S.description = "Village Life Calendar: hours, days and seasons driving the region for the Village Life subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.villagelife.calendar", startHour = 9 })
		inst.system = S
		inst.ctx = ctx
