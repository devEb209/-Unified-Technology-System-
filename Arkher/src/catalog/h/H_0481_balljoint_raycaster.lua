-- ARKHER SYSTEM H.0481 :: Ball Joint Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0481"
	S.key = "arkher.physics.balljoint.query"
	S.name = "Ball Joint Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Ball Joint"
	S.aspect = "Query"
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.balljoint.constraint_solver" }
	S.tags = { "h", "balljoint", "raycaster", "physics" }
	S.description = "Ball Joint Query: rays, sweeps and overlaps against the simulation for the Ball Joint subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.balljoint.query", cellSize = 48 })
		inst.system = S
		inst.ctx = ctx
