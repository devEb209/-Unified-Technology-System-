-- ARKHER SYSTEM T.0325 :: Bug Triage Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0325"
	S.key = "arkher.ai.bugtriage.plan_workflow"
	S.name = "Bug Triage Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.bugtriage.semantic_knowledge" }
	S.tags = { "t", "bugtriage", "workflow", "ai" }
	S.description = "Bug Triage Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Bug Triage subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.bugtriage.plan_workflow", maxRetries = 2, budget = 50 })
		inst.system = S
		inst.ctx = ctx
