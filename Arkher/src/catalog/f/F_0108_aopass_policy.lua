-- ARKHER SYSTEM F.0108 :: Ambient Occlusion Pass Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0108"
	S.key = "arkher.render.aopass.render_policy"
	S.name = "Ambient Occlusion Pass Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.aopass.draw_budget" }
	S.tags = { "f", "aopass", "policy", "render" }
	S.description = "Ambient Occlusion Pass Render Policy: device tier rules for the frame for the Ambient Occlusion Pass subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.aopass.render_policy", algorithm = "lottery", starvationGuard = 51 })
		inst.system = S
		inst.ctx = ctx
