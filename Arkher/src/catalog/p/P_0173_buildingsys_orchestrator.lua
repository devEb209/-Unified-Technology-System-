-- ARKHER SYSTEM P.0173 :: Building State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0173"
	S.key = "arkher.play.buildingsys.state_machine"
	S.name = "Building State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Building"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.buildingsys.combat_resolution" }
	S.tags = { "p", "buildingsys", "orchestrator", "play" }
	S.description = "Building State Machine: the phase machine that drives this gameplay loop for the Building subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.buildingsys.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
