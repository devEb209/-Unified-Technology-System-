-- ARKHER SYSTEM T.0023 :: Prompt Understanding Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0023"
	S.key = "arkher.ai.prompt.working_memory"
	S.name = "Prompt Understanding Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.prompt.outcome_prediction" }
	S.tags = { "t", "prompt", "memory", "ai" }
	S.description = "Prompt Understanding Working Memory: decaying, consolidating recall of what the agent learned for the Prompt Understanding subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.prompt.working_memory", capacity = 70, decayRate = 0.030, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
