-- ARKHER SYSTEM VD.0499 :: Rendering Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0499"
	S.key = "arkher.contsim.rendercont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.rendercont.coherence_guard" }
	S.tags = { "vd", "rendercont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.rendercont.neural_field", dims = 20, hidden = 16, seed = 13206 })
		inst.system = S
		inst.ctx = ctx
