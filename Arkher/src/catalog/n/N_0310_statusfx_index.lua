-- ARKHER SYSTEM N.0310 :: Status Effect Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0310"
	S.key = "arkher.vfx.statusfx.spatial_index"
	S.name = "Status Effect Spatial Index"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.statusfx.quality_policy" }
	S.tags = { "n", "statusfx", "index", "vfx" }
	S.description = "Status Effect Spatial Index: spatial acceleration of effect queries and culling for the Status Effect subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.statusfx.spatial_index", mode = "hash", cellSize = 56 })
		inst.system = S
		inst.ctx = ctx
