-- ARKHER SYSTEM K.0618 :: Reputation Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0618"
	S.key = "arkher.npc.reputation.memory"
	S.name = "Reputation Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.reputation.mind_network" }
	S.tags = { "k", "reputation", "memory", "npc" }
	S.description = "Reputation Memory: episodic memory with decay, recall and consolidation for the Reputation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.reputation.memory", capacity = 92, decayRate = 0.040, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
