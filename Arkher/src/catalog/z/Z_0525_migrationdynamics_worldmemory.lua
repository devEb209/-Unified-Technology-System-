-- ARKHER SYSTEM Z.0525 :: Migration Dynamics World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0525"
	S.key = "arkher.origin.migrationdynamics.world_memory"
	S.name = "Migration Dynamics World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.migrationdynamics.autonomous_pipeline" }
	S.tags = { "z", "migrationdynamics", "worldmemory", "origin" }
	S.description = "Migration Dynamics World Memory: epoch-stamped persistent history with compaction and checkpoints for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.migrationdynamics.world_memory", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
