-- ARKHER SYSTEM T.0306 :: Difficulty Tuning Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0306"
	S.key = "arkher.ai.difficultytuning.model_inference"
	S.name = "Difficulty Tuning Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.difficultytuning.action_planner" }
	S.tags = { "t", "difficultytuning", "inference", "ai" }
	S.description = "Difficulty Tuning Model Inference: quantized inference with batching and budget for the Difficulty Tuning subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.difficultytuning.model_inference", seed = 33159 })
		inst.system = S
		inst.ctx = ctx
