-- ARKHER SYSTEM VA.0428 :: Navigation Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0428"
	S.key = "arkher.contworld.navcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.navcont.neural_field" }
	S.tags = { "va", "navcont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.navcont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
