-- ARKHER SYSTEM T.0564 :: Pipeline Automation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0564"
	S.key = "arkher.ai.pipelineautomation.self_critique"
	S.name = "Pipeline Automation Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.pipelineautomation.plan_workflow" }
	S.tags = { "t", "pipelineautomation", "critic", "ai" }
	S.description = "Pipeline Automation Self Critique: weighted evaluation of the result against declared criteria for the Pipeline Automation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.pipelineautomation.self_critique", passMark = 0.74, reviseMark = 0.49, seed = 51079 })
		inst.system = S
		inst.ctx = ctx
