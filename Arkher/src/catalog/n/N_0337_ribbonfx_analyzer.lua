-- ARKHER SYSTEM N.0337 :: Ribbon Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0337"
	S.key = "arkher.vfx.ribbonfx.analysis"
	S.name = "Ribbon Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Ribbon"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.ribbonfx.spatial_index" }
	S.tags = { "n", "ribbonfx", "analyzer", "vfx" }
	S.description = "Ribbon Analysis: cost, overdraw and stability analysis of the effect for the Ribbon subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.ribbonfx.analysis", window = 90, buckets = 18, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
