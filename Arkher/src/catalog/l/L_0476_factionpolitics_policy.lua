-- ARKHER SYSTEM L.0476 :: Faction Politics Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0476"
	S.key = "arkher.sim.factionpolitics.fidelity_policy"
	S.name = "Faction Politics Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.factionpolitics.streaming" }
	S.tags = { "l", "factionpolitics", "policy", "sim" }
	S.description = "Faction Politics Fidelity Policy: rules that pick full, cohort or statistical simulation for the Faction Politics subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.factionpolitics.fidelity_policy", algorithm = "edf", starvationGuard = 49 })
		inst.system = S
		inst.ctx = ctx
