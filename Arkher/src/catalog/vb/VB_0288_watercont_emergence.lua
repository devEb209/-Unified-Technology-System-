-- ARKHER SYSTEM VB.0288 :: Water Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0288"
	S.key = "arkher.conttime.watercont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.watercont.reality_continuum" }
	S.tags = { "vb", "watercont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.watercont.emergence_continuum", windowSize = 6, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
