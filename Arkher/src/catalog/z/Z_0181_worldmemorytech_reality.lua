-- ARKHER SYSTEM Z.0181 :: World Memory Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0181"
	S.key = "arkher.origin.worldmemorytech.reality_layering"
	S.name = "World Memory Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "worldmemorytech", "reality", "origin" }
	S.description = "World Memory Reality Layering: stacked authored, simulated, proposed and player realities for the World Memory subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.worldmemorytech.reality_layering" })
		inst.system = S
		inst.ctx = ctx
