-- ARKHER SYSTEM VB.0493 :: Rendering Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0493"
	S.key = "arkher.conttime.rendercont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "rendercont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.rendercont.infinite_grid", cellSize = 96, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
