-- ARKHER SYSTEM Z.0699 :: Auto Test Synthesis Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0699"
	S.key = "arkher.origin.autotest.residency_streaming"
	S.name = "Auto Test Synthesis Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autotest.budget_governor" }
	S.tags = { "z", "autotest", "streamer", "origin" }
	S.description = "Auto Test Synthesis Residency Streaming: distance-driven residency of the technology's workload for the Auto Test Synthesis subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.autotest.residency_streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
