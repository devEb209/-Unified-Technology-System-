-- ARKHER SYSTEM R.0265 :: Rate Limiting Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0265"
	S.key = "arkher.net.ratelimiting.replication"
	S.name = "Rate Limiting Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "ratelimiting", "replicator", "net" }
	S.description = "Rate Limiting Replication: authoritative entity state, interest and delta snapshots for the Rate Limiting subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.ratelimiting.replication", mtu = 750, interestRadius = 400, fullEvery = 105 })
		inst.system = S
		inst.ctx = ctx
