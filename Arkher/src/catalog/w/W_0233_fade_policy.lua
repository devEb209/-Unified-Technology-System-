-- ARKHER SYSTEM W.0233 :: Fade Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0233"
	S.key = "arkher.cine.fade.cut_policy"
	S.name = "Fade Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Fade"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.fade.shot_composition" }
	S.tags = { "w", "fade", "policy", "cine" }
	S.description = "Fade Cut Policy: rules deciding when the sequence cuts and to what for the Fade subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.fade.cut_policy", algorithm = "roundrobin", starvationGuard = 16 })
		inst.system = S
		inst.ctx = ctx
