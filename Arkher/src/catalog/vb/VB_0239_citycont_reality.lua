-- ARKHER SYSTEM VB.0239 :: City Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0239"
	S.key = "arkher.conttime.citycont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.citycont.simulation_fabric" }
	S.tags = { "vb", "citycont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.citycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
