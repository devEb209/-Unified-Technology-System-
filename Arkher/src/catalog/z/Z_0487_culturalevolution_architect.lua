-- ARKHER SYSTEM Z.0487 :: Cultural Evolution World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0487"
	S.key = "arkher.origin.culturalevolution.world_architect"
	S.name = "Cultural Evolution World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.emergence_detection" }
	S.tags = { "z", "culturalevolution", "architect", "origin" }
	S.description = "Cultural Evolution World Architect: hierarchical world composition with conserved budgets for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.culturalevolution.world_architect", budget = 1500, seed = 66539 })
		inst.system = S
		inst.ctx = ctx
