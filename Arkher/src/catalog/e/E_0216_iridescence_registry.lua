-- ARKHER SYSTEM E.0216 :: Iridescence Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0216"
	S.key = "arkher.material.iridescence.variant_registry"
	S.name = "Iridescence Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Iridescence"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.iridescence.procedural_detail" }
	S.tags = { "e", "iridescence", "registry", "material" }
	S.description = "Iridescence Variant Registry: named variants and their lifecycle for the Iridescence subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.iridescence.variant_registry" })
		inst.system = S
		inst.ctx = ctx
