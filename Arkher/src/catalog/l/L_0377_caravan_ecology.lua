-- ARKHER SYSTEM L.0377 :: Caravan Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0377"
	S.key = "arkher.sim.caravan.ecology"
	S.name = "Caravan Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.caravan.simulation_core" }
	S.tags = { "l", "caravan", "ecology", "sim" }
	S.description = "Caravan Ecology: populations, predation, harvesting and carrying capacity for the Caravan subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.caravan.ecology" })
		inst.system = S
		inst.ctx = ctx
