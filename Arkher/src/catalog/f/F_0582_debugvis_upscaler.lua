-- ARKHER SYSTEM F.0582 :: Debug Visualization Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0582"
	S.key = "arkher.render.debugvis.adaptive_resolution"
	S.name = "Debug Visualization Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.debugvis.temporal_resolve" }
	S.tags = { "f", "debugvis", "upscaler", "render" }
	S.description = "Debug Visualization Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Debug Visualization subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.debugvis.adaptive_resolution", targetMs = 12.10, index = 4, sharpness = 0.33 })
		inst.system = S
		inst.ctx = ctx
