-- ARKHER SYSTEM K.0656 :: Daily Routine Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0656"
	S.key = "arkher.npc.dailyroutine.daily_schedule"
	S.name = "Daily Routine Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dailyroutine.social_relations" }
	S.tags = { "k", "dailyroutine", "schedule", "npc" }
	S.description = "Daily Routine Daily Schedule: hour-by-hour routine with priority interruptions for the Daily Routine subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.dailyroutine.daily_schedule", startHour = 8 })
		inst.system = S
		inst.ctx = ctx
