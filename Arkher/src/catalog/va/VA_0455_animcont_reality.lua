-- ARKHER SYSTEM VA.0455 :: Animation Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0455"
	S.key = "arkher.contworld.animcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.animcont.simulation_fabric" }
	S.tags = { "va", "animcont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.animcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
