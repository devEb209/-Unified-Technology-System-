-- ARKHER SYSTEM T.0005 :: Intent Parsing World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0005"
	S.key = "arkher.ai.intentparsing.world_architect"
	S.name = "Intent Parsing World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.intentparsing.self_critique" }
	S.tags = { "t", "intentparsing", "architect", "ai" }
	S.description = "Intent Parsing World Architect: composition of a whole world plan with conserved budgets for the Intent Parsing subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.intentparsing.world_architect", budget = 1300, seed = 5997 })
		inst.system = S
		inst.ctx = ctx
