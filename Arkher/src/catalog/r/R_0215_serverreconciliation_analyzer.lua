-- ARKHER SYSTEM R.0215 :: Server Reconciliation Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0215"
	S.key = "arkher.net.serverreconciliation.latency_analysis"
	S.name = "Server Reconciliation Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverreconciliation.audit_ledger" }
	S.tags = { "r", "serverreconciliation", "analyzer", "net" }
	S.description = "Server Reconciliation Latency Analysis: round trip, jitter and loss analysis for the Server Reconciliation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.serverreconciliation.latency_analysis", window = 221, buckets = 9, threshold = 3.30 })
		inst.system = S
		inst.ctx = ctx
