-- ARKHER SYSTEM P.0359 :: Threat Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0359"
	S.key = "arkher.play.threat.save_codec"
	S.name = "Threat Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Threat"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.threat.content_registry" }
	S.tags = { "p", "threat", "codec", "play" }
	S.description = "Threat Save Codec: persistence, diffing and checksum of gameplay state for the Threat subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.threat.save_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
