-- ARKHER SYSTEM F.0075 :: Cascade Shadows Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0075"
	S.key = "arkher.render.cascades.lighting_rig"
	S.name = "Cascade Shadows Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.cascades.geometry_virtualization" }
	S.tags = { "f", "cascades", "lightrig", "render" }
	S.description = "Cascade Shadows Lighting Rig: light clustering, importance and cascades for the Cascade Shadows subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.cascades.lighting_rig", maxActive = 11 })
		inst.system = S
		inst.ctx = ctx
