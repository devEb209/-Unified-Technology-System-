-- ARKHER SYSTEM N.0217 :: Lightning Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0217"
	S.key = "arkher.vfx.lightning.result_cache"
	S.name = "Lightning Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Lightning"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.lightning.spawn_budget" }
	S.tags = { "n", "lightning", "cache", "vfx" }
	S.description = "Lightning Result Cache: reuse of expensive effect evaluations for the Lightning subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.lightning.result_cache", policy = "lru", capacity = 282, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
