-- ARKHER SYSTEM F.0174 :: Atmosphere Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0174"
	S.key = "arkher.render.atmosphere.probe_volume"
	S.name = "Atmosphere Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Atmosphere"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.atmosphere.lighting_rig" }
	S.tags = { "f", "atmosphere", "probe", "render" }
	S.description = "Atmosphere Probe Volume: irradiance probes encoded in spherical harmonics for the Atmosphere subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.atmosphere.probe_volume", spacing = 40 })
		inst.system = S
		inst.ctx = ctx
