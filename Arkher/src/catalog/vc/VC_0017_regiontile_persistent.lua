-- ARKHER SYSTEM VC.0017 :: Region Tile Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0017"
	S.key = "arkher.contneural.regiontile.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.regiontile.multi-scale_fidelity" }
	S.tags = { "vc", "regiontile", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.regiontile.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
