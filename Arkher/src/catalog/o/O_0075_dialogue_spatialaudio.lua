-- ARKHER SYSTEM O.0075 :: Dialogue Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0075"
	S.key = "arkher.audio.dialogue.spatialization"
	S.name = "Dialogue Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Dialogue"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.dialogue.mixer_bus" }
	S.tags = { "o", "dialogue", "spatialaudio", "audio" }
	S.description = "Dialogue Spatialization: distance attenuation, panning, occlusion and doppler for the Dialogue subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.dialogue.spatialization", model = "inverse", refDistance = 3, maxDistance = 160, rolloff = 0.94, maxVoices = 12 })
		inst.system = S
		inst.ctx = ctx
