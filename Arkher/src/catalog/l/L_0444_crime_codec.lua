-- ARKHER SYSTEM L.0444 :: Crime State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0444"
	S.key = "arkher.sim.crime.state_codec"
	S.name = "Crime State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.crime.history_ledger" }
	S.tags = { "l", "crime", "codec", "sim" }
	S.description = "Crime State Codec: persistence, diffing and checksum of the world state for the Crime subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.crime.state_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
