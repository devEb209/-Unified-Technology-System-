-- ARKHER SYSTEM G.0315 :: Weight Quantization Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0315"
	S.key = "arkher.neural.quantization.quality_predictor"
	S.name = "Weight Quantization Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.quantization.weight_codec" }
	S.tags = { "g", "quantization", "predictor", "neural" }
	S.description = "Weight Quantization Quality Predictor: predicted quality and cost of a setting for the Weight Quantization subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.quantization.quality_predictor", method = "markov", alpha = 0.31, window = 85 })
		inst.system = S
		inst.ctx = ctx
