-- ARKHER SYSTEM VB.0023 :: Region Tile Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0023"
	S.key = "arkher.conttime.regiontile.reality_continuum"
	S.name = "Region Tile Reality Continuum"
	S.category = "VB"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.regiontile.simulation_fabric" }
	S.tags = { "vb", "regiontile", "reality", "conttime" }
	S.description = "Region Tile Reality Continuum: stacked reality layers of the continuum for the Region Tile subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.regiontile.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
