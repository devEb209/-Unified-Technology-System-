-- ARKHER SYSTEM Q.0110 :: Toast Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0110"
	S.key = "arkher.ui.toast.widget_tree"
	S.name = "Toast Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Toast"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.toast.responsive_layout" }
	S.tags = { "q", "toast", "widget", "ui" }
	S.description = "Toast Widget Tree: retained widget nodes, properties, bindings and rendering for the Toast subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.toast.widget_tree", theme = "highcontrast", scale = 1.16 })
		inst.system = S
		inst.ctx = ctx
