-- ARKHER SYSTEM N.0171 :: Hail Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0171"
	S.key = "arkher.vfx.hail.particle_simulation"
	S.name = "Hail Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Hail"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.hail.emission" }
	S.tags = { "n", "hail", "particles", "vfx" }
	S.description = "Hail Particle Simulation: pooled integration of position, velocity, colour and life for the Hail subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.hail.particle_simulation", capacity = 320, drag = 0.24, bounce = 0.39, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
