-- ARKHER SYSTEM VD.0620 :: Occupancy Map World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0620"
	S.key = "arkher.contsim.occupancymap.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.occupancymap.neural_field" }
	S.tags = { "vd", "occupancymap", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.occupancymap.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
