-- ARKHER SYSTEM E.0199 :: Sheen Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0199"
	S.key = "arkher.material.sheen.texture_sampling"
	S.name = "Sheen Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Sheen"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.sheen.shading_graph" }
	S.tags = { "e", "sheen", "sampler", "material" }
	S.description = "Sheen Texture Sampling: atlas packing, mip chain and filtered sampling for the Sheen subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.sheen.texture_sampling", atlasSize = 128, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
