-- ARKHER SYSTEM Z.0281 :: Temporal Continuity Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0281"
	S.key = "arkher.origin.temporalcontinuity.reality_layering"
	S.name = "Temporal Continuity Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "temporalcontinuity", "reality", "origin" }
	S.description = "Temporal Continuity Reality Layering: stacked authored, simulated, proposed and player realities for the Temporal Continuity subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.temporalcontinuity.reality_layering" })
		inst.system = S
		inst.ctx = ctx
