-- ARKHER SYSTEM J.0259 :: Damage State Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0259"
	S.key = "arkher.character.damagestate.locomotion"
	S.name = "Damage State Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.damagestate.physical_response" }
	S.tags = { "j", "damagestate", "charmotor", "character" }
	S.description = "Damage State Locomotion: capsule locomotion driving the character for the Damage State subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.damagestate.locomotion", radius = 0.48, height = 1.73, maxSpeed = 5.30, jumpHeight = 1.30, stepOffset = 0.38 })
		inst.system = S
		inst.ctx = ctx
