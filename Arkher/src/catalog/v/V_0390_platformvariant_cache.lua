-- ARKHER SYSTEM V.0390 :: Platform Variant Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0390"
	S.key = "arkher.asset.platformvariant.content_cache"
	S.name = "Platform Variant Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.platformvariant.dependency_graph" }
	S.tags = { "v", "platformvariant", "cache", "asset" }
	S.description = "Platform Variant Content Cache: reuse of already cooked results for the Platform Variant subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.platformvariant.content_cache", policy = "ttl", capacity = 428, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
