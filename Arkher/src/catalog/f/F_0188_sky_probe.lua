-- ARKHER SYSTEM F.0188 :: Sky Model Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0188"
	S.key = "arkher.render.sky.probe_volume"
	S.name = "Sky Model Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sky Model"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sky.lighting_rig" }
	S.tags = { "f", "sky", "probe", "render" }
	S.description = "Sky Model Probe Volume: irradiance probes encoded in spherical harmonics for the Sky Model subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.sky.probe_volume", spacing = 24 })
		inst.system = S
		inst.ctx = ctx
