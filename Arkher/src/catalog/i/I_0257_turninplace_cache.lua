-- ARKHER SYSTEM I.0257 :: Turn In Place Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0257"
	S.key = "arkher.anim.turninplace.pose_cache"
	S.name = "Turn In Place Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.turninplace.playback_pipeline" }
	S.tags = { "i", "turninplace", "cache", "anim" }
	S.description = "Turn In Place Pose Cache: reuse of sampled poses across frames and instances for the Turn In Place subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.turninplace.pose_cache", policy = "ttl", capacity = 416, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
