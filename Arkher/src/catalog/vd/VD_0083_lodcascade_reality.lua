-- ARKHER SYSTEM VD.0083 :: LOD Cascade Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0083"
	S.key = "arkher.contsim.lodcascade.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lodcascade.simulation_fabric" }
	S.tags = { "vd", "lodcascade", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.lodcascade.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
