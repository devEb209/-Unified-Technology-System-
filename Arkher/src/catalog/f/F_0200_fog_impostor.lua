-- ARKHER SYSTEM F.0200 :: Fog Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0200"
	S.key = "arkher.render.fog.geometry_virtualization"
	S.name = "Fog Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Fog"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.fog.visibility_set" }
	S.tags = { "f", "fog", "impostor", "render" }
	S.description = "Fog Geometry Virtualization: impostor and HLOD synthesis under a budget for the Fog subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.fog.geometry_virtualization", atlasSlots = 32, viewCount = 8, errorThreshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
