-- ARKHER SYSTEM V.0321 :: Texture Atlas Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0321"
	S.key = "arkher.asset.atlas.size_budget"
	S.name = "Texture Atlas Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.atlas.compression_codec" }
	S.tags = { "v", "atlas", "budgeter", "asset" }
	S.description = "Texture Atlas Size Budget: byte budget shared between competing asset classes for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.atlas.size_budget", total = 380, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
