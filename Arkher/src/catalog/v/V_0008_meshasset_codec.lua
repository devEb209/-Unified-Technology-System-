-- ARKHER SYSTEM V.0008 :: Mesh Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0008"
	S.key = "arkher.asset.meshasset.compression_codec"
	S.name = "Mesh Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.meshasset.streaming_residency" }
	S.tags = { "v", "meshasset", "codec", "asset" }
	S.description = "Mesh Compression Codec: compact encoding, diffing and checksum of asset payloads for the Mesh subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.meshasset.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
