-- ARKHER SYSTEM K.0667 :: Sleep Cycle Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0667"
	S.key = "arkher.npc.sleepcycle.navigation"
	S.name = "Sleep Cycle Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.sleepcycle.goal_planner" }
	S.tags = { "k", "sleepcycle", "navgraph", "npc" }
	S.description = "Sleep Cycle Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Sleep Cycle subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.sleepcycle.navigation", width = 40, height = 40, cellSize = 4 })
		inst.system = S
		inst.ctx = ctx
