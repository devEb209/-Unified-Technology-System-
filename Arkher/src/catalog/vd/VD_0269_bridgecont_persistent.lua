-- ARKHER SYSTEM VD.0269 :: Bridge Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0269"
	S.key = "arkher.contsim.bridgecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.bridgecont.multi-scale_fidelity" }
	S.tags = { "vd", "bridgecont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.bridgecont.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
