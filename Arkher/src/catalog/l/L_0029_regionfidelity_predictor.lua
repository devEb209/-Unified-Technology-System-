-- ARKHER SYSTEM L.0029 :: Region Fidelity Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0029"
	S.key = "arkher.sim.regionfidelity.forecast"
	S.name = "Region Fidelity Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.regionfidelity.analysis" }
	S.tags = { "l", "regionfidelity", "predictor", "sim" }
	S.description = "Region Fidelity Forecast: prediction of the region's next state for the Region Fidelity subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.regionfidelity.forecast", method = "linear", alpha = 0.16, window = 78 })
		inst.system = S
		inst.ctx = ctx
