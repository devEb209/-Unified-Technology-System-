-- ARKHER SYSTEM O.0389 :: Accessibility Audio Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0389"
	S.key = "arkher.audio.audioaccessibility.voice_budget"
	S.name = "Accessibility Audio Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audioaccessibility.music_sequencer" }
	S.tags = { "o", "audioaccessibility", "budgeter", "audio" }
	S.description = "Accessibility Audio Voice Budget: voice slots allocated by priority and audibility for the Accessibility Audio subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.audioaccessibility.voice_budget", total = 243, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
