-- ARKHER SYSTEM H.0207 :: Substepping Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0207"
	S.key = "arkher.physics.substepping.result_cache"
	S.name = "Substepping Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Substepping"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.substepping.simulation_policy" }
	S.tags = { "h", "substepping", "cache", "physics" }
	S.description = "Substepping Result Cache: reuse of expensive simulation and query results for the Substepping subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.substepping.result_cache", policy = "lru", capacity = 485, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
