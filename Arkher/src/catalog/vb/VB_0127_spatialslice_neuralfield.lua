-- ARKHER SYSTEM VB.0127 :: Spatial Slice Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0127"
	S.key = "arkher.conttime.spatialslice.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.spatialslice.coherence_guard" }
	S.tags = { "vb", "spatialslice", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.spatialslice.neural_field", dims = 20, hidden = 16, seed = 50254 })
		inst.system = S
		inst.ctx = ctx
