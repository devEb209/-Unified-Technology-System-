-- ARKHER SYSTEM VC.0295 :: Climate Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0295"
	S.key = "arkher.contneural.climatecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.climatecont.coherence_guard" }
	S.tags = { "vc", "climatecont", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.climatecont.neural_field", dims = 16, hidden = 12, seed = 22105 })
		inst.system = S
		inst.ctx = ctx
