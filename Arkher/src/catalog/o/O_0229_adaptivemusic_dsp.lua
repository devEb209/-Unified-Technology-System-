-- ARKHER SYSTEM O.0229 :: Adaptive Music DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0229"
	S.key = "arkher.audio.adaptivemusic.dsp_chain"
	S.name = "Adaptive Music DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "adaptivemusic", "dsp", "audio" }
	S.description = "Adaptive Music DSP Chain: biquad filtering, delay, envelope and soft clipping for the Adaptive Music subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.adaptivemusic.dsp_chain", sampleRate = 22050, filter = "lowpass", cutoff = 300, q = 0.700 })
		inst.system = S
		inst.ctx = ctx
