-- ARKHER SYSTEM W.0188 :: Dialogue Scene Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0188"
	S.key = "arkher.cine.dialoguescene.cinematic_mix"
	S.name = "Dialogue Scene Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dialoguescene.motion_tween" }
	S.tags = { "w", "dialoguescene", "mixer", "cine" }
	S.description = "Dialogue Scene Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Dialogue Scene subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.dialoguescene.cinematic_mix", maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
