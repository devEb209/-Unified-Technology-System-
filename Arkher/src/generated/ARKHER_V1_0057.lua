--!strict
-- SpeedTree Atlas — ANIMATION Mixer #0057
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="SpeedTree Atlas — ANIMATION Mixer #0057", size=Vector2.new(600, 460), pos=UDim2.fromOffset(441, 269), parent=parent, icon="▭"})
