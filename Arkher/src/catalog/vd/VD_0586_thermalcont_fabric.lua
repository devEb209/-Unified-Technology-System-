-- ARKHER SYSTEM VD.0586 :: Thermal Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0586"
	S.key = "arkher.contsim.thermalcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.thermalcont.complexity_budget" }
	S.tags = { "vd", "thermalcont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.thermalcont.simulation_fabric", budgetMs = 4.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
