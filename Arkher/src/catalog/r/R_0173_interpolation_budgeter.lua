-- ARKHER SYSTEM R.0173 :: Interpolation Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0173"
	S.key = "arkher.net.interpolation.bandwidth_budget"
	S.name = "Interpolation Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.interpolation.transport_graph" }
	S.tags = { "r", "interpolation", "budgeter", "net" }
	S.description = "Interpolation Bandwidth Budget: bytes per second shared between competing streams for the Interpolation subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.interpolation.bandwidth_budget", total = 261, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
