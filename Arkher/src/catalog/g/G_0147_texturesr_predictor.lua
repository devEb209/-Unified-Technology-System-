-- ARKHER SYSTEM G.0147 :: Texture Super Resolution Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0147"
	S.key = "arkher.neural.texturesr.quality_predictor"
	S.name = "Texture Super Resolution Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.texturesr.weight_codec" }
	S.tags = { "g", "texturesr", "predictor", "neural" }
	S.description = "Texture Super Resolution Quality Predictor: predicted quality and cost of a setting for the Texture Super Resolution subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.texturesr.quality_predictor", method = "markov", alpha = 0.34, window = 64 })
		inst.system = S
		inst.ctx = ctx
