-- ARKHER SYSTEM P.0314 :: Damage Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0314"
	S.key = "arkher.play.damage.inventory"
	S.name = "Damage Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Damage"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.damage.attributes" }
	S.tags = { "p", "damage", "inventory", "play" }
	S.description = "Damage Inventory: slots, stacking, weight, equipment and crafting for the Damage subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.damage.inventory", slots = 12, maxWeight = 40 })
		inst.system = S
		inst.ctx = ctx
