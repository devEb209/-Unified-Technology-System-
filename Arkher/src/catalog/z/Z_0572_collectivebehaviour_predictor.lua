-- ARKHER SYSTEM Z.0572 :: Collective Behaviour Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0572"
	S.key = "arkher.origin.collectivebehaviour.predictive_optimization"
	S.name = "Collective Behaviour Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.collectivebehaviour.adaptive_workflow" }
	S.tags = { "z", "collectivebehaviour", "predictor", "origin" }
	S.description = "Collective Behaviour Predictive Optimization: forecast-driven optimization before the cost is paid for the Collective Behaviour subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.collectivebehaviour.predictive_optimization", method = "ema", alpha = 0.28, window = 122 })
		inst.system = S
		inst.ctx = ctx
