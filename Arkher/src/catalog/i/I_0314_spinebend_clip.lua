-- ARKHER SYSTEM I.0314 :: Spine Bend Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0314"
	S.key = "arkher.anim.spinebend.clip_sampling"
	S.name = "Spine Bend Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Spine Bend"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.spinebend.skeleton" }
	S.tags = { "i", "spinebend", "clip", "anim" }
	S.description = "Spine Bend Clip Sampling: keyframe tracks sampled, retimed and evented for the Spine Bend subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.spinebend.clip_sampling", duration = 2.00, loop = true })
		inst.system = S
		inst.ctx = ctx
