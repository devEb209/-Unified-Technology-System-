-- ARKHER SYSTEM Q.0271 :: Virtual Joystick Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0271"
	S.key = "arkher.ui.virtualjoystick.localization_registry"
	S.name = "Virtual Joystick Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.virtualjoystick.theme_composition" }
	S.tags = { "q", "virtualjoystick", "registry", "ui" }
	S.description = "Virtual Joystick Localization Registry: catalogue of strings, plurals and locale metadata for the Virtual Joystick subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.virtualjoystick.localization_registry" })
		inst.system = S
		inst.ctx = ctx
