-- ARKHER SYSTEM J.0228 :: Character Variant Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0228"
	S.key = "arkher.character.charvariant.variant_registry"
	S.name = "Character Variant Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.charvariant.appearance_composer" }
	S.tags = { "j", "charvariant", "registry", "character" }
	S.description = "Character Variant Variant Registry: named character variants and their lifecycle for the Character Variant subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.charvariant.variant_registry" })
		inst.system = S
		inst.ctx = ctx
