-- ARKHER SYSTEM Z.0807 :: Perceptual Budgeting World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0807"
	S.key = "arkher.origin.perceptualbudget.world_architect"
	S.name = "Perceptual Budgeting World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.perceptualbudget.emergence_detection" }
	S.tags = { "z", "perceptualbudget", "architect", "origin" }
	S.description = "Perceptual Budgeting World Architect: hierarchical world composition with conserved budgets for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.perceptualbudget.world_architect", budget = 1500, seed = 33789 })
		inst.system = S
		inst.ctx = ctx
