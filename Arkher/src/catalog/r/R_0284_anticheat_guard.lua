-- ARKHER SYSTEM R.0284 :: Anti Cheat Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0284"
	S.key = "arkher.net.anticheat.rate_guard"
	S.name = "Anti Cheat Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Anti Cheat"
	S.aspect = "Rate Guard"
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.anticheat.interest_streaming" }
	S.tags = { "r", "anticheat", "guard", "net" }
	S.description = "Anti Cheat Rate Guard: token-bucket protection against floods and abuse for the Anti Cheat subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.anticheat.rate_guard", algorithm = "sliding", capacity = 213, refillPerSec = 18, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
