-- ARKHER SYSTEM E.0280 :: Decal Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0280"
	S.key = "arkher.material.decal.quality_policy"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.decal.compression_codec" }
	S.tags = { "e", "decal", "policy", "material" }
	S.description = "Decal Quality Policy: device tier rules for the surface for the Decal subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.decal.quality_policy", algorithm = "wfq", starvationGuard = 50 })
		inst.system = S
		inst.ctx = ctx
