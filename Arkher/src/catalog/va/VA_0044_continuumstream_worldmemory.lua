-- ARKHER SYSTEM VA.0044 :: Continuum Stream World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0044"
	S.key = "arkher.contworld.continuumstream.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.continuumstream.neural_field" }
	S.tags = { "va", "continuumstream", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.continuumstream.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
