-- ARKHER SYSTEM H.0478 :: Ball Joint Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0478"
	S.key = "arkher.physics.balljoint.collision_shape"
	S.name = "Ball Joint Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Ball Joint"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.balljoint.body_dynamics" }
	S.tags = { "h", "balljoint", "collider", "physics" }
	S.description = "Ball Joint Collision Shape: shape bounds, support mapping and closest points for the Ball Joint subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.balljoint.collision_shape", shape = "capsule", radius = 2.70, height = 2.30, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
