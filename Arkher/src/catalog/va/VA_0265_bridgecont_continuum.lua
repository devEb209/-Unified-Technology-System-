-- ARKHER SYSTEM VA.0265 :: Bridge Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0265"
	S.key = "arkher.contworld.bridgecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "bridgecont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.bridgecont.infinite_grid", cellSize = 64, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
