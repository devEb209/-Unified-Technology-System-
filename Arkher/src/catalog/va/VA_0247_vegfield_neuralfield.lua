-- ARKHER SYSTEM VA.0247 :: Vegetation Field Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0247"
	S.key = "arkher.contworld.vegfield.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vegfield.coherence_guard" }
	S.tags = { "va", "vegfield", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.vegfield.neural_field", dims = 24, hidden = 20, seed = 74739 })
		inst.system = S
		inst.ctx = ctx
