-- ARKHER SYSTEM W.0295 :: Motion Blur Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0295"
	S.key = "arkher.cine.cinemotionblur.motion_tween"
	S.name = "Motion Blur Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Motion Blur"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinemotionblur.playback_orchestrator" }
	S.tags = { "w", "cinemotionblur", "tween", "cine" }
	S.description = "Motion Blur Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.cinemotionblur.motion_tween", timeScale = 1.05 })
		inst.system = S
		inst.ctx = ctx
