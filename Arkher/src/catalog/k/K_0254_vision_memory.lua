-- ARKHER SYSTEM K.0254 :: Vision Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0254"
	S.key = "arkher.npc.vision.memory"
	S.name = "Vision Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.vision.mind_network" }
	S.tags = { "k", "vision", "memory", "npc" }
	S.description = "Vision Memory: episodic memory with decay, recall and consolidation for the Vision subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.vision.memory", capacity = 102, decayRate = 0.050, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
