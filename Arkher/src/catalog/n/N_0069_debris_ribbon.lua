-- ARKHER SYSTEM N.0069 :: Debris Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0069"
	S.key = "arkher.vfx.debris.ribbon_and_trail"
	S.name = "Debris Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Debris"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.debris.force_field" }
	S.tags = { "n", "debris", "ribbon", "vfx" }
	S.description = "Debris Ribbon And Trail: trail points, tapering, beams and decimation for the Debris subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.debris.ribbon_and_trail", maxPoints = 40, lifetime = 2.00, minDistance = 0.35, width = 0.50 })
		inst.system = S
		inst.ctx = ctx
