-- ARKHER SYSTEM F.0347 :: Antialiasing Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0347"
	S.key = "arkher.render.antialiasing.pass_cache"
	S.name = "Antialiasing Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Antialiasing"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.antialiasing.render_policy" }
	S.tags = { "f", "antialiasing", "cache", "render" }
	S.description = "Antialiasing Pass Cache: reuse of pass results across frames for the Antialiasing subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.antialiasing.pass_cache", policy = "lru", capacity = 492, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
