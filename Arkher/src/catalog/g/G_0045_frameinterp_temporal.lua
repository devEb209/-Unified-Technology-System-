-- ARKHER SYSTEM G.0045 :: Frame Interpolation Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0045"
	S.key = "arkher.neural.frameinterp.temporal_history"
	S.name = "Frame Interpolation Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.frameinterp.feature_extraction" }
	S.tags = { "g", "frameinterp", "temporal", "neural" }
	S.description = "Frame Interpolation Temporal History: history buffers reused across frames for the Frame Interpolation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.frameinterp.temporal_history", feedback = 0.83, phase = 8 })
		inst.system = S
		inst.ctx = ctx
