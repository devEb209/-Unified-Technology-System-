-- ARKHER SYSTEM H.0458 :: Distance Joint Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0458"
	S.key = "arkher.physics.distancejoint.simulation_policy"
	S.name = "Distance Joint Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.distancejoint.budget_governor" }
	S.tags = { "h", "distancejoint", "policy", "physics" }
	S.description = "Distance Joint Simulation Policy: device tier rules for substeps, iterations and sleep for the Distance Joint subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.distancejoint.simulation_policy", algorithm = "lottery", starvationGuard = 35 })
		inst.system = S
		inst.ctx = ctx
