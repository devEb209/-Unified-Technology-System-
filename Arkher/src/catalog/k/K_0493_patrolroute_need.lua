-- ARKHER SYSTEM K.0493 :: Patrol Route Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0493"
	S.key = "arkher.npc.patrolroute.drive_system"
	S.name = "Patrol Route Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.patrolroute.memory" }
	S.tags = { "k", "patrolroute", "need", "npc" }
	S.description = "Patrol Route Drive System: drives that decay, turn urgent and get satisfied for the Patrol Route subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.patrolroute.drive_system" })
		inst.system = S
		inst.ctx = ctx
