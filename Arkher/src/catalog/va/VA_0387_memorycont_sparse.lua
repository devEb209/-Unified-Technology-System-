-- ARKHER SYSTEM VA.0387 :: Memory Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0387"
	S.key = "arkher.contworld.memorycont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memorycont.epoch_clock" }
	S.tags = { "va", "memorycont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.memorycont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
