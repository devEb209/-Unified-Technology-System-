-- ARKHER SYSTEM F.0388 :: Sharpening Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0388"
	S.key = "arkher.render.sharpening.render_policy"
	S.name = "Sharpening Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sharpening"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sharpening.draw_budget" }
	S.tags = { "f", "sharpening", "policy", "render" }
	S.description = "Sharpening Render Policy: device tier rules for the frame for the Sharpening subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.sharpening.render_policy", algorithm = "roundrobin", starvationGuard = 40 })
		inst.system = S
		inst.ctx = ctx
