-- ARKHER SYSTEM VC.0066 :: Sparse Page Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0066"
	S.key = "arkher.contneural.sparsepage.coherence_guard"
	S.name = "Sparse Page Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.sparsepage.persistent_state" }
	S.tags = { "vc", "sparsepage", "coherence", "contneural" }
	S.description = "Sparse Page Coherence Guard: seam coherence and drift supervision for the Sparse Page subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.sparsepage.coherence_guard", window = 115, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
