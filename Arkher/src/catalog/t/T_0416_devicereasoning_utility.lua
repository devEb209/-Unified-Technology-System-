-- ARKHER SYSTEM T.0416 :: Device Reasoning Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0416"
	S.key = "arkher.ai.devicereasoning.utility_selection"
	S.name = "Device Reasoning Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.devicereasoning.working_memory" }
	S.tags = { "t", "devicereasoning", "utility", "ai" }
	S.description = "Device Reasoning Utility Selection: scored choice between competing courses of action for the Device Reasoning subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.devicereasoning.utility_selection", momentum = 0.11 })
		inst.system = S
		inst.ctx = ctx
