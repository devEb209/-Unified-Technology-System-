-- ARKHER SYSTEM Z.0850 :: Simulation Time Dilation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0850"
	S.key = "arkher.origin.timedilation.self_critique"
	S.name = "Simulation Time Dilation Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.intent_bridge" }
	S.tags = { "z", "timedilation", "critic", "origin" }
	S.description = "Simulation Time Dilation Self Critique: weighted judgement of the technology's own output for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.timedilation.self_critique", passMark = 0.72, reviseMark = 0.47, seed = 70757 })
		inst.system = S
		inst.ctx = ctx
