-- ARKHER SYSTEM P.0145 :: Crafting Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0145"
	S.key = "arkher.play.crafting.attributes"
	S.name = "Crafting Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Crafting"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "crafting", "stats", "play" }
	S.description = "Crafting Attributes: base values, layered modifiers and derived statistics for the Crafting subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.crafting.attributes" })
		inst.system = S
		inst.ctx = ctx
