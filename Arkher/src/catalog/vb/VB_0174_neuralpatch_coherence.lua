-- ARKHER SYSTEM VB.0174 :: Neural Patch Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0174"
	S.key = "arkher.conttime.neuralpatch.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.neuralpatch.persistent_state" }
	S.tags = { "vb", "neuralpatch", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.neuralpatch.coherence_guard", window = 127, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
