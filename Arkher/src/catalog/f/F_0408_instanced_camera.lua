-- ARKHER SYSTEM F.0408 :: Instanced Draw View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0408"
	S.key = "arkher.render.instanced.view_and_culling"
	S.name = "Instanced Draw View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.instanced.frame_graph" }
	S.tags = { "f", "instanced", "camera", "render" }
	S.description = "Instanced Draw View And Culling: view state, frustum culling and screen-size LOD for the Instanced Draw subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.instanced.view_and_culling", width = 1212, height = 720, fov = 1.1800, far = 2000 })
		inst.system = S
		inst.ctx = ctx
