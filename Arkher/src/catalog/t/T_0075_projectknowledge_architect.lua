-- ARKHER SYSTEM T.0075 :: Project Knowledge World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0075"
	S.key = "arkher.ai.projectknowledge.world_architect"
	S.name = "Project Knowledge World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.projectknowledge.self_critique" }
	S.tags = { "t", "projectknowledge", "architect", "ai" }
	S.description = "Project Knowledge World Architect: composition of a whole world plan with conserved budgets for the Project Knowledge subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.projectknowledge.world_architect", budget = 1100, seed = 72165 })
		inst.system = S
		inst.ctx = ctx
