-- ARKHER SYSTEM VC.0190 :: Simulation Domain Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0190"
	S.key = "arkher.contneural.simdomain.simulation_fabric"
	S.name = "Simulation Domain Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.simdomain.complexity_budget" }
	S.tags = { "vc", "simdomain", "fabric", "contneural" }
	S.description = "Simulation Domain Simulation Fabric: fabric stepping the continuum domains for the Simulation Domain subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.simdomain.simulation_fabric", budgetMs = 1.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
