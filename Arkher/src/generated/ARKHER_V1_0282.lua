...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Roblox Studio — CORE Mixer #0282", size=Vector2.new(600, 460), pos=UDim2.fromOffset(166, 194), parent=parent, icon="☀"})
