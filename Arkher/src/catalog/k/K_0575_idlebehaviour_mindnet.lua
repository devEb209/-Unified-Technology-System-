-- ARKHER SYSTEM K.0575 :: Idle Behaviour Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0575"
	S.key = "arkher.npc.idlebehaviour.mind_network"
	S.name = "Idle Behaviour Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "idlebehaviour", "mindnet", "npc" }
	S.description = "Idle Behaviour Mind Network: the learned policy that turns perception into a decision for the Idle Behaviour subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.idlebehaviour.mind_network", inputs = 6, hidden = 4, seed = 92160, learningRate = 0.050, exploration = 0.020 })
		inst.system = S
		inst.ctx = ctx
