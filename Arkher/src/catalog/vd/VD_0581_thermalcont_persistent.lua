-- ARKHER SYSTEM VD.0581 :: Thermal Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0581"
	S.key = "arkher.contsim.thermalcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.thermalcont.multi-scale_fidelity" }
	S.tags = { "vd", "thermalcont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.thermalcont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
