-- ARKHER SYSTEM L.0119 :: Settlement Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0119"
	S.key = "arkher.sim.settlement.forecast"
	S.name = "Settlement Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.settlement.analysis" }
	S.tags = { "l", "settlement", "predictor", "sim" }
	S.description = "Settlement Forecast: prediction of the region's next state for the Settlement subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.settlement.forecast", method = "linear", alpha = 0.46, window = 36 })
		inst.system = S
		inst.ctx = ctx
