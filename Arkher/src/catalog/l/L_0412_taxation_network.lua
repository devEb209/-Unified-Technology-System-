-- ARKHER SYSTEM L.0412 :: Taxation Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0412"
	S.key = "arkher.sim.taxation.route_network"
	S.name = "Taxation Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.taxation.region_graph" }
	S.tags = { "l", "taxation", "network", "sim" }
	S.description = "Taxation Route Network: roads, rivers and routes between settlements for the Taxation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.taxation.route_network" })
		inst.system = S
		inst.ctx = ctx
