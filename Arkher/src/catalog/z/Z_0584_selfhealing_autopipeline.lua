-- ARKHER SYSTEM Z.0584 :: Self Healing Systems Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0584"
	S.key = "arkher.origin.selfhealing.autonomous_pipeline"
	S.name = "Self Healing Systems Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfhealing.simulation_fabric" }
	S.tags = { "z", "selfhealing", "autopipeline", "origin" }
	S.description = "Self Healing Systems Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.selfhealing.autonomous_pipeline", maxIterations = 7 })
		inst.system = S
		inst.ctx = ctx
