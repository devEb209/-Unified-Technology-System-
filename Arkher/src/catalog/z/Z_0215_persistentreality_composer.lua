-- ARKHER SYSTEM Z.0215 :: Persistent Reality State Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0215"
	S.key = "arkher.origin.persistentreality.signal_composition"
	S.name = "Persistent Reality State Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.telemetry_ledger" }
	S.tags = { "z", "persistentreality", "composer", "origin" }
	S.description = "Persistent Reality State Signal Composition: blending of the technology's input signals into one output for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.persistentreality.signal_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
