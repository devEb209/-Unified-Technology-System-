-- ARKHER SYSTEM T.0016 :: Prompt Understanding Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0016"
	S.key = "arkher.ai.prompt.semantic_knowledge"
	S.name = "Prompt Understanding Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.prompt.intent_understanding" }
	S.tags = { "t", "prompt", "knowledge", "ai" }
	S.description = "Prompt Understanding Semantic Knowledge: typed entities, weighted relations and inferred closure for the Prompt Understanding subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.prompt.semantic_knowledge", dims = 40 })
		inst.system = S
		inst.ctx = ctx
