-- ARKHER SYSTEM L.0303 :: Resource Node Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0303"
	S.key = "arkher.sim.resourcenode.economy"
	S.name = "Resource Node Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.resourcenode.ecology" }
	S.tags = { "l", "resourcenode", "economy", "sim" }
	S.description = "Resource Node Economy: stock, production, demand, price discovery and trade for the Resource Node subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.resourcenode.economy", elasticity = 0.27 })
		inst.system = S
		inst.ctx = ctx
