-- ARKHER SYSTEM L.0534 :: Disease State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0534"
	S.key = "arkher.sim.disease.state_codec"
	S.name = "Disease State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.disease.history_ledger" }
	S.tags = { "l", "disease", "codec", "sim" }
	S.description = "Disease State Codec: persistence, diffing and checksum of the world state for the Disease subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.disease.state_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
