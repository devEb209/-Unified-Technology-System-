-- ARKHER SYSTEM VD.0017 :: Region Tile Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0017"
	S.key = "arkher.contsim.regiontile.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.regiontile.multi-scale_fidelity" }
	S.tags = { "vd", "regiontile", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.regiontile.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
