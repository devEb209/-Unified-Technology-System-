-- ARKHER SYSTEM K.0075 :: Semantic Memory Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0075"
	S.key = "arkher.npc.semanticmemory.perception"
	S.name = "Semantic Memory Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.semanticmemory.emotion" }
	S.tags = { "k", "semanticmemory", "perception", "npc" }
	S.description = "Semantic Memory Perception: sight, hearing and bounded attention for the Semantic Memory subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.semanticmemory.perception", sightRange = 30, hearingRange = 32, attentionSlots = 4, fov = 1.930 })
		inst.system = S
		inst.ctx = ctx
