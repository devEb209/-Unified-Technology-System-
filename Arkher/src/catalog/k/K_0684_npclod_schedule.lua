-- ARKHER SYSTEM K.0684 :: NPC LOD Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0684"
	S.key = "arkher.npc.npclod.daily_schedule"
	S.name = "NPC LOD Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npclod.social_relations" }
	S.tags = { "k", "npclod", "schedule", "npc" }
	S.description = "NPC LOD Daily Schedule: hour-by-hour routine with priority interruptions for the NPC LOD subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.npclod.daily_schedule", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
