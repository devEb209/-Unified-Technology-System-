-- ARKHER SYSTEM VD.0263 :: Road Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0263"
	S.key = "arkher.contsim.roadcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.roadcont.simulation_fabric" }
	S.tags = { "vd", "roadcont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.roadcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
