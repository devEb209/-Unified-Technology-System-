-- ARKHER SYSTEM R.0089 :: Property Replication Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0089"
	S.key = "arkher.net.propertyreplication.bandwidth_budget"
	S.name = "Property Replication Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.propertyreplication.transport_graph" }
	S.tags = { "r", "propertyreplication", "budgeter", "net" }
	S.description = "Property Replication Bandwidth Budget: bytes per second shared between competing streams for the Property Replication subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.propertyreplication.bandwidth_budget", total = 203, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
