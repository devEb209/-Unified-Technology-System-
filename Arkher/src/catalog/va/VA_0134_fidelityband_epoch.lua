-- ARKHER SYSTEM VA.0134 :: Fidelity Band Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0134"
	S.key = "arkher.contworld.fidelityband.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.fidelityband.infinite_grid" }
	S.tags = { "va", "fidelityband", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.fidelityband.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
