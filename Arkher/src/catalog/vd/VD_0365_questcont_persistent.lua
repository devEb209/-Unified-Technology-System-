-- ARKHER SYSTEM VD.0365 :: Quest Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0365"
	S.key = "arkher.contsim.questcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.questcont.multi-scale_fidelity" }
	S.tags = { "vd", "questcont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.questcont.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
