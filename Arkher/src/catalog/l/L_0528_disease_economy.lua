-- ARKHER SYSTEM L.0528 :: Disease Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0528"
	S.key = "arkher.sim.disease.economy"
	S.name = "Disease Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.disease.ecology" }
	S.tags = { "l", "disease", "economy", "sim" }
	S.description = "Disease Economy: stock, production, demand, price discovery and trade for the Disease subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.disease.economy", elasticity = 0.24 })
		inst.system = S
		inst.ctx = ctx
