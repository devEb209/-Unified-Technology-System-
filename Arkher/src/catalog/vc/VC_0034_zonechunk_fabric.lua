-- ARKHER SYSTEM VC.0034 :: Zone Chunk Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0034"
	S.key = "arkher.contneural.zonechunk.simulation_fabric"
	S.name = "Zone Chunk Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.zonechunk.complexity_budget" }
	S.tags = { "vc", "zonechunk", "fabric", "contneural" }
	S.description = "Zone Chunk Simulation Fabric: fabric stepping the continuum domains for the Zone Chunk subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.zonechunk.simulation_fabric", budgetMs = 3.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
