-- ARKHER SYSTEM L.0374 :: Trade Route Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0374"
	S.key = "arkher.sim.traderoute.forecast"
	S.name = "Trade Route Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.traderoute.analysis" }
	S.tags = { "l", "traderoute", "predictor", "sim" }
	S.description = "Trade Route Forecast: prediction of the region's next state for the Trade Route subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.traderoute.forecast", method = "ema", alpha = 0.10, window = 32 })
		inst.system = S
		inst.ctx = ctx
