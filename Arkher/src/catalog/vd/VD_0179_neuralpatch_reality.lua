-- ARKHER SYSTEM VD.0179 :: Neural Patch Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0179"
	S.key = "arkher.contsim.neuralpatch.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.neuralpatch.simulation_fabric" }
	S.tags = { "vd", "neuralpatch", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.neuralpatch.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
