-- ARKHER SYSTEM VC.0251 :: Vegetation Field Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0251"
	S.key = "arkher.contneural.vegfield.reality_continuum"
	S.name = "Vegetation Field Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vegfield.simulation_fabric" }
	S.tags = { "vc", "vegfield", "reality", "contneural" }
	S.description = "Vegetation Field Reality Continuum: stacked reality layers of the continuum for the Vegetation Field subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.vegfield.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
