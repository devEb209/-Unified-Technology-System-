-- ARKHER SYSTEM L.0469 :: Faction Politics Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0469"
	S.key = "arkher.sim.factionpolitics.society"
	S.name = "Faction Politics Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.factionpolitics.economy" }
	S.tags = { "l", "factionpolitics", "society", "sim" }
	S.description = "Faction Politics Society: relations, factions, reputation and cohesion of the region for the Faction Politics subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.factionpolitics.society", decayRate = 0.014, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
