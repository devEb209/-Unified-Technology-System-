-- ARKHER SYSTEM T.0403 :: Performance Reasoning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0403"
	S.key = "arkher.ai.performancereasoning.action_planner"
	S.name = "Performance Reasoning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.performancereasoning.utility_selection" }
	S.tags = { "t", "performancereasoning", "planner", "ai" }
	S.description = "Performance Reasoning Action Planner: goal-oriented action planning over preconditions for the Performance Reasoning subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.performancereasoning.action_planner", maxDepth = 8 })
		inst.system = S
		inst.ctx = ctx
