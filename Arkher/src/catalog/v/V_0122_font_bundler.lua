-- ARKHER SYSTEM V.0122 :: Font Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0122"
	S.key = "arkher.asset.font.bundling"
	S.name = "Font Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.font.import" }
	S.tags = { "v", "font", "bundler", "asset" }
	S.description = "Font Bundling: size-bounded packing, manifests and delta patches for the Font subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.font.bundling", maxBundleBytes = 262144 })
		inst.system = S
		inst.ctx = ctx
