-- ARKHER SYSTEM G.0249 :: Behaviour Prediction Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0249"
	S.key = "arkher.neural.behaviorpredict.error_analysis"
	S.name = "Behaviour Prediction Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.behaviorpredict.heuristic_policy" }
	S.tags = { "g", "behaviorpredict", "analyzer", "neural" }
	S.description = "Behaviour Prediction Error Analysis: residual and drift analysis for the Behaviour Prediction subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.behaviorpredict.error_analysis", window = 151, buckets = 15, threshold = 3.30 })
		inst.system = S
		inst.ctx = ctx
