-- ARKHER SYSTEM V.0013 :: Skeletal Mesh Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0013"
	S.key = "arkher.asset.skeletalmesh.import"
	S.name = "Skeletal Mesh Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "skeletalmesh", "importer", "asset" }
	S.description = "Skeletal Mesh Import: validation, normalization, hashing and deduplication of incoming content for the Skeletal Mesh subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.skeletalmesh.import", unitScale = 1.00 })
		inst.system = S
		inst.ctx = ctx
