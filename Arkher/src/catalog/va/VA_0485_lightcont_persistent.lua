-- ARKHER SYSTEM VA.0485 :: Lighting Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0485"
	S.key = "arkher.contworld.lightcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lightcont.multi-scale_fidelity" }
	S.tags = { "va", "lightcont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.lightcont.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
