-- ARKHER SYSTEM Z.0863 :: Multi Scale Simulation Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0863"
	S.key = "arkher.origin.multiscale.simulation_fabric"
	S.name = "Multi Scale Simulation Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.complexity_governance" }
	S.tags = { "z", "multiscale", "fabric", "origin" }
	S.description = "Multi Scale Simulation Simulation Fabric: every simulation domain stepped under one budgeted clock for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.multiscale.simulation_fabric", budgetMs = 2.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
