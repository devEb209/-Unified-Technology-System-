-- ARKHER SYSTEM V.0346 :: Patch Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0346"
	S.key = "arkher.asset.patch.validation_guard"
	S.name = "Patch Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.patch.size_budget" }
	S.tags = { "v", "patch", "guard", "asset" }
	S.description = "Patch Validation Guard: rate limiting and capability checks on the import path for the Patch subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.patch.validation_guard", algorithm = "sliding", capacity = 215, refillPerSec = 60, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
