-- ARKHER SYSTEM V.0162 :: Particle Asset Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0162"
	S.key = "arkher.asset.particleasset.content_cache"
	S.name = "Particle Asset Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.particleasset.dependency_graph" }
	S.tags = { "v", "particleasset", "cache", "asset" }
	S.description = "Particle Asset Content Cache: reuse of already cooked results for the Particle Asset subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.particleasset.content_cache", policy = "lfu", capacity = 292, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
