-- ARKHER SYSTEM O.0305 :: Notification Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0305"
	S.key = "arkher.audio.notification.voice_budget"
	S.name = "Notification Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Notification"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.notification.music_sequencer" }
	S.tags = { "o", "notification", "budgeter", "audio" }
	S.description = "Notification Voice Budget: voice slots allocated by priority and audibility for the Notification subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.notification.voice_budget", total = 444, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
