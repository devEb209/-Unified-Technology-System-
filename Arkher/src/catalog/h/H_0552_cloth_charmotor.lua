-- ARKHER SYSTEM H.0552 :: Cloth Simulation Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0552"
	S.key = "arkher.physics.cloth.character_motion"
	S.name = "Cloth Simulation Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.cloth.query" }
	S.tags = { "h", "cloth", "charmotor", "physics" }
	S.description = "Cloth Simulation Character Motion: capsule move-and-slide with slopes, steps and jumps for the Cloth Simulation subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.cloth.character_motion", radius = 0.37, height = 1.62, maxSpeed = 4.20, jumpHeight = 1.40, stepOffset = 0.27 })
		inst.system = S
		inst.ctx = ctx
