-- ARKHER SYSTEM W.0138 :: Over The Shoulder Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0138"
	S.key = "arkher.cine.overshoulder.playback_orchestrator"
	S.name = "Over The Shoulder Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.overshoulder.cut_policy" }
	S.tags = { "w", "overshoulder", "orchestrator", "cine" }
	S.description = "Over The Shoulder Playback Orchestrator: the state machine that drives a cinematic from start to end for the Over The Shoulder subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.overshoulder.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
