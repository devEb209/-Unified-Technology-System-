-- ARKHER SYSTEM T.0625 :: Explainability Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0625"
	S.key = "arkher.ai.explainability.working_memory"
	S.name = "Explainability Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.explainability.outcome_prediction" }
	S.tags = { "t", "explainability", "memory", "ai" }
	S.description = "Explainability Working Memory: decaying, consolidating recall of what the agent learned for the Explainability subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.explainability.working_memory", capacity = 49, decayRate = 0.055, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
