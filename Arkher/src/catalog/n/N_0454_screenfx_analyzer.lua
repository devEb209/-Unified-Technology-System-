-- ARKHER SYSTEM N.0454 :: Screen Effect Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0454"
	S.key = "arkher.vfx.screenfx.analysis"
	S.name = "Screen Effect Analysis"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.screenfx.spatial_index" }
	S.tags = { "n", "screenfx", "analyzer", "vfx" }
	S.description = "Screen Effect Analysis: cost, overdraw and stability analysis of the effect for the Screen Effect subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.screenfx.analysis", window = 157, buckets = 13, threshold = 4.90 })
		inst.system = S
		inst.ctx = ctx
