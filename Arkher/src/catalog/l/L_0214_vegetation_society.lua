-- ARKHER SYSTEM L.0214 :: Vegetation Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0214"
	S.key = "arkher.sim.vegetation.society"
	S.name = "Vegetation Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.vegetation.economy" }
	S.tags = { "l", "vegetation", "society", "sim" }
	S.description = "Vegetation Society: relations, factions, reputation and cohesion of the region for the Vegetation subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.vegetation.society", decayRate = 0.006, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
