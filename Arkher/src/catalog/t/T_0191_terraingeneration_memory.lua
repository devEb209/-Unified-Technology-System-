-- ARKHER SYSTEM T.0191 :: Terrain Generation Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0191"
	S.key = "arkher.ai.terraingeneration.working_memory"
	S.name = "Terrain Generation Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.terraingeneration.outcome_prediction" }
	S.tags = { "t", "terraingeneration", "memory", "ai" }
	S.description = "Terrain Generation Working Memory: decaying, consolidating recall of what the agent learned for the Terrain Generation subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.terraingeneration.working_memory", capacity = 59, decayRate = 0.065, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
