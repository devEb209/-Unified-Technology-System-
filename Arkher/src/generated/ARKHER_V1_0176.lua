--!strict
-- Source2 Hammer — CORE Node_Flow #0176
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Source2 Hammer — CORE Node_Flow #0176", size=Vector2.new(680, 440), pos=UDim2.fromOffset(388, 212), parent=parent, icon="◈"})
