-- ARKHER SYSTEM G.0354 :: Batch Inference Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0354"
	S.key = "arkher.neural.batchinference.reconstruction"
	S.name = "Batch Inference Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.batchinference.temporal_history" }
	S.tags = { "g", "batchinference", "upscaler", "neural" }
	S.description = "Batch Inference Reconstruction: resolution ladder and image reconstruction for the Batch Inference subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.batchinference.reconstruction", targetMs = 13.10, index = 5, sharpness = 0.56 })
		inst.system = S
		inst.ctx = ctx
