-- ARKHER SYSTEM VD.0152 :: Persistence Segment World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0152"
	S.key = "arkher.contsim.persistsegment.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.persistsegment.neural_field" }
	S.tags = { "vd", "persistsegment", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.persistsegment.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
