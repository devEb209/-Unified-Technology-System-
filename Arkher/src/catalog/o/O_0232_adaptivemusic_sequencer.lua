-- ARKHER SYSTEM O.0232 :: Adaptive Music Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0232"
	S.key = "arkher.audio.adaptivemusic.music_sequencer"
	S.name = "Adaptive Music Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.adaptivemusic.spatialization" }
	S.tags = { "o", "adaptivemusic", "sequencer", "audio" }
	S.description = "Adaptive Music Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Adaptive Music subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.adaptivemusic.music_sequencer", bpm = 130, beatsPerBar = 4, intensity = 0.58 })
		inst.system = S
		inst.ctx = ctx
