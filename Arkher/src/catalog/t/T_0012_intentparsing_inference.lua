-- ARKHER SYSTEM T.0012 :: Intent Parsing Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0012"
	S.key = "arkher.ai.intentparsing.model_inference"
	S.name = "Intent Parsing Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.intentparsing.action_planner" }
	S.tags = { "t", "intentparsing", "inference", "ai" }
	S.description = "Intent Parsing Model Inference: quantized inference with batching and budget for the Intent Parsing subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.intentparsing.model_inference", seed = 87939 })
		inst.system = S
		inst.ctx = ctx
