-- ARKHER SYSTEM L.0574 :: World History Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0574"
	S.key = "arkher.sim.worldhistory.society"
	S.name = "World History Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldhistory.economy" }
	S.tags = { "l", "worldhistory", "society", "sim" }
	S.description = "World History Society: relations, factions, reputation and cohesion of the region for the World History subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.worldhistory.society", decayRate = 0.014, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
