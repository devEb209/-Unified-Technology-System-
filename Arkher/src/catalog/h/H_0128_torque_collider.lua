-- ARKHER SYSTEM H.0128 :: Torque Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0128"
	S.key = "arkher.physics.torque.collision_shape"
	S.name = "Torque Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Torque"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.torque.body_dynamics" }
	S.tags = { "h", "torque", "collider", "physics" }
	S.description = "Torque Collision Shape: shape bounds, support mapping and closest points for the Torque subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.torque.collision_shape", shape = "capsule", radius = 2.10, height = 1.70, layer = "world" })
		inst.system = S
		inst.ctx = ctx
