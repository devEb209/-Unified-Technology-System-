-- ARKHER SYSTEM E.0196 :: Sheen Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0196"
	S.key = "arkher.material.sheen.definition"
	S.name = "Sheen Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Sheen"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "sheen", "material", "material" }
	S.description = "Sheen Definition: layered PBR definition resolved into parameters for the Sheen subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.sheen.definition", texelBudget = 1310720 })
		inst.system = S
		inst.ctx = ctx
