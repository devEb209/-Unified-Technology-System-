-- ARKHER SYSTEM O.0130 :: Wind Audio Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0130"
	S.key = "arkher.audio.windaudio.analysis"
	S.name = "Wind Audio Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Wind Audio"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.windaudio.playback_policy" }
	S.tags = { "o", "windaudio", "analyzer", "audio" }
	S.description = "Wind Audio Analysis: loudness, headroom and masking analysis for the Wind Audio subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.windaudio.analysis", window = 100, buckets = 16, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
