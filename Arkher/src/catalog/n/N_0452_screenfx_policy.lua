-- ARKHER SYSTEM N.0452 :: Screen Effect Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0452"
	S.key = "arkher.vfx.screenfx.quality_policy"
	S.name = "Screen Effect Quality Policy"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.screenfx.result_cache" }
	S.tags = { "n", "screenfx", "policy", "vfx" }
	S.description = "Screen Effect Quality Policy: distance and device driven fidelity bands for the Screen Effect subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.screenfx.quality_policy", algorithm = "wfq", starvationGuard = 42 })
		inst.system = S
		inst.ctx = ctx
