-- ARKHER SYSTEM VD.0330 :: Economy Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0330"
	S.key = "arkher.contsim.economycont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.economycont.persistent_state" }
	S.tags = { "vd", "economycont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.economycont.coherence_guard", window = 142, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
