-- ARKHER SYSTEM VC.0395 :: Memory Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0395"
	S.key = "arkher.contneural.memorycont.reality_continuum"
	S.name = "Memory Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memorycont.simulation_fabric" }
	S.tags = { "vc", "memorycont", "reality", "contneural" }
	S.description = "Memory Continuum Reality Continuum: stacked reality layers of the continuum for the Memory Continuum subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.memorycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
