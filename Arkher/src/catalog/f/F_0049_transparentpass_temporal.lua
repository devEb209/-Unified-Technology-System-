-- ARKHER SYSTEM F.0049 :: Transparent Pass Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0049"
	S.key = "arkher.render.transparentpass.temporal_resolve"
	S.name = "Transparent Pass Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.transparentpass.probe_volume" }
	S.tags = { "f", "transparentpass", "temporal", "render" }
	S.description = "Transparent Pass Temporal Resolve: history reprojection with neighbourhood clamping for the Transparent Pass subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.transparentpass.temporal_resolve", feedback = 0.83, phase = 8 })
		inst.system = S
		inst.ctx = ctx
