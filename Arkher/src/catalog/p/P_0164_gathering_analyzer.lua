-- ARKHER SYSTEM P.0164 :: Gathering Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0164"
	S.key = "arkher.play.gathering.balance_analysis"
	S.name = "Gathering Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Gathering"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.gathering.event_ledger" }
	S.tags = { "p", "gathering", "analyzer", "play" }
	S.description = "Gathering Balance Analysis: distribution, outlier and pacing analysis for the Gathering subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.gathering.balance_analysis", window = 209, buckets = 17, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
