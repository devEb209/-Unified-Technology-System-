-- ARKHER SYSTEM T.0483 :: Simulation Reasoning Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0483"
	S.key = "arkher.ai.simulationreasoning.decision_policy"
	S.name = "Simulation Reasoning Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.simulationreasoning.reasoning_graph" }
	S.tags = { "t", "simulationreasoning", "policy", "ai" }
	S.description = "Simulation Reasoning Decision Policy: ordered rules deciding what the agent does next for the Simulation Reasoning subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.simulationreasoning.decision_policy", algorithm = "wfq", starvationGuard = 54 })
		inst.system = S
		inst.ctx = ctx
