-- ARKHER SYSTEM F.0090 :: Contact Shadows Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0090"
	S.key = "arkher.render.contact.probe_volume"
	S.name = "Contact Shadows Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.contact.lighting_rig" }
	S.tags = { "f", "contact", "probe", "render" }
	S.description = "Contact Shadows Probe Volume: irradiance probes encoded in spherical harmonics for the Contact Shadows subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.contact.probe_volume", spacing = 40 })
		inst.system = S
		inst.ctx = ctx
