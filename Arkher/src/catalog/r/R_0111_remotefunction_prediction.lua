-- ARKHER SYSTEM R.0111 :: Remote Function Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0111"
	S.key = "arkher.net.remotefunction.prediction_and_reconciliation"
	S.name = "Remote Function Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remotefunction.time_sync" }
	S.tags = { "r", "remotefunction", "prediction", "net" }
	S.description = "Remote Function Prediction And Reconciliation: client simulation, correction and input replay for the Remote Function subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.remotefunction.prediction_and_reconciliation", errorThreshold = 0.035, smoothing = 9.0, maxInputs = 160 })
		inst.system = S
		inst.ctx = ctx
