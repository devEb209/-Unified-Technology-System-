-- ARKHER SYSTEM I.0272 :: Foot Placement IK Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0272"
	S.key = "arkher.anim.footik.analysis"
	S.name = "Foot Placement IK Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.footik.quality_policy" }
	S.tags = { "i", "footik", "analyzer", "anim" }
	S.description = "Foot Placement IK Analysis: pop, drift and cost analysis of playback for the Foot Placement IK subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.footik.analysis", window = 117, buckets = 9, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
