-- ARKHER SYSTEM H.0201 :: Substepping Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0201"
	S.key = "arkher.physics.substepping.query"
	S.name = "Substepping Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Substepping"
	S.aspect = "Query"
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.substepping.constraint_solver" }
	S.tags = { "h", "substepping", "raycaster", "physics" }
	S.description = "Substepping Query: rays, sweeps and overlaps against the simulation for the Substepping subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.substepping.query", cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
