-- ARKHER SYSTEM K.0544 :: Dialogue Behaviour Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0544"
	S.key = "arkher.npc.dialoguebehaviour.daily_schedule"
	S.name = "Dialogue Behaviour Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dialoguebehaviour.social_relations" }
	S.tags = { "k", "dialoguebehaviour", "schedule", "npc" }
	S.description = "Dialogue Behaviour Daily Schedule: hour-by-hour routine with priority interruptions for the Dialogue Behaviour subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.dialoguebehaviour.daily_schedule", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
