-- ARKHER SYSTEM R.0347 :: Reconnection Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0347"
	S.key = "arkher.net.reconnection.latency_analysis"
	S.name = "Reconnection Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Reconnection"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reconnection.audit_ledger" }
	S.tags = { "r", "reconnection", "analyzer", "net" }
	S.description = "Reconnection Latency Analysis: round trip, jitter and loss analysis for the Reconnection subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.reconnection.latency_analysis", window = 230, buckets = 14, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
