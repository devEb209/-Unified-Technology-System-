-- ARKHER SYSTEM VB.0440 :: Physics Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0440"
	S.key = "arkher.conttime.physicscont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.physicscont.neural_field" }
	S.tags = { "vb", "physicscont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.physicscont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
