-- ARKHER SYSTEM N.0205 :: Cloud Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0205"
	S.key = "arkher.vfx.cloud.quality_policy"
	S.name = "Cloud Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloud"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.cloud.result_cache" }
	S.tags = { "n", "cloud", "policy", "vfx" }
	S.description = "Cloud Quality Policy: distance and device driven fidelity bands for the Cloud subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.cloud.quality_policy", algorithm = "wfq", starvationGuard = 58 })
		inst.system = S
		inst.ctx = ctx
