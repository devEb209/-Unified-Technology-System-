-- ARKHER SYSTEM I.0159 :: Additive Layer Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0159"
	S.key = "arkher.anim.additivelayer.layered_blending"
	S.name = "Additive Layer Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.additivelayer.clip_sampling" }
	S.tags = { "i", "additivelayer", "animator", "anim" }
	S.description = "Additive Layer Layered Blending: layers, crossfades, masks and blend trees for the Additive Layer subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.additivelayer.layered_blending", budget = 8 })
		inst.system = S
		inst.ctx = ctx
