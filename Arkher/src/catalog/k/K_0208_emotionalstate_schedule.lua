-- ARKHER SYSTEM K.0208 :: Emotional State Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0208"
	S.key = "arkher.npc.emotionalstate.daily_schedule"
	S.name = "Emotional State Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.emotionalstate.social_relations" }
	S.tags = { "k", "emotionalstate", "schedule", "npc" }
	S.description = "Emotional State Daily Schedule: hour-by-hour routine with priority interruptions for the Emotional State subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.emotionalstate.daily_schedule", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
