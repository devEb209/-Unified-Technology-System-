-- ARKHER SYSTEM VA.0404 :: Perception Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0404"
	S.key = "arkher.contworld.perceptioncont.world_memory_stream"
	S.name = "Perception Continuum World Memory Stream"
	S.category = "VA"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.perceptioncont.neural_field" }
	S.tags = { "va", "perceptioncont", "worldmemory", "contworld" }
	S.description = "Perception Continuum World Memory Stream: world memory continuum over epochs for the Perception Continuum subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.perceptioncont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
