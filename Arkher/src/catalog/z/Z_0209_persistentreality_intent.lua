-- ARKHER SYSTEM Z.0209 :: Persistent Reality State Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0209"
	S.key = "arkher.origin.persistentreality.intent_bridge"
	S.name = "Persistent Reality State Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.semantic_graph" }
	S.tags = { "z", "persistentreality", "intent", "origin" }
	S.description = "Persistent Reality State Intent Bridge: natural language control surface for the technology for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.persistentreality.intent_bridge", minConfidence = 0.30 })
		inst.system = S
		inst.ctx = ctx
