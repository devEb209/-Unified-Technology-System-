-- ARKHER SYSTEM K.0102 :: Memory Consolidation Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0102"
	S.key = "arkher.npc.consolidation.emotion"
	S.name = "Memory Consolidation Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.consolidation.drive_system" }
	S.tags = { "k", "consolidation", "emotion", "npc" }
	S.description = "Memory Consolidation Emotion: appraisal of events into valence, arousal and mood for the Memory Consolidation subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.consolidation.emotion", inertia = 0.93, decayRate = 0.28, baselineArousal = 0.28 })
		inst.system = S
		inst.ctx = ctx
