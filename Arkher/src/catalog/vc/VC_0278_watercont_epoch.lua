-- ARKHER SYSTEM VC.0278 :: Water Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0278"
	S.key = "arkher.contneural.watercont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.watercont.infinite_grid" }
	S.tags = { "vc", "watercont", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.watercont.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
