-- ARKHER SYSTEM VA.0571 :: Mobile Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0571"
	S.key = "arkher.contworld.mobilecont.neural_field"
	S.name = "Mobile Continuum Neural Field"
	S.category = "VA"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.mobilecont.coherence_guard" }
	S.tags = { "va", "mobilecont", "neuralfield", "contworld" }
	S.description = "Mobile Continuum Neural Field: neural field encoding and reconstruction for the Mobile Continuum subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.mobilecont.neural_field", dims = 20, hidden = 16, seed = 1518 })
		inst.system = S
		inst.ctx = ctx
