-- ARKHER SYSTEM I.0202 :: State Machine Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0202"
	S.key = "arkher.anim.animstate.compression_codec"
	S.name = "State Machine Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstate.retarget_graph" }
	S.tags = { "i", "animstate", "codec", "anim" }
	S.description = "State Machine Compression Codec: curve compression and quantized transport for the State Machine subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.animstate.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
