-- ARKHER SYSTEM VD.0020 :: Region Tile World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0020"
	S.key = "arkher.contsim.regiontile.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.regiontile.neural_field" }
	S.tags = { "vd", "regiontile", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.regiontile.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
