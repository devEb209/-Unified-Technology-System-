-- ARKHER SYSTEM VC.0375 :: Dialogue Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0375"
	S.key = "arkher.contneural.dialoguecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.dialoguecont.epoch_clock" }
	S.tags = { "vc", "dialoguecont", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.dialoguecont.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
