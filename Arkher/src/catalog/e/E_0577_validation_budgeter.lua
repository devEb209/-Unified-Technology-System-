-- ARKHER SYSTEM E.0577 :: Material Validation Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0577"
	S.key = "arkher.material.validation.parameter_budget"
	S.name = "Material Validation Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.validation.variant_registry" }
	S.tags = { "e", "validation", "budgeter", "material" }
	S.description = "Material Validation Parameter Budget: texel and layer budget allocation for the Material Validation subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.validation.parameter_budget", total = 182, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
