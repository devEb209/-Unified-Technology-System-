-- ARKHER SYSTEM VA.0270 :: Bridge Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0270"
	S.key = "arkher.contworld.bridgecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.bridgecont.persistent_state" }
	S.tags = { "va", "bridgecont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.bridgecont.coherence_guard", window = 107, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
