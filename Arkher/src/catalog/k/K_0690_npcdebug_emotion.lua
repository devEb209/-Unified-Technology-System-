-- ARKHER SYSTEM K.0690 :: NPC Debug Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0690"
	S.key = "arkher.npc.npcdebug.emotion"
	S.name = "NPC Debug Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcdebug.drive_system" }
	S.tags = { "k", "npcdebug", "emotion", "npc" }
	S.description = "NPC Debug Emotion: appraisal of events into valence, arousal and mood for the NPC Debug subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.npcdebug.emotion", inertia = 0.93, decayRate = 0.38, baselineArousal = 0.28 })
		inst.system = S
		inst.ctx = ctx
