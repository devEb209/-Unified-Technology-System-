-- ARKHER SYSTEM K.0104 :: Memory Consolidation Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0104"
	S.key = "arkher.npc.consolidation.reactive_behaviour"
	S.name = "Memory Consolidation Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.consolidation.perception" }
	S.tags = { "k", "consolidation", "behaviortree", "npc" }
	S.description = "Memory Consolidation Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Memory Consolidation subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.consolidation.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
