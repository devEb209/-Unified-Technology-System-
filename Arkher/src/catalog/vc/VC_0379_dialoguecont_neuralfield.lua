-- ARKHER SYSTEM VC.0379 :: Dialogue Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0379"
	S.key = "arkher.contneural.dialoguecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.dialoguecont.coherence_guard" }
	S.tags = { "vc", "dialoguecont", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.dialoguecont.neural_field", dims = 16, hidden = 12, seed = 48773 })
		inst.system = S
		inst.ctx = ctx
