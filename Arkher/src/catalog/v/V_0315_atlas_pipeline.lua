-- ARKHER SYSTEM V.0315 :: Texture Atlas Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0315"
	S.key = "arkher.asset.atlas.cook_pipeline"
	S.name = "Texture Atlas Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.atlas.bundling" }
	S.tags = { "v", "atlas", "pipeline", "asset" }
	S.description = "Texture Atlas Cook Pipeline: staged cooking with isolation and retries for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.atlas.cook_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
