-- ARKHER SYSTEM VB.0571 :: Mobile Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0571"
	S.key = "arkher.conttime.mobilecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.mobilecont.coherence_guard" }
	S.tags = { "vb", "mobilecont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.mobilecont.neural_field", dims = 24, hidden = 20, seed = 73767 })
		inst.system = S
		inst.ctx = ctx
