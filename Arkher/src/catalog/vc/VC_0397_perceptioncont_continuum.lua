-- ARKHER SYSTEM VC.0397 :: Perception Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0397"
	S.key = "arkher.contneural.perceptioncont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "perceptioncont", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.perceptioncont.infinite_grid", cellSize = 96, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
