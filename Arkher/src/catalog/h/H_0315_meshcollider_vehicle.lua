-- ARKHER SYSTEM H.0315 :: Mesh Collider Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0315"
	S.key = "arkher.physics.meshcollider.vehicle"
	S.name = "Mesh Collider Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.meshcollider.character_motion" }
	S.tags = { "h", "meshcollider", "vehicle", "physics" }
	S.description = "Mesh Collider Vehicle: suspension, drivetrain, steering and tire friction for the Mesh Collider subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.meshcollider.vehicle", mass = 1700, wheelbase = 2.20, track = 1.80, maxRpm = 5600 })
		inst.system = S
		inst.ctx = ctx
