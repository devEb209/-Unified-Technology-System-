-- ARKHER SYSTEM VB.0443 :: Physics Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0443"
	S.key = "arkher.conttime.physicscont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.physicscont.simulation_fabric" }
	S.tags = { "vb", "physicscont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.physicscont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
