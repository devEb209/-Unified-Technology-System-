-- ARKHER SYSTEM Z.0530 :: Migration Dynamics Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0530"
	S.key = "arkher.origin.migrationdynamics.self_critique"
	S.name = "Migration Dynamics Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.migrationdynamics.intent_bridge" }
	S.tags = { "z", "migrationdynamics", "critic", "origin" }
	S.description = "Migration Dynamics Self Critique: weighted judgement of the technology's own output for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.migrationdynamics.self_critique", passMark = 0.77, reviseMark = 0.47, seed = 71347 })
		inst.system = S
		inst.ctx = ctx
