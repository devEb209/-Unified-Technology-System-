-- ARKHER SYSTEM VC.0405 :: Perception Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0405"
	S.key = "arkher.contneural.perceptioncont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.perceptioncont.world_memory_stream" }
	S.tags = { "vc", "perceptioncont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.perceptioncont.complexity_budget", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
