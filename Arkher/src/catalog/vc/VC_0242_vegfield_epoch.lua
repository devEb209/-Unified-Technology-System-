-- ARKHER SYSTEM VC.0242 :: Vegetation Field Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0242"
	S.key = "arkher.contneural.vegfield.epoch_clock"
	S.name = "Vegetation Field Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vegfield.infinite_grid" }
	S.tags = { "vc", "vegfield", "epoch", "contneural" }
	S.description = "Vegetation Field Epoch Clock: deterministic epoch timeline with catch-up for the Vegetation Field subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.vegfield.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
