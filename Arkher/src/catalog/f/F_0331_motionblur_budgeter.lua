-- ARKHER SYSTEM F.0331 :: Motion Blur Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0331"
	S.key = "arkher.render.motionblur.draw_budget"
	S.name = "Motion Blur Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Motion Blur"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.motionblur.adaptive_resolution" }
	S.tags = { "f", "motionblur", "budgeter", "render" }
	S.description = "Motion Blur Draw Budget: draw call and triangle budget allocation for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.motionblur.draw_budget", total = 254, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
