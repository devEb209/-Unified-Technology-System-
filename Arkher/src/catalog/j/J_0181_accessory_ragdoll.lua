-- ARKHER SYSTEM J.0181 :: Accessory Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0181"
	S.key = "arkher.character.accessory.physical_response"
	S.name = "Accessory Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.accessory.look_and_reach" }
	S.tags = { "j", "accessory", "ragdoll", "character" }
	S.description = "Accessory Physical Response: physical reaction, ragdoll and recovery for the Accessory subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.accessory.physical_response", blendSpeed = 2.30 })
		inst.system = S
		inst.ctx = ctx
