-- ARKHER SYSTEM F.0311 :: Depth Of Field Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0311"
	S.key = "arkher.render.dof.visibility_set"
	S.name = "Depth Of Field Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.dof.view_and_culling" }
	S.tags = { "f", "dof", "visibility", "render" }
	S.description = "Depth Of Field Visibility Set: cell, portal and occluder visibility for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.dof.visibility_set", maxDepth = 4 })
		inst.system = S
		inst.ctx = ctx
