-- ARKHER SYSTEM T.0613 :: Safety Alignment Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0613"
	S.key = "arkher.ai.safetyalignment.action_planner"
	S.name = "Safety Alignment Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.safetyalignment.utility_selection" }
	S.tags = { "t", "safetyalignment", "planner", "ai" }
	S.description = "Safety Alignment Action Planner: goal-oriented action planning over preconditions for the Safety Alignment subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.safetyalignment.action_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
