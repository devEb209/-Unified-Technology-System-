-- ARKHER SYSTEM VD.0186 :: Simulation Domain Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0186"
	S.key = "arkher.contsim.simdomain.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.simdomain.persistent_state" }
	S.tags = { "vd", "simdomain", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.simdomain.coherence_guard", window = 53, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
