-- ARKHER SYSTEM I.0475 :: Facial Animation Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0475"
	S.key = "arkher.anim.facialanim.compression_codec"
	S.name = "Facial Animation Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.facialanim.retarget_graph" }
	S.tags = { "i", "facialanim", "codec", "anim" }
	S.description = "Facial Animation Compression Codec: curve compression and quantized transport for the Facial Animation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.facialanim.compression_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
