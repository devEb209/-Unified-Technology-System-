-- ARKHER SYSTEM VC.0606 :: Seam Lattice Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0606"
	S.key = "arkher.contneural.seamlattice.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.seamlattice.persistent_state" }
	S.tags = { "vc", "seamlattice", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.seamlattice.coherence_guard", window = 81, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
