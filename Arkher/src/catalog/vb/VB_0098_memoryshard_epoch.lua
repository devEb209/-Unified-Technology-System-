-- ARKHER SYSTEM VB.0098 :: Memory Shard Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0098"
	S.key = "arkher.conttime.memoryshard.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memoryshard.infinite_grid" }
	S.tags = { "vb", "memoryshard", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.memoryshard.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
