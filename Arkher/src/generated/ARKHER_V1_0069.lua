--!strict
-- Maya Shelf — ANIMATION Profiler #0069
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Maya Shelf — ANIMATION Profiler #0069", size=Vector2.new(600, 500), pos=UDim2.fromOffset(197, 213), parent=parent, icon="⛰"})
...
Components.TextField(right, "File", "input.png", function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_File"..69, v) end end)
