-- ARKHER SYSTEM P.0099 :: Inventory Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0099"
	S.key = "arkher.play.inventorysys.objectives"
	S.name = "Inventory Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Inventory"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.inventorysys.inventory" }
	S.tags = { "p", "inventorysys", "quest", "play" }
	S.description = "Inventory Objectives: objectives, prerequisites, progress and rewards for the Inventory subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.inventorysys.objectives" })
		inst.system = S
		inst.ctx = ctx
