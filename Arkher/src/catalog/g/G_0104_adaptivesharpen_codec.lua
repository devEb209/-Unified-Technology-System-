-- ARKHER SYSTEM G.0104 :: Adaptive Sharpening Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0104"
	S.key = "arkher.neural.adaptivesharpen.weight_codec"
	S.name = "Adaptive Sharpening Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.adaptivesharpen.model_registry" }
	S.tags = { "g", "adaptivesharpen", "codec", "neural" }
	S.description = "Adaptive Sharpening Weight Codec: weight serialization and quantized transport for the Adaptive Sharpening subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.adaptivesharpen.weight_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
