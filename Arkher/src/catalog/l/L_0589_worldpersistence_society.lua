-- ARKHER SYSTEM L.0589 :: World Persistence Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0589"
	S.key = "arkher.sim.worldpersistence.society"
	S.name = "World Persistence Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldpersistence.economy" }
	S.tags = { "l", "worldpersistence", "society", "sim" }
	S.description = "World Persistence Society: relations, factions, reputation and cohesion of the region for the World Persistence subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.worldpersistence.society", decayRate = 0.008, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
