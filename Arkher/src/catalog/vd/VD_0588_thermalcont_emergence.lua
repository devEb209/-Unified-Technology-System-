-- ARKHER SYSTEM VD.0588 :: Thermal Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0588"
	S.key = "arkher.contsim.thermalcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.thermalcont.reality_continuum" }
	S.tags = { "vd", "thermalcont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.thermalcont.emergence_continuum", windowSize = 5, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
