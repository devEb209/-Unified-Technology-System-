-- ARKHER SYSTEM L.0582 :: World History Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0582"
	S.key = "arkher.sim.worldhistory.aggregate_cache"
	S.name = "World History Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldhistory.fidelity_policy" }
	S.tags = { "l", "worldhistory", "cache", "sim" }
	S.description = "World History Aggregate Cache: reuse of expensive aggregate computations for the World History subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.worldhistory.aggregate_cache", policy = "lfu", capacity = 342, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
