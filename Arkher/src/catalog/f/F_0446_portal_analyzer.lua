-- ARKHER SYSTEM F.0446 :: Portal Culling Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0446"
	S.key = "arkher.render.portal.frame_analysis"
	S.name = "Portal Culling Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.portal.pass_cache" }
	S.tags = { "f", "portal", "analyzer", "render" }
	S.description = "Portal Culling Frame Analysis: per-pass cost analysis and outlier detection for the Portal Culling subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.portal.frame_analysis", window = 170, buckets = 14, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
