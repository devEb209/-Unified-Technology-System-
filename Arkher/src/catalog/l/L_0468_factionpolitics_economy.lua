-- ARKHER SYSTEM L.0468 :: Faction Politics Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0468"
	S.key = "arkher.sim.factionpolitics.economy"
	S.name = "Faction Politics Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.factionpolitics.ecology" }
	S.tags = { "l", "factionpolitics", "economy", "sim" }
	S.description = "Faction Politics Economy: stock, production, demand, price discovery and trade for the Faction Politics subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.factionpolitics.economy", elasticity = 0.22 })
		inst.system = S
		inst.ctx = ctx
