-- ARKHER SYSTEM E.0101 :: Height Displacement Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0101"
	S.key = "arkher.material.displacement.instance_cache"
	S.name = "Height Displacement Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.displacement.quality_policy" }
	S.tags = { "e", "displacement", "cache", "material" }
	S.description = "Height Displacement Instance Cache: resolved-parameter cache keyed by context for the Height Displacement subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.displacement.instance_cache", policy = "lfu", capacity = 297, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
