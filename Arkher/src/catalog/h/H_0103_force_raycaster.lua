-- ARKHER SYSTEM H.0103 :: Force Accumulator Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0103"
	S.key = "arkher.physics.force.query"
	S.name = "Force Accumulator Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.force.constraint_solver" }
	S.tags = { "h", "force", "raycaster", "physics" }
	S.description = "Force Accumulator Query: rays, sweeps and overlaps against the simulation for the Force Accumulator subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.force.query", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
