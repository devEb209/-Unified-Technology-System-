--!strict
-- DaVinci Pages — ANIMATION Map #0093
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="DaVinci Pages — ANIMATION Map #0093", size=Vector2.new(600, 480), pos=UDim2.fromOffset(109, 101), parent=parent, icon="◣"})
