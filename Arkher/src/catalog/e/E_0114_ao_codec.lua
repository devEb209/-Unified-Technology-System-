-- ARKHER SYSTEM E.0114 :: Ambient Occlusion Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0114"
	S.key = "arkher.material.ao.compression_codec"
	S.name = "Ambient Occlusion Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.ao.streaming" }
	S.tags = { "e", "ao", "codec", "material" }
	S.description = "Ambient Occlusion Compression Codec: serialization and compression of material data for the Ambient Occlusion subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.ao.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
