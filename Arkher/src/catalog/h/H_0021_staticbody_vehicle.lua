-- ARKHER SYSTEM H.0021 :: Static Body Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0021"
	S.key = "arkher.physics.staticbody.vehicle"
	S.name = "Static Body Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Static Body"
	S.aspect = "Vehicle"
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.staticbody.character_motion" }
	S.tags = { "h", "staticbody", "vehicle", "physics" }
	S.description = "Static Body Vehicle: suspension, drivetrain, steering and tire friction for the Static Body subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.staticbody.vehicle", mass = 2200, wheelbase = 3.10, track = 1.90, maxRpm = 6500 })
		inst.system = S
		inst.ctx = ctx
