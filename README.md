...
```bash
npm test              # 259/259 testes determinísticos
...
declarado funcional sem teste que prove. **GÊNESIS: 83% (83.16 — render 76→81: nuvens volumétricas, fogo de Planck, árvores reais)** (régua de
