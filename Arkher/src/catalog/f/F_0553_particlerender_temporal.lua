-- ARKHER SYSTEM F.0553 :: Particle Rendering Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0553"
	S.key = "arkher.render.particlerender.temporal_resolve"
	S.name = "Particle Rendering Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.particlerender.probe_volume" }
	S.tags = { "f", "particlerender", "temporal", "render" }
	S.description = "Particle Rendering Temporal Resolve: history reprojection with neighbourhood clamping for the Particle Rendering subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.particlerender.temporal_resolve", feedback = 0.92, phase = 8 })
		inst.system = S
		inst.ctx = ctx
