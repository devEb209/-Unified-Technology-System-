-- ARKHER SYSTEM R.0175 :: Interpolation Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0175"
	S.key = "arkher.net.interpolation.interest_streaming"
	S.name = "Interpolation Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.interpolation.serialization_codec" }
	S.tags = { "r", "interpolation", "streamer", "net" }
	S.description = "Interpolation Interest Streaming: distance-driven residency of replicated content for the Interpolation subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.interpolation.interest_streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
