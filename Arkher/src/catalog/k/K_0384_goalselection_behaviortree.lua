-- ARKHER SYSTEM K.0384 :: Goal Selection Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0384"
	S.key = "arkher.npc.goalselection.reactive_behaviour"
	S.name = "Goal Selection Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.goalselection.perception" }
	S.tags = { "k", "goalselection", "behaviortree", "npc" }
	S.description = "Goal Selection Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Goal Selection subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.goalselection.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
