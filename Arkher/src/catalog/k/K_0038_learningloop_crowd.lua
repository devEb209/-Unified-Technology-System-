-- ARKHER SYSTEM K.0038 :: Learning Loop Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0038"
	S.key = "arkher.npc.learningloop.crowd_steering"
	S.name = "Learning Loop Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.learningloop.navigation" }
	S.tags = { "k", "learningloop", "crowd", "npc" }
	S.description = "Learning Loop Crowd Steering: local avoidance, cohesion and arrival at scale for the Learning Loop subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.learningloop.crowd_steering", radius = 0.60, maxSpeed = 5.40, cellSize = 6 })
		inst.system = S
		inst.ctx = ctx
