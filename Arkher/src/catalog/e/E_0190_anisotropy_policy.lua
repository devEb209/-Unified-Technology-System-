-- ARKHER SYSTEM E.0190 :: Anisotropy Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0190"
	S.key = "arkher.material.anisotropy.quality_policy"
	S.name = "Anisotropy Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Anisotropy"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.anisotropy.compression_codec" }
	S.tags = { "e", "anisotropy", "policy", "material" }
	S.description = "Anisotropy Quality Policy: device tier rules for the surface for the Anisotropy subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.anisotropy.quality_policy", algorithm = "lottery", starvationGuard = 19 })
		inst.system = S
		inst.ctx = ctx
