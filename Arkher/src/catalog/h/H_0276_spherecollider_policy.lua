-- ARKHER SYSTEM H.0276 :: Sphere Collider Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0276"
	S.key = "arkher.physics.spherecollider.simulation_policy"
	S.name = "Sphere Collider Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.spherecollider.budget_governor" }
	S.tags = { "h", "spherecollider", "policy", "physics" }
	S.description = "Sphere Collider Simulation Policy: device tier rules for substeps, iterations and sleep for the Sphere Collider subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.spherecollider.simulation_policy", algorithm = "wfq", starvationGuard = 38 })
		inst.system = S
		inst.ctx = ctx
