-- ARKHER SYSTEM I.0283 :: Hand Placement IK Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0283"
	S.key = "arkher.anim.handik.pose_cache"
	S.name = "Hand Placement IK Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.handik.playback_pipeline" }
	S.tags = { "i", "handik", "cache", "anim" }
	S.description = "Hand Placement IK Pose Cache: reuse of sampled poses across frames and instances for the Hand Placement IK subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.handik.pose_cache", policy = "lfu", capacity = 336, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
