-- ARKHER SYSTEM VB.0523 :: Asset Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0523"
	S.key = "arkher.conttime.assetcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.assetcont.coherence_guard" }
	S.tags = { "vb", "assetcont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.assetcont.neural_field", dims = 16, hidden = 12, seed = 47981 })
		inst.system = S
		inst.ctx = ctx
