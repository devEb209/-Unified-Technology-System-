-- ARKHER SYSTEM G.0454 :: On Device Budget Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0454"
	S.key = "arkher.neural.ondevicebudget.weight_codec"
	S.name = "On Device Budget Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ondevicebudget.model_registry" }
	S.tags = { "g", "ondevicebudget", "codec", "neural" }
	S.description = "On Device Budget Weight Codec: weight serialization and quantized transport for the On Device Budget subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.ondevicebudget.weight_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
