-- ARKHER SYSTEM I.0368 :: Retargeting Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0368"
	S.key = "arkher.anim.retargeting.inverse_kinematics"
	S.name = "Retargeting Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Retargeting"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.retargeting.layered_blending" }
	S.tags = { "i", "retargeting", "ik", "anim" }
	S.description = "Retargeting Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Retargeting subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.retargeting.inverse_kinematics", iterations = 5, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
