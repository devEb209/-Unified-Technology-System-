-- ARKHER SYSTEM W.0395 :: Preview Render Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0395"
	S.key = "arkher.cine.previewrender.sequence_analysis"
	S.name = "Preview Render Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.previewrender.frame_budget" }
	S.tags = { "w", "previewrender", "analyzer", "cine" }
	S.description = "Preview Render Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Preview Render subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.previewrender.sequence_analysis", window = 121, buckets = 9, threshold = 3.30 })
		inst.system = S
		inst.ctx = ctx
