-- ARKHER SYSTEM H.0292 :: Box Collider Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0292"
	S.key = "arkher.physics.boxcollider.analysis"
	S.name = "Box Collider Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Box Collider"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.boxcollider.result_cache" }
	S.tags = { "h", "boxcollider", "analyzer", "physics" }
	S.description = "Box Collider Analysis: energy, jitter and cost analysis of the simulation for the Box Collider subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.boxcollider.analysis", window = 162, buckets = 18, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
