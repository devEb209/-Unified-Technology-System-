-- ARKHER SYSTEM VC.0626 :: Interest Field Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0626"
	S.key = "arkher.contneural.interestfield.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.interestfield.infinite_grid" }
	S.tags = { "vc", "interestfield", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.interestfield.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
