-- ARKHER SYSTEM F.0243 :: Reflection Probe Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0243"
	S.key = "arkher.render.reflectionprobe.lighting_rig"
	S.name = "Reflection Probe Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.reflectionprobe.geometry_virtualization" }
	S.tags = { "f", "reflectionprobe", "lightrig", "render" }
	S.description = "Reflection Probe Lighting Rig: light clustering, importance and cascades for the Reflection Probe subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.reflectionprobe.lighting_rig", maxActive = 9 })
		inst.system = S
		inst.ctx = ctx
