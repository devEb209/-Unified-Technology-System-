-- ARKHER SYSTEM G.0298 :: Model Registry Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0298"
	S.key = "arkher.neural.modelregistry.reconstruction"
	S.name = "Model Registry Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelregistry.temporal_history" }
	S.tags = { "g", "modelregistry", "upscaler", "neural" }
	S.description = "Model Registry Reconstruction: resolution ladder and image reconstruction for the Model Registry subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.modelregistry.reconstruction", targetMs = 12.10, index = 4, sharpness = 0.51 })
		inst.system = S
		inst.ctx = ctx
