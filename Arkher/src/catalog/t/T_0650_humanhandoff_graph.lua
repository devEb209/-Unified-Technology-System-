-- ARKHER SYSTEM T.0650 :: Human Handoff Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0650"
	S.key = "arkher.ai.humanhandoff.reasoning_graph"
	S.name = "Human Handoff Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.humanhandoff.world_architect" }
	S.tags = { "t", "humanhandoff", "graph", "ai" }
	S.description = "Human Handoff Reasoning Graph: relationship modelling and shortest-path reasoning for the Human Handoff subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.humanhandoff.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
