-- ARKHER SYSTEM E.0055 :: Roughness Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0055"
	S.key = "arkher.material.roughness.quality_policy"
	S.name = "Roughness Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Roughness"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.roughness.compression_codec" }
	S.tags = { "e", "roughness", "policy", "material" }
	S.description = "Roughness Quality Policy: device tier rules for the surface for the Roughness subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.roughness.quality_policy", algorithm = "lottery", starvationGuard = 59 })
		inst.system = S
		inst.ctx = ctx
