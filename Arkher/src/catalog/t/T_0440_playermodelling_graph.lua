-- ARKHER SYSTEM T.0440 :: Player Modelling Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0440"
	S.key = "arkher.ai.playermodelling.reasoning_graph"
	S.name = "Player Modelling Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.playermodelling.world_architect" }
	S.tags = { "t", "playermodelling", "graph", "ai" }
	S.description = "Player Modelling Reasoning Graph: relationship modelling and shortest-path reasoning for the Player Modelling subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.playermodelling.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
