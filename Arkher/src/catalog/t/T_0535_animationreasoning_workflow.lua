-- ARKHER SYSTEM T.0535 :: Animation Reasoning Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0535"
	S.key = "arkher.ai.animationreasoning.plan_workflow"
	S.name = "Animation Reasoning Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.animationreasoning.semantic_knowledge" }
	S.tags = { "t", "animationreasoning", "workflow", "ai" }
	S.description = "Animation Reasoning Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Animation Reasoning subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.animationreasoning.plan_workflow", maxRetries = 3, budget = 90 })
		inst.system = S
		inst.ctx = ctx
