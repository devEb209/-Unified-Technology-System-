-- ARKHER SYSTEM VC.0264 :: Road Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0264"
	S.key = "arkher.contneural.roadcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.roadcont.reality_continuum" }
	S.tags = { "vc", "roadcont", "emergence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.roadcont.emergence_continuum", windowSize = 4, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
