-- ARKHER SYSTEM Z.0683 :: Auto Test Synthesis Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0683"
	S.key = "arkher.origin.autotest.simulation_fabric"
	S.name = "Auto Test Synthesis Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autotest.complexity_governance" }
	S.tags = { "z", "autotest", "fabric", "origin" }
	S.description = "Auto Test Synthesis Simulation Fabric: every simulation domain stepped under one budgeted clock for the Auto Test Synthesis subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.autotest.simulation_fabric", budgetMs = 1.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
