-- ARKHER SYSTEM K.0376 :: Utility Selection Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0376"
	S.key = "arkher.npc.utilityselection.daily_schedule"
	S.name = "Utility Selection Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.utilityselection.social_relations" }
	S.tags = { "k", "utilityselection", "schedule", "npc" }
	S.description = "Utility Selection Daily Schedule: hour-by-hour routine with priority interruptions for the Utility Selection subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.utilityselection.daily_schedule", startHour = 8 })
		inst.system = S
		inst.ctx = ctx
