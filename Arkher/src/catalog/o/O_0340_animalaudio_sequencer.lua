-- ARKHER SYSTEM O.0340 :: Animal Audio Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0340"
	S.key = "arkher.audio.animalaudio.music_sequencer"
	S.name = "Animal Audio Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Animal Audio"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.animalaudio.spatialization" }
	S.tags = { "o", "animalaudio", "sequencer", "audio" }
	S.description = "Animal Audio Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Animal Audio subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.animalaudio.music_sequencer", bpm = 130, beatsPerBar = 4, intensity = 0.50 })
		inst.system = S
		inst.ctx = ctx
