...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Cinema4D — ANIMATION Map #0123", size=Vector2.new(600, 480), pos=UDim2.fromOffset(499, 91), parent=parent, icon="▭"})
