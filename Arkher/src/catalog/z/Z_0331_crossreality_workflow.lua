-- ARKHER SYSTEM Z.0331 :: Cross Reality Sync Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0331"
	S.key = "arkher.origin.crossreality.adaptive_workflow"
	S.name = "Cross Reality Sync Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.self_critique" }
	S.tags = { "z", "crossreality", "workflow", "origin" }
	S.description = "Cross Reality Sync Adaptive Workflow: verified, retryable, reversible execution plans for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.crossreality.adaptive_workflow", maxRetries = 1, budget = 100 })
		inst.system = S
		inst.ctx = ctx
