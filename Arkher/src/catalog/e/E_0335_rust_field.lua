-- ARKHER SYSTEM E.0335 :: Rust Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0335"
	S.key = "arkher.material.rust.procedural_detail"
	S.name = "Rust Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Rust"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.rust.texture_sampling" }
	S.tags = { "e", "rust", "field", "material" }
	S.description = "Rust Procedural Detail: coherent noise detail driving the surface for the Rust subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.rust.procedural_detail", seed = 44177, frequency = 0.0083, octaves = 4, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
		...
		function inst.integrate(engine)
			...
			inst.engine = engine
			if engine.bus then
				engine.bus:subscribe("arkher.material.rust.*", function(payload) inst.lastSignal = payload end)
			end
