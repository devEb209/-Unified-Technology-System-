-- ARKHER SYSTEM VD.0068 :: Sparse Page World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0068"
	S.key = "arkher.contsim.sparsepage.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.sparsepage.neural_field" }
	S.tags = { "vd", "sparsepage", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.sparsepage.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
