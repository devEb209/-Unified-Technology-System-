--!strict
-- Unity6 URP — ANIMATION Node_Flow #0101
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Unity6 URP — ANIMATION Node_Flow #0101", size=Vector2.new(680, 440), pos=UDim2.fromOffset(213, 237), parent=parent, icon="⬣"})
