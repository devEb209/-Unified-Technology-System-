-- ARKHER SYSTEM O.0189 :: Interior Audio Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0189"
	S.key = "arkher.audio.interioraudio.playback_policy"
	S.name = "Interior Audio Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.interioraudio.compression_codec" }
	S.tags = { "o", "interioraudio", "policy", "audio" }
	S.description = "Interior Audio Playback Policy: rules choosing what may be heard right now for the Interior Audio subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.interioraudio.playback_policy", algorithm = "edf", starvationGuard = 37 })
		inst.system = S
		inst.ctx = ctx
