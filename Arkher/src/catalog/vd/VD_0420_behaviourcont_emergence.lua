-- ARKHER SYSTEM VD.0420 :: Behaviour Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0420"
	S.key = "arkher.contsim.behaviourcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.behaviourcont.reality_continuum" }
	S.tags = { "vd", "behaviourcont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.behaviourcont.emergence_continuum", windowSize = 7, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
