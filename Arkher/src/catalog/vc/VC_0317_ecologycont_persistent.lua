-- ARKHER SYSTEM VC.0317 :: Ecology Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0317"
	S.key = "arkher.contneural.ecologycont.persistent_state"
	S.name = "Ecology Continuum Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.ecologycont.multi-scale_fidelity" }
	S.tags = { "vc", "ecologycont", "persistent", "contneural" }
	S.description = "Ecology Continuum Persistent State: epoch-stamped persistent history and rollback for the Ecology Continuum subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.ecologycont.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
