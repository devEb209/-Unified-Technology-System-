-- ARKHER SYSTEM N.0414 :: Wind Gust Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0414"
	S.key = "arkher.vfx.windgust.spatial_index"
	S.name = "Wind Gust Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Wind Gust"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.windgust.quality_policy" }
	S.tags = { "n", "windgust", "index", "vfx" }
	S.description = "Wind Gust Spatial Index: spatial acceleration of effect queries and culling for the Wind Gust subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.windgust.spatial_index", mode = "hash", cellSize = 88 })
		inst.system = S
		inst.ctx = ctx
