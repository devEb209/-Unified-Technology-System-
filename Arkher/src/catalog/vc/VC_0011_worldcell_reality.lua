-- ARKHER SYSTEM VC.0011 :: World Grid Cell Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0011"
	S.key = "arkher.contneural.worldcell.reality_continuum"
	S.name = "World Grid Cell Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldcell.simulation_fabric" }
	S.tags = { "vc", "worldcell", "reality", "contneural" }
	S.description = "World Grid Cell Reality Continuum: stacked reality layers of the continuum for the World Grid Cell subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.worldcell.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
