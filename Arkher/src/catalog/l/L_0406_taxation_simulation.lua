-- ARKHER SYSTEM L.0406 :: Taxation Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0406"
	S.key = "arkher.sim.taxation.simulation_core"
	S.name = "Taxation Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "taxation", "simulation", "sim" }
	S.description = "Taxation Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Taxation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.taxation.simulation_core", fullRadius = 160, reducedRadius = 1100, budget = 117 })
		inst.system = S
		inst.ctx = ctx
