-- ARKHER SYSTEM VB.0087 :: Residency Window Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0087"
	S.key = "arkher.conttime.residencywindow.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.residencywindow.epoch_clock" }
	S.tags = { "vb", "residencywindow", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.residencywindow.sparse_residency", capacity = 256, pageBytes = 3072 })
		inst.system = S
		inst.ctx = ctx
