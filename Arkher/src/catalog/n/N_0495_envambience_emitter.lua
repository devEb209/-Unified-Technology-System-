-- ARKHER SYSTEM N.0495 :: Environment Ambience Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0495"
	S.key = "arkher.vfx.envambience.emission"
	S.name = "Environment Ambience Emission"
	S.category = "N"
	S.family = "VFX"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "envambience", "emitter", "vfx" }
	S.description = "Environment Ambience Emission: shaped, rate and burst emission of new particles for the Environment Ambience subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.envambience.emission", shape = "box", rate = 46, speed = 5.60, life = 3.40, budget = 256, seed = 34106 })
		inst.system = S
		inst.ctx = ctx
