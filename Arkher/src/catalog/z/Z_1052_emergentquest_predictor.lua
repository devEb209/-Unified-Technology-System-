-- ARKHER SYSTEM Z.1052 :: Emergent Quest Generation Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.1052"
	S.key = "arkher.origin.emergentquest.predictive_optimization"
	S.name = "Emergent Quest Generation Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentquest.adaptive_workflow" }
	S.tags = { "z", "emergentquest", "predictor", "origin" }
	S.description = "Emergent Quest Generation Predictive Optimization: forecast-driven optimization before the cost is paid for the Emergent Quest Generation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.emergentquest.predictive_optimization", method = "markov", alpha = 0.16, window = 118 })
		inst.system = S
		inst.ctx = ctx
