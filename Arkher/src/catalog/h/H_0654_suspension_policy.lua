-- ARKHER SYSTEM H.0654 :: Wheel Suspension Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0654"
	S.key = "arkher.physics.suspension.simulation_policy"
	S.name = "Wheel Suspension Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.suspension.budget_governor" }
	S.tags = { "h", "suspension", "policy", "physics" }
	S.description = "Wheel Suspension Simulation Policy: device tier rules for substeps, iterations and sleep for the Wheel Suspension subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.suspension.simulation_policy", algorithm = "lottery", starvationGuard = 19 })
		inst.system = S
		inst.ctx = ctx
