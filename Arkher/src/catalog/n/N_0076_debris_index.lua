-- ARKHER SYSTEM N.0076 :: Debris Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0076"
	S.key = "arkher.vfx.debris.spatial_index"
	S.name = "Debris Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Debris"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.debris.quality_policy" }
	S.tags = { "n", "debris", "index", "vfx" }
	S.description = "Debris Spatial Index: spatial acceleration of effect queries and culling for the Debris subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.debris.spatial_index", mode = "hash", cellSize = 64 })
		inst.system = S
		inst.ctx = ctx
