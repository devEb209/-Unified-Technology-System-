-- ARKHER SYSTEM L.0523 :: Migration Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0523"
	S.key = "arkher.sim.migration.analysis"
	S.name = "Migration Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.migration.aggregate_cache" }
	S.tags = { "l", "migration", "analyzer", "sim" }
	S.description = "Migration Analysis: trend, anomaly and stability analysis of the world for the Migration subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.migration.analysis", window = 106, buckets = 18, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
