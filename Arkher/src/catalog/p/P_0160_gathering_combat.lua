-- ARKHER SYSTEM P.0160 :: Gathering Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0160"
	S.key = "arkher.play.gathering.combat_resolution"
	S.name = "Gathering Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Gathering"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.gathering.objectives" }
	S.tags = { "p", "gathering", "combat", "play" }
	S.description = "Gathering Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Gathering subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.gathering.combat_resolution", seed = 86315, armourK = 110, critMultiplier = 2.60 })
		inst.system = S
		inst.ctx = ctx
