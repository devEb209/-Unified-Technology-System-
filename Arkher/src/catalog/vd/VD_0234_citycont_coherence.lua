-- ARKHER SYSTEM VD.0234 :: City Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0234"
	S.key = "arkher.contsim.citycont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.citycont.persistent_state" }
	S.tags = { "vd", "citycont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.citycont.coherence_guard", window = 94, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
