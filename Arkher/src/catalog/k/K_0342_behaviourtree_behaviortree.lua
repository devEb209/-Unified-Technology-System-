-- ARKHER SYSTEM K.0342 :: Behaviour Tree Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0342"
	S.key = "arkher.npc.behaviourtree.reactive_behaviour"
	S.name = "Behaviour Tree Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourtree.perception" }
	S.tags = { "k", "behaviourtree", "behaviortree", "npc" }
	S.description = "Behaviour Tree Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Behaviour Tree subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.behaviourtree.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
