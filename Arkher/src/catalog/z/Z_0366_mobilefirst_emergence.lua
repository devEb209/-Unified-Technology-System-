-- ARKHER SYSTEM Z.0366 :: Mobile First Governor Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0366"
	S.key = "arkher.origin.mobilefirst.emergence_detection"
	S.name = "Mobile First Governor Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.world_memory" }
	S.tags = { "z", "mobilefirst", "emergence", "origin" }
	S.description = "Mobile First Governor Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.mobilefirst.emergence_detection", windowSize = 7, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
