-- ARKHER SYSTEM O.0017 :: Foley Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0017"
	S.key = "arkher.audio.foley.voice_budget"
	S.name = "Foley Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Foley"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.foley.music_sequencer" }
	S.tags = { "o", "foley", "budgeter", "audio" }
	S.description = "Foley Voice Budget: voice slots allocated by priority and audibility for the Foley subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.foley.voice_budget", total = 422, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
