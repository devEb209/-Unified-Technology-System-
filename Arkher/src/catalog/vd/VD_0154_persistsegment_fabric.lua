-- ARKHER SYSTEM VD.0154 :: Persistence Segment Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0154"
	S.key = "arkher.contsim.persistsegment.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.persistsegment.complexity_budget" }
	S.tags = { "vd", "persistsegment", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.persistsegment.simulation_fabric", budgetMs = 1.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
