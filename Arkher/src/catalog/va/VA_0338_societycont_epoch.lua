-- ARKHER SYSTEM VA.0338 :: Society Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0338"
	S.key = "arkher.contworld.societycont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.societycont.infinite_grid" }
	S.tags = { "va", "societycont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.societycont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
