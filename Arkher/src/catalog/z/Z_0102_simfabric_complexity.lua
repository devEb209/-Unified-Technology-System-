-- ARKHER SYSTEM Z.0102 :: Universal Simulation Fabric Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0102"
	S.key = "arkher.origin.simfabric.complexity_governance"
	S.name = "Universal Simulation Fabric Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.simfabric.reality_layering" }
	S.tags = { "z", "simfabric", "complexity", "origin" }
	S.description = "Universal Simulation Fabric Complexity Governance: measured scene cost turned into per-subsystem directives for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.simfabric.complexity_governance", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
