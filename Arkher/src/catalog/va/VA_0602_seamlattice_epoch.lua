-- ARKHER SYSTEM VA.0602 :: Seam Lattice Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0602"
	S.key = "arkher.contworld.seamlattice.epoch_clock"
	S.name = "Seam Lattice Epoch Clock"
	S.category = "VA"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.seamlattice.infinite_grid" }
	S.tags = { "va", "seamlattice", "epoch", "contworld" }
	S.description = "Seam Lattice Epoch Clock: deterministic epoch timeline with catch-up for the Seam Lattice subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.seamlattice.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
