-- ARKHER SYSTEM Z.0364 :: Mobile First Governor Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0364"
	S.key = "arkher.origin.mobilefirst.autonomous_pipeline"
	S.name = "Mobile First Governor Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.simulation_fabric" }
	S.tags = { "z", "mobilefirst", "autopipeline", "origin" }
	S.description = "Mobile First Governor Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.mobilefirst.autonomous_pipeline", maxIterations = 6 })
		inst.system = S
		inst.ctx = ctx
