-- ARKHER SYSTEM R.0020 :: Connection Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0020"
	S.key = "arkher.net.connection.rate_guard"
	S.name = "Connection Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Connection"
	S.aspect = "Rate Guard"
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.connection.interest_streaming" }
	S.tags = { "r", "connection", "guard", "net" }
	S.description = "Connection Rate Guard: token-bucket protection against floods and abuse for the Connection subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.connection.rate_guard", algorithm = "leaky", capacity = 53, refillPerSec = 58, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
