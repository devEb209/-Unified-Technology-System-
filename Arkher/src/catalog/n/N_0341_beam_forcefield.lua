-- ARKHER SYSTEM N.0341 :: Beam Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0341"
	S.key = "arkher.vfx.beam.force_field"
	S.name = "Beam Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Beam"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.beam.particle_simulation" }
	S.tags = { "n", "beam", "forcefield", "vfx" }
	S.description = "Beam Force Field: wind, attraction, vortex, drag and curl turbulence for the Beam subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.beam.force_field", seed = 49381 })
		inst.system = S
		inst.ctx = ctx
