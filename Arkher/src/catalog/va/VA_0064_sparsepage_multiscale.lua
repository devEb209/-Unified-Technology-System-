-- ARKHER SYSTEM VA.0064 :: Sparse Page Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VA.0064"
	S.key = "arkher.contworld.sparsepage.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.sparsepage.sparse_residency" }
	S.tags = { "va", "sparsepage", "multiscale", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contworld.sparsepage.multi-scale_fidelity", levels = 4, baseTriangles = 150000 })
		inst.system = S
		inst.ctx = ctx
