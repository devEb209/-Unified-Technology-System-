-- ARKHER SYSTEM VC.0525 :: Asset Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0525"
	S.key = "arkher.contneural.assetcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.assetcont.world_memory_stream" }
	S.tags = { "vc", "assetcont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.assetcont.complexity_budget", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
