-- ARKHER SYSTEM P.0208 :: Trading Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0208"
	S.key = "arkher.play.trading.combat_resolution"
	S.name = "Trading Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Trading"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.trading.objectives" }
	S.tags = { "p", "trading", "combat", "play" }
	S.description = "Trading Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Trading subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.trading.combat_resolution", seed = 10187, armourK = 110, critMultiplier = 2.60 })
		inst.system = S
		inst.ctx = ctx
