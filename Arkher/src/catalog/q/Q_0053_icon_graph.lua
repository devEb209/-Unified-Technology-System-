-- ARKHER SYSTEM Q.0053 :: Icon Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0053"
	S.key = "arkher.ui.icon.navigation_graph"
	S.name = "Icon Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Icon"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.icon.transition" }
	S.tags = { "q", "icon", "graph", "ui" }
	S.description = "Icon Navigation Graph: screens, routes and shortest path between them for the Icon subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.icon.navigation_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
