-- ARKHER SYSTEM I.0184 :: Blend Tree Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0184"
	S.key = "arkher.anim.blendtree.clip_sampling"
	S.name = "Blend Tree Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Blend Tree"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.blendtree.skeleton" }
	S.tags = { "i", "blendtree", "clip", "anim" }
	S.description = "Blend Tree Clip Sampling: keyframe tracks sampled, retimed and evented for the Blend Tree subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.blendtree.clip_sampling", duration = 1.20, loop = true })
		inst.system = S
		inst.ctx = ctx
