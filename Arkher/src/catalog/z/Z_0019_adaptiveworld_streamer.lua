-- ARKHER SYSTEM Z.0019 :: Adaptive World Intelligence Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0019"
	S.key = "arkher.origin.adaptiveworld.residency_streaming"
	S.name = "Adaptive World Intelligence Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.adaptiveworld.budget_governor" }
	S.tags = { "z", "adaptiveworld", "streamer", "origin" }
	S.description = "Adaptive World Intelligence Residency Streaming: distance-driven residency of the technology's workload for the Adaptive World Intelligence subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.adaptiveworld.residency_streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
