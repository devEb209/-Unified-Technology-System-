-- ARKHER SYSTEM L.0076 :: Cohort Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0076"
	S.key = "arkher.sim.cohort.simulation_core"
	S.name = "Cohort Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "cohort", "simulation", "sim" }
	S.description = "Cohort Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Cohort subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.cohort.simulation_core", fullRadius = 280, reducedRadius = 1200, budget = 78 })
		inst.system = S
		inst.ctx = ctx
