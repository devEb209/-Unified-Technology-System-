-- ARKHER SYSTEM VC.0086 :: Residency Window Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0086"
	S.key = "arkher.contneural.residencywindow.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.residencywindow.infinite_grid" }
	S.tags = { "vc", "residencywindow", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.residencywindow.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
