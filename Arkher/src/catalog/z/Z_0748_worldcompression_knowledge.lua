-- ARKHER SYSTEM Z.0748 :: World Compression Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0748"
	S.key = "arkher.origin.worldcompression.semantic_graph"
	S.name = "World Compression Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.world_architect" }
	S.tags = { "z", "worldcompression", "knowledge", "origin" }
	S.description = "World Compression Semantic Graph: typed entities and inferred relations of the technology itself for the World Compression subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.worldcompression.semantic_graph", dims = 16 })
		inst.system = S
		inst.ctx = ctx
