-- ARKHER SYSTEM Q.0022 :: Panel Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0022"
	S.key = "arkher.ui.panel.frame_budget"
	S.name = "Panel Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Panel"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.panel.accessibility_policy" }
	S.tags = { "q", "panel", "budgeter", "ui" }
	S.description = "Panel Frame Budget: per-frame layout and draw budget for the interface for the Panel subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.panel.frame_budget", total = 368, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
