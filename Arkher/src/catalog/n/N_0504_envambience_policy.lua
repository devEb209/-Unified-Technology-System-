-- ARKHER SYSTEM N.0504 :: Environment Ambience Quality Policy
-- Category N - VFX
-- ARKHER VFX Framework capability: emission, simulation, forces and trails inside one shared budget.
-- Kit: policy (distance and device driven fidelity bands)
--@arkher-module
return function(A)
	...
	local S = {}
	S.id = "N.0504"
	S.key = "arkher.vfx.envambience.quality_policy"
	S.name = "Environment Ambience Quality Policy"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.envambience.result_cache" }
	S.tags = { "n", "envambience", "policy", "vfx" }
	S.description = "Environment Ambience Quality Policy: distance and device driven fidelity bands for the Environment Ambience subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.envambience.quality_policy", algorithm = "edf", starvationGuard = 33 })
		inst.system = S
		inst.ctx = ctx
