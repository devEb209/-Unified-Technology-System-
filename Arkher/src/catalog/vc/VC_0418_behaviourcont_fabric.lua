-- ARKHER SYSTEM VC.0418 :: Behaviour Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0418"
	S.key = "arkher.contneural.behaviourcont.simulation_fabric"
	S.name = "Behaviour Continuum Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.behaviourcont.complexity_budget" }
	S.tags = { "vc", "behaviourcont", "fabric", "contneural" }
	S.description = "Behaviour Continuum Simulation Fabric: fabric stepping the continuum domains for the Behaviour Continuum subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.behaviourcont.simulation_fabric", budgetMs = 3.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
