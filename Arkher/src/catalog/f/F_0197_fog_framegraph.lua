-- ARKHER SYSTEM F.0197 :: Fog Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0197"
	S.key = "arkher.render.fog.frame_graph"
	S.name = "Fog Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Fog"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "fog", "framegraph", "render" }
	S.description = "Fog Frame Graph: declared passes, culling, ordering and aliasing for the Fog subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.fog.frame_graph", budgetMs = 9.00 })
		inst.system = S
		inst.ctx = ctx
