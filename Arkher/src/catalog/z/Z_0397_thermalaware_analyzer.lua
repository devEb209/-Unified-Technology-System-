-- ARKHER SYSTEM Z.0397 :: Thermal Aware Simulation Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0397"
	S.key = "arkher.origin.thermalaware.behaviour_analysis"
	S.name = "Thermal Aware Simulation Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.governance_policy" }
	S.tags = { "z", "thermalaware", "analyzer", "origin" }
	S.description = "Thermal Aware Simulation Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.thermalaware.behaviour_analysis", window = 206, buckets = 18, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
