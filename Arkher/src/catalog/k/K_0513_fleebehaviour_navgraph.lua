-- ARKHER SYSTEM K.0513 :: Flee Behaviour Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0513"
	S.key = "arkher.npc.fleebehaviour.navigation"
	S.name = "Flee Behaviour Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.fleebehaviour.goal_planner" }
	S.tags = { "k", "fleebehaviour", "navgraph", "npc" }
	S.description = "Flee Behaviour Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Flee Behaviour subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.fleebehaviour.navigation", width = 40, height = 40, cellSize = 4 })
		inst.system = S
		inst.ctx = ctx
