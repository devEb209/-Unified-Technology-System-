-- ARKHER SYSTEM H.0141 :: Linear Damping Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0141"
	S.key = "arkher.physics.lineardamping.body_dynamics"
	S.name = "Linear Damping Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "lineardamping", "rigidbody", "physics" }
	S.description = "Linear Damping Body Dynamics: integration, impulses, damping and sleeping of a body for the Linear Damping subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.lineardamping.body_dynamics", mass = 13.00, radius = 0.90, restitution = 0.32, friction = 0.62, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
