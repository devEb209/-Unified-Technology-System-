-- ARKHER SYSTEM J.0256 :: Damage State Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0256"
	S.key = "arkher.character.damagestate.blend_controller"
	S.name = "Damage State Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.damagestate.motion_set" }
	S.tags = { "j", "damagestate", "animator", "character" }
	S.description = "Damage State Blend Controller: layered playback driving the character for the Damage State subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.damagestate.blend_controller", budget = 8 })
		inst.system = S
		inst.ctx = ctx
