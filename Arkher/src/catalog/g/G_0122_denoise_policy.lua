-- ARKHER SYSTEM G.0122 :: Denoising Heuristic Policy
...
return function(A)
	...
	local S = {}
	S.id = "G.0122"
	S.key = "arkher.neural.denoise.heuristic_policy"
	S.name = "Denoising Heuristic Policy"
	S.category = "G"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.denoise.result_cache" }
	S.tags = { "g", "denoise", "policy", "neural" }
	S.description = "Denoising Heuristic Policy: rule fallback when the model is unavailable for the Denoising subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.neural.denoise.heuristic_policy", algorithm = "edf", starvationGuard = 53 })
		inst.system = S
		inst.ctx = ctx
