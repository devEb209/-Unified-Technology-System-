-- ARKHER SYSTEM H.0500 :: Slider Joint Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0500"
	S.key = "arkher.physics.sliderjoint.simulation_policy"
	S.name = "Slider Joint Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Slider Joint"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sliderjoint.budget_governor" }
	S.tags = { "h", "sliderjoint", "policy", "physics" }
	S.description = "Slider Joint Simulation Policy: device tier rules for substeps, iterations and sleep for the Slider Joint subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.sliderjoint.simulation_policy", algorithm = "lottery", starvationGuard = 31 })
		inst.system = S
		inst.ctx = ctx
