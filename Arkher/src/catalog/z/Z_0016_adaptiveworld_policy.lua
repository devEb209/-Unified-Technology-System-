-- ARKHER SYSTEM Z.0016 :: Adaptive World Intelligence Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0016"
	S.key = "arkher.origin.adaptiveworld.governance_policy"
	S.name = "Adaptive World Intelligence Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.adaptiveworld.signal_composition" }
	S.tags = { "z", "adaptiveworld", "policy", "origin" }
	S.description = "Adaptive World Intelligence Governance Policy: ordered rules governing when the technology may act for the Adaptive World Intelligence subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.adaptiveworld.governance_policy", algorithm = "wfq", starvationGuard = 22 })
		inst.system = S
		inst.ctx = ctx
