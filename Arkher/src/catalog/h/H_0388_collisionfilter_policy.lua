-- ARKHER SYSTEM H.0388 :: Collision Filter Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0388"
	S.key = "arkher.physics.collisionfilter.simulation_policy"
	S.name = "Collision Filter Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionfilter.budget_governor" }
	S.tags = { "h", "collisionfilter", "policy", "physics" }
	S.description = "Collision Filter Simulation Policy: device tier rules for substeps, iterations and sleep for the Collision Filter subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.collisionfilter.simulation_policy", algorithm = "lottery", starvationGuard = 39 })
		inst.system = S
		inst.ctx = ctx
