-- ARKHER SYSTEM K.0569 :: Work Behaviour Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0569"
	S.key = "arkher.npc.workbehaviour.navigation"
	S.name = "Work Behaviour Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workbehaviour.goal_planner" }
	S.tags = { "k", "workbehaviour", "navgraph", "npc" }
	S.description = "Work Behaviour Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Work Behaviour subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.workbehaviour.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
