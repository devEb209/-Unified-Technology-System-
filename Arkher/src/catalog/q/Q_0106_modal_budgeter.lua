-- ARKHER SYSTEM Q.0106 :: Modal Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0106"
	S.key = "arkher.ui.modal.frame_budget"
	S.name = "Modal Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Modal"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.modal.accessibility_policy" }
	S.tags = { "q", "modal", "budgeter", "ui" }
	S.description = "Modal Frame Budget: per-frame layout and draw budget for the interface for the Modal subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.modal.frame_budget", total = 449, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
