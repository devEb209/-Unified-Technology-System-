-- ARKHER SYSTEM P.0123 :: Loot Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0123"
	S.key = "arkher.play.loot.objectives"
	S.name = "Loot Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Loot"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.loot.inventory" }
	S.tags = { "p", "loot", "quest", "play" }
	S.description = "Loot Objectives: objectives, prerequisites, progress and rewards for the Loot subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.loot.objectives" })
		inst.system = S
		inst.ctx = ctx
