-- ARKHER SYSTEM VC.0489 :: Lighting Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0489"
	S.key = "arkher.contneural.lightcont.complexity_budget"
	S.name = "Lighting Continuum Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lightcont.world_memory_stream" }
	S.tags = { "vc", "lightcont", "complexity", "contneural" }
	S.description = "Lighting Continuum Complexity Budget: complexity budgeting for the continuum for the Lighting Continuum subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.lightcont.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
