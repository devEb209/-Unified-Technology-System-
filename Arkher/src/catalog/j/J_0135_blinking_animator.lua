-- ARKHER SYSTEM J.0135 :: Blinking Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0135"
	S.key = "arkher.character.blinking.blend_controller"
	S.name = "Blinking Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.blinking.motion_set" }
	S.tags = { "j", "blinking", "animator", "character" }
	S.description = "Blinking Blend Controller: layered playback driving the character for the Blinking subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.blinking.blend_controller", budget = 12 })
		inst.system = S
		inst.ctx = ctx
