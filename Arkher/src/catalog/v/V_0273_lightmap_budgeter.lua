-- ARKHER SYSTEM V.0273 :: Lightmap Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0273"
	S.key = "arkher.asset.lightmap.size_budget"
	S.name = "Lightmap Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lightmap.compression_codec" }
	S.tags = { "v", "lightmap", "budgeter", "asset" }
	S.description = "Lightmap Size Budget: byte budget shared between competing asset classes for the Lightmap subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.lightmap.size_budget", total = 381, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
