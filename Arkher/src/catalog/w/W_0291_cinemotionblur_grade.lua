-- ARKHER SYSTEM W.0291 :: Motion Blur Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0291"
	S.key = "arkher.cine.cinemotionblur.colour_grade"
	S.name = "Motion Blur Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Motion Blur"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinemotionblur.camera_rig" }
	S.tags = { "w", "cinemotionblur", "grade", "cine" }
	S.description = "Motion Blur Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.cinemotionblur.colour_grade", exposure = 0.03, contrast = 1.08, saturation = 0.93, toneMap = "filmic" })
		inst.system = S
		inst.ctx = ctx
