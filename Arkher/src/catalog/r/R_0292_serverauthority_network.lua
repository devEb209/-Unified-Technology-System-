-- ARKHER SYSTEM R.0292 :: Server Authority Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0292"
	S.key = "arkher.net.serverauthority.transport_graph"
	S.name = "Server Authority Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverauthority.prediction_and_reconciliation" }
	S.tags = { "r", "serverauthority", "network", "net" }
	S.description = "Server Authority Transport Graph: topology, capacity and routing between endpoints for the Server Authority subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.serverauthority.transport_graph" })
		inst.system = S
		inst.ctx = ctx
