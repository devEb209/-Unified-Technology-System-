-- ARKHER SYSTEM VA.0413 :: Behaviour Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0413"
	S.key = "arkher.contworld.behaviourcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.behaviourcont.multi-scale_fidelity" }
	S.tags = { "va", "behaviourcont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.behaviourcont.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
