-- ARKHER SYSTEM R.0052 :: Player State Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0052"
	S.key = "arkher.net.playerstate.transport_graph"
	S.name = "Player State Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Player State"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.playerstate.prediction_and_reconciliation" }
	S.tags = { "r", "playerstate", "network", "net" }
	S.description = "Player State Transport Graph: topology, capacity and routing between endpoints for the Player State subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.playerstate.transport_graph" })
		inst.system = S
		inst.ctx = ctx
