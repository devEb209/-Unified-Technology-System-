-- ARKHER SYSTEM N.0063 :: Dust Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0063"
	S.key = "arkher.vfx.dust.spatial_index"
	S.name = "Dust Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Dust"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.dust.quality_policy" }
	S.tags = { "n", "dust", "index", "vfx" }
	S.description = "Dust Spatial Index: spatial acceleration of effect queries and culling for the Dust subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.dust.spatial_index", mode = "hash", cellSize = 48 })
		inst.system = S
		inst.ctx = ctx
