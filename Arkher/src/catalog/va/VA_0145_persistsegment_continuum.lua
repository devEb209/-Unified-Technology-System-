-- ARKHER SYSTEM VA.0145 :: Persistence Segment Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0145"
	S.key = "arkher.contworld.persistsegment.infinite_grid"
	S.name = "Persistence Segment Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "persistsegment", "continuum", "contworld" }
	S.description = "Persistence Segment Infinite Grid: seamless paging of the infinite world grid for the Persistence Segment subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.persistsegment.infinite_grid", cellSize = 224, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
