-- ARKHER SYSTEM T.0142 :: Tool Use Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0142"
	S.key = "arkher.ai.tooluse.semantic_knowledge"
	S.name = "Tool Use Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.tooluse.intent_understanding" }
	S.tags = { "t", "tooluse", "knowledge", "ai" }
	S.description = "Tool Use Semantic Knowledge: typed entities, weighted relations and inferred closure for the Tool Use subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.tooluse.semantic_knowledge", dims = 16 })
		inst.system = S
		inst.ctx = ctx
