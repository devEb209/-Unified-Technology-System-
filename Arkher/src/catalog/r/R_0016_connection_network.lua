-- ARKHER SYSTEM R.0016 :: Connection Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0016"
	S.key = "arkher.net.connection.transport_graph"
	S.name = "Connection Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Connection"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.connection.prediction_and_reconciliation" }
	S.tags = { "r", "connection", "network", "net" }
	S.description = "Connection Transport Graph: topology, capacity and routing between endpoints for the Connection subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.connection.transport_graph" })
		inst.system = S
		inst.ctx = ctx
