-- ARKHER SYSTEM E.0043 :: Albedo Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0043"
	S.key = "arkher.material.albedo.authoring_pipeline"
	S.name = "Albedo Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Albedo"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.albedo.analysis" }
	S.tags = { "e", "albedo", "pipeline", "material" }
	S.description = "Albedo Authoring Pipeline: ordered authoring and bake stages for the Albedo subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.albedo.authoring_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
