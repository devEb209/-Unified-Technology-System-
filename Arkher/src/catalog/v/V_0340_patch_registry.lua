-- ARKHER SYSTEM V.0340 :: Patch Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0340"
	S.key = "arkher.asset.patch.asset_registry"
	S.name = "Patch Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.patch.cook_pipeline" }
	S.tags = { "v", "patch", "registry", "asset" }
	S.description = "Patch Asset Registry: catalogue of every asset, its tags and its metadata for the Patch subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.patch.asset_registry" })
		inst.system = S
		inst.ctx = ctx
