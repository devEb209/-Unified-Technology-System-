-- ARKHER SYSTEM P.0257 :: Dialogue Choice State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0257"
	S.key = "arkher.play.dialoguechoice.state_machine"
	S.name = "Dialogue Choice State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.dialoguechoice.combat_resolution" }
	S.tags = { "p", "dialoguechoice", "orchestrator", "play" }
	S.description = "Dialogue Choice State Machine: the phase machine that drives this gameplay loop for the Dialogue Choice subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.dialoguechoice.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
