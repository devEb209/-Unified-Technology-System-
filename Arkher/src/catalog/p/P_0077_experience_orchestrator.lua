-- ARKHER SYSTEM P.0077 :: Experience State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0077"
	S.key = "arkher.play.experience.state_machine"
	S.name = "Experience State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Experience"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.experience.combat_resolution" }
	S.tags = { "p", "experience", "orchestrator", "play" }
	S.description = "Experience State Machine: the phase machine that drives this gameplay loop for the Experience subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.experience.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
