-- ARKHER SYSTEM I.0510 :: Animation Debug Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0510"
	S.key = "arkher.anim.animdebug.layered_blending"
	S.name = "Animation Debug Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animdebug.clip_sampling" }
	S.tags = { "i", "animdebug", "animator", "anim" }
	S.description = "Animation Debug Layered Blending: layers, crossfades, masks and blend trees for the Animation Debug subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.animdebug.layered_blending", budget = 10 })
		inst.system = S
		inst.ctx = ctx
