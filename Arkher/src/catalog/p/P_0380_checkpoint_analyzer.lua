-- ARKHER SYSTEM P.0380 :: Checkpoint Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0380"
	S.key = "arkher.play.checkpoint.balance_analysis"
	S.name = "Checkpoint Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Checkpoint"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.checkpoint.event_ledger" }
	S.tags = { "p", "checkpoint", "analyzer", "play" }
	S.description = "Checkpoint Balance Analysis: distribution, outlier and pacing analysis for the Checkpoint subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.checkpoint.balance_analysis", window = 139, buckets = 19, threshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
