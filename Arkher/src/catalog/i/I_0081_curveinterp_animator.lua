-- ARKHER SYSTEM I.0081 :: Curve Interpolation Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0081"
	S.key = "arkher.anim.curveinterp.layered_blending"
	S.name = "Curve Interpolation Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.curveinterp.clip_sampling" }
	S.tags = { "i", "curveinterp", "animator", "anim" }
	S.description = "Curve Interpolation Layered Blending: layers, crossfades, masks and blend trees for the Curve Interpolation subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.curveinterp.layered_blending", budget = 11 })
		inst.system = S
		inst.ctx = ctx
