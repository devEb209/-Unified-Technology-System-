-- ARKHER SYSTEM H.0059 :: Inertia Tensor Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0059"
	S.key = "arkher.physics.inertia.contact_generation"
	S.name = "Inertia Tensor Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.inertia.collision_shape" }
	S.tags = { "h", "inertia", "contact", "physics" }
	S.description = "Inertia Tensor Contact Generation: narrow-phase manifolds with normal, depth and point for the Inertia Tensor subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.inertia.contact_generation", slop = 0.0060, maxManifolds = 217 })
		inst.system = S
		inst.ctx = ctx
