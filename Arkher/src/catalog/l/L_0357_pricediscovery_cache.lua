-- ARKHER SYSTEM L.0357 :: Price Discovery Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0357"
	S.key = "arkher.sim.pricediscovery.aggregate_cache"
	S.name = "Price Discovery Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.pricediscovery.fidelity_policy" }
	S.tags = { "l", "pricediscovery", "cache", "sim" }
	S.description = "Price Discovery Aggregate Cache: reuse of expensive aggregate computations for the Price Discovery subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.pricediscovery.aggregate_cache", policy = "ttl", capacity = 264, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
