-- ARKHER SYSTEM Z.0723 :: Knowledge Distillation Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0723"
	S.key = "arkher.origin.distillation.simulation_fabric"
	S.name = "Knowledge Distillation Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.distillation.complexity_governance" }
	S.tags = { "z", "distillation", "fabric", "origin" }
	S.description = "Knowledge Distillation Simulation Fabric: every simulation domain stepped under one budgeted clock for the Knowledge Distillation subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.distillation.simulation_fabric", budgetMs = 2.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
