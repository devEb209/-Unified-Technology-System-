-- ARKHER SYSTEM N.0444 :: Screen Effect Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0444"
	S.key = "arkher.vfx.screenfx.particle_simulation"
	S.name = "Screen Effect Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.screenfx.emission" }
	S.tags = { "n", "screenfx", "particles", "vfx" }
	S.description = "Screen Effect Particle Simulation: pooled integration of position, velocity, colour and life for the Screen Effect subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.screenfx.particle_simulation", capacity = 128, drag = 0.17, bounce = 0.42, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
