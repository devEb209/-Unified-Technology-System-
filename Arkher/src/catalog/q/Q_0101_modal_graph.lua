-- ARKHER SYSTEM Q.0101 :: Modal Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0101"
	S.key = "arkher.ui.modal.navigation_graph"
	S.name = "Modal Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Modal"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.modal.transition" }
	S.tags = { "q", "modal", "graph", "ui" }
	S.description = "Modal Navigation Graph: screens, routes and shortest path between them for the Modal subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.modal.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
