-- ARKHER SYSTEM K.0591 :: Relationship Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0591"
	S.key = "arkher.npc.relationship.drive_system"
	S.name = "Relationship Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.relationship.memory" }
	S.tags = { "k", "relationship", "need", "npc" }
	S.description = "Relationship Drive System: drives that decay, turn urgent and get satisfied for the Relationship subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.relationship.drive_system" })
		inst.system = S
		inst.ctx = ctx
