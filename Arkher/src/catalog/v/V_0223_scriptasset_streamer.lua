-- ARKHER SYSTEM V.0223 :: Script Asset Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0223"
	S.key = "arkher.asset.scriptasset.streaming_residency"
	S.name = "Script Asset Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.scriptasset.content_cache" }
	S.tags = { "v", "scriptasset", "streamer", "asset" }
	S.description = "Script Asset Streaming Residency: distance-driven load and unload of asset payloads for the Script Asset subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.scriptasset.streaming_residency", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
