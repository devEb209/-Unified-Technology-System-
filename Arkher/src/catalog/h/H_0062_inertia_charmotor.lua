-- ARKHER SYSTEM H.0062 :: Inertia Tensor Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0062"
	S.key = "arkher.physics.inertia.character_motion"
	S.name = "Inertia Tensor Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.inertia.query" }
	S.tags = { "h", "inertia", "charmotor", "physics" }
	S.description = "Inertia Tensor Character Motion: capsule move-and-slide with slopes, steps and jumps for the Inertia Tensor subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.inertia.character_motion", radius = 0.48, height = 1.93, maxSpeed = 7.30, jumpHeight = 2.10, stepOffset = 0.28 })
		inst.system = S
		inst.ctx = ctx
