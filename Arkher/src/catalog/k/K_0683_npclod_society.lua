-- ARKHER SYSTEM K.0683 :: NPC LOD Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0683"
	S.key = "arkher.npc.npclod.social_relations"
	S.name = "NPC LOD Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npclod.crowd_steering" }
	S.tags = { "k", "npclod", "society", "npc" }
	S.description = "NPC LOD Social Relations: affinity, factions, reputation and gossip for the NPC LOD subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.npclod.social_relations", decayRate = 0.008, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
