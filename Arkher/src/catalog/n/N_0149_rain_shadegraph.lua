-- ARKHER SYSTEM N.0149 :: Rain Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0149"
	S.key = "arkher.vfx.rain.effect_graph"
	S.name = "Rain Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Rain"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.rain.curve_authoring" }
	S.tags = { "n", "rain", "shadegraph", "vfx" }
	S.description = "Rain Effect Graph: node graph describing how the effect is shaded for the Rain subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.rain.effect_graph" })
		inst.system = S
		inst.ctx = ctx
