-- ARKHER SYSTEM V.0195 :: Terrain Asset Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0195"
	S.key = "arkher.asset.terrainasset.cook_pipeline"
	S.name = "Terrain Asset Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.terrainasset.bundling" }
	S.tags = { "v", "terrainasset", "pipeline", "asset" }
	S.description = "Terrain Asset Cook Pipeline: staged cooking with isolation and retries for the Terrain Asset subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.terrainasset.cook_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
