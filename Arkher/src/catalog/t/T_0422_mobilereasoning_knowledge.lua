-- ARKHER SYSTEM T.0422 :: Mobile Reasoning Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0422"
	S.key = "arkher.ai.mobilereasoning.semantic_knowledge"
	S.name = "Mobile Reasoning Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.mobilereasoning.intent_understanding" }
	S.tags = { "t", "mobilereasoning", "knowledge", "ai" }
	S.description = "Mobile Reasoning Semantic Knowledge: typed entities, weighted relations and inferred closure for the Mobile Reasoning subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.mobilereasoning.semantic_knowledge", dims = 16 })
		inst.system = S
		inst.ctx = ctx
