-- ARKHER SYSTEM VD.0297 :: Climate Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0297"
	S.key = "arkher.contsim.climatecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.climatecont.world_memory_stream" }
	S.tags = { "vd", "climatecont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.climatecont.complexity_budget", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
