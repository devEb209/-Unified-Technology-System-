-- ARKHER SYSTEM Z.0195 :: World Memory Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0195"
	S.key = "arkher.origin.worldmemorytech.signal_composition"
	S.name = "World Memory Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldmemorytech.telemetry_ledger" }
	S.tags = { "z", "worldmemorytech", "composer", "origin" }
	S.description = "World Memory Signal Composition: blending of the technology's input signals into one output for the World Memory subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.worldmemorytech.signal_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
