-- ARKHER SYSTEM F.0499 :: HLOD Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0499"
	S.key = "arkher.render.hlod.draw_budget"
	S.name = "HLOD Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "HLOD"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.hlod.adaptive_resolution" }
	S.tags = { "f", "hlod", "budgeter", "render" }
	S.description = "HLOD Draw Budget: draw call and triangle budget allocation for the HLOD subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.hlod.draw_budget", total = 203, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
