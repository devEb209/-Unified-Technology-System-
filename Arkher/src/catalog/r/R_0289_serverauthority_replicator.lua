-- ARKHER SYSTEM R.0289 :: Server Authority Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0289"
	S.key = "arkher.net.serverauthority.replication"
	S.name = "Server Authority Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "serverauthority", "replicator", "net" }
	S.description = "Server Authority Replication: authoritative entity state, interest and delta snapshots for the Server Authority subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.serverauthority.replication", mtu = 600, interestRadius = 200, fullEvery = 30 })
		inst.system = S
		inst.ctx = ctx
