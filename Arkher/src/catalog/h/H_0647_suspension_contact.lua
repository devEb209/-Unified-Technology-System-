-- ARKHER SYSTEM H.0647 :: Wheel Suspension Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0647"
	S.key = "arkher.physics.suspension.contact_generation"
	S.name = "Wheel Suspension Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.suspension.collision_shape" }
	S.tags = { "h", "suspension", "contact", "physics" }
	S.description = "Wheel Suspension Contact Generation: narrow-phase manifolds with normal, depth and point for the Wheel Suspension subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.suspension.contact_generation", slop = 0.0050, maxManifolds = 413 })
		inst.system = S
		inst.ctx = ctx
