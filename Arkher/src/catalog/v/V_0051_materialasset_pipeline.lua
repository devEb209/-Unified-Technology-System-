-- ARKHER SYSTEM V.0051 :: Material Asset Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0051"
	S.key = "arkher.asset.materialasset.cook_pipeline"
	S.name = "Material Asset Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.materialasset.bundling" }
	S.tags = { "v", "materialasset", "pipeline", "asset" }
	S.description = "Material Asset Cook Pipeline: staged cooking with isolation and retries for the Material Asset subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.materialasset.cook_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
