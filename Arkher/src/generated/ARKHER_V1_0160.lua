...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Nuke Nodal — CORE Stack #0160", size=Vector2.new(640, 420), pos=UDim2.fromOffset(180, 200), parent=parent, icon="✥"})
