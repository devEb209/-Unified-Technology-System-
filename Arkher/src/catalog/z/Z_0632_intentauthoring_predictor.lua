-- ARKHER SYSTEM Z.0632 :: Intent Driven Authoring Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0632"
	S.key = "arkher.origin.intentauthoring.predictive_optimization"
	S.name = "Intent Driven Authoring Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.adaptive_workflow" }
	S.tags = { "z", "intentauthoring", "predictor", "origin" }
	S.description = "Intent Driven Authoring Predictive Optimization: forecast-driven optimization before the cost is paid for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.intentauthoring.predictive_optimization", method = "markov", alpha = 0.27, window = 121 })
		inst.system = S
		inst.ctx = ctx
