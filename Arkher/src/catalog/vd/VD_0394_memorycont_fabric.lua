-- ARKHER SYSTEM VD.0394 :: Memory Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0394"
	S.key = "arkher.contsim.memorycont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memorycont.complexity_budget" }
	S.tags = { "vd", "memorycont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.memorycont.simulation_fabric", budgetMs = 2.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
