-- ARKHER SYSTEM Z.0996 :: Engine Self Model Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0996"
	S.key = "arkher.origin.engineselfmodel.governance_policy"
	S.name = "Engine Self Model Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.engineselfmodel.signal_composition" }
	S.tags = { "z", "engineselfmodel", "policy", "origin" }
	S.description = "Engine Self Model Governance Policy: ordered rules governing when the technology may act for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.engineselfmodel.governance_policy", algorithm = "lottery", starvationGuard = 23 })
		inst.system = S
		inst.ctx = ctx
