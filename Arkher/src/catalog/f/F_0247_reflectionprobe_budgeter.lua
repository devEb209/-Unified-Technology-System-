-- ARKHER SYSTEM F.0247 :: Reflection Probe Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0247"
	S.key = "arkher.render.reflectionprobe.draw_budget"
	S.name = "Reflection Probe Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.reflectionprobe.adaptive_resolution" }
	S.tags = { "f", "reflectionprobe", "budgeter", "render" }
	S.description = "Reflection Probe Draw Budget: draw call and triangle budget allocation for the Reflection Probe subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.reflectionprobe.draw_budget", total = 329, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
