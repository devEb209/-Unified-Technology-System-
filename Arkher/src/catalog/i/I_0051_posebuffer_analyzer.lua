-- ARKHER SYSTEM I.0051 :: Pose Buffer Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0051"
	S.key = "arkher.anim.posebuffer.analysis"
	S.name = "Pose Buffer Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Pose Buffer"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.posebuffer.quality_policy" }
	S.tags = { "i", "posebuffer", "analyzer", "anim" }
	S.description = "Pose Buffer Analysis: pop, drift and cost analysis of playback for the Pose Buffer subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.posebuffer.analysis", window = 212, buckets = 12, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
