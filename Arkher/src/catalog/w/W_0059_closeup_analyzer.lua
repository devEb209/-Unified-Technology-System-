-- ARKHER SYSTEM W.0059 :: Close Up Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0059"
	S.key = "arkher.cine.closeup.sequence_analysis"
	S.name = "Close Up Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Close Up"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.closeup.frame_budget" }
	S.tags = { "w", "closeup", "analyzer", "cine" }
	S.description = "Close Up Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Close Up subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.closeup.sequence_analysis", window = 221, buckets = 13, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
