-- ARKHER SYSTEM VC.0093 :: Residency Window Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0093"
	S.key = "arkher.contneural.residencywindow.complexity_budget"
	S.name = "Residency Window Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.residencywindow.world_memory_stream" }
	S.tags = { "vc", "residencywindow", "complexity", "contneural" }
	S.description = "Residency Window Complexity Budget: complexity budgeting for the continuum for the Residency Window subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.residencywindow.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
