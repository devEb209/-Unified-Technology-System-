-- ARKHER SYSTEM I.0067 :: Keyframe Track Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0067"
	S.key = "arkher.anim.keytrack.clip_sampling"
	S.name = "Keyframe Track Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.keytrack.skeleton" }
	S.tags = { "i", "keytrack", "clip", "anim" }
	S.description = "Keyframe Track Clip Sampling: keyframe tracks sampled, retimed and evented for the Keyframe Track subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.keytrack.clip_sampling", duration = 2.10, loop = true })
		inst.system = S
		inst.ctx = ctx
