-- ARKHER SYSTEM E.0349 :: Snow Cover Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0349"
	S.key = "arkher.material.snowcover.texture_sampling"
	S.name = "Snow Cover Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Snow Cover"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.snowcover.shading_graph" }
	S.tags = { "e", "snowcover", "sampler", "material" }
	S.description = "Snow Cover Texture Sampling: atlas packing, mip chain and filtered sampling for the Snow Cover subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.snowcover.texture_sampling", atlasSize = 128, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
