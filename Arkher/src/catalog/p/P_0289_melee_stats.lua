-- ARKHER SYSTEM P.0289 :: Melee Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0289"
	S.key = "arkher.play.melee.attributes"
	S.name = "Melee Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Melee"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "melee", "stats", "play" }
	S.description = "Melee Attributes: base values, layered modifiers and derived statistics for the Melee subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.melee.attributes" })
		inst.system = S
		inst.ctx = ctx
