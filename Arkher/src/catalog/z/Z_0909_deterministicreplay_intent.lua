-- ARKHER SYSTEM Z.0909 :: Deterministic Replay Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0909"
	S.key = "arkher.origin.deterministicreplay.intent_bridge"
	S.name = "Deterministic Replay Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deterministicreplay.semantic_graph" }
	S.tags = { "z", "deterministicreplay", "intent", "origin" }
	S.description = "Deterministic Replay Intent Bridge: natural language control surface for the technology for the Deterministic Replay subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.deterministicreplay.intent_bridge", minConfidence = 0.41 })
		inst.system = S
		inst.ctx = ctx
