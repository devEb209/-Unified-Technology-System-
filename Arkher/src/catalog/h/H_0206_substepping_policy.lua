-- ARKHER SYSTEM H.0206 :: Substepping Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0206"
	S.key = "arkher.physics.substepping.simulation_policy"
	S.name = "Substepping Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Substepping"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.substepping.budget_governor" }
	S.tags = { "h", "substepping", "policy", "physics" }
	S.description = "Substepping Simulation Policy: device tier rules for substeps, iterations and sleep for the Substepping subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.substepping.simulation_policy", algorithm = "roundrobin", starvationGuard = 32 })
		inst.system = S
		inst.ctx = ctx
