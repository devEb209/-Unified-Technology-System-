-- ARKHER SYSTEM VA.0358 :: Narrative Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0358"
	S.key = "arkher.contworld.narrativecont.simulation_fabric"
	S.name = "Narrative Continuum Simulation Fabric"
	S.category = "VA"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.narrativecont.complexity_budget" }
	S.tags = { "va", "narrativecont", "fabric", "contworld" }
	S.description = "Narrative Continuum Simulation Fabric: fabric stepping the continuum domains for the Narrative Continuum subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.narrativecont.simulation_fabric", budgetMs = 2.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
