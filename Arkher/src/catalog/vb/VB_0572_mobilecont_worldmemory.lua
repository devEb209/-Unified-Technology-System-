-- ARKHER SYSTEM VB.0572 :: Mobile Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0572"
	S.key = "arkher.conttime.mobilecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.mobilecont.neural_field" }
	S.tags = { "vb", "mobilecont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.mobilecont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
