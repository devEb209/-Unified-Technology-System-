-- ARKHER SYSTEM VB.0334 :: Economy Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0334"
	S.key = "arkher.conttime.economycont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.economycont.complexity_budget" }
	S.tags = { "vb", "economycont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.economycont.simulation_fabric", budgetMs = 2.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
