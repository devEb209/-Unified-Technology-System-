-- ARKHER SYSTEM F.0229 :: Water Rendering Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0229"
	S.key = "arkher.render.water.lighting_rig"
	S.name = "Water Rendering Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.water.geometry_virtualization" }
	S.tags = { "f", "water", "lightrig", "render" }
	S.description = "Water Rendering Lighting Rig: light clustering, importance and cascades for the Water Rendering subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.water.lighting_rig", maxActive = 4 })
		inst.system = S
		inst.ctx = ctx
