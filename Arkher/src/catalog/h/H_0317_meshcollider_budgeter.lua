-- ARKHER SYSTEM H.0317 :: Mesh Collider Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0317"
	S.key = "arkher.physics.meshcollider.budget_governor"
	S.name = "Mesh Collider Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.meshcollider.broadphase_index" }
	S.tags = { "h", "meshcollider", "budgeter", "physics" }
	S.description = "Mesh Collider Budget Governor: simulation time budget allocation across islands for the Mesh Collider subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.meshcollider.budget_governor", total = 401, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
