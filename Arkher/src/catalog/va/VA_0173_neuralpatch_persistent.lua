-- ARKHER SYSTEM VA.0173 :: Neural Patch Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0173"
	S.key = "arkher.contworld.neuralpatch.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.neuralpatch.multi-scale_fidelity" }
	S.tags = { "va", "neuralpatch", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.neuralpatch.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
