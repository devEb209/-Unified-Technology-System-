-- ARKHER SYSTEM VC.0467 :: Audio Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0467"
	S.key = "arkher.contneural.audiocont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.audiocont.simulation_fabric" }
	S.tags = { "vc", "audiocont", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.audiocont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
