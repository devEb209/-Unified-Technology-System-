-- ARKHER SYSTEM Z.0316 :: Causality Ledger Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0316"
	S.key = "arkher.origin.causality.governance_policy"
	S.name = "Causality Ledger Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.signal_composition" }
	S.tags = { "z", "causality", "policy", "origin" }
	S.description = "Causality Ledger Governance Policy: ordered rules governing when the technology may act for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.causality.governance_policy", algorithm = "roundrobin", starvationGuard = 32 })
		inst.system = S
		inst.ctx = ctx
