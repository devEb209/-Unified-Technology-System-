-- ARKHER SYSTEM G.0151 :: Texture Super Resolution Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0151"
	S.key = "arkher.neural.texturesr.error_analysis"
	S.name = "Texture Super Resolution Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.texturesr.heuristic_policy" }
	S.tags = { "g", "texturesr", "analyzer", "neural" }
	S.description = "Texture Super Resolution Error Analysis: residual and drift analysis for the Texture Super Resolution subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.texturesr.error_analysis", window = 174, buckets = 14, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
