-- ARKHER SYSTEM V.0363 :: Import Preset Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0363"
	S.key = "arkher.asset.importpreset.cook_pipeline"
	S.name = "Import Preset Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.importpreset.bundling" }
	S.tags = { "v", "importpreset", "pipeline", "asset" }
	S.description = "Import Preset Cook Pipeline: staged cooking with isolation and retries for the Import Preset subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.importpreset.cook_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
