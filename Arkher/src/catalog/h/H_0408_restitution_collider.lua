-- ARKHER SYSTEM H.0408 :: Restitution Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0408"
	S.key = "arkher.physics.restitution.collision_shape"
	S.name = "Restitution Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Restitution"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.restitution.body_dynamics" }
	S.tags = { "h", "restitution", "collider", "physics" }
	S.description = "Restitution Collision Shape: shape bounds, support mapping and closest points for the Restitution subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.restitution.collision_shape", shape = "sphere", radius = 1.90, height = 1.50, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
