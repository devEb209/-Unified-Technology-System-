-- ARKHER SYSTEM H.0547 :: Cloth Simulation Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0547"
	S.key = "arkher.physics.cloth.body_dynamics"
	S.name = "Cloth Simulation Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "cloth", "rigidbody", "physics" }
	S.description = "Cloth Simulation Body Dynamics: integration, impulses, damping and sleeping of a body for the Cloth Simulation subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.cloth.body_dynamics", mass = 32.00, radius = 0.85, restitution = 0.51, friction = 0.71, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
