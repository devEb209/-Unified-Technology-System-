...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Roblox Studio — CORE Map #0188", size=Vector2.new(680, 480), pos=UDim2.fromOffset(144, 156), parent=parent, icon="◉"})
