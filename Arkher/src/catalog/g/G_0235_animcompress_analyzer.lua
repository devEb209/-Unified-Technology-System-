-- ARKHER SYSTEM G.0235 :: Animation Compression Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0235"
	S.key = "arkher.neural.animcompress.error_analysis"
	S.name = "Animation Compression Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.animcompress.heuristic_policy" }
	S.tags = { "g", "animcompress", "analyzer", "neural" }
	S.description = "Animation Compression Error Analysis: residual and drift analysis for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.animcompress.error_analysis", window = 66, buckets = 18, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
