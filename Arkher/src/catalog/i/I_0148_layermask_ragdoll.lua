-- ARKHER SYSTEM I.0148 :: Layer Mask Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0148"
	S.key = "arkher.anim.layermask.physical_blend"
	S.name = "Layer Mask Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Layer Mask"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.layermask.inverse_kinematics" }
	S.tags = { "i", "layermask", "ragdoll", "anim" }
	S.description = "Layer Mask Physical Blend: physical bones blended against the animated pose for the Layer Mask subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.layermask.physical_blend", blendSpeed = 3.40 })
		inst.system = S
		inst.ctx = ctx
