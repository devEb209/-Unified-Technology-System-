-- ARKHER SYSTEM P.0327 :: Status Effect Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0327"
	S.key = "arkher.play.statuseffect.objectives"
	S.name = "Status Effect Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.statuseffect.inventory" }
	S.tags = { "p", "statuseffect", "quest", "play" }
	S.description = "Status Effect Objectives: objectives, prerequisites, progress and rewards for the Status Effect subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.statuseffect.objectives" })
		inst.system = S
		inst.ctx = ctx
