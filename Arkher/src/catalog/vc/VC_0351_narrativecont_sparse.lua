-- ARKHER SYSTEM VC.0351 :: Narrative Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0351"
	S.key = "arkher.contneural.narrativecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.narrativecont.epoch_clock" }
	S.tags = { "vc", "narrativecont", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.narrativecont.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
