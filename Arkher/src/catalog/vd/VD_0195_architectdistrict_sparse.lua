-- ARKHER SYSTEM VD.0195 :: Architect District Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0195"
	S.key = "arkher.contsim.architectdistrict.sparse_residency"
	S.name = "Architect District Sparse Residency"
	S.category = "VD"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.architectdistrict.epoch_clock" }
	S.tags = { "vd", "architectdistrict", "sparse", "contsim" }
	S.description = "Architect District Sparse Residency: sparse page residency with eviction and compression for the Architect District subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.architectdistrict.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
