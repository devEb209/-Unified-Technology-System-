-- ARKHER SYSTEM Z.0109 :: Universal Simulation Fabric Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0109"
	S.key = "arkher.origin.simfabric.intent_bridge"
	S.name = "Universal Simulation Fabric Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.simfabric.semantic_graph" }
	S.tags = { "z", "simfabric", "intent", "origin" }
	S.description = "Universal Simulation Fabric Intent Bridge: natural language control surface for the technology for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.simfabric.intent_bridge", minConfidence = 0.41 })
		inst.system = S
		inst.ctx = ctx
