-- ARKHER SYSTEM R.0138 :: Unreliable Channel Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0138"
	S.key = "arkher.net.unreliablechannel.serialization_codec"
	S.name = "Unreliable Channel Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.unreliablechannel.bandwidth_budget" }
	S.tags = { "r", "unreliablechannel", "codec", "net" }
	S.description = "Unreliable Channel Serialization Codec: compact encoding, diffing and checksum of payloads for the Unreliable Channel subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.unreliablechannel.serialization_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
