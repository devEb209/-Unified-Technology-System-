-- ARKHER SYSTEM O.0133 :: Rain Audio DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0133"
	S.key = "arkher.audio.rainaudio.dsp_chain"
	S.name = "Rain Audio DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Rain Audio"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "rainaudio", "dsp", "audio" }
	S.description = "Rain Audio DSP Chain: biquad filtering, delay, envelope and soft clipping for the Rain Audio subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.rainaudio.dsp_chain", sampleRate = 22050, filter = "notch", cutoff = 4800, q = 0.850 })
		inst.system = S
		inst.ctx = ctx
