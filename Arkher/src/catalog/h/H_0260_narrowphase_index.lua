-- ARKHER SYSTEM H.0260 :: Narrowphase Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0260"
	S.key = "arkher.physics.narrowphase.broadphase_index"
	S.name = "Narrowphase Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Narrowphase"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.narrowphase.vehicle" }
	S.tags = { "h", "narrowphase", "index", "physics" }
	S.description = "Narrowphase Broadphase Index: spatial acceleration of candidate pair finding for the Narrowphase subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.narrowphase.broadphase_index", mode = "hash", cellSize = 80 })
		inst.system = S
		inst.ctx = ctx
