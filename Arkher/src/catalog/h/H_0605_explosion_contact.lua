-- ARKHER SYSTEM H.0605 :: Explosion Force Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0605"
	S.key = "arkher.physics.explosion.contact_generation"
	S.name = "Explosion Force Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.explosion.collision_shape" }
	S.tags = { "h", "explosion", "contact", "physics" }
	S.description = "Explosion Force Contact Generation: narrow-phase manifolds with normal, depth and point for the Explosion Force subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.explosion.contact_generation", slop = 0.0050, maxManifolds = 250 })
		inst.system = S
		inst.ctx = ctx
