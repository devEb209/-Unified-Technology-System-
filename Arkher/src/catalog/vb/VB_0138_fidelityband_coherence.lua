-- ARKHER SYSTEM VB.0138 :: Fidelity Band Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0138"
	S.key = "arkher.conttime.fidelityband.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.fidelityband.persistent_state" }
	S.tags = { "vb", "fidelityband", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.fidelityband.coherence_guard", window = 58, threshold = 0.14 })
		inst.system = S
		inst.ctx = ctx
