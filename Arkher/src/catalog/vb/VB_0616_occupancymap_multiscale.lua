-- ARKHER SYSTEM VB.0616 :: Occupancy Map Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0616"
	S.key = "arkher.conttime.occupancymap.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.occupancymap.sparse_residency" }
	S.tags = { "vb", "occupancymap", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.occupancymap.multi-scale_fidelity", levels = 4, baseTriangles = 150000 })
		inst.system = S
		inst.ctx = ctx
