-- ARKHER SYSTEM R.0193 :: Client Prediction Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0193"
	S.key = "arkher.net.clientprediction.replication"
	S.name = "Client Prediction Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "clientprediction", "replicator", "net" }
	S.description = "Client Prediction Replication: authoritative entity state, interest and delta snapshots for the Client Prediction subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.clientprediction.replication", mtu = 1650, interestRadius = 320, fullEvery = 105 })
		inst.system = S
		inst.ctx = ctx
