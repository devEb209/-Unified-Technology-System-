-- ARKHER SYSTEM T.0683 :: Continuous Learning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0683"
	S.key = "arkher.ai.continuouslearning.action_planner"
	S.name = "Continuous Learning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.continuouslearning.utility_selection" }
	S.tags = { "t", "continuouslearning", "planner", "ai" }
	S.description = "Continuous Learning Action Planner: goal-oriented action planning over preconditions for the Continuous Learning subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.continuouslearning.action_planner", maxDepth = 10 })
		inst.system = S
		inst.ctx = ctx
