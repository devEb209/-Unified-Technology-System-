-- ARKHER SYSTEM G.0284 :: Perceptual Metric Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0284"
	S.key = "arkher.neural.perceptual.reconstruction"
	S.name = "Perceptual Metric Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perceptual.temporal_history" }
	S.tags = { "g", "perceptual", "upscaler", "neural" }
	S.description = "Perceptual Metric Reconstruction: resolution ladder and image reconstruction for the Perceptual Metric subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.perceptual.reconstruction", targetMs = 12.10, index = 4, sharpness = 0.33 })
		inst.system = S
		inst.ctx = ctx
