-- ARKHER SYSTEM VC.0294 :: Climate Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0294"
	S.key = "arkher.contneural.climatecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.climatecont.persistent_state" }
	S.tags = { "vc", "climatecont", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.climatecont.coherence_guard", window = 78, threshold = 0.14 })
		inst.system = S
		inst.ctx = ctx
