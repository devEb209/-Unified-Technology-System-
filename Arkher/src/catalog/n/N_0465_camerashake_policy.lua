-- ARKHER SYSTEM N.0465 :: Camera Shake Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0465"
	S.key = "arkher.vfx.camerashake.quality_policy"
	S.name = "Camera Shake Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Camera Shake"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.camerashake.result_cache" }
	S.tags = { "n", "camerashake", "policy", "vfx" }
	S.description = "Camera Shake Quality Policy: distance and device driven fidelity bands for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.camerashake.quality_policy", algorithm = "roundrobin", starvationGuard = 44 })
		inst.system = S
		inst.ctx = ctx
