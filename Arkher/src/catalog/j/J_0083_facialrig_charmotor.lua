-- ARKHER SYSTEM J.0083 :: Facial Rig Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0083"
	S.key = "arkher.character.facialrig.locomotion"
	S.name = "Facial Rig Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.facialrig.physical_response" }
	S.tags = { "j", "facialrig", "charmotor", "character" }
	S.description = "Facial Rig Locomotion: capsule locomotion driving the character for the Facial Rig subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.facialrig.locomotion", radius = 0.38, height = 1.63, maxSpeed = 4.30, jumpHeight = 1.50, stepOffset = 0.28 })
		inst.system = S
		inst.ctx = ctx
