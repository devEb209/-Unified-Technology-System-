-- ARKHER SYSTEM VD.0479 :: VFX Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0479"
	S.key = "arkher.contsim.vfxcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vfxcont.simulation_fabric" }
	S.tags = { "vd", "vfxcont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.vfxcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
