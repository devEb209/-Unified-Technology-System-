-- ARKHER SYSTEM P.0407 :: Match Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0407"
	S.key = "arkher.play.match.save_codec"
	S.name = "Match Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Match"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.match.content_registry" }
	S.tags = { "p", "match", "codec", "play" }
	S.description = "Match Save Codec: persistence, diffing and checksum of gameplay state for the Match subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.match.save_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
