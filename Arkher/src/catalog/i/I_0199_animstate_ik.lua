-- ARKHER SYSTEM I.0199 :: State Machine Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0199"
	S.key = "arkher.anim.animstate.inverse_kinematics"
	S.name = "State Machine Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstate.layered_blending" }
	S.tags = { "i", "animstate", "ik", "anim" }
	S.description = "State Machine Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the State Machine subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.animstate.inverse_kinematics", iterations = 7, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
