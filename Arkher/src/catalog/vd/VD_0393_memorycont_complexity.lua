-- ARKHER SYSTEM VD.0393 :: Memory Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0393"
	S.key = "arkher.contsim.memorycont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memorycont.world_memory_stream" }
	S.tags = { "vd", "memorycont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.memorycont.complexity_budget", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
