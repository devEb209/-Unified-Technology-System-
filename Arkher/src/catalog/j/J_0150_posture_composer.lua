-- ARKHER SYSTEM J.0150 :: Posture Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0150"
	S.key = "arkher.character.posture.appearance_composer"
	S.name = "Posture Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.posture.locomotion" }
	S.tags = { "j", "posture", "composer", "character" }
	S.description = "Posture Appearance Composer: composition of appearance slots into a look for the Posture subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.posture.appearance_composer", mode = "max" })
		inst.system = S
		inst.ctx = ctx
	...
	function inst.dominantLayer()
		...
		function inst.integrate(engine)
			...
			inst.engine = engine
			if engine.bus then
				engine.bus:subscribe("arkher.character.posture.*", function(payload) inst.lastSignal = payload end)
			end
