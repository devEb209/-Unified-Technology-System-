-- ARKHER SYSTEM L.0099 :: Reification State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0099"
	S.key = "arkher.sim.reification.state_codec"
	S.name = "Reification State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.reification.history_ledger" }
	S.tags = { "l", "reification", "codec", "sim" }
	S.description = "Reification State Codec: persistence, diffing and checksum of the world state for the Reification subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.reification.state_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
