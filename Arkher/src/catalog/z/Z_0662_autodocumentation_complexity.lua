-- ARKHER SYSTEM Z.0662 :: Auto Documentation Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0662"
	S.key = "arkher.origin.autodocumentation.complexity_governance"
	S.name = "Auto Documentation Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.reality_layering" }
	S.tags = { "z", "autodocumentation", "complexity", "origin" }
	S.description = "Auto Documentation Complexity Governance: measured scene cost turned into per-subsystem directives for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.autodocumentation.complexity_governance", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
