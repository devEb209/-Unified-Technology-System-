-- ARKHER SYSTEM G.0300 :: Model Registry Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0300"
	S.key = "arkher.neural.modelregistry.weight_codec"
	S.name = "Model Registry Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelregistry.model_registry" }
	S.tags = { "g", "modelregistry", "codec", "neural" }
	S.description = "Model Registry Weight Codec: weight serialization and quantized transport for the Model Registry subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.modelregistry.weight_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
