-- ARKHER SYSTEM N.0176 :: Hail Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0176"
	S.key = "arkher.vfx.hail.effect_composition"
	S.name = "Hail Effect Composition"
	S.category = "N"
	S.family = "VFX"
	S.area = "Hail"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.hail.effect_graph" }
	S.tags = { "n", "hail", "composer", "vfx" }
	S.description = "Hail Effect Composition: blending of several effect signals into one output for the Hail subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.hail.effect_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
