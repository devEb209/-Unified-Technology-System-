-- ARKHER SYSTEM Q.0295 :: Gesture Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0295"
	S.key = "arkher.ui.gesture.localization_registry"
	S.name = "Gesture Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Gesture"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.gesture.theme_composition" }
	S.tags = { "q", "gesture", "registry", "ui" }
	S.description = "Gesture Localization Registry: catalogue of strings, plurals and locale metadata for the Gesture subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.gesture.localization_registry" })
		inst.system = S
		inst.ctx = ctx
