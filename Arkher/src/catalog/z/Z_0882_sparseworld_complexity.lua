-- ARKHER SYSTEM Z.0882 :: Sparse World Representation Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0882"
	S.key = "arkher.origin.sparseworld.complexity_governance"
	S.name = "Sparse World Representation Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.reality_layering" }
	S.tags = { "z", "sparseworld", "complexity", "origin" }
	S.description = "Sparse World Representation Complexity Governance: measured scene cost turned into per-subsystem directives for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.sparseworld.complexity_governance", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
