-- ARKHER SYSTEM K.0492 :: Patrol Route Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0492"
	S.key = "arkher.npc.patrolroute.memory"
	S.name = "Patrol Route Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.patrolroute.mind_network" }
	S.tags = { "k", "patrolroute", "memory", "npc" }
	S.description = "Patrol Route Memory: episodic memory with decay, recall and consolidation for the Patrol Route subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.patrolroute.memory", capacity = 118, decayRate = 0.040, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
