-- ARKHER SYSTEM Z.0296 :: Temporal Continuity Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0296"
	S.key = "arkher.origin.temporalcontinuity.governance_policy"
	S.name = "Temporal Continuity Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.temporalcontinuity.signal_composition" }
	S.tags = { "z", "temporalcontinuity", "policy", "origin" }
	S.description = "Temporal Continuity Governance Policy: ordered rules governing when the technology may act for the Temporal Continuity subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.temporalcontinuity.governance_policy", algorithm = "edf", starvationGuard = 21 })
		inst.system = S
		inst.ctx = ctx
