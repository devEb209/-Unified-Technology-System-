-- ARKHER SYSTEM I.0311 :: Aim Offset Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0311"
	S.key = "arkher.anim.aimoffset.analysis"
	S.name = "Aim Offset Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Aim Offset"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.aimoffset.quality_policy" }
	S.tags = { "i", "aimoffset", "analyzer", "anim" }
	S.description = "Aim Offset Analysis: pop, drift and cost analysis of playback for the Aim Offset subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.aimoffset.analysis", window = 150, buckets = 10, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
