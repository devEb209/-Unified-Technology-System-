-- ARKHER SYSTEM H.0339 :: Compound Collider Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0339"
	S.key = "arkher.physics.compoundcollider.contact_generation"
	S.name = "Compound Collider Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.compoundcollider.collision_shape" }
	S.tags = { "h", "compoundcollider", "contact", "physics" }
	S.description = "Compound Collider Contact Generation: narrow-phase manifolds with normal, depth and point for the Compound Collider subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.compoundcollider.contact_generation", slop = 0.0060, maxManifolds = 147 })
		inst.system = S
		inst.ctx = ctx
