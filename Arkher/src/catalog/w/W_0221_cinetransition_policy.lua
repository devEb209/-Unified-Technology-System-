-- ARKHER SYSTEM W.0221 :: Transition Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0221"
	S.key = "arkher.cine.cinetransition.cut_policy"
	S.name = "Transition Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Transition"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinetransition.shot_composition" }
	S.tags = { "w", "cinetransition", "policy", "cine" }
	S.description = "Transition Cut Policy: rules deciding when the sequence cuts and to what for the Transition subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.cinetransition.cut_policy", algorithm = "wfq", starvationGuard = 22 })
		inst.system = S
		inst.ctx = ctx
