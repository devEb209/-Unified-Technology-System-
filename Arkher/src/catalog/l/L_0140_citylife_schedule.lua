-- ARKHER SYSTEM L.0140 :: City Life Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0140"
	S.key = "arkher.sim.citylife.calendar"
	S.name = "City Life Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.citylife.society" }
	S.tags = { "l", "citylife", "schedule", "sim" }
	S.description = "City Life Calendar: hours, days and seasons driving the region for the City Life subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.citylife.calendar", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
