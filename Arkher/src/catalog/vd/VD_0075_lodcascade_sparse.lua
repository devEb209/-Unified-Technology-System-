-- ARKHER SYSTEM VD.0075 :: LOD Cascade Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0075"
	S.key = "arkher.contsim.lodcascade.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lodcascade.epoch_clock" }
	S.tags = { "vd", "lodcascade", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.lodcascade.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
