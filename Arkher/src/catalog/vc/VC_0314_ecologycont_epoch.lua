-- ARKHER SYSTEM VC.0314 :: Ecology Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0314"
	S.key = "arkher.contneural.ecologycont.epoch_clock"
	S.name = "Ecology Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.ecologycont.infinite_grid" }
	S.tags = { "vc", "ecologycont", "epoch", "contneural" }
	S.description = "Ecology Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Ecology Continuum subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.ecologycont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
