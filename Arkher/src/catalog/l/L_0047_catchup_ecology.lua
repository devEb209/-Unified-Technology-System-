-- ARKHER SYSTEM L.0047 :: Catch Up Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0047"
	S.key = "arkher.sim.catchup.ecology"
	S.name = "Catch Up Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.catchup.simulation_core" }
	S.tags = { "l", "catchup", "ecology", "sim" }
	S.description = "Catch Up Ecology: populations, predation, harvesting and carrying capacity for the Catch Up subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.catchup.ecology" })
		inst.system = S
		inst.ctx = ctx
