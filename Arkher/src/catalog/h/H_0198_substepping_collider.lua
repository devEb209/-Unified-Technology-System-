-- ARKHER SYSTEM H.0198 :: Substepping Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0198"
	S.key = "arkher.physics.substepping.collision_shape"
	S.name = "Substepping Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Substepping"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.substepping.body_dynamics" }
	S.tags = { "h", "substepping", "collider", "physics" }
	S.description = "Substepping Collision Shape: shape bounds, support mapping and closest points for the Substepping subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.substepping.collision_shape", shape = "box", radius = 1.10, height = 1.90, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
