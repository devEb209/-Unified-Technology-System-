-- ARKHER SYSTEM VC.0071 :: Sparse Page Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0071"
	S.key = "arkher.contneural.sparsepage.reality_continuum"
	S.name = "Sparse Page Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.sparsepage.simulation_fabric" }
	S.tags = { "vc", "sparsepage", "reality", "contneural" }
	S.description = "Sparse Page Reality Continuum: stacked reality layers of the continuum for the Sparse Page subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.sparsepage.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
