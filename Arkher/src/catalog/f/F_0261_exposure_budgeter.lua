-- ARKHER SYSTEM F.0261 :: Exposure Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0261"
	S.key = "arkher.render.exposure.draw_budget"
	S.name = "Exposure Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Exposure"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.exposure.adaptive_resolution" }
	S.tags = { "f", "exposure", "budgeter", "render" }
	S.description = "Exposure Draw Budget: draw call and triangle budget allocation for the Exposure subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.exposure.draw_budget", total = 227, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
