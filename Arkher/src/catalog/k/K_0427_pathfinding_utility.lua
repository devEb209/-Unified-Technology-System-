-- ARKHER SYSTEM K.0427 :: Pathfinding Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0427"
	S.key = "arkher.npc.pathfinding.utility_reasoning"
	S.name = "Pathfinding Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.pathfinding.reactive_behaviour" }
	S.tags = { "k", "pathfinding", "utility", "npc" }
	S.description = "Pathfinding Utility Reasoning: scored option selection with response curves for the Pathfinding subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.pathfinding.utility_reasoning", momentum = 0.13 })
		inst.system = S
		inst.ctx = ctx
