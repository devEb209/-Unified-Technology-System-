-- ARKHER SYSTEM VA.0473 :: VFX Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0473"
	S.key = "arkher.contworld.vfxcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vfxcont.multi-scale_fidelity" }
	S.tags = { "va", "vfxcont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.vfxcont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
