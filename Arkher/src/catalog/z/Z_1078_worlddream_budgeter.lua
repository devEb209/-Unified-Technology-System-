-- ARKHER SYSTEM Z.1078 :: World Dream State Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.1078"
	S.key = "arkher.origin.worlddream.budget_governor"
	S.name = "World Dream State Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.behaviour_analysis" }
	S.tags = { "z", "worlddream", "budgeter", "origin" }
	S.description = "World Dream State Budget Governor: allocation of a scarce resource across the technology's consumers for the World Dream State subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.worlddream.budget_governor", total = 430, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
