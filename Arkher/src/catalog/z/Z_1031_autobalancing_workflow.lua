-- ARKHER SYSTEM Z.1031 :: Autonomous Balancing Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.1031"
	S.key = "arkher.origin.autobalancing.adaptive_workflow"
	S.name = "Autonomous Balancing Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autobalancing.self_critique" }
	S.tags = { "z", "autobalancing", "workflow", "origin" }
	S.description = "Autonomous Balancing Adaptive Workflow: verified, retryable, reversible execution plans for the Autonomous Balancing subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.autobalancing.adaptive_workflow", maxRetries = 2, budget = 110 })
		inst.system = S
		inst.ctx = ctx
