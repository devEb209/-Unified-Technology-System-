-- ARKHER SYSTEM VB.0109 :: Temporal Slice Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0109"
	S.key = "arkher.conttime.temporalslice.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "temporalslice", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.temporalslice.infinite_grid", cellSize = 224, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
