-- ARKHER SYSTEM I.0248 :: Turn In Place Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0248"
	S.key = "arkher.anim.turninplace.skeleton"
	S.name = "Turn In Place Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "turninplace", "skeleton", "anim" }
	S.description = "Turn In Place Skeleton: bone hierarchy, bind pose and world resolution for the Turn In Place subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.turninplace.skeleton" })
		inst.system = S
		inst.ctx = ctx
