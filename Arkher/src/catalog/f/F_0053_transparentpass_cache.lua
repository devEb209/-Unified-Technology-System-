-- ARKHER SYSTEM F.0053 :: Transparent Pass Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0053"
	S.key = "arkher.render.transparentpass.pass_cache"
	S.name = "Transparent Pass Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.transparentpass.render_policy" }
	S.tags = { "f", "transparentpass", "cache", "render" }
	S.description = "Transparent Pass Pass Cache: reuse of pass results across frames for the Transparent Pass subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.transparentpass.pass_cache", policy = "ttl", capacity = 380, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
