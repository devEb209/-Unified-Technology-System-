-- ARKHER SYSTEM VA.0414 :: Behaviour Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0414"
	S.key = "arkher.contworld.behaviourcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.behaviourcont.persistent_state" }
	S.tags = { "va", "behaviourcont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.behaviourcont.coherence_guard", window = 64, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
