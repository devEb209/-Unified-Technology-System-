-- ARKHER SYSTEM Z.0451 :: Player Absence Simulation Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0451"
	S.key = "arkher.origin.playerabsence.adaptive_workflow"
	S.name = "Player Absence Simulation Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.self_critique" }
	S.tags = { "z", "playerabsence", "workflow", "origin" }
	S.description = "Player Absence Simulation Adaptive Workflow: verified, retryable, reversible execution plans for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.playerabsence.adaptive_workflow", maxRetries = 2, budget = 110 })
		inst.system = S
		inst.ctx = ctx
