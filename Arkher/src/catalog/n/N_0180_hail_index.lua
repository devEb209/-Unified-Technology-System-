-- ARKHER SYSTEM N.0180 :: Hail Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0180"
	S.key = "arkher.vfx.hail.spatial_index"
	S.name = "Hail Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Hail"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.hail.quality_policy" }
	S.tags = { "n", "hail", "index", "vfx" }
	S.description = "Hail Spatial Index: spatial acceleration of effect queries and culling for the Hail subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.hail.spatial_index", mode = "hash", cellSize = 64 })
		inst.system = S
		inst.ctx = ctx
