-- ARKHER SYSTEM K.0105 :: Memory Consolidation Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0105"
	S.key = "arkher.npc.consolidation.utility_reasoning"
	S.name = "Memory Consolidation Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.consolidation.reactive_behaviour" }
	S.tags = { "k", "consolidation", "utility", "npc" }
	S.description = "Memory Consolidation Utility Reasoning: scored option selection with response curves for the Memory Consolidation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.consolidation.utility_reasoning", momentum = 0.09 })
		inst.system = S
		inst.ctx = ctx
