-- ARKHER SYSTEM T.0415 :: Device Reasoning Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0415"
	S.key = "arkher.ai.devicereasoning.working_memory"
	S.name = "Device Reasoning Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.devicereasoning.outcome_prediction" }
	S.tags = { "t", "devicereasoning", "memory", "ai" }
	S.description = "Device Reasoning Working Memory: decaying, consolidating recall of what the agent learned for the Device Reasoning subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.devicereasoning.working_memory", capacity = 124, decayRate = 0.050, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
