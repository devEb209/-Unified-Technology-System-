-- ARKHER SYSTEM VD.0057 :: Epoch Frame Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0057"
	S.key = "arkher.contsim.epochframe.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.epochframe.world_memory_stream" }
	S.tags = { "vd", "epochframe", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.epochframe.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
