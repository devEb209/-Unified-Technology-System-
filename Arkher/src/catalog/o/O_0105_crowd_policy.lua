-- ARKHER SYSTEM O.0105 :: Crowd Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0105"
	S.key = "arkher.audio.crowd.playback_policy"
	S.name = "Crowd Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Crowd"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.crowd.compression_codec" }
	S.tags = { "o", "crowd", "policy", "audio" }
	S.description = "Crowd Playback Policy: rules choosing what may be heard right now for the Crowd subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.crowd.playback_policy", algorithm = "lottery", starvationGuard = 23 })
		inst.system = S
		inst.ctx = ctx
