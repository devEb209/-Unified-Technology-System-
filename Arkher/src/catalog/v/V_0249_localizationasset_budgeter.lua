-- ARKHER SYSTEM V.0249 :: Localization Asset Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0249"
	S.key = "arkher.asset.localizationasset.size_budget"
	S.name = "Localization Asset Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.localizationasset.compression_codec" }
	S.tags = { "v", "localizationasset", "budgeter", "asset" }
	S.description = "Localization Asset Size Budget: byte budget shared between competing asset classes for the Localization Asset subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.localizationasset.size_budget", total = 231, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
