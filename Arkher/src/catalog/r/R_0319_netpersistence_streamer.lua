-- ARKHER SYSTEM R.0319 :: Data Persistence Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0319"
	S.key = "arkher.net.netpersistence.interest_streaming"
	S.name = "Data Persistence Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netpersistence.serialization_codec" }
	S.tags = { "r", "netpersistence", "streamer", "net" }
	S.description = "Data Persistence Interest Streaming: distance-driven residency of replicated content for the Data Persistence subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.netpersistence.interest_streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
