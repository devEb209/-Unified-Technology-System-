-- ARKHER SYSTEM H.0463 :: Hinge Joint Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0463"
	S.key = "arkher.physics.hingejoint.body_dynamics"
	S.name = "Hinge Joint Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Hinge Joint"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "hingejoint", "rigidbody", "physics" }
	S.description = "Hinge Joint Body Dynamics: integration, impulses, damping and sleeping of a body for the Hinge Joint subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.hingejoint.body_dynamics", mass = 15.00, radius = 1.00, restitution = 0.34, friction = 0.54, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
