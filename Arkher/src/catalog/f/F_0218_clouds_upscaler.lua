-- ARKHER SYSTEM F.0218 :: Cloud Rendering Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0218"
	S.key = "arkher.render.clouds.adaptive_resolution"
	S.name = "Cloud Rendering Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.clouds.temporal_resolve" }
	S.tags = { "f", "clouds", "upscaler", "render" }
	S.description = "Cloud Rendering Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Cloud Rendering subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.clouds.adaptive_resolution", targetMs = 14.10, index = 3, sharpness = 0.25 })
		inst.system = S
		inst.ctx = ctx
