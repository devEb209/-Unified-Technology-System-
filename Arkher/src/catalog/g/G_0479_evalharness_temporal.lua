-- ARKHER SYSTEM G.0479 :: Evaluation Harness Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0479"
	S.key = "arkher.neural.evalharness.temporal_history"
	S.name = "Evaluation Harness Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.evalharness.feature_extraction" }
	S.tags = { "g", "evalharness", "temporal", "neural" }
	S.description = "Evaluation Harness Temporal History: history buffers reused across frames for the Evaluation Harness subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.evalharness.temporal_history", feedback = 0.88, phase = 8 })
		inst.system = S
		inst.ctx = ctx
