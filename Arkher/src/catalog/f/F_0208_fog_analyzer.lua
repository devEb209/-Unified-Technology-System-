-- ARKHER SYSTEM F.0208 :: Fog Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0208"
	S.key = "arkher.render.fog.frame_analysis"
	S.name = "Fog Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Fog"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.fog.pass_cache" }
	S.tags = { "f", "fog", "analyzer", "render" }
	S.description = "Fog Frame Analysis: per-pass cost analysis and outlier detection for the Fog subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.fog.frame_analysis", window = 107, buckets = 19, threshold = 4.90 })
		inst.system = S
		inst.ctx = ctx
