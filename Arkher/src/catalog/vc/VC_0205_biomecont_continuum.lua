-- ARKHER SYSTEM VC.0205 :: Biome Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0205"
	S.key = "arkher.contneural.biomecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "biomecont", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.biomecont.infinite_grid", cellSize = 96, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
