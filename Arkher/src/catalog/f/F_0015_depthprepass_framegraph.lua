-- ARKHER SYSTEM F.0015 :: Depth Prepass Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0015"
	S.key = "arkher.render.depthprepass.frame_graph"
	S.name = "Depth Prepass Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "depthprepass", "framegraph", "render" }
	S.description = "Depth Prepass Frame Graph: declared passes, culling, ordering and aliasing for the Depth Prepass subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.depthprepass.frame_graph", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
