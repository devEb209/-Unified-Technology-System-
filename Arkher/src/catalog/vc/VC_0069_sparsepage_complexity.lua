-- ARKHER SYSTEM VC.0069 :: Sparse Page Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0069"
	S.key = "arkher.contneural.sparsepage.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.sparsepage.world_memory_stream" }
	S.tags = { "vc", "sparsepage", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.sparsepage.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
