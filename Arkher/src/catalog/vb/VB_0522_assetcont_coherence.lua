-- ARKHER SYSTEM VB.0522 :: Asset Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0522"
	S.key = "arkher.conttime.assetcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.assetcont.persistent_state" }
	S.tags = { "vb", "assetcont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.assetcont.coherence_guard", window = 125, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
