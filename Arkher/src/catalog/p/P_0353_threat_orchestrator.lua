-- ARKHER SYSTEM P.0353 :: Threat State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0353"
	S.key = "arkher.play.threat.state_machine"
	S.name = "Threat State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Threat"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.threat.combat_resolution" }
	S.tags = { "p", "threat", "orchestrator", "play" }
	S.description = "Threat State Machine: the phase machine that drives this gameplay loop for the Threat subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.threat.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
