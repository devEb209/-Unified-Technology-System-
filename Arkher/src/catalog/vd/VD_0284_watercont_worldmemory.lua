-- ARKHER SYSTEM VD.0284 :: Water Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0284"
	S.key = "arkher.contsim.watercont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.watercont.neural_field" }
	S.tags = { "vd", "watercont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.watercont.world_memory_stream", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
