-- ARKHER SYSTEM VB.0398 :: Perception Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0398"
	S.key = "arkher.conttime.perceptioncont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.perceptioncont.infinite_grid" }
	S.tags = { "vb", "perceptioncont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.perceptioncont.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
