-- ARKHER SYSTEM J.0184 :: Accessory Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0184"
	S.key = "arkher.character.accessory.variant_registry"
	S.name = "Accessory Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.accessory.appearance_composer" }
	S.tags = { "j", "accessory", "registry", "character" }
	S.description = "Accessory Variant Registry: named character variants and their lifecycle for the Accessory subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.accessory.variant_registry" })
		inst.system = S
		inst.ctx = ctx
