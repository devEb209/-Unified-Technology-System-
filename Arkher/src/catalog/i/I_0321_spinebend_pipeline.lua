-- ARKHER SYSTEM I.0321 :: Spine Bend Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0321"
	S.key = "arkher.anim.spinebend.playback_pipeline"
	S.name = "Spine Bend Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Spine Bend"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.spinebend.event_ledger" }
	S.tags = { "i", "spinebend", "pipeline", "anim" }
	S.description = "Spine Bend Playback Pipeline: ordered sample, blend, ik and output stages for the Spine Bend subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.spinebend.playback_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
