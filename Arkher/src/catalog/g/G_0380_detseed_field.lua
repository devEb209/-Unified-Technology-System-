-- ARKHER SYSTEM G.0380 :: Deterministic Seeding Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0380"
	S.key = "arkher.neural.detseed.feature_extraction"
	S.name = "Deterministic Seeding Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detseed.inference_core" }
	S.tags = { "g", "detseed", "field", "neural" }
	S.description = "Deterministic Seeding Feature Extraction: signal features feeding the model for the Deterministic Seeding subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.detseed.feature_extraction", seed = 79030, frequency = 0.0115, octaves = 5, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
