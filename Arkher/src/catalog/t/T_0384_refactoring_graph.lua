-- ARKHER SYSTEM T.0384 :: Refactoring Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0384"
	S.key = "arkher.ai.refactoring.reasoning_graph"
	S.name = "Refactoring Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.refactoring.world_architect" }
	S.tags = { "t", "refactoring", "graph", "ai" }
	S.description = "Refactoring Reasoning Graph: relationship modelling and shortest-path reasoning for the Refactoring subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.refactoring.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
