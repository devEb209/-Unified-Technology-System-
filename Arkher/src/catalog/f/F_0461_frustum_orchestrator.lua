-- ARKHER SYSTEM F.0461 :: Frustum Culling Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0461"
	S.key = "arkher.render.frustum.orchestration"
	S.name = "Frustum Culling Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.frustum.frame_analysis" }
	S.tags = { "f", "frustum", "orchestrator", "render" }
	S.description = "Frustum Culling Orchestration: frame lifecycle orchestration for the Frustum Culling subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.frustum.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
