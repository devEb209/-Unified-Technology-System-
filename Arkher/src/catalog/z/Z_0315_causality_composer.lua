-- ARKHER SYSTEM Z.0315 :: Causality Ledger Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0315"
	S.key = "arkher.origin.causality.signal_composition"
	S.name = "Causality Ledger Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.telemetry_ledger" }
	S.tags = { "z", "causality", "composer", "origin" }
	S.description = "Causality Ledger Signal Composition: blending of the technology's input signals into one output for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.causality.signal_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
