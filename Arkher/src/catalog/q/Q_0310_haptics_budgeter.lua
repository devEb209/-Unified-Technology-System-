-- ARKHER SYSTEM Q.0310 :: Haptics Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0310"
	S.key = "arkher.ui.haptics.frame_budget"
	S.name = "Haptics Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Haptics"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.haptics.accessibility_policy" }
	S.tags = { "q", "haptics", "budgeter", "ui" }
	S.description = "Haptics Frame Budget: per-frame layout and draw budget for the interface for the Haptics subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.haptics.frame_budget", total = 352, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
