-- ARKHER SYSTEM V.0002 :: Mesh Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0002"
	S.key = "arkher.asset.meshasset.bundling"
	S.name = "Mesh Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.meshasset.import" }
	S.tags = { "v", "meshasset", "bundler", "asset" }
	S.description = "Mesh Bundling: size-bounded packing, manifests and delta patches for the Mesh subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.meshasset.bundling", maxBundleBytes = 524288 })
		inst.system = S
		inst.ctx = ctx
