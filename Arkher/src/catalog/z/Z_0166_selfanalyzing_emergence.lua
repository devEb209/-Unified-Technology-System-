-- ARKHER SYSTEM Z.0166 :: Self Analyzing Project Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0166"
	S.key = "arkher.origin.selfanalyzing.emergence_detection"
	S.name = "Self Analyzing Project Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.world_memory" }
	S.tags = { "z", "selfanalyzing", "emergence", "origin" }
	S.description = "Self Analyzing Project Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.selfanalyzing.emergence_detection", windowSize = 4, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
