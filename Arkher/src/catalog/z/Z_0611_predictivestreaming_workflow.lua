-- ARKHER SYSTEM Z.0611 :: Predictive Streaming Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0611"
	S.key = "arkher.origin.predictivestreaming.adaptive_workflow"
	S.name = "Predictive Streaming Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictivestreaming.self_critique" }
	S.tags = { "z", "predictivestreaming", "workflow", "origin" }
	S.description = "Predictive Streaming Adaptive Workflow: verified, retryable, reversible execution plans for the Predictive Streaming subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.predictivestreaming.adaptive_workflow", maxRetries = 1, budget = 70 })
		inst.system = S
		inst.ctx = ctx
