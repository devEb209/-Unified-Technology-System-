-- ARKHER SYSTEM V.0386 :: Platform Variant Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0386"
	S.key = "arkher.asset.platformvariant.bundling"
	S.name = "Platform Variant Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.platformvariant.import" }
	S.tags = { "v", "platformvariant", "bundler", "asset" }
	S.description = "Platform Variant Bundling: size-bounded packing, manifests and delta patches for the Platform Variant subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.platformvariant.bundling", maxBundleBytes = 655360 })
		inst.system = S
		inst.ctx = ctx
