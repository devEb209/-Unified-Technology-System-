-- ARKHER SYSTEM K.0163 :: Safety Drive Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0163"
	S.key = "arkher.npc.safetydrive.navigation"
	S.name = "Safety Drive Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.safetydrive.goal_planner" }
	S.tags = { "k", "safetydrive", "navgraph", "npc" }
	S.description = "Safety Drive Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Safety Drive subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.safetydrive.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
