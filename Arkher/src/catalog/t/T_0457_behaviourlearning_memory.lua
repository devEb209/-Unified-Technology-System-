-- ARKHER SYSTEM T.0457 :: Behaviour Learning Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0457"
	S.key = "arkher.ai.behaviourlearning.working_memory"
	S.name = "Behaviour Learning Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.behaviourlearning.outcome_prediction" }
	S.tags = { "t", "behaviourlearning", "memory", "ai" }
	S.description = "Behaviour Learning Working Memory: decaying, consolidating recall of what the agent learned for the Behaviour Learning subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.behaviourlearning.working_memory", capacity = 33, decayRate = 0.035, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
