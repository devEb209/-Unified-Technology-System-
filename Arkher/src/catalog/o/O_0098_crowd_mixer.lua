-- ARKHER SYSTEM O.0098 :: Crowd Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0098"
	S.key = "arkher.audio.crowd.mixer_bus"
	S.name = "Crowd Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Crowd"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.crowd.dsp_chain" }
	S.tags = { "o", "crowd", "mixer", "audio" }
	S.description = "Crowd Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Crowd subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.crowd.mixer_bus", maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
