-- ARKHER SYSTEM Z.1018 :: Capability Discovery Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.1018"
	S.key = "arkher.origin.capabilitydiscovery.budget_governor"
	S.name = "Capability Discovery Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.behaviour_analysis" }
	S.tags = { "z", "capabilitydiscovery", "budgeter", "origin" }
	S.description = "Capability Discovery Budget Governor: allocation of a scarce resource across the technology's consumers for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.capabilitydiscovery.budget_governor", total = 262, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
