-- ARKHER SYSTEM F.0365 :: Render Scale Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0365"
	S.key = "arkher.render.renderscale.frame_graph"
	S.name = "Render Scale Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Render Scale"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "renderscale", "framegraph", "render" }
	S.description = "Render Scale Frame Graph: declared passes, culling, ordering and aliasing for the Render Scale subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.renderscale.frame_graph", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
