-- ARKHER SYSTEM L.0499 :: War Society
...
return function(A)
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.war.economy" }
	S.tags = { "l", "war", "society", "sim" }
	S.description = "War Society: relations, factions, reputation and cohesion of the region for the War subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.war.society", decayRate = 0.013, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
