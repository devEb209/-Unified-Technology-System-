-- ARKHER SYSTEM G.0129 :: Detail Synthesis Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0129"
	S.key = "arkher.neural.detailsynth.temporal_history"
	S.name = "Detail Synthesis Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detailsynth.feature_extraction" }
	S.tags = { "g", "detailsynth", "temporal", "neural" }
	S.description = "Detail Synthesis Temporal History: history buffers reused across frames for the Detail Synthesis subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.detailsynth.temporal_history", feedback = 0.89, phase = 8 })
		inst.system = S
		inst.ctx = ctx
