-- ARKHER SYSTEM VA.0499 :: Rendering Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0499"
	S.key = "arkher.contworld.rendercont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.rendercont.coherence_guard" }
	S.tags = { "va", "rendercont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.rendercont.neural_field", dims = 16, hidden = 12, seed = 54065 })
		inst.system = S
		inst.ctx = ctx
