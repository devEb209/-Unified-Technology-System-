-- ARKHER SYSTEM I.0172 :: Crossfade Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0172"
	S.key = "arkher.anim.crossfade.layered_blending"
	S.name = "Crossfade Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Crossfade"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crossfade.clip_sampling" }
	S.tags = { "i", "crossfade", "animator", "anim" }
	S.description = "Crossfade Layered Blending: layers, crossfades, masks and blend trees for the Crossfade subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.crossfade.layered_blending", budget = 7 })
		inst.system = S
		inst.ctx = ctx
