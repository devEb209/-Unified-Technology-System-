-- ARKHER SYSTEM N.0114 :: Blood Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0114"
	S.key = "arkher.vfx.blood.quality_policy"
	S.name = "Blood Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Blood"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.blood.result_cache" }
	S.tags = { "n", "blood", "policy", "vfx" }
	S.description = "Blood Quality Policy: distance and device driven fidelity bands for the Blood subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.blood.quality_policy", algorithm = "roundrobin", starvationGuard = 28 })
		inst.system = S
		inst.ctx = ctx
