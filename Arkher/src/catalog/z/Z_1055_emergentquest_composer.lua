-- ARKHER SYSTEM Z.1055 :: Emergent Quest Generation Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.1055"
	S.key = "arkher.origin.emergentquest.signal_composition"
	S.name = "Emergent Quest Generation Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentquest.telemetry_ledger" }
	S.tags = { "z", "emergentquest", "composer", "origin" }
	S.description = "Emergent Quest Generation Signal Composition: blending of the technology's input signals into one output for the Emergent Quest Generation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.emergentquest.signal_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
