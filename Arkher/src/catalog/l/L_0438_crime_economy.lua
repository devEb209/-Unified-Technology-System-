-- ARKHER SYSTEM L.0438 :: Crime Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0438"
	S.key = "arkher.sim.crime.economy"
	S.name = "Crime Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.crime.ecology" }
	S.tags = { "l", "crime", "economy", "sim" }
	S.description = "Crime Economy: stock, production, demand, price discovery and trade for the Crime subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.crime.economy", elasticity = 0.40 })
		inst.system = S
		inst.ctx = ctx
