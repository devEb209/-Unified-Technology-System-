-- ARKHER SYSTEM F.0680 :: Console Path Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0680"
	S.key = "arkher.render.consolepath.adaptive_resolution"
	S.name = "Console Path Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Console Path"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.consolepath.temporal_resolve" }
	S.tags = { "f", "consolepath", "upscaler", "render" }
	S.description = "Console Path Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Console Path subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.consolepath.adaptive_resolution", targetMs = 14.10, index = 3, sharpness = 0.53 })
		inst.system = S
		inst.ctx = ctx
