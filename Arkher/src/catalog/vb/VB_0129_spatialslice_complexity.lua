-- ARKHER SYSTEM VB.0129 :: Spatial Slice Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0129"
	S.key = "arkher.conttime.spatialslice.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.spatialslice.world_memory_stream" }
	S.tags = { "vb", "spatialslice", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.spatialslice.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
