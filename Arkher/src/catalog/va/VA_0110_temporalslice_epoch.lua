-- ARKHER SYSTEM VA.0110 :: Temporal Slice Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0110"
	S.key = "arkher.contworld.temporalslice.epoch_clock"
	S.name = "Temporal Slice Epoch Clock"
	S.category = "VA"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.temporalslice.infinite_grid" }
	S.tags = { "va", "temporalslice", "epoch", "contworld" }
	S.description = "Temporal Slice Epoch Clock: deterministic epoch timeline with catch-up for the Temporal Slice subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.temporalslice.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
