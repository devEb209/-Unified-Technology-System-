-- ARKHER SYSTEM I.0010 :: Skeleton Rig Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0010"
	S.key = "arkher.anim.skeletonrig.pose_cache"
	S.name = "Skeleton Rig Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Skeleton Rig"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.skeletonrig.playback_pipeline" }
	S.tags = { "i", "skeletonrig", "cache", "anim" }
	S.description = "Skeleton Rig Pose Cache: reuse of sampled poses across frames and instances for the Skeleton Rig subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.skeletonrig.pose_cache", policy = "lfu", capacity = 356, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
