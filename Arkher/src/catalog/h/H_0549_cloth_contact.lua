-- ARKHER SYSTEM H.0549 :: Cloth Simulation Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0549"
	S.key = "arkher.physics.cloth.contact_generation"
	S.name = "Cloth Simulation Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.cloth.collision_shape" }
	S.tags = { "h", "cloth", "contact", "physics" }
	S.description = "Cloth Simulation Contact Generation: narrow-phase manifolds with normal, depth and point for the Cloth Simulation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.cloth.contact_generation", slop = 0.0070, maxManifolds = 475 })
		inst.system = S
		inst.ctx = ctx
