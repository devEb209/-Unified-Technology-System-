-- ARKHER SYSTEM F.0077 :: Cascade Shadows Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0077"
	S.key = "arkher.render.cascades.temporal_resolve"
	S.name = "Cascade Shadows Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.cascades.probe_volume" }
	S.tags = { "f", "cascades", "temporal", "render" }
	S.description = "Cascade Shadows Temporal Resolve: history reprojection with neighbourhood clamping for the Cascade Shadows subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.cascades.temporal_resolve", feedback = 0.90, phase = 8 })
		inst.system = S
		inst.ctx = ctx
