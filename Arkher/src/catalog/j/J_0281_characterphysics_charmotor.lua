-- ARKHER SYSTEM J.0281 :: Character Physics Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0281"
	S.key = "arkher.character.characterphysics.locomotion"
	S.name = "Character Physics Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterphysics.physical_response" }
	S.tags = { "j", "characterphysics", "charmotor", "character" }
	S.description = "Character Physics Locomotion: capsule locomotion driving the character for the Character Physics subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.characterphysics.locomotion", radius = 0.49, height = 1.74, maxSpeed = 9.40, jumpHeight = 1.80, stepOffset = 0.49 })
		inst.system = S
		inst.ctx = ctx
