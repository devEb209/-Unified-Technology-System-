-- ARKHER SYSTEM VC.0247 :: Vegetation Field Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0247"
	S.key = "arkher.contneural.vegfield.neural_field"
	S.name = "Vegetation Field Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vegfield.coherence_guard" }
	S.tags = { "vc", "vegfield", "neuralfield", "contneural" }
	S.description = "Vegetation Field Neural Field: neural field encoding and reconstruction for the Vegetation Field subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.vegfield.neural_field", dims = 24, hidden = 20, seed = 54367 })
		inst.system = S
		inst.ctx = ctx
