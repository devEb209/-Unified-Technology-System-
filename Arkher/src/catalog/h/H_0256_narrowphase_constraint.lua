-- ARKHER SYSTEM H.0256 :: Narrowphase Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0256"
	S.key = "arkher.physics.narrowphase.constraint_solver"
	S.name = "Narrowphase Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Narrowphase"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.narrowphase.contact_generation" }
	S.tags = { "h", "narrowphase", "constraint", "physics" }
	S.description = "Narrowphase Constraint Solver: sequential impulses, friction, joints and warm starting for the Narrowphase subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.narrowphase.constraint_solver", iterations = 12, baumgarte = 0.28, warmStart = true })
		inst.system = S
		inst.ctx = ctx
