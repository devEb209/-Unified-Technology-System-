-- ARKHER SYSTEM P.0350 :: Threat Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0350"
	S.key = "arkher.play.threat.inventory"
	S.name = "Threat Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Threat"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.threat.attributes" }
	S.tags = { "p", "threat", "inventory", "play" }
	S.description = "Threat Inventory: slots, stacking, weight, equipment and crafting for the Threat subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.threat.inventory", slots = 16, maxWeight = 50 })
		inst.system = S
		inst.ctx = ctx
