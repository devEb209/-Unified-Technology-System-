-- ARKHER SYSTEM F.0482 :: Impostor Rendering Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0482"
	S.key = "arkher.render.impostorrender.probe_volume"
	S.name = "Impostor Rendering Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.impostorrender.lighting_rig" }
	S.tags = { "f", "impostorrender", "probe", "render" }
	S.description = "Impostor Rendering Probe Volume: irradiance probes encoded in spherical harmonics for the Impostor Rendering subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.impostorrender.probe_volume", spacing = 8 })
		inst.system = S
		inst.ctx = ctx
