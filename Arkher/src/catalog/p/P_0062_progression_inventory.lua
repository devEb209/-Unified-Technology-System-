-- ARKHER SYSTEM P.0062 :: Progression Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0062"
	S.key = "arkher.play.progression.inventory"
	S.name = "Progression Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Progression"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.progression.attributes" }
	S.tags = { "p", "progression", "inventory", "play" }
	S.description = "Progression Inventory: slots, stacking, weight, equipment and crafting for the Progression subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.progression.inventory", slots = 20, maxWeight = 60 })
		inst.system = S
		inst.ctx = ctx
