-- ARKHER SYSTEM K.0326 :: Curiosity Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0326"
	S.key = "arkher.npc.curiosity.emotion"
	S.name = "Curiosity Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.curiosity.drive_system" }
	S.tags = { "k", "curiosity", "emotion", "npc" }
	S.description = "Curiosity Emotion: appraisal of events into valence, arousal and mood for the Curiosity subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.curiosity.emotion", inertia = 0.92, decayRate = 0.37, baselineArousal = 0.27 })
		inst.system = S
		inst.ctx = ctx
