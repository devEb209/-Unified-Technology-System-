-- ARKHER SYSTEM VD.0112 :: Temporal Slice Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0112"
	S.key = "arkher.contsim.temporalslice.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.temporalslice.sparse_residency" }
	S.tags = { "vd", "temporalslice", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.temporalslice.multi-scale_fidelity", levels = 5, baseTriangles = 90000 })
		inst.system = S
		inst.ctx = ctx
