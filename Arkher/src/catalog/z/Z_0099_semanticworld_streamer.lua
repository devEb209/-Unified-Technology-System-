-- ARKHER SYSTEM Z.0099 :: Semantic World Graph Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0099"
	S.key = "arkher.origin.semanticworld.residency_streaming"
	S.name = "Semantic World Graph Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticworld.budget_governor" }
	S.tags = { "z", "semanticworld", "streamer", "origin" }
	S.description = "Semantic World Graph Residency Streaming: distance-driven residency of the technology's workload for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.semanticworld.residency_streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
