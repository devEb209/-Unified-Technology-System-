-- ARKHER SYSTEM K.0319 :: Threat Assessment Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0319"
	S.key = "arkher.npc.threatassessment.social_relations"
	S.name = "Threat Assessment Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.threatassessment.crowd_steering" }
	S.tags = { "k", "threatassessment", "society", "npc" }
	S.description = "Threat Assessment Social Relations: affinity, factions, reputation and gossip for the Threat Assessment subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.threatassessment.social_relations", decayRate = 0.008, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
