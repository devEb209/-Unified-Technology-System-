-- ARKHER SYSTEM E.0556 :: Material Preview Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0556"
	S.key = "arkher.material.preview.definition"
	S.name = "Material Preview Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "preview", "material", "material" }
	S.description = "Material Preview Definition: layered PBR definition resolved into parameters for the Material Preview subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.preview.definition", texelBudget = 1310720 })
		inst.system = S
		inst.ctx = ctx
