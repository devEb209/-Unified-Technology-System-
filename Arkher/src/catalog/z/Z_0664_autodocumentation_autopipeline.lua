-- ARKHER SYSTEM Z.0664 :: Auto Documentation Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0664"
	S.key = "arkher.origin.autodocumentation.autonomous_pipeline"
	S.name = "Auto Documentation Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.simulation_fabric" }
	S.tags = { "z", "autodocumentation", "autopipeline", "origin" }
	S.description = "Auto Documentation Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.autodocumentation.autonomous_pipeline", maxIterations = 7 })
		inst.system = S
		inst.ctx = ctx
