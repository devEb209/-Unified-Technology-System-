-- ARKHER SYSTEM F.0023 :: Depth Prepass Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0023"
	S.key = "arkher.render.depthprepass.draw_budget"
	S.name = "Depth Prepass Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.depthprepass.adaptive_resolution" }
	S.tags = { "f", "depthprepass", "budgeter", "render" }
	S.description = "Depth Prepass Draw Budget: draw call and triangle budget allocation for the Depth Prepass subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.depthprepass.draw_budget", total = 229, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
