-- ARKHER SYSTEM VD.0183 :: Simulation Domain Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0183"
	S.key = "arkher.contsim.simdomain.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.simdomain.epoch_clock" }
	S.tags = { "vd", "simdomain", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.simdomain.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
