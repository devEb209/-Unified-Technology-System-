-- ARKHER SYSTEM O.0249 :: Combat Music Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0249"
	S.key = "arkher.audio.combatmusic.playback_policy"
	S.name = "Combat Music Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Combat Music"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.combatmusic.compression_codec" }
	S.tags = { "o", "combatmusic", "policy", "audio" }
	S.description = "Combat Music Playback Policy: rules choosing what may be heard right now for the Combat Music subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.combatmusic.playback_policy", algorithm = "wfq", starvationGuard = 54 })
		inst.system = S
		inst.ctx = ctx
