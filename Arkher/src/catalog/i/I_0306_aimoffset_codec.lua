-- ARKHER SYSTEM I.0306 :: Aim Offset Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0306"
	S.key = "arkher.anim.aimoffset.compression_codec"
	S.name = "Aim Offset Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Aim Offset"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.aimoffset.retarget_graph" }
	S.tags = { "i", "aimoffset", "codec", "anim" }
	S.description = "Aim Offset Compression Codec: curve compression and quantized transport for the Aim Offset subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.aimoffset.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
