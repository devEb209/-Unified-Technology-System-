-- ARKHER SYSTEM VC.0137 :: Fidelity Band Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0137"
	S.key = "arkher.contneural.fidelityband.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.fidelityband.multi-scale_fidelity" }
	S.tags = { "vc", "fidelityband", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.fidelityband.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
