-- ARKHER SYSTEM Z.0700 :: Auto Test Synthesis Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0700"
	S.key = "arkher.origin.autotest.orchestration"
	S.name = "Auto Test Synthesis Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autotest.residency_streaming" }
	S.tags = { "z", "autotest", "orchestrator", "origin" }
	S.description = "Auto Test Synthesis Orchestration: lifecycle and phase orchestration of the technology for the Auto Test Synthesis subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.autotest.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
