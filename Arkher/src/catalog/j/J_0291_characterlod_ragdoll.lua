-- ARKHER SYSTEM J.0291 :: Character LOD Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0291"
	S.key = "arkher.character.characterlod.physical_response"
	S.name = "Character LOD Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterlod.look_and_reach" }
	S.tags = { "j", "characterlod", "ragdoll", "character" }
	S.description = "Character LOD Physical Response: physical reaction, ragdoll and recovery for the Character LOD subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.characterlod.physical_response", blendSpeed = 5.70 })
		inst.system = S
		inst.ctx = ctx
