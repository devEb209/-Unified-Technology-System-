-- ARKHER SYSTEM T.0414 :: Device Reasoning Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0414"
	S.key = "arkher.ai.devicereasoning.outcome_prediction"
	S.name = "Device Reasoning Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.devicereasoning.decision_policy" }
	S.tags = { "t", "devicereasoning", "predictor", "ai" }
	S.description = "Device Reasoning Outcome Prediction: forecasting the result before the work is done for the Device Reasoning subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.devicereasoning.outcome_prediction", method = "markov", alpha = 0.47, window = 37 })
		inst.system = S
		inst.ctx = ctx
