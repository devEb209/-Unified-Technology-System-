-- ARKHER SYSTEM V.0074 :: Animation Clip Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0074"
	S.key = "arkher.asset.animationclip.bundling"
	S.name = "Animation Clip Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.animationclip.import" }
	S.tags = { "v", "animationclip", "bundler", "asset" }
	S.description = "Animation Clip Bundling: size-bounded packing, manifests and delta patches for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.animationclip.bundling", maxBundleBytes = 786432 })
		inst.system = S
		inst.ctx = ctx
