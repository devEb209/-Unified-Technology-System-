-- ARKHER SYSTEM L.0396 :: Wealth Distribution Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0396"
	S.key = "arkher.sim.wealth.region_graph"
	S.name = "Wealth Distribution Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wealth.calendar" }
	S.tags = { "l", "wealth", "graph", "sim" }
	S.description = "Wealth Distribution Region Graph: connectivity, components and shortest path between places for the Wealth Distribution subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.wealth.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
