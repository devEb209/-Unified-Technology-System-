-- ARKHER SYSTEM Z.0419 :: Battery Aware Pipeline Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0419"
	S.key = "arkher.origin.batteryaware.residency_streaming"
	S.name = "Battery Aware Pipeline Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.batteryaware.budget_governor" }
	S.tags = { "z", "batteryaware", "streamer", "origin" }
	S.description = "Battery Aware Pipeline Residency Streaming: distance-driven residency of the technology's workload for the Battery Aware Pipeline subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.batteryaware.residency_streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
