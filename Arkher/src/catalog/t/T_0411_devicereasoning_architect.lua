-- ARKHER SYSTEM T.0411 :: Device Reasoning World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0411"
	S.key = "arkher.ai.devicereasoning.world_architect"
	S.name = "Device Reasoning World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.devicereasoning.self_critique" }
	S.tags = { "t", "devicereasoning", "architect", "ai" }
	S.description = "Device Reasoning World Architect: composition of a whole world plan with conserved budgets for the Device Reasoning subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.devicereasoning.world_architect", budget = 800, seed = 10192 })
		inst.system = S
		inst.ctx = ctx
