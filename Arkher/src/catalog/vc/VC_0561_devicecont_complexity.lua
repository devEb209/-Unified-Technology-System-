-- ARKHER SYSTEM VC.0561 :: Device Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0561"
	S.key = "arkher.contneural.devicecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.devicecont.world_memory_stream" }
	S.tags = { "vc", "devicecont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.devicecont.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
