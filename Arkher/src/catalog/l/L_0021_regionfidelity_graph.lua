-- ARKHER SYSTEM L.0021 :: Region Fidelity Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0021"
	S.key = "arkher.sim.regionfidelity.region_graph"
	S.name = "Region Fidelity Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.regionfidelity.calendar" }
	S.tags = { "l", "regionfidelity", "graph", "sim" }
	S.description = "Region Fidelity Region Graph: connectivity, components and shortest path between places for the Region Fidelity subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.regionfidelity.region_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
