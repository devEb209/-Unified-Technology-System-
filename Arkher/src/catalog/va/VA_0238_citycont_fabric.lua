-- ARKHER SYSTEM VA.0238 :: City Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0238"
	S.key = "arkher.contworld.citycont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.citycont.complexity_budget" }
	S.tags = { "va", "citycont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.citycont.simulation_fabric", budgetMs = 3.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
