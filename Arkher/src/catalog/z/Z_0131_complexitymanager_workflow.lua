-- ARKHER SYSTEM Z.0131 :: Dynamic Complexity Manager Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0131"
	S.key = "arkher.origin.complexitymanager.adaptive_workflow"
	S.name = "Dynamic Complexity Manager Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.self_critique" }
	S.tags = { "z", "complexitymanager", "workflow", "origin" }
	S.description = "Dynamic Complexity Manager Adaptive Workflow: verified, retryable, reversible execution plans for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.complexitymanager.adaptive_workflow", maxRetries = 1, budget = 130 })
		inst.system = S
		inst.ctx = ctx
