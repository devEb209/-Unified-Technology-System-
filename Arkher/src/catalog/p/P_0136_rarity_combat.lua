-- ARKHER SYSTEM P.0136 :: Rarity Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0136"
	S.key = "arkher.play.rarity.combat_resolution"
	S.name = "Rarity Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Rarity"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.rarity.objectives" }
	S.tags = { "p", "rarity", "combat", "play" }
	S.description = "Rarity Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Rarity subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.rarity.combat_resolution", seed = 74618, armourK = 100, critMultiplier = 1.70 })
		inst.system = S
		inst.ctx = ctx
