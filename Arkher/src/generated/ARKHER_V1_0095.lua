--!strict
-- Frostbite Frosty — ANIMATION Stack #0095
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Frostbite Frosty — ANIMATION Stack #0095", size=Vector2.new(680, 420), pos=UDim2.fromOffset(135, 135), parent=parent, icon="↻"})
