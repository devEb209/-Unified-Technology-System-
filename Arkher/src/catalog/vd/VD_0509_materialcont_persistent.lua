-- ARKHER SYSTEM VD.0509 :: Material Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0509"
	S.key = "arkher.contsim.materialcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.materialcont.multi-scale_fidelity" }
	S.tags = { "vd", "materialcont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.materialcont.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
