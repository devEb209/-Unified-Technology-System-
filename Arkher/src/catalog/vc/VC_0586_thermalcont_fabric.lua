-- ARKHER SYSTEM VC.0586 :: Thermal Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0586"
	S.key = "arkher.contneural.thermalcont.simulation_fabric"
	S.name = "Thermal Continuum Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.thermalcont.complexity_budget" }
	S.tags = { "vc", "thermalcont", "fabric", "contneural" }
	S.description = "Thermal Continuum Simulation Fabric: fabric stepping the continuum domains for the Thermal Continuum subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.thermalcont.simulation_fabric", budgetMs = 3.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
