-- ARKHER SYSTEM T.0533 :: Animation Reasoning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0533"
	S.key = "arkher.ai.animationreasoning.intent_understanding"
	S.name = "Animation Reasoning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "animationreasoning", "intent", "ai" }
	S.description = "Animation Reasoning Intent Understanding: natural language turned into an actionable, scored intent for the Animation Reasoning subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.animationreasoning.intent_understanding", minConfidence = 0.40 })
		inst.system = S
		inst.ctx = ctx
