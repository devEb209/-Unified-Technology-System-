-- ARKHER SYSTEM Z.1088 :: Original Tech Debug Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.1088"
	S.key = "arkher.origin.origindebug.semantic_graph"
	S.name = "Original Tech Debug Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.origindebug.world_architect" }
	S.tags = { "z", "origindebug", "knowledge", "origin" }
	S.description = "Original Tech Debug Semantic Graph: typed entities and inferred relations of the technology itself for the Original Tech Debug subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.origindebug.semantic_graph", dims = 32 })
		inst.system = S
		inst.ctx = ctx
