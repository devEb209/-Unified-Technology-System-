-- ARKHER SYSTEM V.0234 :: Data Table Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0234"
	S.key = "arkher.asset.datatable.content_cache"
	S.name = "Data Table Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.datatable.dependency_graph" }
	S.tags = { "v", "datatable", "cache", "asset" }
	S.description = "Data Table Content Cache: reuse of already cooked results for the Data Table subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.datatable.content_cache", policy = "ttl", capacity = 75, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
