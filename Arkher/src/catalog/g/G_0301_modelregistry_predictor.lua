-- ARKHER SYSTEM G.0301 :: Model Registry Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0301"
	S.key = "arkher.neural.modelregistry.quality_predictor"
	S.name = "Model Registry Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelregistry.weight_codec" }
	S.tags = { "g", "modelregistry", "predictor", "neural" }
	S.description = "Model Registry Quality Predictor: predicted quality and cost of a setting for the Model Registry subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.modelregistry.quality_predictor", method = "ema", alpha = 0.31, window = 101 })
		inst.system = S
		inst.ctx = ctx
