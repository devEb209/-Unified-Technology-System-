-- ARKHER SYSTEM O.0021 :: Foley Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0021"
	S.key = "arkher.audio.foley.playback_policy"
	S.name = "Foley Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Foley"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.foley.compression_codec" }
	S.tags = { "o", "foley", "policy", "audio" }
	S.description = "Foley Playback Policy: rules choosing what may be heard right now for the Foley subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.foley.playback_policy", algorithm = "wfq", starvationGuard = 22 })
		inst.system = S
		inst.ctx = ctx
