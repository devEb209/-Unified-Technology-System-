-- ARKHER SYSTEM N.0476 :: Distortion Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0476"
	S.key = "arkher.vfx.distortion.spawn_budget"
	S.name = "Distortion Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Distortion"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.distortion.effect_composition" }
	S.tags = { "n", "distortion", "budgeter", "vfx" }
	S.description = "Distortion Spawn Budget: global particle budget shared by every live effect for the Distortion subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.distortion.spawn_budget", total = 420, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
