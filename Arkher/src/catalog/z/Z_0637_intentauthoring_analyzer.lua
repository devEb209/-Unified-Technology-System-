-- ARKHER SYSTEM Z.0637 :: Intent Driven Authoring Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0637"
	S.key = "arkher.origin.intentauthoring.behaviour_analysis"
	S.name = "Intent Driven Authoring Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.governance_policy" }
	S.tags = { "z", "intentauthoring", "analyzer", "origin" }
	S.description = "Intent Driven Authoring Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.intentauthoring.behaviour_analysis", window = 231, buckets = 19, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
