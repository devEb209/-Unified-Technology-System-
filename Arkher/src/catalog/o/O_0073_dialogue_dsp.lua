-- ARKHER SYSTEM O.0073 :: Dialogue DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0073"
	S.key = "arkher.audio.dialogue.dsp_chain"
	S.name = "Dialogue DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Dialogue"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "dialogue", "dsp", "audio" }
	S.description = "Dialogue DSP Chain: biquad filtering, delay, envelope and soft clipping for the Dialogue subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.dialogue.dsp_chain", sampleRate = 22050, filter = "notch", cutoff = 2400, q = 0.770 })
		inst.system = S
		inst.ctx = ctx
