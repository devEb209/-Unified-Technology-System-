-- ARKHER SYSTEM Z.0567 :: Collective Behaviour World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0567"
	S.key = "arkher.origin.collectivebehaviour.world_architect"
	S.name = "Collective Behaviour World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.collectivebehaviour.emergence_detection" }
	S.tags = { "z", "collectivebehaviour", "architect", "origin" }
	S.description = "Collective Behaviour World Architect: hierarchical world composition with conserved budgets for the Collective Behaviour subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.collectivebehaviour.world_architect", budget = 1300, seed = 23597 })
		inst.system = S
		inst.ctx = ctx
