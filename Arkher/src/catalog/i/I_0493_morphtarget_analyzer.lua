-- ARKHER SYSTEM I.0493 :: Morph Target Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0493"
	S.key = "arkher.anim.morphtarget.analysis"
	S.name = "Morph Target Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Morph Target"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.morphtarget.quality_policy" }
	S.tags = { "i", "morphtarget", "analyzer", "anim" }
	S.description = "Morph Target Analysis: pop, drift and cost analysis of playback for the Morph Target subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.morphtarget.analysis", window = 146, buckets = 18, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
