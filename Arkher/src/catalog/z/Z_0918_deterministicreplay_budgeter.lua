-- ARKHER SYSTEM Z.0918 :: Deterministic Replay Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0918"
	S.key = "arkher.origin.deterministicreplay.budget_governor"
	S.name = "Deterministic Replay Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deterministicreplay.behaviour_analysis" }
	S.tags = { "z", "deterministicreplay", "budgeter", "origin" }
	S.description = "Deterministic Replay Budget Governor: allocation of a scarce resource across the technology's consumers for the Deterministic Replay subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.deterministicreplay.budget_governor", total = 249, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
