-- ARKHER SYSTEM VB.0494 :: Rendering Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0494"
	S.key = "arkher.conttime.rendercont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.rendercont.infinite_grid" }
	S.tags = { "vb", "rendercont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.rendercont.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
