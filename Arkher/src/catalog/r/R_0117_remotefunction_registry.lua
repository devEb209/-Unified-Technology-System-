-- ARKHER SYSTEM R.0117 :: Remote Function Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0117"
	S.key = "arkher.net.remotefunction.session_registry"
	S.name = "Remote Function Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remotefunction.rate_guard" }
	S.tags = { "r", "remotefunction", "registry", "net" }
	S.description = "Remote Function Session Registry: catalogue of sessions, players and their metadata for the Remote Function subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.remotefunction.session_registry" })
		inst.system = S
		inst.ctx = ctx
