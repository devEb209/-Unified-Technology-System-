-- ARKHER SYSTEM VD.0159 :: Coherence Seam Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0159"
	S.key = "arkher.contsim.coherenceseam.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.coherenceseam.epoch_clock" }
	S.tags = { "vd", "coherenceseam", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.coherenceseam.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
