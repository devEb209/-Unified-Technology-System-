-- ARKHER SYSTEM VD.0001 :: World Grid Cell Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0001"
	S.key = "arkher.contsim.worldcell.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "worldcell", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.worldcell.infinite_grid", cellSize = 128, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
