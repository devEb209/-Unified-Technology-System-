-- ARKHER SYSTEM L.0426 :: Law Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0426"
	S.key = "arkher.sim.law.region_graph"
	S.name = "Law Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.law.calendar" }
	S.tags = { "l", "law", "graph", "sim" }
	S.description = "Law Region Graph: connectivity, components and shortest path between places for the Law subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.law.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
