-- ARKHER SYSTEM Z.0765 :: Semantic LOD World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0765"
	S.key = "arkher.origin.semanticlod.world_memory"
	S.name = "Semantic LOD World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticlod.autonomous_pipeline" }
	S.tags = { "z", "semanticlod", "worldmemory", "origin" }
	S.description = "Semantic LOD World Memory: epoch-stamped persistent history with compaction and checkpoints for the Semantic LOD subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.semanticlod.world_memory", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
