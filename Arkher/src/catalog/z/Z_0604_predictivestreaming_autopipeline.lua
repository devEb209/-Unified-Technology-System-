-- ARKHER SYSTEM Z.0604 :: Predictive Streaming Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0604"
	S.key = "arkher.origin.predictivestreaming.autonomous_pipeline"
	S.name = "Predictive Streaming Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictivestreaming.simulation_fabric" }
	S.tags = { "z", "predictivestreaming", "autopipeline", "origin" }
	S.description = "Predictive Streaming Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Predictive Streaming subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.predictivestreaming.autonomous_pipeline", maxIterations = 10 })
		inst.system = S
		inst.ctx = ctx
