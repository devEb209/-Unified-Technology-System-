-- ARKHER SYSTEM I.0512 :: Animation Debug Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0512"
	S.key = "arkher.anim.animdebug.physical_blend"
	S.name = "Animation Debug Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animdebug.inverse_kinematics" }
	S.tags = { "i", "animdebug", "ragdoll", "anim" }
	S.description = "Animation Debug Physical Blend: physical bones blended against the animated pose for the Animation Debug subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.animdebug.physical_blend", blendSpeed = 2.20 })
		inst.system = S
		inst.ctx = ctx
