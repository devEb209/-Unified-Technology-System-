-- ARKHER SYSTEM P.0185 :: Economy State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0185"
	S.key = "arkher.play.playereconomy.state_machine"
	S.name = "Economy State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Economy"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playereconomy.combat_resolution" }
	S.tags = { "p", "playereconomy", "orchestrator", "play" }
	S.description = "Economy State Machine: the phase machine that drives this gameplay loop for the Economy subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.playereconomy.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
