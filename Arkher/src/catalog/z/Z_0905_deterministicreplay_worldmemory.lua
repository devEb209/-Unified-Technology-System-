-- ARKHER SYSTEM Z.0905 :: Deterministic Replay World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0905"
	S.key = "arkher.origin.deterministicreplay.world_memory"
	S.name = "Deterministic Replay World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deterministicreplay.autonomous_pipeline" }
	S.tags = { "z", "deterministicreplay", "worldmemory", "origin" }
	S.description = "Deterministic Replay World Memory: epoch-stamped persistent history with compaction and checkpoints for the Deterministic Replay subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.deterministicreplay.world_memory", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
