-- ARKHER SYSTEM T.0192 :: Terrain Generation Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0192"
	S.key = "arkher.ai.terraingeneration.utility_selection"
	S.name = "Terrain Generation Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.terraingeneration.working_memory" }
	S.tags = { "t", "terraingeneration", "utility", "ai" }
	S.description = "Terrain Generation Utility Selection: scored choice between competing courses of action for the Terrain Generation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.terraingeneration.utility_selection", momentum = 0.16 })
		inst.system = S
		inst.ctx = ctx
