-- ARKHER SYSTEM H.0173 :: Sleeping Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0173"
	S.key = "arkher.physics.sleeping.query"
	S.name = "Sleeping Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Sleeping"
	S.aspect = "Query"
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sleeping.constraint_solver" }
	S.tags = { "h", "sleeping", "raycaster", "physics" }
	S.description = "Sleeping Query: rays, sweeps and overlaps against the simulation for the Sleeping subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.sleeping.query", cellSize = 16 })
		inst.system = S
		inst.ctx = ctx
