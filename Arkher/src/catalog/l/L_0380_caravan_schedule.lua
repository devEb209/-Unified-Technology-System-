-- ARKHER SYSTEM L.0380 :: Caravan Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0380"
	S.key = "arkher.sim.caravan.calendar"
	S.name = "Caravan Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.caravan.society" }
	S.tags = { "l", "caravan", "schedule", "sim" }
	S.description = "Caravan Calendar: hours, days and seasons driving the region for the Caravan subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.caravan.calendar", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
