-- ARKHER SYSTEM VA.0605 :: Seam Lattice Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0605"
	S.key = "arkher.contworld.seamlattice.persistent_state"
	S.name = "Seam Lattice Persistent State"
	S.category = "VA"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.seamlattice.multi-scale_fidelity" }
	S.tags = { "va", "seamlattice", "persistent", "contworld" }
	S.description = "Seam Lattice Persistent State: epoch-stamped persistent history and rollback for the Seam Lattice subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.seamlattice.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
