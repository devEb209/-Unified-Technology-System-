-- ARKHER SYSTEM Z.0686 :: Auto Test Synthesis Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0686"
	S.key = "arkher.origin.autotest.emergence_detection"
	S.name = "Auto Test Synthesis Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autotest.world_memory" }
	S.tags = { "z", "autotest", "emergence", "origin" }
	S.description = "Auto Test Synthesis Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Auto Test Synthesis subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.autotest.emergence_detection", windowSize = 4, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
