-- ARKHER SYSTEM P.0049 :: Talent Tree Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0049"
	S.key = "arkher.play.talenttree.attributes"
	S.name = "Talent Tree Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Talent Tree"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "talenttree", "stats", "play" }
	S.description = "Talent Tree Attributes: base values, layered modifiers and derived statistics for the Talent Tree subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.talenttree.attributes" })
		inst.system = S
		inst.ctx = ctx
