-- ARKHER SYSTEM T.0127 :: Skill Library Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0127"
	S.key = "arkher.ai.skilllibrary.intent_understanding"
	S.name = "Skill Library Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "skilllibrary", "intent", "ai" }
	S.description = "Skill Library Intent Understanding: natural language turned into an actionable, scored intent for the Skill Library subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.skilllibrary.intent_understanding", minConfidence = 0.38 })
		inst.system = S
		inst.ctx = ctx
