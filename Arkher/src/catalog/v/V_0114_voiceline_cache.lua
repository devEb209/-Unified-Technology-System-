-- ARKHER SYSTEM V.0114 :: Voice Line Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0114"
	S.key = "arkher.asset.voiceline.content_cache"
	S.name = "Voice Line Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.voiceline.dependency_graph" }
	S.tags = { "v", "voiceline", "cache", "asset" }
	S.description = "Voice Line Content Cache: reuse of already cooked results for the Voice Line subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.voiceline.content_cache", policy = "lfu", capacity = 411, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
