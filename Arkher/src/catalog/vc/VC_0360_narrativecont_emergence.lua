-- ARKHER SYSTEM VC.0360 :: Narrative Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0360"
	S.key = "arkher.contneural.narrativecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.narrativecont.reality_continuum" }
	S.tags = { "vc", "narrativecont", "emergence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.narrativecont.emergence_continuum", windowSize = 7, threshold = 1.40, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
