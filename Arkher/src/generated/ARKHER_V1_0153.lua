...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Sketchfab — ANIMATION Map #0153", size=Vector2.new(600, 480), pos=UDim2.fromOffset(489, 81), parent=parent, icon="⬔"})
