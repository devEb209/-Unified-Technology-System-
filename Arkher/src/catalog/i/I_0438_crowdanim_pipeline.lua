-- ARKHER SYSTEM I.0438 :: Crowd Animation Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0438"
	S.key = "arkher.anim.crowdanim.playback_pipeline"
	S.name = "Crowd Animation Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crowdanim.event_ledger" }
	S.tags = { "i", "crowdanim", "pipeline", "anim" }
	S.description = "Crowd Animation Playback Pipeline: ordered sample, blend, ik and output stages for the Crowd Animation subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.crowdanim.playback_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
