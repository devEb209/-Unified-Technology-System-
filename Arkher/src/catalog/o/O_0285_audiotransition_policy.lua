-- ARKHER SYSTEM O.0285 :: Transition Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0285"
	S.key = "arkher.audio.audiotransition.playback_policy"
	S.name = "Transition Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Transition"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiotransition.compression_codec" }
	S.tags = { "o", "audiotransition", "policy", "audio" }
	S.description = "Transition Playback Policy: rules choosing what may be heard right now for the Transition subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.audiotransition.playback_policy", algorithm = "wfq", starvationGuard = 54 })
		inst.system = S
		inst.ctx = ctx
