-- ARKHER SYSTEM O.0004 :: Footstep Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0004"
	S.key = "arkher.audio.footstep.music_sequencer"
	S.name = "Footstep Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Footstep"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.footstep.spatialization" }
	S.tags = { "o", "footstep", "sequencer", "audio" }
	S.description = "Footstep Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Footstep subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.footstep.music_sequencer", bpm = 160, beatsPerBar = 4, intensity = 0.61 })
		inst.system = S
		inst.ctx = ctx
