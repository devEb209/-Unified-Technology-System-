-- ARKHER SYSTEM Z.1064 :: World Dream State Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.1064"
	S.key = "arkher.origin.worlddream.autonomous_pipeline"
	S.name = "World Dream State Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.simulation_fabric" }
	S.tags = { "z", "worlddream", "autopipeline", "origin" }
	S.description = "World Dream State Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the World Dream State subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.worlddream.autonomous_pipeline", maxIterations = 4 })
		inst.system = S
		inst.ctx = ctx
