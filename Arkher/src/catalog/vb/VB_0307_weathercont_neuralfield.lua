-- ARKHER SYSTEM VB.0307 :: Weather Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0307"
	S.key = "arkher.conttime.weathercont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.weathercont.coherence_guard" }
	S.tags = { "vb", "weathercont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.weathercont.neural_field", dims = 24, hidden = 20, seed = 44583 })
		inst.system = S
		inst.ctx = ctx
