-- ARKHER SYSTEM L.0224 :: Vegetation Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0224"
	S.key = "arkher.sim.vegetation.forecast"
	S.name = "Vegetation Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.vegetation.analysis" }
	S.tags = { "l", "vegetation", "predictor", "sim" }
	S.description = "Vegetation Forecast: prediction of the region's next state for the Vegetation subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.vegetation.forecast", method = "ema", alpha = 0.28, window = 98 })
		inst.system = S
		inst.ctx = ctx
