-- ARKHER SYSTEM O.0346 :: Animal Audio Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0346"
	S.key = "arkher.audio.animalaudio.analysis"
	S.name = "Animal Audio Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Animal Audio"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.animalaudio.playback_policy" }
	S.tags = { "o", "animalaudio", "analyzer", "audio" }
	S.description = "Animal Audio Analysis: loudness, headroom and masking analysis for the Animal Audio subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.animalaudio.analysis", window = 166, buckets = 10, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
