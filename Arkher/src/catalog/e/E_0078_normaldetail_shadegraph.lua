-- ARKHER SYSTEM E.0078 :: Normal Detail Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0078"
	S.key = "arkher.material.normaldetail.shading_graph"
	S.name = "Normal Detail Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.normaldetail.layer_composition" }
	S.tags = { "e", "normaldetail", "shadegraph", "material" }
	S.description = "Normal Detail Shading Graph: node graph evaluated and compiled to Luau for the Normal Detail subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.normaldetail.shading_graph" })
		inst.system = S
		inst.ctx = ctx
