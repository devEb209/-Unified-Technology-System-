-- ARKHER SYSTEM Q.0094 :: Scroll View Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0094"
	S.key = "arkher.ui.scrollview.frame_budget"
	S.name = "Scroll View Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Scroll View"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.scrollview.accessibility_policy" }
	S.tags = { "q", "scrollview", "budgeter", "ui" }
	S.description = "Scroll View Frame Budget: per-frame layout and draw budget for the interface for the Scroll View subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.scrollview.frame_budget", total = 410, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
