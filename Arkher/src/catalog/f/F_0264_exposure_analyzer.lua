-- ARKHER SYSTEM F.0264 :: Exposure Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0264"
	S.key = "arkher.render.exposure.frame_analysis"
	S.name = "Exposure Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Exposure"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.exposure.pass_cache" }
	S.tags = { "f", "exposure", "analyzer", "render" }
	S.description = "Exposure Frame Analysis: per-pass cost analysis and outlier detection for the Exposure subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.exposure.frame_analysis", window = 193, buckets = 9, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
