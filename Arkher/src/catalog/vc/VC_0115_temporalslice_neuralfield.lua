-- ARKHER SYSTEM VC.0115 :: Temporal Slice Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0115"
	S.key = "arkher.contneural.temporalslice.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.temporalslice.coherence_guard" }
	S.tags = { "vc", "temporalslice", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.temporalslice.neural_field", dims = 20, hidden = 16, seed = 98878 })
		inst.system = S
		inst.ctx = ctx
