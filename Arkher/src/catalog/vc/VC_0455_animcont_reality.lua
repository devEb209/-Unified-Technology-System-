-- ARKHER SYSTEM VC.0455 :: Animation Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0455"
	S.key = "arkher.contneural.animcont.reality_continuum"
	S.name = "Animation Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.animcont.simulation_fabric" }
	S.tags = { "vc", "animcont", "reality", "contneural" }
	S.description = "Animation Continuum Reality Continuum: stacked reality layers of the continuum for the Animation Continuum subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.animcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
