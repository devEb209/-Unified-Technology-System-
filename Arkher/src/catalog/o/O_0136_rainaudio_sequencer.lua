-- ARKHER SYSTEM O.0136 :: Rain Audio Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0136"
	S.key = "arkher.audio.rainaudio.music_sequencer"
	S.name = "Rain Audio Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Rain Audio"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.rainaudio.spatialization" }
	S.tags = { "o", "rainaudio", "sequencer", "audio" }
	S.description = "Rain Audio Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Rain Audio subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.rainaudio.music_sequencer", bpm = 130, beatsPerBar = 4, intensity = 0.58 })
		inst.system = S
		inst.ctx = ctx
