-- ARKHER SYSTEM VA.0277 :: Water Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0277"
	S.key = "arkher.contworld.watercont.infinite_grid"
	S.name = "Water Continuum Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "watercont", "continuum", "contworld" }
	S.description = "Water Continuum Infinite Grid: seamless paging of the infinite world grid for the Water Continuum subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.watercont.infinite_grid", cellSize = 128, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
