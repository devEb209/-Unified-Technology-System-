-- ARKHER SYSTEM VA.0296 :: Climate Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0296"
	S.key = "arkher.contworld.climatecont.world_memory_stream"
	S.name = "Climate Continuum World Memory Stream"
	S.category = "VA"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.climatecont.neural_field" }
	S.tags = { "va", "climatecont", "worldmemory", "contworld" }
	S.description = "Climate Continuum World Memory Stream: world memory continuum over epochs for the Climate Continuum subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.climatecont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
