-- ARKHER SYSTEM VA.0535 :: Pipeline Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0535"
	S.key = "arkher.contworld.pipelinecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.pipelinecont.coherence_guard" }
	S.tags = { "va", "pipelinecont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.pipelinecont.neural_field", dims = 16, hidden = 12, seed = 7277 })
		inst.system = S
		inst.ctx = ctx
