-- ARKHER SYSTEM VD.0490 :: Lighting Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0490"
	S.key = "arkher.contsim.lightcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lightcont.complexity_budget" }
	S.tags = { "vd", "lightcont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.lightcont.simulation_fabric", budgetMs = 3.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
