-- ARKHER SYSTEM I.0083 :: Curve Interpolation Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0083"
	S.key = "arkher.anim.curveinterp.physical_blend"
	S.name = "Curve Interpolation Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.curveinterp.inverse_kinematics" }
	S.tags = { "i", "curveinterp", "ragdoll", "anim" }
	S.description = "Curve Interpolation Physical Blend: physical bones blended against the animated pose for the Curve Interpolation subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.curveinterp.physical_blend", blendSpeed = 4.50 })
		inst.system = S
		inst.ctx = ctx
