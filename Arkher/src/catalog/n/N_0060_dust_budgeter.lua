-- ARKHER SYSTEM N.0060 :: Dust Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0060"
	S.key = "arkher.vfx.dust.spawn_budget"
	S.name = "Dust Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Dust"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.dust.effect_composition" }
	S.tags = { "n", "dust", "budgeter", "vfx" }
	S.description = "Dust Spawn Budget: global particle budget shared by every live effect for the Dust subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.dust.spawn_budget", total = 345, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
