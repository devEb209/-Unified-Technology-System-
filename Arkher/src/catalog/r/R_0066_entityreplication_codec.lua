-- ARKHER SYSTEM R.0066 :: Entity Replication Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0066"
	S.key = "arkher.net.entityreplication.serialization_codec"
	S.name = "Entity Replication Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.entityreplication.bandwidth_budget" }
	S.tags = { "r", "entityreplication", "codec", "net" }
	S.description = "Entity Replication Serialization Codec: compact encoding, diffing and checksum of payloads for the Entity Replication subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.entityreplication.serialization_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
