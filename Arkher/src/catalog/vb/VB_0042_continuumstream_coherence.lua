-- ARKHER SYSTEM VB.0042 :: Continuum Stream Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0042"
	S.key = "arkher.conttime.continuumstream.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.continuumstream.persistent_state" }
	S.tags = { "vb", "continuumstream", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.continuumstream.coherence_guard", window = 134, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
