-- ARKHER SYSTEM Z.0627 :: Intent Driven Authoring World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0627"
	S.key = "arkher.origin.intentauthoring.world_architect"
	S.name = "Intent Driven Authoring World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.emergence_detection" }
	S.tags = { "z", "intentauthoring", "architect", "origin" }
	S.description = "Intent Driven Authoring World Architect: hierarchical world composition with conserved budgets for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.intentauthoring.world_architect", budget = 1500, seed = 61819 })
		inst.system = S
		inst.ctx = ctx
