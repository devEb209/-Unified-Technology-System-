-- ARKHER SYSTEM K.0455 :: Crowd Flow Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0455"
	S.key = "arkher.npc.crowdflow.utility_reasoning"
	S.name = "Crowd Flow Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.crowdflow.reactive_behaviour" }
	S.tags = { "k", "crowdflow", "utility", "npc" }
	S.description = "Crowd Flow Utility Reasoning: scored option selection with response curves for the Crowd Flow subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.crowdflow.utility_reasoning", momentum = 0.06 })
		inst.system = S
		inst.ctx = ctx
