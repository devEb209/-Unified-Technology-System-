-- ARKHER SYSTEM K.0449 :: Crowd Flow Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0449"
	S.key = "arkher.npc.crowdflow.mind_network"
	S.name = "Crowd Flow Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "crowdflow", "mindnet", "npc" }
	S.description = "Crowd Flow Mind Network: the learned policy that turns perception into a decision for the Crowd Flow subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.crowdflow.mind_network", inputs = 7, hidden = 8, seed = 39269, learningRate = 0.095, exploration = 0.045 })
		inst.system = S
		inst.ctx = ctx
