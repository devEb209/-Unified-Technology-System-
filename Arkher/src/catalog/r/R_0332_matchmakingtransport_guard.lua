-- ARKHER SYSTEM R.0332 :: Matchmaking Transport Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0332"
	S.key = "arkher.net.matchmakingtransport.rate_guard"
	S.name = "Matchmaking Transport Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.matchmakingtransport.interest_streaming" }
	S.tags = { "r", "matchmakingtransport", "guard", "net" }
	S.description = "Matchmaking Transport Rate Guard: token-bucket protection against floods and abuse for the Matchmaking Transport subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.matchmakingtransport.rate_guard", algorithm = "token", capacity = 58, refillPerSec = 23, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
