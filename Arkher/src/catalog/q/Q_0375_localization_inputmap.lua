-- ARKHER SYSTEM Q.0375 :: Localization Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0375"
	S.key = "arkher.ui.localization.input_mapping"
	S.name = "Localization Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Localization"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.localization.widget_tree" }
	S.tags = { "q", "localization", "inputmap", "ui" }
	S.description = "Localization Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Localization subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.localization.input_mapping", device = "keyboard", holdTime = 0.25, deadzone = 0.15 })
		inst.system = S
		inst.ctx = ctx
