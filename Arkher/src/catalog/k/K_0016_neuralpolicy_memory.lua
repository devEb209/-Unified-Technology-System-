-- ARKHER SYSTEM K.0016 :: Neural Policy Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0016"
	S.key = "arkher.npc.neuralpolicy.memory"
	S.name = "Neural Policy Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.neuralpolicy.mind_network" }
	S.tags = { "k", "neuralpolicy", "memory", "npc" }
	S.description = "Neural Policy Memory: episodic memory with decay, recall and consolidation for the Neural Policy subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.neuralpolicy.memory", capacity = 38, decayRate = 0.020, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
