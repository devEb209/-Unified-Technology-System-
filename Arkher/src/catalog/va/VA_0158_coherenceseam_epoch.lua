-- ARKHER SYSTEM VA.0158 :: Coherence Seam Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0158"
	S.key = "arkher.contworld.coherenceseam.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.coherenceseam.infinite_grid" }
	S.tags = { "va", "coherenceseam", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.coherenceseam.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
