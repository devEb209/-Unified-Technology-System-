-- ARKHER SYSTEM J.0038 :: Skin Definition Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0038"
	S.key = "arkher.character.skindef.physical_response"
	S.name = "Skin Definition Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.skindef.look_and_reach" }
	S.tags = { "j", "skindef", "ragdoll", "character" }
	S.description = "Skin Definition Physical Response: physical reaction, ragdoll and recovery for the Skin Definition subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.skindef.physical_response", blendSpeed = 3.70 })
		inst.system = S
		inst.ctx = ctx
