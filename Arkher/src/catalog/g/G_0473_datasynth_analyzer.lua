-- ARKHER SYSTEM G.0473 :: Training Data Synthesis Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0473"
	S.key = "arkher.neural.datasynth.error_analysis"
	S.name = "Training Data Synthesis Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.datasynth.heuristic_policy" }
	S.tags = { "g", "datasynth", "analyzer", "neural" }
	S.description = "Training Data Synthesis Error Analysis: residual and drift analysis for the Training Data Synthesis subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.datasynth.error_analysis", window = 199, buckets = 19, threshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
