-- ARKHER SYSTEM G.0291 :: Perceptual Metric Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0291"
	S.key = "arkher.neural.perceptual.error_analysis"
	S.name = "Perceptual Metric Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perceptual.heuristic_policy" }
	S.tags = { "g", "perceptual", "analyzer", "neural" }
	S.description = "Perceptual Metric Error Analysis: residual and drift analysis for the Perceptual Metric subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.perceptual.error_analysis", window = 152, buckets = 16, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
