-- ARKHER SYSTEM J.0170 :: Clothing Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0170"
	S.key = "arkher.character.clothing.physical_response"
	S.name = "Clothing Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.clothing.look_and_reach" }
	S.tags = { "j", "clothing", "ragdoll", "character" }
	S.description = "Clothing Physical Response: physical reaction, ragdoll and recovery for the Clothing subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.clothing.physical_response", blendSpeed = 2.80 })
		inst.system = S
		inst.ctx = ctx
