-- ARKHER SYSTEM VB.0197 :: Architect District Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0197"
	S.key = "arkher.conttime.architectdistrict.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.architectdistrict.multi-scale_fidelity" }
	S.tags = { "vb", "architectdistrict", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.architectdistrict.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
