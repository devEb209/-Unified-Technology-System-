-- ARKHER SYSTEM N.0464 :: Camera Shake Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0464"
	S.key = "arkher.vfx.camerashake.result_cache"
	S.name = "Camera Shake Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Camera Shake"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.camerashake.spawn_budget" }
	S.tags = { "n", "camerashake", "cache", "vfx" }
	S.description = "Camera Shake Result Cache: reuse of expensive effect evaluations for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.camerashake.result_cache", policy = "lru", capacity = 77, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
