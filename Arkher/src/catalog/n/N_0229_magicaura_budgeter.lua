-- ARKHER SYSTEM N.0229 :: Magic Aura Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0229"
	S.key = "arkher.vfx.magicaura.spawn_budget"
	S.name = "Magic Aura Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Magic Aura"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.magicaura.effect_composition" }
	S.tags = { "n", "magicaura", "budgeter", "vfx" }
	S.description = "Magic Aura Spawn Budget: global particle budget shared by every live effect for the Magic Aura subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.magicaura.spawn_budget", total = 268, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
