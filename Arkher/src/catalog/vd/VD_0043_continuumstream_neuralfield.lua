-- ARKHER SYSTEM VD.0043 :: Continuum Stream Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0043"
	S.key = "arkher.contsim.continuumstream.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.continuumstream.coherence_guard" }
	S.tags = { "vd", "continuumstream", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.continuumstream.neural_field", dims = 20, hidden = 16, seed = 53910 })
		inst.system = S
		inst.ctx = ctx
