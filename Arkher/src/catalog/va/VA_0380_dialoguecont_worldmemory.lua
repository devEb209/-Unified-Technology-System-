-- ARKHER SYSTEM VA.0380 :: Dialogue Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0380"
	S.key = "arkher.contworld.dialoguecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.dialoguecont.neural_field" }
	S.tags = { "va", "dialoguecont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.dialoguecont.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
