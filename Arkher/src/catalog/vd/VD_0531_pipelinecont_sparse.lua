-- ARKHER SYSTEM VD.0531 :: Pipeline Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0531"
	S.key = "arkher.contsim.pipelinecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.pipelinecont.epoch_clock" }
	S.tags = { "vd", "pipelinecont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.pipelinecont.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
