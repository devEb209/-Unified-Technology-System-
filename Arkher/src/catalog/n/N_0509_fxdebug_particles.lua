-- ARKHER SYSTEM N.0509 :: Effect Debug Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0509"
	S.key = "arkher.vfx.fxdebug.particle_simulation"
	S.name = "Effect Debug Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Effect Debug"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fxdebug.emission" }
	S.tags = { "n", "fxdebug", "particles", "vfx" }
	S.description = "Effect Debug Particle Simulation: pooled integration of position, velocity, colour and life for the Effect Debug subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.fxdebug.particle_simulation", capacity = 512, drag = 0.11, bounce = 0.06, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
