-- ARKHER SYSTEM F.0170 :: Atmosphere View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0170"
	S.key = "arkher.render.atmosphere.view_and_culling"
	S.name = "Atmosphere View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Atmosphere"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.atmosphere.frame_graph" }
	S.tags = { "f", "atmosphere", "camera", "render" }
	S.description = "Atmosphere View And Culling: view state, frustum culling and screen-size LOD for the Atmosphere subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.atmosphere.view_and_culling", width = 1084, height = 900, fov = 1.0700, far = 1800 })
		inst.system = S
		inst.ctx = ctx
