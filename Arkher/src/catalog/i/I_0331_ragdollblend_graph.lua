-- ARKHER SYSTEM I.0331 :: Ragdoll Blend Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0331"
	S.key = "arkher.anim.ragdollblend.retarget_graph"
	S.name = "Ragdoll Blend Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.ragdollblend.physical_blend" }
	S.tags = { "i", "ragdollblend", "graph", "anim" }
	S.description = "Ragdoll Blend Retarget Graph: bone mapping and retarget path resolution for the Ragdoll Blend subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.ragdollblend.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
