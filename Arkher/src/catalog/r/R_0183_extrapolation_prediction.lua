-- ARKHER SYSTEM R.0183 :: Extrapolation Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0183"
	S.key = "arkher.net.extrapolation.prediction_and_reconciliation"
	S.name = "Extrapolation Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.extrapolation.time_sync" }
	S.tags = { "r", "extrapolation", "prediction", "net" }
	S.description = "Extrapolation Prediction And Reconciliation: client simulation, correction and input replay for the Extrapolation subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.extrapolation.prediction_and_reconciliation", errorThreshold = 0.035, smoothing = 9.0, maxInputs = 160 })
		inst.system = S
		inst.ctx = ctx
