-- ARKHER SYSTEM VD.0305 :: Weather Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0305"
	S.key = "arkher.contsim.weathercont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.weathercont.multi-scale_fidelity" }
	S.tags = { "vd", "weathercont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.weathercont.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
