-- ARKHER SYSTEM Z.0140 :: Dynamic Complexity Manager Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0140"
	S.key = "arkher.origin.complexitymanager.orchestration"
	S.name = "Dynamic Complexity Manager Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.residency_streaming" }
	S.tags = { "z", "complexitymanager", "orchestrator", "origin" }
	S.description = "Dynamic Complexity Manager Orchestration: lifecycle and phase orchestration of the technology for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.complexitymanager.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
