-- ARKHER SYSTEM H.0464 :: Hinge Joint Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0464"
	S.key = "arkher.physics.hingejoint.collision_shape"
	S.name = "Hinge Joint Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Hinge Joint"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.hingejoint.body_dynamics" }
	S.tags = { "h", "hingejoint", "collider", "physics" }
	S.description = "Hinge Joint Collision Shape: shape bounds, support mapping and closest points for the Hinge Joint subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.hingejoint.collision_shape", shape = "sphere", radius = 1.90, height = 1.50, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
