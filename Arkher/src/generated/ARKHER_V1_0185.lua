--!strict
-- Gaea Nodes — ANIMATION Stack #0185
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Gaea Nodes — ANIMATION Stack #0185", size=Vector2.new(680, 420), pos=UDim2.fromOffset(105, 105), parent=parent, icon="↻"})
