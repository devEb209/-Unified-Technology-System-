-- ARKHER SYSTEM O.0137 :: Rain Audio Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0137"
	S.key = "arkher.audio.rainaudio.voice_budget"
	S.name = "Rain Audio Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Rain Audio"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.rainaudio.music_sequencer" }
	S.tags = { "o", "rainaudio", "budgeter", "audio" }
	S.description = "Rain Audio Voice Budget: voice slots allocated by priority and audibility for the Rain Audio subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.rainaudio.voice_budget", total = 279, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
