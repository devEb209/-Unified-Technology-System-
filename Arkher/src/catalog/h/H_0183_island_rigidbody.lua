-- ARKHER SYSTEM H.0183 :: Island Solver Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0183"
	S.key = "arkher.physics.island.body_dynamics"
	S.name = "Island Solver Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "island", "rigidbody", "physics" }
	S.description = "Island Solver Body Dynamics: integration, impulses, damping and sleeping of a body for the Island Solver subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.island.body_dynamics", mass = 17.00, radius = 1.10, restitution = 0.16, friction = 0.56, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
