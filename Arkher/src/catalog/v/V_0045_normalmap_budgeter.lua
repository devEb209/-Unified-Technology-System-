-- ARKHER SYSTEM V.0045 :: Normal Map Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0045"
	S.key = "arkher.asset.normalmap.size_budget"
	S.name = "Normal Map Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.normalmap.compression_codec" }
	S.tags = { "v", "normalmap", "budgeter", "asset" }
	S.description = "Normal Map Size Budget: byte budget shared between competing asset classes for the Normal Map subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.normalmap.size_budget", total = 457, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
