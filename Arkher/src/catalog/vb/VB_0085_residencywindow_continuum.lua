-- ARKHER SYSTEM VB.0085 :: Residency Window Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0085"
	S.key = "arkher.conttime.residencywindow.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "residencywindow", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.residencywindow.infinite_grid", cellSize = 96, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
