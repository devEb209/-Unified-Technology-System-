-- ARKHER SYSTEM Q.0268 :: Virtual Joystick Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0268"
	S.key = "arkher.ui.virtualjoystick.transition"
	S.name = "Virtual Joystick Transition"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.virtualjoystick.input_mapping" }
	S.tags = { "q", "virtualjoystick", "tween", "ui" }
	S.description = "Virtual Joystick Transition: eased, delayed, looped and sequenced motion for the Virtual Joystick subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.virtualjoystick.transition", timeScale = 1.11 })
		inst.system = S
		inst.ctx = ctx
