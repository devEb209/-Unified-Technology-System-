-- ARKHER SYSTEM VD.0338 :: Society Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0338"
	S.key = "arkher.contsim.societycont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.societycont.infinite_grid" }
	S.tags = { "vd", "societycont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.societycont.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
