-- ARKHER SYSTEM VA.0476 :: VFX Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0476"
	S.key = "arkher.contworld.vfxcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vfxcont.neural_field" }
	S.tags = { "va", "vfxcont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.vfxcont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
