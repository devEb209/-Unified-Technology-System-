-- ARKHER SYSTEM VB.0033 :: Zone Chunk Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0033"
	S.key = "arkher.conttime.zonechunk.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.zonechunk.world_memory_stream" }
	S.tags = { "vb", "zonechunk", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.zonechunk.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
