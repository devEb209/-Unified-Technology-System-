-- ARKHER SYSTEM W.0127 :: Drone Shot Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0127"
	S.key = "arkher.cine.drone.motion_tween"
	S.name = "Drone Shot Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Drone Shot"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.drone.playback_orchestrator" }
	S.tags = { "w", "drone", "tween", "cine" }
	S.description = "Drone Shot Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Drone Shot subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.drone.motion_tween", timeScale = 1.07 })
		inst.system = S
		inst.ctx = ctx
