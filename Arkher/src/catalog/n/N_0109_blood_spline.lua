-- ARKHER SYSTEM N.0109 :: Blood Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0109"
	S.key = "arkher.vfx.blood.curve_authoring"
	S.name = "Blood Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Blood"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.blood.ribbon_and_trail" }
	S.tags = { "n", "blood", "spline", "vfx" }
	S.description = "Blood Curve Authoring: authored curves driving the effect over its life for the Blood subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.blood.curve_authoring", tension = 0.71, closed = false })
		inst.system = S
		inst.ctx = ctx
