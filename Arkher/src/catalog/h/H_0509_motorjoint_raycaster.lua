-- ARKHER SYSTEM H.0509 :: Motorized Joint Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0509"
	S.key = "arkher.physics.motorjoint.query"
	S.name = "Motorized Joint Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.motorjoint.constraint_solver" }
	S.tags = { "h", "motorjoint", "raycaster", "physics" }
	S.description = "Motorized Joint Query: rays, sweeps and overlaps against the simulation for the Motorized Joint subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.motorjoint.query", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
