-- ARKHER SYSTEM W.0277 :: Depth Of Field Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0277"
	S.key = "arkher.cine.depthoffield.sequence_timeline"
	S.name = "Depth Of Field Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "depthoffield", "timeline", "cine" }
	S.description = "Depth Of Field Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.depthoffield.sequence_timeline", duration = 6.0, rate = 0.90 })
		inst.system = S
		inst.ctx = ctx
