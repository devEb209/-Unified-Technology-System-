-- ARKHER SYSTEM Z.0941 :: Platform Abstraction Doctrine Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0941"
	S.key = "arkher.origin.platformdoctrine.reality_layering"
	S.name = "Platform Abstraction Doctrine Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "platformdoctrine", "reality", "origin" }
	S.description = "Platform Abstraction Doctrine Reality Layering: stacked authored, simulated, proposed and player realities for the Platform Abstraction Doctrine subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.platformdoctrine.reality_layering" })
		inst.system = S
		inst.ctx = ctx
