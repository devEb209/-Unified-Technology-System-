-- ARKHER SYSTEM R.0211 :: Server Reconciliation Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0211"
	S.key = "arkher.net.serverreconciliation.interest_streaming"
	S.name = "Server Reconciliation Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverreconciliation.serialization_codec" }
	S.tags = { "r", "serverreconciliation", "streamer", "net" }
	S.description = "Server Reconciliation Interest Streaming: distance-driven residency of replicated content for the Server Reconciliation subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.serverreconciliation.interest_streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
