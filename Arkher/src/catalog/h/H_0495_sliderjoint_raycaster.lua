-- ARKHER SYSTEM H.0495 :: Slider Joint Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0495"
	S.key = "arkher.physics.sliderjoint.query"
	S.name = "Slider Joint Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Slider Joint"
	S.aspect = "Query"
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sliderjoint.constraint_solver" }
	S.tags = { "h", "sliderjoint", "raycaster", "physics" }
	S.description = "Slider Joint Query: rays, sweeps and overlaps against the simulation for the Slider Joint subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.sliderjoint.query", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
