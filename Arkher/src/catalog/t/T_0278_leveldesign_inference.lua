-- ARKHER SYSTEM T.0278 :: Level Design Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0278"
	S.key = "arkher.ai.leveldesign.model_inference"
	S.name = "Level Design Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.leveldesign.action_planner" }
	S.tags = { "t", "leveldesign", "inference", "ai" }
	S.description = "Level Design Model Inference: quantized inference with batching and budget for the Level Design subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.leveldesign.model_inference", seed = 60952 })
		inst.system = S
		inst.ctx = ctx
