-- ARKHER SYSTEM VB.0437 :: Physics Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0437"
	S.key = "arkher.conttime.physicscont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.physicscont.multi-scale_fidelity" }
	S.tags = { "vb", "physicscont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.physicscont.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
