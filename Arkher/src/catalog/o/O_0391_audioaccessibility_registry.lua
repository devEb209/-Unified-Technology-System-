-- ARKHER SYSTEM O.0391 :: Accessibility Audio Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0391"
	S.key = "arkher.audio.audioaccessibility.asset_registry"
	S.name = "Accessibility Audio Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audioaccessibility.streaming" }
	S.tags = { "o", "audioaccessibility", "registry", "audio" }
	S.description = "Accessibility Audio Asset Registry: catalogue of sounds, variations and metadata for the Accessibility Audio subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.audioaccessibility.asset_registry" })
		inst.system = S
		inst.ctx = ctx
