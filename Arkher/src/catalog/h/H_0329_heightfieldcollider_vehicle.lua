-- ARKHER SYSTEM H.0329 :: Heightfield Collider Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0329"
	S.key = "arkher.physics.heightfieldcollider.vehicle"
	S.name = "Heightfield Collider Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.heightfieldcollider.character_motion" }
	S.tags = { "h", "heightfieldcollider", "vehicle", "physics" }
	S.description = "Heightfield Collider Vehicle: suspension, drivetrain, steering and tire friction for the Heightfield Collider subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.heightfieldcollider.vehicle", mass = 1200, wheelbase = 2.70, track = 1.90, maxRpm = 6100 })
		inst.system = S
		inst.ctx = ctx
