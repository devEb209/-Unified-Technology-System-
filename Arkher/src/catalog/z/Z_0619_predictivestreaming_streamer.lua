-- ARKHER SYSTEM Z.0619 :: Predictive Streaming Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0619"
	S.key = "arkher.origin.predictivestreaming.residency_streaming"
	S.name = "Predictive Streaming Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictivestreaming.budget_governor" }
	S.tags = { "z", "predictivestreaming", "streamer", "origin" }
	S.description = "Predictive Streaming Residency Streaming: distance-driven residency of the technology's workload for the Predictive Streaming subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.predictivestreaming.residency_streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
