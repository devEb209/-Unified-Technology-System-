-- ARKHER SYSTEM T.0624 :: Explainability Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0624"
	S.key = "arkher.ai.explainability.outcome_prediction"
	S.name = "Explainability Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.explainability.decision_policy" }
	S.tags = { "t", "explainability", "predictor", "ai" }
	S.description = "Explainability Outcome Prediction: forecasting the result before the work is done for the Explainability subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.explainability.outcome_prediction", method = "ema", alpha = 0.33, window = 47 })
		inst.system = S
		inst.ctx = ctx
