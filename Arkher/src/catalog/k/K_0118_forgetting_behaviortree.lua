-- ARKHER SYSTEM K.0118 :: Forgetting Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0118"
	S.key = "arkher.npc.forgetting.reactive_behaviour"
	S.name = "Forgetting Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.forgetting.perception" }
	S.tags = { "k", "forgetting", "behaviortree", "npc" }
	S.description = "Forgetting Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Forgetting subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.forgetting.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
