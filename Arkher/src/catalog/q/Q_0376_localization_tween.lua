-- ARKHER SYSTEM Q.0376 :: Localization Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0376"
	S.key = "arkher.ui.localization.transition"
	S.name = "Localization Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Localization"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.localization.input_mapping" }
	S.tags = { "q", "localization", "tween", "ui" }
	S.description = "Localization Transition: eased, delayed, looped and sequenced motion for the Localization subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.localization.transition", timeScale = 1.09 })
		inst.system = S
		inst.ctx = ctx
