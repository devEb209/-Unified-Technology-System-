-- ARKHER SYSTEM F.0072 :: Cascade Shadows View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0072"
	S.key = "arkher.render.cascades.view_and_culling"
	S.name = "Cascade Shadows View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.cascades.frame_graph" }
	S.tags = { "f", "cascades", "camera", "render" }
	S.description = "Cascade Shadows View And Culling: view state, frustum culling and screen-size LOD for the Cascade Shadows subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.cascades.view_and_culling", width = 828, height = 900, fov = 0.9500, far = 2200 })
		inst.system = S
		inst.ctx = ctx
