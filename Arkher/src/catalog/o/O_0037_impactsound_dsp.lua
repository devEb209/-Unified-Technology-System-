-- ARKHER SYSTEM O.0037 :: Impact Sound DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0037"
	S.key = "arkher.audio.impactsound.dsp_chain"
	S.name = "Impact Sound DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Impact Sound"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "impactsound", "dsp", "audio" }
	S.description = "Impact Sound DSP Chain: biquad filtering, delay, envelope and soft clipping for the Impact Sound subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.impactsound.dsp_chain", sampleRate = 22050, filter = "bandpass", cutoff = 5700, q = 0.880 })
		inst.system = S
		inst.ctx = ctx
