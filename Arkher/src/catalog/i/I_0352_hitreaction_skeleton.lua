-- ARKHER SYSTEM I.0352 :: Hit Reaction Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0352"
	S.key = "arkher.anim.hitreaction.skeleton"
	S.name = "Hit Reaction Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Hit Reaction"
	S.aspect = "Skeleton"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "hitreaction", "skeleton", "anim" }
	S.description = "Hit Reaction Skeleton: bone hierarchy, bind pose and world resolution for the Hit Reaction subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.hitreaction.skeleton" })
		inst.system = S
		inst.ctx = ctx
