-- ARKHER SYSTEM G.0185 :: Light Transport Prediction Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0185"
	S.key = "arkher.neural.lightpredict.temporal_history"
	S.name = "Light Transport Prediction Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.lightpredict.feature_extraction" }
	S.tags = { "g", "lightpredict", "temporal", "neural" }
	S.description = "Light Transport Prediction Temporal History: history buffers reused across frames for the Light Transport Prediction subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.lightpredict.temporal_history", feedback = 0.86, phase = 8 })
		inst.system = S
		inst.ctx = ctx
