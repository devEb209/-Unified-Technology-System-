-- ARKHER SYSTEM F.0095 :: Contact Shadows Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0095"
	S.key = "arkher.render.contact.pass_cache"
	S.name = "Contact Shadows Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.contact.render_policy" }
	S.tags = { "f", "contact", "cache", "render" }
	S.description = "Contact Shadows Pass Cache: reuse of pass results across frames for the Contact Shadows subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.contact.pass_cache", policy = "lru", capacity = 125, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
