-- ARKHER SYSTEM N.0165 :: Snow Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0165"
	S.key = "arkher.vfx.snow.result_cache"
	S.name = "Snow Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Snow"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.snow.spawn_budget" }
	S.tags = { "n", "snow", "cache", "vfx" }
	S.description = "Snow Result Cache: reuse of expensive effect evaluations for the Snow subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.snow.result_cache", policy = "ttl", capacity = 151, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
