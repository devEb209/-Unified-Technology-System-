-- ARKHER SYSTEM VB.0585 :: Thermal Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0585"
	S.key = "arkher.conttime.thermalcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.thermalcont.world_memory_stream" }
	S.tags = { "vb", "thermalcont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.thermalcont.complexity_budget", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
