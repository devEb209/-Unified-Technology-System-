-- ARKHER SYSTEM VA.0291 :: Climate Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0291"
	S.key = "arkher.contworld.climatecont.sparse_residency"
	S.name = "Climate Continuum Sparse Residency"
	S.category = "VA"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.climatecont.epoch_clock" }
	S.tags = { "va", "climatecont", "sparse", "contworld" }
	S.description = "Climate Continuum Sparse Residency: sparse page residency with eviction and compression for the Climate Continuum subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.climatecont.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
