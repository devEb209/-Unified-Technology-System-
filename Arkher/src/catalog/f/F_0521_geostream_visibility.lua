-- ARKHER SYSTEM F.0521 :: Geometry Streaming Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0521"
	S.key = "arkher.render.geostream.visibility_set"
	S.name = "Geometry Streaming Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.geostream.view_and_culling" }
	S.tags = { "f", "geostream", "visibility", "render" }
	S.description = "Geometry Streaming Visibility Set: cell, portal and occluder visibility for the Geometry Streaming subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.geostream.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
