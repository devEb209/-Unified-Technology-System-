-- ARKHER SYSTEM V.0121 :: Font Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0121"
	S.key = "arkher.asset.font.import"
	S.name = "Font Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "font", "importer", "asset" }
	S.description = "Font Import: validation, normalization, hashing and deduplication of incoming content for the Font subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.font.import", unitScale = 1.00 })
		inst.system = S
		inst.ctx = ctx
