--!strict
-- 3dsMax Stack — CORE Node_Flow #0096
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="3dsMax Stack — CORE Node_Flow #0096", size=Vector2.new(600, 440), pos=UDim2.fromOffset(148, 152), parent=parent, icon="⤢"})
