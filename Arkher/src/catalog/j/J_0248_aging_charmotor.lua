-- ARKHER SYSTEM J.0248 :: Aging Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0248"
	S.key = "arkher.character.aging.locomotion"
	S.name = "Aging Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.aging.physical_response" }
	S.tags = { "j", "aging", "charmotor", "character" }
	S.description = "Aging Locomotion: capsule locomotion driving the character for the Aging subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.aging.locomotion", radius = 0.49, height = 1.74, maxSpeed = 5.40, jumpHeight = 1.40, stepOffset = 0.39 })
		inst.system = S
		inst.ctx = ctx
