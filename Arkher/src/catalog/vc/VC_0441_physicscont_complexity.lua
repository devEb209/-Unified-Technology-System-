-- ARKHER SYSTEM VC.0441 :: Physics Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0441"
	S.key = "arkher.contneural.physicscont.complexity_budget"
	S.name = "Physics Continuum Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.physicscont.world_memory_stream" }
	S.tags = { "vc", "physicscont", "complexity", "contneural" }
	S.description = "Physics Continuum Complexity Budget: complexity budgeting for the continuum for the Physics Continuum subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.physicscont.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
