-- ARKHER SYSTEM F.0403 :: Draw Call Batching Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0403"
	S.key = "arkher.render.batching.pass_cache"
	S.name = "Draw Call Batching Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.batching.render_policy" }
	S.tags = { "f", "batching", "cache", "render" }
	S.description = "Draw Call Batching Pass Cache: reuse of pass results across frames for the Draw Call Batching subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.batching.pass_cache", policy = "lru", capacity = 452, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
