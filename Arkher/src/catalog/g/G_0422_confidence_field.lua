-- ARKHER SYSTEM G.0422 :: Confidence Gating Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0422"
	S.key = "arkher.neural.confidence.feature_extraction"
	S.name = "Confidence Gating Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.confidence.inference_core" }
	S.tags = { "g", "confidence", "field", "neural" }
	S.description = "Confidence Gating Feature Extraction: signal features feeding the model for the Confidence Gating subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.confidence.feature_extraction", seed = 83280, frequency = 0.0040, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
