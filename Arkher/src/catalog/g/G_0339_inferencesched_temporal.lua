-- ARKHER SYSTEM G.0339 :: Inference Scheduler Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0339"
	S.key = "arkher.neural.inferencesched.temporal_history"
	S.name = "Inference Scheduler Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.inferencesched.feature_extraction" }
	S.tags = { "g", "inferencesched", "temporal", "neural" }
	S.description = "Inference Scheduler Temporal History: history buffers reused across frames for the Inference Scheduler subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.inferencesched.temporal_history", feedback = 0.91, phase = 8 })
		inst.system = S
		inst.ctx = ctx
