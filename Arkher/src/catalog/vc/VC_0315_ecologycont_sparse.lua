-- ARKHER SYSTEM VC.0315 :: Ecology Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0315"
	S.key = "arkher.contneural.ecologycont.sparse_residency"
	S.name = "Ecology Continuum Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.ecologycont.epoch_clock" }
	S.tags = { "vc", "ecologycont", "sparse", "contneural" }
	S.description = "Ecology Continuum Sparse Residency: sparse page residency with eviction and compression for the Ecology Continuum subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.ecologycont.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
