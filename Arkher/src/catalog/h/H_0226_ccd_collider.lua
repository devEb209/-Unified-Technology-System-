-- ARKHER SYSTEM H.0226 :: Continuous Detection Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0226"
	S.key = "arkher.physics.ccd.collision_shape"
	S.name = "Continuous Detection Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.ccd.body_dynamics" }
	S.tags = { "h", "ccd", "collider", "physics" }
	S.description = "Continuous Detection Collision Shape: shape bounds, support mapping and closest points for the Continuous Detection subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.ccd.collision_shape", shape = "capsule", radius = 0.60, height = 1.40, layer = "character" })
		inst.system = S
		inst.ctx = ctx
