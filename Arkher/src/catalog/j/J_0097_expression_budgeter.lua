-- ARKHER SYSTEM J.0097 :: Expression Set Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0097"
	S.key = "arkher.character.expression.budget_governor"
	S.name = "Expression Set Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.expression.variant_registry" }
	S.tags = { "j", "expression", "budgeter", "character" }
	S.description = "Expression Set Budget Governor: per-character cost allocation in a crowd for the Expression Set subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.expression.budget_governor", total = 271, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
