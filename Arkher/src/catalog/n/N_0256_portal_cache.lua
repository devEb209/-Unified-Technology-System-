-- ARKHER SYSTEM N.0256 :: Portal Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0256"
	S.key = "arkher.vfx.portal.result_cache"
	S.name = "Portal Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Portal"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.portal.spawn_budget" }
	S.tags = { "n", "portal", "cache", "vfx" }
	S.description = "Portal Result Cache: reuse of expensive effect evaluations for the Portal subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.portal.result_cache", policy = "lru", capacity = 104, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
