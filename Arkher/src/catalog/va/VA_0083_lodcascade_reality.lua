-- ARKHER SYSTEM VA.0083 :: LOD Cascade Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0083"
	S.key = "arkher.contworld.lodcascade.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lodcascade.simulation_fabric" }
	S.tags = { "va", "lodcascade", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.lodcascade.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
