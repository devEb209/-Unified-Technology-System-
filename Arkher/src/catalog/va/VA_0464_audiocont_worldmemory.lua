-- ARKHER SYSTEM VA.0464 :: Audio Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0464"
	S.key = "arkher.contworld.audiocont.world_memory_stream"
	S.name = "Audio Continuum World Memory Stream"
	S.category = "VA"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.audiocont.neural_field" }
	S.tags = { "va", "audiocont", "worldmemory", "contworld" }
	S.description = "Audio Continuum World Memory Stream: world memory continuum over epochs for the Audio Continuum subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.audiocont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
