-- ARKHER SYSTEM H.0272 :: Sphere Collider Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0272"
	S.key = "arkher.physics.spherecollider.character_motion"
	S.name = "Sphere Collider Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.spherecollider.query" }
	S.tags = { "h", "spherecollider", "charmotor", "physics" }
	S.description = "Sphere Collider Character Motion: capsule move-and-slide with slopes, steps and jumps for the Sphere Collider subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.spherecollider.character_motion", radius = 0.35, height = 1.80, maxSpeed = 6.00, jumpHeight = 2.00, stepOffset = 0.45 })
		inst.system = S
		inst.ctx = ctx
