-- ARKHER SYSTEM VA.0347 :: Society Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0347"
	S.key = "arkher.contworld.societycont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.societycont.simulation_fabric" }
	S.tags = { "va", "societycont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.societycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
