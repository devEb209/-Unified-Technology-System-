-- ARKHER SYSTEM VA.0245 :: Vegetation Field Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0245"
	S.key = "arkher.contworld.vegfield.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vegfield.multi-scale_fidelity" }
	S.tags = { "va", "vegfield", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.vegfield.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
