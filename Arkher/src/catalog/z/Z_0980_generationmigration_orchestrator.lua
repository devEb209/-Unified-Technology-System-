-- ARKHER SYSTEM Z.0980 :: Generation Migration Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0980"
	S.key = "arkher.origin.generationmigration.orchestration"
	S.name = "Generation Migration Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.residency_streaming" }
	S.tags = { "z", "generationmigration", "orchestrator", "origin" }
	S.description = "Generation Migration Orchestration: lifecycle and phase orchestration of the technology for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.generationmigration.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
