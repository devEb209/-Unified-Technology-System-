-- ARKHER SYSTEM I.0218 :: Transition Rule Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0218"
	S.key = "arkher.anim.transitionrule.pose_cache"
	S.name = "Transition Rule Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.transitionrule.playback_pipeline" }
	S.tags = { "i", "transitionrule", "cache", "anim" }
	S.description = "Transition Rule Pose Cache: reuse of sampled poses across frames and instances for the Transition Rule subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.transitionrule.pose_cache", policy = "lru", capacity = 219, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
