-- ARKHER SYSTEM F.0642 :: Memory Aliasing Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0642"
	S.key = "arkher.render.memaliasing.frame_analysis"
	S.name = "Memory Aliasing Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.memaliasing.pass_cache" }
	S.tags = { "f", "memaliasing", "analyzer", "render" }
	S.description = "Memory Aliasing Frame Analysis: per-pass cost analysis and outlier detection for the Memory Aliasing subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.memaliasing.frame_analysis", window = 164, buckets = 12, threshold = 3.60 })
		inst.system = S
		inst.ctx = ctx
