-- ARKHER SYSTEM E.0533 :: Material LOD Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0533"
	S.key = "arkher.material.materiallod.streaming"
	S.name = "Material LOD Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Material LOD"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.materiallod.parameter_budget" }
	S.tags = { "e", "materiallod", "streamer", "material" }
	S.description = "Material LOD Streaming: residency and demand-driven texture streaming for the Material LOD subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.materiallod.streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
