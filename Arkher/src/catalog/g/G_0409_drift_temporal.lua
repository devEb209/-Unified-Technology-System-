-- ARKHER SYSTEM G.0409 :: Drift Detection Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0409"
	S.key = "arkher.neural.drift.temporal_history"
	S.name = "Drift Detection Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.drift.feature_extraction" }
	S.tags = { "g", "drift", "temporal", "neural" }
	S.description = "Drift Detection Temporal History: history buffers reused across frames for the Drift Detection subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.drift.temporal_history", feedback = 0.92, phase = 8 })
		inst.system = S
		inst.ctx = ctx
