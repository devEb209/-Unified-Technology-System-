-- ARKHER SYSTEM P.0074 :: Experience Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0074"
	S.key = "arkher.play.experience.inventory"
	S.name = "Experience Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Experience"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.experience.attributes" }
	S.tags = { "p", "experience", "inventory", "play" }
	S.description = "Experience Inventory: slots, stacking, weight, equipment and crafting for the Experience subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.experience.inventory", slots = 20, maxWeight = 100 })
		inst.system = S
		inst.ctx = ctx
