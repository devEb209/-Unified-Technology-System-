-- ARKHER SYSTEM VD.0254 :: Road Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0254"
	S.key = "arkher.contsim.roadcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.roadcont.infinite_grid" }
	S.tags = { "vd", "roadcont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.roadcont.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
