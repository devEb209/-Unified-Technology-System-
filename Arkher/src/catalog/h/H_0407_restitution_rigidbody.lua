-- ARKHER SYSTEM H.0407 :: Restitution Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0407"
	S.key = "arkher.physics.restitution.body_dynamics"
	S.name = "Restitution Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Restitution"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "restitution", "rigidbody", "physics" }
	S.description = "Restitution Body Dynamics: integration, impulses, damping and sleeping of a body for the Restitution subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.restitution.body_dynamics", mass = 16.00, radius = 1.05, restitution = 0.55, friction = 0.45, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
