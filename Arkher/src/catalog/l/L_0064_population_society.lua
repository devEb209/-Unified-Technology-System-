-- ARKHER SYSTEM L.0064 :: Population Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0064"
	S.key = "arkher.sim.population.society"
	S.name = "Population Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.population.economy" }
	S.tags = { "l", "population", "society", "sim" }
	S.description = "Population Society: relations, factions, reputation and cohesion of the region for the Population subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.population.society", decayRate = 0.008, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
