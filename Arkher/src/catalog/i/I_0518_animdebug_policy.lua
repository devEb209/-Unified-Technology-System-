-- ARKHER SYSTEM I.0518 :: Animation Debug Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0518"
	S.key = "arkher.anim.animdebug.quality_policy"
	S.name = "Animation Debug Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animdebug.pose_cache" }
	S.tags = { "i", "animdebug", "policy", "anim" }
	S.description = "Animation Debug Quality Policy: device tier rules for rate, bones and solvers for the Animation Debug subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.animdebug.quality_policy", algorithm = "edf", starvationGuard = 25 })
		inst.system = S
		inst.ctx = ctx
