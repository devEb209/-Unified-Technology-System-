-- ARKHER SYSTEM Z.0876 :: Multi Scale Simulation Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0876"
	S.key = "arkher.origin.multiscale.governance_policy"
	S.name = "Multi Scale Simulation Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.signal_composition" }
	S.tags = { "z", "multiscale", "policy", "origin" }
	S.description = "Multi Scale Simulation Governance Policy: ordered rules governing when the technology may act for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.multiscale.governance_policy", algorithm = "lottery", starvationGuard = 35 })
		inst.system = S
		inst.ctx = ctx
