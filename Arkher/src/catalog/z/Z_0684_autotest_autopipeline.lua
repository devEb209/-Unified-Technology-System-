-- ARKHER SYSTEM Z.0684 :: Auto Test Synthesis Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0684"
	S.key = "arkher.origin.autotest.autonomous_pipeline"
	S.name = "Auto Test Synthesis Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autotest.simulation_fabric" }
	S.tags = { "z", "autotest", "autopipeline", "origin" }
	S.description = "Auto Test Synthesis Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Auto Test Synthesis subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.autotest.autonomous_pipeline", maxIterations = 7 })
		inst.system = S
		inst.ctx = ctx
