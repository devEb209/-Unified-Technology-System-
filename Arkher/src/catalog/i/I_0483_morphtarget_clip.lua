-- ARKHER SYSTEM I.0483 :: Morph Target Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0483"
	S.key = "arkher.anim.morphtarget.clip_sampling"
	S.name = "Morph Target Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Morph Target"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.morphtarget.skeleton" }
	S.tags = { "i", "morphtarget", "clip", "anim" }
	S.description = "Morph Target Clip Sampling: keyframe tracks sampled, retimed and evented for the Morph Target subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.morphtarget.clip_sampling", duration = 1.70, loop = true })
		inst.system = S
		inst.ctx = ctx
