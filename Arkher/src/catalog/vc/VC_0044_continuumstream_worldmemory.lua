-- ARKHER SYSTEM VC.0044 :: Continuum Stream World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0044"
	S.key = "arkher.contneural.continuumstream.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.continuumstream.neural_field" }
	S.tags = { "vc", "continuumstream", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.continuumstream.world_memory_stream", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
