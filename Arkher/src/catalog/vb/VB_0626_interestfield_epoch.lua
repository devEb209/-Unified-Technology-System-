-- ARKHER SYSTEM VB.0626 :: Interest Field Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0626"
	S.key = "arkher.conttime.interestfield.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.interestfield.infinite_grid" }
	S.tags = { "vb", "interestfield", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.interestfield.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
