-- ARKHER SYSTEM W.0392 :: Preview Render Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0392"
	S.key = "arkher.cine.previewrender.cinematic_mix"
	S.name = "Preview Render Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.previewrender.motion_tween" }
	S.tags = { "w", "previewrender", "mixer", "cine" }
	S.description = "Preview Render Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Preview Render subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.previewrender.cinematic_mix", maxVoices = 48 })
		inst.system = S
		inst.ctx = ctx
