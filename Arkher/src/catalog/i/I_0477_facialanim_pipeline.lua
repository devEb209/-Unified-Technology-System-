-- ARKHER SYSTEM I.0477 :: Facial Animation Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0477"
	S.key = "arkher.anim.facialanim.playback_pipeline"
	S.name = "Facial Animation Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.facialanim.event_ledger" }
	S.tags = { "i", "facialanim", "pipeline", "anim" }
	S.description = "Facial Animation Playback Pipeline: ordered sample, blend, ik and output stages for the Facial Animation subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.facialanim.playback_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
