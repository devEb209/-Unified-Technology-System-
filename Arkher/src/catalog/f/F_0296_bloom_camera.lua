-- ARKHER SYSTEM F.0296 :: Bloom View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0296"
	S.key = "arkher.render.bloom.view_and_culling"
	S.name = "Bloom View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Bloom"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.bloom.frame_graph" }
	S.tags = { "f", "bloom", "camera", "render" }
	S.description = "Bloom View And Culling: view state, frustum culling and screen-size LOD for the Bloom subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.bloom.view_and_culling", width = 828, height = 1260, fov = 1.2500, far = 1800 })
		inst.system = S
		inst.ctx = ctx
