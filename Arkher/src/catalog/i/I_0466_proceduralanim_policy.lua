-- ARKHER SYSTEM I.0466 :: Procedural Animation Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0466"
	S.key = "arkher.anim.proceduralanim.quality_policy"
	S.name = "Procedural Animation Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.proceduralanim.pose_cache" }
	S.tags = { "i", "proceduralanim", "policy", "anim" }
	S.description = "Procedural Animation Quality Policy: device tier rules for rate, bones and solvers for the Procedural Animation subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.proceduralanim.quality_policy", algorithm = "wfq", starvationGuard = 30 })
		inst.system = S
		inst.ctx = ctx
