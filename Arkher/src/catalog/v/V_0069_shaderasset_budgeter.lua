-- ARKHER SYSTEM V.0069 :: Shader Asset Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0069"
	S.key = "arkher.asset.shaderasset.size_budget"
	S.name = "Shader Asset Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.shaderasset.compression_codec" }
	S.tags = { "v", "shaderasset", "budgeter", "asset" }
	S.description = "Shader Asset Size Budget: byte budget shared between competing asset classes for the Shader Asset subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.shaderasset.size_budget", total = 313, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
