-- ARKHER SYSTEM J.0164 :: Gesture Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0164"
	S.key = "arkher.character.gesture.streaming"
	S.name = "Gesture Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gesture.budget_governor" }
	S.tags = { "j", "gesture", "streamer", "character" }
	S.description = "Gesture Streaming: distance-driven residency of character data for the Gesture subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.gesture.streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
