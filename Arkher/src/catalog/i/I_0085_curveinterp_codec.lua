-- ARKHER SYSTEM I.0085 :: Curve Interpolation Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0085"
	S.key = "arkher.anim.curveinterp.compression_codec"
	S.name = "Curve Interpolation Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.curveinterp.retarget_graph" }
	S.tags = { "i", "curveinterp", "codec", "anim" }
	S.description = "Curve Interpolation Compression Codec: curve compression and quantized transport for the Curve Interpolation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.curveinterp.compression_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
