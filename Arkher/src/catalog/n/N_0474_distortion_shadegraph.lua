-- ARKHER SYSTEM N.0474 :: Distortion Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0474"
	S.key = "arkher.vfx.distortion.effect_graph"
	S.name = "Distortion Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Distortion"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.distortion.curve_authoring" }
	S.tags = { "n", "distortion", "shadegraph", "vfx" }
	S.description = "Distortion Effect Graph: node graph describing how the effect is shaded for the Distortion subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.distortion.effect_graph" })
		inst.system = S
		inst.ctx = ctx
