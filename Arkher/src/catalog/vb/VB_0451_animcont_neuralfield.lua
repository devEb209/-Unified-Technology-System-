-- ARKHER SYSTEM VB.0451 :: Animation Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0451"
	S.key = "arkher.conttime.animcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.animcont.coherence_guard" }
	S.tags = { "vb", "animcont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.animcont.neural_field", dims = 12, hidden = 8, seed = 10572 })
		inst.system = S
		inst.ctx = ctx
