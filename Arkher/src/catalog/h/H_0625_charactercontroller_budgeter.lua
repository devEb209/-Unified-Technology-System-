-- ARKHER SYSTEM H.0625 :: Character Controller Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0625"
	S.key = "arkher.physics.charactercontroller.budget_governor"
	S.name = "Character Controller Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.charactercontroller.broadphase_index" }
	S.tags = { "h", "charactercontroller", "budgeter", "physics" }
	S.description = "Character Controller Budget Governor: simulation time budget allocation across islands for the Character Controller subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.charactercontroller.budget_governor", total = 110, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
