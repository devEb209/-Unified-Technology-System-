-- ARKHER SYSTEM VA.0150 :: Persistence Segment Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0150"
	S.key = "arkher.contworld.persistsegment.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.persistsegment.persistent_state" }
	S.tags = { "va", "persistsegment", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.persistsegment.coherence_guard", window = 107, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
