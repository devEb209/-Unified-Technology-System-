-- ARKHER SYSTEM VB.0614 :: Occupancy Map Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0614"
	S.key = "arkher.conttime.occupancymap.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.occupancymap.infinite_grid" }
	S.tags = { "vb", "occupancymap", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.occupancymap.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
