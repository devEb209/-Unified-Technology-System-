-- ARKHER SYSTEM R.0157 :: Snapshot Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0157"
	S.key = "arkher.net.snapshot.replication"
	S.name = "Snapshot Replication"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Snapshot"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "snapshot", "replicator", "net" }
	S.description = "Snapshot Replication: authoritative entity state, interest and delta snapshots for the Snapshot subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.snapshot.replication", mtu = 750, interestRadius = 160, fullEvery = 105 })
		inst.system = S
		inst.ctx = ctx
