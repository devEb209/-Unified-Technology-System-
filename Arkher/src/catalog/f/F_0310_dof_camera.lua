-- ARKHER SYSTEM F.0310 :: Depth Of Field View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0310"
	S.key = "arkher.render.dof.view_and_culling"
	S.name = "Depth Of Field View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.dof.frame_graph" }
	S.tags = { "f", "dof", "camera", "render" }
	S.description = "Depth Of Field View And Culling: view state, frustum culling and screen-size LOD for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.dof.view_and_culling", width = 956, height = 1080, fov = 1.1600, far = 1200 })
		inst.system = S
		inst.ctx = ctx
