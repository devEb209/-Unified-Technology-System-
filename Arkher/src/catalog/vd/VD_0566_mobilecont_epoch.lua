-- ARKHER SYSTEM VD.0566 :: Mobile Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0566"
	S.key = "arkher.contsim.mobilecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.mobilecont.infinite_grid" }
	S.tags = { "vd", "mobilecont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.mobilecont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
