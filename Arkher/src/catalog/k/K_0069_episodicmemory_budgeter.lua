-- ARKHER SYSTEM K.0069 :: Episodic Memory Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0069"
	S.key = "arkher.npc.episodicmemory.thinking_budget"
	S.name = "Episodic Memory Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.episodicmemory.daily_schedule" }
	S.tags = { "k", "episodicmemory", "budgeter", "npc" }
	S.description = "Episodic Memory Thinking Budget: allocation of per-frame thinking time across NPCs for the Episodic Memory subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.episodicmemory.thinking_budget", total = 186, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
