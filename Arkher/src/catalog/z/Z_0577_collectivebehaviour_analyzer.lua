-- ARKHER SYSTEM Z.0577 :: Collective Behaviour Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0577"
	S.key = "arkher.origin.collectivebehaviour.behaviour_analysis"
	S.name = "Collective Behaviour Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.collectivebehaviour.governance_policy" }
	S.tags = { "z", "collectivebehaviour", "analyzer", "origin" }
	S.description = "Collective Behaviour Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Collective Behaviour subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.collectivebehaviour.behaviour_analysis", window = 91, buckets = 11, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
