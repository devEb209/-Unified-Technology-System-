-- ARKHER SYSTEM Z.0622 :: Intent Driven Authoring Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0622"
	S.key = "arkher.origin.intentauthoring.complexity_governance"
	S.name = "Intent Driven Authoring Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.reality_layering" }
	S.tags = { "z", "intentauthoring", "complexity", "origin" }
	S.description = "Intent Driven Authoring Complexity Governance: measured scene cost turned into per-subsystem directives for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.intentauthoring.complexity_governance", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
