-- ARKHER SYSTEM H.0216 :: Fixed Timestep Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0216"
	S.key = "arkher.physics.fixedstep.character_motion"
	S.name = "Fixed Timestep Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.fixedstep.query" }
	S.tags = { "h", "fixedstep", "charmotor", "physics" }
	S.description = "Fixed Timestep Character Motion: capsule move-and-slide with slopes, steps and jumps for the Fixed Timestep subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.fixedstep.character_motion", radius = 0.52, height = 1.77, maxSpeed = 9.70, jumpHeight = 2.10, stepOffset = 0.52 })
		inst.system = S
		inst.ctx = ctx
