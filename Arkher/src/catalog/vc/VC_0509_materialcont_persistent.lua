-- ARKHER SYSTEM VC.0509 :: Material Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0509"
	S.key = "arkher.contneural.materialcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.materialcont.multi-scale_fidelity" }
	S.tags = { "vc", "materialcont", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.materialcont.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
