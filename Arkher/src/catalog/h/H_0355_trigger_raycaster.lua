-- ARKHER SYSTEM H.0355 :: Trigger Volume Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0355"
	S.key = "arkher.physics.trigger.query"
	S.name = "Trigger Volume Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.trigger.constraint_solver" }
	S.tags = { "h", "trigger", "raycaster", "physics" }
	S.description = "Trigger Volume Query: rays, sweeps and overlaps against the simulation for the Trigger Volume subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.trigger.query", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
