-- ARKHER SYSTEM H.0036 :: Kinematic Body Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0036"
	S.key = "arkher.physics.kinematicbody.broadphase_index"
	S.name = "Kinematic Body Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.kinematicbody.vehicle" }
	S.tags = { "h", "kinematicbody", "index", "physics" }
	S.description = "Kinematic Body Broadphase Index: spatial acceleration of candidate pair finding for the Kinematic Body subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.kinematicbody.broadphase_index", mode = "hash", cellSize = 64 })
		inst.system = S
		inst.ctx = ctx
