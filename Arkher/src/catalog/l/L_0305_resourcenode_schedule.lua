-- ARKHER SYSTEM L.0305 :: Resource Node Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0305"
	S.key = "arkher.sim.resourcenode.calendar"
	S.name = "Resource Node Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.resourcenode.society" }
	S.tags = { "l", "resourcenode", "schedule", "sim" }
	S.description = "Resource Node Calendar: hours, days and seasons driving the region for the Resource Node subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.resourcenode.calendar", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
