-- ARKHER SYSTEM J.0024 :: Body Proportions Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0024"
	S.key = "arkher.character.proportions.motion_set"
	S.name = "Body Proportions Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.proportions.rig_definition" }
	S.tags = { "j", "proportions", "clip", "character" }
	S.description = "Body Proportions Motion Set: the clips a character owns and how they sample for the Body Proportions subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.proportions.motion_set", duration = 1.40, loop = true })
		inst.system = S
		inst.ctx = ctx
