-- ARKHER SYSTEM E.0339 :: Rust Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0339"
	S.key = "arkher.material.rust.compression_codec"
	S.name = "Rust Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Rust"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.rust.streaming" }
	S.tags = { "e", "rust", "codec", "material" }
	S.description = "Rust Compression Codec: serialization and compression of material data for the Rust subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.rust.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
