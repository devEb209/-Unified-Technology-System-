-- ARKHER SYSTEM F.0663 :: VR Stereo Path Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0663"
	S.key = "arkher.render.vrpath.lighting_rig"
	S.name = "VR Stereo Path Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.vrpath.geometry_virtualization" }
	S.tags = { "f", "vrpath", "lightrig", "render" }
	S.description = "VR Stereo Path Lighting Rig: light clustering, importance and cascades for the VR Stereo Path subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.vrpath.lighting_rig", maxActive = 11 })
		inst.system = S
		inst.ctx = ctx
