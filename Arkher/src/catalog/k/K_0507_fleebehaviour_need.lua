-- ARKHER SYSTEM K.0507 :: Flee Behaviour Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0507"
	S.key = "arkher.npc.fleebehaviour.drive_system"
	S.name = "Flee Behaviour Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.fleebehaviour.memory" }
	S.tags = { "k", "fleebehaviour", "need", "npc" }
	S.description = "Flee Behaviour Drive System: drives that decay, turn urgent and get satisfied for the Flee Behaviour subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.fleebehaviour.drive_system" })
		inst.system = S
		inst.ctx = ctx
