-- ARKHER SYSTEM N.0441 :: Cloth Wind Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0441"
	S.key = "arkher.vfx.clothwind.analysis"
	S.name = "Cloth Wind Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloth Wind"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.clothwind.spatial_index" }
	S.tags = { "n", "clothwind", "analyzer", "vfx" }
	S.description = "Cloth Wind Analysis: cost, overdraw and stability analysis of the effect for the Cloth Wind subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.clothwind.analysis", window = 167, buckets = 19, threshold = 4.90 })
		inst.system = S
		inst.ctx = ctx
