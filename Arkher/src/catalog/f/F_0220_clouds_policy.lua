-- ARKHER SYSTEM F.0220 :: Cloud Rendering Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0220"
	S.key = "arkher.render.clouds.render_policy"
	S.name = "Cloud Rendering Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.clouds.draw_budget" }
	S.tags = { "f", "clouds", "policy", "render" }
	S.description = "Cloud Rendering Render Policy: device tier rules for the frame for the Cloud Rendering subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.clouds.render_policy", algorithm = "lottery", starvationGuard = 31 })
		inst.system = S
		inst.ctx = ctx
