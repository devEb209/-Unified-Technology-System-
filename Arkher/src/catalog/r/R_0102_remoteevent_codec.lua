-- ARKHER SYSTEM R.0102 :: Remote Event Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0102"
	S.key = "arkher.net.remoteevent.serialization_codec"
	S.name = "Remote Event Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Remote Event"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remoteevent.bandwidth_budget" }
	S.tags = { "r", "remoteevent", "codec", "net" }
	S.description = "Remote Event Serialization Codec: compact encoding, diffing and checksum of payloads for the Remote Event subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.remoteevent.serialization_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
