-- ARKHER SYSTEM K.0610 :: Faction Membership Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0610"
	S.key = "arkher.npc.factionmembership.goal_planner"
	S.name = "Faction Membership Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.factionmembership.utility_reasoning" }
	S.tags = { "k", "factionmembership", "planner", "npc" }
	S.description = "Faction Membership Goal Planner: backward GOAP planning to reach a goal state for the Faction Membership subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.factionmembership.goal_planner", maxDepth = 9 })
		inst.system = S
		inst.ctx = ctx
