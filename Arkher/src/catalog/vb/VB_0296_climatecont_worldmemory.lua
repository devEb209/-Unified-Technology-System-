-- ARKHER SYSTEM VB.0296 :: Climate Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0296"
	S.key = "arkher.conttime.climatecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.climatecont.neural_field" }
	S.tags = { "vb", "climatecont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.climatecont.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
