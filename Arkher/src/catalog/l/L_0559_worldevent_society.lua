-- ARKHER SYSTEM L.0559 :: World Event Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0559"
	S.key = "arkher.sim.worldevent.society"
	S.name = "World Event Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldevent.economy" }
	S.tags = { "l", "worldevent", "society", "sim" }
	S.description = "World Event Society: relations, factions, reputation and cohesion of the region for the World Event subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.worldevent.society", decayRate = 0.008, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
