-- ARKHER SYSTEM L.0493 :: Diplomacy Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0493"
	S.key = "arkher.sim.diplomacy.analysis"
	S.name = "Diplomacy Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.diplomacy.aggregate_cache" }
	S.tags = { "l", "diplomacy", "analyzer", "sim" }
	S.description = "Diplomacy Analysis: trend, anomaly and stability analysis of the world for the Diplomacy subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.diplomacy.analysis", window = 110, buckets = 10, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
