-- ARKHER SYSTEM G.0231 :: Animation Compression Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0231"
	S.key = "arkher.neural.animcompress.quality_predictor"
	S.name = "Animation Compression Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.animcompress.weight_codec" }
	S.tags = { "g", "animcompress", "predictor", "neural" }
	S.description = "Animation Compression Quality Predictor: predicted quality and cost of a setting for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.animcompress.quality_predictor", method = "linear", alpha = 0.37, window = 51 })
		inst.system = S
		inst.ctx = ctx
