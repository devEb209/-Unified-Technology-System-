-- ARKHER SYSTEM K.0249 :: Temperament Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0249"
	S.key = "arkher.npc.temperament.social_relations"
	S.name = "Temperament Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.temperament.crowd_steering" }
	S.tags = { "k", "temperament", "society", "npc" }
	S.description = "Temperament Social Relations: affinity, factions, reputation and gossip for the Temperament subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.temperament.social_relations", decayRate = 0.010, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
