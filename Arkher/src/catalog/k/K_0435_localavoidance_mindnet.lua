-- ARKHER SYSTEM K.0435 :: Local Avoidance Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0435"
	S.key = "arkher.npc.localavoidance.mind_network"
	S.name = "Local Avoidance Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "localavoidance", "mindnet", "npc" }
	S.description = "Local Avoidance Mind Network: the learned policy that turns perception into a decision for the Local Avoidance subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.localavoidance.mind_network", inputs = 9, hidden = 5, seed = 81891, learningRate = 0.055, exploration = 0.035 })
		inst.system = S
		inst.ctx = ctx
