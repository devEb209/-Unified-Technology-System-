-- ARKHER SYSTEM VA.0216 :: Biome Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0216"
	S.key = "arkher.contworld.biomecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.biomecont.reality_continuum" }
	S.tags = { "va", "biomecont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.biomecont.emergence_continuum", windowSize = 5, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
