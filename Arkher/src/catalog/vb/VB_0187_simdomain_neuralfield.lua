-- ARKHER SYSTEM VB.0187 :: Simulation Domain Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0187"
	S.key = "arkher.conttime.simdomain.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.simdomain.coherence_guard" }
	S.tags = { "vb", "simdomain", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.simdomain.neural_field", dims = 20, hidden = 16, seed = 45554 })
		inst.system = S
		inst.ctx = ctx
