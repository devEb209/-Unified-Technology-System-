-- ARKHER SYSTEM Q.0293 :: Gesture Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0293"
	S.key = "arkher.ui.gesture.navigation_graph"
	S.name = "Gesture Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Gesture"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.gesture.transition" }
	S.tags = { "q", "gesture", "graph", "ui" }
	S.description = "Gesture Navigation Graph: screens, routes and shortest path between them for the Gesture subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.gesture.navigation_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
