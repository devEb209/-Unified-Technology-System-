-- ARKHER SYSTEM R.0146 :: Delta Compression Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0146"
	S.key = "arkher.net.deltacompression.time_sync"
	S.name = "Delta Compression Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.deltacompression.replication" }
	S.tags = { "r", "deltacompression", "netclock", "net" }
	S.description = "Delta Compression Time Sync: offset estimation, outlier rejection and jitter buffering for the Delta Compression subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.deltacompression.time_sync", tickRate = 40, bufferDelay = 0.100, maxSamples = 18 })
		inst.system = S
		inst.ctx = ctx
