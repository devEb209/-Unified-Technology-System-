-- ARKHER SYSTEM K.0116 :: Forgetting Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0116"
	S.key = "arkher.npc.forgetting.emotion"
	S.name = "Forgetting Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.forgetting.drive_system" }
	S.tags = { "k", "forgetting", "emotion", "npc" }
	S.description = "Forgetting Emotion: appraisal of events into valence, arousal and mood for the Forgetting subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.forgetting.emotion", inertia = 0.90, decayRate = 0.25, baselineArousal = 0.25 })
		inst.system = S
		inst.ctx = ctx
