-- ARKHER SYSTEM VA.0301 :: Weather Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0301"
	S.key = "arkher.contworld.weathercont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "weathercont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.weathercont.infinite_grid", cellSize = 192, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
