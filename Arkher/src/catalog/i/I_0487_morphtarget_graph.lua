-- ARKHER SYSTEM I.0487 :: Morph Target Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0487"
	S.key = "arkher.anim.morphtarget.retarget_graph"
	S.name = "Morph Target Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Morph Target"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.morphtarget.physical_blend" }
	S.tags = { "i", "morphtarget", "graph", "anim" }
	S.description = "Morph Target Retarget Graph: bone mapping and retarget path resolution for the Morph Target subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.morphtarget.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
