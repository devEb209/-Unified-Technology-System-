-- ARKHER SYSTEM P.0198 :: Shop Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0198"
	S.key = "arkher.play.shop.rule_pipeline"
	S.name = "Shop Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Shop"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.shop.state_machine" }
	S.tags = { "p", "shop", "pipeline", "play" }
	S.description = "Shop Rule Pipeline: ordered rules applied to every gameplay event for the Shop subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.shop.rule_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
