-- ARKHER SYSTEM H.0346 :: Compound Collider Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0346"
	S.key = "arkher.physics.compoundcollider.simulation_policy"
	S.name = "Compound Collider Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.compoundcollider.budget_governor" }
	S.tags = { "h", "compoundcollider", "policy", "physics" }
	S.description = "Compound Collider Simulation Policy: device tier rules for substeps, iterations and sleep for the Compound Collider subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.compoundcollider.simulation_policy", algorithm = "edf", starvationGuard = 25 })
		inst.system = S
		inst.ctx = ctx
