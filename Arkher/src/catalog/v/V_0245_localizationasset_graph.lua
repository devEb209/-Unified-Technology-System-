-- ARKHER SYSTEM V.0245 :: Localization Asset Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0245"
	S.key = "arkher.asset.localizationasset.dependency_graph"
	S.name = "Localization Asset Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.localizationasset.asset_registry" }
	S.tags = { "v", "localizationasset", "graph", "asset" }
	S.description = "Localization Asset Dependency Graph: what references what, and in which order it must be built for the Localization Asset subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.localizationasset.dependency_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
