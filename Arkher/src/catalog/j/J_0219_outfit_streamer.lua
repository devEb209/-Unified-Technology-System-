-- ARKHER SYSTEM J.0219 :: Outfit Composition Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0219"
	S.key = "arkher.character.outfit.streaming"
	S.name = "Outfit Composition Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.outfit.budget_governor" }
	S.tags = { "j", "outfit", "streamer", "character" }
	S.description = "Outfit Composition Streaming: distance-driven residency of character data for the Outfit Composition subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.outfit.streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
