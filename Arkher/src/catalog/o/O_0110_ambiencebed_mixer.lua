-- ARKHER SYSTEM O.0110 :: Ambience Bed Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0110"
	S.key = "arkher.audio.ambiencebed.mixer_bus"
	S.name = "Ambience Bed Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Ambience Bed"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.ambiencebed.dsp_chain" }
	S.tags = { "o", "ambiencebed", "mixer", "audio" }
	S.description = "Ambience Bed Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Ambience Bed subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.ambiencebed.mixer_bus", maxVoices = 48 })
		inst.system = S
		inst.ctx = ctx
