-- ARKHER SYSTEM Z.0459 :: Player Absence Simulation Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0459"
	S.key = "arkher.origin.playerabsence.residency_streaming"
	S.name = "Player Absence Simulation Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.budget_governor" }
	S.tags = { "z", "playerabsence", "streamer", "origin" }
	S.description = "Player Absence Simulation Residency Streaming: distance-driven residency of the technology's workload for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.playerabsence.residency_streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
