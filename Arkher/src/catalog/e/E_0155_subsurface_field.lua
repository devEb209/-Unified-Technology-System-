-- ARKHER SYSTEM E.0155 :: Subsurface Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0155"
	S.key = "arkher.material.subsurface.procedural_detail"
	S.name = "Subsurface Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Subsurface"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.subsurface.texture_sampling" }
	S.tags = { "e", "subsurface", "field", "material" }
	S.description = "Subsurface Procedural Detail: coherent noise detail driving the surface for the Subsurface subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.subsurface.procedural_detail", seed = 73086, frequency = 0.0055, octaves = 5, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
		...
		function inst.integrate(engine)
			...
			inst.engine = engine
			if engine.bus then
				engine.bus:subscribe("arkher.material.subsurface.*", function(payload) inst.lastSignal = payload end)
			end
