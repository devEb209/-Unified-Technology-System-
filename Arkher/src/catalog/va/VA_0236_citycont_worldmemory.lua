-- ARKHER SYSTEM VA.0236 :: City Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0236"
	S.key = "arkher.contworld.citycont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.citycont.neural_field" }
	S.tags = { "va", "citycont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.citycont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
