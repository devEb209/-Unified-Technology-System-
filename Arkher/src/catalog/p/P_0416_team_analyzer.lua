-- ARKHER SYSTEM P.0416 :: Team Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0416"
	S.key = "arkher.play.team.balance_analysis"
	S.name = "Team Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Team"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.team.event_ledger" }
	S.tags = { "p", "team", "analyzer", "play" }
	S.description = "Team Balance Analysis: distribution, outlier and pacing analysis for the Team subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.team.balance_analysis", window = 150, buckets = 10, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
