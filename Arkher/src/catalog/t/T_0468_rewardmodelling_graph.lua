-- ARKHER SYSTEM T.0468 :: Reward Modelling Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0468"
	S.key = "arkher.ai.rewardmodelling.reasoning_graph"
	S.name = "Reward Modelling Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.rewardmodelling.world_architect" }
	S.tags = { "t", "rewardmodelling", "graph", "ai" }
	S.description = "Reward Modelling Reasoning Graph: relationship modelling and shortest-path reasoning for the Reward Modelling subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.rewardmodelling.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
