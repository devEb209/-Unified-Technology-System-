-- ARKHER SYSTEM K.0242 :: Temperament Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0242"
	S.key = "arkher.npc.temperament.emotion"
	S.name = "Temperament Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.temperament.drive_system" }
	S.tags = { "k", "temperament", "emotion", "npc" }
	S.description = "Temperament Emotion: appraisal of events into valence, arousal and mood for the Temperament subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.temperament.emotion", inertia = 0.84, decayRate = 0.39, baselineArousal = 0.19 })
		inst.system = S
		inst.ctx = ctx
