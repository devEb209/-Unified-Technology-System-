-- ARKHER SYSTEM N.0307 :: Status Effect Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0307"
	S.key = "arkher.vfx.statusfx.spawn_budget"
	S.name = "Status Effect Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.statusfx.effect_composition" }
	S.tags = { "n", "statusfx", "budgeter", "vfx" }
	S.description = "Status Effect Spawn Budget: global particle budget shared by every live effect for the Status Effect subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.statusfx.spawn_budget", total = 315, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
