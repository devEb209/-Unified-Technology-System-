-- ARKHER SYSTEM Z.0431 :: Offline World Progression Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0431"
	S.key = "arkher.origin.offlineprogression.adaptive_workflow"
	S.name = "Offline World Progression Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.self_critique" }
	S.tags = { "z", "offlineprogression", "workflow", "origin" }
	S.description = "Offline World Progression Adaptive Workflow: verified, retryable, reversible execution plans for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.offlineprogression.adaptive_workflow", maxRetries = 3, budget = 90 })
		inst.system = S
		inst.ctx = ctx
