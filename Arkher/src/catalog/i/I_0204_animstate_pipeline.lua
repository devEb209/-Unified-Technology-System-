-- ARKHER SYSTEM I.0204 :: State Machine Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0204"
	S.key = "arkher.anim.animstate.playback_pipeline"
	S.name = "State Machine Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstate.event_ledger" }
	S.tags = { "i", "animstate", "pipeline", "anim" }
	S.description = "State Machine Playback Pipeline: ordered sample, blend, ik and output stages for the State Machine subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.animstate.playback_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
