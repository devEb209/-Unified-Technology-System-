-- ARKHER SYSTEM N.0103 :: Muzzle Flash Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0103"
	S.key = "arkher.vfx.muzzleflash.analysis"
	S.name = "Muzzle Flash Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Muzzle Flash"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.muzzleflash.spatial_index" }
	S.tags = { "n", "muzzleflash", "analyzer", "vfx" }
	S.description = "Muzzle Flash Analysis: cost, overdraw and stability analysis of the effect for the Muzzle Flash subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.muzzleflash.analysis", window = 87, buckets = 19, threshold = 4.90 })
		inst.system = S
		inst.ctx = ctx
