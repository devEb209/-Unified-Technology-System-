-- ARKHER SYSTEM VA.0561 :: Device Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0561"
	S.key = "arkher.contworld.devicecont.complexity_budget"
	S.name = "Device Continuum Complexity Budget"
	S.category = "VA"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.devicecont.world_memory_stream" }
	S.tags = { "va", "devicecont", "complexity", "contworld" }
	S.description = "Device Continuum Complexity Budget: complexity budgeting for the continuum for the Device Continuum subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.devicecont.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
