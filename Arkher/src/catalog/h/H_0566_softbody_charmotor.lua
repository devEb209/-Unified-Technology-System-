-- ARKHER SYSTEM H.0566 :: Soft Body Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0566"
	S.key = "arkher.physics.softbody.character_motion"
	S.name = "Soft Body Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Soft Body"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.softbody.query" }
	S.tags = { "h", "softbody", "charmotor", "physics" }
	S.description = "Soft Body Character Motion: capsule move-and-slide with slopes, steps and jumps for the Soft Body subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.softbody.character_motion", radius = 0.47, height = 1.72, maxSpeed = 7.20, jumpHeight = 2.00, stepOffset = 0.27 })
		inst.system = S
		inst.ctx = ctx
