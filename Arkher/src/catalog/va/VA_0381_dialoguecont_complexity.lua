-- ARKHER SYSTEM VA.0381 :: Dialogue Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0381"
	S.key = "arkher.contworld.dialoguecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.dialoguecont.world_memory_stream" }
	S.tags = { "va", "dialoguecont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.dialoguecont.complexity_budget", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
