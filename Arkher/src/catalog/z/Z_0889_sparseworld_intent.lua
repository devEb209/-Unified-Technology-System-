-- ARKHER SYSTEM Z.0889 :: Sparse World Representation Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0889"
	S.key = "arkher.origin.sparseworld.intent_bridge"
	S.name = "Sparse World Representation Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.semantic_graph" }
	S.tags = { "z", "sparseworld", "intent", "origin" }
	S.description = "Sparse World Representation Intent Bridge: natural language control surface for the technology for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.sparseworld.intent_bridge", minConfidence = 0.34 })
		inst.system = S
		inst.ctx = ctx
