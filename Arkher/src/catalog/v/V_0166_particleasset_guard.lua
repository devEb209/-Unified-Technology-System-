-- ARKHER SYSTEM V.0166 :: Particle Asset Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0166"
	S.key = "arkher.asset.particleasset.validation_guard"
	S.name = "Particle Asset Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.particleasset.size_budget" }
	S.tags = { "v", "particleasset", "guard", "asset" }
	S.description = "Particle Asset Validation Guard: rate limiting and capability checks on the import path for the Particle Asset subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.particleasset.validation_guard", algorithm = "token", capacity = 178, refillPerSec = 23, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
