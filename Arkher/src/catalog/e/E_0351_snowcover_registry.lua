-- ARKHER SYSTEM E.0351 :: Snow Cover Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0351"
	S.key = "arkher.material.snowcover.variant_registry"
	S.name = "Snow Cover Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Snow Cover"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.snowcover.procedural_detail" }
	S.tags = { "e", "snowcover", "registry", "material" }
	S.description = "Snow Cover Variant Registry: named variants and their lifecycle for the Snow Cover subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.snowcover.variant_registry" })
		inst.system = S
		inst.ctx = ctx
