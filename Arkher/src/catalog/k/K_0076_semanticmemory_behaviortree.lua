-- ARKHER SYSTEM K.0076 :: Semantic Memory Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0076"
	S.key = "arkher.npc.semanticmemory.reactive_behaviour"
	S.name = "Semantic Memory Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.semanticmemory.perception" }
	S.tags = { "k", "semanticmemory", "behaviortree", "npc" }
	S.description = "Semantic Memory Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Semantic Memory subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.semanticmemory.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
