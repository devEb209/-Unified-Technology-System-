-- ARKHER SYSTEM V.0295 :: LOD Chain Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0295"
	S.key = "arkher.asset.lodchain.streaming_residency"
	S.name = "LOD Chain Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lodchain.content_cache" }
	S.tags = { "v", "lodchain", "streamer", "asset" }
	S.description = "LOD Chain Streaming Residency: distance-driven load and unload of asset payloads for the LOD Chain subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.lodchain.streaming_residency", radius = 320, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
