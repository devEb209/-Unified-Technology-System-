-- ARKHER SYSTEM Q.0082 :: Grid Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0082"
	S.key = "arkher.ui.grid.frame_budget"
	S.name = "Grid Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Grid"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.grid.accessibility_policy" }
	S.tags = { "q", "grid", "budgeter", "ui" }
	S.description = "Grid Frame Budget: per-frame layout and draw budget for the interface for the Grid subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.grid.frame_budget", total = 164, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
