-- ARKHER SYSTEM R.0355 :: Network Debug Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0355"
	S.key = "arkher.net.networkdebug.interest_streaming"
	S.name = "Network Debug Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.networkdebug.serialization_codec" }
	S.tags = { "r", "networkdebug", "streamer", "net" }
	S.description = "Network Debug Interest Streaming: distance-driven residency of replicated content for the Network Debug subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.networkdebug.interest_streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
