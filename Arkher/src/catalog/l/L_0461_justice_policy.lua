-- ARKHER SYSTEM L.0461 :: Justice Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0461"
	S.key = "arkher.sim.justice.fidelity_policy"
	S.name = "Justice Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.justice.streaming" }
	S.tags = { "l", "justice", "policy", "sim" }
	S.description = "Justice Fidelity Policy: rules that pick full, cohort or statistical simulation for the Justice subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.justice.fidelity_policy", algorithm = "wfq", starvationGuard = 26 })
		inst.system = S
		inst.ctx = ctx
