-- ARKHER SYSTEM Z.0982 :: Engine Self Model Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0982"
	S.key = "arkher.origin.engineselfmodel.complexity_governance"
	S.name = "Engine Self Model Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.engineselfmodel.reality_layering" }
	S.tags = { "z", "engineselfmodel", "complexity", "origin" }
	S.description = "Engine Self Model Complexity Governance: measured scene cost turned into per-subsystem directives for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.engineselfmodel.complexity_governance", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
