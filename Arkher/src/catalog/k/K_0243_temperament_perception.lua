-- ARKHER SYSTEM K.0243 :: Temperament Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0243"
	S.key = "arkher.npc.temperament.perception"
	S.name = "Temperament Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.temperament.emotion" }
	S.tags = { "k", "temperament", "perception", "npc" }
	S.description = "Temperament Perception: sight, hearing and bounded attention for the Temperament subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.temperament.perception", sightRange = 30, hearingRange = 16, attentionSlots = 4, fov = 1.770 })
		inst.system = S
		inst.ctx = ctx
