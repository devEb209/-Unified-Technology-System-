-- ARKHER SYSTEM VB.0206 :: Biome Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0206"
	S.key = "arkher.conttime.biomecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.biomecont.infinite_grid" }
	S.tags = { "vb", "biomecont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.biomecont.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
