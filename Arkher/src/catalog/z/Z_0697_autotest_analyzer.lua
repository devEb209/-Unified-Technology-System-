-- ARKHER SYSTEM Z.0697 :: Auto Test Synthesis Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0697"
	S.key = "arkher.origin.autotest.behaviour_analysis"
	S.name = "Auto Test Synthesis Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autotest.governance_policy" }
	S.tags = { "z", "autotest", "analyzer", "origin" }
	S.description = "Auto Test Synthesis Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Auto Test Synthesis subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.autotest.behaviour_analysis", window = 205, buckets = 9, threshold = 2.70 })
		inst.system = S
		inst.ctx = ctx
