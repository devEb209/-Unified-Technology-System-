-- ARKHER SYSTEM VD.0438 :: Physics Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0438"
	S.key = "arkher.contsim.physicscont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.physicscont.persistent_state" }
	S.tags = { "vd", "physicscont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.physicscont.coherence_guard", window = 120, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
