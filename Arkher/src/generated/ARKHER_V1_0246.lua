...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="OSM ODbL — CORE Node_Flow #0246", size=Vector2.new(600, 440), pos=UDim2.fromOffset(498, 102), parent=parent, icon="▶"})
