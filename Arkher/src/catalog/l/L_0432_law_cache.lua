-- ARKHER SYSTEM L.0432 :: Law Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0432"
	S.key = "arkher.sim.law.aggregate_cache"
	S.name = "Law Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.law.fidelity_policy" }
	S.tags = { "l", "law", "cache", "sim" }
	S.description = "Law Aggregate Cache: reuse of expensive aggregate computations for the Law subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.law.aggregate_cache", policy = "ttl", capacity = 202, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
