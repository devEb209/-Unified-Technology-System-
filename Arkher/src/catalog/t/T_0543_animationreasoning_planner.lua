-- ARKHER SYSTEM T.0543 :: Animation Reasoning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0543"
	S.key = "arkher.ai.animationreasoning.action_planner"
	S.name = "Animation Reasoning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.animationreasoning.utility_selection" }
	S.tags = { "t", "animationreasoning", "planner", "ai" }
	S.description = "Animation Reasoning Action Planner: goal-oriented action planning over preconditions for the Animation Reasoning subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.animationreasoning.action_planner", maxDepth = 9 })
		inst.system = S
		inst.ctx = ctx
