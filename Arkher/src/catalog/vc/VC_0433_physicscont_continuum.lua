-- ARKHER SYSTEM VC.0433 :: Physics Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0433"
	S.key = "arkher.contneural.physicscont.infinite_grid"
	S.name = "Physics Continuum Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "physicscont", "continuum", "contneural" }
	S.description = "Physics Continuum Infinite Grid: seamless paging of the infinite world grid for the Physics Continuum subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.physicscont.infinite_grid", cellSize = 224, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
