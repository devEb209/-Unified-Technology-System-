-- ARKHER SYSTEM F.0161 :: Volumetric Light Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0161"
	S.key = "arkher.render.volumetric.temporal_resolve"
	S.name = "Volumetric Light Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.volumetric.probe_volume" }
	S.tags = { "f", "volumetric", "temporal", "render" }
	S.description = "Volumetric Light Temporal Resolve: history reprojection with neighbourhood clamping for the Volumetric Light subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.volumetric.temporal_resolve", feedback = 0.85, phase = 8 })
		inst.system = S
		inst.ctx = ctx
