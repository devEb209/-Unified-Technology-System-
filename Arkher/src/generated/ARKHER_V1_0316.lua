...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Godot4 — CORE Node_Flow #0316", size=Vector2.new(640, 440), pos=UDim2.fromOffset(208, 252), parent=parent, icon="⬡"})
