-- ARKHER SYSTEM W.0375 :: Playback Control Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0375"
	S.key = "arkher.cine.playbackcontrol.colour_grade"
	S.name = "Playback Control Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.playbackcontrol.camera_rig" }
	S.tags = { "w", "playbackcontrol", "grade", "cine" }
	S.description = "Playback Control Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Playback Control subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.playbackcontrol.colour_grade", exposure = 0.13, contrast = 1.18, saturation = 0.88, toneMap = "filmic" })
		inst.system = S
		inst.ctx = ctx
