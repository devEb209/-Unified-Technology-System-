-- ARKHER SYSTEM F.0470 :: Distance Culling Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0470"
	S.key = "arkher.render.distanceculling.adaptive_resolution"
	S.name = "Distance Culling Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.distanceculling.temporal_resolve" }
	S.tags = { "f", "distanceculling", "upscaler", "render" }
	S.description = "Distance Culling Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Distance Culling subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.distanceculling.adaptive_resolution", targetMs = 14.10, index = 3, sharpness = 0.45 })
		inst.system = S
		inst.ctx = ctx
