-- ARKHER SYSTEM P.0148 :: Crafting Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0148"
	S.key = "arkher.play.crafting.combat_resolution"
	S.name = "Crafting Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Crafting"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.crafting.objectives" }
	S.tags = { "p", "crafting", "combat", "play" }
	S.description = "Crafting Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Crafting subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.crafting.combat_resolution", seed = 61765, armourK = 130, critMultiplier = 1.60 })
		inst.system = S
		inst.ctx = ctx
