-- ARKHER SYSTEM I.0486 :: Morph Target Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0486"
	S.key = "arkher.anim.morphtarget.physical_blend"
	S.name = "Morph Target Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Morph Target"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.morphtarget.inverse_kinematics" }
	S.tags = { "i", "morphtarget", "ragdoll", "anim" }
	S.description = "Morph Target Physical Blend: physical bones blended against the animated pose for the Morph Target subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.morphtarget.physical_blend", blendSpeed = 4.60 })
		inst.system = S
		inst.ctx = ctx
