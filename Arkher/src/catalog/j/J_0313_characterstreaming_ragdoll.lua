-- ARKHER SYSTEM J.0313 :: Character Streaming Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0313"
	S.key = "arkher.character.characterstreaming.physical_response"
	S.name = "Character Streaming Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterstreaming.look_and_reach" }
	S.tags = { "j", "characterstreaming", "ragdoll", "character" }
	S.description = "Character Streaming Physical Response: physical reaction, ragdoll and recovery for the Character Streaming subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.characterstreaming.physical_response", blendSpeed = 2.90 })
		inst.system = S
		inst.ctx = ctx
