-- ARKHER SYSTEM T.0145 :: Tool Use World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0145"
	S.key = "arkher.ai.tooluse.world_architect"
	S.name = "Tool Use World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.tooluse.self_critique" }
	S.tags = { "t", "tooluse", "architect", "ai" }
	S.description = "Tool Use World Architect: composition of a whole world plan with conserved budgets for the Tool Use subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.tooluse.world_architect", budget = 1100, seed = 7105 })
		inst.system = S
		inst.ctx = ctx
