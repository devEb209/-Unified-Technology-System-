-- ARKHER SYSTEM T.0334 :: Bug Triage Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0334"
	S.key = "arkher.ai.bugtriage.model_inference"
	S.name = "Bug Triage Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.bugtriage.action_planner" }
	S.tags = { "t", "bugtriage", "inference", "ai" }
	S.description = "Bug Triage Model Inference: quantized inference with batching and budget for the Bug Triage subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.bugtriage.model_inference", seed = 86048 })
		inst.system = S
		inst.ctx = ctx
