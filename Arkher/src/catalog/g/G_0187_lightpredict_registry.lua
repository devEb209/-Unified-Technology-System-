-- ARKHER SYSTEM G.0187 :: Light Transport Prediction Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0187"
	S.key = "arkher.neural.lightpredict.model_registry"
	S.name = "Light Transport Prediction Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.lightpredict.reconstruction" }
	S.tags = { "g", "lightpredict", "registry", "neural" }
	S.description = "Light Transport Prediction Model Registry: named models and their lifecycle for the Light Transport Prediction subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.lightpredict.model_registry" })
		inst.system = S
		inst.ctx = ctx
