-- ARKHER SYSTEM E.0182 :: Anisotropy Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0182"
	S.key = "arkher.material.anisotropy.layer_composition"
	S.name = "Anisotropy Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Anisotropy"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.anisotropy.definition" }
	S.tags = { "e", "anisotropy", "composer", "material" }
	S.description = "Anisotropy Layer Composition: ordered layer composition with blend rules for the Anisotropy subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.anisotropy.layer_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
