-- ARKHER SYSTEM T.0310 :: Optimization Advisor Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0310"
	S.key = "arkher.ai.optimizationadvisor.semantic_knowledge"
	S.name = "Optimization Advisor Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.optimizationadvisor.intent_understanding" }
	S.tags = { "t", "optimizationadvisor", "knowledge", "ai" }
	S.description = "Optimization Advisor Semantic Knowledge: typed entities, weighted relations and inferred closure for the Optimization Advisor subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.optimizationadvisor.semantic_knowledge", dims = 16 })
		inst.system = S
		inst.ctx = ctx
