-- ARKHER SYSTEM F.0068 :: Shadow Pass Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0068"
	S.key = "arkher.render.shadowpass.frame_analysis"
	S.name = "Shadow Pass Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Shadow Pass"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.shadowpass.pass_cache" }
	S.tags = { "f", "shadowpass", "analyzer", "render" }
	S.description = "Shadow Pass Frame Analysis: per-pass cost analysis and outlier detection for the Shadow Pass subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.shadowpass.frame_analysis", window = 177, buckets = 17, threshold = 2.90 })
		inst.system = S
		inst.ctx = ctx
