-- ARKHER SYSTEM O.0165 :: Forest Audio Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0165"
	S.key = "arkher.audio.forestaudio.playback_policy"
	S.name = "Forest Audio Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Forest Audio"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.forestaudio.compression_codec" }
	S.tags = { "o", "forestaudio", "policy", "audio" }
	S.description = "Forest Audio Playback Policy: rules choosing what may be heard right now for the Forest Audio subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.forestaudio.playback_policy", algorithm = "lottery", starvationGuard = 35 })
		inst.system = S
		inst.ctx = ctx
