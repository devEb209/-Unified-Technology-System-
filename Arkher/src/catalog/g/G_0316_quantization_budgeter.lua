-- ARKHER SYSTEM G.0316 :: Weight Quantization Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0316"
	S.key = "arkher.neural.quantization.compute_budget"
	S.name = "Weight Quantization Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.quantization.quality_predictor" }
	S.tags = { "g", "quantization", "budgeter", "neural" }
	S.description = "Weight Quantization Compute Budget: inference time budget allocation for the Weight Quantization subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.quantization.compute_budget", total = 415, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
