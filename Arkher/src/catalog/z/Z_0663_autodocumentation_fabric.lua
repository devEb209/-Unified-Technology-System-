-- ARKHER SYSTEM Z.0663 :: Auto Documentation Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0663"
	S.key = "arkher.origin.autodocumentation.simulation_fabric"
	S.name = "Auto Documentation Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.complexity_governance" }
	S.tags = { "z", "autodocumentation", "fabric", "origin" }
	S.description = "Auto Documentation Simulation Fabric: every simulation domain stepped under one budgeted clock for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.autodocumentation.simulation_fabric", budgetMs = 3.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
