-- ARKHER SYSTEM VD.0111 :: Temporal Slice Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0111"
	S.key = "arkher.contsim.temporalslice.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.temporalslice.epoch_clock" }
	S.tags = { "vd", "temporalslice", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.temporalslice.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
