-- ARKHER SYSTEM V.0362 :: Import Preset Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0362"
	S.key = "arkher.asset.importpreset.bundling"
	S.name = "Import Preset Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.importpreset.import" }
	S.tags = { "v", "importpreset", "bundler", "asset" }
	S.description = "Import Preset Bundling: size-bounded packing, manifests and delta patches for the Import Preset subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.importpreset.bundling", maxBundleBytes = 524288 })
		inst.system = S
		inst.ctx = ctx
