-- ARKHER SYSTEM L.0044 :: Offscreen Simulation Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0044"
	S.key = "arkher.sim.offscreensim.forecast"
	S.name = "Offscreen Simulation Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.offscreensim.analysis" }
	S.tags = { "l", "offscreensim", "predictor", "sim" }
	S.description = "Offscreen Simulation Forecast: prediction of the region's next state for the Offscreen Simulation subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.offscreensim.forecast", method = "linear", alpha = 0.34, window = 72 })
		inst.system = S
		inst.ctx = ctx
