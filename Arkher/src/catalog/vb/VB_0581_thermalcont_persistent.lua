-- ARKHER SYSTEM VB.0581 :: Thermal Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0581"
	S.key = "arkher.conttime.thermalcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.thermalcont.multi-scale_fidelity" }
	S.tags = { "vb", "thermalcont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.thermalcont.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
