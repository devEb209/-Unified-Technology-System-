-- ARKHER SYSTEM J.0162 :: Gesture Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0162"
	S.key = "arkher.character.gesture.variant_registry"
	S.name = "Gesture Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gesture.appearance_composer" }
	S.tags = { "j", "gesture", "registry", "character" }
	S.description = "Gesture Variant Registry: named character variants and their lifecycle for the Gesture subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.gesture.variant_registry" })
		inst.system = S
		inst.ctx = ctx
