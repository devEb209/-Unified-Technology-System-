-- ARKHER SYSTEM VA.0482 :: Lighting Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0482"
	S.key = "arkher.contworld.lightcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lightcont.infinite_grid" }
	S.tags = { "va", "lightcont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.lightcont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
