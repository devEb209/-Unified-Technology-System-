-- ARKHER SYSTEM N.0461 :: Camera Shake Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0461"
	S.key = "arkher.vfx.camerashake.effect_graph"
	S.name = "Camera Shake Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Camera Shake"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.camerashake.curve_authoring" }
	S.tags = { "n", "camerashake", "shadegraph", "vfx" }
	S.description = "Camera Shake Effect Graph: node graph describing how the effect is shaded for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.camerashake.effect_graph" })
		inst.system = S
		inst.ctx = ctx
