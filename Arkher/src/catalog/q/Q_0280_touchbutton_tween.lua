-- ARKHER SYSTEM Q.0280 :: Touch Button Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0280"
	S.key = "arkher.ui.touchbutton.transition"
	S.name = "Touch Button Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Touch Button"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.touchbutton.input_mapping" }
	S.tags = { "q", "touchbutton", "tween", "ui" }
	S.description = "Touch Button Transition: eased, delayed, looped and sequenced motion for the Touch Button subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.touchbutton.transition", timeScale = 0.99 })
		inst.system = S
		inst.ctx = ctx
