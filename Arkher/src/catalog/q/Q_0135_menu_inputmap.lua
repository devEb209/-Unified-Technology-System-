-- ARKHER SYSTEM Q.0135 :: Menu Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0135"
	S.key = "arkher.ui.menu.input_mapping"
	S.name = "Menu Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Menu"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.menu.widget_tree" }
	S.tags = { "q", "menu", "inputmap", "ui" }
	S.description = "Menu Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Menu subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.menu.input_mapping", device = "touch", holdTime = 0.33, deadzone = 0.13 })
		inst.system = S
		inst.ctx = ctx
