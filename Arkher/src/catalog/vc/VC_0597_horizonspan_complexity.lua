-- ARKHER SYSTEM VC.0597 :: Horizon Span Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0597"
	S.key = "arkher.contneural.horizonspan.complexity_budget"
	S.name = "Horizon Span Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.horizonspan.world_memory_stream" }
	S.tags = { "vc", "horizonspan", "complexity", "contneural" }
	S.description = "Horizon Span Complexity Budget: complexity budgeting for the continuum for the Horizon Span subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.horizonspan.complexity_budget", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
