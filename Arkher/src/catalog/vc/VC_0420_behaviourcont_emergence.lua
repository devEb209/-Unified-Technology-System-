-- ARKHER SYSTEM VC.0420 :: Behaviour Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0420"
	S.key = "arkher.contneural.behaviourcont.emergence_continuum"
	S.name = "Behaviour Continuum Emergence Continuum"
	S.category = "VC"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.behaviourcont.reality_continuum" }
	S.tags = { "vc", "behaviourcont", "emergence", "contneural" }
	S.description = "Behaviour Continuum Emergence Continuum: emergence detection over the continuum for the Behaviour Continuum subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.behaviourcont.emergence_continuum", windowSize = 5, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
