-- ARKHER SYSTEM Z.1038 :: Autonomous Balancing Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.1038"
	S.key = "arkher.origin.autobalancing.budget_governor"
	S.name = "Autonomous Balancing Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autobalancing.behaviour_analysis" }
	S.tags = { "z", "autobalancing", "budgeter", "origin" }
	S.description = "Autonomous Balancing Budget Governor: allocation of a scarce resource across the technology's consumers for the Autonomous Balancing subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.autobalancing.budget_governor", total = 82, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
