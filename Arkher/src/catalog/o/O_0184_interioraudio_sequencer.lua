-- ARKHER SYSTEM O.0184 :: Interior Audio Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0184"
	S.key = "arkher.audio.interioraudio.music_sequencer"
	S.name = "Interior Audio Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.interioraudio.spatialization" }
	S.tags = { "o", "interioraudio", "sequencer", "audio" }
	S.description = "Interior Audio Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Interior Audio subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.interioraudio.music_sequencer", bpm = 120, beatsPerBar = 4, intensity = 0.49 })
		inst.system = S
		inst.ctx = ctx
