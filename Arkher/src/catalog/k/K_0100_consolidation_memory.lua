-- ARKHER SYSTEM K.0100 :: Memory Consolidation Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0100"
	S.key = "arkher.npc.consolidation.memory"
	S.name = "Memory Consolidation Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.consolidation.mind_network" }
	S.tags = { "k", "consolidation", "memory", "npc" }
	S.description = "Memory Consolidation Memory: episodic memory with decay, recall and consolidation for the Memory Consolidation subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.consolidation.memory", capacity = 37, decayRate = 0.025, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
