-- ARKHER SYSTEM N.0140 :: Waterfall Mist Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0140"
	S.key = "arkher.vfx.mist.quality_policy"
	S.name = "Waterfall Mist Quality Policy"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.mist.result_cache" }
	S.tags = { "n", "mist", "policy", "vfx" }
	S.description = "Waterfall Mist Quality Policy: distance and device driven fidelity bands for the Waterfall Mist subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.mist.quality_policy", algorithm = "lottery", starvationGuard = 19 })
		inst.system = S
		inst.ctx = ctx
