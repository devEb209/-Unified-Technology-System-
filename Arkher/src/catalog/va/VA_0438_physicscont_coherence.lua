-- ARKHER SYSTEM VA.0438 :: Physics Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0438"
	S.key = "arkher.contworld.physicscont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.physicscont.persistent_state" }
	S.tags = { "va", "physicscont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.physicscont.coherence_guard", window = 70, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
