-- ARKHER SYSTEM VB.0314 :: Ecology Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0314"
	S.key = "arkher.conttime.ecologycont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.ecologycont.infinite_grid" }
	S.tags = { "vb", "ecologycont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.ecologycont.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
