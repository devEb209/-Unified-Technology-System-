-- ARKHER SYSTEM J.0074 :: Teeth Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0074"
	S.key = "arkher.character.teeth.variant_registry"
	S.name = "Teeth Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.teeth.appearance_composer" }
	S.tags = { "j", "teeth", "registry", "character" }
	S.description = "Teeth Variant Registry: named character variants and their lifecycle for the Teeth subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.teeth.variant_registry" })
		inst.system = S
		inst.ctx = ctx
