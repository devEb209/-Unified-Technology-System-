-- ARKHER SYSTEM VA.0019 :: Region Tile Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0019"
	S.key = "arkher.contworld.regiontile.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.regiontile.coherence_guard" }
	S.tags = { "va", "regiontile", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.regiontile.neural_field", dims = 16, hidden = 12, seed = 34169 })
		inst.system = S
		inst.ctx = ctx
