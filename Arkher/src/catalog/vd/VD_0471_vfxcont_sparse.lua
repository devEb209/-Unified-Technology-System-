-- ARKHER SYSTEM VD.0471 :: VFX Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0471"
	S.key = "arkher.contsim.vfxcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vfxcont.epoch_clock" }
	S.tags = { "vd", "vfxcont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.vfxcont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
