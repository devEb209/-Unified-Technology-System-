-- ARKHER SYSTEM G.0032 :: Spatial Reconstruction Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0032"
	S.key = "arkher.neural.spatialrecon.reconstruction"
	S.name = "Spatial Reconstruction Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.spatialrecon.temporal_history" }
	S.tags = { "g", "spatialrecon", "upscaler", "neural" }
	S.description = "Spatial Reconstruction Reconstruction: resolution ladder and image reconstruction for the Spatial Reconstruction subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.spatialrecon.reconstruction", targetMs = 11.10, index = 3, sharpness = 0.26 })
		inst.system = S
		inst.ctx = ctx
