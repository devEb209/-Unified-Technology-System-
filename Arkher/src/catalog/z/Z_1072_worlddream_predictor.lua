-- ARKHER SYSTEM Z.1072 :: World Dream State Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.1072"
	S.key = "arkher.origin.worlddream.predictive_optimization"
	S.name = "World Dream State Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.adaptive_workflow" }
	S.tags = { "z", "worlddream", "predictor", "origin" }
	S.description = "World Dream State Predictive Optimization: forecast-driven optimization before the cost is paid for the World Dream State subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.worlddream.predictive_optimization", method = "linear", alpha = 0.31, window = 45 })
		inst.system = S
		inst.ctx = ctx
