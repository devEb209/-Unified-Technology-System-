-- ARKHER SYSTEM VB.0038 :: Continuum Stream Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0038"
	S.key = "arkher.conttime.continuumstream.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.continuumstream.infinite_grid" }
	S.tags = { "vb", "continuumstream", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.continuumstream.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
