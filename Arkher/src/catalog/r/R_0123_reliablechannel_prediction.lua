-- ARKHER SYSTEM R.0123 :: Reliable Channel Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0123"
	S.key = "arkher.net.reliablechannel.prediction_and_reconciliation"
	S.name = "Reliable Channel Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reliablechannel.time_sync" }
	S.tags = { "r", "reliablechannel", "prediction", "net" }
	S.description = "Reliable Channel Prediction And Reconciliation: client simulation, correction and input replay for the Reliable Channel subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.reliablechannel.prediction_and_reconciliation", errorThreshold = 0.045, smoothing = 11.0, maxInputs = 120 })
		inst.system = S
		inst.ctx = ctx
