-- ARKHER SYSTEM VC.0587 :: Thermal Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0587"
	S.key = "arkher.contneural.thermalcont.reality_continuum"
	S.name = "Thermal Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.thermalcont.simulation_fabric" }
	S.tags = { "vc", "thermalcont", "reality", "contneural" }
	S.description = "Thermal Continuum Reality Continuum: stacked reality layers of the continuum for the Thermal Continuum subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.thermalcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
