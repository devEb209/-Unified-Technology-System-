-- ARKHER SYSTEM K.0267 :: Hearing Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0267"
	S.key = "arkher.npc.hearing.mind_network"
	S.name = "Hearing Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "hearing", "mindnet", "npc" }
	S.description = "Hearing Mind Network: the learned policy that turns perception into a decision for the Hearing subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.hearing.mind_network", inputs = 8, hidden = 8, seed = 59894, learningRate = 0.070, exploration = 0.050 })
		inst.system = S
		inst.ctx = ctx
