-- ARKHER SYSTEM F.0078 :: Cascade Shadows Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0078"
	S.key = "arkher.render.cascades.adaptive_resolution"
	S.name = "Cascade Shadows Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.cascades.temporal_resolve" }
	S.tags = { "f", "cascades", "upscaler", "render" }
	S.description = "Cascade Shadows Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Cascade Shadows subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.cascades.adaptive_resolution", targetMs = 15.10, index = 4, sharpness = 0.56 })
		inst.system = S
		inst.ctx = ctx
