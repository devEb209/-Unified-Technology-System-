-- ARKHER SYSTEM J.0152 :: Posture Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0152"
	S.key = "arkher.character.posture.budget_governor"
	S.name = "Posture Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.posture.variant_registry" }
	S.tags = { "j", "posture", "budgeter", "character" }
	S.description = "Posture Budget Governor: per-character cost allocation in a crowd for the Posture subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.posture.budget_governor", total = 251, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
