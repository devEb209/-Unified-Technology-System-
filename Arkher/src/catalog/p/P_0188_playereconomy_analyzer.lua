-- ARKHER SYSTEM P.0188 :: Economy Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0188"
	S.key = "arkher.play.playereconomy.balance_analysis"
	S.name = "Economy Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Economy"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playereconomy.event_ledger" }
	S.tags = { "p", "playereconomy", "analyzer", "play" }
	S.description = "Economy Balance Analysis: distribution, outlier and pacing analysis for the Economy subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.playereconomy.balance_analysis", window = 63, buckets = 19, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
