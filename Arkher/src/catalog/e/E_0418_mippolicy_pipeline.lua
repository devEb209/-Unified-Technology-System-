-- ARKHER SYSTEM E.0418 :: Mip Policy Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0418"
	S.key = "arkher.material.mippolicy.authoring_pipeline"
	S.name = "Mip Policy Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Mip Policy"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.mippolicy.analysis" }
	S.tags = { "e", "mippolicy", "pipeline", "material" }
	S.description = "Mip Policy Authoring Pipeline: ordered authoring and bake stages for the Mip Policy subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.mippolicy.authoring_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
