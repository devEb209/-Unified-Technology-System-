-- ARKHER SYSTEM H.0024 :: Static Body Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0024"
	S.key = "arkher.physics.staticbody.simulation_policy"
	S.name = "Static Body Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Static Body"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.staticbody.budget_governor" }
	S.tags = { "h", "staticbody", "policy", "physics" }
	S.description = "Static Body Simulation Policy: device tier rules for substeps, iterations and sleep for the Static Body subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.staticbody.simulation_policy", algorithm = "lottery", starvationGuard = 59 })
		inst.system = S
		inst.ctx = ctx
