-- ARKHER SYSTEM P.0196 :: Shop Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0196"
	S.key = "arkher.play.shop.combat_resolution"
	S.name = "Shop Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Shop"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.shop.objectives" }
	S.tags = { "p", "shop", "combat", "play" }
	S.description = "Shop Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Shop subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.shop.combat_resolution", seed = 91163, armourK = 110, critMultiplier = 2.60 })
		inst.system = S
		inst.ctx = ctx
