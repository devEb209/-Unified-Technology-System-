-- ARKHER SYSTEM VA.0623 :: Occupancy Map Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0623"
	S.key = "arkher.contworld.occupancymap.reality_continuum"
	S.name = "Occupancy Map Reality Continuum"
	S.category = "VA"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.occupancymap.simulation_fabric" }
	S.tags = { "va", "occupancymap", "reality", "contworld" }
	S.description = "Occupancy Map Reality Continuum: stacked reality layers of the continuum for the Occupancy Map subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.occupancymap.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
