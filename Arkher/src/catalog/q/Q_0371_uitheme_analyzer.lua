-- ARKHER SYSTEM Q.0371 :: Theme Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0371"
	S.key = "arkher.ui.uitheme.usability_analysis"
	S.name = "Theme Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Theme"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uitheme.frame_budget" }
	S.tags = { "q", "uitheme", "analyzer", "ui" }
	S.description = "Theme Usability Analysis: reachability, latency and abandonment analysis for the Theme subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.uitheme.usability_analysis", window = 210, buckets = 14, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
