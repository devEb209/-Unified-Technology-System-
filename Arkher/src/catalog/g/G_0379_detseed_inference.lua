-- ARKHER SYSTEM G.0379 :: Deterministic Seeding Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0379"
	S.key = "arkher.neural.detseed.inference_core"
	S.name = "Deterministic Seeding Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "detseed", "inference", "neural" }
	S.description = "Deterministic Seeding Inference Core: dense network forward pass and training for the Deterministic Seeding subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.detseed.inference_core", seed = 81471 })
		inst.system = S
		inst.ctx = ctx
