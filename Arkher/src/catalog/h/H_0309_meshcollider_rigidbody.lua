-- ARKHER SYSTEM H.0309 :: Mesh Collider Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0309"
	S.key = "arkher.physics.meshcollider.body_dynamics"
	S.name = "Mesh Collider Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "meshcollider", "rigidbody", "physics" }
	S.description = "Mesh Collider Body Dynamics: integration, impulses, damping and sleeping of a body for the Mesh Collider subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.meshcollider.body_dynamics", mass = 28.00, radius = 0.65, restitution = 0.27, friction = 0.67, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
