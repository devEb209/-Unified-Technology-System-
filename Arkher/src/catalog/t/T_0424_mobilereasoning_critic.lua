-- ARKHER SYSTEM T.0424 :: Mobile Reasoning Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0424"
	S.key = "arkher.ai.mobilereasoning.self_critique"
	S.name = "Mobile Reasoning Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.mobilereasoning.plan_workflow" }
	S.tags = { "t", "mobilereasoning", "critic", "ai" }
	S.description = "Mobile Reasoning Self Critique: weighted evaluation of the result against declared criteria for the Mobile Reasoning subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.mobilereasoning.self_critique", passMark = 0.73, reviseMark = 0.48, seed = 3978 })
		inst.system = S
		inst.ctx = ctx
