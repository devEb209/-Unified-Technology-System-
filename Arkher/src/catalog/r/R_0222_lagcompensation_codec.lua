-- ARKHER SYSTEM R.0222 :: Lag Compensation Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0222"
	S.key = "arkher.net.lagcompensation.serialization_codec"
	S.name = "Lag Compensation Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.lagcompensation.bandwidth_budget" }
	S.tags = { "r", "lagcompensation", "codec", "net" }
	S.description = "Lag Compensation Serialization Codec: compact encoding, diffing and checksum of payloads for the Lag Compensation subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.lagcompensation.serialization_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
