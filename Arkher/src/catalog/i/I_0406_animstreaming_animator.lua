-- ARKHER SYSTEM I.0406 :: Animation Streaming Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0406"
	S.key = "arkher.anim.animstreaming.layered_blending"
	S.name = "Animation Streaming Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstreaming.clip_sampling" }
	S.tags = { "i", "animstreaming", "animator", "anim" }
	S.description = "Animation Streaming Layered Blending: layers, crossfades, masks and blend trees for the Animation Streaming subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.animstreaming.layered_blending", budget = 9 })
		inst.system = S
		inst.ctx = ctx
