-- ARKHER SYSTEM V.0278 :: Impostor Asset Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0278"
	S.key = "arkher.asset.impostorasset.bundling"
	S.name = "Impostor Asset Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.impostorasset.import" }
	S.tags = { "v", "impostorasset", "bundler", "asset" }
	S.description = "Impostor Asset Bundling: size-bounded packing, manifests and delta patches for the Impostor Asset subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.impostorasset.bundling", maxBundleBytes = 393216 })
		inst.system = S
		inst.ctx = ctx
