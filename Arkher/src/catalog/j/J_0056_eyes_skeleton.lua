-- ARKHER SYSTEM J.0056 :: Eyes Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0056"
	S.key = "arkher.character.eyes.rig_definition"
	S.name = "Eyes Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "eyes", "skeleton", "character" }
	S.description = "Eyes Rig Definition: character rig definition and bone budget for the Eyes subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.eyes.rig_definition" })
		inst.system = S
		inst.ctx = ctx
