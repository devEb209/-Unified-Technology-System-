-- ARKHER SYSTEM VC.0511 :: Material Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0511"
	S.key = "arkher.contneural.materialcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.materialcont.coherence_guard" }
	S.tags = { "vc", "materialcont", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.materialcont.neural_field", dims = 20, hidden = 16, seed = 1674 })
		inst.system = S
		inst.ctx = ctx
