-- ARKHER SYSTEM G.0102 :: Adaptive Sharpening Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0102"
	S.key = "arkher.neural.adaptivesharpen.reconstruction"
	S.name = "Adaptive Sharpening Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.adaptivesharpen.temporal_history" }
	S.tags = { "g", "adaptivesharpen", "upscaler", "neural" }
	S.description = "Adaptive Sharpening Reconstruction: resolution ladder and image reconstruction for the Adaptive Sharpening subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.adaptivesharpen.reconstruction", targetMs = 14.10, index = 3, sharpness = 0.41 })
		inst.system = S
		inst.ctx = ctx
