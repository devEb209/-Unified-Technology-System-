-- ARKHER SYSTEM R.0320 :: Data Persistence Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0320"
	S.key = "arkher.net.netpersistence.rate_guard"
	S.name = "Data Persistence Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netpersistence.interest_streaming" }
	S.tags = { "r", "netpersistence", "guard", "net" }
	S.description = "Data Persistence Rate Guard: token-bucket protection against floods and abuse for the Data Persistence subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.netpersistence.rate_guard", algorithm = "token", capacity = 196, refillPerSec = 41, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
