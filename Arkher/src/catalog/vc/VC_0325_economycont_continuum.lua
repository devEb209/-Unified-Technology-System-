-- ARKHER SYSTEM VC.0325 :: Economy Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0325"
	S.key = "arkher.contneural.economycont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "economycont", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.economycont.infinite_grid", cellSize = 160, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
