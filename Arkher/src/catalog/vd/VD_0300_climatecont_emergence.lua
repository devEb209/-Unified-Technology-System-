-- ARKHER SYSTEM VD.0300 :: Climate Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0300"
	S.key = "arkher.contsim.climatecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.climatecont.reality_continuum" }
	S.tags = { "vd", "climatecont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.climatecont.emergence_continuum", windowSize = 6, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
