-- ARKHER SYSTEM F.0422 :: Occlusion Culling View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0422"
	S.key = "arkher.render.occlusion.view_and_culling"
	S.name = "Occlusion Culling View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.occlusion.frame_graph" }
	S.tags = { "f", "occlusion", "camera", "render" }
	S.description = "Occlusion Culling View And Culling: view state, frustum culling and screen-size LOD for the Occlusion Culling subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.occlusion.view_and_culling", width = 1084, height = 720, fov = 1.0200, far = 2000 })
		inst.system = S
		inst.ctx = ctx
