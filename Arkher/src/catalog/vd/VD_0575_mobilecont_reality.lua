-- ARKHER SYSTEM VD.0575 :: Mobile Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0575"
	S.key = "arkher.contsim.mobilecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.mobilecont.simulation_fabric" }
	S.tags = { "vd", "mobilecont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.mobilecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
