-- ARKHER SYSTEM E.0167 :: Clear Coat Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0167"
	S.key = "arkher.material.clearcoat.layer_composition"
	S.name = "Clear Coat Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Clear Coat"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.clearcoat.definition" }
	S.tags = { "e", "clearcoat", "composer", "material" }
	S.description = "Clear Coat Layer Composition: ordered layer composition with blend rules for the Clear Coat subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.clearcoat.layer_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
