-- ARKHER SYSTEM G.0174 :: Shading Approximation Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0174"
	S.key = "arkher.neural.shadingapprox.weight_codec"
	S.name = "Shading Approximation Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.shadingapprox.model_registry" }
	S.tags = { "g", "shadingapprox", "codec", "neural" }
	S.description = "Shading Approximation Weight Codec: weight serialization and quantized transport for the Shading Approximation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.shadingapprox.weight_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
