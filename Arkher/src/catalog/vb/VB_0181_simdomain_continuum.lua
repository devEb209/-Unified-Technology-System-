-- ARKHER SYSTEM VB.0181 :: Simulation Domain Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0181"
	S.key = "arkher.conttime.simdomain.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "simdomain", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.simdomain.infinite_grid", cellSize = 192, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
