-- ARKHER SYSTEM F.0372 :: Render Scale Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0372"
	S.key = "arkher.render.renderscale.adaptive_resolution"
	S.name = "Render Scale Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Render Scale"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.renderscale.temporal_resolve" }
	S.tags = { "f", "renderscale", "upscaler", "render" }
	S.description = "Render Scale Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Render Scale subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.renderscale.adaptive_resolution", targetMs = 16.10, index = 5, sharpness = 0.33 })
		inst.system = S
		inst.ctx = ctx
