-- ARKHER SYSTEM N.0503 :: Environment Ambience Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0503"
	S.key = "arkher.vfx.envambience.result_cache"
	S.name = "Environment Ambience Result Cache"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.envambience.spawn_budget" }
	S.tags = { "n", "envambience", "cache", "vfx" }
	S.description = "Environment Ambience Result Cache: reuse of expensive effect evaluations for the Environment Ambience subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.envambience.result_cache", policy = "ttl", capacity = 147, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
