-- ARKHER SYSTEM H.0512 :: Motorized Joint Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0512"
	S.key = "arkher.physics.motorjoint.broadphase_index"
	S.name = "Motorized Joint Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.motorjoint.vehicle" }
	S.tags = { "h", "motorjoint", "index", "physics" }
	S.description = "Motorized Joint Broadphase Index: spatial acceleration of candidate pair finding for the Motorized Joint subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.motorjoint.broadphase_index", mode = "hash", cellSize = 16 })
		inst.system = S
		inst.ctx = ctx
