-- ARKHER SYSTEM VB.0509 :: Material Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0509"
	S.key = "arkher.conttime.materialcont.persistent_state"
	S.name = "Material Continuum Persistent State"
	S.category = "VB"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.materialcont.multi-scale_fidelity" }
	S.tags = { "vb", "materialcont", "persistent", "conttime" }
	S.description = "Material Continuum Persistent State: epoch-stamped persistent history and rollback for the Material Continuum subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.materialcont.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
