-- ARKHER SYSTEM VD.0258 :: Road Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0258"
	S.key = "arkher.contsim.roadcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.roadcont.persistent_state" }
	S.tags = { "vd", "roadcont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.roadcont.coherence_guard", window = 77, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
