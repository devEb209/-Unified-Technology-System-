-- ARKHER SYSTEM VC.0558 :: Device Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0558"
	S.key = "arkher.contneural.devicecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.devicecont.persistent_state" }
	S.tags = { "vc", "devicecont", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.devicecont.coherence_guard", window = 48, threshold = 0.14 })
		inst.system = S
		inst.ctx = ctx
