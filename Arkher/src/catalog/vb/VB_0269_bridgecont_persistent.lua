-- ARKHER SYSTEM VB.0269 :: Bridge Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0269"
	S.key = "arkher.conttime.bridgecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.bridgecont.multi-scale_fidelity" }
	S.tags = { "vb", "bridgecont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.bridgecont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
