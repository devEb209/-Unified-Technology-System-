-- ARKHER SYSTEM VB.0500 :: Rendering Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0500"
	S.key = "arkher.conttime.rendercont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.rendercont.neural_field" }
	S.tags = { "vb", "rendercont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.rendercont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
