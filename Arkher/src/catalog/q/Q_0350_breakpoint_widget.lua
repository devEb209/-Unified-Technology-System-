-- ARKHER SYSTEM Q.0350 :: Responsive Breakpoint Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0350"
	S.key = "arkher.ui.breakpoint.widget_tree"
	S.name = "Responsive Breakpoint Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.breakpoint.responsive_layout" }
	S.tags = { "q", "breakpoint", "widget", "ui" }
	S.description = "Responsive Breakpoint Widget Tree: retained widget nodes, properties, bindings and rendering for the Responsive Breakpoint subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.breakpoint.widget_tree", theme = "light", scale = 1.17 })
		inst.system = S
		inst.ctx = ctx
