-- ARKHER SYSTEM F.0164 :: Volumetric Light Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0164"
	S.key = "arkher.render.volumetric.render_policy"
	S.name = "Volumetric Light Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.volumetric.draw_budget" }
	S.tags = { "f", "volumetric", "policy", "render" }
	S.description = "Volumetric Light Render Policy: device tier rules for the frame for the Volumetric Light subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.volumetric.render_policy", algorithm = "lottery", starvationGuard = 43 })
		inst.system = S
		inst.ctx = ctx
