-- ARKHER SYSTEM Z.0976 :: Generation Migration Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0976"
	S.key = "arkher.origin.generationmigration.governance_policy"
	S.name = "Generation Migration Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.signal_composition" }
	S.tags = { "z", "generationmigration", "policy", "origin" }
	S.description = "Generation Migration Governance Policy: ordered rules governing when the technology may act for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.generationmigration.governance_policy", algorithm = "wfq", starvationGuard = 62 })
		inst.system = S
		inst.ctx = ctx
