-- ARKHER SYSTEM N.0236 :: Spell Cast Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0236"
	S.key = "arkher.vfx.spellcast.particle_simulation"
	S.name = "Spell Cast Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spell Cast"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spellcast.emission" }
	S.tags = { "n", "spellcast", "particles", "vfx" }
	S.description = "Spell Cast Particle Simulation: pooled integration of position, velocity, colour and life for the Spell Cast subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.spellcast.particle_simulation", capacity = 192, drag = 0.22, bounce = 0.07, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
