-- ARKHER SYSTEM T.0066 :: World Knowledge Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0066"
	S.key = "arkher.ai.worldknowledge.utility_selection"
	S.name = "World Knowledge Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.worldknowledge.working_memory" }
	S.tags = { "t", "worldknowledge", "utility", "ai" }
	S.description = "World Knowledge Utility Selection: scored choice between competing courses of action for the World Knowledge subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.worldknowledge.utility_selection", momentum = 0.13 })
		inst.system = S
		inst.ctx = ctx
