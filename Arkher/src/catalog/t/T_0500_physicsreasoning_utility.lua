-- ARKHER SYSTEM T.0500 :: Physics Reasoning Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0500"
	S.key = "arkher.ai.physicsreasoning.utility_selection"
	S.name = "Physics Reasoning Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.physicsreasoning.working_memory" }
	S.tags = { "t", "physicsreasoning", "utility", "ai" }
	S.description = "Physics Reasoning Utility Selection: scored choice between competing courses of action for the Physics Reasoning subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.physicsreasoning.utility_selection", momentum = 0.03 })
		inst.system = S
		inst.ctx = ctx
