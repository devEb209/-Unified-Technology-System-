-- ARKHER SYSTEM T.0109 :: Context Memory Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0109"
	S.key = "arkher.ai.contextmemory.action_planner"
	S.name = "Context Memory Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.contextmemory.utility_selection" }
	S.tags = { "t", "contextmemory", "planner", "ai" }
	S.description = "Context Memory Action Planner: goal-oriented action planning over preconditions for the Context Memory subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.contextmemory.action_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
