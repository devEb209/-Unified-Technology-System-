-- ARKHER SYSTEM VD.0497 :: Rendering Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0497"
	S.key = "arkher.contsim.rendercont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.rendercont.multi-scale_fidelity" }
	S.tags = { "vd", "rendercont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.rendercont.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
