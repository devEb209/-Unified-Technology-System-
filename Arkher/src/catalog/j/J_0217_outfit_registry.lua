-- ARKHER SYSTEM J.0217 :: Outfit Composition Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0217"
	S.key = "arkher.character.outfit.variant_registry"
	S.name = "Outfit Composition Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.outfit.appearance_composer" }
	S.tags = { "j", "outfit", "registry", "character" }
	S.description = "Outfit Composition Variant Registry: named character variants and their lifecycle for the Outfit Composition subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.outfit.variant_registry" })
		inst.system = S
		inst.ctx = ctx
