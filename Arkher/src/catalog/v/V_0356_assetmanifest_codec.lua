-- ARKHER SYSTEM V.0356 :: Manifest Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0356"
	S.key = "arkher.asset.assetmanifest.compression_codec"
	S.name = "Manifest Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetmanifest.streaming_residency" }
	S.tags = { "v", "assetmanifest", "codec", "asset" }
	S.description = "Manifest Compression Codec: compact encoding, diffing and checksum of asset payloads for the Manifest subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.assetmanifest.compression_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
