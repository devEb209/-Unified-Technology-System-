-- ARKHER SYSTEM T.0320 :: Optimization Advisor Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0320"
	S.key = "arkher.ai.optimizationadvisor.model_inference"
	S.name = "Optimization Advisor Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.optimizationadvisor.action_planner" }
	S.tags = { "t", "optimizationadvisor", "inference", "ai" }
	S.description = "Optimization Advisor Model Inference: quantized inference with batching and budget for the Optimization Advisor subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.optimizationadvisor.model_inference", seed = 6125 })
		inst.system = S
		inst.ctx = ctx
