-- ARKHER SYSTEM O.0045 :: Impact Sound Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0045"
	S.key = "arkher.audio.impactsound.playback_policy"
	S.name = "Impact Sound Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Impact Sound"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.impactsound.compression_codec" }
	S.tags = { "o", "impactsound", "policy", "audio" }
	S.description = "Impact Sound Playback Policy: rules choosing what may be heard right now for the Impact Sound subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.impactsound.playback_policy", algorithm = "edf", starvationGuard = 57 })
		inst.system = S
		inst.ctx = ctx
