-- ARKHER SYSTEM Q.0399 :: UI Debug Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0399"
	S.key = "arkher.ui.uidebug.input_mapping"
	S.name = "UI Debug Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "UI Debug"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uidebug.widget_tree" }
	S.tags = { "q", "uidebug", "inputmap", "ui" }
	S.description = "UI Debug Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the UI Debug subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.uidebug.input_mapping", device = "keyboard", holdTime = 0.42, deadzone = 0.12 })
		inst.system = S
		inst.ctx = ctx
