-- ARKHER SYSTEM T.0276 :: Level Design Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0276"
	S.key = "arkher.ai.leveldesign.utility_selection"
	S.name = "Level Design Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.leveldesign.working_memory" }
	S.tags = { "t", "leveldesign", "utility", "ai" }
	S.description = "Level Design Utility Selection: scored choice between competing courses of action for the Level Design subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.leveldesign.utility_selection", momentum = 0.11 })
		inst.system = S
		inst.ctx = ctx
