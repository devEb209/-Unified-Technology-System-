-- ARKHER SYSTEM H.0439 :: Penetration Recovery Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0439"
	S.key = "arkher.physics.penetration.query"
	S.name = "Penetration Recovery Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.penetration.constraint_solver" }
	S.tags = { "h", "penetration", "raycaster", "physics" }
	S.description = "Penetration Recovery Query: rays, sweeps and overlaps against the simulation for the Penetration Recovery subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.penetration.query", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
