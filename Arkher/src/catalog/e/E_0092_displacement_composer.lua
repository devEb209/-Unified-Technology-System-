-- ARKHER SYSTEM E.0092 :: Height Displacement Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0092"
	S.key = "arkher.material.displacement.layer_composition"
	S.name = "Height Displacement Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.displacement.definition" }
	S.tags = { "e", "displacement", "composer", "material" }
	S.description = "Height Displacement Layer Composition: ordered layer composition with blend rules for the Height Displacement subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.displacement.layer_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
