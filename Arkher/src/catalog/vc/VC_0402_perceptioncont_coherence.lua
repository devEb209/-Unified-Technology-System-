-- ARKHER SYSTEM VC.0402 :: Perception Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0402"
	S.key = "arkher.contneural.perceptioncont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.perceptioncont.persistent_state" }
	S.tags = { "vc", "perceptioncont", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.perceptioncont.coherence_guard", window = 51, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
