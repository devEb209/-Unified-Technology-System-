-- ARKHER SYSTEM Z.0145 :: Autonomous Development Pipeline World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0145"
	S.key = "arkher.origin.autodevpipeline.world_memory"
	S.name = "Autonomous Development Pipeline World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodevpipeline.autonomous_pipeline" }
	S.tags = { "z", "autodevpipeline", "worldmemory", "origin" }
	S.description = "Autonomous Development Pipeline World Memory: epoch-stamped persistent history with compaction and checkpoints for the Autonomous Development Pipeline subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.autodevpipeline.world_memory", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
