-- ARKHER SYSTEM W.0254 :: Match Cut Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0254"
	S.key = "arkher.cine.matchcut.camera_rig"
	S.name = "Match Cut Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Match Cut"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.matchcut.sequence_timeline" }
	S.tags = { "w", "matchcut", "camerarig", "cine" }
	S.description = "Match Cut Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Match Cut subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.matchcut.camera_rig", fov = 1.31, focus = 15.0, aperture = 3.9, smoothing = 11.0, distance = 17, height = 7 })
		inst.system = S
		inst.ctx = ctx
