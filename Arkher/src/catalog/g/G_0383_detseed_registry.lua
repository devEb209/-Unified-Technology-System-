-- ARKHER SYSTEM G.0383 :: Deterministic Seeding Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0383"
	S.key = "arkher.neural.detseed.model_registry"
	S.name = "Deterministic Seeding Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detseed.reconstruction" }
	S.tags = { "g", "detseed", "registry", "neural" }
	S.description = "Deterministic Seeding Model Registry: named models and their lifecycle for the Deterministic Seeding subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.detseed.model_registry" })
		inst.system = S
		inst.ctx = ctx
