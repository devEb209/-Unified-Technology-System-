-- ARKHER SYSTEM N.0062 :: Dust Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0062"
	S.key = "arkher.vfx.dust.quality_policy"
	S.name = "Dust Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Dust"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.dust.result_cache" }
	S.tags = { "n", "dust", "policy", "vfx" }
	S.description = "Dust Quality Policy: distance and device driven fidelity bands for the Dust subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.dust.quality_policy", algorithm = "wfq", starvationGuard = 50 })
		inst.system = S
		inst.ctx = ctx
