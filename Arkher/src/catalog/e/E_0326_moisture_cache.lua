-- ARKHER SYSTEM E.0326 :: Moisture Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0326"
	S.key = "arkher.material.moisture.instance_cache"
	S.name = "Moisture Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Moisture"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.moisture.quality_policy" }
	S.tags = { "e", "moisture", "cache", "material" }
	S.description = "Moisture Instance Cache: resolved-parameter cache keyed by context for the Moisture subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.moisture.instance_cache", policy = "lfu", capacity = 351, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
