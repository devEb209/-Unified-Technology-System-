--!strict
-- SpeedTree Atlas — ANIMATION Stack #0245
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="SpeedTree Atlas — ANIMATION Stack #0245", size=Vector2.new(680, 420), pos=UDim2.fromOffset(485, 85), parent=parent, icon="◆"})
