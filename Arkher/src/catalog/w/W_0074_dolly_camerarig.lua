-- ARKHER SYSTEM W.0074 :: Dolly Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0074"
	S.key = "arkher.cine.dolly.camera_rig"
	S.name = "Dolly Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dolly"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dolly.sequence_timeline" }
	S.tags = { "w", "dolly", "camerarig", "cine" }
	S.description = "Dolly Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Dolly subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.dolly.camera_rig", fov = 0.99, focus = 9.0, aperture = 5.9, smoothing = 7.0, distance = 11, height = 5 })
		inst.system = S
		inst.ctx = ctx
