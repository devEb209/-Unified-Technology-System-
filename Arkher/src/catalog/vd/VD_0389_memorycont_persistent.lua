-- ARKHER SYSTEM VD.0389 :: Memory Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0389"
	S.key = "arkher.contsim.memorycont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memorycont.multi-scale_fidelity" }
	S.tags = { "vd", "memorycont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.memorycont.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
