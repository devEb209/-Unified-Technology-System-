-- ARKHER SYSTEM L.0598 :: World Persistence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0598"
	S.key = "arkher.sim.worldpersistence.analysis"
	S.name = "World Persistence Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldpersistence.aggregate_cache" }
	S.tags = { "l", "worldpersistence", "analyzer", "sim" }
	S.description = "World Persistence Analysis: trend, anomaly and stability analysis of the world for the World Persistence subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.worldpersistence.analysis", window = 50, buckets = 10, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
