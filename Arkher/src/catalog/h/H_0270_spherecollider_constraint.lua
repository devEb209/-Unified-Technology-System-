-- ARKHER SYSTEM H.0270 :: Sphere Collider Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0270"
	S.key = "arkher.physics.spherecollider.constraint_solver"
	S.name = "Sphere Collider Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.spherecollider.contact_generation" }
	S.tags = { "h", "spherecollider", "constraint", "physics" }
	S.description = "Sphere Collider Constraint Solver: sequential impulses, friction, joints and warm starting for the Sphere Collider subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.spherecollider.constraint_solver", iterations = 12, baumgarte = 0.28, warmStart = true })
		inst.system = S
		inst.ctx = ctx
