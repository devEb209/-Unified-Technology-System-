-- ARKHER SYSTEM R.0162 :: Snapshot Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0162"
	S.key = "arkher.net.snapshot.serialization_codec"
	S.name = "Snapshot Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Snapshot"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.snapshot.bandwidth_budget" }
	S.tags = { "r", "snapshot", "codec", "net" }
	S.description = "Snapshot Serialization Codec: compact encoding, diffing and checksum of payloads for the Snapshot subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.snapshot.serialization_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
