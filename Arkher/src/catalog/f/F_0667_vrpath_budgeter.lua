-- ARKHER SYSTEM F.0667 :: VR Stereo Path Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0667"
	S.key = "arkher.render.vrpath.draw_budget"
	S.name = "VR Stereo Path Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.vrpath.adaptive_resolution" }
	S.tags = { "f", "vrpath", "budgeter", "render" }
	S.description = "VR Stereo Path Draw Budget: draw call and triangle budget allocation for the VR Stereo Path subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.vrpath.draw_budget", total = 98, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
