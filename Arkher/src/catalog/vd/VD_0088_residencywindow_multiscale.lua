-- ARKHER SYSTEM VD.0088 :: Residency Window Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0088"
	S.key = "arkher.contsim.residencywindow.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.residencywindow.sparse_residency" }
	S.tags = { "vd", "residencywindow", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.residencywindow.multi-scale_fidelity", levels = 6, baseTriangles = 150000 })
		inst.system = S
		inst.ctx = ctx
