-- ARKHER SYSTEM F.0169 :: Atmosphere Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0169"
	S.key = "arkher.render.atmosphere.frame_graph"
	S.name = "Atmosphere Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Atmosphere"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "atmosphere", "framegraph", "render" }
	S.description = "Atmosphere Frame Graph: declared passes, culling, ordering and aliasing for the Atmosphere subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.atmosphere.frame_graph", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
