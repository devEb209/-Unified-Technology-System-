-- ARKHER SYSTEM Q.0157 :: Navigation Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0157"
	S.key = "arkher.ui.navigation.responsive_layout"
	S.name = "Navigation Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Navigation"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "navigation", "flex", "ui" }
	S.description = "Navigation Responsive Layout: flex solving with safe areas, weights and breakpoints for the Navigation subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.navigation.responsive_layout", width = 570, height = 904, scale = 1.01 })
		inst.system = S
		inst.ctx = ctx
