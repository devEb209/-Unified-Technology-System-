-- ARKHER SYSTEM W.0062 :: Tracking Shot Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0062"
	S.key = "arkher.cine.tracking.camera_rig"
	S.name = "Tracking Shot Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.tracking.sequence_timeline" }
	S.tags = { "w", "tracking", "camerarig", "cine" }
	S.description = "Tracking Shot Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Tracking Shot subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.tracking.camera_rig", fov = 1.45, focus = 19.0, aperture = 4.9, smoothing = 13.0, distance = 21, height = 3 })
		inst.system = S
		inst.ctx = ctx
