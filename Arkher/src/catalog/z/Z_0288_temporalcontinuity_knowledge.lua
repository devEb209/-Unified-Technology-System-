-- ARKHER SYSTEM Z.0288 :: Temporal Continuity Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0288"
	S.key = "arkher.origin.temporalcontinuity.semantic_graph"
	S.name = "Temporal Continuity Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.temporalcontinuity.world_architect" }
	S.tags = { "z", "temporalcontinuity", "knowledge", "origin" }
	S.description = "Temporal Continuity Semantic Graph: typed entities and inferred relations of the technology itself for the Temporal Continuity subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.temporalcontinuity.semantic_graph", dims = 48 })
		inst.system = S
		inst.ctx = ctx
