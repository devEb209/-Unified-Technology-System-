-- ARKHER SYSTEM I.0498 :: Cloth Animation Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0498"
	S.key = "arkher.anim.clothanim.inverse_kinematics"
	S.name = "Cloth Animation Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clothanim.layered_blending" }
	S.tags = { "i", "clothanim", "ik", "anim" }
	S.description = "Cloth Animation Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Cloth Animation subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.clothanim.inverse_kinematics", iterations = 10, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
