-- ARKHER SYSTEM Z.0769 :: Semantic LOD Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0769"
	S.key = "arkher.origin.semanticlod.intent_bridge"
	S.name = "Semantic LOD Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticlod.semantic_graph" }
	S.tags = { "z", "semanticlod", "intent", "origin" }
	S.description = "Semantic LOD Intent Bridge: natural language control surface for the technology for the Semantic LOD subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.semanticlod.intent_bridge", minConfidence = 0.35 })
		inst.system = S
		inst.ctx = ctx
