-- ARKHER SYSTEM L.0487 :: Diplomacy Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0487"
	S.key = "arkher.sim.diplomacy.route_network"
	S.name = "Diplomacy Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.diplomacy.region_graph" }
	S.tags = { "l", "diplomacy", "network", "sim" }
	S.description = "Diplomacy Route Network: roads, rivers and routes between settlements for the Diplomacy subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.diplomacy.route_network" })
		inst.system = S
		inst.ctx = ctx
