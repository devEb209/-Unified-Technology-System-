-- ARKHER SYSTEM F.0343 :: Antialiasing Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0343"
	S.key = "arkher.render.antialiasing.temporal_resolve"
	S.name = "Antialiasing Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Antialiasing"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.antialiasing.probe_volume" }
	S.tags = { "f", "antialiasing", "temporal", "render" }
	S.description = "Antialiasing Temporal Resolve: history reprojection with neighbourhood clamping for the Antialiasing subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.antialiasing.temporal_resolve", feedback = 0.90, phase = 8 })
		inst.system = S
		inst.ctx = ctx
