-- ARKHER SYSTEM P.0142 :: Rarity Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0142"
	S.key = "arkher.play.rarity.content_registry"
	S.name = "Rarity Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Rarity"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.rarity.difficulty_controller" }
	S.tags = { "p", "rarity", "registry", "play" }
	S.description = "Rarity Content Registry: catalogue of the definitions this loop instantiates for the Rarity subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.rarity.content_registry" })
		inst.system = S
		inst.ctx = ctx
