-- ARKHER SYSTEM H.0011 :: Rigid Body Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0011"
	S.key = "arkher.physics.rigidbody.result_cache"
	S.name = "Rigid Body Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Rigid Body"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rigidbody.simulation_policy" }
	S.tags = { "h", "rigidbody", "cache", "physics" }
	S.description = "Rigid Body Result Cache: reuse of expensive simulation and query results for the Rigid Body subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.rigidbody.result_cache", policy = "ttl", capacity = 72, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
