-- ARKHER SYSTEM Z.0432 :: Offline World Progression Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0432"
	S.key = "arkher.origin.offlineprogression.predictive_optimization"
	S.name = "Offline World Progression Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.adaptive_workflow" }
	S.tags = { "z", "offlineprogression", "predictor", "origin" }
	S.description = "Offline World Progression Predictive Optimization: forecast-driven optimization before the cost is paid for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.offlineprogression.predictive_optimization", method = "linear", alpha = 0.49, window = 63 })
		inst.system = S
		inst.ctx = ctx
