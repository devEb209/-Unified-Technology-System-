-- ARKHER SYSTEM H.0530 :: Breakable Joint Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0530"
	S.key = "arkher.physics.breakjoint.analysis"
	S.name = "Breakable Joint Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.breakjoint.result_cache" }
	S.tags = { "h", "breakjoint", "analyzer", "physics" }
	S.description = "Breakable Joint Analysis: energy, jitter and cost analysis of the simulation for the Breakable Joint subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.breakjoint.analysis", window = 230, buckets = 14, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
