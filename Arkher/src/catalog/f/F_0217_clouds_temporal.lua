-- ARKHER SYSTEM F.0217 :: Cloud Rendering Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0217"
	S.key = "arkher.render.clouds.temporal_resolve"
	S.name = "Cloud Rendering Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.clouds.probe_volume" }
	S.tags = { "f", "clouds", "temporal", "render" }
	S.description = "Cloud Rendering Temporal Resolve: history reprojection with neighbourhood clamping for the Cloud Rendering subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.clouds.temporal_resolve", feedback = 0.84, phase = 8 })
		inst.system = S
		inst.ctx = ctx
