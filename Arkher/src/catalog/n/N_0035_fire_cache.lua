-- ARKHER SYSTEM N.0035 :: Fire Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0035"
	S.key = "arkher.vfx.fire.result_cache"
	S.name = "Fire Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fire"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fire.spawn_budget" }
	S.tags = { "n", "fire", "cache", "vfx" }
	S.description = "Fire Result Cache: reuse of expensive effect evaluations for the Fire subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.fire.result_cache", policy = "lru", capacity = 193, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
