-- ARKHER SYSTEM G.0227 :: Animation Compression Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0227"
	S.key = "arkher.neural.animcompress.temporal_history"
	S.name = "Animation Compression Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.animcompress.feature_extraction" }
	S.tags = { "g", "animcompress", "temporal", "neural" }
	S.description = "Animation Compression Temporal History: history buffers reused across frames for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.animcompress.temporal_history", feedback = 0.92, phase = 8 })
		inst.system = S
		inst.ctx = ctx
