-- ARKHER SYSTEM F.0645 :: Mobile Fast Path Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0645"
	S.key = "arkher.render.mobilepath.frame_graph"
	S.name = "Mobile Fast Path Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "mobilepath", "framegraph", "render" }
	S.description = "Mobile Fast Path Frame Graph: declared passes, culling, ordering and aliasing for the Mobile Fast Path subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.mobilepath.frame_graph", budgetMs = 10.00 })
		inst.system = S
		inst.ctx = ctx
