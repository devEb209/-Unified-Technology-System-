-- ARKHER SYSTEM Q.0193 :: Minimap Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0193"
	S.key = "arkher.ui.minimap.responsive_layout"
	S.name = "Minimap Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Minimap"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "minimap", "flex", "ui" }
	S.description = "Minimap Responsive Layout: flex solving with safe areas, weights and breakpoints for the Minimap subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.minimap.responsive_layout", width = 390, height = 904, scale = 1.01 })
		inst.system = S
		inst.ctx = ctx
