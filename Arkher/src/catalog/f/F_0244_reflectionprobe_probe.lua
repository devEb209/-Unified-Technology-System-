-- ARKHER SYSTEM F.0244 :: Reflection Probe Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0244"
	S.key = "arkher.render.reflectionprobe.probe_volume"
	S.name = "Reflection Probe Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.reflectionprobe.lighting_rig" }
	S.tags = { "f", "reflectionprobe", "probe", "render" }
	S.description = "Reflection Probe Probe Volume: irradiance probes encoded in spherical harmonics for the Reflection Probe subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.reflectionprobe.probe_volume", spacing = 8 })
		inst.system = S
		inst.ctx = ctx
