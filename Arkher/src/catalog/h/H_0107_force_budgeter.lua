-- ARKHER SYSTEM H.0107 :: Force Accumulator Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0107"
	S.key = "arkher.physics.force.budget_governor"
	S.name = "Force Accumulator Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.force.broadphase_index" }
	S.tags = { "h", "force", "budgeter", "physics" }
	S.description = "Force Accumulator Budget Governor: simulation time budget allocation across islands for the Force Accumulator subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.force.budget_governor", total = 394, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
