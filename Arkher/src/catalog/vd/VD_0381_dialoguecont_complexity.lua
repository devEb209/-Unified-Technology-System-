-- ARKHER SYSTEM VD.0381 :: Dialogue Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0381"
	S.key = "arkher.contsim.dialoguecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.dialoguecont.world_memory_stream" }
	S.tags = { "vd", "dialoguecont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.dialoguecont.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
