-- ARKHER SYSTEM Z.0096 :: Semantic World Graph Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0096"
	S.key = "arkher.origin.semanticworld.governance_policy"
	S.name = "Semantic World Graph Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticworld.signal_composition" }
	S.tags = { "z", "semanticworld", "policy", "origin" }
	S.description = "Semantic World Graph Governance Policy: ordered rules governing when the technology may act for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.semanticworld.governance_policy", algorithm = "wfq", starvationGuard = 62 })
		inst.system = S
		inst.ctx = ctx
