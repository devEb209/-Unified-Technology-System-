-- ARKHER SYSTEM VA.0005 :: World Grid Cell Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0005"
	S.key = "arkher.contworld.worldcell.persistent_state"
	S.name = "World Grid Cell Persistent State"
	S.category = "VA"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldcell.multi-scale_fidelity" }
	S.tags = { "va", "worldcell", "persistent", "contworld" }
	S.description = "World Grid Cell Persistent State: epoch-stamped persistent history and rollback for the World Grid Cell subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.worldcell.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
