-- ARKHER SYSTEM J.0103 :: Lip Sync Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0103"
	S.key = "arkher.character.lipsync.look_and_reach"
	S.name = "Lip Sync Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.lipsync.blend_controller" }
	S.tags = { "j", "lipsync", "ik", "character" }
	S.description = "Lip Sync Look And Reach: look-at, reach and foot placement for the character for the Lip Sync subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.lipsync.look_and_reach", iterations = 11, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
