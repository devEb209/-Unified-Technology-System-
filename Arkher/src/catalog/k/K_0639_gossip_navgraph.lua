-- ARKHER SYSTEM K.0639 :: Gossip Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0639"
	S.key = "arkher.npc.gossip.navigation"
	S.name = "Gossip Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.gossip.goal_planner" }
	S.tags = { "k", "gossip", "navgraph", "npc" }
	S.description = "Gossip Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Gossip subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.gossip.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
