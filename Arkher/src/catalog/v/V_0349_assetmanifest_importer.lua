-- ARKHER SYSTEM V.0349 :: Manifest Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0349"
	S.key = "arkher.asset.assetmanifest.import"
	S.name = "Manifest Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "assetmanifest", "importer", "asset" }
	S.description = "Manifest Import: validation, normalization, hashing and deduplication of incoming content for the Manifest subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.assetmanifest.import", unitScale = 1.50 })
		inst.system = S
		inst.ctx = ctx
