-- ARKHER SYSTEM I.0376 :: Retargeting Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0376"
	S.key = "arkher.anim.retargeting.analysis"
	S.name = "Retargeting Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Retargeting"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.retargeting.quality_policy" }
	S.tags = { "i", "retargeting", "analyzer", "anim" }
	S.description = "Retargeting Analysis: pop, drift and cost analysis of playback for the Retargeting subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.retargeting.analysis", window = 195, buckets = 11, threshold = 4.70 })
		inst.system = S
		inst.ctx = ctx
