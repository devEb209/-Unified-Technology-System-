-- ARKHER SYSTEM P.0020 :: Attribute Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0020"
	S.key = "arkher.play.attribute.balance_analysis"
	S.name = "Attribute Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Attribute"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.attribute.event_ledger" }
	S.tags = { "p", "attribute", "analyzer", "play" }
	S.description = "Attribute Balance Analysis: distribution, outlier and pacing analysis for the Attribute subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.attribute.balance_analysis", window = 152, buckets = 16, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
