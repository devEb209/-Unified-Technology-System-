-- ARKHER SYSTEM VC.0514 :: Material Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0514"
	S.key = "arkher.contneural.materialcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.materialcont.complexity_budget" }
	S.tags = { "vc", "materialcont", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.materialcont.simulation_fabric", budgetMs = 3.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
