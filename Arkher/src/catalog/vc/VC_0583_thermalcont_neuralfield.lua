-- ARKHER SYSTEM VC.0583 :: Thermal Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0583"
	S.key = "arkher.contneural.thermalcont.neural_field"
	S.name = "Thermal Continuum Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.thermalcont.coherence_guard" }
	S.tags = { "vc", "thermalcont", "neuralfield", "contneural" }
	S.description = "Thermal Continuum Neural Field: neural field encoding and reconstruction for the Thermal Continuum subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.thermalcont.neural_field", dims = 24, hidden = 20, seed = 89967 })
		inst.system = S
		inst.ctx = ctx
