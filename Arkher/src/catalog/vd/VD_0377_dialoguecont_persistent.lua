-- ARKHER SYSTEM VD.0377 :: Dialogue Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0377"
	S.key = "arkher.contsim.dialoguecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.dialoguecont.multi-scale_fidelity" }
	S.tags = { "vd", "dialoguecont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.dialoguecont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
