-- ARKHER SYSTEM G.0036 :: Spatial Reconstruction Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0036"
	S.key = "arkher.neural.spatialrecon.compute_budget"
	S.name = "Spatial Reconstruction Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.spatialrecon.quality_predictor" }
	S.tags = { "g", "spatialrecon", "budgeter", "neural" }
	S.description = "Spatial Reconstruction Compute Budget: inference time budget allocation for the Spatial Reconstruction subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.spatialrecon.compute_budget", total = 203, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
