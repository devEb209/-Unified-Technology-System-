-- ARKHER SYSTEM K.0276 :: Hearing Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0276"
	S.key = "arkher.npc.hearing.crowd_steering"
	S.name = "Hearing Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hearing.navigation" }
	S.tags = { "k", "hearing", "crowd", "npc" }
	S.description = "Hearing Crowd Steering: local avoidance, cohesion and arrival at scale for the Hearing subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.hearing.crowd_steering", radius = 0.70, maxSpeed = 3.60, cellSize = 6 })
		inst.system = S
		inst.ctx = ctx
