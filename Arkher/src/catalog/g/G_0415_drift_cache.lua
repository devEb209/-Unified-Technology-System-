-- ARKHER SYSTEM G.0415 :: Drift Detection Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0415"
	S.key = "arkher.neural.drift.result_cache"
	S.name = "Drift Detection Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.drift.compute_budget" }
	S.tags = { "g", "drift", "cache", "neural" }
	S.description = "Drift Detection Result Cache: cached inference results keyed by input for the Drift Detection subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.drift.result_cache", policy = "ttl", capacity = 467, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
