-- ARKHER SYSTEM F.0386 :: Sharpening Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0386"
	S.key = "arkher.render.sharpening.adaptive_resolution"
	S.name = "Sharpening Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sharpening"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sharpening.temporal_resolve" }
	S.tags = { "f", "sharpening", "upscaler", "render" }
	S.description = "Sharpening Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Sharpening subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.sharpening.adaptive_resolution", targetMs = 15.10, index = 4, sharpness = 0.28 })
		inst.system = S
		inst.ctx = ctx
