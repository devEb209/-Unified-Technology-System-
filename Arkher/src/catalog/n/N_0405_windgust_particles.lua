-- ARKHER SYSTEM N.0405 :: Wind Gust Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0405"
	S.key = "arkher.vfx.windgust.particle_simulation"
	S.name = "Wind Gust Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Wind Gust"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.windgust.emission" }
	S.tags = { "n", "windgust", "particles", "vfx" }
	S.description = "Wind Gust Particle Simulation: pooled integration of position, velocity, colour and life for the Wind Gust subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.windgust.particle_simulation", capacity = 448, drag = 0.10, bounce = 0.45, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
