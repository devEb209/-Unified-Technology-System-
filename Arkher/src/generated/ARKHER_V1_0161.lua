--!strict
-- VFX Niagra — ANIMATION Node_Flow #0161
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="VFX Niagra — ANIMATION Node_Flow #0161", size=Vector2.new(680, 440), pos=UDim2.fromOffset(193, 217), parent=parent, icon="↻"})
