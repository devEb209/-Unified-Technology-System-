-- ARKHER SYSTEM V.0092 :: Audio Clip Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0092"
	S.key = "arkher.asset.audioclip.compression_codec"
	S.name = "Audio Clip Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.audioclip.streaming_residency" }
	S.tags = { "v", "audioclip", "codec", "asset" }
	S.description = "Audio Clip Compression Codec: compact encoding, diffing and checksum of asset payloads for the Audio Clip subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.audioclip.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
