-- ARKHER SYSTEM I.0116 :: Clip Events Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0116"
	S.key = "arkher.anim.clipevents.analysis"
	S.name = "Clip Events Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Events"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clipevents.quality_policy" }
	S.tags = { "i", "clipevents", "analyzer", "anim" }
	S.description = "Clip Events Analysis: pop, drift and cost analysis of playback for the Clip Events subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.clipevents.analysis", window = 193, buckets = 13, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
