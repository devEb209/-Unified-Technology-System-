-- ARKHER SYSTEM F.0659 :: VR Stereo Path Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0659"
	S.key = "arkher.render.vrpath.frame_graph"
	S.name = "VR Stereo Path Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "vrpath", "framegraph", "render" }
	S.description = "VR Stereo Path Frame Graph: declared passes, culling, ordering and aliasing for the VR Stereo Path subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.vrpath.frame_graph", budgetMs = 9.00 })
		inst.system = S
		inst.ctx = ctx
