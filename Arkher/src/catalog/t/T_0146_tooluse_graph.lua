-- ARKHER SYSTEM T.0146 :: Tool Use Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0146"
	S.key = "arkher.ai.tooluse.reasoning_graph"
	S.name = "Tool Use Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.tooluse.world_architect" }
	S.tags = { "t", "tooluse", "graph", "ai" }
	S.description = "Tool Use Reasoning Graph: relationship modelling and shortest-path reasoning for the Tool Use subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.tooluse.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
