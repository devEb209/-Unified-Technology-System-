-- ARKHER SYSTEM Z.0245 :: AI Native Engine Architecture World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0245"
	S.key = "arkher.origin.ainative.world_memory"
	S.name = "AI Native Engine Architecture World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.ainative.autonomous_pipeline" }
	S.tags = { "z", "ainative", "worldmemory", "origin" }
	S.description = "AI Native Engine Architecture World Memory: epoch-stamped persistent history with compaction and checkpoints for the AI Native Engine Architecture subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.ainative.world_memory", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
