-- ARKHER SYSTEM VC.0122 :: Spatial Slice Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0122"
	S.key = "arkher.contneural.spatialslice.epoch_clock"
	S.name = "Spatial Slice Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.spatialslice.infinite_grid" }
	S.tags = { "vc", "spatialslice", "epoch", "contneural" }
	S.description = "Spatial Slice Epoch Clock: deterministic epoch timeline with catch-up for the Spatial Slice subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.spatialslice.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
