-- ARKHER SYSTEM E.0051 :: Roughness Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0051"
	S.key = "arkher.material.roughness.variant_registry"
	S.name = "Roughness Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Roughness"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.roughness.procedural_detail" }
	S.tags = { "e", "roughness", "registry", "material" }
	S.description = "Roughness Variant Registry: named variants and their lifecycle for the Roughness subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.roughness.variant_registry" })
		inst.system = S
		inst.ctx = ctx
