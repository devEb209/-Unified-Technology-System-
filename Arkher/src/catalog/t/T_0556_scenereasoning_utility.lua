-- ARKHER SYSTEM T.0556 :: Scene Reasoning Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0556"
	S.key = "arkher.ai.scenereasoning.utility_selection"
	S.name = "Scene Reasoning Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.scenereasoning.working_memory" }
	S.tags = { "t", "scenereasoning", "utility", "ai" }
	S.description = "Scene Reasoning Utility Selection: scored choice between competing courses of action for the Scene Reasoning subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.scenereasoning.utility_selection", momentum = 0.03 })
		inst.system = S
		inst.ctx = ctx
