-- ARKHER SYSTEM VA.0333 :: Economy Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0333"
	S.key = "arkher.contworld.economycont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.economycont.world_memory_stream" }
	S.tags = { "va", "economycont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.economycont.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
