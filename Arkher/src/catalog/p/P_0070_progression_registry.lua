-- ARKHER SYSTEM P.0070 :: Progression Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0070"
	S.key = "arkher.play.progression.content_registry"
	S.name = "Progression Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Progression"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.progression.difficulty_controller" }
	S.tags = { "p", "progression", "registry", "play" }
	S.description = "Progression Content Registry: catalogue of the definitions this loop instantiates for the Progression subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.progression.content_registry" })
		inst.system = S
		inst.ctx = ctx
