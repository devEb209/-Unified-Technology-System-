-- ARKHER SYSTEM Z.0964 :: Generation Migration Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0964"
	S.key = "arkher.origin.generationmigration.autonomous_pipeline"
	S.name = "Generation Migration Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.simulation_fabric" }
	S.tags = { "z", "generationmigration", "autopipeline", "origin" }
	S.description = "Generation Migration Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.generationmigration.autonomous_pipeline", maxIterations = 7 })
		inst.system = S
		inst.ctx = ctx
