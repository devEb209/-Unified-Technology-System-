-- ARKHER SYSTEM R.0325 :: Matchmaking Transport Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0325"
	S.key = "arkher.net.matchmakingtransport.replication"
	S.name = "Matchmaking Transport Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "matchmakingtransport", "replicator", "net" }
	S.description = "Matchmaking Transport Replication: authoritative entity state, interest and delta snapshots for the Matchmaking Transport subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.matchmakingtransport.replication", mtu = 1350, interestRadius = 320, fullEvery = 45 })
		inst.system = S
		inst.ctx = ctx
