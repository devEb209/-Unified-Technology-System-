-- ARKHER SYSTEM F.0097 :: Contact Shadows Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0097"
	S.key = "arkher.render.contact.orchestration"
	S.name = "Contact Shadows Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.contact.frame_analysis" }
	S.tags = { "f", "contact", "orchestrator", "render" }
	S.description = "Contact Shadows Orchestration: frame lifecycle orchestration for the Contact Shadows subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.contact.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
