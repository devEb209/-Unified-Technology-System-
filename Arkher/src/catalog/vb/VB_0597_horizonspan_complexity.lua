-- ARKHER SYSTEM VB.0597 :: Horizon Span Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0597"
	S.key = "arkher.conttime.horizonspan.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.horizonspan.world_memory_stream" }
	S.tags = { "vb", "horizonspan", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.horizonspan.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
