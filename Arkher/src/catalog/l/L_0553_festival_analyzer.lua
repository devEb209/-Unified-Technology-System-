-- ARKHER SYSTEM L.0553 :: Festival Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0553"
	S.key = "arkher.sim.festival.analysis"
	S.name = "Festival Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.festival.aggregate_cache" }
	S.tags = { "l", "festival", "analyzer", "sim" }
	S.description = "Festival Analysis: trend, anomaly and stability analysis of the world for the Festival subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.festival.analysis", window = 63, buckets = 19, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
