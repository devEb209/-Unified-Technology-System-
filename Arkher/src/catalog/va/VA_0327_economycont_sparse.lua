-- ARKHER SYSTEM VA.0327 :: Economy Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0327"
	S.key = "arkher.contworld.economycont.sparse_residency"
	S.name = "Economy Continuum Sparse Residency"
	S.category = "VA"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.economycont.epoch_clock" }
	S.tags = { "va", "economycont", "sparse", "contworld" }
	S.description = "Economy Continuum Sparse Residency: sparse page residency with eviction and compression for the Economy Continuum subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.economycont.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
