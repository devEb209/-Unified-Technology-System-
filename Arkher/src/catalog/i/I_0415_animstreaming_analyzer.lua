-- ARKHER SYSTEM I.0415 :: Animation Streaming Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0415"
	S.key = "arkher.anim.animstreaming.analysis"
	S.name = "Animation Streaming Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstreaming.quality_policy" }
	S.tags = { "i", "animstreaming", "analyzer", "anim" }
	S.description = "Animation Streaming Analysis: pop, drift and cost analysis of playback for the Animation Streaming subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.animstreaming.analysis", window = 196, buckets = 8, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
