-- ARKHER SYSTEM O.0414 :: Audio Debug Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0414"
	S.key = "arkher.audio.audiodebug.streaming"
	S.name = "Audio Debug Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Audio Debug"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiodebug.voice_budget" }
	S.tags = { "o", "audiodebug", "streamer", "audio" }
	S.description = "Audio Debug Streaming: distance-driven residency of audio assets for the Audio Debug subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.audiodebug.streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
