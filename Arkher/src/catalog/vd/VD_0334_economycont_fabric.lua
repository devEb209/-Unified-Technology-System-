-- ARKHER SYSTEM VD.0334 :: Economy Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0334"
	S.key = "arkher.contsim.economycont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.economycont.complexity_budget" }
	S.tags = { "vd", "economycont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.economycont.simulation_fabric", budgetMs = 3.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
