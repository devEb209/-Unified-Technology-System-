-- ARKHER SYSTEM H.0664 :: Raycast Query Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0664"
	S.key = "arkher.physics.raycast.character_motion"
	S.name = "Raycast Query Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.raycast.query" }
	S.tags = { "h", "raycast", "charmotor", "physics" }
	S.description = "Raycast Query Character Motion: capsule move-and-slide with slopes, steps and jumps for the Raycast Query subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.raycast.character_motion", radius = 0.49, height = 1.74, maxSpeed = 7.40, jumpHeight = 2.20, stepOffset = 0.29 })
		inst.system = S
		inst.ctx = ctx
