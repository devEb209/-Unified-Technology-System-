-- ARKHER SYSTEM P.0051 :: Talent Tree Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0051"
	S.key = "arkher.play.talenttree.objectives"
	S.name = "Talent Tree Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Talent Tree"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.talenttree.inventory" }
	S.tags = { "p", "talenttree", "quest", "play" }
	S.description = "Talent Tree Objectives: objectives, prerequisites, progress and rewards for the Talent Tree subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.talenttree.objectives" })
		inst.system = S
		inst.ctx = ctx
