-- ARKHER SYSTEM V.0123 :: Font Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0123"
	S.key = "arkher.asset.font.cook_pipeline"
	S.name = "Font Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.font.bundling" }
	S.tags = { "v", "font", "pipeline", "asset" }
	S.description = "Font Cook Pipeline: staged cooking with isolation and retries for the Font subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.font.cook_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
