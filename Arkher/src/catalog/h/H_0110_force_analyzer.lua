-- ARKHER SYSTEM H.0110 :: Force Accumulator Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0110"
	S.key = "arkher.physics.force.analysis"
	S.name = "Force Accumulator Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.force.result_cache" }
	S.tags = { "h", "force", "analyzer", "physics" }
	S.description = "Force Accumulator Analysis: energy, jitter and cost analysis of the simulation for the Force Accumulator subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.force.analysis", window = 88, buckets = 8, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
