-- ARKHER SYSTEM K.0625 :: Reputation Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0625"
	S.key = "arkher.npc.reputation.navigation"
	S.name = "Reputation Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.reputation.goal_planner" }
	S.tags = { "k", "reputation", "navgraph", "npc" }
	S.description = "Reputation Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Reputation subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.reputation.navigation", width = 40, height = 40, cellSize = 4 })
		inst.system = S
		inst.ctx = ctx
