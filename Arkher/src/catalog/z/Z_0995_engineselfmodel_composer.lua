-- ARKHER SYSTEM Z.0995 :: Engine Self Model Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0995"
	S.key = "arkher.origin.engineselfmodel.signal_composition"
	S.name = "Engine Self Model Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.engineselfmodel.telemetry_ledger" }
	S.tags = { "z", "engineselfmodel", "composer", "origin" }
	S.description = "Engine Self Model Signal Composition: blending of the technology's input signals into one output for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.engineselfmodel.signal_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
