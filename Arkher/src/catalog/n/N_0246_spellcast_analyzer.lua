-- ARKHER SYSTEM N.0246 :: Spell Cast Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0246"
	S.key = "arkher.vfx.spellcast.analysis"
	S.name = "Spell Cast Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spell Cast"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spellcast.spatial_index" }
	S.tags = { "n", "spellcast", "analyzer", "vfx" }
	S.description = "Spell Cast Analysis: cost, overdraw and stability analysis of the effect for the Spell Cast subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.spellcast.analysis", window = 162, buckets = 10, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
