-- ARKHER SYSTEM T.0604 :: Safety Alignment Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0604"
	S.key = "arkher.ai.safetyalignment.semantic_knowledge"
	S.name = "Safety Alignment Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.safetyalignment.intent_understanding" }
	S.tags = { "t", "safetyalignment", "knowledge", "ai" }
	S.description = "Safety Alignment Semantic Knowledge: typed entities, weighted relations and inferred closure for the Safety Alignment subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.safetyalignment.semantic_knowledge", dims = 24 })
		inst.system = S
		inst.ctx = ctx
