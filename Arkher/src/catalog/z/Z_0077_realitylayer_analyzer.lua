-- ARKHER SYSTEM Z.0077 :: Reality Layer Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0077"
	S.key = "arkher.origin.realitylayer.behaviour_analysis"
	S.name = "Reality Layer Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.governance_policy" }
	S.tags = { "z", "realitylayer", "analyzer", "origin" }
	S.description = "Reality Layer Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.realitylayer.behaviour_analysis", window = 129, buckets = 13, threshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
