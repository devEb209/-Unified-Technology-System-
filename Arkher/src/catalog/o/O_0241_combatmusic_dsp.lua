-- ARKHER SYSTEM O.0241 :: Combat Music DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0241"
	S.key = "arkher.audio.combatmusic.dsp_chain"
	S.name = "Combat Music DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Combat Music"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "combatmusic", "dsp", "audio" }
	S.description = "Combat Music DSP Chain: biquad filtering, delay, envelope and soft clipping for the Combat Music subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.combatmusic.dsp_chain", sampleRate = 22050, filter = "lowpass", cutoff = 1500, q = 0.740 })
		inst.system = S
		inst.ctx = ctx
