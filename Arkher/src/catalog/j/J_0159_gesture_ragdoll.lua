-- ARKHER SYSTEM J.0159 :: Gesture Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0159"
	S.key = "arkher.character.gesture.physical_response"
	S.name = "Gesture Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gesture.look_and_reach" }
	S.tags = { "j", "gesture", "ragdoll", "character" }
	S.description = "Gesture Physical Response: physical reaction, ragdoll and recovery for the Gesture subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.gesture.physical_response", blendSpeed = 2.50 })
		inst.system = S
		inst.ctx = ctx
