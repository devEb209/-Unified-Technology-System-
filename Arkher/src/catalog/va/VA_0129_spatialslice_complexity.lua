-- ARKHER SYSTEM VA.0129 :: Spatial Slice Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0129"
	S.key = "arkher.contworld.spatialslice.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.spatialslice.world_memory_stream" }
	S.tags = { "va", "spatialslice", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.spatialslice.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
