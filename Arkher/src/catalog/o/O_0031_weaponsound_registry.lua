-- ARKHER SYSTEM O.0031 :: Weapon Sound Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0031"
	S.key = "arkher.audio.weaponsound.asset_registry"
	S.name = "Weapon Sound Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Weapon Sound"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.weaponsound.streaming" }
	S.tags = { "o", "weaponsound", "registry", "audio" }
	S.description = "Weapon Sound Asset Registry: catalogue of sounds, variations and metadata for the Weapon Sound subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.weaponsound.asset_registry" })
		inst.system = S
		inst.ctx = ctx
