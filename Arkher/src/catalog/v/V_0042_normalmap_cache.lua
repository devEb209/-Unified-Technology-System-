-- ARKHER SYSTEM V.0042 :: Normal Map Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0042"
	S.key = "arkher.asset.normalmap.content_cache"
	S.name = "Normal Map Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.normalmap.dependency_graph" }
	S.tags = { "v", "normalmap", "cache", "asset" }
	S.description = "Normal Map Content Cache: reuse of already cooked results for the Normal Map subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.normalmap.content_cache", policy = "lfu", capacity = 407, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
