-- ARKHER SYSTEM E.0342 :: Rust Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0342"
	S.key = "arkher.material.rust.analysis"
	S.name = "Rust Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Rust"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.rust.instance_cache" }
	S.tags = { "e", "rust", "analyzer", "material" }
	S.description = "Rust Analysis: cost, redundancy and outlier analysis for the Rust subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.rust.analysis", window = 161, buckets = 13, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
