-- ARKHER SYSTEM Z.0672 :: Auto Documentation Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0672"
	S.key = "arkher.origin.autodocumentation.predictive_optimization"
	S.name = "Auto Documentation Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.adaptive_workflow" }
	S.tags = { "z", "autodocumentation", "predictor", "origin" }
	S.description = "Auto Documentation Predictive Optimization: forecast-driven optimization before the cost is paid for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.autodocumentation.predictive_optimization", method = "linear", alpha = 0.28, window = 42 })
		inst.system = S
		inst.ctx = ctx
