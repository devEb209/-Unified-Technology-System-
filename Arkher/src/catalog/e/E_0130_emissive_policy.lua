-- ARKHER SYSTEM E.0130 :: Emissive Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0130"
	S.key = "arkher.material.emissive.quality_policy"
	S.name = "Emissive Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Emissive"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.emissive.compression_codec" }
	S.tags = { "e", "emissive", "policy", "material" }
	S.description = "Emissive Quality Policy: device tier rules for the surface for the Emissive subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.emissive.quality_policy", algorithm = "edf", starvationGuard = 33 })
		inst.system = S
		inst.ctx = ctx
