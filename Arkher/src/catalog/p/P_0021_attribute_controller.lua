-- ARKHER SYSTEM P.0021 :: Attribute Difficulty Controller
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0021"
	S.key = "arkher.play.attribute.difficulty_controller"
	S.name = "Attribute Difficulty Controller"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Attribute"
	...
	S.kit = "controller"
	S.version = "1.0.0"
	S.deps = { "arkher.play.attribute.balance_analysis" }
	S.tags = { "p", "attribute", "controller", "play" }
	S.description = "Attribute Difficulty Controller: closed-loop tuning toward a target challenge for the Attribute subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("controller", { id = "arkher.play.attribute.difficulty_controller", mode = "pid", target = 0.620, kp = 0.270, ki = 0.100, kd = 0.030, min = 0.05, max = 1.0, initial = 0.52, deadband = 0.01 })
		inst.system = S
		inst.ctx = ctx
