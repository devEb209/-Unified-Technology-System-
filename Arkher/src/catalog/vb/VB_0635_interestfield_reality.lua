-- ARKHER SYSTEM VB.0635 :: Interest Field Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0635"
	S.key = "arkher.conttime.interestfield.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.interestfield.simulation_fabric" }
	S.tags = { "vb", "interestfield", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.interestfield.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
