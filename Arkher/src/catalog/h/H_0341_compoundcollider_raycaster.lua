-- ARKHER SYSTEM H.0341 :: Compound Collider Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0341"
	S.key = "arkher.physics.compoundcollider.query"
	S.name = "Compound Collider Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.compoundcollider.constraint_solver" }
	S.tags = { "h", "compoundcollider", "raycaster", "physics" }
	S.description = "Compound Collider Query: rays, sweeps and overlaps against the simulation for the Compound Collider subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.compoundcollider.query", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
