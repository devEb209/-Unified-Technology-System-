-- ARKHER SYSTEM VC.0423 :: Navigation Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0423"
	S.key = "arkher.contneural.navcont.sparse_residency"
	S.name = "Navigation Continuum Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.navcont.epoch_clock" }
	S.tags = { "vc", "navcont", "sparse", "contneural" }
	S.description = "Navigation Continuum Sparse Residency: sparse page residency with eviction and compression for the Navigation Continuum subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.navcont.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
