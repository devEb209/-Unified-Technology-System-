-- ARKHER SYSTEM Z.0586 :: Self Healing Systems Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0586"
	S.key = "arkher.origin.selfhealing.emergence_detection"
	S.name = "Self Healing Systems Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfhealing.world_memory" }
	S.tags = { "z", "selfhealing", "emergence", "origin" }
	S.description = "Self Healing Systems Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.selfhealing.emergence_detection", windowSize = 6, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
