-- ARKHER SYSTEM VB.0238 :: City Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0238"
	S.key = "arkher.conttime.citycont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.citycont.complexity_budget" }
	S.tags = { "vb", "citycont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.citycont.simulation_fabric", budgetMs = 4.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
