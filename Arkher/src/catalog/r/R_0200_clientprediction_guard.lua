-- ARKHER SYSTEM R.0200 :: Client Prediction Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0200"
	S.key = "arkher.net.clientprediction.rate_guard"
	S.name = "Client Prediction Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.clientprediction.interest_streaming" }
	S.tags = { "r", "clientprediction", "guard", "net" }
	S.description = "Client Prediction Rate Guard: token-bucket protection against floods and abuse for the Client Prediction subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.clientprediction.rate_guard", algorithm = "token", capacity = 188, refillPerSec = 53, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
