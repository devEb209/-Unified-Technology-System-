-- ARKHER SYSTEM I.0001 :: Skeleton Rig Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0001"
	S.key = "arkher.anim.skeletonrig.skeleton"
	S.name = "Skeleton Rig Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Skeleton Rig"
	S.aspect = "Skeleton"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "skeletonrig", "skeleton", "anim" }
	S.description = "Skeleton Rig Skeleton: bone hierarchy, bind pose and world resolution for the Skeleton Rig subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.skeletonrig.skeleton" })
		inst.system = S
		inst.ctx = ctx
