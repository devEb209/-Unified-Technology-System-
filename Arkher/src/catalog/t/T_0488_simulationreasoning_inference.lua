-- ARKHER SYSTEM T.0488 :: Simulation Reasoning Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0488"
	S.key = "arkher.ai.simulationreasoning.model_inference"
	S.name = "Simulation Reasoning Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.simulationreasoning.action_planner" }
	S.tags = { "t", "simulationreasoning", "inference", "ai" }
	S.description = "Simulation Reasoning Model Inference: quantized inference with batching and budget for the Simulation Reasoning subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.simulationreasoning.model_inference", seed = 1329 })
		inst.system = S
		inst.ctx = ctx
