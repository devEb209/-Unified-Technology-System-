-- ARKHER SYSTEM I.0157 :: Additive Layer Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0157"
	S.key = "arkher.anim.additivelayer.skeleton"
	S.name = "Additive Layer Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "additivelayer", "skeleton", "anim" }
	S.description = "Additive Layer Skeleton: bone hierarchy, bind pose and world resolution for the Additive Layer subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.additivelayer.skeleton" })
		inst.system = S
		inst.ctx = ctx
