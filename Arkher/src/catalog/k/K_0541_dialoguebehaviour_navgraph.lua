-- ARKHER SYSTEM K.0541 :: Dialogue Behaviour Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0541"
	S.key = "arkher.npc.dialoguebehaviour.navigation"
	S.name = "Dialogue Behaviour Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dialoguebehaviour.goal_planner" }
	S.tags = { "k", "dialoguebehaviour", "navgraph", "npc" }
	S.description = "Dialogue Behaviour Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Dialogue Behaviour subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.dialoguebehaviour.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
