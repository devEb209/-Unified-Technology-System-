-- ARKHER SYSTEM H.0233 :: Continuous Detection Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0233"
	S.key = "arkher.physics.ccd.budget_governor"
	S.name = "Continuous Detection Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.ccd.broadphase_index" }
	S.tags = { "h", "ccd", "budgeter", "physics" }
	S.description = "Continuous Detection Budget Governor: simulation time budget allocation across islands for the Continuous Detection subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.ccd.budget_governor", total = 165, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
