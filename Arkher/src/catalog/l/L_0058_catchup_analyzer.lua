-- ARKHER SYSTEM L.0058 :: Catch Up Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0058"
	S.key = "arkher.sim.catchup.analysis"
	S.name = "Catch Up Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.catchup.aggregate_cache" }
	S.tags = { "l", "catchup", "analyzer", "sim" }
	S.description = "Catch Up Analysis: trend, anomaly and stability analysis of the world for the Catch Up subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.catchup.analysis", window = 98, buckets = 14, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
