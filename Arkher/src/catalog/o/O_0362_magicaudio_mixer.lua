-- ARKHER SYSTEM O.0362 :: Magic Audio Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0362"
	S.key = "arkher.audio.magicaudio.mixer_bus"
	S.name = "Magic Audio Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Magic Audio"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.magicaudio.dsp_chain" }
	S.tags = { "o", "magicaudio", "mixer", "audio" }
	S.description = "Magic Audio Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Magic Audio subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.magicaudio.mixer_bus", maxVoices = 40 })
		inst.system = S
		inst.ctx = ctx
