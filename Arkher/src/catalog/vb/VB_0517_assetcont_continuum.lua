-- ARKHER SYSTEM VB.0517 :: Asset Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0517"
	S.key = "arkher.conttime.assetcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "assetcont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.assetcont.infinite_grid", cellSize = 96, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
