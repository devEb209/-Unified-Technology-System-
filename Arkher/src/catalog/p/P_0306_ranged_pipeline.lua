-- ARKHER SYSTEM P.0306 :: Ranged Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0306"
	S.key = "arkher.play.ranged.rule_pipeline"
	S.name = "Ranged Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ranged"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ranged.state_machine" }
	S.tags = { "p", "ranged", "pipeline", "play" }
	S.description = "Ranged Rule Pipeline: ordered rules applied to every gameplay event for the Ranged subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.ranged.rule_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
