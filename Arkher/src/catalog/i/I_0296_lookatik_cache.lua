-- ARKHER SYSTEM I.0296 :: Look At IK Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0296"
	S.key = "arkher.anim.lookatik.pose_cache"
	S.name = "Look At IK Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Look At IK"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.lookatik.playback_pipeline" }
	S.tags = { "i", "lookatik", "cache", "anim" }
	S.description = "Look At IK Pose Cache: reuse of sampled poses across frames and instances for the Look At IK subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.lookatik.pose_cache", policy = "ttl", capacity = 80, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
