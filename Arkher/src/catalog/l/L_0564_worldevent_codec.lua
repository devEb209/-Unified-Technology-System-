-- ARKHER SYSTEM L.0564 :: World Event State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0564"
	S.key = "arkher.sim.worldevent.state_codec"
	S.name = "World Event State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldevent.history_ledger" }
	S.tags = { "l", "worldevent", "codec", "sim" }
	S.description = "World Event State Codec: persistence, diffing and checksum of the world state for the World Event subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.worldevent.state_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
