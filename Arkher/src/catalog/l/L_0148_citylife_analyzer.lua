-- ARKHER SYSTEM L.0148 :: City Life Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0148"
	S.key = "arkher.sim.citylife.analysis"
	S.name = "City Life Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.citylife.aggregate_cache" }
	S.tags = { "l", "citylife", "analyzer", "sim" }
	S.description = "City Life Analysis: trend, anomaly and stability analysis of the world for the City Life subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.citylife.analysis", window = 55, buckets = 15, threshold = 2.70 })
		inst.system = S
		inst.ctx = ctx
