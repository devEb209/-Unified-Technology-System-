-- ARKHER SYSTEM VC.0020 :: Region Tile World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0020"
	S.key = "arkher.contneural.regiontile.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.regiontile.neural_field" }
	S.tags = { "vc", "regiontile", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.regiontile.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
