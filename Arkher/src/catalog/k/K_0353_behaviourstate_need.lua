-- ARKHER SYSTEM K.0353 :: Behaviour State Machine Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0353"
	S.key = "arkher.npc.behaviourstate.drive_system"
	S.name = "Behaviour State Machine Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourstate.memory" }
	S.tags = { "k", "behaviourstate", "need", "npc" }
	S.description = "Behaviour State Machine Drive System: drives that decay, turn urgent and get satisfied for the Behaviour State Machine subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.behaviourstate.drive_system" })
		inst.system = S
		inst.ctx = ctx
