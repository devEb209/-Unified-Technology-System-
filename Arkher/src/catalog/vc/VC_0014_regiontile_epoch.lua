-- ARKHER SYSTEM VC.0014 :: Region Tile Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0014"
	S.key = "arkher.contneural.regiontile.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.regiontile.infinite_grid" }
	S.tags = { "vc", "regiontile", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.regiontile.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
