-- ARKHER SYSTEM I.0302 :: Aim Offset Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0302"
	S.key = "arkher.anim.aimoffset.layered_blending"
	S.name = "Aim Offset Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Aim Offset"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.aimoffset.clip_sampling" }
	S.tags = { "i", "aimoffset", "animator", "anim" }
	S.description = "Aim Offset Layered Blending: layers, crossfades, masks and blend trees for the Aim Offset subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.aimoffset.layered_blending", budget = 10 })
		inst.system = S
		inst.ctx = ctx
