-- ARKHER SYSTEM VA.0016 :: Region Tile Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VA.0016"
	S.key = "arkher.contworld.regiontile.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.regiontile.sparse_residency" }
	S.tags = { "va", "regiontile", "multiscale", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contworld.regiontile.multi-scale_fidelity", levels = 5, baseTriangles = 120000 })
		inst.system = S
		inst.ctx = ctx
