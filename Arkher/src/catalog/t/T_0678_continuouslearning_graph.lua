-- ARKHER SYSTEM T.0678 :: Continuous Learning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0678"
	S.key = "arkher.ai.continuouslearning.reasoning_graph"
	S.name = "Continuous Learning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.continuouslearning.world_architect" }
	S.tags = { "t", "continuouslearning", "graph", "ai" }
	S.description = "Continuous Learning Reasoning Graph: relationship modelling and shortest-path reasoning for the Continuous Learning subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.continuouslearning.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
