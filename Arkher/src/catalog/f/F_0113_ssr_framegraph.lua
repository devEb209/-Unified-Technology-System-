-- ARKHER SYSTEM F.0113 :: Screen Space Reflection Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0113"
	S.key = "arkher.render.ssr.frame_graph"
	S.name = "Screen Space Reflection Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "ssr", "framegraph", "render" }
	S.description = "Screen Space Reflection Frame Graph: declared passes, culling, ordering and aliasing for the Screen Space Reflection subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.ssr.frame_graph", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
