-- ARKHER SYSTEM VA.0430 :: Navigation Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0430"
	S.key = "arkher.contworld.navcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.navcont.complexity_budget" }
	S.tags = { "va", "navcont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.navcont.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
