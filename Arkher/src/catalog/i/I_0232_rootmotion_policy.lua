-- ARKHER SYSTEM I.0232 :: Root Motion Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0232"
	S.key = "arkher.anim.rootmotion.quality_policy"
	S.name = "Root Motion Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Root Motion"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.rootmotion.pose_cache" }
	S.tags = { "i", "rootmotion", "policy", "anim" }
	S.description = "Root Motion Quality Policy: device tier rules for rate, bones and solvers for the Root Motion subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.rootmotion.quality_policy", algorithm = "wfq", starvationGuard = 34 })
		inst.system = S
		inst.ctx = ctx
