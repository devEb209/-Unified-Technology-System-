-- ARKHER SYSTEM L.0439 :: Crime Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0439"
	S.key = "arkher.sim.crime.society"
	S.name = "Crime Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.crime.economy" }
	S.tags = { "l", "crime", "society", "sim" }
	S.description = "Crime Society: relations, factions, reputation and cohesion of the region for the Crime subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.crime.society", decayRate = 0.008, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
