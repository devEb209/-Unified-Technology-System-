-- ARKHER SYSTEM K.0636 :: Gossip Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0636"
	S.key = "arkher.npc.gossip.reactive_behaviour"
	S.name = "Gossip Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.gossip.perception" }
	S.tags = { "k", "gossip", "behaviortree", "npc" }
	S.description = "Gossip Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Gossip subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.gossip.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
