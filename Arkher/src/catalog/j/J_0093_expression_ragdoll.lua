-- ARKHER SYSTEM J.0093 :: Expression Set Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0093"
	S.key = "arkher.character.expression.physical_response"
	S.name = "Expression Set Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.expression.look_and_reach" }
	S.tags = { "j", "expression", "ragdoll", "character" }
	S.description = "Expression Set Physical Response: physical reaction, ragdoll and recovery for the Expression Set subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.expression.physical_response", blendSpeed = 3.10 })
		inst.system = S
		inst.ctx = ctx
