-- ARKHER SYSTEM VD.0359 :: Narrative Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0359"
	S.key = "arkher.contsim.narrativecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.narrativecont.simulation_fabric" }
	S.tags = { "vd", "narrativecont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.narrativecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
