-- ARKHER SYSTEM L.0451 :: Justice Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0451"
	S.key = "arkher.sim.justice.simulation_core"
	S.name = "Justice Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "justice", "simulation", "sim" }
	S.description = "Justice Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Justice subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.justice.simulation_core", fullRadius = 120, reducedRadius = 1200, budget = 86 })
		inst.system = S
		inst.ctx = ctx
