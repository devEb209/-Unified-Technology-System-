-- ARKHER SYSTEM O.0345 :: Animal Audio Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0345"
	S.key = "arkher.audio.animalaudio.playback_policy"
	S.name = "Animal Audio Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Animal Audio"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.animalaudio.compression_codec" }
	S.tags = { "o", "animalaudio", "policy", "audio" }
	S.description = "Animal Audio Playback Policy: rules choosing what may be heard right now for the Animal Audio subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.animalaudio.playback_policy", algorithm = "roundrobin", starvationGuard = 28 })
		inst.system = S
		inst.ctx = ctx
