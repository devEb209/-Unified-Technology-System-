-- ARKHER SYSTEM VB.0506 :: Material Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0506"
	S.key = "arkher.conttime.materialcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.materialcont.infinite_grid" }
	S.tags = { "vb", "materialcont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.materialcont.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
