-- ARKHER SYSTEM T.0417 :: Device Reasoning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0417"
	S.key = "arkher.ai.devicereasoning.action_planner"
	S.name = "Device Reasoning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.devicereasoning.utility_selection" }
	S.tags = { "t", "devicereasoning", "planner", "ai" }
	S.description = "Device Reasoning Action Planner: goal-oriented action planning over preconditions for the Device Reasoning subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.devicereasoning.action_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
