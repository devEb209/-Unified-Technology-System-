-- ARKHER SYSTEM K.0218 :: Mood Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0218"
	S.key = "arkher.npc.mood.goal_planner"
	S.name = "Mood Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.mood.utility_reasoning" }
	S.tags = { "k", "mood", "planner", "npc" }
	S.description = "Mood Goal Planner: backward GOAP planning to reach a goal state for the Mood subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.mood.goal_planner", maxDepth = 10 })
		inst.system = S
		inst.ctx = ctx
