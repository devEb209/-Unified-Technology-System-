-- ARKHER SYSTEM N.0339 :: Beam Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0339"
	S.key = "arkher.vfx.beam.emission"
	S.name = "Beam Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Beam"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "beam", "emitter", "vfx" }
	S.description = "Beam Emission: shaped, rate and burst emission of new particles for the Beam subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.beam.emission", shape = "box", rate = 50, speed = 6.00, life = 0.80, budget = 512, seed = 3990 })
		inst.system = S
		inst.ctx = ctx
