-- ARKHER SYSTEM L.0370 :: Trade Route Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0370"
	S.key = "arkher.sim.traderoute.streaming"
	S.name = "Trade Route Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.traderoute.state_codec" }
	S.tags = { "l", "traderoute", "streamer", "sim" }
	S.description = "Trade Route Streaming: distance-driven residency of simulated regions for the Trade Route subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.traderoute.streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
