-- ARKHER SYSTEM P.0143 :: Rarity Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0143"
	S.key = "arkher.play.rarity.save_codec"
	S.name = "Rarity Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Rarity"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.rarity.content_registry" }
	S.tags = { "p", "rarity", "codec", "play" }
	S.description = "Rarity Save Codec: persistence, diffing and checksum of gameplay state for the Rarity subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.rarity.save_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
