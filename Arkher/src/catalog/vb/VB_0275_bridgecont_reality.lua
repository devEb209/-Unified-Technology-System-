-- ARKHER SYSTEM VB.0275 :: Bridge Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0275"
	S.key = "arkher.conttime.bridgecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.bridgecont.simulation_fabric" }
	S.tags = { "vb", "bridgecont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.bridgecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
