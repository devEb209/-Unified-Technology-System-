...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Blender — CORE Node_Flow #0136", size=Vector2.new(640, 440), pos=UDim2.fromOffset(268, 312), parent=parent, icon="✦"})
