-- ARKHER SYSTEM VC.0424 :: Navigation Continuum Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VC.0424"
	S.key = "arkher.contneural.navcont.multi-scale_fidelity"
	S.name = "Navigation Continuum Multi-Scale Fidelity"
	S.category = "VC"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.navcont.sparse_residency" }
	S.tags = { "vc", "navcont", "multiscale", "contneural" }
	S.description = "Navigation Continuum Multi-Scale Fidelity: distance-driven multi-scale level selection for the Navigation Continuum subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contneural.navcont.multi-scale_fidelity", levels = 5, baseTriangles = 75000 })
		inst.system = S
		inst.ctx = ctx
