-- ARKHER SYSTEM H.0271 :: Sphere Collider Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0271"
	S.key = "arkher.physics.spherecollider.query"
	S.name = "Sphere Collider Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.spherecollider.constraint_solver" }
	S.tags = { "h", "spherecollider", "raycaster", "physics" }
	S.description = "Sphere Collider Query: rays, sweeps and overlaps against the simulation for the Sphere Collider subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.spherecollider.query", cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
