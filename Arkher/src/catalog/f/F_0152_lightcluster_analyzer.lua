-- ARKHER SYSTEM F.0152 :: Light Clustering Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0152"
	S.key = "arkher.render.lightcluster.frame_analysis"
	S.name = "Light Clustering Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.lightcluster.pass_cache" }
	S.tags = { "f", "lightcluster", "analyzer", "render" }
	S.description = "Light Clustering Frame Analysis: per-pass cost analysis and outlier detection for the Light Clustering subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.lightcluster.frame_analysis", window = 78, buckets = 10, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
