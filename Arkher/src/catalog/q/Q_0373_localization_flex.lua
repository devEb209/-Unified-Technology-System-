-- ARKHER SYSTEM Q.0373 :: Localization Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0373"
	S.key = "arkher.ui.localization.responsive_layout"
	S.name = "Localization Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Localization"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "localization", "flex", "ui" }
	S.description = "Localization Responsive Layout: flex solving with safe areas, weights and breakpoints for the Localization subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.localization.responsive_layout", width = 390, height = 844, scale = 1.05 })
		inst.system = S
		inst.ctx = ctx
