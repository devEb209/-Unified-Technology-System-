-- ARKHER SYSTEM N.0099 :: Muzzle Flash Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0099"
	S.key = "arkher.vfx.muzzleflash.spawn_budget"
	S.name = "Muzzle Flash Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Muzzle Flash"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.muzzleflash.effect_composition" }
	S.tags = { "n", "muzzleflash", "budgeter", "vfx" }
	S.description = "Muzzle Flash Spawn Budget: global particle budget shared by every live effect for the Muzzle Flash subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.muzzleflash.spawn_budget", total = 276, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
