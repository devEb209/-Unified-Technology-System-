-- ARKHER SYSTEM VA.0446 :: Animation Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0446"
	S.key = "arkher.contworld.animcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.animcont.infinite_grid" }
	S.tags = { "va", "animcont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.animcont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
