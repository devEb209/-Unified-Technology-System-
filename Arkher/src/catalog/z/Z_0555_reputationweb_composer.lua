-- ARKHER SYSTEM Z.0555 :: Reputation Web Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0555"
	S.key = "arkher.origin.reputationweb.signal_composition"
	S.name = "Reputation Web Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.telemetry_ledger" }
	S.tags = { "z", "reputationweb", "composer", "origin" }
	S.description = "Reputation Web Signal Composition: blending of the technology's input signals into one output for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.reputationweb.signal_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
