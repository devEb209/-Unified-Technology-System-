-- ARKHER SYSTEM Z.1061 :: World Dream State Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.1061"
	S.key = "arkher.origin.worlddream.reality_layering"
	S.name = "World Dream State Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "worlddream", "reality", "origin" }
	S.description = "World Dream State Reality Layering: stacked authored, simulated, proposed and player realities for the World Dream State subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.worlddream.reality_layering" })
		inst.system = S
		inst.ctx = ctx
