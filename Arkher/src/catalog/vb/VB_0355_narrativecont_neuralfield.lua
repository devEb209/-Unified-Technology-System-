-- ARKHER SYSTEM VB.0355 :: Narrative Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0355"
	S.key = "arkher.conttime.narrativecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.narrativecont.coherence_guard" }
	S.tags = { "vb", "narrativecont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.narrativecont.neural_field", dims = 24, hidden = 20, seed = 59263 })
		inst.system = S
		inst.ctx = ctx
