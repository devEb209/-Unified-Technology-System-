-- ARKHER SYSTEM F.0589 :: Wireframe Overlay Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0589"
	S.key = "arkher.render.wireframe.frame_graph"
	S.name = "Wireframe Overlay Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "wireframe", "framegraph", "render" }
	S.description = "Wireframe Overlay Frame Graph: declared passes, culling, ordering and aliasing for the Wireframe Overlay subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.wireframe.frame_graph", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
