-- ARKHER SYSTEM T.0431 :: Mobile Reasoning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0431"
	S.key = "arkher.ai.mobilereasoning.action_planner"
	S.name = "Mobile Reasoning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.mobilereasoning.utility_selection" }
	S.tags = { "t", "mobilereasoning", "planner", "ai" }
	S.description = "Mobile Reasoning Action Planner: goal-oriented action planning over preconditions for the Mobile Reasoning subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.mobilereasoning.action_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
