-- ARKHER SYSTEM O.0354 :: Creature Audio Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0354"
	S.key = "arkher.audio.creatureaudio.streaming"
	S.name = "Creature Audio Streaming"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.creatureaudio.voice_budget" }
	S.tags = { "o", "creatureaudio", "streamer", "audio" }
	S.description = "Creature Audio Streaming: distance-driven residency of audio assets for the Creature Audio subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.creatureaudio.streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
