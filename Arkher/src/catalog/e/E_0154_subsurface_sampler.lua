-- ARKHER SYSTEM E.0154 :: Subsurface Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0154"
	S.key = "arkher.material.subsurface.texture_sampling"
	S.name = "Subsurface Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Subsurface"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.subsurface.shading_graph" }
	S.tags = { "e", "subsurface", "sampler", "material" }
	S.description = "Subsurface Texture Sampling: atlas packing, mip chain and filtered sampling for the Subsurface subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.subsurface.texture_sampling", atlasSize = 128, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
