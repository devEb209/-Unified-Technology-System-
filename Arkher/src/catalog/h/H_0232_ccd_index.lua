-- ARKHER SYSTEM H.0232 :: Continuous Detection Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0232"
	S.key = "arkher.physics.ccd.broadphase_index"
	S.name = "Continuous Detection Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.ccd.vehicle" }
	S.tags = { "h", "ccd", "index", "physics" }
	S.description = "Continuous Detection Broadphase Index: spatial acceleration of candidate pair finding for the Continuous Detection subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.ccd.broadphase_index", mode = "hash", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
