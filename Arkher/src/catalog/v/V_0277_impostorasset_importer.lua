-- ARKHER SYSTEM V.0277 :: Impostor Asset Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0277"
	S.key = "arkher.asset.impostorasset.import"
	S.name = "Impostor Asset Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "impostorasset", "importer", "asset" }
	S.description = "Impostor Asset Import: validation, normalization, hashing and deduplication of incoming content for the Impostor Asset subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.impostorasset.import", unitScale = 1.50 })
		inst.system = S
		inst.ctx = ctx
