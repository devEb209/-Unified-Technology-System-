-- ARKHER SYSTEM VB.0590 :: Horizon Span Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0590"
	S.key = "arkher.conttime.horizonspan.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.horizonspan.infinite_grid" }
	S.tags = { "vb", "horizonspan", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.horizonspan.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
