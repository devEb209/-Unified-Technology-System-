-- ARKHER SYSTEM P.0110 :: Equipment Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0110"
	S.key = "arkher.play.equipment.inventory"
	S.name = "Equipment Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Equipment"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.equipment.attributes" }
	S.tags = { "p", "equipment", "inventory", "play" }
	S.description = "Equipment Inventory: slots, stacking, weight, equipment and crafting for the Equipment subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.equipment.inventory", slots = 16, maxWeight = 130 })
		inst.system = S
		inst.ctx = ctx
