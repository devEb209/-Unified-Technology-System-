-- ARKHER SYSTEM O.0051 :: Explosion Sound Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0051"
	S.key = "arkher.audio.explosionsound.spatialization"
	S.name = "Explosion Sound Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.explosionsound.mixer_bus" }
	S.tags = { "o", "explosionsound", "spatialaudio", "audio" }
	S.description = "Explosion Sound Spatialization: distance attenuation, panning, occlusion and doppler for the Explosion Sound subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.explosionsound.spatialization", model = "exponential", refDistance = 8, maxDistance = 100, rolloff = 0.81, maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
