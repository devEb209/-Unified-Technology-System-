-- ARKHER SYSTEM W.0342 :: Camera Shake Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0342"
	S.key = "arkher.cine.camerashake.playback_orchestrator"
	S.name = "Camera Shake Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Camera Shake"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.camerashake.cut_policy" }
	S.tags = { "w", "camerashake", "orchestrator", "cine" }
	S.description = "Camera Shake Playback Orchestrator: the state machine that drives a cinematic from start to end for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.camerashake.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
