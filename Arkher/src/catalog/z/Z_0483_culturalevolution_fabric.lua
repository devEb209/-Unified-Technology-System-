-- ARKHER SYSTEM Z.0483 :: Cultural Evolution Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0483"
	S.key = "arkher.origin.culturalevolution.simulation_fabric"
	S.name = "Cultural Evolution Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.complexity_governance" }
	S.tags = { "z", "culturalevolution", "fabric", "origin" }
	S.description = "Cultural Evolution Simulation Fabric: every simulation domain stepped under one budgeted clock for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.culturalevolution.simulation_fabric", budgetMs = 4.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
