-- ARKHER SYSTEM Z.0943 :: Platform Abstraction Doctrine Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0943"
	S.key = "arkher.origin.platformdoctrine.simulation_fabric"
	S.name = "Platform Abstraction Doctrine Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.platformdoctrine.complexity_governance" }
	S.tags = { "z", "platformdoctrine", "fabric", "origin" }
	S.description = "Platform Abstraction Doctrine Simulation Fabric: every simulation domain stepped under one budgeted clock for the Platform Abstraction Doctrine subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.platformdoctrine.simulation_fabric", budgetMs = 2.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
