-- ARKHER SYSTEM V.0400 :: Thumbnail Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0400"
	S.key = "arkher.asset.thumbnail.asset_registry"
	S.name = "Thumbnail Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.thumbnail.cook_pipeline" }
	S.tags = { "v", "thumbnail", "registry", "asset" }
	S.description = "Thumbnail Asset Registry: catalogue of every asset, its tags and its metadata for the Thumbnail subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.thumbnail.asset_registry" })
		inst.system = S
		inst.ctx = ctx
