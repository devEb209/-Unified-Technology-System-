-- ARKHER SYSTEM VB.0313 :: Ecology Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0313"
	S.key = "arkher.conttime.ecologycont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "ecologycont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.ecologycont.infinite_grid", cellSize = 64, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
