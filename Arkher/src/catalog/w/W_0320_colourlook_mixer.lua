-- ARKHER SYSTEM W.0320 :: Colour Look Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0320"
	S.key = "arkher.cine.colourlook.cinematic_mix"
	S.name = "Colour Look Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Colour Look"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.colourlook.motion_tween" }
	S.tags = { "w", "colourlook", "mixer", "cine" }
	S.description = "Colour Look Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Colour Look subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.colourlook.cinematic_mix", maxVoices = 48 })
		inst.system = S
		inst.ctx = ctx
