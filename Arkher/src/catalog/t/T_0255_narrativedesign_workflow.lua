-- ARKHER SYSTEM T.0255 :: Narrative Design Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0255"
	S.key = "arkher.ai.narrativedesign.plan_workflow"
	S.name = "Narrative Design Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.narrativedesign.semantic_knowledge" }
	S.tags = { "t", "narrativedesign", "workflow", "ai" }
	S.description = "Narrative Design Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Narrative Design subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.narrativedesign.plan_workflow", maxRetries = 2, budget = 110 })
		inst.system = S
		inst.ctx = ctx
