-- ARKHER SYSTEM R.0227 :: Lag Compensation Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0227"
	S.key = "arkher.net.lagcompensation.latency_analysis"
	S.name = "Lag Compensation Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.lagcompensation.audit_ledger" }
	S.tags = { "r", "lagcompensation", "analyzer", "net" }
	S.description = "Lag Compensation Latency Analysis: round trip, jitter and loss analysis for the Lag Compensation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.lagcompensation.latency_analysis", window = 101, buckets = 17, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
