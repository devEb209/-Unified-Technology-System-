-- ARKHER SYSTEM L.0324 :: Production Chain State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0324"
	S.key = "arkher.sim.productionchain.state_codec"
	S.name = "Production Chain State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.productionchain.history_ledger" }
	S.tags = { "l", "productionchain", "codec", "sim" }
	S.description = "Production Chain State Codec: persistence, diffing and checksum of the world state for the Production Chain subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.productionchain.state_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
