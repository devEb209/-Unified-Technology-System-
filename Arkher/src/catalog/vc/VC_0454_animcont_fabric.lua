-- ARKHER SYSTEM VC.0454 :: Animation Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0454"
	S.key = "arkher.contneural.animcont.simulation_fabric"
	S.name = "Animation Continuum Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.animcont.complexity_budget" }
	S.tags = { "vc", "animcont", "fabric", "contneural" }
	S.description = "Animation Continuum Simulation Fabric: fabric stepping the continuum domains for the Animation Continuum subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.animcont.simulation_fabric", budgetMs = 2.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
