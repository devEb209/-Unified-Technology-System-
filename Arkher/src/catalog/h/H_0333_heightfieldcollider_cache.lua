-- ARKHER SYSTEM H.0333 :: Heightfield Collider Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0333"
	S.key = "arkher.physics.heightfieldcollider.result_cache"
	S.name = "Heightfield Collider Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.heightfieldcollider.simulation_policy" }
	S.tags = { "h", "heightfieldcollider", "cache", "physics" }
	S.description = "Heightfield Collider Result Cache: reuse of expensive simulation and query results for the Heightfield Collider subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.heightfieldcollider.result_cache", policy = "lru", capacity = 209, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
