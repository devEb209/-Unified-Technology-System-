-- ARKHER SYSTEM T.0586 :: Build Reasoning Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0586"
	S.key = "arkher.ai.buildreasoning.model_inference"
	S.name = "Build Reasoning Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.buildreasoning.action_planner" }
	S.tags = { "t", "buildreasoning", "inference", "ai" }
	S.description = "Build Reasoning Model Inference: quantized inference with batching and budget for the Build Reasoning subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.buildreasoning.model_inference", seed = 87359 })
		inst.system = S
		inst.ctx = ctx
