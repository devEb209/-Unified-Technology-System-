-- ARKHER SYSTEM VC.0386 :: Memory Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0386"
	S.key = "arkher.contneural.memorycont.epoch_clock"
	S.name = "Memory Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memorycont.infinite_grid" }
	S.tags = { "vc", "memorycont", "epoch", "contneural" }
	S.description = "Memory Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Memory Continuum subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.memorycont.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
