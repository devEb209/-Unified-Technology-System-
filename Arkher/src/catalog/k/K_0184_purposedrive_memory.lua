-- ARKHER SYSTEM K.0184 :: Purpose Drive Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0184"
	S.key = "arkher.npc.purposedrive.memory"
	S.name = "Purpose Drive Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.purposedrive.mind_network" }
	S.tags = { "k", "purposedrive", "memory", "npc" }
	S.description = "Purpose Drive Memory: episodic memory with decay, recall and consolidation for the Purpose Drive subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.purposedrive.memory", capacity = 87, decayRate = 0.035, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
