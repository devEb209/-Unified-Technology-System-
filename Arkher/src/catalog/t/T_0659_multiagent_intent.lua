-- ARKHER SYSTEM T.0659 :: Multi Agent Coordination Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0659"
	S.key = "arkher.ai.multiagent.intent_understanding"
	S.name = "Multi Agent Coordination Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "multiagent", "intent", "ai" }
	S.description = "Multi Agent Coordination Intent Understanding: natural language turned into an actionable, scored intent for the Multi Agent Coordination subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.multiagent.intent_understanding", minConfidence = 0.32 })
		inst.system = S
		inst.ctx = ctx
