-- ARKHER SYSTEM Z.0626 :: Intent Driven Authoring Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0626"
	S.key = "arkher.origin.intentauthoring.emergence_detection"
	S.name = "Intent Driven Authoring Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.world_memory" }
	S.tags = { "z", "intentauthoring", "emergence", "origin" }
	S.description = "Intent Driven Authoring Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.intentauthoring.emergence_detection", windowSize = 6, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
