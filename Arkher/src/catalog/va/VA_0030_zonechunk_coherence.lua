-- ARKHER SYSTEM VA.0030 :: Zone Chunk Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0030"
	S.key = "arkher.contworld.zonechunk.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.zonechunk.persistent_state" }
	S.tags = { "va", "zonechunk", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.zonechunk.coherence_guard", window = 82, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
