-- ARKHER SYSTEM F.0514 :: Mesh LOD Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0514"
	S.key = "arkher.render.meshlod.render_policy"
	S.name = "Mesh LOD Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Mesh LOD"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.meshlod.draw_budget" }
	S.tags = { "f", "meshlod", "policy", "render" }
	S.description = "Mesh LOD Render Policy: device tier rules for the frame for the Mesh LOD subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.meshlod.render_policy", algorithm = "roundrobin", starvationGuard = 28 })
		inst.system = S
		inst.ctx = ctx
