-- ARKHER SYSTEM K.0484 :: Follow Behaviour Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0484"
	S.key = "arkher.npc.followbehaviour.goal_planner"
	S.name = "Follow Behaviour Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.followbehaviour.utility_reasoning" }
	S.tags = { "k", "followbehaviour", "planner", "npc" }
	S.description = "Follow Behaviour Goal Planner: backward GOAP planning to reach a goal state for the Follow Behaviour subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.followbehaviour.goal_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
