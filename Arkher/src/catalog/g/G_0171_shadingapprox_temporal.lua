-- ARKHER SYSTEM G.0171 :: Shading Approximation Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0171"
	S.key = "arkher.neural.shadingapprox.temporal_history"
	S.name = "Shading Approximation Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.shadingapprox.feature_extraction" }
	S.tags = { "g", "shadingapprox", "temporal", "neural" }
	S.description = "Shading Approximation Temporal History: history buffers reused across frames for the Shading Approximation subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.shadingapprox.temporal_history", feedback = 0.91, phase = 8 })
		inst.system = S
		inst.ctx = ctx
