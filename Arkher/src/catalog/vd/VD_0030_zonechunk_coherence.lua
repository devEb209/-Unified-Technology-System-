-- ARKHER SYSTEM VD.0030 :: Zone Chunk Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0030"
	S.key = "arkher.contsim.zonechunk.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.zonechunk.persistent_state" }
	S.tags = { "vd", "zonechunk", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.zonechunk.coherence_guard", window = 119, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
