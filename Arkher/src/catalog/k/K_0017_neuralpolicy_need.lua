-- ARKHER SYSTEM K.0017 :: Neural Policy Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0017"
	S.key = "arkher.npc.neuralpolicy.drive_system"
	S.name = "Neural Policy Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.neuralpolicy.memory" }
	S.tags = { "k", "neuralpolicy", "need", "npc" }
	S.description = "Neural Policy Drive System: drives that decay, turn urgent and get satisfied for the Neural Policy subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.neuralpolicy.drive_system" })
		inst.system = S
		inst.ctx = ctx
