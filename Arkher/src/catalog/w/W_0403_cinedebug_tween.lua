-- ARKHER SYSTEM W.0403 :: Cinematic Debug Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0403"
	S.key = "arkher.cine.cinedebug.motion_tween"
	S.name = "Cinematic Debug Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinedebug.playback_orchestrator" }
	S.tags = { "w", "cinedebug", "tween", "cine" }
	S.description = "Cinematic Debug Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Cinematic Debug subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.cinedebug.motion_tween", timeScale = 1.07 })
		inst.system = S
		inst.ctx = ctx
