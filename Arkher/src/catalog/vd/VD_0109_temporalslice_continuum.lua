-- ARKHER SYSTEM VD.0109 :: Temporal Slice Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0109"
	S.key = "arkher.contsim.temporalslice.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "temporalslice", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.temporalslice.infinite_grid", cellSize = 192, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
