-- ARKHER SYSTEM K.0160 :: Safety Drive Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0160"
	S.key = "arkher.npc.safetydrive.reactive_behaviour"
	S.name = "Safety Drive Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.safetydrive.perception" }
	S.tags = { "k", "safetydrive", "behaviortree", "npc" }
	S.description = "Safety Drive Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Safety Drive subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.safetydrive.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
