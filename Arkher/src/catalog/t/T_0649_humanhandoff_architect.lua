-- ARKHER SYSTEM T.0649 :: Human Handoff World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0649"
	S.key = "arkher.ai.humanhandoff.world_architect"
	S.name = "Human Handoff World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.humanhandoff.self_critique" }
	S.tags = { "t", "humanhandoff", "architect", "ai" }
	S.description = "Human Handoff World Architect: composition of a whole world plan with conserved budgets for the Human Handoff subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.humanhandoff.world_architect", budget = 1300, seed = 59077 })
		inst.system = S
		inst.ctx = ctx
