-- ARKHER SYSTEM L.0434 :: Law Forecast
...
return function(A)
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.law.analysis" }
	S.tags = { "l", "law", "predictor", "sim" }
	S.description = "Law Forecast: prediction of the region's next state for the Law subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.law.forecast", method = "ema", alpha = 0.30, window = 92 })
		inst.system = S
		inst.ctx = ctx
