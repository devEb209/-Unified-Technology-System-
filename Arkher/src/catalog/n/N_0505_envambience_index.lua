-- ARKHER SYSTEM N.0505 :: Environment Ambience Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0505"
	S.key = "arkher.vfx.envambience.spatial_index"
	S.name = "Environment Ambience Spatial Index"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.envambience.quality_policy" }
	S.tags = { "n", "envambience", "index", "vfx" }
	S.description = "Environment Ambience Spatial Index: spatial acceleration of effect queries and culling for the Environment Ambience subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.envambience.spatial_index", mode = "hash", cellSize = 32 })
		inst.system = S
		inst.ctx = ctx
