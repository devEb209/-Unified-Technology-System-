-- ARKHER SYSTEM P.0296 :: Melee Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0296"
	S.key = "arkher.play.melee.balance_analysis"
	S.name = "Melee Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Melee"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.melee.event_ledger" }
	S.tags = { "p", "melee", "analyzer", "play" }
	S.description = "Melee Balance Analysis: distribution, outlier and pacing analysis for the Melee subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.melee.balance_analysis", window = 124, buckets = 8, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
