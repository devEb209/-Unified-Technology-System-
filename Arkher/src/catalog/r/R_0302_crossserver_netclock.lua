-- ARKHER SYSTEM R.0302 :: Cross Server Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0302"
	S.key = "arkher.net.crossserver.time_sync"
	S.name = "Cross Server Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Cross Server"
	S.aspect = "Time Sync"
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.crossserver.replication" }
	S.tags = { "r", "crossserver", "netclock", "net" }
	S.description = "Cross Server Time Sync: offset estimation, outlier rejection and jitter buffering for the Cross Server subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.crossserver.time_sync", tickRate = 20, bufferDelay = 0.060, maxSamples = 16 })
		inst.system = S
		inst.ctx = ctx
