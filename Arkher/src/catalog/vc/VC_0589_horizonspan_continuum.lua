-- ARKHER SYSTEM VC.0589 :: Horizon Span Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0589"
	S.key = "arkher.contneural.horizonspan.infinite_grid"
	S.name = "Horizon Span Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "horizonspan", "continuum", "contneural" }
	S.description = "Horizon Span Infinite Grid: seamless paging of the infinite world grid for the Horizon Span subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.horizonspan.infinite_grid", cellSize = 64, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
