-- ARKHER SYSTEM E.0242 :: Triplanar Projection Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0242"
	S.key = "arkher.material.triplanar.layer_composition"
	S.name = "Triplanar Projection Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.triplanar.definition" }
	S.tags = { "e", "triplanar", "composer", "material" }
	S.description = "Triplanar Projection Layer Composition: ordered layer composition with blend rules for the Triplanar Projection subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.triplanar.layer_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
