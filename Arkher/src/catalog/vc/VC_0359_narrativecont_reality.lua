-- ARKHER SYSTEM VC.0359 :: Narrative Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0359"
	S.key = "arkher.contneural.narrativecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.narrativecont.simulation_fabric" }
	S.tags = { "vc", "narrativecont", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.narrativecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
