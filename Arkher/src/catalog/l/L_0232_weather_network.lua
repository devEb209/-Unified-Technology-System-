-- ARKHER SYSTEM L.0232 :: Weather Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0232"
	S.key = "arkher.sim.weather.route_network"
	S.name = "Weather Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.weather.region_graph" }
	S.tags = { "l", "weather", "network", "sim" }
	S.description = "Weather Route Network: roads, rivers and routes between settlements for the Weather subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.weather.route_network" })
		inst.system = S
		inst.ctx = ctx
