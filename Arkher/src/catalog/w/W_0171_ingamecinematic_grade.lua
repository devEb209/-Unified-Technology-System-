-- ARKHER SYSTEM W.0171 :: In Game Cinematic Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0171"
	S.key = "arkher.cine.ingamecinematic.colour_grade"
	S.name = "In Game Cinematic Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.ingamecinematic.camera_rig" }
	S.tags = { "w", "ingamecinematic", "grade", "cine" }
	S.description = "In Game Cinematic Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the In Game Cinematic subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.ingamecinematic.colour_grade", exposure = -0.03, contrast = 1.02, saturation = 0.97, toneMap = "filmic" })
		inst.system = S
		inst.ctx = ctx
