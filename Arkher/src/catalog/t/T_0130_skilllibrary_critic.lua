-- ARKHER SYSTEM T.0130 :: Skill Library Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0130"
	S.key = "arkher.ai.skilllibrary.self_critique"
	S.name = "Skill Library Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.skilllibrary.plan_workflow" }
	S.tags = { "t", "skilllibrary", "critic", "ai" }
	S.description = "Skill Library Self Critique: weighted evaluation of the result against declared criteria for the Skill Library subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.skilllibrary.self_critique", passMark = 0.78, reviseMark = 0.48, seed = 84998 })
		inst.system = S
		inst.ctx = ctx
