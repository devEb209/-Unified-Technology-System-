-- ARKHER SYSTEM VC.0518 :: Asset Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0518"
	S.key = "arkher.contneural.assetcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.assetcont.infinite_grid" }
	S.tags = { "vc", "assetcont", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.assetcont.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
