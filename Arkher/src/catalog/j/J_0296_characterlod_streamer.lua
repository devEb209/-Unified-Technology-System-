-- ARKHER SYSTEM J.0296 :: Character LOD Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0296"
	S.key = "arkher.character.characterlod.streaming"
	S.name = "Character LOD Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterlod.budget_governor" }
	S.tags = { "j", "characterlod", "streamer", "character" }
	S.description = "Character LOD Streaming: distance-driven residency of character data for the Character LOD subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.characterlod.streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
