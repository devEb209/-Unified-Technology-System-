-- ARKHER SYSTEM VC.0184 :: Simulation Domain Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VC.0184"
	S.key = "arkher.contneural.simdomain.multi-scale_fidelity"
	S.name = "Simulation Domain Multi-Scale Fidelity"
	S.category = "VC"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.simdomain.sparse_residency" }
	S.tags = { "vc", "simdomain", "multiscale", "contneural" }
	S.description = "Simulation Domain Multi-Scale Fidelity: distance-driven multi-scale level selection for the Simulation Domain subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contneural.simdomain.multi-scale_fidelity", levels = 6, baseTriangles = 120000 })
		inst.system = S
		inst.ctx = ctx
