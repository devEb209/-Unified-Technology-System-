-- ARKHER SYSTEM H.0524 :: Breakable Joint Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0524"
	S.key = "arkher.physics.breakjoint.character_motion"
	S.name = "Breakable Joint Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.breakjoint.query" }
	S.tags = { "h", "breakjoint", "charmotor", "physics" }
	S.description = "Breakable Joint Character Motion: capsule move-and-slide with slopes, steps and jumps for the Breakable Joint subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.breakjoint.character_motion", radius = 0.54, height = 1.99, maxSpeed = 7.90, jumpHeight = 1.50, stepOffset = 0.34 })
		inst.system = S
		inst.ctx = ctx
