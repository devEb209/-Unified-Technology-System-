-- ARKHER SYSTEM F.0151 :: Light Clustering Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0151"
	S.key = "arkher.render.lightcluster.pass_cache"
	S.name = "Light Clustering Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.lightcluster.render_policy" }
	S.tags = { "f", "lightcluster", "cache", "render" }
	S.description = "Light Clustering Pass Cache: reuse of pass results across frames for the Light Clustering subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.lightcluster.pass_cache", policy = "lfu", capacity = 190, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
