-- ARKHER SYSTEM T.0117 :: Long Term Memory World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0117"
	S.key = "arkher.ai.longtermmemory.world_architect"
	S.name = "Long Term Memory World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.longtermmemory.self_critique" }
	S.tags = { "t", "longtermmemory", "architect", "ai" }
	S.description = "Long Term Memory World Architect: composition of a whole world plan with conserved budgets for the Long Term Memory subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.longtermmemory.world_architect", budget = 800, seed = 95592 })
		inst.system = S
		inst.ctx = ctx
