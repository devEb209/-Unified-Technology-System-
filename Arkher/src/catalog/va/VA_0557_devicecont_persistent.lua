-- ARKHER SYSTEM VA.0557 :: Device Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0557"
	S.key = "arkher.contworld.devicecont.persistent_state"
	S.name = "Device Continuum Persistent State"
	S.category = "VA"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.devicecont.multi-scale_fidelity" }
	S.tags = { "va", "devicecont", "persistent", "contworld" }
	S.description = "Device Continuum Persistent State: epoch-stamped persistent history and rollback for the Device Continuum subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.devicecont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
