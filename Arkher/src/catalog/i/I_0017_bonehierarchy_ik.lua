-- ARKHER SYSTEM I.0017 :: Bone Hierarchy Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0017"
	S.key = "arkher.anim.bonehierarchy.inverse_kinematics"
	S.name = "Bone Hierarchy Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonehierarchy.layered_blending" }
	S.tags = { "i", "bonehierarchy", "ik", "anim" }
	S.description = "Bone Hierarchy Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Bone Hierarchy subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.bonehierarchy.inverse_kinematics", iterations = 5, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
