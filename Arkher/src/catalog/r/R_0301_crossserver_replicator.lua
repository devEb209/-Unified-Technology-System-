-- ARKHER SYSTEM R.0301 :: Cross Server Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0301"
	S.key = "arkher.net.crossserver.replication"
	S.name = "Cross Server Replication"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Cross Server"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "crossserver", "replicator", "net" }
	S.description = "Cross Server Replication: authoritative entity state, interest and delta snapshots for the Cross Server subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.crossserver.replication", mtu = 900, interestRadius = 360, fullEvery = 60 })
		inst.system = S
		inst.ctx = ctx
