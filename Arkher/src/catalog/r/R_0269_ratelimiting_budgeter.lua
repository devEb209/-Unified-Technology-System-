-- ARKHER SYSTEM R.0269 :: Rate Limiting Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0269"
	S.key = "arkher.net.ratelimiting.bandwidth_budget"
	S.name = "Rate Limiting Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.ratelimiting.transport_graph" }
	S.tags = { "r", "ratelimiting", "budgeter", "net" }
	S.description = "Rate Limiting Bandwidth Budget: bytes per second shared between competing streams for the Rate Limiting subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.ratelimiting.bandwidth_budget", total = 432, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
