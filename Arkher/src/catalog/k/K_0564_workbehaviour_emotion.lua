-- ARKHER SYSTEM K.0564 :: Work Behaviour Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0564"
	S.key = "arkher.npc.workbehaviour.emotion"
	S.name = "Work Behaviour Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workbehaviour.drive_system" }
	S.tags = { "k", "workbehaviour", "emotion", "npc" }
	S.description = "Work Behaviour Emotion: appraisal of events into valence, arousal and mood for the Work Behaviour subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.workbehaviour.emotion", inertia = 0.94, decayRate = 0.29, baselineArousal = 0.29 })
		inst.system = S
		inst.ctx = ctx
