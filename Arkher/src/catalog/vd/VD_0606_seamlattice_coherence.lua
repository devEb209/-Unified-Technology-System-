-- ARKHER SYSTEM VD.0606 :: Seam Lattice Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0606"
	S.key = "arkher.contsim.seamlattice.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.seamlattice.persistent_state" }
	S.tags = { "vd", "seamlattice", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.seamlattice.coherence_guard", window = 143, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
