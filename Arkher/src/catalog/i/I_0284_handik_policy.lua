-- ARKHER SYSTEM I.0284 :: Hand Placement IK Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0284"
	S.key = "arkher.anim.handik.quality_policy"
	S.name = "Hand Placement IK Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.handik.pose_cache" }
	S.tags = { "i", "handik", "policy", "anim" }
	S.description = "Hand Placement IK Quality Policy: device tier rules for rate, bones and solvers for the Hand Placement IK subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.handik.quality_policy", algorithm = "lottery", starvationGuard = 19 })
		inst.system = S
		inst.ctx = ctx
