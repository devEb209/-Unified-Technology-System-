-- ARKHER SYSTEM VC.0323 :: Ecology Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0323"
	S.key = "arkher.contneural.ecologycont.reality_continuum"
	S.name = "Ecology Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.ecologycont.simulation_fabric" }
	S.tags = { "vc", "ecologycont", "reality", "contneural" }
	S.description = "Ecology Continuum Reality Continuum: stacked reality layers of the continuum for the Ecology Continuum subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.ecologycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
