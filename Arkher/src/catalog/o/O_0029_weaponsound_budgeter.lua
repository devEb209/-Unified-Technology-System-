-- ARKHER SYSTEM O.0029 :: Weapon Sound Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0029"
	S.key = "arkher.audio.weaponsound.voice_budget"
	S.name = "Weapon Sound Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Weapon Sound"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.weaponsound.music_sequencer" }
	S.tags = { "o", "weaponsound", "budgeter", "audio" }
	S.description = "Weapon Sound Voice Budget: voice slots allocated by priority and audibility for the Weapon Sound subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.weaponsound.voice_budget", total = 301, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
