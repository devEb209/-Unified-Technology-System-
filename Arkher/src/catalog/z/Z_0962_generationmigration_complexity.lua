-- ARKHER SYSTEM Z.0962 :: Generation Migration Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0962"
	S.key = "arkher.origin.generationmigration.complexity_governance"
	S.name = "Generation Migration Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.reality_layering" }
	S.tags = { "z", "generationmigration", "complexity", "origin" }
	S.description = "Generation Migration Complexity Governance: measured scene cost turned into per-subsystem directives for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.generationmigration.complexity_governance", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
