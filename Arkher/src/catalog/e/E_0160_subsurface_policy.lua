-- ARKHER SYSTEM E.0160 :: Subsurface Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0160"
	S.key = "arkher.material.subsurface.quality_policy"
	S.name = "Subsurface Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Subsurface"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.subsurface.compression_codec" }
	S.tags = { "e", "subsurface", "policy", "material" }
	S.description = "Subsurface Quality Policy: device tier rules for the surface for the Subsurface subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.subsurface.quality_policy", algorithm = "edf", starvationGuard = 17 })
		inst.system = S
		inst.ctx = ctx
