-- ARKHER SYSTEM G.0289 :: Perceptual Metric Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0289"
	S.key = "arkher.neural.perceptual.result_cache"
	S.name = "Perceptual Metric Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perceptual.compute_budget" }
	S.tags = { "g", "perceptual", "cache", "neural" }
	S.description = "Perceptual Metric Result Cache: cached inference results keyed by input for the Perceptual Metric subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.perceptual.result_cache", policy = "lfu", capacity = 125, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
