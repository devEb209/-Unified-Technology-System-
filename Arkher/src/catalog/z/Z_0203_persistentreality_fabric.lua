-- ARKHER SYSTEM Z.0203 :: Persistent Reality State Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0203"
	S.key = "arkher.origin.persistentreality.simulation_fabric"
	S.name = "Persistent Reality State Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.complexity_governance" }
	S.tags = { "z", "persistentreality", "fabric", "origin" }
	S.description = "Persistent Reality State Simulation Fabric: every simulation domain stepped under one budgeted clock for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.persistentreality.simulation_fabric", budgetMs = 4.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
