-- ARKHER SYSTEM N.0426 :: Foliage Motion Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0426"
	S.key = "arkher.vfx.foliagemotion.quality_policy"
	S.name = "Foliage Motion Quality Policy"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.foliagemotion.result_cache" }
	S.tags = { "n", "foliagemotion", "policy", "vfx" }
	S.description = "Foliage Motion Quality Policy: distance and device driven fidelity bands for the Foliage Motion subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.foliagemotion.quality_policy", algorithm = "edf", starvationGuard = 41 })
		inst.system = S
		inst.ctx = ctx
