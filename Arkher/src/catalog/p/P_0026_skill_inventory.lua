-- ARKHER SYSTEM P.0026 :: Skill Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0026"
	S.key = "arkher.play.skill.inventory"
	S.name = "Skill Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Skill"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.skill.attributes" }
	S.tags = { "p", "skill", "inventory", "play" }
	S.description = "Skill Inventory: slots, stacking, weight, equipment and crafting for the Skill subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.skill.inventory", slots = 36, maxWeight = 60 })
		inst.system = S
		inst.ctx = ctx
