-- ARKHER SYSTEM T.0614 :: Safety Alignment Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0614"
	S.key = "arkher.ai.safetyalignment.model_inference"
	S.name = "Safety Alignment Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.safetyalignment.action_planner" }
	S.tags = { "t", "safetyalignment", "inference", "ai" }
	S.description = "Safety Alignment Model Inference: quantized inference with batching and budget for the Safety Alignment subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.safetyalignment.model_inference", seed = 34868 })
		inst.system = S
		inst.ctx = ctx
