-- ARKHER SYSTEM R.0236 :: Interest Management Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0236"
	S.key = "arkher.net.interestmanagement.rate_guard"
	S.name = "Interest Management Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.interestmanagement.interest_streaming" }
	S.tags = { "r", "interestmanagement", "guard", "net" }
	S.description = "Interest Management Rate Guard: token-bucket protection against floods and abuse for the Interest Management subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.interestmanagement.rate_guard", algorithm = "sliding", capacity = 81, refillPerSec = 6, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
