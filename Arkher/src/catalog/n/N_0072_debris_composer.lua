-- ARKHER SYSTEM N.0072 :: Debris Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0072"
	S.key = "arkher.vfx.debris.effect_composition"
	S.name = "Debris Effect Composition"
	S.category = "N"
	S.family = "VFX"
	S.area = "Debris"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.debris.effect_graph" }
	S.tags = { "n", "debris", "composer", "vfx" }
	S.description = "Debris Effect Composition: blending of several effect signals into one output for the Debris subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.debris.effect_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
