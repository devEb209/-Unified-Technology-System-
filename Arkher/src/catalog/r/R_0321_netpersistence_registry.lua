-- ARKHER SYSTEM R.0321 :: Data Persistence Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0321"
	S.key = "arkher.net.netpersistence.session_registry"
	S.name = "Data Persistence Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netpersistence.rate_guard" }
	S.tags = { "r", "netpersistence", "registry", "net" }
	S.description = "Data Persistence Session Registry: catalogue of sessions, players and their metadata for the Data Persistence subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.netpersistence.session_registry" })
		inst.system = S
		inst.ctx = ctx
