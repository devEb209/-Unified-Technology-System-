-- ARKHER SYSTEM VA.0154 :: Persistence Segment Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0154"
	S.key = "arkher.contworld.persistsegment.simulation_fabric"
	S.name = "Persistence Segment Simulation Fabric"
	S.category = "VA"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.persistsegment.complexity_budget" }
	S.tags = { "va", "persistsegment", "fabric", "contworld" }
	S.description = "Persistence Segment Simulation Fabric: fabric stepping the continuum domains for the Persistence Segment subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.persistsegment.simulation_fabric", budgetMs = 1.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
