-- ARKHER SYSTEM VC.0474 :: VFX Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0474"
	S.key = "arkher.contneural.vfxcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vfxcont.persistent_state" }
	S.tags = { "vc", "vfxcont", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.vfxcont.coherence_guard", window = 142, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
