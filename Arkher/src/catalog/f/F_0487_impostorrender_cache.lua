-- ARKHER SYSTEM F.0487 :: Impostor Rendering Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0487"
	S.key = "arkher.render.impostorrender.pass_cache"
	S.name = "Impostor Rendering Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.impostorrender.render_policy" }
	S.tags = { "f", "impostorrender", "cache", "render" }
	S.description = "Impostor Rendering Pass Cache: reuse of pass results across frames for the Impostor Rendering subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.impostorrender.pass_cache", policy = "ttl", capacity = 182, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
