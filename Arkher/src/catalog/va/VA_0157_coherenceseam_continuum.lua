-- ARKHER SYSTEM VA.0157 :: Coherence Seam Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0157"
	S.key = "arkher.contworld.coherenceseam.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "coherenceseam", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.coherenceseam.infinite_grid", cellSize = 64, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
