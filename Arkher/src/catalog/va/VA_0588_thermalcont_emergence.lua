-- ARKHER SYSTEM VA.0588 :: Thermal Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0588"
	S.key = "arkher.contworld.thermalcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.thermalcont.reality_continuum" }
	S.tags = { "va", "thermalcont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.thermalcont.emergence_continuum", windowSize = 4, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
