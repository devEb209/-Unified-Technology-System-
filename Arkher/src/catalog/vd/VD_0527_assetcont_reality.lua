-- ARKHER SYSTEM VD.0527 :: Asset Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0527"
	S.key = "arkher.contsim.assetcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.assetcont.simulation_fabric" }
	S.tags = { "vd", "assetcont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.assetcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
