-- ARKHER SYSTEM VD.0277 :: Water Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0277"
	S.key = "arkher.contsim.watercont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "watercont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.watercont.infinite_grid", cellSize = 192, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
