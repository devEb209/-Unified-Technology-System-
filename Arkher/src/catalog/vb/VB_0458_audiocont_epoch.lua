-- ARKHER SYSTEM VB.0458 :: Audio Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0458"
	S.key = "arkher.conttime.audiocont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.audiocont.infinite_grid" }
	S.tags = { "vb", "audiocont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.audiocont.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
