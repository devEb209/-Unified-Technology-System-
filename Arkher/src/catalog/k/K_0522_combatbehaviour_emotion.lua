-- ARKHER SYSTEM K.0522 :: Combat Behaviour Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0522"
	S.key = "arkher.npc.combatbehaviour.emotion"
	S.name = "Combat Behaviour Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.combatbehaviour.drive_system" }
	S.tags = { "k", "combatbehaviour", "emotion", "npc" }
	S.description = "Combat Behaviour Emotion: appraisal of events into valence, arousal and mood for the Combat Behaviour subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.combatbehaviour.emotion", inertia = 0.80, decayRate = 0.25, baselineArousal = 0.15 })
		inst.system = S
		inst.ctx = ctx
