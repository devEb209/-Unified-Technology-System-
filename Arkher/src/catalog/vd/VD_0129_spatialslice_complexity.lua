-- ARKHER SYSTEM VD.0129 :: Spatial Slice Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0129"
	S.key = "arkher.contsim.spatialslice.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.spatialslice.world_memory_stream" }
	S.tags = { "vd", "spatialslice", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.spatialslice.complexity_budget", targetMs = 19.0 })
		inst.system = S
		inst.ctx = ctx
