-- ARKHER SYSTEM Z.1046 :: Emergent Quest Generation Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.1046"
	S.key = "arkher.origin.emergentquest.emergence_detection"
	S.name = "Emergent Quest Generation Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentquest.world_memory" }
	S.tags = { "z", "emergentquest", "emergence", "origin" }
	S.description = "Emergent Quest Generation Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Emergent Quest Generation subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.emergentquest.emergence_detection", windowSize = 7, threshold = 1.40, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
