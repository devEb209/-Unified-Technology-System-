-- ARKHER SYSTEM VA.0161 :: Coherence Seam Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0161"
	S.key = "arkher.contworld.coherenceseam.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.coherenceseam.multi-scale_fidelity" }
	S.tags = { "va", "coherenceseam", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.coherenceseam.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
