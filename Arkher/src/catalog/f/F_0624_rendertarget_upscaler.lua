-- ARKHER SYSTEM F.0624 :: Render Target Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0624"
	S.key = "arkher.render.rendertarget.adaptive_resolution"
	S.name = "Render Target Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.rendertarget.temporal_resolve" }
	S.tags = { "f", "rendertarget", "upscaler", "render" }
	S.description = "Render Target Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Render Target subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.rendertarget.adaptive_resolution", targetMs = 16.10, index = 5, sharpness = 0.47 })
		inst.system = S
		inst.ctx = ctx
