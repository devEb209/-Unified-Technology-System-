-- ARKHER SYSTEM Z.0638 :: Intent Driven Authoring Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0638"
	S.key = "arkher.origin.intentauthoring.budget_governor"
	S.name = "Intent Driven Authoring Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.behaviour_analysis" }
	S.tags = { "z", "intentauthoring", "budgeter", "origin" }
	S.description = "Intent Driven Authoring Budget Governor: allocation of a scarce resource across the technology's consumers for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.intentauthoring.budget_governor", total = 119, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
