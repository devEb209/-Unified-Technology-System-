-- ARKHER SYSTEM VA.0426 :: Navigation Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0426"
	S.key = "arkher.contworld.navcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.navcont.persistent_state" }
	S.tags = { "va", "navcont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.navcont.coherence_guard", window = 68, threshold = 0.10 })
		inst.system = S
		inst.ctx = ctx
