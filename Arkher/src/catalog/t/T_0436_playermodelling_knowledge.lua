-- ARKHER SYSTEM T.0436 :: Player Modelling Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0436"
	S.key = "arkher.ai.playermodelling.semantic_knowledge"
	S.name = "Player Modelling Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.playermodelling.intent_understanding" }
	S.tags = { "t", "playermodelling", "knowledge", "ai" }
	S.description = "Player Modelling Semantic Knowledge: typed entities, weighted relations and inferred closure for the Player Modelling subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.playermodelling.semantic_knowledge", dims = 40 })
		inst.system = S
		inst.ctx = ctx
