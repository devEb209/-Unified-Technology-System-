...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Neural DLSS — CORE Stack #0100", size=Vector2.new(640, 420), pos=UDim2.fromOffset(200, 220), parent=parent, icon="◐"})
