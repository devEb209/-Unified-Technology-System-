-- ARKHER SYSTEM T.0506 :: Render Reasoning Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0506"
	S.key = "arkher.ai.renderreasoning.semantic_knowledge"
	S.name = "Render Reasoning Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.renderreasoning.intent_understanding" }
	S.tags = { "t", "renderreasoning", "knowledge", "ai" }
	S.description = "Render Reasoning Semantic Knowledge: typed entities, weighted relations and inferred closure for the Render Reasoning subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.renderreasoning.semantic_knowledge", dims = 48 })
		inst.system = S
		inst.ctx = ctx
