-- ARKHER SYSTEM VB.0051 :: Epoch Frame Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0051"
	S.key = "arkher.conttime.epochframe.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.epochframe.epoch_clock" }
	S.tags = { "vb", "epochframe", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.epochframe.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
