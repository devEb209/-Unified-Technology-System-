-- ARKHER SYSTEM L.0584 :: World History Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0584"
	S.key = "arkher.sim.worldhistory.forecast"
	S.name = "World History Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldhistory.analysis" }
	S.tags = { "l", "worldhistory", "predictor", "sim" }
	S.description = "World History Forecast: prediction of the region's next state for the World History subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.worldhistory.forecast", method = "ema", alpha = 0.39, window = 53 })
		inst.system = S
		inst.ctx = ctx
