-- ARKHER SYSTEM Z.0607 :: Predictive Streaming World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0607"
	S.key = "arkher.origin.predictivestreaming.world_architect"
	S.name = "Predictive Streaming World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictivestreaming.emergence_detection" }
	S.tags = { "z", "predictivestreaming", "architect", "origin" }
	S.description = "Predictive Streaming World Architect: hierarchical world composition with conserved budgets for the Predictive Streaming subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.predictivestreaming.world_architect", budget = 800, seed = 20032 })
		inst.system = S
		inst.ctx = ctx
