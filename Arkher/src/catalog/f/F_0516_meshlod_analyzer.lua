-- ARKHER SYSTEM F.0516 :: Mesh LOD Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0516"
	S.key = "arkher.render.meshlod.frame_analysis"
	S.name = "Mesh LOD Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Mesh LOD"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.meshlod.pass_cache" }
	S.tags = { "f", "meshlod", "analyzer", "render" }
	S.description = "Mesh LOD Frame Analysis: per-pass cost analysis and outlier detection for the Mesh LOD subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.meshlod.frame_analysis", window = 120, buckets = 16, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
