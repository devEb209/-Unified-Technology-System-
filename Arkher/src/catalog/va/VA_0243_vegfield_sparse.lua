-- ARKHER SYSTEM VA.0243 :: Vegetation Field Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0243"
	S.key = "arkher.contworld.vegfield.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vegfield.epoch_clock" }
	S.tags = { "va", "vegfield", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.vegfield.sparse_residency", capacity = 256, pageBytes = 3072 })
		inst.system = S
		inst.ctx = ctx
