-- ARKHER SYSTEM I.0262 :: Foot Placement IK Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0262"
	S.key = "arkher.anim.footik.clip_sampling"
	S.name = "Foot Placement IK Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.footik.skeleton" }
	S.tags = { "i", "footik", "clip", "anim" }
	S.description = "Foot Placement IK Clip Sampling: keyframe tracks sampled, retimed and evented for the Foot Placement IK subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.footik.clip_sampling", duration = 2.00, loop = false })
		inst.system = S
		inst.ctx = ctx
