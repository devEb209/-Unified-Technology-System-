--!strict
-- Continuum World — ANIMATION Stack #0295
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Continuum World — ANIMATION Stack #0295", size=Vector2.new(640, 420), pos=UDim2.fromOffset(335, 155), parent=parent, icon="✈"})
