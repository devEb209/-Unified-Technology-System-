-- ARKHER SYSTEM Q.0347 :: Safe Area Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0347"
	S.key = "arkher.ui.safearea.usability_analysis"
	S.name = "Safe Area Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Safe Area"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.safearea.frame_budget" }
	S.tags = { "q", "safearea", "analyzer", "ui" }
	S.description = "Safe Area Usability Analysis: reachability, latency and abandonment analysis for the Safe Area subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.safearea.usability_analysis", window = 199, buckets = 11, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
