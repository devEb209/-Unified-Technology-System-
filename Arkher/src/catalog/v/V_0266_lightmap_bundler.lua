-- ARKHER SYSTEM V.0266 :: Lightmap Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0266"
	S.key = "arkher.asset.lightmap.bundling"
	S.name = "Lightmap Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lightmap.import" }
	S.tags = { "v", "lightmap", "bundler", "asset" }
	S.description = "Lightmap Bundling: size-bounded packing, manifests and delta patches for the Lightmap subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.lightmap.bundling", maxBundleBytes = 262144 })
		inst.system = S
		inst.ctx = ctx
