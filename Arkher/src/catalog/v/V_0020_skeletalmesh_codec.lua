-- ARKHER SYSTEM V.0020 :: Skeletal Mesh Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0020"
	S.key = "arkher.asset.skeletalmesh.compression_codec"
	S.name = "Skeletal Mesh Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.skeletalmesh.streaming_residency" }
	S.tags = { "v", "skeletalmesh", "codec", "asset" }
	S.description = "Skeletal Mesh Compression Codec: compact encoding, diffing and checksum of asset payloads for the Skeletal Mesh subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.skeletalmesh.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
