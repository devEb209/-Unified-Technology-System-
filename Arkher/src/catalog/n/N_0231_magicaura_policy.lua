-- ARKHER SYSTEM N.0231 :: Magic Aura Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0231"
	S.key = "arkher.vfx.magicaura.quality_policy"
	S.name = "Magic Aura Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Magic Aura"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.magicaura.result_cache" }
	S.tags = { "n", "magicaura", "policy", "vfx" }
	S.description = "Magic Aura Quality Policy: distance and device driven fidelity bands for the Magic Aura subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.magicaura.quality_policy", algorithm = "wfq", starvationGuard = 30 })
		inst.system = S
		inst.ctx = ctx
