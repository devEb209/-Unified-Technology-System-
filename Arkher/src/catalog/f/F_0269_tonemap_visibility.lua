-- ARKHER SYSTEM F.0269 :: Tonemapping Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0269"
	S.key = "arkher.render.tonemap.visibility_set"
	S.name = "Tonemapping Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Tonemapping"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.tonemap.view_and_culling" }
	S.tags = { "f", "tonemap", "visibility", "render" }
	S.description = "Tonemapping Visibility Set: cell, portal and occluder visibility for the Tonemapping subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.tonemap.visibility_set", maxDepth = 2 })
		inst.system = S
		inst.ctx = ctx
