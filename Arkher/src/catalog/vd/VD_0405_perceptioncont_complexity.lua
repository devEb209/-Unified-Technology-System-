-- ARKHER SYSTEM VD.0405 :: Perception Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0405"
	S.key = "arkher.contsim.perceptioncont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.perceptioncont.world_memory_stream" }
	S.tags = { "vd", "perceptioncont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.perceptioncont.complexity_budget", targetMs = 19.0 })
		inst.system = S
		inst.ctx = ctx
