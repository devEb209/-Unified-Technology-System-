-- ARKHER SYSTEM VA.0010 :: World Grid Cell Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0010"
	S.key = "arkher.contworld.worldcell.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldcell.complexity_budget" }
	S.tags = { "va", "worldcell", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.worldcell.simulation_fabric", budgetMs = 4.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
