-- ARKHER SYSTEM VB.0487 :: Lighting Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0487"
	S.key = "arkher.conttime.lightcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lightcont.coherence_guard" }
	S.tags = { "vb", "lightcont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.lightcont.neural_field", dims = 16, hidden = 12, seed = 8817 })
		inst.system = S
		inst.ctx = ctx
