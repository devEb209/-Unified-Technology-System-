-- ARKHER SYSTEM F.0637 :: Memory Aliasing Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0637"
	S.key = "arkher.render.memaliasing.temporal_resolve"
	S.name = "Memory Aliasing Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.memaliasing.probe_volume" }
	S.tags = { "f", "memaliasing", "temporal", "render" }
	S.description = "Memory Aliasing Temporal Resolve: history reprojection with neighbourhood clamping for the Memory Aliasing subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.memaliasing.temporal_resolve", feedback = 0.89, phase = 8 })
		inst.system = S
		inst.ctx = ctx
