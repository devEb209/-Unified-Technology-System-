-- ARKHER SYSTEM Q.0395 :: Accessibility Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0395"
	S.key = "arkher.ui.uiaccessibility.usability_analysis"
	S.name = "Accessibility Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uiaccessibility.frame_budget" }
	S.tags = { "q", "uiaccessibility", "analyzer", "ui" }
	S.description = "Accessibility Usability Analysis: reachability, latency and abandonment analysis for the Accessibility subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.uiaccessibility.usability_analysis", window = 122, buckets = 10, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
