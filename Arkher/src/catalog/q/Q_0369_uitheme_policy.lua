-- ARKHER SYSTEM Q.0369 :: Theme Accessibility Policy
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0369"
	S.key = "arkher.ui.uitheme.accessibility_policy"
	S.name = "Theme Accessibility Policy"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Theme"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uitheme.interaction_ledger" }
	S.tags = { "q", "uitheme", "policy", "ui" }
	S.description = "Theme Accessibility Policy: rules enforcing contrast, target size and motion limits for the Theme subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ui.uitheme.accessibility_policy", algorithm = "roundrobin", starvationGuard = 40 })
		inst.system = S
		inst.ctx = ctx
