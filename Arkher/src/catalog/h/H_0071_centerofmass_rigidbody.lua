-- ARKHER SYSTEM H.0071 :: Center Of Mass Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0071"
	S.key = "arkher.physics.centerofmass.body_dynamics"
	S.name = "Center Of Mass Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "centerofmass", "rigidbody", "physics" }
	S.description = "Center Of Mass Body Dynamics: integration, impulses, damping and sleeping of a body for the Center Of Mass subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.centerofmass.body_dynamics", mass = 1.00, radius = 0.30, restitution = 0.40, friction = 0.40, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
