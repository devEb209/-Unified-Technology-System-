-- ARKHER SYSTEM P.0150 :: Crafting Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0150"
	S.key = "arkher.play.crafting.rule_pipeline"
	S.name = "Crafting Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Crafting"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.crafting.state_machine" }
	S.tags = { "p", "crafting", "pipeline", "play" }
	S.description = "Crafting Rule Pipeline: ordered rules applied to every gameplay event for the Crafting subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.crafting.rule_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
