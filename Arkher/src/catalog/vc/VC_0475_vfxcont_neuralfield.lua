-- ARKHER SYSTEM VC.0475 :: VFX Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0475"
	S.key = "arkher.contneural.vfxcont.neural_field"
	S.name = "VFX Continuum Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vfxcont.coherence_guard" }
	S.tags = { "vc", "vfxcont", "neuralfield", "contneural" }
	S.description = "VFX Continuum Neural Field: neural field encoding and reconstruction for the VFX Continuum subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.vfxcont.neural_field", dims = 20, hidden = 16, seed = 57846 })
		inst.system = S
		inst.ctx = ctx
