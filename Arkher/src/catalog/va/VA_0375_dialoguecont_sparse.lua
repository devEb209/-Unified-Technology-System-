-- ARKHER SYSTEM VA.0375 :: Dialogue Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0375"
	S.key = "arkher.contworld.dialoguecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.dialoguecont.epoch_clock" }
	S.tags = { "va", "dialoguecont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.dialoguecont.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
