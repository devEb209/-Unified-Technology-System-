-- ARKHER SYSTEM VB.0249 :: Vegetation Field Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0249"
	S.key = "arkher.conttime.vegfield.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vegfield.world_memory_stream" }
	S.tags = { "vb", "vegfield", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.vegfield.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
