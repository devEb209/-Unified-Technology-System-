-- ARKHER SYSTEM P.0065 :: Progression State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0065"
	S.key = "arkher.play.progression.state_machine"
	S.name = "Progression State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Progression"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.progression.combat_resolution" }
	S.tags = { "p", "progression", "orchestrator", "play" }
	S.description = "Progression State Machine: the phase machine that drives this gameplay loop for the Progression subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.progression.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
