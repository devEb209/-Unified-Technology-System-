-- ARKHER SYSTEM Z.0866 :: Multi Scale Simulation Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0866"
	S.key = "arkher.origin.multiscale.emergence_detection"
	S.name = "Multi Scale Simulation Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.world_memory" }
	S.tags = { "z", "multiscale", "emergence", "origin" }
	S.description = "Multi Scale Simulation Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.multiscale.emergence_detection", windowSize = 4, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
