-- ARKHER SYSTEM VC.0037 :: Continuum Stream Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0037"
	S.key = "arkher.contneural.continuumstream.infinite_grid"
	S.name = "Continuum Stream Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "continuumstream", "continuum", "contneural" }
	S.description = "Continuum Stream Infinite Grid: seamless paging of the infinite world grid for the Continuum Stream subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.continuumstream.infinite_grid", cellSize = 128, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
