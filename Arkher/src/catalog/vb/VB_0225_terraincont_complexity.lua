-- ARKHER SYSTEM VB.0225 :: Terrain Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0225"
	S.key = "arkher.conttime.terraincont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.terraincont.world_memory_stream" }
	S.tags = { "vb", "terraincont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.terraincont.complexity_budget", targetMs = 19.0 })
		inst.system = S
		inst.ctx = ctx
