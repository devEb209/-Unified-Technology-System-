-- ARKHER SYSTEM K.0393 :: Plan Execution Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0393"
	S.key = "arkher.npc.planexecution.mind_network"
	S.name = "Plan Execution Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "planexecution", "mindnet", "npc" }
	S.description = "Plan Execution Mind Network: the learned policy that turns perception into a decision for the Plan Execution subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.planexecution.mind_network", inputs = 9, hidden = 7, seed = 37723, learningRate = 0.065, exploration = 0.035 })
		inst.system = S
		inst.ctx = ctx
