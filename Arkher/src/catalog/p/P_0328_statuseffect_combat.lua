-- ARKHER SYSTEM P.0328 :: Status Effect Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0328"
	S.key = "arkher.play.statuseffect.combat_resolution"
	S.name = "Status Effect Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.statuseffect.objectives" }
	S.tags = { "p", "statuseffect", "combat", "play" }
	S.description = "Status Effect Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Status Effect subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.statuseffect.combat_resolution", seed = 17014, armourK = 140, critMultiplier = 2.50 })
		inst.system = S
		inst.ctx = ctx
