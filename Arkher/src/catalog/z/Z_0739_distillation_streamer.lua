-- ARKHER SYSTEM Z.0739 :: Knowledge Distillation Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0739"
	S.key = "arkher.origin.distillation.residency_streaming"
	S.name = "Knowledge Distillation Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.distillation.budget_governor" }
	S.tags = { "z", "distillation", "streamer", "origin" }
	S.description = "Knowledge Distillation Residency Streaming: distance-driven residency of the technology's workload for the Knowledge Distillation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.distillation.residency_streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
