-- ARKHER SYSTEM Z.0603 :: Predictive Streaming Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0603"
	S.key = "arkher.origin.predictivestreaming.simulation_fabric"
	S.name = "Predictive Streaming Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictivestreaming.complexity_governance" }
	S.tags = { "z", "predictivestreaming", "fabric", "origin" }
	S.description = "Predictive Streaming Simulation Fabric: every simulation domain stepped under one budgeted clock for the Predictive Streaming subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.predictivestreaming.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
