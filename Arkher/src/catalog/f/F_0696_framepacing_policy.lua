-- ARKHER SYSTEM F.0696 :: Frame Pacing Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0696"
	S.key = "arkher.render.framepacing.render_policy"
	S.name = "Frame Pacing Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Frame Pacing"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepacing.draw_budget" }
	S.tags = { "f", "framepacing", "policy", "render" }
	S.description = "Frame Pacing Render Policy: device tier rules for the frame for the Frame Pacing subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.framepacing.render_policy", algorithm = "wfq", starvationGuard = 50 })
		inst.system = S
		inst.ctx = ctx
