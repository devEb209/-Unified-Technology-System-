-- ARKHER SYSTEM VA.0222 :: Terrain Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0222"
	S.key = "arkher.contworld.terraincont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.terraincont.persistent_state" }
	S.tags = { "va", "terraincont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.terraincont.coherence_guard", window = 95, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
