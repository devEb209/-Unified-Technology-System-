-- ARKHER SYSTEM I.0178 :: Crossfade Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0178"
	S.key = "arkher.anim.crossfade.playback_pipeline"
	S.name = "Crossfade Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Crossfade"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crossfade.event_ledger" }
	S.tags = { "i", "crossfade", "pipeline", "anim" }
	S.description = "Crossfade Playback Pipeline: ordered sample, blend, ik and output stages for the Crossfade subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.crossfade.playback_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
