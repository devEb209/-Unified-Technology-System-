-- ARKHER SYSTEM L.0102 :: Reification Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0102"
	S.key = "arkher.sim.reification.aggregate_cache"
	S.name = "Reification Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.reification.fidelity_policy" }
	S.tags = { "l", "reification", "cache", "sim" }
	S.description = "Reification Aggregate Cache: reuse of expensive aggregate computations for the Reification subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.reification.aggregate_cache", policy = "lru", capacity = 86, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
