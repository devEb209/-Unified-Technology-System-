-- ARKHER SYSTEM VD.0210 :: Biome Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0210"
	S.key = "arkher.contsim.biomecont.coherence_guard"
	S.name = "Biome Continuum Coherence Guard"
	S.category = "VD"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.biomecont.persistent_state" }
	S.tags = { "vd", "biomecont", "coherence", "contsim" }
	S.description = "Biome Continuum Coherence Guard: seam coherence and drift supervision for the Biome Continuum subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.biomecont.coherence_guard", window = 117, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
