...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="NASA SRTM — CORE Stack #0260", size=Vector2.new(680, 420), pos=UDim2.fromOffset(280, 80), parent=parent, icon="↻"})
