-- ARKHER SYSTEM V.0201 :: Terrain Asset Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0201"
	S.key = "arkher.asset.terrainasset.size_budget"
	S.name = "Terrain Asset Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.terrainasset.compression_codec" }
	S.tags = { "v", "terrainasset", "budgeter", "asset" }
	S.description = "Terrain Asset Size Budget: byte budget shared between competing asset classes for the Terrain Asset subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.terrainasset.size_budget", total = 103, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
