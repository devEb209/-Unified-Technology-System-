-- ARKHER SYSTEM O.0237 :: Adaptive Music Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0237"
	S.key = "arkher.audio.adaptivemusic.playback_policy"
	S.name = "Adaptive Music Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.adaptivemusic.compression_codec" }
	S.tags = { "o", "adaptivemusic", "policy", "audio" }
	S.description = "Adaptive Music Playback Policy: rules choosing what may be heard right now for the Adaptive Music subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.adaptivemusic.playback_policy", algorithm = "roundrobin", starvationGuard = 56 })
		inst.system = S
		inst.ctx = ctx
