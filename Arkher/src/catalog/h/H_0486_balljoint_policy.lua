-- ARKHER SYSTEM H.0486 :: Ball Joint Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0486"
	S.key = "arkher.physics.balljoint.simulation_policy"
	S.name = "Ball Joint Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Ball Joint"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.balljoint.budget_governor" }
	S.tags = { "h", "balljoint", "policy", "physics" }
	S.description = "Ball Joint Simulation Policy: device tier rules for substeps, iterations and sleep for the Ball Joint subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.balljoint.simulation_policy", algorithm = "roundrobin", starvationGuard = 20 })
		inst.system = S
		inst.ctx = ctx
