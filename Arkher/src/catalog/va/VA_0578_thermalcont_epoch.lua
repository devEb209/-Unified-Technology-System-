-- ARKHER SYSTEM VA.0578 :: Thermal Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0578"
	S.key = "arkher.contworld.thermalcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.thermalcont.infinite_grid" }
	S.tags = { "va", "thermalcont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.thermalcont.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
