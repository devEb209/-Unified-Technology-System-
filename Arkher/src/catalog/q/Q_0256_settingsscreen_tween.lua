-- ARKHER SYSTEM Q.0256 :: Settings Screen Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0256"
	S.key = "arkher.ui.settingsscreen.transition"
	S.name = "Settings Screen Transition"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.settingsscreen.input_mapping" }
	S.tags = { "q", "settingsscreen", "tween", "ui" }
	S.description = "Settings Screen Transition: eased, delayed, looped and sequenced motion for the Settings Screen subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.settingsscreen.transition", timeScale = 1.07 })
		inst.system = S
		inst.ctx = ctx
