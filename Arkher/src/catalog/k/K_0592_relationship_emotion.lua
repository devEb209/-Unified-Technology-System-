-- ARKHER SYSTEM K.0592 :: Relationship Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0592"
	S.key = "arkher.npc.relationship.emotion"
	S.name = "Relationship Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.relationship.drive_system" }
	S.tags = { "k", "relationship", "emotion", "npc" }
	S.description = "Relationship Emotion: appraisal of events into valence, arousal and mood for the Relationship subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.relationship.emotion", inertia = 0.91, decayRate = 0.26, baselineArousal = 0.26 })
		inst.system = S
		inst.ctx = ctx
