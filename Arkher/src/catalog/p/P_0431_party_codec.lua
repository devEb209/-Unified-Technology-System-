-- ARKHER SYSTEM P.0431 :: Party Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0431"
	S.key = "arkher.play.party.save_codec"
	S.name = "Party Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Party"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.party.content_registry" }
	S.tags = { "p", "party", "codec", "play" }
	S.description = "Party Save Codec: persistence, diffing and checksum of gameplay state for the Party subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.party.save_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
