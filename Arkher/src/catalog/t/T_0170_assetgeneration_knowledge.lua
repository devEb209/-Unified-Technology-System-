-- ARKHER SYSTEM T.0170 :: Asset Generation Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0170"
	S.key = "arkher.ai.assetgeneration.semantic_knowledge"
	S.name = "Asset Generation Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.assetgeneration.intent_understanding" }
	S.tags = { "t", "assetgeneration", "knowledge", "ai" }
	S.description = "Asset Generation Semantic Knowledge: typed entities, weighted relations and inferred closure for the Asset Generation subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.assetgeneration.semantic_knowledge", dims = 32 })
		inst.system = S
		inst.ctx = ctx
