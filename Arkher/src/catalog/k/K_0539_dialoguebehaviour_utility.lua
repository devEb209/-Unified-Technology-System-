-- ARKHER SYSTEM K.0539 :: Dialogue Behaviour Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0539"
	S.key = "arkher.npc.dialoguebehaviour.utility_reasoning"
	S.name = "Dialogue Behaviour Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dialoguebehaviour.reactive_behaviour" }
	S.tags = { "k", "dialoguebehaviour", "utility", "npc" }
	S.description = "Dialogue Behaviour Utility Reasoning: scored option selection with response curves for the Dialogue Behaviour subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.dialoguebehaviour.utility_reasoning", momentum = 0.16 })
		inst.system = S
		inst.ctx = ctx
