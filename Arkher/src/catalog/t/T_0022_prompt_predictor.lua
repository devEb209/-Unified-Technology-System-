-- ARKHER SYSTEM T.0022 :: Prompt Understanding Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0022"
	S.key = "arkher.ai.prompt.outcome_prediction"
	S.name = "Prompt Understanding Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.prompt.decision_policy" }
	S.tags = { "t", "prompt", "predictor", "ai" }
	S.description = "Prompt Understanding Outcome Prediction: forecasting the result before the work is done for the Prompt Understanding subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.prompt.outcome_prediction", method = "linear", alpha = 0.17, window = 111 })
		inst.system = S
		inst.ctx = ctx
