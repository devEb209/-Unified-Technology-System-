-- ARKHER SYSTEM Z.0650 :: Natural Language Engine Control Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0650"
	S.key = "arkher.origin.languagecontrol.self_critique"
	S.name = "Natural Language Engine Control Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.languagecontrol.intent_bridge" }
	S.tags = { "z", "languagecontrol", "critic", "origin" }
	S.description = "Natural Language Engine Control Self Critique: weighted judgement of the technology's own output for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.languagecontrol.self_critique", passMark = 0.75, reviseMark = 0.45, seed = 80555 })
		inst.system = S
		inst.ctx = ctx
