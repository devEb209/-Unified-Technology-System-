-- ARKHER SYSTEM E.0514 :: Parameter Animation Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0514"
	S.key = "arkher.material.paramanim.texture_sampling"
	S.name = "Parameter Animation Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.paramanim.shading_graph" }
	S.tags = { "e", "paramanim", "sampler", "material" }
	S.description = "Parameter Animation Texture Sampling: atlas packing, mip chain and filtered sampling for the Parameter Animation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.paramanim.texture_sampling", atlasSize = 128, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
