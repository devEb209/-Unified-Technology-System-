-- ARKHER SYSTEM O.0234 :: Adaptive Music Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0234"
	S.key = "arkher.audio.adaptivemusic.streaming"
	S.name = "Adaptive Music Streaming"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.adaptivemusic.voice_budget" }
	S.tags = { "o", "adaptivemusic", "streamer", "audio" }
	S.description = "Adaptive Music Streaming: distance-driven residency of audio assets for the Adaptive Music subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.adaptivemusic.streaming", radius = 280, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
