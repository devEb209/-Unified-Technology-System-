-- ARKHER SYSTEM V.0112 :: Voice Line Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0112"
	S.key = "arkher.asset.voiceline.asset_registry"
	S.name = "Voice Line Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.voiceline.cook_pipeline" }
	S.tags = { "v", "voiceline", "registry", "asset" }
	S.description = "Voice Line Asset Registry: catalogue of every asset, its tags and its metadata for the Voice Line subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.voiceline.asset_registry" })
		inst.system = S
		inst.ctx = ctx
