-- ARKHER SYSTEM Z.0304 :: Causality Ledger Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0304"
	S.key = "arkher.origin.causality.autonomous_pipeline"
	S.name = "Causality Ledger Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.simulation_fabric" }
	S.tags = { "z", "causality", "autopipeline", "origin" }
	S.description = "Causality Ledger Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.causality.autonomous_pipeline", maxIterations = 5 })
		inst.system = S
		inst.ctx = ctx
