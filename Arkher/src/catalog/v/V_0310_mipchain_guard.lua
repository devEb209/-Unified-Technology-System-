-- ARKHER SYSTEM V.0310 :: Mip Chain Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0310"
	S.key = "arkher.asset.mipchain.validation_guard"
	S.name = "Mip Chain Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.mipchain.size_budget" }
	S.tags = { "v", "mipchain", "guard", "asset" }
	S.description = "Mip Chain Validation Guard: rate limiting and capability checks on the import path for the Mip Chain subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.mipchain.validation_guard", algorithm = "sliding", capacity = 39, refillPerSec = 24, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
