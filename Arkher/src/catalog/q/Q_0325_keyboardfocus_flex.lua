-- ARKHER SYSTEM Q.0325 :: Keyboard Focus Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0325"
	S.key = "arkher.ui.keyboardfocus.responsive_layout"
	S.name = "Keyboard Focus Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "keyboardfocus", "flex", "ui" }
	S.description = "Keyboard Focus Responsive Layout: flex solving with safe areas, weights and breakpoints for the Keyboard Focus subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.keyboardfocus.responsive_layout", width = 510, height = 1024, scale = 0.93 })
		inst.system = S
		inst.ctx = ctx
