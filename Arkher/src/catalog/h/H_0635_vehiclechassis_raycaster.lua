-- ARKHER SYSTEM H.0635 :: Vehicle Chassis Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0635"
	S.key = "arkher.physics.vehiclechassis.query"
	S.name = "Vehicle Chassis Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.vehiclechassis.constraint_solver" }
	S.tags = { "h", "vehiclechassis", "raycaster", "physics" }
	S.description = "Vehicle Chassis Query: rays, sweeps and overlaps against the simulation for the Vehicle Chassis subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.vehiclechassis.query", cellSize = 32 })
		inst.system = S
		inst.ctx = ctx
