-- ARKHER SYSTEM O.0005 :: Footstep Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0005"
	S.key = "arkher.audio.footstep.voice_budget"
	S.name = "Footstep Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Footstep"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.footstep.music_sequencer" }
	S.tags = { "o", "footstep", "budgeter", "audio" }
	S.description = "Footstep Voice Budget: voice slots allocated by priority and audibility for the Footstep subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.footstep.voice_budget", total = 220, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
