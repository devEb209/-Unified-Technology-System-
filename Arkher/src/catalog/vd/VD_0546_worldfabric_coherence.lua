-- ARKHER SYSTEM VD.0546 :: World Fabric Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0546"
	S.key = "arkher.contsim.worldfabric.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldfabric.persistent_state" }
	S.tags = { "vd", "worldfabric", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.worldfabric.coherence_guard", window = 104, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
