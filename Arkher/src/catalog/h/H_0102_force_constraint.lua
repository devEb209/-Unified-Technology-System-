-- ARKHER SYSTEM H.0102 :: Force Accumulator Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0102"
	S.key = "arkher.physics.force.constraint_solver"
	S.name = "Force Accumulator Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.force.contact_generation" }
	S.tags = { "h", "force", "constraint", "physics" }
	S.description = "Force Accumulator Constraint Solver: sequential impulses, friction, joints and warm starting for the Force Accumulator subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.force.constraint_solver", iterations = 11, baumgarte = 0.17, warmStart = true })
		inst.system = S
		inst.ctx = ctx
