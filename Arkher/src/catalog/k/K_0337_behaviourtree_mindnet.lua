-- ARKHER SYSTEM K.0337 :: Behaviour Tree Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0337"
	S.key = "arkher.npc.behaviourtree.mind_network"
	S.name = "Behaviour Tree Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "behaviourtree", "mindnet", "npc" }
	S.description = "Behaviour Tree Mind Network: the learned policy that turns perception into a decision for the Behaviour Tree subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.behaviourtree.mind_network", inputs = 7, hidden = 8, seed = 95069, learningRate = 0.095, exploration = 0.045 })
		inst.system = S
		inst.ctx = ctx
