-- ARKHER SYSTEM VD.0164 :: Coherence Seam World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0164"
	S.key = "arkher.contsim.coherenceseam.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.coherenceseam.neural_field" }
	S.tags = { "vd", "coherenceseam", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.coherenceseam.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
