-- ARKHER SYSTEM VA.0613 :: Occupancy Map Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0613"
	S.key = "arkher.contworld.occupancymap.infinite_grid"
	S.name = "Occupancy Map Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "occupancymap", "continuum", "contworld" }
	S.description = "Occupancy Map Infinite Grid: seamless paging of the infinite world grid for the Occupancy Map subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.occupancymap.infinite_grid", cellSize = 96, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
