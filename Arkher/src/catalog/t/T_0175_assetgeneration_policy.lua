-- ARKHER SYSTEM T.0175 :: Asset Generation Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0175"
	S.key = "arkher.ai.assetgeneration.decision_policy"
	S.name = "Asset Generation Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.assetgeneration.reasoning_graph" }
	S.tags = { "t", "assetgeneration", "policy", "ai" }
	S.description = "Asset Generation Decision Policy: ordered rules deciding what the agent does next for the Asset Generation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.assetgeneration.decision_policy", algorithm = "roundrobin", starvationGuard = 20 })
		inst.system = S
		inst.ctx = ctx
