-- ARKHER SYSTEM VB.0480 :: VFX Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0480"
	S.key = "arkher.conttime.vfxcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vfxcont.reality_continuum" }
	S.tags = { "vb", "vfxcont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.vfxcont.emergence_continuum", windowSize = 6, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
