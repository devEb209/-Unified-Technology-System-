-- ARKHER SYSTEM W.0166 :: Cutscene Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0166"
	S.key = "arkher.cine.cutscene.frame_budget"
	S.name = "Cutscene Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Cutscene"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cutscene.event_ledger" }
	S.tags = { "w", "cutscene", "budgeter", "cine" }
	S.description = "Cutscene Frame Budget: per-frame cost budget for the cinematic systems for the Cutscene subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.cutscene.frame_budget", total = 138, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
