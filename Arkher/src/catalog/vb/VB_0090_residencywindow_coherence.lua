-- ARKHER SYSTEM VB.0090 :: Residency Window Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0090"
	S.key = "arkher.conttime.residencywindow.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.residencywindow.persistent_state" }
	S.tags = { "vb", "residencywindow", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.residencywindow.coherence_guard", window = 90, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
