-- ARKHER SYSTEM Q.0170 :: Head Up Display Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0170"
	S.key = "arkher.ui.hud.widget_tree"
	S.name = "Head Up Display Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.hud.responsive_layout" }
	S.tags = { "q", "hud", "widget", "ui" }
	S.description = "Head Up Display Widget Tree: retained widget nodes, properties, bindings and rendering for the Head Up Display subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.hud.widget_tree", theme = "highcontrast", scale = 1.07 })
		inst.system = S
		inst.ctx = ctx
