-- ARKHER SYSTEM G.0015 :: Temporal Reconstruction Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0015"
	S.key = "arkher.neural.temporalrecon.inference_core"
	S.name = "Temporal Reconstruction Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "temporalrecon", "inference", "neural" }
	S.description = "Temporal Reconstruction Inference Core: dense network forward pass and training for the Temporal Reconstruction subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.temporalrecon.inference_core", seed = 36459 })
		inst.system = S
		inst.ctx = ctx
