-- ARKHER SYSTEM K.0054 :: Reward Model Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0054"
	S.key = "arkher.npc.rewardmodel.daily_schedule"
	S.name = "Reward Model Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.rewardmodel.social_relations" }
	S.tags = { "k", "rewardmodel", "schedule", "npc" }
	S.description = "Reward Model Daily Schedule: hour-by-hour routine with priority interruptions for the Reward Model subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.rewardmodel.daily_schedule", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
