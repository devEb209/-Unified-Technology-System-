-- ARKHER SYSTEM VA.0512 :: Material Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0512"
	S.key = "arkher.contworld.materialcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.materialcont.neural_field" }
	S.tags = { "va", "materialcont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.materialcont.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
