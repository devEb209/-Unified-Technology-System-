-- ARKHER SYSTEM Z.0523 :: Migration Dynamics Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0523"
	S.key = "arkher.origin.migrationdynamics.simulation_fabric"
	S.name = "Migration Dynamics Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.migrationdynamics.complexity_governance" }
	S.tags = { "z", "migrationdynamics", "fabric", "origin" }
	S.description = "Migration Dynamics Simulation Fabric: every simulation domain stepped under one budgeted clock for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.migrationdynamics.simulation_fabric", budgetMs = 3.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
