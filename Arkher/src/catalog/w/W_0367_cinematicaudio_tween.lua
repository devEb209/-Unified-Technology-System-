-- ARKHER SYSTEM W.0367 :: Cinematic Audio Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0367"
	S.key = "arkher.cine.cinematicaudio.motion_tween"
	S.name = "Cinematic Audio Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinematicaudio.playback_orchestrator" }
	S.tags = { "w", "cinematicaudio", "tween", "cine" }
	S.description = "Cinematic Audio Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Cinematic Audio subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.cinematicaudio.motion_tween", timeScale = 0.98 })
		inst.system = S
		inst.ctx = ctx
