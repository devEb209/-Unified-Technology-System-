-- ARKHER SYSTEM F.0309 :: Depth Of Field Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0309"
	S.key = "arkher.render.dof.frame_graph"
	S.name = "Depth Of Field Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "dof", "framegraph", "render" }
	S.description = "Depth Of Field Frame Graph: declared passes, culling, ordering and aliasing for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.dof.frame_graph", budgetMs = 10.00 })
		inst.system = S
		inst.ctx = ctx
