-- ARKHER SYSTEM F.0003 :: Frame Pipeline Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0003"
	S.key = "arkher.render.framepipeline.visibility_set"
	S.name = "Frame Pipeline Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepipeline.view_and_culling" }
	S.tags = { "f", "framepipeline", "visibility", "render" }
	S.description = "Frame Pipeline Visibility Set: cell, portal and occluder visibility for the Frame Pipeline subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.framepipeline.visibility_set", maxDepth = 2 })
		inst.system = S
		inst.ctx = ctx
