-- ARKHER SYSTEM E.0327 :: Moisture Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0327"
	S.key = "arkher.material.moisture.analysis"
	S.name = "Moisture Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Moisture"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.moisture.instance_cache" }
	S.tags = { "e", "moisture", "analyzer", "material" }
	S.description = "Moisture Analysis: cost, redundancy and outlier analysis for the Moisture subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.moisture.analysis", window = 207, buckets = 19, threshold = 4.90 })
		inst.system = S
		inst.ctx = ctx
