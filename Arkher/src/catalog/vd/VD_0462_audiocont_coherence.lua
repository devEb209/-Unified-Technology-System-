-- ARKHER SYSTEM VD.0462 :: Audio Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0462"
	S.key = "arkher.contsim.audiocont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.audiocont.persistent_state" }
	S.tags = { "vd", "audiocont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.audiocont.coherence_guard", window = 123, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
