-- ARKHER SYSTEM O.0087 :: Narration Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0087"
	S.key = "arkher.audio.narration.spatialization"
	S.name = "Narration Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Narration"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.narration.mixer_bus" }
	S.tags = { "o", "narration", "spatialaudio", "audio" }
	S.description = "Narration Spatialization: distance attenuation, panning, occlusion and doppler for the Narration subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.narration.spatialization", model = "inverse", refDistance = 3, maxDistance = 120, rolloff = 0.92, maxVoices = 12 })
		inst.system = S
		inst.ctx = ctx
