-- ARKHER SYSTEM T.0608 :: Safety Alignment Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0608"
	S.key = "arkher.ai.safetyalignment.reasoning_graph"
	S.name = "Safety Alignment Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.safetyalignment.world_architect" }
	S.tags = { "t", "safetyalignment", "graph", "ai" }
	S.description = "Safety Alignment Reasoning Graph: relationship modelling and shortest-path reasoning for the Safety Alignment subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.safetyalignment.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
