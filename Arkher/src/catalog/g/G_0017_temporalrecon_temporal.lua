-- ARKHER SYSTEM G.0017 :: Temporal Reconstruction Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0017"
	S.key = "arkher.neural.temporalrecon.temporal_history"
	S.name = "Temporal Reconstruction Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.temporalrecon.feature_extraction" }
	S.tags = { "g", "temporalrecon", "temporal", "neural" }
	S.description = "Temporal Reconstruction Temporal History: history buffers reused across frames for the Temporal Reconstruction subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.temporalrecon.temporal_history", feedback = 0.93, phase = 8 })
		inst.system = S
		inst.ctx = ctx
