-- ARKHER SYSTEM H.0674 :: Shapecast Query Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0674"
	S.key = "arkher.physics.shapecast.collision_shape"
	S.name = "Shapecast Query Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.shapecast.body_dynamics" }
	S.tags = { "h", "shapecast", "collider", "physics" }
	S.description = "Shapecast Query Collision Shape: shape bounds, support mapping and closest points for the Shapecast Query subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.shapecast.collision_shape", shape = "sphere", radius = 1.00, height = 1.80, layer = "character" })
		inst.system = S
		inst.ctx = ctx
