-- ARKHER SYSTEM F.0492 :: HLOD View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0492"
	S.key = "arkher.render.hlod.view_and_culling"
	S.name = "HLOD View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "HLOD"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.hlod.frame_graph" }
	S.tags = { "f", "hlod", "camera", "render" }
	S.description = "HLOD View And Culling: view state, frustum culling and screen-size LOD for the HLOD subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.hlod.view_and_culling", width = 1340, height = 1260, fov = 1.2900, far = 1800 })
		inst.system = S
		inst.ctx = ctx
