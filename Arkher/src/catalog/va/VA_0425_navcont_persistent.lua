-- ARKHER SYSTEM VA.0425 :: Navigation Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0425"
	S.key = "arkher.contworld.navcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.navcont.multi-scale_fidelity" }
	S.tags = { "va", "navcont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.navcont.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
