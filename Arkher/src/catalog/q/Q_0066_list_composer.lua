-- ARKHER SYSTEM Q.0066 :: List Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0066"
	S.key = "arkher.ui.list.theme_composition"
	S.name = "List Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "List"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.list.navigation_graph" }
	S.tags = { "q", "list", "composer", "ui" }
	S.description = "List Theme Composition: blending of theme signals into the final appearance for the List subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.list.theme_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
