-- ARKHER SYSTEM K.0265 :: Vision Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0265"
	S.key = "arkher.npc.vision.thinking_budget"
	S.name = "Vision Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.vision.daily_schedule" }
	S.tags = { "k", "vision", "budgeter", "npc" }
	S.description = "Vision Thinking Budget: allocation of per-frame thinking time across NPCs for the Vision subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.vision.thinking_budget", total = 88, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
