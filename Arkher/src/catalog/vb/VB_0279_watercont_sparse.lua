-- ARKHER SYSTEM VB.0279 :: Water Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0279"
	S.key = "arkher.conttime.watercont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.watercont.epoch_clock" }
	S.tags = { "vb", "watercont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.watercont.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
