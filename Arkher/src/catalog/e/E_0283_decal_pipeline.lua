-- ARKHER SYSTEM E.0283 :: Decal Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0283"
	S.key = "arkher.material.decal.authoring_pipeline"
	S.name = "Decal Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Decal"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.decal.analysis" }
	S.tags = { "e", "decal", "pipeline", "material" }
	S.description = "Decal Authoring Pipeline: ordered authoring and bake stages for the Decal subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.decal.authoring_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
