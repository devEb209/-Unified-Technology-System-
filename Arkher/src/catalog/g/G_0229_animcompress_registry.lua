-- ARKHER SYSTEM G.0229 :: Animation Compression Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0229"
	S.key = "arkher.neural.animcompress.model_registry"
	S.name = "Animation Compression Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.animcompress.reconstruction" }
	S.tags = { "g", "animcompress", "registry", "neural" }
	S.description = "Animation Compression Model Registry: named models and their lifecycle for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.animcompress.model_registry" })
		inst.system = S
		inst.ctx = ctx
