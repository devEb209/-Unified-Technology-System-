-- ARKHER SYSTEM P.0161 :: Gathering State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0161"
	S.key = "arkher.play.gathering.state_machine"
	S.name = "Gathering State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Gathering"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.gathering.combat_resolution" }
	S.tags = { "p", "gathering", "orchestrator", "play" }
	S.description = "Gathering State Machine: the phase machine that drives this gameplay loop for the Gathering subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.gathering.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
