-- ARKHER SYSTEM E.0591 :: Material Migration Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0591"
	S.key = "arkher.material.migration.variant_registry"
	S.name = "Material Migration Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.migration.procedural_detail" }
	S.tags = { "e", "migration", "registry", "material" }
	S.description = "Material Migration Variant Registry: named variants and their lifecycle for the Material Migration subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.migration.variant_registry" })
		inst.system = S
		inst.ctx = ctx
