-- ARKHER SYSTEM Z.0156 :: Autonomous Development Pipeline Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0156"
	S.key = "arkher.origin.autodevpipeline.governance_policy"
	S.name = "Autonomous Development Pipeline Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodevpipeline.signal_composition" }
	S.tags = { "z", "autodevpipeline", "policy", "origin" }
	S.description = "Autonomous Development Pipeline Governance Policy: ordered rules governing when the technology may act for the Autonomous Development Pipeline subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.autodevpipeline.governance_policy", algorithm = "wfq", starvationGuard = 26 })
		inst.system = S
		inst.ctx = ctx
