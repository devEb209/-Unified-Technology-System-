-- ARKHER SYSTEM J.0218 :: Outfit Composition Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0218"
	S.key = "arkher.character.outfit.budget_governor"
	S.name = "Outfit Composition Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.outfit.variant_registry" }
	S.tags = { "j", "outfit", "budgeter", "character" }
	S.description = "Outfit Composition Budget Governor: per-character cost allocation in a crowd for the Outfit Composition subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.outfit.budget_governor", total = 104, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
