-- ARKHER SYSTEM I.0323 :: Spine Bend Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0323"
	S.key = "arkher.anim.spinebend.quality_policy"
	S.name = "Spine Bend Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Spine Bend"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.spinebend.pose_cache" }
	S.tags = { "i", "spinebend", "policy", "anim" }
	S.description = "Spine Bend Quality Policy: device tier rules for rate, bones and solvers for the Spine Bend subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.spinebend.quality_policy", algorithm = "roundrobin", starvationGuard = 60 })
		inst.system = S
		inst.ctx = ctx
