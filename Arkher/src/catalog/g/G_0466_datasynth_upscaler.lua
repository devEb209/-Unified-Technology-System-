-- ARKHER SYSTEM G.0466 :: Training Data Synthesis Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0466"
	S.key = "arkher.neural.datasynth.reconstruction"
	S.name = "Training Data Synthesis Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.datasynth.temporal_history" }
	S.tags = { "g", "datasynth", "upscaler", "neural" }
	S.description = "Training Data Synthesis Reconstruction: resolution ladder and image reconstruction for the Training Data Synthesis subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.datasynth.reconstruction", targetMs = 16.10, index = 5, sharpness = 0.43 })
		inst.system = S
		inst.ctx = ctx
