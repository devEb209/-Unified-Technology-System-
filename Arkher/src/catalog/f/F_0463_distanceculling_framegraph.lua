-- ARKHER SYSTEM F.0463 :: Distance Culling Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0463"
	S.key = "arkher.render.distanceculling.frame_graph"
	S.name = "Distance Culling Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "distanceculling", "framegraph", "render" }
	S.description = "Distance Culling Frame Graph: declared passes, culling, ordering and aliasing for the Distance Culling subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.distanceculling.frame_graph", budgetMs = 11.00 })
		inst.system = S
		inst.ctx = ctx
