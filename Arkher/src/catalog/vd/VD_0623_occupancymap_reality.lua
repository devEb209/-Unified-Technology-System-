-- ARKHER SYSTEM VD.0623 :: Occupancy Map Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0623"
	S.key = "arkher.contsim.occupancymap.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.occupancymap.simulation_fabric" }
	S.tags = { "vd", "occupancymap", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.occupancymap.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
