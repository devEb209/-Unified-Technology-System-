-- ARKHER SYSTEM K.0156 :: Safety Drive Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0156"
	S.key = "arkher.npc.safetydrive.memory"
	S.name = "Safety Drive Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.safetydrive.mind_network" }
	S.tags = { "k", "safetydrive", "memory", "npc" }
	S.description = "Safety Drive Memory: episodic memory with decay, recall and consolidation for the Safety Drive subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.safetydrive.memory", capacity = 40, decayRate = 0.020, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
