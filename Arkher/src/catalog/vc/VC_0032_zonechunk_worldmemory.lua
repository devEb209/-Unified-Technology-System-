-- ARKHER SYSTEM VC.0032 :: Zone Chunk World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0032"
	S.key = "arkher.contneural.zonechunk.world_memory_stream"
	S.name = "Zone Chunk World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.zonechunk.neural_field" }
	S.tags = { "vc", "zonechunk", "worldmemory", "contneural" }
	S.description = "Zone Chunk World Memory Stream: world memory continuum over epochs for the Zone Chunk subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.zonechunk.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
