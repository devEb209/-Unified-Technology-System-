-- ARKHER SYSTEM L.0108 :: Settlement Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0108"
	S.key = "arkher.sim.settlement.economy"
	S.name = "Settlement Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.settlement.ecology" }
	S.tags = { "l", "settlement", "economy", "sim" }
	S.description = "Settlement Economy: stock, production, demand, price discovery and trade for the Settlement subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.settlement.economy", elasticity = 0.44 })
		inst.system = S
		inst.ctx = ctx
