-- ARKHER SYSTEM W.0145 :: Point Of View Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0145"
	S.key = "arkher.cine.pointofview.sequence_timeline"
	S.name = "Point Of View Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "pointofview", "timeline", "cine" }
	S.description = "Point Of View Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Point Of View subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.pointofview.sequence_timeline", duration = 10.0, rate = 1.02 })
		inst.system = S
		inst.ctx = ctx
