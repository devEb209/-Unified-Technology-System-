-- ARKHER SYSTEM H.0581 :: Buoyancy Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0581"
	S.key = "arkher.physics.buoyancy.vehicle"
	S.name = "Buoyancy Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Buoyancy"
	S.aspect = "Vehicle"
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.buoyancy.character_motion" }
	S.tags = { "h", "buoyancy", "vehicle", "physics" }
	S.description = "Buoyancy Vehicle: suspension, drivetrain, steering and tire friction for the Buoyancy subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.buoyancy.vehicle", mass = 2000, wheelbase = 2.50, track = 2.10, maxRpm = 5900 })
		inst.system = S
		inst.ctx = ctx
