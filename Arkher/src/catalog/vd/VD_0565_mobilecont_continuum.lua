-- ARKHER SYSTEM VD.0565 :: Mobile Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0565"
	S.key = "arkher.contsim.mobilecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "mobilecont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.mobilecont.infinite_grid", cellSize = 96, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
