-- ARKHER SYSTEM T.0217 :: Character Generation Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0217"
	S.key = "arkher.ai.charactergeneration.decision_policy"
	S.name = "Character Generation Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.charactergeneration.reasoning_graph" }
	S.tags = { "t", "charactergeneration", "policy", "ai" }
	S.description = "Character Generation Decision Policy: ordered rules deciding what the agent does next for the Character Generation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.charactergeneration.decision_policy", algorithm = "wfq", starvationGuard = 22 })
		inst.system = S
		inst.ctx = ctx
