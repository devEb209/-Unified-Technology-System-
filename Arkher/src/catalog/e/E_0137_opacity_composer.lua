-- ARKHER SYSTEM E.0137 :: Opacity Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0137"
	S.key = "arkher.material.opacity.layer_composition"
	S.name = "Opacity Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Opacity"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.opacity.definition" }
	S.tags = { "e", "opacity", "composer", "material" }
	S.description = "Opacity Layer Composition: ordered layer composition with blend rules for the Opacity subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.opacity.layer_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
