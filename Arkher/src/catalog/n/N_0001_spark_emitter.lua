-- ARKHER SYSTEM N.0001 :: Spark Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0001"
	S.key = "arkher.vfx.spark.emission"
	S.name = "Spark Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spark"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "spark", "emitter", "vfx" }
	S.description = "Spark Emission: shaped, rate and burst emission of new particles for the Spark subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.spark.emission", shape = "sphere", rate = 33, speed = 4.30, life = 2.10, budget = 448, seed = 36133 })
		inst.system = S
		inst.ctx = ctx
