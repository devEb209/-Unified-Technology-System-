-- ARKHER SYSTEM I.0122 :: Playback Speed Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0122"
	S.key = "arkher.anim.playbackspeed.physical_blend"
	S.name = "Playback Speed Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.playbackspeed.inverse_kinematics" }
	S.tags = { "i", "playbackspeed", "ragdoll", "anim" }
	S.description = "Playback Speed Physical Blend: physical bones blended against the animated pose for the Playback Speed subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.playbackspeed.physical_blend", blendSpeed = 4.30 })
		inst.system = S
		inst.ctx = ctx
