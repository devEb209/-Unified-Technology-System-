-- ARKHER SYSTEM W.0167 :: Cutscene Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0167"
	S.key = "arkher.cine.cutscene.sequence_analysis"
	S.name = "Cutscene Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Cutscene"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cutscene.frame_budget" }
	S.tags = { "w", "cutscene", "analyzer", "cine" }
	S.description = "Cutscene Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Cutscene subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.cutscene.sequence_analysis", window = 112, buckets = 8, threshold = 4.40 })
		inst.system = S
		inst.ctx = ctx
