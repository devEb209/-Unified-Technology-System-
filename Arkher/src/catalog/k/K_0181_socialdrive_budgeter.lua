-- ARKHER SYSTEM K.0181 :: Social Drive Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0181"
	S.key = "arkher.npc.socialdrive.thinking_budget"
	S.name = "Social Drive Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.socialdrive.daily_schedule" }
	S.tags = { "k", "socialdrive", "budgeter", "npc" }
	S.description = "Social Drive Thinking Budget: allocation of per-frame thinking time across NPCs for the Social Drive subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.socialdrive.thinking_budget", total = 93, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
