-- ARKHER SYSTEM Z.0690 :: Auto Test Synthesis Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0690"
	S.key = "arkher.origin.autotest.self_critique"
	S.name = "Auto Test Synthesis Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autotest.intent_bridge" }
	S.tags = { "z", "autotest", "critic", "origin" }
	S.description = "Auto Test Synthesis Self Critique: weighted judgement of the technology's own output for the Auto Test Synthesis subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.autotest.self_critique", passMark = 0.70, reviseMark = 0.40, seed = 33510 })
		inst.system = S
		inst.ctx = ctx
