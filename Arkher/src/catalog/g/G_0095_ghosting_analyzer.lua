-- ARKHER SYSTEM G.0095 :: Ghosting Suppression Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0095"
	S.key = "arkher.neural.ghosting.error_analysis"
	S.name = "Ghosting Suppression Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ghosting.heuristic_policy" }
	S.tags = { "g", "ghosting", "analyzer", "neural" }
	S.description = "Ghosting Suppression Error Analysis: residual and drift analysis for the Ghosting Suppression subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.ghosting.error_analysis", window = 115, buckets = 15, threshold = 2.70 })
		inst.system = S
		inst.ctx = ctx
