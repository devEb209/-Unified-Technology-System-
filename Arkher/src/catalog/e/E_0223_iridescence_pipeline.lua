-- ARKHER SYSTEM E.0223 :: Iridescence Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0223"
	S.key = "arkher.material.iridescence.authoring_pipeline"
	S.name = "Iridescence Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Iridescence"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.iridescence.analysis" }
	S.tags = { "e", "iridescence", "pipeline", "material" }
	S.description = "Iridescence Authoring Pipeline: ordered authoring and bake stages for the Iridescence subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.iridescence.authoring_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
