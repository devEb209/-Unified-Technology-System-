-- ARKHER SYSTEM VD.0454 :: Animation Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0454"
	S.key = "arkher.contsim.animcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.animcont.complexity_budget" }
	S.tags = { "vd", "animcont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.animcont.simulation_fabric", budgetMs = 3.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
