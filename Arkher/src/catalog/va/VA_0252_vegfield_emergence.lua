-- ARKHER SYSTEM VA.0252 :: Vegetation Field Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0252"
	S.key = "arkher.contworld.vegfield.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vegfield.reality_continuum" }
	S.tags = { "va", "vegfield", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.vegfield.emergence_continuum", windowSize = 6, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
