-- ARKHER SYSTEM VB.0305 :: Weather Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0305"
	S.key = "arkher.conttime.weathercont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.weathercont.multi-scale_fidelity" }
	S.tags = { "vb", "weathercont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.weathercont.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
