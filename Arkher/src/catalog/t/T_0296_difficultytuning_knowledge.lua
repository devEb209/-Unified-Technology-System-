-- ARKHER SYSTEM T.0296 :: Difficulty Tuning Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0296"
	S.key = "arkher.ai.difficultytuning.semantic_knowledge"
	S.name = "Difficulty Tuning Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.difficultytuning.intent_understanding" }
	S.tags = { "t", "difficultytuning", "knowledge", "ai" }
	S.description = "Difficulty Tuning Semantic Knowledge: typed entities, weighted relations and inferred closure for the Difficulty Tuning subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.difficultytuning.semantic_knowledge", dims = 48 })
		inst.system = S
		inst.ctx = ctx
