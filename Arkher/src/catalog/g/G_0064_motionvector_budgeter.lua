-- ARKHER SYSTEM G.0064 :: Motion Vector Estimation Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0064"
	S.key = "arkher.neural.motionvector.compute_budget"
	S.name = "Motion Vector Estimation Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.motionvector.quality_predictor" }
	S.tags = { "g", "motionvector", "budgeter", "neural" }
	S.description = "Motion Vector Estimation Compute Budget: inference time budget allocation for the Motion Vector Estimation subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.motionvector.compute_budget", total = 305, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
