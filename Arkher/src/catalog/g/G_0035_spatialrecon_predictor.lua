-- ARKHER SYSTEM G.0035 :: Spatial Reconstruction Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0035"
	S.key = "arkher.neural.spatialrecon.quality_predictor"
	S.name = "Spatial Reconstruction Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.spatialrecon.weight_codec" }
	S.tags = { "g", "spatialrecon", "predictor", "neural" }
	S.description = "Spatial Reconstruction Quality Predictor: predicted quality and cost of a setting for the Spatial Reconstruction subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.spatialrecon.quality_predictor", method = "markov", alpha = 0.23, window = 85 })
		inst.system = S
		inst.ctx = ctx
