-- ARKHER SYSTEM H.0108 :: Force Accumulator Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0108"
	S.key = "arkher.physics.force.simulation_policy"
	S.name = "Force Accumulator Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.force.budget_governor" }
	S.tags = { "h", "force", "policy", "physics" }
	S.description = "Force Accumulator Simulation Policy: device tier rules for substeps, iterations and sleep for the Force Accumulator subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.force.simulation_policy", algorithm = "roundrobin", starvationGuard = 40 })
		inst.system = S
		inst.ctx = ctx
