-- ARKHER SYSTEM T.0151 :: Tool Use Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0151"
	S.key = "arkher.ai.tooluse.action_planner"
	S.name = "Tool Use Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.tooluse.utility_selection" }
	S.tags = { "t", "tooluse", "planner", "ai" }
	S.description = "Tool Use Action Planner: goal-oriented action planning over preconditions for the Tool Use subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.tooluse.action_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
