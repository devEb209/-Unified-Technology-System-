-- ARKHER SYSTEM O.0104 :: Crowd Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0104"
	S.key = "arkher.audio.crowd.compression_codec"
	S.name = "Crowd Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Crowd"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.crowd.asset_registry" }
	S.tags = { "o", "crowd", "codec", "audio" }
	S.description = "Crowd Compression Codec: payload encoding of audio state and events for the Crowd subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.crowd.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
