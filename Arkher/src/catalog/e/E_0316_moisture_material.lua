-- ARKHER SYSTEM E.0316 :: Moisture Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0316"
	S.key = "arkher.material.moisture.definition"
	S.name = "Moisture Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Moisture"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "moisture", "material", "material" }
	S.description = "Moisture Definition: layered PBR definition resolved into parameters for the Moisture subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.moisture.definition", texelBudget = 786432 })
		inst.system = S
		inst.ctx = ctx
