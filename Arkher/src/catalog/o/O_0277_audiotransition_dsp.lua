-- ARKHER SYSTEM O.0277 :: Transition DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0277"
	S.key = "arkher.audio.audiotransition.dsp_chain"
	S.name = "Transition DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Transition"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "audiotransition", "dsp", "audio" }
	S.description = "Transition DSP Chain: biquad filtering, delay, envelope and soft clipping for the Transition subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.audiotransition.dsp_chain", sampleRate = 22050, filter = "notch", cutoff = 6000, q = 0.690 })
		inst.system = S
		inst.ctx = ctx
