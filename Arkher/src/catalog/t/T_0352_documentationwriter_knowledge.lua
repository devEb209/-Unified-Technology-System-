-- ARKHER SYSTEM T.0352 :: Documentation Writer Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0352"
	S.key = "arkher.ai.documentationwriter.semantic_knowledge"
	S.name = "Documentation Writer Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.documentationwriter.intent_understanding" }
	S.tags = { "t", "documentationwriter", "knowledge", "ai" }
	S.description = "Documentation Writer Semantic Knowledge: typed entities, weighted relations and inferred closure for the Documentation Writer subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.documentationwriter.semantic_knowledge", dims = 32 })
		inst.system = S
		inst.ctx = ctx
