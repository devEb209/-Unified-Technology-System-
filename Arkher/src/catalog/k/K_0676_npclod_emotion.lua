-- ARKHER SYSTEM K.0676 :: NPC LOD Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0676"
	S.key = "arkher.npc.npclod.emotion"
	S.name = "NPC LOD Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npclod.drive_system" }
	S.tags = { "k", "npclod", "emotion", "npc" }
	S.description = "NPC LOD Emotion: appraisal of events into valence, arousal and mood for the NPC LOD subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.npclod.emotion", inertia = 0.89, decayRate = 0.44, baselineArousal = 0.24 })
		inst.system = S
		inst.ctx = ctx
