-- ARKHER SYSTEM VB.0610 :: Seam Lattice Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0610"
	S.key = "arkher.conttime.seamlattice.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.seamlattice.complexity_budget" }
	S.tags = { "vb", "seamlattice", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.seamlattice.simulation_fabric", budgetMs = 3.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
