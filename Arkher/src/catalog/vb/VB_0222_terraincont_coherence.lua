-- ARKHER SYSTEM VB.0222 :: Terrain Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0222"
	S.key = "arkher.conttime.terraincont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.terraincont.persistent_state" }
	S.tags = { "vb", "terraincont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.terraincont.coherence_guard", window = 107, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
