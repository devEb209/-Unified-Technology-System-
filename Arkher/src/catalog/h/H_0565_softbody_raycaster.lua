-- ARKHER SYSTEM H.0565 :: Soft Body Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0565"
	S.key = "arkher.physics.softbody.query"
	S.name = "Soft Body Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Soft Body"
	S.aspect = "Query"
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.softbody.constraint_solver" }
	S.tags = { "h", "softbody", "raycaster", "physics" }
	S.description = "Soft Body Query: rays, sweeps and overlaps against the simulation for the Soft Body subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.softbody.query", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
