-- ARKHER SYSTEM G.0162 :: Geometry Detail Prediction Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0162"
	S.key = "arkher.neural.geodetail.compute_budget"
	S.name = "Geometry Detail Prediction Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.geodetail.quality_predictor" }
	S.tags = { "g", "geodetail", "budgeter", "neural" }
	S.description = "Geometry Detail Prediction Compute Budget: inference time budget allocation for the Geometry Detail Prediction subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.geodetail.compute_budget", total = 88, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
