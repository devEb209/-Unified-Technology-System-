-- ARKHER SYSTEM T.0131 :: Skill Library World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0131"
	S.key = "arkher.ai.skilllibrary.world_architect"
	S.name = "Skill Library World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.skilllibrary.self_critique" }
	S.tags = { "t", "skilllibrary", "architect", "ai" }
	S.description = "Skill Library World Architect: composition of a whole world plan with conserved budgets for the Skill Library subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.skilllibrary.world_architect", budget = 1500, seed = 81339 })
		inst.system = S
		inst.ctx = ctx
