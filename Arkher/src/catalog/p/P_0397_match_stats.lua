-- ARKHER SYSTEM P.0397 :: Match Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0397"
	S.key = "arkher.play.match.attributes"
	S.name = "Match Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Match"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "match", "stats", "play" }
	S.description = "Match Attributes: base values, layered modifiers and derived statistics for the Match subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.match.attributes" })
		inst.system = S
		inst.ctx = ctx
