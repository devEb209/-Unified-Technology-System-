-- ARKHER SYSTEM W.0231 :: Fade Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0231"
	S.key = "arkher.cine.fade.colour_grade"
	S.name = "Fade Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Fade"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.fade.camera_rig" }
	S.tags = { "w", "fade", "grade", "cine" }
	S.description = "Fade Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Fade subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.fade.colour_grade", exposure = 0.04, contrast = 1.09, saturation = 1.19, toneMap = "linear" })
		inst.system = S
		inst.ctx = ctx
