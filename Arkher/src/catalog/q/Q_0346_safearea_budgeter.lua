-- ARKHER SYSTEM Q.0346 :: Safe Area Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0346"
	S.key = "arkher.ui.safearea.frame_budget"
	S.name = "Safe Area Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Safe Area"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.safearea.accessibility_policy" }
	S.tags = { "q", "safearea", "budgeter", "ui" }
	S.description = "Safe Area Frame Budget: per-frame layout and draw budget for the interface for the Safe Area subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.safearea.frame_budget", total = 184, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
