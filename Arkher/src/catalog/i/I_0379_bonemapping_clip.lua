-- ARKHER SYSTEM I.0379 :: Bone Mapping Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0379"
	S.key = "arkher.anim.bonemapping.clip_sampling"
	S.name = "Bone Mapping Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bone Mapping"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonemapping.skeleton" }
	S.tags = { "i", "bonemapping", "clip", "anim" }
	S.description = "Bone Mapping Clip Sampling: keyframe tracks sampled, retimed and evented for the Bone Mapping subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.bonemapping.clip_sampling", duration = 2.50, loop = true })
		inst.system = S
		inst.ctx = ctx
