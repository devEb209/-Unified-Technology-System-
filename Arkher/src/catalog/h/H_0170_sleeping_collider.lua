-- ARKHER SYSTEM H.0170 :: Sleeping Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0170"
	S.key = "arkher.physics.sleeping.collision_shape"
	S.name = "Sleeping Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Sleeping"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sleeping.body_dynamics" }
	S.tags = { "h", "sleeping", "collider", "physics" }
	S.description = "Sleeping Collision Shape: shape bounds, support mapping and closest points for the Sleeping subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.sleeping.collision_shape", shape = "sphere", radius = 2.50, height = 2.10, layer = "world" })
		inst.system = S
		inst.ctx = ctx
