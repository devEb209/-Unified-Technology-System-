-- ARKHER SYSTEM L.0262 :: Season Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0262"
	S.key = "arkher.sim.season.route_network"
	S.name = "Season Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.season.region_graph" }
	S.tags = { "l", "season", "network", "sim" }
	S.description = "Season Route Network: roads, rivers and routes between settlements for the Season subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.season.route_network" })
		inst.system = S
		inst.ctx = ctx
