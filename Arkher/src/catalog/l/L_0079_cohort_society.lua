-- ARKHER SYSTEM L.0079 :: Cohort Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0079"
	S.key = "arkher.sim.cohort.society"
	S.name = "Cohort Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.cohort.economy" }
	S.tags = { "l", "cohort", "society", "sim" }
	S.description = "Cohort Society: relations, factions, reputation and cohesion of the region for the Cohort subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.cohort.society", decayRate = 0.008, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
