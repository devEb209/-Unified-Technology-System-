-- ARKHER SYSTEM W.0208 :: Montage Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0208"
	S.key = "arkher.cine.montage.shot_composition"
	S.name = "Montage Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Montage"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.montage.colour_grade" }
	S.tags = { "w", "montage", "composer", "cine" }
	S.description = "Montage Shot Composition: blending of the signals that make up the final shot for the Montage subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.montage.shot_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
