-- ARKHER SYSTEM VB.0632 :: Interest Field World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0632"
	S.key = "arkher.conttime.interestfield.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.interestfield.neural_field" }
	S.tags = { "vb", "interestfield", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.interestfield.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
