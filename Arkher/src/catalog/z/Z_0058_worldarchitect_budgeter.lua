-- ARKHER SYSTEM Z.0058 :: Singularity World Architect Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0058"
	S.key = "arkher.origin.worldarchitect.budget_governor"
	S.name = "Singularity World Architect Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.behaviour_analysis" }
	S.tags = { "z", "worldarchitect", "budgeter", "origin" }
	S.description = "Singularity World Architect Budget Governor: allocation of a scarce resource across the technology's consumers for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.worldarchitect.budget_governor", total = 211, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
