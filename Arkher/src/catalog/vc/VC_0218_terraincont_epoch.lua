-- ARKHER SYSTEM VC.0218 :: Terrain Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0218"
	S.key = "arkher.contneural.terraincont.epoch_clock"
	S.name = "Terrain Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.terraincont.infinite_grid" }
	S.tags = { "vc", "terraincont", "epoch", "contneural" }
	S.description = "Terrain Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Terrain Continuum subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.terraincont.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
