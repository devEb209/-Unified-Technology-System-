-- ARKHER SYSTEM Z.0518 :: Economic Emergence Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0518"
	S.key = "arkher.origin.economicemergence.budget_governor"
	S.name = "Economic Emergence Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.economicemergence.behaviour_analysis" }
	S.tags = { "z", "economicemergence", "budgeter", "origin" }
	S.description = "Economic Emergence Budget Governor: allocation of a scarce resource across the technology's consumers for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.economicemergence.budget_governor", total = 82, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
