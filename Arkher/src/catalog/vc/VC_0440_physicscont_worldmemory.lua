-- ARKHER SYSTEM VC.0440 :: Physics Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0440"
	S.key = "arkher.contneural.physicscont.world_memory_stream"
	S.name = "Physics Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.physicscont.neural_field" }
	S.tags = { "vc", "physicscont", "worldmemory", "contneural" }
	S.description = "Physics Continuum World Memory Stream: world memory continuum over epochs for the Physics Continuum subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.physicscont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
