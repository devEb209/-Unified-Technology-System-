-- ARKHER SYSTEM K.0483 :: Follow Behaviour Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0483"
	S.key = "arkher.npc.followbehaviour.utility_reasoning"
	S.name = "Follow Behaviour Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.followbehaviour.reactive_behaviour" }
	S.tags = { "k", "followbehaviour", "utility", "npc" }
	S.description = "Follow Behaviour Utility Reasoning: scored option selection with response curves for the Follow Behaviour subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.followbehaviour.utility_reasoning", momentum = 0.13 })
		inst.system = S
		inst.ctx = ctx
