-- ARKHER SYSTEM W.0078 :: Dolly Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0078"
	S.key = "arkher.cine.dolly.playback_orchestrator"
	S.name = "Dolly Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dolly"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dolly.cut_policy" }
	S.tags = { "w", "dolly", "orchestrator", "cine" }
	S.description = "Dolly Playback Orchestrator: the state machine that drives a cinematic from start to end for the Dolly subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.dolly.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
