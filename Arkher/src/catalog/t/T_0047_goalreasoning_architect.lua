-- ARKHER SYSTEM T.0047 :: Goal Reasoning World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0047"
	S.key = "arkher.ai.goalreasoning.world_architect"
	S.name = "Goal Reasoning World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.goalreasoning.self_critique" }
	S.tags = { "t", "goalreasoning", "architect", "ai" }
	S.description = "Goal Reasoning World Architect: composition of a whole world plan with conserved budgets for the Goal Reasoning subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.goalreasoning.world_architect", budget = 1400, seed = 30468 })
		inst.system = S
		inst.ctx = ctx
