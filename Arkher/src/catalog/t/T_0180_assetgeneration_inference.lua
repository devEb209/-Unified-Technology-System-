-- ARKHER SYSTEM T.0180 :: Asset Generation Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0180"
	S.key = "arkher.ai.assetgeneration.model_inference"
	S.name = "Asset Generation Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.assetgeneration.action_planner" }
	S.tags = { "t", "assetgeneration", "inference", "ai" }
	S.description = "Asset Generation Model Inference: quantized inference with batching and budget for the Asset Generation subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.assetgeneration.model_inference", seed = 67130 })
		inst.system = S
		inst.ctx = ctx
