-- ARKHER SYSTEM W.0243 :: Dissolve Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0243"
	S.key = "arkher.cine.dissolve.colour_grade"
	S.name = "Dissolve Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dissolve"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dissolve.camera_rig" }
	S.tags = { "w", "dissolve", "grade", "cine" }
	S.description = "Dissolve Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Dissolve subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.dissolve.colour_grade", exposure = 0.01, contrast = 1.06, saturation = 1.16, toneMap = "filmic" })
		inst.system = S
		inst.ctx = ctx
