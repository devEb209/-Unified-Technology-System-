-- ARKHER SYSTEM Z.0083 :: Semantic World Graph Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0083"
	S.key = "arkher.origin.semanticworld.simulation_fabric"
	S.name = "Semantic World Graph Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticworld.complexity_governance" }
	S.tags = { "z", "semanticworld", "fabric", "origin" }
	S.description = "Semantic World Graph Simulation Fabric: every simulation domain stepped under one budgeted clock for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.semanticworld.simulation_fabric", budgetMs = 3.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
