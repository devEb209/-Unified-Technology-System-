-- ARKHER SYSTEM W.0029 :: Scene Cut Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0029"
	S.key = "arkher.cine.scenecut.cut_policy"
	S.name = "Scene Cut Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Scene Cut"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.scenecut.shot_composition" }
	S.tags = { "w", "scenecut", "policy", "cine" }
	S.description = "Scene Cut Cut Policy: rules deciding when the sequence cuts and to what for the Scene Cut subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.scenecut.cut_policy", algorithm = "wfq", starvationGuard = 62 })
		inst.system = S
		inst.ctx = ctx
