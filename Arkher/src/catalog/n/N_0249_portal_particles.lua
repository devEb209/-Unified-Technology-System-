-- ARKHER SYSTEM N.0249 :: Portal Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0249"
	S.key = "arkher.vfx.portal.particle_simulation"
	S.name = "Portal Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Portal"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.portal.emission" }
	S.tags = { "n", "portal", "particles", "vfx" }
	S.description = "Portal Particle Simulation: pooled integration of position, velocity, colour and life for the Portal subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.portal.particle_simulation", capacity = 256, drag = 0.19, bounce = 0.44, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
