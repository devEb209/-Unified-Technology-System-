-- ARKHER SYSTEM VB.0485 :: Lighting Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0485"
	S.key = "arkher.conttime.lightcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lightcont.multi-scale_fidelity" }
	S.tags = { "vb", "lightcont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.lightcont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
