-- ARKHER SYSTEM VB.0145 :: Persistence Segment Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0145"
	S.key = "arkher.conttime.persistsegment.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "persistsegment", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.persistsegment.infinite_grid", cellSize = 64, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
