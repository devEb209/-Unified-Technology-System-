-- ARKHER SYSTEM E.0476 :: Material Instance Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0476"
	S.key = "arkher.material.instance.instance_cache"
	S.name = "Material Instance Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.instance.quality_policy" }
	S.tags = { "e", "instance", "cache", "material" }
	S.description = "Material Instance Instance Cache: resolved-parameter cache keyed by context for the Material Instance subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.instance.instance_cache", policy = "lru", capacity = 382, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
