-- ARKHER SYSTEM G.0003 :: Neural Upscaling Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0003"
	S.key = "arkher.neural.neuralupscale.temporal_history"
	S.name = "Neural Upscaling Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuralupscale.feature_extraction" }
	S.tags = { "g", "neuralupscale", "temporal", "neural" }
	S.description = "Neural Upscaling Temporal History: history buffers reused across frames for the Neural Upscaling subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.neuralupscale.temporal_history", feedback = 0.85, phase = 8 })
		inst.system = S
		inst.ctx = ctx
