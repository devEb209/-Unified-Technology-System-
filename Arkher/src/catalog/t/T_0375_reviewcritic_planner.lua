-- ARKHER SYSTEM T.0375 :: Review Critic Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0375"
	S.key = "arkher.ai.reviewcritic.action_planner"
	S.name = "Review Critic Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.reviewcritic.utility_selection" }
	S.tags = { "t", "reviewcritic", "planner", "ai" }
	S.description = "Review Critic Action Planner: goal-oriented action planning over preconditions for the Review Critic subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.reviewcritic.action_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
