-- ARKHER SYSTEM Z.0786 :: Attention Driven Detail Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0786"
	S.key = "arkher.origin.attentiondetail.emergence_detection"
	S.name = "Attention Driven Detail Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.world_memory" }
	S.tags = { "z", "attentiondetail", "emergence", "origin" }
	S.description = "Attention Driven Detail Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.attentiondetail.emergence_detection", windowSize = 5, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
