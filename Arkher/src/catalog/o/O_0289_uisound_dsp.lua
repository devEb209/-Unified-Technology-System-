-- ARKHER SYSTEM O.0289 :: UI Sound DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0289"
	S.key = "arkher.audio.uisound.dsp_chain"
	S.name = "UI Sound DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "UI Sound"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "uisound", "dsp", "audio" }
	S.description = "UI Sound DSP Chain: biquad filtering, delay, envelope and soft clipping for the UI Sound subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.uisound.dsp_chain", sampleRate = 22050, filter = "lowpass", cutoff = 1500, q = 0.540 })
		inst.system = S
		inst.ctx = ctx
