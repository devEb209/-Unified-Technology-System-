-- ARKHER SYSTEM T.0253 :: Narrative Design Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0253"
	S.key = "arkher.ai.narrativedesign.intent_understanding"
	S.name = "Narrative Design Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "narrativedesign", "intent", "ai" }
	S.description = "Narrative Design Intent Understanding: natural language turned into an actionable, scored intent for the Narrative Design subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.narrativedesign.intent_understanding", minConfidence = 0.41 })
		inst.system = S
		inst.ctx = ctx
