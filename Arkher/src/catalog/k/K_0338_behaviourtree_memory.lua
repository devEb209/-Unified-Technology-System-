-- ARKHER SYSTEM K.0338 :: Behaviour Tree Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0338"
	S.key = "arkher.npc.behaviourtree.memory"
	S.name = "Behaviour Tree Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourtree.mind_network" }
	S.tags = { "k", "behaviourtree", "memory", "npc" }
	S.description = "Behaviour Tree Memory: episodic memory with decay, recall and consolidation for the Behaviour Tree subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.behaviourtree.memory", capacity = 38, decayRate = 0.020, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
