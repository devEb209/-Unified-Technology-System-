-- ARKHER SYSTEM VB.0582 :: Thermal Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0582"
	S.key = "arkher.conttime.thermalcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.thermalcont.persistent_state" }
	S.tags = { "vb", "thermalcont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.thermalcont.coherence_guard", window = 135, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
