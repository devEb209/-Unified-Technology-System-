-- ARKHER SYSTEM VC.0016 :: Region Tile Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VC.0016"
	S.key = "arkher.contneural.regiontile.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.regiontile.sparse_residency" }
	S.tags = { "vc", "regiontile", "multiscale", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contneural.regiontile.multi-scale_fidelity", levels = 4, baseTriangles = 165000 })
		inst.system = S
		inst.ctx = ctx
