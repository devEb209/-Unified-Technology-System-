-- ARKHER SYSTEM Z.0423 :: Offline World Progression Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0423"
	S.key = "arkher.origin.offlineprogression.simulation_fabric"
	S.name = "Offline World Progression Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.complexity_governance" }
	S.tags = { "z", "offlineprogression", "fabric", "origin" }
	S.description = "Offline World Progression Simulation Fabric: every simulation domain stepped under one budgeted clock for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.offlineprogression.simulation_fabric", budgetMs = 2.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
