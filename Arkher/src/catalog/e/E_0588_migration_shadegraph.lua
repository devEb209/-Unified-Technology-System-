-- ARKHER SYSTEM E.0588 :: Material Migration Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0588"
	S.key = "arkher.material.migration.shading_graph"
	S.name = "Material Migration Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.migration.layer_composition" }
	S.tags = { "e", "migration", "shadegraph", "material" }
	S.description = "Material Migration Shading Graph: node graph evaluated and compiled to Luau for the Material Migration subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.migration.shading_graph" })
		inst.system = S
		inst.ctx = ctx
