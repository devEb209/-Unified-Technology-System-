-- ARKHER SYSTEM V.0151 :: UI Sprite Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0151"
	S.key = "arkher.asset.uisprite.streaming_residency"
	S.name = "UI Sprite Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.uisprite.content_cache" }
	S.tags = { "v", "uisprite", "streamer", "asset" }
	S.description = "UI Sprite Streaming Residency: distance-driven load and unload of asset payloads for the UI Sprite subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.uisprite.streaming_residency", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
