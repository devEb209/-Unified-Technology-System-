-- ARKHER SYSTEM P.0291 :: Melee Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0291"
	S.key = "arkher.play.melee.objectives"
	S.name = "Melee Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Melee"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.melee.inventory" }
	S.tags = { "p", "melee", "quest", "play" }
	S.description = "Melee Objectives: objectives, prerequisites, progress and rewards for the Melee subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.melee.objectives" })
		inst.system = S
		inst.ctx = ctx
