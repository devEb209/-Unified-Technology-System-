-- ARKHER SYSTEM F.0458 :: Frustum Culling Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0458"
	S.key = "arkher.render.frustum.render_policy"
	S.name = "Frustum Culling Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.frustum.draw_budget" }
	S.tags = { "f", "frustum", "policy", "render" }
	S.description = "Frustum Culling Render Policy: device tier rules for the frame for the Frustum Culling subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.frustum.render_policy", algorithm = "lottery", starvationGuard = 51 })
		inst.system = S
		inst.ctx = ctx
