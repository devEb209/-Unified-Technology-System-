-- ARKHER SYSTEM VB.0422 :: Navigation Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0422"
	S.key = "arkher.conttime.navcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.navcont.infinite_grid" }
	S.tags = { "vb", "navcont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.navcont.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
