-- ARKHER SYSTEM Z.0418 :: Battery Aware Pipeline Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0418"
	S.key = "arkher.origin.batteryaware.budget_governor"
	S.name = "Battery Aware Pipeline Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.batteryaware.behaviour_analysis" }
	S.tags = { "z", "batteryaware", "budgeter", "origin" }
	S.description = "Battery Aware Pipeline Budget Governor: allocation of a scarce resource across the technology's consumers for the Battery Aware Pipeline subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.batteryaware.budget_governor", total = 129, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
