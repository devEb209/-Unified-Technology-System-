-- ARKHER SYSTEM F.0450 :: Frustum Culling View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0450"
	S.key = "arkher.render.frustum.view_and_culling"
	S.name = "Frustum Culling View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.frustum.frame_graph" }
	S.tags = { "f", "frustum", "camera", "render" }
	S.description = "Frustum Culling View And Culling: view state, frustum culling and screen-size LOD for the Frustum Culling subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.frustum.view_and_culling", width = 1212, height = 1080, fov = 1.2800, far = 1600 })
		inst.system = S
		inst.ctx = ctx
