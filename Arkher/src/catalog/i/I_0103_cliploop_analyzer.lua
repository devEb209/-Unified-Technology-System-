-- ARKHER SYSTEM I.0103 :: Clip Looping Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0103"
	S.key = "arkher.anim.cliploop.analysis"
	S.name = "Clip Looping Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Looping"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.cliploop.quality_policy" }
	S.tags = { "i", "cliploop", "analyzer", "anim" }
	S.description = "Clip Looping Analysis: pop, drift and cost analysis of playback for the Clip Looping subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.cliploop.analysis", window = 208, buckets = 8, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
