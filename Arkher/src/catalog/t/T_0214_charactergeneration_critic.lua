-- ARKHER SYSTEM T.0214 :: Character Generation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0214"
	S.key = "arkher.ai.charactergeneration.self_critique"
	S.name = "Character Generation Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.charactergeneration.plan_workflow" }
	S.tags = { "t", "charactergeneration", "critic", "ai" }
	S.description = "Character Generation Self Critique: weighted evaluation of the result against declared criteria for the Character Generation subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.charactergeneration.self_critique", passMark = 0.83, reviseMark = 0.48, seed = 358 })
		inst.system = S
		inst.ctx = ctx
