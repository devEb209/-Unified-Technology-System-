-- ARKHER SYSTEM J.0148 :: Posture Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0148"
	S.key = "arkher.character.posture.physical_response"
	S.name = "Posture Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.posture.look_and_reach" }
	S.tags = { "j", "posture", "ragdoll", "character" }
	S.description = "Posture Physical Response: physical reaction, ragdoll and recovery for the Posture subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.posture.physical_response", blendSpeed = 5.80 })
		inst.system = S
		inst.ctx = ctx
