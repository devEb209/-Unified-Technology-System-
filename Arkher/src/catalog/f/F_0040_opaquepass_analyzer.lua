-- ARKHER SYSTEM F.0040 :: Opaque Pass Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0040"
	S.key = "arkher.render.opaquepass.frame_analysis"
	S.name = "Opaque Pass Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Opaque Pass"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.opaquepass.pass_cache" }
	S.tags = { "f", "opaquepass", "analyzer", "render" }
	S.description = "Opaque Pass Frame Analysis: per-pass cost analysis and outlier detection for the Opaque Pass subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.opaquepass.frame_analysis", window = 240, buckets = 16, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
