-- ARKHER SYSTEM R.0104 :: Remote Event Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0104"
	S.key = "arkher.net.remoteevent.rate_guard"
	S.name = "Remote Event Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Remote Event"
	S.aspect = "Rate Guard"
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remoteevent.interest_streaming" }
	S.tags = { "r", "remoteevent", "guard", "net" }
	S.description = "Remote Event Rate Guard: token-bucket protection against floods and abuse for the Remote Event subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.remoteevent.rate_guard", algorithm = "token", capacity = 91, refillPerSec = 56, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
