-- ARKHER SYSTEM P.0272 :: Reputation Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0272"
	S.key = "arkher.play.playerreputation.balance_analysis"
	S.name = "Reputation Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Reputation"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playerreputation.event_ledger" }
	S.tags = { "p", "playerreputation", "analyzer", "play" }
	S.description = "Reputation Balance Analysis: distribution, outlier and pacing analysis for the Reputation subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.playerreputation.balance_analysis", window = 93, buckets = 17, threshold = 3.50 })
		inst.system = S
		inst.ctx = ctx
