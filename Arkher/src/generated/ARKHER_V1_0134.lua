--!strict
-- Physics Chaos — CORE Profiler #0134
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Physics Chaos — CORE Profiler #0134", size=Vector2.new(680, 500), pos=UDim2.fromOffset(242, 278), parent=parent, icon="⬣"})
