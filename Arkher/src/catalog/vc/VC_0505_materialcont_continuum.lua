-- ARKHER SYSTEM VC.0505 :: Material Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0505"
	S.key = "arkher.contneural.materialcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "materialcont", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.materialcont.infinite_grid", cellSize = 224, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
