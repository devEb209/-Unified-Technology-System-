-- ARKHER SYSTEM W.0407 :: Cinematic Debug Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0407"
	S.key = "arkher.cine.cinedebug.sequence_analysis"
	S.name = "Cinematic Debug Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinedebug.frame_budget" }
	S.tags = { "w", "cinedebug", "analyzer", "cine" }
	S.description = "Cinematic Debug Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Cinematic Debug subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.cinedebug.sequence_analysis", window = 235, buckets = 15, threshold = 2.70 })
		inst.system = S
		inst.ctx = ctx
