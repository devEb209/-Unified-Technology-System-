-- ARKHER SYSTEM N.0497 :: Environment Ambience Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0497"
	S.key = "arkher.vfx.envambience.force_field"
	S.name = "Environment Ambience Force Field"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.envambience.particle_simulation" }
	S.tags = { "n", "envambience", "forcefield", "vfx" }
	S.description = "Environment Ambience Force Field: wind, attraction, vortex, drag and curl turbulence for the Environment Ambience subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.envambience.force_field", seed = 94444 })
		inst.system = S
		inst.ctx = ctx
