-- ARKHER SYSTEM N.0510 :: Effect Debug Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0510"
	S.key = "arkher.vfx.fxdebug.force_field"
	S.name = "Effect Debug Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Effect Debug"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fxdebug.particle_simulation" }
	S.tags = { "n", "fxdebug", "forcefield", "vfx" }
	S.description = "Effect Debug Force Field: wind, attraction, vortex, drag and curl turbulence for the Effect Debug subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.fxdebug.force_field", seed = 90339 })
		inst.system = S
		inst.ctx = ctx
