-- ARKHER SYSTEM P.0351 :: Threat Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0351"
	S.key = "arkher.play.threat.objectives"
	S.name = "Threat Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Threat"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.threat.inventory" }
	S.tags = { "p", "threat", "quest", "play" }
	S.description = "Threat Objectives: objectives, prerequisites, progress and rewards for the Threat subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.threat.objectives" })
		inst.system = S
		inst.ctx = ctx
