-- ARKHER SYSTEM L.0317 :: Production Chain Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0317"
	S.key = "arkher.sim.productionchain.ecology"
	S.name = "Production Chain Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.productionchain.simulation_core" }
	S.tags = { "l", "productionchain", "ecology", "sim" }
	S.description = "Production Chain Ecology: populations, predation, harvesting and carrying capacity for the Production Chain subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.productionchain.ecology" })
		inst.system = S
		inst.ctx = ctx
