-- ARKHER SYSTEM J.0124 :: Breathing Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0124"
	S.key = "arkher.character.breathing.blend_controller"
	S.name = "Breathing Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.breathing.motion_set" }
	S.tags = { "j", "breathing", "animator", "character" }
	S.description = "Breathing Blend Controller: layered playback driving the character for the Breathing subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.breathing.blend_controller", budget = 14 })
		inst.system = S
		inst.ctx = ctx
