-- ARKHER SYSTEM W.0232 :: Fade Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0232"
	S.key = "arkher.cine.fade.shot_composition"
	S.name = "Fade Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Fade"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.fade.colour_grade" }
	S.tags = { "w", "fade", "composer", "cine" }
	S.description = "Fade Shot Composition: blending of the signals that make up the final shot for the Fade subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.fade.shot_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
