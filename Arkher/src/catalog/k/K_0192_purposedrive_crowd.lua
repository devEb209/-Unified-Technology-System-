-- ARKHER SYSTEM K.0192 :: Purpose Drive Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0192"
	S.key = "arkher.npc.purposedrive.crowd_steering"
	S.name = "Purpose Drive Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.purposedrive.navigation" }
	S.tags = { "k", "purposedrive", "crowd", "npc" }
	S.description = "Purpose Drive Crowd Steering: local avoidance, cohesion and arrival at scale for the Purpose Drive subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.purposedrive.crowd_steering", radius = 0.65, maxSpeed = 3.50, cellSize = 11 })
		inst.system = S
		inst.ctx = ctx
