-- ARKHER SYSTEM Z.0764 :: Semantic LOD Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0764"
	S.key = "arkher.origin.semanticlod.autonomous_pipeline"
	S.name = "Semantic LOD Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticlod.simulation_fabric" }
	S.tags = { "z", "semanticlod", "autopipeline", "origin" }
	S.description = "Semantic LOD Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Semantic LOD subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.semanticlod.autonomous_pipeline", maxIterations = 8 })
		inst.system = S
		inst.ctx = ctx
