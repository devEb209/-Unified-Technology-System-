-- ARKHER SYSTEM VA.0625 :: Interest Field Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0625"
	S.key = "arkher.contworld.interestfield.infinite_grid"
	S.name = "Interest Field Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "interestfield", "continuum", "contworld" }
	S.description = "Interest Field Infinite Grid: seamless paging of the infinite world grid for the Interest Field subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.interestfield.infinite_grid", cellSize = 160, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
