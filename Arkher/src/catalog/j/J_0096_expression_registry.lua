-- ARKHER SYSTEM J.0096 :: Expression Set Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0096"
	S.key = "arkher.character.expression.variant_registry"
	S.name = "Expression Set Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.expression.appearance_composer" }
	S.tags = { "j", "expression", "registry", "character" }
	S.description = "Expression Set Variant Registry: named character variants and their lifecycle for the Expression Set subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.expression.variant_registry" })
		inst.system = S
		inst.ctx = ctx
