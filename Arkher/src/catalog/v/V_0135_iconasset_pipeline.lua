-- ARKHER SYSTEM V.0135 :: Icon Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0135"
	S.key = "arkher.asset.iconasset.cook_pipeline"
	S.name = "Icon Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.iconasset.bundling" }
	S.tags = { "v", "iconasset", "pipeline", "asset" }
	S.description = "Icon Cook Pipeline: staged cooking with isolation and retries for the Icon subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.iconasset.cook_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
