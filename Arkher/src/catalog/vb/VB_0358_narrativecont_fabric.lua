-- ARKHER SYSTEM VB.0358 :: Narrative Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0358"
	S.key = "arkher.conttime.narrativecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.narrativecont.complexity_budget" }
	S.tags = { "vb", "narrativecont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.narrativecont.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
