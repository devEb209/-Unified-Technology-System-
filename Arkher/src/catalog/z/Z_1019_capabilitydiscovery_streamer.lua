-- ARKHER SYSTEM Z.1019 :: Capability Discovery Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.1019"
	S.key = "arkher.origin.capabilitydiscovery.residency_streaming"
	S.name = "Capability Discovery Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.budget_governor" }
	S.tags = { "z", "capabilitydiscovery", "streamer", "origin" }
	S.description = "Capability Discovery Residency Streaming: distance-driven residency of the technology's workload for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.capabilitydiscovery.residency_streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
