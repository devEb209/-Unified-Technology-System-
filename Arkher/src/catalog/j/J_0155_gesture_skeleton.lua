-- ARKHER SYSTEM J.0155 :: Gesture Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0155"
	S.key = "arkher.character.gesture.rig_definition"
	S.name = "Gesture Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "gesture", "skeleton", "character" }
	S.description = "Gesture Rig Definition: character rig definition and bone budget for the Gesture subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.gesture.rig_definition" })
		inst.system = S
		inst.ctx = ctx
