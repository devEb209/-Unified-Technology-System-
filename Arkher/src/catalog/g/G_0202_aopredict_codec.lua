-- ARKHER SYSTEM G.0202 :: Ambient Occlusion Prediction Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0202"
	S.key = "arkher.neural.aopredict.weight_codec"
	S.name = "Ambient Occlusion Prediction Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.aopredict.model_registry" }
	S.tags = { "g", "aopredict", "codec", "neural" }
	S.description = "Ambient Occlusion Prediction Weight Codec: weight serialization and quantized transport for the Ambient Occlusion Prediction subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.aopredict.weight_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
