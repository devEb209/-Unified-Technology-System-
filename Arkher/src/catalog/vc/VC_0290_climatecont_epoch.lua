-- ARKHER SYSTEM VC.0290 :: Climate Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0290"
	S.key = "arkher.contneural.climatecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.climatecont.infinite_grid" }
	S.tags = { "vc", "climatecont", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.climatecont.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
