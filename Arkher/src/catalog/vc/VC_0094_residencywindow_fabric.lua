-- ARKHER SYSTEM VC.0094 :: Residency Window Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0094"
	S.key = "arkher.contneural.residencywindow.simulation_fabric"
	S.name = "Residency Window Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.residencywindow.complexity_budget" }
	S.tags = { "vc", "residencywindow", "fabric", "contneural" }
	S.description = "Residency Window Simulation Fabric: fabric stepping the continuum domains for the Residency Window subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.residencywindow.simulation_fabric", budgetMs = 4.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
