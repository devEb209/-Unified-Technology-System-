-- ARKHER SYSTEM F.0661 :: VR Stereo Path Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0661"
	S.key = "arkher.render.vrpath.visibility_set"
	S.name = "VR Stereo Path Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.vrpath.view_and_culling" }
	S.tags = { "f", "vrpath", "visibility", "render" }
	S.description = "VR Stereo Path Visibility Set: cell, portal and occluder visibility for the VR Stereo Path subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.vrpath.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
