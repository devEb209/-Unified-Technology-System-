-- ARKHER SYSTEM VA.0133 :: Fidelity Band Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0133"
	S.key = "arkher.contworld.fidelityband.infinite_grid"
	S.name = "Fidelity Band Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "fidelityband", "continuum", "contworld" }
	S.description = "Fidelity Band Infinite Grid: seamless paging of the infinite world grid for the Fidelity Band subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.fidelityband.infinite_grid", cellSize = 160, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
