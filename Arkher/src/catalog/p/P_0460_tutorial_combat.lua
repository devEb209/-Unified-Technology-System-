-- ARKHER SYSTEM P.0460 :: Tutorial Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0460"
	S.key = "arkher.play.tutorial.combat_resolution"
	S.name = "Tutorial Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Tutorial"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.tutorial.objectives" }
	S.tags = { "p", "tutorial", "combat", "play" }
	S.description = "Tutorial Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Tutorial subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.tutorial.combat_resolution", seed = 6585, armourK = 90, critMultiplier = 2.40 })
		inst.system = S
		inst.ctx = ctx
