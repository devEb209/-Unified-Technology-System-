-- ARKHER SYSTEM Z.0717 :: Continuous Self Optimization Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0717"
	S.key = "arkher.origin.continuousopt.behaviour_analysis"
	S.name = "Continuous Self Optimization Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.governance_policy" }
	S.tags = { "z", "continuousopt", "analyzer", "origin" }
	S.description = "Continuous Self Optimization Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.continuousopt.behaviour_analysis", window = 223, buckets = 19, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
