-- ARKHER SYSTEM F.0605 :: Frame Capture Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0605"
	S.key = "arkher.render.framecapture.visibility_set"
	S.name = "Frame Capture Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framecapture.view_and_culling" }
	S.tags = { "f", "framecapture", "visibility", "render" }
	S.description = "Frame Capture Visibility Set: cell, portal and occluder visibility for the Frame Capture subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.framecapture.visibility_set", maxDepth = 4 })
		inst.system = S
		inst.ctx = ctx
