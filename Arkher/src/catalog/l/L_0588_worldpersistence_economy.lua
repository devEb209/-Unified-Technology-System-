-- ARKHER SYSTEM L.0588 :: World Persistence Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0588"
	S.key = "arkher.sim.worldpersistence.economy"
	S.name = "World Persistence Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldpersistence.ecology" }
	S.tags = { "l", "worldpersistence", "economy", "sim" }
	S.description = "World Persistence Economy: stock, production, demand, price discovery and trade for the World Persistence subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.worldpersistence.economy", elasticity = 0.38 })
		inst.system = S
		inst.ctx = ctx
