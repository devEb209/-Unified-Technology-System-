-- ARKHER SYSTEM E.0016 :: Surface Definition Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0016"
	S.key = "arkher.material.surfacedef.definition"
	S.name = "Surface Definition Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "surfacedef", "material", "material" }
	S.description = "Surface Definition Definition: layered PBR definition resolved into parameters for the Surface Definition subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.surfacedef.definition", texelBudget = 524288 })
		inst.system = S
		inst.ctx = ctx
