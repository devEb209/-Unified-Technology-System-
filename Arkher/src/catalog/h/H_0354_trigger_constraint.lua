-- ARKHER SYSTEM H.0354 :: Trigger Volume Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0354"
	S.key = "arkher.physics.trigger.constraint_solver"
	S.name = "Trigger Volume Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.trigger.contact_generation" }
	S.tags = { "h", "trigger", "constraint", "physics" }
	S.description = "Trigger Volume Constraint Solver: sequential impulses, friction, joints and warm starting for the Trigger Volume subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.trigger.constraint_solver", iterations = 6, baumgarte = 0.22, warmStart = true })
		inst.system = S
		inst.ctx = ctx
