-- ARKHER SYSTEM F.0317 :: Depth Of Field Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0317"
	S.key = "arkher.render.dof.draw_budget"
	S.name = "Depth Of Field Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.dof.adaptive_resolution" }
	S.tags = { "f", "dof", "budgeter", "render" }
	S.description = "Depth Of Field Draw Budget: draw call and triangle budget allocation for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.dof.draw_budget", total = 122, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
