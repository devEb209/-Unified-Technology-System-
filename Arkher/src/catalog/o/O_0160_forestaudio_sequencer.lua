-- ARKHER SYSTEM O.0160 :: Forest Audio Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0160"
	S.key = "arkher.audio.forestaudio.music_sequencer"
	S.name = "Forest Audio Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Forest Audio"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.forestaudio.spatialization" }
	S.tags = { "o", "forestaudio", "sequencer", "audio" }
	S.description = "Forest Audio Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Forest Audio subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.forestaudio.music_sequencer", bpm = 100, beatsPerBar = 4, intensity = 0.63 })
		inst.system = S
		inst.ctx = ctx
