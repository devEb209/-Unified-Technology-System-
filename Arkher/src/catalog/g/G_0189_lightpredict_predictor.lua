-- ARKHER SYSTEM G.0189 :: Light Transport Prediction Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0189"
	S.key = "arkher.neural.lightpredict.quality_predictor"
	S.name = "Light Transport Prediction Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.lightpredict.weight_codec" }
	S.tags = { "g", "lightpredict", "predictor", "neural" }
	S.description = "Light Transport Prediction Quality Predictor: predicted quality and cost of a setting for the Light Transport Prediction subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.lightpredict.quality_predictor", method = "markov", alpha = 0.11, window = 97 })
		inst.system = S
		inst.ctx = ctx
