-- ARKHER SYSTEM Z.0669 :: Auto Documentation Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0669"
	S.key = "arkher.origin.autodocumentation.intent_bridge"
	S.name = "Auto Documentation Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.semantic_graph" }
	S.tags = { "z", "autodocumentation", "intent", "origin" }
	S.description = "Auto Documentation Intent Bridge: natural language control surface for the technology for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.autodocumentation.intent_bridge", minConfidence = 0.30 })
		inst.system = S
		inst.ctx = ctx
