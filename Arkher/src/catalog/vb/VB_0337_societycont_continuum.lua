-- ARKHER SYSTEM VB.0337 :: Society Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0337"
	S.key = "arkher.conttime.societycont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "societycont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.societycont.infinite_grid", cellSize = 224, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
