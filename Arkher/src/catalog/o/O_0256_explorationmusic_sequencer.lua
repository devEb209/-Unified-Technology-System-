-- ARKHER SYSTEM O.0256 :: Exploration Music Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0256"
	S.key = "arkher.audio.explorationmusic.music_sequencer"
	S.name = "Exploration Music Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.explorationmusic.spatialization" }
	S.tags = { "o", "explorationmusic", "sequencer", "audio" }
	S.description = "Exploration Music Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Exploration Music subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.explorationmusic.music_sequencer", bpm = 150, beatsPerBar = 4, intensity = 0.36 })
		inst.system = S
		inst.ctx = ctx
