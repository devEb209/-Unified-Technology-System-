-- ARKHER SYSTEM VC.0281 :: Water Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0281"
	S.key = "arkher.contneural.watercont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.watercont.multi-scale_fidelity" }
	S.tags = { "vc", "watercont", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.watercont.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
