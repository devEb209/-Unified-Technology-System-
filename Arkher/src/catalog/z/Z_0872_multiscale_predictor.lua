-- ARKHER SYSTEM Z.0872 :: Multi Scale Simulation Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0872"
	S.key = "arkher.origin.multiscale.predictive_optimization"
	S.name = "Multi Scale Simulation Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.adaptive_workflow" }
	S.tags = { "z", "multiscale", "predictor", "origin" }
	S.description = "Multi Scale Simulation Predictive Optimization: forecast-driven optimization before the cost is paid for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.multiscale.predictive_optimization", method = "linear", alpha = 0.44, window = 66 })
		inst.system = S
		inst.ctx = ctx
