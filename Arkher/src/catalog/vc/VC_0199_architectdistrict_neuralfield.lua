-- ARKHER SYSTEM VC.0199 :: Architect District Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0199"
	S.key = "arkher.contneural.architectdistrict.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.architectdistrict.coherence_guard" }
	S.tags = { "vc", "architectdistrict", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.architectdistrict.neural_field", dims = 24, hidden = 20, seed = 49587 })
		inst.system = S
		inst.ctx = ctx
