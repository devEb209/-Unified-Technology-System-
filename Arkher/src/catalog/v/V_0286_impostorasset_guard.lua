-- ARKHER SYSTEM V.0286 :: Impostor Asset Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0286"
	S.key = "arkher.asset.impostorasset.validation_guard"
	S.name = "Impostor Asset Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.impostorasset.size_budget" }
	S.tags = { "v", "impostorasset", "guard", "asset" }
	S.description = "Impostor Asset Validation Guard: rate limiting and capability checks on the import path for the Impostor Asset subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.impostorasset.validation_guard", algorithm = "sliding", capacity = 158, refillPerSec = 63, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
