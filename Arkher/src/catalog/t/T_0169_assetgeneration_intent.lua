-- ARKHER SYSTEM T.0169 :: Asset Generation Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0169"
	S.key = "arkher.ai.assetgeneration.intent_understanding"
	S.name = "Asset Generation Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "assetgeneration", "intent", "ai" }
	S.description = "Asset Generation Intent Understanding: natural language turned into an actionable, scored intent for the Asset Generation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.assetgeneration.intent_understanding", minConfidence = 0.30 })
		inst.system = S
		inst.ctx = ctx
