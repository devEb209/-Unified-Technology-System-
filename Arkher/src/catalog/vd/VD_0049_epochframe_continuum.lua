-- ARKHER SYSTEM VD.0049 :: Epoch Frame Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0049"
	S.key = "arkher.contsim.epochframe.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "epochframe", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.epochframe.infinite_grid", cellSize = 96, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
