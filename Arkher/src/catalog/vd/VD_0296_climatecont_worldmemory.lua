-- ARKHER SYSTEM VD.0296 :: Climate Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0296"
	S.key = "arkher.contsim.climatecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.climatecont.neural_field" }
	S.tags = { "vd", "climatecont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.climatecont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
