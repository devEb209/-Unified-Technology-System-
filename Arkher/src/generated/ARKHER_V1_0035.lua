--!strict
-- Source2 Hammer — ANIMATION Stack #0035
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Source2 Hammer — ANIMATION Stack #0035", size=Vector2.new(680, 420), pos=UDim2.fromOffset(155, 155), parent=parent, icon="⬣"})
