-- ARKHER SYSTEM E.0443 :: Detail Tiling Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0443"
	S.key = "arkher.material.detailtile.streaming"
	S.name = "Detail Tiling Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.detailtile.parameter_budget" }
	S.tags = { "e", "detailtile", "streamer", "material" }
	S.description = "Detail Tiling Streaming: residency and demand-driven texture streaming for the Detail Tiling subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.detailtile.streaming", radius = 320, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
