-- ARKHER SYSTEM VB.0264 :: Road Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0264"
	S.key = "arkher.conttime.roadcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.roadcont.reality_continuum" }
	S.tags = { "vb", "roadcont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.roadcont.emergence_continuum", windowSize = 4, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
