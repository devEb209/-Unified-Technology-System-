--!strict
-- Mapbox GL — ANIMATION Stack #0125
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Mapbox GL — ANIMATION Stack #0125", size=Vector2.new(680, 420), pos=UDim2.fromOffset(125, 125), parent=parent, icon="◤"})
