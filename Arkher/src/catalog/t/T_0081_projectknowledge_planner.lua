-- ARKHER SYSTEM T.0081 :: Project Knowledge Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0081"
	S.key = "arkher.ai.projectknowledge.action_planner"
	S.name = "Project Knowledge Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.projectknowledge.utility_selection" }
	S.tags = { "t", "projectknowledge", "planner", "ai" }
	S.description = "Project Knowledge Action Planner: goal-oriented action planning over preconditions for the Project Knowledge subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.projectknowledge.action_planner", maxDepth = 11 })
		inst.system = S
		inst.ctx = ctx
