-- ARKHER SYSTEM Q.0233 :: Quest Log Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0233"
	S.key = "arkher.ui.questlog.navigation_graph"
	S.name = "Quest Log Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Quest Log"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.questlog.transition" }
	S.tags = { "q", "questlog", "graph", "ui" }
	S.description = "Quest Log Navigation Graph: screens, routes and shortest path between them for the Quest Log subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.questlog.navigation_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
