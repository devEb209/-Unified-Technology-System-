-- ARKHER SYSTEM VA.0534 :: Pipeline Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0534"
	S.key = "arkher.contworld.pipelinecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.pipelinecont.persistent_state" }
	S.tags = { "va", "pipelinecont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.pipelinecont.coherence_guard", window = 139, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
