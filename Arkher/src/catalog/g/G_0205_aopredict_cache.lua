-- ARKHER SYSTEM G.0205 :: Ambient Occlusion Prediction Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0205"
	S.key = "arkher.neural.aopredict.result_cache"
	S.name = "Ambient Occlusion Prediction Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.aopredict.compute_budget" }
	S.tags = { "g", "aopredict", "cache", "neural" }
	S.description = "Ambient Occlusion Prediction Result Cache: cached inference results keyed by input for the Ambient Occlusion Prediction subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.aopredict.result_cache", policy = "lru", capacity = 367, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
