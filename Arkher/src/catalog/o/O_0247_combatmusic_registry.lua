-- ARKHER SYSTEM O.0247 :: Combat Music Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0247"
	S.key = "arkher.audio.combatmusic.asset_registry"
	S.name = "Combat Music Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Combat Music"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.combatmusic.streaming" }
	S.tags = { "o", "combatmusic", "registry", "audio" }
	S.description = "Combat Music Asset Registry: catalogue of sounds, variations and metadata for the Combat Music subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.combatmusic.asset_registry" })
		inst.system = S
		inst.ctx = ctx
