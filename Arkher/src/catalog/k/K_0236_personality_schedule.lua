-- ARKHER SYSTEM K.0236 :: Personality Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0236"
	S.key = "arkher.npc.personality.daily_schedule"
	S.name = "Personality Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.personality.social_relations" }
	S.tags = { "k", "personality", "schedule", "npc" }
	S.description = "Personality Daily Schedule: hour-by-hour routine with priority interruptions for the Personality subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.personality.daily_schedule", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
