-- ARKHER SYSTEM J.0224 :: Character Variant Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0224"
	S.key = "arkher.character.charvariant.look_and_reach"
	S.name = "Character Variant Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.charvariant.blend_controller" }
	S.tags = { "j", "charvariant", "ik", "character" }
	S.description = "Character Variant Look And Reach: look-at, reach and foot placement for the character for the Character Variant subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.charvariant.look_and_reach", iterations = 14, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
