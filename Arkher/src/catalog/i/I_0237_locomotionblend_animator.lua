-- ARKHER SYSTEM I.0237 :: Locomotion Blend Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0237"
	S.key = "arkher.anim.locomotionblend.layered_blending"
	S.name = "Locomotion Blend Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.locomotionblend.clip_sampling" }
	S.tags = { "i", "locomotionblend", "animator", "anim" }
	S.description = "Locomotion Blend Layered Blending: layers, crossfades, masks and blend trees for the Locomotion Blend subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.locomotionblend.layered_blending", budget = 7 })
		inst.system = S
		inst.ctx = ctx
