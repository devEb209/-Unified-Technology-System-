-- ARKHER SYSTEM W.0362 :: Cinematic Audio Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0362"
	S.key = "arkher.cine.cinematicaudio.camera_rig"
	S.name = "Cinematic Audio Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinematicaudio.sequence_timeline" }
	S.tags = { "w", "cinematicaudio", "camerarig", "cine" }
	S.description = "Cinematic Audio Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Cinematic Audio subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.cinematicaudio.camera_rig", fov = 1.18, focus = 10.0, aperture = 3.4, smoothing = 10.0, distance = 12, height = 6 })
		inst.system = S
		inst.ctx = ctx
