-- ARKHER SYSTEM F.0166 :: Volumetric Light Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0166"
	S.key = "arkher.render.volumetric.frame_analysis"
	S.name = "Volumetric Light Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.volumetric.pass_cache" }
	S.tags = { "f", "volumetric", "analyzer", "render" }
	S.description = "Volumetric Light Frame Analysis: per-pass cost analysis and outlier detection for the Volumetric Light subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.volumetric.frame_analysis", window = 72, buckets = 16, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
