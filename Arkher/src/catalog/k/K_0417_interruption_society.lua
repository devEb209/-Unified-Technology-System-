-- ARKHER SYSTEM K.0417 :: Interruption Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0417"
	S.key = "arkher.npc.interruption.social_relations"
	S.name = "Interruption Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.interruption.crowd_steering" }
	S.tags = { "k", "interruption", "society", "npc" }
	S.description = "Interruption Social Relations: affinity, factions, reputation and gossip for the Interruption subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.interruption.social_relations", decayRate = 0.005, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
