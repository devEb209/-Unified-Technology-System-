-- ARKHER SYSTEM Z.0984 :: Engine Self Model Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0984"
	S.key = "arkher.origin.engineselfmodel.autonomous_pipeline"
	S.name = "Engine Self Model Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.engineselfmodel.simulation_fabric" }
	S.tags = { "z", "engineselfmodel", "autopipeline", "origin" }
	S.description = "Engine Self Model Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.engineselfmodel.autonomous_pipeline", maxIterations = 6 })
		inst.system = S
		inst.ctx = ctx
