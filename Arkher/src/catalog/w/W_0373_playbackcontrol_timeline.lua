-- ARKHER SYSTEM W.0373 :: Playback Control Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0373"
	S.key = "arkher.cine.playbackcontrol.sequence_timeline"
	S.name = "Playback Control Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "playbackcontrol", "timeline", "cine" }
	S.description = "Playback Control Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Playback Control subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.playbackcontrol.sequence_timeline", duration = 10.0, rate = 0.94 })
		inst.system = S
		inst.ctx = ctx
