-- ARKHER SYSTEM L.0569 :: World Event Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0569"
	S.key = "arkher.sim.worldevent.forecast"
	S.name = "World Event Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldevent.analysis" }
	S.tags = { "l", "worldevent", "predictor", "sim" }
	S.description = "World Event Forecast: prediction of the region's next state for the World Event subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.worldevent.forecast", method = "markov", alpha = 0.25, window = 79 })
		inst.system = S
		inst.ctx = ctx
