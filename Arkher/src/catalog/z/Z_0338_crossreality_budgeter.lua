-- ARKHER SYSTEM Z.0338 :: Cross Reality Sync Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0338"
	S.key = "arkher.origin.crossreality.budget_governor"
	S.name = "Cross Reality Sync Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.behaviour_analysis" }
	S.tags = { "z", "crossreality", "budgeter", "origin" }
	S.description = "Cross Reality Sync Budget Governor: allocation of a scarce resource across the technology's consumers for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.crossreality.budget_governor", total = 176, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
