-- ARKHER SYSTEM E.0454 :: Procedural Texture Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0454"
	S.key = "arkher.material.proctex.texture_sampling"
	S.name = "Procedural Texture Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.proctex.shading_graph" }
	S.tags = { "e", "proctex", "sampler", "material" }
	S.description = "Procedural Texture Texture Sampling: atlas packing, mip chain and filtered sampling for the Procedural Texture subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.proctex.texture_sampling", atlasSize = 192, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
