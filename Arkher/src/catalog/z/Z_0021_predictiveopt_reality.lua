-- ARKHER SYSTEM Z.0021 :: Predictive Optimization Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0021"
	S.key = "arkher.origin.predictiveopt.reality_layering"
	S.name = "Predictive Optimization Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "predictiveopt", "reality", "origin" }
	S.description = "Predictive Optimization Reality Layering: stacked authored, simulated, proposed and player realities for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.predictiveopt.reality_layering" })
		inst.system = S
		inst.ctx = ctx
