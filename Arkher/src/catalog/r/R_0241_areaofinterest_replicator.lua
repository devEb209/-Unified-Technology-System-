-- ARKHER SYSTEM R.0241 :: Area Of Interest Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0241"
	S.key = "arkher.net.areaofinterest.replication"
	S.name = "Area Of Interest Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "areaofinterest", "replicator", "net" }
	S.description = "Area Of Interest Replication: authoritative entity state, interest and delta snapshots for the Area Of Interest subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.areaofinterest.replication", mtu = 1650, interestRadius = 160, fullEvery = 75 })
		inst.system = S
		inst.ctx = ctx
