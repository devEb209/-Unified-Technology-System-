-- ARKHER SYSTEM N.0483 :: Glow Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0483"
	S.key = "arkher.vfx.glow.particle_simulation"
	S.name = "Glow Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Glow"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.glow.emission" }
	S.tags = { "n", "glow", "particles", "vfx" }
	S.description = "Glow Particle Simulation: pooled integration of position, velocity, colour and life for the Glow subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.glow.particle_simulation", capacity = 384, drag = 0.13, bounce = 0.28, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
