-- ARKHER SYSTEM N.0389 :: Decal Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0389"
	S.key = "arkher.vfx.decal.analysis"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.decal.spatial_index" }
	S.tags = { "n", "decal", "analyzer", "vfx" }
	S.description = "Decal Analysis: cost, overdraw and stability analysis of the effect for the Decal subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.decal.analysis", window = 162, buckets = 18, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
