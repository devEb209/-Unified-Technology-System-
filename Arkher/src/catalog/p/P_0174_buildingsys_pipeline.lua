-- ARKHER SYSTEM P.0174 :: Building Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0174"
	S.key = "arkher.play.buildingsys.rule_pipeline"
	S.name = "Building Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Building"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.buildingsys.state_machine" }
	S.tags = { "p", "buildingsys", "pipeline", "play" }
	S.description = "Building Rule Pipeline: ordered rules applied to every gameplay event for the Building subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.buildingsys.rule_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
