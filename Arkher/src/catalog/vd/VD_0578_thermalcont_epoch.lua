-- ARKHER SYSTEM VD.0578 :: Thermal Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0578"
	S.key = "arkher.contsim.thermalcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.thermalcont.infinite_grid" }
	S.tags = { "vd", "thermalcont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.thermalcont.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
