-- ARKHER SYSTEM J.0214 :: Outfit Composition Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0214"
	S.key = "arkher.character.outfit.physical_response"
	S.name = "Outfit Composition Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.outfit.look_and_reach" }
	S.tags = { "j", "outfit", "ragdoll", "character" }
	S.description = "Outfit Composition Physical Response: physical reaction, ragdoll and recovery for the Outfit Composition subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.outfit.physical_response", blendSpeed = 3.10 })
		inst.system = S
		inst.ctx = ctx
