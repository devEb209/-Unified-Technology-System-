-- ARKHER SYSTEM T.0585 :: Build Reasoning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0585"
	S.key = "arkher.ai.buildreasoning.action_planner"
	S.name = "Build Reasoning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.buildreasoning.utility_selection" }
	S.tags = { "t", "buildreasoning", "planner", "ai" }
	S.description = "Build Reasoning Action Planner: goal-oriented action planning over preconditions for the Build Reasoning subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.buildreasoning.action_planner", maxDepth = 11 })
		inst.system = S
		inst.ctx = ctx
