-- ARKHER SYSTEM E.0445 :: Detail Tiling Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0445"
	S.key = "arkher.material.detailtile.quality_policy"
	S.name = "Detail Tiling Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.detailtile.compression_codec" }
	S.tags = { "e", "detailtile", "policy", "material" }
	S.description = "Detail Tiling Quality Policy: device tier rules for the surface for the Detail Tiling subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.detailtile.quality_policy", algorithm = "roundrobin", starvationGuard = 20 })
		inst.system = S
		inst.ctx = ctx
