-- ARKHER SYSTEM VD.0052 :: Epoch Frame Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0052"
	S.key = "arkher.contsim.epochframe.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.epochframe.sparse_residency" }
	S.tags = { "vd", "epochframe", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.epochframe.multi-scale_fidelity", levels = 4, baseTriangles = 150000 })
		inst.system = S
		inst.ctx = ctx
