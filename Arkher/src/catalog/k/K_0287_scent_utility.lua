-- ARKHER SYSTEM K.0287 :: Scent Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0287"
	S.key = "arkher.npc.scent.utility_reasoning"
	S.name = "Scent Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.scent.reactive_behaviour" }
	S.tags = { "k", "scent", "utility", "npc" }
	S.description = "Scent Utility Reasoning: scored option selection with response curves for the Scent subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.scent.utility_reasoning", momentum = 0.07 })
		inst.system = S
		inst.ctx = ctx
