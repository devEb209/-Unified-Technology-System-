-- ARKHER SYSTEM V.0253 :: Video Asset Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0253"
	S.key = "arkher.asset.videoasset.import"
	S.name = "Video Asset Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "videoasset", "importer", "asset" }
	S.description = "Video Asset Import: validation, normalization, hashing and deduplication of incoming content for the Video Asset subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.videoasset.import", unitScale = 1.50 })
		inst.system = S
		inst.ctx = ctx
