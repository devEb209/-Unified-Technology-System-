-- ARKHER SYSTEM VC.0126 :: Spatial Slice Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0126"
	S.key = "arkher.contneural.spatialslice.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.spatialslice.persistent_state" }
	S.tags = { "vc", "spatialslice", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.spatialslice.coherence_guard", window = 126, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
