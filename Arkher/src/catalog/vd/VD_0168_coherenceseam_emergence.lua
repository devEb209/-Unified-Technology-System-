-- ARKHER SYSTEM VD.0168 :: Coherence Seam Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0168"
	S.key = "arkher.contsim.coherenceseam.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.coherenceseam.reality_continuum" }
	S.tags = { "vd", "coherenceseam", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.coherenceseam.emergence_continuum", windowSize = 6, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
