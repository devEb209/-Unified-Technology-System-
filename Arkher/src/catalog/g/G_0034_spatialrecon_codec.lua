-- ARKHER SYSTEM G.0034 :: Spatial Reconstruction Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0034"
	S.key = "arkher.neural.spatialrecon.weight_codec"
	S.name = "Spatial Reconstruction Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.spatialrecon.model_registry" }
	S.tags = { "g", "spatialrecon", "codec", "neural" }
	S.description = "Spatial Reconstruction Weight Codec: weight serialization and quantized transport for the Spatial Reconstruction subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.spatialrecon.weight_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
