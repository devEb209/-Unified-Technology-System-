-- ARKHER SYSTEM R.0026 :: Handshake Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0026"
	S.key = "arkher.net.handshake.time_sync"
	S.name = "Handshake Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Handshake"
	S.aspect = "Time Sync"
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.handshake.replication" }
	S.tags = { "r", "handshake", "netclock", "net" }
	S.description = "Handshake Time Sync: offset estimation, outlier rejection and jitter buffering for the Handshake subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.handshake.time_sync", tickRate = 40, bufferDelay = 0.100, maxSamples = 14 })
		inst.system = S
		inst.ctx = ctx
