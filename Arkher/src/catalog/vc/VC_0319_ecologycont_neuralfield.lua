-- ARKHER SYSTEM VC.0319 :: Ecology Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0319"
	S.key = "arkher.contneural.ecologycont.neural_field"
	S.name = "Ecology Continuum Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.ecologycont.coherence_guard" }
	S.tags = { "vc", "ecologycont", "neuralfield", "contneural" }
	S.description = "Ecology Continuum Neural Field: neural field encoding and reconstruction for the Ecology Continuum subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.ecologycont.neural_field", dims = 20, hidden = 16, seed = 25262 })
		inst.system = S
		inst.ctx = ctx
