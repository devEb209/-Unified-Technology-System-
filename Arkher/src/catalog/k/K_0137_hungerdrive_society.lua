-- ARKHER SYSTEM K.0137 :: Hunger Drive Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0137"
	S.key = "arkher.npc.hungerdrive.social_relations"
	S.name = "Hunger Drive Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hungerdrive.crowd_steering" }
	S.tags = { "k", "hungerdrive", "society", "npc" }
	S.description = "Hunger Drive Social Relations: affinity, factions, reputation and gossip for the Hunger Drive subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.hungerdrive.social_relations", decayRate = 0.005, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
