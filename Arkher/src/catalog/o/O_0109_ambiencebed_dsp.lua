-- ARKHER SYSTEM O.0109 :: Ambience Bed DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0109"
	S.key = "arkher.audio.ambiencebed.dsp_chain"
	S.name = "Ambience Bed DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Ambience Bed"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "ambiencebed", "dsp", "audio" }
	S.description = "Ambience Bed DSP Chain: biquad filtering, delay, envelope and soft clipping for the Ambience Bed subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.ambiencebed.dsp_chain", sampleRate = 22050, filter = "lowpass", cutoff = 5100, q = 0.860 })
		inst.system = S
		inst.ctx = ctx
