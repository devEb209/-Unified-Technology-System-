-- ARKHER SYSTEM E.0233 :: Layer Blending Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0233"
	S.key = "arkher.material.layerblend.streaming"
	S.name = "Layer Blending Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.layerblend.parameter_budget" }
	S.tags = { "e", "layerblend", "streamer", "material" }
	S.description = "Layer Blending Streaming: residency and demand-driven texture streaming for the Layer Blending subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.layerblend.streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
