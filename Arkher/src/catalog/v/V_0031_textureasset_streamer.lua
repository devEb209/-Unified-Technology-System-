-- ARKHER SYSTEM V.0031 :: Texture Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0031"
	S.key = "arkher.asset.textureasset.streaming_residency"
	S.name = "Texture Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.textureasset.content_cache" }
	S.tags = { "v", "textureasset", "streamer", "asset" }
	S.description = "Texture Streaming Residency: distance-driven load and unload of asset payloads for the Texture subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.textureasset.streaming_residency", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
