-- ARKHER SYSTEM K.0060 :: Episodic Memory Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0060"
	S.key = "arkher.npc.episodicmemory.emotion"
	S.name = "Episodic Memory Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.episodicmemory.drive_system" }
	S.tags = { "k", "episodicmemory", "emotion", "npc" }
	S.description = "Episodic Memory Emotion: appraisal of events into valence, arousal and mood for the Episodic Memory subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.episodicmemory.emotion", inertia = 0.80, decayRate = 0.35, baselineArousal = 0.15 })
		inst.system = S
		inst.ctx = ctx
