-- ARKHER SYSTEM VD.0518 :: Asset Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0518"
	S.key = "arkher.contsim.assetcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.assetcont.infinite_grid" }
	S.tags = { "vd", "assetcont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.assetcont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
