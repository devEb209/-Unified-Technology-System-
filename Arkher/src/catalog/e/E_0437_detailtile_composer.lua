-- ARKHER SYSTEM E.0437 :: Detail Tiling Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0437"
	S.key = "arkher.material.detailtile.layer_composition"
	S.name = "Detail Tiling Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.detailtile.definition" }
	S.tags = { "e", "detailtile", "composer", "material" }
	S.description = "Detail Tiling Layer Composition: ordered layer composition with blend rules for the Detail Tiling subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.detailtile.layer_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
