-- ARKHER SYSTEM F.0303 :: Bloom Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0303"
	S.key = "arkher.render.bloom.draw_budget"
	S.name = "Bloom Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Bloom"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.bloom.adaptive_resolution" }
	S.tags = { "f", "bloom", "budgeter", "render" }
	S.description = "Bloom Draw Budget: draw call and triangle budget allocation for the Bloom subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.bloom.draw_budget", total = 450, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
