-- ARKHER SYSTEM F.0083 :: Cascade Shadows Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0083"
	S.key = "arkher.render.cascades.orchestration"
	S.name = "Cascade Shadows Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.cascades.frame_analysis" }
	S.tags = { "f", "cascades", "orchestrator", "render" }
	S.description = "Cascade Shadows Orchestration: frame lifecycle orchestration for the Cascade Shadows subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.cascades.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
