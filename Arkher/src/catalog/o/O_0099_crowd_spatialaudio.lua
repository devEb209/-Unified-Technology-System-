-- ARKHER SYSTEM O.0099 :: Crowd Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0099"
	S.key = "arkher.audio.crowd.spatialization"
	S.name = "Crowd Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Crowd"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.crowd.mixer_bus" }
	S.tags = { "o", "crowd", "spatialaudio", "audio" }
	S.description = "Crowd Spatialization: distance attenuation, panning, occlusion and doppler for the Crowd subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.crowd.spatialization", model = "linear", refDistance = 4, maxDistance = 260, rolloff = 0.99, maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
