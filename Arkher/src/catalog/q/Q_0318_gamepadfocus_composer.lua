-- ARKHER SYSTEM Q.0318 :: Gamepad Focus Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0318"
	S.key = "arkher.ui.gamepadfocus.theme_composition"
	S.name = "Gamepad Focus Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.gamepadfocus.navigation_graph" }
	S.tags = { "q", "gamepadfocus", "composer", "ui" }
	S.description = "Gamepad Focus Theme Composition: blending of theme signals into the final appearance for the Gamepad Focus subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.gamepadfocus.theme_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
