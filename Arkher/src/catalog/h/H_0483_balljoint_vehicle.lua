-- ARKHER SYSTEM H.0483 :: Ball Joint Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0483"
	S.key = "arkher.physics.balljoint.vehicle"
	S.name = "Ball Joint Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Ball Joint"
	S.aspect = "Vehicle"
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.balljoint.character_motion" }
	S.tags = { "h", "balljoint", "vehicle", "physics" }
	S.description = "Ball Joint Vehicle: suspension, drivetrain, steering and tire friction for the Ball Joint subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.balljoint.vehicle", mass = 1500, wheelbase = 2.20, track = 1.40, maxRpm = 5600 })
		inst.system = S
		inst.ctx = ctx
