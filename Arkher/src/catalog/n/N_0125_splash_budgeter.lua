-- ARKHER SYSTEM N.0125 :: Water Splash Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0125"
	S.key = "arkher.vfx.splash.spawn_budget"
	S.name = "Water Splash Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Water Splash"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.splash.effect_composition" }
	S.tags = { "n", "splash", "budgeter", "vfx" }
	S.description = "Water Splash Spawn Budget: global particle budget shared by every live effect for the Water Splash subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.splash.spawn_budget", total = 244, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
