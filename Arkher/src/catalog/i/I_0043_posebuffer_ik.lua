-- ARKHER SYSTEM I.0043 :: Pose Buffer Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0043"
	S.key = "arkher.anim.posebuffer.inverse_kinematics"
	S.name = "Pose Buffer Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Pose Buffer"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.posebuffer.layered_blending" }
	S.tags = { "i", "posebuffer", "ik", "anim" }
	S.description = "Pose Buffer Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Pose Buffer subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.posebuffer.inverse_kinematics", iterations = 13, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
