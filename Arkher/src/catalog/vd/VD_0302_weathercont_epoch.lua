-- ARKHER SYSTEM VD.0302 :: Weather Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0302"
	S.key = "arkher.contsim.weathercont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.weathercont.infinite_grid" }
	S.tags = { "vd", "weathercont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.weathercont.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
