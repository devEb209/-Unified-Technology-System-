-- ARKHER SYSTEM P.0203 :: Shop Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0203"
	S.key = "arkher.play.shop.save_codec"
	S.name = "Shop Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Shop"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.shop.content_registry" }
	S.tags = { "p", "shop", "codec", "play" }
	S.description = "Shop Save Codec: persistence, diffing and checksum of gameplay state for the Shop subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.shop.save_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
