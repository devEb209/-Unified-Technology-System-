-- ARKHER SYSTEM Q.0201 :: Minimap Accessibility Policy
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0201"
	S.key = "arkher.ui.minimap.accessibility_policy"
	S.name = "Minimap Accessibility Policy"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Minimap"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.minimap.interaction_ledger" }
	S.tags = { "q", "minimap", "policy", "ui" }
	S.description = "Minimap Accessibility Policy: rules enforcing contrast, target size and motion limits for the Minimap subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ui.minimap.accessibility_policy", algorithm = "edf", starvationGuard = 45 })
		inst.system = S
		inst.ctx = ctx
