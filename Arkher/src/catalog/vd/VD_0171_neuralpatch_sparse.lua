-- ARKHER SYSTEM VD.0171 :: Neural Patch Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0171"
	S.key = "arkher.contsim.neuralpatch.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.neuralpatch.epoch_clock" }
	S.tags = { "vd", "neuralpatch", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.neuralpatch.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
