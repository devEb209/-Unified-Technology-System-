-- ARKHER SYSTEM I.0267 :: Foot Placement IK Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0267"
	S.key = "arkher.anim.footik.compression_codec"
	S.name = "Foot Placement IK Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.footik.retarget_graph" }
	S.tags = { "i", "footik", "codec", "anim" }
	S.description = "Foot Placement IK Compression Codec: curve compression and quantized transport for the Foot Placement IK subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.footik.compression_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
