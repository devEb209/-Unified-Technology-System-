-- ARKHER SYSTEM Z.0420 :: Battery Aware Pipeline Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0420"
	S.key = "arkher.origin.batteryaware.orchestration"
	S.name = "Battery Aware Pipeline Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.batteryaware.residency_streaming" }
	S.tags = { "z", "batteryaware", "orchestrator", "origin" }
	S.description = "Battery Aware Pipeline Orchestration: lifecycle and phase orchestration of the technology for the Battery Aware Pipeline subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.batteryaware.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
