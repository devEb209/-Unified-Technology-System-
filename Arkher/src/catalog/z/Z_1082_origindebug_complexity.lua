-- ARKHER SYSTEM Z.1082 :: Original Tech Debug Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.1082"
	S.key = "arkher.origin.origindebug.complexity_governance"
	S.name = "Original Tech Debug Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.origindebug.reality_layering" }
	S.tags = { "z", "origindebug", "complexity", "origin" }
	S.description = "Original Tech Debug Complexity Governance: measured scene cost turned into per-subsystem directives for the Original Tech Debug subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.origindebug.complexity_governance", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
