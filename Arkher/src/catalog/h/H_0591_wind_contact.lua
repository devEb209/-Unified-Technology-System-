-- ARKHER SYSTEM H.0591 :: Wind Force Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0591"
	S.key = "arkher.physics.wind.contact_generation"
	S.name = "Wind Force Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Wind Force"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.wind.collision_shape" }
	S.tags = { "h", "wind", "contact", "physics" }
	S.description = "Wind Force Contact Generation: narrow-phase manifolds with normal, depth and point for the Wind Force subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.wind.contact_generation", slop = 0.0090, maxManifolds = 190 })
		inst.system = S
		inst.ctx = ctx
