-- ARKHER SYSTEM W.0304 :: Lens Flare Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0304"
	S.key = "arkher.cine.lensflare.shot_composition"
	S.name = "Lens Flare Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Lens Flare"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.lensflare.colour_grade" }
	S.tags = { "w", "lensflare", "composer", "cine" }
	S.description = "Lens Flare Shot Composition: blending of the signals that make up the final shot for the Lens Flare subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.lensflare.shot_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
