-- ARKHER SYSTEM J.0063 :: Eyes Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0063"
	S.key = "arkher.character.eyes.variant_registry"
	S.name = "Eyes Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.eyes.appearance_composer" }
	S.tags = { "j", "eyes", "registry", "character" }
	S.description = "Eyes Variant Registry: named character variants and their lifecycle for the Eyes subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.eyes.variant_registry" })
		inst.system = S
		inst.ctx = ctx
