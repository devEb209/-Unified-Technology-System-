-- ARKHER SYSTEM W.0223 :: Transition Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0223"
	S.key = "arkher.cine.cinetransition.motion_tween"
	S.name = "Transition Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Transition"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinetransition.playback_orchestrator" }
	S.tags = { "w", "cinetransition", "tween", "cine" }
	S.description = "Transition Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Transition subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.cinetransition.motion_tween", timeScale = 0.90 })
		inst.system = S
		inst.ctx = ctx
