-- ARKHER SYSTEM J.0112 :: Gaze Behaviour Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0112"
	S.key = "arkher.character.gaze.motion_set"
	S.name = "Gaze Behaviour Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gaze.rig_definition" }
	S.tags = { "j", "gaze", "clip", "character" }
	S.description = "Gaze Behaviour Motion Set: the clips a character owns and how they sample for the Gaze Behaviour subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.gaze.motion_set", duration = 1.40, loop = false })
		inst.system = S
		inst.ctx = ctx
