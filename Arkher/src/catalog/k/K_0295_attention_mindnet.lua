-- ARKHER SYSTEM K.0295 :: Attention Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0295"
	S.key = "arkher.npc.attention.mind_network"
	S.name = "Attention Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "attention", "mindnet", "npc" }
	S.description = "Attention Mind Network: the learned policy that turns perception into a decision for the Attention subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.attention.mind_network", inputs = 9, hidden = 7, seed = 8283, learningRate = 0.065, exploration = 0.035 })
		inst.system = S
		inst.ctx = ctx
