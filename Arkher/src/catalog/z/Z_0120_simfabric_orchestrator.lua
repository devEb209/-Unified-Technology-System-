-- ARKHER SYSTEM Z.0120 :: Universal Simulation Fabric Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0120"
	S.key = "arkher.origin.simfabric.orchestration"
	S.name = "Universal Simulation Fabric Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.simfabric.residency_streaming" }
	S.tags = { "z", "simfabric", "orchestrator", "origin" }
	S.description = "Universal Simulation Fabric Orchestration: lifecycle and phase orchestration of the technology for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.simfabric.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
