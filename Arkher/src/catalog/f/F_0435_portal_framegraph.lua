-- ARKHER SYSTEM F.0435 :: Portal Culling Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0435"
	S.key = "arkher.render.portal.frame_graph"
	S.name = "Portal Culling Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "portal", "framegraph", "render" }
	S.description = "Portal Culling Frame Graph: declared passes, culling, ordering and aliasing for the Portal Culling subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.portal.frame_graph", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
