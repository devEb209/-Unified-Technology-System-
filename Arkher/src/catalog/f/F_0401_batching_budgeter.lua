-- ARKHER SYSTEM F.0401 :: Draw Call Batching Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0401"
	S.key = "arkher.render.batching.draw_budget"
	S.name = "Draw Call Batching Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.batching.adaptive_resolution" }
	S.tags = { "f", "batching", "budgeter", "render" }
	S.description = "Draw Call Batching Draw Budget: draw call and triangle budget allocation for the Draw Call Batching subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.batching.draw_budget", total = 446, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
