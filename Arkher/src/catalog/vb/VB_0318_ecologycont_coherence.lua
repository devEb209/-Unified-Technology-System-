-- ARKHER SYSTEM VB.0318 :: Ecology Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0318"
	S.key = "arkher.conttime.ecologycont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.ecologycont.persistent_state" }
	S.tags = { "vb", "ecologycont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.ecologycont.coherence_guard", window = 67, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
