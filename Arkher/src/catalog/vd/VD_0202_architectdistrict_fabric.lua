-- ARKHER SYSTEM VD.0202 :: Architect District Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0202"
	S.key = "arkher.contsim.architectdistrict.simulation_fabric"
	S.name = "Architect District Simulation Fabric"
	S.category = "VD"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.architectdistrict.complexity_budget" }
	S.tags = { "vd", "architectdistrict", "fabric", "contsim" }
	S.description = "Architect District Simulation Fabric: fabric stepping the continuum domains for the Architect District subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.architectdistrict.simulation_fabric", budgetMs = 1.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
