-- ARKHER SYSTEM K.0691 :: NPC Debug Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0691"
	S.key = "arkher.npc.npcdebug.perception"
	S.name = "NPC Debug Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcdebug.emotion" }
	S.tags = { "k", "npcdebug", "perception", "npc" }
	S.description = "NPC Debug Perception: sight, hearing and bounded attention for the NPC Debug subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.npcdebug.perception", sightRange = 50, hearingRange = 24, attentionSlots = 4, fov = 1.810 })
		inst.system = S
		inst.ctx = ctx
