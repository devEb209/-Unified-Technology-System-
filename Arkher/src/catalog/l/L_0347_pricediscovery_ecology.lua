-- ARKHER SYSTEM L.0347 :: Price Discovery Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0347"
	S.key = "arkher.sim.pricediscovery.ecology"
	S.name = "Price Discovery Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.pricediscovery.simulation_core" }
	S.tags = { "l", "pricediscovery", "ecology", "sim" }
	S.description = "Price Discovery Ecology: populations, predation, harvesting and carrying capacity for the Price Discovery subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.pricediscovery.ecology" })
		inst.system = S
		inst.ctx = ctx
