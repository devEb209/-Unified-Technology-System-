-- ARKHER SYSTEM L.0087 :: Cohort Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0087"
	S.key = "arkher.sim.cohort.aggregate_cache"
	S.name = "Cohort Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.cohort.fidelity_policy" }
	S.tags = { "l", "cohort", "cache", "sim" }
	S.description = "Cohort Aggregate Cache: reuse of expensive aggregate computations for the Cohort subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.cohort.aggregate_cache", policy = "ttl", capacity = 267, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
