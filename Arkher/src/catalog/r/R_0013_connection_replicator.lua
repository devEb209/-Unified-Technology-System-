-- ARKHER SYSTEM R.0013 :: Connection Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0013"
	S.key = "arkher.net.connection.replication"
	S.name = "Connection Replication"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Connection"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "connection", "replicator", "net" }
	S.description = "Connection Replication: authoritative entity state, interest and delta snapshots for the Connection subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.connection.replication", mtu = 600, interestRadius = 200, fullEvery = 30 })
		inst.system = S
		inst.ctx = ctx
