-- ARKHER SYSTEM E.0532 :: Material LOD Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0532"
	S.key = "arkher.material.materiallod.parameter_budget"
	S.name = "Material LOD Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Material LOD"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.materiallod.variant_registry" }
	S.tags = { "e", "materiallod", "budgeter", "material" }
	S.description = "Material LOD Parameter Budget: texel and layer budget allocation for the Material LOD subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.materiallod.parameter_budget", total = 61, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
