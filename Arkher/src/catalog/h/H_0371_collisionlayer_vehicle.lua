-- ARKHER SYSTEM H.0371 :: Collision Layer Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0371"
	S.key = "arkher.physics.collisionlayer.vehicle"
	S.name = "Collision Layer Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionlayer.character_motion" }
	S.tags = { "h", "collisionlayer", "vehicle", "physics" }
	S.description = "Collision Layer Vehicle: suspension, drivetrain, steering and tire friction for the Collision Layer subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.collisionlayer.vehicle", mass = 900, wheelbase = 2.40, track = 2.00, maxRpm = 5800 })
		inst.system = S
		inst.ctx = ctx
