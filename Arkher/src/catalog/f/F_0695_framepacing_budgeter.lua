-- ARKHER SYSTEM F.0695 :: Frame Pacing Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0695"
	S.key = "arkher.render.framepacing.draw_budget"
	S.name = "Frame Pacing Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Frame Pacing"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepacing.adaptive_resolution" }
	S.tags = { "f", "framepacing", "budgeter", "render" }
	S.description = "Frame Pacing Draw Budget: draw call and triangle budget allocation for the Frame Pacing subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.framepacing.draw_budget", total = 170, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
