-- ARKHER SYSTEM E.0568 :: Material Preview Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0568"
	S.key = "arkher.material.preview.authoring_pipeline"
	S.name = "Material Preview Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.preview.analysis" }
	S.tags = { "e", "preview", "pipeline", "material" }
	S.description = "Material Preview Authoring Pipeline: ordered authoring and bake stages for the Material Preview subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.preview.authoring_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
