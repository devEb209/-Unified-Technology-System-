-- ARKHER SYSTEM V.0305 :: Mip Chain Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0305"
	S.key = "arkher.asset.mipchain.dependency_graph"
	S.name = "Mip Chain Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.mipchain.asset_registry" }
	S.tags = { "v", "mipchain", "graph", "asset" }
	S.description = "Mip Chain Dependency Graph: what references what, and in which order it must be built for the Mip Chain subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.mipchain.dependency_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
