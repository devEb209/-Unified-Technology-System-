-- ARKHER SYSTEM VD.0467 :: Audio Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0467"
	S.key = "arkher.contsim.audiocont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.audiocont.simulation_fabric" }
	S.tags = { "vd", "audiocont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.audiocont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
