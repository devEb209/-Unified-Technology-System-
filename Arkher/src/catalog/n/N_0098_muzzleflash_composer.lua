-- ARKHER SYSTEM N.0098 :: Muzzle Flash Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0098"
	S.key = "arkher.vfx.muzzleflash.effect_composition"
	S.name = "Muzzle Flash Effect Composition"
	S.category = "N"
	S.family = "VFX"
	S.area = "Muzzle Flash"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.muzzleflash.effect_graph" }
	S.tags = { "n", "muzzleflash", "composer", "vfx" }
	S.description = "Muzzle Flash Effect Composition: blending of several effect signals into one output for the Muzzle Flash subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.muzzleflash.effect_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
