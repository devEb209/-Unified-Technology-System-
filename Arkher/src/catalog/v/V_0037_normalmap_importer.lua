-- ARKHER SYSTEM V.0037 :: Normal Map Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0037"
	S.key = "arkher.asset.normalmap.import"
	S.name = "Normal Map Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "normalmap", "importer", "asset" }
	S.description = "Normal Map Import: validation, normalization, hashing and deduplication of incoming content for the Normal Map subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.normalmap.import", unitScale = 1.25 })
		inst.system = S
		inst.ctx = ctx
