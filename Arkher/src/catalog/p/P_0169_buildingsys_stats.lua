-- ARKHER SYSTEM P.0169 :: Building Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0169"
	S.key = "arkher.play.buildingsys.attributes"
	S.name = "Building Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Building"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "buildingsys", "stats", "play" }
	S.description = "Building Attributes: base values, layered modifiers and derived statistics for the Building subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.buildingsys.attributes" })
		inst.system = S
		inst.ctx = ctx
