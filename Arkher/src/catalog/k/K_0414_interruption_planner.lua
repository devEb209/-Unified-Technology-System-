-- ARKHER SYSTEM K.0414 :: Interruption Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0414"
	S.key = "arkher.npc.interruption.goal_planner"
	S.name = "Interruption Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.interruption.utility_reasoning" }
	S.tags = { "k", "interruption", "planner", "npc" }
	S.description = "Interruption Goal Planner: backward GOAP planning to reach a goal state for the Interruption subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.interruption.goal_planner", maxDepth = 10 })
		inst.system = S
		inst.ctx = ctx
