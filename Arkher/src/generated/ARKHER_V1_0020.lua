...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="VFX Niagra — CORE Stack #0020", size=Vector2.new(680, 420), pos=UDim2.fromOffset(360, 160), parent=parent, icon="↻"})
