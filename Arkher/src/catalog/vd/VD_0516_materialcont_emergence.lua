-- ARKHER SYSTEM VD.0516 :: Material Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0516"
	S.key = "arkher.contsim.materialcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.materialcont.reality_continuum" }
	S.tags = { "vd", "materialcont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.materialcont.emergence_continuum", windowSize = 7, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
