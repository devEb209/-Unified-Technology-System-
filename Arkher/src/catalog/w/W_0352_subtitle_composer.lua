-- ARKHER SYSTEM W.0352 :: Subtitle Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0352"
	S.key = "arkher.cine.subtitle.shot_composition"
	S.name = "Subtitle Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Subtitle"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.subtitle.colour_grade" }
	S.tags = { "w", "subtitle", "composer", "cine" }
	S.description = "Subtitle Shot Composition: blending of the signals that make up the final shot for the Subtitle subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.subtitle.shot_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
