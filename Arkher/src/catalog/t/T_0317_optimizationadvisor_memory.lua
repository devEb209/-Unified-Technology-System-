-- ARKHER SYSTEM T.0317 :: Optimization Advisor Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0317"
	S.key = "arkher.ai.optimizationadvisor.working_memory"
	S.name = "Optimization Advisor Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.optimizationadvisor.outcome_prediction" }
	S.tags = { "t", "optimizationadvisor", "memory", "ai" }
	S.description = "Optimization Advisor Working Memory: decaying, consolidating recall of what the agent learned for the Optimization Advisor subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.optimizationadvisor.working_memory", capacity = 94, decayRate = 0.020, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
