-- ARKHER SYSTEM VC.0128 :: Spatial Slice World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0128"
	S.key = "arkher.contneural.spatialslice.world_memory_stream"
	S.name = "Spatial Slice World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.spatialslice.neural_field" }
	S.tags = { "vc", "spatialslice", "worldmemory", "contneural" }
	S.description = "Spatial Slice World Memory Stream: world memory continuum over epochs for the Spatial Slice subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.spatialslice.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
