-- ARKHER SYSTEM Z.0679 :: Auto Documentation Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0679"
	S.key = "arkher.origin.autodocumentation.residency_streaming"
	S.name = "Auto Documentation Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.budget_governor" }
	S.tags = { "z", "autodocumentation", "streamer", "origin" }
	S.description = "Auto Documentation Residency Streaming: distance-driven residency of the technology's workload for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.autodocumentation.residency_streaming", radius = 320, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
