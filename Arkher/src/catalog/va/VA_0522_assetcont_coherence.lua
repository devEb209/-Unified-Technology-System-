-- ARKHER SYSTEM VA.0522 :: Asset Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0522"
	S.key = "arkher.contworld.assetcont.coherence_guard"
	S.name = "Asset Continuum Coherence Guard"
	S.category = "VA"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.assetcont.persistent_state" }
	S.tags = { "va", "assetcont", "coherence", "contworld" }
	S.description = "Asset Continuum Coherence Guard: seam coherence and drift supervision for the Asset Continuum subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.assetcont.coherence_guard", window = 72, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
