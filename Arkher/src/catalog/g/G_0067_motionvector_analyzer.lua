-- ARKHER SYSTEM G.0067 :: Motion Vector Estimation Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0067"
	S.key = "arkher.neural.motionvector.error_analysis"
	S.name = "Motion Vector Estimation Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.motionvector.heuristic_policy" }
	S.tags = { "g", "motionvector", "analyzer", "neural" }
	S.description = "Motion Vector Estimation Error Analysis: residual and drift analysis for the Motion Vector Estimation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.motionvector.error_analysis", window = 57, buckets = 13, threshold = 4.90 })
		inst.system = S
		inst.ctx = ctx
