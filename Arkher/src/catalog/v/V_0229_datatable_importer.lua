-- ARKHER SYSTEM V.0229 :: Data Table Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0229"
	S.key = "arkher.asset.datatable.import"
	S.name = "Data Table Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "datatable", "importer", "asset" }
	S.description = "Data Table Import: validation, normalization, hashing and deduplication of incoming content for the Data Table subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.datatable.import", unitScale = 1.50 })
		inst.system = S
		inst.ctx = ctx
