-- ARKHER SYSTEM I.0210 :: Transition Rule Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0210"
	S.key = "arkher.anim.transitionrule.clip_sampling"
	S.name = "Transition Rule Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.transitionrule.skeleton" }
	S.tags = { "i", "transitionrule", "clip", "anim" }
	S.description = "Transition Rule Clip Sampling: keyframe tracks sampled, retimed and evented for the Transition Rule subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.transitionrule.clip_sampling", duration = 2.90, loop = true })
		inst.system = S
		inst.ctx = ctx
