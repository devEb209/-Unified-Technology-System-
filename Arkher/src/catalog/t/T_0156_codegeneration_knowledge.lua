-- ARKHER SYSTEM T.0156 :: Code Generation Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0156"
	S.key = "arkher.ai.codegeneration.semantic_knowledge"
	S.name = "Code Generation Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.codegeneration.intent_understanding" }
	S.tags = { "t", "codegeneration", "knowledge", "ai" }
	S.description = "Code Generation Semantic Knowledge: typed entities, weighted relations and inferred closure for the Code Generation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.codegeneration.semantic_knowledge", dims = 32 })
		inst.system = S
		inst.ctx = ctx
