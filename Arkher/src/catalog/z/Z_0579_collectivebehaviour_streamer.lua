-- ARKHER SYSTEM Z.0579 :: Collective Behaviour Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0579"
	S.key = "arkher.origin.collectivebehaviour.residency_streaming"
	S.name = "Collective Behaviour Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.collectivebehaviour.budget_governor" }
	S.tags = { "z", "collectivebehaviour", "streamer", "origin" }
	S.description = "Collective Behaviour Residency Streaming: distance-driven residency of the technology's workload for the Collective Behaviour subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.collectivebehaviour.residency_streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
