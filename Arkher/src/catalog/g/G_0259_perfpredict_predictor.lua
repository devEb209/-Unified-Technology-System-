-- ARKHER SYSTEM G.0259 :: Performance Prediction Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0259"
	S.key = "arkher.neural.perfpredict.quality_predictor"
	S.name = "Performance Prediction Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perfpredict.weight_codec" }
	S.tags = { "g", "perfpredict", "predictor", "neural" }
	S.description = "Performance Prediction Quality Predictor: predicted quality and cost of a setting for the Performance Prediction subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.perfpredict.quality_predictor", method = "markov", alpha = 0.12, window = 34 })
		inst.system = S
		inst.ctx = ctx
