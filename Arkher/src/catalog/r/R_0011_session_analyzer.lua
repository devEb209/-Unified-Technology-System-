-- ARKHER SYSTEM R.0011 :: Session Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0011"
	S.key = "arkher.net.session.latency_analysis"
	S.name = "Session Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Session"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.session.audit_ledger" }
	S.tags = { "r", "session", "analyzer", "net" }
	S.description = "Session Latency Analysis: round trip, jitter and loss analysis for the Session subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.session.latency_analysis", window = 203, buckets = 19, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
