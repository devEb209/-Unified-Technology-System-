-- ARKHER SYSTEM E.0440 :: Detail Tiling Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0440"
	S.key = "arkher.material.detailtile.procedural_detail"
	S.name = "Detail Tiling Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.detailtile.texture_sampling" }
	S.tags = { "e", "detailtile", "field", "material" }
	S.description = "Detail Tiling Procedural Detail: coherent noise detail driving the surface for the Detail Tiling subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.detailtile.procedural_detail", seed = 83915, frequency = 0.0128, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
