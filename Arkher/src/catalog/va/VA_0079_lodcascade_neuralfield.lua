-- ARKHER SYSTEM VA.0079 :: LOD Cascade Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0079"
	S.key = "arkher.contworld.lodcascade.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lodcascade.coherence_guard" }
	S.tags = { "va", "lodcascade", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.lodcascade.neural_field", dims = 20, hidden = 16, seed = 92134 })
		inst.system = S
		inst.ctx = ctx
