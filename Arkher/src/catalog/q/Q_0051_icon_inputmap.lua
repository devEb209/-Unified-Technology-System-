-- ARKHER SYSTEM Q.0051 :: Icon Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0051"
	S.key = "arkher.ui.icon.input_mapping"
	S.name = "Icon Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Icon"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.icon.widget_tree" }
	S.tags = { "q", "icon", "inputmap", "ui" }
	S.description = "Icon Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Icon subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.icon.input_mapping", device = "keyboard", holdTime = 0.27, deadzone = 0.12 })
		inst.system = S
		inst.ctx = ctx
