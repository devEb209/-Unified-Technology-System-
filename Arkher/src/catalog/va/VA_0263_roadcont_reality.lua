-- ARKHER SYSTEM VA.0263 :: Road Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0263"
	S.key = "arkher.contworld.roadcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.roadcont.simulation_fabric" }
	S.tags = { "va", "roadcont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.roadcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
