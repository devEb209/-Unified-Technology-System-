-- ARKHER SYSTEM T.0318 :: Optimization Advisor Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0318"
	S.key = "arkher.ai.optimizationadvisor.utility_selection"
	S.name = "Optimization Advisor Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.optimizationadvisor.working_memory" }
	S.tags = { "t", "optimizationadvisor", "utility", "ai" }
	S.description = "Optimization Advisor Utility Selection: scored choice between competing courses of action for the Optimization Advisor subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.optimizationadvisor.utility_selection", momentum = 0.03 })
		inst.system = S
		inst.ctx = ctx
