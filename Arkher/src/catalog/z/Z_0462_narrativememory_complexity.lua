-- ARKHER SYSTEM Z.0462 :: Narrative Memory Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0462"
	S.key = "arkher.origin.narrativememory.complexity_governance"
	S.name = "Narrative Memory Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.reality_layering" }
	S.tags = { "z", "narrativememory", "complexity", "origin" }
	S.description = "Narrative Memory Complexity Governance: measured scene cost turned into per-subsystem directives for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.narrativememory.complexity_governance", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
