-- ARKHER SYSTEM T.0674 :: Continuous Learning Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0674"
	S.key = "arkher.ai.continuouslearning.semantic_knowledge"
	S.name = "Continuous Learning Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.continuouslearning.intent_understanding" }
	S.tags = { "t", "continuouslearning", "knowledge", "ai" }
	S.description = "Continuous Learning Semantic Knowledge: typed entities, weighted relations and inferred closure for the Continuous Learning subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.continuouslearning.semantic_knowledge", dims = 40 })
		inst.system = S
		inst.ctx = ctx
