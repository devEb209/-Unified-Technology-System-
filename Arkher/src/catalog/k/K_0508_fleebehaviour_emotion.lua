-- ARKHER SYSTEM K.0508 :: Flee Behaviour Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0508"
	S.key = "arkher.npc.fleebehaviour.emotion"
	S.name = "Flee Behaviour Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.fleebehaviour.drive_system" }
	S.tags = { "k", "fleebehaviour", "emotion", "npc" }
	S.description = "Flee Behaviour Emotion: appraisal of events into valence, arousal and mood for the Flee Behaviour subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.fleebehaviour.emotion", inertia = 0.94, decayRate = 0.29, baselineArousal = 0.29 })
		inst.system = S
		inst.ctx = ctx
