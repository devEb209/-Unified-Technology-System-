-- ARKHER SYSTEM T.0149 :: Tool Use Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0149"
	S.key = "arkher.ai.tooluse.working_memory"
	S.name = "Tool Use Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.tooluse.outcome_prediction" }
	S.tags = { "t", "tooluse", "memory", "ai" }
	S.description = "Tool Use Working Memory: decaying, consolidating recall of what the agent learned for the Tool Use subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.tooluse.working_memory", capacity = 91, decayRate = 0.065, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
