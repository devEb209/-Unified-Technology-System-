-- ARKHER SYSTEM K.0642 :: Gossip Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0642"
	S.key = "arkher.npc.gossip.daily_schedule"
	S.name = "Gossip Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.gossip.social_relations" }
	S.tags = { "k", "gossip", "schedule", "npc" }
	S.description = "Gossip Daily Schedule: hour-by-hour routine with priority interruptions for the Gossip subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.gossip.daily_schedule", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
