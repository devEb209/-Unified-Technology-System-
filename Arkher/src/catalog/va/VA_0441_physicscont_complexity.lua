-- ARKHER SYSTEM VA.0441 :: Physics Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0441"
	S.key = "arkher.contworld.physicscont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.physicscont.world_memory_stream" }
	S.tags = { "va", "physicscont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.physicscont.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
