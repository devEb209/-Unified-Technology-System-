-- ARKHER SYSTEM Z.0375 :: Mobile First Governor Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0375"
	S.key = "arkher.origin.mobilefirst.signal_composition"
	S.name = "Mobile First Governor Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.telemetry_ledger" }
	S.tags = { "z", "mobilefirst", "composer", "origin" }
	S.description = "Mobile First Governor Signal Composition: blending of the technology's input signals into one output for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.mobilefirst.signal_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
