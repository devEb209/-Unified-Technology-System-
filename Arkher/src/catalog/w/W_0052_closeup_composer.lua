-- ARKHER SYSTEM W.0052 :: Close Up Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0052"
	S.key = "arkher.cine.closeup.shot_composition"
	S.name = "Close Up Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Close Up"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.closeup.colour_grade" }
	S.tags = { "w", "closeup", "composer", "cine" }
	S.description = "Close Up Shot Composition: blending of the signals that make up the final shot for the Close Up subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.closeup.shot_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
