-- ARKHER SYSTEM F.0569 :: UI Rendering Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0569"
	S.key = "arkher.render.uirender.draw_budget"
	S.name = "UI Rendering Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "UI Rendering"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.uirender.adaptive_resolution" }
	S.tags = { "f", "uirender", "budgeter", "render" }
	S.description = "UI Rendering Draw Budget: draw call and triangle budget allocation for the UI Rendering subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.uirender.draw_budget", total = 187, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
