-- ARKHER SYSTEM VA.0063 :: Sparse Page Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0063"
	S.key = "arkher.contworld.sparsepage.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.sparsepage.epoch_clock" }
	S.tags = { "va", "sparsepage", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.sparsepage.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
