-- ARKHER SYSTEM H.0109 :: Force Accumulator Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0109"
	S.key = "arkher.physics.force.result_cache"
	S.name = "Force Accumulator Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.force.simulation_policy" }
	S.tags = { "h", "force", "cache", "physics" }
	S.description = "Force Accumulator Result Cache: reuse of expensive simulation and query results for the Force Accumulator subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.force.result_cache", policy = "ttl", capacity = 425, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
