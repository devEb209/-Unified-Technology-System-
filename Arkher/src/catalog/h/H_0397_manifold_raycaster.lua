-- ARKHER SYSTEM H.0397 :: Contact Manifold Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0397"
	S.key = "arkher.physics.manifold.query"
	S.name = "Contact Manifold Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.manifold.constraint_solver" }
	S.tags = { "h", "manifold", "raycaster", "physics" }
	S.description = "Contact Manifold Query: rays, sweeps and overlaps against the simulation for the Contact Manifold subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.manifold.query", cellSize = 16 })
		inst.system = S
		inst.ctx = ctx
