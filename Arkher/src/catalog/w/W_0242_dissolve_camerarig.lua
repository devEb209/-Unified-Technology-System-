-- ARKHER SYSTEM W.0242 :: Dissolve Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0242"
	S.key = "arkher.cine.dissolve.camera_rig"
	S.name = "Dissolve Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dissolve"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dissolve.sequence_timeline" }
	S.tags = { "w", "dissolve", "camerarig", "cine" }
	S.description = "Dissolve Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Dissolve subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.dissolve.camera_rig", fov = 1.36, focus = 12.0, aperture = 6.4, smoothing = 12.0, distance = 14, height = 6 })
		inst.system = S
		inst.ctx = ctx
