-- ARKHER SYSTEM F.0607 :: Frame Capture Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0607"
	S.key = "arkher.render.framecapture.lighting_rig"
	S.name = "Frame Capture Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framecapture.geometry_virtualization" }
	S.tags = { "f", "framecapture", "lightrig", "render" }
	S.description = "Frame Capture Lighting Rig: light clustering, importance and cascades for the Frame Capture subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.framecapture.lighting_rig", maxActive = 6 })
		inst.system = S
		inst.ctx = ctx
