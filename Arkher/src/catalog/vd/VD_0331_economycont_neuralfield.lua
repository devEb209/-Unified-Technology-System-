-- ARKHER SYSTEM VD.0331 :: Economy Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0331"
	S.key = "arkher.contsim.economycont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.economycont.coherence_guard" }
	S.tags = { "vd", "economycont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.economycont.neural_field", dims = 12, hidden = 8, seed = 12092 })
		inst.system = S
		inst.ctx = ctx
