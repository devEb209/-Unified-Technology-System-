-- ARKHER SYSTEM VC.0334 :: Economy Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0334"
	S.key = "arkher.contneural.economycont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.economycont.complexity_budget" }
	S.tags = { "vc", "economycont", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.economycont.simulation_fabric", budgetMs = 3.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
