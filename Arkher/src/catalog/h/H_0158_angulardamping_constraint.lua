-- ARKHER SYSTEM H.0158 :: Angular Damping Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0158"
	S.key = "arkher.physics.angulardamping.constraint_solver"
	S.name = "Angular Damping Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.angulardamping.contact_generation" }
	S.tags = { "h", "angulardamping", "constraint", "physics" }
	S.description = "Angular Damping Constraint Solver: sequential impulses, friction, joints and warm starting for the Angular Damping subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.angulardamping.constraint_solver", iterations = 5, baumgarte = 0.11, warmStart = true })
		inst.system = S
		inst.ctx = ctx
