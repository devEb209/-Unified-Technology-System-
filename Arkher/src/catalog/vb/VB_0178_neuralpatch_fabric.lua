-- ARKHER SYSTEM VB.0178 :: Neural Patch Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0178"
	S.key = "arkher.conttime.neuralpatch.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.neuralpatch.complexity_budget" }
	S.tags = { "vb", "neuralpatch", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.neuralpatch.simulation_fabric", budgetMs = 2.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
