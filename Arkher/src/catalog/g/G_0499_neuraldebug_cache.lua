-- ARKHER SYSTEM G.0499 :: Neural Debug Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0499"
	S.key = "arkher.neural.neuraldebug.result_cache"
	S.name = "Neural Debug Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuraldebug.compute_budget" }
	S.tags = { "g", "neuraldebug", "cache", "neural" }
	S.description = "Neural Debug Result Cache: cached inference results keyed by input for the Neural Debug subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.neuraldebug.result_cache", policy = "lru", capacity = 223, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
