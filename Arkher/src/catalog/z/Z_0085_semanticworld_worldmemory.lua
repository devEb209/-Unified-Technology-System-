-- ARKHER SYSTEM Z.0085 :: Semantic World Graph World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0085"
	S.key = "arkher.origin.semanticworld.world_memory"
	S.name = "Semantic World Graph World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticworld.autonomous_pipeline" }
	S.tags = { "z", "semanticworld", "worldmemory", "origin" }
	S.description = "Semantic World Graph World Memory: epoch-stamped persistent history with compaction and checkpoints for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.semanticworld.world_memory", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
