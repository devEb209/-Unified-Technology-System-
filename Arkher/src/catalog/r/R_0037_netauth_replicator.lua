-- ARKHER SYSTEM R.0037 :: Authentication Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0037"
	S.key = "arkher.net.netauth.replication"
	S.name = "Authentication Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "netauth", "replicator", "net" }
	S.description = "Authentication Replication: authoritative entity state, interest and delta snapshots for the Authentication subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.netauth.replication", mtu = 1650, interestRadius = 480, fullEvery = 45 })
		inst.system = S
		inst.ctx = ctx
