-- ARKHER SYSTEM VC.0634 :: Interest Field Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0634"
	S.key = "arkher.contneural.interestfield.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.interestfield.complexity_budget" }
	S.tags = { "vc", "interestfield", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.interestfield.simulation_fabric", budgetMs = 1.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
