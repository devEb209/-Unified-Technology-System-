-- ARKHER SYSTEM F.0125 :: Screen Space Reflection Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0125"
	S.key = "arkher.render.ssr.orchestration"
	S.name = "Screen Space Reflection Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.ssr.frame_analysis" }
	S.tags = { "f", "ssr", "orchestrator", "render" }
	S.description = "Screen Space Reflection Orchestration: frame lifecycle orchestration for the Screen Space Reflection subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.ssr.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
