-- ARKHER SYSTEM F.0559 :: Particle Rendering Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0559"
	S.key = "arkher.render.particlerender.orchestration"
	S.name = "Particle Rendering Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.particlerender.frame_analysis" }
	S.tags = { "f", "particlerender", "orchestrator", "render" }
	S.description = "Particle Rendering Orchestration: frame lifecycle orchestration for the Particle Rendering subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.particlerender.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
