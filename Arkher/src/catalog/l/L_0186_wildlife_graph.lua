-- ARKHER SYSTEM L.0186 :: Wildlife Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0186"
	S.key = "arkher.sim.wildlife.region_graph"
	S.name = "Wildlife Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wildlife.calendar" }
	S.tags = { "l", "wildlife", "graph", "sim" }
	S.description = "Wildlife Region Graph: connectivity, components and shortest path between places for the Wildlife subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.wildlife.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
