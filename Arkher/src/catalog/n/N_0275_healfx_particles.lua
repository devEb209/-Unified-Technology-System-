-- ARKHER SYSTEM N.0275 :: Heal Effect Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0275"
	S.key = "arkher.vfx.healfx.particle_simulation"
	S.name = "Heal Effect Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Heal Effect"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.healfx.emission" }
	S.tags = { "n", "healfx", "particles", "vfx" }
	S.description = "Heal Effect Particle Simulation: pooled integration of position, velocity, colour and life for the Heal Effect subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.healfx.particle_simulation", capacity = 384, drag = 0.13, bounce = 0.38, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
