-- ARKHER SYSTEM J.0127 :: Breathing Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0127"
	S.key = "arkher.character.breathing.locomotion"
	S.name = "Breathing Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.breathing.physical_response" }
	S.tags = { "j", "breathing", "charmotor", "character" }
	S.description = "Breathing Locomotion: capsule locomotion driving the character for the Breathing subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.breathing.locomotion", radius = 0.54, height = 1.79, maxSpeed = 9.90, jumpHeight = 2.30, stepOffset = 0.54 })
		inst.system = S
		inst.ctx = ctx
