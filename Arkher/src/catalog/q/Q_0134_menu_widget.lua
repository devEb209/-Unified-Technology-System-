-- ARKHER SYSTEM Q.0134 :: Menu Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0134"
	S.key = "arkher.ui.menu.widget_tree"
	S.name = "Menu Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Menu"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.menu.responsive_layout" }
	S.tags = { "q", "menu", "widget", "ui" }
	S.description = "Menu Widget Tree: retained widget nodes, properties, bindings and rendering for the Menu subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.menu.widget_tree", theme = "highcontrast", scale = 1.07 })
		inst.system = S
		inst.ctx = ctx
