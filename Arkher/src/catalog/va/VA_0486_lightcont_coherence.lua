-- ARKHER SYSTEM VA.0486 :: Lighting Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0486"
	S.key = "arkher.contworld.lightcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lightcont.persistent_state" }
	S.tags = { "va", "lightcont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.lightcont.coherence_guard", window = 59, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
