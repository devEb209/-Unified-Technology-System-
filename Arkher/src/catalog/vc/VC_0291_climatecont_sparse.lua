-- ARKHER SYSTEM VC.0291 :: Climate Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0291"
	S.key = "arkher.contneural.climatecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.climatecont.epoch_clock" }
	S.tags = { "vc", "climatecont", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.climatecont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
