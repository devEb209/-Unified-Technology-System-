-- ARKHER SYSTEM L.0337 :: Market Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0337"
	S.key = "arkher.sim.market.route_network"
	S.name = "Market Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.market.region_graph" }
	S.tags = { "l", "market", "network", "sim" }
	S.description = "Market Route Network: roads, rivers and routes between settlements for the Market subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.market.route_network" })
		inst.system = S
		inst.ctx = ctx
