-- ARKHER SYSTEM L.0594 :: World Persistence State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0594"
	S.key = "arkher.sim.worldpersistence.state_codec"
	S.name = "World Persistence State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldpersistence.history_ledger" }
	S.tags = { "l", "worldpersistence", "codec", "sim" }
	S.description = "World Persistence State Codec: persistence, diffing and checksum of the world state for the World Persistence subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.worldpersistence.state_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
