-- ARKHER SYSTEM E.0193 :: Anisotropy Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0193"
	S.key = "arkher.material.anisotropy.authoring_pipeline"
	S.name = "Anisotropy Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Anisotropy"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.anisotropy.analysis" }
	S.tags = { "e", "anisotropy", "pipeline", "material" }
	S.description = "Anisotropy Authoring Pipeline: ordered authoring and bake stages for the Anisotropy subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.anisotropy.authoring_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
