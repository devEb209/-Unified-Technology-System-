-- ARKHER SYSTEM L.0002 :: Living World Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0002"
	S.key = "arkher.sim.livingworld.ecology"
	S.name = "Living World Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livingworld.simulation_core" }
	S.tags = { "l", "livingworld", "ecology", "sim" }
	S.description = "Living World Ecology: populations, predation, harvesting and carrying capacity for the Living World subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.livingworld.ecology" })
		inst.system = S
		inst.ctx = ctx
