-- ARKHER SYSTEM L.0137 :: City Life Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0137"
	S.key = "arkher.sim.citylife.ecology"
	S.name = "City Life Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.citylife.simulation_core" }
	S.tags = { "l", "citylife", "ecology", "sim" }
	S.description = "City Life Ecology: populations, predation, harvesting and carrying capacity for the City Life subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.citylife.ecology" })
		inst.system = S
		inst.ctx = ctx
