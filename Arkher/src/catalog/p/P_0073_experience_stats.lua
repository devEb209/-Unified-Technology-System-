-- ARKHER SYSTEM P.0073 :: Experience Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0073"
	S.key = "arkher.play.experience.attributes"
	S.name = "Experience Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Experience"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "experience", "stats", "play" }
	S.description = "Experience Attributes: base values, layered modifiers and derived statistics for the Experience subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.experience.attributes" })
		inst.system = S
		inst.ctx = ctx
