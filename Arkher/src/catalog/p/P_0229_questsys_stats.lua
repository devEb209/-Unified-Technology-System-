-- ARKHER SYSTEM P.0229 :: Quest Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0229"
	S.key = "arkher.play.questsys.attributes"
	S.name = "Quest Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Quest"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "questsys", "stats", "play" }
	S.description = "Quest Attributes: base values, layered modifiers and derived statistics for the Quest subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.questsys.attributes" })
		inst.system = S
		inst.ctx = ctx
