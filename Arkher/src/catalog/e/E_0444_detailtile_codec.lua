-- ARKHER SYSTEM E.0444 :: Detail Tiling Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0444"
	S.key = "arkher.material.detailtile.compression_codec"
	S.name = "Detail Tiling Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.detailtile.streaming" }
	S.tags = { "e", "detailtile", "codec", "material" }
	S.description = "Detail Tiling Compression Codec: serialization and compression of material data for the Detail Tiling subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.detailtile.compression_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
