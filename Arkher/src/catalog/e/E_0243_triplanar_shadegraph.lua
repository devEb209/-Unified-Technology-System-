-- ARKHER SYSTEM E.0243 :: Triplanar Projection Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0243"
	S.key = "arkher.material.triplanar.shading_graph"
	S.name = "Triplanar Projection Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.triplanar.layer_composition" }
	S.tags = { "e", "triplanar", "shadegraph", "material" }
	S.description = "Triplanar Projection Shading Graph: node graph evaluated and compiled to Luau for the Triplanar Projection subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.triplanar.shading_graph" })
		inst.system = S
		inst.ctx = ctx
