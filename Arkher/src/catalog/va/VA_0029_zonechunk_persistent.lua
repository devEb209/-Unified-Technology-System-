-- ARKHER SYSTEM VA.0029 :: Zone Chunk Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0029"
	S.key = "arkher.contworld.zonechunk.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.zonechunk.multi-scale_fidelity" }
	S.tags = { "va", "zonechunk", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.zonechunk.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
