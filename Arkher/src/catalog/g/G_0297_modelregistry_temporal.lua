-- ARKHER SYSTEM G.0297 :: Model Registry Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0297"
	S.key = "arkher.neural.modelregistry.temporal_history"
	S.name = "Model Registry Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelregistry.feature_extraction" }
	S.tags = { "g", "modelregistry", "temporal", "neural" }
	S.description = "Model Registry Temporal History: history buffers reused across frames for the Model Registry subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.modelregistry.temporal_history", feedback = 0.81, phase = 8 })
		inst.system = S
		inst.ctx = ctx
