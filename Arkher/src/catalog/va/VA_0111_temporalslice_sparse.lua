-- ARKHER SYSTEM VA.0111 :: Temporal Slice Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0111"
	S.key = "arkher.contworld.temporalslice.sparse_residency"
	S.name = "Temporal Slice Sparse Residency"
	S.category = "VA"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.temporalslice.epoch_clock" }
	S.tags = { "va", "temporalslice", "sparse", "contworld" }
	S.description = "Temporal Slice Sparse Residency: sparse page residency with eviction and compression for the Temporal Slice subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.temporalslice.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
