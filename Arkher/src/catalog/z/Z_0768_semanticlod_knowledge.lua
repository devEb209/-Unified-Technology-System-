-- ARKHER SYSTEM Z.0768 :: Semantic LOD Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0768"
	S.key = "arkher.origin.semanticlod.semantic_graph"
	S.name = "Semantic LOD Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticlod.world_architect" }
	S.tags = { "z", "semanticlod", "knowledge", "origin" }
	S.description = "Semantic LOD Semantic Graph: typed entities and inferred relations of the technology itself for the Semantic LOD subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.semanticlod.semantic_graph", dims = 48 })
		inst.system = S
		inst.ctx = ctx
