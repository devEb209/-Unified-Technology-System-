-- ARKHER SYSTEM I.0028 :: Bind Pose Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0028"
	S.key = "arkher.anim.bindpose.clip_sampling"
	S.name = "Bind Pose Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bind Pose"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bindpose.skeleton" }
	S.tags = { "i", "bindpose", "clip", "anim" }
	S.description = "Bind Pose Clip Sampling: keyframe tracks sampled, retimed and evented for the Bind Pose subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.bindpose.clip_sampling", duration = 0.70, loop = true })
		inst.system = S
		inst.ctx = ctx
