-- ARKHER SYSTEM VD.0174 :: Neural Patch Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0174"
	S.key = "arkher.contsim.neuralpatch.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.neuralpatch.persistent_state" }
	S.tags = { "vd", "neuralpatch", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.neuralpatch.coherence_guard", window = 119, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
