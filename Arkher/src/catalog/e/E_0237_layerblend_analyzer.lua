-- ARKHER SYSTEM E.0237 :: Layer Blending Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0237"
	S.key = "arkher.material.layerblend.analysis"
	S.name = "Layer Blending Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.layerblend.instance_cache" }
	S.tags = { "e", "layerblend", "analyzer", "material" }
	S.description = "Layer Blending Analysis: cost, redundancy and outlier analysis for the Layer Blending subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.layerblend.analysis", window = 142, buckets = 14, threshold = 4.40 })
		inst.system = S
		inst.ctx = ctx
