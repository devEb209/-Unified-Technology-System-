-- ARKHER SYSTEM Z.0143 :: Autonomous Development Pipeline Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0143"
	S.key = "arkher.origin.autodevpipeline.simulation_fabric"
	S.name = "Autonomous Development Pipeline Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodevpipeline.complexity_governance" }
	S.tags = { "z", "autodevpipeline", "fabric", "origin" }
	S.description = "Autonomous Development Pipeline Simulation Fabric: every simulation domain stepped under one budgeted clock for the Autonomous Development Pipeline subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.autodevpipeline.simulation_fabric", budgetMs = 3.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
