-- ARKHER SYSTEM N.0340 :: Beam Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0340"
	S.key = "arkher.vfx.beam.particle_simulation"
	S.name = "Beam Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Beam"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.beam.emission" }
	S.tags = { "n", "beam", "particles", "vfx" }
	S.description = "Beam Particle Simulation: pooled integration of position, velocity, colour and life for the Beam subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.beam.particle_simulation", capacity = 192, drag = 0.18, bounce = 0.23, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
