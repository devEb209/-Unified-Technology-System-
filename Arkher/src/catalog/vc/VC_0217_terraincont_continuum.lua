-- ARKHER SYSTEM VC.0217 :: Terrain Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0217"
	S.key = "arkher.contneural.terraincont.infinite_grid"
	S.name = "Terrain Continuum Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "terraincont", "continuum", "contneural" }
	S.description = "Terrain Continuum Infinite Grid: seamless paging of the infinite world grid for the Terrain Continuum subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.terraincont.infinite_grid", cellSize = 160, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
