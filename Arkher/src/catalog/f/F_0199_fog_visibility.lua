-- ARKHER SYSTEM F.0199 :: Fog Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0199"
	S.key = "arkher.render.fog.visibility_set"
	S.name = "Fog Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Fog"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.fog.view_and_culling" }
	S.tags = { "f", "fog", "visibility", "render" }
	S.description = "Fog Visibility Set: cell, portal and occluder visibility for the Fog subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.fog.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
