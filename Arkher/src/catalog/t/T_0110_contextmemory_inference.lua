-- ARKHER SYSTEM T.0110 :: Context Memory Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0110"
	S.key = "arkher.ai.contextmemory.model_inference"
	S.name = "Context Memory Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.contextmemory.action_planner" }
	S.tags = { "t", "contextmemory", "inference", "ai" }
	S.description = "Context Memory Model Inference: quantized inference with batching and budget for the Context Memory subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.contextmemory.model_inference", seed = 42432 })
		inst.system = S
		inst.ctx = ctx
