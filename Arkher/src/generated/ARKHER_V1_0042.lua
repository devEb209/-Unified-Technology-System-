...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Blender — CORE Mixer #0042", size=Vector2.new(600, 460), pos=UDim2.fromOffset(246, 274), parent=parent, icon="🛰"})
