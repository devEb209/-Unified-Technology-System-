-- ARKHER SYSTEM VA.0097 :: Memory Shard Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0097"
	S.key = "arkher.contworld.memoryshard.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "memoryshard", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.memoryshard.infinite_grid", cellSize = 64, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
