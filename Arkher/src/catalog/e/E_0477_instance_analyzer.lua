-- ARKHER SYSTEM E.0477 :: Material Instance Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0477"
	S.key = "arkher.material.instance.analysis"
	S.name = "Material Instance Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.instance.instance_cache" }
	S.tags = { "e", "instance", "analyzer", "material" }
	S.description = "Material Instance Analysis: cost, redundancy and outlier analysis for the Material Instance subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.instance.analysis", window = 52, buckets = 16, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
