-- ARKHER SYSTEM Z.0302 :: Causality Ledger Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0302"
	S.key = "arkher.origin.causality.complexity_governance"
	S.name = "Causality Ledger Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.reality_layering" }
	S.tags = { "z", "causality", "complexity", "origin" }
	S.description = "Causality Ledger Complexity Governance: measured scene cost turned into per-subsystem directives for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.causality.complexity_governance", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
