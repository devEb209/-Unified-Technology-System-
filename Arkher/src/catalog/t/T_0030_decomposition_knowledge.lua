-- ARKHER SYSTEM T.0030 :: Task Decomposition Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0030"
	S.key = "arkher.ai.decomposition.semantic_knowledge"
	S.name = "Task Decomposition Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.decomposition.intent_understanding" }
	S.tags = { "t", "decomposition", "knowledge", "ai" }
	S.description = "Task Decomposition Semantic Knowledge: typed entities, weighted relations and inferred closure for the Task Decomposition subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.decomposition.semantic_knowledge", dims = 48 })
		inst.system = S
		inst.ctx = ctx
