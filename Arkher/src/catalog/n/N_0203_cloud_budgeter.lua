-- ARKHER SYSTEM N.0203 :: Cloud Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0203"
	S.key = "arkher.vfx.cloud.spawn_budget"
	S.name = "Cloud Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloud"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.cloud.effect_composition" }
	S.tags = { "n", "cloud", "budgeter", "vfx" }
	S.description = "Cloud Spawn Budget: global particle budget shared by every live effect for the Cloud subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.cloud.spawn_budget", total = 221, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
