-- ARKHER SYSTEM J.0322 :: Character Debug Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0322"
	S.key = "arkher.character.characterdebug.blend_controller"
	S.name = "Character Debug Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterdebug.motion_set" }
	S.tags = { "j", "characterdebug", "animator", "character" }
	S.description = "Character Debug Blend Controller: layered playback driving the character for the Character Debug subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.characterdebug.blend_controller", budget = 8 })
		inst.system = S
		inst.ctx = ctx
