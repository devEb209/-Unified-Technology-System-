-- ARKHER SYSTEM VD.0161 :: Coherence Seam Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0161"
	S.key = "arkher.contsim.coherenceseam.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.coherenceseam.multi-scale_fidelity" }
	S.tags = { "vd", "coherenceseam", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.coherenceseam.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
