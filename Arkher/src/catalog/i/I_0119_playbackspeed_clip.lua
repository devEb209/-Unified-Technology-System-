-- ARKHER SYSTEM I.0119 :: Playback Speed Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0119"
	S.key = "arkher.anim.playbackspeed.clip_sampling"
	S.name = "Playback Speed Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.playbackspeed.skeleton" }
	S.tags = { "i", "playbackspeed", "clip", "anim" }
	S.description = "Playback Speed Clip Sampling: keyframe tracks sampled, retimed and evented for the Playback Speed subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.playbackspeed.clip_sampling", duration = 2.70, loop = true })
		inst.system = S
		inst.ctx = ctx
