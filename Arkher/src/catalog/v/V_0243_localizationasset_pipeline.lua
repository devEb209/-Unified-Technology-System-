-- ARKHER SYSTEM V.0243 :: Localization Asset Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0243"
	S.key = "arkher.asset.localizationasset.cook_pipeline"
	S.name = "Localization Asset Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.localizationasset.bundling" }
	S.tags = { "v", "localizationasset", "pipeline", "asset" }
	S.description = "Localization Asset Cook Pipeline: staged cooking with isolation and retries for the Localization Asset subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.localizationasset.cook_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
