-- ARKHER SYSTEM T.0433 :: Mobile Reasoning Learning Analysis
...
return function(A)
	...
	local S = {}
	S.id = "T.0433"
	S.key = "arkher.ai.mobilereasoning.learning_analysis"
	S.name = "Mobile Reasoning Learning Analysis"
	S.category = "T"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.mobilereasoning.model_inference" }
	S.tags = { "t", "mobilereasoning", "analyzer", "ai" }
	S.description = "Mobile Reasoning Learning Analysis: trend, anomaly and improvement analysis of the agent for the Mobile Reasoning subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ai.mobilereasoning.learning_analysis", window = 114, buckets = 14, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
