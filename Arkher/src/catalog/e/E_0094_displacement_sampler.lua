-- ARKHER SYSTEM E.0094 :: Height Displacement Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0094"
	S.key = "arkher.material.displacement.texture_sampling"
	S.name = "Height Displacement Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.displacement.shading_graph" }
	S.tags = { "e", "displacement", "sampler", "material" }
	S.description = "Height Displacement Texture Sampling: atlas packing, mip chain and filtered sampling for the Height Displacement subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.displacement.texture_sampling", atlasSize = 128, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
