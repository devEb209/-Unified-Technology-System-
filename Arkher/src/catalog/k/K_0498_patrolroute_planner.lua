-- ARKHER SYSTEM K.0498 :: Patrol Route Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0498"
	S.key = "arkher.npc.patrolroute.goal_planner"
	S.name = "Patrol Route Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.patrolroute.utility_reasoning" }
	S.tags = { "k", "patrolroute", "planner", "npc" }
	S.description = "Patrol Route Goal Planner: backward GOAP planning to reach a goal state for the Patrol Route subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.patrolroute.goal_planner", maxDepth = 10 })
		inst.system = S
		inst.ctx = ctx
