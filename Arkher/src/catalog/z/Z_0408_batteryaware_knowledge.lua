-- ARKHER SYSTEM Z.0408 :: Battery Aware Pipeline Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0408"
	S.key = "arkher.origin.batteryaware.semantic_graph"
	S.name = "Battery Aware Pipeline Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.batteryaware.world_architect" }
	S.tags = { "z", "batteryaware", "knowledge", "origin" }
	S.description = "Battery Aware Pipeline Semantic Graph: typed entities and inferred relations of the technology itself for the Battery Aware Pipeline subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.batteryaware.semantic_graph", dims = 40 })
		inst.system = S
		inst.ctx = ctx
