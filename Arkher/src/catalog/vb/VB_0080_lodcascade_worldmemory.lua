-- ARKHER SYSTEM VB.0080 :: LOD Cascade World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0080"
	S.key = "arkher.conttime.lodcascade.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lodcascade.neural_field" }
	S.tags = { "vb", "lodcascade", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.lodcascade.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
