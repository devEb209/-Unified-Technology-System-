-- ARKHER SYSTEM VC.0254 :: Road Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0254"
	S.key = "arkher.contneural.roadcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.roadcont.infinite_grid" }
	S.tags = { "vc", "roadcont", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.roadcont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
