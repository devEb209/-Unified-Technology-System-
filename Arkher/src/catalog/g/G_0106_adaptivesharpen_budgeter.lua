-- ARKHER SYSTEM G.0106 :: Adaptive Sharpening Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0106"
	S.key = "arkher.neural.adaptivesharpen.compute_budget"
	S.name = "Adaptive Sharpening Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.adaptivesharpen.quality_predictor" }
	S.tags = { "g", "adaptivesharpen", "budgeter", "neural" }
	S.description = "Adaptive Sharpening Compute Budget: inference time budget allocation for the Adaptive Sharpening subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.adaptivesharpen.compute_budget", total = 247, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
