-- ARKHER SYSTEM G.0484 :: Evaluation Harness Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0484"
	S.key = "arkher.neural.evalharness.compute_budget"
	S.name = "Evaluation Harness Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.evalharness.quality_predictor" }
	S.tags = { "g", "evalharness", "budgeter", "neural" }
	S.description = "Evaluation Harness Compute Budget: inference time budget allocation for the Evaluation Harness subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.evalharness.compute_budget", total = 265, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
