-- ARKHER SYSTEM K.0186 :: Purpose Drive Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0186"
	S.key = "arkher.npc.purposedrive.emotion"
	S.name = "Purpose Drive Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.purposedrive.drive_system" }
	S.tags = { "k", "purposedrive", "emotion", "npc" }
	S.description = "Purpose Drive Emotion: appraisal of events into valence, arousal and mood for the Purpose Drive subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.purposedrive.emotion", inertia = 0.76, decayRate = 0.31, baselineArousal = 0.11 })
		inst.system = S
		inst.ctx = ctx
