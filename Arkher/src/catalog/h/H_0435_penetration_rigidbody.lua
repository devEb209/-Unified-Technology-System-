-- ARKHER SYSTEM H.0435 :: Penetration Recovery Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0435"
	S.key = "arkher.physics.penetration.body_dynamics"
	S.name = "Penetration Recovery Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "penetration", "rigidbody", "physics" }
	S.description = "Penetration Recovery Body Dynamics: integration, impulses, damping and sleeping of a body for the Penetration Recovery subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.penetration.body_dynamics", mass = 9.00, radius = 0.70, restitution = 0.48, friction = 0.48, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
