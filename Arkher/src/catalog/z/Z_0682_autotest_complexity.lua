-- ARKHER SYSTEM Z.0682 :: Auto Test Synthesis Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0682"
	S.key = "arkher.origin.autotest.complexity_governance"
	S.name = "Auto Test Synthesis Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autotest.reality_layering" }
	S.tags = { "z", "autotest", "complexity", "origin" }
	S.description = "Auto Test Synthesis Complexity Governance: measured scene cost turned into per-subsystem directives for the Auto Test Synthesis subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.autotest.complexity_governance", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
