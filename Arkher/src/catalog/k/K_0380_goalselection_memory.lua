-- ARKHER SYSTEM K.0380 :: Goal Selection Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0380"
	S.key = "arkher.npc.goalselection.memory"
	S.name = "Goal Selection Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.goalselection.mind_network" }
	S.tags = { "k", "goalselection", "memory", "npc" }
	S.description = "Goal Selection Memory: episodic memory with decay, recall and consolidation for the Goal Selection subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.goalselection.memory", capacity = 104, decayRate = 0.060, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
