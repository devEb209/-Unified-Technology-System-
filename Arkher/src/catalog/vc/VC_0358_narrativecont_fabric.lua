-- ARKHER SYSTEM VC.0358 :: Narrative Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0358"
	S.key = "arkher.contneural.narrativecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.narrativecont.complexity_budget" }
	S.tags = { "vc", "narrativecont", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.narrativecont.simulation_fabric", budgetMs = 3.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
