-- ARKHER SYSTEM R.0295 :: Server Authority Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0295"
	S.key = "arkher.net.serverauthority.interest_streaming"
	S.name = "Server Authority Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverauthority.serialization_codec" }
	S.tags = { "r", "serverauthority", "streamer", "net" }
	S.description = "Server Authority Interest Streaming: distance-driven residency of replicated content for the Server Authority subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.serverauthority.interest_streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
