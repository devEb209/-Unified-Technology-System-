-- ARKHER SYSTEM R.0341 :: Reconnection Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0341"
	S.key = "arkher.net.reconnection.bandwidth_budget"
	S.name = "Reconnection Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Reconnection"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reconnection.transport_graph" }
	S.tags = { "r", "reconnection", "budgeter", "net" }
	S.description = "Reconnection Bandwidth Budget: bytes per second shared between competing streams for the Reconnection subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.reconnection.bandwidth_budget", total = 444, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
