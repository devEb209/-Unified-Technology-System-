-- ARKHER SYSTEM H.0235 :: Continuous Detection Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0235"
	S.key = "arkher.physics.ccd.result_cache"
	S.name = "Continuous Detection Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.ccd.simulation_policy" }
	S.tags = { "h", "ccd", "cache", "physics" }
	S.description = "Continuous Detection Result Cache: reuse of expensive simulation and query results for the Continuous Detection subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.ccd.result_cache", policy = "lru", capacity = 248, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
