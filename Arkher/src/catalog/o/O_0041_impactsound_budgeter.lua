-- ARKHER SYSTEM O.0041 :: Impact Sound Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0041"
	S.key = "arkher.audio.impactsound.voice_budget"
	S.name = "Impact Sound Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Impact Sound"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.impactsound.music_sequencer" }
	S.tags = { "o", "impactsound", "budgeter", "audio" }
	S.description = "Impact Sound Voice Budget: voice slots allocated by priority and audibility for the Impact Sound subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.impactsound.voice_budget", total = 99, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
