-- ARKHER SYSTEM P.0004 :: Player Character Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0004"
	S.key = "arkher.play.playercharacter.combat_resolution"
	S.name = "Player Character Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playercharacter.objectives" }
	S.tags = { "p", "playercharacter", "combat", "play" }
	S.description = "Player Character Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Player Character subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.playercharacter.combat_resolution", seed = 35805, armourK = 130, critMultiplier = 2.40 })
		inst.system = S
		inst.ctx = ctx
