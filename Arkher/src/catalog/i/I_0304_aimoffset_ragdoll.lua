-- ARKHER SYSTEM I.0304 :: Aim Offset Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0304"
	S.key = "arkher.anim.aimoffset.physical_blend"
	S.name = "Aim Offset Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Aim Offset"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.aimoffset.inverse_kinematics" }
	S.tags = { "i", "aimoffset", "ragdoll", "anim" }
	S.description = "Aim Offset Physical Blend: physical bones blended against the animated pose for the Aim Offset subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.aimoffset.physical_blend", blendSpeed = 4.80 })
		inst.system = S
		inst.ctx = ctx
