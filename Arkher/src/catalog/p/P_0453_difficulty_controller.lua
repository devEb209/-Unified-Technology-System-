-- ARKHER SYSTEM P.0453 :: Difficulty Difficulty Controller
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0453"
	S.key = "arkher.play.difficulty.difficulty_controller"
	S.name = "Difficulty Difficulty Controller"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Difficulty"
	...
	S.kit = "controller"
	S.version = "1.0.0"
	S.deps = { "arkher.play.difficulty.balance_analysis" }
	S.tags = { "p", "difficulty", "controller", "play" }
	S.description = "Difficulty Difficulty Controller: closed-loop tuning toward a target challenge for the Difficulty subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("controller", { id = "arkher.play.difficulty.difficulty_controller", mode = "pid", target = 0.660, kp = 0.510, ki = 0.100, kd = 0.020, min = 0.05, max = 1.0, initial = 0.56, deadband = 0.01 })
		inst.system = S
		inst.ctx = ctx
