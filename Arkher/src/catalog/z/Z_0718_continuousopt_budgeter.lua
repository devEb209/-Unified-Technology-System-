-- ARKHER SYSTEM Z.0718 :: Continuous Self Optimization Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0718"
	S.key = "arkher.origin.continuousopt.budget_governor"
	S.name = "Continuous Self Optimization Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.behaviour_analysis" }
	S.tags = { "z", "continuousopt", "budgeter", "origin" }
	S.description = "Continuous Self Optimization Budget Governor: allocation of a scarce resource across the technology's consumers for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.continuousopt.budget_governor", total = 431, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
