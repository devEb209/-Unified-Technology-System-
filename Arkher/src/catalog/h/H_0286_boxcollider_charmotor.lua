-- ARKHER SYSTEM H.0286 :: Box Collider Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0286"
	S.key = "arkher.physics.boxcollider.character_motion"
	S.name = "Box Collider Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Box Collider"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.boxcollider.query" }
	S.tags = { "h", "boxcollider", "charmotor", "physics" }
	S.description = "Box Collider Character Motion: capsule move-and-slide with slopes, steps and jumps for the Box Collider subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.boxcollider.character_motion", radius = 0.47, height = 1.92, maxSpeed = 5.20, jumpHeight = 1.20, stepOffset = 0.37 })
		inst.system = S
		inst.ctx = ctx
