-- ARKHER SYSTEM VA.0471 :: VFX Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0471"
	S.key = "arkher.contworld.vfxcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vfxcont.epoch_clock" }
	S.tags = { "va", "vfxcont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.vfxcont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
