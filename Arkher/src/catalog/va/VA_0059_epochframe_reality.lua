-- ARKHER SYSTEM VA.0059 :: Epoch Frame Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0059"
	S.key = "arkher.contworld.epochframe.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.epochframe.simulation_fabric" }
	S.tags = { "va", "epochframe", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.epochframe.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
