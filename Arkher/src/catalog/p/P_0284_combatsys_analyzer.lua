-- ARKHER SYSTEM P.0284 :: Combat Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0284"
	S.key = "arkher.play.combatsys.balance_analysis"
	S.name = "Combat Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Combat"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.combatsys.event_ledger" }
	S.tags = { "p", "combatsys", "analyzer", "play" }
	S.description = "Combat Balance Analysis: distribution, outlier and pacing analysis for the Combat subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.combatsys.balance_analysis", window = 48, buckets = 8, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
