-- ARKHER SYSTEM T.0557 :: Scene Reasoning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0557"
	S.key = "arkher.ai.scenereasoning.action_planner"
	S.name = "Scene Reasoning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.scenereasoning.utility_selection" }
	S.tags = { "t", "scenereasoning", "planner", "ai" }
	S.description = "Scene Reasoning Action Planner: goal-oriented action planning over preconditions for the Scene Reasoning subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.scenereasoning.action_planner", maxDepth = 8 })
		inst.system = S
		inst.ctx = ctx
