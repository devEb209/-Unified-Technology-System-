-- ARKHER SYSTEM R.0234 :: Interest Management Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0234"
	S.key = "arkher.net.interestmanagement.serialization_codec"
	S.name = "Interest Management Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.interestmanagement.bandwidth_budget" }
	S.tags = { "r", "interestmanagement", "codec", "net" }
	S.description = "Interest Management Serialization Codec: compact encoding, diffing and checksum of payloads for the Interest Management subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.interestmanagement.serialization_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
