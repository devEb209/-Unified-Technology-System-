-- ARKHER SYSTEM VC.0536 :: Pipeline Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0536"
	S.key = "arkher.contneural.pipelinecont.world_memory_stream"
	S.name = "Pipeline Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.pipelinecont.neural_field" }
	S.tags = { "vc", "pipelinecont", "worldmemory", "contneural" }
	S.description = "Pipeline Continuum World Memory Stream: world memory continuum over epochs for the Pipeline Continuum subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.pipelinecont.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
