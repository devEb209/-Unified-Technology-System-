-- ARKHER SYSTEM G.0071 :: Disocclusion Handling Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0071"
	S.key = "arkher.neural.disocclusion.inference_core"
	S.name = "Disocclusion Handling Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "disocclusion", "inference", "neural" }
	S.description = "Disocclusion Handling Inference Core: dense network forward pass and training for the Disocclusion Handling subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.disocclusion.inference_core", seed = 52455 })
		inst.system = S
		inst.ctx = ctx
