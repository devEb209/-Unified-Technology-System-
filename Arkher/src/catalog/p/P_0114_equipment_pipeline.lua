-- ARKHER SYSTEM P.0114 :: Equipment Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0114"
	S.key = "arkher.play.equipment.rule_pipeline"
	S.name = "Equipment Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Equipment"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.equipment.state_machine" }
	S.tags = { "p", "equipment", "pipeline", "play" }
	S.description = "Equipment Rule Pipeline: ordered rules applied to every gameplay event for the Equipment subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.equipment.rule_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
