-- ARKHER SYSTEM F.0024 :: Depth Prepass Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0024"
	S.key = "arkher.render.depthprepass.render_policy"
	S.name = "Depth Prepass Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.depthprepass.draw_budget" }
	S.tags = { "f", "depthprepass", "policy", "render" }
	S.description = "Depth Prepass Render Policy: device tier rules for the frame for the Depth Prepass subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.depthprepass.render_policy", algorithm = "lottery", starvationGuard = 51 })
		inst.system = S
		inst.ctx = ctx
