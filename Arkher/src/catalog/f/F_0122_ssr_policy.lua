-- ARKHER SYSTEM F.0122 :: Screen Space Reflection Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0122"
	S.key = "arkher.render.ssr.render_policy"
	S.name = "Screen Space Reflection Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.ssr.draw_budget" }
	S.tags = { "f", "ssr", "policy", "render" }
	S.description = "Screen Space Reflection Render Policy: device tier rules for the frame for the Screen Space Reflection subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.ssr.render_policy", algorithm = "wfq", starvationGuard = 58 })
		inst.system = S
		inst.ctx = ctx
