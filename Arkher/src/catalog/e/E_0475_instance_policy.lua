-- ARKHER SYSTEM E.0475 :: Material Instance Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0475"
	S.key = "arkher.material.instance.quality_policy"
	S.name = "Material Instance Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.instance.compression_codec" }
	S.tags = { "e", "instance", "policy", "material" }
	S.description = "Material Instance Quality Policy: device tier rules for the surface for the Material Instance subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.instance.quality_policy", algorithm = "lottery", starvationGuard = 55 })
		inst.system = S
		inst.ctx = ctx
