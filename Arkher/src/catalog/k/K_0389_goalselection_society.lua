-- ARKHER SYSTEM K.0389 :: Goal Selection Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0389"
	S.key = "arkher.npc.goalselection.social_relations"
	S.name = "Goal Selection Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.goalselection.crowd_steering" }
	S.tags = { "k", "goalselection", "society", "npc" }
	S.description = "Goal Selection Social Relations: affinity, factions, reputation and gossip for the Goal Selection subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.goalselection.social_relations", decayRate = 0.012, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
