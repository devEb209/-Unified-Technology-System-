-- ARKHER SYSTEM H.0250 :: Broadphase Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0250"
	S.key = "arkher.physics.broadphase.analysis"
	S.name = "Broadphase Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Broadphase"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.broadphase.result_cache" }
	S.tags = { "h", "broadphase", "analyzer", "physics" }
	S.description = "Broadphase Analysis: energy, jitter and cost analysis of the simulation for the Broadphase subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.broadphase.analysis", window = 86, buckets = 14, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
