-- ARKHER SYSTEM O.0321 :: Vehicle Audio Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0321"
	S.key = "arkher.audio.vehicleaudio.playback_policy"
	S.name = "Vehicle Audio Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.vehicleaudio.compression_codec" }
	S.tags = { "o", "vehicleaudio", "policy", "audio" }
	S.description = "Vehicle Audio Playback Policy: rules choosing what may be heard right now for the Vehicle Audio subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.vehicleaudio.playback_policy", algorithm = "wfq", starvationGuard = 58 })
		inst.system = S
		inst.ctx = ctx
