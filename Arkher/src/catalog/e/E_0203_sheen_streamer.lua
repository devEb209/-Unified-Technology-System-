-- ARKHER SYSTEM E.0203 :: Sheen Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0203"
	S.key = "arkher.material.sheen.streaming"
	S.name = "Sheen Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Sheen"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.sheen.parameter_budget" }
	S.tags = { "e", "sheen", "streamer", "material" }
	S.description = "Sheen Streaming: residency and demand-driven texture streaming for the Sheen subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.sheen.streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
