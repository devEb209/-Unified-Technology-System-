-- ARKHER SYSTEM I.0206 :: State Machine Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0206"
	S.key = "arkher.anim.animstate.quality_policy"
	S.name = "State Machine Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstate.pose_cache" }
	S.tags = { "i", "animstate", "policy", "anim" }
	S.description = "State Machine Quality Policy: device tier rules for rate, bones and solvers for the State Machine subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.animstate.quality_policy", algorithm = "wfq", starvationGuard = 50 })
		inst.system = S
		inst.ctx = ctx
