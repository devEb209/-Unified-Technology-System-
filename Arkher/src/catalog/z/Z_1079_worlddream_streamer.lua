-- ARKHER SYSTEM Z.1079 :: World Dream State Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.1079"
	S.key = "arkher.origin.worlddream.residency_streaming"
	S.name = "World Dream State Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.budget_governor" }
	S.tags = { "z", "worlddream", "streamer", "origin" }
	S.description = "World Dream State Residency Streaming: distance-driven residency of the technology's workload for the World Dream State subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.worlddream.residency_streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
