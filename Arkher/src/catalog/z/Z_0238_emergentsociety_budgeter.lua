-- ARKHER SYSTEM Z.0238 :: Emergent Society Framework Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0238"
	S.key = "arkher.origin.emergentsociety.budget_governor"
	S.name = "Emergent Society Framework Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentsociety.behaviour_analysis" }
	S.tags = { "z", "emergentsociety", "budgeter", "origin" }
	S.description = "Emergent Society Framework Budget Governor: allocation of a scarce resource across the technology's consumers for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.emergentsociety.budget_governor", total = 417, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
