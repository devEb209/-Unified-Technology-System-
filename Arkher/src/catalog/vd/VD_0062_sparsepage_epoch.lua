-- ARKHER SYSTEM VD.0062 :: Sparse Page Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0062"
	S.key = "arkher.contsim.sparsepage.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.sparsepage.infinite_grid" }
	S.tags = { "vd", "sparsepage", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.sparsepage.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
