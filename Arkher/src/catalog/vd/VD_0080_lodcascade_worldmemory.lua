-- ARKHER SYSTEM VD.0080 :: LOD Cascade World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0080"
	S.key = "arkher.contsim.lodcascade.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lodcascade.neural_field" }
	S.tags = { "vd", "lodcascade", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.lodcascade.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
