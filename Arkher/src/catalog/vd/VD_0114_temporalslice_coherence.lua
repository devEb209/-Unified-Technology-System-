-- ARKHER SYSTEM VD.0114 :: Temporal Slice Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0114"
	S.key = "arkher.contsim.temporalslice.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.temporalslice.persistent_state" }
	S.tags = { "vd", "temporalslice", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.temporalslice.coherence_guard", window = 72, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
