-- ARKHER SYSTEM VA.0601 :: Seam Lattice Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0601"
	S.key = "arkher.contworld.seamlattice.infinite_grid"
	S.name = "Seam Lattice Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "seamlattice", "continuum", "contworld" }
	S.description = "Seam Lattice Infinite Grid: seamless paging of the infinite world grid for the Seam Lattice subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.seamlattice.infinite_grid", cellSize = 224, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
