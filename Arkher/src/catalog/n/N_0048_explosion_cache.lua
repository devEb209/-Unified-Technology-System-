-- ARKHER SYSTEM N.0048 :: Explosion Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0048"
	S.key = "arkher.vfx.explosion.result_cache"
	S.name = "Explosion Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Explosion"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.explosion.spawn_budget" }
	S.tags = { "n", "explosion", "cache", "vfx" }
	S.description = "Explosion Result Cache: reuse of expensive effect evaluations for the Explosion subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.explosion.result_cache", policy = "lfu", capacity = 386, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
