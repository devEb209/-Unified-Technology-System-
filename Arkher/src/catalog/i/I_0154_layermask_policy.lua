-- ARKHER SYSTEM I.0154 :: Layer Mask Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0154"
	S.key = "arkher.anim.layermask.quality_policy"
	S.name = "Layer Mask Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Layer Mask"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.layermask.pose_cache" }
	S.tags = { "i", "layermask", "policy", "anim" }
	S.description = "Layer Mask Quality Policy: device tier rules for rate, bones and solvers for the Layer Mask subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.layermask.quality_policy", algorithm = "lottery", starvationGuard = 63 })
		inst.system = S
		inst.ctx = ctx
