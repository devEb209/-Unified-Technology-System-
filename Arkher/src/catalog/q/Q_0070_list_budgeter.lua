-- ARKHER SYSTEM Q.0070 :: List Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0070"
	S.key = "arkher.ui.list.frame_budget"
	S.name = "List Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "List"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.list.accessibility_policy" }
	S.tags = { "q", "list", "budgeter", "ui" }
	S.description = "List Frame Budget: per-frame layout and draw budget for the interface for the List subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.list.frame_budget", total = 163, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
