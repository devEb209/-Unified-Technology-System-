-- ARKHER SYSTEM V.0377 :: Cook Target Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0377"
	S.key = "arkher.asset.cooktarget.dependency_graph"
	S.name = "Cook Target Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.cooktarget.asset_registry" }
	S.tags = { "v", "cooktarget", "graph", "asset" }
	S.description = "Cook Target Dependency Graph: what references what, and in which order it must be built for the Cook Target subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.cooktarget.dependency_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
