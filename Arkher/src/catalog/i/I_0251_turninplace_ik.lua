-- ARKHER SYSTEM I.0251 :: Turn In Place Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0251"
	S.key = "arkher.anim.turninplace.inverse_kinematics"
	S.name = "Turn In Place Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.turninplace.layered_blending" }
	S.tags = { "i", "turninplace", "ik", "anim" }
	S.description = "Turn In Place Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Turn In Place subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.turninplace.inverse_kinematics", iterations = 14, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
