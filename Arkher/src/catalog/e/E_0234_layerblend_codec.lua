-- ARKHER SYSTEM E.0234 :: Layer Blending Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0234"
	S.key = "arkher.material.layerblend.compression_codec"
	S.name = "Layer Blending Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.layerblend.streaming" }
	S.tags = { "e", "layerblend", "codec", "material" }
	S.description = "Layer Blending Compression Codec: serialization and compression of material data for the Layer Blending subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.layerblend.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
