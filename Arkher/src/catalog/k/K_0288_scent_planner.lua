-- ARKHER SYSTEM K.0288 :: Scent Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0288"
	S.key = "arkher.npc.scent.goal_planner"
	S.name = "Scent Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.scent.utility_reasoning" }
	S.tags = { "k", "scent", "planner", "npc" }
	S.description = "Scent Goal Planner: backward GOAP planning to reach a goal state for the Scent subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.scent.goal_planner", maxDepth = 11 })
		inst.system = S
		inst.ctx = ctx
