-- ARKHER SYSTEM J.0075 :: Teeth Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0075"
	S.key = "arkher.character.teeth.budget_governor"
	S.name = "Teeth Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.teeth.variant_registry" }
	S.tags = { "j", "teeth", "budgeter", "character" }
	S.description = "Teeth Budget Governor: per-character cost allocation in a crowd for the Teeth subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.teeth.budget_governor", total = 94, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
