-- ARKHER SYSTEM W.0400 :: Cinematic Debug Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0400"
	S.key = "arkher.cine.cinedebug.shot_composition"
	S.name = "Cinematic Debug Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinedebug.colour_grade" }
	S.tags = { "w", "cinedebug", "composer", "cine" }
	S.description = "Cinematic Debug Shot Composition: blending of the signals that make up the final shot for the Cinematic Debug subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.cinedebug.shot_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
