-- ARKHER SYSTEM P.0467 :: Tutorial Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0467"
	S.key = "arkher.play.tutorial.save_codec"
	S.name = "Tutorial Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Tutorial"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.tutorial.content_registry" }
	S.tags = { "p", "tutorial", "codec", "play" }
	S.description = "Tutorial Save Codec: persistence, diffing and checksum of gameplay state for the Tutorial subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.tutorial.save_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
