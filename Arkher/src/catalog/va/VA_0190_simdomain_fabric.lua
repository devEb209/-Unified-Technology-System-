-- ARKHER SYSTEM VA.0190 :: Simulation Domain Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0190"
	S.key = "arkher.contworld.simdomain.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.simdomain.complexity_budget" }
	S.tags = { "va", "simdomain", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.simdomain.simulation_fabric", budgetMs = 2.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
