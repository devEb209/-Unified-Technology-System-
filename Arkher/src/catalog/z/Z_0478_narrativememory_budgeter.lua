-- ARKHER SYSTEM Z.0478 :: Narrative Memory Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0478"
	S.key = "arkher.origin.narrativememory.budget_governor"
	S.name = "Narrative Memory Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.behaviour_analysis" }
	S.tags = { "z", "narrativememory", "budgeter", "origin" }
	S.description = "Narrative Memory Budget Governor: allocation of a scarce resource across the technology's consumers for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.narrativememory.budget_governor", total = 224, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
