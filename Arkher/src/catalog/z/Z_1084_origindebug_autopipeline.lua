-- ARKHER SYSTEM Z.1084 :: Original Tech Debug Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.1084"
	S.key = "arkher.origin.origindebug.autonomous_pipeline"
	S.name = "Original Tech Debug Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.origindebug.simulation_fabric" }
	S.tags = { "z", "origindebug", "autopipeline", "origin" }
	S.description = "Original Tech Debug Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Original Tech Debug subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.origindebug.autonomous_pipeline", maxIterations = 11 })
		inst.system = S
		inst.ctx = ctx
