-- ARKHER SYSTEM VC.0113 :: Temporal Slice Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0113"
	S.key = "arkher.contneural.temporalslice.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.temporalslice.multi-scale_fidelity" }
	S.tags = { "vc", "temporalslice", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.temporalslice.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
