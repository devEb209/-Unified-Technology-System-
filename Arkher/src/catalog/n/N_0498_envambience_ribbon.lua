-- ARKHER SYSTEM N.0498 :: Environment Ambience Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0498"
	S.key = "arkher.vfx.envambience.ribbon_and_trail"
	S.name = "Environment Ambience Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.envambience.force_field" }
	S.tags = { "n", "envambience", "ribbon", "vfx" }
	S.description = "Environment Ambience Ribbon And Trail: trail points, tapering, beams and decimation for the Environment Ambience subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.envambience.ribbon_and_trail", maxPoints = 24, lifetime = 0.80, minDistance = 0.25, width = 0.90 })
		inst.system = S
		inst.ctx = ctx
