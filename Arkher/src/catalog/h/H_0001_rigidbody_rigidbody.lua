-- ARKHER SYSTEM H.0001 :: Rigid Body Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0001"
	S.key = "arkher.physics.rigidbody.body_dynamics"
	S.name = "Rigid Body Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Rigid Body"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "rigidbody", "rigidbody", "physics" }
	S.description = "Rigid Body Body Dynamics: integration, impulses, damping and sleeping of a body for the Rigid Body subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.rigidbody.body_dynamics", mass = 21.00, radius = 0.30, restitution = 0.40, friction = 0.50, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
