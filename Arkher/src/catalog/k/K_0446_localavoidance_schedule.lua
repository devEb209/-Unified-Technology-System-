-- ARKHER SYSTEM K.0446 :: Local Avoidance Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0446"
	S.key = "arkher.npc.localavoidance.daily_schedule"
	S.name = "Local Avoidance Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.localavoidance.social_relations" }
	S.tags = { "k", "localavoidance", "schedule", "npc" }
	S.description = "Local Avoidance Daily Schedule: hour-by-hour routine with priority interruptions for the Local Avoidance subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.localavoidance.daily_schedule", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
