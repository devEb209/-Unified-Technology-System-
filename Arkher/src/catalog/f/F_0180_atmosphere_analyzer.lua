-- ARKHER SYSTEM F.0180 :: Atmosphere Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0180"
	S.key = "arkher.render.atmosphere.frame_analysis"
	S.name = "Atmosphere Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Atmosphere"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.atmosphere.pass_cache" }
	S.tags = { "f", "atmosphere", "analyzer", "render" }
	S.description = "Atmosphere Frame Analysis: per-pass cost analysis and outlier detection for the Atmosphere subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.atmosphere.frame_analysis", window = 186, buckets = 18, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
