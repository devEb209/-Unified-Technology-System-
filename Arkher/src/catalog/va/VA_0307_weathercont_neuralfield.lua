-- ARKHER SYSTEM VA.0307 :: Weather Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0307"
	S.key = "arkher.contworld.weathercont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.weathercont.coherence_guard" }
	S.tags = { "va", "weathercont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.weathercont.neural_field", dims = 12, hidden = 8, seed = 11968 })
		inst.system = S
		inst.ctx = ctx
