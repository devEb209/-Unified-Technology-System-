-- ARKHER SYSTEM L.0001 :: Living World Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0001"
	S.key = "arkher.sim.livingworld.simulation_core"
	S.name = "Living World Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "livingworld", "simulation", "sim" }
	S.description = "Living World Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Living World subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.livingworld.simulation_core", fullRadius = 280, reducedRadius = 800, budget = 114 })
		inst.system = S
		inst.ctx = ctx
