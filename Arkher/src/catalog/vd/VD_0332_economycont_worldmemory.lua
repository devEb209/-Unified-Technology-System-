-- ARKHER SYSTEM VD.0332 :: Economy Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0332"
	S.key = "arkher.contsim.economycont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.economycont.neural_field" }
	S.tags = { "vd", "economycont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.economycont.world_memory_stream", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
