-- ARKHER SYSTEM V.0049 :: Material Asset Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0049"
	S.key = "arkher.asset.materialasset.import"
	S.name = "Material Asset Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "materialasset", "importer", "asset" }
	S.description = "Material Asset Import: validation, normalization, hashing and deduplication of incoming content for the Material Asset subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.materialasset.import", unitScale = 1.50 })
		inst.system = S
		inst.ctx = ctx
