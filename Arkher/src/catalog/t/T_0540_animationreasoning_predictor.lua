-- ARKHER SYSTEM T.0540 :: Animation Reasoning Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0540"
	S.key = "arkher.ai.animationreasoning.outcome_prediction"
	S.name = "Animation Reasoning Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.animationreasoning.decision_policy" }
	S.tags = { "t", "animationreasoning", "predictor", "ai" }
	S.description = "Animation Reasoning Outcome Prediction: forecasting the result before the work is done for the Animation Reasoning subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.animationreasoning.outcome_prediction", method = "linear", alpha = 0.30, window = 108 })
		inst.system = S
		inst.ctx = ctx
