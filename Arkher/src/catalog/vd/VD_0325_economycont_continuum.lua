-- ARKHER SYSTEM VD.0325 :: Economy Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0325"
	S.key = "arkher.contsim.economycont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "economycont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.economycont.infinite_grid", cellSize = 224, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
