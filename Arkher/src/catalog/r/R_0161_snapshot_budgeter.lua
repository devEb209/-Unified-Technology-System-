-- ARKHER SYSTEM R.0161 :: Snapshot Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0161"
	S.key = "arkher.net.snapshot.bandwidth_budget"
	S.name = "Snapshot Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Snapshot"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.snapshot.transport_graph" }
	S.tags = { "r", "snapshot", "budgeter", "net" }
	S.description = "Snapshot Bandwidth Budget: bytes per second shared between competing streams for the Snapshot subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.snapshot.bandwidth_budget", total = 442, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
