-- ARKHER SYSTEM W.0329 :: Exposure Ramp Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0329"
	S.key = "arkher.cine.exposureramp.cut_policy"
	S.name = "Exposure Ramp Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.exposureramp.shot_composition" }
	S.tags = { "w", "exposureramp", "policy", "cine" }
	S.description = "Exposure Ramp Cut Policy: rules deciding when the sequence cuts and to what for the Exposure Ramp subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.exposureramp.cut_policy", algorithm = "edf", starvationGuard = 53 })
		inst.system = S
		inst.ctx = ctx
