-- ARKHER SYSTEM Q.0155 :: Tab Bar Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0155"
	S.key = "arkher.ui.tabbar.usability_analysis"
	S.name = "Tab Bar Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tab Bar"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.tabbar.frame_budget" }
	S.tags = { "q", "tabbar", "analyzer", "ui" }
	S.description = "Tab Bar Usability Analysis: reachability, latency and abandonment analysis for the Tab Bar subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.tabbar.usability_analysis", window = 203, buckets = 15, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
