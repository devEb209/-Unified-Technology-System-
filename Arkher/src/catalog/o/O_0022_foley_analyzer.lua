-- ARKHER SYSTEM O.0022 :: Foley Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0022"
	S.key = "arkher.audio.foley.analysis"
	S.name = "Foley Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Foley"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.foley.playback_policy" }
	S.tags = { "o", "foley", "analyzer", "audio" }
	S.description = "Foley Analysis: loudness, headroom and masking analysis for the Foley subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.foley.analysis", window = 72, buckets = 8, threshold = 4.40 })
		inst.system = S
		inst.ctx = ctx
