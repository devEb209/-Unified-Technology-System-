-- ARKHER SYSTEM E.0083 :: Normal Detail Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0083"
	S.key = "arkher.material.normaldetail.streaming"
	S.name = "Normal Detail Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.normaldetail.parameter_budget" }
	S.tags = { "e", "normaldetail", "streamer", "material" }
	S.description = "Normal Detail Streaming: residency and demand-driven texture streaming for the Normal Detail subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.normaldetail.streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
