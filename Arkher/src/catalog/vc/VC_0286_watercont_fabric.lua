-- ARKHER SYSTEM VC.0286 :: Water Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0286"
	S.key = "arkher.contneural.watercont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.watercont.complexity_budget" }
	S.tags = { "vc", "watercont", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.watercont.simulation_fabric", budgetMs = 2.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
