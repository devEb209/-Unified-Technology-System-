-- ARKHER SYSTEM G.0161 :: Geometry Detail Prediction Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0161"
	S.key = "arkher.neural.geodetail.quality_predictor"
	S.name = "Geometry Detail Prediction Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.geodetail.weight_codec" }
	S.tags = { "g", "geodetail", "predictor", "neural" }
	S.description = "Geometry Detail Prediction Quality Predictor: predicted quality and cost of a setting for the Geometry Detail Prediction subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.geodetail.quality_predictor", method = "markov", alpha = 0.19, window = 49 })
		inst.system = S
		inst.ctx = ctx
