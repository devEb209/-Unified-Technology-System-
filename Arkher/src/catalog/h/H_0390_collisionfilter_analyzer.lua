-- ARKHER SYSTEM H.0390 :: Collision Filter Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0390"
	S.key = "arkher.physics.collisionfilter.analysis"
	S.name = "Collision Filter Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionfilter.result_cache" }
	S.tags = { "h", "collisionfilter", "analyzer", "physics" }
	S.description = "Collision Filter Analysis: energy, jitter and cost analysis of the simulation for the Collision Filter subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.collisionfilter.analysis", window = 88, buckets = 16, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
