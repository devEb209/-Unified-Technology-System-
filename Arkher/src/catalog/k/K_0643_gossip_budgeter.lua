-- ARKHER SYSTEM K.0643 :: Gossip Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0643"
	S.key = "arkher.npc.gossip.thinking_budget"
	S.name = "Gossip Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.gossip.daily_schedule" }
	S.tags = { "k", "gossip", "budgeter", "npc" }
	S.description = "Gossip Thinking Budget: allocation of per-frame thinking time across NPCs for the Gossip subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.gossip.thinking_budget", total = 404, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
