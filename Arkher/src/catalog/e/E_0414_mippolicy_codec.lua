-- ARKHER SYSTEM E.0414 :: Mip Policy Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0414"
	S.key = "arkher.material.mippolicy.compression_codec"
	S.name = "Mip Policy Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Mip Policy"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.mippolicy.streaming" }
	S.tags = { "e", "mippolicy", "codec", "material" }
	S.description = "Mip Policy Compression Codec: serialization and compression of material data for the Mip Policy subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.mippolicy.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
