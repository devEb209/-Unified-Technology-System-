-- ARKHER SYSTEM K.0015 :: Neural Policy Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0015"
	S.key = "arkher.npc.neuralpolicy.mind_network"
	S.name = "Neural Policy Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "neuralpolicy", "mindnet", "npc" }
	S.description = "Neural Policy Mind Network: the learned policy that turns perception into a decision for the Neural Policy subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.neuralpolicy.mind_network", inputs = 7, hidden = 8, seed = 58109, learningRate = 0.095, exploration = 0.045 })
		inst.system = S
		inst.ctx = ctx
