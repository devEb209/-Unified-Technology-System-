-- ARKHER SYSTEM H.0303 :: Capsule Collider Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0303"
	S.key = "arkher.physics.capsulecollider.budget_governor"
	S.name = "Capsule Collider Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.capsulecollider.broadphase_index" }
	S.tags = { "h", "capsulecollider", "budgeter", "physics" }
	S.description = "Capsule Collider Budget Governor: simulation time budget allocation across islands for the Capsule Collider subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.capsulecollider.budget_governor", total = 300, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
