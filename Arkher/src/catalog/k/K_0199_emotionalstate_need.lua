-- ARKHER SYSTEM K.0199 :: Emotional State Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0199"
	S.key = "arkher.npc.emotionalstate.drive_system"
	S.name = "Emotional State Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.emotionalstate.memory" }
	S.tags = { "k", "emotionalstate", "need", "npc" }
	S.description = "Emotional State Drive System: drives that decay, turn urgent and get satisfied for the Emotional State subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.emotionalstate.drive_system" })
		inst.system = S
		inst.ctx = ctx
