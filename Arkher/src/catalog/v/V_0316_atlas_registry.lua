-- ARKHER SYSTEM V.0316 :: Texture Atlas Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0316"
	S.key = "arkher.asset.atlas.asset_registry"
	S.name = "Texture Atlas Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.atlas.cook_pipeline" }
	S.tags = { "v", "atlas", "registry", "asset" }
	S.description = "Texture Atlas Asset Registry: catalogue of every asset, its tags and its metadata for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.atlas.asset_registry" })
		inst.system = S
		inst.ctx = ctx
