-- ARKHER SYSTEM W.0063 :: Tracking Shot Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0063"
	S.key = "arkher.cine.tracking.colour_grade"
	S.name = "Tracking Shot Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.tracking.camera_rig" }
	S.tags = { "w", "tracking", "grade", "cine" }
	S.description = "Tracking Shot Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Tracking Shot subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.tracking.colour_grade", exposure = 0.00, contrast = 1.05, saturation = 1.15, toneMap = "reinhard" })
		inst.system = S
		inst.ctx = ctx
