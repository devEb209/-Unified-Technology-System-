-- ARKHER SYSTEM F.0320 :: Depth Of Field Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0320"
	S.key = "arkher.render.dof.frame_analysis"
	S.name = "Depth Of Field Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.dof.pass_cache" }
	S.tags = { "f", "dof", "analyzer", "render" }
	S.description = "Depth Of Field Frame Analysis: per-pass cost analysis and outlier detection for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.dof.frame_analysis", window = 93, buckets = 17, threshold = 3.50 })
		inst.system = S
		inst.ctx = ctx
