-- ARKHER SYSTEM Z.0412 :: Battery Aware Pipeline Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0412"
	S.key = "arkher.origin.batteryaware.predictive_optimization"
	S.name = "Battery Aware Pipeline Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.batteryaware.adaptive_workflow" }
	S.tags = { "z", "batteryaware", "predictor", "origin" }
	S.description = "Battery Aware Pipeline Predictive Optimization: forecast-driven optimization before the cost is paid for the Battery Aware Pipeline subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.batteryaware.predictive_optimization", method = "linear", alpha = 0.26, window = 48 })
		inst.system = S
		inst.ctx = ctx
