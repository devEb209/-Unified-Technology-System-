-- ARKHER SYSTEM H.0468 :: Hinge Joint Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0468"
	S.key = "arkher.physics.hingejoint.character_motion"
	S.name = "Hinge Joint Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Hinge Joint"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.hingejoint.query" }
	S.tags = { "h", "hingejoint", "charmotor", "physics" }
	S.description = "Hinge Joint Character Motion: capsule move-and-slide with slopes, steps and jumps for the Hinge Joint subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.hingejoint.character_motion", radius = 0.35, height = 1.60, maxSpeed = 4.00, jumpHeight = 1.20, stepOffset = 0.25 })
		inst.system = S
		inst.ctx = ctx
