-- ARKHER SYSTEM Q.0383 :: Localization Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0383"
	S.key = "arkher.ui.localization.usability_analysis"
	S.name = "Localization Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Localization"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.localization.frame_budget" }
	S.tags = { "q", "localization", "analyzer", "ui" }
	S.description = "Localization Usability Analysis: reachability, latency and abandonment analysis for the Localization subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.localization.usability_analysis", window = 243, buckets = 19, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
