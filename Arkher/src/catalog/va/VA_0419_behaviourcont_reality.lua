-- ARKHER SYSTEM VA.0419 :: Behaviour Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0419"
	S.key = "arkher.contworld.behaviourcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.behaviourcont.simulation_fabric" }
	S.tags = { "va", "behaviourcont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.behaviourcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
