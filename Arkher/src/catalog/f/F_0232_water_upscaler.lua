-- ARKHER SYSTEM F.0232 :: Water Rendering Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0232"
	S.key = "arkher.render.water.adaptive_resolution"
	S.name = "Water Rendering Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.water.temporal_resolve" }
	S.tags = { "f", "water", "upscaler", "render" }
	S.description = "Water Rendering Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Water Rendering subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.water.adaptive_resolution", targetMs = 14.10, index = 3, sharpness = 0.57 })
		inst.system = S
		inst.ctx = ctx
