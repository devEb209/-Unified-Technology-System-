-- ARKHER SYSTEM VC.0572 :: Mobile Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0572"
	S.key = "arkher.contneural.mobilecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.mobilecont.neural_field" }
	S.tags = { "vc", "mobilecont", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.mobilecont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
