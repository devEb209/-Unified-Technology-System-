-- ARKHER SYSTEM R.0014 :: Connection Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0014"
	S.key = "arkher.net.connection.time_sync"
	S.name = "Connection Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Connection"
	S.aspect = "Time Sync"
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.connection.replication" }
	S.tags = { "r", "connection", "netclock", "net" }
	S.description = "Connection Time Sync: offset estimation, outlier rejection and jitter buffering for the Connection subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.connection.time_sync", tickRate = 20, bufferDelay = 0.100, maxSamples = 8 })
		inst.system = S
		inst.ctx = ctx
