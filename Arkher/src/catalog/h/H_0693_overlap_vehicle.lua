-- ARKHER SYSTEM H.0693 :: Overlap Query Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0693"
	S.key = "arkher.physics.overlap.vehicle"
	S.name = "Overlap Query Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.overlap.character_motion" }
	S.tags = { "h", "overlap", "vehicle", "physics" }
	S.description = "Overlap Query Vehicle: suspension, drivetrain, steering and tire friction for the Overlap Query subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.overlap.vehicle", mass = 1100, wheelbase = 2.20, track = 1.80, maxRpm = 5600 })
		inst.system = S
		inst.ctx = ctx
