-- ARKHER SYSTEM I.0175 :: Crossfade Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0175"
	S.key = "arkher.anim.crossfade.retarget_graph"
	S.name = "Crossfade Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Crossfade"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crossfade.physical_blend" }
	S.tags = { "i", "crossfade", "graph", "anim" }
	S.description = "Crossfade Retarget Graph: bone mapping and retarget path resolution for the Crossfade subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.crossfade.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
	...
	function inst.hotNodes(limit)
		...
		function inst.integrate(engine)
			...
			inst.engine = engine
			if engine.bus then
				engine.bus:subscribe("arkher.anim.crossfade.*", function(payload) inst.lastSignal = payload end)
			end
