-- ARKHER SYSTEM K.0457 :: Crowd Flow Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0457"
	S.key = "arkher.npc.crowdflow.navigation"
	S.name = "Crowd Flow Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.crowdflow.goal_planner" }
	S.tags = { "k", "crowdflow", "navgraph", "npc" }
	S.description = "Crowd Flow Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Crowd Flow subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.crowdflow.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
