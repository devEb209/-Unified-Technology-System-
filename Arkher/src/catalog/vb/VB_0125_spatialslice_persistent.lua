-- ARKHER SYSTEM VB.0125 :: Spatial Slice Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0125"
	S.key = "arkher.conttime.spatialslice.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.spatialslice.multi-scale_fidelity" }
	S.tags = { "vb", "spatialslice", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.spatialslice.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
