-- ARKHER SYSTEM I.0132 :: Animation Layer Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0132"
	S.key = "arkher.anim.animlayer.clip_sampling"
	S.name = "Animation Layer Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlayer.skeleton" }
	S.tags = { "i", "animlayer", "clip", "anim" }
	S.description = "Animation Layer Clip Sampling: keyframe tracks sampled, retimed and evented for the Animation Layer subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.animlayer.clip_sampling", duration = 2.10, loop = true })
		inst.system = S
		inst.ctx = ctx
