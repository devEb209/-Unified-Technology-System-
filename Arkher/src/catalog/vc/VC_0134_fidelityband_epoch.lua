-- ARKHER SYSTEM VC.0134 :: Fidelity Band Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0134"
	S.key = "arkher.contneural.fidelityband.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.fidelityband.infinite_grid" }
	S.tags = { "vc", "fidelityband", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.fidelityband.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
