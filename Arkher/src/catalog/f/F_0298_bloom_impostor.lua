-- ARKHER SYSTEM F.0298 :: Bloom Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0298"
	S.key = "arkher.render.bloom.geometry_virtualization"
	S.name = "Bloom Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Bloom"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.bloom.visibility_set" }
	S.tags = { "f", "bloom", "impostor", "render" }
	S.description = "Bloom Geometry Virtualization: impostor and HLOD synthesis under a budget for the Bloom subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.bloom.geometry_virtualization", atlasSlots = 96, viewCount = 8, errorThreshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
