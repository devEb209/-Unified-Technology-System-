-- ARKHER SYSTEM Z.0147 :: Autonomous Development Pipeline World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0147"
	S.key = "arkher.origin.autodevpipeline.world_architect"
	S.name = "Autonomous Development Pipeline World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodevpipeline.emergence_detection" }
	S.tags = { "z", "autodevpipeline", "architect", "origin" }
	S.description = "Autonomous Development Pipeline World Architect: hierarchical world composition with conserved budgets for the Autonomous Development Pipeline subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.autodevpipeline.world_architect", budget = 1200, seed = 42416 })
		inst.system = S
		inst.ctx = ctx
