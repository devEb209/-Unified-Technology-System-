-- ARKHER SYSTEM I.0295 :: Look At IK Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0295"
	S.key = "arkher.anim.lookatik.playback_pipeline"
	S.name = "Look At IK Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Look At IK"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.lookatik.event_ledger" }
	S.tags = { "i", "lookatik", "pipeline", "anim" }
	S.description = "Look At IK Playback Pipeline: ordered sample, blend, ik and output stages for the Look At IK subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.lookatik.playback_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
