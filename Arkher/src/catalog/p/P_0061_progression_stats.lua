-- ARKHER SYSTEM P.0061 :: Progression Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0061"
	S.key = "arkher.play.progression.attributes"
	S.name = "Progression Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Progression"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "progression", "stats", "play" }
	S.description = "Progression Attributes: base values, layered modifiers and derived statistics for the Progression subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.progression.attributes" })
		inst.system = S
		inst.ctx = ctx
