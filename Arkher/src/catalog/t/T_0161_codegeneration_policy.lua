-- ARKHER SYSTEM T.0161 :: Code Generation Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0161"
	S.key = "arkher.ai.codegeneration.decision_policy"
	S.name = "Code Generation Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.codegeneration.reasoning_graph" }
	S.tags = { "t", "codegeneration", "policy", "ai" }
	S.description = "Code Generation Decision Policy: ordered rules deciding what the agent does next for the Code Generation subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.codegeneration.decision_policy", algorithm = "wfq", starvationGuard = 46 })
		inst.system = S
		inst.ctx = ctx
