-- ARKHER SYSTEM VC.0543 :: World Fabric Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0543"
	S.key = "arkher.contneural.worldfabric.sparse_residency"
	S.name = "World Fabric Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldfabric.epoch_clock" }
	S.tags = { "vc", "worldfabric", "sparse", "contneural" }
	S.description = "World Fabric Sparse Residency: sparse page residency with eviction and compression for the World Fabric subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.worldfabric.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
