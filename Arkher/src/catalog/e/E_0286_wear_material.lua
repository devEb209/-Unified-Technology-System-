-- ARKHER SYSTEM E.0286 :: Wear And Tear Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0286"
	S.key = "arkher.material.wear.definition"
	S.name = "Wear And Tear Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "wear", "material", "material" }
	S.description = "Wear And Tear Definition: layered PBR definition resolved into parameters for the Wear And Tear subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.wear.definition", texelBudget = 786432 })
		inst.system = S
		inst.ctx = ctx
