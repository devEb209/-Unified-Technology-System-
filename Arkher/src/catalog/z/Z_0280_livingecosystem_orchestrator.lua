-- ARKHER SYSTEM Z.0280 :: Living Ecosystem Engine Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0280"
	S.key = "arkher.origin.livingecosystem.orchestration"
	S.name = "Living Ecosystem Engine Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.livingecosystem.residency_streaming" }
	S.tags = { "z", "livingecosystem", "orchestrator", "origin" }
	S.description = "Living Ecosystem Engine Orchestration: lifecycle and phase orchestration of the technology for the Living Ecosystem Engine subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.livingecosystem.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
