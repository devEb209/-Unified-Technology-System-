-- ARKHER SYSTEM J.0268 :: Wetness Response Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0268"
	S.key = "arkher.character.wetnessresponse.look_and_reach"
	S.name = "Wetness Response Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.wetnessresponse.blend_controller" }
	S.tags = { "j", "wetnessresponse", "ik", "character" }
	S.description = "Wetness Response Look And Reach: look-at, reach and foot placement for the character for the Wetness Response subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.wetnessresponse.look_and_reach", iterations = 14, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
