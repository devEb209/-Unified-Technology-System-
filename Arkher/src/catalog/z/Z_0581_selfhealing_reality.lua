-- ARKHER SYSTEM Z.0581 :: Self Healing Systems Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0581"
	S.key = "arkher.origin.selfhealing.reality_layering"
	S.name = "Self Healing Systems Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "selfhealing", "reality", "origin" }
	S.description = "Self Healing Systems Reality Layering: stacked authored, simulated, proposed and player realities for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.selfhealing.reality_layering" })
		inst.system = S
		inst.ctx = ctx
