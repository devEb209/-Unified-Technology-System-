-- ARKHER SYSTEM H.0146 :: Linear Damping Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0146"
	S.key = "arkher.physics.lineardamping.character_motion"
	S.name = "Linear Damping Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.lineardamping.query" }
	S.tags = { "h", "lineardamping", "charmotor", "physics" }
	S.description = "Linear Damping Character Motion: capsule move-and-slide with slopes, steps and jumps for the Linear Damping subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.lineardamping.character_motion", radius = 0.36, height = 1.81, maxSpeed = 8.10, jumpHeight = 1.70, stepOffset = 0.36 })
		inst.system = S
		inst.ctx = ctx
