-- ARKHER SYSTEM V.0061 :: Shader Asset Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0061"
	S.key = "arkher.asset.shaderasset.import"
	S.name = "Shader Asset Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "shaderasset", "importer", "asset" }
	S.description = "Shader Asset Import: validation, normalization, hashing and deduplication of incoming content for the Shader Asset subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.shaderasset.import", unitScale = 1.75 })
		inst.system = S
		inst.ctx = ctx
