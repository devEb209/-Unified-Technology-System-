-- ARKHER SYSTEM V.0003 :: Mesh Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0003"
	S.key = "arkher.asset.meshasset.cook_pipeline"
	S.name = "Mesh Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.meshasset.bundling" }
	S.tags = { "v", "meshasset", "pipeline", "asset" }
	S.description = "Mesh Cook Pipeline: staged cooking with isolation and retries for the Mesh subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.meshasset.cook_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
