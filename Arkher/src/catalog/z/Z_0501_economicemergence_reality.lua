-- ARKHER SYSTEM Z.0501 :: Economic Emergence Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0501"
	S.key = "arkher.origin.economicemergence.reality_layering"
	S.name = "Economic Emergence Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "economicemergence", "reality", "origin" }
	S.description = "Economic Emergence Reality Layering: stacked authored, simulated, proposed and player realities for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.economicemergence.reality_layering" })
		inst.system = S
		inst.ctx = ctx
