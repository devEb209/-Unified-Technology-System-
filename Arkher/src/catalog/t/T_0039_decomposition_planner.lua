-- ARKHER SYSTEM T.0039 :: Task Decomposition Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0039"
	S.key = "arkher.ai.decomposition.action_planner"
	S.name = "Task Decomposition Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.decomposition.utility_selection" }
	S.tags = { "t", "decomposition", "planner", "ai" }
	S.description = "Task Decomposition Action Planner: goal-oriented action planning over preconditions for the Task Decomposition subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.decomposition.action_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
