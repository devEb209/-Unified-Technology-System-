-- ARKHER SYSTEM P.0449 :: Difficulty State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0449"
	S.key = "arkher.play.difficulty.state_machine"
	S.name = "Difficulty State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Difficulty"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.difficulty.combat_resolution" }
	S.tags = { "p", "difficulty", "orchestrator", "play" }
	S.description = "Difficulty State Machine: the phase machine that drives this gameplay loop for the Difficulty subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.difficulty.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
