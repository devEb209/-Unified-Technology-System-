-- ARKHER SYSTEM L.0547 :: Festival Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0547"
	S.key = "arkher.sim.festival.route_network"
	S.name = "Festival Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.festival.region_graph" }
	S.tags = { "l", "festival", "network", "sim" }
	S.description = "Festival Route Network: roads, rivers and routes between settlements for the Festival subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.festival.route_network" })
		inst.system = S
		inst.ctx = ctx
