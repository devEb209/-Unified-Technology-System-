-- ARKHER SYSTEM Z.0336 :: Cross Reality Sync Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0336"
	S.key = "arkher.origin.crossreality.governance_policy"
	S.name = "Cross Reality Sync Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.signal_composition" }
	S.tags = { "z", "crossreality", "policy", "origin" }
	S.description = "Cross Reality Sync Governance Policy: ordered rules governing when the technology may act for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.crossreality.governance_policy", algorithm = "wfq", starvationGuard = 42 })
		inst.system = S
		inst.ctx = ctx
