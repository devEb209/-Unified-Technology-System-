-- ARKHER SYSTEM F.0613 :: Frame Capture Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0613"
	S.key = "arkher.render.framecapture.pass_cache"
	S.name = "Frame Capture Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framecapture.render_policy" }
	S.tags = { "f", "framecapture", "cache", "render" }
	S.description = "Frame Capture Pass Cache: reuse of pass results across frames for the Frame Capture subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.framecapture.pass_cache", policy = "lru", capacity = 232, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
