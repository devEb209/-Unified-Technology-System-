-- ARKHER SYSTEM I.0334 :: Ragdoll Blend Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0334"
	S.key = "arkher.anim.ragdollblend.playback_pipeline"
	S.name = "Ragdoll Blend Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.ragdollblend.event_ledger" }
	S.tags = { "i", "ragdollblend", "pipeline", "anim" }
	S.description = "Ragdoll Blend Playback Pipeline: ordered sample, blend, ik and output stages for the Ragdoll Blend subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.ragdollblend.playback_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
