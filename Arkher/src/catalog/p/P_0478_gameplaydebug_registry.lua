-- ARKHER SYSTEM P.0478 :: Gameplay Debug Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0478"
	S.key = "arkher.play.gameplaydebug.content_registry"
	S.name = "Gameplay Debug Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.gameplaydebug.difficulty_controller" }
	S.tags = { "p", "gameplaydebug", "registry", "play" }
	S.description = "Gameplay Debug Content Registry: catalogue of the definitions this loop instantiates for the Gameplay Debug subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.gameplaydebug.content_registry" })
		inst.system = S
		inst.ctx = ctx
