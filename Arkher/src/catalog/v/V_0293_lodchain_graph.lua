-- ARKHER SYSTEM V.0293 :: LOD Chain Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0293"
	S.key = "arkher.asset.lodchain.dependency_graph"
	S.name = "LOD Chain Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lodchain.asset_registry" }
	S.tags = { "v", "lodchain", "graph", "asset" }
	S.description = "LOD Chain Dependency Graph: what references what, and in which order it must be built for the LOD Chain subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.lodchain.dependency_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
