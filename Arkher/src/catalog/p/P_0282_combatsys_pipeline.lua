-- ARKHER SYSTEM P.0282 :: Combat Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0282"
	S.key = "arkher.play.combatsys.rule_pipeline"
	S.name = "Combat Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Combat"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.combatsys.state_machine" }
	S.tags = { "p", "combatsys", "pipeline", "play" }
	S.description = "Combat Rule Pipeline: ordered rules applied to every gameplay event for the Combat subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.combatsys.rule_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
