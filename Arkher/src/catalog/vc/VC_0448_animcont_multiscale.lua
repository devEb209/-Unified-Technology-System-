-- ARKHER SYSTEM VC.0448 :: Animation Continuum Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VC.0448"
	S.key = "arkher.contneural.animcont.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.animcont.sparse_residency" }
	S.tags = { "vc", "animcont", "multiscale", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contneural.animcont.multi-scale_fidelity", levels = 5, baseTriangles = 60000 })
		inst.system = S
		inst.ctx = ctx
