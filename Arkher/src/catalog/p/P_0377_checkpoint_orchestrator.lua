-- ARKHER SYSTEM P.0377 :: Checkpoint State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0377"
	S.key = "arkher.play.checkpoint.state_machine"
	S.name = "Checkpoint State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Checkpoint"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.checkpoint.combat_resolution" }
	S.tags = { "p", "checkpoint", "orchestrator", "play" }
	S.description = "Checkpoint State Machine: the phase machine that drives this gameplay loop for the Checkpoint subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.checkpoint.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
