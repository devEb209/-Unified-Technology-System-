-- ARKHER SYSTEM W.0386 :: Preview Render Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0386"
	S.key = "arkher.cine.previewrender.camera_rig"
	S.name = "Preview Render Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.previewrender.sequence_timeline" }
	S.tags = { "w", "previewrender", "camerarig", "cine" }
	S.description = "Preview Render Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Preview Render subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.previewrender.camera_rig", fov = 1.29, focus = 15.0, aperture = 2.9, smoothing = 13.0, distance = 17, height = 5 })
		inst.system = S
		inst.ctx = ctx
