-- ARKHER SYSTEM L.0162 :: Agriculture Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0162"
	S.key = "arkher.sim.agriculture.aggregate_cache"
	S.name = "Agriculture Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.agriculture.fidelity_policy" }
	S.tags = { "l", "agriculture", "cache", "sim" }
	S.description = "Agriculture Aggregate Cache: reuse of expensive aggregate computations for the Agriculture subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.agriculture.aggregate_cache", policy = "ttl", capacity = 413, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
