-- ARKHER SYSTEM VA.0118 :: Temporal Slice Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0118"
	S.key = "arkher.contworld.temporalslice.simulation_fabric"
	S.name = "Temporal Slice Simulation Fabric"
	S.category = "VA"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.temporalslice.complexity_budget" }
	S.tags = { "va", "temporalslice", "fabric", "contworld" }
	S.description = "Temporal Slice Simulation Fabric: fabric stepping the continuum domains for the Temporal Slice subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.temporalslice.simulation_fabric", budgetMs = 1.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
