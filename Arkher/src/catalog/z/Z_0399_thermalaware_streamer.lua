-- ARKHER SYSTEM Z.0399 :: Thermal Aware Simulation Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0399"
	S.key = "arkher.origin.thermalaware.residency_streaming"
	S.name = "Thermal Aware Simulation Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.budget_governor" }
	S.tags = { "z", "thermalaware", "streamer", "origin" }
	S.description = "Thermal Aware Simulation Residency Streaming: distance-driven residency of the technology's workload for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.thermalaware.residency_streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
