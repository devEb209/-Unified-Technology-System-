-- ARKHER SYSTEM W.0151 :: Point Of View Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0151"
	S.key = "arkher.cine.pointofview.motion_tween"
	S.name = "Point Of View Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.pointofview.playback_orchestrator" }
	S.tags = { "w", "pointofview", "tween", "cine" }
	S.description = "Point Of View Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Point Of View subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.pointofview.motion_tween", timeScale = 1.06 })
		inst.system = S
		inst.ctx = ctx
