-- ARKHER SYSTEM Z.0888 :: Sparse World Representation Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0888"
	S.key = "arkher.origin.sparseworld.semantic_graph"
	S.name = "Sparse World Representation Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.world_architect" }
	S.tags = { "z", "sparseworld", "knowledge", "origin" }
	S.description = "Sparse World Representation Semantic Graph: typed entities and inferred relations of the technology itself for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.sparseworld.semantic_graph", dims = 32 })
		inst.system = S
		inst.ctx = ctx
