-- ARKHER SYSTEM L.0253 :: Climate Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0253"
	S.key = "arkher.sim.climate.analysis"
	S.name = "Climate Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.climate.aggregate_cache" }
	S.tags = { "l", "climate", "analyzer", "sim" }
	S.description = "Climate Analysis: trend, anomaly and stability analysis of the world for the Climate subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.climate.analysis", window = 246, buckets = 10, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
