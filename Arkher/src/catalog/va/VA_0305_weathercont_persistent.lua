-- ARKHER SYSTEM VA.0305 :: Weather Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0305"
	S.key = "arkher.contworld.weathercont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.weathercont.multi-scale_fidelity" }
	S.tags = { "va", "weathercont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.weathercont.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
