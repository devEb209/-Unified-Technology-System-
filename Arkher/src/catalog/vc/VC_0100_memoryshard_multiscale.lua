-- ARKHER SYSTEM VC.0100 :: Memory Shard Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VC.0100"
	S.key = "arkher.contneural.memoryshard.multi-scale_fidelity"
	S.name = "Memory Shard Multi-Scale Fidelity"
	S.category = "VC"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memoryshard.sparse_residency" }
	S.tags = { "vc", "memoryshard", "multiscale", "contneural" }
	S.description = "Memory Shard Multi-Scale Fidelity: distance-driven multi-scale level selection for the Memory Shard subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contneural.memoryshard.multi-scale_fidelity", levels = 6, baseTriangles = 165000 })
		inst.system = S
		inst.ctx = ctx
