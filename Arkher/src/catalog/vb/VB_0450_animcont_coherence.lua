-- ARKHER SYSTEM VB.0450 :: Animation Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0450"
	S.key = "arkher.conttime.animcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.animcont.persistent_state" }
	S.tags = { "vb", "animcont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.animcont.coherence_guard", window = 79, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
