-- ARKHER SYSTEM Z.0482 :: Cultural Evolution Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0482"
	S.key = "arkher.origin.culturalevolution.complexity_governance"
	S.name = "Cultural Evolution Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.reality_layering" }
	S.tags = { "z", "culturalevolution", "complexity", "origin" }
	S.description = "Cultural Evolution Complexity Governance: measured scene cost turned into per-subsystem directives for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.culturalevolution.complexity_governance", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
