-- ARKHER SYSTEM L.0437 :: Crime Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0437"
	S.key = "arkher.sim.crime.ecology"
	S.name = "Crime Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.crime.simulation_core" }
	S.tags = { "l", "crime", "ecology", "sim" }
	S.description = "Crime Ecology: populations, predation, harvesting and carrying capacity for the Crime subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.crime.ecology" })
		inst.system = S
		inst.ctx = ctx
