-- ARKHER SYSTEM VD.0303 :: Weather Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0303"
	S.key = "arkher.contsim.weathercont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.weathercont.epoch_clock" }
	S.tags = { "vd", "weathercont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.weathercont.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
