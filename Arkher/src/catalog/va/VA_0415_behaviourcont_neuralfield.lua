-- ARKHER SYSTEM VA.0415 :: Behaviour Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0415"
	S.key = "arkher.contworld.behaviourcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.behaviourcont.coherence_guard" }
	S.tags = { "va", "behaviourcont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.behaviourcont.neural_field", dims = 16, hidden = 12, seed = 2937 })
		inst.system = S
		inst.ctx = ctx
