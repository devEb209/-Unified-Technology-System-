-- ARKHER SYSTEM J.0239 :: Body Type Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0239"
	S.key = "arkher.character.bodytype.variant_registry"
	S.name = "Body Type Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.bodytype.appearance_composer" }
	S.tags = { "j", "bodytype", "registry", "character" }
	S.description = "Body Type Variant Registry: named character variants and their lifecycle for the Body Type subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.bodytype.variant_registry" })
		inst.system = S
		inst.ctx = ctx
