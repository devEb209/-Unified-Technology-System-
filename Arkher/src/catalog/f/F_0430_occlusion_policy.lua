-- ARKHER SYSTEM F.0430 :: Occlusion Culling Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0430"
	S.key = "arkher.render.occlusion.render_policy"
	S.name = "Occlusion Culling Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.occlusion.draw_budget" }
	S.tags = { "f", "occlusion", "policy", "render" }
	S.description = "Occlusion Culling Render Policy: device tier rules for the frame for the Occlusion Culling subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.occlusion.render_policy", algorithm = "wfq", starvationGuard = 54 })
		inst.system = S
		inst.ctx = ctx
