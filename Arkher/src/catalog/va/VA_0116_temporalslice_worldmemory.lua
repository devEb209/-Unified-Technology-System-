-- ARKHER SYSTEM VA.0116 :: Temporal Slice World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0116"
	S.key = "arkher.contworld.temporalslice.world_memory_stream"
	S.name = "Temporal Slice World Memory Stream"
	S.category = "VA"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.temporalslice.neural_field" }
	S.tags = { "va", "temporalslice", "worldmemory", "contworld" }
	S.description = "Temporal Slice World Memory Stream: world memory continuum over epochs for the Temporal Slice subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.temporalslice.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
