-- ARKHER SYSTEM T.0515 :: Render Reasoning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0515"
	S.key = "arkher.ai.renderreasoning.action_planner"
	S.name = "Render Reasoning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.renderreasoning.utility_selection" }
	S.tags = { "t", "renderreasoning", "planner", "ai" }
	S.description = "Render Reasoning Action Planner: goal-oriented action planning over preconditions for the Render Reasoning subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.renderreasoning.action_planner", maxDepth = 11 })
		inst.system = S
		inst.ctx = ctx
