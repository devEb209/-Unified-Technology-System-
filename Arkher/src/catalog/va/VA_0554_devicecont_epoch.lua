-- ARKHER SYSTEM VA.0554 :: Device Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0554"
	S.key = "arkher.contworld.devicecont.epoch_clock"
	S.name = "Device Continuum Epoch Clock"
	S.category = "VA"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.devicecont.infinite_grid" }
	S.tags = { "va", "devicecont", "epoch", "contworld" }
	S.description = "Device Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Device Continuum subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.devicecont.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
