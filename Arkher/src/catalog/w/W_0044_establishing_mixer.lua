-- ARKHER SYSTEM W.0044 :: Establishing Shot Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0044"
	S.key = "arkher.cine.establishing.cinematic_mix"
	S.name = "Establishing Shot Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.establishing.motion_tween" }
	S.tags = { "w", "establishing", "mixer", "cine" }
	S.description = "Establishing Shot Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Establishing Shot subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.establishing.cinematic_mix", maxVoices = 24 })
		inst.system = S
		inst.ctx = ctx
