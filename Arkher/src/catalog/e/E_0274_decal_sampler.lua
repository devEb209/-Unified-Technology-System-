-- ARKHER SYSTEM E.0274 :: Decal Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0274"
	S.key = "arkher.material.decal.texture_sampling"
	S.name = "Decal Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Decal"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.decal.shading_graph" }
	S.tags = { "e", "decal", "sampler", "material" }
	S.description = "Decal Texture Sampling: atlas packing, mip chain and filtered sampling for the Decal subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.decal.texture_sampling", atlasSize = 128, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
