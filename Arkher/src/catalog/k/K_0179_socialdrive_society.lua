-- ARKHER SYSTEM K.0179 :: Social Drive Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0179"
	S.key = "arkher.npc.socialdrive.social_relations"
	S.name = "Social Drive Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.socialdrive.crowd_steering" }
	S.tags = { "k", "socialdrive", "society", "npc" }
	S.description = "Social Drive Social Relations: affinity, factions, reputation and gossip for the Social Drive subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.socialdrive.social_relations", decayRate = 0.010, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
