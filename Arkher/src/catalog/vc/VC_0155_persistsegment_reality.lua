-- ARKHER SYSTEM VC.0155 :: Persistence Segment Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0155"
	S.key = "arkher.contneural.persistsegment.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.persistsegment.simulation_fabric" }
	S.tags = { "vc", "persistsegment", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.persistsegment.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
