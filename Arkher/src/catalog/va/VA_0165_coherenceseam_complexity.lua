-- ARKHER SYSTEM VA.0165 :: Coherence Seam Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0165"
	S.key = "arkher.contworld.coherenceseam.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.coherenceseam.world_memory_stream" }
	S.tags = { "va", "coherenceseam", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.coherenceseam.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
