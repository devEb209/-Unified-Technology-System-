-- ARKHER SYSTEM J.0279 :: Character Physics Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0279"
	S.key = "arkher.character.characterphysics.look_and_reach"
	S.name = "Character Physics Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterphysics.blend_controller" }
	S.tags = { "j", "characterphysics", "ik", "character" }
	S.description = "Character Physics Look And Reach: look-at, reach and foot placement for the character for the Character Physics subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.characterphysics.look_and_reach", iterations = 11, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
