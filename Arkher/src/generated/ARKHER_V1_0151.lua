--!strict
-- SpeedTree Atlas — ANIMATION Node_Flow #0151
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="SpeedTree Atlas — ANIMATION Node_Flow #0151", size=Vector2.new(640, 440), pos=UDim2.fromOffset(463, 307), parent=parent, icon="⬡"})
