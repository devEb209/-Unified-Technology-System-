-- ARKHER SYSTEM T.0537 :: Animation Reasoning World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0537"
	S.key = "arkher.ai.animationreasoning.world_architect"
	S.name = "Animation Reasoning World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.animationreasoning.self_critique" }
	S.tags = { "t", "animationreasoning", "architect", "ai" }
	S.description = "Animation Reasoning World Architect: composition of a whole world plan with conserved budgets for the Animation Reasoning subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.animationreasoning.world_architect", budget = 600, seed = 74570 })
		inst.system = S
		inst.ctx = ctx
