-- ARKHER SYSTEM F.0324 :: Motion Blur View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0324"
	S.key = "arkher.render.motionblur.view_and_culling"
	S.name = "Motion Blur View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Motion Blur"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.motionblur.frame_graph" }
	S.tags = { "f", "motionblur", "camera", "render" }
	S.description = "Motion Blur View And Culling: view state, frustum culling and screen-size LOD for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.motionblur.view_and_culling", width = 828, height = 900, fov = 0.9500, far = 1400 })
		inst.system = S
		inst.ctx = ctx
