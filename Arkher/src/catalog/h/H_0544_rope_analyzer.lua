-- ARKHER SYSTEM H.0544 :: Rope Simulation Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0544"
	S.key = "arkher.physics.rope.analysis"
	S.name = "Rope Simulation Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rope.result_cache" }
	S.tags = { "h", "rope", "analyzer", "physics" }
	S.description = "Rope Simulation Analysis: energy, jitter and cost analysis of the simulation for the Rope Simulation subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.rope.analysis", window = 162, buckets = 18, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
