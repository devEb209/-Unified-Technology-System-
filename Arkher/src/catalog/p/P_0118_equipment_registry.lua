-- ARKHER SYSTEM P.0118 :: Equipment Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0118"
	S.key = "arkher.play.equipment.content_registry"
	S.name = "Equipment Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Equipment"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.equipment.difficulty_controller" }
	S.tags = { "p", "equipment", "registry", "play" }
	S.description = "Equipment Content Registry: catalogue of the definitions this loop instantiates for the Equipment subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.equipment.content_registry" })
		inst.system = S
		inst.ctx = ctx
