-- ARKHER SYSTEM VA.0056 :: Epoch Frame World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0056"
	S.key = "arkher.contworld.epochframe.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.epochframe.neural_field" }
	S.tags = { "va", "epochframe", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.epochframe.world_memory_stream", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
