-- ARKHER SYSTEM K.0355 :: Behaviour State Machine Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0355"
	S.key = "arkher.npc.behaviourstate.perception"
	S.name = "Behaviour State Machine Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourstate.emotion" }
	S.tags = { "k", "behaviourstate", "perception", "npc" }
	S.description = "Behaviour State Machine Perception: sight, hearing and bounded attention for the Behaviour State Machine subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.behaviourstate.perception", sightRange = 50, hearingRange = 32, attentionSlots = 4, fov = 1.730 })
		inst.system = S
		inst.ctx = ctx
