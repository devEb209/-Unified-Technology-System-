-- ARKHER SYSTEM O.0151 :: Water Audio Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0151"
	S.key = "arkher.audio.wateraudio.asset_registry"
	S.name = "Water Audio Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Water Audio"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.wateraudio.streaming" }
	S.tags = { "o", "wateraudio", "registry", "audio" }
	S.description = "Water Audio Asset Registry: catalogue of sounds, variations and metadata for the Water Audio subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.wateraudio.asset_registry" })
		inst.system = S
		inst.ctx = ctx
