-- ARKHER SYSTEM I.0472 :: Facial Animation Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0472"
	S.key = "arkher.anim.facialanim.inverse_kinematics"
	S.name = "Facial Animation Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.facialanim.layered_blending" }
	S.tags = { "i", "facialanim", "ik", "anim" }
	S.description = "Facial Animation Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Facial Animation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.facialanim.inverse_kinematics", iterations = 12, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
