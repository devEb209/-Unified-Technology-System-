-- ARKHER SYSTEM Z.0895 :: Sparse World Representation Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0895"
	S.key = "arkher.origin.sparseworld.signal_composition"
	S.name = "Sparse World Representation Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.telemetry_ledger" }
	S.tags = { "z", "sparseworld", "composer", "origin" }
	S.description = "Sparse World Representation Signal Composition: blending of the technology's input signals into one output for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.sparseworld.signal_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
