-- ARKHER SYSTEM H.0174 :: Sleeping Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0174"
	S.key = "arkher.physics.sleeping.character_motion"
	S.name = "Sleeping Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Sleeping"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sleeping.query" }
	S.tags = { "h", "sleeping", "charmotor", "physics" }
	S.description = "Sleeping Character Motion: capsule move-and-slide with slopes, steps and jumps for the Sleeping subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.sleeping.character_motion", radius = 0.46, height = 1.91, maxSpeed = 7.10, jumpHeight = 1.90, stepOffset = 0.26 })
		inst.system = S
		inst.ctx = ctx
