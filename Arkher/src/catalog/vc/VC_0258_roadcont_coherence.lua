-- ARKHER SYSTEM VC.0258 :: Road Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0258"
	S.key = "arkher.contneural.roadcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.roadcont.persistent_state" }
	S.tags = { "vc", "roadcont", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.roadcont.coherence_guard", window = 135, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
