-- ARKHER SYSTEM T.0368 :: Review Critic Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0368"
	S.key = "arkher.ai.reviewcritic.self_critique"
	S.name = "Review Critic Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.reviewcritic.plan_workflow" }
	S.tags = { "t", "reviewcritic", "critic", "ai" }
	S.description = "Review Critic Self Critique: weighted evaluation of the result against declared criteria for the Review Critic subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.reviewcritic.self_critique", passMark = 0.84, reviseMark = 0.49, seed = 37049 })
		inst.system = S
		inst.ctx = ctx
