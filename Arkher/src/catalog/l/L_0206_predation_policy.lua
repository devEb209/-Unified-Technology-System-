-- ARKHER SYSTEM L.0206 :: Predation Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0206"
	S.key = "arkher.sim.predation.fidelity_policy"
	S.name = "Predation Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.predation.streaming" }
	S.tags = { "l", "predation", "policy", "sim" }
	S.description = "Predation Fidelity Policy: rules that pick full, cohort or statistical simulation for the Predation subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.predation.fidelity_policy", algorithm = "wfq", starvationGuard = 26 })
		inst.system = S
		inst.ctx = ctx
