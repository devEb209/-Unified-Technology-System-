-- ARKHER SYSTEM N.0108 :: Blood Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0108"
	S.key = "arkher.vfx.blood.ribbon_and_trail"
	S.name = "Blood Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Blood"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.blood.force_field" }
	S.tags = { "n", "blood", "ribbon", "vfx" }
	S.description = "Blood Ribbon And Trail: trail points, tapering, beams and decimation for the Blood subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.blood.ribbon_and_trail", maxPoints = 56, lifetime = 2.00, minDistance = 0.35, width = 1.30 })
		inst.system = S
		inst.ctx = ctx
