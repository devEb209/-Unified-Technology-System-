-- ARKHER SYSTEM VD.0318 :: Ecology Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0318"
	S.key = "arkher.contsim.ecologycont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.ecologycont.persistent_state" }
	S.tags = { "vd", "ecologycont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.ecologycont.coherence_guard", window = 131, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
