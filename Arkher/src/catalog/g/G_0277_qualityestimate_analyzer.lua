-- ARKHER SYSTEM G.0277 :: Quality Estimation Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0277"
	S.key = "arkher.neural.qualityestimate.error_analysis"
	S.name = "Quality Estimation Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.qualityestimate.heuristic_policy" }
	S.tags = { "g", "qualityestimate", "analyzer", "neural" }
	S.description = "Quality Estimation Error Analysis: residual and drift analysis for the Quality Estimation subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.qualityestimate.error_analysis", window = 117, buckets = 17, threshold = 2.90 })
		inst.system = S
		inst.ctx = ctx
