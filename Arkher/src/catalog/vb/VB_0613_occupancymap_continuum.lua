-- ARKHER SYSTEM VB.0613 :: Occupancy Map Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0613"
	S.key = "arkher.conttime.occupancymap.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "occupancymap", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.occupancymap.infinite_grid", cellSize = 96, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
