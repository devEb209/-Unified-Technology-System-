-- ARKHER SYSTEM Z.0989 :: Engine Self Model Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0989"
	S.key = "arkher.origin.engineselfmodel.intent_bridge"
	S.name = "Engine Self Model Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.engineselfmodel.semantic_graph" }
	S.tags = { "z", "engineselfmodel", "intent", "origin" }
	S.description = "Engine Self Model Intent Bridge: natural language control surface for the technology for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.engineselfmodel.intent_bridge", minConfidence = 0.41 })
		inst.system = S
		inst.ctx = ctx
