-- ARKHER SYSTEM T.0519 :: Audio Reasoning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0519"
	S.key = "arkher.ai.audioreasoning.intent_understanding"
	S.name = "Audio Reasoning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "audioreasoning", "intent", "ai" }
	S.description = "Audio Reasoning Intent Understanding: natural language turned into an actionable, scored intent for the Audio Reasoning subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.audioreasoning.intent_understanding", minConfidence = 0.38 })
		inst.system = S
		inst.ctx = ctx
