-- ARKHER SYSTEM F.0501 :: HLOD Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0501"
	S.key = "arkher.render.hlod.pass_cache"
	S.name = "HLOD Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "HLOD"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.hlod.render_policy" }
	S.tags = { "f", "hlod", "cache", "render" }
	S.description = "HLOD Pass Cache: reuse of pass results across frames for the HLOD subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.hlod.pass_cache", policy = "lru", capacity = 159, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
