-- ARKHER SYSTEM F.0439 :: Portal Culling Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0439"
	S.key = "arkher.render.portal.lighting_rig"
	S.name = "Portal Culling Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.portal.geometry_virtualization" }
	S.tags = { "f", "portal", "lightrig", "render" }
	S.description = "Portal Culling Lighting Rig: light clustering, importance and cascades for the Portal Culling subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.portal.lighting_rig", maxActive = 8 })
		inst.system = S
		inst.ctx = ctx
