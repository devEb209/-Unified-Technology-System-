-- ARKHER SYSTEM F.0057 :: Shadow Pass Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0057"
	S.key = "arkher.render.shadowpass.frame_graph"
	S.name = "Shadow Pass Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Shadow Pass"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "shadowpass", "framegraph", "render" }
	S.description = "Shadow Pass Frame Graph: declared passes, culling, ordering and aliasing for the Shadow Pass subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.shadowpass.frame_graph", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
