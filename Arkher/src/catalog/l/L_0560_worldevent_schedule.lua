-- ARKHER SYSTEM L.0560 :: World Event Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0560"
	S.key = "arkher.sim.worldevent.calendar"
	S.name = "World Event Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldevent.society" }
	S.tags = { "l", "worldevent", "schedule", "sim" }
	S.description = "World Event Calendar: hours, days and seasons driving the region for the World Event subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.worldevent.calendar", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
