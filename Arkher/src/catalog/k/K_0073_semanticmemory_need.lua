-- ARKHER SYSTEM K.0073 :: Semantic Memory Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0073"
	S.key = "arkher.npc.semanticmemory.drive_system"
	S.name = "Semantic Memory Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.semanticmemory.memory" }
	S.tags = { "k", "semanticmemory", "need", "npc" }
	S.description = "Semantic Memory Drive System: drives that decay, turn urgent and get satisfied for the Semantic Memory subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.semanticmemory.drive_system" })
		inst.system = S
		inst.ctx = ctx
