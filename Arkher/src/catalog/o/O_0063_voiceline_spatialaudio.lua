-- ARKHER SYSTEM O.0063 :: Voice Line Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0063"
	S.key = "arkher.audio.voiceline.spatialization"
	S.name = "Voice Line Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Voice Line"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.voiceline.mixer_bus" }
	S.tags = { "o", "voiceline", "spatialaudio", "audio" }
	S.description = "Voice Line Spatialization: distance attenuation, panning, occlusion and doppler for the Voice Line subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.voiceline.spatialization", model = "linear", refDistance = 4, maxDistance = 140, rolloff = 0.93, maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
