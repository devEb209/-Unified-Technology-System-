-- ARKHER SYSTEM F.0246 :: Reflection Probe Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0246"
	S.key = "arkher.render.reflectionprobe.adaptive_resolution"
	S.name = "Reflection Probe Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.reflectionprobe.temporal_resolve" }
	S.tags = { "f", "reflectionprobe", "upscaler", "render" }
	S.description = "Reflection Probe Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Reflection Probe subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.reflectionprobe.adaptive_resolution", targetMs = 15.10, index = 4, sharpness = 0.22 })
		inst.system = S
		inst.ctx = ctx
