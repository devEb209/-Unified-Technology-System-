-- ARKHER SYSTEM V.0410 :: Asset Search Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0410"
	S.key = "arkher.asset.assetsearch.bundling"
	S.name = "Asset Search Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetsearch.import" }
	S.tags = { "v", "assetsearch", "bundler", "asset" }
	S.description = "Asset Search Bundling: size-bounded packing, manifests and delta patches for the Asset Search subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.assetsearch.bundling", maxBundleBytes = 524288 })
		inst.system = S
		inst.ctx = ctx
