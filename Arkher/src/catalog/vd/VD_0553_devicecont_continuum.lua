-- ARKHER SYSTEM VD.0553 :: Device Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0553"
	S.key = "arkher.contsim.devicecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "devicecont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.devicecont.infinite_grid", cellSize = 128, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
