-- ARKHER SYSTEM E.0426 :: Texture Streaming Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0426"
	S.key = "arkher.material.texstream.variant_registry"
	S.name = "Texture Streaming Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.texstream.procedural_detail" }
	S.tags = { "e", "texstream", "registry", "material" }
	S.description = "Texture Streaming Variant Registry: named variants and their lifecycle for the Texture Streaming subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.texstream.variant_registry" })
		inst.system = S
		inst.ctx = ctx
