-- ARKHER SYSTEM K.0256 :: Vision Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0256"
	S.key = "arkher.npc.vision.emotion"
	S.name = "Vision Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.vision.drive_system" }
	S.tags = { "k", "vision", "emotion", "npc" }
	S.description = "Vision Emotion: appraisal of events into valence, arousal and mood for the Vision subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.vision.emotion", inertia = 0.77, decayRate = 0.42, baselineArousal = 0.12 })
		inst.system = S
		inst.ctx = ctx
