-- ARKHER SYSTEM VA.0402 :: Perception Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0402"
	S.key = "arkher.contworld.perceptioncont.coherence_guard"
	S.name = "Perception Continuum Coherence Guard"
	S.category = "VA"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.perceptioncont.persistent_state" }
	S.tags = { "va", "perceptioncont", "coherence", "contworld" }
	S.description = "Perception Continuum Coherence Guard: seam coherence and drift supervision for the Perception Continuum subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.perceptioncont.coherence_guard", window = 85, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
