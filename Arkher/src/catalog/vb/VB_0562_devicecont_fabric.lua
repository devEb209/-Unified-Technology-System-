-- ARKHER SYSTEM VB.0562 :: Device Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0562"
	S.key = "arkher.conttime.devicecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.devicecont.complexity_budget" }
	S.tags = { "vb", "devicecont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.devicecont.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
