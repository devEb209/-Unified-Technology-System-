-- ARKHER SYSTEM T.0389 :: Refactoring Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0389"
	S.key = "arkher.ai.refactoring.action_planner"
	S.name = "Refactoring Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.refactoring.utility_selection" }
	S.tags = { "t", "refactoring", "planner", "ai" }
	S.description = "Refactoring Action Planner: goal-oriented action planning over preconditions for the Refactoring subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.refactoring.action_planner", maxDepth = 10 })
		inst.system = S
		inst.ctx = ctx
