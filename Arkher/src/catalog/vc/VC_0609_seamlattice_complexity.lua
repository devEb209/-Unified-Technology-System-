-- ARKHER SYSTEM VC.0609 :: Seam Lattice Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0609"
	S.key = "arkher.contneural.seamlattice.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.seamlattice.world_memory_stream" }
	S.tags = { "vc", "seamlattice", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.seamlattice.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
