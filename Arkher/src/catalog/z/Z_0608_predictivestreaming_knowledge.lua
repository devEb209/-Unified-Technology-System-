-- ARKHER SYSTEM Z.0608 :: Predictive Streaming Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0608"
	S.key = "arkher.origin.predictivestreaming.semantic_graph"
	S.name = "Predictive Streaming Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictivestreaming.world_architect" }
	S.tags = { "z", "predictivestreaming", "knowledge", "origin" }
	S.description = "Predictive Streaming Semantic Graph: typed entities and inferred relations of the technology itself for the Predictive Streaming subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.predictivestreaming.semantic_graph", dims = 24 })
		inst.system = S
		inst.ctx = ctx
