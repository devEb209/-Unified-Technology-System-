-- ARKHER SYSTEM VB.0383 :: Dialogue Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0383"
	S.key = "arkher.conttime.dialoguecont.reality_continuum"
	S.name = "Dialogue Continuum Reality Continuum"
	S.category = "VB"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.dialoguecont.simulation_fabric" }
	S.tags = { "vb", "dialoguecont", "reality", "conttime" }
	S.description = "Dialogue Continuum Reality Continuum: stacked reality layers of the continuum for the Dialogue Continuum subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.dialoguecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
