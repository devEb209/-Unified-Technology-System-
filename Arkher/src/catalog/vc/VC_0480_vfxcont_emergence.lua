-- ARKHER SYSTEM VC.0480 :: VFX Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0480"
	S.key = "arkher.contneural.vfxcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vfxcont.reality_continuum" }
	S.tags = { "vc", "vfxcont", "emergence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.vfxcont.emergence_continuum", windowSize = 6, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
