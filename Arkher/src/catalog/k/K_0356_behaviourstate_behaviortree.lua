-- ARKHER SYSTEM K.0356 :: Behaviour State Machine Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0356"
	S.key = "arkher.npc.behaviourstate.reactive_behaviour"
	S.name = "Behaviour State Machine Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourstate.perception" }
	S.tags = { "k", "behaviourstate", "behaviortree", "npc" }
	S.description = "Behaviour State Machine Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Behaviour State Machine subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.behaviourstate.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
