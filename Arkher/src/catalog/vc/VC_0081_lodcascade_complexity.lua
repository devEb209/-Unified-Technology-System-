-- ARKHER SYSTEM VC.0081 :: LOD Cascade Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0081"
	S.key = "arkher.contneural.lodcascade.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lodcascade.world_memory_stream" }
	S.tags = { "vc", "lodcascade", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.lodcascade.complexity_budget", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
