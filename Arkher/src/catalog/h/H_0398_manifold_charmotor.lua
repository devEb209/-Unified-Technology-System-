-- ARKHER SYSTEM H.0398 :: Contact Manifold Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0398"
	S.key = "arkher.physics.manifold.character_motion"
	S.name = "Contact Manifold Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.manifold.query" }
	S.tags = { "h", "manifold", "charmotor", "physics" }
	S.description = "Contact Manifold Character Motion: capsule move-and-slide with slopes, steps and jumps for the Contact Manifold subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.manifold.character_motion", radius = 0.46, height = 1.91, maxSpeed = 5.10, jumpHeight = 2.30, stepOffset = 0.36 })
		inst.system = S
		inst.ctx = ctx
