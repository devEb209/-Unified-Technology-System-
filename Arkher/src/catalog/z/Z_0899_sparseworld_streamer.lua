-- ARKHER SYSTEM Z.0899 :: Sparse World Representation Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0899"
	S.key = "arkher.origin.sparseworld.residency_streaming"
	S.name = "Sparse World Representation Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.budget_governor" }
	S.tags = { "z", "sparseworld", "streamer", "origin" }
	S.description = "Sparse World Representation Residency Streaming: distance-driven residency of the technology's workload for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.sparseworld.residency_streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
