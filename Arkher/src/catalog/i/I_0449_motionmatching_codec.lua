-- ARKHER SYSTEM I.0449 :: Motion Matching Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0449"
	S.key = "arkher.anim.motionmatching.compression_codec"
	S.name = "Motion Matching Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.motionmatching.retarget_graph" }
	S.tags = { "i", "motionmatching", "codec", "anim" }
	S.description = "Motion Matching Compression Codec: curve compression and quantized transport for the Motion Matching subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.motionmatching.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
