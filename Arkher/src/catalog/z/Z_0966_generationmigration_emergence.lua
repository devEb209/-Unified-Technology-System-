-- ARKHER SYSTEM Z.0966 :: Generation Migration Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0966"
	S.key = "arkher.origin.generationmigration.emergence_detection"
	S.name = "Generation Migration Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.world_memory" }
	S.tags = { "z", "generationmigration", "emergence", "origin" }
	S.description = "Generation Migration Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.generationmigration.emergence_detection", windowSize = 7, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
