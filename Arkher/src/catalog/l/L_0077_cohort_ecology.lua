-- ARKHER SYSTEM L.0077 :: Cohort Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0077"
	S.key = "arkher.sim.cohort.ecology"
	S.name = "Cohort Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.cohort.simulation_core" }
	S.tags = { "l", "cohort", "ecology", "sim" }
	S.description = "Cohort Ecology: populations, predation, harvesting and carrying capacity for the Cohort subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.cohort.ecology" })
		inst.system = S
		inst.ctx = ctx
