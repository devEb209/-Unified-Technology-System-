-- ARKHER SYSTEM G.0043 :: Frame Interpolation Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0043"
	S.key = "arkher.neural.frameinterp.inference_core"
	S.name = "Frame Interpolation Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "frameinterp", "inference", "neural" }
	S.description = "Frame Interpolation Inference Core: dense network forward pass and training for the Frame Interpolation subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.frameinterp.inference_core", seed = 61974 })
		inst.system = S
		inst.ctx = ctx
