-- ARKHER SYSTEM O.0077 :: Dialogue Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0077"
	S.key = "arkher.audio.dialogue.voice_budget"
	S.name = "Dialogue Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Dialogue"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.dialogue.music_sequencer" }
	S.tags = { "o", "dialogue", "budgeter", "audio" }
	S.description = "Dialogue Voice Budget: voice slots allocated by priority and audibility for the Dialogue subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.dialogue.voice_budget", total = 183, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
