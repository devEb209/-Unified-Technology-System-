-- ARKHER SYSTEM G.0133 :: Detail Synthesis Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0133"
	S.key = "arkher.neural.detailsynth.quality_predictor"
	S.name = "Detail Synthesis Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detailsynth.weight_codec" }
	S.tags = { "g", "detailsynth", "predictor", "neural" }
	S.description = "Detail Synthesis Quality Predictor: predicted quality and cost of a setting for the Detail Synthesis subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.detailsynth.quality_predictor", method = "markov", alpha = 0.49, window = 103 })
		inst.system = S
		inst.ctx = ctx
