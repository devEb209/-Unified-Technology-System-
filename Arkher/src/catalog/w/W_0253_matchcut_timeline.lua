-- ARKHER SYSTEM W.0253 :: Match Cut Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0253"
	S.key = "arkher.cine.matchcut.sequence_timeline"
	S.name = "Match Cut Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Match Cut"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "matchcut", "timeline", "cine" }
	S.description = "Match Cut Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Match Cut subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.matchcut.sequence_timeline", duration = 7.0, rate = 0.91 })
		inst.system = S
		inst.ctx = ctx
