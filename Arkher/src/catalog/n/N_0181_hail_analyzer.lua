-- ARKHER SYSTEM N.0181 :: Hail Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0181"
	S.key = "arkher.vfx.hail.analysis"
	S.name = "Hail Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Hail"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.hail.spatial_index" }
	S.tags = { "n", "hail", "analyzer", "vfx" }
	S.description = "Hail Analysis: cost, overdraw and stability analysis of the effect for the Hail subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.hail.analysis", window = 224, buckets = 12, threshold = 3.60 })
		inst.system = S
		inst.ctx = ctx
