-- ARKHER SYSTEM Q.0064 :: List Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0064"
	S.key = "arkher.ui.list.transition"
	S.name = "List Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "List"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.list.input_mapping" }
	S.tags = { "q", "list", "tween", "ui" }
	S.description = "List Transition: eased, delayed, looped and sequenced motion for the List subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.list.transition", timeScale = 1.03 })
		inst.system = S
		inst.ctx = ctx
