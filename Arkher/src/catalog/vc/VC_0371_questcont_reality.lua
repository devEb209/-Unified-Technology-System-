-- ARKHER SYSTEM VC.0371 :: Quest Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0371"
	S.key = "arkher.contneural.questcont.reality_continuum"
	S.name = "Quest Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.questcont.simulation_fabric" }
	S.tags = { "vc", "questcont", "reality", "contneural" }
	S.description = "Quest Continuum Reality Continuum: stacked reality layers of the continuum for the Quest Continuum subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.questcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
