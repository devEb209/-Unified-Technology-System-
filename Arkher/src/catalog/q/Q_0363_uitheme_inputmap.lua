-- ARKHER SYSTEM Q.0363 :: Theme Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0363"
	S.key = "arkher.ui.uitheme.input_mapping"
	S.name = "Theme Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Theme"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uitheme.widget_tree" }
	S.tags = { "q", "uitheme", "inputmap", "ui" }
	S.description = "Theme Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Theme subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.uitheme.input_mapping", device = "touch", holdTime = 0.32, deadzone = 0.22 })
		inst.system = S
		inst.ctx = ctx
