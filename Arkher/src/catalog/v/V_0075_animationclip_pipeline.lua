-- ARKHER SYSTEM V.0075 :: Animation Clip Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0075"
	S.key = "arkher.asset.animationclip.cook_pipeline"
	S.name = "Animation Clip Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.animationclip.bundling" }
	S.tags = { "v", "animationclip", "pipeline", "asset" }
	S.description = "Animation Clip Cook Pipeline: staged cooking with isolation and retries for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.animationclip.cook_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
