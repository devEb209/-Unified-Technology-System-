-- ARKHER SYSTEM VD.0594 :: Horizon Span Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0594"
	S.key = "arkher.contsim.horizonspan.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.horizonspan.persistent_state" }
	S.tags = { "vd", "horizonspan", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.horizonspan.coherence_guard", window = 139, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
