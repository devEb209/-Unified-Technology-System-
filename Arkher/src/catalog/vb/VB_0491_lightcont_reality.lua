-- ARKHER SYSTEM VB.0491 :: Lighting Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0491"
	S.key = "arkher.conttime.lightcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lightcont.simulation_fabric" }
	S.tags = { "vb", "lightcont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.lightcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
