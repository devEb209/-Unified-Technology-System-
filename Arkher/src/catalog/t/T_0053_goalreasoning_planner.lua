-- ARKHER SYSTEM T.0053 :: Goal Reasoning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0053"
	S.key = "arkher.ai.goalreasoning.action_planner"
	S.name = "Goal Reasoning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.goalreasoning.utility_selection" }
	S.tags = { "t", "goalreasoning", "planner", "ai" }
	S.description = "Goal Reasoning Action Planner: goal-oriented action planning over preconditions for the Goal Reasoning subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.goalreasoning.action_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
