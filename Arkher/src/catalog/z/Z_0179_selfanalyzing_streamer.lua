-- ARKHER SYSTEM Z.0179 :: Self Analyzing Project Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0179"
	S.key = "arkher.origin.selfanalyzing.residency_streaming"
	S.name = "Self Analyzing Project Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.budget_governor" }
	S.tags = { "z", "selfanalyzing", "streamer", "origin" }
	S.description = "Self Analyzing Project Residency Streaming: distance-driven residency of the technology's workload for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.selfanalyzing.residency_streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
