-- ARKHER SYSTEM VB.0516 :: Material Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0516"
	S.key = "arkher.conttime.materialcont.emergence_continuum"
	S.name = "Material Continuum Emergence Continuum"
	S.category = "VB"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.materialcont.reality_continuum" }
	S.tags = { "vb", "materialcont", "emergence", "conttime" }
	S.description = "Material Continuum Emergence Continuum: emergence detection over the continuum for the Material Continuum subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.materialcont.emergence_continuum", windowSize = 7, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
