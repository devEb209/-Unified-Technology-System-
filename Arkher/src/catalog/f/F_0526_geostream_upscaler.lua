-- ARKHER SYSTEM F.0526 :: Geometry Streaming Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0526"
	S.key = "arkher.render.geostream.adaptive_resolution"
	S.name = "Geometry Streaming Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.geostream.temporal_resolve" }
	S.tags = { "f", "geostream", "upscaler", "render" }
	S.description = "Geometry Streaming Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Geometry Streaming subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.geostream.adaptive_resolution", targetMs = 11.10, index = 3, sharpness = 0.28 })
		inst.system = S
		inst.ctx = ctx
