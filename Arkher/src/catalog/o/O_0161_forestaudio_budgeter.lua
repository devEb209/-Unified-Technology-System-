-- ARKHER SYSTEM O.0161 :: Forest Audio Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0161"
	S.key = "arkher.audio.forestaudio.voice_budget"
	S.name = "Forest Audio Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Forest Audio"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.forestaudio.music_sequencer" }
	S.tags = { "o", "forestaudio", "budgeter", "audio" }
	S.description = "Forest Audio Voice Budget: voice slots allocated by priority and audibility for the Forest Audio subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.forestaudio.voice_budget", total = 169, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
