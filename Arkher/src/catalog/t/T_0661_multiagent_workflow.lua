-- ARKHER SYSTEM T.0661 :: Multi Agent Coordination Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0661"
	S.key = "arkher.ai.multiagent.plan_workflow"
	S.name = "Multi Agent Coordination Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.multiagent.semantic_knowledge" }
	S.tags = { "t", "multiagent", "workflow", "ai" }
	S.description = "Multi Agent Coordination Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Multi Agent Coordination subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.multiagent.plan_workflow", maxRetries = 3, budget = 150 })
		inst.system = S
		inst.ctx = ctx
