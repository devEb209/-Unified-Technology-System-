-- ARKHER SYSTEM T.0220 :: Character Generation Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0220"
	S.key = "arkher.ai.charactergeneration.utility_selection"
	S.name = "Character Generation Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.charactergeneration.working_memory" }
	S.tags = { "t", "charactergeneration", "utility", "ai" }
	S.description = "Character Generation Utility Selection: scored choice between competing courses of action for the Character Generation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.charactergeneration.utility_selection", momentum = 0.11 })
		inst.system = S
		inst.ctx = ctx
