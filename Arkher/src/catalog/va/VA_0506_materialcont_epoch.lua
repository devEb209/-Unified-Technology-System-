-- ARKHER SYSTEM VA.0506 :: Material Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0506"
	S.key = "arkher.contworld.materialcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.materialcont.infinite_grid" }
	S.tags = { "va", "materialcont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.materialcont.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
