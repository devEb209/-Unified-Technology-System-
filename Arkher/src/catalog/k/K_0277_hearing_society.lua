-- ARKHER SYSTEM K.0277 :: Hearing Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0277"
	S.key = "arkher.npc.hearing.social_relations"
	S.name = "Hearing Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hearing.crowd_steering" }
	S.tags = { "k", "hearing", "society", "npc" }
	S.description = "Hearing Social Relations: affinity, factions, reputation and gossip for the Hearing subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.hearing.social_relations", decayRate = 0.010, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
