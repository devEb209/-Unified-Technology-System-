-- ARKHER SYSTEM VA.0598 :: Horizon Span Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0598"
	S.key = "arkher.contworld.horizonspan.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.horizonspan.complexity_budget" }
	S.tags = { "va", "horizonspan", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.horizonspan.simulation_fabric", budgetMs = 3.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
