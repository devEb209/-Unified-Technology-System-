-- ARKHER SYSTEM K.0586 :: Idle Behaviour Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0586"
	S.key = "arkher.npc.idlebehaviour.daily_schedule"
	S.name = "Idle Behaviour Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.idlebehaviour.social_relations" }
	S.tags = { "k", "idlebehaviour", "schedule", "npc" }
	S.description = "Idle Behaviour Daily Schedule: hour-by-hour routine with priority interruptions for the Idle Behaviour subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.idlebehaviour.daily_schedule", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
