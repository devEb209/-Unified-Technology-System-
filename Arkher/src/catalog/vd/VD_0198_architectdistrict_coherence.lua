-- ARKHER SYSTEM VD.0198 :: Architect District Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0198"
	S.key = "arkher.contsim.architectdistrict.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.architectdistrict.persistent_state" }
	S.tags = { "vd", "architectdistrict", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.architectdistrict.coherence_guard", window = 87, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
