-- ARKHER SYSTEM K.0257 :: Vision Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0257"
	S.key = "arkher.npc.vision.perception"
	S.name = "Vision Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.vision.emotion" }
	S.tags = { "k", "vision", "perception", "npc" }
	S.description = "Vision Perception: sight, hearing and bounded attention for the Vision subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.vision.perception", sightRange = 60, hearingRange = 32, attentionSlots = 6, fov = 1.670 })
		inst.system = S
		inst.ctx = ctx
