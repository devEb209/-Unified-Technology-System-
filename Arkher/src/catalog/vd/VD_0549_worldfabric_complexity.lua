-- ARKHER SYSTEM VD.0549 :: World Fabric Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0549"
	S.key = "arkher.contsim.worldfabric.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldfabric.world_memory_stream" }
	S.tags = { "vd", "worldfabric", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.worldfabric.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
