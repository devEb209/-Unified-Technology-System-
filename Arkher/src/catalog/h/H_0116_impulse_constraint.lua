-- ARKHER SYSTEM H.0116 :: Impulse Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0116"
	S.key = "arkher.physics.impulse.constraint_solver"
	S.name = "Impulse Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Impulse"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.impulse.contact_generation" }
	S.tags = { "h", "impulse", "constraint", "physics" }
	S.description = "Impulse Constraint Solver: sequential impulses, friction, joints and warm starting for the Impulse subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.impulse.constraint_solver", iterations = 5, baumgarte = 0.11, warmStart = true })
		inst.system = S
		inst.ctx = ctx
