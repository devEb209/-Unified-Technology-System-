-- ARKHER SYSTEM R.0133 :: Unreliable Channel Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0133"
	S.key = "arkher.net.unreliablechannel.replication"
	S.name = "Unreliable Channel Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "unreliablechannel", "replicator", "net" }
	S.description = "Unreliable Channel Replication: authoritative entity state, interest and delta snapshots for the Unreliable Channel subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.unreliablechannel.replication", mtu = 600, interestRadius = 440, fullEvery = 30 })
		inst.system = S
		inst.ctx = ctx
