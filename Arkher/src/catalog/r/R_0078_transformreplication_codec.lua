-- ARKHER SYSTEM R.0078 :: Transform Replication Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0078"
	S.key = "arkher.net.transformreplication.serialization_codec"
	S.name = "Transform Replication Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.transformreplication.bandwidth_budget" }
	S.tags = { "r", "transformreplication", "codec", "net" }
	S.description = "Transform Replication Serialization Codec: compact encoding, diffing and checksum of payloads for the Transform Replication subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.transformreplication.serialization_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
