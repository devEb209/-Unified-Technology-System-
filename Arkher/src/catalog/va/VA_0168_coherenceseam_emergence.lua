-- ARKHER SYSTEM VA.0168 :: Coherence Seam Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0168"
	S.key = "arkher.contworld.coherenceseam.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.coherenceseam.reality_continuum" }
	S.tags = { "va", "coherenceseam", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.coherenceseam.emergence_continuum", windowSize = 7, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
