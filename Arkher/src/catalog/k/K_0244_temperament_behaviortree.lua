-- ARKHER SYSTEM K.0244 :: Temperament Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0244"
	S.key = "arkher.npc.temperament.reactive_behaviour"
	S.name = "Temperament Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.temperament.perception" }
	S.tags = { "k", "temperament", "behaviortree", "npc" }
	S.description = "Temperament Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Temperament subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.temperament.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
