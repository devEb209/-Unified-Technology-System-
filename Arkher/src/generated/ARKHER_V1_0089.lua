--!strict
-- Blender — ANIMATION Profiler #0089
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Blender — ANIMATION Profiler #0089", size=Vector2.new(680, 500), pos=UDim2.fromOffset(457, 293), parent=parent, icon="◉"})
