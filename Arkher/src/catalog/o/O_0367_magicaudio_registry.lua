-- ARKHER SYSTEM O.0367 :: Magic Audio Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0367"
	S.key = "arkher.audio.magicaudio.asset_registry"
	S.name = "Magic Audio Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Magic Audio"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.magicaudio.streaming" }
	S.tags = { "o", "magicaudio", "registry", "audio" }
	S.description = "Magic Audio Asset Registry: catalogue of sounds, variations and metadata for the Magic Audio subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.magicaudio.asset_registry" })
		inst.system = S
		inst.ctx = ctx
