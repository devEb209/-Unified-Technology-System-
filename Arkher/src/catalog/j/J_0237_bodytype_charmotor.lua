-- ARKHER SYSTEM J.0237 :: Body Type Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0237"
	S.key = "arkher.character.bodytype.locomotion"
	S.name = "Body Type Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.bodytype.physical_response" }
	S.tags = { "j", "bodytype", "charmotor", "character" }
	S.description = "Body Type Locomotion: capsule locomotion driving the character for the Body Type subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.bodytype.locomotion", radius = 0.39, height = 1.64, maxSpeed = 6.40, jumpHeight = 1.20, stepOffset = 0.49 })
		inst.system = S
		inst.ctx = ctx
