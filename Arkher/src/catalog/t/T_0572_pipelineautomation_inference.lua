-- ARKHER SYSTEM T.0572 :: Pipeline Automation Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0572"
	S.key = "arkher.ai.pipelineautomation.model_inference"
	S.name = "Pipeline Automation Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.pipelineautomation.action_planner" }
	S.tags = { "t", "pipelineautomation", "inference", "ai" }
	S.description = "Pipeline Automation Model Inference: quantized inference with batching and budget for the Pipeline Automation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.pipelineautomation.model_inference", seed = 47524 })
		inst.system = S
		inst.ctx = ctx
