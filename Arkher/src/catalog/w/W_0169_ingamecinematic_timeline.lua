-- ARKHER SYSTEM W.0169 :: In Game Cinematic Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0169"
	S.key = "arkher.cine.ingamecinematic.sequence_timeline"
	S.name = "In Game Cinematic Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "ingamecinematic", "timeline", "cine" }
	S.description = "In Game Cinematic Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the In Game Cinematic subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.ingamecinematic.sequence_timeline", duration = 5.0, rate = 0.81 })
		inst.system = S
		inst.ctx = ctx
