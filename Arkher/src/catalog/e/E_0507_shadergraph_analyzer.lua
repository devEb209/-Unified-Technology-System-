-- ARKHER SYSTEM E.0507 :: Shader Graph Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0507"
	S.key = "arkher.material.shadergraph.analysis"
	S.name = "Shader Graph Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Shader Graph"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.shadergraph.instance_cache" }
	S.tags = { "e", "shadergraph", "analyzer", "material" }
	S.description = "Shader Graph Analysis: cost, redundancy and outlier analysis for the Shader Graph subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.shadergraph.analysis", window = 239, buckets = 15, threshold = 2.10 })
		inst.system = S
		inst.ctx = ctx
