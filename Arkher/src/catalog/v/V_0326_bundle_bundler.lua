-- ARKHER SYSTEM V.0326 :: Bundle Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0326"
	S.key = "arkher.asset.bundle.bundling"
	S.name = "Bundle Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.bundle.import" }
	S.tags = { "v", "bundle", "bundler", "asset" }
	S.description = "Bundle Bundling: size-bounded packing, manifests and delta patches for the Bundle subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.bundle.bundling", maxBundleBytes = 524288 })
		inst.system = S
		inst.ctx = ctx
