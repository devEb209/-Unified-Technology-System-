-- ARKHER SYSTEM G.0323 :: Model Distillation Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0323"
	S.key = "arkher.neural.distillation.inference_core"
	S.name = "Model Distillation Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "distillation", "inference", "neural" }
	S.description = "Model Distillation Inference Core: dense network forward pass and training for the Model Distillation subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.distillation.inference_core", seed = 72663 })
		inst.system = S
		inst.ctx = ctx
