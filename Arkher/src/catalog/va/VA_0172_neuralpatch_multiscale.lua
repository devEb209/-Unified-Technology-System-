-- ARKHER SYSTEM VA.0172 :: Neural Patch Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VA.0172"
	S.key = "arkher.contworld.neuralpatch.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.neuralpatch.sparse_residency" }
	S.tags = { "va", "neuralpatch", "multiscale", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contworld.neuralpatch.multi-scale_fidelity", levels = 4, baseTriangles = 165000 })
		inst.system = S
		inst.ctx = ctx
