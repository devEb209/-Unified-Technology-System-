-- ARKHER SYSTEM V.0009 :: Mesh Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0009"
	S.key = "arkher.asset.meshasset.size_budget"
	S.name = "Mesh Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.meshasset.compression_codec" }
	S.tags = { "v", "meshasset", "budgeter", "asset" }
	S.description = "Mesh Size Budget: byte budget shared between competing asset classes for the Mesh subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.meshasset.size_budget", total = 393, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
