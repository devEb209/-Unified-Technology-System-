-- ARKHER SYSTEM VC.0366 :: Quest Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0366"
	S.key = "arkher.contneural.questcont.coherence_guard"
	S.name = "Quest Continuum Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.questcont.persistent_state" }
	S.tags = { "vc", "questcont", "coherence", "contneural" }
	S.description = "Quest Continuum Coherence Guard: seam coherence and drift supervision for the Quest Continuum subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.questcont.coherence_guard", window = 140, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
