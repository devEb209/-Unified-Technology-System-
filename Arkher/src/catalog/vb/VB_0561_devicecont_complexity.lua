-- ARKHER SYSTEM VB.0561 :: Device Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0561"
	S.key = "arkher.conttime.devicecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.devicecont.world_memory_stream" }
	S.tags = { "vb", "devicecont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.devicecont.complexity_budget", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
