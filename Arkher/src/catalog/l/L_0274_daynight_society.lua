-- ARKHER SYSTEM L.0274 :: Day Night Cycle Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0274"
	S.key = "arkher.sim.daynight.society"
	S.name = "Day Night Cycle Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.daynight.economy" }
	S.tags = { "l", "daynight", "society", "sim" }
	S.description = "Day Night Cycle Society: relations, factions, reputation and cohesion of the region for the Day Night Cycle subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.daynight.society", decayRate = 0.012, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
