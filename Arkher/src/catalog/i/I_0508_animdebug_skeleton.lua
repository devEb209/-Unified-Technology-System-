-- ARKHER SYSTEM I.0508 :: Animation Debug Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0508"
	S.key = "arkher.anim.animdebug.skeleton"
	S.name = "Animation Debug Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "animdebug", "skeleton", "anim" }
	S.description = "Animation Debug Skeleton: bone hierarchy, bind pose and world resolution for the Animation Debug subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.animdebug.skeleton" })
		inst.system = S
		inst.ctx = ctx
