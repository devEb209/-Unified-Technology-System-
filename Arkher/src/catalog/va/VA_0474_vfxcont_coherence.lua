-- ARKHER SYSTEM VA.0474 :: VFX Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0474"
	S.key = "arkher.contworld.vfxcont.coherence_guard"
	S.name = "VFX Continuum Coherence Guard"
	S.category = "VA"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vfxcont.persistent_state" }
	S.tags = { "va", "vfxcont", "coherence", "contworld" }
	S.description = "VFX Continuum Coherence Guard: seam coherence and drift supervision for the VFX Continuum subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.vfxcont.coherence_guard", window = 114, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
