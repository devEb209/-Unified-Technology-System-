-- ARKHER SYSTEM N.0196 :: Cloud Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0196"
	S.key = "arkher.vfx.cloud.emission"
	S.name = "Cloud Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloud"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "cloud", "emitter", "vfx" }
	S.description = "Cloud Emission: shaped, rate and burst emission of new particles for the Cloud subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.cloud.emission", shape = "box", rate = 22, speed = 5.20, life = 1.00, budget = 512, seed = 97022 })
		inst.system = S
		inst.ctx = ctx
