-- ARKHER SYSTEM Z.0101 :: Universal Simulation Fabric Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0101"
	S.key = "arkher.origin.simfabric.reality_layering"
	S.name = "Universal Simulation Fabric Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "simfabric", "reality", "origin" }
	S.description = "Universal Simulation Fabric Reality Layering: stacked authored, simulated, proposed and player realities for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.simfabric.reality_layering" })
		inst.system = S
		inst.ctx = ctx
