-- ARKHER SYSTEM T.0698 :: AI Debug Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0698"
	S.key = "arkher.ai.aidebug.model_inference"
	S.name = "AI Debug Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.aidebug.action_planner" }
	S.tags = { "t", "aidebug", "inference", "ai" }
	S.description = "AI Debug Model Inference: quantized inference with batching and budget for the AI Debug subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.aidebug.model_inference", seed = 42496 })
		inst.system = S
		inst.ctx = ctx
