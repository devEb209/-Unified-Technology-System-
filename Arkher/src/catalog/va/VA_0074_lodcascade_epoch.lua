-- ARKHER SYSTEM VA.0074 :: LOD Cascade Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0074"
	S.key = "arkher.contworld.lodcascade.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lodcascade.infinite_grid" }
	S.tags = { "va", "lodcascade", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.lodcascade.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
