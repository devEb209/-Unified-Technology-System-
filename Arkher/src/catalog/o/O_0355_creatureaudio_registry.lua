-- ARKHER SYSTEM O.0355 :: Creature Audio Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0355"
	S.key = "arkher.audio.creatureaudio.asset_registry"
	S.name = "Creature Audio Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.creatureaudio.streaming" }
	S.tags = { "o", "creatureaudio", "registry", "audio" }
	S.description = "Creature Audio Asset Registry: catalogue of sounds, variations and metadata for the Creature Audio subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.creatureaudio.asset_registry" })
		inst.system = S
		inst.ctx = ctx
