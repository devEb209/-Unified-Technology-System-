-- ARKHER SYSTEM E.0279 :: Decal Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0279"
	S.key = "arkher.material.decal.compression_codec"
	S.name = "Decal Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Decal"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.decal.streaming" }
	S.tags = { "e", "decal", "codec", "material" }
	S.description = "Decal Compression Codec: serialization and compression of material data for the Decal subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.decal.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
