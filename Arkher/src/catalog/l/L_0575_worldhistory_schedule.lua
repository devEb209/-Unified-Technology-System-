-- ARKHER SYSTEM L.0575 :: World History Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0575"
	S.key = "arkher.sim.worldhistory.calendar"
	S.name = "World History Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldhistory.society" }
	S.tags = { "l", "worldhistory", "schedule", "sim" }
	S.description = "World History Calendar: hours, days and seasons driving the region for the World History subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.worldhistory.calendar", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
