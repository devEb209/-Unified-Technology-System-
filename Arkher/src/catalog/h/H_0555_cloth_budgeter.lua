-- ARKHER SYSTEM H.0555 :: Cloth Simulation Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0555"
	S.key = "arkher.physics.cloth.budget_governor"
	S.name = "Cloth Simulation Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.cloth.broadphase_index" }
	S.tags = { "h", "cloth", "budgeter", "physics" }
	S.description = "Cloth Simulation Budget Governor: simulation time budget allocation across islands for the Cloth Simulation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.cloth.budget_governor", total = 311, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
