-- ARKHER SYSTEM Z.0170 :: Self Analyzing Project Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0170"
	S.key = "arkher.origin.selfanalyzing.self_critique"
	S.name = "Self Analyzing Project Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.intent_bridge" }
	S.tags = { "z", "selfanalyzing", "critic", "origin" }
	S.description = "Self Analyzing Project Self Critique: weighted judgement of the technology's own output for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.selfanalyzing.self_critique", passMark = 0.79, reviseMark = 0.49, seed = 75729 })
		inst.system = S
		inst.ctx = ctx
