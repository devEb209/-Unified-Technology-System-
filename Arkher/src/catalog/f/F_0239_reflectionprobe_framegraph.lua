-- ARKHER SYSTEM F.0239 :: Reflection Probe Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0239"
	S.key = "arkher.render.reflectionprobe.frame_graph"
	S.name = "Reflection Probe Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "reflectionprobe", "framegraph", "render" }
	S.description = "Reflection Probe Frame Graph: declared passes, culling, ordering and aliasing for the Reflection Probe subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.reflectionprobe.frame_graph", budgetMs = 10.00 })
		inst.system = S
		inst.ctx = ctx
