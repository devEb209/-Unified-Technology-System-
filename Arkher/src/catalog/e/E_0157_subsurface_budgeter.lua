-- ARKHER SYSTEM E.0157 :: Subsurface Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0157"
	S.key = "arkher.material.subsurface.parameter_budget"
	S.name = "Subsurface Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Subsurface"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.subsurface.variant_registry" }
	S.tags = { "e", "subsurface", "budgeter", "material" }
	S.description = "Subsurface Parameter Budget: texel and layer budget allocation for the Subsurface subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.subsurface.parameter_budget", total = 338, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
