-- ARKHER SYSTEM J.0130 :: Breathing Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0130"
	S.key = "arkher.character.breathing.budget_governor"
	S.name = "Breathing Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.breathing.variant_registry" }
	S.tags = { "j", "breathing", "budgeter", "character" }
	S.description = "Breathing Budget Governor: per-character cost allocation in a crowd for the Breathing subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.breathing.budget_governor", total = 147, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
