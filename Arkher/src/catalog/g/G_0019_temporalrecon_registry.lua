-- ARKHER SYSTEM G.0019 :: Temporal Reconstruction Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0019"
	S.key = "arkher.neural.temporalrecon.model_registry"
	S.name = "Temporal Reconstruction Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.temporalrecon.reconstruction" }
	S.tags = { "g", "temporalrecon", "registry", "neural" }
	S.description = "Temporal Reconstruction Model Registry: named models and their lifecycle for the Temporal Reconstruction subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.temporalrecon.model_registry" })
		inst.system = S
		inst.ctx = ctx
