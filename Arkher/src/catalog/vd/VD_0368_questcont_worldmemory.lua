-- ARKHER SYSTEM VD.0368 :: Quest Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0368"
	S.key = "arkher.contsim.questcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.questcont.neural_field" }
	S.tags = { "vd", "questcont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.questcont.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
