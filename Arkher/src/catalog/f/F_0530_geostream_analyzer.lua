-- ARKHER SYSTEM F.0530 :: Geometry Streaming Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0530"
	S.key = "arkher.render.geostream.frame_analysis"
	S.name = "Geometry Streaming Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.geostream.pass_cache" }
	S.tags = { "f", "geostream", "analyzer", "render" }
	S.description = "Geometry Streaming Frame Analysis: per-pass cost analysis and outlier detection for the Geometry Streaming subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.geostream.frame_analysis", window = 171, buckets = 11, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
