-- ARKHER SYSTEM K.0442 :: Local Avoidance Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0442"
	S.key = "arkher.npc.localavoidance.goal_planner"
	S.name = "Local Avoidance Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.localavoidance.utility_reasoning" }
	S.tags = { "k", "localavoidance", "planner", "npc" }
	S.description = "Local Avoidance Goal Planner: backward GOAP planning to reach a goal state for the Local Avoidance subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.localavoidance.goal_planner", maxDepth = 10 })
		inst.system = S
		inst.ctx = ctx
