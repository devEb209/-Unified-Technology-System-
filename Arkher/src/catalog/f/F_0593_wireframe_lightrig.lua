-- ARKHER SYSTEM F.0593 :: Wireframe Overlay Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0593"
	S.key = "arkher.render.wireframe.lighting_rig"
	S.name = "Wireframe Overlay Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.wireframe.geometry_virtualization" }
	S.tags = { "f", "wireframe", "lightrig", "render" }
	S.description = "Wireframe Overlay Lighting Rig: light clustering, importance and cascades for the Wireframe Overlay subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.wireframe.lighting_rig", maxActive = 4 })
		inst.system = S
		inst.ctx = ctx
