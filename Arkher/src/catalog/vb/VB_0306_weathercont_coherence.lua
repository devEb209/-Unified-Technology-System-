-- ARKHER SYSTEM VB.0306 :: Weather Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0306"
	S.key = "arkher.conttime.weathercont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.weathercont.persistent_state" }
	S.tags = { "vb", "weathercont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.weathercont.coherence_guard", window = 55, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
