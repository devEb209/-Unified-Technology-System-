-- ARKHER SYSTEM I.0266 :: Foot Placement IK Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0266"
	S.key = "arkher.anim.footik.retarget_graph"
	S.name = "Foot Placement IK Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.footik.physical_blend" }
	S.tags = { "i", "footik", "graph", "anim" }
	S.description = "Foot Placement IK Retarget Graph: bone mapping and retarget path resolution for the Foot Placement IK subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.footik.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
