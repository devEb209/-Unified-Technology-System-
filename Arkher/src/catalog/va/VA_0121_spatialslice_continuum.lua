-- ARKHER SYSTEM VA.0121 :: Spatial Slice Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0121"
	S.key = "arkher.contworld.spatialslice.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "spatialslice", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.spatialslice.infinite_grid", cellSize = 96, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
