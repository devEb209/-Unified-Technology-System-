-- ARKHER SYSTEM L.0497 :: War Ecology
...
return function(A)
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.war.simulation_core" }
	S.tags = { "l", "war", "ecology", "sim" }
	S.description = "War Ecology: populations, predation, harvesting and carrying capacity for the War subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.war.ecology" })
		inst.system = S
		inst.ctx = ctx
