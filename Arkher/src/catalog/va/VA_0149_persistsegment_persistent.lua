-- ARKHER SYSTEM VA.0149 :: Persistence Segment Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0149"
	S.key = "arkher.contworld.persistsegment.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.persistsegment.multi-scale_fidelity" }
	S.tags = { "va", "persistsegment", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.persistsegment.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
