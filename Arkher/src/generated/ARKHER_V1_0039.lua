--!strict
-- Puter Singularity — ANIMATION Profiler #0039
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Puter Singularity — ANIMATION Profiler #0039", size=Vector2.new(600, 500), pos=UDim2.fromOffset(207, 223), parent=parent, icon="♪"})
...
Components.TextField(right, "File", "input.png", function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_File"..39, v) end end)
