-- ARKHER SYSTEM VB.0605 :: Seam Lattice Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0605"
	S.key = "arkher.conttime.seamlattice.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.seamlattice.multi-scale_fidelity" }
	S.tags = { "vb", "seamlattice", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.seamlattice.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
