-- ARKHER SYSTEM L.0034 :: Offscreen Simulation Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0034"
	S.key = "arkher.sim.offscreensim.society"
	S.name = "Offscreen Simulation Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.offscreensim.economy" }
	S.tags = { "l", "offscreensim", "society", "sim" }
	S.description = "Offscreen Simulation Society: relations, factions, reputation and cohesion of the region for the Offscreen Simulation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.offscreensim.society", decayRate = 0.008, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
