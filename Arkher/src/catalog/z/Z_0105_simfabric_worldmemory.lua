-- ARKHER SYSTEM Z.0105 :: Universal Simulation Fabric World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0105"
	S.key = "arkher.origin.simfabric.world_memory"
	S.name = "Universal Simulation Fabric World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.simfabric.autonomous_pipeline" }
	S.tags = { "z", "simfabric", "worldmemory", "origin" }
	S.description = "Universal Simulation Fabric World Memory: epoch-stamped persistent history with compaction and checkpoints for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.simfabric.world_memory", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
