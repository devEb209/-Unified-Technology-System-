-- ARKHER SYSTEM T.0272 :: Level Design Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0272"
	S.key = "arkher.ai.leveldesign.reasoning_graph"
	S.name = "Level Design Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.leveldesign.world_architect" }
	S.tags = { "t", "leveldesign", "graph", "ai" }
	S.description = "Level Design Reasoning Graph: relationship modelling and shortest-path reasoning for the Level Design subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.leveldesign.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
