-- ARKHER SYSTEM G.0321 :: Weight Quantization Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0321"
	S.key = "arkher.neural.quantization.sampling_graph"
	S.name = "Weight Quantization Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.quantization.training_ledger" }
	S.tags = { "g", "quantization", "graph", "neural" }
	S.description = "Weight Quantization Sampling Graph: dependency graph of sampling stages for the Weight Quantization subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.quantization.sampling_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
