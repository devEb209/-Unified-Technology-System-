-- ARKHER SYSTEM I.0173 :: Crossfade Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0173"
	S.key = "arkher.anim.crossfade.inverse_kinematics"
	S.name = "Crossfade Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Crossfade"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crossfade.layered_blending" }
	S.tags = { "i", "crossfade", "ik", "anim" }
	S.description = "Crossfade Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Crossfade subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.crossfade.inverse_kinematics", iterations = 5, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
