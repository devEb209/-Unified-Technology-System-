-- ARKHER SYSTEM J.0057 :: Eyes Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0057"
	S.key = "arkher.character.eyes.motion_set"
	S.name = "Eyes Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.eyes.rig_definition" }
	S.tags = { "j", "eyes", "clip", "character" }
	S.description = "Eyes Motion Set: the clips a character owns and how they sample for the Eyes subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.eyes.motion_set", duration = 2.90, loop = true })
		inst.system = S
		inst.ctx = ctx
