-- ARKHER SYSTEM VA.0540 :: Pipeline Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0540"
	S.key = "arkher.contworld.pipelinecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.pipelinecont.reality_continuum" }
	S.tags = { "va", "pipelinecont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.pipelinecont.emergence_continuum", windowSize = 5, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
