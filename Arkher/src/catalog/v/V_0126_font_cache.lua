-- ARKHER SYSTEM V.0126 :: Font Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0126"
	S.key = "arkher.asset.font.content_cache"
	S.name = "Font Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.font.dependency_graph" }
	S.tags = { "v", "font", "cache", "asset" }
	S.description = "Font Content Cache: reuse of already cooked results for the Font subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.font.content_cache", policy = "ttl", capacity = 256, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
