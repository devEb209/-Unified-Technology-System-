-- ARKHER SYSTEM T.0383 :: Refactoring World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0383"
	S.key = "arkher.ai.refactoring.world_architect"
	S.name = "Refactoring World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.refactoring.self_critique" }
	S.tags = { "t", "refactoring", "architect", "ai" }
	S.description = "Refactoring World Architect: composition of a whole world plan with conserved budgets for the Refactoring subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.refactoring.world_architect", budget = 700, seed = 89091 })
		inst.system = S
		inst.ctx = ctx
