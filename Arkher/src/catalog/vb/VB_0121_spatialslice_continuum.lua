-- ARKHER SYSTEM VB.0121 :: Spatial Slice Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0121"
	S.key = "arkher.conttime.spatialslice.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "spatialslice", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.spatialslice.infinite_grid", cellSize = 192, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
