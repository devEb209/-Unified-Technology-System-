-- ARKHER SYSTEM VB.0043 :: Continuum Stream Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0043"
	S.key = "arkher.conttime.continuumstream.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.continuumstream.coherence_guard" }
	S.tags = { "vb", "continuumstream", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.continuumstream.neural_field", dims = 20, hidden = 16, seed = 52202 })
		inst.system = S
		inst.ctx = ctx
