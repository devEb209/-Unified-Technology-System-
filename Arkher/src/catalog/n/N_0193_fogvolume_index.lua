-- ARKHER SYSTEM N.0193 :: Fog Volume Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0193"
	S.key = "arkher.vfx.fogvolume.spatial_index"
	S.name = "Fog Volume Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fog Volume"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fogvolume.quality_policy" }
	S.tags = { "n", "fogvolume", "index", "vfx" }
	S.description = "Fog Volume Spatial Index: spatial acceleration of effect queries and culling for the Fog Volume subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.fogvolume.spatial_index", mode = "hash", cellSize = 80 })
		inst.system = S
		inst.ctx = ctx
