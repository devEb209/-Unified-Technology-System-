-- ARKHER SYSTEM VC.0550 :: World Fabric Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0550"
	S.key = "arkher.contneural.worldfabric.simulation_fabric"
	S.name = "World Fabric Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldfabric.complexity_budget" }
	S.tags = { "vc", "worldfabric", "fabric", "contneural" }
	S.description = "World Fabric Simulation Fabric: fabric stepping the continuum domains for the World Fabric subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.worldfabric.simulation_fabric", budgetMs = 2.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
