-- ARKHER SYSTEM Z.0350 :: Device Aware Fidelity Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0350"
	S.key = "arkher.origin.deviceaware.self_critique"
	S.name = "Device Aware Fidelity Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.intent_bridge" }
	S.tags = { "z", "deviceaware", "critic", "origin" }
	S.description = "Device Aware Fidelity Self Critique: weighted judgement of the technology's own output for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.deviceaware.self_critique", passMark = 0.74, reviseMark = 0.49, seed = 18499 })
		inst.system = S
		inst.ctx = ctx
