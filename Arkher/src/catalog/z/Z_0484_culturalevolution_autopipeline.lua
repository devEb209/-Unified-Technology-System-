-- ARKHER SYSTEM Z.0484 :: Cultural Evolution Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0484"
	S.key = "arkher.origin.culturalevolution.autonomous_pipeline"
	S.name = "Cultural Evolution Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.simulation_fabric" }
	S.tags = { "z", "culturalevolution", "autopipeline", "origin" }
	S.description = "Cultural Evolution Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.culturalevolution.autonomous_pipeline", maxIterations = 5 })
		inst.system = S
		inst.ctx = ctx
