-- ARKHER SYSTEM P.0450 :: Difficulty Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0450"
	S.key = "arkher.play.difficulty.rule_pipeline"
	S.name = "Difficulty Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Difficulty"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.difficulty.state_machine" }
	S.tags = { "p", "difficulty", "pipeline", "play" }
	S.description = "Difficulty Rule Pipeline: ordered rules applied to every gameplay event for the Difficulty subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.difficulty.rule_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
