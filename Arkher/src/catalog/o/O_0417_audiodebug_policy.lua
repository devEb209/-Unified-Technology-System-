-- ARKHER SYSTEM O.0417 :: Audio Debug Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0417"
	S.key = "arkher.audio.audiodebug.playback_policy"
	S.name = "Audio Debug Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Audio Debug"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiodebug.compression_codec" }
	S.tags = { "o", "audiodebug", "policy", "audio" }
	S.description = "Audio Debug Playback Policy: rules choosing what may be heard right now for the Audio Debug subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.audiodebug.playback_policy", algorithm = "wfq", starvationGuard = 62 })
		inst.system = S
		inst.ctx = ctx
