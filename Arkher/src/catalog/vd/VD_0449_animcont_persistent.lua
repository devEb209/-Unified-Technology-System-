-- ARKHER SYSTEM VD.0449 :: Animation Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0449"
	S.key = "arkher.contsim.animcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.animcont.multi-scale_fidelity" }
	S.tags = { "vd", "animcont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.animcont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
