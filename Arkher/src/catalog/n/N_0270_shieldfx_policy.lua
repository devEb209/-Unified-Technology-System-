-- ARKHER SYSTEM N.0270 :: Shield Effect Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0270"
	S.key = "arkher.vfx.shieldfx.quality_policy"
	S.name = "Shield Effect Quality Policy"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.shieldfx.result_cache" }
	S.tags = { "n", "shieldfx", "policy", "vfx" }
	S.description = "Shield Effect Quality Policy: distance and device driven fidelity bands for the Shield Effect subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.shieldfx.quality_policy", algorithm = "wfq", starvationGuard = 22 })
		inst.system = S
		inst.ctx = ctx
