-- ARKHER SYSTEM R.0354 :: Network Debug Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0354"
	S.key = "arkher.net.networkdebug.serialization_codec"
	S.name = "Network Debug Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.networkdebug.bandwidth_budget" }
	S.tags = { "r", "networkdebug", "codec", "net" }
	S.description = "Network Debug Serialization Codec: compact encoding, diffing and checksum of payloads for the Network Debug subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.networkdebug.serialization_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
