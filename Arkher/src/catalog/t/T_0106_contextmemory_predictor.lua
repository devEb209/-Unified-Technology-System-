-- ARKHER SYSTEM T.0106 :: Context Memory Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0106"
	S.key = "arkher.ai.contextmemory.outcome_prediction"
	S.name = "Context Memory Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.contextmemory.decision_policy" }
	S.tags = { "t", "contextmemory", "predictor", "ai" }
	S.description = "Context Memory Outcome Prediction: forecasting the result before the work is done for the Context Memory subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.contextmemory.outcome_prediction", method = "ema", alpha = 0.46, window = 68 })
		inst.system = S
		inst.ctx = ctx
