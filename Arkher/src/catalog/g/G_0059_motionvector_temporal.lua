-- ARKHER SYSTEM G.0059 :: Motion Vector Estimation Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0059"
	S.key = "arkher.neural.motionvector.temporal_history"
	S.name = "Motion Vector Estimation Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.motionvector.feature_extraction" }
	S.tags = { "g", "motionvector", "temporal", "neural" }
	S.description = "Motion Vector Estimation Temporal History: history buffers reused across frames for the Motion Vector Estimation subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.motionvector.temporal_history", feedback = 0.80, phase = 8 })
		inst.system = S
		inst.ctx = ctx
