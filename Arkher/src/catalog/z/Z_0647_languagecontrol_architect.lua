-- ARKHER SYSTEM Z.0647 :: Natural Language Engine Control World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0647"
	S.key = "arkher.origin.languagecontrol.world_architect"
	S.name = "Natural Language Engine Control World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.languagecontrol.emergence_detection" }
	S.tags = { "z", "languagecontrol", "architect", "origin" }
	S.description = "Natural Language Engine Control World Architect: hierarchical world composition with conserved budgets for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.languagecontrol.world_architect", budget = 1500, seed = 7249 })
		inst.system = S
		inst.ctx = ctx
