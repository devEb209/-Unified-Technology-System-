-- ARKHER SYSTEM H.0009 :: Rigid Body Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0009"
	S.key = "arkher.physics.rigidbody.budget_governor"
	S.name = "Rigid Body Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Rigid Body"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rigidbody.broadphase_index" }
	S.tags = { "h", "rigidbody", "budgeter", "physics" }
	S.description = "Rigid Body Budget Governor: simulation time budget allocation across islands for the Rigid Body subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.rigidbody.budget_governor", total = 376, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
