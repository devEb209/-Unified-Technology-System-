-- ARKHER SYSTEM F.0327 :: Motion Blur Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0327"
	S.key = "arkher.render.motionblur.lighting_rig"
	S.name = "Motion Blur Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Motion Blur"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.motionblur.geometry_virtualization" }
	S.tags = { "f", "motionblur", "lightrig", "render" }
	S.description = "Motion Blur Lighting Rig: light clustering, importance and cascades for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.motionblur.lighting_rig", maxActive = 12 })
		inst.system = S
		inst.ctx = ctx
