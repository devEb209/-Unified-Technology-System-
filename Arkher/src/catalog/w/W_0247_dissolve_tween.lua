-- ARKHER SYSTEM W.0247 :: Dissolve Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0247"
	S.key = "arkher.cine.dissolve.motion_tween"
	S.name = "Dissolve Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dissolve"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dissolve.playback_orchestrator" }
	S.tags = { "w", "dissolve", "tween", "cine" }
	S.description = "Dissolve Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Dissolve subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.dissolve.motion_tween", timeScale = 0.97 })
		inst.system = S
		inst.ctx = ctx
