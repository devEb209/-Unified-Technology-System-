-- ARKHER SYSTEM F.0362 :: Temporal Accumulation Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0362"
	S.key = "arkher.render.temporalaccum.frame_analysis"
	S.name = "Temporal Accumulation Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.temporalaccum.pass_cache" }
	S.tags = { "f", "temporalaccum", "analyzer", "render" }
	S.description = "Temporal Accumulation Frame Analysis: per-pass cost analysis and outlier detection for the Temporal Accumulation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.temporalaccum.frame_analysis", window = 150, buckets = 18, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
