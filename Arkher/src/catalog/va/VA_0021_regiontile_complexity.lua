-- ARKHER SYSTEM VA.0021 :: Region Tile Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0021"
	S.key = "arkher.contworld.regiontile.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.regiontile.world_memory_stream" }
	S.tags = { "va", "regiontile", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.regiontile.complexity_budget", targetMs = 19.0 })
		inst.system = S
		inst.ctx = ctx
