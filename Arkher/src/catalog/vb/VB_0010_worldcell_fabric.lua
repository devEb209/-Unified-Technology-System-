-- ARKHER SYSTEM VB.0010 :: World Grid Cell Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0010"
	S.key = "arkher.conttime.worldcell.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldcell.complexity_budget" }
	S.tags = { "vb", "worldcell", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.worldcell.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
