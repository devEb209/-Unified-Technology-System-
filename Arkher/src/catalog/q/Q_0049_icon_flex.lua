-- ARKHER SYSTEM Q.0049 :: Icon Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0049"
	S.key = "arkher.ui.icon.responsive_layout"
	S.name = "Icon Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Icon"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "icon", "flex", "ui" }
	S.description = "Icon Responsive Layout: flex solving with safe areas, weights and breakpoints for the Icon subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.icon.responsive_layout", width = 510, height = 1024, scale = 0.93 })
		inst.system = S
		inst.ctx = ctx
