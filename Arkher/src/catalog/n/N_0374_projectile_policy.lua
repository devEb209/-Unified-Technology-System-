-- ARKHER SYSTEM N.0374 :: Projectile Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0374"
	S.key = "arkher.vfx.projectile.quality_policy"
	S.name = "Projectile Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Projectile"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.projectile.result_cache" }
	S.tags = { "n", "projectile", "policy", "vfx" }
	S.description = "Projectile Quality Policy: distance and device driven fidelity bands for the Projectile subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.projectile.quality_policy", algorithm = "edf", starvationGuard = 17 })
		inst.system = S
		inst.ctx = ctx
