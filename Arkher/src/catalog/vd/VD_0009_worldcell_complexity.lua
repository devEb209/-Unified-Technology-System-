-- ARKHER SYSTEM VD.0009 :: World Grid Cell Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0009"
	S.key = "arkher.contsim.worldcell.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldcell.world_memory_stream" }
	S.tags = { "vd", "worldcell", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.worldcell.complexity_budget", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
