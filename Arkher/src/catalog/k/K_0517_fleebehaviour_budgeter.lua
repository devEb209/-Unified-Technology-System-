-- ARKHER SYSTEM K.0517 :: Flee Behaviour Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0517"
	S.key = "arkher.npc.fleebehaviour.thinking_budget"
	S.name = "Flee Behaviour Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.fleebehaviour.daily_schedule" }
	S.tags = { "k", "fleebehaviour", "budgeter", "npc" }
	S.description = "Flee Behaviour Thinking Budget: allocation of per-frame thinking time across NPCs for the Flee Behaviour subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.fleebehaviour.thinking_budget", total = 67, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
