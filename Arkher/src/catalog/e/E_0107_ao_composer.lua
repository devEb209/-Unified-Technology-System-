-- ARKHER SYSTEM E.0107 :: Ambient Occlusion Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0107"
	S.key = "arkher.material.ao.layer_composition"
	S.name = "Ambient Occlusion Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.ao.definition" }
	S.tags = { "e", "ao", "composer", "material" }
	S.description = "Ambient Occlusion Layer Composition: ordered layer composition with blend rules for the Ambient Occlusion subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.ao.layer_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
