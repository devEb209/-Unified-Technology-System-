-- ARKHER SYSTEM T.0382 :: Refactoring Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0382"
	S.key = "arkher.ai.refactoring.self_critique"
	S.name = "Refactoring Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.refactoring.plan_workflow" }
	S.tags = { "t", "refactoring", "critic", "ai" }
	S.description = "Refactoring Self Critique: weighted evaluation of the result against declared criteria for the Refactoring subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.refactoring.self_critique", passMark = 0.74, reviseMark = 0.49, seed = 59209 })
		inst.system = S
		inst.ctx = ctx
