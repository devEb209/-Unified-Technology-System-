-- ARKHER SYSTEM VC.0539 :: Pipeline Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0539"
	S.key = "arkher.contneural.pipelinecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.pipelinecont.simulation_fabric" }
	S.tags = { "vc", "pipelinecont", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.pipelinecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
