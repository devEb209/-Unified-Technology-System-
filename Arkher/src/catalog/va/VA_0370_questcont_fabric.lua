-- ARKHER SYSTEM VA.0370 :: Quest Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0370"
	S.key = "arkher.contworld.questcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.questcont.complexity_budget" }
	S.tags = { "va", "questcont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.questcont.simulation_fabric", budgetMs = 4.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
