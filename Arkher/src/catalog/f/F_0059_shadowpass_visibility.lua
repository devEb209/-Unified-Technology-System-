-- ARKHER SYSTEM F.0059 :: Shadow Pass Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0059"
	S.key = "arkher.render.shadowpass.visibility_set"
	S.name = "Shadow Pass Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Shadow Pass"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.shadowpass.view_and_culling" }
	S.tags = { "f", "shadowpass", "visibility", "render" }
	S.description = "Shadow Pass Visibility Set: cell, portal and occluder visibility for the Shadow Pass subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.shadowpass.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
