-- ARKHER SYSTEM VD.0038 :: Continuum Stream Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0038"
	S.key = "arkher.contsim.continuumstream.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.continuumstream.infinite_grid" }
	S.tags = { "vd", "continuumstream", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.continuumstream.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
