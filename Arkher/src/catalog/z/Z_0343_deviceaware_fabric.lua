-- ARKHER SYSTEM Z.0343 :: Device Aware Fidelity Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0343"
	S.key = "arkher.origin.deviceaware.simulation_fabric"
	S.name = "Device Aware Fidelity Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.complexity_governance" }
	S.tags = { "z", "deviceaware", "fabric", "origin" }
	S.description = "Device Aware Fidelity Simulation Fabric: every simulation domain stepped under one budgeted clock for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.deviceaware.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
