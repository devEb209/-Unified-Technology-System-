-- ARKHER SYSTEM N.0019 :: Smoke Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0019"
	S.key = "arkher.vfx.smoke.effect_graph"
	S.name = "Smoke Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Smoke"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.smoke.curve_authoring" }
	S.tags = { "n", "smoke", "shadegraph", "vfx" }
	S.description = "Smoke Effect Graph: node graph describing how the effect is shaded for the Smoke subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.smoke.effect_graph" })
		inst.system = S
		inst.ctx = ctx
