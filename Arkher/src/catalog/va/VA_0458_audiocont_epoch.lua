-- ARKHER SYSTEM VA.0458 :: Audio Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0458"
	S.key = "arkher.contworld.audiocont.epoch_clock"
	S.name = "Audio Continuum Epoch Clock"
	S.category = "VA"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.audiocont.infinite_grid" }
	S.tags = { "va", "audiocont", "epoch", "contworld" }
	S.description = "Audio Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Audio Continuum subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.audiocont.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
