-- ARKHER SYSTEM Q.0254 :: Settings Screen Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0254"
	S.key = "arkher.ui.settingsscreen.widget_tree"
	S.name = "Settings Screen Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.settingsscreen.responsive_layout" }
	S.tags = { "q", "settingsscreen", "widget", "ui" }
	S.description = "Settings Screen Widget Tree: retained widget nodes, properties, bindings and rendering for the Settings Screen subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.settingsscreen.widget_tree", theme = "light", scale = 0.79 })
		inst.system = S
		inst.ctx = ctx
