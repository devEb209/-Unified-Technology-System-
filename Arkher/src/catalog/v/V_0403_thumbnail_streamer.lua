-- ARKHER SYSTEM V.0403 :: Thumbnail Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0403"
	S.key = "arkher.asset.thumbnail.streaming_residency"
	S.name = "Thumbnail Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.thumbnail.content_cache" }
	S.tags = { "v", "thumbnail", "streamer", "asset" }
	S.description = "Thumbnail Streaming Residency: distance-driven load and unload of asset payloads for the Thumbnail subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.thumbnail.streaming_residency", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
