-- ARKHER SYSTEM L.0312 :: Resource Node Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0312"
	S.key = "arkher.sim.resourcenode.aggregate_cache"
	S.name = "Resource Node Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.resourcenode.fidelity_policy" }
	S.tags = { "l", "resourcenode", "cache", "sim" }
	S.description = "Resource Node Aggregate Cache: reuse of expensive aggregate computations for the Resource Node subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.resourcenode.aggregate_cache", policy = "lru", capacity = 71, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
