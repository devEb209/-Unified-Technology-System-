-- ARKHER SYSTEM R.0196 :: Client Prediction Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0196"
	S.key = "arkher.net.clientprediction.transport_graph"
	S.name = "Client Prediction Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.clientprediction.prediction_and_reconciliation" }
	S.tags = { "r", "clientprediction", "network", "net" }
	S.description = "Client Prediction Transport Graph: topology, capacity and routing between endpoints for the Client Prediction subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.clientprediction.transport_graph" })
		inst.system = S
		inst.ctx = ctx
