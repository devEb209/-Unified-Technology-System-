-- ARKHER SYSTEM H.0268 :: Sphere Collider Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0268"
	S.key = "arkher.physics.spherecollider.collision_shape"
	S.name = "Sphere Collider Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.spherecollider.body_dynamics" }
	S.tags = { "h", "spherecollider", "collider", "physics" }
	S.description = "Sphere Collider Collision Shape: shape bounds, support mapping and closest points for the Sphere Collider subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.spherecollider.collision_shape", shape = "sphere", radius = 0.70, height = 1.50, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
