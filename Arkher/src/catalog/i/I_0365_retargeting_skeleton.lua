-- ARKHER SYSTEM I.0365 :: Retargeting Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0365"
	S.key = "arkher.anim.retargeting.skeleton"
	S.name = "Retargeting Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Retargeting"
	S.aspect = "Skeleton"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "retargeting", "skeleton", "anim" }
	S.description = "Retargeting Skeleton: bone hierarchy, bind pose and world resolution for the Retargeting subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.retargeting.skeleton" })
		inst.system = S
		inst.ctx = ctx
