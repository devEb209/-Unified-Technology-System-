-- ARKHER SYSTEM Z.0137 :: Dynamic Complexity Manager Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0137"
	S.key = "arkher.origin.complexitymanager.behaviour_analysis"
	S.name = "Dynamic Complexity Manager Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.governance_policy" }
	S.tags = { "z", "complexitymanager", "analyzer", "origin" }
	S.description = "Dynamic Complexity Manager Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.complexitymanager.behaviour_analysis", window = 148, buckets = 16, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
