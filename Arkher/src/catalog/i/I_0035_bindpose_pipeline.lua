-- ARKHER SYSTEM I.0035 :: Bind Pose Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0035"
	S.key = "arkher.anim.bindpose.playback_pipeline"
	S.name = "Bind Pose Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bind Pose"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bindpose.event_ledger" }
	S.tags = { "i", "bindpose", "pipeline", "anim" }
	S.description = "Bind Pose Playback Pipeline: ordered sample, blend, ik and output stages for the Bind Pose subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.bindpose.playback_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
