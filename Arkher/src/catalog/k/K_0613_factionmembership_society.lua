-- ARKHER SYSTEM K.0613 :: Faction Membership Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0613"
	S.key = "arkher.npc.factionmembership.social_relations"
	S.name = "Faction Membership Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.factionmembership.crowd_steering" }
	S.tags = { "k", "factionmembership", "society", "npc" }
	S.description = "Faction Membership Social Relations: affinity, factions, reputation and gossip for the Faction Membership subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.factionmembership.social_relations", decayRate = 0.005, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
