-- ARKHER SYSTEM Q.0151 :: Tab Bar Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0151"
	S.key = "arkher.ui.tabbar.localization_registry"
	S.name = "Tab Bar Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tab Bar"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.tabbar.theme_composition" }
	S.tags = { "q", "tabbar", "registry", "ui" }
	S.description = "Tab Bar Localization Registry: catalogue of strings, plurals and locale metadata for the Tab Bar subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.tabbar.localization_registry" })
		inst.system = S
		inst.ctx = ctx
