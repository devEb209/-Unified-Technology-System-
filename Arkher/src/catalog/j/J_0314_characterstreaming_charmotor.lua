-- ARKHER SYSTEM J.0314 :: Character Streaming Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0314"
	S.key = "arkher.character.characterstreaming.locomotion"
	S.name = "Character Streaming Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterstreaming.physical_response" }
	S.tags = { "j", "characterstreaming", "charmotor", "character" }
	S.description = "Character Streaming Locomotion: capsule locomotion driving the character for the Character Streaming subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.characterstreaming.locomotion", radius = 0.43, height = 1.88, maxSpeed = 8.80, jumpHeight = 1.20, stepOffset = 0.43 })
		inst.system = S
		inst.ctx = ctx
