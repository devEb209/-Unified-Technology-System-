-- ARKHER SYSTEM K.0650 :: Daily Routine Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0650"
	S.key = "arkher.npc.dailyroutine.reactive_behaviour"
	S.name = "Daily Routine Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dailyroutine.perception" }
	S.tags = { "k", "dailyroutine", "behaviortree", "npc" }
	S.description = "Daily Routine Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Daily Routine subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.dailyroutine.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
