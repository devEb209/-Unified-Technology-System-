-- ARKHER SYSTEM Q.0402 :: UI Debug Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0402"
	S.key = "arkher.ui.uidebug.theme_composition"
	S.name = "UI Debug Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "UI Debug"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uidebug.navigation_graph" }
	S.tags = { "q", "uidebug", "composer", "ui" }
	S.description = "UI Debug Theme Composition: blending of theme signals into the final appearance for the UI Debug subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.uidebug.theme_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
