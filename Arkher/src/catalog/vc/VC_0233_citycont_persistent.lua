-- ARKHER SYSTEM VC.0233 :: City Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0233"
	S.key = "arkher.contneural.citycont.persistent_state"
	S.name = "City Continuum Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.citycont.multi-scale_fidelity" }
	S.tags = { "vc", "citycont", "persistent", "contneural" }
	S.description = "City Continuum Persistent State: epoch-stamped persistent history and rollback for the City Continuum subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.citycont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
