-- ARKHER SYSTEM Z.0741 :: World Compression Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0741"
	S.key = "arkher.origin.worldcompression.reality_layering"
	S.name = "World Compression Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "worldcompression", "reality", "origin" }
	S.description = "World Compression Reality Layering: stacked authored, simulated, proposed and player realities for the World Compression subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.worldcompression.reality_layering" })
		inst.system = S
		inst.ctx = ctx
