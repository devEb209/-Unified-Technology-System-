-- ARKHER SYSTEM VC.0541 :: World Fabric Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0541"
	S.key = "arkher.contneural.worldfabric.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "worldfabric", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.worldfabric.infinite_grid", cellSize = 128, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
