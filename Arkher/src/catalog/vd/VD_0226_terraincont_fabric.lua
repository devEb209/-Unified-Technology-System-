-- ARKHER SYSTEM VD.0226 :: Terrain Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0226"
	S.key = "arkher.contsim.terraincont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.terraincont.complexity_budget" }
	S.tags = { "vd", "terraincont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.terraincont.simulation_fabric", budgetMs = 2.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
