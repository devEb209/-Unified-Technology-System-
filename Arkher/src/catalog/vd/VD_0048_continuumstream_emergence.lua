-- ARKHER SYSTEM VD.0048 :: Continuum Stream Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0048"
	S.key = "arkher.contsim.continuumstream.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.continuumstream.reality_continuum" }
	S.tags = { "vd", "continuumstream", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.continuumstream.emergence_continuum", windowSize = 5, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
