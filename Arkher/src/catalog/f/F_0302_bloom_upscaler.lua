-- ARKHER SYSTEM F.0302 :: Bloom Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0302"
	S.key = "arkher.render.bloom.adaptive_resolution"
	S.name = "Bloom Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Bloom"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.bloom.temporal_resolve" }
	S.tags = { "f", "bloom", "upscaler", "render" }
	S.description = "Bloom Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Bloom subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.bloom.adaptive_resolution", targetMs = 13.10, index = 5, sharpness = 0.56 })
		inst.system = S
		inst.ctx = ctx
