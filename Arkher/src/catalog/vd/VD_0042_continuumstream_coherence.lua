-- ARKHER SYSTEM VD.0042 :: Continuum Stream Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0042"
	S.key = "arkher.contsim.continuumstream.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.continuumstream.persistent_state" }
	S.tags = { "vd", "continuumstream", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.continuumstream.coherence_guard", window = 106, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
