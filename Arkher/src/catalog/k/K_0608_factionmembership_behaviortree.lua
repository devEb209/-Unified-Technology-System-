-- ARKHER SYSTEM K.0608 :: Faction Membership Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0608"
	S.key = "arkher.npc.factionmembership.reactive_behaviour"
	S.name = "Faction Membership Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.factionmembership.perception" }
	S.tags = { "k", "factionmembership", "behaviortree", "npc" }
	S.description = "Faction Membership Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Faction Membership subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.factionmembership.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
