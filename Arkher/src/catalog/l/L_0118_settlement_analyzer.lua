-- ARKHER SYSTEM L.0118 :: Settlement Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0118"
	S.key = "arkher.sim.settlement.analysis"
	S.name = "Settlement Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.settlement.aggregate_cache" }
	S.tags = { "l", "settlement", "analyzer", "sim" }
	S.description = "Settlement Analysis: trend, anomaly and stability analysis of the world for the Settlement subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.settlement.analysis", window = 188, buckets = 16, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
