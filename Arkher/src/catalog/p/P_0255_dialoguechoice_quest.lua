-- ARKHER SYSTEM P.0255 :: Dialogue Choice Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0255"
	S.key = "arkher.play.dialoguechoice.objectives"
	S.name = "Dialogue Choice Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.dialoguechoice.inventory" }
	S.tags = { "p", "dialoguechoice", "quest", "play" }
	S.description = "Dialogue Choice Objectives: objectives, prerequisites, progress and rewards for the Dialogue Choice subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.dialoguechoice.objectives" })
		inst.system = S
		inst.ctx = ctx
