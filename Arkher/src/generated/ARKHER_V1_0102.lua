...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="RE ImGui — CORE Mixer #0102", size=Vector2.new(600, 460), pos=UDim2.fromOffset(226, 254), parent=parent, icon="⛰"})
