-- ARKHER SYSTEM H.0176 :: Sleeping Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0176"
	S.key = "arkher.physics.sleeping.broadphase_index"
	S.name = "Sleeping Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Sleeping"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sleeping.vehicle" }
	S.tags = { "h", "sleeping", "index", "physics" }
	S.description = "Sleeping Broadphase Index: spatial acceleration of candidate pair finding for the Sleeping subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.sleeping.broadphase_index", mode = "hash", cellSize = 96 })
		inst.system = S
		inst.ctx = ctx
