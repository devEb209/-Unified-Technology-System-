-- ARKHER SYSTEM W.0032 :: Scene Cut Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0032"
	S.key = "arkher.cine.scenecut.cinematic_mix"
	S.name = "Scene Cut Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Scene Cut"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.scenecut.motion_tween" }
	S.tags = { "w", "scenecut", "mixer", "cine" }
	S.description = "Scene Cut Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Scene Cut subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.scenecut.cinematic_mix", maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
