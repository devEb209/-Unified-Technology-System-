-- ARKHER SYSTEM E.0282 :: Decal Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0282"
	S.key = "arkher.material.decal.analysis"
	S.name = "Decal Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Decal"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.decal.instance_cache" }
	S.tags = { "e", "decal", "analyzer", "material" }
	S.description = "Decal Analysis: cost, redundancy and outlier analysis for the Decal subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.decal.analysis", window = 127, buckets = 15, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
