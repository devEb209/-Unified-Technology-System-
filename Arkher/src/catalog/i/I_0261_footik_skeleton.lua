-- ARKHER SYSTEM I.0261 :: Foot Placement IK Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0261"
	S.key = "arkher.anim.footik.skeleton"
	S.name = "Foot Placement IK Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "footik", "skeleton", "anim" }
	S.description = "Foot Placement IK Skeleton: bone hierarchy, bind pose and world resolution for the Foot Placement IK subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.footik.skeleton" })
		inst.system = S
		inst.ctx = ctx
