-- ARKHER SYSTEM K.0626 :: Reputation Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0626"
	S.key = "arkher.npc.reputation.crowd_steering"
	S.name = "Reputation Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.reputation.navigation" }
	S.tags = { "k", "reputation", "crowd", "npc" }
	S.description = "Reputation Crowd Steering: local avoidance, cohesion and arrival at scale for the Reputation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.reputation.crowd_steering", radius = 0.55, maxSpeed = 5.30, cellSize = 11 })
		inst.system = S
		inst.ctx = ctx
