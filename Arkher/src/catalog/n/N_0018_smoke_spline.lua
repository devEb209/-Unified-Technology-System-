-- ARKHER SYSTEM N.0018 :: Smoke Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0018"
	S.key = "arkher.vfx.smoke.curve_authoring"
	S.name = "Smoke Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Smoke"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.smoke.ribbon_and_trail" }
	S.tags = { "n", "smoke", "spline", "vfx" }
	S.description = "Smoke Curve Authoring: authored curves driving the effect over its life for the Smoke subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.smoke.curve_authoring", tension = 0.63, closed = false })
		inst.system = S
		inst.ctx = ctx
