-- ARKHER SYSTEM G.0223 :: Reflection Prediction Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0223"
	S.key = "arkher.neural.reflectpredict.sampling_graph"
	S.name = "Reflection Prediction Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.reflectpredict.training_ledger" }
	S.tags = { "g", "reflectpredict", "graph", "neural" }
	S.description = "Reflection Prediction Sampling Graph: dependency graph of sampling stages for the Reflection Prediction subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.reflectpredict.sampling_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
