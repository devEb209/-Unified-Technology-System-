-- ARKHER SYSTEM K.0371 :: Utility Selection Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0371"
	S.key = "arkher.npc.utilityselection.utility_reasoning"
	S.name = "Utility Selection Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.utilityselection.reactive_behaviour" }
	S.tags = { "k", "utilityselection", "utility", "npc" }
	S.description = "Utility Selection Utility Reasoning: scored option selection with response curves for the Utility Selection subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.utilityselection.utility_reasoning", momentum = 0.12 })
		inst.system = S
		inst.ctx = ctx
