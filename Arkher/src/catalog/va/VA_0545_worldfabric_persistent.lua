-- ARKHER SYSTEM VA.0545 :: World Fabric Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0545"
	S.key = "arkher.contworld.worldfabric.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldfabric.multi-scale_fidelity" }
	S.tags = { "va", "worldfabric", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.worldfabric.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
