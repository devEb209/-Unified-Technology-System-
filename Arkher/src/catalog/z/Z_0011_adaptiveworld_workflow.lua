-- ARKHER SYSTEM Z.0011 :: Adaptive World Intelligence Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0011"
	S.key = "arkher.origin.adaptiveworld.adaptive_workflow"
	S.name = "Adaptive World Intelligence Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.adaptiveworld.self_critique" }
	S.tags = { "z", "adaptiveworld", "workflow", "origin" }
	S.description = "Adaptive World Intelligence Adaptive Workflow: verified, retryable, reversible execution plans for the Adaptive World Intelligence subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.adaptiveworld.adaptive_workflow", maxRetries = 2, budget = 110 })
		inst.system = S
		inst.ctx = ctx
