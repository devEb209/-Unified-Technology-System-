-- ARKHER SYSTEM Z.0072 :: Reality Layer Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0072"
	S.key = "arkher.origin.realitylayer.predictive_optimization"
	S.name = "Reality Layer Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.adaptive_workflow" }
	S.tags = { "z", "realitylayer", "predictor", "origin" }
	S.description = "Reality Layer Predictive Optimization: forecast-driven optimization before the cost is paid for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.realitylayer.predictive_optimization", method = "ema", alpha = 0.37, window = 35 })
		inst.system = S
		inst.ctx = ctx
