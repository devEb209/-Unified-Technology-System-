-- ARKHER SYSTEM R.0086 :: Property Replication Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0086"
	S.key = "arkher.net.propertyreplication.time_sync"
	S.name = "Property Replication Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.propertyreplication.replication" }
	S.tags = { "r", "propertyreplication", "netclock", "net" }
	S.description = "Property Replication Time Sync: offset estimation, outlier rejection and jitter buffering for the Property Replication subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.propertyreplication.time_sync", tickRate = 40, bufferDelay = 0.060, maxSamples = 18 })
		inst.system = S
		inst.ctx = ctx
