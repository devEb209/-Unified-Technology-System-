-- ARKHER SYSTEM K.0358 :: Behaviour State Machine Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0358"
	S.key = "arkher.npc.behaviourstate.goal_planner"
	S.name = "Behaviour State Machine Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourstate.utility_reasoning" }
	S.tags = { "k", "behaviourstate", "planner", "npc" }
	S.description = "Behaviour State Machine Goal Planner: backward GOAP planning to reach a goal state for the Behaviour State Machine subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.behaviourstate.goal_planner", maxDepth = 8 })
		inst.system = S
		inst.ctx = ctx
