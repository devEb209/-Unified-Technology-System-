-- ARKHER SYSTEM Z.0055 :: Singularity World Architect Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0055"
	S.key = "arkher.origin.worldarchitect.signal_composition"
	S.name = "Singularity World Architect Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.telemetry_ledger" }
	S.tags = { "z", "worldarchitect", "composer", "origin" }
	S.description = "Singularity World Architect Signal Composition: blending of the technology's input signals into one output for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.worldarchitect.signal_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
