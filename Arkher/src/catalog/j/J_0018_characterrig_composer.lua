-- ARKHER SYSTEM J.0018 :: Character Rig Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0018"
	S.key = "arkher.character.characterrig.appearance_composer"
	S.name = "Character Rig Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterrig.locomotion" }
	S.tags = { "j", "characterrig", "composer", "character" }
	S.description = "Character Rig Appearance Composer: composition of appearance slots into a look for the Character Rig subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.characterrig.appearance_composer", mode = "add" })
		inst.system = S
		inst.ctx = ctx
