-- ARKHER SYSTEM E.0202 :: Sheen Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0202"
	S.key = "arkher.material.sheen.parameter_budget"
	S.name = "Sheen Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Sheen"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.sheen.variant_registry" }
	S.tags = { "e", "sheen", "budgeter", "material" }
	S.description = "Sheen Parameter Budget: texel and layer budget allocation for the Sheen subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.sheen.parameter_budget", total = 89, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
