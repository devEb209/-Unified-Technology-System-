-- ARKHER SYSTEM Z.0868 :: Multi Scale Simulation Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0868"
	S.key = "arkher.origin.multiscale.semantic_graph"
	S.name = "Multi Scale Simulation Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.world_architect" }
	S.tags = { "z", "multiscale", "knowledge", "origin" }
	S.description = "Multi Scale Simulation Semantic Graph: typed entities and inferred relations of the technology itself for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.multiscale.semantic_graph", dims = 48 })
		inst.system = S
		inst.ctx = ctx
