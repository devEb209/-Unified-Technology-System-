-- ARKHER SYSTEM O.0337 :: Animal Audio DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0337"
	S.key = "arkher.audio.animalaudio.dsp_chain"
	S.name = "Animal Audio DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Animal Audio"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "animalaudio", "dsp", "audio" }
	S.description = "Animal Audio DSP Chain: biquad filtering, delay, envelope and soft clipping for the Animal Audio subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.animalaudio.dsp_chain", sampleRate = 22050, filter = "highpass", cutoff = 4200, q = 0.630 })
		inst.system = S
		inst.ctx = ctx
