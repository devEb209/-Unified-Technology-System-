-- ARKHER SYSTEM VC.0002 :: World Grid Cell Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0002"
	S.key = "arkher.contneural.worldcell.epoch_clock"
	S.name = "World Grid Cell Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldcell.infinite_grid" }
	S.tags = { "vc", "worldcell", "epoch", "contneural" }
	S.description = "World Grid Cell Epoch Clock: deterministic epoch timeline with catch-up for the World Grid Cell subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.worldcell.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
