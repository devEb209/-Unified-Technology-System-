-- ARKHER SYSTEM K.0193 :: Purpose Drive Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0193"
	S.key = "arkher.npc.purposedrive.social_relations"
	S.name = "Purpose Drive Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.purposedrive.crowd_steering" }
	S.tags = { "k", "purposedrive", "society", "npc" }
	S.description = "Purpose Drive Social Relations: affinity, factions, reputation and gossip for the Purpose Drive subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.purposedrive.social_relations", decayRate = 0.005, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
