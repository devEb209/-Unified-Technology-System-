-- ARKHER SYSTEM P.0294 :: Melee Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0294"
	S.key = "arkher.play.melee.rule_pipeline"
	S.name = "Melee Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Melee"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.melee.state_machine" }
	S.tags = { "p", "melee", "pipeline", "play" }
	S.description = "Melee Rule Pipeline: ordered rules applied to every gameplay event for the Melee subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.melee.rule_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
