-- ARKHER SYSTEM H.0417 :: Restitution Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0417"
	S.key = "arkher.physics.restitution.result_cache"
	S.name = "Restitution Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Restitution"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.restitution.simulation_policy" }
	S.tags = { "h", "restitution", "cache", "physics" }
	S.description = "Restitution Result Cache: reuse of expensive simulation and query results for the Restitution subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.restitution.result_cache", policy = "lru", capacity = 334, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
