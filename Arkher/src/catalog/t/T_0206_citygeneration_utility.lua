-- ARKHER SYSTEM T.0206 :: City Generation Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0206"
	S.key = "arkher.ai.citygeneration.utility_selection"
	S.name = "City Generation Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.citygeneration.working_memory" }
	S.tags = { "t", "citygeneration", "utility", "ai" }
	S.description = "City Generation Utility Selection: scored choice between competing courses of action for the City Generation subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.citygeneration.utility_selection", momentum = 0.14 })
		inst.system = S
		inst.ctx = ctx
