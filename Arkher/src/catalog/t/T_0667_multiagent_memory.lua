-- ARKHER SYSTEM T.0667 :: Multi Agent Coordination Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0667"
	S.key = "arkher.ai.multiagent.working_memory"
	S.name = "Multi Agent Coordination Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.multiagent.outcome_prediction" }
	S.tags = { "t", "multiagent", "memory", "ai" }
	S.description = "Multi Agent Coordination Working Memory: decaying, consolidating recall of what the agent learned for the Multi Agent Coordination subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.multiagent.working_memory", capacity = 75, decayRate = 0.055, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
