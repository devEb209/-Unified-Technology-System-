-- ARKHER SYSTEM P.0260 :: Dialogue Choice Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0260"
	S.key = "arkher.play.dialoguechoice.balance_analysis"
	S.name = "Dialogue Choice Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.dialoguechoice.event_ledger" }
	S.tags = { "p", "dialoguechoice", "analyzer", "play" }
	S.description = "Dialogue Choice Balance Analysis: distribution, outlier and pacing analysis for the Dialogue Choice subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.dialoguechoice.balance_analysis", window = 139, buckets = 15, threshold = 2.10 })
		inst.system = S
		inst.ctx = ctx
