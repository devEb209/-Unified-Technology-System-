-- ARKHER SYSTEM K.0502 :: Patrol Route Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0502"
	S.key = "arkher.npc.patrolroute.daily_schedule"
	S.name = "Patrol Route Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.patrolroute.social_relations" }
	S.tags = { "k", "patrolroute", "schedule", "npc" }
	S.description = "Patrol Route Daily Schedule: hour-by-hour routine with priority interruptions for the Patrol Route subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.patrolroute.daily_schedule", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
