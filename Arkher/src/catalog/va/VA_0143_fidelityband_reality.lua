-- ARKHER SYSTEM VA.0143 :: Fidelity Band Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0143"
	S.key = "arkher.contworld.fidelityband.reality_continuum"
	S.name = "Fidelity Band Reality Continuum"
	S.category = "VA"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.fidelityband.simulation_fabric" }
	S.tags = { "va", "fidelityband", "reality", "contworld" }
	S.description = "Fidelity Band Reality Continuum: stacked reality layers of the continuum for the Fidelity Band subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.fidelityband.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
