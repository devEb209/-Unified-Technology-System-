-- ARKHER SYSTEM VA.0207 :: Biome Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0207"
	S.key = "arkher.contworld.biomecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.biomecont.epoch_clock" }
	S.tags = { "va", "biomecont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.biomecont.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
