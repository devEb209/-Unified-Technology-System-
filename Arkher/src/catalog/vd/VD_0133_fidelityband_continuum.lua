-- ARKHER SYSTEM VD.0133 :: Fidelity Band Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0133"
	S.key = "arkher.contsim.fidelityband.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "fidelityband", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.fidelityband.infinite_grid", cellSize = 224, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
