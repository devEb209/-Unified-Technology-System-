-- ARKHER SYSTEM VC.0090 :: Residency Window Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0090"
	S.key = "arkher.contneural.residencywindow.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.residencywindow.persistent_state" }
	S.tags = { "vc", "residencywindow", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.residencywindow.coherence_guard", window = 119, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
