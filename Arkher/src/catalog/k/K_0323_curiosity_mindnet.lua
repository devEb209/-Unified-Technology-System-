-- ARKHER SYSTEM K.0323 :: Curiosity Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0323"
	S.key = "arkher.npc.curiosity.mind_network"
	S.name = "Curiosity Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "curiosity", "mindnet", "npc" }
	S.description = "Curiosity Mind Network: the learned policy that turns perception into a decision for the Curiosity subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.curiosity.mind_network", inputs = 6, hidden = 4, seed = 6040, learningRate = 0.050, exploration = 0.020 })
		inst.system = S
		inst.ctx = ctx
