-- ARKHER SYSTEM O.0208 :: Occlusion Zone Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0208"
	S.key = "arkher.audio.occlusionzone.music_sequencer"
	S.name = "Occlusion Zone Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.occlusionzone.spatialization" }
	S.tags = { "o", "occlusionzone", "sequencer", "audio" }
	S.description = "Occlusion Zone Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Occlusion Zone subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.occlusionzone.music_sequencer", bpm = 110, beatsPerBar = 4, intensity = 0.56 })
		inst.system = S
		inst.ctx = ctx
