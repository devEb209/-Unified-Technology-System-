-- ARKHER SYSTEM O.0344 :: Animal Audio Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0344"
	S.key = "arkher.audio.animalaudio.compression_codec"
	S.name = "Animal Audio Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Animal Audio"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.animalaudio.asset_registry" }
	S.tags = { "o", "animalaudio", "codec", "audio" }
	S.description = "Animal Audio Compression Codec: payload encoding of audio state and events for the Animal Audio subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.animalaudio.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
