-- ARKHER SYSTEM G.0211 :: Reflection Prediction Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0211"
	S.key = "arkher.neural.reflectpredict.inference_core"
	S.name = "Reflection Prediction Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "reflectpredict", "inference", "neural" }
	S.description = "Reflection Prediction Inference Core: dense network forward pass and training for the Reflection Prediction subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.reflectpredict.inference_core", seed = 51863 })
		inst.system = S
		inst.ctx = ctx
