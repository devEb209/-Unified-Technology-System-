-- ARKHER SYSTEM VB.0322 :: Ecology Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0322"
	S.key = "arkher.conttime.ecologycont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.ecologycont.complexity_budget" }
	S.tags = { "vb", "ecologycont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.ecologycont.simulation_fabric", budgetMs = 3.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
