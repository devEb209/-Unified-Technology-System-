-- ARKHER SYSTEM W.0202 :: Action Scene Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0202"
	S.key = "arkher.cine.actionscene.frame_budget"
	S.name = "Action Scene Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Action Scene"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.actionscene.event_ledger" }
	S.tags = { "w", "actionscene", "budgeter", "cine" }
	S.description = "Action Scene Frame Budget: per-frame cost budget for the cinematic systems for the Action Scene subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.actionscene.frame_budget", total = 284, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
