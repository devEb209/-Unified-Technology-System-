-- ARKHER SYSTEM VC.0226 :: Terrain Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0226"
	S.key = "arkher.contneural.terraincont.simulation_fabric"
	S.name = "Terrain Continuum Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.terraincont.complexity_budget" }
	S.tags = { "vc", "terraincont", "fabric", "contneural" }
	S.description = "Terrain Continuum Simulation Fabric: fabric stepping the continuum domains for the Terrain Continuum subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.terraincont.simulation_fabric", budgetMs = 3.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
