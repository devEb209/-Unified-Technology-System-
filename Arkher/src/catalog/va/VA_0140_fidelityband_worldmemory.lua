-- ARKHER SYSTEM VA.0140 :: Fidelity Band World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0140"
	S.key = "arkher.contworld.fidelityband.world_memory_stream"
	S.name = "Fidelity Band World Memory Stream"
	S.category = "VA"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.fidelityband.neural_field" }
	S.tags = { "va", "fidelityband", "worldmemory", "contworld" }
	S.description = "Fidelity Band World Memory Stream: world memory continuum over epochs for the Fidelity Band subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.fidelityband.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
