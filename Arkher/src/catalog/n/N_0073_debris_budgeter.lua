-- ARKHER SYSTEM N.0073 :: Debris Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0073"
	S.key = "arkher.vfx.debris.spawn_budget"
	S.name = "Debris Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Debris"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.debris.effect_composition" }
	S.tags = { "n", "debris", "budgeter", "vfx" }
	S.description = "Debris Spawn Budget: global particle budget shared by every live effect for the Debris subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.debris.spawn_budget", total = 340, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
