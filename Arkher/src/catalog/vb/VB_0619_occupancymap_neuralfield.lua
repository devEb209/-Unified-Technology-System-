-- ARKHER SYSTEM VB.0619 :: Occupancy Map Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0619"
	S.key = "arkher.conttime.occupancymap.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.occupancymap.coherence_guard" }
	S.tags = { "vb", "occupancymap", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.occupancymap.neural_field", dims = 20, hidden = 16, seed = 79302 })
		inst.system = S
		inst.ctx = ctx
