-- ARKHER SYSTEM N.0199 :: Cloud Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0199"
	S.key = "arkher.vfx.cloud.ribbon_and_trail"
	S.name = "Cloud Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloud"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.cloud.force_field" }
	S.tags = { "n", "cloud", "ribbon", "vfx" }
	S.description = "Cloud Ribbon And Trail: trail points, tapering, beams and decimation for the Cloud subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.cloud.ribbon_and_trail", maxPoints = 24, lifetime = 1.00, minDistance = 0.35, width = 0.30 })
		inst.system = S
		inst.ctx = ctx
