-- ARKHER SYSTEM E.0080 :: Normal Detail Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0080"
	S.key = "arkher.material.normaldetail.procedural_detail"
	S.name = "Normal Detail Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.normaldetail.texture_sampling" }
	S.tags = { "e", "normaldetail", "field", "material" }
	S.description = "Normal Detail Procedural Detail: coherent noise detail driving the surface for the Normal Detail subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.normaldetail.procedural_detail", seed = 36776, frequency = 0.0080, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
