-- ARKHER SYSTEM F.0562 :: UI Rendering View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0562"
	S.key = "arkher.render.uirender.view_and_culling"
	S.name = "UI Rendering View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "UI Rendering"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.uirender.frame_graph" }
	S.tags = { "f", "uirender", "camera", "render" }
	S.description = "UI Rendering View And Culling: view state, frustum culling and screen-size LOD for the UI Rendering subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.uirender.view_and_culling", width = 1084, height = 1080, fov = 1.1200, far = 1600 })
		inst.system = S
		inst.ctx = ctx
