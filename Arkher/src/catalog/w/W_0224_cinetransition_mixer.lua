-- ARKHER SYSTEM W.0224 :: Transition Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0224"
	S.key = "arkher.cine.cinetransition.cinematic_mix"
	S.name = "Transition Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Transition"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinetransition.motion_tween" }
	S.tags = { "w", "cinetransition", "mixer", "cine" }
	S.description = "Transition Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Transition subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.cinetransition.cinematic_mix", maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
