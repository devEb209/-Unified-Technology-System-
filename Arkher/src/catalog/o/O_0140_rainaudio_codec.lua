-- ARKHER SYSTEM O.0140 :: Rain Audio Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0140"
	S.key = "arkher.audio.rainaudio.compression_codec"
	S.name = "Rain Audio Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Rain Audio"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.rainaudio.asset_registry" }
	S.tags = { "o", "rainaudio", "codec", "audio" }
	S.description = "Rain Audio Compression Codec: payload encoding of audio state and events for the Rain Audio subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.rainaudio.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
