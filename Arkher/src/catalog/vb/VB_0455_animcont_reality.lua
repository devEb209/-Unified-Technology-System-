-- ARKHER SYSTEM VB.0455 :: Animation Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0455"
	S.key = "arkher.conttime.animcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.animcont.simulation_fabric" }
	S.tags = { "vb", "animcont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.animcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
