-- ARKHER SYSTEM VA.0433 :: Physics Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0433"
	S.key = "arkher.contworld.physicscont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "physicscont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.physicscont.infinite_grid", cellSize = 64, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
