-- ARKHER SYSTEM H.0410 :: Restitution Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0410"
	S.key = "arkher.physics.restitution.constraint_solver"
	S.name = "Restitution Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Restitution"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.restitution.contact_generation" }
	S.tags = { "h", "restitution", "constraint", "physics" }
	S.description = "Restitution Constraint Solver: sequential impulses, friction, joints and warm starting for the Restitution subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.restitution.constraint_solver", iterations = 7, baumgarte = 0.13, warmStart = true })
		inst.system = S
		inst.ctx = ctx
