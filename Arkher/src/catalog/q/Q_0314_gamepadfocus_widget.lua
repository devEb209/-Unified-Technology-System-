-- ARKHER SYSTEM Q.0314 :: Gamepad Focus Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0314"
	S.key = "arkher.ui.gamepadfocus.widget_tree"
	S.name = "Gamepad Focus Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.gamepadfocus.responsive_layout" }
	S.tags = { "q", "gamepadfocus", "widget", "ui" }
	S.description = "Gamepad Focus Widget Tree: retained widget nodes, properties, bindings and rendering for the Gamepad Focus subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.gamepadfocus.widget_tree", theme = "highcontrast", scale = 0.80 })
		inst.system = S
		inst.ctx = ctx
