--!strict
-- Nuke Nodal — ANIMATION Node_Flow #0301
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Nuke Nodal — ANIMATION Node_Flow #0301", size=Vector2.new(640, 440), pos=UDim2.fromOffset(413, 257), parent=parent, icon="✦"})
