-- ARKHER SYSTEM L.0483 :: Diplomacy Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0483"
	S.key = "arkher.sim.diplomacy.economy"
	S.name = "Diplomacy Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.diplomacy.ecology" }
	S.tags = { "l", "diplomacy", "economy", "sim" }
	S.description = "Diplomacy Economy: stock, production, demand, price discovery and trade for the Diplomacy subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.diplomacy.economy", elasticity = 0.31 })
		inst.system = S
		inst.ctx = ctx
