-- ARKHER SYSTEM VD.0285 :: Water Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0285"
	S.key = "arkher.contsim.watercont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.watercont.world_memory_stream" }
	S.tags = { "vd", "watercont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.watercont.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
