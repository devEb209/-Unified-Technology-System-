-- ARKHER SYSTEM VA.0182 :: Simulation Domain Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0182"
	S.key = "arkher.contworld.simdomain.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.simdomain.infinite_grid" }
	S.tags = { "va", "simdomain", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.simdomain.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
