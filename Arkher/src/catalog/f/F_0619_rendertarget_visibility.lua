-- ARKHER SYSTEM F.0619 :: Render Target Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0619"
	S.key = "arkher.render.rendertarget.visibility_set"
	S.name = "Render Target Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.rendertarget.view_and_culling" }
	S.tags = { "f", "rendertarget", "visibility", "render" }
	S.description = "Render Target Visibility Set: cell, portal and occluder visibility for the Render Target subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.rendertarget.visibility_set", maxDepth = 4 })
		inst.system = S
		inst.ctx = ctx
