-- ARKHER SYSTEM VD.0612 :: Seam Lattice Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0612"
	S.key = "arkher.contsim.seamlattice.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.seamlattice.reality_continuum" }
	S.tags = { "vd", "seamlattice", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.seamlattice.emergence_continuum", windowSize = 7, threshold = 1.40, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
