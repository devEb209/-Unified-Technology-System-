-- ARKHER SYSTEM V.0124 :: Font Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0124"
	S.key = "arkher.asset.font.asset_registry"
	S.name = "Font Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.font.cook_pipeline" }
	S.tags = { "v", "font", "registry", "asset" }
	S.description = "Font Asset Registry: catalogue of every asset, its tags and its metadata for the Font subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.font.asset_registry" })
		inst.system = S
		inst.ctx = ctx
