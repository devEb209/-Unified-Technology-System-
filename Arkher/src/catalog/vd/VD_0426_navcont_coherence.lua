-- ARKHER SYSTEM VD.0426 :: Navigation Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0426"
	S.key = "arkher.contsim.navcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.navcont.persistent_state" }
	S.tags = { "vd", "navcont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.navcont.coherence_guard", window = 67, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
