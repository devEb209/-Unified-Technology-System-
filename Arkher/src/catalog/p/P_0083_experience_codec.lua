-- ARKHER SYSTEM P.0083 :: Experience Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0083"
	S.key = "arkher.play.experience.save_codec"
	S.name = "Experience Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Experience"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.experience.content_registry" }
	S.tags = { "p", "experience", "codec", "play" }
	S.description = "Experience Save Codec: persistence, diffing and checksum of gameplay state for the Experience subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.experience.save_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
