-- ARKHER SYSTEM VA.0551 :: World Fabric Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0551"
	S.key = "arkher.contworld.worldfabric.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldfabric.simulation_fabric" }
	S.tags = { "va", "worldfabric", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.worldfabric.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
