-- ARKHER SYSTEM VD.0169 :: Neural Patch Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0169"
	S.key = "arkher.contsim.neuralpatch.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "neuralpatch", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.neuralpatch.infinite_grid", cellSize = 224, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
