-- ARKHER SYSTEM L.0213 :: Vegetation Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0213"
	S.key = "arkher.sim.vegetation.economy"
	S.name = "Vegetation Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.vegetation.ecology" }
	S.tags = { "l", "vegetation", "economy", "sim" }
	S.description = "Vegetation Economy: stock, production, demand, price discovery and trade for the Vegetation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.vegetation.economy", elasticity = 0.23 })
		inst.system = S
		inst.ctx = ctx
