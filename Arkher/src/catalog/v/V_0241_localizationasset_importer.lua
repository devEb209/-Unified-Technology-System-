-- ARKHER SYSTEM V.0241 :: Localization Asset Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0241"
	S.key = "arkher.asset.localizationasset.import"
	S.name = "Localization Asset Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "localizationasset", "importer", "asset" }
	S.description = "Localization Asset Import: validation, normalization, hashing and deduplication of incoming content for the Localization Asset subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.localizationasset.import", unitScale = 1.50 })
		inst.system = S
		inst.ctx = ctx
