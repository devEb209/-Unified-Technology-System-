-- ARKHER SYSTEM Z.0056 :: Singularity World Architect Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0056"
	S.key = "arkher.origin.worldarchitect.governance_policy"
	S.name = "Singularity World Architect Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.signal_composition" }
	S.tags = { "z", "worldarchitect", "policy", "origin" }
	S.description = "Singularity World Architect Governance Policy: ordered rules governing when the technology may act for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.worldarchitect.governance_policy", algorithm = "roundrobin", starvationGuard = 44 })
		inst.system = S
		inst.ctx = ctx
