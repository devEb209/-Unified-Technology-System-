-- ARKHER SYSTEM Z.0884 :: Sparse World Representation Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0884"
	S.key = "arkher.origin.sparseworld.autonomous_pipeline"
	S.name = "Sparse World Representation Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.simulation_fabric" }
	S.tags = { "z", "sparseworld", "autopipeline", "origin" }
	S.description = "Sparse World Representation Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.sparseworld.autonomous_pipeline", maxIterations = 11 })
		inst.system = S
		inst.ctx = ctx
