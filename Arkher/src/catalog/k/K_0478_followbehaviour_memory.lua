-- ARKHER SYSTEM K.0478 :: Follow Behaviour Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0478"
	S.key = "arkher.npc.followbehaviour.memory"
	S.name = "Follow Behaviour Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.followbehaviour.mind_network" }
	S.tags = { "k", "followbehaviour", "memory", "npc" }
	S.description = "Follow Behaviour Memory: episodic memory with decay, recall and consolidation for the Follow Behaviour subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.followbehaviour.memory", capacity = 101, decayRate = 0.045, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
