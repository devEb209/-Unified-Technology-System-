-- ARKHER SYSTEM W.0058 :: Close Up Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0058"
	S.key = "arkher.cine.closeup.frame_budget"
	S.name = "Close Up Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Close Up"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.closeup.event_ledger" }
	S.tags = { "w", "closeup", "budgeter", "cine" }
	S.description = "Close Up Frame Budget: per-frame cost budget for the cinematic systems for the Close Up subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.closeup.frame_budget", total = 421, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
