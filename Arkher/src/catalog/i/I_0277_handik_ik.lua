-- ARKHER SYSTEM I.0277 :: Hand Placement IK Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0277"
	S.key = "arkher.anim.handik.inverse_kinematics"
	S.name = "Hand Placement IK Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.handik.layered_blending" }
	S.tags = { "i", "handik", "ik", "anim" }
	S.description = "Hand Placement IK Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Hand Placement IK subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.handik.inverse_kinematics", iterations = 13, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
