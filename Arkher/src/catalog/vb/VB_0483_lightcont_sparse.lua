-- ARKHER SYSTEM VB.0483 :: Lighting Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0483"
	S.key = "arkher.conttime.lightcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lightcont.epoch_clock" }
	S.tags = { "vb", "lightcont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.lightcont.sparse_residency", capacity = 256, pageBytes = 3072 })
		inst.system = S
		inst.ctx = ctx
