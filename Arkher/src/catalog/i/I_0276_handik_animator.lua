-- ARKHER SYSTEM I.0276 :: Hand Placement IK Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0276"
	S.key = "arkher.anim.handik.layered_blending"
	S.name = "Hand Placement IK Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.handik.clip_sampling" }
	S.tags = { "i", "handik", "animator", "anim" }
	S.description = "Hand Placement IK Layered Blending: layers, crossfades, masks and blend trees for the Hand Placement IK subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.handik.layered_blending", budget = 6 })
		inst.system = S
		inst.ctx = ctx
