-- ARKHER SYSTEM H.0653 :: Wheel Suspension Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0653"
	S.key = "arkher.physics.suspension.budget_governor"
	S.name = "Wheel Suspension Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.suspension.broadphase_index" }
	S.tags = { "h", "suspension", "budgeter", "physics" }
	S.description = "Wheel Suspension Budget Governor: simulation time budget allocation across islands for the Wheel Suspension subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.suspension.budget_governor", total = 176, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
