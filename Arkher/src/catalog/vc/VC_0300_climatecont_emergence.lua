-- ARKHER SYSTEM VC.0300 :: Climate Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0300"
	S.key = "arkher.contneural.climatecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.climatecont.reality_continuum" }
	S.tags = { "vc", "climatecont", "emergence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.climatecont.emergence_continuum", windowSize = 4, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
