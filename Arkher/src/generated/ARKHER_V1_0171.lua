--!strict
-- Rokoko — ANIMATION Node_Flow #0171
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Rokoko — ANIMATION Node_Flow #0171", size=Vector2.new(600, 440), pos=UDim2.fromOffset(323, 127), parent=parent, icon="♪"})
