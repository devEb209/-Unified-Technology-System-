-- ARKHER SYSTEM H.0567 :: Soft Body Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0567"
	S.key = "arkher.physics.softbody.vehicle"
	S.name = "Soft Body Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Soft Body"
	S.aspect = "Vehicle"
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.softbody.character_motion" }
	S.tags = { "h", "softbody", "vehicle", "physics" }
	S.description = "Soft Body Vehicle: suspension, drivetrain, steering and tire friction for the Soft Body subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.softbody.vehicle", mass = 2100, wheelbase = 3.00, track = 1.80, maxRpm = 6400 })
		inst.system = S
		inst.ctx = ctx
