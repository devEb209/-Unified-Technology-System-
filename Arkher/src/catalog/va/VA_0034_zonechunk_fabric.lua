-- ARKHER SYSTEM VA.0034 :: Zone Chunk Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0034"
	S.key = "arkher.contworld.zonechunk.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.zonechunk.complexity_budget" }
	S.tags = { "va", "zonechunk", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.zonechunk.simulation_fabric", budgetMs = 2.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
