-- ARKHER SYSTEM V.0158 :: Particle Asset Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0158"
	S.key = "arkher.asset.particleasset.bundling"
	S.name = "Particle Asset Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.particleasset.import" }
	S.tags = { "v", "particleasset", "bundler", "asset" }
	S.description = "Particle Asset Bundling: size-bounded packing, manifests and delta patches for the Particle Asset subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.particleasset.bundling", maxBundleBytes = 917504 })
		inst.system = S
		inst.ctx = ctx
