-- ARKHER SYSTEM F.0552 :: Particle Rendering Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0552"
	S.key = "arkher.render.particlerender.probe_volume"
	S.name = "Particle Rendering Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.particlerender.lighting_rig" }
	S.tags = { "f", "particlerender", "probe", "render" }
	S.description = "Particle Rendering Probe Volume: irradiance probes encoded in spherical harmonics for the Particle Rendering subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.particlerender.probe_volume", spacing = 24 })
		inst.system = S
		inst.ctx = ctx
