-- ARKHER SYSTEM N.0380 :: Decal Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0380"
	S.key = "arkher.vfx.decal.force_field"
	S.name = "Decal Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Decal"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.decal.particle_simulation" }
	S.tags = { "n", "decal", "forcefield", "vfx" }
	S.description = "Decal Force Field: wind, attraction, vortex, drag and curl turbulence for the Decal subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.decal.force_field", seed = 42473 })
		inst.system = S
		inst.ctx = ctx
