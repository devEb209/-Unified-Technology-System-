-- ARKHER SYSTEM G.0214 :: Reflection Prediction Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0214"
	S.key = "arkher.neural.reflectpredict.reconstruction"
	S.name = "Reflection Prediction Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.reflectpredict.temporal_history" }
	S.tags = { "g", "reflectpredict", "upscaler", "neural" }
	S.description = "Reflection Prediction Reconstruction: resolution ladder and image reconstruction for the Reflection Prediction subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.reflectpredict.reconstruction", targetMs = 14.10, index = 3, sharpness = 0.27 })
		inst.system = S
		inst.ctx = ctx
