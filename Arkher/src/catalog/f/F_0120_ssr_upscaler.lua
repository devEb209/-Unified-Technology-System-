-- ARKHER SYSTEM F.0120 :: Screen Space Reflection Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0120"
	S.key = "arkher.render.ssr.adaptive_resolution"
	S.name = "Screen Space Reflection Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.ssr.temporal_resolve" }
	S.tags = { "f", "ssr", "upscaler", "render" }
	S.description = "Screen Space Reflection Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Screen Space Reflection subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.ssr.adaptive_resolution", targetMs = 13.10, index = 5, sharpness = 0.38 })
		inst.system = S
		inst.ctx = ctx
