-- ARKHER SYSTEM K.0152 :: Rest Drive Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0152"
	S.key = "arkher.npc.restdrive.daily_schedule"
	S.name = "Rest Drive Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.restdrive.social_relations" }
	S.tags = { "k", "restdrive", "schedule", "npc" }
	S.description = "Rest Drive Daily Schedule: hour-by-hour routine with priority interruptions for the Rest Drive subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.restdrive.daily_schedule", startHour = 6 })
		inst.system = S
		inst.ctx = ctx
