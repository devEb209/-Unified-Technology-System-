-- ARKHER SYSTEM VA.0201 :: Architect District Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0201"
	S.key = "arkher.contworld.architectdistrict.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.architectdistrict.world_memory_stream" }
	S.tags = { "va", "architectdistrict", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.architectdistrict.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
