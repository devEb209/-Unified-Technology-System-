-- ARKHER SYSTEM F.0216 :: Cloud Rendering Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0216"
	S.key = "arkher.render.clouds.probe_volume"
	S.name = "Cloud Rendering Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.clouds.lighting_rig" }
	S.tags = { "f", "clouds", "probe", "render" }
	S.description = "Cloud Rendering Probe Volume: irradiance probes encoded in spherical harmonics for the Cloud Rendering subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.clouds.probe_volume", spacing = 32 })
		inst.system = S
		inst.ctx = ctx
