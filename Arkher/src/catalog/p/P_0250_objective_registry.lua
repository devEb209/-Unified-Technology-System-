-- ARKHER SYSTEM P.0250 :: Objective Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0250"
	S.key = "arkher.play.objective.content_registry"
	S.name = "Objective Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Objective"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.objective.difficulty_controller" }
	S.tags = { "p", "objective", "registry", "play" }
	S.description = "Objective Content Registry: catalogue of the definitions this loop instantiates for the Objective subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.objective.content_registry" })
		inst.system = S
		inst.ctx = ctx
