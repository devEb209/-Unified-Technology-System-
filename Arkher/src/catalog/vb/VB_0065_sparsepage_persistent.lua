-- ARKHER SYSTEM VB.0065 :: Sparse Page Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0065"
	S.key = "arkher.conttime.sparsepage.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.sparsepage.multi-scale_fidelity" }
	S.tags = { "vb", "sparsepage", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.sparsepage.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
