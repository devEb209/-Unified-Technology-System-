-- ARKHER SYSTEM R.0311 :: Cross Server Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0311"
	S.key = "arkher.net.crossserver.latency_analysis"
	S.name = "Cross Server Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Cross Server"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.crossserver.audit_ledger" }
	S.tags = { "r", "crossserver", "analyzer", "net" }
	S.description = "Cross Server Latency Analysis: round trip, jitter and loss analysis for the Cross Server subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.crossserver.latency_analysis", window = 123, buckets = 11, threshold = 3.50 })
		inst.system = S
		inst.ctx = ctx
