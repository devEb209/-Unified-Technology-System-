-- ARKHER SYSTEM T.0233 :: Quest Generation Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0233"
	S.key = "arkher.ai.questgeneration.working_memory"
	S.name = "Quest Generation Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.questgeneration.outcome_prediction" }
	S.tags = { "t", "questgeneration", "memory", "ai" }
	S.description = "Quest Generation Working Memory: decaying, consolidating recall of what the agent learned for the Quest Generation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.questgeneration.working_memory", capacity = 92, decayRate = 0.060, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
