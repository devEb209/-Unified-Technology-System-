-- ARKHER SYSTEM F.0228 :: Water Rendering Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0228"
	S.key = "arkher.render.water.geometry_virtualization"
	S.name = "Water Rendering Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.water.visibility_set" }
	S.tags = { "f", "water", "impostor", "render" }
	S.description = "Water Rendering Geometry Virtualization: impostor and HLOD synthesis under a budget for the Water Rendering subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.water.geometry_virtualization", atlasSlots = 80, viewCount = 8, errorThreshold = 1.90 })
		inst.system = S
		inst.ctx = ctx
