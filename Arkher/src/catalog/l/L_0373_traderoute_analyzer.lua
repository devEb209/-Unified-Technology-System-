-- ARKHER SYSTEM L.0373 :: Trade Route Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0373"
	S.key = "arkher.sim.traderoute.analysis"
	S.name = "Trade Route Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.traderoute.aggregate_cache" }
	S.tags = { "l", "traderoute", "analyzer", "sim" }
	S.description = "Trade Route Analysis: trend, anomaly and stability analysis of the world for the Trade Route subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.traderoute.analysis", window = 98, buckets = 18, threshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
