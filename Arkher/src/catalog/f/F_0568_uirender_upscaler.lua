-- ARKHER SYSTEM F.0568 :: UI Rendering Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0568"
	S.key = "arkher.render.uirender.adaptive_resolution"
	S.name = "UI Rendering Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "UI Rendering"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.uirender.temporal_resolve" }
	S.tags = { "f", "uirender", "upscaler", "render" }
	S.description = "UI Rendering Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the UI Rendering subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.uirender.adaptive_resolution", targetMs = 15.10, index = 4, sharpness = 0.30 })
		inst.system = S
		inst.ctx = ctx
