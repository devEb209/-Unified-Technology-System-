-- ARKHER SYSTEM H.0032 :: Kinematic Body Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0032"
	S.key = "arkher.physics.kinematicbody.constraint_solver"
	S.name = "Kinematic Body Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.kinematicbody.contact_generation" }
	S.tags = { "h", "kinematicbody", "constraint", "physics" }
	S.description = "Kinematic Body Constraint Solver: sequential impulses, friction, joints and warm starting for the Kinematic Body subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.kinematicbody.constraint_solver", iterations = 9, baumgarte = 0.25, warmStart = true })
		inst.system = S
		inst.ctx = ctx
