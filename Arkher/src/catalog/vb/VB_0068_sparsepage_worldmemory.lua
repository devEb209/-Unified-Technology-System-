-- ARKHER SYSTEM VB.0068 :: Sparse Page World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0068"
	S.key = "arkher.conttime.sparsepage.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.sparsepage.neural_field" }
	S.tags = { "vb", "sparsepage", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.sparsepage.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
