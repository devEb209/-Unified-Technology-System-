-- ARKHER SYSTEM N.0486 :: Glow Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0486"
	S.key = "arkher.vfx.glow.curve_authoring"
	S.name = "Glow Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Glow"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.glow.ribbon_and_trail" }
	S.tags = { "n", "glow", "spline", "vfx" }
	S.description = "Glow Curve Authoring: authored curves driving the effect over its life for the Glow subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.glow.curve_authoring", tension = 0.40, closed = false })
		inst.system = S
		inst.ctx = ctx
