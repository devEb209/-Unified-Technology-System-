-- ARKHER SYSTEM V.0397 :: Thumbnail Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0397"
	S.key = "arkher.asset.thumbnail.import"
	S.name = "Thumbnail Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "thumbnail", "importer", "asset" }
	S.description = "Thumbnail Import: validation, normalization, hashing and deduplication of incoming content for the Thumbnail subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.thumbnail.import", unitScale = 1.25 })
		inst.system = S
		inst.ctx = ctx
