-- ARKHER SYSTEM I.0186 :: Blend Tree Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0186"
	S.key = "arkher.anim.blendtree.inverse_kinematics"
	S.name = "Blend Tree Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Blend Tree"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.blendtree.layered_blending" }
	S.tags = { "i", "blendtree", "ik", "anim" }
	S.description = "Blend Tree Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Blend Tree subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.blendtree.inverse_kinematics", iterations = 15, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
