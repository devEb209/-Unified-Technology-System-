-- ARKHER SYSTEM G.0204 :: Ambient Occlusion Prediction Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0204"
	S.key = "arkher.neural.aopredict.compute_budget"
	S.name = "Ambient Occlusion Prediction Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.aopredict.quality_predictor" }
	S.tags = { "g", "aopredict", "budgeter", "neural" }
	S.description = "Ambient Occlusion Prediction Compute Budget: inference time budget allocation for the Ambient Occlusion Prediction subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.aopredict.compute_budget", total = 452, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
