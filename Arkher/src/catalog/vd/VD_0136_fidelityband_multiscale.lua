-- ARKHER SYSTEM VD.0136 :: Fidelity Band Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0136"
	S.key = "arkher.contsim.fidelityband.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.fidelityband.sparse_residency" }
	S.tags = { "vd", "fidelityband", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.fidelityband.multi-scale_fidelity", levels = 5, baseTriangles = 150000 })
		inst.system = S
		inst.ctx = ctx
