-- ARKHER SYSTEM Q.0171 :: Head Up Display Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0171"
	S.key = "arkher.ui.hud.input_mapping"
	S.name = "Head Up Display Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.hud.widget_tree" }
	S.tags = { "q", "hud", "inputmap", "ui" }
	S.description = "Head Up Display Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Head Up Display subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.hud.input_mapping", device = "gamepad", holdTime = 0.40, deadzone = 0.20 })
		inst.system = S
		inst.ctx = ctx
