-- ARKHER SYSTEM F.0335 :: Motion Blur Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0335"
	S.key = "arkher.render.motionblur.orchestration"
	S.name = "Motion Blur Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Motion Blur"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.motionblur.frame_analysis" }
	S.tags = { "f", "motionblur", "orchestrator", "render" }
	S.description = "Motion Blur Orchestration: frame lifecycle orchestration for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.motionblur.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
