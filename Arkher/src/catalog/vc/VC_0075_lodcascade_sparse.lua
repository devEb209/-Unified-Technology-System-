-- ARKHER SYSTEM VC.0075 :: LOD Cascade Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0075"
	S.key = "arkher.contneural.lodcascade.sparse_residency"
	S.name = "LOD Cascade Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lodcascade.epoch_clock" }
	S.tags = { "vc", "lodcascade", "sparse", "contneural" }
	S.description = "LOD Cascade Sparse Residency: sparse page residency with eviction and compression for the LOD Cascade subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.lodcascade.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
