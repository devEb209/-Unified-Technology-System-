-- ARKHER SYSTEM T.0541 :: Animation Reasoning Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0541"
	S.key = "arkher.ai.animationreasoning.working_memory"
	S.name = "Animation Reasoning Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.animationreasoning.outcome_prediction" }
	S.tags = { "t", "animationreasoning", "memory", "ai" }
	S.description = "Animation Reasoning Working Memory: decaying, consolidating recall of what the agent learned for the Animation Reasoning subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.animationreasoning.working_memory", capacity = 78, decayRate = 0.060, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
