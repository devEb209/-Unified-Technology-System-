-- ARKHER SYSTEM K.0133 :: Hunger Drive Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0133"
	S.key = "arkher.npc.hungerdrive.utility_reasoning"
	S.name = "Hunger Drive Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hungerdrive.reactive_behaviour" }
	S.tags = { "k", "hungerdrive", "utility", "npc" }
	S.description = "Hunger Drive Utility Reasoning: scored option selection with response curves for the Hunger Drive subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.hungerdrive.utility_reasoning", momentum = 0.01 })
		inst.system = S
		inst.ctx = ctx
