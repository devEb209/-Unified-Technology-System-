-- ARKHER SYSTEM P.0398 :: Match Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0398"
	S.key = "arkher.play.match.inventory"
	S.name = "Match Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Match"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.match.attributes" }
	S.tags = { "p", "match", "inventory", "play" }
	S.description = "Match Inventory: slots, stacking, weight, equipment and crafting for the Match subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.match.inventory", slots = 12, maxWeight = 120 })
		inst.system = S
		inst.ctx = ctx
