-- ARKHER SYSTEM VD.0452 :: Animation Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0452"
	S.key = "arkher.contsim.animcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.animcont.neural_field" }
	S.tags = { "vd", "animcont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.animcont.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
