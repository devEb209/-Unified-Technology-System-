-- ARKHER SYSTEM K.0202 :: Emotional State Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0202"
	S.key = "arkher.npc.emotionalstate.reactive_behaviour"
	S.name = "Emotional State Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.emotionalstate.perception" }
	S.tags = { "k", "emotionalstate", "behaviortree", "npc" }
	S.description = "Emotional State Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Emotional State subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.emotionalstate.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
