-- ARKHER SYSTEM L.0168 :: Livestock Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0168"
	S.key = "arkher.sim.livestock.economy"
	S.name = "Livestock Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livestock.ecology" }
	S.tags = { "l", "livestock", "economy", "sim" }
	S.description = "Livestock Economy: stock, production, demand, price discovery and trade for the Livestock subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.livestock.economy", elasticity = 0.35 })
		inst.system = S
		inst.ctx = ctx
