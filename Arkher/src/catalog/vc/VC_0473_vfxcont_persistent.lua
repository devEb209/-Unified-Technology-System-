-- ARKHER SYSTEM VC.0473 :: VFX Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0473"
	S.key = "arkher.contneural.vfxcont.persistent_state"
	S.name = "VFX Continuum Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vfxcont.multi-scale_fidelity" }
	S.tags = { "vc", "vfxcont", "persistent", "contneural" }
	S.description = "VFX Continuum Persistent State: epoch-stamped persistent history and rollback for the VFX Continuum subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.vfxcont.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
