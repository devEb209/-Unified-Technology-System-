-- ARKHER SYSTEM E.0363 :: Vertex Painting Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0363"
	S.key = "arkher.material.vertexpaint.shading_graph"
	S.name = "Vertex Painting Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.vertexpaint.layer_composition" }
	S.tags = { "e", "vertexpaint", "shadegraph", "material" }
	S.description = "Vertex Painting Shading Graph: node graph evaluated and compiled to Luau for the Vertex Painting subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.vertexpaint.shading_graph" })
		inst.system = S
		inst.ctx = ctx
