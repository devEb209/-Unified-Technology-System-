-- ARKHER SYSTEM E.0162 :: Subsurface Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0162"
	S.key = "arkher.material.subsurface.analysis"
	S.name = "Subsurface Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Subsurface"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.subsurface.instance_cache" }
	S.tags = { "e", "subsurface", "analyzer", "material" }
	S.description = "Subsurface Analysis: cost, redundancy and outlier analysis for the Subsurface subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.subsurface.analysis", window = 156, buckets = 8, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
