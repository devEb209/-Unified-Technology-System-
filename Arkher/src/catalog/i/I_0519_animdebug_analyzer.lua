-- ARKHER SYSTEM I.0519 :: Animation Debug Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0519"
	S.key = "arkher.anim.animdebug.analysis"
	S.name = "Animation Debug Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animdebug.quality_policy" }
	S.tags = { "i", "animdebug", "analyzer", "anim" }
	S.description = "Animation Debug Analysis: pop, drift and cost analysis of playback for the Animation Debug subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.animdebug.analysis", window = 149, buckets = 13, threshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
