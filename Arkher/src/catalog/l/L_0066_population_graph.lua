-- ARKHER SYSTEM L.0066 :: Population Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0066"
	S.key = "arkher.sim.population.region_graph"
	S.name = "Population Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.population.calendar" }
	S.tags = { "l", "population", "graph", "sim" }
	S.description = "Population Region Graph: connectivity, components and shortest path between places for the Population subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.population.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
