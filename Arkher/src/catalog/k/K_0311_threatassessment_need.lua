-- ARKHER SYSTEM K.0311 :: Threat Assessment Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0311"
	S.key = "arkher.npc.threatassessment.drive_system"
	S.name = "Threat Assessment Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.threatassessment.memory" }
	S.tags = { "k", "threatassessment", "need", "npc" }
	S.description = "Threat Assessment Drive System: drives that decay, turn urgent and get satisfied for the Threat Assessment subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.threatassessment.drive_system" })
		inst.system = S
		inst.ctx = ctx
