-- ARKHER SYSTEM VD.0177 :: Neural Patch Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0177"
	S.key = "arkher.contsim.neuralpatch.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.neuralpatch.world_memory_stream" }
	S.tags = { "vd", "neuralpatch", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.neuralpatch.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
