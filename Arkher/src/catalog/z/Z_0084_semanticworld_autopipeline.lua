-- ARKHER SYSTEM Z.0084 :: Semantic World Graph Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0084"
	S.key = "arkher.origin.semanticworld.autonomous_pipeline"
	S.name = "Semantic World Graph Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticworld.simulation_fabric" }
	S.tags = { "z", "semanticworld", "autopipeline", "origin" }
	S.description = "Semantic World Graph Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.semanticworld.autonomous_pipeline", maxIterations = 4 })
		inst.system = S
		inst.ctx = ctx
