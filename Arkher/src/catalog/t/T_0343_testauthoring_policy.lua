-- ARKHER SYSTEM T.0343 :: Test Authoring Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0343"
	S.key = "arkher.ai.testauthoring.decision_policy"
	S.name = "Test Authoring Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.testauthoring.reasoning_graph" }
	S.tags = { "t", "testauthoring", "policy", "ai" }
	S.description = "Test Authoring Decision Policy: ordered rules deciding what the agent does next for the Test Authoring subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.testauthoring.decision_policy", algorithm = "roundrobin", starvationGuard = 40 })
		inst.system = S
		inst.ctx = ctx
