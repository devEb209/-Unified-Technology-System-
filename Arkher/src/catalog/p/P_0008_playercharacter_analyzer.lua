-- ARKHER SYSTEM P.0008 :: Player Character Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0008"
	S.key = "arkher.play.playercharacter.balance_analysis"
	S.name = "Player Character Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playercharacter.event_ledger" }
	S.tags = { "p", "playercharacter", "analyzer", "play" }
	S.description = "Player Character Balance Analysis: distribution, outlier and pacing analysis for the Player Character subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.playercharacter.balance_analysis", window = 136, buckets = 16, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
