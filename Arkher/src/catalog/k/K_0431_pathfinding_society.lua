-- ARKHER SYSTEM K.0431 :: Pathfinding Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0431"
	S.key = "arkher.npc.pathfinding.social_relations"
	S.name = "Pathfinding Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.pathfinding.crowd_steering" }
	S.tags = { "k", "pathfinding", "society", "npc" }
	S.description = "Pathfinding Social Relations: affinity, factions, reputation and gossip for the Pathfinding subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.pathfinding.social_relations", decayRate = 0.005, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
