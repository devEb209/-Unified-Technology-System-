-- ARKHER SYSTEM F.0583 :: Debug Visualization Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0583"
	S.key = "arkher.render.debugvis.draw_budget"
	S.name = "Debug Visualization Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.debugvis.adaptive_resolution" }
	S.tags = { "f", "debugvis", "budgeter", "render" }
	S.description = "Debug Visualization Draw Budget: draw call and triangle budget allocation for the Debug Visualization subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.debugvis.draw_budget", total = 100, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
