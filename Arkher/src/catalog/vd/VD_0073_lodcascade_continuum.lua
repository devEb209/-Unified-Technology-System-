-- ARKHER SYSTEM VD.0073 :: LOD Cascade Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0073"
	S.key = "arkher.contsim.lodcascade.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "lodcascade", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.lodcascade.infinite_grid", cellSize = 64, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
