-- ARKHER SYSTEM F.0565 :: UI Rendering Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0565"
	S.key = "arkher.render.uirender.lighting_rig"
	S.name = "UI Rendering Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "UI Rendering"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.uirender.geometry_virtualization" }
	S.tags = { "f", "uirender", "lightrig", "render" }
	S.description = "UI Rendering Lighting Rig: light clustering, importance and cascades for the UI Rendering subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.uirender.lighting_rig", maxActive = 10 })
		inst.system = S
		inst.ctx = ctx
