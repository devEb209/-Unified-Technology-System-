-- ARKHER SYSTEM VB.0290 :: Climate Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0290"
	S.key = "arkher.conttime.climatecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.climatecont.infinite_grid" }
	S.tags = { "vb", "climatecont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.climatecont.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
