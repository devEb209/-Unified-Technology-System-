-- ARKHER SYSTEM K.0240 :: Temperament Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0240"
	S.key = "arkher.npc.temperament.memory"
	S.name = "Temperament Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.temperament.mind_network" }
	S.tags = { "k", "temperament", "memory", "npc" }
	S.description = "Temperament Memory: episodic memory with decay, recall and consolidation for the Temperament subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.temperament.memory", capacity = 55, decayRate = 0.035, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
