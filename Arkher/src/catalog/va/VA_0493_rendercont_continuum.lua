-- ARKHER SYSTEM VA.0493 :: Rendering Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0493"
	S.key = "arkher.contworld.rendercont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "rendercont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.rendercont.infinite_grid", cellSize = 224, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
