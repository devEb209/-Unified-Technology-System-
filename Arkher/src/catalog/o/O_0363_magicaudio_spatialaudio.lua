-- ARKHER SYSTEM O.0363 :: Magic Audio Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0363"
	S.key = "arkher.audio.magicaudio.spatialization"
	S.name = "Magic Audio Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Magic Audio"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.magicaudio.mixer_bus" }
	S.tags = { "o", "magicaudio", "spatialaudio", "audio" }
	S.description = "Magic Audio Spatialization: distance attenuation, panning, occlusion and doppler for the Magic Audio subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.magicaudio.spatialization", model = "exponential", refDistance = 8, maxDistance = 220, rolloff = 1.07, maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
