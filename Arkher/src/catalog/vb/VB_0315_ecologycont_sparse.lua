-- ARKHER SYSTEM VB.0315 :: Ecology Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0315"
	S.key = "arkher.conttime.ecologycont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.ecologycont.epoch_clock" }
	S.tags = { "vb", "ecologycont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.ecologycont.sparse_residency", capacity = 256, pageBytes = 3072 })
		inst.system = S
		inst.ctx = ctx
