-- ARKHER SYSTEM VD.0005 :: World Grid Cell Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0005"
	S.key = "arkher.contsim.worldcell.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldcell.multi-scale_fidelity" }
	S.tags = { "vd", "worldcell", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.worldcell.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
