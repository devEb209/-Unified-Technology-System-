-- ARKHER SYSTEM VC.0271 :: Bridge Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0271"
	S.key = "arkher.contneural.bridgecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.bridgecont.coherence_guard" }
	S.tags = { "vc", "bridgecont", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.bridgecont.neural_field", dims = 12, hidden = 8, seed = 13976 })
		inst.system = S
		inst.ctx = ctx
