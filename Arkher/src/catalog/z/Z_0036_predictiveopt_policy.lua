-- ARKHER SYSTEM Z.0036 :: Predictive Optimization Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0036"
	S.key = "arkher.origin.predictiveopt.governance_policy"
	S.name = "Predictive Optimization Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.signal_composition" }
	S.tags = { "z", "predictiveopt", "policy", "origin" }
	S.description = "Predictive Optimization Governance Policy: ordered rules governing when the technology may act for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.predictiveopt.governance_policy", algorithm = "wfq", starvationGuard = 18 })
		inst.system = S
		inst.ctx = ctx
