-- ARKHER SYSTEM E.0589 :: Material Migration Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0589"
	S.key = "arkher.material.migration.texture_sampling"
	S.name = "Material Migration Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.migration.shading_graph" }
	S.tags = { "e", "migration", "sampler", "material" }
	S.description = "Material Migration Texture Sampling: atlas packing, mip chain and filtered sampling for the Material Migration subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.migration.texture_sampling", atlasSize = 256, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
