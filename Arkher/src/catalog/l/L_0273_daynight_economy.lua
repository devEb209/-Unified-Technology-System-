-- ARKHER SYSTEM L.0273 :: Day Night Cycle Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0273"
	S.key = "arkher.sim.daynight.economy"
	S.name = "Day Night Cycle Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.daynight.ecology" }
	S.tags = { "l", "daynight", "economy", "sim" }
	S.description = "Day Night Cycle Economy: stock, production, demand, price discovery and trade for the Day Night Cycle subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.daynight.economy", elasticity = 0.29 })
		inst.system = S
		inst.ctx = ctx
