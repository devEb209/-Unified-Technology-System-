-- ARKHER SYSTEM R.0296 :: Server Authority Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0296"
	S.key = "arkher.net.serverauthority.rate_guard"
	S.name = "Server Authority Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverauthority.interest_streaming" }
	S.tags = { "r", "serverauthority", "guard", "net" }
	S.description = "Server Authority Rate Guard: token-bucket protection against floods and abuse for the Server Authority subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.serverauthority.rate_guard", algorithm = "token", capacity = 122, refillPerSec = 47, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
