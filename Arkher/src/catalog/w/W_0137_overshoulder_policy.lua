-- ARKHER SYSTEM W.0137 :: Over The Shoulder Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0137"
	S.key = "arkher.cine.overshoulder.cut_policy"
	S.name = "Over The Shoulder Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.overshoulder.shot_composition" }
	S.tags = { "w", "overshoulder", "policy", "cine" }
	S.description = "Over The Shoulder Cut Policy: rules deciding when the sequence cuts and to what for the Over The Shoulder subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.overshoulder.cut_policy", algorithm = "wfq", starvationGuard = 54 })
		inst.system = S
		inst.ctx = ctx
