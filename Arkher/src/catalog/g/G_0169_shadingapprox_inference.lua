-- ARKHER SYSTEM G.0169 :: Shading Approximation Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0169"
	S.key = "arkher.neural.shadingapprox.inference_core"
	S.name = "Shading Approximation Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "shadingapprox", "inference", "neural" }
	S.description = "Shading Approximation Inference Core: dense network forward pass and training for the Shading Approximation subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.shadingapprox.inference_core", seed = 66457 })
		inst.system = S
		inst.ctx = ctx
