-- ARKHER SYSTEM Q.0186 :: Health Bar Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0186"
	S.key = "arkher.ui.healthbar.theme_composition"
	S.name = "Health Bar Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Health Bar"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.healthbar.navigation_graph" }
	S.tags = { "q", "healthbar", "composer", "ui" }
	S.description = "Health Bar Theme Composition: blending of theme signals into the final appearance for the Health Bar subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.healthbar.theme_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
