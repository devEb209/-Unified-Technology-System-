-- ARKHER SYSTEM J.0138 :: Blinking Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0138"
	S.key = "arkher.character.blinking.locomotion"
	S.name = "Blinking Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.blinking.physical_response" }
	S.tags = { "j", "blinking", "charmotor", "character" }
	S.description = "Blinking Locomotion: capsule locomotion driving the character for the Blinking subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.blinking.locomotion", radius = 0.52, height = 1.97, maxSpeed = 7.70, jumpHeight = 1.30, stepOffset = 0.32 })
		inst.system = S
		inst.ctx = ctx
