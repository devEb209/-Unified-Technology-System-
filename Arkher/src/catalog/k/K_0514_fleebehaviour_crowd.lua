-- ARKHER SYSTEM K.0514 :: Flee Behaviour Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0514"
	S.key = "arkher.npc.fleebehaviour.crowd_steering"
	S.name = "Flee Behaviour Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.fleebehaviour.navigation" }
	S.tags = { "k", "fleebehaviour", "crowd", "npc" }
	S.description = "Flee Behaviour Crowd Steering: local avoidance, cohesion and arrival at scale for the Flee Behaviour subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.fleebehaviour.crowd_steering", radius = 0.60, maxSpeed = 4.40, cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
