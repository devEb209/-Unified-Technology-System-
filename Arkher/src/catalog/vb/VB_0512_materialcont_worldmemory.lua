-- ARKHER SYSTEM VB.0512 :: Material Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0512"
	S.key = "arkher.conttime.materialcont.world_memory_stream"
	S.name = "Material Continuum World Memory Stream"
	S.category = "VB"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.materialcont.neural_field" }
	S.tags = { "vb", "materialcont", "worldmemory", "conttime" }
	S.description = "Material Continuum World Memory Stream: world memory continuum over epochs for the Material Continuum subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.materialcont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
