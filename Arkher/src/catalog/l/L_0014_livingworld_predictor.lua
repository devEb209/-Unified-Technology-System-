-- ARKHER SYSTEM L.0014 :: Living World Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0014"
	S.key = "arkher.sim.livingworld.forecast"
	S.name = "Living World Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livingworld.analysis" }
	S.tags = { "l", "livingworld", "predictor", "sim" }
	S.description = "Living World Forecast: prediction of the region's next state for the Living World subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.livingworld.forecast", method = "ema", alpha = 0.49, window = 119 })
		inst.system = S
		inst.ctx = ctx
