-- ARKHER SYSTEM R.0209 :: Server Reconciliation Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0209"
	S.key = "arkher.net.serverreconciliation.bandwidth_budget"
	S.name = "Server Reconciliation Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverreconciliation.transport_graph" }
	S.tags = { "r", "serverreconciliation", "budgeter", "net" }
	S.description = "Server Reconciliation Bandwidth Budget: bytes per second shared between competing streams for the Server Reconciliation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.serverreconciliation.bandwidth_budget", total = 224, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
