-- ARKHER SYSTEM T.0580 :: Build Reasoning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0580"
	S.key = "arkher.ai.buildreasoning.reasoning_graph"
	S.name = "Build Reasoning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.buildreasoning.world_architect" }
	S.tags = { "t", "buildreasoning", "graph", "ai" }
	S.description = "Build Reasoning Reasoning Graph: relationship modelling and shortest-path reasoning for the Build Reasoning subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.buildreasoning.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
