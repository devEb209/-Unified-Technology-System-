-- ARKHER SYSTEM K.0664 :: Sleep Cycle Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0664"
	S.key = "arkher.npc.sleepcycle.reactive_behaviour"
	S.name = "Sleep Cycle Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.sleepcycle.perception" }
	S.tags = { "k", "sleepcycle", "behaviortree", "npc" }
	S.description = "Sleep Cycle Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Sleep Cycle subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.sleepcycle.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
