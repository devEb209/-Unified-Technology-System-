-- ARKHER SYSTEM Z.1009 :: Capability Discovery Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.1009"
	S.key = "arkher.origin.capabilitydiscovery.intent_bridge"
	S.name = "Capability Discovery Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.semantic_graph" }
	S.tags = { "z", "capabilitydiscovery", "intent", "origin" }
	S.description = "Capability Discovery Intent Bridge: natural language control surface for the technology for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.capabilitydiscovery.intent_bridge", minConfidence = 0.39 })
		inst.system = S
		inst.ctx = ctx
