-- ARKHER SYSTEM VA.0078 :: LOD Cascade Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0078"
	S.key = "arkher.contworld.lodcascade.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lodcascade.persistent_state" }
	S.tags = { "va", "lodcascade", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.lodcascade.coherence_guard", window = 52, threshold = 0.14 })
		inst.system = S
		inst.ctx = ctx
