-- ARKHER SYSTEM Z.1001 :: Capability Discovery Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.1001"
	S.key = "arkher.origin.capabilitydiscovery.reality_layering"
	S.name = "Capability Discovery Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "capabilitydiscovery", "reality", "origin" }
	S.description = "Capability Discovery Reality Layering: stacked authored, simulated, proposed and player realities for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.capabilitydiscovery.reality_layering" })
		inst.system = S
		inst.ctx = ctx
