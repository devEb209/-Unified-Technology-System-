-- ARKHER SYSTEM I.0096 :: Clip Looping Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0096"
	S.key = "arkher.anim.cliploop.physical_blend"
	S.name = "Clip Looping Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Looping"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.cliploop.inverse_kinematics" }
	S.tags = { "i", "cliploop", "ragdoll", "anim" }
	S.description = "Clip Looping Physical Blend: physical bones blended against the animated pose for the Clip Looping subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.cliploop.physical_blend", blendSpeed = 3.10 })
		inst.system = S
		inst.ctx = ctx
