-- ARKHER SYSTEM V.0270 :: Lightmap Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0270"
	S.key = "arkher.asset.lightmap.content_cache"
	S.name = "Lightmap Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lightmap.dependency_graph" }
	S.tags = { "v", "lightmap", "cache", "asset" }
	S.description = "Lightmap Content Cache: reuse of already cooked results for the Lightmap subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.lightmap.content_cache", policy = "lfu", capacity = 154, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
