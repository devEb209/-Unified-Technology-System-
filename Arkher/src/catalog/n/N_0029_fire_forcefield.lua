-- ARKHER SYSTEM N.0029 :: Fire Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0029"
	S.key = "arkher.vfx.fire.force_field"
	S.name = "Fire Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fire"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fire.particle_simulation" }
	S.tags = { "n", "fire", "forcefield", "vfx" }
	S.description = "Fire Force Field: wind, attraction, vortex, drag and curl turbulence for the Fire subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.fire.force_field", seed = 50377 })
		inst.system = S
		inst.ctx = ctx
