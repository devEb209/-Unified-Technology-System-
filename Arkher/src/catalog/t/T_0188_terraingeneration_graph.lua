-- ARKHER SYSTEM T.0188 :: Terrain Generation Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0188"
	S.key = "arkher.ai.terraingeneration.reasoning_graph"
	S.name = "Terrain Generation Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.terraingeneration.world_architect" }
	S.tags = { "t", "terraingeneration", "graph", "ai" }
	S.description = "Terrain Generation Reasoning Graph: relationship modelling and shortest-path reasoning for the Terrain Generation subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.terraingeneration.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
