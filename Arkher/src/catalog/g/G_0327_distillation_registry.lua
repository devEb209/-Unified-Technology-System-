-- ARKHER SYSTEM G.0327 :: Model Distillation Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0327"
	S.key = "arkher.neural.distillation.model_registry"
	S.name = "Model Distillation Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.distillation.reconstruction" }
	S.tags = { "g", "distillation", "registry", "neural" }
	S.description = "Model Distillation Model Registry: named models and their lifecycle for the Model Distillation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.distillation.model_registry" })
		inst.system = S
		inst.ctx = ctx
