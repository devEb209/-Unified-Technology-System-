-- ARKHER SYSTEM Z.0789 :: Attention Driven Detail Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0789"
	S.key = "arkher.origin.attentiondetail.intent_bridge"
	S.name = "Attention Driven Detail Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.semantic_graph" }
	S.tags = { "z", "attentiondetail", "intent", "origin" }
	S.description = "Attention Driven Detail Intent Bridge: natural language control surface for the technology for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.attentiondetail.intent_bridge", minConfidence = 0.40 })
		inst.system = S
		inst.ctx = ctx
