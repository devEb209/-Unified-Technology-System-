-- ARKHER SYSTEM Z.0524 :: Migration Dynamics Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0524"
	S.key = "arkher.origin.migrationdynamics.autonomous_pipeline"
	S.name = "Migration Dynamics Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.migrationdynamics.simulation_fabric" }
	S.tags = { "z", "migrationdynamics", "autopipeline", "origin" }
	S.description = "Migration Dynamics Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.migrationdynamics.autonomous_pipeline", maxIterations = 9 })
		inst.system = S
		inst.ctx = ctx
