-- ARKHER SYSTEM K.0573 :: Work Behaviour Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0573"
	S.key = "arkher.npc.workbehaviour.thinking_budget"
	S.name = "Work Behaviour Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workbehaviour.daily_schedule" }
	S.tags = { "k", "workbehaviour", "budgeter", "npc" }
	S.description = "Work Behaviour Thinking Budget: allocation of per-frame thinking time across NPCs for the Work Behaviour subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.workbehaviour.thinking_budget", total = 123, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
