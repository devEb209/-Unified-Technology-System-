-- ARKHER SYSTEM J.0052 :: Hair Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0052"
	S.key = "arkher.character.hair.variant_registry"
	S.name = "Hair Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.hair.appearance_composer" }
	S.tags = { "j", "hair", "registry", "character" }
	S.description = "Hair Variant Registry: named character variants and their lifecycle for the Hair subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.hair.variant_registry" })
		inst.system = S
		inst.ctx = ctx
