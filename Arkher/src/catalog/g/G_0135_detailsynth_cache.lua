-- ARKHER SYSTEM G.0135 :: Detail Synthesis Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0135"
	S.key = "arkher.neural.detailsynth.result_cache"
	S.name = "Detail Synthesis Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detailsynth.compute_budget" }
	S.tags = { "g", "detailsynth", "cache", "neural" }
	S.description = "Detail Synthesis Result Cache: cached inference results keyed by input for the Detail Synthesis subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.detailsynth.result_cache", policy = "lfu", capacity = 433, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
