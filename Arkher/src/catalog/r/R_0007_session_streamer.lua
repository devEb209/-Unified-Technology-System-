-- ARKHER SYSTEM R.0007 :: Session Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0007"
	S.key = "arkher.net.session.interest_streaming"
	S.name = "Session Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Session"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.session.serialization_codec" }
	S.tags = { "r", "session", "streamer", "net" }
	S.description = "Session Interest Streaming: distance-driven residency of replicated content for the Session subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.session.interest_streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
