-- ARKHER SYSTEM N.0261 :: Shield Effect Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0261"
	S.key = "arkher.vfx.shieldfx.emission"
	S.name = "Shield Effect Emission"
	S.category = "N"
	S.family = "VFX"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "shieldfx", "emitter", "vfx" }
	S.description = "Shield Effect Emission: shaped, rate and burst emission of new particles for the Shield Effect subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.shieldfx.emission", shape = "cone", rate = 60, speed = 5.00, life = 1.80, budget = 384, seed = 41140 })
		inst.system = S
		inst.ctx = ctx
