-- ARKHER SYSTEM I.0412 :: Animation Streaming Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0412"
	S.key = "arkher.anim.animstreaming.playback_pipeline"
	S.name = "Animation Streaming Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstreaming.event_ledger" }
	S.tags = { "i", "animstreaming", "pipeline", "anim" }
	S.description = "Animation Streaming Playback Pipeline: ordered sample, blend, ik and output stages for the Animation Streaming subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.animstreaming.playback_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
