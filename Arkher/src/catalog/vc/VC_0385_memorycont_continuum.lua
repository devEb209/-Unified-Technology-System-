-- ARKHER SYSTEM VC.0385 :: Memory Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0385"
	S.key = "arkher.contneural.memorycont.infinite_grid"
	S.name = "Memory Continuum Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "memorycont", "continuum", "contneural" }
	S.description = "Memory Continuum Infinite Grid: seamless paging of the infinite world grid for the Memory Continuum subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.memorycont.infinite_grid", cellSize = 96, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
