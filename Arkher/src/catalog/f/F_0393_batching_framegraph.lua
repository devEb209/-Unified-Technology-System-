-- ARKHER SYSTEM F.0393 :: Draw Call Batching Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0393"
	S.key = "arkher.render.batching.frame_graph"
	S.name = "Draw Call Batching Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "batching", "framegraph", "render" }
	S.description = "Draw Call Batching Frame Graph: declared passes, culling, ordering and aliasing for the Draw Call Batching subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.batching.frame_graph", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
