-- ARKHER SYSTEM F.0060 :: Shadow Pass Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0060"
	S.key = "arkher.render.shadowpass.geometry_virtualization"
	S.name = "Shadow Pass Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Shadow Pass"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.shadowpass.visibility_set" }
	S.tags = { "f", "shadowpass", "impostor", "render" }
	S.description = "Shadow Pass Geometry Virtualization: impostor and HLOD synthesis under a budget for the Shadow Pass subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.shadowpass.geometry_virtualization", atlasSlots = 80, viewCount = 8, errorThreshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
