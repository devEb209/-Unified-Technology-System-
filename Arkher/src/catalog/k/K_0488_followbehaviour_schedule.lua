-- ARKHER SYSTEM K.0488 :: Follow Behaviour Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0488"
	S.key = "arkher.npc.followbehaviour.daily_schedule"
	S.name = "Follow Behaviour Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.followbehaviour.social_relations" }
	S.tags = { "k", "followbehaviour", "schedule", "npc" }
	S.description = "Follow Behaviour Daily Schedule: hour-by-hour routine with priority interruptions for the Follow Behaviour subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.followbehaviour.daily_schedule", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
