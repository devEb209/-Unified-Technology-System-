-- ARKHER SYSTEM O.0334 :: Engine Audio Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0334"
	S.key = "arkher.audio.engineaudio.analysis"
	S.name = "Engine Audio Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Engine Audio"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.engineaudio.playback_policy" }
	S.tags = { "o", "engineaudio", "analyzer", "audio" }
	S.description = "Engine Audio Analysis: loudness, headroom and masking analysis for the Engine Audio subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.engineaudio.analysis", window = 98, buckets = 18, threshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
