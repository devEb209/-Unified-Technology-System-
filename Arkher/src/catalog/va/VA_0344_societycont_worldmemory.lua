-- ARKHER SYSTEM VA.0344 :: Society Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0344"
	S.key = "arkher.contworld.societycont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.societycont.neural_field" }
	S.tags = { "va", "societycont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.societycont.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
