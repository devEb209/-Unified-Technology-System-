-- ARKHER SYSTEM VD.0404 :: Perception Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0404"
	S.key = "arkher.contsim.perceptioncont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.perceptioncont.neural_field" }
	S.tags = { "vd", "perceptioncont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.perceptioncont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
