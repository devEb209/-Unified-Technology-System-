-- ARKHER SYSTEM Z.0563 :: Collective Behaviour Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0563"
	S.key = "arkher.origin.collectivebehaviour.simulation_fabric"
	S.name = "Collective Behaviour Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.collectivebehaviour.complexity_governance" }
	S.tags = { "z", "collectivebehaviour", "fabric", "origin" }
	S.description = "Collective Behaviour Simulation Fabric: every simulation domain stepped under one budgeted clock for the Collective Behaviour subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.collectivebehaviour.simulation_fabric", budgetMs = 3.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
