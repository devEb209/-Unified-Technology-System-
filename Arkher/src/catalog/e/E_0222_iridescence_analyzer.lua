-- ARKHER SYSTEM E.0222 :: Iridescence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0222"
	S.key = "arkher.material.iridescence.analysis"
	S.name = "Iridescence Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Iridescence"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.iridescence.instance_cache" }
	S.tags = { "e", "iridescence", "analyzer", "material" }
	S.description = "Iridescence Analysis: cost, redundancy and outlier analysis for the Iridescence subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.iridescence.analysis", window = 241, buckets = 9, threshold = 3.30 })
		inst.system = S
		inst.ctx = ctx
