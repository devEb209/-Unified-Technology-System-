-- ARKHER SYSTEM F.0279 :: Tonemapping Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0279"
	S.key = "arkher.render.tonemap.orchestration"
	S.name = "Tonemapping Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Tonemapping"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.tonemap.frame_analysis" }
	S.tags = { "f", "tonemap", "orchestrator", "render" }
	S.description = "Tonemapping Orchestration: frame lifecycle orchestration for the Tonemapping subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.tonemap.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
