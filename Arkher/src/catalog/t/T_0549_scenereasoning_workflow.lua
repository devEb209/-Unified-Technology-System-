-- ARKHER SYSTEM T.0549 :: Scene Reasoning Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0549"
	S.key = "arkher.ai.scenereasoning.plan_workflow"
	S.name = "Scene Reasoning Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.scenereasoning.semantic_knowledge" }
	S.tags = { "t", "scenereasoning", "workflow", "ai" }
	S.description = "Scene Reasoning Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Scene Reasoning subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.scenereasoning.plan_workflow", maxRetries = 2, budget = 140 })
		inst.system = S
		inst.ctx = ctx
