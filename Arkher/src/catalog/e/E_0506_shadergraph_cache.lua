-- ARKHER SYSTEM E.0506 :: Shader Graph Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0506"
	S.key = "arkher.material.shadergraph.instance_cache"
	S.name = "Shader Graph Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Shader Graph"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.shadergraph.quality_policy" }
	S.tags = { "e", "shadergraph", "cache", "material" }
	S.description = "Shader Graph Instance Cache: resolved-parameter cache keyed by context for the Shader Graph subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.shadergraph.instance_cache", policy = "ttl", capacity = 454, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
