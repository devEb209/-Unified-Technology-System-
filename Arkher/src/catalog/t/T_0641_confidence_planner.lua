-- ARKHER SYSTEM T.0641 :: Confidence Estimation Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0641"
	S.key = "arkher.ai.confidence.action_planner"
	S.name = "Confidence Estimation Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.confidence.utility_selection" }
	S.tags = { "t", "confidence", "planner", "ai" }
	S.description = "Confidence Estimation Action Planner: goal-oriented action planning over preconditions for the Confidence Estimation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.confidence.action_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
