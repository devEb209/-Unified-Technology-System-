-- ARKHER SYSTEM VD.0569 :: Mobile Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0569"
	S.key = "arkher.contsim.mobilecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.mobilecont.multi-scale_fidelity" }
	S.tags = { "vd", "mobilecont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.mobilecont.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
