-- ARKHER SYSTEM N.0127 :: Water Splash Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0127"
	S.key = "arkher.vfx.splash.quality_policy"
	S.name = "Water Splash Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Water Splash"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.splash.result_cache" }
	S.tags = { "n", "splash", "policy", "vfx" }
	S.description = "Water Splash Quality Policy: distance and device driven fidelity bands for the Water Splash subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.splash.quality_policy", algorithm = "wfq", starvationGuard = 18 })
		inst.system = S
		inst.ctx = ctx
