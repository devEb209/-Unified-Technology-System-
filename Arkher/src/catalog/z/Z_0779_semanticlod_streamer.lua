-- ARKHER SYSTEM Z.0779 :: Semantic LOD Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0779"
	S.key = "arkher.origin.semanticlod.residency_streaming"
	S.name = "Semantic LOD Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticlod.budget_governor" }
	S.tags = { "z", "semanticlod", "streamer", "origin" }
	S.description = "Semantic LOD Residency Streaming: distance-driven residency of the technology's workload for the Semantic LOD subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.semanticlod.residency_streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
