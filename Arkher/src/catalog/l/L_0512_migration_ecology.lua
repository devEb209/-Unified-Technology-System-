-- ARKHER SYSTEM L.0512 :: Migration Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0512"
	S.key = "arkher.sim.migration.ecology"
	S.name = "Migration Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.migration.simulation_core" }
	S.tags = { "l", "migration", "ecology", "sim" }
	S.description = "Migration Ecology: populations, predation, harvesting and carrying capacity for the Migration subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.migration.ecology" })
		inst.system = S
		inst.ctx = ctx
