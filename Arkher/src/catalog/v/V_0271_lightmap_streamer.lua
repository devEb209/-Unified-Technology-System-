-- ARKHER SYSTEM V.0271 :: Lightmap Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0271"
	S.key = "arkher.asset.lightmap.streaming_residency"
	S.name = "Lightmap Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lightmap.content_cache" }
	S.tags = { "v", "lightmap", "streamer", "asset" }
	S.description = "Lightmap Streaming Residency: distance-driven load and unload of asset payloads for the Lightmap subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.lightmap.streaming_residency", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
