-- ARKHER SYSTEM E.0515 :: Parameter Animation Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0515"
	S.key = "arkher.material.paramanim.procedural_detail"
	S.name = "Parameter Animation Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.paramanim.texture_sampling" }
	S.tags = { "e", "paramanim", "field", "material" }
	S.description = "Parameter Animation Procedural Detail: coherent noise detail driving the surface for the Parameter Animation subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.paramanim.procedural_detail", seed = 24317, frequency = 0.0132, octaves = 4, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
