-- ARKHER SYSTEM VD.0396 :: Memory Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0396"
	S.key = "arkher.contsim.memorycont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memorycont.reality_continuum" }
	S.tags = { "vd", "memorycont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.memorycont.emergence_continuum", windowSize = 6, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
