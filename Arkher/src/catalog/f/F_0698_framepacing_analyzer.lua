-- ARKHER SYSTEM F.0698 :: Frame Pacing Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0698"
	S.key = "arkher.render.framepacing.frame_analysis"
	S.name = "Frame Pacing Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Frame Pacing"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepacing.pass_cache" }
	S.tags = { "f", "framepacing", "analyzer", "render" }
	S.description = "Frame Pacing Frame Analysis: per-pass cost analysis and outlier detection for the Frame Pacing subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.framepacing.frame_analysis", window = 64, buckets = 12, threshold = 3.60 })
		inst.system = S
		inst.ctx = ctx
