-- ARKHER SYSTEM R.0337 :: Reconnection Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0337"
	S.key = "arkher.net.reconnection.replication"
	S.name = "Reconnection Replication"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Reconnection"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "reconnection", "replicator", "net" }
	S.description = "Reconnection Replication: authoritative entity state, interest and delta snapshots for the Reconnection subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.reconnection.replication", mtu = 1050, interestRadius = 480, fullEvery = 75 })
		inst.system = S
		inst.ctx = ctx
