-- ARKHER SYSTEM P.0100 :: Inventory Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0100"
	S.key = "arkher.play.inventorysys.combat_resolution"
	S.name = "Inventory Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Inventory"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.inventorysys.objectives" }
	S.tags = { "p", "inventorysys", "combat", "play" }
	S.description = "Inventory Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Inventory subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.inventorysys.combat_resolution", seed = 32543, armourK = 150, critMultiplier = 2.60 })
		inst.system = S
		inst.ctx = ctx
