-- ARKHER SYSTEM VB.0431 :: Navigation Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0431"
	S.key = "arkher.conttime.navcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.navcont.simulation_fabric" }
	S.tags = { "vb", "navcont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.navcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
