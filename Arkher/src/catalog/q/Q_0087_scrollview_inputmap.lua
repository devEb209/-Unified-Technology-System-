-- ARKHER SYSTEM Q.0087 :: Scroll View Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0087"
	S.key = "arkher.ui.scrollview.input_mapping"
	S.name = "Scroll View Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Scroll View"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.scrollview.widget_tree" }
	S.tags = { "q", "scrollview", "inputmap", "ui" }
	S.description = "Scroll View Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Scroll View subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.scrollview.input_mapping", device = "touch", holdTime = 0.44, deadzone = 0.19 })
		inst.system = S
		inst.ctx = ctx
