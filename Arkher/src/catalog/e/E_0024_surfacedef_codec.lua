-- ARKHER SYSTEM E.0024 :: Surface Definition Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0024"
	S.key = "arkher.material.surfacedef.compression_codec"
	S.name = "Surface Definition Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.surfacedef.streaming" }
	S.tags = { "e", "surfacedef", "codec", "material" }
	S.description = "Surface Definition Compression Codec: serialization and compression of material data for the Surface Definition subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.surfacedef.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
