-- ARKHER SYSTEM V.0186 :: Scene Asset Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0186"
	S.key = "arkher.asset.sceneasset.content_cache"
	S.name = "Scene Asset Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.sceneasset.dependency_graph" }
	S.tags = { "v", "sceneasset", "cache", "asset" }
	S.description = "Scene Asset Content Cache: reuse of already cooked results for the Scene Asset subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.sceneasset.content_cache", policy = "ttl", capacity = 445, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
