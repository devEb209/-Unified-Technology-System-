-- ARKHER SYSTEM O.0086 :: Narration Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0086"
	S.key = "arkher.audio.narration.mixer_bus"
	S.name = "Narration Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Narration"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.narration.dsp_chain" }
	S.tags = { "o", "narration", "mixer", "audio" }
	S.description = "Narration Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Narration subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.narration.mixer_bus", maxVoices = 48 })
		inst.system = S
		inst.ctx = ctx
