-- ARKHER SYSTEM Z.0196 :: World Memory Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0196"
	S.key = "arkher.origin.worldmemorytech.governance_policy"
	S.name = "World Memory Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldmemorytech.signal_composition" }
	S.tags = { "z", "worldmemorytech", "policy", "origin" }
	S.description = "World Memory Governance Policy: ordered rules governing when the technology may act for the World Memory subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.worldmemorytech.governance_policy", algorithm = "lottery", starvationGuard = 23 })
		inst.system = S
		inst.ctx = ctx
