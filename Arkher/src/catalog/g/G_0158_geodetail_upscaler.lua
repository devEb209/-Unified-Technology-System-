-- ARKHER SYSTEM G.0158 :: Geometry Detail Prediction Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0158"
	S.key = "arkher.neural.geodetail.reconstruction"
	S.name = "Geometry Detail Prediction Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.geodetail.temporal_history" }
	S.tags = { "g", "geodetail", "upscaler", "neural" }
	S.description = "Geometry Detail Prediction Reconstruction: resolution ladder and image reconstruction for the Geometry Detail Prediction subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.geodetail.reconstruction", targetMs = 11.10, index = 3, sharpness = 0.42 })
		inst.system = S
		inst.ctx = ctx
