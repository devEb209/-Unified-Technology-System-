-- ARKHER SYSTEM Z.0389 :: Thermal Aware Simulation Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0389"
	S.key = "arkher.origin.thermalaware.intent_bridge"
	S.name = "Thermal Aware Simulation Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.semantic_graph" }
	S.tags = { "z", "thermalaware", "intent", "origin" }
	S.description = "Thermal Aware Simulation Intent Bridge: natural language control surface for the technology for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.thermalaware.intent_bridge", minConfidence = 0.32 })
		inst.system = S
		inst.ctx = ctx
