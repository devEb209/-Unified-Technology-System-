-- ARKHER SYSTEM T.0184 :: Terrain Generation Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0184"
	S.key = "arkher.ai.terraingeneration.semantic_knowledge"
	S.name = "Terrain Generation Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.terraingeneration.intent_understanding" }
	S.tags = { "t", "terraingeneration", "knowledge", "ai" }
	S.description = "Terrain Generation Semantic Knowledge: typed entities, weighted relations and inferred closure for the Terrain Generation subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.terraingeneration.semantic_knowledge", dims = 40 })
		inst.system = S
		inst.ctx = ctx
