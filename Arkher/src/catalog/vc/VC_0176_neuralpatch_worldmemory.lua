-- ARKHER SYSTEM VC.0176 :: Neural Patch World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0176"
	S.key = "arkher.contneural.neuralpatch.world_memory_stream"
	S.name = "Neural Patch World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.neuralpatch.neural_field" }
	S.tags = { "vc", "neuralpatch", "worldmemory", "contneural" }
	S.description = "Neural Patch World Memory Stream: world memory continuum over epochs for the Neural Patch subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.neuralpatch.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
