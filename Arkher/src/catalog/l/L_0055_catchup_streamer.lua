-- ARKHER SYSTEM L.0055 :: Catch Up Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0055"
	S.key = "arkher.sim.catchup.streaming"
	S.name = "Catch Up Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.catchup.state_codec" }
	S.tags = { "l", "catchup", "streamer", "sim" }
	S.description = "Catch Up Streaming: distance-driven residency of simulated regions for the Catch Up subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.catchup.streaming", radius = 280, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
