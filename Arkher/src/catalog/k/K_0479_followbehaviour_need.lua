-- ARKHER SYSTEM K.0479 :: Follow Behaviour Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0479"
	S.key = "arkher.npc.followbehaviour.drive_system"
	S.name = "Follow Behaviour Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.followbehaviour.memory" }
	S.tags = { "k", "followbehaviour", "need", "npc" }
	S.description = "Follow Behaviour Drive System: drives that decay, turn urgent and get satisfied for the Follow Behaviour subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.followbehaviour.drive_system" })
		inst.system = S
		inst.ctx = ctx
