-- ARKHER SYSTEM T.0360 :: Documentation Writer Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0360"
	S.key = "arkher.ai.documentationwriter.utility_selection"
	S.name = "Documentation Writer Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.documentationwriter.working_memory" }
	S.tags = { "t", "documentationwriter", "utility", "ai" }
	S.description = "Documentation Writer Utility Selection: scored choice between competing courses of action for the Documentation Writer subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.documentationwriter.utility_selection", momentum = 0.00 })
		inst.system = S
		inst.ctx = ctx
