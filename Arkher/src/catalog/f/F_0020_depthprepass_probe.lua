-- ARKHER SYSTEM F.0020 :: Depth Prepass Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0020"
	S.key = "arkher.render.depthprepass.probe_volume"
	S.name = "Depth Prepass Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.depthprepass.lighting_rig" }
	S.tags = { "f", "depthprepass", "probe", "render" }
	S.description = "Depth Prepass Probe Volume: irradiance probes encoded in spherical harmonics for the Depth Prepass subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.depthprepass.probe_volume", spacing = 16 })
		inst.system = S
		inst.ctx = ctx
