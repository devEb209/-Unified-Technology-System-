-- ARKHER SYSTEM VD.0319 :: Ecology Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0319"
	S.key = "arkher.contsim.ecologycont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.ecologycont.coherence_guard" }
	S.tags = { "vd", "ecologycont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.ecologycont.neural_field", dims = 12, hidden = 8, seed = 32136 })
		inst.system = S
		inst.ctx = ctx
