-- ARKHER SYSTEM VB.0258 :: Road Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0258"
	S.key = "arkher.conttime.roadcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.roadcont.persistent_state" }
	S.tags = { "vb", "roadcont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.roadcont.coherence_guard", window = 128, threshold = 0.10 })
		inst.system = S
		inst.ctx = ctx
