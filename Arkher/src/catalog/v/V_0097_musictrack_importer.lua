-- ARKHER SYSTEM V.0097 :: Music Track Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0097"
	S.key = "arkher.asset.musictrack.import"
	S.name = "Music Track Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "musictrack", "importer", "asset" }
	S.description = "Music Track Import: validation, normalization, hashing and deduplication of incoming content for the Music Track subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.musictrack.import", unitScale = 1.00 })
		inst.system = S
		inst.ctx = ctx
