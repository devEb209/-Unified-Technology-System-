-- ARKHER SYSTEM R.0359 :: Network Debug Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0359"
	S.key = "arkher.net.networkdebug.latency_analysis"
	S.name = "Network Debug Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.networkdebug.audit_ledger" }
	S.tags = { "r", "networkdebug", "analyzer", "net" }
	S.description = "Network Debug Latency Analysis: round trip, jitter and loss analysis for the Network Debug subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.networkdebug.latency_analysis", window = 198, buckets = 10, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
