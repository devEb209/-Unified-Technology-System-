-- ARKHER SYSTEM O.0164 :: Forest Audio Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0164"
	S.key = "arkher.audio.forestaudio.compression_codec"
	S.name = "Forest Audio Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Forest Audio"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.forestaudio.asset_registry" }
	S.tags = { "o", "forestaudio", "codec", "audio" }
	S.description = "Forest Audio Compression Codec: payload encoding of audio state and events for the Forest Audio subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.forestaudio.compression_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
