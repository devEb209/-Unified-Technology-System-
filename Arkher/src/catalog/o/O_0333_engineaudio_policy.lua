-- ARKHER SYSTEM O.0333 :: Engine Audio Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0333"
	S.key = "arkher.audio.engineaudio.playback_policy"
	S.name = "Engine Audio Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Engine Audio"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.engineaudio.compression_codec" }
	S.tags = { "o", "engineaudio", "policy", "audio" }
	S.description = "Engine Audio Playback Policy: rules choosing what may be heard right now for the Engine Audio subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.engineaudio.playback_policy", algorithm = "lottery", starvationGuard = 43 })
		inst.system = S
		inst.ctx = ctx
