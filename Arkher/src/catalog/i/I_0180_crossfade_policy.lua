-- ARKHER SYSTEM I.0180 :: Crossfade Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0180"
	S.key = "arkher.anim.crossfade.quality_policy"
	S.name = "Crossfade Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Crossfade"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crossfade.pose_cache" }
	S.tags = { "i", "crossfade", "policy", "anim" }
	S.description = "Crossfade Quality Policy: device tier rules for rate, bones and solvers for the Crossfade subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.crossfade.quality_policy", algorithm = "edf", starvationGuard = 37 })
		inst.system = S
		inst.ctx = ctx
