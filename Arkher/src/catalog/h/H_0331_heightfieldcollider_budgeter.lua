-- ARKHER SYSTEM H.0331 :: Heightfield Collider Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0331"
	S.key = "arkher.physics.heightfieldcollider.budget_governor"
	S.name = "Heightfield Collider Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.heightfieldcollider.broadphase_index" }
	S.tags = { "h", "heightfieldcollider", "budgeter", "physics" }
	S.description = "Heightfield Collider Budget Governor: simulation time budget allocation across islands for the Heightfield Collider subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.heightfieldcollider.budget_governor", total = 438, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
