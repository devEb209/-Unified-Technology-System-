-- ARKHER SYSTEM T.0072 :: Project Knowledge Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0072"
	S.key = "arkher.ai.projectknowledge.semantic_knowledge"
	S.name = "Project Knowledge Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.projectknowledge.intent_understanding" }
	S.tags = { "t", "projectknowledge", "knowledge", "ai" }
	S.description = "Project Knowledge Semantic Knowledge: typed entities, weighted relations and inferred closure for the Project Knowledge subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.projectknowledge.semantic_knowledge", dims = 24 })
		inst.system = S
		inst.ctx = ctx
