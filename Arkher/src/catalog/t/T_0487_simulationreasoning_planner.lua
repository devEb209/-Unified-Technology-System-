-- ARKHER SYSTEM T.0487 :: Simulation Reasoning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0487"
	S.key = "arkher.ai.simulationreasoning.action_planner"
	S.name = "Simulation Reasoning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.simulationreasoning.utility_selection" }
	S.tags = { "t", "simulationreasoning", "planner", "ai" }
	S.description = "Simulation Reasoning Action Planner: goal-oriented action planning over preconditions for the Simulation Reasoning subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.simulationreasoning.action_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
