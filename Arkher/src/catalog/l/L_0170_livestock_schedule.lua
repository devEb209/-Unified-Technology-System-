-- ARKHER SYSTEM L.0170 :: Livestock Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0170"
	S.key = "arkher.sim.livestock.calendar"
	S.name = "Livestock Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livestock.society" }
	S.tags = { "l", "livestock", "schedule", "sim" }
	S.description = "Livestock Calendar: hours, days and seasons driving the region for the Livestock subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.livestock.calendar", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
