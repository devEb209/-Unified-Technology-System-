-- ARKHER SYSTEM VD.0032 :: Zone Chunk World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0032"
	S.key = "arkher.contsim.zonechunk.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.zonechunk.neural_field" }
	S.tags = { "vd", "zonechunk", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.zonechunk.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
