-- ARKHER SYSTEM J.0034 :: Skin Definition Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0034"
	S.key = "arkher.character.skindef.rig_definition"
	S.name = "Skin Definition Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "skindef", "skeleton", "character" }
	S.description = "Skin Definition Rig Definition: character rig definition and bone budget for the Skin Definition subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.skindef.rig_definition" })
		inst.system = S
		inst.ctx = ctx
