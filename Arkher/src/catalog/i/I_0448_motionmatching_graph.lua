-- ARKHER SYSTEM I.0448 :: Motion Matching Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0448"
	S.key = "arkher.anim.motionmatching.retarget_graph"
	S.name = "Motion Matching Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.motionmatching.physical_blend" }
	S.tags = { "i", "motionmatching", "graph", "anim" }
	S.description = "Motion Matching Retarget Graph: bone mapping and retarget path resolution for the Motion Matching subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.motionmatching.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
