-- ARKHER SYSTEM K.0460 :: Crowd Flow Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0460"
	S.key = "arkher.npc.crowdflow.daily_schedule"
	S.name = "Crowd Flow Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.crowdflow.social_relations" }
	S.tags = { "k", "crowdflow", "schedule", "npc" }
	S.description = "Crowd Flow Daily Schedule: hour-by-hour routine with priority interruptions for the Crowd Flow subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.crowdflow.daily_schedule", startHour = 6 })
		inst.system = S
		inst.ctx = ctx
