-- ARKHER SYSTEM R.0035 :: Handshake Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0035"
	S.key = "arkher.net.handshake.latency_analysis"
	S.name = "Handshake Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Handshake"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.handshake.audit_ledger" }
	S.tags = { "r", "handshake", "analyzer", "net" }
	S.description = "Handshake Latency Analysis: round trip, jitter and loss analysis for the Handshake subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.handshake.latency_analysis", window = 89, buckets = 17, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
