-- ARKHER SYSTEM K.0461 :: Crowd Flow Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0461"
	S.key = "arkher.npc.crowdflow.thinking_budget"
	S.name = "Crowd Flow Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.crowdflow.daily_schedule" }
	S.tags = { "k", "crowdflow", "budgeter", "npc" }
	S.description = "Crowd Flow Thinking Budget: allocation of per-frame thinking time across NPCs for the Crowd Flow subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.crowdflow.thinking_budget", total = 373, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
