-- ARKHER SYSTEM Z.0015 :: Adaptive World Intelligence Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0015"
	S.key = "arkher.origin.adaptiveworld.signal_composition"
	S.name = "Adaptive World Intelligence Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.adaptiveworld.telemetry_ledger" }
	S.tags = { "z", "adaptiveworld", "composer", "origin" }
	S.description = "Adaptive World Intelligence Signal Composition: blending of the technology's input signals into one output for the Adaptive World Intelligence subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.adaptiveworld.signal_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
