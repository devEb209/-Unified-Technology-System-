-- ARKHER SYSTEM VD.0190 :: Simulation Domain Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0190"
	S.key = "arkher.contsim.simdomain.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.simdomain.complexity_budget" }
	S.tags = { "vd", "simdomain", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.simdomain.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
