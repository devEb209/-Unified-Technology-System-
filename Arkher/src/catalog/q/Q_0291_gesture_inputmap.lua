-- ARKHER SYSTEM Q.0291 :: Gesture Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0291"
	S.key = "arkher.ui.gesture.input_mapping"
	S.name = "Gesture Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Gesture"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.gesture.widget_tree" }
	S.tags = { "q", "gesture", "inputmap", "ui" }
	S.description = "Gesture Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Gesture subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.gesture.input_mapping", device = "gamepad", holdTime = 0.31, deadzone = 0.11 })
		inst.system = S
		inst.ctx = ctx
