-- ARKHER SYSTEM F.0136 :: Global Illumination Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0136"
	S.key = "arkher.render.gi.render_policy"
	S.name = "Global Illumination Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.gi.draw_budget" }
	S.tags = { "f", "gi", "policy", "render" }
	S.description = "Global Illumination Render Policy: device tier rules for the frame for the Global Illumination subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.gi.render_policy", algorithm = "roundrobin", starvationGuard = 24 })
		inst.system = S
		inst.ctx = ctx
