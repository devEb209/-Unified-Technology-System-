-- ARKHER SYSTEM N.0257 :: Portal Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0257"
	S.key = "arkher.vfx.portal.quality_policy"
	S.name = "Portal Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Portal"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.portal.result_cache" }
	S.tags = { "n", "portal", "policy", "vfx" }
	S.description = "Portal Quality Policy: distance and device driven fidelity bands for the Portal subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.portal.quality_policy", algorithm = "wfq", starvationGuard = 62 })
		inst.system = S
		inst.ctx = ctx
