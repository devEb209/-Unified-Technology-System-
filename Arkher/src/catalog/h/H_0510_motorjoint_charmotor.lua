-- ARKHER SYSTEM H.0510 :: Motorized Joint Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0510"
	S.key = "arkher.physics.motorjoint.character_motion"
	S.name = "Motorized Joint Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.motorjoint.query" }
	S.tags = { "h", "motorjoint", "charmotor", "physics" }
	S.description = "Motorized Joint Character Motion: capsule move-and-slide with slopes, steps and jumps for the Motorized Joint subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.motorjoint.character_motion", radius = 0.48, height = 1.93, maxSpeed = 7.30, jumpHeight = 2.10, stepOffset = 0.28 })
		inst.system = S
		inst.ctx = ctx
