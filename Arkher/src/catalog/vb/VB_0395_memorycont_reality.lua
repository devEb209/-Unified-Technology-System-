-- ARKHER SYSTEM VB.0395 :: Memory Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0395"
	S.key = "arkher.conttime.memorycont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memorycont.simulation_fabric" }
	S.tags = { "vb", "memorycont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.memorycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
