-- ARKHER SYSTEM Z.0130 :: Dynamic Complexity Manager Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0130"
	S.key = "arkher.origin.complexitymanager.self_critique"
	S.name = "Dynamic Complexity Manager Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.intent_bridge" }
	S.tags = { "z", "complexitymanager", "critic", "origin" }
	S.description = "Dynamic Complexity Manager Self Critique: weighted judgement of the technology's own output for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.complexitymanager.self_critique", passMark = 0.82, reviseMark = 0.47, seed = 63717 })
		inst.system = S
		inst.ctx = ctx
