-- ARKHER SYSTEM F.0556 :: Particle Rendering Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0556"
	S.key = "arkher.render.particlerender.render_policy"
	S.name = "Particle Rendering Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.particlerender.draw_budget" }
	S.tags = { "f", "particlerender", "policy", "render" }
	S.description = "Particle Rendering Render Policy: device tier rules for the frame for the Particle Rendering subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.particlerender.render_policy", algorithm = "wfq", starvationGuard = 30 })
		inst.system = S
		inst.ctx = ctx
