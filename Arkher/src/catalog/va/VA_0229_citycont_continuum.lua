-- ARKHER SYSTEM VA.0229 :: City Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0229"
	S.key = "arkher.contworld.citycont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "citycont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.citycont.infinite_grid", cellSize = 224, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
