-- ARKHER SYSTEM VB.0606 :: Seam Lattice Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0606"
	S.key = "arkher.conttime.seamlattice.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.seamlattice.persistent_state" }
	S.tags = { "vb", "seamlattice", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.seamlattice.coherence_guard", window = 85, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
