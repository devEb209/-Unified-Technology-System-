-- ARKHER SYSTEM T.0349 :: Test Authoring Learning Analysis
...
return function(A)
	...
	local S = {}
	S.id = "T.0349"
	S.key = "arkher.ai.testauthoring.learning_analysis"
	S.name = "Test Authoring Learning Analysis"
	S.category = "T"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.testauthoring.model_inference" }
	S.tags = { "t", "testauthoring", "analyzer", "ai" }
	S.description = "Test Authoring Learning Analysis: trend, anomaly and improvement analysis of the agent for the Test Authoring subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ai.testauthoring.learning_analysis", window = 119, buckets = 19, threshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
