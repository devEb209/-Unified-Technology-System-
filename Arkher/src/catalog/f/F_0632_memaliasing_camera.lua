-- ARKHER SYSTEM F.0632 :: Memory Aliasing View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0632"
	S.key = "arkher.render.memaliasing.view_and_culling"
	S.name = "Memory Aliasing View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.memaliasing.frame_graph" }
	S.tags = { "f", "memaliasing", "camera", "render" }
	S.description = "Memory Aliasing View And Culling: view state, frustum culling and screen-size LOD for the Memory Aliasing subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.memaliasing.view_and_culling", width = 828, height = 900, fov = 0.9500, far = 2200 })
		inst.system = S
		inst.ctx = ctx
