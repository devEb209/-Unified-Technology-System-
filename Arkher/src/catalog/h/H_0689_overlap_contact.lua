-- ARKHER SYSTEM H.0689 :: Overlap Query Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0689"
	S.key = "arkher.physics.overlap.contact_generation"
	S.name = "Overlap Query Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.overlap.collision_shape" }
	S.tags = { "h", "overlap", "contact", "physics" }
	S.description = "Overlap Query Contact Generation: narrow-phase manifolds with normal, depth and point for the Overlap Query subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.overlap.contact_generation", slop = 0.0070, maxManifolds = 181 })
		inst.system = S
		inst.ctx = ctx
