-- ARKHER SYSTEM O.0218 :: Music Bed Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0218"
	S.key = "arkher.audio.musicbed.mixer_bus"
	S.name = "Music Bed Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Music Bed"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.musicbed.dsp_chain" }
	S.tags = { "o", "musicbed", "mixer", "audio" }
	S.description = "Music Bed Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Music Bed subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.musicbed.mixer_bus", maxVoices = 56 })
		inst.system = S
		inst.ctx = ctx
