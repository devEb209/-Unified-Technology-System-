-- ARKHER SYSTEM V.0290 :: LOD Chain Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0290"
	S.key = "arkher.asset.lodchain.bundling"
	S.name = "LOD Chain Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lodchain.import" }
	S.tags = { "v", "lodchain", "bundler", "asset" }
	S.description = "LOD Chain Bundling: size-bounded packing, manifests and delta patches for the LOD Chain subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.lodchain.bundling", maxBundleBytes = 786432 })
		inst.system = S
		inst.ctx = ctx
