-- ARKHER SYSTEM J.0087 :: Facial Rig Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0087"
	S.key = "arkher.character.facialrig.streaming"
	S.name = "Facial Rig Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.facialrig.budget_governor" }
	S.tags = { "j", "facialrig", "streamer", "character" }
	S.description = "Facial Rig Streaming: distance-driven residency of character data for the Facial Rig subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.facialrig.streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
