-- ARKHER SYSTEM J.0004 :: Digital Human Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0004"
	S.key = "arkher.character.digitalhuman.look_and_reach"
	S.name = "Digital Human Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.digitalhuman.blend_controller" }
	S.tags = { "j", "digitalhuman", "ik", "character" }
	S.description = "Digital Human Look And Reach: look-at, reach and foot placement for the character for the Digital Human subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.digitalhuman.look_and_reach", iterations = 13, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
