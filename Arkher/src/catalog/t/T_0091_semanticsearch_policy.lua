-- ARKHER SYSTEM T.0091 :: Semantic Search Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0091"
	S.key = "arkher.ai.semanticsearch.decision_policy"
	S.name = "Semantic Search Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.semanticsearch.reasoning_graph" }
	S.tags = { "t", "semanticsearch", "policy", "ai" }
	S.description = "Semantic Search Decision Policy: ordered rules deciding what the agent does next for the Semantic Search subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.semanticsearch.decision_policy", algorithm = "edf", starvationGuard = 17 })
		inst.system = S
		inst.ctx = ctx
