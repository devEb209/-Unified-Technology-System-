-- ARKHER SYSTEM N.0314 :: Trail Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0314"
	S.key = "arkher.vfx.trail.particle_simulation"
	S.name = "Trail Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Trail"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.trail.emission" }
	S.tags = { "n", "trail", "particles", "vfx" }
	S.description = "Trail Particle Simulation: pooled integration of position, velocity, colour and life for the Trail subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.trail.particle_simulation", capacity = 192, drag = 0.14, bounce = 0.09, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
