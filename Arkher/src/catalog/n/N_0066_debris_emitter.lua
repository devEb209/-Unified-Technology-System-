-- ARKHER SYSTEM N.0066 :: Debris Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0066"
	S.key = "arkher.vfx.debris.emission"
	S.name = "Debris Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Debris"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "debris", "emitter", "vfx" }
	S.description = "Debris Emission: shaped, rate and burst emission of new particles for the Debris subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.debris.emission", shape = "cone", rate = 56, speed = 4.60, life = 1.40, budget = 128, seed = 75456 })
		inst.system = S
		inst.ctx = ctx
