-- ARKHER SYSTEM V.0385 :: Platform Variant Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0385"
	S.key = "arkher.asset.platformvariant.import"
	S.name = "Platform Variant Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "platformvariant", "importer", "asset" }
	S.description = "Platform Variant Import: validation, normalization, hashing and deduplication of incoming content for the Platform Variant subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.platformvariant.import", unitScale = 1.75 })
		inst.system = S
		inst.ctx = ctx
