-- ARKHER SYSTEM W.0298 :: Motion Blur Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0298"
	S.key = "arkher.cine.cinemotionblur.frame_budget"
	S.name = "Motion Blur Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Motion Blur"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinemotionblur.event_ledger" }
	S.tags = { "w", "cinemotionblur", "budgeter", "cine" }
	S.description = "Motion Blur Frame Budget: per-frame cost budget for the cinematic systems for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.cinemotionblur.frame_budget", total = 453, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
