-- ARKHER SYSTEM T.0529 :: Audio Reasoning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0529"
	S.key = "arkher.ai.audioreasoning.action_planner"
	S.name = "Audio Reasoning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.audioreasoning.utility_selection" }
	S.tags = { "t", "audioreasoning", "planner", "ai" }
	S.description = "Audio Reasoning Action Planner: goal-oriented action planning over preconditions for the Audio Reasoning subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.audioreasoning.action_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
