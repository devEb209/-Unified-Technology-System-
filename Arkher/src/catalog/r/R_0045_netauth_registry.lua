-- ARKHER SYSTEM R.0045 :: Authentication Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0045"
	S.key = "arkher.net.netauth.session_registry"
	S.name = "Authentication Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netauth.rate_guard" }
	S.tags = { "r", "netauth", "registry", "net" }
	S.description = "Authentication Session Registry: catalogue of sessions, players and their metadata for the Authentication subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.netauth.session_registry" })
		inst.system = S
		inst.ctx = ctx
