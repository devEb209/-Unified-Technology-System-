-- ARKHER SYSTEM R.0330 :: Matchmaking Transport Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0330"
	S.key = "arkher.net.matchmakingtransport.serialization_codec"
	S.name = "Matchmaking Transport Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.matchmakingtransport.bandwidth_budget" }
	S.tags = { "r", "matchmakingtransport", "codec", "net" }
	S.description = "Matchmaking Transport Serialization Codec: compact encoding, diffing and checksum of payloads for the Matchmaking Transport subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.matchmakingtransport.serialization_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
