-- ARKHER SYSTEM L.0419 :: Taxation Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0419"
	S.key = "arkher.sim.taxation.forecast"
	S.name = "Taxation Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.taxation.analysis" }
	S.tags = { "l", "taxation", "predictor", "sim" }
	S.description = "Taxation Forecast: prediction of the region's next state for the Taxation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.taxation.forecast", method = "ema", alpha = 0.38, window = 44 })
		inst.system = S
		inst.ctx = ctx
