-- ARKHER SYSTEM V.0110 :: Voice Line Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0110"
	S.key = "arkher.asset.voiceline.bundling"
	S.name = "Voice Line Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.voiceline.import" }
	S.tags = { "v", "voiceline", "bundler", "asset" }
	S.description = "Voice Line Bundling: size-bounded packing, manifests and delta patches for the Voice Line subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.voiceline.bundling", maxBundleBytes = 655360 })
		inst.system = S
		inst.ctx = ctx
