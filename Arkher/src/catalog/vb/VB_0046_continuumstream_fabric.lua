-- ARKHER SYSTEM VB.0046 :: Continuum Stream Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0046"
	S.key = "arkher.conttime.continuumstream.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.continuumstream.complexity_budget" }
	S.tags = { "vb", "continuumstream", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.continuumstream.simulation_fabric", budgetMs = 2.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
