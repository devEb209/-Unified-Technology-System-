-- ARKHER SYSTEM VD.0293 :: Climate Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0293"
	S.key = "arkher.contsim.climatecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.climatecont.multi-scale_fidelity" }
	S.tags = { "vd", "climatecont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.climatecont.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
