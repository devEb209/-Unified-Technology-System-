-- ARKHER SYSTEM N.0034 :: Fire Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0034"
	S.key = "arkher.vfx.fire.spawn_budget"
	S.name = "Fire Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fire"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fire.effect_composition" }
	S.tags = { "n", "fire", "budgeter", "vfx" }
	S.description = "Fire Spawn Budget: global particle budget shared by every live effect for the Fire subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.fire.spawn_budget", total = 298, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
