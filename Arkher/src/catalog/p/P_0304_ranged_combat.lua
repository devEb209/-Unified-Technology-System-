-- ARKHER SYSTEM P.0304 :: Ranged Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0304"
	S.key = "arkher.play.ranged.combat_resolution"
	S.name = "Ranged Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ranged"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ranged.objectives" }
	S.tags = { "p", "ranged", "combat", "play" }
	S.description = "Ranged Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Ranged subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.ranged.combat_resolution", seed = 36554, armourK = 100, critMultiplier = 1.70 })
		inst.system = S
		inst.ctx = ctx
