-- ARKHER SYSTEM L.0268 :: Season Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0268"
	S.key = "arkher.sim.season.analysis"
	S.name = "Season Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.season.aggregate_cache" }
	S.tags = { "l", "season", "analyzer", "sim" }
	S.description = "Season Analysis: trend, anomaly and stability analysis of the world for the Season subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.season.analysis", window = 116, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
