-- ARKHER SYSTEM O.0187 :: Interior Audio Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0187"
	S.key = "arkher.audio.interioraudio.asset_registry"
	S.name = "Interior Audio Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.interioraudio.streaming" }
	S.tags = { "o", "interioraudio", "registry", "audio" }
	S.description = "Interior Audio Asset Registry: catalogue of sounds, variations and metadata for the Interior Audio subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.interioraudio.asset_registry" })
		inst.system = S
		inst.ctx = ctx
