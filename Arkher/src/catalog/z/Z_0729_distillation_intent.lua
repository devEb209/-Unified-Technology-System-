-- ARKHER SYSTEM Z.0729 :: Knowledge Distillation Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0729"
	S.key = "arkher.origin.distillation.intent_bridge"
	S.name = "Knowledge Distillation Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.distillation.semantic_graph" }
	S.tags = { "z", "distillation", "intent", "origin" }
	S.description = "Knowledge Distillation Intent Bridge: natural language control surface for the technology for the Knowledge Distillation subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.distillation.intent_bridge", minConfidence = 0.42 })
		inst.system = S
		inst.ctx = ctx
