-- ARKHER SYSTEM F.0337 :: Antialiasing Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0337"
	S.key = "arkher.render.antialiasing.frame_graph"
	S.name = "Antialiasing Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Antialiasing"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "antialiasing", "framegraph", "render" }
	S.description = "Antialiasing Frame Graph: declared passes, culling, ordering and aliasing for the Antialiasing subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.antialiasing.frame_graph", budgetMs = 12.00 })
		inst.system = S
		inst.ctx = ctx
