-- ARKHER SYSTEM O.0194 :: Reverb Zone Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0194"
	S.key = "arkher.audio.reverbzone.mixer_bus"
	S.name = "Reverb Zone Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Reverb Zone"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.reverbzone.dsp_chain" }
	S.tags = { "o", "reverbzone", "mixer", "audio" }
	S.description = "Reverb Zone Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Reverb Zone subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.reverbzone.mixer_bus", maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
