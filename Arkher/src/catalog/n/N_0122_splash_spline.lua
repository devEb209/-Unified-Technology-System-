-- ARKHER SYSTEM N.0122 :: Water Splash Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0122"
	S.key = "arkher.vfx.splash.curve_authoring"
	S.name = "Water Splash Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Water Splash"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.splash.ribbon_and_trail" }
	S.tags = { "n", "splash", "spline", "vfx" }
	S.description = "Water Splash Curve Authoring: authored curves driving the effect over its life for the Water Splash subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.splash.curve_authoring", tension = 0.45, closed = false })
		inst.system = S
		inst.ctx = ctx
