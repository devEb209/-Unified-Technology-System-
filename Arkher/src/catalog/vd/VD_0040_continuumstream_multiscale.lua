-- ARKHER SYSTEM VD.0040 :: Continuum Stream Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0040"
	S.key = "arkher.contsim.continuumstream.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.continuumstream.sparse_residency" }
	S.tags = { "vd", "continuumstream", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.continuumstream.multi-scale_fidelity", levels = 5, baseTriangles = 75000 })
		inst.system = S
		inst.ctx = ctx
