-- ARKHER SYSTEM P.0104 :: Inventory Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0104"
	S.key = "arkher.play.inventorysys.balance_analysis"
	S.name = "Inventory Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Inventory"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.inventorysys.event_ledger" }
	S.tags = { "p", "inventorysys", "analyzer", "play" }
	S.description = "Inventory Balance Analysis: distribution, outlier and pacing analysis for the Inventory subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.inventorysys.balance_analysis", window = 117, buckets = 9, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
