-- ARKHER SYSTEM VC.0477 :: VFX Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0477"
	S.key = "arkher.contneural.vfxcont.complexity_budget"
	S.name = "VFX Continuum Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vfxcont.world_memory_stream" }
	S.tags = { "vc", "vfxcont", "complexity", "contneural" }
	S.description = "VFX Continuum Complexity Budget: complexity budgeting for the continuum for the VFX Continuum subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.vfxcont.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
