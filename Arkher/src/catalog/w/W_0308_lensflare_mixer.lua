-- ARKHER SYSTEM W.0308 :: Lens Flare Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0308"
	S.key = "arkher.cine.lensflare.cinematic_mix"
	S.name = "Lens Flare Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Lens Flare"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.lensflare.motion_tween" }
	S.tags = { "w", "lensflare", "mixer", "cine" }
	S.description = "Lens Flare Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Lens Flare subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.lensflare.cinematic_mix", maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
