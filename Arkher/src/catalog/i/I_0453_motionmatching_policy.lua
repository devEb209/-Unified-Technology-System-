-- ARKHER SYSTEM I.0453 :: Motion Matching Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0453"
	S.key = "arkher.anim.motionmatching.quality_policy"
	S.name = "Motion Matching Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.motionmatching.pose_cache" }
	S.tags = { "i", "motionmatching", "policy", "anim" }
	S.description = "Motion Matching Quality Policy: device tier rules for rate, bones and solvers for the Motion Matching subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.motionmatching.quality_policy", algorithm = "lottery", starvationGuard = 55 })
		inst.system = S
		inst.ctx = ctx
