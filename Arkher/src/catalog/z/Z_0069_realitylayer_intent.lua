-- ARKHER SYSTEM Z.0069 :: Reality Layer Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0069"
	S.key = "arkher.origin.realitylayer.intent_bridge"
	S.name = "Reality Layer Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.semantic_graph" }
	S.tags = { "z", "realitylayer", "intent", "origin" }
	S.description = "Reality Layer Intent Bridge: natural language control surface for the technology for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.realitylayer.intent_bridge", minConfidence = 0.39 })
		inst.system = S
		inst.ctx = ctx
