-- ARKHER SYSTEM L.0156 :: Agriculture Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0156"
	S.key = "arkher.sim.agriculture.region_graph"
	S.name = "Agriculture Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.agriculture.calendar" }
	S.tags = { "l", "agriculture", "graph", "sim" }
	S.description = "Agriculture Region Graph: connectivity, components and shortest path between places for the Agriculture subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.agriculture.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
