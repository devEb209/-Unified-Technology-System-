-- ARKHER SYSTEM H.0137 :: Torque Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0137"
	S.key = "arkher.physics.torque.result_cache"
	S.name = "Torque Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Torque"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.torque.simulation_policy" }
	S.tags = { "h", "torque", "cache", "physics" }
	S.description = "Torque Result Cache: reuse of expensive simulation and query results for the Torque subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.torque.result_cache", policy = "ttl", capacity = 502, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
