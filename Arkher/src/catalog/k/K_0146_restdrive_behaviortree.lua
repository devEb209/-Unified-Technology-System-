-- ARKHER SYSTEM K.0146 :: Rest Drive Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0146"
	S.key = "arkher.npc.restdrive.reactive_behaviour"
	S.name = "Rest Drive Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.restdrive.perception" }
	S.tags = { "k", "restdrive", "behaviortree", "npc" }
	S.description = "Rest Drive Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Rest Drive subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.restdrive.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
