-- ARKHER SYSTEM J.0136 :: Blinking Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0136"
	S.key = "arkher.character.blinking.look_and_reach"
	S.name = "Blinking Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.blinking.blend_controller" }
	S.tags = { "j", "blinking", "ik", "character" }
	S.description = "Blinking Look And Reach: look-at, reach and foot placement for the character for the Blinking subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.blinking.look_and_reach", iterations = 8, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
