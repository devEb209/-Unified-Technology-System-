-- ARKHER SYSTEM K.0396 :: Plan Execution Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0396"
	S.key = "arkher.npc.planexecution.emotion"
	S.name = "Plan Execution Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.planexecution.drive_system" }
	S.tags = { "k", "planexecution", "emotion", "npc" }
	S.description = "Plan Execution Emotion: appraisal of events into valence, arousal and mood for the Plan Execution subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.planexecution.emotion", inertia = 0.91, decayRate = 0.26, baselineArousal = 0.26 })
		inst.system = S
		inst.ctx = ctx
