-- ARKHER SYSTEM E.0054 :: Roughness Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0054"
	S.key = "arkher.material.roughness.compression_codec"
	S.name = "Roughness Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Roughness"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.roughness.streaming" }
	S.tags = { "e", "roughness", "codec", "material" }
	S.description = "Roughness Compression Codec: serialization and compression of material data for the Roughness subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.roughness.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
