-- ARKHER SYSTEM E.0278 :: Decal Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0278"
	S.key = "arkher.material.decal.streaming"
	S.name = "Decal Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Decal"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.decal.parameter_budget" }
	S.tags = { "e", "decal", "streamer", "material" }
	S.description = "Decal Streaming: residency and demand-driven texture streaming for the Decal subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.decal.streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
