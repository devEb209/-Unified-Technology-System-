-- ARKHER SYSTEM VA.0258 :: Road Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0258"
	S.key = "arkher.contworld.roadcont.coherence_guard"
	S.name = "Road Continuum Coherence Guard"
	S.category = "VA"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.roadcont.persistent_state" }
	S.tags = { "va", "roadcont", "coherence", "contworld" }
	S.description = "Road Continuum Coherence Guard: seam coherence and drift supervision for the Road Continuum subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.roadcont.coherence_guard", window = 78, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
