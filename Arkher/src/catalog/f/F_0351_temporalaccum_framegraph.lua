-- ARKHER SYSTEM F.0351 :: Temporal Accumulation Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0351"
	S.key = "arkher.render.temporalaccum.frame_graph"
	S.name = "Temporal Accumulation Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "temporalaccum", "framegraph", "render" }
	S.description = "Temporal Accumulation Frame Graph: declared passes, culling, ordering and aliasing for the Temporal Accumulation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.temporalaccum.frame_graph", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
