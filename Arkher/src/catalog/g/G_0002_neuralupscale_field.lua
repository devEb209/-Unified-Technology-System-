-- ARKHER SYSTEM G.0002 :: Neural Upscaling Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0002"
	S.key = "arkher.neural.neuralupscale.feature_extraction"
	S.name = "Neural Upscaling Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuralupscale.inference_core" }
	S.tags = { "g", "neuralupscale", "field", "neural" }
	S.description = "Neural Upscaling Feature Extraction: signal features feeding the model for the Neural Upscaling subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.neuralupscale.feature_extraction", seed = 24010, frequency = 0.0065, octaves = 5, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
