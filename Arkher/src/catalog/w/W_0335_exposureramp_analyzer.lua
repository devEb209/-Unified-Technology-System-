-- ARKHER SYSTEM W.0335 :: Exposure Ramp Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0335"
	S.key = "arkher.cine.exposureramp.sequence_analysis"
	S.name = "Exposure Ramp Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.exposureramp.frame_budget" }
	S.tags = { "w", "exposureramp", "analyzer", "cine" }
	S.description = "Exposure Ramp Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Exposure Ramp subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.exposureramp.sequence_analysis", window = 49, buckets = 13, threshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
