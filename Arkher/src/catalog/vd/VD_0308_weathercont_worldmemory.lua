-- ARKHER SYSTEM VD.0308 :: Weather Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0308"
	S.key = "arkher.contsim.weathercont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.weathercont.neural_field" }
	S.tags = { "vd", "weathercont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.weathercont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
