-- ARKHER SYSTEM VA.0627 :: Interest Field Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0627"
	S.key = "arkher.contworld.interestfield.sparse_residency"
	S.name = "Interest Field Sparse Residency"
	S.category = "VA"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.interestfield.epoch_clock" }
	S.tags = { "va", "interestfield", "sparse", "contworld" }
	S.description = "Interest Field Sparse Residency: sparse page residency with eviction and compression for the Interest Field subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.interestfield.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
