-- ARKHER SYSTEM O.0366 :: Magic Audio Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0366"
	S.key = "arkher.audio.magicaudio.streaming"
	S.name = "Magic Audio Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Magic Audio"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.magicaudio.voice_budget" }
	S.tags = { "o", "magicaudio", "streamer", "audio" }
	S.description = "Magic Audio Streaming: distance-driven residency of audio assets for the Magic Audio subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.magicaudio.streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
