-- ARKHER SYSTEM L.0389 :: Caravan Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0389"
	S.key = "arkher.sim.caravan.forecast"
	S.name = "Caravan Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.caravan.analysis" }
	S.tags = { "l", "caravan", "predictor", "sim" }
	S.description = "Caravan Forecast: prediction of the region's next state for the Caravan subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.caravan.forecast", method = "markov", alpha = 0.30, window = 100 })
		inst.system = S
		inst.ctx = ctx
