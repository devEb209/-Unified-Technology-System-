-- ARKHER SYSTEM VD.0513 :: Material Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0513"
	S.key = "arkher.contsim.materialcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.materialcont.world_memory_stream" }
	S.tags = { "vd", "materialcont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.materialcont.complexity_budget", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
