-- ARKHER SYSTEM T.0355 :: Documentation Writer World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0355"
	S.key = "arkher.ai.documentationwriter.world_architect"
	S.name = "Documentation Writer World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.documentationwriter.self_critique" }
	S.tags = { "t", "documentationwriter", "architect", "ai" }
	S.description = "Documentation Writer World Architect: composition of a whole world plan with conserved budgets for the Documentation Writer subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.documentationwriter.world_architect", budget = 1300, seed = 40697 })
		inst.system = S
		inst.ctx = ctx
