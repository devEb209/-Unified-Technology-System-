-- ARKHER SYSTEM L.0016 :: Region Fidelity Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0016"
	S.key = "arkher.sim.regionfidelity.simulation_core"
	S.name = "Region Fidelity Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "regionfidelity", "simulation", "sim" }
	S.description = "Region Fidelity Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Region Fidelity subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.regionfidelity.simulation_core", fullRadius = 320, reducedRadius = 900, budget = 43 })
		inst.system = S
		inst.ctx = ctx
