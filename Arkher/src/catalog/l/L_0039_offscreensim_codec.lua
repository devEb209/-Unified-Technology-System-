-- ARKHER SYSTEM L.0039 :: Offscreen Simulation State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0039"
	S.key = "arkher.sim.offscreensim.state_codec"
	S.name = "Offscreen Simulation State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.offscreensim.history_ledger" }
	S.tags = { "l", "offscreensim", "codec", "sim" }
	S.description = "Offscreen Simulation State Codec: persistence, diffing and checksum of the world state for the Offscreen Simulation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.offscreensim.state_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
