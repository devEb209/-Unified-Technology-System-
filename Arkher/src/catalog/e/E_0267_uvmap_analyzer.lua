-- ARKHER SYSTEM E.0267 :: UV Mapping Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0267"
	S.key = "arkher.material.uvmap.analysis"
	S.name = "UV Mapping Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "UV Mapping"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.uvmap.instance_cache" }
	S.tags = { "e", "uvmap", "analyzer", "material" }
	S.description = "UV Mapping Analysis: cost, redundancy and outlier analysis for the UV Mapping subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.uvmap.analysis", window = 50, buckets = 14, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
