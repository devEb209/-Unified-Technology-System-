-- ARKHER SYSTEM N.0439 :: Cloth Wind Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0439"
	S.key = "arkher.vfx.clothwind.quality_policy"
	S.name = "Cloth Wind Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloth Wind"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.clothwind.result_cache" }
	S.tags = { "n", "clothwind", "policy", "vfx" }
	S.description = "Cloth Wind Quality Policy: distance and device driven fidelity bands for the Cloth Wind subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.clothwind.quality_policy", algorithm = "roundrobin", starvationGuard = 32 })
		inst.system = S
		inst.ctx = ctx
