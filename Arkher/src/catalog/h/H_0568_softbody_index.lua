-- ARKHER SYSTEM H.0568 :: Soft Body Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0568"
	S.key = "arkher.physics.softbody.broadphase_index"
	S.name = "Soft Body Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Soft Body"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.softbody.vehicle" }
	S.tags = { "h", "softbody", "index", "physics" }
	S.description = "Soft Body Broadphase Index: spatial acceleration of candidate pair finding for the Soft Body subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.softbody.broadphase_index", mode = "hash", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
