-- ARKHER SYSTEM W.0311 :: Lens Flare Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0311"
	S.key = "arkher.cine.lensflare.sequence_analysis"
	S.name = "Lens Flare Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Lens Flare"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.lensflare.frame_budget" }
	S.tags = { "w", "lensflare", "analyzer", "cine" }
	S.description = "Lens Flare Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Lens Flare subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.lensflare.sequence_analysis", window = 95, buckets = 15, threshold = 2.70 })
		inst.system = S
		inst.ctx = ctx
