-- ARKHER SYSTEM K.0091 :: Working Memory Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0091"
	S.key = "arkher.npc.workingmemory.utility_reasoning"
	S.name = "Working Memory Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workingmemory.reactive_behaviour" }
	S.tags = { "k", "workingmemory", "utility", "npc" }
	S.description = "Working Memory Utility Reasoning: scored option selection with response curves for the Working Memory subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.workingmemory.utility_reasoning", momentum = 0.08 })
		inst.system = S
		inst.ctx = ctx
