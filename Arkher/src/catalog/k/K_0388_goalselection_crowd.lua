-- ARKHER SYSTEM K.0388 :: Goal Selection Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0388"
	S.key = "arkher.npc.goalselection.crowd_steering"
	S.name = "Goal Selection Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.goalselection.navigation" }
	S.tags = { "k", "goalselection", "crowd", "npc" }
	S.description = "Goal Selection Crowd Steering: local avoidance, cohesion and arrival at scale for the Goal Selection subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.goalselection.crowd_steering", radius = 0.80, maxSpeed = 3.80, cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
