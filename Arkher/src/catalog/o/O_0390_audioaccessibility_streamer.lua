-- ARKHER SYSTEM O.0390 :: Accessibility Audio Streaming
-- Category O - AUDIO
-- ARKHER Audio Framework capability: buses, DSP, spatialization and music that reacts to the world.
-- Kit: streamer (distance-driven residency of audio assets)
--@arkher-module
return function(A)
	...
	local S = {}
	S.id = "O.0390"
	S.key = "arkher.audio.audioaccessibility.streaming"
	S.name = "Accessibility Audio Streaming"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audioaccessibility.voice_budget" }
	S.tags = { "o", "audioaccessibility", "streamer", "audio" }
	S.description = "Accessibility Audio Streaming: distance-driven residency of audio assets for the Accessibility Audio subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.audioaccessibility.streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
