-- ARKHER SYSTEM G.0279 :: Quality Estimation Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0279"
	S.key = "arkher.neural.qualityestimate.sampling_graph"
	S.name = "Quality Estimation Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.qualityestimate.training_ledger" }
	S.tags = { "g", "qualityestimate", "graph", "neural" }
	S.description = "Quality Estimation Sampling Graph: dependency graph of sampling stages for the Quality Estimation subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.qualityestimate.sampling_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
