-- ARKHER SYSTEM VA.0045 :: Continuum Stream Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0045"
	S.key = "arkher.contworld.continuumstream.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.continuumstream.world_memory_stream" }
	S.tags = { "va", "continuumstream", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.continuumstream.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
