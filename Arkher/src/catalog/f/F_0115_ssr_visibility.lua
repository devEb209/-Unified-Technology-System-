-- ARKHER SYSTEM F.0115 :: Screen Space Reflection Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0115"
	S.key = "arkher.render.ssr.visibility_set"
	S.name = "Screen Space Reflection Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.ssr.view_and_culling" }
	S.tags = { "f", "ssr", "visibility", "render" }
	S.description = "Screen Space Reflection Visibility Set: cell, portal and occluder visibility for the Screen Space Reflection subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.ssr.visibility_set", maxDepth = 2 })
		inst.system = S
		inst.ctx = ctx
