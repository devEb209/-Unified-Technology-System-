-- ARKHER SYSTEM K.0292 :: Scent Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0292"
	S.key = "arkher.npc.scent.daily_schedule"
	S.name = "Scent Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.scent.social_relations" }
	S.tags = { "k", "scent", "schedule", "npc" }
	S.description = "Scent Daily Schedule: hour-by-hour routine with priority interruptions for the Scent subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.scent.daily_schedule", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
