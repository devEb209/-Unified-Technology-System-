-- ARKHER SYSTEM P.0089 :: Level Up State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0089"
	S.key = "arkher.play.levelup.state_machine"
	S.name = "Level Up State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Level Up"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.levelup.combat_resolution" }
	S.tags = { "p", "levelup", "orchestrator", "play" }
	S.description = "Level Up State Machine: the phase machine that drives this gameplay loop for the Level Up subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.levelup.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
