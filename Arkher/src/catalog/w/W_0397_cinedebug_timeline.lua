-- ARKHER SYSTEM W.0397 :: Cinematic Debug Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0397"
	S.key = "arkher.cine.cinedebug.sequence_timeline"
	S.name = "Cinematic Debug Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "cinedebug", "timeline", "cine" }
	S.description = "Cinematic Debug Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Cinematic Debug subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.cinedebug.sequence_timeline", duration = 10.0, rate = 1.10 })
		inst.system = S
		inst.ctx = ctx
