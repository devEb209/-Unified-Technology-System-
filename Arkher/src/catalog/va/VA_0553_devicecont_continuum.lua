-- ARKHER SYSTEM VA.0553 :: Device Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0553"
	S.key = "arkher.contworld.devicecont.infinite_grid"
	S.name = "Device Continuum Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "devicecont", "continuum", "contworld" }
	S.description = "Device Continuum Infinite Grid: seamless paging of the infinite world grid for the Device Continuum subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.devicecont.infinite_grid", cellSize = 224, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
