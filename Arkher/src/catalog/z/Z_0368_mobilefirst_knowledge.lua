-- ARKHER SYSTEM Z.0368 :: Mobile First Governor Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0368"
	S.key = "arkher.origin.mobilefirst.semantic_graph"
	S.name = "Mobile First Governor Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.world_architect" }
	S.tags = { "z", "mobilefirst", "knowledge", "origin" }
	S.description = "Mobile First Governor Semantic Graph: typed entities and inferred relations of the technology itself for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.mobilefirst.semantic_graph", dims = 24 })
		inst.system = S
		inst.ctx = ctx
