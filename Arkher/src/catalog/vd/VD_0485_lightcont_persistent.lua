-- ARKHER SYSTEM VD.0485 :: Lighting Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0485"
	S.key = "arkher.contsim.lightcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lightcont.multi-scale_fidelity" }
	S.tags = { "vd", "lightcont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.lightcont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
