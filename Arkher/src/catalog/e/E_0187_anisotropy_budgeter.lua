-- ARKHER SYSTEM E.0187 :: Anisotropy Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0187"
	S.key = "arkher.material.anisotropy.parameter_budget"
	S.name = "Anisotropy Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Anisotropy"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.anisotropy.variant_registry" }
	S.tags = { "e", "anisotropy", "budgeter", "material" }
	S.description = "Anisotropy Parameter Budget: texel and layer budget allocation for the Anisotropy subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.anisotropy.parameter_budget", total = 435, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
