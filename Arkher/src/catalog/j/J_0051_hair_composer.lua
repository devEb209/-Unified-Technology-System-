-- ARKHER SYSTEM J.0051 :: Hair Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0051"
	S.key = "arkher.character.hair.appearance_composer"
	S.name = "Hair Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.hair.locomotion" }
	S.tags = { "j", "hair", "composer", "character" }
	S.description = "Hair Appearance Composer: composition of appearance slots into a look for the Hair subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.hair.appearance_composer", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
	...
	function inst.dominantLayer()
		...
		function inst.integrate(engine)
			...
			inst.engine = engine
			if engine.bus then
				engine.bus:subscribe("arkher.character.hair.*", function(payload) inst.lastSignal = payload end)
			end
