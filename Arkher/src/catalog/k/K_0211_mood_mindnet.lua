-- ARKHER SYSTEM K.0211 :: Mood Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0211"
	S.key = "arkher.npc.mood.mind_network"
	S.name = "Mood Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "mood", "mindnet", "npc" }
	S.description = "Mood Mind Network: the learned policy that turns perception into a decision for the Mood subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.mood.mind_network", inputs = 6, hidden = 4, seed = 79540, learningRate = 0.050, exploration = 0.040 })
		inst.system = S
		inst.ctx = ctx
