-- ARKHER SYSTEM H.0143 :: Linear Damping Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0143"
	S.key = "arkher.physics.lineardamping.contact_generation"
	S.name = "Linear Damping Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.lineardamping.collision_shape" }
	S.tags = { "h", "lineardamping", "contact", "physics" }
	S.description = "Linear Damping Contact Generation: narrow-phase manifolds with normal, depth and point for the Linear Damping subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.lineardamping.contact_generation", slop = 0.0050, maxManifolds = 153 })
		inst.system = S
		inst.ctx = ctx
