-- ARKHER SYSTEM E.0229 :: Layer Blending Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0229"
	S.key = "arkher.material.layerblend.texture_sampling"
	S.name = "Layer Blending Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.layerblend.shading_graph" }
	S.tags = { "e", "layerblend", "sampler", "material" }
	S.description = "Layer Blending Texture Sampling: atlas packing, mip chain and filtered sampling for the Layer Blending subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.layerblend.texture_sampling", atlasSize = 128, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
