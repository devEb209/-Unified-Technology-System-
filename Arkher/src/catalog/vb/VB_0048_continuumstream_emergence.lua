-- ARKHER SYSTEM VB.0048 :: Continuum Stream Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0048"
	S.key = "arkher.conttime.continuumstream.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.continuumstream.reality_continuum" }
	S.tags = { "vb", "continuumstream", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.continuumstream.emergence_continuum", windowSize = 4, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
