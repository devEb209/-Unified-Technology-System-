-- ARKHER SYSTEM E.0158 :: Subsurface Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0158"
	S.key = "arkher.material.subsurface.streaming"
	S.name = "Subsurface Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Subsurface"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.subsurface.parameter_budget" }
	S.tags = { "e", "subsurface", "streamer", "material" }
	S.description = "Subsurface Streaming: residency and demand-driven texture streaming for the Subsurface subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.subsurface.streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
