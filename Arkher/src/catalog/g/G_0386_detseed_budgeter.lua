-- ARKHER SYSTEM G.0386 :: Deterministic Seeding Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0386"
	S.key = "arkher.neural.detseed.compute_budget"
	S.name = "Deterministic Seeding Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detseed.quality_predictor" }
	S.tags = { "g", "detseed", "budgeter", "neural" }
	S.description = "Deterministic Seeding Compute Budget: inference time budget allocation for the Deterministic Seeding subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.detseed.compute_budget", total = 235, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
