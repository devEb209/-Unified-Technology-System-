-- ARKHER SYSTEM G.0130 :: Detail Synthesis Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0130"
	S.key = "arkher.neural.detailsynth.reconstruction"
	S.name = "Detail Synthesis Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detailsynth.temporal_history" }
	S.tags = { "g", "detailsynth", "upscaler", "neural" }
	S.description = "Detail Synthesis Reconstruction: resolution ladder and image reconstruction for the Detail Synthesis subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.detailsynth.reconstruction", targetMs = 13.10, index = 5, sharpness = 0.34 })
		inst.system = S
		inst.ctx = ctx
