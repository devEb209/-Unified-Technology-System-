-- ARKHER SYSTEM O.0034 :: Weapon Sound Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0034"
	S.key = "arkher.audio.weaponsound.analysis"
	S.name = "Weapon Sound Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Weapon Sound"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.weaponsound.playback_policy" }
	S.tags = { "o", "weaponsound", "analyzer", "audio" }
	S.description = "Weapon Sound Analysis: loudness, headroom and masking analysis for the Weapon Sound subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.weaponsound.analysis", window = 59, buckets = 11, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
