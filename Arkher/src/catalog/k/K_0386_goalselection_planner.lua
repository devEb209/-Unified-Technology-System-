-- ARKHER SYSTEM K.0386 :: Goal Selection Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0386"
	S.key = "arkher.npc.goalselection.goal_planner"
	S.name = "Goal Selection Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.goalselection.utility_reasoning" }
	S.tags = { "k", "goalselection", "planner", "npc" }
	S.description = "Goal Selection Goal Planner: backward GOAP planning to reach a goal state for the Goal Selection subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.goalselection.goal_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
