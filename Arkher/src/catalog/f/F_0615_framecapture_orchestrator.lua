-- ARKHER SYSTEM F.0615 :: Frame Capture Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0615"
	S.key = "arkher.render.framecapture.orchestration"
	S.name = "Frame Capture Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framecapture.frame_analysis" }
	S.tags = { "f", "framecapture", "orchestrator", "render" }
	S.description = "Frame Capture Orchestration: frame lifecycle orchestration for the Frame Capture subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.framecapture.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
