-- ARKHER SYSTEM K.0103 :: Memory Consolidation Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0103"
	S.key = "arkher.npc.consolidation.perception"
	S.name = "Memory Consolidation Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.consolidation.emotion" }
	S.tags = { "k", "consolidation", "perception", "npc" }
	S.description = "Memory Consolidation Perception: sight, hearing and bounded attention for the Memory Consolidation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.consolidation.perception", sightRange = 55, hearingRange = 20, attentionSlots = 5, fov = 1.660 })
		inst.system = S
		inst.ctx = ctx
