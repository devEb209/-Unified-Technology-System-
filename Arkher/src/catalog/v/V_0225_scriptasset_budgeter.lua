-- ARKHER SYSTEM V.0225 :: Script Asset Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0225"
	S.key = "arkher.asset.scriptasset.size_budget"
	S.name = "Script Asset Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.scriptasset.compression_codec" }
	S.tags = { "v", "scriptasset", "budgeter", "asset" }
	S.description = "Script Asset Size Budget: byte budget shared between competing asset classes for the Script Asset subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.scriptasset.size_budget", total = 89, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
