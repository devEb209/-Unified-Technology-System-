-- ARKHER SYSTEM G.0472 :: Training Data Synthesis Heuristic Policy
...
return function(A)
	...
	local S = {}
	S.id = "G.0472"
	S.key = "arkher.neural.datasynth.heuristic_policy"
	S.name = "Training Data Synthesis Heuristic Policy"
	S.category = "G"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.datasynth.result_cache" }
	S.tags = { "g", "datasynth", "policy", "neural" }
	S.description = "Training Data Synthesis Heuristic Policy: rule fallback when the model is unavailable for the Training Data Synthesis subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.neural.datasynth.heuristic_policy", algorithm = "wfq", starvationGuard = 58 })
		inst.system = S
		inst.ctx = ctx
