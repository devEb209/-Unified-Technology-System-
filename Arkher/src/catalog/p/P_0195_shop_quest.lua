-- ARKHER SYSTEM P.0195 :: Shop Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0195"
	S.key = "arkher.play.shop.objectives"
	S.name = "Shop Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Shop"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.shop.inventory" }
	S.tags = { "p", "shop", "quest", "play" }
	S.description = "Shop Objectives: objectives, prerequisites, progress and rewards for the Shop subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.shop.objectives" })
		inst.system = S
		inst.ctx = ctx
