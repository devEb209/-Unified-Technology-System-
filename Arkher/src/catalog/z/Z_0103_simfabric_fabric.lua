-- ARKHER SYSTEM Z.0103 :: Universal Simulation Fabric Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0103"
	S.key = "arkher.origin.simfabric.simulation_fabric"
	S.name = "Universal Simulation Fabric Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.simfabric.complexity_governance" }
	S.tags = { "z", "simfabric", "fabric", "origin" }
	S.description = "Universal Simulation Fabric Simulation Fabric: every simulation domain stepped under one budgeted clock for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.simfabric.simulation_fabric", budgetMs = 3.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
