-- ARKHER SYSTEM Z.0898 :: Sparse World Representation Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0898"
	S.key = "arkher.origin.sparseworld.budget_governor"
	S.name = "Sparse World Representation Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.behaviour_analysis" }
	S.tags = { "z", "sparseworld", "budgeter", "origin" }
	S.description = "Sparse World Representation Budget Governor: allocation of a scarce resource across the technology's consumers for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.sparseworld.budget_governor", total = 102, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
