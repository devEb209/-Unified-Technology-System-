-- ARKHER SYSTEM H.0412 :: Restitution Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0412"
	S.key = "arkher.physics.restitution.character_motion"
	S.name = "Restitution Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Restitution"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.restitution.query" }
	S.tags = { "h", "restitution", "charmotor", "physics" }
	S.description = "Restitution Character Motion: capsule move-and-slide with slopes, steps and jumps for the Restitution subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.restitution.character_motion", radius = 0.36, height = 1.61, maxSpeed = 4.10, jumpHeight = 1.30, stepOffset = 0.26 })
		inst.system = S
		inst.ctx = ctx
