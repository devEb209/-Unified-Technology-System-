-- ARKHER SYSTEM T.0332 :: Bug Triage Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0332"
	S.key = "arkher.ai.bugtriage.utility_selection"
	S.name = "Bug Triage Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.bugtriage.working_memory" }
	S.tags = { "t", "bugtriage", "utility", "ai" }
	S.description = "Bug Triage Utility Selection: scored choice between competing courses of action for the Bug Triage subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.bugtriage.utility_selection", momentum = 0.04 })
		inst.system = S
		inst.ctx = ctx
