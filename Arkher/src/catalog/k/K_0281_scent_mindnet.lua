-- ARKHER SYSTEM K.0281 :: Scent Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0281"
	S.key = "arkher.npc.scent.mind_network"
	S.name = "Scent Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "scent", "mindnet", "npc" }
	S.description = "Scent Mind Network: the learned policy that turns perception into a decision for the Scent subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.scent.mind_network", inputs = 9, hidden = 4, seed = 39835, learningRate = 0.075, exploration = 0.035 })
		inst.system = S
		inst.ctx = ctx
