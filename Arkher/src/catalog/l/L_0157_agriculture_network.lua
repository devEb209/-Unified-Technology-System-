-- ARKHER SYSTEM L.0157 :: Agriculture Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0157"
	S.key = "arkher.sim.agriculture.route_network"
	S.name = "Agriculture Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.agriculture.region_graph" }
	S.tags = { "l", "agriculture", "network", "sim" }
	S.description = "Agriculture Route Network: roads, rivers and routes between settlements for the Agriculture subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.agriculture.route_network" })
		inst.system = S
		inst.ctx = ctx
