-- ARKHER SYSTEM F.0481 :: Impostor Rendering Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0481"
	S.key = "arkher.render.impostorrender.lighting_rig"
	S.name = "Impostor Rendering Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.impostorrender.geometry_virtualization" }
	S.tags = { "f", "impostorrender", "lightrig", "render" }
	S.description = "Impostor Rendering Lighting Rig: light clustering, importance and cascades for the Impostor Rendering subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.impostorrender.lighting_rig", maxActive = 11 })
		inst.system = S
		inst.ctx = ctx
