-- ARKHER SYSTEM H.0431 :: Friction Model Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0431"
	S.key = "arkher.physics.friction.result_cache"
	S.name = "Friction Model Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.friction.simulation_policy" }
	S.tags = { "h", "friction", "cache", "physics" }
	S.description = "Friction Model Result Cache: reuse of expensive simulation and query results for the Friction Model subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.friction.result_cache", policy = "lru", capacity = 198, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
