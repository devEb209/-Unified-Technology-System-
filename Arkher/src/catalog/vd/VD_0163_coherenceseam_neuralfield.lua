-- ARKHER SYSTEM VD.0163 :: Coherence Seam Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0163"
	S.key = "arkher.contsim.coherenceseam.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.coherenceseam.coherence_guard" }
	S.tags = { "vd", "coherenceseam", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.coherenceseam.neural_field", dims = 24, hidden = 20, seed = 15859 })
		inst.system = S
		inst.ctx = ctx
