-- ARKHER SYSTEM VB.0259 :: Road Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0259"
	S.key = "arkher.conttime.roadcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.roadcont.coherence_guard" }
	S.tags = { "vb", "roadcont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.roadcont.neural_field", dims = 20, hidden = 16, seed = 55478 })
		inst.system = S
		inst.ctx = ctx
