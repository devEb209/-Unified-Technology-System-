-- ARKHER SYSTEM K.0167 :: Safety Drive Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0167"
	S.key = "arkher.npc.safetydrive.thinking_budget"
	S.name = "Safety Drive Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.safetydrive.daily_schedule" }
	S.tags = { "k", "safetydrive", "budgeter", "npc" }
	S.description = "Safety Drive Thinking Budget: allocation of per-frame thinking time across NPCs for the Safety Drive subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.safetydrive.thinking_budget", total = 381, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
