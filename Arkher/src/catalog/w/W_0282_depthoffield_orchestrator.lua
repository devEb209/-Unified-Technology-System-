-- ARKHER SYSTEM W.0282 :: Depth Of Field Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0282"
	S.key = "arkher.cine.depthoffield.playback_orchestrator"
	S.name = "Depth Of Field Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.depthoffield.cut_policy" }
	S.tags = { "w", "depthoffield", "orchestrator", "cine" }
	S.description = "Depth Of Field Playback Orchestrator: the state machine that drives a cinematic from start to end for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.depthoffield.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
