-- ARKHER SYSTEM VB.0217 :: Terrain Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0217"
	S.key = "arkher.conttime.terraincont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "terraincont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.terraincont.infinite_grid", cellSize = 128, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
