-- ARKHER SYSTEM VB.0544 :: World Fabric Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0544"
	S.key = "arkher.conttime.worldfabric.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldfabric.sparse_residency" }
	S.tags = { "vb", "worldfabric", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.worldfabric.multi-scale_fidelity", levels = 5, baseTriangles = 90000 })
		inst.system = S
		inst.ctx = ctx
