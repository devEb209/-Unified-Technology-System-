-- ARKHER SYSTEM I.0211 :: Transition Rule Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0211"
	S.key = "arkher.anim.transitionrule.layered_blending"
	S.name = "Transition Rule Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.transitionrule.clip_sampling" }
	S.tags = { "i", "transitionrule", "animator", "anim" }
	S.description = "Transition Rule Layered Blending: layers, crossfades, masks and blend trees for the Transition Rule subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.transitionrule.layered_blending", budget = 10 })
		inst.system = S
		inst.ctx = ctx
