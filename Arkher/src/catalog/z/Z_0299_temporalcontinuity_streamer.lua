-- ARKHER SYSTEM Z.0299 :: Temporal Continuity Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0299"
	S.key = "arkher.origin.temporalcontinuity.residency_streaming"
	S.name = "Temporal Continuity Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.temporalcontinuity.budget_governor" }
	S.tags = { "z", "temporalcontinuity", "streamer", "origin" }
	S.description = "Temporal Continuity Residency Streaming: distance-driven residency of the technology's workload for the Temporal Continuity subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.temporalcontinuity.residency_streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
