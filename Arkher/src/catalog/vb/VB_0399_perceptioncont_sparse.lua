-- ARKHER SYSTEM VB.0399 :: Perception Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0399"
	S.key = "arkher.conttime.perceptioncont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.perceptioncont.epoch_clock" }
	S.tags = { "vb", "perceptioncont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.perceptioncont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
