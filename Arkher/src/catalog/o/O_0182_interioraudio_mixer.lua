-- ARKHER SYSTEM O.0182 :: Interior Audio Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0182"
	S.key = "arkher.audio.interioraudio.mixer_bus"
	S.name = "Interior Audio Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.interioraudio.dsp_chain" }
	S.tags = { "o", "interioraudio", "mixer", "audio" }
	S.description = "Interior Audio Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Interior Audio subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.interioraudio.mixer_bus", maxVoices = 48 })
		inst.system = S
		inst.ctx = ctx
