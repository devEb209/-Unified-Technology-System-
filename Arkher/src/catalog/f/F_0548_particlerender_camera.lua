-- ARKHER SYSTEM F.0548 :: Particle Rendering View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0548"
	S.key = "arkher.render.particlerender.view_and_culling"
	S.name = "Particle Rendering View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.particlerender.frame_graph" }
	S.tags = { "f", "particlerender", "camera", "render" }
	S.description = "Particle Rendering View And Culling: view state, frustum culling and screen-size LOD for the Particle Rendering subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.particlerender.view_and_culling", width = 1340, height = 900, fov = 1.1900, far = 2200 })
		inst.system = S
		inst.ctx = ctx
