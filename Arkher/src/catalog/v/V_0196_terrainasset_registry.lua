-- ARKHER SYSTEM V.0196 :: Terrain Asset Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0196"
	S.key = "arkher.asset.terrainasset.asset_registry"
	S.name = "Terrain Asset Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.terrainasset.cook_pipeline" }
	S.tags = { "v", "terrainasset", "registry", "asset" }
	S.description = "Terrain Asset Asset Registry: catalogue of every asset, its tags and its metadata for the Terrain Asset subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.terrainasset.asset_registry" })
		inst.system = S
		inst.ctx = ctx
