-- ARKHER SYSTEM O.0145 :: Water Audio DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0145"
	S.key = "arkher.audio.wateraudio.dsp_chain"
	S.name = "Water Audio DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Water Audio"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "wateraudio", "dsp", "audio" }
	S.description = "Water Audio DSP Chain: biquad filtering, delay, envelope and soft clipping for the Water Audio subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.wateraudio.dsp_chain", sampleRate = 22050, filter = "notch", cutoff = 6000, q = 0.890 })
		inst.system = S
		inst.ctx = ctx
