-- ARKHER SYSTEM K.0360 :: Behaviour State Machine Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0360"
	S.key = "arkher.npc.behaviourstate.crowd_steering"
	S.name = "Behaviour State Machine Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourstate.navigation" }
	S.tags = { "k", "behaviourstate", "crowd", "npc" }
	S.description = "Behaviour State Machine Crowd Steering: local avoidance, cohesion and arrival at scale for the Behaviour State Machine subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.behaviourstate.crowd_steering", radius = 0.70, maxSpeed = 5.60, cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
