-- ARKHER SYSTEM VA.0117 :: Temporal Slice Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0117"
	S.key = "arkher.contworld.temporalslice.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.temporalslice.world_memory_stream" }
	S.tags = { "va", "temporalslice", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.temporalslice.complexity_budget", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
