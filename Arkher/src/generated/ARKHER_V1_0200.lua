...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Sketchfab — CORE Stack #0200", size=Vector2.new(680, 420), pos=UDim2.fromOffset(300, 100), parent=parent, icon="⬣"})
