-- ARKHER SYSTEM W.0115 :: Orbit Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0115"
	S.key = "arkher.cine.orbit.motion_tween"
	S.name = "Orbit Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Orbit"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.orbit.playback_orchestrator" }
	S.tags = { "w", "orbit", "tween", "cine" }
	S.description = "Orbit Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Orbit subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.orbit.motion_tween", timeScale = 1.03 })
		inst.system = S
		inst.ctx = ctx
