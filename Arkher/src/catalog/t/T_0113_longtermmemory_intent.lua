-- ARKHER SYSTEM T.0113 :: Long Term Memory Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0113"
	S.key = "arkher.ai.longtermmemory.intent_understanding"
	S.name = "Long Term Memory Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "longtermmemory", "intent", "ai" }
	S.description = "Long Term Memory Intent Understanding: natural language turned into an actionable, scored intent for the Long Term Memory subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.longtermmemory.intent_understanding", minConfidence = 0.40 })
		inst.system = S
		inst.ctx = ctx
