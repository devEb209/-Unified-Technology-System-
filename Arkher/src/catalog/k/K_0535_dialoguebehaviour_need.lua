-- ARKHER SYSTEM K.0535 :: Dialogue Behaviour Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0535"
	S.key = "arkher.npc.dialoguebehaviour.drive_system"
	S.name = "Dialogue Behaviour Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dialoguebehaviour.memory" }
	S.tags = { "k", "dialoguebehaviour", "need", "npc" }
	S.description = "Dialogue Behaviour Drive System: drives that decay, turn urgent and get satisfied for the Dialogue Behaviour subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.dialoguebehaviour.drive_system" })
		inst.system = S
		inst.ctx = ctx
