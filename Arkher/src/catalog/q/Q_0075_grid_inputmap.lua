-- ARKHER SYSTEM Q.0075 :: Grid Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0075"
	S.key = "arkher.ui.grid.input_mapping"
	S.name = "Grid Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Grid"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.grid.widget_tree" }
	S.tags = { "q", "grid", "inputmap", "ui" }
	S.description = "Grid Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Grid subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.grid.input_mapping", device = "keyboard", holdTime = 0.28, deadzone = 0.18 })
		inst.system = S
		inst.ctx = ctx
