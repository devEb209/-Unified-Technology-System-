-- ARKHER SYSTEM VA.0254 :: Road Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0254"
	S.key = "arkher.contworld.roadcont.epoch_clock"
	S.name = "Road Continuum Epoch Clock"
	S.category = "VA"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.roadcont.infinite_grid" }
	S.tags = { "va", "roadcont", "epoch", "contworld" }
	S.description = "Road Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Road Continuum subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.roadcont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
