-- ARKHER SYSTEM VA.0128 :: Spatial Slice World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0128"
	S.key = "arkher.contworld.spatialslice.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.spatialslice.neural_field" }
	S.tags = { "va", "spatialslice", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.spatialslice.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
