-- ARKHER SYSTEM E.0012 :: Material Library Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0012"
	S.key = "arkher.material.library.analysis"
	S.name = "Material Library Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.library.instance_cache" }
	S.tags = { "e", "library", "analyzer", "material" }
	S.description = "Material Library Analysis: cost, redundancy and outlier analysis for the Material Library subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.library.analysis", window = 158, buckets = 14, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
