-- ARKHER SYSTEM P.0414 :: Team Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0414"
	S.key = "arkher.play.team.rule_pipeline"
	S.name = "Team Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Team"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.team.state_machine" }
	S.tags = { "p", "team", "pipeline", "play" }
	S.description = "Team Rule Pipeline: ordered rules applied to every gameplay event for the Team subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.team.rule_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
