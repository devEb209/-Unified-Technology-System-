-- ARKHER SYSTEM F.0215 :: Cloud Rendering Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0215"
	S.key = "arkher.render.clouds.lighting_rig"
	S.name = "Cloud Rendering Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.clouds.geometry_virtualization" }
	S.tags = { "f", "clouds", "lightrig", "render" }
	S.description = "Cloud Rendering Lighting Rig: light clustering, importance and cascades for the Cloud Rendering subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.clouds.lighting_rig", maxActive = 4 })
		inst.system = S
		inst.ctx = ctx
