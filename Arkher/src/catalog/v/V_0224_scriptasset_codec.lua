-- ARKHER SYSTEM V.0224 :: Script Asset Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0224"
	S.key = "arkher.asset.scriptasset.compression_codec"
	S.name = "Script Asset Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.scriptasset.streaming_residency" }
	S.tags = { "v", "scriptasset", "codec", "asset" }
	S.description = "Script Asset Compression Codec: compact encoding, diffing and checksum of asset payloads for the Script Asset subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.scriptasset.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
