-- ARKHER SYSTEM T.0044 :: Goal Reasoning Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0044"
	S.key = "arkher.ai.goalreasoning.semantic_knowledge"
	S.name = "Goal Reasoning Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.goalreasoning.intent_understanding" }
	S.tags = { "t", "goalreasoning", "knowledge", "ai" }
	S.description = "Goal Reasoning Semantic Knowledge: typed entities, weighted relations and inferred closure for the Goal Reasoning subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.goalreasoning.semantic_knowledge", dims = 32 })
		inst.system = S
		inst.ctx = ctx
