-- ARKHER SYSTEM T.0019 :: Prompt Understanding World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0019"
	S.key = "arkher.ai.prompt.world_architect"
	S.name = "Prompt Understanding World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.prompt.self_critique" }
	S.tags = { "t", "prompt", "architect", "ai" }
	S.description = "Prompt Understanding World Architect: composition of a whole world plan with conserved budgets for the Prompt Understanding subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.prompt.world_architect", budget = 1100, seed = 41815 })
		inst.system = S
		inst.ctx = ctx
