-- ARKHER SYSTEM G.0219 :: Reflection Prediction Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0219"
	S.key = "arkher.neural.reflectpredict.result_cache"
	S.name = "Reflection Prediction Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.reflectpredict.compute_budget" }
	S.tags = { "g", "reflectpredict", "cache", "neural" }
	S.description = "Reflection Prediction Result Cache: cached inference results keyed by input for the Reflection Prediction subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.reflectpredict.result_cache", policy = "ttl", capacity = 220, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
