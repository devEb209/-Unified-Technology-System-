-- ARKHER SYSTEM T.0001 :: Intent Parsing Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0001"
	S.key = "arkher.ai.intentparsing.intent_understanding"
	S.name = "Intent Parsing Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "intentparsing", "intent", "ai" }
	S.description = "Intent Parsing Intent Understanding: natural language turned into an actionable, scored intent for the Intent Parsing subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.intentparsing.intent_understanding", minConfidence = 0.38 })
		inst.system = S
		inst.ctx = ctx
