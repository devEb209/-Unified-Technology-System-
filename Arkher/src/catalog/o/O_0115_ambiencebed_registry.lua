-- ARKHER SYSTEM O.0115 :: Ambience Bed Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0115"
	S.key = "arkher.audio.ambiencebed.asset_registry"
	S.name = "Ambience Bed Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Ambience Bed"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.ambiencebed.streaming" }
	S.tags = { "o", "ambiencebed", "registry", "audio" }
	S.description = "Ambience Bed Asset Registry: catalogue of sounds, variations and metadata for the Ambience Bed subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.ambiencebed.asset_registry" })
		inst.system = S
		inst.ctx = ctx
