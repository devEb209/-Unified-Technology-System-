-- ARKHER SYSTEM W.0053 :: Close Up Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0053"
	S.key = "arkher.cine.closeup.cut_policy"
	S.name = "Close Up Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Close Up"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.closeup.shot_composition" }
	S.tags = { "w", "closeup", "policy", "cine" }
	S.description = "Close Up Cut Policy: rules deciding when the sequence cuts and to what for the Close Up subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.closeup.cut_policy", algorithm = "lottery", starvationGuard = 35 })
		inst.system = S
		inst.ctx = ctx
