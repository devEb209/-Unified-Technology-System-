-- ARKHER SYSTEM T.0203 :: City Generation Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0203"
	S.key = "arkher.ai.citygeneration.decision_policy"
	S.name = "City Generation Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.citygeneration.reasoning_graph" }
	S.tags = { "t", "citygeneration", "policy", "ai" }
	S.description = "City Generation Decision Policy: ordered rules deciding what the agent does next for the City Generation subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.citygeneration.decision_policy", algorithm = "wfq", starvationGuard = 26 })
		inst.system = S
		inst.ctx = ctx
