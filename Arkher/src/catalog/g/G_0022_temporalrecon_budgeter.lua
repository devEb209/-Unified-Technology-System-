-- ARKHER SYSTEM G.0022 :: Temporal Reconstruction Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0022"
	S.key = "arkher.neural.temporalrecon.compute_budget"
	S.name = "Temporal Reconstruction Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.temporalrecon.quality_predictor" }
	S.tags = { "g", "temporalrecon", "budgeter", "neural" }
	S.description = "Temporal Reconstruction Compute Budget: inference time budget allocation for the Temporal Reconstruction subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.temporalrecon.compute_budget", total = 215, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
