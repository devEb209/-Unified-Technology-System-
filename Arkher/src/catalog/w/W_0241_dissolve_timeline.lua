-- ARKHER SYSTEM W.0241 :: Dissolve Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0241"
	S.key = "arkher.cine.dissolve.sequence_timeline"
	S.name = "Dissolve Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dissolve"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "dissolve", "timeline", "cine" }
	S.description = "Dissolve Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Dissolve subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.dissolve.sequence_timeline", duration = 4.0, rate = 0.96 })
		inst.system = S
		inst.ctx = ctx
