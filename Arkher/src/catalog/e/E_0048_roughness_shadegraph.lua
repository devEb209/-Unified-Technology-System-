-- ARKHER SYSTEM E.0048 :: Roughness Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0048"
	S.key = "arkher.material.roughness.shading_graph"
	S.name = "Roughness Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Roughness"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.roughness.layer_composition" }
	S.tags = { "e", "roughness", "shadegraph", "material" }
	S.description = "Roughness Shading Graph: node graph evaluated and compiled to Luau for the Roughness subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.roughness.shading_graph" })
		inst.system = S
		inst.ctx = ctx
