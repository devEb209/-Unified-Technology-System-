-- ARKHER SYSTEM H.0088 :: Gravity Field Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0088"
	S.key = "arkher.physics.gravityfield.constraint_solver"
	S.name = "Gravity Field Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.gravityfield.contact_generation" }
	S.tags = { "h", "gravityfield", "constraint", "physics" }
	S.description = "Gravity Field Constraint Solver: sequential impulses, friction, joints and warm starting for the Gravity Field subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.gravityfield.constraint_solver", iterations = 13, baumgarte = 0.19, warmStart = true })
		inst.system = S
		inst.ctx = ctx
