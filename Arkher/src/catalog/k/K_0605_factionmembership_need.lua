-- ARKHER SYSTEM K.0605 :: Faction Membership Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0605"
	S.key = "arkher.npc.factionmembership.drive_system"
	S.name = "Faction Membership Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.factionmembership.memory" }
	S.tags = { "k", "factionmembership", "need", "npc" }
	S.description = "Faction Membership Drive System: drives that decay, turn urgent and get satisfied for the Faction Membership subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.factionmembership.drive_system" })
		inst.system = S
		inst.ctx = ctx
