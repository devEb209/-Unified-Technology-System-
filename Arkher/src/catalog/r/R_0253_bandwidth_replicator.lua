-- ARKHER SYSTEM R.0253 :: Bandwidth Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0253"
	S.key = "arkher.net.bandwidth.replication"
	S.name = "Bandwidth Replication"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Bandwidth"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "bandwidth", "replicator", "net" }
	S.description = "Bandwidth Replication: authoritative entity state, interest and delta snapshots for the Bandwidth subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.bandwidth.replication", mtu = 600, interestRadius = 200, fullEvery = 60 })
		inst.system = S
		inst.ctx = ctx
