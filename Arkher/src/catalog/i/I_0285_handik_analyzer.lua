-- ARKHER SYSTEM I.0285 :: Hand Placement IK Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0285"
	S.key = "arkher.anim.handik.analysis"
	S.name = "Hand Placement IK Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.handik.quality_policy" }
	S.tags = { "i", "handik", "analyzer", "anim" }
	S.description = "Hand Placement IK Analysis: pop, drift and cost analysis of playback for the Hand Placement IK subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.handik.analysis", window = 222, buckets = 18, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
