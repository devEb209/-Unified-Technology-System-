...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="PolyHaven CC0 — CORE Mixer #0252", size=Vector2.new(600, 460), pos=UDim2.fromOffset(176, 204), parent=parent, icon="⬔"})
