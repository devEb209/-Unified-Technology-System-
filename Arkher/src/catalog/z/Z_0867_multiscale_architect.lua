-- ARKHER SYSTEM Z.0867 :: Multi Scale Simulation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0867"
	S.key = "arkher.origin.multiscale.world_architect"
	S.name = "Multi Scale Simulation World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.emergence_detection" }
	S.tags = { "z", "multiscale", "architect", "origin" }
	S.description = "Multi Scale Simulation World Architect: hierarchical world composition with conserved budgets for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.multiscale.world_architect", budget = 1200, seed = 94516 })
		inst.system = S
		inst.ctx = ctx
