-- ARKHER SYSTEM VD.0410 :: Behaviour Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0410"
	S.key = "arkher.contsim.behaviourcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.behaviourcont.infinite_grid" }
	S.tags = { "vd", "behaviourcont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.behaviourcont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
