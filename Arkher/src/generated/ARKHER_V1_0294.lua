...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Sketchfab — CORE Profiler #0294", size=Vector2.new(600, 500), pos=UDim2.fromOffset(322, 138), parent=parent, icon="⤢"})
...
Components.TextField(right, "File", "input.png", function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_File"..294, v) end end)
