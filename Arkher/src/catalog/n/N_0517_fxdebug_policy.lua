-- ARKHER SYSTEM N.0517 :: Effect Debug Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0517"
	S.key = "arkher.vfx.fxdebug.quality_policy"
	S.name = "Effect Debug Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Effect Debug"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fxdebug.result_cache" }
	S.tags = { "n", "fxdebug", "policy", "vfx" }
	S.description = "Effect Debug Quality Policy: distance and device driven fidelity bands for the Effect Debug subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.fxdebug.quality_policy", algorithm = "wfq", starvationGuard = 18 })
		inst.system = S
		inst.ctx = ctx
