-- ARKHER SYSTEM P.0138 :: Rarity Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0138"
	S.key = "arkher.play.rarity.rule_pipeline"
	S.name = "Rarity Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Rarity"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.rarity.state_machine" }
	S.tags = { "p", "rarity", "pipeline", "play" }
	S.description = "Rarity Rule Pipeline: ordered rules applied to every gameplay event for the Rarity subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.rarity.rule_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
