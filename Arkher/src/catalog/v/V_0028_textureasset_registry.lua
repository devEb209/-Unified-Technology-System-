-- ARKHER SYSTEM V.0028 :: Texture Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0028"
	S.key = "arkher.asset.textureasset.asset_registry"
	S.name = "Texture Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.textureasset.cook_pipeline" }
	S.tags = { "v", "textureasset", "registry", "asset" }
	S.description = "Texture Asset Registry: catalogue of every asset, its tags and its metadata for the Texture subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.textureasset.asset_registry" })
		inst.system = S
		inst.ctx = ctx
