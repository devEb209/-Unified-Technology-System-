-- ARKHER SYSTEM VD.0315 :: Ecology Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0315"
	S.key = "arkher.contsim.ecologycont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.ecologycont.epoch_clock" }
	S.tags = { "vd", "ecologycont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.ecologycont.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
