-- ARKHER SYSTEM H.0683 :: Shapecast Query Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0683"
	S.key = "arkher.physics.shapecast.result_cache"
	S.name = "Shapecast Query Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.shapecast.simulation_policy" }
	S.tags = { "h", "shapecast", "cache", "physics" }
	S.description = "Shapecast Query Result Cache: reuse of expensive simulation and query results for the Shapecast Query subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.shapecast.result_cache", policy = "lru", capacity = 421, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
