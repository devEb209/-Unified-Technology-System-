-- ARKHER SYSTEM T.0622 :: Explainability Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0622"
	S.key = "arkher.ai.explainability.reasoning_graph"
	S.name = "Explainability Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.explainability.world_architect" }
	S.tags = { "t", "explainability", "graph", "ai" }
	S.description = "Explainability Reasoning Graph: relationship modelling and shortest-path reasoning for the Explainability subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.explainability.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
