-- ARKHER SYSTEM L.0100 :: Reification Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0100"
	S.key = "arkher.sim.reification.streaming"
	S.name = "Reification Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.reification.state_codec" }
	S.tags = { "l", "reification", "streamer", "sim" }
	S.description = "Reification Streaming: distance-driven residency of simulated regions for the Reification subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.reification.streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
