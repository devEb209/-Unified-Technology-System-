-- ARKHER SYSTEM N.0212 :: Lightning Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0212"
	S.key = "arkher.vfx.lightning.ribbon_and_trail"
	S.name = "Lightning Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Lightning"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.lightning.force_field" }
	S.tags = { "n", "lightning", "ribbon", "vfx" }
	S.description = "Lightning Ribbon And Trail: trail points, tapering, beams and decimation for the Lightning subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.lightning.ribbon_and_trail", maxPoints = 24, lifetime = 0.80, minDistance = 0.25, width = 0.90 })
		inst.system = S
		inst.ctx = ctx
