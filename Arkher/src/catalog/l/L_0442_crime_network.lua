-- ARKHER SYSTEM L.0442 :: Crime Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0442"
	S.key = "arkher.sim.crime.route_network"
	S.name = "Crime Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.crime.region_graph" }
	S.tags = { "l", "crime", "network", "sim" }
	S.description = "Crime Route Network: roads, rivers and routes between settlements for the Crime subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.crime.route_network" })
		inst.system = S
		inst.ctx = ctx
