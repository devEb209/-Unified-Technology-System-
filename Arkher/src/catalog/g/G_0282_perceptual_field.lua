-- ARKHER SYSTEM G.0282 :: Perceptual Metric Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0282"
	S.key = "arkher.neural.perceptual.feature_extraction"
	S.name = "Perceptual Metric Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perceptual.inference_core" }
	S.tags = { "g", "perceptual", "field", "neural" }
	S.description = "Perceptual Metric Feature Extraction: signal features feeding the model for the Perceptual Metric subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.perceptual.feature_extraction", seed = 14492, frequency = 0.0070, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
