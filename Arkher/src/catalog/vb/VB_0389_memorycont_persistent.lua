-- ARKHER SYSTEM VB.0389 :: Memory Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0389"
	S.key = "arkher.conttime.memorycont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memorycont.multi-scale_fidelity" }
	S.tags = { "vb", "memorycont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.memorycont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
