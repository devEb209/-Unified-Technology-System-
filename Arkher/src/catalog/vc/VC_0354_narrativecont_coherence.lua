-- ARKHER SYSTEM VC.0354 :: Narrative Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0354"
	S.key = "arkher.contneural.narrativecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.narrativecont.persistent_state" }
	S.tags = { "vc", "narrativecont", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.narrativecont.coherence_guard", window = 132, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
