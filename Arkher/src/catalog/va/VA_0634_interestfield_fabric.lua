-- ARKHER SYSTEM VA.0634 :: Interest Field Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0634"
	S.key = "arkher.contworld.interestfield.simulation_fabric"
	S.name = "Interest Field Simulation Fabric"
	S.category = "VA"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.interestfield.complexity_budget" }
	S.tags = { "va", "interestfield", "fabric", "contworld" }
	S.description = "Interest Field Simulation Fabric: fabric stepping the continuum domains for the Interest Field subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.interestfield.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
