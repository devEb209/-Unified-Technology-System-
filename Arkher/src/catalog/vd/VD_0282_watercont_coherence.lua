-- ARKHER SYSTEM VD.0282 :: Water Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0282"
	S.key = "arkher.contsim.watercont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.watercont.persistent_state" }
	S.tags = { "vd", "watercont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.watercont.coherence_guard", window = 87, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
