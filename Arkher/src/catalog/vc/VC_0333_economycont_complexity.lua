-- ARKHER SYSTEM VC.0333 :: Economy Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0333"
	S.key = "arkher.contneural.economycont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.economycont.world_memory_stream" }
	S.tags = { "vc", "economycont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.economycont.complexity_budget", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
