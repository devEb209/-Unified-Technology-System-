-- ARKHER SYSTEM Z.0172 :: Self Analyzing Project Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0172"
	S.key = "arkher.origin.selfanalyzing.predictive_optimization"
	S.name = "Self Analyzing Project Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.adaptive_workflow" }
	S.tags = { "z", "selfanalyzing", "predictor", "origin" }
	S.description = "Self Analyzing Project Predictive Optimization: forecast-driven optimization before the cost is paid for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.selfanalyzing.predictive_optimization", method = "markov", alpha = 0.13, window = 115 })
		inst.system = S
		inst.ctx = ctx
