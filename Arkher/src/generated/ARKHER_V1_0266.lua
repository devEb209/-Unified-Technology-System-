...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Mapbox GL — CORE Node_Flow #0266", size=Vector2.new(680, 440), pos=UDim2.fromOffset(358, 182), parent=parent, icon="⬣"})
