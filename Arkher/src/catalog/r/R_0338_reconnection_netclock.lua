-- ARKHER SYSTEM R.0338 :: Reconnection Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0338"
	S.key = "arkher.net.reconnection.time_sync"
	S.name = "Reconnection Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Reconnection"
	S.aspect = "Time Sync"
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reconnection.replication" }
	S.tags = { "r", "reconnection", "netclock", "net" }
	S.description = "Reconnection Time Sync: offset estimation, outlier rejection and jitter buffering for the Reconnection subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.reconnection.time_sync", tickRate = 40, bufferDelay = 0.120, maxSamples = 18 })
		inst.system = S
		inst.ctx = ctx
