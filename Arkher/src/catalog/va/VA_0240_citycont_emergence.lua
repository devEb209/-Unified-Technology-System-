-- ARKHER SYSTEM VA.0240 :: City Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0240"
	S.key = "arkher.contworld.citycont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.citycont.reality_continuum" }
	S.tags = { "va", "citycont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.citycont.emergence_continuum", windowSize = 4, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
