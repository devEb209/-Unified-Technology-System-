-- ARKHER SYSTEM V.0226 :: Script Asset Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0226"
	S.key = "arkher.asset.scriptasset.validation_guard"
	S.name = "Script Asset Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.scriptasset.size_budget" }
	S.tags = { "v", "scriptasset", "guard", "asset" }
	S.description = "Script Asset Validation Guard: rate limiting and capability checks on the import path for the Script Asset subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.scriptasset.validation_guard", algorithm = "leaky", capacity = 36, refillPerSec = 61, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
