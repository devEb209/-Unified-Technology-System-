-- ARKHER SYSTEM T.0331 :: Bug Triage Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0331"
	S.key = "arkher.ai.bugtriage.working_memory"
	S.name = "Bug Triage Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.bugtriage.outcome_prediction" }
	S.tags = { "t", "bugtriage", "memory", "ai" }
	S.description = "Bug Triage Working Memory: decaying, consolidating recall of what the agent learned for the Bug Triage subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.bugtriage.working_memory", capacity = 88, decayRate = 0.040, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
