-- ARKHER SYSTEM V.0055 :: Material Asset Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0055"
	S.key = "arkher.asset.materialasset.streaming_residency"
	S.name = "Material Asset Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.materialasset.content_cache" }
	S.tags = { "v", "materialasset", "streamer", "asset" }
	S.description = "Material Asset Streaming Residency: distance-driven load and unload of asset payloads for the Material Asset subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.materialasset.streaming_residency", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
