-- ARKHER SYSTEM L.0117 :: Settlement Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0117"
	S.key = "arkher.sim.settlement.aggregate_cache"
	S.name = "Settlement Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.settlement.fidelity_policy" }
	S.tags = { "l", "settlement", "cache", "sim" }
	S.description = "Settlement Aggregate Cache: reuse of expensive aggregate computations for the Settlement subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.settlement.aggregate_cache", policy = "lru", capacity = 70, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
