-- ARKHER SYSTEM Z.0250 :: AI Native Engine Architecture Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0250"
	S.key = "arkher.origin.ainative.self_critique"
	S.name = "AI Native Engine Architecture Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.ainative.intent_bridge" }
	S.tags = { "z", "ainative", "critic", "origin" }
	S.description = "AI Native Engine Architecture Self Critique: weighted judgement of the technology's own output for the AI Native Engine Architecture subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.ainative.self_critique", passMark = 0.73, reviseMark = 0.43, seed = 89763 })
		inst.system = S
		inst.ctx = ctx
