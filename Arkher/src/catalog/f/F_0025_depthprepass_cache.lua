-- ARKHER SYSTEM F.0025 :: Depth Prepass Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0025"
	S.key = "arkher.render.depthprepass.pass_cache"
	S.name = "Depth Prepass Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.depthprepass.render_policy" }
	S.tags = { "f", "depthprepass", "cache", "render" }
	S.description = "Depth Prepass Pass Cache: reuse of pass results across frames for the Depth Prepass subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.depthprepass.pass_cache", policy = "lru", capacity = 351, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
