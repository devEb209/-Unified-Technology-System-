-- ARKHER SYSTEM Z.1063 :: World Dream State Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.1063"
	S.key = "arkher.origin.worlddream.simulation_fabric"
	S.name = "World Dream State Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.complexity_governance" }
	S.tags = { "z", "worlddream", "fabric", "origin" }
	S.description = "World Dream State Simulation Fabric: every simulation domain stepped under one budgeted clock for the World Dream State subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.worlddream.simulation_fabric", budgetMs = 3.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
