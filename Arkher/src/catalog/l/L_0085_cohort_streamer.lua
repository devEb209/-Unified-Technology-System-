-- ARKHER SYSTEM L.0085 :: Cohort Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0085"
	S.key = "arkher.sim.cohort.streaming"
	S.name = "Cohort Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.cohort.state_codec" }
	S.tags = { "l", "cohort", "streamer", "sim" }
	S.description = "Cohort Streaming: distance-driven residency of simulated regions for the Cohort subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.cohort.streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
