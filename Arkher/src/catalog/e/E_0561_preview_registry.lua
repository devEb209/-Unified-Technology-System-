-- ARKHER SYSTEM E.0561 :: Material Preview Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0561"
	S.key = "arkher.material.preview.variant_registry"
	S.name = "Material Preview Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.preview.procedural_detail" }
	S.tags = { "e", "preview", "registry", "material" }
	S.description = "Material Preview Variant Registry: named variants and their lifecycle for the Material Preview subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.preview.variant_registry" })
		inst.system = S
		inst.ctx = ctx
