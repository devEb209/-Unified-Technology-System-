-- ARKHER SYSTEM L.0328 :: Production Chain Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0328"
	S.key = "arkher.sim.productionchain.analysis"
	S.name = "Production Chain Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.productionchain.aggregate_cache" }
	S.tags = { "l", "productionchain", "analyzer", "sim" }
	S.description = "Production Chain Analysis: trend, anomaly and stability analysis of the world for the Production Chain subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.productionchain.analysis", window = 141, buckets = 17, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
