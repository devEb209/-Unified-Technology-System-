-- ARKHER SYSTEM K.0315 :: Threat Assessment Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0315"
	S.key = "arkher.npc.threatassessment.utility_reasoning"
	S.name = "Threat Assessment Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.threatassessment.reactive_behaviour" }
	S.tags = { "k", "threatassessment", "utility", "npc" }
	S.description = "Threat Assessment Utility Reasoning: scored option selection with response curves for the Threat Assessment subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.threatassessment.utility_reasoning", momentum = 0.16 })
		inst.system = S
		inst.ctx = ctx
