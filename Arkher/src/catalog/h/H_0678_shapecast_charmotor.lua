-- ARKHER SYSTEM H.0678 :: Shapecast Query Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0678"
	S.key = "arkher.physics.shapecast.character_motion"
	S.name = "Shapecast Query Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.shapecast.query" }
	S.tags = { "h", "shapecast", "charmotor", "physics" }
	S.description = "Shapecast Query Character Motion: capsule move-and-slide with slopes, steps and jumps for the Shapecast Query subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.shapecast.character_motion", radius = 0.50, height = 1.75, maxSpeed = 9.50, jumpHeight = 1.90, stepOffset = 0.50 })
		inst.system = S
		inst.ctx = ctx
