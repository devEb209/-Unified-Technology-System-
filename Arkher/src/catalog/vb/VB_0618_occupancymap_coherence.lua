-- ARKHER SYSTEM VB.0618 :: Occupancy Map Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0618"
	S.key = "arkher.conttime.occupancymap.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.occupancymap.persistent_state" }
	S.tags = { "vb", "occupancymap", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.occupancymap.coherence_guard", window = 56, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
