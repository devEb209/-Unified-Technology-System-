-- ARKHER SYSTEM Z.0624 :: Intent Driven Authoring Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0624"
	S.key = "arkher.origin.intentauthoring.autonomous_pipeline"
	S.name = "Intent Driven Authoring Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.simulation_fabric" }
	S.tags = { "z", "intentauthoring", "autopipeline", "origin" }
	S.description = "Intent Driven Authoring Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.intentauthoring.autonomous_pipeline", maxIterations = 4 })
		inst.system = S
		inst.ctx = ctx
