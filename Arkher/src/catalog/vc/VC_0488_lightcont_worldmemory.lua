-- ARKHER SYSTEM VC.0488 :: Lighting Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0488"
	S.key = "arkher.contneural.lightcont.world_memory_stream"
	S.name = "Lighting Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lightcont.neural_field" }
	S.tags = { "vc", "lightcont", "worldmemory", "contneural" }
	S.description = "Lighting Continuum World Memory Stream: world memory continuum over epochs for the Lighting Continuum subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.lightcont.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
