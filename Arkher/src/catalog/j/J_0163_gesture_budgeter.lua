-- ARKHER SYSTEM J.0163 :: Gesture Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0163"
	S.key = "arkher.character.gesture.budget_governor"
	S.name = "Gesture Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gesture.variant_registry" }
	S.tags = { "j", "gesture", "budgeter", "character" }
	S.description = "Gesture Budget Governor: per-character cost allocation in a crowd for the Gesture subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.gesture.budget_governor", total = 373, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
