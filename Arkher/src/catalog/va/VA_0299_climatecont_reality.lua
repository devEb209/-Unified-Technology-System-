-- ARKHER SYSTEM VA.0299 :: Climate Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0299"
	S.key = "arkher.contworld.climatecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.climatecont.simulation_fabric" }
	S.tags = { "va", "climatecont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.climatecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
