-- ARKHER SYSTEM H.0016 :: Static Body Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0016"
	S.key = "arkher.physics.staticbody.collision_shape"
	S.name = "Static Body Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Static Body"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.staticbody.body_dynamics" }
	S.tags = { "h", "staticbody", "collider", "physics" }
	S.description = "Static Body Collision Shape: shape bounds, support mapping and closest points for the Static Body subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.staticbody.collision_shape", shape = "box", radius = 2.30, height = 1.90, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
