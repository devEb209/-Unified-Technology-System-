-- ARKHER SYSTEM K.0197 :: Emotional State Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0197"
	S.key = "arkher.npc.emotionalstate.mind_network"
	S.name = "Emotional State Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "emotionalstate", "mindnet", "npc" }
	S.description = "Emotional State Mind Network: the learned policy that turns perception into a decision for the Emotional State subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.emotionalstate.mind_network", inputs = 9, hidden = 6, seed = 88447, learningRate = 0.085, exploration = 0.055 })
		inst.system = S
		inst.ctx = ctx
