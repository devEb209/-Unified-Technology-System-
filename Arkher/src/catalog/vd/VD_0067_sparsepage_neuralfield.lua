-- ARKHER SYSTEM VD.0067 :: Sparse Page Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0067"
	S.key = "arkher.contsim.sparsepage.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.sparsepage.coherence_guard" }
	S.tags = { "vd", "sparsepage", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.sparsepage.neural_field", dims = 24, hidden = 20, seed = 81323 })
		inst.system = S
		inst.ctx = ctx
