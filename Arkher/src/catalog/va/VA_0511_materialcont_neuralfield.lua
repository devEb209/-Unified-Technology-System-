-- ARKHER SYSTEM VA.0511 :: Material Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0511"
	S.key = "arkher.contworld.materialcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.materialcont.coherence_guard" }
	S.tags = { "va", "materialcont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.materialcont.neural_field", dims = 24, hidden = 20, seed = 18219 })
		inst.system = S
		inst.ctx = ctx
