-- ARKHER SYSTEM V.0073 :: Animation Clip Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0073"
	S.key = "arkher.asset.animationclip.import"
	S.name = "Animation Clip Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "animationclip", "importer", "asset" }
	S.description = "Animation Clip Import: validation, normalization, hashing and deduplication of incoming content for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.animationclip.import", unitScale = 1.25 })
		inst.system = S
		inst.ctx = ctx
