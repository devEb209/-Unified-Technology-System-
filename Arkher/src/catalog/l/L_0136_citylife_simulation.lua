-- ARKHER SYSTEM L.0136 :: City Life Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0136"
	S.key = "arkher.sim.citylife.simulation_core"
	S.name = "City Life Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "citylife", "simulation", "sim" }
	S.description = "City Life Simulation Core: observer-driven fidelity, catch-up and aggregate state for the City Life subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.citylife.simulation_core", fullRadius = 160, reducedRadius = 1300, budget = 63 })
		inst.system = S
		inst.ctx = ctx
