-- ARKHER SYSTEM I.0443 :: Motion Matching Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0443"
	S.key = "arkher.anim.motionmatching.skeleton"
	S.name = "Motion Matching Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "motionmatching", "skeleton", "anim" }
	S.description = "Motion Matching Skeleton: bone hierarchy, bind pose and world resolution for the Motion Matching subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.motionmatching.skeleton" })
		inst.system = S
		inst.ctx = ctx
