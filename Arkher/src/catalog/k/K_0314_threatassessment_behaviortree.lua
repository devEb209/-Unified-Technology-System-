-- ARKHER SYSTEM K.0314 :: Threat Assessment Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0314"
	S.key = "arkher.npc.threatassessment.reactive_behaviour"
	S.name = "Threat Assessment Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.threatassessment.perception" }
	S.tags = { "k", "threatassessment", "behaviortree", "npc" }
	S.description = "Threat Assessment Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Threat Assessment subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.threatassessment.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
