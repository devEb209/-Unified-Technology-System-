-- ARKHER SYSTEM Q.0029 :: Button Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0029"
	S.key = "arkher.ui.button.navigation_graph"
	S.name = "Button Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Button"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.button.transition" }
	S.tags = { "q", "button", "graph", "ui" }
	S.description = "Button Navigation Graph: screens, routes and shortest path between them for the Button subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.button.navigation_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
