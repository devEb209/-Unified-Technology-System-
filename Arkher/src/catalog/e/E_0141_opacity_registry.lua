-- ARKHER SYSTEM E.0141 :: Opacity Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0141"
	S.key = "arkher.material.opacity.variant_registry"
	S.name = "Opacity Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Opacity"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.opacity.procedural_detail" }
	S.tags = { "e", "opacity", "registry", "material" }
	S.description = "Opacity Variant Registry: named variants and their lifecycle for the Opacity subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.opacity.variant_registry" })
		inst.system = S
		inst.ctx = ctx
