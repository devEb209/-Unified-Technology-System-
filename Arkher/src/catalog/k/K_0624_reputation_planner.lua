-- ARKHER SYSTEM K.0624 :: Reputation Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0624"
	S.key = "arkher.npc.reputation.goal_planner"
	S.name = "Reputation Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.reputation.utility_reasoning" }
	S.tags = { "k", "reputation", "planner", "npc" }
	S.description = "Reputation Goal Planner: backward GOAP planning to reach a goal state for the Reputation subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.reputation.goal_planner", maxDepth = 10 })
		inst.system = S
		inst.ctx = ctx
