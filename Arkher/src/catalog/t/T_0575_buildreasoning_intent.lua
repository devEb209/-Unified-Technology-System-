-- ARKHER SYSTEM T.0575 :: Build Reasoning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0575"
	S.key = "arkher.ai.buildreasoning.intent_understanding"
	S.name = "Build Reasoning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "buildreasoning", "intent", "ai" }
	S.description = "Build Reasoning Intent Understanding: natural language turned into an actionable, scored intent for the Build Reasoning subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.buildreasoning.intent_understanding", minConfidence = 0.32 })
		inst.system = S
		inst.ctx = ctx
