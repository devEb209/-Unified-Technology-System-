-- ARKHER SYSTEM G.0426 :: Confidence Gating Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0426"
	S.key = "arkher.neural.confidence.weight_codec"
	S.name = "Confidence Gating Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.confidence.model_registry" }
	S.tags = { "g", "confidence", "codec", "neural" }
	S.description = "Confidence Gating Weight Codec: weight serialization and quantized transport for the Confidence Gating subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.confidence.weight_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
