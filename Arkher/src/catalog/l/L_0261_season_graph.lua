-- ARKHER SYSTEM L.0261 :: Season Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0261"
	S.key = "arkher.sim.season.region_graph"
	S.name = "Season Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.season.calendar" }
	S.tags = { "l", "season", "graph", "sim" }
	S.description = "Season Region Graph: connectivity, components and shortest path between places for the Season subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.season.region_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
