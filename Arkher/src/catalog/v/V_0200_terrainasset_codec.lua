-- ARKHER SYSTEM V.0200 :: Terrain Asset Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0200"
	S.key = "arkher.asset.terrainasset.compression_codec"
	S.name = "Terrain Asset Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.terrainasset.streaming_residency" }
	S.tags = { "v", "terrainasset", "codec", "asset" }
	S.description = "Terrain Asset Compression Codec: compact encoding, diffing and checksum of asset payloads for the Terrain Asset subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.terrainasset.compression_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
