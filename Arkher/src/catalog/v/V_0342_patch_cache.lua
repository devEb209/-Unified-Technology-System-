-- ARKHER SYSTEM V.0342 :: Patch Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0342"
	S.key = "arkher.asset.patch.content_cache"
	S.name = "Patch Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.patch.dependency_graph" }
	S.tags = { "v", "patch", "cache", "asset" }
	S.description = "Patch Content Cache: reuse of already cooked results for the Patch subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.patch.content_cache", policy = "lfu", capacity = 458, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
