-- ARKHER SYSTEM N.0404 :: Wind Gust Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0404"
	S.key = "arkher.vfx.windgust.emission"
	S.name = "Wind Gust Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Wind Gust"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "windgust", "emitter", "vfx" }
	S.description = "Wind Gust Emission: shaped, rate and burst emission of new particles for the Wind Gust subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.windgust.emission", shape = "sphere", rate = 41, speed = 5.10, life = 2.90, budget = 448, seed = 56781 })
		inst.system = S
		inst.ctx = ctx
