-- ARKHER SYSTEM R.0326 :: Matchmaking Transport Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0326"
	S.key = "arkher.net.matchmakingtransport.time_sync"
	S.name = "Matchmaking Transport Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.matchmakingtransport.replication" }
	S.tags = { "r", "matchmakingtransport", "netclock", "net" }
	S.description = "Matchmaking Transport Time Sync: offset estimation, outlier rejection and jitter buffering for the Matchmaking Transport subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.matchmakingtransport.time_sync", tickRate = 50, bufferDelay = 0.110, maxSamples = 23 })
		inst.system = S
		inst.ctx = ctx
