-- ARKHER SYSTEM J.0104 :: Lip Sync Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0104"
	S.key = "arkher.character.lipsync.physical_response"
	S.name = "Lip Sync Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.lipsync.look_and_reach" }
	S.tags = { "j", "lipsync", "ragdoll", "character" }
	S.description = "Lip Sync Physical Response: physical reaction, ragdoll and recovery for the Lip Sync subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.lipsync.physical_response", blendSpeed = 2.70 })
		inst.system = S
		inst.ctx = ctx
