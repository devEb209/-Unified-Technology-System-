-- ARKHER SYSTEM H.0638 :: Vehicle Chassis Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0638"
	S.key = "arkher.physics.vehiclechassis.broadphase_index"
	S.name = "Vehicle Chassis Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.vehiclechassis.vehicle" }
	S.tags = { "h", "vehiclechassis", "index", "physics" }
	S.description = "Vehicle Chassis Broadphase Index: spatial acceleration of candidate pair finding for the Vehicle Chassis subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.vehiclechassis.broadphase_index", mode = "hash", cellSize = 80 })
		inst.system = S
		inst.ctx = ctx
