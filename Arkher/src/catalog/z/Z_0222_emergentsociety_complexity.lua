-- ARKHER SYSTEM Z.0222 :: Emergent Society Framework Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0222"
	S.key = "arkher.origin.emergentsociety.complexity_governance"
	S.name = "Emergent Society Framework Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentsociety.reality_layering" }
	S.tags = { "z", "emergentsociety", "complexity", "origin" }
	S.description = "Emergent Society Framework Complexity Governance: measured scene cost turned into per-subsystem directives for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.emergentsociety.complexity_governance", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
