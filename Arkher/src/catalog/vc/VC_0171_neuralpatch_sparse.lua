-- ARKHER SYSTEM VC.0171 :: Neural Patch Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0171"
	S.key = "arkher.contneural.neuralpatch.sparse_residency"
	S.name = "Neural Patch Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.neuralpatch.epoch_clock" }
	S.tags = { "vc", "neuralpatch", "sparse", "contneural" }
	S.description = "Neural Patch Sparse Residency: sparse page residency with eviction and compression for the Neural Patch subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.neuralpatch.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
