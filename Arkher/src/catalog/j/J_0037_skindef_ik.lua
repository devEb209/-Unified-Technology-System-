-- ARKHER SYSTEM J.0037 :: Skin Definition Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0037"
	S.key = "arkher.character.skindef.look_and_reach"
	S.name = "Skin Definition Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.skindef.blend_controller" }
	S.tags = { "j", "skindef", "ik", "character" }
	S.description = "Skin Definition Look And Reach: look-at, reach and foot placement for the character for the Skin Definition subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.skindef.look_and_reach", iterations = 11, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
