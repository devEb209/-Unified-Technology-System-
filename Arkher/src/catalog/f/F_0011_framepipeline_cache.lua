-- ARKHER SYSTEM F.0011 :: Frame Pipeline Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0011"
	S.key = "arkher.render.framepipeline.pass_cache"
	S.name = "Frame Pipeline Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepipeline.render_policy" }
	S.tags = { "f", "framepipeline", "cache", "render" }
	S.description = "Frame Pipeline Pass Cache: reuse of pass results across frames for the Frame Pipeline subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.framepipeline.pass_cache", policy = "lru", capacity = 139, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
