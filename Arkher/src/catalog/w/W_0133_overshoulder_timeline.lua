-- ARKHER SYSTEM W.0133 :: Over The Shoulder Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0133"
	S.key = "arkher.cine.overshoulder.sequence_timeline"
	S.name = "Over The Shoulder Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "overshoulder", "timeline", "cine" }
	S.description = "Over The Shoulder Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Over The Shoulder subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.overshoulder.sequence_timeline", duration = 9.0, rate = 1.01 })
		inst.system = S
		inst.ctx = ctx
