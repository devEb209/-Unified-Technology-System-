-- ARKHER SYSTEM VA.0354 :: Narrative Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0354"
	S.key = "arkher.contworld.narrativecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.narrativecont.persistent_state" }
	S.tags = { "va", "narrativecont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.narrativecont.coherence_guard", window = 93, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
