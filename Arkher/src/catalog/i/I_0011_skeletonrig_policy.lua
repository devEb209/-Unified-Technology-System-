-- ARKHER SYSTEM I.0011 :: Skeleton Rig Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0011"
	S.key = "arkher.anim.skeletonrig.quality_policy"
	S.name = "Skeleton Rig Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Skeleton Rig"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.skeletonrig.pose_cache" }
	S.tags = { "i", "skeletonrig", "policy", "anim" }
	S.description = "Skeleton Rig Quality Policy: device tier rules for rate, bones and solvers for the Skeleton Rig subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.skeletonrig.quality_policy", algorithm = "edf", starvationGuard = 49 })
		inst.system = S
		inst.ctx = ctx
