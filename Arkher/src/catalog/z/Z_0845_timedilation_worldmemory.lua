-- ARKHER SYSTEM Z.0845 :: Simulation Time Dilation World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0845"
	S.key = "arkher.origin.timedilation.world_memory"
	S.name = "Simulation Time Dilation World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.autonomous_pipeline" }
	S.tags = { "z", "timedilation", "worldmemory", "origin" }
	S.description = "Simulation Time Dilation World Memory: epoch-stamped persistent history with compaction and checkpoints for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.timedilation.world_memory", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
