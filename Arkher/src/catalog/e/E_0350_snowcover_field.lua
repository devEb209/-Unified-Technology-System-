-- ARKHER SYSTEM E.0350 :: Snow Cover Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0350"
	S.key = "arkher.material.snowcover.procedural_detail"
	S.name = "Snow Cover Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Snow Cover"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.snowcover.texture_sampling" }
	S.tags = { "e", "snowcover", "field", "material" }
	S.description = "Snow Cover Procedural Detail: coherent noise detail driving the surface for the Snow Cover subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.snowcover.procedural_detail", seed = 41665, frequency = 0.0103, octaves = 4, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
