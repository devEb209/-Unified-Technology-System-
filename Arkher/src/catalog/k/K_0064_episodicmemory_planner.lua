-- ARKHER SYSTEM K.0064 :: Episodic Memory Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0064"
	S.key = "arkher.npc.episodicmemory.goal_planner"
	S.name = "Episodic Memory Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.episodicmemory.utility_reasoning" }
	S.tags = { "k", "episodicmemory", "planner", "npc" }
	S.description = "Episodic Memory Goal Planner: backward GOAP planning to reach a goal state for the Episodic Memory subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.episodicmemory.goal_planner", maxDepth = 11 })
		inst.system = S
		inst.ctx = ctx
