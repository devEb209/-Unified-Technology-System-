-- ARKHER SYSTEM Z.0927 :: Universal Interop Layer World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0927"
	S.key = "arkher.origin.interop.world_architect"
	S.name = "Universal Interop Layer World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.interop.emergence_detection" }
	S.tags = { "z", "interop", "architect", "origin" }
	S.description = "Universal Interop Layer World Architect: hierarchical world composition with conserved budgets for the Universal Interop Layer subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.interop.world_architect", budget = 1400, seed = 88638 })
		inst.system = S
		inst.ctx = ctx
