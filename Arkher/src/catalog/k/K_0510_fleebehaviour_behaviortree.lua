-- ARKHER SYSTEM K.0510 :: Flee Behaviour Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0510"
	S.key = "arkher.npc.fleebehaviour.reactive_behaviour"
	S.name = "Flee Behaviour Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.fleebehaviour.perception" }
	S.tags = { "k", "fleebehaviour", "behaviortree", "npc" }
	S.description = "Flee Behaviour Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Flee Behaviour subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.fleebehaviour.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
