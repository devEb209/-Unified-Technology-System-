-- ARKHER SYSTEM VA.0289 :: Climate Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0289"
	S.key = "arkher.contworld.climatecont.infinite_grid"
	S.name = "Climate Continuum Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "climatecont", "continuum", "contworld" }
	S.description = "Climate Continuum Infinite Grid: seamless paging of the infinite world grid for the Climate Continuum subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.climatecont.infinite_grid", cellSize = 192, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
