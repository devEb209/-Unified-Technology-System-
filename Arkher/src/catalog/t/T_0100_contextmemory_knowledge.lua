-- ARKHER SYSTEM T.0100 :: Context Memory Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0100"
	S.key = "arkher.ai.contextmemory.semantic_knowledge"
	S.name = "Context Memory Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.contextmemory.intent_understanding" }
	S.tags = { "t", "contextmemory", "knowledge", "ai" }
	S.description = "Context Memory Semantic Knowledge: typed entities, weighted relations and inferred closure for the Context Memory subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.contextmemory.semantic_knowledge", dims = 16 })
		inst.system = S
		inst.ctx = ctx
