-- ARKHER SYSTEM VA.0100 :: Memory Shard Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VA.0100"
	S.key = "arkher.contworld.memoryshard.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memoryshard.sparse_residency" }
	S.tags = { "va", "memoryshard", "multiscale", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contworld.memoryshard.multi-scale_fidelity", levels = 4, baseTriangles = 165000 })
		inst.system = S
		inst.ctx = ctx
