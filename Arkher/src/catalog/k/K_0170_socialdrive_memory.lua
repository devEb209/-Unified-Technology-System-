-- ARKHER SYSTEM K.0170 :: Social Drive Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0170"
	S.key = "arkher.npc.socialdrive.memory"
	S.name = "Social Drive Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.socialdrive.mind_network" }
	S.tags = { "k", "socialdrive", "memory", "npc" }
	S.description = "Social Drive Memory: episodic memory with decay, recall and consolidation for the Social Drive subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.socialdrive.memory", capacity = 125, decayRate = 0.045, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
