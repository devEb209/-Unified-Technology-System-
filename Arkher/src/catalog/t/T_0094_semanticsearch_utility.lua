-- ARKHER SYSTEM T.0094 :: Semantic Search Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0094"
	S.key = "arkher.ai.semanticsearch.utility_selection"
	S.name = "Semantic Search Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.semanticsearch.working_memory" }
	S.tags = { "t", "semanticsearch", "utility", "ai" }
	S.description = "Semantic Search Utility Selection: scored choice between competing courses of action for the Semantic Search subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.semanticsearch.utility_selection", momentum = 0.09 })
		inst.system = S
		inst.ctx = ctx
