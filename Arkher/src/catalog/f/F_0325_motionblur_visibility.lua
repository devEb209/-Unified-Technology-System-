-- ARKHER SYSTEM F.0325 :: Motion Blur Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0325"
	S.key = "arkher.render.motionblur.visibility_set"
	S.name = "Motion Blur Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Motion Blur"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.motionblur.view_and_culling" }
	S.tags = { "f", "motionblur", "visibility", "render" }
	S.description = "Motion Blur Visibility Set: cell, portal and occluder visibility for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.motionblur.visibility_set", maxDepth = 2 })
		inst.system = S
		inst.ctx = ctx
