-- ARKHER SYSTEM N.0050 :: Explosion Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0050"
	S.key = "arkher.vfx.explosion.spatial_index"
	S.name = "Explosion Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Explosion"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.explosion.quality_policy" }
	S.tags = { "n", "explosion", "index", "vfx" }
	S.description = "Explosion Spatial Index: spatial acceleration of effect queries and culling for the Explosion subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.explosion.spatial_index", mode = "hash", cellSize = 64 })
		inst.system = S
		inst.ctx = ctx
