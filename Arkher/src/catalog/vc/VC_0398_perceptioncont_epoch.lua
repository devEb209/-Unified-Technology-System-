-- ARKHER SYSTEM VC.0398 :: Perception Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0398"
	S.key = "arkher.contneural.perceptioncont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.perceptioncont.infinite_grid" }
	S.tags = { "vc", "perceptioncont", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.perceptioncont.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
