-- ARKHER SYSTEM E.0297 :: Wear And Tear Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0297"
	S.key = "arkher.material.wear.analysis"
	S.name = "Wear And Tear Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.wear.instance_cache" }
	S.tags = { "e", "wear", "analyzer", "material" }
	S.description = "Wear And Tear Analysis: cost, redundancy and outlier analysis for the Wear And Tear subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.wear.analysis", window = 202, buckets = 18, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
