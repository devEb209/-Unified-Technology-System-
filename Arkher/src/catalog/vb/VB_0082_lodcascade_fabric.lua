-- ARKHER SYSTEM VB.0082 :: LOD Cascade Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0082"
	S.key = "arkher.conttime.lodcascade.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lodcascade.complexity_budget" }
	S.tags = { "vb", "lodcascade", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.lodcascade.simulation_fabric", budgetMs = 2.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
