-- ARKHER SYSTEM Z.0411 :: Battery Aware Pipeline Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0411"
	S.key = "arkher.origin.batteryaware.adaptive_workflow"
	S.name = "Battery Aware Pipeline Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.batteryaware.self_critique" }
	S.tags = { "z", "batteryaware", "workflow", "origin" }
	S.description = "Battery Aware Pipeline Adaptive Workflow: verified, retryable, reversible execution plans for the Battery Aware Pipeline subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.batteryaware.adaptive_workflow", maxRetries = 1, budget = 70 })
		inst.system = S
		inst.ctx = ctx
