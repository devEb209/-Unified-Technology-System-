-- ARKHER SYSTEM F.0361 :: Temporal Accumulation Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0361"
	S.key = "arkher.render.temporalaccum.pass_cache"
	S.name = "Temporal Accumulation Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.temporalaccum.render_policy" }
	S.tags = { "f", "temporalaccum", "cache", "render" }
	S.description = "Temporal Accumulation Pass Cache: reuse of pass results across frames for the Temporal Accumulation subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.temporalaccum.pass_cache", policy = "lru", capacity = 348, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
