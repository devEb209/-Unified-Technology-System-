-- ARKHER SYSTEM Z.0171 :: Self Analyzing Project Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0171"
	S.key = "arkher.origin.selfanalyzing.adaptive_workflow"
	S.name = "Self Analyzing Project Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.self_critique" }
	S.tags = { "z", "selfanalyzing", "workflow", "origin" }
	S.description = "Self Analyzing Project Adaptive Workflow: verified, retryable, reversible execution plans for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.selfanalyzing.adaptive_workflow", maxRetries = 3, budget = 90 })
		inst.system = S
		inst.ctx = ctx
