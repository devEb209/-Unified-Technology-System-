-- ARKHER SYSTEM F.0437 :: Portal Culling Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0437"
	S.key = "arkher.render.portal.visibility_set"
	S.name = "Portal Culling Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.portal.view_and_culling" }
	S.tags = { "f", "portal", "visibility", "render" }
	S.description = "Portal Culling Visibility Set: cell, portal and occluder visibility for the Portal Culling subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.portal.visibility_set", maxDepth = 2 })
		inst.system = S
		inst.ctx = ctx
