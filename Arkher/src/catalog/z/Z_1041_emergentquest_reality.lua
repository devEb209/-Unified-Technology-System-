-- ARKHER SYSTEM Z.1041 :: Emergent Quest Generation Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.1041"
	S.key = "arkher.origin.emergentquest.reality_layering"
	S.name = "Emergent Quest Generation Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "emergentquest", "reality", "origin" }
	S.description = "Emergent Quest Generation Reality Layering: stacked authored, simulated, proposed and player realities for the Emergent Quest Generation subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.emergentquest.reality_layering" })
		inst.system = S
		inst.ctx = ctx
