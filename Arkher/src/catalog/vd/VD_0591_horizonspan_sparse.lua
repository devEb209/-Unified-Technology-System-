-- ARKHER SYSTEM VD.0591 :: Horizon Span Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0591"
	S.key = "arkher.contsim.horizonspan.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.horizonspan.epoch_clock" }
	S.tags = { "vd", "horizonspan", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.horizonspan.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
