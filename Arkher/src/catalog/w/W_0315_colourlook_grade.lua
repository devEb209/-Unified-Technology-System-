-- ARKHER SYSTEM W.0315 :: Colour Look Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0315"
	S.key = "arkher.cine.colourlook.colour_grade"
	S.name = "Colour Look Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Colour Look"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.colourlook.camera_rig" }
	S.tags = { "w", "colourlook", "grade", "cine" }
	S.description = "Colour Look Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Colour Look subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.colourlook.colour_grade", exposure = 0.09, contrast = 1.14, saturation = 1.19, toneMap = "filmic" })
		inst.system = S
		inst.ctx = ctx
