-- ARKHER SYSTEM P.0013 :: Attribute Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0013"
	S.key = "arkher.play.attribute.attributes"
	S.name = "Attribute Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Attribute"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "attribute", "stats", "play" }
	S.description = "Attribute Attributes: base values, layered modifiers and derived statistics for the Attribute subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.attribute.attributes" })
		inst.system = S
		inst.ctx = ctx
