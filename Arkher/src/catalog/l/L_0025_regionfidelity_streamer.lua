-- ARKHER SYSTEM L.0025 :: Region Fidelity Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0025"
	S.key = "arkher.sim.regionfidelity.streaming"
	S.name = "Region Fidelity Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.regionfidelity.state_codec" }
	S.tags = { "l", "regionfidelity", "streamer", "sim" }
	S.description = "Region Fidelity Streaming: distance-driven residency of simulated regions for the Region Fidelity subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.regionfidelity.streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
