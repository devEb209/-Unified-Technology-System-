-- ARKHER SYSTEM T.0692 :: AI Debug Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0692"
	S.key = "arkher.ai.aidebug.reasoning_graph"
	S.name = "AI Debug Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.aidebug.world_architect" }
	S.tags = { "t", "aidebug", "graph", "ai" }
	S.description = "AI Debug Reasoning Graph: relationship modelling and shortest-path reasoning for the AI Debug subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.aidebug.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
