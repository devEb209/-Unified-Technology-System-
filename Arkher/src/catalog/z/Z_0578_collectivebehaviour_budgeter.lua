-- ARKHER SYSTEM Z.0578 :: Collective Behaviour Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0578"
	S.key = "arkher.origin.collectivebehaviour.budget_governor"
	S.name = "Collective Behaviour Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.collectivebehaviour.behaviour_analysis" }
	S.tags = { "z", "collectivebehaviour", "budgeter", "origin" }
	S.description = "Collective Behaviour Budget Governor: allocation of a scarce resource across the technology's consumers for the Collective Behaviour subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.collectivebehaviour.budget_governor", total = 89, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
