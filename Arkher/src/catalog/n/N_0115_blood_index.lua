-- ARKHER SYSTEM N.0115 :: Blood Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0115"
	S.key = "arkher.vfx.blood.spatial_index"
	S.name = "Blood Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Blood"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.blood.quality_policy" }
	S.tags = { "n", "blood", "index", "vfx" }
	S.description = "Blood Spatial Index: spatial acceleration of effect queries and culling for the Blood subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.blood.spatial_index", mode = "hash", cellSize = 72 })
		inst.system = S
		inst.ctx = ctx
