-- ARKHER SYSTEM K.0033 :: Learning Loop Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0033"
	S.key = "arkher.npc.learningloop.perception"
	S.name = "Learning Loop Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.learningloop.emotion" }
	S.tags = { "k", "learningloop", "perception", "npc" }
	S.description = "Learning Loop Perception: sight, hearing and bounded attention for the Learning Loop subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.learningloop.perception", sightRange = 45, hearingRange = 20, attentionSlots = 3, fov = 1.800 })
		inst.system = S
		inst.ctx = ctx
