-- ARKHER SYSTEM Z.0075 :: Reality Layer Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0075"
	S.key = "arkher.origin.realitylayer.signal_composition"
	S.name = "Reality Layer Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.telemetry_ledger" }
	S.tags = { "z", "realitylayer", "composer", "origin" }
	S.description = "Reality Layer Signal Composition: blending of the technology's input signals into one output for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.realitylayer.signal_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
