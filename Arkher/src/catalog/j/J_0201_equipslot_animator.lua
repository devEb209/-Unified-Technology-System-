-- ARKHER SYSTEM J.0201 :: Equipment Slot Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0201"
	S.key = "arkher.character.equipslot.blend_controller"
	S.name = "Equipment Slot Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.equipslot.motion_set" }
	S.tags = { "j", "equipslot", "animator", "character" }
	S.description = "Equipment Slot Blend Controller: layered playback driving the character for the Equipment Slot subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.equipslot.blend_controller", budget = 5 })
		inst.system = S
		inst.ctx = ctx
