-- ARKHER SYSTEM Z.0163 :: Self Analyzing Project Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0163"
	S.key = "arkher.origin.selfanalyzing.simulation_fabric"
	S.name = "Self Analyzing Project Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.complexity_governance" }
	S.tags = { "z", "selfanalyzing", "fabric", "origin" }
	S.description = "Self Analyzing Project Simulation Fabric: every simulation domain stepped under one budgeted clock for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.selfanalyzing.simulation_fabric", budgetMs = 4.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
