-- ARKHER SYSTEM Q.0016 :: Panel Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0016"
	S.key = "arkher.ui.panel.transition"
	S.name = "Panel Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Panel"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.panel.input_mapping" }
	S.tags = { "q", "panel", "tween", "ui" }
	S.description = "Panel Transition: eased, delayed, looped and sequenced motion for the Panel subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.panel.transition", timeScale = 1.01 })
		inst.system = S
		inst.ctx = ctx
