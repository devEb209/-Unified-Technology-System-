-- ARKHER SYSTEM N.0040 :: Explosion Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0040"
	S.key = "arkher.vfx.explosion.emission"
	S.name = "Explosion Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Explosion"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "explosion", "emitter", "vfx" }
	S.description = "Explosion Emission: shaped, rate and burst emission of new particles for the Explosion subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.explosion.emission", shape = "sphere", rate = 37, speed = 6.70, life = 2.50, budget = 448, seed = 37757 })
		inst.system = S
		inst.ctx = ctx
