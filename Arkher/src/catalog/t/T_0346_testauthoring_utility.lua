-- ARKHER SYSTEM T.0346 :: Test Authoring Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0346"
	S.key = "arkher.ai.testauthoring.utility_selection"
	S.name = "Test Authoring Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.testauthoring.working_memory" }
	S.tags = { "t", "testauthoring", "utility", "ai" }
	S.description = "Test Authoring Utility Selection: scored choice between competing courses of action for the Test Authoring subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.testauthoring.utility_selection", momentum = 0.16 })
		inst.system = S
		inst.ctx = ctx
