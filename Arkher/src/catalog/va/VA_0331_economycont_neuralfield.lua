-- ARKHER SYSTEM VA.0331 :: Economy Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0331"
	S.key = "arkher.contworld.economycont.neural_field"
	S.name = "Economy Continuum Neural Field"
	S.category = "VA"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.economycont.coherence_guard" }
	S.tags = { "va", "economycont", "neuralfield", "contworld" }
	S.description = "Economy Continuum Neural Field: neural field encoding and reconstruction for the Economy Continuum subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.economycont.neural_field", dims = 12, hidden = 8, seed = 51696 })
		inst.system = S
		inst.ctx = ctx
