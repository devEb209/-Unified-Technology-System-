-- ARKHER SYSTEM T.0689 :: AI Debug Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0689"
	S.key = "arkher.ai.aidebug.plan_workflow"
	S.name = "AI Debug Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.aidebug.semantic_knowledge" }
	S.tags = { "t", "aidebug", "workflow", "ai" }
	S.description = "AI Debug Plan Workflow: dependency-ordered plans that verify, retry and roll back for the AI Debug subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.aidebug.plan_workflow", maxRetries = 1, budget = 130 })
		inst.system = S
		inst.ctx = ctx
