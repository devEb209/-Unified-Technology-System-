-- ARKHER SYSTEM VC.0228 :: Terrain Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0228"
	S.key = "arkher.contneural.terraincont.emergence_continuum"
	S.name = "Terrain Continuum Emergence Continuum"
	S.category = "VC"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.terraincont.reality_continuum" }
	S.tags = { "vc", "terraincont", "emergence", "contneural" }
	S.description = "Terrain Continuum Emergence Continuum: emergence detection over the continuum for the Terrain Continuum subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.terraincont.emergence_continuum", windowSize = 5, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
