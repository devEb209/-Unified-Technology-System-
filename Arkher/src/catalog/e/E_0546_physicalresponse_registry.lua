-- ARKHER SYSTEM E.0546 :: Physical Response Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0546"
	S.key = "arkher.material.physicalresponse.variant_registry"
	S.name = "Physical Response Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.physicalresponse.procedural_detail" }
	S.tags = { "e", "physicalresponse", "registry", "material" }
	S.description = "Physical Response Variant Registry: named variants and their lifecycle for the Physical Response subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.physicalresponse.variant_registry" })
		inst.system = S
		inst.ctx = ctx
