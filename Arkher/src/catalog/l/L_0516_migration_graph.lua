-- ARKHER SYSTEM L.0516 :: Migration Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0516"
	S.key = "arkher.sim.migration.region_graph"
	S.name = "Migration Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.migration.calendar" }
	S.tags = { "l", "migration", "graph", "sim" }
	S.description = "Migration Region Graph: connectivity, components and shortest path between places for the Migration subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.migration.region_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
