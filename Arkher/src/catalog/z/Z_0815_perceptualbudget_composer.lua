-- ARKHER SYSTEM Z.0815 :: Perceptual Budgeting Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0815"
	S.key = "arkher.origin.perceptualbudget.signal_composition"
	S.name = "Perceptual Budgeting Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.perceptualbudget.telemetry_ledger" }
	S.tags = { "z", "perceptualbudget", "composer", "origin" }
	S.description = "Perceptual Budgeting Signal Composition: blending of the technology's input signals into one output for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.perceptualbudget.signal_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
