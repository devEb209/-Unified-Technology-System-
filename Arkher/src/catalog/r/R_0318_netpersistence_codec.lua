-- ARKHER SYSTEM R.0318 :: Data Persistence Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0318"
	S.key = "arkher.net.netpersistence.serialization_codec"
	S.name = "Data Persistence Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netpersistence.bandwidth_budget" }
	S.tags = { "r", "netpersistence", "codec", "net" }
	S.description = "Data Persistence Serialization Codec: compact encoding, diffing and checksum of payloads for the Data Persistence subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.netpersistence.serialization_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
