-- ARKHER SYSTEM P.0433 :: Matchmaking Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0433"
	S.key = "arkher.play.matchmaking.attributes"
	S.name = "Matchmaking Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Matchmaking"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "matchmaking", "stats", "play" }
	S.description = "Matchmaking Attributes: base values, layered modifiers and derived statistics for the Matchmaking subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.matchmaking.attributes" })
		inst.system = S
		inst.ctx = ctx
