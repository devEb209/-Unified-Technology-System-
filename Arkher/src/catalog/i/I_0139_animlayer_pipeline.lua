-- ARKHER SYSTEM I.0139 :: Animation Layer Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0139"
	S.key = "arkher.anim.animlayer.playback_pipeline"
	S.name = "Animation Layer Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlayer.event_ledger" }
	S.tags = { "i", "animlayer", "pipeline", "anim" }
	S.description = "Animation Layer Playback Pipeline: ordered sample, blend, ik and output stages for the Animation Layer subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.animlayer.playback_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
