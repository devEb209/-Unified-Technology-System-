-- ARKHER SYSTEM K.0648 :: Daily Routine Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0648"
	S.key = "arkher.npc.dailyroutine.emotion"
	S.name = "Daily Routine Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dailyroutine.drive_system" }
	S.tags = { "k", "dailyroutine", "emotion", "npc" }
	S.description = "Daily Routine Emotion: appraisal of events into valence, arousal and mood for the Daily Routine subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.dailyroutine.emotion", inertia = 0.78, decayRate = 0.33, baselineArousal = 0.13 })
		inst.system = S
		inst.ctx = ctx
