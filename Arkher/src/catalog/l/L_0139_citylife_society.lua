-- ARKHER SYSTEM L.0139 :: City Life Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0139"
	S.key = "arkher.sim.citylife.society"
	S.name = "City Life Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.citylife.economy" }
	S.tags = { "l", "citylife", "society", "sim" }
	S.description = "City Life Society: relations, factions, reputation and cohesion of the region for the City Life subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.citylife.society", decayRate = 0.011, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
