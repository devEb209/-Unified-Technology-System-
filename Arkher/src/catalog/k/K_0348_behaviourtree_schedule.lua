-- ARKHER SYSTEM K.0348 :: Behaviour Tree Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0348"
	S.key = "arkher.npc.behaviourtree.daily_schedule"
	S.name = "Behaviour Tree Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourtree.social_relations" }
	S.tags = { "k", "behaviourtree", "schedule", "npc" }
	S.description = "Behaviour Tree Daily Schedule: hour-by-hour routine with priority interruptions for the Behaviour Tree subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.behaviourtree.daily_schedule", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
