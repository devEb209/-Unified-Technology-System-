-- ARKHER SYSTEM F.0385 :: Sharpening Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0385"
	S.key = "arkher.render.sharpening.temporal_resolve"
	S.name = "Sharpening Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sharpening"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sharpening.probe_volume" }
	S.tags = { "f", "sharpening", "temporal", "render" }
	S.description = "Sharpening Temporal Resolve: history reprojection with neighbourhood clamping for the Sharpening subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.sharpening.temporal_resolve", feedback = 0.86, phase = 8 })
		inst.system = S
		inst.ctx = ctx
