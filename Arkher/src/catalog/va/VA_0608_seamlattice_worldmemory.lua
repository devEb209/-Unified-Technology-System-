-- ARKHER SYSTEM VA.0608 :: Seam Lattice World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0608"
	S.key = "arkher.contworld.seamlattice.world_memory_stream"
	S.name = "Seam Lattice World Memory Stream"
	S.category = "VA"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.seamlattice.neural_field" }
	S.tags = { "va", "seamlattice", "worldmemory", "contworld" }
	S.description = "Seam Lattice World Memory Stream: world memory continuum over epochs for the Seam Lattice subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.seamlattice.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
