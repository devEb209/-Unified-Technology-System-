-- ARKHER SYSTEM H.0399 :: Contact Manifold Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0399"
	S.key = "arkher.physics.manifold.vehicle"
	S.name = "Contact Manifold Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.manifold.character_motion" }
	S.tags = { "h", "manifold", "vehicle", "physics" }
	S.description = "Contact Manifold Vehicle: suspension, drivetrain, steering and tire friction for the Contact Manifold subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.manifold.vehicle", mass = 1500, wheelbase = 2.20, track = 1.80, maxRpm = 5600 })
		inst.system = S
		inst.ctx = ctx
