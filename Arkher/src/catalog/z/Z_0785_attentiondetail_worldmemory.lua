-- ARKHER SYSTEM Z.0785 :: Attention Driven Detail World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0785"
	S.key = "arkher.origin.attentiondetail.world_memory"
	S.name = "Attention Driven Detail World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.autonomous_pipeline" }
	S.tags = { "z", "attentiondetail", "worldmemory", "origin" }
	S.description = "Attention Driven Detail World Memory: epoch-stamped persistent history with compaction and checkpoints for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.attentiondetail.world_memory", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
