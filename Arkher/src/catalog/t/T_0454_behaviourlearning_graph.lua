-- ARKHER SYSTEM T.0454 :: Behaviour Learning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0454"
	S.key = "arkher.ai.behaviourlearning.reasoning_graph"
	S.name = "Behaviour Learning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.behaviourlearning.world_architect" }
	S.tags = { "t", "behaviourlearning", "graph", "ai" }
	S.description = "Behaviour Learning Reasoning Graph: relationship modelling and shortest-path reasoning for the Behaviour Learning subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.behaviourlearning.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
