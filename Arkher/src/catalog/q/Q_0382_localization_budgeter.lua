-- ARKHER SYSTEM Q.0382 :: Localization Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0382"
	S.key = "arkher.ui.localization.frame_budget"
	S.name = "Localization Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Localization"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.localization.accessibility_policy" }
	S.tags = { "q", "localization", "budgeter", "ui" }
	S.description = "Localization Frame Budget: per-frame layout and draw budget for the interface for the Localization subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.localization.frame_budget", total = 300, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
