-- ARKHER SYSTEM VC.0095 :: Residency Window Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0095"
	S.key = "arkher.contneural.residencywindow.reality_continuum"
	S.name = "Residency Window Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.residencywindow.simulation_fabric" }
	S.tags = { "vc", "residencywindow", "reality", "contneural" }
	S.description = "Residency Window Reality Continuum: stacked reality layers of the continuum for the Residency Window subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.residencywindow.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
