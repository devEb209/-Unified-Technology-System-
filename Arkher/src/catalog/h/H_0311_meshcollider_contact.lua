-- ARKHER SYSTEM H.0311 :: Mesh Collider Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0311"
	S.key = "arkher.physics.meshcollider.contact_generation"
	S.name = "Mesh Collider Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.meshcollider.collision_shape" }
	S.tags = { "h", "meshcollider", "contact", "physics" }
	S.description = "Mesh Collider Contact Generation: narrow-phase manifolds with normal, depth and point for the Mesh Collider subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.meshcollider.contact_generation", slop = 0.0070, maxManifolds = 397 })
		inst.system = S
		inst.ctx = ctx
