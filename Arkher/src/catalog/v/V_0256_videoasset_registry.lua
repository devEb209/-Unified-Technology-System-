-- ARKHER SYSTEM V.0256 :: Video Asset Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0256"
	S.key = "arkher.asset.videoasset.asset_registry"
	S.name = "Video Asset Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.videoasset.cook_pipeline" }
	S.tags = { "v", "videoasset", "registry", "asset" }
	S.description = "Video Asset Asset Registry: catalogue of every asset, its tags and its metadata for the Video Asset subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.videoasset.asset_registry" })
		inst.system = S
		inst.ctx = ctx
