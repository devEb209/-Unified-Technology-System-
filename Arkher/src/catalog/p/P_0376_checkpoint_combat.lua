-- ARKHER SYSTEM P.0376 :: Checkpoint Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0376"
	S.key = "arkher.play.checkpoint.combat_resolution"
	S.name = "Checkpoint Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Checkpoint"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.checkpoint.objectives" }
	S.tags = { "p", "checkpoint", "combat", "play" }
	S.description = "Checkpoint Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Checkpoint subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.checkpoint.combat_resolution", seed = 70222, armourK = 140, critMultiplier = 2.50 })
		inst.system = S
		inst.ctx = ctx
