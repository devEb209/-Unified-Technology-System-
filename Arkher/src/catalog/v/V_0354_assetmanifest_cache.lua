-- ARKHER SYSTEM V.0354 :: Manifest Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0354"
	S.key = "arkher.asset.assetmanifest.content_cache"
	S.name = "Manifest Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetmanifest.dependency_graph" }
	S.tags = { "v", "assetmanifest", "cache", "asset" }
	S.description = "Manifest Content Cache: reuse of already cooked results for the Manifest subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.assetmanifest.content_cache", policy = "lru", capacity = 97, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
