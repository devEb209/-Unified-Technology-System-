-- ARKHER SYSTEM VA.0577 :: Thermal Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0577"
	S.key = "arkher.contworld.thermalcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "thermalcont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.thermalcont.infinite_grid", cellSize = 64, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
