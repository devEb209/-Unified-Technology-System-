-- ARKHER SYSTEM F.0478 :: Impostor Rendering View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0478"
	S.key = "arkher.render.impostorrender.view_and_culling"
	S.name = "Impostor Rendering View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.impostorrender.frame_graph" }
	S.tags = { "f", "impostorrender", "camera", "render" }
	S.description = "Impostor Rendering View And Culling: view state, frustum culling and screen-size LOD for the Impostor Rendering subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.impostorrender.view_and_culling", width = 1084, height = 1260, fov = 1.1700, far = 1800 })
		inst.system = S
		inst.ctx = ctx
