-- ARKHER SYSTEM Q.0035 :: Button Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0035"
	S.key = "arkher.ui.button.usability_analysis"
	S.name = "Button Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Button"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.button.frame_budget" }
	S.tags = { "q", "button", "analyzer", "ui" }
	S.description = "Button Usability Analysis: reachability, latency and abandonment analysis for the Button subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.button.usability_analysis", window = 150, buckets = 14, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
