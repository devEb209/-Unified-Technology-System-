-- ARKHER SYSTEM F.0156 :: Volumetric Light View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0156"
	S.key = "arkher.render.volumetric.view_and_culling"
	S.name = "Volumetric Light View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.volumetric.frame_graph" }
	S.tags = { "f", "volumetric", "camera", "render" }
	S.description = "Volumetric Light View And Culling: view state, frustum culling and screen-size LOD for the Volumetric Light subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.volumetric.view_and_culling", width = 956, height = 1260, fov = 1.2100, far = 1400 })
		inst.system = S
		inst.ctx = ctx
