-- ARKHER SYSTEM T.0122 :: Long Term Memory Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0122"
	S.key = "arkher.ai.longtermmemory.utility_selection"
	S.name = "Long Term Memory Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.longtermmemory.working_memory" }
	S.tags = { "t", "longtermmemory", "utility", "ai" }
	S.description = "Long Term Memory Utility Selection: scored choice between competing courses of action for the Long Term Memory subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.longtermmemory.utility_selection", momentum = 0.04 })
		inst.system = S
		inst.ctx = ctx
