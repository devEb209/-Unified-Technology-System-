-- ARKHER SYSTEM R.0009 :: Session Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0009"
	S.key = "arkher.net.session.session_registry"
	S.name = "Session Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Session"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.session.rate_guard" }
	S.tags = { "r", "session", "registry", "net" }
	S.description = "Session Session Registry: catalogue of sessions, players and their metadata for the Session subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.session.session_registry" })
		inst.system = S
		inst.ctx = ctx
