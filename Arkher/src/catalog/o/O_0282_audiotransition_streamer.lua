-- ARKHER SYSTEM O.0282 :: Transition Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0282"
	S.key = "arkher.audio.audiotransition.streaming"
	S.name = "Transition Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Transition"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiotransition.voice_budget" }
	S.tags = { "o", "audiotransition", "streamer", "audio" }
	S.description = "Transition Streaming: distance-driven residency of audio assets for the Transition subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.audiotransition.streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
