-- ARKHER SYSTEM P.0147 :: Crafting Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0147"
	S.key = "arkher.play.crafting.objectives"
	S.name = "Crafting Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Crafting"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.crafting.inventory" }
	S.tags = { "p", "crafting", "quest", "play" }
	S.description = "Crafting Objectives: objectives, prerequisites, progress and rewards for the Crafting subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.crafting.objectives" })
		inst.system = S
		inst.ctx = ctx
