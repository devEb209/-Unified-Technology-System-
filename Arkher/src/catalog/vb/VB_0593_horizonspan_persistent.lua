-- ARKHER SYSTEM VB.0593 :: Horizon Span Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0593"
	S.key = "arkher.conttime.horizonspan.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.horizonspan.multi-scale_fidelity" }
	S.tags = { "vb", "horizonspan", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.horizonspan.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
