-- ARKHER SYSTEM VB.0415 :: Behaviour Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0415"
	S.key = "arkher.conttime.behaviourcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.behaviourcont.coherence_guard" }
	S.tags = { "vb", "behaviourcont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.behaviourcont.neural_field", dims = 12, hidden = 8, seed = 46640 })
		inst.system = S
		inst.ctx = ctx
