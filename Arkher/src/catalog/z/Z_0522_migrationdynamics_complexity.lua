-- ARKHER SYSTEM Z.0522 :: Migration Dynamics Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0522"
	S.key = "arkher.origin.migrationdynamics.complexity_governance"
	S.name = "Migration Dynamics Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.migrationdynamics.reality_layering" }
	S.tags = { "z", "migrationdynamics", "complexity", "origin" }
	S.description = "Migration Dynamics Complexity Governance: measured scene cost turned into per-subsystem directives for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.migrationdynamics.complexity_governance", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
