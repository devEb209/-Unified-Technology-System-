-- ARKHER SYSTEM O.0297 :: UI Sound Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0297"
	S.key = "arkher.audio.uisound.playback_policy"
	S.name = "UI Sound Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "UI Sound"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.uisound.compression_codec" }
	S.tags = { "o", "uisound", "policy", "audio" }
	S.description = "UI Sound Playback Policy: rules choosing what may be heard right now for the UI Sound subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.uisound.playback_policy", algorithm = "wfq", starvationGuard = 18 })
		inst.system = S
		inst.ctx = ctx
