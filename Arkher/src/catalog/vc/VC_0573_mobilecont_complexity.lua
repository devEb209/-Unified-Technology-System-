-- ARKHER SYSTEM VC.0573 :: Mobile Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0573"
	S.key = "arkher.contneural.mobilecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.mobilecont.world_memory_stream" }
	S.tags = { "vc", "mobilecont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.mobilecont.complexity_budget", targetMs = 19.0 })
		inst.system = S
		inst.ctx = ctx
