-- ARKHER SYSTEM P.0370 :: Death And Respawn Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0370"
	S.key = "arkher.play.deathrespawn.content_registry"
	S.name = "Death And Respawn Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.deathrespawn.difficulty_controller" }
	S.tags = { "p", "deathrespawn", "registry", "play" }
	S.description = "Death And Respawn Content Registry: catalogue of the definitions this loop instantiates for the Death And Respawn subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.deathrespawn.content_registry" })
		inst.system = S
		inst.ctx = ctx
