-- ARKHER SYSTEM H.0695 :: Overlap Query Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0695"
	S.key = "arkher.physics.overlap.budget_governor"
	S.name = "Overlap Query Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.overlap.broadphase_index" }
	S.tags = { "h", "overlap", "budgeter", "physics" }
	S.description = "Overlap Query Budget Governor: simulation time budget allocation across islands for the Overlap Query subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.overlap.budget_governor", total = 358, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
