-- ARKHER SYSTEM L.0407 :: Taxation Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0407"
	S.key = "arkher.sim.taxation.ecology"
	S.name = "Taxation Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.taxation.simulation_core" }
	S.tags = { "l", "taxation", "ecology", "sim" }
	S.description = "Taxation Ecology: populations, predation, harvesting and carrying capacity for the Taxation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.taxation.ecology" })
		inst.system = S
		inst.ctx = ctx
