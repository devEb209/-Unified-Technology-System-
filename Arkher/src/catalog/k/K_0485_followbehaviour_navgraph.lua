-- ARKHER SYSTEM K.0485 :: Follow Behaviour Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0485"
	S.key = "arkher.npc.followbehaviour.navigation"
	S.name = "Follow Behaviour Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.followbehaviour.goal_planner" }
	S.tags = { "k", "followbehaviour", "navgraph", "npc" }
	S.description = "Follow Behaviour Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Follow Behaviour subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.followbehaviour.navigation", width = 48, height = 48, cellSize = 5 })
		inst.system = S
		inst.ctx = ctx
