-- ARKHER SYSTEM G.0201 :: Ambient Occlusion Prediction Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0201"
	S.key = "arkher.neural.aopredict.model_registry"
	S.name = "Ambient Occlusion Prediction Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.aopredict.reconstruction" }
	S.tags = { "g", "aopredict", "registry", "neural" }
	S.description = "Ambient Occlusion Prediction Model Registry: named models and their lifecycle for the Ambient Occlusion Prediction subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.aopredict.model_registry" })
		inst.system = S
		inst.ctx = ctx
