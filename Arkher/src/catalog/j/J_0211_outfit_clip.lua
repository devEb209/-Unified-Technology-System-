-- ARKHER SYSTEM J.0211 :: Outfit Composition Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0211"
	S.key = "arkher.character.outfit.motion_set"
	S.name = "Outfit Composition Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.outfit.rig_definition" }
	S.tags = { "j", "outfit", "clip", "character" }
	S.description = "Outfit Composition Motion Set: the clips a character owns and how they sample for the Outfit Composition subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.outfit.motion_set", duration = 2.00, loop = false })
		inst.system = S
		inst.ctx = ctx
