-- ARKHER SYSTEM VC.0114 :: Temporal Slice Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0114"
	S.key = "arkher.contneural.temporalslice.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.temporalslice.persistent_state" }
	S.tags = { "vc", "temporalslice", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.temporalslice.coherence_guard", window = 53, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
