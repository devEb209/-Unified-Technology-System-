-- ARKHER SYSTEM P.0365 :: Death And Respawn State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0365"
	S.key = "arkher.play.deathrespawn.state_machine"
	S.name = "Death And Respawn State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.deathrespawn.combat_resolution" }
	S.tags = { "p", "deathrespawn", "orchestrator", "play" }
	S.description = "Death And Respawn State Machine: the phase machine that drives this gameplay loop for the Death And Respawn subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.deathrespawn.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
