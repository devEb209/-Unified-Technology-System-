-- ARKHER SYSTEM VD.0260 :: Road Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0260"
	S.key = "arkher.contsim.roadcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.roadcont.neural_field" }
	S.tags = { "vd", "roadcont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.roadcont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
