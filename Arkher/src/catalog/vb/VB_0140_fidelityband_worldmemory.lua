-- ARKHER SYSTEM VB.0140 :: Fidelity Band World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0140"
	S.key = "arkher.conttime.fidelityband.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.fidelityband.neural_field" }
	S.tags = { "vb", "fidelityband", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.fidelityband.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
