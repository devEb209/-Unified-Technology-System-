-- ARKHER SYSTEM F.0236 :: Water Rendering Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0236"
	S.key = "arkher.render.water.frame_analysis"
	S.name = "Water Rendering Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.water.pass_cache" }
	S.tags = { "f", "water", "analyzer", "render" }
	S.description = "Water Rendering Frame Analysis: per-pass cost analysis and outlier detection for the Water Rendering subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.water.frame_analysis", window = 115, buckets = 19, threshold = 3.70 })
		inst.system = S
		inst.ctx = ctx
