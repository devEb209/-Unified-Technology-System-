-- ARKHER SYSTEM VB.0026 :: Zone Chunk Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0026"
	S.key = "arkher.conttime.zonechunk.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.zonechunk.infinite_grid" }
	S.tags = { "vb", "zonechunk", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.zonechunk.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
