-- ARKHER SYSTEM J.0234 :: Body Type Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0234"
	S.key = "arkher.character.bodytype.blend_controller"
	S.name = "Body Type Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.bodytype.motion_set" }
	S.tags = { "j", "bodytype", "animator", "character" }
	S.description = "Body Type Blend Controller: layered playback driving the character for the Body Type subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.bodytype.blend_controller", budget = 8 })
		inst.system = S
		inst.ctx = ctx
