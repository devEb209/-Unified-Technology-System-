-- ARKHER SYSTEM E.0287 :: Wear And Tear Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0287"
	S.key = "arkher.material.wear.layer_composition"
	S.name = "Wear And Tear Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.wear.definition" }
	S.tags = { "e", "wear", "composer", "material" }
	S.description = "Wear And Tear Layer Composition: ordered layer composition with blend rules for the Wear And Tear subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.wear.layer_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
