--!strict
-- Roblox Studio — ANIMATION Stack #0235
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Roblox Studio — ANIMATION Stack #0235", size=Vector2.new(640, 420), pos=UDim2.fromOffset(355, 175), parent=parent, icon="✦"})
