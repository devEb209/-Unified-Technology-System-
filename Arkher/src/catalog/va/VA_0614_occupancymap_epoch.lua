-- ARKHER SYSTEM VA.0614 :: Occupancy Map Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0614"
	S.key = "arkher.contworld.occupancymap.epoch_clock"
	S.name = "Occupancy Map Epoch Clock"
	S.category = "VA"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.occupancymap.infinite_grid" }
	S.tags = { "va", "occupancymap", "epoch", "contworld" }
	S.description = "Occupancy Map Epoch Clock: deterministic epoch timeline with catch-up for the Occupancy Map subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.occupancymap.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
