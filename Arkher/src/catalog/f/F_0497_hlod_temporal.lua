-- ARKHER SYSTEM F.0497 :: HLOD Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0497"
	S.key = "arkher.render.hlod.temporal_resolve"
	S.name = "HLOD Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "HLOD"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.hlod.probe_volume" }
	S.tags = { "f", "hlod", "temporal", "render" }
	S.description = "HLOD Temporal Resolve: history reprojection with neighbourhood clamping for the HLOD subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.hlod.temporal_resolve", feedback = 0.86, phase = 8 })
		inst.system = S
		inst.ctx = ctx
