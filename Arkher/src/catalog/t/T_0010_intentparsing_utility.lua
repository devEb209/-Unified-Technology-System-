-- ARKHER SYSTEM T.0010 :: Intent Parsing Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0010"
	S.key = "arkher.ai.intentparsing.utility_selection"
	S.name = "Intent Parsing Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.intentparsing.working_memory" }
	S.tags = { "t", "intentparsing", "utility", "ai" }
	S.description = "Intent Parsing Utility Selection: scored choice between competing courses of action for the Intent Parsing subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.intentparsing.utility_selection", momentum = 0.03 })
		inst.system = S
		inst.ctx = ctx
