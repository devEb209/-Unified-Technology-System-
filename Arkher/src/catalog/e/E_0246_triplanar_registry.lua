-- ARKHER SYSTEM E.0246 :: Triplanar Projection Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0246"
	S.key = "arkher.material.triplanar.variant_registry"
	S.name = "Triplanar Projection Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.triplanar.procedural_detail" }
	S.tags = { "e", "triplanar", "registry", "material" }
	S.description = "Triplanar Projection Variant Registry: named variants and their lifecycle for the Triplanar Projection subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.triplanar.variant_registry" })
		inst.system = S
		inst.ctx = ctx
