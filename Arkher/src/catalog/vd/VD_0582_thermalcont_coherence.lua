-- ARKHER SYSTEM VD.0582 :: Thermal Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0582"
	S.key = "arkher.contsim.thermalcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.thermalcont.persistent_state" }
	S.tags = { "vd", "thermalcont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.thermalcont.coherence_guard", window = 136, threshold = 0.14 })
		inst.system = S
		inst.ctx = ctx
