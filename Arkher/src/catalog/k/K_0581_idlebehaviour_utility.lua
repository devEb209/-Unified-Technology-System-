-- ARKHER SYSTEM K.0581 :: Idle Behaviour Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0581"
	S.key = "arkher.npc.idlebehaviour.utility_reasoning"
	S.name = "Idle Behaviour Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.idlebehaviour.reactive_behaviour" }
	S.tags = { "k", "idlebehaviour", "utility", "npc" }
	S.description = "Idle Behaviour Utility Reasoning: scored option selection with response curves for the Idle Behaviour subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.idlebehaviour.utility_reasoning", momentum = 0.12 })
		inst.system = S
		inst.ctx = ctx
