-- ARKHER SYSTEM H.0557 :: Cloth Simulation Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0557"
	S.key = "arkher.physics.cloth.result_cache"
	S.name = "Cloth Simulation Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.cloth.simulation_policy" }
	S.tags = { "h", "cloth", "cache", "physics" }
	S.description = "Cloth Simulation Result Cache: reuse of expensive simulation and query results for the Cloth Simulation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.cloth.result_cache", policy = "lru", capacity = 139, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
