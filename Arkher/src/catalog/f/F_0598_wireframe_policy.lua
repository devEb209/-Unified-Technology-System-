-- ARKHER SYSTEM F.0598 :: Wireframe Overlay Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0598"
	S.key = "arkher.render.wireframe.render_policy"
	S.name = "Wireframe Overlay Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.wireframe.draw_budget" }
	S.tags = { "f", "wireframe", "policy", "render" }
	S.description = "Wireframe Overlay Render Policy: device tier rules for the frame for the Wireframe Overlay subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.wireframe.render_policy", algorithm = "lottery", starvationGuard = 19 })
		inst.system = S
		inst.ctx = ctx
