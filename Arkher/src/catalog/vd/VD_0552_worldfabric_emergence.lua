-- ARKHER SYSTEM VD.0552 :: World Fabric Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0552"
	S.key = "arkher.contsim.worldfabric.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldfabric.reality_continuum" }
	S.tags = { "vd", "worldfabric", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.worldfabric.emergence_continuum", windowSize = 5, threshold = 1.40, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
