...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Cascadeur — CORE Map #0258", size=Vector2.new(600, 480), pos=UDim2.fromOffset(254, 306), parent=parent, icon="◣"})
