-- ARKHER SYSTEM VA.0421 :: Navigation Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0421"
	S.key = "arkher.contworld.navcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "navcont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.navcont.infinite_grid", cellSize = 160, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
