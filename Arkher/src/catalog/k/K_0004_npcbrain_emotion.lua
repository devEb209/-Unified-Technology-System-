-- ARKHER SYSTEM K.0004 :: NPC Brain Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0004"
	S.key = "arkher.npc.npcbrain.emotion"
	S.name = "NPC Brain Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcbrain.drive_system" }
	S.tags = { "k", "npcbrain", "emotion", "npc" }
	S.description = "NPC Brain Emotion: appraisal of events into valence, arousal and mood for the NPC Brain subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.npcbrain.emotion", inertia = 0.89, decayRate = 0.34, baselineArousal = 0.24 })
		inst.system = S
		inst.ctx = ctx
