-- ARKHER SYSTEM Z.0968 :: Generation Migration Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0968"
	S.key = "arkher.origin.generationmigration.semantic_graph"
	S.name = "Generation Migration Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.world_architect" }
	S.tags = { "z", "generationmigration", "knowledge", "origin" }
	S.description = "Generation Migration Semantic Graph: typed entities and inferred relations of the technology itself for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.generationmigration.semantic_graph", dims = 32 })
		inst.system = S
		inst.ctx = ctx
