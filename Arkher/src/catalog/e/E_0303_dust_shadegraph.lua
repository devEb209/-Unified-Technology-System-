-- ARKHER SYSTEM E.0303 :: Dust Accumulation Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0303"
	S.key = "arkher.material.dust.shading_graph"
	S.name = "Dust Accumulation Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.dust.layer_composition" }
	S.tags = { "e", "dust", "shadegraph", "material" }
	S.description = "Dust Accumulation Shading Graph: node graph evaluated and compiled to Luau for the Dust Accumulation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.dust.shading_graph" })
		inst.system = S
		inst.ctx = ctx
