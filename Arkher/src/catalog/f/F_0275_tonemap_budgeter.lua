-- ARKHER SYSTEM F.0275 :: Tonemapping Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0275"
	S.key = "arkher.render.tonemap.draw_budget"
	S.name = "Tonemapping Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Tonemapping"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.tonemap.adaptive_resolution" }
	S.tags = { "f", "tonemap", "budgeter", "render" }
	S.description = "Tonemapping Draw Budget: draw call and triangle budget allocation for the Tonemapping subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.tonemap.draw_budget", total = 141, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
