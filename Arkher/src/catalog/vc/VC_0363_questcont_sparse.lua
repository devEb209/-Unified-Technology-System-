-- ARKHER SYSTEM VC.0363 :: Quest Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0363"
	S.key = "arkher.contneural.questcont.sparse_residency"
	S.name = "Quest Continuum Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.questcont.epoch_clock" }
	S.tags = { "vc", "questcont", "sparse", "contneural" }
	S.description = "Quest Continuum Sparse Residency: sparse page residency with eviction and compression for the Quest Continuum subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.questcont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
