-- ARKHER SYSTEM VB.0073 :: LOD Cascade Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0073"
	S.key = "arkher.conttime.lodcascade.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "lodcascade", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.lodcascade.infinite_grid", cellSize = 96, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
