-- ARKHER SYSTEM J.0045 :: Hair Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0045"
	S.key = "arkher.character.hair.rig_definition"
	S.name = "Hair Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "hair", "skeleton", "character" }
	S.description = "Hair Rig Definition: character rig definition and bone budget for the Hair subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.hair.rig_definition" })
		inst.system = S
		inst.ctx = ctx
