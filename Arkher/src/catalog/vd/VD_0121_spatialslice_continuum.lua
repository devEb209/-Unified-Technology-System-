-- ARKHER SYSTEM VD.0121 :: Spatial Slice Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0121"
	S.key = "arkher.contsim.spatialslice.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "spatialslice", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.spatialslice.infinite_grid", cellSize = 160, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
