-- ARKHER SYSTEM Z.0426 :: Offline World Progression Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0426"
	S.key = "arkher.origin.offlineprogression.emergence_detection"
	S.name = "Offline World Progression Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.world_memory" }
	S.tags = { "z", "offlineprogression", "emergence", "origin" }
	S.description = "Offline World Progression Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.offlineprogression.emergence_detection", windowSize = 4, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
