-- ARKHER SYSTEM G.0057 :: Motion Vector Estimation Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0057"
	S.key = "arkher.neural.motionvector.inference_core"
	S.name = "Motion Vector Estimation Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "motionvector", "inference", "neural" }
	S.description = "Motion Vector Estimation Inference Core: dense network forward pass and training for the Motion Vector Estimation subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.motionvector.inference_core", seed = 44600 })
		inst.system = S
		inst.ctx = ctx
