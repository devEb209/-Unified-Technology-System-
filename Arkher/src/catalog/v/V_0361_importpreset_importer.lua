-- ARKHER SYSTEM V.0361 :: Import Preset Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0361"
	S.key = "arkher.asset.importpreset.import"
	S.name = "Import Preset Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "importpreset", "importer", "asset" }
	S.description = "Import Preset Import: validation, normalization, hashing and deduplication of incoming content for the Import Preset subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.importpreset.import", unitScale = 1.75 })
		inst.system = S
		inst.ctx = ctx
