-- ARKHER SYSTEM K.0402 :: Plan Execution Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0402"
	S.key = "arkher.npc.planexecution.crowd_steering"
	S.name = "Plan Execution Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.planexecution.navigation" }
	S.tags = { "k", "planexecution", "crowd", "npc" }
	S.description = "Plan Execution Crowd Steering: local avoidance, cohesion and arrival at scale for the Plan Execution subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.planexecution.crowd_steering", radius = 0.40, maxSpeed = 5.00, cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
