-- ARKHER SYSTEM F.0561 :: UI Rendering Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0561"
	S.key = "arkher.render.uirender.frame_graph"
	S.name = "UI Rendering Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "UI Rendering"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "uirender", "framegraph", "render" }
	S.description = "UI Rendering Frame Graph: declared passes, culling, ordering and aliasing for the UI Rendering subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.uirender.frame_graph", budgetMs = 10.00 })
		inst.system = S
		inst.ctx = ctx
