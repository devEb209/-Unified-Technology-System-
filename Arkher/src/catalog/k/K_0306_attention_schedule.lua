-- ARKHER SYSTEM K.0306 :: Attention Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0306"
	S.key = "arkher.npc.attention.daily_schedule"
	S.name = "Attention Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.attention.social_relations" }
	S.tags = { "k", "attention", "schedule", "npc" }
	S.description = "Attention Daily Schedule: hour-by-hour routine with priority interruptions for the Attention subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.attention.daily_schedule", startHour = 8 })
		inst.system = S
		inst.ctx = ctx
