-- ARKHER SYSTEM Z.0110 :: Universal Simulation Fabric Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0110"
	S.key = "arkher.origin.simfabric.self_critique"
	S.name = "Universal Simulation Fabric Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.simfabric.intent_bridge" }
	S.tags = { "z", "simfabric", "critic", "origin" }
	S.description = "Universal Simulation Fabric Self Critique: weighted judgement of the technology's own output for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.simfabric.self_critique", passMark = 0.81, reviseMark = 0.41, seed = 81611 })
		inst.system = S
		inst.ctx = ctx
