-- ARKHER SYSTEM J.0196 :: Armor Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0196"
	S.key = "arkher.character.armor.budget_governor"
	S.name = "Armor Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.armor.variant_registry" }
	S.tags = { "j", "armor", "budgeter", "character" }
	S.description = "Armor Budget Governor: per-character cost allocation in a crowd for the Armor subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.armor.budget_governor", total = 366, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
