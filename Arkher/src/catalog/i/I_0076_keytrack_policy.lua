-- ARKHER SYSTEM I.0076 :: Keyframe Track Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0076"
	S.key = "arkher.anim.keytrack.quality_policy"
	S.name = "Keyframe Track Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.keytrack.pose_cache" }
	S.tags = { "i", "keytrack", "policy", "anim" }
	S.description = "Keyframe Track Quality Policy: device tier rules for rate, bones and solvers for the Keyframe Track subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.keytrack.quality_policy", algorithm = "lottery", starvationGuard = 27 })
		inst.system = S
		inst.ctx = ctx
