-- ARKHER SYSTEM L.0490 :: Diplomacy Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0490"
	S.key = "arkher.sim.diplomacy.streaming"
	S.name = "Diplomacy Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.diplomacy.state_codec" }
	S.tags = { "l", "diplomacy", "streamer", "sim" }
	S.description = "Diplomacy Streaming: distance-driven residency of simulated regions for the Diplomacy subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.diplomacy.streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
