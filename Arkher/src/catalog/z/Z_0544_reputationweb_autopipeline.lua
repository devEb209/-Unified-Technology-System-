-- ARKHER SYSTEM Z.0544 :: Reputation Web Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0544"
	S.key = "arkher.origin.reputationweb.autonomous_pipeline"
	S.name = "Reputation Web Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.simulation_fabric" }
	S.tags = { "z", "reputationweb", "autopipeline", "origin" }
	S.description = "Reputation Web Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.reputationweb.autonomous_pipeline", maxIterations = 11 })
		inst.system = S
		inst.ctx = ctx
