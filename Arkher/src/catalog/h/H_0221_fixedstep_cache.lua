-- ARKHER SYSTEM H.0221 :: Fixed Timestep Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0221"
	S.key = "arkher.physics.fixedstep.result_cache"
	S.name = "Fixed Timestep Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.fixedstep.simulation_policy" }
	S.tags = { "h", "fixedstep", "cache", "physics" }
	S.description = "Fixed Timestep Result Cache: reuse of expensive simulation and query results for the Fixed Timestep subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.fixedstep.result_cache", policy = "lfu", capacity = 428, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
