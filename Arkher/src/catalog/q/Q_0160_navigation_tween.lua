-- ARKHER SYSTEM Q.0160 :: Navigation Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0160"
	S.key = "arkher.ui.navigation.transition"
	S.name = "Navigation Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Navigation"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.navigation.input_mapping" }
	S.tags = { "q", "navigation", "tween", "ui" }
	S.description = "Navigation Transition: eased, delayed, looped and sequenced motion for the Navigation subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.navigation.transition", timeScale = 1.00 })
		inst.system = S
		inst.ctx = ctx
