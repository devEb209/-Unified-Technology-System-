-- ARKHER SYSTEM K.0026 :: Neural Policy Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0026"
	S.key = "arkher.npc.neuralpolicy.daily_schedule"
	S.name = "Neural Policy Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.neuralpolicy.social_relations" }
	S.tags = { "k", "neuralpolicy", "schedule", "npc" }
	S.description = "Neural Policy Daily Schedule: hour-by-hour routine with priority interruptions for the Neural Policy subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.neuralpolicy.daily_schedule", startHour = 6 })
		inst.system = S
		inst.ctx = ctx
