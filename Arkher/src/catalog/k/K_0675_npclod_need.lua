-- ARKHER SYSTEM K.0675 :: NPC LOD Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0675"
	S.key = "arkher.npc.npclod.drive_system"
	S.name = "NPC LOD Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npclod.memory" }
	S.tags = { "k", "npclod", "need", "npc" }
	S.description = "NPC LOD Drive System: drives that decay, turn urgent and get satisfied for the NPC LOD subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.npclod.drive_system" })
		inst.system = S
		inst.ctx = ctx
