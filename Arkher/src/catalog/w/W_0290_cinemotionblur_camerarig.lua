-- ARKHER SYSTEM W.0290 :: Motion Blur Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0290"
	S.key = "arkher.cine.cinemotionblur.camera_rig"
	S.name = "Motion Blur Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Motion Blur"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinemotionblur.sequence_timeline" }
	S.tags = { "w", "cinemotionblur", "camerarig", "cine" }
	S.description = "Motion Blur Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.cinemotionblur.camera_rig", fov = 1.14, focus = 6.0, aperture = 1.4, smoothing = 6.0, distance = 8, height = 2 })
		inst.system = S
		inst.ctx = ctx
