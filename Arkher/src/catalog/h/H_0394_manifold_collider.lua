-- ARKHER SYSTEM H.0394 :: Contact Manifold Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0394"
	S.key = "arkher.physics.manifold.collision_shape"
	S.name = "Contact Manifold Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.manifold.body_dynamics" }
	S.tags = { "h", "manifold", "collider", "physics" }
	S.description = "Contact Manifold Collision Shape: shape bounds, support mapping and closest points for the Contact Manifold subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.manifold.collision_shape", shape = "capsule", radius = 2.40, height = 2.00, layer = "default" })
		inst.system = S
		inst.ctx = ctx
