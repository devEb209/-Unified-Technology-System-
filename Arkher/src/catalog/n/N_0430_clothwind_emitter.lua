-- ARKHER SYSTEM N.0430 :: Cloth Wind Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0430"
	S.key = "arkher.vfx.clothwind.emission"
	S.name = "Cloth Wind Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloth Wind"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "clothwind", "emitter", "vfx" }
	S.description = "Cloth Wind Emission: shaped, rate and burst emission of new particles for the Cloth Wind subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.clothwind.emission", shape = "cone", rate = 36, speed = 4.60, life = 2.40, budget = 128, seed = 86896 })
		inst.system = S
		inst.ctx = ctx
