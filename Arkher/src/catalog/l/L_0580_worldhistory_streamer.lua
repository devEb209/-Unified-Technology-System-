-- ARKHER SYSTEM L.0580 :: World History Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0580"
	S.key = "arkher.sim.worldhistory.streaming"
	S.name = "World History Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldhistory.state_codec" }
	S.tags = { "l", "worldhistory", "streamer", "sim" }
	S.description = "World History Streaming: distance-driven residency of simulated regions for the World History subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.worldhistory.streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
