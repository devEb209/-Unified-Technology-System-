-- ARKHER SYSTEM VA.0593 :: Horizon Span Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0593"
	S.key = "arkher.contworld.horizonspan.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.horizonspan.multi-scale_fidelity" }
	S.tags = { "va", "horizonspan", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.horizonspan.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
