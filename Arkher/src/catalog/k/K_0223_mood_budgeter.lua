-- ARKHER SYSTEM K.0223 :: Mood Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0223"
	S.key = "arkher.npc.mood.thinking_budget"
	S.name = "Mood Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.mood.daily_schedule" }
	S.tags = { "k", "mood", "budgeter", "npc" }
	S.description = "Mood Thinking Budget: allocation of per-frame thinking time across NPCs for the Mood subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.mood.thinking_budget", total = 286, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
