-- ARKHER SYSTEM E.0117 :: Ambient Occlusion Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0117"
	S.key = "arkher.material.ao.analysis"
	S.name = "Ambient Occlusion Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.ao.instance_cache" }
	S.tags = { "e", "ao", "analyzer", "material" }
	S.description = "Ambient Occlusion Analysis: cost, redundancy and outlier analysis for the Ambient Occlusion subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.ao.analysis", window = 90, buckets = 10, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
