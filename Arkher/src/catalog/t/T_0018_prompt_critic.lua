-- ARKHER SYSTEM T.0018 :: Prompt Understanding Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0018"
	S.key = "arkher.ai.prompt.self_critique"
	S.name = "Prompt Understanding Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.prompt.plan_workflow" }
	S.tags = { "t", "prompt", "critic", "ai" }
	S.description = "Prompt Understanding Self Critique: weighted evaluation of the result against declared criteria for the Prompt Understanding subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.prompt.self_critique", passMark = 0.78, reviseMark = 0.48, seed = 97778 })
		inst.system = S
		inst.ctx = ctx
