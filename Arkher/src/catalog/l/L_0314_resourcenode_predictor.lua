-- ARKHER SYSTEM L.0314 :: Resource Node Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0314"
	S.key = "arkher.sim.resourcenode.forecast"
	S.name = "Resource Node Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.resourcenode.analysis" }
	S.tags = { "l", "resourcenode", "predictor", "sim" }
	S.description = "Resource Node Forecast: prediction of the region's next state for the Resource Node subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.resourcenode.forecast", method = "ema", alpha = 0.33, window = 47 })
		inst.system = S
		inst.ctx = ctx
