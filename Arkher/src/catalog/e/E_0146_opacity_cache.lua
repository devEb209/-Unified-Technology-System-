-- ARKHER SYSTEM E.0146 :: Opacity Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0146"
	S.key = "arkher.material.opacity.instance_cache"
	S.name = "Opacity Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Opacity"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.opacity.quality_policy" }
	S.tags = { "e", "opacity", "cache", "material" }
	S.description = "Opacity Instance Cache: resolved-parameter cache keyed by context for the Opacity subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.opacity.instance_cache", policy = "ttl", capacity = 461, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
