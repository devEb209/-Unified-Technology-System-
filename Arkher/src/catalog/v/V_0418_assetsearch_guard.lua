-- ARKHER SYSTEM V.0418 :: Asset Search Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0418"
	S.key = "arkher.asset.assetsearch.validation_guard"
	S.name = "Asset Search Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetsearch.size_budget" }
	S.tags = { "v", "assetsearch", "guard", "asset" }
	S.description = "Asset Search Validation Guard: rate limiting and capability checks on the import path for the Asset Search subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.assetsearch.validation_guard", algorithm = "sliding", capacity = 82, refillPerSec = 27, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
