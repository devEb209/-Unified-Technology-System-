-- ARKHER SYSTEM J.0139 :: Blinking Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0139"
	S.key = "arkher.character.blinking.appearance_composer"
	S.name = "Blinking Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.blinking.locomotion" }
	S.tags = { "j", "blinking", "composer", "character" }
	S.description = "Blinking Appearance Composer: composition of appearance slots into a look for the Blinking subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.blinking.appearance_composer", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
	...
	function inst.dominantLayer()
		...
		function inst.integrate(engine)
			...
			inst.engine = engine
			if engine.bus then
				engine.bus:subscribe("arkher.character.blinking.*", function(payload) inst.lastSignal = payload end)
			end
