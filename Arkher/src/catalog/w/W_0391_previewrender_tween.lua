-- ARKHER SYSTEM W.0391 :: Preview Render Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0391"
	S.key = "arkher.cine.previewrender.motion_tween"
	S.name = "Preview Render Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.previewrender.playback_orchestrator" }
	S.tags = { "w", "previewrender", "tween", "cine" }
	S.description = "Preview Render Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Preview Render subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.previewrender.motion_tween", timeScale = 1.12 })
		inst.system = S
		inst.ctx = ctx
