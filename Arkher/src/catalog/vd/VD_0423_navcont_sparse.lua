-- ARKHER SYSTEM VD.0423 :: Navigation Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0423"
	S.key = "arkher.contsim.navcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.navcont.epoch_clock" }
	S.tags = { "vd", "navcont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.navcont.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
