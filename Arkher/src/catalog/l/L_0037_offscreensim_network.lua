-- ARKHER SYSTEM L.0037 :: Offscreen Simulation Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0037"
	S.key = "arkher.sim.offscreensim.route_network"
	S.name = "Offscreen Simulation Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.offscreensim.region_graph" }
	S.tags = { "l", "offscreensim", "network", "sim" }
	S.description = "Offscreen Simulation Route Network: roads, rivers and routes between settlements for the Offscreen Simulation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.offscreensim.route_network" })
		inst.system = S
		inst.ctx = ctx
