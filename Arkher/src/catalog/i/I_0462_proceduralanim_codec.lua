-- ARKHER SYSTEM I.0462 :: Procedural Animation Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0462"
	S.key = "arkher.anim.proceduralanim.compression_codec"
	S.name = "Procedural Animation Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.proceduralanim.retarget_graph" }
	S.tags = { "i", "proceduralanim", "codec", "anim" }
	S.description = "Procedural Animation Compression Codec: curve compression and quantized transport for the Procedural Animation subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.proceduralanim.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
