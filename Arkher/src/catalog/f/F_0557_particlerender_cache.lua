-- ARKHER SYSTEM F.0557 :: Particle Rendering Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0557"
	S.key = "arkher.render.particlerender.pass_cache"
	S.name = "Particle Rendering Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.particlerender.render_policy" }
	S.tags = { "f", "particlerender", "cache", "render" }
	S.description = "Particle Rendering Pass Cache: reuse of pass results across frames for the Particle Rendering subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.particlerender.pass_cache", policy = "lru", capacity = 176, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
