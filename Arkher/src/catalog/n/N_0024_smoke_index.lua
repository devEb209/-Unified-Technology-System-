-- ARKHER SYSTEM N.0024 :: Smoke Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0024"
	S.key = "arkher.vfx.smoke.spatial_index"
	S.name = "Smoke Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Smoke"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.smoke.quality_policy" }
	S.tags = { "n", "smoke", "index", "vfx" }
	S.description = "Smoke Spatial Index: spatial acceleration of effect queries and culling for the Smoke subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.smoke.spatial_index", mode = "hash", cellSize = 72 })
		inst.system = S
		inst.ctx = ctx
