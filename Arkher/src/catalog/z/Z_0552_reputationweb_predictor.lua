-- ARKHER SYSTEM Z.0552 :: Reputation Web Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0552"
	S.key = "arkher.origin.reputationweb.predictive_optimization"
	S.name = "Reputation Web Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.adaptive_workflow" }
	S.tags = { "z", "reputationweb", "predictor", "origin" }
	S.description = "Reputation Web Predictive Optimization: forecast-driven optimization before the cost is paid for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.reputationweb.predictive_optimization", method = "linear", alpha = 0.15, window = 69 })
		inst.system = S
		inst.ctx = ctx
