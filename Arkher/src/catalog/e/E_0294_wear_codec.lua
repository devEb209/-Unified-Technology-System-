-- ARKHER SYSTEM E.0294 :: Wear And Tear Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0294"
	S.key = "arkher.material.wear.compression_codec"
	S.name = "Wear And Tear Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.wear.streaming" }
	S.tags = { "e", "wear", "codec", "material" }
	S.description = "Wear And Tear Compression Codec: serialization and compression of material data for the Wear And Tear subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.wear.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
