-- ARKHER SYSTEM VD.0257 :: Road Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0257"
	S.key = "arkher.contsim.roadcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.roadcont.multi-scale_fidelity" }
	S.tags = { "vd", "roadcont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.roadcont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
