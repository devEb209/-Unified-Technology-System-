-- ARKHER SYSTEM T.0305 :: Difficulty Tuning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0305"
	S.key = "arkher.ai.difficultytuning.action_planner"
	S.name = "Difficulty Tuning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.difficultytuning.utility_selection" }
	S.tags = { "t", "difficultytuning", "planner", "ai" }
	S.description = "Difficulty Tuning Action Planner: goal-oriented action planning over preconditions for the Difficulty Tuning subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.difficultytuning.action_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
