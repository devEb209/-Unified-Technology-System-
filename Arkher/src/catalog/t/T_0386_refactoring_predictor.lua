-- ARKHER SYSTEM T.0386 :: Refactoring Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0386"
	S.key = "arkher.ai.refactoring.outcome_prediction"
	S.name = "Refactoring Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.refactoring.decision_policy" }
	S.tags = { "t", "refactoring", "predictor", "ai" }
	S.description = "Refactoring Outcome Prediction: forecasting the result before the work is done for the Refactoring subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.refactoring.outcome_prediction", method = "ema", alpha = 0.41, window = 71 })
		inst.system = S
		inst.ctx = ctx
