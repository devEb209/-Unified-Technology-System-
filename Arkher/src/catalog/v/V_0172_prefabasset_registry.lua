-- ARKHER SYSTEM V.0172 :: Prefab Asset Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0172"
	S.key = "arkher.asset.prefabasset.asset_registry"
	S.name = "Prefab Asset Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.prefabasset.cook_pipeline" }
	S.tags = { "v", "prefabasset", "registry", "asset" }
	S.description = "Prefab Asset Asset Registry: catalogue of every asset, its tags and its metadata for the Prefab Asset subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.prefabasset.asset_registry" })
		inst.system = S
		inst.ctx = ctx
