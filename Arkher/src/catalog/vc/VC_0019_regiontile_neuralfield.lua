-- ARKHER SYSTEM VC.0019 :: Region Tile Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0019"
	S.key = "arkher.contneural.regiontile.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.regiontile.coherence_guard" }
	S.tags = { "vc", "regiontile", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.regiontile.neural_field", dims = 24, hidden = 20, seed = 62303 })
		inst.system = S
		inst.ctx = ctx
