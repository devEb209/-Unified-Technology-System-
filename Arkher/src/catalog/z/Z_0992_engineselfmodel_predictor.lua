-- ARKHER SYSTEM Z.0992 :: Engine Self Model Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0992"
	S.key = "arkher.origin.engineselfmodel.predictive_optimization"
	S.name = "Engine Self Model Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.engineselfmodel.adaptive_workflow" }
	S.tags = { "z", "engineselfmodel", "predictor", "origin" }
	S.description = "Engine Self Model Predictive Optimization: forecast-driven optimization before the cost is paid for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.engineselfmodel.predictive_optimization", method = "linear", alpha = 0.31, window = 69 })
		inst.system = S
		inst.ctx = ctx
