-- ARKHER SYSTEM K.0297 :: Attention Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0297"
	S.key = "arkher.npc.attention.drive_system"
	S.name = "Attention Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.attention.memory" }
	S.tags = { "k", "attention", "need", "npc" }
	S.description = "Attention Drive System: drives that decay, turn urgent and get satisfied for the Attention subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.attention.drive_system" })
		inst.system = S
		inst.ctx = ctx
