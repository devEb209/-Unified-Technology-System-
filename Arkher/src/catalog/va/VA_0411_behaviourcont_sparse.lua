-- ARKHER SYSTEM VA.0411 :: Behaviour Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0411"
	S.key = "arkher.contworld.behaviourcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.behaviourcont.epoch_clock" }
	S.tags = { "va", "behaviourcont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.behaviourcont.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
