-- ARKHER SYSTEM VC.0198 :: Architect District Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0198"
	S.key = "arkher.contneural.architectdistrict.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.architectdistrict.persistent_state" }
	S.tags = { "vc", "architectdistrict", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.architectdistrict.coherence_guard", window = 131, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
