-- ARKHER SYSTEM N.0082 :: Impact Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0082"
	S.key = "arkher.vfx.impact.ribbon_and_trail"
	S.name = "Impact Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Impact"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.impact.force_field" }
	S.tags = { "n", "impact", "ribbon", "vfx" }
	S.description = "Impact Ribbon And Trail: trail points, tapering, beams and decimation for the Impact subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.impact.ribbon_and_trail", maxPoints = 16, lifetime = 1.70, minDistance = 0.20, width = 0.20 })
		inst.system = S
		inst.ctx = ctx
