-- ARKHER SYSTEM H.0310 :: Mesh Collider Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0310"
	S.key = "arkher.physics.meshcollider.collision_shape"
	S.name = "Mesh Collider Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.meshcollider.body_dynamics" }
	S.tags = { "h", "meshcollider", "collider", "physics" }
	S.description = "Mesh Collider Collision Shape: shape bounds, support mapping and closest points for the Mesh Collider subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.meshcollider.collision_shape", shape = "box", radius = 2.30, height = 1.90, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
