-- ARKHER SYSTEM F.0021 :: Depth Prepass Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0021"
	S.key = "arkher.render.depthprepass.temporal_resolve"
	S.name = "Depth Prepass Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.depthprepass.probe_volume" }
	S.tags = { "f", "depthprepass", "temporal", "render" }
	S.description = "Depth Prepass Temporal Resolve: history reprojection with neighbourhood clamping for the Depth Prepass subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.depthprepass.temporal_resolve", feedback = 0.94, phase = 8 })
		inst.system = S
		inst.ctx = ctx
