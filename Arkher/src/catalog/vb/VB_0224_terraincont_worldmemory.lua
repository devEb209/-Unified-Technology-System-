-- ARKHER SYSTEM VB.0224 :: Terrain Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0224"
	S.key = "arkher.conttime.terraincont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.terraincont.neural_field" }
	S.tags = { "vb", "terraincont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.terraincont.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
