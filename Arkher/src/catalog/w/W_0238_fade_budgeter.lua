-- ARKHER SYSTEM W.0238 :: Fade Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0238"
	S.key = "arkher.cine.fade.frame_budget"
	S.name = "Fade Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Fade"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.fade.event_ledger" }
	S.tags = { "w", "fade", "budgeter", "cine" }
	S.description = "Fade Frame Budget: per-frame cost budget for the cinematic systems for the Fade subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.fade.frame_budget", total = 307, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
