-- ARKHER SYSTEM J.0054 :: Hair Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0054"
	S.key = "arkher.character.hair.streaming"
	S.name = "Hair Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.hair.budget_governor" }
	S.tags = { "j", "hair", "streamer", "character" }
	S.description = "Hair Streaming: distance-driven residency of character data for the Hair subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.hair.streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
