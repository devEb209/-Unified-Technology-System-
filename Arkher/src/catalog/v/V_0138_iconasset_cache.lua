-- ARKHER SYSTEM V.0138 :: Icon Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0138"
	S.key = "arkher.asset.iconasset.content_cache"
	S.name = "Icon Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.iconasset.dependency_graph" }
	S.tags = { "v", "iconasset", "cache", "asset" }
	S.description = "Icon Content Cache: reuse of already cooked results for the Icon subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.iconasset.content_cache", policy = "ttl", capacity = 128, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
