-- ARKHER SYSTEM L.0391 :: Wealth Distribution Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0391"
	S.key = "arkher.sim.wealth.simulation_core"
	S.name = "Wealth Distribution Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "wealth", "simulation", "sim" }
	S.description = "Wealth Distribution Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Wealth Distribution subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.wealth.simulation_core", fullRadius = 160, reducedRadius = 700, budget = 33 })
		inst.system = S
		inst.ctx = ctx
