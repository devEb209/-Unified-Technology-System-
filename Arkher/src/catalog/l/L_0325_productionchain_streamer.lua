-- ARKHER SYSTEM L.0325 :: Production Chain Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0325"
	S.key = "arkher.sim.productionchain.streaming"
	S.name = "Production Chain Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.productionchain.state_codec" }
	S.tags = { "l", "productionchain", "streamer", "sim" }
	S.description = "Production Chain Streaming: distance-driven residency of simulated regions for the Production Chain subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.productionchain.streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
