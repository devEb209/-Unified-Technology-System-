-- ARKHER SYSTEM VB.0169 :: Neural Patch Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0169"
	S.key = "arkher.conttime.neuralpatch.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "neuralpatch", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.neuralpatch.infinite_grid", cellSize = 64, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
