-- ARKHER SYSTEM K.0191 :: Purpose Drive Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0191"
	S.key = "arkher.npc.purposedrive.navigation"
	S.name = "Purpose Drive Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.purposedrive.goal_planner" }
	S.tags = { "k", "purposedrive", "navgraph", "npc" }
	S.description = "Purpose Drive Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Purpose Drive subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.purposedrive.navigation", width = 48, height = 48, cellSize = 5 })
		inst.system = S
		inst.ctx = ctx
