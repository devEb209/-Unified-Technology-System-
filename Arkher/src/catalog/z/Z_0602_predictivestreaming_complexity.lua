-- ARKHER SYSTEM Z.0602 :: Predictive Streaming Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0602"
	S.key = "arkher.origin.predictivestreaming.complexity_governance"
	S.name = "Predictive Streaming Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictivestreaming.reality_layering" }
	S.tags = { "z", "predictivestreaming", "complexity", "origin" }
	S.description = "Predictive Streaming Complexity Governance: measured scene cost turned into per-subsystem directives for the Predictive Streaming subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.predictivestreaming.complexity_governance", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
