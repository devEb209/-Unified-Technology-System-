-- ARKHER SYSTEM VC.0154 :: Persistence Segment Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0154"
	S.key = "arkher.contneural.persistsegment.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.persistsegment.complexity_budget" }
	S.tags = { "vc", "persistsegment", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.persistsegment.simulation_fabric", budgetMs = 3.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
