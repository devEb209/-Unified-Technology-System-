-- ARKHER SYSTEM L.0542 :: Festival Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0542"
	S.key = "arkher.sim.festival.ecology"
	S.name = "Festival Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.festival.simulation_core" }
	S.tags = { "l", "festival", "ecology", "sim" }
	S.description = "Festival Ecology: populations, predation, harvesting and carrying capacity for the Festival subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.festival.ecology" })
		inst.system = S
		inst.ctx = ctx
