-- ARKHER SYSTEM G.0493 :: Neural Debug Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0493"
	S.key = "arkher.neural.neuraldebug.temporal_history"
	S.name = "Neural Debug Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuraldebug.feature_extraction" }
	S.tags = { "g", "neuraldebug", "temporal", "neural" }
	S.description = "Neural Debug Temporal History: history buffers reused across frames for the Neural Debug subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.neuraldebug.temporal_history", feedback = 0.84, phase = 8 })
		inst.system = S
		inst.ctx = ctx
