-- ARKHER SYSTEM N.0055 :: Dust Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0055"
	S.key = "arkher.vfx.dust.force_field"
	S.name = "Dust Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Dust"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.dust.particle_simulation" }
	S.tags = { "n", "dust", "forcefield", "vfx" }
	S.description = "Dust Force Field: wind, attraction, vortex, drag and curl turbulence for the Dust subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.dust.force_field", seed = 89092 })
		inst.system = S
		inst.ctx = ctx
