-- ARKHER SYSTEM VB.0452 :: Animation Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0452"
	S.key = "arkher.conttime.animcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.animcont.neural_field" }
	S.tags = { "vb", "animcont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.animcont.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
