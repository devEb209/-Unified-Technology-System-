-- ARKHER SYSTEM VD.0634 :: Interest Field Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0634"
	S.key = "arkher.contsim.interestfield.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.interestfield.complexity_budget" }
	S.tags = { "vd", "interestfield", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.interestfield.simulation_fabric", budgetMs = 2.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
