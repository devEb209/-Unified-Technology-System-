-- ARKHER SYSTEM N.0327 :: Ribbon Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0327"
	S.key = "arkher.vfx.ribbonfx.particle_simulation"
	S.name = "Ribbon Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Ribbon"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.ribbonfx.emission" }
	S.tags = { "n", "ribbonfx", "particles", "vfx" }
	S.description = "Ribbon Particle Simulation: pooled integration of position, velocity, colour and life for the Ribbon subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.ribbonfx.particle_simulation", capacity = 256, drag = 0.15, bounce = 0.20, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
