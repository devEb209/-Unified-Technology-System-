-- ARKHER SYSTEM VA.0223 :: Terrain Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0223"
	S.key = "arkher.contworld.terraincont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.terraincont.coherence_guard" }
	S.tags = { "va", "terraincont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.terraincont.neural_field", dims = 12, hidden = 8, seed = 5200 })
		inst.system = S
		inst.ctx = ctx
