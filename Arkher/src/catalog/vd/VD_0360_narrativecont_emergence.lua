-- ARKHER SYSTEM VD.0360 :: Narrative Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0360"
	S.key = "arkher.contsim.narrativecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.narrativecont.reality_continuum" }
	S.tags = { "vd", "narrativecont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.narrativecont.emergence_continuum", windowSize = 7, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
