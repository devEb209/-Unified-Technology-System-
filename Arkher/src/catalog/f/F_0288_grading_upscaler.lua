-- ARKHER SYSTEM F.0288 :: Color Grading Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0288"
	S.key = "arkher.render.grading.adaptive_resolution"
	S.name = "Color Grading Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.grading.temporal_resolve" }
	S.tags = { "f", "grading", "upscaler", "render" }
	S.description = "Color Grading Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Color Grading subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.grading.adaptive_resolution", targetMs = 14.10, index = 3, sharpness = 0.43 })
		inst.system = S
		inst.ctx = ctx
