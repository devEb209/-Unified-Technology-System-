-- ARKHER SYSTEM O.0244 :: Combat Music Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0244"
	S.key = "arkher.audio.combatmusic.music_sequencer"
	S.name = "Combat Music Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Combat Music"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.combatmusic.spatialization" }
	S.tags = { "o", "combatmusic", "sequencer", "audio" }
	S.description = "Combat Music Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Combat Music subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.combatmusic.music_sequencer", bpm = 90, beatsPerBar = 4, intensity = 0.30 })
		inst.system = S
		inst.ctx = ctx
