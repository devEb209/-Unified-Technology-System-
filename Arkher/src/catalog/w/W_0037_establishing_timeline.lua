-- ARKHER SYSTEM W.0037 :: Establishing Shot Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0037"
	S.key = "arkher.cine.establishing.sequence_timeline"
	S.name = "Establishing Shot Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "establishing", "timeline", "cine" }
	S.description = "Establishing Shot Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Establishing Shot subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.establishing.sequence_timeline", duration = 8.0, rate = 1.08 })
		inst.system = S
		inst.ctx = ctx
