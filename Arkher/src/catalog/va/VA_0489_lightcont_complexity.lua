-- ARKHER SYSTEM VA.0489 :: Lighting Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0489"
	S.key = "arkher.contworld.lightcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lightcont.world_memory_stream" }
	S.tags = { "va", "lightcont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.lightcont.complexity_budget", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
