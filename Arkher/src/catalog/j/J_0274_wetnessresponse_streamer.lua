-- ARKHER SYSTEM J.0274 :: Wetness Response Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0274"
	S.key = "arkher.character.wetnessresponse.streaming"
	S.name = "Wetness Response Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.wetnessresponse.budget_governor" }
	S.tags = { "j", "wetnessresponse", "streamer", "character" }
	S.description = "Wetness Response Streaming: distance-driven residency of character data for the Wetness Response subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.wetnessresponse.streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
