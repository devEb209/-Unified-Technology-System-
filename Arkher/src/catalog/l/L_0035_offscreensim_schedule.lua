-- ARKHER SYSTEM L.0035 :: Offscreen Simulation Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0035"
	S.key = "arkher.sim.offscreensim.calendar"
	S.name = "Offscreen Simulation Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.offscreensim.society" }
	S.tags = { "l", "offscreensim", "schedule", "sim" }
	S.description = "Offscreen Simulation Calendar: hours, days and seasons driving the region for the Offscreen Simulation subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.offscreensim.calendar", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
