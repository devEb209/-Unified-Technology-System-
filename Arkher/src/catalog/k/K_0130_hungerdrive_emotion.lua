-- ARKHER SYSTEM K.0130 :: Hunger Drive Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0130"
	S.key = "arkher.npc.hungerdrive.emotion"
	S.name = "Hunger Drive Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hungerdrive.drive_system" }
	S.tags = { "k", "hungerdrive", "emotion", "npc" }
	S.description = "Hunger Drive Emotion: appraisal of events into valence, arousal and mood for the Hunger Drive subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.hungerdrive.emotion", inertia = 0.92, decayRate = 0.37, baselineArousal = 0.27 })
		inst.system = S
		inst.ctx = ctx
