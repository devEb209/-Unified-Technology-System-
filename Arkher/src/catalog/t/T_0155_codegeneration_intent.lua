-- ARKHER SYSTEM T.0155 :: Code Generation Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0155"
	S.key = "arkher.ai.codegeneration.intent_understanding"
	S.name = "Code Generation Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "codegeneration", "intent", "ai" }
	S.description = "Code Generation Intent Understanding: natural language turned into an actionable, scored intent for the Code Generation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.codegeneration.intent_understanding", minConfidence = 0.31 })
		inst.system = S
		inst.ctx = ctx
