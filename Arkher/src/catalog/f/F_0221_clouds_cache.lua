-- ARKHER SYSTEM F.0221 :: Cloud Rendering Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0221"
	S.key = "arkher.render.clouds.pass_cache"
	S.name = "Cloud Rendering Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.clouds.render_policy" }
	S.tags = { "f", "clouds", "cache", "render" }
	S.description = "Cloud Rendering Pass Cache: reuse of pass results across frames for the Cloud Rendering subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.clouds.pass_cache", policy = "lru", capacity = 383, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
