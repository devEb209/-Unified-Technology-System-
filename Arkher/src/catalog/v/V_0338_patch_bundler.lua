-- ARKHER SYSTEM V.0338 :: Patch Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0338"
	S.key = "arkher.asset.patch.bundling"
	S.name = "Patch Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.patch.import" }
	S.tags = { "v", "patch", "bundler", "asset" }
	S.description = "Patch Bundling: size-bounded packing, manifests and delta patches for the Patch subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.patch.bundling", maxBundleBytes = 655360 })
		inst.system = S
		inst.ctx = ctx
