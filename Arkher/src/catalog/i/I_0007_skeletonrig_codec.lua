-- ARKHER SYSTEM I.0007 :: Skeleton Rig Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0007"
	S.key = "arkher.anim.skeletonrig.compression_codec"
	S.name = "Skeleton Rig Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Skeleton Rig"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.skeletonrig.retarget_graph" }
	S.tags = { "i", "skeletonrig", "codec", "anim" }
	S.description = "Skeleton Rig Compression Codec: curve compression and quantized transport for the Skeleton Rig subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.skeletonrig.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
