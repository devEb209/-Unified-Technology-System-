-- ARKHER SYSTEM H.0342 :: Compound Collider Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0342"
	S.key = "arkher.physics.compoundcollider.character_motion"
	S.name = "Compound Collider Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.compoundcollider.query" }
	S.tags = { "h", "compoundcollider", "charmotor", "physics" }
	S.description = "Compound Collider Character Motion: capsule move-and-slide with slopes, steps and jumps for the Compound Collider subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.compoundcollider.character_motion", radius = 0.47, height = 1.72, maxSpeed = 7.20, jumpHeight = 2.00, stepOffset = 0.27 })
		inst.system = S
		inst.ctx = ctx
