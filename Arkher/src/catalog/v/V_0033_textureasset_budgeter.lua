-- ARKHER SYSTEM V.0033 :: Texture Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0033"
	S.key = "arkher.asset.textureasset.size_budget"
	S.name = "Texture Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.textureasset.compression_codec" }
	S.tags = { "v", "textureasset", "budgeter", "asset" }
	S.description = "Texture Size Budget: byte budget shared between competing asset classes for the Texture subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.textureasset.size_budget", total = 238, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
