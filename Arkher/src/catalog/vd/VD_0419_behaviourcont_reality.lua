-- ARKHER SYSTEM VD.0419 :: Behaviour Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0419"
	S.key = "arkher.contsim.behaviourcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.behaviourcont.simulation_fabric" }
	S.tags = { "vd", "behaviourcont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.behaviourcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
