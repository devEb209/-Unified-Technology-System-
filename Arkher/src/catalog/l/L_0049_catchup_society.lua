-- ARKHER SYSTEM L.0049 :: Catch Up Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0049"
	S.key = "arkher.sim.catchup.society"
	S.name = "Catch Up Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.catchup.economy" }
	S.tags = { "l", "catchup", "society", "sim" }
	S.description = "Catch Up Society: relations, factions, reputation and cohesion of the region for the Catch Up subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.catchup.society", decayRate = 0.010, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
