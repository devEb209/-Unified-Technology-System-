-- ARKHER SYSTEM VA.0315 :: Ecology Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0315"
	S.key = "arkher.contworld.ecologycont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.ecologycont.epoch_clock" }
	S.tags = { "va", "ecologycont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.ecologycont.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
