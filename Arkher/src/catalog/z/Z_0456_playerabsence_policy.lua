-- ARKHER SYSTEM Z.0456 :: Player Absence Simulation Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0456"
	S.key = "arkher.origin.playerabsence.governance_policy"
	S.name = "Player Absence Simulation Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.signal_composition" }
	S.tags = { "z", "playerabsence", "policy", "origin" }
	S.description = "Player Absence Simulation Governance Policy: ordered rules governing when the technology may act for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.playerabsence.governance_policy", algorithm = "lottery", starvationGuard = 19 })
		inst.system = S
		inst.ctx = ctx
