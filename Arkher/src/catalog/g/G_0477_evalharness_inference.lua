-- ARKHER SYSTEM G.0477 :: Evaluation Harness Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0477"
	S.key = "arkher.neural.evalharness.inference_core"
	S.name = "Evaluation Harness Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "evalharness", "inference", "neural" }
	S.description = "Evaluation Harness Inference Core: dense network forward pass and training for the Evaluation Harness subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.evalharness.inference_core", seed = 10211 })
		inst.system = S
		inst.ctx = ctx
