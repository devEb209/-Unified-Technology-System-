-- ARKHER SYSTEM K.0596 :: Relationship Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0596"
	S.key = "arkher.npc.relationship.goal_planner"
	S.name = "Relationship Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.relationship.utility_reasoning" }
	S.tags = { "k", "relationship", "planner", "npc" }
	S.description = "Relationship Goal Planner: backward GOAP planning to reach a goal state for the Relationship subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.relationship.goal_planner", maxDepth = 10 })
		inst.system = S
		inst.ctx = ctx
