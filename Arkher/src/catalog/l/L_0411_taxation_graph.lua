-- ARKHER SYSTEM L.0411 :: Taxation Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0411"
	S.key = "arkher.sim.taxation.region_graph"
	S.name = "Taxation Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.taxation.calendar" }
	S.tags = { "l", "taxation", "graph", "sim" }
	S.description = "Taxation Region Graph: connectivity, components and shortest path between places for the Taxation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.taxation.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
