-- ARKHER SYSTEM E.0295 :: Wear And Tear Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0295"
	S.key = "arkher.material.wear.quality_policy"
	S.name = "Wear And Tear Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.wear.compression_codec" }
	S.tags = { "e", "wear", "policy", "material" }
	S.description = "Wear And Tear Quality Policy: device tier rules for the surface for the Wear And Tear subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.wear.quality_policy", algorithm = "lottery", starvationGuard = 27 })
		inst.system = S
		inst.ctx = ctx
