-- ARKHER SYSTEM V.0210 :: Level Asset Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0210"
	S.key = "arkher.asset.levelasset.content_cache"
	S.name = "Level Asset Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.levelasset.dependency_graph" }
	S.tags = { "v", "levelasset", "cache", "asset" }
	S.description = "Level Asset Content Cache: reuse of already cooked results for the Level Asset subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.levelasset.content_cache", policy = "lfu", capacity = 144, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
