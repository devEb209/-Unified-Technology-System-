-- ARKHER SYSTEM I.0417 :: Animation LOD Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0417"
	S.key = "arkher.anim.animlod.skeleton"
	S.name = "Animation LOD Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "animlod", "skeleton", "anim" }
	S.description = "Animation LOD Skeleton: bone hierarchy, bind pose and world resolution for the Animation LOD subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.animlod.skeleton" })
		inst.system = S
		inst.ctx = ctx
