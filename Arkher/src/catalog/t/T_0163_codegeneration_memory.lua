-- ARKHER SYSTEM T.0163 :: Code Generation Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0163"
	S.key = "arkher.ai.codegeneration.working_memory"
	S.name = "Code Generation Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.codegeneration.outcome_prediction" }
	S.tags = { "t", "codegeneration", "memory", "ai" }
	S.description = "Code Generation Working Memory: decaying, consolidating recall of what the agent learned for the Code Generation subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.codegeneration.working_memory", capacity = 56, decayRate = 0.030, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
