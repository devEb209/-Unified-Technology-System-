-- ARKHER SYSTEM K.0421 :: Pathfinding Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0421"
	S.key = "arkher.npc.pathfinding.mind_network"
	S.name = "Pathfinding Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "pathfinding", "mindnet", "npc" }
	S.description = "Pathfinding Mind Network: the learned policy that turns perception into a decision for the Pathfinding subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.pathfinding.mind_network", inputs = 6, hidden = 6, seed = 86272, learningRate = 0.060, exploration = 0.020 })
		inst.system = S
		inst.ctx = ctx
