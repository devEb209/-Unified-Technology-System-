-- ARKHER SYSTEM I.0088 :: Curve Interpolation Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0088"
	S.key = "arkher.anim.curveinterp.pose_cache"
	S.name = "Curve Interpolation Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.curveinterp.playback_pipeline" }
	S.tags = { "i", "curveinterp", "cache", "anim" }
	S.description = "Curve Interpolation Pose Cache: reuse of sampled poses across frames and instances for the Curve Interpolation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.curveinterp.pose_cache", policy = "ttl", capacity = 372, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
