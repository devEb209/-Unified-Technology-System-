-- ARKHER SYSTEM F.0119 :: Screen Space Reflection Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0119"
	S.key = "arkher.render.ssr.temporal_resolve"
	S.name = "Screen Space Reflection Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.ssr.probe_volume" }
	S.tags = { "f", "ssr", "temporal", "render" }
	S.description = "Screen Space Reflection Temporal Resolve: history reprojection with neighbourhood clamping for the Screen Space Reflection subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.ssr.temporal_resolve", feedback = 0.80, phase = 8 })
		inst.system = S
		inst.ctx = ctx
