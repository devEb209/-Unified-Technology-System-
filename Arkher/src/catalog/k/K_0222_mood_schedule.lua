-- ARKHER SYSTEM K.0222 :: Mood Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0222"
	S.key = "arkher.npc.mood.daily_schedule"
	S.name = "Mood Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.mood.social_relations" }
	S.tags = { "k", "mood", "schedule", "npc" }
	S.description = "Mood Daily Schedule: hour-by-hour routine with priority interruptions for the Mood subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.mood.daily_schedule", startHour = 8 })
		inst.system = S
		inst.ctx = ctx
