-- ARKHER SYSTEM Z.1008 :: Capability Discovery Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.1008"
	S.key = "arkher.origin.capabilitydiscovery.semantic_graph"
	S.name = "Capability Discovery Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.world_architect" }
	S.tags = { "z", "capabilitydiscovery", "knowledge", "origin" }
	S.description = "Capability Discovery Semantic Graph: typed entities and inferred relations of the technology itself for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.capabilitydiscovery.semantic_graph", dims = 32 })
		inst.system = S
		inst.ctx = ctx
