-- ARKHER SYSTEM VB.0066 :: Sparse Page Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0066"
	S.key = "arkher.conttime.sparsepage.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.sparsepage.persistent_state" }
	S.tags = { "vb", "sparsepage", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.sparsepage.coherence_guard", window = 62, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
