-- ARKHER SYSTEM T.0297 :: Difficulty Tuning Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0297"
	S.key = "arkher.ai.difficultytuning.plan_workflow"
	S.name = "Difficulty Tuning Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.difficultytuning.semantic_knowledge" }
	S.tags = { "t", "difficultytuning", "workflow", "ai" }
	S.description = "Difficulty Tuning Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Difficulty Tuning subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.difficultytuning.plan_workflow", maxRetries = 2, budget = 80 })
		inst.system = S
		inst.ctx = ctx
