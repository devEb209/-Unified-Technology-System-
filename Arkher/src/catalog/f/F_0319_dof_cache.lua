-- ARKHER SYSTEM F.0319 :: Depth Of Field Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0319"
	S.key = "arkher.render.dof.pass_cache"
	S.name = "Depth Of Field Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.dof.render_policy" }
	S.tags = { "f", "dof", "cache", "render" }
	S.description = "Depth Of Field Pass Cache: reuse of pass results across frames for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.dof.pass_cache", policy = "lru", capacity = 111, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
