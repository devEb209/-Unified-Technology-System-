-- ARKHER SYSTEM N.0155 :: Rain Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0155"
	S.key = "arkher.vfx.rain.analysis"
	S.name = "Rain Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Rain"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.rain.spatial_index" }
	S.tags = { "n", "rain", "analyzer", "vfx" }
	S.description = "Rain Analysis: cost, overdraw and stability analysis of the effect for the Rain subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.rain.analysis", window = 231, buckets = 19, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
