-- ARKHER SYSTEM V.0331 :: Bundle Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0331"
	S.key = "arkher.asset.bundle.streaming_residency"
	S.name = "Bundle Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.bundle.content_cache" }
	S.tags = { "v", "bundle", "streamer", "asset" }
	S.description = "Bundle Streaming Residency: distance-driven load and unload of asset payloads for the Bundle subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.bundle.streaming_residency", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
