-- ARKHER SYSTEM T.0512 :: Render Reasoning Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0512"
	S.key = "arkher.ai.renderreasoning.outcome_prediction"
	S.name = "Render Reasoning Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.renderreasoning.decision_policy" }
	S.tags = { "t", "renderreasoning", "predictor", "ai" }
	S.description = "Render Reasoning Outcome Prediction: forecasting the result before the work is done for the Render Reasoning subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.renderreasoning.outcome_prediction", method = "ema", alpha = 0.24, window = 86 })
		inst.system = S
		inst.ctx = ctx
