-- ARKHER SYSTEM W.0071 :: Tracking Shot Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0071"
	S.key = "arkher.cine.tracking.sequence_analysis"
	S.name = "Tracking Shot Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.tracking.frame_budget" }
	S.tags = { "w", "tracking", "analyzer", "cine" }
	S.description = "Tracking Shot Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Tracking Shot subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.tracking.sequence_analysis", window = 175, buckets = 11, threshold = 4.70 })
		inst.system = S
		inst.ctx = ctx
