-- ARKHER SYSTEM VA.0552 :: World Fabric Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0552"
	S.key = "arkher.contworld.worldfabric.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldfabric.reality_continuum" }
	S.tags = { "va", "worldfabric", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.worldfabric.emergence_continuum", windowSize = 6, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
