-- ARKHER SYSTEM J.0328 :: Character Debug Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0328"
	S.key = "arkher.character.characterdebug.budget_governor"
	S.name = "Character Debug Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterdebug.variant_registry" }
	S.tags = { "j", "characterdebug", "budgeter", "character" }
	S.description = "Character Debug Budget Governor: per-character cost allocation in a crowd for the Character Debug subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.characterdebug.budget_governor", total = 300, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
