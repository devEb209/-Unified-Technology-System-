-- ARKHER SYSTEM T.0219 :: Character Generation Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0219"
	S.key = "arkher.ai.charactergeneration.working_memory"
	S.name = "Character Generation Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.charactergeneration.outcome_prediction" }
	S.tags = { "t", "charactergeneration", "memory", "ai" }
	S.description = "Character Generation Working Memory: decaying, consolidating recall of what the agent learned for the Character Generation subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.charactergeneration.working_memory", capacity = 58, decayRate = 0.050, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
