-- ARKHER SYSTEM G.0480 :: Evaluation Harness Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0480"
	S.key = "arkher.neural.evalharness.reconstruction"
	S.name = "Evaluation Harness Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.evalharness.temporal_history" }
	S.tags = { "g", "evalharness", "upscaler", "neural" }
	S.description = "Evaluation Harness Reconstruction: resolution ladder and image reconstruction for the Evaluation Harness subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.evalharness.reconstruction", targetMs = 12.10, index = 4, sharpness = 0.59 })
		inst.system = S
		inst.ctx = ctx
