-- ARKHER SYSTEM H.0085 :: Gravity Field Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0085"
	S.key = "arkher.physics.gravityfield.body_dynamics"
	S.name = "Gravity Field Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "gravityfield", "rigidbody", "physics" }
	S.description = "Gravity Field Body Dynamics: integration, impulses, damping and sleeping of a body for the Gravity Field subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.gravityfield.body_dynamics", mass = 24.00, radius = 0.45, restitution = 0.43, friction = 0.63, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
