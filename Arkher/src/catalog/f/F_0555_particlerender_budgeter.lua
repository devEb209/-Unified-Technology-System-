-- ARKHER SYSTEM F.0555 :: Particle Rendering Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0555"
	S.key = "arkher.render.particlerender.draw_budget"
	S.name = "Particle Rendering Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.particlerender.adaptive_resolution" }
	S.tags = { "f", "particlerender", "budgeter", "render" }
	S.description = "Particle Rendering Draw Budget: draw call and triangle budget allocation for the Particle Rendering subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.particlerender.draw_budget", total = 277, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
