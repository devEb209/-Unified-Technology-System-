-- ARKHER SYSTEM L.0361 :: Trade Route Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0361"
	S.key = "arkher.sim.traderoute.simulation_core"
	S.name = "Trade Route Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "traderoute", "simulation", "sim" }
	S.description = "Trade Route Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Trade Route subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.traderoute.simulation_core", fullRadius = 280, reducedRadius = 800, budget = 90 })
		inst.system = S
		inst.ctx = ctx
