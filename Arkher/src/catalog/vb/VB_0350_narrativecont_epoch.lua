-- ARKHER SYSTEM VB.0350 :: Narrative Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0350"
	S.key = "arkher.conttime.narrativecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.narrativecont.infinite_grid" }
	S.tags = { "vb", "narrativecont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.narrativecont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
