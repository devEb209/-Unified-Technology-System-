-- ARKHER SYSTEM O.0326 :: Engine Audio Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0326"
	S.key = "arkher.audio.engineaudio.mixer_bus"
	S.name = "Engine Audio Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Engine Audio"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.engineaudio.dsp_chain" }
	S.tags = { "o", "engineaudio", "mixer", "audio" }
	S.description = "Engine Audio Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Engine Audio subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.engineaudio.mixer_bus", maxVoices = 48 })
		inst.system = S
		inst.ctx = ctx
