-- ARKHER SYSTEM L.0256 :: Season Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0256"
	S.key = "arkher.sim.season.simulation_core"
	S.name = "Season Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "season", "simulation", "sim" }
	S.description = "Season Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Season subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.season.simulation_core", fullRadius = 120, reducedRadius = 600, budget = 32 })
		inst.system = S
		inst.ctx = ctx
