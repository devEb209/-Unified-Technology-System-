-- ARKHER SYSTEM R.0017 :: Connection Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0017"
	S.key = "arkher.net.connection.bandwidth_budget"
	S.name = "Connection Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Connection"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.connection.transport_graph" }
	S.tags = { "r", "connection", "budgeter", "net" }
	S.description = "Connection Bandwidth Budget: bytes per second shared between competing streams for the Connection subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.connection.bandwidth_budget", total = 233, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
