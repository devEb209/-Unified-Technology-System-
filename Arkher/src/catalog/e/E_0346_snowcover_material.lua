-- ARKHER SYSTEM E.0346 :: Snow Cover Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0346"
	S.key = "arkher.material.snowcover.definition"
	S.name = "Snow Cover Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Snow Cover"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "snowcover", "material", "material" }
	S.description = "Snow Cover Definition: layered PBR definition resolved into parameters for the Snow Cover subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.snowcover.definition", texelBudget = 1835008 })
		inst.system = S
		inst.ctx = ctx
