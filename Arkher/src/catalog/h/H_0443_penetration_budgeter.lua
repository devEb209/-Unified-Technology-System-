-- ARKHER SYSTEM H.0443 :: Penetration Recovery Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0443"
	S.key = "arkher.physics.penetration.budget_governor"
	S.name = "Penetration Recovery Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.penetration.broadphase_index" }
	S.tags = { "h", "penetration", "budgeter", "physics" }
	S.description = "Penetration Recovery Budget Governor: simulation time budget allocation across islands for the Penetration Recovery subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.penetration.budget_governor", total = 117, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
