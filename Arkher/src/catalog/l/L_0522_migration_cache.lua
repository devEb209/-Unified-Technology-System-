-- ARKHER SYSTEM L.0522 :: Migration Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0522"
	S.key = "arkher.sim.migration.aggregate_cache"
	S.name = "Migration Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.migration.fidelity_policy" }
	S.tags = { "l", "migration", "cache", "sim" }
	S.description = "Migration Aggregate Cache: reuse of expensive aggregate computations for the Migration subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.migration.aggregate_cache", policy = "lru", capacity = 216, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
