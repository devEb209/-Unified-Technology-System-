-- ARKHER SYSTEM K.0452 :: Crowd Flow Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0452"
	S.key = "arkher.npc.crowdflow.emotion"
	S.name = "Crowd Flow Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.crowdflow.drive_system" }
	S.tags = { "k", "crowdflow", "emotion", "npc" }
	S.description = "Crowd Flow Emotion: appraisal of events into valence, arousal and mood for the Crowd Flow subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.crowdflow.emotion", inertia = 0.81, decayRate = 0.26, baselineArousal = 0.16 })
		inst.system = S
		inst.ctx = ctx
