-- ARKHER SYSTEM VA.0409 :: Behaviour Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0409"
	S.key = "arkher.contworld.behaviourcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "behaviourcont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.behaviourcont.infinite_grid", cellSize = 160, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
