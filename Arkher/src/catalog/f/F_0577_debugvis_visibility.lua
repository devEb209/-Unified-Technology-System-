-- ARKHER SYSTEM F.0577 :: Debug Visualization Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0577"
	S.key = "arkher.render.debugvis.visibility_set"
	S.name = "Debug Visualization Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.debugvis.view_and_culling" }
	S.tags = { "f", "debugvis", "visibility", "render" }
	S.description = "Debug Visualization Visibility Set: cell, portal and occluder visibility for the Debug Visualization subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.debugvis.visibility_set", maxDepth = 2 })
		inst.system = S
		inst.ctx = ctx
