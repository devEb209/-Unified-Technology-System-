-- ARKHER SYSTEM G.0449 :: On Device Budget Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0449"
	S.key = "arkher.neural.ondevicebudget.inference_core"
	S.name = "On Device Budget Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "ondevicebudget", "inference", "neural" }
	S.description = "On Device Budget Inference Core: dense network forward pass and training for the On Device Budget subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.ondevicebudget.inference_core", seed = 8617 })
		inst.system = S
		inst.ctx = ctx
