-- ARKHER SYSTEM E.0401 :: Texture Atlas Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0401"
	S.key = "arkher.material.atlas.instance_cache"
	S.name = "Texture Atlas Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.atlas.quality_policy" }
	S.tags = { "e", "atlas", "cache", "material" }
	S.description = "Texture Atlas Instance Cache: resolved-parameter cache keyed by context for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.atlas.instance_cache", policy = "lru", capacity = 464, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
