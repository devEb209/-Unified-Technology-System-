-- ARKHER SYSTEM VC.0158 :: Coherence Seam Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0158"
	S.key = "arkher.contneural.coherenceseam.epoch_clock"
	S.name = "Coherence Seam Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.coherenceseam.infinite_grid" }
	S.tags = { "vc", "coherenceseam", "epoch", "contneural" }
	S.description = "Coherence Seam Epoch Clock: deterministic epoch timeline with catch-up for the Coherence Seam subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.coherenceseam.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
