-- ARKHER SYSTEM VC.0362 :: Quest Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0362"
	S.key = "arkher.contneural.questcont.epoch_clock"
	S.name = "Quest Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.questcont.infinite_grid" }
	S.tags = { "vc", "questcont", "epoch", "contneural" }
	S.description = "Quest Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Quest Continuum subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.questcont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
