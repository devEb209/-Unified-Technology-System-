-- ARKHER SYSTEM VB.0575 :: Mobile Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0575"
	S.key = "arkher.conttime.mobilecont.reality_continuum"
	S.name = "Mobile Continuum Reality Continuum"
	S.category = "VB"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.mobilecont.simulation_fabric" }
	S.tags = { "vb", "mobilecont", "reality", "conttime" }
	S.description = "Mobile Continuum Reality Continuum: stacked reality layers of the continuum for the Mobile Continuum subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.mobilecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
