-- ARKHER SYSTEM T.0004 :: Intent Parsing Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0004"
	S.key = "arkher.ai.intentparsing.self_critique"
	S.name = "Intent Parsing Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.intentparsing.plan_workflow" }
	S.tags = { "t", "intentparsing", "critic", "ai" }
	S.description = "Intent Parsing Self Critique: weighted evaluation of the result against declared criteria for the Intent Parsing subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.intentparsing.self_critique", passMark = 0.83, reviseMark = 0.43, seed = 673 })
		inst.system = S
		inst.ctx = ctx
