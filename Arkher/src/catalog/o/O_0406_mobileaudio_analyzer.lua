-- ARKHER SYSTEM O.0406 :: Mobile Audio Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0406"
	S.key = "arkher.audio.mobileaudio.analysis"
	S.name = "Mobile Audio Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mobile Audio"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mobileaudio.playback_policy" }
	S.tags = { "o", "mobileaudio", "analyzer", "audio" }
	S.description = "Mobile Audio Analysis: loudness, headroom and masking analysis for the Mobile Audio subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.mobileaudio.analysis", window = 231, buckets = 19, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
