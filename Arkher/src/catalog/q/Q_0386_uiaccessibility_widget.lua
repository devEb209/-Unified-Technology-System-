-- ARKHER SYSTEM Q.0386 :: Accessibility Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0386"
	S.key = "arkher.ui.uiaccessibility.widget_tree"
	S.name = "Accessibility Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uiaccessibility.responsive_layout" }
	S.tags = { "q", "uiaccessibility", "widget", "ui" }
	S.description = "Accessibility Widget Tree: retained widget nodes, properties, bindings and rendering for the Accessibility subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.uiaccessibility.widget_tree", theme = "highcontrast", scale = 0.90 })
		inst.system = S
		inst.ctx = ctx
