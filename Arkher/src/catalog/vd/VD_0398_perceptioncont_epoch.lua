-- ARKHER SYSTEM VD.0398 :: Perception Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0398"
	S.key = "arkher.contsim.perceptioncont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.perceptioncont.infinite_grid" }
	S.tags = { "vd", "perceptioncont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.perceptioncont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
