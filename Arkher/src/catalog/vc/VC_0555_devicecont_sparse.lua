-- ARKHER SYSTEM VC.0555 :: Device Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0555"
	S.key = "arkher.contneural.devicecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.devicecont.epoch_clock" }
	S.tags = { "vc", "devicecont", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.devicecont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
