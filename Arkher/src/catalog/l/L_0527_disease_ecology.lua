-- ARKHER SYSTEM L.0527 :: Disease Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0527"
	S.key = "arkher.sim.disease.ecology"
	S.name = "Disease Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.disease.simulation_core" }
	S.tags = { "l", "disease", "ecology", "sim" }
	S.description = "Disease Ecology: populations, predation, harvesting and carrying capacity for the Disease subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.disease.ecology" })
		inst.system = S
		inst.ctx = ctx
