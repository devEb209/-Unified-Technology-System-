-- ARKHER SYSTEM E.0535 :: Material LOD Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0535"
	S.key = "arkher.material.materiallod.quality_policy"
	S.name = "Material LOD Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Material LOD"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.materiallod.compression_codec" }
	S.tags = { "e", "materiallod", "policy", "material" }
	S.description = "Material LOD Quality Policy: device tier rules for the surface for the Material LOD subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.materiallod.quality_policy", algorithm = "edf", starvationGuard = 29 })
		inst.system = S
		inst.ctx = ctx
