-- ARKHER SYSTEM W.0350 :: Subtitle Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0350"
	S.key = "arkher.cine.subtitle.camera_rig"
	S.name = "Subtitle Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Subtitle"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.subtitle.sequence_timeline" }
	S.tags = { "w", "subtitle", "camerarig", "cine" }
	S.description = "Subtitle Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Subtitle subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.subtitle.camera_rig", fov = 1.44, focus = 8.0, aperture = 4.4, smoothing = 8.0, distance = 10, height = 2 })
		inst.system = S
		inst.ctx = ctx
