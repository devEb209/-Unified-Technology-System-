-- ARKHER SYSTEM V.0366 :: Import Preset Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0366"
	S.key = "arkher.asset.importpreset.content_cache"
	S.name = "Import Preset Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.importpreset.dependency_graph" }
	S.tags = { "v", "importpreset", "cache", "asset" }
	S.description = "Import Preset Content Cache: reuse of already cooked results for the Import Preset subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.importpreset.content_cache", policy = "lru", capacity = 291, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
