-- ARKHER SYSTEM T.0362 :: Documentation Writer Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0362"
	S.key = "arkher.ai.documentationwriter.model_inference"
	S.name = "Documentation Writer Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.documentationwriter.action_planner" }
	S.tags = { "t", "documentationwriter", "inference", "ai" }
	S.description = "Documentation Writer Model Inference: quantized inference with batching and budget for the Documentation Writer subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.documentationwriter.model_inference", seed = 98220 })
		inst.system = S
		inst.ctx = ctx
