-- ARKHER SYSTEM Z.0689 :: Auto Test Synthesis Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0689"
	S.key = "arkher.origin.autotest.intent_bridge"
	S.name = "Auto Test Synthesis Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autotest.semantic_graph" }
	S.tags = { "z", "autotest", "intent", "origin" }
	S.description = "Auto Test Synthesis Intent Bridge: natural language control surface for the technology for the Auto Test Synthesis subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.autotest.intent_bridge", minConfidence = 0.35 })
		inst.system = S
		inst.ctx = ctx
