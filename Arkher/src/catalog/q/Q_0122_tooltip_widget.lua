-- ARKHER SYSTEM Q.0122 :: Tooltip Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0122"
	S.key = "arkher.ui.tooltip.widget_tree"
	S.name = "Tooltip Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tooltip"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.tooltip.responsive_layout" }
	S.tags = { "q", "tooltip", "widget", "ui" }
	S.description = "Tooltip Widget Tree: retained widget nodes, properties, bindings and rendering for the Tooltip subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.tooltip.widget_tree", theme = "light", scale = 0.97 })
		inst.system = S
		inst.ctx = ctx
