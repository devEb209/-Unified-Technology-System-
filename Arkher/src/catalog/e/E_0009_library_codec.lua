-- ARKHER SYSTEM E.0009 :: Material Library Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0009"
	S.key = "arkher.material.library.compression_codec"
	S.name = "Material Library Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.library.streaming" }
	S.tags = { "e", "library", "codec", "material" }
	S.description = "Material Library Compression Codec: serialization and compression of material data for the Material Library subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.library.compression_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
