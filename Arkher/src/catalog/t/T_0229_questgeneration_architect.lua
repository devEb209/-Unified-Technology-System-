-- ARKHER SYSTEM T.0229 :: Quest Generation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0229"
	S.key = "arkher.ai.questgeneration.world_architect"
	S.name = "Quest Generation World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.questgeneration.self_critique" }
	S.tags = { "t", "questgeneration", "architect", "ai" }
	S.description = "Quest Generation World Architect: composition of a whole world plan with conserved budgets for the Quest Generation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.questgeneration.world_architect", budget = 600, seed = 71590 })
		inst.system = S
		inst.ctx = ctx
