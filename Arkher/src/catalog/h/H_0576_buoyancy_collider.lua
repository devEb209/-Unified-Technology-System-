-- ARKHER SYSTEM H.0576 :: Buoyancy Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0576"
	S.key = "arkher.physics.buoyancy.collision_shape"
	S.name = "Buoyancy Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Buoyancy"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.buoyancy.body_dynamics" }
	S.tags = { "h", "buoyancy", "collider", "physics" }
	S.description = "Buoyancy Collision Shape: shape bounds, support mapping and closest points for the Buoyancy subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.buoyancy.collision_shape", shape = "capsule", radius = 2.10, height = 1.70, layer = "world" })
		inst.system = S
		inst.ctx = ctx
