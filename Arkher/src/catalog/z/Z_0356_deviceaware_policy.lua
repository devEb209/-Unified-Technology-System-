-- ARKHER SYSTEM Z.0356 :: Device Aware Fidelity Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0356"
	S.key = "arkher.origin.deviceaware.governance_policy"
	S.name = "Device Aware Fidelity Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.signal_composition" }
	S.tags = { "z", "deviceaware", "policy", "origin" }
	S.description = "Device Aware Fidelity Governance Policy: ordered rules governing when the technology may act for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.deviceaware.governance_policy", algorithm = "roundrobin", starvationGuard = 60 })
		inst.system = S
		inst.ctx = ctx
