-- ARKHER SYSTEM R.0008 :: Session Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0008"
	S.key = "arkher.net.session.rate_guard"
	S.name = "Session Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Session"
	S.aspect = "Rate Guard"
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.session.interest_streaming" }
	S.tags = { "r", "session", "guard", "net" }
	S.description = "Session Rate Guard: token-bucket protection against floods and abuse for the Session subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.session.rate_guard", algorithm = "leaky", capacity = 129, refillPerSec = 34, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
