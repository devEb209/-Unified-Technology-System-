-- ARKHER SYSTEM G.0287 :: Perceptual Metric Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0287"
	S.key = "arkher.neural.perceptual.quality_predictor"
	S.name = "Perceptual Metric Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perceptual.weight_codec" }
	S.tags = { "g", "perceptual", "predictor", "neural" }
	S.description = "Perceptual Metric Quality Predictor: predicted quality and cost of a setting for the Perceptual Metric subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.perceptual.quality_predictor", method = "markov", alpha = 0.10, window = 40 })
		inst.system = S
		inst.ctx = ctx
