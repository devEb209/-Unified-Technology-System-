-- ARKHER SYSTEM VD.0605 :: Seam Lattice Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0605"
	S.key = "arkher.contsim.seamlattice.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.seamlattice.multi-scale_fidelity" }
	S.tags = { "vd", "seamlattice", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.seamlattice.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
