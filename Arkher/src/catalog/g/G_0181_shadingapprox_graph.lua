-- ARKHER SYSTEM G.0181 :: Shading Approximation Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0181"
	S.key = "arkher.neural.shadingapprox.sampling_graph"
	S.name = "Shading Approximation Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.shadingapprox.training_ledger" }
	S.tags = { "g", "shadingapprox", "graph", "neural" }
	S.description = "Shading Approximation Sampling Graph: dependency graph of sampling stages for the Shading Approximation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.shadingapprox.sampling_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
