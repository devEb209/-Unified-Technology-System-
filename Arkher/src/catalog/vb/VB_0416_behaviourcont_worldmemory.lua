-- ARKHER SYSTEM VB.0416 :: Behaviour Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0416"
	S.key = "arkher.conttime.behaviourcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.behaviourcont.neural_field" }
	S.tags = { "vb", "behaviourcont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.behaviourcont.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
