-- ARKHER SYSTEM Q.0055 :: Icon Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0055"
	S.key = "arkher.ui.icon.localization_registry"
	S.name = "Icon Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Icon"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.icon.theme_composition" }
	S.tags = { "q", "icon", "registry", "ui" }
	S.description = "Icon Localization Registry: catalogue of strings, plurals and locale metadata for the Icon subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.icon.localization_registry" })
		inst.system = S
		inst.ctx = ctx
