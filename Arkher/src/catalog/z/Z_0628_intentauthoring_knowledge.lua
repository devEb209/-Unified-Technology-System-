-- ARKHER SYSTEM Z.0628 :: Intent Driven Authoring Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0628"
	S.key = "arkher.origin.intentauthoring.semantic_graph"
	S.name = "Intent Driven Authoring Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.world_architect" }
	S.tags = { "z", "intentauthoring", "knowledge", "origin" }
	S.description = "Intent Driven Authoring Semantic Graph: typed entities and inferred relations of the technology itself for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.intentauthoring.semantic_graph", dims = 32 })
		inst.system = S
		inst.ctx = ctx
