-- ARKHER SYSTEM L.0284 :: Day Night Cycle Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0284"
	S.key = "arkher.sim.daynight.forecast"
	S.name = "Day Night Cycle Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.daynight.analysis" }
	S.tags = { "l", "daynight", "predictor", "sim" }
	S.description = "Day Night Cycle Forecast: prediction of the region's next state for the Day Night Cycle subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.daynight.forecast", method = "ema", alpha = 0.14, window = 92 })
		inst.system = S
		inst.ctx = ctx
