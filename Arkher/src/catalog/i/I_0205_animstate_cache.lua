-- ARKHER SYSTEM I.0205 :: State Machine Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0205"
	S.key = "arkher.anim.animstate.pose_cache"
	S.name = "State Machine Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstate.playback_pipeline" }
	S.tags = { "i", "animstate", "cache", "anim" }
	S.description = "State Machine Pose Cache: reuse of sampled poses across frames and instances for the State Machine subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.animstate.pose_cache", policy = "lru", capacity = 400, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
