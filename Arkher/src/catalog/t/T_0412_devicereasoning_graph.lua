-- ARKHER SYSTEM T.0412 :: Device Reasoning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0412"
	S.key = "arkher.ai.devicereasoning.reasoning_graph"
	S.name = "Device Reasoning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.devicereasoning.world_architect" }
	S.tags = { "t", "devicereasoning", "graph", "ai" }
	S.description = "Device Reasoning Reasoning Graph: relationship modelling and shortest-path reasoning for the Device Reasoning subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.devicereasoning.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
