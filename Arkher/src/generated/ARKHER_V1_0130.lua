--!strict
-- ZBrush SubTool — CORE Stack #0130
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="ZBrush SubTool — CORE Stack #0130", size=Vector2.new(640, 420), pos=UDim2.fromOffset(190, 210), parent=parent, icon="✈"})
