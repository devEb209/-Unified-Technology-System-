-- ARKHER SYSTEM VB.0072 :: Sparse Page Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0072"
	S.key = "arkher.conttime.sparsepage.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.sparsepage.reality_continuum" }
	S.tags = { "vb", "sparsepage", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.sparsepage.emergence_continuum", windowSize = 5, threshold = 1.60, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
