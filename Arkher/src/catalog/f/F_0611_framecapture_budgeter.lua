-- ARKHER SYSTEM F.0611 :: Frame Capture Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0611"
	S.key = "arkher.render.framecapture.draw_budget"
	S.name = "Frame Capture Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framecapture.adaptive_resolution" }
	S.tags = { "f", "framecapture", "budgeter", "render" }
	S.description = "Frame Capture Draw Budget: draw call and triangle budget allocation for the Frame Capture subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.framecapture.draw_budget", total = 409, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
