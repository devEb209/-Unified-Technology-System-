-- ARKHER SYSTEM O.0266 :: Stinger Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0266"
	S.key = "arkher.audio.stinger.mixer_bus"
	S.name = "Stinger Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Stinger"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.stinger.dsp_chain" }
	S.tags = { "o", "stinger", "mixer", "audio" }
	S.description = "Stinger Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Stinger subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.stinger.mixer_bus", maxVoices = 24 })
		inst.system = S
		inst.ctx = ctx
