-- ARKHER SYSTEM T.0450 :: Behaviour Learning Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0450"
	S.key = "arkher.ai.behaviourlearning.semantic_knowledge"
	S.name = "Behaviour Learning Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.behaviourlearning.intent_understanding" }
	S.tags = { "t", "behaviourlearning", "knowledge", "ai" }
	S.description = "Behaviour Learning Semantic Knowledge: typed entities, weighted relations and inferred closure for the Behaviour Learning subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.behaviourlearning.semantic_knowledge", dims = 40 })
		inst.system = S
		inst.ctx = ctx
