-- ARKHER SYSTEM VA.0339 :: Society Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0339"
	S.key = "arkher.contworld.societycont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.societycont.epoch_clock" }
	S.tags = { "va", "societycont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.societycont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
