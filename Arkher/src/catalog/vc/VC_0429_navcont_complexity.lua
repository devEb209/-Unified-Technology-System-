-- ARKHER SYSTEM VC.0429 :: Navigation Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0429"
	S.key = "arkher.contneural.navcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.navcont.world_memory_stream" }
	S.tags = { "vc", "navcont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.navcont.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
