-- ARKHER SYSTEM P.0356 :: Threat Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0356"
	S.key = "arkher.play.threat.balance_analysis"
	S.name = "Threat Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Threat"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.threat.event_ledger" }
	S.tags = { "p", "threat", "analyzer", "play" }
	S.description = "Threat Balance Analysis: distribution, outlier and pacing analysis for the Threat subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.threat.balance_analysis", window = 211, buckets = 11, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
