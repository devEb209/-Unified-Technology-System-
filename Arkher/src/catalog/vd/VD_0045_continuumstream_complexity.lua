-- ARKHER SYSTEM VD.0045 :: Continuum Stream Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0045"
	S.key = "arkher.contsim.continuumstream.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.continuumstream.world_memory_stream" }
	S.tags = { "vd", "continuumstream", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.continuumstream.complexity_budget", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
