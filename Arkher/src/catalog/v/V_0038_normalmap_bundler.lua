-- ARKHER SYSTEM V.0038 :: Normal Map Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0038"
	S.key = "arkher.asset.normalmap.bundling"
	S.name = "Normal Map Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.normalmap.import" }
	S.tags = { "v", "normalmap", "bundler", "asset" }
	S.description = "Normal Map Bundling: size-bounded packing, manifests and delta patches for the Normal Map subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.normalmap.bundling", maxBundleBytes = 655360 })
		inst.system = S
		inst.ctx = ctx
