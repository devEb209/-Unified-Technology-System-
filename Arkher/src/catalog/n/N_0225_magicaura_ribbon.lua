-- ARKHER SYSTEM N.0225 :: Magic Aura Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0225"
	S.key = "arkher.vfx.magicaura.ribbon_and_trail"
	S.name = "Magic Aura Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Magic Aura"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.magicaura.force_field" }
	S.tags = { "n", "magicaura", "ribbon", "vfx" }
	S.description = "Magic Aura Ribbon And Trail: trail points, tapering, beams and decimation for the Magic Aura subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.magicaura.ribbon_and_trail", maxPoints = 16, lifetime = 0.70, minDistance = 0.20, width = 0.80 })
		inst.system = S
		inst.ctx = ctx
