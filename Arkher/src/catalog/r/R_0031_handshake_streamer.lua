-- ARKHER SYSTEM R.0031 :: Handshake Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0031"
	S.key = "arkher.net.handshake.interest_streaming"
	S.name = "Handshake Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Handshake"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.handshake.serialization_codec" }
	S.tags = { "r", "handshake", "streamer", "net" }
	S.description = "Handshake Interest Streaming: distance-driven residency of replicated content for the Handshake subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.handshake.interest_streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
