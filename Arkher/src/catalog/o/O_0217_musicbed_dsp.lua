-- ARKHER SYSTEM O.0217 :: Music Bed DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0217"
	S.key = "arkher.audio.musicbed.dsp_chain"
	S.name = "Music Bed DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Music Bed"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "musicbed", "dsp", "audio" }
	S.description = "Music Bed DSP Chain: biquad filtering, delay, envelope and soft clipping for the Music Bed subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.musicbed.dsp_chain", sampleRate = 22050, filter = "lowpass", cutoff = 1500, q = 0.540 })
		inst.system = S
		inst.ctx = ctx
