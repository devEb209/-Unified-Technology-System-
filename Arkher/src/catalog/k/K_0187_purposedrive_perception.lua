-- ARKHER SYSTEM K.0187 :: Purpose Drive Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0187"
	S.key = "arkher.npc.purposedrive.perception"
	S.name = "Purpose Drive Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.purposedrive.emotion" }
	S.tags = { "k", "purposedrive", "perception", "npc" }
	S.description = "Purpose Drive Perception: sight, hearing and bounded attention for the Purpose Drive subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.purposedrive.perception", sightRange = 35, hearingRange = 20, attentionSlots = 5, fov = 1.780 })
		inst.system = S
		inst.ctx = ctx
