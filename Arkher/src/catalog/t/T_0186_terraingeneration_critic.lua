-- ARKHER SYSTEM T.0186 :: Terrain Generation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0186"
	S.key = "arkher.ai.terraingeneration.self_critique"
	S.name = "Terrain Generation Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.terraingeneration.plan_workflow" }
	S.tags = { "t", "terraingeneration", "critic", "ai" }
	S.description = "Terrain Generation Self Critique: weighted evaluation of the result against declared criteria for the Terrain Generation subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.terraingeneration.self_critique", passMark = 0.80, reviseMark = 0.45, seed = 88375 })
		inst.system = S
		inst.ctx = ctx
