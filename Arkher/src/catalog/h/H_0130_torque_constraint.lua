-- ARKHER SYSTEM H.0130 :: Torque Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0130"
	S.key = "arkher.physics.torque.constraint_solver"
	S.name = "Torque Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Torque"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.torque.contact_generation" }
	S.tags = { "h", "torque", "constraint", "physics" }
	S.description = "Torque Constraint Solver: sequential impulses, friction, joints and warm starting for the Torque subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.torque.constraint_solver", iterations = 6, baumgarte = 0.12, warmStart = true })
		inst.system = S
		inst.ctx = ctx
