-- ARKHER SYSTEM Z.0023 :: Predictive Optimization Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0023"
	S.key = "arkher.origin.predictiveopt.simulation_fabric"
	S.name = "Predictive Optimization Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.complexity_governance" }
	S.tags = { "z", "predictiveopt", "fabric", "origin" }
	S.description = "Predictive Optimization Simulation Fabric: every simulation domain stepped under one budgeted clock for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.predictiveopt.simulation_fabric", budgetMs = 2.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
