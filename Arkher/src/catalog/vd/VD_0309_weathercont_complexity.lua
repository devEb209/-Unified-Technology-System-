-- ARKHER SYSTEM VD.0309 :: Weather Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0309"
	S.key = "arkher.contsim.weathercont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.weathercont.world_memory_stream" }
	S.tags = { "vd", "weathercont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.weathercont.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
