-- ARKHER SYSTEM T.0057 :: World Knowledge Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0057"
	S.key = "arkher.ai.worldknowledge.intent_understanding"
	S.name = "World Knowledge Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "worldknowledge", "intent", "ai" }
	S.description = "World Knowledge Intent Understanding: natural language turned into an actionable, scored intent for the World Knowledge subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.worldknowledge.intent_understanding", minConfidence = 0.36 })
		inst.system = S
		inst.ctx = ctx
