...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Mapbox GL — CORE Map #0078", size=Vector2.new(600, 480), pos=UDim2.fromOffset(314, 106), parent=parent, icon="▣"})
