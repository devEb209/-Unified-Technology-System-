-- ARKHER SYSTEM N.0500 :: Environment Ambience Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0500"
	S.key = "arkher.vfx.envambience.effect_graph"
	S.name = "Environment Ambience Effect Graph"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.envambience.curve_authoring" }
	S.tags = { "n", "envambience", "shadegraph", "vfx" }
	S.description = "Environment Ambience Effect Graph: node graph describing how the effect is shaded for the Environment Ambience subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.envambience.effect_graph" })
		inst.system = S
		inst.ctx = ctx
