-- ARKHER SYSTEM G.0396 :: Fallback Heuristic Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0396"
	S.key = "arkher.neural.fallbackheuristic.reconstruction"
	S.name = "Fallback Heuristic Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.fallbackheuristic.temporal_history" }
	S.tags = { "g", "fallbackheuristic", "upscaler", "neural" }
	S.description = "Fallback Heuristic Reconstruction: resolution ladder and image reconstruction for the Fallback Heuristic subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.fallbackheuristic.reconstruction", targetMs = 16.10, index = 5, sharpness = 0.55 })
		inst.system = S
		inst.ctx = ctx
