-- ARKHER SYSTEM N.0488 :: Glow Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0488"
	S.key = "arkher.vfx.glow.effect_composition"
	S.name = "Glow Effect Composition"
	S.category = "N"
	S.family = "VFX"
	S.area = "Glow"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.glow.effect_graph" }
	S.tags = { "n", "glow", "composer", "vfx" }
	S.description = "Glow Effect Composition: blending of several effect signals into one output for the Glow subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.glow.effect_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
