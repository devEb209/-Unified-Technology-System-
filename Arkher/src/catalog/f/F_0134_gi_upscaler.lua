-- ARKHER SYSTEM F.0134 :: Global Illumination Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0134"
	S.key = "arkher.render.gi.adaptive_resolution"
	S.name = "Global Illumination Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.gi.temporal_resolve" }
	S.tags = { "f", "gi", "upscaler", "render" }
	S.description = "Global Illumination Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Global Illumination subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.gi.adaptive_resolution", targetMs = 12.10, index = 4, sharpness = 0.29 })
		inst.system = S
		inst.ctx = ctx
