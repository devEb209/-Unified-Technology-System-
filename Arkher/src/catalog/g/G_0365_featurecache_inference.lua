-- ARKHER SYSTEM G.0365 :: Feature Cache Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0365"
	S.key = "arkher.neural.featurecache.inference_core"
	S.name = "Feature Cache Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "featurecache", "inference", "neural" }
	S.description = "Feature Cache Inference Core: dense network forward pass and training for the Feature Cache subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.featurecache.inference_core", seed = 5442 })
		inst.system = S
		inst.ctx = ctx
