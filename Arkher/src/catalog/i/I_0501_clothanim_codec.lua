-- ARKHER SYSTEM I.0501 :: Cloth Animation Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0501"
	S.key = "arkher.anim.clothanim.compression_codec"
	S.name = "Cloth Animation Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clothanim.retarget_graph" }
	S.tags = { "i", "clothanim", "codec", "anim" }
	S.description = "Cloth Animation Compression Codec: curve compression and quantized transport for the Cloth Animation subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.clothanim.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
