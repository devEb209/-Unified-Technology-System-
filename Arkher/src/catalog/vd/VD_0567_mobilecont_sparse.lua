-- ARKHER SYSTEM VD.0567 :: Mobile Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0567"
	S.key = "arkher.contsim.mobilecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.mobilecont.epoch_clock" }
	S.tags = { "vd", "mobilecont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.mobilecont.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
