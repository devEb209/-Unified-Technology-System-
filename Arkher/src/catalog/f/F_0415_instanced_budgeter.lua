-- ARKHER SYSTEM F.0415 :: Instanced Draw Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0415"
	S.key = "arkher.render.instanced.draw_budget"
	S.name = "Instanced Draw Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.instanced.adaptive_resolution" }
	S.tags = { "f", "instanced", "budgeter", "render" }
	S.description = "Instanced Draw Draw Budget: draw call and triangle budget allocation for the Instanced Draw subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.instanced.draw_budget", total = 426, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
