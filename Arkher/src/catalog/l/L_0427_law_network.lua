-- ARKHER SYSTEM L.0427 :: Law Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0427"
	S.key = "arkher.sim.law.route_network"
	S.name = "Law Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.law.region_graph" }
	S.tags = { "l", "law", "network", "sim" }
	S.description = "Law Route Network: roads, rivers and routes between settlements for the Law subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.law.route_network" })
		inst.system = S
		inst.ctx = ctx
