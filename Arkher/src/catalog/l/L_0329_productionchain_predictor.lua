-- ARKHER SYSTEM L.0329 :: Production Chain Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0329"
	S.key = "arkher.sim.productionchain.forecast"
	S.name = "Production Chain Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.productionchain.analysis" }
	S.tags = { "l", "productionchain", "predictor", "sim" }
	S.description = "Production Chain Forecast: prediction of the region's next state for the Production Chain subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.productionchain.forecast", method = "linear", alpha = 0.46, window = 60 })
		inst.system = S
		inst.ctx = ctx
