-- ARKHER SYSTEM H.0646 :: Wheel Suspension Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0646"
	S.key = "arkher.physics.suspension.collision_shape"
	S.name = "Wheel Suspension Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.suspension.body_dynamics" }
	S.tags = { "h", "suspension", "collider", "physics" }
	S.description = "Wheel Suspension Collision Shape: shape bounds, support mapping and closest points for the Wheel Suspension subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.suspension.collision_shape", shape = "box", radius = 2.60, height = 2.20, layer = "character" })
		inst.system = S
		inst.ctx = ctx
