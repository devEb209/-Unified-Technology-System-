-- ARKHER SYSTEM T.0527 :: Audio Reasoning Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0527"
	S.key = "arkher.ai.audioreasoning.working_memory"
	S.name = "Audio Reasoning Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.audioreasoning.outcome_prediction" }
	S.tags = { "t", "audioreasoning", "memory", "ai" }
	S.description = "Audio Reasoning Working Memory: decaying, consolidating recall of what the agent learned for the Audio Reasoning subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.audioreasoning.working_memory", capacity = 59, decayRate = 0.035, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
