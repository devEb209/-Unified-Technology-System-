-- ARKHER SYSTEM O.0315 :: Vehicle Audio Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0315"
	S.key = "arkher.audio.vehicleaudio.spatialization"
	S.name = "Vehicle Audio Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.vehicleaudio.mixer_bus" }
	S.tags = { "o", "vehicleaudio", "spatialaudio", "audio" }
	S.description = "Vehicle Audio Spatialization: distance attenuation, panning, occlusion and doppler for the Vehicle Audio subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.vehicleaudio.spatialization", model = "linear", refDistance = 7, maxDistance = 80, rolloff = 0.80, maxVoices = 28 })
		inst.system = S
		inst.ctx = ctx
