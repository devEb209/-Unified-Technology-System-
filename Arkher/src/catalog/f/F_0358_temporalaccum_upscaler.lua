-- ARKHER SYSTEM F.0358 :: Temporal Accumulation Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0358"
	S.key = "arkher.render.temporalaccum.adaptive_resolution"
	S.name = "Temporal Accumulation Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.temporalaccum.temporal_resolve" }
	S.tags = { "f", "temporalaccum", "upscaler", "render" }
	S.description = "Temporal Accumulation Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Temporal Accumulation subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.temporalaccum.adaptive_resolution", targetMs = 15.10, index = 4, sharpness = 0.22 })
		inst.system = S
		inst.ctx = ctx
