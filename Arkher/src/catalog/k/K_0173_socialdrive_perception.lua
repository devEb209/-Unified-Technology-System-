-- ARKHER SYSTEM K.0173 :: Social Drive Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0173"
	S.key = "arkher.npc.socialdrive.perception"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.socialdrive.emotion" }
	S.tags = { "k", "socialdrive", "perception", "npc" }
	S.description = "Social Drive Perception: sight, hearing and bounded attention for the Social Drive subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.socialdrive.perception", sightRange = 55, hearingRange = 20, attentionSlots = 5, fov = 1.660 })
		inst.system = S
		inst.ctx = ctx
