-- ARKHER SYSTEM I.0381 :: Bone Mapping Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0381"
	S.key = "arkher.anim.bonemapping.inverse_kinematics"
	S.name = "Bone Mapping Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bone Mapping"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonemapping.layered_blending" }
	S.tags = { "i", "bonemapping", "ik", "anim" }
	S.description = "Bone Mapping Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Bone Mapping subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.bonemapping.inverse_kinematics", iterations = 5, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
