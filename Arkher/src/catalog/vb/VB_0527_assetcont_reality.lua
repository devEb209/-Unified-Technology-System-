-- ARKHER SYSTEM VB.0527 :: Asset Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0527"
	S.key = "arkher.conttime.assetcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.assetcont.simulation_fabric" }
	S.tags = { "vb", "assetcont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.assetcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
