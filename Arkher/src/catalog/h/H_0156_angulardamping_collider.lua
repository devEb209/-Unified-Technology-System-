-- ARKHER SYSTEM H.0156 :: Angular Damping Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0156"
	S.key = "arkher.physics.angulardamping.collision_shape"
	S.name = "Angular Damping Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.angulardamping.body_dynamics" }
	S.tags = { "h", "angulardamping", "collider", "physics" }
	S.description = "Angular Damping Collision Shape: shape bounds, support mapping and closest points for the Angular Damping subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.angulardamping.collision_shape", shape = "box", radius = 1.10, height = 1.90, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
