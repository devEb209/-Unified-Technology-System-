-- ARKHER SYSTEM VD.0464 :: Audio Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0464"
	S.key = "arkher.contsim.audiocont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.audiocont.neural_field" }
	S.tags = { "vd", "audiocont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.audiocont.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
