-- ARKHER SYSTEM Z.0439 :: Offline World Progression Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0439"
	S.key = "arkher.origin.offlineprogression.residency_streaming"
	S.name = "Offline World Progression Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.budget_governor" }
	S.tags = { "z", "offlineprogression", "streamer", "origin" }
	S.description = "Offline World Progression Residency Streaming: distance-driven residency of the technology's workload for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.offlineprogression.residency_streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
