-- ARKHER SYSTEM VD.0501 :: Rendering Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0501"
	S.key = "arkher.contsim.rendercont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.rendercont.world_memory_stream" }
	S.tags = { "vd", "rendercont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.rendercont.complexity_budget", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
