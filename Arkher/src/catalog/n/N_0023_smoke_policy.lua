-- ARKHER SYSTEM N.0023 :: Smoke Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0023"
	S.key = "arkher.vfx.smoke.quality_policy"
	S.name = "Smoke Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Smoke"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.smoke.result_cache" }
	S.tags = { "n", "smoke", "policy", "vfx" }
	S.description = "Smoke Quality Policy: distance and device driven fidelity bands for the Smoke subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.smoke.quality_policy", algorithm = "roundrobin", starvationGuard = 44 })
		inst.system = S
		inst.ctx = ctx
