-- ARKHER SYSTEM VD.0562 :: Device Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0562"
	S.key = "arkher.contsim.devicecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.devicecont.complexity_budget" }
	S.tags = { "vd", "devicecont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.devicecont.simulation_fabric", budgetMs = 1.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
