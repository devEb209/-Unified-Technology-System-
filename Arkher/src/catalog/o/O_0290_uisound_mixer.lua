-- ARKHER SYSTEM O.0290 :: UI Sound Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0290"
	S.key = "arkher.audio.uisound.mixer_bus"
	S.name = "UI Sound Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "UI Sound"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.uisound.dsp_chain" }
	S.tags = { "o", "uisound", "mixer", "audio" }
	S.description = "UI Sound Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the UI Sound subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.uisound.mixer_bus", maxVoices = 48 })
		inst.system = S
		inst.ctx = ctx
