-- ARKHER SYSTEM I.0144 :: Layer Mask Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0144"
	S.key = "arkher.anim.layermask.skeleton"
	S.name = "Layer Mask Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Layer Mask"
	S.aspect = "Skeleton"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "layermask", "skeleton", "anim" }
	S.description = "Layer Mask Skeleton: bone hierarchy, bind pose and world resolution for the Layer Mask subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.layermask.skeleton" })
		inst.system = S
		inst.ctx = ctx
