-- ARKHER SYSTEM R.0294 :: Server Authority Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0294"
	S.key = "arkher.net.serverauthority.serialization_codec"
	S.name = "Server Authority Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverauthority.bandwidth_budget" }
	S.tags = { "r", "serverauthority", "codec", "net" }
	S.description = "Server Authority Serialization Codec: compact encoding, diffing and checksum of payloads for the Server Authority subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.serverauthority.serialization_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
