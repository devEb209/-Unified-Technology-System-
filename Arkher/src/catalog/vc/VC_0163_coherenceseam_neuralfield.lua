-- ARKHER SYSTEM VC.0163 :: Coherence Seam Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0163"
	S.key = "arkher.contneural.coherenceseam.neural_field"
	S.name = "Coherence Seam Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.coherenceseam.coherence_guard" }
	S.tags = { "vc", "coherenceseam", "neuralfield", "contneural" }
	S.description = "Coherence Seam Neural Field: neural field encoding and reconstruction for the Coherence Seam subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.coherenceseam.neural_field", dims = 20, hidden = 16, seed = 22870 })
		inst.system = S
		inst.ctx = ctx
