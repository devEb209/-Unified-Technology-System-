--!strict
-- Quixel Bridge — CORE Profiler #0084
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Quixel Bridge — CORE Profiler #0084", size=Vector2.new(600, 500), pos=UDim2.fromOffset(392, 208), parent=parent, icon="☀"})
...
Components.TextField(right, "File", "input.png", function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_File"..84, v) end end)
