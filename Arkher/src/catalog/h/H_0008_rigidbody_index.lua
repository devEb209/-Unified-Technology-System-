-- ARKHER SYSTEM H.0008 :: Rigid Body Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0008"
	S.key = "arkher.physics.rigidbody.broadphase_index"
	S.name = "Rigid Body Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Rigid Body"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rigidbody.vehicle" }
	S.tags = { "h", "rigidbody", "index", "physics" }
	S.description = "Rigid Body Broadphase Index: spatial acceleration of candidate pair finding for the Rigid Body subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.rigidbody.broadphase_index", mode = "hash", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
