-- ARKHER SYSTEM P.0362 :: Death And Respawn Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0362"
	S.key = "arkher.play.deathrespawn.inventory"
	S.name = "Death And Respawn Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.deathrespawn.attributes" }
	S.tags = { "p", "deathrespawn", "inventory", "play" }
	S.description = "Death And Respawn Inventory: slots, stacking, weight, equipment and crafting for the Death And Respawn subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.deathrespawn.inventory", slots = 32, maxWeight = 130 })
		inst.system = S
		inst.ctx = ctx
