-- ARKHER SYSTEM G.0283 :: Perceptual Metric Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0283"
	S.key = "arkher.neural.perceptual.temporal_history"
	S.name = "Perceptual Metric Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perceptual.feature_extraction" }
	S.tags = { "g", "perceptual", "temporal", "neural" }
	S.description = "Perceptual Metric Temporal History: history buffers reused across frames for the Perceptual Metric subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.perceptual.temporal_history", feedback = 0.93, phase = 8 })
		inst.system = S
		inst.ctx = ctx
