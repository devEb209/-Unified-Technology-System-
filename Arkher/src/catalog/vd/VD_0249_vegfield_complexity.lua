-- ARKHER SYSTEM VD.0249 :: Vegetation Field Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0249"
	S.key = "arkher.contsim.vegfield.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vegfield.world_memory_stream" }
	S.tags = { "vd", "vegfield", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.vegfield.complexity_budget", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
