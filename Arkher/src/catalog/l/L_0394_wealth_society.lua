-- ARKHER SYSTEM L.0394 :: Wealth Distribution Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0394"
	S.key = "arkher.sim.wealth.society"
	S.name = "Wealth Distribution Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wealth.economy" }
	S.tags = { "l", "wealth", "society", "sim" }
	S.description = "Wealth Distribution Society: relations, factions, reputation and cohesion of the region for the Wealth Distribution subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.wealth.society", decayRate = 0.009, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
