-- ARKHER SYSTEM N.0460 :: Camera Shake Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0460"
	S.key = "arkher.vfx.camerashake.curve_authoring"
	S.name = "Camera Shake Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Camera Shake"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.camerashake.ribbon_and_trail" }
	S.tags = { "n", "camerashake", "spline", "vfx" }
	S.description = "Camera Shake Curve Authoring: authored curves driving the effect over its life for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.camerashake.curve_authoring", tension = 0.37, closed = false })
		inst.system = S
		inst.ctx = ctx
