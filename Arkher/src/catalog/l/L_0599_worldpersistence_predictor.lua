-- ARKHER SYSTEM L.0599 :: World Persistence Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0599"
	S.key = "arkher.sim.worldpersistence.forecast"
	S.name = "World Persistence Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldpersistence.analysis" }
	S.tags = { "l", "worldpersistence", "predictor", "sim" }
	S.description = "World Persistence Forecast: prediction of the region's next state for the World Persistence subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.worldpersistence.forecast", method = "linear", alpha = 0.41, window = 111 })
		inst.system = S
		inst.ctx = ctx
