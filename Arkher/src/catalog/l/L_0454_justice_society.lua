-- ARKHER SYSTEM L.0454 :: Justice Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0454"
	S.key = "arkher.sim.justice.society"
	S.name = "Justice Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.justice.economy" }
	S.tags = { "l", "justice", "society", "sim" }
	S.description = "Justice Society: relations, factions, reputation and cohesion of the region for the Justice subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.justice.society", decayRate = 0.006, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
