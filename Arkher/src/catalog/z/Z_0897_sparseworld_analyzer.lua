-- ARKHER SYSTEM Z.0897 :: Sparse World Representation Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0897"
	S.key = "arkher.origin.sparseworld.behaviour_analysis"
	S.name = "Sparse World Representation Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.governance_policy" }
	S.tags = { "z", "sparseworld", "analyzer", "origin" }
	S.description = "Sparse World Representation Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.sparseworld.behaviour_analysis", window = 216, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
