-- ARKHER SYSTEM Z.0498 :: Cultural Evolution Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0498"
	S.key = "arkher.origin.culturalevolution.budget_governor"
	S.name = "Cultural Evolution Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.behaviour_analysis" }
	S.tags = { "z", "culturalevolution", "budgeter", "origin" }
	S.description = "Cultural Evolution Budget Governor: allocation of a scarce resource across the technology's consumers for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.culturalevolution.budget_governor", total = 165, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
