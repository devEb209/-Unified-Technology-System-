-- ARKHER SYSTEM P.0159 :: Gathering Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0159"
	S.key = "arkher.play.gathering.objectives"
	S.name = "Gathering Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Gathering"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.gathering.inventory" }
	S.tags = { "p", "gathering", "quest", "play" }
	S.description = "Gathering Objectives: objectives, prerequisites, progress and rewards for the Gathering subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.gathering.objectives" })
		inst.system = S
		inst.ctx = ctx
