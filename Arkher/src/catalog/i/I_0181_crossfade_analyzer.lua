-- ARKHER SYSTEM I.0181 :: Crossfade Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0181"
	S.key = "arkher.anim.crossfade.analysis"
	S.name = "Crossfade Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Crossfade"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crossfade.quality_policy" }
	S.tags = { "i", "crossfade", "analyzer", "anim" }
	S.description = "Crossfade Analysis: pop, drift and cost analysis of playback for the Crossfade subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.crossfade.analysis", window = 230, buckets = 18, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
