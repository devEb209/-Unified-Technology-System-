-- ARKHER SYSTEM VB.0339 :: Society Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0339"
	S.key = "arkher.conttime.societycont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.societycont.epoch_clock" }
	S.tags = { "vb", "societycont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.societycont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
