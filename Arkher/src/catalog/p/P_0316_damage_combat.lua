-- ARKHER SYSTEM P.0316 :: Damage Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0316"
	S.key = "arkher.play.damage.combat_resolution"
	S.name = "Damage Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Damage"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.damage.objectives" }
	S.tags = { "p", "damage", "combat", "play" }
	S.description = "Damage Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Damage subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.damage.combat_resolution", seed = 18701, armourK = 130, critMultiplier = 2.00 })
		inst.system = S
		inst.ctx = ctx
