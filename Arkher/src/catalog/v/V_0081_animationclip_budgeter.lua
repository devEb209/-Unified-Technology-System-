-- ARKHER SYSTEM V.0081 :: Animation Clip Size Budget
...
-- Kit: budgeter (byte budget shared between competing asset classes)
--@arkher-module
return function(A)
	...
	local S = {}
	S.id = "V.0081"
	S.key = "arkher.asset.animationclip.size_budget"
	S.name = "Animation Clip Size Budget"
	S.category = "V"
	S.family = "ASSET PIPELINE"
	S.area = "Animation Clip"
	S.aspect = "Size Budget"
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.animationclip.compression_codec" }
	S.tags = { "v", "animationclip", "budgeter", "asset" }
	S.description = "Animation Clip Size Budget: byte budget shared between competing asset classes for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.animationclip.size_budget", total = 371, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
