--!strict
-- Frostbite Frosty — CORE Mixer #0142
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Frostbite Frosty — CORE Mixer #0142", size=Vector2.new(640, 460), pos=UDim2.fromOffset(346, 154), parent=parent, icon="≡"})
...
Components.Slider(right, "Rate", 0,3000,600, function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_Rate"..142, v) end end)
