-- ARKHER SYSTEM VD.0602 :: Seam Lattice Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0602"
	S.key = "arkher.contsim.seamlattice.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.seamlattice.infinite_grid" }
	S.tags = { "vd", "seamlattice", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.seamlattice.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
