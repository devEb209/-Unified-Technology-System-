-- ARKHER SYSTEM Z.0206 :: Persistent Reality State Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0206"
	S.key = "arkher.origin.persistentreality.emergence_detection"
	S.name = "Persistent Reality State Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.world_memory" }
	S.tags = { "z", "persistentreality", "emergence", "origin" }
	S.description = "Persistent Reality State Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.persistentreality.emergence_detection", windowSize = 6, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
