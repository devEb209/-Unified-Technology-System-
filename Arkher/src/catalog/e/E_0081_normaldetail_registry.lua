-- ARKHER SYSTEM E.0081 :: Normal Detail Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0081"
	S.key = "arkher.material.normaldetail.variant_registry"
	S.name = "Normal Detail Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.normaldetail.procedural_detail" }
	S.tags = { "e", "normaldetail", "registry", "material" }
	S.description = "Normal Detail Variant Registry: named variants and their lifecycle for the Normal Detail subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.normaldetail.variant_registry" })
		inst.system = S
		inst.ctx = ctx
