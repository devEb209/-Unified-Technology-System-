-- ARKHER SYSTEM P.0262 :: Dialogue Choice Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0262"
	S.key = "arkher.play.dialoguechoice.content_registry"
	S.name = "Dialogue Choice Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.dialoguechoice.difficulty_controller" }
	S.tags = { "p", "dialoguechoice", "registry", "play" }
	S.description = "Dialogue Choice Content Registry: catalogue of the definitions this loop instantiates for the Dialogue Choice subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.dialoguechoice.content_registry" })
		inst.system = S
		inst.ctx = ctx
