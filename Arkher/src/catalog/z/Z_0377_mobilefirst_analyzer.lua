-- ARKHER SYSTEM Z.0377 :: Mobile First Governor Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0377"
	S.key = "arkher.origin.mobilefirst.behaviour_analysis"
	S.name = "Mobile First Governor Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.governance_policy" }
	S.tags = { "z", "mobilefirst", "analyzer", "origin" }
	S.description = "Mobile First Governor Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.mobilefirst.behaviour_analysis", window = 201, buckets = 17, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
