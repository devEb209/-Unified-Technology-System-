-- ARKHER SYSTEM K.0400 :: Plan Execution Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0400"
	S.key = "arkher.npc.planexecution.goal_planner"
	S.name = "Plan Execution Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.planexecution.utility_reasoning" }
	S.tags = { "k", "planexecution", "planner", "npc" }
	S.description = "Plan Execution Goal Planner: backward GOAP planning to reach a goal state for the Plan Execution subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.planexecution.goal_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
