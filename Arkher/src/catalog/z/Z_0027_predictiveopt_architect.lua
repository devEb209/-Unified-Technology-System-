-- ARKHER SYSTEM Z.0027 :: Predictive Optimization World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0027"
	S.key = "arkher.origin.predictiveopt.world_architect"
	S.name = "Predictive Optimization World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.emergence_detection" }
	S.tags = { "z", "predictiveopt", "architect", "origin" }
	S.description = "Predictive Optimization World Architect: hierarchical world composition with conserved budgets for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.predictiveopt.world_architect", budget = 1000, seed = 53224 })
		inst.system = S
		inst.ctx = ctx
