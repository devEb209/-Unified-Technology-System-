-- ARKHER SYSTEM T.0430 :: Mobile Reasoning Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0430"
	S.key = "arkher.ai.mobilereasoning.utility_selection"
	S.name = "Mobile Reasoning Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.mobilereasoning.working_memory" }
	S.tags = { "t", "mobilereasoning", "utility", "ai" }
	S.description = "Mobile Reasoning Utility Selection: scored choice between competing courses of action for the Mobile Reasoning subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.mobilereasoning.utility_selection", momentum = 0.12 })
		inst.system = S
		inst.ctx = ctx
