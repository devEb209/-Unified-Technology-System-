-- ARKHER SYSTEM R.0071 :: Entity Replication Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0071"
	S.key = "arkher.net.entityreplication.latency_analysis"
	S.name = "Entity Replication Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.entityreplication.audit_ledger" }
	S.tags = { "r", "entityreplication", "analyzer", "net" }
	S.description = "Entity Replication Latency Analysis: round trip, jitter and loss analysis for the Entity Replication subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.entityreplication.latency_analysis", window = 218, buckets = 10, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
