-- ARKHER SYSTEM R.0153 :: Delta Compression Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0153"
	S.key = "arkher.net.deltacompression.session_registry"
	S.name = "Delta Compression Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.deltacompression.rate_guard" }
	S.tags = { "r", "deltacompression", "registry", "net" }
	S.description = "Delta Compression Session Registry: catalogue of sessions, players and their metadata for the Delta Compression subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.deltacompression.session_registry" })
		inst.system = S
		inst.ctx = ctx
