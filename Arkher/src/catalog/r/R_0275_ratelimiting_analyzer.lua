-- ARKHER SYSTEM R.0275 :: Rate Limiting Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0275"
	S.key = "arkher.net.ratelimiting.latency_analysis"
	S.name = "Rate Limiting Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.ratelimiting.audit_ledger" }
	S.tags = { "r", "ratelimiting", "analyzer", "net" }
	S.description = "Rate Limiting Latency Analysis: round trip, jitter and loss analysis for the Rate Limiting subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.ratelimiting.latency_analysis", window = 90, buckets = 18, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
