-- ARKHER SYSTEM VC.0579 :: Thermal Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0579"
	S.key = "arkher.contneural.thermalcont.sparse_residency"
	S.name = "Thermal Continuum Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.thermalcont.epoch_clock" }
	S.tags = { "vc", "thermalcont", "sparse", "contneural" }
	S.description = "Thermal Continuum Sparse Residency: sparse page residency with eviction and compression for the Thermal Continuum subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.thermalcont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
