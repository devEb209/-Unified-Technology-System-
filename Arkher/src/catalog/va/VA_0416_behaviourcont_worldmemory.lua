-- ARKHER SYSTEM VA.0416 :: Behaviour Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0416"
	S.key = "arkher.contworld.behaviourcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.behaviourcont.neural_field" }
	S.tags = { "va", "behaviourcont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.behaviourcont.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
