-- ARKHER SYSTEM O.0426 :: Audio Profiling Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0426"
	S.key = "arkher.audio.audioprofiling.streaming"
	S.name = "Audio Profiling Streaming"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audioprofiling.voice_budget" }
	S.tags = { "o", "audioprofiling", "streamer", "audio" }
	S.description = "Audio Profiling Streaming: distance-driven residency of audio assets for the Audio Profiling subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.audioprofiling.streaming", radius = 280, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
