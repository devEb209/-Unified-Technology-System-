-- ARKHER SYSTEM VD.0351 :: Narrative Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0351"
	S.key = "arkher.contsim.narrativecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.narrativecont.epoch_clock" }
	S.tags = { "vd", "narrativecont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.narrativecont.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
