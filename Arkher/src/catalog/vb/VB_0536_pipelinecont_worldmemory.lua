-- ARKHER SYSTEM VB.0536 :: Pipeline Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0536"
	S.key = "arkher.conttime.pipelinecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.pipelinecont.neural_field" }
	S.tags = { "vb", "pipelinecont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.pipelinecont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
