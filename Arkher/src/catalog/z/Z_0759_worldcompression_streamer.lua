-- ARKHER SYSTEM Z.0759 :: World Compression Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0759"
	S.key = "arkher.origin.worldcompression.residency_streaming"
	S.name = "World Compression Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.budget_governor" }
	S.tags = { "z", "worldcompression", "streamer", "origin" }
	S.description = "World Compression Residency Streaming: distance-driven residency of the technology's workload for the World Compression subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.worldcompression.residency_streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
