-- ARKHER SYSTEM L.0322 :: Production Chain Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0322"
	S.key = "arkher.sim.productionchain.route_network"
	S.name = "Production Chain Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.productionchain.region_graph" }
	S.tags = { "l", "productionchain", "network", "sim" }
	S.description = "Production Chain Route Network: roads, rivers and routes between settlements for the Production Chain subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.productionchain.route_network" })
		inst.system = S
		inst.ctx = ctx
