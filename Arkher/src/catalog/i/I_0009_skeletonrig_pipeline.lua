-- ARKHER SYSTEM I.0009 :: Skeleton Rig Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0009"
	S.key = "arkher.anim.skeletonrig.playback_pipeline"
	S.name = "Skeleton Rig Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Skeleton Rig"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.skeletonrig.event_ledger" }
	S.tags = { "i", "skeletonrig", "pipeline", "anim" }
	S.description = "Skeleton Rig Playback Pipeline: ordered sample, blend, ik and output stages for the Skeleton Rig subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.skeletonrig.playback_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
