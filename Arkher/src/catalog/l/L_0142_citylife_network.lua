-- ARKHER SYSTEM L.0142 :: City Life Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0142"
	S.key = "arkher.sim.citylife.route_network"
	S.name = "City Life Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.citylife.region_graph" }
	S.tags = { "l", "citylife", "network", "sim" }
	S.description = "City Life Route Network: roads, rivers and routes between settlements for the City Life subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.citylife.route_network" })
		inst.system = S
		inst.ctx = ctx
