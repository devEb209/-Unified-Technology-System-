-- ARKHER SYSTEM O.0074 :: Dialogue Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0074"
	S.key = "arkher.audio.dialogue.mixer_bus"
	S.name = "Dialogue Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Dialogue"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.dialogue.dsp_chain" }
	S.tags = { "o", "dialogue", "mixer", "audio" }
	S.description = "Dialogue Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Dialogue subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.dialogue.mixer_bus", maxVoices = 24 })
		inst.system = S
		inst.ctx = ctx
