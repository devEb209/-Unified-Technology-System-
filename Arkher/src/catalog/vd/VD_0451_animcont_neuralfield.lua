-- ARKHER SYSTEM VD.0451 :: Animation Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0451"
	S.key = "arkher.contsim.animcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.animcont.coherence_guard" }
	S.tags = { "vd", "animcont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.animcont.neural_field", dims = 20, hidden = 16, seed = 92034 })
		inst.system = S
		inst.ctx = ctx
