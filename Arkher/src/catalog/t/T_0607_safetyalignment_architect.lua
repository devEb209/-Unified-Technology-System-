-- ARKHER SYSTEM T.0607 :: Safety Alignment World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0607"
	S.key = "arkher.ai.safetyalignment.world_architect"
	S.name = "Safety Alignment World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.safetyalignment.self_critique" }
	S.tags = { "t", "safetyalignment", "architect", "ai" }
	S.description = "Safety Alignment World Architect: composition of a whole world plan with conserved budgets for the Safety Alignment subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.safetyalignment.world_architect", budget = 1000, seed = 69024 })
		inst.system = S
		inst.ctx = ctx
