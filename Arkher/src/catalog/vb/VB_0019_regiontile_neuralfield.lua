-- ARKHER SYSTEM VB.0019 :: Region Tile Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0019"
	S.key = "arkher.conttime.regiontile.neural_field"
	S.name = "Region Tile Neural Field"
	S.category = "VB"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.regiontile.coherence_guard" }
	S.tags = { "vb", "regiontile", "neuralfield", "conttime" }
	S.description = "Region Tile Neural Field: neural field encoding and reconstruction for the Region Tile subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.regiontile.neural_field", dims = 20, hidden = 16, seed = 91778 })
		inst.system = S
		inst.ctx = ctx
