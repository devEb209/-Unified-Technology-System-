-- ARKHER SYSTEM T.0123 :: Long Term Memory Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0123"
	S.key = "arkher.ai.longtermmemory.action_planner"
	S.name = "Long Term Memory Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.longtermmemory.utility_selection" }
	S.tags = { "t", "longtermmemory", "planner", "ai" }
	S.description = "Long Term Memory Action Planner: goal-oriented action planning over preconditions for the Long Term Memory subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.longtermmemory.action_planner", maxDepth = 10 })
		inst.system = S
		inst.ctx = ctx
