-- ARKHER SYSTEM F.0683 :: Console Path Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0683"
	S.key = "arkher.render.consolepath.pass_cache"
	S.name = "Console Path Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Console Path"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.consolepath.render_policy" }
	S.tags = { "f", "consolepath", "cache", "render" }
	S.description = "Console Path Pass Cache: reuse of pass results across frames for the Console Path subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.consolepath.pass_cache", policy = "lru", capacity = 474, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
