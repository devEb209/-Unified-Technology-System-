-- ARKHER SYSTEM VA.0003 :: World Grid Cell Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0003"
	S.key = "arkher.contworld.worldcell.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldcell.epoch_clock" }
	S.tags = { "va", "worldcell", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.worldcell.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
