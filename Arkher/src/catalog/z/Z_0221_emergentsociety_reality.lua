-- ARKHER SYSTEM Z.0221 :: Emergent Society Framework Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0221"
	S.key = "arkher.origin.emergentsociety.reality_layering"
	S.name = "Emergent Society Framework Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "emergentsociety", "reality", "origin" }
	S.description = "Emergent Society Framework Reality Layering: stacked authored, simulated, proposed and player realities for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.emergentsociety.reality_layering" })
		inst.system = S
		inst.ctx = ctx
