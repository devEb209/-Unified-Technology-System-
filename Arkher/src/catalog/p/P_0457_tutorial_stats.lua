-- ARKHER SYSTEM P.0457 :: Tutorial Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0457"
	S.key = "arkher.play.tutorial.attributes"
	S.name = "Tutorial Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Tutorial"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "tutorial", "stats", "play" }
	S.description = "Tutorial Attributes: base values, layered modifiers and derived statistics for the Tutorial subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.tutorial.attributes" })
		inst.system = S
		inst.ctx = ctx
