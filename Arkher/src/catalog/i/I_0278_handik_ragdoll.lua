-- ARKHER SYSTEM I.0278 :: Hand Placement IK Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0278"
	S.key = "arkher.anim.handik.physical_blend"
	S.name = "Hand Placement IK Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.handik.inverse_kinematics" }
	S.tags = { "i", "handik", "ragdoll", "anim" }
	S.description = "Hand Placement IK Physical Blend: physical bones blended against the animated pose for the Hand Placement IK subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.handik.physical_blend", blendSpeed = 2.30 })
		inst.system = S
		inst.ctx = ctx
