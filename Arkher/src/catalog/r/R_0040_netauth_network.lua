-- ARKHER SYSTEM R.0040 :: Authentication Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0040"
	S.key = "arkher.net.netauth.transport_graph"
	S.name = "Authentication Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netauth.prediction_and_reconciliation" }
	S.tags = { "r", "netauth", "network", "net" }
	S.description = "Authentication Transport Graph: topology, capacity and routing between endpoints for the Authentication subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.netauth.transport_graph" })
		inst.system = S
		inst.ctx = ctx
