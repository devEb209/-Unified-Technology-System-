-- ARKHER SYSTEM I.0495 :: Cloth Animation Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0495"
	S.key = "arkher.anim.clothanim.skeleton"
	S.name = "Cloth Animation Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "clothanim", "skeleton", "anim" }
	S.description = "Cloth Animation Skeleton: bone hierarchy, bind pose and world resolution for the Cloth Animation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.clothanim.skeleton" })
		inst.system = S
		inst.ctx = ctx
