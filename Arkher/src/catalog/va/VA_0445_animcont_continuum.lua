-- ARKHER SYSTEM VA.0445 :: Animation Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0445"
	S.key = "arkher.contworld.animcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "animcont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.animcont.infinite_grid", cellSize = 224, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
