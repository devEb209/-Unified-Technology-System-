-- ARKHER SYSTEM E.0516 :: Parameter Animation Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0516"
	S.key = "arkher.material.paramanim.variant_registry"
	S.name = "Parameter Animation Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.paramanim.procedural_detail" }
	S.tags = { "e", "paramanim", "registry", "material" }
	S.description = "Parameter Animation Variant Registry: named variants and their lifecycle for the Parameter Animation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.paramanim.variant_registry" })
		inst.system = S
		inst.ctx = ctx
