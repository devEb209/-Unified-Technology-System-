-- ARKHER SYSTEM VC.0013 :: Region Tile Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0013"
	S.key = "arkher.contneural.regiontile.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "regiontile", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.regiontile.infinite_grid", cellSize = 160, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
