-- ARKHER SYSTEM VA.0075 :: LOD Cascade Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0075"
	S.key = "arkher.contworld.lodcascade.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lodcascade.epoch_clock" }
	S.tags = { "va", "lodcascade", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.lodcascade.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
