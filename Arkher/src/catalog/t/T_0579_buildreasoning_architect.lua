-- ARKHER SYSTEM T.0579 :: Build Reasoning World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0579"
	S.key = "arkher.ai.buildreasoning.world_architect"
	S.name = "Build Reasoning World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.buildreasoning.self_critique" }
	S.tags = { "t", "buildreasoning", "architect", "ai" }
	S.description = "Build Reasoning World Architect: composition of a whole world plan with conserved budgets for the Build Reasoning subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.buildreasoning.world_architect", budget = 1400, seed = 1248 })
		inst.system = S
		inst.ctx = ctx
