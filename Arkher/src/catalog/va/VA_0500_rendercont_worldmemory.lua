-- ARKHER SYSTEM VA.0500 :: Rendering Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0500"
	S.key = "arkher.contworld.rendercont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.rendercont.neural_field" }
	S.tags = { "va", "rendercont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.rendercont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
