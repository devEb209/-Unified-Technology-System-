-- ARKHER SYSTEM VB.0230 :: City Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0230"
	S.key = "arkher.conttime.citycont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.citycont.infinite_grid" }
	S.tags = { "vb", "citycont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.citycont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
