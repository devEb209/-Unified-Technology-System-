-- ARKHER SYSTEM VC.0206 :: Biome Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0206"
	S.key = "arkher.contneural.biomecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.biomecont.infinite_grid" }
	S.tags = { "vc", "biomecont", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.biomecont.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
