-- ARKHER SYSTEM E.0456 :: Procedural Texture Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0456"
	S.key = "arkher.material.proctex.variant_registry"
	S.name = "Procedural Texture Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.proctex.procedural_detail" }
	S.tags = { "e", "proctex", "registry", "material" }
	S.description = "Procedural Texture Variant Registry: named variants and their lifecycle for the Procedural Texture subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.proctex.variant_registry" })
		inst.system = S
		inst.ctx = ctx
