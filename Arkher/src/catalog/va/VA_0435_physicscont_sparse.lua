-- ARKHER SYSTEM VA.0435 :: Physics Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0435"
	S.key = "arkher.contworld.physicscont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.physicscont.epoch_clock" }
	S.tags = { "va", "physicscont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.physicscont.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
