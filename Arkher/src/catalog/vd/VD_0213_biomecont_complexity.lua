-- ARKHER SYSTEM VD.0213 :: Biome Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0213"
	S.key = "arkher.contsim.biomecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.biomecont.world_memory_stream" }
	S.tags = { "vd", "biomecont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.biomecont.complexity_budget", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
