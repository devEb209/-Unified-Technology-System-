-- ARKHER SYSTEM H.0403 :: Contact Manifold Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0403"
	S.key = "arkher.physics.manifold.result_cache"
	S.name = "Contact Manifold Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.manifold.simulation_policy" }
	S.tags = { "h", "manifold", "cache", "physics" }
	S.description = "Contact Manifold Result Cache: reuse of expensive simulation and query results for the Contact Manifold subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.manifold.result_cache", policy = "lfu", capacity = 200, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
