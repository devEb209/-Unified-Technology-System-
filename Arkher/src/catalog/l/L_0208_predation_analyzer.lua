-- ARKHER SYSTEM L.0208 :: Predation Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0208"
	S.key = "arkher.sim.predation.analysis"
	S.name = "Predation Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.predation.aggregate_cache" }
	S.tags = { "l", "predation", "analyzer", "sim" }
	S.description = "Predation Analysis: trend, anomaly and stability analysis of the world for the Predation subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.predation.analysis", window = 144, buckets = 8, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
