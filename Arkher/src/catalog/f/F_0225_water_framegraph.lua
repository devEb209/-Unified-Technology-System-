-- ARKHER SYSTEM F.0225 :: Water Rendering Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0225"
	S.key = "arkher.render.water.frame_graph"
	S.name = "Water Rendering Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "water", "framegraph", "render" }
	S.description = "Water Rendering Frame Graph: declared passes, culling, ordering and aliasing for the Water Rendering subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.water.frame_graph", budgetMs = 12.00 })
		inst.system = S
		inst.ctx = ctx
