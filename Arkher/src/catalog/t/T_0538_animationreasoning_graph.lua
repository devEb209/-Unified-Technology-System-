-- ARKHER SYSTEM T.0538 :: Animation Reasoning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0538"
	S.key = "arkher.ai.animationreasoning.reasoning_graph"
	S.name = "Animation Reasoning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.animationreasoning.world_architect" }
	S.tags = { "t", "animationreasoning", "graph", "ai" }
	S.description = "Animation Reasoning Reasoning Graph: relationship modelling and shortest-path reasoning for the Animation Reasoning subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.animationreasoning.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
