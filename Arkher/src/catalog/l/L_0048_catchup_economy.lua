-- ARKHER SYSTEM L.0048 :: Catch Up Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0048"
	S.key = "arkher.sim.catchup.economy"
	S.name = "Catch Up Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.catchup.ecology" }
	S.tags = { "l", "catchup", "economy", "sim" }
	S.description = "Catch Up Economy: stock, production, demand, price discovery and trade for the Catch Up subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.catchup.economy", elasticity = 0.17 })
		inst.system = S
		inst.ctx = ctx
