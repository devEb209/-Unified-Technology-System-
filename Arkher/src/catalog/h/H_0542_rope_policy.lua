-- ARKHER SYSTEM H.0542 :: Rope Simulation Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0542"
	S.key = "arkher.physics.rope.simulation_policy"
	S.name = "Rope Simulation Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rope.budget_governor" }
	S.tags = { "h", "rope", "policy", "physics" }
	S.description = "Rope Simulation Simulation Policy: device tier rules for substeps, iterations and sleep for the Rope Simulation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.rope.simulation_policy", algorithm = "roundrobin", starvationGuard = 40 })
		inst.system = S
		inst.ctx = ctx
