-- ARKHER SYSTEM K.0229 :: Personality Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0229"
	S.key = "arkher.npc.personality.perception"
	S.name = "Personality Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.personality.emotion" }
	S.tags = { "k", "personality", "perception", "npc" }
	S.description = "Personality Perception: sight, hearing and bounded attention for the Personality subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.personality.perception", sightRange = 30, hearingRange = 16, attentionSlots = 4, fov = 1.690 })
		inst.system = S
		inst.ctx = ctx
