...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="RE ImGui — ANIMATION Stack #0055", size=Vector2.new(640, 420), pos=UDim2.fromOffset(415, 235), parent=parent, icon="⬣"})
