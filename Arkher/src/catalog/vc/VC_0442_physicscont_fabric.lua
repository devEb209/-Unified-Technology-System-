-- ARKHER SYSTEM VC.0442 :: Physics Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0442"
	S.key = "arkher.contneural.physicscont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.physicscont.complexity_budget" }
	S.tags = { "vc", "physicscont", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.physicscont.simulation_fabric", budgetMs = 2.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
