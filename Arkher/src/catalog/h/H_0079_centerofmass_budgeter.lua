-- ARKHER SYSTEM H.0079 :: Center Of Mass Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0079"
	S.key = "arkher.physics.centerofmass.budget_governor"
	S.name = "Center Of Mass Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.centerofmass.broadphase_index" }
	S.tags = { "h", "centerofmass", "budgeter", "physics" }
	S.description = "Center Of Mass Budget Governor: simulation time budget allocation across islands for the Center Of Mass subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.centerofmass.budget_governor", total = 427, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
