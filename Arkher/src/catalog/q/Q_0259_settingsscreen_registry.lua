-- ARKHER SYSTEM Q.0259 :: Settings Screen Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0259"
	S.key = "arkher.ui.settingsscreen.localization_registry"
	S.name = "Settings Screen Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.settingsscreen.theme_composition" }
	S.tags = { "q", "settingsscreen", "registry", "ui" }
	S.description = "Settings Screen Localization Registry: catalogue of strings, plurals and locale metadata for the Settings Screen subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.settingsscreen.localization_registry" })
		inst.system = S
		inst.ctx = ctx
