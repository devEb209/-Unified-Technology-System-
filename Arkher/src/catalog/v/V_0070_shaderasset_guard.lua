-- ARKHER SYSTEM V.0070 :: Shader Asset Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0070"
	S.key = "arkher.asset.shaderasset.validation_guard"
	S.name = "Shader Asset Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.shaderasset.size_budget" }
	S.tags = { "v", "shaderasset", "guard", "asset" }
	S.description = "Shader Asset Validation Guard: rate limiting and capability checks on the import path for the Shader Asset subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.shaderasset.validation_guard", algorithm = "sliding", capacity = 178, refillPerSec = 63, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
