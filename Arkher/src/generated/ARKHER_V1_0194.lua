--!strict
-- Neural DLSS — CORE Profiler #0194
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Neural DLSS — CORE Profiler #0194", size=Vector2.new(680, 500), pos=UDim2.fromOffset(222, 258), parent=parent, icon="↻"})
