-- ARKHER SYSTEM H.0080 :: Center Of Mass Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0080"
	S.key = "arkher.physics.centerofmass.simulation_policy"
	S.name = "Center Of Mass Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.centerofmass.budget_governor" }
	S.tags = { "h", "centerofmass", "policy", "physics" }
	S.description = "Center Of Mass Simulation Policy: device tier rules for substeps, iterations and sleep for the Center Of Mass subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.centerofmass.simulation_policy", algorithm = "roundrobin", starvationGuard = 36 })
		inst.system = S
		inst.ctx = ctx
