-- ARKHER SYSTEM Z.0707 :: Continuous Self Optimization World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0707"
	S.key = "arkher.origin.continuousopt.world_architect"
	S.name = "Continuous Self Optimization World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.emergence_detection" }
	S.tags = { "z", "continuousopt", "architect", "origin" }
	S.description = "Continuous Self Optimization World Architect: hierarchical world composition with conserved budgets for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.continuousopt.world_architect", budget = 600, seed = 10060 })
		inst.system = S
		inst.ctx = ctx
