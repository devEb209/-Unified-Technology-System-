-- ARKHER SYSTEM H.0298 :: Capsule Collider Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0298"
	S.key = "arkher.physics.capsulecollider.constraint_solver"
	S.name = "Capsule Collider Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.capsulecollider.contact_generation" }
	S.tags = { "h", "capsulecollider", "constraint", "physics" }
	S.description = "Capsule Collider Constraint Solver: sequential impulses, friction, joints and warm starting for the Capsule Collider subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.capsulecollider.constraint_solver", iterations = 11, baumgarte = 0.27, warmStart = true })
		inst.system = S
		inst.ctx = ctx
