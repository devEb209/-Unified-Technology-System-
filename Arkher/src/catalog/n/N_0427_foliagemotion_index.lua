-- ARKHER SYSTEM N.0427 :: Foliage Motion Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0427"
	S.key = "arkher.vfx.foliagemotion.spatial_index"
	S.name = "Foliage Motion Spatial Index"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.foliagemotion.quality_policy" }
	S.tags = { "n", "foliagemotion", "index", "vfx" }
	S.description = "Foliage Motion Spatial Index: spatial acceleration of effect queries and culling for the Foliage Motion subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.foliagemotion.spatial_index", mode = "hash", cellSize = 32 })
		inst.system = S
		inst.ctx = ctx
