-- ARKHER SYSTEM VC.0065 :: Sparse Page Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0065"
	S.key = "arkher.contneural.sparsepage.persistent_state"
	S.name = "Sparse Page Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.sparsepage.multi-scale_fidelity" }
	S.tags = { "vc", "sparsepage", "persistent", "contneural" }
	S.description = "Sparse Page Persistent State: epoch-stamped persistent history and rollback for the Sparse Page subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.sparsepage.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
