-- ARKHER SYSTEM V.0415 :: Asset Search Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0415"
	S.key = "arkher.asset.assetsearch.streaming_residency"
	S.name = "Asset Search Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetsearch.content_cache" }
	S.tags = { "v", "assetsearch", "streamer", "asset" }
	S.description = "Asset Search Streaming Residency: distance-driven load and unload of asset payloads for the Asset Search subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.assetsearch.streaming_residency", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
