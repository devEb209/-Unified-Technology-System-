-- ARKHER SYSTEM N.0031 :: Fire Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0031"
	S.key = "arkher.vfx.fire.curve_authoring"
	S.name = "Fire Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fire"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fire.ribbon_and_trail" }
	S.tags = { "n", "fire", "spline", "vfx" }
	S.description = "Fire Curve Authoring: authored curves driving the effect over its life for the Fire subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.fire.curve_authoring", tension = 0.69, closed = false })
		inst.system = S
		inst.ctx = ctx
