-- ARKHER SYSTEM Z.0784 :: Attention Driven Detail Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0784"
	S.key = "arkher.origin.attentiondetail.autonomous_pipeline"
	S.name = "Attention Driven Detail Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.simulation_fabric" }
	S.tags = { "z", "attentiondetail", "autopipeline", "origin" }
	S.description = "Attention Driven Detail Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.attentiondetail.autonomous_pipeline", maxIterations = 8 })
		inst.system = S
		inst.ctx = ctx
