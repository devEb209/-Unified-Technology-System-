-- ARKHER SYSTEM R.0188 :: Extrapolation Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0188"
	S.key = "arkher.net.extrapolation.rate_guard"
	S.name = "Extrapolation Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.extrapolation.interest_streaming" }
	S.tags = { "r", "extrapolation", "guard", "net" }
	S.description = "Extrapolation Rate Guard: token-bucket protection against floods and abuse for the Extrapolation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.extrapolation.rate_guard", algorithm = "token", capacity = 192, refillPerSec = 17, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
