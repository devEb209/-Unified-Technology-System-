-- ARKHER SYSTEM V.0173 :: Prefab Asset Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0173"
	S.key = "arkher.asset.prefabasset.dependency_graph"
	S.name = "Prefab Asset Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.prefabasset.asset_registry" }
	S.tags = { "v", "prefabasset", "graph", "asset" }
	S.description = "Prefab Asset Dependency Graph: what references what, and in which order it must be built for the Prefab Asset subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.prefabasset.dependency_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
