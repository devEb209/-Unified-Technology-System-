-- ARKHER SYSTEM T.0183 :: Terrain Generation Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0183"
	S.key = "arkher.ai.terraingeneration.intent_understanding"
	S.name = "Terrain Generation Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "terraingeneration", "intent", "ai" }
	S.description = "Terrain Generation Intent Understanding: natural language turned into an actionable, scored intent for the Terrain Generation subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.terraingeneration.intent_understanding", minConfidence = 0.44 })
		inst.system = S
		inst.ctx = ctx
