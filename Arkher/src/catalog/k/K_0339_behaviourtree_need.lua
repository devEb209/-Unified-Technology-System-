-- ARKHER SYSTEM K.0339 :: Behaviour Tree Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0339"
	S.key = "arkher.npc.behaviourtree.drive_system"
	S.name = "Behaviour Tree Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourtree.memory" }
	S.tags = { "k", "behaviourtree", "need", "npc" }
	S.description = "Behaviour Tree Drive System: drives that decay, turn urgent and get satisfied for the Behaviour Tree subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.behaviourtree.drive_system" })
		inst.system = S
		inst.ctx = ctx
