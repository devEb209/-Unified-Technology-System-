...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="USGS DEM — ANIMATION Stack #0005", size=Vector2.new(680, 420), pos=UDim2.fromOffset(165, 165), parent=parent, icon="✎"})
