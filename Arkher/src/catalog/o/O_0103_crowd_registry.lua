-- ARKHER SYSTEM O.0103 :: Crowd Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0103"
	S.key = "arkher.audio.crowd.asset_registry"
	S.name = "Crowd Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Crowd"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.crowd.streaming" }
	S.tags = { "o", "crowd", "registry", "audio" }
	S.description = "Crowd Asset Registry: catalogue of sounds, variations and metadata for the Crowd subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.crowd.asset_registry" })
		inst.system = S
		inst.ctx = ctx
