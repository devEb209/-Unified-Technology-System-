-- ARKHER SYSTEM P.0400 :: Match Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0400"
	S.key = "arkher.play.match.combat_resolution"
	S.name = "Match Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Match"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.match.objectives" }
	S.tags = { "p", "match", "combat", "play" }
	S.description = "Match Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Match subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.match.combat_resolution", seed = 81498, armourK = 100, critMultiplier = 2.10 })
		inst.system = S
		inst.ctx = ctx
