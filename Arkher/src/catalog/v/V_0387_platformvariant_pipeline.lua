-- ARKHER SYSTEM V.0387 :: Platform Variant Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0387"
	S.key = "arkher.asset.platformvariant.cook_pipeline"
	S.name = "Platform Variant Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.platformvariant.bundling" }
	S.tags = { "v", "platformvariant", "pipeline", "asset" }
	S.description = "Platform Variant Cook Pipeline: staged cooking with isolation and retries for the Platform Variant subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.platformvariant.cook_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
