-- ARKHER SYSTEM VB.0211 :: Biome Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0211"
	S.key = "arkher.conttime.biomecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.biomecont.coherence_guard" }
	S.tags = { "vb", "biomecont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.biomecont.neural_field", dims = 16, hidden = 12, seed = 67205 })
		inst.system = S
		inst.ctx = ctx
