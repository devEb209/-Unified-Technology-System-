-- ARKHER SYSTEM L.0147 :: City Life Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0147"
	S.key = "arkher.sim.citylife.aggregate_cache"
	S.name = "City Life Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.citylife.fidelity_policy" }
	S.tags = { "l", "citylife", "cache", "sim" }
	S.description = "City Life Aggregate Cache: reuse of expensive aggregate computations for the City Life subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.citylife.aggregate_cache", policy = "ttl", capacity = 281, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
