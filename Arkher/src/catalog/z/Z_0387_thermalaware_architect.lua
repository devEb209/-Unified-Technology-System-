-- ARKHER SYSTEM Z.0387 :: Thermal Aware Simulation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0387"
	S.key = "arkher.origin.thermalaware.world_architect"
	S.name = "Thermal Aware Simulation World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.emergence_detection" }
	S.tags = { "z", "thermalaware", "architect", "origin" }
	S.description = "Thermal Aware Simulation World Architect: hierarchical world composition with conserved budgets for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.thermalaware.world_architect", budget = 1100, seed = 34065 })
		inst.system = S
		inst.ctx = ctx
