-- ARKHER SYSTEM VC.0346 :: Society Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0346"
	S.key = "arkher.contneural.societycont.simulation_fabric"
	S.name = "Society Continuum Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.societycont.complexity_budget" }
	S.tags = { "vc", "societycont", "fabric", "contneural" }
	S.description = "Society Continuum Simulation Fabric: fabric stepping the continuum domains for the Society Continuum subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.societycont.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
