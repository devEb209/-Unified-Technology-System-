-- ARKHER SYSTEM R.0212 :: Server Reconciliation Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0212"
	S.key = "arkher.net.serverreconciliation.rate_guard"
	S.name = "Server Reconciliation Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverreconciliation.interest_streaming" }
	S.tags = { "r", "serverreconciliation", "guard", "net" }
	S.description = "Server Reconciliation Rate Guard: token-bucket protection against floods and abuse for the Server Reconciliation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.serverreconciliation.rate_guard", algorithm = "sliding", capacity = 139, refillPerSec = 24, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
