-- ARKHER SYSTEM W.0303 :: Lens Flare Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0303"
	S.key = "arkher.cine.lensflare.colour_grade"
	S.name = "Lens Flare Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Lens Flare"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.lensflare.camera_rig" }
	S.tags = { "w", "lensflare", "grade", "cine" }
	S.description = "Lens Flare Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Lens Flare subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.lensflare.colour_grade", exposure = -0.15, contrast = 0.90, saturation = 0.95, toneMap = "filmic" })
		inst.system = S
		inst.ctx = ctx
