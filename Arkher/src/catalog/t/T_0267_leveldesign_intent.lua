-- ARKHER SYSTEM T.0267 :: Level Design Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0267"
	S.key = "arkher.ai.leveldesign.intent_understanding"
	S.name = "Level Design Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "leveldesign", "intent", "ai" }
	S.description = "Level Design Intent Understanding: natural language turned into an actionable, scored intent for the Level Design subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.leveldesign.intent_understanding", minConfidence = 0.44 })
		inst.system = S
		inst.ctx = ctx
