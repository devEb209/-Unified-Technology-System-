-- ARKHER SYSTEM VB.0407 :: Perception Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0407"
	S.key = "arkher.conttime.perceptioncont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.perceptioncont.simulation_fabric" }
	S.tags = { "vb", "perceptioncont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.perceptioncont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
