-- ARKHER SYSTEM I.0183 :: Blend Tree Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0183"
	S.key = "arkher.anim.blendtree.skeleton"
	S.name = "Blend Tree Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Blend Tree"
	S.aspect = "Skeleton"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "blendtree", "skeleton", "anim" }
	S.description = "Blend Tree Skeleton: bone hierarchy, bind pose and world resolution for the Blend Tree subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.blendtree.skeleton" })
		inst.system = S
		inst.ctx = ctx
