-- ARKHER SYSTEM VD.0036 :: Zone Chunk Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0036"
	S.key = "arkher.contsim.zonechunk.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.zonechunk.reality_continuum" }
	S.tags = { "vd", "zonechunk", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.zonechunk.emergence_continuum", windowSize = 6, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
