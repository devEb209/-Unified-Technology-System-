-- ARKHER SYSTEM L.0126 :: Village Life Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0126"
	S.key = "arkher.sim.villagelife.region_graph"
	S.name = "Village Life Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.villagelife.calendar" }
	S.tags = { "l", "villagelife", "graph", "sim" }
	S.description = "Village Life Region Graph: connectivity, components and shortest path between places for the Village Life subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.villagelife.region_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
