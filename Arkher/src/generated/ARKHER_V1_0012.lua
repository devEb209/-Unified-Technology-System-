...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Sketchfab — CORE Mixer #0012", size=Vector2.new(600, 460), pos=UDim2.fromOffset(256, 284), parent=parent, icon="▣"})
