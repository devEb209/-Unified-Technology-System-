-- ARKHER SYSTEM N.0280 :: Heal Effect Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0280"
	S.key = "arkher.vfx.healfx.effect_composition"
	S.name = "Heal Effect Effect Composition"
	S.category = "N"
	S.family = "VFX"
	S.area = "Heal Effect"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.healfx.effect_graph" }
	S.tags = { "n", "healfx", "composer", "vfx" }
	S.description = "Heal Effect Effect Composition: blending of several effect signals into one output for the Heal Effect subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.healfx.effect_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
