-- ARKHER SYSTEM H.0177 :: Sleeping Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0177"
	S.key = "arkher.physics.sleeping.budget_governor"
	S.name = "Sleeping Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Sleeping"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sleeping.broadphase_index" }
	S.tags = { "h", "sleeping", "budgeter", "physics" }
	S.description = "Sleeping Budget Governor: simulation time budget allocation across islands for the Sleeping subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.sleeping.budget_governor", total = 434, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
