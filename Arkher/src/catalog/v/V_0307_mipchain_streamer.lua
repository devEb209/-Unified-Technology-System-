-- ARKHER SYSTEM V.0307 :: Mip Chain Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0307"
	S.key = "arkher.asset.mipchain.streaming_residency"
	S.name = "Mip Chain Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.mipchain.content_cache" }
	S.tags = { "v", "mipchain", "streamer", "asset" }
	S.description = "Mip Chain Streaming Residency: distance-driven load and unload of asset payloads for the Mip Chain subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.mipchain.streaming_residency", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
