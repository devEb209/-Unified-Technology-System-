-- ARKHER SYSTEM K.0681 :: NPC LOD Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0681"
	S.key = "arkher.npc.npclod.navigation"
	S.name = "NPC LOD Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npclod.goal_planner" }
	S.tags = { "k", "npclod", "navgraph", "npc" }
	S.description = "NPC LOD Navigation: grid pathfinding, smoothing, line of sight and flow fields for the NPC LOD subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.npclod.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
