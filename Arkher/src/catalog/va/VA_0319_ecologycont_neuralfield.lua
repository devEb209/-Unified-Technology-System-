-- ARKHER SYSTEM VA.0319 :: Ecology Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0319"
	S.key = "arkher.contworld.ecologycont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.ecologycont.coherence_guard" }
	S.tags = { "va", "ecologycont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.ecologycont.neural_field", dims = 20, hidden = 16, seed = 20354 })
		inst.system = S
		inst.ctx = ctx
