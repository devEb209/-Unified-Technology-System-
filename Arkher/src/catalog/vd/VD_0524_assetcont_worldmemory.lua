-- ARKHER SYSTEM VD.0524 :: Asset Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0524"
	S.key = "arkher.contsim.assetcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.assetcont.neural_field" }
	S.tags = { "vd", "assetcont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.assetcont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
