-- ARKHER SYSTEM T.0190 :: Terrain Generation Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0190"
	S.key = "arkher.ai.terraingeneration.outcome_prediction"
	S.name = "Terrain Generation Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.terraingeneration.decision_policy" }
	S.tags = { "t", "terraingeneration", "predictor", "ai" }
	S.description = "Terrain Generation Outcome Prediction: forecasting the result before the work is done for the Terrain Generation subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.terraingeneration.outcome_prediction", method = "linear", alpha = 0.28, window = 114 })
		inst.system = S
		inst.ctx = ctx
