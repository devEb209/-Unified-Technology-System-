-- ARKHER SYSTEM VC.0320 :: Ecology Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0320"
	S.key = "arkher.contneural.ecologycont.world_memory_stream"
	S.name = "Ecology Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.ecologycont.neural_field" }
	S.tags = { "vc", "ecologycont", "worldmemory", "contneural" }
	S.description = "Ecology Continuum World Memory Stream: world memory continuum over epochs for the Ecology Continuum subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.ecologycont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
