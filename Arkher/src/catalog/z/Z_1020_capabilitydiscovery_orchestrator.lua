-- ARKHER SYSTEM Z.1020 :: Capability Discovery Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.1020"
	S.key = "arkher.origin.capabilitydiscovery.orchestration"
	S.name = "Capability Discovery Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.residency_streaming" }
	S.tags = { "z", "capabilitydiscovery", "orchestrator", "origin" }
	S.description = "Capability Discovery Orchestration: lifecycle and phase orchestration of the technology for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.capabilitydiscovery.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
