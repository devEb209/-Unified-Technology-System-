-- ARKHER SYSTEM K.0477 :: Follow Behaviour Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0477"
	S.key = "arkher.npc.followbehaviour.mind_network"
	S.name = "Follow Behaviour Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "followbehaviour", "mindnet", "npc" }
	S.description = "Follow Behaviour Mind Network: the learned policy that turns perception into a decision for the Follow Behaviour subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.followbehaviour.mind_network", inputs = 6, hidden = 8, seed = 45644, learningRate = 0.070, exploration = 0.040 })
		inst.system = S
		inst.ctx = ctx
