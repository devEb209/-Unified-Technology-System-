--!strict
-- Puter Singularity — ANIMATION Node_Flow #0321
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Puter Singularity — ANIMATION Node_Flow #0321", size=Vector2.new(600, 440), pos=UDim2.fromOffset(273, 337), parent=parent, icon="▭"})
