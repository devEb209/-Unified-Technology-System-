-- ARKHER SYSTEM F.0486 :: Impostor Rendering Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0486"
	S.key = "arkher.render.impostorrender.render_policy"
	S.name = "Impostor Rendering Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.impostorrender.draw_budget" }
	S.tags = { "f", "impostorrender", "policy", "render" }
	S.description = "Impostor Rendering Render Policy: device tier rules for the frame for the Impostor Rendering subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.impostorrender.render_policy", algorithm = "edf", starvationGuard = 53 })
		inst.system = S
		inst.ctx = ctx
