-- ARKHER SYSTEM O.0185 :: Interior Audio Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0185"
	S.key = "arkher.audio.interioraudio.voice_budget"
	S.name = "Interior Audio Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.interioraudio.music_sequencer" }
	S.tags = { "o", "interioraudio", "budgeter", "audio" }
	S.description = "Interior Audio Voice Budget: voice slots allocated by priority and audibility for the Interior Audio subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.interioraudio.voice_budget", total = 370, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
