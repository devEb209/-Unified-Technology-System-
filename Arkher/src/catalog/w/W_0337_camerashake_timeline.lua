-- ARKHER SYSTEM W.0337 :: Camera Shake Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0337"
	S.key = "arkher.cine.camerashake.sequence_timeline"
	S.name = "Camera Shake Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Camera Shake"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "camerashake", "timeline", "cine" }
	S.description = "Camera Shake Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.camerashake.sequence_timeline", duration = 6.0, rate = 0.82 })
		inst.system = S
		inst.ctx = ctx
