-- ARKHER SYSTEM VA.0527 :: Asset Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0527"
	S.key = "arkher.contworld.assetcont.reality_continuum"
	S.name = "Asset Continuum Reality Continuum"
	S.category = "VA"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.assetcont.simulation_fabric" }
	S.tags = { "va", "assetcont", "reality", "contworld" }
	S.description = "Asset Continuum Reality Continuum: stacked reality layers of the continuum for the Asset Continuum subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.assetcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
