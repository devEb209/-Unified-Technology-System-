-- ARKHER SYSTEM VD.0173 :: Neural Patch Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0173"
	S.key = "arkher.contsim.neuralpatch.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.neuralpatch.multi-scale_fidelity" }
	S.tags = { "vd", "neuralpatch", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.neuralpatch.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
