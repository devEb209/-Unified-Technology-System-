-- ARKHER SYSTEM VB.0623 :: Occupancy Map Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0623"
	S.key = "arkher.conttime.occupancymap.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.occupancymap.simulation_fabric" }
	S.tags = { "vb", "occupancymap", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.occupancymap.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
