-- ARKHER SYSTEM H.0541 :: Rope Simulation Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0541"
	S.key = "arkher.physics.rope.budget_governor"
	S.name = "Rope Simulation Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rope.broadphase_index" }
	S.tags = { "h", "rope", "budgeter", "physics" }
	S.description = "Rope Simulation Budget Governor: simulation time budget allocation across islands for the Rope Simulation subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.rope.budget_governor", total = 435, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
