-- ARKHER SYSTEM VD.0230 :: City Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0230"
	S.key = "arkher.contsim.citycont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.citycont.infinite_grid" }
	S.tags = { "vd", "citycont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.citycont.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
