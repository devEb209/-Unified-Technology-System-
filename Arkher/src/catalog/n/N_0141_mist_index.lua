-- ARKHER SYSTEM N.0141 :: Waterfall Mist Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0141"
	S.key = "arkher.vfx.mist.spatial_index"
	S.name = "Waterfall Mist Spatial Index"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.mist.quality_policy" }
	S.tags = { "n", "mist", "index", "vfx" }
	S.description = "Waterfall Mist Spatial Index: spatial acceleration of effect queries and culling for the Waterfall Mist subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.mist.spatial_index", mode = "hash", cellSize = 80 })
		inst.system = S
		inst.ctx = ctx
