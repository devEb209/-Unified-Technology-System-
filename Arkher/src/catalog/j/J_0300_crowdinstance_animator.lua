-- ARKHER SYSTEM J.0300 :: Crowd Instance Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0300"
	S.key = "arkher.character.crowdinstance.blend_controller"
	S.name = "Crowd Instance Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.crowdinstance.motion_set" }
	S.tags = { "j", "crowdinstance", "animator", "character" }
	S.description = "Crowd Instance Blend Controller: layered playback driving the character for the Crowd Instance subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.crowdinstance.blend_controller", budget = 13 })
		inst.system = S
		inst.ctx = ctx
