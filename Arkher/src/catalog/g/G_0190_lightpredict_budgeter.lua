-- ARKHER SYSTEM G.0190 :: Light Transport Prediction Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0190"
	S.key = "arkher.neural.lightpredict.compute_budget"
	S.name = "Light Transport Prediction Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.lightpredict.quality_predictor" }
	S.tags = { "g", "lightpredict", "budgeter", "neural" }
	S.description = "Light Transport Prediction Compute Budget: inference time budget allocation for the Light Transport Prediction subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.lightpredict.compute_budget", total = 250, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
