-- ARKHER SYSTEM F.0055 :: Transparent Pass Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0055"
	S.key = "arkher.render.transparentpass.orchestration"
	S.name = "Transparent Pass Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.transparentpass.frame_analysis" }
	S.tags = { "f", "transparentpass", "orchestrator", "render" }
	S.description = "Transparent Pass Orchestration: frame lifecycle orchestration for the Transparent Pass subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.transparentpass.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
