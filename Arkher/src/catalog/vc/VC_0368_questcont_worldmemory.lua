-- ARKHER SYSTEM VC.0368 :: Quest Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0368"
	S.key = "arkher.contneural.questcont.world_memory_stream"
	S.name = "Quest Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.questcont.neural_field" }
	S.tags = { "vc", "questcont", "worldmemory", "contneural" }
	S.description = "Quest Continuum World Memory Stream: world memory continuum over epochs for the Quest Continuum subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.questcont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
