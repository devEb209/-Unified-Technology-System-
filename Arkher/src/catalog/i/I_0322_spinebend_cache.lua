-- ARKHER SYSTEM I.0322 :: Spine Bend Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0322"
	S.key = "arkher.anim.spinebend.pose_cache"
	S.name = "Spine Bend Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Spine Bend"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.spinebend.playback_pipeline" }
	S.tags = { "i", "spinebend", "cache", "anim" }
	S.description = "Spine Bend Pose Cache: reuse of sampled poses across frames and instances for the Spine Bend subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.spinebend.pose_cache", policy = "ttl", capacity = 80, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
