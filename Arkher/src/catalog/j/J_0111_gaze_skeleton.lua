-- ARKHER SYSTEM J.0111 :: Gaze Behaviour Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0111"
	S.key = "arkher.character.gaze.rig_definition"
	S.name = "Gaze Behaviour Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "gaze", "skeleton", "character" }
	S.description = "Gaze Behaviour Rig Definition: character rig definition and bone budget for the Gaze Behaviour subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.gaze.rig_definition" })
		inst.system = S
		inst.ctx = ctx
