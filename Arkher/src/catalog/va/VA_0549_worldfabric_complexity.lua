-- ARKHER SYSTEM VA.0549 :: World Fabric Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0549"
	S.key = "arkher.contworld.worldfabric.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldfabric.world_memory_stream" }
	S.tags = { "va", "worldfabric", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.worldfabric.complexity_budget", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
