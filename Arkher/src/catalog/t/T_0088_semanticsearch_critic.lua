-- ARKHER SYSTEM T.0088 :: Semantic Search Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0088"
	S.key = "arkher.ai.semanticsearch.self_critique"
	S.name = "Semantic Search Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.semanticsearch.plan_workflow" }
	S.tags = { "t", "semanticsearch", "critic", "ai" }
	S.description = "Semantic Search Self Critique: weighted evaluation of the result against declared criteria for the Semantic Search subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.semanticsearch.self_critique", passMark = 0.81, reviseMark = 0.46, seed = 83156 })
		inst.system = S
		inst.ctx = ctx
