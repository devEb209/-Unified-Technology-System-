-- ARKHER SYSTEM Z.0007 :: Adaptive World Intelligence World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0007"
	S.key = "arkher.origin.adaptiveworld.world_architect"
	S.name = "Adaptive World Intelligence World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.adaptiveworld.emergence_detection" }
	S.tags = { "z", "adaptiveworld", "architect", "origin" }
	S.description = "Adaptive World Intelligence World Architect: hierarchical world composition with conserved budgets for the Adaptive World Intelligence subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.adaptiveworld.world_architect", budget = 600, seed = 63010 })
		inst.system = S
		inst.ctx = ctx
