-- ARKHER SYSTEM J.0025 :: Body Proportions Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0025"
	S.key = "arkher.character.proportions.blend_controller"
	S.name = "Body Proportions Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.proportions.motion_set" }
	S.tags = { "j", "proportions", "animator", "character" }
	S.description = "Body Proportions Blend Controller: layered playback driving the character for the Body Proportions subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.proportions.blend_controller", budget = 6 })
		inst.system = S
		inst.ctx = ctx
