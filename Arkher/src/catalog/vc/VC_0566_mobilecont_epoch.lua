-- ARKHER SYSTEM VC.0566 :: Mobile Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0566"
	S.key = "arkher.contneural.mobilecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.mobilecont.infinite_grid" }
	S.tags = { "vc", "mobilecont", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.mobilecont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
