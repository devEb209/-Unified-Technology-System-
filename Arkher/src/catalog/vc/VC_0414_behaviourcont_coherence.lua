-- ARKHER SYSTEM VC.0414 :: Behaviour Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0414"
	S.key = "arkher.contneural.behaviourcont.coherence_guard"
	S.name = "Behaviour Continuum Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.behaviourcont.persistent_state" }
	S.tags = { "vc", "behaviourcont", "coherence", "contneural" }
	S.description = "Behaviour Continuum Coherence Guard: seam coherence and drift supervision for the Behaviour Continuum subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.behaviourcont.coherence_guard", window = 133, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
