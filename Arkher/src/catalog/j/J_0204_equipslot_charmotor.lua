-- ARKHER SYSTEM J.0204 :: Equipment Slot Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0204"
	S.key = "arkher.character.equipslot.locomotion"
	S.name = "Equipment Slot Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.equipslot.physical_response" }
	S.tags = { "j", "equipslot", "charmotor", "character" }
	S.description = "Equipment Slot Locomotion: capsule locomotion driving the character for the Equipment Slot subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.equipslot.locomotion", radius = 0.44, height = 1.69, maxSpeed = 8.90, jumpHeight = 1.30, stepOffset = 0.44 })
		inst.system = S
		inst.ctx = ctx
