-- ARKHER SYSTEM P.0025 :: Skill Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0025"
	S.key = "arkher.play.skill.attributes"
	S.name = "Skill Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Skill"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "skill", "stats", "play" }
	S.description = "Skill Attributes: base values, layered modifiers and derived statistics for the Skill subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.skill.attributes" })
		inst.system = S
		inst.ctx = ctx
