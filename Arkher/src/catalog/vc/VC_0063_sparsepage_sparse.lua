-- ARKHER SYSTEM VC.0063 :: Sparse Page Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0063"
	S.key = "arkher.contneural.sparsepage.sparse_residency"
	S.name = "Sparse Page Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.sparsepage.epoch_clock" }
	S.tags = { "vc", "sparsepage", "sparse", "contneural" }
	S.description = "Sparse Page Sparse Residency: sparse page residency with eviction and compression for the Sparse Page subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.sparsepage.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
