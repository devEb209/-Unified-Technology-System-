-- ARKHER SYSTEM VB.0495 :: Rendering Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0495"
	S.key = "arkher.conttime.rendercont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.rendercont.epoch_clock" }
	S.tags = { "vb", "rendercont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.rendercont.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
