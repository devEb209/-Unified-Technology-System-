-- ARKHER SYSTEM VC.0585 :: Thermal Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0585"
	S.key = "arkher.contneural.thermalcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.thermalcont.world_memory_stream" }
	S.tags = { "vc", "thermalcont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.thermalcont.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
