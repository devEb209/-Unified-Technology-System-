-- ARKHER SYSTEM O.0280 :: Transition Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0280"
	S.key = "arkher.audio.audiotransition.music_sequencer"
	S.name = "Transition Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Transition"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiotransition.spatialization" }
	S.tags = { "o", "audiotransition", "sequencer", "audio" }
	S.description = "Transition Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Transition subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.audiotransition.music_sequencer", bpm = 120, beatsPerBar = 4, intensity = 0.65 })
		inst.system = S
		inst.ctx = ctx
