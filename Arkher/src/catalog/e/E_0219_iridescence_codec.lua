-- ARKHER SYSTEM E.0219 :: Iridescence Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0219"
	S.key = "arkher.material.iridescence.compression_codec"
	S.name = "Iridescence Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Iridescence"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.iridescence.streaming" }
	S.tags = { "e", "iridescence", "codec", "material" }
	S.description = "Iridescence Compression Codec: serialization and compression of material data for the Iridescence subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.iridescence.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
