-- ARKHER SYSTEM T.0342 :: Test Authoring Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0342"
	S.key = "arkher.ai.testauthoring.reasoning_graph"
	S.name = "Test Authoring Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.testauthoring.world_architect" }
	S.tags = { "t", "testauthoring", "graph", "ai" }
	S.description = "Test Authoring Reasoning Graph: relationship modelling and shortest-path reasoning for the Test Authoring subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.testauthoring.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
