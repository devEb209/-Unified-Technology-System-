-- ARKHER SYSTEM H.0479 :: Ball Joint Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0479"
	S.key = "arkher.physics.balljoint.contact_generation"
	S.name = "Ball Joint Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Ball Joint"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.balljoint.collision_shape" }
	S.tags = { "h", "balljoint", "contact", "physics" }
	S.description = "Ball Joint Contact Generation: narrow-phase manifolds with normal, depth and point for the Ball Joint subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.balljoint.contact_generation", slop = 0.0070, maxManifolds = 138 })
		inst.system = S
		inst.ctx = ctx
