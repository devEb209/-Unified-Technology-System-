-- ARKHER SYSTEM VA.0122 :: Spatial Slice Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0122"
	S.key = "arkher.contworld.spatialslice.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.spatialslice.infinite_grid" }
	S.tags = { "va", "spatialslice", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.spatialslice.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
