-- ARKHER SYSTEM O.0379 :: Mix Snapshot Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0379"
	S.key = "arkher.audio.mixsnapshot.asset_registry"
	S.name = "Mix Snapshot Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mix Snapshot"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mixsnapshot.streaming" }
	S.tags = { "o", "mixsnapshot", "registry", "audio" }
	S.description = "Mix Snapshot Asset Registry: catalogue of sounds, variations and metadata for the Mix Snapshot subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.mixsnapshot.asset_registry" })
		inst.system = S
		inst.ctx = ctx
