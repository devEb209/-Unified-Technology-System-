-- ARKHER SYSTEM O.0026 :: Weapon Sound Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0026"
	S.key = "arkher.audio.weaponsound.mixer_bus"
	S.name = "Weapon Sound Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Weapon Sound"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.weaponsound.dsp_chain" }
	S.tags = { "o", "weaponsound", "mixer", "audio" }
	S.description = "Weapon Sound Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Weapon Sound subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.weaponsound.mixer_bus", maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
