-- ARKHER SYSTEM K.0025 :: Neural Policy Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0025"
	S.key = "arkher.npc.neuralpolicy.social_relations"
	S.name = "Neural Policy Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.neuralpolicy.crowd_steering" }
	S.tags = { "k", "neuralpolicy", "society", "npc" }
	S.description = "Neural Policy Social Relations: affinity, factions, reputation and gossip for the Neural Policy subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.neuralpolicy.social_relations", decayRate = 0.005, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
