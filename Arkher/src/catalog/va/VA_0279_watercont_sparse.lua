-- ARKHER SYSTEM VA.0279 :: Water Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0279"
	S.key = "arkher.contworld.watercont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.watercont.epoch_clock" }
	S.tags = { "va", "watercont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.watercont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
