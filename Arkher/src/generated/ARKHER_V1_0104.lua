--!strict
-- SpeedTree Atlas — CORE Profiler #0104
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="SpeedTree Atlas — CORE Profiler #0104", size=Vector2.new(680, 500), pos=UDim2.fromOffset(252, 288), parent=parent, icon="✎"})
