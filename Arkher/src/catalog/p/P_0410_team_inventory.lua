-- ARKHER SYSTEM P.0410 :: Team Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0410"
	S.key = "arkher.play.team.inventory"
	S.name = "Team Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Team"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.team.attributes" }
	S.tags = { "p", "team", "inventory", "play" }
	S.description = "Team Inventory: slots, stacking, weight, equipment and crafting for the Team subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.team.inventory", slots = 40, maxWeight = 150 })
		inst.system = S
		inst.ctx = ctx
