-- ARKHER SYSTEM H.0452 :: Distance Joint Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0452"
	S.key = "arkher.physics.distancejoint.constraint_solver"
	S.name = "Distance Joint Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.distancejoint.contact_generation" }
	S.tags = { "h", "distancejoint", "constraint", "physics" }
	S.description = "Distance Joint Constraint Solver: sequential impulses, friction, joints and warm starting for the Distance Joint subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.distancejoint.constraint_solver", iterations = 8, baumgarte = 0.14, warmStart = true })
		inst.system = S
		inst.ctx = ctx
