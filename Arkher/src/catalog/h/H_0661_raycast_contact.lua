-- ARKHER SYSTEM H.0661 :: Raycast Query Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0661"
	S.key = "arkher.physics.raycast.contact_generation"
	S.name = "Raycast Query Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.raycast.collision_shape" }
	S.tags = { "h", "raycast", "contact", "physics" }
	S.description = "Raycast Query Contact Generation: narrow-phase manifolds with normal, depth and point for the Raycast Query subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.raycast.contact_generation", slop = 0.0050, maxManifolds = 304 })
		inst.system = S
		inst.ctx = ctx
