-- ARKHER SYSTEM G.0248 :: Behaviour Prediction Heuristic Policy
...
return function(A)
	...
	local S = {}
	S.id = "G.0248"
	S.key = "arkher.neural.behaviorpredict.heuristic_policy"
	S.name = "Behaviour Prediction Heuristic Policy"
	S.category = "G"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.behaviorpredict.result_cache" }
	S.tags = { "g", "behaviorpredict", "policy", "neural" }
	S.description = "Behaviour Prediction Heuristic Policy: rule fallback when the model is unavailable for the Behaviour Prediction subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.neural.behaviorpredict.heuristic_policy", algorithm = "edf", starvationGuard = 45 })
		inst.system = S
		inst.ctx = ctx
