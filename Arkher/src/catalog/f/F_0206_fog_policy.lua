-- ARKHER SYSTEM F.0206 :: Fog Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0206"
	S.key = "arkher.render.fog.render_policy"
	S.name = "Fog Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Fog"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.fog.draw_budget" }
	S.tags = { "f", "fog", "policy", "render" }
	S.description = "Fog Render Policy: device tier rules for the frame for the Fog subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.fog.render_policy", algorithm = "edf", starvationGuard = 61 })
		inst.system = S
		inst.ctx = ctx
