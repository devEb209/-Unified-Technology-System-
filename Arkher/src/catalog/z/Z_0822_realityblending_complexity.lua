-- ARKHER SYSTEM Z.0822 :: Reality Blending Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0822"
	S.key = "arkher.origin.realityblending.complexity_governance"
	S.name = "Reality Blending Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.reality_layering" }
	S.tags = { "z", "realityblending", "complexity", "origin" }
	S.description = "Reality Blending Complexity Governance: measured scene cost turned into per-subsystem directives for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.realityblending.complexity_governance", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
