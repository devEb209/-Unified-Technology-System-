-- ARKHER SYSTEM V.0206 :: Level Asset Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0206"
	S.key = "arkher.asset.levelasset.bundling"
	S.name = "Level Asset Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.levelasset.import" }
	S.tags = { "v", "levelasset", "bundler", "asset" }
	S.description = "Level Asset Bundling: size-bounded packing, manifests and delta patches for the Level Asset subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.levelasset.bundling", maxBundleBytes = 1048576 })
		inst.system = S
		inst.ctx = ctx
