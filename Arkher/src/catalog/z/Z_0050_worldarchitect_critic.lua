-- ARKHER SYSTEM Z.0050 :: Singularity World Architect Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0050"
	S.key = "arkher.origin.worldarchitect.self_critique"
	S.name = "Singularity World Architect Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.intent_bridge" }
	S.tags = { "z", "worldarchitect", "critic", "origin" }
	S.description = "Singularity World Architect Self Critique: weighted judgement of the technology's own output for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.worldarchitect.self_critique", passMark = 0.70, reviseMark = 0.40, seed = 96990 })
		inst.system = S
		inst.ctx = ctx
