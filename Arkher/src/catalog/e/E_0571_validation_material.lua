-- ARKHER SYSTEM E.0571 :: Material Validation Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0571"
	S.key = "arkher.material.validation.definition"
	S.name = "Material Validation Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "validation", "material", "material" }
	S.description = "Material Validation Definition: layered PBR definition resolved into parameters for the Material Validation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.validation.definition", texelBudget = 524288 })
		inst.system = S
		inst.ctx = ctx
