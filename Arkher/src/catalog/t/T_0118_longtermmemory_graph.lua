-- ARKHER SYSTEM T.0118 :: Long Term Memory Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0118"
	S.key = "arkher.ai.longtermmemory.reasoning_graph"
	S.name = "Long Term Memory Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.longtermmemory.world_architect" }
	S.tags = { "t", "longtermmemory", "graph", "ai" }
	S.description = "Long Term Memory Reasoning Graph: relationship modelling and shortest-path reasoning for the Long Term Memory subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.longtermmemory.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
