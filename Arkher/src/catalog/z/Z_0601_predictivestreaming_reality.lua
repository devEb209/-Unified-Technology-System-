-- ARKHER SYSTEM Z.0601 :: Predictive Streaming Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0601"
	S.key = "arkher.origin.predictivestreaming.reality_layering"
	S.name = "Predictive Streaming Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "predictivestreaming", "reality", "origin" }
	S.description = "Predictive Streaming Reality Layering: stacked authored, simulated, proposed and player realities for the Predictive Streaming subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.predictivestreaming.reality_layering" })
		inst.system = S
		inst.ctx = ctx
