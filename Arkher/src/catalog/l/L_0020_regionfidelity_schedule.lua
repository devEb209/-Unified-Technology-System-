-- ARKHER SYSTEM L.0020 :: Region Fidelity Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0020"
	S.key = "arkher.sim.regionfidelity.calendar"
	S.name = "Region Fidelity Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.regionfidelity.society" }
	S.tags = { "l", "regionfidelity", "schedule", "sim" }
	S.description = "Region Fidelity Calendar: hours, days and seasons driving the region for the Region Fidelity subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.regionfidelity.calendar", startHour = 9 })
		inst.system = S
		inst.ctx = ctx
