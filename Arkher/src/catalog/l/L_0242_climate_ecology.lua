-- ARKHER SYSTEM L.0242 :: Climate Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0242"
	S.key = "arkher.sim.climate.ecology"
	S.name = "Climate Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.climate.simulation_core" }
	S.tags = { "l", "climate", "ecology", "sim" }
	S.description = "Climate Ecology: populations, predation, harvesting and carrying capacity for the Climate subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.climate.ecology" })
		inst.system = S
		inst.ctx = ctx
