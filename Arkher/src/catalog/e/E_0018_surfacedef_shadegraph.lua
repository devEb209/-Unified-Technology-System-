-- ARKHER SYSTEM E.0018 :: Surface Definition Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0018"
	S.key = "arkher.material.surfacedef.shading_graph"
	S.name = "Surface Definition Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.surfacedef.layer_composition" }
	S.tags = { "e", "surfacedef", "shadegraph", "material" }
	S.description = "Surface Definition Shading Graph: node graph evaluated and compiled to Luau for the Surface Definition subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.surfacedef.shading_graph" })
		inst.system = S
		inst.ctx = ctx
