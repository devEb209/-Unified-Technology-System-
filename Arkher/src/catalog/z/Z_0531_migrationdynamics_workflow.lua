-- ARKHER SYSTEM Z.0531 :: Migration Dynamics Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0531"
	S.key = "arkher.origin.migrationdynamics.adaptive_workflow"
	S.name = "Migration Dynamics Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.migrationdynamics.self_critique" }
	S.tags = { "z", "migrationdynamics", "workflow", "origin" }
	S.description = "Migration Dynamics Adaptive Workflow: verified, retryable, reversible execution plans for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.migrationdynamics.adaptive_workflow", maxRetries = 1, budget = 100 })
		inst.system = S
		inst.ctx = ctx
