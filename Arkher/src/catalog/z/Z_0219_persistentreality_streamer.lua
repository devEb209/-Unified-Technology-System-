-- ARKHER SYSTEM Z.0219 :: Persistent Reality State Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0219"
	S.key = "arkher.origin.persistentreality.residency_streaming"
	S.name = "Persistent Reality State Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.budget_governor" }
	S.tags = { "z", "persistentreality", "streamer", "origin" }
	S.description = "Persistent Reality State Residency Streaming: distance-driven residency of the technology's workload for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.persistentreality.residency_streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
