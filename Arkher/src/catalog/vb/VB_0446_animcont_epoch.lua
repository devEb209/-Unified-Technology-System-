-- ARKHER SYSTEM VB.0446 :: Animation Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0446"
	S.key = "arkher.conttime.animcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.animcont.infinite_grid" }
	S.tags = { "vb", "animcont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.animcont.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
