-- ARKHER SYSTEM Z.0402 :: Battery Aware Pipeline Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0402"
	S.key = "arkher.origin.batteryaware.complexity_governance"
	S.name = "Battery Aware Pipeline Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.batteryaware.reality_layering" }
	S.tags = { "z", "batteryaware", "complexity", "origin" }
	S.description = "Battery Aware Pipeline Complexity Governance: measured scene cost turned into per-subsystem directives for the Battery Aware Pipeline subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.batteryaware.complexity_governance", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
