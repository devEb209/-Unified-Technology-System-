-- ARKHER SYSTEM O.0318 :: Vehicle Audio Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0318"
	S.key = "arkher.audio.vehicleaudio.streaming"
	S.name = "Vehicle Audio Streaming"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.vehicleaudio.voice_budget" }
	S.tags = { "o", "vehicleaudio", "streamer", "audio" }
	S.description = "Vehicle Audio Streaming: distance-driven residency of audio assets for the Vehicle Audio subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.vehicleaudio.streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
