-- ARKHER SYSTEM N.0467 :: Camera Shake Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0467"
	S.key = "arkher.vfx.camerashake.analysis"
	S.name = "Camera Shake Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Camera Shake"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.camerashake.spatial_index" }
	S.tags = { "n", "camerashake", "analyzer", "vfx" }
	S.description = "Camera Shake Analysis: cost, overdraw and stability analysis of the effect for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.camerashake.analysis", window = 234, buckets = 18, threshold = 3.60 })
		inst.system = S
		inst.ctx = ctx
