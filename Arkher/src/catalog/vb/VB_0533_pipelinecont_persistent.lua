-- ARKHER SYSTEM VB.0533 :: Pipeline Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0533"
	S.key = "arkher.conttime.pipelinecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.pipelinecont.multi-scale_fidelity" }
	S.tags = { "vb", "pipelinecont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.pipelinecont.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
