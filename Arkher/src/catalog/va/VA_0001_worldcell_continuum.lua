-- ARKHER SYSTEM VA.0001 :: World Grid Cell Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0001"
	S.key = "arkher.contworld.worldcell.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "worldcell", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.worldcell.infinite_grid", cellSize = 160, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
