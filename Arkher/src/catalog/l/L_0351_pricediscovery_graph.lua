-- ARKHER SYSTEM L.0351 :: Price Discovery Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0351"
	S.key = "arkher.sim.pricediscovery.region_graph"
	S.name = "Price Discovery Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.pricediscovery.calendar" }
	S.tags = { "l", "pricediscovery", "graph", "sim" }
	S.description = "Price Discovery Region Graph: connectivity, components and shortest path between places for the Price Discovery subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.pricediscovery.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
