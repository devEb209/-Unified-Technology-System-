-- ARKHER SYSTEM Z.0438 :: Offline World Progression Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0438"
	S.key = "arkher.origin.offlineprogression.budget_governor"
	S.name = "Offline World Progression Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.behaviour_analysis" }
	S.tags = { "z", "offlineprogression", "budgeter", "origin" }
	S.description = "Offline World Progression Budget Governor: allocation of a scarce resource across the technology's consumers for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.offlineprogression.budget_governor", total = 138, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
