-- ARKHER SYSTEM V.0187 :: Scene Asset Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0187"
	S.key = "arkher.asset.sceneasset.streaming_residency"
	S.name = "Scene Asset Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.sceneasset.content_cache" }
	S.tags = { "v", "sceneasset", "streamer", "asset" }
	S.description = "Scene Asset Streaming Residency: distance-driven load and unload of asset payloads for the Scene Asset subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.sceneasset.streaming_residency", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
