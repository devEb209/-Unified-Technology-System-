-- ARKHER SYSTEM V.0026 :: Texture Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0026"
	S.key = "arkher.asset.textureasset.bundling"
	S.name = "Texture Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.textureasset.import" }
	S.tags = { "v", "textureasset", "bundler", "asset" }
	S.description = "Texture Bundling: size-bounded packing, manifests and delta patches for the Texture subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.textureasset.bundling", maxBundleBytes = 786432 })
		inst.system = S
		inst.ctx = ctx
