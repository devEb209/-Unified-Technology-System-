-- ARKHER SYSTEM E.0040 :: Albedo Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0040"
	S.key = "arkher.material.albedo.quality_policy"
	S.name = "Albedo Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Albedo"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.albedo.compression_codec" }
	S.tags = { "e", "albedo", "policy", "material" }
	S.description = "Albedo Quality Policy: device tier rules for the surface for the Albedo subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.albedo.quality_policy", algorithm = "roundrobin", starvationGuard = 24 })
		inst.system = S
		inst.ctx = ctx
