-- ARKHER SYSTEM H.0306 :: Capsule Collider Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0306"
	S.key = "arkher.physics.capsulecollider.analysis"
	S.name = "Capsule Collider Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.capsulecollider.result_cache" }
	S.tags = { "h", "capsulecollider", "analyzer", "physics" }
	S.description = "Capsule Collider Analysis: energy, jitter and cost analysis of the simulation for the Capsule Collider subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.capsulecollider.analysis", window = 109, buckets = 17, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
