-- ARKHER SYSTEM R.0145 :: Delta Compression Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0145"
	S.key = "arkher.net.deltacompression.replication"
	S.name = "Delta Compression Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "deltacompression", "replicator", "net" }
	S.description = "Delta Compression Replication: authoritative entity state, interest and delta snapshots for the Delta Compression subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.deltacompression.replication", mtu = 1050, interestRadius = 320, fullEvery = 45 })
		inst.system = S
		inst.ctx = ctx
