-- ARKHER SYSTEM I.0198 :: State Machine Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0198"
	S.key = "arkher.anim.animstate.layered_blending"
	S.name = "State Machine Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstate.clip_sampling" }
	S.tags = { "i", "animstate", "animator", "anim" }
	S.description = "State Machine Layered Blending: layers, crossfades, masks and blend trees for the State Machine subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.animstate.layered_blending", budget = 15 })
		inst.system = S
		inst.ctx = ctx
