-- ARKHER SYSTEM V.0294 :: LOD Chain Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0294"
	S.key = "arkher.asset.lodchain.content_cache"
	S.name = "LOD Chain Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lodchain.dependency_graph" }
	S.tags = { "v", "lodchain", "cache", "asset" }
	S.description = "LOD Chain Content Cache: reuse of already cooked results for the LOD Chain subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.lodchain.content_cache", policy = "lfu", capacity = 257, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
