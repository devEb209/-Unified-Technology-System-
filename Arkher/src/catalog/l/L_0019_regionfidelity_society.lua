-- ARKHER SYSTEM L.0019 :: Region Fidelity Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0019"
	S.key = "arkher.sim.regionfidelity.society"
	S.name = "Region Fidelity Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.regionfidelity.economy" }
	S.tags = { "l", "regionfidelity", "society", "sim" }
	S.description = "Region Fidelity Society: relations, factions, reputation and cohesion of the region for the Region Fidelity subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.regionfidelity.society", decayRate = 0.011, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
