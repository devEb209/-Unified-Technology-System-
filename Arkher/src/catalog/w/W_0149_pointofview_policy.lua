-- ARKHER SYSTEM W.0149 :: Point Of View Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0149"
	S.key = "arkher.cine.pointofview.cut_policy"
	S.name = "Point Of View Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.pointofview.shot_composition" }
	S.tags = { "w", "pointofview", "policy", "cine" }
	S.description = "Point Of View Cut Policy: rules deciding when the sequence cuts and to what for the Point Of View subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.pointofview.cut_policy", algorithm = "edf", starvationGuard = 33 })
		inst.system = S
		inst.ctx = ctx
