-- ARKHER SYSTEM VB.0173 :: Neural Patch Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0173"
	S.key = "arkher.conttime.neuralpatch.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.neuralpatch.multi-scale_fidelity" }
	S.tags = { "vb", "neuralpatch", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.neuralpatch.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
