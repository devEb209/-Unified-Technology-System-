-- ARKHER SYSTEM J.0046 :: Hair Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0046"
	S.key = "arkher.character.hair.motion_set"
	S.name = "Hair Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.hair.rig_definition" }
	S.tags = { "j", "hair", "clip", "character" }
	S.description = "Hair Motion Set: the clips a character owns and how they sample for the Hair subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.hair.motion_set", duration = 2.40, loop = false })
		inst.system = S
		inst.ctx = ctx
