-- ARKHER SYSTEM E.0173 :: Clear Coat Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0173"
	S.key = "arkher.material.clearcoat.streaming"
	S.name = "Clear Coat Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Clear Coat"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.clearcoat.parameter_budget" }
	S.tags = { "e", "clearcoat", "streamer", "material" }
	S.description = "Clear Coat Streaming: residency and demand-driven texture streaming for the Clear Coat subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.clearcoat.streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
