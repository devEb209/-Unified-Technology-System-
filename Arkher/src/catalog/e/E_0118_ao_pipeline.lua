-- ARKHER SYSTEM E.0118 :: Ambient Occlusion Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0118"
	S.key = "arkher.material.ao.authoring_pipeline"
	S.name = "Ambient Occlusion Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.ao.analysis" }
	S.tags = { "e", "ao", "pipeline", "material" }
	S.description = "Ambient Occlusion Authoring Pipeline: ordered authoring and bake stages for the Ambient Occlusion subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.ao.authoring_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
