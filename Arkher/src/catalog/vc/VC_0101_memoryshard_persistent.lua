-- ARKHER SYSTEM VC.0101 :: Memory Shard Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0101"
	S.key = "arkher.contneural.memoryshard.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memoryshard.multi-scale_fidelity" }
	S.tags = { "vc", "memoryshard", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.memoryshard.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
