-- ARKHER SYSTEM Z.0831 :: Reality Blending Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0831"
	S.key = "arkher.origin.realityblending.adaptive_workflow"
	S.name = "Reality Blending Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.self_critique" }
	S.tags = { "z", "realityblending", "workflow", "origin" }
	S.description = "Reality Blending Adaptive Workflow: verified, retryable, reversible execution plans for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.realityblending.adaptive_workflow", maxRetries = 3, budget = 150 })
		inst.system = S
		inst.ctx = ctx
