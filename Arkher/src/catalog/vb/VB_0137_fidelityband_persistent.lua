-- ARKHER SYSTEM VB.0137 :: Fidelity Band Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0137"
	S.key = "arkher.conttime.fidelityband.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.fidelityband.multi-scale_fidelity" }
	S.tags = { "vb", "fidelityband", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.fidelityband.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
