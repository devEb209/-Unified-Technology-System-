-- ARKHER SYSTEM Z.0859 :: Simulation Time Dilation Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0859"
	S.key = "arkher.origin.timedilation.residency_streaming"
	S.name = "Simulation Time Dilation Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.budget_governor" }
	S.tags = { "z", "timedilation", "streamer", "origin" }
	S.description = "Simulation Time Dilation Residency Streaming: distance-driven residency of the technology's workload for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.timedilation.residency_streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
