-- ARKHER SYSTEM E.0087 :: Normal Detail Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0087"
	S.key = "arkher.material.normaldetail.analysis"
	S.name = "Normal Detail Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.normaldetail.instance_cache" }
	S.tags = { "e", "normaldetail", "analyzer", "material" }
	S.description = "Normal Detail Analysis: cost, redundancy and outlier analysis for the Normal Detail subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.normaldetail.analysis", window = 237, buckets = 9, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
