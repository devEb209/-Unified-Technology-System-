-- ARKHER SYSTEM R.0019 :: Connection Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0019"
	S.key = "arkher.net.connection.interest_streaming"
	S.name = "Connection Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Connection"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.connection.serialization_codec" }
	S.tags = { "r", "connection", "streamer", "net" }
	S.description = "Connection Interest Streaming: distance-driven residency of replicated content for the Connection subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.connection.interest_streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
