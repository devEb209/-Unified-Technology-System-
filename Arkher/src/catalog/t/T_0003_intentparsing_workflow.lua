-- ARKHER SYSTEM T.0003 :: Intent Parsing Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0003"
	S.key = "arkher.ai.intentparsing.plan_workflow"
	S.name = "Intent Parsing Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.intentparsing.semantic_knowledge" }
	S.tags = { "t", "intentparsing", "workflow", "ai" }
	S.description = "Intent Parsing Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Intent Parsing subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.intentparsing.plan_workflow", maxRetries = 1, budget = 70 })
		inst.system = S
		inst.ctx = ctx
