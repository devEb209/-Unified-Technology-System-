-- ARKHER SYSTEM Q.0071 :: List Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0071"
	S.key = "arkher.ui.list.usability_analysis"
	S.name = "List Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "List"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.list.frame_budget" }
	S.tags = { "q", "list", "analyzer", "ui" }
	S.description = "List Usability Analysis: reachability, latency and abandonment analysis for the List subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.list.usability_analysis", window = 116, buckets = 16, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
