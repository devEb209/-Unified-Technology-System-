-- ARKHER SYSTEM H.0614 :: Explosion Force Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0614"
	S.key = "arkher.physics.explosion.analysis"
	S.name = "Explosion Force Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.explosion.result_cache" }
	S.tags = { "h", "explosion", "analyzer", "physics" }
	S.description = "Explosion Force Analysis: energy, jitter and cost analysis of the simulation for the Explosion Force subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.explosion.analysis", window = 239, buckets = 11, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
