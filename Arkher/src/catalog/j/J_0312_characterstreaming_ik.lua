-- ARKHER SYSTEM J.0312 :: Character Streaming Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0312"
	S.key = "arkher.character.characterstreaming.look_and_reach"
	S.name = "Character Streaming Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterstreaming.blend_controller" }
	S.tags = { "j", "characterstreaming", "ik", "character" }
	S.description = "Character Streaming Look And Reach: look-at, reach and foot placement for the character for the Character Streaming subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.characterstreaming.look_and_reach", iterations = 14, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
