-- ARKHER SYSTEM F.0571 :: UI Rendering Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0571"
	S.key = "arkher.render.uirender.pass_cache"
	S.name = "UI Rendering Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "UI Rendering"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.uirender.render_policy" }
	S.tags = { "f", "uirender", "cache", "render" }
	S.description = "UI Rendering Pass Cache: reuse of pass results across frames for the UI Rendering subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.uirender.pass_cache", policy = "lru", capacity = 80, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
