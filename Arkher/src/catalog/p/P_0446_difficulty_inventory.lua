-- ARKHER SYSTEM P.0446 :: Difficulty Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0446"
	S.key = "arkher.play.difficulty.inventory"
	S.name = "Difficulty Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Difficulty"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.difficulty.attributes" }
	S.tags = { "p", "difficulty", "inventory", "play" }
	S.description = "Difficulty Inventory: slots, stacking, weight, equipment and crafting for the Difficulty subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.difficulty.inventory", slots = 36, maxWeight = 60 })
		inst.system = S
		inst.ctx = ctx
