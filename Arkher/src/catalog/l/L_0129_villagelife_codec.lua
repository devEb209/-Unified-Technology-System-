-- ARKHER SYSTEM L.0129 :: Village Life State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0129"
	S.key = "arkher.sim.villagelife.state_codec"
	S.name = "Village Life State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.villagelife.history_ledger" }
	S.tags = { "l", "villagelife", "codec", "sim" }
	S.description = "Village Life State Codec: persistence, diffing and checksum of the world state for the Village Life subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.villagelife.state_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
