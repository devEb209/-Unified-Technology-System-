-- ARKHER SYSTEM Z.0271 :: Living Ecosystem Engine Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0271"
	S.key = "arkher.origin.livingecosystem.adaptive_workflow"
	S.name = "Living Ecosystem Engine Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.livingecosystem.self_critique" }
	S.tags = { "z", "livingecosystem", "workflow", "origin" }
	S.description = "Living Ecosystem Engine Adaptive Workflow: verified, retryable, reversible execution plans for the Living Ecosystem Engine subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.livingecosystem.adaptive_workflow", maxRetries = 1, budget = 70 })
		inst.system = S
		inst.ctx = ctx
