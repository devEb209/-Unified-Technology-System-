-- ARKHER SYSTEM T.0258 :: Narrative Design Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0258"
	S.key = "arkher.ai.narrativedesign.reasoning_graph"
	S.name = "Narrative Design Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.narrativedesign.world_architect" }
	S.tags = { "t", "narrativedesign", "graph", "ai" }
	S.description = "Narrative Design Reasoning Graph: relationship modelling and shortest-path reasoning for the Narrative Design subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.narrativedesign.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
