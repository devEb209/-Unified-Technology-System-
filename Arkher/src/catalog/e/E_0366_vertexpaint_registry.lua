-- ARKHER SYSTEM E.0366 :: Vertex Painting Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0366"
	S.key = "arkher.material.vertexpaint.variant_registry"
	S.name = "Vertex Painting Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.vertexpaint.procedural_detail" }
	S.tags = { "e", "vertexpaint", "registry", "material" }
	S.description = "Vertex Painting Variant Registry: named variants and their lifecycle for the Vertex Painting subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.vertexpaint.variant_registry" })
		inst.system = S
		inst.ctx = ctx
