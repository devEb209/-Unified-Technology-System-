-- ARKHER SYSTEM VB.0361 :: Quest Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0361"
	S.key = "arkher.conttime.questcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "questcont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.questcont.infinite_grid", cellSize = 96, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
