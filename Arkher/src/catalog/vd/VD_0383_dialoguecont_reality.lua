-- ARKHER SYSTEM VD.0383 :: Dialogue Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0383"
	S.key = "arkher.contsim.dialoguecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.dialoguecont.simulation_fabric" }
	S.tags = { "vd", "dialoguecont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.dialoguecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
