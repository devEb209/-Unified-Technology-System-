-- ARKHER SYSTEM V.0214 :: Level Asset Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0214"
	S.key = "arkher.asset.levelasset.validation_guard"
	S.name = "Level Asset Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.levelasset.size_budget" }
	S.tags = { "v", "levelasset", "guard", "asset" }
	S.description = "Level Asset Validation Guard: rate limiting and capability checks on the import path for the Level Asset subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.levelasset.validation_guard", algorithm = "leaky", capacity = 119, refillPerSec = 64, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
