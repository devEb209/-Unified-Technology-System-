-- ARKHER SYSTEM Q.0331 :: Keyboard Focus Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0331"
	S.key = "arkher.ui.keyboardfocus.localization_registry"
	S.name = "Keyboard Focus Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.keyboardfocus.theme_composition" }
	S.tags = { "q", "keyboardfocus", "registry", "ui" }
	S.description = "Keyboard Focus Localization Registry: catalogue of strings, plurals and locale metadata for the Keyboard Focus subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.keyboardfocus.localization_registry" })
		inst.system = S
		inst.ctx = ctx
