-- ARKHER SYSTEM V.0169 :: Prefab Asset Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0169"
	S.key = "arkher.asset.prefabasset.import"
	S.name = "Prefab Asset Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "prefabasset", "importer", "asset" }
	S.description = "Prefab Asset Import: validation, normalization, hashing and deduplication of incoming content for the Prefab Asset subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.prefabasset.import", unitScale = 1.75 })
		inst.system = S
		inst.ctx = ctx
