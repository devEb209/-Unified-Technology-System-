-- ARKHER SYSTEM G.0011 :: Neural Upscaling Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0011"
	S.key = "arkher.neural.neuralupscale.error_analysis"
	S.name = "Neural Upscaling Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuralupscale.heuristic_policy" }
	S.tags = { "g", "neuralupscale", "analyzer", "neural" }
	S.description = "Neural Upscaling Error Analysis: residual and drift analysis for the Neural Upscaling subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.neuralupscale.error_analysis", window = 91, buckets = 19, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
