-- ARKHER SYSTEM N.0157 :: Snow Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0157"
	S.key = "arkher.vfx.snow.emission"
	S.name = "Snow Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Snow"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "snow", "emitter", "vfx" }
	S.description = "Snow Emission: shaped, rate and burst emission of new particles for the Snow subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.snow.emission", shape = "sphere", rate = 69, speed = 3.90, life = 2.70, budget = 192, seed = 27289 })
		inst.system = S
		inst.ctx = ctx
