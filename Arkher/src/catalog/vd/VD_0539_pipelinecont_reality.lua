-- ARKHER SYSTEM VD.0539 :: Pipeline Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0539"
	S.key = "arkher.contsim.pipelinecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.pipelinecont.simulation_fabric" }
	S.tags = { "vd", "pipelinecont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.pipelinecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
