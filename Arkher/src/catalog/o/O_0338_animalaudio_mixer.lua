-- ARKHER SYSTEM O.0338 :: Animal Audio Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0338"
	S.key = "arkher.audio.animalaudio.mixer_bus"
	S.name = "Animal Audio Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Animal Audio"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.animalaudio.dsp_chain" }
	S.tags = { "o", "animalaudio", "mixer", "audio" }
	S.description = "Animal Audio Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Animal Audio subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.animalaudio.mixer_bus", maxVoices = 56 })
		inst.system = S
		inst.ctx = ctx
