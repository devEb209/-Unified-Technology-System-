-- ARKHER SYSTEM T.0385 :: Refactoring Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0385"
	S.key = "arkher.ai.refactoring.decision_policy"
	S.name = "Refactoring Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.refactoring.reasoning_graph" }
	S.tags = { "t", "refactoring", "policy", "ai" }
	S.description = "Refactoring Decision Policy: ordered rules deciding what the agent does next for the Refactoring subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.refactoring.decision_policy", algorithm = "wfq", starvationGuard = 42 })
		inst.system = S
		inst.ctx = ctx
