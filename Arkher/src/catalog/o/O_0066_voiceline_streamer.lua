-- ARKHER SYSTEM O.0066 :: Voice Line Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0066"
	S.key = "arkher.audio.voiceline.streaming"
	S.name = "Voice Line Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Voice Line"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.voiceline.voice_budget" }
	S.tags = { "o", "voiceline", "streamer", "audio" }
	S.description = "Voice Line Streaming: distance-driven residency of audio assets for the Voice Line subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.voiceline.streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
