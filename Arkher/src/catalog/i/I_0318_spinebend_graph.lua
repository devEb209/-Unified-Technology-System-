-- ARKHER SYSTEM I.0318 :: Spine Bend Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0318"
	S.key = "arkher.anim.spinebend.retarget_graph"
	S.name = "Spine Bend Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Spine Bend"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.spinebend.physical_blend" }
	S.tags = { "i", "spinebend", "graph", "anim" }
	S.description = "Spine Bend Retarget Graph: bone mapping and retarget path resolution for the Spine Bend subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.spinebend.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
