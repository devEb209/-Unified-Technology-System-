-- ARKHER SYSTEM P.0116 :: Equipment Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0116"
	S.key = "arkher.play.equipment.balance_analysis"
	S.name = "Equipment Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Equipment"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.equipment.event_ledger" }
	S.tags = { "p", "equipment", "analyzer", "play" }
	S.description = "Equipment Balance Analysis: distribution, outlier and pacing analysis for the Equipment subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.equipment.balance_analysis", window = 136, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
