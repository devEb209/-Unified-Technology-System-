-- ARKHER SYSTEM V.0236 :: Data Table Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0236"
	S.key = "arkher.asset.datatable.compression_codec"
	S.name = "Data Table Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.datatable.streaming_residency" }
	S.tags = { "v", "datatable", "codec", "asset" }
	S.description = "Data Table Compression Codec: compact encoding, diffing and checksum of asset payloads for the Data Table subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.datatable.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
