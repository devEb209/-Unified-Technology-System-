-- ARKHER SYSTEM K.0172 :: Social Drive Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0172"
	S.key = "arkher.npc.socialdrive.emotion"
	S.name = "Social Drive Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.socialdrive.drive_system" }
	S.tags = { "k", "socialdrive", "emotion", "npc" }
	S.description = "Social Drive Emotion: appraisal of events into valence, arousal and mood for the Social Drive subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.socialdrive.emotion", inertia = 0.79, decayRate = 0.34, baselineArousal = 0.14 })
		inst.system = S
		inst.ctx = ctx
