-- ARKHER SYSTEM E.0061 :: Metalness Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0061"
	S.key = "arkher.material.metalness.definition"
	S.name = "Metalness Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Metalness"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "metalness", "material", "material" }
	S.description = "Metalness Definition: layered PBR definition resolved into parameters for the Metalness subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.metalness.definition", texelBudget = 786432 })
		inst.system = S
		inst.ctx = ctx
