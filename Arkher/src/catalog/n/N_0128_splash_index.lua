-- ARKHER SYSTEM N.0128 :: Water Splash Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0128"
	S.key = "arkher.vfx.splash.spatial_index"
	S.name = "Water Splash Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Water Splash"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.splash.quality_policy" }
	S.tags = { "n", "splash", "index", "vfx" }
	S.description = "Water Splash Spatial Index: spatial acceleration of effect queries and culling for the Water Splash subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.splash.spatial_index", mode = "hash", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
