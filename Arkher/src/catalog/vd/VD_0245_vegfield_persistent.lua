-- ARKHER SYSTEM VD.0245 :: Vegetation Field Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0245"
	S.key = "arkher.contsim.vegfield.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vegfield.multi-scale_fidelity" }
	S.tags = { "vd", "vegfield", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.vegfield.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
