-- ARKHER SYSTEM VB.0266 :: Bridge Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0266"
	S.key = "arkher.conttime.bridgecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.bridgecont.infinite_grid" }
	S.tags = { "vb", "bridgecont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.bridgecont.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
