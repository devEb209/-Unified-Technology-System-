-- ARKHER SYSTEM Z.0715 :: Continuous Self Optimization Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0715"
	S.key = "arkher.origin.continuousopt.signal_composition"
	S.name = "Continuous Self Optimization Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.telemetry_ledger" }
	S.tags = { "z", "continuousopt", "composer", "origin" }
	S.description = "Continuous Self Optimization Signal Composition: blending of the technology's input signals into one output for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.continuousopt.signal_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
