-- ARKHER SYSTEM VC.0195 :: Architect District Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0195"
	S.key = "arkher.contneural.architectdistrict.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.architectdistrict.epoch_clock" }
	S.tags = { "vc", "architectdistrict", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.architectdistrict.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
