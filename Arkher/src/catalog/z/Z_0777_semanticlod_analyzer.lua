-- ARKHER SYSTEM Z.0777 :: Semantic LOD Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0777"
	S.key = "arkher.origin.semanticlod.behaviour_analysis"
	S.name = "Semantic LOD Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticlod.governance_policy" }
	S.tags = { "z", "semanticlod", "analyzer", "origin" }
	S.description = "Semantic LOD Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Semantic LOD subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.semanticlod.behaviour_analysis", window = 186, buckets = 10, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
