-- ARKHER SYSTEM K.0316 :: Threat Assessment Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0316"
	S.key = "arkher.npc.threatassessment.goal_planner"
	S.name = "Threat Assessment Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.threatassessment.utility_reasoning" }
	S.tags = { "k", "threatassessment", "planner", "npc" }
	S.description = "Threat Assessment Goal Planner: backward GOAP planning to reach a goal state for the Threat Assessment subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.threatassessment.goal_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
