-- ARKHER SYSTEM T.0626 :: Explainability Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0626"
	S.key = "arkher.ai.explainability.utility_selection"
	S.name = "Explainability Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.explainability.working_memory" }
	S.tags = { "t", "explainability", "utility", "ai" }
	S.description = "Explainability Utility Selection: scored choice between competing courses of action for the Explainability subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.explainability.utility_selection", momentum = 0.10 })
		inst.system = S
		inst.ctx = ctx
