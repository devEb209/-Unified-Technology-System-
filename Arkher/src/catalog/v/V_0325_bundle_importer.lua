-- ARKHER SYSTEM V.0325 :: Bundle Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0325"
	S.key = "arkher.asset.bundle.import"
	S.name = "Bundle Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "bundle", "importer", "asset" }
	S.description = "Bundle Import: validation, normalization, hashing and deduplication of incoming content for the Bundle subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.bundle.import", unitScale = 1.50 })
		inst.system = S
		inst.ctx = ctx
