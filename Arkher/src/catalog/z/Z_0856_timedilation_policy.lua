-- ARKHER SYSTEM Z.0856 :: Simulation Time Dilation Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0856"
	S.key = "arkher.origin.timedilation.governance_policy"
	S.name = "Simulation Time Dilation Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.signal_composition" }
	S.tags = { "z", "timedilation", "policy", "origin" }
	S.description = "Simulation Time Dilation Governance Policy: ordered rules governing when the technology may act for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.timedilation.governance_policy", algorithm = "roundrobin", starvationGuard = 24 })
		inst.system = S
		inst.ctx = ctx
