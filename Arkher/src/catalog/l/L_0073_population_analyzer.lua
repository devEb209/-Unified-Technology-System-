-- ARKHER SYSTEM L.0073 :: Population Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0073"
	S.key = "arkher.sim.population.analysis"
	S.name = "Population Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.population.aggregate_cache" }
	S.tags = { "l", "population", "analyzer", "sim" }
	S.description = "Population Analysis: trend, anomaly and stability analysis of the world for the Population subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.population.analysis", window = 201, buckets = 9, threshold = 3.30 })
		inst.system = S
		inst.ctx = ctx
