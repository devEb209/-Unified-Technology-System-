...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="UE5/6 Nanite — CORE Mixer #0262", size=Vector2.new(640, 460), pos=UDim2.fromOffset(306, 114), parent=parent, icon="✈"})
...
Components.Slider(right, "Rate", 0,3000,600, function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_Rate"..262, v) end end)
