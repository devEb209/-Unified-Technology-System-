-- ARKHER SYSTEM R.0287 :: Anti Cheat Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0287"
	S.key = "arkher.net.anticheat.latency_analysis"
	S.name = "Anti Cheat Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Anti Cheat"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.anticheat.audit_ledger" }
	S.tags = { "r", "anticheat", "analyzer", "net" }
	S.description = "Anti Cheat Latency Analysis: round trip, jitter and loss analysis for the Anti Cheat subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.anticheat.latency_analysis", window = 152, buckets = 16, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
