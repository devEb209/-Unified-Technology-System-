-- ARKHER SYSTEM P.0166 :: Gathering Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0166"
	S.key = "arkher.play.gathering.content_registry"
	S.name = "Gathering Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Gathering"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.gathering.difficulty_controller" }
	S.tags = { "p", "gathering", "registry", "play" }
	S.description = "Gathering Content Registry: catalogue of the definitions this loop instantiates for the Gathering subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.gathering.content_registry" })
		inst.system = S
		inst.ctx = ctx
