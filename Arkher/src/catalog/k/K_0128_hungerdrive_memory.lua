-- ARKHER SYSTEM K.0128 :: Hunger Drive Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0128"
	S.key = "arkher.npc.hungerdrive.memory"
	S.name = "Hunger Drive Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hungerdrive.mind_network" }
	S.tags = { "k", "hungerdrive", "memory", "npc" }
	S.description = "Hunger Drive Memory: episodic memory with decay, recall and consolidation for the Hunger Drive subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.hungerdrive.memory", capacity = 102, decayRate = 0.040, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
