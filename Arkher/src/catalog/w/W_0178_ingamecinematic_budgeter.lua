-- ARKHER SYSTEM W.0178 :: In Game Cinematic Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0178"
	S.key = "arkher.cine.ingamecinematic.frame_budget"
	S.name = "In Game Cinematic Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.ingamecinematic.event_ledger" }
	S.tags = { "w", "ingamecinematic", "budgeter", "cine" }
	S.description = "In Game Cinematic Frame Budget: per-frame cost budget for the cinematic systems for the In Game Cinematic subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.ingamecinematic.frame_budget", total = 263, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
