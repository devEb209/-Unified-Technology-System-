-- ARKHER SYSTEM VA.0127 :: Spatial Slice Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0127"
	S.key = "arkher.contworld.spatialslice.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.spatialslice.coherence_guard" }
	S.tags = { "va", "spatialslice", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.spatialslice.neural_field", dims = 20, hidden = 16, seed = 23046 })
		inst.system = S
		inst.ctx = ctx
