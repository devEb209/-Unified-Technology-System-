-- ARKHER SYSTEM O.0411 :: Audio Debug Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0411"
	S.key = "arkher.audio.audiodebug.spatialization"
	S.name = "Audio Debug Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Audio Debug"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiodebug.mixer_bus" }
	S.tags = { "o", "audiodebug", "spatialaudio", "audio" }
	S.description = "Audio Debug Spatialization: distance attenuation, panning, occlusion and doppler for the Audio Debug subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.audiodebug.spatialization", model = "exponential", refDistance = 8, maxDistance = 220, rolloff = 0.87, maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
