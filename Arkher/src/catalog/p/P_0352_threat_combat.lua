-- ARKHER SYSTEM P.0352 :: Threat Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0352"
	S.key = "arkher.play.threat.combat_resolution"
	S.name = "Threat Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Threat"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.threat.objectives" }
	S.tags = { "p", "threat", "combat", "play" }
	S.description = "Threat Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Threat subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.threat.combat_resolution", seed = 22892, armourK = 120, critMultiplier = 2.30 })
		inst.system = S
		inst.ctx = ctx
