-- ARKHER SYSTEM N.0243 :: Spell Cast Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0243"
	S.key = "arkher.vfx.spellcast.result_cache"
	S.name = "Spell Cast Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spell Cast"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spellcast.spawn_budget" }
	S.tags = { "n", "spellcast", "cache", "vfx" }
	S.description = "Spell Cast Result Cache: reuse of expensive effect evaluations for the Spell Cast subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.spellcast.result_cache", policy = "ttl", capacity = 122, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
