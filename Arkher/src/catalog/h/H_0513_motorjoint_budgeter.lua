-- ARKHER SYSTEM H.0513 :: Motorized Joint Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0513"
	S.key = "arkher.physics.motorjoint.budget_governor"
	S.name = "Motorized Joint Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.motorjoint.broadphase_index" }
	S.tags = { "h", "motorjoint", "budgeter", "physics" }
	S.description = "Motorized Joint Budget Governor: simulation time budget allocation across islands for the Motorized Joint subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.motorjoint.budget_governor", total = 122, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
