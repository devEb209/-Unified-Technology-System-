-- ARKHER SYSTEM L.0573 :: World History Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0573"
	S.key = "arkher.sim.worldhistory.economy"
	S.name = "World History Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldhistory.ecology" }
	S.tags = { "l", "worldhistory", "economy", "sim" }
	S.description = "World History Economy: stock, production, demand, price discovery and trade for the World History subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.worldhistory.economy", elasticity = 0.17 })
		inst.system = S
		inst.ctx = ctx
