-- ARKHER SYSTEM G.0008 :: Neural Upscaling Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0008"
	S.key = "arkher.neural.neuralupscale.compute_budget"
	S.name = "Neural Upscaling Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuralupscale.quality_predictor" }
	S.tags = { "g", "neuralupscale", "budgeter", "neural" }
	S.description = "Neural Upscaling Compute Budget: inference time budget allocation for the Neural Upscaling subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.neuralupscale.compute_budget", total = 216, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
