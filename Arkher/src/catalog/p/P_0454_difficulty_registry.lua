-- ARKHER SYSTEM P.0454 :: Difficulty Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0454"
	S.key = "arkher.play.difficulty.content_registry"
	S.name = "Difficulty Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Difficulty"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.difficulty.difficulty_controller" }
	S.tags = { "p", "difficulty", "registry", "play" }
	S.description = "Difficulty Content Registry: catalogue of the definitions this loop instantiates for the Difficulty subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.difficulty.content_registry" })
		inst.system = S
		inst.ctx = ctx
