-- ARKHER SYSTEM V.0298 :: LOD Chain Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0298"
	S.key = "arkher.asset.lodchain.validation_guard"
	S.name = "LOD Chain Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lodchain.size_budget" }
	S.tags = { "v", "lodchain", "guard", "asset" }
	S.description = "LOD Chain Validation Guard: rate limiting and capability checks on the import path for the LOD Chain subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.lodchain.validation_guard", algorithm = "token", capacity = 190, refillPerSec = 35, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
