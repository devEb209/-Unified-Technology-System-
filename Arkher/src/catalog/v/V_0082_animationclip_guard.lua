-- ARKHER SYSTEM V.0082 :: Animation Clip Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0082"
	S.key = "arkher.asset.animationclip.validation_guard"
	S.name = "Animation Clip Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.animationclip.size_budget" }
	S.tags = { "v", "animationclip", "guard", "asset" }
	S.description = "Animation Clip Validation Guard: rate limiting and capability checks on the import path for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.animationclip.validation_guard", algorithm = "token", capacity = 55, refillPerSec = 20, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
