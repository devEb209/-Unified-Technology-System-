-- ARKHER SYSTEM Z.0119 :: Universal Simulation Fabric Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0119"
	S.key = "arkher.origin.simfabric.residency_streaming"
	S.name = "Universal Simulation Fabric Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.simfabric.budget_governor" }
	S.tags = { "z", "simfabric", "streamer", "origin" }
	S.description = "Universal Simulation Fabric Residency Streaming: distance-driven residency of the technology's workload for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.simfabric.residency_streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
