-- ARKHER SYSTEM E.0208 :: Sheen Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0208"
	S.key = "arkher.material.sheen.authoring_pipeline"
	S.name = "Sheen Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Sheen"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.sheen.analysis" }
	S.tags = { "e", "sheen", "pipeline", "material" }
	S.description = "Sheen Authoring Pipeline: ordered authoring and bake stages for the Sheen subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.sheen.authoring_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
