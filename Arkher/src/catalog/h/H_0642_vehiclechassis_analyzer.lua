-- ARKHER SYSTEM H.0642 :: Vehicle Chassis Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0642"
	S.key = "arkher.physics.vehiclechassis.analysis"
	S.name = "Vehicle Chassis Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.vehiclechassis.result_cache" }
	S.tags = { "h", "vehiclechassis", "analyzer", "physics" }
	S.description = "Vehicle Chassis Analysis: energy, jitter and cost analysis of the simulation for the Vehicle Chassis subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.vehiclechassis.analysis", window = 208, buckets = 16, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
