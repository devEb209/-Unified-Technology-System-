-- ARKHER SYSTEM Z.0565 :: Collective Behaviour World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0565"
	S.key = "arkher.origin.collectivebehaviour.world_memory"
	S.name = "Collective Behaviour World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.collectivebehaviour.autonomous_pipeline" }
	S.tags = { "z", "collectivebehaviour", "worldmemory", "origin" }
	S.description = "Collective Behaviour World Memory: epoch-stamped persistent history with compaction and checkpoints for the Collective Behaviour subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.collectivebehaviour.world_memory", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
