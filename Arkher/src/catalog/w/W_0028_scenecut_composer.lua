-- ARKHER SYSTEM W.0028 :: Scene Cut Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0028"
	S.key = "arkher.cine.scenecut.shot_composition"
	S.name = "Scene Cut Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Scene Cut"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.scenecut.colour_grade" }
	S.tags = { "w", "scenecut", "composer", "cine" }
	S.description = "Scene Cut Shot Composition: blending of the signals that make up the final shot for the Scene Cut subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.scenecut.shot_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
