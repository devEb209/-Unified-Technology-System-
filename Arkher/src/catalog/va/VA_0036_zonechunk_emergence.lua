-- ARKHER SYSTEM VA.0036 :: Zone Chunk Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0036"
	S.key = "arkher.contworld.zonechunk.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.zonechunk.reality_continuum" }
	S.tags = { "va", "zonechunk", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.zonechunk.emergence_continuum", windowSize = 6, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
