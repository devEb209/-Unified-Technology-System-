-- ARKHER SYSTEM O.0050 :: Explosion Sound Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0050"
	S.key = "arkher.audio.explosionsound.mixer_bus"
	S.name = "Explosion Sound Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.explosionsound.dsp_chain" }
	S.tags = { "o", "explosionsound", "mixer", "audio" }
	S.description = "Explosion Sound Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Explosion Sound subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.explosionsound.mixer_bus", maxVoices = 56 })
		inst.system = S
		inst.ctx = ctx
