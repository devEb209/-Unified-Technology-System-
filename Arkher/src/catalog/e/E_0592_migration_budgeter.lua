-- ARKHER SYSTEM E.0592 :: Material Migration Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0592"
	S.key = "arkher.material.migration.parameter_budget"
	S.name = "Material Migration Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.migration.variant_registry" }
	S.tags = { "e", "migration", "budgeter", "material" }
	S.description = "Material Migration Parameter Budget: texel and layer budget allocation for the Material Migration subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.migration.parameter_budget", total = 441, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
