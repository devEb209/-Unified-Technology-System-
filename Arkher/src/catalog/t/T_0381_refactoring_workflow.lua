-- ARKHER SYSTEM T.0381 :: Refactoring Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0381"
	S.key = "arkher.ai.refactoring.plan_workflow"
	S.name = "Refactoring Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.refactoring.semantic_knowledge" }
	S.tags = { "t", "refactoring", "workflow", "ai" }
	S.description = "Refactoring Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Refactoring subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.refactoring.plan_workflow", maxRetries = 2, budget = 50 })
		inst.system = S
		inst.ctx = ctx
