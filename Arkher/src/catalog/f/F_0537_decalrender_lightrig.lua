-- ARKHER SYSTEM F.0537 :: Decal Rendering Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0537"
	S.key = "arkher.render.decalrender.lighting_rig"
	S.name = "Decal Rendering Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.decalrender.geometry_virtualization" }
	S.tags = { "f", "decalrender", "lightrig", "render" }
	S.description = "Decal Rendering Lighting Rig: light clustering, importance and cascades for the Decal Rendering subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.decalrender.lighting_rig", maxActive = 12 })
		inst.system = S
		inst.ctx = ctx
