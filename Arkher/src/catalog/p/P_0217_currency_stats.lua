-- ARKHER SYSTEM P.0217 :: Currency Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0217"
	S.key = "arkher.play.currency.attributes"
	S.name = "Currency Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Currency"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "currency", "stats", "play" }
	S.description = "Currency Attributes: base values, layered modifiers and derived statistics for the Currency subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.currency.attributes" })
		inst.system = S
		inst.ctx = ctx
