-- ARKHER SYSTEM H.0445 :: Penetration Recovery Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0445"
	S.key = "arkher.physics.penetration.result_cache"
	S.name = "Penetration Recovery Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.penetration.simulation_policy" }
	S.tags = { "h", "penetration", "cache", "physics" }
	S.description = "Penetration Recovery Result Cache: reuse of expensive simulation and query results for the Penetration Recovery subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.penetration.result_cache", policy = "lru", capacity = 403, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
