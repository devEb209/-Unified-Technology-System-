-- ARKHER SYSTEM P.0363 :: Death And Respawn Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0363"
	S.key = "arkher.play.deathrespawn.objectives"
	S.name = "Death And Respawn Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.deathrespawn.inventory" }
	S.tags = { "p", "deathrespawn", "quest", "play" }
	S.description = "Death And Respawn Objectives: objectives, prerequisites, progress and rewards for the Death And Respawn subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.deathrespawn.objectives" })
		inst.system = S
		inst.ctx = ctx
