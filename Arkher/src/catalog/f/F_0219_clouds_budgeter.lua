-- ARKHER SYSTEM F.0219 :: Cloud Rendering Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0219"
	S.key = "arkher.render.clouds.draw_budget"
	S.name = "Cloud Rendering Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.clouds.adaptive_resolution" }
	S.tags = { "f", "clouds", "budgeter", "render" }
	S.description = "Cloud Rendering Draw Budget: draw call and triangle budget allocation for the Cloud Rendering subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.clouds.draw_budget", total = 237, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
