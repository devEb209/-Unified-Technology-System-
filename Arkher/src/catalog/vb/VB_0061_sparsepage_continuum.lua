-- ARKHER SYSTEM VB.0061 :: Sparse Page Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0061"
	S.key = "arkher.conttime.sparsepage.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "sparsepage", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.sparsepage.infinite_grid", cellSize = 64, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
