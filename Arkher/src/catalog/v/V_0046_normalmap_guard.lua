-- ARKHER SYSTEM V.0046 :: Normal Map Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0046"
	S.key = "arkher.asset.normalmap.validation_guard"
	S.name = "Normal Map Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.normalmap.size_budget" }
	S.tags = { "v", "normalmap", "guard", "asset" }
	S.description = "Normal Map Validation Guard: rate limiting and capability checks on the import path for the Normal Map subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.normalmap.validation_guard", algorithm = "token", capacity = 167, refillPerSec = 32, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
