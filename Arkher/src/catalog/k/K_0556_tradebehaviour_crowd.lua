-- ARKHER SYSTEM K.0556 :: Trade Behaviour Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0556"
	S.key = "arkher.npc.tradebehaviour.crowd_steering"
	S.name = "Trade Behaviour Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.tradebehaviour.navigation" }
	S.tags = { "k", "tradebehaviour", "crowd", "npc" }
	S.description = "Trade Behaviour Crowd Steering: local avoidance, cohesion and arrival at scale for the Trade Behaviour subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.tradebehaviour.crowd_steering", radius = 0.75, maxSpeed = 5.70, cellSize = 9 })
		inst.system = S
		inst.ctx = ctx
