-- ARKHER SYSTEM G.0410 :: Drift Detection Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0410"
	S.key = "arkher.neural.drift.reconstruction"
	S.name = "Drift Detection Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.drift.temporal_history" }
	S.tags = { "g", "drift", "upscaler", "neural" }
	S.description = "Drift Detection Reconstruction: resolution ladder and image reconstruction for the Drift Detection subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.drift.reconstruction", targetMs = 11.10, index = 3, sharpness = 0.28 })
		inst.system = S
		inst.ctx = ctx
