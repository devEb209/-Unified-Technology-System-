-- ARKHER SYSTEM L.0519 :: Migration State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0519"
	S.key = "arkher.sim.migration.state_codec"
	S.name = "Migration State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.migration.history_ledger" }
	S.tags = { "l", "migration", "codec", "sim" }
	S.description = "Migration State Codec: persistence, diffing and checksum of the world state for the Migration subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.migration.state_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
