-- ARKHER SYSTEM F.0004 :: Frame Pipeline Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0004"
	S.key = "arkher.render.framepipeline.geometry_virtualization"
	S.name = "Frame Pipeline Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepipeline.visibility_set" }
	S.tags = { "f", "framepipeline", "impostor", "render" }
	S.description = "Frame Pipeline Geometry Virtualization: impostor and HLOD synthesis under a budget for the Frame Pipeline subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.framepipeline.geometry_virtualization", atlasSlots = 80, viewCount = 8, errorThreshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
