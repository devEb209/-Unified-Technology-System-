-- ARKHER SYSTEM R.0218 :: Lag Compensation Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0218"
	S.key = "arkher.net.lagcompensation.time_sync"
	S.name = "Lag Compensation Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.lagcompensation.replication" }
	S.tags = { "r", "lagcompensation", "netclock", "net" }
	S.description = "Lag Compensation Time Sync: offset estimation, outlier rejection and jitter buffering for the Lag Compensation subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.lagcompensation.time_sync", tickRate = 50, bufferDelay = 0.070, maxSamples = 23 })
		inst.system = S
		inst.ctx = ctx
