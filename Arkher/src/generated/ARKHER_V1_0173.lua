--!strict
-- OpenWeather — ANIMATION Map #0173
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="OpenWeather — ANIMATION Map #0173", size=Vector2.new(680, 480), pos=UDim2.fromOffset(349, 161), parent=parent, icon="⬢"})
