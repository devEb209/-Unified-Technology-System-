-- ARKHER SYSTEM O.0016 :: Foley Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0016"
	S.key = "arkher.audio.foley.music_sequencer"
	S.name = "Foley Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Foley"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.foley.spatialization" }
	S.tags = { "o", "foley", "sequencer", "audio" }
	S.description = "Foley Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Foley subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.foley.music_sequencer", bpm = 160, beatsPerBar = 4, intensity = 0.53 })
		inst.system = S
		inst.ctx = ctx
