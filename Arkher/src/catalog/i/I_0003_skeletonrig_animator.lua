-- ARKHER SYSTEM I.0003 :: Skeleton Rig Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0003"
	S.key = "arkher.anim.skeletonrig.layered_blending"
	S.name = "Skeleton Rig Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Skeleton Rig"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.skeletonrig.clip_sampling" }
	S.tags = { "i", "skeletonrig", "animator", "anim" }
	S.description = "Skeleton Rig Layered Blending: layers, crossfades, masks and blend trees for the Skeleton Rig subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.skeletonrig.layered_blending", budget = 9 })
		inst.system = S
		inst.ctx = ctx
