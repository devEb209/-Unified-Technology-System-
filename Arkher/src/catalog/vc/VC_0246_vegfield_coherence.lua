-- ARKHER SYSTEM VC.0246 :: Vegetation Field Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0246"
	S.key = "arkher.contneural.vegfield.coherence_guard"
	S.name = "Vegetation Field Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vegfield.persistent_state" }
	S.tags = { "vc", "vegfield", "coherence", "contneural" }
	S.description = "Vegetation Field Coherence Guard: seam coherence and drift supervision for the Vegetation Field subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.vegfield.coherence_guard", window = 117, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
