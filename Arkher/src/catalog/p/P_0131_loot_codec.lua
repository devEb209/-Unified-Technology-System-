-- ARKHER SYSTEM P.0131 :: Loot Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0131"
	S.key = "arkher.play.loot.save_codec"
	S.name = "Loot Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Loot"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.loot.content_registry" }
	S.tags = { "p", "loot", "codec", "play" }
	S.description = "Loot Save Codec: persistence, diffing and checksum of gameplay state for the Loot subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.loot.save_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
