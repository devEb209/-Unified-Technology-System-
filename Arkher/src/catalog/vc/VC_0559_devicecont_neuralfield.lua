-- ARKHER SYSTEM VC.0559 :: Device Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0559"
	S.key = "arkher.contneural.devicecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.devicecont.coherence_guard" }
	S.tags = { "vc", "devicecont", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.devicecont.neural_field", dims = 12, hidden = 8, seed = 57872 })
		inst.system = S
		inst.ctx = ctx
