-- ARKHER SYSTEM VD.0489 :: Lighting Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0489"
	S.key = "arkher.contsim.lightcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lightcont.world_memory_stream" }
	S.tags = { "vd", "lightcont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.lightcont.complexity_budget", targetMs = 19.0 })
		inst.system = S
		inst.ctx = ctx
