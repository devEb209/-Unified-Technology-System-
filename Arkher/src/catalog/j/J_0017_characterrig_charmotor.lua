-- ARKHER SYSTEM J.0017 :: Character Rig Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0017"
	S.key = "arkher.character.characterrig.locomotion"
	S.name = "Character Rig Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterrig.physical_response" }
	S.tags = { "j", "characterrig", "charmotor", "character" }
	S.description = "Character Rig Locomotion: capsule locomotion driving the character for the Character Rig subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.characterrig.locomotion", radius = 0.54, height = 1.99, maxSpeed = 9.90, jumpHeight = 2.30, stepOffset = 0.54 })
		inst.system = S
		inst.ctx = ctx
