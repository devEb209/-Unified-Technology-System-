-- ARKHER SYSTEM VA.0357 :: Narrative Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0357"
	S.key = "arkher.contworld.narrativecont.complexity_budget"
	S.name = "Narrative Continuum Complexity Budget"
	S.category = "VA"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.narrativecont.world_memory_stream" }
	S.tags = { "va", "narrativecont", "complexity", "contworld" }
	S.description = "Narrative Continuum Complexity Budget: complexity budgeting for the continuum for the Narrative Continuum subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.narrativecont.complexity_budget", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
