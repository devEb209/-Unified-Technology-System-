-- ARKHER SYSTEM VC.0309 :: Weather Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0309"
	S.key = "arkher.contneural.weathercont.complexity_budget"
	S.name = "Weather Continuum Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.weathercont.world_memory_stream" }
	S.tags = { "vc", "weathercont", "complexity", "contneural" }
	S.description = "Weather Continuum Complexity Budget: complexity budgeting for the continuum for the Weather Continuum subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.weathercont.complexity_budget", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
