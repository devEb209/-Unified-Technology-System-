-- ARKHER SYSTEM VC.0001 :: World Grid Cell Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0001"
	S.key = "arkher.contneural.worldcell.infinite_grid"
	S.name = "World Grid Cell Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "worldcell", "continuum", "contneural" }
	S.description = "World Grid Cell Infinite Grid: seamless paging of the infinite world grid for the World Grid Cell subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.worldcell.infinite_grid", cellSize = 128, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
