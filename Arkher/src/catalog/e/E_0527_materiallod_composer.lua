-- ARKHER SYSTEM E.0527 :: Material LOD Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0527"
	S.key = "arkher.material.materiallod.layer_composition"
	S.name = "Material LOD Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Material LOD"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.materiallod.definition" }
	S.tags = { "e", "materiallod", "composer", "material" }
	S.description = "Material LOD Layer Composition: ordered layer composition with blend rules for the Material LOD subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.materiallod.layer_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
