-- ARKHER SYSTEM P.0357 :: Threat Difficulty Controller
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0357"
	S.key = "arkher.play.threat.difficulty_controller"
	S.name = "Threat Difficulty Controller"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Threat"
	...
	S.kit = "controller"
	S.version = "1.0.0"
	S.deps = { "arkher.play.threat.balance_analysis" }
	S.tags = { "p", "threat", "controller", "play" }
	S.description = "Threat Difficulty Controller: closed-loop tuning toward a target challenge for the Threat subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("controller", { id = "arkher.play.threat.difficulty_controller", mode = "bangbang", target = 0.690, kp = 0.340, ki = 0.080, kd = 0.050, min = 0.05, max = 1.0, initial = 0.59, deadband = 0.01 })
		inst.system = S
		inst.ctx = ctx
