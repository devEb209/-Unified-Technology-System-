-- ARKHER SYSTEM G.0427 :: Confidence Gating Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0427"
	S.key = "arkher.neural.confidence.quality_predictor"
	S.name = "Confidence Gating Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.confidence.weight_codec" }
	S.tags = { "g", "confidence", "predictor", "neural" }
	S.description = "Confidence Gating Quality Predictor: predicted quality and cost of a setting for the Confidence Gating subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.confidence.quality_predictor", method = "markov", alpha = 0.43, window = 73 })
		inst.system = S
		inst.ctx = ctx
