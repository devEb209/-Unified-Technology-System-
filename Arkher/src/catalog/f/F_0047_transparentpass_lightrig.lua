-- ARKHER SYSTEM F.0047 :: Transparent Pass Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0047"
	S.key = "arkher.render.transparentpass.lighting_rig"
	S.name = "Transparent Pass Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.transparentpass.geometry_virtualization" }
	S.tags = { "f", "transparentpass", "lightrig", "render" }
	S.description = "Transparent Pass Lighting Rig: light clustering, importance and cascades for the Transparent Pass subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.transparentpass.lighting_rig", maxActive = 7 })
		inst.system = S
		inst.ctx = ctx
