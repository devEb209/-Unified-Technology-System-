-- ARKHER SYSTEM V.0098 :: Music Track Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0098"
	S.key = "arkher.asset.musictrack.bundling"
	S.name = "Music Track Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.musictrack.import" }
	S.tags = { "v", "musictrack", "bundler", "asset" }
	S.description = "Music Track Bundling: size-bounded packing, manifests and delta patches for the Music Track subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.musictrack.bundling", maxBundleBytes = 262144 })
		inst.system = S
		inst.ctx = ctx
