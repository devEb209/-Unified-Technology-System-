-- ARKHER SYSTEM F.0181 :: Atmosphere Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0181"
	S.key = "arkher.render.atmosphere.orchestration"
	S.name = "Atmosphere Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Atmosphere"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.atmosphere.frame_analysis" }
	S.tags = { "f", "atmosphere", "orchestrator", "render" }
	S.description = "Atmosphere Orchestration: frame lifecycle orchestration for the Atmosphere subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.atmosphere.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
