-- ARKHER SYSTEM Z.0048 :: Singularity World Architect Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0048"
	S.key = "arkher.origin.worldarchitect.semantic_graph"
	S.name = "Singularity World Architect Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.world_architect" }
	S.tags = { "z", "worldarchitect", "knowledge", "origin" }
	S.description = "Singularity World Architect Semantic Graph: typed entities and inferred relations of the technology itself for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.worldarchitect.semantic_graph", dims = 16 })
		inst.system = S
		inst.ctx = ctx
