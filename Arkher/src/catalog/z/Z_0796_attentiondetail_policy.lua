-- ARKHER SYSTEM Z.0796 :: Attention Driven Detail Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0796"
	S.key = "arkher.origin.attentiondetail.governance_policy"
	S.name = "Attention Driven Detail Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.signal_composition" }
	S.tags = { "z", "attentiondetail", "policy", "origin" }
	S.description = "Attention Driven Detail Governance Policy: ordered rules governing when the technology may act for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.attentiondetail.governance_policy", algorithm = "lottery", starvationGuard = 23 })
		inst.system = S
		inst.ctx = ctx
