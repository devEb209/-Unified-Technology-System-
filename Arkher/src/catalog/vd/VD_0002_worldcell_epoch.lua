-- ARKHER SYSTEM VD.0002 :: World Grid Cell Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0002"
	S.key = "arkher.contsim.worldcell.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldcell.infinite_grid" }
	S.tags = { "vd", "worldcell", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.worldcell.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
