-- ARKHER SYSTEM L.0089 :: Cohort Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0089"
	S.key = "arkher.sim.cohort.forecast"
	S.name = "Cohort Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.cohort.analysis" }
	S.tags = { "l", "cohort", "predictor", "sim" }
	S.description = "Cohort Forecast: prediction of the region's next state for the Cohort subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.cohort.forecast", method = "linear", alpha = 0.31, window = 45 })
		inst.system = S
		inst.ctx = ctx
