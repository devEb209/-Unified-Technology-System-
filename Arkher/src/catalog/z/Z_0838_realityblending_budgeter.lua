-- ARKHER SYSTEM Z.0838 :: Reality Blending Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0838"
	S.key = "arkher.origin.realityblending.budget_governor"
	S.name = "Reality Blending Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.behaviour_analysis" }
	S.tags = { "z", "realityblending", "budgeter", "origin" }
	S.description = "Reality Blending Budget Governor: allocation of a scarce resource across the technology's consumers for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.realityblending.budget_governor", total = 135, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
