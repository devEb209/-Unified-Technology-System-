-- ARKHER SYSTEM VA.0546 :: World Fabric Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0546"
	S.key = "arkher.contworld.worldfabric.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldfabric.persistent_state" }
	S.tags = { "va", "worldfabric", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.worldfabric.coherence_guard", window = 62, threshold = 0.10 })
		inst.system = S
		inst.ctx = ctx
