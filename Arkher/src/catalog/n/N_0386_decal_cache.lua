-- ARKHER SYSTEM N.0386 :: Decal Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0386"
	S.key = "arkher.vfx.decal.result_cache"
	S.name = "Decal Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Decal"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.decal.spawn_budget" }
	S.tags = { "n", "decal", "cache", "vfx" }
	S.description = "Decal Result Cache: reuse of expensive effect evaluations for the Decal subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.decal.result_cache", policy = "lfu", capacity = 502, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
