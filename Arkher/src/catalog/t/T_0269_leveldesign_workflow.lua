-- ARKHER SYSTEM T.0269 :: Level Design Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0269"
	S.key = "arkher.ai.leveldesign.plan_workflow"
	S.name = "Level Design Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.leveldesign.semantic_knowledge" }
	S.tags = { "t", "leveldesign", "workflow", "ai" }
	S.description = "Level Design Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Level Design subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.leveldesign.plan_workflow", maxRetries = 3, budget = 60 })
		inst.system = S
		inst.ctx = ctx
