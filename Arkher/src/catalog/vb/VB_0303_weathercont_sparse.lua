-- ARKHER SYSTEM VB.0303 :: Weather Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0303"
	S.key = "arkher.conttime.weathercont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.weathercont.epoch_clock" }
	S.tags = { "vb", "weathercont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.weathercont.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
