-- ARKHER SYSTEM H.0673 :: Shapecast Query Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0673"
	S.key = "arkher.physics.shapecast.body_dynamics"
	S.name = "Shapecast Query Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "shapecast", "rigidbody", "physics" }
	S.description = "Shapecast Query Body Dynamics: integration, impulses, damping and sleeping of a body for the Shapecast Query subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.shapecast.body_dynamics", mass = 23.00, radius = 0.40, restitution = 0.22, friction = 0.42, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
