-- ARKHER SYSTEM N.0240 :: Spell Cast Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0240"
	S.key = "arkher.vfx.spellcast.effect_graph"
	S.name = "Spell Cast Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spell Cast"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spellcast.curve_authoring" }
	S.tags = { "n", "spellcast", "shadegraph", "vfx" }
	S.description = "Spell Cast Effect Graph: node graph describing how the effect is shaded for the Spell Cast subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.spellcast.effect_graph" })
		inst.system = S
		inst.ctx = ctx
