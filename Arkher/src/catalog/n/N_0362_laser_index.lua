-- ARKHER SYSTEM N.0362 :: Laser Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0362"
	S.key = "arkher.vfx.laser.spatial_index"
	S.name = "Laser Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Laser"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.laser.quality_policy" }
	S.tags = { "n", "laser", "index", "vfx" }
	S.description = "Laser Spatial Index: spatial acceleration of effect queries and culling for the Laser subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.laser.spatial_index", mode = "hash", cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
