-- ARKHER SYSTEM F.0195 :: Sky Model Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0195"
	S.key = "arkher.render.sky.orchestration"
	S.name = "Sky Model Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sky Model"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sky.frame_analysis" }
	S.tags = { "f", "sky", "orchestrator", "render" }
	S.description = "Sky Model Orchestration: frame lifecycle orchestration for the Sky Model subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.sky.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
