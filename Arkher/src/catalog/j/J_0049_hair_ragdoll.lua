-- ARKHER SYSTEM J.0049 :: Hair Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0049"
	S.key = "arkher.character.hair.physical_response"
	S.name = "Hair Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.hair.look_and_reach" }
	S.tags = { "j", "hair", "ragdoll", "character" }
	S.description = "Hair Physical Response: physical reaction, ragdoll and recovery for the Hair subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.hair.physical_response", blendSpeed = 4.30 })
		inst.system = S
		inst.ctx = ctx
