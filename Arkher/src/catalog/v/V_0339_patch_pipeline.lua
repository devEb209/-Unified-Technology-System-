-- ARKHER SYSTEM V.0339 :: Patch Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0339"
	S.key = "arkher.asset.patch.cook_pipeline"
	S.name = "Patch Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.patch.bundling" }
	S.tags = { "v", "patch", "pipeline", "asset" }
	S.description = "Patch Cook Pipeline: staged cooking with isolation and retries for the Patch subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.patch.cook_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
