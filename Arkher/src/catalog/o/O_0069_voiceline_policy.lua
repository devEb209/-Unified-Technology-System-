-- ARKHER SYSTEM O.0069 :: Voice Line Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0069"
	S.key = "arkher.audio.voiceline.playback_policy"
	S.name = "Voice Line Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Voice Line"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.voiceline.compression_codec" }
	S.tags = { "o", "voiceline", "policy", "audio" }
	S.description = "Voice Line Playback Policy: rules choosing what may be heard right now for the Voice Line subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.voiceline.playback_policy", algorithm = "wfq", starvationGuard = 54 })
		inst.system = S
		inst.ctx = ctx
