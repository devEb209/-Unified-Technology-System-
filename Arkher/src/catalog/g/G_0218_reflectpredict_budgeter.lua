-- ARKHER SYSTEM G.0218 :: Reflection Prediction Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0218"
	S.key = "arkher.neural.reflectpredict.compute_budget"
	S.name = "Reflection Prediction Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.reflectpredict.quality_predictor" }
	S.tags = { "g", "reflectpredict", "budgeter", "neural" }
	S.description = "Reflection Prediction Compute Budget: inference time budget allocation for the Reflection Prediction subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.reflectpredict.compute_budget", total = 140, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
