-- ARKHER SYSTEM P.0437 :: Matchmaking State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0437"
	S.key = "arkher.play.matchmaking.state_machine"
	S.name = "Matchmaking State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Matchmaking"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.matchmaking.combat_resolution" }
	S.tags = { "p", "matchmaking", "orchestrator", "play" }
	S.description = "Matchmaking State Machine: the phase machine that drives this gameplay loop for the Matchmaking subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.matchmaking.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
