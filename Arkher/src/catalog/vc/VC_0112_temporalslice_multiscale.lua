-- ARKHER SYSTEM VC.0112 :: Temporal Slice Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VC.0112"
	S.key = "arkher.contneural.temporalslice.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.temporalslice.sparse_residency" }
	S.tags = { "vc", "temporalslice", "multiscale", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contneural.temporalslice.multi-scale_fidelity", levels = 5, baseTriangles = 105000 })
		inst.system = S
		inst.ctx = ctx
