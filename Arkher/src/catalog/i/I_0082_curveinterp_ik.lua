-- ARKHER SYSTEM I.0082 :: Curve Interpolation Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0082"
	S.key = "arkher.anim.curveinterp.inverse_kinematics"
	S.name = "Curve Interpolation Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.curveinterp.layered_blending" }
	S.tags = { "i", "curveinterp", "ik", "anim" }
	S.description = "Curve Interpolation Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Curve Interpolation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.curveinterp.inverse_kinematics", iterations = 7, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
