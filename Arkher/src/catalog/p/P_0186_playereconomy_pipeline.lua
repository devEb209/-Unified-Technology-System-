-- ARKHER SYSTEM P.0186 :: Economy Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0186"
	S.key = "arkher.play.playereconomy.rule_pipeline"
	S.name = "Economy Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Economy"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playereconomy.state_machine" }
	S.tags = { "p", "playereconomy", "pipeline", "play" }
	S.description = "Economy Rule Pipeline: ordered rules applied to every gameplay event for the Economy subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.playereconomy.rule_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
