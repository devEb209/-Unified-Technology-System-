-- ARKHER SYSTEM N.0438 :: Cloth Wind Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0438"
	S.key = "arkher.vfx.clothwind.result_cache"
	S.name = "Cloth Wind Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloth Wind"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.clothwind.spawn_budget" }
	S.tags = { "n", "clothwind", "cache", "vfx" }
	S.description = "Cloth Wind Result Cache: reuse of expensive effect evaluations for the Cloth Wind subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.clothwind.result_cache", policy = "ttl", capacity = 202, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
