-- ARKHER SYSTEM VA.0633 :: Interest Field Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0633"
	S.key = "arkher.contworld.interestfield.complexity_budget"
	S.name = "Interest Field Complexity Budget"
	S.category = "VA"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.interestfield.world_memory_stream" }
	S.tags = { "va", "interestfield", "complexity", "contworld" }
	S.description = "Interest Field Complexity Budget: complexity budgeting for the continuum for the Interest Field subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.interestfield.complexity_budget", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
