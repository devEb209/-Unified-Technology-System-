-- ARKHER SYSTEM N.0303 :: Status Effect Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0303"
	S.key = "arkher.vfx.statusfx.ribbon_and_trail"
	S.name = "Status Effect Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.statusfx.force_field" }
	S.tags = { "n", "statusfx", "ribbon", "vfx" }
	S.description = "Status Effect Ribbon And Trail: trail points, tapering, beams and decimation for the Status Effect subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.statusfx.ribbon_and_trail", maxPoints = 48, lifetime = 2.30, minDistance = 0.50, width = 1.20 })
		inst.system = S
		inst.ctx = ctx
