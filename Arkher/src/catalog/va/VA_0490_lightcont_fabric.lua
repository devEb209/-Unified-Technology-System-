-- ARKHER SYSTEM VA.0490 :: Lighting Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0490"
	S.key = "arkher.contworld.lightcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lightcont.complexity_budget" }
	S.tags = { "va", "lightcont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.lightcont.simulation_fabric", budgetMs = 4.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
