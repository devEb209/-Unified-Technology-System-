-- ARKHER SYSTEM H.0039 :: Kinematic Body Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0039"
	S.key = "arkher.physics.kinematicbody.result_cache"
	S.name = "Kinematic Body Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.kinematicbody.simulation_policy" }
	S.tags = { "h", "kinematicbody", "cache", "physics" }
	S.description = "Kinematic Body Result Cache: reuse of expensive simulation and query results for the Kinematic Body subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.kinematicbody.result_cache", policy = "lfu", capacity = 218, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
