-- ARKHER SYSTEM VD.0417 :: Behaviour Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0417"
	S.key = "arkher.contsim.behaviourcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.behaviourcont.world_memory_stream" }
	S.tags = { "vd", "behaviourcont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.behaviourcont.complexity_budget", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
