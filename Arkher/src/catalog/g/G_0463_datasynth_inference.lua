-- ARKHER SYSTEM G.0463 :: Training Data Synthesis Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0463"
	S.key = "arkher.neural.datasynth.inference_core"
	S.name = "Training Data Synthesis Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "datasynth", "inference", "neural" }
	S.description = "Training Data Synthesis Inference Core: dense network forward pass and training for the Training Data Synthesis subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.datasynth.inference_core", seed = 53115 })
		inst.system = S
		inst.ctx = ctx
