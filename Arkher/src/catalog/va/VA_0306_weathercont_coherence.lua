-- ARKHER SYSTEM VA.0306 :: Weather Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0306"
	S.key = "arkher.contworld.weathercont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.weathercont.persistent_state" }
	S.tags = { "va", "weathercont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.weathercont.coherence_guard", window = 112, threshold = 0.10 })
		inst.system = S
		inst.ctx = ctx
