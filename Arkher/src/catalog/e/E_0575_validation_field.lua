-- ARKHER SYSTEM E.0575 :: Material Validation Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0575"
	S.key = "arkher.material.validation.procedural_detail"
	S.name = "Material Validation Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.validation.texture_sampling" }
	S.tags = { "e", "validation", "field", "material" }
	S.description = "Material Validation Procedural Detail: coherent noise detail driving the surface for the Material Validation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.validation.procedural_detail", seed = 16931, frequency = 0.0067, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
