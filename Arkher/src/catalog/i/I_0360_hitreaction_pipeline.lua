-- ARKHER SYSTEM I.0360 :: Hit Reaction Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0360"
	S.key = "arkher.anim.hitreaction.playback_pipeline"
	S.name = "Hit Reaction Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Hit Reaction"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.hitreaction.event_ledger" }
	S.tags = { "i", "hitreaction", "pipeline", "anim" }
	S.description = "Hit Reaction Playback Pipeline: ordered sample, blend, ik and output stages for the Hit Reaction subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.hitreaction.playback_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
