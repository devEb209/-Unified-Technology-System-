-- ARKHER SYSTEM VA.0153 :: Persistence Segment Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0153"
	S.key = "arkher.contworld.persistsegment.complexity_budget"
	S.name = "Persistence Segment Complexity Budget"
	S.category = "VA"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.persistsegment.world_memory_stream" }
	S.tags = { "va", "persistsegment", "complexity", "contworld" }
	S.description = "Persistence Segment Complexity Budget: complexity budgeting for the continuum for the Persistence Segment subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.persistsegment.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
