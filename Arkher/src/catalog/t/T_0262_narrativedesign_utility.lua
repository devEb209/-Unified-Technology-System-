-- ARKHER SYSTEM T.0262 :: Narrative Design Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0262"
	S.key = "arkher.ai.narrativedesign.utility_selection"
	S.name = "Narrative Design Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.narrativedesign.working_memory" }
	S.tags = { "t", "narrativedesign", "utility", "ai" }
	S.description = "Narrative Design Utility Selection: scored choice between competing courses of action for the Narrative Design subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.narrativedesign.utility_selection", momentum = 0.05 })
		inst.system = S
		inst.ctx = ctx
