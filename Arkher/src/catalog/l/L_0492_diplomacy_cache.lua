-- ARKHER SYSTEM L.0492 :: Diplomacy Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0492"
	S.key = "arkher.sim.diplomacy.aggregate_cache"
	S.name = "Diplomacy Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.diplomacy.fidelity_policy" }
	S.tags = { "l", "diplomacy", "cache", "sim" }
	S.description = "Diplomacy Aggregate Cache: reuse of expensive aggregate computations for the Diplomacy subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.diplomacy.aggregate_cache", policy = "lfu", capacity = 179, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
