-- ARKHER SYSTEM VC.0248 :: Vegetation Field World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0248"
	S.key = "arkher.contneural.vegfield.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vegfield.neural_field" }
	S.tags = { "vc", "vegfield", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.vegfield.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
