-- ARKHER SYSTEM VB.0505 :: Material Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0505"
	S.key = "arkher.conttime.materialcont.infinite_grid"
	S.name = "Material Continuum Infinite Grid"
	S.category = "VB"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "materialcont", "continuum", "conttime" }
	S.description = "Material Continuum Infinite Grid: seamless paging of the infinite world grid for the Material Continuum subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.materialcont.infinite_grid", cellSize = 160, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
