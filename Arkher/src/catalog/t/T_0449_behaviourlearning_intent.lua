-- ARKHER SYSTEM T.0449 :: Behaviour Learning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0449"
	S.key = "arkher.ai.behaviourlearning.intent_understanding"
	S.name = "Behaviour Learning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "behaviourlearning", "intent", "ai" }
	S.description = "Behaviour Learning Intent Understanding: natural language turned into an actionable, scored intent for the Behaviour Learning subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.behaviourlearning.intent_understanding", minConfidence = 0.33 })
		inst.system = S
		inst.ctx = ctx
