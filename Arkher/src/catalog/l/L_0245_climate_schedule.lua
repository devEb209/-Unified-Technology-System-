-- ARKHER SYSTEM L.0245 :: Climate Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0245"
	S.key = "arkher.sim.climate.calendar"
	S.name = "Climate Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.climate.society" }
	S.tags = { "l", "climate", "schedule", "sim" }
	S.description = "Climate Calendar: hours, days and seasons driving the region for the Climate subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.climate.calendar", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
