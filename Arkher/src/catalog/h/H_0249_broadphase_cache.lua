-- ARKHER SYSTEM H.0249 :: Broadphase Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0249"
	S.key = "arkher.physics.broadphase.result_cache"
	S.name = "Broadphase Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Broadphase"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.broadphase.simulation_policy" }
	S.tags = { "h", "broadphase", "cache", "physics" }
	S.description = "Broadphase Result Cache: reuse of expensive simulation and query results for the Broadphase subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.broadphase.result_cache", policy = "ttl", capacity = 454, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
