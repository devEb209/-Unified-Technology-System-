-- ARKHER SYSTEM Z.0592 :: Self Healing Systems Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0592"
	S.key = "arkher.origin.selfhealing.predictive_optimization"
	S.name = "Self Healing Systems Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfhealing.adaptive_workflow" }
	S.tags = { "z", "selfhealing", "predictor", "origin" }
	S.description = "Self Healing Systems Predictive Optimization: forecast-driven optimization before the cost is paid for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.selfhealing.predictive_optimization", method = "markov", alpha = 0.47, window = 109 })
		inst.system = S
		inst.ctx = ctx
