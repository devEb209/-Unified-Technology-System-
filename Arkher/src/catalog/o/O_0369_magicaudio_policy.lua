-- ARKHER SYSTEM O.0369 :: Magic Audio Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0369"
	S.key = "arkher.audio.magicaudio.playback_policy"
	S.name = "Magic Audio Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Magic Audio"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.magicaudio.compression_codec" }
	S.tags = { "o", "magicaudio", "policy", "audio" }
	S.description = "Magic Audio Playback Policy: rules choosing what may be heard right now for the Magic Audio subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.magicaudio.playback_policy", algorithm = "roundrobin", starvationGuard = 44 })
		inst.system = S
		inst.ctx = ctx
