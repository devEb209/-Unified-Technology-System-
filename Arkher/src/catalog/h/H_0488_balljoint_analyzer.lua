-- ARKHER SYSTEM H.0488 :: Ball Joint Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0488"
	S.key = "arkher.physics.balljoint.analysis"
	S.name = "Ball Joint Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Ball Joint"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.balljoint.result_cache" }
	S.tags = { "h", "balljoint", "analyzer", "physics" }
	S.description = "Ball Joint Analysis: energy, jitter and cost analysis of the simulation for the Ball Joint subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.balljoint.analysis", window = 219, buckets = 19, threshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
