-- ARKHER SYSTEM H.0300 :: Capsule Collider Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0300"
	S.key = "arkher.physics.capsulecollider.character_motion"
	S.name = "Capsule Collider Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.capsulecollider.query" }
	S.tags = { "h", "capsulecollider", "charmotor", "physics" }
	S.description = "Capsule Collider Character Motion: capsule move-and-slide with slopes, steps and jumps for the Capsule Collider subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.capsulecollider.character_motion", radius = 0.53, height = 1.98, maxSpeed = 5.80, jumpHeight = 1.80, stepOffset = 0.43 })
		inst.system = S
		inst.ctx = ctx
