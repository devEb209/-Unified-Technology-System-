-- ARKHER SYSTEM F.0455 :: Frustum Culling Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0455"
	S.key = "arkher.render.frustum.temporal_resolve"
	S.name = "Frustum Culling Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.frustum.probe_volume" }
	S.tags = { "f", "frustum", "temporal", "render" }
	S.description = "Frustum Culling Temporal Resolve: history reprojection with neighbourhood clamping for the Frustum Culling subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.frustum.temporal_resolve", feedback = 0.92, phase = 8 })
		inst.system = S
		inst.ctx = ctx
