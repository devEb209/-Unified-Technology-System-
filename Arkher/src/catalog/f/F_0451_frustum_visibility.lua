-- ARKHER SYSTEM F.0451 :: Frustum Culling Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0451"
	S.key = "arkher.render.frustum.visibility_set"
	S.name = "Frustum Culling Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.frustum.view_and_culling" }
	S.tags = { "f", "frustum", "visibility", "render" }
	S.description = "Frustum Culling Visibility Set: cell, portal and occluder visibility for the Frustum Culling subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.frustum.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
