-- ARKHER SYSTEM VD.0506 :: Material Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0506"
	S.key = "arkher.contsim.materialcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.materialcont.infinite_grid" }
	S.tags = { "vd", "materialcont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.materialcont.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
