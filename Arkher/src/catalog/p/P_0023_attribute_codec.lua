-- ARKHER SYSTEM P.0023 :: Attribute Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0023"
	S.key = "arkher.play.attribute.save_codec"
	S.name = "Attribute Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Attribute"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.attribute.content_registry" }
	S.tags = { "p", "attribute", "codec", "play" }
	S.description = "Attribute Save Codec: persistence, diffing and checksum of gameplay state for the Attribute subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.attribute.save_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
