-- ARKHER SYSTEM P.0422 :: Party Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0422"
	S.key = "arkher.play.party.inventory"
	S.name = "Party Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Party"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.party.attributes" }
	S.tags = { "p", "party", "inventory", "play" }
	S.description = "Party Inventory: slots, stacking, weight, equipment and crafting for the Party subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.party.inventory", slots = 12, maxWeight = 40 })
		inst.system = S
		inst.ctx = ctx
