-- ARKHER SYSTEM Q.0242 :: Map Screen Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0242"
	S.key = "arkher.ui.mapscreen.widget_tree"
	S.name = "Map Screen Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Map Screen"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.mapscreen.responsive_layout" }
	S.tags = { "q", "mapscreen", "widget", "ui" }
	S.description = "Map Screen Widget Tree: retained widget nodes, properties, bindings and rendering for the Map Screen subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.mapscreen.widget_tree", theme = "light", scale = 0.78 })
		inst.system = S
		inst.ctx = ctx
