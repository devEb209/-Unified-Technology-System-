-- ARKHER SYSTEM H.0535 :: Rope Simulation Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0535"
	S.key = "arkher.physics.rope.contact_generation"
	S.name = "Rope Simulation Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rope.collision_shape" }
	S.tags = { "h", "rope", "contact", "physics" }
	S.description = "Rope Simulation Contact Generation: narrow-phase manifolds with normal, depth and point for the Rope Simulation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.rope.contact_generation", slop = 0.0070, maxManifolds = 420 })
		inst.system = S
		inst.ctx = ctx
