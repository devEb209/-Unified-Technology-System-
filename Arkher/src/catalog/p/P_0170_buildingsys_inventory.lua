-- ARKHER SYSTEM P.0170 :: Building Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0170"
	S.key = "arkher.play.buildingsys.inventory"
	S.name = "Building Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Building"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.buildingsys.attributes" }
	S.tags = { "p", "buildingsys", "inventory", "play" }
	S.description = "Building Inventory: slots, stacking, weight, equipment and crafting for the Building subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.buildingsys.inventory", slots = 32, maxWeight = 130 })
		inst.system = S
		inst.ctx = ctx
