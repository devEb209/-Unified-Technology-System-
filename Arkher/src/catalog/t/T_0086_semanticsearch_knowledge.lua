-- ARKHER SYSTEM T.0086 :: Semantic Search Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0086"
	S.key = "arkher.ai.semanticsearch.semantic_knowledge"
	S.name = "Semantic Search Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.semanticsearch.intent_understanding" }
	S.tags = { "t", "semanticsearch", "knowledge", "ai" }
	S.description = "Semantic Search Semantic Knowledge: typed entities, weighted relations and inferred closure for the Semantic Search subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.semanticsearch.semantic_knowledge", dims = 16 })
		inst.system = S
		inst.ctx = ctx
