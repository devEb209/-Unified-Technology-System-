-- ARKHER SYSTEM O.0101 :: Crowd Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0101"
	S.key = "arkher.audio.crowd.voice_budget"
	S.name = "Crowd Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Crowd"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.crowd.music_sequencer" }
	S.tags = { "o", "crowd", "budgeter", "audio" }
	S.description = "Crowd Voice Budget: voice slots allocated by priority and audibility for the Crowd subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.crowd.voice_budget", total = 445, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
