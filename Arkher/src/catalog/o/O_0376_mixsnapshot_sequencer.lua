-- ARKHER SYSTEM O.0376 :: Mix Snapshot Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0376"
	S.key = "arkher.audio.mixsnapshot.music_sequencer"
	S.name = "Mix Snapshot Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mix Snapshot"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mixsnapshot.spatialization" }
	S.tags = { "o", "mixsnapshot", "sequencer", "audio" }
	S.description = "Mix Snapshot Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Mix Snapshot subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.mixsnapshot.music_sequencer", bpm = 120, beatsPerBar = 4, intensity = 0.49 })
		inst.system = S
		inst.ctx = ctx
