-- ARKHER SYSTEM T.0407 :: Device Reasoning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0407"
	S.key = "arkher.ai.devicereasoning.intent_understanding"
	S.name = "Device Reasoning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "devicereasoning", "intent", "ai" }
	S.description = "Device Reasoning Intent Understanding: natural language turned into an actionable, scored intent for the Device Reasoning subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.devicereasoning.intent_understanding", minConfidence = 0.42 })
		inst.system = S
		inst.ctx = ctx
