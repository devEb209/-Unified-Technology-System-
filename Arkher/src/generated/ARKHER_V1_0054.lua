...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Unity6 URP — CORE Profiler #0054", size=Vector2.new(600, 500), pos=UDim2.fromOffset(402, 218), parent=parent, icon="⬔"})
...
Components.TextField(right, "File", "input.png", function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_File"..54, v) end end)
