-- ARKHER SYSTEM VC.0620 :: Occupancy Map World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0620"
	S.key = "arkher.contneural.occupancymap.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.occupancymap.neural_field" }
	S.tags = { "vc", "occupancymap", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.occupancymap.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
