-- ARKHER SYSTEM E.0093 :: Height Displacement Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0093"
	S.key = "arkher.material.displacement.shading_graph"
	S.name = "Height Displacement Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.displacement.layer_composition" }
	S.tags = { "e", "displacement", "shadegraph", "material" }
	S.description = "Height Displacement Shading Graph: node graph evaluated and compiled to Luau for the Height Displacement subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.displacement.shading_graph" })
		inst.system = S
		inst.ctx = ctx
