-- ARKHER SYSTEM I.0433 :: Crowd Animation Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0433"
	S.key = "arkher.anim.crowdanim.inverse_kinematics"
	S.name = "Crowd Animation Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crowdanim.layered_blending" }
	S.tags = { "i", "crowdanim", "ik", "anim" }
	S.description = "Crowd Animation Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Crowd Animation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.crowdanim.inverse_kinematics", iterations = 11, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
