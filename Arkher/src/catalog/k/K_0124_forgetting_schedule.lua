-- ARKHER SYSTEM K.0124 :: Forgetting Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0124"
	S.key = "arkher.npc.forgetting.daily_schedule"
	S.name = "Forgetting Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.forgetting.social_relations" }
	S.tags = { "k", "forgetting", "schedule", "npc" }
	S.description = "Forgetting Daily Schedule: hour-by-hour routine with priority interruptions for the Forgetting subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.forgetting.daily_schedule", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
