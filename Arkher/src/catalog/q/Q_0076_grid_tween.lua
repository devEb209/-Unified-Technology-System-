-- ARKHER SYSTEM Q.0076 :: Grid Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0076"
	S.key = "arkher.ui.grid.transition"
	S.name = "Grid Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Grid"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.grid.input_mapping" }
	S.tags = { "q", "grid", "tween", "ui" }
	S.description = "Grid Transition: eased, delayed, looped and sequenced motion for the Grid subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.grid.transition", timeScale = 0.94 })
		inst.system = S
		inst.ctx = ctx
