-- ARKHER SYSTEM P.0152 :: Crafting Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0152"
	S.key = "arkher.play.crafting.balance_analysis"
	S.name = "Crafting Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Crafting"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.crafting.event_ledger" }
	S.tags = { "p", "crafting", "analyzer", "play" }
	S.description = "Crafting Balance Analysis: distribution, outlier and pacing analysis for the Crafting subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.crafting.balance_analysis", window = 153, buckets = 9, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
