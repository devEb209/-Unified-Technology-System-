-- ARKHER SYSTEM Q.0400 :: UI Debug Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0400"
	S.key = "arkher.ui.uidebug.transition"
	S.name = "UI Debug Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "UI Debug"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uidebug.input_mapping" }
	S.tags = { "q", "uidebug", "tween", "ui" }
	S.description = "UI Debug Transition: eased, delayed, looped and sequenced motion for the UI Debug subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.uidebug.transition", timeScale = 0.98 })
		inst.system = S
		inst.ctx = ctx
