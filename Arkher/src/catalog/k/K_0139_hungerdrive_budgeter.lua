-- ARKHER SYSTEM K.0139 :: Hunger Drive Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0139"
	S.key = "arkher.npc.hungerdrive.thinking_budget"
	S.name = "Hunger Drive Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hungerdrive.daily_schedule" }
	S.tags = { "k", "hungerdrive", "budgeter", "npc" }
	S.description = "Hunger Drive Thinking Budget: allocation of per-frame thinking time across NPCs for the Hunger Drive subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.hungerdrive.thinking_budget", total = 289, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
