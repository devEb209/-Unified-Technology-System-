-- ARKHER SYSTEM VD.0231 :: City Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0231"
	S.key = "arkher.contsim.citycont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.citycont.epoch_clock" }
	S.tags = { "vd", "citycont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.citycont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
