-- ARKHER SYSTEM O.0002 :: Footstep Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0002"
	S.key = "arkher.audio.footstep.mixer_bus"
	S.name = "Footstep Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Footstep"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.footstep.dsp_chain" }
	S.tags = { "o", "footstep", "mixer", "audio" }
	S.description = "Footstep Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Footstep subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.footstep.mixer_bus", maxVoices = 24 })
		inst.system = S
		inst.ctx = ctx
