-- ARKHER SYSTEM VC.0104 :: Memory Shard World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0104"
	S.key = "arkher.contneural.memoryshard.world_memory_stream"
	S.name = "Memory Shard World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memoryshard.neural_field" }
	S.tags = { "vc", "memoryshard", "worldmemory", "contneural" }
	S.description = "Memory Shard World Memory Stream: world memory continuum over epochs for the Memory Shard subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.memoryshard.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
