-- ARKHER SYSTEM O.0186 :: Interior Audio Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0186"
	S.key = "arkher.audio.interioraudio.streaming"
	S.name = "Interior Audio Streaming"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.interioraudio.voice_budget" }
	S.tags = { "o", "interioraudio", "streamer", "audio" }
	S.description = "Interior Audio Streaming: distance-driven residency of audio assets for the Interior Audio subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.interioraudio.streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
