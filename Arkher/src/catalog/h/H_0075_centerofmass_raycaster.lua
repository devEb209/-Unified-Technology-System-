-- ARKHER SYSTEM H.0075 :: Center Of Mass Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0075"
	S.key = "arkher.physics.centerofmass.query"
	S.name = "Center Of Mass Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.centerofmass.constraint_solver" }
	S.tags = { "h", "centerofmass", "raycaster", "physics" }
	S.description = "Center Of Mass Query: rays, sweeps and overlaps against the simulation for the Center Of Mass subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.centerofmass.query", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
