-- ARKHER SYSTEM K.0068 :: Episodic Memory Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0068"
	S.key = "arkher.npc.episodicmemory.daily_schedule"
	S.name = "Episodic Memory Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.episodicmemory.social_relations" }
	S.tags = { "k", "episodicmemory", "schedule", "npc" }
	S.description = "Episodic Memory Daily Schedule: hour-by-hour routine with priority interruptions for the Episodic Memory subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.episodicmemory.daily_schedule", startHour = 6 })
		inst.system = S
		inst.ctx = ctx
