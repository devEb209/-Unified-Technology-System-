-- ARKHER SYSTEM V.0282 :: Impostor Asset Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0282"
	S.key = "arkher.asset.impostorasset.content_cache"
	S.name = "Impostor Asset Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.impostorasset.dependency_graph" }
	S.tags = { "v", "impostorasset", "cache", "asset" }
	S.description = "Impostor Asset Content Cache: reuse of already cooked results for the Impostor Asset subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.impostorasset.content_cache", policy = "lfu", capacity = 256, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
