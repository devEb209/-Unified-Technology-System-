-- ARKHER SYSTEM Z.1075 :: World Dream State Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.1075"
	S.key = "arkher.origin.worlddream.signal_composition"
	S.name = "World Dream State Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.telemetry_ledger" }
	S.tags = { "z", "worlddream", "composer", "origin" }
	S.description = "World Dream State Signal Composition: blending of the technology's input signals into one output for the World Dream State subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.worlddream.signal_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
