-- ARKHER SYSTEM VA.0278 :: Water Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0278"
	S.key = "arkher.contworld.watercont.epoch_clock"
	S.name = "Water Continuum Epoch Clock"
	S.category = "VA"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.watercont.infinite_grid" }
	S.tags = { "va", "watercont", "epoch", "contworld" }
	S.description = "Water Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Water Continuum subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.watercont.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
