-- ARKHER SYSTEM I.0225 :: Root Motion Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0225"
	S.key = "arkher.anim.rootmotion.inverse_kinematics"
	S.name = "Root Motion Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Root Motion"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.rootmotion.layered_blending" }
	S.tags = { "i", "rootmotion", "ik", "anim" }
	S.description = "Root Motion Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Root Motion subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.rootmotion.inverse_kinematics", iterations = 9, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
