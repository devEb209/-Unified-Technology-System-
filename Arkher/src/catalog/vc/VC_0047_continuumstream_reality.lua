-- ARKHER SYSTEM VC.0047 :: Continuum Stream Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0047"
	S.key = "arkher.contneural.continuumstream.reality_continuum"
	S.name = "Continuum Stream Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.continuumstream.simulation_fabric" }
	S.tags = { "vc", "continuumstream", "reality", "contneural" }
	S.description = "Continuum Stream Reality Continuum: stacked reality layers of the continuum for the Continuum Stream subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.continuumstream.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
