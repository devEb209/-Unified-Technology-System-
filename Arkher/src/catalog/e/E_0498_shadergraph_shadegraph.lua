-- ARKHER SYSTEM E.0498 :: Shader Graph Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0498"
	S.key = "arkher.material.shadergraph.shading_graph"
	S.name = "Shader Graph Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Shader Graph"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.shadergraph.layer_composition" }
	S.tags = { "e", "shadergraph", "shadegraph", "material" }
	S.description = "Shader Graph Shading Graph: node graph evaluated and compiled to Luau for the Shader Graph subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.shadergraph.shading_graph" })
		inst.system = S
		inst.ctx = ctx
