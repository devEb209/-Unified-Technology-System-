-- ARKHER SYSTEM VA.0176 :: Neural Patch World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0176"
	S.key = "arkher.contworld.neuralpatch.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.neuralpatch.neural_field" }
	S.tags = { "va", "neuralpatch", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.neuralpatch.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
