-- ARKHER SYSTEM I.0005 :: Skeleton Rig Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0005"
	S.key = "arkher.anim.skeletonrig.physical_blend"
	S.name = "Skeleton Rig Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Skeleton Rig"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.skeletonrig.inverse_kinematics" }
	S.tags = { "i", "skeletonrig", "ragdoll", "anim" }
	S.description = "Skeleton Rig Physical Blend: physical bones blended against the animated pose for the Skeleton Rig subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.skeletonrig.physical_blend", blendSpeed = 4.60 })
		inst.system = S
		inst.ctx = ctx
