-- ARKHER SYSTEM H.0275 :: Sphere Collider Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0275"
	S.key = "arkher.physics.spherecollider.budget_governor"
	S.name = "Sphere Collider Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.spherecollider.broadphase_index" }
	S.tags = { "h", "spherecollider", "budgeter", "physics" }
	S.description = "Sphere Collider Budget Governor: simulation time budget allocation across islands for the Sphere Collider subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.spherecollider.budget_governor", total = 397, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
