-- ARKHER SYSTEM H.0358 :: Trigger Volume Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0358"
	S.key = "arkher.physics.trigger.broadphase_index"
	S.name = "Trigger Volume Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.trigger.vehicle" }
	S.tags = { "h", "trigger", "index", "physics" }
	S.description = "Trigger Volume Broadphase Index: spatial acceleration of candidate pair finding for the Trigger Volume subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.trigger.broadphase_index", mode = "hash", cellSize = 32 })
		inst.system = S
		inst.ctx = ctx
