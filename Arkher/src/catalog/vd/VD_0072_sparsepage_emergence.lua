-- ARKHER SYSTEM VD.0072 :: Sparse Page Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0072"
	S.key = "arkher.contsim.sparsepage.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.sparsepage.reality_continuum" }
	S.tags = { "vd", "sparsepage", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.sparsepage.emergence_continuum", windowSize = 4, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
