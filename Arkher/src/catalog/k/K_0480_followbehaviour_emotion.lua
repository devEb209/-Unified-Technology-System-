-- ARKHER SYSTEM K.0480 :: Follow Behaviour Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0480"
	S.key = "arkher.npc.followbehaviour.emotion"
	S.name = "Follow Behaviour Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.followbehaviour.drive_system" }
	S.tags = { "k", "followbehaviour", "emotion", "npc" }
	S.description = "Follow Behaviour Emotion: appraisal of events into valence, arousal and mood for the Follow Behaviour subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.followbehaviour.emotion", inertia = 0.80, decayRate = 0.25, baselineArousal = 0.15 })
		inst.system = S
		inst.ctx = ctx
