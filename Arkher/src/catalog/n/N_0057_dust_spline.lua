-- ARKHER SYSTEM N.0057 :: Dust Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0057"
	S.key = "arkher.vfx.dust.curve_authoring"
	S.name = "Dust Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Dust"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.dust.ribbon_and_trail" }
	S.tags = { "n", "dust", "spline", "vfx" }
	S.description = "Dust Curve Authoring: authored curves driving the effect over its life for the Dust subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.dust.curve_authoring", tension = 0.61, closed = false })
		inst.system = S
		inst.ctx = ctx
