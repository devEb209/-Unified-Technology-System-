-- ARKHER SYSTEM L.0498 :: War Economy
...
return function(A)
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.war.ecology" }
	S.tags = { "l", "war", "economy", "sim" }
	S.description = "War Economy: stock, production, demand, price discovery and trade for the War subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.war.economy", elasticity = 0.26 })
		inst.system = S
		inst.ctx = ctx
