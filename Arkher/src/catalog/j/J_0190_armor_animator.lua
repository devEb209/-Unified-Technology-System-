-- ARKHER SYSTEM J.0190 :: Armor Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0190"
	S.key = "arkher.character.armor.blend_controller"
	S.name = "Armor Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.armor.motion_set" }
	S.tags = { "j", "armor", "animator", "character" }
	S.description = "Armor Blend Controller: layered playback driving the character for the Armor subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.armor.blend_controller", budget = 7 })
		inst.system = S
		inst.ctx = ctx
