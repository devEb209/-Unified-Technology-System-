-- ARKHER SYSTEM I.0441 :: Crowd Animation Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0441"
	S.key = "arkher.anim.crowdanim.analysis"
	S.name = "Crowd Animation Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crowdanim.quality_policy" }
	S.tags = { "i", "crowdanim", "analyzer", "anim" }
	S.description = "Crowd Animation Analysis: pop, drift and cost analysis of playback for the Crowd Animation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.crowdanim.analysis", window = 174, buckets = 14, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
