-- ARKHER SYSTEM L.0260 :: Season Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0260"
	S.key = "arkher.sim.season.calendar"
	S.name = "Season Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.season.society" }
	S.tags = { "l", "season", "schedule", "sim" }
	S.description = "Season Calendar: hours, days and seasons driving the region for the Season subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.season.calendar", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
