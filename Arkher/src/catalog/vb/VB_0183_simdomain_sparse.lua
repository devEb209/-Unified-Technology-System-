-- ARKHER SYSTEM VB.0183 :: Simulation Domain Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0183"
	S.key = "arkher.conttime.simdomain.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.simdomain.epoch_clock" }
	S.tags = { "vb", "simdomain", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.simdomain.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
