-- ARKHER SYSTEM V.0149 :: UI Sprite Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0149"
	S.key = "arkher.asset.uisprite.dependency_graph"
	S.name = "UI Sprite Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.uisprite.asset_registry" }
	S.tags = { "v", "uisprite", "graph", "asset" }
	S.description = "UI Sprite Dependency Graph: what references what, and in which order it must be built for the UI Sprite subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.uisprite.dependency_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
