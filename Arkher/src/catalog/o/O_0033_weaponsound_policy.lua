-- ARKHER SYSTEM O.0033 :: Weapon Sound Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0033"
	S.key = "arkher.audio.weaponsound.playback_policy"
	S.name = "Weapon Sound Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Weapon Sound"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.weaponsound.compression_codec" }
	S.tags = { "o", "weaponsound", "policy", "audio" }
	S.description = "Weapon Sound Playback Policy: rules choosing what may be heard right now for the Weapon Sound subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.weaponsound.playback_policy", algorithm = "edf", starvationGuard = 29 })
		inst.system = S
		inst.ctx = ctx
