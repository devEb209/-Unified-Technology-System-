-- ARKHER SYSTEM J.0232 :: Body Type Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0232"
	S.key = "arkher.character.bodytype.rig_definition"
	S.name = "Body Type Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "bodytype", "skeleton", "character" }
	S.description = "Body Type Rig Definition: character rig definition and bone budget for the Body Type subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.bodytype.rig_definition" })
		inst.system = S
		inst.ctx = ctx
