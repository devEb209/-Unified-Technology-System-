-- ARKHER SYSTEM E.0241 :: Triplanar Projection Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0241"
	S.key = "arkher.material.triplanar.definition"
	S.name = "Triplanar Projection Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "triplanar", "material", "material" }
	S.description = "Triplanar Projection Definition: layered PBR definition resolved into parameters for the Triplanar Projection subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.triplanar.definition", texelBudget = 1572864 })
		inst.system = S
		inst.ctx = ctx
