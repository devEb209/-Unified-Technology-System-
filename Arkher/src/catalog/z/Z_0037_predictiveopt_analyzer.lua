-- ARKHER SYSTEM Z.0037 :: Predictive Optimization Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0037"
	S.key = "arkher.origin.predictiveopt.behaviour_analysis"
	S.name = "Predictive Optimization Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.governance_policy" }
	S.tags = { "z", "predictiveopt", "analyzer", "origin" }
	S.description = "Predictive Optimization Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.predictiveopt.behaviour_analysis", window = 146, buckets = 10, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
