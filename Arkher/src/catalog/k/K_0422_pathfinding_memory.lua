-- ARKHER SYSTEM K.0422 :: Pathfinding Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0422"
	S.key = "arkher.npc.pathfinding.memory"
	S.name = "Pathfinding Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.pathfinding.mind_network" }
	S.tags = { "k", "pathfinding", "memory", "npc" }
	S.description = "Pathfinding Memory: episodic memory with decay, recall and consolidation for the Pathfinding subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.pathfinding.memory", capacity = 80, decayRate = 0.020, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
