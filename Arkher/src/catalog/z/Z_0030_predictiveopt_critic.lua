-- ARKHER SYSTEM Z.0030 :: Predictive Optimization Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0030"
	S.key = "arkher.origin.predictiveopt.self_critique"
	S.name = "Predictive Optimization Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.intent_bridge" }
	S.tags = { "z", "predictiveopt", "critic", "origin" }
	S.description = "Predictive Optimization Self Critique: weighted judgement of the technology's own output for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.predictiveopt.self_critique", passMark = 0.70, reviseMark = 0.40, seed = 6090 })
		inst.system = S
		inst.ctx = ctx
