-- ARKHER SYSTEM O.0309 :: Notification Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0309"
	S.key = "arkher.audio.notification.playback_policy"
	S.name = "Notification Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Notification"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.notification.compression_codec" }
	S.tags = { "o", "notification", "policy", "audio" }
	S.description = "Notification Playback Policy: rules choosing what may be heard right now for the Notification subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.notification.playback_policy", algorithm = "wfq", starvationGuard = 26 })
		inst.system = S
		inst.ctx = ctx
