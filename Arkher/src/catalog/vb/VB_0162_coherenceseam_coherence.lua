-- ARKHER SYSTEM VB.0162 :: Coherence Seam Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0162"
	S.key = "arkher.conttime.coherenceseam.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.coherenceseam.persistent_state" }
	S.tags = { "vb", "coherenceseam", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.coherenceseam.coherence_guard", window = 59, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
