-- ARKHER SYSTEM K.0261 :: Vision Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0261"
	S.key = "arkher.npc.vision.navigation"
	S.name = "Vision Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.vision.goal_planner" }
	S.tags = { "k", "vision", "navgraph", "npc" }
	S.description = "Vision Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Vision subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.vision.navigation", width = 48, height = 48, cellSize = 5 })
		inst.system = S
		inst.ctx = ctx
