-- ARKHER SYSTEM W.0341 :: Camera Shake Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0341"
	S.key = "arkher.cine.camerashake.cut_policy"
	S.name = "Camera Shake Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Camera Shake"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.camerashake.shot_composition" }
	S.tags = { "w", "camerashake", "policy", "cine" }
	S.description = "Camera Shake Cut Policy: rules deciding when the sequence cuts and to what for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.camerashake.cut_policy", algorithm = "lottery", starvationGuard = 27 })
		inst.system = S
		inst.ctx = ctx
