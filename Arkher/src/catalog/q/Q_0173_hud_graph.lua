-- ARKHER SYSTEM Q.0173 :: Head Up Display Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0173"
	S.key = "arkher.ui.hud.navigation_graph"
	S.name = "Head Up Display Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.hud.transition" }
	S.tags = { "q", "hud", "graph", "ui" }
	S.description = "Head Up Display Navigation Graph: screens, routes and shortest path between them for the Head Up Display subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.hud.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
