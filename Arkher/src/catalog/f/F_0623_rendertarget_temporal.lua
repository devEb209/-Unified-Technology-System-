-- ARKHER SYSTEM F.0623 :: Render Target Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0623"
	S.key = "arkher.render.rendertarget.temporal_resolve"
	S.name = "Render Target Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.rendertarget.probe_volume" }
	S.tags = { "f", "rendertarget", "temporal", "render" }
	S.description = "Render Target Temporal Resolve: history reprojection with neighbourhood clamping for the Render Target subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.rendertarget.temporal_resolve", feedback = 0.82, phase = 8 })
		inst.system = S
		inst.ctx = ctx
