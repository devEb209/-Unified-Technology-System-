-- ARKHER SYSTEM Z.0652 :: Natural Language Engine Control Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0652"
	S.key = "arkher.origin.languagecontrol.predictive_optimization"
	S.name = "Natural Language Engine Control Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.languagecontrol.adaptive_workflow" }
	S.tags = { "z", "languagecontrol", "predictor", "origin" }
	S.description = "Natural Language Engine Control Predictive Optimization: forecast-driven optimization before the cost is paid for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.languagecontrol.predictive_optimization", method = "markov", alpha = 0.37, window = 67 })
		inst.system = S
		inst.ctx = ctx
