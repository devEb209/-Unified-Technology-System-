-- ARKHER SYSTEM F.0360 :: Temporal Accumulation Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0360"
	S.key = "arkher.render.temporalaccum.render_policy"
	S.name = "Temporal Accumulation Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.temporalaccum.draw_budget" }
	S.tags = { "f", "temporalaccum", "policy", "render" }
	S.description = "Temporal Accumulation Render Policy: device tier rules for the frame for the Temporal Accumulation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.temporalaccum.render_policy", algorithm = "lottery", starvationGuard = 47 })
		inst.system = S
		inst.ctx = ctx
