-- ARKHER SYSTEM H.0376 :: Collision Layer Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0376"
	S.key = "arkher.physics.collisionlayer.analysis"
	S.name = "Collision Layer Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionlayer.result_cache" }
	S.tags = { "h", "collisionlayer", "analyzer", "physics" }
	S.description = "Collision Layer Analysis: energy, jitter and cost analysis of the simulation for the Collision Layer subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.collisionlayer.analysis", window = 116, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
