-- ARKHER SYSTEM Q.0063 :: List Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0063"
	S.key = "arkher.ui.list.input_mapping"
	S.name = "List Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "List"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.list.widget_tree" }
	S.tags = { "q", "list", "inputmap", "ui" }
	S.description = "List Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the List subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.list.input_mapping", device = "touch", holdTime = 0.39, deadzone = 0.19 })
		inst.system = S
		inst.ctx = ctx
