-- ARKHER SYSTEM Z.0107 :: Universal Simulation Fabric World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0107"
	S.key = "arkher.origin.simfabric.world_architect"
	S.name = "Universal Simulation Fabric World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.simfabric.emergence_detection" }
	S.tags = { "z", "simfabric", "architect", "origin" }
	S.description = "Universal Simulation Fabric World Architect: hierarchical world composition with conserved budgets for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.simfabric.world_architect", budget = 1500, seed = 99369 })
		inst.system = S
		inst.ctx = ctx
