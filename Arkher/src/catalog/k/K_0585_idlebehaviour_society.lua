-- ARKHER SYSTEM K.0585 :: Idle Behaviour Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0585"
	S.key = "arkher.npc.idlebehaviour.social_relations"
	S.name = "Idle Behaviour Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.idlebehaviour.crowd_steering" }
	S.tags = { "k", "idlebehaviour", "society", "npc" }
	S.description = "Idle Behaviour Social Relations: affinity, factions, reputation and gossip for the Idle Behaviour subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.idlebehaviour.social_relations", decayRate = 0.005, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
