-- ARKHER SYSTEM T.0079 :: Project Knowledge Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0079"
	S.key = "arkher.ai.projectknowledge.working_memory"
	S.name = "Project Knowledge Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.projectknowledge.outcome_prediction" }
	S.tags = { "t", "projectknowledge", "memory", "ai" }
	S.description = "Project Knowledge Working Memory: decaying, consolidating recall of what the agent learned for the Project Knowledge subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.projectknowledge.working_memory", capacity = 94, decayRate = 0.030, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
