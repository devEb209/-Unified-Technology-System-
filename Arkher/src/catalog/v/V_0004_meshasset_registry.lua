-- ARKHER SYSTEM V.0004 :: Mesh Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0004"
	S.key = "arkher.asset.meshasset.asset_registry"
	S.name = "Mesh Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.meshasset.cook_pipeline" }
	S.tags = { "v", "meshasset", "registry", "asset" }
	S.description = "Mesh Asset Registry: catalogue of every asset, its tags and its metadata for the Mesh subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.meshasset.asset_registry" })
		inst.system = S
		inst.ctx = ctx
