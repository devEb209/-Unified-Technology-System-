-- ARKHER SYSTEM E.0277 :: Decal Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0277"
	S.key = "arkher.material.decal.parameter_budget"
	S.name = "Decal Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Decal"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.decal.variant_registry" }
	S.tags = { "e", "decal", "budgeter", "material" }
	S.description = "Decal Parameter Budget: texel and layer budget allocation for the Decal subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.decal.parameter_budget", total = 436, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
