-- ARKHER SYSTEM F.0428 :: Occlusion Culling Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0428"
	S.key = "arkher.render.occlusion.adaptive_resolution"
	S.name = "Occlusion Culling Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.occlusion.temporal_resolve" }
	S.tags = { "f", "occlusion", "upscaler", "render" }
	S.description = "Occlusion Culling Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Occlusion Culling subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.occlusion.adaptive_resolution", targetMs = 16.10, index = 5, sharpness = 0.41 })
		inst.system = S
		inst.ctx = ctx
