-- ARKHER SYSTEM E.0071 :: Metalness Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0071"
	S.key = "arkher.material.metalness.instance_cache"
	S.name = "Metalness Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Metalness"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.metalness.quality_policy" }
	S.tags = { "e", "metalness", "cache", "material" }
	S.description = "Metalness Instance Cache: resolved-parameter cache keyed by context for the Metalness subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.metalness.instance_cache", policy = "lfu", capacity = 208, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
