-- ARKHER SYSTEM G.0072 :: Disocclusion Handling Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0072"
	S.key = "arkher.neural.disocclusion.feature_extraction"
	S.name = "Disocclusion Handling Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.disocclusion.inference_core" }
	S.tags = { "g", "disocclusion", "field", "neural" }
	S.description = "Disocclusion Handling Feature Extraction: signal features feeding the model for the Disocclusion Handling subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.disocclusion.feature_extraction", seed = 68359, frequency = 0.0138, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
