-- ARKHER SYSTEM VB.0276 :: Bridge Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0276"
	S.key = "arkher.conttime.bridgecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.bridgecont.reality_continuum" }
	S.tags = { "vb", "bridgecont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.bridgecont.emergence_continuum", windowSize = 5, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
