-- ARKHER SYSTEM E.0398 :: Texture Atlas Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0398"
	S.key = "arkher.material.atlas.streaming"
	S.name = "Texture Atlas Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.atlas.parameter_budget" }
	S.tags = { "e", "atlas", "streamer", "material" }
	S.description = "Texture Atlas Streaming: residency and demand-driven texture streaming for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.atlas.streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
