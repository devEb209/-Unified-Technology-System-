-- ARKHER SYSTEM K.0226 :: Personality Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0226"
	S.key = "arkher.npc.personality.memory"
	S.name = "Personality Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.personality.mind_network" }
	S.tags = { "k", "personality", "memory", "npc" }
	S.description = "Personality Memory: episodic memory with decay, recall and consolidation for the Personality subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.personality.memory", capacity = 96, decayRate = 0.050, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
