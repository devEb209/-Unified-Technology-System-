-- ARKHER SYSTEM P.0402 :: Match Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0402"
	S.key = "arkher.play.match.rule_pipeline"
	S.name = "Match Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Match"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.match.state_machine" }
	S.tags = { "p", "match", "pipeline", "play" }
	S.description = "Match Rule Pipeline: ordered rules applied to every gameplay event for the Match subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.match.rule_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
