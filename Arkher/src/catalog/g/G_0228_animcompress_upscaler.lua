-- ARKHER SYSTEM G.0228 :: Animation Compression Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0228"
	S.key = "arkher.neural.animcompress.reconstruction"
	S.name = "Animation Compression Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.animcompress.temporal_history" }
	S.tags = { "g", "animcompress", "upscaler", "neural" }
	S.description = "Animation Compression Reconstruction: resolution ladder and image reconstruction for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.animcompress.reconstruction", targetMs = 13.10, index = 5, sharpness = 0.40 })
		inst.system = S
		inst.ctx = ctx
