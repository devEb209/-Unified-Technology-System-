-- ARKHER SYSTEM Q.0077 :: Grid Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0077"
	S.key = "arkher.ui.grid.navigation_graph"
	S.name = "Grid Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Grid"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.grid.transition" }
	S.tags = { "q", "grid", "graph", "ui" }
	S.description = "Grid Navigation Graph: screens, routes and shortest path between them for the Grid subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.grid.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
