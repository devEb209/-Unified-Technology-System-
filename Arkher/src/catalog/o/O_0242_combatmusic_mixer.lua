-- ARKHER SYSTEM O.0242 :: Combat Music Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0242"
	S.key = "arkher.audio.combatmusic.mixer_bus"
	S.name = "Combat Music Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Combat Music"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.combatmusic.dsp_chain" }
	S.tags = { "o", "combatmusic", "mixer", "audio" }
	S.description = "Combat Music Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Combat Music subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.combatmusic.mixer_bus", maxVoices = 40 })
		inst.system = S
		inst.ctx = ctx
