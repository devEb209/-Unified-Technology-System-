-- ARKHER SYSTEM E.0139 :: Opacity Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0139"
	S.key = "arkher.material.opacity.texture_sampling"
	S.name = "Opacity Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Opacity"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.opacity.shading_graph" }
	S.tags = { "e", "opacity", "sampler", "material" }
	S.description = "Opacity Texture Sampling: atlas packing, mip chain and filtered sampling for the Opacity subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.opacity.texture_sampling", atlasSize = 128, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
