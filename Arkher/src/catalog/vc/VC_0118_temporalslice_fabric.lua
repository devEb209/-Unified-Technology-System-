-- ARKHER SYSTEM VC.0118 :: Temporal Slice Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0118"
	S.key = "arkher.contneural.temporalslice.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.temporalslice.complexity_budget" }
	S.tags = { "vc", "temporalslice", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.temporalslice.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
