-- ARKHER SYSTEM Z.0864 :: Multi Scale Simulation Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0864"
	S.key = "arkher.origin.multiscale.autonomous_pipeline"
	S.name = "Multi Scale Simulation Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.simulation_fabric" }
	S.tags = { "z", "multiscale", "autopipeline", "origin" }
	S.description = "Multi Scale Simulation Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.multiscale.autonomous_pipeline", maxIterations = 6 })
		inst.system = S
		inst.ctx = ctx
