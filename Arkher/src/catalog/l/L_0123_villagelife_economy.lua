-- ARKHER SYSTEM L.0123 :: Village Life Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0123"
	S.key = "arkher.sim.villagelife.economy"
	S.name = "Village Life Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.villagelife.ecology" }
	S.tags = { "l", "villagelife", "economy", "sim" }
	S.description = "Village Life Economy: stock, production, demand, price discovery and trade for the Village Life subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.villagelife.economy", elasticity = 0.31 })
		inst.system = S
		inst.ctx = ctx
