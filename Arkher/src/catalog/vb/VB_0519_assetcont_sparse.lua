-- ARKHER SYSTEM VB.0519 :: Asset Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0519"
	S.key = "arkher.conttime.assetcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.assetcont.epoch_clock" }
	S.tags = { "vb", "assetcont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.assetcont.sparse_residency", capacity = 256, pageBytes = 3072 })
		inst.system = S
		inst.ctx = ctx
