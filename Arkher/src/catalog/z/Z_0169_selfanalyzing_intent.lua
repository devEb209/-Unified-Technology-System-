-- ARKHER SYSTEM Z.0169 :: Self Analyzing Project Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0169"
	S.key = "arkher.origin.selfanalyzing.intent_bridge"
	S.name = "Self Analyzing Project Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.semantic_graph" }
	S.tags = { "z", "selfanalyzing", "intent", "origin" }
	S.description = "Self Analyzing Project Intent Bridge: natural language control surface for the technology for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.selfanalyzing.intent_bridge", minConfidence = 0.41 })
		inst.system = S
		inst.ctx = ctx
