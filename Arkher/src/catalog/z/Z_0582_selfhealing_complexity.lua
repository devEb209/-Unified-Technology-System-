-- ARKHER SYSTEM Z.0582 :: Self Healing Systems Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0582"
	S.key = "arkher.origin.selfhealing.complexity_governance"
	S.name = "Self Healing Systems Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfhealing.reality_layering" }
	S.tags = { "z", "selfhealing", "complexity", "origin" }
	S.description = "Self Healing Systems Complexity Governance: measured scene cost turned into per-subsystem directives for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.selfhealing.complexity_governance", targetMs = 19.0 })
		inst.system = S
		inst.ctx = ctx
