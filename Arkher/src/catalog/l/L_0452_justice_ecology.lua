-- ARKHER SYSTEM L.0452 :: Justice Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0452"
	S.key = "arkher.sim.justice.ecology"
	S.name = "Justice Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.justice.simulation_core" }
	S.tags = { "l", "justice", "ecology", "sim" }
	S.description = "Justice Ecology: populations, predation, harvesting and carrying capacity for the Justice subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.justice.ecology" })
		inst.system = S
		inst.ctx = ctx
