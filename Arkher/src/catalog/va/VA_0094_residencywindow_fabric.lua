-- ARKHER SYSTEM VA.0094 :: Residency Window Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0094"
	S.key = "arkher.contworld.residencywindow.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.residencywindow.complexity_budget" }
	S.tags = { "va", "residencywindow", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.residencywindow.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
