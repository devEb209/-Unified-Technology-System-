-- ARKHER SYSTEM F.0479 :: Impostor Rendering Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0479"
	S.key = "arkher.render.impostorrender.visibility_set"
	S.name = "Impostor Rendering Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.impostorrender.view_and_culling" }
	S.tags = { "f", "impostorrender", "visibility", "render" }
	S.description = "Impostor Rendering Visibility Set: cell, portal and occluder visibility for the Impostor Rendering subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.impostorrender.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
