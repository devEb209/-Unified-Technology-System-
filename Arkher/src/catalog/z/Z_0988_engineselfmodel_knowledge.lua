-- ARKHER SYSTEM Z.0988 :: Engine Self Model Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0988"
	S.key = "arkher.origin.engineselfmodel.semantic_graph"
	S.name = "Engine Self Model Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.engineselfmodel.world_architect" }
	S.tags = { "z", "engineselfmodel", "knowledge", "origin" }
	S.description = "Engine Self Model Semantic Graph: typed entities and inferred relations of the technology itself for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.engineselfmodel.semantic_graph", dims = 16 })
		inst.system = S
		inst.ctx = ctx
