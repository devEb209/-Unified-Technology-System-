-- ARKHER SYSTEM VD.0147 :: Persistence Segment Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0147"
	S.key = "arkher.contsim.persistsegment.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.persistsegment.epoch_clock" }
	S.tags = { "vd", "persistsegment", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.persistsegment.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
