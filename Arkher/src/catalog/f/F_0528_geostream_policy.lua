-- ARKHER SYSTEM F.0528 :: Geometry Streaming Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0528"
	S.key = "arkher.render.geostream.render_policy"
	S.name = "Geometry Streaming Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.geostream.draw_budget" }
	S.tags = { "f", "geostream", "policy", "render" }
	S.description = "Geometry Streaming Render Policy: device tier rules for the frame for the Geometry Streaming subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.geostream.render_policy", algorithm = "roundrobin", starvationGuard = 28 })
		inst.system = S
		inst.ctx = ctx
