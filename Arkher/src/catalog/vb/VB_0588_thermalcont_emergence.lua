-- ARKHER SYSTEM VB.0588 :: Thermal Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0588"
	S.key = "arkher.conttime.thermalcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.thermalcont.reality_continuum" }
	S.tags = { "vb", "thermalcont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.thermalcont.emergence_continuum", windowSize = 6, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
