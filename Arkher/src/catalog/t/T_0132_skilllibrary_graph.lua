-- ARKHER SYSTEM T.0132 :: Skill Library Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0132"
	S.key = "arkher.ai.skilllibrary.reasoning_graph"
	S.name = "Skill Library Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.skilllibrary.world_architect" }
	S.tags = { "t", "skilllibrary", "graph", "ai" }
	S.description = "Skill Library Reasoning Graph: relationship modelling and shortest-path reasoning for the Skill Library subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.skilllibrary.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
