-- ARKHER SYSTEM H.0485 :: Ball Joint Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0485"
	S.key = "arkher.physics.balljoint.budget_governor"
	S.name = "Ball Joint Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Ball Joint"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.balljoint.broadphase_index" }
	S.tags = { "h", "balljoint", "budgeter", "physics" }
	S.description = "Ball Joint Budget Governor: simulation time budget allocation across islands for the Ball Joint subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.balljoint.budget_governor", total = 331, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
