-- ARKHER SYSTEM Q.0234 :: Quest Log Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0234"
	S.key = "arkher.ui.questlog.theme_composition"
	S.name = "Quest Log Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Quest Log"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.questlog.navigation_graph" }
	S.tags = { "q", "questlog", "composer", "ui" }
	S.description = "Quest Log Theme Composition: blending of theme signals into the final appearance for the Quest Log subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.questlog.theme_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
