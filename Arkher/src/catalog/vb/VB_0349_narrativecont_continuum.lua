-- ARKHER SYSTEM VB.0349 :: Narrative Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0349"
	S.key = "arkher.conttime.narrativecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "narrativecont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.narrativecont.infinite_grid", cellSize = 128, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
