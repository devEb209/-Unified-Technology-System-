-- ARKHER SYSTEM H.0228 :: Continuous Detection Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0228"
	S.key = "arkher.physics.ccd.constraint_solver"
	S.name = "Continuous Detection Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.ccd.contact_generation" }
	S.tags = { "h", "ccd", "constraint", "physics" }
	S.description = "Continuous Detection Constraint Solver: sequential impulses, friction, joints and warm starting for the Continuous Detection subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.ccd.constraint_solver", iterations = 11, baumgarte = 0.27, warmStart = true })
		inst.system = S
		inst.ctx = ctx
