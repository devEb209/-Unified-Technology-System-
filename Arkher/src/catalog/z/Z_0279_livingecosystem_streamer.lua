-- ARKHER SYSTEM Z.0279 :: Living Ecosystem Engine Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0279"
	S.key = "arkher.origin.livingecosystem.residency_streaming"
	S.name = "Living Ecosystem Engine Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.livingecosystem.budget_governor" }
	S.tags = { "z", "livingecosystem", "streamer", "origin" }
	S.description = "Living Ecosystem Engine Residency Streaming: distance-driven residency of the technology's workload for the Living Ecosystem Engine subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.livingecosystem.residency_streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
