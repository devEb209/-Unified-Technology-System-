-- ARKHER SYSTEM L.0154 :: Agriculture Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0154"
	S.key = "arkher.sim.agriculture.society"
	S.name = "Agriculture Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.agriculture.economy" }
	S.tags = { "l", "agriculture", "society", "sim" }
	S.description = "Agriculture Society: relations, factions, reputation and cohesion of the region for the Agriculture subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.agriculture.society", decayRate = 0.011, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
