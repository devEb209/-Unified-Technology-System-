-- ARKHER SYSTEM P.0191 :: Economy Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0191"
	S.key = "arkher.play.playereconomy.save_codec"
	S.name = "Economy Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Economy"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playereconomy.content_registry" }
	S.tags = { "p", "playereconomy", "codec", "play" }
	S.description = "Economy Save Codec: persistence, diffing and checksum of gameplay state for the Economy subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.playereconomy.save_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
