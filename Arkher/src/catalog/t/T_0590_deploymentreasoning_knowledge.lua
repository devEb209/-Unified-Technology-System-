-- ARKHER SYSTEM T.0590 :: Deployment Reasoning Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0590"
	S.key = "arkher.ai.deploymentreasoning.semantic_knowledge"
	S.name = "Deployment Reasoning Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.deploymentreasoning.intent_understanding" }
	S.tags = { "t", "deploymentreasoning", "knowledge", "ai" }
	S.description = "Deployment Reasoning Semantic Knowledge: typed entities, weighted relations and inferred closure for the Deployment Reasoning subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.deploymentreasoning.semantic_knowledge", dims = 40 })
		inst.system = S
		inst.ctx = ctx
