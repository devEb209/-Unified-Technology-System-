-- ARKHER SYSTEM E.0122 :: Emissive Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0122"
	S.key = "arkher.material.emissive.layer_composition"
	S.name = "Emissive Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Emissive"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.emissive.definition" }
	S.tags = { "e", "emissive", "composer", "material" }
	S.description = "Emissive Layer Composition: ordered layer composition with blend rules for the Emissive subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.emissive.layer_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
