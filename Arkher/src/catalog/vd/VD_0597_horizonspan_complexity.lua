-- ARKHER SYSTEM VD.0597 :: Horizon Span Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0597"
	S.key = "arkher.contsim.horizonspan.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.horizonspan.world_memory_stream" }
	S.tags = { "vd", "horizonspan", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.horizonspan.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
