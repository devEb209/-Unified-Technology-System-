-- ARKHER SYSTEM VC.0466 :: Audio Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0466"
	S.key = "arkher.contneural.audiocont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.audiocont.complexity_budget" }
	S.tags = { "vc", "audiocont", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.audiocont.simulation_fabric", budgetMs = 1.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
