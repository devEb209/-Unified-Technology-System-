-- ARKHER SYSTEM Z.0629 :: Intent Driven Authoring Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0629"
	S.key = "arkher.origin.intentauthoring.intent_bridge"
	S.name = "Intent Driven Authoring Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.semantic_graph" }
	S.tags = { "z", "intentauthoring", "intent", "origin" }
	S.description = "Intent Driven Authoring Intent Bridge: natural language control surface for the technology for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.intentauthoring.intent_bridge", minConfidence = 0.43 })
		inst.system = S
		inst.ctx = ctx
