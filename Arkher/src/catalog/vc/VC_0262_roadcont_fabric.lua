-- ARKHER SYSTEM VC.0262 :: Road Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0262"
	S.key = "arkher.contneural.roadcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.roadcont.complexity_budget" }
	S.tags = { "vc", "roadcont", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.roadcont.simulation_fabric", budgetMs = 4.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
