-- ARKHER SYSTEM T.0645 :: Human Handoff Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0645"
	S.key = "arkher.ai.humanhandoff.intent_understanding"
	S.name = "Human Handoff Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "humanhandoff", "intent", "ai" }
	S.description = "Human Handoff Intent Understanding: natural language turned into an actionable, scored intent for the Human Handoff subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.humanhandoff.intent_understanding", minConfidence = 0.34 })
		inst.system = S
		inst.ctx = ctx
