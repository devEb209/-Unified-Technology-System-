-- ARKHER SYSTEM F.0426 :: Occlusion Culling Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0426"
	S.key = "arkher.render.occlusion.probe_volume"
	S.name = "Occlusion Culling Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.occlusion.lighting_rig" }
	S.tags = { "f", "occlusion", "probe", "render" }
	S.description = "Occlusion Culling Probe Volume: irradiance probes encoded in spherical harmonics for the Occlusion Culling subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.occlusion.probe_volume", spacing = 40 })
		inst.system = S
		inst.ctx = ctx
