-- ARKHER SYSTEM P.0434 :: Matchmaking Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0434"
	S.key = "arkher.play.matchmaking.inventory"
	S.name = "Matchmaking Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Matchmaking"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.matchmaking.attributes" }
	S.tags = { "p", "matchmaking", "inventory", "play" }
	S.description = "Matchmaking Inventory: slots, stacking, weight, equipment and crafting for the Matchmaking subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.matchmaking.inventory", slots = 20, maxWeight = 100 })
		inst.system = S
		inst.ctx = ctx
