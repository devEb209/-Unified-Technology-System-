-- ARKHER SYSTEM O.0019 :: Foley Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0019"
	S.key = "arkher.audio.foley.asset_registry"
	S.name = "Foley Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Foley"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.foley.streaming" }
	S.tags = { "o", "foley", "registry", "audio" }
	S.description = "Foley Asset Registry: catalogue of sounds, variations and metadata for the Foley subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.foley.asset_registry" })
		inst.system = S
		inst.ctx = ctx
