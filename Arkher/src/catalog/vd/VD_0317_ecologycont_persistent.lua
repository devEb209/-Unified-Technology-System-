-- ARKHER SYSTEM VD.0317 :: Ecology Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0317"
	S.key = "arkher.contsim.ecologycont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.ecologycont.multi-scale_fidelity" }
	S.tags = { "vd", "ecologycont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.ecologycont.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
