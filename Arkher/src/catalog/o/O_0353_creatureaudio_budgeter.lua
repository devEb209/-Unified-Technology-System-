-- ARKHER SYSTEM O.0353 :: Creature Audio Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0353"
	S.key = "arkher.audio.creatureaudio.voice_budget"
	S.name = "Creature Audio Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.creatureaudio.music_sequencer" }
	S.tags = { "o", "creatureaudio", "budgeter", "audio" }
	S.description = "Creature Audio Voice Budget: voice slots allocated by priority and audibility for the Creature Audio subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.creatureaudio.voice_budget", total = 264, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
