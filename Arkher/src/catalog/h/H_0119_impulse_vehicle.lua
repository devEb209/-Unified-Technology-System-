-- ARKHER SYSTEM H.0119 :: Impulse Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0119"
	S.key = "arkher.physics.impulse.vehicle"
	S.name = "Impulse Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Impulse"
	S.aspect = "Vehicle"
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.impulse.character_motion" }
	S.tags = { "h", "impulse", "vehicle", "physics" }
	S.description = "Impulse Vehicle: suspension, drivetrain, steering and tire friction for the Impulse subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.impulse.vehicle", mass = 1000, wheelbase = 3.10, track = 1.50, maxRpm = 6500 })
		inst.system = S
		inst.ctx = ctx
