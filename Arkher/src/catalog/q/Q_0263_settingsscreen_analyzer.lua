-- ARKHER SYSTEM Q.0263 :: Settings Screen Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0263"
	S.key = "arkher.ui.settingsscreen.usability_analysis"
	S.name = "Settings Screen Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.settingsscreen.frame_budget" }
	S.tags = { "q", "settingsscreen", "analyzer", "ui" }
	S.description = "Settings Screen Usability Analysis: reachability, latency and abandonment analysis for the Settings Screen subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.settingsscreen.usability_analysis", window = 124, buckets = 16, threshold = 4.60 })
		inst.system = S
		inst.ctx = ctx
