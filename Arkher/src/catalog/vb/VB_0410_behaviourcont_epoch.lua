-- ARKHER SYSTEM VB.0410 :: Behaviour Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0410"
	S.key = "arkher.conttime.behaviourcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.behaviourcont.infinite_grid" }
	S.tags = { "vb", "behaviourcont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.behaviourcont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
