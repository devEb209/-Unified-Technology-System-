-- ARKHER SYSTEM T.0669 :: Multi Agent Coordination Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0669"
	S.key = "arkher.ai.multiagent.action_planner"
	S.name = "Multi Agent Coordination Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.multiagent.utility_selection" }
	S.tags = { "t", "multiagent", "planner", "ai" }
	S.description = "Multi Agent Coordination Action Planner: goal-oriented action planning over preconditions for the Multi Agent Coordination subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.multiagent.action_planner", maxDepth = 9 })
		inst.system = S
		inst.ctx = ctx
