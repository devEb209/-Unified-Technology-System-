-- ARKHER SYSTEM F.0124 :: Screen Space Reflection Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0124"
	S.key = "arkher.render.ssr.frame_analysis"
	S.name = "Screen Space Reflection Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.ssr.pass_cache" }
	S.tags = { "f", "ssr", "analyzer", "render" }
	S.description = "Screen Space Reflection Frame Analysis: per-pass cost analysis and outlier detection for the Screen Space Reflection subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.ssr.frame_analysis", window = 113, buckets = 13, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
