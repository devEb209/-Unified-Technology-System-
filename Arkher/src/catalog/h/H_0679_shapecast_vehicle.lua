-- ARKHER SYSTEM H.0679 :: Shapecast Query Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0679"
	S.key = "arkher.physics.shapecast.vehicle"
	S.name = "Shapecast Query Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.shapecast.character_motion" }
	S.tags = { "h", "shapecast", "vehicle", "physics" }
	S.description = "Shapecast Query Vehicle: suspension, drivetrain, steering and tire friction for the Shapecast Query subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.shapecast.vehicle", mass = 1400, wheelbase = 2.90, track = 1.70, maxRpm = 6300 })
		inst.system = S
		inst.ctx = ctx
