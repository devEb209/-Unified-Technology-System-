-- ARKHER SYSTEM K.0692 :: NPC Debug Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0692"
	S.key = "arkher.npc.npcdebug.reactive_behaviour"
	S.name = "NPC Debug Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcdebug.perception" }
	S.tags = { "k", "npcdebug", "behaviortree", "npc" }
	S.description = "NPC Debug Reactive Behaviour: sequences, selectors, decorators and cooldowns for the NPC Debug subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.npcdebug.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
