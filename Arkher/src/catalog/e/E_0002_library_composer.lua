-- ARKHER SYSTEM E.0002 :: Material Library Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0002"
	S.key = "arkher.material.library.layer_composition"
	S.name = "Material Library Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.library.definition" }
	S.tags = { "e", "library", "composer", "material" }
	S.description = "Material Library Layer Composition: ordered layer composition with blend rules for the Material Library subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.library.layer_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
