-- ARKHER SYSTEM F.0653 :: Mobile Fast Path Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0653"
	S.key = "arkher.render.mobilepath.draw_budget"
	S.name = "Mobile Fast Path Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.mobilepath.adaptive_resolution" }
	S.tags = { "f", "mobilepath", "budgeter", "render" }
	S.description = "Mobile Fast Path Draw Budget: draw call and triangle budget allocation for the Mobile Fast Path subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.mobilepath.draw_budget", total = 178, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
