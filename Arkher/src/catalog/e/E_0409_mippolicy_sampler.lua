-- ARKHER SYSTEM E.0409 :: Mip Policy Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0409"
	S.key = "arkher.material.mippolicy.texture_sampling"
	S.name = "Mip Policy Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Mip Policy"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.mippolicy.shading_graph" }
	S.tags = { "e", "mippolicy", "sampler", "material" }
	S.description = "Mip Policy Texture Sampling: atlas packing, mip chain and filtered sampling for the Mip Policy subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.mippolicy.texture_sampling", atlasSize = 128, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
