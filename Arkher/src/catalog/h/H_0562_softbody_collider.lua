-- ARKHER SYSTEM H.0562 :: Soft Body Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0562"
	S.key = "arkher.physics.softbody.collision_shape"
	S.name = "Soft Body Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Soft Body"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.softbody.body_dynamics" }
	S.tags = { "h", "softbody", "collider", "physics" }
	S.description = "Soft Body Collision Shape: shape bounds, support mapping and closest points for the Soft Body subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.softbody.collision_shape", shape = "box", radius = 1.40, height = 2.20, layer = "character" })
		inst.system = S
		inst.ctx = ctx
