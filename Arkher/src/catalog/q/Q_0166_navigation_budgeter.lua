-- ARKHER SYSTEM Q.0166 :: Navigation Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0166"
	S.key = "arkher.ui.navigation.frame_budget"
	S.name = "Navigation Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Navigation"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.navigation.accessibility_policy" }
	S.tags = { "q", "navigation", "budgeter", "ui" }
	S.description = "Navigation Frame Budget: per-frame layout and draw budget for the interface for the Navigation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.navigation.frame_budget", total = 376, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
