-- ARKHER SYSTEM VB.0067 :: Sparse Page Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0067"
	S.key = "arkher.conttime.sparsepage.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.sparsepage.coherence_guard" }
	S.tags = { "vb", "sparsepage", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.sparsepage.neural_field", dims = 24, hidden = 20, seed = 17311 })
		inst.system = S
		inst.ctx = ctx
