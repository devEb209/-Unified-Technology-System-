-- ARKHER SYSTEM N.0421 :: Foliage Motion Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0421"
	S.key = "arkher.vfx.foliagemotion.curve_authoring"
	S.name = "Foliage Motion Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.foliagemotion.ribbon_and_trail" }
	S.tags = { "n", "foliagemotion", "spline", "vfx" }
	S.description = "Foliage Motion Curve Authoring: authored curves driving the effect over its life for the Foliage Motion subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.foliagemotion.curve_authoring", tension = 0.48, closed = false })
		inst.system = S
		inst.ctx = ctx
