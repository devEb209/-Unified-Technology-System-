-- ARKHER SYSTEM K.0232 :: Personality Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0232"
	S.key = "arkher.npc.personality.goal_planner"
	S.name = "Personality Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.personality.utility_reasoning" }
	S.tags = { "k", "personality", "planner", "npc" }
	S.description = "Personality Goal Planner: backward GOAP planning to reach a goal state for the Personality subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.personality.goal_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
