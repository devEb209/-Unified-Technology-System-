-- ARKHER SYSTEM L.0292 :: Water Cycle Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0292"
	S.key = "arkher.sim.watercycle.route_network"
	S.name = "Water Cycle Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.watercycle.region_graph" }
	S.tags = { "l", "watercycle", "network", "sim" }
	S.description = "Water Cycle Route Network: roads, rivers and routes between settlements for the Water Cycle subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.watercycle.route_network" })
		inst.system = S
		inst.ctx = ctx
