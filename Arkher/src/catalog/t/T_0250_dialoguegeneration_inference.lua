-- ARKHER SYSTEM T.0250 :: Dialogue Generation Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0250"
	S.key = "arkher.ai.dialoguegeneration.model_inference"
	S.name = "Dialogue Generation Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.dialoguegeneration.action_planner" }
	S.tags = { "t", "dialoguegeneration", "inference", "ai" }
	S.description = "Dialogue Generation Model Inference: quantized inference with batching and budget for the Dialogue Generation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.dialoguegeneration.model_inference", seed = 63286 })
		inst.system = S
		inst.ctx = ctx
