-- ARKHER SYSTEM E.0322 :: Moisture Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0322"
	S.key = "arkher.material.moisture.parameter_budget"
	S.name = "Moisture Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Moisture"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.moisture.variant_registry" }
	S.tags = { "e", "moisture", "budgeter", "material" }
	S.description = "Moisture Parameter Budget: texel and layer budget allocation for the Moisture subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.moisture.parameter_budget", total = 456, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
