-- ARKHER SYSTEM N.0378 :: Decal Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0378"
	S.key = "arkher.vfx.decal.emission"
	S.name = "Decal Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Decal"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "decal", "emitter", "vfx" }
	S.description = "Decal Emission: shaped, rate and burst emission of new particles for the Decal subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.decal.emission", shape = "sphere", rate = 57, speed = 6.70, life = 1.50, budget = 448, seed = 62917 })
		inst.system = S
		inst.ctx = ctx
