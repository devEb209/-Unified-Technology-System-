-- ARKHER SYSTEM J.0153 :: Posture Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0153"
	S.key = "arkher.character.posture.streaming"
	S.name = "Posture Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.posture.budget_governor" }
	S.tags = { "j", "posture", "streamer", "character" }
	S.description = "Posture Streaming: distance-driven residency of character data for the Posture subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.posture.streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
