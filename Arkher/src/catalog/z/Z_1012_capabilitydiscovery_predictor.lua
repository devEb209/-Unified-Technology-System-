-- ARKHER SYSTEM Z.1012 :: Capability Discovery Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.1012"
	S.key = "arkher.origin.capabilitydiscovery.predictive_optimization"
	S.name = "Capability Discovery Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.adaptive_workflow" }
	S.tags = { "z", "capabilitydiscovery", "predictor", "origin" }
	S.description = "Capability Discovery Predictive Optimization: forecast-driven optimization before the cost is paid for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.capabilitydiscovery.predictive_optimization", method = "linear", alpha = 0.11, window = 57 })
		inst.system = S
		inst.ctx = ctx
