-- ARKHER SYSTEM P.0122 :: Loot Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0122"
	S.key = "arkher.play.loot.inventory"
	S.name = "Loot Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Loot"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.loot.attributes" }
	S.tags = { "p", "loot", "inventory", "play" }
	S.description = "Loot Inventory: slots, stacking, weight, equipment and crafting for the Loot subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.loot.inventory", slots = 12, maxWeight = 120 })
		inst.system = S
		inst.ctx = ctx
