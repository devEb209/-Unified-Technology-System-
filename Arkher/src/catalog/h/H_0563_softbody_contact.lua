-- ARKHER SYSTEM H.0563 :: Soft Body Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0563"
	S.key = "arkher.physics.softbody.contact_generation"
	S.name = "Soft Body Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Soft Body"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.softbody.collision_shape" }
	S.tags = { "h", "softbody", "contact", "physics" }
	S.description = "Soft Body Contact Generation: narrow-phase manifolds with normal, depth and point for the Soft Body subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.softbody.contact_generation", slop = 0.0080, maxManifolds = 286 })
		inst.system = S
		inst.ctx = ctx
