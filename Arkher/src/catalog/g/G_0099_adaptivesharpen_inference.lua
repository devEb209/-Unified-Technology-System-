-- ARKHER SYSTEM G.0099 :: Adaptive Sharpening Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0099"
	S.key = "arkher.neural.adaptivesharpen.inference_core"
	S.name = "Adaptive Sharpening Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "adaptivesharpen", "inference", "neural" }
	S.description = "Adaptive Sharpening Inference Core: dense network forward pass and training for the Adaptive Sharpening subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.adaptivesharpen.inference_core", seed = 54586 })
		inst.system = S
		inst.ctx = ctx
