-- ARKHER SYSTEM J.0009 :: Digital Human Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0009"
	S.key = "arkher.character.digitalhuman.budget_governor"
	S.name = "Digital Human Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.digitalhuman.variant_registry" }
	S.tags = { "j", "digitalhuman", "budgeter", "character" }
	S.description = "Digital Human Budget Governor: per-character cost allocation in a crowd for the Digital Human subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.digitalhuman.budget_governor", total = 213, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
