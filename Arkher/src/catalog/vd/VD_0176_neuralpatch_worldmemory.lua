-- ARKHER SYSTEM VD.0176 :: Neural Patch World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0176"
	S.key = "arkher.contsim.neuralpatch.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.neuralpatch.neural_field" }
	S.tags = { "vd", "neuralpatch", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.neuralpatch.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
