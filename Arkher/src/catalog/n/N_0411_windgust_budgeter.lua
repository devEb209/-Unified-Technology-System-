-- ARKHER SYSTEM N.0411 :: Wind Gust Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0411"
	S.key = "arkher.vfx.windgust.spawn_budget"
	S.name = "Wind Gust Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Wind Gust"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.windgust.effect_composition" }
	S.tags = { "n", "windgust", "budgeter", "vfx" }
	S.description = "Wind Gust Spawn Budget: global particle budget shared by every live effect for the Wind Gust subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.windgust.spawn_budget", total = 92, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
