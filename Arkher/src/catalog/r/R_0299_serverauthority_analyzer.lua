-- ARKHER SYSTEM R.0299 :: Server Authority Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0299"
	S.key = "arkher.net.serverauthority.latency_analysis"
	S.name = "Server Authority Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverauthority.audit_ledger" }
	S.tags = { "r", "serverauthority", "analyzer", "net" }
	S.description = "Server Authority Latency Analysis: round trip, jitter and loss analysis for the Server Authority subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.serverauthority.latency_analysis", window = 96, buckets = 8, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
