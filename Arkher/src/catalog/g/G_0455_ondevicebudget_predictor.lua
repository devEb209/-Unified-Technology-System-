-- ARKHER SYSTEM G.0455 :: On Device Budget Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0455"
	S.key = "arkher.neural.ondevicebudget.quality_predictor"
	S.name = "On Device Budget Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ondevicebudget.weight_codec" }
	S.tags = { "g", "ondevicebudget", "predictor", "neural" }
	S.description = "On Device Budget Quality Predictor: predicted quality and cost of a setting for the On Device Budget subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.ondevicebudget.quality_predictor", method = "ema", alpha = 0.39, window = 125 })
		inst.system = S
		inst.ctx = ctx
