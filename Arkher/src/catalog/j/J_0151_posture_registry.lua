-- ARKHER SYSTEM J.0151 :: Posture Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0151"
	S.key = "arkher.character.posture.variant_registry"
	S.name = "Posture Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.posture.appearance_composer" }
	S.tags = { "j", "posture", "registry", "character" }
	S.description = "Posture Variant Registry: named character variants and their lifecycle for the Posture subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.posture.variant_registry" })
		inst.system = S
		inst.ctx = ctx
