-- ARKHER SYSTEM VC.0426 :: Navigation Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0426"
	S.key = "arkher.contneural.navcont.coherence_guard"
	S.name = "Navigation Continuum Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.navcont.persistent_state" }
	S.tags = { "vc", "navcont", "coherence", "contneural" }
	S.description = "Navigation Continuum Coherence Guard: seam coherence and drift supervision for the Navigation Continuum subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.navcont.coherence_guard", window = 82, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
