-- ARKHER SYSTEM Z.0640 :: Intent Driven Authoring Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0640"
	S.key = "arkher.origin.intentauthoring.orchestration"
	S.name = "Intent Driven Authoring Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.residency_streaming" }
	S.tags = { "z", "intentauthoring", "orchestrator", "origin" }
	S.description = "Intent Driven Authoring Orchestration: lifecycle and phase orchestration of the technology for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.intentauthoring.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
