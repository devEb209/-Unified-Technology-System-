-- ARKHER SYSTEM E.0235 :: Layer Blending Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0235"
	S.key = "arkher.material.layerblend.quality_policy"
	S.name = "Layer Blending Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.layerblend.compression_codec" }
	S.tags = { "e", "layerblend", "policy", "material" }
	S.description = "Layer Blending Quality Policy: device tier rules for the surface for the Layer Blending subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.layerblend.quality_policy", algorithm = "wfq", starvationGuard = 46 })
		inst.system = S
		inst.ctx = ctx
