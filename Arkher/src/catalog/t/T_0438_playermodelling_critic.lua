-- ARKHER SYSTEM T.0438 :: Player Modelling Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0438"
	S.key = "arkher.ai.playermodelling.self_critique"
	S.name = "Player Modelling Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.playermodelling.plan_workflow" }
	S.tags = { "t", "playermodelling", "critic", "ai" }
	S.description = "Player Modelling Self Critique: weighted evaluation of the result against declared criteria for the Player Modelling subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.playermodelling.self_critique", passMark = 0.72, reviseMark = 0.42, seed = 58532 })
		inst.system = S
		inst.ctx = ctx
