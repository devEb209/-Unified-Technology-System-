-- ARKHER SYSTEM P.0340 :: Cooldown Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0340"
	S.key = "arkher.play.cooldown.combat_resolution"
	S.name = "Cooldown Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Cooldown"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.cooldown.objectives" }
	S.tags = { "p", "cooldown", "combat", "play" }
	S.description = "Cooldown Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Cooldown subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.cooldown.combat_resolution", seed = 62597, armourK = 130, critMultiplier = 2.00 })
		inst.system = S
		inst.ctx = ctx
