-- ARKHER SYSTEM Z.0258 :: AI Native Engine Architecture Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0258"
	S.key = "arkher.origin.ainative.budget_governor"
	S.name = "AI Native Engine Architecture Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.ainative.behaviour_analysis" }
	S.tags = { "z", "ainative", "budgeter", "origin" }
	S.description = "AI Native Engine Architecture Budget Governor: allocation of a scarce resource across the technology's consumers for the AI Native Engine Architecture subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.ainative.budget_governor", total = 424, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
