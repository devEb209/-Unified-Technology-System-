-- ARKHER SYSTEM W.0326 :: Exposure Ramp Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0326"
	S.key = "arkher.cine.exposureramp.camera_rig"
	S.name = "Exposure Ramp Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.exposureramp.sequence_timeline" }
	S.tags = { "w", "exposureramp", "camerarig", "cine" }
	S.description = "Exposure Ramp Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Exposure Ramp subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.exposureramp.camera_rig", fov = 0.92, focus = 6.0, aperture = 2.4, smoothing = 12.0, distance = 8, height = 4 })
		inst.system = S
		inst.ctx = ctx
