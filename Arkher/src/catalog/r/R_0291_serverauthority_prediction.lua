-- ARKHER SYSTEM R.0291 :: Server Authority Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0291"
	S.key = "arkher.net.serverauthority.prediction_and_reconciliation"
	S.name = "Server Authority Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverauthority.time_sync" }
	S.tags = { "r", "serverauthority", "prediction", "net" }
	S.description = "Server Authority Prediction And Reconciliation: client simulation, correction and input replay for the Server Authority subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.serverauthority.prediction_and_reconciliation", errorThreshold = 0.070, smoothing = 16.0, maxInputs = 100 })
		inst.system = S
		inst.ctx = ctx
