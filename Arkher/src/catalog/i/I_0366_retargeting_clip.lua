-- ARKHER SYSTEM I.0366 :: Retargeting Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0366"
	S.key = "arkher.anim.retargeting.clip_sampling"
	S.name = "Retargeting Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Retargeting"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.retargeting.skeleton" }
	S.tags = { "i", "retargeting", "clip", "anim" }
	S.description = "Retargeting Clip Sampling: keyframe tracks sampled, retimed and evented for the Retargeting subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.retargeting.clip_sampling", duration = 2.70, loop = true })
		inst.system = S
		inst.ctx = ctx
