-- ARKHER SYSTEM VB.0193 :: Architect District Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0193"
	S.key = "arkher.conttime.architectdistrict.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "architectdistrict", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.architectdistrict.infinite_grid", cellSize = 160, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
