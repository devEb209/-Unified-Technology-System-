-- ARKHER SYSTEM VB.0133 :: Fidelity Band Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0133"
	S.key = "arkher.conttime.fidelityband.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "fidelityband", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.fidelityband.infinite_grid", cellSize = 64, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
