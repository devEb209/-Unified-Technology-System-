-- ARKHER SYSTEM N.0496 :: Environment Ambience Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0496"
	S.key = "arkher.vfx.envambience.particle_simulation"
	S.name = "Environment Ambience Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.envambience.emission" }
	S.tags = { "n", "envambience", "particles", "vfx" }
	S.description = "Environment Ambience Particle Simulation: pooled integration of position, velocity, colour and life for the Environment Ambience subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.envambience.particle_simulation", capacity = 320, drag = 0.08, bounce = 0.23, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
