-- ARKHER SYSTEM L.0504 :: War State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0504"
	S.key = "arkher.sim.war.state_codec"
	S.name = "War State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.war.history_ledger" }
	S.tags = { "l", "war", "codec", "sim" }
	S.description = "War State Codec: persistence, diffing and checksum of the world state for the War subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.war.state_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
