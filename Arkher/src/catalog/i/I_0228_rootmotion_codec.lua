-- ARKHER SYSTEM I.0228 :: Root Motion Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0228"
	S.key = "arkher.anim.rootmotion.compression_codec"
	S.name = "Root Motion Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Root Motion"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.rootmotion.retarget_graph" }
	S.tags = { "i", "rootmotion", "codec", "anim" }
	S.description = "Root Motion Compression Codec: curve compression and quantized transport for the Root Motion subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.rootmotion.compression_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
