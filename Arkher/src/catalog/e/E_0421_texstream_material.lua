-- ARKHER SYSTEM E.0421 :: Texture Streaming Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0421"
	S.key = "arkher.material.texstream.definition"
	S.name = "Texture Streaming Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "texstream", "material", "material" }
	S.description = "Texture Streaming Definition: layered PBR definition resolved into parameters for the Texture Streaming subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.texstream.definition", texelBudget = 524288 })
		inst.system = S
		inst.ctx = ctx
