--!strict
-- 3dsMax Stack — ANIMATION Map #0143
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="3dsMax Stack — ANIMATION Map #0143", size=Vector2.new(680, 480), pos=UDim2.fromOffset(359, 171), parent=parent, icon="◈"})
