-- ARKHER SYSTEM V.0413 :: Asset Search Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0413"
	S.key = "arkher.asset.assetsearch.dependency_graph"
	S.name = "Asset Search Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetsearch.asset_registry" }
	S.tags = { "v", "assetsearch", "graph", "asset" }
	S.description = "Asset Search Dependency Graph: what references what, and in which order it must be built for the Asset Search subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.assetsearch.dependency_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
