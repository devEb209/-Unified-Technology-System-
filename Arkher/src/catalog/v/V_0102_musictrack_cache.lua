-- ARKHER SYSTEM V.0102 :: Music Track Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0102"
	S.key = "arkher.asset.musictrack.content_cache"
	S.name = "Music Track Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.musictrack.dependency_graph" }
	S.tags = { "v", "musictrack", "cache", "asset" }
	S.description = "Music Track Content Cache: reuse of already cooked results for the Music Track subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.musictrack.content_cache", policy = "lfu", capacity = 414, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
