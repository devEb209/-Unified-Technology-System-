-- ARKHER SYSTEM F.0677 :: Console Path Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0677"
	S.key = "arkher.render.consolepath.lighting_rig"
	S.name = "Console Path Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Console Path"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.consolepath.geometry_virtualization" }
	S.tags = { "f", "consolepath", "lightrig", "render" }
	S.description = "Console Path Lighting Rig: light clustering, importance and cascades for the Console Path subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.consolepath.lighting_rig", maxActive = 10 })
		inst.system = S
		inst.ctx = ctx
