-- ARKHER SYSTEM H.0648 :: Wheel Suspension Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0648"
	S.key = "arkher.physics.suspension.constraint_solver"
	S.name = "Wheel Suspension Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.suspension.contact_generation" }
	S.tags = { "h", "suspension", "constraint", "physics" }
	S.description = "Wheel Suspension Constraint Solver: sequential impulses, friction, joints and warm starting for the Wheel Suspension subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.suspension.constraint_solver", iterations = 11, baumgarte = 0.17, warmStart = true })
		inst.system = S
		inst.ctx = ctx
