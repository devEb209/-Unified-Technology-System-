-- ARKHER SYSTEM I.0514 :: Animation Debug Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0514"
	S.key = "arkher.anim.animdebug.compression_codec"
	S.name = "Animation Debug Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animdebug.retarget_graph" }
	S.tags = { "i", "animdebug", "codec", "anim" }
	S.description = "Animation Debug Compression Codec: curve compression and quantized transport for the Animation Debug subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.animdebug.compression_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
