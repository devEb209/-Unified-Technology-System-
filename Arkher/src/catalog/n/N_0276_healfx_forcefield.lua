-- ARKHER SYSTEM N.0276 :: Heal Effect Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0276"
	S.key = "arkher.vfx.healfx.force_field"
	S.name = "Heal Effect Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Heal Effect"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.healfx.particle_simulation" }
	S.tags = { "n", "healfx", "forcefield", "vfx" }
	S.description = "Heal Effect Force Field: wind, attraction, vortex, drag and curl turbulence for the Heal Effect subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.healfx.force_field", seed = 93733 })
		inst.system = S
		inst.ctx = ctx
