-- ARKHER SYSTEM G.0407 :: Drift Detection Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0407"
	S.key = "arkher.neural.drift.inference_core"
	S.name = "Drift Detection Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "drift", "inference", "neural" }
	S.description = "Drift Detection Inference Core: dense network forward pass and training for the Drift Detection subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.drift.inference_core", seed = 94639 })
		inst.system = S
		inst.ctx = ctx
