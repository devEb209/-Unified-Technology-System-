-- ARKHER SYSTEM Z.0509 :: Economic Emergence Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0509"
	S.key = "arkher.origin.economicemergence.intent_bridge"
	S.name = "Economic Emergence Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.economicemergence.semantic_graph" }
	S.tags = { "z", "economicemergence", "intent", "origin" }
	S.description = "Economic Emergence Intent Bridge: natural language control surface for the technology for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.economicemergence.intent_bridge", minConfidence = 0.37 })
		inst.system = S
		inst.ctx = ctx
