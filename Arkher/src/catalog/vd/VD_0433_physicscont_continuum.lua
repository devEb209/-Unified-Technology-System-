-- ARKHER SYSTEM VD.0433 :: Physics Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0433"
	S.key = "arkher.contsim.physicscont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "physicscont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.physicscont.infinite_grid", cellSize = 64, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
