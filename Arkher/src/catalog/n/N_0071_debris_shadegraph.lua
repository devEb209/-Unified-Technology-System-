-- ARKHER SYSTEM N.0071 :: Debris Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0071"
	S.key = "arkher.vfx.debris.effect_graph"
	S.name = "Debris Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Debris"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.debris.curve_authoring" }
	S.tags = { "n", "debris", "shadegraph", "vfx" }
	S.description = "Debris Effect Graph: node graph describing how the effect is shaded for the Debris subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.debris.effect_graph" })
		inst.system = S
		inst.ctx = ctx
