-- ARKHER SYSTEM VB.0579 :: Thermal Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0579"
	S.key = "arkher.conttime.thermalcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.thermalcont.epoch_clock" }
	S.tags = { "vb", "thermalcont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.thermalcont.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
