-- ARKHER SYSTEM P.0244 :: Objective Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0244"
	S.key = "arkher.play.objective.combat_resolution"
	S.name = "Objective Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Objective"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.objective.objectives" }
	S.tags = { "p", "objective", "combat", "play" }
	S.description = "Objective Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Objective subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.objective.combat_resolution", seed = 63964, armourK = 120, critMultiplier = 1.90 })
		inst.system = S
		inst.ctx = ctx
