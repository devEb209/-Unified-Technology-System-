-- ARKHER SYSTEM J.0029 :: Body Proportions Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0029"
	S.key = "arkher.character.proportions.appearance_composer"
	S.name = "Body Proportions Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.proportions.locomotion" }
	S.tags = { "j", "proportions", "composer", "character" }
	S.description = "Body Proportions Appearance Composer: composition of appearance slots into a look for the Body Proportions subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.proportions.appearance_composer", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
