-- ARKHER SYSTEM K.0409 :: Interruption Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0409"
	S.key = "arkher.npc.interruption.drive_system"
	S.name = "Interruption Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.interruption.memory" }
	S.tags = { "k", "interruption", "need", "npc" }
	S.description = "Interruption Drive System: drives that decay, turn urgent and get satisfied for the Interruption subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.interruption.drive_system" })
		inst.system = S
		inst.ctx = ctx
