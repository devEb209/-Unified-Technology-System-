-- ARKHER SYSTEM P.0113 :: Equipment State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0113"
	S.key = "arkher.play.equipment.state_machine"
	S.name = "Equipment State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Equipment"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.equipment.combat_resolution" }
	S.tags = { "p", "equipment", "orchestrator", "play" }
	S.description = "Equipment State Machine: the phase machine that drives this gameplay loop for the Equipment subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.equipment.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
