-- ARKHER SYSTEM VD.0560 :: Device Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0560"
	S.key = "arkher.contsim.devicecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.devicecont.neural_field" }
	S.tags = { "vd", "devicecont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.devicecont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
