-- ARKHER SYSTEM R.0134 :: Unreliable Channel Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0134"
	S.key = "arkher.net.unreliablechannel.time_sync"
	S.name = "Unreliable Channel Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.unreliablechannel.replication" }
	S.tags = { "r", "unreliablechannel", "netclock", "net" }
	S.description = "Unreliable Channel Time Sync: offset estimation, outlier rejection and jitter buffering for the Unreliable Channel subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.unreliablechannel.time_sync", tickRate = 30, bufferDelay = 0.070, maxSamples = 9 })
		inst.system = S
		inst.ctx = ctx
