-- ARKHER SYSTEM E.0361 :: Vertex Painting Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0361"
	S.key = "arkher.material.vertexpaint.definition"
	S.name = "Vertex Painting Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "vertexpaint", "material", "material" }
	S.description = "Vertex Painting Definition: layered PBR definition resolved into parameters for the Vertex Painting subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.vertexpaint.definition", texelBudget = 786432 })
		inst.system = S
		inst.ctx = ctx
