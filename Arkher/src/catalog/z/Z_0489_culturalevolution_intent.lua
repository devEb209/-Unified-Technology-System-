-- ARKHER SYSTEM Z.0489 :: Cultural Evolution Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0489"
	S.key = "arkher.origin.culturalevolution.intent_bridge"
	S.name = "Cultural Evolution Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.semantic_graph" }
	S.tags = { "z", "culturalevolution", "intent", "origin" }
	S.description = "Cultural Evolution Intent Bridge: natural language control surface for the technology for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.culturalevolution.intent_bridge", minConfidence = 0.34 })
		inst.system = S
		inst.ctx = ctx
