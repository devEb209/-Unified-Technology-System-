-- ARKHER SYSTEM VA.0420 :: Behaviour Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0420"
	S.key = "arkher.contworld.behaviourcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.behaviourcont.reality_continuum" }
	S.tags = { "va", "behaviourcont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.behaviourcont.emergence_continuum", windowSize = 7, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
