-- ARKHER SYSTEM F.0058 :: Shadow Pass View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0058"
	S.key = "arkher.render.shadowpass.view_and_culling"
	S.name = "Shadow Pass View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Shadow Pass"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.shadowpass.frame_graph" }
	S.tags = { "f", "shadowpass", "camera", "render" }
	S.description = "Shadow Pass View And Culling: view state, frustum culling and screen-size LOD for the Shadow Pass subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.shadowpass.view_and_culling", width = 956, height = 720, fov = 1.0600, far = 1200 })
		inst.system = S
		inst.ctx = ctx
