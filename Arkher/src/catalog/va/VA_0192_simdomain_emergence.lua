-- ARKHER SYSTEM VA.0192 :: Simulation Domain Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0192"
	S.key = "arkher.contworld.simdomain.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.simdomain.reality_continuum" }
	S.tags = { "va", "simdomain", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.simdomain.emergence_continuum", windowSize = 6, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
