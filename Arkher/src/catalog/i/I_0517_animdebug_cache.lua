-- ARKHER SYSTEM I.0517 :: Animation Debug Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0517"
	S.key = "arkher.anim.animdebug.pose_cache"
	S.name = "Animation Debug Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animdebug.playback_pipeline" }
	S.tags = { "i", "animdebug", "cache", "anim" }
	S.description = "Animation Debug Pose Cache: reuse of sampled poses across frames and instances for the Animation Debug subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.animdebug.pose_cache", policy = "ttl", capacity = 105, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
