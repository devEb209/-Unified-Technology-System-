-- ARKHER SYSTEM VA.0276 :: Bridge Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0276"
	S.key = "arkher.contworld.bridgecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.bridgecont.reality_continuum" }
	S.tags = { "va", "bridgecont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.bridgecont.emergence_continuum", windowSize = 7, threshold = 1.60, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
