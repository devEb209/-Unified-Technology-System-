-- ARKHER SYSTEM E.0301 :: Dust Accumulation Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0301"
	S.key = "arkher.material.dust.definition"
	S.name = "Dust Accumulation Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "dust", "material", "material" }
	S.description = "Dust Accumulation Definition: layered PBR definition resolved into parameters for the Dust Accumulation subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.dust.definition", texelBudget = 1572864 })
		inst.system = S
		inst.ctx = ctx
