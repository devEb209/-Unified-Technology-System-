-- ARKHER SYSTEM J.0258 :: Damage State Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0258"
	S.key = "arkher.character.damagestate.physical_response"
	S.name = "Damage State Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.damagestate.look_and_reach" }
	S.tags = { "j", "damagestate", "ragdoll", "character" }
	S.description = "Damage State Physical Response: physical reaction, ragdoll and recovery for the Damage State subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.damagestate.physical_response", blendSpeed = 4.50 })
		inst.system = S
		inst.ctx = ctx
