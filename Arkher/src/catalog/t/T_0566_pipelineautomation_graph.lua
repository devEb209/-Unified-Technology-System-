-- ARKHER SYSTEM T.0566 :: Pipeline Automation Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0566"
	S.key = "arkher.ai.pipelineautomation.reasoning_graph"
	S.name = "Pipeline Automation Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.pipelineautomation.world_architect" }
	S.tags = { "t", "pipelineautomation", "graph", "ai" }
	S.description = "Pipeline Automation Reasoning Graph: relationship modelling and shortest-path reasoning for the Pipeline Automation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.pipelineautomation.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
