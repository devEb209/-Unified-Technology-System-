-- ARKHER SYSTEM VC.0087 :: Residency Window Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0087"
	S.key = "arkher.contneural.residencywindow.sparse_residency"
	S.name = "Residency Window Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.residencywindow.epoch_clock" }
	S.tags = { "vc", "residencywindow", "sparse", "contneural" }
	S.description = "Residency Window Sparse Residency: sparse page residency with eviction and compression for the Residency Window subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.residencywindow.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
