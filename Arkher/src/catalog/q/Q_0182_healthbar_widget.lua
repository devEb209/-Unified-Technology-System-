-- ARKHER SYSTEM Q.0182 :: Health Bar Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0182"
	S.key = "arkher.ui.healthbar.widget_tree"
	S.name = "Health Bar Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Health Bar"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.healthbar.responsive_layout" }
	S.tags = { "q", "healthbar", "widget", "ui" }
	S.description = "Health Bar Widget Tree: retained widget nodes, properties, bindings and rendering for the Health Bar subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.healthbar.widget_tree", theme = "dark", scale = 1.10 })
		inst.system = S
		inst.ctx = ctx
