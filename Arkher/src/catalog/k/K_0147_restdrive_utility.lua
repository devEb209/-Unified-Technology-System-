-- ARKHER SYSTEM K.0147 :: Rest Drive Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0147"
	S.key = "arkher.npc.restdrive.utility_reasoning"
	S.name = "Rest Drive Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.restdrive.reactive_behaviour" }
	S.tags = { "k", "restdrive", "utility", "npc" }
	S.description = "Rest Drive Utility Reasoning: scored option selection with response curves for the Rest Drive subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.restdrive.utility_reasoning", momentum = 0.18 })
		inst.system = S
		inst.ctx = ctx
