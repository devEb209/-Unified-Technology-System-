-- ARKHER SYSTEM Z.0999 :: Engine Self Model Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0999"
	S.key = "arkher.origin.engineselfmodel.residency_streaming"
	S.name = "Engine Self Model Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.engineselfmodel.budget_governor" }
	S.tags = { "z", "engineselfmodel", "streamer", "origin" }
	S.description = "Engine Self Model Residency Streaming: distance-driven residency of the technology's workload for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.engineselfmodel.residency_streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
