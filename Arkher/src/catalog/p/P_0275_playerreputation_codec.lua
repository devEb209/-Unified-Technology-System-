-- ARKHER SYSTEM P.0275 :: Reputation Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0275"
	S.key = "arkher.play.playerreputation.save_codec"
	S.name = "Reputation Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Reputation"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playerreputation.content_registry" }
	S.tags = { "p", "playerreputation", "codec", "play" }
	S.description = "Reputation Save Codec: persistence, diffing and checksum of gameplay state for the Reputation subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.playerreputation.save_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
