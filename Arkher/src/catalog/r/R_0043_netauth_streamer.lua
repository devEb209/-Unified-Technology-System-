-- ARKHER SYSTEM R.0043 :: Authentication Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0043"
	S.key = "arkher.net.netauth.interest_streaming"
	S.name = "Authentication Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netauth.serialization_codec" }
	S.tags = { "r", "netauth", "streamer", "net" }
	S.description = "Authentication Interest Streaming: distance-driven residency of replicated content for the Authentication subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.netauth.interest_streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
