-- ARKHER SYSTEM F.0222 :: Cloud Rendering Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0222"
	S.key = "arkher.render.clouds.frame_analysis"
	S.name = "Cloud Rendering Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.clouds.pass_cache" }
	S.tags = { "f", "clouds", "analyzer", "render" }
	S.description = "Cloud Rendering Frame Analysis: per-pass cost analysis and outlier detection for the Cloud Rendering subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.clouds.frame_analysis", window = 241, buckets = 9, threshold = 3.30 })
		inst.system = S
		inst.ctx = ctx
