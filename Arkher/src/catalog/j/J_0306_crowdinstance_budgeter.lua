-- ARKHER SYSTEM J.0306 :: Crowd Instance Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0306"
	S.key = "arkher.character.crowdinstance.budget_governor"
	S.name = "Crowd Instance Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.crowdinstance.variant_registry" }
	S.tags = { "j", "crowdinstance", "budgeter", "character" }
	S.description = "Crowd Instance Budget Governor: per-character cost allocation in a crowd for the Crowd Instance subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.crowdinstance.budget_governor", total = 301, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
