-- ARKHER SYSTEM Z.0218 :: Persistent Reality State Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0218"
	S.key = "arkher.origin.persistentreality.budget_governor"
	S.name = "Persistent Reality State Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.behaviour_analysis" }
	S.tags = { "z", "persistentreality", "budgeter", "origin" }
	S.description = "Persistent Reality State Budget Governor: allocation of a scarce resource across the technology's consumers for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.persistentreality.budget_governor", total = 376, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
