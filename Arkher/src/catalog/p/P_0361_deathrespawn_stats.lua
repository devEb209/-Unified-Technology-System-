-- ARKHER SYSTEM P.0361 :: Death And Respawn Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0361"
	S.key = "arkher.play.deathrespawn.attributes"
	S.name = "Death And Respawn Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "deathrespawn", "stats", "play" }
	S.description = "Death And Respawn Attributes: base values, layered modifiers and derived statistics for the Death And Respawn subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.deathrespawn.attributes" })
		inst.system = S
		inst.ctx = ctx
