-- ARKHER SYSTEM VC.0031 :: Zone Chunk Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0031"
	S.key = "arkher.contneural.zonechunk.neural_field"
	S.name = "Zone Chunk Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.zonechunk.coherence_guard" }
	S.tags = { "vc", "zonechunk", "neuralfield", "contneural" }
	S.description = "Zone Chunk Neural Field: neural field encoding and reconstruction for the Zone Chunk subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.zonechunk.neural_field", dims = 16, hidden = 12, seed = 46865 })
		inst.system = S
		inst.ctx = ctx
