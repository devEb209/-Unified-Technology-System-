-- ARKHER SYSTEM W.0001 :: Shot Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0001"
	S.key = "arkher.cine.shot.sequence_timeline"
	S.name = "Shot Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Shot"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "shot", "timeline", "cine" }
	S.description = "Shot Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Shot subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.shot.sequence_timeline", duration = 8.0, rate = 0.92 })
		inst.system = S
		inst.ctx = ctx
