-- ARKHER SYSTEM J.0229 :: Character Variant Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0229"
	S.key = "arkher.character.charvariant.budget_governor"
	S.name = "Character Variant Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.charvariant.variant_registry" }
	S.tags = { "j", "charvariant", "budgeter", "character" }
	S.description = "Character Variant Budget Governor: per-character cost allocation in a crowd for the Character Variant subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.charvariant.budget_governor", total = 357, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
