-- ARKHER SYSTEM VD.0084 :: LOD Cascade Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0084"
	S.key = "arkher.contsim.lodcascade.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lodcascade.reality_continuum" }
	S.tags = { "vd", "lodcascade", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.lodcascade.emergence_continuum", windowSize = 6, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
