-- ARKHER SYSTEM VD.0130 :: Spatial Slice Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0130"
	S.key = "arkher.contsim.spatialslice.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.spatialslice.complexity_budget" }
	S.tags = { "vd", "spatialslice", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.spatialslice.simulation_fabric", budgetMs = 4.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
