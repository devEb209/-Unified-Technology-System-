-- ARKHER SYSTEM N.0014 :: Smoke Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0014"
	S.key = "arkher.vfx.smoke.emission"
	S.name = "Smoke Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Smoke"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "smoke", "emitter", "vfx" }
	S.description = "Smoke Emission: shaped, rate and burst emission of new particles for the Smoke subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.smoke.emission", shape = "point", rate = 47, speed = 5.70, life = 3.50, budget = 320, seed = 34587 })
		inst.system = S
		inst.ctx = ctx
