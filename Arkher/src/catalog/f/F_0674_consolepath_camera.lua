-- ARKHER SYSTEM F.0674 :: Console Path View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0674"
	S.key = "arkher.render.consolepath.view_and_culling"
	S.name = "Console Path View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Console Path"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.consolepath.frame_graph" }
	S.tags = { "f", "consolepath", "camera", "render" }
	S.description = "Console Path View And Culling: view state, frustum culling and screen-size LOD for the Console Path subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.consolepath.view_and_culling", width = 1084, height = 1080, fov = 1.1200, far = 1600 })
		inst.system = S
		inst.ctx = ctx
