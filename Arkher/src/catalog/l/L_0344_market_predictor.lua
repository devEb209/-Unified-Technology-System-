-- ARKHER SYSTEM L.0344 :: Market Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0344"
	S.key = "arkher.sim.market.forecast"
	S.name = "Market Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.market.analysis" }
	S.tags = { "l", "market", "predictor", "sim" }
	S.description = "Market Forecast: prediction of the region's next state for the Market subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.market.forecast", method = "markov", alpha = 0.49, window = 103 })
		inst.system = S
		inst.ctx = ctx
