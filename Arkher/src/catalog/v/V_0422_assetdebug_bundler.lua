-- ARKHER SYSTEM V.0422 :: Asset Debug Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0422"
	S.key = "arkher.asset.assetdebug.bundling"
	S.name = "Asset Debug Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetdebug.import" }
	S.tags = { "v", "assetdebug", "bundler", "asset" }
	S.description = "Asset Debug Bundling: size-bounded packing, manifests and delta patches for the Asset Debug subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.assetdebug.bundling", maxBundleBytes = 524288 })
		inst.system = S
		inst.ctx = ctx
