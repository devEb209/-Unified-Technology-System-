-- ARKHER SYSTEM G.0310 :: Weight Quantization Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0310"
	S.key = "arkher.neural.quantization.feature_extraction"
	S.name = "Weight Quantization Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.quantization.inference_core" }
	S.tags = { "g", "quantization", "field", "neural" }
	S.description = "Weight Quantization Feature Extraction: signal features feeding the model for the Weight Quantization subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.quantization.feature_extraction", seed = 49504, frequency = 0.0100, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
