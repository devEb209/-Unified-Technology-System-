-- ARKHER SYSTEM VD.0603 :: Seam Lattice Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0603"
	S.key = "arkher.contsim.seamlattice.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.seamlattice.epoch_clock" }
	S.tags = { "vd", "seamlattice", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.seamlattice.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
