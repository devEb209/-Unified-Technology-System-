-- ARKHER SYSTEM I.0460 :: Procedural Animation Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0460"
	S.key = "arkher.anim.proceduralanim.physical_blend"
	S.name = "Procedural Animation Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.proceduralanim.inverse_kinematics" }
	S.tags = { "i", "proceduralanim", "ragdoll", "anim" }
	S.description = "Procedural Animation Physical Blend: physical bones blended against the animated pose for the Procedural Animation subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.proceduralanim.physical_blend", blendSpeed = 4.10 })
		inst.system = S
		inst.ctx = ctx
