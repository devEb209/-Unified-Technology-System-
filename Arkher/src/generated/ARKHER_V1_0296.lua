--!strict
-- RAGE ImGui — CORE Node_Flow #0296
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="RAGE ImGui — CORE Node_Flow #0296", size=Vector2.new(680, 440), pos=UDim2.fromOffset(348, 172), parent=parent, icon="☷"})
