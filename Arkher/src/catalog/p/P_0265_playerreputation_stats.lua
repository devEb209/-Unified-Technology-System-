-- ARKHER SYSTEM P.0265 :: Reputation Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0265"
	S.key = "arkher.play.playerreputation.attributes"
	S.name = "Reputation Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Reputation"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "playerreputation", "stats", "play" }
	S.description = "Reputation Attributes: base values, layered modifiers and derived statistics for the Reputation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.playerreputation.attributes" })
		inst.system = S
		inst.ctx = ctx
