-- ARKHER SYSTEM I.0207 :: State Machine Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0207"
	S.key = "arkher.anim.animstate.analysis"
	S.name = "State Machine Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstate.quality_policy" }
	S.tags = { "i", "animstate", "analyzer", "anim" }
	S.description = "State Machine Analysis: pop, drift and cost analysis of playback for the State Machine subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.animstate.analysis", window = 139, buckets = 19, threshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
