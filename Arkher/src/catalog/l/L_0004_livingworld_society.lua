-- ARKHER SYSTEM L.0004 :: Living World Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0004"
	S.key = "arkher.sim.livingworld.society"
	S.name = "Living World Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livingworld.economy" }
	S.tags = { "l", "livingworld", "society", "sim" }
	S.description = "Living World Society: relations, factions, reputation and cohesion of the region for the Living World subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.livingworld.society", decayRate = 0.007, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
