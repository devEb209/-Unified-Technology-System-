-- ARKHER SYSTEM Z.0002 :: Adaptive World Intelligence Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0002"
	S.key = "arkher.origin.adaptiveworld.complexity_governance"
	S.name = "Adaptive World Intelligence Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.adaptiveworld.reality_layering" }
	S.tags = { "z", "adaptiveworld", "complexity", "origin" }
	S.description = "Adaptive World Intelligence Complexity Governance: measured scene cost turned into per-subsystem directives for the Adaptive World Intelligence subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.adaptiveworld.complexity_governance", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
