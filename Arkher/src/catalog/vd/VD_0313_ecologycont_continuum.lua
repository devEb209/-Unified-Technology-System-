-- ARKHER SYSTEM VD.0313 :: Ecology Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0313"
	S.key = "arkher.contsim.ecologycont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "ecologycont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.ecologycont.infinite_grid", cellSize = 224, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
