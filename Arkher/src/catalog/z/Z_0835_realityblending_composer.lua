-- ARKHER SYSTEM Z.0835 :: Reality Blending Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0835"
	S.key = "arkher.origin.realityblending.signal_composition"
	S.name = "Reality Blending Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.telemetry_ledger" }
	S.tags = { "z", "realityblending", "composer", "origin" }
	S.description = "Reality Blending Signal Composition: blending of the technology's input signals into one output for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.realityblending.signal_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
