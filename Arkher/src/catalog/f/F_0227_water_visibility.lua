-- ARKHER SYSTEM F.0227 :: Water Rendering Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0227"
	S.key = "arkher.render.water.visibility_set"
	S.name = "Water Rendering Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.water.view_and_culling" }
	S.tags = { "f", "water", "visibility", "render" }
	S.description = "Water Rendering Visibility Set: cell, portal and occluder visibility for the Water Rendering subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.water.visibility_set", maxDepth = 4 })
		inst.system = S
		inst.ctx = ctx
