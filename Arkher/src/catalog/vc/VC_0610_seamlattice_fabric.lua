-- ARKHER SYSTEM VC.0610 :: Seam Lattice Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0610"
	S.key = "arkher.contneural.seamlattice.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.seamlattice.complexity_budget" }
	S.tags = { "vc", "seamlattice", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.seamlattice.simulation_fabric", budgetMs = 3.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
