-- ARKHER SYSTEM Q.0062 :: List Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0062"
	S.key = "arkher.ui.list.widget_tree"
	S.name = "List Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "List"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.list.responsive_layout" }
	S.tags = { "q", "list", "widget", "ui" }
	S.description = "List Widget Tree: retained widget nodes, properties, bindings and rendering for the List subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.list.widget_tree", theme = "highcontrast", scale = 1.22 })
		inst.system = S
		inst.ctx = ctx
