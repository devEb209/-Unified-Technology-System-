-- ARKHER SYSTEM VC.0003 :: World Grid Cell Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0003"
	S.key = "arkher.contneural.worldcell.sparse_residency"
	S.name = "World Grid Cell Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldcell.epoch_clock" }
	S.tags = { "vc", "worldcell", "sparse", "contneural" }
	S.description = "World Grid Cell Sparse Residency: sparse page residency with eviction and compression for the World Grid Cell subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.worldcell.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
