--!strict
-- Cinema4D — ANIMATION Profiler #0029
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Cinema4D — ANIMATION Profiler #0029", size=Vector2.new(680, 500), pos=UDim2.fromOffset(477, 313), parent=parent, icon="↻"})
