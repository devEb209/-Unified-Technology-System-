-- ARKHER SYSTEM VD.0472 :: VFX Continuum Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0472"
	S.key = "arkher.contsim.vfxcont.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vfxcont.sparse_residency" }
	S.tags = { "vd", "vfxcont", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.vfxcont.multi-scale_fidelity", levels = 4, baseTriangles = 120000 })
		inst.system = S
		inst.ctx = ctx
