-- ARKHER SYSTEM K.0426 :: Pathfinding Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0426"
	S.key = "arkher.npc.pathfinding.reactive_behaviour"
	S.name = "Pathfinding Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.pathfinding.perception" }
	S.tags = { "k", "pathfinding", "behaviortree", "npc" }
	S.description = "Pathfinding Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Pathfinding subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.pathfinding.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
