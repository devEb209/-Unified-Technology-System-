-- ARKHER SYSTEM O.0319 :: Vehicle Audio Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0319"
	S.key = "arkher.audio.vehicleaudio.asset_registry"
	S.name = "Vehicle Audio Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.vehicleaudio.streaming" }
	S.tags = { "o", "vehicleaudio", "registry", "audio" }
	S.description = "Vehicle Audio Asset Registry: catalogue of sounds, variations and metadata for the Vehicle Audio subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.vehicleaudio.asset_registry" })
		inst.system = S
		inst.ctx = ctx
