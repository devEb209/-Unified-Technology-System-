-- ARKHER SYSTEM L.0065 :: Population Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0065"
	S.key = "arkher.sim.population.calendar"
	S.name = "Population Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.population.society" }
	S.tags = { "l", "population", "schedule", "sim" }
	S.description = "Population Calendar: hours, days and seasons driving the region for the Population subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.population.calendar", startHour = 6 })
		inst.system = S
		inst.ctx = ctx
