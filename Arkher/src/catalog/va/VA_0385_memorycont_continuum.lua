-- ARKHER SYSTEM VA.0385 :: Memory Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0385"
	S.key = "arkher.contworld.memorycont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "memorycont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.memorycont.infinite_grid", cellSize = 160, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
