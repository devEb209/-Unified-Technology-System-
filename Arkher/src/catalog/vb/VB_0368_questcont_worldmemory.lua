-- ARKHER SYSTEM VB.0368 :: Quest Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0368"
	S.key = "arkher.conttime.questcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.questcont.neural_field" }
	S.tags = { "vb", "questcont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.questcont.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
