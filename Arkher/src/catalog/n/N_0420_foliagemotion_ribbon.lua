-- ARKHER SYSTEM N.0420 :: Foliage Motion Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0420"
	S.key = "arkher.vfx.foliagemotion.ribbon_and_trail"
	S.name = "Foliage Motion Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.foliagemotion.force_field" }
	S.tags = { "n", "foliagemotion", "ribbon", "vfx" }
	S.description = "Foliage Motion Ribbon And Trail: trail points, tapering, beams and decimation for the Foliage Motion subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.foliagemotion.ribbon_and_trail", maxPoints = 40, lifetime = 2.00, minDistance = 0.35, width = 0.50 })
		inst.system = S
		inst.ctx = ctx
