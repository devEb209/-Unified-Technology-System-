-- ARKHER SYSTEM VA.0241 :: Vegetation Field Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0241"
	S.key = "arkher.contworld.vegfield.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "vegfield", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.vegfield.infinite_grid", cellSize = 64, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
