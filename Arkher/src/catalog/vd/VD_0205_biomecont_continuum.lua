-- ARKHER SYSTEM VD.0205 :: Biome Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0205"
	S.key = "arkher.contsim.biomecont.infinite_grid"
	S.name = "Biome Continuum Infinite Grid"
	S.category = "VD"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "biomecont", "continuum", "contsim" }
	S.description = "Biome Continuum Infinite Grid: seamless paging of the infinite world grid for the Biome Continuum subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.biomecont.infinite_grid", cellSize = 128, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
