-- ARKHER SYSTEM VD.0511 :: Material Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0511"
	S.key = "arkher.contsim.materialcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.materialcont.coherence_guard" }
	S.tags = { "vd", "materialcont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.materialcont.neural_field", dims = 16, hidden = 12, seed = 82017 })
		inst.system = S
		inst.ctx = ctx
