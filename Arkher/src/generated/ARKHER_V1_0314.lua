--!strict
-- OpenWeather — CORE Profiler #0314
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="OpenWeather — CORE Profiler #0314", size=Vector2.new(680, 500), pos=UDim2.fromOffset(182, 218), parent=parent, icon="⚑"})
