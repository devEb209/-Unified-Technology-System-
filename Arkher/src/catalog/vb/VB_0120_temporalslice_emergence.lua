-- ARKHER SYSTEM VB.0120 :: Temporal Slice Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0120"
	S.key = "arkher.conttime.temporalslice.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.temporalslice.reality_continuum" }
	S.tags = { "vb", "temporalslice", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.temporalslice.emergence_continuum", windowSize = 6, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
