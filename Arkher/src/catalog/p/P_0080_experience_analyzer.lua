-- ARKHER SYSTEM P.0080 :: Experience Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0080"
	S.key = "arkher.play.experience.balance_analysis"
	S.name = "Experience Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Experience"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.experience.event_ledger" }
	S.tags = { "p", "experience", "analyzer", "play" }
	S.description = "Experience Balance Analysis: distribution, outlier and pacing analysis for the Experience subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.experience.balance_analysis", window = 137, buckets = 9, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
