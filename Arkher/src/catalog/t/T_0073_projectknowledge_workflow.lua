-- ARKHER SYSTEM T.0073 :: Project Knowledge Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0073"
	S.key = "arkher.ai.projectknowledge.plan_workflow"
	S.name = "Project Knowledge Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.projectknowledge.semantic_knowledge" }
	S.tags = { "t", "projectknowledge", "workflow", "ai" }
	S.description = "Project Knowledge Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Project Knowledge subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.projectknowledge.plan_workflow", maxRetries = 3, budget = 150 })
		inst.system = S
		inst.ctx = ctx
