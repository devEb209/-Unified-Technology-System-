-- ARKHER SYSTEM VC.0547 :: World Fabric Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0547"
	S.key = "arkher.contneural.worldfabric.neural_field"
	S.name = "World Fabric Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldfabric.coherence_guard" }
	S.tags = { "vc", "worldfabric", "neuralfield", "contneural" }
	S.description = "World Fabric Neural Field: neural field encoding and reconstruction for the World Fabric subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.worldfabric.neural_field", dims = 24, hidden = 20, seed = 71099 })
		inst.system = S
		inst.ctx = ctx
