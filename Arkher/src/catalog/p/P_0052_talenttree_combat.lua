-- ARKHER SYSTEM P.0052 :: Talent Tree Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0052"
	S.key = "arkher.play.talenttree.combat_resolution"
	S.name = "Talent Tree Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Talent Tree"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.talenttree.objectives" }
	S.tags = { "p", "talenttree", "combat", "play" }
	S.description = "Talent Tree Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Talent Tree subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.talenttree.combat_resolution", seed = 47502, armourK = 140, critMultiplier = 2.10 })
		inst.system = S
		inst.ctx = ctx
