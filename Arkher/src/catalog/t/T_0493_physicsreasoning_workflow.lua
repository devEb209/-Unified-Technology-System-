-- ARKHER SYSTEM T.0493 :: Physics Reasoning Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0493"
	S.key = "arkher.ai.physicsreasoning.plan_workflow"
	S.name = "Physics Reasoning Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.physicsreasoning.semantic_knowledge" }
	S.tags = { "t", "physicsreasoning", "workflow", "ai" }
	S.description = "Physics Reasoning Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Physics Reasoning subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.physicsreasoning.plan_workflow", maxRetries = 2, budget = 80 })
		inst.system = S
		inst.ctx = ctx
