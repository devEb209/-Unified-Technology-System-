-- ARKHER SYSTEM W.0229 :: Fade Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0229"
	S.key = "arkher.cine.fade.sequence_timeline"
	S.name = "Fade Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Fade"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "fade", "timeline", "cine" }
	S.description = "Fade Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Fade subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.fade.sequence_timeline", duration = 11.0, rate = 0.95 })
		inst.system = S
		inst.ctx = ctx
