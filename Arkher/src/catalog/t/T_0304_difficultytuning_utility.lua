-- ARKHER SYSTEM T.0304 :: Difficulty Tuning Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0304"
	S.key = "arkher.ai.difficultytuning.utility_selection"
	S.name = "Difficulty Tuning Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.difficultytuning.working_memory" }
	S.tags = { "t", "difficultytuning", "utility", "ai" }
	S.description = "Difficulty Tuning Utility Selection: scored choice between competing courses of action for the Difficulty Tuning subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.difficultytuning.utility_selection", momentum = 0.08 })
		inst.system = S
		inst.ctx = ctx
