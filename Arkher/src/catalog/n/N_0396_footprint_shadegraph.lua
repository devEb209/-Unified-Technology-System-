-- ARKHER SYSTEM N.0396 :: Footprint Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0396"
	S.key = "arkher.vfx.footprint.effect_graph"
	S.name = "Footprint Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Footprint"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.footprint.curve_authoring" }
	S.tags = { "n", "footprint", "shadegraph", "vfx" }
	S.description = "Footprint Effect Graph: node graph describing how the effect is shaded for the Footprint subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.footprint.effect_graph" })
		inst.system = S
		inst.ctx = ctx
