-- ARKHER SYSTEM Z.0736 :: Knowledge Distillation Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0736"
	S.key = "arkher.origin.distillation.governance_policy"
	S.name = "Knowledge Distillation Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.distillation.signal_composition" }
	S.tags = { "z", "distillation", "policy", "origin" }
	S.description = "Knowledge Distillation Governance Policy: ordered rules governing when the technology may act for the Knowledge Distillation subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.distillation.governance_policy", algorithm = "lottery", starvationGuard = 39 })
		inst.system = S
		inst.ctx = ctx
