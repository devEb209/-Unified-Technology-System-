-- ARKHER SYSTEM V.0159 :: Particle Asset Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0159"
	S.key = "arkher.asset.particleasset.cook_pipeline"
	S.name = "Particle Asset Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.particleasset.bundling" }
	S.tags = { "v", "particleasset", "pipeline", "asset" }
	S.description = "Particle Asset Cook Pipeline: staged cooking with isolation and retries for the Particle Asset subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.particleasset.cook_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
