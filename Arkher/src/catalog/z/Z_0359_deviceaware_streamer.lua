-- ARKHER SYSTEM Z.0359 :: Device Aware Fidelity Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0359"
	S.key = "arkher.origin.deviceaware.residency_streaming"
	S.name = "Device Aware Fidelity Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.budget_governor" }
	S.tags = { "z", "deviceaware", "streamer", "origin" }
	S.description = "Device Aware Fidelity Residency Streaming: distance-driven residency of the technology's workload for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.deviceaware.residency_streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
