-- ARKHER SYSTEM VB.0371 :: Quest Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0371"
	S.key = "arkher.conttime.questcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.questcont.simulation_fabric" }
	S.tags = { "vb", "questcont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.questcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
