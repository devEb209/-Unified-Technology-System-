-- ARKHER SYSTEM R.0198 :: Client Prediction Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0198"
	S.key = "arkher.net.clientprediction.serialization_codec"
	S.name = "Client Prediction Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.clientprediction.bandwidth_budget" }
	S.tags = { "r", "clientprediction", "codec", "net" }
	S.description = "Client Prediction Serialization Codec: compact encoding, diffing and checksum of payloads for the Client Prediction subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.clientprediction.serialization_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
