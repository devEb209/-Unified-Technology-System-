-- ARKHER SYSTEM Q.0253 :: Settings Screen Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0253"
	S.key = "arkher.ui.settingsscreen.responsive_layout"
	S.name = "Settings Screen Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "settingsscreen", "flex", "ui" }
	S.description = "Settings Screen Responsive Layout: flex solving with safe areas, weights and breakpoints for the Settings Screen subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.settingsscreen.responsive_layout", width = 450, height = 1084, scale = 0.94 })
		inst.system = S
		inst.ctx = ctx
