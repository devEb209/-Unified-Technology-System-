-- ARKHER SYSTEM VD.0092 :: Residency Window World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0092"
	S.key = "arkher.contsim.residencywindow.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.residencywindow.neural_field" }
	S.tags = { "vd", "residencywindow", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.residencywindow.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
