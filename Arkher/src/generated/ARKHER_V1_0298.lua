--!strict
-- Substance Layers — CORE Map #0298
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Substance Layers — CORE Map #0298", size=Vector2.new(640, 480), pos=UDim2.fromOffset(374, 206), parent=parent, icon="◐"})
...
Components.Slider(props, "Value", -5,5,0, function(v) local s=game:GetService("Selection"):Get()[1]; if s and s:IsA("BasePart") then s:SetAttribute("ARKHER_T"..298, v) end end)
