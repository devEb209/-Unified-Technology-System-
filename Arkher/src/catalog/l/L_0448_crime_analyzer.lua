-- ARKHER SYSTEM L.0448 :: Crime Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0448"
	S.key = "arkher.sim.crime.analysis"
	S.name = "Crime Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.crime.aggregate_cache" }
	S.tags = { "l", "crime", "analyzer", "sim" }
	S.description = "Crime Analysis: trend, anomaly and stability analysis of the world for the Crime subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.crime.analysis", window = 84, buckets = 8, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
