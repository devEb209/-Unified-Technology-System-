-- ARKHER SYSTEM H.0330 :: Heightfield Collider Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0330"
	S.key = "arkher.physics.heightfieldcollider.broadphase_index"
	S.name = "Heightfield Collider Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.heightfieldcollider.vehicle" }
	S.tags = { "h", "heightfieldcollider", "index", "physics" }
	S.description = "Heightfield Collider Broadphase Index: spatial acceleration of candidate pair finding for the Heightfield Collider subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.heightfieldcollider.broadphase_index", mode = "hash", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
