-- ARKHER SYSTEM H.0190 :: Island Solver Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0190"
	S.key = "arkher.physics.island.broadphase_index"
	S.name = "Island Solver Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.island.vehicle" }
	S.tags = { "h", "island", "index", "physics" }
	S.description = "Island Solver Broadphase Index: spatial acceleration of candidate pair finding for the Island Solver subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.island.broadphase_index", mode = "hash", cellSize = 64 })
		inst.system = S
		inst.ctx = ctx
