-- ARKHER SYSTEM F.0586 :: Debug Visualization Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0586"
	S.key = "arkher.render.debugvis.frame_analysis"
	S.name = "Debug Visualization Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.debugvis.pass_cache" }
	S.tags = { "f", "debugvis", "analyzer", "render" }
	S.description = "Debug Visualization Frame Analysis: per-pass cost analysis and outlier detection for the Debug Visualization subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.debugvis.frame_analysis", window = 109, buckets = 17, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
