-- ARKHER SYSTEM G.0178 :: Shading Approximation Heuristic Policy
...
return function(A)
	...
	local S = {}
	S.id = "G.0178"
	S.key = "arkher.neural.shadingapprox.heuristic_policy"
	S.name = "Shading Approximation Heuristic Policy"
	S.category = "G"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.shadingapprox.result_cache" }
	S.tags = { "g", "shadingapprox", "policy", "neural" }
	S.description = "Shading Approximation Heuristic Policy: rule fallback when the model is unavailable for the Shading Approximation subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.neural.shadingapprox.heuristic_policy", algorithm = "lottery", starvationGuard = 39 })
		inst.system = S
		inst.ctx = ctx
