-- ARKHER SYSTEM O.0111 :: Ambience Bed Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0111"
	S.key = "arkher.audio.ambiencebed.spatialization"
	S.name = "Ambience Bed Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Ambience Bed"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.ambiencebed.mixer_bus" }
	S.tags = { "o", "ambiencebed", "spatialaudio", "audio" }
	S.description = "Ambience Bed Spatialization: distance attenuation, panning, occlusion and doppler for the Ambience Bed subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.ambiencebed.spatialization", model = "linear", refDistance = 7, maxDistance = 200, rolloff = 0.96, maxVoices = 28 })
		inst.system = S
		inst.ctx = ctx
