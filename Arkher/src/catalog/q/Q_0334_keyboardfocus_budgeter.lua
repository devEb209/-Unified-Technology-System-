-- ARKHER SYSTEM Q.0334 :: Keyboard Focus Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0334"
	S.key = "arkher.ui.keyboardfocus.frame_budget"
	S.name = "Keyboard Focus Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.keyboardfocus.accessibility_policy" }
	S.tags = { "q", "keyboardfocus", "budgeter", "ui" }
	S.description = "Keyboard Focus Frame Budget: per-frame layout and draw budget for the interface for the Keyboard Focus subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.keyboardfocus.frame_budget", total = 389, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
