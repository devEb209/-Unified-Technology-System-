-- ARKHER SYSTEM J.0254 :: Damage State Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0254"
	S.key = "arkher.character.damagestate.rig_definition"
	S.name = "Damage State Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "damagestate", "skeleton", "character" }
	S.description = "Damage State Rig Definition: character rig definition and bone budget for the Damage State subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.damagestate.rig_definition" })
		inst.system = S
		inst.ctx = ctx
