--!strict
-- Decima Workshop — ANIMATION Map #0263
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Decima Workshop — ANIMATION Map #0263", size=Vector2.new(680, 480), pos=UDim2.fromOffset(319, 131), parent=parent, icon="☷"})
