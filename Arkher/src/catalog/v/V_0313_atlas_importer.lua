-- ARKHER SYSTEM V.0313 :: Texture Atlas Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0313"
	S.key = "arkher.asset.atlas.import"
	S.name = "Texture Atlas Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "atlas", "importer", "asset" }
	S.description = "Texture Atlas Import: validation, normalization, hashing and deduplication of incoming content for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.atlas.import", unitScale = 1.50 })
		inst.system = S
		inst.ctx = ctx
