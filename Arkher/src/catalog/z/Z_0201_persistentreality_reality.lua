-- ARKHER SYSTEM Z.0201 :: Persistent Reality State Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0201"
	S.key = "arkher.origin.persistentreality.reality_layering"
	S.name = "Persistent Reality State Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "persistentreality", "reality", "origin" }
	S.description = "Persistent Reality State Reality Layering: stacked authored, simulated, proposed and player realities for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.persistentreality.reality_layering" })
		inst.system = S
		inst.ctx = ctx
