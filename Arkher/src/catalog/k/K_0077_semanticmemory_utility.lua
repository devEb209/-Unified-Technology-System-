-- ARKHER SYSTEM K.0077 :: Semantic Memory Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0077"
	S.key = "arkher.npc.semanticmemory.utility_reasoning"
	S.name = "Semantic Memory Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.semanticmemory.reactive_behaviour" }
	S.tags = { "k", "semanticmemory", "utility", "npc" }
	S.description = "Semantic Memory Utility Reasoning: scored option selection with response curves for the Semantic Memory subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.semanticmemory.utility_reasoning", momentum = 0.05 })
		inst.system = S
		inst.ctx = ctx
