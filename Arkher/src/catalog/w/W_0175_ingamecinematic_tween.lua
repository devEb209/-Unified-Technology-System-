-- ARKHER SYSTEM W.0175 :: In Game Cinematic Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0175"
	S.key = "arkher.cine.ingamecinematic.motion_tween"
	S.name = "In Game Cinematic Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.ingamecinematic.playback_orchestrator" }
	S.tags = { "w", "ingamecinematic", "tween", "cine" }
	S.description = "In Game Cinematic Motion Tween: eased, delayed and sequenced motion of cinematic properties for the In Game Cinematic subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.ingamecinematic.motion_tween", timeScale = 1.04 })
		inst.system = S
		inst.ctx = ctx
