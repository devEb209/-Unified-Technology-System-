-- ARKHER SYSTEM K.0345 :: Behaviour Tree Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0345"
	S.key = "arkher.npc.behaviourtree.navigation"
	S.name = "Behaviour Tree Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourtree.goal_planner" }
	S.tags = { "k", "behaviourtree", "navgraph", "npc" }
	S.description = "Behaviour Tree Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Behaviour Tree subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.behaviourtree.navigation", width = 48, height = 48, cellSize = 5 })
		inst.system = S
		inst.ctx = ctx
