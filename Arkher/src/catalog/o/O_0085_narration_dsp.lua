-- ARKHER SYSTEM O.0085 :: Narration DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0085"
	S.key = "arkher.audio.narration.dsp_chain"
	S.name = "Narration DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Narration"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "narration", "dsp", "audio" }
	S.description = "Narration DSP Chain: biquad filtering, delay, envelope and soft clipping for the Narration subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.narration.dsp_chain", sampleRate = 22050, filter = "lowpass", cutoff = 5100, q = 0.860 })
		inst.system = S
		inst.ctx = ctx
