-- ARKHER SYSTEM W.0128 :: Drone Shot Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0128"
	S.key = "arkher.cine.drone.cinematic_mix"
	S.name = "Drone Shot Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Drone Shot"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.drone.motion_tween" }
	S.tags = { "w", "drone", "mixer", "cine" }
	S.description = "Drone Shot Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Drone Shot subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.drone.cinematic_mix", maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
