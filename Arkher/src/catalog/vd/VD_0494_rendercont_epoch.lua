-- ARKHER SYSTEM VD.0494 :: Rendering Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0494"
	S.key = "arkher.contsim.rendercont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.rendercont.infinite_grid" }
	S.tags = { "vd", "rendercont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.rendercont.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
