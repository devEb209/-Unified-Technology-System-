--!strict
-- CryEngine Qt — CORE Node_Flow #0256
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="CryEngine Qt — CORE Node_Flow #0256", size=Vector2.new(640, 440), pos=UDim2.fromOffset(228, 272), parent=parent, icon="●"})
