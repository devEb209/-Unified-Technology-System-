-- ARKHER SYSTEM H.0284 :: Box Collider Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0284"
	S.key = "arkher.physics.boxcollider.constraint_solver"
	S.name = "Box Collider Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Box Collider"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.boxcollider.contact_generation" }
	S.tags = { "h", "boxcollider", "constraint", "physics" }
	S.description = "Box Collider Constraint Solver: sequential impulses, friction, joints and warm starting for the Box Collider subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.boxcollider.constraint_solver", iterations = 8, baumgarte = 0.24, warmStart = true })
		inst.system = S
		inst.ctx = ctx
