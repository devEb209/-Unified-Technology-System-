-- ARKHER SYSTEM H.0245 :: Broadphase Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0245"
	S.key = "arkher.physics.broadphase.vehicle"
	S.name = "Broadphase Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Broadphase"
	S.aspect = "Vehicle"
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.broadphase.character_motion" }
	S.tags = { "h", "broadphase", "vehicle", "physics" }
	S.description = "Broadphase Vehicle: suspension, drivetrain, steering and tire friction for the Broadphase subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.broadphase.vehicle", mass = 1000, wheelbase = 2.90, track = 2.10, maxRpm = 6300 })
		inst.system = S
		inst.ctx = ctx
