-- ARKHER SYSTEM L.0086 :: Cohort Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0086"
	S.key = "arkher.sim.cohort.fidelity_policy"
	S.name = "Cohort Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.cohort.streaming" }
	S.tags = { "l", "cohort", "policy", "sim" }
	S.description = "Cohort Fidelity Policy: rules that pick full, cohort or statistical simulation for the Cohort subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.cohort.fidelity_policy", algorithm = "wfq", starvationGuard = 38 })
		inst.system = S
		inst.ctx = ctx
