-- ARKHER SYSTEM G.0304 :: Model Registry Heuristic Policy
...
return function(A)
	...
	local S = {}
	S.id = "G.0304"
	S.key = "arkher.neural.modelregistry.heuristic_policy"
	S.name = "Model Registry Heuristic Policy"
	S.category = "G"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelregistry.result_cache" }
	S.tags = { "g", "modelregistry", "policy", "neural" }
	S.description = "Model Registry Heuristic Policy: rule fallback when the model is unavailable for the Model Registry subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.neural.modelregistry.heuristic_policy", algorithm = "wfq", starvationGuard = 46 })
		inst.system = S
		inst.ctx = ctx
