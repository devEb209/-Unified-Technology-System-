-- ARKHER SYSTEM I.0213 :: Transition Rule Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0213"
	S.key = "arkher.anim.transitionrule.physical_blend"
	S.name = "Transition Rule Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.transitionrule.inverse_kinematics" }
	S.tags = { "i", "transitionrule", "ragdoll", "anim" }
	S.description = "Transition Rule Physical Blend: physical bones blended against the animated pose for the Transition Rule subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.transitionrule.physical_blend", blendSpeed = 3.80 })
		inst.system = S
		inst.ctx = ctx
