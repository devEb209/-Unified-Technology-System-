-- ARKHER SYSTEM H.0692 :: Overlap Query Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0692"
	S.key = "arkher.physics.overlap.character_motion"
	S.name = "Overlap Query Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.overlap.query" }
	S.tags = { "h", "overlap", "charmotor", "physics" }
	S.description = "Overlap Query Character Motion: capsule move-and-slide with slopes, steps and jumps for the Overlap Query subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.overlap.character_motion", radius = 0.42, height = 1.87, maxSpeed = 8.70, jumpHeight = 2.30, stepOffset = 0.42 })
		inst.system = S
		inst.ctx = ctx
