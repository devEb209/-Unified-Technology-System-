-- ARKHER SYSTEM Z.0551 :: Reputation Web Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0551"
	S.key = "arkher.origin.reputationweb.adaptive_workflow"
	S.name = "Reputation Web Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.self_critique" }
	S.tags = { "z", "reputationweb", "workflow", "origin" }
	S.description = "Reputation Web Adaptive Workflow: verified, retryable, reversible execution plans for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.reputationweb.adaptive_workflow", maxRetries = 3, budget = 120 })
		inst.system = S
		inst.ctx = ctx
