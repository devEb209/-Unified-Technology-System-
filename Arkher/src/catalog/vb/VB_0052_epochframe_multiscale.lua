-- ARKHER SYSTEM VB.0052 :: Epoch Frame Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0052"
	S.key = "arkher.conttime.epochframe.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.epochframe.sparse_residency" }
	S.tags = { "vb", "epochframe", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.epochframe.multi-scale_fidelity", levels = 5, baseTriangles = 165000 })
		inst.system = S
		inst.ctx = ctx
