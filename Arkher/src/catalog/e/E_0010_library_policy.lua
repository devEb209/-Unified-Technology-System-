-- ARKHER SYSTEM E.0010 :: Material Library Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0010"
	S.key = "arkher.material.library.quality_policy"
	S.name = "Material Library Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.library.compression_codec" }
	S.tags = { "e", "library", "policy", "material" }
	S.description = "Material Library Quality Policy: device tier rules for the surface for the Material Library subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.library.quality_policy", algorithm = "roundrobin", starvationGuard = 28 })
		inst.system = S
		inst.ctx = ctx
