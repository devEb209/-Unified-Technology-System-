-- ARKHER SYSTEM W.0226 :: Transition Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0226"
	S.key = "arkher.cine.cinetransition.frame_budget"
	S.name = "Transition Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Transition"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinetransition.event_ledger" }
	S.tags = { "w", "cinetransition", "budgeter", "cine" }
	S.description = "Transition Frame Budget: per-frame cost budget for the cinematic systems for the Transition subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.cinetransition.frame_budget", total = 422, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
