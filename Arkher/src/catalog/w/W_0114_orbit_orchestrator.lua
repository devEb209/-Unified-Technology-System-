-- ARKHER SYSTEM W.0114 :: Orbit Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0114"
	S.key = "arkher.cine.orbit.playback_orchestrator"
	S.name = "Orbit Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Orbit"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.orbit.cut_policy" }
	S.tags = { "w", "orbit", "orchestrator", "cine" }
	S.description = "Orbit Playback Orchestrator: the state machine that drives a cinematic from start to end for the Orbit subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.orbit.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
