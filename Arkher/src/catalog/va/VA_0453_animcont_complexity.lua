-- ARKHER SYSTEM VA.0453 :: Animation Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0453"
	S.key = "arkher.contworld.animcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.animcont.world_memory_stream" }
	S.tags = { "va", "animcont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.animcont.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
