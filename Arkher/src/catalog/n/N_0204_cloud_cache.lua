-- ARKHER SYSTEM N.0204 :: Cloud Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0204"
	S.key = "arkher.vfx.cloud.result_cache"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.cloud.spawn_budget" }
	S.tags = { "n", "cloud", "cache", "vfx" }
	S.description = "Cloud Result Cache: reuse of expensive effect evaluations for the Cloud subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.cloud.result_cache", policy = "ttl", capacity = 355, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
