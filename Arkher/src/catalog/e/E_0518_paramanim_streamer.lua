-- ARKHER SYSTEM E.0518 :: Parameter Animation Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0518"
	S.key = "arkher.material.paramanim.streaming"
	S.name = "Parameter Animation Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.paramanim.parameter_budget" }
	S.tags = { "e", "paramanim", "streamer", "material" }
	S.description = "Parameter Animation Streaming: residency and demand-driven texture streaming for the Parameter Animation subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.paramanim.streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
