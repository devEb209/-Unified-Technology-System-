-- ARKHER SYSTEM K.0669 :: Sleep Cycle Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0669"
	S.key = "arkher.npc.sleepcycle.social_relations"
	S.name = "Sleep Cycle Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.sleepcycle.crowd_steering" }
	S.tags = { "k", "sleepcycle", "society", "npc" }
	S.description = "Sleep Cycle Social Relations: affinity, factions, reputation and gossip for the Sleep Cycle subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.sleepcycle.social_relations", decayRate = 0.007, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
