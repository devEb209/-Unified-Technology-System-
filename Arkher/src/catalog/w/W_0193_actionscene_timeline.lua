-- ARKHER SYSTEM W.0193 :: Action Scene Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0193"
	S.key = "arkher.cine.actionscene.sequence_timeline"
	S.name = "Action Scene Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Action Scene"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "actionscene", "timeline", "cine" }
	S.description = "Action Scene Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Action Scene subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.actionscene.sequence_timeline", duration = 4.0, rate = 1.12 })
		inst.system = S
		inst.ctx = ctx
