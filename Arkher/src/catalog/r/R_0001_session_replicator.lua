-- ARKHER SYSTEM R.0001 :: Session Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0001"
	S.key = "arkher.net.session.replication"
	S.name = "Session Replication"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Session"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "session", "replicator", "net" }
	S.description = "Session Replication: authoritative entity state, interest and delta snapshots for the Session subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.session.replication", mtu = 1350, interestRadius = 400, fullEvery = 75 })
		inst.system = S
		inst.ctx = ctx
