-- ARKHER SYSTEM F.0600 :: Wireframe Overlay Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0600"
	S.key = "arkher.render.wireframe.frame_analysis"
	S.name = "Wireframe Overlay Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.wireframe.pass_cache" }
	S.tags = { "f", "wireframe", "analyzer", "render" }
	S.description = "Wireframe Overlay Frame Analysis: per-pass cost analysis and outlier detection for the Wireframe Overlay subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.wireframe.frame_analysis", window = 129, buckets = 17, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
