-- ARKHER SYSTEM R.0206 :: Server Reconciliation Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0206"
	S.key = "arkher.net.serverreconciliation.time_sync"
	S.name = "Server Reconciliation Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverreconciliation.replication" }
	S.tags = { "r", "serverreconciliation", "netclock", "net" }
	S.description = "Server Reconciliation Time Sync: offset estimation, outlier rejection and jitter buffering for the Server Reconciliation subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.serverreconciliation.time_sync", tickRate = 30, bufferDelay = 0.070, maxSamples = 13 })
		inst.system = S
		inst.ctx = ctx
