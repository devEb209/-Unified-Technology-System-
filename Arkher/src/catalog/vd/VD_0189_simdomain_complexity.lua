-- ARKHER SYSTEM VD.0189 :: Simulation Domain Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0189"
	S.key = "arkher.contsim.simdomain.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.simdomain.world_memory_stream" }
	S.tags = { "vd", "simdomain", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.simdomain.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
