-- ARKHER SYSTEM W.0083 :: Dolly Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0083"
	S.key = "arkher.cine.dolly.sequence_analysis"
	S.name = "Dolly Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dolly"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dolly.frame_budget" }
	S.tags = { "w", "dolly", "analyzer", "cine" }
	S.description = "Dolly Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Dolly subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.dolly.sequence_analysis", window = 74, buckets = 10, threshold = 4.60 })
		inst.system = S
		inst.ctx = ctx
