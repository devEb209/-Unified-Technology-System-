-- ARKHER SYSTEM N.0110 :: Blood Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0110"
	S.key = "arkher.vfx.blood.effect_graph"
	S.name = "Blood Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Blood"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.blood.curve_authoring" }
	S.tags = { "n", "blood", "shadegraph", "vfx" }
	S.description = "Blood Effect Graph: node graph describing how the effect is shaded for the Blood subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.blood.effect_graph" })
		inst.system = S
		inst.ctx = ctx
