-- ARKHER SYSTEM H.0383 :: Collision Filter Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0383"
	S.key = "arkher.physics.collisionfilter.query"
	S.name = "Collision Filter Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionfilter.constraint_solver" }
	S.tags = { "h", "collisionfilter", "raycaster", "physics" }
	S.description = "Collision Filter Query: rays, sweeps and overlaps against the simulation for the Collision Filter subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.collisionfilter.query", cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
