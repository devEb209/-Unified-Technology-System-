-- ARKHER SYSTEM VB.0346 :: Society Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0346"
	S.key = "arkher.conttime.societycont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.societycont.complexity_budget" }
	S.tags = { "vb", "societycont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.societycont.simulation_fabric", budgetMs = 1.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
