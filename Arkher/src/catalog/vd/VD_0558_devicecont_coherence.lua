-- ARKHER SYSTEM VD.0558 :: Device Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0558"
	S.key = "arkher.contsim.devicecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.devicecont.persistent_state" }
	S.tags = { "vd", "devicecont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.devicecont.coherence_guard", window = 68, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
