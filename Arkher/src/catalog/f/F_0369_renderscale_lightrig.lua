-- ARKHER SYSTEM F.0369 :: Render Scale Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0369"
	S.key = "arkher.render.renderscale.lighting_rig"
	S.name = "Render Scale Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Render Scale"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.renderscale.geometry_virtualization" }
	S.tags = { "f", "renderscale", "lightrig", "render" }
	S.description = "Render Scale Lighting Rig: light clustering, importance and cascades for the Render Scale subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.renderscale.lighting_rig", maxActive = 11 })
		inst.system = S
		inst.ctx = ctx
