--!strict
-- ZBrush SubTool — CORE Profiler #0224
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="ZBrush SubTool — CORE Profiler #0224", size=Vector2.new(680, 500), pos=UDim2.fromOffset(212, 248), parent=parent, icon="◤"})
    win.Root.Name="ARKHER_V1_0224"
    win.Root.Visible=false
    local content=win.Content
    content.BackgroundColor3=Theme.tokens.void
    -- accent line per UI
    local accent=Instance.new("Frame"); accent.Size=UDim2.new(1,0,0,2); accent.BackgroundColor3=Theme.categoryColor("ZBrush S"); accent.BorderSizePixel=0; accent.Parent=content
