-- ARKHER SYSTEM VA.0053 :: Epoch Frame Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0053"
	S.key = "arkher.contworld.epochframe.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.epochframe.multi-scale_fidelity" }
	S.tags = { "va", "epochframe", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.epochframe.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
