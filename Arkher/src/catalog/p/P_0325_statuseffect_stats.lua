-- ARKHER SYSTEM P.0325 :: Status Effect Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0325"
	S.key = "arkher.play.statuseffect.attributes"
	S.name = "Status Effect Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "statuseffect", "stats", "play" }
	S.description = "Status Effect Attributes: base values, layered modifiers and derived statistics for the Status Effect subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.statuseffect.attributes" })
		inst.system = S
		inst.ctx = ctx
