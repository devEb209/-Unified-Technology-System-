-- ARKHER SYSTEM E.0176 :: Clear Coat Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0176"
	S.key = "arkher.material.clearcoat.instance_cache"
	S.name = "Clear Coat Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Clear Coat"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.clearcoat.quality_policy" }
	S.tags = { "e", "clearcoat", "cache", "material" }
	S.description = "Clear Coat Instance Cache: resolved-parameter cache keyed by context for the Clear Coat subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.clearcoat.instance_cache", policy = "lru", capacity = 178, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
