-- ARKHER SYSTEM VA.0418 :: Behaviour Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0418"
	S.key = "arkher.contworld.behaviourcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.behaviourcont.complexity_budget" }
	S.tags = { "va", "behaviourcont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.behaviourcont.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
