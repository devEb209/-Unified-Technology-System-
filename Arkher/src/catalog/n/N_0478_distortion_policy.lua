-- ARKHER SYSTEM N.0478 :: Distortion Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0478"
	S.key = "arkher.vfx.distortion.quality_policy"
	S.name = "Distortion Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Distortion"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.distortion.result_cache" }
	S.tags = { "n", "distortion", "policy", "vfx" }
	S.description = "Distortion Quality Policy: distance and device driven fidelity bands for the Distortion subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.distortion.quality_policy", algorithm = "roundrobin", starvationGuard = 36 })
		inst.system = S
		inst.ctx = ctx
