-- ARKHER SYSTEM H.0691 :: Overlap Query Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0691"
	S.key = "arkher.physics.overlap.query"
	S.name = "Overlap Query Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.overlap.constraint_solver" }
	S.tags = { "h", "overlap", "raycaster", "physics" }
	S.description = "Overlap Query Query: rays, sweeps and overlaps against the simulation for the Overlap Query subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.overlap.query", cellSize = 48 })
		inst.system = S
		inst.ctx = ctx
