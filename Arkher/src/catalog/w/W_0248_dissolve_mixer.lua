-- ARKHER SYSTEM W.0248 :: Dissolve Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0248"
	S.key = "arkher.cine.dissolve.cinematic_mix"
	S.name = "Dissolve Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dissolve"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dissolve.motion_tween" }
	S.tags = { "w", "dissolve", "mixer", "cine" }
	S.description = "Dissolve Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Dissolve subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.dissolve.cinematic_mix", maxVoices = 40 })
		inst.system = S
		inst.ctx = ctx
