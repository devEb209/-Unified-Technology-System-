-- ARKHER SYSTEM O.0049 :: Explosion Sound DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0049"
	S.key = "arkher.audio.explosionsound.dsp_chain"
	S.name = "Explosion Sound DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "explosionsound", "dsp", "audio" }
	S.description = "Explosion Sound DSP Chain: biquad filtering, delay, envelope and soft clipping for the Explosion Sound subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.explosionsound.dsp_chain", sampleRate = 22050, filter = "highpass", cutoff = 1800, q = 0.750 })
		inst.system = S
		inst.ctx = ctx
