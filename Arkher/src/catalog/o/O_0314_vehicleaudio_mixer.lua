-- ARKHER SYSTEM O.0314 :: Vehicle Audio Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0314"
	S.key = "arkher.audio.vehicleaudio.mixer_bus"
	S.name = "Vehicle Audio Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.vehicleaudio.dsp_chain" }
	S.tags = { "o", "vehicleaudio", "mixer", "audio" }
	S.description = "Vehicle Audio Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Vehicle Audio subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.vehicleaudio.mixer_bus", maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
