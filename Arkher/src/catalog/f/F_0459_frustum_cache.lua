-- ARKHER SYSTEM F.0459 :: Frustum Culling Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0459"
	S.key = "arkher.render.frustum.pass_cache"
	S.name = "Frustum Culling Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.frustum.render_policy" }
	S.tags = { "f", "frustum", "cache", "render" }
	S.description = "Frustum Culling Pass Cache: reuse of pass results across frames for the Frustum Culling subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.frustum.pass_cache", policy = "lru", capacity = 388, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
