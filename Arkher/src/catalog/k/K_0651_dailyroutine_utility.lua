-- ARKHER SYSTEM K.0651 :: Daily Routine Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0651"
	S.key = "arkher.npc.dailyroutine.utility_reasoning"
	S.name = "Daily Routine Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dailyroutine.reactive_behaviour" }
	S.tags = { "k", "dailyroutine", "utility", "npc" }
	S.description = "Daily Routine Utility Reasoning: scored option selection with response curves for the Daily Routine subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.dailyroutine.utility_reasoning", momentum = 0.13 })
		inst.system = S
		inst.ctx = ctx
