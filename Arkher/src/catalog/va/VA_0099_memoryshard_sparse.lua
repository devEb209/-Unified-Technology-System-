-- ARKHER SYSTEM VA.0099 :: Memory Shard Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0099"
	S.key = "arkher.contworld.memoryshard.sparse_residency"
	S.name = "Memory Shard Sparse Residency"
	S.category = "VA"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memoryshard.epoch_clock" }
	S.tags = { "va", "memoryshard", "sparse", "contworld" }
	S.description = "Memory Shard Sparse Residency: sparse page residency with eviction and compression for the Memory Shard subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.memoryshard.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
