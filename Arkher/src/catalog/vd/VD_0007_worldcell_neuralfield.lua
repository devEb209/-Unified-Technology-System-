-- ARKHER SYSTEM VD.0007 :: World Grid Cell Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0007"
	S.key = "arkher.contsim.worldcell.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldcell.coherence_guard" }
	S.tags = { "vd", "worldcell", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.worldcell.neural_field", dims = 24, hidden = 20, seed = 73659 })
		inst.system = S
		inst.ctx = ctx
