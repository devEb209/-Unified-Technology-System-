-- ARKHER SYSTEM K.0495 :: Patrol Route Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0495"
	S.key = "arkher.npc.patrolroute.perception"
	S.name = "Patrol Route Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.patrolroute.emotion" }
	S.tags = { "k", "patrolroute", "perception", "npc" }
	S.description = "Patrol Route Perception: sight, hearing and bounded attention for the Patrol Route subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.patrolroute.perception", sightRange = 30, hearingRange = 16, attentionSlots = 4, fov = 1.930 })
		inst.system = S
		inst.ctx = ctx
