-- ARKHER SYSTEM V.0220 :: Script Asset Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0220"
	S.key = "arkher.asset.scriptasset.asset_registry"
	S.name = "Script Asset Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.scriptasset.cook_pipeline" }
	S.tags = { "v", "scriptasset", "registry", "asset" }
	S.description = "Script Asset Asset Registry: catalogue of every asset, its tags and its metadata for the Script Asset subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.scriptasset.asset_registry" })
		inst.system = S
		inst.ctx = ctx
