-- ARKHER SYSTEM H.0325 :: Heightfield Collider Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0325"
	S.key = "arkher.physics.heightfieldcollider.contact_generation"
	S.name = "Heightfield Collider Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.heightfieldcollider.collision_shape" }
	S.tags = { "h", "heightfieldcollider", "contact", "physics" }
	S.description = "Heightfield Collider Contact Generation: narrow-phase manifolds with normal, depth and point for the Heightfield Collider subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.heightfieldcollider.contact_generation", slop = 0.0060, maxManifolds = 160 })
		inst.system = S
		inst.ctx = ctx
