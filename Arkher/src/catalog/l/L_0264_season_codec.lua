-- ARKHER SYSTEM L.0264 :: Season State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0264"
	S.key = "arkher.sim.season.state_codec"
	S.name = "Season State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.season.history_ledger" }
	S.tags = { "l", "season", "codec", "sim" }
	S.description = "Season State Codec: persistence, diffing and checksum of the world state for the Season subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.season.state_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
