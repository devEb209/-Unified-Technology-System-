-- ARKHER SYSTEM Z.0264 :: Living Ecosystem Engine Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0264"
	S.key = "arkher.origin.livingecosystem.autonomous_pipeline"
	S.name = "Living Ecosystem Engine Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.livingecosystem.simulation_fabric" }
	S.tags = { "z", "livingecosystem", "autopipeline", "origin" }
	S.description = "Living Ecosystem Engine Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Living Ecosystem Engine subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.livingecosystem.autonomous_pipeline", maxIterations = 6 })
		inst.system = S
		inst.ctx = ctx
