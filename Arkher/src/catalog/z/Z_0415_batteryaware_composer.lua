-- ARKHER SYSTEM Z.0415 :: Battery Aware Pipeline Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0415"
	S.key = "arkher.origin.batteryaware.signal_composition"
	S.name = "Battery Aware Pipeline Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.batteryaware.telemetry_ledger" }
	S.tags = { "z", "batteryaware", "composer", "origin" }
	S.description = "Battery Aware Pipeline Signal Composition: blending of the technology's input signals into one output for the Battery Aware Pipeline subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.batteryaware.signal_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
