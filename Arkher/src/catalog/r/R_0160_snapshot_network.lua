-- ARKHER SYSTEM R.0160 :: Snapshot Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0160"
	S.key = "arkher.net.snapshot.transport_graph"
	S.name = "Snapshot Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Snapshot"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.snapshot.prediction_and_reconciliation" }
	S.tags = { "r", "snapshot", "network", "net" }
	S.description = "Snapshot Transport Graph: topology, capacity and routing between endpoints for the Snapshot subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.snapshot.transport_graph" })
		inst.system = S
		inst.ctx = ctx
