-- ARKHER SYSTEM W.0002 :: Shot Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0002"
	S.key = "arkher.cine.shot.camera_rig"
	S.name = "Shot Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Shot"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.shot.sequence_timeline" }
	S.tags = { "w", "shot", "camerarig", "cine" }
	S.description = "Shot Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Shot subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.shot.camera_rig", fov = 1.34, focus = 14.0, aperture = 5.4, smoothing = 6.0, distance = 16, height = 4 })
		inst.system = S
		inst.ctx = ctx
