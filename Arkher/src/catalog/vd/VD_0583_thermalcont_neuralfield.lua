-- ARKHER SYSTEM VD.0583 :: Thermal Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0583"
	S.key = "arkher.contsim.thermalcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.thermalcont.coherence_guard" }
	S.tags = { "vd", "thermalcont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.thermalcont.neural_field", dims = 12, hidden = 8, seed = 70072 })
		inst.system = S
		inst.ctx = ctx
