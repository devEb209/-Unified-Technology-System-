-- ARKHER SYSTEM F.0566 :: UI Rendering Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0566"
	S.key = "arkher.render.uirender.probe_volume"
	S.name = "UI Rendering Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "UI Rendering"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.uirender.lighting_rig" }
	S.tags = { "f", "uirender", "probe", "render" }
	S.description = "UI Rendering Probe Volume: irradiance probes encoded in spherical harmonics for the UI Rendering subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.uirender.probe_volume", spacing = 40 })
		inst.system = S
		inst.ctx = ctx
