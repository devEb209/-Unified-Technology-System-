-- ARKHER SYSTEM I.0431 :: Crowd Animation Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0431"
	S.key = "arkher.anim.crowdanim.clip_sampling"
	S.name = "Crowd Animation Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crowdanim.skeleton" }
	S.tags = { "i", "crowdanim", "clip", "anim" }
	S.description = "Crowd Animation Clip Sampling: keyframe tracks sampled, retimed and evented for the Crowd Animation subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.crowdanim.clip_sampling", duration = 0.70, loop = true })
		inst.system = S
		inst.ctx = ctx
