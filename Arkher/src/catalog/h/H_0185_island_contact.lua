-- ARKHER SYSTEM H.0185 :: Island Solver Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0185"
	S.key = "arkher.physics.island.contact_generation"
	S.name = "Island Solver Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.island.collision_shape" }
	S.tags = { "h", "island", "contact", "physics" }
	S.description = "Island Solver Contact Generation: narrow-phase manifolds with normal, depth and point for the Island Solver subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.island.contact_generation", slop = 0.0080, maxManifolds = 224 })
		inst.system = S
		inst.ctx = ctx
