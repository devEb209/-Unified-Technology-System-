-- ARKHER SYSTEM Q.0374 :: Localization Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0374"
	S.key = "arkher.ui.localization.widget_tree"
	S.name = "Localization Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Localization"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.localization.responsive_layout" }
	S.tags = { "q", "localization", "widget", "ui" }
	S.description = "Localization Widget Tree: retained widget nodes, properties, bindings and rendering for the Localization subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.localization.widget_tree", theme = "light", scale = 0.98 })
		inst.system = S
		inst.ctx = ctx
