-- ARKHER SYSTEM VC.0331 :: Economy Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0331"
	S.key = "arkher.contneural.economycont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.economycont.coherence_guard" }
	S.tags = { "vc", "economycont", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.economycont.neural_field", dims = 24, hidden = 20, seed = 3255 })
		inst.system = S
		inst.ctx = ctx
