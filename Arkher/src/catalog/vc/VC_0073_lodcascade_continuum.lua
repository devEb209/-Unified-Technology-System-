-- ARKHER SYSTEM VC.0073 :: LOD Cascade Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0073"
	S.key = "arkher.contneural.lodcascade.infinite_grid"
	S.name = "LOD Cascade Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "lodcascade", "continuum", "contneural" }
	S.description = "LOD Cascade Infinite Grid: seamless paging of the infinite world grid for the LOD Cascade subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.lodcascade.infinite_grid", cellSize = 64, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
