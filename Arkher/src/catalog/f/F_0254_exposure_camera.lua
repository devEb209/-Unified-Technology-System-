-- ARKHER SYSTEM F.0254 :: Exposure View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0254"
	S.key = "arkher.render.exposure.view_and_culling"
	S.name = "Exposure View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Exposure"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.exposure.frame_graph" }
	S.tags = { "f", "exposure", "camera", "render" }
	S.description = "Exposure View And Culling: view state, frustum culling and screen-size LOD for the Exposure subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.exposure.view_and_culling", width = 828, height = 900, fov = 1.1500, far = 1400 })
		inst.system = S
		inst.ctx = ctx
