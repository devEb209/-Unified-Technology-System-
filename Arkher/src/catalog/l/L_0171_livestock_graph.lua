-- ARKHER SYSTEM L.0171 :: Livestock Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0171"
	S.key = "arkher.sim.livestock.region_graph"
	S.name = "Livestock Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livestock.calendar" }
	S.tags = { "l", "livestock", "graph", "sim" }
	S.description = "Livestock Region Graph: connectivity, components and shortest path between places for the Livestock subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.livestock.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
