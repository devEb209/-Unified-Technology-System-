-- ARKHER SYSTEM G.0465 :: Training Data Synthesis Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0465"
	S.key = "arkher.neural.datasynth.temporal_history"
	S.name = "Training Data Synthesis Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.datasynth.feature_extraction" }
	S.tags = { "g", "datasynth", "temporal", "neural" }
	S.description = "Training Data Synthesis Temporal History: history buffers reused across frames for the Training Data Synthesis subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.datasynth.temporal_history", feedback = 0.83, phase = 8 })
		inst.system = S
		inst.ctx = ctx
