-- ARKHER SYSTEM E.0033 :: Albedo Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0033"
	S.key = "arkher.material.albedo.shading_graph"
	S.name = "Albedo Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Albedo"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.albedo.layer_composition" }
	S.tags = { "e", "albedo", "shadegraph", "material" }
	S.description = "Albedo Shading Graph: node graph evaluated and compiled to Luau for the Albedo subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.albedo.shading_graph" })
		inst.system = S
		inst.ctx = ctx
