-- ARKHER SYSTEM K.0368 :: Utility Selection Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0368"
	S.key = "arkher.npc.utilityselection.emotion"
	S.name = "Utility Selection Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.utilityselection.drive_system" }
	S.tags = { "k", "utilityselection", "emotion", "npc" }
	S.description = "Utility Selection Emotion: appraisal of events into valence, arousal and mood for the Utility Selection subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.utilityselection.emotion", inertia = 0.84, decayRate = 0.29, baselineArousal = 0.19 })
		inst.system = S
		inst.ctx = ctx
