-- ARKHER SYSTEM O.0248 :: Combat Music Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0248"
	S.key = "arkher.audio.combatmusic.compression_codec"
	S.name = "Combat Music Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Combat Music"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.combatmusic.asset_registry" }
	S.tags = { "o", "combatmusic", "codec", "audio" }
	S.description = "Combat Music Compression Codec: payload encoding of audio state and events for the Combat Music subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.combatmusic.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
