-- ARKHER SYSTEM L.0586 :: World Persistence Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0586"
	S.key = "arkher.sim.worldpersistence.simulation_core"
	S.name = "World Persistence Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "worldpersistence", "simulation", "sim" }
	S.description = "World Persistence Simulation Core: observer-driven fidelity, catch-up and aggregate state for the World Persistence subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.worldpersistence.simulation_core", fullRadius = 120, reducedRadius = 800, budget = 50 })
		inst.system = S
		inst.ctx = ctx
