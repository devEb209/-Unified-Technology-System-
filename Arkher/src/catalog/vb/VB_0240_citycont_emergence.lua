-- ARKHER SYSTEM VB.0240 :: City Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0240"
	S.key = "arkher.conttime.citycont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.citycont.reality_continuum" }
	S.tags = { "vb", "citycont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.citycont.emergence_continuum", windowSize = 7, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
