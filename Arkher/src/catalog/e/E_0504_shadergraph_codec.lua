-- ARKHER SYSTEM E.0504 :: Shader Graph Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0504"
	S.key = "arkher.material.shadergraph.compression_codec"
	S.name = "Shader Graph Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Shader Graph"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.shadergraph.streaming" }
	S.tags = { "e", "shadergraph", "codec", "material" }
	S.description = "Shader Graph Compression Codec: serialization and compression of material data for the Shader Graph subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.shadergraph.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
