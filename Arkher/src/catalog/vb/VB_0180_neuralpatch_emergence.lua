-- ARKHER SYSTEM VB.0180 :: Neural Patch Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0180"
	S.key = "arkher.conttime.neuralpatch.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.neuralpatch.reality_continuum" }
	S.tags = { "vb", "neuralpatch", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.neuralpatch.emergence_continuum", windowSize = 6, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
