-- ARKHER SYSTEM I.0074 :: Keyframe Track Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0074"
	S.key = "arkher.anim.keytrack.playback_pipeline"
	S.name = "Keyframe Track Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.keytrack.event_ledger" }
	S.tags = { "i", "keytrack", "pipeline", "anim" }
	S.description = "Keyframe Track Playback Pipeline: ordered sample, blend, ik and output stages for the Keyframe Track subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.keytrack.playback_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
