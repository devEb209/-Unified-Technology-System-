-- ARKHER SYSTEM VD.0013 :: Region Tile Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0013"
	S.key = "arkher.contsim.regiontile.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "regiontile", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.regiontile.infinite_grid", cellSize = 224, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
