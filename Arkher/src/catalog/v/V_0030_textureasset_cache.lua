-- ARKHER SYSTEM V.0030 :: Texture Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0030"
	S.key = "arkher.asset.textureasset.content_cache"
	S.name = "Texture Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.textureasset.dependency_graph" }
	S.tags = { "v", "textureasset", "cache", "asset" }
	S.description = "Texture Content Cache: reuse of already cooked results for the Texture subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.textureasset.content_cache", policy = "ttl", capacity = 474, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
