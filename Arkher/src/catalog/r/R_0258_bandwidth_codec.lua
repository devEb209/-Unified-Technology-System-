-- ARKHER SYSTEM R.0258 :: Bandwidth Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0258"
	S.key = "arkher.net.bandwidth.serialization_codec"
	S.name = "Bandwidth Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Bandwidth"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.bandwidth.bandwidth_budget" }
	S.tags = { "r", "bandwidth", "codec", "net" }
	S.description = "Bandwidth Serialization Codec: compact encoding, diffing and checksum of payloads for the Bandwidth subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.bandwidth.serialization_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
