-- ARKHER SYSTEM Z.1099 :: Original Tech Debug Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.1099"
	S.key = "arkher.origin.origindebug.residency_streaming"
	S.name = "Original Tech Debug Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.origindebug.budget_governor" }
	S.tags = { "z", "origindebug", "streamer", "origin" }
	S.description = "Original Tech Debug Residency Streaming: distance-driven residency of the technology's workload for the Original Tech Debug subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.origindebug.residency_streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
