-- ARKHER SYSTEM N.0466 :: Camera Shake Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0466"
	S.key = "arkher.vfx.camerashake.spatial_index"
	S.name = "Camera Shake Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Camera Shake"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.camerashake.quality_policy" }
	S.tags = { "n", "camerashake", "index", "vfx" }
	S.description = "Camera Shake Spatial Index: spatial acceleration of effect queries and culling for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.camerashake.spatial_index", mode = "hash", cellSize = 16 })
		inst.system = S
		inst.ctx = ctx
