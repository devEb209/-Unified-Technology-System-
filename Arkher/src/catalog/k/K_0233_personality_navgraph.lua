-- ARKHER SYSTEM K.0233 :: Personality Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0233"
	S.key = "arkher.npc.personality.navigation"
	S.name = "Personality Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.personality.goal_planner" }
	S.tags = { "k", "personality", "navgraph", "npc" }
	S.description = "Personality Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Personality subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.personality.navigation", width = 24, height = 24, cellSize = 2 })
		inst.system = S
		inst.ctx = ctx
