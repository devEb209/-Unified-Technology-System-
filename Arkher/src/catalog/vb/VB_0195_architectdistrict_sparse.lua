-- ARKHER SYSTEM VB.0195 :: Architect District Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0195"
	S.key = "arkher.conttime.architectdistrict.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.architectdistrict.epoch_clock" }
	S.tags = { "vb", "architectdistrict", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.architectdistrict.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
