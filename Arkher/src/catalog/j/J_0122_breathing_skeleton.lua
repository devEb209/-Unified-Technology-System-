-- ARKHER SYSTEM J.0122 :: Breathing Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0122"
	S.key = "arkher.character.breathing.rig_definition"
	S.name = "Breathing Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "breathing", "skeleton", "character" }
	S.description = "Breathing Rig Definition: character rig definition and bone budget for the Breathing subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.breathing.rig_definition" })
		inst.system = S
		inst.ctx = ctx
