-- ARKHER SYSTEM Z.0659 :: Natural Language Engine Control Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0659"
	S.key = "arkher.origin.languagecontrol.residency_streaming"
	S.name = "Natural Language Engine Control Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.languagecontrol.budget_governor" }
	S.tags = { "z", "languagecontrol", "streamer", "origin" }
	S.description = "Natural Language Engine Control Residency Streaming: distance-driven residency of the technology's workload for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.languagecontrol.residency_streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
