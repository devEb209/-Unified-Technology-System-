-- ARKHER SYSTEM I.0303 :: Aim Offset Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0303"
	S.key = "arkher.anim.aimoffset.inverse_kinematics"
	S.name = "Aim Offset Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Aim Offset"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.aimoffset.layered_blending" }
	S.tags = { "i", "aimoffset", "ik", "anim" }
	S.description = "Aim Offset Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Aim Offset subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.aimoffset.inverse_kinematics", iterations = 15, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
