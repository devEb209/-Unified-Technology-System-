-- ARKHER SYSTEM H.0454 :: Distance Joint Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0454"
	S.key = "arkher.physics.distancejoint.character_motion"
	S.name = "Distance Joint Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.distancejoint.query" }
	S.tags = { "h", "distancejoint", "charmotor", "physics" }
	S.description = "Distance Joint Character Motion: capsule move-and-slide with slopes, steps and jumps for the Distance Joint subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.distancejoint.character_motion", radius = 0.36, height = 1.81, maxSpeed = 6.10, jumpHeight = 2.10, stepOffset = 0.46 })
		inst.system = S
		inst.ctx = ctx
