-- ARKHER SYSTEM K.0122 :: Forgetting Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0122"
	S.key = "arkher.npc.forgetting.crowd_steering"
	S.name = "Forgetting Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.forgetting.navigation" }
	S.tags = { "k", "forgetting", "crowd", "npc" }
	S.description = "Forgetting Crowd Steering: local avoidance, cohesion and arrival at scale for the Forgetting subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.forgetting.crowd_steering", radius = 0.75, maxSpeed = 5.70, cellSize = 9 })
		inst.system = S
		inst.ctx = ctx
