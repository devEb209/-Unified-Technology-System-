-- ARKHER SYSTEM I.0439 :: Crowd Animation Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0439"
	S.key = "arkher.anim.crowdanim.pose_cache"
	S.name = "Crowd Animation Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crowdanim.playback_pipeline" }
	S.tags = { "i", "crowdanim", "cache", "anim" }
	S.description = "Crowd Animation Pose Cache: reuse of sampled poses across frames and instances for the Crowd Animation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.crowdanim.pose_cache", policy = "lru", capacity = 500, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
