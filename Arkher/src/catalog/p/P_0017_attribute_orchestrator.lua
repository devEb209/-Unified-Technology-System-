-- ARKHER SYSTEM P.0017 :: Attribute State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0017"
	S.key = "arkher.play.attribute.state_machine"
	S.name = "Attribute State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Attribute"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.attribute.combat_resolution" }
	S.tags = { "p", "attribute", "orchestrator", "play" }
	S.description = "Attribute State Machine: the phase machine that drives this gameplay loop for the Attribute subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.attribute.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
