-- ARKHER SYSTEM VA.0575 :: Mobile Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0575"
	S.key = "arkher.contworld.mobilecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.mobilecont.simulation_fabric" }
	S.tags = { "va", "mobilecont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.mobilecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
