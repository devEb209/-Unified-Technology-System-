-- ARKHER SYSTEM I.0223 :: Root Motion Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0223"
	S.key = "arkher.anim.rootmotion.clip_sampling"
	S.name = "Root Motion Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Root Motion"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.rootmotion.skeleton" }
	S.tags = { "i", "rootmotion", "clip", "anim" }
	S.description = "Root Motion Clip Sampling: keyframe tracks sampled, retimed and evented for the Root Motion subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.rootmotion.clip_sampling", duration = 1.10, loop = true })
		inst.system = S
		inst.ctx = ctx
