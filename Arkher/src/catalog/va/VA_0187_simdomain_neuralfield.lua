-- ARKHER SYSTEM VA.0187 :: Simulation Domain Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0187"
	S.key = "arkher.contworld.simdomain.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.simdomain.coherence_guard" }
	S.tags = { "va", "simdomain", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.simdomain.neural_field", dims = 24, hidden = 20, seed = 84467 })
		inst.system = S
		inst.ctx = ctx
