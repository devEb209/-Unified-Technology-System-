-- ARKHER SYSTEM R.0029 :: Handshake Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0029"
	S.key = "arkher.net.handshake.bandwidth_budget"
	S.name = "Handshake Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Handshake"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.handshake.transport_graph" }
	S.tags = { "r", "handshake", "budgeter", "net" }
	S.description = "Handshake Bandwidth Budget: bytes per second shared between competing streams for the Handshake subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.handshake.bandwidth_budget", total = 190, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
