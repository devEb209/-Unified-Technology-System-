-- ARKHER SYSTEM VA.0343 :: Society Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0343"
	S.key = "arkher.contworld.societycont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.societycont.coherence_guard" }
	S.tags = { "va", "societycont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.societycont.neural_field", dims = 24, hidden = 20, seed = 22703 })
		inst.system = S
		inst.ctx = ctx
