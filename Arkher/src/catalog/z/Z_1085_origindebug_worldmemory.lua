-- ARKHER SYSTEM Z.1085 :: Original Tech Debug World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.1085"
	S.key = "arkher.origin.origindebug.world_memory"
	S.name = "Original Tech Debug World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.origindebug.autonomous_pipeline" }
	S.tags = { "z", "origindebug", "worldmemory", "origin" }
	S.description = "Original Tech Debug World Memory: epoch-stamped persistent history with compaction and checkpoints for the Original Tech Debug subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.origindebug.world_memory", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
