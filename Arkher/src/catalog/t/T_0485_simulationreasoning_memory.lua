-- ARKHER SYSTEM T.0485 :: Simulation Reasoning Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0485"
	S.key = "arkher.ai.simulationreasoning.working_memory"
	S.name = "Simulation Reasoning Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.simulationreasoning.outcome_prediction" }
	S.tags = { "t", "simulationreasoning", "memory", "ai" }
	S.description = "Simulation Reasoning Working Memory: decaying, consolidating recall of what the agent learned for the Simulation Reasoning subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.simulationreasoning.working_memory", capacity = 74, decayRate = 0.020, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
