-- ARKHER SYSTEM T.0254 :: Narrative Design Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0254"
	S.key = "arkher.ai.narrativedesign.semantic_knowledge"
	S.name = "Narrative Design Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.narrativedesign.intent_understanding" }
	S.tags = { "t", "narrativedesign", "knowledge", "ai" }
	S.description = "Narrative Design Semantic Knowledge: typed entities, weighted relations and inferred closure for the Narrative Design subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.narrativedesign.semantic_knowledge", dims = 32 })
		inst.system = S
		inst.ctx = ctx
