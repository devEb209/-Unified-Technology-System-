-- ARKHER SYSTEM H.0564 :: Soft Body Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0564"
	S.key = "arkher.physics.softbody.constraint_solver"
	S.name = "Soft Body Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Soft Body"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.softbody.contact_generation" }
	S.tags = { "h", "softbody", "constraint", "physics" }
	S.description = "Soft Body Constraint Solver: sequential impulses, friction, joints and warm starting for the Soft Body subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.softbody.constraint_solver", iterations = 6, baumgarte = 0.22, warmStart = true })
		inst.system = S
		inst.ctx = ctx
