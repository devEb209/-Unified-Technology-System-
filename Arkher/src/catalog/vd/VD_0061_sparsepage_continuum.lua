-- ARKHER SYSTEM VD.0061 :: Sparse Page Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0061"
	S.key = "arkher.contsim.sparsepage.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "sparsepage", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.sparsepage.infinite_grid", cellSize = 96, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
