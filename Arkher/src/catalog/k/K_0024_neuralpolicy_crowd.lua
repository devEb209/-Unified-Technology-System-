-- ARKHER SYSTEM K.0024 :: Neural Policy Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0024"
	S.key = "arkher.npc.neuralpolicy.crowd_steering"
	S.name = "Neural Policy Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.neuralpolicy.navigation" }
	S.tags = { "k", "neuralpolicy", "crowd", "npc" }
	S.description = "Neural Policy Crowd Steering: local avoidance, cohesion and arrival at scale for the Neural Policy subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.neuralpolicy.crowd_steering", radius = 0.40, maxSpeed = 5.00, cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
