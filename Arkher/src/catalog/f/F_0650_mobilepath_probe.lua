-- ARKHER SYSTEM F.0650 :: Mobile Fast Path Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0650"
	S.key = "arkher.render.mobilepath.probe_volume"
	S.name = "Mobile Fast Path Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.mobilepath.lighting_rig" }
	S.tags = { "f", "mobilepath", "probe", "render" }
	S.description = "Mobile Fast Path Probe Volume: irradiance probes encoded in spherical harmonics for the Mobile Fast Path subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.mobilepath.probe_volume", spacing = 32 })
		inst.system = S
		inst.ctx = ctx
