-- ARKHER SYSTEM P.0330 :: Status Effect Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0330"
	S.key = "arkher.play.statuseffect.rule_pipeline"
	S.name = "Status Effect Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.statuseffect.state_machine" }
	S.tags = { "p", "statuseffect", "pipeline", "play" }
	S.description = "Status Effect Rule Pipeline: ordered rules applied to every gameplay event for the Status Effect subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.statuseffect.rule_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
