-- ARKHER SYSTEM Z.0511 :: Economic Emergence Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0511"
	S.key = "arkher.origin.economicemergence.adaptive_workflow"
	S.name = "Economic Emergence Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.economicemergence.self_critique" }
	S.tags = { "z", "economicemergence", "workflow", "origin" }
	S.description = "Economic Emergence Adaptive Workflow: verified, retryable, reversible execution plans for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.economicemergence.adaptive_workflow", maxRetries = 3, budget = 150 })
		inst.system = S
		inst.ctx = ctx
