-- ARKHER SYSTEM E.0236 :: Layer Blending Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0236"
	S.key = "arkher.material.layerblend.instance_cache"
	S.name = "Layer Blending Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.layerblend.quality_policy" }
	S.tags = { "e", "layerblend", "cache", "material" }
	S.description = "Layer Blending Instance Cache: resolved-parameter cache keyed by context for the Layer Blending subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.layerblend.instance_cache", policy = "ttl", capacity = 474, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
