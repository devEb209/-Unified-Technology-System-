-- ARKHER SYSTEM Z.0104 :: Universal Simulation Fabric Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0104"
	S.key = "arkher.origin.simfabric.autonomous_pipeline"
	S.name = "Universal Simulation Fabric Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.simfabric.simulation_fabric" }
	S.tags = { "z", "simfabric", "autopipeline", "origin" }
	S.description = "Universal Simulation Fabric Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.simfabric.autonomous_pipeline", maxIterations = 8 })
		inst.system = S
		inst.ctx = ctx
