-- ARKHER SYSTEM Z.1002 :: Capability Discovery Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.1002"
	S.key = "arkher.origin.capabilitydiscovery.complexity_governance"
	S.name = "Capability Discovery Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.reality_layering" }
	S.tags = { "z", "capabilitydiscovery", "complexity", "origin" }
	S.description = "Capability Discovery Complexity Governance: measured scene cost turned into per-subsystem directives for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.capabilitydiscovery.complexity_governance", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
