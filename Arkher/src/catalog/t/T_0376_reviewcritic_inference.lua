-- ARKHER SYSTEM T.0376 :: Review Critic Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0376"
	S.key = "arkher.ai.reviewcritic.model_inference"
	S.name = "Review Critic Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.reviewcritic.action_planner" }
	S.tags = { "t", "reviewcritic", "inference", "ai" }
	S.description = "Review Critic Model Inference: quantized inference with batching and budget for the Review Critic subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.reviewcritic.model_inference", seed = 27913 })
		inst.system = S
		inst.ctx = ctx
