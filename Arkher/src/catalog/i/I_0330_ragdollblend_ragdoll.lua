-- ARKHER SYSTEM I.0330 :: Ragdoll Blend Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0330"
	S.key = "arkher.anim.ragdollblend.physical_blend"
	S.name = "Ragdoll Blend Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.ragdollblend.inverse_kinematics" }
	S.tags = { "i", "ragdollblend", "ragdoll", "anim" }
	S.description = "Ragdoll Blend Physical Blend: physical bones blended against the animated pose for the Ragdoll Blend subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.ragdollblend.physical_blend", blendSpeed = 3.80 })
		inst.system = S
		inst.ctx = ctx
