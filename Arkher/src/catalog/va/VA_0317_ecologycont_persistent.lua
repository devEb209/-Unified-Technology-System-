-- ARKHER SYSTEM VA.0317 :: Ecology Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0317"
	S.key = "arkher.contworld.ecologycont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.ecologycont.multi-scale_fidelity" }
	S.tags = { "va", "ecologycont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.ecologycont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
