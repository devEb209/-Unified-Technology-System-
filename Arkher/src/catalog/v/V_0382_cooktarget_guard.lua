-- ARKHER SYSTEM V.0382 :: Cook Target Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0382"
	S.key = "arkher.asset.cooktarget.validation_guard"
	S.name = "Cook Target Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.cooktarget.size_budget" }
	S.tags = { "v", "cooktarget", "guard", "asset" }
	S.description = "Cook Target Validation Guard: rate limiting and capability checks on the import path for the Cook Target subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.cooktarget.validation_guard", algorithm = "token", capacity = 199, refillPerSec = 44, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
