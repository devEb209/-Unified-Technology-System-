-- ARKHER SYSTEM VC.0408 :: Perception Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0408"
	S.key = "arkher.contneural.perceptioncont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.perceptioncont.reality_continuum" }
	S.tags = { "vc", "perceptioncont", "emergence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.perceptioncont.emergence_continuum", windowSize = 6, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
