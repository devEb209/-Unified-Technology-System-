-- ARKHER SYSTEM VA.0569 :: Mobile Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0569"
	S.key = "arkher.contworld.mobilecont.persistent_state"
	S.name = "Mobile Continuum Persistent State"
	S.category = "VA"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.mobilecont.multi-scale_fidelity" }
	S.tags = { "va", "mobilecont", "persistent", "contworld" }
	S.description = "Mobile Continuum Persistent State: epoch-stamped persistent history and rollback for the Mobile Continuum subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.mobilecont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
