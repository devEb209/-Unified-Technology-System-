-- ARKHER SYSTEM G.0468 :: Training Data Synthesis Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0468"
	S.key = "arkher.neural.datasynth.weight_codec"
	S.name = "Training Data Synthesis Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.datasynth.model_registry" }
	S.tags = { "g", "datasynth", "codec", "neural" }
	S.description = "Training Data Synthesis Weight Codec: weight serialization and quantized transport for the Training Data Synthesis subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.datasynth.weight_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
