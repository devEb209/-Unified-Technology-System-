-- ARKHER SYSTEM T.0051 :: Goal Reasoning Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0051"
	S.key = "arkher.ai.goalreasoning.working_memory"
	S.name = "Goal Reasoning Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.goalreasoning.outcome_prediction" }
	S.tags = { "t", "goalreasoning", "memory", "ai" }
	S.description = "Goal Reasoning Working Memory: decaying, consolidating recall of what the agent learned for the Goal Reasoning subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.goalreasoning.working_memory", capacity = 90, decayRate = 0.030, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
