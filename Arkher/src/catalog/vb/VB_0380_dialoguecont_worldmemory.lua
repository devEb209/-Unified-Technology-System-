-- ARKHER SYSTEM VB.0380 :: Dialogue Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0380"
	S.key = "arkher.conttime.dialoguecont.world_memory_stream"
	S.name = "Dialogue Continuum World Memory Stream"
	S.category = "VB"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.dialoguecont.neural_field" }
	S.tags = { "vb", "dialoguecont", "worldmemory", "conttime" }
	S.description = "Dialogue Continuum World Memory Stream: world memory continuum over epochs for the Dialogue Continuum subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.dialoguecont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
