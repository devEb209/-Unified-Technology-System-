-- ARKHER SYSTEM F.0500 :: HLOD Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0500"
	S.key = "arkher.render.hlod.render_policy"
	S.name = "HLOD Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "HLOD"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.hlod.draw_budget" }
	S.tags = { "f", "hlod", "policy", "render" }
	S.description = "HLOD Render Policy: device tier rules for the frame for the HLOD subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.hlod.render_policy", algorithm = "wfq", starvationGuard = 50 })
		inst.system = S
		inst.ctx = ctx
