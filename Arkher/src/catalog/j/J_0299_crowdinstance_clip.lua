-- ARKHER SYSTEM J.0299 :: Crowd Instance Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0299"
	S.key = "arkher.character.crowdinstance.motion_set"
	S.name = "Crowd Instance Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.crowdinstance.rig_definition" }
	S.tags = { "j", "crowdinstance", "clip", "character" }
	S.description = "Crowd Instance Motion Set: the clips a character owns and how they sample for the Crowd Instance subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.crowdinstance.motion_set", duration = 1.90, loop = true })
		inst.system = S
		inst.ctx = ctx
