-- ARKHER SYSTEM O.0018 :: Foley Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0018"
	S.key = "arkher.audio.foley.streaming"
	S.name = "Foley Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Foley"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.foley.voice_budget" }
	S.tags = { "o", "foley", "streamer", "audio" }
	S.description = "Foley Streaming: distance-driven residency of audio assets for the Foley subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.foley.streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
