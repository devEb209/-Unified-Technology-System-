-- ARKHER SYSTEM R.0056 :: Player State Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0056"
	S.key = "arkher.net.playerstate.rate_guard"
	S.name = "Player State Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Player State"
	S.aspect = "Rate Guard"
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.playerstate.interest_streaming" }
	S.tags = { "r", "playerstate", "guard", "net" }
	S.description = "Player State Rate Guard: token-bucket protection against floods and abuse for the Player State subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.playerstate.rate_guard", algorithm = "token", capacity = 145, refillPerSec = 50, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
