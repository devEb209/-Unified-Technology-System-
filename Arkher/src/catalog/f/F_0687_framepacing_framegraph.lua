-- ARKHER SYSTEM F.0687 :: Frame Pacing Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0687"
	S.key = "arkher.render.framepacing.frame_graph"
	S.name = "Frame Pacing Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Frame Pacing"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "framepacing", "framegraph", "render" }
	S.description = "Frame Pacing Frame Graph: declared passes, culling, ordering and aliasing for the Frame Pacing subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.framepacing.frame_graph", budgetMs = 11.00 })
		inst.system = S
		inst.ctx = ctx
