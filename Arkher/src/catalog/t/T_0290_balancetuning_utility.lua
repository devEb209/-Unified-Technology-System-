-- ARKHER SYSTEM T.0290 :: Balance Tuning Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0290"
	S.key = "arkher.ai.balancetuning.utility_selection"
	S.name = "Balance Tuning Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.balancetuning.working_memory" }
	S.tags = { "t", "balancetuning", "utility", "ai" }
	S.description = "Balance Tuning Utility Selection: scored choice between competing courses of action for the Balance Tuning subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.balancetuning.utility_selection", momentum = 0.03 })
		inst.system = S
		inst.ctx = ctx
