-- ARKHER SYSTEM VB.0463 :: Audio Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0463"
	S.key = "arkher.conttime.audiocont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.audiocont.coherence_guard" }
	S.tags = { "vb", "audiocont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.audiocont.neural_field", dims = 24, hidden = 20, seed = 14899 })
		inst.system = S
		inst.ctx = ctx
