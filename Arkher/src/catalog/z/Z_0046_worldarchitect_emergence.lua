-- ARKHER SYSTEM Z.0046 :: Singularity World Architect Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0046"
	S.key = "arkher.origin.worldarchitect.emergence_detection"
	S.name = "Singularity World Architect Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.world_memory" }
	S.tags = { "z", "worldarchitect", "emergence", "origin" }
	S.description = "Singularity World Architect Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.worldarchitect.emergence_detection", windowSize = 7, threshold = 1.40, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
