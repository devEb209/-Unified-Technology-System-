-- ARKHER SYSTEM V.0394 :: Platform Variant Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0394"
	S.key = "arkher.asset.platformvariant.validation_guard"
	S.name = "Platform Variant Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.platformvariant.size_budget" }
	S.tags = { "v", "platformvariant", "guard", "asset" }
	S.description = "Platform Variant Validation Guard: rate limiting and capability checks on the import path for the Platform Variant subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.platformvariant.validation_guard", algorithm = "sliding", capacity = 89, refillPerSec = 54, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
