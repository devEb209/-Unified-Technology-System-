-- ARKHER SYSTEM N.0191 :: Fog Volume Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0191"
	S.key = "arkher.vfx.fogvolume.result_cache"
	S.name = "Fog Volume Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fog Volume"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fogvolume.spawn_budget" }
	S.tags = { "n", "fogvolume", "cache", "vfx" }
	S.description = "Fog Volume Result Cache: reuse of expensive effect evaluations for the Fog Volume subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.fogvolume.result_cache", policy = "lfu", capacity = 417, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
