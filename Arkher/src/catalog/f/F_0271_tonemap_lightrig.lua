-- ARKHER SYSTEM F.0271 :: Tonemapping Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0271"
	S.key = "arkher.render.tonemap.lighting_rig"
	S.name = "Tonemapping Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Tonemapping"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.tonemap.geometry_virtualization" }
	S.tags = { "f", "tonemap", "lightrig", "render" }
	S.description = "Tonemapping Lighting Rig: light clustering, importance and cascades for the Tonemapping subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.tonemap.lighting_rig", maxActive = 12 })
		inst.system = S
		inst.ctx = ctx
