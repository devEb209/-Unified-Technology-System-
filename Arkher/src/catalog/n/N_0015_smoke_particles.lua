-- ARKHER SYSTEM N.0015 :: Smoke Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0015"
	S.key = "arkher.vfx.smoke.particle_simulation"
	S.name = "Smoke Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Smoke"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.smoke.emission" }
	S.tags = { "n", "smoke", "particles", "vfx" }
	S.description = "Smoke Particle Simulation: pooled integration of position, velocity, colour and life for the Smoke subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.smoke.particle_simulation", capacity = 448, drag = 0.06, bounce = 0.41, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
