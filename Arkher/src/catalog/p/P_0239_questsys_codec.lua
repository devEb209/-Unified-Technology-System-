-- ARKHER SYSTEM P.0239 :: Quest Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0239"
	S.key = "arkher.play.questsys.save_codec"
	S.name = "Quest Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Quest"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.questsys.content_registry" }
	S.tags = { "p", "questsys", "codec", "play" }
	S.description = "Quest Save Codec: persistence, diffing and checksum of gameplay state for the Quest subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.questsys.save_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
