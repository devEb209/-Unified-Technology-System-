-- ARKHER SYSTEM O.0423 :: Audio Profiling Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0423"
	S.key = "arkher.audio.audioprofiling.spatialization"
	S.name = "Audio Profiling Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audioprofiling.mixer_bus" }
	S.tags = { "o", "audioprofiling", "spatialaudio", "audio" }
	S.description = "Audio Profiling Spatialization: distance attenuation, panning, occlusion and doppler for the Audio Profiling subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.audioprofiling.spatialization", model = "linear", refDistance = 7, maxDistance = 120, rolloff = 0.92, maxVoices = 28 })
		inst.system = S
		inst.ctx = ctx
