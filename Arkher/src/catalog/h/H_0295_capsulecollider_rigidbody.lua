-- ARKHER SYSTEM H.0295 :: Capsule Collider Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0295"
	S.key = "arkher.physics.capsulecollider.body_dynamics"
	S.name = "Capsule Collider Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "capsulecollider", "rigidbody", "physics" }
	S.description = "Capsule Collider Body Dynamics: integration, impulses, damping and sleeping of a body for the Capsule Collider subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.capsulecollider.body_dynamics", mass = 3.00, radius = 0.40, restitution = 0.22, friction = 0.72, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
