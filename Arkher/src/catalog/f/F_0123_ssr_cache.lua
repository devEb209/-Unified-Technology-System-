-- ARKHER SYSTEM F.0123 :: Screen Space Reflection Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0123"
	S.key = "arkher.render.ssr.pass_cache"
	S.name = "Screen Space Reflection Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.ssr.render_policy" }
	S.tags = { "f", "ssr", "cache", "render" }
	S.description = "Screen Space Reflection Pass Cache: reuse of pass results across frames for the Screen Space Reflection subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.ssr.pass_cache", policy = "ttl", capacity = 155, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
