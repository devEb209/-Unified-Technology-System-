-- ARKHER SYSTEM VC.0549 :: World Fabric Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0549"
	S.key = "arkher.contneural.worldfabric.complexity_budget"
	S.name = "World Fabric Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldfabric.world_memory_stream" }
	S.tags = { "vc", "worldfabric", "complexity", "contneural" }
	S.description = "World Fabric Complexity Budget: complexity budgeting for the continuum for the World Fabric subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.worldfabric.complexity_budget", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
