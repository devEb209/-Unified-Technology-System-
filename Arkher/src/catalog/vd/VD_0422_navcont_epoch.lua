-- ARKHER SYSTEM VD.0422 :: Navigation Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0422"
	S.key = "arkher.contsim.navcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.navcont.infinite_grid" }
	S.tags = { "vd", "navcont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.navcont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
