-- ARKHER SYSTEM VB.0219 :: Terrain Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0219"
	S.key = "arkher.conttime.terraincont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.terraincont.epoch_clock" }
	S.tags = { "vb", "terraincont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.terraincont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
