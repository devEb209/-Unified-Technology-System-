-- ARKHER SYSTEM E.0004 :: Material Library Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0004"
	S.key = "arkher.material.library.texture_sampling"
	S.name = "Material Library Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.library.shading_graph" }
	S.tags = { "e", "library", "sampler", "material" }
	S.description = "Material Library Texture Sampling: atlas packing, mip chain and filtered sampling for the Material Library subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.library.texture_sampling", atlasSize = 256, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
