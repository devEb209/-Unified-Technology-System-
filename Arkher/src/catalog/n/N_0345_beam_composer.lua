-- ARKHER SYSTEM N.0345 :: Beam Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0345"
	S.key = "arkher.vfx.beam.effect_composition"
	S.name = "Beam Effect Composition"
	S.category = "N"
	S.family = "VFX"
	S.area = "Beam"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.beam.effect_graph" }
	S.tags = { "n", "beam", "composer", "vfx" }
	S.description = "Beam Effect Composition: blending of several effect signals into one output for the Beam subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.beam.effect_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
