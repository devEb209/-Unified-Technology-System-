-- ARKHER SYSTEM R.0141 :: Unreliable Channel Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0141"
	S.key = "arkher.net.unreliablechannel.session_registry"
	S.name = "Unreliable Channel Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.unreliablechannel.rate_guard" }
	S.tags = { "r", "unreliablechannel", "registry", "net" }
	S.description = "Unreliable Channel Session Registry: catalogue of sessions, players and their metadata for the Unreliable Channel subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.unreliablechannel.session_registry" })
		inst.system = S
		inst.ctx = ctx
