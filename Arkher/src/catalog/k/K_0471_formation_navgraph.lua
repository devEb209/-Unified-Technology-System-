-- ARKHER SYSTEM K.0471 :: Formation Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0471"
	S.key = "arkher.npc.formation.navigation"
	S.name = "Formation Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.formation.goal_planner" }
	S.tags = { "k", "formation", "navgraph", "npc" }
	S.description = "Formation Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Formation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.formation.navigation", width = 40, height = 40, cellSize = 4 })
		inst.system = S
		inst.ctx = ctx
