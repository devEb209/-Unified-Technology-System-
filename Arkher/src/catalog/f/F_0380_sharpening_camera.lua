-- ARKHER SYSTEM F.0380 :: Sharpening View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0380"
	S.key = "arkher.render.sharpening.view_and_culling"
	S.name = "Sharpening View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sharpening"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sharpening.frame_graph" }
	S.tags = { "f", "sharpening", "camera", "render" }
	S.description = "Sharpening View And Culling: view state, frustum culling and screen-size LOD for the Sharpening subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.sharpening.view_and_culling", width = 1212, height = 720, fov = 0.9800, far = 2000 })
		inst.system = S
		inst.ctx = ctx
