-- ARKHER SYSTEM E.0508 :: Shader Graph Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0508"
	S.key = "arkher.material.shadergraph.authoring_pipeline"
	S.name = "Shader Graph Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Shader Graph"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.shadergraph.analysis" }
	S.tags = { "e", "shadergraph", "pipeline", "material" }
	S.description = "Shader Graph Authoring Pipeline: ordered authoring and bake stages for the Shader Graph subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.shadergraph.authoring_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
