-- ARKHER SYSTEM VC.0545 :: World Fabric Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0545"
	S.key = "arkher.contneural.worldfabric.persistent_state"
	S.name = "World Fabric Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldfabric.multi-scale_fidelity" }
	S.tags = { "vc", "worldfabric", "persistent", "contneural" }
	S.description = "World Fabric Persistent State: epoch-stamped persistent history and rollback for the World Fabric subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.worldfabric.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
