-- ARKHER SYSTEM VB.0221 :: Terrain Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0221"
	S.key = "arkher.conttime.terraincont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.terraincont.multi-scale_fidelity" }
	S.tags = { "vb", "terraincont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.terraincont.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
