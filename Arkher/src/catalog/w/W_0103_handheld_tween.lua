-- ARKHER SYSTEM W.0103 :: Handheld Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0103"
	S.key = "arkher.cine.handheld.motion_tween"
	S.name = "Handheld Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Handheld"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.handheld.playback_orchestrator" }
	S.tags = { "w", "handheld", "tween", "cine" }
	S.description = "Handheld Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Handheld subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.handheld.motion_tween", timeScale = 1.10 })
		inst.system = S
		inst.ctx = ctx
