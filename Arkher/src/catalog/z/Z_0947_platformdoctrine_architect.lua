-- ARKHER SYSTEM Z.0947 :: Platform Abstraction Doctrine World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0947"
	S.key = "arkher.origin.platformdoctrine.world_architect"
	S.name = "Platform Abstraction Doctrine World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.platformdoctrine.emergence_detection" }
	S.tags = { "z", "platformdoctrine", "architect", "origin" }
	S.description = "Platform Abstraction Doctrine World Architect: hierarchical world composition with conserved budgets for the Platform Abstraction Doctrine subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.platformdoctrine.world_architect", budget = 600, seed = 4820 })
		inst.system = S
		inst.ctx = ctx
