-- ARKHER SYSTEM P.0411 :: Team Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0411"
	S.key = "arkher.play.team.objectives"
	S.name = "Team Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Team"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.team.inventory" }
	S.tags = { "p", "team", "quest", "play" }
	S.description = "Team Objectives: objectives, prerequisites, progress and rewards for the Team subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.team.objectives" })
		inst.system = S
		inst.ctx = ctx
