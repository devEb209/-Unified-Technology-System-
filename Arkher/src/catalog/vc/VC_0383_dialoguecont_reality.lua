-- ARKHER SYSTEM VC.0383 :: Dialogue Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0383"
	S.key = "arkher.contneural.dialoguecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.dialoguecont.simulation_fabric" }
	S.tags = { "vc", "dialoguecont", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.dialoguecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
