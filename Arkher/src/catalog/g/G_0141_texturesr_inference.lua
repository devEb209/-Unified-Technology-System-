-- ARKHER SYSTEM G.0141 :: Texture Super Resolution Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0141"
	S.key = "arkher.neural.texturesr.inference_core"
	S.name = "Texture Super Resolution Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "texturesr", "inference", "neural" }
	S.description = "Texture Super Resolution Inference Core: dense network forward pass and training for the Texture Super Resolution subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.texturesr.inference_core", seed = 84623 })
		inst.system = S
		inst.ctx = ctx
