-- ARKHER SYSTEM VA.0073 :: LOD Cascade Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0073"
	S.key = "arkher.contworld.lodcascade.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "lodcascade", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.lodcascade.infinite_grid", cellSize = 64, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
