-- ARKHER SYSTEM V.0142 :: Icon Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0142"
	S.key = "arkher.asset.iconasset.validation_guard"
	S.name = "Icon Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.iconasset.size_budget" }
	S.tags = { "v", "iconasset", "guard", "asset" }
	S.description = "Icon Validation Guard: rate limiting and capability checks on the import path for the Icon subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.iconasset.validation_guard", algorithm = "sliding", capacity = 190, refillPerSec = 15, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
