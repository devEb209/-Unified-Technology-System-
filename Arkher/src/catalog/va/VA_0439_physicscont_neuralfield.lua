-- ARKHER SYSTEM VA.0439 :: Physics Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0439"
	S.key = "arkher.contworld.physicscont.neural_field"
	S.name = "Physics Continuum Neural Field"
	S.category = "VA"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.physicscont.coherence_guard" }
	S.tags = { "va", "physicscont", "neuralfield", "contworld" }
	S.description = "Physics Continuum Neural Field: neural field encoding and reconstruction for the Physics Continuum subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.physicscont.neural_field", dims = 16, hidden = 12, seed = 46517 })
		inst.system = S
		inst.ctx = ctx
