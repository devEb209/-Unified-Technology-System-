-- ARKHER SYSTEM N.0292 :: Buff Effect Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0292"
	S.key = "arkher.vfx.bufffx.effect_graph"
	S.name = "Buff Effect Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Buff Effect"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.bufffx.curve_authoring" }
	S.tags = { "n", "bufffx", "shadegraph", "vfx" }
	S.description = "Buff Effect Effect Graph: node graph describing how the effect is shaded for the Buff Effect subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.bufffx.effect_graph" })
		inst.system = S
		inst.ctx = ctx
