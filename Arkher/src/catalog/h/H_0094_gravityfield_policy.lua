-- ARKHER SYSTEM H.0094 :: Gravity Field Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0094"
	S.key = "arkher.physics.gravityfield.simulation_policy"
	S.name = "Gravity Field Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.gravityfield.budget_governor" }
	S.tags = { "h", "gravityfield", "policy", "physics" }
	S.description = "Gravity Field Simulation Policy: device tier rules for substeps, iterations and sleep for the Gravity Field subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.gravityfield.simulation_policy", algorithm = "roundrobin", starvationGuard = 52 })
		inst.system = S
		inst.ctx = ctx
