-- ARKHER SYSTEM V.0147 :: UI Sprite Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0147"
	S.key = "arkher.asset.uisprite.cook_pipeline"
	S.name = "UI Sprite Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.uisprite.bundling" }
	S.tags = { "v", "uisprite", "pipeline", "asset" }
	S.description = "UI Sprite Cook Pipeline: staged cooking with isolation and retries for the UI Sprite subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.uisprite.cook_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
