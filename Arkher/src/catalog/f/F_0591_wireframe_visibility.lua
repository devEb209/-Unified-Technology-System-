-- ARKHER SYSTEM F.0591 :: Wireframe Overlay Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0591"
	S.key = "arkher.render.wireframe.visibility_set"
	S.name = "Wireframe Overlay Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.wireframe.view_and_culling" }
	S.tags = { "f", "wireframe", "visibility", "render" }
	S.description = "Wireframe Overlay Visibility Set: cell, portal and occluder visibility for the Wireframe Overlay subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.wireframe.visibility_set", maxDepth = 4 })
		inst.system = S
		inst.ctx = ctx
