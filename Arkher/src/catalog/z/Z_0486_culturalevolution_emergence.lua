-- ARKHER SYSTEM Z.0486 :: Cultural Evolution Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0486"
	S.key = "arkher.origin.culturalevolution.emergence_detection"
	S.name = "Cultural Evolution Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.world_memory" }
	S.tags = { "z", "culturalevolution", "emergence", "origin" }
	S.description = "Cultural Evolution Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.culturalevolution.emergence_detection", windowSize = 4, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
