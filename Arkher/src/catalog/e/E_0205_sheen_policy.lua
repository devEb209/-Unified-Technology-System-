-- ARKHER SYSTEM E.0205 :: Sheen Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0205"
	S.key = "arkher.material.sheen.quality_policy"
	S.name = "Sheen Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Sheen"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.sheen.compression_codec" }
	S.tags = { "e", "sheen", "policy", "material" }
	S.description = "Sheen Quality Policy: device tier rules for the surface for the Sheen subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.sheen.quality_policy", algorithm = "edf", starvationGuard = 41 })
		inst.system = S
		inst.ctx = ctx
