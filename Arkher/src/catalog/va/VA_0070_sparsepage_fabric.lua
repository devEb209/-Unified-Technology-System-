-- ARKHER SYSTEM VA.0070 :: Sparse Page Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0070"
	S.key = "arkher.contworld.sparsepage.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.sparsepage.complexity_budget" }
	S.tags = { "va", "sparsepage", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.sparsepage.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
