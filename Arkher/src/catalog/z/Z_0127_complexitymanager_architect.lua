-- ARKHER SYSTEM Z.0127 :: Dynamic Complexity Manager World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0127"
	S.key = "arkher.origin.complexitymanager.world_architect"
	S.name = "Dynamic Complexity Manager World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.emergence_detection" }
	S.tags = { "z", "complexitymanager", "architect", "origin" }
	S.description = "Dynamic Complexity Manager World Architect: hierarchical world composition with conserved budgets for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.complexitymanager.world_architect", budget = 600, seed = 46380 })
		inst.system = S
		inst.ctx = ctx
