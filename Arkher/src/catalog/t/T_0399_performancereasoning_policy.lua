-- ARKHER SYSTEM T.0399 :: Performance Reasoning Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0399"
	S.key = "arkher.ai.performancereasoning.decision_policy"
	S.name = "Performance Reasoning Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.performancereasoning.reasoning_graph" }
	S.tags = { "t", "performancereasoning", "policy", "ai" }
	S.description = "Performance Reasoning Decision Policy: ordered rules deciding what the agent does next for the Performance Reasoning subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.performancereasoning.decision_policy", algorithm = "lottery", starvationGuard = 35 })
		inst.system = S
		inst.ctx = ctx
