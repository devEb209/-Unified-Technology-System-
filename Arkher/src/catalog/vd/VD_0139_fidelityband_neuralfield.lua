-- ARKHER SYSTEM VD.0139 :: Fidelity Band Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0139"
	S.key = "arkher.contsim.fidelityband.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.fidelityband.coherence_guard" }
	S.tags = { "vd", "fidelityband", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.fidelityband.neural_field", dims = 12, hidden = 8, seed = 1632 })
		inst.system = S
		inst.ctx = ctx
