-- ARKHER SYSTEM V.0057 :: Material Asset Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0057"
	S.key = "arkher.asset.materialasset.size_budget"
	S.name = "Material Asset Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.materialasset.compression_codec" }
	S.tags = { "v", "materialasset", "budgeter", "asset" }
	S.description = "Material Asset Size Budget: byte budget shared between competing asset classes for the Material Asset subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.materialasset.size_budget", total = 215, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
