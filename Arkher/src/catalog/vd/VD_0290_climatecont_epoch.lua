-- ARKHER SYSTEM VD.0290 :: Climate Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0290"
	S.key = "arkher.contsim.climatecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.climatecont.infinite_grid" }
	S.tags = { "vd", "climatecont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.climatecont.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
