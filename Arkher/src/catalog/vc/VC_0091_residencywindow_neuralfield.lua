-- ARKHER SYSTEM VC.0091 :: Residency Window Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0091"
	S.key = "arkher.contneural.residencywindow.neural_field"
	S.name = "Residency Window Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.residencywindow.coherence_guard" }
	S.tags = { "vc", "residencywindow", "neuralfield", "contneural" }
	S.description = "Residency Window Neural Field: neural field encoding and reconstruction for the Residency Window subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.residencywindow.neural_field", dims = 20, hidden = 16, seed = 65430 })
		inst.system = S
		inst.ctx = ctx
