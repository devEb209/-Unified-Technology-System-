-- ARKHER SYSTEM Z.0910 :: Deterministic Replay Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0910"
	S.key = "arkher.origin.deterministicreplay.self_critique"
	S.name = "Deterministic Replay Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deterministicreplay.intent_bridge" }
	S.tags = { "z", "deterministicreplay", "critic", "origin" }
	S.description = "Deterministic Replay Self Critique: weighted judgement of the technology's own output for the Deterministic Replay subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.deterministicreplay.self_critique", passMark = 0.71, reviseMark = 0.46, seed = 5386 })
		inst.system = S
		inst.ctx = ctx
