-- ARKHER SYSTEM W.0079 :: Dolly Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0079"
	S.key = "arkher.cine.dolly.motion_tween"
	S.name = "Dolly Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dolly"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dolly.playback_orchestrator" }
	S.tags = { "w", "dolly", "tween", "cine" }
	S.description = "Dolly Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Dolly subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.dolly.motion_tween", timeScale = 1.11 })
		inst.system = S
		inst.ctx = ctx
