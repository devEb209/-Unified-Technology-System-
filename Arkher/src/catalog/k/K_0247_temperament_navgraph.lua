-- ARKHER SYSTEM K.0247 :: Temperament Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0247"
	S.key = "arkher.npc.temperament.navigation"
	S.name = "Temperament Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.temperament.goal_planner" }
	S.tags = { "k", "temperament", "navgraph", "npc" }
	S.description = "Temperament Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Temperament subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.temperament.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
