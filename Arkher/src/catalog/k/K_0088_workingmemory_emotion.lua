-- ARKHER SYSTEM K.0088 :: Working Memory Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0088"
	S.key = "arkher.npc.workingmemory.emotion"
	S.name = "Working Memory Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workingmemory.drive_system" }
	S.tags = { "k", "workingmemory", "emotion", "npc" }
	S.description = "Working Memory Emotion: appraisal of events into valence, arousal and mood for the Working Memory subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.workingmemory.emotion", inertia = 0.94, decayRate = 0.29, baselineArousal = 0.29 })
		inst.system = S
		inst.ctx = ctx
