-- ARKHER SYSTEM L.0478 :: Faction Politics Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0478"
	S.key = "arkher.sim.factionpolitics.analysis"
	S.name = "Faction Politics Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.factionpolitics.aggregate_cache" }
	S.tags = { "l", "factionpolitics", "analyzer", "sim" }
	S.description = "Faction Politics Analysis: trend, anomaly and stability analysis of the world for the Faction Politics subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.factionpolitics.analysis", window = 144, buckets = 12, threshold = 3.60 })
		inst.system = S
		inst.ctx = ctx
