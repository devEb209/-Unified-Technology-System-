-- ARKHER SYSTEM I.0256 :: Turn In Place Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0256"
	S.key = "arkher.anim.turninplace.playback_pipeline"
	S.name = "Turn In Place Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.turninplace.event_ledger" }
	S.tags = { "i", "turninplace", "pipeline", "anim" }
	S.description = "Turn In Place Playback Pipeline: ordered sample, blend, ik and output stages for the Turn In Place subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.turninplace.playback_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
