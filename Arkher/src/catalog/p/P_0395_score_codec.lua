-- ARKHER SYSTEM P.0395 :: Score Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0395"
	S.key = "arkher.play.score.save_codec"
	S.name = "Score Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Score"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.score.content_registry" }
	S.tags = { "p", "score", "codec", "play" }
	S.description = "Score Save Codec: persistence, diffing and checksum of gameplay state for the Score subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.score.save_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
