-- ARKHER SYSTEM W.0327 :: Exposure Ramp Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0327"
	S.key = "arkher.cine.exposureramp.colour_grade"
	S.name = "Exposure Ramp Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.exposureramp.camera_rig" }
	S.tags = { "w", "exposureramp", "grade", "cine" }
	S.description = "Exposure Ramp Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Exposure Ramp subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.exposureramp.colour_grade", exposure = 0.06, contrast = 1.11, saturation = 1.06, toneMap = "linear" })
		inst.system = S
		inst.ctx = ctx
