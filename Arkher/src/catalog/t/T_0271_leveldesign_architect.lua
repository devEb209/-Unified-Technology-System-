-- ARKHER SYSTEM T.0271 :: Level Design World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0271"
	S.key = "arkher.ai.leveldesign.world_architect"
	S.name = "Level Design World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.leveldesign.self_critique" }
	S.tags = { "t", "leveldesign", "architect", "ai" }
	S.description = "Level Design World Architect: composition of a whole world plan with conserved budgets for the Level Design subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.leveldesign.world_architect", budget = 800, seed = 40232 })
		inst.system = S
		inst.ctx = ctx
