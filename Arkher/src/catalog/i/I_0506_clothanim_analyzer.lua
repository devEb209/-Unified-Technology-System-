-- ARKHER SYSTEM I.0506 :: Cloth Animation Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0506"
	S.key = "arkher.anim.clothanim.analysis"
	S.name = "Cloth Animation Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clothanim.quality_policy" }
	S.tags = { "i", "clothanim", "analyzer", "anim" }
	S.description = "Cloth Animation Analysis: pop, drift and cost analysis of playback for the Cloth Animation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.clothanim.analysis", window = 96, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
