-- ARKHER SYSTEM VC.0179 :: Neural Patch Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0179"
	S.key = "arkher.contneural.neuralpatch.reality_continuum"
	S.name = "Neural Patch Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.neuralpatch.simulation_fabric" }
	S.tags = { "vc", "neuralpatch", "reality", "contneural" }
	S.description = "Neural Patch Reality Continuum: stacked reality layers of the continuum for the Neural Patch subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.neuralpatch.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
