-- ARKHER SYSTEM Z.1005 :: Capability Discovery World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.1005"
	S.key = "arkher.origin.capabilitydiscovery.world_memory"
	S.name = "Capability Discovery World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.autonomous_pipeline" }
	S.tags = { "z", "capabilitydiscovery", "worldmemory", "origin" }
	S.description = "Capability Discovery World Memory: epoch-stamped persistent history with compaction and checkpoints for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.capabilitydiscovery.world_memory", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
