-- ARKHER SYSTEM I.0357 :: Hit Reaction Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0357"
	S.key = "arkher.anim.hitreaction.retarget_graph"
	S.name = "Hit Reaction Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Hit Reaction"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.hitreaction.physical_blend" }
	S.tags = { "i", "hitreaction", "graph", "anim" }
	S.description = "Hit Reaction Retarget Graph: bone mapping and retarget path resolution for the Hit Reaction subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.hitreaction.retarget_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
