-- ARKHER SYSTEM F.0639 :: Memory Aliasing Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0639"
	S.key = "arkher.render.memaliasing.draw_budget"
	S.name = "Memory Aliasing Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.memaliasing.adaptive_resolution" }
	S.tags = { "f", "memaliasing", "budgeter", "render" }
	S.description = "Memory Aliasing Draw Budget: draw call and triangle budget allocation for the Memory Aliasing subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.memaliasing.draw_budget", total = 185, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
