-- ARKHER SYSTEM VA.0504 :: Rendering Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0504"
	S.key = "arkher.contworld.rendercont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.rendercont.reality_continuum" }
	S.tags = { "va", "rendercont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.rendercont.emergence_continuum", windowSize = 6, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
