-- ARKHER SYSTEM F.0111 :: Ambient Occlusion Pass Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0111"
	S.key = "arkher.render.aopass.orchestration"
	S.name = "Ambient Occlusion Pass Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.aopass.frame_analysis" }
	S.tags = { "f", "aopass", "orchestrator", "render" }
	S.description = "Ambient Occlusion Pass Orchestration: frame lifecycle orchestration for the Ambient Occlusion Pass subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.aopass.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
