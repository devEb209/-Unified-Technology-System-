-- ARKHER SYSTEM E.0446 :: Detail Tiling Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0446"
	S.key = "arkher.material.detailtile.instance_cache"
	S.name = "Detail Tiling Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.detailtile.quality_policy" }
	S.tags = { "e", "detailtile", "cache", "material" }
	S.description = "Detail Tiling Instance Cache: resolved-parameter cache keyed by context for the Detail Tiling subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.detailtile.instance_cache", policy = "ttl", capacity = 265, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
