-- ARKHER SYSTEM W.0095 :: Crane Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0095"
	S.key = "arkher.cine.crane.sequence_analysis"
	S.name = "Crane Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Crane"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.crane.frame_budget" }
	S.tags = { "w", "crane", "analyzer", "cine" }
	S.description = "Crane Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Crane subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.crane.sequence_analysis", window = 207, buckets = 15, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
