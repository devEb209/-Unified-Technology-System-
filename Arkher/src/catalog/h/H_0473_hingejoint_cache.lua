-- ARKHER SYSTEM H.0473 :: Hinge Joint Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0473"
	S.key = "arkher.physics.hingejoint.result_cache"
	S.name = "Hinge Joint Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Hinge Joint"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.hingejoint.simulation_policy" }
	S.tags = { "h", "hingejoint", "cache", "physics" }
	S.description = "Hinge Joint Result Cache: reuse of expensive simulation and query results for the Hinge Joint subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.hingejoint.result_cache", policy = "lru", capacity = 103, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
