-- ARKHER SYSTEM H.0606 :: Explosion Force Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0606"
	S.key = "arkher.physics.explosion.constraint_solver"
	S.name = "Explosion Force Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.explosion.contact_generation" }
	S.tags = { "h", "explosion", "constraint", "physics" }
	S.description = "Explosion Force Constraint Solver: sequential impulses, friction, joints and warm starting for the Explosion Force subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.explosion.constraint_solver", iterations = 12, baumgarte = 0.28, warmStart = true })
		inst.system = S
		inst.ctx = ctx
