-- ARKHER SYSTEM J.0178 :: Accessory Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0178"
	S.key = "arkher.character.accessory.motion_set"
	S.name = "Accessory Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.accessory.rig_definition" }
	S.tags = { "j", "accessory", "clip", "character" }
	S.description = "Accessory Motion Set: the clips a character owns and how they sample for the Accessory subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.accessory.motion_set", duration = 2.00, loop = true })
		inst.system = S
		inst.ctx = ctx
