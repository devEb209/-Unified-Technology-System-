-- ARKHER SYSTEM VB.0374 :: Dialogue Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0374"
	S.key = "arkher.conttime.dialoguecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.dialoguecont.infinite_grid" }
	S.tags = { "vb", "dialoguecont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.dialoguecont.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
