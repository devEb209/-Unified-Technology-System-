-- ARKHER SYSTEM K.0043 :: Reward Model Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0043"
	S.key = "arkher.npc.rewardmodel.mind_network"
	S.name = "Reward Model Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "rewardmodel", "mindnet", "npc" }
	S.description = "Reward Model Mind Network: the learned policy that turns perception into a decision for the Reward Model subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.rewardmodel.mind_network", inputs = 7, hidden = 6, seed = 25097, learningRate = 0.085, exploration = 0.025 })
		inst.system = S
		inst.ctx = ctx
