-- ARKHER SYSTEM F.0183 :: Sky Model Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0183"
	S.key = "arkher.render.sky.frame_graph"
	S.name = "Sky Model Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sky Model"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "sky", "framegraph", "render" }
	S.description = "Sky Model Frame Graph: declared passes, culling, ordering and aliasing for the Sky Model subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.sky.frame_graph", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
