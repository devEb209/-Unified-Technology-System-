-- ARKHER SYSTEM I.0226 :: Root Motion Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0226"
	S.key = "arkher.anim.rootmotion.physical_blend"
	S.name = "Root Motion Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Root Motion"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.rootmotion.inverse_kinematics" }
	S.tags = { "i", "rootmotion", "ragdoll", "anim" }
	S.description = "Root Motion Physical Blend: physical bones blended against the animated pose for the Root Motion subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.rootmotion.physical_blend", blendSpeed = 5.70 })
		inst.system = S
		inst.ctx = ctx
