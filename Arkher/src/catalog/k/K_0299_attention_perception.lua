-- ARKHER SYSTEM K.0299 :: Attention Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0299"
	S.key = "arkher.npc.attention.perception"
	S.name = "Attention Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.attention.emotion" }
	S.tags = { "k", "attention", "perception", "npc" }
	S.description = "Attention Perception: sight, hearing and bounded attention for the Attention subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.attention.perception", sightRange = 55, hearingRange = 28, attentionSlots = 5, fov = 1.900 })
		inst.system = S
		inst.ctx = ctx
