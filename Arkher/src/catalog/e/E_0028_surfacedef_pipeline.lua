-- ARKHER SYSTEM E.0028 :: Surface Definition Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0028"
	S.key = "arkher.material.surfacedef.authoring_pipeline"
	S.name = "Surface Definition Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.surfacedef.analysis" }
	S.tags = { "e", "surfacedef", "pipeline", "material" }
	S.description = "Surface Definition Authoring Pipeline: ordered authoring and bake stages for the Surface Definition subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.surfacedef.authoring_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
