-- ARKHER SYSTEM J.0278 :: Character Physics Blend Controller
...
-- Kit: animator (layered playback driving the character)
--@arkher-module
return function(A)
	...
	local S = {}
	S.id = "J.0278"
	S.key = "arkher.character.characterphysics.blend_controller"
	S.name = "Character Physics Blend Controller"
	S.category = "J"
	S.family = "CHARACTERS / DIGITAL HUMANS"
	S.area = "Character Physics"
	S.aspect = "Blend Controller"
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterphysics.motion_set" }
	S.tags = { "j", "characterphysics", "animator", "character" }
	S.description = "Character Physics Blend Controller: layered playback driving the character for the Character Physics subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.characterphysics.blend_controller", budget = 13 })
		inst.system = S
		inst.ctx = ctx
