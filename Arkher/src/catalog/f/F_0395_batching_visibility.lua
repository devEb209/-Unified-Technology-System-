-- ARKHER SYSTEM F.0395 :: Draw Call Batching Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0395"
	S.key = "arkher.render.batching.visibility_set"
	S.name = "Draw Call Batching Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.batching.view_and_culling" }
	S.tags = { "f", "batching", "visibility", "render" }
	S.description = "Draw Call Batching Visibility Set: cell, portal and occluder visibility for the Draw Call Batching subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.batching.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
