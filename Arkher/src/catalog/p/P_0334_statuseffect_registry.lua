-- ARKHER SYSTEM P.0334 :: Status Effect Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0334"
	S.key = "arkher.play.statuseffect.content_registry"
	S.name = "Status Effect Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.statuseffect.difficulty_controller" }
	S.tags = { "p", "statuseffect", "registry", "play" }
	S.description = "Status Effect Content Registry: catalogue of the definitions this loop instantiates for the Status Effect subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.statuseffect.content_registry" })
		inst.system = S
		inst.ctx = ctx
