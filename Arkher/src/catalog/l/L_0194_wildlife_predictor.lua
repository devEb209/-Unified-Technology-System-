-- ARKHER SYSTEM L.0194 :: Wildlife Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0194"
	S.key = "arkher.sim.wildlife.forecast"
	S.name = "Wildlife Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wildlife.analysis" }
	S.tags = { "l", "wildlife", "predictor", "sim" }
	S.description = "Wildlife Forecast: prediction of the region's next state for the Wildlife subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.wildlife.forecast", method = "markov", alpha = 0.19, window = 49 })
		inst.system = S
		inst.ctx = ctx
