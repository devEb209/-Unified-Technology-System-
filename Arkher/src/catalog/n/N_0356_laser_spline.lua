-- ARKHER SYSTEM N.0356 :: Laser Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0356"
	S.key = "arkher.vfx.laser.curve_authoring"
	S.name = "Laser Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Laser"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.laser.ribbon_and_trail" }
	S.tags = { "n", "laser", "spline", "vfx" }
	S.description = "Laser Curve Authoring: authored curves driving the effect over its life for the Laser subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.laser.curve_authoring", tension = 0.53, closed = false })
		inst.system = S
		inst.ctx = ctx
