-- ARKHER SYSTEM K.0698 :: NPC Debug Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0698"
	S.key = "arkher.npc.npcdebug.daily_schedule"
	S.name = "NPC Debug Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcdebug.social_relations" }
	S.tags = { "k", "npcdebug", "schedule", "npc" }
	S.description = "NPC Debug Daily Schedule: hour-by-hour routine with priority interruptions for the NPC Debug subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.npcdebug.daily_schedule", startHour = 9 })
		inst.system = S
		inst.ctx = ctx
