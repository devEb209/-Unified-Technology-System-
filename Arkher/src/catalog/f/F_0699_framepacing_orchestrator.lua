-- ARKHER SYSTEM F.0699 :: Frame Pacing Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0699"
	S.key = "arkher.render.framepacing.orchestration"
	S.name = "Frame Pacing Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Frame Pacing"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepacing.frame_analysis" }
	S.tags = { "f", "framepacing", "orchestrator", "render" }
	S.description = "Frame Pacing Orchestration: frame lifecycle orchestration for the Frame Pacing subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.framepacing.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
