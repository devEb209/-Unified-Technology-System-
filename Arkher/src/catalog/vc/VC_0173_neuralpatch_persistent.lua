-- ARKHER SYSTEM VC.0173 :: Neural Patch Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0173"
	S.key = "arkher.contneural.neuralpatch.persistent_state"
	S.name = "Neural Patch Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.neuralpatch.multi-scale_fidelity" }
	S.tags = { "vc", "neuralpatch", "persistent", "contneural" }
	S.description = "Neural Patch Persistent State: epoch-stamped persistent history and rollback for the Neural Patch subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.neuralpatch.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
