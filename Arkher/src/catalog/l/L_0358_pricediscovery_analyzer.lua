-- ARKHER SYSTEM L.0358 :: Price Discovery Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0358"
	S.key = "arkher.sim.pricediscovery.analysis"
	S.name = "Price Discovery Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.pricediscovery.aggregate_cache" }
	S.tags = { "l", "pricediscovery", "analyzer", "sim" }
	S.description = "Price Discovery Analysis: trend, anomaly and stability analysis of the world for the Price Discovery subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.pricediscovery.analysis", window = 104, buckets = 8, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
