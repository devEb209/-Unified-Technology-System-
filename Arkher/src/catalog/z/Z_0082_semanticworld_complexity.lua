-- ARKHER SYSTEM Z.0082 :: Semantic World Graph Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0082"
	S.key = "arkher.origin.semanticworld.complexity_governance"
	S.name = "Semantic World Graph Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticworld.reality_layering" }
	S.tags = { "z", "semanticworld", "complexity", "origin" }
	S.description = "Semantic World Graph Complexity Governance: measured scene cost turned into per-subsystem directives for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.semanticworld.complexity_governance", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
