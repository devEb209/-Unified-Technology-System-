-- ARKHER SYSTEM K.0231 :: Personality Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0231"
	S.key = "arkher.npc.personality.utility_reasoning"
	S.name = "Personality Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.personality.reactive_behaviour" }
	S.tags = { "k", "personality", "utility", "npc" }
	S.description = "Personality Utility Reasoning: scored option selection with response curves for the Personality subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.personality.utility_reasoning", momentum = 0.17 })
		inst.system = S
		inst.ctx = ctx
