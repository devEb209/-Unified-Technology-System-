-- ARKHER SYSTEM K.0500 :: Patrol Route Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0500"
	S.key = "arkher.npc.patrolroute.crowd_steering"
	S.name = "Patrol Route Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.patrolroute.navigation" }
	S.tags = { "k", "patrolroute", "crowd", "npc" }
	S.description = "Patrol Route Crowd Steering: local avoidance, cohesion and arrival at scale for the Patrol Route subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.patrolroute.crowd_steering", radius = 0.45, maxSpeed = 4.10, cellSize = 11 })
		inst.system = S
		inst.ctx = ctx
