-- ARKHER SYSTEM K.0190 :: Purpose Drive Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0190"
	S.key = "arkher.npc.purposedrive.goal_planner"
	S.name = "Purpose Drive Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.purposedrive.utility_reasoning" }
	S.tags = { "k", "purposedrive", "planner", "npc" }
	S.description = "Purpose Drive Goal Planner: backward GOAP planning to reach a goal state for the Purpose Drive subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.purposedrive.goal_planner", maxDepth = 8 })
		inst.system = S
		inst.ctx = ctx
