-- ARKHER SYSTEM Z.0135 :: Dynamic Complexity Manager Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0135"
	S.key = "arkher.origin.complexitymanager.signal_composition"
	S.name = "Dynamic Complexity Manager Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.telemetry_ledger" }
	S.tags = { "z", "complexitymanager", "composer", "origin" }
	S.description = "Dynamic Complexity Manager Signal Composition: blending of the technology's input signals into one output for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.complexitymanager.signal_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
