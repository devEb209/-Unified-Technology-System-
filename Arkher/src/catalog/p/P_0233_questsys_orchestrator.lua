-- ARKHER SYSTEM P.0233 :: Quest State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0233"
	S.key = "arkher.play.questsys.state_machine"
	S.name = "Quest State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Quest"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.questsys.combat_resolution" }
	S.tags = { "p", "questsys", "orchestrator", "play" }
	S.description = "Quest State Machine: the phase machine that drives this gameplay loop for the Quest subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.questsys.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
