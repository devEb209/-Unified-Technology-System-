-- ARKHER SYSTEM VA.0231 :: City Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0231"
	S.key = "arkher.contworld.citycont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.citycont.epoch_clock" }
	S.tags = { "va", "citycont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.citycont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
