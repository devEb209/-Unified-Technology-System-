-- ARKHER SYSTEM L.0349 :: Price Discovery Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0349"
	S.key = "arkher.sim.pricediscovery.society"
	S.name = "Price Discovery Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.pricediscovery.economy" }
	S.tags = { "l", "pricediscovery", "society", "sim" }
	S.description = "Price Discovery Society: relations, factions, reputation and cohesion of the region for the Price Discovery subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.pricediscovery.society", decayRate = 0.007, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
