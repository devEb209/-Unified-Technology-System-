-- ARKHER SYSTEM Q.0137 :: Menu Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0137"
	S.key = "arkher.ui.menu.navigation_graph"
	S.name = "Menu Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Menu"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.menu.transition" }
	S.tags = { "q", "menu", "graph", "ui" }
	S.description = "Menu Navigation Graph: screens, routes and shortest path between them for the Menu subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.menu.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
