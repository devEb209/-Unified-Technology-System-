-- ARKHER SYSTEM VC.0007 :: World Grid Cell Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0007"
	S.key = "arkher.contneural.worldcell.neural_field"
	S.name = "World Grid Cell Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldcell.coherence_guard" }
	S.tags = { "vc", "worldcell", "neuralfield", "contneural" }
	S.description = "World Grid Cell Neural Field: neural field encoding and reconstruction for the World Grid Cell subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.worldcell.neural_field", dims = 20, hidden = 16, seed = 37218 })
		inst.system = S
		inst.ctx = ctx
