--!strict
-- PolyHaven CC0 — ANIMATION Profiler #0299
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="PolyHaven CC0 — ANIMATION Profiler #0299", size=Vector2.new(680, 500), pos=UDim2.fromOffset(387, 223), parent=parent, icon="⬣"})
