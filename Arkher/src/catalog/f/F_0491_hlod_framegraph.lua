-- ARKHER SYSTEM F.0491 :: HLOD Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0491"
	S.key = "arkher.render.hlod.frame_graph"
	S.name = "HLOD Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "HLOD"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "hlod", "framegraph", "render" }
	S.description = "HLOD Frame Graph: declared passes, culling, ordering and aliasing for the HLOD subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.hlod.frame_graph", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
