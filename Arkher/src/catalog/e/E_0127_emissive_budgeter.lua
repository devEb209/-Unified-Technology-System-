-- ARKHER SYSTEM E.0127 :: Emissive Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0127"
	S.key = "arkher.material.emissive.parameter_budget"
	S.name = "Emissive Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Emissive"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.emissive.variant_registry" }
	S.tags = { "e", "emissive", "budgeter", "material" }
	S.description = "Emissive Parameter Budget: texel and layer budget allocation for the Emissive subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.emissive.parameter_budget", total = 369, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
