-- ARKHER SYSTEM J.0169 :: Clothing Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0169"
	S.key = "arkher.character.clothing.look_and_reach"
	S.name = "Clothing Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.clothing.blend_controller" }
	S.tags = { "j", "clothing", "ik", "character" }
	S.description = "Clothing Look And Reach: look-at, reach and foot placement for the character for the Clothing subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.clothing.look_and_reach", iterations = 6, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
