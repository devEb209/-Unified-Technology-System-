...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="PolyHaven CC0 — CORE Map #0158", size=Vector2.new(680, 480), pos=UDim2.fromOffset(154, 166), parent=parent, icon="◤"})
