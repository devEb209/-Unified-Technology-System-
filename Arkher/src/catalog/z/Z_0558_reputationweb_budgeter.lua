-- ARKHER SYSTEM Z.0558 :: Reputation Web Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0558"
	S.key = "arkher.origin.reputationweb.budget_governor"
	S.name = "Reputation Web Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.behaviour_analysis" }
	S.tags = { "z", "reputationweb", "budgeter", "origin" }
	S.description = "Reputation Web Budget Governor: allocation of a scarce resource across the technology's consumers for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.reputationweb.budget_governor", total = 343, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
