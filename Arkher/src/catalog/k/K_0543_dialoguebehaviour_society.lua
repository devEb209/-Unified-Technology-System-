-- ARKHER SYSTEM K.0543 :: Dialogue Behaviour Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0543"
	S.key = "arkher.npc.dialoguebehaviour.social_relations"
	S.name = "Dialogue Behaviour Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dialoguebehaviour.crowd_steering" }
	S.tags = { "k", "dialoguebehaviour", "society", "npc" }
	S.description = "Dialogue Behaviour Social Relations: affinity, factions, reputation and gossip for the Dialogue Behaviour subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.dialoguebehaviour.social_relations", decayRate = 0.010, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
