-- ARKHER SYSTEM F.0440 :: Portal Culling Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0440"
	S.key = "arkher.render.portal.probe_volume"
	S.name = "Portal Culling Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.portal.lighting_rig" }
	S.tags = { "f", "portal", "probe", "render" }
	S.description = "Portal Culling Probe Volume: irradiance probes encoded in spherical harmonics for the Portal Culling subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.portal.probe_volume", spacing = 24 })
		inst.system = S
		inst.ctx = ctx
