-- ARKHER SYSTEM Z.0912 :: Deterministic Replay Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0912"
	S.key = "arkher.origin.deterministicreplay.predictive_optimization"
	S.name = "Deterministic Replay Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deterministicreplay.adaptive_workflow" }
	S.tags = { "z", "deterministicreplay", "predictor", "origin" }
	S.description = "Deterministic Replay Predictive Optimization: forecast-driven optimization before the cost is paid for the Deterministic Replay subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.deterministicreplay.predictive_optimization", method = "linear", alpha = 0.48, window = 54 })
		inst.system = S
		inst.ctx = ctx
