-- ARKHER SYSTEM VC.0048 :: Continuum Stream Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0048"
	S.key = "arkher.contneural.continuumstream.emergence_continuum"
	S.name = "Continuum Stream Emergence Continuum"
	S.category = "VC"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.continuumstream.reality_continuum" }
	S.tags = { "vc", "continuumstream", "emergence", "contneural" }
	S.description = "Continuum Stream Emergence Continuum: emergence detection over the continuum for the Continuum Stream subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.continuumstream.emergence_continuum", windowSize = 6, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
