-- ARKHER SYSTEM VA.0049 :: Epoch Frame Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0049"
	S.key = "arkher.contworld.epochframe.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "epochframe", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.epochframe.infinite_grid", cellSize = 160, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
