-- ARKHER SYSTEM VA.0191 :: Simulation Domain Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0191"
	S.key = "arkher.contworld.simdomain.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.simdomain.simulation_fabric" }
	S.tags = { "va", "simdomain", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.simdomain.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
