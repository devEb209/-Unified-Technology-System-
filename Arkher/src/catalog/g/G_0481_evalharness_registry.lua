-- ARKHER SYSTEM G.0481 :: Evaluation Harness Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0481"
	S.key = "arkher.neural.evalharness.model_registry"
	S.name = "Evaluation Harness Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.evalharness.reconstruction" }
	S.tags = { "g", "evalharness", "registry", "neural" }
	S.description = "Evaluation Harness Model Registry: named models and their lifecycle for the Evaluation Harness subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.evalharness.model_registry" })
		inst.system = S
		inst.ctx = ctx
