-- ARKHER SYSTEM G.0451 :: On Device Budget Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0451"
	S.key = "arkher.neural.ondevicebudget.temporal_history"
	S.name = "On Device Budget Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ondevicebudget.feature_extraction" }
	S.tags = { "g", "ondevicebudget", "temporal", "neural" }
	S.description = "On Device Budget Temporal History: history buffers reused across frames for the On Device Budget subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.ondevicebudget.temporal_history", feedback = 0.82, phase = 8 })
		inst.system = S
		inst.ctx = ctx
