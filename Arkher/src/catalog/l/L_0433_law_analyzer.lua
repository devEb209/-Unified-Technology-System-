-- ARKHER SYSTEM L.0433 :: Law Analysis
...
return function(A)
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.law.aggregate_cache" }
	S.tags = { "l", "law", "analyzer", "sim" }
	S.description = "Law Analysis: trend, anomaly and stability analysis of the world for the Law subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.law.analysis", window = 179, buckets = 11, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
