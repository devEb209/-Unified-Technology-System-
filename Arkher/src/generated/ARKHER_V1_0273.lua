--!strict
-- Google Maps — ANIMATION Map #0273
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Google Maps — ANIMATION Map #0273", size=Vector2.new(600, 480), pos=UDim2.fromOffset(449, 301), parent=parent, icon="🛰"})
