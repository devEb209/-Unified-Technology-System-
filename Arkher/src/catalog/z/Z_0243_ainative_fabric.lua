-- ARKHER SYSTEM Z.0243 :: AI Native Engine Architecture Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0243"
	S.key = "arkher.origin.ainative.simulation_fabric"
	S.name = "AI Native Engine Architecture Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.ainative.complexity_governance" }
	S.tags = { "z", "ainative", "fabric", "origin" }
	S.description = "AI Native Engine Architecture Simulation Fabric: every simulation domain stepped under one budgeted clock for the AI Native Engine Architecture subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.ainative.simulation_fabric", budgetMs = 2.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
