-- ARKHER SYSTEM K.0390 :: Goal Selection Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0390"
	S.key = "arkher.npc.goalselection.daily_schedule"
	S.name = "Goal Selection Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.goalselection.social_relations" }
	S.tags = { "k", "goalselection", "schedule", "npc" }
	S.description = "Goal Selection Daily Schedule: hour-by-hour routine with priority interruptions for the Goal Selection subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.goalselection.daily_schedule", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
