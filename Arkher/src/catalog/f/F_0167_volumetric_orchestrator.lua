-- ARKHER SYSTEM F.0167 :: Volumetric Light Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0167"
	S.key = "arkher.render.volumetric.orchestration"
	S.name = "Volumetric Light Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.volumetric.frame_analysis" }
	S.tags = { "f", "volumetric", "orchestrator", "render" }
	S.description = "Volumetric Light Orchestration: frame lifecycle orchestration for the Volumetric Light subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.volumetric.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
