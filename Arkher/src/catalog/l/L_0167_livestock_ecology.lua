-- ARKHER SYSTEM L.0167 :: Livestock Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0167"
	S.key = "arkher.sim.livestock.ecology"
	S.name = "Livestock Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livestock.simulation_core" }
	S.tags = { "l", "livestock", "ecology", "sim" }
	S.description = "Livestock Ecology: populations, predation, harvesting and carrying capacity for the Livestock subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.livestock.ecology" })
		inst.system = S
		inst.ctx = ctx
