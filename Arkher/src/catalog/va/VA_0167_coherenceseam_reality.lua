-- ARKHER SYSTEM VA.0167 :: Coherence Seam Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0167"
	S.key = "arkher.contworld.coherenceseam.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.coherenceseam.simulation_fabric" }
	S.tags = { "va", "coherenceseam", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.coherenceseam.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
