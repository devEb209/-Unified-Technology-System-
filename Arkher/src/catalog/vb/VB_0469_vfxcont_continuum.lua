-- ARKHER SYSTEM VB.0469 :: VFX Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0469"
	S.key = "arkher.conttime.vfxcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "vfxcont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.vfxcont.infinite_grid", cellSize = 224, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
