-- ARKHER SYSTEM F.0067 :: Shadow Pass Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0067"
	S.key = "arkher.render.shadowpass.pass_cache"
	S.name = "Shadow Pass Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Shadow Pass"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.shadowpass.render_policy" }
	S.tags = { "f", "shadowpass", "cache", "render" }
	S.description = "Shadow Pass Pass Cache: reuse of pass results across frames for the Shadow Pass subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.shadowpass.pass_cache", policy = "ttl", capacity = 425, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
