-- ARKHER SYSTEM L.0144 :: City Life State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0144"
	S.key = "arkher.sim.citylife.state_codec"
	S.name = "City Life State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.citylife.history_ledger" }
	S.tags = { "l", "citylife", "codec", "sim" }
	S.description = "City Life State Codec: persistence, diffing and checksum of the world state for the City Life subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.citylife.state_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
