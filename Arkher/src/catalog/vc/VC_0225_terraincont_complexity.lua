-- ARKHER SYSTEM VC.0225 :: Terrain Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0225"
	S.key = "arkher.contneural.terraincont.complexity_budget"
	S.name = "Terrain Continuum Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.terraincont.world_memory_stream" }
	S.tags = { "vc", "terraincont", "complexity", "contneural" }
	S.description = "Terrain Continuum Complexity Budget: complexity budgeting for the continuum for the Terrain Continuum subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.terraincont.complexity_budget", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
