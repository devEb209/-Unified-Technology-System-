-- ARKHER SYSTEM I.0100 :: Clip Looping Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0100"
	S.key = "arkher.anim.cliploop.playback_pipeline"
	S.name = "Clip Looping Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Looping"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.cliploop.event_ledger" }
	S.tags = { "i", "cliploop", "pipeline", "anim" }
	S.description = "Clip Looping Playback Pipeline: ordered sample, blend, ik and output stages for the Clip Looping subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.cliploop.playback_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
