-- ARKHER SYSTEM Z.1006 :: Capability Discovery Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.1006"
	S.key = "arkher.origin.capabilitydiscovery.emergence_detection"
	S.name = "Capability Discovery Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.world_memory" }
	S.tags = { "z", "capabilitydiscovery", "emergence", "origin" }
	S.description = "Capability Discovery Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.capabilitydiscovery.emergence_detection", windowSize = 4, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
