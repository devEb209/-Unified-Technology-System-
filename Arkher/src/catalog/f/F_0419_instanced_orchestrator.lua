-- ARKHER SYSTEM F.0419 :: Instanced Draw Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0419"
	S.key = "arkher.render.instanced.orchestration"
	S.name = "Instanced Draw Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.instanced.frame_analysis" }
	S.tags = { "f", "instanced", "orchestrator", "render" }
	S.description = "Instanced Draw Orchestration: frame lifecycle orchestration for the Instanced Draw subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.instanced.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
