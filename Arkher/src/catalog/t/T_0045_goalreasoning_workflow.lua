-- ARKHER SYSTEM T.0045 :: Goal Reasoning Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0045"
	S.key = "arkher.ai.goalreasoning.plan_workflow"
	S.name = "Goal Reasoning Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.goalreasoning.semantic_knowledge" }
	S.tags = { "t", "goalreasoning", "workflow", "ai" }
	S.description = "Goal Reasoning Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Goal Reasoning subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.goalreasoning.plan_workflow", maxRetries = 1, budget = 70 })
		inst.system = S
		inst.ctx = ctx
