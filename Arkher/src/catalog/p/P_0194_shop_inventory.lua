-- ARKHER SYSTEM P.0194 :: Shop Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0194"
	S.key = "arkher.play.shop.inventory"
	S.name = "Shop Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Shop"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.shop.attributes" }
	S.tags = { "p", "shop", "inventory", "play" }
	S.description = "Shop Inventory: slots, stacking, weight, equipment and crafting for the Shop subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.shop.inventory", slots = 20, maxWeight = 60 })
		inst.system = S
		inst.ctx = ctx
