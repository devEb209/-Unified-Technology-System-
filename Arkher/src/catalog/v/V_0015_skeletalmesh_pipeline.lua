-- ARKHER SYSTEM V.0015 :: Skeletal Mesh Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0015"
	S.key = "arkher.asset.skeletalmesh.cook_pipeline"
	S.name = "Skeletal Mesh Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.skeletalmesh.bundling" }
	S.tags = { "v", "skeletalmesh", "pipeline", "asset" }
	S.description = "Skeletal Mesh Cook Pipeline: staged cooking with isolation and retries for the Skeletal Mesh subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.skeletalmesh.cook_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
