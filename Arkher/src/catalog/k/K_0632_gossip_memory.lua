-- ARKHER SYSTEM K.0632 :: Gossip Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0632"
	S.key = "arkher.npc.gossip.memory"
	S.name = "Gossip Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.gossip.mind_network" }
	S.tags = { "k", "gossip", "memory", "npc" }
	S.description = "Gossip Memory: episodic memory with decay, recall and consolidation for the Gossip subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.gossip.memory", capacity = 32, decayRate = 0.030, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
