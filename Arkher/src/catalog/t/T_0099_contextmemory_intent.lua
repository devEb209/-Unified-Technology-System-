-- ARKHER SYSTEM T.0099 :: Context Memory Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0099"
	S.key = "arkher.ai.contextmemory.intent_understanding"
	S.name = "Context Memory Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "contextmemory", "intent", "ai" }
	S.description = "Context Memory Intent Understanding: natural language turned into an actionable, scored intent for the Context Memory subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.contextmemory.intent_understanding", minConfidence = 0.41 })
		inst.system = S
		inst.ctx = ctx
