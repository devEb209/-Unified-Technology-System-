-- ARKHER SYSTEM Z.0146 :: Autonomous Development Pipeline Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0146"
	S.key = "arkher.origin.autodevpipeline.emergence_detection"
	S.name = "Autonomous Development Pipeline Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodevpipeline.world_memory" }
	S.tags = { "z", "autodevpipeline", "emergence", "origin" }
	S.description = "Autonomous Development Pipeline Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Autonomous Development Pipeline subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.autodevpipeline.emergence_detection", windowSize = 7, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
