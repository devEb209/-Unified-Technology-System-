-- ARKHER SYSTEM VB.0540 :: Pipeline Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0540"
	S.key = "arkher.conttime.pipelinecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.pipelinecont.reality_continuum" }
	S.tags = { "vb", "pipelinecont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.pipelinecont.emergence_continuum", windowSize = 4, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
