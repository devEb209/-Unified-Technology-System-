-- ARKHER SYSTEM T.0393 :: Performance Reasoning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0393"
	S.key = "arkher.ai.performancereasoning.intent_understanding"
	S.name = "Performance Reasoning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "performancereasoning", "intent", "ai" }
	S.description = "Performance Reasoning Intent Understanding: natural language turned into an actionable, scored intent for the Performance Reasoning subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.performancereasoning.intent_understanding", minConfidence = 0.44 })
		inst.system = S
		inst.ctx = ctx
