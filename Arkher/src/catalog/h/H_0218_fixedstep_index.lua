-- ARKHER SYSTEM H.0218 :: Fixed Timestep Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0218"
	S.key = "arkher.physics.fixedstep.broadphase_index"
	S.name = "Fixed Timestep Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.fixedstep.vehicle" }
	S.tags = { "h", "fixedstep", "index", "physics" }
	S.description = "Fixed Timestep Broadphase Index: spatial acceleration of candidate pair finding for the Fixed Timestep subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.fixedstep.broadphase_index", mode = "hash", cellSize = 48 })
		inst.system = S
		inst.ctx = ctx
