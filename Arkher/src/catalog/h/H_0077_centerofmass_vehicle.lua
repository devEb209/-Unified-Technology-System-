-- ARKHER SYSTEM H.0077 :: Center Of Mass Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0077"
	S.key = "arkher.physics.centerofmass.vehicle"
	S.name = "Center Of Mass Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.centerofmass.character_motion" }
	S.tags = { "h", "centerofmass", "vehicle", "physics" }
	S.description = "Center Of Mass Vehicle: suspension, drivetrain, steering and tire friction for the Center Of Mass subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.centerofmass.vehicle", mass = 2100, wheelbase = 3.00, track = 1.80, maxRpm = 6400 })
		inst.system = S
		inst.ctx = ctx
