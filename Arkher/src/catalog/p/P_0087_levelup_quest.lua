-- ARKHER SYSTEM P.0087 :: Level Up Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0087"
	S.key = "arkher.play.levelup.objectives"
	S.name = "Level Up Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Level Up"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.levelup.inventory" }
	S.tags = { "p", "levelup", "quest", "play" }
	S.description = "Level Up Objectives: objectives, prerequisites, progress and rewards for the Level Up subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.levelup.objectives" })
		inst.system = S
		inst.ctx = ctx
