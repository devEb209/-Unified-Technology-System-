-- ARKHER SYSTEM N.0096 :: Muzzle Flash Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0096"
	S.key = "arkher.vfx.muzzleflash.curve_authoring"
	S.name = "Muzzle Flash Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Muzzle Flash"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.muzzleflash.ribbon_and_trail" }
	S.tags = { "n", "muzzleflash", "spline", "vfx" }
	S.description = "Muzzle Flash Curve Authoring: authored curves driving the effect over its life for the Muzzle Flash subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.muzzleflash.curve_authoring", tension = 0.46, closed = false })
		inst.system = S
		inst.ctx = ctx
