-- ARKHER SYSTEM E.0391 :: Texture Atlas Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0391"
	S.key = "arkher.material.atlas.definition"
	S.name = "Texture Atlas Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "atlas", "material", "material" }
	S.description = "Texture Atlas Definition: layered PBR definition resolved into parameters for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.atlas.definition", texelBudget = 1835008 })
		inst.system = S
		inst.ctx = ctx
