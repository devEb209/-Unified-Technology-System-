-- ARKHER SYSTEM E.0453 :: Procedural Texture Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0453"
	S.key = "arkher.material.proctex.shading_graph"
	S.name = "Procedural Texture Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.proctex.layer_composition" }
	S.tags = { "e", "proctex", "shadegraph", "material" }
	S.description = "Procedural Texture Shading Graph: node graph evaluated and compiled to Luau for the Procedural Texture subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.proctex.shading_graph" })
		inst.system = S
		inst.ctx = ctx
