-- ARKHER SYSTEM R.0110 :: Remote Function Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0110"
	S.key = "arkher.net.remotefunction.time_sync"
	S.name = "Remote Function Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remotefunction.replication" }
	S.tags = { "r", "remotefunction", "netclock", "net" }
	S.description = "Remote Function Time Sync: offset estimation, outlier rejection and jitter buffering for the Remote Function subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.remotefunction.time_sync", tickRate = 30, bufferDelay = 0.110, maxSamples = 13 })
		inst.system = S
		inst.ctx = ctx
