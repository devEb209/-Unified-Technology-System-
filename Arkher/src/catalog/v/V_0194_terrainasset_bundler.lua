-- ARKHER SYSTEM V.0194 :: Terrain Asset Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0194"
	S.key = "arkher.asset.terrainasset.bundling"
	S.name = "Terrain Asset Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.terrainasset.import" }
	S.tags = { "v", "terrainasset", "bundler", "asset" }
	S.description = "Terrain Asset Bundling: size-bounded packing, manifests and delta patches for the Terrain Asset subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.terrainasset.bundling", maxBundleBytes = 1179648 })
		inst.system = S
		inst.ctx = ctx
