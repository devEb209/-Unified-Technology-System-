-- ARKHER SYSTEM H.0344 :: Compound Collider Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0344"
	S.key = "arkher.physics.compoundcollider.broadphase_index"
	S.name = "Compound Collider Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.compoundcollider.vehicle" }
	S.tags = { "h", "compoundcollider", "index", "physics" }
	S.description = "Compound Collider Broadphase Index: spatial acceleration of candidate pair finding for the Compound Collider subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.compoundcollider.broadphase_index", mode = "hash", cellSize = 64 })
		inst.system = S
		inst.ctx = ctx
