-- ARKHER SYSTEM E.0292 :: Wear And Tear Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0292"
	S.key = "arkher.material.wear.parameter_budget"
	S.name = "Wear And Tear Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.wear.variant_registry" }
	S.tags = { "e", "wear", "budgeter", "material" }
	S.description = "Wear And Tear Parameter Budget: texel and layer budget allocation for the Wear And Tear subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.wear.parameter_budget", total = 232, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
