-- ARKHER SYSTEM E.0406 :: Mip Policy Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0406"
	S.key = "arkher.material.mippolicy.definition"
	S.name = "Mip Policy Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Mip Policy"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "mippolicy", "material", "material" }
	S.description = "Mip Policy Definition: layered PBR definition resolved into parameters for the Mip Policy subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.mippolicy.definition", texelBudget = 1835008 })
		inst.system = S
		inst.ctx = ctx
