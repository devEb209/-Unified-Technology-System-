-- ARKHER SYSTEM VB.0357 :: Narrative Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0357"
	S.key = "arkher.conttime.narrativecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.narrativecont.world_memory_stream" }
	S.tags = { "vb", "narrativecont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.narrativecont.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
