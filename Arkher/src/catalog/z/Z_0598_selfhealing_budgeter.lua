-- ARKHER SYSTEM Z.0598 :: Self Healing Systems Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0598"
	S.key = "arkher.origin.selfhealing.budget_governor"
	S.name = "Self Healing Systems Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfhealing.behaviour_analysis" }
	S.tags = { "z", "selfhealing", "budgeter", "origin" }
	S.description = "Self Healing Systems Budget Governor: allocation of a scarce resource across the technology's consumers for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.selfhealing.budget_governor", total = 360, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
