-- ARKHER SYSTEM VD.0246 :: Vegetation Field Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0246"
	S.key = "arkher.contsim.vegfield.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vegfield.persistent_state" }
	S.tags = { "vd", "vegfield", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.vegfield.coherence_guard", window = 82, threshold = 0.10 })
		inst.system = S
		inst.ctx = ctx
