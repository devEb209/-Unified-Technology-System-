-- ARKHER SYSTEM VD.0218 :: Terrain Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0218"
	S.key = "arkher.contsim.terraincont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.terraincont.infinite_grid" }
	S.tags = { "vd", "terraincont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.terraincont.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
