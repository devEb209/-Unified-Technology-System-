-- ARKHER SYSTEM VC.0449 :: Animation Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0449"
	S.key = "arkher.contneural.animcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.animcont.multi-scale_fidelity" }
	S.tags = { "vc", "animcont", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.animcont.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
