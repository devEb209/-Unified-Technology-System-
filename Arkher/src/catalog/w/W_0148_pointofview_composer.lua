-- ARKHER SYSTEM W.0148 :: Point Of View Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0148"
	S.key = "arkher.cine.pointofview.shot_composition"
	S.name = "Point Of View Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.pointofview.colour_grade" }
	S.tags = { "w", "pointofview", "composer", "cine" }
	S.description = "Point Of View Shot Composition: blending of the signals that make up the final shot for the Point Of View subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.pointofview.shot_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
