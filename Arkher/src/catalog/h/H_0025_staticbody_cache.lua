-- ARKHER SYSTEM H.0025 :: Static Body Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0025"
	S.key = "arkher.physics.staticbody.result_cache"
	S.name = "Static Body Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Static Body"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.staticbody.simulation_policy" }
	S.tags = { "h", "staticbody", "cache", "physics" }
	S.description = "Static Body Result Cache: reuse of expensive simulation and query results for the Static Body subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.staticbody.result_cache", policy = "lru", capacity = 96, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
