-- ARKHER SYSTEM H.0656 :: Wheel Suspension Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0656"
	S.key = "arkher.physics.suspension.analysis"
	S.name = "Wheel Suspension Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.suspension.result_cache" }
	S.tags = { "h", "suspension", "analyzer", "physics" }
	S.description = "Wheel Suspension Analysis: energy, jitter and cost analysis of the simulation for the Wheel Suspension subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.suspension.analysis", window = 208, buckets = 12, threshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
