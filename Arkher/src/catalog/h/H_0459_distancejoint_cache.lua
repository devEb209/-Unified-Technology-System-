-- ARKHER SYSTEM H.0459 :: Distance Joint Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0459"
	S.key = "arkher.physics.distancejoint.result_cache"
	S.name = "Distance Joint Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.distancejoint.simulation_policy" }
	S.tags = { "h", "distancejoint", "cache", "physics" }
	S.description = "Distance Joint Result Cache: reuse of expensive simulation and query results for the Distance Joint subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.distancejoint.result_cache", policy = "lru", capacity = 123, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
