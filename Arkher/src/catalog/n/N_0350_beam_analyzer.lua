-- ARKHER SYSTEM N.0350 :: Beam Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0350"
	S.key = "arkher.vfx.beam.analysis"
	S.name = "Beam Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Beam"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.beam.spatial_index" }
	S.tags = { "n", "beam", "analyzer", "vfx" }
	S.description = "Beam Analysis: cost, overdraw and stability analysis of the effect for the Beam subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.beam.analysis", window = 89, buckets = 9, threshold = 2.10 })
		inst.system = S
		inst.ctx = ctx
