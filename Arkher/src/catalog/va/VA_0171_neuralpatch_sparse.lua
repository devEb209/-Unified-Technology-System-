-- ARKHER SYSTEM VA.0171 :: Neural Patch Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0171"
	S.key = "arkher.contworld.neuralpatch.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.neuralpatch.epoch_clock" }
	S.tags = { "va", "neuralpatch", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.neuralpatch.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
