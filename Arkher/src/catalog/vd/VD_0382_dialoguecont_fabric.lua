-- ARKHER SYSTEM VD.0382 :: Dialogue Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0382"
	S.key = "arkher.contsim.dialoguecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.dialoguecont.complexity_budget" }
	S.tags = { "vd", "dialoguecont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.dialoguecont.simulation_fabric", budgetMs = 3.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
