-- ARKHER SYSTEM VA.0325 :: Economy Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0325"
	S.key = "arkher.contworld.economycont.infinite_grid"
	S.name = "Economy Continuum Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "economycont", "continuum", "contworld" }
	S.description = "Economy Continuum Infinite Grid: seamless paging of the infinite world grid for the Economy Continuum subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.economycont.infinite_grid", cellSize = 192, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
