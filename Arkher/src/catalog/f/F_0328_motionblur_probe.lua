-- ARKHER SYSTEM F.0328 :: Motion Blur Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0328"
	S.key = "arkher.render.motionblur.probe_volume"
	S.name = "Motion Blur Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Motion Blur"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.motionblur.lighting_rig" }
	S.tags = { "f", "motionblur", "probe", "render" }
	S.description = "Motion Blur Probe Volume: irradiance probes encoded in spherical harmonics for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.motionblur.probe_volume", spacing = 8 })
		inst.system = S
		inst.ctx = ctx
