-- ARKHER SYSTEM VA.0297 :: Climate Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0297"
	S.key = "arkher.contworld.climatecont.complexity_budget"
	S.name = "Climate Continuum Complexity Budget"
	S.category = "VA"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.climatecont.world_memory_stream" }
	S.tags = { "va", "climatecont", "complexity", "contworld" }
	S.description = "Climate Continuum Complexity Budget: complexity budgeting for the continuum for the Climate Continuum subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.climatecont.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
