-- ARKHER SYSTEM L.0084 :: Cohort State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0084"
	S.key = "arkher.sim.cohort.state_codec"
	S.name = "Cohort State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.cohort.history_ledger" }
	S.tags = { "l", "cohort", "codec", "sim" }
	S.description = "Cohort State Codec: persistence, diffing and checksum of the world state for the Cohort subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.cohort.state_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
