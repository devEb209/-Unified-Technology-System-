-- ARKHER SYSTEM VC.0590 :: Horizon Span Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0590"
	S.key = "arkher.contneural.horizonspan.epoch_clock"
	S.name = "Horizon Span Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.horizonspan.infinite_grid" }
	S.tags = { "vc", "horizonspan", "epoch", "contneural" }
	S.description = "Horizon Span Epoch Clock: deterministic epoch timeline with catch-up for the Horizon Span subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.horizonspan.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
