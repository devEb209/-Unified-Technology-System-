-- ARKHER SYSTEM G.0268 :: Quality Estimation Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0268"
	S.key = "arkher.neural.qualityestimate.feature_extraction"
	S.name = "Quality Estimation Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.qualityestimate.inference_core" }
	S.tags = { "g", "qualityestimate", "field", "neural" }
	S.description = "Quality Estimation Feature Extraction: signal features feeding the model for the Quality Estimation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.qualityestimate.feature_extraction", seed = 76630, frequency = 0.0115, octaves = 5, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
