-- ARKHER SYSTEM L.0509 :: War Forecast
...
return function(A)
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.war.analysis" }
	S.tags = { "l", "war", "predictor", "sim" }
	S.description = "War Forecast: prediction of the region's next state for the War subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.war.forecast", method = "ema", alpha = 0.11, window = 65 })
		inst.system = S
		inst.ctx = ctx
