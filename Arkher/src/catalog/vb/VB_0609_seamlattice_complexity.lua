-- ARKHER SYSTEM VB.0609 :: Seam Lattice Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0609"
	S.key = "arkher.conttime.seamlattice.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.seamlattice.world_memory_stream" }
	S.tags = { "vb", "seamlattice", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.seamlattice.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
