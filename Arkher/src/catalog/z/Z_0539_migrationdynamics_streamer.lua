-- ARKHER SYSTEM Z.0539 :: Migration Dynamics Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0539"
	S.key = "arkher.origin.migrationdynamics.residency_streaming"
	S.name = "Migration Dynamics Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.migrationdynamics.budget_governor" }
	S.tags = { "z", "migrationdynamics", "streamer", "origin" }
	S.description = "Migration Dynamics Residency Streaming: distance-driven residency of the technology's workload for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.migrationdynamics.residency_streaming", radius = 280, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
