-- ARKHER SYSTEM VB.0530 :: Pipeline Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0530"
	S.key = "arkher.conttime.pipelinecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.pipelinecont.infinite_grid" }
	S.tags = { "vb", "pipelinecont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.pipelinecont.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
