-- ARKHER SYSTEM VB.0049 :: Epoch Frame Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0049"
	S.key = "arkher.conttime.epochframe.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "epochframe", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.epochframe.infinite_grid", cellSize = 128, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
