-- ARKHER SYSTEM Q.0217 :: Inventory Screen Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0217"
	S.key = "arkher.ui.inventoryscreen.responsive_layout"
	S.name = "Inventory Screen Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "inventoryscreen", "flex", "ui" }
	S.description = "Inventory Screen Responsive Layout: flex solving with safe areas, weights and breakpoints for the Inventory Screen subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.inventoryscreen.responsive_layout", width = 570, height = 1084, scale = 1.04 })
		inst.system = S
		inst.ctx = ctx
