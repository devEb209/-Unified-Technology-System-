-- ARKHER SYSTEM F.0366 :: Render Scale View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0366"
	S.key = "arkher.render.renderscale.view_and_culling"
	S.name = "Render Scale View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Render Scale"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.renderscale.frame_graph" }
	S.tags = { "f", "renderscale", "camera", "render" }
	S.description = "Render Scale View And Culling: view state, frustum culling and screen-size LOD for the Render Scale subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.renderscale.view_and_culling", width = 1084, height = 900, fov = 1.2700, far = 1400 })
		inst.system = S
		inst.ctx = ctx
