-- ARKHER SYSTEM Z.0004 :: Adaptive World Intelligence Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0004"
	S.key = "arkher.origin.adaptiveworld.autonomous_pipeline"
	S.name = "Adaptive World Intelligence Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.adaptiveworld.simulation_fabric" }
	S.tags = { "z", "adaptiveworld", "autopipeline", "origin" }
	S.description = "Adaptive World Intelligence Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Adaptive World Intelligence subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.adaptiveworld.autonomous_pipeline", maxIterations = 5 })
		inst.system = S
		inst.ctx = ctx
