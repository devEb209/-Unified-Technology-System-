-- ARKHER SYSTEM V.0375 :: Cook Target Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0375"
	S.key = "arkher.asset.cooktarget.cook_pipeline"
	S.name = "Cook Target Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.cooktarget.bundling" }
	S.tags = { "v", "cooktarget", "pipeline", "asset" }
	S.description = "Cook Target Cook Pipeline: staged cooking with isolation and retries for the Cook Target subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.cooktarget.cook_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
