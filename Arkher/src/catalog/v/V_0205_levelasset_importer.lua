-- ARKHER SYSTEM V.0205 :: Level Asset Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0205"
	S.key = "arkher.asset.levelasset.import"
	S.name = "Level Asset Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "levelasset", "importer", "asset" }
	S.description = "Level Asset Import: validation, normalization, hashing and deduplication of incoming content for the Level Asset subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.levelasset.import", unitScale = 1.50 })
		inst.system = S
		inst.ctx = ctx
