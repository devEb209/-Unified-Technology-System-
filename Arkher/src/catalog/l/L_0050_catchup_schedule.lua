-- ARKHER SYSTEM L.0050 :: Catch Up Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0050"
	S.key = "arkher.sim.catchup.calendar"
	S.name = "Catch Up Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.catchup.society" }
	S.tags = { "l", "catchup", "schedule", "sim" }
	S.description = "Catch Up Calendar: hours, days and seasons driving the region for the Catch Up subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.catchup.calendar", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
