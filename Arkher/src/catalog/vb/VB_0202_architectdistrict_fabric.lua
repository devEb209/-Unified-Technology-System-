-- ARKHER SYSTEM VB.0202 :: Architect District Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0202"
	S.key = "arkher.conttime.architectdistrict.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.architectdistrict.complexity_budget" }
	S.tags = { "vb", "architectdistrict", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.architectdistrict.simulation_fabric", budgetMs = 4.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
