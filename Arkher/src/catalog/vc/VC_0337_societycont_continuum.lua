-- ARKHER SYSTEM VC.0337 :: Society Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0337"
	S.key = "arkher.contneural.societycont.infinite_grid"
	S.name = "Society Continuum Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "societycont", "continuum", "contneural" }
	S.description = "Society Continuum Infinite Grid: seamless paging of the infinite world grid for the Society Continuum subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.societycont.infinite_grid", cellSize = 128, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
