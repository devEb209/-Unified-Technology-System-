-- ARKHER SYSTEM VA.0401 :: Perception Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0401"
	S.key = "arkher.contworld.perceptioncont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.perceptioncont.multi-scale_fidelity" }
	S.tags = { "va", "perceptioncont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.perceptioncont.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
