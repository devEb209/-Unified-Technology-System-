-- ARKHER SYSTEM T.0387 :: Refactoring Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0387"
	S.key = "arkher.ai.refactoring.working_memory"
	S.name = "Refactoring Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.refactoring.outcome_prediction" }
	S.tags = { "t", "refactoring", "memory", "ai" }
	S.description = "Refactoring Working Memory: decaying, consolidating recall of what the agent learned for the Refactoring subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.refactoring.working_memory", capacity = 102, decayRate = 0.020, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
