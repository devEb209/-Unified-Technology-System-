-- ARKHER SYSTEM V.0379 :: Cook Target Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0379"
	S.key = "arkher.asset.cooktarget.streaming_residency"
	S.name = "Cook Target Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.cooktarget.content_cache" }
	S.tags = { "v", "cooktarget", "streamer", "asset" }
	S.description = "Cook Target Streaming Residency: distance-driven load and unload of asset payloads for the Cook Target subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.cooktarget.streaming_residency", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
