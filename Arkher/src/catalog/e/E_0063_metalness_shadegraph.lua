-- ARKHER SYSTEM E.0063 :: Metalness Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0063"
	S.key = "arkher.material.metalness.shading_graph"
	S.name = "Metalness Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Metalness"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.metalness.layer_composition" }
	S.tags = { "e", "metalness", "shadegraph", "material" }
	S.description = "Metalness Shading Graph: node graph evaluated and compiled to Luau for the Metalness subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.metalness.shading_graph" })
		inst.system = S
		inst.ctx = ctx
