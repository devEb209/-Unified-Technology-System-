-- ARKHER SYSTEM O.0065 :: Voice Line Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0065"
	S.key = "arkher.audio.voiceline.voice_budget"
	S.name = "Voice Line Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Voice Line"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.voiceline.music_sequencer" }
	S.tags = { "o", "voiceline", "budgeter", "audio" }
	S.description = "Voice Line Voice Budget: voice slots allocated by priority and audibility for the Voice Line subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.voiceline.voice_budget", total = 93, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
