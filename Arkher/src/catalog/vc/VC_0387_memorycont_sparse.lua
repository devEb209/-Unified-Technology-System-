-- ARKHER SYSTEM VC.0387 :: Memory Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0387"
	S.key = "arkher.contneural.memorycont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memorycont.epoch_clock" }
	S.tags = { "vc", "memorycont", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.memorycont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
