-- ARKHER SYSTEM VD.0264 :: Road Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0264"
	S.key = "arkher.contsim.roadcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.roadcont.reality_continuum" }
	S.tags = { "vd", "roadcont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.roadcont.emergence_continuum", windowSize = 6, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
