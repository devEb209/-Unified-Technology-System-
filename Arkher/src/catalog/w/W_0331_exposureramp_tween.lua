-- ARKHER SYSTEM W.0331 :: Exposure Ramp Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0331"
	S.key = "arkher.cine.exposureramp.motion_tween"
	S.name = "Exposure Ramp Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.exposureramp.playback_orchestrator" }
	S.tags = { "w", "exposureramp", "tween", "cine" }
	S.description = "Exposure Ramp Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Exposure Ramp subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.exposureramp.motion_tween", timeScale = 1.08 })
		inst.system = S
		inst.ctx = ctx
