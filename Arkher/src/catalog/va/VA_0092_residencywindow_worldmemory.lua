-- ARKHER SYSTEM VA.0092 :: Residency Window World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0092"
	S.key = "arkher.contworld.residencywindow.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.residencywindow.neural_field" }
	S.tags = { "va", "residencywindow", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.residencywindow.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
