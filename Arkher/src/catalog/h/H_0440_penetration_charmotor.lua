-- ARKHER SYSTEM H.0440 :: Penetration Recovery Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0440"
	S.key = "arkher.physics.penetration.character_motion"
	S.name = "Penetration Recovery Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.penetration.query" }
	S.tags = { "h", "penetration", "charmotor", "physics" }
	S.description = "Penetration Recovery Character Motion: capsule move-and-slide with slopes, steps and jumps for the Penetration Recovery subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.penetration.character_motion", radius = 0.37, height = 1.62, maxSpeed = 8.20, jumpHeight = 1.80, stepOffset = 0.37 })
		inst.system = S
		inst.ctx = ctx
