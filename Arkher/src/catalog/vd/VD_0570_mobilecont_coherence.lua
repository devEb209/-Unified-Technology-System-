-- ARKHER SYSTEM VD.0570 :: Mobile Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0570"
	S.key = "arkher.contsim.mobilecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.mobilecont.persistent_state" }
	S.tags = { "vd", "mobilecont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.mobilecont.coherence_guard", window = 93, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
