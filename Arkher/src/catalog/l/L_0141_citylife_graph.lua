-- ARKHER SYSTEM L.0141 :: City Life Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0141"
	S.key = "arkher.sim.citylife.region_graph"
	S.name = "City Life Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.citylife.calendar" }
	S.tags = { "l", "citylife", "graph", "sim" }
	S.description = "City Life Region Graph: connectivity, components and shortest path between places for the City Life subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.citylife.region_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
