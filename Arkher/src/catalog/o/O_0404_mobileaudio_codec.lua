-- ARKHER SYSTEM O.0404 :: Mobile Audio Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0404"
	S.key = "arkher.audio.mobileaudio.compression_codec"
	S.name = "Mobile Audio Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mobile Audio"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mobileaudio.asset_registry" }
	S.tags = { "o", "mobileaudio", "codec", "audio" }
	S.description = "Mobile Audio Compression Codec: payload encoding of audio state and events for the Mobile Audio subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.mobileaudio.compression_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
