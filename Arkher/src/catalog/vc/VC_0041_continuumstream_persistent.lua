-- ARKHER SYSTEM VC.0041 :: Continuum Stream Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0041"
	S.key = "arkher.contneural.continuumstream.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.continuumstream.multi-scale_fidelity" }
	S.tags = { "vc", "continuumstream", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.continuumstream.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
