-- ARKHER SYSTEM VB.0060 :: Epoch Frame Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0060"
	S.key = "arkher.conttime.epochframe.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.epochframe.reality_continuum" }
	S.tags = { "vb", "epochframe", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.epochframe.emergence_continuum", windowSize = 4, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
