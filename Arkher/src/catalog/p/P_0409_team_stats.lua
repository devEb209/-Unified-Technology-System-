-- ARKHER SYSTEM P.0409 :: Team Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0409"
	S.key = "arkher.play.team.attributes"
	S.name = "Team Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Team"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "team", "stats", "play" }
	S.description = "Team Attributes: base values, layered modifiers and derived statistics for the Team subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.team.attributes" })
		inst.system = S
		inst.ctx = ctx
