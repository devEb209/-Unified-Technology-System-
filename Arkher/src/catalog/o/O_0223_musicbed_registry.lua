-- ARKHER SYSTEM O.0223 :: Music Bed Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0223"
	S.key = "arkher.audio.musicbed.asset_registry"
	S.name = "Music Bed Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Music Bed"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.musicbed.streaming" }
	S.tags = { "o", "musicbed", "registry", "audio" }
	S.description = "Music Bed Asset Registry: catalogue of sounds, variations and metadata for the Music Bed subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.musicbed.asset_registry" })
		inst.system = S
		inst.ctx = ctx
