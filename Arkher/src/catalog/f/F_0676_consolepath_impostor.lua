-- ARKHER SYSTEM F.0676 :: Console Path Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0676"
	S.key = "arkher.render.consolepath.geometry_virtualization"
	S.name = "Console Path Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Console Path"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.consolepath.visibility_set" }
	S.tags = { "f", "consolepath", "impostor", "render" }
	S.description = "Console Path Geometry Virtualization: impostor and HLOD synthesis under a budget for the Console Path subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.consolepath.geometry_virtualization", atlasSlots = 96, viewCount = 8, errorThreshold = 1.40 })
		inst.system = S
		inst.ctx = ctx
