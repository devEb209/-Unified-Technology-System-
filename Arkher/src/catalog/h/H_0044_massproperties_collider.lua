-- ARKHER SYSTEM H.0044 :: Mass Properties Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0044"
	S.key = "arkher.physics.massproperties.collision_shape"
	S.name = "Mass Properties Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.massproperties.body_dynamics" }
	S.tags = { "h", "massproperties", "collider", "physics" }
	S.description = "Mass Properties Collision Shape: shape bounds, support mapping and closest points for the Mass Properties subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.massproperties.collision_shape", shape = "sphere", radius = 2.20, height = 1.80, layer = "character" })
		inst.system = S
		inst.ctx = ctx
