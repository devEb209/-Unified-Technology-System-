-- ARKHER SYSTEM W.0310 :: Lens Flare Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0310"
	S.key = "arkher.cine.lensflare.frame_budget"
	S.name = "Lens Flare Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Lens Flare"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.lensflare.event_ledger" }
	S.tags = { "w", "lensflare", "budgeter", "cine" }
	S.description = "Lens Flare Frame Budget: per-frame cost budget for the cinematic systems for the Lens Flare subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.lensflare.frame_budget", total = 436, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
