-- ARKHER SYSTEM I.0430 :: Crowd Animation Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0430"
	S.key = "arkher.anim.crowdanim.skeleton"
	S.name = "Crowd Animation Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "crowdanim", "skeleton", "anim" }
	S.description = "Crowd Animation Skeleton: bone hierarchy, bind pose and world resolution for the Crowd Animation subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.crowdanim.skeleton" })
		inst.system = S
		inst.ctx = ctx
