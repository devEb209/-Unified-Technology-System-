-- ARKHER SYSTEM Z.0116 :: Universal Simulation Fabric Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0116"
	S.key = "arkher.origin.simfabric.governance_policy"
	S.name = "Universal Simulation Fabric Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.simfabric.signal_composition" }
	S.tags = { "z", "simfabric", "policy", "origin" }
	S.description = "Universal Simulation Fabric Governance Policy: ordered rules governing when the technology may act for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.simfabric.governance_policy", algorithm = "roundrobin", starvationGuard = 40 })
		inst.system = S
		inst.ctx = ctx
