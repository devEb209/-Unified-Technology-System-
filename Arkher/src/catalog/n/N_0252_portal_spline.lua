-- ARKHER SYSTEM N.0252 :: Portal Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0252"
	S.key = "arkher.vfx.portal.curve_authoring"
	S.name = "Portal Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Portal"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.portal.ribbon_and_trail" }
	S.tags = { "n", "portal", "spline", "vfx" }
	S.description = "Portal Curve Authoring: authored curves driving the effect over its life for the Portal subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.portal.curve_authoring", tension = 0.58, closed = false })
		inst.system = S
		inst.ctx = ctx
