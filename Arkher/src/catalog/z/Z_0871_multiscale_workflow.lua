-- ARKHER SYSTEM Z.0871 :: Multi Scale Simulation Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0871"
	S.key = "arkher.origin.multiscale.adaptive_workflow"
	S.name = "Multi Scale Simulation Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.self_critique" }
	S.tags = { "z", "multiscale", "workflow", "origin" }
	S.description = "Multi Scale Simulation Adaptive Workflow: verified, retryable, reversible execution plans for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.multiscale.adaptive_workflow", maxRetries = 1, budget = 130 })
		inst.system = S
		inst.ctx = ctx
