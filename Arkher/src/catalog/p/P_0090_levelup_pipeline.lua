-- ARKHER SYSTEM P.0090 :: Level Up Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0090"
	S.key = "arkher.play.levelup.rule_pipeline"
	S.name = "Level Up Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Level Up"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.levelup.state_machine" }
	S.tags = { "p", "levelup", "pipeline", "play" }
	S.description = "Level Up Rule Pipeline: ordered rules applied to every gameplay event for the Level Up subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.levelup.rule_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
