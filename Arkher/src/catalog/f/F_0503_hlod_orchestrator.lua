-- ARKHER SYSTEM F.0503 :: HLOD Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0503"
	S.key = "arkher.render.hlod.orchestration"
	S.name = "HLOD Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "HLOD"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.hlod.frame_analysis" }
	S.tags = { "f", "hlod", "orchestrator", "render" }
	S.description = "HLOD Orchestration: frame lifecycle orchestration for the HLOD subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.hlod.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
