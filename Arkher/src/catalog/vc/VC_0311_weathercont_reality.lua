-- ARKHER SYSTEM VC.0311 :: Weather Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0311"
	S.key = "arkher.contneural.weathercont.reality_continuum"
	S.name = "Weather Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.weathercont.simulation_fabric" }
	S.tags = { "vc", "weathercont", "reality", "contneural" }
	S.description = "Weather Continuum Reality Continuum: stacked reality layers of the continuum for the Weather Continuum subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.weathercont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
