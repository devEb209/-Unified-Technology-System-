-- ARKHER SYSTEM P.0274 :: Reputation Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0274"
	S.key = "arkher.play.playerreputation.content_registry"
	S.name = "Reputation Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Reputation"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playerreputation.difficulty_controller" }
	S.tags = { "p", "playerreputation", "registry", "play" }
	S.description = "Reputation Content Registry: catalogue of the definitions this loop instantiates for the Reputation subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.playerreputation.content_registry" })
		inst.system = S
		inst.ctx = ctx
