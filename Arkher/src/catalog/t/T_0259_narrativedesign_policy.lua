-- ARKHER SYSTEM T.0259 :: Narrative Design Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0259"
	S.key = "arkher.ai.narrativedesign.decision_policy"
	S.name = "Narrative Design Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.narrativedesign.reasoning_graph" }
	S.tags = { "t", "narrativedesign", "policy", "ai" }
	S.description = "Narrative Design Decision Policy: ordered rules deciding what the agent does next for the Narrative Design subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.narrativedesign.decision_policy", algorithm = "wfq", starvationGuard = 62 })
		inst.system = S
		inst.ctx = ctx
