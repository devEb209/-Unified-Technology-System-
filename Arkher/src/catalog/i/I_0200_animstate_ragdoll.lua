-- ARKHER SYSTEM I.0200 :: State Machine Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0200"
	S.key = "arkher.anim.animstate.physical_blend"
	S.name = "State Machine Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstate.inverse_kinematics" }
	S.tags = { "i", "animstate", "ragdoll", "anim" }
	S.description = "State Machine Physical Blend: physical bones blended against the animated pose for the State Machine subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.animstate.physical_blend", blendSpeed = 4.30 })
		inst.system = S
		inst.ctx = ctx
