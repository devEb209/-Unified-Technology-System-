-- ARKHER SYSTEM VA.0322 :: Ecology Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0322"
	S.key = "arkher.contworld.ecologycont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.ecologycont.complexity_budget" }
	S.tags = { "va", "ecologycont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.ecologycont.simulation_fabric", budgetMs = 3.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
