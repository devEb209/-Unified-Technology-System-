-- ARKHER SYSTEM E.0066 :: Metalness Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0066"
	S.key = "arkher.material.metalness.variant_registry"
	S.name = "Metalness Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Metalness"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.metalness.procedural_detail" }
	S.tags = { "e", "metalness", "registry", "material" }
	S.description = "Metalness Variant Registry: named variants and their lifecycle for the Metalness subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.metalness.variant_registry" })
		inst.system = S
		inst.ctx = ctx
