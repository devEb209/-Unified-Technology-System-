-- ARKHER SYSTEM VD.0025 :: Zone Chunk Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0025"
	S.key = "arkher.contsim.zonechunk.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "zonechunk", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.zonechunk.infinite_grid", cellSize = 64, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
