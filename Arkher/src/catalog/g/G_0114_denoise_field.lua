-- ARKHER SYSTEM G.0114 :: Denoising Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0114"
	S.key = "arkher.neural.denoise.feature_extraction"
	S.name = "Denoising Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.denoise.inference_core" }
	S.tags = { "g", "denoise", "field", "neural" }
	S.description = "Denoising Feature Extraction: signal features feeding the model for the Denoising subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.denoise.feature_extraction", seed = 43944, frequency = 0.0100, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
