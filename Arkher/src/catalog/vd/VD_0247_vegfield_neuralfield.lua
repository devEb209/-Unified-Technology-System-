-- ARKHER SYSTEM VD.0247 :: Vegetation Field Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0247"
	S.key = "arkher.contsim.vegfield.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vegfield.coherence_guard" }
	S.tags = { "vd", "vegfield", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.vegfield.neural_field", dims = 20, hidden = 16, seed = 98746 })
		inst.system = S
		inst.ctx = ctx
