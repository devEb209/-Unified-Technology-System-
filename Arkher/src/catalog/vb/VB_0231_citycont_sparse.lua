-- ARKHER SYSTEM VB.0231 :: City Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0231"
	S.key = "arkher.conttime.citycont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.citycont.epoch_clock" }
	S.tags = { "vb", "citycont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.citycont.sparse_residency", capacity = 256, pageBytes = 3072 })
		inst.system = S
		inst.ctx = ctx
