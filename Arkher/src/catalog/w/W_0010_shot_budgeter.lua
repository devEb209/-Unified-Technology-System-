-- ARKHER SYSTEM W.0010 :: Shot Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0010"
	S.key = "arkher.cine.shot.frame_budget"
	S.name = "Shot Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Shot"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.shot.event_ledger" }
	S.tags = { "w", "shot", "budgeter", "cine" }
	S.description = "Shot Frame Budget: per-frame cost budget for the cinematic systems for the Shot subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.shot.frame_budget", total = 425, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
