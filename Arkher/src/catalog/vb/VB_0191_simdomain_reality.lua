-- ARKHER SYSTEM VB.0191 :: Simulation Domain Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0191"
	S.key = "arkher.conttime.simdomain.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.simdomain.simulation_fabric" }
	S.tags = { "vb", "simdomain", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.simdomain.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
