-- ARKHER SYSTEM K.0439 :: Local Avoidance Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0439"
	S.key = "arkher.npc.localavoidance.perception"
	S.name = "Local Avoidance Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.localavoidance.emotion" }
	S.tags = { "k", "localavoidance", "perception", "npc" }
	S.description = "Local Avoidance Perception: sight, hearing and bounded attention for the Local Avoidance subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.localavoidance.perception", sightRange = 30, hearingRange = 32, attentionSlots = 4, fov = 1.850 })
		inst.system = S
		inst.ctx = ctx
