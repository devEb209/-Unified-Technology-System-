-- ARKHER SYSTEM VA.0431 :: Navigation Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0431"
	S.key = "arkher.contworld.navcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.navcont.simulation_fabric" }
	S.tags = { "va", "navcont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.navcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
