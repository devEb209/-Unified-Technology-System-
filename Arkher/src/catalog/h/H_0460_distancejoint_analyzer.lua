-- ARKHER SYSTEM H.0460 :: Distance Joint Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0460"
	S.key = "arkher.physics.distancejoint.analysis"
	S.name = "Distance Joint Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.distancejoint.result_cache" }
	S.tags = { "h", "distancejoint", "analyzer", "physics" }
	S.description = "Distance Joint Analysis: energy, jitter and cost analysis of the simulation for the Distance Joint subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.distancejoint.analysis", window = 193, buckets = 13, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
