-- ARKHER SYSTEM L.0127 :: Village Life Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0127"
	S.key = "arkher.sim.villagelife.route_network"
	S.name = "Village Life Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.villagelife.region_graph" }
	S.tags = { "l", "villagelife", "network", "sim" }
	S.description = "Village Life Route Network: roads, rivers and routes between settlements for the Village Life subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.villagelife.route_network" })
		inst.system = S
		inst.ctx = ctx
