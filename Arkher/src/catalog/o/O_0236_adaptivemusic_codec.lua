-- ARKHER SYSTEM O.0236 :: Adaptive Music Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0236"
	S.key = "arkher.audio.adaptivemusic.compression_codec"
	S.name = "Adaptive Music Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.adaptivemusic.asset_registry" }
	S.tags = { "o", "adaptivemusic", "codec", "audio" }
	S.description = "Adaptive Music Compression Codec: payload encoding of audio state and events for the Adaptive Music subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.adaptivemusic.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
