-- ARKHER SYSTEM VD.0095 :: Residency Window Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0095"
	S.key = "arkher.contsim.residencywindow.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.residencywindow.simulation_fabric" }
	S.tags = { "vd", "residencywindow", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.residencywindow.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
