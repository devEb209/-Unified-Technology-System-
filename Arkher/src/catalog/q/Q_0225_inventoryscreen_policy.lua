-- ARKHER SYSTEM Q.0225 :: Inventory Screen Accessibility Policy
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0225"
	S.key = "arkher.ui.inventoryscreen.accessibility_policy"
	S.name = "Inventory Screen Accessibility Policy"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.inventoryscreen.interaction_ledger" }
	S.tags = { "q", "inventoryscreen", "policy", "ui" }
	S.description = "Inventory Screen Accessibility Policy: rules enforcing contrast, target size and motion limits for the Inventory Screen subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ui.inventoryscreen.accessibility_policy", algorithm = "lottery", starvationGuard = 39 })
		inst.system = S
		inst.ctx = ctx
