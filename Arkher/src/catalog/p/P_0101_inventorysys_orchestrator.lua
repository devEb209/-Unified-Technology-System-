-- ARKHER SYSTEM P.0101 :: Inventory State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0101"
	S.key = "arkher.play.inventorysys.state_machine"
	S.name = "Inventory State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Inventory"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.inventorysys.combat_resolution" }
	S.tags = { "p", "inventorysys", "orchestrator", "play" }
	S.description = "Inventory State Machine: the phase machine that drives this gameplay loop for the Inventory subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.inventorysys.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
