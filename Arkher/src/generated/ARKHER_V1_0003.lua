...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Mixamo — ANIMATION Map #0003", size=Vector2.new(600, 480), pos=UDim2.fromOffset(139, 131), parent=parent, icon="⛰"})
