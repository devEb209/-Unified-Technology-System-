-- ARKHER SYSTEM O.0061 :: Voice Line DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0061"
	S.key = "arkher.audio.voiceline.dsp_chain"
	S.name = "Voice Line DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Voice Line"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "voiceline", "dsp", "audio" }
	S.description = "Voice Line DSP Chain: biquad filtering, delay, envelope and soft clipping for the Voice Line subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.voiceline.dsp_chain", sampleRate = 22050, filter = "highpass", cutoff = 1800, q = 0.550 })
		inst.system = S
		inst.ctx = ctx
