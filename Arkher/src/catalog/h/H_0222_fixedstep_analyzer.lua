-- ARKHER SYSTEM H.0222 :: Fixed Timestep Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0222"
	S.key = "arkher.physics.fixedstep.analysis"
	S.name = "Fixed Timestep Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.fixedstep.result_cache" }
	S.tags = { "h", "fixedstep", "analyzer", "physics" }
	S.description = "Fixed Timestep Analysis: energy, jitter and cost analysis of the simulation for the Fixed Timestep subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.fixedstep.analysis", window = 72, buckets = 12, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
