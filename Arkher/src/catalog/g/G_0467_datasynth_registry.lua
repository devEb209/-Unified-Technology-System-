-- ARKHER SYSTEM G.0467 :: Training Data Synthesis Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0467"
	S.key = "arkher.neural.datasynth.model_registry"
	S.name = "Training Data Synthesis Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.datasynth.reconstruction" }
	S.tags = { "g", "datasynth", "registry", "neural" }
	S.description = "Training Data Synthesis Model Registry: named models and their lifecycle for the Training Data Synthesis subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.datasynth.model_registry" })
		inst.system = S
		inst.ctx = ctx
