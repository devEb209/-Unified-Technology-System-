-- ARKHER SYSTEM VA.0288 :: Water Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0288"
	S.key = "arkher.contworld.watercont.emergence_continuum"
	S.name = "Water Continuum Emergence Continuum"
	S.category = "VA"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.watercont.reality_continuum" }
	S.tags = { "va", "watercont", "emergence", "contworld" }
	S.description = "Water Continuum Emergence Continuum: emergence detection over the continuum for the Water Continuum subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.watercont.emergence_continuum", windowSize = 4, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
