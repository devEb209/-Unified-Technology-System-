-- ARKHER SYSTEM W.0143 :: Over The Shoulder Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0143"
	S.key = "arkher.cine.overshoulder.sequence_analysis"
	S.name = "Over The Shoulder Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.overshoulder.frame_budget" }
	S.tags = { "w", "overshoulder", "analyzer", "cine" }
	S.description = "Over The Shoulder Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Over The Shoulder subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.overshoulder.sequence_analysis", window = 234, buckets = 10, threshold = 4.60 })
		inst.system = S
		inst.ctx = ctx
