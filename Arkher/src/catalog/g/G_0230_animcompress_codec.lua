-- ARKHER SYSTEM G.0230 :: Animation Compression Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0230"
	S.key = "arkher.neural.animcompress.weight_codec"
	S.name = "Animation Compression Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.animcompress.model_registry" }
	S.tags = { "g", "animcompress", "codec", "neural" }
	S.description = "Animation Compression Weight Codec: weight serialization and quantized transport for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.animcompress.weight_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
