-- ARKHER SYSTEM VA.0009 :: World Grid Cell Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0009"
	S.key = "arkher.contworld.worldcell.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldcell.world_memory_stream" }
	S.tags = { "va", "worldcell", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.worldcell.complexity_budget", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
