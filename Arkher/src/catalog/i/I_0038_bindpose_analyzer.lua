-- ARKHER SYSTEM I.0038 :: Bind Pose Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0038"
	S.key = "arkher.anim.bindpose.analysis"
	S.name = "Bind Pose Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bind Pose"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bindpose.quality_policy" }
	S.tags = { "i", "bindpose", "analyzer", "anim" }
	S.description = "Bind Pose Analysis: pop, drift and cost analysis of playback for the Bind Pose subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.bindpose.analysis", window = 100, buckets = 8, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
