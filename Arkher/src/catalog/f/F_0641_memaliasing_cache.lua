-- ARKHER SYSTEM F.0641 :: Memory Aliasing Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0641"
	S.key = "arkher.render.memaliasing.pass_cache"
	S.name = "Memory Aliasing Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.memaliasing.render_policy" }
	S.tags = { "f", "memaliasing", "cache", "render" }
	S.description = "Memory Aliasing Pass Cache: reuse of pass results across frames for the Memory Aliasing subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.memaliasing.pass_cache", policy = "lfu", capacity = 169, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
