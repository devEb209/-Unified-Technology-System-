-- ARKHER SYSTEM Q.0143 :: Menu Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0143"
	S.key = "arkher.ui.menu.usability_analysis"
	S.name = "Menu Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Menu"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.menu.frame_budget" }
	S.tags = { "q", "menu", "analyzer", "ui" }
	S.description = "Menu Usability Analysis: reachability, latency and abandonment analysis for the Menu subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.menu.usability_analysis", window = 237, buckets = 13, threshold = 4.90 })
		inst.system = S
		inst.ctx = ctx
