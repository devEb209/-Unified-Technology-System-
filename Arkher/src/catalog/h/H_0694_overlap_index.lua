-- ARKHER SYSTEM H.0694 :: Overlap Query Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0694"
	S.key = "arkher.physics.overlap.broadphase_index"
	S.name = "Overlap Query Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.overlap.vehicle" }
	S.tags = { "h", "overlap", "index", "physics" }
	S.description = "Overlap Query Broadphase Index: spatial acceleration of candidate pair finding for the Overlap Query subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.overlap.broadphase_index", mode = "hash", cellSize = 96 })
		inst.system = S
		inst.ctx = ctx
