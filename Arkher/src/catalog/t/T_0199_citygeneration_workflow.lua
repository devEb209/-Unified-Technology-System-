-- ARKHER SYSTEM T.0199 :: City Generation Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0199"
	S.key = "arkher.ai.citygeneration.plan_workflow"
	S.name = "City Generation Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.citygeneration.semantic_knowledge" }
	S.tags = { "t", "citygeneration", "workflow", "ai" }
	S.description = "City Generation Plan Workflow: dependency-ordered plans that verify, retry and roll back for the City Generation subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.citygeneration.plan_workflow", maxRetries = 2, budget = 140 })
		inst.system = S
		inst.ctx = ctx
