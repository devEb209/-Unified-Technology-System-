-- ARKHER SYSTEM E.0260 :: UV Mapping Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0260"
	S.key = "arkher.material.uvmap.procedural_detail"
	S.name = "UV Mapping Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "UV Mapping"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.uvmap.texture_sampling" }
	S.tags = { "e", "uvmap", "field", "material" }
	S.description = "UV Mapping Procedural Detail: coherent noise detail driving the surface for the UV Mapping subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.uvmap.procedural_detail", seed = 71383, frequency = 0.0097, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
		...
		function inst.integrate(engine)
			...
			inst.engine = engine
			if engine.bus then
				engine.bus:subscribe("arkher.material.uvmap.*", function(payload) inst.lastSignal = payload end)
			end
