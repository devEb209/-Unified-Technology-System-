-- ARKHER SYSTEM O.0212 :: Occlusion Zone Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0212"
	S.key = "arkher.audio.occlusionzone.compression_codec"
	S.name = "Occlusion Zone Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.occlusionzone.asset_registry" }
	S.tags = { "o", "occlusionzone", "codec", "audio" }
	S.description = "Occlusion Zone Compression Codec: payload encoding of audio state and events for the Occlusion Zone subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.occlusionzone.compression_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
