-- ARKHER SYSTEM VC.0025 :: Zone Chunk Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0025"
	S.key = "arkher.contneural.zonechunk.infinite_grid"
	S.name = "Zone Chunk Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "zonechunk", "continuum", "contneural" }
	S.description = "Zone Chunk Infinite Grid: seamless paging of the infinite world grid for the Zone Chunk subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.zonechunk.infinite_grid", cellSize = 192, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
