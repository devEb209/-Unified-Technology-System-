-- ARKHER SYSTEM F.0692 :: Frame Pacing Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0692"
	S.key = "arkher.render.framepacing.probe_volume"
	S.name = "Frame Pacing Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Frame Pacing"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepacing.lighting_rig" }
	S.tags = { "f", "framepacing", "probe", "render" }
	S.description = "Frame Pacing Probe Volume: irradiance probes encoded in spherical harmonics for the Frame Pacing subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.framepacing.probe_volume", spacing = 24 })
		inst.system = S
		inst.ctx = ctx
