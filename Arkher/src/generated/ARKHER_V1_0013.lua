--!strict
-- Continuum World — ANIMATION Map #0013
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Continuum World — ANIMATION Map #0013", size=Vector2.new(640, 480), pos=UDim2.fromOffset(269, 301), parent=parent, icon="⚙"})
...
Components.Slider(props, "Value", -5,5,0, function(v) local s=game:GetService("Selection"):Get()[1]; if s and s:IsA("BasePart") then s:SetAttribute("ARKHER_T"..13, v) end end)
