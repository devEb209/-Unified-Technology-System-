-- ARKHER SYSTEM Z.0670 :: Auto Documentation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0670"
	S.key = "arkher.origin.autodocumentation.self_critique"
	S.name = "Auto Documentation Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.intent_bridge" }
	S.tags = { "z", "autodocumentation", "critic", "origin" }
	S.description = "Auto Documentation Self Critique: weighted judgement of the technology's own output for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.autodocumentation.self_critique", passMark = 0.72, reviseMark = 0.42, seed = 91322 })
		inst.system = S
		inst.ctx = ctx
