-- ARKHER SYSTEM F.0421 :: Occlusion Culling Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0421"
	S.key = "arkher.render.occlusion.frame_graph"
	S.name = "Occlusion Culling Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "occlusion", "framegraph", "render" }
	S.description = "Occlusion Culling Frame Graph: declared passes, culling, ordering and aliasing for the Occlusion Culling subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.occlusion.frame_graph", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
