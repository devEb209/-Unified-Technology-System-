-- ARKHER SYSTEM T.0548 :: Scene Reasoning Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0548"
	S.key = "arkher.ai.scenereasoning.semantic_knowledge"
	S.name = "Scene Reasoning Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.scenereasoning.intent_understanding" }
	S.tags = { "t", "scenereasoning", "knowledge", "ai" }
	S.description = "Scene Reasoning Semantic Knowledge: typed entities, weighted relations and inferred closure for the Scene Reasoning subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.scenereasoning.semantic_knowledge", dims = 16 })
		inst.system = S
		inst.ctx = ctx
