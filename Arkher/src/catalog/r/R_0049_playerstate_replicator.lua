-- ARKHER SYSTEM R.0049 :: Player State Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0049"
	S.key = "arkher.net.playerstate.replication"
	S.name = "Player State Replication"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Player State"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "playerstate", "replicator", "net" }
	S.description = "Player State Replication: authoritative entity state, interest and delta snapshots for the Player State subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.playerstate.replication", mtu = 1200, interestRadius = 440, fullEvery = 90 })
		inst.system = S
		inst.ctx = ctx
