-- ARKHER SYSTEM VD.0082 :: LOD Cascade Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0082"
	S.key = "arkher.contsim.lodcascade.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lodcascade.complexity_budget" }
	S.tags = { "vd", "lodcascade", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.lodcascade.simulation_fabric", budgetMs = 1.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
