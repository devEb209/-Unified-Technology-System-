-- ARKHER SYSTEM VD.0555 :: Device Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0555"
	S.key = "arkher.contsim.devicecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.devicecont.epoch_clock" }
	S.tags = { "vd", "devicecont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.devicecont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
