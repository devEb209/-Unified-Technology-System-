-- ARKHER SYSTEM VC.0582 :: Thermal Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0582"
	S.key = "arkher.contneural.thermalcont.coherence_guard"
	S.name = "Thermal Continuum Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.thermalcont.persistent_state" }
	S.tags = { "vc", "thermalcont", "coherence", "contneural" }
	S.description = "Thermal Continuum Coherence Guard: seam coherence and drift supervision for the Thermal Continuum subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.thermalcont.coherence_guard", window = 69, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
