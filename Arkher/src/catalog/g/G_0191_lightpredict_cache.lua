-- ARKHER SYSTEM G.0191 :: Light Transport Prediction Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0191"
	S.key = "arkher.neural.lightpredict.result_cache"
	S.name = "Light Transport Prediction Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.lightpredict.compute_budget" }
	S.tags = { "g", "lightpredict", "cache", "neural" }
	S.description = "Light Transport Prediction Result Cache: cached inference results keyed by input for the Light Transport Prediction subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.lightpredict.result_cache", policy = "ttl", capacity = 372, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
