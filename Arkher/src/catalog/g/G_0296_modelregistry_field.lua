-- ARKHER SYSTEM G.0296 :: Model Registry Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0296"
	S.key = "arkher.neural.modelregistry.feature_extraction"
	S.name = "Model Registry Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelregistry.inference_core" }
	S.tags = { "g", "modelregistry", "field", "neural" }
	S.description = "Model Registry Feature Extraction: signal features feeding the model for the Model Registry subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.modelregistry.feature_extraction", seed = 45744, frequency = 0.0100, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
