-- ARKHER SYSTEM E.0333 :: Rust Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0333"
	S.key = "arkher.material.rust.shading_graph"
	S.name = "Rust Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Rust"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.rust.layer_composition" }
	S.tags = { "e", "rust", "shadegraph", "material" }
	S.description = "Rust Shading Graph: node graph evaluated and compiled to Luau for the Rust subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.rust.shading_graph" })
		inst.system = S
		inst.ctx = ctx
