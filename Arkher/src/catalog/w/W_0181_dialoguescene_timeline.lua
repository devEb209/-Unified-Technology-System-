-- ARKHER SYSTEM W.0181 :: Dialogue Scene Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0181"
	S.key = "arkher.cine.dialoguescene.sequence_timeline"
	S.name = "Dialogue Scene Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "dialoguescene", "timeline", "cine" }
	S.description = "Dialogue Scene Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Dialogue Scene subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.dialoguescene.sequence_timeline", duration = 10.0, rate = 1.02 })
		inst.system = S
		inst.ctx = ctx
