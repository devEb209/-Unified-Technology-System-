-- ARKHER SYSTEM Z.0517 :: Economic Emergence Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0517"
	S.key = "arkher.origin.economicemergence.behaviour_analysis"
	S.name = "Economic Emergence Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.economicemergence.governance_policy" }
	S.tags = { "z", "economicemergence", "analyzer", "origin" }
	S.description = "Economic Emergence Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.economicemergence.behaviour_analysis", window = 114, buckets = 10, threshold = 4.60 })
		inst.system = S
		inst.ctx = ctx
