-- ARKHER SYSTEM L.0202 :: Predation Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0202"
	S.key = "arkher.sim.predation.route_network"
	S.name = "Predation Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.predation.region_graph" }
	S.tags = { "l", "predation", "network", "sim" }
	S.description = "Predation Route Network: roads, rivers and routes between settlements for the Predation subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.predation.route_network" })
		inst.system = S
		inst.ctx = ctx
