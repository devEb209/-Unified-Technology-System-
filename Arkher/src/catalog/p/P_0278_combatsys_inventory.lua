-- ARKHER SYSTEM P.0278 :: Combat Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0278"
	S.key = "arkher.play.combatsys.inventory"
	S.name = "Combat Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Combat"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.combatsys.attributes" }
	S.tags = { "p", "combatsys", "inventory", "play" }
	S.description = "Combat Inventory: slots, stacking, weight, equipment and crafting for the Combat subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.combatsys.inventory", slots = 40, maxWeight = 70 })
		inst.system = S
		inst.ctx = ctx
