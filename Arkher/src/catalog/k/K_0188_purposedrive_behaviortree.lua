-- ARKHER SYSTEM K.0188 :: Purpose Drive Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0188"
	S.key = "arkher.npc.purposedrive.reactive_behaviour"
	S.name = "Purpose Drive Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.purposedrive.perception" }
	S.tags = { "k", "purposedrive", "behaviortree", "npc" }
	S.description = "Purpose Drive Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Purpose Drive subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.purposedrive.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
