-- ARKHER SYSTEM H.0192 :: Island Solver Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0192"
	S.key = "arkher.physics.island.simulation_policy"
	S.name = "Island Solver Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.island.budget_governor" }
	S.tags = { "h", "island", "policy", "physics" }
	S.description = "Island Solver Simulation Policy: device tier rules for substeps, iterations and sleep for the Island Solver subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.island.simulation_policy", algorithm = "wfq", starvationGuard = 26 })
		inst.system = S
		inst.ctx = ctx
