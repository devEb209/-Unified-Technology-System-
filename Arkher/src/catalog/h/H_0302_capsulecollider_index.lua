-- ARKHER SYSTEM H.0302 :: Capsule Collider Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0302"
	S.key = "arkher.physics.capsulecollider.broadphase_index"
	S.name = "Capsule Collider Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.capsulecollider.vehicle" }
	S.tags = { "h", "capsulecollider", "index", "physics" }
	S.description = "Capsule Collider Broadphase Index: spatial acceleration of candidate pair finding for the Capsule Collider subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.capsulecollider.broadphase_index", mode = "hash", cellSize = 88 })
		inst.system = S
		inst.ctx = ctx
