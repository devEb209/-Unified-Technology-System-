-- ARKHER SYSTEM N.0349 :: Beam Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0349"
	S.key = "arkher.vfx.beam.spatial_index"
	S.name = "Beam Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Beam"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.beam.quality_policy" }
	S.tags = { "n", "beam", "index", "vfx" }
	S.description = "Beam Spatial Index: spatial acceleration of effect queries and culling for the Beam subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.beam.spatial_index", mode = "hash", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
