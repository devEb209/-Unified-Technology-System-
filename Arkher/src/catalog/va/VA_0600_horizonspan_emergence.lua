-- ARKHER SYSTEM VA.0600 :: Horizon Span Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0600"
	S.key = "arkher.contworld.horizonspan.emergence_continuum"
	S.name = "Horizon Span Emergence Continuum"
	S.category = "VA"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.horizonspan.reality_continuum" }
	S.tags = { "va", "horizonspan", "emergence", "contworld" }
	S.description = "Horizon Span Emergence Continuum: emergence detection over the continuum for the Horizon Span subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.horizonspan.emergence_continuum", windowSize = 4, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
