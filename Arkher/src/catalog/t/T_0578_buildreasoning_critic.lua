-- ARKHER SYSTEM T.0578 :: Build Reasoning Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0578"
	S.key = "arkher.ai.buildreasoning.self_critique"
	S.name = "Build Reasoning Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.buildreasoning.plan_workflow" }
	S.tags = { "t", "buildreasoning", "critic", "ai" }
	S.description = "Build Reasoning Self Critique: weighted evaluation of the result against declared criteria for the Build Reasoning subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.buildreasoning.self_critique", passMark = 0.72, reviseMark = 0.42, seed = 33662 })
		inst.system = S
		inst.ctx = ctx
