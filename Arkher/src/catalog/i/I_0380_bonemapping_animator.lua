-- ARKHER SYSTEM I.0380 :: Bone Mapping Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0380"
	S.key = "arkher.anim.bonemapping.layered_blending"
	S.name = "Bone Mapping Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bone Mapping"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonemapping.clip_sampling" }
	S.tags = { "i", "bonemapping", "animator", "anim" }
	S.description = "Bone Mapping Layered Blending: layers, crossfades, masks and blend trees for the Bone Mapping subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.bonemapping.layered_blending", budget = 14 })
		inst.system = S
		inst.ctx = ctx
