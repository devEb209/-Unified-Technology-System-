-- ARKHER SYSTEM H.0211 :: Fixed Timestep Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0211"
	S.key = "arkher.physics.fixedstep.body_dynamics"
	S.name = "Fixed Timestep Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "fixedstep", "rigidbody", "physics" }
	S.description = "Fixed Timestep Body Dynamics: integration, impulses, damping and sleeping of a body for the Fixed Timestep subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.fixedstep.body_dynamics", mass = 29.00, radius = 0.70, restitution = 0.08, friction = 0.48, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
