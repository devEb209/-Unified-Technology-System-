-- ARKHER SYSTEM Z.0917 :: Deterministic Replay Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0917"
	S.key = "arkher.origin.deterministicreplay.behaviour_analysis"
	S.name = "Deterministic Replay Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deterministicreplay.governance_policy" }
	S.tags = { "z", "deterministicreplay", "analyzer", "origin" }
	S.description = "Deterministic Replay Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Deterministic Replay subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.deterministicreplay.behaviour_analysis", window = 240, buckets = 8, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
