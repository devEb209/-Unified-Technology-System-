-- ARKHER SYSTEM N.0120 :: Water Splash Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0120"
	S.key = "arkher.vfx.splash.force_field"
	S.name = "Water Splash Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Water Splash"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.splash.particle_simulation" }
	S.tags = { "n", "splash", "forcefield", "vfx" }
	S.description = "Water Splash Force Field: wind, attraction, vortex, drag and curl turbulence for the Water Splash subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.splash.force_field", seed = 59488 })
		inst.system = S
		inst.ctx = ctx
