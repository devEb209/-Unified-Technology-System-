-- ARKHER SYSTEM K.0141 :: Rest Drive Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0141"
	S.key = "arkher.npc.restdrive.mind_network"
	S.name = "Rest Drive Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "restdrive", "mindnet", "npc" }
	S.description = "Rest Drive Mind Network: the learned policy that turns perception into a decision for the Rest Drive subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.restdrive.mind_network", inputs = 8, hidden = 5, seed = 4066, learningRate = 0.080, exploration = 0.030 })
		inst.system = S
		inst.ctx = ctx
