-- ARKHER SYSTEM O.0027 :: Weapon Sound Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0027"
	S.key = "arkher.audio.weaponsound.spatialization"
	S.name = "Weapon Sound Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Weapon Sound"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.weaponsound.mixer_bus" }
	S.tags = { "o", "weaponsound", "spatialaudio", "audio" }
	S.description = "Weapon Sound Spatialization: distance attenuation, panning, occlusion and doppler for the Weapon Sound subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.weaponsound.spatialization", model = "exponential", refDistance = 5, maxDistance = 200, rolloff = 0.96, maxVoices = 20 })
		inst.system = S
		inst.ctx = ctx
