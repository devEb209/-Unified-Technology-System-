-- ARKHER SYSTEM E.0488 :: Material Variant Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0488"
	S.key = "arkher.material.variant.streaming"
	S.name = "Material Variant Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.variant.parameter_budget" }
	S.tags = { "e", "variant", "streamer", "material" }
	S.description = "Material Variant Streaming: residency and demand-driven texture streaming for the Material Variant subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.variant.streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
