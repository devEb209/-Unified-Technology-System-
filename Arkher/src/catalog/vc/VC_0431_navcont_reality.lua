-- ARKHER SYSTEM VC.0431 :: Navigation Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0431"
	S.key = "arkher.contneural.navcont.reality_continuum"
	S.name = "Navigation Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.navcont.simulation_fabric" }
	S.tags = { "vc", "navcont", "reality", "contneural" }
	S.description = "Navigation Continuum Reality Continuum: stacked reality layers of the continuum for the Navigation Continuum subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.navcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
