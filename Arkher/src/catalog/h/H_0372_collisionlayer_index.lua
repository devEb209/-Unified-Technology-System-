-- ARKHER SYSTEM H.0372 :: Collision Layer Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0372"
	S.key = "arkher.physics.collisionlayer.broadphase_index"
	S.name = "Collision Layer Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionlayer.vehicle" }
	S.tags = { "h", "collisionlayer", "index", "physics" }
	S.description = "Collision Layer Broadphase Index: spatial acceleration of candidate pair finding for the Collision Layer subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.collisionlayer.broadphase_index", mode = "hash", cellSize = 72 })
		inst.system = S
		inst.ctx = ctx
