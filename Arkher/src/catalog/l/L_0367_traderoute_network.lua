-- ARKHER SYSTEM L.0367 :: Trade Route Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0367"
	S.key = "arkher.sim.traderoute.route_network"
	S.name = "Trade Route Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.traderoute.region_graph" }
	S.tags = { "l", "traderoute", "network", "sim" }
	S.description = "Trade Route Route Network: roads, rivers and routes between settlements for the Trade Route subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.traderoute.route_network" })
		inst.system = S
		inst.ctx = ctx
