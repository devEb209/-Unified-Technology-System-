-- ARKHER SYSTEM VC.0578 :: Thermal Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0578"
	S.key = "arkher.contneural.thermalcont.epoch_clock"
	S.name = "Thermal Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.thermalcont.infinite_grid" }
	S.tags = { "vc", "thermalcont", "epoch", "contneural" }
	S.description = "Thermal Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Thermal Continuum subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.thermalcont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
