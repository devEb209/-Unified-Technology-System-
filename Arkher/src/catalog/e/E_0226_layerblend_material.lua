-- ARKHER SYSTEM E.0226 :: Layer Blending Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0226"
	S.key = "arkher.material.layerblend.definition"
	S.name = "Layer Blending Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "layerblend", "material", "material" }
	S.description = "Layer Blending Definition: layered PBR definition resolved into parameters for the Layer Blending subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.layerblend.definition", texelBudget = 524288 })
		inst.system = S
		inst.ctx = ctx
