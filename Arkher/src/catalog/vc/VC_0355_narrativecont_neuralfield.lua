-- ARKHER SYSTEM VC.0355 :: Narrative Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0355"
	S.key = "arkher.contneural.narrativecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.narrativecont.coherence_guard" }
	S.tags = { "vc", "narrativecont", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.narrativecont.neural_field", dims = 12, hidden = 8, seed = 37468 })
		inst.system = S
		inst.ctx = ctx
