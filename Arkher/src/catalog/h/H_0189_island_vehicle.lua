-- ARKHER SYSTEM H.0189 :: Island Solver Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0189"
	S.key = "arkher.physics.island.vehicle"
	S.name = "Island Solver Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.island.character_motion" }
	S.tags = { "h", "island", "vehicle", "physics" }
	S.description = "Island Solver Vehicle: suspension, drivetrain, steering and tire friction for the Island Solver subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.island.vehicle", mass = 1200, wheelbase = 3.30, track = 1.70, maxRpm = 6700 })
		inst.system = S
		inst.ctx = ctx
