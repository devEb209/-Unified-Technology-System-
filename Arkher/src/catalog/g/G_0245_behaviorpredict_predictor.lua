-- ARKHER SYSTEM G.0245 :: Behaviour Prediction Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0245"
	S.key = "arkher.neural.behaviorpredict.quality_predictor"
	S.name = "Behaviour Prediction Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.behaviorpredict.weight_codec" }
	S.tags = { "g", "behaviorpredict", "predictor", "neural" }
	S.description = "Behaviour Prediction Quality Predictor: predicted quality and cost of a setting for the Behaviour Prediction subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.behaviorpredict.quality_predictor", method = "linear", alpha = 0.35, window = 81 })
		inst.system = S
		inst.ctx = ctx
