-- ARKHER SYSTEM VA.0456 :: Animation Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0456"
	S.key = "arkher.contworld.animcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.animcont.reality_continuum" }
	S.tags = { "va", "animcont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.animcont.emergence_continuum", windowSize = 7, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
