...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Creation2 — ANIMATION Map #0203", size=Vector2.new(680, 480), pos=UDim2.fromOffset(339, 151), parent=parent, icon="✎"})
