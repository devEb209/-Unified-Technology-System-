-- ARKHER SYSTEM I.0024 :: Bone Hierarchy Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0024"
	S.key = "arkher.anim.bonehierarchy.quality_policy"
	S.name = "Bone Hierarchy Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonehierarchy.pose_cache" }
	S.tags = { "i", "bonehierarchy", "policy", "anim" }
	S.description = "Bone Hierarchy Quality Policy: device tier rules for rate, bones and solvers for the Bone Hierarchy subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.bonehierarchy.quality_policy", algorithm = "lottery", starvationGuard = 63 })
		inst.system = S
		inst.ctx = ctx
