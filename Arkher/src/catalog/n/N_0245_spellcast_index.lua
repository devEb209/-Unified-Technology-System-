-- ARKHER SYSTEM N.0245 :: Spell Cast Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0245"
	S.key = "arkher.vfx.spellcast.spatial_index"
	S.name = "Spell Cast Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spell Cast"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spellcast.quality_policy" }
	S.tags = { "n", "spellcast", "index", "vfx" }
	S.description = "Spell Cast Spatial Index: spatial acceleration of effect queries and culling for the Spell Cast subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.spellcast.spatial_index", mode = "hash", cellSize = 16 })
		inst.system = S
		inst.ctx = ctx
