-- ARKHER SYSTEM J.0114 :: Gaze Behaviour Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0114"
	S.key = "arkher.character.gaze.look_and_reach"
	S.name = "Gaze Behaviour Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gaze.blend_controller" }
	S.tags = { "j", "gaze", "ik", "character" }
	S.description = "Gaze Behaviour Look And Reach: look-at, reach and foot placement for the character for the Gaze Behaviour subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.gaze.look_and_reach", iterations = 13, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
