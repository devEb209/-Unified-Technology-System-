-- ARKHER SYSTEM I.0245 :: Locomotion Blend Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0245"
	S.key = "arkher.anim.locomotionblend.quality_policy"
	S.name = "Locomotion Blend Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.locomotionblend.pose_cache" }
	S.tags = { "i", "locomotionblend", "policy", "anim" }
	S.description = "Locomotion Blend Quality Policy: device tier rules for rate, bones and solvers for the Locomotion Blend subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.locomotionblend.quality_policy", algorithm = "wfq", starvationGuard = 26 })
		inst.system = S
		inst.ctx = ctx
