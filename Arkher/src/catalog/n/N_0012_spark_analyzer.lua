-- ARKHER SYSTEM N.0012 :: Spark Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0012"
	S.key = "arkher.vfx.spark.analysis"
	S.name = "Spark Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spark"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spark.spatial_index" }
	S.tags = { "n", "spark", "analyzer", "vfx" }
	S.description = "Spark Analysis: cost, overdraw and stability analysis of the effect for the Spark subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.spark.analysis", window = 215, buckets = 19, threshold = 3.70 })
		inst.system = S
		inst.ctx = ctx
