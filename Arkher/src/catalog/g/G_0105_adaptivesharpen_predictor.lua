-- ARKHER SYSTEM G.0105 :: Adaptive Sharpening Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0105"
	S.key = "arkher.neural.adaptivesharpen.quality_predictor"
	S.name = "Adaptive Sharpening Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.adaptivesharpen.weight_codec" }
	S.tags = { "g", "adaptivesharpen", "predictor", "neural" }
	S.description = "Adaptive Sharpening Quality Predictor: predicted quality and cost of a setting for the Adaptive Sharpening subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.adaptivesharpen.quality_predictor", method = "linear", alpha = 0.16, window = 126 })
		inst.system = S
		inst.ctx = ctx
