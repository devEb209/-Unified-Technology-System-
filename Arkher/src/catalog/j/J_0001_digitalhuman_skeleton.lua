-- ARKHER SYSTEM J.0001 :: Digital Human Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0001"
	S.key = "arkher.character.digitalhuman.rig_definition"
	S.name = "Digital Human Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "digitalhuman", "skeleton", "character" }
	S.description = "Digital Human Rig Definition: character rig definition and bone budget for the Digital Human subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.digitalhuman.rig_definition" })
		inst.system = S
		inst.ctx = ctx
