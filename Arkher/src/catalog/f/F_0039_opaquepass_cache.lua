-- ARKHER SYSTEM F.0039 :: Opaque Pass Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0039"
	S.key = "arkher.render.opaquepass.pass_cache"
	S.name = "Opaque Pass Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Opaque Pass"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.opaquepass.render_policy" }
	S.tags = { "f", "opaquepass", "cache", "render" }
	S.description = "Opaque Pass Pass Cache: reuse of pass results across frames for the Opaque Pass subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.opaquepass.pass_cache", policy = "ttl", capacity = 434, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
