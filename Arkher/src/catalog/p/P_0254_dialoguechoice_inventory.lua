-- ARKHER SYSTEM P.0254 :: Dialogue Choice Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0254"
	S.key = "arkher.play.dialoguechoice.inventory"
	S.name = "Dialogue Choice Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.dialoguechoice.attributes" }
	S.tags = { "p", "dialoguechoice", "inventory", "play" }
	S.description = "Dialogue Choice Inventory: slots, stacking, weight, equipment and crafting for the Dialogue Choice subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.dialoguechoice.inventory", slots = 40, maxWeight = 110 })
		inst.system = S
		inst.ctx = ctx
