-- ARKHER SYSTEM N.0487 :: Glow Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0487"
	S.key = "arkher.vfx.glow.effect_graph"
	S.name = "Glow Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Glow"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.glow.curve_authoring" }
	S.tags = { "n", "glow", "shadegraph", "vfx" }
	S.description = "Glow Effect Graph: node graph describing how the effect is shaded for the Glow subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.glow.effect_graph" })
		inst.system = S
		inst.ctx = ctx
