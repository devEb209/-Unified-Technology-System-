-- ARKHER SYSTEM V.0176 :: Prefab Asset Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0176"
	S.key = "arkher.asset.prefabasset.compression_codec"
	S.name = "Prefab Asset Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.prefabasset.streaming_residency" }
	S.tags = { "v", "prefabasset", "codec", "asset" }
	S.description = "Prefab Asset Compression Codec: compact encoding, diffing and checksum of asset payloads for the Prefab Asset subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.prefabasset.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
