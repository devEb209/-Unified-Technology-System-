-- ARKHER SYSTEM VA.0214 :: Biome Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0214"
	S.key = "arkher.contworld.biomecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.biomecont.complexity_budget" }
	S.tags = { "va", "biomecont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.biomecont.simulation_fabric", budgetMs = 2.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
