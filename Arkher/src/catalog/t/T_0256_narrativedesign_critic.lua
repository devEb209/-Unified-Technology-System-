-- ARKHER SYSTEM T.0256 :: Narrative Design Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0256"
	S.key = "arkher.ai.narrativedesign.self_critique"
	S.name = "Narrative Design Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.narrativedesign.plan_workflow" }
	S.tags = { "t", "narrativedesign", "critic", "ai" }
	S.description = "Narrative Design Self Critique: weighted evaluation of the result against declared criteria for the Narrative Design subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.narrativedesign.self_critique", passMark = 0.73, reviseMark = 0.43, seed = 68043 })
		inst.system = S
		inst.ctx = ctx
