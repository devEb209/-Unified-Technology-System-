-- ARKHER SYSTEM P.0426 :: Party Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0426"
	S.key = "arkher.play.party.rule_pipeline"
	S.name = "Party Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Party"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.party.state_machine" }
	S.tags = { "p", "party", "pipeline", "play" }
	S.description = "Party Rule Pipeline: ordered rules applied to every gameplay event for the Party subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.party.rule_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
