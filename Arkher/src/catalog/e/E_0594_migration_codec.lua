-- ARKHER SYSTEM E.0594 :: Material Migration Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0594"
	S.key = "arkher.material.migration.compression_codec"
	S.name = "Material Migration Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.migration.streaming" }
	S.tags = { "e", "migration", "codec", "material" }
	S.description = "Material Migration Compression Codec: serialization and compression of material data for the Material Migration subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.migration.compression_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
