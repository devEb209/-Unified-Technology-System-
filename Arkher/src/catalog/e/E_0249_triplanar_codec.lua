-- ARKHER SYSTEM E.0249 :: Triplanar Projection Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0249"
	S.key = "arkher.material.triplanar.compression_codec"
	S.name = "Triplanar Projection Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.triplanar.streaming" }
	S.tags = { "e", "triplanar", "codec", "material" }
	S.description = "Triplanar Projection Compression Codec: serialization and compression of material data for the Triplanar Projection subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.triplanar.compression_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
