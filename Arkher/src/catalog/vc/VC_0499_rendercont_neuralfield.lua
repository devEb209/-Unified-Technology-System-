-- ARKHER SYSTEM VC.0499 :: Rendering Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0499"
	S.key = "arkher.contneural.rendercont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.rendercont.coherence_guard" }
	S.tags = { "vc", "rendercont", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.rendercont.neural_field", dims = 16, hidden = 12, seed = 7017 })
		inst.system = S
		inst.ctx = ctx
