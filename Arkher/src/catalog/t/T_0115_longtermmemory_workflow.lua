-- ARKHER SYSTEM T.0115 :: Long Term Memory Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0115"
	S.key = "arkher.ai.longtermmemory.plan_workflow"
	S.name = "Long Term Memory Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.longtermmemory.semantic_knowledge" }
	S.tags = { "t", "longtermmemory", "workflow", "ai" }
	S.description = "Long Term Memory Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Long Term Memory subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.longtermmemory.plan_workflow", maxRetries = 3, budget = 90 })
		inst.system = S
		inst.ctx = ctx
