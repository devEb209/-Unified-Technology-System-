-- ARKHER SYSTEM J.0290 :: Character LOD Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0290"
	S.key = "arkher.character.characterlod.look_and_reach"
	S.name = "Character LOD Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterlod.blend_controller" }
	S.tags = { "j", "characterlod", "ik", "character" }
	S.description = "Character LOD Look And Reach: look-at, reach and foot placement for the character for the Character LOD subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.characterlod.look_and_reach", iterations = 11, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
