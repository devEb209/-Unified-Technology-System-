-- ARKHER SYSTEM VD.0341 :: Society Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0341"
	S.key = "arkher.contsim.societycont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.societycont.multi-scale_fidelity" }
	S.tags = { "vd", "societycont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.societycont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
