-- ARKHER SYSTEM J.0266 :: Wetness Response Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0266"
	S.key = "arkher.character.wetnessresponse.motion_set"
	S.name = "Wetness Response Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.wetnessresponse.rig_definition" }
	S.tags = { "j", "wetnessresponse", "clip", "character" }
	S.description = "Wetness Response Motion Set: the clips a character owns and how they sample for the Wetness Response subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.wetnessresponse.motion_set", duration = 2.80, loop = true })
		inst.system = S
		inst.ctx = ctx
