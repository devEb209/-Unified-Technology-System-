-- ARKHER SYSTEM K.0584 :: Idle Behaviour Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0584"
	S.key = "arkher.npc.idlebehaviour.crowd_steering"
	S.name = "Idle Behaviour Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.idlebehaviour.navigation" }
	S.tags = { "k", "idlebehaviour", "crowd", "npc" }
	S.description = "Idle Behaviour Crowd Steering: local avoidance, cohesion and arrival at scale for the Idle Behaviour subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.idlebehaviour.crowd_steering", radius = 0.75, maxSpeed = 5.70, cellSize = 9 })
		inst.system = S
		inst.ctx = ctx
