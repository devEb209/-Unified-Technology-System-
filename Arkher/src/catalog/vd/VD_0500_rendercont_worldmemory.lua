-- ARKHER SYSTEM VD.0500 :: Rendering Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0500"
	S.key = "arkher.contsim.rendercont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.rendercont.neural_field" }
	S.tags = { "vd", "rendercont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.rendercont.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
