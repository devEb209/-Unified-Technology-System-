-- ARKHER SYSTEM H.0385 :: Collision Filter Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0385"
	S.key = "arkher.physics.collisionfilter.vehicle"
	S.name = "Collision Filter Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionfilter.character_motion" }
	S.tags = { "h", "collisionfilter", "vehicle", "physics" }
	S.description = "Collision Filter Vehicle: suspension, drivetrain, steering and tire friction for the Collision Filter subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.collisionfilter.vehicle", mass = 1300, wheelbase = 2.80, track = 1.60, maxRpm = 6200 })
		inst.system = S
		inst.ctx = ctx
