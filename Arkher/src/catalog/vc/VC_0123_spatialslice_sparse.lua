-- ARKHER SYSTEM VC.0123 :: Spatial Slice Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0123"
	S.key = "arkher.contneural.spatialslice.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.spatialslice.epoch_clock" }
	S.tags = { "vc", "spatialslice", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.spatialslice.sparse_residency", capacity = 256, pageBytes = 3072 })
		inst.system = S
		inst.ctx = ctx
