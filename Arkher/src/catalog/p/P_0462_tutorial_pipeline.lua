-- ARKHER SYSTEM P.0462 :: Tutorial Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0462"
	S.key = "arkher.play.tutorial.rule_pipeline"
	S.name = "Tutorial Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Tutorial"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.tutorial.state_machine" }
	S.tags = { "p", "tutorial", "pipeline", "play" }
	S.description = "Tutorial Rule Pipeline: ordered rules applied to every gameplay event for the Tutorial subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.tutorial.rule_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
