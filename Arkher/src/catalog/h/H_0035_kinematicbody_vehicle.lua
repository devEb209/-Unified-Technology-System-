-- ARKHER SYSTEM H.0035 :: Kinematic Body Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0035"
	S.key = "arkher.physics.kinematicbody.vehicle"
	S.name = "Kinematic Body Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.kinematicbody.character_motion" }
	S.tags = { "h", "kinematicbody", "vehicle", "physics" }
	S.description = "Kinematic Body Vehicle: suspension, drivetrain, steering and tire friction for the Kinematic Body subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.kinematicbody.vehicle", mass = 1500, wheelbase = 2.40, track = 2.00, maxRpm = 5800 })
		inst.system = S
		inst.ctx = ctx
