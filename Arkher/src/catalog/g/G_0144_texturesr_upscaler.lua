-- ARKHER SYSTEM G.0144 :: Texture Super Resolution Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0144"
	S.key = "arkher.neural.texturesr.reconstruction"
	S.name = "Texture Super Resolution Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.texturesr.temporal_history" }
	S.tags = { "g", "texturesr", "upscaler", "neural" }
	S.description = "Texture Super Resolution Reconstruction: resolution ladder and image reconstruction for the Texture Super Resolution subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.texturesr.reconstruction", targetMs = 16.10, index = 5, sharpness = 0.35 })
		inst.system = S
		inst.ctx = ctx
