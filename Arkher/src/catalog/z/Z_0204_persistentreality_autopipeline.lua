-- ARKHER SYSTEM Z.0204 :: Persistent Reality State Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0204"
	S.key = "arkher.origin.persistentreality.autonomous_pipeline"
	S.name = "Persistent Reality State Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.simulation_fabric" }
	S.tags = { "z", "persistentreality", "autopipeline", "origin" }
	S.description = "Persistent Reality State Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.persistentreality.autonomous_pipeline", maxIterations = 9 })
		inst.system = S
		inst.ctx = ctx
