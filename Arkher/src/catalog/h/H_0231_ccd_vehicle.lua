-- ARKHER SYSTEM H.0231 :: Continuous Detection Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0231"
	S.key = "arkher.physics.ccd.vehicle"
	S.name = "Continuous Detection Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.ccd.character_motion" }
	S.tags = { "h", "ccd", "vehicle", "physics" }
	S.description = "Continuous Detection Vehicle: suspension, drivetrain, steering and tire friction for the Continuous Detection subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.ccd.vehicle", mass = 1200, wheelbase = 3.10, track = 1.50, maxRpm = 6500 })
		inst.system = S
		inst.ctx = ctx
