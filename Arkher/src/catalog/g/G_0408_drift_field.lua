-- ARKHER SYSTEM G.0408 :: Drift Detection Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0408"
	S.key = "arkher.neural.drift.feature_extraction"
	S.name = "Drift Detection Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.drift.inference_core" }
	S.tags = { "g", "drift", "field", "neural" }
	S.description = "Drift Detection Feature Extraction: signal features feeding the model for the Drift Detection subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.drift.feature_extraction", seed = 70295, frequency = 0.0077, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
