-- ARKHER SYSTEM I.0410 :: Animation Streaming Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0410"
	S.key = "arkher.anim.animstreaming.compression_codec"
	S.name = "Animation Streaming Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstreaming.retarget_graph" }
	S.tags = { "i", "animstreaming", "codec", "anim" }
	S.description = "Animation Streaming Compression Codec: curve compression and quantized transport for the Animation Streaming subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.animstreaming.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
