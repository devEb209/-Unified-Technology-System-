-- ARKHER SYSTEM O.0328 :: Engine Audio Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0328"
	S.key = "arkher.audio.engineaudio.music_sequencer"
	S.name = "Engine Audio Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Engine Audio"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.engineaudio.spatialization" }
	S.tags = { "o", "engineaudio", "sequencer", "audio" }
	S.description = "Engine Audio Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Engine Audio subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.engineaudio.music_sequencer", bpm = 90, beatsPerBar = 4, intensity = 0.38 })
		inst.system = S
		inst.ctx = ctx
