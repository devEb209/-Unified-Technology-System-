-- ARKHER SYSTEM W.0124 :: Drone Shot Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0124"
	S.key = "arkher.cine.drone.shot_composition"
	S.name = "Drone Shot Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Drone Shot"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.drone.colour_grade" }
	S.tags = { "w", "drone", "composer", "cine" }
	S.description = "Drone Shot Shot Composition: blending of the signals that make up the final shot for the Drone Shot subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.drone.shot_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
