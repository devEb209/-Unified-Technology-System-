-- ARKHER SYSTEM J.0089 :: Expression Set Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0089"
	S.key = "arkher.character.expression.rig_definition"
	S.name = "Expression Set Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "expression", "skeleton", "character" }
	S.description = "Expression Set Rig Definition: character rig definition and bone budget for the Expression Set subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.expression.rig_definition" })
		inst.system = S
		inst.ctx = ctx
