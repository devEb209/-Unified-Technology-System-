-- ARKHER SYSTEM I.0191 :: Blend Tree Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0191"
	S.key = "arkher.anim.blendtree.playback_pipeline"
	S.name = "Blend Tree Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Blend Tree"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.blendtree.event_ledger" }
	S.tags = { "i", "blendtree", "pipeline", "anim" }
	S.description = "Blend Tree Playback Pipeline: ordered sample, blend, ik and output stages for the Blend Tree subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.blendtree.playback_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
