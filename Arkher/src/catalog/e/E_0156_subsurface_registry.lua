-- ARKHER SYSTEM E.0156 :: Subsurface Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0156"
	S.key = "arkher.material.subsurface.variant_registry"
	S.name = "Subsurface Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Subsurface"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.subsurface.procedural_detail" }
	S.tags = { "e", "subsurface", "registry", "material" }
	S.description = "Subsurface Variant Registry: named variants and their lifecycle for the Subsurface subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.subsurface.variant_registry" })
		inst.system = S
		inst.ctx = ctx
