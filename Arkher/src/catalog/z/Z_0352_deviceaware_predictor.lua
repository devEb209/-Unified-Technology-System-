-- ARKHER SYSTEM Z.0352 :: Device Aware Fidelity Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0352"
	S.key = "arkher.origin.deviceaware.predictive_optimization"
	S.name = "Device Aware Fidelity Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.adaptive_workflow" }
	S.tags = { "z", "deviceaware", "predictor", "origin" }
	S.description = "Device Aware Fidelity Predictive Optimization: forecast-driven optimization before the cost is paid for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.deviceaware.predictive_optimization", method = "markov", alpha = 0.39, window = 85 })
		inst.system = S
		inst.ctx = ctx
