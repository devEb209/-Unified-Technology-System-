-- ARKHER SYSTEM F.0334 :: Motion Blur Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0334"
	S.key = "arkher.render.motionblur.frame_analysis"
	S.name = "Motion Blur Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Motion Blur"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.motionblur.pass_cache" }
	S.tags = { "f", "motionblur", "analyzer", "render" }
	S.description = "Motion Blur Frame Analysis: per-pass cost analysis and outlier detection for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.motionblur.frame_analysis", window = 91, buckets = 19, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
