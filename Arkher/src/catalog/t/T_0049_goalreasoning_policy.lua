-- ARKHER SYSTEM T.0049 :: Goal Reasoning Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0049"
	S.key = "arkher.ai.goalreasoning.decision_policy"
	S.name = "Goal Reasoning Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.goalreasoning.reasoning_graph" }
	S.tags = { "t", "goalreasoning", "policy", "ai" }
	S.description = "Goal Reasoning Decision Policy: ordered rules deciding what the agent does next for the Goal Reasoning subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.goalreasoning.decision_policy", algorithm = "wfq", starvationGuard = 30 })
		inst.system = S
		inst.ctx = ctx
