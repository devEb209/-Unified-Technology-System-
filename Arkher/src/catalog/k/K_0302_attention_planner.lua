-- ARKHER SYSTEM K.0302 :: Attention Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0302"
	S.key = "arkher.npc.attention.goal_planner"
	S.name = "Attention Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.attention.utility_reasoning" }
	S.tags = { "k", "attention", "planner", "npc" }
	S.description = "Attention Goal Planner: backward GOAP planning to reach a goal state for the Attention subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.attention.goal_planner", maxDepth = 11 })
		inst.system = S
		inst.ctx = ctx
