-- ARKHER SYSTEM Z.0121 :: Dynamic Complexity Manager Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0121"
	S.key = "arkher.origin.complexitymanager.reality_layering"
	S.name = "Dynamic Complexity Manager Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "complexitymanager", "reality", "origin" }
	S.description = "Dynamic Complexity Manager Reality Layering: stacked authored, simulated, proposed and player realities for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.complexitymanager.reality_layering" })
		inst.system = S
		inst.ctx = ctx
