-- ARKHER SYSTEM VB.0151 :: Persistence Segment Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0151"
	S.key = "arkher.conttime.persistsegment.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.persistsegment.coherence_guard" }
	S.tags = { "vb", "persistsegment", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.persistsegment.neural_field", dims = 24, hidden = 20, seed = 73347 })
		inst.system = S
		inst.ctx = ctx
