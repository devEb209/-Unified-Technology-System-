-- ARKHER SYSTEM VA.0104 :: Memory Shard World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0104"
	S.key = "arkher.contworld.memoryshard.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memoryshard.neural_field" }
	S.tags = { "va", "memoryshard", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.memoryshard.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
