-- ARKHER SYSTEM T.0209 :: City Generation Learning Analysis
...
return function(A)
	...
	local S = {}
	S.id = "T.0209"
	S.key = "arkher.ai.citygeneration.learning_analysis"
	S.name = "City Generation Learning Analysis"
	S.category = "T"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.citygeneration.model_inference" }
	S.tags = { "t", "citygeneration", "analyzer", "ai" }
	S.description = "City Generation Learning Analysis: trend, anomaly and improvement analysis of the agent for the City Generation subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ai.citygeneration.learning_analysis", window = 202, buckets = 14, threshold = 4.40 })
		inst.system = S
		inst.ctx = ctx
