-- ARKHER SYSTEM VA.0565 :: Mobile Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0565"
	S.key = "arkher.contworld.mobilecont.infinite_grid"
	S.name = "Mobile Continuum Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "mobilecont", "continuum", "contworld" }
	S.description = "Mobile Continuum Infinite Grid: seamless paging of the infinite world grid for the Mobile Continuum subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.mobilecont.infinite_grid", cellSize = 192, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
