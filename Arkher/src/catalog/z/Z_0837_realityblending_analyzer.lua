-- ARKHER SYSTEM Z.0837 :: Reality Blending Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0837"
	S.key = "arkher.origin.realityblending.behaviour_analysis"
	S.name = "Reality Blending Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.governance_policy" }
	S.tags = { "z", "realityblending", "analyzer", "origin" }
	S.description = "Reality Blending Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.realityblending.behaviour_analysis", window = 48, buckets = 8, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
