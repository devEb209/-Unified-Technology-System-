-- ARKHER SYSTEM Z.0309 :: Causality Ledger Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0309"
	S.key = "arkher.origin.causality.intent_bridge"
	S.name = "Causality Ledger Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.semantic_graph" }
	S.tags = { "z", "causality", "intent", "origin" }
	S.description = "Causality Ledger Intent Bridge: natural language control surface for the technology for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.causality.intent_bridge", minConfidence = 0.35 })
		inst.system = S
		inst.ctx = ctx
