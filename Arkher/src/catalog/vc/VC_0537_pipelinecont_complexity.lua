-- ARKHER SYSTEM VC.0537 :: Pipeline Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0537"
	S.key = "arkher.contneural.pipelinecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.pipelinecont.world_memory_stream" }
	S.tags = { "vc", "pipelinecont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.pipelinecont.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
