-- ARKHER SYSTEM F.0407 :: Instanced Draw Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0407"
	S.key = "arkher.render.instanced.frame_graph"
	S.name = "Instanced Draw Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "instanced", "framegraph", "render" }
	S.description = "Instanced Draw Frame Graph: declared passes, culling, ordering and aliasing for the Instanced Draw subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.instanced.frame_graph", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
