-- ARKHER SYSTEM VA.0583 :: Thermal Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0583"
	S.key = "arkher.contworld.thermalcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.thermalcont.coherence_guard" }
	S.tags = { "va", "thermalcont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.thermalcont.neural_field", dims = 12, hidden = 8, seed = 61048 })
		inst.system = S
		inst.ctx = ctx
