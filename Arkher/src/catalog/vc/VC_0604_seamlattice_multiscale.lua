-- ARKHER SYSTEM VC.0604 :: Seam Lattice Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VC.0604"
	S.key = "arkher.contneural.seamlattice.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.seamlattice.sparse_residency" }
	S.tags = { "vc", "seamlattice", "multiscale", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contneural.seamlattice.multi-scale_fidelity", levels = 4, baseTriangles = 90000 })
		inst.system = S
		inst.ctx = ctx
