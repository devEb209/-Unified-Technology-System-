-- ARKHER SYSTEM T.0456 :: Behaviour Learning Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0456"
	S.key = "arkher.ai.behaviourlearning.outcome_prediction"
	S.name = "Behaviour Learning Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.behaviourlearning.decision_policy" }
	S.tags = { "t", "behaviourlearning", "predictor", "ai" }
	S.description = "Behaviour Learning Outcome Prediction: forecasting the result before the work is done for the Behaviour Learning subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.behaviourlearning.outcome_prediction", method = "linear", alpha = 0.13, window = 51 })
		inst.system = S
		inst.ctx = ctx
