-- ARKHER SYSTEM G.0437 :: Model Versioning Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0437"
	S.key = "arkher.neural.modelversion.temporal_history"
	S.name = "Model Versioning Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelversion.feature_extraction" }
	S.tags = { "g", "modelversion", "temporal", "neural" }
	S.description = "Model Versioning Temporal History: history buffers reused across frames for the Model Versioning subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.modelversion.temporal_history", feedback = 0.93, phase = 8 })
		inst.system = S
		inst.ctx = ctx
