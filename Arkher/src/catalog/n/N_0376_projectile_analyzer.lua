-- ARKHER SYSTEM N.0376 :: Projectile Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0376"
	S.key = "arkher.vfx.projectile.analysis"
	S.name = "Projectile Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Projectile"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.projectile.spatial_index" }
	S.tags = { "n", "projectile", "analyzer", "vfx" }
	S.description = "Projectile Analysis: cost, overdraw and stability analysis of the effect for the Projectile subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.projectile.analysis", window = 170, buckets = 14, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
