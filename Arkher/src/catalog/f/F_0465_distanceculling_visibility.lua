-- ARKHER SYSTEM F.0465 :: Distance Culling Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0465"
	S.key = "arkher.render.distanceculling.visibility_set"
	S.name = "Distance Culling Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.distanceculling.view_and_culling" }
	S.tags = { "f", "distanceculling", "visibility", "render" }
	S.description = "Distance Culling Visibility Set: cell, portal and occluder visibility for the Distance Culling subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.distanceculling.visibility_set", maxDepth = 4 })
		inst.system = S
		inst.ctx = ctx
