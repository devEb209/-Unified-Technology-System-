-- ARKHER SYSTEM Z.0886 :: Sparse World Representation Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0886"
	S.key = "arkher.origin.sparseworld.emergence_detection"
	S.name = "Sparse World Representation Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.world_memory" }
	S.tags = { "z", "sparseworld", "emergence", "origin" }
	S.description = "Sparse World Representation Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.sparseworld.emergence_detection", windowSize = 7, threshold = 1.60, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
