-- ARKHER SYSTEM VB.0633 :: Interest Field Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0633"
	S.key = "arkher.conttime.interestfield.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.interestfield.world_memory_stream" }
	S.tags = { "vb", "interestfield", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.interestfield.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
