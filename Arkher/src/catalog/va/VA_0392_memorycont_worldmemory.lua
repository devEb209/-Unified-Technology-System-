-- ARKHER SYSTEM VA.0392 :: Memory Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0392"
	S.key = "arkher.contworld.memorycont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memorycont.neural_field" }
	S.tags = { "va", "memorycont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.memorycont.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
