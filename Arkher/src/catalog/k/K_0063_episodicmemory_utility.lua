-- ARKHER SYSTEM K.0063 :: Episodic Memory Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0063"
	S.key = "arkher.npc.episodicmemory.utility_reasoning"
	S.name = "Episodic Memory Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.episodicmemory.reactive_behaviour" }
	S.tags = { "k", "episodicmemory", "utility", "npc" }
	S.description = "Episodic Memory Utility Reasoning: scored option selection with response curves for the Episodic Memory subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.episodicmemory.utility_reasoning", momentum = 0.12 })
		inst.system = S
		inst.ctx = ctx
