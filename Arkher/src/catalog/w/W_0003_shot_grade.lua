-- ARKHER SYSTEM W.0003 :: Shot Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0003"
	S.key = "arkher.cine.shot.colour_grade"
	S.name = "Shot Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Shot"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.shot.camera_rig" }
	S.tags = { "w", "shot", "grade", "cine" }
	S.description = "Shot Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Shot subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.shot.colour_grade", exposure = -0.10, contrast = 0.95, saturation = 0.95, toneMap = "reinhard" })
		inst.system = S
		inst.ctx = ctx
