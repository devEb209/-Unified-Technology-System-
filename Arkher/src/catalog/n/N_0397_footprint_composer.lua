-- ARKHER SYSTEM N.0397 :: Footprint Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0397"
	S.key = "arkher.vfx.footprint.effect_composition"
	S.name = "Footprint Effect Composition"
	S.category = "N"
	S.family = "VFX"
	S.area = "Footprint"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.footprint.effect_graph" }
	S.tags = { "n", "footprint", "composer", "vfx" }
	S.description = "Footprint Effect Composition: blending of several effect signals into one output for the Footprint subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.footprint.effect_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
