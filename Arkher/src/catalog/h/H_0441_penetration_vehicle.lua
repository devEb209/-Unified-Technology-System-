-- ARKHER SYSTEM H.0441 :: Penetration Recovery Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0441"
	S.key = "arkher.physics.penetration.vehicle"
	S.name = "Penetration Recovery Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.penetration.character_motion" }
	S.tags = { "h", "penetration", "vehicle", "physics" }
	S.description = "Penetration Recovery Vehicle: suspension, drivetrain, steering and tire friction for the Penetration Recovery subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.penetration.vehicle", mass = 1400, wheelbase = 2.50, track = 1.70, maxRpm = 5900 })
		inst.system = S
		inst.ctx = ctx
