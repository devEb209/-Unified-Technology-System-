-- ARKHER SYSTEM VA.0071 :: Sparse Page Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0071"
	S.key = "arkher.contworld.sparsepage.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.sparsepage.simulation_fabric" }
	S.tags = { "va", "sparsepage", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.sparsepage.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
