-- ARKHER SYSTEM P.0452 :: Difficulty Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0452"
	S.key = "arkher.play.difficulty.balance_analysis"
	S.name = "Difficulty Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Difficulty"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.difficulty.event_ledger" }
	S.tags = { "p", "difficulty", "analyzer", "play" }
	S.description = "Difficulty Balance Analysis: distribution, outlier and pacing analysis for the Difficulty subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.difficulty.balance_analysis", window = 177, buckets = 9, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
