-- ARKHER SYSTEM T.0524 :: Audio Reasoning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0524"
	S.key = "arkher.ai.audioreasoning.reasoning_graph"
	S.name = "Audio Reasoning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.audioreasoning.world_architect" }
	S.tags = { "t", "audioreasoning", "graph", "ai" }
	S.description = "Audio Reasoning Reasoning Graph: relationship modelling and shortest-path reasoning for the Audio Reasoning subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.audioreasoning.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
