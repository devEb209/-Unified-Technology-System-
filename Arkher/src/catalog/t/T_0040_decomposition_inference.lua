-- ARKHER SYSTEM T.0040 :: Task Decomposition Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0040"
	S.key = "arkher.ai.decomposition.model_inference"
	S.name = "Task Decomposition Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.decomposition.action_planner" }
	S.tags = { "t", "decomposition", "inference", "ai" }
	S.description = "Task Decomposition Model Inference: quantized inference with batching and budget for the Task Decomposition subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.decomposition.model_inference", seed = 4250 })
		inst.system = S
		inst.ctx = ctx
