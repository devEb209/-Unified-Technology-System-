-- ARKHER SYSTEM VD.0609 :: Seam Lattice Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0609"
	S.key = "arkher.contsim.seamlattice.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.seamlattice.world_memory_stream" }
	S.tags = { "vd", "seamlattice", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.seamlattice.complexity_budget", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
