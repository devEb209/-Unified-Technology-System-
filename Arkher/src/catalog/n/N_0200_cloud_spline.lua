-- ARKHER SYSTEM N.0200 :: Cloud Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0200"
	S.key = "arkher.vfx.cloud.curve_authoring"
	S.name = "Cloud Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloud"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.cloud.ribbon_and_trail" }
	S.tags = { "n", "cloud", "spline", "vfx" }
	S.description = "Cloud Curve Authoring: authored curves driving the effect over its life for the Cloud subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.cloud.curve_authoring", tension = 0.73, closed = false })
		inst.system = S
		inst.ctx = ctx
