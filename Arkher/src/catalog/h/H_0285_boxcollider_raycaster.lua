-- ARKHER SYSTEM H.0285 :: Box Collider Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0285"
	S.key = "arkher.physics.boxcollider.query"
	S.name = "Box Collider Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Box Collider"
	S.aspect = "Query"
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.boxcollider.constraint_solver" }
	S.tags = { "h", "boxcollider", "raycaster", "physics" }
	S.description = "Box Collider Query: rays, sweeps and overlaps against the simulation for the Box Collider subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.boxcollider.query", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
