...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="D-O15 S620 — ANIMATION Map #0033", size=Vector2.new(600, 480), pos=UDim2.fromOffset(129, 121), parent=parent, icon="⬢"})
