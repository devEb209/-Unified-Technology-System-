...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="UE5/6 Nanite — CORE Map #0168", size=Vector2.new(600, 480), pos=UDim2.fromOffset(284, 336), parent=parent, icon="⛰"})
