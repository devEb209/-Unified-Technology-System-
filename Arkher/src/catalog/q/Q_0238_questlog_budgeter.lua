-- ARKHER SYSTEM Q.0238 :: Quest Log Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0238"
	S.key = "arkher.ui.questlog.frame_budget"
	S.name = "Quest Log Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Quest Log"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.questlog.accessibility_policy" }
	S.tags = { "q", "questlog", "budgeter", "ui" }
	S.description = "Quest Log Frame Budget: per-frame layout and draw budget for the interface for the Quest Log subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.questlog.frame_budget", total = 149, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
