-- ARKHER SYSTEM VB.0175 :: Neural Patch Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0175"
	S.key = "arkher.conttime.neuralpatch.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.neuralpatch.coherence_guard" }
	S.tags = { "vb", "neuralpatch", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.neuralpatch.neural_field", dims = 20, hidden = 16, seed = 14570 })
		inst.system = S
		inst.ctx = ctx
