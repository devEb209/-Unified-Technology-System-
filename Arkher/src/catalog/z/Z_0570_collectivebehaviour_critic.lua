-- ARKHER SYSTEM Z.0570 :: Collective Behaviour Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0570"
	S.key = "arkher.origin.collectivebehaviour.self_critique"
	S.name = "Collective Behaviour Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.collectivebehaviour.intent_bridge" }
	S.tags = { "z", "collectivebehaviour", "critic", "origin" }
	S.description = "Collective Behaviour Self Critique: weighted judgement of the technology's own output for the Collective Behaviour subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.collectivebehaviour.self_critique", passMark = 0.71, reviseMark = 0.46, seed = 42376 })
		inst.system = S
		inst.ctx = ctx
