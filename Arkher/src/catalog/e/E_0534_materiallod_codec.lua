-- ARKHER SYSTEM E.0534 :: Material LOD Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0534"
	S.key = "arkher.material.materiallod.compression_codec"
	S.name = "Material LOD Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Material LOD"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.materiallod.streaming" }
	S.tags = { "e", "materiallod", "codec", "material" }
	S.description = "Material LOD Compression Codec: serialization and compression of material data for the Material LOD subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.materiallod.compression_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
