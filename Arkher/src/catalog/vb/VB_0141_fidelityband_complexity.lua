-- ARKHER SYSTEM VB.0141 :: Fidelity Band Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0141"
	S.key = "arkher.conttime.fidelityband.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.fidelityband.world_memory_stream" }
	S.tags = { "vb", "fidelityband", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.fidelityband.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
