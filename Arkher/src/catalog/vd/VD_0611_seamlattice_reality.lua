-- ARKHER SYSTEM VD.0611 :: Seam Lattice Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0611"
	S.key = "arkher.contsim.seamlattice.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.seamlattice.simulation_fabric" }
	S.tags = { "vd", "seamlattice", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.seamlattice.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
