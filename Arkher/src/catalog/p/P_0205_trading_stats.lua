-- ARKHER SYSTEM P.0205 :: Trading Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0205"
	S.key = "arkher.play.trading.attributes"
	S.name = "Trading Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Trading"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "trading", "stats", "play" }
	S.description = "Trading Attributes: base values, layered modifiers and derived statistics for the Trading subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.trading.attributes" })
		inst.system = S
		inst.ctx = ctx
