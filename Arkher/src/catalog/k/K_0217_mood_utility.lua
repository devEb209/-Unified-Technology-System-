-- ARKHER SYSTEM K.0217 :: Mood Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0217"
	S.key = "arkher.npc.mood.utility_reasoning"
	S.name = "Mood Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.mood.reactive_behaviour" }
	S.tags = { "k", "mood", "utility", "npc" }
	S.description = "Mood Utility Reasoning: scored option selection with response curves for the Mood subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.mood.utility_reasoning", momentum = 0.05 })
		inst.system = S
		inst.ctx = ctx
