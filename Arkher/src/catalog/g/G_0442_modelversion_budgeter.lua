-- ARKHER SYSTEM G.0442 :: Model Versioning Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0442"
	S.key = "arkher.neural.modelversion.compute_budget"
	S.name = "Model Versioning Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelversion.quality_predictor" }
	S.tags = { "g", "modelversion", "budgeter", "neural" }
	S.description = "Model Versioning Compute Budget: inference time budget allocation for the Model Versioning subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.modelversion.compute_budget", total = 300, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
