-- ARKHER SYSTEM R.0152 :: Delta Compression Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0152"
	S.key = "arkher.net.deltacompression.rate_guard"
	S.name = "Delta Compression Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.deltacompression.interest_streaming" }
	S.tags = { "r", "deltacompression", "guard", "net" }
	S.description = "Delta Compression Rate Guard: token-bucket protection against floods and abuse for the Delta Compression subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.deltacompression.rate_guard", algorithm = "token", capacity = 112, refillPerSec = 17, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
