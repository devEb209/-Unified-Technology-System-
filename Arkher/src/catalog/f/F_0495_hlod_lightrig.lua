-- ARKHER SYSTEM F.0495 :: HLOD Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0495"
	S.key = "arkher.render.hlod.lighting_rig"
	S.name = "HLOD Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "HLOD"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.hlod.geometry_virtualization" }
	S.tags = { "f", "hlod", "lightrig", "render" }
	S.description = "HLOD Lighting Rig: light clustering, importance and cascades for the HLOD subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.hlod.lighting_rig", maxActive = 4 })
		inst.system = S
		inst.ctx = ctx
