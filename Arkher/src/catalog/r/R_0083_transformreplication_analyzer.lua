-- ARKHER SYSTEM R.0083 :: Transform Replication Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0083"
	S.key = "arkher.net.transformreplication.latency_analysis"
	S.name = "Transform Replication Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.transformreplication.audit_ledger" }
	S.tags = { "r", "transformreplication", "analyzer", "net" }
	S.description = "Transform Replication Latency Analysis: round trip, jitter and loss analysis for the Transform Replication subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.transformreplication.latency_analysis", window = 61, buckets = 13, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
