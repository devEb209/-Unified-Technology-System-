-- ARKHER SYSTEM VC.0097 :: Memory Shard Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0097"
	S.key = "arkher.contneural.memoryshard.infinite_grid"
	S.name = "Memory Shard Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "memoryshard", "continuum", "contneural" }
	S.description = "Memory Shard Infinite Grid: seamless paging of the infinite world grid for the Memory Shard subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.memoryshard.infinite_grid", cellSize = 192, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
