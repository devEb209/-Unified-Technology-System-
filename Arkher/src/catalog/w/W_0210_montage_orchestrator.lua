-- ARKHER SYSTEM W.0210 :: Montage Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0210"
	S.key = "arkher.cine.montage.playback_orchestrator"
	S.name = "Montage Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Montage"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.montage.cut_policy" }
	S.tags = { "w", "montage", "orchestrator", "cine" }
	S.description = "Montage Playback Orchestrator: the state machine that drives a cinematic from start to end for the Montage subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.montage.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
