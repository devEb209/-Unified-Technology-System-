-- ARKHER SYSTEM N.0142 :: Waterfall Mist Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0142"
	S.key = "arkher.vfx.mist.analysis"
	S.name = "Waterfall Mist Analysis"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.mist.spatial_index" }
	S.tags = { "n", "mist", "analyzer", "vfx" }
	S.description = "Waterfall Mist Analysis: cost, overdraw and stability analysis of the effect for the Waterfall Mist subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.mist.analysis", window = 49, buckets = 13, threshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
