-- ARKHER SYSTEM F.0116 :: Screen Space Reflection Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0116"
	S.key = "arkher.render.ssr.geometry_virtualization"
	S.name = "Screen Space Reflection Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.ssr.visibility_set" }
	S.tags = { "f", "ssr", "impostor", "render" }
	S.description = "Screen Space Reflection Geometry Virtualization: impostor and HLOD synthesis under a budget for the Screen Space Reflection subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.ssr.geometry_virtualization", atlasSlots = 112, viewCount = 8, errorThreshold = 2.10 })
		inst.system = S
		inst.ctx = ctx
