-- ARKHER SYSTEM VB.0611 :: Seam Lattice Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0611"
	S.key = "arkher.conttime.seamlattice.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.seamlattice.simulation_fabric" }
	S.tags = { "vb", "seamlattice", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.seamlattice.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
