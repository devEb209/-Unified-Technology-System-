-- ARKHER SYSTEM VA.0361 :: Quest Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0361"
	S.key = "arkher.contworld.questcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "questcont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.questcont.infinite_grid", cellSize = 224, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
