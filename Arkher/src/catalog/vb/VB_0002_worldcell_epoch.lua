-- ARKHER SYSTEM VB.0002 :: World Grid Cell Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0002"
	S.key = "arkher.conttime.worldcell.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldcell.infinite_grid" }
	S.tags = { "vb", "worldcell", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.worldcell.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
