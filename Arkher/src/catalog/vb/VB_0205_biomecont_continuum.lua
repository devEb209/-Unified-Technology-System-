-- ARKHER SYSTEM VB.0205 :: Biome Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0205"
	S.key = "arkher.conttime.biomecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "biomecont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.biomecont.infinite_grid", cellSize = 224, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
