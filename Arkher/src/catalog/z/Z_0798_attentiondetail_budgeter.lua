-- ARKHER SYSTEM Z.0798 :: Attention Driven Detail Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0798"
	S.key = "arkher.origin.attentiondetail.budget_governor"
	S.name = "Attention Driven Detail Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.behaviour_analysis" }
	S.tags = { "z", "attentiondetail", "budgeter", "origin" }
	S.description = "Attention Driven Detail Budget Governor: allocation of a scarce resource across the technology's consumers for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.attentiondetail.budget_governor", total = 69, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
