-- ARKHER SYSTEM VD.0629 :: Interest Field Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0629"
	S.key = "arkher.contsim.interestfield.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.interestfield.multi-scale_fidelity" }
	S.tags = { "vd", "interestfield", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.interestfield.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
