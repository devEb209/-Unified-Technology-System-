-- ARKHER SYSTEM N.0090 :: Impact Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0090"
	S.key = "arkher.vfx.impact.analysis"
	S.name = "Impact Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Impact"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.impact.spatial_index" }
	S.tags = { "n", "impact", "analyzer", "vfx" }
	S.description = "Impact Analysis: cost, overdraw and stability analysis of the effect for the Impact subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.impact.analysis", window = 105, buckets = 13, threshold = 3.70 })
		inst.system = S
		inst.ctx = ctx
