-- ARKHER SYSTEM VB.0250 :: Vegetation Field Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0250"
	S.key = "arkher.conttime.vegfield.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vegfield.complexity_budget" }
	S.tags = { "vb", "vegfield", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.vegfield.simulation_fabric", budgetMs = 2.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
