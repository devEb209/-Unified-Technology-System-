-- ARKHER SYSTEM H.0551 :: Cloth Simulation Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0551"
	S.key = "arkher.physics.cloth.query"
	S.name = "Cloth Simulation Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.cloth.constraint_solver" }
	S.tags = { "h", "cloth", "raycaster", "physics" }
	S.description = "Cloth Simulation Query: rays, sweeps and overlaps against the simulation for the Cloth Simulation subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.cloth.query", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
