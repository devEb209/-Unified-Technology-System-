-- ARKHER SYSTEM Z.0337 :: Cross Reality Sync Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0337"
	S.key = "arkher.origin.crossreality.behaviour_analysis"
	S.name = "Cross Reality Sync Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.governance_policy" }
	S.tags = { "z", "crossreality", "analyzer", "origin" }
	S.description = "Cross Reality Sync Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.crossreality.behaviour_analysis", window = 165, buckets = 17, threshold = 4.70 })
		inst.system = S
		inst.ctx = ctx
