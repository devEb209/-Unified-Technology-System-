-- ARKHER SYSTEM O.0425 :: Audio Profiling Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0425"
	S.key = "arkher.audio.audioprofiling.voice_budget"
	S.name = "Audio Profiling Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audioprofiling.music_sequencer" }
	S.tags = { "o", "audioprofiling", "budgeter", "audio" }
	S.description = "Audio Profiling Voice Budget: voice slots allocated by priority and audibility for the Audio Profiling subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.audioprofiling.voice_budget", total = 146, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
