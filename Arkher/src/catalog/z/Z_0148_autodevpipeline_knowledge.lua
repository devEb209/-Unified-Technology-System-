-- ARKHER SYSTEM Z.0148 :: Autonomous Development Pipeline Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0148"
	S.key = "arkher.origin.autodevpipeline.semantic_graph"
	S.name = "Autonomous Development Pipeline Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodevpipeline.world_architect" }
	S.tags = { "z", "autodevpipeline", "knowledge", "origin" }
	S.description = "Autonomous Development Pipeline Semantic Graph: typed entities and inferred relations of the technology itself for the Autonomous Development Pipeline subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.autodevpipeline.semantic_graph", dims = 24 })
		inst.system = S
		inst.ctx = ctx
