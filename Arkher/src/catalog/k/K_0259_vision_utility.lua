-- ARKHER SYSTEM K.0259 :: Vision Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0259"
	S.key = "arkher.npc.vision.utility_reasoning"
	S.name = "Vision Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.vision.reactive_behaviour" }
	S.tags = { "k", "vision", "utility", "npc" }
	S.description = "Vision Utility Reasoning: scored option selection with response curves for the Vision subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.vision.utility_reasoning", momentum = 0.19 })
		inst.system = S
		inst.ctx = ctx
