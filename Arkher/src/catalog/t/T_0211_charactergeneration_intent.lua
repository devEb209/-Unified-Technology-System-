-- ARKHER SYSTEM T.0211 :: Character Generation Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0211"
	S.key = "arkher.ai.charactergeneration.intent_understanding"
	S.name = "Character Generation Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "charactergeneration", "intent", "ai" }
	S.description = "Character Generation Intent Understanding: natural language turned into an actionable, scored intent for the Character Generation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.charactergeneration.intent_understanding", minConfidence = 0.41 })
		inst.system = S
		inst.ctx = ctx
