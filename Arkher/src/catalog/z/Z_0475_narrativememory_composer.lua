-- ARKHER SYSTEM Z.0475 :: Narrative Memory Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0475"
	S.key = "arkher.origin.narrativememory.signal_composition"
	S.name = "Narrative Memory Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.telemetry_ledger" }
	S.tags = { "z", "narrativememory", "composer", "origin" }
	S.description = "Narrative Memory Signal Composition: blending of the technology's input signals into one output for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.narrativememory.signal_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
