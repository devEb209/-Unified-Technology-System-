-- ARKHER SYSTEM K.0578 :: Idle Behaviour Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0578"
	S.key = "arkher.npc.idlebehaviour.emotion"
	S.name = "Idle Behaviour Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.idlebehaviour.drive_system" }
	S.tags = { "k", "idlebehaviour", "emotion", "npc" }
	S.description = "Idle Behaviour Emotion: appraisal of events into valence, arousal and mood for the Idle Behaviour subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.idlebehaviour.emotion", inertia = 0.90, decayRate = 0.25, baselineArousal = 0.25 })
		inst.system = S
		inst.ctx = ctx
