-- ARKHER SYSTEM K.0416 :: Interruption Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0416"
	S.key = "arkher.npc.interruption.crowd_steering"
	S.name = "Interruption Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.interruption.navigation" }
	S.tags = { "k", "interruption", "crowd", "npc" }
	S.description = "Interruption Crowd Steering: local avoidance, cohesion and arrival at scale for the Interruption subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.interruption.crowd_steering", radius = 0.60, maxSpeed = 3.40, cellSize = 10 })
		inst.system = S
		inst.ctx = ctx
