-- ARKHER SYSTEM G.0272 :: Quality Estimation Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0272"
	S.key = "arkher.neural.qualityestimate.weight_codec"
	S.name = "Quality Estimation Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.qualityestimate.model_registry" }
	S.tags = { "g", "qualityestimate", "codec", "neural" }
	S.description = "Quality Estimation Weight Codec: weight serialization and quantized transport for the Quality Estimation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.qualityestimate.weight_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
