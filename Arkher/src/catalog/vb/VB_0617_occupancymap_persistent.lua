-- ARKHER SYSTEM VB.0617 :: Occupancy Map Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0617"
	S.key = "arkher.conttime.occupancymap.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.occupancymap.multi-scale_fidelity" }
	S.tags = { "vb", "occupancymap", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.occupancymap.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
