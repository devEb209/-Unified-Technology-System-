-- ARKHER SYSTEM L.0477 :: Faction Politics Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0477"
	S.key = "arkher.sim.factionpolitics.aggregate_cache"
	S.name = "Faction Politics Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.factionpolitics.fidelity_policy" }
	S.tags = { "l", "factionpolitics", "cache", "sim" }
	S.description = "Faction Politics Aggregate Cache: reuse of expensive aggregate computations for the Faction Politics subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.factionpolitics.aggregate_cache", policy = "lru", capacity = 255, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
