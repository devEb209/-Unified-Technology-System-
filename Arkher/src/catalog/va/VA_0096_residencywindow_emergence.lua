-- ARKHER SYSTEM VA.0096 :: Residency Window Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0096"
	S.key = "arkher.contworld.residencywindow.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.residencywindow.reality_continuum" }
	S.tags = { "va", "residencywindow", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.residencywindow.emergence_continuum", windowSize = 7, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
