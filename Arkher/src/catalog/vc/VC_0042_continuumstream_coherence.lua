-- ARKHER SYSTEM VC.0042 :: Continuum Stream Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0042"
	S.key = "arkher.contneural.continuumstream.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.continuumstream.persistent_state" }
	S.tags = { "vc", "continuumstream", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.continuumstream.coherence_guard", window = 49, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
