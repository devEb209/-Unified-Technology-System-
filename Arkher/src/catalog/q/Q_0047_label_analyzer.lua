-- ARKHER SYSTEM Q.0047 :: Label Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0047"
	S.key = "arkher.ui.label.usability_analysis"
	S.name = "Label Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Label"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.label.frame_budget" }
	S.tags = { "q", "label", "analyzer", "ui" }
	S.description = "Label Usability Analysis: reachability, latency and abandonment analysis for the Label subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.label.usability_analysis", window = 51, buckets = 15, threshold = 3.30 })
		inst.system = S
		inst.ctx = ctx
