-- ARKHER SYSTEM VA.0543 :: World Fabric Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0543"
	S.key = "arkher.contworld.worldfabric.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldfabric.epoch_clock" }
	S.tags = { "va", "worldfabric", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.worldfabric.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
