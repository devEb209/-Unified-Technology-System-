-- ARKHER SYSTEM E.0191 :: Anisotropy Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0191"
	S.key = "arkher.material.anisotropy.instance_cache"
	S.name = "Anisotropy Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Anisotropy"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.anisotropy.quality_policy" }
	S.tags = { "e", "anisotropy", "cache", "material" }
	S.description = "Anisotropy Instance Cache: resolved-parameter cache keyed by context for the Anisotropy subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.anisotropy.instance_cache", policy = "ttl", capacity = 375, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
