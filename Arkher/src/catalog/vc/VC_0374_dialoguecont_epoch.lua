-- ARKHER SYSTEM VC.0374 :: Dialogue Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0374"
	S.key = "arkher.contneural.dialoguecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.dialoguecont.infinite_grid" }
	S.tags = { "vc", "dialoguecont", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.dialoguecont.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
