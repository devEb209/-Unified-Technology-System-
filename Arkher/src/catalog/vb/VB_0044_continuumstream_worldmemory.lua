-- ARKHER SYSTEM VB.0044 :: Continuum Stream World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0044"
	S.key = "arkher.conttime.continuumstream.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.continuumstream.neural_field" }
	S.tags = { "vb", "continuumstream", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.continuumstream.world_memory_stream", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
