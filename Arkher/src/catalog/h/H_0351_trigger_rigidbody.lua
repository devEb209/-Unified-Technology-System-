-- ARKHER SYSTEM H.0351 :: Trigger Volume Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0351"
	S.key = "arkher.physics.trigger.body_dynamics"
	S.name = "Trigger Volume Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "trigger", "rigidbody", "physics" }
	S.description = "Trigger Volume Body Dynamics: integration, impulses, damping and sleeping of a body for the Trigger Volume subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.trigger.body_dynamics", mass = 30.00, radius = 0.75, restitution = 0.49, friction = 0.59, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
