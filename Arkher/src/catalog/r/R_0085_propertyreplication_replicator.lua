-- ARKHER SYSTEM R.0085 :: Property Replication Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0085"
	S.key = "arkher.net.propertyreplication.replication"
	S.name = "Property Replication Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "propertyreplication", "replicator", "net" }
	S.description = "Property Replication Replication: authoritative entity state, interest and delta snapshots for the Property Replication subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.propertyreplication.replication", mtu = 1650, interestRadius = 240, fullEvery = 75 })
		inst.system = S
		inst.ctx = ctx
