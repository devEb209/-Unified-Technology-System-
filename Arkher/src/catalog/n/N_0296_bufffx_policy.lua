-- ARKHER SYSTEM N.0296 :: Buff Effect Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0296"
	S.key = "arkher.vfx.bufffx.quality_policy"
	S.name = "Buff Effect Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Buff Effect"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.bufffx.result_cache" }
	S.tags = { "n", "bufffx", "policy", "vfx" }
	S.description = "Buff Effect Quality Policy: distance and device driven fidelity bands for the Buff Effect subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.bufffx.quality_policy", algorithm = "edf", starvationGuard = 49 })
		inst.system = S
		inst.ctx = ctx
