-- ARKHER SYSTEM VD.0252 :: Vegetation Field Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0252"
	S.key = "arkher.contsim.vegfield.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vegfield.reality_continuum" }
	S.tags = { "vd", "vegfield", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.vegfield.emergence_continuum", windowSize = 4, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
