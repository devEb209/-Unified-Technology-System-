-- ARKHER SYSTEM G.0394 :: Fallback Heuristic Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0394"
	S.key = "arkher.neural.fallbackheuristic.feature_extraction"
	S.name = "Fallback Heuristic Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.fallbackheuristic.inference_core" }
	S.tags = { "g", "fallbackheuristic", "field", "neural" }
	S.description = "Fallback Heuristic Feature Extraction: signal features feeding the model for the Fallback Heuristic subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.fallbackheuristic.feature_extraction", seed = 36103, frequency = 0.0097, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
