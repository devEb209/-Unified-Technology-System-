-- ARKHER SYSTEM O.0172 :: City Audio Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0172"
	S.key = "arkher.audio.cityaudio.music_sequencer"
	S.name = "City Audio Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "City Audio"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.cityaudio.spatialization" }
	S.tags = { "o", "cityaudio", "sequencer", "audio" }
	S.description = "City Audio Music Sequencer: musical time, sections, stems, cues and quantized transitions for the City Audio subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.cityaudio.music_sequencer", bpm = 100, beatsPerBar = 4, intensity = 0.47 })
		inst.system = S
		inst.ctx = ctx
