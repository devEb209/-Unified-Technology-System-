-- ARKHER SYSTEM J.0141 :: Blinking Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0141"
	S.key = "arkher.character.blinking.budget_governor"
	S.name = "Blinking Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.blinking.variant_registry" }
	S.tags = { "j", "blinking", "budgeter", "character" }
	S.description = "Blinking Budget Governor: per-character cost allocation in a crowd for the Blinking subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.blinking.budget_governor", total = 313, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
