-- ARKHER SYSTEM VB.0167 :: Coherence Seam Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0167"
	S.key = "arkher.conttime.coherenceseam.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.coherenceseam.simulation_fabric" }
	S.tags = { "vb", "coherenceseam", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.coherenceseam.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
