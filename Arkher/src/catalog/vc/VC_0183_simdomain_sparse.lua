-- ARKHER SYSTEM VC.0183 :: Simulation Domain Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0183"
	S.key = "arkher.contneural.simdomain.sparse_residency"
	S.name = "Simulation Domain Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.simdomain.epoch_clock" }
	S.tags = { "vc", "simdomain", "sparse", "contneural" }
	S.description = "Simulation Domain Sparse Residency: sparse page residency with eviction and compression for the Simulation Domain subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.simdomain.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
