-- ARKHER SYSTEM VC.0240 :: City Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0240"
	S.key = "arkher.contneural.citycont.emergence_continuum"
	S.name = "City Continuum Emergence Continuum"
	S.category = "VC"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.citycont.reality_continuum" }
	S.tags = { "vc", "citycont", "emergence", "contneural" }
	S.description = "City Continuum Emergence Continuum: emergence detection over the continuum for the City Continuum subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.citycont.emergence_continuum", windowSize = 6, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
