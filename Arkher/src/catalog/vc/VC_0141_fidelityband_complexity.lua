-- ARKHER SYSTEM VC.0141 :: Fidelity Band Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0141"
	S.key = "arkher.contneural.fidelityband.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.fidelityband.world_memory_stream" }
	S.tags = { "vc", "fidelityband", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.fidelityband.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
