-- ARKHER SYSTEM Z.0449 :: Player Absence Simulation Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0449"
	S.key = "arkher.origin.playerabsence.intent_bridge"
	S.name = "Player Absence Simulation Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.semantic_graph" }
	S.tags = { "z", "playerabsence", "intent", "origin" }
	S.description = "Player Absence Simulation Intent Bridge: natural language control surface for the technology for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.playerabsence.intent_bridge", minConfidence = 0.33 })
		inst.system = S
		inst.ctx = ctx
