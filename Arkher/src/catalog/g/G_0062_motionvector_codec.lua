-- ARKHER SYSTEM G.0062 :: Motion Vector Estimation Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0062"
	S.key = "arkher.neural.motionvector.weight_codec"
	S.name = "Motion Vector Estimation Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.motionvector.model_registry" }
	S.tags = { "g", "motionvector", "codec", "neural" }
	S.description = "Motion Vector Estimation Weight Codec: weight serialization and quantized transport for the Motion Vector Estimation subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.motionvector.weight_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
