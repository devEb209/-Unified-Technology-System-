-- ARKHER SYSTEM F.0251 :: Reflection Probe Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0251"
	S.key = "arkher.render.reflectionprobe.orchestration"
	S.name = "Reflection Probe Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.reflectionprobe.frame_analysis" }
	S.tags = { "f", "reflectionprobe", "orchestrator", "render" }
	S.description = "Reflection Probe Orchestration: frame lifecycle orchestration for the Reflection Probe subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.reflectionprobe.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
