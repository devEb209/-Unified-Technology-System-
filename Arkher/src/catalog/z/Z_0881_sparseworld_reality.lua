-- ARKHER SYSTEM Z.0881 :: Sparse World Representation Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0881"
	S.key = "arkher.origin.sparseworld.reality_layering"
	S.name = "Sparse World Representation Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "sparseworld", "reality", "origin" }
	S.description = "Sparse World Representation Reality Layering: stacked authored, simulated, proposed and player realities for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.sparseworld.reality_layering" })
		inst.system = S
		inst.ctx = ctx
