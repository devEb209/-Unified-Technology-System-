-- ARKHER SYSTEM VA.0043 :: Continuum Stream Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0043"
	S.key = "arkher.contworld.continuumstream.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.continuumstream.coherence_guard" }
	S.tags = { "va", "continuumstream", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.continuumstream.neural_field", dims = 12, hidden = 8, seed = 48600 })
		inst.system = S
		inst.ctx = ctx
