-- ARKHER SYSTEM VB.0515 :: Material Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0515"
	S.key = "arkher.conttime.materialcont.reality_continuum"
	S.name = "Material Continuum Reality Continuum"
	S.category = "VB"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.materialcont.simulation_fabric" }
	S.tags = { "vb", "materialcont", "reality", "conttime" }
	S.description = "Material Continuum Reality Continuum: stacked reality layers of the continuum for the Material Continuum subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.materialcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
