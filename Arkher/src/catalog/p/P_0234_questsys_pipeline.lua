-- ARKHER SYSTEM P.0234 :: Quest Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0234"
	S.key = "arkher.play.questsys.rule_pipeline"
	S.name = "Quest Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Quest"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.questsys.state_machine" }
	S.tags = { "p", "questsys", "pipeline", "play" }
	S.description = "Quest Rule Pipeline: ordered rules applied to every gameplay event for the Quest subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.questsys.rule_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
