-- ARKHER SYSTEM E.0598 :: Material Migration Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0598"
	S.key = "arkher.material.migration.authoring_pipeline"
	S.name = "Material Migration Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.migration.analysis" }
	S.tags = { "e", "migration", "pipeline", "material" }
	S.description = "Material Migration Authoring Pipeline: ordered authoring and bake stages for the Material Migration subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.migration.authoring_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
