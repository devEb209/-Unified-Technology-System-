-- ARKHER SYSTEM H.0193 :: Island Solver Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0193"
	S.key = "arkher.physics.island.result_cache"
	S.name = "Island Solver Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.island.simulation_policy" }
	S.tags = { "h", "island", "cache", "physics" }
	S.description = "Island Solver Result Cache: reuse of expensive simulation and query results for the Island Solver subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.island.result_cache", policy = "ttl", capacity = 142, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
