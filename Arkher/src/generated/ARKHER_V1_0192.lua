...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Terragen Sky — CORE Mixer #0192", size=Vector2.new(600, 460), pos=UDim2.fromOffset(196, 224), parent=parent, icon="◣"})
