-- ARKHER SYSTEM VD.0557 :: Device Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0557"
	S.key = "arkher.contsim.devicecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.devicecont.multi-scale_fidelity" }
	S.tags = { "vd", "devicecont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.devicecont.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
