-- ARKHER SYSTEM P.0058 :: Talent Tree Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0058"
	S.key = "arkher.play.talenttree.content_registry"
	S.name = "Talent Tree Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Talent Tree"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.talenttree.difficulty_controller" }
	S.tags = { "p", "talenttree", "registry", "play" }
	S.description = "Talent Tree Content Registry: catalogue of the definitions this loop instantiates for the Talent Tree subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.talenttree.content_registry" })
		inst.system = S
		inst.ctx = ctx
