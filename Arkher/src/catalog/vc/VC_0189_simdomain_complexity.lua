-- ARKHER SYSTEM VC.0189 :: Simulation Domain Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0189"
	S.key = "arkher.contneural.simdomain.complexity_budget"
	S.name = "Simulation Domain Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.simdomain.world_memory_stream" }
	S.tags = { "vc", "simdomain", "complexity", "contneural" }
	S.description = "Simulation Domain Complexity Budget: complexity budgeting for the continuum for the Simulation Domain subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.simdomain.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
