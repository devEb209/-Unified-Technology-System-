-- ARKHER SYSTEM V.0189 :: Scene Asset Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0189"
	S.key = "arkher.asset.sceneasset.size_budget"
	S.name = "Scene Asset Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.sceneasset.compression_codec" }
	S.tags = { "v", "sceneasset", "budgeter", "asset" }
	S.description = "Scene Asset Size Budget: byte budget shared between competing asset classes for the Scene Asset subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.sceneasset.size_budget", total = 91, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
