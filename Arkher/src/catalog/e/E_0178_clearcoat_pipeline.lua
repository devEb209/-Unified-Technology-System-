-- ARKHER SYSTEM E.0178 :: Clear Coat Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0178"
	S.key = "arkher.material.clearcoat.authoring_pipeline"
	S.name = "Clear Coat Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Clear Coat"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.clearcoat.analysis" }
	S.tags = { "e", "clearcoat", "pipeline", "material" }
	S.description = "Clear Coat Authoring Pipeline: ordered authoring and bake stages for the Clear Coat subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.clearcoat.authoring_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
