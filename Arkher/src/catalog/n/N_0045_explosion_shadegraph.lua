-- ARKHER SYSTEM N.0045 :: Explosion Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0045"
	S.key = "arkher.vfx.explosion.effect_graph"
	S.name = "Explosion Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Explosion"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.explosion.curve_authoring" }
	S.tags = { "n", "explosion", "shadegraph", "vfx" }
	S.description = "Explosion Effect Graph: node graph describing how the effect is shaded for the Explosion subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.explosion.effect_graph" })
		inst.system = S
		inst.ctx = ctx
