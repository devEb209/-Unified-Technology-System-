-- ARKHER SYSTEM I.0093 :: Clip Looping Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0093"
	S.key = "arkher.anim.cliploop.clip_sampling"
	S.name = "Clip Looping Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Looping"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.cliploop.skeleton" }
	S.tags = { "i", "cliploop", "clip", "anim" }
	S.description = "Clip Looping Clip Sampling: keyframe tracks sampled, retimed and evented for the Clip Looping subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.cliploop.clip_sampling", duration = 2.30, loop = true })
		inst.system = S
		inst.ctx = ctx
