-- ARKHER SYSTEM E.0131 :: Emissive Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0131"
	S.key = "arkher.material.emissive.instance_cache"
	S.name = "Emissive Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Emissive"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.emissive.quality_policy" }
	S.tags = { "e", "emissive", "cache", "material" }
	S.description = "Emissive Instance Cache: resolved-parameter cache keyed by context for the Emissive subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.emissive.instance_cache", policy = "lru", capacity = 507, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
