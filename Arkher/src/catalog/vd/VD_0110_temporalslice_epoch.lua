-- ARKHER SYSTEM VD.0110 :: Temporal Slice Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0110"
	S.key = "arkher.contsim.temporalslice.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.temporalslice.infinite_grid" }
	S.tags = { "vd", "temporalslice", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.temporalslice.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
