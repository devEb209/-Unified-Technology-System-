-- ARKHER SYSTEM L.0207 :: Predation Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0207"
	S.key = "arkher.sim.predation.aggregate_cache"
	S.name = "Predation Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.predation.fidelity_policy" }
	S.tags = { "l", "predation", "cache", "sim" }
	S.description = "Predation Aggregate Cache: reuse of expensive aggregate computations for the Predation subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.predation.aggregate_cache", policy = "lru", capacity = 349, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
