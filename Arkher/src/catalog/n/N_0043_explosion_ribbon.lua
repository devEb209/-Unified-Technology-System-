-- ARKHER SYSTEM N.0043 :: Explosion Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0043"
	S.key = "arkher.vfx.explosion.ribbon_and_trail"
	S.name = "Explosion Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Explosion"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.explosion.force_field" }
	S.tags = { "n", "explosion", "ribbon", "vfx" }
	S.description = "Explosion Ribbon And Trail: trail points, tapering, beams and decimation for the Explosion subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.explosion.ribbon_and_trail", maxPoints = 32, lifetime = 2.30, minDistance = 0.50, width = 0.40 })
		inst.system = S
		inst.ctx = ctx
