-- ARKHER SYSTEM W.0280 :: Depth Of Field Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0280"
	S.key = "arkher.cine.depthoffield.shot_composition"
	S.name = "Depth Of Field Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.depthoffield.colour_grade" }
	S.tags = { "w", "depthoffield", "composer", "cine" }
	S.description = "Depth Of Field Shot Composition: blending of the signals that make up the final shot for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.depthoffield.shot_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
