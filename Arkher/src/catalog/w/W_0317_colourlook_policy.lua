-- ARKHER SYSTEM W.0317 :: Colour Look Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0317"
	S.key = "arkher.cine.colourlook.cut_policy"
	S.name = "Colour Look Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Colour Look"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.colourlook.shot_composition" }
	S.tags = { "w", "colourlook", "policy", "cine" }
	S.description = "Colour Look Cut Policy: rules deciding when the sequence cuts and to what for the Colour Look subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.colourlook.cut_policy", algorithm = "wfq", starvationGuard = 54 })
		inst.system = S
		inst.ctx = ctx
