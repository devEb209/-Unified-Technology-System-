-- ARKHER SYSTEM H.0047 :: Mass Properties Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0047"
	S.key = "arkher.physics.massproperties.query"
	S.name = "Mass Properties Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.massproperties.constraint_solver" }
	S.tags = { "h", "massproperties", "raycaster", "physics" }
	S.description = "Mass Properties Query: rays, sweeps and overlaps against the simulation for the Mass Properties subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.massproperties.query", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
