-- ARKHER SYSTEM J.0058 :: Eyes Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0058"
	S.key = "arkher.character.eyes.blend_controller"
	S.name = "Eyes Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.eyes.motion_set" }
	S.tags = { "j", "eyes", "animator", "character" }
	S.description = "Eyes Blend Controller: layered playback driving the character for the Eyes subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.eyes.blend_controller", budget = 9 })
		inst.system = S
		inst.ctx = ctx
