-- ARKHER SYSTEM T.0335 :: Bug Triage Learning Analysis
...
return function(A)
	...
	local S = {}
	S.id = "T.0335"
	S.key = "arkher.ai.bugtriage.learning_analysis"
	S.name = "Bug Triage Learning Analysis"
	S.category = "T"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.bugtriage.model_inference" }
	S.tags = { "t", "bugtriage", "analyzer", "ai" }
	S.description = "Bug Triage Learning Analysis: trend, anomaly and improvement analysis of the agent for the Bug Triage subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ai.bugtriage.learning_analysis", window = 146, buckets = 14, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
