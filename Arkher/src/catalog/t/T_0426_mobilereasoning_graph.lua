-- ARKHER SYSTEM T.0426 :: Mobile Reasoning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0426"
	S.key = "arkher.ai.mobilereasoning.reasoning_graph"
	S.name = "Mobile Reasoning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.mobilereasoning.world_architect" }
	S.tags = { "t", "mobilereasoning", "graph", "ai" }
	S.description = "Mobile Reasoning Reasoning Graph: relationship modelling and shortest-path reasoning for the Mobile Reasoning subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.mobilereasoning.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
