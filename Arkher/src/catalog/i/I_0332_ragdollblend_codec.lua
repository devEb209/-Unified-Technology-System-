-- ARKHER SYSTEM I.0332 :: Ragdoll Blend Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0332"
	S.key = "arkher.anim.ragdollblend.compression_codec"
	S.name = "Ragdoll Blend Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.ragdollblend.retarget_graph" }
	S.tags = { "i", "ragdollblend", "codec", "anim" }
	S.description = "Ragdoll Blend Compression Codec: curve compression and quantized transport for the Ragdoll Blend subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.ragdollblend.compression_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
