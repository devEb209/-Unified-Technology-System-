-- ARKHER SYSTEM VC.0088 :: Residency Window Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VC.0088"
	S.key = "arkher.contneural.residencywindow.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.residencywindow.sparse_residency" }
	S.tags = { "vc", "residencywindow", "multiscale", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contneural.residencywindow.multi-scale_fidelity", levels = 5, baseTriangles = 75000 })
		inst.system = S
		inst.ctx = ctx
