-- ARKHER SYSTEM Z.0329 :: Cross Reality Sync Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0329"
	S.key = "arkher.origin.crossreality.intent_bridge"
	S.name = "Cross Reality Sync Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.semantic_graph" }
	S.tags = { "z", "crossreality", "intent", "origin" }
	S.description = "Cross Reality Sync Intent Bridge: natural language control surface for the technology for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.crossreality.intent_bridge", minConfidence = 0.41 })
		inst.system = S
		inst.ctx = ctx
