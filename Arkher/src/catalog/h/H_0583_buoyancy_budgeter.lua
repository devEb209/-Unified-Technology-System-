-- ARKHER SYSTEM H.0583 :: Buoyancy Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0583"
	S.key = "arkher.physics.buoyancy.budget_governor"
	S.name = "Buoyancy Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Buoyancy"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.buoyancy.broadphase_index" }
	S.tags = { "h", "buoyancy", "budgeter", "physics" }
	S.description = "Buoyancy Budget Governor: simulation time budget allocation across islands for the Buoyancy subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.buoyancy.budget_governor", total = 177, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
