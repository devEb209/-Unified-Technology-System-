-- ARKHER SYSTEM I.0061 :: Animation Clip Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0061"
	S.key = "arkher.anim.animclip.playback_pipeline"
	S.name = "Animation Clip Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animclip.event_ledger" }
	S.tags = { "i", "animclip", "pipeline", "anim" }
	S.description = "Animation Clip Playback Pipeline: ordered sample, blend, ik and output stages for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.animclip.playback_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
