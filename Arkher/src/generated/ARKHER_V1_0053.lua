--!strict
-- Neural DLSS — ANIMATION Map #0053
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Neural DLSS — ANIMATION Map #0053", size=Vector2.new(680, 480), pos=UDim2.fromOffset(389, 201), parent=parent, icon="↻"})
