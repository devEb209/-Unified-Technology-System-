-- ARKHER SYSTEM T.0642 :: Confidence Estimation Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0642"
	S.key = "arkher.ai.confidence.model_inference"
	S.name = "Confidence Estimation Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.confidence.action_planner" }
	S.tags = { "t", "confidence", "inference", "ai" }
	S.description = "Confidence Estimation Model Inference: quantized inference with batching and budget for the Confidence Estimation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.confidence.model_inference", seed = 82932 })
		inst.system = S
		inst.ctx = ctx
