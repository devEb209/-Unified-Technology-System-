-- ARKHER SYSTEM J.0195 :: Armor Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0195"
	S.key = "arkher.character.armor.variant_registry"
	S.name = "Armor Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.armor.appearance_composer" }
	S.tags = { "j", "armor", "registry", "character" }
	S.description = "Armor Variant Registry: named character variants and their lifecycle for the Armor subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.armor.variant_registry" })
		inst.system = S
		inst.ctx = ctx
