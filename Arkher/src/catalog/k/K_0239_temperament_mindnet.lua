-- ARKHER SYSTEM K.0239 :: Temperament Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0239"
	S.key = "arkher.npc.temperament.mind_network"
	S.name = "Temperament Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "temperament", "mindnet", "npc" }
	S.description = "Temperament Mind Network: the learned policy that turns perception into a decision for the Temperament subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.temperament.mind_network", inputs = 7, hidden = 7, seed = 36713, learningRate = 0.065, exploration = 0.025 })
		inst.system = S
		inst.ctx = ctx
