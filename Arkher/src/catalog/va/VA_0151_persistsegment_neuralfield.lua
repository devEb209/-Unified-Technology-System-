-- ARKHER SYSTEM VA.0151 :: Persistence Segment Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0151"
	S.key = "arkher.contworld.persistsegment.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.persistsegment.coherence_guard" }
	S.tags = { "va", "persistsegment", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.persistsegment.neural_field", dims = 20, hidden = 16, seed = 75186 })
		inst.system = S
		inst.ctx = ctx
