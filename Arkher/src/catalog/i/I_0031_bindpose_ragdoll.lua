-- ARKHER SYSTEM I.0031 :: Bind Pose Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0031"
	S.key = "arkher.anim.bindpose.physical_blend"
	S.name = "Bind Pose Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bind Pose"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bindpose.inverse_kinematics" }
	S.tags = { "i", "bindpose", "ragdoll", "anim" }
	S.description = "Bind Pose Physical Blend: physical bones blended against the animated pose for the Bind Pose subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.bindpose.physical_blend", blendSpeed = 3.30 })
		inst.system = S
		inst.ctx = ctx
