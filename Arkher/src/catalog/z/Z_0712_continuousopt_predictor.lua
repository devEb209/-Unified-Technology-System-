-- ARKHER SYSTEM Z.0712 :: Continuous Self Optimization Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0712"
	S.key = "arkher.origin.continuousopt.predictive_optimization"
	S.name = "Continuous Self Optimization Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.adaptive_workflow" }
	S.tags = { "z", "continuousopt", "predictor", "origin" }
	S.description = "Continuous Self Optimization Predictive Optimization: forecast-driven optimization before the cost is paid for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.continuousopt.predictive_optimization", method = "markov", alpha = 0.34, window = 112 })
		inst.system = S
		inst.ctx = ctx
