-- ARKHER SYSTEM V.0358 :: Manifest Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0358"
	S.key = "arkher.asset.assetmanifest.validation_guard"
	S.name = "Manifest Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetmanifest.size_budget" }
	S.tags = { "v", "assetmanifest", "guard", "asset" }
	S.description = "Manifest Validation Guard: rate limiting and capability checks on the import path for the Manifest subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.assetmanifest.validation_guard", algorithm = "leaky", capacity = 203, refillPerSec = 28, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
