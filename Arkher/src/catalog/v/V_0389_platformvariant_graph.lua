-- ARKHER SYSTEM V.0389 :: Platform Variant Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0389"
	S.key = "arkher.asset.platformvariant.dependency_graph"
	S.name = "Platform Variant Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.platformvariant.asset_registry" }
	S.tags = { "v", "platformvariant", "graph", "asset" }
	S.description = "Platform Variant Dependency Graph: what references what, and in which order it must be built for the Platform Variant subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.platformvariant.dependency_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
