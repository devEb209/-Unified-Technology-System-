-- ARKHER SYSTEM T.0442 :: Player Modelling Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0442"
	S.key = "arkher.ai.playermodelling.outcome_prediction"
	S.name = "Player Modelling Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.playermodelling.decision_policy" }
	S.tags = { "t", "playermodelling", "predictor", "ai" }
	S.description = "Player Modelling Outcome Prediction: forecasting the result before the work is done for the Player Modelling subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.playermodelling.outcome_prediction", method = "ema", alpha = 0.31, window = 101 })
		inst.system = S
		inst.ctx = ctx
