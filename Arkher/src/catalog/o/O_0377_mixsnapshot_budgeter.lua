-- ARKHER SYSTEM O.0377 :: Mix Snapshot Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0377"
	S.key = "arkher.audio.mixsnapshot.voice_budget"
	S.name = "Mix Snapshot Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mix Snapshot"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mixsnapshot.music_sequencer" }
	S.tags = { "o", "mixsnapshot", "budgeter", "audio" }
	S.description = "Mix Snapshot Voice Budget: voice slots allocated by priority and audibility for the Mix Snapshot subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.mixsnapshot.voice_budget", total = 355, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
