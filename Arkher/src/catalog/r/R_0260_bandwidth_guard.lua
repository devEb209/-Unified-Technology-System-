-- ARKHER SYSTEM R.0260 :: Bandwidth Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0260"
	S.key = "arkher.net.bandwidth.rate_guard"
	S.name = "Bandwidth Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Bandwidth"
	S.aspect = "Rate Guard"
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.bandwidth.interest_streaming" }
	S.tags = { "r", "bandwidth", "guard", "net" }
	S.description = "Bandwidth Rate Guard: token-bucket protection against floods and abuse for the Bandwidth subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.bandwidth.rate_guard", algorithm = "token", capacity = 113, refillPerSec = 38, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
