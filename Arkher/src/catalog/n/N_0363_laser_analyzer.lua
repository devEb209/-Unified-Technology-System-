-- ARKHER SYSTEM N.0363 :: Laser Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0363"
	S.key = "arkher.vfx.laser.analysis"
	S.name = "Laser Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Laser"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.laser.spatial_index" }
	S.tags = { "n", "laser", "analyzer", "vfx" }
	S.description = "Laser Analysis: cost, overdraw and stability analysis of the effect for the Laser subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.laser.analysis", window = 200, buckets = 16, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
