-- ARKHER SYSTEM H.0136 :: Torque Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0136"
	S.key = "arkher.physics.torque.simulation_policy"
	S.name = "Torque Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Torque"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.torque.budget_governor" }
	S.tags = { "h", "torque", "policy", "physics" }
	S.description = "Torque Simulation Policy: device tier rules for substeps, iterations and sleep for the Torque subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.torque.simulation_policy", algorithm = "edf", starvationGuard = 37 })
		inst.system = S
		inst.ctx = ctx
