-- ARKHER SYSTEM F.0287 :: Color Grading Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0287"
	S.key = "arkher.render.grading.temporal_resolve"
	S.name = "Color Grading Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.grading.probe_volume" }
	S.tags = { "f", "grading", "temporal", "render" }
	S.description = "Color Grading Temporal Resolve: history reprojection with neighbourhood clamping for the Color Grading subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.grading.temporal_resolve", feedback = 0.91, phase = 8 })
		inst.system = S
		inst.ctx = ctx
