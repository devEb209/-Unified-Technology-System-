-- ARKHER SYSTEM VD.0166 :: Coherence Seam Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0166"
	S.key = "arkher.contsim.coherenceseam.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.coherenceseam.complexity_budget" }
	S.tags = { "vd", "coherenceseam", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.coherenceseam.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
