-- ARKHER SYSTEM H.0115 :: Impulse Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0115"
	S.key = "arkher.physics.impulse.contact_generation"
	S.name = "Impulse Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Impulse"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.impulse.collision_shape" }
	S.tags = { "h", "impulse", "contact", "physics" }
	S.description = "Impulse Contact Generation: narrow-phase manifolds with normal, depth and point for the Impulse subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.impulse.contact_generation", slop = 0.0050, maxManifolds = 206 })
		inst.system = S
		inst.ctx = ctx
