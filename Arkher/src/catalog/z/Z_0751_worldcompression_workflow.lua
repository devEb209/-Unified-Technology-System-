-- ARKHER SYSTEM Z.0751 :: World Compression Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0751"
	S.key = "arkher.origin.worldcompression.adaptive_workflow"
	S.name = "World Compression Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.self_critique" }
	S.tags = { "z", "worldcompression", "workflow", "origin" }
	S.description = "World Compression Adaptive Workflow: verified, retryable, reversible execution plans for the World Compression subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.worldcompression.adaptive_workflow", maxRetries = 1, budget = 130 })
		inst.system = S
		inst.ctx = ctx
