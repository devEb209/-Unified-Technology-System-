-- ARKHER SYSTEM R.0109 :: Remote Function Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0109"
	S.key = "arkher.net.remotefunction.replication"
	S.name = "Remote Function Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "remotefunction", "replicator", "net" }
	S.description = "Remote Function Replication: authoritative entity state, interest and delta snapshots for the Remote Function subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.remotefunction.replication", mtu = 1050, interestRadius = 320, fullEvery = 75 })
		inst.system = S
		inst.ctx = ctx
