-- ARKHER SYSTEM N.0021 :: Smoke Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0021"
	S.key = "arkher.vfx.smoke.spawn_budget"
	S.name = "Smoke Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Smoke"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.smoke.effect_composition" }
	S.tags = { "n", "smoke", "budgeter", "vfx" }
	S.description = "Smoke Spawn Budget: global particle budget shared by every live effect for the Smoke subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.smoke.spawn_budget", total = 382, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
