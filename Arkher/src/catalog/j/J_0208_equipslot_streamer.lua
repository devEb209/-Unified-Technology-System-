-- ARKHER SYSTEM J.0208 :: Equipment Slot Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0208"
	S.key = "arkher.character.equipslot.streaming"
	S.name = "Equipment Slot Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.equipslot.budget_governor" }
	S.tags = { "j", "equipslot", "streamer", "character" }
	S.description = "Equipment Slot Streaming: distance-driven residency of character data for the Equipment Slot subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.equipslot.streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
