...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="DaVinci Pages — CORE Stack #0140", size=Vector2.new(680, 420), pos=UDim2.fromOffset(320, 120), parent=parent, icon="⬢"})
