-- ARKHER SYSTEM G.0471 :: Training Data Synthesis Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0471"
	S.key = "arkher.neural.datasynth.result_cache"
	S.name = "Training Data Synthesis Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.datasynth.compute_budget" }
	S.tags = { "g", "datasynth", "cache", "neural" }
	S.description = "Training Data Synthesis Result Cache: cached inference results keyed by input for the Training Data Synthesis subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.datasynth.result_cache", policy = "lfu", capacity = 385, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
