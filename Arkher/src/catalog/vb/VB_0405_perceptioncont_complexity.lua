-- ARKHER SYSTEM VB.0405 :: Perception Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0405"
	S.key = "arkher.conttime.perceptioncont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.perceptioncont.world_memory_stream" }
	S.tags = { "vb", "perceptioncont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.perceptioncont.complexity_budget", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
