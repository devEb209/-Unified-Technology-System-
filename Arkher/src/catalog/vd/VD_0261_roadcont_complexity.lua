-- ARKHER SYSTEM VD.0261 :: Road Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0261"
	S.key = "arkher.contsim.roadcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.roadcont.world_memory_stream" }
	S.tags = { "vd", "roadcont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.roadcont.complexity_budget", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
