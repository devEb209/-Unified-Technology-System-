-- ARKHER SYSTEM K.0113 :: Forgetting Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0113"
	S.key = "arkher.npc.forgetting.mind_network"
	S.name = "Forgetting Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "forgetting", "mindnet", "npc" }
	S.description = "Forgetting Mind Network: the learned policy that turns perception into a decision for the Forgetting subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.forgetting.mind_network", inputs = 9, hidden = 8, seed = 36319, learningRate = 0.095, exploration = 0.055 })
		inst.system = S
		inst.ctx = ctx
