-- ARKHER SYSTEM P.0419 :: Team Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0419"
	S.key = "arkher.play.team.save_codec"
	S.name = "Team Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Team"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.team.content_registry" }
	S.tags = { "p", "team", "codec", "play" }
	S.description = "Team Save Codec: persistence, diffing and checksum of gameplay state for the Team subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.team.save_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
