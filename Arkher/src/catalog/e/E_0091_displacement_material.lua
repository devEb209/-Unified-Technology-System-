-- ARKHER SYSTEM E.0091 :: Height Displacement Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0091"
	S.key = "arkher.material.displacement.definition"
	S.name = "Height Displacement Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "displacement", "material", "material" }
	S.description = "Height Displacement Definition: layered PBR definition resolved into parameters for the Height Displacement subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.displacement.definition", texelBudget = 1310720 })
		inst.system = S
		inst.ctx = ctx
