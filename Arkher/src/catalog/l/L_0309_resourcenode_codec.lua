-- ARKHER SYSTEM L.0309 :: Resource Node State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0309"
	S.key = "arkher.sim.resourcenode.state_codec"
	S.name = "Resource Node State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.resourcenode.history_ledger" }
	S.tags = { "l", "resourcenode", "codec", "sim" }
	S.description = "Resource Node State Codec: persistence, diffing and checksum of the world state for the Resource Node subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.resourcenode.state_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
