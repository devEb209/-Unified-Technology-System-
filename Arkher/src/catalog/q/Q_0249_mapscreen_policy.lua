-- ARKHER SYSTEM Q.0249 :: Map Screen Accessibility Policy
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0249"
	S.key = "arkher.ui.mapscreen.accessibility_policy"
	S.name = "Map Screen Accessibility Policy"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Map Screen"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.mapscreen.interaction_ledger" }
	S.tags = { "q", "mapscreen", "policy", "ui" }
	S.description = "Map Screen Accessibility Policy: rules enforcing contrast, target size and motion limits for the Map Screen subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ui.mapscreen.accessibility_policy", algorithm = "lottery", starvationGuard = 35 })
		inst.system = S
		inst.ctx = ctx
