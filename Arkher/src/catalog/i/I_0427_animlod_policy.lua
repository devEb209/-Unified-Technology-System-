-- ARKHER SYSTEM I.0427 :: Animation LOD Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0427"
	S.key = "arkher.anim.animlod.quality_policy"
	S.name = "Animation LOD Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlod.pose_cache" }
	S.tags = { "i", "animlod", "policy", "anim" }
	S.description = "Animation LOD Quality Policy: device tier rules for rate, bones and solvers for the Animation LOD subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.animlod.quality_policy", algorithm = "roundrobin", starvationGuard = 28 })
		inst.system = S
		inst.ctx = ctx
