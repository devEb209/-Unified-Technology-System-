-- ARKHER SYSTEM VC.0608 :: Seam Lattice World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0608"
	S.key = "arkher.contneural.seamlattice.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.seamlattice.neural_field" }
	S.tags = { "vc", "seamlattice", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.seamlattice.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
