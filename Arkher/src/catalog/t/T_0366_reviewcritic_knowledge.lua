-- ARKHER SYSTEM T.0366 :: Review Critic Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0366"
	S.key = "arkher.ai.reviewcritic.semantic_knowledge"
	S.name = "Review Critic Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.reviewcritic.intent_understanding" }
	S.tags = { "t", "reviewcritic", "knowledge", "ai" }
	S.description = "Review Critic Semantic Knowledge: typed entities, weighted relations and inferred closure for the Review Critic subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.reviewcritic.semantic_knowledge", dims = 48 })
		inst.system = S
		inst.ctx = ctx
