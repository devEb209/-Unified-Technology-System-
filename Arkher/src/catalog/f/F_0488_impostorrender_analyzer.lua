-- ARKHER SYSTEM F.0488 :: Impostor Rendering Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0488"
	S.key = "arkher.render.impostorrender.frame_analysis"
	S.name = "Impostor Rendering Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.impostorrender.pass_cache" }
	S.tags = { "f", "impostorrender", "analyzer", "render" }
	S.description = "Impostor Rendering Frame Analysis: per-pass cost analysis and outlier detection for the Impostor Rendering subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.impostorrender.frame_analysis", window = 172, buckets = 16, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
