-- ARKHER SYSTEM N.0298 :: Buff Effect Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0298"
	S.key = "arkher.vfx.bufffx.analysis"
	S.name = "Buff Effect Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Buff Effect"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.bufffx.spatial_index" }
	S.tags = { "n", "bufffx", "analyzer", "vfx" }
	S.description = "Buff Effect Analysis: cost, overdraw and stability analysis of the effect for the Buff Effect subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.bufffx.analysis", window = 50, buckets = 14, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
