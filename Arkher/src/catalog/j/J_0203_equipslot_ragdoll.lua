-- ARKHER SYSTEM J.0203 :: Equipment Slot Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0203"
	S.key = "arkher.character.equipslot.physical_response"
	S.name = "Equipment Slot Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.equipslot.look_and_reach" }
	S.tags = { "j", "equipslot", "ragdoll", "character" }
	S.description = "Equipment Slot Physical Response: physical reaction, ragdoll and recovery for the Equipment Slot subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.equipslot.physical_response", blendSpeed = 5.50 })
		inst.system = S
		inst.ctx = ctx
