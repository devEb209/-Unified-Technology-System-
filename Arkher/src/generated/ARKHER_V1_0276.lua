--!strict
-- Anvil Cluster — CORE Node_Flow #0276
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Anvil Cluster — CORE Node_Flow #0276", size=Vector2.new(600, 440), pos=UDim2.fromOffset(488, 92), parent=parent, icon="▣"})
