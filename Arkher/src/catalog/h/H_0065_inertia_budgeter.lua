-- ARKHER SYSTEM H.0065 :: Inertia Tensor Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0065"
	S.key = "arkher.physics.inertia.budget_governor"
	S.name = "Inertia Tensor Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.inertia.broadphase_index" }
	S.tags = { "h", "inertia", "budgeter", "physics" }
	S.description = "Inertia Tensor Budget Governor: simulation time budget allocation across islands for the Inertia Tensor subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.inertia.budget_governor", total = 117, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
