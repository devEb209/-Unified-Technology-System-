-- ARKHER SYSTEM VA.0537 :: Pipeline Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0537"
	S.key = "arkher.contworld.pipelinecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.pipelinecont.world_memory_stream" }
	S.tags = { "va", "pipelinecont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.pipelinecont.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
