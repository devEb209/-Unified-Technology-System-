-- ARKHER SYSTEM Z.0370 :: Mobile First Governor Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0370"
	S.key = "arkher.origin.mobilefirst.self_critique"
	S.name = "Mobile First Governor Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.intent_bridge" }
	S.tags = { "z", "mobilefirst", "critic", "origin" }
	S.description = "Mobile First Governor Self Critique: weighted judgement of the technology's own output for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.mobilefirst.self_critique", passMark = 0.79, reviseMark = 0.44, seed = 42924 })
		inst.system = S
		inst.ctx = ctx
