-- ARKHER SYSTEM G.0076 :: Disocclusion Handling Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0076"
	S.key = "arkher.neural.disocclusion.weight_codec"
	S.name = "Disocclusion Handling Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.disocclusion.model_registry" }
	S.tags = { "g", "disocclusion", "codec", "neural" }
	S.description = "Disocclusion Handling Weight Codec: weight serialization and quantized transport for the Disocclusion Handling subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.disocclusion.weight_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
