-- ARKHER SYSTEM VC.0495 :: Rendering Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0495"
	S.key = "arkher.contneural.rendercont.sparse_residency"
	S.name = "Rendering Continuum Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.rendercont.epoch_clock" }
	S.tags = { "vc", "rendercont", "sparse", "contneural" }
	S.description = "Rendering Continuum Sparse Residency: sparse page residency with eviction and compression for the Rendering Continuum subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.rendercont.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
