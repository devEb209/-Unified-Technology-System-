-- ARKHER SYSTEM V.0067 :: Shader Asset Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0067"
	S.key = "arkher.asset.shaderasset.streaming_residency"
	S.name = "Shader Asset Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.shaderasset.content_cache" }
	S.tags = { "v", "shaderasset", "streamer", "asset" }
	S.description = "Shader Asset Streaming Residency: distance-driven load and unload of asset payloads for the Shader Asset subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.shaderasset.streaming_residency", radius = 320, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
