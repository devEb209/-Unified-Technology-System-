-- ARKHER SYSTEM P.0310 :: Ranged Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0310"
	S.key = "arkher.play.ranged.content_registry"
	S.name = "Ranged Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ranged"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ranged.difficulty_controller" }
	S.tags = { "p", "ranged", "registry", "play" }
	S.description = "Ranged Content Registry: catalogue of the definitions this loop instantiates for the Ranged subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.ranged.content_registry" })
		inst.system = S
		inst.ctx = ctx
