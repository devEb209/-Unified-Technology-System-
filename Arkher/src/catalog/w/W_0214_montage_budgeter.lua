-- ARKHER SYSTEM W.0214 :: Montage Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0214"
	S.key = "arkher.cine.montage.frame_budget"
	S.name = "Montage Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Montage"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.montage.event_ledger" }
	S.tags = { "w", "montage", "budgeter", "cine" }
	S.description = "Montage Frame Budget: per-frame cost budget for the cinematic systems for the Montage subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.montage.frame_budget", total = 353, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
