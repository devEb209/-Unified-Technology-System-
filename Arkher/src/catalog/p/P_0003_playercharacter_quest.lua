-- ARKHER SYSTEM P.0003 :: Player Character Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0003"
	S.key = "arkher.play.playercharacter.objectives"
	S.name = "Player Character Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playercharacter.inventory" }
	S.tags = { "p", "playercharacter", "quest", "play" }
	S.description = "Player Character Objectives: objectives, prerequisites, progress and rewards for the Player Character subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.playercharacter.objectives" })
		inst.system = S
		inst.ctx = ctx
