-- ARKHER SYSTEM E.0310 :: Dust Accumulation Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0310"
	S.key = "arkher.material.dust.quality_policy"
	S.name = "Dust Accumulation Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.dust.compression_codec" }
	S.tags = { "e", "dust", "policy", "material" }
	S.description = "Dust Accumulation Quality Policy: device tier rules for the surface for the Dust Accumulation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.dust.quality_policy", algorithm = "wfq", starvationGuard = 30 })
		inst.system = S
		inst.ctx = ctx
