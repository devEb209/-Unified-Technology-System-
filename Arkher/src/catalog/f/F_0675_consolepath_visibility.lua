-- ARKHER SYSTEM F.0675 :: Console Path Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0675"
	S.key = "arkher.render.consolepath.visibility_set"
	S.name = "Console Path Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Console Path"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.consolepath.view_and_culling" }
	S.tags = { "f", "consolepath", "visibility", "render" }
	S.description = "Console Path Visibility Set: cell, portal and occluder visibility for the Console Path subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.consolepath.visibility_set", maxDepth = 4 })
		inst.system = S
		inst.ctx = ctx
