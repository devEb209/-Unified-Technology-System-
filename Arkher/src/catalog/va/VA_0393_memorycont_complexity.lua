-- ARKHER SYSTEM VA.0393 :: Memory Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0393"
	S.key = "arkher.contworld.memorycont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memorycont.world_memory_stream" }
	S.tags = { "va", "memorycont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.memorycont.complexity_budget", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
