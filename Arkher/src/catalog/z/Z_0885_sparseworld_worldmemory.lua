-- ARKHER SYSTEM Z.0885 :: Sparse World Representation World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0885"
	S.key = "arkher.origin.sparseworld.world_memory"
	S.name = "Sparse World Representation World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.autonomous_pipeline" }
	S.tags = { "z", "sparseworld", "worldmemory", "origin" }
	S.description = "Sparse World Representation World Memory: epoch-stamped persistent history with compaction and checkpoints for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.sparseworld.world_memory", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
