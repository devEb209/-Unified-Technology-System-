-- ARKHER SYSTEM K.0467 :: Formation Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0467"
	S.key = "arkher.npc.formation.perception"
	S.name = "Formation Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.formation.emotion" }
	S.tags = { "k", "formation", "perception", "npc" }
	S.description = "Formation Perception: sight, hearing and bounded attention for the Formation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.formation.perception", sightRange = 45, hearingRange = 12, attentionSlots = 3, fov = 1.640 })
		inst.system = S
		inst.ctx = ctx
