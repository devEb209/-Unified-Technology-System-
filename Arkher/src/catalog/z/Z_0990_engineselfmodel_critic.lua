-- ARKHER SYSTEM Z.0990 :: Engine Self Model Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0990"
	S.key = "arkher.origin.engineselfmodel.self_critique"
	S.name = "Engine Self Model Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.engineselfmodel.intent_bridge" }
	S.tags = { "z", "engineselfmodel", "critic", "origin" }
	S.description = "Engine Self Model Self Critique: weighted judgement of the technology's own output for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.engineselfmodel.self_critique", passMark = 0.73, reviseMark = 0.43, seed = 46173 })
		inst.system = S
		inst.ctx = ctx
