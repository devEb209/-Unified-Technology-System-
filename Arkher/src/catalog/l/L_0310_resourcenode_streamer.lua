-- ARKHER SYSTEM L.0310 :: Resource Node Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0310"
	S.key = "arkher.sim.resourcenode.streaming"
	S.name = "Resource Node Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.resourcenode.state_codec" }
	S.tags = { "l", "resourcenode", "streamer", "sim" }
	S.description = "Resource Node Streaming: distance-driven residency of simulated regions for the Resource Node subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.resourcenode.streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
