--!strict
-- 3dsMax Stack — ANIMATION Mixer #0237
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="3dsMax Stack — ANIMATION Mixer #0237", size=Vector2.new(600, 460), pos=UDim2.fromOffset(381, 209), parent=parent, icon="♪"})
