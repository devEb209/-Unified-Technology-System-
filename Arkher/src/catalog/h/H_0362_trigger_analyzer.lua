-- ARKHER SYSTEM H.0362 :: Trigger Volume Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0362"
	S.key = "arkher.physics.trigger.analysis"
	S.name = "Trigger Volume Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.trigger.result_cache" }
	S.tags = { "h", "trigger", "analyzer", "physics" }
	S.description = "Trigger Volume Analysis: energy, jitter and cost analysis of the simulation for the Trigger Volume subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.trigger.analysis", window = 238, buckets = 10, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
