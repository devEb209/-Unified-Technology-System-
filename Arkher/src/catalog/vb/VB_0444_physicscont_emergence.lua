-- ARKHER SYSTEM VB.0444 :: Physics Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0444"
	S.key = "arkher.conttime.physicscont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.physicscont.reality_continuum" }
	S.tags = { "vb", "physicscont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.physicscont.emergence_continuum", windowSize = 6, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
