-- ARKHER SYSTEM R.0327 :: Matchmaking Transport Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0327"
	S.key = "arkher.net.matchmakingtransport.prediction_and_reconciliation"
	S.name = "Matchmaking Transport Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.matchmakingtransport.time_sync" }
	S.tags = { "r", "matchmakingtransport", "prediction", "net" }
	S.description = "Matchmaking Transport Prediction And Reconciliation: client simulation, correction and input replay for the Matchmaking Transport subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.matchmakingtransport.prediction_and_reconciliation", errorThreshold = 0.075, smoothing = 17.0, maxInputs = 120 })
		inst.system = S
		inst.ctx = ctx
