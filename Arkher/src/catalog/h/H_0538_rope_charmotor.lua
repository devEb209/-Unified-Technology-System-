-- ARKHER SYSTEM H.0538 :: Rope Simulation Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0538"
	S.key = "arkher.physics.rope.character_motion"
	S.name = "Rope Simulation Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rope.query" }
	S.tags = { "h", "rope", "charmotor", "physics" }
	S.description = "Rope Simulation Character Motion: capsule move-and-slide with slopes, steps and jumps for the Rope Simulation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.rope.character_motion", radius = 0.44, height = 1.69, maxSpeed = 4.90, jumpHeight = 2.10, stepOffset = 0.34 })
		inst.system = S
		inst.ctx = ctx
