-- ARKHER SYSTEM T.0341 :: Test Authoring World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0341"
	S.key = "arkher.ai.testauthoring.world_architect"
	S.name = "Test Authoring World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.testauthoring.self_critique" }
	S.tags = { "t", "testauthoring", "architect", "ai" }
	S.description = "Test Authoring World Architect: composition of a whole world plan with conserved budgets for the Test Authoring subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.testauthoring.world_architect", budget = 900, seed = 78993 })
		inst.system = S
		inst.ctx = ctx
