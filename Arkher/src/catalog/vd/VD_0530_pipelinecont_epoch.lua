-- ARKHER SYSTEM VD.0530 :: Pipeline Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0530"
	S.key = "arkher.contsim.pipelinecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.pipelinecont.infinite_grid" }
	S.tags = { "vd", "pipelinecont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.pipelinecont.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
