-- ARKHER SYSTEM Z.0825 :: Reality Blending World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0825"
	S.key = "arkher.origin.realityblending.world_memory"
	S.name = "Reality Blending World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.autonomous_pipeline" }
	S.tags = { "z", "realityblending", "worldmemory", "origin" }
	S.description = "Reality Blending World Memory: epoch-stamped persistent history with compaction and checkpoints for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.realityblending.world_memory", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
