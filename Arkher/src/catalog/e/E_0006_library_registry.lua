-- ARKHER SYSTEM E.0006 :: Material Library Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0006"
	S.key = "arkher.material.library.variant_registry"
	S.name = "Material Library Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.library.procedural_detail" }
	S.tags = { "e", "library", "registry", "material" }
	S.description = "Material Library Variant Registry: named variants and their lifecycle for the Material Library subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.library.variant_registry" })
		inst.system = S
		inst.ctx = ctx
