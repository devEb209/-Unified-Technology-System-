-- ARKHER SYSTEM I.0287 :: Look At IK Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0287"
	S.key = "arkher.anim.lookatik.skeleton"
	S.name = "Look At IK Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Look At IK"
	S.aspect = "Skeleton"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "lookatik", "skeleton", "anim" }
	S.description = "Look At IK Skeleton: bone hierarchy, bind pose and world resolution for the Look At IK subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.lookatik.skeleton" })
		inst.system = S
		inst.ctx = ctx
