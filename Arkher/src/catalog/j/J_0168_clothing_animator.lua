-- ARKHER SYSTEM J.0168 :: Clothing Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0168"
	S.key = "arkher.character.clothing.blend_controller"
	S.name = "Clothing Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.clothing.motion_set" }
	S.tags = { "j", "clothing", "animator", "character" }
	S.description = "Clothing Blend Controller: layered playback driving the character for the Clothing subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.clothing.blend_controller", budget = 14 })
		inst.system = S
		inst.ctx = ctx
