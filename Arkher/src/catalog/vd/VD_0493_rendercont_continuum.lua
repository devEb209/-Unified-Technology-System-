-- ARKHER SYSTEM VD.0493 :: Rendering Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0493"
	S.key = "arkher.contsim.rendercont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "rendercont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.rendercont.infinite_grid", cellSize = 128, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
