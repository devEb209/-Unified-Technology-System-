-- ARKHER SYSTEM H.0061 :: Inertia Tensor Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0061"
	S.key = "arkher.physics.inertia.query"
	S.name = "Inertia Tensor Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.inertia.constraint_solver" }
	S.tags = { "h", "inertia", "raycaster", "physics" }
	S.description = "Inertia Tensor Query: rays, sweeps and overlaps against the simulation for the Inertia Tensor subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.inertia.query", cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
