-- ARKHER SYSTEM T.0136 :: Skill Library Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0136"
	S.key = "arkher.ai.skilllibrary.utility_selection"
	S.name = "Skill Library Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.skilllibrary.working_memory" }
	S.tags = { "t", "skilllibrary", "utility", "ai" }
	S.description = "Skill Library Utility Selection: scored choice between competing courses of action for the Skill Library subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.skilllibrary.utility_selection", momentum = 0.14 })
		inst.system = S
		inst.ctx = ctx
