-- ARKHER SYSTEM T.0052 :: Goal Reasoning Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0052"
	S.key = "arkher.ai.goalreasoning.utility_selection"
	S.name = "Goal Reasoning Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.goalreasoning.working_memory" }
	S.tags = { "t", "goalreasoning", "utility", "ai" }
	S.description = "Goal Reasoning Utility Selection: scored choice between competing courses of action for the Goal Reasoning subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.goalreasoning.utility_selection", momentum = 0.11 })
		inst.system = S
		inst.ctx = ctx
