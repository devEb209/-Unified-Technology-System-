-- ARKHER SYSTEM K.0148 :: Rest Drive Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0148"
	S.key = "arkher.npc.restdrive.goal_planner"
	S.name = "Rest Drive Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.restdrive.utility_reasoning" }
	S.tags = { "k", "restdrive", "planner", "npc" }
	S.description = "Rest Drive Goal Planner: backward GOAP planning to reach a goal state for the Rest Drive subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.restdrive.goal_planner", maxDepth = 8 })
		inst.system = S
		inst.ctx = ctx
