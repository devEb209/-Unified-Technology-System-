-- ARKHER SYSTEM Q.0147 :: Tab Bar Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0147"
	S.key = "arkher.ui.tabbar.input_mapping"
	S.name = "Tab Bar Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tab Bar"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.tabbar.widget_tree" }
	S.tags = { "q", "tabbar", "inputmap", "ui" }
	S.description = "Tab Bar Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Tab Bar subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.tabbar.input_mapping", device = "touch", holdTime = 0.36, deadzone = 0.16 })
		inst.system = S
		inst.ctx = ctx
