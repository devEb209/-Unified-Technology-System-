-- ARKHER SYSTEM Z.0262 :: Living Ecosystem Engine Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0262"
	S.key = "arkher.origin.livingecosystem.complexity_governance"
	S.name = "Living Ecosystem Engine Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.livingecosystem.reality_layering" }
	S.tags = { "z", "livingecosystem", "complexity", "origin" }
	S.description = "Living Ecosystem Engine Complexity Governance: measured scene cost turned into per-subsystem directives for the Living Ecosystem Engine subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.livingecosystem.complexity_governance", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
