-- ARKHER SYSTEM Z.0742 :: World Compression Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0742"
	S.key = "arkher.origin.worldcompression.complexity_governance"
	S.name = "World Compression Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.reality_layering" }
	S.tags = { "z", "worldcompression", "complexity", "origin" }
	S.description = "World Compression Complexity Governance: measured scene cost turned into per-subsystem directives for the World Compression subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.worldcompression.complexity_governance", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
