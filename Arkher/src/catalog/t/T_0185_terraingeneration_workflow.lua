-- ARKHER SYSTEM T.0185 :: Terrain Generation Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0185"
	S.key = "arkher.ai.terraingeneration.plan_workflow"
	S.name = "Terrain Generation Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.terraingeneration.semantic_knowledge" }
	S.tags = { "t", "terraingeneration", "workflow", "ai" }
	S.description = "Terrain Generation Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Terrain Generation subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.terraingeneration.plan_workflow", maxRetries = 1, budget = 40 })
		inst.system = S
		inst.ctx = ctx
