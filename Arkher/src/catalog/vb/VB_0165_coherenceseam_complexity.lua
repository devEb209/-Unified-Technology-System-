-- ARKHER SYSTEM VB.0165 :: Coherence Seam Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0165"
	S.key = "arkher.conttime.coherenceseam.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.coherenceseam.world_memory_stream" }
	S.tags = { "vb", "coherenceseam", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.coherenceseam.complexity_budget", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
