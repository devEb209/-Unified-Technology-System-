-- ARKHER SYSTEM Z.0576 :: Collective Behaviour Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0576"
	S.key = "arkher.origin.collectivebehaviour.governance_policy"
	S.name = "Collective Behaviour Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.collectivebehaviour.signal_composition" }
	S.tags = { "z", "collectivebehaviour", "policy", "origin" }
	S.description = "Collective Behaviour Governance Policy: ordered rules governing when the technology may act for the Collective Behaviour subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.collectivebehaviour.governance_policy", algorithm = "lottery", starvationGuard = 63 })
		inst.system = S
		inst.ctx = ctx
