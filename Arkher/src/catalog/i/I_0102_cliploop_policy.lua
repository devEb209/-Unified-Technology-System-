-- ARKHER SYSTEM I.0102 :: Clip Looping Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0102"
	S.key = "arkher.anim.cliploop.quality_policy"
	S.name = "Clip Looping Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Looping"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.cliploop.pose_cache" }
	S.tags = { "i", "cliploop", "policy", "anim" }
	S.description = "Clip Looping Quality Policy: device tier rules for rate, bones and solvers for the Clip Looping subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.cliploop.quality_policy", algorithm = "edf", starvationGuard = 33 })
		inst.system = S
		inst.ctx = ctx
