-- ARKHER SYSTEM VC.0421 :: Navigation Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0421"
	S.key = "arkher.contneural.navcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "navcont", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.navcont.infinite_grid", cellSize = 96, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
