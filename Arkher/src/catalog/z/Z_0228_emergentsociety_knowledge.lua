-- ARKHER SYSTEM Z.0228 :: Emergent Society Framework Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0228"
	S.key = "arkher.origin.emergentsociety.semantic_graph"
	S.name = "Emergent Society Framework Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentsociety.world_architect" }
	S.tags = { "z", "emergentsociety", "knowledge", "origin" }
	S.description = "Emergent Society Framework Semantic Graph: typed entities and inferred relations of the technology itself for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.emergentsociety.semantic_graph", dims = 48 })
		inst.system = S
		inst.ctx = ctx
