-- ARKHER SYSTEM R.0136 :: Unreliable Channel Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0136"
	S.key = "arkher.net.unreliablechannel.transport_graph"
	S.name = "Unreliable Channel Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.unreliablechannel.prediction_and_reconciliation" }
	S.tags = { "r", "unreliablechannel", "network", "net" }
	S.description = "Unreliable Channel Transport Graph: topology, capacity and routing between endpoints for the Unreliable Channel subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.unreliablechannel.transport_graph" })
		inst.system = S
		inst.ctx = ctx
