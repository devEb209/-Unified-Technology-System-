-- ARKHER SYSTEM VC.0335 :: Economy Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0335"
	S.key = "arkher.contneural.economycont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.economycont.simulation_fabric" }
	S.tags = { "vc", "economycont", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.economycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
