-- ARKHER SYSTEM Z.0125 :: Dynamic Complexity Manager World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0125"
	S.key = "arkher.origin.complexitymanager.world_memory"
	S.name = "Dynamic Complexity Manager World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.autonomous_pipeline" }
	S.tags = { "z", "complexitymanager", "worldmemory", "origin" }
	S.description = "Dynamic Complexity Manager World Memory: epoch-stamped persistent history with compaction and checkpoints for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.complexitymanager.world_memory", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
