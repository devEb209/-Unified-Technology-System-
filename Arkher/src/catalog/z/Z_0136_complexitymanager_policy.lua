-- ARKHER SYSTEM Z.0136 :: Dynamic Complexity Manager Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0136"
	S.key = "arkher.origin.complexitymanager.governance_policy"
	S.name = "Dynamic Complexity Manager Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.signal_composition" }
	S.tags = { "z", "complexitymanager", "policy", "origin" }
	S.description = "Dynamic Complexity Manager Governance Policy: ordered rules governing when the technology may act for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.complexitymanager.governance_policy", algorithm = "wfq", starvationGuard = 30 })
		inst.system = S
		inst.ctx = ctx
