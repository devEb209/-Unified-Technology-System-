-- ARKHER SYSTEM VA.0194 :: Architect District Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0194"
	S.key = "arkher.contworld.architectdistrict.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.architectdistrict.infinite_grid" }
	S.tags = { "va", "architectdistrict", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.architectdistrict.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
