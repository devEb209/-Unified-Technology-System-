-- ARKHER SYSTEM VB.0608 :: Seam Lattice World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0608"
	S.key = "arkher.conttime.seamlattice.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.seamlattice.neural_field" }
	S.tags = { "vb", "seamlattice", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.seamlattice.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
