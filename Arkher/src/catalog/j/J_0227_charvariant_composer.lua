-- ARKHER SYSTEM J.0227 :: Character Variant Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0227"
	S.key = "arkher.character.charvariant.appearance_composer"
	S.name = "Character Variant Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.charvariant.locomotion" }
	S.tags = { "j", "charvariant", "composer", "character" }
	S.description = "Character Variant Appearance Composer: composition of appearance slots into a look for the Character Variant subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.charvariant.appearance_composer", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
