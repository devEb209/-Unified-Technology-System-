-- ARKHER SYSTEM Z.0031 :: Predictive Optimization Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0031"
	S.key = "arkher.origin.predictiveopt.adaptive_workflow"
	S.name = "Predictive Optimization Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.self_critique" }
	S.tags = { "z", "predictiveopt", "workflow", "origin" }
	S.description = "Predictive Optimization Adaptive Workflow: verified, retryable, reversible execution plans for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.predictiveopt.adaptive_workflow", maxRetries = 3, budget = 120 })
		inst.system = S
		inst.ctx = ctx
