-- ARKHER SYSTEM G.0384 :: Deterministic Seeding Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0384"
	S.key = "arkher.neural.detseed.weight_codec"
	S.name = "Deterministic Seeding Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detseed.model_registry" }
	S.tags = { "g", "detseed", "codec", "neural" }
	S.description = "Deterministic Seeding Weight Codec: weight serialization and quantized transport for the Deterministic Seeding subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.detseed.weight_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
