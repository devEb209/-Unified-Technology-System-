-- ARKHER SYSTEM VD.0444 :: Physics Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0444"
	S.key = "arkher.contsim.physicscont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.physicscont.reality_continuum" }
	S.tags = { "vd", "physicscont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.physicscont.emergence_continuum", windowSize = 5, threshold = 1.60, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
