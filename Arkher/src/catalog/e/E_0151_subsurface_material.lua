-- ARKHER SYSTEM E.0151 :: Subsurface Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0151"
	S.key = "arkher.material.subsurface.definition"
	S.name = "Subsurface Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Subsurface"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "subsurface", "material", "material" }
	S.description = "Subsurface Definition: layered PBR definition resolved into parameters for the Subsurface subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.subsurface.definition", texelBudget = 524288 })
		inst.system = S
		inst.ctx = ctx
