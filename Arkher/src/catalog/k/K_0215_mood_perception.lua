-- ARKHER SYSTEM K.0215 :: Mood Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0215"
	S.key = "arkher.npc.mood.perception"
	S.name = "Mood Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.mood.emotion" }
	S.tags = { "k", "mood", "perception", "npc" }
	S.description = "Mood Perception: sight, hearing and bounded attention for the Mood subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.mood.perception", sightRange = 30, hearingRange = 16, attentionSlots = 4, fov = 1.610 })
		inst.system = S
		inst.ctx = ctx
