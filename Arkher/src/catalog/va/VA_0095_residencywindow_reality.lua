-- ARKHER SYSTEM VA.0095 :: Residency Window Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0095"
	S.key = "arkher.contworld.residencywindow.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.residencywindow.simulation_fabric" }
	S.tags = { "va", "residencywindow", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.residencywindow.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
