--!strict
-- Quixel Bridge — ANIMATION Node_Flow #0131
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Quixel Bridge — ANIMATION Node_Flow #0131", size=Vector2.new(680, 440), pos=UDim2.fromOffset(203, 227), parent=parent, icon="☷"})
