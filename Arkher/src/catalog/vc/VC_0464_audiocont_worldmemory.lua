-- ARKHER SYSTEM VC.0464 :: Audio Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0464"
	S.key = "arkher.contneural.audiocont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.audiocont.neural_field" }
	S.tags = { "vc", "audiocont", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.audiocont.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
