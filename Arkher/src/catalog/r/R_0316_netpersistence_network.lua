-- ARKHER SYSTEM R.0316 :: Data Persistence Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0316"
	S.key = "arkher.net.netpersistence.transport_graph"
	S.name = "Data Persistence Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netpersistence.prediction_and_reconciliation" }
	S.tags = { "r", "netpersistence", "network", "net" }
	S.description = "Data Persistence Transport Graph: topology, capacity and routing between endpoints for the Data Persistence subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.netpersistence.transport_graph" })
		inst.system = S
		inst.ctx = ctx
