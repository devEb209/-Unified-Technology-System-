-- ARKHER SYSTEM H.0649 :: Wheel Suspension Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0649"
	S.key = "arkher.physics.suspension.query"
	S.name = "Wheel Suspension Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.suspension.constraint_solver" }
	S.tags = { "h", "suspension", "raycaster", "physics" }
	S.description = "Wheel Suspension Query: rays, sweeps and overlaps against the simulation for the Wheel Suspension subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.suspension.query", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
