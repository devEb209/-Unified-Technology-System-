-- ARKHER SYSTEM F.0543 :: Decal Rendering Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0543"
	S.key = "arkher.render.decalrender.pass_cache"
	S.name = "Decal Rendering Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.decalrender.render_policy" }
	S.tags = { "f", "decalrender", "cache", "render" }
	S.description = "Decal Rendering Pass Cache: reuse of pass results across frames for the Decal Rendering subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.decalrender.pass_cache", policy = "lru", capacity = 130, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
