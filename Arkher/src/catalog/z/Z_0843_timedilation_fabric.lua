-- ARKHER SYSTEM Z.0843 :: Simulation Time Dilation Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0843"
	S.key = "arkher.origin.timedilation.simulation_fabric"
	S.name = "Simulation Time Dilation Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.complexity_governance" }
	S.tags = { "z", "timedilation", "fabric", "origin" }
	S.description = "Simulation Time Dilation Simulation Fabric: every simulation domain stepped under one budgeted clock for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.timedilation.simulation_fabric", budgetMs = 2.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
