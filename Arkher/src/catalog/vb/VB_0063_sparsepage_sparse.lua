-- ARKHER SYSTEM VB.0063 :: Sparse Page Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0063"
	S.key = "arkher.conttime.sparsepage.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.sparsepage.epoch_clock" }
	S.tags = { "vb", "sparsepage", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.sparsepage.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
