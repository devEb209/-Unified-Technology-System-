-- ARKHER SYSTEM T.0204 :: City Generation Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0204"
	S.key = "arkher.ai.citygeneration.outcome_prediction"
	S.name = "City Generation Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.citygeneration.decision_policy" }
	S.tags = { "t", "citygeneration", "predictor", "ai" }
	S.description = "City Generation Outcome Prediction: forecasting the result before the work is done for the City Generation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.citygeneration.outcome_prediction", method = "ema", alpha = 0.38, window = 116 })
		inst.system = S
		inst.ctx = ctx
