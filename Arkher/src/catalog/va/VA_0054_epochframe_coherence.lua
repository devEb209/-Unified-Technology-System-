-- ARKHER SYSTEM VA.0054 :: Epoch Frame Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0054"
	S.key = "arkher.contworld.epochframe.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.epochframe.persistent_state" }
	S.tags = { "va", "epochframe", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.epochframe.coherence_guard", window = 68, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
