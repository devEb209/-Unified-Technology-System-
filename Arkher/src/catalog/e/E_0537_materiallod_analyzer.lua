-- ARKHER SYSTEM E.0537 :: Material LOD Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0537"
	S.key = "arkher.material.materiallod.analysis"
	S.name = "Material LOD Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Material LOD"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.materiallod.instance_cache" }
	S.tags = { "e", "materiallod", "analyzer", "material" }
	S.description = "Material LOD Analysis: cost, redundancy and outlier analysis for the Material LOD subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.materiallod.analysis", window = 127, buckets = 11, threshold = 2.90 })
		inst.system = S
		inst.ctx = ctx
