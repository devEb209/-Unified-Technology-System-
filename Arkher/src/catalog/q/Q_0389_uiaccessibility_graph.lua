-- ARKHER SYSTEM Q.0389 :: Accessibility Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0389"
	S.key = "arkher.ui.uiaccessibility.navigation_graph"
	S.name = "Accessibility Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uiaccessibility.transition" }
	S.tags = { "q", "uiaccessibility", "graph", "ui" }
	S.description = "Accessibility Navigation Graph: screens, routes and shortest path between them for the Accessibility subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.uiaccessibility.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
