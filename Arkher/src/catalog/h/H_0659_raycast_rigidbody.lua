-- ARKHER SYSTEM H.0659 :: Raycast Query Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0659"
	S.key = "arkher.physics.raycast.body_dynamics"
	S.name = "Raycast Query Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "raycast", "rigidbody", "physics" }
	S.description = "Raycast Query Body Dynamics: integration, impulses, damping and sleeping of a body for the Raycast Query subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.raycast.body_dynamics", mass = 11.00, radius = 0.80, restitution = 0.50, friction = 0.40, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
