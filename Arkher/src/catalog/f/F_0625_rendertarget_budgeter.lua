-- ARKHER SYSTEM F.0625 :: Render Target Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0625"
	S.key = "arkher.render.rendertarget.draw_budget"
	S.name = "Render Target Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.rendertarget.adaptive_resolution" }
	S.tags = { "f", "rendertarget", "budgeter", "render" }
	S.description = "Render Target Draw Budget: draw call and triangle budget allocation for the Render Target subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.rendertarget.draw_budget", total = 122, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
