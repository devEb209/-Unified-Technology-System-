-- ARKHER SYSTEM Z.0421 :: Offline World Progression Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0421"
	S.key = "arkher.origin.offlineprogression.reality_layering"
	S.name = "Offline World Progression Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "offlineprogression", "reality", "origin" }
	S.description = "Offline World Progression Reality Layering: stacked authored, simulated, proposed and player realities for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.offlineprogression.reality_layering" })
		inst.system = S
		inst.ctx = ctx
