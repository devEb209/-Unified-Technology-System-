-- ARKHER SYSTEM VC.0107 :: Memory Shard Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0107"
	S.key = "arkher.contneural.memoryshard.reality_continuum"
	S.name = "Memory Shard Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memoryshard.simulation_fabric" }
	S.tags = { "vc", "memoryshard", "reality", "contneural" }
	S.description = "Memory Shard Reality Continuum: stacked reality layers of the continuum for the Memory Shard subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.memoryshard.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
