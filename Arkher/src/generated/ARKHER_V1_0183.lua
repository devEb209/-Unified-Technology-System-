...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Blender — ANIMATION Map #0183", size=Vector2.new(600, 480), pos=UDim2.fromOffset(479, 331), parent=parent, icon="☀"})
