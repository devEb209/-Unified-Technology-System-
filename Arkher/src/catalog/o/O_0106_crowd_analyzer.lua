-- ARKHER SYSTEM O.0106 :: Crowd Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0106"
	S.key = "arkher.audio.crowd.analysis"
	S.name = "Crowd Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Crowd"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.crowd.playback_policy" }
	S.tags = { "o", "crowd", "analyzer", "audio" }
	S.description = "Crowd Analysis: loudness, headroom and masking analysis for the Crowd subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.crowd.analysis", window = 242, buckets = 14, threshold = 4.40 })
		inst.system = S
		inst.ctx = ctx
