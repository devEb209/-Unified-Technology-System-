-- ARKHER SYSTEM Z.0308 :: Causality Ledger Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0308"
	S.key = "arkher.origin.causality.semantic_graph"
	S.name = "Causality Ledger Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.world_architect" }
	S.tags = { "z", "causality", "knowledge", "origin" }
	S.description = "Causality Ledger Semantic Graph: typed entities and inferred relations of the technology itself for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.causality.semantic_graph", dims = 24 })
		inst.system = S
		inst.ctx = ctx
