-- ARKHER SYSTEM I.0114 :: Clip Events Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0114"
	S.key = "arkher.anim.clipevents.pose_cache"
	S.name = "Clip Events Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Events"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clipevents.playback_pipeline" }
	S.tags = { "i", "clipevents", "cache", "anim" }
	S.description = "Clip Events Pose Cache: reuse of sampled poses across frames and instances for the Clip Events subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.clipevents.pose_cache", policy = "lfu", capacity = 389, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
