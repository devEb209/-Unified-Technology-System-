-- ARKHER SYSTEM L.0199 :: Predation Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0199"
	S.key = "arkher.sim.predation.society"
	S.name = "Predation Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.predation.economy" }
	S.tags = { "l", "predation", "society", "sim" }
	S.description = "Predation Society: relations, factions, reputation and cohesion of the region for the Predation subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.predation.society", decayRate = 0.007, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
