-- ARKHER SYSTEM Z.0435 :: Offline World Progression Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0435"
	S.key = "arkher.origin.offlineprogression.signal_composition"
	S.name = "Offline World Progression Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.telemetry_ledger" }
	S.tags = { "z", "offlineprogression", "composer", "origin" }
	S.description = "Offline World Progression Signal Composition: blending of the technology's input signals into one output for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.offlineprogression.signal_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
