-- ARKHER SYSTEM I.0071 :: Keyframe Track Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0071"
	S.key = "arkher.anim.keytrack.retarget_graph"
	S.name = "Keyframe Track Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.keytrack.physical_blend" }
	S.tags = { "i", "keytrack", "graph", "anim" }
	S.description = "Keyframe Track Retarget Graph: bone mapping and retarget path resolution for the Keyframe Track subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.keytrack.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
