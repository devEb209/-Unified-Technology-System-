-- ARKHER SYSTEM V.0297 :: LOD Chain Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0297"
	S.key = "arkher.asset.lodchain.size_budget"
	S.name = "LOD Chain Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lodchain.compression_codec" }
	S.tags = { "v", "lodchain", "budgeter", "asset" }
	S.description = "LOD Chain Size Budget: byte budget shared between competing asset classes for the LOD Chain subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.lodchain.size_budget", total = 357, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
