-- ARKHER SYSTEM L.0069 :: Population State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0069"
	S.key = "arkher.sim.population.state_codec"
	S.name = "Population State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.population.history_ledger" }
	S.tags = { "l", "population", "codec", "sim" }
	S.description = "Population State Codec: persistence, diffing and checksum of the world state for the Population subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.population.state_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
