--!strict
-- Physics Chaos — ANIMATION Stack #0275
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Physics Chaos — ANIMATION Stack #0275", size=Vector2.new(680, 420), pos=UDim2.fromOffset(475, 335), parent=parent, icon="◈"})
