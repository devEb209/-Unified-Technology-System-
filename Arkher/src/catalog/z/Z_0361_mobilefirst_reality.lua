-- ARKHER SYSTEM Z.0361 :: Mobile First Governor Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0361"
	S.key = "arkher.origin.mobilefirst.reality_layering"
	S.name = "Mobile First Governor Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "mobilefirst", "reality", "origin" }
	S.description = "Mobile First Governor Reality Layering: stacked authored, simulated, proposed and player realities for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.mobilefirst.reality_layering" })
		inst.system = S
		inst.ctx = ctx
