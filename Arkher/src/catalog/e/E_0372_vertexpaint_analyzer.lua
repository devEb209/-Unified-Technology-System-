-- ARKHER SYSTEM E.0372 :: Vertex Painting Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0372"
	S.key = "arkher.material.vertexpaint.analysis"
	S.name = "Vertex Painting Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.vertexpaint.instance_cache" }
	S.tags = { "e", "vertexpaint", "analyzer", "material" }
	S.description = "Vertex Painting Analysis: cost, redundancy and outlier analysis for the Vertex Painting subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.vertexpaint.analysis", window = 61, buckets = 9, threshold = 3.30 })
		inst.system = S
		inst.ctx = ctx
