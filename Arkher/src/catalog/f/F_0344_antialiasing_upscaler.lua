-- ARKHER SYSTEM F.0344 :: Antialiasing Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0344"
	S.key = "arkher.render.antialiasing.adaptive_resolution"
	S.name = "Antialiasing Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Antialiasing"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.antialiasing.temporal_resolve" }
	S.tags = { "f", "antialiasing", "upscaler", "render" }
	S.description = "Antialiasing Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Antialiasing subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.antialiasing.adaptive_resolution", targetMs = 12.10, index = 4, sharpness = 0.33 })
		inst.system = S
		inst.ctx = ctx
