-- ARKHER SYSTEM O.0253 :: Exploration Music DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0253"
	S.key = "arkher.audio.explorationmusic.dsp_chain"
	S.name = "Exploration Music DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "explorationmusic", "dsp", "audio" }
	S.description = "Exploration Music DSP Chain: biquad filtering, delay, envelope and soft clipping for the Exploration Music subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.explorationmusic.dsp_chain", sampleRate = 22050, filter = "notch", cutoff = 6000, q = 0.690 })
		inst.system = S
		inst.ctx = ctx
