-- ARKHER SYSTEM W.0353 :: Subtitle Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0353"
	S.key = "arkher.cine.subtitle.cut_policy"
	S.name = "Subtitle Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Subtitle"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.subtitle.shot_composition" }
	S.tags = { "w", "subtitle", "policy", "cine" }
	S.description = "Subtitle Cut Policy: rules deciding when the sequence cuts and to what for the Subtitle subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.subtitle.cut_policy", algorithm = "wfq", starvationGuard = 46 })
		inst.system = S
		inst.ctx = ctx
