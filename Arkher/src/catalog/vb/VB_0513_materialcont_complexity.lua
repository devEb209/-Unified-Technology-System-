-- ARKHER SYSTEM VB.0513 :: Material Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0513"
	S.key = "arkher.conttime.materialcont.complexity_budget"
	S.name = "Material Continuum Complexity Budget"
	S.category = "VB"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.materialcont.world_memory_stream" }
	S.tags = { "vb", "materialcont", "complexity", "conttime" }
	S.description = "Material Continuum Complexity Budget: complexity budgeting for the continuum for the Material Continuum subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.materialcont.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
