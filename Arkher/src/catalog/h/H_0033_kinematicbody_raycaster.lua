-- ARKHER SYSTEM H.0033 :: Kinematic Body Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0033"
	S.key = "arkher.physics.kinematicbody.query"
	S.name = "Kinematic Body Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.kinematicbody.constraint_solver" }
	S.tags = { "h", "kinematicbody", "raycaster", "physics" }
	S.description = "Kinematic Body Query: rays, sweeps and overlaps against the simulation for the Kinematic Body subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.kinematicbody.query", cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
