-- ARKHER SYSTEM VA.0196 :: Architect District Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VA.0196"
	S.key = "arkher.contworld.architectdistrict.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.architectdistrict.sparse_residency" }
	S.tags = { "va", "architectdistrict", "multiscale", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contworld.architectdistrict.multi-scale_fidelity", levels = 5, baseTriangles = 75000 })
		inst.system = S
		inst.ctx = ctx
