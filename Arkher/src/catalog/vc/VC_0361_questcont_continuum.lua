-- ARKHER SYSTEM VC.0361 :: Quest Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0361"
	S.key = "arkher.contneural.questcont.infinite_grid"
	S.name = "Quest Continuum Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "questcont", "continuum", "contneural" }
	S.description = "Quest Continuum Infinite Grid: seamless paging of the infinite world grid for the Quest Continuum subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.questcont.infinite_grid", cellSize = 96, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
