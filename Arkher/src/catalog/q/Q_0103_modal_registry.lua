-- ARKHER SYSTEM Q.0103 :: Modal Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0103"
	S.key = "arkher.ui.modal.localization_registry"
	S.name = "Modal Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Modal"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.modal.theme_composition" }
	S.tags = { "q", "modal", "registry", "ui" }
	S.description = "Modal Localization Registry: catalogue of strings, plurals and locale metadata for the Modal subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.modal.localization_registry" })
		inst.system = S
		inst.ctx = ctx
