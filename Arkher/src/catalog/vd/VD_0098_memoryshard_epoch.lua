-- ARKHER SYSTEM VD.0098 :: Memory Shard Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0098"
	S.key = "arkher.contsim.memoryshard.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memoryshard.infinite_grid" }
	S.tags = { "vd", "memoryshard", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.memoryshard.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
