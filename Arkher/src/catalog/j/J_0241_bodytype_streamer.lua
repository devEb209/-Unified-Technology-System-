-- ARKHER SYSTEM J.0241 :: Body Type Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0241"
	S.key = "arkher.character.bodytype.streaming"
	S.name = "Body Type Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.bodytype.budget_governor" }
	S.tags = { "j", "bodytype", "streamer", "character" }
	S.description = "Body Type Streaming: distance-driven residency of character data for the Body Type subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.bodytype.streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
