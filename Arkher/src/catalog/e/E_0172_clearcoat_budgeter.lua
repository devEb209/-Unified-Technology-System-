-- ARKHER SYSTEM E.0172 :: Clear Coat Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0172"
	S.key = "arkher.material.clearcoat.parameter_budget"
	S.name = "Clear Coat Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Clear Coat"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.clearcoat.variant_registry" }
	S.tags = { "e", "clearcoat", "budgeter", "material" }
	S.description = "Clear Coat Parameter Budget: texel and layer budget allocation for the Clear Coat subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.clearcoat.parameter_budget", total = 240, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
