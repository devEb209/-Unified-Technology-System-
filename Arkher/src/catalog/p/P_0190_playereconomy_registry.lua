-- ARKHER SYSTEM P.0190 :: Economy Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0190"
	S.key = "arkher.play.playereconomy.content_registry"
	S.name = "Economy Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Economy"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playereconomy.difficulty_controller" }
	S.tags = { "p", "playereconomy", "registry", "play" }
	S.description = "Economy Content Registry: catalogue of the definitions this loop instantiates for the Economy subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.playereconomy.content_registry" })
		inst.system = S
		inst.ctx = ctx
