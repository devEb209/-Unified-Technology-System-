-- ARKHER SYSTEM Z.0417 :: Battery Aware Pipeline Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0417"
	S.key = "arkher.origin.batteryaware.behaviour_analysis"
	S.name = "Battery Aware Pipeline Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.batteryaware.governance_policy" }
	S.tags = { "z", "batteryaware", "analyzer", "origin" }
	S.description = "Battery Aware Pipeline Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Battery Aware Pipeline subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.batteryaware.behaviour_analysis", window = 124, buckets = 8, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
