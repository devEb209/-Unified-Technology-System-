-- ARKHER SYSTEM N.0400 :: Footprint Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0400"
	S.key = "arkher.vfx.footprint.quality_policy"
	S.name = "Footprint Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Footprint"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.footprint.result_cache" }
	S.tags = { "n", "footprint", "policy", "vfx" }
	S.description = "Footprint Quality Policy: distance and device driven fidelity bands for the Footprint subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.footprint.quality_policy", algorithm = "lottery", starvationGuard = 43 })
		inst.system = S
		inst.ctx = ctx
