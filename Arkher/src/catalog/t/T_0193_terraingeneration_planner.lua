-- ARKHER SYSTEM T.0193 :: Terrain Generation Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0193"
	S.key = "arkher.ai.terraingeneration.action_planner"
	S.name = "Terrain Generation Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.terraingeneration.utility_selection" }
	S.tags = { "t", "terraingeneration", "planner", "ai" }
	S.description = "Terrain Generation Action Planner: goal-oriented action planning over preconditions for the Terrain Generation subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.terraingeneration.action_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
