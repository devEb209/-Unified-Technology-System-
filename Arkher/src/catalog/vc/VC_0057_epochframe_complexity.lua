-- ARKHER SYSTEM VC.0057 :: Epoch Frame Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0057"
	S.key = "arkher.contneural.epochframe.complexity_budget"
	S.name = "Epoch Frame Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.epochframe.world_memory_stream" }
	S.tags = { "vc", "epochframe", "complexity", "contneural" }
	S.description = "Epoch Frame Complexity Budget: complexity budgeting for the continuum for the Epoch Frame subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.epochframe.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
