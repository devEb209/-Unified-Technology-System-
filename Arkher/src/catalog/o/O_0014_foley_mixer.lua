-- ARKHER SYSTEM O.0014 :: Foley Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0014"
	S.key = "arkher.audio.foley.mixer_bus"
	S.name = "Foley Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Foley"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.foley.dsp_chain" }
	S.tags = { "o", "foley", "mixer", "audio" }
	S.description = "Foley Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Foley subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.foley.mixer_bus", maxVoices = 24 })
		inst.system = S
		inst.ctx = ctx
