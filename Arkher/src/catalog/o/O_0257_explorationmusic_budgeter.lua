-- ARKHER SYSTEM O.0257 :: Exploration Music Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0257"
	S.key = "arkher.audio.explorationmusic.voice_budget"
	S.name = "Exploration Music Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.explorationmusic.music_sequencer" }
	S.tags = { "o", "explorationmusic", "budgeter", "audio" }
	S.description = "Exploration Music Voice Budget: voice slots allocated by priority and audibility for the Exploration Music subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.explorationmusic.voice_budget", total = 407, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
