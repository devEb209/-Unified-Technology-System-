-- ARKHER SYSTEM F.0171 :: Atmosphere Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0171"
	S.key = "arkher.render.atmosphere.visibility_set"
	S.name = "Atmosphere Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Atmosphere"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.atmosphere.view_and_culling" }
	S.tags = { "f", "atmosphere", "visibility", "render" }
	S.description = "Atmosphere Visibility Set: cell, portal and occluder visibility for the Atmosphere subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.atmosphere.visibility_set", maxDepth = 2 })
		inst.system = S
		inst.ctx = ctx
