-- ARKHER SYSTEM R.0357 :: Network Debug Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0357"
	S.key = "arkher.net.networkdebug.session_registry"
	S.name = "Network Debug Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.networkdebug.rate_guard" }
	S.tags = { "r", "networkdebug", "registry", "net" }
	S.description = "Network Debug Session Registry: catalogue of sessions, players and their metadata for the Network Debug subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.networkdebug.session_registry" })
		inst.system = S
		inst.ctx = ctx
