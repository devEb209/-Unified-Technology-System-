-- ARKHER SYSTEM Z.0970 :: Generation Migration Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0970"
	S.key = "arkher.origin.generationmigration.self_critique"
	S.name = "Generation Migration Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.intent_bridge" }
	S.tags = { "z", "generationmigration", "critic", "origin" }
	S.description = "Generation Migration Self Critique: weighted judgement of the technology's own output for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.generationmigration.self_critique", passMark = 0.80, reviseMark = 0.40, seed = 65050 })
		inst.system = S
		inst.ctx = ctx
