-- ARKHER SYSTEM F.0621 :: Render Target Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0621"
	S.key = "arkher.render.rendertarget.lighting_rig"
	S.name = "Render Target Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.rendertarget.geometry_virtualization" }
	S.tags = { "f", "rendertarget", "lightrig", "render" }
	S.description = "Render Target Lighting Rig: light clustering, importance and cascades for the Render Target subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.rendertarget.lighting_rig", maxActive = 12 })
		inst.system = S
		inst.ctx = ctx
