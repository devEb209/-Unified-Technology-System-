-- ARKHER SYSTEM T.0144 :: Tool Use Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0144"
	S.key = "arkher.ai.tooluse.self_critique"
	S.name = "Tool Use Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.tooluse.plan_workflow" }
	S.tags = { "t", "tooluse", "critic", "ai" }
	S.description = "Tool Use Self Critique: weighted evaluation of the result against declared criteria for the Tool Use subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.tooluse.self_critique", passMark = 0.78, reviseMark = 0.48, seed = 9158 })
		inst.system = S
		inst.ctx = ctx
