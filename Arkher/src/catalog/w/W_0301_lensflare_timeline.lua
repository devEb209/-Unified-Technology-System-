-- ARKHER SYSTEM W.0301 :: Lens Flare Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0301"
	S.key = "arkher.cine.lensflare.sequence_timeline"
	S.name = "Lens Flare Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Lens Flare"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "lensflare", "timeline", "cine" }
	S.description = "Lens Flare Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Lens Flare subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.lensflare.sequence_timeline", duration = 8.0, rate = 1.00 })
		inst.system = S
		inst.ctx = ctx
