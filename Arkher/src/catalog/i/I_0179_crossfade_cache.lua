-- ARKHER SYSTEM I.0179 :: Crossfade Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0179"
	S.key = "arkher.anim.crossfade.pose_cache"
	S.name = "Crossfade Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Crossfade"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crossfade.playback_pipeline" }
	S.tags = { "i", "crossfade", "cache", "anim" }
	S.description = "Crossfade Pose Cache: reuse of sampled poses across frames and instances for the Crossfade subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.crossfade.pose_cache", policy = "lfu", capacity = 477, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
