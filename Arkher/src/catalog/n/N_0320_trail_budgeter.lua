-- ARKHER SYSTEM N.0320 :: Trail Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0320"
	S.key = "arkher.vfx.trail.spawn_budget"
	S.name = "Trail Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Trail"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.trail.effect_composition" }
	S.tags = { "n", "trail", "budgeter", "vfx" }
	S.description = "Trail Spawn Budget: global particle budget shared by every live effect for the Trail subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.trail.spawn_budget", total = 112, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
