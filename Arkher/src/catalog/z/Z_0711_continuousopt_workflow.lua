-- ARKHER SYSTEM Z.0711 :: Continuous Self Optimization Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0711"
	S.key = "arkher.origin.continuousopt.adaptive_workflow"
	S.name = "Continuous Self Optimization Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.self_critique" }
	S.tags = { "z", "continuousopt", "workflow", "origin" }
	S.description = "Continuous Self Optimization Adaptive Workflow: verified, retryable, reversible execution plans for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.continuousopt.adaptive_workflow", maxRetries = 3, budget = 150 })
		inst.system = S
		inst.ctx = ctx
