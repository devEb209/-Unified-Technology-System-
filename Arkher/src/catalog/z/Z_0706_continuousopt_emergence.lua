-- ARKHER SYSTEM Z.0706 :: Continuous Self Optimization Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0706"
	S.key = "arkher.origin.continuousopt.emergence_detection"
	S.name = "Continuous Self Optimization Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.world_memory" }
	S.tags = { "z", "continuousopt", "emergence", "origin" }
	S.description = "Continuous Self Optimization Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.continuousopt.emergence_detection", windowSize = 7, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
