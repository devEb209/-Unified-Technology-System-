-- ARKHER SYSTEM V.0367 :: Import Preset Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0367"
	S.key = "arkher.asset.importpreset.streaming_residency"
	S.name = "Import Preset Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.importpreset.content_cache" }
	S.tags = { "v", "importpreset", "streamer", "asset" }
	S.description = "Import Preset Streaming Residency: distance-driven load and unload of asset payloads for the Import Preset subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.importpreset.streaming_residency", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
