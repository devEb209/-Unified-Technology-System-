-- ARKHER SYSTEM I.0418 :: Animation LOD Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0418"
	S.key = "arkher.anim.animlod.clip_sampling"
	S.name = "Animation LOD Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlod.skeleton" }
	S.tags = { "i", "animlod", "clip", "anim" }
	S.description = "Animation LOD Clip Sampling: keyframe tracks sampled, retimed and evented for the Animation LOD subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.animlod.clip_sampling", duration = 2.10, loop = true })
		inst.system = S
		inst.ctx = ctx
