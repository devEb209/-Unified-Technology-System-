...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="RAGE ImGui — CORE Profiler #0014", size=Vector2.new(680, 500), pos=UDim2.fromOffset(282, 318), parent=parent, icon="◆"})
