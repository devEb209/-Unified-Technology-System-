-- ARKHER SYSTEM O.0370 :: Magic Audio Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0370"
	S.key = "arkher.audio.magicaudio.analysis"
	S.name = "Magic Audio Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Magic Audio"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.magicaudio.playback_policy" }
	S.tags = { "o", "magicaudio", "analyzer", "audio" }
	S.description = "Magic Audio Analysis: loudness, headroom and masking analysis for the Magic Audio subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.magicaudio.analysis", window = 237, buckets = 9, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
