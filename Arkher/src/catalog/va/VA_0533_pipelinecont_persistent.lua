-- ARKHER SYSTEM VA.0533 :: Pipeline Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0533"
	S.key = "arkher.contworld.pipelinecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.pipelinecont.multi-scale_fidelity" }
	S.tags = { "va", "pipelinecont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.pipelinecont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
