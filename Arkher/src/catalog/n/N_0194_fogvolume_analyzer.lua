-- ARKHER SYSTEM N.0194 :: Fog Volume Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0194"
	S.key = "arkher.vfx.fogvolume.analysis"
	S.name = "Fog Volume Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fog Volume"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fogvolume.spatial_index" }
	S.tags = { "n", "fogvolume", "analyzer", "vfx" }
	S.description = "Fog Volume Analysis: cost, overdraw and stability analysis of the effect for the Fog Volume subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.fogvolume.analysis", window = 221, buckets = 17, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
