-- ARKHER SYSTEM VC.0349 :: Narrative Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0349"
	S.key = "arkher.contneural.narrativecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "narrativecont", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.narrativecont.infinite_grid", cellSize = 224, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
