-- ARKHER SYSTEM T.0107 :: Context Memory Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0107"
	S.key = "arkher.ai.contextmemory.working_memory"
	S.name = "Context Memory Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.contextmemory.outcome_prediction" }
	S.tags = { "t", "contextmemory", "memory", "ai" }
	S.description = "Context Memory Working Memory: decaying, consolidating recall of what the agent learned for the Context Memory subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.contextmemory.working_memory", capacity = 55, decayRate = 0.065, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
