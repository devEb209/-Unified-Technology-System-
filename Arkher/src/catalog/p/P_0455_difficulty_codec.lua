-- ARKHER SYSTEM P.0455 :: Difficulty Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0455"
	S.key = "arkher.play.difficulty.save_codec"
	S.name = "Difficulty Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Difficulty"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.difficulty.content_registry" }
	S.tags = { "p", "difficulty", "codec", "play" }
	S.description = "Difficulty Save Codec: persistence, diffing and checksum of gameplay state for the Difficulty subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.difficulty.save_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
