-- ARKHER SYSTEM VA.0378 :: Dialogue Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0378"
	S.key = "arkher.contworld.dialoguecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.dialoguecont.persistent_state" }
	S.tags = { "va", "dialoguecont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.dialoguecont.coherence_guard", window = 124, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
