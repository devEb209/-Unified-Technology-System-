-- ARKHER SYSTEM I.0337 :: Ragdoll Blend Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0337"
	S.key = "arkher.anim.ragdollblend.analysis"
	S.name = "Ragdoll Blend Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.ragdollblend.quality_policy" }
	S.tags = { "i", "ragdollblend", "analyzer", "anim" }
	S.description = "Ragdoll Blend Analysis: pop, drift and cost analysis of playback for the Ragdoll Blend subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.ragdollblend.analysis", window = 103, buckets = 15, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
