-- ARKHER SYSTEM H.0381 :: Collision Filter Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0381"
	S.key = "arkher.physics.collisionfilter.contact_generation"
	S.name = "Collision Filter Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionfilter.collision_shape" }
	S.tags = { "h", "collisionfilter", "contact", "physics" }
	S.description = "Collision Filter Contact Generation: narrow-phase manifolds with normal, depth and point for the Collision Filter subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.collisionfilter.contact_generation", slop = 0.0050, maxManifolds = 199 })
		inst.system = S
		inst.ctx = ctx
