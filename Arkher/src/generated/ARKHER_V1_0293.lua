...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="OSM ODbL — ANIMATION Map #0293", size=Vector2.new(680, 480), pos=UDim2.fromOffset(309, 121), parent=parent, icon="↻"})
