-- ARKHER SYSTEM L.0221 :: Vegetation Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0221"
	S.key = "arkher.sim.vegetation.fidelity_policy"
	S.name = "Vegetation Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.vegetation.streaming" }
	S.tags = { "l", "vegetation", "policy", "sim" }
	S.description = "Vegetation Fidelity Policy: rules that pick full, cohort or statistical simulation for the Vegetation subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.vegetation.fidelity_policy", algorithm = "roundrobin", starvationGuard = 56 })
		inst.system = S
		inst.ctx = ctx
