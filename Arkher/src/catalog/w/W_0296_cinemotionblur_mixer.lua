-- ARKHER SYSTEM W.0296 :: Motion Blur Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0296"
	S.key = "arkher.cine.cinemotionblur.cinematic_mix"
	S.name = "Motion Blur Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Motion Blur"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinemotionblur.motion_tween" }
	S.tags = { "w", "cinemotionblur", "mixer", "cine" }
	S.description = "Motion Blur Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.cinemotionblur.cinematic_mix", maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
