-- ARKHER SYSTEM VC.0596 :: Horizon Span World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0596"
	S.key = "arkher.contneural.horizonspan.world_memory_stream"
	S.name = "Horizon Span World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.horizonspan.neural_field" }
	S.tags = { "vc", "horizonspan", "worldmemory", "contneural" }
	S.description = "Horizon Span World Memory Stream: world memory continuum over epochs for the Horizon Span subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.horizonspan.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
