-- ARKHER SYSTEM E.0085 :: Normal Detail Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0085"
	S.key = "arkher.material.normaldetail.quality_policy"
	S.name = "Normal Detail Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.normaldetail.compression_codec" }
	S.tags = { "e", "normaldetail", "policy", "material" }
	S.description = "Normal Detail Quality Policy: device tier rules for the surface for the Normal Detail subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.normaldetail.quality_policy", algorithm = "wfq", starvationGuard = 42 })
		inst.system = S
		inst.ctx = ctx
