-- ARKHER SYSTEM VD.0197 :: Architect District Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0197"
	S.key = "arkher.contsim.architectdistrict.persistent_state"
	S.name = "Architect District Persistent State"
	S.category = "VD"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.architectdistrict.multi-scale_fidelity" }
	S.tags = { "vd", "architectdistrict", "persistent", "contsim" }
	S.description = "Architect District Persistent State: epoch-stamped persistent history and rollback for the Architect District subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.architectdistrict.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
