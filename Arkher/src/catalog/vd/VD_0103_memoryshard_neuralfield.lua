-- ARKHER SYSTEM VD.0103 :: Memory Shard Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0103"
	S.key = "arkher.contsim.memoryshard.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memoryshard.coherence_guard" }
	S.tags = { "vd", "memoryshard", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.memoryshard.neural_field", dims = 20, hidden = 16, seed = 34314 })
		inst.system = S
		inst.ctx = ctx
