-- ARKHER SYSTEM VB.0251 :: Vegetation Field Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0251"
	S.key = "arkher.conttime.vegfield.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vegfield.simulation_fabric" }
	S.tags = { "vb", "vegfield", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.vegfield.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
