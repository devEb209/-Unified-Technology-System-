--!strict
-- UE5/6 Nanite — ANIMATION Stack #0215
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="UE5/6 Nanite — ANIMATION Stack #0215", size=Vector2.new(680, 420), pos=UDim2.fromOffset(495, 95), parent=parent, icon="⚑"})
