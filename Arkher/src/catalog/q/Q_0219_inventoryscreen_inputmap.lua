-- ARKHER SYSTEM Q.0219 :: Inventory Screen Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0219"
	S.key = "arkher.ui.inventoryscreen.input_mapping"
	S.name = "Inventory Screen Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.inventoryscreen.widget_tree" }
	S.tags = { "q", "inventoryscreen", "inputmap", "ui" }
	S.description = "Inventory Screen Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Inventory Screen subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.inventoryscreen.input_mapping", device = "keyboard", holdTime = 0.31, deadzone = 0.21 })
		inst.system = S
		inst.ctx = ctx
