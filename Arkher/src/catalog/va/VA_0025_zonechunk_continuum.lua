-- ARKHER SYSTEM VA.0025 :: Zone Chunk Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0025"
	S.key = "arkher.contworld.zonechunk.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "zonechunk", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.zonechunk.infinite_grid", cellSize = 96, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
