-- ARKHER SYSTEM L.0282 :: Day Night Cycle Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0282"
	S.key = "arkher.sim.daynight.aggregate_cache"
	S.name = "Day Night Cycle Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.daynight.fidelity_policy" }
	S.tags = { "l", "daynight", "cache", "sim" }
	S.description = "Day Night Cycle Aggregate Cache: reuse of expensive aggregate computations for the Day Night Cycle subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.daynight.aggregate_cache", policy = "ttl", capacity = 299, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
