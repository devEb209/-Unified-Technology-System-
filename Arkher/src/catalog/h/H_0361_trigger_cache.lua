-- ARKHER SYSTEM H.0361 :: Trigger Volume Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0361"
	S.key = "arkher.physics.trigger.result_cache"
	S.name = "Trigger Volume Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.trigger.simulation_policy" }
	S.tags = { "h", "trigger", "cache", "physics" }
	S.description = "Trigger Volume Result Cache: reuse of expensive simulation and query results for the Trigger Volume subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.trigger.result_cache", policy = "lfu", capacity = 187, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
