--!strict
-- ZBrush SubTool — CORE Node_Flow #0036
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="ZBrush SubTool — CORE Node_Flow #0036", size=Vector2.new(600, 440), pos=UDim2.fromOffset(168, 172), parent=parent, icon="⛰"})
