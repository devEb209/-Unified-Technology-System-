-- ARKHER SYSTEM H.0171 :: Sleeping Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0171"
	S.key = "arkher.physics.sleeping.contact_generation"
	S.name = "Sleeping Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Sleeping"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sleeping.collision_shape" }
	S.tags = { "h", "sleeping", "contact", "physics" }
	S.description = "Sleeping Contact Generation: narrow-phase manifolds with normal, depth and point for the Sleeping subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.sleeping.contact_generation", slop = 0.0080, maxManifolds = 210 })
		inst.system = S
		inst.ctx = ctx
