-- ARKHER SYSTEM VB.0273 :: Bridge Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0273"
	S.key = "arkher.conttime.bridgecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.bridgecont.world_memory_stream" }
	S.tags = { "vb", "bridgecont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.bridgecont.complexity_budget", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
