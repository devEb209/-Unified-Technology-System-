-- ARKHER SYSTEM I.0301 :: Aim Offset Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0301"
	S.key = "arkher.anim.aimoffset.clip_sampling"
	S.name = "Aim Offset Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Aim Offset"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.aimoffset.skeleton" }
	S.tags = { "i", "aimoffset", "clip", "anim" }
	S.description = "Aim Offset Clip Sampling: keyframe tracks sampled, retimed and evented for the Aim Offset subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.aimoffset.clip_sampling", duration = 2.20, loop = false })
		inst.system = S
		inst.ctx = ctx
