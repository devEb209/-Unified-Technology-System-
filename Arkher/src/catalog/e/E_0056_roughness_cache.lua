-- ARKHER SYSTEM E.0056 :: Roughness Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0056"
	S.key = "arkher.material.roughness.instance_cache"
	S.name = "Roughness Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Roughness"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.roughness.quality_policy" }
	S.tags = { "e", "roughness", "cache", "material" }
	S.description = "Roughness Instance Cache: resolved-parameter cache keyed by context for the Roughness subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.roughness.instance_cache", policy = "lru", capacity = 253, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
