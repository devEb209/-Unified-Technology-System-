-- ARKHER SYSTEM VD.0358 :: Narrative Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0358"
	S.key = "arkher.contsim.narrativecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.narrativecont.complexity_budget" }
	S.tags = { "vd", "narrativecont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.narrativecont.simulation_fabric", budgetMs = 2.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
