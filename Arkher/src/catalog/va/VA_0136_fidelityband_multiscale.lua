-- ARKHER SYSTEM VA.0136 :: Fidelity Band Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VA.0136"
	S.key = "arkher.contworld.fidelityband.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.fidelityband.sparse_residency" }
	S.tags = { "va", "fidelityband", "multiscale", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contworld.fidelityband.multi-scale_fidelity", levels = 6, baseTriangles = 105000 })
		inst.system = S
		inst.ctx = ctx
