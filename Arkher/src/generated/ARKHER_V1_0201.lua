--!strict
-- Continuum World — ANIMATION Node_Flow #0201
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Continuum World — ANIMATION Node_Flow #0201", size=Vector2.new(600, 440), pos=UDim2.fromOffset(313, 117), parent=parent, icon="⛰"})
