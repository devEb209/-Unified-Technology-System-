-- ARKHER SYSTEM T.0292 :: Balance Tuning Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0292"
	S.key = "arkher.ai.balancetuning.model_inference"
	S.name = "Balance Tuning Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.balancetuning.action_planner" }
	S.tags = { "t", "balancetuning", "inference", "ai" }
	S.description = "Balance Tuning Model Inference: quantized inference with batching and budget for the Balance Tuning subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.balancetuning.model_inference", seed = 14016 })
		inst.system = S
		inst.ctx = ctx
