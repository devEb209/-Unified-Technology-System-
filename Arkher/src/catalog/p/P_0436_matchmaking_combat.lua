-- ARKHER SYSTEM P.0436 :: Matchmaking Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0436"
	S.key = "arkher.play.matchmaking.combat_resolution"
	S.name = "Matchmaking Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Matchmaking"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.matchmaking.objectives" }
	S.tags = { "p", "matchmaking", "combat", "play" }
	S.description = "Matchmaking Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Matchmaking subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.matchmaking.combat_resolution", seed = 48900, armourK = 120, critMultiplier = 1.50 })
		inst.system = S
		inst.ctx = ctx
