-- ARKHER SYSTEM L.0250 :: Climate Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0250"
	S.key = "arkher.sim.climate.streaming"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.climate.state_codec" }
	S.tags = { "l", "climate", "streamer", "sim" }
	S.description = "Climate Streaming: distance-driven residency of simulated regions for the Climate subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.climate.streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
