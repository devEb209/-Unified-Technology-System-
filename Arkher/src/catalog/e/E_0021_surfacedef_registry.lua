-- ARKHER SYSTEM E.0021 :: Surface Definition Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0021"
	S.key = "arkher.material.surfacedef.variant_registry"
	S.name = "Surface Definition Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.surfacedef.procedural_detail" }
	S.tags = { "e", "surfacedef", "registry", "material" }
	S.description = "Surface Definition Variant Registry: named variants and their lifecycle for the Surface Definition subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.surfacedef.variant_registry" })
		inst.system = S
		inst.ctx = ctx
