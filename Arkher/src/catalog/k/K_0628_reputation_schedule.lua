-- ARKHER SYSTEM K.0628 :: Reputation Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0628"
	S.key = "arkher.npc.reputation.daily_schedule"
	S.name = "Reputation Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.reputation.social_relations" }
	S.tags = { "k", "reputation", "schedule", "npc" }
	S.description = "Reputation Daily Schedule: hour-by-hour routine with priority interruptions for the Reputation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.reputation.daily_schedule", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
