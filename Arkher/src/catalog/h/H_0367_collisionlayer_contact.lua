-- ARKHER SYSTEM H.0367 :: Collision Layer Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0367"
	S.key = "arkher.physics.collisionlayer.contact_generation"
	S.name = "Collision Layer Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionlayer.collision_shape" }
	S.tags = { "h", "collisionlayer", "contact", "physics" }
	S.description = "Collision Layer Contact Generation: narrow-phase manifolds with normal, depth and point for the Collision Layer subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.collisionlayer.contact_generation", slop = 0.0080, maxManifolds = 171 })
		inst.system = S
		inst.ctx = ctx
