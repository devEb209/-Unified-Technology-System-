-- ARKHER SYSTEM O.0352 :: Creature Audio Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0352"
	S.key = "arkher.audio.creatureaudio.music_sequencer"
	S.name = "Creature Audio Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.creatureaudio.spatialization" }
	S.tags = { "o", "creatureaudio", "sequencer", "audio" }
	S.description = "Creature Audio Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Creature Audio subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.creatureaudio.music_sequencer", bpm = 130, beatsPerBar = 4, intensity = 0.34 })
		inst.system = S
		inst.ctx = ctx
