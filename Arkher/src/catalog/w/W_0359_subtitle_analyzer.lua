-- ARKHER SYSTEM W.0359 :: Subtitle Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0359"
	S.key = "arkher.cine.subtitle.sequence_analysis"
	S.name = "Subtitle Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Subtitle"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.subtitle.frame_budget" }
	S.tags = { "w", "subtitle", "analyzer", "cine" }
	S.description = "Subtitle Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Subtitle subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.subtitle.sequence_analysis", window = 192, buckets = 16, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
