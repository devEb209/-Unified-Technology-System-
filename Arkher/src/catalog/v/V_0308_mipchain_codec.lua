-- ARKHER SYSTEM V.0308 :: Mip Chain Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0308"
	S.key = "arkher.asset.mipchain.compression_codec"
	S.name = "Mip Chain Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.mipchain.streaming_residency" }
	S.tags = { "v", "mipchain", "codec", "asset" }
	S.description = "Mip Chain Compression Codec: compact encoding, diffing and checksum of asset payloads for the Mip Chain subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.mipchain.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
