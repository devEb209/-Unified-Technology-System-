-- ARKHER SYSTEM E.0451 :: Procedural Texture Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0451"
	S.key = "arkher.material.proctex.definition"
	S.name = "Procedural Texture Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "proctex", "material", "material" }
	S.description = "Procedural Texture Definition: layered PBR definition resolved into parameters for the Procedural Texture subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.proctex.definition", texelBudget = 1572864 })
		inst.system = S
		inst.ctx = ctx
