-- ARKHER SYSTEM VD.0251 :: Vegetation Field Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0251"
	S.key = "arkher.contsim.vegfield.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vegfield.simulation_fabric" }
	S.tags = { "vd", "vegfield", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.vegfield.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
