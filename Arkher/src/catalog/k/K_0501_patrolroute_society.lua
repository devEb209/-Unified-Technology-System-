-- ARKHER SYSTEM K.0501 :: Patrol Route Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0501"
	S.key = "arkher.npc.patrolroute.social_relations"
	S.name = "Patrol Route Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.patrolroute.crowd_steering" }
	S.tags = { "k", "patrolroute", "society", "npc" }
	S.description = "Patrol Route Social Relations: affinity, factions, reputation and gossip for the Patrol Route subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.patrolroute.social_relations", decayRate = 0.008, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
