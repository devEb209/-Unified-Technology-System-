-- ARKHER SYSTEM V.0280 :: Impostor Asset Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0280"
	S.key = "arkher.asset.impostorasset.asset_registry"
	S.name = "Impostor Asset Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.impostorasset.cook_pipeline" }
	S.tags = { "v", "impostorasset", "registry", "asset" }
	S.description = "Impostor Asset Asset Registry: catalogue of every asset, its tags and its metadata for the Impostor Asset subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.impostorasset.asset_registry" })
		inst.system = S
		inst.ctx = ctx
