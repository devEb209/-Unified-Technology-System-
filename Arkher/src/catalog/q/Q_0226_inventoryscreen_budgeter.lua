-- ARKHER SYSTEM Q.0226 :: Inventory Screen Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0226"
	S.key = "arkher.ui.inventoryscreen.frame_budget"
	S.name = "Inventory Screen Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.inventoryscreen.accessibility_policy" }
	S.tags = { "q", "inventoryscreen", "budgeter", "ui" }
	S.description = "Inventory Screen Frame Budget: per-frame layout and draw budget for the interface for the Inventory Screen subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.inventoryscreen.frame_budget", total = 135, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
