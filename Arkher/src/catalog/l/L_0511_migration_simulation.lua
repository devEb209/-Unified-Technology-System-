-- ARKHER SYSTEM L.0511 :: Migration Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0511"
	S.key = "arkher.sim.migration.simulation_core"
	S.name = "Migration Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "migration", "simulation", "sim" }
	S.description = "Migration Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Migration subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.migration.simulation_core", fullRadius = 280, reducedRadius = 600, budget = 120 })
		inst.system = S
		inst.ctx = ctx
