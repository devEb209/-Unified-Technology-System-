-- ARKHER SYSTEM V.0068 :: Shader Asset Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0068"
	S.key = "arkher.asset.shaderasset.compression_codec"
	S.name = "Shader Asset Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.shaderasset.streaming_residency" }
	S.tags = { "v", "shaderasset", "codec", "asset" }
	S.description = "Shader Asset Compression Codec: compact encoding, diffing and checksum of asset payloads for the Shader Asset subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.shaderasset.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
