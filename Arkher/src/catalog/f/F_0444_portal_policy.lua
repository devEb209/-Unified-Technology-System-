-- ARKHER SYSTEM F.0444 :: Portal Culling Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0444"
	S.key = "arkher.render.portal.render_policy"
	S.name = "Portal Culling Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.portal.draw_budget" }
	S.tags = { "f", "portal", "policy", "render" }
	S.description = "Portal Culling Render Policy: device tier rules for the frame for the Portal Culling subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.portal.render_policy", algorithm = "roundrobin", starvationGuard = 36 })
		inst.system = S
		inst.ctx = ctx
