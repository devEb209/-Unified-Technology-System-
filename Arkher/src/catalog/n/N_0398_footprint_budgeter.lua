-- ARKHER SYSTEM N.0398 :: Footprint Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0398"
	S.key = "arkher.vfx.footprint.spawn_budget"
	S.name = "Footprint Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Footprint"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.footprint.effect_composition" }
	S.tags = { "n", "footprint", "budgeter", "vfx" }
	S.description = "Footprint Spawn Budget: global particle budget shared by every live effect for the Footprint subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.footprint.spawn_budget", total = 266, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
