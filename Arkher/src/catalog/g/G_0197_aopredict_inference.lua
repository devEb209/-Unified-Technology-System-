-- ARKHER SYSTEM G.0197 :: Ambient Occlusion Prediction Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0197"
	S.key = "arkher.neural.aopredict.inference_core"
	S.name = "Ambient Occlusion Prediction Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "aopredict", "inference", "neural" }
	S.description = "Ambient Occlusion Prediction Inference Core: dense network forward pass and training for the Ambient Occlusion Prediction subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.aopredict.inference_core", seed = 54273 })
		inst.system = S
		inst.ctx = ctx
