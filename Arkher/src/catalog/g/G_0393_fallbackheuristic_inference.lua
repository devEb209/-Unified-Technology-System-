-- ARKHER SYSTEM G.0393 :: Fallback Heuristic Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0393"
	S.key = "arkher.neural.fallbackheuristic.inference_core"
	S.name = "Fallback Heuristic Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "fallbackheuristic", "inference", "neural" }
	S.description = "Fallback Heuristic Inference Core: dense network forward pass and training for the Fallback Heuristic subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.fallbackheuristic.inference_core", seed = 10189 })
		inst.system = S
		inst.ctx = ctx
