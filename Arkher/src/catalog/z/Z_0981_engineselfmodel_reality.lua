-- ARKHER SYSTEM Z.0981 :: Engine Self Model Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0981"
	S.key = "arkher.origin.engineselfmodel.reality_layering"
	S.name = "Engine Self Model Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "engineselfmodel", "reality", "origin" }
	S.description = "Engine Self Model Reality Layering: stacked authored, simulated, proposed and player realities for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.engineselfmodel.reality_layering" })
		inst.system = S
		inst.ctx = ctx
