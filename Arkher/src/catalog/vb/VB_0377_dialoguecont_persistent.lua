-- ARKHER SYSTEM VB.0377 :: Dialogue Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0377"
	S.key = "arkher.conttime.dialoguecont.persistent_state"
	S.name = "Dialogue Continuum Persistent State"
	S.category = "VB"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.dialoguecont.multi-scale_fidelity" }
	S.tags = { "vb", "dialoguecont", "persistent", "conttime" }
	S.description = "Dialogue Continuum Persistent State: epoch-stamped persistent history and rollback for the Dialogue Continuum subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.dialoguecont.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
