-- ARKHER SYSTEM J.0192 :: Armor Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0192"
	S.key = "arkher.character.armor.physical_response"
	S.name = "Armor Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.armor.look_and_reach" }
	S.tags = { "j", "armor", "ragdoll", "character" }
	S.description = "Armor Physical Response: physical reaction, ragdoll and recovery for the Armor subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.armor.physical_response", blendSpeed = 2.20 })
		inst.system = S
		inst.ctx = ctx
