-- ARKHER SYSTEM P.0447 :: Difficulty Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0447"
	S.key = "arkher.play.difficulty.objectives"
	S.name = "Difficulty Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Difficulty"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.difficulty.inventory" }
	S.tags = { "p", "difficulty", "quest", "play" }
	S.description = "Difficulty Objectives: objectives, prerequisites, progress and rewards for the Difficulty subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.difficulty.objectives" })
		inst.system = S
		inst.ctx = ctx
