-- ARKHER SYSTEM F.0165 :: Volumetric Light Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0165"
	S.key = "arkher.render.volumetric.pass_cache"
	S.name = "Volumetric Light Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.volumetric.render_policy" }
	S.tags = { "f", "volumetric", "cache", "render" }
	S.description = "Volumetric Light Pass Cache: reuse of pass results across frames for the Volumetric Light subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.volumetric.pass_cache", policy = "lfu", capacity = 167, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
