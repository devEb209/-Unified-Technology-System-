-- ARKHER SYSTEM V.0222 :: Script Asset Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0222"
	S.key = "arkher.asset.scriptasset.content_cache"
	S.name = "Script Asset Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.scriptasset.dependency_graph" }
	S.tags = { "v", "scriptasset", "cache", "asset" }
	S.description = "Script Asset Content Cache: reuse of already cooked results for the Script Asset subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.scriptasset.content_cache", policy = "ttl", capacity = 202, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
