...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Maya Shelf — CORE Mixer #0022", size=Vector2.new(640, 460), pos=UDim2.fromOffset(386, 194), parent=parent, icon="⬣"})
...
Components.Slider(right, "Rate", 0,3000,600, function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_Rate"..22, v) end end)
