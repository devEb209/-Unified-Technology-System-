-- ARKHER SYSTEM L.0235 :: Weather Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0235"
	S.key = "arkher.sim.weather.streaming"
	S.name = "Weather Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.weather.state_codec" }
	S.tags = { "l", "weather", "streamer", "sim" }
	S.description = "Weather Streaming: distance-driven residency of simulated regions for the Weather subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.weather.streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
