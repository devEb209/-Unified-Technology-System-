-- ARKHER SYSTEM VD.0435 :: Physics Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0435"
	S.key = "arkher.contsim.physicscont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.physicscont.epoch_clock" }
	S.tags = { "vd", "physicscont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.physicscont.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
