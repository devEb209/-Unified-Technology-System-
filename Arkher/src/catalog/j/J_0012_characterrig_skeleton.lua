-- ARKHER SYSTEM J.0012 :: Character Rig Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0012"
	S.key = "arkher.character.characterrig.rig_definition"
	S.name = "Character Rig Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "characterrig", "skeleton", "character" }
	S.description = "Character Rig Rig Definition: character rig definition and bone budget for the Character Rig subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.characterrig.rig_definition" })
		inst.system = S
		inst.ctx = ctx
