-- ARKHER SYSTEM VA.0450 :: Animation Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0450"
	S.key = "arkher.contworld.animcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.animcont.persistent_state" }
	S.tags = { "va", "animcont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.animcont.coherence_guard", window = 94, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
