-- ARKHER SYSTEM VB.0207 :: Biome Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0207"
	S.key = "arkher.conttime.biomecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.biomecont.epoch_clock" }
	S.tags = { "vb", "biomecont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.biomecont.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
