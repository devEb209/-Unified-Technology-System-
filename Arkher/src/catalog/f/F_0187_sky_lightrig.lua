-- ARKHER SYSTEM F.0187 :: Sky Model Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0187"
	S.key = "arkher.render.sky.lighting_rig"
	S.name = "Sky Model Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sky Model"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sky.geometry_virtualization" }
	S.tags = { "f", "sky", "lightrig", "render" }
	S.description = "Sky Model Lighting Rig: light clustering, importance and cascades for the Sky Model subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.sky.lighting_rig", maxActive = 8 })
		inst.system = S
		inst.ctx = ctx
