-- ARKHER SYSTEM N.0113 :: Blood Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0113"
	S.key = "arkher.vfx.blood.result_cache"
	S.name = "Blood Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Blood"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.blood.spawn_budget" }
	S.tags = { "n", "blood", "cache", "vfx" }
	S.description = "Blood Result Cache: reuse of expensive effect evaluations for the Blood subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.blood.result_cache", policy = "lru", capacity = 164, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
