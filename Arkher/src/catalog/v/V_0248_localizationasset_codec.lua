-- ARKHER SYSTEM V.0248 :: Localization Asset Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0248"
	S.key = "arkher.asset.localizationasset.compression_codec"
	S.name = "Localization Asset Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.localizationasset.streaming_residency" }
	S.tags = { "v", "localizationasset", "codec", "asset" }
	S.description = "Localization Asset Compression Codec: compact encoding, diffing and checksum of asset payloads for the Localization Asset subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.localizationasset.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
