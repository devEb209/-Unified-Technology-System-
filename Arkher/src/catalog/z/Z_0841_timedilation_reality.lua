-- ARKHER SYSTEM Z.0841 :: Simulation Time Dilation Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0841"
	S.key = "arkher.origin.timedilation.reality_layering"
	S.name = "Simulation Time Dilation Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "timedilation", "reality", "origin" }
	S.description = "Simulation Time Dilation Reality Layering: stacked authored, simulated, proposed and player realities for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.timedilation.reality_layering" })
		inst.system = S
		inst.ctx = ctx
