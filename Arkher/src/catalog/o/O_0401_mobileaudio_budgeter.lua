-- ARKHER SYSTEM O.0401 :: Mobile Audio Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0401"
	S.key = "arkher.audio.mobileaudio.voice_budget"
	S.name = "Mobile Audio Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mobile Audio"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mobileaudio.music_sequencer" }
	S.tags = { "o", "mobileaudio", "budgeter", "audio" }
	S.description = "Mobile Audio Voice Budget: voice slots allocated by priority and audibility for the Mobile Audio subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.mobileaudio.voice_budget", total = 283, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
