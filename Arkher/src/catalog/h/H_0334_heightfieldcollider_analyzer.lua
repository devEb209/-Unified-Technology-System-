-- ARKHER SYSTEM H.0334 :: Heightfield Collider Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0334"
	S.key = "arkher.physics.heightfieldcollider.analysis"
	S.name = "Heightfield Collider Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.heightfieldcollider.result_cache" }
	S.tags = { "h", "heightfieldcollider", "analyzer", "physics" }
	S.description = "Heightfield Collider Analysis: energy, jitter and cost analysis of the simulation for the Heightfield Collider subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.heightfieldcollider.analysis", window = 95, buckets = 11, threshold = 4.70 })
		inst.system = S
		inst.ctx = ctx
