-- ARKHER SYSTEM P.0030 :: Skill Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0030"
	S.key = "arkher.play.skill.rule_pipeline"
	S.name = "Skill Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Skill"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.skill.state_machine" }
	S.tags = { "p", "skill", "pipeline", "play" }
	S.description = "Skill Rule Pipeline: ordered rules applied to every gameplay event for the Skill subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.skill.rule_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
