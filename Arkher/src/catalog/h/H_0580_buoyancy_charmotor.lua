-- ARKHER SYSTEM H.0580 :: Buoyancy Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0580"
	S.key = "arkher.physics.buoyancy.character_motion"
	S.name = "Buoyancy Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Buoyancy"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.buoyancy.query" }
	S.tags = { "h", "buoyancy", "charmotor", "physics" }
	S.description = "Buoyancy Character Motion: capsule move-and-slide with slopes, steps and jumps for the Buoyancy subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.buoyancy.character_motion", radius = 0.54, height = 1.99, maxSpeed = 9.90, jumpHeight = 2.30, stepOffset = 0.54 })
		inst.system = S
		inst.ctx = ctx
