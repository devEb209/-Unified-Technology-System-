-- ARKHER SYSTEM K.0553 :: Trade Behaviour Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0553"
	S.key = "arkher.npc.tradebehaviour.utility_reasoning"
	S.name = "Trade Behaviour Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.tradebehaviour.reactive_behaviour" }
	S.tags = { "k", "tradebehaviour", "utility", "npc" }
	S.description = "Trade Behaviour Utility Reasoning: scored option selection with response curves for the Trade Behaviour subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.tradebehaviour.utility_reasoning", momentum = 0.19 })
		inst.system = S
		inst.ctx = ctx
