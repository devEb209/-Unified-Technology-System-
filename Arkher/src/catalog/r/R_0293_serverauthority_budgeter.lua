-- ARKHER SYSTEM R.0293 :: Server Authority Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0293"
	S.key = "arkher.net.serverauthority.bandwidth_budget"
	S.name = "Server Authority Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverauthority.transport_graph" }
	S.tags = { "r", "serverauthority", "budgeter", "net" }
	S.description = "Server Authority Bandwidth Budget: bytes per second shared between competing streams for the Server Authority subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.serverauthority.bandwidth_budget", total = 117, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
