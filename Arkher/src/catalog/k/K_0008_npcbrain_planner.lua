-- ARKHER SYSTEM K.0008 :: NPC Brain Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0008"
	S.key = "arkher.npc.npcbrain.goal_planner"
	S.name = "NPC Brain Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcbrain.utility_reasoning" }
	S.tags = { "k", "npcbrain", "planner", "npc" }
	S.description = "NPC Brain Goal Planner: backward GOAP planning to reach a goal state for the NPC Brain subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.npcbrain.goal_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
