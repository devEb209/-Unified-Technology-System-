-- ARKHER SYSTEM F.0445 :: Portal Culling Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0445"
	S.key = "arkher.render.portal.pass_cache"
	S.name = "Portal Culling Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.portal.render_policy" }
	S.tags = { "f", "portal", "cache", "render" }
	S.description = "Portal Culling Pass Cache: reuse of pass results across frames for the Portal Culling subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.portal.pass_cache", policy = "ttl", capacity = 113, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
