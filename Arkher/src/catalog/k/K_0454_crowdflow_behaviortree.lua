-- ARKHER SYSTEM K.0454 :: Crowd Flow Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0454"
	S.key = "arkher.npc.crowdflow.reactive_behaviour"
	S.name = "Crowd Flow Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.crowdflow.perception" }
	S.tags = { "k", "crowdflow", "behaviortree", "npc" }
	S.description = "Crowd Flow Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Crowd Flow subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.crowdflow.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
