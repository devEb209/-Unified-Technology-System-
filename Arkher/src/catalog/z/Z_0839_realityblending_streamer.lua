-- ARKHER SYSTEM Z.0839 :: Reality Blending Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0839"
	S.key = "arkher.origin.realityblending.residency_streaming"
	S.name = "Reality Blending Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.budget_governor" }
	S.tags = { "z", "realityblending", "streamer", "origin" }
	S.description = "Reality Blending Residency Streaming: distance-driven residency of the technology's workload for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.realityblending.residency_streaming", radius = 280, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
