-- ARKHER SYSTEM F.0468 :: Distance Culling Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0468"
	S.key = "arkher.render.distanceculling.probe_volume"
	S.name = "Distance Culling Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.distanceculling.lighting_rig" }
	S.tags = { "f", "distanceculling", "probe", "render" }
	S.description = "Distance Culling Probe Volume: irradiance probes encoded in spherical harmonics for the Distance Culling subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.distanceculling.probe_volume", spacing = 24 })
		inst.system = S
		inst.ctx = ctx
