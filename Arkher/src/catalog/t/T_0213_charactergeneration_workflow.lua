-- ARKHER SYSTEM T.0213 :: Character Generation Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0213"
	S.key = "arkher.ai.charactergeneration.plan_workflow"
	S.name = "Character Generation Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.charactergeneration.semantic_knowledge" }
	S.tags = { "t", "charactergeneration", "workflow", "ai" }
	S.description = "Character Generation Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Character Generation subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.charactergeneration.plan_workflow", maxRetries = 1, budget = 100 })
		inst.system = S
		inst.ctx = ctx
