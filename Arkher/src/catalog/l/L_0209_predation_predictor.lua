-- ARKHER SYSTEM L.0209 :: Predation Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0209"
	S.key = "arkher.sim.predation.forecast"
	S.name = "Predation Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.predation.analysis" }
	S.tags = { "l", "predation", "predictor", "sim" }
	S.description = "Predation Forecast: prediction of the region's next state for the Predation subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.predation.forecast", method = "ema", alpha = 0.35, window = 41 })
		inst.system = S
		inst.ctx = ctx
