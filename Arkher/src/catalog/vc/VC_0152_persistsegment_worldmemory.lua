-- ARKHER SYSTEM VC.0152 :: Persistence Segment World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0152"
	S.key = "arkher.contneural.persistsegment.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.persistsegment.neural_field" }
	S.tags = { "vc", "persistsegment", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.persistsegment.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
