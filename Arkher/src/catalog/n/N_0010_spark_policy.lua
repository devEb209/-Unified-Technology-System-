-- ARKHER SYSTEM N.0010 :: Spark Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0010"
	S.key = "arkher.vfx.spark.quality_policy"
	S.name = "Spark Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spark"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spark.result_cache" }
	S.tags = { "n", "spark", "policy", "vfx" }
	S.description = "Spark Quality Policy: distance and device driven fidelity bands for the Spark subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.spark.quality_policy", algorithm = "lottery", starvationGuard = 39 })
		inst.system = S
		inst.ctx = ctx
