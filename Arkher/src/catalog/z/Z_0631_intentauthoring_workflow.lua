-- ARKHER SYSTEM Z.0631 :: Intent Driven Authoring Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0631"
	S.key = "arkher.origin.intentauthoring.adaptive_workflow"
	S.name = "Intent Driven Authoring Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.self_critique" }
	S.tags = { "z", "intentauthoring", "workflow", "origin" }
	S.description = "Intent Driven Authoring Adaptive Workflow: verified, retryable, reversible execution plans for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.intentauthoring.adaptive_workflow", maxRetries = 2, budget = 80 })
		inst.system = S
		inst.ctx = ctx
