-- ARKHER SYSTEM E.0505 :: Shader Graph Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0505"
	S.key = "arkher.material.shadergraph.quality_policy"
	S.name = "Shader Graph Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Shader Graph"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.shadergraph.compression_codec" }
	S.tags = { "e", "shadergraph", "policy", "material" }
	S.description = "Shader Graph Quality Policy: device tier rules for the surface for the Shader Graph subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.shadergraph.quality_policy", algorithm = "wfq", starvationGuard = 38 })
		inst.system = S
		inst.ctx = ctx
