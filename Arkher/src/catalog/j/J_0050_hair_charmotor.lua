-- ARKHER SYSTEM J.0050 :: Hair Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0050"
	S.key = "arkher.character.hair.locomotion"
	S.name = "Hair Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.hair.physical_response" }
	S.tags = { "j", "hair", "charmotor", "character" }
	S.description = "Hair Locomotion: capsule locomotion driving the character for the Hair subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.hair.locomotion", radius = 0.49, height = 1.74, maxSpeed = 5.40, jumpHeight = 1.40, stepOffset = 0.39 })
		inst.system = S
		inst.ctx = ctx
