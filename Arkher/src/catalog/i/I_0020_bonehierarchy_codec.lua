-- ARKHER SYSTEM I.0020 :: Bone Hierarchy Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0020"
	S.key = "arkher.anim.bonehierarchy.compression_codec"
	S.name = "Bone Hierarchy Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonehierarchy.retarget_graph" }
	S.tags = { "i", "bonehierarchy", "codec", "anim" }
	S.description = "Bone Hierarchy Compression Codec: curve compression and quantized transport for the Bone Hierarchy subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.bonehierarchy.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
