-- ARKHER SYSTEM VA.0448 :: Animation Continuum Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VA.0448"
	S.key = "arkher.contworld.animcont.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.animcont.sparse_residency" }
	S.tags = { "va", "animcont", "multiscale", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contworld.animcont.multi-scale_fidelity", levels = 5, baseTriangles = 135000 })
		inst.system = S
		inst.ctx = ctx
