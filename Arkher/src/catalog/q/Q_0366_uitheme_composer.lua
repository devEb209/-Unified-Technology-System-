-- ARKHER SYSTEM Q.0366 :: Theme Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0366"
	S.key = "arkher.ui.uitheme.theme_composition"
	S.name = "Theme Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Theme"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uitheme.navigation_graph" }
	S.tags = { "q", "uitheme", "composer", "ui" }
	S.description = "Theme Theme Composition: blending of theme signals into the final appearance for the Theme subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.uitheme.theme_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
