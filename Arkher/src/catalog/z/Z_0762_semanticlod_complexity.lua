-- ARKHER SYSTEM Z.0762 :: Semantic LOD Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0762"
	S.key = "arkher.origin.semanticlod.complexity_governance"
	S.name = "Semantic LOD Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticlod.reality_layering" }
	S.tags = { "z", "semanticlod", "complexity", "origin" }
	S.description = "Semantic LOD Complexity Governance: measured scene cost turned into per-subsystem directives for the Semantic LOD subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.semanticlod.complexity_governance", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
