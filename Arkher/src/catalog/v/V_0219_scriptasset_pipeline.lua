-- ARKHER SYSTEM V.0219 :: Script Asset Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0219"
	S.key = "arkher.asset.scriptasset.cook_pipeline"
	S.name = "Script Asset Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.scriptasset.bundling" }
	S.tags = { "v", "scriptasset", "pipeline", "asset" }
	S.description = "Script Asset Cook Pipeline: staged cooking with isolation and retries for the Script Asset subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.scriptasset.cook_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
