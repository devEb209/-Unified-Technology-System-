-- ARKHER SYSTEM E.0174 :: Clear Coat Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0174"
	S.key = "arkher.material.clearcoat.compression_codec"
	S.name = "Clear Coat Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Clear Coat"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.clearcoat.streaming" }
	S.tags = { "e", "clearcoat", "codec", "material" }
	S.description = "Clear Coat Compression Codec: serialization and compression of material data for the Clear Coat subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.clearcoat.compression_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
