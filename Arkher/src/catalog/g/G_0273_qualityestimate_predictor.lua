-- ARKHER SYSTEM G.0273 :: Quality Estimation Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0273"
	S.key = "arkher.neural.qualityestimate.quality_predictor"
	S.name = "Quality Estimation Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.qualityestimate.weight_codec" }
	S.tags = { "g", "qualityestimate", "predictor", "neural" }
	S.description = "Quality Estimation Quality Predictor: predicted quality and cost of a setting for the Quality Estimation subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.qualityestimate.quality_predictor", method = "markov", alpha = 0.44, window = 34 })
		inst.system = S
		inst.ctx = ctx
