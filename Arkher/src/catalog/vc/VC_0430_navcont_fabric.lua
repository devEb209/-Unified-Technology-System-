-- ARKHER SYSTEM VC.0430 :: Navigation Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0430"
	S.key = "arkher.contneural.navcont.simulation_fabric"
	S.name = "Navigation Continuum Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.navcont.complexity_budget" }
	S.tags = { "vc", "navcont", "fabric", "contneural" }
	S.description = "Navigation Continuum Simulation Fabric: fabric stepping the continuum domains for the Navigation Continuum subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.navcont.simulation_fabric", budgetMs = 4.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
