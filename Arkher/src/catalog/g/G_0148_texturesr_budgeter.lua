-- ARKHER SYSTEM G.0148 :: Texture Super Resolution Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0148"
	S.key = "arkher.neural.texturesr.compute_budget"
	S.name = "Texture Super Resolution Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.texturesr.quality_predictor" }
	S.tags = { "g", "texturesr", "budgeter", "neural" }
	S.description = "Texture Super Resolution Compute Budget: inference time budget allocation for the Texture Super Resolution subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.texturesr.compute_budget", total = 351, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
