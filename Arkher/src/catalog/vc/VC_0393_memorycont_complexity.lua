-- ARKHER SYSTEM VC.0393 :: Memory Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0393"
	S.key = "arkher.contneural.memorycont.complexity_budget"
	S.name = "Memory Continuum Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memorycont.world_memory_stream" }
	S.tags = { "vc", "memorycont", "complexity", "contneural" }
	S.description = "Memory Continuum Complexity Budget: complexity budgeting for the continuum for the Memory Continuum subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.memorycont.complexity_budget", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
