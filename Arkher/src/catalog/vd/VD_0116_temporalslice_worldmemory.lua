-- ARKHER SYSTEM VD.0116 :: Temporal Slice World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0116"
	S.key = "arkher.contsim.temporalslice.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.temporalslice.neural_field" }
	S.tags = { "vd", "temporalslice", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.temporalslice.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
