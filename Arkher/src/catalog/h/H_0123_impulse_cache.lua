-- ARKHER SYSTEM H.0123 :: Impulse Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0123"
	S.key = "arkher.physics.impulse.result_cache"
	S.name = "Impulse Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Impulse"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.impulse.simulation_policy" }
	S.tags = { "h", "impulse", "cache", "physics" }
	S.description = "Impulse Result Cache: reuse of expensive simulation and query results for the Impulse subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.impulse.result_cache", policy = "ttl", capacity = 320, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
