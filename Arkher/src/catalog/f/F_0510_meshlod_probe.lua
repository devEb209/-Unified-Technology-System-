-- ARKHER SYSTEM F.0510 :: Mesh LOD Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0510"
	S.key = "arkher.render.meshlod.probe_volume"
	S.name = "Mesh LOD Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Mesh LOD"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.meshlod.lighting_rig" }
	S.tags = { "f", "meshlod", "probe", "render" }
	S.description = "Mesh LOD Probe Volume: irradiance probes encoded in spherical harmonics for the Mesh LOD subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.meshlod.probe_volume", spacing = 8 })
		inst.system = S
		inst.ctx = ctx
