-- ARKHER SYSTEM T.0321 :: Optimization Advisor Learning Analysis
...
return function(A)
	...
	local S = {}
	S.id = "T.0321"
	S.key = "arkher.ai.optimizationadvisor.learning_analysis"
	S.name = "Optimization Advisor Learning Analysis"
	S.category = "T"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.optimizationadvisor.model_inference" }
	S.tags = { "t", "optimizationadvisor", "analyzer", "ai" }
	S.description = "Optimization Advisor Learning Analysis: trend, anomaly and improvement analysis of the agent for the Optimization Advisor subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ai.optimizationadvisor.learning_analysis", window = 100, buckets = 12, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
