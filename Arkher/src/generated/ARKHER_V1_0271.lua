--!strict
-- ZBrush SubTool — ANIMATION Node_Flow #0271
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="ZBrush SubTool — ANIMATION Node_Flow #0271", size=Vector2.new(640, 440), pos=UDim2.fromOffset(423, 267), parent=parent, icon="🎬"})
