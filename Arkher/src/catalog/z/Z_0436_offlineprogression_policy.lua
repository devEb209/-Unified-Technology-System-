-- ARKHER SYSTEM Z.0436 :: Offline World Progression Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0436"
	S.key = "arkher.origin.offlineprogression.governance_policy"
	S.name = "Offline World Progression Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.signal_composition" }
	S.tags = { "z", "offlineprogression", "policy", "origin" }
	S.description = "Offline World Progression Governance Policy: ordered rules governing when the technology may act for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.offlineprogression.governance_policy", algorithm = "lottery", starvationGuard = 31 })
		inst.system = S
		inst.ctx = ctx
