-- ARKHER SYSTEM F.0062 :: Shadow Pass Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0062"
	S.key = "arkher.render.shadowpass.probe_volume"
	S.name = "Shadow Pass Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Shadow Pass"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.shadowpass.lighting_rig" }
	S.tags = { "f", "shadowpass", "probe", "render" }
	S.description = "Shadow Pass Probe Volume: irradiance probes encoded in spherical harmonics for the Shadow Pass subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.shadowpass.probe_volume", spacing = 16 })
		inst.system = S
		inst.ctx = ctx
