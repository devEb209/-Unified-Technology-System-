-- ARKHER SYSTEM Z.0230 :: Emergent Society Framework Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0230"
	S.key = "arkher.origin.emergentsociety.self_critique"
	S.name = "Emergent Society Framework Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentsociety.intent_bridge" }
	S.tags = { "z", "emergentsociety", "critic", "origin" }
	S.description = "Emergent Society Framework Self Critique: weighted judgement of the technology's own output for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.emergentsociety.self_critique", passMark = 0.71, reviseMark = 0.46, seed = 28456 })
		inst.system = S
		inst.ctx = ctx
