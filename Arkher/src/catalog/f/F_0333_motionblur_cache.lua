-- ARKHER SYSTEM F.0333 :: Motion Blur Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0333"
	S.key = "arkher.render.motionblur.pass_cache"
	S.name = "Motion Blur Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Motion Blur"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.motionblur.render_policy" }
	S.tags = { "f", "motionblur", "cache", "render" }
	S.description = "Motion Blur Pass Cache: reuse of pass results across frames for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.motionblur.pass_cache", policy = "lru", capacity = 347, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
