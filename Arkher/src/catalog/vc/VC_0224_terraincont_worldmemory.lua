-- ARKHER SYSTEM VC.0224 :: Terrain Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0224"
	S.key = "arkher.contneural.terraincont.world_memory_stream"
	S.name = "Terrain Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.terraincont.neural_field" }
	S.tags = { "vc", "terraincont", "worldmemory", "contneural" }
	S.description = "Terrain Continuum World Memory Stream: world memory continuum over epochs for the Terrain Continuum subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.terraincont.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
