-- ARKHER SYSTEM F.0352 :: Temporal Accumulation View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0352"
	S.key = "arkher.render.temporalaccum.view_and_culling"
	S.name = "Temporal Accumulation View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.temporalaccum.frame_graph" }
	S.tags = { "f", "temporalaccum", "camera", "render" }
	S.description = "Temporal Accumulation View And Culling: view state, frustum culling and screen-size LOD for the Temporal Accumulation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.temporalaccum.view_and_culling", width = 956, height = 720, fov = 1.2600, far = 1600 })
		inst.system = S
		inst.ctx = ctx
