-- ARKHER SYSTEM J.0260 :: Damage State Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0260"
	S.key = "arkher.character.damagestate.appearance_composer"
	S.name = "Damage State Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.damagestate.locomotion" }
	S.tags = { "j", "damagestate", "composer", "character" }
	S.description = "Damage State Appearance Composer: composition of appearance slots into a look for the Damage State subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.damagestate.appearance_composer", mode = "max" })
		inst.system = S
		inst.ctx = ctx
