-- ARKHER SYSTEM F.0315 :: Depth Of Field Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0315"
	S.key = "arkher.render.dof.temporal_resolve"
	S.name = "Depth Of Field Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.dof.probe_volume" }
	S.tags = { "f", "dof", "temporal", "render" }
	S.description = "Depth Of Field Temporal Resolve: history reprojection with neighbourhood clamping for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.dof.temporal_resolve", feedback = 0.85, phase = 8 })
		inst.system = S
		inst.ctx = ctx
