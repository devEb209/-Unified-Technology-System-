-- ARKHER SYSTEM H.0092 :: Gravity Field Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0092"
	S.key = "arkher.physics.gravityfield.broadphase_index"
	S.name = "Gravity Field Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.gravityfield.vehicle" }
	S.tags = { "h", "gravityfield", "index", "physics" }
	S.description = "Gravity Field Broadphase Index: spatial acceleration of candidate pair finding for the Gravity Field subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.gravityfield.broadphase_index", mode = "hash", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
