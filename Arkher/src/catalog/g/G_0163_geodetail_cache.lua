-- ARKHER SYSTEM G.0163 :: Geometry Detail Prediction Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0163"
	S.key = "arkher.neural.geodetail.result_cache"
	S.name = "Geometry Detail Prediction Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.geodetail.compute_budget" }
	S.tags = { "g", "geodetail", "cache", "neural" }
	S.description = "Geometry Detail Prediction Result Cache: cached inference results keyed by input for the Geometry Detail Prediction subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.geodetail.result_cache", policy = "lru", capacity = 480, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
