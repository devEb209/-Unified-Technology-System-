-- ARKHER SYSTEM K.0320 :: Threat Assessment Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0320"
	S.key = "arkher.npc.threatassessment.daily_schedule"
	S.name = "Threat Assessment Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.threatassessment.social_relations" }
	S.tags = { "k", "threatassessment", "schedule", "npc" }
	S.description = "Threat Assessment Daily Schedule: hour-by-hour routine with priority interruptions for the Threat Assessment subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.threatassessment.daily_schedule", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
