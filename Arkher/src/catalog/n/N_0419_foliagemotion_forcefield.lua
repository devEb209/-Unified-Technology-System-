-- ARKHER SYSTEM N.0419 :: Foliage Motion Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0419"
	S.key = "arkher.vfx.foliagemotion.force_field"
	S.name = "Foliage Motion Force Field"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.foliagemotion.particle_simulation" }
	S.tags = { "n", "foliagemotion", "forcefield", "vfx" }
	S.description = "Foliage Motion Force Field: wind, attraction, vortex, drag and curl turbulence for the Foliage Motion subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.foliagemotion.force_field", seed = 17991 })
		inst.system = S
		inst.ctx = ctx
