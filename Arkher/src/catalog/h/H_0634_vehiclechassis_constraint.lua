-- ARKHER SYSTEM H.0634 :: Vehicle Chassis Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0634"
	S.key = "arkher.physics.vehiclechassis.constraint_solver"
	S.name = "Vehicle Chassis Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.vehiclechassis.contact_generation" }
	S.tags = { "h", "vehiclechassis", "constraint", "physics" }
	S.description = "Vehicle Chassis Constraint Solver: sequential impulses, friction, joints and warm starting for the Vehicle Chassis subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.vehiclechassis.constraint_solver", iterations = 12, baumgarte = 0.28, warmStart = true })
		inst.system = S
		inst.ctx = ctx
