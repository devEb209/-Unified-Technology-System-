-- ARKHER SYSTEM H.0604 :: Explosion Force Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0604"
	S.key = "arkher.physics.explosion.collision_shape"
	S.name = "Explosion Force Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.explosion.body_dynamics" }
	S.tags = { "h", "explosion", "collider", "physics" }
	S.description = "Explosion Force Collision Shape: shape bounds, support mapping and closest points for the Explosion Force subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.explosion.collision_shape", shape = "capsule", radius = 2.70, height = 2.30, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
