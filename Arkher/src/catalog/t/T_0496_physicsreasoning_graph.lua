-- ARKHER SYSTEM T.0496 :: Physics Reasoning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0496"
	S.key = "arkher.ai.physicsreasoning.reasoning_graph"
	S.name = "Physics Reasoning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.physicsreasoning.world_architect" }
	S.tags = { "t", "physicsreasoning", "graph", "ai" }
	S.description = "Physics Reasoning Reasoning Graph: relationship modelling and shortest-path reasoning for the Physics Reasoning subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.physicsreasoning.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
