-- ARKHER SYSTEM F.0649 :: Mobile Fast Path Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0649"
	S.key = "arkher.render.mobilepath.lighting_rig"
	S.name = "Mobile Fast Path Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.mobilepath.geometry_virtualization" }
	S.tags = { "f", "mobilepath", "lightrig", "render" }
	S.description = "Mobile Fast Path Lighting Rig: light clustering, importance and cascades for the Mobile Fast Path subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.mobilepath.lighting_rig", maxActive = 9 })
		inst.system = S
		inst.ctx = ctx
