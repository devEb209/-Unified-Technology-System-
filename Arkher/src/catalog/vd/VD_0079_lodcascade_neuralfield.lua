-- ARKHER SYSTEM VD.0079 :: LOD Cascade Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0079"
	S.key = "arkher.contsim.lodcascade.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lodcascade.coherence_guard" }
	S.tags = { "vd", "lodcascade", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.lodcascade.neural_field", dims = 16, hidden = 12, seed = 31737 })
		inst.system = S
		inst.ctx = ctx
