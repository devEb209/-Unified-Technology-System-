-- ARKHER SYSTEM VB.0625 :: Interest Field Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0625"
	S.key = "arkher.conttime.interestfield.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "interestfield", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.interestfield.infinite_grid", cellSize = 160, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
