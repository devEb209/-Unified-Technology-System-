-- ARKHER SYSTEM I.0503 :: Cloth Animation Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0503"
	S.key = "arkher.anim.clothanim.playback_pipeline"
	S.name = "Cloth Animation Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clothanim.event_ledger" }
	S.tags = { "i", "clothanim", "pipeline", "anim" }
	S.description = "Cloth Animation Playback Pipeline: ordered sample, blend, ik and output stages for the Cloth Animation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.clothanim.playback_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
