-- ARKHER SYSTEM N.0092 :: Muzzle Flash Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0092"
	S.key = "arkher.vfx.muzzleflash.emission"
	S.name = "Muzzle Flash Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Muzzle Flash"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "muzzleflash", "emitter", "vfx" }
	S.description = "Muzzle Flash Emission: shaped, rate and burst emission of new particles for the Muzzle Flash subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.muzzleflash.emission", shape = "cone", rate = 44, speed = 3.40, life = 3.20, budget = 384, seed = 66924 })
		inst.system = S
		inst.ctx = ctx
