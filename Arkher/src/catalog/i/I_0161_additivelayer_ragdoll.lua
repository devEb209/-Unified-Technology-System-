-- ARKHER SYSTEM I.0161 :: Additive Layer Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0161"
	S.key = "arkher.anim.additivelayer.physical_blend"
	S.name = "Additive Layer Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.additivelayer.inverse_kinematics" }
	S.tags = { "i", "additivelayer", "ragdoll", "anim" }
	S.description = "Additive Layer Physical Blend: physical bones blended against the animated pose for the Additive Layer subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.additivelayer.physical_blend", blendSpeed = 2.60 })
		inst.system = S
		inst.ctx = ctx
