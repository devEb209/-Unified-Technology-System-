-- ARKHER SYSTEM J.0002 :: Digital Human Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0002"
	S.key = "arkher.character.digitalhuman.motion_set"
	S.name = "Digital Human Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.digitalhuman.rig_definition" }
	S.tags = { "j", "digitalhuman", "clip", "character" }
	S.description = "Digital Human Motion Set: the clips a character owns and how they sample for the Digital Human subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.digitalhuman.motion_set", duration = 2.60, loop = false })
		inst.system = S
		inst.ctx = ctx
