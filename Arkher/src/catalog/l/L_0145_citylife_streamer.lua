-- ARKHER SYSTEM L.0145 :: City Life Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0145"
	S.key = "arkher.sim.citylife.streaming"
	S.name = "City Life Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.citylife.state_codec" }
	S.tags = { "l", "citylife", "streamer", "sim" }
	S.description = "City Life Streaming: distance-driven residency of simulated regions for the City Life subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.citylife.streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
