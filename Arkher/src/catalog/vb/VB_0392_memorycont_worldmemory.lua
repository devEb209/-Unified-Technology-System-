-- ARKHER SYSTEM VB.0392 :: Memory Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0392"
	S.key = "arkher.conttime.memorycont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memorycont.neural_field" }
	S.tags = { "vb", "memorycont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.memorycont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
