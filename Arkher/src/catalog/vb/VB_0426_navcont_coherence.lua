-- ARKHER SYSTEM VB.0426 :: Navigation Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0426"
	S.key = "arkher.conttime.navcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.navcont.persistent_state" }
	S.tags = { "vb", "navcont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.navcont.coherence_guard", window = 67, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
