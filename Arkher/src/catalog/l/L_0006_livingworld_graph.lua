-- ARKHER SYSTEM L.0006 :: Living World Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0006"
	S.key = "arkher.sim.livingworld.region_graph"
	S.name = "Living World Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livingworld.calendar" }
	S.tags = { "l", "livingworld", "graph", "sim" }
	S.description = "Living World Region Graph: connectivity, components and shortest path between places for the Living World subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.livingworld.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
