-- ARKHER SYSTEM W.0366 :: Cinematic Audio Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0366"
	S.key = "arkher.cine.cinematicaudio.playback_orchestrator"
	S.name = "Cinematic Audio Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinematicaudio.cut_policy" }
	S.tags = { "w", "cinematicaudio", "orchestrator", "cine" }
	S.description = "Cinematic Audio Playback Orchestrator: the state machine that drives a cinematic from start to end for the Cinematic Audio subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.cinematicaudio.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
