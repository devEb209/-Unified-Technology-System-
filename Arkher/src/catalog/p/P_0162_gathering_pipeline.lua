-- ARKHER SYSTEM P.0162 :: Gathering Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0162"
	S.key = "arkher.play.gathering.rule_pipeline"
	S.name = "Gathering Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Gathering"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.gathering.state_machine" }
	S.tags = { "p", "gathering", "pipeline", "play" }
	S.description = "Gathering Rule Pipeline: ordered rules applied to every gameplay event for the Gathering subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.gathering.rule_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
