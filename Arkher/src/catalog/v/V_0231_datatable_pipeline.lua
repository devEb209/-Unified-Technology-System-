-- ARKHER SYSTEM V.0231 :: Data Table Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0231"
	S.key = "arkher.asset.datatable.cook_pipeline"
	S.name = "Data Table Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.datatable.bundling" }
	S.tags = { "v", "datatable", "pipeline", "asset" }
	S.description = "Data Table Cook Pipeline: staged cooking with isolation and retries for the Data Table subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.datatable.cook_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
