-- ARKHER SYSTEM Z.0545 :: Reputation Web World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0545"
	S.key = "arkher.origin.reputationweb.world_memory"
	S.name = "Reputation Web World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.autonomous_pipeline" }
	S.tags = { "z", "reputationweb", "worldmemory", "origin" }
	S.description = "Reputation Web World Memory: epoch-stamped persistent history with compaction and checkpoints for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.reputationweb.world_memory", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
