-- ARKHER SYSTEM H.0396 :: Contact Manifold Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0396"
	S.key = "arkher.physics.manifold.constraint_solver"
	S.name = "Contact Manifold Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.manifold.contact_generation" }
	S.tags = { "h", "manifold", "constraint", "physics" }
	S.description = "Contact Manifold Constraint Solver: sequential impulses, friction, joints and warm starting for the Contact Manifold subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.manifold.constraint_solver", iterations = 10, baumgarte = 0.16, warmStart = true })
		inst.system = S
		inst.ctx = ctx
