-- ARKHER SYSTEM H.0677 :: Shapecast Query Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0677"
	S.key = "arkher.physics.shapecast.query"
	S.name = "Shapecast Query Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.shapecast.constraint_solver" }
	S.tags = { "h", "shapecast", "raycaster", "physics" }
	S.description = "Shapecast Query Query: rays, sweeps and overlaps against the simulation for the Shapecast Query subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.shapecast.query", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
