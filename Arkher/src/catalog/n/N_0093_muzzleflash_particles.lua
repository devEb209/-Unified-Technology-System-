-- ARKHER SYSTEM N.0093 :: Muzzle Flash Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0093"
	S.key = "arkher.vfx.muzzleflash.particle_simulation"
	S.name = "Muzzle Flash Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Muzzle Flash"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.muzzleflash.emission" }
	S.tags = { "n", "muzzleflash", "particles", "vfx" }
	S.description = "Muzzle Flash Particle Simulation: pooled integration of position, velocity, colour and life for the Muzzle Flash subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.muzzleflash.particle_simulation", capacity = 576, drag = 0.12, bounce = 0.27, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
