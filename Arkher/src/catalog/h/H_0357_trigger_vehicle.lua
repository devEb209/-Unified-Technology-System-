-- ARKHER SYSTEM H.0357 :: Trigger Volume Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0357"
	S.key = "arkher.physics.trigger.vehicle"
	S.name = "Trigger Volume Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.trigger.character_motion" }
	S.tags = { "h", "trigger", "vehicle", "physics" }
	S.description = "Trigger Volume Vehicle: suspension, drivetrain, steering and tire friction for the Trigger Volume subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.trigger.vehicle", mass = 1000, wheelbase = 3.30, track = 2.10, maxRpm = 6700 })
		inst.system = S
		inst.ctx = ctx
