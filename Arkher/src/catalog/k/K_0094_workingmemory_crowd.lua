-- ARKHER SYSTEM K.0094 :: Working Memory Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0094"
	S.key = "arkher.npc.workingmemory.crowd_steering"
	S.name = "Working Memory Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workingmemory.navigation" }
	S.tags = { "k", "workingmemory", "crowd", "npc" }
	S.description = "Working Memory Crowd Steering: local avoidance, cohesion and arrival at scale for the Working Memory subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.workingmemory.crowd_steering", radius = 0.80, maxSpeed = 5.80, cellSize = 10 })
		inst.system = S
		inst.ctx = ctx
