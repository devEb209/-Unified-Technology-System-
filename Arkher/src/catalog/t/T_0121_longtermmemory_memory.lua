-- ARKHER SYSTEM T.0121 :: Long Term Memory Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0121"
	S.key = "arkher.ai.longtermmemory.working_memory"
	S.name = "Long Term Memory Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.longtermmemory.outcome_prediction" }
	S.tags = { "t", "longtermmemory", "memory", "ai" }
	S.description = "Long Term Memory Working Memory: decaying, consolidating recall of what the agent learned for the Long Term Memory subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.longtermmemory.working_memory", capacity = 43, decayRate = 0.065, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
