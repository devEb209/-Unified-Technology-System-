-- ARKHER SYSTEM VC.0135 :: Fidelity Band Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0135"
	S.key = "arkher.contneural.fidelityband.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.fidelityband.epoch_clock" }
	S.tags = { "vc", "fidelityband", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.fidelityband.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
