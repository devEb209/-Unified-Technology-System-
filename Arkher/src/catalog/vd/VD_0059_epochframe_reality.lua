-- ARKHER SYSTEM VD.0059 :: Epoch Frame Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0059"
	S.key = "arkher.contsim.epochframe.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.epochframe.simulation_fabric" }
	S.tags = { "vd", "epochframe", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.epochframe.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
