...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Continuum World — CORE Map #0248", size=Vector2.new(680, 480), pos=UDim2.fromOffset(124, 136), parent=parent, icon="⚑"})
