-- ARKHER SYSTEM N.0197 :: Cloud Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0197"
	S.key = "arkher.vfx.cloud.particle_simulation"
	S.name = "Cloud Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloud"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.cloud.emission" }
	S.tags = { "n", "cloud", "particles", "vfx" }
	S.description = "Cloud Particle Simulation: pooled integration of position, velocity, colour and life for the Cloud subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.cloud.particle_simulation", capacity = 384, drag = 0.17, bounce = 0.42, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
