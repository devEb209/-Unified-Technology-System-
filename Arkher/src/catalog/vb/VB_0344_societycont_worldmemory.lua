-- ARKHER SYSTEM VB.0344 :: Society Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0344"
	S.key = "arkher.conttime.societycont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.societycont.neural_field" }
	S.tags = { "vb", "societycont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.societycont.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
