-- ARKHER SYSTEM T.0465 :: Reward Modelling Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0465"
	S.key = "arkher.ai.rewardmodelling.plan_workflow"
	S.name = "Reward Modelling Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.rewardmodelling.semantic_knowledge" }
	S.tags = { "t", "rewardmodelling", "workflow", "ai" }
	S.description = "Reward Modelling Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Reward Modelling subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.rewardmodelling.plan_workflow", maxRetries = 1, budget = 70 })
		inst.system = S
		inst.ctx = ctx
