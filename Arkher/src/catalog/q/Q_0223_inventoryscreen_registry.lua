-- ARKHER SYSTEM Q.0223 :: Inventory Screen Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0223"
	S.key = "arkher.ui.inventoryscreen.localization_registry"
	S.name = "Inventory Screen Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.inventoryscreen.theme_composition" }
	S.tags = { "q", "inventoryscreen", "registry", "ui" }
	S.description = "Inventory Screen Localization Registry: catalogue of strings, plurals and locale metadata for the Inventory Screen subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.inventoryscreen.localization_registry" })
		inst.system = S
		inst.ctx = ctx
