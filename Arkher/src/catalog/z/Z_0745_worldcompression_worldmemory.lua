-- ARKHER SYSTEM Z.0745 :: World Compression World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0745"
	S.key = "arkher.origin.worldcompression.world_memory"
	S.name = "World Compression World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.autonomous_pipeline" }
	S.tags = { "z", "worldcompression", "worldmemory", "origin" }
	S.description = "World Compression World Memory: epoch-stamped persistent history with compaction and checkpoints for the World Compression subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.worldcompression.world_memory", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
