-- ARKHER SYSTEM T.0559 :: Scene Reasoning Learning Analysis
...
return function(A)
	...
	local S = {}
	S.id = "T.0559"
	S.key = "arkher.ai.scenereasoning.learning_analysis"
	S.name = "Scene Reasoning Learning Analysis"
	S.category = "T"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.scenereasoning.model_inference" }
	S.tags = { "t", "scenereasoning", "analyzer", "ai" }
	S.description = "Scene Reasoning Learning Analysis: trend, anomaly and improvement analysis of the agent for the Scene Reasoning subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ai.scenereasoning.learning_analysis", window = 230, buckets = 14, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
