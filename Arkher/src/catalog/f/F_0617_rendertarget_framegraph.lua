-- ARKHER SYSTEM F.0617 :: Render Target Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0617"
	S.key = "arkher.render.rendertarget.frame_graph"
	S.name = "Render Target Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "rendertarget", "framegraph", "render" }
	S.description = "Render Target Frame Graph: declared passes, culling, ordering and aliasing for the Render Target subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.rendertarget.frame_graph", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
