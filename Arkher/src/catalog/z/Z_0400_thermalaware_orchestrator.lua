-- ARKHER SYSTEM Z.0400 :: Thermal Aware Simulation Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0400"
	S.key = "arkher.origin.thermalaware.orchestration"
	S.name = "Thermal Aware Simulation Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.residency_streaming" }
	S.tags = { "z", "thermalaware", "orchestrator", "origin" }
	S.description = "Thermal Aware Simulation Orchestration: lifecycle and phase orchestration of the technology for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.thermalaware.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
