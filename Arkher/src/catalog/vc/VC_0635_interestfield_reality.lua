-- ARKHER SYSTEM VC.0635 :: Interest Field Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0635"
	S.key = "arkher.contneural.interestfield.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.interestfield.simulation_fabric" }
	S.tags = { "vc", "interestfield", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.interestfield.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
