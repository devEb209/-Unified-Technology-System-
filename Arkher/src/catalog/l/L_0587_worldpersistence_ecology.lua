-- ARKHER SYSTEM L.0587 :: World Persistence Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0587"
	S.key = "arkher.sim.worldpersistence.ecology"
	S.name = "World Persistence Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldpersistence.simulation_core" }
	S.tags = { "l", "worldpersistence", "ecology", "sim" }
	S.description = "World Persistence Ecology: populations, predation, harvesting and carrying capacity for the World Persistence subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.worldpersistence.ecology" })
		inst.system = S
		inst.ctx = ctx
