-- ARKHER SYSTEM T.0696 :: AI Debug Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0696"
	S.key = "arkher.ai.aidebug.utility_selection"
	S.name = "AI Debug Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.aidebug.working_memory" }
	S.tags = { "t", "aidebug", "utility", "ai" }
	S.description = "AI Debug Utility Selection: scored choice between competing courses of action for the AI Debug subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.aidebug.utility_selection", momentum = 0.03 })
		inst.system = S
		inst.ctx = ctx
