-- ARKHER SYSTEM T.0171 :: Asset Generation Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0171"
	S.key = "arkher.ai.assetgeneration.plan_workflow"
	S.name = "Asset Generation Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.assetgeneration.semantic_knowledge" }
	S.tags = { "t", "assetgeneration", "workflow", "ai" }
	S.description = "Asset Generation Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Asset Generation subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.assetgeneration.plan_workflow", maxRetries = 1, budget = 70 })
		inst.system = S
		inst.ctx = ctx
