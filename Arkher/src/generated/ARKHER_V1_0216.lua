--!strict
-- Decima Workshop — CORE Node_Flow #0216
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Decima Workshop — CORE Node_Flow #0216", size=Vector2.new(600, 440), pos=UDim2.fromOffset(108, 112), parent=parent, icon="☀"})
