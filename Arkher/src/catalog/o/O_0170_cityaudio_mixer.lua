-- ARKHER SYSTEM O.0170 :: City Audio Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0170"
	S.key = "arkher.audio.cityaudio.mixer_bus"
	S.name = "City Audio Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "City Audio"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.cityaudio.dsp_chain" }
	S.tags = { "o", "cityaudio", "mixer", "audio" }
	S.description = "City Audio Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the City Audio subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.cityaudio.mixer_bus", maxVoices = 40 })
		inst.system = S
		inst.ctx = ctx
