-- ARKHER SYSTEM I.0404 :: Animation Streaming Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0404"
	S.key = "arkher.anim.animstreaming.skeleton"
	S.name = "Animation Streaming Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "animstreaming", "skeleton", "anim" }
	S.description = "Animation Streaming Skeleton: bone hierarchy, bind pose and world resolution for the Animation Streaming subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.animstreaming.skeleton" })
		inst.system = S
		inst.ctx = ctx
