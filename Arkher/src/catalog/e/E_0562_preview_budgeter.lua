-- ARKHER SYSTEM E.0562 :: Material Preview Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0562"
	S.key = "arkher.material.preview.parameter_budget"
	S.name = "Material Preview Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.preview.variant_registry" }
	S.tags = { "e", "preview", "budgeter", "material" }
	S.description = "Material Preview Parameter Budget: texel and layer budget allocation for the Material Preview subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.preview.parameter_budget", total = 213, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
