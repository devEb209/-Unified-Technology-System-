-- ARKHER SYSTEM I.0080 :: Curve Interpolation Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0080"
	S.key = "arkher.anim.curveinterp.clip_sampling"
	S.name = "Curve Interpolation Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.curveinterp.skeleton" }
	S.tags = { "i", "curveinterp", "clip", "anim" }
	S.description = "Curve Interpolation Clip Sampling: keyframe tracks sampled, retimed and evented for the Curve Interpolation subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.curveinterp.clip_sampling", duration = 0.70, loop = true })
		inst.system = S
		inst.ctx = ctx
