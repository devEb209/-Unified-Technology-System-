-- ARKHER SYSTEM L.0193 :: Wildlife Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0193"
	S.key = "arkher.sim.wildlife.analysis"
	S.name = "Wildlife Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wildlife.aggregate_cache" }
	S.tags = { "l", "wildlife", "analyzer", "sim" }
	S.description = "Wildlife Analysis: trend, anomaly and stability analysis of the world for the Wildlife subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.wildlife.analysis", window = 235, buckets = 15, threshold = 2.70 })
		inst.system = S
		inst.ctx = ctx
