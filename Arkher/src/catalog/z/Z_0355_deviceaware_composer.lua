-- ARKHER SYSTEM Z.0355 :: Device Aware Fidelity Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0355"
	S.key = "arkher.origin.deviceaware.signal_composition"
	S.name = "Device Aware Fidelity Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.telemetry_ledger" }
	S.tags = { "z", "deviceaware", "composer", "origin" }
	S.description = "Device Aware Fidelity Signal Composition: blending of the technology's input signals into one output for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.deviceaware.signal_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
