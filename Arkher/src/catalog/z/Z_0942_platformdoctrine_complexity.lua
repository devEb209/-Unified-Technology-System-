-- ARKHER SYSTEM Z.0942 :: Platform Abstraction Doctrine Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0942"
	S.key = "arkher.origin.platformdoctrine.complexity_governance"
	S.name = "Platform Abstraction Doctrine Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.platformdoctrine.reality_layering" }
	S.tags = { "z", "platformdoctrine", "complexity", "origin" }
	S.description = "Platform Abstraction Doctrine Complexity Governance: measured scene cost turned into per-subsystem directives for the Platform Abstraction Doctrine subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.platformdoctrine.complexity_governance", targetMs = 19.0 })
		inst.system = S
		inst.ctx = ctx
