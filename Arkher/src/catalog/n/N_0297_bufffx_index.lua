-- ARKHER SYSTEM N.0297 :: Buff Effect Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0297"
	S.key = "arkher.vfx.bufffx.spatial_index"
	S.name = "Buff Effect Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Buff Effect"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.bufffx.quality_policy" }
	S.tags = { "n", "bufffx", "index", "vfx" }
	S.description = "Buff Effect Spatial Index: spatial acceleration of effect queries and culling for the Buff Effect subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.bufffx.spatial_index", mode = "hash", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
