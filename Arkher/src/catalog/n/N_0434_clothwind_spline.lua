-- ARKHER SYSTEM N.0434 :: Cloth Wind Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0434"
	S.key = "arkher.vfx.clothwind.curve_authoring"
	S.name = "Cloth Wind Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloth Wind"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.clothwind.ribbon_and_trail" }
	S.tags = { "n", "clothwind", "spline", "vfx" }
	S.description = "Cloth Wind Curve Authoring: authored curves driving the effect over its life for the Cloth Wind subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.clothwind.curve_authoring", tension = 0.52, closed = false })
		inst.system = S
		inst.ctx = ctx
