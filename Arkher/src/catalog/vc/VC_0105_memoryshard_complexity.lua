-- ARKHER SYSTEM VC.0105 :: Memory Shard Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0105"
	S.key = "arkher.contneural.memoryshard.complexity_budget"
	S.name = "Memory Shard Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memoryshard.world_memory_stream" }
	S.tags = { "vc", "memoryshard", "complexity", "contneural" }
	S.description = "Memory Shard Complexity Budget: complexity budgeting for the continuum for the Memory Shard subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.memoryshard.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
