-- ARKHER SYSTEM T.0571 :: Pipeline Automation Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0571"
	S.key = "arkher.ai.pipelineautomation.action_planner"
	S.name = "Pipeline Automation Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.pipelineautomation.utility_selection" }
	S.tags = { "t", "pipelineautomation", "planner", "ai" }
	S.description = "Pipeline Automation Action Planner: goal-oriented action planning over preconditions for the Pipeline Automation subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.pipelineautomation.action_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
