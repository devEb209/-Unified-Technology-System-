-- ARKHER SYSTEM W.0091 :: Crane Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0091"
	S.key = "arkher.cine.crane.motion_tween"
	S.name = "Crane Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Crane"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.crane.playback_orchestrator" }
	S.tags = { "w", "crane", "tween", "cine" }
	S.description = "Crane Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Crane subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.crane.motion_tween", timeScale = 1.11 })
		inst.system = S
		inst.ctx = ctx
