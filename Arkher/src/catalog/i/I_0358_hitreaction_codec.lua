-- ARKHER SYSTEM I.0358 :: Hit Reaction Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0358"
	S.key = "arkher.anim.hitreaction.compression_codec"
	S.name = "Hit Reaction Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Hit Reaction"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.hitreaction.retarget_graph" }
	S.tags = { "i", "hitreaction", "codec", "anim" }
	S.description = "Hit Reaction Compression Codec: curve compression and quantized transport for the Hit Reaction subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.hitreaction.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
