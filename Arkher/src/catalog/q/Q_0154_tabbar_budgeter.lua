-- ARKHER SYSTEM Q.0154 :: Tab Bar Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0154"
	S.key = "arkher.ui.tabbar.frame_budget"
	S.name = "Tab Bar Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tab Bar"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.tabbar.accessibility_policy" }
	S.tags = { "q", "tabbar", "budgeter", "ui" }
	S.description = "Tab Bar Frame Budget: per-frame layout and draw budget for the interface for the Tab Bar subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.tabbar.frame_budget", total = 161, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
