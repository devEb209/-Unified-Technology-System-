-- ARKHER SYSTEM L.0494 :: Diplomacy Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0494"
	S.key = "arkher.sim.diplomacy.forecast"
	S.name = "Diplomacy Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.diplomacy.analysis" }
	S.tags = { "l", "diplomacy", "predictor", "sim" }
	S.description = "Diplomacy Forecast: prediction of the region's next state for the Diplomacy subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.diplomacy.forecast", method = "ema", alpha = 0.24, window = 38 })
		inst.system = S
		inst.ctx = ctx
