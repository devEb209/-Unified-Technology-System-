-- ARKHER SYSTEM J.0061 :: Eyes Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0061"
	S.key = "arkher.character.eyes.locomotion"
	S.name = "Eyes Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.eyes.physical_response" }
	S.tags = { "j", "eyes", "charmotor", "character" }
	S.description = "Eyes Locomotion: capsule locomotion driving the character for the Eyes subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.eyes.locomotion", radius = 0.35, height = 1.80, maxSpeed = 8.00, jumpHeight = 1.60, stepOffset = 0.35 })
		inst.system = S
		inst.ctx = ctx
