-- ARKHER SYSTEM Z.0376 :: Mobile First Governor Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0376"
	S.key = "arkher.origin.mobilefirst.governance_policy"
	S.name = "Mobile First Governor Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.signal_composition" }
	S.tags = { "z", "mobilefirst", "policy", "origin" }
	S.description = "Mobile First Governor Governance Policy: ordered rules governing when the technology may act for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.mobilefirst.governance_policy", algorithm = "roundrobin", starvationGuard = 24 })
		inst.system = S
		inst.ctx = ctx
