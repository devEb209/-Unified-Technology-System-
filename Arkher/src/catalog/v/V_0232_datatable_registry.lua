-- ARKHER SYSTEM V.0232 :: Data Table Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0232"
	S.key = "arkher.asset.datatable.asset_registry"
	S.name = "Data Table Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.datatable.cook_pipeline" }
	S.tags = { "v", "datatable", "registry", "asset" }
	S.description = "Data Table Asset Registry: catalogue of every asset, its tags and its metadata for the Data Table subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.datatable.asset_registry" })
		inst.system = S
		inst.ctx = ctx
