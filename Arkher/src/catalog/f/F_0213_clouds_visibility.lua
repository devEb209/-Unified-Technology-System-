-- ARKHER SYSTEM F.0213 :: Cloud Rendering Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0213"
	S.key = "arkher.render.clouds.visibility_set"
	S.name = "Cloud Rendering Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.clouds.view_and_culling" }
	S.tags = { "f", "clouds", "visibility", "render" }
	S.description = "Cloud Rendering Visibility Set: cell, portal and occluder visibility for the Cloud Rendering subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.clouds.visibility_set", maxDepth = 2 })
		inst.system = S
		inst.ctx = ctx
