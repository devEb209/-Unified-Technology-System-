-- ARKHER SYSTEM L.0010 :: Living World Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0010"
	S.key = "arkher.sim.livingworld.streaming"
	S.name = "Living World Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livingworld.state_codec" }
	S.tags = { "l", "livingworld", "streamer", "sim" }
	S.description = "Living World Streaming: distance-driven residency of simulated regions for the Living World subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.livingworld.streaming", radius = 320, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
