-- ARKHER SYSTEM J.0301 :: Crowd Instance Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0301"
	S.key = "arkher.character.crowdinstance.look_and_reach"
	S.name = "Crowd Instance Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.crowdinstance.blend_controller" }
	S.tags = { "j", "crowdinstance", "ik", "character" }
	S.description = "Crowd Instance Look And Reach: look-at, reach and foot placement for the character for the Crowd Instance subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.crowdinstance.look_and_reach", iterations = 8, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
