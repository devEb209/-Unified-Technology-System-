-- ARKHER SYSTEM L.0381 :: Caravan Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0381"
	S.key = "arkher.sim.caravan.region_graph"
	S.name = "Caravan Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.caravan.calendar" }
	S.tags = { "l", "caravan", "graph", "sim" }
	S.description = "Caravan Region Graph: connectivity, components and shortest path between places for the Caravan subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.caravan.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
