-- ARKHER SYSTEM I.0369 :: Retargeting Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0369"
	S.key = "arkher.anim.retargeting.physical_blend"
	S.name = "Retargeting Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Retargeting"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.retargeting.inverse_kinematics" }
	S.tags = { "i", "retargeting", "ragdoll", "anim" }
	S.description = "Retargeting Physical Blend: physical bones blended against the animated pose for the Retargeting subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.retargeting.physical_blend", blendSpeed = 2.30 })
		inst.system = S
		inst.ctx = ctx
