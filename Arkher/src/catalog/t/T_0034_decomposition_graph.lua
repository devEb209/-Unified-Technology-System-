-- ARKHER SYSTEM T.0034 :: Task Decomposition Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0034"
	S.key = "arkher.ai.decomposition.reasoning_graph"
	S.name = "Task Decomposition Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.decomposition.world_architect" }
	S.tags = { "t", "decomposition", "graph", "ai" }
	S.description = "Task Decomposition Reasoning Graph: relationship modelling and shortest-path reasoning for the Task Decomposition subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.decomposition.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
