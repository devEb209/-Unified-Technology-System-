-- ARKHER SYSTEM R.0176 :: Interpolation Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0176"
	S.key = "arkher.net.interpolation.rate_guard"
	S.name = "Interpolation Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.interpolation.interest_streaming" }
	S.tags = { "r", "interpolation", "guard", "net" }
	S.description = "Interpolation Rate Guard: token-bucket protection against floods and abuse for the Interpolation subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.interpolation.rate_guard", algorithm = "token", capacity = 134, refillPerSec = 59, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
