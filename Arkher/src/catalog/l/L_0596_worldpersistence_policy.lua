-- ARKHER SYSTEM L.0596 :: World Persistence Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0596"
	S.key = "arkher.sim.worldpersistence.fidelity_policy"
	S.name = "World Persistence Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldpersistence.streaming" }
	S.tags = { "l", "worldpersistence", "policy", "sim" }
	S.description = "World Persistence Fidelity Policy: rules that pick full, cohort or statistical simulation for the World Persistence subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.worldpersistence.fidelity_policy", algorithm = "edf", starvationGuard = 17 })
		inst.system = S
		inst.ctx = ctx
