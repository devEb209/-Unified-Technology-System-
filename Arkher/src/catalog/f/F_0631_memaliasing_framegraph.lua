-- ARKHER SYSTEM F.0631 :: Memory Aliasing Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0631"
	S.key = "arkher.render.memaliasing.frame_graph"
	S.name = "Memory Aliasing Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "memaliasing", "framegraph", "render" }
	S.description = "Memory Aliasing Frame Graph: declared passes, culling, ordering and aliasing for the Memory Aliasing subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.memaliasing.frame_graph", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
