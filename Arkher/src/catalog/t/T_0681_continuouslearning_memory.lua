-- ARKHER SYSTEM T.0681 :: Continuous Learning Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0681"
	S.key = "arkher.ai.continuouslearning.working_memory"
	S.name = "Continuous Learning Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.continuouslearning.outcome_prediction" }
	S.tags = { "t", "continuouslearning", "memory", "ai" }
	S.description = "Continuous Learning Working Memory: decaying, consolidating recall of what the agent learned for the Continuous Learning subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.continuouslearning.working_memory", capacity = 87, decayRate = 0.055, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
