-- ARKHER SYSTEM Z.0600 :: Self Healing Systems Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0600"
	S.key = "arkher.origin.selfhealing.orchestration"
	S.name = "Self Healing Systems Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfhealing.residency_streaming" }
	S.tags = { "z", "selfhealing", "orchestrator", "origin" }
	S.description = "Self Healing Systems Orchestration: lifecycle and phase orchestration of the technology for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.selfhealing.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
