-- ARKHER SYSTEM E.0597 :: Material Migration Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0597"
	S.key = "arkher.material.migration.analysis"
	S.name = "Material Migration Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.migration.instance_cache" }
	S.tags = { "e", "migration", "analyzer", "material" }
	S.description = "Material Migration Analysis: cost, redundancy and outlier analysis for the Material Migration subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.migration.analysis", window = 198, buckets = 10, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
