-- ARKHER SYSTEM E.0228 :: Layer Blending Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0228"
	S.key = "arkher.material.layerblend.shading_graph"
	S.name = "Layer Blending Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.layerblend.layer_composition" }
	S.tags = { "e", "layerblend", "shadegraph", "material" }
	S.description = "Layer Blending Shading Graph: node graph evaluated and compiled to Luau for the Layer Blending subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.layerblend.shading_graph" })
		inst.system = S
		inst.ctx = ctx
