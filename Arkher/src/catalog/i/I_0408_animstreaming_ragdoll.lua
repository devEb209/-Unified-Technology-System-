-- ARKHER SYSTEM I.0408 :: Animation Streaming Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0408"
	S.key = "arkher.anim.animstreaming.physical_blend"
	S.name = "Animation Streaming Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstreaming.inverse_kinematics" }
	S.tags = { "i", "animstreaming", "ragdoll", "anim" }
	S.description = "Animation Streaming Physical Blend: physical bones blended against the animated pose for the Animation Streaming subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.animstreaming.physical_blend", blendSpeed = 5.10 })
		inst.system = S
		inst.ctx = ctx
