-- ARKHER SYSTEM VB.0341 :: Society Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0341"
	S.key = "arkher.conttime.societycont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.societycont.multi-scale_fidelity" }
	S.tags = { "vb", "societycont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.societycont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
