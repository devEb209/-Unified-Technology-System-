-- ARKHER SYSTEM H.0414 :: Restitution Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0414"
	S.key = "arkher.physics.restitution.broadphase_index"
	S.name = "Restitution Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Restitution"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.restitution.vehicle" }
	S.tags = { "h", "restitution", "index", "physics" }
	S.description = "Restitution Broadphase Index: spatial acceleration of candidate pair finding for the Restitution subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.restitution.broadphase_index", mode = "hash", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
