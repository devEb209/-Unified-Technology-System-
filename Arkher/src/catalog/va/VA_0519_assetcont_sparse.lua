-- ARKHER SYSTEM VA.0519 :: Asset Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0519"
	S.key = "arkher.contworld.assetcont.sparse_residency"
	S.name = "Asset Continuum Sparse Residency"
	S.category = "VA"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.assetcont.epoch_clock" }
	S.tags = { "va", "assetcont", "sparse", "contworld" }
	S.description = "Asset Continuum Sparse Residency: sparse page residency with eviction and compression for the Asset Continuum subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.assetcont.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
