-- ARKHER SYSTEM VA.0397 :: Perception Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0397"
	S.key = "arkher.contworld.perceptioncont.infinite_grid"
	S.name = "Perception Continuum Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "perceptioncont", "continuum", "contworld" }
	S.description = "Perception Continuum Infinite Grid: seamless paging of the infinite world grid for the Perception Continuum subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.perceptioncont.infinite_grid", cellSize = 224, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
