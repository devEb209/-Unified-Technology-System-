-- ARKHER SYSTEM N.0210 :: Lightning Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0210"
	S.key = "arkher.vfx.lightning.particle_simulation"
	S.name = "Lightning Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Lightning"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.lightning.emission" }
	S.tags = { "n", "lightning", "particles", "vfx" }
	S.description = "Lightning Particle Simulation: pooled integration of position, velocity, colour and life for the Lightning subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.lightning.particle_simulation", capacity = 448, drag = 0.22, bounce = 0.17, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
