-- ARKHER SYSTEM K.0250 :: Temperament Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0250"
	S.key = "arkher.npc.temperament.daily_schedule"
	S.name = "Temperament Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.temperament.social_relations" }
	S.tags = { "k", "temperament", "schedule", "npc" }
	S.description = "Temperament Daily Schedule: hour-by-hour routine with priority interruptions for the Temperament subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.temperament.daily_schedule", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
