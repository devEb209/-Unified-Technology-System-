-- ARKHER SYSTEM R.0331 :: Matchmaking Transport Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0331"
	S.key = "arkher.net.matchmakingtransport.interest_streaming"
	S.name = "Matchmaking Transport Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.matchmakingtransport.serialization_codec" }
	S.tags = { "r", "matchmakingtransport", "streamer", "net" }
	S.description = "Matchmaking Transport Interest Streaming: distance-driven residency of replicated content for the Matchmaking Transport subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.matchmakingtransport.interest_streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
