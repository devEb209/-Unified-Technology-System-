-- ARKHER SYSTEM VA.0225 :: Terrain Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0225"
	S.key = "arkher.contworld.terraincont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.terraincont.world_memory_stream" }
	S.tags = { "va", "terraincont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.terraincont.complexity_budget", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
