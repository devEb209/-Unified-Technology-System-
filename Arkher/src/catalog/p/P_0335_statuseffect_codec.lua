-- ARKHER SYSTEM P.0335 :: Status Effect Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0335"
	S.key = "arkher.play.statuseffect.save_codec"
	S.name = "Status Effect Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.statuseffect.content_registry" }
	S.tags = { "p", "statuseffect", "codec", "play" }
	S.description = "Status Effect Save Codec: persistence, diffing and checksum of gameplay state for the Status Effect subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.statuseffect.save_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
