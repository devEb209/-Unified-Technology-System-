-- ARKHER SYSTEM VA.0137 :: Fidelity Band Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0137"
	S.key = "arkher.contworld.fidelityband.persistent_state"
	S.name = "Fidelity Band Persistent State"
	S.category = "VA"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.fidelityband.multi-scale_fidelity" }
	S.tags = { "va", "fidelityband", "persistent", "contworld" }
	S.description = "Fidelity Band Persistent State: epoch-stamped persistent history and rollback for the Fidelity Band subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.fidelityband.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
