-- ARKHER SYSTEM N.0294 :: Buff Effect Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0294"
	S.key = "arkher.vfx.bufffx.spawn_budget"
	S.name = "Buff Effect Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Buff Effect"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.bufffx.effect_composition" }
	S.tags = { "n", "bufffx", "budgeter", "vfx" }
	S.description = "Buff Effect Spawn Budget: global particle budget shared by every live effect for the Buff Effect subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.bufffx.spawn_budget", total = 179, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
