-- ARKHER SYSTEM F.0242 :: Reflection Probe Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0242"
	S.key = "arkher.render.reflectionprobe.geometry_virtualization"
	S.name = "Reflection Probe Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.reflectionprobe.visibility_set" }
	S.tags = { "f", "reflectionprobe", "impostor", "render" }
	S.description = "Reflection Probe Geometry Virtualization: impostor and HLOD synthesis under a budget for the Reflection Probe subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.reflectionprobe.geometry_virtualization", atlasSlots = 32, viewCount = 8, errorThreshold = 1.00 })
		inst.system = S
		inst.ctx = ctx
