-- ARKHER SYSTEM F.0293 :: Color Grading Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0293"
	S.key = "arkher.render.grading.orchestration"
	S.name = "Color Grading Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.grading.frame_analysis" }
	S.tags = { "f", "grading", "orchestrator", "render" }
	S.description = "Color Grading Orchestration: frame lifecycle orchestration for the Color Grading subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.grading.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
