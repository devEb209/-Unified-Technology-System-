-- ARKHER SYSTEM Z.0282 :: Temporal Continuity Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0282"
	S.key = "arkher.origin.temporalcontinuity.complexity_governance"
	S.name = "Temporal Continuity Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.temporalcontinuity.reality_layering" }
	S.tags = { "z", "temporalcontinuity", "complexity", "origin" }
	S.description = "Temporal Continuity Complexity Governance: measured scene cost turned into per-subsystem directives for the Temporal Continuity subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.temporalcontinuity.complexity_governance", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
