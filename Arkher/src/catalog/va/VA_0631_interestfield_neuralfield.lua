-- ARKHER SYSTEM VA.0631 :: Interest Field Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0631"
	S.key = "arkher.contworld.interestfield.neural_field"
	S.name = "Interest Field Neural Field"
	S.category = "VA"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.interestfield.coherence_guard" }
	S.tags = { "va", "interestfield", "neuralfield", "contworld" }
	S.description = "Interest Field Neural Field: neural field encoding and reconstruction for the Interest Field subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.interestfield.neural_field", dims = 16, hidden = 12, seed = 49557 })
		inst.system = S
		inst.ctx = ctx
