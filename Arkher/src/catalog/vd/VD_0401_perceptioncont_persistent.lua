-- ARKHER SYSTEM VD.0401 :: Perception Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0401"
	S.key = "arkher.contsim.perceptioncont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.perceptioncont.multi-scale_fidelity" }
	S.tags = { "vd", "perceptioncont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.perceptioncont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
