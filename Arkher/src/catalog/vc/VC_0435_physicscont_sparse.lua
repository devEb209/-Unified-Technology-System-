-- ARKHER SYSTEM VC.0435 :: Physics Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0435"
	S.key = "arkher.contneural.physicscont.sparse_residency"
	S.name = "Physics Continuum Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.physicscont.epoch_clock" }
	S.tags = { "vc", "physicscont", "sparse", "contneural" }
	S.description = "Physics Continuum Sparse Residency: sparse page residency with eviction and compression for the Physics Continuum subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.physicscont.sparse_residency", capacity = 256, pageBytes = 3072 })
		inst.system = S
		inst.ctx = ctx
