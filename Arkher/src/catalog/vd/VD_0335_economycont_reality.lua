-- ARKHER SYSTEM VD.0335 :: Economy Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0335"
	S.key = "arkher.contsim.economycont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.economycont.simulation_fabric" }
	S.tags = { "vd", "economycont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.economycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
