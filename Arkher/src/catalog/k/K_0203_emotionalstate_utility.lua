-- ARKHER SYSTEM K.0203 :: Emotional State Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0203"
	S.key = "arkher.npc.emotionalstate.utility_reasoning"
	S.name = "Emotional State Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.emotionalstate.reactive_behaviour" }
	S.tags = { "k", "emotionalstate", "utility", "npc" }
	S.description = "Emotional State Utility Reasoning: scored option selection with response curves for the Emotional State subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.emotionalstate.utility_reasoning", momentum = 0.10 })
		inst.system = S
		inst.ctx = ctx
