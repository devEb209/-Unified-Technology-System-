-- ARKHER SYSTEM VD.0275 :: Bridge Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0275"
	S.key = "arkher.contsim.bridgecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.bridgecont.simulation_fabric" }
	S.tags = { "vd", "bridgecont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.bridgecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
