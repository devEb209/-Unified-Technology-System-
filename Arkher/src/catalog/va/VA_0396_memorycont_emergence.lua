-- ARKHER SYSTEM VA.0396 :: Memory Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0396"
	S.key = "arkher.contworld.memorycont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memorycont.reality_continuum" }
	S.tags = { "va", "memorycont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.memorycont.emergence_continuum", windowSize = 6, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
