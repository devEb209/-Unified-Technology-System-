-- ARKHER SYSTEM G.0090 :: Ghosting Suppression Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0090"
	S.key = "arkher.neural.ghosting.weight_codec"
	S.name = "Ghosting Suppression Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ghosting.model_registry" }
	S.tags = { "g", "ghosting", "codec", "neural" }
	S.description = "Ghosting Suppression Weight Codec: weight serialization and quantized transport for the Ghosting Suppression subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.ghosting.weight_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
