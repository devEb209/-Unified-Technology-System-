-- ARKHER SYSTEM T.0327 :: Bug Triage World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0327"
	S.key = "arkher.ai.bugtriage.world_architect"
	S.name = "Bug Triage World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.bugtriage.self_critique" }
	S.tags = { "t", "bugtriage", "architect", "ai" }
	S.description = "Bug Triage World Architect: composition of a whole world plan with conserved budgets for the Bug Triage subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.bugtriage.world_architect", budget = 1500, seed = 40339 })
		inst.system = S
		inst.ctx = ctx
