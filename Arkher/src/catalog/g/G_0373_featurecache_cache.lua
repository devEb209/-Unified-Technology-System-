-- ARKHER SYSTEM G.0373 :: Feature Cache Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0373"
	S.key = "arkher.neural.featurecache.result_cache"
	S.name = "Feature Cache Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.featurecache.compute_budget" }
	S.tags = { "g", "featurecache", "cache", "neural" }
	S.description = "Feature Cache Result Cache: cached inference results keyed by input for the Feature Cache subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.featurecache.result_cache", policy = "lfu", capacity = 243, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
