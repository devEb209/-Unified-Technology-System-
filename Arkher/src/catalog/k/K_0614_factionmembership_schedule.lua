-- ARKHER SYSTEM K.0614 :: Faction Membership Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0614"
	S.key = "arkher.npc.factionmembership.daily_schedule"
	S.name = "Faction Membership Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.factionmembership.social_relations" }
	S.tags = { "k", "factionmembership", "schedule", "npc" }
	S.description = "Faction Membership Daily Schedule: hour-by-hour routine with priority interruptions for the Faction Membership subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.factionmembership.daily_schedule", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
