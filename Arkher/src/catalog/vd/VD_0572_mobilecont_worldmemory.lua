-- ARKHER SYSTEM VD.0572 :: Mobile Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0572"
	S.key = "arkher.contsim.mobilecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.mobilecont.neural_field" }
	S.tags = { "vd", "mobilecont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.mobilecont.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
