-- ARKHER SYSTEM P.0472 :: Gameplay Debug Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0472"
	S.key = "arkher.play.gameplaydebug.combat_resolution"
	S.name = "Gameplay Debug Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.gameplaydebug.objectives" }
	S.tags = { "p", "gameplaydebug", "combat", "play" }
	S.description = "Gameplay Debug Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Gameplay Debug subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.gameplaydebug.combat_resolution", seed = 38890, armourK = 100, critMultiplier = 2.50 })
		inst.system = S
		inst.ctx = ctx
