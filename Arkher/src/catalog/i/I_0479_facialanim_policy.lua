-- ARKHER SYSTEM I.0479 :: Facial Animation Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0479"
	S.key = "arkher.anim.facialanim.quality_policy"
	S.name = "Facial Animation Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.facialanim.pose_cache" }
	S.tags = { "i", "facialanim", "policy", "anim" }
	S.description = "Facial Animation Quality Policy: device tier rules for rate, bones and solvers for the Facial Animation subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.facialanim.quality_policy", algorithm = "lottery", starvationGuard = 59 })
		inst.system = S
		inst.ctx = ctx
