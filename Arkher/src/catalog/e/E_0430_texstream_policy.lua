-- ARKHER SYSTEM E.0430 :: Texture Streaming Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0430"
	S.key = "arkher.material.texstream.quality_policy"
	S.name = "Texture Streaming Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.texstream.compression_codec" }
	S.tags = { "e", "texstream", "policy", "material" }
	S.description = "Texture Streaming Quality Policy: device tier rules for the surface for the Texture Streaming subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.texstream.quality_policy", algorithm = "edf", starvationGuard = 61 })
		inst.system = S
		inst.ctx = ctx
