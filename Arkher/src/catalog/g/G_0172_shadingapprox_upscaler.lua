-- ARKHER SYSTEM G.0172 :: Shading Approximation Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0172"
	S.key = "arkher.neural.shadingapprox.reconstruction"
	S.name = "Shading Approximation Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.shadingapprox.temporal_history" }
	S.tags = { "g", "shadingapprox", "upscaler", "neural" }
	S.description = "Shading Approximation Reconstruction: resolution ladder and image reconstruction for the Shading Approximation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.shadingapprox.reconstruction", targetMs = 11.10, index = 3, sharpness = 0.56 })
		inst.system = S
		inst.ctx = ctx
