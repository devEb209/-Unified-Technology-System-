-- ARKHER SYSTEM P.0406 :: Match Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0406"
	S.key = "arkher.play.match.content_registry"
	S.name = "Match Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Match"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.match.difficulty_controller" }
	S.tags = { "p", "match", "registry", "play" }
	S.description = "Match Content Registry: catalogue of the definitions this loop instantiates for the Match subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.match.content_registry" })
		inst.system = S
		inst.ctx = ctx
