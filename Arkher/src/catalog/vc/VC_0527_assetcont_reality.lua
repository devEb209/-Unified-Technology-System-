-- ARKHER SYSTEM VC.0527 :: Asset Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0527"
	S.key = "arkher.contneural.assetcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.assetcont.simulation_fabric" }
	S.tags = { "vc", "assetcont", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.assetcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
