-- ARKHER SYSTEM VD.0593 :: Horizon Span Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0593"
	S.key = "arkher.contsim.horizonspan.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.horizonspan.multi-scale_fidelity" }
	S.tags = { "vd", "horizonspan", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.horizonspan.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
