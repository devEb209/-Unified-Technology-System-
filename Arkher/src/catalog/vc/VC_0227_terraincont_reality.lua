-- ARKHER SYSTEM VC.0227 :: Terrain Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0227"
	S.key = "arkher.contneural.terraincont.reality_continuum"
	S.name = "Terrain Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.terraincont.simulation_fabric" }
	S.tags = { "vc", "terraincont", "reality", "contneural" }
	S.description = "Terrain Continuum Reality Continuum: stacked reality layers of the continuum for the Terrain Continuum subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.terraincont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
