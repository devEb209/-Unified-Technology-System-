-- ARKHER SYSTEM VC.0434 :: Physics Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0434"
	S.key = "arkher.contneural.physicscont.epoch_clock"
	S.name = "Physics Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.physicscont.infinite_grid" }
	S.tags = { "vc", "physicscont", "epoch", "contneural" }
	S.description = "Physics Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Physics Continuum subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.physicscont.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
