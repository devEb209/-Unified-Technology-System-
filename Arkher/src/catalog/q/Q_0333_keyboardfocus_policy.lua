-- ARKHER SYSTEM Q.0333 :: Keyboard Focus Accessibility Policy
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0333"
	S.key = "arkher.ui.keyboardfocus.accessibility_policy"
	S.name = "Keyboard Focus Accessibility Policy"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.keyboardfocus.interaction_ledger" }
	S.tags = { "q", "keyboardfocus", "policy", "ui" }
	S.description = "Keyboard Focus Accessibility Policy: rules enforcing contrast, target size and motion limits for the Keyboard Focus subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ui.keyboardfocus.accessibility_policy", algorithm = "roundrobin", starvationGuard = 32 })
		inst.system = S
		inst.ctx = ctx
