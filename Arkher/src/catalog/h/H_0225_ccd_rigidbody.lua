-- ARKHER SYSTEM H.0225 :: Continuous Detection Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0225"
	S.key = "arkher.physics.ccd.body_dynamics"
	S.name = "Continuous Detection Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "ccd", "rigidbody", "physics" }
	S.description = "Continuous Detection Body Dynamics: integration, impulses, damping and sleeping of a body for the Continuous Detection subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.ccd.body_dynamics", mass = 3.00, radius = 0.40, restitution = 0.02, friction = 0.72, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
