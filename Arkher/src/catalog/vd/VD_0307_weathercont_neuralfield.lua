-- ARKHER SYSTEM VD.0307 :: Weather Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0307"
	S.key = "arkher.contsim.weathercont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.weathercont.coherence_guard" }
	S.tags = { "vd", "weathercont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.weathercont.neural_field", dims = 24, hidden = 20, seed = 1151 })
		inst.system = S
		inst.ctx = ctx
