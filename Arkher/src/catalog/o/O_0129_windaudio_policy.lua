-- ARKHER SYSTEM O.0129 :: Wind Audio Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0129"
	S.key = "arkher.audio.windaudio.playback_policy"
	S.name = "Wind Audio Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Wind Audio"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.windaudio.compression_codec" }
	S.tags = { "o", "windaudio", "policy", "audio" }
	S.description = "Wind Audio Playback Policy: rules choosing what may be heard right now for the Wind Audio subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.windaudio.playback_policy", algorithm = "lottery", starvationGuard = 59 })
		inst.system = S
		inst.ctx = ctx
