-- ARKHER SYSTEM I.0188 :: Blend Tree Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0188"
	S.key = "arkher.anim.blendtree.retarget_graph"
	S.name = "Blend Tree Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Blend Tree"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.blendtree.physical_blend" }
	S.tags = { "i", "blendtree", "graph", "anim" }
	S.description = "Blend Tree Retarget Graph: bone mapping and retarget path resolution for the Blend Tree subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.blendtree.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
