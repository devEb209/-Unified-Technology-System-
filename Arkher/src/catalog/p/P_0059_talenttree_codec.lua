-- ARKHER SYSTEM P.0059 :: Talent Tree Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0059"
	S.key = "arkher.play.talenttree.save_codec"
	S.name = "Talent Tree Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Talent Tree"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.talenttree.content_registry" }
	S.tags = { "p", "talenttree", "codec", "play" }
	S.description = "Talent Tree Save Codec: persistence, diffing and checksum of gameplay state for the Talent Tree subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.talenttree.save_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
