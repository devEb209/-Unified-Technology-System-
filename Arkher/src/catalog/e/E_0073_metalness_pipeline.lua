-- ARKHER SYSTEM E.0073 :: Metalness Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0073"
	S.key = "arkher.material.metalness.authoring_pipeline"
	S.name = "Metalness Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Metalness"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.metalness.analysis" }
	S.tags = { "e", "metalness", "pipeline", "material" }
	S.description = "Metalness Authoring Pipeline: ordered authoring and bake stages for the Metalness subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.metalness.authoring_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
