-- ARKHER SYSTEM I.0451 :: Motion Matching Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0451"
	S.key = "arkher.anim.motionmatching.playback_pipeline"
	S.name = "Motion Matching Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.motionmatching.event_ledger" }
	S.tags = { "i", "motionmatching", "pipeline", "anim" }
	S.description = "Motion Matching Playback Pipeline: ordered sample, blend, ik and output stages for the Motion Matching subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.motionmatching.playback_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
