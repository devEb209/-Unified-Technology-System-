-- ARKHER SYSTEM Z.0752 :: World Compression Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0752"
	S.key = "arkher.origin.worldcompression.predictive_optimization"
	S.name = "World Compression Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.adaptive_workflow" }
	S.tags = { "z", "worldcompression", "predictor", "origin" }
	S.description = "World Compression Predictive Optimization: forecast-driven optimization before the cost is paid for the World Compression subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.worldcompression.predictive_optimization", method = "ema", alpha = 0.31, window = 53 })
		inst.system = S
		inst.ctx = ctx
