-- ARKHER SYSTEM VC.0373 :: Dialogue Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0373"
	S.key = "arkher.contneural.dialoguecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "dialoguecont", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.dialoguecont.infinite_grid", cellSize = 192, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
