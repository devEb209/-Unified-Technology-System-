-- ARKHER SYSTEM G.0184 :: Light Transport Prediction Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0184"
	S.key = "arkher.neural.lightpredict.feature_extraction"
	S.name = "Light Transport Prediction Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.lightpredict.inference_core" }
	S.tags = { "g", "lightpredict", "field", "neural" }
	S.description = "Light Transport Prediction Feature Extraction: signal features feeding the model for the Light Transport Prediction subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.lightpredict.feature_extraction", seed = 74370, frequency = 0.0065, octaves = 5, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
