-- ARKHER SYSTEM Z.0755 :: World Compression Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0755"
	S.key = "arkher.origin.worldcompression.signal_composition"
	S.name = "World Compression Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.telemetry_ledger" }
	S.tags = { "z", "worldcompression", "composer", "origin" }
	S.description = "World Compression Signal Composition: blending of the technology's input signals into one output for the World Compression subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.worldcompression.signal_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
