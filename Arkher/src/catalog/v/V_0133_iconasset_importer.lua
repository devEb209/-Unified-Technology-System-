-- ARKHER SYSTEM V.0133 :: Icon Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0133"
	S.key = "arkher.asset.iconasset.import"
	S.name = "Icon Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "iconasset", "importer", "asset" }
	S.description = "Icon Import: validation, normalization, hashing and deduplication of incoming content for the Icon subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.iconasset.import", unitScale = 1.50 })
		inst.system = S
		inst.ctx = ctx
