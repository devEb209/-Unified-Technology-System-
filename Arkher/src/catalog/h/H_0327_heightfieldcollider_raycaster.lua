-- ARKHER SYSTEM H.0327 :: Heightfield Collider Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0327"
	S.key = "arkher.physics.heightfieldcollider.query"
	S.name = "Heightfield Collider Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.heightfieldcollider.constraint_solver" }
	S.tags = { "h", "heightfieldcollider", "raycaster", "physics" }
	S.description = "Heightfield Collider Query: rays, sweeps and overlaps against the simulation for the Heightfield Collider subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.heightfieldcollider.query", cellSize = 48 })
		inst.system = S
		inst.ctx = ctx
