-- ARKHER SYSTEM VC.0486 :: Lighting Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0486"
	S.key = "arkher.contneural.lightcont.coherence_guard"
	S.name = "Lighting Continuum Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lightcont.persistent_state" }
	S.tags = { "vc", "lightcont", "coherence", "contneural" }
	S.description = "Lighting Continuum Coherence Guard: seam coherence and drift supervision for the Lighting Continuum subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.lightcont.coherence_guard", window = 68, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
