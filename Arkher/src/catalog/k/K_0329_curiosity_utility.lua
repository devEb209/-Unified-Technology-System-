-- ARKHER SYSTEM K.0329 :: Curiosity Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0329"
	S.key = "arkher.npc.curiosity.utility_reasoning"
	S.name = "Curiosity Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.curiosity.reactive_behaviour" }
	S.tags = { "k", "curiosity", "utility", "npc" }
	S.description = "Curiosity Utility Reasoning: scored option selection with response curves for the Curiosity subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.curiosity.utility_reasoning", momentum = 0.15 })
		inst.system = S
		inst.ctx = ctx
