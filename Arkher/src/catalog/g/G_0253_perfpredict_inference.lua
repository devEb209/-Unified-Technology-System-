-- ARKHER SYSTEM G.0253 :: Performance Prediction Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0253"
	S.key = "arkher.neural.perfpredict.inference_core"
	S.name = "Performance Prediction Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "perfpredict", "inference", "neural" }
	S.description = "Performance Prediction Inference Core: dense network forward pass and training for the Performance Prediction subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.perfpredict.inference_core", seed = 80872 })
		inst.system = S
		inst.ctx = ctx
