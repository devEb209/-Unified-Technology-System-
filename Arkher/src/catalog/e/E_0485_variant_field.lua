-- ARKHER SYSTEM E.0485 :: Material Variant Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0485"
	S.key = "arkher.material.variant.procedural_detail"
	S.name = "Material Variant Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.variant.texture_sampling" }
	S.tags = { "e", "variant", "field", "material" }
	S.description = "Material Variant Procedural Detail: coherent noise detail driving the surface for the Material Variant subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.variant.procedural_detail", seed = 79538, frequency = 0.0085, octaves = 5, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
