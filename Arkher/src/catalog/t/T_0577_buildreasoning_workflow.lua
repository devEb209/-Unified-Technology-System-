-- ARKHER SYSTEM T.0577 :: Build Reasoning Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0577"
	S.key = "arkher.ai.buildreasoning.plan_workflow"
	S.name = "Build Reasoning Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.buildreasoning.semantic_knowledge" }
	S.tags = { "t", "buildreasoning", "workflow", "ai" }
	S.description = "Build Reasoning Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Build Reasoning subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.buildreasoning.plan_workflow", maxRetries = 2, budget = 50 })
		inst.system = S
		inst.ctx = ctx
