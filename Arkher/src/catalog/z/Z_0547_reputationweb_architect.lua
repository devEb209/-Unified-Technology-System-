-- ARKHER SYSTEM Z.0547 :: Reputation Web World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0547"
	S.key = "arkher.origin.reputationweb.world_architect"
	S.name = "Reputation Web World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.emergence_detection" }
	S.tags = { "z", "reputationweb", "architect", "origin" }
	S.description = "Reputation Web World Architect: hierarchical world composition with conserved budgets for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.reputationweb.world_architect", budget = 1000, seed = 94904 })
		inst.system = S
		inst.ctx = ctx
