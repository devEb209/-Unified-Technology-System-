-- ARKHER SYSTEM N.0422 :: Foliage Motion Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0422"
	S.key = "arkher.vfx.foliagemotion.effect_graph"
	S.name = "Foliage Motion Effect Graph"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.foliagemotion.curve_authoring" }
	S.tags = { "n", "foliagemotion", "shadegraph", "vfx" }
	S.description = "Foliage Motion Effect Graph: node graph describing how the effect is shaded for the Foliage Motion subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.foliagemotion.effect_graph" })
		inst.system = S
		inst.ctx = ctx
