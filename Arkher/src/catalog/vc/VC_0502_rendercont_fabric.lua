-- ARKHER SYSTEM VC.0502 :: Rendering Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0502"
	S.key = "arkher.contneural.rendercont.simulation_fabric"
	S.name = "Rendering Continuum Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.rendercont.complexity_budget" }
	S.tags = { "vc", "rendercont", "fabric", "contneural" }
	S.description = "Rendering Continuum Simulation Fabric: fabric stepping the continuum domains for the Rendering Continuum subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.rendercont.simulation_fabric", budgetMs = 2.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
