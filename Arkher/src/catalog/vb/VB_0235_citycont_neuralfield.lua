-- ARKHER SYSTEM VB.0235 :: City Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0235"
	S.key = "arkher.conttime.citycont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.citycont.coherence_guard" }
	S.tags = { "vb", "citycont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.citycont.neural_field", dims = 16, hidden = 12, seed = 38201 })
		inst.system = S
		inst.ctx = ctx
