-- ARKHER SYSTEM W.0030 :: Scene Cut Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0030"
	S.key = "arkher.cine.scenecut.playback_orchestrator"
	S.name = "Scene Cut Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Scene Cut"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.scenecut.cut_policy" }
	S.tags = { "w", "scenecut", "orchestrator", "cine" }
	S.description = "Scene Cut Playback Orchestrator: the state machine that drives a cinematic from start to end for the Scene Cut subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.scenecut.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
