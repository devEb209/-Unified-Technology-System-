-- ARKHER SYSTEM VC.0116 :: Temporal Slice World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0116"
	S.key = "arkher.contneural.temporalslice.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.temporalslice.neural_field" }
	S.tags = { "vc", "temporalslice", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.temporalslice.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
