-- ARKHER SYSTEM VB.0584 :: Thermal Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0584"
	S.key = "arkher.conttime.thermalcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.thermalcont.neural_field" }
	S.tags = { "vb", "thermalcont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.thermalcont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
