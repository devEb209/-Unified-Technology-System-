-- ARKHER SYSTEM T.0691 :: AI Debug World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0691"
	S.key = "arkher.ai.aidebug.world_architect"
	S.name = "AI Debug World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.aidebug.self_critique" }
	S.tags = { "t", "aidebug", "architect", "ai" }
	S.description = "AI Debug World Architect: composition of a whole world plan with conserved budgets for the AI Debug subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.aidebug.world_architect", budget = 1100, seed = 51715 })
		inst.system = S
		inst.ctx = ctx
