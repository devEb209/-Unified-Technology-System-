-- ARKHER SYSTEM V.0265 :: Lightmap Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0265"
	S.key = "arkher.asset.lightmap.import"
	S.name = "Lightmap Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "lightmap", "importer", "asset" }
	S.description = "Lightmap Import: validation, normalization, hashing and deduplication of incoming content for the Lightmap subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.lightmap.import", unitScale = 1.00 })
		inst.system = S
		inst.ctx = ctx
