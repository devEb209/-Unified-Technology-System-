-- ARKHER SYSTEM L.0059 :: Catch Up Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0059"
	S.key = "arkher.sim.catchup.forecast"
	S.name = "Catch Up Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.catchup.analysis" }
	S.tags = { "l", "catchup", "predictor", "sim" }
	S.description = "Catch Up Forecast: prediction of the region's next state for the Catch Up subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.catchup.forecast", method = "markov", alpha = 0.33, window = 103 })
		inst.system = S
		inst.ctx = ctx
