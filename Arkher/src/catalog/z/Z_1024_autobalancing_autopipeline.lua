-- ARKHER SYSTEM Z.1024 :: Autonomous Balancing Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.1024"
	S.key = "arkher.origin.autobalancing.autonomous_pipeline"
	S.name = "Autonomous Balancing Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autobalancing.simulation_fabric" }
	S.tags = { "z", "autobalancing", "autopipeline", "origin" }
	S.description = "Autonomous Balancing Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Autonomous Balancing subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.autobalancing.autonomous_pipeline", maxIterations = 11 })
		inst.system = S
		inst.ctx = ctx
