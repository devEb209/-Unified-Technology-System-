-- ARKHER SYSTEM W.0260 :: Match Cut Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0260"
	S.key = "arkher.cine.matchcut.cinematic_mix"
	S.name = "Match Cut Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Match Cut"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.matchcut.motion_tween" }
	S.tags = { "w", "matchcut", "mixer", "cine" }
	S.description = "Match Cut Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Match Cut subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.matchcut.cinematic_mix", maxVoices = 56 })
		inst.system = S
		inst.ctx = ctx
