-- ARKHER SYSTEM E.0470 :: Material Instance Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0470"
	S.key = "arkher.material.instance.procedural_detail"
	S.name = "Material Instance Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.instance.texture_sampling" }
	S.tags = { "e", "instance", "field", "material" }
	S.description = "Material Instance Procedural Detail: coherent noise detail driving the surface for the Material Instance subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.instance.procedural_detail", seed = 93821, frequency = 0.0093, octaves = 4, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
