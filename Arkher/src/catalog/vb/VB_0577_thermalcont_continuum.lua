-- ARKHER SYSTEM VB.0577 :: Thermal Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0577"
	S.key = "arkher.conttime.thermalcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "thermalcont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.thermalcont.infinite_grid", cellSize = 224, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
