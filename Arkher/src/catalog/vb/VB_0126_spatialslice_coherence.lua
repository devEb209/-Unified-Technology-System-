-- ARKHER SYSTEM VB.0126 :: Spatial Slice Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0126"
	S.key = "arkher.conttime.spatialslice.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.spatialslice.persistent_state" }
	S.tags = { "vb", "spatialslice", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.spatialslice.coherence_guard", window = 53, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
