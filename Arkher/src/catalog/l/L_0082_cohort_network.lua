-- ARKHER SYSTEM L.0082 :: Cohort Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0082"
	S.key = "arkher.sim.cohort.route_network"
	S.name = "Cohort Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.cohort.region_graph" }
	S.tags = { "l", "cohort", "network", "sim" }
	S.description = "Cohort Route Network: roads, rivers and routes between settlements for the Cohort subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.cohort.route_network" })
		inst.system = S
		inst.ctx = ctx
