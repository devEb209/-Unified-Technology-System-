-- ARKHER SYSTEM V.0209 :: Level Asset Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0209"
	S.key = "arkher.asset.levelasset.dependency_graph"
	S.name = "Level Asset Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.levelasset.asset_registry" }
	S.tags = { "v", "levelasset", "graph", "asset" }
	S.description = "Level Asset Dependency Graph: what references what, and in which order it must be built for the Level Asset subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.levelasset.dependency_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
