-- ARKHER SYSTEM I.0064 :: Animation Clip Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0064"
	S.key = "arkher.anim.animclip.analysis"
	S.name = "Animation Clip Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animclip.quality_policy" }
	S.tags = { "i", "animclip", "analyzer", "anim" }
	S.description = "Animation Clip Analysis: pop, drift and cost analysis of playback for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.animclip.analysis", window = 228, buckets = 16, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
