-- ARKHER SYSTEM T.0370 :: Review Critic Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0370"
	S.key = "arkher.ai.reviewcritic.reasoning_graph"
	S.name = "Review Critic Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.reviewcritic.world_architect" }
	S.tags = { "t", "reviewcritic", "graph", "ai" }
	S.description = "Review Critic Reasoning Graph: relationship modelling and shortest-path reasoning for the Review Critic subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.reviewcritic.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
