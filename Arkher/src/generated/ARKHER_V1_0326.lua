--!strict
-- Gaea Nodes — CORE Node_Flow #0326
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Gaea Nodes — CORE Node_Flow #0326", size=Vector2.new(680, 440), pos=UDim2.fromOffset(338, 162), parent=parent, icon="↻"})
