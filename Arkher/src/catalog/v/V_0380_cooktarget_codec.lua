-- ARKHER SYSTEM V.0380 :: Cook Target Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0380"
	S.key = "arkher.asset.cooktarget.compression_codec"
	S.name = "Cook Target Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.cooktarget.streaming_residency" }
	S.tags = { "v", "cooktarget", "codec", "asset" }
	S.description = "Cook Target Compression Codec: compact encoding, diffing and checksum of asset payloads for the Cook Target subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.cooktarget.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
