-- ARKHER SYSTEM L.0259 :: Season Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0259"
	S.key = "arkher.sim.season.society"
	S.name = "Season Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.season.economy" }
	S.tags = { "l", "season", "society", "sim" }
	S.description = "Season Society: relations, factions, reputation and cohesion of the region for the Season subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.season.society", decayRate = 0.013, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
