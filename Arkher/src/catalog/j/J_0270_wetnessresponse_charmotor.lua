-- ARKHER SYSTEM J.0270 :: Wetness Response Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0270"
	S.key = "arkher.character.wetnessresponse.locomotion"
	S.name = "Wetness Response Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.wetnessresponse.physical_response" }
	S.tags = { "j", "wetnessresponse", "charmotor", "character" }
	S.description = "Wetness Response Locomotion: capsule locomotion driving the character for the Wetness Response subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.wetnessresponse.locomotion", radius = 0.41, height = 1.86, maxSpeed = 6.60, jumpHeight = 1.40, stepOffset = 0.51 })
		inst.system = S
		inst.ctx = ctx
