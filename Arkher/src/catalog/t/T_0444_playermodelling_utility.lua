-- ARKHER SYSTEM T.0444 :: Player Modelling Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0444"
	S.key = "arkher.ai.playermodelling.utility_selection"
	S.name = "Player Modelling Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.playermodelling.working_memory" }
	S.tags = { "t", "playermodelling", "utility", "ai" }
	S.description = "Player Modelling Utility Selection: scored choice between competing courses of action for the Player Modelling subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.playermodelling.utility_selection", momentum = 0.11 })
		inst.system = S
		inst.ctx = ctx
