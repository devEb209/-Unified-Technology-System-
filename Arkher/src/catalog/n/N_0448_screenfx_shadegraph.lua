-- ARKHER SYSTEM N.0448 :: Screen Effect Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0448"
	S.key = "arkher.vfx.screenfx.effect_graph"
	S.name = "Screen Effect Effect Graph"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.screenfx.curve_authoring" }
	S.tags = { "n", "screenfx", "shadegraph", "vfx" }
	S.description = "Screen Effect Effect Graph: node graph describing how the effect is shaded for the Screen Effect subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.screenfx.effect_graph" })
		inst.system = S
		inst.ctx = ctx
