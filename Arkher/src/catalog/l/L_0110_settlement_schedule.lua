-- ARKHER SYSTEM L.0110 :: Settlement Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0110"
	S.key = "arkher.sim.settlement.calendar"
	S.name = "Settlement Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.settlement.society" }
	S.tags = { "l", "settlement", "schedule", "sim" }
	S.description = "Settlement Calendar: hours, days and seasons driving the region for the Settlement subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.settlement.calendar", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
