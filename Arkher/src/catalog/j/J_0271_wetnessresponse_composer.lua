-- ARKHER SYSTEM J.0271 :: Wetness Response Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0271"
	S.key = "arkher.character.wetnessresponse.appearance_composer"
	S.name = "Wetness Response Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.wetnessresponse.locomotion" }
	S.tags = { "j", "wetnessresponse", "composer", "character" }
	S.description = "Wetness Response Appearance Composer: composition of appearance slots into a look for the Wetness Response subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.wetnessresponse.appearance_composer", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
