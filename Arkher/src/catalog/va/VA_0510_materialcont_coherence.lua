-- ARKHER SYSTEM VA.0510 :: Material Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0510"
	S.key = "arkher.contworld.materialcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.materialcont.persistent_state" }
	S.tags = { "va", "materialcont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.materialcont.coherence_guard", window = 50, threshold = 0.14 })
		inst.system = S
		inst.ctx = ctx
