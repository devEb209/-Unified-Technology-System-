-- ARKHER SYSTEM L.0133 :: Village Life Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0133"
	S.key = "arkher.sim.villagelife.analysis"
	S.name = "Village Life Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.villagelife.aggregate_cache" }
	S.tags = { "l", "villagelife", "analyzer", "sim" }
	S.description = "Village Life Analysis: trend, anomaly and stability analysis of the world for the Village Life subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.villagelife.analysis", window = 136, buckets = 8, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
