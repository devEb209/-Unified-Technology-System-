-- ARKHER SYSTEM K.0469 :: Formation Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0469"
	S.key = "arkher.npc.formation.utility_reasoning"
	S.name = "Formation Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.formation.reactive_behaviour" }
	S.tags = { "k", "formation", "utility", "npc" }
	S.description = "Formation Utility Reasoning: scored option selection with response curves for the Formation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.formation.utility_reasoning", momentum = 0.12 })
		inst.system = S
		inst.ctx = ctx
