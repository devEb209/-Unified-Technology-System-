-- ARKHER SYSTEM VB.0203 :: Architect District Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0203"
	S.key = "arkher.conttime.architectdistrict.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.architectdistrict.simulation_fabric" }
	S.tags = { "vb", "architectdistrict", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.architectdistrict.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
