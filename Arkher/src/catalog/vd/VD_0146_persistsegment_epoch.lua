-- ARKHER SYSTEM VD.0146 :: Persistence Segment Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0146"
	S.key = "arkher.contsim.persistsegment.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.persistsegment.infinite_grid" }
	S.tags = { "vd", "persistsegment", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.persistsegment.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
