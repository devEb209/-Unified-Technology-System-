-- ARKHER SYSTEM I.0165 :: Additive Layer Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0165"
	S.key = "arkher.anim.additivelayer.playback_pipeline"
	S.name = "Additive Layer Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.additivelayer.event_ledger" }
	S.tags = { "i", "additivelayer", "pipeline", "anim" }
	S.description = "Additive Layer Playback Pipeline: ordered sample, blend, ik and output stages for the Additive Layer subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.additivelayer.playback_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
