-- ARKHER SYSTEM H.0584 :: Buoyancy Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0584"
	S.key = "arkher.physics.buoyancy.simulation_policy"
	S.name = "Buoyancy Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Buoyancy"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.buoyancy.budget_governor" }
	S.tags = { "h", "buoyancy", "policy", "physics" }
	S.description = "Buoyancy Simulation Policy: device tier rules for substeps, iterations and sleep for the Buoyancy subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.buoyancy.simulation_policy", algorithm = "roundrobin", starvationGuard = 60 })
		inst.system = S
		inst.ctx = ctx
