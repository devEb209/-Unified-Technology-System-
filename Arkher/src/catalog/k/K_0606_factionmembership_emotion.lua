-- ARKHER SYSTEM K.0606 :: Faction Membership Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0606"
	S.key = "arkher.npc.factionmembership.emotion"
	S.name = "Faction Membership Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.factionmembership.drive_system" }
	S.tags = { "k", "factionmembership", "emotion", "npc" }
	S.description = "Faction Membership Emotion: appraisal of events into valence, arousal and mood for the Faction Membership subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.factionmembership.emotion", inertia = 0.84, decayRate = 0.29, baselineArousal = 0.19 })
		inst.system = S
		inst.ctx = ctx
