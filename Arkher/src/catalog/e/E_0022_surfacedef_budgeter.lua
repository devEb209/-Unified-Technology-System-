-- ARKHER SYSTEM E.0022 :: Surface Definition Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0022"
	S.key = "arkher.material.surfacedef.parameter_budget"
	S.name = "Surface Definition Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.surfacedef.variant_registry" }
	S.tags = { "e", "surfacedef", "budgeter", "material" }
	S.description = "Surface Definition Parameter Budget: texel and layer budget allocation for the Surface Definition subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.surfacedef.parameter_budget", total = 157, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
