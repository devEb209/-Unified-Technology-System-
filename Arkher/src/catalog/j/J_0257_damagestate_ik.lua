-- ARKHER SYSTEM J.0257 :: Damage State Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0257"
	S.key = "arkher.character.damagestate.look_and_reach"
	S.name = "Damage State Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.damagestate.blend_controller" }
	S.tags = { "j", "damagestate", "ik", "character" }
	S.description = "Damage State Look And Reach: look-at, reach and foot placement for the character for the Damage State subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.damagestate.look_and_reach", iterations = 12, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
