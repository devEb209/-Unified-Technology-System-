-- ARKHER SYSTEM G.0207 :: Ambient Occlusion Prediction Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0207"
	S.key = "arkher.neural.aopredict.error_analysis"
	S.name = "Ambient Occlusion Prediction Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.aopredict.heuristic_policy" }
	S.tags = { "g", "aopredict", "analyzer", "neural" }
	S.description = "Ambient Occlusion Prediction Error Analysis: residual and drift analysis for the Ambient Occlusion Prediction subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.aopredict.error_analysis", window = 218, buckets = 14, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
