-- ARKHER SYSTEM VB.0081 :: LOD Cascade Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0081"
	S.key = "arkher.conttime.lodcascade.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lodcascade.world_memory_stream" }
	S.tags = { "vb", "lodcascade", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.lodcascade.complexity_budget", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
