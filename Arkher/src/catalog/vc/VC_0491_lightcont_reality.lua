-- ARKHER SYSTEM VC.0491 :: Lighting Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0491"
	S.key = "arkher.contneural.lightcont.reality_continuum"
	S.name = "Lighting Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lightcont.simulation_fabric" }
	S.tags = { "vc", "lightcont", "reality", "contneural" }
	S.description = "Lighting Continuum Reality Continuum: stacked reality layers of the continuum for the Lighting Continuum subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.lightcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
