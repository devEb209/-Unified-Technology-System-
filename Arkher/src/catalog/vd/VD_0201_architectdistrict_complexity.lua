-- ARKHER SYSTEM VD.0201 :: Architect District Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0201"
	S.key = "arkher.contsim.architectdistrict.complexity_budget"
	S.name = "Architect District Complexity Budget"
	S.category = "VD"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.architectdistrict.world_memory_stream" }
	S.tags = { "vd", "architectdistrict", "complexity", "contsim" }
	S.description = "Architect District Complexity Budget: complexity budgeting for the continuum for the Architect District subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.architectdistrict.complexity_budget", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
