-- ARKHER SYSTEM L.0115 :: Settlement Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0115"
	S.key = "arkher.sim.settlement.streaming"
	S.name = "Settlement Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.settlement.state_codec" }
	S.tags = { "l", "settlement", "streamer", "sim" }
	S.description = "Settlement Streaming: distance-driven residency of simulated regions for the Settlement subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.settlement.streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
