-- ARKHER SYSTEM H.0352 :: Trigger Volume Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0352"
	S.key = "arkher.physics.trigger.collision_shape"
	S.name = "Trigger Volume Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.trigger.body_dynamics" }
	S.tags = { "h", "trigger", "collider", "physics" }
	S.description = "Trigger Volume Collision Shape: shape bounds, support mapping and closest points for the Trigger Volume subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.trigger.collision_shape", shape = "capsule", radius = 0.60, height = 1.40, layer = "character" })
		inst.system = S
		inst.ctx = ctx
