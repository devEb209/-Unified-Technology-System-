-- ARKHER SYSTEM K.0562 :: Work Behaviour Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0562"
	S.key = "arkher.npc.workbehaviour.memory"
	S.name = "Work Behaviour Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workbehaviour.mind_network" }
	S.tags = { "k", "workbehaviour", "memory", "npc" }
	S.description = "Work Behaviour Memory: episodic memory with decay, recall and consolidation for the Work Behaviour subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.workbehaviour.memory", capacity = 62, decayRate = 0.040, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
