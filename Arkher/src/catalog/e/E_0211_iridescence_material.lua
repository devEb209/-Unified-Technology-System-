-- ARKHER SYSTEM E.0211 :: Iridescence Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0211"
	S.key = "arkher.material.iridescence.definition"
	S.name = "Iridescence Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Iridescence"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "iridescence", "material", "material" }
	S.description = "Iridescence Definition: layered PBR definition resolved into parameters for the Iridescence subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.iridescence.definition", texelBudget = 1835008 })
		inst.system = S
		inst.ctx = ctx
