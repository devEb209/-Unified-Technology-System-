-- ARKHER SYSTEM H.0424 :: Friction Model Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0424"
	S.key = "arkher.physics.friction.constraint_solver"
	S.name = "Friction Model Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.friction.contact_generation" }
	S.tags = { "h", "friction", "constraint", "physics" }
	S.description = "Friction Model Constraint Solver: sequential impulses, friction, joints and warm starting for the Friction Model subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.friction.constraint_solver", iterations = 5, baumgarte = 0.11, warmStart = true })
		inst.system = S
		inst.ctx = ctx
