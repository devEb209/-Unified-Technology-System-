-- ARKHER SYSTEM W.0234 :: Fade Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0234"
	S.key = "arkher.cine.fade.playback_orchestrator"
	S.name = "Fade Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Fade"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.fade.cut_policy" }
	S.tags = { "w", "fade", "orchestrator", "cine" }
	S.description = "Fade Playback Orchestrator: the state machine that drives a cinematic from start to end for the Fade subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.fade.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
