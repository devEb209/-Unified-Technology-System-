-- ARKHER SYSTEM VA.0012 :: World Grid Cell Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0012"
	S.key = "arkher.contworld.worldcell.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldcell.reality_continuum" }
	S.tags = { "va", "worldcell", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.worldcell.emergence_continuum", windowSize = 7, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
