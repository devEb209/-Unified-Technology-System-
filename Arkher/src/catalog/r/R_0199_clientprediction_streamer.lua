-- ARKHER SYSTEM R.0199 :: Client Prediction Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0199"
	S.key = "arkher.net.clientprediction.interest_streaming"
	S.name = "Client Prediction Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.clientprediction.serialization_codec" }
	S.tags = { "r", "clientprediction", "streamer", "net" }
	S.description = "Client Prediction Interest Streaming: distance-driven residency of replicated content for the Client Prediction subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.clientprediction.interest_streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
