-- ARKHER SYSTEM VA.0228 :: Terrain Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0228"
	S.key = "arkher.contworld.terraincont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.terraincont.reality_continuum" }
	S.tags = { "va", "terraincont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.terraincont.emergence_continuum", windowSize = 6, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
