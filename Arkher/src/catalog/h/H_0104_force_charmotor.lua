-- ARKHER SYSTEM H.0104 :: Force Accumulator Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0104"
	S.key = "arkher.physics.force.character_motion"
	S.name = "Force Accumulator Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.force.query" }
	S.tags = { "h", "force", "charmotor", "physics" }
	S.description = "Force Accumulator Character Motion: capsule move-and-slide with slopes, steps and jumps for the Force Accumulator subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.force.character_motion", radius = 0.53, height = 1.98, maxSpeed = 9.80, jumpHeight = 2.20, stepOffset = 0.53 })
		inst.system = S
		inst.ctx = ctx
