-- ARKHER SYSTEM I.0233 :: Root Motion Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0233"
	S.key = "arkher.anim.rootmotion.analysis"
	S.name = "Root Motion Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Root Motion"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.rootmotion.quality_policy" }
	S.tags = { "i", "rootmotion", "analyzer", "anim" }
	S.description = "Root Motion Analysis: pop, drift and cost analysis of playback for the Root Motion subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.rootmotion.analysis", window = 226, buckets = 14, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
