-- ARKHER SYSTEM VA.0077 :: LOD Cascade Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0077"
	S.key = "arkher.contworld.lodcascade.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lodcascade.multi-scale_fidelity" }
	S.tags = { "va", "lodcascade", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.lodcascade.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
