-- ARKHER SYSTEM P.0344 :: Cooldown Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0344"
	S.key = "arkher.play.cooldown.balance_analysis"
	S.name = "Cooldown Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Cooldown"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.cooldown.event_ledger" }
	S.tags = { "p", "cooldown", "analyzer", "play" }
	S.description = "Cooldown Balance Analysis: distribution, outlier and pacing analysis for the Cooldown subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.cooldown.balance_analysis", window = 208, buckets = 12, threshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
