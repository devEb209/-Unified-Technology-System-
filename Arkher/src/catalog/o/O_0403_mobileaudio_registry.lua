-- ARKHER SYSTEM O.0403 :: Mobile Audio Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0403"
	S.key = "arkher.audio.mobileaudio.asset_registry"
	S.name = "Mobile Audio Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mobile Audio"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mobileaudio.streaming" }
	S.tags = { "o", "mobileaudio", "registry", "audio" }
	S.description = "Mobile Audio Asset Registry: catalogue of sounds, variations and metadata for the Mobile Audio subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.mobileaudio.asset_registry" })
		inst.system = S
		inst.ctx = ctx
