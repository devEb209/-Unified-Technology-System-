-- ARKHER SYSTEM Q.0239 :: Quest Log Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0239"
	S.key = "arkher.ui.questlog.usability_analysis"
	S.name = "Quest Log Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Quest Log"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.questlog.frame_budget" }
	S.tags = { "q", "questlog", "analyzer", "ui" }
	S.description = "Quest Log Usability Analysis: reachability, latency and abandonment analysis for the Quest Log subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.questlog.usability_analysis", window = 184, buckets = 8, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
