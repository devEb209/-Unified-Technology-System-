-- ARKHER SYSTEM Z.0124 :: Dynamic Complexity Manager Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0124"
	S.key = "arkher.origin.complexitymanager.autonomous_pipeline"
	S.name = "Dynamic Complexity Manager Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.simulation_fabric" }
	S.tags = { "z", "complexitymanager", "autopipeline", "origin" }
	S.description = "Dynamic Complexity Manager Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.complexitymanager.autonomous_pipeline", maxIterations = 6 })
		inst.system = S
		inst.ctx = ctx
