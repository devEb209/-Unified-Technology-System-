-- ARKHER SYSTEM H.0374 :: Collision Layer Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0374"
	S.key = "arkher.physics.collisionlayer.simulation_policy"
	S.name = "Collision Layer Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionlayer.budget_governor" }
	S.tags = { "h", "collisionlayer", "policy", "physics" }
	S.description = "Collision Layer Simulation Policy: device tier rules for substeps, iterations and sleep for the Collision Layer subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.collisionlayer.simulation_policy", algorithm = "edf", starvationGuard = 49 })
		inst.system = S
		inst.ctx = ctx
