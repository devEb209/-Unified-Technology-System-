-- ARKHER SYSTEM O.0046 :: Impact Sound Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0046"
	S.key = "arkher.audio.impactsound.analysis"
	S.name = "Impact Sound Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Impact Sound"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.impactsound.playback_policy" }
	S.tags = { "o", "impactsound", "analyzer", "audio" }
	S.description = "Impact Sound Analysis: loudness, headroom and masking analysis for the Impact Sound subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.impactsound.analysis", window = 108, buckets = 16, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
