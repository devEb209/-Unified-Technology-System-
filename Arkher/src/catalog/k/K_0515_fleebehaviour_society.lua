-- ARKHER SYSTEM K.0515 :: Flee Behaviour Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0515"
	S.key = "arkher.npc.fleebehaviour.social_relations"
	S.name = "Flee Behaviour Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.fleebehaviour.crowd_steering" }
	S.tags = { "k", "fleebehaviour", "society", "npc" }
	S.description = "Flee Behaviour Social Relations: affinity, factions, reputation and gossip for the Flee Behaviour subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.fleebehaviour.social_relations", decayRate = 0.005, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
