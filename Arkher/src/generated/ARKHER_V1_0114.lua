...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="VFX Niagra — CORE Profiler #0114", size=Vector2.new(600, 500), pos=UDim2.fromOffset(382, 198), parent=parent, icon="▶"})
...
Components.TextField(right, "File", "input.png", function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_File"..114, v) end end)
