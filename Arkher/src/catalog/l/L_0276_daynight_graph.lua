-- ARKHER SYSTEM L.0276 :: Day Night Cycle Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0276"
	S.key = "arkher.sim.daynight.region_graph"
	S.name = "Day Night Cycle Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.daynight.calendar" }
	S.tags = { "l", "daynight", "graph", "sim" }
	S.description = "Day Night Cycle Region Graph: connectivity, components and shortest path between places for the Day Night Cycle subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.daynight.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
