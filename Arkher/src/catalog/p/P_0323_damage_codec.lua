-- ARKHER SYSTEM P.0323 :: Damage Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0323"
	S.key = "arkher.play.damage.save_codec"
	S.name = "Damage Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Damage"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.damage.content_registry" }
	S.tags = { "p", "damage", "codec", "play" }
	S.description = "Damage Save Codec: persistence, diffing and checksum of gameplay state for the Damage subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.damage.save_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
