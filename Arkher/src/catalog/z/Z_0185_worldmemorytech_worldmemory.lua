-- ARKHER SYSTEM Z.0185 :: World Memory World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0185"
	S.key = "arkher.origin.worldmemorytech.world_memory"
	S.name = "World Memory World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldmemorytech.autonomous_pipeline" }
	S.tags = { "z", "worldmemorytech", "worldmemory", "origin" }
	S.description = "World Memory World Memory: epoch-stamped persistent history with compaction and checkpoints for the World Memory subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.worldmemorytech.world_memory", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
