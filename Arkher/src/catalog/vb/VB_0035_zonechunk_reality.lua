-- ARKHER SYSTEM VB.0035 :: Zone Chunk Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0035"
	S.key = "arkher.conttime.zonechunk.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.zonechunk.simulation_fabric" }
	S.tags = { "vb", "zonechunk", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.zonechunk.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
