-- ARKHER SYSTEM T.0347 :: Test Authoring Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0347"
	S.key = "arkher.ai.testauthoring.action_planner"
	S.name = "Test Authoring Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.testauthoring.utility_selection" }
	S.tags = { "t", "testauthoring", "planner", "ai" }
	S.description = "Test Authoring Action Planner: goal-oriented action planning over preconditions for the Test Authoring subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.testauthoring.action_planner", maxDepth = 8 })
		inst.system = S
		inst.ctx = ctx
