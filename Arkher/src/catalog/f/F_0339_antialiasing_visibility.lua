-- ARKHER SYSTEM F.0339 :: Antialiasing Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0339"
	S.key = "arkher.render.antialiasing.visibility_set"
	S.name = "Antialiasing Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Antialiasing"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.antialiasing.view_and_culling" }
	S.tags = { "f", "antialiasing", "visibility", "render" }
	S.description = "Antialiasing Visibility Set: cell, portal and occluder visibility for the Antialiasing subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.antialiasing.visibility_set", maxDepth = 4 })
		inst.system = S
		inst.ctx = ctx
