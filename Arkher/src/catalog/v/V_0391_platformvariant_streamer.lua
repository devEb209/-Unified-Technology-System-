-- ARKHER SYSTEM V.0391 :: Platform Variant Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0391"
	S.key = "arkher.asset.platformvariant.streaming_residency"
	S.name = "Platform Variant Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.platformvariant.content_cache" }
	S.tags = { "v", "platformvariant", "streamer", "asset" }
	S.description = "Platform Variant Streaming Residency: distance-driven load and unload of asset payloads for the Platform Variant subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.platformvariant.streaming_residency", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
