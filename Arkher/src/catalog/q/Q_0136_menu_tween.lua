-- ARKHER SYSTEM Q.0136 :: Menu Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0136"
	S.key = "arkher.ui.menu.transition"
	S.name = "Menu Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Menu"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.menu.input_mapping" }
	S.tags = { "q", "menu", "tween", "ui" }
	S.description = "Menu Transition: eased, delayed, looped and sequenced motion for the Menu subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.menu.transition", timeScale = 1.13 })
		inst.system = S
		inst.ctx = ctx
