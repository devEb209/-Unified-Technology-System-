-- ARKHER SYSTEM O.0265 :: Stinger DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0265"
	S.key = "arkher.audio.stinger.dsp_chain"
	S.name = "Stinger DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Stinger"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "stinger", "dsp", "audio" }
	S.description = "Stinger DSP Chain: biquad filtering, delay, envelope and soft clipping for the Stinger subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.stinger.dsp_chain", sampleRate = 22050, filter = "bandpass", cutoff = 2100, q = 0.560 })
		inst.system = S
		inst.ctx = ctx
