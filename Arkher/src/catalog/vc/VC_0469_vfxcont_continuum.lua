-- ARKHER SYSTEM VC.0469 :: VFX Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0469"
	S.key = "arkher.contneural.vfxcont.infinite_grid"
	S.name = "VFX Continuum Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "vfxcont", "continuum", "contneural" }
	S.description = "VFX Continuum Infinite Grid: seamless paging of the infinite world grid for the VFX Continuum subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.vfxcont.infinite_grid", cellSize = 128, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
