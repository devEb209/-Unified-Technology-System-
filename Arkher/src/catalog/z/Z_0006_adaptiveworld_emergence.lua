-- ARKHER SYSTEM Z.0006 :: Adaptive World Intelligence Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0006"
	S.key = "arkher.origin.adaptiveworld.emergence_detection"
	S.name = "Adaptive World Intelligence Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.adaptiveworld.world_memory" }
	S.tags = { "z", "adaptiveworld", "emergence", "origin" }
	S.description = "Adaptive World Intelligence Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Adaptive World Intelligence subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.adaptiveworld.emergence_detection", windowSize = 5, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
