-- ARKHER SYSTEM W.0388 :: Preview Render Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0388"
	S.key = "arkher.cine.previewrender.shot_composition"
	S.name = "Preview Render Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.previewrender.colour_grade" }
	S.tags = { "w", "previewrender", "composer", "cine" }
	S.description = "Preview Render Shot Composition: blending of the signals that make up the final shot for the Preview Render subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.previewrender.shot_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
