-- ARKHER SYSTEM Z.0447 :: Player Absence Simulation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0447"
	S.key = "arkher.origin.playerabsence.world_architect"
	S.name = "Player Absence Simulation World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.emergence_detection" }
	S.tags = { "z", "playerabsence", "architect", "origin" }
	S.description = "Player Absence Simulation World Architect: hierarchical world composition with conserved budgets for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.playerabsence.world_architect", budget = 1400, seed = 91418 })
		inst.system = S
		inst.ctx = ctx
