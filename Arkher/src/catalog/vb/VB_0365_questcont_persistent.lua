-- ARKHER SYSTEM VB.0365 :: Quest Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0365"
	S.key = "arkher.conttime.questcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.questcont.multi-scale_fidelity" }
	S.tags = { "vb", "questcont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.questcont.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
