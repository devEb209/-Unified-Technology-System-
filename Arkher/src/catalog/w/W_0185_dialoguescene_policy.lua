-- ARKHER SYSTEM W.0185 :: Dialogue Scene Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0185"
	S.key = "arkher.cine.dialoguescene.cut_policy"
	S.name = "Dialogue Scene Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dialoguescene.shot_composition" }
	S.tags = { "w", "dialoguescene", "policy", "cine" }
	S.description = "Dialogue Scene Cut Policy: rules deciding when the sequence cuts and to what for the Dialogue Scene subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.dialoguescene.cut_policy", algorithm = "wfq", starvationGuard = 26 })
		inst.system = S
		inst.ctx = ctx
