-- ARKHER SYSTEM F.0192 :: Sky Model Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0192"
	S.key = "arkher.render.sky.render_policy"
	S.name = "Sky Model Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sky Model"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sky.draw_budget" }
	S.tags = { "f", "sky", "policy", "render" }
	S.description = "Sky Model Render Policy: device tier rules for the frame for the Sky Model subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.sky.render_policy", algorithm = "roundrobin", starvationGuard = 52 })
		inst.system = S
		inst.ctx = ctx
