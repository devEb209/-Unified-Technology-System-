-- ARKHER SYSTEM K.0096 :: Working Memory Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0096"
	S.key = "arkher.npc.workingmemory.daily_schedule"
	S.name = "Working Memory Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workingmemory.social_relations" }
	S.tags = { "k", "workingmemory", "schedule", "npc" }
	S.description = "Working Memory Daily Schedule: hour-by-hour routine with priority interruptions for the Working Memory subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.workingmemory.daily_schedule", startHour = 8 })
		inst.system = S
		inst.ctx = ctx
