-- ARKHER SYSTEM VB.0624 :: Occupancy Map Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0624"
	S.key = "arkher.conttime.occupancymap.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.occupancymap.reality_continuum" }
	S.tags = { "vb", "occupancymap", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.occupancymap.emergence_continuum", windowSize = 7, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
