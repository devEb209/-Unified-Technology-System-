-- ARKHER SYSTEM W.0020 :: Sequence Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0020"
	S.key = "arkher.cine.sequence.cinematic_mix"
	S.name = "Sequence Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Sequence"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.sequence.motion_tween" }
	S.tags = { "w", "sequence", "mixer", "cine" }
	S.description = "Sequence Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Sequence subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.sequence.cinematic_mix", maxVoices = 24 })
		inst.system = S
		inst.ctx = ctx
