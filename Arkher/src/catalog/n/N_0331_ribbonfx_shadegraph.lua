-- ARKHER SYSTEM N.0331 :: Ribbon Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0331"
	S.key = "arkher.vfx.ribbonfx.effect_graph"
	S.name = "Ribbon Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Ribbon"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.ribbonfx.curve_authoring" }
	S.tags = { "n", "ribbonfx", "shadegraph", "vfx" }
	S.description = "Ribbon Effect Graph: node graph describing how the effect is shaded for the Ribbon subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.ribbonfx.effect_graph" })
		inst.system = S
		inst.ctx = ctx
