-- ARKHER SYSTEM N.0473 :: Distortion Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0473"
	S.key = "arkher.vfx.distortion.curve_authoring"
	S.name = "Distortion Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Distortion"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.distortion.ribbon_and_trail" }
	S.tags = { "n", "distortion", "spline", "vfx" }
	S.description = "Distortion Curve Authoring: authored curves driving the effect over its life for the Distortion subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.distortion.curve_authoring", tension = 0.37, closed = false })
		inst.system = S
		inst.ctx = ctx
