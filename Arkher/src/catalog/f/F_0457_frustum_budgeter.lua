-- ARKHER SYSTEM F.0457 :: Frustum Culling Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0457"
	S.key = "arkher.render.frustum.draw_budget"
	S.name = "Frustum Culling Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.frustum.adaptive_resolution" }
	S.tags = { "f", "frustum", "budgeter", "render" }
	S.description = "Frustum Culling Draw Budget: draw call and triangle budget allocation for the Frustum Culling subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.frustum.draw_budget", total = 322, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
