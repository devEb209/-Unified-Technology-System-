-- ARKHER SYSTEM N.0288 :: Buff Effect Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0288"
	S.key = "arkher.vfx.bufffx.particle_simulation"
	S.name = "Buff Effect Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Buff Effect"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.bufffx.emission" }
	S.tags = { "n", "bufffx", "particles", "vfx" }
	S.description = "Buff Effect Particle Simulation: pooled integration of position, velocity, colour and life for the Buff Effect subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.bufffx.particle_simulation", capacity = 192, drag = 0.22, bounce = 0.17, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
