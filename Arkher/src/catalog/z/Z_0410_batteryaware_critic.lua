-- ARKHER SYSTEM Z.0410 :: Battery Aware Pipeline Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0410"
	S.key = "arkher.origin.batteryaware.self_critique"
	S.name = "Battery Aware Pipeline Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.batteryaware.intent_bridge" }
	S.tags = { "z", "batteryaware", "critic", "origin" }
	S.description = "Battery Aware Pipeline Self Critique: weighted judgement of the technology's own output for the Battery Aware Pipeline subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.batteryaware.self_critique", passMark = 0.82, reviseMark = 0.47, seed = 84537 })
		inst.system = S
		inst.ctx = ctx
