-- ARKHER SYSTEM VB.0158 :: Coherence Seam Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0158"
	S.key = "arkher.conttime.coherenceseam.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.coherenceseam.infinite_grid" }
	S.tags = { "vb", "coherenceseam", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.coherenceseam.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
