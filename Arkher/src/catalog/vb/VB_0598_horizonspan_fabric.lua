-- ARKHER SYSTEM VB.0598 :: Horizon Span Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0598"
	S.key = "arkher.conttime.horizonspan.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.horizonspan.complexity_budget" }
	S.tags = { "vb", "horizonspan", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.horizonspan.simulation_fabric", budgetMs = 4.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
