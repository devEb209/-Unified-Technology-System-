-- ARKHER SYSTEM VD.0192 :: Simulation Domain Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0192"
	S.key = "arkher.contsim.simdomain.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.simdomain.reality_continuum" }
	S.tags = { "vd", "simdomain", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.simdomain.emergence_continuum", windowSize = 6, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
