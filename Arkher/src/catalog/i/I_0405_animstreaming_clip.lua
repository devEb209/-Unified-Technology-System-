-- ARKHER SYSTEM I.0405 :: Animation Streaming Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0405"
	S.key = "arkher.anim.animstreaming.clip_sampling"
	S.name = "Animation Streaming Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstreaming.skeleton" }
	S.tags = { "i", "animstreaming", "clip", "anim" }
	S.description = "Animation Streaming Clip Sampling: keyframe tracks sampled, retimed and evented for the Animation Streaming subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.animstreaming.clip_sampling", duration = 0.70, loop = true })
		inst.system = S
		inst.ctx = ctx
