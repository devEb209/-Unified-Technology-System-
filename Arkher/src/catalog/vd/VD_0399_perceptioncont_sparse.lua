-- ARKHER SYSTEM VD.0399 :: Perception Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0399"
	S.key = "arkher.contsim.perceptioncont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.perceptioncont.epoch_clock" }
	S.tags = { "vd", "perceptioncont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.perceptioncont.sparse_residency", capacity = 256, pageBytes = 3072 })
		inst.system = S
		inst.ctx = ctx
