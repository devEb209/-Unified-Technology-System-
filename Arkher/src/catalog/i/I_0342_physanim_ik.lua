-- ARKHER SYSTEM I.0342 :: Physical Animation Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0342"
	S.key = "arkher.anim.physanim.inverse_kinematics"
	S.name = "Physical Animation Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.physanim.layered_blending" }
	S.tags = { "i", "physanim", "ik", "anim" }
	S.description = "Physical Animation Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Physical Animation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.physanim.inverse_kinematics", iterations = 5, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
