-- ARKHER SYSTEM L.0190 :: Wildlife Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0190"
	S.key = "arkher.sim.wildlife.streaming"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wildlife.state_codec" }
	S.tags = { "l", "wildlife", "streamer", "sim" }
	S.description = "Wildlife Streaming: distance-driven residency of simulated regions for the Wildlife subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.wildlife.streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
