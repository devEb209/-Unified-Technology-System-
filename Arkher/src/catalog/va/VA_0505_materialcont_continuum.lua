-- ARKHER SYSTEM VA.0505 :: Material Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0505"
	S.key = "arkher.contworld.materialcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "materialcont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.materialcont.infinite_grid", cellSize = 192, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
