-- ARKHER SYSTEM N.0344 :: Beam Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0344"
	S.key = "arkher.vfx.beam.effect_graph"
	S.name = "Beam Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Beam"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.beam.curve_authoring" }
	S.tags = { "n", "beam", "shadegraph", "vfx" }
	S.description = "Beam Effect Graph: node graph describing how the effect is shaded for the Beam subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.beam.effect_graph" })
		inst.system = S
		inst.ctx = ctx
