--!strict
-- CryEngine Qt — ANIMATION Stack #0115
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="CryEngine Qt — ANIMATION Stack #0115", size=Vector2.new(640, 420), pos=UDim2.fromOffset(395, 215), parent=parent, icon="◨"})
