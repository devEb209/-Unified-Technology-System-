-- ARKHER SYSTEM VC.0239 :: City Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0239"
	S.key = "arkher.contneural.citycont.reality_continuum"
	S.name = "City Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.citycont.simulation_fabric" }
	S.tags = { "vc", "citycont", "reality", "contneural" }
	S.description = "City Continuum Reality Continuum: stacked reality layers of the continuum for the City Continuum subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.citycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
