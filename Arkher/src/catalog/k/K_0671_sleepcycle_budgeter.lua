-- ARKHER SYSTEM K.0671 :: Sleep Cycle Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0671"
	S.key = "arkher.npc.sleepcycle.thinking_budget"
	S.name = "Sleep Cycle Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.sleepcycle.daily_schedule" }
	S.tags = { "k", "sleepcycle", "budgeter", "npc" }
	S.description = "Sleep Cycle Thinking Budget: allocation of per-frame thinking time across NPCs for the Sleep Cycle subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.sleepcycle.thinking_budget", total = 166, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
