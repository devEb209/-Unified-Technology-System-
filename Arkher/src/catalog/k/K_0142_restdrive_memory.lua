-- ARKHER SYSTEM K.0142 :: Rest Drive Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0142"
	S.key = "arkher.npc.restdrive.memory"
	S.name = "Rest Drive Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.restdrive.mind_network" }
	S.tags = { "k", "restdrive", "memory", "npc" }
	S.description = "Rest Drive Memory: episodic memory with decay, recall and consolidation for the Rest Drive subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.restdrive.memory", capacity = 101, decayRate = 0.025, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
