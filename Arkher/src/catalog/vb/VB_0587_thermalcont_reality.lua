-- ARKHER SYSTEM VB.0587 :: Thermal Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0587"
	S.key = "arkher.conttime.thermalcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.thermalcont.simulation_fabric" }
	S.tags = { "vb", "thermalcont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.thermalcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
