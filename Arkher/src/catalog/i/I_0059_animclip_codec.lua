-- ARKHER SYSTEM I.0059 :: Animation Clip Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0059"
	S.key = "arkher.anim.animclip.compression_codec"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animclip.retarget_graph" }
	S.tags = { "i", "animclip", "codec", "anim" }
	S.description = "Animation Clip Compression Codec: curve compression and quantized transport for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.animclip.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
