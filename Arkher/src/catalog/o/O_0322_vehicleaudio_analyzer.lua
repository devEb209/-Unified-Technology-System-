-- ARKHER SYSTEM O.0322 :: Vehicle Audio Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0322"
	S.key = "arkher.audio.vehicleaudio.analysis"
	S.name = "Vehicle Audio Analysis"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.vehicleaudio.playback_policy" }
	S.tags = { "o", "vehicleaudio", "analyzer", "audio" }
	S.description = "Vehicle Audio Analysis: loudness, headroom and masking analysis for the Vehicle Audio subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.vehicleaudio.analysis", window = 116, buckets = 16, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
