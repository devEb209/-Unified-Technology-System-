-- ARKHER SYSTEM H.0212 :: Fixed Timestep Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0212"
	S.key = "arkher.physics.fixedstep.collision_shape"
	S.name = "Fixed Timestep Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.fixedstep.body_dynamics" }
	S.tags = { "h", "fixedstep", "collider", "physics" }
	S.description = "Fixed Timestep Collision Shape: shape bounds, support mapping and closest points for the Fixed Timestep subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.fixedstep.collision_shape", shape = "capsule", radius = 1.20, height = 2.00, layer = "default" })
		inst.system = S
		inst.ctx = ctx
