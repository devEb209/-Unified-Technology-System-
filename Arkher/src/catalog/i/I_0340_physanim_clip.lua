-- ARKHER SYSTEM I.0340 :: Physical Animation Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0340"
	S.key = "arkher.anim.physanim.clip_sampling"
	S.name = "Physical Animation Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.physanim.skeleton" }
	S.tags = { "i", "physanim", "clip", "anim" }
	S.description = "Physical Animation Clip Sampling: keyframe tracks sampled, retimed and evented for the Physical Animation subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.physanim.clip_sampling", duration = 0.70, loop = true })
		inst.system = S
		inst.ctx = ctx
