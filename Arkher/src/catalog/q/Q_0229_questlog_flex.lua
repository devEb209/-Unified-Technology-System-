-- ARKHER SYSTEM Q.0229 :: Quest Log Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0229"
	S.key = "arkher.ui.questlog.responsive_layout"
	S.name = "Quest Log Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Quest Log"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "questlog", "flex", "ui" }
	S.description = "Quest Log Responsive Layout: flex solving with safe areas, weights and breakpoints for the Quest Log subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.questlog.responsive_layout", width = 570, height = 904, scale = 0.96 })
		inst.system = S
		inst.ctx = ctx
