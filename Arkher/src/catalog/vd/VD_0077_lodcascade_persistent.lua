-- ARKHER SYSTEM VD.0077 :: LOD Cascade Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0077"
	S.key = "arkher.contsim.lodcascade.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lodcascade.multi-scale_fidelity" }
	S.tags = { "vd", "lodcascade", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.lodcascade.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
