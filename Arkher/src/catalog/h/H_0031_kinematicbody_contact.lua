-- ARKHER SYSTEM H.0031 :: Kinematic Body Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0031"
	S.key = "arkher.physics.kinematicbody.contact_generation"
	S.name = "Kinematic Body Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.kinematicbody.collision_shape" }
	S.tags = { "h", "kinematicbody", "contact", "physics" }
	S.description = "Kinematic Body Contact Generation: narrow-phase manifolds with normal, depth and point for the Kinematic Body subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.kinematicbody.contact_generation", slop = 0.0070, maxManifolds = 380 })
		inst.system = S
		inst.ctx = ctx
