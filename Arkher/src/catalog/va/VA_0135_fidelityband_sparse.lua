-- ARKHER SYSTEM VA.0135 :: Fidelity Band Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0135"
	S.key = "arkher.contworld.fidelityband.sparse_residency"
	S.name = "Fidelity Band Sparse Residency"
	S.category = "VA"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.fidelityband.epoch_clock" }
	S.tags = { "va", "fidelityband", "sparse", "contworld" }
	S.description = "Fidelity Band Sparse Residency: sparse page residency with eviction and compression for the Fidelity Band subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.fidelityband.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
