-- ARKHER SYSTEM F.0160 :: Volumetric Light Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0160"
	S.key = "arkher.render.volumetric.probe_volume"
	S.name = "Volumetric Light Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.volumetric.lighting_rig" }
	S.tags = { "f", "volumetric", "probe", "render" }
	S.description = "Volumetric Light Probe Volume: irradiance probes encoded in spherical harmonics for the Volumetric Light subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.volumetric.probe_volume", spacing = 32 })
		inst.system = S
		inst.ctx = ctx
