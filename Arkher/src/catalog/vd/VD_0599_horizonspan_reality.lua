-- ARKHER SYSTEM VD.0599 :: Horizon Span Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0599"
	S.key = "arkher.contsim.horizonspan.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.horizonspan.simulation_fabric" }
	S.tags = { "vd", "horizonspan", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.horizonspan.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
