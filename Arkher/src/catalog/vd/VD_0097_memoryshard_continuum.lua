-- ARKHER SYSTEM VD.0097 :: Memory Shard Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0097"
	S.key = "arkher.contsim.memoryshard.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "memoryshard", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.memoryshard.infinite_grid", cellSize = 128, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
