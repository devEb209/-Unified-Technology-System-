-- ARKHER SYSTEM N.0187 :: Fog Volume Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0187"
	S.key = "arkher.vfx.fogvolume.curve_authoring"
	S.name = "Fog Volume Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fog Volume"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fogvolume.ribbon_and_trail" }
	S.tags = { "n", "fogvolume", "spline", "vfx" }
	S.description = "Fog Volume Curve Authoring: authored curves driving the effect over its life for the Fog Volume subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.fogvolume.curve_authoring", tension = 0.47, closed = false })
		inst.system = S
		inst.ctx = ctx
