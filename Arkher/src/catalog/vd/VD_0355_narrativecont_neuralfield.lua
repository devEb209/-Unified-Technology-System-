-- ARKHER SYSTEM VD.0355 :: Narrative Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0355"
	S.key = "arkher.contsim.narrativecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.narrativecont.coherence_guard" }
	S.tags = { "vd", "narrativecont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.narrativecont.neural_field", dims = 12, hidden = 8, seed = 62356 })
		inst.system = S
		inst.ctx = ctx
