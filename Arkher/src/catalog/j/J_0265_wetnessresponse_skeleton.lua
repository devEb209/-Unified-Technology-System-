-- ARKHER SYSTEM J.0265 :: Wetness Response Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0265"
	S.key = "arkher.character.wetnessresponse.rig_definition"
	S.name = "Wetness Response Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "wetnessresponse", "skeleton", "character" }
	S.description = "Wetness Response Rig Definition: character rig definition and bone budget for the Wetness Response subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.wetnessresponse.rig_definition" })
		inst.system = S
		inst.ctx = ctx
