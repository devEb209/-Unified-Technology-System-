-- ARKHER SYSTEM F.0697 :: Frame Pacing Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0697"
	S.key = "arkher.render.framepacing.pass_cache"
	S.name = "Frame Pacing Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Frame Pacing"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepacing.render_policy" }
	S.tags = { "f", "framepacing", "cache", "render" }
	S.description = "Frame Pacing Pass Cache: reuse of pass results across frames for the Frame Pacing subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.framepacing.pass_cache", policy = "ttl", capacity = 235, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
