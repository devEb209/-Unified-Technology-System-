-- ARKHER SYSTEM O.0025 :: Weapon Sound DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0025"
	S.key = "arkher.audio.weaponsound.dsp_chain"
	S.name = "Weapon Sound DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Weapon Sound"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "weaponsound", "dsp", "audio" }
	S.description = "Weapon Sound DSP Chain: biquad filtering, delay, envelope and soft clipping for the Weapon Sound subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.weaponsound.dsp_chain", sampleRate = 22050, filter = "lowpass", cutoff = 300, q = 0.500 })
		inst.system = S
		inst.ctx = ctx
