-- ARKHER SYSTEM Z.0678 :: Auto Documentation Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0678"
	S.key = "arkher.origin.autodocumentation.budget_governor"
	S.name = "Auto Documentation Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.behaviour_analysis" }
	S.tags = { "z", "autodocumentation", "budgeter", "origin" }
	S.description = "Auto Documentation Budget Governor: allocation of a scarce resource across the technology's consumers for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.autodocumentation.budget_governor", total = 189, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
