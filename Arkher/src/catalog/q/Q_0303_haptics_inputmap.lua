-- ARKHER SYSTEM Q.0303 :: Haptics Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0303"
	S.key = "arkher.ui.haptics.input_mapping"
	S.name = "Haptics Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Haptics"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.haptics.widget_tree" }
	S.tags = { "q", "haptics", "inputmap", "ui" }
	S.description = "Haptics Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Haptics subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.haptics.input_mapping", device = "gamepad", holdTime = 0.25, deadzone = 0.20 })
		inst.system = S
		inst.ctx = ctx
