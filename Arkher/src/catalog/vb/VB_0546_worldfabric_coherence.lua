-- ARKHER SYSTEM VB.0546 :: World Fabric Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0546"
	S.key = "arkher.conttime.worldfabric.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldfabric.persistent_state" }
	S.tags = { "vb", "worldfabric", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.worldfabric.coherence_guard", window = 71, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
