-- ARKHER SYSTEM VC.0287 :: Water Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0287"
	S.key = "arkher.contneural.watercont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.watercont.simulation_fabric" }
	S.tags = { "vc", "watercont", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.watercont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
