-- ARKHER SYSTEM P.0292 :: Melee Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0292"
	S.key = "arkher.play.melee.combat_resolution"
	S.name = "Melee Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Melee"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.melee.objectives" }
	S.tags = { "p", "melee", "combat", "play" }
	S.description = "Melee Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Melee subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.melee.combat_resolution", seed = 48996, armourK = 120, critMultiplier = 1.50 })
		inst.system = S
		inst.ctx = ctx
