-- ARKHER SYSTEM G.0033 :: Spatial Reconstruction Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0033"
	S.key = "arkher.neural.spatialrecon.model_registry"
	S.name = "Spatial Reconstruction Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.spatialrecon.reconstruction" }
	S.tags = { "g", "spatialrecon", "registry", "neural" }
	S.description = "Spatial Reconstruction Model Registry: named models and their lifecycle for the Spatial Reconstruction subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.spatialrecon.model_registry" })
		inst.system = S
		inst.ctx = ctx
