--!strict
-- UE5/6 Nanite — ANIMATION Node_Flow #0121
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="UE5/6 Nanite — ANIMATION Node_Flow #0121", size=Vector2.new(640, 440), pos=UDim2.fromOffset(473, 317), parent=parent, icon="⬣"})
