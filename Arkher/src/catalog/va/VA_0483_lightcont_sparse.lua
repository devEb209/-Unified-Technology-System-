-- ARKHER SYSTEM VA.0483 :: Lighting Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0483"
	S.key = "arkher.contworld.lightcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lightcont.epoch_clock" }
	S.tags = { "va", "lightcont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.lightcont.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
