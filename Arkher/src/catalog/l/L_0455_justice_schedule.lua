-- ARKHER SYSTEM L.0455 :: Justice Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0455"
	S.key = "arkher.sim.justice.calendar"
	S.name = "Justice Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.justice.society" }
	S.tags = { "l", "justice", "schedule", "sim" }
	S.description = "Justice Calendar: hours, days and seasons driving the region for the Justice subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.justice.calendar", startHour = 9 })
		inst.system = S
		inst.ctx = ctx
