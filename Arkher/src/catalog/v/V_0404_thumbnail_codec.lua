-- ARKHER SYSTEM V.0404 :: Thumbnail Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0404"
	S.key = "arkher.asset.thumbnail.compression_codec"
	S.name = "Thumbnail Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.thumbnail.streaming_residency" }
	S.tags = { "v", "thumbnail", "codec", "asset" }
	S.description = "Thumbnail Compression Codec: compact encoding, diffing and checksum of asset payloads for the Thumbnail subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.thumbnail.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
