-- ARKHER SYSTEM F.0173 :: Atmosphere Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0173"
	S.key = "arkher.render.atmosphere.lighting_rig"
	S.name = "Atmosphere Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Atmosphere"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.atmosphere.geometry_virtualization" }
	S.tags = { "f", "atmosphere", "lightrig", "render" }
	S.description = "Atmosphere Lighting Rig: light clustering, importance and cascades for the Atmosphere subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.atmosphere.lighting_rig", maxActive = 8 })
		inst.system = S
		inst.ctx = ctx
