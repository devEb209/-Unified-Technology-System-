-- ARKHER SYSTEM N.0388 :: Decal Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0388"
	S.key = "arkher.vfx.decal.spatial_index"
	S.name = "Decal Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Decal"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.decal.quality_policy" }
	S.tags = { "n", "decal", "index", "vfx" }
	S.description = "Decal Spatial Index: spatial acceleration of effect queries and culling for the Decal subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.decal.spatial_index", mode = "hash", cellSize = 88 })
		inst.system = S
		inst.ctx = ctx
