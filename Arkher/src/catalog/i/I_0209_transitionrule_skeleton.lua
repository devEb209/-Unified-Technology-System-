-- ARKHER SYSTEM I.0209 :: Transition Rule Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0209"
	S.key = "arkher.anim.transitionrule.skeleton"
	S.name = "Transition Rule Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "transitionrule", "skeleton", "anim" }
	S.description = "Transition Rule Skeleton: bone hierarchy, bind pose and world resolution for the Transition Rule subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.transitionrule.skeleton" })
		inst.system = S
		inst.ctx = ctx
