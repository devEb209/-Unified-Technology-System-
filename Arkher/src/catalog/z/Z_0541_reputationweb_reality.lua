-- ARKHER SYSTEM Z.0541 :: Reputation Web Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0541"
	S.key = "arkher.origin.reputationweb.reality_layering"
	S.name = "Reputation Web Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "reputationweb", "reality", "origin" }
	S.description = "Reputation Web Reality Layering: stacked authored, simulated, proposed and player realities for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.reputationweb.reality_layering" })
		inst.system = S
		inst.ctx = ctx
