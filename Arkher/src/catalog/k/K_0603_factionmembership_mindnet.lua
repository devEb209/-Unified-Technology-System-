-- ARKHER SYSTEM K.0603 :: Faction Membership Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0603"
	S.key = "arkher.npc.factionmembership.mind_network"
	S.name = "Faction Membership Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "factionmembership", "mindnet", "npc" }
	S.description = "Faction Membership Mind Network: the learned policy that turns perception into a decision for the Faction Membership subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.factionmembership.mind_network", inputs = 8, hidden = 8, seed = 77034, learningRate = 0.070, exploration = 0.030 })
		inst.system = S
		inst.ctx = ctx
