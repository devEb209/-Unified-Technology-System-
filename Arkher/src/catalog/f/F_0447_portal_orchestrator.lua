-- ARKHER SYSTEM F.0447 :: Portal Culling Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0447"
	S.key = "arkher.render.portal.orchestration"
	S.name = "Portal Culling Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.portal.frame_analysis" }
	S.tags = { "f", "portal", "orchestrator", "render" }
	S.description = "Portal Culling Orchestration: frame lifecycle orchestration for the Portal Culling subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.portal.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
