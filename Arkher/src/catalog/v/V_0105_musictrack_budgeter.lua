-- ARKHER SYSTEM V.0105 :: Music Track Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0105"
	S.key = "arkher.asset.musictrack.size_budget"
	S.name = "Music Track Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.musictrack.compression_codec" }
	S.tags = { "v", "musictrack", "budgeter", "asset" }
	S.description = "Music Track Size Budget: byte budget shared between competing asset classes for the Music Track subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.musictrack.size_budget", total = 326, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
