-- ARKHER SYSTEM J.0262 :: Damage State Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0262"
	S.key = "arkher.character.damagestate.budget_governor"
	S.name = "Damage State Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.damagestate.variant_registry" }
	S.tags = { "j", "damagestate", "budgeter", "character" }
	S.description = "Damage State Budget Governor: per-character cost allocation in a crowd for the Damage State subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.damagestate.budget_governor", total = 202, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
