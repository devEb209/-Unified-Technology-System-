-- ARKHER SYSTEM H.0465 :: Hinge Joint Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0465"
	S.key = "arkher.physics.hingejoint.contact_generation"
	S.name = "Hinge Joint Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Hinge Joint"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.hingejoint.collision_shape" }
	S.tags = { "h", "hingejoint", "contact", "physics" }
	S.description = "Hinge Joint Contact Generation: narrow-phase manifolds with normal, depth and point for the Hinge Joint subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.hingejoint.contact_generation", slop = 0.0050, maxManifolds = 509 })
		inst.system = S
		inst.ctx = ctx
