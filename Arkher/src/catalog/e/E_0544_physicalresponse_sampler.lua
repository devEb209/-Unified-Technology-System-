-- ARKHER SYSTEM E.0544 :: Physical Response Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0544"
	S.key = "arkher.material.physicalresponse.texture_sampling"
	S.name = "Physical Response Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.physicalresponse.shading_graph" }
	S.tags = { "e", "physicalresponse", "sampler", "material" }
	S.description = "Physical Response Texture Sampling: atlas packing, mip chain and filtered sampling for the Physical Response subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.physicalresponse.texture_sampling", atlasSize = 256, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
