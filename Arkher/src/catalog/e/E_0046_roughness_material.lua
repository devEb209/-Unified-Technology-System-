-- ARKHER SYSTEM E.0046 :: Roughness Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0046"
	S.key = "arkher.material.roughness.definition"
	S.name = "Roughness Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Roughness"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "roughness", "material", "material" }
	S.description = "Roughness Definition: layered PBR definition resolved into parameters for the Roughness subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.roughness.definition", texelBudget = 524288 })
		inst.system = S
		inst.ctx = ctx
