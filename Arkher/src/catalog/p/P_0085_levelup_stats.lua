-- ARKHER SYSTEM P.0085 :: Level Up Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0085"
	S.key = "arkher.play.levelup.attributes"
	S.name = "Level Up Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Level Up"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "levelup", "stats", "play" }
	S.description = "Level Up Attributes: base values, layered modifiers and derived statistics for the Level Up subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.levelup.attributes" })
		inst.system = S
		inst.ctx = ctx
