-- ARKHER SYSTEM N.0159 :: Snow Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0159"
	S.key = "arkher.vfx.snow.force_field"
	S.name = "Snow Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Snow"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.snow.particle_simulation" }
	S.tags = { "n", "snow", "forcefield", "vfx" }
	S.description = "Snow Force Field: wind, attraction, vortex, drag and curl turbulence for the Snow subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.snow.force_field", seed = 80968 })
		inst.system = S
		inst.ctx = ctx
