-- ARKHER SYSTEM P.0461 :: Tutorial State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0461"
	S.key = "arkher.play.tutorial.state_machine"
	S.name = "Tutorial State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Tutorial"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.tutorial.combat_resolution" }
	S.tags = { "p", "tutorial", "orchestrator", "play" }
	S.description = "Tutorial State Machine: the phase machine that drives this gameplay loop for the Tutorial subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.tutorial.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
