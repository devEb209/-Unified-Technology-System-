-- ARKHER SYSTEM I.0136 :: Animation Layer Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0136"
	S.key = "arkher.anim.animlayer.retarget_graph"
	S.name = "Animation Layer Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlayer.physical_blend" }
	S.tags = { "i", "animlayer", "graph", "anim" }
	S.description = "Animation Layer Retarget Graph: bone mapping and retarget path resolution for the Animation Layer subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.animlayer.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
