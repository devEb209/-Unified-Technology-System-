-- ARKHER SYSTEM Z.0470 :: Narrative Memory Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0470"
	S.key = "arkher.origin.narrativememory.self_critique"
	S.name = "Narrative Memory Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.intent_bridge" }
	S.tags = { "z", "narrativememory", "critic", "origin" }
	S.description = "Narrative Memory Self Critique: weighted judgement of the technology's own output for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.narrativememory.self_critique", passMark = 0.83, reviseMark = 0.48, seed = 25888 })
		inst.system = S
		inst.ctx = ctx
