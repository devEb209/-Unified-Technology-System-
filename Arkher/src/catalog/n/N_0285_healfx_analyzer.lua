-- ARKHER SYSTEM N.0285 :: Heal Effect Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0285"
	S.key = "arkher.vfx.healfx.analysis"
	S.name = "Heal Effect Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Heal Effect"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.healfx.spatial_index" }
	S.tags = { "n", "healfx", "analyzer", "vfx" }
	S.description = "Heal Effect Analysis: cost, overdraw and stability analysis of the effect for the Heal Effect subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.healfx.analysis", window = 187, buckets = 15, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
