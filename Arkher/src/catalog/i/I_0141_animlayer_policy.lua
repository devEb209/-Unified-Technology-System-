-- ARKHER SYSTEM I.0141 :: Animation Layer Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0141"
	S.key = "arkher.anim.animlayer.quality_policy"
	S.name = "Animation Layer Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlayer.pose_cache" }
	S.tags = { "i", "animlayer", "policy", "anim" }
	S.description = "Animation Layer Quality Policy: device tier rules for rate, bones and solvers for the Animation Layer subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.animlayer.quality_policy", algorithm = "roundrobin", starvationGuard = 52 })
		inst.system = S
		inst.ctx = ctx
