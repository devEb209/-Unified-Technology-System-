-- ARKHER SYSTEM Z.0915 :: Deterministic Replay Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0915"
	S.key = "arkher.origin.deterministicreplay.signal_composition"
	S.name = "Deterministic Replay Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deterministicreplay.telemetry_ledger" }
	S.tags = { "z", "deterministicreplay", "composer", "origin" }
	S.description = "Deterministic Replay Signal Composition: blending of the technology's input signals into one output for the Deterministic Replay subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.deterministicreplay.signal_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
