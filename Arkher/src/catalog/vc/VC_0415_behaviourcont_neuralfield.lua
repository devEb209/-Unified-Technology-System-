-- ARKHER SYSTEM VC.0415 :: Behaviour Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0415"
	S.key = "arkher.contneural.behaviourcont.neural_field"
	S.name = "Behaviour Continuum Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.behaviourcont.coherence_guard" }
	S.tags = { "vc", "behaviourcont", "neuralfield", "contneural" }
	S.description = "Behaviour Continuum Neural Field: neural field encoding and reconstruction for the Behaviour Continuum subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.behaviourcont.neural_field", dims = 16, hidden = 12, seed = 51193 })
		inst.system = S
		inst.ctx = ctx
