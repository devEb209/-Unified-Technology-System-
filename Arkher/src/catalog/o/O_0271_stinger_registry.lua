-- ARKHER SYSTEM O.0271 :: Stinger Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0271"
	S.key = "arkher.audio.stinger.asset_registry"
	S.name = "Stinger Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Stinger"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.stinger.streaming" }
	S.tags = { "o", "stinger", "registry", "audio" }
	S.description = "Stinger Asset Registry: catalogue of sounds, variations and metadata for the Stinger subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.stinger.asset_registry" })
		inst.system = S
		inst.ctx = ctx
