-- ARKHER SYSTEM VC.0139 :: Fidelity Band Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0139"
	S.key = "arkher.contneural.fidelityband.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.fidelityband.coherence_guard" }
	S.tags = { "vc", "fidelityband", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.fidelityband.neural_field", dims = 12, hidden = 8, seed = 86068 })
		inst.system = S
		inst.ctx = ctx
