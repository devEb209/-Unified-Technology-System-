-- ARKHER SYSTEM H.0191 :: Island Solver Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0191"
	S.key = "arkher.physics.island.budget_governor"
	S.name = "Island Solver Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.island.broadphase_index" }
	S.tags = { "h", "island", "budgeter", "physics" }
	S.description = "Island Solver Budget Governor: simulation time budget allocation across islands for the Island Solver subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.island.budget_governor", total = 206, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
