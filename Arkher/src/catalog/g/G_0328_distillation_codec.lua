-- ARKHER SYSTEM G.0328 :: Model Distillation Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0328"
	S.key = "arkher.neural.distillation.weight_codec"
	S.name = "Model Distillation Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.distillation.model_registry" }
	S.tags = { "g", "distillation", "codec", "neural" }
	S.description = "Model Distillation Weight Codec: weight serialization and quantized transport for the Model Distillation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.distillation.weight_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
