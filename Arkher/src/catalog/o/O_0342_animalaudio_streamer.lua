-- ARKHER SYSTEM O.0342 :: Animal Audio Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0342"
	S.key = "arkher.audio.animalaudio.streaming"
	S.name = "Animal Audio Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Animal Audio"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.animalaudio.voice_budget" }
	S.tags = { "o", "animalaudio", "streamer", "audio" }
	S.description = "Animal Audio Streaming: distance-driven residency of audio assets for the Animal Audio subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.animalaudio.streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
