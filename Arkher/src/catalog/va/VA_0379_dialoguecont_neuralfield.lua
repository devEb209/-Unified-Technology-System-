-- ARKHER SYSTEM VA.0379 :: Dialogue Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0379"
	S.key = "arkher.contworld.dialoguecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.dialoguecont.coherence_guard" }
	S.tags = { "va", "dialoguecont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.dialoguecont.neural_field", dims = 12, hidden = 8, seed = 75824 })
		inst.system = S
		inst.ctx = ctx
