-- ARKHER SYSTEM N.0433 :: Cloth Wind Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0433"
	S.key = "arkher.vfx.clothwind.ribbon_and_trail"
	S.name = "Cloth Wind Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloth Wind"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.clothwind.force_field" }
	S.tags = { "n", "clothwind", "ribbon", "vfx" }
	S.description = "Cloth Wind Ribbon And Trail: trail points, tapering, beams and decimation for the Cloth Wind subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.clothwind.ribbon_and_trail", maxPoints = 56, lifetime = 1.80, minDistance = 0.25, width = 0.70 })
		inst.system = S
		inst.ctx = ctx
