-- ARKHER SYSTEM F.0404 :: Draw Call Batching Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0404"
	S.key = "arkher.render.batching.frame_analysis"
	S.name = "Draw Call Batching Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.batching.pass_cache" }
	S.tags = { "f", "batching", "analyzer", "render" }
	S.description = "Draw Call Batching Frame Analysis: per-pass cost analysis and outlier detection for the Draw Call Batching subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.batching.frame_analysis", window = 200, buckets = 16, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
