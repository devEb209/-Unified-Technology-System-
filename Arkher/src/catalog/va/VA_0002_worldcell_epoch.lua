-- ARKHER SYSTEM VA.0002 :: World Grid Cell Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0002"
	S.key = "arkher.contworld.worldcell.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldcell.infinite_grid" }
	S.tags = { "va", "worldcell", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.worldcell.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
