-- ARKHER SYSTEM I.0163 :: Additive Layer Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0163"
	S.key = "arkher.anim.additivelayer.compression_codec"
	S.name = "Additive Layer Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.additivelayer.retarget_graph" }
	S.tags = { "i", "additivelayer", "codec", "anim" }
	S.description = "Additive Layer Compression Codec: curve compression and quantized transport for the Additive Layer subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.additivelayer.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
