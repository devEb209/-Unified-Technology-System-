-- ARKHER SYSTEM I.0239 :: Locomotion Blend Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0239"
	S.key = "arkher.anim.locomotionblend.physical_blend"
	S.name = "Locomotion Blend Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.locomotionblend.inverse_kinematics" }
	S.tags = { "i", "locomotionblend", "ragdoll", "anim" }
	S.description = "Locomotion Blend Physical Blend: physical bones blended against the animated pose for the Locomotion Blend subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.locomotionblend.physical_blend", blendSpeed = 4.80 })
		inst.system = S
		inst.ctx = ctx
