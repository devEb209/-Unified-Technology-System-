-- ARKHER SYSTEM G.0242 :: Behaviour Prediction Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0242"
	S.key = "arkher.neural.behaviorpredict.reconstruction"
	S.name = "Behaviour Prediction Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.behaviorpredict.temporal_history" }
	S.tags = { "g", "behaviorpredict", "upscaler", "neural" }
	S.description = "Behaviour Prediction Reconstruction: resolution ladder and image reconstruction for the Behaviour Prediction subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.behaviorpredict.reconstruction", targetMs = 11.10, index = 3, sharpness = 0.48 })
		inst.system = S
		inst.ctx = ctx
