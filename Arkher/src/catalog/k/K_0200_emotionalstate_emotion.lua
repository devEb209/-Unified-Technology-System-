-- ARKHER SYSTEM K.0200 :: Emotional State Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0200"
	S.key = "arkher.npc.emotionalstate.emotion"
	S.name = "Emotional State Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.emotionalstate.drive_system" }
	S.tags = { "k", "emotionalstate", "emotion", "npc" }
	S.description = "Emotional State Emotion: appraisal of events into valence, arousal and mood for the Emotional State subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.emotionalstate.emotion", inertia = 0.83, decayRate = 0.28, baselineArousal = 0.18 })
		inst.system = S
		inst.ctx = ctx
