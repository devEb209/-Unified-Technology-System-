-- ARKHER SYSTEM Z.0521 :: Migration Dynamics Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0521"
	S.key = "arkher.origin.migrationdynamics.reality_layering"
	S.name = "Migration Dynamics Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "migrationdynamics", "reality", "origin" }
	S.description = "Migration Dynamics Reality Layering: stacked authored, simulated, proposed and player realities for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.migrationdynamics.reality_layering" })
		inst.system = S
		inst.ctx = ctx
