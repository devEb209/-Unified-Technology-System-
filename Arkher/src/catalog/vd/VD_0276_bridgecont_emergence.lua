-- ARKHER SYSTEM VD.0276 :: Bridge Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0276"
	S.key = "arkher.contsim.bridgecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.bridgecont.reality_continuum" }
	S.tags = { "vd", "bridgecont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.bridgecont.emergence_continuum", windowSize = 7, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
