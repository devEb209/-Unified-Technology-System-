-- ARKHER SYSTEM Z.0639 :: Intent Driven Authoring Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0639"
	S.key = "arkher.origin.intentauthoring.residency_streaming"
	S.name = "Intent Driven Authoring Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.budget_governor" }
	S.tags = { "z", "intentauthoring", "streamer", "origin" }
	S.description = "Intent Driven Authoring Residency Streaming: distance-driven residency of the technology's workload for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.intentauthoring.residency_streaming", radius = 280, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
