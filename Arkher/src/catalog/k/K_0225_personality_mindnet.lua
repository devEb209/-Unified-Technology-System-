-- ARKHER SYSTEM K.0225 :: Personality Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0225"
	S.key = "arkher.npc.personality.mind_network"
	S.name = "Personality Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "personality", "mindnet", "npc" }
	S.description = "Personality Mind Network: the learned policy that turns perception into a decision for the Personality subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.personality.mind_network", inputs = 6, hidden = 8, seed = 85964, learningRate = 0.070, exploration = 0.040 })
		inst.system = S
		inst.ctx = ctx
