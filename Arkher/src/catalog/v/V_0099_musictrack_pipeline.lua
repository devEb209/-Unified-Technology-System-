-- ARKHER SYSTEM V.0099 :: Music Track Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0099"
	S.key = "arkher.asset.musictrack.cook_pipeline"
	S.name = "Music Track Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.musictrack.bundling" }
	S.tags = { "v", "musictrack", "pipeline", "asset" }
	S.description = "Music Track Cook Pipeline: staged cooking with isolation and retries for the Music Track subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.musictrack.cook_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
