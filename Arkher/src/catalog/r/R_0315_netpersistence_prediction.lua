-- ARKHER SYSTEM R.0315 :: Data Persistence Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0315"
	S.key = "arkher.net.netpersistence.prediction_and_reconciliation"
	S.name = "Data Persistence Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netpersistence.time_sync" }
	S.tags = { "r", "netpersistence", "prediction", "net" }
	S.description = "Data Persistence Prediction And Reconciliation: client simulation, correction and input replay for the Data Persistence subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.netpersistence.prediction_and_reconciliation", errorThreshold = 0.045, smoothing = 11.0, maxInputs = 160 })
		inst.system = S
		inst.ctx = ctx
