-- ARKHER SYSTEM E.0124 :: Emissive Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0124"
	S.key = "arkher.material.emissive.texture_sampling"
	S.name = "Emissive Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Emissive"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.emissive.shading_graph" }
	S.tags = { "e", "emissive", "sampler", "material" }
	S.description = "Emissive Texture Sampling: atlas packing, mip chain and filtered sampling for the Emissive subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.emissive.texture_sampling", atlasSize = 256, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
