-- ARKHER SYSTEM O.0380 :: Mix Snapshot Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0380"
	S.key = "arkher.audio.mixsnapshot.compression_codec"
	S.name = "Mix Snapshot Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mix Snapshot"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mixsnapshot.asset_registry" }
	S.tags = { "o", "mixsnapshot", "codec", "audio" }
	S.description = "Mix Snapshot Compression Codec: payload encoding of audio state and events for the Mix Snapshot subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.mixsnapshot.compression_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
