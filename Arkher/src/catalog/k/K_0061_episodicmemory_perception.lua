-- ARKHER SYSTEM K.0061 :: Episodic Memory Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0061"
	S.key = "arkher.npc.episodicmemory.perception"
	S.name = "Episodic Memory Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.episodicmemory.emotion" }
	S.tags = { "k", "episodicmemory", "perception", "npc" }
	S.description = "Episodic Memory Perception: sight, hearing and bounded attention for the Episodic Memory subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.episodicmemory.perception", sightRange = 35, hearingRange = 28, attentionSlots = 5, fov = 1.700 })
		inst.system = S
		inst.ctx = ctx
