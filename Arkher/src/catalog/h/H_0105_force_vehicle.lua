-- ARKHER SYSTEM H.0105 :: Force Accumulator Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0105"
	S.key = "arkher.physics.force.vehicle"
	S.name = "Force Accumulator Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.force.character_motion" }
	S.tags = { "h", "force", "vehicle", "physics" }
	S.description = "Force Accumulator Vehicle: suspension, drivetrain, steering and tire friction for the Force Accumulator subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.force.vehicle", mass = 1100, wheelbase = 2.80, track = 2.00, maxRpm = 6200 })
		inst.system = S
		inst.ctx = ctx
