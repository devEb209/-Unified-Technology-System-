-- ARKHER SYSTEM I.0426 :: Animation LOD Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0426"
	S.key = "arkher.anim.animlod.pose_cache"
	S.name = "Animation LOD Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlod.playback_pipeline" }
	S.tags = { "i", "animlod", "cache", "anim" }
	S.description = "Animation LOD Pose Cache: reuse of sampled poses across frames and instances for the Animation LOD subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.animlod.pose_cache", policy = "lru", capacity = 107, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
