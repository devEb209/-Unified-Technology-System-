-- ARKHER SYSTEM N.0437 :: Cloth Wind Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0437"
	S.key = "arkher.vfx.clothwind.spawn_budget"
	S.name = "Cloth Wind Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloth Wind"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.clothwind.effect_composition" }
	S.tags = { "n", "clothwind", "budgeter", "vfx" }
	S.description = "Cloth Wind Spawn Budget: global particle budget shared by every live effect for the Cloth Wind subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.clothwind.spawn_budget", total = 211, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
