-- ARKHER SYSTEM P.0011 :: Player Character Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0011"
	S.key = "arkher.play.playercharacter.save_codec"
	S.name = "Player Character Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playercharacter.content_registry" }
	S.tags = { "p", "playercharacter", "codec", "play" }
	S.description = "Player Character Save Codec: persistence, diffing and checksum of gameplay state for the Player Character subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.playercharacter.save_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
