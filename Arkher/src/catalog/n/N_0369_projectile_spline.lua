-- ARKHER SYSTEM N.0369 :: Projectile Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0369"
	S.key = "arkher.vfx.projectile.curve_authoring"
	S.name = "Projectile Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Projectile"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.projectile.ribbon_and_trail" }
	S.tags = { "n", "projectile", "spline", "vfx" }
	S.description = "Projectile Curve Authoring: authored curves driving the effect over its life for the Projectile subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.projectile.curve_authoring", tension = 0.60, closed = false })
		inst.system = S
		inst.ctx = ctx
