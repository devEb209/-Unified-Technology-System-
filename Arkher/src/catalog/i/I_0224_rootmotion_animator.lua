-- ARKHER SYSTEM I.0224 :: Root Motion Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0224"
	S.key = "arkher.anim.rootmotion.layered_blending"
	S.name = "Root Motion Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Root Motion"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.rootmotion.clip_sampling" }
	S.tags = { "i", "rootmotion", "animator", "anim" }
	S.description = "Root Motion Layered Blending: layers, crossfades, masks and blend trees for the Root Motion subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.rootmotion.layered_blending", budget = 14 })
		inst.system = S
		inst.ctx = ctx
