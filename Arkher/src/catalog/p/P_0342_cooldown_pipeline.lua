-- ARKHER SYSTEM P.0342 :: Cooldown Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0342"
	S.key = "arkher.play.cooldown.rule_pipeline"
	S.name = "Cooldown Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Cooldown"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.cooldown.state_machine" }
	S.tags = { "p", "cooldown", "pipeline", "play" }
	S.description = "Cooldown Rule Pipeline: ordered rules applied to every gameplay event for the Cooldown subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.cooldown.rule_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
