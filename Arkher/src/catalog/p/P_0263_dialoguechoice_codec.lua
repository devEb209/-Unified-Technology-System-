-- ARKHER SYSTEM P.0263 :: Dialogue Choice Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0263"
	S.key = "arkher.play.dialoguechoice.save_codec"
	S.name = "Dialogue Choice Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.dialoguechoice.content_registry" }
	S.tags = { "p", "dialoguechoice", "codec", "play" }
	S.description = "Dialogue Choice Save Codec: persistence, diffing and checksum of gameplay state for the Dialogue Choice subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.dialoguechoice.save_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
