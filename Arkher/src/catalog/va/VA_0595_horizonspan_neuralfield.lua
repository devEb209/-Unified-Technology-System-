-- ARKHER SYSTEM VA.0595 :: Horizon Span Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0595"
	S.key = "arkher.contworld.horizonspan.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.horizonspan.coherence_guard" }
	S.tags = { "va", "horizonspan", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.horizonspan.neural_field", dims = 20, hidden = 16, seed = 88810 })
		inst.system = S
		inst.ctx = ctx
