-- ARKHER SYSTEM W.0387 :: Preview Render Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0387"
	S.key = "arkher.cine.previewrender.colour_grade"
	S.name = "Preview Render Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.previewrender.camera_rig" }
	S.tags = { "w", "previewrender", "grade", "cine" }
	S.description = "Preview Render Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Preview Render subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.previewrender.colour_grade", exposure = -0.09, contrast = 0.96, saturation = 0.86, toneMap = "filmic" })
		inst.system = S
		inst.ctx = ctx
