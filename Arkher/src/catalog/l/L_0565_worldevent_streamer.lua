-- ARKHER SYSTEM L.0565 :: World Event Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0565"
	S.key = "arkher.sim.worldevent.streaming"
	S.name = "World Event Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldevent.state_codec" }
	S.tags = { "l", "worldevent", "streamer", "sim" }
	S.description = "World Event Streaming: distance-driven residency of simulated regions for the World Event subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.worldevent.streaming", radius = 320, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
