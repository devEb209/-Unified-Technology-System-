-- ARKHER SYSTEM F.0147 :: Light Clustering Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0147"
	S.key = "arkher.render.lightcluster.temporal_resolve"
	S.name = "Light Clustering Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.lightcluster.probe_volume" }
	S.tags = { "f", "lightcluster", "temporal", "render" }
	S.description = "Light Clustering Temporal Resolve: history reprojection with neighbourhood clamping for the Light Clustering subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.lightcluster.temporal_resolve", feedback = 0.83, phase = 8 })
		inst.system = S
		inst.ctx = ctx
