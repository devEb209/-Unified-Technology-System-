-- ARKHER SYSTEM T.0143 :: Tool Use Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0143"
	S.key = "arkher.ai.tooluse.plan_workflow"
	S.name = "Tool Use Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.tooluse.semantic_knowledge" }
	S.tags = { "t", "tooluse", "workflow", "ai" }
	S.description = "Tool Use Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Tool Use subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.tooluse.plan_workflow", maxRetries = 3, budget = 120 })
		inst.system = S
		inst.ctx = ctx
