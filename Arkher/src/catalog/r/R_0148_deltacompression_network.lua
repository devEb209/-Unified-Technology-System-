-- ARKHER SYSTEM R.0148 :: Delta Compression Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0148"
	S.key = "arkher.net.deltacompression.transport_graph"
	S.name = "Delta Compression Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.deltacompression.prediction_and_reconciliation" }
	S.tags = { "r", "deltacompression", "network", "net" }
	S.description = "Delta Compression Transport Graph: topology, capacity and routing between endpoints for the Delta Compression subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.deltacompression.transport_graph" })
		inst.system = S
		inst.ctx = ctx
