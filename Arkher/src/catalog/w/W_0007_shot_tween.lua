-- ARKHER SYSTEM W.0007 :: Shot Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0007"
	S.key = "arkher.cine.shot.motion_tween"
	S.name = "Shot Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Shot"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.shot.playback_orchestrator" }
	S.tags = { "w", "shot", "tween", "cine" }
	S.description = "Shot Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Shot subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.shot.motion_tween", timeScale = 0.99 })
		inst.system = S
		inst.ctx = ctx
