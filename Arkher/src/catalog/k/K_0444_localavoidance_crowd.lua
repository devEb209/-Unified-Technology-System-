-- ARKHER SYSTEM K.0444 :: Local Avoidance Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0444"
	S.key = "arkher.npc.localavoidance.crowd_steering"
	S.name = "Local Avoidance Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.localavoidance.navigation" }
	S.tags = { "k", "localavoidance", "crowd", "npc" }
	S.description = "Local Avoidance Crowd Steering: local avoidance, cohesion and arrival at scale for the Local Avoidance subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.localavoidance.crowd_steering", radius = 0.75, maxSpeed = 3.70, cellSize = 7 })
		inst.system = S
		inst.ctx = ctx
