-- ARKHER SYSTEM K.0270 :: Hearing Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0270"
	S.key = "arkher.npc.hearing.emotion"
	S.name = "Hearing Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hearing.drive_system" }
	S.tags = { "k", "hearing", "emotion", "npc" }
	S.description = "Hearing Emotion: appraisal of events into valence, arousal and mood for the Hearing subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.hearing.emotion", inertia = 0.83, decayRate = 0.38, baselineArousal = 0.18 })
		inst.system = S
		inst.ctx = ctx
