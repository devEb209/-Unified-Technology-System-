-- ARKHER SYSTEM F.0133 :: Global Illumination Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0133"
	S.key = "arkher.render.gi.temporal_resolve"
	S.name = "Global Illumination Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.gi.probe_volume" }
	S.tags = { "f", "gi", "temporal", "render" }
	S.description = "Global Illumination Temporal Resolve: history reprojection with neighbourhood clamping for the Global Illumination subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.gi.temporal_resolve", feedback = 0.93, phase = 8 })
		inst.system = S
		inst.ctx = ctx
