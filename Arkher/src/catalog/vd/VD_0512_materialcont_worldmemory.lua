-- ARKHER SYSTEM VD.0512 :: Material Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0512"
	S.key = "arkher.contsim.materialcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.materialcont.neural_field" }
	S.tags = { "vd", "materialcont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.materialcont.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
