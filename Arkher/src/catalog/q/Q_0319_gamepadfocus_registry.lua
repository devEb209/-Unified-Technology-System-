-- ARKHER SYSTEM Q.0319 :: Gamepad Focus Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0319"
	S.key = "arkher.ui.gamepadfocus.localization_registry"
	S.name = "Gamepad Focus Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.gamepadfocus.theme_composition" }
	S.tags = { "q", "gamepadfocus", "registry", "ui" }
	S.description = "Gamepad Focus Localization Registry: catalogue of strings, plurals and locale metadata for the Gamepad Focus subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.gamepadfocus.localization_registry" })
		inst.system = S
		inst.ctx = ctx
