-- ARKHER SYSTEM Z.0208 :: Persistent Reality State Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0208"
	S.key = "arkher.origin.persistentreality.semantic_graph"
	S.name = "Persistent Reality State Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.world_architect" }
	S.tags = { "z", "persistentreality", "knowledge", "origin" }
	S.description = "Persistent Reality State Semantic Graph: typed entities and inferred relations of the technology itself for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.persistentreality.semantic_graph", dims = 32 })
		inst.system = S
		inst.ctx = ctx
