-- ARKHER SYSTEM Z.0026 :: Predictive Optimization Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0026"
	S.key = "arkher.origin.predictiveopt.emergence_detection"
	S.name = "Predictive Optimization Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.world_memory" }
	S.tags = { "z", "predictiveopt", "emergence", "origin" }
	S.description = "Predictive Optimization Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.predictiveopt.emergence_detection", windowSize = 4, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
