-- ARKHER SYSTEM O.0138 :: Rain Audio Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0138"
	S.key = "arkher.audio.rainaudio.streaming"
	S.name = "Rain Audio Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Rain Audio"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.rainaudio.voice_budget" }
	S.tags = { "o", "rainaudio", "streamer", "audio" }
	S.description = "Rain Audio Streaming: distance-driven residency of audio assets for the Rain Audio subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.rainaudio.streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
