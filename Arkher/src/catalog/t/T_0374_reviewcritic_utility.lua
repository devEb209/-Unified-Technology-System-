-- ARKHER SYSTEM T.0374 :: Review Critic Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0374"
	S.key = "arkher.ai.reviewcritic.utility_selection"
	S.name = "Review Critic Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.reviewcritic.working_memory" }
	S.tags = { "t", "reviewcritic", "utility", "ai" }
	S.description = "Review Critic Utility Selection: scored choice between competing courses of action for the Review Critic subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.reviewcritic.utility_selection", momentum = 0.15 })
		inst.system = S
		inst.ctx = ctx
