-- ARKHER SYSTEM J.0160 :: Gesture Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0160"
	S.key = "arkher.character.gesture.locomotion"
	S.name = "Gesture Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gesture.physical_response" }
	S.tags = { "j", "gesture", "charmotor", "character" }
	S.description = "Gesture Locomotion: capsule locomotion driving the character for the Gesture subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.gesture.locomotion", radius = 0.45, height = 1.90, maxSpeed = 9.00, jumpHeight = 1.40, stepOffset = 0.45 })
		inst.system = S
		inst.ctx = ctx
