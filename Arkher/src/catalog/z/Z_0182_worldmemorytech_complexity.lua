-- ARKHER SYSTEM Z.0182 :: World Memory Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0182"
	S.key = "arkher.origin.worldmemorytech.complexity_governance"
	S.name = "World Memory Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldmemorytech.reality_layering" }
	S.tags = { "z", "worldmemorytech", "complexity", "origin" }
	S.description = "World Memory Complexity Governance: measured scene cost turned into per-subsystem directives for the World Memory subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.worldmemorytech.complexity_governance", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
