-- ARKHER SYSTEM J.0177 :: Accessory Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0177"
	S.key = "arkher.character.accessory.rig_definition"
	S.name = "Accessory Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "accessory", "skeleton", "character" }
	S.description = "Accessory Rig Definition: character rig definition and bone budget for the Accessory subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.accessory.rig_definition" })
		inst.system = S
		inst.ctx = ctx
