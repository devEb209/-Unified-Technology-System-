-- ARKHER SYSTEM F.0205 :: Fog Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0205"
	S.key = "arkher.render.fog.draw_budget"
	S.name = "Fog Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Fog"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.fog.adaptive_resolution" }
	S.tags = { "f", "fog", "budgeter", "render" }
	S.description = "Fog Draw Budget: draw call and triangle budget allocation for the Fog subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.fog.draw_budget", total = 277, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
