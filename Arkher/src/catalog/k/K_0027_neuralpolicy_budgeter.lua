-- ARKHER SYSTEM K.0027 :: Neural Policy Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0027"
	S.key = "arkher.npc.neuralpolicy.thinking_budget"
	S.name = "Neural Policy Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.neuralpolicy.daily_schedule" }
	S.tags = { "k", "neuralpolicy", "budgeter", "npc" }
	S.description = "Neural Policy Thinking Budget: allocation of per-frame thinking time across NPCs for the Neural Policy subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.neuralpolicy.thinking_budget", total = 150, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
