-- ARKHER SYSTEM Z.0178 :: Self Analyzing Project Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0178"
	S.key = "arkher.origin.selfanalyzing.budget_governor"
	S.name = "Self Analyzing Project Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.behaviour_analysis" }
	S.tags = { "z", "selfanalyzing", "budgeter", "origin" }
	S.description = "Self Analyzing Project Budget Governor: allocation of a scarce resource across the technology's consumers for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.selfanalyzing.budget_governor", total = 306, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
