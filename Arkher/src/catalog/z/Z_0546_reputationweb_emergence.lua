-- ARKHER SYSTEM Z.0546 :: Reputation Web Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0546"
	S.key = "arkher.origin.reputationweb.emergence_detection"
	S.name = "Reputation Web Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.world_memory" }
	S.tags = { "z", "reputationweb", "emergence", "origin" }
	S.description = "Reputation Web Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.reputationweb.emergence_detection", windowSize = 4, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
