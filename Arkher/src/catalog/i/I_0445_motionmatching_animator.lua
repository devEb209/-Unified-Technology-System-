-- ARKHER SYSTEM I.0445 :: Motion Matching Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0445"
	S.key = "arkher.anim.motionmatching.layered_blending"
	S.name = "Motion Matching Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.motionmatching.clip_sampling" }
	S.tags = { "i", "motionmatching", "animator", "anim" }
	S.description = "Motion Matching Layered Blending: layers, crossfades, masks and blend trees for the Motion Matching subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.motionmatching.layered_blending", budget = 8 })
		inst.system = S
		inst.ctx = ctx
