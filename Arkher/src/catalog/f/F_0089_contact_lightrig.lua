-- ARKHER SYSTEM F.0089 :: Contact Shadows Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0089"
	S.key = "arkher.render.contact.lighting_rig"
	S.name = "Contact Shadows Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.contact.geometry_virtualization" }
	S.tags = { "f", "contact", "lightrig", "render" }
	S.description = "Contact Shadows Lighting Rig: light clustering, importance and cascades for the Contact Shadows subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.contact.lighting_rig", maxActive = 9 })
		inst.system = S
		inst.ctx = ctx
