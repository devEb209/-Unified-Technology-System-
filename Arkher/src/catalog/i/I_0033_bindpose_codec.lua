-- ARKHER SYSTEM I.0033 :: Bind Pose Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0033"
	S.key = "arkher.anim.bindpose.compression_codec"
	S.name = "Bind Pose Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bind Pose"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bindpose.retarget_graph" }
	S.tags = { "i", "bindpose", "codec", "anim" }
	S.description = "Bind Pose Compression Codec: curve compression and quantized transport for the Bind Pose subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.bindpose.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
