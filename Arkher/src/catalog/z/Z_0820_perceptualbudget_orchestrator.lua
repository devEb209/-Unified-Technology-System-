-- ARKHER SYSTEM Z.0820 :: Perceptual Budgeting Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0820"
	S.key = "arkher.origin.perceptualbudget.orchestration"
	S.name = "Perceptual Budgeting Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.perceptualbudget.residency_streaming" }
	S.tags = { "z", "perceptualbudget", "orchestrator", "origin" }
	S.description = "Perceptual Budgeting Orchestration: lifecycle and phase orchestration of the technology for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.perceptualbudget.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
