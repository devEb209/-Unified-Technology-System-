-- ARKHER SYSTEM L.0401 :: Wealth Distribution Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0401"
	S.key = "arkher.sim.wealth.fidelity_policy"
	S.name = "Wealth Distribution Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wealth.streaming" }
	S.tags = { "l", "wealth", "policy", "sim" }
	S.description = "Wealth Distribution Fidelity Policy: rules that pick full, cohort or statistical simulation for the Wealth Distribution subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.wealth.fidelity_policy", algorithm = "edf", starvationGuard = 29 })
		inst.system = S
		inst.ctx = ctx
