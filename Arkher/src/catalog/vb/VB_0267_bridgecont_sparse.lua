-- ARKHER SYSTEM VB.0267 :: Bridge Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0267"
	S.key = "arkher.conttime.bridgecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.bridgecont.epoch_clock" }
	S.tags = { "vb", "bridgecont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.bridgecont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
