-- ARKHER SYSTEM VD.0199 :: Architect District Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0199"
	S.key = "arkher.contsim.architectdistrict.neural_field"
	S.name = "Architect District Neural Field"
	S.category = "VD"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.architectdistrict.coherence_guard" }
	S.tags = { "vd", "architectdistrict", "neuralfield", "contsim" }
	S.description = "Architect District Neural Field: neural field encoding and reconstruction for the Architect District subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.architectdistrict.neural_field", dims = 20, hidden = 16, seed = 3834 })
		inst.system = S
		inst.ctx = ctx
