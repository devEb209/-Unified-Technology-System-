-- ARKHER SYSTEM VD.0450 :: Animation Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0450"
	S.key = "arkher.contsim.animcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.animcont.persistent_state" }
	S.tags = { "vd", "animcont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.animcont.coherence_guard", window = 133, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
