-- ARKHER SYSTEM P.0041 :: Ability State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0041"
	S.key = "arkher.play.ability.state_machine"
	S.name = "Ability State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ability"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ability.combat_resolution" }
	S.tags = { "p", "ability", "orchestrator", "play" }
	S.description = "Ability State Machine: the phase machine that drives this gameplay loop for the Ability subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.ability.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
