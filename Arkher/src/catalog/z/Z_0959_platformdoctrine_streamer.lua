-- ARKHER SYSTEM Z.0959 :: Platform Abstraction Doctrine Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0959"
	S.key = "arkher.origin.platformdoctrine.residency_streaming"
	S.name = "Platform Abstraction Doctrine Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.platformdoctrine.budget_governor" }
	S.tags = { "z", "platformdoctrine", "streamer", "origin" }
	S.description = "Platform Abstraction Doctrine Residency Streaming: distance-driven residency of the technology's workload for the Platform Abstraction Doctrine subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.platformdoctrine.residency_streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
