-- ARKHER SYSTEM E.0528 :: Material LOD Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0528"
	S.key = "arkher.material.materiallod.shading_graph"
	S.name = "Material LOD Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Material LOD"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.materiallod.layer_composition" }
	S.tags = { "e", "materiallod", "shadegraph", "material" }
	S.description = "Material LOD Shading Graph: node graph evaluated and compiled to Luau for the Material LOD subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.materiallod.shading_graph" })
		inst.system = S
		inst.ctx = ctx
