-- ARKHER SYSTEM K.0589 :: Relationship Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0589"
	S.key = "arkher.npc.relationship.mind_network"
	S.name = "Relationship Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "relationship", "mindnet", "npc" }
	S.description = "Relationship Mind Network: the learned policy that turns perception into a decision for the Relationship subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.relationship.mind_network", inputs = 9, hidden = 6, seed = 31887, learningRate = 0.085, exploration = 0.055 })
		inst.system = S
		inst.ctx = ctx
