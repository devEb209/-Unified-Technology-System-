-- ARKHER SYSTEM VD.0187 :: Simulation Domain Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0187"
	S.key = "arkher.contsim.simdomain.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.simdomain.coherence_guard" }
	S.tags = { "vd", "simdomain", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.simdomain.neural_field", dims = 20, hidden = 16, seed = 63274 })
		inst.system = S
		inst.ctx = ctx
