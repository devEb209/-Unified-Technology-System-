-- ARKHER SYSTEM VA.0183 :: Simulation Domain Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0183"
	S.key = "arkher.contworld.simdomain.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.simdomain.epoch_clock" }
	S.tags = { "va", "simdomain", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.simdomain.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
