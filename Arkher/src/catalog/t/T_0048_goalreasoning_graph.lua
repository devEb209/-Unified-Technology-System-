-- ARKHER SYSTEM T.0048 :: Goal Reasoning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0048"
	S.key = "arkher.ai.goalreasoning.reasoning_graph"
	S.name = "Goal Reasoning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.goalreasoning.world_architect" }
	S.tags = { "t", "goalreasoning", "graph", "ai" }
	S.description = "Goal Reasoning Reasoning Graph: relationship modelling and shortest-path reasoning for the Goal Reasoning subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.goalreasoning.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
