-- ARKHER SYSTEM T.0486 :: Simulation Reasoning Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0486"
	S.key = "arkher.ai.simulationreasoning.utility_selection"
	S.name = "Simulation Reasoning Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.simulationreasoning.working_memory" }
	S.tags = { "t", "simulationreasoning", "utility", "ai" }
	S.description = "Simulation Reasoning Utility Selection: scored choice between competing courses of action for the Simulation Reasoning subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.simulationreasoning.utility_selection", momentum = 0.05 })
		inst.system = S
		inst.ctx = ctx
