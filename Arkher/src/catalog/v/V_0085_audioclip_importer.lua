-- ARKHER SYSTEM V.0085 :: Audio Clip Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0085"
	S.key = "arkher.asset.audioclip.import"
	S.name = "Audio Clip Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "audioclip", "importer", "asset" }
	S.description = "Audio Clip Import: validation, normalization, hashing and deduplication of incoming content for the Audio Clip subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.audioclip.import", unitScale = 1.75 })
		inst.system = S
		inst.ctx = ctx
