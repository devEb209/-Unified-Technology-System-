-- ARKHER SYSTEM VD.0559 :: Device Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0559"
	S.key = "arkher.contsim.devicecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.devicecont.coherence_guard" }
	S.tags = { "vd", "devicecont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.devicecont.neural_field", dims = 24, hidden = 20, seed = 14539 })
		inst.system = S
		inst.ctx = ctx
