-- ARKHER SYSTEM VC.0630 :: Interest Field Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0630"
	S.key = "arkher.contneural.interestfield.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.interestfield.persistent_state" }
	S.tags = { "vc", "interestfield", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.interestfield.coherence_guard", window = 71, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
