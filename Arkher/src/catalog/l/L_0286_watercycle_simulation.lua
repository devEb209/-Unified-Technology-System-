-- ARKHER SYSTEM L.0286 :: Water Cycle Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0286"
	S.key = "arkher.sim.watercycle.simulation_core"
	S.name = "Water Cycle Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "watercycle", "simulation", "sim" }
	S.description = "Water Cycle Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Water Cycle subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.watercycle.simulation_core", fullRadius = 160, reducedRadius = 900, budget = 123 })
		inst.system = S
		inst.ctx = ctx
