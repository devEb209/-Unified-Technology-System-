-- ARKHER SYSTEM T.0187 :: Terrain Generation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0187"
	S.key = "arkher.ai.terraingeneration.world_architect"
	S.name = "Terrain Generation World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.terraingeneration.self_critique" }
	S.tags = { "t", "terraingeneration", "architect", "ai" }
	S.description = "Terrain Generation World Architect: composition of a whole world plan with conserved budgets for the Terrain Generation subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.terraingeneration.world_architect", budget = 1300, seed = 30127 })
		inst.system = S
		inst.ctx = ctx
