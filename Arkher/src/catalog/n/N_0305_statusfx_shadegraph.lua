-- ARKHER SYSTEM N.0305 :: Status Effect Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0305"
	S.key = "arkher.vfx.statusfx.effect_graph"
	S.name = "Status Effect Effect Graph"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.statusfx.curve_authoring" }
	S.tags = { "n", "statusfx", "shadegraph", "vfx" }
	S.description = "Status Effect Effect Graph: node graph describing how the effect is shaded for the Status Effect subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.statusfx.effect_graph" })
		inst.system = S
		inst.ctx = ctx
