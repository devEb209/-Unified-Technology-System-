-- ARKHER SYSTEM F.0587 :: Debug Visualization Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0587"
	S.key = "arkher.render.debugvis.orchestration"
	S.name = "Debug Visualization Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.debugvis.frame_analysis" }
	S.tags = { "f", "debugvis", "orchestrator", "render" }
	S.description = "Debug Visualization Orchestration: frame lifecycle orchestration for the Debug Visualization subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.debugvis.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
