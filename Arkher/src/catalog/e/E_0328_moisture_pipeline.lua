-- ARKHER SYSTEM E.0328 :: Moisture Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0328"
	S.key = "arkher.material.moisture.authoring_pipeline"
	S.name = "Moisture Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Moisture"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.moisture.analysis" }
	S.tags = { "e", "moisture", "pipeline", "material" }
	S.description = "Moisture Authoring Pipeline: ordered authoring and bake stages for the Moisture subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.moisture.authoring_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
