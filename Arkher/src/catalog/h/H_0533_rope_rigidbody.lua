-- ARKHER SYSTEM H.0533 :: Rope Simulation Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0533"
	S.key = "arkher.physics.rope.body_dynamics"
	S.name = "Rope Simulation Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "rope", "rigidbody", "physics" }
	S.description = "Rope Simulation Body Dynamics: integration, impulses, damping and sleeping of a body for the Rope Simulation subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.rope.body_dynamics", mass = 16.00, radius = 1.05, restitution = 0.35, friction = 0.65, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
