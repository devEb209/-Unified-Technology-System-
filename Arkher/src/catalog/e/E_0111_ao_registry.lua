-- ARKHER SYSTEM E.0111 :: Ambient Occlusion Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0111"
	S.key = "arkher.material.ao.variant_registry"
	S.name = "Ambient Occlusion Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.ao.procedural_detail" }
	S.tags = { "e", "ao", "registry", "material" }
	S.description = "Ambient Occlusion Variant Registry: named variants and their lifecycle for the Ambient Occlusion subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.ao.variant_registry" })
		inst.system = S
		inst.ctx = ctx
