-- ARKHER SYSTEM Z.1059 :: Emergent Quest Generation Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.1059"
	S.key = "arkher.origin.emergentquest.residency_streaming"
	S.name = "Emergent Quest Generation Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentquest.budget_governor" }
	S.tags = { "z", "emergentquest", "streamer", "origin" }
	S.description = "Emergent Quest Generation Residency Streaming: distance-driven residency of the technology's workload for the Emergent Quest Generation subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.emergentquest.residency_streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
