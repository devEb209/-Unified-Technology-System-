-- ARKHER SYSTEM VC.0510 :: Material Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0510"
	S.key = "arkher.contneural.materialcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.materialcont.persistent_state" }
	S.tags = { "vc", "materialcont", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.materialcont.coherence_guard", window = 78, threshold = 0.14 })
		inst.system = S
		inst.ctx = ctx
