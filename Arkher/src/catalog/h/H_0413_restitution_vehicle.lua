-- ARKHER SYSTEM H.0413 :: Restitution Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0413"
	S.key = "arkher.physics.restitution.vehicle"
	S.name = "Restitution Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Restitution"
	S.aspect = "Vehicle"
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.restitution.character_motion" }
	S.tags = { "h", "restitution", "vehicle", "physics" }
	S.description = "Restitution Vehicle: suspension, drivetrain, steering and tire friction for the Restitution subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.restitution.vehicle", mass = 2200, wheelbase = 2.90, track = 2.10, maxRpm = 6300 })
		inst.system = S
		inst.ctx = ctx
