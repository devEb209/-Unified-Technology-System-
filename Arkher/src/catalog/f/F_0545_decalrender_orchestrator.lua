-- ARKHER SYSTEM F.0545 :: Decal Rendering Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0545"
	S.key = "arkher.render.decalrender.orchestration"
	S.name = "Decal Rendering Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.decalrender.frame_analysis" }
	S.tags = { "f", "decalrender", "orchestrator", "render" }
	S.description = "Decal Rendering Orchestration: frame lifecycle orchestration for the Decal Rendering subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.decalrender.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
