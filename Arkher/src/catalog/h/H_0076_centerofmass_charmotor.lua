-- ARKHER SYSTEM H.0076 :: Center Of Mass Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0076"
	S.key = "arkher.physics.centerofmass.character_motion"
	S.name = "Center Of Mass Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.centerofmass.query" }
	S.tags = { "h", "centerofmass", "charmotor", "physics" }
	S.description = "Center Of Mass Character Motion: capsule move-and-slide with slopes, steps and jumps for the Center Of Mass subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.centerofmass.character_motion", radius = 0.52, height = 1.97, maxSpeed = 7.70, jumpHeight = 1.30, stepOffset = 0.32 })
		inst.system = S
		inst.ctx = ctx
