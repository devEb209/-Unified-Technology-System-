-- ARKHER SYSTEM Z.1080 :: World Dream State Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.1080"
	S.key = "arkher.origin.worlddream.orchestration"
	S.name = "World Dream State Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.residency_streaming" }
	S.tags = { "z", "worlddream", "orchestrator", "origin" }
	S.description = "World Dream State Orchestration: lifecycle and phase orchestration of the technology for the World Dream State subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.worlddream.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
