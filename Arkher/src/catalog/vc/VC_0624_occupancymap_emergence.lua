-- ARKHER SYSTEM VC.0624 :: Occupancy Map Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0624"
	S.key = "arkher.contneural.occupancymap.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.occupancymap.reality_continuum" }
	S.tags = { "vc", "occupancymap", "emergence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.occupancymap.emergence_continuum", windowSize = 6, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
