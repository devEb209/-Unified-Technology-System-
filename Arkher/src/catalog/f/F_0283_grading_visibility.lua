-- ARKHER SYSTEM F.0283 :: Color Grading Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0283"
	S.key = "arkher.render.grading.visibility_set"
	S.name = "Color Grading Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.grading.view_and_culling" }
	S.tags = { "f", "grading", "visibility", "render" }
	S.description = "Color Grading Visibility Set: cell, portal and occluder visibility for the Color Grading subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.grading.visibility_set", maxDepth = 2 })
		inst.system = S
		inst.ctx = ctx
