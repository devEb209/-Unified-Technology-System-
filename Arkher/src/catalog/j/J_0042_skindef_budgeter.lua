-- ARKHER SYSTEM J.0042 :: Skin Definition Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0042"
	S.key = "arkher.character.skindef.budget_governor"
	S.name = "Skin Definition Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.skindef.variant_registry" }
	S.tags = { "j", "skindef", "budgeter", "character" }
	S.description = "Skin Definition Budget Governor: per-character cost allocation in a crowd for the Skin Definition subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.skindef.budget_governor", total = 189, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
