-- ARKHER SYSTEM E.0206 :: Sheen Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0206"
	S.key = "arkher.material.sheen.instance_cache"
	S.name = "Sheen Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Sheen"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.sheen.quality_policy" }
	S.tags = { "e", "sheen", "cache", "material" }
	S.description = "Sheen Instance Cache: resolved-parameter cache keyed by context for the Sheen subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.sheen.instance_cache", policy = "lru", capacity = 336, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
