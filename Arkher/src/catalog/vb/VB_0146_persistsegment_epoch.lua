-- ARKHER SYSTEM VB.0146 :: Persistence Segment Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0146"
	S.key = "arkher.conttime.persistsegment.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.persistsegment.infinite_grid" }
	S.tags = { "vb", "persistsegment", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.persistsegment.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
