-- ARKHER SYSTEM VD.0371 :: Quest Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0371"
	S.key = "arkher.contsim.questcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.questcont.simulation_fabric" }
	S.tags = { "vd", "questcont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.questcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
