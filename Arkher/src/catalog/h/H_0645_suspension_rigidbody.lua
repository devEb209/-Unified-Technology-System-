-- ARKHER SYSTEM H.0645 :: Wheel Suspension Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0645"
	S.key = "arkher.physics.suspension.body_dynamics"
	S.name = "Wheel Suspension Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "suspension", "rigidbody", "physics" }
	S.description = "Wheel Suspension Body Dynamics: integration, impulses, damping and sleeping of a body for the Wheel Suspension subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.suspension.body_dynamics", mass = 38.00, radius = 1.15, restitution = 0.17, friction = 0.47, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
