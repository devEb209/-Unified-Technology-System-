-- ARKHER SYSTEM T.0599 :: Deployment Reasoning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0599"
	S.key = "arkher.ai.deploymentreasoning.action_planner"
	S.name = "Deployment Reasoning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.deploymentreasoning.utility_selection" }
	S.tags = { "t", "deploymentreasoning", "planner", "ai" }
	S.description = "Deployment Reasoning Action Planner: goal-oriented action planning over preconditions for the Deployment Reasoning subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.deploymentreasoning.action_planner", maxDepth = 11 })
		inst.system = S
		inst.ctx = ctx
