-- ARKHER SYSTEM VC.0164 :: Coherence Seam World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0164"
	S.key = "arkher.contneural.coherenceseam.world_memory_stream"
	S.name = "Coherence Seam World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.coherenceseam.neural_field" }
	S.tags = { "vc", "coherenceseam", "worldmemory", "contneural" }
	S.description = "Coherence Seam World Memory Stream: world memory continuum over epochs for the Coherence Seam subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.coherenceseam.world_memory_stream", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
