-- ARKHER SYSTEM R.0074 :: Transform Replication Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0074"
	S.key = "arkher.net.transformreplication.time_sync"
	S.name = "Transform Replication Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.transformreplication.replication" }
	S.tags = { "r", "transformreplication", "netclock", "net" }
	S.description = "Transform Replication Time Sync: offset estimation, outlier rejection and jitter buffering for the Transform Replication subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.transformreplication.time_sync", tickRate = 40, bufferDelay = 0.100, maxSamples = 18 })
		inst.system = S
		inst.ctx = ctx
