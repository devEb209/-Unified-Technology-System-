-- ARKHER SYSTEM VD.0135 :: Fidelity Band Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0135"
	S.key = "arkher.contsim.fidelityband.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.fidelityband.epoch_clock" }
	S.tags = { "vd", "fidelityband", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.fidelityband.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
