-- ARKHER SYSTEM W.0136 :: Over The Shoulder Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0136"
	S.key = "arkher.cine.overshoulder.shot_composition"
	S.name = "Over The Shoulder Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.overshoulder.colour_grade" }
	S.tags = { "w", "overshoulder", "composer", "cine" }
	S.description = "Over The Shoulder Shot Composition: blending of the signals that make up the final shot for the Over The Shoulder subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.overshoulder.shot_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
