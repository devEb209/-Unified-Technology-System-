-- ARKHER SYSTEM G.0311 :: Weight Quantization Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0311"
	S.key = "arkher.neural.quantization.temporal_history"
	S.name = "Weight Quantization Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.quantization.feature_extraction" }
	S.tags = { "g", "quantization", "temporal", "neural" }
	S.description = "Weight Quantization Temporal History: history buffers reused across frames for the Weight Quantization subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.quantization.temporal_history", feedback = 0.83, phase = 8 })
		inst.system = S
		inst.ctx = ctx
