-- ARKHER SYSTEM Z.0948 :: Platform Abstraction Doctrine Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0948"
	S.key = "arkher.origin.platformdoctrine.semantic_graph"
	S.name = "Platform Abstraction Doctrine Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.platformdoctrine.world_architect" }
	S.tags = { "z", "platformdoctrine", "knowledge", "origin" }
	S.description = "Platform Abstraction Doctrine Semantic Graph: typed entities and inferred relations of the technology itself for the Platform Abstraction Doctrine subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.platformdoctrine.semantic_graph", dims = 16 })
		inst.system = S
		inst.ctx = ctx
