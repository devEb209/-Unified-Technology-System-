-- ARKHER SYSTEM J.0325 :: Character Debug Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0325"
	S.key = "arkher.character.characterdebug.locomotion"
	S.name = "Character Debug Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterdebug.physical_response" }
	S.tags = { "j", "characterdebug", "charmotor", "character" }
	S.description = "Character Debug Locomotion: capsule locomotion driving the character for the Character Debug subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.characterdebug.locomotion", radius = 0.52, height = 1.97, maxSpeed = 5.70, jumpHeight = 1.70, stepOffset = 0.42 })
		inst.system = S
		inst.ctx = ctx
