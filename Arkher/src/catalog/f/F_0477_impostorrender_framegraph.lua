-- ARKHER SYSTEM F.0477 :: Impostor Rendering Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0477"
	S.key = "arkher.render.impostorrender.frame_graph"
	S.name = "Impostor Rendering Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "impostorrender", "framegraph", "render" }
	S.description = "Impostor Rendering Frame Graph: declared passes, culling, ordering and aliasing for the Impostor Rendering subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.impostorrender.frame_graph", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
