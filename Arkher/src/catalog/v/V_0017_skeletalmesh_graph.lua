-- ARKHER SYSTEM V.0017 :: Skeletal Mesh Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0017"
	S.key = "arkher.asset.skeletalmesh.dependency_graph"
	S.name = "Skeletal Mesh Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.skeletalmesh.asset_registry" }
	S.tags = { "v", "skeletalmesh", "graph", "asset" }
	S.description = "Skeletal Mesh Dependency Graph: what references what, and in which order it must be built for the Skeletal Mesh subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.skeletalmesh.dependency_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
