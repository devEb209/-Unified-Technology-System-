-- ARKHER SYSTEM Z.0907 :: Deterministic Replay World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0907"
	S.key = "arkher.origin.deterministicreplay.world_architect"
	S.name = "Deterministic Replay World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deterministicreplay.emergence_detection" }
	S.tags = { "z", "deterministicreplay", "architect", "origin" }
	S.description = "Deterministic Replay World Architect: hierarchical world composition with conserved budgets for the Deterministic Replay subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.deterministicreplay.world_architect", budget = 1000, seed = 80774 })
		inst.system = S
		inst.ctx = ctx
