-- ARKHER SYSTEM Z.0557 :: Reputation Web Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0557"
	S.key = "arkher.origin.reputationweb.behaviour_analysis"
	S.name = "Reputation Web Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.governance_policy" }
	S.tags = { "z", "reputationweb", "analyzer", "origin" }
	S.description = "Reputation Web Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.reputationweb.behaviour_analysis", window = 154, buckets = 10, threshold = 4.60 })
		inst.system = S
		inst.ctx = ctx
