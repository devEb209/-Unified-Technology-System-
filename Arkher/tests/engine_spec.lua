...
t:describe("engine/boot", function(s)
	...
	s:it("reports category coverage", function(a)
		...
		a:equal(r.byCategory.N, 520)
		a:equal(r.byCategory.O, 432)
		a:equal(r.byCategory.P, 480)
		a:equal(r.byCategory.Q, 408)
		a:equal(r.byCategory.R, 360)
		a:equal(r.byCategory.T, 700)
		a:equal(r.byCategory.V, 432)
		a:equal(r.byCategory.W, 408)
		a:equal(r.byCategory.Z, 1100)
		a:equal(r.byCategory.VA, 636)
		a:equal(r.byCategory.VB, 636)
		a:equal(r.byCategory.VC, 636)
		a:equal(r.byCategory.VD, 636)
		a:equal(r.systems, 17188)
	end)
end)
