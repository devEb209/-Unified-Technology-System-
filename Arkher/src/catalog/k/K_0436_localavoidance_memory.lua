-- ARKHER SYSTEM K.0436 :: Local Avoidance Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0436"
	S.key = "arkher.npc.localavoidance.memory"
	S.name = "Local Avoidance Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.localavoidance.mind_network" }
	S.tags = { "k", "localavoidance", "memory", "npc" }
	S.description = "Local Avoidance Memory: episodic memory with decay, recall and consolidation for the Local Avoidance subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.localavoidance.memory", capacity = 37, decayRate = 0.045, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
