-- ARKHER SYSTEM L.0425 :: Law Calendar
...
return function(A)
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.law.society" }
	S.tags = { "l", "law", "schedule", "sim" }
	S.description = "Law Calendar: hours, days and seasons driving the region for the Law subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.law.calendar", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
