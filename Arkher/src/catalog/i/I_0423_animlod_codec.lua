-- ARKHER SYSTEM I.0423 :: Animation LOD Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0423"
	S.key = "arkher.anim.animlod.compression_codec"
	S.name = "Animation LOD Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlod.retarget_graph" }
	S.tags = { "i", "animlod", "codec", "anim" }
	S.description = "Animation LOD Compression Codec: curve compression and quantized transport for the Animation LOD subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.animlod.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
