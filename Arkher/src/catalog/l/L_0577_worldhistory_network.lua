-- ARKHER SYSTEM L.0577 :: World History Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0577"
	S.key = "arkher.sim.worldhistory.route_network"
	S.name = "World History Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldhistory.region_graph" }
	S.tags = { "l", "worldhistory", "network", "sim" }
	S.description = "World History Route Network: roads, rivers and routes between settlements for the World History subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.worldhistory.route_network" })
		inst.system = S
		inst.ctx = ctx
