-- ARKHER SYSTEM K.0357 :: Behaviour State Machine Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0357"
	S.key = "arkher.npc.behaviourstate.utility_reasoning"
	S.name = "Behaviour State Machine Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourstate.reactive_behaviour" }
	S.tags = { "k", "behaviourstate", "utility", "npc" }
	S.description = "Behaviour State Machine Utility Reasoning: scored option selection with response curves for the Behaviour State Machine subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.behaviourstate.utility_reasoning", momentum = 0.08 })
		inst.system = S
		inst.ctx = ctx
