-- ARKHER SYSTEM VC.0564 :: Device Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0564"
	S.key = "arkher.contneural.devicecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.devicecont.reality_continuum" }
	S.tags = { "vc", "devicecont", "emergence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.devicecont.emergence_continuum", windowSize = 6, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
