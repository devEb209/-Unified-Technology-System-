-- ARKHER SYSTEM P.0374 :: Checkpoint Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0374"
	S.key = "arkher.play.checkpoint.inventory"
	S.name = "Checkpoint Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Checkpoint"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.checkpoint.attributes" }
	S.tags = { "p", "checkpoint", "inventory", "play" }
	S.description = "Checkpoint Inventory: slots, stacking, weight, equipment and crafting for the Checkpoint subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.checkpoint.inventory", slots = 24, maxWeight = 110 })
		inst.system = S
		inst.ctx = ctx
