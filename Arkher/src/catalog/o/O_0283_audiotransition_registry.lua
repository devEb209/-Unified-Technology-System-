-- ARKHER SYSTEM O.0283 :: Transition Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0283"
	S.key = "arkher.audio.audiotransition.asset_registry"
	S.name = "Transition Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Transition"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiotransition.streaming" }
	S.tags = { "o", "audiotransition", "registry", "audio" }
	S.description = "Transition Asset Registry: catalogue of sounds, variations and metadata for the Transition subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.audiotransition.asset_registry" })
		inst.system = S
		inst.ctx = ctx
