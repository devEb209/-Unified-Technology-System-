-- ARKHER SYSTEM VA.0629 :: Interest Field Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0629"
	S.key = "arkher.contworld.interestfield.persistent_state"
	S.name = "Interest Field Persistent State"
	S.category = "VA"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.interestfield.multi-scale_fidelity" }
	S.tags = { "va", "interestfield", "persistent", "contworld" }
	S.description = "Interest Field Persistent State: epoch-stamped persistent history and rollback for the Interest Field subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.interestfield.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
