--!strict
-- OpenLandMap — ANIMATION Map #0233
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="OpenLandMap — ANIMATION Map #0233", size=Vector2.new(680, 480), pos=UDim2.fromOffset(329, 141), parent=parent, icon="⬣"})
