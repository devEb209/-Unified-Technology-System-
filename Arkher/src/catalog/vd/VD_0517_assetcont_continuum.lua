-- ARKHER SYSTEM VD.0517 :: Asset Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0517"
	S.key = "arkher.contsim.assetcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "assetcont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.assetcont.infinite_grid", cellSize = 192, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
