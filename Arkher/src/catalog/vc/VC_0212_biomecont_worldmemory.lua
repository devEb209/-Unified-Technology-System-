-- ARKHER SYSTEM VC.0212 :: Biome Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0212"
	S.key = "arkher.contneural.biomecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.biomecont.neural_field" }
	S.tags = { "vc", "biomecont", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.biomecont.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
