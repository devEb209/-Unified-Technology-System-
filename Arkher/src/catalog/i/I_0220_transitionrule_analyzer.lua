-- ARKHER SYSTEM I.0220 :: Transition Rule Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0220"
	S.key = "arkher.anim.transitionrule.analysis"
	S.name = "Transition Rule Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.transitionrule.quality_policy" }
	S.tags = { "i", "transitionrule", "analyzer", "anim" }
	S.description = "Transition Rule Analysis: pop, drift and cost analysis of playback for the Transition Rule subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.transitionrule.analysis", window = 156, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
