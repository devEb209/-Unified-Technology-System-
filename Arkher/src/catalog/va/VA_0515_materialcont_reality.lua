-- ARKHER SYSTEM VA.0515 :: Material Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0515"
	S.key = "arkher.contworld.materialcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.materialcont.simulation_fabric" }
	S.tags = { "va", "materialcont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.materialcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
