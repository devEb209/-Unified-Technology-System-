-- ARKHER SYSTEM VB.0327 :: Economy Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0327"
	S.key = "arkher.conttime.economycont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.economycont.epoch_clock" }
	S.tags = { "vb", "economycont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.economycont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
