-- ARKHER SYSTEM K.0597 :: Relationship Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0597"
	S.key = "arkher.npc.relationship.navigation"
	S.name = "Relationship Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.relationship.goal_planner" }
	S.tags = { "k", "relationship", "navgraph", "npc" }
	S.description = "Relationship Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Relationship subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.relationship.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
