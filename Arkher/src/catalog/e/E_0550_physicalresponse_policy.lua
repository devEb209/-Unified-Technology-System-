-- ARKHER SYSTEM E.0550 :: Physical Response Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0550"
	S.key = "arkher.material.physicalresponse.quality_policy"
	S.name = "Physical Response Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.physicalresponse.compression_codec" }
	S.tags = { "e", "physicalresponse", "policy", "material" }
	S.description = "Physical Response Quality Policy: device tier rules for the surface for the Physical Response subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.physicalresponse.quality_policy", algorithm = "edf", starvationGuard = 37 })
		inst.system = S
		inst.ctx = ctx
