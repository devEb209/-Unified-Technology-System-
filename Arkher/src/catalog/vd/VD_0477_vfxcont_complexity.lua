-- ARKHER SYSTEM VD.0477 :: VFX Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0477"
	S.key = "arkher.contsim.vfxcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vfxcont.world_memory_stream" }
	S.tags = { "vd", "vfxcont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.vfxcont.complexity_budget", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
