-- ARKHER SYSTEM VB.0011 :: World Grid Cell Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0011"
	S.key = "arkher.conttime.worldcell.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldcell.simulation_fabric" }
	S.tags = { "vb", "worldcell", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.worldcell.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
