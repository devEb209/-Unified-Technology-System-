-- ARKHER SYSTEM L.0283 :: Day Night Cycle Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0283"
	S.key = "arkher.sim.daynight.analysis"
	S.name = "Day Night Cycle Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.daynight.aggregate_cache" }
	S.tags = { "l", "daynight", "analyzer", "sim" }
	S.description = "Day Night Cycle Analysis: trend, anomaly and stability analysis of the world for the Day Night Cycle subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.daynight.analysis", window = 127, buckets = 11, threshold = 2.90 })
		inst.system = S
		inst.ctx = ctx
