-- ARKHER SYSTEM I.0341 :: Physical Animation Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0341"
	S.key = "arkher.anim.physanim.layered_blending"
	S.name = "Physical Animation Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.physanim.clip_sampling" }
	S.tags = { "i", "physanim", "animator", "anim" }
	S.description = "Physical Animation Layered Blending: layers, crossfades, masks and blend trees for the Physical Animation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.physanim.layered_blending", budget = 6 })
		inst.system = S
		inst.ctx = ctx
