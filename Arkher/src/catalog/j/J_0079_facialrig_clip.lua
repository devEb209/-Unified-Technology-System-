-- ARKHER SYSTEM J.0079 :: Facial Rig Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0079"
	S.key = "arkher.character.facialrig.motion_set"
	S.name = "Facial Rig Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.facialrig.rig_definition" }
	S.tags = { "j", "facialrig", "clip", "character" }
	S.description = "Facial Rig Motion Set: the clips a character owns and how they sample for the Facial Rig subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.facialrig.motion_set", duration = 0.70, loop = true })
		inst.system = S
		inst.ctx = ctx
