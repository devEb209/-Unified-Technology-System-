-- ARKHER SYSTEM N.0326 :: Ribbon Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0326"
	S.key = "arkher.vfx.ribbonfx.emission"
	S.name = "Ribbon Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Ribbon"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "ribbonfx", "emitter", "vfx" }
	S.description = "Ribbon Emission: shaped, rate and burst emission of new particles for the Ribbon subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.ribbonfx.emission", shape = "point", rate = 31, speed = 4.10, life = 1.90, budget = 320, seed = 18851 })
		inst.system = S
		inst.ctx = ctx
