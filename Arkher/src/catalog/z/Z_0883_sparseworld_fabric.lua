-- ARKHER SYSTEM Z.0883 :: Sparse World Representation Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0883"
	S.key = "arkher.origin.sparseworld.simulation_fabric"
	S.name = "Sparse World Representation Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.complexity_governance" }
	S.tags = { "z", "sparseworld", "fabric", "origin" }
	S.description = "Sparse World Representation Simulation Fabric: every simulation domain stepped under one budgeted clock for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.sparseworld.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
