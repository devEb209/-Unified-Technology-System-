-- ARKHER SYSTEM R.0004 :: Session Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0004"
	S.key = "arkher.net.session.transport_graph"
	S.name = "Session Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Session"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.session.prediction_and_reconciliation" }
	S.tags = { "r", "session", "network", "net" }
	S.description = "Session Transport Graph: topology, capacity and routing between endpoints for the Session subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.session.transport_graph" })
		inst.system = S
		inst.ctx = ctx
