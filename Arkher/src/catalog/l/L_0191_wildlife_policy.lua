-- ARKHER SYSTEM L.0191 :: Wildlife Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0191"
	S.key = "arkher.sim.wildlife.fidelity_policy"
	S.name = "Wildlife Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wildlife.streaming" }
	S.tags = { "l", "wildlife", "policy", "sim" }
	S.description = "Wildlife Fidelity Policy: rules that pick full, cohort or statistical simulation for the Wildlife subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.wildlife.fidelity_policy", algorithm = "wfq", starvationGuard = 42 })
		inst.system = S
		inst.ctx = ctx
