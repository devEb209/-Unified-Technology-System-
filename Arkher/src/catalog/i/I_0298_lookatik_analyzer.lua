-- ARKHER SYSTEM I.0298 :: Look At IK Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0298"
	S.key = "arkher.anim.lookatik.analysis"
	S.name = "Look At IK Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Look At IK"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.lookatik.quality_policy" }
	S.tags = { "i", "lookatik", "analyzer", "anim" }
	S.description = "Look At IK Analysis: pop, drift and cost analysis of playback for the Look At IK subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.lookatik.analysis", window = 179, buckets = 19, threshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
