-- ARKHER SYSTEM VD.0180 :: Neural Patch Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0180"
	S.key = "arkher.contsim.neuralpatch.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.neuralpatch.reality_continuum" }
	S.tags = { "vd", "neuralpatch", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.neuralpatch.emergence_continuum", windowSize = 5, threshold = 1.40, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
