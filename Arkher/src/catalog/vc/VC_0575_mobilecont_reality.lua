-- ARKHER SYSTEM VC.0575 :: Mobile Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0575"
	S.key = "arkher.contneural.mobilecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.mobilecont.simulation_fabric" }
	S.tags = { "vc", "mobilecont", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.mobilecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
