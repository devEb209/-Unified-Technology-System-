-- ARKHER SYSTEM N.0281 :: Heal Effect Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0281"
	S.key = "arkher.vfx.healfx.spawn_budget"
	S.name = "Heal Effect Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Heal Effect"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.healfx.effect_composition" }
	S.tags = { "n", "healfx", "budgeter", "vfx" }
	S.description = "Heal Effect Spawn Budget: global particle budget shared by every live effect for the Heal Effect subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.healfx.spawn_budget", total = 355, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
