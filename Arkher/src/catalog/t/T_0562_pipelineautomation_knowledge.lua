-- ARKHER SYSTEM T.0562 :: Pipeline Automation Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0562"
	S.key = "arkher.ai.pipelineautomation.semantic_knowledge"
	S.name = "Pipeline Automation Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.pipelineautomation.intent_understanding" }
	S.tags = { "t", "pipelineautomation", "knowledge", "ai" }
	S.description = "Pipeline Automation Semantic Knowledge: typed entities, weighted relations and inferred closure for the Pipeline Automation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.pipelineautomation.semantic_knowledge", dims = 24 })
		inst.system = S
		inst.ctx = ctx
