-- ARKHER SYSTEM I.0068 :: Keyframe Track Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0068"
	S.key = "arkher.anim.keytrack.layered_blending"
	S.name = "Keyframe Track Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.keytrack.clip_sampling" }
	S.tags = { "i", "keytrack", "animator", "anim" }
	S.description = "Keyframe Track Layered Blending: layers, crossfades, masks and blend trees for the Keyframe Track subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.keytrack.layered_blending", budget = 6 })
		inst.system = S
		inst.ctx = ctx
