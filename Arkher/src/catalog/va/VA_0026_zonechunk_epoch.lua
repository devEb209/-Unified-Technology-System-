-- ARKHER SYSTEM VA.0026 :: Zone Chunk Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0026"
	S.key = "arkher.contworld.zonechunk.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.zonechunk.infinite_grid" }
	S.tags = { "va", "zonechunk", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.zonechunk.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
