-- ARKHER SYSTEM R.0267 :: Rate Limiting Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0267"
	S.key = "arkher.net.ratelimiting.prediction_and_reconciliation"
	S.name = "Rate Limiting Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.ratelimiting.time_sync" }
	S.tags = { "r", "ratelimiting", "prediction", "net" }
	S.description = "Rate Limiting Prediction And Reconciliation: client simulation, correction and input replay for the Rate Limiting subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.ratelimiting.prediction_and_reconciliation", errorThreshold = 0.030, smoothing = 8.0, maxInputs = 100 })
		inst.system = S
		inst.ctx = ctx
