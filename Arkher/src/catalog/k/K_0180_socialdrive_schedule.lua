-- ARKHER SYSTEM K.0180 :: Social Drive Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0180"
	S.key = "arkher.npc.socialdrive.daily_schedule"
	S.name = "Social Drive Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.socialdrive.social_relations" }
	S.tags = { "k", "socialdrive", "schedule", "npc" }
	S.description = "Social Drive Daily Schedule: hour-by-hour routine with priority interruptions for the Social Drive subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.socialdrive.daily_schedule", startHour = 9 })
		inst.system = S
		inst.ctx = ctx
