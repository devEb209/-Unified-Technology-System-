-- ARKHER SYSTEM K.0048 :: Reward Model Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0048"
	S.key = "arkher.npc.rewardmodel.reactive_behaviour"
	S.name = "Reward Model Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.rewardmodel.perception" }
	S.tags = { "k", "rewardmodel", "behaviortree", "npc" }
	S.description = "Reward Model Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Reward Model subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.rewardmodel.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
