-- ARKHER SYSTEM T.0068 :: World Knowledge Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0068"
	S.key = "arkher.ai.worldknowledge.model_inference"
	S.name = "World Knowledge Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.worldknowledge.action_planner" }
	S.tags = { "t", "worldknowledge", "inference", "ai" }
	S.description = "World Knowledge Model Inference: quantized inference with batching and budget for the World Knowledge subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.worldknowledge.model_inference", seed = 62906 })
		inst.system = S
		inst.ctx = ctx
