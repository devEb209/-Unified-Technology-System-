-- ARKHER SYSTEM VD.0447 :: Animation Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0447"
	S.key = "arkher.contsim.animcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.animcont.epoch_clock" }
	S.tags = { "vd", "animcont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.animcont.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
