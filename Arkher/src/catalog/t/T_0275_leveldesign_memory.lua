-- ARKHER SYSTEM T.0275 :: Level Design Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0275"
	S.key = "arkher.ai.leveldesign.working_memory"
	S.name = "Level Design Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.leveldesign.outcome_prediction" }
	S.tags = { "t", "leveldesign", "memory", "ai" }
	S.description = "Level Design Working Memory: decaying, consolidating recall of what the agent learned for the Level Design subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.leveldesign.working_memory", capacity = 41, decayRate = 0.045, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
