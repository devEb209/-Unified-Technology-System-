-- ARKHER SYSTEM N.0471 :: Distortion Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0471"
	S.key = "arkher.vfx.distortion.force_field"
	S.name = "Distortion Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Distortion"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.distortion.particle_simulation" }
	S.tags = { "n", "distortion", "forcefield", "vfx" }
	S.description = "Distortion Force Field: wind, attraction, vortex, drag and curl turbulence for the Distortion subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.distortion.force_field", seed = 86706 })
		inst.system = S
		inst.ctx = ctx
