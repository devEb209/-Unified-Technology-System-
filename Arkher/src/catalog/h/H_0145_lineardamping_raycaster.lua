-- ARKHER SYSTEM H.0145 :: Linear Damping Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0145"
	S.key = "arkher.physics.lineardamping.query"
	S.name = "Linear Damping Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.lineardamping.constraint_solver" }
	S.tags = { "h", "lineardamping", "raycaster", "physics" }
	S.description = "Linear Damping Query: rays, sweeps and overlaps against the simulation for the Linear Damping subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.lineardamping.query", cellSize = 32 })
		inst.system = S
		inst.ctx = ctx
