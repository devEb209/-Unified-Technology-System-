-- ARKHER SYSTEM Z.0391 :: Thermal Aware Simulation Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0391"
	S.key = "arkher.origin.thermalaware.adaptive_workflow"
	S.name = "Thermal Aware Simulation Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.self_critique" }
	S.tags = { "z", "thermalaware", "workflow", "origin" }
	S.description = "Thermal Aware Simulation Adaptive Workflow: verified, retryable, reversible execution plans for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.thermalaware.adaptive_workflow", maxRetries = 3, budget = 150 })
		inst.system = S
		inst.ctx = ctx
