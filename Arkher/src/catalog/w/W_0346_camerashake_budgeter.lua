-- ARKHER SYSTEM W.0346 :: Camera Shake Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0346"
	S.key = "arkher.cine.camerashake.frame_budget"
	S.name = "Camera Shake Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Camera Shake"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.camerashake.event_ledger" }
	S.tags = { "w", "camerashake", "budgeter", "cine" }
	S.description = "Camera Shake Frame Budget: per-frame cost budget for the cinematic systems for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.camerashake.frame_budget", total = 217, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
