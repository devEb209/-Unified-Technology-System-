-- ARKHER SYSTEM E.0296 :: Wear And Tear Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0296"
	S.key = "arkher.material.wear.instance_cache"
	S.name = "Wear And Tear Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.wear.quality_policy" }
	S.tags = { "e", "wear", "cache", "material" }
	S.description = "Wear And Tear Instance Cache: resolved-parameter cache keyed by context for the Wear And Tear subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.wear.instance_cache", policy = "lfu", capacity = 145, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
