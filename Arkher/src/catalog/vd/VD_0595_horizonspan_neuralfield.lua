-- ARKHER SYSTEM VD.0595 :: Horizon Span Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0595"
	S.key = "arkher.contsim.horizonspan.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.horizonspan.coherence_guard" }
	S.tags = { "vd", "horizonspan", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.horizonspan.neural_field", dims = 12, hidden = 8, seed = 9900 })
		inst.system = S
		inst.ctx = ctx
