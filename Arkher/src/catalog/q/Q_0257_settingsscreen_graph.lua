-- ARKHER SYSTEM Q.0257 :: Settings Screen Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0257"
	S.key = "arkher.ui.settingsscreen.navigation_graph"
	S.name = "Settings Screen Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.settingsscreen.transition" }
	S.tags = { "q", "settingsscreen", "graph", "ui" }
	S.description = "Settings Screen Navigation Graph: screens, routes and shortest path between them for the Settings Screen subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.settingsscreen.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
