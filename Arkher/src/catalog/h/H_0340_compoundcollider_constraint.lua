-- ARKHER SYSTEM H.0340 :: Compound Collider Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0340"
	S.key = "arkher.physics.compoundcollider.constraint_solver"
	S.name = "Compound Collider Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.compoundcollider.contact_generation" }
	S.tags = { "h", "compoundcollider", "constraint", "physics" }
	S.description = "Compound Collider Constraint Solver: sequential impulses, friction, joints and warm starting for the Compound Collider subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.compoundcollider.constraint_solver", iterations = 6, baumgarte = 0.12, warmStart = true })
		inst.system = S
		inst.ctx = ctx
