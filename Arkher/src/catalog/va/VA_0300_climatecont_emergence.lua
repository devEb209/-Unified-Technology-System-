-- ARKHER SYSTEM VA.0300 :: Climate Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0300"
	S.key = "arkher.contworld.climatecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.climatecont.reality_continuum" }
	S.tags = { "va", "climatecont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.climatecont.emergence_continuum", windowSize = 5, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
