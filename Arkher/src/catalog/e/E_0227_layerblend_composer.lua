-- ARKHER SYSTEM E.0227 :: Layer Blending Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0227"
	S.key = "arkher.material.layerblend.layer_composition"
	S.name = "Layer Blending Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.layerblend.definition" }
	S.tags = { "e", "layerblend", "composer", "material" }
	S.description = "Layer Blending Layer Composition: ordered layer composition with blend rules for the Layer Blending subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.layerblend.layer_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
