-- ARKHER SYSTEM K.0030 :: Learning Loop Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0030"
	S.key = "arkher.npc.learningloop.memory"
	S.name = "Learning Loop Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.learningloop.mind_network" }
	S.tags = { "k", "learningloop", "memory", "npc" }
	S.description = "Learning Loop Memory: episodic memory with decay, recall and consolidation for the Learning Loop subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.learningloop.memory", capacity = 96, decayRate = 0.040, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
