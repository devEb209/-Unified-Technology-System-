-- ARKHER SYSTEM L.0091 :: Reification Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0091"
	S.key = "arkher.sim.reification.simulation_core"
	S.name = "Reification Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "reification", "simulation", "sim" }
	S.description = "Reification Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Reification subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.reification.simulation_core", fullRadius = 280, reducedRadius = 1200, budget = 102 })
		inst.system = S
		inst.ctx = ctx
