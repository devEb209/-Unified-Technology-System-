-- ARKHER SYSTEM Z.0923 :: Universal Interop Layer Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0923"
	S.key = "arkher.origin.interop.simulation_fabric"
	S.name = "Universal Interop Layer Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.interop.complexity_governance" }
	S.tags = { "z", "interop", "fabric", "origin" }
	S.description = "Universal Interop Layer Simulation Fabric: every simulation domain stepped under one budgeted clock for the Universal Interop Layer subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.interop.simulation_fabric", budgetMs = 2.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
