-- ARKHER SYSTEM Z.0722 :: Knowledge Distillation Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0722"
	S.key = "arkher.origin.distillation.complexity_governance"
	S.name = "Knowledge Distillation Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.distillation.reality_layering" }
	S.tags = { "z", "distillation", "complexity", "origin" }
	S.description = "Knowledge Distillation Complexity Governance: measured scene cost turned into per-subsystem directives for the Knowledge Distillation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.distillation.complexity_governance", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
