-- ARKHER SYSTEM Z.0738 :: Knowledge Distillation Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0738"
	S.key = "arkher.origin.distillation.budget_governor"
	S.name = "Knowledge Distillation Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.distillation.behaviour_analysis" }
	S.tags = { "z", "distillation", "budgeter", "origin" }
	S.description = "Knowledge Distillation Budget Governor: allocation of a scarce resource across the technology's consumers for the Knowledge Distillation subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.distillation.budget_governor", total = 458, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
