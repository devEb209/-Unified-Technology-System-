-- ARKHER SYSTEM T.0551 :: Scene Reasoning World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0551"
	S.key = "arkher.ai.scenereasoning.world_architect"
	S.name = "Scene Reasoning World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.scenereasoning.self_critique" }
	S.tags = { "t", "scenereasoning", "architect", "ai" }
	S.description = "Scene Reasoning World Architect: composition of a whole world plan with conserved budgets for the Scene Reasoning subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.scenereasoning.world_architect", budget = 800, seed = 52762 })
		inst.system = S
		inst.ctx = ctx
