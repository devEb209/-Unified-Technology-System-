-- ARKHER SYSTEM T.0080 :: Project Knowledge Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0080"
	S.key = "arkher.ai.projectknowledge.utility_selection"
	S.name = "Project Knowledge Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.projectknowledge.working_memory" }
	S.tags = { "t", "projectknowledge", "utility", "ai" }
	S.description = "Project Knowledge Utility Selection: scored choice between competing courses of action for the Project Knowledge subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.projectknowledge.utility_selection", momentum = 0.16 })
		inst.system = S
		inst.ctx = ctx
