-- ARKHER SYSTEM VD.0215 :: Biome Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0215"
	S.key = "arkher.contsim.biomecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.biomecont.simulation_fabric" }
	S.tags = { "vd", "biomecont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.biomecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
