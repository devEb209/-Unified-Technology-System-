-- ARKHER SYSTEM N.0412 :: Wind Gust Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0412"
	S.key = "arkher.vfx.windgust.result_cache"
	S.name = "Wind Gust Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Wind Gust"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.windgust.spawn_budget" }
	S.tags = { "n", "windgust", "cache", "vfx" }
	S.description = "Wind Gust Result Cache: reuse of expensive effect evaluations for the Wind Gust subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.windgust.result_cache", policy = "ttl", capacity = 68, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
