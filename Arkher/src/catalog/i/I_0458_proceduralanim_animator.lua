-- ARKHER SYSTEM I.0458 :: Procedural Animation Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0458"
	S.key = "arkher.anim.proceduralanim.layered_blending"
	S.name = "Procedural Animation Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.proceduralanim.clip_sampling" }
	S.tags = { "i", "proceduralanim", "animator", "anim" }
	S.description = "Procedural Animation Layered Blending: layers, crossfades, masks and blend trees for the Procedural Animation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.proceduralanim.layered_blending", budget = 4 })
		inst.system = S
		inst.ctx = ctx
