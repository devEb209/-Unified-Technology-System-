-- ARKHER SYSTEM G.0127 :: Detail Synthesis Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0127"
	S.key = "arkher.neural.detailsynth.inference_core"
	S.name = "Detail Synthesis Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "detailsynth", "inference", "neural" }
	S.description = "Detail Synthesis Inference Core: dense network forward pass and training for the Detail Synthesis subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.detailsynth.inference_core", seed = 61837 })
		inst.system = S
		inst.ctx = ctx
