-- ARKHER SYSTEM R.0163 :: Snapshot Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0163"
	S.key = "arkher.net.snapshot.interest_streaming"
	S.name = "Snapshot Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Snapshot"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.snapshot.serialization_codec" }
	S.tags = { "r", "snapshot", "streamer", "net" }
	S.description = "Snapshot Interest Streaming: distance-driven residency of replicated content for the Snapshot subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.snapshot.interest_streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
