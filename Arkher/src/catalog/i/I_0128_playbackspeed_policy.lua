-- ARKHER SYSTEM I.0128 :: Playback Speed Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0128"
	S.key = "arkher.anim.playbackspeed.quality_policy"
	S.name = "Playback Speed Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.playbackspeed.pose_cache" }
	S.tags = { "i", "playbackspeed", "policy", "anim" }
	S.description = "Playback Speed Quality Policy: device tier rules for rate, bones and solvers for the Playback Speed subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.playbackspeed.quality_policy", algorithm = "roundrobin", starvationGuard = 20 })
		inst.system = S
		inst.ctx = ctx
