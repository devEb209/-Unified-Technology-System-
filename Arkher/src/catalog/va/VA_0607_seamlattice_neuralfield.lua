-- ARKHER SYSTEM VA.0607 :: Seam Lattice Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0607"
	S.key = "arkher.contworld.seamlattice.neural_field"
	S.name = "Seam Lattice Neural Field"
	S.category = "VA"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.seamlattice.coherence_guard" }
	S.tags = { "va", "seamlattice", "neuralfield", "contworld" }
	S.description = "Seam Lattice Neural Field: neural field encoding and reconstruction for the Seam Lattice subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.seamlattice.neural_field", dims = 16, hidden = 12, seed = 80581 })
		inst.system = S
		inst.ctx = ctx
