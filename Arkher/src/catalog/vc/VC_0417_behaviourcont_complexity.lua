-- ARKHER SYSTEM VC.0417 :: Behaviour Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0417"
	S.key = "arkher.contneural.behaviourcont.complexity_budget"
	S.name = "Behaviour Continuum Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.behaviourcont.world_memory_stream" }
	S.tags = { "vc", "behaviourcont", "complexity", "contneural" }
	S.description = "Behaviour Continuum Complexity Budget: complexity budgeting for the continuum for the Behaviour Continuum subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.behaviourcont.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
