-- ARKHER SYSTEM VC.0378 :: Dialogue Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0378"
	S.key = "arkher.contneural.dialoguecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.dialoguecont.persistent_state" }
	S.tags = { "vc", "dialoguecont", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.dialoguecont.coherence_guard", window = 123, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
