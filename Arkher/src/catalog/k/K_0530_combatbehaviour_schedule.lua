-- ARKHER SYSTEM K.0530 :: Combat Behaviour Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0530"
	S.key = "arkher.npc.combatbehaviour.daily_schedule"
	S.name = "Combat Behaviour Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.combatbehaviour.social_relations" }
	S.tags = { "k", "combatbehaviour", "schedule", "npc" }
	S.description = "Combat Behaviour Daily Schedule: hour-by-hour routine with priority interruptions for the Combat Behaviour subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.combatbehaviour.daily_schedule", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
