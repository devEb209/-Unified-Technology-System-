-- ARKHER SYSTEM VC.0297 :: Climate Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0297"
	S.key = "arkher.contneural.climatecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.climatecont.world_memory_stream" }
	S.tags = { "vc", "climatecont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.climatecont.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
