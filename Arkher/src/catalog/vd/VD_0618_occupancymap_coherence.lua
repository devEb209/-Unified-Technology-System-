-- ARKHER SYSTEM VD.0618 :: Occupancy Map Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0618"
	S.key = "arkher.contsim.occupancymap.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.occupancymap.persistent_state" }
	S.tags = { "vd", "occupancymap", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.occupancymap.coherence_guard", window = 65, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
