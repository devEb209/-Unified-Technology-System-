...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Mixamo — CORE Profiler #0144", size=Vector2.new(600, 500), pos=UDim2.fromOffset(372, 188), parent=parent, icon="▣"})
...
Components.TextField(right, "File", "input.png", function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_File"..144, v) end end)
