-- ARKHER SYSTEM L.0088 :: Cohort Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0088"
	S.key = "arkher.sim.cohort.analysis"
	S.name = "Cohort Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.cohort.aggregate_cache" }
	S.tags = { "l", "cohort", "analyzer", "sim" }
	S.description = "Cohort Analysis: trend, anomaly and stability analysis of the world for the Cohort subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.cohort.analysis", window = 167, buckets = 11, threshold = 2.90 })
		inst.system = S
		inst.ctx = ctx
