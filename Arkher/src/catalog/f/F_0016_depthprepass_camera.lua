-- ARKHER SYSTEM F.0016 :: Depth Prepass View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0016"
	S.key = "arkher.render.depthprepass.view_and_culling"
	S.name = "Depth Prepass View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.depthprepass.frame_graph" }
	S.tags = { "f", "depthprepass", "camera", "render" }
	S.description = "Depth Prepass View And Culling: view state, frustum culling and screen-size LOD for the Depth Prepass subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.depthprepass.view_and_culling", width = 1340, height = 900, fov = 0.9900, far = 1400 })
		inst.system = S
		inst.ctx = ctx
