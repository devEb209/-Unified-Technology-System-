-- ARKHER SYSTEM F.0551 :: Particle Rendering Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0551"
	S.key = "arkher.render.particlerender.lighting_rig"
	S.name = "Particle Rendering Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.particlerender.geometry_virtualization" }
	S.tags = { "f", "particlerender", "lightrig", "render" }
	S.description = "Particle Rendering Lighting Rig: light clustering, importance and cascades for the Particle Rendering subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.particlerender.lighting_rig", maxActive = 12 })
		inst.system = S
		inst.ctx = ctx
