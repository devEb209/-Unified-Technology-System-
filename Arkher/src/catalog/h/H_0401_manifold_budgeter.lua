-- ARKHER SYSTEM H.0401 :: Contact Manifold Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0401"
	S.key = "arkher.physics.manifold.budget_governor"
	S.name = "Contact Manifold Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.manifold.broadphase_index" }
	S.tags = { "h", "manifold", "budgeter", "physics" }
	S.description = "Contact Manifold Budget Governor: simulation time budget allocation across islands for the Contact Manifold subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.manifold.budget_governor", total = 440, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
