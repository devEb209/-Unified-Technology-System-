-- ARKHER SYSTEM H.0175 :: Sleeping Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0175"
	S.key = "arkher.physics.sleeping.vehicle"
	S.name = "Sleeping Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Sleeping"
	S.aspect = "Vehicle"
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sleeping.character_motion" }
	S.tags = { "h", "sleeping", "vehicle", "physics" }
	S.description = "Sleeping Vehicle: suspension, drivetrain, steering and tire friction for the Sleeping subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.sleeping.vehicle", mass = 1900, wheelbase = 3.20, track = 1.60, maxRpm = 6600 })
		inst.system = S
		inst.ctx = ctx
