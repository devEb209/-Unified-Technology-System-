-- ARKHER SYSTEM K.0120 :: Forgetting Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0120"
	S.key = "arkher.npc.forgetting.goal_planner"
	S.name = "Forgetting Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.forgetting.utility_reasoning" }
	S.tags = { "k", "forgetting", "planner", "npc" }
	S.description = "Forgetting Goal Planner: backward GOAP planning to reach a goal state for the Forgetting subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.forgetting.goal_planner", maxDepth = 9 })
		inst.system = S
		inst.ctx = ctx
