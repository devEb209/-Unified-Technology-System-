-- ARKHER SYSTEM O.0273 :: Stinger Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0273"
	S.key = "arkher.audio.stinger.playback_policy"
	S.name = "Stinger Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Stinger"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.stinger.compression_codec" }
	S.tags = { "o", "stinger", "policy", "audio" }
	S.description = "Stinger Playback Policy: rules choosing what may be heard right now for the Stinger subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.stinger.playback_policy", algorithm = "roundrobin", starvationGuard = 60 })
		inst.system = S
		inst.ctx = ctx
