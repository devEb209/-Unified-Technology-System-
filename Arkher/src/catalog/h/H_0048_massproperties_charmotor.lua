-- ARKHER SYSTEM H.0048 :: Mass Properties Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0048"
	S.key = "arkher.physics.massproperties.character_motion"
	S.name = "Mass Properties Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.massproperties.query" }
	S.tags = { "h", "massproperties", "charmotor", "physics" }
	S.description = "Mass Properties Character Motion: capsule move-and-slide with slopes, steps and jumps for the Mass Properties subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.massproperties.character_motion", radius = 0.37, height = 1.82, maxSpeed = 6.20, jumpHeight = 2.20, stepOffset = 0.47 })
		inst.system = S
		inst.ctx = ctx
