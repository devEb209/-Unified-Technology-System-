-- ARKHER SYSTEM Z.0184 :: World Memory Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0184"
	S.key = "arkher.origin.worldmemorytech.autonomous_pipeline"
	S.name = "World Memory Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldmemorytech.simulation_fabric" }
	S.tags = { "z", "worldmemorytech", "autopipeline", "origin" }
	S.description = "World Memory Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the World Memory subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.worldmemorytech.autonomous_pipeline", maxIterations = 5 })
		inst.system = S
		inst.ctx = ctx
