-- ARKHER SYSTEM Z.0588 :: Self Healing Systems Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0588"
	S.key = "arkher.origin.selfhealing.semantic_graph"
	S.name = "Self Healing Systems Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfhealing.world_architect" }
	S.tags = { "z", "selfhealing", "knowledge", "origin" }
	S.description = "Self Healing Systems Semantic Graph: typed entities and inferred relations of the technology itself for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.selfhealing.semantic_graph", dims = 24 })
		inst.system = S
		inst.ctx = ctx
