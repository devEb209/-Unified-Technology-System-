-- ARKHER SYSTEM T.0390 :: Refactoring Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0390"
	S.key = "arkher.ai.refactoring.model_inference"
	S.name = "Refactoring Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.refactoring.action_planner" }
	S.tags = { "t", "refactoring", "inference", "ai" }
	S.description = "Refactoring Model Inference: quantized inference with batching and budget for the Refactoring subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.refactoring.model_inference", seed = 68511 })
		inst.system = S
		inst.ctx = ctx
