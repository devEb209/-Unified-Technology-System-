-- ARKHER SYSTEM O.0222 :: Music Bed Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0222"
	S.key = "arkher.audio.musicbed.streaming"
	S.name = "Music Bed Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Music Bed"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.musicbed.voice_budget" }
	S.tags = { "o", "musicbed", "streamer", "audio" }
	S.description = "Music Bed Streaming: distance-driven residency of audio assets for the Music Bed subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.musicbed.streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
