...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Cinema4D — CORE Profiler #0264", size=Vector2.new(600, 500), pos=UDim2.fromOffset(332, 148), parent=parent, icon="⬢"})
...
Components.TextField(right, "File", "input.png", function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_File"..264, v) end end)
