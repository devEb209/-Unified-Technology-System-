-- ARKHER SYSTEM I.0142 :: Animation Layer Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0142"
	S.key = "arkher.anim.animlayer.analysis"
	S.name = "Animation Layer Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlayer.quality_policy" }
	S.tags = { "i", "animlayer", "analyzer", "anim" }
	S.description = "Animation Layer Analysis: pop, drift and cost analysis of playback for the Animation Layer subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.animlayer.analysis", window = 200, buckets = 8, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
