-- ARKHER SYSTEM L.0464 :: Justice Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0464"
	S.key = "arkher.sim.justice.forecast"
	S.name = "Justice Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.justice.analysis" }
	S.tags = { "l", "justice", "predictor", "sim" }
	S.description = "Justice Forecast: prediction of the region's next state for the Justice subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.justice.forecast", method = "ema", alpha = 0.33, window = 71 })
		inst.system = S
		inst.ctx = ctx
