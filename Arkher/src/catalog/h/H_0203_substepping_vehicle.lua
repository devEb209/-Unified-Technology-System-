-- ARKHER SYSTEM H.0203 :: Substepping Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0203"
	S.key = "arkher.physics.substepping.vehicle"
	S.name = "Substepping Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Substepping"
	S.aspect = "Vehicle"
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.substepping.character_motion" }
	S.tags = { "h", "substepping", "vehicle", "physics" }
	S.description = "Substepping Vehicle: suspension, drivetrain, steering and tire friction for the Substepping subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.substepping.vehicle", mass = 1200, wheelbase = 3.30, track = 1.70, maxRpm = 6700 })
		inst.system = S
		inst.ctx = ctx
