-- ARKHER SYSTEM R.0135 :: Unreliable Channel Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0135"
	S.key = "arkher.net.unreliablechannel.prediction_and_reconciliation"
	S.name = "Unreliable Channel Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.unreliablechannel.time_sync" }
	S.tags = { "r", "unreliablechannel", "prediction", "net" }
	S.description = "Unreliable Channel Prediction And Reconciliation: client simulation, correction and input replay for the Unreliable Channel subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.unreliablechannel.prediction_and_reconciliation", errorThreshold = 0.030, smoothing = 8.0, maxInputs = 60 })
		inst.system = S
		inst.ctx = ctx
