-- ARKHER SYSTEM I.0504 :: Cloth Animation Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0504"
	S.key = "arkher.anim.clothanim.pose_cache"
	S.name = "Cloth Animation Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clothanim.playback_pipeline" }
	S.tags = { "i", "clothanim", "cache", "anim" }
	S.description = "Cloth Animation Pose Cache: reuse of sampled poses across frames and instances for the Cloth Animation subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.clothanim.pose_cache", policy = "ttl", capacity = 166, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
