-- ARKHER SYSTEM K.0274 :: Hearing Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0274"
	S.key = "arkher.npc.hearing.goal_planner"
	S.name = "Hearing Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hearing.utility_reasoning" }
	S.tags = { "k", "hearing", "planner", "npc" }
	S.description = "Hearing Goal Planner: backward GOAP planning to reach a goal state for the Hearing subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.hearing.goal_planner", maxDepth = 11 })
		inst.system = S
		inst.ctx = ctx
