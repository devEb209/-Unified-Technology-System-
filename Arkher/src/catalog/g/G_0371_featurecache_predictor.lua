-- ARKHER SYSTEM G.0371 :: Feature Cache Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0371"
	S.key = "arkher.neural.featurecache.quality_predictor"
	S.name = "Feature Cache Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.featurecache.weight_codec" }
	S.tags = { "g", "featurecache", "predictor", "neural" }
	S.description = "Feature Cache Quality Predictor: predicted quality and cost of a setting for the Feature Cache subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.featurecache.quality_predictor", method = "linear", alpha = 0.43, window = 81 })
		inst.system = S
		inst.ctx = ctx
