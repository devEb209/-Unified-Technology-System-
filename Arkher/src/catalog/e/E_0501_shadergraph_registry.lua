-- ARKHER SYSTEM E.0501 :: Shader Graph Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0501"
	S.key = "arkher.material.shadergraph.variant_registry"
	S.name = "Shader Graph Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Shader Graph"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.shadergraph.procedural_detail" }
	S.tags = { "e", "shadergraph", "registry", "material" }
	S.description = "Shader Graph Variant Registry: named variants and their lifecycle for the Shader Graph subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.shadergraph.variant_registry" })
		inst.system = S
		inst.ctx = ctx
