-- ARKHER SYSTEM V.0148 :: UI Sprite Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0148"
	S.key = "arkher.asset.uisprite.asset_registry"
	S.name = "UI Sprite Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.uisprite.cook_pipeline" }
	S.tags = { "v", "uisprite", "registry", "asset" }
	S.description = "UI Sprite Asset Registry: catalogue of every asset, its tags and its metadata for the UI Sprite subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.uisprite.asset_registry" })
		inst.system = S
		inst.ctx = ctx
