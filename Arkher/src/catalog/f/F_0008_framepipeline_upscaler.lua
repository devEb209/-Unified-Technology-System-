-- ARKHER SYSTEM F.0008 :: Frame Pipeline Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0008"
	S.key = "arkher.render.framepipeline.adaptive_resolution"
	S.name = "Frame Pipeline Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepipeline.temporal_resolve" }
	S.tags = { "f", "framepipeline", "upscaler", "render" }
	S.description = "Frame Pipeline Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Frame Pipeline subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.framepipeline.adaptive_resolution", targetMs = 15.10, index = 4, sharpness = 0.54 })
		inst.system = S
		inst.ctx = ctx
