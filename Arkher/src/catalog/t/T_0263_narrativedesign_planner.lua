-- ARKHER SYSTEM T.0263 :: Narrative Design Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0263"
	S.key = "arkher.ai.narrativedesign.action_planner"
	S.name = "Narrative Design Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.narrativedesign.utility_selection" }
	S.tags = { "t", "narrativedesign", "planner", "ai" }
	S.description = "Narrative Design Action Planner: goal-oriented action planning over preconditions for the Narrative Design subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.narrativedesign.action_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
