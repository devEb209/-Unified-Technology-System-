-- ARKHER SYSTEM P.0064 :: Progression Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0064"
	S.key = "arkher.play.progression.combat_resolution"
	S.name = "Progression Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Progression"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.progression.objectives" }
	S.tags = { "p", "progression", "combat", "play" }
	S.description = "Progression Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Progression subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.progression.combat_resolution", seed = 51471, armourK = 150, critMultiplier = 1.80 })
		inst.system = S
		inst.ctx = ctx
