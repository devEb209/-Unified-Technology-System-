-- ARKHER SYSTEM K.0107 :: Memory Consolidation Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0107"
	S.key = "arkher.npc.consolidation.navigation"
	S.name = "Memory Consolidation Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.consolidation.goal_planner" }
	S.tags = { "k", "consolidation", "navgraph", "npc" }
	S.description = "Memory Consolidation Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Memory Consolidation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.consolidation.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
