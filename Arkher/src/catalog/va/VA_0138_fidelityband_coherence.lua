-- ARKHER SYSTEM VA.0138 :: Fidelity Band Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0138"
	S.key = "arkher.contworld.fidelityband.coherence_guard"
	S.name = "Fidelity Band Coherence Guard"
	S.category = "VA"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.fidelityband.persistent_state" }
	S.tags = { "va", "fidelityband", "coherence", "contworld" }
	S.description = "Fidelity Band Coherence Guard: seam coherence and drift supervision for the Fidelity Band subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.fidelityband.coherence_guard", window = 99, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
