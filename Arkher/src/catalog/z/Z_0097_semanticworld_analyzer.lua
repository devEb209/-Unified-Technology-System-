-- ARKHER SYSTEM Z.0097 :: Semantic World Graph Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0097"
	S.key = "arkher.origin.semanticworld.behaviour_analysis"
	S.name = "Semantic World Graph Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticworld.governance_policy" }
	S.tags = { "z", "semanticworld", "analyzer", "origin" }
	S.description = "Semantic World Graph Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.semanticworld.behaviour_analysis", window = 96, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
