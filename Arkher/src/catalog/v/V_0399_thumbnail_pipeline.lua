-- ARKHER SYSTEM V.0399 :: Thumbnail Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0399"
	S.key = "arkher.asset.thumbnail.cook_pipeline"
	S.name = "Thumbnail Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.thumbnail.bundling" }
	S.tags = { "v", "thumbnail", "pipeline", "asset" }
	S.description = "Thumbnail Cook Pipeline: staged cooking with isolation and retries for the Thumbnail subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.thumbnail.cook_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
