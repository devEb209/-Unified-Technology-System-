-- ARKHER SYSTEM K.0363 :: Behaviour State Machine Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0363"
	S.key = "arkher.npc.behaviourstate.thinking_budget"
	S.name = "Behaviour State Machine Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourstate.daily_schedule" }
	S.tags = { "k", "behaviourstate", "budgeter", "npc" }
	S.description = "Behaviour State Machine Thinking Budget: allocation of per-frame thinking time across NPCs for the Behaviour State Machine subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.behaviourstate.thinking_budget", total = 360, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
