-- ARKHER SYSTEM E.0353 :: Snow Cover Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0353"
	S.key = "arkher.material.snowcover.streaming"
	S.name = "Snow Cover Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Snow Cover"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.snowcover.parameter_budget" }
	S.tags = { "e", "snowcover", "streamer", "material" }
	S.description = "Snow Cover Streaming: residency and demand-driven texture streaming for the Snow Cover subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.snowcover.streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
