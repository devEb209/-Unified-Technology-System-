-- ARKHER SYSTEM H.0318 :: Mesh Collider Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0318"
	S.key = "arkher.physics.meshcollider.simulation_policy"
	S.name = "Mesh Collider Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.meshcollider.budget_governor" }
	S.tags = { "h", "meshcollider", "policy", "physics" }
	S.description = "Mesh Collider Simulation Policy: device tier rules for substeps, iterations and sleep for the Mesh Collider subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.meshcollider.simulation_policy", algorithm = "roundrobin", starvationGuard = 40 })
		inst.system = S
		inst.ctx = ctx
