-- ARKHER SYSTEM I.0219 :: Transition Rule Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0219"
	S.key = "arkher.anim.transitionrule.quality_policy"
	S.name = "Transition Rule Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.transitionrule.pose_cache" }
	S.tags = { "i", "transitionrule", "policy", "anim" }
	S.description = "Transition Rule Quality Policy: device tier rules for rate, bones and solvers for the Transition Rule subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.transitionrule.quality_policy", algorithm = "wfq", starvationGuard = 46 })
		inst.system = S
		inst.ctx = ctx
