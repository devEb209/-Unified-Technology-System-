-- ARKHER SYSTEM L.0378 :: Caravan Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0378"
	S.key = "arkher.sim.caravan.economy"
	S.name = "Caravan Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.caravan.ecology" }
	S.tags = { "l", "caravan", "economy", "sim" }
	S.description = "Caravan Economy: stock, production, demand, price discovery and trade for the Caravan subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.caravan.economy", elasticity = 0.26 })
		inst.system = S
		inst.ctx = ctx
