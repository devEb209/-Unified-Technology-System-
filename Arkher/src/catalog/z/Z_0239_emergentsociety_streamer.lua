-- ARKHER SYSTEM Z.0239 :: Emergent Society Framework Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0239"
	S.key = "arkher.origin.emergentsociety.residency_streaming"
	S.name = "Emergent Society Framework Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentsociety.budget_governor" }
	S.tags = { "z", "emergentsociety", "streamer", "origin" }
	S.description = "Emergent Society Framework Residency Streaming: distance-driven residency of the technology's workload for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.emergentsociety.residency_streaming", radius = 280, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
