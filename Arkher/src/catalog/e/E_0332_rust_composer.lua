-- ARKHER SYSTEM E.0332 :: Rust Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0332"
	S.key = "arkher.material.rust.layer_composition"
	S.name = "Rust Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Rust"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.rust.definition" }
	S.tags = { "e", "rust", "composer", "material" }
	S.description = "Rust Layer Composition: ordered layer composition with blend rules for the Rust subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.rust.layer_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
