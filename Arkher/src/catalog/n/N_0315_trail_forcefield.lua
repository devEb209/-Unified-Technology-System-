-- ARKHER SYSTEM N.0315 :: Trail Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0315"
	S.key = "arkher.vfx.trail.force_field"
	S.name = "Trail Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Trail"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.trail.particle_simulation" }
	S.tags = { "n", "trail", "forcefield", "vfx" }
	S.description = "Trail Force Field: wind, attraction, vortex, drag and curl turbulence for the Trail subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.trail.force_field", seed = 8063 })
		inst.system = S
		inst.ctx = ctx
