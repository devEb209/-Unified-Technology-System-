-- ARKHER SYSTEM VC.0633 :: Interest Field Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0633"
	S.key = "arkher.contneural.interestfield.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.interestfield.world_memory_stream" }
	S.tags = { "vc", "interestfield", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.interestfield.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
