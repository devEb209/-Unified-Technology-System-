--!strict
-- Frostbite Frosty — ANIMATION Profiler #0189
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Frostbite Frosty — ANIMATION Profiler #0189", size=Vector2.new(600, 500), pos=UDim2.fromOffset(157, 173), parent=parent, icon="▭"})
...
Components.TextField(right, "File", "input.png", function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_File"..189, v) end end)
