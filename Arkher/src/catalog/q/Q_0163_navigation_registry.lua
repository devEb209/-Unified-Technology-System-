-- ARKHER SYSTEM Q.0163 :: Navigation Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0163"
	S.key = "arkher.ui.navigation.localization_registry"
	S.name = "Navigation Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Navigation"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.navigation.theme_composition" }
	S.tags = { "q", "navigation", "registry", "ui" }
	S.description = "Navigation Localization Registry: catalogue of strings, plurals and locale metadata for the Navigation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.navigation.localization_registry" })
		inst.system = S
		inst.ctx = ctx
