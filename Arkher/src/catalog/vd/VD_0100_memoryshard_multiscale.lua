-- ARKHER SYSTEM VD.0100 :: Memory Shard Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0100"
	S.key = "arkher.contsim.memoryshard.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memoryshard.sparse_residency" }
	S.tags = { "vd", "memoryshard", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.memoryshard.multi-scale_fidelity", levels = 5, baseTriangles = 135000 })
		inst.system = S
		inst.ctx = ctx
