-- ARKHER SYSTEM W.0293 :: Motion Blur Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0293"
	S.key = "arkher.cine.cinemotionblur.cut_policy"
	S.name = "Motion Blur Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Motion Blur"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinemotionblur.shot_composition" }
	S.tags = { "w", "cinemotionblur", "policy", "cine" }
	S.description = "Motion Blur Cut Policy: rules deciding when the sequence cuts and to what for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.cinemotionblur.cut_policy", algorithm = "edf", starvationGuard = 45 })
		inst.system = S
		inst.ctx = ctx
