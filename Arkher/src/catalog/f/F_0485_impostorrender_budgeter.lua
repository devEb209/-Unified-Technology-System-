-- ARKHER SYSTEM F.0485 :: Impostor Rendering Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0485"
	S.key = "arkher.render.impostorrender.draw_budget"
	S.name = "Impostor Rendering Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.impostorrender.adaptive_resolution" }
	S.tags = { "f", "impostorrender", "budgeter", "render" }
	S.description = "Impostor Rendering Draw Budget: draw call and triangle budget allocation for the Impostor Rendering subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.impostorrender.draw_budget", total = 245, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
