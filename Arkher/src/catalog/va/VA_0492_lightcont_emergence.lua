-- ARKHER SYSTEM VA.0492 :: Lighting Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0492"
	S.key = "arkher.contworld.lightcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lightcont.reality_continuum" }
	S.tags = { "va", "lightcont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.lightcont.emergence_continuum", windowSize = 6, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
