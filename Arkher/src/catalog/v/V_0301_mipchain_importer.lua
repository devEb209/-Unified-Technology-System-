-- ARKHER SYSTEM V.0301 :: Mip Chain Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0301"
	S.key = "arkher.asset.mipchain.import"
	S.name = "Mip Chain Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "mipchain", "importer", "asset" }
	S.description = "Mip Chain Import: validation, normalization, hashing and deduplication of incoming content for the Mip Chain subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.mipchain.import", unitScale = 1.25 })
		inst.system = S
		inst.ctx = ctx
