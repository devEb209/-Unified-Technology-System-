-- ARKHER SYSTEM Z.0635 :: Intent Driven Authoring Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0635"
	S.key = "arkher.origin.intentauthoring.signal_composition"
	S.name = "Intent Driven Authoring Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.telemetry_ledger" }
	S.tags = { "z", "intentauthoring", "composer", "origin" }
	S.description = "Intent Driven Authoring Signal Composition: blending of the technology's input signals into one output for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.intentauthoring.signal_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
