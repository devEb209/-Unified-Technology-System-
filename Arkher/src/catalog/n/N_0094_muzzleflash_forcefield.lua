-- ARKHER SYSTEM N.0094 :: Muzzle Flash Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0094"
	S.key = "arkher.vfx.muzzleflash.force_field"
	S.name = "Muzzle Flash Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Muzzle Flash"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.muzzleflash.particle_simulation" }
	S.tags = { "n", "muzzleflash", "forcefield", "vfx" }
	S.description = "Muzzle Flash Force Field: wind, attraction, vortex, drag and curl turbulence for the Muzzle Flash subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.muzzleflash.force_field", seed = 66293 })
		inst.system = S
		inst.ctx = ctx
