-- ARKHER SYSTEM H.0622 :: Character Controller Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0622"
	S.key = "arkher.physics.charactercontroller.character_motion"
	S.name = "Character Controller Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.charactercontroller.query" }
	S.tags = { "h", "charactercontroller", "charmotor", "physics" }
	S.description = "Character Controller Character Motion: capsule move-and-slide with slopes, steps and jumps for the Character Controller subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.charactercontroller.character_motion", radius = 0.44, height = 1.89, maxSpeed = 8.90, jumpHeight = 1.30, stepOffset = 0.44 })
		inst.system = S
		inst.ctx = ctx
