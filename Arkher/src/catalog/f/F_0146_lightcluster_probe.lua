-- ARKHER SYSTEM F.0146 :: Light Clustering Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0146"
	S.key = "arkher.render.lightcluster.probe_volume"
	S.name = "Light Clustering Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.lightcluster.lighting_rig" }
	S.tags = { "f", "lightcluster", "probe", "render" }
	S.description = "Light Clustering Probe Volume: irradiance probes encoded in spherical harmonics for the Light Clustering subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.lightcluster.probe_volume", spacing = 32 })
		inst.system = S
		inst.ctx = ctx
