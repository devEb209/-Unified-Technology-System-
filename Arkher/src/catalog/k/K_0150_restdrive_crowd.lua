-- ARKHER SYSTEM K.0150 :: Rest Drive Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0150"
	S.key = "arkher.npc.restdrive.crowd_steering"
	S.name = "Rest Drive Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.restdrive.navigation" }
	S.tags = { "k", "restdrive", "crowd", "npc" }
	S.description = "Rest Drive Crowd Steering: local avoidance, cohesion and arrival at scale for the Rest Drive subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.restdrive.crowd_steering", radius = 0.65, maxSpeed = 3.50, cellSize = 11 })
		inst.system = S
		inst.ctx = ctx
