-- ARKHER SYSTEM I.0397 :: Animation Compression Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0397"
	S.key = "arkher.anim.animcompression.compression_codec"
	S.name = "Animation Compression Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animcompression.retarget_graph" }
	S.tags = { "i", "animcompression", "codec", "anim" }
	S.description = "Animation Compression Compression Codec: curve compression and quantized transport for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.animcompression.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
