-- ARKHER SYSTEM J.0235 :: Body Type Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0235"
	S.key = "arkher.character.bodytype.look_and_reach"
	S.name = "Body Type Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.bodytype.blend_controller" }
	S.tags = { "j", "bodytype", "ik", "character" }
	S.description = "Body Type Look And Reach: look-at, reach and foot placement for the character for the Body Type subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.bodytype.look_and_reach", iterations = 9, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
