-- ARKHER SYSTEM VC.0344 :: Society Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0344"
	S.key = "arkher.contneural.societycont.world_memory_stream"
	S.name = "Society Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.societycont.neural_field" }
	S.tags = { "vc", "societycont", "worldmemory", "contneural" }
	S.description = "Society Continuum World Memory Stream: world memory continuum over epochs for the Society Continuum subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.societycont.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
