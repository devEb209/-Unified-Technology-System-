-- ARKHER SYSTEM VD.0548 :: World Fabric World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0548"
	S.key = "arkher.contsim.worldfabric.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldfabric.neural_field" }
	S.tags = { "vd", "worldfabric", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.worldfabric.world_memory_stream", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
