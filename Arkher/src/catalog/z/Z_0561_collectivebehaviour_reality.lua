-- ARKHER SYSTEM Z.0561 :: Collective Behaviour Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0561"
	S.key = "arkher.origin.collectivebehaviour.reality_layering"
	S.name = "Collective Behaviour Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "collectivebehaviour", "reality", "origin" }
	S.description = "Collective Behaviour Reality Layering: stacked authored, simulated, proposed and player realities for the Collective Behaviour subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.collectivebehaviour.reality_layering" })
		inst.system = S
		inst.ctx = ctx
