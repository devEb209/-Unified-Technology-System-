-- ARKHER SYSTEM F.0226 :: Water Rendering View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0226"
	S.key = "arkher.render.water.view_and_culling"
	S.name = "Water Rendering View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.water.frame_graph" }
	S.tags = { "f", "water", "camera", "render" }
	S.description = "Water Rendering View And Culling: view state, frustum culling and screen-size LOD for the Water Rendering subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.water.view_and_culling", width = 1212, height = 720, fov = 0.9800, far = 1200 })
		inst.system = S
		inst.ctx = ctx
