-- ARKHER SYSTEM Z.0464 :: Narrative Memory Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0464"
	S.key = "arkher.origin.narrativememory.autonomous_pipeline"
	S.name = "Narrative Memory Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.simulation_fabric" }
	S.tags = { "z", "narrativememory", "autopipeline", "origin" }
	S.description = "Narrative Memory Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.narrativememory.autonomous_pipeline", maxIterations = 7 })
		inst.system = S
		inst.ctx = ctx
