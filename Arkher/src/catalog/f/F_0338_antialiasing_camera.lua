-- ARKHER SYSTEM F.0338 :: Antialiasing View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0338"
	S.key = "arkher.render.antialiasing.view_and_culling"
	S.name = "Antialiasing View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Antialiasing"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.antialiasing.frame_graph" }
	S.tags = { "f", "antialiasing", "camera", "render" }
	S.description = "Antialiasing View And Culling: view state, frustum culling and screen-size LOD for the Antialiasing subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.antialiasing.view_and_culling", width = 828, height = 900, fov = 1.1500, far = 2200 })
		inst.system = S
		inst.ctx = ctx
