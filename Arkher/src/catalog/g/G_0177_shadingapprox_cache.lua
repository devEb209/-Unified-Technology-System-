-- ARKHER SYSTEM G.0177 :: Shading Approximation Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0177"
	S.key = "arkher.neural.shadingapprox.result_cache"
	S.name = "Shading Approximation Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.shadingapprox.compute_budget" }
	S.tags = { "g", "shadingapprox", "cache", "neural" }
	S.description = "Shading Approximation Result Cache: cached inference results keyed by input for the Shading Approximation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.shadingapprox.result_cache", policy = "lfu", capacity = 294, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
