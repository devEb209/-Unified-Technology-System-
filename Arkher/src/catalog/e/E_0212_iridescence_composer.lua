-- ARKHER SYSTEM E.0212 :: Iridescence Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0212"
	S.key = "arkher.material.iridescence.layer_composition"
	S.name = "Iridescence Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Iridescence"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.iridescence.definition" }
	S.tags = { "e", "iridescence", "composer", "material" }
	S.description = "Iridescence Layer Composition: ordered layer composition with blend rules for the Iridescence subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.iridescence.layer_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
