-- ARKHER SYSTEM P.0227 :: Currency Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0227"
	S.key = "arkher.play.currency.save_codec"
	S.name = "Currency Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Currency"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.currency.content_registry" }
	S.tags = { "p", "currency", "codec", "play" }
	S.description = "Currency Save Codec: persistence, diffing and checksum of gameplay state for the Currency subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.currency.save_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
