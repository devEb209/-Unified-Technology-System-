-- ARKHER SYSTEM VA.0109 :: Temporal Slice Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0109"
	S.key = "arkher.contworld.temporalslice.infinite_grid"
	S.name = "Temporal Slice Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "temporalslice", "continuum", "contworld" }
	S.description = "Temporal Slice Infinite Grid: seamless paging of the infinite world grid for the Temporal Slice subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.temporalslice.infinite_grid", cellSize = 96, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
