-- ARKHER SYSTEM E.0062 :: Metalness Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0062"
	S.key = "arkher.material.metalness.layer_composition"
	S.name = "Metalness Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Metalness"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.metalness.definition" }
	S.tags = { "e", "metalness", "composer", "material" }
	S.description = "Metalness Layer Composition: ordered layer composition with blend rules for the Metalness subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.metalness.layer_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
