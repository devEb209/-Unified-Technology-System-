-- ARKHER SYSTEM Q.0315 :: Gamepad Focus Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0315"
	S.key = "arkher.ui.gamepadfocus.input_mapping"
	S.name = "Gamepad Focus Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.gamepadfocus.widget_tree" }
	S.tags = { "q", "gamepadfocus", "inputmap", "ui" }
	S.description = "Gamepad Focus Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Gamepad Focus subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.gamepadfocus.input_mapping", device = "keyboard", holdTime = 0.35, deadzone = 0.15 })
		inst.system = S
		inst.ctx = ctx
