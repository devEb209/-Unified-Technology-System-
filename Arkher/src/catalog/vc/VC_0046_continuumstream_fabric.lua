-- ARKHER SYSTEM VC.0046 :: Continuum Stream Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0046"
	S.key = "arkher.contneural.continuumstream.simulation_fabric"
	S.name = "Continuum Stream Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.continuumstream.complexity_budget" }
	S.tags = { "vc", "continuumstream", "fabric", "contneural" }
	S.description = "Continuum Stream Simulation Fabric: fabric stepping the continuum domains for the Continuum Stream subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.continuumstream.simulation_fabric", budgetMs = 2.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
