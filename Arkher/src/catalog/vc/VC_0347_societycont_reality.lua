-- ARKHER SYSTEM VC.0347 :: Society Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0347"
	S.key = "arkher.contneural.societycont.reality_continuum"
	S.name = "Society Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.societycont.simulation_fabric" }
	S.tags = { "vc", "societycont", "reality", "contneural" }
	S.description = "Society Continuum Reality Continuum: stacked reality layers of the continuum for the Society Continuum subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.societycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
