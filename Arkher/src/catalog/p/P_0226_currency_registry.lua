-- ARKHER SYSTEM P.0226 :: Currency Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0226"
	S.key = "arkher.play.currency.content_registry"
	S.name = "Currency Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Currency"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.currency.difficulty_controller" }
	S.tags = { "p", "currency", "registry", "play" }
	S.description = "Currency Content Registry: catalogue of the definitions this loop instantiates for the Currency subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.currency.content_registry" })
		inst.system = S
		inst.ctx = ctx
