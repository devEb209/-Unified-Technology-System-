-- ARKHER SYSTEM Z.0778 :: Semantic LOD Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0778"
	S.key = "arkher.origin.semanticlod.budget_governor"
	S.name = "Semantic LOD Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticlod.behaviour_analysis" }
	S.tags = { "z", "semanticlod", "budgeter", "origin" }
	S.description = "Semantic LOD Budget Governor: allocation of a scarce resource across the technology's consumers for the Semantic LOD subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.semanticlod.budget_governor", total = 75, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
