-- ARKHER SYSTEM VC.0022 :: Region Tile Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0022"
	S.key = "arkher.contneural.regiontile.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.regiontile.complexity_budget" }
	S.tags = { "vc", "regiontile", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.regiontile.simulation_fabric", budgetMs = 1.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
