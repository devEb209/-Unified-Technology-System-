-- ARKHER SYSTEM L.0022 :: Region Fidelity Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0022"
	S.key = "arkher.sim.regionfidelity.route_network"
	S.name = "Region Fidelity Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.regionfidelity.region_graph" }
	S.tags = { "l", "regionfidelity", "network", "sim" }
	S.description = "Region Fidelity Route Network: roads, rivers and routes between settlements for the Region Fidelity subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.regionfidelity.route_network" })
		inst.system = S
		inst.ctx = ctx
