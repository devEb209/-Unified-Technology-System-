-- ARKHER SYSTEM Z.1062 :: World Dream State Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.1062"
	S.key = "arkher.origin.worlddream.complexity_governance"
	S.name = "World Dream State Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.reality_layering" }
	S.tags = { "z", "worlddream", "complexity", "origin" }
	S.description = "World Dream State Complexity Governance: measured scene cost turned into per-subsystem directives for the World Dream State subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.worlddream.complexity_governance", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
