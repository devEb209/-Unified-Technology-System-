-- ARKHER SYSTEM I.0236 :: Locomotion Blend Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0236"
	S.key = "arkher.anim.locomotionblend.clip_sampling"
	S.name = "Locomotion Blend Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.locomotionblend.skeleton" }
	S.tags = { "i", "locomotionblend", "clip", "anim" }
	S.description = "Locomotion Blend Clip Sampling: keyframe tracks sampled, retimed and evented for the Locomotion Blend subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.locomotionblend.clip_sampling", duration = 2.20, loop = true })
		inst.system = S
		inst.ctx = ctx
