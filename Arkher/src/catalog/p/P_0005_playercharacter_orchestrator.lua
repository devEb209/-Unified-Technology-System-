-- ARKHER SYSTEM P.0005 :: Player Character State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0005"
	S.key = "arkher.play.playercharacter.state_machine"
	S.name = "Player Character State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playercharacter.combat_resolution" }
	S.tags = { "p", "playercharacter", "orchestrator", "play" }
	S.description = "Player Character State Machine: the phase machine that drives this gameplay loop for the Player Character subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.playercharacter.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
