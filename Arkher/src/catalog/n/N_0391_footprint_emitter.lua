-- ARKHER SYSTEM N.0391 :: Footprint Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0391"
	S.key = "arkher.vfx.footprint.emission"
	S.name = "Footprint Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Footprint"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "footprint", "emitter", "vfx" }
	S.description = "Footprint Emission: shaped, rate and burst emission of new particles for the Footprint subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.footprint.emission", shape = "point", rate = 43, speed = 3.30, life = 3.10, budget = 320, seed = 52643 })
		inst.system = S
		inst.ctx = ctx
