-- ARKHER SYSTEM Z.0422 :: Offline World Progression Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0422"
	S.key = "arkher.origin.offlineprogression.complexity_governance"
	S.name = "Offline World Progression Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.reality_layering" }
	S.tags = { "z", "offlineprogression", "complexity", "origin" }
	S.description = "Offline World Progression Complexity Governance: measured scene cost turned into per-subsystem directives for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.offlineprogression.complexity_governance", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
