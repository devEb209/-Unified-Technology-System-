-- ARKHER SYSTEM N.0485 :: Glow Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0485"
	S.key = "arkher.vfx.glow.ribbon_and_trail"
	S.name = "Glow Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Glow"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.glow.force_field" }
	S.tags = { "n", "glow", "ribbon", "vfx" }
	S.description = "Glow Ribbon And Trail: trail points, tapering, beams and decimation for the Glow subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.glow.ribbon_and_trail", maxPoints = 56, lifetime = 1.00, minDistance = 0.35, width = 0.70 })
		inst.system = S
		inst.ctx = ctx
