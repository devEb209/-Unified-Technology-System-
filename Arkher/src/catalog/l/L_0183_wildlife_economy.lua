-- ARKHER SYSTEM L.0183 :: Wildlife Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0183"
	S.key = "arkher.sim.wildlife.economy"
	S.name = "Wildlife Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wildlife.ecology" }
	S.tags = { "l", "wildlife", "economy", "sim" }
	S.description = "Wildlife Economy: stock, production, demand, price discovery and trade for the Wildlife subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.wildlife.economy", elasticity = 0.25 })
		inst.system = S
		inst.ctx = ctx
