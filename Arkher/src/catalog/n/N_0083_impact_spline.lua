-- ARKHER SYSTEM N.0083 :: Impact Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0083"
	S.key = "arkher.vfx.impact.curve_authoring"
	S.name = "Impact Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Impact"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.impact.ribbon_and_trail" }
	S.tags = { "n", "impact", "spline", "vfx" }
	S.description = "Impact Curve Authoring: authored curves driving the effect over its life for the Impact subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.impact.curve_authoring", tension = 0.47, closed = false })
		inst.system = S
		inst.ctx = ctx
