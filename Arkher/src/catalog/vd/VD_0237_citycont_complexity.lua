-- ARKHER SYSTEM VD.0237 :: City Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0237"
	S.key = "arkher.contsim.citycont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.citycont.world_memory_stream" }
	S.tags = { "vd", "citycont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.citycont.complexity_budget", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
