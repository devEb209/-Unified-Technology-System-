-- ARKHER SYSTEM P.0033 :: Skill Difficulty Controller
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0033"
	S.key = "arkher.play.skill.difficulty_controller"
	S.name = "Skill Difficulty Controller"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Skill"
	...
	S.kit = "controller"
	S.version = "1.0.0"
	S.deps = { "arkher.play.skill.balance_analysis" }
	S.tags = { "p", "skill", "controller", "play" }
	S.description = "Skill Difficulty Controller: closed-loop tuning toward a target challenge for the Skill subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("controller", { id = "arkher.play.skill.difficulty_controller", mode = "pid", target = 0.720, kp = 0.270, ki = 0.040, kd = 0.030, min = 0.05, max = 1.0, initial = 0.62, deadband = 0.01 })
		inst.system = S
		inst.ctx = ctx
