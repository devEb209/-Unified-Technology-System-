-- ARKHER SYSTEM K.0020 :: Neural Policy Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0020"
	S.key = "arkher.npc.neuralpolicy.reactive_behaviour"
	S.name = "Neural Policy Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.neuralpolicy.perception" }
	S.tags = { "k", "neuralpolicy", "behaviortree", "npc" }
	S.description = "Neural Policy Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Neural Policy subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.neuralpolicy.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
