-- ARKHER SYSTEM V.0153 :: UI Sprite Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0153"
	S.key = "arkher.asset.uisprite.size_budget"
	S.name = "UI Sprite Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.uisprite.compression_codec" }
	S.tags = { "v", "uisprite", "budgeter", "asset" }
	S.description = "UI Sprite Size Budget: byte budget shared between competing asset classes for the UI Sprite subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.uisprite.size_budget", total = 294, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
