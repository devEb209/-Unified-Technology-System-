-- ARKHER SYSTEM H.0138 :: Torque Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0138"
	S.key = "arkher.physics.torque.analysis"
	S.name = "Torque Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Torque"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.torque.result_cache" }
	S.tags = { "h", "torque", "analyzer", "physics" }
	S.description = "Torque Analysis: energy, jitter and cost analysis of the simulation for the Torque subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.torque.analysis", window = 123, buckets = 19, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
