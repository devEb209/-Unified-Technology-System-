-- ARKHER SYSTEM F.0142 :: Light Clustering View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0142"
	S.key = "arkher.render.lightcluster.view_and_culling"
	S.name = "Light Clustering View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.lightcluster.frame_graph" }
	S.tags = { "f", "lightcluster", "camera", "render" }
	S.description = "Light Clustering View And Culling: view state, frustum culling and screen-size LOD for the Light Clustering subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.lightcluster.view_and_culling", width = 956, height = 1080, fov = 0.9600, far = 1200 })
		inst.system = S
		inst.ctx = ctx
