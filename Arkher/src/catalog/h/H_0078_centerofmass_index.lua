-- ARKHER SYSTEM H.0078 :: Center Of Mass Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0078"
	S.key = "arkher.physics.centerofmass.broadphase_index"
	S.name = "Center Of Mass Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.centerofmass.vehicle" }
	S.tags = { "h", "centerofmass", "index", "physics" }
	S.description = "Center Of Mass Broadphase Index: spatial acceleration of candidate pair finding for the Center Of Mass subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.centerofmass.broadphase_index", mode = "hash", cellSize = 72 })
		inst.system = S
		inst.ctx = ctx
