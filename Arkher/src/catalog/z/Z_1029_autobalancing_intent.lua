-- ARKHER SYSTEM Z.1029 :: Autonomous Balancing Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.1029"
	S.key = "arkher.origin.autobalancing.intent_bridge"
	S.name = "Autonomous Balancing Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autobalancing.semantic_graph" }
	S.tags = { "z", "autobalancing", "intent", "origin" }
	S.description = "Autonomous Balancing Intent Bridge: natural language control surface for the technology for the Autonomous Balancing subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.autobalancing.intent_bridge", minConfidence = 0.33 })
		inst.system = S
		inst.ctx = ctx
