-- ARKHER SYSTEM L.0296 :: Water Cycle Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0296"
	S.key = "arkher.sim.watercycle.fidelity_policy"
	S.name = "Water Cycle Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.watercycle.streaming" }
	S.tags = { "l", "watercycle", "policy", "sim" }
	S.description = "Water Cycle Fidelity Policy: rules that pick full, cohort or statistical simulation for the Water Cycle subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.watercycle.fidelity_policy", algorithm = "wfq", starvationGuard = 22 })
		inst.system = S
		inst.ctx = ctx
