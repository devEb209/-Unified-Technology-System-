-- ARKHER SYSTEM Z.0290 :: Temporal Continuity Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0290"
	S.key = "arkher.origin.temporalcontinuity.self_critique"
	S.name = "Temporal Continuity Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.temporalcontinuity.intent_bridge" }
	S.tags = { "z", "temporalcontinuity", "critic", "origin" }
	S.description = "Temporal Continuity Self Critique: weighted judgement of the technology's own output for the Temporal Continuity subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.temporalcontinuity.self_critique", passMark = 0.77, reviseMark = 0.42, seed = 64222 })
		inst.system = S
		inst.ctx = ctx
