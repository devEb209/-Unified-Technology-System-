-- ARKHER SYSTEM L.0172 :: Livestock Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0172"
	S.key = "arkher.sim.livestock.route_network"
	S.name = "Livestock Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livestock.region_graph" }
	S.tags = { "l", "livestock", "network", "sim" }
	S.description = "Livestock Route Network: roads, rivers and routes between settlements for the Livestock subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.livestock.route_network" })
		inst.system = S
		inst.ctx = ctx
