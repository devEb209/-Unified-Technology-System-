-- ARKHER SYSTEM V.0027 :: Texture Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0027"
	S.key = "arkher.asset.textureasset.cook_pipeline"
	S.name = "Texture Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.textureasset.bundling" }
	S.tags = { "v", "textureasset", "pipeline", "asset" }
	S.description = "Texture Cook Pipeline: staged cooking with isolation and retries for the Texture subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.textureasset.cook_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
