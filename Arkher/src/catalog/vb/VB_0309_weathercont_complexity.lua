-- ARKHER SYSTEM VB.0309 :: Weather Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0309"
	S.key = "arkher.conttime.weathercont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.weathercont.world_memory_stream" }
	S.tags = { "vb", "weathercont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.weathercont.complexity_budget", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
