-- ARKHER SYSTEM Z.1077 :: World Dream State Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.1077"
	S.key = "arkher.origin.worlddream.behaviour_analysis"
	S.name = "World Dream State Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.governance_policy" }
	S.tags = { "z", "worlddream", "analyzer", "origin" }
	S.description = "World Dream State Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the World Dream State subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.worlddream.behaviour_analysis", window = 52, buckets = 16, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
