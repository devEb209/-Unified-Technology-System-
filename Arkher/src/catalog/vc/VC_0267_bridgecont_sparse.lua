-- ARKHER SYSTEM VC.0267 :: Bridge Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0267"
	S.key = "arkher.contneural.bridgecont.sparse_residency"
	S.name = "Bridge Continuum Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.bridgecont.epoch_clock" }
	S.tags = { "vc", "bridgecont", "sparse", "contneural" }
	S.description = "Bridge Continuum Sparse Residency: sparse page residency with eviction and compression for the Bridge Continuum subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.bridgecont.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
