-- ARKHER SYSTEM VB.0492 :: Lighting Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0492"
	S.key = "arkher.conttime.lightcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lightcont.reality_continuum" }
	S.tags = { "vb", "lightcont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.lightcont.emergence_continuum", windowSize = 5, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
