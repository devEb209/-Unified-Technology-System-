-- ARKHER SYSTEM F.0519 :: Geometry Streaming Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0519"
	S.key = "arkher.render.geostream.frame_graph"
	S.name = "Geometry Streaming Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "geostream", "framegraph", "render" }
	S.description = "Geometry Streaming Frame Graph: declared passes, culling, ordering and aliasing for the Geometry Streaming subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.geostream.frame_graph", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
