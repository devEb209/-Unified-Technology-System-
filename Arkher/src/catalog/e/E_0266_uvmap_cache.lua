-- ARKHER SYSTEM E.0266 :: UV Mapping Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0266"
	S.key = "arkher.material.uvmap.instance_cache"
	S.name = "UV Mapping Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "UV Mapping"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.uvmap.quality_policy" }
	S.tags = { "e", "uvmap", "cache", "material" }
	S.description = "UV Mapping Instance Cache: resolved-parameter cache keyed by context for the UV Mapping subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.uvmap.instance_cache", policy = "lfu", capacity = 267, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
