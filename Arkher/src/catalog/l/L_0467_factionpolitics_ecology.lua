-- ARKHER SYSTEM L.0467 :: Faction Politics Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0467"
	S.key = "arkher.sim.factionpolitics.ecology"
	S.name = "Faction Politics Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.factionpolitics.simulation_core" }
	S.tags = { "l", "factionpolitics", "ecology", "sim" }
	S.description = "Faction Politics Ecology: populations, predation, harvesting and carrying capacity for the Faction Politics subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.factionpolitics.ecology" })
		inst.system = S
		inst.ctx = ctx
