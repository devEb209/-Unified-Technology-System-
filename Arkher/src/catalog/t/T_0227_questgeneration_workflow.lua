-- ARKHER SYSTEM T.0227 :: Quest Generation Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0227"
	S.key = "arkher.ai.questgeneration.plan_workflow"
	S.name = "Quest Generation Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.questgeneration.semantic_knowledge" }
	S.tags = { "t", "questgeneration", "workflow", "ai" }
	S.description = "Quest Generation Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Quest Generation subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.questgeneration.plan_workflow", maxRetries = 1, budget = 70 })
		inst.system = S
		inst.ctx = ctx
