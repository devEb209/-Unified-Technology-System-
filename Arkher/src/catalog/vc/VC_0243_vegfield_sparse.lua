-- ARKHER SYSTEM VC.0243 :: Vegetation Field Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0243"
	S.key = "arkher.contneural.vegfield.sparse_residency"
	S.name = "Vegetation Field Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vegfield.epoch_clock" }
	S.tags = { "vc", "vegfield", "sparse", "contneural" }
	S.description = "Vegetation Field Sparse Residency: sparse page residency with eviction and compression for the Vegetation Field subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.vegfield.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
