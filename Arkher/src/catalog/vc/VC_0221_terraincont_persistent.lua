-- ARKHER SYSTEM VC.0221 :: Terrain Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0221"
	S.key = "arkher.contneural.terraincont.persistent_state"
	S.name = "Terrain Continuum Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.terraincont.multi-scale_fidelity" }
	S.tags = { "vc", "terraincont", "persistent", "contneural" }
	S.description = "Terrain Continuum Persistent State: epoch-stamped persistent history and rollback for the Terrain Continuum subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.terraincont.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
