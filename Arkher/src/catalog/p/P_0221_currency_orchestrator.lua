-- ARKHER SYSTEM P.0221 :: Currency State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0221"
	S.key = "arkher.play.currency.state_machine"
	S.name = "Currency State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Currency"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.currency.combat_resolution" }
	S.tags = { "p", "currency", "orchestrator", "play" }
	S.description = "Currency State Machine: the phase machine that drives this gameplay loop for the Currency subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.currency.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
