-- ARKHER SYSTEM I.0274 :: Hand Placement IK Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0274"
	S.key = "arkher.anim.handik.skeleton"
	S.name = "Hand Placement IK Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "handik", "skeleton", "anim" }
	S.description = "Hand Placement IK Skeleton: bone hierarchy, bind pose and world resolution for the Hand Placement IK subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.handik.skeleton" })
		inst.system = S
		inst.ctx = ctx
