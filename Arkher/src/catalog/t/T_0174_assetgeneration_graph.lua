-- ARKHER SYSTEM T.0174 :: Asset Generation Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0174"
	S.key = "arkher.ai.assetgeneration.reasoning_graph"
	S.name = "Asset Generation Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.assetgeneration.world_architect" }
	S.tags = { "t", "assetgeneration", "graph", "ai" }
	S.description = "Asset Generation Reasoning Graph: relationship modelling and shortest-path reasoning for the Asset Generation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.assetgeneration.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
