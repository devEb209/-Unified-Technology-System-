-- ARKHER SYSTEM VB.0331 :: Economy Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0331"
	S.key = "arkher.conttime.economycont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.economycont.coherence_guard" }
	S.tags = { "vb", "economycont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.economycont.neural_field", dims = 20, hidden = 16, seed = 91842 })
		inst.system = S
		inst.ctx = ctx
