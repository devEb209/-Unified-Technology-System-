-- ARKHER SYSTEM Q.0085 :: Scroll View Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0085"
	S.key = "arkher.ui.scrollview.responsive_layout"
	S.name = "Scroll View Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Scroll View"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "scrollview", "flex", "ui" }
	S.description = "Scroll View Responsive Layout: flex solving with safe areas, weights and breakpoints for the Scroll View subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.scrollview.responsive_layout", width = 630, height = 844, scale = 0.95 })
		inst.system = S
		inst.ctx = ctx
