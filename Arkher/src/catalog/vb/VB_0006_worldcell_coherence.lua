-- ARKHER SYSTEM VB.0006 :: World Grid Cell Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0006"
	S.key = "arkher.conttime.worldcell.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldcell.persistent_state" }
	S.tags = { "vb", "worldcell", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.worldcell.coherence_guard", window = 139, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
