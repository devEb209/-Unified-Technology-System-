-- ARKHER SYSTEM VA.0217 :: Terrain Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0217"
	S.key = "arkher.contworld.terraincont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "terraincont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.terraincont.infinite_grid", cellSize = 160, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
