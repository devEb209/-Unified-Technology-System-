-- ARKHER SYSTEM VB.0254 :: Road Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0254"
	S.key = "arkher.conttime.roadcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.roadcont.infinite_grid" }
	S.tags = { "vb", "roadcont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.roadcont.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
