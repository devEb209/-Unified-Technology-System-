-- ARKHER SYSTEM VB.0105 :: Memory Shard Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0105"
	S.key = "arkher.conttime.memoryshard.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memoryshard.world_memory_stream" }
	S.tags = { "vb", "memoryshard", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.memoryshard.complexity_budget", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
