-- ARKHER SYSTEM VA.0585 :: Thermal Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0585"
	S.key = "arkher.contworld.thermalcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.thermalcont.world_memory_stream" }
	S.tags = { "va", "thermalcont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.thermalcont.complexity_budget", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
