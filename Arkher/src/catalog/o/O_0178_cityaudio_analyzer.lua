-- ARKHER SYSTEM O.0178 :: City Audio Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0178"
	S.key = "arkher.audio.cityaudio.analysis"
	S.name = "City Audio Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "City Audio"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.cityaudio.playback_policy" }
	S.tags = { "o", "cityaudio", "analyzer", "audio" }
	S.description = "City Audio Analysis: loudness, headroom and masking analysis for the City Audio subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.cityaudio.analysis", window = 239, buckets = 19, threshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
