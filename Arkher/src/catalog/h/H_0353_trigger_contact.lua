-- ARKHER SYSTEM H.0353 :: Trigger Volume Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0353"
	S.key = "arkher.physics.trigger.contact_generation"
	S.name = "Trigger Volume Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.trigger.collision_shape" }
	S.tags = { "h", "trigger", "contact", "physics" }
	S.description = "Trigger Volume Contact Generation: narrow-phase manifolds with normal, depth and point for the Trigger Volume subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.trigger.contact_generation", slop = 0.0090, maxManifolds = 223 })
		inst.system = S
		inst.ctx = ctx
