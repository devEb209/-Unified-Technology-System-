-- ARKHER SYSTEM K.0438 :: Local Avoidance Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0438"
	S.key = "arkher.npc.localavoidance.emotion"
	S.name = "Local Avoidance Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.localavoidance.drive_system" }
	S.tags = { "k", "localavoidance", "emotion", "npc" }
	S.description = "Local Avoidance Emotion: appraisal of events into valence, arousal and mood for the Local Avoidance subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.localavoidance.emotion", inertia = 0.84, decayRate = 0.29, baselineArousal = 0.19 })
		inst.system = S
		inst.ctx = ctx
