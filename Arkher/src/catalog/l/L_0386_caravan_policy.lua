-- ARKHER SYSTEM L.0386 :: Caravan Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0386"
	S.key = "arkher.sim.caravan.fidelity_policy"
	S.name = "Caravan Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.caravan.streaming" }
	S.tags = { "l", "caravan", "policy", "sim" }
	S.description = "Caravan Fidelity Policy: rules that pick full, cohort or statistical simulation for the Caravan subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.caravan.fidelity_policy", algorithm = "edf", starvationGuard = 25 })
		inst.system = S
		inst.ctx = ctx
