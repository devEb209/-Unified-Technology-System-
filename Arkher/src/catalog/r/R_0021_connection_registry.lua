-- ARKHER SYSTEM R.0021 :: Connection Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0021"
	S.key = "arkher.net.connection.session_registry"
	S.name = "Connection Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Connection"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.connection.rate_guard" }
	S.tags = { "r", "connection", "registry", "net" }
	S.description = "Connection Session Registry: catalogue of sessions, players and their metadata for the Connection subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.connection.session_registry" })
		inst.system = S
		inst.ctx = ctx
