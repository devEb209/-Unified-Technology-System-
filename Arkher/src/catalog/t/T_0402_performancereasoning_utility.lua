-- ARKHER SYSTEM T.0402 :: Performance Reasoning Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0402"
	S.key = "arkher.ai.performancereasoning.utility_selection"
	S.name = "Performance Reasoning Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.performancereasoning.working_memory" }
	S.tags = { "t", "performancereasoning", "utility", "ai" }
	S.description = "Performance Reasoning Utility Selection: scored choice between competing courses of action for the Performance Reasoning subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.performancereasoning.utility_selection", momentum = 0.01 })
		inst.system = S
		inst.ctx = ctx
