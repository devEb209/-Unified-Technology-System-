-- ARKHER SYSTEM Z.0388 :: Thermal Aware Simulation Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0388"
	S.key = "arkher.origin.thermalaware.semantic_graph"
	S.name = "Thermal Aware Simulation Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.world_architect" }
	S.tags = { "z", "thermalaware", "knowledge", "origin" }
	S.description = "Thermal Aware Simulation Semantic Graph: typed entities and inferred relations of the technology itself for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.thermalaware.semantic_graph", dims = 48 })
		inst.system = S
		inst.ctx = ctx
