-- ARKHER SYSTEM H.0652 :: Wheel Suspension Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0652"
	S.key = "arkher.physics.suspension.broadphase_index"
	S.name = "Wheel Suspension Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.suspension.vehicle" }
	S.tags = { "h", "suspension", "index", "physics" }
	S.description = "Wheel Suspension Broadphase Index: spatial acceleration of candidate pair finding for the Wheel Suspension subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.suspension.broadphase_index", mode = "hash", cellSize = 16 })
		inst.system = S
		inst.ctx = ctx
