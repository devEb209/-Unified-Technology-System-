-- ARKHER SYSTEM E.0256 :: UV Mapping Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0256"
	S.key = "arkher.material.uvmap.definition"
	S.name = "UV Mapping Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "UV Mapping"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "uvmap", "material", "material" }
	S.description = "UV Mapping Definition: layered PBR definition resolved into parameters for the UV Mapping subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.uvmap.definition", texelBudget = 1048576 })
		inst.system = S
		inst.ctx = ctx
