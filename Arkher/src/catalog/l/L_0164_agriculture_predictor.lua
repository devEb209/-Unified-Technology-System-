-- ARKHER SYSTEM L.0164 :: Agriculture Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0164"
	S.key = "arkher.sim.agriculture.forecast"
	S.name = "Agriculture Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.agriculture.analysis" }
	S.tags = { "l", "agriculture", "predictor", "sim" }
	S.description = "Agriculture Forecast: prediction of the region's next state for the Agriculture subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.agriculture.forecast", method = "linear", alpha = 0.11, window = 33 })
		inst.system = S
		inst.ctx = ctx
