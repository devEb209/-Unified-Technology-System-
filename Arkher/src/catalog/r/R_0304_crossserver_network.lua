-- ARKHER SYSTEM R.0304 :: Cross Server Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0304"
	S.key = "arkher.net.crossserver.transport_graph"
	S.name = "Cross Server Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Cross Server"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.crossserver.prediction_and_reconciliation" }
	S.tags = { "r", "crossserver", "network", "net" }
	S.description = "Cross Server Transport Graph: topology, capacity and routing between endpoints for the Cross Server subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.crossserver.transport_graph" })
		inst.system = S
		inst.ctx = ctx
