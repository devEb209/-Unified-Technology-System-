-- ARKHER SYSTEM L.0103 :: Reification Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0103"
	S.key = "arkher.sim.reification.analysis"
	S.name = "Reification Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.reification.aggregate_cache" }
	S.tags = { "l", "reification", "analyzer", "sim" }
	S.description = "Reification Analysis: trend, anomaly and stability analysis of the world for the Reification subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.reification.analysis", window = 101, buckets = 13, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
