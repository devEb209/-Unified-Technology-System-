-- ARKHER SYSTEM VD.0547 :: World Fabric Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0547"
	S.key = "arkher.contsim.worldfabric.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldfabric.coherence_guard" }
	S.tags = { "vd", "worldfabric", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.worldfabric.neural_field", dims = 12, hidden = 8, seed = 80360 })
		inst.system = S
		inst.ctx = ctx
