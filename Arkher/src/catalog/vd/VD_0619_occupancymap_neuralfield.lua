-- ARKHER SYSTEM VD.0619 :: Occupancy Map Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0619"
	S.key = "arkher.contsim.occupancymap.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.occupancymap.coherence_guard" }
	S.tags = { "vd", "occupancymap", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.occupancymap.neural_field", dims = 16, hidden = 12, seed = 4109 })
		inst.system = S
		inst.ctx = ctx
