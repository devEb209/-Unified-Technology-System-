-- ARKHER SYSTEM VA.0369 :: Quest Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0369"
	S.key = "arkher.contworld.questcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.questcont.world_memory_stream" }
	S.tags = { "va", "questcont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.questcont.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
