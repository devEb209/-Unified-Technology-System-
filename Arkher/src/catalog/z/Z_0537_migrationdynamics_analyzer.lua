-- ARKHER SYSTEM Z.0537 :: Migration Dynamics Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0537"
	S.key = "arkher.origin.migrationdynamics.behaviour_analysis"
	S.name = "Migration Dynamics Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.migrationdynamics.governance_policy" }
	S.tags = { "z", "migrationdynamics", "analyzer", "origin" }
	S.description = "Migration Dynamics Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.migrationdynamics.behaviour_analysis", window = 203, buckets = 15, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
