-- ARKHER SYSTEM Q.0113 :: Toast Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0113"
	S.key = "arkher.ui.toast.navigation_graph"
	S.name = "Toast Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Toast"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.toast.transition" }
	S.tags = { "q", "toast", "graph", "ui" }
	S.description = "Toast Navigation Graph: screens, routes and shortest path between them for the Toast subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.toast.navigation_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
