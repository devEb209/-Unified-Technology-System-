-- ARKHER SYSTEM Z.0168 :: Self Analyzing Project Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0168"
	S.key = "arkher.origin.selfanalyzing.semantic_graph"
	S.name = "Self Analyzing Project Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.world_architect" }
	S.tags = { "z", "selfanalyzing", "knowledge", "origin" }
	S.description = "Self Analyzing Project Semantic Graph: typed entities and inferred relations of the technology itself for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.selfanalyzing.semantic_graph", dims = 40 })
		inst.system = S
		inst.ctx = ctx
