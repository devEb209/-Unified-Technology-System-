-- ARKHER SYSTEM G.0381 :: Deterministic Seeding Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0381"
	S.key = "arkher.neural.detseed.temporal_history"
	S.name = "Deterministic Seeding Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detseed.feature_extraction" }
	S.tags = { "g", "detseed", "temporal", "neural" }
	S.description = "Deterministic Seeding Temporal History: history buffers reused across frames for the Deterministic Seeding subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.detseed.temporal_history", feedback = 0.86, phase = 8 })
		inst.system = S
		inst.ctx = ctx
