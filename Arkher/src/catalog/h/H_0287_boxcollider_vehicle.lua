-- ARKHER SYSTEM H.0287 :: Box Collider Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0287"
	S.key = "arkher.physics.boxcollider.vehicle"
	S.name = "Box Collider Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Box Collider"
	S.aspect = "Vehicle"
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.boxcollider.character_motion" }
	S.tags = { "h", "boxcollider", "vehicle", "physics" }
	S.description = "Box Collider Vehicle: suspension, drivetrain, steering and tire friction for the Box Collider subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.boxcollider.vehicle", mass = 1900, wheelbase = 2.40, track = 1.60, maxRpm = 5800 })
		inst.system = S
		inst.ctx = ctx
