-- ARKHER SYSTEM VA.0475 :: VFX Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0475"
	S.key = "arkher.contworld.vfxcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vfxcont.coherence_guard" }
	S.tags = { "va", "vfxcont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.vfxcont.neural_field", dims = 12, hidden = 8, seed = 61868 })
		inst.system = S
		inst.ctx = ctx
