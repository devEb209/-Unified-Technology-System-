-- ARKHER SYSTEM Q.0329 :: Keyboard Focus Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0329"
	S.key = "arkher.ui.keyboardfocus.navigation_graph"
	S.name = "Keyboard Focus Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.keyboardfocus.transition" }
	S.tags = { "q", "keyboardfocus", "graph", "ui" }
	S.description = "Keyboard Focus Navigation Graph: screens, routes and shortest path between them for the Keyboard Focus subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.keyboardfocus.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
