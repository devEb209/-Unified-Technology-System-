-- ARKHER SYSTEM W.0244 :: Dissolve Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0244"
	S.key = "arkher.cine.dissolve.shot_composition"
	S.name = "Dissolve Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dissolve"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dissolve.colour_grade" }
	S.tags = { "w", "dissolve", "composer", "cine" }
	S.description = "Dissolve Shot Composition: blending of the signals that make up the final shot for the Dissolve subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.dissolve.shot_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
