-- ARKHER SYSTEM VC.0446 :: Animation Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0446"
	S.key = "arkher.contneural.animcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.animcont.infinite_grid" }
	S.tags = { "vc", "animcont", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.animcont.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
