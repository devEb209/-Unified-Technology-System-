-- ARKHER SYSTEM G.0303 :: Model Registry Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0303"
	S.key = "arkher.neural.modelregistry.result_cache"
	S.name = "Model Registry Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelregistry.compute_budget" }
	S.tags = { "g", "modelregistry", "cache", "neural" }
	S.description = "Model Registry Result Cache: cached inference results keyed by input for the Model Registry subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.modelregistry.result_cache", policy = "lfu", capacity = 67, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
