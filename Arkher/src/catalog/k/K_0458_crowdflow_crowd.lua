-- ARKHER SYSTEM K.0458 :: Crowd Flow Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0458"
	S.key = "arkher.npc.crowdflow.crowd_steering"
	S.name = "Crowd Flow Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.crowdflow.navigation" }
	S.tags = { "k", "crowdflow", "crowd", "npc" }
	S.description = "Crowd Flow Crowd Steering: local avoidance, cohesion and arrival at scale for the Crowd Flow subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.crowdflow.crowd_steering", radius = 0.40, maxSpeed = 5.00, cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
