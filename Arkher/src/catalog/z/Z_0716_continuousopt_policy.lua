-- ARKHER SYSTEM Z.0716 :: Continuous Self Optimization Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0716"
	S.key = "arkher.origin.continuousopt.governance_policy"
	S.name = "Continuous Self Optimization Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.signal_composition" }
	S.tags = { "z", "continuousopt", "policy", "origin" }
	S.description = "Continuous Self Optimization Governance Policy: ordered rules governing when the technology may act for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.continuousopt.governance_policy", algorithm = "edf", starvationGuard = 17 })
		inst.system = S
		inst.ctx = ctx
