-- ARKHER SYSTEM VB.0252 :: Vegetation Field Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0252"
	S.key = "arkher.conttime.vegfield.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vegfield.reality_continuum" }
	S.tags = { "vb", "vegfield", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.vegfield.emergence_continuum", windowSize = 4, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
