-- ARKHER SYSTEM F.0370 :: Render Scale Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0370"
	S.key = "arkher.render.renderscale.probe_volume"
	S.name = "Render Scale Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Render Scale"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.renderscale.lighting_rig" }
	S.tags = { "f", "renderscale", "probe", "render" }
	S.description = "Render Scale Probe Volume: irradiance probes encoded in spherical harmonics for the Render Scale subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.renderscale.probe_volume", spacing = 8 })
		inst.system = S
		inst.ctx = ctx
