...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Marvelous — CORE Map #0278", size=Vector2.new(680, 480), pos=UDim2.fromOffset(114, 126), parent=parent, icon="◆"})
