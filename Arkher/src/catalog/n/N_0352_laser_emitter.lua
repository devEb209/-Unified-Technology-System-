-- ARKHER SYSTEM N.0352 :: Laser Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0352"
	S.key = "arkher.vfx.laser.emission"
	S.name = "Laser Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Laser"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "laser", "emitter", "vfx" }
	S.description = "Laser Emission: shaped, rate and burst emission of new particles for the Laser subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.laser.emission", shape = "sphere", rate = 25, speed = 3.50, life = 1.30, budget = 448, seed = 62765 })
		inst.system = S
		inst.ctx = ctx
