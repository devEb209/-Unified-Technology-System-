-- ARKHER SYSTEM Z.0079 :: Reality Layer Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0079"
	S.key = "arkher.origin.realitylayer.residency_streaming"
	S.name = "Reality Layer Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.budget_governor" }
	S.tags = { "z", "realitylayer", "streamer", "origin" }
	S.description = "Reality Layer Residency Streaming: distance-driven residency of the technology's workload for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.realitylayer.residency_streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
