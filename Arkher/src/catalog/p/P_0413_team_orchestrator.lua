-- ARKHER SYSTEM P.0413 :: Team State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0413"
	S.key = "arkher.play.team.state_machine"
	S.name = "Team State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Team"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.team.combat_resolution" }
	S.tags = { "p", "team", "orchestrator", "play" }
	S.description = "Team State Machine: the phase machine that drives this gameplay loop for the Team subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.team.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
