-- ARKHER SYSTEM K.0576 :: Idle Behaviour Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0576"
	S.key = "arkher.npc.idlebehaviour.memory"
	S.name = "Idle Behaviour Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.idlebehaviour.mind_network" }
	S.tags = { "k", "idlebehaviour", "memory", "npc" }
	S.description = "Idle Behaviour Memory: episodic memory with decay, recall and consolidation for the Idle Behaviour subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.idlebehaviour.memory", capacity = 123, decayRate = 0.035, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
