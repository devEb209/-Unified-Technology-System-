-- ARKHER SYSTEM L.0513 :: Migration Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0513"
	S.key = "arkher.sim.migration.economy"
	S.name = "Migration Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.migration.ecology" }
	S.tags = { "l", "migration", "economy", "sim" }
	S.description = "Migration Economy: stock, production, demand, price discovery and trade for the Migration subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.migration.economy", elasticity = 0.32 })
		inst.system = S
		inst.ctx = ctx
