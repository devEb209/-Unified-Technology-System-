-- ARKHER SYSTEM Q.0328 :: Keyboard Focus Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0328"
	S.key = "arkher.ui.keyboardfocus.transition"
	S.name = "Keyboard Focus Transition"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.keyboardfocus.input_mapping" }
	S.tags = { "q", "keyboardfocus", "tween", "ui" }
	S.description = "Keyboard Focus Transition: eased, delayed, looped and sequenced motion for the Keyboard Focus subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.keyboardfocus.transition", timeScale = 0.94 })
		inst.system = S
		inst.ctx = ctx
