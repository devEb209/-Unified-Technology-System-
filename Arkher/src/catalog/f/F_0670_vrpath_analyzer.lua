-- ARKHER SYSTEM F.0670 :: VR Stereo Path Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0670"
	S.key = "arkher.render.vrpath.frame_analysis"
	S.name = "VR Stereo Path Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.vrpath.pass_cache" }
	S.tags = { "f", "vrpath", "analyzer", "render" }
	S.description = "VR Stereo Path Frame Analysis: per-pass cost analysis and outlier detection for the VR Stereo Path subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.vrpath.frame_analysis", window = 159, buckets = 11, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
