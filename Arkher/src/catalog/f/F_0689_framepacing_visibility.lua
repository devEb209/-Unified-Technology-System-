-- ARKHER SYSTEM F.0689 :: Frame Pacing Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0689"
	S.key = "arkher.render.framepacing.visibility_set"
	S.name = "Frame Pacing Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Frame Pacing"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepacing.view_and_culling" }
	S.tags = { "f", "framepacing", "visibility", "render" }
	S.description = "Frame Pacing Visibility Set: cell, portal and occluder visibility for the Frame Pacing subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.framepacing.visibility_set", maxDepth = 2 })
		inst.system = S
		inst.ctx = ctx
