-- ARKHER SYSTEM Z.0363 :: Mobile First Governor Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0363"
	S.key = "arkher.origin.mobilefirst.simulation_fabric"
	S.name = "Mobile First Governor Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.complexity_governance" }
	S.tags = { "z", "mobilefirst", "fabric", "origin" }
	S.description = "Mobile First Governor Simulation Fabric: every simulation domain stepped under one budgeted clock for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.mobilefirst.simulation_fabric", budgetMs = 4.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
