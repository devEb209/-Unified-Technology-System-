...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Sketchfab API CUSTOM 125301", size=Vector2.new(653, 557), pos=UDim2.fromOffset(407, 393), parent=parent, icon="▣"})
    win.Root.Name="ARKHER_CUST_125301"
...
Components.Slider(content, "Scale", 0.1, 5, 1, function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_C125301", v) end end)
Components.Checkbox(content, "Active", true, function(v) end)
    ...
    local idLbl=Instance.new("TextLabel"); idLbl.Size=UDim2.new(1,0,0,12); idLbl.Position=UDim2.new(0,0,1,-12); idLbl.BackgroundTransparency=1; idLbl.Text="ID "..(2000000+125301*137); idLbl.Font=Enum.Font.Code; idLbl.TextSize=8; idLbl.TextColor3=Theme.tokens.slate400; idLbl.Parent=img
