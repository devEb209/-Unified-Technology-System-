-- ARKHER SYSTEM K.0317 :: Threat Assessment Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0317"
	S.key = "arkher.npc.threatassessment.navigation"
	S.name = "Threat Assessment Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.threatassessment.goal_planner" }
	S.tags = { "k", "threatassessment", "navgraph", "npc" }
	S.description = "Threat Assessment Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Threat Assessment subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.threatassessment.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
