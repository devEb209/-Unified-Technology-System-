-- ARKHER SYSTEM VB.0295 :: Climate Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0295"
	S.key = "arkher.conttime.climatecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.climatecont.coherence_guard" }
	S.tags = { "vb", "climatecont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.climatecont.neural_field", dims = 12, hidden = 8, seed = 96264 })
		inst.system = S
		inst.ctx = ctx
