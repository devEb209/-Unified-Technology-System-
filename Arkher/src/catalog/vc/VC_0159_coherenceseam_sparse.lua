-- ARKHER SYSTEM VC.0159 :: Coherence Seam Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0159"
	S.key = "arkher.contneural.coherenceseam.sparse_residency"
	S.name = "Coherence Seam Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.coherenceseam.epoch_clock" }
	S.tags = { "vc", "coherenceseam", "sparse", "contneural" }
	S.description = "Coherence Seam Sparse Residency: sparse page residency with eviction and compression for the Coherence Seam subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.coherenceseam.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
