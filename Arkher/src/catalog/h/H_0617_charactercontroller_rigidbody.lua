-- ARKHER SYSTEM H.0617 :: Character Controller Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0617"
	S.key = "arkher.physics.charactercontroller.body_dynamics"
	S.name = "Character Controller Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "charactercontroller", "rigidbody", "physics" }
	S.description = "Character Controller Body Dynamics: integration, impulses, damping and sleeping of a body for the Character Controller subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.charactercontroller.body_dynamics", mass = 6.00, radius = 0.55, restitution = 0.05, friction = 0.55, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
