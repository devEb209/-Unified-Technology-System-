-- ARKHER SYSTEM H.0155 :: Angular Damping Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0155"
	S.key = "arkher.physics.angulardamping.body_dynamics"
	S.name = "Angular Damping Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "angulardamping", "rigidbody", "physics" }
	S.description = "Angular Damping Body Dynamics: integration, impulses, damping and sleeping of a body for the Angular Damping subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.angulardamping.body_dynamics", mass = 15.00, radius = 1.00, restitution = 0.14, friction = 0.64, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
