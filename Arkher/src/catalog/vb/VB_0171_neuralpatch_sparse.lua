-- ARKHER SYSTEM VB.0171 :: Neural Patch Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0171"
	S.key = "arkher.conttime.neuralpatch.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.neuralpatch.epoch_clock" }
	S.tags = { "vb", "neuralpatch", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.neuralpatch.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
