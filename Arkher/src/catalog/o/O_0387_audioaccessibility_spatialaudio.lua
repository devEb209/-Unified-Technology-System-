-- ARKHER SYSTEM O.0387 :: Accessibility Audio Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0387"
	S.key = "arkher.audio.audioaccessibility.spatialization"
	S.name = "Accessibility Audio Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audioaccessibility.mixer_bus" }
	S.tags = { "o", "audioaccessibility", "spatialaudio", "audio" }
	S.description = "Accessibility Audio Spatialization: distance attenuation, panning, occlusion and doppler for the Accessibility Audio subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.audioaccessibility.spatialization", model = "linear", refDistance = 7, maxDistance = 160, rolloff = 0.84, maxVoices = 28 })
		inst.system = S
		inst.ctx = ctx
