-- ARKHER SYSTEM Z.0186 :: World Memory Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0186"
	S.key = "arkher.origin.worldmemorytech.emergence_detection"
	S.name = "World Memory Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldmemorytech.world_memory" }
	S.tags = { "z", "worldmemorytech", "emergence", "origin" }
	S.description = "World Memory Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the World Memory subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.worldmemorytech.emergence_detection", windowSize = 7, threshold = 1.40, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
