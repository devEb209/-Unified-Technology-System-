-- ARKHER SYSTEM VC.0170 :: Neural Patch Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0170"
	S.key = "arkher.contneural.neuralpatch.epoch_clock"
	S.name = "Neural Patch Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.neuralpatch.infinite_grid" }
	S.tags = { "vc", "neuralpatch", "epoch", "contneural" }
	S.description = "Neural Patch Epoch Clock: deterministic epoch timeline with catch-up for the Neural Patch subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.neuralpatch.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
