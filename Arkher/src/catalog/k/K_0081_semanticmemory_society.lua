-- ARKHER SYSTEM K.0081 :: Semantic Memory Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0081"
	S.key = "arkher.npc.semanticmemory.social_relations"
	S.name = "Semantic Memory Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.semanticmemory.crowd_steering" }
	S.tags = { "k", "semanticmemory", "society", "npc" }
	S.description = "Semantic Memory Social Relations: affinity, factions, reputation and gossip for the Semantic Memory subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.semanticmemory.social_relations", decayRate = 0.013, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
