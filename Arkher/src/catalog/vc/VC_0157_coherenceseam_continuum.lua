-- ARKHER SYSTEM VC.0157 :: Coherence Seam Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0157"
	S.key = "arkher.contneural.coherenceseam.infinite_grid"
	S.name = "Coherence Seam Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "coherenceseam", "continuum", "contneural" }
	S.description = "Coherence Seam Infinite Grid: seamless paging of the infinite world grid for the Coherence Seam subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.coherenceseam.infinite_grid", cellSize = 192, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
