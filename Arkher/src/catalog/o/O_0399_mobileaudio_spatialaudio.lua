-- ARKHER SYSTEM O.0399 :: Mobile Audio Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0399"
	S.key = "arkher.audio.mobileaudio.spatialization"
	S.name = "Mobile Audio Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mobile Audio"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mobileaudio.mixer_bus" }
	S.tags = { "o", "mobileaudio", "spatialaudio", "audio" }
	S.description = "Mobile Audio Spatialization: distance attenuation, panning, occlusion and doppler for the Mobile Audio subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.mobileaudio.spatialization", model = "linear", refDistance = 4, maxDistance = 180, rolloff = 0.85, maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
