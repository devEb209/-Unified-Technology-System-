-- ARKHER SYSTEM I.0401 :: Animation Compression Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0401"
	S.key = "arkher.anim.animcompression.quality_policy"
	S.name = "Animation Compression Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animcompression.pose_cache" }
	S.tags = { "i", "animcompression", "policy", "anim" }
	S.description = "Animation Compression Quality Policy: device tier rules for rate, bones and solvers for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.animcompression.quality_policy", algorithm = "lottery", starvationGuard = 51 })
		inst.system = S
		inst.ctx = ctx
