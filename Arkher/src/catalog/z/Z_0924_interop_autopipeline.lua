-- ARKHER SYSTEM Z.0924 :: Universal Interop Layer Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0924"
	S.key = "arkher.origin.interop.autonomous_pipeline"
	S.name = "Universal Interop Layer Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.interop.simulation_fabric" }
	S.tags = { "z", "interop", "autopipeline", "origin" }
	S.description = "Universal Interop Layer Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Universal Interop Layer subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.interop.autonomous_pipeline", maxIterations = 5 })
		inst.system = S
		inst.ctx = ctx
