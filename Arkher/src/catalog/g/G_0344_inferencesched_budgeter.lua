-- ARKHER SYSTEM G.0344 :: Inference Scheduler Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0344"
	S.key = "arkher.neural.inferencesched.compute_budget"
	S.name = "Inference Scheduler Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.inferencesched.quality_predictor" }
	S.tags = { "g", "inferencesched", "budgeter", "neural" }
	S.description = "Inference Scheduler Compute Budget: inference time budget allocation for the Inference Scheduler subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.inferencesched.compute_budget", total = 374, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
