-- ARKHER SYSTEM I.0023 :: Bone Hierarchy Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0023"
	S.key = "arkher.anim.bonehierarchy.pose_cache"
	S.name = "Bone Hierarchy Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonehierarchy.playback_pipeline" }
	S.tags = { "i", "bonehierarchy", "cache", "anim" }
	S.description = "Bone Hierarchy Pose Cache: reuse of sampled poses across frames and instances for the Bone Hierarchy subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.bonehierarchy.pose_cache", policy = "lru", capacity = 410, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
