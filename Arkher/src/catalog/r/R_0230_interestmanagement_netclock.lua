-- ARKHER SYSTEM R.0230 :: Interest Management Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0230"
	S.key = "arkher.net.interestmanagement.time_sync"
	S.name = "Interest Management Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.interestmanagement.replication" }
	S.tags = { "r", "interestmanagement", "netclock", "net" }
	S.description = "Interest Management Time Sync: offset estimation, outlier rejection and jitter buffering for the Interest Management subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.interestmanagement.time_sync", tickRate = 40, bufferDelay = 0.100, maxSamples = 10 })
		inst.system = S
		inst.ctx = ctx
