-- ARKHER SYSTEM Q.0232 :: Quest Log Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0232"
	S.key = "arkher.ui.questlog.transition"
	S.name = "Quest Log Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Quest Log"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.questlog.input_mapping" }
	S.tags = { "q", "questlog", "tween", "ui" }
	S.description = "Quest Log Transition: eased, delayed, looped and sequenced motion for the Quest Log subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.questlog.transition", timeScale = 0.90 })
		inst.system = S
		inst.ctx = ctx
