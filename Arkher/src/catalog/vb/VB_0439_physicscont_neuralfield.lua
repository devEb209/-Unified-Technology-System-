-- ARKHER SYSTEM VB.0439 :: Physics Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0439"
	S.key = "arkher.conttime.physicscont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.physicscont.coherence_guard" }
	S.tags = { "vb", "physicscont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.physicscont.neural_field", dims = 24, hidden = 20, seed = 29315 })
		inst.system = S
		inst.ctx = ctx
