-- ARKHER SYSTEM K.0567 :: Work Behaviour Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0567"
	S.key = "arkher.npc.workbehaviour.utility_reasoning"
	S.name = "Work Behaviour Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workbehaviour.reactive_behaviour" }
	S.tags = { "k", "workbehaviour", "utility", "npc" }
	S.description = "Work Behaviour Utility Reasoning: scored option selection with response curves for the Work Behaviour subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.workbehaviour.utility_reasoning", momentum = 0.02 })
		inst.system = S
		inst.ctx = ctx
