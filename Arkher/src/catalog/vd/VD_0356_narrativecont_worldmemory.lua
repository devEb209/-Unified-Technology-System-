-- ARKHER SYSTEM VD.0356 :: Narrative Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0356"
	S.key = "arkher.contsim.narrativecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.narrativecont.neural_field" }
	S.tags = { "vd", "narrativecont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.narrativecont.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
