-- ARKHER SYSTEM H.0623 :: Character Controller Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0623"
	S.key = "arkher.physics.charactercontroller.vehicle"
	S.name = "Character Controller Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.charactercontroller.character_motion" }
	S.tags = { "h", "charactercontroller", "vehicle", "physics" }
	S.description = "Character Controller Vehicle: suspension, drivetrain, steering and tire friction for the Character Controller subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.charactercontroller.vehicle", mass = 1400, wheelbase = 3.10, track = 1.90, maxRpm = 6500 })
		inst.system = S
		inst.ctx = ctx
