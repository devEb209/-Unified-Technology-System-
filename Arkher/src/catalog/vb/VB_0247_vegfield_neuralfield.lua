-- ARKHER SYSTEM VB.0247 :: Vegetation Field Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0247"
	S.key = "arkher.conttime.vegfield.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vegfield.coherence_guard" }
	S.tags = { "vb", "vegfield", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.vegfield.neural_field", dims = 24, hidden = 20, seed = 90059 })
		inst.system = S
		inst.ctx = ctx
