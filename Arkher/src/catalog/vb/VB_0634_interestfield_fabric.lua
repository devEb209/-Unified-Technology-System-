-- ARKHER SYSTEM VB.0634 :: Interest Field Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0634"
	S.key = "arkher.conttime.interestfield.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.interestfield.complexity_budget" }
	S.tags = { "vb", "interestfield", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.interestfield.simulation_fabric", budgetMs = 2.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
