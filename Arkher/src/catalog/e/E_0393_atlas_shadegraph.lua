-- ARKHER SYSTEM E.0393 :: Texture Atlas Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0393"
	S.key = "arkher.material.atlas.shading_graph"
	S.name = "Texture Atlas Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.atlas.layer_composition" }
	S.tags = { "e", "atlas", "shadegraph", "material" }
	S.description = "Texture Atlas Shading Graph: node graph evaluated and compiled to Luau for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.atlas.shading_graph" })
		inst.system = S
		inst.ctx = ctx
