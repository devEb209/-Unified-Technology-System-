-- ARKHER SYSTEM P.0002 :: Player Character Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0002"
	S.key = "arkher.play.playercharacter.inventory"
	S.name = "Player Character Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playercharacter.attributes" }
	S.tags = { "p", "playercharacter", "inventory", "play" }
	S.description = "Player Character Inventory: slots, stacking, weight, equipment and crafting for the Player Character subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.playercharacter.inventory", slots = 32, maxWeight = 90 })
		inst.system = S
		inst.ctx = ctx
