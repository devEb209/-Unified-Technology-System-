-- ARKHER SYSTEM Q.0275 :: Virtual Joystick Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0275"
	S.key = "arkher.ui.virtualjoystick.usability_analysis"
	S.name = "Virtual Joystick Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.virtualjoystick.frame_budget" }
	S.tags = { "q", "virtualjoystick", "analyzer", "ui" }
	S.description = "Virtual Joystick Usability Analysis: reachability, latency and abandonment analysis for the Virtual Joystick subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.virtualjoystick.usability_analysis", window = 156, buckets = 16, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
