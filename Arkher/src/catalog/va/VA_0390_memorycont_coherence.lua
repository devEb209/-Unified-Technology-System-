-- ARKHER SYSTEM VA.0390 :: Memory Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0390"
	S.key = "arkher.contworld.memorycont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memorycont.persistent_state" }
	S.tags = { "va", "memorycont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.memorycont.coherence_guard", window = 135, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
