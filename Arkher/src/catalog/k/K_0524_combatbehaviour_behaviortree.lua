-- ARKHER SYSTEM K.0524 :: Combat Behaviour Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0524"
	S.key = "arkher.npc.combatbehaviour.reactive_behaviour"
	S.name = "Combat Behaviour Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.combatbehaviour.perception" }
	S.tags = { "k", "combatbehaviour", "behaviortree", "npc" }
	S.description = "Combat Behaviour Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Combat Behaviour subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.combatbehaviour.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
