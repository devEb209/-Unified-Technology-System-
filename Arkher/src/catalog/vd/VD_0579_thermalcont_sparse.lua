-- ARKHER SYSTEM VD.0579 :: Thermal Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0579"
	S.key = "arkher.contsim.thermalcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.thermalcont.epoch_clock" }
	S.tags = { "vd", "thermalcont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.thermalcont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
