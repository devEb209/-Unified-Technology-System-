-- ARKHER SYSTEM K.0654 :: Daily Routine Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0654"
	S.key = "arkher.npc.dailyroutine.crowd_steering"
	S.name = "Daily Routine Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dailyroutine.navigation" }
	S.tags = { "k", "dailyroutine", "crowd", "npc" }
	S.description = "Daily Routine Crowd Steering: local avoidance, cohesion and arrival at scale for the Daily Routine subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.dailyroutine.crowd_steering", radius = 0.50, maxSpeed = 4.20, cellSize = 6 })
		inst.system = S
		inst.ctx = ctx
