-- ARKHER SYSTEM VD.0278 :: Water Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0278"
	S.key = "arkher.contsim.watercont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.watercont.infinite_grid" }
	S.tags = { "vd", "watercont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.watercont.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
