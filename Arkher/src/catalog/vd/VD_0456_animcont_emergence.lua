-- ARKHER SYSTEM VD.0456 :: Animation Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0456"
	S.key = "arkher.contsim.animcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.animcont.reality_continuum" }
	S.tags = { "vd", "animcont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.animcont.emergence_continuum", windowSize = 7, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
