-- ARKHER SYSTEM T.0542 :: Animation Reasoning Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0542"
	S.key = "arkher.ai.animationreasoning.utility_selection"
	S.name = "Animation Reasoning Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.animationreasoning.working_memory" }
	S.tags = { "t", "animationreasoning", "utility", "ai" }
	S.description = "Animation Reasoning Utility Selection: scored choice between competing courses of action for the Animation Reasoning subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.animationreasoning.utility_selection", momentum = 0.17 })
		inst.system = S
		inst.ctx = ctx
