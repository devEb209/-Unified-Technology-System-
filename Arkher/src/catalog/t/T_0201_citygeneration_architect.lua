-- ARKHER SYSTEM T.0201 :: City Generation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0201"
	S.key = "arkher.ai.citygeneration.world_architect"
	S.name = "City Generation World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.citygeneration.self_critique" }
	S.tags = { "t", "citygeneration", "architect", "ai" }
	S.description = "City Generation World Architect: composition of a whole world plan with conserved budgets for the City Generation subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.citygeneration.world_architect", budget = 1200, seed = 71936 })
		inst.system = S
		inst.ctx = ctx
