-- ARKHER SYSTEM F.0608 :: Frame Capture Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0608"
	S.key = "arkher.render.framecapture.probe_volume"
	S.name = "Frame Capture Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framecapture.lighting_rig" }
	S.tags = { "f", "framecapture", "probe", "render" }
	S.description = "Frame Capture Probe Volume: irradiance probes encoded in spherical harmonics for the Frame Capture subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.framecapture.probe_volume", spacing = 32 })
		inst.system = S
		inst.ctx = ctx
