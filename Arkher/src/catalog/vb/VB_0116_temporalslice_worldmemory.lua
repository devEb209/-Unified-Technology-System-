-- ARKHER SYSTEM VB.0116 :: Temporal Slice World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0116"
	S.key = "arkher.conttime.temporalslice.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.temporalslice.neural_field" }
	S.tags = { "vb", "temporalslice", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.temporalslice.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
