-- ARKHER SYSTEM VD.0274 :: Bridge Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0274"
	S.key = "arkher.contsim.bridgecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.bridgecont.complexity_budget" }
	S.tags = { "vd", "bridgecont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.bridgecont.simulation_fabric", budgetMs = 2.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
