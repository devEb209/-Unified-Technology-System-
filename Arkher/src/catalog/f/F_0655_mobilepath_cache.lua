-- ARKHER SYSTEM F.0655 :: Mobile Fast Path Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0655"
	S.key = "arkher.render.mobilepath.pass_cache"
	S.name = "Mobile Fast Path Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.mobilepath.render_policy" }
	S.tags = { "f", "mobilepath", "cache", "render" }
	S.description = "Mobile Fast Path Pass Cache: reuse of pass results across frames for the Mobile Fast Path subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.mobilepath.pass_cache", policy = "ttl", capacity = 511, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
