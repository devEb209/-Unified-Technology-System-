-- ARKHER SYSTEM I.0447 :: Motion Matching Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0447"
	S.key = "arkher.anim.motionmatching.physical_blend"
	S.name = "Motion Matching Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.motionmatching.inverse_kinematics" }
	S.tags = { "i", "motionmatching", "ragdoll", "anim" }
	S.description = "Motion Matching Physical Blend: physical bones blended against the animated pose for the Motion Matching subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.motionmatching.physical_blend", blendSpeed = 2.30 })
		inst.system = S
		inst.ctx = ctx
