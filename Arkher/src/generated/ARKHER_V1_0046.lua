--!strict
-- DaVinci Pages — CORE Node_Flow #0046
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="DaVinci Pages — CORE Node_Flow #0046", size=Vector2.new(640, 440), pos=UDim2.fromOffset(298, 82), parent=parent, icon="⚙"})
