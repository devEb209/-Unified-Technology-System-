-- ARKHER SYSTEM E.0355 :: Snow Cover Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0355"
	S.key = "arkher.material.snowcover.quality_policy"
	S.name = "Snow Cover Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Snow Cover"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.snowcover.compression_codec" }
	S.tags = { "e", "snowcover", "policy", "material" }
	S.description = "Snow Cover Quality Policy: device tier rules for the surface for the Snow Cover subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.snowcover.quality_policy", algorithm = "wfq", starvationGuard = 42 })
		inst.system = S
		inst.ctx = ctx
