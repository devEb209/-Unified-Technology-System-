-- ARKHER SYSTEM VB.0414 :: Behaviour Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0414"
	S.key = "arkher.conttime.behaviourcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.behaviourcont.persistent_state" }
	S.tags = { "vb", "behaviourcont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.behaviourcont.coherence_guard", window = 60, threshold = 0.14 })
		inst.system = S
		inst.ctx = ctx
