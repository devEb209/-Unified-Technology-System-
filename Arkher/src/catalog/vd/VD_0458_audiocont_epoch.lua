-- ARKHER SYSTEM VD.0458 :: Audio Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0458"
	S.key = "arkher.contsim.audiocont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.audiocont.infinite_grid" }
	S.tags = { "vd", "audiocont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.audiocont.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
