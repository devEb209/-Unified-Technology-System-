-- ARKHER SYSTEM L.0567 :: World Event Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0567"
	S.key = "arkher.sim.worldevent.aggregate_cache"
	S.name = "World Event Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldevent.fidelity_policy" }
	S.tags = { "l", "worldevent", "cache", "sim" }
	S.description = "World Event Aggregate Cache: reuse of expensive aggregate computations for the World Event subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.worldevent.aggregate_cache", policy = "lfu", capacity = 261, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
