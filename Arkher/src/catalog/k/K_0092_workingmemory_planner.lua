-- ARKHER SYSTEM K.0092 :: Working Memory Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0092"
	S.key = "arkher.npc.workingmemory.goal_planner"
	S.name = "Working Memory Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workingmemory.utility_reasoning" }
	S.tags = { "k", "workingmemory", "planner", "npc" }
	S.description = "Working Memory Goal Planner: backward GOAP planning to reach a goal state for the Working Memory subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.workingmemory.goal_planner", maxDepth = 11 })
		inst.system = S
		inst.ctx = ctx
