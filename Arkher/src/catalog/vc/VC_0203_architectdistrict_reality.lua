-- ARKHER SYSTEM VC.0203 :: Architect District Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0203"
	S.key = "arkher.contneural.architectdistrict.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.architectdistrict.simulation_fabric" }
	S.tags = { "vc", "architectdistrict", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.architectdistrict.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
