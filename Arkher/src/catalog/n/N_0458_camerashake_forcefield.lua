-- ARKHER SYSTEM N.0458 :: Camera Shake Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0458"
	S.key = "arkher.vfx.camerashake.force_field"
	S.name = "Camera Shake Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Camera Shake"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.camerashake.particle_simulation" }
	S.tags = { "n", "camerashake", "forcefield", "vfx" }
	S.description = "Camera Shake Force Field: wind, attraction, vortex, drag and curl turbulence for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.camerashake.force_field", seed = 32792 })
		inst.system = S
		inst.ctx = ctx
