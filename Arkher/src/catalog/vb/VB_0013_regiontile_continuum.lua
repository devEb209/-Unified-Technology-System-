-- ARKHER SYSTEM VB.0013 :: Region Tile Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0013"
	S.key = "arkher.conttime.regiontile.infinite_grid"
	S.name = "Region Tile Infinite Grid"
	S.category = "VB"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "regiontile", "continuum", "conttime" }
	S.description = "Region Tile Infinite Grid: seamless paging of the infinite world grid for the Region Tile subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.regiontile.infinite_grid", cellSize = 128, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
