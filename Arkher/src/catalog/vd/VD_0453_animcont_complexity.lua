-- ARKHER SYSTEM VD.0453 :: Animation Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0453"
	S.key = "arkher.contsim.animcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.animcont.world_memory_stream" }
	S.tags = { "vd", "animcont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.animcont.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
