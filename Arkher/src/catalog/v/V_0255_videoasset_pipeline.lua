-- ARKHER SYSTEM V.0255 :: Video Asset Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0255"
	S.key = "arkher.asset.videoasset.cook_pipeline"
	S.name = "Video Asset Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.videoasset.bundling" }
	S.tags = { "v", "videoasset", "pipeline", "asset" }
	S.description = "Video Asset Cook Pipeline: staged cooking with isolation and retries for the Video Asset subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.videoasset.cook_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
