-- ARKHER SYSTEM VB.0077 :: LOD Cascade Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0077"
	S.key = "arkher.conttime.lodcascade.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lodcascade.multi-scale_fidelity" }
	S.tags = { "vb", "lodcascade", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.lodcascade.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
