-- ARKHER SYSTEM Z.0024 :: Predictive Optimization Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0024"
	S.key = "arkher.origin.predictiveopt.autonomous_pipeline"
	S.name = "Predictive Optimization Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.simulation_fabric" }
	S.tags = { "z", "predictiveopt", "autopipeline", "origin" }
	S.description = "Predictive Optimization Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.predictiveopt.autonomous_pipeline", maxIterations = 9 })
		inst.system = S
		inst.ctx = ctx
