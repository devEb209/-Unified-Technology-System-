-- ARKHER SYSTEM H.0240 :: Broadphase Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0240"
	S.key = "arkher.physics.broadphase.collision_shape"
	S.name = "Broadphase Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Broadphase"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.broadphase.body_dynamics" }
	S.tags = { "h", "broadphase", "collider", "physics" }
	S.description = "Broadphase Collision Shape: shape bounds, support mapping and closest points for the Broadphase subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.broadphase.collision_shape", shape = "sphere", radius = 0.70, height = 1.50, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
