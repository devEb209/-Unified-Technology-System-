-- ARKHER SYSTEM VA.0562 :: Device Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0562"
	S.key = "arkher.contworld.devicecont.simulation_fabric"
	S.name = "Device Continuum Simulation Fabric"
	S.category = "VA"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.devicecont.complexity_budget" }
	S.tags = { "va", "devicecont", "fabric", "contworld" }
	S.description = "Device Continuum Simulation Fabric: fabric stepping the continuum domains for the Device Continuum subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.devicecont.simulation_fabric", budgetMs = 2.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
