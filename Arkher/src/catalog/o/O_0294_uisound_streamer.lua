-- ARKHER SYSTEM O.0294 :: UI Sound Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0294"
	S.key = "arkher.audio.uisound.streaming"
	S.name = "UI Sound Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "UI Sound"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.uisound.voice_budget" }
	S.tags = { "o", "uisound", "streamer", "audio" }
	S.description = "UI Sound Streaming: distance-driven residency of audio assets for the UI Sound subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.uisound.streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
