-- ARKHER SYSTEM T.0594 :: Deployment Reasoning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0594"
	S.key = "arkher.ai.deploymentreasoning.reasoning_graph"
	S.name = "Deployment Reasoning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.deploymentreasoning.world_architect" }
	S.tags = { "t", "deploymentreasoning", "graph", "ai" }
	S.description = "Deployment Reasoning Reasoning Graph: relationship modelling and shortest-path reasoning for the Deployment Reasoning subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.deploymentreasoning.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
