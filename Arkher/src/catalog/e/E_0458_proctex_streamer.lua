-- ARKHER SYSTEM E.0458 :: Procedural Texture Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0458"
	S.key = "arkher.material.proctex.streaming"
	S.name = "Procedural Texture Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.proctex.parameter_budget" }
	S.tags = { "e", "proctex", "streamer", "material" }
	S.description = "Procedural Texture Streaming: residency and demand-driven texture streaming for the Procedural Texture subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.proctex.streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
