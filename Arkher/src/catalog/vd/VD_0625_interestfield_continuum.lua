-- ARKHER SYSTEM VD.0625 :: Interest Field Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0625"
	S.key = "arkher.contsim.interestfield.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "interestfield", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.interestfield.infinite_grid", cellSize = 192, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
