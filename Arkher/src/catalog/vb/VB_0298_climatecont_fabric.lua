-- ARKHER SYSTEM VB.0298 :: Climate Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0298"
	S.key = "arkher.conttime.climatecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.climatecont.complexity_budget" }
	S.tags = { "vb", "climatecont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.climatecont.simulation_fabric", budgetMs = 1.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
