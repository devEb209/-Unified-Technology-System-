-- ARKHER SYSTEM K.0673 :: NPC LOD Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0673"
	S.key = "arkher.npc.npclod.mind_network"
	S.name = "NPC LOD Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "npclod", "mindnet", "npc" }
	S.description = "NPC LOD Mind Network: the learned policy that turns perception into a decision for the NPC LOD subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.npclod.mind_network", inputs = 6, hidden = 5, seed = 8376, learningRate = 0.080, exploration = 0.020 })
		inst.system = S
		inst.ctx = ctx
