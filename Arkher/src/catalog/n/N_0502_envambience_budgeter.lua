-- ARKHER SYSTEM N.0502 :: Environment Ambience Spawn Budget
-- Category N - VFX
-- ARKHER VFX Framework capability: emission, simulation, forces and trails inside one shared budget.
-- Kit: budgeter (global particle budget shared by every live effect)
--@arkher-module
return function(A)
	...
	local S = {}
	S.id = "N.0502"
	S.key = "arkher.vfx.envambience.spawn_budget"
	S.name = "Environment Ambience Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Environment Ambience"
	S.aspect = "Spawn Budget"
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.envambience.effect_composition" }
	S.tags = { "n", "envambience", "budgeter", "vfx" }
	S.description = "Environment Ambience Spawn Budget: global particle budget shared by every live effect for the Environment Ambience subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.envambience.spawn_budget", total = 339, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
