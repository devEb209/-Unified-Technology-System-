-- ARKHER SYSTEM Z.1007 :: Capability Discovery World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.1007"
	S.key = "arkher.origin.capabilitydiscovery.world_architect"
	S.name = "Capability Discovery World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.emergence_detection" }
	S.tags = { "z", "capabilitydiscovery", "architect", "origin" }
	S.description = "Capability Discovery World Architect: hierarchical world composition with conserved budgets for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.capabilitydiscovery.world_architect", budget = 1200, seed = 73466 })
		inst.system = S
		inst.ctx = ctx
