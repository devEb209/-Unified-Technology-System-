-- ARKHER SYSTEM Z.0367 :: Mobile First Governor World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0367"
	S.key = "arkher.origin.mobilefirst.world_architect"
	S.name = "Mobile First Governor World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.emergence_detection" }
	S.tags = { "z", "mobilefirst", "architect", "origin" }
	S.description = "Mobile First Governor World Architect: hierarchical world composition with conserved budgets for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.mobilefirst.world_architect", budget = 700, seed = 96511 })
		inst.system = S
		inst.ctx = ctx
