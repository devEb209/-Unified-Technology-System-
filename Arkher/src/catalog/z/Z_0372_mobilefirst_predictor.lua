-- ARKHER SYSTEM Z.0372 :: Mobile First Governor Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0372"
	S.key = "arkher.origin.mobilefirst.predictive_optimization"
	S.name = "Mobile First Governor Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.adaptive_workflow" }
	S.tags = { "z", "mobilefirst", "predictor", "origin" }
	S.description = "Mobile First Governor Predictive Optimization: forecast-driven optimization before the cost is paid for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.mobilefirst.predictive_optimization", method = "ema", alpha = 0.42, window = 104 })
		inst.system = S
		inst.ctx = ctx
