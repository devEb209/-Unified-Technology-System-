-- ARKHER SYSTEM H.0269 :: Sphere Collider Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0269"
	S.key = "arkher.physics.spherecollider.contact_generation"
	S.name = "Sphere Collider Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.spherecollider.collision_shape" }
	S.tags = { "h", "spherecollider", "contact", "physics" }
	S.description = "Sphere Collider Contact Generation: narrow-phase manifolds with normal, depth and point for the Sphere Collider subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.spherecollider.contact_generation", slop = 0.0090, maxManifolds = 284 })
		inst.system = S
		inst.ctx = ctx
