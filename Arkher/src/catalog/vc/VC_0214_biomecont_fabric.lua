-- ARKHER SYSTEM VC.0214 :: Biome Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0214"
	S.key = "arkher.contneural.biomecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.biomecont.complexity_budget" }
	S.tags = { "vc", "biomecont", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.biomecont.simulation_fabric", budgetMs = 2.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
