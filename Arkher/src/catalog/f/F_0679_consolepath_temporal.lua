-- ARKHER SYSTEM F.0679 :: Console Path Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0679"
	S.key = "arkher.render.consolepath.temporal_resolve"
	S.name = "Console Path Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Console Path"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.consolepath.probe_volume" }
	S.tags = { "f", "consolepath", "temporal", "render" }
	S.description = "Console Path Temporal Resolve: history reprojection with neighbourhood clamping for the Console Path subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.consolepath.temporal_resolve", feedback = 0.84, phase = 8 })
		inst.system = S
		inst.ctx = ctx
