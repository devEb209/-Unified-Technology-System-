-- ARKHER SYSTEM H.0491 :: Slider Joint Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0491"
	S.key = "arkher.physics.sliderjoint.body_dynamics"
	S.name = "Slider Joint Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Slider Joint"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "sliderjoint", "rigidbody", "physics" }
	S.description = "Slider Joint Body Dynamics: integration, impulses, damping and sleeping of a body for the Slider Joint subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.sliderjoint.body_dynamics", mass = 11.00, radius = 0.80, restitution = 0.10, friction = 0.60, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
