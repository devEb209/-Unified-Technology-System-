-- ARKHER SYSTEM VB.0020 :: Region Tile World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0020"
	S.key = "arkher.conttime.regiontile.world_memory_stream"
	S.name = "Region Tile World Memory Stream"
	S.category = "VB"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.regiontile.neural_field" }
	S.tags = { "vb", "regiontile", "worldmemory", "conttime" }
	S.description = "Region Tile World Memory Stream: world memory continuum over epochs for the Region Tile subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.regiontile.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
