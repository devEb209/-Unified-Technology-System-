-- ARKHER SYSTEM VD.0235 :: City Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0235"
	S.key = "arkher.contsim.citycont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.citycont.coherence_guard" }
	S.tags = { "vd", "citycont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.citycont.neural_field", dims = 24, hidden = 20, seed = 92283 })
		inst.system = S
		inst.ctx = ctx
