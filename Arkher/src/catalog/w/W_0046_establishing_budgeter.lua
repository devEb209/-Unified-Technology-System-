-- ARKHER SYSTEM W.0046 :: Establishing Shot Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0046"
	S.key = "arkher.cine.establishing.frame_budget"
	S.name = "Establishing Shot Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.establishing.event_ledger" }
	S.tags = { "w", "establishing", "budgeter", "cine" }
	S.description = "Establishing Shot Frame Budget: per-frame cost budget for the cinematic systems for the Establishing Shot subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.establishing.frame_budget", total = 239, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
