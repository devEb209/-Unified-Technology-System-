-- ARKHER SYSTEM Z.1097 :: Original Tech Debug Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.1097"
	S.key = "arkher.origin.origindebug.behaviour_analysis"
	S.name = "Original Tech Debug Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.origindebug.governance_policy" }
	S.tags = { "z", "origindebug", "analyzer", "origin" }
	S.description = "Original Tech Debug Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Original Tech Debug subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.origindebug.behaviour_analysis", window = 184, buckets = 8, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
