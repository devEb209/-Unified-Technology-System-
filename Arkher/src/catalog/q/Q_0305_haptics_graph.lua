-- ARKHER SYSTEM Q.0305 :: Haptics Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0305"
	S.key = "arkher.ui.haptics.navigation_graph"
	S.name = "Haptics Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Haptics"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.haptics.transition" }
	S.tags = { "q", "haptics", "graph", "ui" }
	S.description = "Haptics Navigation Graph: screens, routes and shortest path between them for the Haptics subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.haptics.navigation_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
