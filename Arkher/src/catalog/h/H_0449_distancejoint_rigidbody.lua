-- ARKHER SYSTEM H.0449 :: Distance Joint Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0449"
	S.key = "arkher.physics.distancejoint.body_dynamics"
	S.name = "Distance Joint Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "distancejoint", "rigidbody", "physics" }
	S.description = "Distance Joint Body Dynamics: integration, impulses, damping and sleeping of a body for the Distance Joint subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.distancejoint.body_dynamics", mass = 10.00, radius = 0.75, restitution = 0.09, friction = 0.79, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
