-- ARKHER SYSTEM F.0230 :: Water Rendering Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0230"
	S.key = "arkher.render.water.probe_volume"
	S.name = "Water Rendering Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.water.lighting_rig" }
	S.tags = { "f", "water", "probe", "render" }
	S.description = "Water Rendering Probe Volume: irradiance probes encoded in spherical harmonics for the Water Rendering subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.water.probe_volume", spacing = 8 })
		inst.system = S
		inst.ctx = ctx
