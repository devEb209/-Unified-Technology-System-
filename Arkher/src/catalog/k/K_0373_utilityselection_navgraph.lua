-- ARKHER SYSTEM K.0373 :: Utility Selection Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0373"
	S.key = "arkher.npc.utilityselection.navigation"
	S.name = "Utility Selection Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.utilityselection.goal_planner" }
	S.tags = { "k", "utilityselection", "navgraph", "npc" }
	S.description = "Utility Selection Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Utility Selection subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.utilityselection.navigation", width = 24, height = 24, cellSize = 2 })
		inst.system = S
		inst.ctx = ctx
