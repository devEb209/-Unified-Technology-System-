-- ARKHER SYSTEM T.0006 :: Intent Parsing Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0006"
	S.key = "arkher.ai.intentparsing.reasoning_graph"
	S.name = "Intent Parsing Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.intentparsing.world_architect" }
	S.tags = { "t", "intentparsing", "graph", "ai" }
	S.description = "Intent Parsing Reasoning Graph: relationship modelling and shortest-path reasoning for the Intent Parsing subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.intentparsing.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
