-- ARKHER SYSTEM VA.0253 :: Road Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0253"
	S.key = "arkher.contworld.roadcont.infinite_grid"
	S.name = "Road Continuum Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "roadcont", "continuum", "contworld" }
	S.description = "Road Continuum Infinite Grid: seamless paging of the infinite world grid for the Road Continuum subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.roadcont.infinite_grid", cellSize = 224, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
