-- ARKHER SYSTEM VA.0069 :: Sparse Page Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0069"
	S.key = "arkher.contworld.sparsepage.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.sparsepage.world_memory_stream" }
	S.tags = { "va", "sparsepage", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.sparsepage.complexity_budget", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
