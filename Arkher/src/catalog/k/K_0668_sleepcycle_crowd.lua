-- ARKHER SYSTEM K.0668 :: Sleep Cycle Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0668"
	S.key = "arkher.npc.sleepcycle.crowd_steering"
	S.name = "Sleep Cycle Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.sleepcycle.navigation" }
	S.tags = { "k", "sleepcycle", "crowd", "npc" }
	S.description = "Sleep Cycle Crowd Steering: local avoidance, cohesion and arrival at scale for the Sleep Cycle subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.sleepcycle.crowd_steering", radius = 0.55, maxSpeed = 5.30, cellSize = 11 })
		inst.system = S
		inst.ctx = ctx
