-- ARKHER SYSTEM L.0408 :: Taxation Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0408"
	S.key = "arkher.sim.taxation.economy"
	S.name = "Taxation Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.taxation.ecology" }
	S.tags = { "l", "taxation", "economy", "sim" }
	S.description = "Taxation Economy: stock, production, demand, price discovery and trade for the Taxation subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.taxation.economy", elasticity = 0.22 })
		inst.system = S
		inst.ctx = ctx
