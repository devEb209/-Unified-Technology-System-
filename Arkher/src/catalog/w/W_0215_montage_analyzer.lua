-- ARKHER SYSTEM W.0215 :: Montage Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0215"
	S.key = "arkher.cine.montage.sequence_analysis"
	S.name = "Montage Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Montage"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.montage.frame_budget" }
	S.tags = { "w", "montage", "analyzer", "cine" }
	S.description = "Montage Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Montage subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.montage.sequence_analysis", window = 176, buckets = 16, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
