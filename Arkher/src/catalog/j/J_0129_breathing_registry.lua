-- ARKHER SYSTEM J.0129 :: Breathing Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0129"
	S.key = "arkher.character.breathing.variant_registry"
	S.name = "Breathing Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.breathing.appearance_composer" }
	S.tags = { "j", "breathing", "registry", "character" }
	S.description = "Breathing Variant Registry: named character variants and their lifecycle for the Breathing subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.breathing.variant_registry" })
		inst.system = S
		inst.ctx = ctx
