-- ARKHER SYSTEM E.0489 :: Material Variant Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0489"
	S.key = "arkher.material.variant.compression_codec"
	S.name = "Material Variant Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.variant.streaming" }
	S.tags = { "e", "variant", "codec", "material" }
	S.description = "Material Variant Compression Codec: serialization and compression of material data for the Material Variant subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.variant.compression_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
