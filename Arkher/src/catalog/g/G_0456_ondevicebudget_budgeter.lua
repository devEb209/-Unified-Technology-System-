-- ARKHER SYSTEM G.0456 :: On Device Budget Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0456"
	S.key = "arkher.neural.ondevicebudget.compute_budget"
	S.name = "On Device Budget Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ondevicebudget.quality_predictor" }
	S.tags = { "g", "ondevicebudget", "budgeter", "neural" }
	S.description = "On Device Budget Compute Budget: inference time budget allocation for the On Device Budget subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.ondevicebudget.compute_budget", total = 353, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
