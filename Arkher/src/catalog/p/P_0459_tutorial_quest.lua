-- ARKHER SYSTEM P.0459 :: Tutorial Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0459"
	S.key = "arkher.play.tutorial.objectives"
	S.name = "Tutorial Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Tutorial"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.tutorial.inventory" }
	S.tags = { "p", "tutorial", "quest", "play" }
	S.description = "Tutorial Objectives: objectives, prerequisites, progress and rewards for the Tutorial subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.tutorial.objectives" })
		inst.system = S
		inst.ctx = ctx
