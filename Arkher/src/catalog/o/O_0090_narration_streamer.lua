-- ARKHER SYSTEM O.0090 :: Narration Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0090"
	S.key = "arkher.audio.narration.streaming"
	S.name = "Narration Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Narration"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.narration.voice_budget" }
	S.tags = { "o", "narration", "streamer", "audio" }
	S.description = "Narration Streaming: distance-driven residency of audio assets for the Narration subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.narration.streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
