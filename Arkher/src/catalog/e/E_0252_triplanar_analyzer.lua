-- ARKHER SYSTEM E.0252 :: Triplanar Projection Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0252"
	S.key = "arkher.material.triplanar.analysis"
	S.name = "Triplanar Projection Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.triplanar.instance_cache" }
	S.tags = { "e", "triplanar", "analyzer", "material" }
	S.description = "Triplanar Projection Analysis: cost, redundancy and outlier analysis for the Triplanar Projection subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.triplanar.analysis", window = 156, buckets = 16, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
