-- ARKHER SYSTEM N.0017 :: Smoke Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0017"
	S.key = "arkher.vfx.smoke.ribbon_and_trail"
	S.name = "Smoke Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Smoke"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.smoke.force_field" }
	S.tags = { "n", "smoke", "ribbon", "vfx" }
	S.description = "Smoke Ribbon And Trail: trail points, tapering, beams and decimation for the Smoke subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.smoke.ribbon_and_trail", maxPoints = 32, lifetime = 2.10, minDistance = 0.40, width = 1.00 })
		inst.system = S
		inst.ctx = ctx
