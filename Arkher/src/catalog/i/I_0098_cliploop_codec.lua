-- ARKHER SYSTEM I.0098 :: Clip Looping Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0098"
	S.key = "arkher.anim.cliploop.compression_codec"
	S.name = "Clip Looping Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Looping"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.cliploop.retarget_graph" }
	S.tags = { "i", "cliploop", "codec", "anim" }
	S.description = "Clip Looping Compression Codec: curve compression and quantized transport for the Clip Looping subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.cliploop.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
