-- ARKHER SYSTEM I.0041 :: Pose Buffer Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0041"
	S.key = "arkher.anim.posebuffer.clip_sampling"
	S.name = "Pose Buffer Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Pose Buffer"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.posebuffer.skeleton" }
	S.tags = { "i", "posebuffer", "clip", "anim" }
	S.description = "Pose Buffer Clip Sampling: keyframe tracks sampled, retimed and evented for the Pose Buffer subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.posebuffer.clip_sampling", duration = 3.10, loop = true })
		inst.system = S
		inst.ctx = ctx
