-- ARKHER SYSTEM P.0230 :: Quest Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0230"
	S.key = "arkher.play.questsys.inventory"
	S.name = "Quest Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Quest"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.questsys.attributes" }
	S.tags = { "p", "questsys", "inventory", "play" }
	S.description = "Quest Inventory: slots, stacking, weight, equipment and crafting for the Quest subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.questsys.inventory", slots = 36, maxWeight = 100 })
		inst.system = S
		inst.ctx = ctx
