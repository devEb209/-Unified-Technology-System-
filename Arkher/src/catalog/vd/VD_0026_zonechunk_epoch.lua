-- ARKHER SYSTEM VD.0026 :: Zone Chunk Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0026"
	S.key = "arkher.contsim.zonechunk.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.zonechunk.infinite_grid" }
	S.tags = { "vd", "zonechunk", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.zonechunk.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
