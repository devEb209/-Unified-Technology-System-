-- ARKHER SYSTEM Z.0226 :: Emergent Society Framework Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0226"
	S.key = "arkher.origin.emergentsociety.emergence_detection"
	S.name = "Emergent Society Framework Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentsociety.world_memory" }
	S.tags = { "z", "emergentsociety", "emergence", "origin" }
	S.description = "Emergent Society Framework Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.emergentsociety.emergence_detection", windowSize = 7, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
