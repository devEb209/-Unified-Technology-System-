-- ARKHER SYSTEM VC.0409 :: Behaviour Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0409"
	S.key = "arkher.contneural.behaviourcont.infinite_grid"
	S.name = "Behaviour Continuum Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "behaviourcont", "continuum", "contneural" }
	S.description = "Behaviour Continuum Infinite Grid: seamless paging of the infinite world grid for the Behaviour Continuum subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.behaviourcont.infinite_grid", cellSize = 128, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
