-- ARKHER SYSTEM V.0393 :: Platform Variant Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0393"
	S.key = "arkher.asset.platformvariant.size_budget"
	S.name = "Platform Variant Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.platformvariant.compression_codec" }
	S.tags = { "v", "platformvariant", "budgeter", "asset" }
	S.description = "Platform Variant Size Budget: byte budget shared between competing asset classes for the Platform Variant subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.platformvariant.size_budget", total = 142, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
