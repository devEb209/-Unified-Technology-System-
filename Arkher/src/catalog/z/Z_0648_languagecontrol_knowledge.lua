-- ARKHER SYSTEM Z.0648 :: Natural Language Engine Control Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0648"
	S.key = "arkher.origin.languagecontrol.semantic_graph"
	S.name = "Natural Language Engine Control Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.languagecontrol.world_architect" }
	S.tags = { "z", "languagecontrol", "knowledge", "origin" }
	S.description = "Natural Language Engine Control Semantic Graph: typed entities and inferred relations of the technology itself for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.languagecontrol.semantic_graph", dims = 24 })
		inst.system = S
		inst.ctx = ctx
