-- ARKHER SYSTEM R.0333 :: Matchmaking Transport Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0333"
	S.key = "arkher.net.matchmakingtransport.session_registry"
	S.name = "Matchmaking Transport Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.matchmakingtransport.rate_guard" }
	S.tags = { "r", "matchmakingtransport", "registry", "net" }
	S.description = "Matchmaking Transport Session Registry: catalogue of sessions, players and their metadata for the Matchmaking Transport subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.matchmakingtransport.session_registry" })
		inst.system = S
		inst.ctx = ctx
