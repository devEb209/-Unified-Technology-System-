-- ARKHER SYSTEM T.0124 :: Long Term Memory Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0124"
	S.key = "arkher.ai.longtermmemory.model_inference"
	S.name = "Long Term Memory Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.longtermmemory.action_planner" }
	S.tags = { "t", "longtermmemory", "inference", "ai" }
	S.description = "Long Term Memory Model Inference: quantized inference with batching and budget for the Long Term Memory subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.longtermmemory.model_inference", seed = 17036 })
		inst.system = S
		inst.ctx = ctx
