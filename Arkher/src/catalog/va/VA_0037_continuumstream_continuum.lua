-- ARKHER SYSTEM VA.0037 :: Continuum Stream Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0037"
	S.key = "arkher.contworld.continuumstream.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "continuumstream", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.continuumstream.infinite_grid", cellSize = 96, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
