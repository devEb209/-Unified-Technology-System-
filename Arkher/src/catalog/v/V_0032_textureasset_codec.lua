-- ARKHER SYSTEM V.0032 :: Texture Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0032"
	S.key = "arkher.asset.textureasset.compression_codec"
	S.name = "Texture Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.textureasset.streaming_residency" }
	S.tags = { "v", "textureasset", "codec", "asset" }
	S.description = "Texture Compression Codec: compact encoding, diffing and checksum of asset payloads for the Texture subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.textureasset.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
