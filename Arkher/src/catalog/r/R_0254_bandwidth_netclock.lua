-- ARKHER SYSTEM R.0254 :: Bandwidth Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0254"
	S.key = "arkher.net.bandwidth.time_sync"
	S.name = "Bandwidth Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Bandwidth"
	S.aspect = "Time Sync"
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.bandwidth.replication" }
	S.tags = { "r", "bandwidth", "netclock", "net" }
	S.description = "Bandwidth Time Sync: offset estimation, outlier rejection and jitter buffering for the Bandwidth subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.bandwidth.time_sync", tickRate = 30, bufferDelay = 0.090, maxSamples = 9 })
		inst.system = S
		inst.ctx = ctx
