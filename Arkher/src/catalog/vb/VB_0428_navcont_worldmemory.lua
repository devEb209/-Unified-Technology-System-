-- ARKHER SYSTEM VB.0428 :: Navigation Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0428"
	S.key = "arkher.conttime.navcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.navcont.neural_field" }
	S.tags = { "vb", "navcont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.navcont.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
