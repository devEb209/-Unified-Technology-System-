-- ARKHER SYSTEM R.0281 :: Anti Cheat Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0281"
	S.key = "arkher.net.anticheat.bandwidth_budget"
	S.name = "Anti Cheat Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Anti Cheat"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.anticheat.transport_graph" }
	S.tags = { "r", "anticheat", "budgeter", "net" }
	S.description = "Anti Cheat Bandwidth Budget: bytes per second shared between competing streams for the Anti Cheat subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.anticheat.bandwidth_budget", total = 74, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
