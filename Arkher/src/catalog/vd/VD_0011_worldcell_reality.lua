-- ARKHER SYSTEM VD.0011 :: World Grid Cell Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0011"
	S.key = "arkher.contsim.worldcell.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldcell.simulation_fabric" }
	S.tags = { "vd", "worldcell", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.worldcell.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
