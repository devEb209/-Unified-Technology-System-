-- ARKHER SYSTEM VA.0408 :: Perception Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0408"
	S.key = "arkher.contworld.perceptioncont.emergence_continuum"
	S.name = "Perception Continuum Emergence Continuum"
	S.category = "VA"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.perceptioncont.reality_continuum" }
	S.tags = { "va", "perceptioncont", "emergence", "contworld" }
	S.description = "Perception Continuum Emergence Continuum: emergence detection over the continuum for the Perception Continuum subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.perceptioncont.emergence_continuum", windowSize = 4, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
