-- ARKHER SYSTEM K.0296 :: Attention Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0296"
	S.key = "arkher.npc.attention.memory"
	S.name = "Attention Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.attention.mind_network" }
	S.tags = { "k", "attention", "memory", "npc" }
	S.description = "Attention Memory: episodic memory with decay, recall and consolidation for the Attention subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.attention.memory", capacity = 44, decayRate = 0.050, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
