-- ARKHER SYSTEM L.0539 :: Disease Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0539"
	S.key = "arkher.sim.disease.forecast"
	S.name = "Disease Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.disease.analysis" }
	S.tags = { "l", "disease", "predictor", "sim" }
	S.description = "Disease Forecast: prediction of the region's next state for the Disease subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.disease.forecast", method = "ema", alpha = 0.23, window = 53 })
		inst.system = S
		inst.ctx = ctx
