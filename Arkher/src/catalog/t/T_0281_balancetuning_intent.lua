-- ARKHER SYSTEM T.0281 :: Balance Tuning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0281"
	S.key = "arkher.ai.balancetuning.intent_understanding"
	S.name = "Balance Tuning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "balancetuning", "intent", "ai" }
	S.description = "Balance Tuning Intent Understanding: natural language turned into an actionable, scored intent for the Balance Tuning subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.balancetuning.intent_understanding", minConfidence = 0.42 })
		inst.system = S
		inst.ctx = ctx
