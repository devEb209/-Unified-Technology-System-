-- ARKHER SYSTEM G.0212 :: Reflection Prediction Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0212"
	S.key = "arkher.neural.reflectpredict.feature_extraction"
	S.name = "Reflection Prediction Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.reflectpredict.inference_core" }
	S.tags = { "g", "reflectpredict", "field", "neural" }
	S.description = "Reflection Prediction Feature Extraction: signal features feeding the model for the Reflection Prediction subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.reflectpredict.feature_extraction", seed = 97836, frequency = 0.0130, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
