...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="RE ImGui — CORE Stack #0290", size=Vector2.new(680, 420), pos=UDim2.fromOffset(270, 330), parent=parent, icon="◤"})
