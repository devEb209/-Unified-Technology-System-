-- ARKHER SYSTEM VD.0120 :: Temporal Slice Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0120"
	S.key = "arkher.contsim.temporalslice.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.temporalslice.reality_continuum" }
	S.tags = { "vd", "temporalslice", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.temporalslice.emergence_continuum", windowSize = 6, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
