-- ARKHER SYSTEM R.0203 :: Client Prediction Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0203"
	S.key = "arkher.net.clientprediction.latency_analysis"
	S.name = "Client Prediction Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.clientprediction.audit_ledger" }
	S.tags = { "r", "clientprediction", "analyzer", "net" }
	S.description = "Client Prediction Latency Analysis: round trip, jitter and loss analysis for the Client Prediction subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.clientprediction.latency_analysis", window = 88, buckets = 8, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
