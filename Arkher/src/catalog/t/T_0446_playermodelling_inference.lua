-- ARKHER SYSTEM T.0446 :: Player Modelling Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0446"
	S.key = "arkher.ai.playermodelling.model_inference"
	S.name = "Player Modelling Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.playermodelling.action_planner" }
	S.tags = { "t", "playermodelling", "inference", "ai" }
	S.description = "Player Modelling Model Inference: quantized inference with batching and budget for the Player Modelling subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.playermodelling.model_inference", seed = 93661 })
		inst.system = S
		inst.ctx = ctx
