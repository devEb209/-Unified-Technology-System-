-- ARKHER SYSTEM G.0411 :: Drift Detection Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0411"
	S.key = "arkher.neural.drift.model_registry"
	S.name = "Drift Detection Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.drift.reconstruction" }
	S.tags = { "g", "drift", "registry", "neural" }
	S.description = "Drift Detection Model Registry: named models and their lifecycle for the Drift Detection subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.drift.model_registry" })
		inst.system = S
		inst.ctx = ctx
