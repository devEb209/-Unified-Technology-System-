-- ARKHER SYSTEM R.0174 :: Interpolation Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0174"
	S.key = "arkher.net.interpolation.serialization_codec"
	S.name = "Interpolation Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.interpolation.bandwidth_budget" }
	S.tags = { "r", "interpolation", "codec", "net" }
	S.description = "Interpolation Serialization Codec: compact encoding, diffing and checksum of payloads for the Interpolation subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.interpolation.serialization_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
