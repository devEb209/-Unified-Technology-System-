-- ARKHER SYSTEM W.0314 :: Colour Look Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0314"
	S.key = "arkher.cine.colourlook.camera_rig"
	S.name = "Colour Look Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Colour Look"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.colourlook.sequence_timeline" }
	S.tags = { "w", "colourlook", "camerarig", "cine" }
	S.description = "Colour Look Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Colour Look subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.colourlook.camera_rig", fov = 0.95, focus = 7.0, aperture = 3.9, smoothing = 11.0, distance = 9, height = 7 })
		inst.system = S
		inst.ctx = ctx
