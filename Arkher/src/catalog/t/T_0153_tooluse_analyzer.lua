-- ARKHER SYSTEM T.0153 :: Tool Use Learning Analysis
...
return function(A)
	...
	local S = {}
	S.id = "T.0153"
	S.key = "arkher.ai.tooluse.learning_analysis"
	S.name = "Tool Use Learning Analysis"
	S.category = "T"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.tooluse.model_inference" }
	S.tags = { "t", "tooluse", "analyzer", "ai" }
	S.description = "Tool Use Learning Analysis: trend, anomaly and improvement analysis of the agent for the Tool Use subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ai.tooluse.learning_analysis", window = 143, buckets = 15, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
