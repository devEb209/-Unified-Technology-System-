-- ARKHER SYSTEM VA.0058 :: Epoch Frame Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0058"
	S.key = "arkher.contworld.epochframe.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.epochframe.complexity_budget" }
	S.tags = { "va", "epochframe", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.epochframe.simulation_fabric", budgetMs = 2.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
