-- ARKHER SYSTEM VA.0235 :: City Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0235"
	S.key = "arkher.contworld.citycont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.citycont.coherence_guard" }
	S.tags = { "va", "citycont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.citycont.neural_field", dims = 16, hidden = 12, seed = 62821 })
		inst.system = S
		inst.ctx = ctx
