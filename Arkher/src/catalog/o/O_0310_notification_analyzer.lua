-- ARKHER SYSTEM O.0310 :: Notification Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0310"
	S.key = "arkher.audio.notification.analysis"
	S.name = "Notification Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Notification"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.notification.playback_policy" }
	S.tags = { "o", "notification", "analyzer", "audio" }
	S.description = "Notification Analysis: loudness, headroom and masking analysis for the Notification subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.notification.analysis", window = 114, buckets = 14, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
