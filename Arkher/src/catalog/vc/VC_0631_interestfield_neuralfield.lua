-- ARKHER SYSTEM VC.0631 :: Interest Field Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0631"
	S.key = "arkher.contneural.interestfield.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.interestfield.coherence_guard" }
	S.tags = { "vc", "interestfield", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.interestfield.neural_field", dims = 12, hidden = 8, seed = 18028 })
		inst.system = S
		inst.ctx = ctx
