-- ARKHER SYSTEM H.0579 :: Buoyancy Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0579"
	S.key = "arkher.physics.buoyancy.query"
	S.name = "Buoyancy Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Buoyancy"
	S.aspect = "Query"
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.buoyancy.constraint_solver" }
	S.tags = { "h", "buoyancy", "raycaster", "physics" }
	S.description = "Buoyancy Query: rays, sweeps and overlaps against the simulation for the Buoyancy subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.buoyancy.query", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
