-- ARKHER SYSTEM K.0029 :: Learning Loop Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0029"
	S.key = "arkher.npc.learningloop.mind_network"
	S.name = "Learning Loop Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "learningloop", "mindnet", "npc" }
	S.description = "Learning Loop Mind Network: the learned policy that turns perception into a decision for the Learning Loop subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.learningloop.mind_network", inputs = 6, hidden = 7, seed = 77868, learningRate = 0.090, exploration = 0.040 })
		inst.system = S
		inst.ctx = ctx
