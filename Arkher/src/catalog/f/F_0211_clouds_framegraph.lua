-- ARKHER SYSTEM F.0211 :: Cloud Rendering Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0211"
	S.key = "arkher.render.clouds.frame_graph"
	S.name = "Cloud Rendering Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "clouds", "framegraph", "render" }
	S.description = "Cloud Rendering Frame Graph: declared passes, culling, ordering and aliasing for the Cloud Rendering subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.clouds.frame_graph", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
