-- ARKHER SYSTEM E.0403 :: Texture Atlas Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0403"
	S.key = "arkher.material.atlas.authoring_pipeline"
	S.name = "Texture Atlas Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.atlas.analysis" }
	S.tags = { "e", "atlas", "pipeline", "material" }
	S.description = "Texture Atlas Authoring Pipeline: ordered authoring and bake stages for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.atlas.authoring_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
