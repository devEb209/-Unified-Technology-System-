-- ARKHER SYSTEM Q.0202 :: Minimap Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0202"
	S.key = "arkher.ui.minimap.frame_budget"
	S.name = "Minimap Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Minimap"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.minimap.accessibility_policy" }
	S.tags = { "q", "minimap", "budgeter", "ui" }
	S.description = "Minimap Frame Budget: per-frame layout and draw budget for the interface for the Minimap subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.minimap.frame_budget", total = 242, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
