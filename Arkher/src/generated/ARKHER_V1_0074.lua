--!strict
-- UE5/6 Nanite — CORE Profiler #0074
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="UE5/6 Nanite — CORE Profiler #0074", size=Vector2.new(680, 500), pos=UDim2.fromOffset(262, 298), parent=parent, icon="⬢"})
