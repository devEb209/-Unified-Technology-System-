-- ARKHER SYSTEM G.0048 :: Frame Interpolation Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0048"
	S.key = "arkher.neural.frameinterp.weight_codec"
	S.name = "Frame Interpolation Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.frameinterp.model_registry" }
	S.tags = { "g", "frameinterp", "codec", "neural" }
	S.description = "Frame Interpolation Weight Codec: weight serialization and quantized transport for the Frame Interpolation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.frameinterp.weight_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
