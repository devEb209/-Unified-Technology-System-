-- ARKHER SYSTEM O.0148 :: Water Audio Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0148"
	S.key = "arkher.audio.wateraudio.music_sequencer"
	S.name = "Water Audio Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Water Audio"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.wateraudio.spatialization" }
	S.tags = { "o", "wateraudio", "sequencer", "audio" }
	S.description = "Water Audio Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Water Audio subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.wateraudio.music_sequencer", bpm = 150, beatsPerBar = 4, intensity = 0.44 })
		inst.system = S
		inst.ctx = ctx
