-- ARKHER SYSTEM L.0130 :: Village Life Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0130"
	S.key = "arkher.sim.villagelife.streaming"
	S.name = "Village Life Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.villagelife.state_codec" }
	S.tags = { "l", "villagelife", "streamer", "sim" }
	S.description = "Village Life Streaming: distance-driven residency of simulated regions for the Village Life subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.villagelife.streaming", radius = 280, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
