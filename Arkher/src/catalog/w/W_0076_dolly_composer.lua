-- ARKHER SYSTEM W.0076 :: Dolly Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0076"
	S.key = "arkher.cine.dolly.shot_composition"
	S.name = "Dolly Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dolly"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dolly.colour_grade" }
	S.tags = { "w", "dolly", "composer", "cine" }
	S.description = "Dolly Shot Composition: blending of the signals that make up the final shot for the Dolly subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.dolly.shot_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
