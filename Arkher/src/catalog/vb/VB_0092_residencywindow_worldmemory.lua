-- ARKHER SYSTEM VB.0092 :: Residency Window World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0092"
	S.key = "arkher.conttime.residencywindow.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.residencywindow.neural_field" }
	S.tags = { "vb", "residencywindow", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.residencywindow.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
