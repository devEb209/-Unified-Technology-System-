-- ARKHER SYSTEM Z.0508 :: Economic Emergence Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0508"
	S.key = "arkher.origin.economicemergence.semantic_graph"
	S.name = "Economic Emergence Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.economicemergence.world_architect" }
	S.tags = { "z", "economicemergence", "knowledge", "origin" }
	S.description = "Economic Emergence Semantic Graph: typed entities and inferred relations of the technology itself for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.economicemergence.semantic_graph", dims = 32 })
		inst.system = S
		inst.ctx = ctx
