-- ARKHER SYSTEM V.0063 :: Shader Asset Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0063"
	S.key = "arkher.asset.shaderasset.cook_pipeline"
	S.name = "Shader Asset Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.shaderasset.bundling" }
	S.tags = { "v", "shaderasset", "pipeline", "asset" }
	S.description = "Shader Asset Cook Pipeline: staged cooking with isolation and retries for the Shader Asset subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.shaderasset.cook_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
