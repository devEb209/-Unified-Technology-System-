-- ARKHER SYSTEM R.0251 :: Area Of Interest Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0251"
	S.key = "arkher.net.areaofinterest.latency_analysis"
	S.name = "Area Of Interest Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.areaofinterest.audit_ledger" }
	S.tags = { "r", "areaofinterest", "analyzer", "net" }
	S.description = "Area Of Interest Latency Analysis: round trip, jitter and loss analysis for the Area Of Interest subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.areaofinterest.latency_analysis", window = 157, buckets = 9, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
