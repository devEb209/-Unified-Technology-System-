-- ARKHER SYSTEM VC.0471 :: VFX Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0471"
	S.key = "arkher.contneural.vfxcont.sparse_residency"
	S.name = "VFX Continuum Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vfxcont.epoch_clock" }
	S.tags = { "vc", "vfxcont", "sparse", "contneural" }
	S.description = "VFX Continuum Sparse Residency: sparse page residency with eviction and compression for the VFX Continuum subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.vfxcont.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
