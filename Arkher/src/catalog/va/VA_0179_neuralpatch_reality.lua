-- ARKHER SYSTEM VA.0179 :: Neural Patch Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0179"
	S.key = "arkher.contworld.neuralpatch.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.neuralpatch.simulation_fabric" }
	S.tags = { "va", "neuralpatch", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.neuralpatch.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
