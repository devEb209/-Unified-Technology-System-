-- ARKHER SYSTEM VD.0065 :: Sparse Page Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0065"
	S.key = "arkher.contsim.sparsepage.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.sparsepage.multi-scale_fidelity" }
	S.tags = { "vd", "sparsepage", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.sparsepage.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
