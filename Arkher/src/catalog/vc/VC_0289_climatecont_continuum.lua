-- ARKHER SYSTEM VC.0289 :: Climate Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0289"
	S.key = "arkher.contneural.climatecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "climatecont", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.climatecont.infinite_grid", cellSize = 96, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
