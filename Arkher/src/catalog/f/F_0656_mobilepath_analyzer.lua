-- ARKHER SYSTEM F.0656 :: Mobile Fast Path Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0656"
	S.key = "arkher.render.mobilepath.frame_analysis"
	S.name = "Mobile Fast Path Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.mobilepath.pass_cache" }
	S.tags = { "f", "mobilepath", "analyzer", "render" }
	S.description = "Mobile Fast Path Frame Analysis: per-pass cost analysis and outlier detection for the Mobile Fast Path subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.mobilepath.frame_analysis", window = 178, buckets = 14, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
