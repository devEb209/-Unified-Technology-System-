-- ARKHER SYSTEM H.0681 :: Shapecast Query Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0681"
	S.key = "arkher.physics.shapecast.budget_governor"
	S.name = "Shapecast Query Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.shapecast.broadphase_index" }
	S.tags = { "h", "shapecast", "budgeter", "physics" }
	S.description = "Shapecast Query Budget Governor: simulation time budget allocation across islands for the Shapecast Query subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.shapecast.budget_governor", total = 144, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
