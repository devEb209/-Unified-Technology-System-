-- ARKHER SYSTEM R.0229 :: Interest Management Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0229"
	S.key = "arkher.net.interestmanagement.replication"
	S.name = "Interest Management Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "interestmanagement", "replicator", "net" }
	S.description = "Interest Management Replication: authoritative entity state, interest and delta snapshots for the Interest Management subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.interestmanagement.replication", mtu = 1050, interestRadius = 400, fullEvery = 105 })
		inst.system = S
		inst.ctx = ctx
