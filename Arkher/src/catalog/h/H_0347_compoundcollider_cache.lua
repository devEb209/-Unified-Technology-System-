-- ARKHER SYSTEM H.0347 :: Compound Collider Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0347"
	S.key = "arkher.physics.compoundcollider.result_cache"
	S.name = "Compound Collider Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.compoundcollider.simulation_policy" }
	S.tags = { "h", "compoundcollider", "cache", "physics" }
	S.description = "Compound Collider Result Cache: reuse of expensive simulation and query results for the Compound Collider subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.compoundcollider.result_cache", policy = "lru", capacity = 123, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
