-- ARKHER SYSTEM VC.0127 :: Spatial Slice Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0127"
	S.key = "arkher.contneural.spatialslice.neural_field"
	S.name = "Spatial Slice Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.spatialslice.coherence_guard" }
	S.tags = { "vc", "spatialslice", "neuralfield", "contneural" }
	S.description = "Spatial Slice Neural Field: neural field encoding and reconstruction for the Spatial Slice subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.spatialslice.neural_field", dims = 12, hidden = 8, seed = 75156 })
		inst.system = S
		inst.ctx = ctx
