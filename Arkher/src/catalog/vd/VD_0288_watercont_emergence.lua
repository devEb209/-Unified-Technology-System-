-- ARKHER SYSTEM VD.0288 :: Water Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0288"
	S.key = "arkher.contsim.watercont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.watercont.reality_continuum" }
	S.tags = { "vd", "watercont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.watercont.emergence_continuum", windowSize = 4, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
