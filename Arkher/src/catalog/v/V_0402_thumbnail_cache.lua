-- ARKHER SYSTEM V.0402 :: Thumbnail Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0402"
	S.key = "arkher.asset.thumbnail.content_cache"
	S.name = "Thumbnail Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.thumbnail.dependency_graph" }
	S.tags = { "v", "thumbnail", "cache", "asset" }
	S.description = "Thumbnail Content Cache: reuse of already cooked results for the Thumbnail subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.thumbnail.content_cache", policy = "lfu", capacity = 416, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
