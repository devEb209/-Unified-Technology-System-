-- ARKHER SYSTEM Z.1036 :: Autonomous Balancing Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.1036"
	S.key = "arkher.origin.autobalancing.governance_policy"
	S.name = "Autonomous Balancing Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autobalancing.signal_composition" }
	S.tags = { "z", "autobalancing", "policy", "origin" }
	S.description = "Autonomous Balancing Governance Policy: ordered rules governing when the technology may act for the Autonomous Balancing subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.autobalancing.governance_policy", algorithm = "edf", starvationGuard = 45 })
		inst.system = S
		inst.ctx = ctx
