-- ARKHER SYSTEM I.0492 :: Morph Target Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0492"
	S.key = "arkher.anim.morphtarget.quality_policy"
	S.name = "Morph Target Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Morph Target"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.morphtarget.pose_cache" }
	S.tags = { "i", "morphtarget", "policy", "anim" }
	S.description = "Morph Target Quality Policy: device tier rules for rate, bones and solvers for the Morph Target subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.morphtarget.quality_policy", algorithm = "roundrobin", starvationGuard = 16 })
		inst.system = S
		inst.ctx = ctx
