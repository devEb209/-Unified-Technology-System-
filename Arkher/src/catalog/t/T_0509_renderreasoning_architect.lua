-- ARKHER SYSTEM T.0509 :: Render Reasoning World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0509"
	S.key = "arkher.ai.renderreasoning.world_architect"
	S.name = "Render Reasoning World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.renderreasoning.self_critique" }
	S.tags = { "t", "renderreasoning", "architect", "ai" }
	S.description = "Render Reasoning World Architect: composition of a whole world plan with conserved budgets for the Render Reasoning subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.renderreasoning.world_architect", budget = 1100, seed = 7165 })
		inst.system = S
		inst.ctx = ctx
