...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Google Maps — CORE Map #0038", size=Vector2.new(680, 480), pos=UDim2.fromOffset(194, 206), parent=parent, icon="✎"})
