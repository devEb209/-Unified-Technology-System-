-- ARKHER SYSTEM F.0596 :: Wireframe Overlay Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0596"
	S.key = "arkher.render.wireframe.adaptive_resolution"
	S.name = "Wireframe Overlay Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.wireframe.temporal_resolve" }
	S.tags = { "f", "wireframe", "upscaler", "render" }
	S.description = "Wireframe Overlay Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Wireframe Overlay subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.wireframe.adaptive_resolution", targetMs = 13.10, index = 5, sharpness = 0.54 })
		inst.system = S
		inst.ctx = ctx
