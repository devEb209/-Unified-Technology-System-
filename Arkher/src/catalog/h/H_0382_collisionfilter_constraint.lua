-- ARKHER SYSTEM H.0382 :: Collision Filter Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0382"
	S.key = "arkher.physics.collisionfilter.constraint_solver"
	S.name = "Collision Filter Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionfilter.contact_generation" }
	S.tags = { "h", "collisionfilter", "constraint", "physics" }
	S.description = "Collision Filter Constraint Solver: sequential impulses, friction, joints and warm starting for the Collision Filter subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.collisionfilter.constraint_solver", iterations = 10, baumgarte = 0.26, warmStart = true })
		inst.system = S
		inst.ctx = ctx
