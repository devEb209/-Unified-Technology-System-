-- ARKHER SYSTEM VC.0146 :: Persistence Segment Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0146"
	S.key = "arkher.contneural.persistsegment.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.persistsegment.infinite_grid" }
	S.tags = { "vc", "persistsegment", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.persistsegment.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
