-- ARKHER SYSTEM V.0054 :: Material Asset Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0054"
	S.key = "arkher.asset.materialasset.content_cache"
	S.name = "Material Asset Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.materialasset.dependency_graph" }
	S.tags = { "v", "materialasset", "cache", "asset" }
	S.description = "Material Asset Content Cache: reuse of already cooked results for the Material Asset subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.materialasset.content_cache", policy = "lfu", capacity = 248, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
