-- ARKHER SYSTEM Z.0180 :: Self Analyzing Project Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0180"
	S.key = "arkher.origin.selfanalyzing.orchestration"
	S.name = "Self Analyzing Project Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.residency_streaming" }
	S.tags = { "z", "selfanalyzing", "orchestrator", "origin" }
	S.description = "Self Analyzing Project Orchestration: lifecycle and phase orchestration of the technology for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.selfanalyzing.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
