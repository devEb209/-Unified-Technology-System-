-- ARKHER SYSTEM K.0547 :: Trade Behaviour Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0547"
	S.key = "arkher.npc.tradebehaviour.mind_network"
	S.name = "Trade Behaviour Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "tradebehaviour", "mindnet", "npc" }
	S.description = "Trade Behaviour Mind Network: the learned policy that turns perception into a decision for the Trade Behaviour subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.tradebehaviour.mind_network", inputs = 9, hidden = 6, seed = 43647, learningRate = 0.085, exploration = 0.055 })
		inst.system = S
		inst.ctx = ctx
