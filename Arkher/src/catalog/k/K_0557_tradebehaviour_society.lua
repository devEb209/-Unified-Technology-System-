-- ARKHER SYSTEM K.0557 :: Trade Behaviour Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0557"
	S.key = "arkher.npc.tradebehaviour.social_relations"
	S.name = "Trade Behaviour Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.tradebehaviour.crowd_steering" }
	S.tags = { "k", "tradebehaviour", "society", "npc" }
	S.description = "Trade Behaviour Social Relations: affinity, factions, reputation and gossip for the Trade Behaviour subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.tradebehaviour.social_relations", decayRate = 0.012, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
