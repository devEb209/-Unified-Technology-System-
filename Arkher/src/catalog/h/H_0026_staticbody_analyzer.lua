-- ARKHER SYSTEM H.0026 :: Static Body Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0026"
	S.key = "arkher.physics.staticbody.analysis"
	S.name = "Static Body Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Static Body"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.staticbody.result_cache" }
	S.tags = { "h", "staticbody", "analyzer", "physics" }
	S.description = "Static Body Analysis: energy, jitter and cost analysis of the simulation for the Static Body subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.staticbody.analysis", window = 100, buckets = 16, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
