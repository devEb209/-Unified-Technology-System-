-- ARKHER SYSTEM Z.0667 :: Auto Documentation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0667"
	S.key = "arkher.origin.autodocumentation.world_architect"
	S.name = "Auto Documentation World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.emergence_detection" }
	S.tags = { "z", "autodocumentation", "architect", "origin" }
	S.description = "Auto Documentation World Architect: hierarchical world composition with conserved budgets for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.autodocumentation.world_architect", budget = 1200, seed = 22526 })
		inst.system = S
		inst.ctx = ctx
