-- ARKHER SYSTEM Z.0022 :: Predictive Optimization Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0022"
	S.key = "arkher.origin.predictiveopt.complexity_governance"
	S.name = "Predictive Optimization Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.reality_layering" }
	S.tags = { "z", "predictiveopt", "complexity", "origin" }
	S.description = "Predictive Optimization Complexity Governance: measured scene cost turned into per-subsystem directives for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.predictiveopt.complexity_governance", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
