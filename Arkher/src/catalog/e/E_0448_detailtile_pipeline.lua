-- ARKHER SYSTEM E.0448 :: Detail Tiling Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0448"
	S.key = "arkher.material.detailtile.authoring_pipeline"
	S.name = "Detail Tiling Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.detailtile.analysis" }
	S.tags = { "e", "detailtile", "pipeline", "material" }
	S.description = "Detail Tiling Authoring Pipeline: ordered authoring and bake stages for the Detail Tiling subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.detailtile.authoring_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
