-- ARKHER SYSTEM I.0347 :: Physical Animation Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0347"
	S.key = "arkher.anim.physanim.playback_pipeline"
	S.name = "Physical Animation Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.physanim.event_ledger" }
	S.tags = { "i", "physanim", "pipeline", "anim" }
	S.description = "Physical Animation Playback Pipeline: ordered sample, blend, ik and output stages for the Physical Animation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.physanim.playback_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
