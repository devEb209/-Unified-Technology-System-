-- ARKHER SYSTEM N.0095 :: Muzzle Flash Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0095"
	S.key = "arkher.vfx.muzzleflash.ribbon_and_trail"
	S.name = "Muzzle Flash Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Muzzle Flash"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.muzzleflash.force_field" }
	S.tags = { "n", "muzzleflash", "ribbon", "vfx" }
	S.description = "Muzzle Flash Ribbon And Trail: trail points, tapering, beams and decimation for the Muzzle Flash subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.muzzleflash.ribbon_and_trail", maxPoints = 32, lifetime = 0.70, minDistance = 0.20, width = 0.40 })
		inst.system = S
		inst.ctx = ctx
