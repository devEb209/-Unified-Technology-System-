-- ARKHER SYSTEM E.0377 :: Terrain Splat Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0377"
	S.key = "arkher.material.splat.layer_composition"
	S.name = "Terrain Splat Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.splat.definition" }
	S.tags = { "e", "splat", "composer", "material" }
	S.description = "Terrain Splat Layer Composition: ordered layer composition with blend rules for the Terrain Splat subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.splat.layer_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
