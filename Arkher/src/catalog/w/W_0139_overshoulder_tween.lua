-- ARKHER SYSTEM W.0139 :: Over The Shoulder Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0139"
	S.key = "arkher.cine.overshoulder.motion_tween"
	S.name = "Over The Shoulder Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.overshoulder.playback_orchestrator" }
	S.tags = { "w", "overshoulder", "tween", "cine" }
	S.description = "Over The Shoulder Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Over The Shoulder subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.overshoulder.motion_tween", timeScale = 1.06 })
		inst.system = S
		inst.ctx = ctx
