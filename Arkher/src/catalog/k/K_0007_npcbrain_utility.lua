-- ARKHER SYSTEM K.0007 :: NPC Brain Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0007"
	S.key = "arkher.npc.npcbrain.utility_reasoning"
	S.name = "NPC Brain Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcbrain.reactive_behaviour" }
	S.tags = { "k", "npcbrain", "utility", "npc" }
	S.description = "NPC Brain Utility Reasoning: scored option selection with response curves for the NPC Brain subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.npcbrain.utility_reasoning", momentum = 0.02 })
		inst.system = S
		inst.ctx = ctx
