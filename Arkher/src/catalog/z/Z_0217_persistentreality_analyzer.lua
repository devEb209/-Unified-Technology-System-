-- ARKHER SYSTEM Z.0217 :: Persistent Reality State Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0217"
	S.key = "arkher.origin.persistentreality.behaviour_analysis"
	S.name = "Persistent Reality State Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.governance_policy" }
	S.tags = { "z", "persistentreality", "analyzer", "origin" }
	S.description = "Persistent Reality State Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.persistentreality.behaviour_analysis", window = 86, buckets = 14, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
