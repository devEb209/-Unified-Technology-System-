-- ARKHER SYSTEM H.0281 :: Box Collider Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0281"
	S.key = "arkher.physics.boxcollider.body_dynamics"
	S.name = "Box Collider Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Box Collider"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "boxcollider", "rigidbody", "physics" }
	S.description = "Box Collider Body Dynamics: integration, impulses, damping and sleeping of a body for the Box Collider subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.boxcollider.body_dynamics", mass = 20.00, radius = 1.25, restitution = 0.59, friction = 0.59, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
