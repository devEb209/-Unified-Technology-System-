-- ARKHER SYSTEM VA.0027 :: Zone Chunk Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0027"
	S.key = "arkher.contworld.zonechunk.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.zonechunk.epoch_clock" }
	S.tags = { "va", "zonechunk", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.zonechunk.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
