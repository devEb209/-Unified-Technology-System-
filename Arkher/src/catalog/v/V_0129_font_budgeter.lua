-- ARKHER SYSTEM V.0129 :: Font Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0129"
	S.key = "arkher.asset.font.size_budget"
	S.name = "Font Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.font.compression_codec" }
	S.tags = { "v", "font", "budgeter", "asset" }
	S.description = "Font Size Budget: byte budget shared between competing asset classes for the Font subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.font.size_budget", total = 356, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
