-- ARKHER SYSTEM J.0294 :: Character LOD Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0294"
	S.key = "arkher.character.characterlod.variant_registry"
	S.name = "Character LOD Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterlod.appearance_composer" }
	S.tags = { "j", "characterlod", "registry", "character" }
	S.description = "Character LOD Variant Registry: named character variants and their lifecycle for the Character LOD subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.characterlod.variant_registry" })
		inst.system = S
		inst.ctx = ctx
