-- ARKHER SYSTEM T.0668 :: Multi Agent Coordination Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0668"
	S.key = "arkher.ai.multiagent.utility_selection"
	S.name = "Multi Agent Coordination Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.multiagent.working_memory" }
	S.tags = { "t", "multiagent", "utility", "ai" }
	S.description = "Multi Agent Coordination Utility Selection: scored choice between competing courses of action for the Multi Agent Coordination subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.multiagent.utility_selection", momentum = 0.02 })
		inst.system = S
		inst.ctx = ctx
