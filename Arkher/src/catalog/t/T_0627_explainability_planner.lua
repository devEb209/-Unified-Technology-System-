-- ARKHER SYSTEM T.0627 :: Explainability Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0627"
	S.key = "arkher.ai.explainability.action_planner"
	S.name = "Explainability Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.explainability.utility_selection" }
	S.tags = { "t", "explainability", "planner", "ai" }
	S.description = "Explainability Action Planner: goal-oriented action planning over preconditions for the Explainability subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.explainability.action_planner", maxDepth = 9 })
		inst.system = S
		inst.ctx = ctx
