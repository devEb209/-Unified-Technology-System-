-- ARKHER SYSTEM T.0690 :: AI Debug Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0690"
	S.key = "arkher.ai.aidebug.self_critique"
	S.name = "AI Debug Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.aidebug.plan_workflow" }
	S.tags = { "t", "aidebug", "critic", "ai" }
	S.description = "AI Debug Self Critique: weighted evaluation of the result against declared criteria for the AI Debug subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.aidebug.self_critique", passMark = 0.70, reviseMark = 0.40, seed = 48360 })
		inst.system = S
		inst.ctx = ctx
