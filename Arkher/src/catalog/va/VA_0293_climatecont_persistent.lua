-- ARKHER SYSTEM VA.0293 :: Climate Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0293"
	S.key = "arkher.contworld.climatecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.climatecont.multi-scale_fidelity" }
	S.tags = { "va", "climatecont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.climatecont.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
