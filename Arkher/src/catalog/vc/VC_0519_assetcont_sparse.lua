-- ARKHER SYSTEM VC.0519 :: Asset Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0519"
	S.key = "arkher.contneural.assetcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.assetcont.epoch_clock" }
	S.tags = { "vc", "assetcont", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.assetcont.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
