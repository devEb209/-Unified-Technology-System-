-- ARKHER SYSTEM E.0487 :: Material Variant Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0487"
	S.key = "arkher.material.variant.parameter_budget"
	S.name = "Material Variant Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.variant.variant_registry" }
	S.tags = { "e", "variant", "budgeter", "material" }
	S.description = "Material Variant Parameter Budget: texel and layer budget allocation for the Material Variant subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.variant.parameter_budget", total = 177, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
