-- ARKHER SYSTEM F.0397 :: Draw Call Batching Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0397"
	S.key = "arkher.render.batching.lighting_rig"
	S.name = "Draw Call Batching Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.batching.geometry_virtualization" }
	S.tags = { "f", "batching", "lightrig", "render" }
	S.description = "Draw Call Batching Lighting Rig: light clustering, importance and cascades for the Draw Call Batching subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.batching.lighting_rig", maxActive = 10 })
		inst.system = S
		inst.ctx = ctx
