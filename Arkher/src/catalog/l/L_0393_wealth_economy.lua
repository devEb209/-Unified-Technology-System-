-- ARKHER SYSTEM L.0393 :: Wealth Distribution Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0393"
	S.key = "arkher.sim.wealth.economy"
	S.name = "Wealth Distribution Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wealth.ecology" }
	S.tags = { "l", "wealth", "economy", "sim" }
	S.description = "Wealth Distribution Economy: stock, production, demand, price discovery and trade for the Wealth Distribution subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.wealth.economy", elasticity = 0.20 })
		inst.system = S
		inst.ctx = ctx
