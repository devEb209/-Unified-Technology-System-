-- ARKHER SYSTEM G.0179 :: Shading Approximation Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0179"
	S.key = "arkher.neural.shadingapprox.error_analysis"
	S.name = "Shading Approximation Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.shadingapprox.heuristic_policy" }
	S.tags = { "g", "shadingapprox", "analyzer", "neural" }
	S.description = "Shading Approximation Error Analysis: residual and drift analysis for the Shading Approximation subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.shadingapprox.error_analysis", window = 213, buckets = 9, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
