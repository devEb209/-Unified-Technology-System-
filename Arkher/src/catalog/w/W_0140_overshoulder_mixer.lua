-- ARKHER SYSTEM W.0140 :: Over The Shoulder Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0140"
	S.key = "arkher.cine.overshoulder.cinematic_mix"
	S.name = "Over The Shoulder Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.overshoulder.motion_tween" }
	S.tags = { "w", "overshoulder", "mixer", "cine" }
	S.description = "Over The Shoulder Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Over The Shoulder subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.overshoulder.cinematic_mix", maxVoices = 48 })
		inst.system = S
		inst.ctx = ctx
