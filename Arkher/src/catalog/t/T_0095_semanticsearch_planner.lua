-- ARKHER SYSTEM T.0095 :: Semantic Search Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0095"
	S.key = "arkher.ai.semanticsearch.action_planner"
	S.name = "Semantic Search Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.semanticsearch.utility_selection" }
	S.tags = { "t", "semanticsearch", "planner", "ai" }
	S.description = "Semantic Search Action Planner: goal-oriented action planning over preconditions for the Semantic Search subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.semanticsearch.action_planner", maxDepth = 11 })
		inst.system = S
		inst.ctx = ctx
