-- ARKHER SYSTEM VB.0213 :: Biome Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0213"
	S.key = "arkher.conttime.biomecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.biomecont.world_memory_stream" }
	S.tags = { "vb", "biomecont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.biomecont.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
