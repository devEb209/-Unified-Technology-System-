-- ARKHER SYSTEM E.0538 :: Material LOD Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0538"
	S.key = "arkher.material.materiallod.authoring_pipeline"
	S.name = "Material LOD Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Material LOD"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.materiallod.analysis" }
	S.tags = { "e", "materiallod", "pipeline", "material" }
	S.description = "Material LOD Authoring Pipeline: ordered authoring and bake stages for the Material LOD subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.materiallod.authoring_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
