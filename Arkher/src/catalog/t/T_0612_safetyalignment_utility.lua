-- ARKHER SYSTEM T.0612 :: Safety Alignment Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0612"
	S.key = "arkher.ai.safetyalignment.utility_selection"
	S.name = "Safety Alignment Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.safetyalignment.working_memory" }
	S.tags = { "t", "safetyalignment", "utility", "ai" }
	S.description = "Safety Alignment Utility Selection: scored choice between competing courses of action for the Safety Alignment subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.safetyalignment.utility_selection", momentum = 0.03 })
		inst.system = S
		inst.ctx = ctx
