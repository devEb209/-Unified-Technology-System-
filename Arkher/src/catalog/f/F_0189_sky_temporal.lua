-- ARKHER SYSTEM F.0189 :: Sky Model Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0189"
	S.key = "arkher.render.sky.temporal_resolve"
	S.name = "Sky Model Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sky Model"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sky.probe_volume" }
	S.tags = { "f", "sky", "temporal", "render" }
	S.description = "Sky Model Temporal Resolve: history reprojection with neighbourhood clamping for the Sky Model subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.sky.temporal_resolve", feedback = 0.82, phase = 8 })
		inst.system = S
		inst.ctx = ctx
