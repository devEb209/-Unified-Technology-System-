-- ARKHER SYSTEM VD.0339 :: Society Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0339"
	S.key = "arkher.contsim.societycont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.societycont.epoch_clock" }
	S.tags = { "vd", "societycont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.societycont.sparse_residency", capacity = 256, pageBytes = 3072 })
		inst.system = S
		inst.ctx = ctx
