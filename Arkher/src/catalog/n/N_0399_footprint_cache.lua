-- ARKHER SYSTEM N.0399 :: Footprint Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0399"
	S.key = "arkher.vfx.footprint.result_cache"
	S.name = "Footprint Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Footprint"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.footprint.spawn_budget" }
	S.tags = { "n", "footprint", "cache", "vfx" }
	S.description = "Footprint Result Cache: reuse of expensive effect evaluations for the Footprint subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.footprint.result_cache", policy = "lru", capacity = 487, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
