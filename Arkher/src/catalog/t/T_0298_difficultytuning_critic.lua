-- ARKHER SYSTEM T.0298 :: Difficulty Tuning Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0298"
	S.key = "arkher.ai.difficultytuning.self_critique"
	S.name = "Difficulty Tuning Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.difficultytuning.plan_workflow" }
	S.tags = { "t", "difficultytuning", "critic", "ai" }
	S.description = "Difficulty Tuning Self Critique: weighted evaluation of the result against declared criteria for the Difficulty Tuning subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.difficultytuning.self_critique", passMark = 0.70, reviseMark = 0.40, seed = 28200 })
		inst.system = S
		inst.ctx = ctx
