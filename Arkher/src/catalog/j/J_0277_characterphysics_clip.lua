-- ARKHER SYSTEM J.0277 :: Character Physics Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0277"
	S.key = "arkher.character.characterphysics.motion_set"
	S.name = "Character Physics Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterphysics.rig_definition" }
	S.tags = { "j", "characterphysics", "clip", "character" }
	S.description = "Character Physics Motion Set: the clips a character owns and how they sample for the Character Physics subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.characterphysics.motion_set", duration = 1.00, loop = true })
		inst.system = S
		inst.ctx = ctx
