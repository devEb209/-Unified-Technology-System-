-- ARKHER SYSTEM V.0183 :: Scene Asset Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0183"
	S.key = "arkher.asset.sceneasset.cook_pipeline"
	S.name = "Scene Asset Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.sceneasset.bundling" }
	S.tags = { "v", "sceneasset", "pipeline", "asset" }
	S.description = "Scene Asset Cook Pipeline: staged cooking with isolation and retries for the Scene Asset subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.sceneasset.cook_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
