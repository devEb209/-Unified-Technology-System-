-- ARKHER SYSTEM VC.0235 :: City Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0235"
	S.key = "arkher.contneural.citycont.neural_field"
	S.name = "City Continuum Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.citycont.coherence_guard" }
	S.tags = { "vc", "citycont", "neuralfield", "contneural" }
	S.description = "City Continuum Neural Field: neural field encoding and reconstruction for the City Continuum subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.citycont.neural_field", dims = 16, hidden = 12, seed = 24105 })
		inst.system = S
		inst.ctx = ctx
