-- ARKHER SYSTEM F.0185 :: Sky Model Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0185"
	S.key = "arkher.render.sky.visibility_set"
	S.name = "Sky Model Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sky Model"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sky.view_and_culling" }
	S.tags = { "f", "sky", "visibility", "render" }
	S.description = "Sky Model Visibility Set: cell, portal and occluder visibility for the Sky Model subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.sky.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
