-- ARKHER SYSTEM VB.0534 :: Pipeline Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0534"
	S.key = "arkher.conttime.pipelinecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.pipelinecont.persistent_state" }
	S.tags = { "vb", "pipelinecont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.pipelinecont.coherence_guard", window = 50, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
