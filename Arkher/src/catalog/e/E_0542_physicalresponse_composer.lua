-- ARKHER SYSTEM E.0542 :: Physical Response Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0542"
	S.key = "arkher.material.physicalresponse.layer_composition"
	S.name = "Physical Response Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.physicalresponse.definition" }
	S.tags = { "e", "physicalresponse", "composer", "material" }
	S.description = "Physical Response Layer Composition: ordered layer composition with blend rules for the Physical Response subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.physicalresponse.layer_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
