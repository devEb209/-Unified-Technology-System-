-- ARKHER SYSTEM Z.0446 :: Player Absence Simulation Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0446"
	S.key = "arkher.origin.playerabsence.emergence_detection"
	S.name = "Player Absence Simulation Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.world_memory" }
	S.tags = { "z", "playerabsence", "emergence", "origin" }
	S.description = "Player Absence Simulation Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.playerabsence.emergence_detection", windowSize = 6, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
