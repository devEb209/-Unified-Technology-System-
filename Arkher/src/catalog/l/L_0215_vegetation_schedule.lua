-- ARKHER SYSTEM L.0215 :: Vegetation Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0215"
	S.key = "arkher.sim.vegetation.calendar"
	S.name = "Vegetation Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.vegetation.society" }
	S.tags = { "l", "vegetation", "schedule", "sim" }
	S.description = "Vegetation Calendar: hours, days and seasons driving the region for the Vegetation subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.vegetation.calendar", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
