-- ARKHER SYSTEM Z.0428 :: Offline World Progression Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0428"
	S.key = "arkher.origin.offlineprogression.semantic_graph"
	S.name = "Offline World Progression Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.world_architect" }
	S.tags = { "z", "offlineprogression", "knowledge", "origin" }
	S.description = "Offline World Progression Semantic Graph: typed entities and inferred relations of the technology itself for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.offlineprogression.semantic_graph", dims = 40 })
		inst.system = S
		inst.ctx = ctx
