--!strict
-- OpenLandMap — ANIMATION Mixer #0327
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="OpenLandMap — ANIMATION Mixer #0327", size=Vector2.new(600, 460), pos=UDim2.fromOffset(351, 179), parent=parent, icon="⤢"})
