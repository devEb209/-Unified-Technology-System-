-- ARKHER SYSTEM T.0398 :: Performance Reasoning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0398"
	S.key = "arkher.ai.performancereasoning.reasoning_graph"
	S.name = "Performance Reasoning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.performancereasoning.world_architect" }
	S.tags = { "t", "performancereasoning", "graph", "ai" }
	S.description = "Performance Reasoning Reasoning Graph: relationship modelling and shortest-path reasoning for the Performance Reasoning subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.performancereasoning.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
