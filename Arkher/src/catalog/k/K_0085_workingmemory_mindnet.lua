-- ARKHER SYSTEM K.0085 :: Working Memory Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0085"
	S.key = "arkher.npc.workingmemory.mind_network"
	S.name = "Working Memory Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "workingmemory", "mindnet", "npc" }
	S.description = "Working Memory Mind Network: the learned policy that turns perception into a decision for the Working Memory subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.workingmemory.mind_network", inputs = 7, hidden = 7, seed = 54413, learningRate = 0.065, exploration = 0.045 })
		inst.system = S
		inst.ctx = ctx
