-- ARKHER SYSTEM K.0158 :: Safety Drive Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0158"
	S.key = "arkher.npc.safetydrive.emotion"
	S.name = "Safety Drive Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.safetydrive.drive_system" }
	S.tags = { "k", "safetydrive", "emotion", "npc" }
	S.description = "Safety Drive Emotion: appraisal of events into valence, arousal and mood for the Safety Drive subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.safetydrive.emotion", inertia = 0.81, decayRate = 0.36, baselineArousal = 0.16 })
		inst.system = S
		inst.ctx = ctx
