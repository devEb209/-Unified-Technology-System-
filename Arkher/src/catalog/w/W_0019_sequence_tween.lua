-- ARKHER SYSTEM W.0019 :: Sequence Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0019"
	S.key = "arkher.cine.sequence.motion_tween"
	S.name = "Sequence Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Sequence"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.sequence.playback_orchestrator" }
	S.tags = { "w", "sequence", "tween", "cine" }
	S.description = "Sequence Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Sequence subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.sequence.motion_tween", timeScale = 1.03 })
		inst.system = S
		inst.ctx = ctx
