-- ARKHER SYSTEM W.0239 :: Fade Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0239"
	S.key = "arkher.cine.fade.sequence_analysis"
	S.name = "Fade Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Fade"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.fade.frame_budget" }
	S.tags = { "w", "fade", "analyzer", "cine" }
	S.description = "Fade Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Fade subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.fade.sequence_analysis", window = 177, buckets = 9, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
