-- ARKHER SYSTEM T.0316 :: Optimization Advisor Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0316"
	S.key = "arkher.ai.optimizationadvisor.outcome_prediction"
	S.name = "Optimization Advisor Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.optimizationadvisor.decision_policy" }
	S.tags = { "t", "optimizationadvisor", "predictor", "ai" }
	S.description = "Optimization Advisor Outcome Prediction: forecasting the result before the work is done for the Optimization Advisor subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.optimizationadvisor.outcome_prediction", method = "ema", alpha = 0.45, window = 107 })
		inst.system = S
		inst.ctx = ctx
