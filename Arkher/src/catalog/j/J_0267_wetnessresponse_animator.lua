-- ARKHER SYSTEM J.0267 :: Wetness Response Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0267"
	S.key = "arkher.character.wetnessresponse.blend_controller"
	S.name = "Wetness Response Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.wetnessresponse.motion_set" }
	S.tags = { "j", "wetnessresponse", "animator", "character" }
	S.description = "Wetness Response Blend Controller: layered playback driving the character for the Wetness Response subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.wetnessresponse.blend_controller", budget = 9 })
		inst.system = S
		inst.ctx = ctx
