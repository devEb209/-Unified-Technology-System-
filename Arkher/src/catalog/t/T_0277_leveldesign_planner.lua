-- ARKHER SYSTEM T.0277 :: Level Design Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0277"
	S.key = "arkher.ai.leveldesign.action_planner"
	S.name = "Level Design Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.leveldesign.utility_selection" }
	S.tags = { "t", "leveldesign", "planner", "ai" }
	S.description = "Level Design Action Planner: goal-oriented action planning over preconditions for the Level Design subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.leveldesign.action_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
