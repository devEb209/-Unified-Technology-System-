-- ARKHER SYSTEM I.0511 :: Animation Debug Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0511"
	S.key = "arkher.anim.animdebug.inverse_kinematics"
	S.name = "Animation Debug Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animdebug.layered_blending" }
	S.tags = { "i", "animdebug", "ik", "anim" }
	S.description = "Animation Debug Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Animation Debug subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.animdebug.inverse_kinematics", iterations = 7, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
