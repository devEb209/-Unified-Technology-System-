-- ARKHER SYSTEM VD.0015 :: Region Tile Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0015"
	S.key = "arkher.contsim.regiontile.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.regiontile.epoch_clock" }
	S.tags = { "vd", "regiontile", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.regiontile.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
