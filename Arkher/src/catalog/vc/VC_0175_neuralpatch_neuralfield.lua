-- ARKHER SYSTEM VC.0175 :: Neural Patch Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0175"
	S.key = "arkher.contneural.neuralpatch.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.neuralpatch.coherence_guard" }
	S.tags = { "vc", "neuralpatch", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.neuralpatch.neural_field", dims = 12, hidden = 8, seed = 42192 })
		inst.system = S
		inst.ctx = ctx
