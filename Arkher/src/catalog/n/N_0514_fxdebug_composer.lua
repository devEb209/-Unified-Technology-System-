-- ARKHER SYSTEM N.0514 :: Effect Debug Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0514"
	S.key = "arkher.vfx.fxdebug.effect_composition"
	S.name = "Effect Debug Effect Composition"
	S.category = "N"
	S.family = "VFX"
	S.area = "Effect Debug"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fxdebug.effect_graph" }
	S.tags = { "n", "fxdebug", "composer", "vfx" }
	S.description = "Effect Debug Effect Composition: blending of several effect signals into one output for the Effect Debug subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.fxdebug.effect_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
