-- ARKHER SYSTEM VC.0557 :: Device Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0557"
	S.key = "arkher.contneural.devicecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.devicecont.multi-scale_fidelity" }
	S.tags = { "vc", "devicecont", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.devicecont.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
