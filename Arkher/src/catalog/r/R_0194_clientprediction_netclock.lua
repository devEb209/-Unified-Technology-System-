-- ARKHER SYSTEM R.0194 :: Client Prediction Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0194"
	S.key = "arkher.net.clientprediction.time_sync"
	S.name = "Client Prediction Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.clientprediction.replication" }
	S.tags = { "r", "clientprediction", "netclock", "net" }
	S.description = "Client Prediction Time Sync: offset estimation, outlier rejection and jitter buffering for the Client Prediction subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.clientprediction.time_sync", tickRate = 20, bufferDelay = 0.080, maxSamples = 16 })
		inst.system = S
		inst.ctx = ctx
