-- ARKHER SYSTEM Z.0325 :: Cross Reality Sync World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0325"
	S.key = "arkher.origin.crossreality.world_memory"
	S.name = "Cross Reality Sync World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.autonomous_pipeline" }
	S.tags = { "z", "crossreality", "worldmemory", "origin" }
	S.description = "Cross Reality Sync World Memory: epoch-stamped persistent history with compaction and checkpoints for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.crossreality.world_memory", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
