-- ARKHER SYSTEM VA.0542 :: World Fabric Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0542"
	S.key = "arkher.contworld.worldfabric.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldfabric.infinite_grid" }
	S.tags = { "va", "worldfabric", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.worldfabric.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
