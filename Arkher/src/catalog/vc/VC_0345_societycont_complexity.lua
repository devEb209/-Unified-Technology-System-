-- ARKHER SYSTEM VC.0345 :: Society Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0345"
	S.key = "arkher.contneural.societycont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.societycont.world_memory_stream" }
	S.tags = { "vc", "societycont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.societycont.complexity_budget", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
