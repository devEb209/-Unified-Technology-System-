-- ARKHER SYSTEM H.0289 :: Box Collider Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0289"
	S.key = "arkher.physics.boxcollider.budget_governor"
	S.name = "Box Collider Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Box Collider"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.boxcollider.broadphase_index" }
	S.tags = { "h", "boxcollider", "budgeter", "physics" }
	S.description = "Box Collider Budget Governor: simulation time budget allocation across islands for the Box Collider subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.boxcollider.budget_governor", total = 415, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
