-- ARKHER SYSTEM K.0185 :: Purpose Drive Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0185"
	S.key = "arkher.npc.purposedrive.drive_system"
	S.name = "Purpose Drive Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.purposedrive.memory" }
	S.tags = { "k", "purposedrive", "need", "npc" }
	S.description = "Purpose Drive Drive System: drives that decay, turn urgent and get satisfied for the Purpose Drive subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.purposedrive.drive_system" })
		inst.system = S
		inst.ctx = ctx
