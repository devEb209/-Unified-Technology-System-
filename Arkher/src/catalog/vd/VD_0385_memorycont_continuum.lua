-- ARKHER SYSTEM VD.0385 :: Memory Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0385"
	S.key = "arkher.contsim.memorycont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "memorycont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.memorycont.infinite_grid", cellSize = 64, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
