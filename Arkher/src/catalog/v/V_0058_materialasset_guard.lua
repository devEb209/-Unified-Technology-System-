-- ARKHER SYSTEM V.0058 :: Material Asset Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0058"
	S.key = "arkher.asset.materialasset.validation_guard"
	S.name = "Material Asset Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.materialasset.size_budget" }
	S.tags = { "v", "materialasset", "guard", "asset" }
	S.description = "Material Asset Validation Guard: rate limiting and capability checks on the import path for the Material Asset subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.materialasset.validation_guard", algorithm = "token", capacity = 84, refillPerSec = 29, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
