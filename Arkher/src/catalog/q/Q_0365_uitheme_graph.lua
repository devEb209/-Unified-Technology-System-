-- ARKHER SYSTEM Q.0365 :: Theme Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0365"
	S.key = "arkher.ui.uitheme.navigation_graph"
	S.name = "Theme Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Theme"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uitheme.transition" }
	S.tags = { "q", "uitheme", "graph", "ui" }
	S.description = "Theme Navigation Graph: screens, routes and shortest path between them for the Theme subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.uitheme.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
