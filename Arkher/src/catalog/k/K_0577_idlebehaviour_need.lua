-- ARKHER SYSTEM K.0577 :: Idle Behaviour Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0577"
	S.key = "arkher.npc.idlebehaviour.drive_system"
	S.name = "Idle Behaviour Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.idlebehaviour.memory" }
	S.tags = { "k", "idlebehaviour", "need", "npc" }
	S.description = "Idle Behaviour Drive System: drives that decay, turn urgent and get satisfied for the Idle Behaviour subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.idlebehaviour.drive_system" })
		inst.system = S
		inst.ctx = ctx
