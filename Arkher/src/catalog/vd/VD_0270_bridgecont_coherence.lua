-- ARKHER SYSTEM VD.0270 :: Bridge Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0270"
	S.key = "arkher.contsim.bridgecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.bridgecont.persistent_state" }
	S.tags = { "vd", "bridgecont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.bridgecont.coherence_guard", window = 132, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
