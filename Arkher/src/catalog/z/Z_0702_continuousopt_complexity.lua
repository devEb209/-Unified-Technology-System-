-- ARKHER SYSTEM Z.0702 :: Continuous Self Optimization Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0702"
	S.key = "arkher.origin.continuousopt.complexity_governance"
	S.name = "Continuous Self Optimization Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.reality_layering" }
	S.tags = { "z", "continuousopt", "complexity", "origin" }
	S.description = "Continuous Self Optimization Complexity Governance: measured scene cost turned into per-subsystem directives for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.continuousopt.complexity_governance", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
