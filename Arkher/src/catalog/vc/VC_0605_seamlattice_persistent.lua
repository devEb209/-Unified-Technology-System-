-- ARKHER SYSTEM VC.0605 :: Seam Lattice Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0605"
	S.key = "arkher.contneural.seamlattice.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.seamlattice.multi-scale_fidelity" }
	S.tags = { "vc", "seamlattice", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.seamlattice.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
