-- ARKHER SYSTEM Z.0566 :: Collective Behaviour Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0566"
	S.key = "arkher.origin.collectivebehaviour.emergence_detection"
	S.name = "Collective Behaviour Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.collectivebehaviour.world_memory" }
	S.tags = { "z", "collectivebehaviour", "emergence", "origin" }
	S.description = "Collective Behaviour Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Collective Behaviour subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.collectivebehaviour.emergence_detection", windowSize = 7, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
