-- ARKHER SYSTEM F.0207 :: Fog Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0207"
	S.key = "arkher.render.fog.pass_cache"
	S.name = "Fog Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Fog"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.fog.render_policy" }
	S.tags = { "f", "fog", "cache", "render" }
	S.description = "Fog Pass Cache: reuse of pass results across frames for the Fog subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.fog.pass_cache", policy = "lru", capacity = 255, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
