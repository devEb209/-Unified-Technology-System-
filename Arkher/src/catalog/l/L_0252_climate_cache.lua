-- ARKHER SYSTEM L.0252 :: Climate Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0252"
	S.key = "arkher.sim.climate.aggregate_cache"
	S.name = "Climate Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.climate.fidelity_policy" }
	S.tags = { "l", "climate", "cache", "sim" }
	S.description = "Climate Aggregate Cache: reuse of expensive aggregate computations for the Climate subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.climate.aggregate_cache", policy = "lru", capacity = 181, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
