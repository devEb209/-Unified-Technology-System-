-- ARKHER SYSTEM P.0179 :: Building Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0179"
	S.key = "arkher.play.buildingsys.save_codec"
	S.name = "Building Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Building"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.buildingsys.content_registry" }
	S.tags = { "p", "buildingsys", "codec", "play" }
	S.description = "Building Save Codec: persistence, diffing and checksum of gameplay state for the Building subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.buildingsys.save_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
