-- ARKHER SYSTEM P.0286 :: Combat Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0286"
	S.key = "arkher.play.combatsys.content_registry"
	S.name = "Combat Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Combat"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.combatsys.difficulty_controller" }
	S.tags = { "p", "combatsys", "registry", "play" }
	S.description = "Combat Content Registry: catalogue of the definitions this loop instantiates for the Combat subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.combatsys.content_registry" })
		inst.system = S
		inst.ctx = ctx
