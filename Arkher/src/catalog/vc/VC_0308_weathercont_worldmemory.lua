-- ARKHER SYSTEM VC.0308 :: Weather Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0308"
	S.key = "arkher.contneural.weathercont.world_memory_stream"
	S.name = "Weather Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.weathercont.neural_field" }
	S.tags = { "vc", "weathercont", "worldmemory", "contneural" }
	S.description = "Weather Continuum World Memory Stream: world memory continuum over epochs for the Weather Continuum subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.weathercont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
