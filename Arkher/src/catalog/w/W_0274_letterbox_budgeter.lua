-- ARKHER SYSTEM W.0274 :: Letterbox Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0274"
	S.key = "arkher.cine.letterbox.frame_budget"
	S.name = "Letterbox Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Letterbox"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.letterbox.event_ledger" }
	S.tags = { "w", "letterbox", "budgeter", "cine" }
	S.description = "Letterbox Frame Budget: per-frame cost budget for the cinematic systems for the Letterbox subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.letterbox.frame_budget", total = 80, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
