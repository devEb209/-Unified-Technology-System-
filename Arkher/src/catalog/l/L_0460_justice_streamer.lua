-- ARKHER SYSTEM L.0460 :: Justice Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0460"
	S.key = "arkher.sim.justice.streaming"
	S.name = "Justice Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.justice.state_codec" }
	S.tags = { "l", "justice", "streamer", "sim" }
	S.description = "Justice Streaming: distance-driven residency of simulated regions for the Justice subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.justice.streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
