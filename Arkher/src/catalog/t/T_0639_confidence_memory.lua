-- ARKHER SYSTEM T.0639 :: Confidence Estimation Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0639"
	S.key = "arkher.ai.confidence.working_memory"
	S.name = "Confidence Estimation Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.confidence.outcome_prediction" }
	S.tags = { "t", "confidence", "memory", "ai" }
	S.description = "Confidence Estimation Working Memory: decaying, consolidating recall of what the agent learned for the Confidence Estimation subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.confidence.working_memory", capacity = 45, decayRate = 0.025, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
