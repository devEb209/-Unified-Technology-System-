-- ARKHER SYSTEM VB.0631 :: Interest Field Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0631"
	S.key = "arkher.conttime.interestfield.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.interestfield.coherence_guard" }
	S.tags = { "vb", "interestfield", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.interestfield.neural_field", dims = 16, hidden = 12, seed = 35253 })
		inst.system = S
		inst.ctx = ctx
