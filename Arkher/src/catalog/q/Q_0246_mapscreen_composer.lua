-- ARKHER SYSTEM Q.0246 :: Map Screen Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0246"
	S.key = "arkher.ui.mapscreen.theme_composition"
	S.name = "Map Screen Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Map Screen"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.mapscreen.navigation_graph" }
	S.tags = { "q", "mapscreen", "composer", "ui" }
	S.description = "Map Screen Theme Composition: blending of theme signals into the final appearance for the Map Screen subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.mapscreen.theme_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
