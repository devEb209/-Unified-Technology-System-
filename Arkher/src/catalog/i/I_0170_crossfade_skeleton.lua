-- ARKHER SYSTEM I.0170 :: Crossfade Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0170"
	S.key = "arkher.anim.crossfade.skeleton"
	S.name = "Crossfade Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Crossfade"
	S.aspect = "Skeleton"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "crossfade", "skeleton", "anim" }
	S.description = "Crossfade Skeleton: bone hierarchy, bind pose and world resolution for the Crossfade subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.crossfade.skeleton" })
		inst.system = S
		inst.ctx = ctx
