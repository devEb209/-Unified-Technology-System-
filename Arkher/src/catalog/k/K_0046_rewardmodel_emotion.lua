-- ARKHER SYSTEM K.0046 :: Reward Model Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0046"
	S.key = "arkher.npc.rewardmodel.emotion"
	S.name = "Reward Model Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.rewardmodel.drive_system" }
	S.tags = { "k", "rewardmodel", "emotion", "npc" }
	S.description = "Reward Model Emotion: appraisal of events into valence, arousal and mood for the Reward Model subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.rewardmodel.emotion", inertia = 0.92, decayRate = 0.27, baselineArousal = 0.27 })
		inst.system = S
		inst.ctx = ctx
