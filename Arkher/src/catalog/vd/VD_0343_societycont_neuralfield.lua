-- ARKHER SYSTEM VD.0343 :: Society Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0343"
	S.key = "arkher.contsim.societycont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.societycont.coherence_guard" }
	S.tags = { "vd", "societycont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.societycont.neural_field", dims = 20, hidden = 16, seed = 2310 })
		inst.system = S
		inst.ctx = ctx
