-- ARKHER SYSTEM N.0282 :: Heal Effect Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0282"
	S.key = "arkher.vfx.healfx.result_cache"
	S.name = "Heal Effect Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Heal Effect"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.healfx.spawn_budget" }
	S.tags = { "n", "healfx", "cache", "vfx" }
	S.description = "Heal Effect Result Cache: reuse of expensive effect evaluations for the Heal Effect subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.healfx.result_cache", policy = "ttl", capacity = 371, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
