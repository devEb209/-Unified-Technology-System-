-- ARKHER SYSTEM VC.0169 :: Neural Patch Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0169"
	S.key = "arkher.contneural.neuralpatch.infinite_grid"
	S.name = "Neural Patch Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "neuralpatch", "continuum", "contneural" }
	S.description = "Neural Patch Infinite Grid: seamless paging of the infinite world grid for the Neural Patch subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.neuralpatch.infinite_grid", cellSize = 160, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
