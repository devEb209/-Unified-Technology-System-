-- ARKHER SYSTEM VC.0615 :: Occupancy Map Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0615"
	S.key = "arkher.contneural.occupancymap.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.occupancymap.epoch_clock" }
	S.tags = { "vc", "occupancymap", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.occupancymap.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
