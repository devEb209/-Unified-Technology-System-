-- ARKHER SYSTEM VB.0325 :: Economy Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0325"
	S.key = "arkher.conttime.economycont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "economycont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.economycont.infinite_grid", cellSize = 192, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
