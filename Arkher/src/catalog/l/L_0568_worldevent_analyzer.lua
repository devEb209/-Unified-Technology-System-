-- ARKHER SYSTEM L.0568 :: World Event Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0568"
	S.key = "arkher.sim.worldevent.analysis"
	S.name = "World Event Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldevent.aggregate_cache" }
	S.tags = { "l", "worldevent", "analyzer", "sim" }
	S.description = "World Event Analysis: trend, anomaly and stability analysis of the world for the World Event subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.worldevent.analysis", window = 146, buckets = 18, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
