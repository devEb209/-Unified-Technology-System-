-- ARKHER SYSTEM H.0595 :: Wind Force Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0595"
	S.key = "arkher.physics.wind.vehicle"
	S.name = "Wind Force Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Wind Force"
	S.aspect = "Vehicle"
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.wind.character_motion" }
	S.tags = { "h", "wind", "vehicle", "physics" }
	S.description = "Wind Force Vehicle: suspension, drivetrain, steering and tire friction for the Wind Force subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.wind.vehicle", mass = 1500, wheelbase = 2.80, track = 1.60, maxRpm = 6200 })
		inst.system = S
		inst.ctx = ctx
