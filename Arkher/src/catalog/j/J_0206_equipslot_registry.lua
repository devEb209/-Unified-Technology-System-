-- ARKHER SYSTEM J.0206 :: Equipment Slot Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0206"
	S.key = "arkher.character.equipslot.variant_registry"
	S.name = "Equipment Slot Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.equipslot.appearance_composer" }
	S.tags = { "j", "equipslot", "registry", "character" }
	S.description = "Equipment Slot Variant Registry: named character variants and their lifecycle for the Equipment Slot subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.equipslot.variant_registry" })
		inst.system = S
		inst.ctx = ctx
