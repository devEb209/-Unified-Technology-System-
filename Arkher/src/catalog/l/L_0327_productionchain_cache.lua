-- ARKHER SYSTEM L.0327 :: Production Chain Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0327"
	S.key = "arkher.sim.productionchain.aggregate_cache"
	S.name = "Production Chain Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.productionchain.fidelity_policy" }
	S.tags = { "l", "productionchain", "cache", "sim" }
	S.description = "Production Chain Aggregate Cache: reuse of expensive aggregate computations for the Production Chain subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.productionchain.aggregate_cache", policy = "ttl", capacity = 281, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
