-- ARKHER SYSTEM T.0648 :: Human Handoff Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0648"
	S.key = "arkher.ai.humanhandoff.self_critique"
	S.name = "Human Handoff Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.humanhandoff.plan_workflow" }
	S.tags = { "t", "humanhandoff", "critic", "ai" }
	S.description = "Human Handoff Self Critique: weighted evaluation of the result against declared criteria for the Human Handoff subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.humanhandoff.self_critique", passMark = 0.75, reviseMark = 0.45, seed = 18665 })
		inst.system = S
		inst.ctx = ctx
