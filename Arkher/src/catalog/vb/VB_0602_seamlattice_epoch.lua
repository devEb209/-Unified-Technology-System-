-- ARKHER SYSTEM VB.0602 :: Seam Lattice Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0602"
	S.key = "arkher.conttime.seamlattice.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.seamlattice.infinite_grid" }
	S.tags = { "vb", "seamlattice", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.seamlattice.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
