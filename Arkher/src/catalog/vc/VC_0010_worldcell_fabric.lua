-- ARKHER SYSTEM VC.0010 :: World Grid Cell Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0010"
	S.key = "arkher.contneural.worldcell.simulation_fabric"
	S.name = "World Grid Cell Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldcell.complexity_budget" }
	S.tags = { "vc", "worldcell", "fabric", "contneural" }
	S.description = "World Grid Cell Simulation Fabric: fabric stepping the continuum domains for the World Grid Cell subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.worldcell.simulation_fabric", budgetMs = 2.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
