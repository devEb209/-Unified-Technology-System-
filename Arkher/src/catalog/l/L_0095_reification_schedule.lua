-- ARKHER SYSTEM L.0095 :: Reification Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0095"
	S.key = "arkher.sim.reification.calendar"
	S.name = "Reification Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.reification.society" }
	S.tags = { "l", "reification", "schedule", "sim" }
	S.description = "Reification Calendar: hours, days and seasons driving the region for the Reification subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.reification.calendar", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
