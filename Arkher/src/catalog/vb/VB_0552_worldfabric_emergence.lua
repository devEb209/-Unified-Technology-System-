-- ARKHER SYSTEM VB.0552 :: World Fabric Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0552"
	S.key = "arkher.conttime.worldfabric.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldfabric.reality_continuum" }
	S.tags = { "vb", "worldfabric", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.worldfabric.emergence_continuum", windowSize = 6, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
