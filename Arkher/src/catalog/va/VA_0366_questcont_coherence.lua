-- ARKHER SYSTEM VA.0366 :: Quest Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0366"
	S.key = "arkher.contworld.questcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.questcont.persistent_state" }
	S.tags = { "va", "questcont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.questcont.coherence_guard", window = 128, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
