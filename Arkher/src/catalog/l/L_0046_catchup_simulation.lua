-- ARKHER SYSTEM L.0046 :: Catch Up Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0046"
	S.key = "arkher.sim.catchup.simulation_core"
	S.name = "Catch Up Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "catchup", "simulation", "sim" }
	S.description = "Catch Up Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Catch Up subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.catchup.simulation_core", fullRadius = 160, reducedRadius = 1100, budget = 93 })
		inst.system = S
		inst.ctx = ctx
