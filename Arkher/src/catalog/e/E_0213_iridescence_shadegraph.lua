-- ARKHER SYSTEM E.0213 :: Iridescence Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0213"
	S.key = "arkher.material.iridescence.shading_graph"
	S.name = "Iridescence Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Iridescence"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.iridescence.layer_composition" }
	S.tags = { "e", "iridescence", "shadegraph", "material" }
	S.description = "Iridescence Shading Graph: node graph evaluated and compiled to Luau for the Iridescence subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.iridescence.shading_graph" })
		inst.system = S
		inst.ctx = ctx
