-- ARKHER SYSTEM T.0328 :: Bug Triage Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0328"
	S.key = "arkher.ai.bugtriage.reasoning_graph"
	S.name = "Bug Triage Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.bugtriage.world_architect" }
	S.tags = { "t", "bugtriage", "graph", "ai" }
	S.description = "Bug Triage Reasoning Graph: relationship modelling and shortest-path reasoning for the Bug Triage subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.bugtriage.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
