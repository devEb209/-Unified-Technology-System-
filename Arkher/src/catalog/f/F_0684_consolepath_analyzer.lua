-- ARKHER SYSTEM F.0684 :: Console Path Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0684"
	S.key = "arkher.render.consolepath.frame_analysis"
	S.name = "Console Path Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Console Path"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.consolepath.pass_cache" }
	S.tags = { "f", "consolepath", "analyzer", "render" }
	S.description = "Console Path Frame Analysis: per-pass cost analysis and outlier detection for the Console Path subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.consolepath.frame_analysis", window = 74, buckets = 14, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
