-- ARKHER SYSTEM V.0025 :: Texture Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0025"
	S.key = "arkher.asset.textureasset.import"
	S.name = "Texture Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "textureasset", "importer", "asset" }
	S.description = "Texture Import: validation, normalization, hashing and deduplication of incoming content for the Texture subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.textureasset.import", unitScale = 1.50 })
		inst.system = S
		inst.ctx = ctx
