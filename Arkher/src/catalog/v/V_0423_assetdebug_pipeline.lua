-- ARKHER SYSTEM V.0423 :: Asset Debug Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0423"
	S.key = "arkher.asset.assetdebug.cook_pipeline"
	S.name = "Asset Debug Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetdebug.bundling" }
	S.tags = { "v", "assetdebug", "pipeline", "asset" }
	S.description = "Asset Debug Cook Pipeline: staged cooking with isolation and retries for the Asset Debug subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.assetdebug.cook_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
