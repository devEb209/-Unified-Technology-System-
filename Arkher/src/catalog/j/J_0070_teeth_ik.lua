-- ARKHER SYSTEM J.0070 :: Teeth Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0070"
	S.key = "arkher.character.teeth.look_and_reach"
	S.name = "Teeth Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.teeth.blend_controller" }
	S.tags = { "j", "teeth", "ik", "character" }
	S.description = "Teeth Look And Reach: look-at, reach and foot placement for the character for the Teeth subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.teeth.look_and_reach", iterations = 10, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
