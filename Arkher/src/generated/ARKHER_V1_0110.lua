--!strict
-- Substance Layers — CORE Stack #0110
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Substance Layers — CORE Stack #0110", size=Vector2.new(680, 420), pos=UDim2.fromOffset(330, 130), parent=parent, icon="◈"})
