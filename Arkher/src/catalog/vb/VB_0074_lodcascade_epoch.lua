-- ARKHER SYSTEM VB.0074 :: LOD Cascade Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0074"
	S.key = "arkher.conttime.lodcascade.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lodcascade.infinite_grid" }
	S.tags = { "vb", "lodcascade", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.lodcascade.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
