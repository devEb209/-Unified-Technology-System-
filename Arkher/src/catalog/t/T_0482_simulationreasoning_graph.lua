-- ARKHER SYSTEM T.0482 :: Simulation Reasoning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0482"
	S.key = "arkher.ai.simulationreasoning.reasoning_graph"
	S.name = "Simulation Reasoning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.simulationreasoning.world_architect" }
	S.tags = { "t", "simulationreasoning", "graph", "ai" }
	S.description = "Simulation Reasoning Reasoning Graph: relationship modelling and shortest-path reasoning for the Simulation Reasoning subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.simulationreasoning.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
