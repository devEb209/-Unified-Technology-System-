-- ARKHER SYSTEM G.0286 :: Perceptual Metric Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0286"
	S.key = "arkher.neural.perceptual.weight_codec"
	S.name = "Perceptual Metric Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perceptual.model_registry" }
	S.tags = { "g", "perceptual", "codec", "neural" }
	S.description = "Perceptual Metric Weight Codec: weight serialization and quantized transport for the Perceptual Metric subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.perceptual.weight_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
