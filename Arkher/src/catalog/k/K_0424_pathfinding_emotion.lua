-- ARKHER SYSTEM K.0424 :: Pathfinding Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0424"
	S.key = "arkher.npc.pathfinding.emotion"
	S.name = "Pathfinding Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.pathfinding.drive_system" }
	S.tags = { "k", "pathfinding", "emotion", "npc" }
	S.description = "Pathfinding Emotion: appraisal of events into valence, arousal and mood for the Pathfinding subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.pathfinding.emotion", inertia = 0.86, decayRate = 0.21, baselineArousal = 0.21 })
		inst.system = S
		inst.ctx = ctx
