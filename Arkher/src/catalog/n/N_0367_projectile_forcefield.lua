-- ARKHER SYSTEM N.0367 :: Projectile Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0367"
	S.key = "arkher.vfx.projectile.force_field"
	S.name = "Projectile Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Projectile"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.projectile.particle_simulation" }
	S.tags = { "n", "projectile", "forcefield", "vfx" }
	S.description = "Projectile Force Field: wind, attraction, vortex, drag and curl turbulence for the Projectile subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.projectile.force_field", seed = 53292 })
		inst.system = S
		inst.ctx = ctx
