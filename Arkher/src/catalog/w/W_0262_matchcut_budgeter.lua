-- ARKHER SYSTEM W.0262 :: Match Cut Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0262"
	S.key = "arkher.cine.matchcut.frame_budget"
	S.name = "Match Cut Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Match Cut"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.matchcut.event_ledger" }
	S.tags = { "w", "matchcut", "budgeter", "cine" }
	S.description = "Match Cut Frame Budget: per-frame cost budget for the cinematic systems for the Match Cut subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.matchcut.frame_budget", total = 382, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
