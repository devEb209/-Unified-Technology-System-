-- ARKHER SYSTEM F.0131 :: Global Illumination Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0131"
	S.key = "arkher.render.gi.lighting_rig"
	S.name = "Global Illumination Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.gi.geometry_virtualization" }
	S.tags = { "f", "gi", "lightrig", "render" }
	S.description = "Global Illumination Lighting Rig: light clustering, importance and cascades for the Global Illumination subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.gi.lighting_rig", maxActive = 9 })
		inst.system = S
		inst.ctx = ctx
