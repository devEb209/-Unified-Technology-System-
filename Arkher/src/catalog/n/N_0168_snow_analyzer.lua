-- ARKHER SYSTEM N.0168 :: Snow Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0168"
	S.key = "arkher.vfx.snow.analysis"
	S.name = "Snow Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Snow"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.snow.spatial_index" }
	S.tags = { "n", "snow", "analyzer", "vfx" }
	S.description = "Snow Analysis: cost, overdraw and stability analysis of the effect for the Snow subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.snow.analysis", window = 139, buckets = 15, threshold = 2.10 })
		inst.system = S
		inst.ctx = ctx
