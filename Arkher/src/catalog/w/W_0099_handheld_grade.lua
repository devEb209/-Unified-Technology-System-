-- ARKHER SYSTEM W.0099 :: Handheld Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0099"
	S.key = "arkher.cine.handheld.colour_grade"
	S.name = "Handheld Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Handheld"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.handheld.camera_rig" }
	S.tags = { "w", "handheld", "grade", "cine" }
	S.description = "Handheld Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Handheld subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.handheld.colour_grade", exposure = 0.14, contrast = 1.19, saturation = 0.89, toneMap = "linear" })
		inst.system = S
		inst.ctx = ctx
