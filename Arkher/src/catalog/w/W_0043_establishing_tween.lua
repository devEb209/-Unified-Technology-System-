-- ARKHER SYSTEM W.0043 :: Establishing Shot Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0043"
	S.key = "arkher.cine.establishing.motion_tween"
	S.name = "Establishing Shot Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.establishing.playback_orchestrator" }
	S.tags = { "w", "establishing", "tween", "cine" }
	S.description = "Establishing Shot Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Establishing Shot subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.establishing.motion_tween", timeScale = 0.91 })
		inst.system = S
		inst.ctx = ctx
