-- ARKHER SYSTEM P.0128 :: Loot Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0128"
	S.key = "arkher.play.loot.balance_analysis"
	S.name = "Loot Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Loot"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.loot.event_ledger" }
	S.tags = { "p", "loot", "analyzer", "play" }
	S.description = "Loot Balance Analysis: distribution, outlier and pacing analysis for the Loot subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.loot.balance_analysis", window = 147, buckets = 15, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
