-- ARKHER SYSTEM K.0291 :: Scent Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0291"
	S.key = "arkher.npc.scent.social_relations"
	S.name = "Scent Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.scent.crowd_steering" }
	S.tags = { "k", "scent", "society", "npc" }
	S.description = "Scent Social Relations: affinity, factions, reputation and gossip for the Scent subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.scent.social_relations", decayRate = 0.014, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
