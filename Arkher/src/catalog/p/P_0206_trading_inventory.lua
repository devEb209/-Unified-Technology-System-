-- ARKHER SYSTEM P.0206 :: Trading Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0206"
	S.key = "arkher.play.trading.inventory"
	S.name = "Trading Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Trading"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.trading.attributes" }
	S.tags = { "p", "trading", "inventory", "play" }
	S.description = "Trading Inventory: slots, stacking, weight, equipment and crafting for the Trading subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.trading.inventory", slots = 32, maxWeight = 50 })
		inst.system = S
		inst.ctx = ctx
