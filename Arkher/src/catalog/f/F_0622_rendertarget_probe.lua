-- ARKHER SYSTEM F.0622 :: Render Target Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0622"
	S.key = "arkher.render.rendertarget.probe_volume"
	S.name = "Render Target Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.rendertarget.lighting_rig" }
	S.tags = { "f", "rendertarget", "probe", "render" }
	S.description = "Render Target Probe Volume: irradiance probes encoded in spherical harmonics for the Render Target subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.rendertarget.probe_volume", spacing = 16 })
		inst.system = S
		inst.ctx = ctx
