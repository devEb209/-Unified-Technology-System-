-- ARKHER SYSTEM Z.0809 :: Perceptual Budgeting Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0809"
	S.key = "arkher.origin.perceptualbudget.intent_bridge"
	S.name = "Perceptual Budgeting Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.perceptualbudget.semantic_graph" }
	S.tags = { "z", "perceptualbudget", "intent", "origin" }
	S.description = "Perceptual Budgeting Intent Bridge: natural language control surface for the technology for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.perceptualbudget.intent_bridge", minConfidence = 0.38 })
		inst.system = S
		inst.ctx = ctx
