-- ARKHER SYSTEM E.0334 :: Rust Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0334"
	S.key = "arkher.material.rust.texture_sampling"
	S.name = "Rust Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Rust"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.rust.shading_graph" }
	S.tags = { "e", "rust", "sampler", "material" }
	S.description = "Rust Texture Sampling: atlas packing, mip chain and filtered sampling for the Rust subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.rust.texture_sampling", atlasSize = 192, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
