-- ARKHER SYSTEM H.0609 :: Explosion Force Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0609"
	S.key = "arkher.physics.explosion.vehicle"
	S.name = "Explosion Force Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.explosion.character_motion" }
	S.tags = { "h", "explosion", "vehicle", "physics" }
	S.description = "Explosion Force Vehicle: suspension, drivetrain, steering and tire friction for the Explosion Force subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.explosion.vehicle", mass = 2200, wheelbase = 3.30, track = 1.70, maxRpm = 6700 })
		inst.system = S
		inst.ctx = ctx
