-- ARKHER SYSTEM T.0664 :: Multi Agent Coordination Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0664"
	S.key = "arkher.ai.multiagent.reasoning_graph"
	S.name = "Multi Agent Coordination Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.multiagent.world_architect" }
	S.tags = { "t", "multiagent", "graph", "ai" }
	S.description = "Multi Agent Coordination Reasoning Graph: relationship modelling and shortest-path reasoning for the Multi Agent Coordination subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.multiagent.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
