-- ARKHER SYSTEM R.0213 :: Server Reconciliation Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0213"
	S.key = "arkher.net.serverreconciliation.session_registry"
	S.name = "Server Reconciliation Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverreconciliation.rate_guard" }
	S.tags = { "r", "serverreconciliation", "registry", "net" }
	S.description = "Server Reconciliation Session Registry: catalogue of sessions, players and their metadata for the Server Reconciliation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.serverreconciliation.session_registry" })
		inst.system = S
		inst.ctx = ctx
