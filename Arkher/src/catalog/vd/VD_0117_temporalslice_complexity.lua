-- ARKHER SYSTEM VD.0117 :: Temporal Slice Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0117"
	S.key = "arkher.contsim.temporalslice.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.temporalslice.world_memory_stream" }
	S.tags = { "vd", "temporalslice", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.temporalslice.complexity_budget", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
