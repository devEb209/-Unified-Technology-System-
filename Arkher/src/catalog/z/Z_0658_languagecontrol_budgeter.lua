-- ARKHER SYSTEM Z.0658 :: Natural Language Engine Control Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0658"
	S.key = "arkher.origin.languagecontrol.budget_governor"
	S.name = "Natural Language Engine Control Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.languagecontrol.behaviour_analysis" }
	S.tags = { "z", "languagecontrol", "budgeter", "origin" }
	S.description = "Natural Language Engine Control Budget Governor: allocation of a scarce resource across the technology's consumers for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.languagecontrol.budget_governor", total = 255, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
