-- ARKHER SYSTEM L.0160 :: Agriculture Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0160"
	S.key = "arkher.sim.agriculture.streaming"
	S.name = "Agriculture Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.agriculture.state_codec" }
	S.tags = { "l", "agriculture", "streamer", "sim" }
	S.description = "Agriculture Streaming: distance-driven residency of simulated regions for the Agriculture subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.agriculture.streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
