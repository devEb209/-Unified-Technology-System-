-- ARKHER SYSTEM R.0115 :: Remote Function Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0115"
	S.key = "arkher.net.remotefunction.interest_streaming"
	S.name = "Remote Function Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remotefunction.serialization_codec" }
	S.tags = { "r", "remotefunction", "streamer", "net" }
	S.description = "Remote Function Interest Streaming: distance-driven residency of replicated content for the Remote Function subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.remotefunction.interest_streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
