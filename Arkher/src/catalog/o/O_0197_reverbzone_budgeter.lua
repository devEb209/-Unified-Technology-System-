-- ARKHER SYSTEM O.0197 :: Reverb Zone Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0197"
	S.key = "arkher.audio.reverbzone.voice_budget"
	S.name = "Reverb Zone Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Reverb Zone"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.reverbzone.music_sequencer" }
	S.tags = { "o", "reverbzone", "budgeter", "audio" }
	S.description = "Reverb Zone Voice Budget: voice slots allocated by priority and audibility for the Reverb Zone subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.reverbzone.voice_budget", total = 248, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
