-- ARKHER SYSTEM K.0635 :: Gossip Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0635"
	S.key = "arkher.npc.gossip.perception"
	S.name = "Gossip Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.gossip.emotion" }
	S.tags = { "k", "gossip", "perception", "npc" }
	S.description = "Gossip Perception: sight, hearing and bounded attention for the Gossip subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.gossip.perception", sightRange = 60, hearingRange = 16, attentionSlots = 6, fov = 1.990 })
		inst.system = S
		inst.ctx = ctx
