-- ARKHER SYSTEM I.0230 :: Root Motion Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0230"
	S.key = "arkher.anim.rootmotion.playback_pipeline"
	S.name = "Root Motion Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Root Motion"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.rootmotion.event_ledger" }
	S.tags = { "i", "rootmotion", "pipeline", "anim" }
	S.description = "Root Motion Playback Pipeline: ordered sample, blend, ik and output stages for the Root Motion subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.rootmotion.playback_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
