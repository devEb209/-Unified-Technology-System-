-- ARKHER SYSTEM L.0484 :: Diplomacy Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0484"
	S.key = "arkher.sim.diplomacy.society"
	S.name = "Diplomacy Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.diplomacy.economy" }
	S.tags = { "l", "diplomacy", "society", "sim" }
	S.description = "Diplomacy Society: relations, factions, reputation and cohesion of the region for the Diplomacy subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.diplomacy.society", decayRate = 0.009, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
