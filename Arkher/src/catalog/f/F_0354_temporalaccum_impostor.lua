-- ARKHER SYSTEM F.0354 :: Temporal Accumulation Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0354"
	S.key = "arkher.render.temporalaccum.geometry_virtualization"
	S.name = "Temporal Accumulation Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.temporalaccum.visibility_set" }
	S.tags = { "f", "temporalaccum", "impostor", "render" }
	S.description = "Temporal Accumulation Geometry Virtualization: impostor and HLOD synthesis under a budget for the Temporal Accumulation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.temporalaccum.geometry_virtualization", atlasSlots = 48, viewCount = 8, errorThreshold = 1.10 })
		inst.system = S
		inst.ctx = ctx
