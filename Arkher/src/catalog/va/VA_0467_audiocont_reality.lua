-- ARKHER SYSTEM VA.0467 :: Audio Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0467"
	S.key = "arkher.contworld.audiocont.reality_continuum"
	S.name = "Audio Continuum Reality Continuum"
	S.category = "VA"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.audiocont.simulation_fabric" }
	S.tags = { "va", "audiocont", "reality", "contworld" }
	S.description = "Audio Continuum Reality Continuum: stacked reality layers of the continuum for the Audio Continuum subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.audiocont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
