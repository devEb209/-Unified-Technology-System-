-- ARKHER SYSTEM VB.0385 :: Memory Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0385"
	S.key = "arkher.conttime.memorycont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "memorycont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.memorycont.infinite_grid", cellSize = 64, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
