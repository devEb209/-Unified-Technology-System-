-- ARKHER SYSTEM VB.0551 :: World Fabric Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0551"
	S.key = "arkher.conttime.worldfabric.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldfabric.simulation_fabric" }
	S.tags = { "vb", "worldfabric", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.worldfabric.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
