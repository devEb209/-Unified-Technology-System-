-- ARKHER SYSTEM L.0481 :: Diplomacy Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0481"
	S.key = "arkher.sim.diplomacy.simulation_core"
	S.name = "Diplomacy Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "diplomacy", "simulation", "sim" }
	S.description = "Diplomacy Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Diplomacy subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.diplomacy.simulation_core", fullRadius = 320, reducedRadius = 700, budget = 73 })
		inst.system = S
		inst.ctx = ctx
