-- ARKHER SYSTEM VA.0166 :: Coherence Seam Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0166"
	S.key = "arkher.contworld.coherenceseam.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.coherenceseam.complexity_budget" }
	S.tags = { "va", "coherenceseam", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.coherenceseam.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
