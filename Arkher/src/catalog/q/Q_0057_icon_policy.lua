-- ARKHER SYSTEM Q.0057 :: Icon Accessibility Policy
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0057"
	S.key = "arkher.ui.icon.accessibility_policy"
	S.name = "Icon Accessibility Policy"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Icon"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.icon.interaction_ledger" }
	S.tags = { "q", "icon", "policy", "ui" }
	S.description = "Icon Accessibility Policy: rules enforcing contrast, target size and motion limits for the Icon subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ui.icon.accessibility_policy", algorithm = "wfq", starvationGuard = 62 })
		inst.system = S
		inst.ctx = ctx
