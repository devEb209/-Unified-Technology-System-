-- ARKHER SYSTEM VC.0614 :: Occupancy Map Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0614"
	S.key = "arkher.contneural.occupancymap.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.occupancymap.infinite_grid" }
	S.tags = { "vc", "occupancymap", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.occupancymap.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
