-- ARKHER SYSTEM L.0321 :: Production Chain Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0321"
	S.key = "arkher.sim.productionchain.region_graph"
	S.name = "Production Chain Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.productionchain.calendar" }
	S.tags = { "l", "productionchain", "graph", "sim" }
	S.description = "Production Chain Region Graph: connectivity, components and shortest path between places for the Production Chain subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.productionchain.region_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
