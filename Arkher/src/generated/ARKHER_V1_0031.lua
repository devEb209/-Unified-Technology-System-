--!strict
-- Mapbox GL — ANIMATION Node_Flow #0031
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Mapbox GL — ANIMATION Node_Flow #0031", size=Vector2.new(640, 440), pos=UDim2.fromOffset(103, 87), parent=parent, icon="✈"})
