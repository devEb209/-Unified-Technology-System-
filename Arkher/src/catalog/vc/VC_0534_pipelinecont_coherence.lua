-- ARKHER SYSTEM VC.0534 :: Pipeline Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0534"
	S.key = "arkher.contneural.pipelinecont.coherence_guard"
	S.name = "Pipeline Continuum Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.pipelinecont.persistent_state" }
	S.tags = { "vc", "pipelinecont", "coherence", "contneural" }
	S.description = "Pipeline Continuum Coherence Guard: seam coherence and drift supervision for the Pipeline Continuum subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.pipelinecont.coherence_guard", window = 135, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
