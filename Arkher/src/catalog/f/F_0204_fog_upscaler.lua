-- ARKHER SYSTEM F.0204 :: Fog Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0204"
	S.key = "arkher.render.fog.adaptive_resolution"
	S.name = "Fog Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Fog"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.fog.temporal_resolve" }
	S.tags = { "f", "fog", "upscaler", "render" }
	S.description = "Fog Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Fog subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.fog.adaptive_resolution", targetMs = 16.10, index = 5, sharpness = 0.55 })
		inst.system = S
		inst.ctx = ctx
