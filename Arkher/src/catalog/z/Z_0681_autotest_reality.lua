-- ARKHER SYSTEM Z.0681 :: Auto Test Synthesis Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0681"
	S.key = "arkher.origin.autotest.reality_layering"
	S.name = "Auto Test Synthesis Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "autotest", "reality", "origin" }
	S.description = "Auto Test Synthesis Reality Layering: stacked authored, simulated, proposed and player realities for the Auto Test Synthesis subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.autotest.reality_layering" })
		inst.system = S
		inst.ctx = ctx
