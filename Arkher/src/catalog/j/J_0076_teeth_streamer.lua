-- ARKHER SYSTEM J.0076 :: Teeth Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0076"
	S.key = "arkher.character.teeth.streaming"
	S.name = "Teeth Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.teeth.budget_governor" }
	S.tags = { "j", "teeth", "streamer", "character" }
	S.description = "Teeth Streaming: distance-driven residency of character data for the Teeth subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.teeth.streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
