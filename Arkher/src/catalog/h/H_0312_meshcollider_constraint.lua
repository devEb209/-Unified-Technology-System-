-- ARKHER SYSTEM H.0312 :: Mesh Collider Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0312"
	S.key = "arkher.physics.meshcollider.constraint_solver"
	S.name = "Mesh Collider Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.meshcollider.contact_generation" }
	S.tags = { "h", "meshcollider", "constraint", "physics" }
	S.description = "Mesh Collider Constraint Solver: sequential impulses, friction, joints and warm starting for the Mesh Collider subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.meshcollider.constraint_solver", iterations = 6, baumgarte = 0.22, warmStart = true })
		inst.system = S
		inst.ctx = ctx
