-- ARKHER SYSTEM T.0619 :: Explainability Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0619"
	S.key = "arkher.ai.explainability.plan_workflow"
	S.name = "Explainability Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.explainability.semantic_knowledge" }
	S.tags = { "t", "explainability", "workflow", "ai" }
	S.description = "Explainability Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Explainability subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.explainability.plan_workflow", maxRetries = 3, budget = 90 })
		inst.system = S
		inst.ctx = ctx
