-- ARKHER SYSTEM L.0196 :: Predation Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0196"
	S.key = "arkher.sim.predation.simulation_core"
	S.name = "Predation Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "predation", "simulation", "sim" }
	S.description = "Predation Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Predation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.predation.simulation_core", fullRadius = 200, reducedRadius = 1200, budget = 94 })
		inst.system = S
		inst.ctx = ctx
