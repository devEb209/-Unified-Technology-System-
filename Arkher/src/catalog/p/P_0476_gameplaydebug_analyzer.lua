-- ARKHER SYSTEM P.0476 :: Gameplay Debug Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0476"
	S.key = "arkher.play.gameplaydebug.balance_analysis"
	S.name = "Gameplay Debug Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.gameplaydebug.event_ledger" }
	S.tags = { "p", "gameplaydebug", "analyzer", "play" }
	S.description = "Gameplay Debug Balance Analysis: distribution, outlier and pacing analysis for the Gameplay Debug subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.gameplaydebug.balance_analysis", window = 243, buckets = 19, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
