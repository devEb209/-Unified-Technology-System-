-- ARKHER SYSTEM F.0270 :: Tonemapping Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0270"
	S.key = "arkher.render.tonemap.geometry_virtualization"
	S.name = "Tonemapping Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Tonemapping"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.tonemap.visibility_set" }
	S.tags = { "f", "tonemap", "impostor", "render" }
	S.description = "Tonemapping Geometry Virtualization: impostor and HLOD synthesis under a budget for the Tonemapping subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.tonemap.geometry_virtualization", atlasSlots = 32, viewCount = 8, errorThreshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
