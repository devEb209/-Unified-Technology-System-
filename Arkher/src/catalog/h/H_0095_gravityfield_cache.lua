-- ARKHER SYSTEM H.0095 :: Gravity Field Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0095"
	S.key = "arkher.physics.gravityfield.result_cache"
	S.name = "Gravity Field Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.gravityfield.simulation_policy" }
	S.tags = { "h", "gravityfield", "cache", "physics" }
	S.description = "Gravity Field Result Cache: reuse of expensive simulation and query results for the Gravity Field subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.gravityfield.result_cache", policy = "lfu", capacity = 102, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
