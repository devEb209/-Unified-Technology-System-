-- ARKHER SYSTEM H.0332 :: Heightfield Collider Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0332"
	S.key = "arkher.physics.heightfieldcollider.simulation_policy"
	S.name = "Heightfield Collider Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.heightfieldcollider.budget_governor" }
	S.tags = { "h", "heightfieldcollider", "policy", "physics" }
	S.description = "Heightfield Collider Simulation Policy: device tier rules for substeps, iterations and sleep for the Heightfield Collider subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.heightfieldcollider.simulation_policy", algorithm = "edf", starvationGuard = 33 })
		inst.system = S
		inst.ctx = ctx
