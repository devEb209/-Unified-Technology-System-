-- ARKHER SYSTEM H.0520 :: Breakable Joint Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0520"
	S.key = "arkher.physics.breakjoint.collision_shape"
	S.name = "Breakable Joint Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.breakjoint.body_dynamics" }
	S.tags = { "h", "breakjoint", "collider", "physics" }
	S.description = "Breakable Joint Collision Shape: shape bounds, support mapping and closest points for the Breakable Joint subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.breakjoint.collision_shape", shape = "sphere", radius = 0.70, height = 1.50, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
