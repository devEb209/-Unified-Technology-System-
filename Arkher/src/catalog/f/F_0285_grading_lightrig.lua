-- ARKHER SYSTEM F.0285 :: Color Grading Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0285"
	S.key = "arkher.render.grading.lighting_rig"
	S.name = "Color Grading Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.grading.geometry_virtualization" }
	S.tags = { "f", "grading", "lightrig", "render" }
	S.description = "Color Grading Lighting Rig: light clustering, importance and cascades for the Color Grading subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.grading.lighting_rig", maxActive = 9 })
		inst.system = S
		inst.ctx = ctx
