-- ARKHER SYSTEM VD.0051 :: Epoch Frame Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0051"
	S.key = "arkher.contsim.epochframe.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.epochframe.epoch_clock" }
	S.tags = { "vd", "epochframe", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.epochframe.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
