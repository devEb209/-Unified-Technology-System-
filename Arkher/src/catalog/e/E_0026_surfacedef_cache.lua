-- ARKHER SYSTEM E.0026 :: Surface Definition Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0026"
	S.key = "arkher.material.surfacedef.instance_cache"
	S.name = "Surface Definition Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.surfacedef.quality_policy" }
	S.tags = { "e", "surfacedef", "cache", "material" }
	S.description = "Surface Definition Instance Cache: resolved-parameter cache keyed by context for the Surface Definition subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.surfacedef.instance_cache", policy = "ttl", capacity = 425, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
