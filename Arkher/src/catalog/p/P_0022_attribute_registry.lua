-- ARKHER SYSTEM P.0022 :: Attribute Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0022"
	S.key = "arkher.play.attribute.content_registry"
	S.name = "Attribute Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Attribute"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.attribute.difficulty_controller" }
	S.tags = { "p", "attribute", "registry", "play" }
	S.description = "Attribute Content Registry: catalogue of the definitions this loop instantiates for the Attribute subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.attribute.content_registry" })
		inst.system = S
		inst.ctx = ctx
