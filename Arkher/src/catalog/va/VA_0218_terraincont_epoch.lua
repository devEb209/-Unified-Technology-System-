-- ARKHER SYSTEM VA.0218 :: Terrain Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0218"
	S.key = "arkher.contworld.terraincont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.terraincont.infinite_grid" }
	S.tags = { "va", "terraincont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.terraincont.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
