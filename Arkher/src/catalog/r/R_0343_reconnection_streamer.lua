-- ARKHER SYSTEM R.0343 :: Reconnection Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0343"
	S.key = "arkher.net.reconnection.interest_streaming"
	S.name = "Reconnection Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Reconnection"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reconnection.serialization_codec" }
	S.tags = { "r", "reconnection", "streamer", "net" }
	S.description = "Reconnection Interest Streaming: distance-driven residency of replicated content for the Reconnection subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.reconnection.interest_streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
