-- ARKHER SYSTEM V.0412 :: Asset Search Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0412"
	S.key = "arkher.asset.assetsearch.asset_registry"
	S.name = "Asset Search Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetsearch.cook_pipeline" }
	S.tags = { "v", "assetsearch", "registry", "asset" }
	S.description = "Asset Search Asset Registry: catalogue of every asset, its tags and its metadata for the Asset Search subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.assetsearch.asset_registry" })
		inst.system = S
		inst.ctx = ctx
