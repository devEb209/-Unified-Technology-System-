-- ARKHER SYSTEM E.0415 :: Mip Policy Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0415"
	S.key = "arkher.material.mippolicy.quality_policy"
	S.name = "Mip Policy Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Mip Policy"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.mippolicy.compression_codec" }
	S.tags = { "e", "mippolicy", "policy", "material" }
	S.description = "Mip Policy Quality Policy: device tier rules for the surface for the Mip Policy subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.mippolicy.quality_policy", algorithm = "edf", starvationGuard = 41 })
		inst.system = S
		inst.ctx = ctx
