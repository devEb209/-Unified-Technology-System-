--!strict
-- PolyHaven CC0 — ANIMATION Stack #0205
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="PolyHaven CC0 — ANIMATION Stack #0205", size=Vector2.new(640, 420), pos=UDim2.fromOffset(365, 185), parent=parent, icon="🎬"})
