-- ARKHER SYSTEM VC.0625 :: Interest Field Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0625"
	S.key = "arkher.contneural.interestfield.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "interestfield", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.interestfield.infinite_grid", cellSize = 128, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
