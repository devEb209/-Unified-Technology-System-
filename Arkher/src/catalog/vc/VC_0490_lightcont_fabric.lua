-- ARKHER SYSTEM VC.0490 :: Lighting Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0490"
	S.key = "arkher.contneural.lightcont.simulation_fabric"
	S.name = "Lighting Continuum Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lightcont.complexity_budget" }
	S.tags = { "vc", "lightcont", "fabric", "contneural" }
	S.description = "Lighting Continuum Simulation Fabric: fabric stepping the continuum domains for the Lighting Continuum subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.lightcont.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
