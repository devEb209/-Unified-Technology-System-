-- ARKHER SYSTEM K.0189 :: Purpose Drive Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0189"
	S.key = "arkher.npc.purposedrive.utility_reasoning"
	S.name = "Purpose Drive Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.purposedrive.reactive_behaviour" }
	S.tags = { "k", "purposedrive", "utility", "npc" }
	S.description = "Purpose Drive Utility Reasoning: scored option selection with response curves for the Purpose Drive subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.purposedrive.utility_reasoning", momentum = 0.04 })
		inst.system = S
		inst.ctx = ctx
