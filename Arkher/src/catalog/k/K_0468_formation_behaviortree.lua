-- ARKHER SYSTEM K.0468 :: Formation Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0468"
	S.key = "arkher.npc.formation.reactive_behaviour"
	S.name = "Formation Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.formation.perception" }
	S.tags = { "k", "formation", "behaviortree", "npc" }
	S.description = "Formation Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Formation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.formation.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
