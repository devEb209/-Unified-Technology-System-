-- ARKHER SYSTEM P.0001 :: Player Character Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0001"
	S.key = "arkher.play.playercharacter.attributes"
	S.name = "Player Character Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "playercharacter", "stats", "play" }
	S.description = "Player Character Attributes: base values, layered modifiers and derived statistics for the Player Character subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.playercharacter.attributes" })
		inst.system = S
		inst.ctx = ctx
