-- ARKHER SYSTEM VD.0138 :: Fidelity Band Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0138"
	S.key = "arkher.contsim.fidelityband.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.fidelityband.persistent_state" }
	S.tags = { "vd", "fidelityband", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.fidelityband.coherence_guard", window = 117, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
