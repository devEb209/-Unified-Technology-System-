-- ARKHER SYSTEM P.0266 :: Reputation Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0266"
	S.key = "arkher.play.playerreputation.inventory"
	S.name = "Reputation Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Reputation"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playerreputation.attributes" }
	S.tags = { "p", "playerreputation", "inventory", "play" }
	S.description = "Reputation Inventory: slots, stacking, weight, equipment and crafting for the Reputation subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.playerreputation.inventory", slots = 20, maxWeight = 140 })
		inst.system = S
		inst.ctx = ctx
