-- ARKHER SYSTEM VA.0250 :: Vegetation Field Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0250"
	S.key = "arkher.contworld.vegfield.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vegfield.complexity_budget" }
	S.tags = { "va", "vegfield", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.vegfield.simulation_fabric", budgetMs = 2.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
