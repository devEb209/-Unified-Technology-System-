-- ARKHER SYSTEM F.0484 :: Impostor Rendering Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0484"
	S.key = "arkher.render.impostorrender.adaptive_resolution"
	S.name = "Impostor Rendering Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.impostorrender.temporal_resolve" }
	S.tags = { "f", "impostorrender", "upscaler", "render" }
	S.description = "Impostor Rendering Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Impostor Rendering subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.impostorrender.adaptive_resolution", targetMs = 12.10, index = 4, sharpness = 0.43 })
		inst.system = S
		inst.ctx = ctx
