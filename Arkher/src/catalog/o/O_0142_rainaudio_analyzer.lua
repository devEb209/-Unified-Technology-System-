-- ARKHER SYSTEM O.0142 :: Rain Audio Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0142"
	S.key = "arkher.audio.rainaudio.analysis"
	S.name = "Rain Audio Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Rain Audio"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.rainaudio.playback_policy" }
	S.tags = { "o", "rainaudio", "analyzer", "audio" }
	S.description = "Rain Audio Analysis: loudness, headroom and masking analysis for the Rain Audio subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.rainaudio.analysis", window = 150, buckets = 14, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
