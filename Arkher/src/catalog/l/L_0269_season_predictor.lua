-- ARKHER SYSTEM L.0269 :: Season Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0269"
	S.key = "arkher.sim.season.forecast"
	S.name = "Season Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.season.analysis" }
	S.tags = { "l", "season", "predictor", "sim" }
	S.description = "Season Forecast: prediction of the region's next state for the Season subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.season.forecast", method = "linear", alpha = 0.42, window = 96 })
		inst.system = S
		inst.ctx = ctx
