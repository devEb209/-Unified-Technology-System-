-- ARKHER SYSTEM V.0007 :: Mesh Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0007"
	S.key = "arkher.asset.meshasset.streaming_residency"
	S.name = "Mesh Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.meshasset.content_cache" }
	S.tags = { "v", "meshasset", "streamer", "asset" }
	S.description = "Mesh Streaming Residency: distance-driven load and unload of asset payloads for the Mesh subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.meshasset.streaming_residency", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
