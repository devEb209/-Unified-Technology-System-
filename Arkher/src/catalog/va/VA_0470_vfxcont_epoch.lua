-- ARKHER SYSTEM VA.0470 :: VFX Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0470"
	S.key = "arkher.contworld.vfxcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vfxcont.infinite_grid" }
	S.tags = { "va", "vfxcont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.vfxcont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
