-- ARKHER SYSTEM T.0673 :: Continuous Learning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0673"
	S.key = "arkher.ai.continuouslearning.intent_understanding"
	S.name = "Continuous Learning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "continuouslearning", "intent", "ai" }
	S.description = "Continuous Learning Intent Understanding: natural language turned into an actionable, scored intent for the Continuous Learning subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.continuouslearning.intent_understanding", minConfidence = 0.32 })
		inst.system = S
		inst.ctx = ctx
