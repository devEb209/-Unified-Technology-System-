-- ARKHER SYSTEM Z.0636 :: Intent Driven Authoring Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0636"
	S.key = "arkher.origin.intentauthoring.governance_policy"
	S.name = "Intent Driven Authoring Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.signal_composition" }
	S.tags = { "z", "intentauthoring", "policy", "origin" }
	S.description = "Intent Driven Authoring Governance Policy: ordered rules governing when the technology may act for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.intentauthoring.governance_policy", algorithm = "edf", starvationGuard = 17 })
		inst.system = S
		inst.ctx = ctx
