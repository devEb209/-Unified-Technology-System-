-- ARKHER SYSTEM VD.0310 :: Weather Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0310"
	S.key = "arkher.contsim.weathercont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.weathercont.complexity_budget" }
	S.tags = { "vd", "weathercont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.weathercont.simulation_fabric", budgetMs = 4.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
