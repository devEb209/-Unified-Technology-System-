-- ARKHER SYSTEM VA.0011 :: World Grid Cell Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0011"
	S.key = "arkher.contworld.worldcell.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldcell.simulation_fabric" }
	S.tags = { "va", "worldcell", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.worldcell.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
