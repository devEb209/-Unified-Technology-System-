-- ARKHER SYSTEM Z.0844 :: Simulation Time Dilation Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0844"
	S.key = "arkher.origin.timedilation.autonomous_pipeline"
	S.name = "Simulation Time Dilation Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.simulation_fabric" }
	S.tags = { "z", "timedilation", "autopipeline", "origin" }
	S.description = "Simulation Time Dilation Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.timedilation.autonomous_pipeline", maxIterations = 9 })
		inst.system = S
		inst.ctx = ctx
