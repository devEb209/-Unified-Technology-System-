-- ARKHER SYSTEM VB.0226 :: Terrain Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0226"
	S.key = "arkher.conttime.terraincont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.terraincont.complexity_budget" }
	S.tags = { "vb", "terraincont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.terraincont.simulation_fabric", budgetMs = 2.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
