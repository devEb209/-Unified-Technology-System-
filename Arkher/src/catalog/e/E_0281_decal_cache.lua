-- ARKHER SYSTEM E.0281 :: Decal Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0281"
	S.key = "arkher.material.decal.instance_cache"
	S.name = "Decal Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Decal"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.decal.quality_policy" }
	S.tags = { "e", "decal", "cache", "material" }
	S.description = "Decal Instance Cache: resolved-parameter cache keyed by context for the Decal subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.decal.instance_cache", policy = "ttl", capacity = 175, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
