-- ARKHER SYSTEM G.0342 :: Inference Scheduler Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0342"
	S.key = "arkher.neural.inferencesched.weight_codec"
	S.name = "Inference Scheduler Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.inferencesched.model_registry" }
	S.tags = { "g", "inferencesched", "codec", "neural" }
	S.description = "Inference Scheduler Weight Codec: weight serialization and quantized transport for the Inference Scheduler subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.inferencesched.weight_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
