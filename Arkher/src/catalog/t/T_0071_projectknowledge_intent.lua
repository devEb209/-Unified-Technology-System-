-- ARKHER SYSTEM T.0071 :: Project Knowledge Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0071"
	S.key = "arkher.ai.projectknowledge.intent_understanding"
	S.name = "Project Knowledge Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "projectknowledge", "intent", "ai" }
	S.description = "Project Knowledge Intent Understanding: natural language turned into an actionable, scored intent for the Project Knowledge subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.projectknowledge.intent_understanding", minConfidence = 0.42 })
		inst.system = S
		inst.ctx = ctx
