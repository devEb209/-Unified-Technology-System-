-- ARKHER SYSTEM I.0027 :: Bind Pose Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0027"
	S.key = "arkher.anim.bindpose.skeleton"
	S.name = "Bind Pose Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bind Pose"
	S.aspect = "Skeleton"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "bindpose", "skeleton", "anim" }
	S.description = "Bind Pose Skeleton: bone hierarchy, bind pose and world resolution for the Bind Pose subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.bindpose.skeleton" })
		inst.system = S
		inst.ctx = ctx
