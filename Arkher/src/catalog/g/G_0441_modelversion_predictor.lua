-- ARKHER SYSTEM G.0441 :: Model Versioning Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0441"
	S.key = "arkher.neural.modelversion.quality_predictor"
	S.name = "Model Versioning Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelversion.weight_codec" }
	S.tags = { "g", "modelversion", "predictor", "neural" }
	S.description = "Model Versioning Quality Predictor: predicted quality and cost of a setting for the Model Versioning subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.modelversion.quality_predictor", method = "linear", alpha = 0.19, window = 81 })
		inst.system = S
		inst.ctx = ctx
