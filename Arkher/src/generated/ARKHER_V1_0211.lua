--!strict
-- Cascadeur — ANIMATION Node_Flow #0211
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Cascadeur — ANIMATION Node_Flow #0211", size=Vector2.new(640, 440), pos=UDim2.fromOffset(443, 287), parent=parent, icon="⚙"})
