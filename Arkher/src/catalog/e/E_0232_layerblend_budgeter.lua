-- ARKHER SYSTEM E.0232 :: Layer Blending Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0232"
	S.key = "arkher.material.layerblend.parameter_budget"
	S.name = "Layer Blending Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.layerblend.variant_registry" }
	S.tags = { "e", "layerblend", "budgeter", "material" }
	S.description = "Layer Blending Parameter Budget: texel and layer budget allocation for the Layer Blending subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.layerblend.parameter_budget", total = 361, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
