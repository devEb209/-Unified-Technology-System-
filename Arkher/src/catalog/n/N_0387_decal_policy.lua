-- ARKHER SYSTEM N.0387 :: Decal Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0387"
	S.key = "arkher.vfx.decal.quality_policy"
	S.name = "Decal Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Decal"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.decal.result_cache" }
	S.tags = { "n", "decal", "policy", "vfx" }
	S.description = "Decal Quality Policy: distance and device driven fidelity bands for the Decal subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.decal.quality_policy", algorithm = "edf", starvationGuard = 53 })
		inst.system = S
		inst.ctx = ctx
