-- ARKHER SYSTEM I.0454 :: Motion Matching Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0454"
	S.key = "arkher.anim.motionmatching.analysis"
	S.name = "Motion Matching Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.motionmatching.quality_policy" }
	S.tags = { "i", "motionmatching", "analyzer", "anim" }
	S.description = "Motion Matching Analysis: pop, drift and cost analysis of playback for the Motion Matching subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.motionmatching.analysis", window = 138, buckets = 10, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
