-- ARKHER SYSTEM R.0249 :: Area Of Interest Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0249"
	S.key = "arkher.net.areaofinterest.session_registry"
	S.name = "Area Of Interest Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.areaofinterest.rate_guard" }
	S.tags = { "r", "areaofinterest", "registry", "net" }
	S.description = "Area Of Interest Session Registry: catalogue of sessions, players and their metadata for the Area Of Interest subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.areaofinterest.session_registry" })
		inst.system = S
		inst.ctx = ctx
