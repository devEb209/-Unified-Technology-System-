-- ARKHER SYSTEM K.0066 :: Episodic Memory Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0066"
	S.key = "arkher.npc.episodicmemory.crowd_steering"
	S.name = "Episodic Memory Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.episodicmemory.navigation" }
	S.tags = { "k", "episodicmemory", "crowd", "npc" }
	S.description = "Episodic Memory Crowd Steering: local avoidance, cohesion and arrival at scale for the Episodic Memory subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.episodicmemory.crowd_steering", radius = 0.60, maxSpeed = 5.40, cellSize = 6 })
		inst.system = S
		inst.ctx = ctx
