-- ARKHER SYSTEM W.0347 :: Camera Shake Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0347"
	S.key = "arkher.cine.camerashake.sequence_analysis"
	S.name = "Camera Shake Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Camera Shake"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.camerashake.frame_budget" }
	S.tags = { "w", "camerashake", "analyzer", "cine" }
	S.description = "Camera Shake Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.camerashake.sequence_analysis", window = 95, buckets = 15, threshold = 2.70 })
		inst.system = S
		inst.ctx = ctx
