-- ARKHER SYSTEM G.0281 :: Perceptual Metric Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0281"
	S.key = "arkher.neural.perceptual.inference_core"
	S.name = "Perceptual Metric Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "perceptual", "inference", "neural" }
	S.description = "Perceptual Metric Inference Core: dense network forward pass and training for the Perceptual Metric subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.perceptual.inference_core", seed = 98880 })
		inst.system = S
		inst.ctx = ctx
