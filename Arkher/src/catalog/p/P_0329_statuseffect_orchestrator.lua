-- ARKHER SYSTEM P.0329 :: Status Effect State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0329"
	S.key = "arkher.play.statuseffect.state_machine"
	S.name = "Status Effect State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.statuseffect.combat_resolution" }
	S.tags = { "p", "statuseffect", "orchestrator", "play" }
	S.description = "Status Effect State Machine: the phase machine that drives this gameplay loop for the Status Effect subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.statuseffect.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
