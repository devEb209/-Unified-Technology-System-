-- ARKHER SYSTEM VB.0150 :: Persistence Segment Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0150"
	S.key = "arkher.conttime.persistsegment.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.persistsegment.persistent_state" }
	S.tags = { "vb", "persistsegment", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.persistsegment.coherence_guard", window = 96, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
