-- ARKHER SYSTEM V.0053 :: Material Asset Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0053"
	S.key = "arkher.asset.materialasset.dependency_graph"
	S.name = "Material Asset Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.materialasset.asset_registry" }
	S.tags = { "v", "materialasset", "graph", "asset" }
	S.description = "Material Asset Dependency Graph: what references what, and in which order it must be built for the Material Asset subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.materialasset.dependency_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
