-- ARKHER SYSTEM J.0060 :: Eyes Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0060"
	S.key = "arkher.character.eyes.physical_response"
	S.name = "Eyes Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.eyes.look_and_reach" }
	S.tags = { "j", "eyes", "ragdoll", "character" }
	S.description = "Eyes Physical Response: physical reaction, ragdoll and recovery for the Eyes subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.eyes.physical_response", blendSpeed = 5.90 })
		inst.system = S
		inst.ctx = ctx
