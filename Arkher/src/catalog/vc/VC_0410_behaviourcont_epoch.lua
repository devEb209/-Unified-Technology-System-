-- ARKHER SYSTEM VC.0410 :: Behaviour Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0410"
	S.key = "arkher.contneural.behaviourcont.epoch_clock"
	S.name = "Behaviour Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.behaviourcont.infinite_grid" }
	S.tags = { "vc", "behaviourcont", "epoch", "contneural" }
	S.description = "Behaviour Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Behaviour Continuum subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.behaviourcont.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
