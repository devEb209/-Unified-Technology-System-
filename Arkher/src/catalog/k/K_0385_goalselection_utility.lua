-- ARKHER SYSTEM K.0385 :: Goal Selection Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0385"
	S.key = "arkher.npc.goalselection.utility_reasoning"
	S.name = "Goal Selection Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.goalselection.reactive_behaviour" }
	S.tags = { "k", "goalselection", "utility", "npc" }
	S.description = "Goal Selection Utility Reasoning: scored option selection with response curves for the Goal Selection subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.goalselection.utility_reasoning", momentum = 0.02 })
		inst.system = S
		inst.ctx = ctx
