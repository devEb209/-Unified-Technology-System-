-- ARKHER SYSTEM O.0373 :: Mix Snapshot DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0373"
	S.key = "arkher.audio.mixsnapshot.dsp_chain"
	S.name = "Mix Snapshot DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mix Snapshot"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "mixsnapshot", "dsp", "audio" }
	S.description = "Mix Snapshot DSP Chain: biquad filtering, delay, envelope and soft clipping for the Mix Snapshot subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.mixsnapshot.dsp_chain", sampleRate = 22050, filter = "highpass", cutoff = 4200, q = 0.830 })
		inst.system = S
		inst.ctx = ctx
