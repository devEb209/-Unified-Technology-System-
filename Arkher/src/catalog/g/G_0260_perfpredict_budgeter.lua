-- ARKHER SYSTEM G.0260 :: Performance Prediction Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0260"
	S.key = "arkher.neural.perfpredict.compute_budget"
	S.name = "Performance Prediction Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perfpredict.quality_predictor" }
	S.tags = { "g", "perfpredict", "budgeter", "neural" }
	S.description = "Performance Prediction Compute Budget: inference time budget allocation for the Performance Prediction subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.perfpredict.compute_budget", total = 183, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
