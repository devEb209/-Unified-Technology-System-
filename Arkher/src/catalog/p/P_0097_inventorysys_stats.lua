-- ARKHER SYSTEM P.0097 :: Inventory Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0097"
	S.key = "arkher.play.inventorysys.attributes"
	S.name = "Inventory Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Inventory"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "inventorysys", "stats", "play" }
	S.description = "Inventory Attributes: base values, layered modifiers and derived statistics for the Inventory subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.inventorysys.attributes" })
		inst.system = S
		inst.ctx = ctx
