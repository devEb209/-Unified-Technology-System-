-- ARKHER SYSTEM Q.0090 :: Scroll View Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0090"
	S.key = "arkher.ui.scrollview.theme_composition"
	S.name = "Scroll View Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Scroll View"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.scrollview.navigation_graph" }
	S.tags = { "q", "scrollview", "composer", "ui" }
	S.description = "Scroll View Theme Composition: blending of theme signals into the final appearance for the Scroll View subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.scrollview.theme_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
