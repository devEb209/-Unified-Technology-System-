-- ARKHER SYSTEM H.0291 :: Box Collider Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0291"
	S.key = "arkher.physics.boxcollider.result_cache"
	S.name = "Box Collider Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Box Collider"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.boxcollider.simulation_policy" }
	S.tags = { "h", "boxcollider", "cache", "physics" }
	S.description = "Box Collider Result Cache: reuse of expensive simulation and query results for the Box Collider subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.boxcollider.result_cache", policy = "ttl", capacity = 435, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
