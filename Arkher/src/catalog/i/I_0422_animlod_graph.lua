-- ARKHER SYSTEM I.0422 :: Animation LOD Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0422"
	S.key = "arkher.anim.animlod.retarget_graph"
	S.name = "Animation LOD Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlod.physical_blend" }
	S.tags = { "i", "animlod", "graph", "anim" }
	S.description = "Animation LOD Retarget Graph: bone mapping and retarget path resolution for the Animation LOD subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.animlod.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
