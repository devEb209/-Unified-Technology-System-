-- ARKHER SYSTEM Z.0504 :: Economic Emergence Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0504"
	S.key = "arkher.origin.economicemergence.autonomous_pipeline"
	S.name = "Economic Emergence Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.economicemergence.simulation_fabric" }
	S.tags = { "z", "economicemergence", "autopipeline", "origin" }
	S.description = "Economic Emergence Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.economicemergence.autonomous_pipeline", maxIterations = 10 })
		inst.system = S
		inst.ctx = ctx
