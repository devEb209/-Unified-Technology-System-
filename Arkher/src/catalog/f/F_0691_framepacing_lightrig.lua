-- ARKHER SYSTEM F.0691 :: Frame Pacing Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0691"
	S.key = "arkher.render.framepacing.lighting_rig"
	S.name = "Frame Pacing Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Frame Pacing"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepacing.geometry_virtualization" }
	S.tags = { "f", "framepacing", "lightrig", "render" }
	S.description = "Frame Pacing Lighting Rig: light clustering, importance and cascades for the Frame Pacing subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.framepacing.lighting_rig", maxActive = 8 })
		inst.system = S
		inst.ctx = ctx
