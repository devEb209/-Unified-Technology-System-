-- ARKHER SYSTEM L.0456 :: Justice Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0456"
	S.key = "arkher.sim.justice.region_graph"
	S.name = "Justice Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.justice.calendar" }
	S.tags = { "l", "justice", "graph", "sim" }
	S.description = "Justice Region Graph: connectivity, components and shortest path between places for the Justice subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.justice.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
