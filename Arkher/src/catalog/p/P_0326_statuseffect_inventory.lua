-- ARKHER SYSTEM P.0326 :: Status Effect Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0326"
	S.key = "arkher.play.statuseffect.inventory"
	S.name = "Status Effect Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.statuseffect.attributes" }
	S.tags = { "p", "statuseffect", "inventory", "play" }
	S.description = "Status Effect Inventory: slots, stacking, weight, equipment and crafting for the Status Effect subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.statuseffect.inventory", slots = 28, maxWeight = 40 })
		inst.system = S
		inst.ctx = ctx
