-- ARKHER SYSTEM T.0194 :: Terrain Generation Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0194"
	S.key = "arkher.ai.terraingeneration.model_inference"
	S.name = "Terrain Generation Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.terraingeneration.action_planner" }
	S.tags = { "t", "terraingeneration", "inference", "ai" }
	S.description = "Terrain Generation Model Inference: quantized inference with batching and budget for the Terrain Generation subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.terraingeneration.model_inference", seed = 31706 })
		inst.system = S
		inst.ctx = ctx
