-- ARKHER SYSTEM I.0440 :: Crowd Animation Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0440"
	S.key = "arkher.anim.crowdanim.quality_policy"
	S.name = "Crowd Animation Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crowdanim.pose_cache" }
	S.tags = { "i", "crowdanim", "policy", "anim" }
	S.description = "Crowd Animation Quality Policy: device tier rules for rate, bones and solvers for the Crowd Animation subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.crowdanim.quality_policy", algorithm = "roundrobin", starvationGuard = 40 })
		inst.system = S
		inst.ctx = ctx
