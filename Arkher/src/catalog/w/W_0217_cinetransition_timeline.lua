-- ARKHER SYSTEM W.0217 :: Transition Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0217"
	S.key = "arkher.cine.cinetransition.sequence_timeline"
	S.name = "Transition Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Transition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "cinetransition", "timeline", "cine" }
	S.description = "Transition Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Transition subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.cinetransition.sequence_timeline", duration = 11.0, rate = 1.19 })
		inst.system = S
		inst.ctx = ctx
