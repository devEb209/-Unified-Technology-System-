-- ARKHER SYSTEM W.0040 :: Establishing Shot Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0040"
	S.key = "arkher.cine.establishing.shot_composition"
	S.name = "Establishing Shot Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.establishing.colour_grade" }
	S.tags = { "w", "establishing", "composer", "cine" }
	S.description = "Establishing Shot Shot Composition: blending of the signals that make up the final shot for the Establishing Shot subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.establishing.shot_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
