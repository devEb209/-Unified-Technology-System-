-- ARKHER SYSTEM I.0490 :: Morph Target Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0490"
	S.key = "arkher.anim.morphtarget.playback_pipeline"
	S.name = "Morph Target Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Morph Target"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.morphtarget.event_ledger" }
	S.tags = { "i", "morphtarget", "pipeline", "anim" }
	S.description = "Morph Target Playback Pipeline: ordered sample, blend, ik and output stages for the Morph Target subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.morphtarget.playback_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
