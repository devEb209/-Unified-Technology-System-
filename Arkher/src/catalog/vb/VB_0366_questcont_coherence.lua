-- ARKHER SYSTEM VB.0366 :: Quest Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0366"
	S.key = "arkher.conttime.questcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.questcont.persistent_state" }
	S.tags = { "vb", "questcont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.questcont.coherence_guard", window = 121, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
