-- ARKHER SYSTEM J.0272 :: Wetness Response Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0272"
	S.key = "arkher.character.wetnessresponse.variant_registry"
	S.name = "Wetness Response Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.wetnessresponse.appearance_composer" }
	S.tags = { "j", "wetnessresponse", "registry", "character" }
	S.description = "Wetness Response Variant Registry: named character variants and their lifecycle for the Wetness Response subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.wetnessresponse.variant_registry" })
		inst.system = S
		inst.ctx = ctx
