-- ARKHER SYSTEM R.0303 :: Cross Server Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0303"
	S.key = "arkher.net.crossserver.prediction_and_reconciliation"
	S.name = "Cross Server Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Cross Server"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.crossserver.time_sync" }
	S.tags = { "r", "crossserver", "prediction", "net" }
	S.description = "Cross Server Prediction And Reconciliation: client simulation, correction and input replay for the Cross Server subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.crossserver.prediction_and_reconciliation", errorThreshold = 0.050, smoothing = 12.0, maxInputs = 140 })
		inst.system = S
		inst.ctx = ctx
