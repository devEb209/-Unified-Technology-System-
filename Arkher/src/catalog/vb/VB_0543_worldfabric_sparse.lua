-- ARKHER SYSTEM VB.0543 :: World Fabric Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0543"
	S.key = "arkher.conttime.worldfabric.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldfabric.epoch_clock" }
	S.tags = { "vb", "worldfabric", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.worldfabric.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
