-- ARKHER SYSTEM Q.0133 :: Menu Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0133"
	S.key = "arkher.ui.menu.responsive_layout"
	S.name = "Menu Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Menu"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "menu", "flex", "ui" }
	S.description = "Menu Responsive Layout: flex solving with safe areas, weights and breakpoints for the Menu subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.menu.responsive_layout", width = 510, height = 1084, scale = 0.94 })
		inst.system = S
		inst.ctx = ctx
