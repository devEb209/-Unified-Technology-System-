-- ARKHER SYSTEM E.0170 :: Clear Coat Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0170"
	S.key = "arkher.material.clearcoat.procedural_detail"
	S.name = "Clear Coat Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Clear Coat"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.clearcoat.texture_sampling" }
	S.tags = { "e", "clearcoat", "field", "material" }
	S.description = "Clear Coat Procedural Detail: coherent noise detail driving the surface for the Clear Coat subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.clearcoat.procedural_detail", seed = 27329, frequency = 0.0063, octaves = 4, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
		...
		function inst.integrate(engine)
			...
			inst.engine = engine
			if engine.bus then
				engine.bus:subscribe("arkher.material.clearcoat.*", function(payload) inst.lastSignal = payload end)
			end
