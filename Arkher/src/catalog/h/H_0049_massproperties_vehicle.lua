-- ARKHER SYSTEM H.0049 :: Mass Properties Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0049"
	S.key = "arkher.physics.massproperties.vehicle"
	S.name = "Mass Properties Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.massproperties.character_motion" }
	S.tags = { "h", "massproperties", "vehicle", "physics" }
	S.description = "Mass Properties Vehicle: suspension, drivetrain, steering and tire friction for the Mass Properties subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.massproperties.vehicle", mass = 1100, wheelbase = 2.20, track = 1.40, maxRpm = 5600 })
		inst.system = S
		inst.ctx = ctx
