-- ARKHER SYSTEM T.0507 :: Render Reasoning Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0507"
	S.key = "arkher.ai.renderreasoning.plan_workflow"
	S.name = "Render Reasoning Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.renderreasoning.semantic_knowledge" }
	S.tags = { "t", "renderreasoning", "workflow", "ai" }
	S.description = "Render Reasoning Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Render Reasoning subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.renderreasoning.plan_workflow", maxRetries = 3, budget = 60 })
		inst.system = S
		inst.ctx = ctx
