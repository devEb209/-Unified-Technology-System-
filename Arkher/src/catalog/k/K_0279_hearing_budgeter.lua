-- ARKHER SYSTEM K.0279 :: Hearing Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0279"
	S.key = "arkher.npc.hearing.thinking_budget"
	S.name = "Hearing Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hearing.daily_schedule" }
	S.tags = { "k", "hearing", "budgeter", "npc" }
	S.description = "Hearing Thinking Budget: allocation of per-frame thinking time across NPCs for the Hearing subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.hearing.thinking_budget", total = 267, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
