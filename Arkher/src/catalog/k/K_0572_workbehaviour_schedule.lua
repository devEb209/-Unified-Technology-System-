-- ARKHER SYSTEM K.0572 :: Work Behaviour Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0572"
	S.key = "arkher.npc.workbehaviour.daily_schedule"
	S.name = "Work Behaviour Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workbehaviour.social_relations" }
	S.tags = { "k", "workbehaviour", "schedule", "npc" }
	S.description = "Work Behaviour Daily Schedule: hour-by-hour routine with priority interruptions for the Work Behaviour subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.workbehaviour.daily_schedule", startHour = 6 })
		inst.system = S
		inst.ctx = ctx
