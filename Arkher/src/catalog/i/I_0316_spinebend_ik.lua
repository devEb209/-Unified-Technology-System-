-- ARKHER SYSTEM I.0316 :: Spine Bend Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0316"
	S.key = "arkher.anim.spinebend.inverse_kinematics"
	S.name = "Spine Bend Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Spine Bend"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.spinebend.layered_blending" }
	S.tags = { "i", "spinebend", "ik", "anim" }
	S.description = "Spine Bend Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Spine Bend subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.spinebend.inverse_kinematics", iterations = 4, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
