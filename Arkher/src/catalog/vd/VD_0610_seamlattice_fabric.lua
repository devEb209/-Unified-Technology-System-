-- ARKHER SYSTEM VD.0610 :: Seam Lattice Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0610"
	S.key = "arkher.contsim.seamlattice.simulation_fabric"
	S.name = "Seam Lattice Simulation Fabric"
	S.category = "VD"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.seamlattice.complexity_budget" }
	S.tags = { "vd", "seamlattice", "fabric", "contsim" }
	S.description = "Seam Lattice Simulation Fabric: fabric stepping the continuum domains for the Seam Lattice subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.seamlattice.simulation_fabric", budgetMs = 4.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
