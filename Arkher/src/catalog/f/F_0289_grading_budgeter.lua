-- ARKHER SYSTEM F.0289 :: Color Grading Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0289"
	S.key = "arkher.render.grading.draw_budget"
	S.name = "Color Grading Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.grading.adaptive_resolution" }
	S.tags = { "f", "grading", "budgeter", "render" }
	S.description = "Color Grading Draw Budget: draw call and triangle budget allocation for the Color Grading subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.grading.draw_budget", total = 351, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
