-- ARKHER SYSTEM L.0057 :: Catch Up Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0057"
	S.key = "arkher.sim.catchup.aggregate_cache"
	S.name = "Catch Up Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.catchup.fidelity_policy" }
	S.tags = { "l", "catchup", "cache", "sim" }
	S.description = "Catch Up Aggregate Cache: reuse of expensive aggregate computations for the Catch Up subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.catchup.aggregate_cache", policy = "lfu", capacity = 341, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
