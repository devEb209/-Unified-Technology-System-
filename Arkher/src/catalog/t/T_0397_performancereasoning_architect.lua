-- ARKHER SYSTEM T.0397 :: Performance Reasoning World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0397"
	S.key = "arkher.ai.performancereasoning.world_architect"
	S.name = "Performance Reasoning World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.performancereasoning.self_critique" }
	S.tags = { "t", "performancereasoning", "architect", "ai" }
	S.description = "Performance Reasoning World Architect: composition of a whole world plan with conserved budgets for the Performance Reasoning subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.performancereasoning.world_architect", budget = 600, seed = 82310 })
		inst.system = S
		inst.ctx = ctx
