-- ARKHER SYSTEM E.0238 :: Layer Blending Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0238"
	S.key = "arkher.material.layerblend.authoring_pipeline"
	S.name = "Layer Blending Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.layerblend.analysis" }
	S.tags = { "e", "layerblend", "pipeline", "material" }
	S.description = "Layer Blending Authoring Pipeline: ordered authoring and bake stages for the Layer Blending subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.layerblend.authoring_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
