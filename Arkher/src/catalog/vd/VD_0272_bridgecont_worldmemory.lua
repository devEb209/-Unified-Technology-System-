-- ARKHER SYSTEM VD.0272 :: Bridge Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0272"
	S.key = "arkher.contsim.bridgecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.bridgecont.neural_field" }
	S.tags = { "vd", "bridgecont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.bridgecont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
