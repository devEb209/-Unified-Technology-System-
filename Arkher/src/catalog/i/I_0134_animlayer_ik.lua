-- ARKHER SYSTEM I.0134 :: Animation Layer Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0134"
	S.key = "arkher.anim.animlayer.inverse_kinematics"
	S.name = "Animation Layer Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlayer.layered_blending" }
	S.tags = { "i", "animlayer", "ik", "anim" }
	S.description = "Animation Layer Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Animation Layer subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.animlayer.inverse_kinematics", iterations = 5, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
