-- ARKHER SYSTEM L.0061 :: Population Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0061"
	S.key = "arkher.sim.population.simulation_core"
	S.name = "Population Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "population", "simulation", "sim" }
	S.description = "Population Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Population subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.population.simulation_core", fullRadius = 160, reducedRadius = 700, budget = 105 })
		inst.system = S
		inst.ctx = ctx
