-- ARKHER SYSTEM K.0031 :: Learning Loop Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0031"
	S.key = "arkher.npc.learningloop.drive_system"
	S.name = "Learning Loop Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.learningloop.memory" }
	S.tags = { "k", "learningloop", "need", "npc" }
	S.description = "Learning Loop Drive System: drives that decay, turn urgent and get satisfied for the Learning Loop subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.learningloop.drive_system" })
		inst.system = S
		inst.ctx = ctx
