-- ARKHER SYSTEM VC.0051 :: Epoch Frame Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0051"
	S.key = "arkher.contneural.epochframe.sparse_residency"
	S.name = "Epoch Frame Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.epochframe.epoch_clock" }
	S.tags = { "vc", "epochframe", "sparse", "contneural" }
	S.description = "Epoch Frame Sparse Residency: sparse page residency with eviction and compression for the Epoch Frame subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.epochframe.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
