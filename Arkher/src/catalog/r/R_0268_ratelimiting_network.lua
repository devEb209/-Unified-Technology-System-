-- ARKHER SYSTEM R.0268 :: Rate Limiting Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0268"
	S.key = "arkher.net.ratelimiting.transport_graph"
	S.name = "Rate Limiting Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.ratelimiting.prediction_and_reconciliation" }
	S.tags = { "r", "ratelimiting", "network", "net" }
	S.description = "Rate Limiting Transport Graph: topology, capacity and routing between endpoints for the Rate Limiting subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.ratelimiting.transport_graph" })
		inst.system = S
		inst.ctx = ctx
