-- ARKHER SYSTEM P.0424 :: Party Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0424"
	S.key = "arkher.play.party.combat_resolution"
	S.name = "Party Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Party"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.party.objectives" }
	S.tags = { "p", "party", "combat", "play" }
	S.description = "Party Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Party subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.party.combat_resolution", seed = 26251, armourK = 110, critMultiplier = 2.20 })
		inst.system = S
		inst.ctx = ctx
