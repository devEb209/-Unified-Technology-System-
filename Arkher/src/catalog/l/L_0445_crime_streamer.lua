-- ARKHER SYSTEM L.0445 :: Crime Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0445"
	S.key = "arkher.sim.crime.streaming"
	S.name = "Crime Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.crime.state_codec" }
	S.tags = { "l", "crime", "streamer", "sim" }
	S.description = "Crime Streaming: distance-driven residency of simulated regions for the Crime subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.crime.streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
