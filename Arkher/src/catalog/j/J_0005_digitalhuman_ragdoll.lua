-- ARKHER SYSTEM J.0005 :: Digital Human Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0005"
	S.key = "arkher.character.digitalhuman.physical_response"
	S.name = "Digital Human Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.digitalhuman.look_and_reach" }
	S.tags = { "j", "digitalhuman", "ragdoll", "character" }
	S.description = "Digital Human Physical Response: physical reaction, ragdoll and recovery for the Digital Human subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.digitalhuman.physical_response", blendSpeed = 2.30 })
		inst.system = S
		inst.ctx = ctx
