-- ARKHER SYSTEM W.0035 :: Scene Cut Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0035"
	S.key = "arkher.cine.scenecut.sequence_analysis"
	S.name = "Scene Cut Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Scene Cut"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.scenecut.frame_budget" }
	S.tags = { "w", "scenecut", "analyzer", "cine" }
	S.description = "Scene Cut Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Scene Cut subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.scenecut.sequence_analysis", window = 134, buckets = 10, threshold = 4.60 })
		inst.system = S
		inst.ctx = ctx
