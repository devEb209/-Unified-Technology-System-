--!strict
-- Sketchfab — ANIMATION Mixer #0247
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Sketchfab — ANIMATION Mixer #0247", size=Vector2.new(640, 460), pos=UDim2.fromOffset(111, 119), parent=parent, icon="◨"})
...
Components.Slider(right, "Rate", 0,3000,600, function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_Rate"..247, v) end end)
