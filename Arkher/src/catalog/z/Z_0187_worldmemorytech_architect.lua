-- ARKHER SYSTEM Z.0187 :: World Memory World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0187"
	S.key = "arkher.origin.worldmemorytech.world_architect"
	S.name = "World Memory World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldmemorytech.emergence_detection" }
	S.tags = { "z", "worldmemorytech", "architect", "origin" }
	S.description = "World Memory World Architect: hierarchical world composition with conserved budgets for the World Memory subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.worldmemorytech.world_architect", budget = 800, seed = 96342 })
		inst.system = S
		inst.ctx = ctx
