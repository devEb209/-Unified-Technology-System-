-- ARKHER SYSTEM G.0319 :: Weight Quantization Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0319"
	S.key = "arkher.neural.quantization.error_analysis"
	S.name = "Weight Quantization Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.quantization.heuristic_policy" }
	S.tags = { "g", "quantization", "analyzer", "neural" }
	S.description = "Weight Quantization Error Analysis: residual and drift analysis for the Weight Quantization subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.quantization.error_analysis", window = 182, buckets = 18, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
