-- ARKHER SYSTEM R.0210 :: Server Reconciliation Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0210"
	S.key = "arkher.net.serverreconciliation.serialization_codec"
	S.name = "Server Reconciliation Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverreconciliation.bandwidth_budget" }
	S.tags = { "r", "serverreconciliation", "codec", "net" }
	S.description = "Server Reconciliation Serialization Codec: compact encoding, diffing and checksum of payloads for the Server Reconciliation subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.serverreconciliation.serialization_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
