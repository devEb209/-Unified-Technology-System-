-- ARKHER SYSTEM VB.0553 :: Device Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0553"
	S.key = "arkher.conttime.devicecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "devicecont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.devicecont.infinite_grid", cellSize = 192, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
