-- ARKHER SYSTEM F.0371 :: Render Scale Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0371"
	S.key = "arkher.render.renderscale.temporal_resolve"
	S.name = "Render Scale Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Render Scale"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.renderscale.probe_volume" }
	S.tags = { "f", "renderscale", "temporal", "render" }
	S.description = "Render Scale Temporal Resolve: history reprojection with neighbourhood clamping for the Render Scale subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.renderscale.temporal_resolve", feedback = 0.81, phase = 8 })
		inst.system = S
		inst.ctx = ctx
