-- ARKHER SYSTEM VC.0342 :: Society Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0342"
	S.key = "arkher.contneural.societycont.coherence_guard"
	S.name = "Society Continuum Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.societycont.persistent_state" }
	S.tags = { "vc", "societycont", "coherence", "contneural" }
	S.description = "Society Continuum Coherence Guard: seam coherence and drift supervision for the Society Continuum subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.societycont.coherence_guard", window = 69, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
