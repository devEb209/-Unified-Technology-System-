-- ARKHER SYSTEM W.0116 :: Orbit Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0116"
	S.key = "arkher.cine.orbit.cinematic_mix"
	S.name = "Orbit Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Orbit"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.orbit.motion_tween" }
	S.tags = { "w", "orbit", "mixer", "cine" }
	S.description = "Orbit Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Orbit subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.orbit.cinematic_mix", maxVoices = 48 })
		inst.system = S
		inst.ctx = ctx
