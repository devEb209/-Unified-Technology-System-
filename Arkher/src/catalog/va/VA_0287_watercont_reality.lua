-- ARKHER SYSTEM VA.0287 :: Water Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0287"
	S.key = "arkher.contworld.watercont.reality_continuum"
	S.name = "Water Continuum Reality Continuum"
	S.category = "VA"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.watercont.simulation_fabric" }
	S.tags = { "va", "watercont", "reality", "contworld" }
	S.description = "Water Continuum Reality Continuum: stacked reality layers of the continuum for the Water Continuum subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.watercont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
