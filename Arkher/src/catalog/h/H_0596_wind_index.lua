-- ARKHER SYSTEM H.0596 :: Wind Force Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0596"
	S.key = "arkher.physics.wind.broadphase_index"
	S.name = "Wind Force Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Wind Force"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.wind.vehicle" }
	S.tags = { "h", "wind", "index", "physics" }
	S.description = "Wind Force Broadphase Index: spatial acceleration of candidate pair finding for the Wind Force subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.wind.broadphase_index", mode = "hash", cellSize = 48 })
		inst.system = S
		inst.ctx = ctx
