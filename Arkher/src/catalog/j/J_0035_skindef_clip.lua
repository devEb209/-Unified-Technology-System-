-- ARKHER SYSTEM J.0035 :: Skin Definition Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0035"
	S.key = "arkher.character.skindef.motion_set"
	S.name = "Skin Definition Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.skindef.rig_definition" }
	S.tags = { "j", "skindef", "clip", "character" }
	S.description = "Skin Definition Motion Set: the clips a character owns and how they sample for the Skin Definition subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.skindef.motion_set", duration = 1.60, loop = true })
		inst.system = S
		inst.ctx = ctx
