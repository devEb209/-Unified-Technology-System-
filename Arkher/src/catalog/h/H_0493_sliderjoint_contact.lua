-- ARKHER SYSTEM H.0493 :: Slider Joint Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0493"
	S.key = "arkher.physics.sliderjoint.contact_generation"
	S.name = "Slider Joint Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Slider Joint"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sliderjoint.collision_shape" }
	S.tags = { "h", "sliderjoint", "contact", "physics" }
	S.description = "Slider Joint Contact Generation: narrow-phase manifolds with normal, depth and point for the Slider Joint subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.sliderjoint.contact_generation", slop = 0.0080, maxManifolds = 508 })
		inst.system = S
		inst.ctx = ctx
