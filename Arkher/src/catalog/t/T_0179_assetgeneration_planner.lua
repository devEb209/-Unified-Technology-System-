-- ARKHER SYSTEM T.0179 :: Asset Generation Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0179"
	S.key = "arkher.ai.assetgeneration.action_planner"
	S.name = "Asset Generation Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.assetgeneration.utility_selection" }
	S.tags = { "t", "assetgeneration", "planner", "ai" }
	S.description = "Asset Generation Action Planner: goal-oriented action planning over preconditions for the Asset Generation subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.assetgeneration.action_planner", maxDepth = 11 })
		inst.system = S
		inst.ctx = ctx
