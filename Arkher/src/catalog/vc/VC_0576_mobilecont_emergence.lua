-- ARKHER SYSTEM VC.0576 :: Mobile Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0576"
	S.key = "arkher.contneural.mobilecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.mobilecont.reality_continuum" }
	S.tags = { "vc", "mobilecont", "emergence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.mobilecont.emergence_continuum", windowSize = 4, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
