-- ARKHER SYSTEM R.0220 :: Lag Compensation Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0220"
	S.key = "arkher.net.lagcompensation.transport_graph"
	S.name = "Lag Compensation Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.lagcompensation.prediction_and_reconciliation" }
	S.tags = { "r", "lagcompensation", "network", "net" }
	S.description = "Lag Compensation Transport Graph: topology, capacity and routing between endpoints for the Lag Compensation subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.lagcompensation.transport_graph" })
		inst.system = S
		inst.ctx = ctx
