-- ARKHER SYSTEM VD.0087 :: Residency Window Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0087"
	S.key = "arkher.contsim.residencywindow.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.residencywindow.epoch_clock" }
	S.tags = { "vd", "residencywindow", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.residencywindow.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
