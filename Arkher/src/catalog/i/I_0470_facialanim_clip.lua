-- ARKHER SYSTEM I.0470 :: Facial Animation Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0470"
	S.key = "arkher.anim.facialanim.clip_sampling"
	S.name = "Facial Animation Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.facialanim.skeleton" }
	S.tags = { "i", "facialanim", "clip", "anim" }
	S.description = "Facial Animation Clip Sampling: keyframe tracks sampled, retimed and evented for the Facial Animation subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.facialanim.clip_sampling", duration = 2.00, loop = true })
		inst.system = S
		inst.ctx = ctx
