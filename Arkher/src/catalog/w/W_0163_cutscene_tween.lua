-- ARKHER SYSTEM W.0163 :: Cutscene Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0163"
	S.key = "arkher.cine.cutscene.motion_tween"
	S.name = "Cutscene Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Cutscene"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cutscene.playback_orchestrator" }
	S.tags = { "w", "cutscene", "tween", "cine" }
	S.description = "Cutscene Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Cutscene subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.cutscene.motion_tween", timeScale = 1.00 })
		inst.system = S
		inst.ctx = ctx
