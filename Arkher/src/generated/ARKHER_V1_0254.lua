...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Nuke Nodal — CORE Profiler #0254", size=Vector2.new(680, 500), pos=UDim2.fromOffset(202, 238), parent=parent, icon="◉"})
