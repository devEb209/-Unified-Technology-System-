-- ARKHER SYSTEM VA.0275 :: Bridge Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0275"
	S.key = "arkher.contworld.bridgecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.bridgecont.simulation_fabric" }
	S.tags = { "va", "bridgecont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.bridgecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
