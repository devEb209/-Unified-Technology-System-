-- ARKHER SYSTEM Z.0395 :: Thermal Aware Simulation Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0395"
	S.key = "arkher.origin.thermalaware.signal_composition"
	S.name = "Thermal Aware Simulation Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.telemetry_ledger" }
	S.tags = { "z", "thermalaware", "composer", "origin" }
	S.description = "Thermal Aware Simulation Signal Composition: blending of the technology's input signals into one output for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.thermalaware.signal_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
