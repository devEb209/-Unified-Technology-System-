-- ARKHER SYSTEM VD.0071 :: Sparse Page Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0071"
	S.key = "arkher.contsim.sparsepage.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.sparsepage.simulation_fabric" }
	S.tags = { "vd", "sparsepage", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.sparsepage.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
