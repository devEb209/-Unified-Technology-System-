-- ARKHER SYSTEM H.0037 :: Kinematic Body Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0037"
	S.key = "arkher.physics.kinematicbody.budget_governor"
	S.name = "Kinematic Body Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.kinematicbody.broadphase_index" }
	S.tags = { "h", "kinematicbody", "budgeter", "physics" }
	S.description = "Kinematic Body Budget Governor: simulation time budget allocation across islands for the Kinematic Body subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.kinematicbody.budget_governor", total = 453, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
