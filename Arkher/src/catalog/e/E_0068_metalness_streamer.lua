-- ARKHER SYSTEM E.0068 :: Metalness Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0068"
	S.key = "arkher.material.metalness.streaming"
	S.name = "Metalness Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Metalness"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.metalness.parameter_budget" }
	S.tags = { "e", "metalness", "streamer", "material" }
	S.description = "Metalness Streaming: residency and demand-driven texture streaming for the Metalness subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.metalness.streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
