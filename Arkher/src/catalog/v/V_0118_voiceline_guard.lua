-- ARKHER SYSTEM V.0118 :: Voice Line Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0118"
	S.key = "arkher.asset.voiceline.validation_guard"
	S.name = "Voice Line Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.voiceline.size_budget" }
	S.tags = { "v", "voiceline", "guard", "asset" }
	S.description = "Voice Line Validation Guard: rate limiting and capability checks on the import path for the Voice Line subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.voiceline.validation_guard", algorithm = "leaky", capacity = 76, refillPerSec = 61, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
