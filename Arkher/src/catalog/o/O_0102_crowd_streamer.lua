-- ARKHER SYSTEM O.0102 :: Crowd Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0102"
	S.key = "arkher.audio.crowd.streaming"
	S.name = "Crowd Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Crowd"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.crowd.voice_budget" }
	S.tags = { "o", "crowd", "streamer", "audio" }
	S.description = "Crowd Streaming: distance-driven residency of audio assets for the Crowd subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.crowd.streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
