-- ARKHER SYSTEM I.0388 :: Bone Mapping Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0388"
	S.key = "arkher.anim.bonemapping.quality_policy"
	S.name = "Bone Mapping Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bone Mapping"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonemapping.pose_cache" }
	S.tags = { "i", "bonemapping", "policy", "anim" }
	S.description = "Bone Mapping Quality Policy: device tier rules for rate, bones and solvers for the Bone Mapping subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.bonemapping.quality_policy", algorithm = "wfq", starvationGuard = 22 })
		inst.system = S
		inst.ctx = ctx
