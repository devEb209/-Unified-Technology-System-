-- ARKHER SYSTEM VC.0061 :: Sparse Page Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0061"
	S.key = "arkher.contneural.sparsepage.infinite_grid"
	S.name = "Sparse Page Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "sparsepage", "continuum", "contneural" }
	S.description = "Sparse Page Infinite Grid: seamless paging of the infinite world grid for the Sparse Page subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.sparsepage.infinite_grid", cellSize = 96, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
