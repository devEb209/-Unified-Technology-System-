-- ARKHER SYSTEM K.0600 :: Relationship Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0600"
	S.key = "arkher.npc.relationship.daily_schedule"
	S.name = "Relationship Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.relationship.social_relations" }
	S.tags = { "k", "relationship", "schedule", "npc" }
	S.description = "Relationship Daily Schedule: hour-by-hour routine with priority interruptions for the Relationship subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.relationship.daily_schedule", startHour = 9 })
		inst.system = S
		inst.ctx = ctx
