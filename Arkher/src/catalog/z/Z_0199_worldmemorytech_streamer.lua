-- ARKHER SYSTEM Z.0199 :: World Memory Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0199"
	S.key = "arkher.origin.worldmemorytech.residency_streaming"
	S.name = "World Memory Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldmemorytech.budget_governor" }
	S.tags = { "z", "worldmemorytech", "streamer", "origin" }
	S.description = "World Memory Residency Streaming: distance-driven residency of the technology's workload for the World Memory subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.worldmemorytech.residency_streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
