-- ARKHER SYSTEM O.0193 :: Reverb Zone DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0193"
	S.key = "arkher.audio.reverbzone.dsp_chain"
	S.name = "Reverb Zone DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Reverb Zone"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "reverbzone", "dsp", "audio" }
	S.description = "Reverb Zone DSP Chain: biquad filtering, delay, envelope and soft clipping for the Reverb Zone subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.reverbzone.dsp_chain", sampleRate = 22050, filter = "lowpass", cutoff = 5100, q = 0.860 })
		inst.system = S
		inst.ctx = ctx
