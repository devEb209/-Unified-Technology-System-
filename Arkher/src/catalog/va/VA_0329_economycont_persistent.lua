-- ARKHER SYSTEM VA.0329 :: Economy Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0329"
	S.key = "arkher.contworld.economycont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.economycont.multi-scale_fidelity" }
	S.tags = { "va", "economycont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.economycont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
