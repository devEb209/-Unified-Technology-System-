-- ARKHER SYSTEM Z.0165 :: Self Analyzing Project World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0165"
	S.key = "arkher.origin.selfanalyzing.world_memory"
	S.name = "Self Analyzing Project World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.autonomous_pipeline" }
	S.tags = { "z", "selfanalyzing", "worldmemory", "origin" }
	S.description = "Self Analyzing Project World Memory: epoch-stamped persistent history with compaction and checkpoints for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.selfanalyzing.world_memory", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
