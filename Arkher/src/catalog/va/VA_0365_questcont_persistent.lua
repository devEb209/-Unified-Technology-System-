-- ARKHER SYSTEM VA.0365 :: Quest Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0365"
	S.key = "arkher.contworld.questcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.questcont.multi-scale_fidelity" }
	S.tags = { "va", "questcont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.questcont.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
