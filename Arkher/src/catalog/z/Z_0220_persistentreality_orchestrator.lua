-- ARKHER SYSTEM Z.0220 :: Persistent Reality State Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0220"
	S.key = "arkher.origin.persistentreality.orchestration"
	S.name = "Persistent Reality State Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.residency_streaming" }
	S.tags = { "z", "persistentreality", "orchestrator", "origin" }
	S.description = "Persistent Reality State Orchestration: lifecycle and phase orchestration of the technology for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.persistentreality.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
