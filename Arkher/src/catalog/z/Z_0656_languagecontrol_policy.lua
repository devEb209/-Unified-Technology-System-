-- ARKHER SYSTEM Z.0656 :: Natural Language Engine Control Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0656"
	S.key = "arkher.origin.languagecontrol.governance_policy"
	S.name = "Natural Language Engine Control Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.languagecontrol.signal_composition" }
	S.tags = { "z", "languagecontrol", "policy", "origin" }
	S.description = "Natural Language Engine Control Governance Policy: ordered rules governing when the technology may act for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.languagecontrol.governance_policy", algorithm = "wfq", starvationGuard = 30 })
		inst.system = S
		inst.ctx = ctx
