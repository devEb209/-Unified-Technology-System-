-- ARKHER SYSTEM VC.0274 :: Bridge Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0274"
	S.key = "arkher.contneural.bridgecont.simulation_fabric"
	S.name = "Bridge Continuum Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.bridgecont.complexity_budget" }
	S.tags = { "vc", "bridgecont", "fabric", "contneural" }
	S.description = "Bridge Continuum Simulation Fabric: fabric stepping the continuum domains for the Bridge Continuum subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.bridgecont.simulation_fabric", budgetMs = 3.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
