-- ARKHER SYSTEM H.0012 :: Rigid Body Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0012"
	S.key = "arkher.physics.rigidbody.analysis"
	S.name = "Rigid Body Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Rigid Body"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rigidbody.result_cache" }
	S.tags = { "h", "rigidbody", "analyzer", "physics" }
	S.description = "Rigid Body Analysis: energy, jitter and cost analysis of the simulation for the Rigid Body subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.rigidbody.analysis", window = 242, buckets = 14, threshold = 4.40 })
		inst.system = S
		inst.ctx = ctx
