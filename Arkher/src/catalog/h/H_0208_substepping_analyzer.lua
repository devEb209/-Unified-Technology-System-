-- ARKHER SYSTEM H.0208 :: Substepping Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0208"
	S.key = "arkher.physics.substepping.analysis"
	S.name = "Substepping Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Substepping"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.substepping.result_cache" }
	S.tags = { "h", "substepping", "analyzer", "physics" }
	S.description = "Substepping Analysis: energy, jitter and cost analysis of the simulation for the Substepping subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.substepping.analysis", window = 162, buckets = 18, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
