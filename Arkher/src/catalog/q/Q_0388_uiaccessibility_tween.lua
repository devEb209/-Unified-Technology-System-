-- ARKHER SYSTEM Q.0388 :: Accessibility Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0388"
	S.key = "arkher.ui.uiaccessibility.transition"
	S.name = "Accessibility Transition"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uiaccessibility.input_mapping" }
	S.tags = { "q", "uiaccessibility", "tween", "ui" }
	S.description = "Accessibility Transition: eased, delayed, looped and sequenced motion for the Accessibility subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.uiaccessibility.transition", timeScale = 0.93 })
		inst.system = S
		inst.ctx = ctx
