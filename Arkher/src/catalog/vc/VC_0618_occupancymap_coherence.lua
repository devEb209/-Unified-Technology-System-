-- ARKHER SYSTEM VC.0618 :: Occupancy Map Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0618"
	S.key = "arkher.contneural.occupancymap.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.occupancymap.persistent_state" }
	S.tags = { "vc", "occupancymap", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.occupancymap.coherence_guard", window = 50, threshold = 0.14 })
		inst.system = S
		inst.ctx = ctx
