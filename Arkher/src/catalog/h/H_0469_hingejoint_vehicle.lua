-- ARKHER SYSTEM H.0469 :: Hinge Joint Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0469"
	S.key = "arkher.physics.hingejoint.vehicle"
	S.name = "Hinge Joint Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Hinge Joint"
	S.aspect = "Vehicle"
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.hingejoint.character_motion" }
	S.tags = { "h", "hingejoint", "vehicle", "physics" }
	S.description = "Hinge Joint Vehicle: suspension, drivetrain, steering and tire friction for the Hinge Joint subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.hingejoint.vehicle", mass = 1500, wheelbase = 3.20, track = 1.60, maxRpm = 6600 })
		inst.system = S
		inst.ctx = ctx
