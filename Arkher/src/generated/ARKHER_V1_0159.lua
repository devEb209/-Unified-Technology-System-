--!strict
-- ESA WorldCover — ANIMATION Profiler #0159
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="ESA WorldCover — ANIMATION Profiler #0159", size=Vector2.new(600, 500), pos=UDim2.fromOffset(167, 183), parent=parent, icon="◣"})
...
Components.TextField(right, "File", "input.png", function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_File"..159, v) end end)
