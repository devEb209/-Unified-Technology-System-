-- ARKHER SYSTEM N.0335 :: Ribbon Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0335"
	S.key = "arkher.vfx.ribbonfx.quality_policy"
	S.name = "Ribbon Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Ribbon"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.ribbonfx.result_cache" }
	S.tags = { "n", "ribbonfx", "policy", "vfx" }
	S.description = "Ribbon Quality Policy: distance and device driven fidelity bands for the Ribbon subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.ribbonfx.quality_policy", algorithm = "roundrobin", starvationGuard = 44 })
		inst.system = S
		inst.ctx = ctx
