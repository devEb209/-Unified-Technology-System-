-- ARKHER SYSTEM R.0025 :: Handshake Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0025"
	S.key = "arkher.net.handshake.replication"
	S.name = "Handshake Replication"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Handshake"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "handshake", "replicator", "net" }
	S.description = "Handshake Replication: authoritative entity state, interest and delta snapshots for the Handshake subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.handshake.replication", mtu = 1050, interestRadius = 240, fullEvery = 75 })
		inst.system = S
		inst.ctx = ctx
