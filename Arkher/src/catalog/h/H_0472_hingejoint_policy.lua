-- ARKHER SYSTEM H.0472 :: Hinge Joint Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0472"
	S.key = "arkher.physics.hingejoint.simulation_policy"
	S.name = "Hinge Joint Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Hinge Joint"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.hingejoint.budget_governor" }
	S.tags = { "h", "hingejoint", "policy", "physics" }
	S.description = "Hinge Joint Simulation Policy: device tier rules for substeps, iterations and sleep for the Hinge Joint subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.hingejoint.simulation_policy", algorithm = "lottery", starvationGuard = 35 })
		inst.system = S
		inst.ctx = ctx
