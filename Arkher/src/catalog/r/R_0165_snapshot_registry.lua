-- ARKHER SYSTEM R.0165 :: Snapshot Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0165"
	S.key = "arkher.net.snapshot.session_registry"
	S.name = "Snapshot Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Snapshot"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.snapshot.rate_guard" }
	S.tags = { "r", "snapshot", "registry", "net" }
	S.description = "Snapshot Session Registry: catalogue of sessions, players and their metadata for the Snapshot subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.snapshot.session_registry" })
		inst.system = S
		inst.ctx = ctx
