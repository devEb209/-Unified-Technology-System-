-- ARKHER SYSTEM V.0314 :: Texture Atlas Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0314"
	S.key = "arkher.asset.atlas.bundling"
	S.name = "Texture Atlas Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.atlas.import" }
	S.tags = { "v", "atlas", "bundler", "asset" }
	S.description = "Texture Atlas Bundling: size-bounded packing, manifests and delta patches for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.atlas.bundling", maxBundleBytes = 917504 })
		inst.system = S
		inst.ctx = ctx
