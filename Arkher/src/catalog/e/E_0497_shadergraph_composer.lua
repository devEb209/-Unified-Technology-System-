-- ARKHER SYSTEM E.0497 :: Shader Graph Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0497"
	S.key = "arkher.material.shadergraph.layer_composition"
	S.name = "Shader Graph Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Shader Graph"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.shadergraph.definition" }
	S.tags = { "e", "shadergraph", "composer", "material" }
	S.description = "Shader Graph Layer Composition: ordered layer composition with blend rules for the Shader Graph subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.shadergraph.layer_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
