-- ARKHER SYSTEM K.0309 :: Threat Assessment Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0309"
	S.key = "arkher.npc.threatassessment.mind_network"
	S.name = "Threat Assessment Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "threatassessment", "mindnet", "npc" }
	S.description = "Threat Assessment Mind Network: the learned policy that turns perception into a decision for the Threat Assessment subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.threatassessment.mind_network", inputs = 6, hidden = 7, seed = 21368, learningRate = 0.090, exploration = 0.020 })
		inst.system = S
		inst.ctx = ctx
