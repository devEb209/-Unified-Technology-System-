-- ARKHER SYSTEM F.0286 :: Color Grading Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0286"
	S.key = "arkher.render.grading.probe_volume"
	S.name = "Color Grading Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.grading.lighting_rig" }
	S.tags = { "f", "grading", "probe", "render" }
	S.description = "Color Grading Probe Volume: irradiance probes encoded in spherical harmonics for the Color Grading subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.grading.probe_volume", spacing = 24 })
		inst.system = S
		inst.ctx = ctx
