-- ARKHER SYSTEM P.0302 :: Ranged Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0302"
	S.key = "arkher.play.ranged.inventory"
	S.name = "Ranged Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ranged"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ranged.attributes" }
	S.tags = { "p", "ranged", "inventory", "play" }
	S.description = "Ranged Inventory: slots, stacking, weight, equipment and crafting for the Ranged subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.ranged.inventory", slots = 20, maxWeight = 100 })
		inst.system = S
		inst.ctx = ctx
