-- ARKHER SYSTEM W.0404 :: Cinematic Debug Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0404"
	S.key = "arkher.cine.cinedebug.cinematic_mix"
	S.name = "Cinematic Debug Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinedebug.motion_tween" }
	S.tags = { "w", "cinedebug", "mixer", "cine" }
	S.description = "Cinematic Debug Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Cinematic Debug subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.cinedebug.cinematic_mix", maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
