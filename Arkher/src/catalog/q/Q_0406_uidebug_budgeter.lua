-- ARKHER SYSTEM Q.0406 :: UI Debug Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0406"
	S.key = "arkher.ui.uidebug.frame_budget"
	S.name = "UI Debug Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "UI Debug"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uidebug.accessibility_policy" }
	S.tags = { "q", "uidebug", "budgeter", "ui" }
	S.description = "UI Debug Frame Budget: per-frame layout and draw budget for the interface for the UI Debug subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.uidebug.frame_budget", total = 376, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
