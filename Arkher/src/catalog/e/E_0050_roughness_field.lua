-- ARKHER SYSTEM E.0050 :: Roughness Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0050"
	S.key = "arkher.material.roughness.procedural_detail"
	S.name = "Roughness Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Roughness"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.roughness.texture_sampling" }
	S.tags = { "e", "roughness", "field", "material" }
	S.description = "Roughness Procedural Detail: coherent noise detail driving the surface for the Roughness subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.roughness.procedural_detail", seed = 8812, frequency = 0.0070, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
