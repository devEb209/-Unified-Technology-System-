-- ARKHER SYSTEM F.0194 :: Sky Model Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0194"
	S.key = "arkher.render.sky.frame_analysis"
	S.name = "Sky Model Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sky Model"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sky.pass_cache" }
	S.tags = { "f", "sky", "analyzer", "render" }
	S.description = "Sky Model Frame Analysis: per-pass cost analysis and outlier detection for the Sky Model subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.sky.frame_analysis", window = 189, buckets = 13, threshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
