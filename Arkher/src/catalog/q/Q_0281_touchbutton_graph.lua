-- ARKHER SYSTEM Q.0281 :: Touch Button Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0281"
	S.key = "arkher.ui.touchbutton.navigation_graph"
	S.name = "Touch Button Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Touch Button"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.touchbutton.transition" }
	S.tags = { "q", "touchbutton", "graph", "ui" }
	S.description = "Touch Button Navigation Graph: screens, routes and shortest path between them for the Touch Button subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.touchbutton.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
