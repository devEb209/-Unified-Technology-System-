-- ARKHER SYSTEM Z.0609 :: Predictive Streaming Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0609"
	S.key = "arkher.origin.predictivestreaming.intent_bridge"
	S.name = "Predictive Streaming Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictivestreaming.semantic_graph" }
	S.tags = { "z", "predictivestreaming", "intent", "origin" }
	S.description = "Predictive Streaming Intent Bridge: natural language control surface for the technology for the Predictive Streaming subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.predictivestreaming.intent_bridge", minConfidence = 0.34 })
		inst.system = S
		inst.ctx = ctx
