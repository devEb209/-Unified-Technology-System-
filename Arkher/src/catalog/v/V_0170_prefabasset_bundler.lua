-- ARKHER SYSTEM V.0170 :: Prefab Asset Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0170"
	S.key = "arkher.asset.prefabasset.bundling"
	S.name = "Prefab Asset Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.prefabasset.import" }
	S.tags = { "v", "prefabasset", "bundler", "asset" }
	S.description = "Prefab Asset Bundling: size-bounded packing, manifests and delta patches for the Prefab Asset subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.prefabasset.bundling", maxBundleBytes = 1179648 })
		inst.system = S
		inst.ctx = ctx
