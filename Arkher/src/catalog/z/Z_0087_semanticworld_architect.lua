-- ARKHER SYSTEM Z.0087 :: Semantic World Graph World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0087"
	S.key = "arkher.origin.semanticworld.world_architect"
	S.name = "Semantic World Graph World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticworld.emergence_detection" }
	S.tags = { "z", "semanticworld", "architect", "origin" }
	S.description = "Semantic World Graph World Architect: hierarchical world composition with conserved budgets for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.semanticworld.world_architect", budget = 700, seed = 42341 })
		inst.system = S
		inst.ctx = ctx
