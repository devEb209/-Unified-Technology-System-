-- ARKHER SYSTEM G.0046 :: Frame Interpolation Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0046"
	S.key = "arkher.neural.frameinterp.reconstruction"
	S.name = "Frame Interpolation Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.frameinterp.temporal_history" }
	S.tags = { "g", "frameinterp", "upscaler", "neural" }
	S.description = "Frame Interpolation Reconstruction: resolution ladder and image reconstruction for the Frame Interpolation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.frameinterp.reconstruction", targetMs = 15.10, index = 4, sharpness = 0.24 })
		inst.system = S
		inst.ctx = ctx
