-- ARKHER SYSTEM VA.0046 :: Continuum Stream Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0046"
	S.key = "arkher.contworld.continuumstream.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.continuumstream.complexity_budget" }
	S.tags = { "va", "continuumstream", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.continuumstream.simulation_fabric", budgetMs = 1.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
