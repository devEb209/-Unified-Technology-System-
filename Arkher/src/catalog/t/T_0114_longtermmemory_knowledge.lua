-- ARKHER SYSTEM T.0114 :: Long Term Memory Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0114"
	S.key = "arkher.ai.longtermmemory.semantic_knowledge"
	S.name = "Long Term Memory Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.longtermmemory.intent_understanding" }
	S.tags = { "t", "longtermmemory", "knowledge", "ai" }
	S.description = "Long Term Memory Semantic Knowledge: typed entities, weighted relations and inferred closure for the Long Term Memory subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.longtermmemory.semantic_knowledge", dims = 32 })
		inst.system = S
		inst.ctx = ctx
