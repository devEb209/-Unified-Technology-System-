-- ARKHER SYSTEM H.0034 :: Kinematic Body Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0034"
	S.key = "arkher.physics.kinematicbody.character_motion"
	S.name = "Kinematic Body Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.kinematicbody.query" }
	S.tags = { "h", "kinematicbody", "charmotor", "physics" }
	S.description = "Kinematic Body Character Motion: capsule move-and-slide with slopes, steps and jumps for the Kinematic Body subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.kinematicbody.character_motion", radius = 0.37, height = 1.82, maxSpeed = 8.20, jumpHeight = 1.80, stepOffset = 0.37 })
		inst.system = S
		inst.ctx = ctx
