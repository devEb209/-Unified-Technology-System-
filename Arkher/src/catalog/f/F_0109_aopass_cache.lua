-- ARKHER SYSTEM F.0109 :: Ambient Occlusion Pass Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0109"
	S.key = "arkher.render.aopass.pass_cache"
	S.name = "Ambient Occlusion Pass Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.aopass.render_policy" }
	S.tags = { "f", "aopass", "cache", "render" }
	S.description = "Ambient Occlusion Pass Pass Cache: reuse of pass results across frames for the Ambient Occlusion Pass subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.aopass.pass_cache", policy = "ttl", capacity = 325, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
