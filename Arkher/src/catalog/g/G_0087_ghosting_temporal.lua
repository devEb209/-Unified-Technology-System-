-- ARKHER SYSTEM G.0087 :: Ghosting Suppression Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0087"
	S.key = "arkher.neural.ghosting.temporal_history"
	S.name = "Ghosting Suppression Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ghosting.feature_extraction" }
	S.tags = { "g", "ghosting", "temporal", "neural" }
	S.description = "Ghosting Suppression Temporal History: history buffers reused across frames for the Ghosting Suppression subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.ghosting.temporal_history", feedback = 0.89, phase = 8 })
		inst.system = S
		inst.ctx = ctx
