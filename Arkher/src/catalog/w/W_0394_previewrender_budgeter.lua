-- ARKHER SYSTEM W.0394 :: Preview Render Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0394"
	S.key = "arkher.cine.previewrender.frame_budget"
	S.name = "Preview Render Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.previewrender.event_ledger" }
	S.tags = { "w", "previewrender", "budgeter", "cine" }
	S.description = "Preview Render Frame Budget: per-frame cost budget for the cinematic systems for the Preview Render subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.previewrender.frame_budget", total = 185, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
