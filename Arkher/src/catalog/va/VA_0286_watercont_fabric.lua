-- ARKHER SYSTEM VA.0286 :: Water Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0286"
	S.key = "arkher.contworld.watercont.simulation_fabric"
	S.name = "Water Continuum Simulation Fabric"
	S.category = "VA"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.watercont.complexity_budget" }
	S.tags = { "va", "watercont", "fabric", "contworld" }
	S.description = "Water Continuum Simulation Fabric: fabric stepping the continuum domains for the Water Continuum subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.watercont.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
