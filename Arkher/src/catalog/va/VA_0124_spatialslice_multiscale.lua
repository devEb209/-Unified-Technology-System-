-- ARKHER SYSTEM VA.0124 :: Spatial Slice Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VA.0124"
	S.key = "arkher.contworld.spatialslice.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.spatialslice.sparse_residency" }
	S.tags = { "va", "spatialslice", "multiscale", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contworld.spatialslice.multi-scale_fidelity", levels = 4, baseTriangles = 135000 })
		inst.system = S
		inst.ctx = ctx
