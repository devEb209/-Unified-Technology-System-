-- ARKHER SYSTEM I.0349 :: Physical Animation Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0349"
	S.key = "arkher.anim.physanim.quality_policy"
	S.name = "Physical Animation Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.physanim.pose_cache" }
	S.tags = { "i", "physanim", "policy", "anim" }
	S.description = "Physical Animation Quality Policy: device tier rules for rate, bones and solvers for the Physical Animation subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.physanim.quality_policy", algorithm = "edf", starvationGuard = 49 })
		inst.system = S
		inst.ctx = ctx
