-- ARKHER SYSTEM T.0480 :: Simulation Reasoning Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0480"
	S.key = "arkher.ai.simulationreasoning.self_critique"
	S.name = "Simulation Reasoning Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.simulationreasoning.plan_workflow" }
	S.tags = { "t", "simulationreasoning", "critic", "ai" }
	S.description = "Simulation Reasoning Self Critique: weighted evaluation of the result against declared criteria for the Simulation Reasoning subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.simulationreasoning.self_critique", passMark = 0.79, reviseMark = 0.49, seed = 4239 })
		inst.system = S
		inst.ctx = ctx
