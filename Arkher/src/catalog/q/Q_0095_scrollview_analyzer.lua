-- ARKHER SYSTEM Q.0095 :: Scroll View Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0095"
	S.key = "arkher.ui.scrollview.usability_analysis"
	S.name = "Scroll View Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Scroll View"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.scrollview.frame_budget" }
	S.tags = { "q", "scrollview", "analyzer", "ui" }
	S.description = "Scroll View Usability Analysis: reachability, latency and abandonment analysis for the Scroll View subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.scrollview.usability_analysis", window = 238, buckets = 10, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
