-- ARKHER SYSTEM VB.0595 :: Horizon Span Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0595"
	S.key = "arkher.conttime.horizonspan.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.horizonspan.coherence_guard" }
	S.tags = { "vb", "horizonspan", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.horizonspan.neural_field", dims = 24, hidden = 20, seed = 5883 })
		inst.system = S
		inst.ctx = ctx
