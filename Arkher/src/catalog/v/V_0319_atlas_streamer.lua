-- ARKHER SYSTEM V.0319 :: Texture Atlas Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0319"
	S.key = "arkher.asset.atlas.streaming_residency"
	S.name = "Texture Atlas Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.atlas.content_cache" }
	S.tags = { "v", "atlas", "streamer", "asset" }
	S.description = "Texture Atlas Streaming Residency: distance-driven load and unload of asset payloads for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.atlas.streaming_residency", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
