-- ARKHER SYSTEM K.0375 :: Utility Selection Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0375"
	S.key = "arkher.npc.utilityselection.social_relations"
	S.name = "Utility Selection Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.utilityselection.crowd_steering" }
	S.tags = { "k", "utilityselection", "society", "npc" }
	S.description = "Utility Selection Social Relations: affinity, factions, reputation and gossip for the Utility Selection subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.utilityselection.social_relations", decayRate = 0.013, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
