-- ARKHER SYSTEM F.0694 :: Frame Pacing Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0694"
	S.key = "arkher.render.framepacing.adaptive_resolution"
	S.name = "Frame Pacing Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Frame Pacing"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepacing.temporal_resolve" }
	S.tags = { "f", "framepacing", "upscaler", "render" }
	S.description = "Frame Pacing Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Frame Pacing subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.framepacing.adaptive_resolution", targetMs = 13.10, index = 5, sharpness = 0.42 })
		inst.system = S
		inst.ctx = ctx
