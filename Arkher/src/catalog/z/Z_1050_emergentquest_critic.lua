-- ARKHER SYSTEM Z.1050 :: Emergent Quest Generation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.1050"
	S.key = "arkher.origin.emergentquest.self_critique"
	S.name = "Emergent Quest Generation Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentquest.intent_bridge" }
	S.tags = { "z", "emergentquest", "critic", "origin" }
	S.description = "Emergent Quest Generation Self Critique: weighted judgement of the technology's own output for the Emergent Quest Generation subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.emergentquest.self_critique", passMark = 0.74, reviseMark = 0.44, seed = 38494 })
		inst.system = S
		inst.ctx = ctx
