-- ARKHER SYSTEM VA.0242 :: Vegetation Field Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0242"
	S.key = "arkher.contworld.vegfield.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vegfield.infinite_grid" }
	S.tags = { "va", "vegfield", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.vegfield.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
