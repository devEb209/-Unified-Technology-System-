-- ARKHER SYSTEM VA.0227 :: Terrain Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0227"
	S.key = "arkher.contworld.terraincont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.terraincont.simulation_fabric" }
	S.tags = { "va", "terraincont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.terraincont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
