-- ARKHER SYSTEM F.0431 :: Occlusion Culling Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0431"
	S.key = "arkher.render.occlusion.pass_cache"
	S.name = "Occlusion Culling Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.occlusion.render_policy" }
	S.tags = { "f", "occlusion", "cache", "render" }
	S.description = "Occlusion Culling Pass Cache: reuse of pass results across frames for the Occlusion Culling subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.occlusion.pass_cache", policy = "ttl", capacity = 331, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
