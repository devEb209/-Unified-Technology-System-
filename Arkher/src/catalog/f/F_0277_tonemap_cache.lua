-- ARKHER SYSTEM F.0277 :: Tonemapping Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0277"
	S.key = "arkher.render.tonemap.pass_cache"
	S.name = "Tonemapping Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Tonemapping"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.tonemap.render_policy" }
	S.tags = { "f", "tonemap", "cache", "render" }
	S.description = "Tonemapping Pass Cache: reuse of pass results across frames for the Tonemapping subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.tonemap.pass_cache", policy = "lfu", capacity = 457, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
