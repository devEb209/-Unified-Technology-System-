-- ARKHER SYSTEM E.0427 :: Texture Streaming Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0427"
	S.key = "arkher.material.texstream.parameter_budget"
	S.name = "Texture Streaming Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.texstream.variant_registry" }
	S.tags = { "e", "texstream", "budgeter", "material" }
	S.description = "Texture Streaming Parameter Budget: texel and layer budget allocation for the Texture Streaming subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.texstream.parameter_budget", total = 246, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
