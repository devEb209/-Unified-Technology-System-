-- ARKHER SYSTEM VB.0114 :: Temporal Slice Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0114"
	S.key = "arkher.conttime.temporalslice.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.temporalslice.persistent_state" }
	S.tags = { "vb", "temporalslice", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.temporalslice.coherence_guard", window = 120, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
