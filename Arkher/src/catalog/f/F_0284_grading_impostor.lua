-- ARKHER SYSTEM F.0284 :: Color Grading Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0284"
	S.key = "arkher.render.grading.geometry_virtualization"
	S.name = "Color Grading Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.grading.visibility_set" }
	S.tags = { "f", "grading", "impostor", "render" }
	S.description = "Color Grading Geometry Virtualization: impostor and HLOD synthesis under a budget for the Color Grading subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.grading.geometry_virtualization", atlasSlots = 64, viewCount = 8, errorThreshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
