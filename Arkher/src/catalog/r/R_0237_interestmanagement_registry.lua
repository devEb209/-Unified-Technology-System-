-- ARKHER SYSTEM R.0237 :: Interest Management Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0237"
	S.key = "arkher.net.interestmanagement.session_registry"
	S.name = "Interest Management Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.interestmanagement.rate_guard" }
	S.tags = { "r", "interestmanagement", "registry", "net" }
	S.description = "Interest Management Session Registry: catalogue of sessions, players and their metadata for the Interest Management subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.interestmanagement.session_registry" })
		inst.system = S
		inst.ctx = ctx
