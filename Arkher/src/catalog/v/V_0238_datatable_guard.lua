-- ARKHER SYSTEM V.0238 :: Data Table Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0238"
	S.key = "arkher.asset.datatable.validation_guard"
	S.name = "Data Table Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.datatable.size_budget" }
	S.tags = { "v", "datatable", "guard", "asset" }
	S.description = "Data Table Validation Guard: rate limiting and capability checks on the import path for the Data Table subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.datatable.validation_guard", algorithm = "leaky", capacity = 42, refillPerSec = 7, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
