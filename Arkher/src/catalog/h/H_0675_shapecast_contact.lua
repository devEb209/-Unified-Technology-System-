-- ARKHER SYSTEM H.0675 :: Shapecast Query Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0675"
	S.key = "arkher.physics.shapecast.contact_generation"
	S.name = "Shapecast Query Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.shapecast.collision_shape" }
	S.tags = { "h", "shapecast", "contact", "physics" }
	S.description = "Shapecast Query Contact Generation: narrow-phase manifolds with normal, depth and point for the Shapecast Query subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.shapecast.contact_generation", slop = 0.0060, maxManifolds = 451 })
		inst.system = S
		inst.ctx = ctx
