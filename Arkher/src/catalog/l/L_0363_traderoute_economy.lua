-- ARKHER SYSTEM L.0363 :: Trade Route Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0363"
	S.key = "arkher.sim.traderoute.economy"
	S.name = "Trade Route Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.traderoute.ecology" }
	S.tags = { "l", "traderoute", "economy", "sim" }
	S.description = "Trade Route Economy: stock, production, demand, price discovery and trade for the Trade Route subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.traderoute.economy", elasticity = 0.16 })
		inst.system = S
		inst.ctx = ctx
