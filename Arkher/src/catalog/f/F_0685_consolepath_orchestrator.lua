-- ARKHER SYSTEM F.0685 :: Console Path Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0685"
	S.key = "arkher.render.consolepath.orchestration"
	S.name = "Console Path Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Console Path"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.consolepath.frame_analysis" }
	S.tags = { "f", "consolepath", "orchestrator", "render" }
	S.description = "Console Path Orchestration: frame lifecycle orchestration for the Console Path subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.consolepath.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
