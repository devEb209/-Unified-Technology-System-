-- ARKHER SYSTEM W.0200 :: Action Scene Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0200"
	S.key = "arkher.cine.actionscene.cinematic_mix"
	S.name = "Action Scene Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Action Scene"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.actionscene.motion_tween" }
	S.tags = { "w", "actionscene", "mixer", "cine" }
	S.description = "Action Scene Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Action Scene subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.actionscene.cinematic_mix", maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
