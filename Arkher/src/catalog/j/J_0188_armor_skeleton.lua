-- ARKHER SYSTEM J.0188 :: Armor Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0188"
	S.key = "arkher.character.armor.rig_definition"
	S.name = "Armor Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "armor", "skeleton", "character" }
	S.description = "Armor Rig Definition: character rig definition and bone budget for the Armor subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.armor.rig_definition" })
		inst.system = S
		inst.ctx = ctx
