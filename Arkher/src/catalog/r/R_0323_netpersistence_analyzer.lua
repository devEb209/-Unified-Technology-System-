-- ARKHER SYSTEM R.0323 :: Data Persistence Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0323"
	S.key = "arkher.net.netpersistence.latency_analysis"
	S.name = "Data Persistence Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netpersistence.audit_ledger" }
	S.tags = { "r", "netpersistence", "analyzer", "net" }
	S.description = "Data Persistence Latency Analysis: round trip, jitter and loss analysis for the Data Persistence subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.netpersistence.latency_analysis", window = 225, buckets = 9, threshold = 2.70 })
		inst.system = S
		inst.ctx = ctx
