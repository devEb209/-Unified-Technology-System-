-- ARKHER SYSTEM Z.0781 :: Attention Driven Detail Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0781"
	S.key = "arkher.origin.attentiondetail.reality_layering"
	S.name = "Attention Driven Detail Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "attentiondetail", "reality", "origin" }
	S.description = "Attention Driven Detail Reality Layering: stacked authored, simulated, proposed and player realities for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.attentiondetail.reality_layering" })
		inst.system = S
		inst.ctx = ctx
