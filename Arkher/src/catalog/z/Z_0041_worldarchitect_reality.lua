-- ARKHER SYSTEM Z.0041 :: Singularity World Architect Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0041"
	S.key = "arkher.origin.worldarchitect.reality_layering"
	S.name = "Singularity World Architect Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "worldarchitect", "reality", "origin" }
	S.description = "Singularity World Architect Reality Layering: stacked authored, simulated, proposed and player realities for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.worldarchitect.reality_layering" })
		inst.system = S
		inst.ctx = ctx
