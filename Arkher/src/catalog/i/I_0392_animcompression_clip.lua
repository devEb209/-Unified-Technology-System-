-- ARKHER SYSTEM I.0392 :: Animation Compression Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0392"
	S.key = "arkher.anim.animcompression.clip_sampling"
	S.name = "Animation Compression Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animcompression.skeleton" }
	S.tags = { "i", "animcompression", "clip", "anim" }
	S.description = "Animation Compression Clip Sampling: keyframe tracks sampled, retimed and evented for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.animcompression.clip_sampling", duration = 1.70, loop = true })
		inst.system = S
		inst.ctx = ctx
