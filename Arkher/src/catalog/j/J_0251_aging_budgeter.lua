-- ARKHER SYSTEM J.0251 :: Aging Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0251"
	S.key = "arkher.character.aging.budget_governor"
	S.name = "Aging Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.aging.variant_registry" }
	S.tags = { "j", "aging", "budgeter", "character" }
	S.description = "Aging Budget Governor: per-character cost allocation in a crowd for the Aging subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.aging.budget_governor", total = 172, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
