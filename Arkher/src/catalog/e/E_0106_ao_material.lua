-- ARKHER SYSTEM E.0106 :: Ambient Occlusion Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0106"
	S.key = "arkher.material.ao.definition"
	S.name = "Ambient Occlusion Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "ao", "material", "material" }
	S.description = "Ambient Occlusion Definition: layered PBR definition resolved into parameters for the Ambient Occlusion subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.ao.definition", texelBudget = 2097152 })
		inst.system = S
		inst.ctx = ctx
