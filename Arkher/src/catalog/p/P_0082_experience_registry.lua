-- ARKHER SYSTEM P.0082 :: Experience Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0082"
	S.key = "arkher.play.experience.content_registry"
	S.name = "Experience Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Experience"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.experience.difficulty_controller" }
	S.tags = { "p", "experience", "registry", "play" }
	S.description = "Experience Content Registry: catalogue of the definitions this loop instantiates for the Experience subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.experience.content_registry" })
		inst.system = S
		inst.ctx = ctx
