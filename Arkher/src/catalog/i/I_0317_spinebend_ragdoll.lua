-- ARKHER SYSTEM I.0317 :: Spine Bend Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0317"
	S.key = "arkher.anim.spinebend.physical_blend"
	S.name = "Spine Bend Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Spine Bend"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.spinebend.inverse_kinematics" }
	S.tags = { "i", "spinebend", "ragdoll", "anim" }
	S.description = "Spine Bend Physical Blend: physical bones blended against the animated pose for the Spine Bend subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.spinebend.physical_blend", blendSpeed = 3.70 })
		inst.system = S
		inst.ctx = ctx
