-- ARKHER SYSTEM F.0007 :: Frame Pipeline Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0007"
	S.key = "arkher.render.framepipeline.temporal_resolve"
	S.name = "Frame Pipeline Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepipeline.probe_volume" }
	S.tags = { "f", "framepipeline", "temporal", "render" }
	S.description = "Frame Pipeline Temporal Resolve: history reprojection with neighbourhood clamping for the Frame Pipeline subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.framepipeline.temporal_resolve", feedback = 0.91, phase = 8 })
		inst.system = S
		inst.ctx = ctx
