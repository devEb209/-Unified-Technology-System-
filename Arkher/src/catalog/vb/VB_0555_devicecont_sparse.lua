-- ARKHER SYSTEM VB.0555 :: Device Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0555"
	S.key = "arkher.conttime.devicecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.devicecont.epoch_clock" }
	S.tags = { "vb", "devicecont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.devicecont.sparse_residency", capacity = 256, pageBytes = 3072 })
		inst.system = S
		inst.ctx = ctx
