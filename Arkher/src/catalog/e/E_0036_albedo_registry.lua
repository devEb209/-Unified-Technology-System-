-- ARKHER SYSTEM E.0036 :: Albedo Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0036"
	S.key = "arkher.material.albedo.variant_registry"
	S.name = "Albedo Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Albedo"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.albedo.procedural_detail" }
	S.tags = { "e", "albedo", "registry", "material" }
	S.description = "Albedo Variant Registry: named variants and their lifecycle for the Albedo subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.albedo.variant_registry" })
		inst.system = S
		inst.ctx = ctx
