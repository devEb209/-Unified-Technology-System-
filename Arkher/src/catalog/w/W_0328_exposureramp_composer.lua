-- ARKHER SYSTEM W.0328 :: Exposure Ramp Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0328"
	S.key = "arkher.cine.exposureramp.shot_composition"
	S.name = "Exposure Ramp Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.exposureramp.colour_grade" }
	S.tags = { "w", "exposureramp", "composer", "cine" }
	S.description = "Exposure Ramp Shot Composition: blending of the signals that make up the final shot for the Exposure Ramp subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.exposureramp.shot_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
