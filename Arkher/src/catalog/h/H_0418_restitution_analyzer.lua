-- ARKHER SYSTEM H.0418 :: Restitution Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0418"
	S.key = "arkher.physics.restitution.analysis"
	S.name = "Restitution Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Restitution"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.restitution.result_cache" }
	S.tags = { "h", "restitution", "analyzer", "physics" }
	S.description = "Restitution Analysis: energy, jitter and cost analysis of the simulation for the Restitution subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.restitution.analysis", window = 244, buckets = 8, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
