-- ARKHER SYSTEM T.0563 :: Pipeline Automation Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0563"
	S.key = "arkher.ai.pipelineautomation.plan_workflow"
	S.name = "Pipeline Automation Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.pipelineautomation.semantic_knowledge" }
	S.tags = { "t", "pipelineautomation", "workflow", "ai" }
	S.description = "Pipeline Automation Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Pipeline Automation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.pipelineautomation.plan_workflow", maxRetries = 1, budget = 100 })
		inst.system = S
		inst.ctx = ctx
