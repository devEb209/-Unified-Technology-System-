-- ARKHER SYSTEM R.0143 :: Unreliable Channel Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0143"
	S.key = "arkher.net.unreliablechannel.latency_analysis"
	S.name = "Unreliable Channel Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.unreliablechannel.audit_ledger" }
	S.tags = { "r", "unreliablechannel", "analyzer", "net" }
	S.description = "Unreliable Channel Latency Analysis: round trip, jitter and loss analysis for the Unreliable Channel subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.unreliablechannel.latency_analysis", window = 71, buckets = 15, threshold = 3.30 })
		inst.system = S
		inst.ctx = ctx
