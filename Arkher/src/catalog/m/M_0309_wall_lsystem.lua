-- ARKHER SYSTEM M.0309 :: Wall Grammar
...
return function(A)
	...
	local S = {}
	S.id = "M.0309"
	S.key = "arkher.proc.wall.grammar"
	S.name = "Wall Grammar"
	S.category = "M"
	S.family = "PROCEDURAL"
	S.area = "Wall"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "m", "wall", "lsystem", "proc" }
	S.description = "Wall Grammar: rewriting grammar interpreted into geometry for the Wall subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lsystem", { id = "arkher.proc.wall.grammar", axiom = "F", angle = 34, step = 5.0 })
		inst.system = S
		inst.ctx = ctx
