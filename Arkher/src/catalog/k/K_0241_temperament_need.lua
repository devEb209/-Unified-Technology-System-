-- ARKHER SYSTEM K.0241 :: Temperament Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0241"
	S.key = "arkher.npc.temperament.drive_system"
	S.name = "Temperament Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.temperament.memory" }
	S.tags = { "k", "temperament", "need", "npc" }
	S.description = "Temperament Drive System: drives that decay, turn urgent and get satisfied for the Temperament subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.temperament.drive_system" })
		inst.system = S
		inst.ctx = ctx
