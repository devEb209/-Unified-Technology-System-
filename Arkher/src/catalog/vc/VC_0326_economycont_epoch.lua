-- ARKHER SYSTEM VC.0326 :: Economy Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0326"
	S.key = "arkher.contneural.economycont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.economycont.infinite_grid" }
	S.tags = { "vc", "economycont", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.economycont.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
