-- ARKHER SYSTEM Z.0855 :: Simulation Time Dilation Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0855"
	S.key = "arkher.origin.timedilation.signal_composition"
	S.name = "Simulation Time Dilation Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.telemetry_ledger" }
	S.tags = { "z", "timedilation", "composer", "origin" }
	S.description = "Simulation Time Dilation Signal Composition: blending of the technology's input signals into one output for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.timedilation.signal_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
