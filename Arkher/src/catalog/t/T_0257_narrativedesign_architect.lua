-- ARKHER SYSTEM T.0257 :: Narrative Design World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0257"
	S.key = "arkher.ai.narrativedesign.world_architect"
	S.name = "Narrative Design World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.narrativedesign.self_critique" }
	S.tags = { "t", "narrativedesign", "architect", "ai" }
	S.description = "Narrative Design World Architect: composition of a whole world plan with conserved budgets for the Narrative Design subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.narrativedesign.world_architect", budget = 700, seed = 98241 })
		inst.system = S
		inst.ctx = ctx
