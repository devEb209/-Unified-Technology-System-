-- ARKHER SYSTEM K.0283 :: Scent Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0283"
	S.key = "arkher.npc.scent.drive_system"
	S.name = "Scent Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.scent.memory" }
	S.tags = { "k", "scent", "need", "npc" }
	S.description = "Scent Drive System: drives that decay, turn urgent and get satisfied for the Scent subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.scent.drive_system" })
		inst.system = S
		inst.ctx = ctx
