-- ARKHER SYSTEM H.0667 :: Raycast Query Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0667"
	S.key = "arkher.physics.raycast.budget_governor"
	S.name = "Raycast Query Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.raycast.broadphase_index" }
	S.tags = { "h", "raycast", "budgeter", "physics" }
	S.description = "Raycast Query Budget Governor: simulation time budget allocation across islands for the Raycast Query subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.raycast.budget_governor", total = 337, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
