-- ARKHER SYSTEM VA.0219 :: Terrain Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0219"
	S.key = "arkher.contworld.terraincont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.terraincont.epoch_clock" }
	S.tags = { "va", "terraincont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.terraincont.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
