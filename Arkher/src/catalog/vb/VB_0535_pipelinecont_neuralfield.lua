-- ARKHER SYSTEM VB.0535 :: Pipeline Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0535"
	S.key = "arkher.conttime.pipelinecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.pipelinecont.coherence_guard" }
	S.tags = { "vb", "pipelinecont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.pipelinecont.neural_field", dims = 12, hidden = 8, seed = 56096 })
		inst.system = S
		inst.ctx = ctx
