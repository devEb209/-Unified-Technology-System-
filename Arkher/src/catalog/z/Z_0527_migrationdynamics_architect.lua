-- ARKHER SYSTEM Z.0527 :: Migration Dynamics World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0527"
	S.key = "arkher.origin.migrationdynamics.world_architect"
	S.name = "Migration Dynamics World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.migrationdynamics.emergence_detection" }
	S.tags = { "z", "migrationdynamics", "architect", "origin" }
	S.description = "Migration Dynamics World Architect: hierarchical world composition with conserved budgets for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.migrationdynamics.world_architect", budget = 1000, seed = 29624 })
		inst.system = S
		inst.ctx = ctx
