-- ARKHER SYSTEM V.0392 :: Platform Variant Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0392"
	S.key = "arkher.asset.platformvariant.compression_codec"
	S.name = "Platform Variant Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.platformvariant.streaming_residency" }
	S.tags = { "v", "platformvariant", "codec", "asset" }
	S.description = "Platform Variant Compression Codec: compact encoding, diffing and checksum of asset payloads for the Platform Variant subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.platformvariant.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
