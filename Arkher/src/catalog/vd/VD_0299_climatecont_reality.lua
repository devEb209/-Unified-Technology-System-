-- ARKHER SYSTEM VD.0299 :: Climate Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0299"
	S.key = "arkher.contsim.climatecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.climatecont.simulation_fabric" }
	S.tags = { "vd", "climatecont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.climatecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
