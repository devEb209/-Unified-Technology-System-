-- ARKHER SYSTEM F.0291 :: Color Grading Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0291"
	S.key = "arkher.render.grading.pass_cache"
	S.name = "Color Grading Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.grading.render_policy" }
	S.tags = { "f", "grading", "cache", "render" }
	S.description = "Color Grading Pass Cache: reuse of pass results across frames for the Color Grading subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.grading.pass_cache", policy = "lfu", capacity = 75, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
