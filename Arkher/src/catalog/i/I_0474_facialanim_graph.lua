-- ARKHER SYSTEM I.0474 :: Facial Animation Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0474"
	S.key = "arkher.anim.facialanim.retarget_graph"
	S.name = "Facial Animation Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.facialanim.physical_blend" }
	S.tags = { "i", "facialanim", "graph", "anim" }
	S.description = "Facial Animation Retarget Graph: bone mapping and retarget path resolution for the Facial Animation subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.facialanim.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
