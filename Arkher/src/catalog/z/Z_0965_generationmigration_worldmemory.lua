-- ARKHER SYSTEM Z.0965 :: Generation Migration World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0965"
	S.key = "arkher.origin.generationmigration.world_memory"
	S.name = "Generation Migration World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.autonomous_pipeline" }
	S.tags = { "z", "generationmigration", "worldmemory", "origin" }
	S.description = "Generation Migration World Memory: epoch-stamped persistent history with compaction and checkpoints for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.generationmigration.world_memory", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
