-- ARKHER SYSTEM VA.0014 :: Region Tile Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0014"
	S.key = "arkher.contworld.regiontile.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.regiontile.infinite_grid" }
	S.tags = { "va", "regiontile", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.regiontile.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
