-- ARKHER SYSTEM P.0464 :: Tutorial Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0464"
	S.key = "arkher.play.tutorial.balance_analysis"
	S.name = "Tutorial Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Tutorial"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.tutorial.event_ledger" }
	S.tags = { "p", "tutorial", "analyzer", "play" }
	S.description = "Tutorial Balance Analysis: distribution, outlier and pacing analysis for the Tutorial subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.tutorial.balance_analysis", window = 68, buckets = 8, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
