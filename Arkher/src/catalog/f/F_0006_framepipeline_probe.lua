-- ARKHER SYSTEM F.0006 :: Frame Pipeline Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0006"
	S.key = "arkher.render.framepipeline.probe_volume"
	S.name = "Frame Pipeline Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepipeline.lighting_rig" }
	S.tags = { "f", "framepipeline", "probe", "render" }
	S.description = "Frame Pipeline Probe Volume: irradiance probes encoded in spherical harmonics for the Frame Pipeline subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.framepipeline.probe_volume", spacing = 24 })
		inst.system = S
		inst.ctx = ctx
