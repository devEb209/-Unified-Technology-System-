-- ARKHER SYSTEM VB.0607 :: Seam Lattice Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0607"
	S.key = "arkher.conttime.seamlattice.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.seamlattice.coherence_guard" }
	S.tags = { "vb", "seamlattice", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.seamlattice.neural_field", dims = 12, hidden = 8, seed = 84988 })
		inst.system = S
		inst.ctx = ctx
