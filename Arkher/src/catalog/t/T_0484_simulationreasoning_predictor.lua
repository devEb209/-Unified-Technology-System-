-- ARKHER SYSTEM T.0484 :: Simulation Reasoning Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0484"
	S.key = "arkher.ai.simulationreasoning.outcome_prediction"
	S.name = "Simulation Reasoning Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.simulationreasoning.decision_policy" }
	S.tags = { "t", "simulationreasoning", "predictor", "ai" }
	S.description = "Simulation Reasoning Outcome Prediction: forecasting the result before the work is done for the Simulation Reasoning subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.simulationreasoning.outcome_prediction", method = "ema", alpha = 0.43, window = 89 })
		inst.system = S
		inst.ctx = ctx
