-- ARKHER SYSTEM K.0456 :: Crowd Flow Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0456"
	S.key = "arkher.npc.crowdflow.goal_planner"
	S.name = "Crowd Flow Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.crowdflow.utility_reasoning" }
	S.tags = { "k", "crowdflow", "planner", "npc" }
	S.description = "Crowd Flow Goal Planner: backward GOAP planning to reach a goal state for the Crowd Flow subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.crowdflow.goal_planner", maxDepth = 9 })
		inst.system = S
		inst.ctx = ctx
