-- ARKHER SYSTEM VB.0094 :: Residency Window Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0094"
	S.key = "arkher.conttime.residencywindow.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.residencywindow.complexity_budget" }
	S.tags = { "vb", "residencywindow", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.residencywindow.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
