-- ARKHER SYSTEM F.0533 :: Decal Rendering Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0533"
	S.key = "arkher.render.decalrender.frame_graph"
	S.name = "Decal Rendering Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "decalrender", "framegraph", "render" }
	S.description = "Decal Rendering Frame Graph: declared passes, culling, ordering and aliasing for the Decal Rendering subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.decalrender.frame_graph", budgetMs = 11.00 })
		inst.system = S
		inst.ctx = ctx
