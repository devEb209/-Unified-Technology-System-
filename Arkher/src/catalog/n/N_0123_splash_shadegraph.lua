-- ARKHER SYSTEM N.0123 :: Water Splash Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0123"
	S.key = "arkher.vfx.splash.effect_graph"
	S.name = "Water Splash Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Water Splash"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.splash.curve_authoring" }
	S.tags = { "n", "splash", "shadegraph", "vfx" }
	S.description = "Water Splash Effect Graph: node graph describing how the effect is shaded for the Water Splash subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.splash.effect_graph" })
		inst.system = S
		inst.ctx = ctx
