-- ARKHER SYSTEM H.0690 :: Overlap Query Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0690"
	S.key = "arkher.physics.overlap.constraint_solver"
	S.name = "Overlap Query Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.overlap.contact_generation" }
	S.tags = { "h", "overlap", "constraint", "physics" }
	S.description = "Overlap Query Constraint Solver: sequential impulses, friction, joints and warm starting for the Overlap Query subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.overlap.constraint_solver", iterations = 9, baumgarte = 0.15, warmStart = true })
		inst.system = S
		inst.ctx = ctx
