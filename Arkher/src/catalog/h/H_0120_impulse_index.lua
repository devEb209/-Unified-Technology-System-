-- ARKHER SYSTEM H.0120 :: Impulse Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0120"
	S.key = "arkher.physics.impulse.broadphase_index"
	S.name = "Impulse Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Impulse"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.impulse.vehicle" }
	S.tags = { "h", "impulse", "index", "physics" }
	S.description = "Impulse Broadphase Index: spatial acceleration of candidate pair finding for the Impulse subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.impulse.broadphase_index", mode = "hash", cellSize = 16 })
		inst.system = S
		inst.ctx = ctx
