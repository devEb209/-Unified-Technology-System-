-- ARKHER SYSTEM Z.0424 :: Offline World Progression Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0424"
	S.key = "arkher.origin.offlineprogression.autonomous_pipeline"
	S.name = "Offline World Progression Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.simulation_fabric" }
	S.tags = { "z", "offlineprogression", "autopipeline", "origin" }
	S.description = "Offline World Progression Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.offlineprogression.autonomous_pipeline", maxIterations = 8 })
		inst.system = S
		inst.ctx = ctx
