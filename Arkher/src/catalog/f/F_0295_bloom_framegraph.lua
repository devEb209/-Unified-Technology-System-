-- ARKHER SYSTEM F.0295 :: Bloom Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0295"
	S.key = "arkher.render.bloom.frame_graph"
	S.name = "Bloom Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Bloom"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "bloom", "framegraph", "render" }
	S.description = "Bloom Frame Graph: declared passes, culling, ordering and aliasing for the Bloom subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.bloom.frame_graph", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
