-- ARKHER SYSTEM K.0019 :: Neural Policy Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0019"
	S.key = "arkher.npc.neuralpolicy.perception"
	S.name = "Neural Policy Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.neuralpolicy.emotion" }
	S.tags = { "k", "neuralpolicy", "perception", "npc" }
	S.description = "Neural Policy Perception: sight, hearing and bounded attention for the Neural Policy subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.neuralpolicy.perception", sightRange = 30, hearingRange = 32, attentionSlots = 4, fov = 1.850 })
		inst.system = S
		inst.ctx = ctx
