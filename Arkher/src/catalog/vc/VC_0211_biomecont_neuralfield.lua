-- ARKHER SYSTEM VC.0211 :: Biome Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0211"
	S.key = "arkher.contneural.biomecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.biomecont.coherence_guard" }
	S.tags = { "vc", "biomecont", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.biomecont.neural_field", dims = 16, hidden = 12, seed = 16241 })
		inst.system = S
		inst.ctx = ctx
