--!strict
-- VFX Niagra — ANIMATION Mixer #0067
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="VFX Niagra — ANIMATION Mixer #0067", size=Vector2.new(640, 460), pos=UDim2.fromOffset(171, 179), parent=parent, icon="◐"})
...
Components.Slider(right, "Rate", 0,3000,600, function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_Rate"..67, v) end end)
