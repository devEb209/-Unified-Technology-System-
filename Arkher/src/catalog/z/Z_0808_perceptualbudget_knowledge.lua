-- ARKHER SYSTEM Z.0808 :: Perceptual Budgeting Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0808"
	S.key = "arkher.origin.perceptualbudget.semantic_graph"
	S.name = "Perceptual Budgeting Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.perceptualbudget.world_architect" }
	S.tags = { "z", "perceptualbudget", "knowledge", "origin" }
	S.description = "Perceptual Budgeting Semantic Graph: typed entities and inferred relations of the technology itself for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.perceptualbudget.semantic_graph", dims = 40 })
		inst.system = S
		inst.ctx = ctx
