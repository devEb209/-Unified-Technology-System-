-- ARKHER SYSTEM F.0104 :: Ambient Occlusion Pass Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0104"
	S.key = "arkher.render.aopass.probe_volume"
	S.name = "Ambient Occlusion Pass Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.aopass.lighting_rig" }
	S.tags = { "f", "aopass", "probe", "render" }
	S.description = "Ambient Occlusion Pass Probe Volume: irradiance probes encoded in spherical harmonics for the Ambient Occlusion Pass subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.aopass.probe_volume", spacing = 8 })
		inst.system = S
		inst.ctx = ctx
