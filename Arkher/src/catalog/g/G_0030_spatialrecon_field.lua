-- ARKHER SYSTEM G.0030 :: Spatial Reconstruction Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0030"
	S.key = "arkher.neural.spatialrecon.feature_extraction"
	S.name = "Spatial Reconstruction Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.spatialrecon.inference_core" }
	S.tags = { "g", "spatialrecon", "field", "neural" }
	S.description = "Spatial Reconstruction Feature Extraction: signal features feeding the model for the Spatial Reconstruction subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.spatialrecon.feature_extraction", seed = 70530, frequency = 0.0065, octaves = 5, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
