-- ARKHER SYSTEM Z.0657 :: Natural Language Engine Control Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0657"
	S.key = "arkher.origin.languagecontrol.behaviour_analysis"
	S.name = "Natural Language Engine Control Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.languagecontrol.governance_policy" }
	S.tags = { "z", "languagecontrol", "analyzer", "origin" }
	S.description = "Natural Language Engine Control Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.languagecontrol.behaviour_analysis", window = 182, buckets = 18, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
