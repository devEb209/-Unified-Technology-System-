-- ARKHER SYSTEM Z.0369 :: Mobile First Governor Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0369"
	S.key = "arkher.origin.mobilefirst.intent_bridge"
	S.name = "Mobile First Governor Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.semantic_graph" }
	S.tags = { "z", "mobilefirst", "intent", "origin" }
	S.description = "Mobile First Governor Intent Bridge: natural language control surface for the technology for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.mobilefirst.intent_bridge", minConfidence = 0.36 })
		inst.system = S
		inst.ctx = ctx
