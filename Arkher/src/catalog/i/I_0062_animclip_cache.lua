-- ARKHER SYSTEM I.0062 :: Animation Clip Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0062"
	S.key = "arkher.anim.animclip.pose_cache"
	S.name = "Animation Clip Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animclip.playback_pipeline" }
	S.tags = { "i", "animclip", "cache", "anim" }
	S.description = "Animation Clip Pose Cache: reuse of sampled poses across frames and instances for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.animclip.pose_cache", policy = "lfu", capacity = 450, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
