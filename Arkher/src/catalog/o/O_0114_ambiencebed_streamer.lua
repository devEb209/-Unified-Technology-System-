-- ARKHER SYSTEM O.0114 :: Ambience Bed Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0114"
	S.key = "arkher.audio.ambiencebed.streaming"
	S.name = "Ambience Bed Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Ambience Bed"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.ambiencebed.voice_budget" }
	S.tags = { "o", "ambiencebed", "streamer", "audio" }
	S.description = "Ambience Bed Streaming: distance-driven residency of audio assets for the Ambience Bed subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.ambiencebed.streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
