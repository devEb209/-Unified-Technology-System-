-- ARKHER SYSTEM L.0121 :: Village Life Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0121"
	S.key = "arkher.sim.villagelife.simulation_core"
	S.name = "Village Life Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "villagelife", "simulation", "sim" }
	S.description = "Village Life Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Village Life subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.villagelife.simulation_core", fullRadius = 280, reducedRadius = 600, budget = 96 })
		inst.system = S
		inst.ctx = ctx
