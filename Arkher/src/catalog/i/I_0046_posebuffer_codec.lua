-- ARKHER SYSTEM I.0046 :: Pose Buffer Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0046"
	S.key = "arkher.anim.posebuffer.compression_codec"
	S.name = "Pose Buffer Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Pose Buffer"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.posebuffer.retarget_graph" }
	S.tags = { "i", "posebuffer", "codec", "anim" }
	S.description = "Pose Buffer Compression Codec: curve compression and quantized transport for the Pose Buffer subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.posebuffer.compression_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
