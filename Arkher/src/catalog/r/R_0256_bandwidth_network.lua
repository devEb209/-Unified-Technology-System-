-- ARKHER SYSTEM R.0256 :: Bandwidth Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0256"
	S.key = "arkher.net.bandwidth.transport_graph"
	S.name = "Bandwidth Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Bandwidth"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.bandwidth.prediction_and_reconciliation" }
	S.tags = { "r", "bandwidth", "network", "net" }
	S.description = "Bandwidth Transport Graph: topology, capacity and routing between endpoints for the Bandwidth subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.bandwidth.transport_graph" })
		inst.system = S
		inst.ctx = ctx
