-- ARKHER SYSTEM Q.0403 :: UI Debug Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0403"
	S.key = "arkher.ui.uidebug.localization_registry"
	S.name = "UI Debug Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "UI Debug"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uidebug.theme_composition" }
	S.tags = { "q", "uidebug", "registry", "ui" }
	S.description = "UI Debug Localization Registry: catalogue of strings, plurals and locale metadata for the UI Debug subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.uidebug.localization_registry" })
		inst.system = S
		inst.ctx = ctx
