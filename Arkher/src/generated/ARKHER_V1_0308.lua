...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Fairlight — CORE Map #0308", size=Vector2.new(680, 480), pos=UDim2.fromOffset(104, 116), parent=parent, icon="◈"})
