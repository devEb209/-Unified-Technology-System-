-- ARKHER SYSTEM VD.0035 :: Zone Chunk Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0035"
	S.key = "arkher.contsim.zonechunk.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.zonechunk.simulation_fabric" }
	S.tags = { "vd", "zonechunk", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.zonechunk.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
