-- ARKHER SYSTEM T.0065 :: World Knowledge Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0065"
	S.key = "arkher.ai.worldknowledge.working_memory"
	S.name = "World Knowledge Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.worldknowledge.outcome_prediction" }
	S.tags = { "t", "worldknowledge", "memory", "ai" }
	S.description = "World Knowledge Working Memory: decaying, consolidating recall of what the agent learned for the World Knowledge subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.worldknowledge.working_memory", capacity = 109, decayRate = 0.025, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
