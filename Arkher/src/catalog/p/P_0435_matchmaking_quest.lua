-- ARKHER SYSTEM P.0435 :: Matchmaking Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0435"
	S.key = "arkher.play.matchmaking.objectives"
	S.name = "Matchmaking Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Matchmaking"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.matchmaking.inventory" }
	S.tags = { "p", "matchmaking", "quest", "play" }
	S.description = "Matchmaking Objectives: objectives, prerequisites, progress and rewards for the Matchmaking subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.matchmaking.objectives" })
		inst.system = S
		inst.ctx = ctx
