-- ARKHER SYSTEM O.0118 :: Ambience Bed Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0118"
	S.key = "arkher.audio.ambiencebed.analysis"
	S.name = "Ambience Bed Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Ambience Bed"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.ambiencebed.playback_policy" }
	S.tags = { "o", "ambiencebed", "analyzer", "audio" }
	S.description = "Ambience Bed Analysis: loudness, headroom and masking analysis for the Ambience Bed subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.ambiencebed.analysis", window = 208, buckets = 8, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
