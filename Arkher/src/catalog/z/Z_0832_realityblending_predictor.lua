-- ARKHER SYSTEM Z.0832 :: Reality Blending Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0832"
	S.key = "arkher.origin.realityblending.predictive_optimization"
	S.name = "Reality Blending Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.adaptive_workflow" }
	S.tags = { "z", "realityblending", "predictor", "origin" }
	S.description = "Reality Blending Predictive Optimization: forecast-driven optimization before the cost is paid for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.realityblending.predictive_optimization", method = "markov", alpha = 0.38, window = 52 })
		inst.system = S
		inst.ctx = ctx
