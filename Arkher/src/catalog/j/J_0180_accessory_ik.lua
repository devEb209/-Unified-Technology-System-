-- ARKHER SYSTEM J.0180 :: Accessory Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0180"
	S.key = "arkher.character.accessory.look_and_reach"
	S.name = "Accessory Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.accessory.blend_controller" }
	S.tags = { "j", "accessory", "ik", "character" }
	S.description = "Accessory Look And Reach: look-at, reach and foot placement for the character for the Accessory subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.accessory.look_and_reach", iterations = 5, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
