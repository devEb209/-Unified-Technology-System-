-- ARKHER SYSTEM K.0119 :: Forgetting Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0119"
	S.key = "arkher.npc.forgetting.utility_reasoning"
	S.name = "Forgetting Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.forgetting.reactive_behaviour" }
	S.tags = { "k", "forgetting", "utility", "npc" }
	S.description = "Forgetting Utility Reasoning: scored option selection with response curves for the Forgetting subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.forgetting.utility_reasoning", momentum = 0.06 })
		inst.system = S
		inst.ctx = ctx
