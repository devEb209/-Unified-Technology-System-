-- ARKHER SYSTEM Z.0510 :: Economic Emergence Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0510"
	S.key = "arkher.origin.economicemergence.self_critique"
	S.name = "Economic Emergence Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.economicemergence.intent_bridge" }
	S.tags = { "z", "economicemergence", "critic", "origin" }
	S.description = "Economic Emergence Self Critique: weighted judgement of the technology's own output for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.economicemergence.self_critique", passMark = 0.80, reviseMark = 0.40, seed = 17200 })
		inst.system = S
		inst.ctx = ctx
