-- ARKHER SYSTEM Z.0401 :: Battery Aware Pipeline Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0401"
	S.key = "arkher.origin.batteryaware.reality_layering"
	S.name = "Battery Aware Pipeline Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "batteryaware", "reality", "origin" }
	S.description = "Battery Aware Pipeline Reality Layering: stacked authored, simulated, proposed and player realities for the Battery Aware Pipeline subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.batteryaware.reality_layering" })
		inst.system = S
		inst.ctx = ctx
