-- ARKHER SYSTEM O.0078 :: Dialogue Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0078"
	S.key = "arkher.audio.dialogue.streaming"
	S.name = "Dialogue Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Dialogue"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.dialogue.voice_budget" }
	S.tags = { "o", "dialogue", "streamer", "audio" }
	S.description = "Dialogue Streaming: distance-driven residency of audio assets for the Dialogue subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.dialogue.streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
