-- ARKHER SYSTEM I.0075 :: Keyframe Track Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0075"
	S.key = "arkher.anim.keytrack.pose_cache"
	S.name = "Keyframe Track Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.keytrack.playback_pipeline" }
	S.tags = { "i", "keytrack", "cache", "anim" }
	S.description = "Keyframe Track Pose Cache: reuse of sampled poses across frames and instances for the Keyframe Track subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.keytrack.pose_cache", policy = "lfu", capacity = 208, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
