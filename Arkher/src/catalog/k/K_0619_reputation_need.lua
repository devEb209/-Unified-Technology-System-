-- ARKHER SYSTEM K.0619 :: Reputation Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0619"
	S.key = "arkher.npc.reputation.drive_system"
	S.name = "Reputation Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.reputation.memory" }
	S.tags = { "k", "reputation", "need", "npc" }
	S.description = "Reputation Drive System: drives that decay, turn urgent and get satisfied for the Reputation subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.reputation.drive_system" })
		inst.system = S
		inst.ctx = ctx
