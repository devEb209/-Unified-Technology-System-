-- ARKHER SYSTEM VD.0563 :: Device Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0563"
	S.key = "arkher.contsim.devicecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.devicecont.simulation_fabric" }
	S.tags = { "vd", "devicecont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.devicecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
