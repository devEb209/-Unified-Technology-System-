-- ARKHER SYSTEM Z.0939 :: Universal Interop Layer Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0939"
	S.key = "arkher.origin.interop.residency_streaming"
	S.name = "Universal Interop Layer Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.interop.budget_governor" }
	S.tags = { "z", "interop", "streamer", "origin" }
	S.description = "Universal Interop Layer Residency Streaming: distance-driven residency of the technology's workload for the Universal Interop Layer subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.interop.residency_streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
