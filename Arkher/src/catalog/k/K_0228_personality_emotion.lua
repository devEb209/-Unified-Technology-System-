-- ARKHER SYSTEM K.0228 :: Personality Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0228"
	S.key = "arkher.npc.personality.emotion"
	S.name = "Personality Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.personality.drive_system" }
	S.tags = { "k", "personality", "emotion", "npc" }
	S.description = "Personality Emotion: appraisal of events into valence, arousal and mood for the Personality subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.personality.emotion", inertia = 0.75, decayRate = 0.40, baselineArousal = 0.10 })
		inst.system = S
		inst.ctx = ctx
