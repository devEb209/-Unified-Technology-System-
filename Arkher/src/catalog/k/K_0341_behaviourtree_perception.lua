-- ARKHER SYSTEM K.0341 :: Behaviour Tree Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0341"
	S.key = "arkher.npc.behaviourtree.perception"
	S.name = "Behaviour Tree Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourtree.emotion" }
	S.tags = { "k", "behaviourtree", "perception", "npc" }
	S.description = "Behaviour Tree Perception: sight, hearing and bounded attention for the Behaviour Tree subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.behaviourtree.perception", sightRange = 60, hearingRange = 16, attentionSlots = 6, fov = 1.750 })
		inst.system = S
		inst.ctx = ctx
