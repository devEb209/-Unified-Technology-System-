-- ARKHER SYSTEM VA.0341 :: Society Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0341"
	S.key = "arkher.contworld.societycont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.societycont.multi-scale_fidelity" }
	S.tags = { "va", "societycont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.societycont.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
