-- ARKHER SYSTEM VD.0178 :: Neural Patch Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0178"
	S.key = "arkher.contsim.neuralpatch.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.neuralpatch.complexity_budget" }
	S.tags = { "vd", "neuralpatch", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.neuralpatch.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
