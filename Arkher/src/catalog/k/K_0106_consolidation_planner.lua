-- ARKHER SYSTEM K.0106 :: Memory Consolidation Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0106"
	S.key = "arkher.npc.consolidation.goal_planner"
	S.name = "Memory Consolidation Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.consolidation.utility_reasoning" }
	S.tags = { "k", "consolidation", "planner", "npc" }
	S.description = "Memory Consolidation Goal Planner: backward GOAP planning to reach a goal state for the Memory Consolidation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.consolidation.goal_planner", maxDepth = 9 })
		inst.system = S
		inst.ctx = ctx
