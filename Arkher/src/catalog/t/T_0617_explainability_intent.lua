-- ARKHER SYSTEM T.0617 :: Explainability Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0617"
	S.key = "arkher.ai.explainability.intent_understanding"
	S.name = "Explainability Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "explainability", "intent", "ai" }
	S.description = "Explainability Intent Understanding: natural language turned into an actionable, scored intent for the Explainability subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.explainability.intent_understanding", minConfidence = 0.39 })
		inst.system = S
		inst.ctx = ctx
