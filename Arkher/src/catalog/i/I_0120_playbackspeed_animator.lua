-- ARKHER SYSTEM I.0120 :: Playback Speed Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0120"
	S.key = "arkher.anim.playbackspeed.layered_blending"
	S.name = "Playback Speed Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.playbackspeed.clip_sampling" }
	S.tags = { "i", "playbackspeed", "animator", "anim" }
	S.description = "Playback Speed Layered Blending: layers, crossfades, masks and blend trees for the Playback Speed subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.playbackspeed.layered_blending", budget = 6 })
		inst.system = S
		inst.ctx = ctx
