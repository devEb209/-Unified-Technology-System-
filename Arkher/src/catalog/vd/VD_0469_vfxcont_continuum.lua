-- ARKHER SYSTEM VD.0469 :: VFX Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0469"
	S.key = "arkher.contsim.vfxcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "vfxcont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.vfxcont.infinite_grid", cellSize = 224, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
