-- ARKHER SYSTEM G.0309 :: Weight Quantization Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0309"
	S.key = "arkher.neural.quantization.inference_core"
	S.name = "Weight Quantization Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "quantization", "inference", "neural" }
	S.description = "Weight Quantization Inference Core: dense network forward pass and training for the Weight Quantization subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.quantization.inference_core", seed = 66189 })
		inst.system = S
		inst.ctx = ctx
