-- ARKHER SYSTEM O.0210 :: Occlusion Zone Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0210"
	S.key = "arkher.audio.occlusionzone.streaming"
	S.name = "Occlusion Zone Streaming"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.occlusionzone.voice_budget" }
	S.tags = { "o", "occlusionzone", "streamer", "audio" }
	S.description = "Occlusion Zone Streaming: distance-driven residency of audio assets for the Occlusion Zone subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.occlusionzone.streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
