-- ARKHER SYSTEM P.0305 :: Ranged State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0305"
	S.key = "arkher.play.ranged.state_machine"
	S.name = "Ranged State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ranged"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ranged.combat_resolution" }
	S.tags = { "p", "ranged", "orchestrator", "play" }
	S.description = "Ranged State Machine: the phase machine that drives this gameplay loop for the Ranged subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.ranged.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
