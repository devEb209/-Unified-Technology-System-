-- ARKHER SYSTEM Z.0800 :: Attention Driven Detail Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0800"
	S.key = "arkher.origin.attentiondetail.orchestration"
	S.name = "Attention Driven Detail Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.residency_streaming" }
	S.tags = { "z", "attentiondetail", "orchestrator", "origin" }
	S.description = "Attention Driven Detail Orchestration: lifecycle and phase orchestration of the technology for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.attentiondetail.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
