-- ARKHER SYSTEM VD.0427 :: Navigation Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0427"
	S.key = "arkher.contsim.navcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.navcont.coherence_guard" }
	S.tags = { "vd", "navcont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.navcont.neural_field", dims = 24, hidden = 20, seed = 57803 })
		inst.system = S
		inst.ctx = ctx
