-- ARKHER SYSTEM R.0342 :: Reconnection Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0342"
	S.key = "arkher.net.reconnection.serialization_codec"
	S.name = "Reconnection Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Reconnection"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reconnection.bandwidth_budget" }
	S.tags = { "r", "reconnection", "codec", "net" }
	S.description = "Reconnection Serialization Codec: compact encoding, diffing and checksum of payloads for the Reconnection subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.reconnection.serialization_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
