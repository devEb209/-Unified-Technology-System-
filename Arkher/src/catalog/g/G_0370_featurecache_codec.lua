-- ARKHER SYSTEM G.0370 :: Feature Cache Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0370"
	S.key = "arkher.neural.featurecache.weight_codec"
	S.name = "Feature Cache Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.featurecache.model_registry" }
	S.tags = { "g", "featurecache", "codec", "neural" }
	S.description = "Feature Cache Weight Codec: weight serialization and quantized transport for the Feature Cache subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.featurecache.weight_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
