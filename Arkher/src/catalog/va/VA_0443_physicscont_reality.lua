-- ARKHER SYSTEM VA.0443 :: Physics Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0443"
	S.key = "arkher.contworld.physicscont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.physicscont.simulation_fabric" }
	S.tags = { "va", "physicscont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.physicscont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
