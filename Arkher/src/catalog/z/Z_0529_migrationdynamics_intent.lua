-- ARKHER SYSTEM Z.0529 :: Migration Dynamics Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0529"
	S.key = "arkher.origin.migrationdynamics.intent_bridge"
	S.name = "Migration Dynamics Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.migrationdynamics.semantic_graph" }
	S.tags = { "z", "migrationdynamics", "intent", "origin" }
	S.description = "Migration Dynamics Intent Bridge: natural language control surface for the technology for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.migrationdynamics.intent_bridge", minConfidence = 0.43 })
		inst.system = S
		inst.ctx = ctx
