-- ARKHER SYSTEM J.0146 :: Posture Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0146"
	S.key = "arkher.character.posture.blend_controller"
	S.name = "Posture Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.posture.motion_set" }
	S.tags = { "j", "posture", "animator", "character" }
	S.description = "Posture Blend Controller: layered playback driving the character for the Posture subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.posture.blend_controller", budget = 15 })
		inst.system = S
		inst.ctx = ctx
