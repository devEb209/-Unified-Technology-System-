-- ARKHER SYSTEM E.0027 :: Surface Definition Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0027"
	S.key = "arkher.material.surfacedef.analysis"
	S.name = "Surface Definition Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.surfacedef.instance_cache" }
	S.tags = { "e", "surfacedef", "analyzer", "material" }
	S.description = "Surface Definition Analysis: cost, redundancy and outlier analysis for the Surface Definition subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.surfacedef.analysis", window = 149, buckets = 9, threshold = 2.10 })
		inst.system = S
		inst.ctx = ctx
