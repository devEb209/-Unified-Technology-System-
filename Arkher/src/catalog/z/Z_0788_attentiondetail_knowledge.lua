-- ARKHER SYSTEM Z.0788 :: Attention Driven Detail Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0788"
	S.key = "arkher.origin.attentiondetail.semantic_graph"
	S.name = "Attention Driven Detail Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.world_architect" }
	S.tags = { "z", "attentiondetail", "knowledge", "origin" }
	S.description = "Attention Driven Detail Semantic Graph: typed entities and inferred relations of the technology itself for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.attentiondetail.semantic_graph", dims = 16 })
		inst.system = S
		inst.ctx = ctx
