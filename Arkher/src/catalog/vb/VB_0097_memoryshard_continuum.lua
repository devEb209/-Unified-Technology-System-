-- ARKHER SYSTEM VB.0097 :: Memory Shard Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0097"
	S.key = "arkher.conttime.memoryshard.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "memoryshard", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.memoryshard.infinite_grid", cellSize = 128, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
