-- ARKHER SYSTEM VD.0037 :: Continuum Stream Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0037"
	S.key = "arkher.contsim.continuumstream.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "continuumstream", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.continuumstream.infinite_grid", cellSize = 64, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
