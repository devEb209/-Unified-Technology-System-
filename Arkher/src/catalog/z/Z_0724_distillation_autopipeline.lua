-- ARKHER SYSTEM Z.0724 :: Knowledge Distillation Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0724"
	S.key = "arkher.origin.distillation.autonomous_pipeline"
	S.name = "Knowledge Distillation Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.distillation.simulation_fabric" }
	S.tags = { "z", "distillation", "autopipeline", "origin" }
	S.description = "Knowledge Distillation Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Knowledge Distillation subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.distillation.autonomous_pipeline", maxIterations = 7 })
		inst.system = S
		inst.ctx = ctx
