-- ARKHER SYSTEM I.0505 :: Cloth Animation Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0505"
	S.key = "arkher.anim.clothanim.quality_policy"
	S.name = "Cloth Animation Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clothanim.pose_cache" }
	S.tags = { "i", "clothanim", "policy", "anim" }
	S.description = "Cloth Animation Quality Policy: device tier rules for rate, bones and solvers for the Cloth Animation subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.clothanim.quality_policy", algorithm = "lottery", starvationGuard = 59 })
		inst.system = S
		inst.ctx = ctx
