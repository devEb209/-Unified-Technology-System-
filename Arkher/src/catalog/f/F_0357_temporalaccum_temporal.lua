-- ARKHER SYSTEM F.0357 :: Temporal Accumulation Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0357"
	S.key = "arkher.render.temporalaccum.temporal_resolve"
	S.name = "Temporal Accumulation Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.temporalaccum.probe_volume" }
	S.tags = { "f", "temporalaccum", "temporal", "render" }
	S.description = "Temporal Accumulation Temporal Resolve: history reprojection with neighbourhood clamping for the Temporal Accumulation subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.temporalaccum.temporal_resolve", feedback = 0.82, phase = 8 })
		inst.system = S
		inst.ctx = ctx
