-- ARKHER SYSTEM F.0157 :: Volumetric Light Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0157"
	S.key = "arkher.render.volumetric.visibility_set"
	S.name = "Volumetric Light Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.volumetric.view_and_culling" }
	S.tags = { "f", "volumetric", "visibility", "render" }
	S.description = "Volumetric Light Visibility Set: cell, portal and occluder visibility for the Volumetric Light subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.volumetric.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
