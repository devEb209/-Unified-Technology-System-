-- ARKHER SYSTEM P.0318 :: Damage Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0318"
	S.key = "arkher.play.damage.rule_pipeline"
	S.name = "Damage Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Damage"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.damage.state_machine" }
	S.tags = { "p", "damage", "pipeline", "play" }
	S.description = "Damage Rule Pipeline: ordered rules applied to every gameplay event for the Damage subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.damage.rule_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
