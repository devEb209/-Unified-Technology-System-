-- ARKHER SYSTEM K.0006 :: NPC Brain Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0006"
	S.key = "arkher.npc.npcbrain.reactive_behaviour"
	S.name = "NPC Brain Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcbrain.perception" }
	S.tags = { "k", "npcbrain", "behaviortree", "npc" }
	S.description = "NPC Brain Reactive Behaviour: sequences, selectors, decorators and cooldowns for the NPC Brain subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.npcbrain.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
