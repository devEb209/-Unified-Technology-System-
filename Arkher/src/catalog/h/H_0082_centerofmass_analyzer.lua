-- ARKHER SYSTEM H.0082 :: Center Of Mass Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0082"
	S.key = "arkher.physics.centerofmass.analysis"
	S.name = "Center Of Mass Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.centerofmass.result_cache" }
	S.tags = { "h", "centerofmass", "analyzer", "physics" }
	S.description = "Center Of Mass Analysis: energy, jitter and cost analysis of the simulation for the Center Of Mass subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.centerofmass.analysis", window = 111, buckets = 11, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
