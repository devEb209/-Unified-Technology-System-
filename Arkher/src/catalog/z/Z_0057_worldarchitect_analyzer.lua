-- ARKHER SYSTEM Z.0057 :: Singularity World Architect Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0057"
	S.key = "arkher.origin.worldarchitect.behaviour_analysis"
	S.name = "Singularity World Architect Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.governance_policy" }
	S.tags = { "z", "worldarchitect", "analyzer", "origin" }
	S.description = "Singularity World Architect Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.worldarchitect.behaviour_analysis", window = 202, buckets = 18, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
