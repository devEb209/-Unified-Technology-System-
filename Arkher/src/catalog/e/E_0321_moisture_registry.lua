-- ARKHER SYSTEM E.0321 :: Moisture Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0321"
	S.key = "arkher.material.moisture.variant_registry"
	S.name = "Moisture Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Moisture"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.moisture.procedural_detail" }
	S.tags = { "e", "moisture", "registry", "material" }
	S.description = "Moisture Variant Registry: named variants and their lifecycle for the Moisture subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.moisture.variant_registry" })
		inst.system = S
		inst.ctx = ctx
