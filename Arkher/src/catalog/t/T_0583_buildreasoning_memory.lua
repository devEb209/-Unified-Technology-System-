-- ARKHER SYSTEM T.0583 :: Build Reasoning Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0583"
	S.key = "arkher.ai.buildreasoning.working_memory"
	S.name = "Build Reasoning Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.buildreasoning.outcome_prediction" }
	S.tags = { "t", "buildreasoning", "memory", "ai" }
	S.description = "Build Reasoning Working Memory: decaying, consolidating recall of what the agent learned for the Build Reasoning subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.buildreasoning.working_memory", capacity = 105, decayRate = 0.055, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
