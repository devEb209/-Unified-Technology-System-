-- ARKHER SYSTEM F.0580 :: Debug Visualization Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0580"
	S.key = "arkher.render.debugvis.probe_volume"
	S.name = "Debug Visualization Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.debugvis.lighting_rig" }
	S.tags = { "f", "debugvis", "probe", "render" }
	S.description = "Debug Visualization Probe Volume: irradiance probes encoded in spherical harmonics for the Debug Visualization subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.debugvis.probe_volume", spacing = 16 })
		inst.system = S
		inst.ctx = ctx
