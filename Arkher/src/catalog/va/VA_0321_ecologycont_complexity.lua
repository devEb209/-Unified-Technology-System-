-- ARKHER SYSTEM VA.0321 :: Ecology Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0321"
	S.key = "arkher.contworld.ecologycont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.ecologycont.world_memory_stream" }
	S.tags = { "va", "ecologycont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.ecologycont.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
