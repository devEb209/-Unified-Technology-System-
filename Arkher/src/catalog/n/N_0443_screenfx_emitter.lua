-- ARKHER SYSTEM N.0443 :: Screen Effect Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0443"
	S.key = "arkher.vfx.screenfx.emission"
	S.name = "Screen Effect Emission"
	S.category = "N"
	S.family = "VFX"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "screenfx", "emitter", "vfx" }
	S.description = "Screen Effect Emission: shaped, rate and burst emission of new particles for the Screen Effect subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.screenfx.emission", shape = "sphere", rate = 77, speed = 6.70, life = 3.50, budget = 448, seed = 38037 })
		inst.system = S
		inst.ctx = ctx
