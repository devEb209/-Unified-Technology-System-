-- ARKHER SYSTEM Z.0727 :: Knowledge Distillation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0727"
	S.key = "arkher.origin.distillation.world_architect"
	S.name = "Knowledge Distillation World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.distillation.emergence_detection" }
	S.tags = { "z", "distillation", "architect", "origin" }
	S.description = "Knowledge Distillation World Architect: hierarchical world composition with conserved budgets for the Knowledge Distillation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.distillation.world_architect", budget = 1400, seed = 92028 })
		inst.system = S
		inst.ctx = ctx
