-- ARKHER SYSTEM K.0437 :: Local Avoidance Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0437"
	S.key = "arkher.npc.localavoidance.drive_system"
	S.name = "Local Avoidance Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.localavoidance.memory" }
	S.tags = { "k", "localavoidance", "need", "npc" }
	S.description = "Local Avoidance Drive System: drives that decay, turn urgent and get satisfied for the Local Avoidance subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.localavoidance.drive_system" })
		inst.system = S
		inst.ctx = ctx
