-- ARKHER SYSTEM K.0497 :: Patrol Route Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0497"
	S.key = "arkher.npc.patrolroute.utility_reasoning"
	S.name = "Patrol Route Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.patrolroute.reactive_behaviour" }
	S.tags = { "k", "patrolroute", "utility", "npc" }
	S.description = "Patrol Route Utility Reasoning: scored option selection with response curves for the Patrol Route subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.patrolroute.utility_reasoning", momentum = 0.15 })
		inst.system = S
		inst.ctx = ctx
