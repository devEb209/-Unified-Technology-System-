-- ARKHER SYSTEM VB.0372 :: Quest Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0372"
	S.key = "arkher.conttime.questcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.questcont.reality_continuum" }
	S.tags = { "vb", "questcont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.questcont.emergence_continuum", windowSize = 4, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
