-- ARKHER SYSTEM VA.0113 :: Temporal Slice Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0113"
	S.key = "arkher.contworld.temporalslice.persistent_state"
	S.name = "Temporal Slice Persistent State"
	S.category = "VA"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.temporalslice.multi-scale_fidelity" }
	S.tags = { "va", "temporalslice", "persistent", "contworld" }
	S.description = "Temporal Slice Persistent State: epoch-stamped persistent history and rollback for the Temporal Slice subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.temporalslice.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
