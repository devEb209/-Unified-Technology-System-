-- ARKHER SYSTEM VD.0434 :: Physics Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0434"
	S.key = "arkher.contsim.physicscont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.physicscont.infinite_grid" }
	S.tags = { "vd", "physicscont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.physicscont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
