-- ARKHER SYSTEM Z.0144 :: Autonomous Development Pipeline Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0144"
	S.key = "arkher.origin.autodevpipeline.autonomous_pipeline"
	S.name = "Autonomous Development Pipeline Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodevpipeline.simulation_fabric" }
	S.tags = { "z", "autodevpipeline", "autopipeline", "origin" }
	S.description = "Autonomous Development Pipeline Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Autonomous Development Pipeline subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.autodevpipeline.autonomous_pipeline", maxIterations = 9 })
		inst.system = S
		inst.ctx = ctx
