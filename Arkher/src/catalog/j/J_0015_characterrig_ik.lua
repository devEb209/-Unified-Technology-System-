-- ARKHER SYSTEM J.0015 :: Character Rig Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0015"
	S.key = "arkher.character.characterrig.look_and_reach"
	S.name = "Character Rig Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterrig.blend_controller" }
	S.tags = { "j", "characterrig", "ik", "character" }
	S.description = "Character Rig Look And Reach: look-at, reach and foot placement for the character for the Character Rig subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.characterrig.look_and_reach", iterations = 15, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
