-- ARKHER SYSTEM VD.0029 :: Zone Chunk Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0029"
	S.key = "arkher.contsim.zonechunk.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.zonechunk.multi-scale_fidelity" }
	S.tags = { "vd", "zonechunk", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.zonechunk.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
