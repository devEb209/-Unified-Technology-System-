-- ARKHER SYSTEM R.0041 :: Authentication Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0041"
	S.key = "arkher.net.netauth.bandwidth_budget"
	S.name = "Authentication Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netauth.transport_graph" }
	S.tags = { "r", "netauth", "budgeter", "net" }
	S.description = "Authentication Bandwidth Budget: bytes per second shared between competing streams for the Authentication subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.netauth.bandwidth_budget", total = 127, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
