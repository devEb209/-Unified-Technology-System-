-- ARKHER SYSTEM H.0608 :: Explosion Force Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0608"
	S.key = "arkher.physics.explosion.character_motion"
	S.name = "Explosion Force Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.explosion.query" }
	S.tags = { "h", "explosion", "charmotor", "physics" }
	S.description = "Explosion Force Character Motion: capsule move-and-slide with slopes, steps and jumps for the Explosion Force subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.explosion.character_motion", radius = 0.36, height = 1.81, maxSpeed = 8.10, jumpHeight = 1.70, stepOffset = 0.36 })
		inst.system = S
		inst.ctx = ctx
