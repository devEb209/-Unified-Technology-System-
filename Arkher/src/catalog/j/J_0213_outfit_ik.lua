-- ARKHER SYSTEM J.0213 :: Outfit Composition Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0213"
	S.key = "arkher.character.outfit.look_and_reach"
	S.name = "Outfit Composition Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.outfit.blend_controller" }
	S.tags = { "j", "outfit", "ik", "character" }
	S.description = "Outfit Composition Look And Reach: look-at, reach and foot placement for the character for the Outfit Composition subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.outfit.look_and_reach", iterations = 10, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
