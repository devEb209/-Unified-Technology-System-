-- ARKHER SYSTEM VD.0295 :: Climate Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0295"
	S.key = "arkher.contsim.climatecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.climatecont.coherence_guard" }
	S.tags = { "vd", "climatecont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.climatecont.neural_field", dims = 24, hidden = 20, seed = 20019 })
		inst.system = S
		inst.ctx = ctx
