-- ARKHER SYSTEM J.0131 :: Breathing Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0131"
	S.key = "arkher.character.breathing.streaming"
	S.name = "Breathing Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.breathing.budget_governor" }
	S.tags = { "j", "breathing", "streamer", "character" }
	S.description = "Breathing Streaming: distance-driven residency of character data for the Breathing subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.breathing.streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
