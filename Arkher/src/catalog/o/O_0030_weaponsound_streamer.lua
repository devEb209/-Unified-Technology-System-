-- ARKHER SYSTEM O.0030 :: Weapon Sound Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0030"
	S.key = "arkher.audio.weaponsound.streaming"
	S.name = "Weapon Sound Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Weapon Sound"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.weaponsound.voice_budget" }
	S.tags = { "o", "weaponsound", "streamer", "audio" }
	S.description = "Weapon Sound Streaming: distance-driven residency of audio assets for the Weapon Sound subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.weaponsound.streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
