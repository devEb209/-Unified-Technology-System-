-- ARKHER SYSTEM VA.0427 :: Navigation Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0427"
	S.key = "arkher.contworld.navcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.navcont.coherence_guard" }
	S.tags = { "va", "navcont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.navcont.neural_field", dims = 24, hidden = 20, seed = 2283 })
		inst.system = S
		inst.ctx = ctx
