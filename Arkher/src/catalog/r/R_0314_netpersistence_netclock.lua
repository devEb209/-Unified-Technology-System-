-- ARKHER SYSTEM R.0314 :: Data Persistence Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0314"
	S.key = "arkher.net.netpersistence.time_sync"
	S.name = "Data Persistence Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netpersistence.replication" }
	S.tags = { "r", "netpersistence", "netclock", "net" }
	S.description = "Data Persistence Time Sync: offset estimation, outlier rejection and jitter buffering for the Data Persistence subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.netpersistence.time_sync", tickRate = 20, bufferDelay = 0.140, maxSamples = 20 })
		inst.system = S
		inst.ctx = ctx
