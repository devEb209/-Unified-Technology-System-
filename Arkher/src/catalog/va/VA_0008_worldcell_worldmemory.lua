-- ARKHER SYSTEM VA.0008 :: World Grid Cell World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0008"
	S.key = "arkher.contworld.worldcell.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldcell.neural_field" }
	S.tags = { "va", "worldcell", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.worldcell.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
