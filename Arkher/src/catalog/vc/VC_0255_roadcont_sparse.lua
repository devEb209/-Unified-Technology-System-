-- ARKHER SYSTEM VC.0255 :: Road Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0255"
	S.key = "arkher.contneural.roadcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.roadcont.epoch_clock" }
	S.tags = { "vc", "roadcont", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.roadcont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
