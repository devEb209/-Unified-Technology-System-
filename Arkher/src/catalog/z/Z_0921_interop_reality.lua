-- ARKHER SYSTEM Z.0921 :: Universal Interop Layer Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0921"
	S.key = "arkher.origin.interop.reality_layering"
	S.name = "Universal Interop Layer Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "interop", "reality", "origin" }
	S.description = "Universal Interop Layer Reality Layering: stacked authored, simulated, proposed and player realities for the Universal Interop Layer subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.interop.reality_layering" })
		inst.system = S
		inst.ctx = ctx
