-- ARKHER SYSTEM E.0397 :: Texture Atlas Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0397"
	S.key = "arkher.material.atlas.parameter_budget"
	S.name = "Texture Atlas Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.atlas.variant_registry" }
	S.tags = { "e", "atlas", "budgeter", "material" }
	S.description = "Texture Atlas Parameter Budget: texel and layer budget allocation for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.atlas.parameter_budget", total = 389, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
