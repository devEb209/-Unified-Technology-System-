-- ARKHER SYSTEM G.0375 :: Feature Cache Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0375"
	S.key = "arkher.neural.featurecache.error_analysis"
	S.name = "Feature Cache Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.featurecache.heuristic_policy" }
	S.tags = { "g", "featurecache", "analyzer", "neural" }
	S.description = "Feature Cache Error Analysis: residual and drift analysis for the Feature Cache subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.featurecache.error_analysis", window = 231, buckets = 11, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
