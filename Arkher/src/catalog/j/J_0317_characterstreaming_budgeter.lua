-- ARKHER SYSTEM J.0317 :: Character Streaming Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0317"
	S.key = "arkher.character.characterstreaming.budget_governor"
	S.name = "Character Streaming Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterstreaming.variant_registry" }
	S.tags = { "j", "characterstreaming", "budgeter", "character" }
	S.description = "Character Streaming Budget Governor: per-character cost allocation in a crowd for the Character Streaming subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.characterstreaming.budget_governor", total = 318, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
