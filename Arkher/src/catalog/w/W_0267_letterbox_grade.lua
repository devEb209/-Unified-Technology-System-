-- ARKHER SYSTEM W.0267 :: Letterbox Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0267"
	S.key = "arkher.cine.letterbox.colour_grade"
	S.name = "Letterbox Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Letterbox"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.letterbox.camera_rig" }
	S.tags = { "w", "letterbox", "grade", "cine" }
	S.description = "Letterbox Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Letterbox subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.letterbox.colour_grade", exposure = -0.10, contrast = 0.95, saturation = 1.10, toneMap = "reinhard" })
		inst.system = S
		inst.ctx = ctx
