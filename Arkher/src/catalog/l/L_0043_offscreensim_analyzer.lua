-- ARKHER SYSTEM L.0043 :: Offscreen Simulation Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0043"
	S.key = "arkher.sim.offscreensim.analysis"
	S.name = "Offscreen Simulation Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.offscreensim.aggregate_cache" }
	S.tags = { "l", "offscreensim", "analyzer", "sim" }
	S.description = "Offscreen Simulation Analysis: trend, anomaly and stability analysis of the world for the Offscreen Simulation subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.offscreensim.analysis", window = 184, buckets = 12, threshold = 3.60 })
		inst.system = S
		inst.ctx = ctx
