-- ARKHER SYSTEM VD.0188 :: Simulation Domain World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0188"
	S.key = "arkher.contsim.simdomain.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.simdomain.neural_field" }
	S.tags = { "vd", "simdomain", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.simdomain.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
