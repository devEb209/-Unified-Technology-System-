-- ARKHER SYSTEM K.0065 :: Episodic Memory Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0065"
	S.key = "arkher.npc.episodicmemory.navigation"
	S.name = "Episodic Memory Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.episodicmemory.goal_planner" }
	S.tags = { "k", "episodicmemory", "navgraph", "npc" }
	S.description = "Episodic Memory Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Episodic Memory subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.episodicmemory.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
