-- ARKHER SYSTEM E.0364 :: Vertex Painting Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0364"
	S.key = "arkher.material.vertexpaint.texture_sampling"
	S.name = "Vertex Painting Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.vertexpaint.shading_graph" }
	S.tags = { "e", "vertexpaint", "sampler", "material" }
	S.description = "Vertex Painting Texture Sampling: atlas packing, mip chain and filtered sampling for the Vertex Painting subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.vertexpaint.texture_sampling", atlasSize = 192, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
