-- ARKHER SYSTEM T.0225 :: Quest Generation Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0225"
	S.key = "arkher.ai.questgeneration.intent_understanding"
	S.name = "Quest Generation Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "questgeneration", "intent", "ai" }
	S.description = "Quest Generation Intent Understanding: natural language turned into an actionable, scored intent for the Quest Generation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.questgeneration.intent_understanding", minConfidence = 0.35 })
		inst.system = S
		inst.ctx = ctx
