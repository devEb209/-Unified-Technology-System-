-- ARKHER SYSTEM J.0115 :: Gaze Behaviour Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0115"
	S.key = "arkher.character.gaze.physical_response"
	S.name = "Gaze Behaviour Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gaze.look_and_reach" }
	S.tags = { "j", "gaze", "ragdoll", "character" }
	S.description = "Gaze Behaviour Physical Response: physical reaction, ragdoll and recovery for the Gaze Behaviour subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.gaze.physical_response", blendSpeed = 4.50 })
		inst.system = S
		inst.ctx = ctx
