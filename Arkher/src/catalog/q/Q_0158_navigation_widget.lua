-- ARKHER SYSTEM Q.0158 :: Navigation Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0158"
	S.key = "arkher.ui.navigation.widget_tree"
	S.name = "Navigation Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Navigation"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.navigation.responsive_layout" }
	S.tags = { "q", "navigation", "widget", "ui" }
	S.description = "Navigation Widget Tree: retained widget nodes, properties, bindings and rendering for the Navigation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.navigation.widget_tree", theme = "highcontrast", scale = 0.83 })
		inst.system = S
		inst.ctx = ctx
