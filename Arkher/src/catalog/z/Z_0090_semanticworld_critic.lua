-- ARKHER SYSTEM Z.0090 :: Semantic World Graph Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0090"
	S.key = "arkher.origin.semanticworld.self_critique"
	S.name = "Semantic World Graph Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticworld.intent_bridge" }
	S.tags = { "z", "semanticworld", "critic", "origin" }
	S.description = "Semantic World Graph Self Critique: weighted judgement of the technology's own output for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.semanticworld.self_critique", passMark = 0.84, reviseMark = 0.44, seed = 80684 })
		inst.system = S
		inst.ctx = ctx
