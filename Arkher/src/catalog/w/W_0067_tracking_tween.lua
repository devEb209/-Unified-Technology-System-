-- ARKHER SYSTEM W.0067 :: Tracking Shot Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0067"
	S.key = "arkher.cine.tracking.motion_tween"
	S.name = "Tracking Shot Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.tracking.playback_orchestrator" }
	S.tags = { "w", "tracking", "tween", "cine" }
	S.description = "Tracking Shot Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Tracking Shot subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.tracking.motion_tween", timeScale = 1.03 })
		inst.system = S
		inst.ctx = ctx
