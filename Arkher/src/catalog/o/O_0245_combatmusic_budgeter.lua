-- ARKHER SYSTEM O.0245 :: Combat Music Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0245"
	S.key = "arkher.audio.combatmusic.voice_budget"
	S.name = "Combat Music Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Combat Music"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.combatmusic.music_sequencer" }
	S.tags = { "o", "combatmusic", "budgeter", "audio" }
	S.description = "Combat Music Voice Budget: voice slots allocated by priority and audibility for the Combat Music subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.combatmusic.voice_budget", total = 410, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
