-- ARKHER SYSTEM J.0105 :: Lip Sync Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0105"
	S.key = "arkher.character.lipsync.locomotion"
	S.name = "Lip Sync Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.lipsync.physical_response" }
	S.tags = { "j", "lipsync", "charmotor", "character" }
	S.description = "Lip Sync Locomotion: capsule locomotion driving the character for the Lip Sync subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.lipsync.locomotion", radius = 0.54, height = 1.79, maxSpeed = 7.90, jumpHeight = 1.50, stepOffset = 0.34 })
		inst.system = S
		inst.ctx = ctx
