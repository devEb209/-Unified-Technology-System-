-- ARKHER SYSTEM E.0469 :: Material Instance Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0469"
	S.key = "arkher.material.instance.texture_sampling"
	S.name = "Material Instance Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.instance.shading_graph" }
	S.tags = { "e", "instance", "sampler", "material" }
	S.description = "Material Instance Texture Sampling: atlas packing, mip chain and filtered sampling for the Material Instance subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.instance.texture_sampling", atlasSize = 128, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
