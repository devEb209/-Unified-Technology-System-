-- ARKHER SYSTEM W.0218 :: Transition Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0218"
	S.key = "arkher.cine.cinetransition.camera_rig"
	S.name = "Transition Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Transition"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinetransition.sequence_timeline" }
	S.tags = { "w", "cinetransition", "camerarig", "cine" }
	S.description = "Transition Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Transition subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.cinetransition.camera_rig", fov = 1.45, focus = 7.0, aperture = 4.9, smoothing = 9.0, distance = 9, height = 3 })
		inst.system = S
		inst.ctx = ctx
