-- ARKHER SYSTEM K.0695 :: NPC Debug Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0695"
	S.key = "arkher.npc.npcdebug.navigation"
	S.name = "NPC Debug Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcdebug.goal_planner" }
	S.tags = { "k", "npcdebug", "navgraph", "npc" }
	S.description = "NPC Debug Navigation: grid pathfinding, smoothing, line of sight and flow fields for the NPC Debug subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.npcdebug.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
