-- ARKHER SYSTEM O.0238 :: Adaptive Music Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0238"
	S.key = "arkher.audio.adaptivemusic.analysis"
	S.name = "Adaptive Music Analysis"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.adaptivemusic.playback_policy" }
	S.tags = { "o", "adaptivemusic", "analyzer", "audio" }
	S.description = "Adaptive Music Analysis: loudness, headroom and masking analysis for the Adaptive Music subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.adaptivemusic.analysis", window = 70, buckets = 10, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
