-- ARKHER SYSTEM G.0215 :: Reflection Prediction Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0215"
	S.key = "arkher.neural.reflectpredict.model_registry"
	S.name = "Reflection Prediction Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.reflectpredict.reconstruction" }
	S.tags = { "g", "reflectpredict", "registry", "neural" }
	S.description = "Reflection Prediction Model Registry: named models and their lifecycle for the Reflection Prediction subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.reflectpredict.model_registry" })
		inst.system = S
		inst.ctx = ctx
