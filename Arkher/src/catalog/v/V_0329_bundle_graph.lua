-- ARKHER SYSTEM V.0329 :: Bundle Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0329"
	S.key = "arkher.asset.bundle.dependency_graph"
	S.name = "Bundle Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.bundle.asset_registry" }
	S.tags = { "v", "bundle", "graph", "asset" }
	S.description = "Bundle Dependency Graph: what references what, and in which order it must be built for the Bundle subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.bundle.dependency_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
