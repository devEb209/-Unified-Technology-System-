-- ARKHER SYSTEM O.0398 :: Mobile Audio Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0398"
	S.key = "arkher.audio.mobileaudio.mixer_bus"
	S.name = "Mobile Audio Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mobile Audio"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mobileaudio.dsp_chain" }
	S.tags = { "o", "mobileaudio", "mixer", "audio" }
	S.description = "Mobile Audio Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Mobile Audio subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.mobileaudio.mixer_bus", maxVoices = 48 })
		inst.system = S
		inst.ctx = ctx
