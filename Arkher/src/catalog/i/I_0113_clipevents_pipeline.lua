-- ARKHER SYSTEM I.0113 :: Clip Events Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0113"
	S.key = "arkher.anim.clipevents.playback_pipeline"
	S.name = "Clip Events Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Events"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clipevents.event_ledger" }
	S.tags = { "i", "clipevents", "pipeline", "anim" }
	S.description = "Clip Events Playback Pipeline: ordered sample, blend, ik and output stages for the Clip Events subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.clipevents.playback_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
