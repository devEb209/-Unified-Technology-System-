-- ARKHER SYSTEM V.0268 :: Lightmap Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0268"
	S.key = "arkher.asset.lightmap.asset_registry"
	S.name = "Lightmap Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lightmap.cook_pipeline" }
	S.tags = { "v", "lightmap", "registry", "asset" }
	S.description = "Lightmap Asset Registry: catalogue of every asset, its tags and its metadata for the Lightmap subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.lightmap.asset_registry" })
		inst.system = S
		inst.ctx = ctx
