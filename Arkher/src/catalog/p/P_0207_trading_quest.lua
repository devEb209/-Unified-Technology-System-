-- ARKHER SYSTEM P.0207 :: Trading Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0207"
	S.key = "arkher.play.trading.objectives"
	S.name = "Trading Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Trading"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.trading.inventory" }
	S.tags = { "p", "trading", "quest", "play" }
	S.description = "Trading Objectives: objectives, prerequisites, progress and rewards for the Trading subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.trading.objectives" })
		inst.system = S
		inst.ctx = ctx
