-- ARKHER SYSTEM Z.0806 :: Perceptual Budgeting Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0806"
	S.key = "arkher.origin.perceptualbudget.emergence_detection"
	S.name = "Perceptual Budgeting Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.perceptualbudget.world_memory" }
	S.tags = { "z", "perceptualbudget", "emergence", "origin" }
	S.description = "Perceptual Budgeting Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.perceptualbudget.emergence_detection", windowSize = 6, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
