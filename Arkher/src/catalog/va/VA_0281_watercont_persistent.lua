-- ARKHER SYSTEM VA.0281 :: Water Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0281"
	S.key = "arkher.contworld.watercont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.watercont.multi-scale_fidelity" }
	S.tags = { "va", "watercont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.watercont.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
