-- ARKHER SYSTEM I.0339 :: Physical Animation Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0339"
	S.key = "arkher.anim.physanim.skeleton"
	S.name = "Physical Animation Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "physanim", "skeleton", "anim" }
	S.description = "Physical Animation Skeleton: bone hierarchy, bind pose and world resolution for the Physical Animation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.physanim.skeleton" })
		inst.system = S
		inst.ctx = ctx
