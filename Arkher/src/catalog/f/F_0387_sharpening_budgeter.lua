-- ARKHER SYSTEM F.0387 :: Sharpening Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0387"
	S.key = "arkher.render.sharpening.draw_budget"
	S.name = "Sharpening Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sharpening"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sharpening.adaptive_resolution" }
	S.tags = { "f", "sharpening", "budgeter", "render" }
	S.description = "Sharpening Draw Budget: draw call and triangle budget allocation for the Sharpening subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.sharpening.draw_budget", total = 218, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
