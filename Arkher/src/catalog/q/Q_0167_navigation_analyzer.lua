-- ARKHER SYSTEM Q.0167 :: Navigation Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0167"
	S.key = "arkher.ui.navigation.usability_analysis"
	S.name = "Navigation Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Navigation"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.navigation.frame_budget" }
	S.tags = { "q", "navigation", "analyzer", "ui" }
	S.description = "Navigation Usability Analysis: reachability, latency and abandonment analysis for the Navigation subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.navigation.usability_analysis", window = 228, buckets = 12, threshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
