-- ARKHER SYSTEM T.0638 :: Confidence Estimation Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0638"
	S.key = "arkher.ai.confidence.outcome_prediction"
	S.name = "Confidence Estimation Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.confidence.decision_policy" }
	S.tags = { "t", "confidence", "predictor", "ai" }
	S.description = "Confidence Estimation Outcome Prediction: forecasting the result before the work is done for the Confidence Estimation subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.confidence.outcome_prediction", method = "ema", alpha = 0.42, window = 56 })
		inst.system = S
		inst.ctx = ctx
