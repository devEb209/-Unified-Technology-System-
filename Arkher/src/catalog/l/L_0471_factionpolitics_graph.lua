-- ARKHER SYSTEM L.0471 :: Faction Politics Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0471"
	S.key = "arkher.sim.factionpolitics.region_graph"
	S.name = "Faction Politics Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.factionpolitics.calendar" }
	S.tags = { "l", "factionpolitics", "graph", "sim" }
	S.description = "Faction Politics Region Graph: connectivity, components and shortest path between places for the Faction Politics subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.factionpolitics.region_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
