-- ARKHER SYSTEM P.0224 :: Currency Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0224"
	S.key = "arkher.play.currency.balance_analysis"
	S.name = "Currency Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Currency"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.currency.event_ledger" }
	S.tags = { "p", "currency", "analyzer", "play" }
	S.description = "Currency Balance Analysis: distribution, outlier and pacing analysis for the Currency subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.currency.balance_analysis", window = 93, buckets = 9, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
