-- ARKHER SYSTEM L.0226 :: Weather Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0226"
	S.key = "arkher.sim.weather.simulation_core"
	S.name = "Weather Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "weather", "simulation", "sim" }
	S.description = "Weather Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Weather subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.weather.simulation_core", fullRadius = 320, reducedRadius = 1300, budget = 79 })
		inst.system = S
		inst.ctx = ctx
