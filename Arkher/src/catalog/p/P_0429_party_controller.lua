-- ARKHER SYSTEM P.0429 :: Party Difficulty Controller
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0429"
	S.key = "arkher.play.party.difficulty_controller"
	S.name = "Party Difficulty Controller"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Party"
	...
	S.kit = "controller"
	S.version = "1.0.0"
	S.deps = { "arkher.play.party.balance_analysis" }
	S.tags = { "p", "party", "controller", "play" }
	S.description = "Party Difficulty Controller: closed-loop tuning toward a target challenge for the Party subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("controller", { id = "arkher.play.party.difficulty_controller", mode = "pid", target = 0.760, kp = 0.310, ki = 0.020, kd = 0.020, min = 0.05, max = 1.0, initial = 0.66, deadband = 0.01 })
		inst.system = S
		inst.ctx = ctx
