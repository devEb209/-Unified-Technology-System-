-- ARKHER SYSTEM VD.0101 :: Memory Shard Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0101"
	S.key = "arkher.contsim.memoryshard.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memoryshard.multi-scale_fidelity" }
	S.tags = { "vd", "memoryshard", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.memoryshard.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
