-- ARKHER SYSTEM VA.0531 :: Pipeline Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0531"
	S.key = "arkher.contworld.pipelinecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.pipelinecont.epoch_clock" }
	S.tags = { "va", "pipelinecont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.pipelinecont.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
