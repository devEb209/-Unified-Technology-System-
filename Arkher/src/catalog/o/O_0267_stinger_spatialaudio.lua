-- ARKHER SYSTEM O.0267 :: Stinger Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0267"
	S.key = "arkher.audio.stinger.spatialization"
	S.name = "Stinger Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Stinger"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.stinger.mixer_bus" }
	S.tags = { "o", "stinger", "spatialaudio", "audio" }
	S.description = "Stinger Spatialization: distance attenuation, panning, occlusion and doppler for the Stinger subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.stinger.spatialization", model = "linear", refDistance = 4, maxDistance = 140, rolloff = 1.13, maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
