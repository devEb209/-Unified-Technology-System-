-- ARKHER SYSTEM O.0079 :: Dialogue Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0079"
	S.key = "arkher.audio.dialogue.asset_registry"
	S.name = "Dialogue Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Dialogue"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.dialogue.streaming" }
	S.tags = { "o", "dialogue", "registry", "audio" }
	S.description = "Dialogue Asset Registry: catalogue of sounds, variations and metadata for the Dialogue subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.dialogue.asset_registry" })
		inst.system = S
		inst.ctx = ctx
