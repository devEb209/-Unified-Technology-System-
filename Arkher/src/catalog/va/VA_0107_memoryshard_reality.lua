-- ARKHER SYSTEM VA.0107 :: Memory Shard Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0107"
	S.key = "arkher.contworld.memoryshard.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memoryshard.simulation_fabric" }
	S.tags = { "va", "memoryshard", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.memoryshard.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
