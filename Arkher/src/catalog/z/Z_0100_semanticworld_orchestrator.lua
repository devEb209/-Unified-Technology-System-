-- ARKHER SYSTEM Z.0100 :: Semantic World Graph Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0100"
	S.key = "arkher.origin.semanticworld.orchestration"
	S.name = "Semantic World Graph Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticworld.residency_streaming" }
	S.tags = { "z", "semanticworld", "orchestrator", "origin" }
	S.description = "Semantic World Graph Orchestration: lifecycle and phase orchestration of the technology for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.semanticworld.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
