-- ARKHER SYSTEM L.0505 :: War Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0505"
	S.key = "arkher.sim.war.streaming"
	S.name = "War Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.war.state_codec" }
	S.tags = { "l", "war", "streamer", "sim" }
	S.description = "War Streaming: distance-driven residency of simulated regions for the War subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.war.streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
