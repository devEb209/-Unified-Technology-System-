-- ARKHER SYSTEM E.0317 :: Moisture Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0317"
	S.key = "arkher.material.moisture.layer_composition"
	S.name = "Moisture Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Moisture"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.moisture.definition" }
	S.tags = { "e", "moisture", "composer", "material" }
	S.description = "Moisture Layer Composition: ordered layer composition with blend rules for the Moisture subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.moisture.layer_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
