-- ARKHER SYSTEM VA.0181 :: Simulation Domain Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0181"
	S.key = "arkher.contworld.simdomain.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "simdomain", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.simdomain.infinite_grid", cellSize = 96, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
