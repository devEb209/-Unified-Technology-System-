-- ARKHER SYSTEM VA.0267 :: Bridge Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0267"
	S.key = "arkher.contworld.bridgecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.bridgecont.epoch_clock" }
	S.tags = { "va", "bridgecont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.bridgecont.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
