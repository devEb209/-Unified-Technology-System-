-- ARKHER SYSTEM VC.0167 :: Coherence Seam Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0167"
	S.key = "arkher.contneural.coherenceseam.reality_continuum"
	S.name = "Coherence Seam Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.coherenceseam.simulation_fabric" }
	S.tags = { "vc", "coherenceseam", "reality", "contneural" }
	S.description = "Coherence Seam Reality Continuum: stacked reality layers of the continuum for the Coherence Seam subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.coherenceseam.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
