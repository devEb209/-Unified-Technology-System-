-- ARKHER SYSTEM T.0074 :: Project Knowledge Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0074"
	S.key = "arkher.ai.projectknowledge.self_critique"
	S.name = "Project Knowledge Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.projectknowledge.plan_workflow" }
	S.tags = { "t", "projectknowledge", "critic", "ai" }
	S.description = "Project Knowledge Self Critique: weighted evaluation of the result against declared criteria for the Project Knowledge subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.projectknowledge.self_critique", passMark = 0.77, reviseMark = 0.42, seed = 53662 })
		inst.system = S
		inst.ctx = ctx
