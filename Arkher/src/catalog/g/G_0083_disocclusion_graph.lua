-- ARKHER SYSTEM G.0083 :: Disocclusion Handling Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0083"
	S.key = "arkher.neural.disocclusion.sampling_graph"
	S.name = "Disocclusion Handling Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.disocclusion.training_ledger" }
	S.tags = { "g", "disocclusion", "graph", "neural" }
	S.description = "Disocclusion Handling Sampling Graph: dependency graph of sampling stages for the Disocclusion Handling subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.disocclusion.sampling_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
