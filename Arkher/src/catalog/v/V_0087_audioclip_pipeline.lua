-- ARKHER SYSTEM V.0087 :: Audio Clip Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0087"
	S.key = "arkher.asset.audioclip.cook_pipeline"
	S.name = "Audio Clip Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.audioclip.bundling" }
	S.tags = { "v", "audioclip", "pipeline", "asset" }
	S.description = "Audio Clip Cook Pipeline: staged cooking with isolation and retries for the Audio Clip subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.audioclip.cook_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
