-- ARKHER SYSTEM F.0418 :: Instanced Draw Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0418"
	S.key = "arkher.render.instanced.frame_analysis"
	S.name = "Instanced Draw Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.instanced.pass_cache" }
	S.tags = { "f", "instanced", "analyzer", "render" }
	S.description = "Instanced Draw Frame Analysis: per-pass cost analysis and outlier detection for the Instanced Draw subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.instanced.frame_analysis", window = 92, buckets = 12, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
