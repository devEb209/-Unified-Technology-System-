-- ARKHER SYSTEM VC.0498 :: Rendering Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0498"
	S.key = "arkher.contneural.rendercont.coherence_guard"
	S.name = "Rendering Continuum Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.rendercont.persistent_state" }
	S.tags = { "vc", "rendercont", "coherence", "contneural" }
	S.description = "Rendering Continuum Coherence Guard: seam coherence and drift supervision for the Rendering Continuum subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.rendercont.coherence_guard", window = 55, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
