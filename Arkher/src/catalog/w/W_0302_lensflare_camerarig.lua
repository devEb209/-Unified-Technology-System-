-- ARKHER SYSTEM W.0302 :: Lens Flare Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0302"
	S.key = "arkher.cine.lensflare.camera_rig"
	S.name = "Lens Flare Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Lens Flare"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.lensflare.sequence_timeline" }
	S.tags = { "w", "lensflare", "camerarig", "cine" }
	S.description = "Lens Flare Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Lens Flare subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.lensflare.camera_rig", fov = 1.41, focus = 13.0, aperture = 2.9, smoothing = 9.0, distance = 15, height = 5 })
		inst.system = S
		inst.ctx = ctx
