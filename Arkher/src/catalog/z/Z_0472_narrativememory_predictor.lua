-- ARKHER SYSTEM Z.0472 :: Narrative Memory Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0472"
	S.key = "arkher.origin.narrativememory.predictive_optimization"
	S.name = "Narrative Memory Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.adaptive_workflow" }
	S.tags = { "z", "narrativememory", "predictor", "origin" }
	S.description = "Narrative Memory Predictive Optimization: forecast-driven optimization before the cost is paid for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.narrativememory.predictive_optimization", method = "markov", alpha = 0.30, window = 52 })
		inst.system = S
		inst.ctx = ctx
