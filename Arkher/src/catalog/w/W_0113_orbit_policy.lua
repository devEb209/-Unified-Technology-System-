-- ARKHER SYSTEM W.0113 :: Orbit Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0113"
	S.key = "arkher.cine.orbit.cut_policy"
	S.name = "Orbit Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Orbit"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.orbit.shot_composition" }
	S.tags = { "w", "orbit", "policy", "cine" }
	S.description = "Orbit Cut Policy: rules deciding when the sequence cuts and to what for the Orbit subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.orbit.cut_policy", algorithm = "edf", starvationGuard = 45 })
		inst.system = S
		inst.ctx = ctx
