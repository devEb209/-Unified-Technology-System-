-- ARKHER SYSTEM H.0455 :: Distance Joint Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0455"
	S.key = "arkher.physics.distancejoint.vehicle"
	S.name = "Distance Joint Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.distancejoint.character_motion" }
	S.tags = { "h", "distancejoint", "vehicle", "physics" }
	S.description = "Distance Joint Vehicle: suspension, drivetrain, steering and tire friction for the Distance Joint subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.distancejoint.vehicle", mass = 1000, wheelbase = 2.90, track = 2.10, maxRpm = 6300 })
		inst.system = S
		inst.ctx = ctx
