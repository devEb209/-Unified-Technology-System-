-- ARKHER SYSTEM N.0175 :: Hail Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0175"
	S.key = "arkher.vfx.hail.effect_graph"
	S.name = "Hail Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Hail"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.hail.curve_authoring" }
	S.tags = { "n", "hail", "shadegraph", "vfx" }
	S.description = "Hail Effect Graph: node graph describing how the effect is shaded for the Hail subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.hail.effect_graph" })
		inst.system = S
		inst.ctx = ctx
