-- ARKHER SYSTEM VD.0091 :: Residency Window Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0091"
	S.key = "arkher.contsim.residencywindow.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.residencywindow.coherence_guard" }
	S.tags = { "vd", "residencywindow", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.residencywindow.neural_field", dims = 20, hidden = 16, seed = 27978 })
		inst.system = S
		inst.ctx = ctx
