-- ARKHER SYSTEM VB.0009 :: World Grid Cell Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0009"
	S.key = "arkher.conttime.worldcell.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldcell.world_memory_stream" }
	S.tags = { "vb", "worldcell", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.worldcell.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
