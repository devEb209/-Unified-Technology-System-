-- ARKHER SYSTEM F.0141 :: Light Clustering Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0141"
	S.key = "arkher.render.lightcluster.frame_graph"
	S.name = "Light Clustering Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "lightcluster", "framegraph", "render" }
	S.description = "Light Clustering Frame Graph: declared passes, culling, ordering and aliasing for the Light Clustering subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.lightcluster.frame_graph", budgetMs = 10.00 })
		inst.system = S
		inst.ctx = ctx
