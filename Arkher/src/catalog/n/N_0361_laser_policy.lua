-- ARKHER SYSTEM N.0361 :: Laser Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0361"
	S.key = "arkher.vfx.laser.quality_policy"
	S.name = "Laser Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Laser"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.laser.result_cache" }
	S.tags = { "n", "laser", "policy", "vfx" }
	S.description = "Laser Quality Policy: distance and device driven fidelity bands for the Laser subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.laser.quality_policy", algorithm = "wfq", starvationGuard = 42 })
		inst.system = S
		inst.ctx = ctx
