-- ARKHER SYSTEM VD.0023 :: Region Tile Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0023"
	S.key = "arkher.contsim.regiontile.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.regiontile.simulation_fabric" }
	S.tags = { "vd", "regiontile", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.regiontile.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
