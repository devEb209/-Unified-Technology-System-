-- ARKHER SYSTEM O.0211 :: Occlusion Zone Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0211"
	S.key = "arkher.audio.occlusionzone.asset_registry"
	S.name = "Occlusion Zone Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.occlusionzone.streaming" }
	S.tags = { "o", "occlusionzone", "registry", "audio" }
	S.description = "Occlusion Zone Asset Registry: catalogue of sounds, variations and metadata for the Occlusion Zone subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.occlusionzone.asset_registry" })
		inst.system = S
		inst.ctx = ctx
