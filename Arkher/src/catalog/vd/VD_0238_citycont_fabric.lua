-- ARKHER SYSTEM VD.0238 :: City Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0238"
	S.key = "arkher.contsim.citycont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.citycont.complexity_budget" }
	S.tags = { "vd", "citycont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.citycont.simulation_fabric", budgetMs = 1.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
