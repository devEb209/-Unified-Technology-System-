-- ARKHER SYSTEM H.0093 :: Gravity Field Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0093"
	S.key = "arkher.physics.gravityfield.budget_governor"
	S.name = "Gravity Field Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.gravityfield.broadphase_index" }
	S.tags = { "h", "gravityfield", "budgeter", "physics" }
	S.description = "Gravity Field Budget Governor: simulation time budget allocation across islands for the Gravity Field subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.gravityfield.budget_governor", total = 240, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
