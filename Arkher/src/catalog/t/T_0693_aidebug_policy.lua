-- ARKHER SYSTEM T.0693 :: AI Debug Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0693"
	S.key = "arkher.ai.aidebug.decision_policy"
	S.name = "AI Debug Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.aidebug.reasoning_graph" }
	S.tags = { "t", "aidebug", "policy", "ai" }
	S.description = "AI Debug Decision Policy: ordered rules deciding what the agent does next for the AI Debug subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.aidebug.decision_policy", algorithm = "roundrobin", starvationGuard = 60 })
		inst.system = S
		inst.ctx = ctx
