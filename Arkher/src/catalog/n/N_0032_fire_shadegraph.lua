-- ARKHER SYSTEM N.0032 :: Fire Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0032"
	S.key = "arkher.vfx.fire.effect_graph"
	S.name = "Fire Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fire"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fire.curve_authoring" }
	S.tags = { "n", "fire", "shadegraph", "vfx" }
	S.description = "Fire Effect Graph: node graph describing how the effect is shaded for the Fire subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.fire.effect_graph" })
		inst.system = S
		inst.ctx = ctx
