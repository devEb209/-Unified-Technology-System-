-- ARKHER SYSTEM W.0399 :: Cinematic Debug Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0399"
	S.key = "arkher.cine.cinedebug.colour_grade"
	S.name = "Cinematic Debug Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinedebug.camera_rig" }
	S.tags = { "w", "cinedebug", "grade", "cine" }
	S.description = "Cinematic Debug Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Cinematic Debug subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.cinedebug.colour_grade", exposure = -0.12, contrast = 0.93, saturation = 0.93, toneMap = "reinhard" })
		inst.system = S
		inst.ctx = ctx
