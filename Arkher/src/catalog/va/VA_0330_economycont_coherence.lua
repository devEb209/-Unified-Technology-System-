-- ARKHER SYSTEM VA.0330 :: Economy Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0330"
	S.key = "arkher.contworld.economycont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.economycont.persistent_state" }
	S.tags = { "va", "economycont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.economycont.coherence_guard", window = 123, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
