-- ARKHER SYSTEM W.0255 :: Match Cut Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0255"
	S.key = "arkher.cine.matchcut.colour_grade"
	S.name = "Match Cut Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Match Cut"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.matchcut.camera_rig" }
	S.tags = { "w", "matchcut", "grade", "cine" }
	S.description = "Match Cut Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Match Cut subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.matchcut.colour_grade", exposure = 0.13, contrast = 1.18, saturation = 0.88, toneMap = "filmic" })
		inst.system = S
		inst.ctx = ctx
