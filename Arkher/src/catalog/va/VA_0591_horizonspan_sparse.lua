-- ARKHER SYSTEM VA.0591 :: Horizon Span Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0591"
	S.key = "arkher.contworld.horizonspan.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.horizonspan.epoch_clock" }
	S.tags = { "va", "horizonspan", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.horizonspan.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
