-- ARKHER SYSTEM T.0235 :: Quest Generation Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0235"
	S.key = "arkher.ai.questgeneration.action_planner"
	S.name = "Quest Generation Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.questgeneration.utility_selection" }
	S.tags = { "t", "questgeneration", "planner", "ai" }
	S.description = "Quest Generation Action Planner: goal-oriented action planning over preconditions for the Quest Generation subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.questgeneration.action_planner", maxDepth = 10 })
		inst.system = S
		inst.ctx = ctx
