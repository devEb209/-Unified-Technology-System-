-- ARKHER SYSTEM H.0010 :: Rigid Body Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0010"
	S.key = "arkher.physics.rigidbody.simulation_policy"
	S.name = "Rigid Body Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Rigid Body"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rigidbody.budget_governor" }
	S.tags = { "h", "rigidbody", "policy", "physics" }
	S.description = "Rigid Body Simulation Policy: device tier rules for substeps, iterations and sleep for the Rigid Body subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.rigidbody.simulation_policy", algorithm = "edf", starvationGuard = 49 })
		inst.system = S
		inst.ctx = ctx
