-- ARKHER SYSTEM VC.0627 :: Interest Field Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0627"
	S.key = "arkher.contneural.interestfield.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.interestfield.epoch_clock" }
	S.tags = { "vc", "interestfield", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.interestfield.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
