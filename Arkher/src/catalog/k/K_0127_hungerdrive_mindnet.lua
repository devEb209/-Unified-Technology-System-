-- ARKHER SYSTEM K.0127 :: Hunger Drive Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0127"
	S.key = "arkher.npc.hungerdrive.mind_network"
	S.name = "Hunger Drive Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "hungerdrive", "mindnet", "npc" }
	S.description = "Hunger Drive Mind Network: the learned policy that turns perception into a decision for the Hunger Drive subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.hungerdrive.mind_network", inputs = 6, hidden = 7, seed = 19368, learningRate = 0.090, exploration = 0.020 })
		inst.system = S
		inst.ctx = ctx
