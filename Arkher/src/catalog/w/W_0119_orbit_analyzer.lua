-- ARKHER SYSTEM W.0119 :: Orbit Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0119"
	S.key = "arkher.cine.orbit.sequence_analysis"
	S.name = "Orbit Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Orbit"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.orbit.frame_budget" }
	S.tags = { "w", "orbit", "analyzer", "cine" }
	S.description = "Orbit Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Orbit subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.orbit.sequence_analysis", window = 139, buckets = 15, threshold = 2.10 })
		inst.system = S
		inst.ctx = ctx
