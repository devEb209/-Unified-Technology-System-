-- ARKHER SYSTEM VC.0023 :: Region Tile Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0023"
	S.key = "arkher.contneural.regiontile.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.regiontile.simulation_fabric" }
	S.tags = { "vc", "regiontile", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.regiontile.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
