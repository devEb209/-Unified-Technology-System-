-- ARKHER SYSTEM F.0471 :: Distance Culling Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0471"
	S.key = "arkher.render.distanceculling.draw_budget"
	S.name = "Distance Culling Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.distanceculling.adaptive_resolution" }
	S.tags = { "f", "distanceculling", "budgeter", "render" }
	S.description = "Distance Culling Draw Budget: draw call and triangle budget allocation for the Distance Culling subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.distanceculling.draw_budget", total = 369, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
