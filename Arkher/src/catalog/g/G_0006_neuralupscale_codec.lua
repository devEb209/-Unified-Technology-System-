-- ARKHER SYSTEM G.0006 :: Neural Upscaling Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0006"
	S.key = "arkher.neural.neuralupscale.weight_codec"
	S.name = "Neural Upscaling Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuralupscale.model_registry" }
	S.tags = { "g", "neuralupscale", "codec", "neural" }
	S.description = "Neural Upscaling Weight Codec: weight serialization and quantized transport for the Neural Upscaling subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.neuralupscale.weight_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
