-- ARKHER SYSTEM K.0655 :: Daily Routine Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0655"
	S.key = "arkher.npc.dailyroutine.social_relations"
	S.name = "Daily Routine Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dailyroutine.crowd_steering" }
	S.tags = { "k", "dailyroutine", "society", "npc" }
	S.description = "Daily Routine Social Relations: affinity, factions, reputation and gossip for the Daily Routine subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.dailyroutine.social_relations", decayRate = 0.006, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
