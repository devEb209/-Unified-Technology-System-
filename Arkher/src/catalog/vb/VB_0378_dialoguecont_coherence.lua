-- ARKHER SYSTEM VB.0378 :: Dialogue Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0378"
	S.key = "arkher.conttime.dialoguecont.coherence_guard"
	S.name = "Dialogue Continuum Coherence Guard"
	S.category = "VB"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.dialoguecont.persistent_state" }
	S.tags = { "vb", "dialoguecont", "coherence", "conttime" }
	S.description = "Dialogue Continuum Coherence Guard: seam coherence and drift supervision for the Dialogue Continuum subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.dialoguecont.coherence_guard", window = 135, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
