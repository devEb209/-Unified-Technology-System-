-- ARKHER SYSTEM P.0028 :: Skill Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0028"
	S.key = "arkher.play.skill.combat_resolution"
	S.name = "Skill Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Skill"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.skill.objectives" }
	S.tags = { "p", "skill", "combat", "play" }
	S.description = "Skill Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Skill subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.skill.combat_resolution", seed = 2259, armourK = 110, critMultiplier = 1.80 })
		inst.system = S
		inst.ctx = ctx
