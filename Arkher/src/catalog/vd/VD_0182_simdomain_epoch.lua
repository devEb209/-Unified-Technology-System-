-- ARKHER SYSTEM VD.0182 :: Simulation Domain Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0182"
	S.key = "arkher.contsim.simdomain.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.simdomain.infinite_grid" }
	S.tags = { "vd", "simdomain", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.simdomain.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
