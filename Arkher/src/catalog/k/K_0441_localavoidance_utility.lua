-- ARKHER SYSTEM K.0441 :: Local Avoidance Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0441"
	S.key = "arkher.npc.localavoidance.utility_reasoning"
	S.name = "Local Avoidance Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.localavoidance.reactive_behaviour" }
	S.tags = { "k", "localavoidance", "utility", "npc" }
	S.description = "Local Avoidance Utility Reasoning: scored option selection with response curves for the Local Avoidance subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.localavoidance.utility_reasoning", momentum = 0.05 })
		inst.system = S
		inst.ctx = ctx
