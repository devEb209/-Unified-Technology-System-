-- ARKHER SYSTEM H.0004 :: Rigid Body Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0004"
	S.key = "arkher.physics.rigidbody.constraint_solver"
	S.name = "Rigid Body Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Rigid Body"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rigidbody.contact_generation" }
	S.tags = { "h", "rigidbody", "constraint", "physics" }
	S.description = "Rigid Body Constraint Solver: sequential impulses, friction, joints and warm starting for the Rigid Body subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.rigidbody.constraint_solver", iterations = 11, baumgarte = 0.27, warmStart = true })
		inst.system = S
		inst.ctx = ctx
