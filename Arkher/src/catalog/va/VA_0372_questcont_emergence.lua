-- ARKHER SYSTEM VA.0372 :: Quest Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0372"
	S.key = "arkher.contworld.questcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.questcont.reality_continuum" }
	S.tags = { "va", "questcont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.questcont.emergence_continuum", windowSize = 7, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
