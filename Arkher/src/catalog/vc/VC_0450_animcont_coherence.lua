-- ARKHER SYSTEM VC.0450 :: Animation Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0450"
	S.key = "arkher.contneural.animcont.coherence_guard"
	S.name = "Animation Continuum Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.animcont.persistent_state" }
	S.tags = { "vc", "animcont", "coherence", "contneural" }
	S.description = "Animation Continuum Coherence Guard: seam coherence and drift supervision for the Animation Continuum subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.animcont.coherence_guard", window = 114, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
