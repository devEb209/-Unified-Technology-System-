-- ARKHER SYSTEM O.0427 :: Audio Profiling Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0427"
	S.key = "arkher.audio.audioprofiling.asset_registry"
	S.name = "Audio Profiling Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audioprofiling.streaming" }
	S.tags = { "o", "audioprofiling", "registry", "audio" }
	S.description = "Audio Profiling Asset Registry: catalogue of sounds, variations and metadata for the Audio Profiling subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.audioprofiling.asset_registry" })
		inst.system = S
		inst.ctx = ctx
