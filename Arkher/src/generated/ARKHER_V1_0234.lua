--!strict
-- DaVinci Pages — CORE Profiler #0234
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="DaVinci Pages — CORE Profiler #0234", size=Vector2.new(600, 500), pos=UDim2.fromOffset(342, 158), parent=parent, icon="⛰"})
...
Components.TextField(right, "File", "input.png", function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_File"..234, v) end end)
