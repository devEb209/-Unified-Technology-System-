-- ARKHER SYSTEM Z.0265 :: Living Ecosystem Engine World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0265"
	S.key = "arkher.origin.livingecosystem.world_memory"
	S.name = "Living Ecosystem Engine World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.livingecosystem.autonomous_pipeline" }
	S.tags = { "z", "livingecosystem", "worldmemory", "origin" }
	S.description = "Living Ecosystem Engine World Memory: epoch-stamped persistent history with compaction and checkpoints for the Living Ecosystem Engine subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.livingecosystem.world_memory", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
