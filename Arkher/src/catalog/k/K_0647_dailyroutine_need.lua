-- ARKHER SYSTEM K.0647 :: Daily Routine Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0647"
	S.key = "arkher.npc.dailyroutine.drive_system"
	S.name = "Daily Routine Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dailyroutine.memory" }
	S.tags = { "k", "dailyroutine", "need", "npc" }
	S.description = "Daily Routine Drive System: drives that decay, turn urgent and get satisfied for the Daily Routine subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.dailyroutine.drive_system" })
		inst.system = S
		inst.ctx = ctx
