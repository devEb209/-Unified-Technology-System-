-- ARKHER SYSTEM E.0201 :: Sheen Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0201"
	S.key = "arkher.material.sheen.variant_registry"
	S.name = "Sheen Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Sheen"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.sheen.procedural_detail" }
	S.tags = { "e", "sheen", "registry", "material" }
	S.description = "Sheen Variant Registry: named variants and their lifecycle for the Sheen subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.sheen.variant_registry" })
		inst.system = S
		inst.ctx = ctx
