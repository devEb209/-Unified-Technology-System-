-- ARKHER SYSTEM W.0107 :: Handheld Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0107"
	S.key = "arkher.cine.handheld.sequence_analysis"
	S.name = "Handheld Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Handheld"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.handheld.frame_budget" }
	S.tags = { "w", "handheld", "analyzer", "cine" }
	S.description = "Handheld Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Handheld subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.handheld.sequence_analysis", window = 236, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
