-- ARKHER SYSTEM H.0236 :: Continuous Detection Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0236"
	S.key = "arkher.physics.ccd.analysis"
	S.name = "Continuous Detection Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.ccd.result_cache" }
	S.tags = { "h", "ccd", "analyzer", "physics" }
	S.description = "Continuous Detection Analysis: energy, jitter and cost analysis of the simulation for the Continuous Detection subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.ccd.analysis", window = 50, buckets = 10, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
