-- ARKHER SYSTEM K.0093 :: Working Memory Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0093"
	S.key = "arkher.npc.workingmemory.navigation"
	S.name = "Working Memory Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workingmemory.goal_planner" }
	S.tags = { "k", "workingmemory", "navgraph", "npc" }
	S.description = "Working Memory Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Working Memory subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.workingmemory.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
