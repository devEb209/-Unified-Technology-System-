-- ARKHER SYSTEM H.0578 :: Buoyancy Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0578"
	S.key = "arkher.physics.buoyancy.constraint_solver"
	S.name = "Buoyancy Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Buoyancy"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.buoyancy.contact_generation" }
	S.tags = { "h", "buoyancy", "constraint", "physics" }
	S.description = "Buoyancy Constraint Solver: sequential impulses, friction, joints and warm starting for the Buoyancy subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.buoyancy.constraint_solver", iterations = 11, baumgarte = 0.27, warmStart = true })
		inst.system = S
		inst.ctx = ctx
