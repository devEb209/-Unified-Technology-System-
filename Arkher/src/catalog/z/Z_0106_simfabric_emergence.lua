-- ARKHER SYSTEM Z.0106 :: Universal Simulation Fabric Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0106"
	S.key = "arkher.origin.simfabric.emergence_detection"
	S.name = "Universal Simulation Fabric Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.simfabric.world_memory" }
	S.tags = { "z", "simfabric", "emergence", "origin" }
	S.description = "Universal Simulation Fabric Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.simfabric.emergence_detection", windowSize = 4, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
