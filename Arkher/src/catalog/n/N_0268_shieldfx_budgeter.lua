-- ARKHER SYSTEM N.0268 :: Shield Effect Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0268"
	S.key = "arkher.vfx.shieldfx.spawn_budget"
	S.name = "Shield Effect Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.shieldfx.effect_composition" }
	S.tags = { "n", "shieldfx", "budgeter", "vfx" }
	S.description = "Shield Effect Spawn Budget: global particle budget shared by every live effect for the Shield Effect subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.shieldfx.spawn_budget", total = 127, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
