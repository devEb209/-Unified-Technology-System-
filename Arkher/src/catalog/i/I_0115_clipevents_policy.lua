-- ARKHER SYSTEM I.0115 :: Clip Events Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0115"
	S.key = "arkher.anim.clipevents.quality_policy"
	S.name = "Clip Events Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Events"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clipevents.pose_cache" }
	S.tags = { "i", "clipevents", "policy", "anim" }
	S.description = "Clip Events Quality Policy: device tier rules for rate, bones and solvers for the Clip Events subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.clipevents.quality_policy", algorithm = "wfq", starvationGuard = 34 })
		inst.system = S
		inst.ctx = ctx
