-- ARKHER SYSTEM T.0359 :: Documentation Writer Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0359"
	S.key = "arkher.ai.documentationwriter.working_memory"
	S.name = "Documentation Writer Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.documentationwriter.outcome_prediction" }
	S.tags = { "t", "documentationwriter", "memory", "ai" }
	S.description = "Documentation Writer Working Memory: decaying, consolidating recall of what the agent learned for the Documentation Writer subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.documentationwriter.working_memory", capacity = 43, decayRate = 0.025, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
