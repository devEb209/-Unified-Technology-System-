-- ARKHER SYSTEM VC.0479 :: VFX Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0479"
	S.key = "arkher.contneural.vfxcont.reality_continuum"
	S.name = "VFX Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vfxcont.simulation_fabric" }
	S.tags = { "vc", "vfxcont", "reality", "contneural" }
	S.description = "VFX Continuum Reality Continuum: stacked reality layers of the continuum for the VFX Continuum subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.vfxcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
