-- ARKHER SYSTEM T.0284 :: Balance Tuning Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0284"
	S.key = "arkher.ai.balancetuning.self_critique"
	S.name = "Balance Tuning Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.balancetuning.plan_workflow" }
	S.tags = { "t", "balancetuning", "critic", "ai" }
	S.description = "Balance Tuning Self Critique: weighted evaluation of the result against declared criteria for the Balance Tuning subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.balancetuning.self_critique", passMark = 0.83, reviseMark = 0.43, seed = 74143 })
		inst.system = S
		inst.ctx = ctx
