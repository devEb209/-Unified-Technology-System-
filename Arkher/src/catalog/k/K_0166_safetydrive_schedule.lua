-- ARKHER SYSTEM K.0166 :: Safety Drive Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0166"
	S.key = "arkher.npc.safetydrive.daily_schedule"
	S.name = "Safety Drive Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.safetydrive.social_relations" }
	S.tags = { "k", "safetydrive", "schedule", "npc" }
	S.description = "Safety Drive Daily Schedule: hour-by-hour routine with priority interruptions for the Safety Drive subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.safetydrive.daily_schedule", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
