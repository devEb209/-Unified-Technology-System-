-- ARKHER SYSTEM O.0173 :: City Audio Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0173"
	S.key = "arkher.audio.cityaudio.voice_budget"
	S.name = "City Audio Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "City Audio"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.cityaudio.music_sequencer" }
	S.tags = { "o", "cityaudio", "budgeter", "audio" }
	S.description = "City Audio Voice Budget: voice slots allocated by priority and audibility for the City Audio subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.cityaudio.voice_budget", total = 127, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
