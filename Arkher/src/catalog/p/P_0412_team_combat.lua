-- ARKHER SYSTEM P.0412 :: Team Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0412"
	S.key = "arkher.play.team.combat_resolution"
	S.name = "Team Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Team"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.team.objectives" }
	S.tags = { "p", "team", "combat", "play" }
	S.description = "Team Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Team subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.team.combat_resolution", seed = 77653, armourK = 130, critMultiplier = 1.60 })
		inst.system = S
		inst.ctx = ctx
