-- ARKHER SYSTEM O.0064 :: Voice Line Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0064"
	S.key = "arkher.audio.voiceline.music_sequencer"
	S.name = "Voice Line Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Voice Line"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.voiceline.spatialization" }
	S.tags = { "o", "voiceline", "sequencer", "audio" }
	S.description = "Voice Line Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Voice Line subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.voiceline.music_sequencer", bpm = 100, beatsPerBar = 4, intensity = 0.55 })
		inst.system = S
		inst.ctx = ctx
