-- ARKHER SYSTEM K.0044 :: Reward Model Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0044"
	S.key = "arkher.npc.rewardmodel.memory"
	S.name = "Reward Model Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.rewardmodel.mind_network" }
	S.tags = { "k", "rewardmodel", "memory", "npc" }
	S.description = "Reward Model Memory: episodic memory with decay, recall and consolidation for the Reward Model subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.rewardmodel.memory", capacity = 99, decayRate = 0.045, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
