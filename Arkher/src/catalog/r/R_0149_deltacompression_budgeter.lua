-- ARKHER SYSTEM R.0149 :: Delta Compression Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0149"
	S.key = "arkher.net.deltacompression.bandwidth_budget"
	S.name = "Delta Compression Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.deltacompression.transport_graph" }
	S.tags = { "r", "deltacompression", "budgeter", "net" }
	S.description = "Delta Compression Bandwidth Budget: bytes per second shared between competing streams for the Delta Compression subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.deltacompression.bandwidth_budget", total = 146, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
