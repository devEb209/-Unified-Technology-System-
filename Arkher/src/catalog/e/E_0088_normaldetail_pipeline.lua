-- ARKHER SYSTEM E.0088 :: Normal Detail Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0088"
	S.key = "arkher.material.normaldetail.authoring_pipeline"
	S.name = "Normal Detail Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.normaldetail.analysis" }
	S.tags = { "e", "normaldetail", "pipeline", "material" }
	S.description = "Normal Detail Authoring Pipeline: ordered authoring and bake stages for the Normal Detail subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.normaldetail.authoring_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
