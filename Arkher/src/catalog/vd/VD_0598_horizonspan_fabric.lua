-- ARKHER SYSTEM VD.0598 :: Horizon Span Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0598"
	S.key = "arkher.contsim.horizonspan.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.horizonspan.complexity_budget" }
	S.tags = { "vd", "horizonspan", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.horizonspan.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
