-- ARKHER SYSTEM VB.0560 :: Device Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0560"
	S.key = "arkher.conttime.devicecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.devicecont.neural_field" }
	S.tags = { "vb", "devicecont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.devicecont.world_memory_stream", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
