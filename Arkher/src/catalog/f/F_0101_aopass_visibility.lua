-- ARKHER SYSTEM F.0101 :: Ambient Occlusion Pass Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0101"
	S.key = "arkher.render.aopass.visibility_set"
	S.name = "Ambient Occlusion Pass Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.aopass.view_and_culling" }
	S.tags = { "f", "aopass", "visibility", "render" }
	S.description = "Ambient Occlusion Pass Visibility Set: cell, portal and occluder visibility for the Ambient Occlusion Pass subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.aopass.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
