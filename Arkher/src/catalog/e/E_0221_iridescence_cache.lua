-- ARKHER SYSTEM E.0221 :: Iridescence Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0221"
	S.key = "arkher.material.iridescence.instance_cache"
	S.name = "Iridescence Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Iridescence"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.iridescence.quality_policy" }
	S.tags = { "e", "iridescence", "cache", "material" }
	S.description = "Iridescence Instance Cache: resolved-parameter cache keyed by context for the Iridescence subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.iridescence.instance_cache", policy = "lru", capacity = 89, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
