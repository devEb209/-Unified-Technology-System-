-- ARKHER SYSTEM F.0301 :: Bloom Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0301"
	S.key = "arkher.render.bloom.temporal_resolve"
	S.name = "Bloom Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Bloom"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.bloom.probe_volume" }
	S.tags = { "f", "bloom", "temporal", "render" }
	S.description = "Bloom Temporal Resolve: history reprojection with neighbourhood clamping for the Bloom subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.bloom.temporal_resolve", feedback = 0.91, phase = 8 })
		inst.system = S
		inst.ctx = ctx
