-- ARKHER SYSTEM T.0223 :: Character Generation Learning Analysis
...
return function(A)
	...
	local S = {}
	S.id = "T.0223"
	S.key = "arkher.ai.charactergeneration.learning_analysis"
	S.name = "Character Generation Learning Analysis"
	S.category = "T"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.charactergeneration.model_inference" }
	S.tags = { "t", "charactergeneration", "analyzer", "ai" }
	S.description = "Character Generation Learning Analysis: trend, anomaly and improvement analysis of the agent for the Character Generation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ai.charactergeneration.learning_analysis", window = 181, buckets = 17, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
