-- ARKHER SYSTEM L.0197 :: Predation Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0197"
	S.key = "arkher.sim.predation.ecology"
	S.name = "Predation Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.predation.simulation_core" }
	S.tags = { "l", "predation", "ecology", "sim" }
	S.description = "Predation Ecology: populations, predation, harvesting and carrying capacity for the Predation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.predation.ecology" })
		inst.system = S
		inst.ctx = ctx
