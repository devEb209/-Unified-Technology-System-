-- ARKHER SYSTEM V.0309 :: Mip Chain Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0309"
	S.key = "arkher.asset.mipchain.size_budget"
	S.name = "Mip Chain Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.mipchain.compression_codec" }
	S.tags = { "v", "mipchain", "budgeter", "asset" }
	S.description = "Mip Chain Size Budget: byte budget shared between competing asset classes for the Mip Chain subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.mipchain.size_budget", total = 349, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
