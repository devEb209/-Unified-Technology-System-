-- ARKHER SYSTEM VD.0086 :: Residency Window Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0086"
	S.key = "arkher.contsim.residencywindow.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.residencywindow.infinite_grid" }
	S.tags = { "vd", "residencywindow", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.residencywindow.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
