-- ARKHER SYSTEM VC.0035 :: Zone Chunk Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0035"
	S.key = "arkher.contneural.zonechunk.reality_continuum"
	S.name = "Zone Chunk Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.zonechunk.simulation_fabric" }
	S.tags = { "vc", "zonechunk", "reality", "contneural" }
	S.description = "Zone Chunk Reality Continuum: stacked reality layers of the continuum for the Zone Chunk subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.zonechunk.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
