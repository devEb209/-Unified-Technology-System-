-- ARKHER SYSTEM VC.0296 :: Climate Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0296"
	S.key = "arkher.contneural.climatecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.climatecont.neural_field" }
	S.tags = { "vc", "climatecont", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.climatecont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
