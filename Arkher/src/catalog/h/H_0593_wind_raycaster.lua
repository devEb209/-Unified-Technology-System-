-- ARKHER SYSTEM H.0593 :: Wind Force Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0593"
	S.key = "arkher.physics.wind.query"
	S.name = "Wind Force Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Wind Force"
	S.aspect = "Query"
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.wind.constraint_solver" }
	S.tags = { "h", "wind", "raycaster", "physics" }
	S.description = "Wind Force Query: rays, sweeps and overlaps against the simulation for the Wind Force subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.wind.query", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
