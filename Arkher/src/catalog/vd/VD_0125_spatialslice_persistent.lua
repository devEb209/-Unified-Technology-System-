-- ARKHER SYSTEM VD.0125 :: Spatial Slice Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0125"
	S.key = "arkher.contsim.spatialslice.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.spatialslice.multi-scale_fidelity" }
	S.tags = { "vd", "spatialslice", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.spatialslice.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
