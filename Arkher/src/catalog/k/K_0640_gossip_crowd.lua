-- ARKHER SYSTEM K.0640 :: Gossip Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0640"
	S.key = "arkher.npc.gossip.crowd_steering"
	S.name = "Gossip Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.gossip.navigation" }
	S.tags = { "k", "gossip", "crowd", "npc" }
	S.description = "Gossip Crowd Steering: local avoidance, cohesion and arrival at scale for the Gossip subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.gossip.crowd_steering", radius = 0.45, maxSpeed = 3.10, cellSize = 7 })
		inst.system = S
		inst.ctx = ctx
