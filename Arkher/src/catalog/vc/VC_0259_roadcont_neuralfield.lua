-- ARKHER SYSTEM VC.0259 :: Road Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0259"
	S.key = "arkher.contneural.roadcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.roadcont.coherence_guard" }
	S.tags = { "vc", "roadcont", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.roadcont.neural_field", dims = 16, hidden = 12, seed = 58633 })
		inst.system = S
		inst.ctx = ctx
