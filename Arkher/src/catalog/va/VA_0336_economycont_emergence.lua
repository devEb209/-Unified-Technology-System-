-- ARKHER SYSTEM VA.0336 :: Economy Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0336"
	S.key = "arkher.contworld.economycont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.economycont.reality_continuum" }
	S.tags = { "va", "economycont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.economycont.emergence_continuum", windowSize = 7, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
