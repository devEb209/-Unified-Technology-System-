-- ARKHER SYSTEM VC.0149 :: Persistence Segment Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0149"
	S.key = "arkher.contneural.persistsegment.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.persistsegment.multi-scale_fidelity" }
	S.tags = { "vc", "persistsegment", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.persistsegment.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
