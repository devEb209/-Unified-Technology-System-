-- ARKHER SYSTEM W.0272 :: Letterbox Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0272"
	S.key = "arkher.cine.letterbox.cinematic_mix"
	S.name = "Letterbox Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Letterbox"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.letterbox.motion_tween" }
	S.tags = { "w", "letterbox", "mixer", "cine" }
	S.description = "Letterbox Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Letterbox subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.letterbox.cinematic_mix", maxVoices = 40 })
		inst.system = S
		inst.ctx = ctx
