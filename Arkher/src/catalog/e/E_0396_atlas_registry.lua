-- ARKHER SYSTEM E.0396 :: Texture Atlas Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0396"
	S.key = "arkher.material.atlas.variant_registry"
	S.name = "Texture Atlas Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.atlas.procedural_detail" }
	S.tags = { "e", "atlas", "registry", "material" }
	S.description = "Texture Atlas Variant Registry: named variants and their lifecycle for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.atlas.variant_registry" })
		inst.system = S
		inst.ctx = ctx
