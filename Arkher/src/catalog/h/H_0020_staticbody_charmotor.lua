-- ARKHER SYSTEM H.0020 :: Static Body Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0020"
	S.key = "arkher.physics.staticbody.character_motion"
	S.name = "Static Body Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Static Body"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.staticbody.query" }
	S.tags = { "h", "staticbody", "charmotor", "physics" }
	S.description = "Static Body Character Motion: capsule move-and-slide with slopes, steps and jumps for the Static Body subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.staticbody.character_motion", radius = 0.35, height = 1.80, maxSpeed = 8.00, jumpHeight = 1.60, stepOffset = 0.35 })
		inst.system = S
		inst.ctx = ctx
