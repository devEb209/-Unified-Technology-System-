-- ARKHER SYSTEM E.0424 :: Texture Streaming Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0424"
	S.key = "arkher.material.texstream.texture_sampling"
	S.name = "Texture Streaming Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.texstream.shading_graph" }
	S.tags = { "e", "texstream", "sampler", "material" }
	S.description = "Texture Streaming Texture Sampling: atlas packing, mip chain and filtered sampling for the Texture Streaming subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.texstream.texture_sampling", atlasSize = 192, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
