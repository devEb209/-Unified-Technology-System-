-- ARKHER SYSTEM F.0400 :: Draw Call Batching Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0400"
	S.key = "arkher.render.batching.adaptive_resolution"
	S.name = "Draw Call Batching Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.batching.temporal_resolve" }
	S.tags = { "f", "batching", "upscaler", "render" }
	S.description = "Draw Call Batching Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Draw Call Batching subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.batching.adaptive_resolution", targetMs = 15.10, index = 4, sharpness = 0.22 })
		inst.system = S
		inst.ctx = ctx
