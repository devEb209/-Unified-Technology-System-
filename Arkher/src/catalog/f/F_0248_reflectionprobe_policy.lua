-- ARKHER SYSTEM F.0248 :: Reflection Probe Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0248"
	S.key = "arkher.render.reflectionprobe.render_policy"
	S.name = "Reflection Probe Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.reflectionprobe.draw_budget" }
	S.tags = { "f", "reflectionprobe", "policy", "render" }
	S.description = "Reflection Probe Render Policy: device tier rules for the frame for the Reflection Probe subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.reflectionprobe.render_policy", algorithm = "lottery", starvationGuard = 35 })
		inst.system = S
		inst.ctx = ctx
