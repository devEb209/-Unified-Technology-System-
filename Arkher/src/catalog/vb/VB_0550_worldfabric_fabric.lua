-- ARKHER SYSTEM VB.0550 :: World Fabric Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0550"
	S.key = "arkher.conttime.worldfabric.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldfabric.complexity_budget" }
	S.tags = { "vb", "worldfabric", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.worldfabric.simulation_fabric", budgetMs = 2.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
