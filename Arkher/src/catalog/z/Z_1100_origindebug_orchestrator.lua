-- ARKHER SYSTEM Z.1100 :: Original Tech Debug Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.1100"
	S.key = "arkher.origin.origindebug.orchestration"
	S.name = "Original Tech Debug Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.origindebug.residency_streaming" }
	S.tags = { "z", "origindebug", "orchestrator", "origin" }
	S.description = "Original Tech Debug Orchestration: lifecycle and phase orchestration of the technology for the Original Tech Debug subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.origindebug.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
