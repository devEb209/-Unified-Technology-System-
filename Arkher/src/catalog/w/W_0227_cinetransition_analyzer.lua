-- ARKHER SYSTEM W.0227 :: Transition Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0227"
	S.key = "arkher.cine.cinetransition.sequence_analysis"
	S.name = "Transition Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Transition"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinetransition.frame_budget" }
	S.tags = { "w", "cinetransition", "analyzer", "cine" }
	S.description = "Transition Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Transition subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.cinetransition.sequence_analysis", window = 126, buckets = 14, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
