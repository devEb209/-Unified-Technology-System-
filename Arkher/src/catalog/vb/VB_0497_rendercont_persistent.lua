-- ARKHER SYSTEM VB.0497 :: Rendering Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0497"
	S.key = "arkher.conttime.rendercont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.rendercont.multi-scale_fidelity" }
	S.tags = { "vb", "rendercont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.rendercont.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
