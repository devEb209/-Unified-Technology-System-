-- ARKHER SYSTEM V.0343 :: Patch Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0343"
	S.key = "arkher.asset.patch.streaming_residency"
	S.name = "Patch Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.patch.content_cache" }
	S.tags = { "v", "patch", "streamer", "asset" }
	S.description = "Patch Streaming Residency: distance-driven load and unload of asset payloads for the Patch subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.patch.streaming_residency", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
