-- ARKHER SYSTEM V.0411 :: Asset Search Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0411"
	S.key = "arkher.asset.assetsearch.cook_pipeline"
	S.name = "Asset Search Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetsearch.bundling" }
	S.tags = { "v", "assetsearch", "pipeline", "asset" }
	S.description = "Asset Search Cook Pipeline: staged cooking with isolation and retries for the Asset Search subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.assetsearch.cook_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
