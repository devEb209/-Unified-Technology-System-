-- ARKHER SYSTEM I.0467 :: Procedural Animation Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0467"
	S.key = "arkher.anim.proceduralanim.analysis"
	S.name = "Procedural Animation Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.proceduralanim.quality_policy" }
	S.tags = { "i", "proceduralanim", "analyzer", "anim" }
	S.description = "Procedural Animation Analysis: pop, drift and cost analysis of playback for the Procedural Animation subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.proceduralanim.analysis", window = 109, buckets = 9, threshold = 2.10 })
		inst.system = S
		inst.ctx = ctx
