-- ARKHER SYSTEM Z.0227 :: Emergent Society Framework World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0227"
	S.key = "arkher.origin.emergentsociety.world_architect"
	S.name = "Emergent Society Framework World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentsociety.emergence_detection" }
	S.tags = { "z", "emergentsociety", "architect", "origin" }
	S.description = "Emergent Society Framework World Architect: hierarchical world composition with conserved budgets for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.emergentsociety.world_architect", budget = 1500, seed = 51469 })
		inst.system = S
		inst.ctx = ctx
