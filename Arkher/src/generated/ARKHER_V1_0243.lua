...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="RE ImGui — ANIMATION Map #0243", size=Vector2.new(600, 480), pos=UDim2.fromOffset(459, 311), parent=parent, icon="▣"})
