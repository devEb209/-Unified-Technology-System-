-- ARKHER SYSTEM VB.0566 :: Mobile Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0566"
	S.key = "arkher.conttime.mobilecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.mobilecont.infinite_grid" }
	S.tags = { "vb", "mobilecont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.mobilecont.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
