-- ARKHER SYSTEM VB.0417 :: Behaviour Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0417"
	S.key = "arkher.conttime.behaviourcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.behaviourcont.world_memory_stream" }
	S.tags = { "vb", "behaviourcont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.behaviourcont.complexity_budget", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
