-- ARKHER SYSTEM VC.0138 :: Fidelity Band Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0138"
	S.key = "arkher.contneural.fidelityband.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.fidelityband.persistent_state" }
	S.tags = { "vc", "fidelityband", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.fidelityband.coherence_guard", window = 130, threshold = 0.10 })
		inst.system = S
		inst.ctx = ctx
