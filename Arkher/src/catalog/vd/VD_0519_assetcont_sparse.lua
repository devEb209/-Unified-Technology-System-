-- ARKHER SYSTEM VD.0519 :: Asset Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0519"
	S.key = "arkher.contsim.assetcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.assetcont.epoch_clock" }
	S.tags = { "vd", "assetcont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.assetcont.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
