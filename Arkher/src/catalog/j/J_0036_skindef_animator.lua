-- ARKHER SYSTEM J.0036 :: Skin Definition Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0036"
	S.key = "arkher.character.skindef.blend_controller"
	S.name = "Skin Definition Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.skindef.motion_set" }
	S.tags = { "j", "skindef", "animator", "character" }
	S.description = "Skin Definition Blend Controller: layered playback driving the character for the Skin Definition subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.skindef.blend_controller", budget = 15 })
		inst.system = S
		inst.ctx = ctx
