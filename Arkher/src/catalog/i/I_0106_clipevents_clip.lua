-- ARKHER SYSTEM I.0106 :: Clip Events Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0106"
	S.key = "arkher.anim.clipevents.clip_sampling"
	S.name = "Clip Events Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Events"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clipevents.skeleton" }
	S.tags = { "i", "clipevents", "clip", "anim" }
	S.description = "Clip Events Clip Sampling: keyframe tracks sampled, retimed and evented for the Clip Events subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.clipevents.clip_sampling", duration = 2.40, loop = true })
		inst.system = S
		inst.ctx = ctx
