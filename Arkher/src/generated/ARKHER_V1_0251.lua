--!strict
-- Substance Layers — ANIMATION Node_Flow #0251
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Substance Layers — ANIMATION Node_Flow #0251", size=Vector2.new(680, 440), pos=UDim2.fromOffset(163, 187), parent=parent, icon="↻"})
