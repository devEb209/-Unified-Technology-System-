-- ARKHER SYSTEM VA.0334 :: Economy Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0334"
	S.key = "arkher.contworld.economycont.simulation_fabric"
	S.name = "Economy Continuum Simulation Fabric"
	S.category = "VA"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.economycont.complexity_budget" }
	S.tags = { "va", "economycont", "fabric", "contworld" }
	S.description = "Economy Continuum Simulation Fabric: fabric stepping the continuum domains for the Economy Continuum subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.economycont.simulation_fabric", budgetMs = 4.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
