-- ARKHER SYSTEM Z.0326 :: Cross Reality Sync Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0326"
	S.key = "arkher.origin.crossreality.emergence_detection"
	S.name = "Cross Reality Sync Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.world_memory" }
	S.tags = { "z", "crossreality", "emergence", "origin" }
	S.description = "Cross Reality Sync Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.crossreality.emergence_detection", windowSize = 6, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
