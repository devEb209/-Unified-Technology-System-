-- ARKHER SYSTEM N.0177 :: Hail Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0177"
	S.key = "arkher.vfx.hail.spawn_budget"
	S.name = "Hail Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Hail"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.hail.effect_composition" }
	S.tags = { "n", "hail", "budgeter", "vfx" }
	S.description = "Hail Spawn Budget: global particle budget shared by every live effect for the Hail subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.hail.spawn_budget", total = 439, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
