-- ARKHER SYSTEM VB.0025 :: Zone Chunk Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0025"
	S.key = "arkher.conttime.zonechunk.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "zonechunk", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.zonechunk.infinite_grid", cellSize = 128, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
