-- ARKHER SYSTEM VA.0434 :: Physics Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0434"
	S.key = "arkher.contworld.physicscont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.physicscont.infinite_grid" }
	S.tags = { "va", "physicscont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.physicscont.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
