-- ARKHER SYSTEM N.0239 :: Spell Cast Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0239"
	S.key = "arkher.vfx.spellcast.curve_authoring"
	S.name = "Spell Cast Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spell Cast"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spellcast.ribbon_and_trail" }
	S.tags = { "n", "spellcast", "spline", "vfx" }
	S.description = "Spell Cast Curve Authoring: authored curves driving the effect over its life for the Spell Cast subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.spellcast.curve_authoring", tension = 0.47, closed = false })
		inst.system = S
		inst.ctx = ctx
