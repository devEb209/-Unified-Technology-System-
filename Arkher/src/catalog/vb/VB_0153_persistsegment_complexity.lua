-- ARKHER SYSTEM VB.0153 :: Persistence Segment Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0153"
	S.key = "arkher.conttime.persistsegment.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.persistsegment.world_memory_stream" }
	S.tags = { "vb", "persistsegment", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.persistsegment.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
