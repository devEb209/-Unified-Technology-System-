-- ARKHER SYSTEM VB.0474 :: VFX Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0474"
	S.key = "arkher.conttime.vfxcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vfxcont.persistent_state" }
	S.tags = { "vb", "vfxcont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.vfxcont.coherence_guard", window = 108, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
