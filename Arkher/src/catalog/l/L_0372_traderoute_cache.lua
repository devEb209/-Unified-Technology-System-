-- ARKHER SYSTEM L.0372 :: Trade Route Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0372"
	S.key = "arkher.sim.traderoute.aggregate_cache"
	S.name = "Trade Route Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.traderoute.fidelity_policy" }
	S.tags = { "l", "traderoute", "cache", "sim" }
	S.description = "Trade Route Aggregate Cache: reuse of expensive aggregate computations for the Trade Route subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.traderoute.aggregate_cache", policy = "lfu", capacity = 405, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
