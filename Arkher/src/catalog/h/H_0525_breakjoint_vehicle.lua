-- ARKHER SYSTEM H.0525 :: Breakable Joint Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0525"
	S.key = "arkher.physics.breakjoint.vehicle"
	S.name = "Breakable Joint Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.breakjoint.character_motion" }
	S.tags = { "h", "breakjoint", "vehicle", "physics" }
	S.description = "Breakable Joint Vehicle: suspension, drivetrain, steering and tire friction for the Breakable Joint subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.breakjoint.vehicle", mass = 1200, wheelbase = 2.90, track = 1.70, maxRpm = 6300 })
		inst.system = S
		inst.ctx = ctx
