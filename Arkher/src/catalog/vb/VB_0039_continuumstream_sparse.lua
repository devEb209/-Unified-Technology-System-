-- ARKHER SYSTEM VB.0039 :: Continuum Stream Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0039"
	S.key = "arkher.conttime.continuumstream.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.continuumstream.epoch_clock" }
	S.tags = { "vb", "continuumstream", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.continuumstream.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
