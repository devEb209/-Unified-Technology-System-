-- ARKHER SYSTEM Z.1068 :: World Dream State Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.1068"
	S.key = "arkher.origin.worlddream.semantic_graph"
	S.name = "World Dream State Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.world_architect" }
	S.tags = { "z", "worlddream", "knowledge", "origin" }
	S.description = "World Dream State Semantic Graph: typed entities and inferred relations of the technology itself for the World Dream State subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.worlddream.semantic_graph", dims = 48 })
		inst.system = S
		inst.ctx = ctx
