-- ARKHER SYSTEM H.0244 :: Broadphase Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0244"
	S.key = "arkher.physics.broadphase.character_motion"
	S.name = "Broadphase Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Broadphase"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.broadphase.query" }
	S.tags = { "h", "broadphase", "charmotor", "physics" }
	S.description = "Broadphase Character Motion: capsule move-and-slide with slopes, steps and jumps for the Broadphase subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.broadphase.character_motion", radius = 0.50, height = 1.75, maxSpeed = 7.50, jumpHeight = 2.30, stepOffset = 0.30 })
		inst.system = S
		inst.ctx = ctx
