-- ARKHER SYSTEM T.0172 :: Asset Generation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0172"
	S.key = "arkher.ai.assetgeneration.self_critique"
	S.name = "Asset Generation Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.assetgeneration.plan_workflow" }
	S.tags = { "t", "assetgeneration", "critic", "ai" }
	S.description = "Asset Generation Self Critique: weighted evaluation of the result against declared criteria for the Asset Generation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.assetgeneration.self_critique", passMark = 0.74, reviseMark = 0.49, seed = 84079 })
		inst.system = S
		inst.ctx = ctx
