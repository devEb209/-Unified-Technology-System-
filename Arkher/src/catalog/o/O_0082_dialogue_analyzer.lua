-- ARKHER SYSTEM O.0082 :: Dialogue Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0082"
	S.key = "arkher.audio.dialogue.analysis"
	S.name = "Dialogue Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Dialogue"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.dialogue.playback_policy" }
	S.tags = { "o", "dialogue", "analyzer", "audio" }
	S.description = "Dialogue Analysis: loudness, headroom and masking analysis for the Dialogue subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.dialogue.analysis", window = 128, buckets = 8, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
