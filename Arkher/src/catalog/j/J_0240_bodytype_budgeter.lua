-- ARKHER SYSTEM J.0240 :: Body Type Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0240"
	S.key = "arkher.character.bodytype.budget_governor"
	S.name = "Body Type Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.bodytype.variant_registry" }
	S.tags = { "j", "bodytype", "budgeter", "character" }
	S.description = "Body Type Budget Governor: per-character cost allocation in a crowd for the Body Type subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.bodytype.budget_governor", total = 211, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
