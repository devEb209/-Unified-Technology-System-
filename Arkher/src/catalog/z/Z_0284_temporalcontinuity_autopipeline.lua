-- ARKHER SYSTEM Z.0284 :: Temporal Continuity Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0284"
	S.key = "arkher.origin.temporalcontinuity.autonomous_pipeline"
	S.name = "Temporal Continuity Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.temporalcontinuity.simulation_fabric" }
	S.tags = { "z", "temporalcontinuity", "autopipeline", "origin" }
	S.description = "Temporal Continuity Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Temporal Continuity subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.temporalcontinuity.autonomous_pipeline", maxIterations = 4 })
		inst.system = S
		inst.ctx = ctx
