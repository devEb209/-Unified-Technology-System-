-- ARKHER SYSTEM G.0497 :: Neural Debug Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0497"
	S.key = "arkher.neural.neuraldebug.quality_predictor"
	S.name = "Neural Debug Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuraldebug.weight_codec" }
	S.tags = { "g", "neuraldebug", "predictor", "neural" }
	S.description = "Neural Debug Quality Predictor: predicted quality and cost of a setting for the Neural Debug subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.neuraldebug.quality_predictor", method = "linear", alpha = 0.38, window = 60 })
		inst.system = S
		inst.ctx = ctx
