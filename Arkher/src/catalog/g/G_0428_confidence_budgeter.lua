-- ARKHER SYSTEM G.0428 :: Confidence Gating Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0428"
	S.key = "arkher.neural.confidence.compute_budget"
	S.name = "Confidence Gating Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.confidence.quality_predictor" }
	S.tags = { "g", "confidence", "budgeter", "neural" }
	S.description = "Confidence Gating Compute Budget: inference time budget allocation for the Confidence Gating subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.confidence.compute_budget", total = 436, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
