-- ARKHER SYSTEM VD.0432 :: Navigation Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0432"
	S.key = "arkher.contsim.navcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.navcont.reality_continuum" }
	S.tags = { "vd", "navcont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.navcont.emergence_continuum", windowSize = 7, threshold = 1.40, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
