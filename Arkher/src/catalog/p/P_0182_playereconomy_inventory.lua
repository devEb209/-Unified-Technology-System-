-- ARKHER SYSTEM P.0182 :: Economy Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0182"
	S.key = "arkher.play.playereconomy.inventory"
	S.name = "Economy Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Economy"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playereconomy.attributes" }
	S.tags = { "p", "playereconomy", "inventory", "play" }
	S.description = "Economy Inventory: slots, stacking, weight, equipment and crafting for the Economy subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.playereconomy.inventory", slots = 32, maxWeight = 50 })
		inst.system = S
		inst.ctx = ctx
