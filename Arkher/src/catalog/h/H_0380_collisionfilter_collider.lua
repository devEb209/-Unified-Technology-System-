-- ARKHER SYSTEM H.0380 :: Collision Filter Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0380"
	S.key = "arkher.physics.collisionfilter.collision_shape"
	S.name = "Collision Filter Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionfilter.body_dynamics" }
	S.tags = { "h", "collisionfilter", "collider", "physics" }
	S.description = "Collision Filter Collision Shape: shape bounds, support mapping and closest points for the Collision Filter subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.collisionfilter.collision_shape", shape = "sphere", radius = 0.70, height = 1.50, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
