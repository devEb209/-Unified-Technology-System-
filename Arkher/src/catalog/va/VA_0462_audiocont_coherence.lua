-- ARKHER SYSTEM VA.0462 :: Audio Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0462"
	S.key = "arkher.contworld.audiocont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.audiocont.persistent_state" }
	S.tags = { "va", "audiocont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.audiocont.coherence_guard", window = 55, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
