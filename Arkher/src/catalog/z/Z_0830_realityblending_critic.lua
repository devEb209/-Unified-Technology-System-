-- ARKHER SYSTEM Z.0830 :: Reality Blending Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0830"
	S.key = "arkher.origin.realityblending.self_critique"
	S.name = "Reality Blending Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.intent_bridge" }
	S.tags = { "z", "realityblending", "critic", "origin" }
	S.description = "Reality Blending Self Critique: weighted judgement of the technology's own output for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.realityblending.self_critique", passMark = 0.72, reviseMark = 0.47, seed = 43667 })
		inst.system = S
		inst.ctx = ctx
