-- ARKHER SYSTEM J.0080 :: Facial Rig Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0080"
	S.key = "arkher.character.facialrig.blend_controller"
	S.name = "Facial Rig Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.facialrig.motion_set" }
	S.tags = { "j", "facialrig", "animator", "character" }
	S.description = "Facial Rig Blend Controller: layered playback driving the character for the Facial Rig subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.facialrig.blend_controller", budget = 11 })
		inst.system = S
		inst.ctx = ctx
