-- ARKHER SYSTEM VB.0360 :: Narrative Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0360"
	S.key = "arkher.conttime.narrativecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.narrativecont.reality_continuum" }
	S.tags = { "vb", "narrativecont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.narrativecont.emergence_continuum", windowSize = 4, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
