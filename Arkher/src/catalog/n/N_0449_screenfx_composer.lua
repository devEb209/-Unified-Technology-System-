-- ARKHER SYSTEM N.0449 :: Screen Effect Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0449"
	S.key = "arkher.vfx.screenfx.effect_composition"
	S.name = "Screen Effect Effect Composition"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.screenfx.effect_graph" }
	S.tags = { "n", "screenfx", "composer", "vfx" }
	S.description = "Screen Effect Effect Composition: blending of several effect signals into one output for the Screen Effect subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.screenfx.effect_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
