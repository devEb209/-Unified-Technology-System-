-- ARKHER SYSTEM Z.0625 :: Intent Driven Authoring World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0625"
	S.key = "arkher.origin.intentauthoring.world_memory"
	S.name = "Intent Driven Authoring World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.autonomous_pipeline" }
	S.tags = { "z", "intentauthoring", "worldmemory", "origin" }
	S.description = "Intent Driven Authoring World Memory: epoch-stamped persistent history with compaction and checkpoints for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.intentauthoring.world_memory", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
