-- ARKHER SYSTEM E.0500 :: Shader Graph Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0500"
	S.key = "arkher.material.shadergraph.procedural_detail"
	S.name = "Shader Graph Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Shader Graph"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.shadergraph.texture_sampling" }
	S.tags = { "e", "shadergraph", "field", "material" }
	S.description = "Shader Graph Procedural Detail: coherent noise detail driving the surface for the Shader Graph subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.shadergraph.procedural_detail", seed = 79432, frequency = 0.0120, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
