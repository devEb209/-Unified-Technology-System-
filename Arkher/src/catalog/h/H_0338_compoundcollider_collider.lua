-- ARKHER SYSTEM H.0338 :: Compound Collider Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0338"
	S.key = "arkher.physics.compoundcollider.collision_shape"
	S.name = "Compound Collider Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.compoundcollider.body_dynamics" }
	S.tags = { "h", "compoundcollider", "collider", "physics" }
	S.description = "Compound Collider Collision Shape: shape bounds, support mapping and closest points for the Compound Collider subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.compoundcollider.collision_shape", shape = "capsule", radius = 1.20, height = 2.00, layer = "default" })
		inst.system = S
		inst.ctx = ctx
