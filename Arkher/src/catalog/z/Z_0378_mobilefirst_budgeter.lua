-- ARKHER SYSTEM Z.0378 :: Mobile First Governor Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0378"
	S.key = "arkher.origin.mobilefirst.budget_governor"
	S.name = "Mobile First Governor Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.behaviour_analysis" }
	S.tags = { "z", "mobilefirst", "budgeter", "origin" }
	S.description = "Mobile First Governor Budget Governor: allocation of a scarce resource across the technology's consumers for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.mobilefirst.budget_governor", total = 175, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
