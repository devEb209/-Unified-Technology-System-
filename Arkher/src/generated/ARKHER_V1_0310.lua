--!strict
-- Decima Workshop — CORE Stack #0310
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Decima Workshop — CORE Stack #0310", size=Vector2.new(640, 420), pos=UDim2.fromOffset(130, 150), parent=parent, icon="⚙"})
