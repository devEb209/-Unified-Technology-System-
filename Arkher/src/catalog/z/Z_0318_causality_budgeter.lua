-- ARKHER SYSTEM Z.0318 :: Causality Ledger Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0318"
	S.key = "arkher.origin.causality.budget_governor"
	S.name = "Causality Ledger Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.behaviour_analysis" }
	S.tags = { "z", "causality", "budgeter", "origin" }
	S.description = "Causality Ledger Budget Governor: allocation of a scarce resource across the technology's consumers for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.causality.budget_governor", total = 306, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
