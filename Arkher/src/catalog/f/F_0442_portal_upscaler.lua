-- ARKHER SYSTEM F.0442 :: Portal Culling Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0442"
	S.key = "arkher.render.portal.adaptive_resolution"
	S.name = "Portal Culling Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.portal.temporal_resolve" }
	S.tags = { "f", "portal", "upscaler", "render" }
	S.description = "Portal Culling Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Portal Culling subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.portal.adaptive_resolution", targetMs = 15.10, index = 4, sharpness = 0.34 })
		inst.system = S
		inst.ctx = ctx
