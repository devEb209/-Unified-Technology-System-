-- ARKHER SYSTEM VB.0504 :: Rendering Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0504"
	S.key = "arkher.conttime.rendercont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.rendercont.reality_continuum" }
	S.tags = { "vb", "rendercont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.rendercont.emergence_continuum", windowSize = 6, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
