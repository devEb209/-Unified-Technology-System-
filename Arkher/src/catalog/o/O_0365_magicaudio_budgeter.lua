-- ARKHER SYSTEM O.0365 :: Magic Audio Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0365"
	S.key = "arkher.audio.magicaudio.voice_budget"
	S.name = "Magic Audio Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Magic Audio"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.magicaudio.music_sequencer" }
	S.tags = { "o", "magicaudio", "budgeter", "audio" }
	S.description = "Magic Audio Voice Budget: voice slots allocated by priority and audibility for the Magic Audio subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.magicaudio.voice_budget", total = 294, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
