-- ARKHER SYSTEM VC.0437 :: Physics Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0437"
	S.key = "arkher.contneural.physicscont.persistent_state"
	S.name = "Physics Continuum Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.physicscont.multi-scale_fidelity" }
	S.tags = { "vc", "physicscont", "persistent", "contneural" }
	S.description = "Physics Continuum Persistent State: epoch-stamped persistent history and rollback for the Physics Continuum subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.physicscont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
