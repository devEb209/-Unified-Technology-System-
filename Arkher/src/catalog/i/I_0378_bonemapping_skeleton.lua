-- ARKHER SYSTEM I.0378 :: Bone Mapping Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0378"
	S.key = "arkher.anim.bonemapping.skeleton"
	S.name = "Bone Mapping Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bone Mapping"
	S.aspect = "Skeleton"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "bonemapping", "skeleton", "anim" }
	S.description = "Bone Mapping Skeleton: bone hierarchy, bind pose and world resolution for the Bone Mapping subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.bonemapping.skeleton" })
		inst.system = S
		inst.ctx = ctx
