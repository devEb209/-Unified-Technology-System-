-- ARKHER SYSTEM I.0386 :: Bone Mapping Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0386"
	S.key = "arkher.anim.bonemapping.playback_pipeline"
	S.name = "Bone Mapping Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bone Mapping"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonemapping.event_ledger" }
	S.tags = { "i", "bonemapping", "pipeline", "anim" }
	S.description = "Bone Mapping Playback Pipeline: ordered sample, blend, ik and output stages for the Bone Mapping subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.bonemapping.playback_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
