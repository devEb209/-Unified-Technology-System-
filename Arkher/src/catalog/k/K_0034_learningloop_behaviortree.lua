-- ARKHER SYSTEM K.0034 :: Learning Loop Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0034"
	S.key = "arkher.npc.learningloop.reactive_behaviour"
	S.name = "Learning Loop Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.learningloop.perception" }
	S.tags = { "k", "learningloop", "behaviortree", "npc" }
	S.description = "Learning Loop Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Learning Loop subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.learningloop.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
