-- ARKHER SYSTEM H.0650 :: Wheel Suspension Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0650"
	S.key = "arkher.physics.suspension.character_motion"
	S.name = "Wheel Suspension Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.suspension.query" }
	S.tags = { "h", "suspension", "charmotor", "physics" }
	S.description = "Wheel Suspension Character Motion: capsule move-and-slide with slopes, steps and jumps for the Wheel Suspension subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.suspension.character_motion", radius = 0.45, height = 1.90, maxSpeed = 9.00, jumpHeight = 1.40, stepOffset = 0.45 })
		inst.system = S
		inst.ctx = ctx
