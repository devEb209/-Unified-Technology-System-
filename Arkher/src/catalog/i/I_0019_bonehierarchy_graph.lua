-- ARKHER SYSTEM I.0019 :: Bone Hierarchy Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0019"
	S.key = "arkher.anim.bonehierarchy.retarget_graph"
	S.name = "Bone Hierarchy Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonehierarchy.physical_blend" }
	S.tags = { "i", "bonehierarchy", "graph", "anim" }
	S.description = "Bone Hierarchy Retarget Graph: bone mapping and retarget path resolution for the Bone Hierarchy subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.bonehierarchy.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
