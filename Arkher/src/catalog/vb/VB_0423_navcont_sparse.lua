-- ARKHER SYSTEM VB.0423 :: Navigation Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0423"
	S.key = "arkher.conttime.navcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.navcont.epoch_clock" }
	S.tags = { "vb", "navcont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.navcont.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
