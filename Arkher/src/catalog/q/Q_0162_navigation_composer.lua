-- ARKHER SYSTEM Q.0162 :: Navigation Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0162"
	S.key = "arkher.ui.navigation.theme_composition"
	S.name = "Navigation Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Navigation"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.navigation.navigation_graph" }
	S.tags = { "q", "navigation", "composer", "ui" }
	S.description = "Navigation Theme Composition: blending of theme signals into the final appearance for the Navigation subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.navigation.theme_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
