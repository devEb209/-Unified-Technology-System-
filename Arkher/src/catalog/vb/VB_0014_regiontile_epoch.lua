-- ARKHER SYSTEM VB.0014 :: Region Tile Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0014"
	S.key = "arkher.conttime.regiontile.epoch_clock"
	S.name = "Region Tile Epoch Clock"
	S.category = "VB"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.regiontile.infinite_grid" }
	S.tags = { "vb", "regiontile", "epoch", "conttime" }
	S.description = "Region Tile Epoch Clock: deterministic epoch timeline with catch-up for the Region Tile subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.regiontile.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
