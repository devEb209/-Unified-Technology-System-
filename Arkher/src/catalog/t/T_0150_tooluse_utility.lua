-- ARKHER SYSTEM T.0150 :: Tool Use Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0150"
	S.key = "arkher.ai.tooluse.utility_selection"
	S.name = "Tool Use Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.tooluse.working_memory" }
	S.tags = { "t", "tooluse", "utility", "ai" }
	S.description = "Tool Use Utility Selection: scored choice between competing courses of action for the Tool Use subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.tooluse.utility_selection", momentum = 0.15 })
		inst.system = S
		inst.ctx = ctx
