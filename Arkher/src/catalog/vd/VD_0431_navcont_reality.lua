-- ARKHER SYSTEM VD.0431 :: Navigation Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0431"
	S.key = "arkher.contsim.navcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.navcont.simulation_fabric" }
	S.tags = { "vd", "navcont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.navcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
