-- ARKHER SYSTEM VD.0239 :: City Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0239"
	S.key = "arkher.contsim.citycont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.citycont.simulation_fabric" }
	S.tags = { "vd", "citycont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.citycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
