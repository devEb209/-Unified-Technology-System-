-- ARKHER SYSTEM G.0183 :: Light Transport Prediction Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0183"
	S.key = "arkher.neural.lightpredict.inference_core"
	S.name = "Light Transport Prediction Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "lightpredict", "inference", "neural" }
	S.description = "Light Transport Prediction Inference Core: dense network forward pass and training for the Light Transport Prediction subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.lightpredict.inference_core", seed = 6416 })
		inst.system = S
		inst.ctx = ctx
