-- ARKHER SYSTEM J.0166 :: Clothing Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0166"
	S.key = "arkher.character.clothing.rig_definition"
	S.name = "Clothing Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "clothing", "skeleton", "character" }
	S.description = "Clothing Rig Definition: character rig definition and bone budget for the Clothing subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.clothing.rig_definition" })
		inst.system = S
		inst.ctx = ctx
