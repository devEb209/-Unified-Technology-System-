-- ARKHER SYSTEM F.0453 :: Frustum Culling Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0453"
	S.key = "arkher.render.frustum.lighting_rig"
	S.name = "Frustum Culling Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.frustum.geometry_virtualization" }
	S.tags = { "f", "frustum", "lightrig", "render" }
	S.description = "Frustum Culling Lighting Rig: light clustering, importance and cascades for the Frustum Culling subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.frustum.lighting_rig", maxActive = 9 })
		inst.system = S
		inst.ctx = ctx
