-- ARKHER SYSTEM Z.0892 :: Sparse World Representation Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0892"
	S.key = "arkher.origin.sparseworld.predictive_optimization"
	S.name = "Sparse World Representation Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.adaptive_workflow" }
	S.tags = { "z", "sparseworld", "predictor", "origin" }
	S.description = "Sparse World Representation Predictive Optimization: forecast-driven optimization before the cost is paid for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.sparseworld.predictive_optimization", method = "markov", alpha = 0.10, window = 112 })
		inst.system = S
		inst.ctx = ctx
