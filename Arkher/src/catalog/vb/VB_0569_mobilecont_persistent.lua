-- ARKHER SYSTEM VB.0569 :: Mobile Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0569"
	S.key = "arkher.conttime.mobilecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.mobilecont.multi-scale_fidelity" }
	S.tags = { "vb", "mobilecont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.mobilecont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
