-- ARKHER SYSTEM VB.0064 :: Sparse Page Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0064"
	S.key = "arkher.conttime.sparsepage.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.sparsepage.sparse_residency" }
	S.tags = { "vb", "sparsepage", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.sparsepage.multi-scale_fidelity", levels = 6, baseTriangles = 120000 })
		inst.system = S
		inst.ctx = ctx
