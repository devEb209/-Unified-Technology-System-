-- ARKHER SYSTEM T.0096 :: Semantic Search Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0096"
	S.key = "arkher.ai.semanticsearch.model_inference"
	S.name = "Semantic Search Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.semanticsearch.action_planner" }
	S.tags = { "t", "semanticsearch", "inference", "ai" }
	S.description = "Semantic Search Model Inference: quantized inference with batching and budget for the Semantic Search subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.semanticsearch.model_inference", seed = 4168 })
		inst.system = S
		inst.ctx = ctx
