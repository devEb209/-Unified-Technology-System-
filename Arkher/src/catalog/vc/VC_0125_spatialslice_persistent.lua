-- ARKHER SYSTEM VC.0125 :: Spatial Slice Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0125"
	S.key = "arkher.contneural.spatialslice.persistent_state"
	S.name = "Spatial Slice Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.spatialslice.multi-scale_fidelity" }
	S.tags = { "vc", "spatialslice", "persistent", "contneural" }
	S.description = "Spatial Slice Persistent State: epoch-stamped persistent history and rollback for the Spatial Slice subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.spatialslice.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
