-- ARKHER SYSTEM T.0354 :: Documentation Writer Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0354"
	S.key = "arkher.ai.documentationwriter.self_critique"
	S.name = "Documentation Writer Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.documentationwriter.plan_workflow" }
	S.tags = { "t", "documentationwriter", "critic", "ai" }
	S.description = "Documentation Writer Self Critique: weighted evaluation of the result against declared criteria for the Documentation Writer subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.documentationwriter.self_critique", passMark = 0.75, reviseMark = 0.45, seed = 54305 })
		inst.system = S
		inst.ctx = ctx
