-- ARKHER SYSTEM F.0103 :: Ambient Occlusion Pass Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0103"
	S.key = "arkher.render.aopass.lighting_rig"
	S.name = "Ambient Occlusion Pass Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.aopass.geometry_virtualization" }
	S.tags = { "f", "aopass", "lightrig", "render" }
	S.description = "Ambient Occlusion Pass Lighting Rig: light clustering, importance and cascades for the Ambient Occlusion Pass subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.aopass.lighting_rig", maxActive = 11 })
		inst.system = S
		inst.ctx = ctx
