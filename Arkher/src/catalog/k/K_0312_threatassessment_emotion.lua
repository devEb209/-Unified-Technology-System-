-- ARKHER SYSTEM K.0312 :: Threat Assessment Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0312"
	S.key = "arkher.npc.threatassessment.emotion"
	S.name = "Threat Assessment Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.threatassessment.drive_system" }
	S.tags = { "k", "threatassessment", "emotion", "npc" }
	S.description = "Threat Assessment Emotion: appraisal of events into valence, arousal and mood for the Threat Assessment subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.threatassessment.emotion", inertia = 0.78, decayRate = 0.23, baselineArousal = 0.13 })
		inst.system = S
		inst.ctx = ctx
