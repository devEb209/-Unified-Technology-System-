-- ARKHER SYSTEM G.0159 :: Geometry Detail Prediction Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0159"
	S.key = "arkher.neural.geodetail.model_registry"
	S.name = "Geometry Detail Prediction Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.geodetail.reconstruction" }
	S.tags = { "g", "geodetail", "registry", "neural" }
	S.description = "Geometry Detail Prediction Model Registry: named models and their lifecycle for the Geometry Detail Prediction subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.geodetail.model_registry" })
		inst.system = S
		inst.ctx = ctx
