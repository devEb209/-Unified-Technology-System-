-- ARKHER SYSTEM N.0218 :: Lightning Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0218"
	S.key = "arkher.vfx.lightning.quality_policy"
	S.name = "Lightning Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Lightning"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.lightning.result_cache" }
	S.tags = { "n", "lightning", "policy", "vfx" }
	S.description = "Lightning Quality Policy: distance and device driven fidelity bands for the Lightning subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.lightning.quality_policy", algorithm = "edf", starvationGuard = 53 })
		inst.system = S
		inst.ctx = ctx
