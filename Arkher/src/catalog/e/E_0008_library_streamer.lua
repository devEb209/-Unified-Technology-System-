-- ARKHER SYSTEM E.0008 :: Material Library Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0008"
	S.key = "arkher.material.library.streaming"
	S.name = "Material Library Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.library.parameter_budget" }
	S.tags = { "e", "library", "streamer", "material" }
	S.description = "Material Library Streaming: residency and demand-driven texture streaming for the Material Library subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.library.streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
