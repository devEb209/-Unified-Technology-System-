-- ARKHER SYSTEM Q.0209 :: Compass Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0209"
	S.key = "arkher.ui.compass.navigation_graph"
	S.name = "Compass Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Compass"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.compass.transition" }
	S.tags = { "q", "compass", "graph", "ui" }
	S.description = "Compass Navigation Graph: screens, routes and shortest path between them for the Compass subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.compass.navigation_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
