-- ARKHER SYSTEM P.0373 :: Checkpoint Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0373"
	S.key = "arkher.play.checkpoint.attributes"
	S.name = "Checkpoint Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Checkpoint"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "checkpoint", "stats", "play" }
	S.description = "Checkpoint Attributes: base values, layered modifiers and derived statistics for the Checkpoint subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.checkpoint.attributes" })
		inst.system = S
		inst.ctx = ctx
