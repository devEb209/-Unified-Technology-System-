-- ARKHER SYSTEM T.0312 :: Optimization Advisor Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0312"
	S.key = "arkher.ai.optimizationadvisor.self_critique"
	S.name = "Optimization Advisor Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.optimizationadvisor.plan_workflow" }
	S.tags = { "t", "optimizationadvisor", "critic", "ai" }
	S.description = "Optimization Advisor Self Critique: weighted evaluation of the result against declared criteria for the Optimization Advisor subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.optimizationadvisor.self_critique", passMark = 0.78, reviseMark = 0.48, seed = 2768 })
		inst.system = S
		inst.ctx = ctx
