-- ARKHER SYSTEM H.0063 :: Inertia Tensor Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0063"
	S.key = "arkher.physics.inertia.vehicle"
	S.name = "Inertia Tensor Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.inertia.character_motion" }
	S.tags = { "h", "inertia", "vehicle", "physics" }
	S.description = "Inertia Tensor Vehicle: suspension, drivetrain, steering and tire friction for the Inertia Tensor subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.inertia.vehicle", mass = 1900, wheelbase = 3.20, track = 1.60, maxRpm = 6600 })
		inst.system = S
		inst.ctx = ctx
