-- ARKHER SYSTEM P.0050 :: Talent Tree Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0050"
	S.key = "arkher.play.talenttree.inventory"
	S.name = "Talent Tree Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Talent Tree"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.talenttree.attributes" }
	S.tags = { "p", "talenttree", "inventory", "play" }
	S.description = "Talent Tree Inventory: slots, stacking, weight, equipment and crafting for the Talent Tree subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.talenttree.inventory", slots = 16, maxWeight = 90 })
		inst.system = S
		inst.ctx = ctx
