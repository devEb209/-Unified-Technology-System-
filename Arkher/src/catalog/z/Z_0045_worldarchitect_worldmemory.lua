-- ARKHER SYSTEM Z.0045 :: Singularity World Architect World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0045"
	S.key = "arkher.origin.worldarchitect.world_memory"
	S.name = "Singularity World Architect World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.autonomous_pipeline" }
	S.tags = { "z", "worldarchitect", "worldmemory", "origin" }
	S.description = "Singularity World Architect World Memory: epoch-stamped persistent history with compaction and checkpoints for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.worldarchitect.world_memory", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
