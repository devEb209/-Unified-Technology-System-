-- ARKHER SYSTEM F.0051 :: Transparent Pass Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0051"
	S.key = "arkher.render.transparentpass.draw_budget"
	S.name = "Transparent Pass Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.transparentpass.adaptive_resolution" }
	S.tags = { "f", "transparentpass", "budgeter", "render" }
	S.description = "Transparent Pass Draw Budget: draw call and triangle budget allocation for the Transparent Pass subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.transparentpass.draw_budget", total = 187, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
