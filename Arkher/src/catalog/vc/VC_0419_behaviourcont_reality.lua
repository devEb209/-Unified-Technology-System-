-- ARKHER SYSTEM VC.0419 :: Behaviour Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0419"
	S.key = "arkher.contneural.behaviourcont.reality_continuum"
	S.name = "Behaviour Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.behaviourcont.simulation_fabric" }
	S.tags = { "vc", "behaviourcont", "reality", "contneural" }
	S.description = "Behaviour Continuum Reality Continuum: stacked reality layers of the continuum for the Behaviour Continuum subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.behaviourcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
