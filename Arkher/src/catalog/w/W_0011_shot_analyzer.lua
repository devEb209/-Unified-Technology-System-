-- ARKHER SYSTEM W.0011 :: Shot Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0011"
	S.key = "arkher.cine.shot.sequence_analysis"
	S.name = "Shot Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Shot"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.shot.frame_budget" }
	S.tags = { "w", "shot", "analyzer", "cine" }
	S.description = "Shot Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Shot subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.shot.sequence_analysis", window = 171, buckets = 11, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
