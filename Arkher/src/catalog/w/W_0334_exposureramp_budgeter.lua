-- ARKHER SYSTEM W.0334 :: Exposure Ramp Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0334"
	S.key = "arkher.cine.exposureramp.frame_budget"
	S.name = "Exposure Ramp Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.exposureramp.event_ledger" }
	S.tags = { "w", "exposureramp", "budgeter", "cine" }
	S.description = "Exposure Ramp Frame Budget: per-frame cost budget for the cinematic systems for the Exposure Ramp subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.exposureramp.frame_budget", total = 145, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
