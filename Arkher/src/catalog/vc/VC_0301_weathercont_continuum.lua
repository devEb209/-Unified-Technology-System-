-- ARKHER SYSTEM VC.0301 :: Weather Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0301"
	S.key = "arkher.contneural.weathercont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "weathercont", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.weathercont.infinite_grid", cellSize = 128, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
