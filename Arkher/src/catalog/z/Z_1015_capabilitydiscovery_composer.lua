-- ARKHER SYSTEM Z.1015 :: Capability Discovery Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.1015"
	S.key = "arkher.origin.capabilitydiscovery.signal_composition"
	S.name = "Capability Discovery Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.telemetry_ledger" }
	S.tags = { "z", "capabilitydiscovery", "composer", "origin" }
	S.description = "Capability Discovery Signal Composition: blending of the technology's input signals into one output for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.capabilitydiscovery.signal_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
