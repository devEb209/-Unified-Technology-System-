-- ARKHER SYSTEM G.0258 :: Performance Prediction Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0258"
	S.key = "arkher.neural.perfpredict.weight_codec"
	S.name = "Performance Prediction Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perfpredict.model_registry" }
	S.tags = { "g", "perfpredict", "codec", "neural" }
	S.description = "Performance Prediction Weight Codec: weight serialization and quantized transport for the Performance Prediction subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.perfpredict.weight_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
