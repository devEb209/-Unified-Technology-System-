-- ARKHER SYSTEM E.0578 :: Material Validation Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0578"
	S.key = "arkher.material.validation.streaming"
	S.name = "Material Validation Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.validation.parameter_budget" }
	S.tags = { "e", "validation", "streamer", "material" }
	S.description = "Material Validation Streaming: residency and demand-driven texture streaming for the Material Validation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.validation.streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
