-- ARKHER SYSTEM I.0456 :: Procedural Animation Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0456"
	S.key = "arkher.anim.proceduralanim.skeleton"
	S.name = "Procedural Animation Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "proceduralanim", "skeleton", "anim" }
	S.description = "Procedural Animation Skeleton: bone hierarchy, bind pose and world resolution for the Procedural Animation subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.proceduralanim.skeleton" })
		inst.system = S
		inst.ctx = ctx
