-- ARKHER SYSTEM V.0285 :: Impostor Asset Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0285"
	S.key = "arkher.asset.impostorasset.size_budget"
	S.name = "Impostor Asset Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.impostorasset.compression_codec" }
	S.tags = { "v", "impostorasset", "budgeter", "asset" }
	S.description = "Impostor Asset Size Budget: byte budget shared between competing asset classes for the Impostor Asset subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.impostorasset.size_budget", total = 134, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
