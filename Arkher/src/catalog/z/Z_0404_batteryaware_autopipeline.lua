-- ARKHER SYSTEM Z.0404 :: Battery Aware Pipeline Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0404"
	S.key = "arkher.origin.batteryaware.autonomous_pipeline"
	S.name = "Battery Aware Pipeline Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.batteryaware.simulation_fabric" }
	S.tags = { "z", "batteryaware", "autopipeline", "origin" }
	S.description = "Battery Aware Pipeline Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Battery Aware Pipeline subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.batteryaware.autonomous_pipeline", maxIterations = 10 })
		inst.system = S
		inst.ctx = ctx
