-- ARKHER SYSTEM Q.0091 :: Scroll View Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0091"
	S.key = "arkher.ui.scrollview.localization_registry"
	S.name = "Scroll View Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Scroll View"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.scrollview.theme_composition" }
	S.tags = { "q", "scrollview", "registry", "ui" }
	S.description = "Scroll View Localization Registry: catalogue of strings, plurals and locale metadata for the Scroll View subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.scrollview.localization_registry" })
		inst.system = S
		inst.ctx = ctx
