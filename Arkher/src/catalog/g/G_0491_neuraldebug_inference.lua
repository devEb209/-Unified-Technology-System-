-- ARKHER SYSTEM G.0491 :: Neural Debug Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0491"
	S.key = "arkher.neural.neuraldebug.inference_core"
	S.name = "Neural Debug Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "neuraldebug", "inference", "neural" }
	S.description = "Neural Debug Inference Core: dense network forward pass and training for the Neural Debug subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.neuraldebug.inference_core", seed = 98986 })
		inst.system = S
		inst.ctx = ctx
