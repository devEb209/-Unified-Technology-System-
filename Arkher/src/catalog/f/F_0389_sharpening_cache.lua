-- ARKHER SYSTEM F.0389 :: Sharpening Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0389"
	S.key = "arkher.render.sharpening.pass_cache"
	S.name = "Sharpening Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sharpening"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sharpening.render_policy" }
	S.tags = { "f", "sharpening", "cache", "render" }
	S.description = "Sharpening Pass Cache: reuse of pass results across frames for the Sharpening subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.sharpening.pass_cache", policy = "lru", capacity = 160, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
