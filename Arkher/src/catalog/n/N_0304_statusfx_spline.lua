-- ARKHER SYSTEM N.0304 :: Status Effect Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0304"
	S.key = "arkher.vfx.statusfx.curve_authoring"
	S.name = "Status Effect Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.statusfx.ribbon_and_trail" }
	S.tags = { "n", "statusfx", "spline", "vfx" }
	S.description = "Status Effect Curve Authoring: authored curves driving the effect over its life for the Status Effect subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.statusfx.curve_authoring", tension = 0.42, closed = false })
		inst.system = S
		inst.ctx = ctx
