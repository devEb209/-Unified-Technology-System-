-- ARKHER SYSTEM T.0675 :: Continuous Learning Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0675"
	S.key = "arkher.ai.continuouslearning.plan_workflow"
	S.name = "Continuous Learning Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.continuouslearning.semantic_knowledge" }
	S.tags = { "t", "continuouslearning", "workflow", "ai" }
	S.description = "Continuous Learning Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Continuous Learning subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.continuouslearning.plan_workflow", maxRetries = 2, budget = 140 })
		inst.system = S
		inst.ctx = ctx
