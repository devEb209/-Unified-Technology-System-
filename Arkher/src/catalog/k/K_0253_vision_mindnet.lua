-- ARKHER SYSTEM K.0253 :: Vision Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0253"
	S.key = "arkher.npc.vision.mind_network"
	S.name = "Vision Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "vision", "mindnet", "npc" }
	S.description = "Vision Mind Network: the learned policy that turns perception into a decision for the Vision subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.vision.mind_network", inputs = 6, hidden = 8, seed = 45264, learningRate = 0.070, exploration = 0.020 })
		inst.system = S
		inst.ctx = ctx
