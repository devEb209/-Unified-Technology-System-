-- ARKHER SYSTEM H.0430 :: Friction Model Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0430"
	S.key = "arkher.physics.friction.simulation_policy"
	S.name = "Friction Model Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.friction.budget_governor" }
	S.tags = { "h", "friction", "policy", "physics" }
	S.description = "Friction Model Simulation Policy: device tier rules for substeps, iterations and sleep for the Friction Model subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.friction.simulation_policy", algorithm = "roundrobin", starvationGuard = 56 })
		inst.system = S
		inst.ctx = ctx
