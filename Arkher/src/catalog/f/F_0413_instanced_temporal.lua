-- ARKHER SYSTEM F.0413 :: Instanced Draw Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0413"
	S.key = "arkher.render.instanced.temporal_resolve"
	S.name = "Instanced Draw Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.instanced.probe_volume" }
	S.tags = { "f", "instanced", "temporal", "render" }
	S.description = "Instanced Draw Temporal Resolve: history reprojection with neighbourhood clamping for the Instanced Draw subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.instanced.temporal_resolve", feedback = 0.90, phase = 8 })
		inst.system = S
		inst.ctx = ctx
