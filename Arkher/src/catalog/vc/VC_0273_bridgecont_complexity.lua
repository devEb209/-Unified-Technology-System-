-- ARKHER SYSTEM VC.0273 :: Bridge Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0273"
	S.key = "arkher.contneural.bridgecont.complexity_budget"
	S.name = "Bridge Continuum Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.bridgecont.world_memory_stream" }
	S.tags = { "vc", "bridgecont", "complexity", "contneural" }
	S.description = "Bridge Continuum Complexity Budget: complexity budgeting for the continuum for the Bridge Continuum subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.bridgecont.complexity_budget", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
