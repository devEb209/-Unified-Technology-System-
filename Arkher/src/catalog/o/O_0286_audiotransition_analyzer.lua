-- ARKHER SYSTEM O.0286 :: Transition Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0286"
	S.key = "arkher.audio.audiotransition.analysis"
	S.name = "Transition Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Transition"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiotransition.playback_policy" }
	S.tags = { "o", "audiotransition", "analyzer", "audio" }
	S.description = "Transition Analysis: loudness, headroom and masking analysis for the Transition subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.audiotransition.analysis", window = 126, buckets = 14, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
