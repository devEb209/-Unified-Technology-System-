-- ARKHER SYSTEM Z.0540 :: Migration Dynamics Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0540"
	S.key = "arkher.origin.migrationdynamics.orchestration"
	S.name = "Migration Dynamics Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.migrationdynamics.residency_streaming" }
	S.tags = { "z", "migrationdynamics", "orchestrator", "origin" }
	S.description = "Migration Dynamics Orchestration: lifecycle and phase orchestration of the technology for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.migrationdynamics.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
