-- ARKHER SYSTEM F.0073 :: Cascade Shadows Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0073"
	S.key = "arkher.render.cascades.visibility_set"
	S.name = "Cascade Shadows Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.cascades.view_and_culling" }
	S.tags = { "f", "cascades", "visibility", "render" }
	S.description = "Cascade Shadows Visibility Set: cell, portal and occluder visibility for the Cascade Shadows subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.cascades.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
