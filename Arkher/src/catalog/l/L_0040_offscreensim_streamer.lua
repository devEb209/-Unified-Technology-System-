-- ARKHER SYSTEM L.0040 :: Offscreen Simulation Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0040"
	S.key = "arkher.sim.offscreensim.streaming"
	S.name = "Offscreen Simulation Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.offscreensim.state_codec" }
	S.tags = { "l", "offscreensim", "streamer", "sim" }
	S.description = "Offscreen Simulation Streaming: distance-driven residency of simulated regions for the Offscreen Simulation subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.offscreensim.streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
