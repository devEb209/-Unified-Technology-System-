-- ARKHER SYSTEM VB.0409 :: Behaviour Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0409"
	S.key = "arkher.conttime.behaviourcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "behaviourcont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.behaviourcont.infinite_grid", cellSize = 224, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
