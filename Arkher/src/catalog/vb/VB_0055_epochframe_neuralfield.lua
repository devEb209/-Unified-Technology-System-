-- ARKHER SYSTEM VB.0055 :: Epoch Frame Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0055"
	S.key = "arkher.conttime.epochframe.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.epochframe.coherence_guard" }
	S.tags = { "vb", "epochframe", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.epochframe.neural_field", dims = 24, hidden = 20, seed = 53947 })
		inst.system = S
		inst.ctx = ctx
