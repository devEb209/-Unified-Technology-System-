-- ARKHER SYSTEM Z.0758 :: World Compression Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0758"
	S.key = "arkher.origin.worldcompression.budget_governor"
	S.name = "World Compression Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.behaviour_analysis" }
	S.tags = { "z", "worldcompression", "budgeter", "origin" }
	S.description = "World Compression Budget Governor: allocation of a scarce resource across the technology's consumers for the World Compression subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.worldcompression.budget_governor", total = 220, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
