-- ARKHER SYSTEM R.0352 :: Network Debug Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0352"
	S.key = "arkher.net.networkdebug.transport_graph"
	S.name = "Network Debug Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.networkdebug.prediction_and_reconciliation" }
	S.tags = { "r", "networkdebug", "network", "net" }
	S.description = "Network Debug Transport Graph: topology, capacity and routing between endpoints for the Network Debug subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.networkdebug.transport_graph" })
		inst.system = S
		inst.ctx = ctx
