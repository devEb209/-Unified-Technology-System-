...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="RAGE ImGui — CORE Map #0108", size=Vector2.new(600, 480), pos=UDim2.fromOffset(304, 96), parent=parent, icon="🛰"})
