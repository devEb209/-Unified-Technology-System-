-- ARKHER SYSTEM W.0259 :: Match Cut Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0259"
	S.key = "arkher.cine.matchcut.motion_tween"
	S.name = "Match Cut Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Match Cut"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.matchcut.playback_orchestrator" }
	S.tags = { "w", "matchcut", "tween", "cine" }
	S.description = "Match Cut Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Match Cut subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.matchcut.motion_tween", timeScale = 1.14 })
		inst.system = S
		inst.ctx = ctx
