-- ARKHER SYSTEM VA.0132 :: Spatial Slice Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0132"
	S.key = "arkher.contworld.spatialslice.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.spatialslice.reality_continuum" }
	S.tags = { "va", "spatialslice", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.spatialslice.emergence_continuum", windowSize = 7, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
