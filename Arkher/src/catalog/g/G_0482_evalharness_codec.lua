-- ARKHER SYSTEM G.0482 :: Evaluation Harness Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0482"
	S.key = "arkher.neural.evalharness.weight_codec"
	S.name = "Evaluation Harness Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.evalharness.model_registry" }
	S.tags = { "g", "evalharness", "codec", "neural" }
	S.description = "Evaluation Harness Weight Codec: weight serialization and quantized transport for the Evaluation Harness subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.evalharness.weight_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
