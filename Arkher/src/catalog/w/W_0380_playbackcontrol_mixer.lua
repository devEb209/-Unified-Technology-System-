-- ARKHER SYSTEM W.0380 :: Playback Control Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0380"
	S.key = "arkher.cine.playbackcontrol.cinematic_mix"
	S.name = "Playback Control Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.playbackcontrol.motion_tween" }
	S.tags = { "w", "playbackcontrol", "mixer", "cine" }
	S.description = "Playback Control Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Playback Control subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.playbackcontrol.cinematic_mix", maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
