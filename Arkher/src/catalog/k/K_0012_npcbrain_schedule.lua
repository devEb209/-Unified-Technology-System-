-- ARKHER SYSTEM K.0012 :: NPC Brain Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0012"
	S.key = "arkher.npc.npcbrain.daily_schedule"
	S.name = "NPC Brain Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcbrain.social_relations" }
	S.tags = { "k", "npcbrain", "schedule", "npc" }
	S.description = "NPC Brain Daily Schedule: hour-by-hour routine with priority interruptions for the NPC Brain subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.npcbrain.daily_schedule", startHour = 8 })
		inst.system = S
		inst.ctx = ctx
