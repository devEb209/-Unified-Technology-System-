-- ARKHER SYSTEM G.0213 :: Reflection Prediction Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0213"
	S.key = "arkher.neural.reflectpredict.temporal_history"
	S.name = "Reflection Prediction Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.reflectpredict.feature_extraction" }
	S.tags = { "g", "reflectpredict", "temporal", "neural" }
	S.description = "Reflection Prediction Temporal History: history buffers reused across frames for the Reflection Prediction subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.reflectpredict.temporal_history", feedback = 0.88, phase = 8 })
		inst.system = S
		inst.ctx = ctx
