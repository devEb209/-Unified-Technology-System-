-- ARKHER SYSTEM W.0094 :: Crane Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0094"
	S.key = "arkher.cine.crane.frame_budget"
	S.name = "Crane Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Crane"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.crane.event_ledger" }
	S.tags = { "w", "crane", "budgeter", "cine" }
	S.description = "Crane Frame Budget: per-frame cost budget for the cinematic systems for the Crane subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.crane.frame_budget", total = 394, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
