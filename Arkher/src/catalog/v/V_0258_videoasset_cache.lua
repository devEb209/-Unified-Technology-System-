-- ARKHER SYSTEM V.0258 :: Video Asset Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0258"
	S.key = "arkher.asset.videoasset.content_cache"
	S.name = "Video Asset Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.videoasset.dependency_graph" }
	S.tags = { "v", "videoasset", "cache", "asset" }
	S.description = "Video Asset Content Cache: reuse of already cooked results for the Video Asset subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.videoasset.content_cache", policy = "lfu", capacity = 381, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
