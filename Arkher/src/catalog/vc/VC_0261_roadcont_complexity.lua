-- ARKHER SYSTEM VC.0261 :: Road Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0261"
	S.key = "arkher.contneural.roadcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.roadcont.world_memory_stream" }
	S.tags = { "vc", "roadcont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.roadcont.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
