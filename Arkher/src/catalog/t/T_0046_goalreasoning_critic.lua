-- ARKHER SYSTEM T.0046 :: Goal Reasoning Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0046"
	S.key = "arkher.ai.goalreasoning.self_critique"
	S.name = "Goal Reasoning Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.goalreasoning.plan_workflow" }
	S.tags = { "t", "goalreasoning", "critic", "ai" }
	S.description = "Goal Reasoning Self Critique: weighted evaluation of the result against declared criteria for the Goal Reasoning subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.goalreasoning.self_critique", passMark = 0.70, reviseMark = 0.45, seed = 53895 })
		inst.system = S
		inst.ctx = ctx
