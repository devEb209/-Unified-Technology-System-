-- ARKHER SYSTEM L.0475 :: Faction Politics Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0475"
	S.key = "arkher.sim.factionpolitics.streaming"
	S.name = "Faction Politics Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.factionpolitics.state_codec" }
	S.tags = { "l", "factionpolitics", "streamer", "sim" }
	S.description = "Faction Politics Streaming: distance-driven residency of simulated regions for the Faction Politics subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.factionpolitics.streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
