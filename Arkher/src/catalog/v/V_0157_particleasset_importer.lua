-- ARKHER SYSTEM V.0157 :: Particle Asset Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0157"
	S.key = "arkher.asset.particleasset.import"
	S.name = "Particle Asset Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "particleasset", "importer", "asset" }
	S.description = "Particle Asset Import: validation, normalization, hashing and deduplication of incoming content for the Particle Asset subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.particleasset.import", unitScale = 1.75 })
		inst.system = S
		inst.ctx = ctx
