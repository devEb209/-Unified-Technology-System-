-- ARKHER SYSTEM O.0070 :: Voice Line Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0070"
	S.key = "arkher.audio.voiceline.analysis"
	S.name = "Voice Line Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Voice Line"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.voiceline.playback_policy" }
	S.tags = { "o", "voiceline", "analyzer", "audio" }
	S.description = "Voice Line Analysis: loudness, headroom and masking analysis for the Voice Line subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.voiceline.analysis", window = 234, buckets = 14, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
