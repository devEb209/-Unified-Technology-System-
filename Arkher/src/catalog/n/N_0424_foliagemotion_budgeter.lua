-- ARKHER SYSTEM N.0424 :: Foliage Motion Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0424"
	S.key = "arkher.vfx.foliagemotion.spawn_budget"
	S.name = "Foliage Motion Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.foliagemotion.effect_composition" }
	S.tags = { "n", "foliagemotion", "budgeter", "vfx" }
	S.description = "Foliage Motion Spawn Budget: global particle budget shared by every live effect for the Foliage Motion subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.foliagemotion.spawn_budget", total = 135, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
