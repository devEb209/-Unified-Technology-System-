-- ARKHER SYSTEM K.0512 :: Flee Behaviour Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0512"
	S.key = "arkher.npc.fleebehaviour.goal_planner"
	S.name = "Flee Behaviour Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.fleebehaviour.utility_reasoning" }
	S.tags = { "k", "fleebehaviour", "planner", "npc" }
	S.description = "Flee Behaviour Goal Planner: backward GOAP planning to reach a goal state for the Flee Behaviour subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.fleebehaviour.goal_planner", maxDepth = 8 })
		inst.system = S
		inst.ctx = ctx
