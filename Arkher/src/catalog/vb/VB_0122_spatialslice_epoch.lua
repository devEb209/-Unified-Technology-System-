-- ARKHER SYSTEM VB.0122 :: Spatial Slice Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0122"
	S.key = "arkher.conttime.spatialslice.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.spatialslice.infinite_grid" }
	S.tags = { "vb", "spatialslice", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.spatialslice.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
