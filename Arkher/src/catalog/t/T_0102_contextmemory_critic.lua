-- ARKHER SYSTEM T.0102 :: Context Memory Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0102"
	S.key = "arkher.ai.contextmemory.self_critique"
	S.name = "Context Memory Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.contextmemory.plan_workflow" }
	S.tags = { "t", "contextmemory", "critic", "ai" }
	S.description = "Context Memory Self Critique: weighted evaluation of the result against declared criteria for the Context Memory subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.contextmemory.self_critique", passMark = 0.79, reviseMark = 0.44, seed = 80904 })
		inst.system = S
		inst.ctx = ctx
