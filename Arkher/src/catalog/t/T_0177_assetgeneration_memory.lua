-- ARKHER SYSTEM T.0177 :: Asset Generation Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0177"
	S.key = "arkher.ai.assetgeneration.working_memory"
	S.name = "Asset Generation Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.assetgeneration.outcome_prediction" }
	S.tags = { "t", "assetgeneration", "memory", "ai" }
	S.description = "Asset Generation Working Memory: decaying, consolidating recall of what the agent learned for the Asset Generation subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.assetgeneration.working_memory", capacity = 71, decayRate = 0.045, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
