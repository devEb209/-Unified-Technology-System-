-- ARKHER SYSTEM R.0077 :: Transform Replication Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0077"
	S.key = "arkher.net.transformreplication.bandwidth_budget"
	S.name = "Transform Replication Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.transformreplication.transport_graph" }
	S.tags = { "r", "transformreplication", "budgeter", "net" }
	S.description = "Transform Replication Bandwidth Budget: bytes per second shared between competing streams for the Transform Replication subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.transformreplication.bandwidth_budget", total = 344, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
