-- ARKHER SYSTEM J.0287 :: Character LOD Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0287"
	S.key = "arkher.character.characterlod.rig_definition"
	S.name = "Character LOD Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "characterlod", "skeleton", "character" }
	S.description = "Character LOD Rig Definition: character rig definition and bone budget for the Character LOD subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.characterlod.rig_definition" })
		inst.system = S
		inst.ctx = ctx
