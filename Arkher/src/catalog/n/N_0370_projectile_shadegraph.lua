-- ARKHER SYSTEM N.0370 :: Projectile Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0370"
	S.key = "arkher.vfx.projectile.effect_graph"
	S.name = "Projectile Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Projectile"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.projectile.curve_authoring" }
	S.tags = { "n", "projectile", "shadegraph", "vfx" }
	S.description = "Projectile Effect Graph: node graph describing how the effect is shaded for the Projectile subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.projectile.effect_graph" })
		inst.system = S
		inst.ctx = ctx
