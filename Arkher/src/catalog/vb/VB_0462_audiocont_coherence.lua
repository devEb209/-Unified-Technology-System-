-- ARKHER SYSTEM VB.0462 :: Audio Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0462"
	S.key = "arkher.conttime.audiocont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.audiocont.persistent_state" }
	S.tags = { "vb", "audiocont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.audiocont.coherence_guard", window = 70, threshold = 0.10 })
		inst.system = S
		inst.ctx = ctx
