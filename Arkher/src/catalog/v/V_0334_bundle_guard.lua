-- ARKHER SYSTEM V.0334 :: Bundle Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0334"
	S.key = "arkher.asset.bundle.validation_guard"
	S.name = "Bundle Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.bundle.size_budget" }
	S.tags = { "v", "bundle", "guard", "asset" }
	S.description = "Bundle Validation Guard: rate limiting and capability checks on the import path for the Bundle subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.bundle.validation_guard", algorithm = "token", capacity = 195, refillPerSec = 20, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
