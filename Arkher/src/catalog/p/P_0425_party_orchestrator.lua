-- ARKHER SYSTEM P.0425 :: Party State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0425"
	S.key = "arkher.play.party.state_machine"
	S.name = "Party State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Party"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.party.combat_resolution" }
	S.tags = { "p", "party", "orchestrator", "play" }
	S.description = "Party State Machine: the phase machine that drives this gameplay loop for the Party subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.party.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
