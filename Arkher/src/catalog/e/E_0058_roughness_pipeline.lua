-- ARKHER SYSTEM E.0058 :: Roughness Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0058"
	S.key = "arkher.material.roughness.authoring_pipeline"
	S.name = "Roughness Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Roughness"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.roughness.analysis" }
	S.tags = { "e", "roughness", "pipeline", "material" }
	S.description = "Roughness Authoring Pipeline: ordered authoring and bake stages for the Roughness subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.roughness.authoring_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
