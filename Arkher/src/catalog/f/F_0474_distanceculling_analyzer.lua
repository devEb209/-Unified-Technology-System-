-- ARKHER SYSTEM F.0474 :: Distance Culling Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0474"
	S.key = "arkher.render.distanceculling.frame_analysis"
	S.name = "Distance Culling Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.distanceculling.pass_cache" }
	S.tags = { "f", "distanceculling", "analyzer", "render" }
	S.description = "Distance Culling Frame Analysis: per-pass cost analysis and outlier detection for the Distance Culling subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.distanceculling.frame_analysis", window = 172, buckets = 16, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
