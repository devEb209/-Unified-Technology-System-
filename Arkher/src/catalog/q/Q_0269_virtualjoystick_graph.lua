-- ARKHER SYSTEM Q.0269 :: Virtual Joystick Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0269"
	S.key = "arkher.ui.virtualjoystick.navigation_graph"
	S.name = "Virtual Joystick Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.virtualjoystick.transition" }
	S.tags = { "q", "virtualjoystick", "graph", "ui" }
	S.description = "Virtual Joystick Navigation Graph: screens, routes and shortest path between them for the Virtual Joystick subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.virtualjoystick.navigation_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
