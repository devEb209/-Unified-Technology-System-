-- ARKHER SYSTEM T.0270 :: Level Design Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0270"
	S.key = "arkher.ai.leveldesign.self_critique"
	S.name = "Level Design Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.leveldesign.plan_workflow" }
	S.tags = { "t", "leveldesign", "critic", "ai" }
	S.description = "Level Design Self Critique: weighted evaluation of the result against declared criteria for the Level Design subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.leveldesign.self_critique", passMark = 0.72, reviseMark = 0.42, seed = 67082 })
		inst.system = S
		inst.ctx = ctx
