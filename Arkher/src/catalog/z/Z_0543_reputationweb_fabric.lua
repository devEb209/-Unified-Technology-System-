-- ARKHER SYSTEM Z.0543 :: Reputation Web Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0543"
	S.key = "arkher.origin.reputationweb.simulation_fabric"
	S.name = "Reputation Web Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.complexity_governance" }
	S.tags = { "z", "reputationweb", "fabric", "origin" }
	S.description = "Reputation Web Simulation Fabric: every simulation domain stepped under one budgeted clock for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.reputationweb.simulation_fabric", budgetMs = 4.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
