-- ARKHER SYSTEM N.0219 :: Lightning Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0219"
	S.key = "arkher.vfx.lightning.spatial_index"
	S.name = "Lightning Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Lightning"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.lightning.quality_policy" }
	S.tags = { "n", "lightning", "index", "vfx" }
	S.description = "Lightning Spatial Index: spatial acceleration of effect queries and culling for the Lightning subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.lightning.spatial_index", mode = "hash", cellSize = 56 })
		inst.system = S
		inst.ctx = ctx
