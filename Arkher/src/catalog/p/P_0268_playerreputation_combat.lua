-- ARKHER SYSTEM P.0268 :: Reputation Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0268"
	S.key = "arkher.play.playerreputation.combat_resolution"
	S.name = "Reputation Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Reputation"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playerreputation.objectives" }
	S.tags = { "p", "playerreputation", "combat", "play" }
	S.description = "Reputation Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Reputation subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.playerreputation.combat_resolution", seed = 90130, armourK = 100, critMultiplier = 2.50 })
		inst.system = S
		inst.ctx = ctx
