-- ARKHER SYSTEM M.0365 :: Maze Grammar
...
return function(A)
	...
	local S = {}
	S.id = "M.0365"
	S.key = "arkher.proc.maze.grammar"
	S.name = "Maze Grammar"
	S.category = "M"
	S.family = "PROCEDURAL"
	S.area = "Maze"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "m", "maze", "lsystem", "proc" }
	S.description = "Maze Grammar: rewriting grammar interpreted into geometry for the Maze subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lsystem", { id = "arkher.proc.maze.grammar", axiom = "F", angle = 33, step = 6.0 })
		inst.system = S
		inst.ctx = ctx
