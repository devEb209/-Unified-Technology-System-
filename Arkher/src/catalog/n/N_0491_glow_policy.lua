-- ARKHER SYSTEM N.0491 :: Glow Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0491"
	S.key = "arkher.vfx.glow.quality_policy"
	S.name = "Glow Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Glow"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.glow.result_cache" }
	S.tags = { "n", "glow", "policy", "vfx" }
	S.description = "Glow Quality Policy: distance and device driven fidelity bands for the Glow subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.glow.quality_policy", algorithm = "edf", starvationGuard = 25 })
		inst.system = S
		inst.ctx = ctx
