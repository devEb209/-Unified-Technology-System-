-- ARKHER SYSTEM N.0343 :: Beam Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0343"
	S.key = "arkher.vfx.beam.curve_authoring"
	S.name = "Beam Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Beam"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.beam.ribbon_and_trail" }
	S.tags = { "n", "beam", "spline", "vfx" }
	S.description = "Beam Curve Authoring: authored curves driving the effect over its life for the Beam subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.beam.curve_authoring", tension = 0.53, closed = false })
		inst.system = S
		inst.ctx = ctx
