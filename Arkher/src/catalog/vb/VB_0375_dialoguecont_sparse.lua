-- ARKHER SYSTEM VB.0375 :: Dialogue Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0375"
	S.key = "arkher.conttime.dialoguecont.sparse_residency"
	S.name = "Dialogue Continuum Sparse Residency"
	S.category = "VB"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.dialoguecont.epoch_clock" }
	S.tags = { "vb", "dialoguecont", "sparse", "conttime" }
	S.description = "Dialogue Continuum Sparse Residency: sparse page residency with eviction and compression for the Dialogue Continuum subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.dialoguecont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
