-- ARKHER SYSTEM K.0352 :: Behaviour State Machine Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0352"
	S.key = "arkher.npc.behaviourstate.memory"
	S.name = "Behaviour State Machine Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourstate.mind_network" }
	S.tags = { "k", "behaviourstate", "memory", "npc" }
	S.description = "Behaviour State Machine Memory: episodic memory with decay, recall and consolidation for the Behaviour State Machine subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.behaviourstate.memory", capacity = 55, decayRate = 0.045, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
