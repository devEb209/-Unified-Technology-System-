-- ARKHER SYSTEM V.0152 :: UI Sprite Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0152"
	S.key = "arkher.asset.uisprite.compression_codec"
	S.name = "UI Sprite Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.uisprite.streaming_residency" }
	S.tags = { "v", "uisprite", "codec", "asset" }
	S.description = "UI Sprite Compression Codec: compact encoding, diffing and checksum of asset payloads for the UI Sprite subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.uisprite.compression_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
