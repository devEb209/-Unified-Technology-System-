--!strict
-- OSM ODbL — ANIMATION Node_Flow #0011
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="OSM ODbL — ANIMATION Node_Flow #0011", size=Vector2.new(680, 440), pos=UDim2.fromOffset(243, 267), parent=parent, icon="◈"})
