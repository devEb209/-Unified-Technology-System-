-- ARKHER SYSTEM VC.0432 :: Navigation Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0432"
	S.key = "arkher.contneural.navcont.emergence_continuum"
	S.name = "Navigation Continuum Emergence Continuum"
	S.category = "VC"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.navcont.reality_continuum" }
	S.tags = { "vc", "navcont", "emergence", "contneural" }
	S.description = "Navigation Continuum Emergence Continuum: emergence detection over the continuum for the Navigation Continuum subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.navcont.emergence_continuum", windowSize = 7, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
