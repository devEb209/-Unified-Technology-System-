-- ARKHER SYSTEM K.0001 :: NPC Brain Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0001"
	S.key = "arkher.npc.npcbrain.mind_network"
	S.name = "NPC Brain Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "npcbrain", "mindnet", "npc" }
	S.description = "NPC Brain Mind Network: the learned policy that turns perception into a decision for the NPC Brain subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.npcbrain.mind_network", inputs = 6, hidden = 4, seed = 34140, learningRate = 0.050, exploration = 0.040 })
		inst.system = S
		inst.ctx = ctx
