-- ARKHER SYSTEM P.0474 :: Gameplay Debug Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0474"
	S.key = "arkher.play.gameplaydebug.rule_pipeline"
	S.name = "Gameplay Debug Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.gameplaydebug.state_machine" }
	S.tags = { "p", "gameplaydebug", "pipeline", "play" }
	S.description = "Gameplay Debug Rule Pipeline: ordered rules applied to every gameplay event for the Gameplay Debug subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.gameplaydebug.rule_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
