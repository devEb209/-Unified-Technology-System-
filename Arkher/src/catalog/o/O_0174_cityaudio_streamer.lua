-- ARKHER SYSTEM O.0174 :: City Audio Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0174"
	S.key = "arkher.audio.cityaudio.streaming"
	S.name = "City Audio Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "City Audio"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.cityaudio.voice_budget" }
	S.tags = { "o", "cityaudio", "streamer", "audio" }
	S.description = "City Audio Streaming: distance-driven residency of audio assets for the City Audio subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.cityaudio.streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
