-- ARKHER SYSTEM L.0526 :: Disease Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0526"
	S.key = "arkher.sim.disease.simulation_core"
	S.name = "Disease Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "disease", "simulation", "sim" }
	S.description = "Disease Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Disease subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.disease.simulation_core", fullRadius = 160, reducedRadius = 900, budget = 51 })
		inst.system = S
		inst.ctx = ctx
