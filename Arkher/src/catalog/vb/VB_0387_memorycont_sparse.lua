-- ARKHER SYSTEM VB.0387 :: Memory Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0387"
	S.key = "arkher.conttime.memorycont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memorycont.epoch_clock" }
	S.tags = { "vb", "memorycont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.memorycont.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
