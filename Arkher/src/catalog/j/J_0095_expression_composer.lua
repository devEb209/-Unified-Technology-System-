-- ARKHER SYSTEM J.0095 :: Expression Set Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0095"
	S.key = "arkher.character.expression.appearance_composer"
	S.name = "Expression Set Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.expression.locomotion" }
	S.tags = { "j", "expression", "composer", "character" }
	S.description = "Expression Set Appearance Composer: composition of appearance slots into a look for the Expression Set subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.expression.appearance_composer", mode = "max" })
		inst.system = S
		inst.ctx = ctx
