-- ARKHER SYSTEM Z.0406 :: Battery Aware Pipeline Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0406"
	S.key = "arkher.origin.batteryaware.emergence_detection"
	S.name = "Battery Aware Pipeline Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.batteryaware.world_memory" }
	S.tags = { "z", "batteryaware", "emergence", "origin" }
	S.description = "Battery Aware Pipeline Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Battery Aware Pipeline subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.batteryaware.emergence_detection", windowSize = 7, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
