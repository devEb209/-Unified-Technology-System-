-- ARKHER SYSTEM P.0418 :: Team Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0418"
	S.key = "arkher.play.team.content_registry"
	S.name = "Team Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Team"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.team.difficulty_controller" }
	S.tags = { "p", "team", "registry", "play" }
	S.description = "Team Content Registry: catalogue of the definitions this loop instantiates for the Team subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.team.content_registry" })
		inst.system = S
		inst.ctx = ctx
