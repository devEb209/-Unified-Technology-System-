-- ARKHER SYSTEM K.0631 :: Gossip Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0631"
	S.key = "arkher.npc.gossip.mind_network"
	S.name = "Gossip Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "gossip", "mindnet", "npc" }
	S.description = "Gossip Mind Network: the learned policy that turns perception into a decision for the Gossip subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.gossip.mind_network", inputs = 7, hidden = 7, seed = 34853, learningRate = 0.065, exploration = 0.045 })
		inst.system = S
		inst.ctx = ctx
