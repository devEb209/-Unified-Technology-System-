-- ARKHER SYSTEM Z.0590 :: Self Healing Systems Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0590"
	S.key = "arkher.origin.selfhealing.self_critique"
	S.name = "Self Healing Systems Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfhealing.intent_bridge" }
	S.tags = { "z", "selfhealing", "critic", "origin" }
	S.description = "Self Healing Systems Self Critique: weighted judgement of the technology's own output for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.selfhealing.self_critique", passMark = 0.75, reviseMark = 0.40, seed = 73010 })
		inst.system = S
		inst.ctx = ctx
