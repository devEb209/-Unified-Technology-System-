-- ARKHER SYSTEM I.0025 :: Bone Hierarchy Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0025"
	S.key = "arkher.anim.bonehierarchy.analysis"
	S.name = "Bone Hierarchy Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonehierarchy.quality_policy" }
	S.tags = { "i", "bonehierarchy", "analyzer", "anim" }
	S.description = "Bone Hierarchy Analysis: pop, drift and cost analysis of playback for the Bone Hierarchy subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.bonehierarchy.analysis", window = 147, buckets = 15, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
