-- ARKHER SYSTEM K.0558 :: Trade Behaviour Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0558"
	S.key = "arkher.npc.tradebehaviour.daily_schedule"
	S.name = "Trade Behaviour Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.tradebehaviour.social_relations" }
	S.tags = { "k", "tradebehaviour", "schedule", "npc" }
	S.description = "Trade Behaviour Daily Schedule: hour-by-hour routine with priority interruptions for the Trade Behaviour subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.tradebehaviour.daily_schedule", startHour = 6 })
		inst.system = S
		inst.ctx = ctx
