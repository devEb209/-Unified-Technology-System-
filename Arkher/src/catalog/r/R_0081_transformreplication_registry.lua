-- ARKHER SYSTEM R.0081 :: Transform Replication Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0081"
	S.key = "arkher.net.transformreplication.session_registry"
	S.name = "Transform Replication Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.transformreplication.rate_guard" }
	S.tags = { "r", "transformreplication", "registry", "net" }
	S.description = "Transform Replication Session Registry: catalogue of sessions, players and their metadata for the Transform Replication subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.transformreplication.session_registry" })
		inst.system = S
		inst.ctx = ctx
