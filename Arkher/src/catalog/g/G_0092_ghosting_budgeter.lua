-- ARKHER SYSTEM G.0092 :: Ghosting Suppression Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0092"
	S.key = "arkher.neural.ghosting.compute_budget"
	S.name = "Ghosting Suppression Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ghosting.quality_predictor" }
	S.tags = { "g", "ghosting", "budgeter", "neural" }
	S.description = "Ghosting Suppression Compute Budget: inference time budget allocation for the Ghosting Suppression subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.ghosting.compute_budget", total = 292, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
