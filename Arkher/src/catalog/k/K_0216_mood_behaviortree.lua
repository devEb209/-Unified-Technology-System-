-- ARKHER SYSTEM K.0216 :: Mood Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0216"
	S.key = "arkher.npc.mood.reactive_behaviour"
	S.name = "Mood Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.mood.perception" }
	S.tags = { "k", "mood", "behaviortree", "npc" }
	S.description = "Mood Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Mood subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.mood.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
