-- ARKHER SYSTEM H.0005 :: Rigid Body Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0005"
	S.key = "arkher.physics.rigidbody.query"
	S.name = "Rigid Body Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Rigid Body"
	S.aspect = "Query"
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rigidbody.constraint_solver" }
	S.tags = { "h", "rigidbody", "raycaster", "physics" }
	S.description = "Rigid Body Query: rays, sweeps and overlaps against the simulation for the Rigid Body subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.rigidbody.query", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
