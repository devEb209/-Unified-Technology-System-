-- ARKHER SYSTEM O.0162 :: Forest Audio Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0162"
	S.key = "arkher.audio.forestaudio.streaming"
	S.name = "Forest Audio Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Forest Audio"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.forestaudio.voice_budget" }
	S.tags = { "o", "forestaudio", "streamer", "audio" }
	S.description = "Forest Audio Streaming: distance-driven residency of audio assets for the Forest Audio subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.forestaudio.streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
