-- ARKHER SYSTEM Z.0321 :: Cross Reality Sync Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0321"
	S.key = "arkher.origin.crossreality.reality_layering"
	S.name = "Cross Reality Sync Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "crossreality", "reality", "origin" }
	S.description = "Cross Reality Sync Reality Layering: stacked authored, simulated, proposed and player realities for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.crossreality.reality_layering" })
		inst.system = S
		inst.ctx = ctx
