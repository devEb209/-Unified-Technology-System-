-- ARKHER SYSTEM T.0459 :: Behaviour Learning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0459"
	S.key = "arkher.ai.behaviourlearning.action_planner"
	S.name = "Behaviour Learning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.behaviourlearning.utility_selection" }
	S.tags = { "t", "behaviourlearning", "planner", "ai" }
	S.description = "Behaviour Learning Action Planner: goal-oriented action planning over preconditions for the Behaviour Learning subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.behaviourlearning.action_planner", maxDepth = 10 })
		inst.system = S
		inst.ctx = ctx
