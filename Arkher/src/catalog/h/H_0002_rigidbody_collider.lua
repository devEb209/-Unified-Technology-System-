-- ARKHER SYSTEM H.0002 :: Rigid Body Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0002"
	S.key = "arkher.physics.rigidbody.collision_shape"
	S.name = "Rigid Body Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Rigid Body"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rigidbody.body_dynamics" }
	S.tags = { "h", "rigidbody", "collider", "physics" }
	S.description = "Rigid Body Collision Shape: shape bounds, support mapping and closest points for the Rigid Body subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.rigidbody.collision_shape", shape = "box", radius = 1.10, height = 1.90, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
