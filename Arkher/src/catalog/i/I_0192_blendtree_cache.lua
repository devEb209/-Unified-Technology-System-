-- ARKHER SYSTEM I.0192 :: Blend Tree Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0192"
	S.key = "arkher.anim.blendtree.pose_cache"
	S.name = "Blend Tree Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Blend Tree"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.blendtree.playback_pipeline" }
	S.tags = { "i", "blendtree", "cache", "anim" }
	S.description = "Blend Tree Pose Cache: reuse of sampled poses across frames and instances for the Blend Tree subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.blendtree.pose_cache", policy = "lru", capacity = 291, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
