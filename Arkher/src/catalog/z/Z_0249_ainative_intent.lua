-- ARKHER SYSTEM Z.0249 :: AI Native Engine Architecture Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0249"
	S.key = "arkher.origin.ainative.intent_bridge"
	S.name = "AI Native Engine Architecture Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.ainative.semantic_graph" }
	S.tags = { "z", "ainative", "intent", "origin" }
	S.description = "AI Native Engine Architecture Intent Bridge: natural language control surface for the technology for the AI Native Engine Architecture subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.ainative.intent_bridge", minConfidence = 0.31 })
		inst.system = S
		inst.ctx = ctx
