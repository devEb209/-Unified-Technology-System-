-- ARKHER SYSTEM O.0201 :: Reverb Zone Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0201"
	S.key = "arkher.audio.reverbzone.playback_policy"
	S.name = "Reverb Zone Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Reverb Zone"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.reverbzone.compression_codec" }
	S.tags = { "o", "reverbzone", "policy", "audio" }
	S.description = "Reverb Zone Playback Policy: rules choosing what may be heard right now for the Reverb Zone subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.reverbzone.playback_policy", algorithm = "lottery", starvationGuard = 59 })
		inst.system = S
		inst.ctx = ctx
