-- ARKHER SYSTEM L.0340 :: Market Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0340"
	S.key = "arkher.sim.market.streaming"
	S.name = "Market Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.market.state_codec" }
	S.tags = { "l", "market", "streamer", "sim" }
	S.description = "Market Streaming: distance-driven residency of simulated regions for the Market subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.market.streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
