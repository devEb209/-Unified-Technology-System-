-- ARKHER SYSTEM F.0473 :: Distance Culling Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0473"
	S.key = "arkher.render.distanceculling.pass_cache"
	S.name = "Distance Culling Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.distanceculling.render_policy" }
	S.tags = { "f", "distanceculling", "cache", "render" }
	S.description = "Distance Culling Pass Cache: reuse of pass results across frames for the Distance Culling subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.distanceculling.pass_cache", policy = "ttl", capacity = 124, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
