-- ARKHER SYSTEM I.0231 :: Root Motion Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0231"
	S.key = "arkher.anim.rootmotion.pose_cache"
	S.name = "Root Motion Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Root Motion"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.rootmotion.playback_pipeline" }
	S.tags = { "i", "rootmotion", "cache", "anim" }
	S.description = "Root Motion Pose Cache: reuse of sampled poses across frames and instances for the Root Motion subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.rootmotion.pose_cache", policy = "lfu", capacity = 266, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
