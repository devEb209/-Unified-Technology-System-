-- ARKHER SYSTEM VD.0019 :: Region Tile Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0019"
	S.key = "arkher.contsim.regiontile.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.regiontile.coherence_guard" }
	S.tags = { "vd", "regiontile", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.regiontile.neural_field", dims = 12, hidden = 8, seed = 78744 })
		inst.system = S
		inst.ctx = ctx
