-- ARKHER SYSTEM P.0303 :: Ranged Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0303"
	S.key = "arkher.play.ranged.objectives"
	S.name = "Ranged Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ranged"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ranged.inventory" }
	S.tags = { "p", "ranged", "quest", "play" }
	S.description = "Ranged Objectives: objectives, prerequisites, progress and rewards for the Ranged subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.ranged.objectives" })
		inst.system = S
		inst.ctx = ctx
