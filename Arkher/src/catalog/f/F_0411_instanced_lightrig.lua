-- ARKHER SYSTEM F.0411 :: Instanced Draw Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0411"
	S.key = "arkher.render.instanced.lighting_rig"
	S.name = "Instanced Draw Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.instanced.geometry_virtualization" }
	S.tags = { "f", "instanced", "lightrig", "render" }
	S.description = "Instanced Draw Lighting Rig: light clustering, importance and cascades for the Instanced Draw subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.instanced.lighting_rig", maxActive = 4 })
		inst.system = S
		inst.ctx = ctx
