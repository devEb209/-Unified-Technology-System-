-- ARKHER SYSTEM I.0484 :: Morph Target Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0484"
	S.key = "arkher.anim.morphtarget.layered_blending"
	S.name = "Morph Target Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Morph Target"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.morphtarget.clip_sampling" }
	S.tags = { "i", "morphtarget", "animator", "anim" }
	S.description = "Morph Target Layered Blending: layers, crossfades, masks and blend trees for the Morph Target subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.morphtarget.layered_blending", budget = 15 })
		inst.system = S
		inst.ctx = ctx
