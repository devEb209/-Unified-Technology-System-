-- ARKHER SYSTEM R.0177 :: Interpolation Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0177"
	S.key = "arkher.net.interpolation.session_registry"
	S.name = "Interpolation Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.interpolation.rate_guard" }
	S.tags = { "r", "interpolation", "registry", "net" }
	S.description = "Interpolation Session Registry: catalogue of sessions, players and their metadata for the Interpolation subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.interpolation.session_registry" })
		inst.system = S
		inst.ctx = ctx
