-- ARKHER SYSTEM VC.0522 :: Asset Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0522"
	S.key = "arkher.contneural.assetcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.assetcont.persistent_state" }
	S.tags = { "vc", "assetcont", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.assetcont.coherence_guard", window = 75, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
