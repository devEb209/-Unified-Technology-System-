-- ARKHER SYSTEM P.0106 :: Inventory Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0106"
	S.key = "arkher.play.inventorysys.content_registry"
	S.name = "Inventory Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Inventory"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.inventorysys.difficulty_controller" }
	S.tags = { "p", "inventorysys", "registry", "play" }
	S.description = "Inventory Content Registry: catalogue of the definitions this loop instantiates for the Inventory subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.inventorysys.content_registry" })
		inst.system = S
		inst.ctx = ctx
