-- ARKHER SYSTEM V.0304 :: Mip Chain Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0304"
	S.key = "arkher.asset.mipchain.asset_registry"
	S.name = "Mip Chain Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.mipchain.cook_pipeline" }
	S.tags = { "v", "mipchain", "registry", "asset" }
	S.description = "Mip Chain Asset Registry: catalogue of every asset, its tags and its metadata for the Mip Chain subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.mipchain.asset_registry" })
		inst.system = S
		inst.ctx = ctx
