-- ARKHER SYSTEM F.0541 :: Decal Rendering Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0541"
	S.key = "arkher.render.decalrender.draw_budget"
	S.name = "Decal Rendering Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.decalrender.adaptive_resolution" }
	S.tags = { "f", "decalrender", "budgeter", "render" }
	S.description = "Decal Rendering Draw Budget: draw call and triangle budget allocation for the Decal Rendering subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.decalrender.draw_budget", total = 129, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
