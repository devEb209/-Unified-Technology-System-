-- ARKHER SYSTEM Z.0111 :: Universal Simulation Fabric Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0111"
	S.key = "arkher.origin.simfabric.adaptive_workflow"
	S.name = "Universal Simulation Fabric Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.simfabric.self_critique" }
	S.tags = { "z", "simfabric", "workflow", "origin" }
	S.description = "Universal Simulation Fabric Adaptive Workflow: verified, retryable, reversible execution plans for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.simfabric.adaptive_workflow", maxRetries = 2, budget = 80 })
		inst.system = S
		inst.ctx = ctx
