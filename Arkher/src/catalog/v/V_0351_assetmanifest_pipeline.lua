-- ARKHER SYSTEM V.0351 :: Manifest Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0351"
	S.key = "arkher.asset.assetmanifest.cook_pipeline"
	S.name = "Manifest Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetmanifest.bundling" }
	S.tags = { "v", "assetmanifest", "pipeline", "asset" }
	S.description = "Manifest Cook Pipeline: staged cooking with isolation and retries for the Manifest subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.assetmanifest.cook_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
