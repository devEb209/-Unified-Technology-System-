-- ARKHER SYSTEM T.0339 :: Test Authoring Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0339"
	S.key = "arkher.ai.testauthoring.plan_workflow"
	S.name = "Test Authoring Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.testauthoring.semantic_knowledge" }
	S.tags = { "t", "testauthoring", "workflow", "ai" }
	S.description = "Test Authoring Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Test Authoring subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.testauthoring.plan_workflow", maxRetries = 3, budget = 150 })
		inst.system = S
		inst.ctx = ctx
