-- ARKHER SYSTEM Z.1032 :: Autonomous Balancing Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.1032"
	S.key = "arkher.origin.autobalancing.predictive_optimization"
	S.name = "Autonomous Balancing Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autobalancing.adaptive_workflow" }
	S.tags = { "z", "autobalancing", "predictor", "origin" }
	S.description = "Autonomous Balancing Predictive Optimization: forecast-driven optimization before the cost is paid for the Autonomous Balancing subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.autobalancing.predictive_optimization", method = "ema", alpha = 0.49, window = 119 })
		inst.system = S
		inst.ctx = ctx
