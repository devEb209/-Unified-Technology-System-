-- ARKHER SYSTEM L.0595 :: World Persistence Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0595"
	S.key = "arkher.sim.worldpersistence.streaming"
	S.name = "World Persistence Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldpersistence.state_codec" }
	S.tags = { "l", "worldpersistence", "streamer", "sim" }
	S.description = "World Persistence Streaming: distance-driven residency of simulated regions for the World Persistence subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.worldpersistence.streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
