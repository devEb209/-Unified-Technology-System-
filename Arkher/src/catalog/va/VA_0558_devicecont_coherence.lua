-- ARKHER SYSTEM VA.0558 :: Device Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0558"
	S.key = "arkher.contworld.devicecont.coherence_guard"
	S.name = "Device Continuum Coherence Guard"
	S.category = "VA"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.devicecont.persistent_state" }
	S.tags = { "va", "devicecont", "coherence", "contworld" }
	S.description = "Device Continuum Coherence Guard: seam coherence and drift supervision for the Device Continuum subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.devicecont.coherence_guard", window = 62, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
