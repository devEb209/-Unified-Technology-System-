-- ARKHER SYSTEM Z.0192 :: World Memory Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0192"
	S.key = "arkher.origin.worldmemorytech.predictive_optimization"
	S.name = "World Memory Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldmemorytech.adaptive_workflow" }
	S.tags = { "z", "worldmemorytech", "predictor", "origin" }
	S.description = "World Memory Predictive Optimization: forecast-driven optimization before the cost is paid for the World Memory subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.worldmemorytech.predictive_optimization", method = "linear", alpha = 0.32, window = 78 })
		inst.system = S
		inst.ctx = ctx
