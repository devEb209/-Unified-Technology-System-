-- ARKHER SYSTEM O.0413 :: Audio Debug Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0413"
	S.key = "arkher.audio.audiodebug.voice_budget"
	S.name = "Audio Debug Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Audio Debug"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiodebug.music_sequencer" }
	S.tags = { "o", "audiodebug", "budgeter", "audio" }
	S.description = "Audio Debug Voice Budget: voice slots allocated by priority and audibility for the Audio Debug subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.audiodebug.voice_budget", total = 325, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
