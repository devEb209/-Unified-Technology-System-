-- ARKHER SYSTEM VA.0260 :: Road Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0260"
	S.key = "arkher.contworld.roadcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.roadcont.neural_field" }
	S.tags = { "va", "roadcont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.roadcont.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
