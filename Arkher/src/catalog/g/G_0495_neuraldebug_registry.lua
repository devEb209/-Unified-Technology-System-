-- ARKHER SYSTEM G.0495 :: Neural Debug Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0495"
	S.key = "arkher.neural.neuraldebug.model_registry"
	S.name = "Neural Debug Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuraldebug.reconstruction" }
	S.tags = { "g", "neuraldebug", "registry", "neural" }
	S.description = "Neural Debug Model Registry: named models and their lifecycle for the Neural Debug subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.neuraldebug.model_registry" })
		inst.system = S
		inst.ctx = ctx
