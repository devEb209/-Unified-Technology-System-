-- ARKHER SYSTEM I.0246 :: Locomotion Blend Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0246"
	S.key = "arkher.anim.locomotionblend.analysis"
	S.name = "Locomotion Blend Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.locomotionblend.quality_policy" }
	S.tags = { "i", "locomotionblend", "analyzer", "anim" }
	S.description = "Locomotion Blend Analysis: pop, drift and cost analysis of playback for the Locomotion Blend subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.locomotionblend.analysis", window = 197, buckets = 9, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
