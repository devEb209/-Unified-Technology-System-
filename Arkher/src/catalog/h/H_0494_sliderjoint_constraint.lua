-- ARKHER SYSTEM H.0494 :: Slider Joint Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0494"
	S.key = "arkher.physics.sliderjoint.constraint_solver"
	S.name = "Slider Joint Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Slider Joint"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sliderjoint.contact_generation" }
	S.tags = { "h", "sliderjoint", "constraint", "physics" }
	S.description = "Slider Joint Constraint Solver: sequential impulses, friction, joints and warm starting for the Slider Joint subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.sliderjoint.constraint_solver", iterations = 12, baumgarte = 0.28, warmStart = true })
		inst.system = S
		inst.ctx = ctx
