...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Gaea Nodes — CORE Profiler #0044", size=Vector2.new(680, 500), pos=UDim2.fromOffset(272, 308), parent=parent, icon="◈"})
