-- ARKHER SYSTEM H.0665 :: Raycast Query Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0665"
	S.key = "arkher.physics.raycast.vehicle"
	S.name = "Raycast Query Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.raycast.character_motion" }
	S.tags = { "h", "raycast", "vehicle", "physics" }
	S.description = "Raycast Query Vehicle: suspension, drivetrain, steering and tire friction for the Raycast Query subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.raycast.vehicle", mass = 1500, wheelbase = 3.20, track = 1.60, maxRpm = 6600 })
		inst.system = S
		inst.ctx = ctx
