-- ARKHER SYSTEM H.0045 :: Mass Properties Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0045"
	S.key = "arkher.physics.massproperties.contact_generation"
	S.name = "Mass Properties Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.massproperties.collision_shape" }
	S.tags = { "h", "massproperties", "contact", "physics" }
	S.description = "Mass Properties Contact Generation: narrow-phase manifolds with normal, depth and point for the Mass Properties subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.massproperties.contact_generation", slop = 0.0080, maxManifolds = 442 })
		inst.system = S
		inst.ctx = ctx
