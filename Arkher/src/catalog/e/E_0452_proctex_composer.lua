-- ARKHER SYSTEM E.0452 :: Procedural Texture Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0452"
	S.key = "arkher.material.proctex.layer_composition"
	S.name = "Procedural Texture Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.proctex.definition" }
	S.tags = { "e", "proctex", "composer", "material" }
	S.description = "Procedural Texture Layer Composition: ordered layer composition with blend rules for the Procedural Texture subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.proctex.layer_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
