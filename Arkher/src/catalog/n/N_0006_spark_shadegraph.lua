-- ARKHER SYSTEM N.0006 :: Spark Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0006"
	S.key = "arkher.vfx.spark.effect_graph"
	S.name = "Spark Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spark"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spark.curve_authoring" }
	S.tags = { "n", "spark", "shadegraph", "vfx" }
	S.description = "Spark Effect Graph: node graph describing how the effect is shaded for the Spark subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.spark.effect_graph" })
		inst.system = S
		inst.ctx = ctx
