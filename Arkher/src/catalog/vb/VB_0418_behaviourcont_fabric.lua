-- ARKHER SYSTEM VB.0418 :: Behaviour Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0418"
	S.key = "arkher.conttime.behaviourcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.behaviourcont.complexity_budget" }
	S.tags = { "vb", "behaviourcont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.behaviourcont.simulation_fabric", budgetMs = 4.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
