-- ARKHER SYSTEM E.0133 :: Emissive Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0133"
	S.key = "arkher.material.emissive.authoring_pipeline"
	S.name = "Emissive Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Emissive"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.emissive.analysis" }
	S.tags = { "e", "emissive", "pipeline", "material" }
	S.description = "Emissive Authoring Pipeline: ordered authoring and bake stages for the Emissive subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.emissive.authoring_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
