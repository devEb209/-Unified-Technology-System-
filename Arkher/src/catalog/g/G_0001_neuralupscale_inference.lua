-- ARKHER SYSTEM G.0001 :: Neural Upscaling Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0001"
	S.key = "arkher.neural.neuralupscale.inference_core"
	S.name = "Neural Upscaling Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "neuralupscale", "inference", "neural" }
	S.description = "Neural Upscaling Inference Core: dense network forward pass and training for the Neural Upscaling subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.neuralupscale.inference_core", seed = 85326 })
		inst.system = S
		inst.ctx = ctx
