-- ARKHER SYSTEM I.0253 :: Turn In Place Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0253"
	S.key = "arkher.anim.turninplace.retarget_graph"
	S.name = "Turn In Place Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.turninplace.physical_blend" }
	S.tags = { "i", "turninplace", "graph", "anim" }
	S.description = "Turn In Place Retarget Graph: bone mapping and retarget path resolution for the Turn In Place subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.turninplace.retarget_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
