-- ARKHER SYSTEM Z.0818 :: Perceptual Budgeting Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0818"
	S.key = "arkher.origin.perceptualbudget.budget_governor"
	S.name = "Perceptual Budgeting Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.perceptualbudget.behaviour_analysis" }
	S.tags = { "z", "perceptualbudget", "budgeter", "origin" }
	S.description = "Perceptual Budgeting Budget Governor: allocation of a scarce resource across the technology's consumers for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.perceptualbudget.budget_governor", total = 236, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
