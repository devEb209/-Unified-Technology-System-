-- ARKHER SYSTEM VA.0105 :: Memory Shard Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0105"
	S.key = "arkher.contworld.memoryshard.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memoryshard.world_memory_stream" }
	S.tags = { "va", "memoryshard", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.memoryshard.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
