-- ARKHER SYSTEM L.0449 :: Crime Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0449"
	S.key = "arkher.sim.crime.forecast"
	S.name = "Crime Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.crime.analysis" }
	S.tags = { "l", "crime", "predictor", "sim" }
	S.description = "Crime Forecast: prediction of the region's next state for the Crime subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.crime.forecast", method = "markov", alpha = 0.16, window = 46 })
		inst.system = S
		inst.ctx = ctx
