-- ARKHER SYSTEM L.0479 :: Faction Politics Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0479"
	S.key = "arkher.sim.factionpolitics.forecast"
	S.name = "Faction Politics Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.factionpolitics.analysis" }
	S.tags = { "l", "factionpolitics", "predictor", "sim" }
	S.description = "Faction Politics Forecast: prediction of the region's next state for the Faction Politics subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.factionpolitics.forecast", method = "ema", alpha = 0.28, window = 122 })
		inst.system = S
		inst.ctx = ctx
