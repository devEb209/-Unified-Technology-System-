-- ARKHER SYSTEM Z.0757 :: World Compression Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0757"
	S.key = "arkher.origin.worldcompression.behaviour_analysis"
	S.name = "World Compression Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.governance_policy" }
	S.tags = { "z", "worldcompression", "analyzer", "origin" }
	S.description = "World Compression Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the World Compression subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.worldcompression.behaviour_analysis", window = 230, buckets = 18, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
