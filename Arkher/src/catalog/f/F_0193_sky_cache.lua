-- ARKHER SYSTEM F.0193 :: Sky Model Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0193"
	S.key = "arkher.render.sky.pass_cache"
	S.name = "Sky Model Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sky Model"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sky.render_policy" }
	S.tags = { "f", "sky", "cache", "render" }
	S.description = "Sky Model Pass Cache: reuse of pass results across frames for the Sky Model subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.sky.pass_cache", policy = "lfu", capacity = 465, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
