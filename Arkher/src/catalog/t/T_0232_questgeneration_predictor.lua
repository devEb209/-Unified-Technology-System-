-- ARKHER SYSTEM T.0232 :: Quest Generation Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0232"
	S.key = "arkher.ai.questgeneration.outcome_prediction"
	S.name = "Quest Generation Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.questgeneration.decision_policy" }
	S.tags = { "t", "questgeneration", "predictor", "ai" }
	S.description = "Quest Generation Outcome Prediction: forecasting the result before the work is done for the Quest Generation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.questgeneration.outcome_prediction", method = "ema", alpha = 0.32, window = 86 })
		inst.system = S
		inst.ctx = ctx
