-- ARKHER SYSTEM O.0010 :: Footstep Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0010"
	S.key = "arkher.audio.footstep.analysis"
	S.name = "Footstep Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Footstep"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.footstep.playback_policy" }
	S.tags = { "o", "footstep", "analyzer", "audio" }
	S.description = "Footstep Analysis: loudness, headroom and masking analysis for the Footstep subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.footstep.analysis", window = 54, buckets = 10, threshold = 4.60 })
		inst.system = S
		inst.ctx = ctx
