-- ARKHER SYSTEM T.0198 :: City Generation Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0198"
	S.key = "arkher.ai.citygeneration.semantic_knowledge"
	S.name = "City Generation Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.citygeneration.intent_understanding" }
	S.tags = { "t", "citygeneration", "knowledge", "ai" }
	S.description = "City Generation Semantic Knowledge: typed entities, weighted relations and inferred closure for the City Generation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.citygeneration.semantic_knowledge", dims = 40 })
		inst.system = S
		inst.ctx = ctx
