-- ARKHER SYSTEM W.0047 :: Establishing Shot Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0047"
	S.key = "arkher.cine.establishing.sequence_analysis"
	S.name = "Establishing Shot Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.establishing.frame_budget" }
	S.tags = { "w", "establishing", "analyzer", "cine" }
	S.description = "Establishing Shot Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Establishing Shot subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.establishing.sequence_analysis", window = 61, buckets = 13, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
