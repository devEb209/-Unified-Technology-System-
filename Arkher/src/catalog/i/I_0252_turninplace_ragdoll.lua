-- ARKHER SYSTEM I.0252 :: Turn In Place Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0252"
	S.key = "arkher.anim.turninplace.physical_blend"
	S.name = "Turn In Place Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.turninplace.inverse_kinematics" }
	S.tags = { "i", "turninplace", "ragdoll", "anim" }
	S.description = "Turn In Place Physical Blend: physical bones blended against the animated pose for the Turn In Place subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.turninplace.physical_blend", blendSpeed = 3.40 })
		inst.system = S
		inst.ctx = ctx
