-- ARKHER SYSTEM R.0151 :: Delta Compression Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0151"
	S.key = "arkher.net.deltacompression.interest_streaming"
	S.name = "Delta Compression Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.deltacompression.serialization_codec" }
	S.tags = { "r", "deltacompression", "streamer", "net" }
	S.description = "Delta Compression Interest Streaming: distance-driven residency of replicated content for the Delta Compression subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.deltacompression.interest_streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
