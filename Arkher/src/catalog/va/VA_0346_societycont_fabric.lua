-- ARKHER SYSTEM VA.0346 :: Society Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0346"
	S.key = "arkher.contworld.societycont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.societycont.complexity_budget" }
	S.tags = { "va", "societycont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.societycont.simulation_fabric", budgetMs = 1.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
