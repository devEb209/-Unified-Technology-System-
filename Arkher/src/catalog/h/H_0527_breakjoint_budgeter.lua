-- ARKHER SYSTEM H.0527 :: Breakable Joint Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0527"
	S.key = "arkher.physics.breakjoint.budget_governor"
	S.name = "Breakable Joint Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.breakjoint.broadphase_index" }
	S.tags = { "h", "breakjoint", "budgeter", "physics" }
	S.description = "Breakable Joint Budget Governor: simulation time budget allocation across islands for the Breakable Joint subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.breakjoint.budget_governor", total = 227, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
