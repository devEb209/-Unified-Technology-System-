-- ARKHER SYSTEM VA.0596 :: Horizon Span World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0596"
	S.key = "arkher.contworld.horizonspan.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.horizonspan.neural_field" }
	S.tags = { "va", "horizonspan", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.horizonspan.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
