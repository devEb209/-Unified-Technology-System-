-- ARKHER SYSTEM T.0249 :: Dialogue Generation Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0249"
	S.key = "arkher.ai.dialoguegeneration.action_planner"
	S.name = "Dialogue Generation Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.dialoguegeneration.utility_selection" }
	S.tags = { "t", "dialoguegeneration", "planner", "ai" }
	S.description = "Dialogue Generation Action Planner: goal-oriented action planning over preconditions for the Dialogue Generation subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.dialoguegeneration.action_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
