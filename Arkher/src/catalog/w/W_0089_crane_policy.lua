-- ARKHER SYSTEM W.0089 :: Crane Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0089"
	S.key = "arkher.cine.crane.cut_policy"
	S.name = "Crane Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Crane"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.crane.shot_composition" }
	S.tags = { "w", "crane", "policy", "cine" }
	S.description = "Crane Cut Policy: rules deciding when the sequence cuts and to what for the Crane subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.crane.cut_policy", algorithm = "lottery", starvationGuard = 63 })
		inst.system = S
		inst.ctx = ctx
