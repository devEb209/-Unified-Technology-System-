-- ARKHER SYSTEM VD.0283 :: Water Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0283"
	S.key = "arkher.contsim.watercont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.watercont.coherence_guard" }
	S.tags = { "vd", "watercont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.watercont.neural_field", dims = 16, hidden = 12, seed = 30869 })
		inst.system = S
		inst.ctx = ctx
