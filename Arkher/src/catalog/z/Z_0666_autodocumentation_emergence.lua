-- ARKHER SYSTEM Z.0666 :: Auto Documentation Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0666"
	S.key = "arkher.origin.autodocumentation.emergence_detection"
	S.name = "Auto Documentation Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.world_memory" }
	S.tags = { "z", "autodocumentation", "emergence", "origin" }
	S.description = "Auto Documentation Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.autodocumentation.emergence_detection", windowSize = 6, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
