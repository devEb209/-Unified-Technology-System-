-- ARKHER SYSTEM VD.0242 :: Vegetation Field Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0242"
	S.key = "arkher.contsim.vegfield.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vegfield.infinite_grid" }
	S.tags = { "vd", "vegfield", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.vegfield.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
