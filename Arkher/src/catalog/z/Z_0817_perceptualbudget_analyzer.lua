-- ARKHER SYSTEM Z.0817 :: Perceptual Budgeting Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0817"
	S.key = "arkher.origin.perceptualbudget.behaviour_analysis"
	S.name = "Perceptual Budgeting Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.perceptualbudget.governance_policy" }
	S.tags = { "z", "perceptualbudget", "analyzer", "origin" }
	S.description = "Perceptual Budgeting Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.perceptualbudget.behaviour_analysis", window = 48, buckets = 12, threshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
