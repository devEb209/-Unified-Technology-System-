-- ARKHER SYSTEM Q.0355 :: Responsive Breakpoint Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0355"
	S.key = "arkher.ui.breakpoint.localization_registry"
	S.name = "Responsive Breakpoint Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.breakpoint.theme_composition" }
	S.tags = { "q", "breakpoint", "registry", "ui" }
	S.description = "Responsive Breakpoint Localization Registry: catalogue of strings, plurals and locale metadata for the Responsive Breakpoint subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.breakpoint.localization_registry" })
		inst.system = S
		inst.ctx = ctx
