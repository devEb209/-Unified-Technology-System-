-- ARKHER SYSTEM V.0086 :: Audio Clip Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0086"
	S.key = "arkher.asset.audioclip.bundling"
	S.name = "Audio Clip Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.audioclip.import" }
	S.tags = { "v", "audioclip", "bundler", "asset" }
	S.description = "Audio Clip Bundling: size-bounded packing, manifests and delta patches for the Audio Clip subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.audioclip.bundling", maxBundleBytes = 917504 })
		inst.system = S
		inst.ctx = ctx
