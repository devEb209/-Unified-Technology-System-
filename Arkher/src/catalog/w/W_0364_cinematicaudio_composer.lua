-- ARKHER SYSTEM W.0364 :: Cinematic Audio Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0364"
	S.key = "arkher.cine.cinematicaudio.shot_composition"
	S.name = "Cinematic Audio Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinematicaudio.colour_grade" }
	S.tags = { "w", "cinematicaudio", "composer", "cine" }
	S.description = "Cinematic Audio Shot Composition: blending of the signals that make up the final shot for the Cinematic Audio subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.cinematicaudio.shot_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
