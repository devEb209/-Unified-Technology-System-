-- ARKHER SYSTEM VA.0249 :: Vegetation Field Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0249"
	S.key = "arkher.contworld.vegfield.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vegfield.world_memory_stream" }
	S.tags = { "va", "vegfield", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.vegfield.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
