-- ARKHER SYSTEM VC.0399 :: Perception Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0399"
	S.key = "arkher.contneural.perceptioncont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.perceptioncont.epoch_clock" }
	S.tags = { "vc", "perceptioncont", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.perceptioncont.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
