-- ARKHER SYSTEM F.0572 :: UI Rendering Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0572"
	S.key = "arkher.render.uirender.frame_analysis"
	S.name = "UI Rendering Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "UI Rendering"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.uirender.pass_cache" }
	S.tags = { "f", "uirender", "analyzer", "render" }
	S.description = "UI Rendering Frame Analysis: per-pass cost analysis and outlier detection for the UI Rendering subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.uirender.frame_analysis", window = 218, buckets = 18, threshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
