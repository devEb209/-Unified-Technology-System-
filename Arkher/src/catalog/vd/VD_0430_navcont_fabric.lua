-- ARKHER SYSTEM VD.0430 :: Navigation Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0430"
	S.key = "arkher.contsim.navcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.navcont.complexity_budget" }
	S.tags = { "vd", "navcont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.navcont.simulation_fabric", budgetMs = 4.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
