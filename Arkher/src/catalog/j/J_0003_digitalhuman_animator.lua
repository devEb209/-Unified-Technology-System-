-- ARKHER SYSTEM J.0003 :: Digital Human Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0003"
	S.key = "arkher.character.digitalhuman.blend_controller"
	S.name = "Digital Human Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.digitalhuman.motion_set" }
	S.tags = { "j", "digitalhuman", "animator", "character" }
	S.description = "Digital Human Blend Controller: layered playback driving the character for the Digital Human subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.digitalhuman.blend_controller", budget = 6 })
		inst.system = S
		inst.ctx = ctx
