-- ARKHER SYSTEM Z.1076 :: World Dream State Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.1076"
	S.key = "arkher.origin.worlddream.governance_policy"
	S.name = "World Dream State Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.signal_composition" }
	S.tags = { "z", "worlddream", "policy", "origin" }
	S.description = "World Dream State Governance Policy: ordered rules governing when the technology may act for the World Dream State subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.worlddream.governance_policy", algorithm = "edf", starvationGuard = 61 })
		inst.system = S
		inst.ctx = ctx
