-- ARKHER SYSTEM K.0697 :: NPC Debug Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0697"
	S.key = "arkher.npc.npcdebug.social_relations"
	S.name = "NPC Debug Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcdebug.crowd_steering" }
	S.tags = { "k", "npcdebug", "society", "npc" }
	S.description = "NPC Debug Social Relations: affinity, factions, reputation and gossip for the NPC Debug subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.npcdebug.social_relations", decayRate = 0.011, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
