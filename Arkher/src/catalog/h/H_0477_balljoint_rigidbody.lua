-- ARKHER SYSTEM H.0477 :: Ball Joint Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0477"
	S.key = "arkher.physics.balljoint.body_dynamics"
	S.name = "Ball Joint Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Ball Joint"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "balljoint", "rigidbody", "physics" }
	S.description = "Ball Joint Body Dynamics: integration, impulses, damping and sleeping of a body for the Ball Joint subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.balljoint.body_dynamics", mass = 17.00, radius = 1.10, restitution = 0.36, friction = 0.46, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
