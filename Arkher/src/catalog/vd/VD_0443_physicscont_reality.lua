-- ARKHER SYSTEM VD.0443 :: Physics Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0443"
	S.key = "arkher.contsim.physicscont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.physicscont.simulation_fabric" }
	S.tags = { "vd", "physicscont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.physicscont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
