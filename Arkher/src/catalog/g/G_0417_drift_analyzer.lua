-- ARKHER SYSTEM G.0417 :: Drift Detection Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0417"
	S.key = "arkher.neural.drift.error_analysis"
	S.name = "Drift Detection Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.drift.heuristic_policy" }
	S.tags = { "g", "drift", "analyzer", "neural" }
	S.description = "Drift Detection Error Analysis: residual and drift analysis for the Drift Detection subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.drift.error_analysis", window = 183, buckets = 19, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
