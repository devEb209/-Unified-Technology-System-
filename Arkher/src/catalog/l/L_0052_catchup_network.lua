-- ARKHER SYSTEM L.0052 :: Catch Up Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0052"
	S.key = "arkher.sim.catchup.route_network"
	S.name = "Catch Up Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.catchup.region_graph" }
	S.tags = { "l", "catchup", "network", "sim" }
	S.description = "Catch Up Route Network: roads, rivers and routes between settlements for the Catch Up subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.catchup.route_network" })
		inst.system = S
		inst.ctx = ctx
