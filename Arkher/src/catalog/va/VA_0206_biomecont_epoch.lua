-- ARKHER SYSTEM VA.0206 :: Biome Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0206"
	S.key = "arkher.contworld.biomecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.biomecont.infinite_grid" }
	S.tags = { "va", "biomecont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.biomecont.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
