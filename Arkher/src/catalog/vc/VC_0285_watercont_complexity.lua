-- ARKHER SYSTEM VC.0285 :: Water Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0285"
	S.key = "arkher.contneural.watercont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.watercont.world_memory_stream" }
	S.tags = { "vc", "watercont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.watercont.complexity_budget", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
