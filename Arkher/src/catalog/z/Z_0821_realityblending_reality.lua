-- ARKHER SYSTEM Z.0821 :: Reality Blending Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0821"
	S.key = "arkher.origin.realityblending.reality_layering"
	S.name = "Reality Blending Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "realityblending", "reality", "origin" }
	S.description = "Reality Blending Reality Layering: stacked authored, simulated, proposed and player realities for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.realityblending.reality_layering" })
		inst.system = S
		inst.ctx = ctx
