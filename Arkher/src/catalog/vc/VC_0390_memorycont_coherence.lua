-- ARKHER SYSTEM VC.0390 :: Memory Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0390"
	S.key = "arkher.contneural.memorycont.coherence_guard"
	S.name = "Memory Continuum Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memorycont.persistent_state" }
	S.tags = { "vc", "memorycont", "coherence", "contneural" }
	S.description = "Memory Continuum Coherence Guard: seam coherence and drift supervision for the Memory Continuum subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.memorycont.coherence_guard", window = 125, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
