-- ARKHER SYSTEM VB.0326 :: Economy Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0326"
	S.key = "arkher.conttime.economycont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.economycont.infinite_grid" }
	S.tags = { "vb", "economycont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.economycont.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
