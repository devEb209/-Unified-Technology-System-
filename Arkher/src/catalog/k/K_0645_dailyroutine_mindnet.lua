-- ARKHER SYSTEM K.0645 :: Daily Routine Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0645"
	S.key = "arkher.npc.dailyroutine.mind_network"
	S.name = "Daily Routine Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "dailyroutine", "mindnet", "npc" }
	S.description = "Daily Routine Mind Network: the learned policy that turns perception into a decision for the Daily Routine subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.dailyroutine.mind_network", inputs = 9, hidden = 8, seed = 62419, learningRate = 0.095, exploration = 0.035 })
		inst.system = S
		inst.ctx = ctx
