-- ARKHER SYSTEM O.0009 :: Footstep Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0009"
	S.key = "arkher.audio.footstep.playback_policy"
	S.name = "Footstep Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Footstep"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.footstep.compression_codec" }
	S.tags = { "o", "footstep", "policy", "audio" }
	S.description = "Footstep Playback Policy: rules choosing what may be heard right now for the Footstep subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.footstep.playback_policy", algorithm = "edf", starvationGuard = 25 })
		inst.system = S
		inst.ctx = ctx
