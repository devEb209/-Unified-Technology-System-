-- ARKHER SYSTEM N.0462 :: Camera Shake Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0462"
	S.key = "arkher.vfx.camerashake.effect_composition"
	S.name = "Camera Shake Effect Composition"
	S.category = "N"
	S.family = "VFX"
	S.area = "Camera Shake"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.camerashake.effect_graph" }
	S.tags = { "n", "camerashake", "composer", "vfx" }
	S.description = "Camera Shake Effect Composition: blending of several effect signals into one output for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.camerashake.effect_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
