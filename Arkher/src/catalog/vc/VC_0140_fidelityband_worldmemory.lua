-- ARKHER SYSTEM VC.0140 :: Fidelity Band World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0140"
	S.key = "arkher.contneural.fidelityband.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.fidelityband.neural_field" }
	S.tags = { "vc", "fidelityband", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.fidelityband.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
