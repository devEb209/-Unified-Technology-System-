-- ARKHER SYSTEM VA.0619 :: Occupancy Map Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0619"
	S.key = "arkher.contworld.occupancymap.neural_field"
	S.name = "Occupancy Map Neural Field"
	S.category = "VA"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.occupancymap.coherence_guard" }
	S.tags = { "va", "occupancymap", "neuralfield", "contworld" }
	S.description = "Occupancy Map Neural Field: neural field encoding and reconstruction for the Occupancy Map subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.occupancymap.neural_field", dims = 12, hidden = 8, seed = 40952 })
		inst.system = S
		inst.ctx = ctx
