-- ARKHER SYSTEM VA.0383 :: Dialogue Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0383"
	S.key = "arkher.contworld.dialoguecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.dialoguecont.simulation_fabric" }
	S.tags = { "va", "dialoguecont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.dialoguecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
