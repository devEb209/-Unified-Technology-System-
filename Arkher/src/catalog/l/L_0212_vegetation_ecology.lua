-- ARKHER SYSTEM L.0212 :: Vegetation Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0212"
	S.key = "arkher.sim.vegetation.ecology"
	S.name = "Vegetation Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.vegetation.simulation_core" }
	S.tags = { "l", "vegetation", "ecology", "sim" }
	S.description = "Vegetation Ecology: populations, predation, harvesting and carrying capacity for the Vegetation subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.vegetation.ecology" })
		inst.system = S
		inst.ctx = ctx
