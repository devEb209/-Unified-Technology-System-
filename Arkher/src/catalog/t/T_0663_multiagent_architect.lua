-- ARKHER SYSTEM T.0663 :: Multi Agent Coordination World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0663"
	S.key = "arkher.ai.multiagent.world_architect"
	S.name = "Multi Agent Coordination World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.multiagent.self_critique" }
	S.tags = { "t", "multiagent", "architect", "ai" }
	S.description = "Multi Agent Coordination World Architect: composition of a whole world plan with conserved budgets for the Multi Agent Coordination subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.multiagent.world_architect", budget = 600, seed = 95780 })
		inst.system = S
		inst.ctx = ctx
