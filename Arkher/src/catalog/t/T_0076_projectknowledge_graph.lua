-- ARKHER SYSTEM T.0076 :: Project Knowledge Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0076"
	S.key = "arkher.ai.projectknowledge.reasoning_graph"
	S.name = "Project Knowledge Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.projectknowledge.world_architect" }
	S.tags = { "t", "projectknowledge", "graph", "ai" }
	S.description = "Project Knowledge Reasoning Graph: relationship modelling and shortest-path reasoning for the Project Knowledge subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.projectknowledge.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
