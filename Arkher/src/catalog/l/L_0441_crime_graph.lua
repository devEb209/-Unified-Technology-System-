-- ARKHER SYSTEM L.0441 :: Crime Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0441"
	S.key = "arkher.sim.crime.region_graph"
	S.name = "Crime Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.crime.calendar" }
	S.tags = { "l", "crime", "graph", "sim" }
	S.description = "Crime Region Graph: connectivity, components and shortest path between places for the Crime subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.crime.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
