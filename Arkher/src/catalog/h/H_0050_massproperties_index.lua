-- ARKHER SYSTEM H.0050 :: Mass Properties Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0050"
	S.key = "arkher.physics.massproperties.broadphase_index"
	S.name = "Mass Properties Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.massproperties.vehicle" }
	S.tags = { "h", "massproperties", "index", "physics" }
	S.description = "Mass Properties Broadphase Index: spatial acceleration of candidate pair finding for the Mass Properties subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.massproperties.broadphase_index", mode = "hash", cellSize = 88 })
		inst.system = S
		inst.ctx = ctx
