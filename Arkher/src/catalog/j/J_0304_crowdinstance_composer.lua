-- ARKHER SYSTEM J.0304 :: Crowd Instance Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0304"
	S.key = "arkher.character.crowdinstance.appearance_composer"
	S.name = "Crowd Instance Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.crowdinstance.locomotion" }
	S.tags = { "j", "crowdinstance", "composer", "character" }
	S.description = "Crowd Instance Appearance Composer: composition of appearance slots into a look for the Crowd Instance subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.crowdinstance.appearance_composer", mode = "add" })
		inst.system = S
		inst.ctx = ctx
