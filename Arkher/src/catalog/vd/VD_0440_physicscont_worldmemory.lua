-- ARKHER SYSTEM VD.0440 :: Physics Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0440"
	S.key = "arkher.contsim.physicscont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.physicscont.neural_field" }
	S.tags = { "vd", "physicscont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.physicscont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
