-- ARKHER SYSTEM H.0540 :: Rope Simulation Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0540"
	S.key = "arkher.physics.rope.broadphase_index"
	S.name = "Rope Simulation Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rope.vehicle" }
	S.tags = { "h", "rope", "index", "physics" }
	S.description = "Rope Simulation Broadphase Index: spatial acceleration of candidate pair finding for the Rope Simulation subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.rope.broadphase_index", mode = "hash", cellSize = 16 })
		inst.system = S
		inst.ctx = ctx
