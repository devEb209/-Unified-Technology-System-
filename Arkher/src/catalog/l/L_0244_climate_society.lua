-- ARKHER SYSTEM L.0244 :: Climate Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0244"
	S.key = "arkher.sim.climate.society"
	S.name = "Climate Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.climate.economy" }
	S.tags = { "l", "climate", "society", "sim" }
	S.description = "Climate Society: relations, factions, reputation and cohesion of the region for the Climate subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.climate.society", decayRate = 0.014, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
