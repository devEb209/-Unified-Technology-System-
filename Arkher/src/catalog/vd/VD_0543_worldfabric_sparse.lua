-- ARKHER SYSTEM VD.0543 :: World Fabric Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0543"
	S.key = "arkher.contsim.worldfabric.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldfabric.epoch_clock" }
	S.tags = { "vd", "worldfabric", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.worldfabric.sparse_residency", capacity = 256, pageBytes = 3072 })
		inst.system = S
		inst.ctx = ctx
