-- ARKHER SYSTEM N.0469 :: Distortion Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0469"
	S.key = "arkher.vfx.distortion.emission"
	S.name = "Distortion Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Distortion"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "distortion", "emitter", "vfx" }
	S.description = "Distortion Emission: shaped, rate and burst emission of new particles for the Distortion subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.distortion.emission", shape = "box", rate = 62, speed = 3.20, life = 2.00, budget = 256, seed = 98562 })
		inst.system = S
		inst.ctx = ctx
