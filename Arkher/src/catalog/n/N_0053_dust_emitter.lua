-- ARKHER SYSTEM N.0053 :: Dust Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0053"
	S.key = "arkher.vfx.dust.emission"
	S.name = "Dust Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Dust"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "dust", "emitter", "vfx" }
	S.description = "Dust Emission: shaped, rate and burst emission of new particles for the Dust subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.dust.emission", shape = "box", rate = 50, speed = 4.00, life = 0.80, budget = 256, seed = 40890 })
		inst.system = S
		inst.ctx = ctx
