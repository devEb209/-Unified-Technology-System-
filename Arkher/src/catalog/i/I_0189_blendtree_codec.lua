-- ARKHER SYSTEM I.0189 :: Blend Tree Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0189"
	S.key = "arkher.anim.blendtree.compression_codec"
	S.name = "Blend Tree Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Blend Tree"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.blendtree.retarget_graph" }
	S.tags = { "i", "blendtree", "codec", "anim" }
	S.description = "Blend Tree Compression Codec: curve compression and quantized transport for the Blend Tree subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.blendtree.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
