-- ARKHER SYSTEM F.0304 :: Bloom Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0304"
	S.key = "arkher.render.bloom.render_policy"
	S.name = "Bloom Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Bloom"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.bloom.draw_budget" }
	S.tags = { "f", "bloom", "policy", "render" }
	S.description = "Bloom Render Policy: device tier rules for the frame for the Bloom subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.bloom.render_policy", algorithm = "roundrobin", starvationGuard = 28 })
		inst.system = S
		inst.ctx = ctx
