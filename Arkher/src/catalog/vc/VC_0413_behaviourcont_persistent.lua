-- ARKHER SYSTEM VC.0413 :: Behaviour Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0413"
	S.key = "arkher.contneural.behaviourcont.persistent_state"
	S.name = "Behaviour Continuum Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.behaviourcont.multi-scale_fidelity" }
	S.tags = { "vc", "behaviourcont", "persistent", "contneural" }
	S.description = "Behaviour Continuum Persistent State: epoch-stamped persistent history and rollback for the Behaviour Continuum subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.behaviourcont.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
