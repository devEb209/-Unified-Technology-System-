-- ARKHER SYSTEM I.0147 :: Layer Mask Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0147"
	S.key = "arkher.anim.layermask.inverse_kinematics"
	S.name = "Layer Mask Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Layer Mask"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.layermask.layered_blending" }
	S.tags = { "i", "layermask", "ik", "anim" }
	S.description = "Layer Mask Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Layer Mask subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.layermask.inverse_kinematics", iterations = 14, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
