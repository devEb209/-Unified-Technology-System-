-- ARKHER SYSTEM H.0502 :: Slider Joint Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0502"
	S.key = "arkher.physics.sliderjoint.analysis"
	S.name = "Slider Joint Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Slider Joint"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sliderjoint.result_cache" }
	S.tags = { "h", "sliderjoint", "analyzer", "physics" }
	S.description = "Slider Joint Analysis: energy, jitter and cost analysis of the simulation for the Slider Joint subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.sliderjoint.analysis", window = 245, buckets = 17, threshold = 4.70 })
		inst.system = S
		inst.ctx = ctx
