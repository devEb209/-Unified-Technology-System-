-- ARKHER SYSTEM P.0382 :: Checkpoint Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0382"
	S.key = "arkher.play.checkpoint.content_registry"
	S.name = "Checkpoint Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Checkpoint"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.checkpoint.difficulty_controller" }
	S.tags = { "p", "checkpoint", "registry", "play" }
	S.description = "Checkpoint Content Registry: catalogue of the definitions this loop instantiates for the Checkpoint subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.checkpoint.content_registry" })
		inst.system = S
		inst.ctx = ctx
