-- ARKHER SYSTEM Z.0651 :: Natural Language Engine Control Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0651"
	S.key = "arkher.origin.languagecontrol.adaptive_workflow"
	S.name = "Natural Language Engine Control Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.languagecontrol.self_critique" }
	S.tags = { "z", "languagecontrol", "workflow", "origin" }
	S.description = "Natural Language Engine Control Adaptive Workflow: verified, retryable, reversible execution plans for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.languagecontrol.adaptive_workflow", maxRetries = 3, budget = 150 })
		inst.system = S
		inst.ctx = ctx
