-- ARKHER SYSTEM Z.0278 :: Living Ecosystem Engine Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0278"
	S.key = "arkher.origin.livingecosystem.budget_governor"
	S.name = "Living Ecosystem Engine Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.livingecosystem.behaviour_analysis" }
	S.tags = { "z", "livingecosystem", "budgeter", "origin" }
	S.description = "Living Ecosystem Engine Budget Governor: allocation of a scarce resource across the technology's consumers for the Living Ecosystem Engine subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.livingecosystem.budget_governor", total = 454, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
