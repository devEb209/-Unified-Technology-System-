-- ARKHER SYSTEM L.0241 :: Climate Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0241"
	S.key = "arkher.sim.climate.simulation_core"
	S.name = "Climate Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "climate", "simulation", "sim" }
	S.description = "Climate Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Climate subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.climate.simulation_core", fullRadius = 280, reducedRadius = 600, budget = 96 })
		inst.system = S
		inst.ctx = ctx
