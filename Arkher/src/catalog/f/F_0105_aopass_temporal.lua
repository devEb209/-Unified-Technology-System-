-- ARKHER SYSTEM F.0105 :: Ambient Occlusion Pass Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0105"
	S.key = "arkher.render.aopass.temporal_resolve"
	S.name = "Ambient Occlusion Pass Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.aopass.probe_volume" }
	S.tags = { "f", "aopass", "temporal", "render" }
	S.description = "Ambient Occlusion Pass Temporal Resolve: history reprojection with neighbourhood clamping for the Ambient Occlusion Pass subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.aopass.temporal_resolve", feedback = 0.92, phase = 8 })
		inst.system = S
		inst.ctx = ctx
