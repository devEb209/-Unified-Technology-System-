-- ARKHER SYSTEM F.0469 :: Distance Culling Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0469"
	S.key = "arkher.render.distanceculling.temporal_resolve"
	S.name = "Distance Culling Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.distanceculling.probe_volume" }
	S.tags = { "f", "distanceculling", "temporal", "render" }
	S.description = "Distance Culling Temporal Resolve: history reprojection with neighbourhood clamping for the Distance Culling subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.distanceculling.temporal_resolve", feedback = 0.85, phase = 8 })
		inst.system = S
		inst.ctx = ctx
