-- ARKHER SYSTEM Z.0452 :: Player Absence Simulation Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0452"
	S.key = "arkher.origin.playerabsence.predictive_optimization"
	S.name = "Player Absence Simulation Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.adaptive_workflow" }
	S.tags = { "z", "playerabsence", "predictor", "origin" }
	S.description = "Player Absence Simulation Predictive Optimization: forecast-driven optimization before the cost is paid for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.playerabsence.predictive_optimization", method = "markov", alpha = 0.23, window = 37 })
		inst.system = S
		inst.ctx = ctx
