-- ARKHER SYSTEM L.0063 :: Population Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0063"
	S.key = "arkher.sim.population.economy"
	S.name = "Population Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.population.ecology" }
	S.tags = { "l", "population", "economy", "sim" }
	S.description = "Population Economy: stock, production, demand, price discovery and trade for the Population subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.population.economy", elasticity = 0.36 })
		inst.system = S
		inst.ctx = ctx
