-- ARKHER SYSTEM K.0157 :: Safety Drive Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0157"
	S.key = "arkher.npc.safetydrive.drive_system"
	S.name = "Safety Drive Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.safetydrive.memory" }
	S.tags = { "k", "safetydrive", "need", "npc" }
	S.description = "Safety Drive Drive System: drives that decay, turn urgent and get satisfied for the Safety Drive subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.safetydrive.drive_system" })
		inst.system = S
		inst.ctx = ctx
