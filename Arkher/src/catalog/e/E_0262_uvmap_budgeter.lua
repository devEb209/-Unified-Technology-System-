-- ARKHER SYSTEM E.0262 :: UV Mapping Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0262"
	S.key = "arkher.material.uvmap.parameter_budget"
	S.name = "UV Mapping Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "UV Mapping"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.uvmap.variant_registry" }
	S.tags = { "e", "uvmap", "budgeter", "material" }
	S.description = "UV Mapping Parameter Budget: texel and layer budget allocation for the UV Mapping subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.uvmap.parameter_budget", total = 445, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
