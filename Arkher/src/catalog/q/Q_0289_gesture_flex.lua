-- ARKHER SYSTEM Q.0289 :: Gesture Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0289"
	S.key = "arkher.ui.gesture.responsive_layout"
	S.name = "Gesture Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Gesture"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "gesture", "flex", "ui" }
	S.description = "Gesture Responsive Layout: flex solving with safe areas, weights and breakpoints for the Gesture subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.gesture.responsive_layout", width = 630, height = 1084, scale = 0.94 })
		inst.system = S
		inst.ctx = ctx
