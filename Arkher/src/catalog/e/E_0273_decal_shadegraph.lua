-- ARKHER SYSTEM E.0273 :: Decal Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0273"
	S.key = "arkher.material.decal.shading_graph"
	S.name = "Decal Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Decal"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.decal.layer_composition" }
	S.tags = { "e", "decal", "shadegraph", "material" }
	S.description = "Decal Shading Graph: node graph evaluated and compiled to Luau for the Decal subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.decal.shading_graph" })
		inst.system = S
		inst.ctx = ctx
