--!strict
-- Frostbite Frosty — CORE Map #0048
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Frostbite Frosty — CORE Map #0048", size=Vector2.new(600, 480), pos=UDim2.fromOffset(324, 116), parent=parent, icon="▶"})
