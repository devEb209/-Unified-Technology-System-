-- ARKHER SYSTEM I.0095 :: Clip Looping Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0095"
	S.key = "arkher.anim.cliploop.inverse_kinematics"
	S.name = "Clip Looping Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Looping"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.cliploop.layered_blending" }
	S.tags = { "i", "cliploop", "ik", "anim" }
	S.description = "Clip Looping Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Clip Looping subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.cliploop.inverse_kinematics", iterations = 8, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
