-- ARKHER SYSTEM Q.0362 :: Theme Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0362"
	S.key = "arkher.ui.uitheme.widget_tree"
	S.name = "Theme Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Theme"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uitheme.responsive_layout" }
	S.tags = { "q", "uitheme", "widget", "ui" }
	S.description = "Theme Widget Tree: retained widget nodes, properties, bindings and rendering for the Theme subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.uitheme.widget_tree", theme = "highcontrast", scale = 0.83 })
		inst.system = S
		inst.ctx = ctx
