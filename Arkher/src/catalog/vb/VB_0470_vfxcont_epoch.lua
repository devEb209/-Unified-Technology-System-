-- ARKHER SYSTEM VB.0470 :: VFX Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0470"
	S.key = "arkher.conttime.vfxcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vfxcont.infinite_grid" }
	S.tags = { "vb", "vfxcont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.vfxcont.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
