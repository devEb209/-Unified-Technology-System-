-- ARKHER SYSTEM T.0077 :: Project Knowledge Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0077"
	S.key = "arkher.ai.projectknowledge.decision_policy"
	S.name = "Project Knowledge Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.projectknowledge.reasoning_graph" }
	S.tags = { "t", "projectknowledge", "policy", "ai" }
	S.description = "Project Knowledge Decision Policy: ordered rules deciding what the agent does next for the Project Knowledge subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.projectknowledge.decision_policy", algorithm = "edf", starvationGuard = 53 })
		inst.system = S
		inst.ctx = ctx
