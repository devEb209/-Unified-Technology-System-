-- ARKHER SYSTEM Z.0801 :: Perceptual Budgeting Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0801"
	S.key = "arkher.origin.perceptualbudget.reality_layering"
	S.name = "Perceptual Budgeting Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "perceptualbudget", "reality", "origin" }
	S.description = "Perceptual Budgeting Reality Layering: stacked authored, simulated, proposed and player realities for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.perceptualbudget.reality_layering" })
		inst.system = S
		inst.ctx = ctx
