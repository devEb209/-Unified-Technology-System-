-- ARKHER SYSTEM VD.0354 :: Narrative Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0354"
	S.key = "arkher.contsim.narrativecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.narrativecont.persistent_state" }
	S.tags = { "vd", "narrativecont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.narrativecont.coherence_guard", window = 71, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
