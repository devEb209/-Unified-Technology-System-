-- ARKHER SYSTEM T.0502 :: Physics Reasoning Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0502"
	S.key = "arkher.ai.physicsreasoning.model_inference"
	S.name = "Physics Reasoning Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.physicsreasoning.action_planner" }
	S.tags = { "t", "physicsreasoning", "inference", "ai" }
	S.description = "Physics Reasoning Model Inference: quantized inference with batching and budget for the Physics Reasoning subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.physicsreasoning.model_inference", seed = 49087 })
		inst.system = S
		inst.ctx = ctx
