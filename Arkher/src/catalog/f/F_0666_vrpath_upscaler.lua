-- ARKHER SYSTEM F.0666 :: VR Stereo Path Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0666"
	S.key = "arkher.render.vrpath.adaptive_resolution"
	S.name = "VR Stereo Path Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.vrpath.temporal_resolve" }
	S.tags = { "f", "vrpath", "upscaler", "render" }
	S.description = "VR Stereo Path Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the VR Stereo Path subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.vrpath.adaptive_resolution", targetMs = 13.10, index = 5, sharpness = 0.28 })
		inst.system = S
		inst.ctx = ctx
