-- ARKHER SYSTEM VA.0615 :: Occupancy Map Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0615"
	S.key = "arkher.contworld.occupancymap.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.occupancymap.epoch_clock" }
	S.tags = { "va", "occupancymap", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.occupancymap.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
