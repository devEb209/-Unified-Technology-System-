-- ARKHER SYSTEM O.0089 :: Narration Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0089"
	S.key = "arkher.audio.narration.voice_budget"
	S.name = "Narration Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Narration"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.narration.music_sequencer" }
	S.tags = { "o", "narration", "budgeter", "audio" }
	S.description = "Narration Voice Budget: voice slots allocated by priority and audibility for the Narration subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.narration.voice_budget", total = 438, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
