-- ARKHER SYSTEM VB.0438 :: Physics Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0438"
	S.key = "arkher.conttime.physicscont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.physicscont.persistent_state" }
	S.tags = { "vb", "physicscont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.physicscont.coherence_guard", window = 54, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
