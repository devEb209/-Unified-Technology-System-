-- ARKHER SYSTEM N.0324 :: Trail Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0324"
	S.key = "arkher.vfx.trail.analysis"
	S.name = "Trail Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Trail"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.trail.spatial_index" }
	S.tags = { "n", "trail", "analyzer", "vfx" }
	S.description = "Trail Analysis: cost, overdraw and stability analysis of the effect for the Trail subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.trail.analysis", window = 227, buckets = 15, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
