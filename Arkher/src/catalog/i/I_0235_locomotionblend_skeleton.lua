-- ARKHER SYSTEM I.0235 :: Locomotion Blend Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0235"
	S.key = "arkher.anim.locomotionblend.skeleton"
	S.name = "Locomotion Blend Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "locomotionblend", "skeleton", "anim" }
	S.description = "Locomotion Blend Skeleton: bone hierarchy, bind pose and world resolution for the Locomotion Blend subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.locomotionblend.skeleton" })
		inst.system = S
		inst.ctx = ctx
