-- ARKHER SYSTEM N.0506 :: Environment Ambience Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0506"
	S.key = "arkher.vfx.envambience.analysis"
	S.name = "Environment Ambience Analysis"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.envambience.spatial_index" }
	S.tags = { "n", "envambience", "analyzer", "vfx" }
	S.description = "Environment Ambience Analysis: cost, overdraw and stability analysis of the effect for the Environment Ambience subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.envambience.analysis", window = 113, buckets = 9, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
