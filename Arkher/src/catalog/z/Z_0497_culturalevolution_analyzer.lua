-- ARKHER SYSTEM Z.0497 :: Cultural Evolution Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0497"
	S.key = "arkher.origin.culturalevolution.behaviour_analysis"
	S.name = "Cultural Evolution Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.governance_policy" }
	S.tags = { "z", "culturalevolution", "analyzer", "origin" }
	S.description = "Cultural Evolution Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.culturalevolution.behaviour_analysis", window = 51, buckets = 19, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
