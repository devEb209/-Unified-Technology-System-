-- ARKHER SYSTEM O.0409 :: Audio Debug DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0409"
	S.key = "arkher.audio.audiodebug.dsp_chain"
	S.name = "Audio Debug DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Audio Debug"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "audiodebug", "dsp", "audio" }
	S.description = "Audio Debug DSP Chain: biquad filtering, delay, envelope and soft clipping for the Audio Debug subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.audiodebug.dsp_chain", sampleRate = 22050, filter = "notch", cutoff = 4800, q = 0.650 })
		inst.system = S
		inst.ctx = ctx
