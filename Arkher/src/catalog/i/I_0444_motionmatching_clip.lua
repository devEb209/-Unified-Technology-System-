-- ARKHER SYSTEM I.0444 :: Motion Matching Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0444"
	S.key = "arkher.anim.motionmatching.clip_sampling"
	S.name = "Motion Matching Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.motionmatching.skeleton" }
	S.tags = { "i", "motionmatching", "clip", "anim" }
	S.description = "Motion Matching Clip Sampling: keyframe tracks sampled, retimed and evented for the Motion Matching subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.motionmatching.clip_sampling", duration = 2.20, loop = true })
		inst.system = S
		inst.ctx = ctx
