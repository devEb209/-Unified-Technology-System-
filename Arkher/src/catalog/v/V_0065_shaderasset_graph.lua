-- ARKHER SYSTEM V.0065 :: Shader Asset Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0065"
	S.key = "arkher.asset.shaderasset.dependency_graph"
	S.name = "Shader Asset Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.shaderasset.asset_registry" }
	S.tags = { "v", "shaderasset", "graph", "asset" }
	S.description = "Shader Asset Dependency Graph: what references what, and in which order it must be built for the Shader Asset subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.shaderasset.dependency_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
