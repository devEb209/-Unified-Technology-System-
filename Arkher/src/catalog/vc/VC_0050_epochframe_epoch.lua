-- ARKHER SYSTEM VC.0050 :: Epoch Frame Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0050"
	S.key = "arkher.contneural.epochframe.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.epochframe.infinite_grid" }
	S.tags = { "vc", "epochframe", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.epochframe.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
