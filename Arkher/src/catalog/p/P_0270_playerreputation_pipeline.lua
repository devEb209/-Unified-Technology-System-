-- ARKHER SYSTEM P.0270 :: Reputation Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0270"
	S.key = "arkher.play.playerreputation.rule_pipeline"
	S.name = "Reputation Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Reputation"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playerreputation.state_machine" }
	S.tags = { "p", "playerreputation", "pipeline", "play" }
	S.description = "Reputation Rule Pipeline: ordered rules applied to every gameplay event for the Reputation subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.playerreputation.rule_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
