-- ARKHER SYSTEM Q.0237 :: Quest Log Accessibility Policy
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0237"
	S.key = "arkher.ui.questlog.accessibility_policy"
	S.name = "Quest Log Accessibility Policy"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Quest Log"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.questlog.interaction_ledger" }
	S.tags = { "q", "questlog", "policy", "ui" }
	S.description = "Quest Log Accessibility Policy: rules enforcing contrast, target size and motion limits for the Quest Log subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ui.questlog.accessibility_policy", algorithm = "lottery", starvationGuard = 23 })
		inst.system = S
		inst.ctx = ctx
