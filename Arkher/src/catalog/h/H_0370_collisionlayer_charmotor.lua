-- ARKHER SYSTEM H.0370 :: Collision Layer Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0370"
	S.key = "arkher.physics.collisionlayer.character_motion"
	S.name = "Collision Layer Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionlayer.query" }
	S.tags = { "h", "collisionlayer", "charmotor", "physics" }
	S.description = "Collision Layer Character Motion: capsule move-and-slide with slopes, steps and jumps for the Collision Layer subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.collisionlayer.character_motion", radius = 0.54, height = 1.99, maxSpeed = 7.90, jumpHeight = 1.50, stepOffset = 0.34 })
		inst.system = S
		inst.ctx = ctx
