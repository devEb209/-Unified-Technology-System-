-- ARKHER SYSTEM VB.0243 :: Vegetation Field Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0243"
	S.key = "arkher.conttime.vegfield.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vegfield.epoch_clock" }
	S.tags = { "vb", "vegfield", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.vegfield.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
