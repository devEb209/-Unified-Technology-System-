-- ARKHER SYSTEM Z.0642 :: Natural Language Engine Control Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0642"
	S.key = "arkher.origin.languagecontrol.complexity_governance"
	S.name = "Natural Language Engine Control Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.languagecontrol.reality_layering" }
	S.tags = { "z", "languagecontrol", "complexity", "origin" }
	S.description = "Natural Language Engine Control Complexity Governance: measured scene cost turned into per-subsystem directives for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.languagecontrol.complexity_governance", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
