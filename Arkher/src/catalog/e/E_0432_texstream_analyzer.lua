-- ARKHER SYSTEM E.0432 :: Texture Streaming Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0432"
	S.key = "arkher.material.texstream.analysis"
	S.name = "Texture Streaming Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.texstream.instance_cache" }
	S.tags = { "e", "texstream", "analyzer", "material" }
	S.description = "Texture Streaming Analysis: cost, redundancy and outlier analysis for the Texture Streaming subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.texstream.analysis", window = 113, buckets = 9, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
