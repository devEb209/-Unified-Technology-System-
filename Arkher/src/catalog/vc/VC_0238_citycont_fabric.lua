-- ARKHER SYSTEM VC.0238 :: City Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0238"
	S.key = "arkher.contneural.citycont.simulation_fabric"
	S.name = "City Continuum Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.citycont.complexity_budget" }
	S.tags = { "vc", "citycont", "fabric", "contneural" }
	S.description = "City Continuum Simulation Fabric: fabric stepping the continuum domains for the City Continuum subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.citycont.simulation_fabric", budgetMs = 1.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
