-- ARKHER SYSTEM L.0299 :: Water Cycle Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0299"
	S.key = "arkher.sim.watercycle.forecast"
	S.name = "Water Cycle Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.watercycle.analysis" }
	S.tags = { "l", "watercycle", "predictor", "sim" }
	S.description = "Water Cycle Forecast: prediction of the region's next state for the Water Cycle subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.watercycle.forecast", method = "linear", alpha = 0.12, window = 42 })
		inst.system = S
		inst.ctx = ctx
