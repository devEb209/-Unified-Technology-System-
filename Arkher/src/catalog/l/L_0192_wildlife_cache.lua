-- ARKHER SYSTEM L.0192 :: Wildlife Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0192"
	S.key = "arkher.sim.wildlife.aggregate_cache"
	S.name = "Wildlife Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wildlife.fidelity_policy" }
	S.tags = { "l", "wildlife", "cache", "sim" }
	S.description = "Wildlife Aggregate Cache: reuse of expensive aggregate computations for the Wildlife subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.wildlife.aggregate_cache", policy = "lru", capacity = 404, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
