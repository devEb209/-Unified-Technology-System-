-- ARKHER SYSTEM Z.0550 :: Reputation Web Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0550"
	S.key = "arkher.origin.reputationweb.self_critique"
	S.name = "Reputation Web Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.intent_bridge" }
	S.tags = { "z", "reputationweb", "critic", "origin" }
	S.description = "Reputation Web Self Critique: weighted judgement of the technology's own output for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.reputationweb.self_critique", passMark = 0.80, reviseMark = 0.40, seed = 72940 })
		inst.system = S
		inst.ctx = ctx
