-- ARKHER SYSTEM G.0355 :: Batch Inference Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0355"
	S.key = "arkher.neural.batchinference.model_registry"
	S.name = "Batch Inference Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.batchinference.reconstruction" }
	S.tags = { "g", "batchinference", "registry", "neural" }
	S.description = "Batch Inference Model Registry: named models and their lifecycle for the Batch Inference subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.batchinference.model_registry" })
		inst.system = S
		inst.ctx = ctx
