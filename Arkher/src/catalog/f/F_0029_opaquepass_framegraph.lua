-- ARKHER SYSTEM F.0029 :: Opaque Pass Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0029"
	S.key = "arkher.render.opaquepass.frame_graph"
	S.name = "Opaque Pass Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Opaque Pass"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "opaquepass", "framegraph", "render" }
	S.description = "Opaque Pass Frame Graph: declared passes, culling, ordering and aliasing for the Opaque Pass subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.opaquepass.frame_graph", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
