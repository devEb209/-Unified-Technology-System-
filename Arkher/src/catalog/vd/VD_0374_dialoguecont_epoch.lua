-- ARKHER SYSTEM VD.0374 :: Dialogue Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0374"
	S.key = "arkher.contsim.dialoguecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.dialoguecont.infinite_grid" }
	S.tags = { "vd", "dialoguecont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.dialoguecont.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
