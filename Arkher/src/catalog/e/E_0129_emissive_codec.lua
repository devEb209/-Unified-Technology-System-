-- ARKHER SYSTEM E.0129 :: Emissive Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0129"
	S.key = "arkher.material.emissive.compression_codec"
	S.name = "Emissive Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Emissive"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.emissive.streaming" }
	S.tags = { "e", "emissive", "codec", "material" }
	S.description = "Emissive Compression Codec: serialization and compression of material data for the Emissive subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.emissive.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
