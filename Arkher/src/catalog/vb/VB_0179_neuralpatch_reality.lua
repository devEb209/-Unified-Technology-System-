-- ARKHER SYSTEM VB.0179 :: Neural Patch Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0179"
	S.key = "arkher.conttime.neuralpatch.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.neuralpatch.simulation_fabric" }
	S.tags = { "vb", "neuralpatch", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.neuralpatch.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
