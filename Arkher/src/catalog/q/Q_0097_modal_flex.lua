-- ARKHER SYSTEM Q.0097 :: Modal Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0097"
	S.key = "arkher.ui.modal.responsive_layout"
	S.name = "Modal Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Modal"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "modal", "flex", "ui" }
	S.description = "Modal Responsive Layout: flex solving with safe areas, weights and breakpoints for the Modal subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.modal.responsive_layout", width = 510, height = 1084, scale = 1.04 })
		inst.system = S
		inst.ctx = ctx
