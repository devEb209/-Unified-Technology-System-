-- ARKHER SYSTEM I.0049 :: Pose Buffer Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0049"
	S.key = "arkher.anim.posebuffer.pose_cache"
	S.name = "Pose Buffer Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Pose Buffer"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.posebuffer.playback_pipeline" }
	S.tags = { "i", "posebuffer", "cache", "anim" }
	S.description = "Pose Buffer Pose Cache: reuse of sampled poses across frames and instances for the Pose Buffer subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.posebuffer.pose_cache", policy = "ttl", capacity = 304, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
