-- ARKHER SYSTEM VA.0480 :: VFX Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0480"
	S.key = "arkher.contworld.vfxcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vfxcont.reality_continuum" }
	S.tags = { "va", "vfxcont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.vfxcont.emergence_continuum", windowSize = 6, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
