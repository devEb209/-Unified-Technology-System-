-- ARKHER SYSTEM E.0399 :: Texture Atlas Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0399"
	S.key = "arkher.material.atlas.compression_codec"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.atlas.streaming" }
	S.tags = { "e", "atlas", "codec", "material" }
	S.description = "Texture Atlas Compression Codec: serialization and compression of material data for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.atlas.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
