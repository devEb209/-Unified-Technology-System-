-- ARKHER SYSTEM E.0189 :: Anisotropy Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0189"
	S.key = "arkher.material.anisotropy.compression_codec"
	S.name = "Anisotropy Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Anisotropy"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.anisotropy.streaming" }
	S.tags = { "e", "anisotropy", "codec", "material" }
	S.description = "Anisotropy Compression Codec: serialization and compression of material data for the Anisotropy subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.anisotropy.compression_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
