-- ARKHER SYSTEM VC.0343 :: Society Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0343"
	S.key = "arkher.contneural.societycont.neural_field"
	S.name = "Society Continuum Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.societycont.coherence_guard" }
	S.tags = { "vc", "societycont", "neuralfield", "contneural" }
	S.description = "Society Continuum Neural Field: neural field encoding and reconstruction for the Society Continuum subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.societycont.neural_field", dims = 24, hidden = 20, seed = 14863 })
		inst.system = S
		inst.ctx = ctx
