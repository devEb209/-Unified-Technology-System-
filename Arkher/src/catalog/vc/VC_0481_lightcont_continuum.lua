-- ARKHER SYSTEM VC.0481 :: Lighting Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0481"
	S.key = "arkher.contneural.lightcont.infinite_grid"
	S.name = "Lighting Continuum Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "lightcont", "continuum", "contneural" }
	S.description = "Lighting Continuum Infinite Grid: seamless paging of the infinite world grid for the Lighting Continuum subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.lightcont.infinite_grid", cellSize = 160, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
