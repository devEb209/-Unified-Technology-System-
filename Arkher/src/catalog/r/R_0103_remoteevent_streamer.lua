-- ARKHER SYSTEM R.0103 :: Remote Event Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0103"
	S.key = "arkher.net.remoteevent.interest_streaming"
	S.name = "Remote Event Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Remote Event"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remoteevent.serialization_codec" }
	S.tags = { "r", "remoteevent", "streamer", "net" }
	S.description = "Remote Event Interest Streaming: distance-driven residency of replicated content for the Remote Event subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.remoteevent.interest_streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
