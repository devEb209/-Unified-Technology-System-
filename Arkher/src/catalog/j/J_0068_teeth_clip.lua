-- ARKHER SYSTEM J.0068 :: Teeth Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0068"
	S.key = "arkher.character.teeth.motion_set"
	S.name = "Teeth Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.teeth.rig_definition" }
	S.tags = { "j", "teeth", "clip", "character" }
	S.description = "Teeth Motion Set: the clips a character owns and how they sample for the Teeth subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.teeth.motion_set", duration = 0.90, loop = true })
		inst.system = S
		inst.ctx = ctx
