-- ARKHER SYSTEM H.0550 :: Cloth Simulation Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0550"
	S.key = "arkher.physics.cloth.constraint_solver"
	S.name = "Cloth Simulation Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.cloth.contact_generation" }
	S.tags = { "h", "cloth", "constraint", "physics" }
	S.description = "Cloth Simulation Constraint Solver: sequential impulses, friction, joints and warm starting for the Cloth Simulation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.cloth.constraint_solver", iterations = 6, baumgarte = 0.22, warmStart = true })
		inst.system = S
		inst.ctx = ctx
