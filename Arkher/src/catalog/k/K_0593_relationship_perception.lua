-- ARKHER SYSTEM K.0593 :: Relationship Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0593"
	S.key = "arkher.npc.relationship.perception"
	S.name = "Relationship Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.relationship.emotion" }
	S.tags = { "k", "relationship", "perception", "npc" }
	S.description = "Relationship Perception: sight, hearing and bounded attention for the Relationship subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.relationship.perception", sightRange = 40, hearingRange = 24, attentionSlots = 6, fov = 1.630 })
		inst.system = S
		inst.ctx = ctx
