-- ARKHER SYSTEM L.0457 :: Justice Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0457"
	S.key = "arkher.sim.justice.route_network"
	S.name = "Justice Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.justice.region_graph" }
	S.tags = { "l", "justice", "network", "sim" }
	S.description = "Justice Route Network: roads, rivers and routes between settlements for the Justice subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.justice.route_network" })
		inst.system = S
		inst.ctx = ctx
