-- ARKHER SYSTEM T.0158 :: Code Generation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0158"
	S.key = "arkher.ai.codegeneration.self_critique"
	S.name = "Code Generation Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.codegeneration.plan_workflow" }
	S.tags = { "t", "codegeneration", "critic", "ai" }
	S.description = "Code Generation Self Critique: weighted evaluation of the result against declared criteria for the Code Generation subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.codegeneration.self_critique", passMark = 0.82, reviseMark = 0.47, seed = 85167 })
		inst.system = S
		inst.ctx = ctx
