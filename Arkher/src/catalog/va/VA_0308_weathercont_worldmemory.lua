-- ARKHER SYSTEM VA.0308 :: Weather Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0308"
	S.key = "arkher.contworld.weathercont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.weathercont.neural_field" }
	S.tags = { "va", "weathercont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.weathercont.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
