-- ARKHER SYSTEM H.0666 :: Raycast Query Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0666"
	S.key = "arkher.physics.raycast.broadphase_index"
	S.name = "Raycast Query Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.raycast.vehicle" }
	S.tags = { "h", "raycast", "index", "physics" }
	S.description = "Raycast Query Broadphase Index: spatial acceleration of candidate pair finding for the Raycast Query subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.raycast.broadphase_index", mode = "hash", cellSize = 72 })
		inst.system = S
		inst.ctx = ctx
