-- ARKHER SYSTEM J.0193 :: Armor Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0193"
	S.key = "arkher.character.armor.locomotion"
	S.name = "Armor Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.armor.physical_response" }
	S.tags = { "j", "armor", "charmotor", "character" }
	S.description = "Armor Locomotion: capsule locomotion driving the character for the Armor subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.armor.locomotion", radius = 0.48, height = 1.73, maxSpeed = 5.30, jumpHeight = 1.30, stepOffset = 0.38 })
		inst.system = S
		inst.ctx = ctx
