-- ARKHER SYSTEM VD.0551 :: World Fabric Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0551"
	S.key = "arkher.contsim.worldfabric.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldfabric.simulation_fabric" }
	S.tags = { "vd", "worldfabric", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.worldfabric.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
