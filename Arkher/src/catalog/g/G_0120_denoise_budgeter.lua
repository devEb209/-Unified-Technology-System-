-- ARKHER SYSTEM G.0120 :: Denoising Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0120"
	S.key = "arkher.neural.denoise.compute_budget"
	S.name = "Denoising Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.denoise.quality_predictor" }
	S.tags = { "g", "denoise", "budgeter", "neural" }
	S.description = "Denoising Compute Budget: inference time budget allocation for the Denoising subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.denoise.compute_budget", total = 209, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
