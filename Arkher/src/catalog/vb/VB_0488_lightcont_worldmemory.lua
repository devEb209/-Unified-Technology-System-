-- ARKHER SYSTEM VB.0488 :: Lighting Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0488"
	S.key = "arkher.conttime.lightcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lightcont.neural_field" }
	S.tags = { "vb", "lightcont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.lightcont.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
