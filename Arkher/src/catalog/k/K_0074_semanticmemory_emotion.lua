-- ARKHER SYSTEM K.0074 :: Semantic Memory Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0074"
	S.key = "arkher.npc.semanticmemory.emotion"
	S.name = "Semantic Memory Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.semanticmemory.drive_system" }
	S.tags = { "k", "semanticmemory", "emotion", "npc" }
	S.description = "Semantic Memory Emotion: appraisal of events into valence, arousal and mood for the Semantic Memory subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.semanticmemory.emotion", inertia = 0.81, decayRate = 0.26, baselineArousal = 0.16 })
		inst.system = S
		inst.ctx = ctx
