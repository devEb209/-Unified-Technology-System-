-- ARKHER SYSTEM L.0009 :: Living World State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0009"
	S.key = "arkher.sim.livingworld.state_codec"
	S.name = "Living World State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livingworld.history_ledger" }
	S.tags = { "l", "livingworld", "codec", "sim" }
	S.description = "Living World State Codec: persistence, diffing and checksum of the world state for the Living World subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.livingworld.state_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
