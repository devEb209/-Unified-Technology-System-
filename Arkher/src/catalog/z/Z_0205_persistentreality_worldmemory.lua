-- ARKHER SYSTEM Z.0205 :: Persistent Reality State World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0205"
	S.key = "arkher.origin.persistentreality.world_memory"
	S.name = "Persistent Reality State World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.autonomous_pipeline" }
	S.tags = { "z", "persistentreality", "worldmemory", "origin" }
	S.description = "Persistent Reality State World Memory: epoch-stamped persistent history with compaction and checkpoints for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.persistentreality.world_memory", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
