-- ARKHER SYSTEM H.0019 :: Static Body Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0019"
	S.key = "arkher.physics.staticbody.query"
	S.name = "Static Body Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Static Body"
	S.aspect = "Query"
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.staticbody.constraint_solver" }
	S.tags = { "h", "staticbody", "raycaster", "physics" }
	S.description = "Static Body Query: rays, sweeps and overlaps against the simulation for the Static Body subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.staticbody.query", cellSize = 48 })
		inst.system = S
		inst.ctx = ctx
