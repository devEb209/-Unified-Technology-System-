-- ARKHER SYSTEM P.0349 :: Threat Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0349"
	S.key = "arkher.play.threat.attributes"
	S.name = "Threat Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Threat"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "threat", "stats", "play" }
	S.description = "Threat Attributes: base values, layered modifiers and derived statistics for the Threat subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.threat.attributes" })
		inst.system = S
		inst.ctx = ctx
