-- ARKHER SYSTEM E.0383 :: Terrain Splat Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0383"
	S.key = "arkher.material.splat.streaming"
	S.name = "Terrain Splat Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.splat.parameter_budget" }
	S.tags = { "e", "splat", "streamer", "material" }
	S.description = "Terrain Splat Streaming: residency and demand-driven texture streaming for the Terrain Splat subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.splat.streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
