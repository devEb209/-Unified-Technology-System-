-- ARKHER SYSTEM G.0246 :: Behaviour Prediction Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0246"
	S.key = "arkher.neural.behaviorpredict.compute_budget"
	S.name = "Behaviour Prediction Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.behaviorpredict.quality_predictor" }
	S.tags = { "g", "behaviorpredict", "budgeter", "neural" }
	S.description = "Behaviour Prediction Compute Budget: inference time budget allocation for the Behaviour Prediction subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.behaviorpredict.compute_budget", total = 356, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
