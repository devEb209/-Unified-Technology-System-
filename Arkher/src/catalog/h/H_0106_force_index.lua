-- ARKHER SYSTEM H.0106 :: Force Accumulator Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0106"
	S.key = "arkher.physics.force.broadphase_index"
	S.name = "Force Accumulator Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.force.vehicle" }
	S.tags = { "h", "force", "index", "physics" }
	S.description = "Force Accumulator Broadphase Index: spatial acceleration of candidate pair finding for the Force Accumulator subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.force.broadphase_index", mode = "hash", cellSize = 72 })
		inst.system = S
		inst.ctx = ctx
