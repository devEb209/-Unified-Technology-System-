-- ARKHER SYSTEM F.0356 :: Temporal Accumulation Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0356"
	S.key = "arkher.render.temporalaccum.probe_volume"
	S.name = "Temporal Accumulation Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.temporalaccum.lighting_rig" }
	S.tags = { "f", "temporalaccum", "probe", "render" }
	S.description = "Temporal Accumulation Probe Volume: irradiance probes encoded in spherical harmonics for the Temporal Accumulation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.temporalaccum.probe_volume", spacing = 16 })
		inst.system = S
		inst.ctx = ctx
