-- ARKHER SYSTEM W.0265 :: Letterbox Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0265"
	S.key = "arkher.cine.letterbox.sequence_timeline"
	S.name = "Letterbox Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Letterbox"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "letterbox", "timeline", "cine" }
	S.description = "Letterbox Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Letterbox subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.letterbox.sequence_timeline", duration = 9.0, rate = 1.17 })
		inst.system = S
		inst.ctx = ctx
