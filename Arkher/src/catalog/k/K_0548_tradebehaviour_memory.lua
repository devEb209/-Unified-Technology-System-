-- ARKHER SYSTEM K.0548 :: Trade Behaviour Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0548"
	S.key = "arkher.npc.tradebehaviour.memory"
	S.name = "Trade Behaviour Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.tradebehaviour.mind_network" }
	S.tags = { "k", "tradebehaviour", "memory", "npc" }
	S.description = "Trade Behaviour Memory: episodic memory with decay, recall and consolidation for the Trade Behaviour subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.tradebehaviour.memory", capacity = 54, decayRate = 0.040, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
