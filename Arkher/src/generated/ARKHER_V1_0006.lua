--!strict
-- Neural DLSS — CORE Node_Flow #0006
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Neural DLSS — CORE Node_Flow #0006", size=Vector2.new(600, 440), pos=UDim2.fromOffset(178, 182), parent=parent, icon="♪"})
