-- ARKHER SYSTEM T.0635 :: Confidence Estimation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0635"
	S.key = "arkher.ai.confidence.world_architect"
	S.name = "Confidence Estimation World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.confidence.self_critique" }
	S.tags = { "t", "confidence", "architect", "ai" }
	S.description = "Confidence Estimation World Architect: composition of a whole world plan with conserved budgets for the Confidence Estimation subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.confidence.world_architect", budget = 700, seed = 37601 })
		inst.system = S
		inst.ctx = ctx
