-- ARKHER SYSTEM N.0106 :: Blood Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0106"
	S.key = "arkher.vfx.blood.particle_simulation"
	S.name = "Blood Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Blood"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.blood.emission" }
	S.tags = { "n", "blood", "particles", "vfx" }
	S.description = "Blood Particle Simulation: pooled integration of position, velocity, colour and life for the Blood subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.blood.particle_simulation", capacity = 192, drag = 0.18, bounce = 0.03, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
