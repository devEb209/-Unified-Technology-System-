-- ARKHER SYSTEM VC.0200 :: Architect District World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0200"
	S.key = "arkher.contneural.architectdistrict.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.architectdistrict.neural_field" }
	S.tags = { "vc", "architectdistrict", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.architectdistrict.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
