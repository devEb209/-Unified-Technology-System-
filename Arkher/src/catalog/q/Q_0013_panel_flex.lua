-- ARKHER SYSTEM Q.0013 :: Panel Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0013"
	S.key = "arkher.ui.panel.responsive_layout"
	S.name = "Panel Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Panel"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "panel", "flex", "ui" }
	S.description = "Panel Responsive Layout: flex solving with safe areas, weights and breakpoints for the Panel subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.panel.responsive_layout", width = 510, height = 1084, scale = 0.99 })
		inst.system = S
		inst.ctx = ctx
