-- ARKHER SYSTEM VD.0014 :: Region Tile Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0014"
	S.key = "arkher.contsim.regiontile.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.regiontile.infinite_grid" }
	S.tags = { "vd", "regiontile", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.regiontile.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
