-- ARKHER SYSTEM VC.0187 :: Simulation Domain Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0187"
	S.key = "arkher.contneural.simdomain.neural_field"
	S.name = "Simulation Domain Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.simdomain.coherence_guard" }
	S.tags = { "vc", "simdomain", "neuralfield", "contneural" }
	S.description = "Simulation Domain Neural Field: neural field encoding and reconstruction for the Simulation Domain subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.simdomain.neural_field", dims = 12, hidden = 8, seed = 55780 })
		inst.system = S
		inst.ctx = ctx
