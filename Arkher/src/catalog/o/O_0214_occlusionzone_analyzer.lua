-- ARKHER SYSTEM O.0214 :: Occlusion Zone Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0214"
	S.key = "arkher.audio.occlusionzone.analysis"
	S.name = "Occlusion Zone Analysis"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.occlusionzone.playback_policy" }
	S.tags = { "o", "occlusionzone", "analyzer", "audio" }
	S.description = "Occlusion Zone Analysis: loudness, headroom and masking analysis for the Occlusion Zone subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.occlusionzone.analysis", window = 184, buckets = 8, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
