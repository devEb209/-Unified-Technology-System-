-- ARKHER SYSTEM F.0249 :: Reflection Probe Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0249"
	S.key = "arkher.render.reflectionprobe.pass_cache"
	S.name = "Reflection Probe Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.reflectionprobe.render_policy" }
	S.tags = { "f", "reflectionprobe", "cache", "render" }
	S.description = "Reflection Probe Pass Cache: reuse of pass results across frames for the Reflection Probe subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.reflectionprobe.pass_cache", policy = "ttl", capacity = 452, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
