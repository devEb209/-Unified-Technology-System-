-- ARKHER SYSTEM Z.0479 :: Narrative Memory Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0479"
	S.key = "arkher.origin.narrativememory.residency_streaming"
	S.name = "Narrative Memory Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.budget_governor" }
	S.tags = { "z", "narrativememory", "streamer", "origin" }
	S.description = "Narrative Memory Residency Streaming: distance-driven residency of the technology's workload for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.narrativememory.residency_streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
