-- ARKHER SYSTEM E.0098 :: Height Displacement Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0098"
	S.key = "arkher.material.displacement.streaming"
	S.name = "Height Displacement Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.displacement.parameter_budget" }
	S.tags = { "e", "displacement", "streamer", "material" }
	S.description = "Height Displacement Streaming: residency and demand-driven texture streaming for the Height Displacement subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.displacement.streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
