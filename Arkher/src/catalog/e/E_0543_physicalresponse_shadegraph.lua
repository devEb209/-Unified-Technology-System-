-- ARKHER SYSTEM E.0543 :: Physical Response Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0543"
	S.key = "arkher.material.physicalresponse.shading_graph"
	S.name = "Physical Response Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.physicalresponse.layer_composition" }
	S.tags = { "e", "physicalresponse", "shadegraph", "material" }
	S.description = "Physical Response Shading Graph: node graph evaluated and compiled to Luau for the Physical Response subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.physicalresponse.shading_graph" })
		inst.system = S
		inst.ctx = ctx
