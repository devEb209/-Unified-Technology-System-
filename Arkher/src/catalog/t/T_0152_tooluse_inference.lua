-- ARKHER SYSTEM T.0152 :: Tool Use Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0152"
	S.key = "arkher.ai.tooluse.model_inference"
	S.name = "Tool Use Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.tooluse.action_planner" }
	S.tags = { "t", "tooluse", "inference", "ai" }
	S.description = "Tool Use Model Inference: quantized inference with batching and budget for the Tool Use subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.tooluse.model_inference", seed = 51997 })
		inst.system = S
		inst.ctx = ctx
