-- ARKHER SYSTEM VB.0319 :: Ecology Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0319"
	S.key = "arkher.conttime.ecologycont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.ecologycont.coherence_guard" }
	S.tags = { "vb", "ecologycont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.ecologycont.neural_field", dims = 12, hidden = 8, seed = 26040 })
		inst.system = S
		inst.ctx = ctx
