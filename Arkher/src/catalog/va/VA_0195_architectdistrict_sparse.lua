-- ARKHER SYSTEM VA.0195 :: Architect District Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0195"
	S.key = "arkher.contworld.architectdistrict.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.architectdistrict.epoch_clock" }
	S.tags = { "va", "architectdistrict", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.architectdistrict.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
