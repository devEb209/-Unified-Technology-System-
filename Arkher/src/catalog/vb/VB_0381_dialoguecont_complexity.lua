-- ARKHER SYSTEM VB.0381 :: Dialogue Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0381"
	S.key = "arkher.conttime.dialoguecont.complexity_budget"
	S.name = "Dialogue Continuum Complexity Budget"
	S.category = "VB"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.dialoguecont.world_memory_stream" }
	S.tags = { "vb", "dialoguecont", "complexity", "conttime" }
	S.description = "Dialogue Continuum Complexity Budget: complexity budgeting for the continuum for the Dialogue Continuum subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.dialoguecont.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
