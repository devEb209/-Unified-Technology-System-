-- ARKHER SYSTEM J.0145 :: Posture Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0145"
	S.key = "arkher.character.posture.motion_set"
	S.name = "Posture Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.posture.rig_definition" }
	S.tags = { "j", "posture", "clip", "character" }
	S.description = "Posture Motion Set: the clips a character owns and how they sample for the Posture subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.posture.motion_set", duration = 1.40, loop = false })
		inst.system = S
		inst.ctx = ctx
