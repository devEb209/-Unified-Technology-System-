-- ARKHER SYSTEM W.0077 :: Dolly Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0077"
	S.key = "arkher.cine.dolly.cut_policy"
	S.name = "Dolly Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dolly"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dolly.shot_composition" }
	S.tags = { "w", "dolly", "policy", "cine" }
	S.description = "Dolly Cut Policy: rules deciding when the sequence cuts and to what for the Dolly subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.dolly.cut_policy", algorithm = "edf", starvationGuard = 25 })
		inst.system = S
		inst.ctx = ctx
