-- ARKHER SYSTEM VB.0079 :: LOD Cascade Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0079"
	S.key = "arkher.conttime.lodcascade.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lodcascade.coherence_guard" }
	S.tags = { "vb", "lodcascade", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.lodcascade.neural_field", dims = 12, hidden = 8, seed = 592 })
		inst.system = S
		inst.ctx = ctx
