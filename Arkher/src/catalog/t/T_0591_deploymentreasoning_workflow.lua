-- ARKHER SYSTEM T.0591 :: Deployment Reasoning Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0591"
	S.key = "arkher.ai.deploymentreasoning.plan_workflow"
	S.name = "Deployment Reasoning Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.deploymentreasoning.semantic_knowledge" }
	S.tags = { "t", "deploymentreasoning", "workflow", "ai" }
	S.description = "Deployment Reasoning Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Deployment Reasoning subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.deploymentreasoning.plan_workflow", maxRetries = 2, budget = 80 })
		inst.system = S
		inst.ctx = ctx
