-- ARKHER SYSTEM P.0154 :: Crafting Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0154"
	S.key = "arkher.play.crafting.content_registry"
	S.name = "Crafting Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Crafting"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.crafting.difficulty_controller" }
	S.tags = { "p", "crafting", "registry", "play" }
	S.description = "Crafting Content Registry: catalogue of the definitions this loop instantiates for the Crafting subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.crafting.content_registry" })
		inst.system = S
		inst.ctx = ctx
