-- ARKHER SYSTEM F.0005 :: Frame Pipeline Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0005"
	S.key = "arkher.render.framepipeline.lighting_rig"
	S.name = "Frame Pipeline Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepipeline.geometry_virtualization" }
	S.tags = { "f", "framepipeline", "lightrig", "render" }
	S.description = "Frame Pipeline Lighting Rig: light clustering, importance and cascades for the Frame Pipeline subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.framepipeline.lighting_rig", maxActive = 9 })
		inst.system = S
		inst.ctx = ctx
