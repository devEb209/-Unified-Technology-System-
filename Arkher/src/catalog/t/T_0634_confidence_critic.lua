-- ARKHER SYSTEM T.0634 :: Confidence Estimation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0634"
	S.key = "arkher.ai.confidence.self_critique"
	S.name = "Confidence Estimation Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.confidence.plan_workflow" }
	S.tags = { "t", "confidence", "critic", "ai" }
	S.description = "Confidence Estimation Self Critique: weighted evaluation of the result against declared criteria for the Confidence Estimation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.confidence.self_critique", passMark = 0.83, reviseMark = 0.48, seed = 31408 })
		inst.system = S
		inst.ctx = ctx
