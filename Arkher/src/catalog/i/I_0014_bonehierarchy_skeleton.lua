-- ARKHER SYSTEM I.0014 :: Bone Hierarchy Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0014"
	S.key = "arkher.anim.bonehierarchy.skeleton"
	S.name = "Bone Hierarchy Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "bonehierarchy", "skeleton", "anim" }
	S.description = "Bone Hierarchy Skeleton: bone hierarchy, bind pose and world resolution for the Bone Hierarchy subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.bonehierarchy.skeleton" })
		inst.system = S
		inst.ctx = ctx
