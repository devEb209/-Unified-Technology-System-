-- ARKHER SYSTEM VA.0538 :: Pipeline Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0538"
	S.key = "arkher.contworld.pipelinecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.pipelinecont.complexity_budget" }
	S.tags = { "va", "pipelinecont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.pipelinecont.simulation_fabric", budgetMs = 1.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
