-- ARKHER SYSTEM T.0526 :: Audio Reasoning Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0526"
	S.key = "arkher.ai.audioreasoning.outcome_prediction"
	S.name = "Audio Reasoning Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.audioreasoning.decision_policy" }
	S.tags = { "t", "audioreasoning", "predictor", "ai" }
	S.description = "Audio Reasoning Outcome Prediction: forecasting the result before the work is done for the Audio Reasoning subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.audioreasoning.outcome_prediction", method = "ema", alpha = 0.15, window = 77 })
		inst.system = S
		inst.ctx = ctx
