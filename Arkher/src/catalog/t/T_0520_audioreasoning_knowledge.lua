-- ARKHER SYSTEM T.0520 :: Audio Reasoning Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0520"
	S.key = "arkher.ai.audioreasoning.semantic_knowledge"
	S.name = "Audio Reasoning Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.audioreasoning.intent_understanding" }
	S.tags = { "t", "audioreasoning", "knowledge", "ai" }
	S.description = "Audio Reasoning Semantic Knowledge: typed entities, weighted relations and inferred closure for the Audio Reasoning subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.audioreasoning.semantic_knowledge", dims = 24 })
		inst.system = S
		inst.ctx = ctx
