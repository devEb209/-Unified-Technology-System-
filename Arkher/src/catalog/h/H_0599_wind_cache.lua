-- ARKHER SYSTEM H.0599 :: Wind Force Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0599"
	S.key = "arkher.physics.wind.result_cache"
	S.name = "Wind Force Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Wind Force"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.wind.simulation_policy" }
	S.tags = { "h", "wind", "cache", "physics" }
	S.description = "Wind Force Result Cache: reuse of expensive simulation and query results for the Wind Force subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.wind.result_cache", policy = "ttl", capacity = 285, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
