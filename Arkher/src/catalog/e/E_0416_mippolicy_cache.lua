-- ARKHER SYSTEM E.0416 :: Mip Policy Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0416"
	S.key = "arkher.material.mippolicy.instance_cache"
	S.name = "Mip Policy Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Mip Policy"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.mippolicy.quality_policy" }
	S.tags = { "e", "mippolicy", "cache", "material" }
	S.description = "Mip Policy Instance Cache: resolved-parameter cache keyed by context for the Mip Policy subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.mippolicy.instance_cache", policy = "lfu", capacity = 161, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
