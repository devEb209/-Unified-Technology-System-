-- ARKHER SYSTEM L.0237 :: Weather Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0237"
	S.key = "arkher.sim.weather.aggregate_cache"
	S.name = "Weather Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.weather.fidelity_policy" }
	S.tags = { "l", "weather", "cache", "sim" }
	S.description = "Weather Aggregate Cache: reuse of expensive aggregate computations for the Weather subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.weather.aggregate_cache", policy = "ttl", capacity = 446, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
