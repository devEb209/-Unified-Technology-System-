-- ARKHER SYSTEM I.0434 :: Crowd Animation Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0434"
	S.key = "arkher.anim.crowdanim.physical_blend"
	S.name = "Crowd Animation Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crowdanim.inverse_kinematics" }
	S.tags = { "i", "crowdanim", "ragdoll", "anim" }
	S.description = "Crowd Animation Physical Blend: physical bones blended against the animated pose for the Crowd Animation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.crowdanim.physical_blend", blendSpeed = 5.60 })
		inst.system = S
		inst.ctx = ctx
