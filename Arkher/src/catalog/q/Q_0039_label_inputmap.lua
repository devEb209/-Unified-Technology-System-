-- ARKHER SYSTEM Q.0039 :: Label Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0039"
	S.key = "arkher.ui.label.input_mapping"
	S.name = "Label Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Label"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.label.widget_tree" }
	S.tags = { "q", "label", "inputmap", "ui" }
	S.description = "Label Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Label subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.label.input_mapping", device = "gamepad", holdTime = 0.30, deadzone = 0.20 })
		inst.system = S
		inst.ctx = ctx
