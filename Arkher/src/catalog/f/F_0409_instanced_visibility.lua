-- ARKHER SYSTEM F.0409 :: Instanced Draw Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0409"
	S.key = "arkher.render.instanced.visibility_set"
	S.name = "Instanced Draw Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.instanced.view_and_culling" }
	S.tags = { "f", "instanced", "visibility", "render" }
	S.description = "Instanced Draw Visibility Set: cell, portal and occluder visibility for the Instanced Draw subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.instanced.visibility_set", maxDepth = 2 })
		inst.system = S
		inst.ctx = ctx
