-- ARKHER SYSTEM E.0247 :: Triplanar Projection Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0247"
	S.key = "arkher.material.triplanar.parameter_budget"
	S.name = "Triplanar Projection Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.triplanar.variant_registry" }
	S.tags = { "e", "triplanar", "budgeter", "material" }
	S.description = "Triplanar Projection Parameter Budget: texel and layer budget allocation for the Triplanar Projection subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.triplanar.parameter_budget", total = 295, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
