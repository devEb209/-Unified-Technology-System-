-- ARKHER SYSTEM VA.0013 :: Region Tile Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0013"
	S.key = "arkher.contworld.regiontile.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "regiontile", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.regiontile.infinite_grid", cellSize = 128, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
