-- ARKHER SYSTEM VD.0514 :: Material Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0514"
	S.key = "arkher.contsim.materialcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.materialcont.complexity_budget" }
	S.tags = { "vd", "materialcont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.materialcont.simulation_fabric", budgetMs = 4.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
