-- ARKHER SYSTEM VC.0493 :: Rendering Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0493"
	S.key = "arkher.contneural.rendercont.infinite_grid"
	S.name = "Rendering Continuum Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "rendercont", "continuum", "contneural" }
	S.description = "Rendering Continuum Infinite Grid: seamless paging of the infinite world grid for the Rendering Continuum subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.rendercont.infinite_grid", cellSize = 160, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
