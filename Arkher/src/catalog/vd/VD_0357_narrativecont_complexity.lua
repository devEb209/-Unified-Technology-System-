-- ARKHER SYSTEM VD.0357 :: Narrative Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0357"
	S.key = "arkher.contsim.narrativecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.narrativecont.world_memory_stream" }
	S.tags = { "vd", "narrativecont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.narrativecont.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
