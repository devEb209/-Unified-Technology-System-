-- ARKHER SYSTEM P.0385 :: Score Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0385"
	S.key = "arkher.play.score.attributes"
	S.name = "Score Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Score"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "score", "stats", "play" }
	S.description = "Score Attributes: base values, layered modifiers and derived statistics for the Score subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.score.attributes" })
		inst.system = S
		inst.ctx = ctx
