-- ARKHER SYSTEM Z.0761 :: Semantic LOD Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0761"
	S.key = "arkher.origin.semanticlod.reality_layering"
	S.name = "Semantic LOD Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "semanticlod", "reality", "origin" }
	S.description = "Semantic LOD Reality Layering: stacked authored, simulated, proposed and player realities for the Semantic LOD subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.semanticlod.reality_layering" })
		inst.system = S
		inst.ctx = ctx
