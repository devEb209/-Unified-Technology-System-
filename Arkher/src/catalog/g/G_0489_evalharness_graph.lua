-- ARKHER SYSTEM G.0489 :: Evaluation Harness Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0489"
	S.key = "arkher.neural.evalharness.sampling_graph"
	S.name = "Evaluation Harness Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.evalharness.training_ledger" }
	S.tags = { "g", "evalharness", "graph", "neural" }
	S.description = "Evaluation Harness Sampling Graph: dependency graph of sampling stages for the Evaluation Harness subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.evalharness.sampling_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
