-- ARKHER SYSTEM E.0214 :: Iridescence Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0214"
	S.key = "arkher.material.iridescence.texture_sampling"
	S.name = "Iridescence Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Iridescence"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.iridescence.shading_graph" }
	S.tags = { "e", "iridescence", "sampler", "material" }
	S.description = "Iridescence Texture Sampling: atlas packing, mip chain and filtered sampling for the Iridescence subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.iridescence.texture_sampling", atlasSize = 256, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
