...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Cascadeur — CORE Profiler #0164", size=Vector2.new(680, 500), pos=UDim2.fromOffset(232, 268), parent=parent, icon="☷"})
