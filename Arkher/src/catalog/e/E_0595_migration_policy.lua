-- ARKHER SYSTEM E.0595 :: Material Migration Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0595"
	S.key = "arkher.material.migration.quality_policy"
	S.name = "Material Migration Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.migration.compression_codec" }
	S.tags = { "e", "migration", "policy", "material" }
	S.description = "Material Migration Quality Policy: device tier rules for the surface for the Material Migration subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.migration.quality_policy", algorithm = "edf", starvationGuard = 17 })
		inst.system = S
		inst.ctx = ctx
