-- ARKHER SYSTEM V.0190 :: Scene Asset Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0190"
	S.key = "arkher.asset.sceneasset.validation_guard"
	S.name = "Scene Asset Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.sceneasset.size_budget" }
	S.tags = { "v", "sceneasset", "guard", "asset" }
	S.description = "Scene Asset Validation Guard: rate limiting and capability checks on the import path for the Scene Asset subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.sceneasset.validation_guard", algorithm = "leaky", capacity = 146, refillPerSec = 31, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
