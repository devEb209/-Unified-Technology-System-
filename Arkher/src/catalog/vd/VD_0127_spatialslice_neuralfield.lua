-- ARKHER SYSTEM VD.0127 :: Spatial Slice Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0127"
	S.key = "arkher.contsim.spatialslice.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.spatialslice.coherence_guard" }
	S.tags = { "vd", "spatialslice", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.spatialslice.neural_field", dims = 12, hidden = 8, seed = 87508 })
		inst.system = S
		inst.ctx = ctx
