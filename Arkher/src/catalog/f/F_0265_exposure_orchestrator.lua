-- ARKHER SYSTEM F.0265 :: Exposure Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0265"
	S.key = "arkher.render.exposure.orchestration"
	S.name = "Exposure Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Exposure"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.exposure.frame_analysis" }
	S.tags = { "f", "exposure", "orchestrator", "render" }
	S.description = "Exposure Orchestration: frame lifecycle orchestration for the Exposure subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.exposure.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
