-- ARKHER SYSTEM H.0521 :: Breakable Joint Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0521"
	S.key = "arkher.physics.breakjoint.contact_generation"
	S.name = "Breakable Joint Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.breakjoint.collision_shape" }
	S.tags = { "h", "breakjoint", "contact", "physics" }
	S.description = "Breakable Joint Contact Generation: narrow-phase manifolds with normal, depth and point for the Breakable Joint subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.breakjoint.contact_generation", slop = 0.0070, maxManifolds = 299 })
		inst.system = S
		inst.ctx = ctx
