-- ARKHER SYSTEM E.0025 :: Surface Definition Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0025"
	S.key = "arkher.material.surfacedef.quality_policy"
	S.name = "Surface Definition Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.surfacedef.compression_codec" }
	S.tags = { "e", "surfacedef", "policy", "material" }
	S.description = "Surface Definition Quality Policy: device tier rules for the surface for the Surface Definition subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.surfacedef.quality_policy", algorithm = "lottery", starvationGuard = 55 })
		inst.system = S
		inst.ctx = ctx
