-- ARKHER SYSTEM VA.0226 :: Terrain Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0226"
	S.key = "arkher.contworld.terraincont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.terraincont.complexity_budget" }
	S.tags = { "va", "terraincont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.terraincont.simulation_fabric", budgetMs = 2.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
