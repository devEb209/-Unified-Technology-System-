-- ARKHER SYSTEM V.0426 :: Asset Debug Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0426"
	S.key = "arkher.asset.assetdebug.content_cache"
	S.name = "Asset Debug Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetdebug.dependency_graph" }
	S.tags = { "v", "assetdebug", "cache", "asset" }
	S.description = "Asset Debug Content Cache: reuse of already cooked results for the Asset Debug subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.assetdebug.content_cache", policy = "lfu", capacity = 419, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
