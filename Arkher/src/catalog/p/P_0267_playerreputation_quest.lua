-- ARKHER SYSTEM P.0267 :: Reputation Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0267"
	S.key = "arkher.play.playerreputation.objectives"
	S.name = "Reputation Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Reputation"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playerreputation.inventory" }
	S.tags = { "p", "playerreputation", "quest", "play" }
	S.description = "Reputation Objectives: objectives, prerequisites, progress and rewards for the Reputation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.playerreputation.objectives" })
		inst.system = S
		inst.ctx = ctx
