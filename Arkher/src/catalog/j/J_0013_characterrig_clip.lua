-- ARKHER SYSTEM J.0013 :: Character Rig Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0013"
	S.key = "arkher.character.characterrig.motion_set"
	S.name = "Character Rig Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterrig.rig_definition" }
	S.tags = { "j", "characterrig", "clip", "character" }
	S.description = "Character Rig Motion Set: the clips a character owns and how they sample for the Character Rig subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.characterrig.motion_set", duration = 1.20, loop = true })
		inst.system = S
		inst.ctx = ctx
