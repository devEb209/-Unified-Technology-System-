-- ARKHER SYSTEM VD.0587 :: Thermal Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0587"
	S.key = "arkher.contsim.thermalcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.thermalcont.simulation_fabric" }
	S.tags = { "vd", "thermalcont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.thermalcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
