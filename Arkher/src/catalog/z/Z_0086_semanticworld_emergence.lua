-- ARKHER SYSTEM Z.0086 :: Semantic World Graph Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0086"
	S.key = "arkher.origin.semanticworld.emergence_detection"
	S.name = "Semantic World Graph Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticworld.world_memory" }
	S.tags = { "z", "semanticworld", "emergence", "origin" }
	S.description = "Semantic World Graph Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.semanticworld.emergence_detection", windowSize = 6, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
