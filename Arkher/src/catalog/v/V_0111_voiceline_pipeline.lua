-- ARKHER SYSTEM V.0111 :: Voice Line Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0111"
	S.key = "arkher.asset.voiceline.cook_pipeline"
	S.name = "Voice Line Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.voiceline.bundling" }
	S.tags = { "v", "voiceline", "pipeline", "asset" }
	S.description = "Voice Line Cook Pipeline: staged cooking with isolation and retries for the Voice Line subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.voiceline.cook_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
