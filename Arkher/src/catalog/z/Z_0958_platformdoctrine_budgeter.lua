-- ARKHER SYSTEM Z.0958 :: Platform Abstraction Doctrine Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0958"
	S.key = "arkher.origin.platformdoctrine.budget_governor"
	S.name = "Platform Abstraction Doctrine Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.platformdoctrine.behaviour_analysis" }
	S.tags = { "z", "platformdoctrine", "budgeter", "origin" }
	S.description = "Platform Abstraction Doctrine Budget Governor: allocation of a scarce resource across the technology's consumers for the Platform Abstraction Doctrine subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.platformdoctrine.budget_governor", total = 172, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
