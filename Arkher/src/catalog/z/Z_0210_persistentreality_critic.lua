-- ARKHER SYSTEM Z.0210 :: Persistent Reality State Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0210"
	S.key = "arkher.origin.persistentreality.self_critique"
	S.name = "Persistent Reality State Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.intent_bridge" }
	S.tags = { "z", "persistentreality", "critic", "origin" }
	S.description = "Persistent Reality State Self Critique: weighted judgement of the technology's own output for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.persistentreality.self_critique", passMark = 0.83, reviseMark = 0.43, seed = 45913 })
		inst.system = S
		inst.ctx = ctx
