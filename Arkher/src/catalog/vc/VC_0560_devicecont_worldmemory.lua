-- ARKHER SYSTEM VC.0560 :: Device Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0560"
	S.key = "arkher.contneural.devicecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.devicecont.neural_field" }
	S.tags = { "vc", "devicecont", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.devicecont.world_memory_stream", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
