-- ARKHER SYSTEM J.0059 :: Eyes Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0059"
	S.key = "arkher.character.eyes.look_and_reach"
	S.name = "Eyes Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.eyes.blend_controller" }
	S.tags = { "j", "eyes", "ik", "character" }
	S.description = "Eyes Look And Reach: look-at, reach and foot placement for the character for the Eyes subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.eyes.look_and_reach", iterations = 6, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
