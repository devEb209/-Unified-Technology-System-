-- ARKHER SYSTEM H.0375 :: Collision Layer Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0375"
	S.key = "arkher.physics.collisionlayer.result_cache"
	S.name = "Collision Layer Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionlayer.simulation_policy" }
	S.tags = { "h", "collisionlayer", "cache", "physics" }
	S.description = "Collision Layer Result Cache: reuse of expensive simulation and query results for the Collision Layer subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.collisionlayer.result_cache", policy = "lru", capacity = 339, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
