-- ARKHER SYSTEM T.0452 :: Behaviour Learning Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0452"
	S.key = "arkher.ai.behaviourlearning.self_critique"
	S.name = "Behaviour Learning Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.behaviourlearning.plan_workflow" }
	S.tags = { "t", "behaviourlearning", "critic", "ai" }
	S.description = "Behaviour Learning Self Critique: weighted evaluation of the result against declared criteria for the Behaviour Learning subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.behaviourlearning.self_critique", passMark = 0.72, reviseMark = 0.42, seed = 9212 })
		inst.system = S
		inst.ctx = ctx
