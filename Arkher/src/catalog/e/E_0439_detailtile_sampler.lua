-- ARKHER SYSTEM E.0439 :: Detail Tiling Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0439"
	S.key = "arkher.material.detailtile.texture_sampling"
	S.name = "Detail Tiling Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.detailtile.shading_graph" }
	S.tags = { "e", "detailtile", "sampler", "material" }
	S.description = "Detail Tiling Texture Sampling: atlas packing, mip chain and filtered sampling for the Detail Tiling subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.detailtile.texture_sampling", atlasSize = 128, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
