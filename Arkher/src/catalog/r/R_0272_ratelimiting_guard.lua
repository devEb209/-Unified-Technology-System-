-- ARKHER SYSTEM R.0272 :: Rate Limiting Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0272"
	S.key = "arkher.net.ratelimiting.rate_guard"
	S.name = "Rate Limiting Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.ratelimiting.interest_streaming" }
	S.tags = { "r", "ratelimiting", "guard", "net" }
	S.description = "Rate Limiting Rate Guard: token-bucket protection against floods and abuse for the Rate Limiting subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.ratelimiting.rate_guard", algorithm = "sliding", capacity = 116, refillPerSec = 21, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
