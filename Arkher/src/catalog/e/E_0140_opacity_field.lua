-- ARKHER SYSTEM E.0140 :: Opacity Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0140"
	S.key = "arkher.material.opacity.procedural_detail"
	S.name = "Opacity Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Opacity"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.opacity.texture_sampling" }
	S.tags = { "e", "opacity", "field", "material" }
	S.description = "Opacity Procedural Detail: coherent noise detail driving the surface for the Opacity subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.opacity.procedural_detail", seed = 37098, frequency = 0.0085, octaves = 5, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
