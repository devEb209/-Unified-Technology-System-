-- ARKHER SYSTEM Q.0126 :: Tooltip Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0126"
	S.key = "arkher.ui.tooltip.theme_composition"
	S.name = "Tooltip Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tooltip"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.tooltip.navigation_graph" }
	S.tags = { "q", "tooltip", "composer", "ui" }
	S.description = "Tooltip Theme Composition: blending of theme signals into the final appearance for the Tooltip subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.tooltip.theme_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
