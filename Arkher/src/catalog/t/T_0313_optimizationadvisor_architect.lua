-- ARKHER SYSTEM T.0313 :: Optimization Advisor World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0313"
	S.key = "arkher.ai.optimizationadvisor.world_architect"
	S.name = "Optimization Advisor World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.optimizationadvisor.self_critique" }
	S.tags = { "t", "optimizationadvisor", "architect", "ai" }
	S.description = "Optimization Advisor World Architect: composition of a whole world plan with conserved budgets for the Optimization Advisor subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.optimizationadvisor.world_architect", budget = 700, seed = 28821 })
		inst.system = S
		inst.ctx = ctx
