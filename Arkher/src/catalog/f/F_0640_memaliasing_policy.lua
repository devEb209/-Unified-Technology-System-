-- ARKHER SYSTEM F.0640 :: Memory Aliasing Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0640"
	S.key = "arkher.render.memaliasing.render_policy"
	S.name = "Memory Aliasing Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.memaliasing.draw_budget" }
	S.tags = { "f", "memaliasing", "policy", "render" }
	S.description = "Memory Aliasing Render Policy: device tier rules for the frame for the Memory Aliasing subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.memaliasing.render_policy", algorithm = "wfq", starvationGuard = 58 })
		inst.system = S
		inst.ctx = ctx
