-- ARKHER SYSTEM VC.0465 :: Audio Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0465"
	S.key = "arkher.contneural.audiocont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.audiocont.world_memory_stream" }
	S.tags = { "vc", "audiocont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.audiocont.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
