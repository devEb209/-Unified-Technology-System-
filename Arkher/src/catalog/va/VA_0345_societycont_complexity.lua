-- ARKHER SYSTEM VA.0345 :: Society Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0345"
	S.key = "arkher.contworld.societycont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.societycont.world_memory_stream" }
	S.tags = { "va", "societycont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.societycont.complexity_budget", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
