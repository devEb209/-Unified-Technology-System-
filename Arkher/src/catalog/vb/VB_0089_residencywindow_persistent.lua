-- ARKHER SYSTEM VB.0089 :: Residency Window Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0089"
	S.key = "arkher.conttime.residencywindow.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.residencywindow.multi-scale_fidelity" }
	S.tags = { "vb", "residencywindow", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.residencywindow.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
