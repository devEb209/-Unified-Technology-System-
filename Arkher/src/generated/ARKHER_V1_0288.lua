...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Neural DLSS — CORE Map #0288", size=Vector2.new(600, 480), pos=UDim2.fromOffset(244, 296), parent=parent, icon="▭"})
