-- ARKHER SYSTEM VA.0283 :: Water Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0283"
	S.key = "arkher.contworld.watercont.neural_field"
	S.name = "Water Continuum Neural Field"
	S.category = "VA"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.watercont.coherence_guard" }
	S.tags = { "va", "watercont", "neuralfield", "contworld" }
	S.description = "Water Continuum Neural Field: neural field encoding and reconstruction for the Water Continuum subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.watercont.neural_field", dims = 16, hidden = 12, seed = 68505 })
		inst.system = S
		inst.ctx = ctx
