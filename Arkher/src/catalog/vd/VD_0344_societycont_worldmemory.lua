-- ARKHER SYSTEM VD.0344 :: Society Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0344"
	S.key = "arkher.contsim.societycont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.societycont.neural_field" }
	S.tags = { "vd", "societycont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.societycont.world_memory_stream", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
