-- ARKHER SYSTEM N.0223 :: Magic Aura Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0223"
	S.key = "arkher.vfx.magicaura.particle_simulation"
	S.name = "Magic Aura Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Magic Aura"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.magicaura.emission" }
	S.tags = { "n", "magicaura", "particles", "vfx" }
	S.description = "Magic Aura Particle Simulation: pooled integration of position, velocity, colour and life for the Magic Aura subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.magicaura.particle_simulation", capacity = 448, drag = 0.22, bounce = 0.17, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
