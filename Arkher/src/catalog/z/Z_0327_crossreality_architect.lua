-- ARKHER SYSTEM Z.0327 :: Cross Reality Sync World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0327"
	S.key = "arkher.origin.crossreality.world_architect"
	S.name = "Cross Reality Sync World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.emergence_detection" }
	S.tags = { "z", "crossreality", "architect", "origin" }
	S.description = "Cross Reality Sync World Architect: hierarchical world composition with conserved budgets for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.crossreality.world_architect", budget = 1500, seed = 88409 })
		inst.system = S
		inst.ctx = ctx
