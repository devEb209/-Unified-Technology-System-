-- ARKHER SYSTEM F.0281 :: Color Grading Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0281"
	S.key = "arkher.render.grading.frame_graph"
	S.name = "Color Grading Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "grading", "framegraph", "render" }
	S.description = "Color Grading Frame Graph: declared passes, culling, ordering and aliasing for the Color Grading subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.grading.frame_graph", budgetMs = 11.00 })
		inst.system = S
		inst.ctx = ctx
