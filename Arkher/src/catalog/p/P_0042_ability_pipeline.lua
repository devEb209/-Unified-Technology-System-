-- ARKHER SYSTEM P.0042 :: Ability Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0042"
	S.key = "arkher.play.ability.rule_pipeline"
	S.name = "Ability Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ability"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ability.state_machine" }
	S.tags = { "p", "ability", "pipeline", "play" }
	S.description = "Ability Rule Pipeline: ordered rules applied to every gameplay event for the Ability subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.ability.rule_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
