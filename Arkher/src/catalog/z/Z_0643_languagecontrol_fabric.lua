-- ARKHER SYSTEM Z.0643 :: Natural Language Engine Control Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0643"
	S.key = "arkher.origin.languagecontrol.simulation_fabric"
	S.name = "Natural Language Engine Control Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.languagecontrol.complexity_governance" }
	S.tags = { "z", "languagecontrol", "fabric", "origin" }
	S.description = "Natural Language Engine Control Simulation Fabric: every simulation domain stepped under one budgeted clock for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.languagecontrol.simulation_fabric", budgetMs = 2.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
