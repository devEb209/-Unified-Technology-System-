-- ARKHER SYSTEM K.0629 :: Reputation Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0629"
	S.key = "arkher.npc.reputation.thinking_budget"
	S.name = "Reputation Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.reputation.daily_schedule" }
	S.tags = { "k", "reputation", "budgeter", "npc" }
	S.description = "Reputation Thinking Budget: allocation of per-frame thinking time across NPCs for the Reputation subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.reputation.thinking_budget", total = 263, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
