-- ARKHER SYSTEM VC.0121 :: Spatial Slice Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0121"
	S.key = "arkher.contneural.spatialslice.infinite_grid"
	S.name = "Spatial Slice Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "spatialslice", "continuum", "contneural" }
	S.description = "Spatial Slice Infinite Grid: seamless paging of the infinite world grid for the Spatial Slice subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.spatialslice.infinite_grid", cellSize = 160, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
