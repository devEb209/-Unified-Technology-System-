-- ARKHER SYSTEM Q.0014 :: Panel Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0014"
	S.key = "arkher.ui.panel.widget_tree"
	S.name = "Panel Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Panel"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.panel.responsive_layout" }
	S.tags = { "q", "panel", "widget", "ui" }
	S.description = "Panel Widget Tree: retained widget nodes, properties, bindings and rendering for the Panel subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.panel.widget_tree", theme = "highcontrast", scale = 1.07 })
		inst.system = S
		inst.ctx = ctx
