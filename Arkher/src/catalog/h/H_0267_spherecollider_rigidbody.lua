-- ARKHER SYSTEM H.0267 :: Sphere Collider Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0267"
	S.key = "arkher.physics.spherecollider.body_dynamics"
	S.name = "Sphere Collider Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "spherecollider", "rigidbody", "physics" }
	S.description = "Sphere Collider Body Dynamics: integration, impulses, damping and sleeping of a body for the Sphere Collider subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.spherecollider.body_dynamics", mass = 24.00, radius = 0.45, restitution = 0.43, friction = 0.63, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
