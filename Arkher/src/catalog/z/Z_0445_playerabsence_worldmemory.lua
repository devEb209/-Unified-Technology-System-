-- ARKHER SYSTEM Z.0445 :: Player Absence Simulation World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0445"
	S.key = "arkher.origin.playerabsence.world_memory"
	S.name = "Player Absence Simulation World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.autonomous_pipeline" }
	S.tags = { "z", "playerabsence", "worldmemory", "origin" }
	S.description = "Player Absence Simulation World Memory: epoch-stamped persistent history with compaction and checkpoints for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.playerabsence.world_memory", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
