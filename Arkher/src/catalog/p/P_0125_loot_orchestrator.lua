-- ARKHER SYSTEM P.0125 :: Loot State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0125"
	S.key = "arkher.play.loot.state_machine"
	S.name = "Loot State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Loot"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.loot.combat_resolution" }
	S.tags = { "p", "loot", "orchestrator", "play" }
	S.description = "Loot State Machine: the phase machine that drives this gameplay loop for the Loot subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.loot.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
