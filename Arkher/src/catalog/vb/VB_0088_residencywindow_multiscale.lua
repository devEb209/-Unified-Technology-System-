-- ARKHER SYSTEM VB.0088 :: Residency Window Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0088"
	S.key = "arkher.conttime.residencywindow.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.residencywindow.sparse_residency" }
	S.tags = { "vb", "residencywindow", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.residencywindow.multi-scale_fidelity", levels = 4, baseTriangles = 75000 })
		inst.system = S
		inst.ctx = ctx
