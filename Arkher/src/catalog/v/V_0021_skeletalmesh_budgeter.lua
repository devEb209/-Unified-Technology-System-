-- ARKHER SYSTEM V.0021 :: Skeletal Mesh Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0021"
	S.key = "arkher.asset.skeletalmesh.size_budget"
	S.name = "Skeletal Mesh Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.skeletalmesh.compression_codec" }
	S.tags = { "v", "skeletalmesh", "budgeter", "asset" }
	S.description = "Skeletal Mesh Size Budget: byte budget shared between competing asset classes for the Skeletal Mesh subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.skeletalmesh.size_budget", total = 103, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
