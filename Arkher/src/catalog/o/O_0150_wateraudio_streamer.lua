-- ARKHER SYSTEM O.0150 :: Water Audio Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0150"
	S.key = "arkher.audio.wateraudio.streaming"
	S.name = "Water Audio Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Water Audio"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.wateraudio.voice_budget" }
	S.tags = { "o", "wateraudio", "streamer", "audio" }
	S.description = "Water Audio Streaming: distance-driven residency of audio assets for the Water Audio subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.wateraudio.streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
