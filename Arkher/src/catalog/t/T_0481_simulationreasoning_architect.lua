-- ARKHER SYSTEM T.0481 :: Simulation Reasoning World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0481"
	S.key = "arkher.ai.simulationreasoning.world_architect"
	S.name = "Simulation Reasoning World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.simulationreasoning.self_critique" }
	S.tags = { "t", "simulationreasoning", "architect", "ai" }
	S.description = "Simulation Reasoning World Architect: composition of a whole world plan with conserved budgets for the Simulation Reasoning subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.simulationreasoning.world_architect", budget = 800, seed = 75642 })
		inst.system = S
		inst.ctx = ctx
