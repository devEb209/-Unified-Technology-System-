-- ARKHER SYSTEM K.0149 :: Rest Drive Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0149"
	S.key = "arkher.npc.restdrive.navigation"
	S.name = "Rest Drive Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.restdrive.goal_planner" }
	S.tags = { "k", "restdrive", "navgraph", "npc" }
	S.description = "Rest Drive Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Rest Drive subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.restdrive.navigation", width = 40, height = 40, cellSize = 4 })
		inst.system = S
		inst.ctx = ctx
