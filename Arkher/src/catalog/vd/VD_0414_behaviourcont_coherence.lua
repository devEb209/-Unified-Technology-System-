-- ARKHER SYSTEM VD.0414 :: Behaviour Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0414"
	S.key = "arkher.contsim.behaviourcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.behaviourcont.persistent_state" }
	S.tags = { "vd", "behaviourcont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.behaviourcont.coherence_guard", window = 57, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
