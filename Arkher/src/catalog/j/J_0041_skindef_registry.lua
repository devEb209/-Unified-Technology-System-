-- ARKHER SYSTEM J.0041 :: Skin Definition Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0041"
	S.key = "arkher.character.skindef.variant_registry"
	S.name = "Skin Definition Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.skindef.appearance_composer" }
	S.tags = { "j", "skindef", "registry", "character" }
	S.description = "Skin Definition Variant Registry: named character variants and their lifecycle for the Skin Definition subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.skindef.variant_registry" })
		inst.system = S
		inst.ctx = ctx
