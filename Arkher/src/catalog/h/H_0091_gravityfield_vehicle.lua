-- ARKHER SYSTEM H.0091 :: Gravity Field Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0091"
	S.key = "arkher.physics.gravityfield.vehicle"
	S.name = "Gravity Field Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.gravityfield.character_motion" }
	S.tags = { "h", "gravityfield", "vehicle", "physics" }
	S.description = "Gravity Field Vehicle: suspension, drivetrain, steering and tire friction for the Gravity Field subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.gravityfield.vehicle", mass = 1400, wheelbase = 2.30, track = 1.90, maxRpm = 5700 })
		inst.system = S
		inst.ctx = ctx
