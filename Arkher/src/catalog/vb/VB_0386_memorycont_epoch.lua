-- ARKHER SYSTEM VB.0386 :: Memory Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0386"
	S.key = "arkher.conttime.memorycont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memorycont.infinite_grid" }
	S.tags = { "vb", "memorycont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.memorycont.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
