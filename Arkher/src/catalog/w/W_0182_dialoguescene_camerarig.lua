-- ARKHER SYSTEM W.0182 :: Dialogue Scene Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0182"
	S.key = "arkher.cine.dialoguescene.camera_rig"
	S.name = "Dialogue Scene Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dialoguescene.sequence_timeline" }
	S.tags = { "w", "dialoguescene", "camerarig", "cine" }
	S.description = "Dialogue Scene Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Dialogue Scene subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.dialoguescene.camera_rig", fov = 1.49, focus = 17.0, aperture = 6.9, smoothing = 9.0, distance = 19, height = 7 })
		inst.system = S
		inst.ctx = ctx
