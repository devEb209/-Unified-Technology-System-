-- ARKHER SYSTEM VA.0310 :: Weather Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0310"
	S.key = "arkher.contworld.weathercont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.weathercont.complexity_budget" }
	S.tags = { "va", "weathercont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.weathercont.simulation_fabric", budgetMs = 3.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
