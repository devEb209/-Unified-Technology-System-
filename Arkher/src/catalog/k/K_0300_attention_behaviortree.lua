-- ARKHER SYSTEM K.0300 :: Attention Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0300"
	S.key = "arkher.npc.attention.reactive_behaviour"
	S.name = "Attention Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.attention.perception" }
	S.tags = { "k", "attention", "behaviortree", "npc" }
	S.description = "Attention Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Attention subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.attention.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
