-- ARKHER SYSTEM T.0291 :: Balance Tuning Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0291"
	S.key = "arkher.ai.balancetuning.action_planner"
	S.name = "Balance Tuning Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.balancetuning.utility_selection" }
	S.tags = { "t", "balancetuning", "planner", "ai" }
	S.description = "Balance Tuning Action Planner: goal-oriented action planning over preconditions for the Balance Tuning subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.balancetuning.action_planner", maxDepth = 8 })
		inst.system = S
		inst.ctx = ctx
