-- ARKHER SYSTEM I.0214 :: Transition Rule Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0214"
	S.key = "arkher.anim.transitionrule.retarget_graph"
	S.name = "Transition Rule Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.transitionrule.physical_blend" }
	S.tags = { "i", "transitionrule", "graph", "anim" }
	S.description = "Transition Rule Retarget Graph: bone mapping and retarget path resolution for the Transition Rule subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.transitionrule.retarget_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
