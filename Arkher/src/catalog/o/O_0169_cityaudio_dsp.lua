-- ARKHER SYSTEM O.0169 :: City Audio DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0169"
	S.key = "arkher.audio.cityaudio.dsp_chain"
	S.name = "City Audio DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "City Audio"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "cityaudio", "dsp", "audio" }
	S.description = "City Audio DSP Chain: biquad filtering, delay, envelope and soft clipping for the City Audio subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.cityaudio.dsp_chain", sampleRate = 22050, filter = "lowpass", cutoff = 5100, q = 0.860 })
		inst.system = S
		inst.ctx = ctx
