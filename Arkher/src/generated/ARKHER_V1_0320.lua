...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Google Maps — CORE Stack #0320", size=Vector2.new(680, 420), pos=UDim2.fromOffset(260, 320), parent=parent, icon="◉"})
