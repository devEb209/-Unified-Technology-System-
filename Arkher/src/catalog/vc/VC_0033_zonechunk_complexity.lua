-- ARKHER SYSTEM VC.0033 :: Zone Chunk Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0033"
	S.key = "arkher.contneural.zonechunk.complexity_budget"
	S.name = "Zone Chunk Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.zonechunk.world_memory_stream" }
	S.tags = { "vc", "zonechunk", "complexity", "contneural" }
	S.description = "Zone Chunk Complexity Budget: complexity budgeting for the continuum for the Zone Chunk subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.zonechunk.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
