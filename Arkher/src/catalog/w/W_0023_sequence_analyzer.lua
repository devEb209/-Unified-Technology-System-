-- ARKHER SYSTEM W.0023 :: Sequence Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0023"
	S.key = "arkher.cine.sequence.sequence_analysis"
	S.name = "Sequence Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Sequence"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.sequence.frame_budget" }
	S.tags = { "w", "sequence", "analyzer", "cine" }
	S.description = "Sequence Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Sequence subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.sequence.sequence_analysis", window = 141, buckets = 17, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
