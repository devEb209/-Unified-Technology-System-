-- ARKHER SYSTEM Q.0046 :: Label Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0046"
	S.key = "arkher.ui.label.frame_budget"
	S.name = "Label Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Label"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.label.accessibility_policy" }
	S.tags = { "q", "label", "budgeter", "ui" }
	S.description = "Label Frame Budget: per-frame layout and draw budget for the interface for the Label subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.label.frame_budget", total = 216, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
