-- ARKHER SYSTEM VA.0335 :: Economy Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0335"
	S.key = "arkher.contworld.economycont.reality_continuum"
	S.name = "Economy Continuum Reality Continuum"
	S.category = "VA"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.economycont.simulation_fabric" }
	S.tags = { "va", "economycont", "reality", "contworld" }
	S.description = "Economy Continuum Reality Continuum: stacked reality layers of the continuum for the Economy Continuum subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.economycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
