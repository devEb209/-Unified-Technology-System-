-- ARKHER SYSTEM Z.1090 :: Original Tech Debug Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.1090"
	S.key = "arkher.origin.origindebug.self_critique"
	S.name = "Original Tech Debug Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.origindebug.intent_bridge" }
	S.tags = { "z", "origindebug", "critic", "origin" }
	S.description = "Original Tech Debug Self Critique: weighted judgement of the technology's own output for the Original Tech Debug subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.origindebug.self_critique", passMark = 0.84, reviseMark = 0.44, seed = 72044 })
		inst.system = S
		inst.ctx = ctx
