-- ARKHER SYSTEM P.0032 :: Skill Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0032"
	S.key = "arkher.play.skill.balance_analysis"
	S.name = "Skill Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Skill"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.skill.event_ledger" }
	S.tags = { "p", "skill", "analyzer", "play" }
	S.description = "Skill Balance Analysis: distribution, outlier and pacing analysis for the Skill subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.skill.balance_analysis", window = 118, buckets = 14, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
