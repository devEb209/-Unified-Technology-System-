-- ARKHER SYSTEM J.0186 :: Accessory Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0186"
	S.key = "arkher.character.accessory.streaming"
	S.name = "Accessory Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.accessory.budget_governor" }
	S.tags = { "j", "accessory", "streamer", "character" }
	S.description = "Accessory Streaming: distance-driven residency of character data for the Accessory subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.accessory.streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
