-- ARKHER SYSTEM E.0462 :: Procedural Texture Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0462"
	S.key = "arkher.material.proctex.analysis"
	S.name = "Procedural Texture Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.proctex.instance_cache" }
	S.tags = { "e", "proctex", "analyzer", "material" }
	S.description = "Procedural Texture Analysis: cost, redundancy and outlier analysis for the Procedural Texture subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.proctex.analysis", window = 158, buckets = 18, threshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
