-- ARKHER SYSTEM Q.0211 :: Compass Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0211"
	S.key = "arkher.ui.compass.localization_registry"
	S.name = "Compass Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Compass"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.compass.theme_composition" }
	S.tags = { "q", "compass", "registry", "ui" }
	S.description = "Compass Localization Registry: catalogue of strings, plurals and locale metadata for the Compass subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.compass.localization_registry" })
		inst.system = S
		inst.ctx = ctx
