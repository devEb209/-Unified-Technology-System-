-- ARKHER SYSTEM VC.0132 :: Spatial Slice Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0132"
	S.key = "arkher.contneural.spatialslice.emergence_continuum"
	S.name = "Spatial Slice Emergence Continuum"
	S.category = "VC"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.spatialslice.reality_continuum" }
	S.tags = { "vc", "spatialslice", "emergence", "contneural" }
	S.description = "Spatial Slice Emergence Continuum: emergence detection over the continuum for the Spatial Slice subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.spatialslice.emergence_continuum", windowSize = 5, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
