-- ARKHER SYSTEM E.0572 :: Material Validation Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0572"
	S.key = "arkher.material.validation.layer_composition"
	S.name = "Material Validation Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.validation.definition" }
	S.tags = { "e", "validation", "composer", "material" }
	S.description = "Material Validation Layer Composition: ordered layer composition with blend rules for the Material Validation subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.validation.layer_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
