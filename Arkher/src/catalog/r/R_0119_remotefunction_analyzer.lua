-- ARKHER SYSTEM R.0119 :: Remote Function Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0119"
	S.key = "arkher.net.remotefunction.latency_analysis"
	S.name = "Remote Function Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remotefunction.audit_ledger" }
	S.tags = { "r", "remotefunction", "analyzer", "net" }
	S.description = "Remote Function Latency Analysis: round trip, jitter and loss analysis for the Remote Function subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.remotefunction.latency_analysis", window = 150, buckets = 14, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
