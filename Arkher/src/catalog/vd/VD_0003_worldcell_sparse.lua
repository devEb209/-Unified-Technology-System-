-- ARKHER SYSTEM VD.0003 :: World Grid Cell Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0003"
	S.key = "arkher.contsim.worldcell.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldcell.epoch_clock" }
	S.tags = { "vd", "worldcell", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.worldcell.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
