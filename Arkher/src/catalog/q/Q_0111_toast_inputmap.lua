-- ARKHER SYSTEM Q.0111 :: Toast Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0111"
	S.key = "arkher.ui.toast.input_mapping"
	S.name = "Toast Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Toast"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.toast.widget_tree" }
	S.tags = { "q", "toast", "inputmap", "ui" }
	S.description = "Toast Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Toast subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.toast.input_mapping", device = "touch", holdTime = 0.25, deadzone = 0.10 })
		inst.system = S
		inst.ctx = ctx
