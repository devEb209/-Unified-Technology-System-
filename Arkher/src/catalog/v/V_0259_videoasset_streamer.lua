-- ARKHER SYSTEM V.0259 :: Video Asset Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0259"
	S.key = "arkher.asset.videoasset.streaming_residency"
	S.name = "Video Asset Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.videoasset.content_cache" }
	S.tags = { "v", "videoasset", "streamer", "asset" }
	S.description = "Video Asset Streaming Residency: distance-driven load and unload of asset payloads for the Video Asset subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.videoasset.streaming_residency", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
