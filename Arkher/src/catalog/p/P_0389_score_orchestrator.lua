-- ARKHER SYSTEM P.0389 :: Score State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0389"
	S.key = "arkher.play.score.state_machine"
	S.name = "Score State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Score"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.score.combat_resolution" }
	S.tags = { "p", "score", "orchestrator", "play" }
	S.description = "Score State Machine: the phase machine that drives this gameplay loop for the Score subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.score.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
