-- ARKHER SYSTEM L.0003 :: Living World Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0003"
	S.key = "arkher.sim.livingworld.economy"
	S.name = "Living World Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livingworld.ecology" }
	S.tags = { "l", "livingworld", "economy", "sim" }
	S.description = "Living World Economy: stock, production, demand, price discovery and trade for the Living World subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.livingworld.economy", elasticity = 0.29 })
		inst.system = S
		inst.ctx = ctx
