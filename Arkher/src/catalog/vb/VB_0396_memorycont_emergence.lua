-- ARKHER SYSTEM VB.0396 :: Memory Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0396"
	S.key = "arkher.conttime.memorycont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memorycont.reality_continuum" }
	S.tags = { "vb", "memorycont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.memorycont.emergence_continuum", windowSize = 6, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
