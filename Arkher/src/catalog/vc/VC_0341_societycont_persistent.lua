-- ARKHER SYSTEM VC.0341 :: Society Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0341"
	S.key = "arkher.contneural.societycont.persistent_state"
	S.name = "Society Continuum Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.societycont.multi-scale_fidelity" }
	S.tags = { "vc", "societycont", "persistent", "contneural" }
	S.description = "Society Continuum Persistent State: epoch-stamped persistent history and rollback for the Society Continuum subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.societycont.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
