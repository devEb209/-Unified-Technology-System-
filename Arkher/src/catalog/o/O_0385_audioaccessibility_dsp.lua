-- ARKHER SYSTEM O.0385 :: Accessibility Audio DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0385"
	S.key = "arkher.audio.audioaccessibility.dsp_chain"
	S.name = "Accessibility Audio DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "audioaccessibility", "dsp", "audio" }
	S.description = "Accessibility Audio DSP Chain: biquad filtering, delay, envelope and soft clipping for the Accessibility Audio subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.audioaccessibility.dsp_chain", sampleRate = 22050, filter = "bandpass", cutoff = 3300, q = 0.600 })
		inst.system = S
		inst.ctx = ctx
