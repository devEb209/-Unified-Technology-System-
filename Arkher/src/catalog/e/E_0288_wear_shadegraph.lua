-- ARKHER SYSTEM E.0288 :: Wear And Tear Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0288"
	S.key = "arkher.material.wear.shading_graph"
	S.name = "Wear And Tear Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.wear.layer_composition" }
	S.tags = { "e", "wear", "shadegraph", "material" }
	S.description = "Wear And Tear Shading Graph: node graph evaluated and compiled to Luau for the Wear And Tear subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.wear.shading_graph" })
		inst.system = S
		inst.ctx = ctx
