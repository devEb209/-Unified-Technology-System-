-- ARKHER SYSTEM E.0580 :: Material Validation Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0580"
	S.key = "arkher.material.validation.quality_policy"
	S.name = "Material Validation Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.validation.compression_codec" }
	S.tags = { "e", "validation", "policy", "material" }
	S.description = "Material Validation Quality Policy: device tier rules for the surface for the Material Validation subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.validation.quality_policy", algorithm = "edf", starvationGuard = 25 })
		inst.system = S
		inst.ctx = ctx
