-- ARKHER SYSTEM G.0053 :: Frame Interpolation Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0053"
	S.key = "arkher.neural.frameinterp.error_analysis"
	S.name = "Frame Interpolation Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.frameinterp.heuristic_policy" }
	S.tags = { "g", "frameinterp", "analyzer", "neural" }
	S.description = "Frame Interpolation Error Analysis: residual and drift analysis for the Frame Interpolation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.frameinterp.error_analysis", window = 56, buckets = 16, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
