-- ARKHER SYSTEM N.0206 :: Cloud Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0206"
	S.key = "arkher.vfx.cloud.spatial_index"
	S.name = "Cloud Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloud"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.cloud.quality_policy" }
	S.tags = { "n", "cloud", "index", "vfx" }
	S.description = "Cloud Spatial Index: spatial acceleration of effect queries and culling for the Cloud subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.cloud.spatial_index", mode = "hash", cellSize = 48 })
		inst.system = S
		inst.ctx = ctx
