-- ARKHER SYSTEM VC.0406 :: Perception Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0406"
	S.key = "arkher.contneural.perceptioncont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.perceptioncont.complexity_budget" }
	S.tags = { "vc", "perceptioncont", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.perceptioncont.simulation_fabric", budgetMs = 2.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
