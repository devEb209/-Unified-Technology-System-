-- ARKHER SYSTEM I.0480 :: Facial Animation Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0480"
	S.key = "arkher.anim.facialanim.analysis"
	S.name = "Facial Animation Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.facialanim.quality_policy" }
	S.tags = { "i", "facialanim", "analyzer", "anim" }
	S.description = "Facial Animation Analysis: pop, drift and cost analysis of playback for the Facial Animation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.facialanim.analysis", window = 198, buckets = 14, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
