-- ARKHER SYSTEM W.0184 :: Dialogue Scene Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0184"
	S.key = "arkher.cine.dialoguescene.shot_composition"
	S.name = "Dialogue Scene Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dialoguescene.colour_grade" }
	S.tags = { "w", "dialoguescene", "composer", "cine" }
	S.description = "Dialogue Scene Shot Composition: blending of the signals that make up the final shot for the Dialogue Scene subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.dialoguescene.shot_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
