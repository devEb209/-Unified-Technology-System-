-- ARKHER SYSTEM VA.0271 :: Bridge Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0271"
	S.key = "arkher.contworld.bridgecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.bridgecont.coherence_guard" }
	S.tags = { "va", "bridgecont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.bridgecont.neural_field", dims = 20, hidden = 16, seed = 91582 })
		inst.system = S
		inst.ctx = ctx
