-- ARKHER SYSTEM E.0261 :: UV Mapping Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0261"
	S.key = "arkher.material.uvmap.variant_registry"
	S.name = "UV Mapping Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "UV Mapping"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.uvmap.procedural_detail" }
	S.tags = { "e", "uvmap", "registry", "material" }
	S.description = "UV Mapping Variant Registry: named variants and their lifecycle for the UV Mapping subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.uvmap.variant_registry" })
		inst.system = S
		inst.ctx = ctx
