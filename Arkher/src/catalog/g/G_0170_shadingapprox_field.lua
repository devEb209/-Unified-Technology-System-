-- ARKHER SYSTEM G.0170 :: Shading Approximation Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0170"
	S.key = "arkher.neural.shadingapprox.feature_extraction"
	S.name = "Shading Approximation Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.shadingapprox.inference_core" }
	S.tags = { "g", "shadingapprox", "field", "neural" }
	S.description = "Shading Approximation Feature Extraction: signal features feeding the model for the Shading Approximation subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.shadingapprox.feature_extraction", seed = 45385, frequency = 0.0103, octaves = 4, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
