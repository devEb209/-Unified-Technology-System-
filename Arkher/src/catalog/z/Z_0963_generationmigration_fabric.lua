-- ARKHER SYSTEM Z.0963 :: Generation Migration Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0963"
	S.key = "arkher.origin.generationmigration.simulation_fabric"
	S.name = "Generation Migration Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.complexity_governance" }
	S.tags = { "z", "generationmigration", "fabric", "origin" }
	S.description = "Generation Migration Simulation Fabric: every simulation domain stepped under one budgeted clock for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.generationmigration.simulation_fabric", budgetMs = 4.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
