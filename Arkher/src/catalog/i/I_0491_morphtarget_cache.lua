-- ARKHER SYSTEM I.0491 :: Morph Target Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0491"
	S.key = "arkher.anim.morphtarget.pose_cache"
	S.name = "Morph Target Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Morph Target"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.morphtarget.playback_pipeline" }
	S.tags = { "i", "morphtarget", "cache", "anim" }
	S.description = "Morph Target Pose Cache: reuse of sampled poses across frames and instances for the Morph Target subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.morphtarget.pose_cache", policy = "lru", capacity = 500, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
