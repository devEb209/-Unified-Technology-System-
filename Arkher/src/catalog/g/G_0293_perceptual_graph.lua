-- ARKHER SYSTEM G.0293 :: Perceptual Metric Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0293"
	S.key = "arkher.neural.perceptual.sampling_graph"
	S.name = "Perceptual Metric Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perceptual.training_ledger" }
	S.tags = { "g", "perceptual", "graph", "neural" }
	S.description = "Perceptual Metric Sampling Graph: dependency graph of sampling stages for the Perceptual Metric subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.perceptual.sampling_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
