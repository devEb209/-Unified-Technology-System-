-- ARKHER SYSTEM VC.0303 :: Weather Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0303"
	S.key = "arkher.contneural.weathercont.sparse_residency"
	S.name = "Weather Continuum Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.weathercont.epoch_clock" }
	S.tags = { "vc", "weathercont", "sparse", "contneural" }
	S.description = "Weather Continuum Sparse Residency: sparse page residency with eviction and compression for the Weather Continuum subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.weathercont.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
