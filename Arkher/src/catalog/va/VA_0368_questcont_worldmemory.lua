-- ARKHER SYSTEM VA.0368 :: Quest Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0368"
	S.key = "arkher.contworld.questcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.questcont.neural_field" }
	S.tags = { "va", "questcont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.questcont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
