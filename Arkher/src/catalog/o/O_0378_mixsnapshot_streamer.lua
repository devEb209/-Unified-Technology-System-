-- ARKHER SYSTEM O.0378 :: Mix Snapshot Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0378"
	S.key = "arkher.audio.mixsnapshot.streaming"
	S.name = "Mix Snapshot Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mix Snapshot"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mixsnapshot.voice_budget" }
	S.tags = { "o", "mixsnapshot", "streamer", "audio" }
	S.description = "Mix Snapshot Streaming: distance-driven residency of audio assets for the Mix Snapshot subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.mixsnapshot.streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
