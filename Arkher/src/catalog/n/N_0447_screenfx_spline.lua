-- ARKHER SYSTEM N.0447 :: Screen Effect Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0447"
	S.key = "arkher.vfx.screenfx.curve_authoring"
	S.name = "Screen Effect Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.screenfx.ribbon_and_trail" }
	S.tags = { "n", "screenfx", "spline", "vfx" }
	S.description = "Screen Effect Curve Authoring: authored curves driving the effect over its life for the Screen Effect subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.screenfx.curve_authoring", tension = 0.45, closed = false })
		inst.system = S
		inst.ctx = ctx
