-- ARKHER SYSTEM VA.0440 :: Physics Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0440"
	S.key = "arkher.contworld.physicscont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.physicscont.neural_field" }
	S.tags = { "va", "physicscont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.physicscont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
