-- ARKHER SYSTEM L.0384 :: Caravan State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0384"
	S.key = "arkher.sim.caravan.state_codec"
	S.name = "Caravan State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.caravan.history_ledger" }
	S.tags = { "l", "caravan", "codec", "sim" }
	S.description = "Caravan State Codec: persistence, diffing and checksum of the world state for the Caravan subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.caravan.state_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
