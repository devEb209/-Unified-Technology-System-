-- ARKHER SYSTEM N.0238 :: Spell Cast Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0238"
	S.key = "arkher.vfx.spellcast.ribbon_and_trail"
	S.name = "Spell Cast Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spell Cast"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spellcast.force_field" }
	S.tags = { "n", "spellcast", "ribbon", "vfx" }
	S.description = "Spell Cast Ribbon And Trail: trail points, tapering, beams and decimation for the Spell Cast subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.spellcast.ribbon_and_trail", maxPoints = 56, lifetime = 0.60, minDistance = 0.15, width = 0.70 })
		inst.system = S
		inst.ctx = ctx
