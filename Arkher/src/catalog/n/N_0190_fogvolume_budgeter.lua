-- ARKHER SYSTEM N.0190 :: Fog Volume Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0190"
	S.key = "arkher.vfx.fogvolume.spawn_budget"
	S.name = "Fog Volume Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fog Volume"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fogvolume.effect_composition" }
	S.tags = { "n", "fogvolume", "budgeter", "vfx" }
	S.description = "Fog Volume Spawn Budget: global particle budget shared by every live effect for the Fog Volume subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.fogvolume.spawn_budget", total = 442, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
