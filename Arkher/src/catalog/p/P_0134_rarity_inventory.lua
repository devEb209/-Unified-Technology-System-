-- ARKHER SYSTEM P.0134 :: Rarity Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0134"
	S.key = "arkher.play.rarity.inventory"
	S.name = "Rarity Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Rarity"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.rarity.attributes" }
	S.tags = { "p", "rarity", "inventory", "play" }
	S.description = "Rarity Inventory: slots, stacking, weight, equipment and crafting for the Rarity subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.rarity.inventory", slots = 28, maxWeight = 120 })
		inst.system = S
		inst.ctx = ctx
