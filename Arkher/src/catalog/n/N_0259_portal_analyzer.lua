-- ARKHER SYSTEM N.0259 :: Portal Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0259"
	S.key = "arkher.vfx.portal.analysis"
	S.name = "Portal Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Portal"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.portal.spatial_index" }
	S.tags = { "n", "portal", "analyzer", "vfx" }
	S.description = "Portal Analysis: cost, overdraw and stability analysis of the effect for the Portal subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.portal.analysis", window = 246, buckets = 14, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
