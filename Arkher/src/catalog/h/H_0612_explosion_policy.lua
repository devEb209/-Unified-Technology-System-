-- ARKHER SYSTEM H.0612 :: Explosion Force Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0612"
	S.key = "arkher.physics.explosion.simulation_policy"
	S.name = "Explosion Force Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.explosion.budget_governor" }
	S.tags = { "h", "explosion", "policy", "physics" }
	S.description = "Explosion Force Simulation Policy: device tier rules for substeps, iterations and sleep for the Explosion Force subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.explosion.simulation_policy", algorithm = "wfq", starvationGuard = 58 })
		inst.system = S
		inst.ctx = ctx
