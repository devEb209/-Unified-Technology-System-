-- ARKHER SYSTEM E.0496 :: Shader Graph Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0496"
	S.key = "arkher.material.shadergraph.definition"
	S.name = "Shader Graph Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Shader Graph"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "shadergraph", "material", "material" }
	S.description = "Shader Graph Definition: layered PBR definition resolved into parameters for the Shader Graph subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.shadergraph.definition", texelBudget = 262144 })
		inst.system = S
		inst.ctx = ctx
