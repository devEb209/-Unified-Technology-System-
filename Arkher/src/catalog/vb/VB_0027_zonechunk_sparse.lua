-- ARKHER SYSTEM VB.0027 :: Zone Chunk Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0027"
	S.key = "arkher.conttime.zonechunk.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.zonechunk.epoch_clock" }
	S.tags = { "vb", "zonechunk", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.zonechunk.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
