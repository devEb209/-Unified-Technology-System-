-- ARKHER SYSTEM Z.0277 :: Living Ecosystem Engine Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0277"
	S.key = "arkher.origin.livingecosystem.behaviour_analysis"
	S.name = "Living Ecosystem Engine Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.livingecosystem.governance_policy" }
	S.tags = { "z", "livingecosystem", "analyzer", "origin" }
	S.description = "Living Ecosystem Engine Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Living Ecosystem Engine subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.livingecosystem.behaviour_analysis", window = 58, buckets = 18, threshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
