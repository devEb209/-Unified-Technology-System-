-- ARKHER SYSTEM V.0429 :: Asset Debug Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0429"
	S.key = "arkher.asset.assetdebug.size_budget"
	S.name = "Asset Debug Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetdebug.compression_codec" }
	S.tags = { "v", "assetdebug", "budgeter", "asset" }
	S.description = "Asset Debug Size Budget: byte budget shared between competing asset classes for the Asset Debug subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.assetdebug.size_budget", total = 421, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
