-- ARKHER SYSTEM E.0371 :: Vertex Painting Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0371"
	S.key = "arkher.material.vertexpaint.instance_cache"
	S.name = "Vertex Painting Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.vertexpaint.quality_policy" }
	S.tags = { "e", "vertexpaint", "cache", "material" }
	S.description = "Vertex Painting Instance Cache: resolved-parameter cache keyed by context for the Vertex Painting subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.vertexpaint.instance_cache", policy = "ttl", capacity = 312, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
