-- ARKHER SYSTEM VA.0050 :: Epoch Frame Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0050"
	S.key = "arkher.contworld.epochframe.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.epochframe.infinite_grid" }
	S.tags = { "va", "epochframe", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.epochframe.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
