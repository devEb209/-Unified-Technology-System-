-- ARKHER SYSTEM I.0107 :: Clip Events Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0107"
	S.key = "arkher.anim.clipevents.layered_blending"
	S.name = "Clip Events Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Events"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clipevents.clip_sampling" }
	S.tags = { "i", "clipevents", "animator", "anim" }
	S.description = "Clip Events Layered Blending: layers, crossfades, masks and blend trees for the Clip Events subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.clipevents.layered_blending", budget = 5 })
		inst.system = S
		inst.ctx = ctx
