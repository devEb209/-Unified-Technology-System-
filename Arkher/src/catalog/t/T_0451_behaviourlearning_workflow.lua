-- ARKHER SYSTEM T.0451 :: Behaviour Learning Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0451"
	S.key = "arkher.ai.behaviourlearning.plan_workflow"
	S.name = "Behaviour Learning Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.behaviourlearning.semantic_knowledge" }
	S.tags = { "t", "behaviourlearning", "workflow", "ai" }
	S.description = "Behaviour Learning Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Behaviour Learning subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.behaviourlearning.plan_workflow", maxRetries = 3, budget = 120 })
		inst.system = S
		inst.ctx = ctx
