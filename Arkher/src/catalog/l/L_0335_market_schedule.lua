-- ARKHER SYSTEM L.0335 :: Market Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0335"
	S.key = "arkher.sim.market.calendar"
	S.name = "Market Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.market.society" }
	S.tags = { "l", "market", "schedule", "sim" }
	S.description = "Market Calendar: hours, days and seasons driving the region for the Market subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.market.calendar", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
