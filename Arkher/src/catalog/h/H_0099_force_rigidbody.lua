-- ARKHER SYSTEM H.0099 :: Force Accumulator Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0099"
	S.key = "arkher.physics.force.body_dynamics"
	S.name = "Force Accumulator Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "force", "rigidbody", "physics" }
	S.description = "Force Accumulator Body Dynamics: integration, impulses, damping and sleeping of a body for the Force Accumulator subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.force.body_dynamics", mass = 14.00, radius = 0.95, restitution = 0.33, friction = 0.53, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
