-- ARKHER SYSTEM VC.0284 :: Water Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0284"
	S.key = "arkher.contneural.watercont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.watercont.neural_field" }
	S.tags = { "vc", "watercont", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.watercont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
