-- ARKHER SYSTEM I.0097 :: Clip Looping Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0097"
	S.key = "arkher.anim.cliploop.retarget_graph"
	S.name = "Clip Looping Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Looping"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.cliploop.physical_blend" }
	S.tags = { "i", "cliploop", "graph", "anim" }
	S.description = "Clip Looping Retarget Graph: bone mapping and retarget path resolution for the Clip Looping subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.cliploop.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
