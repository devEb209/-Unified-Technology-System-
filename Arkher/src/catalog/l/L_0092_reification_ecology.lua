-- ARKHER SYSTEM L.0092 :: Reification Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0092"
	S.key = "arkher.sim.reification.ecology"
	S.name = "Reification Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.reification.simulation_core" }
	S.tags = { "l", "reification", "ecology", "sim" }
	S.description = "Reification Ecology: populations, predation, harvesting and carrying capacity for the Reification subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.reification.ecology" })
		inst.system = S
		inst.ctx = ctx
