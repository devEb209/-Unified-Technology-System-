...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="NASA SRTM — ANIMATION Map #0213", size=Vector2.new(600, 480), pos=UDim2.fromOffset(469, 321), parent=parent, icon="▶"})
