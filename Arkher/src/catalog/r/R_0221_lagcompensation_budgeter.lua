-- ARKHER SYSTEM R.0221 :: Lag Compensation Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0221"
	S.key = "arkher.net.lagcompensation.bandwidth_budget"
	S.name = "Lag Compensation Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.lagcompensation.transport_graph" }
	S.tags = { "r", "lagcompensation", "budgeter", "net" }
	S.description = "Lag Compensation Bandwidth Budget: bytes per second shared between competing streams for the Lag Compensation subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.lagcompensation.bandwidth_budget", total = 341, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
