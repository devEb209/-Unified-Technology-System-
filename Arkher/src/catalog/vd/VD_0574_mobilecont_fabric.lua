-- ARKHER SYSTEM VD.0574 :: Mobile Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0574"
	S.key = "arkher.contsim.mobilecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.mobilecont.complexity_budget" }
	S.tags = { "vd", "mobilecont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.mobilecont.simulation_fabric", budgetMs = 2.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
