-- ARKHER SYSTEM E.0218 :: Iridescence Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0218"
	S.key = "arkher.material.iridescence.streaming"
	S.name = "Iridescence Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Iridescence"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.iridescence.parameter_budget" }
	S.tags = { "e", "iridescence", "streamer", "material" }
	S.description = "Iridescence Streaming: residency and demand-driven texture streaming for the Iridescence subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.iridescence.streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
