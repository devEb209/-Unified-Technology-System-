-- ARKHER SYSTEM VB.0058 :: Epoch Frame Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0058"
	S.key = "arkher.conttime.epochframe.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.epochframe.complexity_budget" }
	S.tags = { "vb", "epochframe", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.epochframe.simulation_fabric", budgetMs = 2.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
