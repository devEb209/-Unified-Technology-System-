-- ARKHER SYSTEM VA.0494 :: Rendering Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0494"
	S.key = "arkher.contworld.rendercont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.rendercont.infinite_grid" }
	S.tags = { "va", "rendercont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.rendercont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
