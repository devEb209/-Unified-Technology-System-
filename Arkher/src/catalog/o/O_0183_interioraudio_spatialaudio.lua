-- ARKHER SYSTEM O.0183 :: Interior Audio Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0183"
	S.key = "arkher.audio.interioraudio.spatialization"
	S.name = "Interior Audio Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.interioraudio.mixer_bus" }
	S.tags = { "o", "interioraudio", "spatialaudio", "audio" }
	S.description = "Interior Audio Spatialization: distance attenuation, panning, occlusion and doppler for the Interior Audio subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.interioraudio.spatialization", model = "linear", refDistance = 7, maxDistance = 200, rolloff = 0.96, maxVoices = 28 })
		inst.system = S
		inst.ctx = ctx
