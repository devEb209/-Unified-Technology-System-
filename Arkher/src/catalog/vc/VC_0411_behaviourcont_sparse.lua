-- ARKHER SYSTEM VC.0411 :: Behaviour Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0411"
	S.key = "arkher.contneural.behaviourcont.sparse_residency"
	S.name = "Behaviour Continuum Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.behaviourcont.epoch_clock" }
	S.tags = { "vc", "behaviourcont", "sparse", "contneural" }
	S.description = "Behaviour Continuum Sparse Residency: sparse page residency with eviction and compression for the Behaviour Continuum subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.behaviourcont.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
