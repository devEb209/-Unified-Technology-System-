-- ARKHER SYSTEM VC.0403 :: Perception Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0403"
	S.key = "arkher.contneural.perceptioncont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.perceptioncont.coherence_guard" }
	S.tags = { "vc", "perceptioncont", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.perceptioncont.neural_field", dims = 24, hidden = 20, seed = 4863 })
		inst.system = S
		inst.ctx = ctx
