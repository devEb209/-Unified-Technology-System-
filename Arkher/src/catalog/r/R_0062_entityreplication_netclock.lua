-- ARKHER SYSTEM R.0062 :: Entity Replication Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0062"
	S.key = "arkher.net.entityreplication.time_sync"
	S.name = "Entity Replication Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.entityreplication.replication" }
	S.tags = { "r", "entityreplication", "netclock", "net" }
	S.description = "Entity Replication Time Sync: offset estimation, outlier rejection and jitter buffering for the Entity Replication subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.entityreplication.time_sync", tickRate = 50, bufferDelay = 0.130, maxSamples = 23 })
		inst.system = S
		inst.ctx = ctx
