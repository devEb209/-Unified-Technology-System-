-- ARKHER SYSTEM K.0412 :: Interruption Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0412"
	S.key = "arkher.npc.interruption.reactive_behaviour"
	S.name = "Interruption Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.interruption.perception" }
	S.tags = { "k", "interruption", "behaviortree", "npc" }
	S.description = "Interruption Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Interruption subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.interruption.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
