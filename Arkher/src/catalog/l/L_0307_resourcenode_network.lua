-- ARKHER SYSTEM L.0307 :: Resource Node Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0307"
	S.key = "arkher.sim.resourcenode.route_network"
	S.name = "Resource Node Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.resourcenode.region_graph" }
	S.tags = { "l", "resourcenode", "network", "sim" }
	S.description = "Resource Node Route Network: roads, rivers and routes between settlements for the Resource Node subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.resourcenode.route_network" })
		inst.system = S
		inst.ctx = ctx
