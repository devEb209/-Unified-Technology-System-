--!strict
-- ESA WorldCover — CORE Mixer #0112
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="ESA WorldCover — CORE Mixer #0112", size=Vector2.new(640, 460), pos=UDim2.fromOffset(356, 164), parent=parent, icon="⚙"})
...
Components.Slider(right, "Rate", 0,3000,600, function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_Rate"..112, v) end end)
