-- ARKHER SYSTEM VB.0139 :: Fidelity Band Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0139"
	S.key = "arkher.conttime.fidelityband.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.fidelityband.coherence_guard" }
	S.tags = { "vb", "fidelityband", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.fidelityband.neural_field", dims = 16, hidden = 12, seed = 67793 })
		inst.system = S
		inst.ctx = ctx
