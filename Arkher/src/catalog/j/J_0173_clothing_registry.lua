-- ARKHER SYSTEM J.0173 :: Clothing Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0173"
	S.key = "arkher.character.clothing.variant_registry"
	S.name = "Clothing Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.clothing.appearance_composer" }
	S.tags = { "j", "clothing", "registry", "character" }
	S.description = "Clothing Variant Registry: named character variants and their lifecycle for the Clothing subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.clothing.variant_registry" })
		inst.system = S
		inst.ctx = ctx
