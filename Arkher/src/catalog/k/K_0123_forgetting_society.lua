-- ARKHER SYSTEM K.0123 :: Forgetting Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0123"
	S.key = "arkher.npc.forgetting.social_relations"
	S.name = "Forgetting Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.forgetting.crowd_steering" }
	S.tags = { "k", "forgetting", "society", "npc" }
	S.description = "Forgetting Social Relations: affinity, factions, reputation and gossip for the Forgetting subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.forgetting.social_relations", decayRate = 0.011, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
