-- ARKHER SYSTEM VA.0349 :: Narrative Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0349"
	S.key = "arkher.contworld.narrativecont.infinite_grid"
	S.name = "Narrative Continuum Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "narrativecont", "continuum", "contworld" }
	S.description = "Narrative Continuum Infinite Grid: seamless paging of the infinite world grid for the Narrative Continuum subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.narrativecont.infinite_grid", cellSize = 64, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
