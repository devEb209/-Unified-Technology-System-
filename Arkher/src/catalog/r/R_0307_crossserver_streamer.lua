-- ARKHER SYSTEM R.0307 :: Cross Server Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0307"
	S.key = "arkher.net.crossserver.interest_streaming"
	S.name = "Cross Server Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Cross Server"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.crossserver.serialization_codec" }
	S.tags = { "r", "crossserver", "streamer", "net" }
	S.description = "Cross Server Interest Streaming: distance-driven residency of replicated content for the Cross Server subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.crossserver.interest_streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
