-- ARKHER SYSTEM R.0266 :: Rate Limiting Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0266"
	S.key = "arkher.net.ratelimiting.time_sync"
	S.name = "Rate Limiting Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.ratelimiting.replication" }
	S.tags = { "r", "ratelimiting", "netclock", "net" }
	S.description = "Rate Limiting Time Sync: offset estimation, outlier rejection and jitter buffering for the Rate Limiting subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.ratelimiting.time_sync", tickRate = 40, bufferDelay = 0.140, maxSamples = 14 })
		inst.system = S
		inst.ctx = ctx
