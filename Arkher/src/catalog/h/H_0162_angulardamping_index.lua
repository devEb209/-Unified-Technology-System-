-- ARKHER SYSTEM H.0162 :: Angular Damping Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0162"
	S.key = "arkher.physics.angulardamping.broadphase_index"
	S.name = "Angular Damping Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.angulardamping.vehicle" }
	S.tags = { "h", "angulardamping", "index", "physics" }
	S.description = "Angular Damping Broadphase Index: spatial acceleration of candidate pair finding for the Angular Damping subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.angulardamping.broadphase_index", mode = "hash", cellSize = 80 })
		inst.system = S
		inst.ctx = ctx
