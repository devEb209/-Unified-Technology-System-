-- ARKHER SYSTEM VD.0353 :: Narrative Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0353"
	S.key = "arkher.contsim.narrativecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.narrativecont.multi-scale_fidelity" }
	S.tags = { "vd", "narrativecont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.narrativecont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
