-- ARKHER SYSTEM H.0603 :: Explosion Force Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0603"
	S.key = "arkher.physics.explosion.body_dynamics"
	S.name = "Explosion Force Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "explosion", "rigidbody", "physics" }
	S.description = "Explosion Force Body Dynamics: integration, impulses, damping and sleeping of a body for the Explosion Force subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.explosion.body_dynamics", mass = 2.00, radius = 0.35, restitution = 0.21, friction = 0.71, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
