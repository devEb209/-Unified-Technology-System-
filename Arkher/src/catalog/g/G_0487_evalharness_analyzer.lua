-- ARKHER SYSTEM G.0487 :: Evaluation Harness Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0487"
	S.key = "arkher.neural.evalharness.error_analysis"
	S.name = "Evaluation Harness Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.evalharness.heuristic_policy" }
	S.tags = { "g", "evalharness", "analyzer", "neural" }
	S.description = "Evaluation Harness Error Analysis: residual and drift analysis for the Evaluation Harness subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.evalharness.error_analysis", window = 217, buckets = 13, threshold = 4.90 })
		inst.system = S
		inst.ctx = ctx
