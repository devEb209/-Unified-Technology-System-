--!strict
-- Anvil Cluster — ANIMATION Map #0323
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Anvil Cluster — ANIMATION Map #0323", size=Vector2.new(680, 480), pos=UDim2.fromOffset(299, 111), parent=parent, icon="◤"})
