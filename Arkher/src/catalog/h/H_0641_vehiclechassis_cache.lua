-- ARKHER SYSTEM H.0641 :: Vehicle Chassis Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0641"
	S.key = "arkher.physics.vehiclechassis.result_cache"
	S.name = "Vehicle Chassis Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.vehiclechassis.simulation_policy" }
	S.tags = { "h", "vehiclechassis", "cache", "physics" }
	S.description = "Vehicle Chassis Result Cache: reuse of expensive simulation and query results for the Vehicle Chassis subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.vehiclechassis.result_cache", policy = "lru", capacity = 284, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
