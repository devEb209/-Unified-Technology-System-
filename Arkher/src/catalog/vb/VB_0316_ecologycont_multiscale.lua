-- ARKHER SYSTEM VB.0316 :: Ecology Continuum Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0316"
	S.key = "arkher.conttime.ecologycont.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.ecologycont.sparse_residency" }
	S.tags = { "vb", "ecologycont", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.ecologycont.multi-scale_fidelity", levels = 6, baseTriangles = 90000 })
		inst.system = S
		inst.ctx = ctx
