-- ARKHER SYSTEM O.0200 :: Reverb Zone Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0200"
	S.key = "arkher.audio.reverbzone.compression_codec"
	S.name = "Reverb Zone Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Reverb Zone"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.reverbzone.asset_registry" }
	S.tags = { "o", "reverbzone", "codec", "audio" }
	S.description = "Reverb Zone Compression Codec: payload encoding of audio state and events for the Reverb Zone subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.reverbzone.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
