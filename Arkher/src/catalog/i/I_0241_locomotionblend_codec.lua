-- ARKHER SYSTEM I.0241 :: Locomotion Blend Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0241"
	S.key = "arkher.anim.locomotionblend.compression_codec"
	S.name = "Locomotion Blend Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.locomotionblend.retarget_graph" }
	S.tags = { "i", "locomotionblend", "codec", "anim" }
	S.description = "Locomotion Blend Compression Codec: curve compression and quantized transport for the Locomotion Blend subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.locomotionblend.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
