-- ARKHER SYSTEM VD.0221 :: Terrain Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0221"
	S.key = "arkher.contsim.terraincont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.terraincont.multi-scale_fidelity" }
	S.tags = { "vd", "terraincont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.terraincont.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
