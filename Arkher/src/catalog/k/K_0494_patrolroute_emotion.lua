-- ARKHER SYSTEM K.0494 :: Patrol Route Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0494"
	S.key = "arkher.npc.patrolroute.emotion"
	S.name = "Patrol Route Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.patrolroute.drive_system" }
	S.tags = { "k", "patrolroute", "emotion", "npc" }
	S.description = "Patrol Route Emotion: appraisal of events into valence, arousal and mood for the Patrol Route subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.patrolroute.emotion", inertia = 0.78, decayRate = 0.33, baselineArousal = 0.13 })
		inst.system = S
		inst.ctx = ctx
