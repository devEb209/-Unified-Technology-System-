-- ARKHER SYSTEM I.0050 :: Pose Buffer Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0050"
	S.key = "arkher.anim.posebuffer.quality_policy"
	S.name = "Pose Buffer Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Pose Buffer"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.posebuffer.pose_cache" }
	S.tags = { "i", "posebuffer", "policy", "anim" }
	S.description = "Pose Buffer Quality Policy: device tier rules for rate, bones and solvers for the Pose Buffer subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.posebuffer.quality_policy", algorithm = "wfq", starvationGuard = 42 })
		inst.system = S
		inst.ctx = ctx
