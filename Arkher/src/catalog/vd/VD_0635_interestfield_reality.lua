-- ARKHER SYSTEM VD.0635 :: Interest Field Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0635"
	S.key = "arkher.contsim.interestfield.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.interestfield.simulation_fabric" }
	S.tags = { "vd", "interestfield", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.interestfield.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
