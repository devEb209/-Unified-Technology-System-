-- ARKHER SYSTEM VA.0239 :: City Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0239"
	S.key = "arkher.contworld.citycont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.citycont.simulation_fabric" }
	S.tags = { "va", "citycont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.citycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
