-- ARKHER SYSTEM T.0576 :: Build Reasoning Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0576"
	S.key = "arkher.ai.buildreasoning.semantic_knowledge"
	S.name = "Build Reasoning Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.buildreasoning.intent_understanding" }
	S.tags = { "t", "buildreasoning", "knowledge", "ai" }
	S.description = "Build Reasoning Semantic Knowledge: typed entities, weighted relations and inferred closure for the Build Reasoning subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.buildreasoning.semantic_knowledge", dims = 16 })
		inst.system = S
		inst.ctx = ctx
