-- ARKHER SYSTEM Z.0787 :: Attention Driven Detail World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0787"
	S.key = "arkher.origin.attentiondetail.world_architect"
	S.name = "Attention Driven Detail World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.emergence_detection" }
	S.tags = { "z", "attentiondetail", "architect", "origin" }
	S.description = "Attention Driven Detail World Architect: hierarchical world composition with conserved budgets for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.attentiondetail.world_architect", budget = 1300, seed = 53187 })
		inst.system = S
		inst.ctx = ctx
