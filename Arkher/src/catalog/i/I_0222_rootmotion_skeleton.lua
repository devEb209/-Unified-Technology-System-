-- ARKHER SYSTEM I.0222 :: Root Motion Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0222"
	S.key = "arkher.anim.rootmotion.skeleton"
	S.name = "Root Motion Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Root Motion"
	S.aspect = "Skeleton"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "rootmotion", "skeleton", "anim" }
	S.description = "Root Motion Skeleton: bone hierarchy, bind pose and world resolution for the Root Motion subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.rootmotion.skeleton" })
		inst.system = S
		inst.ctx = ctx
