-- ARKHER SYSTEM P.0214 :: Trading Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0214"
	S.key = "arkher.play.trading.content_registry"
	S.name = "Trading Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Trading"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.trading.difficulty_controller" }
	S.tags = { "p", "trading", "registry", "play" }
	S.description = "Trading Content Registry: catalogue of the definitions this loop instantiates for the Trading subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.trading.content_registry" })
		inst.system = S
		inst.ctx = ctx
