-- ARKHER SYSTEM H.0507 :: Motorized Joint Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0507"
	S.key = "arkher.physics.motorjoint.contact_generation"
	S.name = "Motorized Joint Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.motorjoint.collision_shape" }
	S.tags = { "h", "motorjoint", "contact", "physics" }
	S.description = "Motorized Joint Contact Generation: narrow-phase manifolds with normal, depth and point for the Motorized Joint subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.motorjoint.contact_generation", slop = 0.0050, maxManifolds = 401 })
		inst.system = S
		inst.ctx = ctx
