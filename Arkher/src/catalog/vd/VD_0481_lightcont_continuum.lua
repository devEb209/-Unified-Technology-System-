-- ARKHER SYSTEM VD.0481 :: Lighting Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0481"
	S.key = "arkher.contsim.lightcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "lightcont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.lightcont.infinite_grid", cellSize = 192, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
