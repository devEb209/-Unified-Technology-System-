-- ARKHER SYSTEM F.0511 :: Mesh LOD Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0511"
	S.key = "arkher.render.meshlod.temporal_resolve"
	S.name = "Mesh LOD Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Mesh LOD"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.meshlod.probe_volume" }
	S.tags = { "f", "meshlod", "temporal", "render" }
	S.description = "Mesh LOD Temporal Resolve: history reprojection with neighbourhood clamping for the Mesh LOD subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.meshlod.temporal_resolve", feedback = 0.88, phase = 8 })
		inst.system = S
		inst.ctx = ctx
