-- ARKHER SYSTEM Z.1087 :: Original Tech Debug World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.1087"
	S.key = "arkher.origin.origindebug.world_architect"
	S.name = "Original Tech Debug World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.origindebug.emergence_detection" }
	S.tags = { "z", "origindebug", "architect", "origin" }
	S.description = "Original Tech Debug World Architect: hierarchical world composition with conserved budgets for the Original Tech Debug subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.origindebug.world_architect", budget = 1200, seed = 31146 })
		inst.system = S
		inst.ctx = ctx
