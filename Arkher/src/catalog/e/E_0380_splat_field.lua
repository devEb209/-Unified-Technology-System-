-- ARKHER SYSTEM E.0380 :: Terrain Splat Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0380"
	S.key = "arkher.material.splat.procedural_detail"
	S.name = "Terrain Splat Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.splat.texture_sampling" }
	S.tags = { "e", "splat", "field", "material" }
	S.description = "Terrain Splat Procedural Detail: coherent noise detail driving the surface for the Terrain Splat subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.splat.procedural_detail", seed = 88293, frequency = 0.0072, octaves = 4, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
