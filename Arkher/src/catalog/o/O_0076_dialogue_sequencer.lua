-- ARKHER SYSTEM O.0076 :: Dialogue Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0076"
	S.key = "arkher.audio.dialogue.music_sequencer"
	S.name = "Dialogue Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Dialogue"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.dialogue.spatialization" }
	S.tags = { "o", "dialogue", "sequencer", "audio" }
	S.description = "Dialogue Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Dialogue subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.dialogue.music_sequencer", bpm = 90, beatsPerBar = 4, intensity = 0.38 })
		inst.system = S
		inst.ctx = ctx
