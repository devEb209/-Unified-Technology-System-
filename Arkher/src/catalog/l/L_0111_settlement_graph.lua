-- ARKHER SYSTEM L.0111 :: Settlement Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0111"
	S.key = "arkher.sim.settlement.region_graph"
	S.name = "Settlement Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.settlement.calendar" }
	S.tags = { "l", "settlement", "graph", "sim" }
	S.description = "Settlement Region Graph: connectivity, components and shortest path between places for the Settlement subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.settlement.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
