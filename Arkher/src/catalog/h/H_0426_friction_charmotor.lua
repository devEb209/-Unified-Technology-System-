-- ARKHER SYSTEM H.0426 :: Friction Model Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0426"
	S.key = "arkher.physics.friction.character_motion"
	S.name = "Friction Model Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.friction.query" }
	S.tags = { "h", "friction", "charmotor", "physics" }
	S.description = "Friction Model Character Motion: capsule move-and-slide with slopes, steps and jumps for the Friction Model subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.friction.character_motion", radius = 0.37, height = 1.62, maxSpeed = 8.20, jumpHeight = 1.80, stepOffset = 0.37 })
		inst.system = S
		inst.ctx = ctx
