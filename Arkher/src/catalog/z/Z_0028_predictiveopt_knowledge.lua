-- ARKHER SYSTEM Z.0028 :: Predictive Optimization Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0028"
	S.key = "arkher.origin.predictiveopt.semantic_graph"
	S.name = "Predictive Optimization Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.world_architect" }
	S.tags = { "z", "predictiveopt", "knowledge", "origin" }
	S.description = "Predictive Optimization Semantic Graph: typed entities and inferred relations of the technology itself for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.predictiveopt.semantic_graph", dims = 16 })
		inst.system = S
		inst.ctx = ctx
