-- ARKHER SYSTEM Z.0548 :: Reputation Web Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0548"
	S.key = "arkher.origin.reputationweb.semantic_graph"
	S.name = "Reputation Web Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.world_architect" }
	S.tags = { "z", "reputationweb", "knowledge", "origin" }
	S.description = "Reputation Web Semantic Graph: typed entities and inferred relations of the technology itself for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.reputationweb.semantic_graph", dims = 24 })
		inst.system = S
		inst.ctx = ctx
