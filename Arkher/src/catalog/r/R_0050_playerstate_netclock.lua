-- ARKHER SYSTEM R.0050 :: Player State Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0050"
	S.key = "arkher.net.playerstate.time_sync"
	S.name = "Player State Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Player State"
	S.aspect = "Time Sync"
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.playerstate.replication" }
	S.tags = { "r", "playerstate", "netclock", "net" }
	S.description = "Player State Time Sync: offset estimation, outlier rejection and jitter buffering for the Player State subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.playerstate.time_sync", tickRate = 40, bufferDelay = 0.080, maxSamples = 22 })
		inst.system = S
		inst.ctx = ctx
