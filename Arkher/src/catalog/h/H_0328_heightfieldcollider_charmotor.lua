-- ARKHER SYSTEM H.0328 :: Heightfield Collider Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0328"
	S.key = "arkher.physics.heightfieldcollider.character_motion"
	S.name = "Heightfield Collider Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.heightfieldcollider.query" }
	S.tags = { "h", "heightfieldcollider", "charmotor", "physics" }
	S.description = "Heightfield Collider Character Motion: capsule move-and-slide with slopes, steps and jumps for the Heightfield Collider subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.heightfieldcollider.character_motion", radius = 0.46, height = 1.71, maxSpeed = 9.10, jumpHeight = 1.50, stepOffset = 0.46 })
		inst.system = S
		inst.ctx = ctx
