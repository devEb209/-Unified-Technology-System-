-- ARKHER SYSTEM L.0243 :: Climate Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0243"
	S.key = "arkher.sim.climate.economy"
	S.name = "Climate Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.climate.ecology" }
	S.tags = { "l", "climate", "economy", "sim" }
	S.description = "Climate Economy: stock, production, demand, price discovery and trade for the Climate subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.climate.economy", elasticity = 0.21 })
		inst.system = S
		inst.ctx = ctx
