-- ARKHER SYSTEM L.0228 :: Weather Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0228"
	S.key = "arkher.sim.weather.economy"
	S.name = "Weather Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.weather.ecology" }
	S.tags = { "l", "weather", "economy", "sim" }
	S.description = "Weather Economy: stock, production, demand, price discovery and trade for the Weather subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.weather.economy", elasticity = 0.26 })
		inst.system = S
		inst.ctx = ctx
