-- ARKHER SYSTEM E.0596 :: Material Migration Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0596"
	S.key = "arkher.material.migration.instance_cache"
	S.name = "Material Migration Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.migration.quality_policy" }
	S.tags = { "e", "migration", "cache", "material" }
	S.description = "Material Migration Instance Cache: resolved-parameter cache keyed by context for the Material Migration subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.migration.instance_cache", policy = "lfu", capacity = 299, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
