-- ARKHER SYSTEM L.0400 :: Wealth Distribution Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0400"
	S.key = "arkher.sim.wealth.streaming"
	S.name = "Wealth Distribution Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wealth.state_codec" }
	S.tags = { "l", "wealth", "streamer", "sim" }
	S.description = "Wealth Distribution Streaming: distance-driven residency of simulated regions for the Wealth Distribution subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.wealth.streaming", radius = 320, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
