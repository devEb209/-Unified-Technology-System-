-- ARKHER SYSTEM Z.0064 :: Reality Layer Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0064"
	S.key = "arkher.origin.realitylayer.autonomous_pipeline"
	S.name = "Reality Layer Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.simulation_fabric" }
	S.tags = { "z", "realitylayer", "autopipeline", "origin" }
	S.description = "Reality Layer Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.realitylayer.autonomous_pipeline", maxIterations = 4 })
		inst.system = S
		inst.ctx = ctx
