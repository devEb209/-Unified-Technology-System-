-- ARKHER SYSTEM I.0048 :: Pose Buffer Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0048"
	S.key = "arkher.anim.posebuffer.playback_pipeline"
	S.name = "Pose Buffer Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Pose Buffer"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.posebuffer.event_ledger" }
	S.tags = { "i", "posebuffer", "pipeline", "anim" }
	S.description = "Pose Buffer Playback Pipeline: ordered sample, blend, ik and output stages for the Pose Buffer subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.posebuffer.playback_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
