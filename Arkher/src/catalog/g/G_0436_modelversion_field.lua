-- ARKHER SYSTEM G.0436 :: Model Versioning Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0436"
	S.key = "arkher.neural.modelversion.feature_extraction"
	S.name = "Model Versioning Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelversion.inference_core" }
	S.tags = { "g", "modelversion", "field", "neural" }
	S.description = "Model Versioning Feature Extraction: signal features feeding the model for the Model Versioning subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.modelversion.feature_extraction", seed = 49659, frequency = 0.0088, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
