-- ARKHER SYSTEM J.0147 :: Posture Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0147"
	S.key = "arkher.character.posture.look_and_reach"
	S.name = "Posture Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.posture.blend_controller" }
	S.tags = { "j", "posture", "ik", "character" }
	S.description = "Posture Look And Reach: look-at, reach and foot placement for the character for the Posture subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.posture.look_and_reach", iterations = 10, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
