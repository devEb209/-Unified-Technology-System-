-- ARKHER SYSTEM VB.0078 :: LOD Cascade Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0078"
	S.key = "arkher.conttime.lodcascade.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lodcascade.persistent_state" }
	S.tags = { "vb", "lodcascade", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.lodcascade.coherence_guard", window = 85, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
