-- ARKHER SYSTEM VA.0348 :: Society Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0348"
	S.key = "arkher.contworld.societycont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.societycont.reality_continuum" }
	S.tags = { "va", "societycont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.societycont.emergence_continuum", windowSize = 4, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
