-- ARKHER SYSTEM W.0256 :: Match Cut Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0256"
	S.key = "arkher.cine.matchcut.shot_composition"
	S.name = "Match Cut Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Match Cut"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.matchcut.colour_grade" }
	S.tags = { "w", "matchcut", "composer", "cine" }
	S.description = "Match Cut Shot Composition: blending of the signals that make up the final shot for the Match Cut subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.matchcut.shot_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
