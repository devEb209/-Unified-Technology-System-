-- ARKHER SYSTEM O.0233 :: Adaptive Music Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0233"
	S.key = "arkher.audio.adaptivemusic.voice_budget"
	S.name = "Adaptive Music Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.adaptivemusic.music_sequencer" }
	S.tags = { "o", "adaptivemusic", "budgeter", "audio" }
	S.description = "Adaptive Music Voice Budget: voice slots allocated by priority and audibility for the Adaptive Music subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.adaptivemusic.voice_budget", total = 122, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
