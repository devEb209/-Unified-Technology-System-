...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Fairlight — ANIMATION Map #0073", size=Vector2.new(640, 480), pos=UDim2.fromOffset(249, 281), parent=parent, icon="🎬"})
...
Components.Slider(props, "Value", -5,5,0, function(v) local s=game:GetService("Selection"):Get()[1]; if s and s:IsA("BasePart") then s:SetAttribute("ARKHER_T"..73, v) end end)
