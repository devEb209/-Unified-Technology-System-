-- ARKHER SYSTEM Z.0661 :: Auto Documentation Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0661"
	S.key = "arkher.origin.autodocumentation.reality_layering"
	S.name = "Auto Documentation Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "autodocumentation", "reality", "origin" }
	S.description = "Auto Documentation Reality Layering: stacked authored, simulated, proposed and player realities for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.autodocumentation.reality_layering" })
		inst.system = S
		inst.ctx = ctx
