-- ARKHER SYSTEM T.0061 :: World Knowledge World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0061"
	S.key = "arkher.ai.worldknowledge.world_architect"
	S.name = "World Knowledge World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.worldknowledge.self_critique" }
	S.tags = { "t", "worldknowledge", "architect", "ai" }
	S.description = "World Knowledge World Architect: composition of a whole world plan with conserved budgets for the World Knowledge subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.worldknowledge.world_architect", budget = 1000, seed = 45064 })
		inst.system = S
		inst.ctx = ctx
