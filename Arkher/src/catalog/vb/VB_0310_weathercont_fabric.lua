-- ARKHER SYSTEM VB.0310 :: Weather Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0310"
	S.key = "arkher.conttime.weathercont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.weathercont.complexity_budget" }
	S.tags = { "vb", "weathercont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.weathercont.simulation_fabric", budgetMs = 4.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
