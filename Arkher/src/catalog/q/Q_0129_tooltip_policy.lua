-- ARKHER SYSTEM Q.0129 :: Tooltip Accessibility Policy
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0129"
	S.key = "arkher.ui.tooltip.accessibility_policy"
	S.name = "Tooltip Accessibility Policy"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tooltip"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.tooltip.interaction_ledger" }
	S.tags = { "q", "tooltip", "policy", "ui" }
	S.description = "Tooltip Accessibility Policy: rules enforcing contrast, target size and motion limits for the Tooltip subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ui.tooltip.accessibility_policy", algorithm = "edf", starvationGuard = 41 })
		inst.system = S
		inst.ctx = ctx
