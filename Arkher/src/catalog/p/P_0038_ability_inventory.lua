-- ARKHER SYSTEM P.0038 :: Ability Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0038"
	S.key = "arkher.play.ability.inventory"
	S.name = "Ability Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ability"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ability.attributes" }
	S.tags = { "p", "ability", "inventory", "play" }
	S.description = "Ability Inventory: slots, stacking, weight, equipment and crafting for the Ability subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.ability.inventory", slots = 20, maxWeight = 100 })
		inst.system = S
		inst.ctx = ctx
