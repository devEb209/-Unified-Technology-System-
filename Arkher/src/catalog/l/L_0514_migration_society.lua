-- ARKHER SYSTEM L.0514 :: Migration Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0514"
	S.key = "arkher.sim.migration.society"
	S.name = "Migration Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.migration.economy" }
	S.tags = { "l", "migration", "society", "sim" }
	S.description = "Migration Society: relations, factions, reputation and cohesion of the region for the Migration subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.migration.society", decayRate = 0.009, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
