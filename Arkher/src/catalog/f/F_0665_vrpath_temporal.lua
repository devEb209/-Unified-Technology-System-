-- ARKHER SYSTEM F.0665 :: VR Stereo Path Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0665"
	S.key = "arkher.render.vrpath.temporal_resolve"
	S.name = "VR Stereo Path Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.vrpath.probe_volume" }
	S.tags = { "f", "vrpath", "temporal", "render" }
	S.description = "VR Stereo Path Temporal Resolve: history reprojection with neighbourhood clamping for the VR Stereo Path subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.vrpath.temporal_resolve", feedback = 0.93, phase = 8 })
		inst.system = S
		inst.ctx = ctx
