-- ARKHER SYSTEM VB.0390 :: Memory Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0390"
	S.key = "arkher.conttime.memorycont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memorycont.persistent_state" }
	S.tags = { "vb", "memorycont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.memorycont.coherence_guard", window = 120, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
