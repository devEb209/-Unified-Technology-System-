-- ARKHER SYSTEM F.0575 :: Debug Visualization Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0575"
	S.key = "arkher.render.debugvis.frame_graph"
	S.name = "Debug Visualization Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "debugvis", "framegraph", "render" }
	S.description = "Debug Visualization Frame Graph: declared passes, culling, ordering and aliasing for the Debug Visualization subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.debugvis.frame_graph", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
