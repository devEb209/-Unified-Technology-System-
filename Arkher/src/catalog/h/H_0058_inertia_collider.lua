-- ARKHER SYSTEM H.0058 :: Inertia Tensor Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0058"
	S.key = "arkher.physics.inertia.collision_shape"
	S.name = "Inertia Tensor Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.inertia.body_dynamics" }
	S.tags = { "h", "inertia", "collider", "physics" }
	S.description = "Inertia Tensor Collision Shape: shape bounds, support mapping and closest points for the Inertia Tensor subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.inertia.collision_shape", shape = "sphere", radius = 2.50, height = 2.10, layer = "world" })
		inst.system = S
		inst.ctx = ctx
