-- ARKHER SYSTEM H.0316 :: Mesh Collider Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0316"
	S.key = "arkher.physics.meshcollider.broadphase_index"
	S.name = "Mesh Collider Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.meshcollider.vehicle" }
	S.tags = { "h", "meshcollider", "index", "physics" }
	S.description = "Mesh Collider Broadphase Index: spatial acceleration of candidate pair finding for the Mesh Collider subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.meshcollider.broadphase_index", mode = "hash", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
