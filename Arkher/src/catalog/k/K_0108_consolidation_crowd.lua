-- ARKHER SYSTEM K.0108 :: Memory Consolidation Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0108"
	S.key = "arkher.npc.consolidation.crowd_steering"
	S.name = "Memory Consolidation Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.consolidation.navigation" }
	S.tags = { "k", "consolidation", "crowd", "npc" }
	S.description = "Memory Consolidation Crowd Steering: local avoidance, cohesion and arrival at scale for the Memory Consolidation subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.consolidation.crowd_steering", radius = 0.70, maxSpeed = 4.60, cellSize = 10 })
		inst.system = S
		inst.ctx = ctx
