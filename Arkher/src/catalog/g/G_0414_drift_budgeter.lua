-- ARKHER SYSTEM G.0414 :: Drift Detection Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0414"
	S.key = "arkher.neural.drift.compute_budget"
	S.name = "Drift Detection Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.drift.quality_predictor" }
	S.tags = { "g", "drift", "budgeter", "neural" }
	S.description = "Drift Detection Compute Budget: inference time budget allocation for the Drift Detection subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.drift.compute_budget", total = 86, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
