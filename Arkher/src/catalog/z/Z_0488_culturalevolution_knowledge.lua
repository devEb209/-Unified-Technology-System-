-- ARKHER SYSTEM Z.0488 :: Cultural Evolution Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0488"
	S.key = "arkher.origin.culturalevolution.semantic_graph"
	S.name = "Cultural Evolution Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.world_architect" }
	S.tags = { "z", "culturalevolution", "knowledge", "origin" }
	S.description = "Cultural Evolution Semantic Graph: typed entities and inferred relations of the technology itself for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.culturalevolution.semantic_graph", dims = 32 })
		inst.system = S
		inst.ctx = ctx
