-- ARKHER SYSTEM N.0393 :: Footprint Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0393"
	S.key = "arkher.vfx.footprint.force_field"
	S.name = "Footprint Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Footprint"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.footprint.particle_simulation" }
	S.tags = { "n", "footprint", "forcefield", "vfx" }
	S.description = "Footprint Force Field: wind, attraction, vortex, drag and curl turbulence for the Footprint subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.footprint.force_field", seed = 9518 })
		inst.system = S
		inst.ctx = ctx
