-- ARKHER SYSTEM J.0085 :: Facial Rig Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0085"
	S.key = "arkher.character.facialrig.variant_registry"
	S.name = "Facial Rig Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.facialrig.appearance_composer" }
	S.tags = { "j", "facialrig", "registry", "character" }
	S.description = "Facial Rig Variant Registry: named character variants and their lifecycle for the Facial Rig subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.facialrig.variant_registry" })
		inst.system = S
		inst.ctx = ctx
