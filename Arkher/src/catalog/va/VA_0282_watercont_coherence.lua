-- ARKHER SYSTEM VA.0282 :: Water Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0282"
	S.key = "arkher.contworld.watercont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.watercont.persistent_state" }
	S.tags = { "va", "watercont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.watercont.coherence_guard", window = 84, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
