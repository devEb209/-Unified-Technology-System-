-- ARKHER SYSTEM K.0570 :: Work Behaviour Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0570"
	S.key = "arkher.npc.workbehaviour.crowd_steering"
	S.name = "Work Behaviour Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workbehaviour.navigation" }
	S.tags = { "k", "workbehaviour", "crowd", "npc" }
	S.description = "Work Behaviour Crowd Steering: local avoidance, cohesion and arrival at scale for the Work Behaviour subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.workbehaviour.crowd_steering", radius = 0.85, maxSpeed = 4.90, cellSize = 7 })
		inst.system = S
		inst.ctx = ctx
