-- ARKHER SYSTEM V.0109 :: Voice Line Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0109"
	S.key = "arkher.asset.voiceline.import"
	S.name = "Voice Line Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "voiceline", "importer", "asset" }
	S.description = "Voice Line Import: validation, normalization, hashing and deduplication of incoming content for the Voice Line subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.voiceline.import", unitScale = 1.75 })
		inst.system = S
		inst.ctx = ctx
