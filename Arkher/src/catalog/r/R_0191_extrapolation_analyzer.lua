-- ARKHER SYSTEM R.0191 :: Extrapolation Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0191"
	S.key = "arkher.net.extrapolation.latency_analysis"
	S.name = "Extrapolation Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.extrapolation.audit_ledger" }
	S.tags = { "r", "extrapolation", "analyzer", "net" }
	S.description = "Extrapolation Latency Analysis: round trip, jitter and loss analysis for the Extrapolation subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.extrapolation.latency_analysis", window = 133, buckets = 17, threshold = 3.50 })
		inst.system = S
		inst.ctx = ctx
