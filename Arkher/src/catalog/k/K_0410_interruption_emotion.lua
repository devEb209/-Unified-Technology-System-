-- ARKHER SYSTEM K.0410 :: Interruption Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0410"
	S.key = "arkher.npc.interruption.emotion"
	S.name = "Interruption Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.interruption.drive_system" }
	S.tags = { "k", "interruption", "emotion", "npc" }
	S.description = "Interruption Emotion: appraisal of events into valence, arousal and mood for the Interruption subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.interruption.emotion", inertia = 0.93, decayRate = 0.28, baselineArousal = 0.28 })
		inst.system = S
		inst.ctx = ctx
