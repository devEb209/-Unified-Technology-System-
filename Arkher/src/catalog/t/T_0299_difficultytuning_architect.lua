-- ARKHER SYSTEM T.0299 :: Difficulty Tuning World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0299"
	S.key = "arkher.ai.difficultytuning.world_architect"
	S.name = "Difficulty Tuning World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.difficultytuning.self_critique" }
	S.tags = { "t", "difficultytuning", "architect", "ai" }
	S.description = "Difficulty Tuning World Architect: composition of a whole world plan with conserved budgets for the Difficulty Tuning subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.difficultytuning.world_architect", budget = 600, seed = 31740 })
		inst.system = S
		inst.ctx = ctx
