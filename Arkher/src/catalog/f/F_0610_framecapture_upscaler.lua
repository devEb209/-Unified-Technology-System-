-- ARKHER SYSTEM F.0610 :: Frame Capture Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0610"
	S.key = "arkher.render.framecapture.adaptive_resolution"
	S.name = "Frame Capture Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framecapture.temporal_resolve" }
	S.tags = { "f", "framecapture", "upscaler", "render" }
	S.description = "Frame Capture Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Frame Capture subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.framecapture.adaptive_resolution", targetMs = 15.10, index = 4, sharpness = 0.48 })
		inst.system = S
		inst.ctx = ctx
