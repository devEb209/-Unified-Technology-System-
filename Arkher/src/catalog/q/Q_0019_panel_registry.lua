-- ARKHER SYSTEM Q.0019 :: Panel Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0019"
	S.key = "arkher.ui.panel.localization_registry"
	S.name = "Panel Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Panel"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.panel.theme_composition" }
	S.tags = { "q", "panel", "registry", "ui" }
	S.description = "Panel Localization Registry: catalogue of strings, plurals and locale metadata for the Panel subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.panel.localization_registry" })
		inst.system = S
		inst.ctx = ctx
