-- ARKHER SYSTEM W.0376 :: Playback Control Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0376"
	S.key = "arkher.cine.playbackcontrol.shot_composition"
	S.name = "Playback Control Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.playbackcontrol.colour_grade" }
	S.tags = { "w", "playbackcontrol", "composer", "cine" }
	S.description = "Playback Control Shot Composition: blending of the signals that make up the final shot for the Playback Control subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.playbackcontrol.shot_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
