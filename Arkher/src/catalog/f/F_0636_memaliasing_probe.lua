-- ARKHER SYSTEM F.0636 :: Memory Aliasing Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0636"
	S.key = "arkher.render.memaliasing.probe_volume"
	S.name = "Memory Aliasing Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.memaliasing.lighting_rig" }
	S.tags = { "f", "memaliasing", "probe", "render" }
	S.description = "Memory Aliasing Probe Volume: irradiance probes encoded in spherical harmonics for the Memory Aliasing subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.memaliasing.probe_volume", spacing = 40 })
		inst.system = S
		inst.ctx = ctx
