-- ARKHER SYSTEM Z.0139 :: Dynamic Complexity Manager Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0139"
	S.key = "arkher.origin.complexitymanager.residency_streaming"
	S.name = "Dynamic Complexity Manager Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.budget_governor" }
	S.tags = { "z", "complexitymanager", "streamer", "origin" }
	S.description = "Dynamic Complexity Manager Residency Streaming: distance-driven residency of the technology's workload for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.complexitymanager.residency_streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
