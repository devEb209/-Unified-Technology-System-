-- ARKHER SYSTEM VC.0059 :: Epoch Frame Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0059"
	S.key = "arkher.contneural.epochframe.reality_continuum"
	S.name = "Epoch Frame Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.epochframe.simulation_fabric" }
	S.tags = { "vc", "epochframe", "reality", "contneural" }
	S.description = "Epoch Frame Reality Continuum: stacked reality layers of the continuum for the Epoch Frame subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.epochframe.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
