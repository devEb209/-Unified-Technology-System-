-- ARKHER SYSTEM VD.0027 :: Zone Chunk Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0027"
	S.key = "arkher.contsim.zonechunk.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.zonechunk.epoch_clock" }
	S.tags = { "vd", "zonechunk", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.zonechunk.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
