-- ARKHER SYSTEM E.0072 :: Metalness Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0072"
	S.key = "arkher.material.metalness.analysis"
	S.name = "Metalness Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Metalness"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.metalness.instance_cache" }
	S.tags = { "e", "metalness", "analyzer", "material" }
	S.description = "Metalness Analysis: cost, redundancy and outlier analysis for the Metalness subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.metalness.analysis", window = 157, buckets = 17, threshold = 2.90 })
		inst.system = S
		inst.ctx = ctx
