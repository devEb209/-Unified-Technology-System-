-- ARKHER SYSTEM T.0469 :: Reward Modelling Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0469"
	S.key = "arkher.ai.rewardmodelling.decision_policy"
	S.name = "Reward Modelling Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.rewardmodelling.reasoning_graph" }
	S.tags = { "t", "rewardmodelling", "policy", "ai" }
	S.description = "Reward Modelling Decision Policy: ordered rules deciding what the agent does next for the Reward Modelling subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.rewardmodelling.decision_policy", algorithm = "roundrobin", starvationGuard = 48 })
		inst.system = S
		inst.ctx = ctx
