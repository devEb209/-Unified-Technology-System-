-- ARKHER SYSTEM Z.0746 :: World Compression Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0746"
	S.key = "arkher.origin.worldcompression.emergence_detection"
	S.name = "World Compression Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.world_memory" }
	S.tags = { "z", "worldcompression", "emergence", "origin" }
	S.description = "World Compression Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the World Compression subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.worldcompression.emergence_detection", windowSize = 5, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
