-- ARKHER SYSTEM F.0590 :: Wireframe Overlay View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0590"
	S.key = "arkher.render.wireframe.view_and_culling"
	S.name = "Wireframe Overlay View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.wireframe.frame_graph" }
	S.tags = { "f", "wireframe", "camera", "render" }
	S.description = "Wireframe Overlay View And Culling: view state, frustum culling and screen-size LOD for the Wireframe Overlay subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.wireframe.view_and_culling", width = 956, height = 1260, fov = 1.0100, far = 2200 })
		inst.system = S
		inst.ctx = ctx
