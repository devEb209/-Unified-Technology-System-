-- ARKHER SYSTEM Z.0360 :: Device Aware Fidelity Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0360"
	S.key = "arkher.origin.deviceaware.orchestration"
	S.name = "Device Aware Fidelity Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.residency_streaming" }
	S.tags = { "z", "deviceaware", "orchestrator", "origin" }
	S.description = "Device Aware Fidelity Orchestration: lifecycle and phase orchestration of the technology for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.deviceaware.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
