-- ARKHER SYSTEM VD.0425 :: Navigation Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0425"
	S.key = "arkher.contsim.navcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.navcont.multi-scale_fidelity" }
	S.tags = { "vd", "navcont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.navcont.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
