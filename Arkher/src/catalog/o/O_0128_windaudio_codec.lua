-- ARKHER SYSTEM O.0128 :: Wind Audio Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0128"
	S.key = "arkher.audio.windaudio.compression_codec"
	S.name = "Wind Audio Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Wind Audio"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.windaudio.asset_registry" }
	S.tags = { "o", "windaudio", "codec", "audio" }
	S.description = "Wind Audio Compression Codec: payload encoding of audio state and events for the Wind Audio subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.windaudio.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
