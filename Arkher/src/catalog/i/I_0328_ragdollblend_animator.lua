-- ARKHER SYSTEM I.0328 :: Ragdoll Blend Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0328"
	S.key = "arkher.anim.ragdollblend.layered_blending"
	S.name = "Ragdoll Blend Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.ragdollblend.clip_sampling" }
	S.tags = { "i", "ragdollblend", "animator", "anim" }
	S.description = "Ragdoll Blend Layered Blending: layers, crossfades, masks and blend trees for the Ragdoll Blend subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.ragdollblend.layered_blending", budget = 11 })
		inst.system = S
		inst.ctx = ctx
