-- ARKHER SYSTEM L.0230 :: Weather Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0230"
	S.key = "arkher.sim.weather.calendar"
	S.name = "Weather Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.weather.society" }
	S.tags = { "l", "weather", "schedule", "sim" }
	S.description = "Weather Calendar: hours, days and seasons driving the region for the Weather subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.weather.calendar", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
