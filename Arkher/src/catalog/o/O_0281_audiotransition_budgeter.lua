-- ARKHER SYSTEM O.0281 :: Transition Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0281"
	S.key = "arkher.audio.audiotransition.voice_budget"
	S.name = "Transition Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Transition"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiotransition.music_sequencer" }
	S.tags = { "o", "audiotransition", "budgeter", "audio" }
	S.description = "Transition Voice Budget: voice slots allocated by priority and audibility for the Transition subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.audiotransition.voice_budget", total = 72, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
