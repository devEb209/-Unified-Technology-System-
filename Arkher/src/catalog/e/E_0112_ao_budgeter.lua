-- ARKHER SYSTEM E.0112 :: Ambient Occlusion Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0112"
	S.key = "arkher.material.ao.parameter_budget"
	S.name = "Ambient Occlusion Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.ao.variant_registry" }
	S.tags = { "e", "ao", "budgeter", "material" }
	S.description = "Ambient Occlusion Parameter Budget: texel and layer budget allocation for the Ambient Occlusion subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.ao.parameter_budget", total = 208, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
