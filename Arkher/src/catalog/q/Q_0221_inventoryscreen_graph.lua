-- ARKHER SYSTEM Q.0221 :: Inventory Screen Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0221"
	S.key = "arkher.ui.inventoryscreen.navigation_graph"
	S.name = "Inventory Screen Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.inventoryscreen.transition" }
	S.tags = { "q", "inventoryscreen", "graph", "ui" }
	S.description = "Inventory Screen Navigation Graph: screens, routes and shortest path between them for the Inventory Screen subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.inventoryscreen.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
