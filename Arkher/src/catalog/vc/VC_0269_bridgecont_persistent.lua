-- ARKHER SYSTEM VC.0269 :: Bridge Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0269"
	S.key = "arkher.contneural.bridgecont.persistent_state"
	S.name = "Bridge Continuum Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.bridgecont.multi-scale_fidelity" }
	S.tags = { "vc", "bridgecont", "persistent", "contneural" }
	S.description = "Bridge Continuum Persistent State: epoch-stamped persistent history and rollback for the Bridge Continuum subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.bridgecont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
