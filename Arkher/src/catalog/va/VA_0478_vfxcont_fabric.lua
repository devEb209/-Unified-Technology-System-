-- ARKHER SYSTEM VA.0478 :: VFX Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0478"
	S.key = "arkher.contworld.vfxcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vfxcont.complexity_budget" }
	S.tags = { "va", "vfxcont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.vfxcont.simulation_fabric", budgetMs = 1.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
