-- ARKHER SYSTEM T.0105 :: Context Memory Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0105"
	S.key = "arkher.ai.contextmemory.decision_policy"
	S.name = "Context Memory Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.contextmemory.reasoning_graph" }
	S.tags = { "t", "contextmemory", "policy", "ai" }
	S.description = "Context Memory Decision Policy: ordered rules deciding what the agent does next for the Context Memory subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.contextmemory.decision_policy", algorithm = "lottery", starvationGuard = 19 })
		inst.system = S
		inst.ctx = ctx
