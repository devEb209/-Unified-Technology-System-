-- ARKHER SYSTEM VD.0397 :: Perception Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0397"
	S.key = "arkher.contsim.perceptioncont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "perceptioncont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.perceptioncont.infinite_grid", cellSize = 160, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
