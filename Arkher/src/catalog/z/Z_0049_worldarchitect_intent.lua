-- ARKHER SYSTEM Z.0049 :: Singularity World Architect Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0049"
	S.key = "arkher.origin.worldarchitect.intent_bridge"
	S.name = "Singularity World Architect Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.semantic_graph" }
	S.tags = { "z", "worldarchitect", "intent", "origin" }
	S.description = "Singularity World Architect Intent Bridge: natural language control surface for the technology for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.worldarchitect.intent_bridge", minConfidence = 0.41 })
		inst.system = S
		inst.ctx = ctx
