-- ARKHER SYSTEM G.0312 :: Weight Quantization Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0312"
	S.key = "arkher.neural.quantization.reconstruction"
	S.name = "Weight Quantization Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.quantization.temporal_history" }
	S.tags = { "g", "quantization", "upscaler", "neural" }
	S.description = "Weight Quantization Reconstruction: resolution ladder and image reconstruction for the Weight Quantization subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.quantization.reconstruction", targetMs = 15.10, index = 4, sharpness = 0.48 })
		inst.system = S
		inst.ctx = ctx
