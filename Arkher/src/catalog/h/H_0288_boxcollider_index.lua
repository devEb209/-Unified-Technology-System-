-- ARKHER SYSTEM H.0288 :: Box Collider Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0288"
	S.key = "arkher.physics.boxcollider.broadphase_index"
	S.name = "Box Collider Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Box Collider"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.boxcollider.vehicle" }
	S.tags = { "h", "boxcollider", "index", "physics" }
	S.description = "Box Collider Broadphase Index: spatial acceleration of candidate pair finding for the Box Collider subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.boxcollider.broadphase_index", mode = "hash", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
