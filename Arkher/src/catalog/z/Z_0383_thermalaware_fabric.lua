-- ARKHER SYSTEM Z.0383 :: Thermal Aware Simulation Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0383"
	S.key = "arkher.origin.thermalaware.simulation_fabric"
	S.name = "Thermal Aware Simulation Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.complexity_governance" }
	S.tags = { "z", "thermalaware", "fabric", "origin" }
	S.description = "Thermal Aware Simulation Simulation Fabric: every simulation domain stepped under one budgeted clock for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.thermalaware.simulation_fabric", budgetMs = 2.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
