-- ARKHER SYSTEM H.0687 :: Overlap Query Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0687"
	S.key = "arkher.physics.overlap.body_dynamics"
	S.name = "Overlap Query Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "overlap", "rigidbody", "physics" }
	S.description = "Overlap Query Body Dynamics: integration, impulses, damping and sleeping of a body for the Overlap Query subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.overlap.body_dynamics", mass = 21.00, radius = 0.30, restitution = 0.40, friction = 0.60, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
