-- ARKHER SYSTEM N.0135 :: Waterfall Mist Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0135"
	S.key = "arkher.vfx.mist.curve_authoring"
	S.name = "Waterfall Mist Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.mist.ribbon_and_trail" }
	S.tags = { "n", "mist", "spline", "vfx" }
	S.description = "Waterfall Mist Curve Authoring: authored curves driving the effect over its life for the Waterfall Mist subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.mist.curve_authoring", tension = 0.64, closed = false })
		inst.system = S
		inst.ctx = ctx
