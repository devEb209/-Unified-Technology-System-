-- ARKHER SYSTEM Z.0985 :: Engine Self Model World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0985"
	S.key = "arkher.origin.engineselfmodel.world_memory"
	S.name = "Engine Self Model World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.engineselfmodel.autonomous_pipeline" }
	S.tags = { "z", "engineselfmodel", "worldmemory", "origin" }
	S.description = "Engine Self Model World Memory: epoch-stamped persistent history with compaction and checkpoints for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.engineselfmodel.world_memory", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
