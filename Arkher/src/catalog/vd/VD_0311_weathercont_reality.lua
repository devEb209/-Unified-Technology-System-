-- ARKHER SYSTEM VD.0311 :: Weather Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0311"
	S.key = "arkher.contsim.weathercont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.weathercont.simulation_fabric" }
	S.tags = { "vd", "weathercont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.weathercont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
