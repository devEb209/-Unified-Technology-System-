-- ARKHER SYSTEM W.0268 :: Letterbox Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0268"
	S.key = "arkher.cine.letterbox.shot_composition"
	S.name = "Letterbox Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Letterbox"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.letterbox.colour_grade" }
	S.tags = { "w", "letterbox", "composer", "cine" }
	S.description = "Letterbox Shot Composition: blending of the signals that make up the final shot for the Letterbox subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.letterbox.shot_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
