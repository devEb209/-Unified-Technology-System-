-- ARKHER SYSTEM O.0317 :: Vehicle Audio Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0317"
	S.key = "arkher.audio.vehicleaudio.voice_budget"
	S.name = "Vehicle Audio Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.vehicleaudio.music_sequencer" }
	S.tags = { "o", "vehicleaudio", "budgeter", "audio" }
	S.description = "Vehicle Audio Voice Budget: voice slots allocated by priority and audibility for the Vehicle Audio subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.vehicleaudio.voice_budget", total = 326, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
