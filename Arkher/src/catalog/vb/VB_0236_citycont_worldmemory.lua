-- ARKHER SYSTEM VB.0236 :: City Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0236"
	S.key = "arkher.conttime.citycont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.citycont.neural_field" }
	S.tags = { "vb", "citycont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.citycont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
