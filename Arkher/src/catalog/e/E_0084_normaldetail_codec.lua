-- ARKHER SYSTEM E.0084 :: Normal Detail Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0084"
	S.key = "arkher.material.normaldetail.compression_codec"
	S.name = "Normal Detail Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.normaldetail.streaming" }
	S.tags = { "e", "normaldetail", "codec", "material" }
	S.description = "Normal Detail Compression Codec: serialization and compression of material data for the Normal Detail subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.normaldetail.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
