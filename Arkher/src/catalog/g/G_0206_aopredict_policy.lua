-- ARKHER SYSTEM G.0206 :: Ambient Occlusion Prediction Heuristic Policy
...
return function(A)
	...
	local S = {}
	S.id = "G.0206"
	S.key = "arkher.neural.aopredict.heuristic_policy"
	S.name = "Ambient Occlusion Prediction Heuristic Policy"
	S.category = "G"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.aopredict.result_cache" }
	S.tags = { "g", "aopredict", "policy", "neural" }
	S.description = "Ambient Occlusion Prediction Heuristic Policy: rule fallback when the model is unavailable for the Ambient Occlusion Prediction subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.neural.aopredict.heuristic_policy", algorithm = "roundrobin", starvationGuard = 32 })
		inst.system = S
		inst.ctx = ctx
