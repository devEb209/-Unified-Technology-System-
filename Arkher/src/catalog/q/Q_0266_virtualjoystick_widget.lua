-- ARKHER SYSTEM Q.0266 :: Virtual Joystick Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0266"
	S.key = "arkher.ui.virtualjoystick.widget_tree"
	S.name = "Virtual Joystick Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.virtualjoystick.responsive_layout" }
	S.tags = { "q", "virtualjoystick", "widget", "ui" }
	S.description = "Virtual Joystick Widget Tree: retained widget nodes, properties, bindings and rendering for the Virtual Joystick subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.virtualjoystick.widget_tree", theme = "dark", scale = 1.17 })
		inst.system = S
		inst.ctx = ctx
