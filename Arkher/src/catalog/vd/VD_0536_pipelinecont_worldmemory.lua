-- ARKHER SYSTEM VD.0536 :: Pipeline Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0536"
	S.key = "arkher.contsim.pipelinecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.pipelinecont.neural_field" }
	S.tags = { "vd", "pipelinecont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.pipelinecont.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
