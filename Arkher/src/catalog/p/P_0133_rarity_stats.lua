-- ARKHER SYSTEM P.0133 :: Rarity Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0133"
	S.key = "arkher.play.rarity.attributes"
	S.name = "Rarity Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Rarity"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "rarity", "stats", "play" }
	S.description = "Rarity Attributes: base values, layered modifiers and derived statistics for the Rarity subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.rarity.attributes" })
		inst.system = S
		inst.ctx = ctx
