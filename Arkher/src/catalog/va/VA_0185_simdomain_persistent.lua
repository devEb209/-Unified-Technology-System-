-- ARKHER SYSTEM VA.0185 :: Simulation Domain Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0185"
	S.key = "arkher.contworld.simdomain.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.simdomain.multi-scale_fidelity" }
	S.tags = { "va", "simdomain", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.simdomain.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
