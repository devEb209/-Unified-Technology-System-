-- ARKHER SYSTEM P.0399 :: Match Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0399"
	S.key = "arkher.play.match.objectives"
	S.name = "Match Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Match"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.match.inventory" }
	S.tags = { "p", "match", "quest", "play" }
	S.description = "Match Objectives: objectives, prerequisites, progress and rewards for the Match subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.match.objectives" })
		inst.system = S
		inst.ctx = ctx
