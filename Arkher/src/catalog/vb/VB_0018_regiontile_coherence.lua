-- ARKHER SYSTEM VB.0018 :: Region Tile Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0018"
	S.key = "arkher.conttime.regiontile.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.regiontile.persistent_state" }
	S.tags = { "vb", "regiontile", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.regiontile.coherence_guard", window = 121, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
