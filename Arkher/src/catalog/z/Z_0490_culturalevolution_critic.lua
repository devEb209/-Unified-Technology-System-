-- ARKHER SYSTEM Z.0490 :: Cultural Evolution Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0490"
	S.key = "arkher.origin.culturalevolution.self_critique"
	S.name = "Cultural Evolution Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.intent_bridge" }
	S.tags = { "z", "culturalevolution", "critic", "origin" }
	S.description = "Cultural Evolution Self Critique: weighted judgement of the technology's own output for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.culturalevolution.self_critique", passMark = 0.70, reviseMark = 0.40, seed = 84120 })
		inst.system = S
		inst.ctx = ctx
