-- ARKHER SYSTEM VC.0030 :: Zone Chunk Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0030"
	S.key = "arkher.contneural.zonechunk.coherence_guard"
	S.name = "Zone Chunk Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.zonechunk.persistent_state" }
	S.tags = { "vc", "zonechunk", "coherence", "contneural" }
	S.description = "Zone Chunk Coherence Guard: seam coherence and drift supervision for the Zone Chunk subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.zonechunk.coherence_guard", window = 127, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
