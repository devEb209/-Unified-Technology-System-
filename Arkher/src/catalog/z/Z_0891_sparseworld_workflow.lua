-- ARKHER SYSTEM Z.0891 :: Sparse World Representation Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0891"
	S.key = "arkher.origin.sparseworld.adaptive_workflow"
	S.name = "Sparse World Representation Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.self_critique" }
	S.tags = { "z", "sparseworld", "workflow", "origin" }
	S.description = "Sparse World Representation Adaptive Workflow: verified, retryable, reversible execution plans for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.sparseworld.adaptive_workflow", maxRetries = 3, budget = 150 })
		inst.system = S
		inst.ctx = ctx
