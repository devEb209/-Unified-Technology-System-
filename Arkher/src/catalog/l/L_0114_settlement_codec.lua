-- ARKHER SYSTEM L.0114 :: Settlement State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0114"
	S.key = "arkher.sim.settlement.state_codec"
	S.name = "Settlement State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.settlement.history_ledger" }
	S.tags = { "l", "settlement", "codec", "sim" }
	S.description = "Settlement State Codec: persistence, diffing and checksum of the world state for the Settlement subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.settlement.state_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
