-- ARKHER SYSTEM Q.0190 :: Health Bar Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0190"
	S.key = "arkher.ui.healthbar.frame_budget"
	S.name = "Health Bar Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Health Bar"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.healthbar.accessibility_policy" }
	S.tags = { "q", "healthbar", "budgeter", "ui" }
	S.description = "Health Bar Frame Budget: per-frame layout and draw budget for the interface for the Health Bar subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.healthbar.frame_budget", total = 133, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
