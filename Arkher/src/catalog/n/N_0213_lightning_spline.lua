-- ARKHER SYSTEM N.0213 :: Lightning Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0213"
	S.key = "arkher.vfx.lightning.curve_authoring"
	S.name = "Lightning Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Lightning"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.lightning.ribbon_and_trail" }
	S.tags = { "n", "lightning", "spline", "vfx" }
	S.description = "Lightning Curve Authoring: authored curves driving the effect over its life for the Lightning subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.lightning.curve_authoring", tension = 0.70, closed = false })
		inst.system = S
		inst.ctx = ctx
