-- ARKHER SYSTEM W.0368 :: Cinematic Audio Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0368"
	S.key = "arkher.cine.cinematicaudio.cinematic_mix"
	S.name = "Cinematic Audio Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinematicaudio.motion_tween" }
	S.tags = { "w", "cinematicaudio", "mixer", "cine" }
	S.description = "Cinematic Audio Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Cinematic Audio subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.cinematicaudio.cinematic_mix", maxVoices = 56 })
		inst.system = S
		inst.ctx = ctx
