-- ARKHER SYSTEM Q.0007 :: Screen Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0007"
	S.key = "arkher.ui.screen.localization_registry"
	S.name = "Screen Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Screen"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.screen.theme_composition" }
	S.tags = { "q", "screen", "registry", "ui" }
	S.description = "Screen Localization Registry: catalogue of strings, plurals and locale metadata for the Screen subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.screen.localization_registry" })
		inst.system = S
		inst.ctx = ctx
