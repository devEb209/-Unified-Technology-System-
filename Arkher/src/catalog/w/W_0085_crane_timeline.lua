-- ARKHER SYSTEM W.0085 :: Crane Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0085"
	S.key = "arkher.cine.crane.sequence_timeline"
	S.name = "Crane Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Crane"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "crane", "timeline", "cine" }
	S.description = "Crane Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Crane subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.crane.sequence_timeline", duration = 5.0, rate = 0.89 })
		inst.system = S
		inst.ctx = ctx
