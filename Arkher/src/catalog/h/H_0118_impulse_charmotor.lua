-- ARKHER SYSTEM H.0118 :: Impulse Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0118"
	S.key = "arkher.physics.impulse.character_motion"
	S.name = "Impulse Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Impulse"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.impulse.query" }
	S.tags = { "h", "impulse", "charmotor", "physics" }
	S.description = "Impulse Character Motion: capsule move-and-slide with slopes, steps and jumps for the Impulse subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.impulse.character_motion", radius = 0.42, height = 1.87, maxSpeed = 4.70, jumpHeight = 1.90, stepOffset = 0.32 })
		inst.system = S
		inst.ctx = ctx
