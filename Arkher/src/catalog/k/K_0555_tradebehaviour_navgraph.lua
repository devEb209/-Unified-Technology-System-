-- ARKHER SYSTEM K.0555 :: Trade Behaviour Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0555"
	S.key = "arkher.npc.tradebehaviour.navigation"
	S.name = "Trade Behaviour Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.tradebehaviour.goal_planner" }
	S.tags = { "k", "tradebehaviour", "navgraph", "npc" }
	S.description = "Trade Behaviour Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Trade Behaviour subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.tradebehaviour.navigation", width = 40, height = 40, cellSize = 4 })
		inst.system = S
		inst.ctx = ctx
