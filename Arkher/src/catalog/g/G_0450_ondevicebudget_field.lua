-- ARKHER SYSTEM G.0450 :: On Device Budget Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0450"
	S.key = "arkher.neural.ondevicebudget.feature_extraction"
	S.name = "On Device Budget Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ondevicebudget.inference_core" }
	S.tags = { "g", "ondevicebudget", "field", "neural" }
	S.description = "On Device Budget Feature Extraction: signal features feeding the model for the On Device Budget subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.ondevicebudget.feature_extraction", seed = 35940, frequency = 0.0090, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
