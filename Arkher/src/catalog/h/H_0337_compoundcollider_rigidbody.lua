-- ARKHER SYSTEM H.0337 :: Compound Collider Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0337"
	S.key = "arkher.physics.compoundcollider.body_dynamics"
	S.name = "Compound Collider Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "compoundcollider", "rigidbody", "physics" }
	S.description = "Compound Collider Body Dynamics: integration, impulses, damping and sleeping of a body for the Compound Collider subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.compoundcollider.body_dynamics", mass = 18.00, radius = 1.15, restitution = 0.17, friction = 0.37, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
