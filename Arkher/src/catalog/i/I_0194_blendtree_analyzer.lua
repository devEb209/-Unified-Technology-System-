-- ARKHER SYSTEM I.0194 :: Blend Tree Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0194"
	S.key = "arkher.anim.blendtree.analysis"
	S.name = "Blend Tree Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Blend Tree"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.blendtree.quality_policy" }
	S.tags = { "i", "blendtree", "analyzer", "anim" }
	S.description = "Blend Tree Analysis: pop, drift and cost analysis of playback for the Blend Tree subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.blendtree.analysis", window = 49, buckets = 17, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
