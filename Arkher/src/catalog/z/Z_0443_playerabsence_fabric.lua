-- ARKHER SYSTEM Z.0443 :: Player Absence Simulation Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0443"
	S.key = "arkher.origin.playerabsence.simulation_fabric"
	S.name = "Player Absence Simulation Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.complexity_governance" }
	S.tags = { "z", "playerabsence", "fabric", "origin" }
	S.description = "Player Absence Simulation Simulation Fabric: every simulation domain stepped under one budgeted clock for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.playerabsence.simulation_fabric", budgetMs = 2.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
