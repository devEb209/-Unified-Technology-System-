-- ARKHER SYSTEM VB.0031 :: Zone Chunk Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0031"
	S.key = "arkher.conttime.zonechunk.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.zonechunk.coherence_guard" }
	S.tags = { "vb", "zonechunk", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.zonechunk.neural_field", dims = 16, hidden = 12, seed = 69593 })
		inst.system = S
		inst.ctx = ctx
