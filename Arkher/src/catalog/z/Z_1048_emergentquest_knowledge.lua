-- ARKHER SYSTEM Z.1048 :: Emergent Quest Generation Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.1048"
	S.key = "arkher.origin.emergentquest.semantic_graph"
	S.name = "Emergent Quest Generation Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentquest.world_architect" }
	S.tags = { "z", "emergentquest", "knowledge", "origin" }
	S.description = "Emergent Quest Generation Semantic Graph: typed entities and inferred relations of the technology itself for the Emergent Quest Generation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.emergentquest.semantic_graph", dims = 40 })
		inst.system = S
		inst.ctx = ctx
