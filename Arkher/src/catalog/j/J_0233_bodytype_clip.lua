-- ARKHER SYSTEM J.0233 :: Body Type Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0233"
	S.key = "arkher.character.bodytype.motion_set"
	S.name = "Body Type Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.bodytype.rig_definition" }
	S.tags = { "j", "bodytype", "clip", "character" }
	S.description = "Body Type Motion Set: the clips a character owns and how they sample for the Body Type subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.bodytype.motion_set", duration = 1.90, loop = true })
		inst.system = S
		inst.ctx = ctx
