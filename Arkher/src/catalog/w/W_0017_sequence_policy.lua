-- ARKHER SYSTEM W.0017 :: Sequence Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0017"
	S.key = "arkher.cine.sequence.cut_policy"
	S.name = "Sequence Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Sequence"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.sequence.shot_composition" }
	S.tags = { "w", "sequence", "policy", "cine" }
	S.description = "Sequence Cut Policy: rules deciding when the sequence cuts and to what for the Sequence subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.sequence.cut_policy", algorithm = "wfq", starvationGuard = 34 })
		inst.system = S
		inst.ctx = ctx
