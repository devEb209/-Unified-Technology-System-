-- ARKHER SYSTEM VA.0356 :: Narrative Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0356"
	S.key = "arkher.contworld.narrativecont.world_memory_stream"
	S.name = "Narrative Continuum World Memory Stream"
	S.category = "VA"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.narrativecont.neural_field" }
	S.tags = { "va", "narrativecont", "worldmemory", "contworld" }
	S.description = "Narrative Continuum World Memory Stream: world memory continuum over epochs for the Narrative Continuum subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.narrativecont.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
