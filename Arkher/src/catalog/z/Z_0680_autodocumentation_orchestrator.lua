-- ARKHER SYSTEM Z.0680 :: Auto Documentation Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0680"
	S.key = "arkher.origin.autodocumentation.orchestration"
	S.name = "Auto Documentation Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.residency_streaming" }
	S.tags = { "z", "autodocumentation", "orchestrator", "origin" }
	S.description = "Auto Documentation Orchestration: lifecycle and phase orchestration of the technology for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.autodocumentation.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
