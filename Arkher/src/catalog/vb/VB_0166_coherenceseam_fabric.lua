-- ARKHER SYSTEM VB.0166 :: Coherence Seam Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0166"
	S.key = "arkher.conttime.coherenceseam.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.coherenceseam.complexity_budget" }
	S.tags = { "vb", "coherenceseam", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.coherenceseam.simulation_fabric", budgetMs = 1.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
