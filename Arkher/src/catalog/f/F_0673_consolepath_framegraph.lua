-- ARKHER SYSTEM F.0673 :: Console Path Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0673"
	S.key = "arkher.render.consolepath.frame_graph"
	S.name = "Console Path Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Console Path"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "consolepath", "framegraph", "render" }
	S.description = "Console Path Frame Graph: declared passes, culling, ordering and aliasing for the Console Path subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.consolepath.frame_graph", budgetMs = 11.00 })
		inst.system = S
		inst.ctx = ctx
