-- ARKHER SYSTEM V.0376 :: Cook Target Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0376"
	S.key = "arkher.asset.cooktarget.asset_registry"
	S.name = "Cook Target Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.cooktarget.cook_pipeline" }
	S.tags = { "v", "cooktarget", "registry", "asset" }
	S.description = "Cook Target Asset Registry: catalogue of every asset, its tags and its metadata for the Cook Target subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.cooktarget.asset_registry" })
		inst.system = S
		inst.ctx = ctx
