-- ARKHER SYSTEM VC.0554 :: Device Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0554"
	S.key = "arkher.contneural.devicecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.devicecont.infinite_grid" }
	S.tags = { "vc", "devicecont", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.devicecont.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
