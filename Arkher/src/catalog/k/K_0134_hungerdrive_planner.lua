-- ARKHER SYSTEM K.0134 :: Hunger Drive Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0134"
	S.key = "arkher.npc.hungerdrive.goal_planner"
	S.name = "Hunger Drive Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hungerdrive.utility_reasoning" }
	S.tags = { "k", "hungerdrive", "planner", "npc" }
	S.description = "Hunger Drive Goal Planner: backward GOAP planning to reach a goal state for the Hunger Drive subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.hungerdrive.goal_planner", maxDepth = 9 })
		inst.system = S
		inst.ctx = ctx
