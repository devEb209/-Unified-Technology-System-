-- ARKHER SYSTEM VD.0031 :: Zone Chunk Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0031"
	S.key = "arkher.contsim.zonechunk.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.zonechunk.coherence_guard" }
	S.tags = { "vd", "zonechunk", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.zonechunk.neural_field", dims = 20, hidden = 16, seed = 17046 })
		inst.system = S
		inst.ctx = ctx
