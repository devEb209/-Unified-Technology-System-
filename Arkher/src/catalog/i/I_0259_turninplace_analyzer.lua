-- ARKHER SYSTEM I.0259 :: Turn In Place Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0259"
	S.key = "arkher.anim.turninplace.analysis"
	S.name = "Turn In Place Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.turninplace.quality_policy" }
	S.tags = { "i", "turninplace", "analyzer", "anim" }
	S.description = "Turn In Place Analysis: pop, drift and cost analysis of playback for the Turn In Place subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.turninplace.analysis", window = 200, buckets = 16, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
