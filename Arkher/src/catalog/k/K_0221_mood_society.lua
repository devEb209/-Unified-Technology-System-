-- ARKHER SYSTEM K.0221 :: Mood Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0221"
	S.key = "arkher.npc.mood.social_relations"
	S.name = "Mood Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.mood.crowd_steering" }
	S.tags = { "k", "mood", "society", "npc" }
	S.description = "Mood Social Relations: affinity, factions, reputation and gossip for the Mood subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.mood.social_relations", decayRate = 0.013, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
