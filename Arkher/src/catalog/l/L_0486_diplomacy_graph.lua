-- ARKHER SYSTEM L.0486 :: Diplomacy Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0486"
	S.key = "arkher.sim.diplomacy.region_graph"
	S.name = "Diplomacy Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.diplomacy.calendar" }
	S.tags = { "l", "diplomacy", "graph", "sim" }
	S.description = "Diplomacy Region Graph: connectivity, components and shortest path between places for the Diplomacy subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.diplomacy.region_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
