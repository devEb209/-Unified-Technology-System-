-- ARKHER SYSTEM N.0064 :: Dust Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0064"
	S.key = "arkher.vfx.dust.analysis"
	S.name = "Dust Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Dust"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.dust.spatial_index" }
	S.tags = { "n", "dust", "analyzer", "vfx" }
	S.description = "Dust Analysis: cost, overdraw and stability analysis of the effect for the Dust subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.dust.analysis", window = 120, buckets = 16, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
