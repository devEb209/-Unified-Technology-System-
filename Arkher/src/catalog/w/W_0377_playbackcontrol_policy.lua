-- ARKHER SYSTEM W.0377 :: Playback Control Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0377"
	S.key = "arkher.cine.playbackcontrol.cut_policy"
	S.name = "Playback Control Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.playbackcontrol.shot_composition" }
	S.tags = { "w", "playbackcontrol", "policy", "cine" }
	S.description = "Playback Control Cut Policy: rules deciding when the sequence cuts and to what for the Playback Control subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.playbackcontrol.cut_policy", algorithm = "wfq", starvationGuard = 58 })
		inst.system = S
		inst.ctx = ctx
