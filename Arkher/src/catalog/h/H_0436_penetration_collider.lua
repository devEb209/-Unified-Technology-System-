-- ARKHER SYSTEM H.0436 :: Penetration Recovery Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0436"
	S.key = "arkher.physics.penetration.collision_shape"
	S.name = "Penetration Recovery Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.penetration.body_dynamics" }
	S.tags = { "h", "penetration", "collider", "physics" }
	S.description = "Penetration Recovery Collision Shape: shape bounds, support mapping and closest points for the Penetration Recovery subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.penetration.collision_shape", shape = "sphere", radius = 1.30, height = 2.10, layer = "world" })
		inst.system = S
		inst.ctx = ctx
