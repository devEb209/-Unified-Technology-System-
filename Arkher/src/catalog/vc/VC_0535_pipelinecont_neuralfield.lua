-- ARKHER SYSTEM VC.0535 :: Pipeline Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0535"
	S.key = "arkher.contneural.pipelinecont.neural_field"
	S.name = "Pipeline Continuum Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.pipelinecont.coherence_guard" }
	S.tags = { "vc", "pipelinecont", "neuralfield", "contneural" }
	S.description = "Pipeline Continuum Neural Field: neural field encoding and reconstruction for the Pipeline Continuum subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.pipelinecont.neural_field", dims = 16, hidden = 12, seed = 55561 })
		inst.system = S
		inst.ctx = ctx
