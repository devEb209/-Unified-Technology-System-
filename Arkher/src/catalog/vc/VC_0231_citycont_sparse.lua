-- ARKHER SYSTEM VC.0231 :: City Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0231"
	S.key = "arkher.contneural.citycont.sparse_residency"
	S.name = "City Continuum Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.citycont.epoch_clock" }
	S.tags = { "vc", "citycont", "sparse", "contneural" }
	S.description = "City Continuum Sparse Residency: sparse page residency with eviction and compression for the City Continuum subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.citycont.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
