-- ARKHER SYSTEM F.0262 :: Exposure Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0262"
	S.key = "arkher.render.exposure.render_policy"
	S.name = "Exposure Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Exposure"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.exposure.draw_budget" }
	S.tags = { "f", "exposure", "policy", "render" }
	S.description = "Exposure Render Policy: device tier rules for the frame for the Exposure subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.exposure.render_policy", algorithm = "roundrobin", starvationGuard = 48 })
		inst.system = S
		inst.ctx = ctx
