-- ARKHER SYSTEM Z.0562 :: Collective Behaviour Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0562"
	S.key = "arkher.origin.collectivebehaviour.complexity_governance"
	S.name = "Collective Behaviour Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.collectivebehaviour.reality_layering" }
	S.tags = { "z", "collectivebehaviour", "complexity", "origin" }
	S.description = "Collective Behaviour Complexity Governance: measured scene cost turned into per-subsystem directives for the Collective Behaviour subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.collectivebehaviour.complexity_governance", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
