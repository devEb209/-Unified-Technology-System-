-- ARKHER SYSTEM F.0299 :: Bloom Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0299"
	S.key = "arkher.render.bloom.lighting_rig"
	S.name = "Bloom Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Bloom"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.bloom.geometry_virtualization" }
	S.tags = { "f", "bloom", "lightrig", "render" }
	S.description = "Bloom Lighting Rig: light clustering, importance and cascades for the Bloom subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.bloom.lighting_rig", maxActive = 12 })
		inst.system = S
		inst.ctx = ctx
