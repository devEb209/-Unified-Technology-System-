-- ARKHER SYSTEM Z.0319 :: Causality Ledger Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0319"
	S.key = "arkher.origin.causality.residency_streaming"
	S.name = "Causality Ledger Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.budget_governor" }
	S.tags = { "z", "causality", "streamer", "origin" }
	S.description = "Causality Ledger Residency Streaming: distance-driven residency of the technology's workload for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.causality.residency_streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
