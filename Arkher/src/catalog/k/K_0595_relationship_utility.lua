-- ARKHER SYSTEM K.0595 :: Relationship Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0595"
	S.key = "arkher.npc.relationship.utility_reasoning"
	S.name = "Relationship Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.relationship.reactive_behaviour" }
	S.tags = { "k", "relationship", "utility", "npc" }
	S.description = "Relationship Utility Reasoning: scored option selection with response curves for the Relationship subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.relationship.utility_reasoning", momentum = 0.07 })
		inst.system = S
		inst.ctx = ctx
