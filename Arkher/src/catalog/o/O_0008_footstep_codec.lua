-- ARKHER SYSTEM O.0008 :: Footstep Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0008"
	S.key = "arkher.audio.footstep.compression_codec"
	S.name = "Footstep Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Footstep"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.footstep.asset_registry" }
	S.tags = { "o", "footstep", "codec", "audio" }
	S.description = "Footstep Compression Codec: payload encoding of audio state and events for the Footstep subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.footstep.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
