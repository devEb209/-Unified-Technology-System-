-- ARKHER SYSTEM G.0470 :: Training Data Synthesis Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0470"
	S.key = "arkher.neural.datasynth.compute_budget"
	S.name = "Training Data Synthesis Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.datasynth.quality_predictor" }
	S.tags = { "g", "datasynth", "budgeter", "neural" }
	S.description = "Training Data Synthesis Compute Budget: inference time budget allocation for the Training Data Synthesis subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.datasynth.compute_budget", total = 264, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
