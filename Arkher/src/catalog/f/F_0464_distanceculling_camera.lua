-- ARKHER SYSTEM F.0464 :: Distance Culling View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0464"
	S.key = "arkher.render.distanceculling.view_and_culling"
	S.name = "Distance Culling View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.distanceculling.frame_graph" }
	S.tags = { "f", "distanceculling", "camera", "render" }
	S.description = "Distance Culling View And Culling: view state, frustum culling and screen-size LOD for the Distance Culling subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.distanceculling.view_and_culling", width = 956, height = 900, fov = 0.9100, far = 2200 })
		inst.system = S
		inst.ctx = ctx
