-- ARKHER SYSTEM VB.0476 :: VFX Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0476"
	S.key = "arkher.conttime.vfxcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vfxcont.neural_field" }
	S.tags = { "vb", "vfxcont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.vfxcont.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
