-- ARKHER SYSTEM Z.0857 :: Simulation Time Dilation Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0857"
	S.key = "arkher.origin.timedilation.behaviour_analysis"
	S.name = "Simulation Time Dilation Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.governance_policy" }
	S.tags = { "z", "timedilation", "analyzer", "origin" }
	S.description = "Simulation Time Dilation Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.timedilation.behaviour_analysis", window = 53, buckets = 17, threshold = 3.50 })
		inst.system = S
		inst.ctx = ctx
