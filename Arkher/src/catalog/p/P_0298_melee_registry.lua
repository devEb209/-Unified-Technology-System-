-- ARKHER SYSTEM P.0298 :: Melee Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0298"
	S.key = "arkher.play.melee.content_registry"
	S.name = "Melee Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Melee"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.melee.difficulty_controller" }
	S.tags = { "p", "melee", "registry", "play" }
	S.description = "Melee Content Registry: catalogue of the definitions this loop instantiates for the Melee subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.melee.content_registry" })
		inst.system = S
		inst.ctx = ctx
