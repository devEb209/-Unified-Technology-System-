-- ARKHER SYSTEM VA.0089 :: Residency Window Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0089"
	S.key = "arkher.contworld.residencywindow.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.residencywindow.multi-scale_fidelity" }
	S.tags = { "va", "residencywindow", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.residencywindow.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
