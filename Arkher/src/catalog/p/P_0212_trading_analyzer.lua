-- ARKHER SYSTEM P.0212 :: Trading Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0212"
	S.key = "arkher.play.trading.balance_analysis"
	S.name = "Trading Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Trading"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.trading.event_ledger" }
	S.tags = { "p", "trading", "analyzer", "play" }
	S.description = "Trading Balance Analysis: distribution, outlier and pacing analysis for the Trading subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.trading.balance_analysis", window = 113, buckets = 9, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
