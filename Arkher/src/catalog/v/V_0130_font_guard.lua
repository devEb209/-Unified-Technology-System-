-- ARKHER SYSTEM V.0130 :: Font Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0130"
	S.key = "arkher.asset.font.validation_guard"
	S.name = "Font Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.font.size_budget" }
	S.tags = { "v", "font", "guard", "asset" }
	S.description = "Font Validation Guard: rate limiting and capability checks on the import path for the Font subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.font.validation_guard", algorithm = "leaky", capacity = 136, refillPerSec = 61, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
