-- ARKHER SYSTEM O.0258 :: Exploration Music Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0258"
	S.key = "arkher.audio.explorationmusic.streaming"
	S.name = "Exploration Music Streaming"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.explorationmusic.voice_budget" }
	S.tags = { "o", "explorationmusic", "streamer", "audio" }
	S.description = "Exploration Music Streaming: distance-driven residency of audio assets for the Exploration Music subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.explorationmusic.streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
