-- ARKHER SYSTEM Z.0158 :: Autonomous Development Pipeline Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0158"
	S.key = "arkher.origin.autodevpipeline.budget_governor"
	S.name = "Autonomous Development Pipeline Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodevpipeline.behaviour_analysis" }
	S.tags = { "z", "autodevpipeline", "budgeter", "origin" }
	S.description = "Autonomous Development Pipeline Budget Governor: allocation of a scarce resource across the technology's consumers for the Autonomous Development Pipeline subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.autodevpipeline.budget_governor", total = 344, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
