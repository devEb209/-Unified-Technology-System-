-- ARKHER SYSTEM T.0067 :: World Knowledge Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0067"
	S.key = "arkher.ai.worldknowledge.action_planner"
	S.name = "World Knowledge Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.worldknowledge.utility_selection" }
	S.tags = { "t", "worldknowledge", "planner", "ai" }
	S.description = "World Knowledge Action Planner: goal-oriented action planning over preconditions for the World Knowledge subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.worldknowledge.action_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
