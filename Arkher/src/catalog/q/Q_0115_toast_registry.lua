-- ARKHER SYSTEM Q.0115 :: Toast Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0115"
	S.key = "arkher.ui.toast.localization_registry"
	S.name = "Toast Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Toast"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.toast.theme_composition" }
	S.tags = { "q", "toast", "registry", "ui" }
	S.description = "Toast Localization Registry: catalogue of strings, plurals and locale metadata for the Toast subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.toast.localization_registry" })
		inst.system = S
		inst.ctx = ctx
