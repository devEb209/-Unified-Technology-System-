-- ARKHER SYSTEM T.0395 :: Performance Reasoning Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0395"
	S.key = "arkher.ai.performancereasoning.plan_workflow"
	S.name = "Performance Reasoning Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.performancereasoning.semantic_knowledge" }
	S.tags = { "t", "performancereasoning", "workflow", "ai" }
	S.description = "Performance Reasoning Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Performance Reasoning subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.performancereasoning.plan_workflow", maxRetries = 3, budget = 120 })
		inst.system = S
		inst.ctx = ctx
