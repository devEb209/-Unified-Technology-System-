-- ARKHER SYSTEM T.0653 :: Human Handoff Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0653"
	S.key = "arkher.ai.humanhandoff.working_memory"
	S.name = "Human Handoff Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.humanhandoff.outcome_prediction" }
	S.tags = { "t", "humanhandoff", "memory", "ai" }
	S.description = "Human Handoff Working Memory: decaying, consolidating recall of what the agent learned for the Human Handoff subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.humanhandoff.working_memory", capacity = 80, decayRate = 0.020, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
