-- ARKHER SYSTEM K.0155 :: Safety Drive Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0155"
	S.key = "arkher.npc.safetydrive.mind_network"
	S.name = "Safety Drive Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "safetydrive", "mindnet", "npc" }
	S.description = "Safety Drive Mind Network: the learned policy that turns perception into a decision for the Safety Drive subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.safetydrive.mind_network", inputs = 8, hidden = 8, seed = 33934, learningRate = 0.070, exploration = 0.050 })
		inst.system = S
		inst.ctx = ctx
