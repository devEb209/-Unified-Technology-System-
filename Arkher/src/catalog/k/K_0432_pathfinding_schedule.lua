-- ARKHER SYSTEM K.0432 :: Pathfinding Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0432"
	S.key = "arkher.npc.pathfinding.daily_schedule"
	S.name = "Pathfinding Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.pathfinding.social_relations" }
	S.tags = { "k", "pathfinding", "schedule", "npc" }
	S.description = "Pathfinding Daily Schedule: hour-by-hour routine with priority interruptions for the Pathfinding subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.pathfinding.daily_schedule", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
