-- ARKHER SYSTEM H.0534 :: Rope Simulation Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0534"
	S.key = "arkher.physics.rope.collision_shape"
	S.name = "Rope Simulation Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rope.body_dynamics" }
	S.tags = { "h", "rope", "collider", "physics" }
	S.description = "Rope Simulation Collision Shape: shape bounds, support mapping and closest points for the Rope Simulation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.rope.collision_shape", shape = "capsule", radius = 2.40, height = 2.00, layer = "default" })
		inst.system = S
		inst.ctx = ctx
