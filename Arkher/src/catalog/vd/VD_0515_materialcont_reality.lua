-- ARKHER SYSTEM VD.0515 :: Material Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0515"
	S.key = "arkher.contsim.materialcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.materialcont.simulation_fabric" }
	S.tags = { "vd", "materialcont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.materialcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
