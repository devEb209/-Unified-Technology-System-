-- ARKHER SYSTEM VA.0495 :: Rendering Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0495"
	S.key = "arkher.contworld.rendercont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.rendercont.epoch_clock" }
	S.tags = { "va", "rendercont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.rendercont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
