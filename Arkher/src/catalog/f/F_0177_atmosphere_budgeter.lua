-- ARKHER SYSTEM F.0177 :: Atmosphere Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0177"
	S.key = "arkher.render.atmosphere.draw_budget"
	S.name = "Atmosphere Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Atmosphere"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.atmosphere.adaptive_resolution" }
	S.tags = { "f", "atmosphere", "budgeter", "render" }
	S.description = "Atmosphere Draw Budget: draw call and triangle budget allocation for the Atmosphere subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.atmosphere.draw_budget", total = 206, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
