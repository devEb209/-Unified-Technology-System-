-- ARKHER SYSTEM N.0164 :: Snow Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0164"
	S.key = "arkher.vfx.snow.spawn_budget"
	S.name = "Snow Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Snow"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.snow.effect_composition" }
	S.tags = { "n", "snow", "budgeter", "vfx" }
	S.description = "Snow Spawn Budget: global particle budget shared by every live effect for the Snow subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.snow.spawn_budget", total = 408, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
