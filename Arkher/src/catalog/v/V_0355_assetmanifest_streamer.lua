-- ARKHER SYSTEM V.0355 :: Manifest Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0355"
	S.key = "arkher.asset.assetmanifest.streaming_residency"
	S.name = "Manifest Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetmanifest.content_cache" }
	S.tags = { "v", "assetmanifest", "streamer", "asset" }
	S.description = "Manifest Streaming Residency: distance-driven load and unload of asset payloads for the Manifest subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.assetmanifest.streaming_residency", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
