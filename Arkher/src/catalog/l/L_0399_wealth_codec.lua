-- ARKHER SYSTEM L.0399 :: Wealth Distribution State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0399"
	S.key = "arkher.sim.wealth.state_codec"
	S.name = "Wealth Distribution State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wealth.history_ledger" }
	S.tags = { "l", "wealth", "codec", "sim" }
	S.description = "Wealth Distribution State Codec: persistence, diffing and checksum of the world state for the Wealth Distribution subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.wealth.state_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
