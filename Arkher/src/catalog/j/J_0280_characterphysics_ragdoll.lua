-- ARKHER SYSTEM J.0280 :: Character Physics Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0280"
	S.key = "arkher.character.characterphysics.physical_response"
	S.name = "Character Physics Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterphysics.look_and_reach" }
	S.tags = { "j", "characterphysics", "ragdoll", "character" }
	S.description = "Character Physics Physical Response: physical reaction, ragdoll and recovery for the Character Physics subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.characterphysics.physical_response", blendSpeed = 2.70 })
		inst.system = S
		inst.ctx = ctx
