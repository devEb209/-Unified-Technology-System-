-- ARKHER SYSTEM H.0348 :: Compound Collider Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0348"
	S.key = "arkher.physics.compoundcollider.analysis"
	S.name = "Compound Collider Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.compoundcollider.result_cache" }
	S.tags = { "h", "compoundcollider", "analyzer", "physics" }
	S.description = "Compound Collider Analysis: energy, jitter and cost analysis of the simulation for the Compound Collider subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.compoundcollider.analysis", window = 57, buckets = 9, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
