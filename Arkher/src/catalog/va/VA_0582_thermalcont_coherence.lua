-- ARKHER SYSTEM VA.0582 :: Thermal Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0582"
	S.key = "arkher.contworld.thermalcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.thermalcont.persistent_state" }
	S.tags = { "va", "thermalcont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.thermalcont.coherence_guard", window = 142, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
