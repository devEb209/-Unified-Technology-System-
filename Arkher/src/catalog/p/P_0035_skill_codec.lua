-- ARKHER SYSTEM P.0035 :: Skill Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0035"
	S.key = "arkher.play.skill.save_codec"
	S.name = "Skill Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Skill"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.skill.content_registry" }
	S.tags = { "p", "skill", "codec", "play" }
	S.description = "Skill Save Codec: persistence, diffing and checksum of gameplay state for the Skill subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.skill.save_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
