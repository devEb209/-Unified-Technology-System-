-- ARKHER SYSTEM W.0196 :: Action Scene Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0196"
	S.key = "arkher.cine.actionscene.shot_composition"
	S.name = "Action Scene Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Action Scene"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.actionscene.colour_grade" }
	S.tags = { "w", "actionscene", "composer", "cine" }
	S.description = "Action Scene Shot Composition: blending of the signals that make up the final shot for the Action Scene subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.actionscene.shot_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
