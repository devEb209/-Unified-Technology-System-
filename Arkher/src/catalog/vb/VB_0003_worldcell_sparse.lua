-- ARKHER SYSTEM VB.0003 :: World Grid Cell Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0003"
	S.key = "arkher.conttime.worldcell.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldcell.epoch_clock" }
	S.tags = { "vb", "worldcell", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.worldcell.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
