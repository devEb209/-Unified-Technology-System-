-- ARKHER SYSTEM Z.0705 :: Continuous Self Optimization World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0705"
	S.key = "arkher.origin.continuousopt.world_memory"
	S.name = "Continuous Self Optimization World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.autonomous_pipeline" }
	S.tags = { "z", "continuousopt", "worldmemory", "origin" }
	S.description = "Continuous Self Optimization World Memory: epoch-stamped persistent history with compaction and checkpoints for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.continuousopt.world_memory", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
