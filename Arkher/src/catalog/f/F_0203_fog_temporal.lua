-- ARKHER SYSTEM F.0203 :: Fog Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0203"
	S.key = "arkher.render.fog.temporal_resolve"
	S.name = "Fog Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Fog"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.fog.probe_volume" }
	S.tags = { "f", "fog", "temporal", "render" }
	S.description = "Fog Temporal Resolve: history reprojection with neighbourhood clamping for the Fog subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.fog.temporal_resolve", feedback = 0.93, phase = 8 })
		inst.system = S
		inst.ctx = ctx
