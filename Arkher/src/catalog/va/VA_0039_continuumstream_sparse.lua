-- ARKHER SYSTEM VA.0039 :: Continuum Stream Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0039"
	S.key = "arkher.contworld.continuumstream.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.continuumstream.epoch_clock" }
	S.tags = { "va", "continuumstream", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.continuumstream.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
