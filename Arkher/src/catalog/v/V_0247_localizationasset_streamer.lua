-- ARKHER SYSTEM V.0247 :: Localization Asset Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0247"
	S.key = "arkher.asset.localizationasset.streaming_residency"
	S.name = "Localization Asset Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.localizationasset.content_cache" }
	S.tags = { "v", "localizationasset", "streamer", "asset" }
	S.description = "Localization Asset Streaming Residency: distance-driven load and unload of asset payloads for the Localization Asset subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.localizationasset.streaming_residency", radius = 280, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
