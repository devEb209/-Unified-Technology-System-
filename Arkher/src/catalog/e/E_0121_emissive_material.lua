-- ARKHER SYSTEM E.0121 :: Emissive Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0121"
	S.key = "arkher.material.emissive.definition"
	S.name = "Emissive Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Emissive"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "emissive", "material", "material" }
	S.description = "Emissive Definition: layered PBR definition resolved into parameters for the Emissive subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.emissive.definition", texelBudget = 2097152 })
		inst.system = S
		inst.ctx = ctx
