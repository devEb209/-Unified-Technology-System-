-- ARKHER SYSTEM Z.1004 :: Capability Discovery Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.1004"
	S.key = "arkher.origin.capabilitydiscovery.autonomous_pipeline"
	S.name = "Capability Discovery Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.simulation_fabric" }
	S.tags = { "z", "capabilitydiscovery", "autopipeline", "origin" }
	S.description = "Capability Discovery Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.capabilitydiscovery.autonomous_pipeline", maxIterations = 11 })
		inst.system = S
		inst.ctx = ctx
