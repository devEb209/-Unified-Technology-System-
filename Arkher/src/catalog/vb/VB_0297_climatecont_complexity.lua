-- ARKHER SYSTEM VB.0297 :: Climate Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0297"
	S.key = "arkher.conttime.climatecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.climatecont.world_memory_stream" }
	S.tags = { "vb", "climatecont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.climatecont.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
