-- ARKHER SYSTEM H.0053 :: Mass Properties Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0053"
	S.key = "arkher.physics.massproperties.result_cache"
	S.name = "Mass Properties Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.massproperties.simulation_policy" }
	S.tags = { "h", "massproperties", "cache", "physics" }
	S.description = "Mass Properties Result Cache: reuse of expensive simulation and query results for the Mass Properties subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.massproperties.result_cache", policy = "ttl", capacity = 109, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
