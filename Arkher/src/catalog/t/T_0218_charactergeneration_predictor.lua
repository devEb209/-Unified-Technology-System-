-- ARKHER SYSTEM T.0218 :: Character Generation Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0218"
	S.key = "arkher.ai.charactergeneration.outcome_prediction"
	S.name = "Character Generation Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.charactergeneration.decision_policy" }
	S.tags = { "t", "charactergeneration", "predictor", "ai" }
	S.description = "Character Generation Outcome Prediction: forecasting the result before the work is done for the Character Generation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.charactergeneration.outcome_prediction", method = "linear", alpha = 0.43, window = 81 })
		inst.system = S
		inst.ctx = ctx
