-- ARKHER SYSTEM T.0432 :: Mobile Reasoning Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0432"
	S.key = "arkher.ai.mobilereasoning.model_inference"
	S.name = "Mobile Reasoning Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.mobilereasoning.action_planner" }
	S.tags = { "t", "mobilereasoning", "inference", "ai" }
	S.description = "Mobile Reasoning Model Inference: quantized inference with batching and budget for the Mobile Reasoning subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.mobilereasoning.model_inference", seed = 8643 })
		inst.system = S
		inst.ctx = ctx
