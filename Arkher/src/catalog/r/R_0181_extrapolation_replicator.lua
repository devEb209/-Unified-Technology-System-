-- ARKHER SYSTEM R.0181 :: Extrapolation Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0181"
	S.key = "arkher.net.extrapolation.replication"
	S.name = "Extrapolation Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "extrapolation", "replicator", "net" }
	S.description = "Extrapolation Replication: authoritative entity state, interest and delta snapshots for the Extrapolation subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.extrapolation.replication", mtu = 1350, interestRadius = 320, fullEvery = 105 })
		inst.system = S
		inst.ctx = ctx
