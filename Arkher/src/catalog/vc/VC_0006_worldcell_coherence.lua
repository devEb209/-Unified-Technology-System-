-- ARKHER SYSTEM VC.0006 :: World Grid Cell Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0006"
	S.key = "arkher.contneural.worldcell.coherence_guard"
	S.name = "World Grid Cell Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldcell.persistent_state" }
	S.tags = { "vc", "worldcell", "coherence", "contneural" }
	S.description = "World Grid Cell Coherence Guard: seam coherence and drift supervision for the World Grid Cell subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.worldcell.coherence_guard", window = 73, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
