-- ARKHER SYSTEM VB.0111 :: Temporal Slice Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0111"
	S.key = "arkher.conttime.temporalslice.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.temporalslice.epoch_clock" }
	S.tags = { "vb", "temporalslice", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.temporalslice.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
