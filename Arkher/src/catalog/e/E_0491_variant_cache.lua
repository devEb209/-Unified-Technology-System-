-- ARKHER SYSTEM E.0491 :: Material Variant Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0491"
	S.key = "arkher.material.variant.instance_cache"
	S.name = "Material Variant Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.variant.quality_policy" }
	S.tags = { "e", "variant", "cache", "material" }
	S.description = "Material Variant Instance Cache: resolved-parameter cache keyed by context for the Material Variant subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.variant.instance_cache", policy = "ttl", capacity = 363, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
