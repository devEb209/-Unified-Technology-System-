-- ARKHER SYSTEM Z.0469 :: Narrative Memory Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0469"
	S.key = "arkher.origin.narrativememory.intent_bridge"
	S.name = "Narrative Memory Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.semantic_graph" }
	S.tags = { "z", "narrativememory", "intent", "origin" }
	S.description = "Narrative Memory Intent Bridge: natural language control surface for the technology for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.narrativememory.intent_bridge", minConfidence = 0.44 })
		inst.system = S
		inst.ctx = ctx
