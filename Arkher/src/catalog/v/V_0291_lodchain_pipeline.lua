-- ARKHER SYSTEM V.0291 :: LOD Chain Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0291"
	S.key = "arkher.asset.lodchain.cook_pipeline"
	S.name = "LOD Chain Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lodchain.bundling" }
	S.tags = { "v", "lodchain", "pipeline", "asset" }
	S.description = "LOD Chain Cook Pipeline: staged cooking with isolation and retries for the LOD Chain subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.lodchain.cook_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
