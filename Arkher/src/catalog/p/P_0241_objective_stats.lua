-- ARKHER SYSTEM P.0241 :: Objective Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0241"
	S.key = "arkher.play.objective.attributes"
	S.name = "Objective Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Objective"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "objective", "stats", "play" }
	S.description = "Objective Attributes: base values, layered modifiers and derived statistics for the Objective subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.objective.attributes" })
		inst.system = S
		inst.ctx = ctx
