-- ARKHER SYSTEM VB.0237 :: City Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0237"
	S.key = "arkher.conttime.citycont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.citycont.world_memory_stream" }
	S.tags = { "vb", "citycont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.citycont.complexity_budget", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
