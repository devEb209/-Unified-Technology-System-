-- ARKHER SYSTEM W.0322 :: Colour Look Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0322"
	S.key = "arkher.cine.colourlook.frame_budget"
	S.name = "Colour Look Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Colour Look"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.colourlook.event_ledger" }
	S.tags = { "w", "colourlook", "budgeter", "cine" }
	S.description = "Colour Look Frame Budget: per-frame cost budget for the cinematic systems for the Colour Look subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.colourlook.frame_budget", total = 117, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
