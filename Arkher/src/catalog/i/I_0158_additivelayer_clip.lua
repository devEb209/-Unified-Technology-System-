-- ARKHER SYSTEM I.0158 :: Additive Layer Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0158"
	S.key = "arkher.anim.additivelayer.clip_sampling"
	S.name = "Additive Layer Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.additivelayer.skeleton" }
	S.tags = { "i", "additivelayer", "clip", "anim" }
	S.description = "Additive Layer Clip Sampling: keyframe tracks sampled, retimed and evented for the Additive Layer subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.additivelayer.clip_sampling", duration = 2.60, loop = false })
		inst.system = S
		inst.ctx = ctx
