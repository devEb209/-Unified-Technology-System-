-- ARKHER SYSTEM K.0082 :: Semantic Memory Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0082"
	S.key = "arkher.npc.semanticmemory.daily_schedule"
	S.name = "Semantic Memory Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.semanticmemory.social_relations" }
	S.tags = { "k", "semanticmemory", "schedule", "npc" }
	S.description = "Semantic Memory Daily Schedule: hour-by-hour routine with priority interruptions for the Semantic Memory subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.semanticmemory.daily_schedule", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
