-- ARKHER SYSTEM VB.0558 :: Device Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0558"
	S.key = "arkher.conttime.devicecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.devicecont.persistent_state" }
	S.tags = { "vb", "devicecont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.devicecont.coherence_guard", window = 116, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
