-- ARKHER SYSTEM VA.0031 :: Zone Chunk Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0031"
	S.key = "arkher.contworld.zonechunk.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.zonechunk.coherence_guard" }
	S.tags = { "va", "zonechunk", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.zonechunk.neural_field", dims = 12, hidden = 8, seed = 64312 })
		inst.system = S
		inst.ctx = ctx
