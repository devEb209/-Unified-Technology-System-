-- ARKHER SYSTEM E.0143 :: Opacity Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0143"
	S.key = "arkher.material.opacity.streaming"
	S.name = "Opacity Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Opacity"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.opacity.parameter_budget" }
	S.tags = { "e", "opacity", "streamer", "material" }
	S.description = "Opacity Streaming: residency and demand-driven texture streaming for the Opacity subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.opacity.streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
