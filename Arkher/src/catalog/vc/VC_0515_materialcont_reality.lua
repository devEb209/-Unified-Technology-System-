-- ARKHER SYSTEM VC.0515 :: Material Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0515"
	S.key = "arkher.contneural.materialcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.materialcont.simulation_fabric" }
	S.tags = { "vc", "materialcont", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.materialcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
