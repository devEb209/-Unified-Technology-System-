-- ARKHER SYSTEM Z.0824 :: Reality Blending Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0824"
	S.key = "arkher.origin.realityblending.autonomous_pipeline"
	S.name = "Reality Blending Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.simulation_fabric" }
	S.tags = { "z", "realityblending", "autopipeline", "origin" }
	S.description = "Reality Blending Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.realityblending.autonomous_pipeline", maxIterations = 7 })
		inst.system = S
		inst.ctx = ctx
