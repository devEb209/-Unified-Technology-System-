-- ARKHER SYSTEM Z.1066 :: World Dream State Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.1066"
	S.key = "arkher.origin.worlddream.emergence_detection"
	S.name = "World Dream State Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.world_memory" }
	S.tags = { "z", "worlddream", "emergence", "origin" }
	S.description = "World Dream State Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the World Dream State subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.worlddream.emergence_detection", windowSize = 4, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
