-- ARKHER SYSTEM VD.0194 :: Architect District Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0194"
	S.key = "arkher.contsim.architectdistrict.epoch_clock"
	S.name = "Architect District Epoch Clock"
	S.category = "VD"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.architectdistrict.infinite_grid" }
	S.tags = { "vd", "architectdistrict", "epoch", "contsim" }
	S.description = "Architect District Epoch Clock: deterministic epoch timeline with catch-up for the Architect District subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.architectdistrict.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
