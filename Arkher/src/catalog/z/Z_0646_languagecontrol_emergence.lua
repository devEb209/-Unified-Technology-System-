-- ARKHER SYSTEM Z.0646 :: Natural Language Engine Control Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0646"
	S.key = "arkher.origin.languagecontrol.emergence_detection"
	S.name = "Natural Language Engine Control Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.languagecontrol.world_memory" }
	S.tags = { "z", "languagecontrol", "emergence", "origin" }
	S.description = "Natural Language Engine Control Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.languagecontrol.emergence_detection", windowSize = 7, threshold = 1.60, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
