-- ARKHER SYSTEM T.0478 :: Simulation Reasoning Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0478"
	S.key = "arkher.ai.simulationreasoning.semantic_knowledge"
	S.name = "Simulation Reasoning Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.simulationreasoning.intent_understanding" }
	S.tags = { "t", "simulationreasoning", "knowledge", "ai" }
	S.description = "Simulation Reasoning Semantic Knowledge: typed entities, weighted relations and inferred closure for the Simulation Reasoning subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.simulationreasoning.semantic_knowledge", dims = 32 })
		inst.system = S
		inst.ctx = ctx
