-- ARKHER SYSTEM K.0646 :: Daily Routine Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0646"
	S.key = "arkher.npc.dailyroutine.memory"
	S.name = "Daily Routine Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dailyroutine.mind_network" }
	S.tags = { "k", "dailyroutine", "memory", "npc" }
	S.description = "Daily Routine Memory: episodic memory with decay, recall and consolidation for the Daily Routine subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.dailyroutine.memory", capacity = 68, decayRate = 0.030, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
