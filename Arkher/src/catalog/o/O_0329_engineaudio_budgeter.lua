-- ARKHER SYSTEM O.0329 :: Engine Audio Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0329"
	S.key = "arkher.audio.engineaudio.voice_budget"
	S.name = "Engine Audio Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Engine Audio"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.engineaudio.music_sequencer" }
	S.tags = { "o", "engineaudio", "budgeter", "audio" }
	S.description = "Engine Audio Voice Budget: voice slots allocated by priority and audibility for the Engine Audio subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.engineaudio.voice_budget", total = 266, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
