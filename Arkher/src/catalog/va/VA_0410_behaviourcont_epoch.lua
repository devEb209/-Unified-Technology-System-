-- ARKHER SYSTEM VA.0410 :: Behaviour Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0410"
	S.key = "arkher.contworld.behaviourcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.behaviourcont.infinite_grid" }
	S.tags = { "va", "behaviourcont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.behaviourcont.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
