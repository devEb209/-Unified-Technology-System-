-- ARKHER SYSTEM J.0126 :: Breathing Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0126"
	S.key = "arkher.character.breathing.physical_response"
	S.name = "Breathing Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.breathing.look_and_reach" }
	S.tags = { "j", "breathing", "ragdoll", "character" }
	S.description = "Breathing Physical Response: physical reaction, ragdoll and recovery for the Breathing subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.breathing.physical_response", blendSpeed = 2.80 })
		inst.system = S
		inst.ctx = ctx
