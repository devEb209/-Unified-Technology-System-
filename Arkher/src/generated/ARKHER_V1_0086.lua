--!strict
-- Puter Singularity — CORE Node_Flow #0086
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Puter Singularity — CORE Node_Flow #0086", size=Vector2.new(680, 440), pos=UDim2.fromOffset(418, 242), parent=parent, icon="↻"})
