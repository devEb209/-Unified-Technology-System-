-- ARKHER SYSTEM I.0066 :: Keyframe Track Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0066"
	S.key = "arkher.anim.keytrack.skeleton"
	S.name = "Keyframe Track Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "keytrack", "skeleton", "anim" }
	S.description = "Keyframe Track Skeleton: bone hierarchy, bind pose and world resolution for the Keyframe Track subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.keytrack.skeleton" })
		inst.system = S
		inst.ctx = ctx
