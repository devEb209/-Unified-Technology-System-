-- ARKHER SYSTEM I.0108 :: Clip Events Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0108"
	S.key = "arkher.anim.clipevents.inverse_kinematics"
	S.name = "Clip Events Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Events"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clipevents.layered_blending" }
	S.tags = { "i", "clipevents", "ik", "anim" }
	S.description = "Clip Events Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Clip Events subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.clipevents.inverse_kinematics", iterations = 15, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
