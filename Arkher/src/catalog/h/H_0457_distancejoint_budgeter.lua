-- ARKHER SYSTEM H.0457 :: Distance Joint Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0457"
	S.key = "arkher.physics.distancejoint.budget_governor"
	S.name = "Distance Joint Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.distancejoint.broadphase_index" }
	S.tags = { "h", "distancejoint", "budgeter", "physics" }
	S.description = "Distance Joint Budget Governor: simulation time budget allocation across islands for the Distance Joint subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.distancejoint.budget_governor", total = 143, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
