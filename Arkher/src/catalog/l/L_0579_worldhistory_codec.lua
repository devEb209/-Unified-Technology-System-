-- ARKHER SYSTEM L.0579 :: World History State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0579"
	S.key = "arkher.sim.worldhistory.state_codec"
	S.name = "World History State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldhistory.history_ledger" }
	S.tags = { "l", "worldhistory", "codec", "sim" }
	S.description = "World History State Codec: persistence, diffing and checksum of the world state for the World History subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.worldhistory.state_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
