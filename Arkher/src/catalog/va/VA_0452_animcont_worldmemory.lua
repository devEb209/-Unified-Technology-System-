-- ARKHER SYSTEM VA.0452 :: Animation Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0452"
	S.key = "arkher.contworld.animcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.animcont.neural_field" }
	S.tags = { "va", "animcont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.animcont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
