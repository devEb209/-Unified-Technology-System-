-- ARKHER SYSTEM F.0093 :: Contact Shadows Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0093"
	S.key = "arkher.render.contact.draw_budget"
	S.name = "Contact Shadows Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.contact.adaptive_resolution" }
	S.tags = { "f", "contact", "budgeter", "render" }
	S.description = "Contact Shadows Draw Budget: draw call and triangle budget allocation for the Contact Shadows subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.contact.draw_budget", total = 166, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
