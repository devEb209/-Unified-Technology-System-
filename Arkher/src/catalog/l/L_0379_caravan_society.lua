-- ARKHER SYSTEM L.0379 :: Caravan Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0379"
	S.key = "arkher.sim.caravan.society"
	S.name = "Caravan Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.caravan.economy" }
	S.tags = { "l", "caravan", "society", "sim" }
	S.description = "Caravan Society: relations, factions, reputation and cohesion of the region for the Caravan subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.caravan.society", decayRate = 0.008, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
