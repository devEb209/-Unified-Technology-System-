-- ARKHER SYSTEM V.0202 :: Terrain Asset Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0202"
	S.key = "arkher.asset.terrainasset.validation_guard"
	S.name = "Terrain Asset Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.terrainasset.size_budget" }
	S.tags = { "v", "terrainasset", "guard", "asset" }
	S.description = "Terrain Asset Validation Guard: rate limiting and capability checks on the import path for the Terrain Asset subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.terrainasset.validation_guard", algorithm = "token", capacity = 80, refillPerSec = 5, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
