-- ARKHER SYSTEM E.0231 :: Layer Blending Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0231"
	S.key = "arkher.material.layerblend.variant_registry"
	S.name = "Layer Blending Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.layerblend.procedural_detail" }
	S.tags = { "e", "layerblend", "registry", "material" }
	S.description = "Layer Blending Variant Registry: named variants and their lifecycle for the Layer Blending subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.layerblend.variant_registry" })
		inst.system = S
		inst.ctx = ctx
