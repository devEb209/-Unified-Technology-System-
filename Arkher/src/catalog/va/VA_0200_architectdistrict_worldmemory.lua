-- ARKHER SYSTEM VA.0200 :: Architect District World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0200"
	S.key = "arkher.contworld.architectdistrict.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.architectdistrict.neural_field" }
	S.tags = { "va", "architectdistrict", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.architectdistrict.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
