-- ARKHER SYSTEM V.0357 :: Manifest Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0357"
	S.key = "arkher.asset.assetmanifest.size_budget"
	S.name = "Manifest Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetmanifest.compression_codec" }
	S.tags = { "v", "assetmanifest", "budgeter", "asset" }
	S.description = "Manifest Size Budget: byte budget shared between competing asset classes for the Manifest subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.assetmanifest.size_budget", total = 126, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
