-- ARKHER SYSTEM VC.0210 :: Biome Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0210"
	S.key = "arkher.contneural.biomecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.biomecont.persistent_state" }
	S.tags = { "vc", "biomecont", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.biomecont.coherence_guard", window = 102, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
