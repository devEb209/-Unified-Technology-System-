-- ARKHER SYSTEM VB.0278 :: Water Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0278"
	S.key = "arkher.conttime.watercont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.watercont.infinite_grid" }
	S.tags = { "vb", "watercont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.watercont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
