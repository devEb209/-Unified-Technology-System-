-- ARKHER SYSTEM Q.0038 :: Label Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0038"
	S.key = "arkher.ui.label.widget_tree"
	S.name = "Label Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Label"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.label.responsive_layout" }
	S.tags = { "q", "label", "widget", "ui" }
	S.description = "Label Widget Tree: retained widget nodes, properties, bindings and rendering for the Label subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.label.widget_tree", theme = "highcontrast", scale = 0.94 })
		inst.system = S
		inst.ctx = ctx
