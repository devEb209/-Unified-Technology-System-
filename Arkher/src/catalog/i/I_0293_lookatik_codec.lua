-- ARKHER SYSTEM I.0293 :: Look At IK Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0293"
	S.key = "arkher.anim.lookatik.compression_codec"
	S.name = "Look At IK Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Look At IK"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.lookatik.retarget_graph" }
	S.tags = { "i", "lookatik", "codec", "anim" }
	S.description = "Look At IK Compression Codec: curve compression and quantized transport for the Look At IK subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.lookatik.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
