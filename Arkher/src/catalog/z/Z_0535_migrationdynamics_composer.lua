-- ARKHER SYSTEM Z.0535 :: Migration Dynamics Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0535"
	S.key = "arkher.origin.migrationdynamics.signal_composition"
	S.name = "Migration Dynamics Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.migrationdynamics.telemetry_ledger" }
	S.tags = { "z", "migrationdynamics", "composer", "origin" }
	S.description = "Migration Dynamics Signal Composition: blending of the technology's input signals into one output for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.migrationdynamics.signal_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
