-- ARKHER SYSTEM VA.0442 :: Physics Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0442"
	S.key = "arkher.contworld.physicscont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.physicscont.complexity_budget" }
	S.tags = { "va", "physicscont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.physicscont.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
