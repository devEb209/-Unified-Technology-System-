-- ARKHER SYSTEM VB.0053 :: Epoch Frame Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0053"
	S.key = "arkher.conttime.epochframe.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.epochframe.multi-scale_fidelity" }
	S.tags = { "vb", "epochframe", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.epochframe.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
