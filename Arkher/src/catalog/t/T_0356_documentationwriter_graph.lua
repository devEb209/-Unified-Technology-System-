-- ARKHER SYSTEM T.0356 :: Documentation Writer Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0356"
	S.key = "arkher.ai.documentationwriter.reasoning_graph"
	S.name = "Documentation Writer Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.documentationwriter.world_architect" }
	S.tags = { "t", "documentationwriter", "graph", "ai" }
	S.description = "Documentation Writer Reasoning Graph: relationship modelling and shortest-path reasoning for the Documentation Writer subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.documentationwriter.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
