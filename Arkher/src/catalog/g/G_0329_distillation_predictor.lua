-- ARKHER SYSTEM G.0329 :: Model Distillation Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0329"
	S.key = "arkher.neural.distillation.quality_predictor"
	S.name = "Model Distillation Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.distillation.weight_codec" }
	S.tags = { "g", "distillation", "predictor", "neural" }
	S.description = "Model Distillation Quality Predictor: predicted quality and cost of a setting for the Model Distillation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.distillation.quality_predictor", method = "ema", alpha = 0.18, window = 32 })
		inst.system = S
		inst.ctx = ctx
