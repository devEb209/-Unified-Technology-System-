-- ARKHER SYSTEM VA.0033 :: Zone Chunk Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0033"
	S.key = "arkher.contworld.zonechunk.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.zonechunk.world_memory_stream" }
	S.tags = { "va", "zonechunk", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.zonechunk.complexity_budget", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
