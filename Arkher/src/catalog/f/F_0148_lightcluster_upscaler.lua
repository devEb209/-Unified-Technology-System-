-- ARKHER SYSTEM F.0148 :: Light Clustering Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0148"
	S.key = "arkher.render.lightcluster.adaptive_resolution"
	S.name = "Light Clustering Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.lightcluster.temporal_resolve" }
	S.tags = { "f", "lightcluster", "upscaler", "render" }
	S.description = "Light Clustering Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Light Clustering subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.lightcluster.adaptive_resolution", targetMs = 11.10, index = 3, sharpness = 0.58 })
		inst.system = S
		inst.ctx = ctx
