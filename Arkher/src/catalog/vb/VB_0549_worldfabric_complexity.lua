-- ARKHER SYSTEM VB.0549 :: World Fabric Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0549"
	S.key = "arkher.conttime.worldfabric.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldfabric.world_memory_stream" }
	S.tags = { "vb", "worldfabric", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.worldfabric.complexity_budget", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
