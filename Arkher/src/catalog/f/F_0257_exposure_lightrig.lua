-- ARKHER SYSTEM F.0257 :: Exposure Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0257"
	S.key = "arkher.render.exposure.lighting_rig"
	S.name = "Exposure Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Exposure"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.exposure.geometry_virtualization" }
	S.tags = { "f", "exposure", "lightrig", "render" }
	S.description = "Exposure Lighting Rig: light clustering, importance and cascades for the Exposure subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.exposure.lighting_rig", maxActive = 6 })
		inst.system = S
		inst.ctx = ctx
