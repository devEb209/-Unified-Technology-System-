-- ARKHER SYSTEM J.0069 :: Teeth Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0069"
	S.key = "arkher.character.teeth.blend_controller"
	S.name = "Teeth Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.teeth.motion_set" }
	S.tags = { "j", "teeth", "animator", "character" }
	S.description = "Teeth Blend Controller: layered playback driving the character for the Teeth subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.teeth.blend_controller", budget = 15 })
		inst.system = S
		inst.ctx = ctx
