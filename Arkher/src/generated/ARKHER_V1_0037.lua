--!strict
-- Quixel Bridge — ANIMATION Mixer #0037
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Quixel Bridge — ANIMATION Mixer #0037", size=Vector2.new(640, 460), pos=UDim2.fromOffset(181, 189), parent=parent, icon="✦"})
...
Components.Slider(right, "Rate", 0,3000,600, function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_Rate"..37, v) end end)
