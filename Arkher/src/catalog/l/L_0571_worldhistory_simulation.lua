-- ARKHER SYSTEM L.0571 :: World History Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0571"
	S.key = "arkher.sim.worldhistory.simulation_core"
	S.name = "World History Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "worldhistory", "simulation", "sim" }
	S.description = "World History Simulation Core: observer-driven fidelity, catch-up and aggregate state for the World History subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.worldhistory.simulation_core", fullRadius = 240, reducedRadius = 900, budget = 59 })
		inst.system = S
		inst.ctx = ctx
