-- ARKHER SYSTEM G.0357 :: Batch Inference Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0357"
	S.key = "arkher.neural.batchinference.quality_predictor"
	S.name = "Batch Inference Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.batchinference.weight_codec" }
	S.tags = { "g", "batchinference", "predictor", "neural" }
	S.description = "Batch Inference Quality Predictor: predicted quality and cost of a setting for the Batch Inference subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.batchinference.quality_predictor", method = "markov", alpha = 0.44, window = 34 })
		inst.system = S
		inst.ctx = ctx
