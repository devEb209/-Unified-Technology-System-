-- ARKHER SYSTEM VD.0162 :: Coherence Seam Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0162"
	S.key = "arkher.contsim.coherenceseam.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.coherenceseam.persistent_state" }
	S.tags = { "vd", "coherenceseam", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.coherenceseam.coherence_guard", window = 67, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
