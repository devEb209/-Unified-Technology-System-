-- ARKHER SYSTEM VB.0477 :: VFX Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0477"
	S.key = "arkher.conttime.vfxcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vfxcont.world_memory_stream" }
	S.tags = { "vb", "vfxcont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.vfxcont.complexity_budget", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
