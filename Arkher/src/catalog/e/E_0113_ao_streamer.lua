-- ARKHER SYSTEM E.0113 :: Ambient Occlusion Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0113"
	S.key = "arkher.material.ao.streaming"
	S.name = "Ambient Occlusion Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.ao.parameter_budget" }
	S.tags = { "e", "ao", "streamer", "material" }
	S.description = "Ambient Occlusion Streaming: residency and demand-driven texture streaming for the Ambient Occlusion subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.ao.streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
