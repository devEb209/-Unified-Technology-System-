-- ARKHER SYSTEM P.0341 :: Cooldown State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0341"
	S.key = "arkher.play.cooldown.state_machine"
	S.name = "Cooldown State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Cooldown"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.cooldown.combat_resolution" }
	S.tags = { "p", "cooldown", "orchestrator", "play" }
	S.description = "Cooldown State Machine: the phase machine that drives this gameplay loop for the Cooldown subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.cooldown.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
