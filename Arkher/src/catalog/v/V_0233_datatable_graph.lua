-- ARKHER SYSTEM V.0233 :: Data Table Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0233"
	S.key = "arkher.asset.datatable.dependency_graph"
	S.name = "Data Table Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.datatable.asset_registry" }
	S.tags = { "v", "datatable", "graph", "asset" }
	S.description = "Data Table Dependency Graph: what references what, and in which order it must be built for the Data Table subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.datatable.dependency_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
