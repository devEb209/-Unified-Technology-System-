-- ARKHER SYSTEM L.0507 :: War Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0507"
	S.key = "arkher.sim.war.aggregate_cache"
	S.name = "War Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.war.fidelity_policy" }
	S.tags = { "l", "war", "cache", "sim" }
	S.description = "War Aggregate Cache: reuse of expensive aggregate computations for the War subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.war.aggregate_cache", policy = "lfu", capacity = 161, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
