-- ARKHER SYSTEM VD.0505 :: Material Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0505"
	S.key = "arkher.contsim.materialcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "materialcont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.materialcont.infinite_grid", cellSize = 192, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
