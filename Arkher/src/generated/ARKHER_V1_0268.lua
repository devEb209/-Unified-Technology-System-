...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="D-O15 S620 — CORE Map #0268", size=Vector2.new(640, 480), pos=UDim2.fromOffset(384, 216), parent=parent, icon="✦"})
...
Components.Slider(props, "Value", -5,5,0, function(v) local s=game:GetService("Selection"):Get()[1]; if s and s:IsA("BasePart") then s:SetAttribute("ARKHER_T"..268, v) end end)
