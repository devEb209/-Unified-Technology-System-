-- ARKHER SYSTEM L.0354 :: Price Discovery State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0354"
	S.key = "arkher.sim.pricediscovery.state_codec"
	S.name = "Price Discovery State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.pricediscovery.history_ledger" }
	S.tags = { "l", "pricediscovery", "codec", "sim" }
	S.description = "Price Discovery State Codec: persistence, diffing and checksum of the world state for the Price Discovery subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.pricediscovery.state_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
