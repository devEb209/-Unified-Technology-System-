-- ARKHER SYSTEM P.0158 :: Gathering Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0158"
	S.key = "arkher.play.gathering.inventory"
	S.name = "Gathering Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Gathering"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.gathering.attributes" }
	S.tags = { "p", "gathering", "inventory", "play" }
	S.description = "Gathering Inventory: slots, stacking, weight, equipment and crafting for the Gathering subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.gathering.inventory", slots = 32, maxWeight = 90 })
		inst.system = S
		inst.ctx = ctx
