-- ARKHER SYSTEM VA.0351 :: Narrative Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0351"
	S.key = "arkher.contworld.narrativecont.sparse_residency"
	S.name = "Narrative Continuum Sparse Residency"
	S.category = "VA"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.narrativecont.epoch_clock" }
	S.tags = { "va", "narrativecont", "sparse", "contworld" }
	S.description = "Narrative Continuum Sparse Residency: sparse page residency with eviction and compression for the Narrative Continuum subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.narrativecont.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
