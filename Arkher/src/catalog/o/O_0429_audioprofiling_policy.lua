-- ARKHER SYSTEM O.0429 :: Audio Profiling Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0429"
	S.key = "arkher.audio.audioprofiling.playback_policy"
	S.name = "Audio Profiling Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audioprofiling.compression_codec" }
	S.tags = { "o", "audioprofiling", "policy", "audio" }
	S.description = "Audio Profiling Playback Policy: rules choosing what may be heard right now for the Audio Profiling subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.audioprofiling.playback_policy", algorithm = "edf", starvationGuard = 17 })
		inst.system = S
		inst.ctx = ctx
