-- ARKHER SYSTEM W.0097 :: Handheld Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0097"
	S.key = "arkher.cine.handheld.sequence_timeline"
	S.name = "Handheld Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Handheld"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "handheld", "timeline", "cine" }
	S.description = "Handheld Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Handheld subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.handheld.sequence_timeline", duration = 5.0, rate = 1.05 })
		inst.system = S
		inst.ctx = ctx
