-- ARKHER SYSTEM VB.0413 :: Behaviour Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0413"
	S.key = "arkher.conttime.behaviourcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.behaviourcont.multi-scale_fidelity" }
	S.tags = { "vb", "behaviourcont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.behaviourcont.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
