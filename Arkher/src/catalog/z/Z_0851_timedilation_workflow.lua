-- ARKHER SYSTEM Z.0851 :: Simulation Time Dilation Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0851"
	S.key = "arkher.origin.timedilation.adaptive_workflow"
	S.name = "Simulation Time Dilation Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.self_critique" }
	S.tags = { "z", "timedilation", "workflow", "origin" }
	S.description = "Simulation Time Dilation Adaptive Workflow: verified, retryable, reversible execution plans for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.timedilation.adaptive_workflow", maxRetries = 1, budget = 130 })
		inst.system = S
		inst.ctx = ctx
