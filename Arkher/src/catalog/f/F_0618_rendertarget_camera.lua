-- ARKHER SYSTEM F.0618 :: Render Target View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0618"
	S.key = "arkher.render.rendertarget.view_and_culling"
	S.name = "Render Target View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.rendertarget.frame_graph" }
	S.tags = { "f", "rendertarget", "camera", "render" }
	S.description = "Render Target View And Culling: view state, frustum culling and screen-size LOD for the Render Target subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.rendertarget.view_and_culling", width = 1340, height = 720, fov = 1.1400, far = 1200 })
		inst.system = S
		inst.ctx = ctx
