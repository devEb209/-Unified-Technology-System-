-- ARKHER SYSTEM VD.0039 :: Continuum Stream Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0039"
	S.key = "arkher.contsim.continuumstream.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.continuumstream.epoch_clock" }
	S.tags = { "vd", "continuumstream", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.continuumstream.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
