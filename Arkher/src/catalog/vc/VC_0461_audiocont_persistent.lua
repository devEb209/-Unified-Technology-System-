-- ARKHER SYSTEM VC.0461 :: Audio Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0461"
	S.key = "arkher.contneural.audiocont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.audiocont.multi-scale_fidelity" }
	S.tags = { "vc", "audiocont", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.audiocont.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
