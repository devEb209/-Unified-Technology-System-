-- ARKHER SYSTEM I.0413 :: Animation Streaming Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0413"
	S.key = "arkher.anim.animstreaming.pose_cache"
	S.name = "Animation Streaming Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstreaming.playback_pipeline" }
	S.tags = { "i", "animstreaming", "cache", "anim" }
	S.description = "Animation Streaming Pose Cache: reuse of sampled poses across frames and instances for the Animation Streaming subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.animstreaming.pose_cache", policy = "lfu", capacity = 102, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
