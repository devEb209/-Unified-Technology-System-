-- ARKHER SYSTEM E.0308 :: Dust Accumulation Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0308"
	S.key = "arkher.material.dust.streaming"
	S.name = "Dust Accumulation Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.dust.parameter_budget" }
	S.tags = { "e", "dust", "streamer", "material" }
	S.description = "Dust Accumulation Streaming: residency and demand-driven texture streaming for the Dust Accumulation subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.dust.streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
