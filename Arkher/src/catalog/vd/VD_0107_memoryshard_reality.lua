-- ARKHER SYSTEM VD.0107 :: Memory Shard Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0107"
	S.key = "arkher.contsim.memoryshard.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memoryshard.simulation_fabric" }
	S.tags = { "vd", "memoryshard", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.memoryshard.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
