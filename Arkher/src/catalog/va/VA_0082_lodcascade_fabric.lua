-- ARKHER SYSTEM VA.0082 :: LOD Cascade Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0082"
	S.key = "arkher.contworld.lodcascade.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lodcascade.complexity_budget" }
	S.tags = { "va", "lodcascade", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.lodcascade.simulation_fabric", budgetMs = 2.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
