-- ARKHER SYSTEM N.0379 :: Decal Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0379"
	S.key = "arkher.vfx.decal.particle_simulation"
	S.name = "Decal Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Decal"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.decal.emission" }
	S.tags = { "n", "decal", "particles", "vfx" }
	S.description = "Decal Particle Simulation: pooled integration of position, velocity, colour and life for the Decal subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.decal.particle_simulation", capacity = 576, drag = 0.12, bounce = 0.17, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
