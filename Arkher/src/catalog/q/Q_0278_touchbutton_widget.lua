-- ARKHER SYSTEM Q.0278 :: Touch Button Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0278"
	S.key = "arkher.ui.touchbutton.widget_tree"
	S.name = "Touch Button Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Touch Button"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.touchbutton.responsive_layout" }
	S.tags = { "q", "touchbutton", "widget", "ui" }
	S.description = "Touch Button Widget Tree: retained widget nodes, properties, bindings and rendering for the Touch Button subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.touchbutton.widget_tree", theme = "light", scale = 0.80 })
		inst.system = S
		inst.ctx = ctx
