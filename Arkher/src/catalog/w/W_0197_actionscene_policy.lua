-- ARKHER SYSTEM W.0197 :: Action Scene Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0197"
	S.key = "arkher.cine.actionscene.cut_policy"
	S.name = "Action Scene Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Action Scene"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.actionscene.shot_composition" }
	S.tags = { "w", "actionscene", "policy", "cine" }
	S.description = "Action Scene Cut Policy: rules deciding when the sequence cuts and to what for the Action Scene subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.actionscene.cut_policy", algorithm = "lottery", starvationGuard = 19 })
		inst.system = S
		inst.ctx = ctx
