-- ARKHER SYSTEM H.0427 :: Friction Model Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0427"
	S.key = "arkher.physics.friction.vehicle"
	S.name = "Friction Model Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.friction.character_motion" }
	S.tags = { "h", "friction", "vehicle", "physics" }
	S.description = "Friction Model Vehicle: suspension, drivetrain, steering and tire friction for the Friction Model subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.friction.vehicle", mass = 1700, wheelbase = 3.20, track = 1.60, maxRpm = 6600 })
		inst.system = S
		inst.ctx = ctx
