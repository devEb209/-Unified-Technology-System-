-- ARKHER SYSTEM VA.0224 :: Terrain Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0224"
	S.key = "arkher.contworld.terraincont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.terraincont.neural_field" }
	S.tags = { "va", "terraincont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.terraincont.world_memory_stream", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
