-- ARKHER SYSTEM E.0293 :: Wear And Tear Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0293"
	S.key = "arkher.material.wear.streaming"
	S.name = "Wear And Tear Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.wear.parameter_budget" }
	S.tags = { "e", "wear", "streamer", "material" }
	S.description = "Wear And Tear Streaming: residency and demand-driven texture streaming for the Wear And Tear subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.wear.streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
