-- ARKHER SYSTEM Z.0877 :: Multi Scale Simulation Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0877"
	S.key = "arkher.origin.multiscale.behaviour_analysis"
	S.name = "Multi Scale Simulation Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.governance_policy" }
	S.tags = { "z", "multiscale", "analyzer", "origin" }
	S.description = "Multi Scale Simulation Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.multiscale.behaviour_analysis", window = 140, buckets = 8, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
