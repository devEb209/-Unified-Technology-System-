-- ARKHER SYSTEM Z.0920 :: Deterministic Replay Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0920"
	S.key = "arkher.origin.deterministicreplay.orchestration"
	S.name = "Deterministic Replay Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deterministicreplay.residency_streaming" }
	S.tags = { "z", "deterministicreplay", "orchestrator", "origin" }
	S.description = "Deterministic Replay Orchestration: lifecycle and phase orchestration of the technology for the Deterministic Replay subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.deterministicreplay.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
