-- ARKHER SYSTEM E.0412 :: Mip Policy Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0412"
	S.key = "arkher.material.mippolicy.parameter_budget"
	S.name = "Mip Policy Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Mip Policy"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.mippolicy.variant_registry" }
	S.tags = { "e", "mippolicy", "budgeter", "material" }
	S.description = "Mip Policy Parameter Budget: texel and layer budget allocation for the Mip Policy subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.mippolicy.parameter_budget", total = 64, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
