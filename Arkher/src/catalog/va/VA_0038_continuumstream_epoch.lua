-- ARKHER SYSTEM VA.0038 :: Continuum Stream Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0038"
	S.key = "arkher.contworld.continuumstream.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.continuumstream.infinite_grid" }
	S.tags = { "va", "continuumstream", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.continuumstream.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
