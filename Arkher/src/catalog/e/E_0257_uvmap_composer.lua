-- ARKHER SYSTEM E.0257 :: UV Mapping Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0257"
	S.key = "arkher.material.uvmap.layer_composition"
	S.name = "UV Mapping Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "UV Mapping"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.uvmap.definition" }
	S.tags = { "e", "uvmap", "composer", "material" }
	S.description = "UV Mapping Layer Composition: ordered layer composition with blend rules for the UV Mapping subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.uvmap.layer_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
