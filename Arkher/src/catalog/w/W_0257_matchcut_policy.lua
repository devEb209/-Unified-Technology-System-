-- ARKHER SYSTEM W.0257 :: Match Cut Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0257"
	S.key = "arkher.cine.matchcut.cut_policy"
	S.name = "Match Cut Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Match Cut"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.matchcut.shot_composition" }
	S.tags = { "w", "matchcut", "policy", "cine" }
	S.description = "Match Cut Cut Policy: rules deciding when the sequence cuts and to what for the Match Cut subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.matchcut.cut_policy", algorithm = "wfq", starvationGuard = 58 })
		inst.system = S
		inst.ctx = ctx
