-- ARKHER SYSTEM N.0263 :: Shield Effect Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0263"
	S.key = "arkher.vfx.shieldfx.force_field"
	S.name = "Shield Effect Force Field"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.shieldfx.particle_simulation" }
	S.tags = { "n", "shieldfx", "forcefield", "vfx" }
	S.description = "Shield Effect Force Field: wind, attraction, vortex, drag and curl turbulence for the Shield Effect subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.shieldfx.force_field", seed = 1709 })
		inst.system = S
		inst.ctx = ctx
