-- ARKHER SYSTEM H.0585 :: Buoyancy Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0585"
	S.key = "arkher.physics.buoyancy.result_cache"
	S.name = "Buoyancy Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Buoyancy"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.buoyancy.simulation_policy" }
	S.tags = { "h", "buoyancy", "cache", "physics" }
	S.description = "Buoyancy Result Cache: reuse of expensive simulation and query results for the Buoyancy subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.buoyancy.result_cache", policy = "lfu", capacity = 425, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
