-- ARKHER SYSTEM O.0163 :: Forest Audio Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0163"
	S.key = "arkher.audio.forestaudio.asset_registry"
	S.name = "Forest Audio Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Forest Audio"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.forestaudio.streaming" }
	S.tags = { "o", "forestaudio", "registry", "audio" }
	S.description = "Forest Audio Asset Registry: catalogue of sounds, variations and metadata for the Forest Audio subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.forestaudio.asset_registry" })
		inst.system = S
		inst.ctx = ctx
