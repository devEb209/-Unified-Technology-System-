-- ARKHER SYSTEM VA.0324 :: Ecology Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0324"
	S.key = "arkher.contworld.ecologycont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.ecologycont.reality_continuum" }
	S.tags = { "va", "ecologycont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.ecologycont.emergence_continuum", windowSize = 7, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
