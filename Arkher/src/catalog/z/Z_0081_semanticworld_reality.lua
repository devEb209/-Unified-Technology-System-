-- ARKHER SYSTEM Z.0081 :: Semantic World Graph Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0081"
	S.key = "arkher.origin.semanticworld.reality_layering"
	S.name = "Semantic World Graph Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "semanticworld", "reality", "origin" }
	S.description = "Semantic World Graph Reality Layering: stacked authored, simulated, proposed and player realities for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.semanticworld.reality_layering" })
		inst.system = S
		inst.ctx = ctx
