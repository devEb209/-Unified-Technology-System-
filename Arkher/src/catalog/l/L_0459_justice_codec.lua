-- ARKHER SYSTEM L.0459 :: Justice State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0459"
	S.key = "arkher.sim.justice.state_codec"
	S.name = "Justice State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.justice.history_ledger" }
	S.tags = { "l", "justice", "codec", "sim" }
	S.description = "Justice State Codec: persistence, diffing and checksum of the world state for the Justice subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.justice.state_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
