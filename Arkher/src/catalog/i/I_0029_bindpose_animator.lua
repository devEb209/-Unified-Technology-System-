-- ARKHER SYSTEM I.0029 :: Bind Pose Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0029"
	S.key = "arkher.anim.bindpose.layered_blending"
	S.name = "Bind Pose Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bind Pose"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bindpose.clip_sampling" }
	S.tags = { "i", "bindpose", "animator", "anim" }
	S.description = "Bind Pose Layered Blending: layers, crossfades, masks and blend trees for the Bind Pose subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.bindpose.layered_blending", budget = 7 })
		inst.system = S
		inst.ctx = ctx
