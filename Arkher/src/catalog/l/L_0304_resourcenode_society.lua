-- ARKHER SYSTEM L.0304 :: Resource Node Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0304"
	S.key = "arkher.sim.resourcenode.society"
	S.name = "Resource Node Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.resourcenode.economy" }
	S.tags = { "l", "resourcenode", "society", "sim" }
	S.description = "Resource Node Society: relations, factions, reputation and cohesion of the region for the Resource Node subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.resourcenode.society", decayRate = 0.007, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
