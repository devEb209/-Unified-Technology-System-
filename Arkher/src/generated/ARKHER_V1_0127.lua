--!strict
-- D-O15 S620 — ANIMATION Mixer #0127
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="D-O15 S620 — ANIMATION Mixer #0127", size=Vector2.new(640, 460), pos=UDim2.fromOffset(151, 159), parent=parent, icon="✥"})
...
Components.Slider(right, "Rate", 0,3000,600, function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_Rate"..127, v) end end)
