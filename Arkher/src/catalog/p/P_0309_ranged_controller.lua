-- ARKHER SYSTEM P.0309 :: Ranged Difficulty Controller
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0309"
	S.key = "arkher.play.ranged.difficulty_controller"
	S.name = "Ranged Difficulty Controller"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ranged"
	...
	S.kit = "controller"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ranged.balance_analysis" }
	S.tags = { "p", "ranged", "controller", "play" }
	S.description = "Ranged Difficulty Controller: closed-loop tuning toward a target challenge for the Ranged subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("controller", { id = "arkher.play.ranged.difficulty_controller", mode = "bangbang", target = 0.810, kp = 0.360, ki = 0.070, kd = 0.020, min = 0.05, max = 1.0, initial = 0.71, deadband = 0.01 })
		inst.system = S
		inst.ctx = ctx
