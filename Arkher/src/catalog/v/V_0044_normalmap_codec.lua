-- ARKHER SYSTEM V.0044 :: Normal Map Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0044"
	S.key = "arkher.asset.normalmap.compression_codec"
	S.name = "Normal Map Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.normalmap.streaming_residency" }
	S.tags = { "v", "normalmap", "codec", "asset" }
	S.description = "Normal Map Compression Codec: compact encoding, diffing and checksum of asset payloads for the Normal Map subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.normalmap.compression_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
