-- ARKHER SYSTEM VB.0369 :: Quest Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0369"
	S.key = "arkher.conttime.questcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.questcont.world_memory_stream" }
	S.tags = { "vb", "questcont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.questcont.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
