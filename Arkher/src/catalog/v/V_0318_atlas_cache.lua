-- ARKHER SYSTEM V.0318 :: Texture Atlas Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0318"
	S.key = "arkher.asset.atlas.content_cache"
	S.name = "Texture Atlas Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.atlas.dependency_graph" }
	S.tags = { "v", "atlas", "cache", "asset" }
	S.description = "Texture Atlas Content Cache: reuse of already cooked results for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.atlas.content_cache", policy = "ttl", capacity = 467, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
