-- ARKHER SYSTEM VA.0170 :: Neural Patch Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0170"
	S.key = "arkher.contworld.neuralpatch.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.neuralpatch.infinite_grid" }
	S.tags = { "va", "neuralpatch", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.neuralpatch.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
