-- ARKHER SYSTEM Z.0950 :: Platform Abstraction Doctrine Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0950"
	S.key = "arkher.origin.platformdoctrine.self_critique"
	S.name = "Platform Abstraction Doctrine Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.platformdoctrine.intent_bridge" }
	S.tags = { "z", "platformdoctrine", "critic", "origin" }
	S.description = "Platform Abstraction Doctrine Self Critique: weighted judgement of the technology's own output for the Platform Abstraction Doctrine subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.platformdoctrine.self_critique", passMark = 0.79, reviseMark = 0.44, seed = 27654 })
		inst.system = S
		inst.ctx = ctx
