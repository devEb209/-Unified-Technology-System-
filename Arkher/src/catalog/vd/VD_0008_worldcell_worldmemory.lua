-- ARKHER SYSTEM VD.0008 :: World Grid Cell World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0008"
	S.key = "arkher.contsim.worldcell.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldcell.neural_field" }
	S.tags = { "vd", "worldcell", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.worldcell.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
