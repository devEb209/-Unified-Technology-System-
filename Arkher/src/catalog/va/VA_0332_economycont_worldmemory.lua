-- ARKHER SYSTEM VA.0332 :: Economy Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0332"
	S.key = "arkher.contworld.economycont.world_memory_stream"
	S.name = "Economy Continuum World Memory Stream"
	S.category = "VA"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.economycont.neural_field" }
	S.tags = { "va", "economycont", "worldmemory", "contworld" }
	S.description = "Economy Continuum World Memory Stream: world memory continuum over epochs for the Economy Continuum subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.economycont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
