-- ARKHER SYSTEM H.0484 :: Ball Joint Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0484"
	S.key = "arkher.physics.balljoint.broadphase_index"
	S.name = "Ball Joint Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Ball Joint"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.balljoint.vehicle" }
	S.tags = { "h", "balljoint", "index", "physics" }
	S.description = "Ball Joint Broadphase Index: spatial acceleration of candidate pair finding for the Ball Joint subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.balljoint.broadphase_index", mode = "hash", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
