-- ARKHER SYSTEM N.0080 :: Impact Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0080"
	S.key = "arkher.vfx.impact.particle_simulation"
	S.name = "Impact Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Impact"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.impact.emission" }
	S.tags = { "n", "impact", "particles", "vfx" }
	S.description = "Impact Particle Simulation: pooled integration of position, velocity, colour and life for the Impact subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.impact.particle_simulation", capacity = 192, drag = 0.22, bounce = 0.37, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
