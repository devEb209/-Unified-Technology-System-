-- ARKHER SYSTEM N.0328 :: Ribbon Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0328"
	S.key = "arkher.vfx.ribbonfx.force_field"
	S.name = "Ribbon Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Ribbon"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.ribbonfx.particle_simulation" }
	S.tags = { "n", "ribbonfx", "forcefield", "vfx" }
	S.description = "Ribbon Force Field: wind, attraction, vortex, drag and curl turbulence for the Ribbon subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.ribbonfx.force_field", seed = 21693 })
		inst.system = S
		inst.ctx = ctx
