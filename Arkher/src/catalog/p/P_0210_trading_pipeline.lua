-- ARKHER SYSTEM P.0210 :: Trading Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0210"
	S.key = "arkher.play.trading.rule_pipeline"
	S.name = "Trading Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Trading"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.trading.state_machine" }
	S.tags = { "p", "trading", "pipeline", "play" }
	S.description = "Trading Rule Pipeline: ordered rules applied to every gameplay event for the Trading subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.trading.rule_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
