-- ARKHER SYSTEM L.0107 :: Settlement Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0107"
	S.key = "arkher.sim.settlement.ecology"
	S.name = "Settlement Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.settlement.simulation_core" }
	S.tags = { "l", "settlement", "ecology", "sim" }
	S.description = "Settlement Ecology: populations, predation, harvesting and carrying capacity for the Settlement subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.settlement.ecology" })
		inst.system = S
		inst.ctx = ctx
