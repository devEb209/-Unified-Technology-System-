-- ARKHER SYSTEM VB.0430 :: Navigation Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0430"
	S.key = "arkher.conttime.navcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.navcont.complexity_budget" }
	S.tags = { "vb", "navcont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.navcont.simulation_fabric", budgetMs = 4.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
