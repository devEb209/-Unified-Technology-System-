-- ARKHER SYSTEM L.0070 :: Population Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0070"
	S.key = "arkher.sim.population.streaming"
	S.name = "Population Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.population.state_codec" }
	S.tags = { "l", "population", "streamer", "sim" }
	S.description = "Population Streaming: distance-driven residency of simulated regions for the Population subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.population.streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
