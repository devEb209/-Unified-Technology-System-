-- ARKHER SYSTEM I.0370 :: Retargeting Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0370"
	S.key = "arkher.anim.retargeting.retarget_graph"
	S.name = "Retargeting Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Retargeting"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.retargeting.physical_blend" }
	S.tags = { "i", "retargeting", "graph", "anim" }
	S.description = "Retargeting Retarget Graph: bone mapping and retarget path resolution for the Retargeting subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.retargeting.retarget_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
