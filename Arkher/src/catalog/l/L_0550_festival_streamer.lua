-- ARKHER SYSTEM L.0550 :: Festival Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0550"
	S.key = "arkher.sim.festival.streaming"
	S.name = "Festival Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.festival.state_codec" }
	S.tags = { "l", "festival", "streamer", "sim" }
	S.description = "Festival Streaming: distance-driven residency of simulated regions for the Festival subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.festival.streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
