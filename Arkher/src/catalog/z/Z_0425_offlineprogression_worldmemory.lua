-- ARKHER SYSTEM Z.0425 :: Offline World Progression World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0425"
	S.key = "arkher.origin.offlineprogression.world_memory"
	S.name = "Offline World Progression World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.autonomous_pipeline" }
	S.tags = { "z", "offlineprogression", "worldmemory", "origin" }
	S.description = "Offline World Progression World Memory: epoch-stamped persistent history with compaction and checkpoints for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.offlineprogression.world_memory", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
