-- ARKHER SYSTEM E.0358 :: Snow Cover Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0358"
	S.key = "arkher.material.snowcover.authoring_pipeline"
	S.name = "Snow Cover Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Snow Cover"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.snowcover.analysis" }
	S.tags = { "e", "snowcover", "pipeline", "material" }
	S.description = "Snow Cover Authoring Pipeline: ordered authoring and bake stages for the Snow Cover subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.snowcover.authoring_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
