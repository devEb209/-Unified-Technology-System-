-- ARKHER SYSTEM O.0357 :: Creature Audio Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0357"
	S.key = "arkher.audio.creatureaudio.playback_policy"
	S.name = "Creature Audio Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.creatureaudio.compression_codec" }
	S.tags = { "o", "creatureaudio", "policy", "audio" }
	S.description = "Creature Audio Playback Policy: rules choosing what may be heard right now for the Creature Audio subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.creatureaudio.playback_policy", algorithm = "lottery", starvationGuard = 51 })
		inst.system = S
		inst.ctx = ctx
