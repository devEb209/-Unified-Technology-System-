-- ARKHER SYSTEM O.0209 :: Occlusion Zone Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0209"
	S.key = "arkher.audio.occlusionzone.voice_budget"
	S.name = "Occlusion Zone Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.occlusionzone.music_sequencer" }
	S.tags = { "o", "occlusionzone", "budgeter", "audio" }
	S.description = "Occlusion Zone Voice Budget: voice slots allocated by priority and audibility for the Occlusion Zone subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.occlusionzone.voice_budget", total = 184, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
