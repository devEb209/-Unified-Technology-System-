-- ARKHER SYSTEM L.0500 :: War Calendar
...
return function(A)
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.war.society" }
	S.tags = { "l", "war", "schedule", "sim" }
	S.description = "War Calendar: hours, days and seasons driving the region for the War subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.war.calendar", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
