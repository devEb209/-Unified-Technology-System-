-- ARKHER SYSTEM Z.0725 :: Knowledge Distillation World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0725"
	S.key = "arkher.origin.distillation.world_memory"
	S.name = "Knowledge Distillation World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.distillation.autonomous_pipeline" }
	S.tags = { "z", "distillation", "worldmemory", "origin" }
	S.description = "Knowledge Distillation World Memory: epoch-stamped persistent history with compaction and checkpoints for the Knowledge Distillation subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.distillation.world_memory", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
