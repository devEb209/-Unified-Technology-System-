-- ARKHER SYSTEM E.0108 :: Ambient Occlusion Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0108"
	S.key = "arkher.material.ao.shading_graph"
	S.name = "Ambient Occlusion Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.ao.layer_composition" }
	S.tags = { "e", "ao", "shadegraph", "material" }
	S.description = "Ambient Occlusion Shading Graph: node graph evaluated and compiled to Luau for the Ambient Occlusion subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.ao.shading_graph" })
		inst.system = S
		inst.ctx = ctx
