-- ARKHER SYSTEM N.0167 :: Snow Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0167"
	S.key = "arkher.vfx.snow.spatial_index"
	S.name = "Snow Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Snow"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.snow.quality_policy" }
	S.tags = { "n", "snow", "index", "vfx" }
	S.description = "Snow Spatial Index: spatial acceleration of effect queries and culling for the Snow subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.snow.spatial_index", mode = "hash", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
