--!strict
-- Physics Chaos — ANIMATION Node_Flow #0181
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Physics Chaos — ANIMATION Node_Flow #0181", size=Vector2.new(640, 440), pos=UDim2.fromOffset(453, 297), parent=parent, icon="◨"})
