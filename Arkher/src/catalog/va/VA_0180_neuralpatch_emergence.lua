-- ARKHER SYSTEM VA.0180 :: Neural Patch Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0180"
	S.key = "arkher.contworld.neuralpatch.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.neuralpatch.reality_continuum" }
	S.tags = { "va", "neuralpatch", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.neuralpatch.emergence_continuum", windowSize = 7, threshold = 1.40, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
