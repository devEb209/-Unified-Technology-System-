-- ARKHER SYSTEM Z.0098 :: Semantic World Graph Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0098"
	S.key = "arkher.origin.semanticworld.budget_governor"
	S.name = "Semantic World Graph Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticworld.behaviour_analysis" }
	S.tags = { "z", "semanticworld", "budgeter", "origin" }
	S.description = "Semantic World Graph Budget Governor: allocation of a scarce resource across the technology's consumers for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.semanticworld.budget_governor", total = 80, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
