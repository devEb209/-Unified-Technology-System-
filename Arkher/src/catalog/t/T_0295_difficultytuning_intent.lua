-- ARKHER SYSTEM T.0295 :: Difficulty Tuning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0295"
	S.key = "arkher.ai.difficultytuning.intent_understanding"
	S.name = "Difficulty Tuning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "difficultytuning", "intent", "ai" }
	S.description = "Difficulty Tuning Intent Understanding: natural language turned into an actionable, scored intent for the Difficulty Tuning subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.difficultytuning.intent_understanding", minConfidence = 0.36 })
		inst.system = S
		inst.ctx = ctx
