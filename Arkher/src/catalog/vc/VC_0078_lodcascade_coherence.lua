-- ARKHER SYSTEM VC.0078 :: LOD Cascade Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0078"
	S.key = "arkher.contneural.lodcascade.coherence_guard"
	S.name = "LOD Cascade Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lodcascade.persistent_state" }
	S.tags = { "vc", "lodcascade", "coherence", "contneural" }
	S.description = "LOD Cascade Coherence Guard: seam coherence and drift supervision for the LOD Cascade subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.lodcascade.coherence_guard", window = 97, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
