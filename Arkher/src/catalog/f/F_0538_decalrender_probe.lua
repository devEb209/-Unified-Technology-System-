-- ARKHER SYSTEM F.0538 :: Decal Rendering Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0538"
	S.key = "arkher.render.decalrender.probe_volume"
	S.name = "Decal Rendering Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.decalrender.lighting_rig" }
	S.tags = { "f", "decalrender", "probe", "render" }
	S.description = "Decal Rendering Probe Volume: irradiance probes encoded in spherical harmonics for the Decal Rendering subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.decalrender.probe_volume", spacing = 24 })
		inst.system = S
		inst.ctx = ctx
