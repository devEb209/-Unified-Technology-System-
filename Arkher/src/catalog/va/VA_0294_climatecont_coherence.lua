-- ARKHER SYSTEM VA.0294 :: Climate Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0294"
	S.key = "arkher.contworld.climatecont.coherence_guard"
	S.name = "Climate Continuum Coherence Guard"
	S.category = "VA"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.climatecont.persistent_state" }
	S.tags = { "va", "climatecont", "coherence", "contworld" }
	S.description = "Climate Continuum Coherence Guard: seam coherence and drift supervision for the Climate Continuum subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.climatecont.coherence_guard", window = 129, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
