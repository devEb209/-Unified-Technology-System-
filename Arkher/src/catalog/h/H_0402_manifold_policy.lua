-- ARKHER SYSTEM H.0402 :: Contact Manifold Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0402"
	S.key = "arkher.physics.manifold.simulation_policy"
	S.name = "Contact Manifold Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.manifold.budget_governor" }
	S.tags = { "h", "manifold", "policy", "physics" }
	S.description = "Contact Manifold Simulation Policy: device tier rules for substeps, iterations and sleep for the Contact Manifold subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.manifold.simulation_policy", algorithm = "roundrobin", starvationGuard = 36 })
		inst.system = S
		inst.ctx = ctx
