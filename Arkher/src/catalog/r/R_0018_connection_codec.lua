-- ARKHER SYSTEM R.0018 :: Connection Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0018"
	S.key = "arkher.net.connection.serialization_codec"
	S.name = "Connection Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Connection"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.connection.bandwidth_budget" }
	S.tags = { "r", "connection", "codec", "net" }
	S.description = "Connection Serialization Codec: compact encoding, diffing and checksum of payloads for the Connection subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.connection.serialization_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
