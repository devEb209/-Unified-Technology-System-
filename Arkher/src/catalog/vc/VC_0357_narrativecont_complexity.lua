-- ARKHER SYSTEM VC.0357 :: Narrative Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0357"
	S.key = "arkher.contneural.narrativecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.narrativecont.world_memory_stream" }
	S.tags = { "vc", "narrativecont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.narrativecont.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
