-- ARKHER SYSTEM VD.0144 :: Fidelity Band Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0144"
	S.key = "arkher.contsim.fidelityband.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.fidelityband.reality_continuum" }
	S.tags = { "vd", "fidelityband", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.fidelityband.emergence_continuum", windowSize = 7, threshold = 1.60, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
