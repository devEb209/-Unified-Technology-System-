-- ARKHER SYSTEM L.0403 :: Wealth Distribution Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0403"
	S.key = "arkher.sim.wealth.analysis"
	S.name = "Wealth Distribution Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wealth.aggregate_cache" }
	S.tags = { "l", "wealth", "analyzer", "sim" }
	S.description = "Wealth Distribution Analysis: trend, anomaly and stability analysis of the world for the Wealth Distribution subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.wealth.analysis", window = 74, buckets = 18, threshold = 3.60 })
		inst.system = S
		inst.ctx = ctx
