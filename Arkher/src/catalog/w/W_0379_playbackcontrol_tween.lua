-- ARKHER SYSTEM W.0379 :: Playback Control Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0379"
	S.key = "arkher.cine.playbackcontrol.motion_tween"
	S.name = "Playback Control Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.playbackcontrol.playback_orchestrator" }
	S.tags = { "w", "playbackcontrol", "tween", "cine" }
	S.description = "Playback Control Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Playback Control subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.playbackcontrol.motion_tween", timeScale = 1.03 })
		inst.system = S
		inst.ctx = ctx
