-- ARKHER SYSTEM G.0313 :: Weight Quantization Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0313"
	S.key = "arkher.neural.quantization.model_registry"
	S.name = "Weight Quantization Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.quantization.reconstruction" }
	S.tags = { "g", "quantization", "registry", "neural" }
	S.description = "Weight Quantization Model Registry: named models and their lifecycle for the Weight Quantization subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.quantization.model_registry" })
		inst.system = S
		inst.ctx = ctx
