--!strict
-- Anvil Cluster — ANIMATION Node_Flow #0041
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Anvil Cluster — ANIMATION Node_Flow #0041", size=Vector2.new(680, 440), pos=UDim2.fromOffset(233, 257), parent=parent, icon="⬢"})
