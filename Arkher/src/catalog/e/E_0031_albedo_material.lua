-- ARKHER SYSTEM E.0031 :: Albedo Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0031"
	S.key = "arkher.material.albedo.definition"
	S.name = "Albedo Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Albedo"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "albedo", "material", "material" }
	S.description = "Albedo Definition: layered PBR definition resolved into parameters for the Albedo subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.albedo.definition", texelBudget = 2097152 })
		inst.system = S
		inst.ctx = ctx
