-- ARKHER SYSTEM VA.0259 :: Road Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0259"
	S.key = "arkher.contworld.roadcont.neural_field"
	S.name = "Road Continuum Neural Field"
	S.category = "VA"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.roadcont.coherence_guard" }
	S.tags = { "va", "roadcont", "neuralfield", "contworld" }
	S.description = "Road Continuum Neural Field: neural field encoding and reconstruction for the Road Continuum subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.roadcont.neural_field", dims = 16, hidden = 12, seed = 9793 })
		inst.system = S
		inst.ctx = ctx
