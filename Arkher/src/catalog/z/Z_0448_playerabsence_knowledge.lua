-- ARKHER SYSTEM Z.0448 :: Player Absence Simulation Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0448"
	S.key = "arkher.origin.playerabsence.semantic_graph"
	S.name = "Player Absence Simulation Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.world_architect" }
	S.tags = { "z", "playerabsence", "knowledge", "origin" }
	S.description = "Player Absence Simulation Semantic Graph: typed entities and inferred relations of the technology itself for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.playerabsence.semantic_graph", dims = 24 })
		inst.system = S
		inst.ctx = ctx
