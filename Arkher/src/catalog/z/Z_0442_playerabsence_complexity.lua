-- ARKHER SYSTEM Z.0442 :: Player Absence Simulation Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0442"
	S.key = "arkher.origin.playerabsence.complexity_governance"
	S.name = "Player Absence Simulation Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.reality_layering" }
	S.tags = { "z", "playerabsence", "complexity", "origin" }
	S.description = "Player Absence Simulation Complexity Governance: measured scene cost turned into per-subsystem directives for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.playerabsence.complexity_governance", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
