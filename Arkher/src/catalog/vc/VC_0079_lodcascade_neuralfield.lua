-- ARKHER SYSTEM VC.0079 :: LOD Cascade Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0079"
	S.key = "arkher.contneural.lodcascade.neural_field"
	S.name = "LOD Cascade Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lodcascade.coherence_guard" }
	S.tags = { "vc", "lodcascade", "neuralfield", "contneural" }
	S.description = "LOD Cascade Neural Field: neural field encoding and reconstruction for the LOD Cascade subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.lodcascade.neural_field", dims = 24, hidden = 20, seed = 38911 })
		inst.system = S
		inst.ctx = ctx
