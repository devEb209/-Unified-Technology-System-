-- ARKHER SYSTEM Q.0196 :: Minimap Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0196"
	S.key = "arkher.ui.minimap.transition"
	S.name = "Minimap Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Minimap"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.minimap.input_mapping" }
	S.tags = { "q", "minimap", "tween", "ui" }
	S.description = "Minimap Transition: eased, delayed, looped and sequenced motion for the Minimap subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.minimap.transition", timeScale = 1.03 })
		inst.system = S
		inst.ctx = ctx
