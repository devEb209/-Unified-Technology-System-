-- ARKHER SYSTEM Q.0001 :: Screen Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0001"
	S.key = "arkher.ui.screen.responsive_layout"
	S.name = "Screen Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Screen"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "screen", "flex", "ui" }
	S.description = "Screen Responsive Layout: flex solving with safe areas, weights and breakpoints for the Screen subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.screen.responsive_layout", width = 450, height = 844, scale = 0.90 })
		inst.system = S
		inst.ctx = ctx
