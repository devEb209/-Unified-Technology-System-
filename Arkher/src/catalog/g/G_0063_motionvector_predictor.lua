-- ARKHER SYSTEM G.0063 :: Motion Vector Estimation Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0063"
	S.key = "arkher.neural.motionvector.quality_predictor"
	S.name = "Motion Vector Estimation Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.motionvector.weight_codec" }
	S.tags = { "g", "motionvector", "predictor", "neural" }
	S.description = "Motion Vector Estimation Quality Predictor: predicted quality and cost of a setting for the Motion Vector Estimation subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.motionvector.quality_predictor", method = "ema", alpha = 0.17, window = 47 })
		inst.system = S
		inst.ctx = ctx
