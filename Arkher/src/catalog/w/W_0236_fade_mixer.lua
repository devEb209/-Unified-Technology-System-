-- ARKHER SYSTEM W.0236 :: Fade Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0236"
	S.key = "arkher.cine.fade.cinematic_mix"
	S.name = "Fade Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Fade"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.fade.motion_tween" }
	S.tags = { "w", "fade", "mixer", "cine" }
	S.description = "Fade Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Fade subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.fade.cinematic_mix", maxVoices = 48 })
		inst.system = S
		inst.ctx = ctx
