-- ARKHER SYSTEM T.0697 :: AI Debug Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0697"
	S.key = "arkher.ai.aidebug.action_planner"
	S.name = "AI Debug Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.aidebug.utility_selection" }
	S.tags = { "t", "aidebug", "planner", "ai" }
	S.description = "AI Debug Action Planner: goal-oriented action planning over preconditions for the AI Debug subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.aidebug.action_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
