-- ARKHER SYSTEM O.0320 :: Vehicle Audio Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0320"
	S.key = "arkher.audio.vehicleaudio.compression_codec"
	S.name = "Vehicle Audio Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.vehicleaudio.asset_registry" }
	S.tags = { "o", "vehicleaudio", "codec", "audio" }
	S.description = "Vehicle Audio Compression Codec: payload encoding of audio state and events for the Vehicle Audio subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.vehicleaudio.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
