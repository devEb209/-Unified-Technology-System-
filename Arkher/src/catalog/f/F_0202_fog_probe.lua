-- ARKHER SYSTEM F.0202 :: Fog Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0202"
	S.key = "arkher.render.fog.probe_volume"
	S.name = "Fog Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Fog"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.fog.lighting_rig" }
	S.tags = { "f", "fog", "probe", "render" }
	S.description = "Fog Probe Volume: irradiance probes encoded in spherical harmonics for the Fog subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.fog.probe_volume", spacing = 16 })
		inst.system = S
		inst.ctx = ctx
