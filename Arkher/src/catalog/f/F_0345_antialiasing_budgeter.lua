-- ARKHER SYSTEM F.0345 :: Antialiasing Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0345"
	S.key = "arkher.render.antialiasing.draw_budget"
	S.name = "Antialiasing Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Antialiasing"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.antialiasing.adaptive_resolution" }
	S.tags = { "f", "antialiasing", "budgeter", "render" }
	S.description = "Antialiasing Draw Budget: draw call and triangle budget allocation for the Antialiasing subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.antialiasing.draw_budget", total = 270, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
