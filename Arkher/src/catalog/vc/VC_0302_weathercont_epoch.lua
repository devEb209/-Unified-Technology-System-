-- ARKHER SYSTEM VC.0302 :: Weather Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0302"
	S.key = "arkher.contneural.weathercont.epoch_clock"
	S.name = "Weather Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.weathercont.infinite_grid" }
	S.tags = { "vc", "weathercont", "epoch", "contneural" }
	S.description = "Weather Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Weather Continuum subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.weathercont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
