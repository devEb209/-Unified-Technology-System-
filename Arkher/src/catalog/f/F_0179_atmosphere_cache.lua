-- ARKHER SYSTEM F.0179 :: Atmosphere Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0179"
	S.key = "arkher.render.atmosphere.pass_cache"
	S.name = "Atmosphere Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Atmosphere"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.atmosphere.render_policy" }
	S.tags = { "f", "atmosphere", "cache", "render" }
	S.description = "Atmosphere Pass Cache: reuse of pass results across frames for the Atmosphere subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.atmosphere.pass_cache", policy = "lfu", capacity = 444, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
