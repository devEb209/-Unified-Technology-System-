-- ARKHER SYSTEM W.0401 :: Cinematic Debug Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0401"
	S.key = "arkher.cine.cinedebug.cut_policy"
	S.name = "Cinematic Debug Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinedebug.shot_composition" }
	S.tags = { "w", "cinedebug", "policy", "cine" }
	S.description = "Cinematic Debug Cut Policy: rules deciding when the sequence cuts and to what for the Cinematic Debug subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.cinedebug.cut_policy", algorithm = "roundrobin", starvationGuard = 40 })
		inst.system = S
		inst.ctx = ctx
