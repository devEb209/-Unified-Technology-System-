-- ARKHER SYSTEM G.0007 :: Neural Upscaling Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0007"
	S.key = "arkher.neural.neuralupscale.quality_predictor"
	S.name = "Neural Upscaling Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuralupscale.weight_codec" }
	S.tags = { "g", "neuralupscale", "predictor", "neural" }
	S.description = "Neural Upscaling Quality Predictor: predicted quality and cost of a setting for the Neural Upscaling subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.neuralupscale.quality_predictor", method = "linear", alpha = 0.45, window = 75 })
		inst.system = S
		inst.ctx = ctx
