-- ARKHER SYSTEM VA.0521 :: Asset Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0521"
	S.key = "arkher.contworld.assetcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.assetcont.multi-scale_fidelity" }
	S.tags = { "va", "assetcont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.assetcont.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
