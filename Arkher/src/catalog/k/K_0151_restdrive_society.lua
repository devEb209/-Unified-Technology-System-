-- ARKHER SYSTEM K.0151 :: Rest Drive Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0151"
	S.key = "arkher.npc.restdrive.social_relations"
	S.name = "Rest Drive Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.restdrive.crowd_steering" }
	S.tags = { "k", "restdrive", "society", "npc" }
	S.description = "Rest Drive Social Relations: affinity, factions, reputation and gossip for the Rest Drive subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.restdrive.social_relations", decayRate = 0.014, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
