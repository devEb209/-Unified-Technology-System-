-- ARKHER SYSTEM T.0164 :: Code Generation Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0164"
	S.key = "arkher.ai.codegeneration.utility_selection"
	S.name = "Code Generation Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.codegeneration.working_memory" }
	S.tags = { "t", "codegeneration", "utility", "ai" }
	S.description = "Code Generation Utility Selection: scored choice between competing courses of action for the Code Generation subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.codegeneration.utility_selection", momentum = 0.12 })
		inst.system = S
		inst.ctx = ctx
