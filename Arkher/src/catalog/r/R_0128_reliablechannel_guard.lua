-- ARKHER SYSTEM R.0128 :: Reliable Channel Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0128"
	S.key = "arkher.net.reliablechannel.rate_guard"
	S.name = "Reliable Channel Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reliablechannel.interest_streaming" }
	S.tags = { "r", "reliablechannel", "guard", "net" }
	S.description = "Reliable Channel Rate Guard: token-bucket protection against floods and abuse for the Reliable Channel subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.reliablechannel.rate_guard", algorithm = "token", capacity = 212, refillPerSec = 17, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
