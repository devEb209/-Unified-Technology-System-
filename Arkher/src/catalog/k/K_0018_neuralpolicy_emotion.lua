-- ARKHER SYSTEM K.0018 :: Neural Policy Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0018"
	S.key = "arkher.npc.neuralpolicy.emotion"
	S.name = "Neural Policy Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.neuralpolicy.drive_system" }
	S.tags = { "k", "neuralpolicy", "emotion", "npc" }
	S.description = "Neural Policy Emotion: appraisal of events into valence, arousal and mood for the Neural Policy subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.neuralpolicy.emotion", inertia = 0.90, decayRate = 0.45, baselineArousal = 0.25 })
		inst.system = S
		inst.ctx = ctx
