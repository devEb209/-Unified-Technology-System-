-- ARKHER SYSTEM I.0012 :: Skeleton Rig Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0012"
	S.key = "arkher.anim.skeletonrig.analysis"
	S.name = "Skeleton Rig Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Skeleton Rig"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.skeletonrig.quality_policy" }
	S.tags = { "i", "skeletonrig", "analyzer", "anim" }
	S.description = "Skeleton Rig Analysis: pop, drift and cost analysis of playback for the Skeleton Rig subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.skeletonrig.analysis", window = 64, buckets = 8, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
