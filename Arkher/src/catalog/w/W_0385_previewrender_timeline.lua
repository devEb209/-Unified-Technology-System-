-- ARKHER SYSTEM W.0385 :: Preview Render Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0385"
	S.key = "arkher.cine.previewrender.sequence_timeline"
	S.name = "Preview Render Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "previewrender", "timeline", "cine" }
	S.description = "Preview Render Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Preview Render subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.previewrender.sequence_timeline", duration = 6.0, rate = 0.90 })
		inst.system = S
		inst.ctx = ctx
