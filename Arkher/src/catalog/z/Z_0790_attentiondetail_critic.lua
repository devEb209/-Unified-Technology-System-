-- ARKHER SYSTEM Z.0790 :: Attention Driven Detail Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0790"
	S.key = "arkher.origin.attentiondetail.self_critique"
	S.name = "Attention Driven Detail Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.intent_bridge" }
	S.tags = { "z", "attentiondetail", "critic", "origin" }
	S.description = "Attention Driven Detail Self Critique: weighted judgement of the technology's own output for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.attentiondetail.self_critique", passMark = 0.79, reviseMark = 0.44, seed = 28344 })
		inst.system = S
		inst.ctx = ctx
