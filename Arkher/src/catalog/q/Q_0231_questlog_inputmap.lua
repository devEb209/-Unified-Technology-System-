-- ARKHER SYSTEM Q.0231 :: Quest Log Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0231"
	S.key = "arkher.ui.questlog.input_mapping"
	S.name = "Quest Log Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Quest Log"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.questlog.widget_tree" }
	S.tags = { "q", "questlog", "inputmap", "ui" }
	S.description = "Quest Log Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Quest Log subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.questlog.input_mapping", device = "gamepad", holdTime = 0.40, deadzone = 0.20 })
		inst.system = S
		inst.ctx = ctx
