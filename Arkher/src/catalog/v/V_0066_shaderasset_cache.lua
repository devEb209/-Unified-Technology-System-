-- ARKHER SYSTEM V.0066 :: Shader Asset Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0066"
	S.key = "arkher.asset.shaderasset.content_cache"
	S.name = "Shader Asset Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.shaderasset.dependency_graph" }
	S.tags = { "v", "shaderasset", "cache", "asset" }
	S.description = "Shader Asset Content Cache: reuse of already cooked results for the Shader Asset subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.shaderasset.content_cache", policy = "ttl", capacity = 362, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
