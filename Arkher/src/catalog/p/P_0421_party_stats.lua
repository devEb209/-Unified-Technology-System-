-- ARKHER SYSTEM P.0421 :: Party Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0421"
	S.key = "arkher.play.party.attributes"
	S.name = "Party Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Party"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "party", "stats", "play" }
	S.description = "Party Attributes: base values, layered modifiers and derived statistics for the Party subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.party.attributes" })
		inst.system = S
		inst.ctx = ctx
