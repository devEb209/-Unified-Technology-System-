-- ARKHER SYSTEM O.0361 :: Magic Audio DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0361"
	S.key = "arkher.audio.magicaudio.dsp_chain"
	S.name = "Magic Audio DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Magic Audio"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "magicaudio", "dsp", "audio" }
	S.description = "Magic Audio DSP Chain: biquad filtering, delay, envelope and soft clipping for the Magic Audio subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.magicaudio.dsp_chain", sampleRate = 22050, filter = "lowpass", cutoff = 5100, q = 0.660 })
		inst.system = S
		inst.ctx = ctx
