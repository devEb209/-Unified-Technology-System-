-- ARKHER SYSTEM G.0173 :: Shading Approximation Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0173"
	S.key = "arkher.neural.shadingapprox.model_registry"
	S.name = "Shading Approximation Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.shadingapprox.reconstruction" }
	S.tags = { "g", "shadingapprox", "registry", "neural" }
	S.description = "Shading Approximation Model Registry: named models and their lifecycle for the Shading Approximation subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.shadingapprox.model_registry" })
		inst.system = S
		inst.ctx = ctx
