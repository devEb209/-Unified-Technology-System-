-- ARKHER SYSTEM VC.0045 :: Continuum Stream Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0045"
	S.key = "arkher.contneural.continuumstream.complexity_budget"
	S.name = "Continuum Stream Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.continuumstream.world_memory_stream" }
	S.tags = { "vc", "continuumstream", "complexity", "contneural" }
	S.description = "Continuum Stream Complexity Budget: complexity budgeting for the continuum for the Continuum Stream subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.continuumstream.complexity_budget", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
