-- ARKHER SYSTEM N.0287 :: Buff Effect Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0287"
	S.key = "arkher.vfx.bufffx.emission"
	S.name = "Buff Effect Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Buff Effect"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "bufffx", "emitter", "vfx" }
	S.description = "Buff Effect Emission: shaped, rate and burst emission of new particles for the Buff Effect subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.bufffx.emission", shape = "box", rate = 26, speed = 3.60, life = 1.40, budget = 512, seed = 45726 })
		inst.system = S
		inst.ctx = ctx
