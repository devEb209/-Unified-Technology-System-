-- ARKHER SYSTEM VA.0599 :: Horizon Span Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0599"
	S.key = "arkher.contworld.horizonspan.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.horizonspan.simulation_fabric" }
	S.tags = { "va", "horizonspan", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.horizonspan.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
