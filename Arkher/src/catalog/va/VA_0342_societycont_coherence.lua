-- ARKHER SYSTEM VA.0342 :: Society Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0342"
	S.key = "arkher.contworld.societycont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.societycont.persistent_state" }
	S.tags = { "va", "societycont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.societycont.coherence_guard", window = 131, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
