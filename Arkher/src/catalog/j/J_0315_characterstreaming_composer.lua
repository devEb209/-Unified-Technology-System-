-- ARKHER SYSTEM J.0315 :: Character Streaming Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0315"
	S.key = "arkher.character.characterstreaming.appearance_composer"
	S.name = "Character Streaming Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterstreaming.locomotion" }
	S.tags = { "j", "characterstreaming", "composer", "character" }
	S.description = "Character Streaming Appearance Composer: composition of appearance slots into a look for the Character Streaming subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.characterstreaming.appearance_composer", mode = "add" })
		inst.system = S
		inst.ctx = ctx
