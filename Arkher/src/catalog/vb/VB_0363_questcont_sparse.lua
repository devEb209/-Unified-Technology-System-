-- ARKHER SYSTEM VB.0363 :: Quest Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0363"
	S.key = "arkher.conttime.questcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.questcont.epoch_clock" }
	S.tags = { "vb", "questcont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.questcont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
