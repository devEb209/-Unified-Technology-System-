-- ARKHER SYSTEM H.0529 :: Breakable Joint Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0529"
	S.key = "arkher.physics.breakjoint.result_cache"
	S.name = "Breakable Joint Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.breakjoint.simulation_policy" }
	S.tags = { "h", "breakjoint", "cache", "physics" }
	S.description = "Breakable Joint Result Cache: reuse of expensive simulation and query results for the Breakable Joint subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.breakjoint.result_cache", policy = "lfu", capacity = 149, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
