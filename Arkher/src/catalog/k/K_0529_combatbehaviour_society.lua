-- ARKHER SYSTEM K.0529 :: Combat Behaviour Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0529"
	S.key = "arkher.npc.combatbehaviour.social_relations"
	S.name = "Combat Behaviour Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.combatbehaviour.crowd_steering" }
	S.tags = { "k", "combatbehaviour", "society", "npc" }
	S.description = "Combat Behaviour Social Relations: affinity, factions, reputation and gossip for the Combat Behaviour subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.combatbehaviour.social_relations", decayRate = 0.010, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
