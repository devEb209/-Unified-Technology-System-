-- ARKHER SYSTEM E.0096 :: Height Displacement Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0096"
	S.key = "arkher.material.displacement.variant_registry"
	S.name = "Height Displacement Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.displacement.procedural_detail" }
	S.tags = { "e", "displacement", "registry", "material" }
	S.description = "Height Displacement Variant Registry: named variants and their lifecycle for the Height Displacement subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.displacement.variant_registry" })
		inst.system = S
		inst.ctx = ctx
