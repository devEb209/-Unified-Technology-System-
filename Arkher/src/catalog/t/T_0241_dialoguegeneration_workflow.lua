-- ARKHER SYSTEM T.0241 :: Dialogue Generation Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0241"
	S.key = "arkher.ai.dialoguegeneration.plan_workflow"
	S.name = "Dialogue Generation Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.dialoguegeneration.semantic_knowledge" }
	S.tags = { "t", "dialoguegeneration", "workflow", "ai" }
	S.description = "Dialogue Generation Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Dialogue Generation subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.dialoguegeneration.plan_workflow", maxRetries = 3, budget = 60 })
		inst.system = S
		inst.ctx = ctx
