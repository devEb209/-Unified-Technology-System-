-- ARKHER SYSTEM O.0306 :: Notification Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0306"
	S.key = "arkher.audio.notification.streaming"
	S.name = "Notification Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Notification"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.notification.voice_budget" }
	S.tags = { "o", "notification", "streamer", "audio" }
	S.description = "Notification Streaming: distance-driven residency of audio assets for the Notification subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.notification.streaming", radius = 320, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
