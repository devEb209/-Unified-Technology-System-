-- ARKHER SYSTEM VD.0018 :: Region Tile Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0018"
	S.key = "arkher.contsim.regiontile.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.regiontile.persistent_state" }
	S.tags = { "vd", "regiontile", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.regiontile.coherence_guard", window = 133, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
