-- ARKHER SYSTEM V.0136 :: Icon Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0136"
	S.key = "arkher.asset.iconasset.asset_registry"
	S.name = "Icon Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.iconasset.cook_pipeline" }
	S.tags = { "v", "iconasset", "registry", "asset" }
	S.description = "Icon Asset Registry: catalogue of every asset, its tags and its metadata for the Icon subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.iconasset.asset_registry" })
		inst.system = S
		inst.ctx = ctx
