-- ARKHER SYSTEM Q.0054 :: Icon Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0054"
	S.key = "arkher.ui.icon.theme_composition"
	S.name = "Icon Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Icon"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.icon.navigation_graph" }
	S.tags = { "q", "icon", "composer", "ui" }
	S.description = "Icon Theme Composition: blending of theme signals into the final appearance for the Icon subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.icon.theme_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
