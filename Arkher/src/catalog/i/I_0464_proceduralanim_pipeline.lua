-- ARKHER SYSTEM I.0464 :: Procedural Animation Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0464"
	S.key = "arkher.anim.proceduralanim.playback_pipeline"
	S.name = "Procedural Animation Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.proceduralanim.event_ledger" }
	S.tags = { "i", "proceduralanim", "pipeline", "anim" }
	S.description = "Procedural Animation Playback Pipeline: ordered sample, blend, ik and output stages for the Procedural Animation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.proceduralanim.playback_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
