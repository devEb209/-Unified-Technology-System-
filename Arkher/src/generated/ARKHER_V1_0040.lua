...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Physics Chaos — CORE Stack #0040", size=Vector2.new(640, 420), pos=UDim2.fromOffset(220, 240), parent=parent, icon="🎬"})
