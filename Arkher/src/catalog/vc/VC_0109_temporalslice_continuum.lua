-- ARKHER SYSTEM VC.0109 :: Temporal Slice Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0109"
	S.key = "arkher.contneural.temporalslice.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "temporalslice", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.temporalslice.infinite_grid", cellSize = 128, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
