-- ARKHER SYSTEM G.0288 :: Perceptual Metric Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0288"
	S.key = "arkher.neural.perceptual.compute_budget"
	S.name = "Perceptual Metric Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perceptual.quality_predictor" }
	S.tags = { "g", "perceptual", "budgeter", "neural" }
	S.description = "Perceptual Metric Compute Budget: inference time budget allocation for the Perceptual Metric subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.perceptual.compute_budget", total = 162, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
