-- ARKHER SYSTEM VA.0125 :: Spatial Slice Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0125"
	S.key = "arkher.contworld.spatialslice.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.spatialslice.multi-scale_fidelity" }
	S.tags = { "va", "spatialslice", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.spatialslice.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
