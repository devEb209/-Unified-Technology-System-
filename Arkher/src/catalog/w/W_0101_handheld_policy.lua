-- ARKHER SYSTEM W.0101 :: Handheld Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0101"
	S.key = "arkher.cine.handheld.cut_policy"
	S.name = "Handheld Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Handheld"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.handheld.shot_composition" }
	S.tags = { "w", "handheld", "policy", "cine" }
	S.description = "Handheld Cut Policy: rules deciding when the sequence cuts and to what for the Handheld subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.handheld.cut_policy", algorithm = "edf", starvationGuard = 57 })
		inst.system = S
		inst.ctx = ctx
