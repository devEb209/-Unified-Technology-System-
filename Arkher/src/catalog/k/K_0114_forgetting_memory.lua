-- ARKHER SYSTEM K.0114 :: Forgetting Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0114"
	S.key = "arkher.npc.forgetting.memory"
	S.name = "Forgetting Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.forgetting.mind_network" }
	S.tags = { "k", "forgetting", "memory", "npc" }
	S.description = "Forgetting Memory: episodic memory with decay, recall and consolidation for the Forgetting subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.forgetting.memory", capacity = 61, decayRate = 0.035, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
