-- ARKHER SYSTEM VD.0390 :: Memory Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0390"
	S.key = "arkher.contsim.memorycont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memorycont.persistent_state" }
	S.tags = { "vd", "memorycont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.memorycont.coherence_guard", window = 104, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
