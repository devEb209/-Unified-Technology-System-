-- ARKHER SYSTEM VC.0313 :: Ecology Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0313"
	S.key = "arkher.contneural.ecologycont.infinite_grid"
	S.name = "Ecology Continuum Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "ecologycont", "continuum", "contneural" }
	S.description = "Ecology Continuum Infinite Grid: seamless paging of the infinite world grid for the Ecology Continuum subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.ecologycont.infinite_grid", cellSize = 192, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
