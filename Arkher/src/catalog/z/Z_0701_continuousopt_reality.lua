-- ARKHER SYSTEM Z.0701 :: Continuous Self Optimization Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0701"
	S.key = "arkher.origin.continuousopt.reality_layering"
	S.name = "Continuous Self Optimization Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "continuousopt", "reality", "origin" }
	S.description = "Continuous Self Optimization Reality Layering: stacked authored, simulated, proposed and player realities for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.continuousopt.reality_layering" })
		inst.system = S
		inst.ctx = ctx
