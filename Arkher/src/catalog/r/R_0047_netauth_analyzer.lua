-- ARKHER SYSTEM R.0047 :: Authentication Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0047"
	S.key = "arkher.net.netauth.latency_analysis"
	S.name = "Authentication Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netauth.audit_ledger" }
	S.tags = { "r", "netauth", "analyzer", "net" }
	S.description = "Authentication Latency Analysis: round trip, jitter and loss analysis for the Authentication subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.netauth.latency_analysis", window = 67, buckets = 19, threshold = 4.90 })
		inst.system = S
		inst.ctx = ctx
