-- ARKHER SYSTEM W.0194 :: Action Scene Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0194"
	S.key = "arkher.cine.actionscene.camera_rig"
	S.name = "Action Scene Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Action Scene"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.actionscene.sequence_timeline" }
	S.tags = { "w", "actionscene", "camerarig", "cine" }
	S.description = "Action Scene Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Action Scene subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.actionscene.camera_rig", fov = 1.11, focus = 15.0, aperture = 5.9, smoothing = 7.0, distance = 17, height = 5 })
		inst.system = S
		inst.ctx = ctx
