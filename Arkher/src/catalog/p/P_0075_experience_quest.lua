-- ARKHER SYSTEM P.0075 :: Experience Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0075"
	S.key = "arkher.play.experience.objectives"
	S.name = "Experience Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Experience"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.experience.inventory" }
	S.tags = { "p", "experience", "quest", "play" }
	S.description = "Experience Objectives: objectives, prerequisites, progress and rewards for the Experience subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.experience.objectives" })
		inst.system = S
		inst.ctx = ctx
