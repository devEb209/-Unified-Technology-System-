-- ARKHER SYSTEM T.0300 :: Difficulty Tuning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0300"
	S.key = "arkher.ai.difficultytuning.reasoning_graph"
	S.name = "Difficulty Tuning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.difficultytuning.world_architect" }
	S.tags = { "t", "difficultytuning", "graph", "ai" }
	S.description = "Difficulty Tuning Reasoning Graph: relationship modelling and shortest-path reasoning for the Difficulty Tuning subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.difficultytuning.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
