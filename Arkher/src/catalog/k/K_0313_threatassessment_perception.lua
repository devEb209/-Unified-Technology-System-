-- ARKHER SYSTEM K.0313 :: Threat Assessment Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0313"
	S.key = "arkher.npc.threatassessment.perception"
	S.name = "Threat Assessment Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.threatassessment.emotion" }
	S.tags = { "k", "threatassessment", "perception", "npc" }
	S.description = "Threat Assessment Perception: sight, hearing and bounded attention for the Threat Assessment subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.threatassessment.perception", sightRange = 45, hearingRange = 28, attentionSlots = 3, fov = 1.800 })
		inst.system = S
		inst.ctx = ctx
