-- ARKHER SYSTEM I.0016 :: Bone Hierarchy Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0016"
	S.key = "arkher.anim.bonehierarchy.layered_blending"
	S.name = "Bone Hierarchy Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonehierarchy.clip_sampling" }
	S.tags = { "i", "bonehierarchy", "animator", "anim" }
	S.description = "Bone Hierarchy Layered Blending: layers, crossfades, masks and blend trees for the Bone Hierarchy subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.bonehierarchy.layered_blending", budget = 9 })
		inst.system = S
		inst.ctx = ctx
