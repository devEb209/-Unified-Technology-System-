-- ARKHER SYSTEM T.0011 :: Intent Parsing Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0011"
	S.key = "arkher.ai.intentparsing.action_planner"
	S.name = "Intent Parsing Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.intentparsing.utility_selection" }
	S.tags = { "t", "intentparsing", "planner", "ai" }
	S.description = "Intent Parsing Action Planner: goal-oriented action planning over preconditions for the Intent Parsing subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.intentparsing.action_planner", maxDepth = 10 })
		inst.system = S
		inst.ctx = ctx
