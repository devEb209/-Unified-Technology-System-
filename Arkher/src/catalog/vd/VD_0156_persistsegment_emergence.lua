-- ARKHER SYSTEM VD.0156 :: Persistence Segment Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0156"
	S.key = "arkher.contsim.persistsegment.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.persistsegment.reality_continuum" }
	S.tags = { "vd", "persistsegment", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.persistsegment.emergence_continuum", windowSize = 7, threshold = 1.60, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
