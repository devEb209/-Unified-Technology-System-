-- ARKHER SYSTEM Z.0720 :: Continuous Self Optimization Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0720"
	S.key = "arkher.origin.continuousopt.orchestration"
	S.name = "Continuous Self Optimization Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.residency_streaming" }
	S.tags = { "z", "continuousopt", "orchestrator", "origin" }
	S.description = "Continuous Self Optimization Orchestration: lifecycle and phase orchestration of the technology for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.continuousopt.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
