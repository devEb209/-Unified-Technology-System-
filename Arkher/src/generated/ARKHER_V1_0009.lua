--!strict
-- Houdini — ANIMATION Profiler #0009
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Houdini — ANIMATION Profiler #0009", size=Vector2.new(600, 500), pos=UDim2.fromOffset(217, 233), parent=parent, icon="🛰"})
...
Components.TextField(right, "File", "input.png", function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_File"..9, v) end end)
