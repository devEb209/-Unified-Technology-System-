-- ARKHER SYSTEM G.0232 :: Animation Compression Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0232"
	S.key = "arkher.neural.animcompress.compute_budget"
	S.name = "Animation Compression Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.animcompress.quality_predictor" }
	S.tags = { "g", "animcompress", "budgeter", "neural" }
	S.description = "Animation Compression Compute Budget: inference time budget allocation for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.animcompress.compute_budget", total = 418, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
