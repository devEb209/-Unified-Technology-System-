-- ARKHER SYSTEM G.0103 :: Adaptive Sharpening Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0103"
	S.key = "arkher.neural.adaptivesharpen.model_registry"
	S.name = "Adaptive Sharpening Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.adaptivesharpen.reconstruction" }
	S.tags = { "g", "adaptivesharpen", "registry", "neural" }
	S.description = "Adaptive Sharpening Model Registry: named models and their lifecycle for the Adaptive Sharpening subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.adaptivesharpen.model_registry" })
		inst.system = S
		inst.ctx = ctx
