-- ARKHER SYSTEM K.0579 :: Idle Behaviour Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0579"
	S.key = "arkher.npc.idlebehaviour.perception"
	S.name = "Idle Behaviour Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.idlebehaviour.emotion" }
	S.tags = { "k", "idlebehaviour", "perception", "npc" }
	S.description = "Idle Behaviour Perception: sight, hearing and bounded attention for the Idle Behaviour subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.idlebehaviour.perception", sightRange = 30, hearingRange = 32, attentionSlots = 4, fov = 1.930 })
		inst.system = S
		inst.ctx = ctx
