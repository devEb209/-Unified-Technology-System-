-- ARKHER SYSTEM T.0521 :: Audio Reasoning Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0521"
	S.key = "arkher.ai.audioreasoning.plan_workflow"
	S.name = "Audio Reasoning Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.audioreasoning.semantic_knowledge" }
	S.tags = { "t", "audioreasoning", "workflow", "ai" }
	S.description = "Audio Reasoning Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Audio Reasoning subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.audioreasoning.plan_workflow", maxRetries = 2, budget = 50 })
		inst.system = S
		inst.ctx = ctx
