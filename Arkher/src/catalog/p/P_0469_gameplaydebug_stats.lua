-- ARKHER SYSTEM P.0469 :: Gameplay Debug Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0469"
	S.key = "arkher.play.gameplaydebug.attributes"
	S.name = "Gameplay Debug Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "gameplaydebug", "stats", "play" }
	S.description = "Gameplay Debug Attributes: base values, layered modifiers and derived statistics for the Gameplay Debug subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.gameplaydebug.attributes" })
		inst.system = S
		inst.ctx = ctx
