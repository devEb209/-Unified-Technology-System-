-- ARKHER SYSTEM L.0175 :: Livestock Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0175"
	S.key = "arkher.sim.livestock.streaming"
	S.name = "Livestock Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livestock.state_codec" }
	S.tags = { "l", "livestock", "streamer", "sim" }
	S.description = "Livestock Streaming: distance-driven residency of simulated regions for the Livestock subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.livestock.streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
