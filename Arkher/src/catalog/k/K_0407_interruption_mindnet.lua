-- ARKHER SYSTEM K.0407 :: Interruption Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0407"
	S.key = "arkher.npc.interruption.mind_network"
	S.name = "Interruption Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "interruption", "mindnet", "npc" }
	S.description = "Interruption Mind Network: the learned policy that turns perception into a decision for the Interruption subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.interruption.mind_network", inputs = 8, hidden = 4, seed = 34150, learningRate = 0.050, exploration = 0.050 })
		inst.system = S
		inst.ctx = ctx
