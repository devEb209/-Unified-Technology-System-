-- ARKHER SYSTEM O.0278 :: Transition Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0278"
	S.key = "arkher.audio.audiotransition.mixer_bus"
	S.name = "Transition Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Transition"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiotransition.dsp_chain" }
	S.tags = { "o", "audiotransition", "mixer", "audio" }
	S.description = "Transition Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Transition subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.audiotransition.mixer_bus", maxVoices = 40 })
		inst.system = S
		inst.ctx = ctx
