-- ARKHER SYSTEM J.0053 :: Hair Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0053"
	S.key = "arkher.character.hair.budget_governor"
	S.name = "Hair Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.hair.variant_registry" }
	S.tags = { "j", "hair", "budgeter", "character" }
	S.description = "Hair Budget Governor: per-character cost allocation in a crowd for the Hair subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.hair.budget_governor", total = 296, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
