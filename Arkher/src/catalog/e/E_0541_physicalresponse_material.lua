-- ARKHER SYSTEM E.0541 :: Physical Response Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0541"
	S.key = "arkher.material.physicalresponse.definition"
	S.name = "Physical Response Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "physicalresponse", "material", "material" }
	S.description = "Physical Response Definition: layered PBR definition resolved into parameters for the Physical Response subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.physicalresponse.definition", texelBudget = 1310720 })
		inst.system = S
		inst.ctx = ctx
