-- ARKHER SYSTEM H.0043 :: Mass Properties Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0043"
	S.key = "arkher.physics.massproperties.body_dynamics"
	S.name = "Mass Properties Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "massproperties", "rigidbody", "physics" }
	S.description = "Mass Properties Body Dynamics: integration, impulses, damping and sleeping of a body for the Mass Properties subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.massproperties.body_dynamics", mass = 21.00, radius = 0.30, restitution = 0.40, friction = 0.70, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
