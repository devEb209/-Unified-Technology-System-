-- ARKHER SYSTEM E.0136 :: Opacity Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0136"
	S.key = "arkher.material.opacity.definition"
	S.name = "Opacity Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Opacity"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "opacity", "material", "material" }
	S.description = "Opacity Definition: layered PBR definition resolved into parameters for the Opacity subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.opacity.definition", texelBudget = 1048576 })
		inst.system = S
		inst.ctx = ctx
