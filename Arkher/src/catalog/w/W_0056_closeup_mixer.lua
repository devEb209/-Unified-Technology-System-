-- ARKHER SYSTEM W.0056 :: Close Up Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0056"
	S.key = "arkher.cine.closeup.cinematic_mix"
	S.name = "Close Up Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Close Up"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.closeup.motion_tween" }
	S.tags = { "w", "closeup", "mixer", "cine" }
	S.description = "Close Up Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Close Up subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.closeup.cinematic_mix", maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
