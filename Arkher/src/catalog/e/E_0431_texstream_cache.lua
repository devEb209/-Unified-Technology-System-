-- ARKHER SYSTEM E.0431 :: Texture Streaming Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0431"
	S.key = "arkher.material.texstream.instance_cache"
	S.name = "Texture Streaming Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.texstream.quality_policy" }
	S.tags = { "e", "texstream", "cache", "material" }
	S.description = "Texture Streaming Instance Cache: resolved-parameter cache keyed by context for the Texture Streaming subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.texstream.instance_cache", policy = "ttl", capacity = 427, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
