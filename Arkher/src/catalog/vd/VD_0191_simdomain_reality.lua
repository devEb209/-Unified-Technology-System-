-- ARKHER SYSTEM VD.0191 :: Simulation Domain Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0191"
	S.key = "arkher.contsim.simdomain.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.simdomain.simulation_fabric" }
	S.tags = { "vd", "simdomain", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.simdomain.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
