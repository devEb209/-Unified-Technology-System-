-- ARKHER SYSTEM W.0205 :: Montage Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0205"
	S.key = "arkher.cine.montage.sequence_timeline"
	S.name = "Montage Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Montage"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "montage", "timeline", "cine" }
	S.description = "Montage Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Montage subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.montage.sequence_timeline", duration = 6.0, rate = 1.06 })
		inst.system = S
		inst.ctx = ctx
