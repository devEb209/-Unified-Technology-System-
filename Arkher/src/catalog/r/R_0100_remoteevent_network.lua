-- ARKHER SYSTEM R.0100 :: Remote Event Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0100"
	S.key = "arkher.net.remoteevent.transport_graph"
	S.name = "Remote Event Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Remote Event"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remoteevent.prediction_and_reconciliation" }
	S.tags = { "r", "remoteevent", "network", "net" }
	S.description = "Remote Event Transport Graph: topology, capacity and routing between endpoints for the Remote Event subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.remoteevent.transport_graph" })
		inst.system = S
		inst.ctx = ctx
