-- ARKHER SYSTEM I.0215 :: Transition Rule Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0215"
	S.key = "arkher.anim.transitionrule.compression_codec"
	S.name = "Transition Rule Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.transitionrule.retarget_graph" }
	S.tags = { "i", "transitionrule", "codec", "anim" }
	S.description = "Transition Rule Compression Codec: curve compression and quantized transport for the Transition Rule subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.transitionrule.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
