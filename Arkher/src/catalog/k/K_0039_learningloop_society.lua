-- ARKHER SYSTEM K.0039 :: Learning Loop Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0039"
	S.key = "arkher.npc.learningloop.social_relations"
	S.name = "Learning Loop Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.learningloop.crowd_steering" }
	S.tags = { "k", "learningloop", "society", "npc" }
	S.description = "Learning Loop Social Relations: affinity, factions, reputation and gossip for the Learning Loop subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.learningloop.social_relations", decayRate = 0.012, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
