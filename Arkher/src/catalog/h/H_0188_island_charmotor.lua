-- ARKHER SYSTEM H.0188 :: Island Solver Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0188"
	S.key = "arkher.physics.island.character_motion"
	S.name = "Island Solver Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.island.query" }
	S.tags = { "h", "island", "charmotor", "physics" }
	S.description = "Island Solver Character Motion: capsule move-and-slide with slopes, steps and jumps for the Island Solver subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.island.character_motion", radius = 0.36, height = 1.61, maxSpeed = 8.10, jumpHeight = 1.70, stepOffset = 0.36 })
		inst.system = S
		inst.ctx = ctx
