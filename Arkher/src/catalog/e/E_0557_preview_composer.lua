-- ARKHER SYSTEM E.0557 :: Material Preview Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0557"
	S.key = "arkher.material.preview.layer_composition"
	S.name = "Material Preview Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.preview.definition" }
	S.tags = { "e", "preview", "composer", "material" }
	S.description = "Material Preview Layer Composition: ordered layer composition with blend rules for the Material Preview subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.preview.layer_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
