-- ARKHER SYSTEM R.0093 :: Property Replication Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0093"
	S.key = "arkher.net.propertyreplication.session_registry"
	S.name = "Property Replication Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.propertyreplication.rate_guard" }
	S.tags = { "r", "propertyreplication", "registry", "net" }
	S.description = "Property Replication Session Registry: catalogue of sessions, players and their metadata for the Property Replication subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.propertyreplication.session_registry" })
		inst.system = S
		inst.ctx = ctx
