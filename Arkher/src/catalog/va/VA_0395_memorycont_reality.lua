-- ARKHER SYSTEM VA.0395 :: Memory Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0395"
	S.key = "arkher.contworld.memorycont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memorycont.simulation_fabric" }
	S.tags = { "va", "memorycont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.memorycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
