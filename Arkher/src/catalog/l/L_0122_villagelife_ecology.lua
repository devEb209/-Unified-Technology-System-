-- ARKHER SYSTEM L.0122 :: Village Life Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0122"
	S.key = "arkher.sim.villagelife.ecology"
	S.name = "Village Life Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.villagelife.simulation_core" }
	S.tags = { "l", "villagelife", "ecology", "sim" }
	S.description = "Village Life Ecology: populations, predation, harvesting and carrying capacity for the Village Life subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.villagelife.ecology" })
		inst.system = S
		inst.ctx = ctx
