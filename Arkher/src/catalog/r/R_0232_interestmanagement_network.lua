-- ARKHER SYSTEM R.0232 :: Interest Management Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0232"
	S.key = "arkher.net.interestmanagement.transport_graph"
	S.name = "Interest Management Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.interestmanagement.prediction_and_reconciliation" }
	S.tags = { "r", "interestmanagement", "network", "net" }
	S.description = "Interest Management Transport Graph: topology, capacity and routing between endpoints for the Interest Management subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.interestmanagement.transport_graph" })
		inst.system = S
		inst.ctx = ctx
