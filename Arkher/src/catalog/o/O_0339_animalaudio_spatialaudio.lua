-- ARKHER SYSTEM O.0339 :: Animal Audio Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0339"
	S.key = "arkher.audio.animalaudio.spatialization"
	S.name = "Animal Audio Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Animal Audio"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.animalaudio.mixer_bus" }
	S.tags = { "o", "animalaudio", "spatialaudio", "audio" }
	S.description = "Animal Audio Spatialization: distance attenuation, panning, occlusion and doppler for the Animal Audio subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.animalaudio.spatialization", model = "exponential", refDistance = 8, maxDistance = 140, rolloff = 0.83, maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
