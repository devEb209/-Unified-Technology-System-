-- ARKHER SYSTEM Z.0065 :: Reality Layer World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0065"
	S.key = "arkher.origin.realitylayer.world_memory"
	S.name = "Reality Layer World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.autonomous_pipeline" }
	S.tags = { "z", "realitylayer", "worldmemory", "origin" }
	S.description = "Reality Layer World Memory: epoch-stamped persistent history with compaction and checkpoints for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.realitylayer.world_memory", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
