-- ARKHER SYSTEM T.0633 :: Confidence Estimation Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0633"
	S.key = "arkher.ai.confidence.plan_workflow"
	S.name = "Confidence Estimation Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.confidence.semantic_knowledge" }
	S.tags = { "t", "confidence", "workflow", "ai" }
	S.description = "Confidence Estimation Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Confidence Estimation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.confidence.plan_workflow", maxRetries = 1, budget = 130 })
		inst.system = S
		inst.ctx = ctx
