-- ARKHER SYSTEM K.0609 :: Faction Membership Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0609"
	S.key = "arkher.npc.factionmembership.utility_reasoning"
	S.name = "Faction Membership Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.factionmembership.reactive_behaviour" }
	S.tags = { "k", "factionmembership", "utility", "npc" }
	S.description = "Faction Membership Utility Reasoning: scored option selection with response curves for the Faction Membership subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.factionmembership.utility_reasoning", momentum = 0.01 })
		inst.system = S
		inst.ctx = ctx
