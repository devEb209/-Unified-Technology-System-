-- ARKHER SYSTEM E.0337 :: Rust Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0337"
	S.key = "arkher.material.rust.parameter_budget"
	S.name = "Rust Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Rust"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.rust.variant_registry" }
	S.tags = { "e", "rust", "budgeter", "material" }
	S.description = "Rust Parameter Budget: texel and layer budget allocation for the Rust subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.rust.parameter_budget", total = 336, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
