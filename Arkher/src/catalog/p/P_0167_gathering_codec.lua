-- ARKHER SYSTEM P.0167 :: Gathering Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0167"
	S.key = "arkher.play.gathering.save_codec"
	S.name = "Gathering Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Gathering"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.gathering.content_registry" }
	S.tags = { "p", "gathering", "codec", "play" }
	S.description = "Gathering Save Codec: persistence, diffing and checksum of gameplay state for the Gathering subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.gathering.save_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
