-- ARKHER SYSTEM O.0230 :: Adaptive Music Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0230"
	S.key = "arkher.audio.adaptivemusic.mixer_bus"
	S.name = "Adaptive Music Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.adaptivemusic.dsp_chain" }
	S.tags = { "o", "adaptivemusic", "mixer", "audio" }
	S.description = "Adaptive Music Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Adaptive Music subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.adaptivemusic.mixer_bus", maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
