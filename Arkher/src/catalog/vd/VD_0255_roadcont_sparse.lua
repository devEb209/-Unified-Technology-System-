-- ARKHER SYSTEM VD.0255 :: Road Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0255"
	S.key = "arkher.contsim.roadcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.roadcont.epoch_clock" }
	S.tags = { "vd", "roadcont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.roadcont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
