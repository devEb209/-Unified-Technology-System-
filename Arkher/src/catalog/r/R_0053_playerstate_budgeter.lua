-- ARKHER SYSTEM R.0053 :: Player State Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0053"
	S.key = "arkher.net.playerstate.bandwidth_budget"
	S.name = "Player State Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Player State"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.playerstate.transport_graph" }
	S.tags = { "r", "playerstate", "budgeter", "net" }
	S.description = "Player State Bandwidth Budget: bytes per second shared between competing streams for the Player State subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.playerstate.bandwidth_budget", total = 150, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
