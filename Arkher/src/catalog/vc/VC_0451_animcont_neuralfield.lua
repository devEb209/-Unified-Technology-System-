-- ARKHER SYSTEM VC.0451 :: Animation Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0451"
	S.key = "arkher.contneural.animcont.neural_field"
	S.name = "Animation Continuum Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.animcont.coherence_guard" }
	S.tags = { "vc", "animcont", "neuralfield", "contneural" }
	S.description = "Animation Continuum Neural Field: neural field encoding and reconstruction for the Animation Continuum subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.animcont.neural_field", dims = 12, hidden = 8, seed = 95464 })
		inst.system = S
		inst.ctx = ctx
