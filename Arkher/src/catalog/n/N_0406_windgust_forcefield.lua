-- ARKHER SYSTEM N.0406 :: Wind Gust Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0406"
	S.key = "arkher.vfx.windgust.force_field"
	S.name = "Wind Gust Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Wind Gust"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.windgust.particle_simulation" }
	S.tags = { "n", "windgust", "forcefield", "vfx" }
	S.description = "Wind Gust Force Field: wind, attraction, vortex, drag and curl turbulence for the Wind Gust subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.windgust.force_field", seed = 30955 })
		inst.system = S
		inst.ctx = ctx
