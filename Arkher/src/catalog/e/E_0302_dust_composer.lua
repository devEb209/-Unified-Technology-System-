-- ARKHER SYSTEM E.0302 :: Dust Accumulation Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0302"
	S.key = "arkher.material.dust.layer_composition"
	S.name = "Dust Accumulation Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.dust.definition" }
	S.tags = { "e", "dust", "composer", "material" }
	S.description = "Dust Accumulation Layer Composition: ordered layer composition with blend rules for the Dust Accumulation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.dust.layer_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
