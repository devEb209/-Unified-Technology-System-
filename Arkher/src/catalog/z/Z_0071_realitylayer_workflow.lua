-- ARKHER SYSTEM Z.0071 :: Reality Layer Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0071"
	S.key = "arkher.origin.realitylayer.adaptive_workflow"
	S.name = "Reality Layer Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.self_critique" }
	S.tags = { "z", "realitylayer", "workflow", "origin" }
	S.description = "Reality Layer Adaptive Workflow: verified, retryable, reversible execution plans for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.realitylayer.adaptive_workflow", maxRetries = 2, budget = 50 })
		inst.system = S
		inst.ctx = ctx
