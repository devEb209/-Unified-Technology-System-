-- ARKHER SYSTEM F.0374 :: Render Scale Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0374"
	S.key = "arkher.render.renderscale.render_policy"
	S.name = "Render Scale Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Render Scale"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.renderscale.draw_budget" }
	S.tags = { "f", "renderscale", "policy", "render" }
	S.description = "Render Scale Render Policy: device tier rules for the frame for the Render Scale subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.renderscale.render_policy", algorithm = "wfq", starvationGuard = 26 })
		inst.system = S
		inst.ctx = ctx
