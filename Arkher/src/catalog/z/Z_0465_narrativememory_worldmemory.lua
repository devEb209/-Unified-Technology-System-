-- ARKHER SYSTEM Z.0465 :: Narrative Memory World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0465"
	S.key = "arkher.origin.narrativememory.world_memory"
	S.name = "Narrative Memory World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.autonomous_pipeline" }
	S.tags = { "z", "narrativememory", "worldmemory", "origin" }
	S.description = "Narrative Memory World Memory: epoch-stamped persistent history with compaction and checkpoints for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.narrativememory.world_memory", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
