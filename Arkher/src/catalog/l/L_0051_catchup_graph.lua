-- ARKHER SYSTEM L.0051 :: Catch Up Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0051"
	S.key = "arkher.sim.catchup.region_graph"
	S.name = "Catch Up Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.catchup.calendar" }
	S.tags = { "l", "catchup", "graph", "sim" }
	S.description = "Catch Up Region Graph: connectivity, components and shortest path between places for the Catch Up subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.catchup.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
