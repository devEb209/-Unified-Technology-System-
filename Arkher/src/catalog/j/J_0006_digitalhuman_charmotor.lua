-- ARKHER SYSTEM J.0006 :: Digital Human Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0006"
	S.key = "arkher.character.digitalhuman.locomotion"
	S.name = "Digital Human Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.digitalhuman.physical_response" }
	S.tags = { "j", "digitalhuman", "charmotor", "character" }
	S.description = "Digital Human Locomotion: capsule locomotion driving the character for the Digital Human subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.digitalhuman.locomotion", radius = 0.45, height = 1.70, maxSpeed = 7.00, jumpHeight = 1.80, stepOffset = 0.25 })
		inst.system = S
		inst.ctx = ctx
