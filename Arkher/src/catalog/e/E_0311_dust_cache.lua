-- ARKHER SYSTEM E.0311 :: Dust Accumulation Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0311"
	S.key = "arkher.material.dust.instance_cache"
	S.name = "Dust Accumulation Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.dust.quality_policy" }
	S.tags = { "e", "dust", "cache", "material" }
	S.description = "Dust Accumulation Instance Cache: resolved-parameter cache keyed by context for the Dust Accumulation subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.dust.instance_cache", policy = "ttl", capacity = 151, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
