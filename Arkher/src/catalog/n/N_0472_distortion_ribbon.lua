-- ARKHER SYSTEM N.0472 :: Distortion Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0472"
	S.key = "arkher.vfx.distortion.ribbon_and_trail"
	S.name = "Distortion Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Distortion"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.distortion.force_field" }
	S.tags = { "n", "distortion", "ribbon", "vfx" }
	S.description = "Distortion Ribbon And Trail: trail points, tapering, beams and decimation for the Distortion subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.distortion.ribbon_and_trail", maxPoints = 16, lifetime = 1.70, minDistance = 0.20, width = 0.20 })
		inst.system = S
		inst.ctx = ctx
