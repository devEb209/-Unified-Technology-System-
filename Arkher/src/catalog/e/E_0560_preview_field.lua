-- ARKHER SYSTEM E.0560 :: Material Preview Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0560"
	S.key = "arkher.material.preview.procedural_detail"
	S.name = "Material Preview Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.preview.texture_sampling" }
	S.tags = { "e", "preview", "field", "material" }
	S.description = "Material Preview Procedural Detail: coherent noise detail driving the surface for the Material Preview subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.preview.procedural_detail", seed = 65539, frequency = 0.0088, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
