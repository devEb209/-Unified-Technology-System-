-- ARKHER SYSTEM K.0132 :: Hunger Drive Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0132"
	S.key = "arkher.npc.hungerdrive.reactive_behaviour"
	S.name = "Hunger Drive Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hungerdrive.perception" }
	S.tags = { "k", "hungerdrive", "behaviortree", "npc" }
	S.description = "Hunger Drive Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Hunger Drive subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.hungerdrive.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
