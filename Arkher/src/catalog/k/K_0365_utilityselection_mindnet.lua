-- ARKHER SYSTEM K.0365 :: Utility Selection Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0365"
	S.key = "arkher.npc.utilityselection.mind_network"
	S.name = "Utility Selection Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "utilityselection", "mindnet", "npc" }
	S.description = "Utility Selection Mind Network: the learned policy that turns perception into a decision for the Utility Selection subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.utilityselection.mind_network", inputs = 8, hidden = 7, seed = 11198, learningRate = 0.090, exploration = 0.050 })
		inst.system = S
		inst.ctx = ctx
