-- ARKHER SYSTEM V.0368 :: Import Preset Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0368"
	S.key = "arkher.asset.importpreset.compression_codec"
	S.name = "Import Preset Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.importpreset.streaming_residency" }
	S.tags = { "v", "importpreset", "codec", "asset" }
	S.description = "Import Preset Compression Codec: compact encoding, diffing and checksum of asset payloads for the Import Preset subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.importpreset.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
