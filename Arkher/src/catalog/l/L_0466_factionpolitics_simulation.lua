-- ARKHER SYSTEM L.0466 :: Faction Politics Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0466"
	S.key = "arkher.sim.factionpolitics.simulation_core"
	S.name = "Faction Politics Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "factionpolitics", "simulation", "sim" }
	S.description = "Faction Politics Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Faction Politics subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.factionpolitics.simulation_core", fullRadius = 120, reducedRadius = 1200, budget = 62 })
		inst.system = S
		inst.ctx = ctx
