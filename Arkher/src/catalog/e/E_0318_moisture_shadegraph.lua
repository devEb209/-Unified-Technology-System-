-- ARKHER SYSTEM E.0318 :: Moisture Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0318"
	S.key = "arkher.material.moisture.shading_graph"
	S.name = "Moisture Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Moisture"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.moisture.layer_composition" }
	S.tags = { "e", "moisture", "shadegraph", "material" }
	S.description = "Moisture Shading Graph: node graph evaluated and compiled to Luau for the Moisture subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.moisture.shading_graph" })
		inst.system = S
		inst.ctx = ctx
