-- ARKHER SYSTEM L.0178 :: Livestock Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0178"
	S.key = "arkher.sim.livestock.analysis"
	S.name = "Livestock Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livestock.aggregate_cache" }
	S.tags = { "l", "livestock", "analyzer", "sim" }
	S.description = "Livestock Analysis: trend, anomaly and stability analysis of the world for the Livestock subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.livestock.analysis", window = 118, buckets = 18, threshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
