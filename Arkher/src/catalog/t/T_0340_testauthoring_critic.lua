-- ARKHER SYSTEM T.0340 :: Test Authoring Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0340"
	S.key = "arkher.ai.testauthoring.self_critique"
	S.name = "Test Authoring Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.testauthoring.plan_workflow" }
	S.tags = { "t", "testauthoring", "critic", "ai" }
	S.description = "Test Authoring Self Critique: weighted evaluation of the result against declared criteria for the Test Authoring subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.testauthoring.self_critique", passMark = 0.82, reviseMark = 0.47, seed = 79077 })
		inst.system = S
		inst.ctx = ctx
