-- ARKHER SYSTEM Z.0047 :: Singularity World Architect World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0047"
	S.key = "arkher.origin.worldarchitect.world_architect"
	S.name = "Singularity World Architect World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.emergence_detection" }
	S.tags = { "z", "worldarchitect", "architect", "origin" }
	S.description = "Singularity World Architect World Architect: hierarchical world composition with conserved budgets for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.worldarchitect.world_architect", budget = 1400, seed = 44948 })
		inst.system = S
		inst.ctx = ctx
