-- ARKHER SYSTEM VB.0359 :: Narrative Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0359"
	S.key = "arkher.conttime.narrativecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.narrativecont.simulation_fabric" }
	S.tags = { "vb", "narrativecont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.narrativecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
