-- ARKHER SYSTEM VD.0372 :: Quest Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0372"
	S.key = "arkher.contsim.questcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.questcont.reality_continuum" }
	S.tags = { "vd", "questcont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.questcont.emergence_continuum", windowSize = 7, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
