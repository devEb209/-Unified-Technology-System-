-- ARKHER SYSTEM T.0361 :: Documentation Writer Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0361"
	S.key = "arkher.ai.documentationwriter.action_planner"
	S.name = "Documentation Writer Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.documentationwriter.utility_selection" }
	S.tags = { "t", "documentationwriter", "planner", "ai" }
	S.description = "Documentation Writer Action Planner: goal-oriented action planning over preconditions for the Documentation Writer subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.documentationwriter.action_planner", maxDepth = 11 })
		inst.system = S
		inst.ctx = ctx
