-- ARKHER SYSTEM W.0319 :: Colour Look Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0319"
	S.key = "arkher.cine.colourlook.motion_tween"
	S.name = "Colour Look Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Colour Look"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.colourlook.playback_orchestrator" }
	S.tags = { "w", "colourlook", "tween", "cine" }
	S.description = "Colour Look Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Colour Look subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.colourlook.motion_tween", timeScale = 1.14 })
		inst.system = S
		inst.ctx = ctx
