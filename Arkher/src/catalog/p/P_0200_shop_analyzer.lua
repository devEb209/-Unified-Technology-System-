-- ARKHER SYSTEM P.0200 :: Shop Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0200"
	S.key = "arkher.play.shop.balance_analysis"
	S.name = "Shop Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Shop"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.shop.event_ledger" }
	S.tags = { "p", "shop", "analyzer", "play" }
	S.description = "Shop Balance Analysis: distribution, outlier and pacing analysis for the Shop subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.shop.balance_analysis", window = 247, buckets = 19, threshold = 4.90 })
		inst.system = S
		inst.ctx = ctx
