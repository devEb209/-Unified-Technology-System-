-- ARKHER SYSTEM L.0238 :: Weather Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0238"
	S.key = "arkher.sim.weather.analysis"
	S.name = "Weather Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.weather.aggregate_cache" }
	S.tags = { "l", "weather", "analyzer", "sim" }
	S.description = "Weather Analysis: trend, anomaly and stability analysis of the world for the Weather subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.weather.analysis", window = 193, buckets = 13, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
