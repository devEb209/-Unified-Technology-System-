-- ARKHER SYSTEM Q.0205 :: Compass Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0205"
	S.key = "arkher.ui.compass.responsive_layout"
	S.name = "Compass Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Compass"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "compass", "flex", "ui" }
	S.description = "Compass Responsive Layout: flex solving with safe areas, weights and breakpoints for the Compass subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.compass.responsive_layout", width = 450, height = 1084, scale = 0.99 })
		inst.system = S
		inst.ctx = ctx
