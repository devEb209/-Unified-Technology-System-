-- ARKHER SYSTEM E.0433 :: Texture Streaming Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0433"
	S.key = "arkher.material.texstream.authoring_pipeline"
	S.name = "Texture Streaming Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.texstream.analysis" }
	S.tags = { "e", "texstream", "pipeline", "material" }
	S.description = "Texture Streaming Authoring Pipeline: ordered authoring and bake stages for the Texture Streaming subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.texstream.authoring_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
