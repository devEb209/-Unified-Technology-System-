-- ARKHER SYSTEM K.0165 :: Safety Drive Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0165"
	S.key = "arkher.npc.safetydrive.social_relations"
	S.name = "Safety Drive Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.safetydrive.crowd_steering" }
	S.tags = { "k", "safetydrive", "society", "npc" }
	S.description = "Safety Drive Social Relations: affinity, factions, reputation and gossip for the Safety Drive subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.safetydrive.social_relations", decayRate = 0.011, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
