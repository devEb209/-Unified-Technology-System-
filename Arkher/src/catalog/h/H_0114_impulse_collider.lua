-- ARKHER SYSTEM H.0114 :: Impulse Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0114"
	S.key = "arkher.physics.impulse.collision_shape"
	S.name = "Impulse Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Impulse"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.impulse.body_dynamics" }
	S.tags = { "h", "impulse", "collider", "physics" }
	S.description = "Impulse Collision Shape: shape bounds, support mapping and closest points for the Impulse subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.impulse.collision_shape", shape = "capsule", radius = 2.40, height = 2.00, layer = "default" })
		inst.system = S
		inst.ctx = ctx
