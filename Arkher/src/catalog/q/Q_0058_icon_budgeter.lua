-- ARKHER SYSTEM Q.0058 :: Icon Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0058"
	S.key = "arkher.ui.icon.frame_budget"
	S.name = "Icon Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Icon"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.icon.accessibility_policy" }
	S.tags = { "q", "icon", "budgeter", "ui" }
	S.description = "Icon Frame Budget: per-frame layout and draw budget for the interface for the Icon subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.icon.frame_budget", total = 434, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
