-- ARKHER SYSTEM I.0152 :: Layer Mask Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0152"
	S.key = "arkher.anim.layermask.playback_pipeline"
	S.name = "Layer Mask Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Layer Mask"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.layermask.event_ledger" }
	S.tags = { "i", "layermask", "pipeline", "anim" }
	S.description = "Layer Mask Playback Pipeline: ordered sample, blend, ik and output stages for the Layer Mask subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.layermask.playback_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
