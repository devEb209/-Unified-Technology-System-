-- ARKHER SYSTEM K.0687 :: NPC Debug Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0687"
	S.key = "arkher.npc.npcdebug.mind_network"
	S.name = "NPC Debug Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "npcdebug", "mindnet", "npc" }
	S.description = "NPC Debug Mind Network: the learned policy that turns perception into a decision for the NPC Debug subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.npcdebug.mind_network", inputs = 9, hidden = 8, seed = 26959, learningRate = 0.095, exploration = 0.055 })
		inst.system = S
		inst.ctx = ctx
