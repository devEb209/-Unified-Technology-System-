-- ARKHER SYSTEM L.0424 :: Law Society
...
return function(A)
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.law.economy" }
	S.tags = { "l", "law", "society", "sim" }
	S.description = "Law Society: relations, factions, reputation and cohesion of the region for the Law subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.law.society", decayRate = 0.009, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
