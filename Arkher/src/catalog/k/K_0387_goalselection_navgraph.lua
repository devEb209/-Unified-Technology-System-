-- ARKHER SYSTEM K.0387 :: Goal Selection Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0387"
	S.key = "arkher.npc.goalselection.navigation"
	S.name = "Goal Selection Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.goalselection.goal_planner" }
	S.tags = { "k", "goalselection", "navgraph", "npc" }
	S.description = "Goal Selection Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Goal Selection subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.goalselection.navigation", width = 40, height = 40, cellSize = 4 })
		inst.system = S
		inst.ctx = ctx
