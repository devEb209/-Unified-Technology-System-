-- ARKHER SYSTEM H.0369 :: Collision Layer Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0369"
	S.key = "arkher.physics.collisionlayer.query"
	S.name = "Collision Layer Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionlayer.constraint_solver" }
	S.tags = { "h", "collisionlayer", "raycaster", "physics" }
	S.description = "Collision Layer Query: rays, sweeps and overlaps against the simulation for the Collision Layer subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.collisionlayer.query", cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
