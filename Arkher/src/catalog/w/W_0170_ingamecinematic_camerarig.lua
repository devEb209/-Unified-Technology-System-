-- ARKHER SYSTEM W.0170 :: In Game Cinematic Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0170"
	S.key = "arkher.cine.ingamecinematic.camera_rig"
	S.name = "In Game Cinematic Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.ingamecinematic.sequence_timeline" }
	S.tags = { "w", "ingamecinematic", "camerarig", "cine" }
	S.description = "In Game Cinematic Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the In Game Cinematic subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.ingamecinematic.camera_rig", fov = 1.12, focus = 14.0, aperture = 6.4, smoothing = 12.0, distance = 16, height = 6 })
		inst.system = S
		inst.ctx = ctx
