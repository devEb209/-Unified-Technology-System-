-- ARKHER SYSTEM VB.0113 :: Temporal Slice Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0113"
	S.key = "arkher.conttime.temporalslice.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.temporalslice.multi-scale_fidelity" }
	S.tags = { "vb", "temporalslice", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.temporalslice.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
