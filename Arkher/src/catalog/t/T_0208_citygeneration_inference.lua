-- ARKHER SYSTEM T.0208 :: City Generation Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0208"
	S.key = "arkher.ai.citygeneration.model_inference"
	S.name = "City Generation Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.citygeneration.action_planner" }
	S.tags = { "t", "citygeneration", "inference", "ai" }
	S.description = "City Generation Model Inference: quantized inference with batching and budget for the City Generation subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.citygeneration.model_inference", seed = 91637 })
		inst.system = S
		inst.ctx = ctx
