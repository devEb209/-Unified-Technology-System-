-- ARKHER SYSTEM VB.0471 :: VFX Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0471"
	S.key = "arkher.conttime.vfxcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vfxcont.epoch_clock" }
	S.tags = { "vb", "vfxcont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.vfxcont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
