-- ARKHER SYSTEM T.0491 :: Physics Reasoning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0491"
	S.key = "arkher.ai.physicsreasoning.intent_understanding"
	S.name = "Physics Reasoning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "physicsreasoning", "intent", "ai" }
	S.description = "Physics Reasoning Intent Understanding: natural language turned into an actionable, scored intent for the Physics Reasoning subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.physicsreasoning.intent_understanding", minConfidence = 0.33 })
		inst.system = S
		inst.ctx = ctx
