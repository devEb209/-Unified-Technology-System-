-- ARKHER SYSTEM VA.0454 :: Animation Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0454"
	S.key = "arkher.contworld.animcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.animcont.complexity_budget" }
	S.tags = { "va", "animcont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.animcont.simulation_fabric", budgetMs = 2.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
