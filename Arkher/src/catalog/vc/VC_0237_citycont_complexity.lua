-- ARKHER SYSTEM VC.0237 :: City Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0237"
	S.key = "arkher.contneural.citycont.complexity_budget"
	S.name = "City Continuum Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.citycont.world_memory_stream" }
	S.tags = { "vc", "citycont", "complexity", "contneural" }
	S.description = "City Continuum Complexity Budget: complexity budgeting for the continuum for the City Continuum subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.citycont.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
