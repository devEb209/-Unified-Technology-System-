-- ARKHER SYSTEM T.0212 :: Character Generation Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0212"
	S.key = "arkher.ai.charactergeneration.semantic_knowledge"
	S.name = "Character Generation Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.charactergeneration.intent_understanding" }
	S.tags = { "t", "charactergeneration", "knowledge", "ai" }
	S.description = "Character Generation Semantic Knowledge: typed entities, weighted relations and inferred closure for the Character Generation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.charactergeneration.semantic_knowledge", dims = 24 })
		inst.system = S
		inst.ctx = ctx
