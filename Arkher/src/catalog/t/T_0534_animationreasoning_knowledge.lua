-- ARKHER SYSTEM T.0534 :: Animation Reasoning Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0534"
	S.key = "arkher.ai.animationreasoning.semantic_knowledge"
	S.name = "Animation Reasoning Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.animationreasoning.intent_understanding" }
	S.tags = { "t", "animationreasoning", "knowledge", "ai" }
	S.description = "Animation Reasoning Semantic Knowledge: typed entities, weighted relations and inferred closure for the Animation Reasoning subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.animationreasoning.semantic_knowledge", dims = 16 })
		inst.system = S
		inst.ctx = ctx
