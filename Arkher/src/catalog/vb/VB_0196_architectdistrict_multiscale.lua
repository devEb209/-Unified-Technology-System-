-- ARKHER SYSTEM VB.0196 :: Architect District Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0196"
	S.key = "arkher.conttime.architectdistrict.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.architectdistrict.sparse_residency" }
	S.tags = { "vb", "architectdistrict", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.architectdistrict.multi-scale_fidelity", levels = 6, baseTriangles = 105000 })
		inst.system = S
		inst.ctx = ctx
