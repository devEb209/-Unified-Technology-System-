-- ARKHER SYSTEM VA.0547 :: World Fabric Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0547"
	S.key = "arkher.contworld.worldfabric.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldfabric.coherence_guard" }
	S.tags = { "va", "worldfabric", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.worldfabric.neural_field", dims = 12, hidden = 8, seed = 99768 })
		inst.system = S
		inst.ctx = ctx
