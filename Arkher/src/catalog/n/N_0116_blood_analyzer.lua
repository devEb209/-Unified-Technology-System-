-- ARKHER SYSTEM N.0116 :: Blood Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0116"
	S.key = "arkher.vfx.blood.analysis"
	S.name = "Blood Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Blood"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.blood.spatial_index" }
	S.tags = { "n", "blood", "analyzer", "vfx" }
	S.description = "Blood Analysis: cost, overdraw and stability analysis of the effect for the Blood subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.blood.analysis", window = 93, buckets = 9, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
