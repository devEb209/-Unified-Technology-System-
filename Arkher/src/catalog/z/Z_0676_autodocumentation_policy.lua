-- ARKHER SYSTEM Z.0676 :: Auto Documentation Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0676"
	S.key = "arkher.origin.autodocumentation.governance_policy"
	S.name = "Auto Documentation Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.signal_composition" }
	S.tags = { "z", "autodocumentation", "policy", "origin" }
	S.description = "Auto Documentation Governance Policy: ordered rules governing when the technology may act for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.autodocumentation.governance_policy", algorithm = "roundrobin", starvationGuard = 16 })
		inst.system = S
		inst.ctx = ctx
