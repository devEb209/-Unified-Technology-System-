-- ARKHER SYSTEM L.0546 :: Festival Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0546"
	S.key = "arkher.sim.festival.region_graph"
	S.name = "Festival Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.festival.calendar" }
	S.tags = { "l", "festival", "graph", "sim" }
	S.description = "Festival Region Graph: connectivity, components and shortest path between places for the Festival subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.festival.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
