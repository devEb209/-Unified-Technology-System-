-- ARKHER SYSTEM W.0278 :: Depth Of Field Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0278"
	S.key = "arkher.cine.depthoffield.camera_rig"
	S.name = "Depth Of Field Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.depthoffield.sequence_timeline" }
	S.tags = { "w", "depthoffield", "camerarig", "cine" }
	S.description = "Depth Of Field Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.depthoffield.camera_rig", fov = 1.04, focus = 8.0, aperture = 2.4, smoothing = 8.0, distance = 10, height = 4 })
		inst.system = S
		inst.ctx = ctx
