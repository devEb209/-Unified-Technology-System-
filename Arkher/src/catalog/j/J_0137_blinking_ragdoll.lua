-- ARKHER SYSTEM J.0137 :: Blinking Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0137"
	S.key = "arkher.character.blinking.physical_response"
	S.name = "Blinking Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.blinking.look_and_reach" }
	S.tags = { "j", "blinking", "ragdoll", "character" }
	S.description = "Blinking Physical Response: physical reaction, ragdoll and recovery for the Blinking subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.blinking.physical_response", blendSpeed = 5.30 })
		inst.system = S
		inst.ctx = ctx
