-- ARKHER SYSTEM J.0032 :: Body Proportions Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0032"
	S.key = "arkher.character.proportions.streaming"
	S.name = "Body Proportions Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.proportions.budget_governor" }
	S.tags = { "j", "proportions", "streamer", "character" }
	S.description = "Body Proportions Streaming: distance-driven residency of character data for the Body Proportions subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.proportions.streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
