-- ARKHER SYSTEM E.0103 :: Height Displacement Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0103"
	S.key = "arkher.material.displacement.authoring_pipeline"
	S.name = "Height Displacement Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.displacement.analysis" }
	S.tags = { "e", "displacement", "pipeline", "material" }
	S.description = "Height Displacement Authoring Pipeline: ordered authoring and bake stages for the Height Displacement subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.displacement.authoring_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
