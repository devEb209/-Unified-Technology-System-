-- ARKHER SYSTEM R.0263 :: Bandwidth Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0263"
	S.key = "arkher.net.bandwidth.latency_analysis"
	S.name = "Bandwidth Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Bandwidth"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.bandwidth.audit_ledger" }
	S.tags = { "r", "bandwidth", "analyzer", "net" }
	S.description = "Bandwidth Latency Analysis: round trip, jitter and loss analysis for the Bandwidth subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.bandwidth.latency_analysis", window = 174, buckets = 10, threshold = 4.60 })
		inst.system = S
		inst.ctx = ctx
