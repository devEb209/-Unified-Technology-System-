-- ARKHER SYSTEM VB.0017 :: Region Tile Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0017"
	S.key = "arkher.conttime.regiontile.persistent_state"
	S.name = "Region Tile Persistent State"
	S.category = "VB"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.regiontile.multi-scale_fidelity" }
	S.tags = { "vb", "regiontile", "persistent", "conttime" }
	S.description = "Region Tile Persistent State: epoch-stamped persistent history and rollback for the Region Tile subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.regiontile.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
