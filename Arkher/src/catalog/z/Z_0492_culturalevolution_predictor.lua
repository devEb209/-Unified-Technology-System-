-- ARKHER SYSTEM Z.0492 :: Cultural Evolution Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0492"
	S.key = "arkher.origin.culturalevolution.predictive_optimization"
	S.name = "Cultural Evolution Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.adaptive_workflow" }
	S.tags = { "z", "culturalevolution", "predictor", "origin" }
	S.description = "Cultural Evolution Predictive Optimization: forecast-driven optimization before the cost is paid for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.culturalevolution.predictive_optimization", method = "markov", alpha = 0.30, window = 124 })
		inst.system = S
		inst.ctx = ctx
