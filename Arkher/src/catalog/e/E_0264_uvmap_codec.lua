-- ARKHER SYSTEM E.0264 :: UV Mapping Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0264"
	S.key = "arkher.material.uvmap.compression_codec"
	S.name = "UV Mapping Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "UV Mapping"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.uvmap.streaming" }
	S.tags = { "e", "uvmap", "codec", "material" }
	S.description = "UV Mapping Compression Codec: serialization and compression of material data for the UV Mapping subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.uvmap.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
