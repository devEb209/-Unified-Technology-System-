-- ARKHER SYSTEM VA.0539 :: Pipeline Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0539"
	S.key = "arkher.contworld.pipelinecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.pipelinecont.simulation_fabric" }
	S.tags = { "va", "pipelinecont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.pipelinecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
