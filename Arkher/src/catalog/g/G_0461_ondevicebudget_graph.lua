-- ARKHER SYSTEM G.0461 :: On Device Budget Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0461"
	S.key = "arkher.neural.ondevicebudget.sampling_graph"
	S.name = "On Device Budget Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ondevicebudget.training_ledger" }
	S.tags = { "g", "ondevicebudget", "graph", "neural" }
	S.description = "On Device Budget Sampling Graph: dependency graph of sampling stages for the On Device Budget subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.ondevicebudget.sampling_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
