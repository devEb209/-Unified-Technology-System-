-- ARKHER SYSTEM N.0209 :: Lightning Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0209"
	S.key = "arkher.vfx.lightning.emission"
	S.name = "Lightning Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Lightning"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "lightning", "emitter", "vfx" }
	S.description = "Lightning Emission: shaped, rate and burst emission of new particles for the Lightning subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.lightning.emission", shape = "box", rate = 62, speed = 5.20, life = 2.00, budget = 512, seed = 26022 })
		inst.system = S
		inst.ctx = ctx
