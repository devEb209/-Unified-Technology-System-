-- ARKHER SYSTEM N.0144 :: Rain Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0144"
	S.key = "arkher.vfx.rain.emission"
	S.name = "Rain Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Rain"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "rain", "emitter", "vfx" }
	S.description = "Rain Emission: shaped, rate and burst emission of new particles for the Rain subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.rain.emission", shape = "box", rate = 30, speed = 4.00, life = 1.80, budget = 256, seed = 13090 })
		inst.system = S
		inst.ctx = ctx
