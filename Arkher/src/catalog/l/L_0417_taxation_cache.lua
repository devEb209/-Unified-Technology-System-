-- ARKHER SYSTEM L.0417 :: Taxation Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0417"
	S.key = "arkher.sim.taxation.aggregate_cache"
	S.name = "Taxation Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.taxation.fidelity_policy" }
	S.tags = { "l", "taxation", "cache", "sim" }
	S.description = "Taxation Aggregate Cache: reuse of expensive aggregate computations for the Taxation subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.taxation.aggregate_cache", policy = "lru", capacity = 115, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
