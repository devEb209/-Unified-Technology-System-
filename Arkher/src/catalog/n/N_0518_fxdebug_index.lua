-- ARKHER SYSTEM N.0518 :: Effect Debug Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0518"
	S.key = "arkher.vfx.fxdebug.spatial_index"
	S.name = "Effect Debug Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Effect Debug"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fxdebug.quality_policy" }
	S.tags = { "n", "fxdebug", "index", "vfx" }
	S.description = "Effect Debug Spatial Index: spatial acceleration of effect queries and culling for the Effect Debug subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.fxdebug.spatial_index", mode = "hash", cellSize = 80 })
		inst.system = S
		inst.ctx = ctx
