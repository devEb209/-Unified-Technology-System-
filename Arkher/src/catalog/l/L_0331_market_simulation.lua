-- ARKHER SYSTEM L.0331 :: Market Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0331"
	S.key = "arkher.sim.market.simulation_core"
	S.name = "Market Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "market", "simulation", "sim" }
	S.description = "Market Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Market subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.market.simulation_core", fullRadius = 320, reducedRadius = 900, budget = 43 })
		inst.system = S
		inst.ctx = ctx
