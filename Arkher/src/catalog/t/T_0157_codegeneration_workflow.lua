-- ARKHER SYSTEM T.0157 :: Code Generation Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0157"
	S.key = "arkher.ai.codegeneration.plan_workflow"
	S.name = "Code Generation Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.codegeneration.semantic_knowledge" }
	S.tags = { "t", "codegeneration", "workflow", "ai" }
	S.description = "Code Generation Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Code Generation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.codegeneration.plan_workflow", maxRetries = 3, budget = 120 })
		inst.system = S
		inst.ctx = ctx
