-- ARKHER SYSTEM E.0067 :: Metalness Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0067"
	S.key = "arkher.material.metalness.parameter_budget"
	S.name = "Metalness Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Metalness"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.metalness.variant_registry" }
	S.tags = { "e", "metalness", "budgeter", "material" }
	S.description = "Metalness Parameter Budget: texel and layer budget allocation for the Metalness subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.metalness.parameter_budget", total = 321, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
