-- ARKHER SYSTEM VA.0164 :: Coherence Seam World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0164"
	S.key = "arkher.contworld.coherenceseam.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.coherenceseam.neural_field" }
	S.tags = { "va", "coherenceseam", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.coherenceseam.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
