-- ARKHER SYSTEM W.0361 :: Cinematic Audio Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0361"
	S.key = "arkher.cine.cinematicaudio.sequence_timeline"
	S.name = "Cinematic Audio Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "cinematicaudio", "timeline", "cine" }
	S.description = "Cinematic Audio Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Cinematic Audio subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.cinematicaudio.sequence_timeline", duration = 5.0, rate = 0.81 })
		inst.system = S
		inst.ctx = ctx
