-- ARKHER SYSTEM W.0343 :: Camera Shake Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0343"
	S.key = "arkher.cine.camerashake.motion_tween"
	S.name = "Camera Shake Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Camera Shake"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.camerashake.playback_orchestrator" }
	S.tags = { "w", "camerashake", "tween", "cine" }
	S.description = "Camera Shake Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.camerashake.motion_tween", timeScale = 1.06 })
		inst.system = S
		inst.ctx = ctx
