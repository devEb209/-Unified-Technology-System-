-- ARKHER SYSTEM Z.0112 :: Universal Simulation Fabric Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0112"
	S.key = "arkher.origin.simfabric.predictive_optimization"
	S.name = "Universal Simulation Fabric Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.simfabric.adaptive_workflow" }
	S.tags = { "z", "simfabric", "predictor", "origin" }
	S.description = "Universal Simulation Fabric Predictive Optimization: forecast-driven optimization before the cost is paid for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.simfabric.predictive_optimization", method = "linear", alpha = 0.43, window = 33 })
		inst.system = S
		inst.ctx = ctx
