-- ARKHER SYSTEM K.0080 :: Semantic Memory Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0080"
	S.key = "arkher.npc.semanticmemory.crowd_steering"
	S.name = "Semantic Memory Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.semanticmemory.navigation" }
	S.tags = { "k", "semanticmemory", "crowd", "npc" }
	S.description = "Semantic Memory Crowd Steering: local avoidance, cohesion and arrival at scale for the Semantic Memory subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.semanticmemory.crowd_steering", radius = 0.55, maxSpeed = 4.30, cellSize = 7 })
		inst.system = S
		inst.ctx = ctx
