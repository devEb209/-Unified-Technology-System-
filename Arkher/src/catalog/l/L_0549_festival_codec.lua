-- ARKHER SYSTEM L.0549 :: Festival State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0549"
	S.key = "arkher.sim.festival.state_codec"
	S.name = "Festival State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.festival.history_ledger" }
	S.tags = { "l", "festival", "codec", "sim" }
	S.description = "Festival State Codec: persistence, diffing and checksum of the world state for the Festival subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.festival.state_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
