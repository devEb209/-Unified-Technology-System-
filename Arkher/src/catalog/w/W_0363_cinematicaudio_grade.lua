-- ARKHER SYSTEM W.0363 :: Cinematic Audio Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0363"
	S.key = "arkher.cine.cinematicaudio.colour_grade"
	S.name = "Cinematic Audio Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinematicaudio.camera_rig" }
	S.tags = { "w", "cinematicaudio", "grade", "cine" }
	S.description = "Cinematic Audio Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Cinematic Audio subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.cinematicaudio.colour_grade", exposure = -0.03, contrast = 1.02, saturation = 0.87, toneMap = "filmic" })
		inst.system = S
		inst.ctx = ctx
