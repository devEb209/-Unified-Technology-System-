-- ARKHER SYSTEM VD.0408 :: Perception Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0408"
	S.key = "arkher.contsim.perceptioncont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.perceptioncont.reality_continuum" }
	S.tags = { "vd", "perceptioncont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.perceptioncont.emergence_continuum", windowSize = 6, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
