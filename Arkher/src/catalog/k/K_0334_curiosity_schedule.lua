-- ARKHER SYSTEM K.0334 :: Curiosity Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0334"
	S.key = "arkher.npc.curiosity.daily_schedule"
	S.name = "Curiosity Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.curiosity.social_relations" }
	S.tags = { "k", "curiosity", "schedule", "npc" }
	S.description = "Curiosity Daily Schedule: hour-by-hour routine with priority interruptions for the Curiosity subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.curiosity.daily_schedule", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
