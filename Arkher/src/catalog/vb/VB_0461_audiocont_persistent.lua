-- ARKHER SYSTEM VB.0461 :: Audio Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0461"
	S.key = "arkher.conttime.audiocont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.audiocont.multi-scale_fidelity" }
	S.tags = { "vb", "audiocont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.audiocont.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
