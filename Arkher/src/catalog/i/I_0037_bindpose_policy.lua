-- ARKHER SYSTEM I.0037 :: Bind Pose Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0037"
	S.key = "arkher.anim.bindpose.quality_policy"
	S.name = "Bind Pose Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bind Pose"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bindpose.pose_cache" }
	S.tags = { "i", "bindpose", "policy", "anim" }
	S.description = "Bind Pose Quality Policy: device tier rules for rate, bones and solvers for the Bind Pose subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.bindpose.quality_policy", algorithm = "edf", starvationGuard = 41 })
		inst.system = S
		inst.ctx = ctx
