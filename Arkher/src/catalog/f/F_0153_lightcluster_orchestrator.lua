-- ARKHER SYSTEM F.0153 :: Light Clustering Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0153"
	S.key = "arkher.render.lightcluster.orchestration"
	S.name = "Light Clustering Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.lightcluster.frame_analysis" }
	S.tags = { "f", "lightcluster", "orchestrator", "render" }
	S.description = "Light Clustering Orchestration: frame lifecycle orchestration for the Light Clustering subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.lightcluster.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
