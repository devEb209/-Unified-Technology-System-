-- ARKHER SYSTEM K.0496 :: Patrol Route Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0496"
	S.key = "arkher.npc.patrolroute.reactive_behaviour"
	S.name = "Patrol Route Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.patrolroute.perception" }
	S.tags = { "k", "patrolroute", "behaviortree", "npc" }
	S.description = "Patrol Route Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Patrol Route subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.patrolroute.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
