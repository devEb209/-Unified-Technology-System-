-- ARKHER SYSTEM VD.0158 :: Coherence Seam Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0158"
	S.key = "arkher.contsim.coherenceseam.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.coherenceseam.infinite_grid" }
	S.tags = { "vd", "coherenceseam", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.coherenceseam.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
