-- ARKHER SYSTEM O.0221 :: Music Bed Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0221"
	S.key = "arkher.audio.musicbed.voice_budget"
	S.name = "Music Bed Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Music Bed"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.musicbed.music_sequencer" }
	S.tags = { "o", "musicbed", "budgeter", "audio" }
	S.description = "Music Bed Voice Budget: voice slots allocated by priority and audibility for the Music Bed subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.musicbed.voice_budget", total = 205, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
