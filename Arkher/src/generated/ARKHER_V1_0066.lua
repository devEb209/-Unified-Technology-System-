--!strict
-- Nuke Nodal — CORE Node_Flow #0066
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Nuke Nodal — CORE Node_Flow #0066", size=Vector2.new(600, 440), pos=UDim2.fromOffset(158, 162), parent=parent, icon="⬢"})
