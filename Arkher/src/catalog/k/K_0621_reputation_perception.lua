-- ARKHER SYSTEM K.0621 :: Reputation Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0621"
	S.key = "arkher.npc.reputation.perception"
	S.name = "Reputation Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.reputation.emotion" }
	S.tags = { "k", "reputation", "perception", "npc" }
	S.description = "Reputation Perception: sight, hearing and bounded attention for the Reputation subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.reputation.perception", sightRange = 60, hearingRange = 24, attentionSlots = 6, fov = 1.830 })
		inst.system = S
		inst.ctx = ctx
