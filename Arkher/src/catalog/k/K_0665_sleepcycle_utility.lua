-- ARKHER SYSTEM K.0665 :: Sleep Cycle Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0665"
	S.key = "arkher.npc.sleepcycle.utility_reasoning"
	S.name = "Sleep Cycle Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.sleepcycle.reactive_behaviour" }
	S.tags = { "k", "sleepcycle", "utility", "npc" }
	S.description = "Sleep Cycle Utility Reasoning: scored option selection with response curves for the Sleep Cycle subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.sleepcycle.utility_reasoning", momentum = 0.10 })
		inst.system = S
		inst.ctx = ctx
