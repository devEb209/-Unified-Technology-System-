-- ARKHER SYSTEM VB.0118 :: Temporal Slice Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0118"
	S.key = "arkher.conttime.temporalslice.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.temporalslice.complexity_budget" }
	S.tags = { "vb", "temporalslice", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.temporalslice.simulation_fabric", budgetMs = 1.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
