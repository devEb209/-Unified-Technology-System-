-- ARKHER SYSTEM I.0356 :: Hit Reaction Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0356"
	S.key = "arkher.anim.hitreaction.physical_blend"
	S.name = "Hit Reaction Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Hit Reaction"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.hitreaction.inverse_kinematics" }
	S.tags = { "i", "hitreaction", "ragdoll", "anim" }
	S.description = "Hit Reaction Physical Blend: physical bones blended against the animated pose for the Hit Reaction subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.hitreaction.physical_blend", blendSpeed = 4.50 })
		inst.system = S
		inst.ctx = ctx
