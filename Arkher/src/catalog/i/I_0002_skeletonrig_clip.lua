-- ARKHER SYSTEM I.0002 :: Skeleton Rig Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0002"
	S.key = "arkher.anim.skeletonrig.clip_sampling"
	S.name = "Skeleton Rig Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Skeleton Rig"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.skeletonrig.skeleton" }
	S.tags = { "i", "skeletonrig", "clip", "anim" }
	S.description = "Skeleton Rig Clip Sampling: keyframe tracks sampled, retimed and evented for the Skeleton Rig subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.skeletonrig.clip_sampling", duration = 3.00, loop = false })
		inst.system = S
		inst.ctx = ctx
