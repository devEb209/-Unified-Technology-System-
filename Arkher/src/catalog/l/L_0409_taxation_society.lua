-- ARKHER SYSTEM L.0409 :: Taxation Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0409"
	S.key = "arkher.sim.taxation.society"
	S.name = "Taxation Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.taxation.economy" }
	S.tags = { "l", "taxation", "society", "sim" }
	S.description = "Taxation Society: relations, factions, reputation and cohesion of the region for the Taxation subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.taxation.society", decayRate = 0.005, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
