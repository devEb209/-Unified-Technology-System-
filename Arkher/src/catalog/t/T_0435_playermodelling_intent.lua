-- ARKHER SYSTEM T.0435 :: Player Modelling Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0435"
	S.key = "arkher.ai.playermodelling.intent_understanding"
	S.name = "Player Modelling Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "playermodelling", "intent", "ai" }
	S.description = "Player Modelling Intent Understanding: natural language turned into an actionable, scored intent for the Player Modelling subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.playermodelling.intent_understanding", minConfidence = 0.41 })
		inst.system = S
		inst.ctx = ctx
