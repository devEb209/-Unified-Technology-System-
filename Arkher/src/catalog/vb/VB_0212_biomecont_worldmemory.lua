-- ARKHER SYSTEM VB.0212 :: Biome Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0212"
	S.key = "arkher.conttime.biomecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.biomecont.neural_field" }
	S.tags = { "vb", "biomecont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.biomecont.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
