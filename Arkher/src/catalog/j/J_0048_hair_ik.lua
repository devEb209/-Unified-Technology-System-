-- ARKHER SYSTEM J.0048 :: Hair Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0048"
	S.key = "arkher.character.hair.look_and_reach"
	S.name = "Hair Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.hair.blend_controller" }
	S.tags = { "j", "hair", "ik", "character" }
	S.description = "Hair Look And Reach: look-at, reach and foot placement for the character for the Hair subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.hair.look_and_reach", iterations = 13, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
