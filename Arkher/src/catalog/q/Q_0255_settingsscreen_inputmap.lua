-- ARKHER SYSTEM Q.0255 :: Settings Screen Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0255"
	S.key = "arkher.ui.settingsscreen.input_mapping"
	S.name = "Settings Screen Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.settingsscreen.widget_tree" }
	S.tags = { "q", "settingsscreen", "inputmap", "ui" }
	S.description = "Settings Screen Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Settings Screen subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.settingsscreen.input_mapping", device = "keyboard", holdTime = 0.25, deadzone = 0.15 })
		inst.system = S
		inst.ctx = ctx
