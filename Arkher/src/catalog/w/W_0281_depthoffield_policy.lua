-- ARKHER SYSTEM W.0281 :: Depth Of Field Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0281"
	S.key = "arkher.cine.depthoffield.cut_policy"
	S.name = "Depth Of Field Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.depthoffield.shot_composition" }
	S.tags = { "w", "depthoffield", "policy", "cine" }
	S.description = "Depth Of Field Cut Policy: rules deciding when the sequence cuts and to what for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.depthoffield.cut_policy", algorithm = "roundrobin", starvationGuard = 60 })
		inst.system = S
		inst.ctx = ctx
