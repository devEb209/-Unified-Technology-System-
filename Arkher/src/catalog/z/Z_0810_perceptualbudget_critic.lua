-- ARKHER SYSTEM Z.0810 :: Perceptual Budgeting Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0810"
	S.key = "arkher.origin.perceptualbudget.self_critique"
	S.name = "Perceptual Budgeting Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.perceptualbudget.intent_bridge" }
	S.tags = { "z", "perceptualbudget", "critic", "origin" }
	S.description = "Perceptual Budgeting Self Critique: weighted judgement of the technology's own output for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.perceptualbudget.self_critique", passMark = 0.76, reviseMark = 0.46, seed = 92316 })
		inst.system = S
		inst.ctx = ctx
