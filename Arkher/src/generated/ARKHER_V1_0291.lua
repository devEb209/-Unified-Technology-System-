--!strict
-- Houdini — ANIMATION Node_Flow #0291
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Houdini — ANIMATION Node_Flow #0291", size=Vector2.new(600, 440), pos=UDim2.fromOffset(283, 87), parent=parent, icon="◣"})
