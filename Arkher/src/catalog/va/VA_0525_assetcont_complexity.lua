-- ARKHER SYSTEM VA.0525 :: Asset Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0525"
	S.key = "arkher.contworld.assetcont.complexity_budget"
	S.name = "Asset Continuum Complexity Budget"
	S.category = "VA"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.assetcont.world_memory_stream" }
	S.tags = { "va", "assetcont", "complexity", "contworld" }
	S.description = "Asset Continuum Complexity Budget: complexity budgeting for the continuum for the Asset Continuum subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.assetcont.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
