-- ARKHER SYSTEM O.0057 :: Explosion Sound Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0057"
	S.key = "arkher.audio.explosionsound.playback_policy"
	S.name = "Explosion Sound Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.explosionsound.compression_codec" }
	S.tags = { "o", "explosionsound", "policy", "audio" }
	S.description = "Explosion Sound Playback Policy: rules choosing what may be heard right now for the Explosion Sound subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.explosionsound.playback_policy", algorithm = "lottery", starvationGuard = 43 })
		inst.system = S
		inst.ctx = ctx
