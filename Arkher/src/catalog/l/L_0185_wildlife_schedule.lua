-- ARKHER SYSTEM L.0185 :: Wildlife Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0185"
	S.key = "arkher.sim.wildlife.calendar"
	S.name = "Wildlife Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wildlife.society" }
	S.tags = { "l", "wildlife", "schedule", "sim" }
	S.description = "Wildlife Calendar: hours, days and seasons driving the region for the Wildlife subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.wildlife.calendar", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
