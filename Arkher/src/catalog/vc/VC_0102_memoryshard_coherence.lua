-- ARKHER SYSTEM VC.0102 :: Memory Shard Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0102"
	S.key = "arkher.contneural.memoryshard.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memoryshard.persistent_state" }
	S.tags = { "vc", "memoryshard", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.memoryshard.coherence_guard", window = 122, threshold = 0.10 })
		inst.system = S
		inst.ctx = ctx
