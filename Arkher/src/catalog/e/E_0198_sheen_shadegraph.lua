-- ARKHER SYSTEM E.0198 :: Sheen Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0198"
	S.key = "arkher.material.sheen.shading_graph"
	S.name = "Sheen Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Sheen"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.sheen.layer_composition" }
	S.tags = { "e", "sheen", "shadegraph", "material" }
	S.description = "Sheen Shading Graph: node graph evaluated and compiled to Luau for the Sheen subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.sheen.shading_graph" })
		inst.system = S
		inst.ctx = ctx
