-- ARKHER SYSTEM P.0137 :: Rarity State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0137"
	S.key = "arkher.play.rarity.state_machine"
	S.name = "Rarity State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Rarity"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.rarity.combat_resolution" }
	S.tags = { "p", "rarity", "orchestrator", "play" }
	S.description = "Rarity State Machine: the phase machine that drives this gameplay loop for the Rarity subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.rarity.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
