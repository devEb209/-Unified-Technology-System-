-- ARKHER SYSTEM E.0323 :: Moisture Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0323"
	S.key = "arkher.material.moisture.streaming"
	S.name = "Moisture Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Moisture"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.moisture.parameter_budget" }
	S.tags = { "e", "moisture", "streamer", "material" }
	S.description = "Moisture Streaming: residency and demand-driven texture streaming for the Moisture subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.moisture.streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
