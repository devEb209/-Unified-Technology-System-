-- ARKHER SYSTEM VC.0332 :: Economy Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0332"
	S.key = "arkher.contneural.economycont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.economycont.neural_field" }
	S.tags = { "vc", "economycont", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.economycont.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
