-- ARKHER SYSTEM Z.0979 :: Generation Migration Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0979"
	S.key = "arkher.origin.generationmigration.residency_streaming"
	S.name = "Generation Migration Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.budget_governor" }
	S.tags = { "z", "generationmigration", "streamer", "origin" }
	S.description = "Generation Migration Residency Streaming: distance-driven residency of the technology's workload for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.generationmigration.residency_streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
