-- ARKHER SYSTEM E.0428 :: Texture Streaming Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0428"
	S.key = "arkher.material.texstream.streaming"
	S.name = "Texture Streaming Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.texstream.parameter_budget" }
	S.tags = { "e", "texstream", "streamer", "material" }
	S.description = "Texture Streaming Streaming: residency and demand-driven texture streaming for the Texture Streaming subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.texstream.streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
