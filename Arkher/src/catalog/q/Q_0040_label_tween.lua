-- ARKHER SYSTEM Q.0040 :: Label Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0040"
	S.key = "arkher.ui.label.transition"
	S.name = "Label Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Label"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.label.input_mapping" }
	S.tags = { "q", "label", "tween", "ui" }
	S.description = "Label Transition: eased, delayed, looped and sequenced motion for the Label subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.label.transition", timeScale = 0.96 })
		inst.system = S
		inst.ctx = ctx
