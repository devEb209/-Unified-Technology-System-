-- ARKHER SYSTEM E.0447 :: Detail Tiling Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0447"
	S.key = "arkher.material.detailtile.analysis"
	S.name = "Detail Tiling Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.detailtile.instance_cache" }
	S.tags = { "e", "detailtile", "analyzer", "material" }
	S.description = "Detail Tiling Analysis: cost, redundancy and outlier analysis for the Detail Tiling subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.detailtile.analysis", window = 75, buckets = 19, threshold = 3.70 })
		inst.system = S
		inst.ctx = ctx
