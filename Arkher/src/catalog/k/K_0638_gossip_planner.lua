-- ARKHER SYSTEM K.0638 :: Gossip Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0638"
	S.key = "arkher.npc.gossip.goal_planner"
	S.name = "Gossip Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.gossip.utility_reasoning" }
	S.tags = { "k", "gossip", "planner", "npc" }
	S.description = "Gossip Goal Planner: backward GOAP planning to reach a goal state for the Gossip subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.gossip.goal_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
