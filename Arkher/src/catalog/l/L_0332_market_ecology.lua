-- ARKHER SYSTEM L.0332 :: Market Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0332"
	S.key = "arkher.sim.market.ecology"
	S.name = "Market Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.market.simulation_core" }
	S.tags = { "l", "market", "ecology", "sim" }
	S.description = "Market Ecology: populations, predation, harvesting and carrying capacity for the Market subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.market.ecology" })
		inst.system = S
		inst.ctx = ctx
