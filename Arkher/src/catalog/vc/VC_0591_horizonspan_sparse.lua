-- ARKHER SYSTEM VC.0591 :: Horizon Span Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0591"
	S.key = "arkher.contneural.horizonspan.sparse_residency"
	S.name = "Horizon Span Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.horizonspan.epoch_clock" }
	S.tags = { "vc", "horizonspan", "sparse", "contneural" }
	S.description = "Horizon Span Sparse Residency: sparse page residency with eviction and compression for the Horizon Span subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.horizonspan.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
