-- ARKHER SYSTEM VD.0428 :: Navigation Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0428"
	S.key = "arkher.contsim.navcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.navcont.neural_field" }
	S.tags = { "vd", "navcont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.navcont.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
