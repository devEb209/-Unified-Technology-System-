-- ARKHER SYSTEM VD.0386 :: Memory Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0386"
	S.key = "arkher.contsim.memorycont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memorycont.infinite_grid" }
	S.tags = { "vd", "memorycont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.memorycont.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
