-- ARKHER SYSTEM W.0382 :: Playback Control Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0382"
	S.key = "arkher.cine.playbackcontrol.frame_budget"
	S.name = "Playback Control Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.playbackcontrol.event_ledger" }
	S.tags = { "w", "playbackcontrol", "budgeter", "cine" }
	S.description = "Playback Control Frame Budget: per-frame cost budget for the cinematic systems for the Playback Control subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.playbackcontrol.frame_budget", total = 198, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
