-- ARKHER SYSTEM Z.0461 :: Narrative Memory Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0461"
	S.key = "arkher.origin.narrativememory.reality_layering"
	S.name = "Narrative Memory Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "narrativememory", "reality", "origin" }
	S.description = "Narrative Memory Reality Layering: stacked authored, simulated, proposed and player realities for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.narrativememory.reality_layering" })
		inst.system = S
		inst.ctx = ctx
