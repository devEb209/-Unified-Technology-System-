-- ARKHER SYSTEM J.0072 :: Teeth Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0072"
	S.key = "arkher.character.teeth.locomotion"
	S.name = "Teeth Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.teeth.physical_response" }
	S.tags = { "j", "teeth", "charmotor", "character" }
	S.description = "Teeth Locomotion: capsule locomotion driving the character for the Teeth subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.teeth.locomotion", radius = 0.38, height = 1.83, maxSpeed = 8.30, jumpHeight = 1.90, stepOffset = 0.38 })
		inst.system = S
		inst.ctx = ctx
