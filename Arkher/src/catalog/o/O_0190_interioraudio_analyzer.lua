-- ARKHER SYSTEM O.0190 :: Interior Audio Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0190"
	S.key = "arkher.audio.interioraudio.analysis"
	S.name = "Interior Audio Analysis"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.interioraudio.playback_policy" }
	S.tags = { "o", "interioraudio", "analyzer", "audio" }
	S.description = "Interior Audio Analysis: loudness, headroom and masking analysis for the Interior Audio subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.interioraudio.analysis", window = 172, buckets = 16, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
