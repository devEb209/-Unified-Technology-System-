-- ARKHER SYSTEM J.0295 :: Character LOD Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0295"
	S.key = "arkher.character.characterlod.budget_governor"
	S.name = "Character LOD Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterlod.variant_registry" }
	S.tags = { "j", "characterlod", "budgeter", "character" }
	S.description = "Character LOD Budget Governor: per-character cost allocation in a crowd for the Character LOD subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.characterlod.budget_governor", total = 314, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
