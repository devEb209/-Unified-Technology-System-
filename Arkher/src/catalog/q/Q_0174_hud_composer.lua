-- ARKHER SYSTEM Q.0174 :: Head Up Display Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0174"
	S.key = "arkher.ui.hud.theme_composition"
	S.name = "Head Up Display Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.hud.navigation_graph" }
	S.tags = { "q", "hud", "composer", "ui" }
	S.description = "Head Up Display Theme Composition: blending of theme signals into the final appearance for the Head Up Display subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.hud.theme_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
