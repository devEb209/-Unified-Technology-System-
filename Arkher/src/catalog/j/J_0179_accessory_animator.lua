-- ARKHER SYSTEM J.0179 :: Accessory Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0179"
	S.key = "arkher.character.accessory.blend_controller"
	S.name = "Accessory Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.accessory.motion_set" }
	S.tags = { "j", "accessory", "animator", "character" }
	S.description = "Accessory Blend Controller: layered playback driving the character for the Accessory subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.accessory.blend_controller", budget = 11 })
		inst.system = S
		inst.ctx = ctx
