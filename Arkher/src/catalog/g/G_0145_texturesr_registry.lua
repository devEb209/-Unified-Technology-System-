-- ARKHER SYSTEM G.0145 :: Texture Super Resolution Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0145"
	S.key = "arkher.neural.texturesr.model_registry"
	S.name = "Texture Super Resolution Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.texturesr.reconstruction" }
	S.tags = { "g", "texturesr", "registry", "neural" }
	S.description = "Texture Super Resolution Model Registry: named models and their lifecycle for the Texture Super Resolution subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.texturesr.model_registry" })
		inst.system = S
		inst.ctx = ctx
