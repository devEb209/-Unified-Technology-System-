-- ARKHER SYSTEM G.0340 :: Inference Scheduler Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0340"
	S.key = "arkher.neural.inferencesched.reconstruction"
	S.name = "Inference Scheduler Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.inferencesched.temporal_history" }
	S.tags = { "g", "inferencesched", "upscaler", "neural" }
	S.description = "Inference Scheduler Reconstruction: resolution ladder and image reconstruction for the Inference Scheduler subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.inferencesched.reconstruction", targetMs = 15.10, index = 4, sharpness = 0.44 })
		inst.system = S
		inst.ctx = ctx
