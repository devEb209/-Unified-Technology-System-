-- ARKHER SYSTEM VD.0523 :: Asset Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0523"
	S.key = "arkher.contsim.assetcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.assetcont.coherence_guard" }
	S.tags = { "vd", "assetcont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.assetcont.neural_field", dims = 20, hidden = 16, seed = 20002 })
		inst.system = S
		inst.ctx = ctx
