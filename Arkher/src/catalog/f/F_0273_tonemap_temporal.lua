-- ARKHER SYSTEM F.0273 :: Tonemapping Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0273"
	S.key = "arkher.render.tonemap.temporal_resolve"
	S.name = "Tonemapping Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Tonemapping"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.tonemap.probe_volume" }
	S.tags = { "f", "tonemap", "temporal", "render" }
	S.description = "Tonemapping Temporal Resolve: history reprojection with neighbourhood clamping for the Tonemapping subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.tonemap.temporal_resolve", feedback = 0.91, phase = 8 })
		inst.system = S
		inst.ctx = ctx
