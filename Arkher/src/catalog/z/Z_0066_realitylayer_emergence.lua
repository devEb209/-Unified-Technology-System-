-- ARKHER SYSTEM Z.0066 :: Reality Layer Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0066"
	S.key = "arkher.origin.realitylayer.emergence_detection"
	S.name = "Reality Layer Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.world_memory" }
	S.tags = { "z", "realitylayer", "emergence", "origin" }
	S.description = "Reality Layer Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.realitylayer.emergence_detection", windowSize = 5, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
