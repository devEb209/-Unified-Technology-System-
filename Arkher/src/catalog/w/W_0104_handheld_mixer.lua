-- ARKHER SYSTEM W.0104 :: Handheld Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0104"
	S.key = "arkher.cine.handheld.cinematic_mix"
	S.name = "Handheld Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Handheld"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.handheld.motion_tween" }
	S.tags = { "w", "handheld", "mixer", "cine" }
	S.description = "Handheld Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Handheld subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.handheld.cinematic_mix", maxVoices = 40 })
		inst.system = S
		inst.ctx = ctx
