-- ARKHER SYSTEM F.0554 :: Particle Rendering Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0554"
	S.key = "arkher.render.particlerender.adaptive_resolution"
	S.name = "Particle Rendering Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.particlerender.temporal_resolve" }
	S.tags = { "f", "particlerender", "upscaler", "render" }
	S.description = "Particle Rendering Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Particle Rendering subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.particlerender.adaptive_resolution", targetMs = 16.10, index = 5, sharpness = 0.39 })
		inst.system = S
		inst.ctx = ctx
