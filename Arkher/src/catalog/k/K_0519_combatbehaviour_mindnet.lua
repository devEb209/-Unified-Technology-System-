-- ARKHER SYSTEM K.0519 :: Combat Behaviour Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0519"
	S.key = "arkher.npc.combatbehaviour.mind_network"
	S.name = "Combat Behaviour Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "combatbehaviour", "mindnet", "npc" }
	S.description = "Combat Behaviour Mind Network: the learned policy that turns perception into a decision for the Combat Behaviour subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.combatbehaviour.mind_network", inputs = 6, hidden = 6, seed = 8372, learningRate = 0.060, exploration = 0.040 })
		inst.system = S
		inst.ctx = ctx
