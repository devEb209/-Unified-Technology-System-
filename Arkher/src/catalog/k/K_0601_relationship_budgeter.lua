-- ARKHER SYSTEM K.0601 :: Relationship Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0601"
	S.key = "arkher.npc.relationship.thinking_budget"
	S.name = "Relationship Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.relationship.daily_schedule" }
	S.tags = { "k", "relationship", "budgeter", "npc" }
	S.description = "Relationship Thinking Budget: allocation of per-frame thinking time across NPCs for the Relationship subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.relationship.thinking_budget", total = 148, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
