-- ARKHER SYSTEM F.0201 :: Fog Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0201"
	S.key = "arkher.render.fog.lighting_rig"
	S.name = "Fog Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Fog"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.fog.geometry_virtualization" }
	S.tags = { "f", "fog", "lightrig", "render" }
	S.description = "Fog Lighting Rig: light clustering, importance and cascades for the Fog subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.fog.lighting_rig", maxActive = 7 })
		inst.system = S
		inst.ctx = ctx
