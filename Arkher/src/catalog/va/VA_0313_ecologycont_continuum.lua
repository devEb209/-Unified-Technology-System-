-- ARKHER SYSTEM VA.0313 :: Ecology Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0313"
	S.key = "arkher.contworld.ecologycont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "ecologycont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.ecologycont.infinite_grid", cellSize = 160, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
