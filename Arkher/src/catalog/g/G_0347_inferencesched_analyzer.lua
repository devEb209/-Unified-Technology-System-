-- ARKHER SYSTEM G.0347 :: Inference Scheduler Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0347"
	S.key = "arkher.neural.inferencesched.error_analysis"
	S.name = "Inference Scheduler Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.inferencesched.heuristic_policy" }
	S.tags = { "g", "inferencesched", "analyzer", "neural" }
	S.description = "Inference Scheduler Error Analysis: residual and drift analysis for the Inference Scheduler subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.inferencesched.error_analysis", window = 145, buckets = 13, threshold = 3.70 })
		inst.system = S
		inst.ctx = ctx
