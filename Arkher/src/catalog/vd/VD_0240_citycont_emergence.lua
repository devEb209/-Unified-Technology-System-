-- ARKHER SYSTEM VD.0240 :: City Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0240"
	S.key = "arkher.contsim.citycont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.citycont.reality_continuum" }
	S.tags = { "vd", "citycont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.citycont.emergence_continuum", windowSize = 5, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
