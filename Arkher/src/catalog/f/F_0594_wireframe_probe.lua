-- ARKHER SYSTEM F.0594 :: Wireframe Overlay Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0594"
	S.key = "arkher.render.wireframe.probe_volume"
	S.name = "Wireframe Overlay Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.wireframe.lighting_rig" }
	S.tags = { "f", "wireframe", "probe", "render" }
	S.description = "Wireframe Overlay Probe Volume: irradiance probes encoded in spherical harmonics for the Wireframe Overlay subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.wireframe.probe_volume", spacing = 8 })
		inst.system = S
		inst.ctx = ctx
