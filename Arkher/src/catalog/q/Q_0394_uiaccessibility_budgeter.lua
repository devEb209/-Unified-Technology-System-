-- ARKHER SYSTEM Q.0394 :: Accessibility Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0394"
	S.key = "arkher.ui.uiaccessibility.frame_budget"
	S.name = "Accessibility Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uiaccessibility.accessibility_policy" }
	S.tags = { "q", "uiaccessibility", "budgeter", "ui" }
	S.description = "Accessibility Frame Budget: per-frame layout and draw budget for the interface for the Accessibility subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.uiaccessibility.frame_budget", total = 361, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
