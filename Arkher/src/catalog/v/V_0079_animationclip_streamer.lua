-- ARKHER SYSTEM V.0079 :: Animation Clip Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0079"
	S.key = "arkher.asset.animationclip.streaming_residency"
	S.name = "Animation Clip Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.animationclip.content_cache" }
	S.tags = { "v", "animationclip", "streamer", "asset" }
	S.description = "Animation Clip Streaming Residency: distance-driven load and unload of asset payloads for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.animationclip.streaming_residency", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
