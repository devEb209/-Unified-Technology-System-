-- ARKHER SYSTEM O.0250 :: Combat Music Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0250"
	S.key = "arkher.audio.combatmusic.analysis"
	S.name = "Combat Music Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Combat Music"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.combatmusic.playback_policy" }
	S.tags = { "o", "combatmusic", "analyzer", "audio" }
	S.description = "Combat Music Analysis: loudness, headroom and masking analysis for the Combat Music subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.combatmusic.analysis", window = 180, buckets = 12, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
