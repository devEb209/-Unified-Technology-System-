-- ARKHER SYSTEM H.0121 :: Impulse Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0121"
	S.key = "arkher.physics.impulse.budget_governor"
	S.name = "Impulse Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Impulse"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.impulse.broadphase_index" }
	S.tags = { "h", "impulse", "budgeter", "physics" }
	S.description = "Impulse Budget Governor: simulation time budget allocation across islands for the Impulse subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.impulse.budget_governor", total = 435, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
