-- ARKHER SYSTEM N.0179 :: Hail Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0179"
	S.key = "arkher.vfx.hail.quality_policy"
	S.name = "Hail Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Hail"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.hail.result_cache" }
	S.tags = { "n", "hail", "policy", "vfx" }
	S.description = "Hail Quality Policy: distance and device driven fidelity bands for the Hail subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.hail.quality_policy", algorithm = "roundrobin", starvationGuard = 52 })
		inst.system = S
		inst.ctx = ctx
