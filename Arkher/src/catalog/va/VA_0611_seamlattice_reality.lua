-- ARKHER SYSTEM VA.0611 :: Seam Lattice Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0611"
	S.key = "arkher.contworld.seamlattice.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.seamlattice.simulation_fabric" }
	S.tags = { "va", "seamlattice", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.seamlattice.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
