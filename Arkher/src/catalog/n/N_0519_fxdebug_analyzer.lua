-- ARKHER SYSTEM N.0519 :: Effect Debug Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0519"
	S.key = "arkher.vfx.fxdebug.analysis"
	S.name = "Effect Debug Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Effect Debug"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fxdebug.spatial_index" }
	S.tags = { "n", "fxdebug", "analyzer", "vfx" }
	S.description = "Effect Debug Analysis: cost, overdraw and stability analysis of the effect for the Effect Debug subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.fxdebug.analysis", window = 120, buckets = 12, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
