-- ARKHER SYSTEM E.0152 :: Subsurface Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0152"
	S.key = "arkher.material.subsurface.layer_composition"
	S.name = "Subsurface Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Subsurface"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.subsurface.definition" }
	S.tags = { "e", "subsurface", "composer", "material" }
	S.description = "Subsurface Layer Composition: ordered layer composition with blend rules for the Subsurface subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.subsurface.layer_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
