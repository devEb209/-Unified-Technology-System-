-- ARKHER SYSTEM Q.0393 :: Accessibility Accessibility Policy
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0393"
	S.key = "arkher.ui.uiaccessibility.accessibility_policy"
	S.name = "Accessibility Accessibility Policy"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uiaccessibility.interaction_ledger" }
	S.tags = { "q", "uiaccessibility", "policy", "ui" }
	S.description = "Accessibility Accessibility Policy: rules enforcing contrast, target size and motion limits for the Accessibility subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ui.uiaccessibility.accessibility_policy", algorithm = "lottery", starvationGuard = 51 })
		inst.system = S
		inst.ctx = ctx
