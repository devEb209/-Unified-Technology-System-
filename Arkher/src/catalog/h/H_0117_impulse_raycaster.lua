-- ARKHER SYSTEM H.0117 :: Impulse Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0117"
	S.key = "arkher.physics.impulse.query"
	S.name = "Impulse Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Impulse"
	S.aspect = "Query"
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.impulse.constraint_solver" }
	S.tags = { "h", "impulse", "raycaster", "physics" }
	S.description = "Impulse Query: rays, sweeps and overlaps against the simulation for the Impulse subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.impulse.query", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
