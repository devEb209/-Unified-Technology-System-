-- ARKHER SYSTEM Z.0770 :: Semantic LOD Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0770"
	S.key = "arkher.origin.semanticlod.self_critique"
	S.name = "Semantic LOD Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticlod.intent_bridge" }
	S.tags = { "z", "semanticlod", "critic", "origin" }
	S.description = "Semantic LOD Self Critique: weighted judgement of the technology's own output for the Semantic LOD subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.semanticlod.self_critique", passMark = 0.71, reviseMark = 0.46, seed = 60316 })
		inst.system = S
		inst.ctx = ctx
