-- ARKHER SYSTEM G.0198 :: Ambient Occlusion Prediction Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0198"
	S.key = "arkher.neural.aopredict.feature_extraction"
	S.name = "Ambient Occlusion Prediction Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.aopredict.inference_core" }
	S.tags = { "g", "aopredict", "field", "neural" }
	S.description = "Ambient Occlusion Prediction Feature Extraction: signal features feeding the model for the Ambient Occlusion Prediction subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.aopredict.feature_extraction", seed = 5494, frequency = 0.0075, octaves = 5, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
