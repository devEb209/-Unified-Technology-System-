-- ARKHER SYSTEM E.0306 :: Dust Accumulation Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0306"
	S.key = "arkher.material.dust.variant_registry"
	S.name = "Dust Accumulation Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.dust.procedural_detail" }
	S.tags = { "e", "dust", "registry", "material" }
	S.description = "Dust Accumulation Variant Registry: named variants and their lifecycle for the Dust Accumulation subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.dust.variant_registry" })
		inst.system = S
		inst.ctx = ctx
