-- ARKHER SYSTEM Q.0148 :: Tab Bar Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0148"
	S.key = "arkher.ui.tabbar.transition"
	S.name = "Tab Bar Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tab Bar"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.tabbar.input_mapping" }
	S.tags = { "q", "tabbar", "tween", "ui" }
	S.description = "Tab Bar Transition: eased, delayed, looped and sequenced motion for the Tab Bar subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.tabbar.transition", timeScale = 1.13 })
		inst.system = S
		inst.ctx = ctx
