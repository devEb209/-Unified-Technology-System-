-- ARKHER SYSTEM F.0137 :: Global Illumination Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0137"
	S.key = "arkher.render.gi.pass_cache"
	S.name = "Global Illumination Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.gi.render_policy" }
	S.tags = { "f", "gi", "cache", "render" }
	S.description = "Global Illumination Pass Cache: reuse of pass results across frames for the Global Illumination subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.gi.pass_cache", policy = "lru", capacity = 226, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
