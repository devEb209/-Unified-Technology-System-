-- ARKHER SYSTEM F.0155 :: Volumetric Light Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0155"
	S.key = "arkher.render.volumetric.frame_graph"
	S.name = "Volumetric Light Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "volumetric", "framegraph", "render" }
	S.description = "Volumetric Light Frame Graph: declared passes, culling, ordering and aliasing for the Volumetric Light subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.volumetric.frame_graph", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
