-- ARKHER SYSTEM I.0497 :: Cloth Animation Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0497"
	S.key = "arkher.anim.clothanim.layered_blending"
	S.name = "Cloth Animation Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clothanim.clip_sampling" }
	S.tags = { "i", "clothanim", "animator", "anim" }
	S.description = "Cloth Animation Layered Blending: layers, crossfades, masks and blend trees for the Cloth Animation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.clothanim.layered_blending", budget = 14 })
		inst.system = S
		inst.ctx = ctx
