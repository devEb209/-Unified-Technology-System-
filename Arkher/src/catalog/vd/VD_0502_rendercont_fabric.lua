-- ARKHER SYSTEM VD.0502 :: Rendering Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0502"
	S.key = "arkher.contsim.rendercont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.rendercont.complexity_budget" }
	S.tags = { "vd", "rendercont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.rendercont.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
