-- ARKHER SYSTEM O.0246 :: Combat Music Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0246"
	S.key = "arkher.audio.combatmusic.streaming"
	S.name = "Combat Music Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Combat Music"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.combatmusic.voice_budget" }
	S.tags = { "o", "combatmusic", "streamer", "audio" }
	S.description = "Combat Music Streaming: distance-driven residency of audio assets for the Combat Music subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.combatmusic.streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
