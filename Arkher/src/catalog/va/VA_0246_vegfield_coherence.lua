-- ARKHER SYSTEM VA.0246 :: Vegetation Field Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0246"
	S.key = "arkher.contworld.vegfield.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vegfield.persistent_state" }
	S.tags = { "va", "vegfield", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.vegfield.coherence_guard", window = 92, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
