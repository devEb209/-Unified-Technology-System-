-- ARKHER SYSTEM Z.0305 :: Causality Ledger World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0305"
	S.key = "arkher.origin.causality.world_memory"
	S.name = "Causality Ledger World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.autonomous_pipeline" }
	S.tags = { "z", "causality", "worldmemory", "origin" }
	S.description = "Causality Ledger World Memory: epoch-stamped persistent history with compaction and checkpoints for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.causality.world_memory", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
