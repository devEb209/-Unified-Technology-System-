-- ARKHER SYSTEM K.0425 :: Pathfinding Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0425"
	S.key = "arkher.npc.pathfinding.perception"
	S.name = "Pathfinding Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.pathfinding.emotion" }
	S.tags = { "k", "pathfinding", "perception", "npc" }
	S.description = "Pathfinding Perception: sight, hearing and bounded attention for the Pathfinding subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.pathfinding.perception", sightRange = 45, hearingRange = 28, attentionSlots = 3, fov = 1.720 })
		inst.system = S
		inst.ctx = ctx
