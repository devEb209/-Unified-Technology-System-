-- ARKHER SYSTEM Q.0112 :: Toast Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0112"
	S.key = "arkher.ui.toast.transition"
	S.name = "Toast Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Toast"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.toast.input_mapping" }
	S.tags = { "q", "toast", "tween", "ui" }
	S.description = "Toast Transition: eased, delayed, looped and sequenced motion for the Toast subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.toast.transition", timeScale = 0.94 })
		inst.system = S
		inst.ctx = ctx
