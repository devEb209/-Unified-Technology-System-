-- ARKHER SYSTEM VC.0182 :: Simulation Domain Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0182"
	S.key = "arkher.contneural.simdomain.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.simdomain.infinite_grid" }
	S.tags = { "vc", "simdomain", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.simdomain.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
