-- ARKHER SYSTEM VD.0627 :: Interest Field Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0627"
	S.key = "arkher.contsim.interestfield.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.interestfield.epoch_clock" }
	S.tags = { "vd", "interestfield", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.interestfield.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
