-- ARKHER SYSTEM K.0101 :: Memory Consolidation Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0101"
	S.key = "arkher.npc.consolidation.drive_system"
	S.name = "Memory Consolidation Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.consolidation.memory" }
	S.tags = { "k", "consolidation", "need", "npc" }
	S.description = "Memory Consolidation Drive System: drives that decay, turn urgent and get satisfied for the Memory Consolidation subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.consolidation.drive_system" })
		inst.system = S
		inst.ctx = ctx
