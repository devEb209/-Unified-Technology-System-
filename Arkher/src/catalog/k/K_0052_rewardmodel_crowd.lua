-- ARKHER SYSTEM K.0052 :: Reward Model Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0052"
	S.key = "arkher.npc.rewardmodel.crowd_steering"
	S.name = "Reward Model Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.rewardmodel.navigation" }
	S.tags = { "k", "rewardmodel", "crowd", "npc" }
	S.description = "Reward Model Crowd Steering: local avoidance, cohesion and arrival at scale for the Reward Model subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.rewardmodel.crowd_steering", radius = 0.40, maxSpeed = 4.00, cellSize = 10 })
		inst.system = S
		inst.ctx = ctx
