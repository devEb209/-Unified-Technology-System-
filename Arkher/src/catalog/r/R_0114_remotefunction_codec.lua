-- ARKHER SYSTEM R.0114 :: Remote Function Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0114"
	S.key = "arkher.net.remotefunction.serialization_codec"
	S.name = "Remote Function Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remotefunction.bandwidth_budget" }
	S.tags = { "r", "remotefunction", "codec", "net" }
	S.description = "Remote Function Serialization Codec: compact encoding, diffing and checksum of payloads for the Remote Function subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.remotefunction.serialization_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
