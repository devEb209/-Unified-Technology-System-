-- ARKHER SYSTEM G.0452 :: On Device Budget Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0452"
	S.key = "arkher.neural.ondevicebudget.reconstruction"
	S.name = "On Device Budget Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ondevicebudget.temporal_history" }
	S.tags = { "g", "ondevicebudget", "upscaler", "neural" }
	S.description = "On Device Budget Reconstruction: resolution ladder and image reconstruction for the On Device Budget subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.ondevicebudget.reconstruction", targetMs = 14.10, index = 3, sharpness = 0.53 })
		inst.system = S
		inst.ctx = ctx
