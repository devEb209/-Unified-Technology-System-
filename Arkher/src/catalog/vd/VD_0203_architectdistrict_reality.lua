-- ARKHER SYSTEM VD.0203 :: Architect District Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0203"
	S.key = "arkher.contsim.architectdistrict.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.architectdistrict.simulation_fabric" }
	S.tags = { "vd", "architectdistrict", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.architectdistrict.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
