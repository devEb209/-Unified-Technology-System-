-- ARKHER SYSTEM F.0383 :: Sharpening Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0383"
	S.key = "arkher.render.sharpening.lighting_rig"
	S.name = "Sharpening Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sharpening"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sharpening.geometry_virtualization" }
	S.tags = { "f", "sharpening", "lightrig", "render" }
	S.description = "Sharpening Lighting Rig: light clustering, importance and cascades for the Sharpening subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.sharpening.lighting_rig", maxActive = 6 })
		inst.system = S
		inst.ctx = ctx
