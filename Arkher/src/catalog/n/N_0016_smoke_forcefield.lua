-- ARKHER SYSTEM N.0016 :: Smoke Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0016"
	S.key = "arkher.vfx.smoke.force_field"
	S.name = "Smoke Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Smoke"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.smoke.particle_simulation" }
	S.tags = { "n", "smoke", "forcefield", "vfx" }
	S.description = "Smoke Force Field: wind, attraction, vortex, drag and curl turbulence for the Smoke subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.smoke.force_field", seed = 20959 })
		inst.system = S
		inst.ctx = ctx
