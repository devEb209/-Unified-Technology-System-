-- ARKHER SYSTEM O.0124 :: Wind Audio Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0124"
	S.key = "arkher.audio.windaudio.music_sequencer"
	S.name = "Wind Audio Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Wind Audio"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.windaudio.spatialization" }
	S.tags = { "o", "windaudio", "sequencer", "audio" }
	S.description = "Wind Audio Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Wind Audio subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.windaudio.music_sequencer", bpm = 140, beatsPerBar = 4, intensity = 0.35 })
		inst.system = S
		inst.ctx = ctx
