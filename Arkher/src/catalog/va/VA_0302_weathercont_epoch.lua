-- ARKHER SYSTEM VA.0302 :: Weather Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0302"
	S.key = "arkher.contworld.weathercont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.weathercont.infinite_grid" }
	S.tags = { "va", "weathercont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.weathercont.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
