-- ARKHER SYSTEM Z.0906 :: Deterministic Replay Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0906"
	S.key = "arkher.origin.deterministicreplay.emergence_detection"
	S.name = "Deterministic Replay Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deterministicreplay.world_memory" }
	S.tags = { "z", "deterministicreplay", "emergence", "origin" }
	S.description = "Deterministic Replay Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Deterministic Replay subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.deterministicreplay.emergence_detection", windowSize = 4, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
