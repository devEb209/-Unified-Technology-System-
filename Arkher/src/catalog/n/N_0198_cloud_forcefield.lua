-- ARKHER SYSTEM N.0198 :: Cloud Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0198"
	S.key = "arkher.vfx.cloud.force_field"
	S.name = "Cloud Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloud"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.cloud.particle_simulation" }
	S.tags = { "n", "cloud", "forcefield", "vfx" }
	S.description = "Cloud Force Field: wind, attraction, vortex, drag and curl turbulence for the Cloud subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.cloud.force_field", seed = 19848 })
		inst.system = S
		inst.ctx = ctx
