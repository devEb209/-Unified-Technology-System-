-- ARKHER SYSTEM Z.0339 :: Cross Reality Sync Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0339"
	S.key = "arkher.origin.crossreality.residency_streaming"
	S.name = "Cross Reality Sync Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.budget_governor" }
	S.tags = { "z", "crossreality", "streamer", "origin" }
	S.description = "Cross Reality Sync Residency Streaming: distance-driven residency of the technology's workload for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.crossreality.residency_streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
