-- ARKHER SYSTEM N.0425 :: Foliage Motion Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0425"
	S.key = "arkher.vfx.foliagemotion.result_cache"
	S.name = "Foliage Motion Result Cache"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.foliagemotion.spawn_budget" }
	S.tags = { "n", "foliagemotion", "cache", "vfx" }
	S.description = "Foliage Motion Result Cache: reuse of expensive effect evaluations for the Foliage Motion subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.foliagemotion.result_cache", policy = "lru", capacity = 498, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
