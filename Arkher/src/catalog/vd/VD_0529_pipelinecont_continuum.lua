-- ARKHER SYSTEM VD.0529 :: Pipeline Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0529"
	S.key = "arkher.contsim.pipelinecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "pipelinecont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.pipelinecont.infinite_grid", cellSize = 224, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
