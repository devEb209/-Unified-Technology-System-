-- ARKHER SYSTEM R.0305 :: Cross Server Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0305"
	S.key = "arkher.net.crossserver.bandwidth_budget"
	S.name = "Cross Server Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Cross Server"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.crossserver.transport_graph" }
	S.tags = { "r", "crossserver", "budgeter", "net" }
	S.description = "Cross Server Bandwidth Budget: bytes per second shared between competing streams for the Cross Server subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.crossserver.bandwidth_budget", total = 408, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
