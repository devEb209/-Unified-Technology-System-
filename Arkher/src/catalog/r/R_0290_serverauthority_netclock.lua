-- ARKHER SYSTEM R.0290 :: Server Authority Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0290"
	S.key = "arkher.net.serverauthority.time_sync"
	S.name = "Server Authority Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverauthority.replication" }
	S.tags = { "r", "serverauthority", "netclock", "net" }
	S.description = "Server Authority Time Sync: offset estimation, outlier rejection and jitter buffering for the Server Authority subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.serverauthority.time_sync", tickRate = 20, bufferDelay = 0.060, maxSamples = 16 })
		inst.system = S
		inst.ctx = ctx
