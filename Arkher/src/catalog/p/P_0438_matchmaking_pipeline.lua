-- ARKHER SYSTEM P.0438 :: Matchmaking Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0438"
	S.key = "arkher.play.matchmaking.rule_pipeline"
	S.name = "Matchmaking Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Matchmaking"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.matchmaking.state_machine" }
	S.tags = { "p", "matchmaking", "pipeline", "play" }
	S.description = "Matchmaking Rule Pipeline: ordered rules applied to every gameplay event for the Matchmaking subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.matchmaking.rule_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
