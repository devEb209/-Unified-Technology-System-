-- ARKHER SYSTEM I.0399 :: Animation Compression Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0399"
	S.key = "arkher.anim.animcompression.playback_pipeline"
	S.name = "Animation Compression Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animcompression.event_ledger" }
	S.tags = { "i", "animcompression", "pipeline", "anim" }
	S.description = "Animation Compression Playback Pipeline: ordered sample, blend, ik and output stages for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.animcompression.playback_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
