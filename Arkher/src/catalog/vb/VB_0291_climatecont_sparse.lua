-- ARKHER SYSTEM VB.0291 :: Climate Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0291"
	S.key = "arkher.conttime.climatecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.climatecont.epoch_clock" }
	S.tags = { "vb", "climatecont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.climatecont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
