-- ARKHER SYSTEM R.0208 :: Server Reconciliation Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0208"
	S.key = "arkher.net.serverreconciliation.transport_graph"
	S.name = "Server Reconciliation Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverreconciliation.prediction_and_reconciliation" }
	S.tags = { "r", "serverreconciliation", "network", "net" }
	S.description = "Server Reconciliation Transport Graph: topology, capacity and routing between endpoints for the Server Reconciliation subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.serverreconciliation.transport_graph" })
		inst.system = S
		inst.ctx = ctx
