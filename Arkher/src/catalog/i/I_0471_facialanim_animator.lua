-- ARKHER SYSTEM I.0471 :: Facial Animation Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0471"
	S.key = "arkher.anim.facialanim.layered_blending"
	S.name = "Facial Animation Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.facialanim.clip_sampling" }
	S.tags = { "i", "facialanim", "animator", "anim" }
	S.description = "Facial Animation Layered Blending: layers, crossfades, masks and blend trees for the Facial Animation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.facialanim.layered_blending", budget = 11 })
		inst.system = S
		inst.ctx = ctx
