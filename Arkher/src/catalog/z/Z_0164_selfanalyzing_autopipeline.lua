-- ARKHER SYSTEM Z.0164 :: Self Analyzing Project Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0164"
	S.key = "arkher.origin.selfanalyzing.autonomous_pipeline"
	S.name = "Self Analyzing Project Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.simulation_fabric" }
	S.tags = { "z", "selfanalyzing", "autopipeline", "origin" }
	S.description = "Self Analyzing Project Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.selfanalyzing.autonomous_pipeline", maxIterations = 4 })
		inst.system = S
		inst.ctx = ctx
