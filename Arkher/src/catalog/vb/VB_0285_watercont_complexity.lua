-- ARKHER SYSTEM VB.0285 :: Water Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0285"
	S.key = "arkher.conttime.watercont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.watercont.world_memory_stream" }
	S.tags = { "vb", "watercont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.watercont.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
