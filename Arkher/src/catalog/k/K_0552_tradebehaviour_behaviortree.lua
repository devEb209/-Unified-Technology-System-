-- ARKHER SYSTEM K.0552 :: Trade Behaviour Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0552"
	S.key = "arkher.npc.tradebehaviour.reactive_behaviour"
	S.name = "Trade Behaviour Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.tradebehaviour.perception" }
	S.tags = { "k", "tradebehaviour", "behaviortree", "npc" }
	S.description = "Trade Behaviour Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Trade Behaviour subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.tradebehaviour.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
