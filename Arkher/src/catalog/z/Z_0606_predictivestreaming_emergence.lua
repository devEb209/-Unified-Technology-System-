-- ARKHER SYSTEM Z.0606 :: Predictive Streaming Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0606"
	S.key = "arkher.origin.predictivestreaming.emergence_detection"
	S.name = "Predictive Streaming Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictivestreaming.world_memory" }
	S.tags = { "z", "predictivestreaming", "emergence", "origin" }
	S.description = "Predictive Streaming Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Predictive Streaming subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.predictivestreaming.emergence_detection", windowSize = 5, threshold = 1.40, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
