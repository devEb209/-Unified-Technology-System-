-- ARKHER SYSTEM VA.0523 :: Asset Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0523"
	S.key = "arkher.contworld.assetcont.neural_field"
	S.name = "Asset Continuum Neural Field"
	S.category = "VA"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.assetcont.coherence_guard" }
	S.tags = { "va", "assetcont", "neuralfield", "contworld" }
	S.description = "Asset Continuum Neural Field: neural field encoding and reconstruction for the Asset Continuum subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.assetcont.neural_field", dims = 24, hidden = 20, seed = 7819 })
		inst.system = S
		inst.ctx = ctx
