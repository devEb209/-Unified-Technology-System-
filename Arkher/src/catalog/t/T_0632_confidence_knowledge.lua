-- ARKHER SYSTEM T.0632 :: Confidence Estimation Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0632"
	S.key = "arkher.ai.confidence.semantic_knowledge"
	S.name = "Confidence Estimation Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.confidence.intent_understanding" }
	S.tags = { "t", "confidence", "knowledge", "ai" }
	S.description = "Confidence Estimation Semantic Knowledge: typed entities, weighted relations and inferred closure for the Confidence Estimation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.confidence.semantic_knowledge", dims = 24 })
		inst.system = S
		inst.ctx = ctx
