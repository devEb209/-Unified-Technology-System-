-- ARKHER SYSTEM P.0366 :: Death And Respawn Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0366"
	S.key = "arkher.play.deathrespawn.rule_pipeline"
	S.name = "Death And Respawn Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.deathrespawn.state_machine" }
	S.tags = { "p", "deathrespawn", "pipeline", "play" }
	S.description = "Death And Respawn Rule Pipeline: ordered rules applied to every gameplay event for the Death And Respawn subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.deathrespawn.rule_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
