-- ARKHER SYSTEM L.0529 :: Disease Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0529"
	S.key = "arkher.sim.disease.society"
	S.name = "Disease Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.disease.economy" }
	S.tags = { "l", "disease", "society", "sim" }
	S.description = "Disease Society: relations, factions, reputation and cohesion of the region for the Disease subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.disease.society", decayRate = 0.013, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
