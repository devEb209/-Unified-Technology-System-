-- ARKHER SYSTEM N.0150 :: Rain Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0150"
	S.key = "arkher.vfx.rain.effect_composition"
	S.name = "Rain Effect Composition"
	S.category = "N"
	S.family = "VFX"
	S.area = "Rain"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.rain.effect_graph" }
	S.tags = { "n", "rain", "composer", "vfx" }
	S.description = "Rain Effect Composition: blending of several effect signals into one output for the Rain subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.rain.effect_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
