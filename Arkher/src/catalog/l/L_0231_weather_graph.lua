-- ARKHER SYSTEM L.0231 :: Weather Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0231"
	S.key = "arkher.sim.weather.region_graph"
	S.name = "Weather Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.weather.calendar" }
	S.tags = { "l", "weather", "graph", "sim" }
	S.description = "Weather Region Graph: connectivity, components and shortest path between places for the Weather subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.weather.region_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
