-- ARKHER SYSTEM V.0292 :: LOD Chain Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0292"
	S.key = "arkher.asset.lodchain.asset_registry"
	S.name = "LOD Chain Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lodchain.cook_pipeline" }
	S.tags = { "v", "lodchain", "registry", "asset" }
	S.description = "LOD Chain Asset Registry: catalogue of every asset, its tags and its metadata for the LOD Chain subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.lodchain.asset_registry" })
		inst.system = S
		inst.ctx = ctx
