-- ARKHER SYSTEM Z.0247 :: AI Native Engine Architecture World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0247"
	S.key = "arkher.origin.ainative.world_architect"
	S.name = "AI Native Engine Architecture World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.ainative.emergence_detection" }
	S.tags = { "z", "ainative", "architect", "origin" }
	S.description = "AI Native Engine Architecture World Architect: hierarchical world composition with conserved budgets for the AI Native Engine Architecture subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.ainative.world_architect", budget = 1200, seed = 39896 })
		inst.system = S
		inst.ctx = ctx
