-- ARKHER SYSTEM V.0188 :: Scene Asset Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0188"
	S.key = "arkher.asset.sceneasset.compression_codec"
	S.name = "Scene Asset Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.sceneasset.streaming_residency" }
	S.tags = { "v", "sceneasset", "codec", "asset" }
	S.description = "Scene Asset Compression Codec: compact encoding, diffing and checksum of asset payloads for the Scene Asset subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.sceneasset.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
