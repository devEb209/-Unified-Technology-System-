-- ARKHER SYSTEM F.0412 :: Instanced Draw Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0412"
	S.key = "arkher.render.instanced.probe_volume"
	S.name = "Instanced Draw Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.instanced.lighting_rig" }
	S.tags = { "f", "instanced", "probe", "render" }
	S.description = "Instanced Draw Probe Volume: irradiance probes encoded in spherical harmonics for the Instanced Draw subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.instanced.probe_volume", spacing = 24 })
		inst.system = S
		inst.ctx = ctx
