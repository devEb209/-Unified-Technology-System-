-- ARKHER SYSTEM Z.0211 :: Persistent Reality State Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0211"
	S.key = "arkher.origin.persistentreality.adaptive_workflow"
	S.name = "Persistent Reality State Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.self_critique" }
	S.tags = { "z", "persistentreality", "workflow", "origin" }
	S.description = "Persistent Reality State Adaptive Workflow: verified, retryable, reversible execution plans for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.persistentreality.adaptive_workflow", maxRetries = 2, budget = 80 })
		inst.system = S
		inst.ctx = ctx
