-- ARKHER SYSTEM K.0331 :: Curiosity Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0331"
	S.key = "arkher.npc.curiosity.navigation"
	S.name = "Curiosity Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.curiosity.goal_planner" }
	S.tags = { "k", "curiosity", "navgraph", "npc" }
	S.description = "Curiosity Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Curiosity subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.curiosity.navigation", width = 48, height = 48, cellSize = 5 })
		inst.system = S
		inst.ctx = ctx
