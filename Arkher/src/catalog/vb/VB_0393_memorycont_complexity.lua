-- ARKHER SYSTEM VB.0393 :: Memory Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0393"
	S.key = "arkher.conttime.memorycont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memorycont.world_memory_stream" }
	S.tags = { "vb", "memorycont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.memorycont.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
