-- ARKHER SYSTEM I.0355 :: Hit Reaction Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0355"
	S.key = "arkher.anim.hitreaction.inverse_kinematics"
	S.name = "Hit Reaction Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Hit Reaction"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.hitreaction.layered_blending" }
	S.tags = { "i", "hitreaction", "ik", "anim" }
	S.description = "Hit Reaction Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Hit Reaction subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.hitreaction.inverse_kinematics", iterations = 6, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
