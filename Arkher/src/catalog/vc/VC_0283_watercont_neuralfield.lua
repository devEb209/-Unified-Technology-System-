-- ARKHER SYSTEM VC.0283 :: Water Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0283"
	S.key = "arkher.contneural.watercont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.watercont.coherence_guard" }
	S.tags = { "vc", "watercont", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.watercont.neural_field", dims = 16, hidden = 12, seed = 49025 })
		inst.system = S
		inst.ctx = ctx
