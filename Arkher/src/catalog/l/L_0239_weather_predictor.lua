-- ARKHER SYSTEM L.0239 :: Weather Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0239"
	S.key = "arkher.sim.weather.forecast"
	S.name = "Weather Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.weather.analysis" }
	S.tags = { "l", "weather", "predictor", "sim" }
	S.description = "Weather Forecast: prediction of the region's next state for the Weather subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.weather.forecast", method = "ema", alpha = 0.27, window = 41 })
		inst.system = S
		inst.ctx = ctx
