-- ARKHER SYSTEM N.0284 :: Heal Effect Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0284"
	S.key = "arkher.vfx.healfx.spatial_index"
	S.name = "Heal Effect Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Heal Effect"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.healfx.quality_policy" }
	S.tags = { "n", "healfx", "index", "vfx" }
	S.description = "Heal Effect Spatial Index: spatial acceleration of effect queries and culling for the Heal Effect subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.healfx.spatial_index", mode = "hash", cellSize = 16 })
		inst.system = S
		inst.ctx = ctx
