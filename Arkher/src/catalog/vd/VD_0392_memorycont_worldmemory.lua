-- ARKHER SYSTEM VD.0392 :: Memory Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0392"
	S.key = "arkher.contsim.memorycont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memorycont.neural_field" }
	S.tags = { "vd", "memorycont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.memorycont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
