-- ARKHER SYSTEM Z.0025 :: Predictive Optimization World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0025"
	S.key = "arkher.origin.predictiveopt.world_memory"
	S.name = "Predictive Optimization World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.autonomous_pipeline" }
	S.tags = { "z", "predictiveopt", "worldmemory", "origin" }
	S.description = "Predictive Optimization World Memory: epoch-stamped persistent history with compaction and checkpoints for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.predictiveopt.world_memory", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
