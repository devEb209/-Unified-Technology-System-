-- ARKHER SYSTEM T.0631 :: Confidence Estimation Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0631"
	S.key = "arkher.ai.confidence.intent_understanding"
	S.name = "Confidence Estimation Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "confidence", "intent", "ai" }
	S.description = "Confidence Estimation Intent Understanding: natural language turned into an actionable, scored intent for the Confidence Estimation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.confidence.intent_understanding", minConfidence = 0.31 })
		inst.system = S
		inst.ctx = ctx
