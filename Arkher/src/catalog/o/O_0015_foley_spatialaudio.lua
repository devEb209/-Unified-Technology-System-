-- ARKHER SYSTEM O.0015 :: Foley Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0015"
	S.key = "arkher.audio.foley.spatialization"
	S.name = "Foley Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Foley"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.foley.mixer_bus" }
	S.tags = { "o", "foley", "spatialaudio", "audio" }
	S.description = "Foley Spatialization: distance attenuation, panning, occlusion and doppler for the Foley subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.foley.spatialization", model = "linear", refDistance = 7, maxDistance = 240, rolloff = 1.18, maxVoices = 28 })
		inst.system = S
		inst.ctx = ctx
