-- ARKHER SYSTEM E.0523 :: Parameter Animation Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0523"
	S.key = "arkher.material.paramanim.authoring_pipeline"
	S.name = "Parameter Animation Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.paramanim.analysis" }
	S.tags = { "e", "paramanim", "pipeline", "material" }
	S.description = "Parameter Animation Authoring Pipeline: ordered authoring and bake stages for the Parameter Animation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.paramanim.authoring_pipeline", budgetMs = 7.00 })
		inst.system = S
		inst.ctx = ctx
