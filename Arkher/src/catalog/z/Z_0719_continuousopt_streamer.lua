-- ARKHER SYSTEM Z.0719 :: Continuous Self Optimization Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0719"
	S.key = "arkher.origin.continuousopt.residency_streaming"
	S.name = "Continuous Self Optimization Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.budget_governor" }
	S.tags = { "z", "continuousopt", "streamer", "origin" }
	S.description = "Continuous Self Optimization Residency Streaming: distance-driven residency of the technology's workload for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.continuousopt.residency_streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
