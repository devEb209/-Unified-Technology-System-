-- ARKHER SYSTEM P.0253 :: Dialogue Choice Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0253"
	S.key = "arkher.play.dialoguechoice.attributes"
	S.name = "Dialogue Choice Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "dialoguechoice", "stats", "play" }
	S.description = "Dialogue Choice Attributes: base values, layered modifiers and derived statistics for the Dialogue Choice subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.dialoguechoice.attributes" })
		inst.system = S
		inst.ctx = ctx
