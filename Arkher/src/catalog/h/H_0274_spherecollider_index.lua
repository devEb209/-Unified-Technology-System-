-- ARKHER SYSTEM H.0274 :: Sphere Collider Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0274"
	S.key = "arkher.physics.spherecollider.broadphase_index"
	S.name = "Sphere Collider Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.spherecollider.vehicle" }
	S.tags = { "h", "spherecollider", "index", "physics" }
	S.description = "Sphere Collider Broadphase Index: spatial acceleration of candidate pair finding for the Sphere Collider subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.spherecollider.broadphase_index", mode = "hash", cellSize = 96 })
		inst.system = S
		inst.ctx = ctx
