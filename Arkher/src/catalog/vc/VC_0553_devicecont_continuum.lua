-- ARKHER SYSTEM VC.0553 :: Device Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0553"
	S.key = "arkher.contneural.devicecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "devicecont", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.devicecont.infinite_grid", cellSize = 224, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
