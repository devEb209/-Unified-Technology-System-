-- ARKHER SYSTEM Q.0089 :: Scroll View Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0089"
	S.key = "arkher.ui.scrollview.navigation_graph"
	S.name = "Scroll View Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Scroll View"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.scrollview.transition" }
	S.tags = { "q", "scrollview", "graph", "ui" }
	S.description = "Scroll View Navigation Graph: screens, routes and shortest path between them for the Scroll View subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.scrollview.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
