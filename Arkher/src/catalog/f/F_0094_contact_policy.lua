-- ARKHER SYSTEM F.0094 :: Contact Shadows Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0094"
	S.key = "arkher.render.contact.render_policy"
	S.name = "Contact Shadows Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.contact.draw_budget" }
	S.tags = { "f", "contact", "policy", "render" }
	S.description = "Contact Shadows Render Policy: device tier rules for the frame for the Contact Shadows subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.contact.render_policy", algorithm = "roundrobin", starvationGuard = 20 })
		inst.system = S
		inst.ctx = ctx
