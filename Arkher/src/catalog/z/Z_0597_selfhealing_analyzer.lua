-- ARKHER SYSTEM Z.0597 :: Self Healing Systems Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0597"
	S.key = "arkher.origin.selfhealing.behaviour_analysis"
	S.name = "Self Healing Systems Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfhealing.governance_policy" }
	S.tags = { "z", "selfhealing", "analyzer", "origin" }
	S.description = "Self Healing Systems Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.selfhealing.behaviour_analysis", window = 158, buckets = 18, threshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
