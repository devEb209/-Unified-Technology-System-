-- ARKHER SYSTEM T.0002 :: Intent Parsing Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0002"
	S.key = "arkher.ai.intentparsing.semantic_knowledge"
	S.name = "Intent Parsing Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.intentparsing.intent_understanding" }
	S.tags = { "t", "intentparsing", "knowledge", "ai" }
	S.description = "Intent Parsing Semantic Knowledge: typed entities, weighted relations and inferred closure for the Intent Parsing subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.intentparsing.semantic_knowledge", dims = 40 })
		inst.system = S
		inst.ctx = ctx
