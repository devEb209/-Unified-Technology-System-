-- ARKHER SYSTEM I.0343 :: Physical Animation Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0343"
	S.key = "arkher.anim.physanim.physical_blend"
	S.name = "Physical Animation Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.physanim.inverse_kinematics" }
	S.tags = { "i", "physanim", "ragdoll", "anim" }
	S.description = "Physical Animation Physical Blend: physical bones blended against the animated pose for the Physical Animation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.physanim.physical_blend", blendSpeed = 5.60 })
		inst.system = S
		inst.ctx = ctx
