-- ARKHER SYSTEM VD.0590 :: Horizon Span Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0590"
	S.key = "arkher.contsim.horizonspan.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.horizonspan.infinite_grid" }
	S.tags = { "vd", "horizonspan", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.horizonspan.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
