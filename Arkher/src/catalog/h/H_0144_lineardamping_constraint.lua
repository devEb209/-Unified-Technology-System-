-- ARKHER SYSTEM H.0144 :: Linear Damping Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0144"
	S.key = "arkher.physics.lineardamping.constraint_solver"
	S.name = "Linear Damping Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.lineardamping.contact_generation" }
	S.tags = { "h", "lineardamping", "constraint", "physics" }
	S.description = "Linear Damping Constraint Solver: sequential impulses, friction, joints and warm starting for the Linear Damping subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.lineardamping.constraint_solver", iterations = 9, baumgarte = 0.15, warmStart = true })
		inst.system = S
		inst.ctx = ctx
