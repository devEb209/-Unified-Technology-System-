-- ARKHER SYSTEM VB.0136 :: Fidelity Band Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0136"
	S.key = "arkher.conttime.fidelityband.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.fidelityband.sparse_residency" }
	S.tags = { "vb", "fidelityband", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.fidelityband.multi-scale_fidelity", levels = 4, baseTriangles = 150000 })
		inst.system = S
		inst.ctx = ctx
