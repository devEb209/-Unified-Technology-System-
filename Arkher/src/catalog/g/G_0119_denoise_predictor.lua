-- ARKHER SYSTEM G.0119 :: Denoising Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0119"
	S.key = "arkher.neural.denoise.quality_predictor"
	S.name = "Denoising Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.denoise.weight_codec" }
	S.tags = { "g", "denoise", "predictor", "neural" }
	S.description = "Denoising Quality Predictor: predicted quality and cost of a setting for the Denoising subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.denoise.quality_predictor", method = "ema", alpha = 0.11, window = 41 })
		inst.system = S
		inst.ctx = ctx
