-- ARKHER SYSTEM W.0269 :: Letterbox Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0269"
	S.key = "arkher.cine.letterbox.cut_policy"
	S.name = "Letterbox Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Letterbox"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.letterbox.shot_composition" }
	S.tags = { "w", "letterbox", "policy", "cine" }
	S.description = "Letterbox Cut Policy: rules deciding when the sequence cuts and to what for the Letterbox subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.letterbox.cut_policy", algorithm = "edf", starvationGuard = 33 })
		inst.system = S
		inst.ctx = ctx
