-- ARKHER SYSTEM N.0067 :: Debris Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0067"
	S.key = "arkher.vfx.debris.particle_simulation"
	S.name = "Debris Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Debris"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.debris.emission" }
	S.tags = { "n", "debris", "particles", "vfx" }
	S.description = "Debris Particle Simulation: pooled integration of position, velocity, colour and life for the Debris subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.debris.particle_simulation", capacity = 256, drag = 0.07, bounce = 0.12, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
