-- ARKHER SYSTEM E.0271 :: Decal Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0271"
	S.key = "arkher.material.decal.definition"
	S.name = "Decal Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Decal"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "decal", "material", "material" }
	S.description = "Decal Definition: layered PBR definition resolved into parameters for the Decal subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.decal.definition", texelBudget = 524288 })
		inst.system = S
		inst.ctx = ctx
