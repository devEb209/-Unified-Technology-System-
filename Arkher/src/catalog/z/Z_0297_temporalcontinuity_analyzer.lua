-- ARKHER SYSTEM Z.0297 :: Temporal Continuity Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0297"
	S.key = "arkher.origin.temporalcontinuity.behaviour_analysis"
	S.name = "Temporal Continuity Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.temporalcontinuity.governance_policy" }
	S.tags = { "z", "temporalcontinuity", "analyzer", "origin" }
	S.description = "Temporal Continuity Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Temporal Continuity subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.temporalcontinuity.behaviour_analysis", window = 96, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
