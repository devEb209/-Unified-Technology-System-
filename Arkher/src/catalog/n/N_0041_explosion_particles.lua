-- ARKHER SYSTEM N.0041 :: Explosion Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0041"
	S.key = "arkher.vfx.explosion.particle_simulation"
	S.name = "Explosion Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Explosion"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.explosion.emission" }
	S.tags = { "n", "explosion", "particles", "vfx" }
	S.description = "Explosion Particle Simulation: pooled integration of position, velocity, colour and life for the Explosion subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.explosion.particle_simulation", capacity = 576, drag = 0.24, bounce = 0.19, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
