-- ARKHER SYSTEM VC.0468 :: Audio Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0468"
	S.key = "arkher.contneural.audiocont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.audiocont.reality_continuum" }
	S.tags = { "vc", "audiocont", "emergence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.audiocont.emergence_continuum", windowSize = 7, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
