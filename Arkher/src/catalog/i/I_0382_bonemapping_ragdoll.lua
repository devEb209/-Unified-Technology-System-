-- ARKHER SYSTEM I.0382 :: Bone Mapping Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0382"
	S.key = "arkher.anim.bonemapping.physical_blend"
	S.name = "Bone Mapping Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bone Mapping"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonemapping.inverse_kinematics" }
	S.tags = { "i", "bonemapping", "ragdoll", "anim" }
	S.description = "Bone Mapping Physical Blend: physical bones blended against the animated pose for the Bone Mapping subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.bonemapping.physical_blend", blendSpeed = 4.30 })
		inst.system = S
		inst.ctx = ctx
