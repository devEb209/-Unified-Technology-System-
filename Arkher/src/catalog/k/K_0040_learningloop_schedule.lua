-- ARKHER SYSTEM K.0040 :: Learning Loop Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0040"
	S.key = "arkher.npc.learningloop.daily_schedule"
	S.name = "Learning Loop Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.learningloop.social_relations" }
	S.tags = { "k", "learningloop", "schedule", "npc" }
	S.description = "Learning Loop Daily Schedule: hour-by-hour routine with priority interruptions for the Learning Loop subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.learningloop.daily_schedule", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
