-- ARKHER SYSTEM Z.0852 :: Simulation Time Dilation Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0852"
	S.key = "arkher.origin.timedilation.predictive_optimization"
	S.name = "Simulation Time Dilation Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.adaptive_workflow" }
	S.tags = { "z", "timedilation", "predictor", "origin" }
	S.description = "Simulation Time Dilation Predictive Optimization: forecast-driven optimization before the cost is paid for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.timedilation.predictive_optimization", method = "linear", alpha = 0.16, window = 126 })
		inst.system = S
		inst.ctx = ctx
