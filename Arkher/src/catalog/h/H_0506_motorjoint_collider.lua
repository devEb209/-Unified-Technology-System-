-- ARKHER SYSTEM H.0506 :: Motorized Joint Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0506"
	S.key = "arkher.physics.motorjoint.collision_shape"
	S.name = "Motorized Joint Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.motorjoint.body_dynamics" }
	S.tags = { "h", "motorjoint", "collider", "physics" }
	S.description = "Motorized Joint Collision Shape: shape bounds, support mapping and closest points for the Motorized Joint subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.motorjoint.collision_shape", shape = "box", radius = 2.60, height = 2.20, layer = "character" })
		inst.system = S
		inst.ctx = ctx
