-- ARKHER SYSTEM I.0056 :: Animation Clip Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0056"
	S.key = "arkher.anim.animclip.inverse_kinematics"
	S.name = "Animation Clip Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animclip.layered_blending" }
	S.tags = { "i", "animclip", "ik", "anim" }
	S.description = "Animation Clip Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.animclip.inverse_kinematics", iterations = 12, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
