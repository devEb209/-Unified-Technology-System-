-- ARKHER SYSTEM Z.0559 :: Reputation Web Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0559"
	S.key = "arkher.origin.reputationweb.residency_streaming"
	S.name = "Reputation Web Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.budget_governor" }
	S.tags = { "z", "reputationweb", "streamer", "origin" }
	S.description = "Reputation Web Residency Streaming: distance-driven residency of the technology's workload for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.reputationweb.residency_streaming", radius = 280, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
