-- ARKHER SYSTEM H.0166 :: Angular Damping Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0166"
	S.key = "arkher.physics.angulardamping.analysis"
	S.name = "Angular Damping Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.angulardamping.result_cache" }
	S.tags = { "h", "angulardamping", "analyzer", "physics" }
	S.description = "Angular Damping Analysis: energy, jitter and cost analysis of the simulation for the Angular Damping subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.angulardamping.analysis", window = 206, buckets = 10, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
