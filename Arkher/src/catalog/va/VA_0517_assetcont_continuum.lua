-- ARKHER SYSTEM VA.0517 :: Asset Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0517"
	S.key = "arkher.contworld.assetcont.infinite_grid"
	S.name = "Asset Continuum Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "assetcont", "continuum", "contworld" }
	S.description = "Asset Continuum Infinite Grid: seamless paging of the infinite world grid for the Asset Continuum subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.assetcont.infinite_grid", cellSize = 192, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
