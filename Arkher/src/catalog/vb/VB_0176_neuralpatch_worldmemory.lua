-- ARKHER SYSTEM VB.0176 :: Neural Patch World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0176"
	S.key = "arkher.conttime.neuralpatch.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.neuralpatch.neural_field" }
	S.tags = { "vb", "neuralpatch", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.neuralpatch.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
