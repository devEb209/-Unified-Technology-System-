-- ARKHER SYSTEM H.0543 :: Rope Simulation Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0543"
	S.key = "arkher.physics.rope.result_cache"
	S.name = "Rope Simulation Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rope.simulation_policy" }
	S.tags = { "h", "rope", "cache", "physics" }
	S.description = "Rope Simulation Result Cache: reuse of expensive simulation and query results for the Rope Simulation subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.rope.result_cache", policy = "ttl", capacity = 145, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
