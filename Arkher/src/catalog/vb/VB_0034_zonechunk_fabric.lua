-- ARKHER SYSTEM VB.0034 :: Zone Chunk Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0034"
	S.key = "arkher.conttime.zonechunk.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.zonechunk.complexity_budget" }
	S.tags = { "vb", "zonechunk", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.zonechunk.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
