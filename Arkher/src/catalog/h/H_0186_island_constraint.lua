-- ARKHER SYSTEM H.0186 :: Island Solver Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0186"
	S.key = "arkher.physics.island.constraint_solver"
	S.name = "Island Solver Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.island.contact_generation" }
	S.tags = { "h", "island", "constraint", "physics" }
	S.description = "Island Solver Constraint Solver: sequential impulses, friction, joints and warm starting for the Island Solver subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.island.constraint_solver", iterations = 7, baumgarte = 0.23, warmStart = true })
		inst.system = S
		inst.ctx = ctx
