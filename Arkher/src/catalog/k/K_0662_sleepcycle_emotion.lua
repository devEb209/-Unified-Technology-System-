-- ARKHER SYSTEM K.0662 :: Sleep Cycle Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0662"
	S.key = "arkher.npc.sleepcycle.emotion"
	S.name = "Sleep Cycle Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.sleepcycle.drive_system" }
	S.tags = { "k", "sleepcycle", "emotion", "npc" }
	S.description = "Sleep Cycle Emotion: appraisal of events into valence, arousal and mood for the Sleep Cycle subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.sleepcycle.emotion", inertia = 0.80, decayRate = 0.35, baselineArousal = 0.15 })
		inst.system = S
		inst.ctx = ctx
