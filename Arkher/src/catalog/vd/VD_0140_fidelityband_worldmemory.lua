-- ARKHER SYSTEM VD.0140 :: Fidelity Band World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0140"
	S.key = "arkher.contsim.fidelityband.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.fidelityband.neural_field" }
	S.tags = { "vd", "fidelityband", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.fidelityband.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
