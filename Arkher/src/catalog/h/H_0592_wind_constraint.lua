-- ARKHER SYSTEM H.0592 :: Wind Force Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0592"
	S.key = "arkher.physics.wind.constraint_solver"
	S.name = "Wind Force Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Wind Force"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.wind.contact_generation" }
	S.tags = { "h", "wind", "constraint", "physics" }
	S.description = "Wind Force Constraint Solver: sequential impulses, friction, joints and warm starting for the Wind Force subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.wind.constraint_solver", iterations = 9, baumgarte = 0.15, warmStart = true })
		inst.system = S
		inst.ctx = ctx
