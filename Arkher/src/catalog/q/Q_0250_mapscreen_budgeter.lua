-- ARKHER SYSTEM Q.0250 :: Map Screen Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0250"
	S.key = "arkher.ui.mapscreen.frame_budget"
	S.name = "Map Screen Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Map Screen"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.mapscreen.accessibility_policy" }
	S.tags = { "q", "mapscreen", "budgeter", "ui" }
	S.description = "Map Screen Frame Budget: per-frame layout and draw budget for the interface for the Map Screen subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.mapscreen.frame_budget", total = 424, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
