-- ARKHER SYSTEM VC.0457 :: Audio Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0457"
	S.key = "arkher.contneural.audiocont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "audiocont", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.audiocont.infinite_grid", cellSize = 160, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
