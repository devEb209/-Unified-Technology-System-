-- ARKHER SYSTEM O.0006 :: Footstep Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0006"
	S.key = "arkher.audio.footstep.streaming"
	S.name = "Footstep Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Footstep"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.footstep.voice_budget" }
	S.tags = { "o", "footstep", "streamer", "audio" }
	S.description = "Footstep Streaming: distance-driven residency of audio assets for the Footstep subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.footstep.streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
