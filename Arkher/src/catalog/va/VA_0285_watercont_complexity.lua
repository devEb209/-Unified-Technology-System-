-- ARKHER SYSTEM VA.0285 :: Water Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0285"
	S.key = "arkher.contworld.watercont.complexity_budget"
	S.name = "Water Continuum Complexity Budget"
	S.category = "VA"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.watercont.world_memory_stream" }
	S.tags = { "va", "watercont", "complexity", "contworld" }
	S.description = "Water Continuum Complexity Budget: complexity budgeting for the continuum for the Water Continuum subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.watercont.complexity_budget", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
