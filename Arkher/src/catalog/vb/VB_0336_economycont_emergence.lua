-- ARKHER SYSTEM VB.0336 :: Economy Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0336"
	S.key = "arkher.conttime.economycont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.economycont.reality_continuum" }
	S.tags = { "vb", "economycont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.economycont.emergence_continuum", windowSize = 4, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
