-- ARKHER SYSTEM F.0508 :: Mesh LOD Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0508"
	S.key = "arkher.render.meshlod.geometry_virtualization"
	S.name = "Mesh LOD Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Mesh LOD"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.meshlod.visibility_set" }
	S.tags = { "f", "meshlod", "impostor", "render" }
	S.description = "Mesh LOD Geometry Virtualization: impostor and HLOD synthesis under a budget for the Mesh LOD subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.meshlod.geometry_virtualization", atlasSlots = 48, viewCount = 8, errorThreshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
