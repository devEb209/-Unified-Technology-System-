-- ARKHER SYSTEM L.0277 :: Day Night Cycle Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0277"
	S.key = "arkher.sim.daynight.route_network"
	S.name = "Day Night Cycle Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.daynight.region_graph" }
	S.tags = { "l", "daynight", "network", "sim" }
	S.description = "Day Night Cycle Route Network: roads, rivers and routes between settlements for the Day Night Cycle subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.daynight.route_network" })
		inst.system = S
		inst.ctx = ctx
