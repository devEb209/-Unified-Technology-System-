-- ARKHER SYSTEM I.0488 :: Morph Target Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0488"
	S.key = "arkher.anim.morphtarget.compression_codec"
	S.name = "Morph Target Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Morph Target"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.morphtarget.retarget_graph" }
	S.tags = { "i", "morphtarget", "codec", "anim" }
	S.description = "Morph Target Compression Codec: curve compression and quantized transport for the Morph Target subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.morphtarget.compression_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
