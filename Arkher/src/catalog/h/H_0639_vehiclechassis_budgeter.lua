-- ARKHER SYSTEM H.0639 :: Vehicle Chassis Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0639"
	S.key = "arkher.physics.vehiclechassis.budget_governor"
	S.name = "Vehicle Chassis Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.vehiclechassis.broadphase_index" }
	S.tags = { "h", "vehiclechassis", "budgeter", "physics" }
	S.description = "Vehicle Chassis Budget Governor: simulation time budget allocation across islands for the Vehicle Chassis subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.vehiclechassis.budget_governor", total = 330, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
