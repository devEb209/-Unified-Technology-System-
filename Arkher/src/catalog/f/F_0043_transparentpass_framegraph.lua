-- ARKHER SYSTEM F.0043 :: Transparent Pass Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0043"
	S.key = "arkher.render.transparentpass.frame_graph"
	S.name = "Transparent Pass Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "transparentpass", "framegraph", "render" }
	S.description = "Transparent Pass Frame Graph: declared passes, culling, ordering and aliasing for the Transparent Pass subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.transparentpass.frame_graph", budgetMs = 12.00 })
		inst.system = S
		inst.ctx = ctx
