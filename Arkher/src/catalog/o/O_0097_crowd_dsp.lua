-- ARKHER SYSTEM O.0097 :: Crowd DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0097"
	S.key = "arkher.audio.crowd.dsp_chain"
	S.name = "Crowd DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Crowd"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "crowd", "dsp", "audio" }
	S.description = "Crowd DSP Chain: biquad filtering, delay, envelope and soft clipping for the Crowd subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.crowd.dsp_chain", sampleRate = 22050, filter = "highpass", cutoff = 600, q = 0.510 })
		inst.system = S
		inst.ctx = ctx
