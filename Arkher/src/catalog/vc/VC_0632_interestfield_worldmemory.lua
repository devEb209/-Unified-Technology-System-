-- ARKHER SYSTEM VC.0632 :: Interest Field World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0632"
	S.key = "arkher.contneural.interestfield.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.interestfield.neural_field" }
	S.tags = { "vc", "interestfield", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.interestfield.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
