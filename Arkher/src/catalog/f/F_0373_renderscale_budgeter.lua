-- ARKHER SYSTEM F.0373 :: Render Scale Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0373"
	S.key = "arkher.render.renderscale.draw_budget"
	S.name = "Render Scale Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Render Scale"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.renderscale.adaptive_resolution" }
	S.tags = { "f", "renderscale", "budgeter", "render" }
	S.description = "Render Scale Draw Budget: draw call and triangle budget allocation for the Render Scale subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.renderscale.draw_budget", total = 220, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
