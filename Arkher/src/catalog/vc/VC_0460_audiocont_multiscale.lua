-- ARKHER SYSTEM VC.0460 :: Audio Continuum Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VC.0460"
	S.key = "arkher.contneural.audiocont.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.audiocont.sparse_residency" }
	S.tags = { "vc", "audiocont", "multiscale", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contneural.audiocont.multi-scale_fidelity", levels = 6, baseTriangles = 75000 })
		inst.system = S
		inst.ctx = ctx
