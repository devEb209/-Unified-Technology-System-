...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Gaea Nodes — CORE Map #0138", size=Vector2.new(600, 480), pos=UDim2.fromOffset(294, 86), parent=parent, icon="♪"})
