-- ARKHER SYSTEM VB.0411 :: Behaviour Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0411"
	S.key = "arkher.conttime.behaviourcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.behaviourcont.epoch_clock" }
	S.tags = { "vb", "behaviourcont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.behaviourcont.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
