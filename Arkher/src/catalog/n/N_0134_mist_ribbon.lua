-- ARKHER SYSTEM N.0134 :: Waterfall Mist Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0134"
	S.key = "arkher.vfx.mist.ribbon_and_trail"
	S.name = "Waterfall Mist Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.mist.force_field" }
	S.tags = { "n", "mist", "ribbon", "vfx" }
	S.description = "Waterfall Mist Ribbon And Trail: trail points, tapering, beams and decimation for the Waterfall Mist subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.mist.ribbon_and_trail", maxPoints = 40, lifetime = 0.60, minDistance = 0.15, width = 1.10 })
		inst.system = S
		inst.ctx = ctx
