-- ARKHER SYSTEM VD.0596 :: Horizon Span World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0596"
	S.key = "arkher.contsim.horizonspan.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.horizonspan.neural_field" }
	S.tags = { "vd", "horizonspan", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.horizonspan.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
