-- ARKHER SYSTEM Q.0017 :: Panel Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0017"
	S.key = "arkher.ui.panel.navigation_graph"
	S.name = "Panel Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Panel"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.panel.transition" }
	S.tags = { "q", "panel", "graph", "ui" }
	S.description = "Panel Navigation Graph: screens, routes and shortest path between them for the Panel subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.panel.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
