-- ARKHER SYSTEM L.0163 :: Agriculture Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0163"
	S.key = "arkher.sim.agriculture.analysis"
	S.name = "Agriculture Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.agriculture.aggregate_cache" }
	S.tags = { "l", "agriculture", "analyzer", "sim" }
	S.description = "Agriculture Analysis: trend, anomaly and stability analysis of the world for the Agriculture subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.agriculture.analysis", window = 73, buckets = 17, threshold = 3.50 })
		inst.system = S
		inst.ctx = ctx
