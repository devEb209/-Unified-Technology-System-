-- ARKHER SYSTEM E.0463 :: Procedural Texture Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0463"
	S.key = "arkher.material.proctex.authoring_pipeline"
	S.name = "Procedural Texture Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.proctex.analysis" }
	S.tags = { "e", "proctex", "pipeline", "material" }
	S.description = "Procedural Texture Authoring Pipeline: ordered authoring and bake stages for the Procedural Texture subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.proctex.authoring_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
