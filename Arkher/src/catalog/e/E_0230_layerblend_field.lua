-- ARKHER SYSTEM E.0230 :: Layer Blending Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0230"
	S.key = "arkher.material.layerblend.procedural_detail"
	S.name = "Layer Blending Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Layer Blending"
	S.aspect = "Procedural Detail"
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.layerblend.texture_sampling" }
	S.tags = { "e", "layerblend", "field", "material" }
	S.description = "Layer Blending Procedural Detail: coherent noise detail driving the surface for the Layer Blending subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.layerblend.procedural_detail", seed = 38895, frequency = 0.0077, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
		...
		function inst.integrate(engine)
			...
			inst.engine = engine
			if engine.bus then
				engine.bus:subscribe("arkher.material.layerblend.*", function(payload) inst.lastSignal = payload end)
			end
