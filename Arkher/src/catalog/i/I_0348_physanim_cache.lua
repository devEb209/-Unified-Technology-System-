-- ARKHER SYSTEM I.0348 :: Physical Animation Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0348"
	S.key = "arkher.anim.physanim.pose_cache"
	S.name = "Physical Animation Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.physanim.playback_pipeline" }
	S.tags = { "i", "physanim", "cache", "anim" }
	S.description = "Physical Animation Pose Cache: reuse of sampled poses across frames and instances for the Physical Animation subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.physanim.pose_cache", policy = "ttl", capacity = 440, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
