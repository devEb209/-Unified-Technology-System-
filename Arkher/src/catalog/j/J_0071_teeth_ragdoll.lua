-- ARKHER SYSTEM J.0071 :: Teeth Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0071"
	S.key = "arkher.character.teeth.physical_response"
	S.name = "Teeth Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.teeth.look_and_reach" }
	S.tags = { "j", "teeth", "ragdoll", "character" }
	S.description = "Teeth Physical Response: physical reaction, ragdoll and recovery for the Teeth subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.teeth.physical_response", blendSpeed = 5.90 })
		inst.system = S
		inst.ctx = ctx
