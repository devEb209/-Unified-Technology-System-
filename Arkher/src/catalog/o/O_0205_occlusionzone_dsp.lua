-- ARKHER SYSTEM O.0205 :: Occlusion Zone DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0205"
	S.key = "arkher.audio.occlusionzone.dsp_chain"
	S.name = "Occlusion Zone DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "occlusionzone", "dsp", "audio" }
	S.description = "Occlusion Zone DSP Chain: biquad filtering, delay, envelope and soft clipping for the Occlusion Zone subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.occlusionzone.dsp_chain", sampleRate = 22050, filter = "bandpass", cutoff = 3300, q = 0.600 })
		inst.system = S
		inst.ctx = ctx
