-- ARKHER SYSTEM E.0166 :: Clear Coat Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0166"
	S.key = "arkher.material.clearcoat.definition"
	S.name = "Clear Coat Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Clear Coat"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "clearcoat", "material", "material" }
	S.description = "Clear Coat Definition: layered PBR definition resolved into parameters for the Clear Coat subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.clearcoat.definition", texelBudget = 2097152 })
		inst.system = S
		inst.ctx = ctx
