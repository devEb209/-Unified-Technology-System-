-- ARKHER SYSTEM F.0010 :: Frame Pipeline Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0010"
	S.key = "arkher.render.framepipeline.render_policy"
	S.name = "Frame Pipeline Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepipeline.draw_budget" }
	S.tags = { "f", "framepipeline", "policy", "render" }
	S.description = "Frame Pipeline Render Policy: device tier rules for the frame for the Frame Pipeline subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.framepipeline.render_policy", algorithm = "lottery", starvationGuard = 19 })
		inst.system = S
		inst.ctx = ctx
