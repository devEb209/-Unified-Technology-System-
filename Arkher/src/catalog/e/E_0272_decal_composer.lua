-- ARKHER SYSTEM E.0272 :: Decal Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0272"
	S.key = "arkher.material.decal.layer_composition"
	S.name = "Decal Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Decal"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.decal.definition" }
	S.tags = { "e", "decal", "composer", "material" }
	S.description = "Decal Layer Composition: ordered layer composition with blend rules for the Decal subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.decal.layer_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
