-- ARKHER SYSTEM E.0472 :: Material Instance Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0472"
	S.key = "arkher.material.instance.parameter_budget"
	S.name = "Material Instance Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.instance.variant_registry" }
	S.tags = { "e", "instance", "budgeter", "material" }
	S.description = "Material Instance Parameter Budget: texel and layer budget allocation for the Material Instance subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.instance.parameter_budget", total = 120, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
