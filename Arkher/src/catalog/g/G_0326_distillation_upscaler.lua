-- ARKHER SYSTEM G.0326 :: Model Distillation Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0326"
	S.key = "arkher.neural.distillation.reconstruction"
	S.name = "Model Distillation Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.distillation.temporal_history" }
	S.tags = { "g", "distillation", "upscaler", "neural" }
	S.description = "Model Distillation Reconstruction: resolution ladder and image reconstruction for the Model Distillation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.distillation.reconstruction", targetMs = 13.10, index = 5, sharpness = 0.42 })
		inst.system = S
		inst.ctx = ctx
