-- ARKHER SYSTEM VC.0458 :: Audio Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0458"
	S.key = "arkher.contneural.audiocont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.audiocont.infinite_grid" }
	S.tags = { "vc", "audiocont", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.audiocont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
