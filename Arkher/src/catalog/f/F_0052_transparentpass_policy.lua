...
return function(A)
	...
	local S = {}
	S.id = "F.0052"
	S.key = "arkher.render.transparentpass.render_policy"
	S.name = "Transparent Pass Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Transparent Pass"
	S.aspect = "Render Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.transparentpass.draw_budget" }
	S.tags = { "f", "transparentpass", "policy", "render" }
	S.description = "Transparent Pass Render Policy: device tier rules for the frame for the Transparent Pass subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.transparentpass.render_policy", algorithm = "roundrobin", starvationGuard = 32 })
		inst.system = S
		inst.ctx = ctx
