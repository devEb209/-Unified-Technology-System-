-- ARKHER SYSTEM E.0519 :: Parameter Animation Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0519"
	S.key = "arkher.material.paramanim.compression_codec"
	S.name = "Parameter Animation Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.paramanim.streaming" }
	S.tags = { "e", "paramanim", "codec", "material" }
	S.description = "Parameter Animation Compression Codec: serialization and compression of material data for the Parameter Animation subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.paramanim.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
