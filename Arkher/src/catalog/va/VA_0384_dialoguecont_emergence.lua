-- ARKHER SYSTEM VA.0384 :: Dialogue Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0384"
	S.key = "arkher.contworld.dialoguecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.dialoguecont.reality_continuum" }
	S.tags = { "va", "dialoguecont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.dialoguecont.emergence_continuum", windowSize = 4, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
