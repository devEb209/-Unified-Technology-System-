-- ARKHER SYSTEM T.0082 :: Project Knowledge Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0082"
	S.key = "arkher.ai.projectknowledge.model_inference"
	S.name = "Project Knowledge Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.projectknowledge.action_planner" }
	S.tags = { "t", "projectknowledge", "inference", "ai" }
	S.description = "Project Knowledge Model Inference: quantized inference with batching and budget for the Project Knowledge subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.projectknowledge.model_inference", seed = 78314 })
		inst.system = S
		inst.ctx = ctx
