-- ARKHER SYSTEM F.0118 :: Screen Space Reflection Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0118"
	S.key = "arkher.render.ssr.probe_volume"
	S.name = "Screen Space Reflection Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.ssr.lighting_rig" }
	S.tags = { "f", "ssr", "probe", "render" }
	S.description = "Screen Space Reflection Probe Volume: irradiance probes encoded in spherical harmonics for the Screen Space Reflection subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.ssr.probe_volume", spacing = 32 })
		inst.system = S
		inst.ctx = ctx
