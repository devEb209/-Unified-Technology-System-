-- ARKHER SYSTEM K.0258 :: Vision Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0258"
	S.key = "arkher.npc.vision.reactive_behaviour"
	S.name = "Vision Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.vision.perception" }
	S.tags = { "k", "vision", "behaviortree", "npc" }
	S.description = "Vision Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Vision subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.vision.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
