-- ARKHER SYSTEM Z.0828 :: Reality Blending Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0828"
	S.key = "arkher.origin.realityblending.semantic_graph"
	S.name = "Reality Blending Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.world_architect" }
	S.tags = { "z", "realityblending", "knowledge", "origin" }
	S.description = "Reality Blending Semantic Graph: typed entities and inferred relations of the technology itself for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.realityblending.semantic_graph", dims = 40 })
		inst.system = S
		inst.ctx = ctx
