-- ARKHER SYSTEM VA.0234 :: City Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0234"
	S.key = "arkher.contworld.citycont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.citycont.persistent_state" }
	S.tags = { "va", "citycont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.citycont.coherence_guard", window = 75, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
