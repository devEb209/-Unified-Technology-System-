-- ARKHER SYSTEM F.0191 :: Sky Model Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0191"
	S.key = "arkher.render.sky.draw_budget"
	S.name = "Sky Model Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sky Model"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sky.adaptive_resolution" }
	S.tags = { "f", "sky", "budgeter", "render" }
	S.description = "Sky Model Draw Budget: draw call and triangle budget allocation for the Sky Model subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.sky.draw_budget", total = 163, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
