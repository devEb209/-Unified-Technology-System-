-- ARKHER SYSTEM R.0201 :: Client Prediction Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0201"
	S.key = "arkher.net.clientprediction.session_registry"
	S.name = "Client Prediction Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.clientprediction.rate_guard" }
	S.tags = { "r", "clientprediction", "registry", "net" }
	S.description = "Client Prediction Session Registry: catalogue of sessions, players and their metadata for the Client Prediction subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.clientprediction.session_registry" })
		inst.system = S
		inst.ctx = ctx
