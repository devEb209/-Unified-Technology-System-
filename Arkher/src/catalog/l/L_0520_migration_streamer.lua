-- ARKHER SYSTEM L.0520 :: Migration Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0520"
	S.key = "arkher.sim.migration.streaming"
	S.name = "Migration Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.migration.state_codec" }
	S.tags = { "l", "migration", "streamer", "sim" }
	S.description = "Migration Streaming: distance-driven residency of simulated regions for the Migration subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.migration.streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
