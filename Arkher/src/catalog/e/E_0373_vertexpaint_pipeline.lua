-- ARKHER SYSTEM E.0373 :: Vertex Painting Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0373"
	S.key = "arkher.material.vertexpaint.authoring_pipeline"
	S.name = "Vertex Painting Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.vertexpaint.analysis" }
	S.tags = { "e", "vertexpaint", "pipeline", "material" }
	S.description = "Vertex Painting Authoring Pipeline: ordered authoring and bake stages for the Vertex Painting subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.vertexpaint.authoring_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
