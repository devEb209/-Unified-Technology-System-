-- ARKHER SYSTEM VA.0503 :: Rendering Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0503"
	S.key = "arkher.contworld.rendercont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.rendercont.simulation_fabric" }
	S.tags = { "va", "rendercont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.rendercont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
