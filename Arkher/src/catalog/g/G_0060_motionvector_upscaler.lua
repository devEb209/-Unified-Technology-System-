-- ARKHER SYSTEM G.0060 :: Motion Vector Estimation Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0060"
	S.key = "arkher.neural.motionvector.reconstruction"
	S.name = "Motion Vector Estimation Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.motionvector.temporal_history" }
	S.tags = { "g", "motionvector", "upscaler", "neural" }
	S.description = "Motion Vector Estimation Reconstruction: resolution ladder and image reconstruction for the Motion Vector Estimation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.motionvector.reconstruction", targetMs = 13.10, index = 5, sharpness = 0.28 })
		inst.system = S
		inst.ctx = ctx
