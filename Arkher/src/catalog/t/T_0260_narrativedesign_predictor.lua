-- ARKHER SYSTEM T.0260 :: Narrative Design Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0260"
	S.key = "arkher.ai.narrativedesign.outcome_prediction"
	S.name = "Narrative Design Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.narrativedesign.decision_policy" }
	S.tags = { "t", "narrativedesign", "predictor", "ai" }
	S.description = "Narrative Design Outcome Prediction: forecasting the result before the work is done for the Narrative Design subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.narrativedesign.outcome_prediction", method = "ema", alpha = 0.35, window = 113 })
		inst.system = S
		inst.ctx = ctx
