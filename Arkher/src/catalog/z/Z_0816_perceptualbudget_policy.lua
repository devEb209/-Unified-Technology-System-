-- ARKHER SYSTEM Z.0816 :: Perceptual Budgeting Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0816"
	S.key = "arkher.origin.perceptualbudget.governance_policy"
	S.name = "Perceptual Budgeting Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.perceptualbudget.signal_composition" }
	S.tags = { "z", "perceptualbudget", "policy", "origin" }
	S.description = "Perceptual Budgeting Governance Policy: ordered rules governing when the technology may act for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.perceptualbudget.governance_policy", algorithm = "roundrobin", starvationGuard = 44 })
		inst.system = S
		inst.ctx = ctx
