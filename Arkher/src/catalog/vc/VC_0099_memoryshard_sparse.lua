-- ARKHER SYSTEM VC.0099 :: Memory Shard Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0099"
	S.key = "arkher.contneural.memoryshard.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memoryshard.epoch_clock" }
	S.tags = { "vc", "memoryshard", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.memoryshard.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
