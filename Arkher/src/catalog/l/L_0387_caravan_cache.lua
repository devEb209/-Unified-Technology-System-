-- ARKHER SYSTEM L.0387 :: Caravan Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0387"
	S.key = "arkher.sim.caravan.aggregate_cache"
	S.name = "Caravan Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.caravan.fidelity_policy" }
	S.tags = { "l", "caravan", "cache", "sim" }
	S.description = "Caravan Aggregate Cache: reuse of expensive aggregate computations for the Caravan subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.caravan.aggregate_cache", policy = "ttl", capacity = 295, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
