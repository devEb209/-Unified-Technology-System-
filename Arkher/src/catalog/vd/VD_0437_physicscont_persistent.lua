-- ARKHER SYSTEM VD.0437 :: Physics Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0437"
	S.key = "arkher.contsim.physicscont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.physicscont.multi-scale_fidelity" }
	S.tags = { "vd", "physicscont", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.physicscont.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
