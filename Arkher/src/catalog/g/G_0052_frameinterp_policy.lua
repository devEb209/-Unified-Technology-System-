-- ARKHER SYSTEM G.0052 :: Frame Interpolation Heuristic Policy
...
return function(A)
	...
	local S = {}
	S.id = "G.0052"
	S.key = "arkher.neural.frameinterp.heuristic_policy"
	S.name = "Frame Interpolation Heuristic Policy"
	S.category = "G"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.frameinterp.result_cache" }
	S.tags = { "g", "frameinterp", "policy", "neural" }
	S.description = "Frame Interpolation Heuristic Policy: rule fallback when the model is unavailable for the Frame Interpolation subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.neural.frameinterp.heuristic_policy", algorithm = "lottery", starvationGuard = 47 })
		inst.system = S
		inst.ctx = ctx
