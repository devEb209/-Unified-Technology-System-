-- ARKHER SYSTEM E.0023 :: Surface Definition Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0023"
	S.key = "arkher.material.surfacedef.streaming"
	S.name = "Surface Definition Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.surfacedef.parameter_budget" }
	S.tags = { "e", "surfacedef", "streamer", "material" }
	S.description = "Surface Definition Streaming: residency and demand-driven texture streaming for the Surface Definition subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.surfacedef.streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
