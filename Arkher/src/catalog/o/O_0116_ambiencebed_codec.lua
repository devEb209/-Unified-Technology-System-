-- ARKHER SYSTEM O.0116 :: Ambience Bed Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0116"
	S.key = "arkher.audio.ambiencebed.compression_codec"
	S.name = "Ambience Bed Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Ambience Bed"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.ambiencebed.asset_registry" }
	S.tags = { "o", "ambiencebed", "codec", "audio" }
	S.description = "Ambience Bed Compression Codec: payload encoding of audio state and events for the Ambience Bed subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.ambiencebed.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
