-- ARKHER SYSTEM N.0372 :: Projectile Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0372"
	S.key = "arkher.vfx.projectile.spawn_budget"
	S.name = "Projectile Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Projectile"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.projectile.effect_composition" }
	S.tags = { "n", "projectile", "budgeter", "vfx" }
	S.description = "Projectile Spawn Budget: global particle budget shared by every live effect for the Projectile subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.projectile.spawn_budget", total = 434, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
