-- ARKHER SYSTEM Z.0668 :: Auto Documentation Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0668"
	S.key = "arkher.origin.autodocumentation.semantic_graph"
	S.name = "Auto Documentation Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.world_architect" }
	S.tags = { "z", "autodocumentation", "knowledge", "origin" }
	S.description = "Auto Documentation Semantic Graph: typed entities and inferred relations of the technology itself for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.autodocumentation.semantic_graph", dims = 16 })
		inst.system = S
		inst.ctx = ctx
