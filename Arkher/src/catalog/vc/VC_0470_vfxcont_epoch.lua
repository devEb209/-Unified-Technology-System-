-- ARKHER SYSTEM VC.0470 :: VFX Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0470"
	S.key = "arkher.contneural.vfxcont.epoch_clock"
	S.name = "VFX Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vfxcont.infinite_grid" }
	S.tags = { "vc", "vfxcont", "epoch", "contneural" }
	S.description = "VFX Continuum Epoch Clock: deterministic epoch timeline with catch-up for the VFX Continuum subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.vfxcont.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
