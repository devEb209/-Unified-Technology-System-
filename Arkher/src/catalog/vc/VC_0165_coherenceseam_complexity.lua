-- ARKHER SYSTEM VC.0165 :: Coherence Seam Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0165"
	S.key = "arkher.contneural.coherenceseam.complexity_budget"
	S.name = "Coherence Seam Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.coherenceseam.world_memory_stream" }
	S.tags = { "vc", "coherenceseam", "complexity", "contneural" }
	S.description = "Coherence Seam Complexity Budget: complexity budgeting for the continuum for the Coherence Seam subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.coherenceseam.complexity_budget", targetMs = 19.0 })
		inst.system = S
		inst.ctx = ctx
