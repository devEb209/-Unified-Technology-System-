-- ARKHER SYSTEM F.0527 :: Geometry Streaming Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0527"
	S.key = "arkher.render.geostream.draw_budget"
	S.name = "Geometry Streaming Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.geostream.adaptive_resolution" }
	S.tags = { "f", "geostream", "budgeter", "render" }
	S.description = "Geometry Streaming Draw Budget: draw call and triangle budget allocation for the Geometry Streaming subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.geostream.draw_budget", total = 336, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
