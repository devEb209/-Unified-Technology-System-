-- ARKHER SYSTEM N.0146 :: Rain Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0146"
	S.key = "arkher.vfx.rain.force_field"
	S.name = "Rain Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Rain"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.rain.particle_simulation" }
	S.tags = { "n", "rain", "forcefield", "vfx" }
	S.description = "Rain Force Field: wind, attraction, vortex, drag and curl turbulence for the Rain subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.rain.force_field", seed = 38052 })
		inst.system = S
		inst.ctx = ctx
