-- ARKHER SYSTEM VA.0570 :: Mobile Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0570"
	S.key = "arkher.contworld.mobilecont.coherence_guard"
	S.name = "Mobile Continuum Coherence Guard"
	S.category = "VA"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.mobilecont.persistent_state" }
	S.tags = { "va", "mobilecont", "coherence", "contworld" }
	S.description = "Mobile Continuum Coherence Guard: seam coherence and drift supervision for the Mobile Continuum subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.mobilecont.coherence_guard", window = 56, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
