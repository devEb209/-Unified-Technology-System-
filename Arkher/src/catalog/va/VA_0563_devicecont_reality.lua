-- ARKHER SYSTEM VA.0563 :: Device Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0563"
	S.key = "arkher.contworld.devicecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.devicecont.simulation_fabric" }
	S.tags = { "va", "devicecont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.devicecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
