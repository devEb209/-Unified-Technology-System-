-- ARKHER SYSTEM R.0140 :: Unreliable Channel Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0140"
	S.key = "arkher.net.unreliablechannel.rate_guard"
	S.name = "Unreliable Channel Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.unreliablechannel.interest_streaming" }
	S.tags = { "r", "unreliablechannel", "guard", "net" }
	S.description = "Unreliable Channel Rate Guard: token-bucket protection against floods and abuse for the Unreliable Channel subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.unreliablechannel.rate_guard", algorithm = "token", capacity = 69, refillPerSec = 14, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
