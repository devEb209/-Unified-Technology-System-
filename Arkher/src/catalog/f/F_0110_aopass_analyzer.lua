-- ARKHER SYSTEM F.0110 :: Ambient Occlusion Pass Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0110"
	S.key = "arkher.render.aopass.frame_analysis"
	S.name = "Ambient Occlusion Pass Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.aopass.pass_cache" }
	S.tags = { "f", "aopass", "analyzer", "render" }
	S.description = "Ambient Occlusion Pass Frame Analysis: per-pass cost analysis and outlier detection for the Ambient Occlusion Pass subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.aopass.frame_analysis", window = 152, buckets = 12, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
