...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="ZBrush SubTool — CORE Map #0318", size=Vector2.new(600, 480), pos=UDim2.fromOffset(234, 286), parent=parent, icon="⬔"})
