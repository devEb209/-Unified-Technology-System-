-- ARKHER SYSTEM J.0120 :: Gaze Behaviour Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0120"
	S.key = "arkher.character.gaze.streaming"
	S.name = "Gaze Behaviour Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gaze.budget_governor" }
	S.tags = { "j", "gaze", "streamer", "character" }
	S.description = "Gaze Behaviour Streaming: distance-driven residency of character data for the Gaze Behaviour subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.gaze.streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
