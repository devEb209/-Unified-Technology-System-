-- ARKHER SYSTEM J.0020 :: Character Rig Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0020"
	S.key = "arkher.character.characterrig.budget_governor"
	S.name = "Character Rig Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterrig.variant_registry" }
	S.tags = { "j", "characterrig", "budgeter", "character" }
	S.description = "Character Rig Budget Governor: per-character cost allocation in a crowd for the Character Rig subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.characterrig.budget_governor", total = 262, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
