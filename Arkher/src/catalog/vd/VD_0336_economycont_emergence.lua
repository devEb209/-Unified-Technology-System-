-- ARKHER SYSTEM VD.0336 :: Economy Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0336"
	S.key = "arkher.contsim.economycont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.economycont.reality_continuum" }
	S.tags = { "vd", "economycont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.economycont.emergence_continuum", windowSize = 4, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
