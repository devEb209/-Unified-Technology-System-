-- ARKHER SYSTEM Z.0957 :: Platform Abstraction Doctrine Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0957"
	S.key = "arkher.origin.platformdoctrine.behaviour_analysis"
	S.name = "Platform Abstraction Doctrine Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.platformdoctrine.governance_policy" }
	S.tags = { "z", "platformdoctrine", "analyzer", "origin" }
	S.description = "Platform Abstraction Doctrine Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Platform Abstraction Doctrine subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.platformdoctrine.behaviour_analysis", window = 199, buckets = 11, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
