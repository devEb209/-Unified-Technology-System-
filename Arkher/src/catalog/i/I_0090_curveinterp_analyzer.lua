-- ARKHER SYSTEM I.0090 :: Curve Interpolation Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0090"
	S.key = "arkher.anim.curveinterp.analysis"
	S.name = "Curve Interpolation Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.curveinterp.quality_policy" }
	S.tags = { "i", "curveinterp", "analyzer", "anim" }
	S.description = "Curve Interpolation Analysis: pop, drift and cost analysis of playback for the Curve Interpolation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.curveinterp.analysis", window = 75, buckets = 15, threshold = 2.70 })
		inst.system = S
		inst.ctx = ctx
