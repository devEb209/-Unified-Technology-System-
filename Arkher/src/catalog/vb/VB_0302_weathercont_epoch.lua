-- ARKHER SYSTEM VB.0302 :: Weather Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0302"
	S.key = "arkher.conttime.weathercont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.weathercont.infinite_grid" }
	S.tags = { "vb", "weathercont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.weathercont.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
