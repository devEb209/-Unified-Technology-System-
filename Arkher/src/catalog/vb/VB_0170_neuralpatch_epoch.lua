-- ARKHER SYSTEM VB.0170 :: Neural Patch Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0170"
	S.key = "arkher.conttime.neuralpatch.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.neuralpatch.infinite_grid" }
	S.tags = { "vb", "neuralpatch", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.neuralpatch.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
