-- ARKHER SYSTEM K.0002 :: NPC Brain Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0002"
	S.key = "arkher.npc.npcbrain.memory"
	S.name = "NPC Brain Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcbrain.mind_network" }
	S.tags = { "k", "npcbrain", "memory", "npc" }
	S.description = "NPC Brain Memory: episodic memory with decay, recall and consolidation for the NPC Brain subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.npcbrain.memory", capacity = 104, decayRate = 0.030, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
