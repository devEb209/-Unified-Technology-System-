-- ARKHER SYSTEM N.0267 :: Shield Effect Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0267"
	S.key = "arkher.vfx.shieldfx.effect_composition"
	S.name = "Shield Effect Effect Composition"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.shieldfx.effect_graph" }
	S.tags = { "n", "shieldfx", "composer", "vfx" }
	S.description = "Shield Effect Effect Composition: blending of several effect signals into one output for the Shield Effect subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.shieldfx.effect_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
