-- ARKHER SYSTEM I.0387 :: Bone Mapping Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0387"
	S.key = "arkher.anim.bonemapping.pose_cache"
	S.name = "Bone Mapping Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bone Mapping"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonemapping.playback_pipeline" }
	S.tags = { "i", "bonemapping", "cache", "anim" }
	S.description = "Bone Mapping Pose Cache: reuse of sampled poses across frames and instances for the Bone Mapping subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.bonemapping.pose_cache", policy = "lru", capacity = 65, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
