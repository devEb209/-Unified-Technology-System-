-- ARKHER SYSTEM F.0346 :: Antialiasing Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0346"
	S.key = "arkher.render.antialiasing.render_policy"
	S.name = "Antialiasing Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Antialiasing"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.antialiasing.draw_budget" }
	S.tags = { "f", "antialiasing", "policy", "render" }
	S.description = "Antialiasing Render Policy: device tier rules for the frame for the Antialiasing subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.antialiasing.render_policy", algorithm = "wfq", starvationGuard = 30 })
		inst.system = S
		inst.ctx = ctx
