-- ARKHER SYSTEM J.0142 :: Blinking Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0142"
	S.key = "arkher.character.blinking.streaming"
	S.name = "Blinking Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.blinking.budget_governor" }
	S.tags = { "j", "blinking", "streamer", "character" }
	S.description = "Blinking Streaming: distance-driven residency of character data for the Blinking subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.blinking.streaming", radius = 320, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
