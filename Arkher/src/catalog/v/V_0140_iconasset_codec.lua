-- ARKHER SYSTEM V.0140 :: Icon Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0140"
	S.key = "arkher.asset.iconasset.compression_codec"
	S.name = "Icon Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.iconasset.streaming_residency" }
	S.tags = { "v", "iconasset", "codec", "asset" }
	S.description = "Icon Compression Codec: compact encoding, diffing and checksum of asset payloads for the Icon subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.iconasset.compression_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
