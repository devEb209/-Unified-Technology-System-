-- ARKHER SYSTEM VD.0021 :: Region Tile Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0021"
	S.key = "arkher.contsim.regiontile.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.regiontile.world_memory_stream" }
	S.tags = { "vd", "regiontile", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.regiontile.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
