-- ARKHER SYSTEM K.0463 :: Formation Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0463"
	S.key = "arkher.npc.formation.mind_network"
	S.name = "Formation Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "formation", "mindnet", "npc" }
	S.description = "Formation Mind Network: the learned policy that turns perception into a decision for the Formation subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.formation.mind_network", inputs = 9, hidden = 7, seed = 5983, learningRate = 0.065, exploration = 0.055 })
		inst.system = S
		inst.ctx = ctx
