-- ARKHER SYSTEM VA.0491 :: Lighting Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0491"
	S.key = "arkher.contworld.lightcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lightcont.simulation_fabric" }
	S.tags = { "va", "lightcont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.lightcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
