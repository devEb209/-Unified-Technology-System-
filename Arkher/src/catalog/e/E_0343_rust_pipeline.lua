-- ARKHER SYSTEM E.0343 :: Rust Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0343"
	S.key = "arkher.material.rust.authoring_pipeline"
	S.name = "Rust Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Rust"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.rust.analysis" }
	S.tags = { "e", "rust", "pipeline", "material" }
	S.description = "Rust Authoring Pipeline: ordered authoring and bake stages for the Rust subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.rust.authoring_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
