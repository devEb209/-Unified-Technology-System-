-- ARKHER SYSTEM Z.0938 :: Universal Interop Layer Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0938"
	S.key = "arkher.origin.interop.budget_governor"
	S.name = "Universal Interop Layer Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.interop.behaviour_analysis" }
	S.tags = { "z", "interop", "budgeter", "origin" }
	S.description = "Universal Interop Layer Budget Governor: allocation of a scarce resource across the technology's consumers for the Universal Interop Layer subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.interop.budget_governor", total = 132, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
