-- ARKHER SYSTEM VC.0024 :: Region Tile Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0024"
	S.key = "arkher.contneural.regiontile.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.regiontile.reality_continuum" }
	S.tags = { "vc", "regiontile", "emergence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.regiontile.emergence_continuum", windowSize = 4, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
