-- ARKHER SYSTEM O.0225 :: Music Bed Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0225"
	S.key = "arkher.audio.musicbed.playback_policy"
	S.name = "Music Bed Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Music Bed"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.musicbed.compression_codec" }
	S.tags = { "o", "musicbed", "policy", "audio" }
	S.description = "Music Bed Playback Policy: rules choosing what may be heard right now for the Music Bed subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.musicbed.playback_policy", algorithm = "wfq", starvationGuard = 34 })
		inst.system = S
		inst.ctx = ctx
