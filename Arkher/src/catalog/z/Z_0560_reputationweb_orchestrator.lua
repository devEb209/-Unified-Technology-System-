-- ARKHER SYSTEM Z.0560 :: Reputation Web Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0560"
	S.key = "arkher.origin.reputationweb.orchestration"
	S.name = "Reputation Web Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.residency_streaming" }
	S.tags = { "z", "reputationweb", "orchestrator", "origin" }
	S.description = "Reputation Web Orchestration: lifecycle and phase orchestration of the technology for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.reputationweb.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
