-- ARKHER SYSTEM T.0495 :: Physics Reasoning World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0495"
	S.key = "arkher.ai.physicsreasoning.world_architect"
	S.name = "Physics Reasoning World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.physicsreasoning.self_critique" }
	S.tags = { "t", "physicsreasoning", "architect", "ai" }
	S.description = "Physics Reasoning World Architect: composition of a whole world plan with conserved budgets for the Physics Reasoning subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.physicsreasoning.world_architect", budget = 900, seed = 42493 })
		inst.system = S
		inst.ctx = ctx
