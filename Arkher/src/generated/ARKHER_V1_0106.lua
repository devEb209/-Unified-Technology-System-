...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Sketchfab — CORE Node_Flow #0106", size=Vector2.new(640, 440), pos=UDim2.fromOffset(278, 322), parent=parent, icon="🎬"})
