--!strict
-- PolyHaven CC0 — ANIMATION Node_Flow #0111
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="PolyHaven CC0 — ANIMATION Node_Flow #0111", size=Vector2.new(600, 440), pos=UDim2.fromOffset(343, 147), parent=parent, icon="▣"})
