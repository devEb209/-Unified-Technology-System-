-- ARKHER SYSTEM L.0436 :: Crime Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0436"
	S.key = "arkher.sim.crime.simulation_core"
	S.name = "Crime Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "crime", "simulation", "sim" }
	S.description = "Crime Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Crime subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.crime.simulation_core", fullRadius = 320, reducedRadius = 1100, budget = 85 })
		inst.system = S
		inst.ctx = ctx
