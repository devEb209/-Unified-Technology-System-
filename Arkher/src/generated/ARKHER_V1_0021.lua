--!strict
-- CryEngine Qt — ANIMATION Node_Flow #0021
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="CryEngine Qt — ANIMATION Node_Flow #0021", size=Vector2.new(600, 440), pos=UDim2.fromOffset(373, 177), parent=parent, icon="⬔"})
