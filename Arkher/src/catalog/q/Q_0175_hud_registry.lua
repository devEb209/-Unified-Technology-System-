-- ARKHER SYSTEM Q.0175 :: Head Up Display Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0175"
	S.key = "arkher.ui.hud.localization_registry"
	S.name = "Head Up Display Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.hud.theme_composition" }
	S.tags = { "q", "hud", "registry", "ui" }
	S.description = "Head Up Display Localization Registry: catalogue of strings, plurals and locale metadata for the Head Up Display subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.hud.localization_registry" })
		inst.system = S
		inst.ctx = ctx
