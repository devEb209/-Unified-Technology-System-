-- ARKHER SYSTEM Z.0068 :: Reality Layer Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0068"
	S.key = "arkher.origin.realitylayer.semantic_graph"
	S.name = "Reality Layer Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.world_architect" }
	S.tags = { "z", "realitylayer", "knowledge", "origin" }
	S.description = "Reality Layer Semantic Graph: typed entities and inferred relations of the technology itself for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.realitylayer.semantic_graph", dims = 48 })
		inst.system = S
		inst.ctx = ctx
