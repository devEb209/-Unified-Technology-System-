-- ARKHER SYSTEM VA.0141 :: Fidelity Band Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0141"
	S.key = "arkher.contworld.fidelityband.complexity_budget"
	S.name = "Fidelity Band Complexity Budget"
	S.category = "VA"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.fidelityband.world_memory_stream" }
	S.tags = { "va", "fidelityband", "complexity", "contworld" }
	S.description = "Fidelity Band Complexity Budget: complexity budgeting for the continuum for the Fidelity Band subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.fidelityband.complexity_budget", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
