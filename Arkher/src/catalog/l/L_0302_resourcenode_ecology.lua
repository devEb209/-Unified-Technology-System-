-- ARKHER SYSTEM L.0302 :: Resource Node Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0302"
	S.key = "arkher.sim.resourcenode.ecology"
	S.name = "Resource Node Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.resourcenode.simulation_core" }
	S.tags = { "l", "resourcenode", "ecology", "sim" }
	S.description = "Resource Node Ecology: populations, predation, harvesting and carrying capacity for the Resource Node subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.resourcenode.ecology" })
		inst.system = S
		inst.ctx = ctx
