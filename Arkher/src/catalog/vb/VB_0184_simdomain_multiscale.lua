-- ARKHER SYSTEM VB.0184 :: Simulation Domain Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0184"
	S.key = "arkher.conttime.simdomain.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.simdomain.sparse_residency" }
	S.tags = { "vb", "simdomain", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.simdomain.multi-scale_fidelity", levels = 4, baseTriangles = 135000 })
		inst.system = S
		inst.ctx = ctx
