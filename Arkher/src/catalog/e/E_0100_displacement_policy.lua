-- ARKHER SYSTEM E.0100 :: Height Displacement Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0100"
	S.key = "arkher.material.displacement.quality_policy"
	S.name = "Height Displacement Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.displacement.compression_codec" }
	S.tags = { "e", "displacement", "policy", "material" }
	S.description = "Height Displacement Quality Policy: device tier rules for the surface for the Height Displacement subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.displacement.quality_policy", algorithm = "lottery", starvationGuard = 63 })
		inst.system = S
		inst.ctx = ctx
