-- ARKHER SYSTEM F.0671 :: VR Stereo Path Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0671"
	S.key = "arkher.render.vrpath.orchestration"
	S.name = "VR Stereo Path Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.vrpath.frame_analysis" }
	S.tags = { "f", "vrpath", "orchestrator", "render" }
	S.description = "VR Stereo Path Orchestration: frame lifecycle orchestration for the VR Stereo Path subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.vrpath.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
