-- ARKHER SYSTEM VA.0501 :: Rendering Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0501"
	S.key = "arkher.contworld.rendercont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.rendercont.world_memory_stream" }
	S.tags = { "va", "rendercont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.rendercont.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
