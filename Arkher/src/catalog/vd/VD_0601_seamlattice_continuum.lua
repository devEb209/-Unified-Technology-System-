-- ARKHER SYSTEM VD.0601 :: Seam Lattice Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0601"
	S.key = "arkher.contsim.seamlattice.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "seamlattice", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.seamlattice.infinite_grid", cellSize = 192, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
