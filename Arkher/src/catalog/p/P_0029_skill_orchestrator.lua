-- ARKHER SYSTEM P.0029 :: Skill State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0029"
	S.key = "arkher.play.skill.state_machine"
	S.name = "Skill State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Skill"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.skill.combat_resolution" }
	S.tags = { "p", "skill", "orchestrator", "play" }
	S.description = "Skill State Machine: the phase machine that drives this gameplay loop for the Skill subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.skill.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
