-- ARKHER SYSTEM K.0050 :: Reward Model Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0050"
	S.key = "arkher.npc.rewardmodel.goal_planner"
	S.name = "Reward Model Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.rewardmodel.utility_reasoning" }
	S.tags = { "k", "rewardmodel", "planner", "npc" }
	S.description = "Reward Model Goal Planner: backward GOAP planning to reach a goal state for the Reward Model subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.rewardmodel.goal_planner", maxDepth = 10 })
		inst.system = S
		inst.ctx = ctx
