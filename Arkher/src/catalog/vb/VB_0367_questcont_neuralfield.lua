-- ARKHER SYSTEM VB.0367 :: Quest Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0367"
	S.key = "arkher.conttime.questcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.questcont.coherence_guard" }
	S.tags = { "vb", "questcont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.questcont.neural_field", dims = 24, hidden = 20, seed = 7035 })
		inst.system = S
		inst.ctx = ctx
