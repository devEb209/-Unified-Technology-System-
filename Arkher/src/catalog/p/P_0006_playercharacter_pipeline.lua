-- ARKHER SYSTEM P.0006 :: Player Character Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0006"
	S.key = "arkher.play.playercharacter.rule_pipeline"
	S.name = "Player Character Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playercharacter.state_machine" }
	S.tags = { "p", "playercharacter", "pipeline", "play" }
	S.description = "Player Character Rule Pipeline: ordered rules applied to every gameplay event for the Player Character subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.playercharacter.rule_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
