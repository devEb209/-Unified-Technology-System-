-- ARKHER SYSTEM F.0032 :: Opaque Pass Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0032"
	S.key = "arkher.render.opaquepass.geometry_virtualization"
	S.name = "Opaque Pass Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Opaque Pass"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.opaquepass.visibility_set" }
	S.tags = { "f", "opaquepass", "impostor", "render" }
	S.description = "Opaque Pass Geometry Virtualization: impostor and HLOD synthesis under a budget for the Opaque Pass subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.opaquepass.geometry_virtualization", atlasSlots = 32, viewCount = 8, errorThreshold = 1.00 })
		inst.system = S
		inst.ctx = ctx
