-- ARKHER SYSTEM R.0075 :: Transform Replication Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0075"
	S.key = "arkher.net.transformreplication.prediction_and_reconciliation"
	S.name = "Transform Replication Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.transformreplication.time_sync" }
	S.tags = { "r", "transformreplication", "prediction", "net" }
	S.description = "Transform Replication Prediction And Reconciliation: client simulation, correction and input replay for the Transform Replication subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.transformreplication.prediction_and_reconciliation", errorThreshold = 0.035, smoothing = 9.0, maxInputs = 120 })
		inst.system = S
		inst.ctx = ctx
