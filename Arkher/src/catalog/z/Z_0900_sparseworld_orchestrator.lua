-- ARKHER SYSTEM Z.0900 :: Sparse World Representation Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0900"
	S.key = "arkher.origin.sparseworld.orchestration"
	S.name = "Sparse World Representation Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.residency_streaming" }
	S.tags = { "z", "sparseworld", "orchestrator", "origin" }
	S.description = "Sparse World Representation Orchestration: lifecycle and phase orchestration of the technology for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.sparseworld.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
