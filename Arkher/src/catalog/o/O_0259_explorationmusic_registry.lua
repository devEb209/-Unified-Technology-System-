-- ARKHER SYSTEM O.0259 :: Exploration Music Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0259"
	S.key = "arkher.audio.explorationmusic.asset_registry"
	S.name = "Exploration Music Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.explorationmusic.streaming" }
	S.tags = { "o", "explorationmusic", "registry", "audio" }
	S.description = "Exploration Music Asset Registry: catalogue of sounds, variations and metadata for the Exploration Music subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.explorationmusic.asset_registry" })
		inst.system = S
		inst.ctx = ctx
