-- ARKHER SYSTEM H.0582 :: Buoyancy Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0582"
	S.key = "arkher.physics.buoyancy.broadphase_index"
	S.name = "Buoyancy Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Buoyancy"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.buoyancy.vehicle" }
	S.tags = { "h", "buoyancy", "index", "physics" }
	S.description = "Buoyancy Broadphase Index: spatial acceleration of candidate pair finding for the Buoyancy subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.buoyancy.broadphase_index", mode = "hash", cellSize = 56 })
		inst.system = S
		inst.ctx = ctx
