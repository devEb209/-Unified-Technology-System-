-- ARKHER SYSTEM Z.0644 :: Natural Language Engine Control Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0644"
	S.key = "arkher.origin.languagecontrol.autonomous_pipeline"
	S.name = "Natural Language Engine Control Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.languagecontrol.simulation_fabric" }
	S.tags = { "z", "languagecontrol", "autopipeline", "origin" }
	S.description = "Natural Language Engine Control Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.languagecontrol.autonomous_pipeline", maxIterations = 5 })
		inst.system = S
		inst.ctx = ctx
