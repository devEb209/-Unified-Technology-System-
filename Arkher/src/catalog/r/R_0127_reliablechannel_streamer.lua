-- ARKHER SYSTEM R.0127 :: Reliable Channel Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0127"
	S.key = "arkher.net.reliablechannel.interest_streaming"
	S.name = "Reliable Channel Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reliablechannel.serialization_codec" }
	S.tags = { "r", "reliablechannel", "streamer", "net" }
	S.description = "Reliable Channel Interest Streaming: distance-driven residency of replicated content for the Reliable Channel subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.reliablechannel.interest_streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
