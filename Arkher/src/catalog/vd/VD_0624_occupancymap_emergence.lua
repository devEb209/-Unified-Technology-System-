-- ARKHER SYSTEM VD.0624 :: Occupancy Map Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0624"
	S.key = "arkher.contsim.occupancymap.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.occupancymap.reality_continuum" }
	S.tags = { "vd", "occupancymap", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.occupancymap.emergence_continuum", windowSize = 4, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
