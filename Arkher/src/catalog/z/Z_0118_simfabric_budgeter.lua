-- ARKHER SYSTEM Z.0118 :: Universal Simulation Fabric Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0118"
	S.key = "arkher.origin.simfabric.budget_governor"
	S.name = "Universal Simulation Fabric Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.simfabric.behaviour_analysis" }
	S.tags = { "z", "simfabric", "budgeter", "origin" }
	S.description = "Universal Simulation Fabric Budget Governor: allocation of a scarce resource across the technology's consumers for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.simfabric.budget_governor", total = 302, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
