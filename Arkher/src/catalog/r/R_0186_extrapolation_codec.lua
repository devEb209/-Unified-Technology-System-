-- ARKHER SYSTEM R.0186 :: Extrapolation Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0186"
	S.key = "arkher.net.extrapolation.serialization_codec"
	S.name = "Extrapolation Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.extrapolation.bandwidth_budget" }
	S.tags = { "r", "extrapolation", "codec", "net" }
	S.description = "Extrapolation Serialization Codec: compact encoding, diffing and checksum of payloads for the Extrapolation subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.extrapolation.serialization_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
