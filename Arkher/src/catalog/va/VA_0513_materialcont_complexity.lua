-- ARKHER SYSTEM VA.0513 :: Material Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0513"
	S.key = "arkher.contworld.materialcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.materialcont.world_memory_stream" }
	S.tags = { "va", "materialcont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.materialcont.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
