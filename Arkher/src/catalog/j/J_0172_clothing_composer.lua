-- ARKHER SYSTEM J.0172 :: Clothing Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0172"
	S.key = "arkher.character.clothing.appearance_composer"
	S.name = "Clothing Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.clothing.locomotion" }
	S.tags = { "j", "clothing", "composer", "character" }
	S.description = "Clothing Appearance Composer: composition of appearance slots into a look for the Clothing subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.clothing.appearance_composer", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
