-- ARKHER SYSTEM VA.0114 :: Temporal Slice Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0114"
	S.key = "arkher.contworld.temporalslice.coherence_guard"
	S.name = "Temporal Slice Coherence Guard"
	S.category = "VA"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.temporalslice.persistent_state" }
	S.tags = { "va", "temporalslice", "coherence", "contworld" }
	S.description = "Temporal Slice Coherence Guard: seam coherence and drift supervision for the Temporal Slice subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.temporalslice.coherence_guard", window = 105, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
