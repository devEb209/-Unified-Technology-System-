-- ARKHER SYSTEM J.0062 :: Eyes Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0062"
	S.key = "arkher.character.eyes.appearance_composer"
	S.name = "Eyes Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.eyes.locomotion" }
	S.tags = { "j", "eyes", "composer", "character" }
	S.description = "Eyes Appearance Composer: composition of appearance slots into a look for the Eyes subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.eyes.appearance_composer", mode = "max" })
		inst.system = S
		inst.ctx = ctx
	...
	function inst.dominantLayer()
		...
		function inst.integrate(engine)
			...
			inst.engine = engine
			if engine.bus then
				engine.bus:subscribe("arkher.character.eyes.*", function(payload) inst.lastSignal = payload end)
			end
