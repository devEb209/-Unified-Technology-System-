-- ARKHER SYSTEM VC.0142 :: Fidelity Band Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0142"
	S.key = "arkher.contneural.fidelityband.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.fidelityband.complexity_budget" }
	S.tags = { "vc", "fidelityband", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.fidelityband.simulation_fabric", budgetMs = 3.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
