-- ARKHER SYSTEM Q.0301 :: Haptics Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0301"
	S.key = "arkher.ui.haptics.responsive_layout"
	S.name = "Haptics Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Haptics"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "haptics", "flex", "ui" }
	S.description = "Haptics Responsive Layout: flex solving with safe areas, weights and breakpoints for the Haptics subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.haptics.responsive_layout", width = 570, height = 1084, scale = 1.09 })
		inst.system = S
		inst.ctx = ctx
