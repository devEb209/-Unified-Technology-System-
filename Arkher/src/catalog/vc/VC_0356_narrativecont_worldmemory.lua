-- ARKHER SYSTEM VC.0356 :: Narrative Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0356"
	S.key = "arkher.contneural.narrativecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.narrativecont.neural_field" }
	S.tags = { "vc", "narrativecont", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.narrativecont.world_memory_stream", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
