-- ARKHER SYSTEM Q.0109 :: Toast Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0109"
	S.key = "arkher.ui.toast.responsive_layout"
	S.name = "Toast Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Toast"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "toast", "flex", "ui" }
	S.description = "Toast Responsive Layout: flex solving with safe areas, weights and breakpoints for the Toast subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.toast.responsive_layout", width = 390, height = 964, scale = 1.12 })
		inst.system = S
		inst.ctx = ctx
