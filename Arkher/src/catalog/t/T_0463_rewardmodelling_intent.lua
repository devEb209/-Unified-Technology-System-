-- ARKHER SYSTEM T.0463 :: Reward Modelling Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0463"
	S.key = "arkher.ai.rewardmodelling.intent_understanding"
	S.name = "Reward Modelling Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "rewardmodelling", "intent", "ai" }
	S.description = "Reward Modelling Intent Understanding: natural language turned into an actionable, scored intent for the Reward Modelling subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.rewardmodelling.intent_understanding", minConfidence = 0.42 })
		inst.system = S
		inst.ctx = ctx
