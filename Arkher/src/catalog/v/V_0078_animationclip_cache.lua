-- ARKHER SYSTEM V.0078 :: Animation Clip Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0078"
	S.key = "arkher.asset.animationclip.content_cache"
	S.name = "Animation Clip Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.animationclip.dependency_graph" }
	S.tags = { "v", "animationclip", "cache", "asset" }
	S.description = "Animation Clip Content Cache: reuse of already cooked results for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.animationclip.content_cache", policy = "ttl", capacity = 138, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
