-- ARKHER SYSTEM G.0128 :: Detail Synthesis Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0128"
	S.key = "arkher.neural.detailsynth.feature_extraction"
	S.name = "Detail Synthesis Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detailsynth.inference_core" }
	S.tags = { "g", "detailsynth", "field", "neural" }
	S.description = "Detail Synthesis Feature Extraction: signal features feeding the model for the Detail Synthesis subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.detailsynth.feature_extraction", seed = 25773, frequency = 0.0072, octaves = 4, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
