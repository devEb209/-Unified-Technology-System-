-- ARKHER SYSTEM F.0121 :: Screen Space Reflection Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0121"
	S.key = "arkher.render.ssr.draw_budget"
	S.name = "Screen Space Reflection Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.ssr.adaptive_resolution" }
	S.tags = { "f", "ssr", "budgeter", "render" }
	S.description = "Screen Space Reflection Draw Budget: draw call and triangle budget allocation for the Screen Space Reflection subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.ssr.draw_budget", total = 397, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
