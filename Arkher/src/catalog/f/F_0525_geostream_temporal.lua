-- ARKHER SYSTEM F.0525 :: Geometry Streaming Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0525"
	S.key = "arkher.render.geostream.temporal_resolve"
	S.name = "Geometry Streaming Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.geostream.probe_volume" }
	S.tags = { "f", "geostream", "temporal", "render" }
	S.description = "Geometry Streaming Temporal Resolve: history reprojection with neighbourhood clamping for the Geometry Streaming subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.geostream.temporal_resolve", feedback = 0.91, phase = 8 })
		inst.system = S
		inst.ctx = ctx
