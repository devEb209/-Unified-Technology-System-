-- ARKHER SYSTEM VA.0130 :: Spatial Slice Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0130"
	S.key = "arkher.contworld.spatialslice.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.spatialslice.complexity_budget" }
	S.tags = { "va", "spatialslice", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.spatialslice.simulation_fabric", budgetMs = 2.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
