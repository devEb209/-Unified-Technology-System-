-- ARKHER SYSTEM L.0521 :: Migration Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0521"
	S.key = "arkher.sim.migration.fidelity_policy"
	S.name = "Migration Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.migration.streaming" }
	S.tags = { "l", "migration", "policy", "sim" }
	S.description = "Migration Fidelity Policy: rules that pick full, cohort or statistical simulation for the Migration subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.migration.fidelity_policy", algorithm = "roundrobin", starvationGuard = 24 })
		inst.system = S
		inst.ctx = ctx
