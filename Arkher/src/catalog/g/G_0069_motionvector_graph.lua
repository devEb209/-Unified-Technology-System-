-- ARKHER SYSTEM G.0069 :: Motion Vector Estimation Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0069"
	S.key = "arkher.neural.motionvector.sampling_graph"
	S.name = "Motion Vector Estimation Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.motionvector.training_ledger" }
	S.tags = { "g", "motionvector", "graph", "neural" }
	S.description = "Motion Vector Estimation Sampling Graph: dependency graph of sampling stages for the Motion Vector Estimation subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.motionvector.sampling_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
