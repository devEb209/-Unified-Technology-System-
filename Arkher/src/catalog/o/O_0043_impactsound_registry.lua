-- ARKHER SYSTEM O.0043 :: Impact Sound Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0043"
	S.key = "arkher.audio.impactsound.asset_registry"
	S.name = "Impact Sound Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Impact Sound"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.impactsound.streaming" }
	S.tags = { "o", "impactsound", "registry", "audio" }
	S.description = "Impact Sound Asset Registry: catalogue of sounds, variations and metadata for the Impact Sound subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.impactsound.asset_registry" })
		inst.system = S
		inst.ctx = ctx
