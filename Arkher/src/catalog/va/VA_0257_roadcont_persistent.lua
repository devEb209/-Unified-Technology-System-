-- ARKHER SYSTEM VA.0257 :: Road Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0257"
	S.key = "arkher.contworld.roadcont.persistent_state"
	S.name = "Road Continuum Persistent State"
	S.category = "VA"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.roadcont.multi-scale_fidelity" }
	S.tags = { "va", "roadcont", "persistent", "contworld" }
	S.description = "Road Continuum Persistent State: epoch-stamped persistent history and rollback for the Road Continuum subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.roadcont.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
