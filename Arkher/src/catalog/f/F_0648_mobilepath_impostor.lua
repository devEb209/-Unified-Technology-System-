-- ARKHER SYSTEM F.0648 :: Mobile Fast Path Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0648"
	S.key = "arkher.render.mobilepath.geometry_virtualization"
	S.name = "Mobile Fast Path Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.mobilepath.visibility_set" }
	S.tags = { "f", "mobilepath", "impostor", "render" }
	S.description = "Mobile Fast Path Geometry Virtualization: impostor and HLOD synthesis under a budget for the Mobile Fast Path subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.mobilepath.geometry_virtualization", atlasSlots = 32, viewCount = 8, errorThreshold = 1.60 })
		inst.system = S
		inst.ctx = ctx
