-- ARKHER SYSTEM N.0207 :: Cloud Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0207"
	S.key = "arkher.vfx.cloud.analysis"
	S.name = "Cloud Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloud"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.cloud.spatial_index" }
	S.tags = { "n", "cloud", "analyzer", "vfx" }
	S.description = "Cloud Analysis: cost, overdraw and stability analysis of the effect for the Cloud subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.cloud.analysis", window = 214, buckets = 14, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
