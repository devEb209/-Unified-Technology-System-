-- ARKHER SYSTEM E.0077 :: Normal Detail Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0077"
	S.key = "arkher.material.normaldetail.layer_composition"
	S.name = "Normal Detail Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.normaldetail.definition" }
	S.tags = { "e", "normaldetail", "composer", "material" }
	S.description = "Normal Detail Layer Composition: ordered layer composition with blend rules for the Normal Detail subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.normaldetail.layer_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
