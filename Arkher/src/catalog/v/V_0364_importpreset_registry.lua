-- ARKHER SYSTEM V.0364 :: Import Preset Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0364"
	S.key = "arkher.asset.importpreset.asset_registry"
	S.name = "Import Preset Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.importpreset.cook_pipeline" }
	S.tags = { "v", "importpreset", "registry", "asset" }
	S.description = "Import Preset Asset Registry: catalogue of every asset, its tags and its metadata for the Import Preset subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.importpreset.asset_registry" })
		inst.system = S
		inst.ctx = ctx
