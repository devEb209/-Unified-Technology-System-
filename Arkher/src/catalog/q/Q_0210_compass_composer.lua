-- ARKHER SYSTEM Q.0210 :: Compass Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0210"
	S.key = "arkher.ui.compass.theme_composition"
	S.name = "Compass Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Compass"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.compass.navigation_graph" }
	S.tags = { "q", "compass", "composer", "ui" }
	S.description = "Compass Theme Composition: blending of theme signals into the final appearance for the Compass subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.compass.theme_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
