-- ARKHER SYSTEM G.0337 :: Inference Scheduler Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0337"
	S.key = "arkher.neural.inferencesched.inference_core"
	S.name = "Inference Scheduler Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "inferencesched", "inference", "neural" }
	S.description = "Inference Scheduler Inference Core: dense network forward pass and training for the Inference Scheduler subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.inferencesched.inference_core", seed = 60143 })
		inst.system = S
		inst.ctx = ctx
