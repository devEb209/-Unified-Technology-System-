-- ARKHER SYSTEM K.0542 :: Dialogue Behaviour Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0542"
	S.key = "arkher.npc.dialoguebehaviour.crowd_steering"
	S.name = "Dialogue Behaviour Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dialoguebehaviour.navigation" }
	S.tags = { "k", "dialoguebehaviour", "crowd", "npc" }
	S.description = "Dialogue Behaviour Crowd Steering: local avoidance, cohesion and arrival at scale for the Dialogue Behaviour subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.dialoguebehaviour.crowd_steering", radius = 0.75, maxSpeed = 4.70, cellSize = 11 })
		inst.system = S
		inst.ctx = ctx
