-- ARKHER SYSTEM I.0478 :: Facial Animation Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0478"
	S.key = "arkher.anim.facialanim.pose_cache"
	S.name = "Facial Animation Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.facialanim.playback_pipeline" }
	S.tags = { "i", "facialanim", "cache", "anim" }
	S.description = "Facial Animation Pose Cache: reuse of sampled poses across frames and instances for the Facial Animation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.facialanim.pose_cache", policy = "lfu", capacity = 265, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
