-- ARKHER SYSTEM I.0374 :: Retargeting Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0374"
	S.key = "arkher.anim.retargeting.pose_cache"
	S.name = "Retargeting Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Retargeting"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.retargeting.playback_pipeline" }
	S.tags = { "i", "retargeting", "cache", "anim" }
	S.description = "Retargeting Pose Cache: reuse of sampled poses across frames and instances for the Retargeting subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.retargeting.pose_cache", policy = "lfu", capacity = 267, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
