-- ARKHER SYSTEM O.0325 :: Engine Audio DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0325"
	S.key = "arkher.audio.engineaudio.dsp_chain"
	S.name = "Engine Audio DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Engine Audio"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "engineaudio", "dsp", "audio" }
	S.description = "Engine Audio DSP Chain: biquad filtering, delay, envelope and soft clipping for the Engine Audio subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.engineaudio.dsp_chain", sampleRate = 22050, filter = "notch", cutoff = 6000, q = 0.690 })
		inst.system = S
		inst.ctx = ctx
