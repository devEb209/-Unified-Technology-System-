-- ARKHER SYSTEM VA.0514 :: Material Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0514"
	S.key = "arkher.contworld.materialcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.materialcont.complexity_budget" }
	S.tags = { "va", "materialcont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.materialcont.simulation_fabric", budgetMs = 1.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
