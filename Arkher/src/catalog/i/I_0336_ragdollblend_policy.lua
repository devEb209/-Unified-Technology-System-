-- ARKHER SYSTEM I.0336 :: Ragdoll Blend Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0336"
	S.key = "arkher.anim.ragdollblend.quality_policy"
	S.name = "Ragdoll Blend Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.ragdollblend.pose_cache" }
	S.tags = { "i", "ragdollblend", "policy", "anim" }
	S.description = "Ragdoll Blend Quality Policy: device tier rules for rate, bones and solvers for the Ragdoll Blend subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.ragdollblend.quality_policy", algorithm = "lottery", starvationGuard = 51 })
		inst.system = S
		inst.ctx = ctx
