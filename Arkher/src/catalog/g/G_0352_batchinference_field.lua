-- ARKHER SYSTEM G.0352 :: Batch Inference Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0352"
	S.key = "arkher.neural.batchinference.feature_extraction"
	S.name = "Batch Inference Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.batchinference.inference_core" }
	S.tags = { "g", "batchinference", "field", "neural" }
	S.description = "Batch Inference Feature Extraction: signal features feeding the model for the Batch Inference subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.batchinference.feature_extraction", seed = 9475, frequency = 0.0128, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
