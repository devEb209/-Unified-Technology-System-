-- ARKHER SYSTEM I.0391 :: Animation Compression Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0391"
	S.key = "arkher.anim.animcompression.skeleton"
	S.name = "Animation Compression Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "animcompression", "skeleton", "anim" }
	S.description = "Animation Compression Skeleton: bone hierarchy, bind pose and world resolution for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.animcompression.skeleton" })
		inst.system = S
		inst.ctx = ctx
