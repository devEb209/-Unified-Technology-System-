-- ARKHER SYSTEM VA.0091 :: Residency Window Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0091"
	S.key = "arkher.contworld.residencywindow.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.residencywindow.coherence_guard" }
	S.tags = { "va", "residencywindow", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.residencywindow.neural_field", dims = 16, hidden = 12, seed = 25085 })
		inst.system = S
		inst.ctx = ctx
