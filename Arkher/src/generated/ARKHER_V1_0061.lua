--!strict
-- RAGE ImGui — ANIMATION Node_Flow #0061
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="RAGE ImGui — ANIMATION Node_Flow #0061", size=Vector2.new(640, 440), pos=UDim2.fromOffset(493, 337), parent=parent, icon="✥"})
