-- ARKHER SYSTEM K.0010 :: NPC Brain Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0010"
	S.key = "arkher.npc.npcbrain.crowd_steering"
	S.name = "NPC Brain Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcbrain.navigation" }
	S.tags = { "k", "npcbrain", "crowd", "npc" }
	S.description = "NPC Brain Crowd Steering: local avoidance, cohesion and arrival at scale for the NPC Brain subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.npcbrain.crowd_steering", radius = 0.50, maxSpeed = 4.20, cellSize = 6 })
		inst.system = S
		inst.ctx = ctx
