-- ARKHER SYSTEM Z.0003 :: Adaptive World Intelligence Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0003"
	S.key = "arkher.origin.adaptiveworld.simulation_fabric"
	S.name = "Adaptive World Intelligence Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.adaptiveworld.complexity_governance" }
	S.tags = { "z", "adaptiveworld", "fabric", "origin" }
	S.description = "Adaptive World Intelligence Simulation Fabric: every simulation domain stepped under one budgeted clock for the Adaptive World Intelligence subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.adaptiveworld.simulation_fabric", budgetMs = 1.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
