-- ARKHER SYSTEM E.0123 :: Emissive Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0123"
	S.key = "arkher.material.emissive.shading_graph"
	S.name = "Emissive Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Emissive"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.emissive.layer_composition" }
	S.tags = { "e", "emissive", "shadegraph", "material" }
	S.description = "Emissive Shading Graph: node graph evaluated and compiled to Luau for the Emissive subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.emissive.shading_graph" })
		inst.system = S
		inst.ctx = ctx
