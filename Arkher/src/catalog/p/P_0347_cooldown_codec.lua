-- ARKHER SYSTEM P.0347 :: Cooldown Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0347"
	S.key = "arkher.play.cooldown.save_codec"
	S.name = "Cooldown Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Cooldown"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.cooldown.content_registry" }
	S.tags = { "p", "cooldown", "codec", "play" }
	S.description = "Cooldown Save Codec: persistence, diffing and checksum of gameplay state for the Cooldown subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.cooldown.save_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
