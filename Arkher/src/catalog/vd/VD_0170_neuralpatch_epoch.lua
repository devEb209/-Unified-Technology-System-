-- ARKHER SYSTEM VD.0170 :: Neural Patch Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0170"
	S.key = "arkher.contsim.neuralpatch.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.neuralpatch.infinite_grid" }
	S.tags = { "vd", "neuralpatch", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.neuralpatch.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
