-- ARKHER SYSTEM L.0177 :: Livestock Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0177"
	S.key = "arkher.sim.livestock.aggregate_cache"
	S.name = "Livestock Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livestock.fidelity_policy" }
	S.tags = { "l", "livestock", "cache", "sim" }
	S.description = "Livestock Aggregate Cache: reuse of expensive aggregate computations for the Livestock subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.livestock.aggregate_cache", policy = "lru", capacity = 243, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
