-- ARKHER SYSTEM F.0099 :: Ambient Occlusion Pass Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0099"
	S.key = "arkher.render.aopass.frame_graph"
	S.name = "Ambient Occlusion Pass Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "aopass", "framegraph", "render" }
	S.description = "Ambient Occlusion Pass Frame Graph: declared passes, culling, ordering and aliasing for the Ambient Occlusion Pass subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.aopass.frame_graph", budgetMs = 12.00 })
		inst.system = S
		inst.ctx = ctx
