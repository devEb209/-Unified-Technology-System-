-- ARKHER SYSTEM Q.0267 :: Virtual Joystick Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0267"
	S.key = "arkher.ui.virtualjoystick.input_mapping"
	S.name = "Virtual Joystick Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.virtualjoystick.widget_tree" }
	S.tags = { "q", "virtualjoystick", "inputmap", "ui" }
	S.description = "Virtual Joystick Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Virtual Joystick subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.virtualjoystick.input_mapping", device = "gamepad", holdTime = 0.35, deadzone = 0.20 })
		inst.system = S
		inst.ctx = ctx
