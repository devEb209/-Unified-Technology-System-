-- ARKHER SYSTEM I.0329 :: Ragdoll Blend Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0329"
	S.key = "arkher.anim.ragdollblend.inverse_kinematics"
	S.name = "Ragdoll Blend Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.ragdollblend.layered_blending" }
	S.tags = { "i", "ragdollblend", "ik", "anim" }
	S.description = "Ragdoll Blend Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Ragdoll Blend subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.ragdollblend.inverse_kinematics", iterations = 10, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
