-- ARKHER SYSTEM L.0376 :: Caravan Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0376"
	S.key = "arkher.sim.caravan.simulation_core"
	S.name = "Caravan Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "caravan", "simulation", "sim" }
	S.description = "Caravan Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Caravan subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.caravan.simulation_core", fullRadius = 240, reducedRadius = 700, budget = 41 })
		inst.system = S
		inst.ctx = ctx
