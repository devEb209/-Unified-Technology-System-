-- ARKHER SYSTEM Z.0311 :: Causality Ledger Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0311"
	S.key = "arkher.origin.causality.adaptive_workflow"
	S.name = "Causality Ledger Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.self_critique" }
	S.tags = { "z", "causality", "workflow", "origin" }
	S.description = "Causality Ledger Adaptive Workflow: verified, retryable, reversible execution plans for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.causality.adaptive_workflow", maxRetries = 3, budget = 90 })
		inst.system = S
		inst.ctx = ctx
