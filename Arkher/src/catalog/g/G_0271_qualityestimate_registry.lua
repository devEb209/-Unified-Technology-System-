-- ARKHER SYSTEM G.0271 :: Quality Estimation Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0271"
	S.key = "arkher.neural.qualityestimate.model_registry"
	S.name = "Quality Estimation Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.qualityestimate.reconstruction" }
	S.tags = { "g", "qualityestimate", "registry", "neural" }
	S.description = "Quality Estimation Model Registry: named models and their lifecycle for the Quality Estimation subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.qualityestimate.model_registry" })
		inst.system = S
		inst.ctx = ctx
