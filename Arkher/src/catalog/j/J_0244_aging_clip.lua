-- ARKHER SYSTEM J.0244 :: Aging Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0244"
	S.key = "arkher.character.aging.motion_set"
	S.name = "Aging Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.aging.rig_definition" }
	S.tags = { "j", "aging", "clip", "character" }
	S.description = "Aging Motion Set: the clips a character owns and how they sample for the Aging subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.aging.motion_set", duration = 3.00, loop = true })
		inst.system = S
		inst.ctx = ctx
