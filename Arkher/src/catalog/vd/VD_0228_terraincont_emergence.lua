-- ARKHER SYSTEM VD.0228 :: Terrain Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0228"
	S.key = "arkher.contsim.terraincont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.terraincont.reality_continuum" }
	S.tags = { "vd", "terraincont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.terraincont.emergence_continuum", windowSize = 4, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
