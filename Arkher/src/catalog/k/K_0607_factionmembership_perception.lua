-- ARKHER SYSTEM K.0607 :: Faction Membership Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0607"
	S.key = "arkher.npc.factionmembership.perception"
	S.name = "Faction Membership Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.factionmembership.emotion" }
	S.tags = { "k", "factionmembership", "perception", "npc" }
	S.description = "Faction Membership Perception: sight, hearing and bounded attention for the Faction Membership subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.factionmembership.perception", sightRange = 25, hearingRange = 20, attentionSlots = 3, fov = 1.840 })
		inst.system = S
		inst.ctx = ctx
