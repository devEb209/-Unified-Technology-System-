-- ARKHER SYSTEM VC.0482 :: Lighting Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0482"
	S.key = "arkher.contneural.lightcont.epoch_clock"
	S.name = "Lighting Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lightcont.infinite_grid" }
	S.tags = { "vc", "lightcont", "epoch", "contneural" }
	S.description = "Lighting Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Lighting Continuum subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.lightcont.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
