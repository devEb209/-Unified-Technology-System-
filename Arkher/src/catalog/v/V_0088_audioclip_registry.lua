-- ARKHER SYSTEM V.0088 :: Audio Clip Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0088"
	S.key = "arkher.asset.audioclip.asset_registry"
	S.name = "Audio Clip Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.audioclip.cook_pipeline" }
	S.tags = { "v", "audioclip", "registry", "asset" }
	S.description = "Audio Clip Asset Registry: catalogue of every asset, its tags and its metadata for the Audio Clip subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.audioclip.asset_registry" })
		inst.system = S
		inst.ctx = ctx
