-- ARKHER SYSTEM O.0042 :: Impact Sound Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0042"
	S.key = "arkher.audio.impactsound.streaming"
	S.name = "Impact Sound Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Impact Sound"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.impactsound.voice_budget" }
	S.tags = { "o", "impactsound", "streamer", "audio" }
	S.description = "Impact Sound Streaming: distance-driven residency of audio assets for the Impact Sound subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.impactsound.streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
