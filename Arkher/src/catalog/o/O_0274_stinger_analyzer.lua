-- ARKHER SYSTEM O.0274 :: Stinger Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0274"
	S.key = "arkher.audio.stinger.analysis"
	S.name = "Stinger Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Stinger"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.stinger.playback_policy" }
	S.tags = { "o", "stinger", "analyzer", "audio" }
	S.description = "Stinger Analysis: loudness, headroom and masking analysis for the Stinger subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.stinger.analysis", window = 92, buckets = 8, threshold = 4.40 })
		inst.system = S
		inst.ctx = ctx
