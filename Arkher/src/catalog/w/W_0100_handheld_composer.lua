-- ARKHER SYSTEM W.0100 :: Handheld Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0100"
	S.key = "arkher.cine.handheld.shot_composition"
	S.name = "Handheld Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Handheld"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.handheld.colour_grade" }
	S.tags = { "w", "handheld", "composer", "cine" }
	S.description = "Handheld Shot Composition: blending of the signals that make up the final shot for the Handheld subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.handheld.shot_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
