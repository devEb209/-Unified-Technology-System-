-- ARKHER SYSTEM G.0193 :: Light Transport Prediction Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0193"
	S.key = "arkher.neural.lightpredict.error_analysis"
	S.name = "Light Transport Prediction Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.lightpredict.heuristic_policy" }
	S.tags = { "g", "lightpredict", "analyzer", "neural" }
	S.description = "Light Transport Prediction Error Analysis: residual and drift analysis for the Light Transport Prediction subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.lightpredict.error_analysis", window = 127, buckets = 19, threshold = 4.90 })
		inst.system = S
		inst.ctx = ctx
