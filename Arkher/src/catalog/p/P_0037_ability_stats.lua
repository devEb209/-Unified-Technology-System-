-- ARKHER SYSTEM P.0037 :: Ability Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0037"
	S.key = "arkher.play.ability.attributes"
	S.name = "Ability Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ability"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "ability", "stats", "play" }
	S.description = "Ability Attributes: base values, layered modifiers and derived statistics for the Ability subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.ability.attributes" })
		inst.system = S
		inst.ctx = ctx
