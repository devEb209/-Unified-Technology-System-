-- ARKHER SYSTEM L.0017 :: Region Fidelity Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0017"
	S.key = "arkher.sim.regionfidelity.ecology"
	S.name = "Region Fidelity Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.regionfidelity.simulation_core" }
	S.tags = { "l", "regionfidelity", "ecology", "sim" }
	S.description = "Region Fidelity Ecology: populations, predation, harvesting and carrying capacity for the Region Fidelity subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.regionfidelity.ecology" })
		inst.system = S
		inst.ctx = ctx
