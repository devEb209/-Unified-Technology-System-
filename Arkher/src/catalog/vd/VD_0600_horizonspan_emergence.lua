-- ARKHER SYSTEM VD.0600 :: Horizon Span Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0600"
	S.key = "arkher.contsim.horizonspan.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.horizonspan.reality_continuum" }
	S.tags = { "vd", "horizonspan", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.horizonspan.emergence_continuum", windowSize = 6, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
