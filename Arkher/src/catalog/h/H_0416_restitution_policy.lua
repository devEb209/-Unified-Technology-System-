-- ARKHER SYSTEM H.0416 :: Restitution Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0416"
	S.key = "arkher.physics.restitution.simulation_policy"
	S.name = "Restitution Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Restitution"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.restitution.budget_governor" }
	S.tags = { "h", "restitution", "policy", "physics" }
	S.description = "Restitution Simulation Policy: device tier rules for substeps, iterations and sleep for the Restitution subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.restitution.simulation_policy", algorithm = "roundrobin", starvationGuard = 32 })
		inst.system = S
		inst.ctx = ctx
