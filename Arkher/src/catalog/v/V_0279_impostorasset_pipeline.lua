-- ARKHER SYSTEM V.0279 :: Impostor Asset Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0279"
	S.key = "arkher.asset.impostorasset.cook_pipeline"
	S.name = "Impostor Asset Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.impostorasset.bundling" }
	S.tags = { "v", "impostorasset", "pipeline", "asset" }
	S.description = "Impostor Asset Cook Pipeline: staged cooking with isolation and retries for the Impostor Asset subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.impostorasset.cook_pipeline", budgetMs = 3.00 })
		inst.system = S
		inst.ctx = ctx
