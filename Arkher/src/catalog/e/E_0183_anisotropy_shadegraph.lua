-- ARKHER SYSTEM E.0183 :: Anisotropy Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0183"
	S.key = "arkher.material.anisotropy.shading_graph"
	S.name = "Anisotropy Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Anisotropy"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.anisotropy.layer_composition" }
	S.tags = { "e", "anisotropy", "shadegraph", "material" }
	S.description = "Anisotropy Shading Graph: node graph evaluated and compiled to Luau for the Anisotropy subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.anisotropy.shading_graph" })
		inst.system = S
		inst.ctx = ctx
