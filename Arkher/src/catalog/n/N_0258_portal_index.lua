-- ARKHER SYSTEM N.0258 :: Portal Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0258"
	S.key = "arkher.vfx.portal.spatial_index"
	S.name = "Portal Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Portal"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.portal.quality_policy" }
	S.tags = { "n", "portal", "index", "vfx" }
	S.description = "Portal Spatial Index: spatial acceleration of effect queries and culling for the Portal subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.portal.spatial_index", mode = "hash", cellSize = 64 })
		inst.system = S
		inst.ctx = ctx
