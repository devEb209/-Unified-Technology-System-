-- ARKHER SYSTEM R.0297 :: Server Authority Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0297"
	S.key = "arkher.net.serverauthority.session_registry"
	S.name = "Server Authority Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.serverauthority.rate_guard" }
	S.tags = { "r", "serverauthority", "registry", "net" }
	S.description = "Server Authority Session Registry: catalogue of sessions, players and their metadata for the Server Authority subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.serverauthority.session_registry" })
		inst.system = S
		inst.ctx = ctx
