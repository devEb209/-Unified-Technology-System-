-- ARKHER SYSTEM K.0087 :: Working Memory Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0087"
	S.key = "arkher.npc.workingmemory.drive_system"
	S.name = "Working Memory Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workingmemory.memory" }
	S.tags = { "k", "workingmemory", "need", "npc" }
	S.description = "Working Memory Drive System: drives that decay, turn urgent and get satisfied for the Working Memory subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.workingmemory.drive_system" })
		inst.system = S
		inst.ctx = ctx
