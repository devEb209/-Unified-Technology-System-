-- ARKHER SYSTEM H.0438 :: Penetration Recovery Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0438"
	S.key = "arkher.physics.penetration.constraint_solver"
	S.name = "Penetration Recovery Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.penetration.contact_generation" }
	S.tags = { "h", "penetration", "constraint", "physics" }
	S.description = "Penetration Recovery Constraint Solver: sequential impulses, friction, joints and warm starting for the Penetration Recovery subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.penetration.constraint_solver", iterations = 7, baumgarte = 0.23, warmStart = true })
		inst.system = S
		inst.ctx = ctx
