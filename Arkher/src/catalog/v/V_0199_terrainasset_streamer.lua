-- ARKHER SYSTEM V.0199 :: Terrain Asset Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0199"
	S.key = "arkher.asset.terrainasset.streaming_residency"
	S.name = "Terrain Asset Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.terrainasset.content_cache" }
	S.tags = { "v", "terrainasset", "streamer", "asset" }
	S.description = "Terrain Asset Streaming Residency: distance-driven load and unload of asset payloads for the Terrain Asset subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.terrainasset.streaming_residency", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
