-- ARKHER SYSTEM G.0199 :: Ambient Occlusion Prediction Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0199"
	S.key = "arkher.neural.aopredict.temporal_history"
	S.name = "Ambient Occlusion Prediction Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.aopredict.feature_extraction" }
	S.tags = { "g", "aopredict", "temporal", "neural" }
	S.description = "Ambient Occlusion Prediction Temporal History: history buffers reused across frames for the Ambient Occlusion Prediction subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.aopredict.temporal_history", feedback = 0.81, phase = 8 })
		inst.system = S
		inst.ctx = ctx
