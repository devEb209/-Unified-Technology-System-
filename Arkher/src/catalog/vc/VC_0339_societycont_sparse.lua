-- ARKHER SYSTEM VC.0339 :: Society Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0339"
	S.key = "arkher.contneural.societycont.sparse_residency"
	S.name = "Society Continuum Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.societycont.epoch_clock" }
	S.tags = { "vc", "societycont", "sparse", "contneural" }
	S.description = "Society Continuum Sparse Residency: sparse page residency with eviction and compression for the Society Continuum subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.societycont.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
