-- ARKHER SYSTEM VD.0540 :: Pipeline Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0540"
	S.key = "arkher.contsim.pipelinecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.pipelinecont.reality_continuum" }
	S.tags = { "vd", "pipelinecont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.pipelinecont.emergence_continuum", windowSize = 4, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
