-- ARKHER SYSTEM G.0498 :: Neural Debug Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0498"
	S.key = "arkher.neural.neuraldebug.compute_budget"
	S.name = "Neural Debug Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuraldebug.quality_predictor" }
	S.tags = { "g", "neuraldebug", "budgeter", "neural" }
	S.description = "Neural Debug Compute Budget: inference time budget allocation for the Neural Debug subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.neuraldebug.compute_budget", total = 82, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
