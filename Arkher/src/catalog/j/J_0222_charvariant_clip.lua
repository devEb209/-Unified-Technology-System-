-- ARKHER SYSTEM J.0222 :: Character Variant Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0222"
	S.key = "arkher.character.charvariant.motion_set"
	S.name = "Character Variant Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.charvariant.rig_definition" }
	S.tags = { "j", "charvariant", "clip", "character" }
	S.description = "Character Variant Motion Set: the clips a character owns and how they sample for the Character Variant subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.charvariant.motion_set", duration = 0.60, loop = true })
		inst.system = S
		inst.ctx = ctx
