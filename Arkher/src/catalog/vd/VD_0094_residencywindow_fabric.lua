-- ARKHER SYSTEM VD.0094 :: Residency Window Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0094"
	S.key = "arkher.contsim.residencywindow.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.residencywindow.complexity_budget" }
	S.tags = { "vd", "residencywindow", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.residencywindow.simulation_fabric", budgetMs = 2.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
