-- ARKHER SYSTEM T.0159 :: Code Generation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0159"
	S.key = "arkher.ai.codegeneration.world_architect"
	S.name = "Code Generation World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.codegeneration.self_critique" }
	S.tags = { "t", "codegeneration", "architect", "ai" }
	S.description = "Code Generation World Architect: composition of a whole world plan with conserved budgets for the Code Generation subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.codegeneration.world_architect", budget = 800, seed = 56002 })
		inst.system = S
		inst.ctx = ctx
