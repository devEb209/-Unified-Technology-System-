-- ARKHER SYSTEM Q.0342 :: Safe Area Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0342"
	S.key = "arkher.ui.safearea.theme_composition"
	S.name = "Safe Area Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Safe Area"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.safearea.navigation_graph" }
	S.tags = { "q", "safearea", "composer", "ui" }
	S.description = "Safe Area Theme Composition: blending of theme signals into the final appearance for the Safe Area subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.safearea.theme_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
