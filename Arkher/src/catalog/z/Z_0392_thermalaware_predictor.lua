-- ARKHER SYSTEM Z.0392 :: Thermal Aware Simulation Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0392"
	S.key = "arkher.origin.thermalaware.predictive_optimization"
	S.name = "Thermal Aware Simulation Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.adaptive_workflow" }
	S.tags = { "z", "thermalaware", "predictor", "origin" }
	S.description = "Thermal Aware Simulation Predictive Optimization: forecast-driven optimization before the cost is paid for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.thermalaware.predictive_optimization", method = "linear", alpha = 0.49, window = 63 })
		inst.system = S
		inst.ctx = ctx
