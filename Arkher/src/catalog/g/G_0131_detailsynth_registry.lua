-- ARKHER SYSTEM G.0131 :: Detail Synthesis Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0131"
	S.key = "arkher.neural.detailsynth.model_registry"
	S.name = "Detail Synthesis Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detailsynth.reconstruction" }
	S.tags = { "g", "detailsynth", "registry", "neural" }
	S.description = "Detail Synthesis Model Registry: named models and their lifecycle for the Detail Synthesis subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.detailsynth.model_registry" })
		inst.system = S
		inst.ctx = ctx
