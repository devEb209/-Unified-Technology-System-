-- ARKHER SYSTEM J.0092 :: Expression Set Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0092"
	S.key = "arkher.character.expression.look_and_reach"
	S.name = "Expression Set Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.expression.blend_controller" }
	S.tags = { "j", "expression", "ik", "character" }
	S.description = "Expression Set Look And Reach: look-at, reach and foot placement for the character for the Expression Set subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.expression.look_and_reach", iterations = 5, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
