-- ARKHER SYSTEM R.0088 :: Property Replication Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0088"
	S.key = "arkher.net.propertyreplication.transport_graph"
	S.name = "Property Replication Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.propertyreplication.prediction_and_reconciliation" }
	S.tags = { "r", "propertyreplication", "network", "net" }
	S.description = "Property Replication Transport Graph: topology, capacity and routing between endpoints for the Property Replication subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.propertyreplication.transport_graph" })
		inst.system = S
		inst.ctx = ctx
