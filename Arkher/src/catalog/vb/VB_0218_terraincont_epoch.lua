-- ARKHER SYSTEM VB.0218 :: Terrain Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0218"
	S.key = "arkher.conttime.terraincont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.terraincont.infinite_grid" }
	S.tags = { "vb", "terraincont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.terraincont.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
