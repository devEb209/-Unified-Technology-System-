-- ARKHER SYSTEM L.0151 :: Agriculture Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0151"
	S.key = "arkher.sim.agriculture.simulation_core"
	S.name = "Agriculture Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "agriculture", "simulation", "sim" }
	S.description = "Agriculture Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Agriculture subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.agriculture.simulation_core", fullRadius = 320, reducedRadius = 700, budget = 73 })
		inst.system = S
		inst.ctx = ctx
