-- ARKHER SYSTEM W.0121 :: Drone Shot Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0121"
	S.key = "arkher.cine.drone.sequence_timeline"
	S.name = "Drone Shot Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Drone Shot"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "drone", "timeline", "cine" }
	S.description = "Drone Shot Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Drone Shot subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.drone.sequence_timeline", duration = 6.0, rate = 1.14 })
		inst.system = S
		inst.ctx = ctx
