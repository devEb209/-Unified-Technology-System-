-- ARKHER SYSTEM F.0267 :: Tonemapping Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0267"
	S.key = "arkher.render.tonemap.frame_graph"
	S.name = "Tonemapping Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Tonemapping"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "tonemap", "framegraph", "render" }
	S.description = "Tonemapping Frame Graph: declared passes, culling, ordering and aliasing for the Tonemapping subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.tonemap.frame_graph", budgetMs = 12.00 })
		inst.system = S
		inst.ctx = ctx
