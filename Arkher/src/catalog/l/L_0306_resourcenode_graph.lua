-- ARKHER SYSTEM L.0306 :: Resource Node Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0306"
	S.key = "arkher.sim.resourcenode.region_graph"
	S.name = "Resource Node Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.resourcenode.calendar" }
	S.tags = { "l", "resourcenode", "graph", "sim" }
	S.description = "Resource Node Region Graph: connectivity, components and shortest path between places for the Resource Node subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.resourcenode.region_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
