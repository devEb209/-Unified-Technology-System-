-- ARKHER SYSTEM F.0305 :: Bloom Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0305"
	S.key = "arkher.render.bloom.pass_cache"
	S.name = "Bloom Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Bloom"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.bloom.render_policy" }
	S.tags = { "f", "bloom", "cache", "render" }
	S.description = "Bloom Pass Cache: reuse of pass results across frames for the Bloom subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.bloom.pass_cache", policy = "lru", capacity = 468, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
