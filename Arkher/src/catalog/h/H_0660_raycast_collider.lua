-- ARKHER SYSTEM H.0660 :: Raycast Query Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0660"
	S.key = "arkher.physics.raycast.collision_shape"
	S.name = "Raycast Query Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.raycast.body_dynamics" }
	S.tags = { "h", "raycast", "collider", "physics" }
	S.description = "Raycast Query Collision Shape: shape bounds, support mapping and closest points for the Raycast Query subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.raycast.collision_shape", shape = "sphere", radius = 0.40, height = 1.20, layer = "default" })
		inst.system = S
		inst.ctx = ctx
