-- ARKHER SYSTEM Z.0848 :: Simulation Time Dilation Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0848"
	S.key = "arkher.origin.timedilation.semantic_graph"
	S.name = "Simulation Time Dilation Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.world_architect" }
	S.tags = { "z", "timedilation", "knowledge", "origin" }
	S.description = "Simulation Time Dilation Semantic Graph: typed entities and inferred relations of the technology itself for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.timedilation.semantic_graph", dims = 16 })
		inst.system = S
		inst.ctx = ctx
