-- ARKHER SYSTEM I.0057 :: Animation Clip Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0057"
	S.key = "arkher.anim.animclip.physical_blend"
	S.name = "Animation Clip Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animclip.inverse_kinematics" }
	S.tags = { "i", "animclip", "ragdoll", "anim" }
	S.description = "Animation Clip Physical Blend: physical bones blended against the animated pose for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.animclip.physical_blend", blendSpeed = 2.10 })
		inst.system = S
		inst.ctx = ctx
