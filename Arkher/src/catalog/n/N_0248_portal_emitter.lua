-- ARKHER SYSTEM N.0248 :: Portal Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0248"
	S.key = "arkher.vfx.portal.emission"
	S.name = "Portal Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Portal"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "portal", "emitter", "vfx" }
	S.description = "Portal Emission: shaped, rate and burst emission of new particles for the Portal subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.portal.emission", shape = "cone", rate = 60, speed = 5.00, life = 1.80, budget = 384, seed = 59380 })
		inst.system = S
		inst.ctx = ctx
