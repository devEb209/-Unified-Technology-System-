-- ARKHER SYSTEM Z.0040 :: Predictive Optimization Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0040"
	S.key = "arkher.origin.predictiveopt.orchestration"
	S.name = "Predictive Optimization Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.residency_streaming" }
	S.tags = { "z", "predictiveopt", "orchestrator", "origin" }
	S.description = "Predictive Optimization Orchestration: lifecycle and phase orchestration of the technology for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.predictiveopt.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
