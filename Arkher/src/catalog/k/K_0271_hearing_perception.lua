-- ARKHER SYSTEM K.0271 :: Hearing Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0271"
	S.key = "arkher.npc.hearing.perception"
	S.name = "Hearing Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hearing.emotion" }
	S.tags = { "k", "hearing", "perception", "npc" }
	S.description = "Hearing Perception: sight, hearing and bounded attention for the Hearing subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.hearing.perception", sightRange = 60, hearingRange = 16, attentionSlots = 6, fov = 1.830 })
		inst.system = S
		inst.ctx = ctx
