-- ARKHER SYSTEM K.0649 :: Daily Routine Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0649"
	S.key = "arkher.npc.dailyroutine.perception"
	S.name = "Daily Routine Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dailyroutine.emotion" }
	S.tags = { "k", "dailyroutine", "perception", "npc" }
	S.description = "Daily Routine Perception: sight, hearing and bounded attention for the Daily Routine subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.dailyroutine.perception", sightRange = 50, hearingRange = 32, attentionSlots = 4, fov = 1.810 })
		inst.system = S
		inst.ctx = ctx
