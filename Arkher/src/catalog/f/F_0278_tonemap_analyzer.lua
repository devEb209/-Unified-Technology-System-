-- ARKHER SYSTEM F.0278 :: Tonemapping Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0278"
	S.key = "arkher.render.tonemap.frame_analysis"
	S.name = "Tonemapping Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Tonemapping"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.tonemap.pass_cache" }
	S.tags = { "f", "tonemap", "analyzer", "render" }
	S.description = "Tonemapping Frame Analysis: per-pass cost analysis and outlier detection for the Tonemapping subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.tonemap.frame_analysis", window = 98, buckets = 14, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
