-- ARKHER SYSTEM N.0037 :: Fire Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0037"
	S.key = "arkher.vfx.fire.spatial_index"
	S.name = "Fire Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fire"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fire.quality_policy" }
	S.tags = { "n", "fire", "index", "vfx" }
	S.description = "Fire Spatial Index: spatial acceleration of effect queries and culling for the Fire subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.fire.spatial_index", mode = "hash", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
