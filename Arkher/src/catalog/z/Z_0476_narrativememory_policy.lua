-- ARKHER SYSTEM Z.0476 :: Narrative Memory Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0476"
	S.key = "arkher.origin.narrativememory.governance_policy"
	S.name = "Narrative Memory Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.signal_composition" }
	S.tags = { "z", "narrativememory", "policy", "origin" }
	S.description = "Narrative Memory Governance Policy: ordered rules governing when the technology may act for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.narrativememory.governance_policy", algorithm = "lottery", starvationGuard = 27 })
		inst.system = S
		inst.ctx = ctx
