-- ARKHER SYSTEM H.0242 :: Broadphase Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0242"
	S.key = "arkher.physics.broadphase.constraint_solver"
	S.name = "Broadphase Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Broadphase"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.broadphase.contact_generation" }
	S.tags = { "h", "broadphase", "constraint", "physics" }
	S.description = "Broadphase Constraint Solver: sequential impulses, friction, joints and warm starting for the Broadphase subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.broadphase.constraint_solver", iterations = 13, baumgarte = 0.29, warmStart = true })
		inst.system = S
		inst.ctx = ctx
