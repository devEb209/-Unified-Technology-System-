-- ARKHER SYSTEM VD.0184 :: Simulation Domain Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0184"
	S.key = "arkher.contsim.simdomain.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.simdomain.sparse_residency" }
	S.tags = { "vd", "simdomain", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.simdomain.multi-scale_fidelity", levels = 4, baseTriangles = 105000 })
		inst.system = S
		inst.ctx = ctx
