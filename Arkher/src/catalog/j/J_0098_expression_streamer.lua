-- ARKHER SYSTEM J.0098 :: Expression Set Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0098"
	S.key = "arkher.character.expression.streaming"
	S.name = "Expression Set Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.expression.budget_governor" }
	S.tags = { "j", "expression", "streamer", "character" }
	S.description = "Expression Set Streaming: distance-driven residency of character data for the Expression Set subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.expression.streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
