-- ARKHER SYSTEM I.0428 :: Animation LOD Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0428"
	S.key = "arkher.anim.animlod.analysis"
	S.name = "Animation LOD Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlod.quality_policy" }
	S.tags = { "i", "animlod", "analyzer", "anim" }
	S.description = "Animation LOD Analysis: pop, drift and cost analysis of playback for the Animation LOD subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.animlod.analysis", window = 210, buckets = 10, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
