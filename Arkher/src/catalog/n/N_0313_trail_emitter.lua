-- ARKHER SYSTEM N.0313 :: Trail Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0313"
	S.key = "arkher.vfx.trail.emission"
	S.name = "Trail Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Trail"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "trail", "emitter", "vfx" }
	S.description = "Trail Emission: shaped, rate and burst emission of new particles for the Trail subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.trail.emission", shape = "cone", rate = 32, speed = 4.20, life = 2.00, budget = 384, seed = 40092 })
		inst.system = S
		inst.ctx = ctx
