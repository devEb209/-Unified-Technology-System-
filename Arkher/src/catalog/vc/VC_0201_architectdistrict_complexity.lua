-- ARKHER SYSTEM VC.0201 :: Architect District Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0201"
	S.key = "arkher.contneural.architectdistrict.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.architectdistrict.world_memory_stream" }
	S.tags = { "vc", "architectdistrict", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.architectdistrict.complexity_budget", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
