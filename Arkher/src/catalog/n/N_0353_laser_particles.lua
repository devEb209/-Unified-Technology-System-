-- ARKHER SYSTEM N.0353 :: Laser Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0353"
	S.key = "arkher.vfx.laser.particle_simulation"
	S.name = "Laser Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Laser"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.laser.emission" }
	S.tags = { "n", "laser", "particles", "vfx" }
	S.description = "Laser Particle Simulation: pooled integration of position, velocity, colour and life for the Laser subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.laser.particle_simulation", capacity = 192, drag = 0.14, bounce = 0.09, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
