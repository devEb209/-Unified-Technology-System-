-- ARKHER SYSTEM J.0064 :: Eyes Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0064"
	S.key = "arkher.character.eyes.budget_governor"
	S.name = "Eyes Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.eyes.variant_registry" }
	S.tags = { "j", "eyes", "budgeter", "character" }
	S.description = "Eyes Budget Governor: per-character cost allocation in a crowd for the Eyes subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.eyes.budget_governor", total = 251, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
