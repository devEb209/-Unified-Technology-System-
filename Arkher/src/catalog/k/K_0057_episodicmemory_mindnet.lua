-- ARKHER SYSTEM K.0057 :: Episodic Memory Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0057"
	S.key = "arkher.npc.episodicmemory.mind_network"
	S.name = "Episodic Memory Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "episodicmemory", "mindnet", "npc" }
	S.description = "Episodic Memory Mind Network: the learned policy that turns perception into a decision for the Episodic Memory subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.episodicmemory.mind_network", inputs = 8, hidden = 5, seed = 77586, learningRate = 0.080, exploration = 0.030 })
		inst.system = S
		inst.ctx = ctx
