-- ARKHER SYSTEM VD.0525 :: Asset Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0525"
	S.key = "arkher.contsim.assetcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.assetcont.world_memory_stream" }
	S.tags = { "vd", "assetcont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.assetcont.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
