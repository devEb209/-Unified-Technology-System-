-- ARKHER SYSTEM R.0261 :: Bandwidth Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0261"
	S.key = "arkher.net.bandwidth.session_registry"
	S.name = "Bandwidth Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Bandwidth"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.bandwidth.rate_guard" }
	S.tags = { "r", "bandwidth", "registry", "net" }
	S.description = "Bandwidth Session Registry: catalogue of sessions, players and their metadata for the Bandwidth subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.bandwidth.session_registry" })
		inst.system = S
		inst.ctx = ctx
