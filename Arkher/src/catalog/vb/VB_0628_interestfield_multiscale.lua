-- ARKHER SYSTEM VB.0628 :: Interest Field Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0628"
	S.key = "arkher.conttime.interestfield.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.interestfield.sparse_residency" }
	S.tags = { "vb", "interestfield", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.interestfield.multi-scale_fidelity", levels = 6, baseTriangles = 135000 })
		inst.system = S
		inst.ctx = ctx
