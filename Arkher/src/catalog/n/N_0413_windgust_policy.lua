-- ARKHER SYSTEM N.0413 :: Wind Gust Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0413"
	S.key = "arkher.vfx.windgust.quality_policy"
	S.name = "Wind Gust Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Wind Gust"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.windgust.result_cache" }
	S.tags = { "n", "windgust", "policy", "vfx" }
	S.description = "Wind Gust Quality Policy: distance and device driven fidelity bands for the Wind Gust subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.windgust.quality_policy", algorithm = "wfq", starvationGuard = 58 })
		inst.system = S
		inst.ctx = ctx
