-- ARKHER SYSTEM W.0152 :: Point Of View Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0152"
	S.key = "arkher.cine.pointofview.cinematic_mix"
	S.name = "Point Of View Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.pointofview.motion_tween" }
	S.tags = { "w", "pointofview", "mixer", "cine" }
	S.description = "Point Of View Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Point Of View subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.pointofview.cinematic_mix", maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
