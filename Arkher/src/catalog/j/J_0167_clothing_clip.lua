-- ARKHER SYSTEM J.0167 :: Clothing Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0167"
	S.key = "arkher.character.clothing.motion_set"
	S.name = "Clothing Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.clothing.rig_definition" }
	S.tags = { "j", "clothing", "clip", "character" }
	S.description = "Clothing Motion Set: the clips a character owns and how they sample for the Clothing subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.clothing.motion_set", duration = 1.10, loop = true })
		inst.system = S
		inst.ctx = ctx
