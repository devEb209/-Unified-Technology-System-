-- ARKHER SYSTEM VD.0439 :: Physics Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0439"
	S.key = "arkher.contsim.physicscont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.physicscont.coherence_guard" }
	S.tags = { "vd", "physicscont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.physicscont.neural_field", dims = 12, hidden = 8, seed = 12244 })
		inst.system = S
		inst.ctx = ctx
