-- ARKHER SYSTEM K.0663 :: Sleep Cycle Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0663"
	S.key = "arkher.npc.sleepcycle.perception"
	S.name = "Sleep Cycle Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.sleepcycle.emotion" }
	S.tags = { "k", "sleepcycle", "perception", "npc" }
	S.description = "Sleep Cycle Perception: sight, hearing and bounded attention for the Sleep Cycle subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.sleepcycle.perception", sightRange = 55, hearingRange = 12, attentionSlots = 5, fov = 1.740 })
		inst.system = S
		inst.ctx = ctx
