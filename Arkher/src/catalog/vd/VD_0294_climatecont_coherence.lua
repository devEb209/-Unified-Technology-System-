-- ARKHER SYSTEM VD.0294 :: Climate Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0294"
	S.key = "arkher.contsim.climatecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.climatecont.persistent_state" }
	S.tags = { "vd", "climatecont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.climatecont.coherence_guard", window = 133, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
