-- ARKHER SYSTEM E.0298 :: Wear And Tear Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0298"
	S.key = "arkher.material.wear.authoring_pipeline"
	S.name = "Wear And Tear Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.wear.analysis" }
	S.tags = { "e", "wear", "pipeline", "material" }
	S.description = "Wear And Tear Authoring Pipeline: ordered authoring and bake stages for the Wear And Tear subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.wear.authoring_pipeline", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
