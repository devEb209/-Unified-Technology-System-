-- ARKHER SYSTEM Z.0967 :: Generation Migration World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0967"
	S.key = "arkher.origin.generationmigration.world_architect"
	S.name = "Generation Migration World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.emergence_detection" }
	S.tags = { "z", "generationmigration", "architect", "origin" }
	S.description = "Generation Migration World Architect: hierarchical world composition with conserved budgets for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.generationmigration.world_architect", budget = 600, seed = 1740 })
		inst.system = S
		inst.ctx = ctx
