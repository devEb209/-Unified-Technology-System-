-- ARKHER SYSTEM V.0100 :: Music Track Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0100"
	S.key = "arkher.asset.musictrack.asset_registry"
	S.name = "Music Track Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.musictrack.cook_pipeline" }
	S.tags = { "v", "musictrack", "registry", "asset" }
	S.description = "Music Track Asset Registry: catalogue of every asset, its tags and its metadata for the Music Track subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.musictrack.asset_registry" })
		inst.system = S
		inst.ctx = ctx
