-- ARKHER SYSTEM P.0109 :: Equipment Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0109"
	S.key = "arkher.play.equipment.attributes"
	S.name = "Equipment Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Equipment"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "equipment", "stats", "play" }
	S.description = "Equipment Attributes: base values, layered modifiers and derived statistics for the Equipment subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.equipment.attributes" })
		inst.system = S
		inst.ctx = ctx
