-- ARKHER SYSTEM L.0036 :: Offscreen Simulation Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0036"
	S.key = "arkher.sim.offscreensim.region_graph"
	S.name = "Offscreen Simulation Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.offscreensim.calendar" }
	S.tags = { "l", "offscreensim", "graph", "sim" }
	S.description = "Offscreen Simulation Region Graph: connectivity, components and shortest path between places for the Offscreen Simulation subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.offscreensim.region_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
