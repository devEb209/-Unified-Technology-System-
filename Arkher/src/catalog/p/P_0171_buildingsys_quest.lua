-- ARKHER SYSTEM P.0171 :: Building Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0171"
	S.key = "arkher.play.buildingsys.objectives"
	S.name = "Building Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Building"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.buildingsys.inventory" }
	S.tags = { "p", "buildingsys", "quest", "play" }
	S.description = "Building Objectives: objectives, prerequisites, progress and rewards for the Building subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.buildingsys.objectives" })
		inst.system = S
		inst.ctx = ctx
