-- ARKHER SYSTEM V.0235 :: Data Table Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0235"
	S.key = "arkher.asset.datatable.streaming_residency"
	S.name = "Data Table Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.datatable.content_cache" }
	S.tags = { "v", "datatable", "streamer", "asset" }
	S.description = "Data Table Streaming Residency: distance-driven load and unload of asset payloads for the Data Table subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.datatable.streaming_residency", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
