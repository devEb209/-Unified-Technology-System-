-- ARKHER SYSTEM VC.0463 :: Audio Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0463"
	S.key = "arkher.contneural.audiocont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.audiocont.coherence_guard" }
	S.tags = { "vc", "audiocont", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.audiocont.neural_field", dims = 24, hidden = 20, seed = 24243 })
		inst.system = S
		inst.ctx = ctx
