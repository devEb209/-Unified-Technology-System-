-- ARKHER SYSTEM K.0696 :: NPC Debug Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0696"
	S.key = "arkher.npc.npcdebug.crowd_steering"
	S.name = "NPC Debug Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcdebug.navigation" }
	S.tags = { "k", "npcdebug", "crowd", "npc" }
	S.description = "NPC Debug Crowd Steering: local avoidance, cohesion and arrival at scale for the NPC Debug subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.npcdebug.crowd_steering", radius = 0.55, maxSpeed = 3.30, cellSize = 9 })
		inst.system = S
		inst.ctx = ctx
