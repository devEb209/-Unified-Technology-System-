-- ARKHER SYSTEM I.0111 :: Clip Events Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0111"
	S.key = "arkher.anim.clipevents.compression_codec"
	S.name = "Clip Events Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Events"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clipevents.retarget_graph" }
	S.tags = { "i", "clipevents", "codec", "anim" }
	S.description = "Clip Events Compression Codec: curve compression and quantized transport for the Clip Events subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.clipevents.compression_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
