-- ARKHER SYSTEM V.0374 :: Cook Target Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0374"
	S.key = "arkher.asset.cooktarget.bundling"
	S.name = "Cook Target Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.cooktarget.import" }
	S.tags = { "v", "cooktarget", "bundler", "asset" }
	S.description = "Cook Target Bundling: size-bounded packing, manifests and delta patches for the Cook Target subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.cooktarget.bundling", maxBundleBytes = 524288 })
		inst.system = S
		inst.ctx = ctx
