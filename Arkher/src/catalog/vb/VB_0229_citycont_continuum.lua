-- ARKHER SYSTEM VB.0229 :: City Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0229"
	S.key = "arkher.conttime.citycont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "citycont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.citycont.infinite_grid", cellSize = 128, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
