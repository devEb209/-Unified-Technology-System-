-- ARKHER SYSTEM O.0428 :: Audio Profiling Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0428"
	S.key = "arkher.audio.audioprofiling.compression_codec"
	S.name = "Audio Profiling Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audioprofiling.asset_registry" }
	S.tags = { "o", "audioprofiling", "codec", "audio" }
	S.description = "Audio Profiling Compression Codec: payload encoding of audio state and events for the Audio Profiling subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.audioprofiling.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
