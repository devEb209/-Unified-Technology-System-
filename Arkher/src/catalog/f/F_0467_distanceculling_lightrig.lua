-- ARKHER SYSTEM F.0467 :: Distance Culling Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0467"
	S.key = "arkher.render.distanceculling.lighting_rig"
	S.name = "Distance Culling Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.distanceculling.geometry_virtualization" }
	S.tags = { "f", "distanceculling", "lightrig", "render" }
	S.description = "Distance Culling Lighting Rig: light clustering, importance and cascades for the Distance Culling subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.distanceculling.lighting_rig", maxActive = 11 })
		inst.system = S
		inst.ctx = ctx
