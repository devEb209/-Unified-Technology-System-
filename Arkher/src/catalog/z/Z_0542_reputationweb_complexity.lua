-- ARKHER SYSTEM Z.0542 :: Reputation Web Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0542"
	S.key = "arkher.origin.reputationweb.complexity_governance"
	S.name = "Reputation Web Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.reality_layering" }
	S.tags = { "z", "reputationweb", "complexity", "origin" }
	S.description = "Reputation Web Complexity Governance: measured scene cost turned into per-subsystem directives for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.reputationweb.complexity_governance", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
