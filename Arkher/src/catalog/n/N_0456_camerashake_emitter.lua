-- ARKHER SYSTEM N.0456 :: Camera Shake Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0456"
	S.key = "arkher.vfx.camerashake.emission"
	S.name = "Camera Shake Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Camera Shake"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "camerashake", "emitter", "vfx" }
	S.description = "Camera Shake Emission: shaped, rate and burst emission of new particles for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.camerashake.emission", shape = "sphere", rate = 65, speed = 3.50, life = 2.30, budget = 448, seed = 79485 })
		inst.system = S
		inst.ctx = ctx
