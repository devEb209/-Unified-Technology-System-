-- ARKHER SYSTEM K.0399 :: Plan Execution Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0399"
	S.key = "arkher.npc.planexecution.utility_reasoning"
	S.name = "Plan Execution Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.planexecution.reactive_behaviour" }
	S.tags = { "k", "planexecution", "utility", "npc" }
	S.description = "Plan Execution Utility Reasoning: scored option selection with response curves for the Plan Execution subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.planexecution.utility_reasoning", momentum = 0.01 })
		inst.system = S
		inst.ctx = ctx
