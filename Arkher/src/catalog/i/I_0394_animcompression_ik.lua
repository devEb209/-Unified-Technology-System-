-- ARKHER SYSTEM I.0394 :: Animation Compression Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0394"
	S.key = "arkher.anim.animcompression.inverse_kinematics"
	S.name = "Animation Compression Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animcompression.layered_blending" }
	S.tags = { "i", "animcompression", "ik", "anim" }
	S.description = "Animation Compression Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.animcompression.inverse_kinematics", iterations = 9, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
