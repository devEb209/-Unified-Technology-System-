-- ARKHER SYSTEM VA.0626 :: Interest Field Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0626"
	S.key = "arkher.contworld.interestfield.epoch_clock"
	S.name = "Interest Field Epoch Clock"
	S.category = "VA"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.interestfield.infinite_grid" }
	S.tags = { "va", "interestfield", "epoch", "contworld" }
	S.description = "Interest Field Epoch Clock: deterministic epoch timeline with catch-up for the Interest Field subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.interestfield.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
