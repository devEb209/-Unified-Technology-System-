-- ARKHER SYSTEM T.0600 :: Deployment Reasoning Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0600"
	S.key = "arkher.ai.deploymentreasoning.model_inference"
	S.name = "Deployment Reasoning Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.deploymentreasoning.action_planner" }
	S.tags = { "t", "deploymentreasoning", "inference", "ai" }
	S.description = "Deployment Reasoning Model Inference: quantized inference with batching and budget for the Deployment Reasoning subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.deploymentreasoning.model_inference", seed = 78286 })
		inst.system = S
		inst.ctx = ctx
