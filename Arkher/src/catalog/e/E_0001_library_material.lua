-- ARKHER SYSTEM E.0001 :: Material Library Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0001"
	S.key = "arkher.material.library.definition"
	S.name = "Material Library Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "library", "material", "material" }
	S.description = "Material Library Definition: layered PBR definition resolved into parameters for the Material Library subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.library.definition", texelBudget = 2097152 })
		inst.system = S
		inst.ctx = ctx
