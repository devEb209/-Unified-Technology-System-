-- ARKHER SYSTEM Z.0467 :: Narrative Memory World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0467"
	S.key = "arkher.origin.narrativememory.world_architect"
	S.name = "Narrative Memory World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.emergence_detection" }
	S.tags = { "z", "narrativememory", "architect", "origin" }
	S.description = "Narrative Memory World Architect: hierarchical world composition with conserved budgets for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.narrativememory.world_architect", budget = 1400, seed = 33608 })
		inst.system = S
		inst.ctx = ctx
