-- ARKHER SYSTEM Z.0138 :: Dynamic Complexity Manager Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0138"
	S.key = "arkher.origin.complexitymanager.budget_governor"
	S.name = "Dynamic Complexity Manager Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.behaviour_analysis" }
	S.tags = { "z", "complexitymanager", "budgeter", "origin" }
	S.description = "Dynamic Complexity Manager Budget Governor: allocation of a scarce resource across the technology's consumers for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.complexitymanager.budget_governor", total = 411, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
