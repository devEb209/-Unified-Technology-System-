-- ARKHER SYSTEM VA.0382 :: Dialogue Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0382"
	S.key = "arkher.contworld.dialoguecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.dialoguecont.complexity_budget" }
	S.tags = { "va", "dialoguecont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.dialoguecont.simulation_fabric", budgetMs = 3.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
