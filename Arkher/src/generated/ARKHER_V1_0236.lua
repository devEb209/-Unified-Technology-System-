--!strict
-- Frostbite Frosty — CORE Node_Flow #0236
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Frostbite Frosty — CORE Node_Flow #0236", size=Vector2.new(680, 440), pos=UDim2.fromOffset(368, 192), parent=parent, icon="✎"})
