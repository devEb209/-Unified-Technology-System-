-- ARKHER SYSTEM Z.0731 :: Knowledge Distillation Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0731"
	S.key = "arkher.origin.distillation.adaptive_workflow"
	S.name = "Knowledge Distillation Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.distillation.self_critique" }
	S.tags = { "z", "distillation", "workflow", "origin" }
	S.description = "Knowledge Distillation Adaptive Workflow: verified, retryable, reversible execution plans for the Knowledge Distillation subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.distillation.adaptive_workflow", maxRetries = 2, budget = 50 })
		inst.system = S
		inst.ctx = ctx
