-- ARKHER SYSTEM H.0064 :: Inertia Tensor Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0064"
	S.key = "arkher.physics.inertia.broadphase_index"
	S.name = "Inertia Tensor Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.inertia.vehicle" }
	S.tags = { "h", "inertia", "index", "physics" }
	S.description = "Inertia Tensor Broadphase Index: spatial acceleration of candidate pair finding for the Inertia Tensor subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.inertia.broadphase_index", mode = "hash", cellSize = 80 })
		inst.system = S
		inst.ctx = ctx
