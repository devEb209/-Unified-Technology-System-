-- ARKHER SYSTEM VB.0186 :: Simulation Domain Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0186"
	S.key = "arkher.conttime.simdomain.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.simdomain.persistent_state" }
	S.tags = { "vb", "simdomain", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.simdomain.coherence_guard", window = 130, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
