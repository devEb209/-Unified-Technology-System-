-- ARKHER SYSTEM F.0091 :: Contact Shadows Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0091"
	S.key = "arkher.render.contact.temporal_resolve"
	S.name = "Contact Shadows Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.contact.probe_volume" }
	S.tags = { "f", "contact", "temporal", "render" }
	S.description = "Contact Shadows Temporal Resolve: history reprojection with neighbourhood clamping for the Contact Shadows subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.contact.temporal_resolve", feedback = 0.92, phase = 8 })
		inst.system = S
		inst.ctx = ctx
