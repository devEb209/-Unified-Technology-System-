-- ARKHER SYSTEM K.0214 :: Mood Emotion
...
return function(A)
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.mood.drive_system" }
	S.tags = { "k", "mood", "emotion", "npc" }
	S.description = "Mood Emotion: appraisal of events into valence, arousal and mood for the Mood subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.mood.emotion", inertia = 0.86, decayRate = 0.41, baselineArousal = 0.21 })
		inst.system = S
		inst.ctx = ctx
