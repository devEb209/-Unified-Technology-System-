-- ARKHER SYSTEM T.0409 :: Device Reasoning Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0409"
	S.key = "arkher.ai.devicereasoning.plan_workflow"
	S.name = "Device Reasoning Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.devicereasoning.semantic_knowledge" }
	S.tags = { "t", "devicereasoning", "workflow", "ai" }
	S.description = "Device Reasoning Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Device Reasoning subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.devicereasoning.plan_workflow", maxRetries = 2, budget = 140 })
		inst.system = S
		inst.ctx = ctx
