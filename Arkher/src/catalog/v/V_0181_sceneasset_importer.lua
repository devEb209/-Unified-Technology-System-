-- ARKHER SYSTEM V.0181 :: Scene Asset Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0181"
	S.key = "arkher.asset.sceneasset.import"
	S.name = "Scene Asset Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "sceneasset", "importer", "asset" }
	S.description = "Scene Asset Import: validation, normalization, hashing and deduplication of incoming content for the Scene Asset subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.sceneasset.import", unitScale = 1.25 })
		inst.system = S
		inst.ctx = ctx
