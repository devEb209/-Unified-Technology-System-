-- ARKHER SYSTEM R.0057 :: Player State Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0057"
	S.key = "arkher.net.playerstate.session_registry"
	S.name = "Player State Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Player State"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.playerstate.rate_guard" }
	S.tags = { "r", "playerstate", "registry", "net" }
	S.description = "Player State Session Registry: catalogue of sessions, players and their metadata for the Player State subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.playerstate.session_registry" })
		inst.system = S
		inst.ctx = ctx
