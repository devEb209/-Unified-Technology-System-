-- ARKHER SYSTEM I.0305 :: Aim Offset Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0305"
	S.key = "arkher.anim.aimoffset.retarget_graph"
	S.name = "Aim Offset Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Aim Offset"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.aimoffset.physical_blend" }
	S.tags = { "i", "aimoffset", "graph", "anim" }
	S.description = "Aim Offset Retarget Graph: bone mapping and retarget path resolution for the Aim Offset subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.aimoffset.retarget_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
