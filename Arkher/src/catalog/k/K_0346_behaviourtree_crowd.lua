-- ARKHER SYSTEM K.0346 :: Behaviour Tree Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0346"
	S.key = "arkher.npc.behaviourtree.crowd_steering"
	S.name = "Behaviour Tree Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourtree.navigation" }
	S.tags = { "k", "behaviourtree", "crowd", "npc" }
	S.description = "Behaviour Tree Crowd Steering: local avoidance, cohesion and arrival at scale for the Behaviour Tree subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.behaviourtree.crowd_steering", radius = 0.40, maxSpeed = 4.00, cellSize = 10 })
		inst.system = S
		inst.ctx = ctx
