-- ARKHER SYSTEM W.0088 :: Crane Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0088"
	S.key = "arkher.cine.crane.shot_composition"
	S.name = "Crane Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Crane"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.crane.colour_grade" }
	S.tags = { "w", "crane", "composer", "cine" }
	S.description = "Crane Shot Composition: blending of the signals that make up the final shot for the Crane subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.crane.shot_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
