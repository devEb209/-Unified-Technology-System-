-- ARKHER SYSTEM VC.0265 :: Bridge Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0265"
	S.key = "arkher.contneural.bridgecont.infinite_grid"
	S.name = "Bridge Continuum Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "bridgecont", "continuum", "contneural" }
	S.description = "Bridge Continuum Infinite Grid: seamless paging of the infinite world grid for the Bridge Continuum subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.bridgecont.infinite_grid", cellSize = 96, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
