-- ARKHER SYSTEM E.0357 :: Snow Cover Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0357"
	S.key = "arkher.material.snowcover.analysis"
	S.name = "Snow Cover Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Snow Cover"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.snowcover.instance_cache" }
	S.tags = { "e", "snowcover", "analyzer", "material" }
	S.description = "Snow Cover Analysis: cost, redundancy and outlier analysis for the Snow Cover subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.snowcover.analysis", window = 199, buckets = 11, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
