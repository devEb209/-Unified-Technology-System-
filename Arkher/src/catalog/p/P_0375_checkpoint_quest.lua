-- ARKHER SYSTEM P.0375 :: Checkpoint Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0375"
	S.key = "arkher.play.checkpoint.objectives"
	S.name = "Checkpoint Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Checkpoint"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.checkpoint.inventory" }
	S.tags = { "p", "checkpoint", "quest", "play" }
	S.description = "Checkpoint Objectives: objectives, prerequisites, progress and rewards for the Checkpoint subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.checkpoint.objectives" })
		inst.system = S
		inst.ctx = ctx
