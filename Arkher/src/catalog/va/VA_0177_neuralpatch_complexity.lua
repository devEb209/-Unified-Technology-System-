-- ARKHER SYSTEM VA.0177 :: Neural Patch Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0177"
	S.key = "arkher.contworld.neuralpatch.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.neuralpatch.world_memory_stream" }
	S.tags = { "va", "neuralpatch", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.neuralpatch.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
