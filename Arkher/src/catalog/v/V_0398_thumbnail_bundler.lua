-- ARKHER SYSTEM V.0398 :: Thumbnail Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0398"
	S.key = "arkher.asset.thumbnail.bundling"
	S.name = "Thumbnail Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.thumbnail.import" }
	S.tags = { "v", "thumbnail", "bundler", "asset" }
	S.description = "Thumbnail Bundling: size-bounded packing, manifests and delta patches for the Thumbnail subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.thumbnail.bundling", maxBundleBytes = 786432 })
		inst.system = S
		inst.ctx = ctx
