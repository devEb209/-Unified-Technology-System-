-- ARKHER SYSTEM R.0233 :: Interest Management Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0233"
	S.key = "arkher.net.interestmanagement.bandwidth_budget"
	S.name = "Interest Management Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.interestmanagement.transport_graph" }
	S.tags = { "r", "interestmanagement", "budgeter", "net" }
	S.description = "Interest Management Bandwidth Budget: bytes per second shared between competing streams for the Interest Management subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.interestmanagement.bandwidth_budget", total = 344, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
