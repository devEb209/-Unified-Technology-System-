-- ARKHER SYSTEM VC.0538 :: Pipeline Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0538"
	S.key = "arkher.contneural.pipelinecont.simulation_fabric"
	S.name = "Pipeline Continuum Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.pipelinecont.complexity_budget" }
	S.tags = { "vc", "pipelinecont", "fabric", "contneural" }
	S.description = "Pipeline Continuum Simulation Fabric: fabric stepping the continuum domains for the Pipeline Continuum subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.pipelinecont.simulation_fabric", budgetMs = 2.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
