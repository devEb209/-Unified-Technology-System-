-- ARKHER SYSTEM P.0470 :: Gameplay Debug Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0470"
	S.key = "arkher.play.gameplaydebug.inventory"
	S.name = "Gameplay Debug Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.gameplaydebug.attributes" }
	S.tags = { "p", "gameplaydebug", "inventory", "play" }
	S.description = "Gameplay Debug Inventory: slots, stacking, weight, equipment and crafting for the Gameplay Debug subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.gameplaydebug.inventory", slots = 36, maxWeight = 140 })
		inst.system = S
		inst.ctx = ctx
