-- ARKHER SYSTEM H.0169 :: Sleeping Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0169"
	S.key = "arkher.physics.sleeping.body_dynamics"
	S.name = "Sleeping Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Sleeping"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "sleeping", "rigidbody", "physics" }
	S.description = "Sleeping Body Dynamics: integration, impulses, damping and sleeping of a body for the Sleeping subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.sleeping.body_dynamics", mass = 29.00, radius = 0.70, restitution = 0.28, friction = 0.78, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
