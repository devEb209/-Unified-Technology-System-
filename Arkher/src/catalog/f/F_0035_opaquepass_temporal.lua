-- ARKHER SYSTEM F.0035 :: Opaque Pass Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0035"
	S.key = "arkher.render.opaquepass.temporal_resolve"
	S.name = "Opaque Pass Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Opaque Pass"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.opaquepass.probe_volume" }
	S.tags = { "f", "opaquepass", "temporal", "render" }
	S.description = "Opaque Pass Temporal Resolve: history reprojection with neighbourhood clamping for the Opaque Pass subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.opaquepass.temporal_resolve", feedback = 0.94, phase = 8 })
		inst.system = S
		inst.ctx = ctx
