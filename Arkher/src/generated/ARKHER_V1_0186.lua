--!strict
-- OpenLandMap — CORE Node_Flow #0186
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="OpenLandMap — CORE Node_Flow #0186", size=Vector2.new(600, 440), pos=UDim2.fromOffset(118, 122), parent=parent, icon="⬔"})
