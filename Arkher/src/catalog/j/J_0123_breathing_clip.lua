-- ARKHER SYSTEM J.0123 :: Breathing Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0123"
	S.key = "arkher.character.breathing.motion_set"
	S.name = "Breathing Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.breathing.rig_definition" }
	S.tags = { "j", "breathing", "clip", "character" }
	S.description = "Breathing Motion Set: the clips a character owns and how they sample for the Breathing subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.breathing.motion_set", duration = 2.40, loop = false })
		inst.system = S
		inst.ctx = ctx
