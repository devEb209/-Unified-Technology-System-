-- ARKHER SYSTEM N.0482 :: Glow Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0482"
	S.key = "arkher.vfx.glow.emission"
	S.name = "Glow Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Glow"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "glow", "emitter", "vfx" }
	S.description = "Glow Emission: shaped, rate and burst emission of new particles for the Glow subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.glow.emission", shape = "box", rate = 26, speed = 5.60, life = 1.40, budget = 256, seed = 59106 })
		inst.system = S
		inst.ctx = ctx
