-- ARKHER SYSTEM H.0600 :: Wind Force Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0600"
	S.key = "arkher.physics.wind.analysis"
	S.name = "Wind Force Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Wind Force"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.wind.result_cache" }
	S.tags = { "h", "wind", "analyzer", "physics" }
	S.description = "Wind Force Analysis: energy, jitter and cost analysis of the simulation for the Wind Force subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.wind.analysis", window = 187, buckets = 11, threshold = 2.90 })
		inst.system = S
		inst.ctx = ctx
