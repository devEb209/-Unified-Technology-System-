-- ARKHER SYSTEM L.0485 :: Diplomacy Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0485"
	S.key = "arkher.sim.diplomacy.calendar"
	S.name = "Diplomacy Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.diplomacy.society" }
	S.tags = { "l", "diplomacy", "schedule", "sim" }
	S.description = "Diplomacy Calendar: hours, days and seasons driving the region for the Diplomacy subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.diplomacy.calendar", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
