-- ARKHER SYSTEM VD.0227 :: Terrain Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0227"
	S.key = "arkher.contsim.terraincont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.terraincont.simulation_fabric" }
	S.tags = { "vd", "terraincont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.terraincont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
