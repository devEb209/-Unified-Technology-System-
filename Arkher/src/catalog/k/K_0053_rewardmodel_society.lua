-- ARKHER SYSTEM K.0053 :: Reward Model Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0053"
	S.key = "arkher.npc.rewardmodel.social_relations"
	S.name = "Reward Model Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.rewardmodel.crowd_steering" }
	S.tags = { "k", "rewardmodel", "society", "npc" }
	S.description = "Reward Model Social Relations: affinity, factions, reputation and gossip for the Reward Model subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.rewardmodel.social_relations", decayRate = 0.005, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
