-- ARKHER SYSTEM N.0440 :: Cloth Wind Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0440"
	S.key = "arkher.vfx.clothwind.spatial_index"
	S.name = "Cloth Wind Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloth Wind"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.clothwind.quality_policy" }
	S.tags = { "n", "clothwind", "index", "vfx" }
	S.description = "Cloth Wind Spatial Index: spatial acceleration of effect queries and culling for the Cloth Wind subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.clothwind.spatial_index", mode = "hash", cellSize = 24 })
		inst.system = S
		inst.ctx = ctx
