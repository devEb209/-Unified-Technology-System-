-- ARKHER SYSTEM T.0656 :: Human Handoff Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0656"
	S.key = "arkher.ai.humanhandoff.model_inference"
	S.name = "Human Handoff Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.humanhandoff.action_planner" }
	S.tags = { "t", "humanhandoff", "inference", "ai" }
	S.description = "Human Handoff Model Inference: quantized inference with batching and budget for the Human Handoff subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.humanhandoff.model_inference", seed = 75994 })
		inst.system = S
		inst.ctx = ctx
