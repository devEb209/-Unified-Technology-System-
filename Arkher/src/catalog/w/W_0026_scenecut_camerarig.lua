-- ARKHER SYSTEM W.0026 :: Scene Cut Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0026"
	S.key = "arkher.cine.scenecut.camera_rig"
	S.name = "Scene Cut Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Scene Cut"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.scenecut.sequence_timeline" }
	S.tags = { "w", "scenecut", "camerarig", "cine" }
	S.description = "Scene Cut Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Scene Cut subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.scenecut.camera_rig", fov = 0.92, focus = 6.0, aperture = 2.4, smoothing = 8.0, distance = 8, height = 4 })
		inst.system = S
		inst.ctx = ctx
