-- ARKHER SYSTEM I.0240 :: Locomotion Blend Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0240"
	S.key = "arkher.anim.locomotionblend.retarget_graph"
	S.name = "Locomotion Blend Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.locomotionblend.physical_blend" }
	S.tags = { "i", "locomotionblend", "graph", "anim" }
	S.description = "Locomotion Blend Retarget Graph: bone mapping and retarget path resolution for the Locomotion Blend subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.locomotionblend.retarget_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
