-- ARKHER SYSTEM G.0139 :: Detail Synthesis Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0139"
	S.key = "arkher.neural.detailsynth.sampling_graph"
	S.name = "Detail Synthesis Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detailsynth.training_ledger" }
	S.tags = { "g", "detailsynth", "graph", "neural" }
	S.description = "Detail Synthesis Sampling Graph: dependency graph of sampling stages for the Detail Synthesis subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.detailsynth.sampling_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
