-- ARKHER SYSTEM Z.0060 :: Singularity World Architect Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0060"
	S.key = "arkher.origin.worldarchitect.orchestration"
	S.name = "Singularity World Architect Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.residency_streaming" }
	S.tags = { "z", "worldarchitect", "orchestrator", "origin" }
	S.description = "Singularity World Architect Orchestration: lifecycle and phase orchestration of the technology for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.worldarchitect.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
