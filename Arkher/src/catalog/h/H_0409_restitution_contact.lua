-- ARKHER SYSTEM H.0409 :: Restitution Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0409"
	S.key = "arkher.physics.restitution.contact_generation"
	S.name = "Restitution Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Restitution"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.restitution.collision_shape" }
	S.tags = { "h", "restitution", "contact", "physics" }
	S.description = "Restitution Contact Generation: narrow-phase manifolds with normal, depth and point for the Restitution subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.restitution.contact_generation", slop = 0.0050, maxManifolds = 149 })
		inst.system = S
		inst.ctx = ctx
