-- ARKHER SYSTEM H.0089 :: Gravity Field Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0089"
	S.key = "arkher.physics.gravityfield.query"
	S.name = "Gravity Field Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.gravityfield.constraint_solver" }
	S.tags = { "h", "gravityfield", "raycaster", "physics" }
	S.description = "Gravity Field Query: rays, sweeps and overlaps against the simulation for the Gravity Field subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.gravityfield.query", cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
