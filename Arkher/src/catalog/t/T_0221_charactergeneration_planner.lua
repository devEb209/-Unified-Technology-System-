-- ARKHER SYSTEM T.0221 :: Character Generation Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0221"
	S.key = "arkher.ai.charactergeneration.action_planner"
	S.name = "Character Generation Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.charactergeneration.utility_selection" }
	S.tags = { "t", "charactergeneration", "planner", "ai" }
	S.description = "Character Generation Action Planner: goal-oriented action planning over preconditions for the Character Generation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.charactergeneration.action_planner", maxDepth = 8 })
		inst.system = S
		inst.ctx = ctx
