-- ARKHER SYSTEM F.0402 :: Draw Call Batching Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0402"
	S.key = "arkher.render.batching.render_policy"
	S.name = "Draw Call Batching Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.batching.draw_budget" }
	S.tags = { "f", "batching", "policy", "render" }
	S.description = "Draw Call Batching Render Policy: device tier rules for the frame for the Draw Call Batching subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.batching.render_policy", algorithm = "lottery", starvationGuard = 39 })
		inst.system = S
		inst.ctx = ctx
