-- ARKHER SYSTEM VC.0111 :: Temporal Slice Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0111"
	S.key = "arkher.contneural.temporalslice.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.temporalslice.epoch_clock" }
	S.tags = { "vc", "temporalslice", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.temporalslice.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
