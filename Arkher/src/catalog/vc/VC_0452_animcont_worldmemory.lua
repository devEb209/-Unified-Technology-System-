-- ARKHER SYSTEM VC.0452 :: Animation Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0452"
	S.key = "arkher.contneural.animcont.world_memory_stream"
	S.name = "Animation Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.animcont.neural_field" }
	S.tags = { "vc", "animcont", "worldmemory", "contneural" }
	S.description = "Animation Continuum World Memory Stream: world memory continuum over epochs for the Animation Continuum subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.animcont.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
