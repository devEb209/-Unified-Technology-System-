-- ARKHER SYSTEM VD.0633 :: Interest Field Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0633"
	S.key = "arkher.contsim.interestfield.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.interestfield.world_memory_stream" }
	S.tags = { "vd", "interestfield", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.interestfield.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
