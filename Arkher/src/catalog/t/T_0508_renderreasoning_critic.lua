-- ARKHER SYSTEM T.0508 :: Render Reasoning Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0508"
	S.key = "arkher.ai.renderreasoning.self_critique"
	S.name = "Render Reasoning Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.renderreasoning.plan_workflow" }
	S.tags = { "t", "renderreasoning", "critic", "ai" }
	S.description = "Render Reasoning Self Critique: weighted evaluation of the result against declared criteria for the Render Reasoning subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.renderreasoning.self_critique", passMark = 0.79, reviseMark = 0.49, seed = 18129 })
		inst.system = S
		inst.ctx = ctx
