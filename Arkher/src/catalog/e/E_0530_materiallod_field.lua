-- ARKHER SYSTEM E.0530 :: Material LOD Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0530"
	S.key = "arkher.material.materiallod.procedural_detail"
	S.name = "Material LOD Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Material LOD"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.materiallod.texture_sampling" }
	S.tags = { "e", "materiallod", "field", "material" }
	S.description = "Material LOD Procedural Detail: coherent noise detail driving the surface for the Material LOD subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.materiallod.procedural_detail", seed = 50789, frequency = 0.0112, octaves = 4, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
