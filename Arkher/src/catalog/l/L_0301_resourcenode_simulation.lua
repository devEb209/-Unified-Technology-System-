-- ARKHER SYSTEM L.0301 :: Resource Node Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0301"
	S.key = "arkher.sim.resourcenode.simulation_core"
	S.name = "Resource Node Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "resourcenode", "simulation", "sim" }
	S.description = "Resource Node Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Resource Node subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.resourcenode.simulation_core", fullRadius = 120, reducedRadius = 800, budget = 122 })
		inst.system = S
		inst.ctx = ctx
