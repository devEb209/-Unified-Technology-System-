-- ARKHER SYSTEM F.0483 :: Impostor Rendering Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0483"
	S.key = "arkher.render.impostorrender.temporal_resolve"
	S.name = "Impostor Rendering Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.impostorrender.probe_volume" }
	S.tags = { "f", "impostorrender", "temporal", "render" }
	S.description = "Impostor Rendering Temporal Resolve: history reprojection with neighbourhood clamping for the Impostor Rendering subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.impostorrender.temporal_resolve", feedback = 0.85, phase = 8 })
		inst.system = S
		inst.ctx = ctx
