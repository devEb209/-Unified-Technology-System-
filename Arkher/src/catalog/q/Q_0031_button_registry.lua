-- ARKHER SYSTEM Q.0031 :: Button Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0031"
	S.key = "arkher.ui.button.localization_registry"
	S.name = "Button Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Button"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.button.theme_composition" }
	S.tags = { "q", "button", "registry", "ui" }
	S.description = "Button Localization Registry: catalogue of strings, plurals and locale metadata for the Button subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.button.localization_registry" })
		inst.system = S
		inst.ctx = ctx
