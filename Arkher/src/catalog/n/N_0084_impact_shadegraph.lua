-- ARKHER SYSTEM N.0084 :: Impact Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0084"
	S.key = "arkher.vfx.impact.effect_graph"
	S.name = "Impact Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Impact"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.impact.curve_authoring" }
	S.tags = { "n", "impact", "shadegraph", "vfx" }
	S.description = "Impact Effect Graph: node graph describing how the effect is shaded for the Impact subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.impact.effect_graph" })
		inst.system = S
		inst.ctx = ctx
