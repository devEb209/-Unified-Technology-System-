...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="CryEngine Qt — CORE Mixer #0162", size=Vector2.new(600, 460), pos=UDim2.fromOffset(206, 234), parent=parent, icon="⤢"})
