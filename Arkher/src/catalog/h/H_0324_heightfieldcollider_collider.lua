-- ARKHER SYSTEM H.0324 :: Heightfield Collider Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0324"
	S.key = "arkher.physics.heightfieldcollider.collision_shape"
	S.name = "Heightfield Collider Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.heightfieldcollider.body_dynamics" }
	S.tags = { "h", "heightfieldcollider", "collider", "physics" }
	S.description = "Heightfield Collider Collision Shape: shape bounds, support mapping and closest points for the Heightfield Collider subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.heightfieldcollider.collision_shape", shape = "sphere", radius = 2.20, height = 1.80, layer = "character" })
		inst.system = S
		inst.ctx = ctx
