-- ARKHER SYSTEM VB.0190 :: Simulation Domain Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0190"
	S.key = "arkher.conttime.simdomain.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.simdomain.complexity_budget" }
	S.tags = { "vb", "simdomain", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.simdomain.simulation_fabric", budgetMs = 2.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
