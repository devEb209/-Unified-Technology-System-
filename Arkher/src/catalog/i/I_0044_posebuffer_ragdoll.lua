-- ARKHER SYSTEM I.0044 :: Pose Buffer Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0044"
	S.key = "arkher.anim.posebuffer.physical_blend"
	S.name = "Pose Buffer Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Pose Buffer"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.posebuffer.inverse_kinematics" }
	S.tags = { "i", "posebuffer", "ragdoll", "anim" }
	S.description = "Pose Buffer Physical Blend: physical bones blended against the animated pose for the Pose Buffer subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.posebuffer.physical_blend", blendSpeed = 5.70 })
		inst.system = S
		inst.ctx = ctx
