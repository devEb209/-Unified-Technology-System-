-- ARKHER SYSTEM G.0447 :: Model Versioning Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0447"
	S.key = "arkher.neural.modelversion.sampling_graph"
	S.name = "Model Versioning Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelversion.training_ledger" }
	S.tags = { "g", "modelversion", "graph", "neural" }
	S.description = "Model Versioning Sampling Graph: dependency graph of sampling stages for the Model Versioning subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.modelversion.sampling_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
