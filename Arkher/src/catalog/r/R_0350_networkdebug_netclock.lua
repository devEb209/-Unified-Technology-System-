-- ARKHER SYSTEM R.0350 :: Network Debug Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0350"
	S.key = "arkher.net.networkdebug.time_sync"
	S.name = "Network Debug Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.networkdebug.replication" }
	S.tags = { "r", "networkdebug", "netclock", "net" }
	S.description = "Network Debug Time Sync: offset estimation, outlier rejection and jitter buffering for the Network Debug subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.networkdebug.time_sync", tickRate = 30, bufferDelay = 0.070, maxSamples = 21 })
		inst.system = S
		inst.ctx = ctx
