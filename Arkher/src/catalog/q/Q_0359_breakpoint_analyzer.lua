-- ARKHER SYSTEM Q.0359 :: Responsive Breakpoint Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0359"
	S.key = "arkher.ui.breakpoint.usability_analysis"
	S.name = "Responsive Breakpoint Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.breakpoint.frame_budget" }
	S.tags = { "q", "breakpoint", "analyzer", "ui" }
	S.description = "Responsive Breakpoint Usability Analysis: reachability, latency and abandonment analysis for the Responsive Breakpoint subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.breakpoint.usability_analysis", window = 111, buckets = 11, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
