-- ARKHER SYSTEM N.0028 :: Fire Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0028"
	S.key = "arkher.vfx.fire.particle_simulation"
	S.name = "Fire Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fire"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fire.emission" }
	S.tags = { "n", "fire", "particles", "vfx" }
	S.description = "Fire Particle Simulation: pooled integration of position, velocity, colour and life for the Fire subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.fire.particle_simulation", capacity = 576, drag = 0.16, bounce = 0.11, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
