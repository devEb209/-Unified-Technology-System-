-- ARKHER SYSTEM P.0176 :: Building Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0176"
	S.key = "arkher.play.buildingsys.balance_analysis"
	S.name = "Building Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Building"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.buildingsys.event_ledger" }
	S.tags = { "p", "buildingsys", "analyzer", "play" }
	S.description = "Building Balance Analysis: distribution, outlier and pacing analysis for the Building subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.buildingsys.balance_analysis", window = 233, buckets = 17, threshold = 3.50 })
		inst.system = S
		inst.ctx = ctx
