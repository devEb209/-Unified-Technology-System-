-- ARKHER SYSTEM N.0139 :: Waterfall Mist Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0139"
	S.key = "arkher.vfx.mist.result_cache"
	S.name = "Waterfall Mist Result Cache"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.mist.spawn_budget" }
	S.tags = { "n", "mist", "cache", "vfx" }
	S.description = "Waterfall Mist Result Cache: reuse of expensive effect evaluations for the Waterfall Mist subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.mist.result_cache", policy = "lru", capacity = 161, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
