-- ARKHER SYSTEM P.0155 :: Crafting Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0155"
	S.key = "arkher.play.crafting.save_codec"
	S.name = "Crafting Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Crafting"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.crafting.content_registry" }
	S.tags = { "p", "crafting", "codec", "play" }
	S.description = "Crafting Save Codec: persistence, diffing and checksum of gameplay state for the Crafting subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.crafting.save_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
