-- ARKHER SYSTEM P.0232 :: Quest Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0232"
	S.key = "arkher.play.questsys.combat_resolution"
	S.name = "Quest Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Quest"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.questsys.objectives" }
	S.tags = { "p", "questsys", "combat", "play" }
	S.description = "Quest Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Quest subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.questsys.combat_resolution", seed = 73608, armourK = 80, critMultiplier = 1.50 })
		inst.system = S
		inst.ctx = ctx
