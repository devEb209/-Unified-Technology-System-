-- ARKHER SYSTEM K.0227 :: Personality Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0227"
	S.key = "arkher.npc.personality.drive_system"
	S.name = "Personality Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.personality.memory" }
	S.tags = { "k", "personality", "need", "npc" }
	S.description = "Personality Drive System: drives that decay, turn urgent and get satisfied for the Personality subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.personality.drive_system" })
		inst.system = S
		inst.ctx = ctx
