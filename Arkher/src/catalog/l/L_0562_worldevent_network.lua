-- ARKHER SYSTEM L.0562 :: World Event Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0562"
	S.key = "arkher.sim.worldevent.route_network"
	S.name = "World Event Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldevent.region_graph" }
	S.tags = { "l", "worldevent", "network", "sim" }
	S.description = "World Event Route Network: roads, rivers and routes between settlements for the World Event subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.worldevent.route_network" })
		inst.system = S
		inst.ctx = ctx
