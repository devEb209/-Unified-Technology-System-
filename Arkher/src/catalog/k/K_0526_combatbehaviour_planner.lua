-- ARKHER SYSTEM K.0526 :: Combat Behaviour Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0526"
	S.key = "arkher.npc.combatbehaviour.goal_planner"
	S.name = "Combat Behaviour Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.combatbehaviour.utility_reasoning" }
	S.tags = { "k", "combatbehaviour", "planner", "npc" }
	S.description = "Combat Behaviour Goal Planner: backward GOAP planning to reach a goal state for the Combat Behaviour subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.combatbehaviour.goal_planner", maxDepth = 9 })
		inst.system = S
		inst.ctx = ctx
