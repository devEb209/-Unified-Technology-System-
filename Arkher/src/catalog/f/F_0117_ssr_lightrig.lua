-- ARKHER SYSTEM F.0117 :: Screen Space Reflection Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0117"
	S.key = "arkher.render.ssr.lighting_rig"
	S.name = "Screen Space Reflection Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.ssr.geometry_virtualization" }
	S.tags = { "f", "ssr", "lightrig", "render" }
	S.description = "Screen Space Reflection Lighting Rig: light clustering, importance and cascades for the Screen Space Reflection subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.ssr.lighting_rig", maxActive = 10 })
		inst.system = S
		inst.ctx = ctx
