-- ARKHER SYSTEM Z.0862 :: Multi Scale Simulation Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0862"
	S.key = "arkher.origin.multiscale.complexity_governance"
	S.name = "Multi Scale Simulation Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.reality_layering" }
	S.tags = { "z", "multiscale", "complexity", "origin" }
	S.description = "Multi Scale Simulation Complexity Governance: measured scene cost turned into per-subsystem directives for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.multiscale.complexity_governance", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
