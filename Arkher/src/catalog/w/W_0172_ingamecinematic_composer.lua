-- ARKHER SYSTEM W.0172 :: In Game Cinematic Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0172"
	S.key = "arkher.cine.ingamecinematic.shot_composition"
	S.name = "In Game Cinematic Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.ingamecinematic.colour_grade" }
	S.tags = { "w", "ingamecinematic", "composer", "cine" }
	S.description = "In Game Cinematic Shot Composition: blending of the signals that make up the final shot for the In Game Cinematic subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.ingamecinematic.shot_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
