-- ARKHER SYSTEM VB.0333 :: Economy Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0333"
	S.key = "arkher.conttime.economycont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.economycont.world_memory_stream" }
	S.tags = { "vb", "economycont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.economycont.complexity_budget", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
