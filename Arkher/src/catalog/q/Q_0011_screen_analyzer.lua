-- ARKHER SYSTEM Q.0011 :: Screen Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0011"
	S.key = "arkher.ui.screen.usability_analysis"
	S.name = "Screen Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Screen"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.screen.frame_budget" }
	S.tags = { "q", "screen", "analyzer", "ui" }
	S.description = "Screen Usability Analysis: reachability, latency and abandonment analysis for the Screen subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.screen.usability_analysis", window = 115, buckets = 19, threshold = 3.70 })
		inst.system = S
		inst.ctx = ctx
