-- ARKHER SYSTEM L.0265 :: Season Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0265"
	S.key = "arkher.sim.season.streaming"
	S.name = "Season Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.season.state_codec" }
	S.tags = { "l", "season", "streamer", "sim" }
	S.description = "Season Streaming: distance-driven residency of simulated regions for the Season subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.season.streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
