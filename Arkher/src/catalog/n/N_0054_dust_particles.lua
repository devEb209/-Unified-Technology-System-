-- ARKHER SYSTEM N.0054 :: Dust Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0054"
	S.key = "arkher.vfx.dust.particle_simulation"
	S.name = "Dust Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Dust"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.dust.emission" }
	S.tags = { "n", "dust", "particles", "vfx" }
	S.description = "Dust Particle Simulation: pooled integration of position, velocity, colour and life for the Dust subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.dust.particle_simulation", capacity = 192, drag = 0.10, bounce = 0.45, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
