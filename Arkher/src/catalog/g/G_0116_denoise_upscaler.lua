-- ARKHER SYSTEM G.0116 :: Denoising Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0116"
	S.key = "arkher.neural.denoise.reconstruction"
	S.name = "Denoising Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.denoise.temporal_history" }
	S.tags = { "g", "denoise", "upscaler", "neural" }
	S.description = "Denoising Reconstruction: resolution ladder and image reconstruction for the Denoising subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.denoise.reconstruction", targetMs = 16.10, index = 5, sharpness = 0.47 })
		inst.system = S
		inst.ctx = ctx
