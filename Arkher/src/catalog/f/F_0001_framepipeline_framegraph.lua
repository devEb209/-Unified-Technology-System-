-- ARKHER SYSTEM F.0001 :: Frame Pipeline Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0001"
	S.key = "arkher.render.framepipeline.frame_graph"
	S.name = "Frame Pipeline Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "framepipeline", "framegraph", "render" }
	S.description = "Frame Pipeline Frame Graph: declared passes, culling, ordering and aliasing for the Frame Pipeline subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.framepipeline.frame_graph", budgetMs = 9.00 })
		inst.system = S
		inst.ctx = ctx
