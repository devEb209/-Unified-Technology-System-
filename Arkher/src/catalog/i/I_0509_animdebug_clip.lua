-- ARKHER SYSTEM I.0509 :: Animation Debug Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0509"
	S.key = "arkher.anim.animdebug.clip_sampling"
	S.name = "Animation Debug Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animdebug.skeleton" }
	S.tags = { "i", "animdebug", "clip", "anim" }
	S.description = "Animation Debug Clip Sampling: keyframe tracks sampled, retimed and evented for the Animation Debug subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.animdebug.clip_sampling", duration = 1.70, loop = true })
		inst.system = S
		inst.ctx = ctx
