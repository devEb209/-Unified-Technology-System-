-- ARKHER SYSTEM K.0411 :: Interruption Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0411"
	S.key = "arkher.npc.interruption.perception"
	S.name = "Interruption Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.interruption.emotion" }
	S.tags = { "k", "interruption", "perception", "npc" }
	S.description = "Interruption Perception: sight, hearing and bounded attention for the Interruption subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.interruption.perception", sightRange = 35, hearingRange = 20, attentionSlots = 5, fov = 1.860 })
		inst.system = S
		inst.ctx = ctx
