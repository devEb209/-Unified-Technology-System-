-- ARKHER SYSTEM N.0211 :: Lightning Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0211"
	S.key = "arkher.vfx.lightning.force_field"
	S.name = "Lightning Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Lightning"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.lightning.particle_simulation" }
	S.tags = { "n", "lightning", "forcefield", "vfx" }
	S.description = "Lightning Force Field: wind, attraction, vortex, drag and curl turbulence for the Lightning subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.lightning.force_field", seed = 36868 })
		inst.system = S
		inst.ctx = ctx
