-- ARKHER SYSTEM P.0016 :: Attribute Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0016"
	S.key = "arkher.play.attribute.combat_resolution"
	S.name = "Attribute Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Attribute"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.attribute.objectives" }
	S.tags = { "p", "attribute", "combat", "play" }
	S.description = "Attribute Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Attribute subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.attribute.combat_resolution", seed = 99204, armourK = 120, critMultiplier = 1.50 })
		inst.system = S
		inst.ctx = ctx
