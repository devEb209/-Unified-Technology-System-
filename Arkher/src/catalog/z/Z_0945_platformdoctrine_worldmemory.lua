-- ARKHER SYSTEM Z.0945 :: Platform Abstraction Doctrine World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0945"
	S.key = "arkher.origin.platformdoctrine.world_memory"
	S.name = "Platform Abstraction Doctrine World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.platformdoctrine.autonomous_pipeline" }
	S.tags = { "z", "platformdoctrine", "worldmemory", "origin" }
	S.description = "Platform Abstraction Doctrine World Memory: epoch-stamped persistent history with compaction and checkpoints for the Platform Abstraction Doctrine subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.platformdoctrine.world_memory", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
