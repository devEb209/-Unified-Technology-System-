-- ARKHER SYSTEM I.0452 :: Motion Matching Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0452"
	S.key = "arkher.anim.motionmatching.pose_cache"
	S.name = "Motion Matching Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.motionmatching.playback_pipeline" }
	S.tags = { "i", "motionmatching", "cache", "anim" }
	S.description = "Motion Matching Pose Cache: reuse of sampled poses across frames and instances for the Motion Matching subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.motionmatching.pose_cache", policy = "ttl", capacity = 120, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
