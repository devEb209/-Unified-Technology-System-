-- ARKHER SYSTEM E.0097 :: Height Displacement Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0097"
	S.key = "arkher.material.displacement.parameter_budget"
	S.name = "Height Displacement Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.displacement.variant_registry" }
	S.tags = { "e", "displacement", "budgeter", "material" }
	S.description = "Height Displacement Parameter Budget: texel and layer budget allocation for the Height Displacement subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.displacement.parameter_budget", total = 415, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
