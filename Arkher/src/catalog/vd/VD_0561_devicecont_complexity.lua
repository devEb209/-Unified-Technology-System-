-- ARKHER SYSTEM VD.0561 :: Device Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0561"
	S.key = "arkher.contsim.devicecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.devicecont.world_memory_stream" }
	S.tags = { "vd", "devicecont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.devicecont.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
