-- ARKHER SYSTEM E.0336 :: Rust Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0336"
	S.key = "arkher.material.rust.variant_registry"
	S.name = "Rust Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Rust"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.rust.procedural_detail" }
	S.tags = { "e", "rust", "registry", "material" }
	S.description = "Rust Variant Registry: named variants and their lifecycle for the Rust subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.rust.variant_registry" })
		inst.system = S
		inst.ctx = ctx
