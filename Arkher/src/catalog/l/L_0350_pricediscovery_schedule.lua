-- ARKHER SYSTEM L.0350 :: Price Discovery Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0350"
	S.key = "arkher.sim.pricediscovery.calendar"
	S.name = "Price Discovery Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.pricediscovery.society" }
	S.tags = { "l", "pricediscovery", "schedule", "sim" }
	S.description = "Price Discovery Calendar: hours, days and seasons driving the region for the Price Discovery subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.pricediscovery.calendar", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
