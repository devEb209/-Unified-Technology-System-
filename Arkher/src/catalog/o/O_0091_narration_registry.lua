-- ARKHER SYSTEM O.0091 :: Narration Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0091"
	S.key = "arkher.audio.narration.asset_registry"
	S.name = "Narration Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Narration"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.narration.streaming" }
	S.tags = { "o", "narration", "registry", "audio" }
	S.description = "Narration Asset Registry: catalogue of sounds, variations and metadata for the Narration subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.narration.asset_registry" })
		inst.system = S
		inst.ctx = ctx
