-- ARKHER SYSTEM I.0174 :: Crossfade Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0174"
	S.key = "arkher.anim.crossfade.physical_blend"
	S.name = "Crossfade Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Crossfade"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crossfade.inverse_kinematics" }
	S.tags = { "i", "crossfade", "ragdoll", "anim" }
	S.description = "Crossfade Physical Blend: physical bones blended against the animated pose for the Crossfade subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.crossfade.physical_blend", blendSpeed = 5.60 })
		inst.system = S
		inst.ctx = ctx
