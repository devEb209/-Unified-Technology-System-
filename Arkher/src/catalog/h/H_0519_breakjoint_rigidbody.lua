-- ARKHER SYSTEM H.0519 :: Breakable Joint Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0519"
	S.key = "arkher.physics.breakjoint.body_dynamics"
	S.name = "Breakable Joint Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "breakjoint", "rigidbody", "physics" }
	S.description = "Breakable Joint Body Dynamics: integration, impulses, damping and sleeping of a body for the Breakable Joint subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.breakjoint.body_dynamics", mass = 32.00, radius = 0.85, restitution = 0.31, friction = 0.41, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
