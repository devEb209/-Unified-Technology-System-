-- ARKHER SYSTEM Z.0235 :: Emergent Society Framework Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0235"
	S.key = "arkher.origin.emergentsociety.signal_composition"
	S.name = "Emergent Society Framework Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentsociety.telemetry_ledger" }
	S.tags = { "z", "emergentsociety", "composer", "origin" }
	S.description = "Emergent Society Framework Signal Composition: blending of the technology's input signals into one output for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.emergentsociety.signal_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
