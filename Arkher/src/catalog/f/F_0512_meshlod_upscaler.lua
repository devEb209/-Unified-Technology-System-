-- ARKHER SYSTEM F.0512 :: Mesh LOD Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0512"
	S.key = "arkher.render.meshlod.adaptive_resolution"
	S.name = "Mesh LOD Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Mesh LOD"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.meshlod.temporal_resolve" }
	S.tags = { "f", "meshlod", "upscaler", "render" }
	S.description = "Mesh LOD Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Mesh LOD subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.meshlod.adaptive_resolution", targetMs = 14.10, index = 3, sharpness = 0.23 })
		inst.system = S
		inst.ctx = ctx
