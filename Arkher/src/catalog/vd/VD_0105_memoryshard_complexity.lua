-- ARKHER SYSTEM VD.0105 :: Memory Shard Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0105"
	S.key = "arkher.contsim.memoryshard.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memoryshard.world_memory_stream" }
	S.tags = { "vd", "memoryshard", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.memoryshard.complexity_budget", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
