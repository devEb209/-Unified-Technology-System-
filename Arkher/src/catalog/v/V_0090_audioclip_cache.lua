-- ARKHER SYSTEM V.0090 :: Audio Clip Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0090"
	S.key = "arkher.asset.audioclip.content_cache"
	S.name = "Audio Clip Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.audioclip.dependency_graph" }
	S.tags = { "v", "audioclip", "cache", "asset" }
	S.description = "Audio Clip Content Cache: reuse of already cooked results for the Audio Clip subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.audioclip.content_cache", policy = "lfu", capacity = 203, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
