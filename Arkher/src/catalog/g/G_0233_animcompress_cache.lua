-- ARKHER SYSTEM G.0233 :: Animation Compression Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0233"
	S.key = "arkher.neural.animcompress.result_cache"
	S.name = "Animation Compression Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.animcompress.compute_budget" }
	S.tags = { "g", "animcompress", "cache", "neural" }
	S.description = "Animation Compression Result Cache: cached inference results keyed by input for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.animcompress.result_cache", policy = "ttl", capacity = 87, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
