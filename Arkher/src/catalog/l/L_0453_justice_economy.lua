-- ARKHER SYSTEM L.0453 :: Justice Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0453"
	S.key = "arkher.sim.justice.economy"
	S.name = "Justice Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.justice.ecology" }
	S.tags = { "l", "justice", "economy", "sim" }
	S.description = "Justice Economy: stock, production, demand, price discovery and trade for the Justice subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.justice.economy", elasticity = 0.34 })
		inst.system = S
		inst.ctx = ctx
