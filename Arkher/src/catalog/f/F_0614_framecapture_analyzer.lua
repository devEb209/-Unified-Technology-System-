-- ARKHER SYSTEM F.0614 :: Frame Capture Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0614"
	S.key = "arkher.render.framecapture.frame_analysis"
	S.name = "Frame Capture Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framecapture.pass_cache" }
	S.tags = { "f", "framecapture", "analyzer", "render" }
	S.description = "Frame Capture Frame Analysis: per-pass cost analysis and outlier detection for the Frame Capture subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.framecapture.frame_analysis", window = 232, buckets = 16, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
