-- ARKHER SYSTEM T.0248 :: Dialogue Generation Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0248"
	S.key = "arkher.ai.dialoguegeneration.utility_selection"
	S.name = "Dialogue Generation Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.dialoguegeneration.working_memory" }
	S.tags = { "t", "dialoguegeneration", "utility", "ai" }
	S.description = "Dialogue Generation Utility Selection: scored choice between competing courses of action for the Dialogue Generation subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.dialoguegeneration.utility_selection", momentum = 0.14 })
		inst.system = S
		inst.ctx = ctx
