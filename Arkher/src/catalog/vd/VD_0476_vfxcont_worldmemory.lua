-- ARKHER SYSTEM VD.0476 :: VFX Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0476"
	S.key = "arkher.contsim.vfxcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vfxcont.neural_field" }
	S.tags = { "vd", "vfxcont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.vfxcont.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
