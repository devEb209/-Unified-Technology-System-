-- ARKHER SYSTEM P.0053 :: Talent Tree State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0053"
	S.key = "arkher.play.talenttree.state_machine"
	S.name = "Talent Tree State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Talent Tree"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.talenttree.combat_resolution" }
	S.tags = { "p", "talenttree", "orchestrator", "play" }
	S.description = "Talent Tree State Machine: the phase machine that drives this gameplay loop for the Talent Tree subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.talenttree.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
