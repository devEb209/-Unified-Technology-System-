-- ARKHER SYSTEM J.0161 :: Gesture Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0161"
	S.key = "arkher.character.gesture.appearance_composer"
	S.name = "Gesture Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gesture.locomotion" }
	S.tags = { "j", "gesture", "composer", "character" }
	S.description = "Gesture Appearance Composer: composition of appearance slots into a look for the Gesture subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.gesture.appearance_composer", mode = "max" })
		inst.system = S
		inst.ctx = ctx
