-- ARKHER SYSTEM VC.0027 :: Zone Chunk Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0027"
	S.key = "arkher.contneural.zonechunk.sparse_residency"
	S.name = "Zone Chunk Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.zonechunk.epoch_clock" }
	S.tags = { "vc", "zonechunk", "sparse", "contneural" }
	S.description = "Zone Chunk Sparse Residency: sparse page residency with eviction and compression for the Zone Chunk subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.zonechunk.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
