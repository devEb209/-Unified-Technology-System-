-- ARKHER SYSTEM O.0303 :: Notification Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0303"
	S.key = "arkher.audio.notification.spatialization"
	S.name = "Notification Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Notification"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.notification.mixer_bus" }
	S.tags = { "o", "notification", "spatialaudio", "audio" }
	S.description = "Notification Spatialization: distance attenuation, panning, occlusion and doppler for the Notification subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.notification.spatialization", model = "linear", refDistance = 7, maxDistance = 240, rolloff = 0.98, maxVoices = 28 })
		inst.system = S
		inst.ctx = ctx
