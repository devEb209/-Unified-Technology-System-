-- ARKHER SYSTEM E.0331 :: Rust Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0331"
	S.key = "arkher.material.rust.definition"
	S.name = "Rust Definition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Rust"
	S.aspect = "Definition"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "rust", "material", "material" }
	S.description = "Rust Definition: layered PBR definition resolved into parameters for the Rust subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.rust.definition", texelBudget = 1572864 })
		inst.system = S
		inst.ctx = ctx
