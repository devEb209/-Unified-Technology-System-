-- ARKHER SYSTEM VB.0262 :: Road Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0262"
	S.key = "arkher.conttime.roadcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.roadcont.complexity_budget" }
	S.tags = { "vb", "roadcont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.roadcont.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
