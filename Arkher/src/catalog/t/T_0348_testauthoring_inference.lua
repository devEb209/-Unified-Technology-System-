-- ARKHER SYSTEM T.0348 :: Test Authoring Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0348"
	S.key = "arkher.ai.testauthoring.model_inference"
	S.name = "Test Authoring Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.testauthoring.action_planner" }
	S.tags = { "t", "testauthoring", "inference", "ai" }
	S.description = "Test Authoring Model Inference: quantized inference with batching and budget for the Test Authoring subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.testauthoring.model_inference", seed = 36803 })
		inst.system = S
		inst.ctx = ctx
