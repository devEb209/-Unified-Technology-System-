-- ARKHER SYSTEM L.0155 :: Agriculture Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0155"
	S.key = "arkher.sim.agriculture.calendar"
	S.name = "Agriculture Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.agriculture.society" }
	S.tags = { "l", "agriculture", "schedule", "sim" }
	S.description = "Agriculture Calendar: hours, days and seasons driving the region for the Agriculture subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.agriculture.calendar", startHour = 8 })
		inst.system = S
		inst.ctx = ctx
