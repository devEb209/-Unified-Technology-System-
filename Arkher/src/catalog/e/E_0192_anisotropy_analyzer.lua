-- ARKHER SYSTEM E.0192 :: Anisotropy Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0192"
	S.key = "arkher.material.anisotropy.analysis"
	S.name = "Anisotropy Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Anisotropy"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.anisotropy.instance_cache" }
	S.tags = { "e", "anisotropy", "analyzer", "material" }
	S.description = "Anisotropy Analysis: cost, redundancy and outlier analysis for the Anisotropy subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.anisotropy.analysis", window = 197, buckets = 17, threshold = 2.90 })
		inst.system = S
		inst.ctx = ctx
