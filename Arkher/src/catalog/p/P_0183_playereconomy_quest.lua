-- ARKHER SYSTEM P.0183 :: Economy Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0183"
	S.key = "arkher.play.playereconomy.objectives"
	S.name = "Economy Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Economy"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playereconomy.inventory" }
	S.tags = { "p", "playereconomy", "quest", "play" }
	S.description = "Economy Objectives: objectives, prerequisites, progress and rewards for the Economy subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.playereconomy.objectives" })
		inst.system = S
		inst.ctx = ctx
