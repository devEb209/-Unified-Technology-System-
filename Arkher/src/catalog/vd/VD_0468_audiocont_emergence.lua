-- ARKHER SYSTEM VD.0468 :: Audio Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0468"
	S.key = "arkher.contsim.audiocont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.audiocont.reality_continuum" }
	S.tags = { "vd", "audiocont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.audiocont.emergence_continuum", windowSize = 4, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
