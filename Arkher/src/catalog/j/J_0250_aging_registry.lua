-- ARKHER SYSTEM J.0250 :: Aging Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0250"
	S.key = "arkher.character.aging.variant_registry"
	S.name = "Aging Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.aging.appearance_composer" }
	S.tags = { "j", "aging", "registry", "character" }
	S.description = "Aging Variant Registry: named character variants and their lifecycle for the Aging subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.aging.variant_registry" })
		inst.system = S
		inst.ctx = ctx
