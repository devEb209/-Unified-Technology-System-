-- ARKHER SYSTEM V.0043 :: Normal Map Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0043"
	S.key = "arkher.asset.normalmap.streaming_residency"
	S.name = "Normal Map Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.normalmap.content_cache" }
	S.tags = { "v", "normalmap", "streamer", "asset" }
	S.description = "Normal Map Streaming Residency: distance-driven load and unload of asset payloads for the Normal Map subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.normalmap.streaming_residency", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
