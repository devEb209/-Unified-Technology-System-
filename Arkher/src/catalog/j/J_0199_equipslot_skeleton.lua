-- ARKHER SYSTEM J.0199 :: Equipment Slot Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0199"
	S.key = "arkher.character.equipslot.rig_definition"
	S.name = "Equipment Slot Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "equipslot", "skeleton", "character" }
	S.description = "Equipment Slot Rig Definition: character rig definition and bone budget for the Equipment Slot subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.equipslot.rig_definition" })
		inst.system = S
		inst.ctx = ctx
