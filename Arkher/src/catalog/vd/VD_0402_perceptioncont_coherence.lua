-- ARKHER SYSTEM VD.0402 :: Perception Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0402"
	S.key = "arkher.contsim.perceptioncont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.perceptioncont.persistent_state" }
	S.tags = { "vd", "perceptioncont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.perceptioncont.coherence_guard", window = 109, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
