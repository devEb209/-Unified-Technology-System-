-- ARKHER SYSTEM N.0323 :: Trail Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0323"
	S.key = "arkher.vfx.trail.spatial_index"
	S.name = "Trail Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Trail"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.trail.quality_policy" }
	S.tags = { "n", "trail", "index", "vfx" }
	S.description = "Trail Spatial Index: spatial acceleration of effect queries and culling for the Trail subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.trail.spatial_index", mode = "hash", cellSize = 56 })
		inst.system = S
		inst.ctx = ctx
