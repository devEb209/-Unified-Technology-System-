-- ARKHER SYSTEM V.0116 :: Voice Line Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0116"
	S.key = "arkher.asset.voiceline.compression_codec"
	S.name = "Voice Line Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.voiceline.streaming_residency" }
	S.tags = { "v", "voiceline", "codec", "asset" }
	S.description = "Voice Line Compression Codec: compact encoding, diffing and checksum of asset payloads for the Voice Line subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.voiceline.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
