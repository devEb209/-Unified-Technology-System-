-- ARKHER SYSTEM VC.0178 :: Neural Patch Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0178"
	S.key = "arkher.contneural.neuralpatch.simulation_fabric"
	S.name = "Neural Patch Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.neuralpatch.complexity_budget" }
	S.tags = { "vc", "neuralpatch", "fabric", "contneural" }
	S.description = "Neural Patch Simulation Fabric: fabric stepping the continuum domains for the Neural Patch subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.neuralpatch.simulation_fabric", budgetMs = 2.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
