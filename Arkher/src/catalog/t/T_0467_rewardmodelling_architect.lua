-- ARKHER SYSTEM T.0467 :: Reward Modelling World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0467"
	S.key = "arkher.ai.rewardmodelling.world_architect"
	S.name = "Reward Modelling World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.rewardmodelling.self_critique" }
	S.tags = { "t", "rewardmodelling", "architect", "ai" }
	S.description = "Reward Modelling World Architect: composition of a whole world plan with conserved budgets for the Reward Modelling subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.rewardmodelling.world_architect", budget = 800, seed = 8922 })
		inst.system = S
		inst.ctx = ctx
