-- ARKHER SYSTEM VD.0145 :: Persistence Segment Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0145"
	S.key = "arkher.contsim.persistsegment.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "persistsegment", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.persistsegment.infinite_grid", cellSize = 128, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
