--!strict
-- Roblox Studio — ANIMATION Node_Flow #0141
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Roblox Studio — ANIMATION Node_Flow #0141", size=Vector2.new(600, 440), pos=UDim2.fromOffset(333, 137), parent=parent, icon="🛰"})
