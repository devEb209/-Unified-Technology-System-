-- ARKHER SYSTEM H.0365 :: Collision Layer Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0365"
	S.key = "arkher.physics.collisionlayer.body_dynamics"
	S.name = "Collision Layer Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "collisionlayer", "rigidbody", "physics" }
	S.description = "Collision Layer Body Dynamics: integration, impulses, damping and sleeping of a body for the Collision Layer subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.collisionlayer.body_dynamics", mass = 33.00, radius = 0.90, restitution = 0.52, friction = 0.32, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
