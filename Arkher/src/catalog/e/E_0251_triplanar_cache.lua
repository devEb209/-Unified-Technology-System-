-- ARKHER SYSTEM E.0251 :: Triplanar Projection Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0251"
	S.key = "arkher.material.triplanar.instance_cache"
	S.name = "Triplanar Projection Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.triplanar.quality_policy" }
	S.tags = { "e", "triplanar", "cache", "material" }
	S.description = "Triplanar Projection Instance Cache: resolved-parameter cache keyed by context for the Triplanar Projection subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.triplanar.instance_cache", policy = "lru", capacity = 278, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
