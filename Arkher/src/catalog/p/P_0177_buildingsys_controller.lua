-- ARKHER SYSTEM P.0177 :: Building Difficulty Controller
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0177"
	S.key = "arkher.play.buildingsys.difficulty_controller"
	S.name = "Building Difficulty Controller"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Building"
	...
	S.kit = "controller"
	S.version = "1.0.0"
	S.deps = { "arkher.play.buildingsys.balance_analysis" }
	S.tags = { "p", "buildingsys", "controller", "play" }
	S.description = "Building Difficulty Controller: closed-loop tuning toward a target challenge for the Building subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("controller", { id = "arkher.play.buildingsys.difficulty_controller", mode = "pid", target = 0.560, kp = 0.510, ki = 0.070, kd = 0.020, min = 0.05, max = 1.0, initial = 0.46, deadband = 0.01 })
		inst.system = S
		inst.ctx = ctx
