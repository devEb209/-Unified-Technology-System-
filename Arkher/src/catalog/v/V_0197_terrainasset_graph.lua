-- ARKHER SYSTEM V.0197 :: Terrain Asset Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0197"
	S.key = "arkher.asset.terrainasset.dependency_graph"
	S.name = "Terrain Asset Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.terrainasset.asset_registry" }
	S.tags = { "v", "terrainasset", "graph", "asset" }
	S.description = "Terrain Asset Dependency Graph: what references what, and in which order it must be built for the Terrain Asset subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.terrainasset.dependency_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
