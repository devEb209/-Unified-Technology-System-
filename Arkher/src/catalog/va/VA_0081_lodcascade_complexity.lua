-- ARKHER SYSTEM VA.0081 :: LOD Cascade Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0081"
	S.key = "arkher.contworld.lodcascade.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lodcascade.world_memory_stream" }
	S.tags = { "va", "lodcascade", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.lodcascade.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
