-- ARKHER SYSTEM F.0096 :: Contact Shadows Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0096"
	S.key = "arkher.render.contact.frame_analysis"
	S.name = "Contact Shadows Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.contact.pass_cache" }
	S.tags = { "f", "contact", "analyzer", "render" }
	S.description = "Contact Shadows Frame Analysis: per-pass cost analysis and outlier detection for the Contact Shadows subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.contact.frame_analysis", window = 234, buckets = 14, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
