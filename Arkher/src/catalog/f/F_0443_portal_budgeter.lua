-- ARKHER SYSTEM F.0443 :: Portal Culling Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0443"
	S.key = "arkher.render.portal.draw_budget"
	S.name = "Portal Culling Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.portal.adaptive_resolution" }
	S.tags = { "f", "portal", "budgeter", "render" }
	S.description = "Portal Culling Draw Budget: draw call and triangle budget allocation for the Portal Culling subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.portal.draw_budget", total = 75, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
