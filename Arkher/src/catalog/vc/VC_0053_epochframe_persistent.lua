-- ARKHER SYSTEM VC.0053 :: Epoch Frame Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0053"
	S.key = "arkher.contneural.epochframe.persistent_state"
	S.name = "Epoch Frame Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.epochframe.multi-scale_fidelity" }
	S.tags = { "vc", "epochframe", "persistent", "contneural" }
	S.description = "Epoch Frame Persistent State: epoch-stamped persistent history and rollback for the Epoch Frame subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.epochframe.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
