-- ARKHER SYSTEM VB.0029 :: Zone Chunk Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0029"
	S.key = "arkher.conttime.zonechunk.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.zonechunk.multi-scale_fidelity" }
	S.tags = { "vb", "zonechunk", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.zonechunk.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
