-- ARKHER SYSTEM VD.0287 :: Water Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0287"
	S.key = "arkher.contsim.watercont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.watercont.simulation_fabric" }
	S.tags = { "vd", "watercont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.watercont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
