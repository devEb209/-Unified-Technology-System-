-- ARKHER SYSTEM H.0199 :: Substepping Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0199"
	S.key = "arkher.physics.substepping.contact_generation"
	S.name = "Substepping Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Substepping"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.substepping.collision_shape" }
	S.tags = { "h", "substepping", "contact", "physics" }
	S.description = "Substepping Contact Generation: narrow-phase manifolds with normal, depth and point for the Substepping subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.substepping.contact_generation", slop = 0.0060, maxManifolds = 289 })
		inst.system = S
		inst.ctx = ctx
