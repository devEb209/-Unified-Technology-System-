-- ARKHER SYSTEM Z.0767 :: Semantic LOD World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0767"
	S.key = "arkher.origin.semanticlod.world_architect"
	S.name = "Semantic LOD World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticlod.emergence_detection" }
	S.tags = { "z", "semanticlod", "architect", "origin" }
	S.description = "Semantic LOD World Architect: hierarchical world composition with conserved budgets for the Semantic LOD subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.semanticlod.world_architect", budget = 1400, seed = 90508 })
		inst.system = S
		inst.ctx = ctx
