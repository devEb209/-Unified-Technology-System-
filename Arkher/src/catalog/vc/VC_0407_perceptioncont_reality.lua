-- ARKHER SYSTEM VC.0407 :: Perception Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0407"
	S.key = "arkher.contneural.perceptioncont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.perceptioncont.simulation_fabric" }
	S.tags = { "vc", "perceptioncont", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.perceptioncont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
