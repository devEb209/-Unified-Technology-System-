-- ARKHER SYSTEM L.0556 :: World Event Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0556"
	S.key = "arkher.sim.worldevent.simulation_core"
	S.name = "World Event Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "worldevent", "simulation", "sim" }
	S.description = "World Event Simulation Core: observer-driven fidelity, catch-up and aggregate state for the World Event subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.worldevent.simulation_core", fullRadius = 160, reducedRadius = 1300, budget = 39 })
		inst.system = S
		inst.ctx = ctx
