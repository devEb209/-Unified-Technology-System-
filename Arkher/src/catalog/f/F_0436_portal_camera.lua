-- ARKHER SYSTEM F.0436 :: Portal Culling View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0436"
	S.key = "arkher.render.portal.view_and_culling"
	S.name = "Portal Culling View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.portal.frame_graph" }
	S.tags = { "f", "portal", "camera", "render" }
	S.description = "Portal Culling View And Culling: view state, frustum culling and screen-size LOD for the Portal Culling subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.portal.view_and_culling", width = 1340, height = 900, fov = 0.9900, far = 2200 })
		inst.system = S
		inst.ctx = ctx
