-- ARKHER SYSTEM VD.0482 :: Lighting Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0482"
	S.key = "arkher.contsim.lightcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lightcont.infinite_grid" }
	S.tags = { "vd", "lightcont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.lightcont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
