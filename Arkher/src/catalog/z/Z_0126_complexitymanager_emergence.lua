-- ARKHER SYSTEM Z.0126 :: Dynamic Complexity Manager Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0126"
	S.key = "arkher.origin.complexitymanager.emergence_detection"
	S.name = "Dynamic Complexity Manager Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.world_memory" }
	S.tags = { "z", "complexitymanager", "emergence", "origin" }
	S.description = "Dynamic Complexity Manager Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.complexitymanager.emergence_detection", windowSize = 5, threshold = 1.40, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
