-- ARKHER SYSTEM VA.0405 :: Perception Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0405"
	S.key = "arkher.contworld.perceptioncont.complexity_budget"
	S.name = "Perception Continuum Complexity Budget"
	S.category = "VA"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.perceptioncont.world_memory_stream" }
	S.tags = { "va", "perceptioncont", "complexity", "contworld" }
	S.description = "Perception Continuum Complexity Budget: complexity budgeting for the continuum for the Perception Continuum subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.perceptioncont.complexity_budget", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
