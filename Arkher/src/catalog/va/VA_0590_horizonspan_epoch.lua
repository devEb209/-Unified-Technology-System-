-- ARKHER SYSTEM VA.0590 :: Horizon Span Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0590"
	S.key = "arkher.contworld.horizonspan.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.horizonspan.infinite_grid" }
	S.tags = { "va", "horizonspan", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.horizonspan.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
