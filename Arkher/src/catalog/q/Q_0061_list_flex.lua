-- ARKHER SYSTEM Q.0061 :: List Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0061"
	S.key = "arkher.ui.list.responsive_layout"
	S.name = "List Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "List"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "list", "flex", "ui" }
	S.description = "List Responsive Layout: flex solving with safe areas, weights and breakpoints for the List subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.list.responsive_layout", width = 450, height = 964, scale = 1.07 })
		inst.system = S
		inst.ctx = ctx
