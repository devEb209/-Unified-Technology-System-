-- ARKHER SYSTEM VB.0008 :: World Grid Cell World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0008"
	S.key = "arkher.conttime.worldcell.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldcell.neural_field" }
	S.tags = { "vb", "worldcell", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.worldcell.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
