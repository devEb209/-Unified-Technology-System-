-- ARKHER SYSTEM Q.0079 :: Grid Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0079"
	S.key = "arkher.ui.grid.localization_registry"
	S.name = "Grid Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Grid"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.grid.theme_composition" }
	S.tags = { "q", "grid", "registry", "ui" }
	S.description = "Grid Localization Registry: catalogue of strings, plurals and locale metadata for the Grid subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.grid.localization_registry" })
		inst.system = S
		inst.ctx = ctx
