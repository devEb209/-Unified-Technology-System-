-- ARKHER SYSTEM VC.0234 :: City Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0234"
	S.key = "arkher.contneural.citycont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.citycont.persistent_state" }
	S.tags = { "vc", "citycont", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.citycont.coherence_guard", window = 100, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
