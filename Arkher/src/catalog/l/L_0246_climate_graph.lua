-- ARKHER SYSTEM L.0246 :: Climate Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0246"
	S.key = "arkher.sim.climate.region_graph"
	S.name = "Climate Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.climate.calendar" }
	S.tags = { "l", "climate", "graph", "sim" }
	S.description = "Climate Region Graph: connectivity, components and shortest path between places for the Climate subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.climate.region_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
