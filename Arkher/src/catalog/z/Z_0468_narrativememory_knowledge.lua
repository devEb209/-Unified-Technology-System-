-- ARKHER SYSTEM Z.0468 :: Narrative Memory Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0468"
	S.key = "arkher.origin.narrativememory.semantic_graph"
	S.name = "Narrative Memory Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.narrativememory.world_architect" }
	S.tags = { "z", "narrativememory", "knowledge", "origin" }
	S.description = "Narrative Memory Semantic Graph: typed entities and inferred relations of the technology itself for the Narrative Memory subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.narrativememory.semantic_graph", dims = 32 })
		inst.system = S
		inst.ctx = ctx
