-- ARKHER SYSTEM Z.1043 :: Emergent Quest Generation Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.1043"
	S.key = "arkher.origin.emergentquest.simulation_fabric"
	S.name = "Emergent Quest Generation Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentquest.complexity_governance" }
	S.tags = { "z", "emergentquest", "fabric", "origin" }
	S.description = "Emergent Quest Generation Simulation Fabric: every simulation domain stepped under one budgeted clock for the Emergent Quest Generation subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.emergentquest.simulation_fabric", budgetMs = 3.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
