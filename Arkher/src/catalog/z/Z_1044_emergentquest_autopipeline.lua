-- ARKHER SYSTEM Z.1044 :: Emergent Quest Generation Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.1044"
	S.key = "arkher.origin.emergentquest.autonomous_pipeline"
	S.name = "Emergent Quest Generation Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentquest.simulation_fabric" }
	S.tags = { "z", "emergentquest", "autopipeline", "origin" }
	S.description = "Emergent Quest Generation Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Emergent Quest Generation subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.emergentquest.autonomous_pipeline", maxIterations = 10 })
		inst.system = S
		inst.ctx = ctx
