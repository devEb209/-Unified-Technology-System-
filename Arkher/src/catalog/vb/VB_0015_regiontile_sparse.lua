-- ARKHER SYSTEM VB.0015 :: Region Tile Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0015"
	S.key = "arkher.conttime.regiontile.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.regiontile.epoch_clock" }
	S.tags = { "vb", "regiontile", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.regiontile.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
