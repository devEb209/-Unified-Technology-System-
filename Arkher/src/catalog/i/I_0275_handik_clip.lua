-- ARKHER SYSTEM I.0275 :: Hand Placement IK Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0275"
	S.key = "arkher.anim.handik.clip_sampling"
	S.name = "Hand Placement IK Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.handik.skeleton" }
	S.tags = { "i", "handik", "clip", "anim" }
	S.description = "Hand Placement IK Clip Sampling: keyframe tracks sampled, retimed and evented for the Hand Placement IK subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.handik.clip_sampling", duration = 2.10, loop = true })
		inst.system = S
		inst.ctx = ctx
