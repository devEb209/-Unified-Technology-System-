-- ARKHER SYSTEM Q.0370 :: Theme Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0370"
	S.key = "arkher.ui.uitheme.frame_budget"
	S.name = "Theme Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Theme"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uitheme.accessibility_policy" }
	S.tags = { "q", "uitheme", "budgeter", "ui" }
	S.description = "Theme Frame Budget: per-frame layout and draw budget for the interface for the Theme subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.uitheme.frame_budget", total = 295, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
