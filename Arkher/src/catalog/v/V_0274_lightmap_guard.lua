-- ARKHER SYSTEM V.0274 :: Lightmap Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0274"
	S.key = "arkher.asset.lightmap.validation_guard"
	S.name = "Lightmap Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lightmap.size_budget" }
	S.tags = { "v", "lightmap", "guard", "asset" }
	S.description = "Lightmap Validation Guard: rate limiting and capability checks on the import path for the Lightmap subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.lightmap.validation_guard", algorithm = "leaky", capacity = 204, refillPerSec = 49, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
