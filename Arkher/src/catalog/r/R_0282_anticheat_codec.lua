-- ARKHER SYSTEM R.0282 :: Anti Cheat Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0282"
	S.key = "arkher.net.anticheat.serialization_codec"
	S.name = "Anti Cheat Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Anti Cheat"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.anticheat.bandwidth_budget" }
	S.tags = { "r", "anticheat", "codec", "net" }
	S.description = "Anti Cheat Serialization Codec: compact encoding, diffing and checksum of payloads for the Anti Cheat subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.anticheat.serialization_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
