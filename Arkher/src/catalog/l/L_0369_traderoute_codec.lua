-- ARKHER SYSTEM L.0369 :: Trade Route State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0369"
	S.key = "arkher.sim.traderoute.state_codec"
	S.name = "Trade Route State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.traderoute.history_ledger" }
	S.tags = { "l", "traderoute", "codec", "sim" }
	S.description = "Trade Route State Codec: persistence, diffing and checksum of the world state for the Trade Route subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.traderoute.state_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
