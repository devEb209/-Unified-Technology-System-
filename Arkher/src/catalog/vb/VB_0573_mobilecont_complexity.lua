-- ARKHER SYSTEM VB.0573 :: Mobile Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0573"
	S.key = "arkher.conttime.mobilecont.complexity_budget"
	S.name = "Mobile Continuum Complexity Budget"
	S.category = "VB"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.mobilecont.world_memory_stream" }
	S.tags = { "vb", "mobilecont", "complexity", "conttime" }
	S.description = "Mobile Continuum Complexity Budget: complexity budgeting for the continuum for the Mobile Continuum subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.mobilecont.complexity_budget", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
