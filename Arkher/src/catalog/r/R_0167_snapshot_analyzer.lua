-- ARKHER SYSTEM R.0167 :: Snapshot Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0167"
	S.key = "arkher.net.snapshot.latency_analysis"
	S.name = "Snapshot Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Snapshot"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.snapshot.audit_ledger" }
	S.tags = { "r", "snapshot", "analyzer", "net" }
	S.description = "Snapshot Latency Analysis: round trip, jitter and loss analysis for the Snapshot subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.snapshot.latency_analysis", window = 107, buckets = 11, threshold = 2.90 })
		inst.system = S
		inst.ctx = ctx
