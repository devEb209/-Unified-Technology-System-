-- ARKHER SYSTEM E.0215 :: Iridescence Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0215"
	S.key = "arkher.material.iridescence.procedural_detail"
	S.name = "Iridescence Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Iridescence"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.iridescence.texture_sampling" }
	S.tags = { "e", "iridescence", "field", "material" }
	S.description = "Iridescence Procedural Detail: coherent noise detail driving the surface for the Iridescence subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.iridescence.procedural_detail", seed = 83958, frequency = 0.0135, octaves = 5, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
		...
		function inst.integrate(engine)
			...
			inst.engine = engine
			if engine.bus then
				engine.bus:subscribe("arkher.material.iridescence.*", function(payload) inst.lastSignal = payload end)
			end
