-- ARKHER SYSTEM J.0157 :: Gesture Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0157"
	S.key = "arkher.character.gesture.blend_controller"
	S.name = "Gesture Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gesture.motion_set" }
	S.tags = { "j", "gesture", "animator", "character" }
	S.description = "Gesture Blend Controller: layered playback driving the character for the Gesture subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.gesture.blend_controller", budget = 14 })
		inst.system = S
		inst.ctx = ctx
