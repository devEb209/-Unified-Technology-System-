-- ARKHER SYSTEM Q.0026 :: Button Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0026"
	S.key = "arkher.ui.button.widget_tree"
	S.name = "Button Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Button"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.button.responsive_layout" }
	S.tags = { "q", "button", "widget", "ui" }
	S.description = "Button Widget Tree: retained widget nodes, properties, bindings and rendering for the Button subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.button.widget_tree", theme = "dark", scale = 1.05 })
		inst.system = S
		inst.ctx = ctx
