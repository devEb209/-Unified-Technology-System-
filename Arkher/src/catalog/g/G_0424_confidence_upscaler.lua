-- ARKHER SYSTEM G.0424 :: Confidence Gating Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0424"
	S.key = "arkher.neural.confidence.reconstruction"
	S.name = "Confidence Gating Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.confidence.temporal_history" }
	S.tags = { "g", "confidence", "upscaler", "neural" }
	S.description = "Confidence Gating Reconstruction: resolution ladder and image reconstruction for the Confidence Gating subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.confidence.reconstruction", targetMs = 14.10, index = 3, sharpness = 0.53 })
		inst.system = S
		inst.ctx = ctx
