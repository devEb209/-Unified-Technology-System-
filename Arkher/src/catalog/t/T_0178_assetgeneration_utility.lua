-- ARKHER SYSTEM T.0178 :: Asset Generation Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0178"
	S.key = "arkher.ai.assetgeneration.utility_selection"
	S.name = "Asset Generation Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.assetgeneration.working_memory" }
	S.tags = { "t", "assetgeneration", "utility", "ai" }
	S.description = "Asset Generation Utility Selection: scored choice between competing courses of action for the Asset Generation subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.assetgeneration.utility_selection", momentum = 0.11 })
		inst.system = S
		inst.ctx = ctx
