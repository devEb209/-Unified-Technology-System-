-- ARKHER SYSTEM I.0036 :: Bind Pose Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0036"
	S.key = "arkher.anim.bindpose.pose_cache"
	S.name = "Bind Pose Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bind Pose"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bindpose.playback_pipeline" }
	S.tags = { "i", "bindpose", "cache", "anim" }
	S.description = "Bind Pose Pose Cache: reuse of sampled poses across frames and instances for the Bind Pose subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.bindpose.pose_cache", policy = "ttl", capacity = 67, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
