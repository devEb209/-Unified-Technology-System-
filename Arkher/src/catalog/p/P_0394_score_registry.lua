-- ARKHER SYSTEM P.0394 :: Score Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0394"
	S.key = "arkher.play.score.content_registry"
	S.name = "Score Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Score"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.score.difficulty_controller" }
	S.tags = { "p", "score", "registry", "play" }
	S.description = "Score Content Registry: catalogue of the definitions this loop instantiates for the Score subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.score.content_registry" })
		inst.system = S
		inst.ctx = ctx
