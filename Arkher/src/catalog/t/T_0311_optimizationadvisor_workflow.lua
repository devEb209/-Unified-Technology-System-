-- ARKHER SYSTEM T.0311 :: Optimization Advisor Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0311"
	S.key = "arkher.ai.optimizationadvisor.plan_workflow"
	S.name = "Optimization Advisor Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.optimizationadvisor.semantic_knowledge" }
	S.tags = { "t", "optimizationadvisor", "workflow", "ai" }
	S.description = "Optimization Advisor Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Optimization Advisor subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.optimizationadvisor.plan_workflow", maxRetries = 1, budget = 130 })
		inst.system = S
		inst.ctx = ctx
