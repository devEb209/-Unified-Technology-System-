-- ARKHER SYSTEM V.0146 :: UI Sprite Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0146"
	S.key = "arkher.asset.uisprite.bundling"
	S.name = "UI Sprite Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.uisprite.import" }
	S.tags = { "v", "uisprite", "bundler", "asset" }
	S.description = "UI Sprite Bundling: size-bounded packing, manifests and delta patches for the UI Sprite subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.uisprite.bundling", maxBundleBytes = 262144 })
		inst.system = S
		inst.ctx = ctx
