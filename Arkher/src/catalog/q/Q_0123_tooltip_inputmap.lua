-- ARKHER SYSTEM Q.0123 :: Tooltip Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0123"
	S.key = "arkher.ui.tooltip.input_mapping"
	S.name = "Tooltip Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tooltip"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.tooltip.widget_tree" }
	S.tags = { "q", "tooltip", "inputmap", "ui" }
	S.description = "Tooltip Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Tooltip subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.tooltip.input_mapping", device = "touch", holdTime = 0.29, deadzone = 0.19 })
		inst.system = S
		inst.ctx = ctx
