-- ARKHER SYSTEM H.0628 :: Character Controller Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0628"
	S.key = "arkher.physics.charactercontroller.analysis"
	S.name = "Character Controller Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.charactercontroller.result_cache" }
	S.tags = { "h", "charactercontroller", "analyzer", "physics" }
	S.description = "Character Controller Analysis: energy, jitter and cost analysis of the simulation for the Character Controller subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.charactercontroller.analysis", window = 89, buckets = 13, threshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
