-- ARKHER SYSTEM J.0086 :: Facial Rig Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0086"
	S.key = "arkher.character.facialrig.budget_governor"
	S.name = "Facial Rig Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.facialrig.variant_registry" }
	S.tags = { "j", "facialrig", "budgeter", "character" }
	S.description = "Facial Rig Budget Governor: per-character cost allocation in a crowd for the Facial Rig subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.facialrig.budget_governor", total = 65, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
