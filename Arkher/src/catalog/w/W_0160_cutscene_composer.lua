-- ARKHER SYSTEM W.0160 :: Cutscene Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0160"
	S.key = "arkher.cine.cutscene.shot_composition"
	S.name = "Cutscene Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Cutscene"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cutscene.colour_grade" }
	S.tags = { "w", "cutscene", "composer", "cine" }
	S.description = "Cutscene Shot Composition: blending of the signals that make up the final shot for the Cutscene subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.cutscene.shot_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
