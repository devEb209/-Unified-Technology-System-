-- ARKHER SYSTEM VD.0522 :: Asset Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0522"
	S.key = "arkher.contsim.assetcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.assetcont.persistent_state" }
	S.tags = { "vd", "assetcont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.assetcont.coherence_guard", window = 62, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
