-- ARKHER SYSTEM O.0171 :: City Audio Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0171"
	S.key = "arkher.audio.cityaudio.spatialization"
	S.name = "City Audio Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "City Audio"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.cityaudio.mixer_bus" }
	S.tags = { "o", "cityaudio", "spatialaudio", "audio" }
	S.description = "City Audio Spatialization: distance attenuation, panning, occlusion and doppler for the City Audio subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.cityaudio.spatialization", model = "linear", refDistance = 7, maxDistance = 200, rolloff = 1.16, maxVoices = 28 })
		inst.system = S
		inst.ctx = ctx
