-- ARKHER SYSTEM Z.0961 :: Generation Migration Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0961"
	S.key = "arkher.origin.generationmigration.reality_layering"
	S.name = "Generation Migration Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "generationmigration", "reality", "origin" }
	S.description = "Generation Migration Reality Layering: stacked authored, simulated, proposed and player realities for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.generationmigration.reality_layering" })
		inst.system = S
		inst.ctx = ctx
