-- ARKHER SYSTEM K.0568 :: Work Behaviour Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0568"
	S.key = "arkher.npc.workbehaviour.goal_planner"
	S.name = "Work Behaviour Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workbehaviour.utility_reasoning" }
	S.tags = { "k", "workbehaviour", "planner", "npc" }
	S.description = "Work Behaviour Goal Planner: backward GOAP planning to reach a goal state for the Work Behaviour subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.workbehaviour.goal_planner", maxDepth = 8 })
		inst.system = S
		inst.ctx = ctx
