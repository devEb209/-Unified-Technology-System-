-- ARKHER SYSTEM O.0330 :: Engine Audio Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0330"
	S.key = "arkher.audio.engineaudio.streaming"
	S.name = "Engine Audio Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Engine Audio"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.engineaudio.voice_budget" }
	S.tags = { "o", "engineaudio", "streamer", "audio" }
	S.description = "Engine Audio Streaming: distance-driven residency of audio assets for the Engine Audio subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.engineaudio.streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
