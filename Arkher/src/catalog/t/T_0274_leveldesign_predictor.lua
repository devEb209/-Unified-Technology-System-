-- ARKHER SYSTEM T.0274 :: Level Design Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0274"
	S.key = "arkher.ai.leveldesign.outcome_prediction"
	S.name = "Level Design Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.leveldesign.decision_policy" }
	S.tags = { "t", "leveldesign", "predictor", "ai" }
	S.description = "Level Design Outcome Prediction: forecasting the result before the work is done for the Level Design subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.leveldesign.outcome_prediction", method = "ema", alpha = 0.24, window = 38 })
		inst.system = S
		inst.ctx = ctx
