-- ARKHER SYSTEM L.0138 :: City Life Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0138"
	S.key = "arkher.sim.citylife.economy"
	S.name = "City Life Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.citylife.ecology" }
	S.tags = { "l", "citylife", "economy", "sim" }
	S.description = "City Life Economy: stock, production, demand, price discovery and trade for the City Life subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.citylife.economy", elasticity = 0.19 })
		inst.system = S
		inst.ctx = ctx
