-- ARKHER SYSTEM VD.0346 :: Society Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0346"
	S.key = "arkher.contsim.societycont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.societycont.complexity_budget" }
	S.tags = { "vd", "societycont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.societycont.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
