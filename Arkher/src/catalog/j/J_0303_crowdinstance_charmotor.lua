-- ARKHER SYSTEM J.0303 :: Crowd Instance Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0303"
	S.key = "arkher.character.crowdinstance.locomotion"
	S.name = "Crowd Instance Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.crowdinstance.physical_response" }
	S.tags = { "j", "crowdinstance", "charmotor", "character" }
	S.description = "Crowd Instance Locomotion: capsule locomotion driving the character for the Crowd Instance subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.crowdinstance.locomotion", radius = 0.35, height = 1.80, maxSpeed = 6.00, jumpHeight = 2.00, stepOffset = 0.45 })
		inst.system = S
		inst.ctx = ctx
