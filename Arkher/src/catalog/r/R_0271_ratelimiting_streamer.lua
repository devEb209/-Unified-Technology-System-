-- ARKHER SYSTEM R.0271 :: Rate Limiting Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0271"
	S.key = "arkher.net.ratelimiting.interest_streaming"
	S.name = "Rate Limiting Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.ratelimiting.serialization_codec" }
	S.tags = { "r", "ratelimiting", "streamer", "net" }
	S.description = "Rate Limiting Interest Streaming: distance-driven residency of replicated content for the Rate Limiting subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.ratelimiting.interest_streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
