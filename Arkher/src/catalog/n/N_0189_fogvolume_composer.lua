-- ARKHER SYSTEM N.0189 :: Fog Volume Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0189"
	S.key = "arkher.vfx.fogvolume.effect_composition"
	S.name = "Fog Volume Effect Composition"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fog Volume"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fogvolume.effect_graph" }
	S.tags = { "n", "fogvolume", "composer", "vfx" }
	S.description = "Fog Volume Effect Composition: blending of several effect signals into one output for the Fog Volume subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.fogvolume.effect_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
