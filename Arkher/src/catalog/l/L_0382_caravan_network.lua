-- ARKHER SYSTEM L.0382 :: Caravan Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0382"
	S.key = "arkher.sim.caravan.route_network"
	S.name = "Caravan Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.caravan.region_graph" }
	S.tags = { "l", "caravan", "network", "sim" }
	S.description = "Caravan Route Network: roads, rivers and routes between settlements for the Caravan subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.caravan.route_network" })
		inst.system = S
		inst.ctx = ctx
