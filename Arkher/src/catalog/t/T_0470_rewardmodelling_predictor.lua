-- ARKHER SYSTEM T.0470 :: Reward Modelling Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0470"
	S.key = "arkher.ai.rewardmodelling.outcome_prediction"
	S.name = "Reward Modelling Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.rewardmodelling.decision_policy" }
	S.tags = { "t", "rewardmodelling", "predictor", "ai" }
	S.description = "Reward Modelling Outcome Prediction: forecasting the result before the work is done for the Reward Modelling subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.rewardmodelling.outcome_prediction", method = "linear", alpha = 0.37, window = 51 })
		inst.system = S
		inst.ctx = ctx
