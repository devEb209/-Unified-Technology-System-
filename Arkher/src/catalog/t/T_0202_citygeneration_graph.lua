-- ARKHER SYSTEM T.0202 :: City Generation Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0202"
	S.key = "arkher.ai.citygeneration.reasoning_graph"
	S.name = "City Generation Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.citygeneration.world_architect" }
	S.tags = { "t", "citygeneration", "graph", "ai" }
	S.description = "City Generation Reasoning Graph: relationship modelling and shortest-path reasoning for the City Generation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.citygeneration.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
