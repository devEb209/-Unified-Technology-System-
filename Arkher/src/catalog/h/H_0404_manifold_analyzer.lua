-- ARKHER SYSTEM H.0404 :: Contact Manifold Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0404"
	S.key = "arkher.physics.manifold.analysis"
	S.name = "Contact Manifold Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.manifold.result_cache" }
	S.tags = { "h", "manifold", "analyzer", "physics" }
	S.description = "Contact Manifold Analysis: energy, jitter and cost analysis of the simulation for the Contact Manifold subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.manifold.analysis", window = 243, buckets = 19, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
