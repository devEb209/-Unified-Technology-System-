-- ARKHER SYSTEM Q.0145 :: Tab Bar Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0145"
	S.key = "arkher.ui.tabbar.responsive_layout"
	S.name = "Tab Bar Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tab Bar"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "tabbar", "flex", "ui" }
	S.description = "Tab Bar Responsive Layout: flex solving with safe areas, weights and breakpoints for the Tab Bar subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.tabbar.responsive_layout", width = 690, height = 964, scale = 1.02 })
		inst.system = S
		inst.ctx = ctx
