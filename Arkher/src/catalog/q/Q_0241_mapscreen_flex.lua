-- ARKHER SYSTEM Q.0241 :: Map Screen Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0241"
	S.key = "arkher.ui.mapscreen.responsive_layout"
	S.name = "Map Screen Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Map Screen"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "mapscreen", "flex", "ui" }
	S.description = "Map Screen Responsive Layout: flex solving with safe areas, weights and breakpoints for the Map Screen subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.mapscreen.responsive_layout", width = 570, height = 904, scale = 0.91 })
		inst.system = S
		inst.ctx = ctx
