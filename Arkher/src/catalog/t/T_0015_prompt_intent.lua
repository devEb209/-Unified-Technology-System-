-- ARKHER SYSTEM T.0015 :: Prompt Understanding Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0015"
	S.key = "arkher.ai.prompt.intent_understanding"
	S.name = "Prompt Understanding Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "prompt", "intent", "ai" }
	S.description = "Prompt Understanding Intent Understanding: natural language turned into an actionable, scored intent for the Prompt Understanding subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.prompt.intent_understanding", minConfidence = 0.32 })
		inst.system = S
		inst.ctx = ctx
