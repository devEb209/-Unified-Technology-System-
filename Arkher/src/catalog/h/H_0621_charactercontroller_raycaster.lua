-- ARKHER SYSTEM H.0621 :: Character Controller Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0621"
	S.key = "arkher.physics.charactercontroller.query"
	S.name = "Character Controller Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.charactercontroller.constraint_solver" }
	S.tags = { "h", "charactercontroller", "raycaster", "physics" }
	S.description = "Character Controller Query: rays, sweeps and overlaps against the simulation for the Character Controller subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.charactercontroller.query", cellSize = 48 })
		inst.system = S
		inst.ctx = ctx
