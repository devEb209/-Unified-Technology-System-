-- ARKHER SYSTEM VA.0272 :: Bridge Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0272"
	S.key = "arkher.contworld.bridgecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.bridgecont.neural_field" }
	S.tags = { "va", "bridgecont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.bridgecont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
