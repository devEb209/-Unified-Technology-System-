-- ARKHER SYSTEM VA.0103 :: Memory Shard Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0103"
	S.key = "arkher.contworld.memoryshard.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memoryshard.coherence_guard" }
	S.tags = { "va", "memoryshard", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.memoryshard.neural_field", dims = 24, hidden = 20, seed = 92295 })
		inst.system = S
		inst.ctx = ctx
