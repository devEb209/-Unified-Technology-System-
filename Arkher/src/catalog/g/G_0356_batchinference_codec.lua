-- ARKHER SYSTEM G.0356 :: Batch Inference Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0356"
	S.key = "arkher.neural.batchinference.weight_codec"
	S.name = "Batch Inference Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.batchinference.model_registry" }
	S.tags = { "g", "batchinference", "codec", "neural" }
	S.description = "Batch Inference Weight Codec: weight serialization and quantized transport for the Batch Inference subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.batchinference.weight_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
