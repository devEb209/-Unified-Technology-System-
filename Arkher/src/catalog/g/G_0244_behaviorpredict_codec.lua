-- ARKHER SYSTEM G.0244 :: Behaviour Prediction Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0244"
	S.key = "arkher.neural.behaviorpredict.weight_codec"
	S.name = "Behaviour Prediction Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.behaviorpredict.model_registry" }
	S.tags = { "g", "behaviorpredict", "codec", "neural" }
	S.description = "Behaviour Prediction Weight Codec: weight serialization and quantized transport for the Behaviour Prediction subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.behaviorpredict.weight_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
