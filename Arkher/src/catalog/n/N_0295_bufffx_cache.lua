-- ARKHER SYSTEM N.0295 :: Buff Effect Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0295"
	S.key = "arkher.vfx.bufffx.result_cache"
	S.name = "Buff Effect Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Buff Effect"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.bufffx.spawn_budget" }
	S.tags = { "n", "bufffx", "cache", "vfx" }
	S.description = "Buff Effect Result Cache: reuse of expensive effect evaluations for the Buff Effect subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.bufffx.result_cache", policy = "lru", capacity = 496, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
