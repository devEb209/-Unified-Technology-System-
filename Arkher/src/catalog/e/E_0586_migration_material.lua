-- ARKHER SYSTEM E.0586 :: Material Migration Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0586"
	S.key = "arkher.material.migration.definition"
	S.name = "Material Migration Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "migration", "material", "material" }
	S.description = "Material Migration Definition: layered PBR definition resolved into parameters for the Material Migration subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.migration.definition", texelBudget = 262144 })
		inst.system = S
		inst.ctx = ctx
