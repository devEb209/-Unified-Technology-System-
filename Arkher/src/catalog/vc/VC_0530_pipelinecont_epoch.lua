-- ARKHER SYSTEM VC.0530 :: Pipeline Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0530"
	S.key = "arkher.contneural.pipelinecont.epoch_clock"
	S.name = "Pipeline Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.pipelinecont.infinite_grid" }
	S.tags = { "vc", "pipelinecont", "epoch", "contneural" }
	S.description = "Pipeline Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Pipeline Continuum subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.pipelinecont.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
