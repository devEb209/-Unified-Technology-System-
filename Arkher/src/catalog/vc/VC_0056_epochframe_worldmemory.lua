-- ARKHER SYSTEM VC.0056 :: Epoch Frame World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0056"
	S.key = "arkher.contneural.epochframe.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.epochframe.neural_field" }
	S.tags = { "vc", "epochframe", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.epochframe.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
