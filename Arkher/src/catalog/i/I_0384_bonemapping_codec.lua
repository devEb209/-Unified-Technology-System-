-- ARKHER SYSTEM I.0384 :: Bone Mapping Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0384"
	S.key = "arkher.anim.bonemapping.compression_codec"
	S.name = "Bone Mapping Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Bone Mapping"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonemapping.retarget_graph" }
	S.tags = { "i", "bonemapping", "codec", "anim" }
	S.description = "Bone Mapping Compression Codec: curve compression and quantized transport for the Bone Mapping subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.bonemapping.compression_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
