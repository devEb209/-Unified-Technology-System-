-- ARKHER SYSTEM Z.1026 :: Autonomous Balancing Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.1026"
	S.key = "arkher.origin.autobalancing.emergence_detection"
	S.name = "Autonomous Balancing Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autobalancing.world_memory" }
	S.tags = { "z", "autobalancing", "emergence", "origin" }
	S.description = "Autonomous Balancing Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Autonomous Balancing subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.autobalancing.emergence_detection", windowSize = 7, threshold = 1.40, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
