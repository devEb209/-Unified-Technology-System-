-- ARKHER SYSTEM J.0305 :: Crowd Instance Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0305"
	S.key = "arkher.character.crowdinstance.variant_registry"
	S.name = "Crowd Instance Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.crowdinstance.appearance_composer" }
	S.tags = { "j", "crowdinstance", "registry", "character" }
	S.description = "Crowd Instance Variant Registry: named character variants and their lifecycle for the Crowd Instance subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.crowdinstance.variant_registry" })
		inst.system = S
		inst.ctx = ctx
