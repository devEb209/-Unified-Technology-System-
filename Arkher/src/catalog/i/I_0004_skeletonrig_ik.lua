-- ARKHER SYSTEM I.0004 :: Skeleton Rig Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0004"
	S.key = "arkher.anim.skeletonrig.inverse_kinematics"
	S.name = "Skeleton Rig Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Skeleton Rig"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.skeletonrig.layered_blending" }
	S.tags = { "i", "skeletonrig", "ik", "anim" }
	S.description = "Skeleton Rig Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Skeleton Rig subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.skeletonrig.inverse_kinematics", iterations = 7, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
