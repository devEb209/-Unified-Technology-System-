-- ARKHER SYSTEM R.0090 :: Property Replication Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0090"
	S.key = "arkher.net.propertyreplication.serialization_codec"
	S.name = "Property Replication Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.propertyreplication.bandwidth_budget" }
	S.tags = { "r", "propertyreplication", "codec", "net" }
	S.description = "Property Replication Serialization Codec: compact encoding, diffing and checksum of payloads for the Property Replication subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.propertyreplication.serialization_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
