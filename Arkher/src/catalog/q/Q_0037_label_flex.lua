-- ARKHER SYSTEM Q.0037 :: Label Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0037"
	S.key = "arkher.ui.label.responsive_layout"
	S.name = "Label Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Label"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "label", "flex", "ui" }
	S.description = "Label Responsive Layout: flex solving with safe areas, weights and breakpoints for the Label subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.label.responsive_layout", width = 510, height = 1084, scale = 0.94 })
		inst.system = S
		inst.ctx = ctx
