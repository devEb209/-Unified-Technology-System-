-- ARKHER SYSTEM G.0049 :: Frame Interpolation Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0049"
	S.key = "arkher.neural.frameinterp.quality_predictor"
	S.name = "Frame Interpolation Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.frameinterp.weight_codec" }
	S.tags = { "g", "frameinterp", "predictor", "neural" }
	S.description = "Frame Interpolation Quality Predictor: predicted quality and cost of a setting for the Frame Interpolation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.frameinterp.quality_predictor", method = "linear", alpha = 0.46, window = 60 })
		inst.system = S
		inst.ctx = ctx
