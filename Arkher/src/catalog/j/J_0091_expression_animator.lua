-- ARKHER SYSTEM J.0091 :: Expression Set Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0091"
	S.key = "arkher.character.expression.blend_controller"
	S.name = "Expression Set Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.expression.motion_set" }
	S.tags = { "j", "expression", "animator", "character" }
	S.description = "Expression Set Blend Controller: layered playback driving the character for the Expression Set subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.expression.blend_controller", budget = 6 })
		inst.system = S
		inst.ctx = ctx
