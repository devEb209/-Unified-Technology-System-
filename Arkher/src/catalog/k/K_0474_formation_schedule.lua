-- ARKHER SYSTEM K.0474 :: Formation Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0474"
	S.key = "arkher.npc.formation.daily_schedule"
	S.name = "Formation Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.formation.social_relations" }
	S.tags = { "k", "formation", "schedule", "npc" }
	S.description = "Formation Daily Schedule: hour-by-hour routine with priority interruptions for the Formation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.formation.daily_schedule", startHour = 6 })
		inst.system = S
		inst.ctx = ctx
