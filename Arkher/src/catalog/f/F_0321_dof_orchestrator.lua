-- ARKHER SYSTEM F.0321 :: Depth Of Field Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0321"
	S.key = "arkher.render.dof.orchestration"
	S.name = "Depth Of Field Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.dof.frame_analysis" }
	S.tags = { "f", "dof", "orchestrator", "render" }
	S.description = "Depth Of Field Orchestration: frame lifecycle orchestration for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.dof.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
