-- ARKHER SYSTEM Q.0184 :: Health Bar Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0184"
	S.key = "arkher.ui.healthbar.transition"
	S.name = "Health Bar Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Health Bar"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.healthbar.input_mapping" }
	S.tags = { "q", "healthbar", "tween", "ui" }
	S.description = "Health Bar Transition: eased, delayed, looped and sequenced motion for the Health Bar subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.healthbar.transition", timeScale = 1.12 })
		inst.system = S
		inst.ctx = ctx
