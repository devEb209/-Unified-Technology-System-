-- ARKHER SYSTEM F.0542 :: Decal Rendering Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0542"
	S.key = "arkher.render.decalrender.render_policy"
	S.name = "Decal Rendering Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.decalrender.draw_budget" }
	S.tags = { "f", "decalrender", "policy", "render" }
	S.description = "Decal Rendering Render Policy: device tier rules for the frame for the Decal Rendering subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.decalrender.render_policy", algorithm = "roundrobin", starvationGuard = 32 })
		inst.system = S
		inst.ctx = ctx
