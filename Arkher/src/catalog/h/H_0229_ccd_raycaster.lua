-- ARKHER SYSTEM H.0229 :: Continuous Detection Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0229"
	S.key = "arkher.physics.ccd.query"
	S.name = "Continuous Detection Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.ccd.constraint_solver" }
	S.tags = { "h", "ccd", "raycaster", "physics" }
	S.description = "Continuous Detection Query: rays, sweeps and overlaps against the simulation for the Continuous Detection subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.ccd.query", cellSize = 32 })
		inst.system = S
		inst.ctx = ctx
