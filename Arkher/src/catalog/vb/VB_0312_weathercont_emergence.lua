-- ARKHER SYSTEM VB.0312 :: Weather Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0312"
	S.key = "arkher.conttime.weathercont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.weathercont.reality_continuum" }
	S.tags = { "vb", "weathercont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.weathercont.emergence_continuum", windowSize = 5, threshold = 1.20, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
