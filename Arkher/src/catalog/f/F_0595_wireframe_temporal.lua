-- ARKHER SYSTEM F.0595 :: Wireframe Overlay Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0595"
	S.key = "arkher.render.wireframe.temporal_resolve"
	S.name = "Wireframe Overlay Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.wireframe.probe_volume" }
	S.tags = { "f", "wireframe", "temporal", "render" }
	S.description = "Wireframe Overlay Temporal Resolve: history reprojection with neighbourhood clamping for the Wireframe Overlay subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.wireframe.temporal_resolve", feedback = 0.81, phase = 8 })
		inst.system = S
		inst.ctx = ctx
