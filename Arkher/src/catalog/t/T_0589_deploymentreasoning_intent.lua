-- ARKHER SYSTEM T.0589 :: Deployment Reasoning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0589"
	S.key = "arkher.ai.deploymentreasoning.intent_understanding"
	S.name = "Deployment Reasoning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "deploymentreasoning", "intent", "ai" }
	S.description = "Deployment Reasoning Intent Understanding: natural language turned into an actionable, scored intent for the Deployment Reasoning subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.deploymentreasoning.intent_understanding", minConfidence = 0.38 })
		inst.system = S
		inst.ctx = ctx
