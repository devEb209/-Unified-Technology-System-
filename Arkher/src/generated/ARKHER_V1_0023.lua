...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Cascadeur — ANIMATION Map #0023", size=Vector2.new(680, 480), pos=UDim2.fromOffset(399, 211), parent=parent, icon="◉"})
