-- ARKHER SYSTEM W.0351 :: Subtitle Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0351"
	S.key = "arkher.cine.subtitle.colour_grade"
	S.name = "Subtitle Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Subtitle"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.subtitle.camera_rig" }
	S.tags = { "w", "subtitle", "grade", "cine" }
	S.description = "Subtitle Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Subtitle subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.subtitle.colour_grade", exposure = -0.11, contrast = 0.94, saturation = 1.14, toneMap = "filmic" })
		inst.system = S
		inst.ctx = ctx
