-- ARKHER SYSTEM VD.0470 :: VFX Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0470"
	S.key = "arkher.contsim.vfxcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vfxcont.infinite_grid" }
	S.tags = { "vd", "vfxcont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.vfxcont.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
