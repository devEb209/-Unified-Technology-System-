-- ARKHER SYSTEM P.0280 :: Combat Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0280"
	S.key = "arkher.play.combatsys.combat_resolution"
	S.name = "Combat Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Combat"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.combatsys.objectives" }
	S.tags = { "p", "combatsys", "combat", "play" }
	S.description = "Combat Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Combat subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.combatsys.combat_resolution", seed = 86665, armourK = 90, critMultiplier = 1.60 })
		inst.system = S
		inst.ctx = ctx
