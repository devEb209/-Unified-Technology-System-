-- ARKHER SYSTEM VD.0286 :: Water Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0286"
	S.key = "arkher.contsim.watercont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.watercont.complexity_budget" }
	S.tags = { "vd", "watercont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.watercont.simulation_fabric", budgetMs = 2.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
