-- ARKHER SYSTEM VD.0370 :: Quest Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0370"
	S.key = "arkher.contsim.questcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.questcont.complexity_budget" }
	S.tags = { "vd", "questcont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.questcont.simulation_fabric", budgetMs = 3.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
