-- ARKHER SYSTEM VB.0102 :: Memory Shard Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0102"
	S.key = "arkher.conttime.memoryshard.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memoryshard.persistent_state" }
	S.tags = { "vb", "memoryshard", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.memoryshard.coherence_guard", window = 57, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
