-- ARKHER SYSTEM T.0421 :: Mobile Reasoning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0421"
	S.key = "arkher.ai.mobilereasoning.intent_understanding"
	S.name = "Mobile Reasoning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "mobilereasoning", "intent", "ai" }
	S.description = "Mobile Reasoning Intent Understanding: natural language turned into an actionable, scored intent for the Mobile Reasoning subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.mobilereasoning.intent_understanding", minConfidence = 0.31 })
		inst.system = S
		inst.ctx = ctx
