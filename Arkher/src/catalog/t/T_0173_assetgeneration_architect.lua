-- ARKHER SYSTEM T.0173 :: Asset Generation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0173"
	S.key = "arkher.ai.assetgeneration.world_architect"
	S.name = "Asset Generation World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.assetgeneration.self_critique" }
	S.tags = { "t", "assetgeneration", "architect", "ai" }
	S.description = "Asset Generation World Architect: composition of a whole world plan with conserved budgets for the Asset Generation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.assetgeneration.world_architect", budget = 1500, seed = 4439 })
		inst.system = S
		inst.ctx = ctx
