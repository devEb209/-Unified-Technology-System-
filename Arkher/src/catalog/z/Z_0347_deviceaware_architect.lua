-- ARKHER SYSTEM Z.0347 :: Device Aware Fidelity World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0347"
	S.key = "arkher.origin.deviceaware.world_architect"
	S.name = "Device Aware Fidelity World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.emergence_detection" }
	S.tags = { "z", "deviceaware", "architect", "origin" }
	S.description = "Device Aware Fidelity World Architect: hierarchical world composition with conserved budgets for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.deviceaware.world_architect", budget = 600, seed = 61720 })
		inst.system = S
		inst.ctx = ctx
