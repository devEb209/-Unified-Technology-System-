-- ARKHER SYSTEM K.0521 :: Combat Behaviour Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0521"
	S.key = "arkher.npc.combatbehaviour.drive_system"
	S.name = "Combat Behaviour Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.combatbehaviour.memory" }
	S.tags = { "k", "combatbehaviour", "need", "npc" }
	S.description = "Combat Behaviour Drive System: drives that decay, turn urgent and get satisfied for the Combat Behaviour subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.combatbehaviour.drive_system" })
		inst.system = S
		inst.ctx = ctx
