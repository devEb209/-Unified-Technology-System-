-- ARKHER SYSTEM VB.0084 :: LOD Cascade Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0084"
	S.key = "arkher.conttime.lodcascade.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lodcascade.reality_continuum" }
	S.tags = { "vb", "lodcascade", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.lodcascade.emergence_continuum", windowSize = 7, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
