-- ARKHER SYSTEM K.0009 :: NPC Brain Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0009"
	S.key = "arkher.npc.npcbrain.navigation"
	S.name = "NPC Brain Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcbrain.goal_planner" }
	S.tags = { "k", "npcbrain", "navgraph", "npc" }
	S.description = "NPC Brain Navigation: grid pathfinding, smoothing, line of sight and flow fields for the NPC Brain subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.npcbrain.navigation", width = 48, height = 48, cellSize = 5 })
		inst.system = S
		inst.ctx = ctx
