-- ARKHER SYSTEM VB.0156 :: Persistence Segment Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0156"
	S.key = "arkher.conttime.persistsegment.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.persistsegment.reality_continuum" }
	S.tags = { "vb", "persistsegment", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.persistsegment.emergence_continuum", windowSize = 5, threshold = 1.60, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
