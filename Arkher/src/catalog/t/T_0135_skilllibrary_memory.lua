-- ARKHER SYSTEM T.0135 :: Skill Library Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0135"
	S.key = "arkher.ai.skilllibrary.working_memory"
	S.name = "Skill Library Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.skilllibrary.outcome_prediction" }
	S.tags = { "t", "skilllibrary", "memory", "ai" }
	S.description = "Skill Library Working Memory: decaying, consolidating recall of what the agent learned for the Skill Library subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.skilllibrary.working_memory", capacity = 115, decayRate = 0.025, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
