-- ARKHER SYSTEM W.0203 :: Action Scene Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0203"
	S.key = "arkher.cine.actionscene.sequence_analysis"
	S.name = "Action Scene Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Action Scene"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.actionscene.frame_budget" }
	S.tags = { "w", "actionscene", "analyzer", "cine" }
	S.description = "Action Scene Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Action Scene subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.actionscene.sequence_analysis", window = 95, buckets = 19, threshold = 3.70 })
		inst.system = S
		inst.ctx = ctx
