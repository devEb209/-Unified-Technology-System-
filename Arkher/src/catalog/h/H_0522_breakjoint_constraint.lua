-- ARKHER SYSTEM H.0522 :: Breakable Joint Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0522"
	S.key = "arkher.physics.breakjoint.constraint_solver"
	S.name = "Breakable Joint Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.breakjoint.contact_generation" }
	S.tags = { "h", "breakjoint", "constraint", "physics" }
	S.description = "Breakable Joint Constraint Solver: sequential impulses, friction, joints and warm starting for the Breakable Joint subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.breakjoint.constraint_solver", iterations = 4, baumgarte = 0.20, warmStart = true })
		inst.system = S
		inst.ctx = ctx
