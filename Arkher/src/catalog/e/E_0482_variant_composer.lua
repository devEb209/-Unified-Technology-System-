-- ARKHER SYSTEM E.0482 :: Material Variant Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0482"
	S.key = "arkher.material.variant.layer_composition"
	S.name = "Material Variant Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.variant.definition" }
	S.tags = { "e", "variant", "composer", "material" }
	S.description = "Material Variant Layer Composition: ordered layer composition with blend rules for the Material Variant subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.variant.layer_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
