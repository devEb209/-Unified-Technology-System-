-- ARKHER SYSTEM I.0197 :: State Machine Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0197"
	S.key = "arkher.anim.animstate.clip_sampling"
	S.name = "State Machine Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstate.skeleton" }
	S.tags = { "i", "animstate", "clip", "anim" }
	S.description = "State Machine Clip Sampling: keyframe tracks sampled, retimed and evented for the State Machine subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.animstate.clip_sampling", duration = 1.70, loop = true })
		inst.system = S
		inst.ctx = ctx
