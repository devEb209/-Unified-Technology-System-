-- ARKHER SYSTEM F.0080 :: Cascade Shadows Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0080"
	S.key = "arkher.render.cascades.render_policy"
	S.name = "Cascade Shadows Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.cascades.draw_budget" }
	S.tags = { "f", "cascades", "policy", "render" }
	S.description = "Cascade Shadows Render Policy: device tier rules for the frame for the Cascade Shadows subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.cascades.render_policy", algorithm = "lottery", starvationGuard = 27 })
		inst.system = S
		inst.ctx = ctx
