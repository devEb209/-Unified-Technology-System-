-- ARKHER SYSTEM H.0415 :: Restitution Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0415"
	S.key = "arkher.physics.restitution.budget_governor"
	S.name = "Restitution Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Restitution"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.restitution.broadphase_index" }
	S.tags = { "h", "restitution", "budgeter", "physics" }
	S.description = "Restitution Budget Governor: simulation time budget allocation across islands for the Restitution subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.restitution.budget_governor", total = 98, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
