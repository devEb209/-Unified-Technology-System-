-- ARKHER SYSTEM Z.0307 :: Causality Ledger World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0307"
	S.key = "arkher.origin.causality.world_architect"
	S.name = "Causality Ledger World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.emergence_detection" }
	S.tags = { "z", "causality", "architect", "origin" }
	S.description = "Causality Ledger World Architect: hierarchical world composition with conserved budgets for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.causality.world_architect", budget = 600, seed = 18480 })
		inst.system = S
		inst.ctx = ctx
