-- ARKHER SYSTEM N.0511 :: Effect Debug Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0511"
	S.key = "arkher.vfx.fxdebug.ribbon_and_trail"
	S.name = "Effect Debug Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Effect Debug"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fxdebug.force_field" }
	S.tags = { "n", "fxdebug", "ribbon", "vfx" }
	S.description = "Effect Debug Ribbon And Trail: trail points, tapering, beams and decimation for the Effect Debug subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.fxdebug.ribbon_and_trail", maxPoints = 56, lifetime = 1.00, minDistance = 0.35, width = 0.70 })
		inst.system = S
		inst.ctx = ctx
