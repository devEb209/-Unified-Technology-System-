-- ARKHER SYSTEM Z.0747 :: World Compression World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0747"
	S.key = "arkher.origin.worldcompression.world_architect"
	S.name = "World Compression World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.emergence_detection" }
	S.tags = { "z", "worldcompression", "architect", "origin" }
	S.description = "World Compression World Architect: hierarchical world composition with conserved budgets for the World Compression subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.worldcompression.world_architect", budget = 700, seed = 57671 })
		inst.system = S
		inst.ctx = ctx
