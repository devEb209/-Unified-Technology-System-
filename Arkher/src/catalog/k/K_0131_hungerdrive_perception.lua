-- ARKHER SYSTEM K.0131 :: Hunger Drive Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0131"
	S.key = "arkher.npc.hungerdrive.perception"
	S.name = "Hunger Drive Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hungerdrive.emotion" }
	S.tags = { "k", "hungerdrive", "perception", "npc" }
	S.description = "Hunger Drive Perception: sight, hearing and bounded attention for the Hunger Drive subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.hungerdrive.perception", sightRange = 45, hearingRange = 20, attentionSlots = 3, fov = 1.720 })
		inst.system = S
		inst.ctx = ctx
