-- ARKHER SYSTEM VD.0411 :: Behaviour Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0411"
	S.key = "arkher.contsim.behaviourcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.behaviourcont.epoch_clock" }
	S.tags = { "vd", "behaviourcont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.behaviourcont.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
