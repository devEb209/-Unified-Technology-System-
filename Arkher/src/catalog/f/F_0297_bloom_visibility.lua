-- ARKHER SYSTEM F.0297 :: Bloom Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0297"
	S.key = "arkher.render.bloom.visibility_set"
	S.name = "Bloom Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Bloom"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.bloom.view_and_culling" }
	S.tags = { "f", "bloom", "visibility", "render" }
	S.description = "Bloom Visibility Set: cell, portal and occluder visibility for the Bloom subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.bloom.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
