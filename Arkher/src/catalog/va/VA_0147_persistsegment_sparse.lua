-- ARKHER SYSTEM VA.0147 :: Persistence Segment Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0147"
	S.key = "arkher.contworld.persistsegment.sparse_residency"
	S.name = "Persistence Segment Sparse Residency"
	S.category = "VA"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.persistsegment.epoch_clock" }
	S.tags = { "va", "persistsegment", "sparse", "contworld" }
	S.description = "Persistence Segment Sparse Residency: sparse page residency with eviction and compression for the Persistence Segment subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.persistsegment.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
