-- ARKHER SYSTEM J.0189 :: Armor Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0189"
	S.key = "arkher.character.armor.motion_set"
	S.name = "Armor Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.armor.rig_definition" }
	S.tags = { "j", "armor", "clip", "character" }
	S.description = "Armor Motion Set: the clips a character owns and how they sample for the Armor subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.armor.motion_set", duration = 2.10, loop = true })
		inst.system = S
		inst.ctx = ctx
