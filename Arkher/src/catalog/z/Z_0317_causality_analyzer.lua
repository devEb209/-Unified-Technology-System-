-- ARKHER SYSTEM Z.0317 :: Causality Ledger Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0317"
	S.key = "arkher.origin.causality.behaviour_analysis"
	S.name = "Causality Ledger Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.governance_policy" }
	S.tags = { "z", "causality", "analyzer", "origin" }
	S.description = "Causality Ledger Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.causality.behaviour_analysis", window = 52, buckets = 16, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
