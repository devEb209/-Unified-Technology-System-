-- ARKHER SYSTEM E.0086 :: Normal Detail Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0086"
	S.key = "arkher.material.normaldetail.instance_cache"
	S.name = "Normal Detail Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.normaldetail.quality_policy" }
	S.tags = { "e", "normaldetail", "cache", "material" }
	S.description = "Normal Detail Instance Cache: resolved-parameter cache keyed by context for the Normal Detail subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.normaldetail.instance_cache", policy = "lru", capacity = 406, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
