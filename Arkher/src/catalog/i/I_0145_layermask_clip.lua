-- ARKHER SYSTEM I.0145 :: Layer Mask Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0145"
	S.key = "arkher.anim.layermask.clip_sampling"
	S.name = "Layer Mask Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Layer Mask"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.layermask.skeleton" }
	S.tags = { "i", "layermask", "clip", "anim" }
	S.description = "Layer Mask Clip Sampling: keyframe tracks sampled, retimed and evented for the Layer Mask subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.layermask.clip_sampling", duration = 1.90, loop = true })
		inst.system = S
		inst.ctx = ctx
