-- ARKHER SYSTEM H.0548 :: Cloth Simulation Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0548"
	S.key = "arkher.physics.cloth.collision_shape"
	S.name = "Cloth Simulation Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.cloth.body_dynamics" }
	S.tags = { "h", "cloth", "collider", "physics" }
	S.description = "Cloth Simulation Collision Shape: shape bounds, support mapping and closest points for the Cloth Simulation subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.cloth.collision_shape", shape = "capsule", radius = 0.60, height = 1.40, layer = "character" })
		inst.system = S
		inst.ctx = ctx
