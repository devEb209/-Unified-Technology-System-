-- ARKHER SYSTEM E.0474 :: Material Instance Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0474"
	S.key = "arkher.material.instance.compression_codec"
	S.name = "Material Instance Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.instance.streaming" }
	S.tags = { "e", "instance", "codec", "material" }
	S.description = "Material Instance Compression Codec: serialization and compression of material data for the Material Instance subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.instance.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
