-- ARKHER SYSTEM J.0182 :: Accessory Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0182"
	S.key = "arkher.character.accessory.locomotion"
	S.name = "Accessory Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.accessory.physical_response" }
	S.tags = { "j", "accessory", "charmotor", "character" }
	S.description = "Accessory Locomotion: capsule locomotion driving the character for the Accessory subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.accessory.locomotion", radius = 0.49, height = 1.74, maxSpeed = 5.40, jumpHeight = 1.40, stepOffset = 0.39 })
		inst.system = S
		inst.ctx = ctx
