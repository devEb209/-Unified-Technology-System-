-- ARKHER SYSTEM P.0098 :: Inventory Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0098"
	S.key = "arkher.play.inventorysys.inventory"
	S.name = "Inventory Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Inventory"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.inventorysys.attributes" }
	S.tags = { "p", "inventorysys", "inventory", "play" }
	S.description = "Inventory Inventory: slots, stacking, weight, equipment and crafting for the Inventory subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.inventorysys.inventory", slots = 24, maxWeight = 150 })
		inst.system = S
		inst.ctx = ctx
