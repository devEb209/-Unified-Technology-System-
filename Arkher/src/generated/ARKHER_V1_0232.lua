...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Gaea Nodes — CORE Mixer #0232", size=Vector2.new(640, 460), pos=UDim2.fromOffset(316, 124), parent=parent, icon="◐"})
...
Components.Slider(right, "Rate", 0,3000,600, function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_Rate"..232, v) end end)
