-- ARKHER SYSTEM VD.0211 :: Biome Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0211"
	S.key = "arkher.contsim.biomecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.biomecont.coherence_guard" }
	S.tags = { "vd", "biomecont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.biomecont.neural_field", dims = 16, hidden = 12, seed = 43397 })
		inst.system = S
		inst.ctx = ctx
