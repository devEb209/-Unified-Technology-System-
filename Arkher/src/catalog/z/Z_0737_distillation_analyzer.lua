-- ARKHER SYSTEM Z.0737 :: Knowledge Distillation Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0737"
	S.key = "arkher.origin.distillation.behaviour_analysis"
	S.name = "Knowledge Distillation Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.distillation.governance_policy" }
	S.tags = { "z", "distillation", "analyzer", "origin" }
	S.description = "Knowledge Distillation Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Knowledge Distillation subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.distillation.behaviour_analysis", window = 58, buckets = 18, threshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
