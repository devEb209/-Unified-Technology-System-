-- ARKHER SYSTEM K.0527 :: Combat Behaviour Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0527"
	S.key = "arkher.npc.combatbehaviour.navigation"
	S.name = "Combat Behaviour Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.combatbehaviour.goal_planner" }
	S.tags = { "k", "combatbehaviour", "navgraph", "npc" }
	S.description = "Combat Behaviour Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Combat Behaviour subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.combatbehaviour.navigation", width = 40, height = 40, cellSize = 4 })
		inst.system = S
		inst.ctx = ctx
