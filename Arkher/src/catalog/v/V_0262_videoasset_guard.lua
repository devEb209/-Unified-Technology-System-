-- ARKHER SYSTEM V.0262 :: Video Asset Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0262"
	S.key = "arkher.asset.videoasset.validation_guard"
	S.name = "Video Asset Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.videoasset.size_budget" }
	S.tags = { "v", "videoasset", "guard", "asset" }
	S.description = "Video Asset Validation Guard: rate limiting and capability checks on the import path for the Video Asset subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.videoasset.validation_guard", algorithm = "leaky", capacity = 169, refillPerSec = 34, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
