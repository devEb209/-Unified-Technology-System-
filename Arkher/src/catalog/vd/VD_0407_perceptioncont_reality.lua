-- ARKHER SYSTEM VD.0407 :: Perception Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0407"
	S.key = "arkher.contsim.perceptioncont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.perceptioncont.simulation_fabric" }
	S.tags = { "vd", "perceptioncont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.perceptioncont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
