-- ARKHER SYSTEM W.0356 :: Subtitle Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0356"
	S.key = "arkher.cine.subtitle.cinematic_mix"
	S.name = "Subtitle Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Subtitle"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.subtitle.motion_tween" }
	S.tags = { "w", "subtitle", "mixer", "cine" }
	S.description = "Subtitle Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Subtitle subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.subtitle.cinematic_mix", maxVoices = 40 })
		inst.system = S
		inst.ctx = ctx
