-- ARKHER SYSTEM Z.0261 :: Living Ecosystem Engine Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0261"
	S.key = "arkher.origin.livingecosystem.reality_layering"
	S.name = "Living Ecosystem Engine Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "livingecosystem", "reality", "origin" }
	S.description = "Living Ecosystem Engine Reality Layering: stacked authored, simulated, proposed and player realities for the Living Ecosystem Engine subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.livingecosystem.reality_layering" })
		inst.system = S
		inst.ctx = ctx
