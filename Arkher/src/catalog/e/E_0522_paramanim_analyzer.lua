-- ARKHER SYSTEM E.0522 :: Parameter Animation Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0522"
	S.key = "arkher.material.paramanim.analysis"
	S.name = "Parameter Animation Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.paramanim.instance_cache" }
	S.tags = { "e", "paramanim", "analyzer", "material" }
	S.description = "Parameter Animation Analysis: cost, redundancy and outlier analysis for the Parameter Animation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.paramanim.analysis", window = 158, buckets = 14, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
