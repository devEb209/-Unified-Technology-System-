-- ARKHER SYSTEM N.0409 :: Wind Gust Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0409"
	S.key = "arkher.vfx.windgust.effect_graph"
	S.name = "Wind Gust Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Wind Gust"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.windgust.curve_authoring" }
	S.tags = { "n", "windgust", "shadegraph", "vfx" }
	S.description = "Wind Gust Effect Graph: node graph describing how the effect is shaded for the Wind Gust subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.windgust.effect_graph" })
		inst.system = S
		inst.ctx = ctx
