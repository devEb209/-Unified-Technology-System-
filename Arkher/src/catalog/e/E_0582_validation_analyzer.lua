-- ARKHER SYSTEM E.0582 :: Material Validation Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0582"
	S.key = "arkher.material.validation.analysis"
	S.name = "Material Validation Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.validation.instance_cache" }
	S.tags = { "e", "validation", "analyzer", "material" }
	S.description = "Material Validation Analysis: cost, redundancy and outlier analysis for the Material Validation subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.validation.analysis", window = 165, buckets = 13, threshold = 3.70 })
		inst.system = S
		inst.ctx = ctx
