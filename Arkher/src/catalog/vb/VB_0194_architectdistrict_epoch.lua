-- ARKHER SYSTEM VB.0194 :: Architect District Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0194"
	S.key = "arkher.conttime.architectdistrict.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.architectdistrict.infinite_grid" }
	S.tags = { "vb", "architectdistrict", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.architectdistrict.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
