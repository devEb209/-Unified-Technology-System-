-- ARKHER SYSTEM K.0269 :: Hearing Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0269"
	S.key = "arkher.npc.hearing.drive_system"
	S.name = "Hearing Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hearing.memory" }
	S.tags = { "k", "hearing", "need", "npc" }
	S.description = "Hearing Drive System: drives that decay, turn urgent and get satisfied for the Hearing subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.hearing.drive_system" })
		inst.system = S
		inst.ctx = ctx
