-- ARKHER SYSTEM I.0496 :: Cloth Animation Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0496"
	S.key = "arkher.anim.clothanim.clip_sampling"
	S.name = "Cloth Animation Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clothanim.skeleton" }
	S.tags = { "i", "clothanim", "clip", "anim" }
	S.description = "Cloth Animation Clip Sampling: keyframe tracks sampled, retimed and evented for the Cloth Animation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.clothanim.clip_sampling", duration = 1.90, loop = true })
		inst.system = S
		inst.ctx = ctx
