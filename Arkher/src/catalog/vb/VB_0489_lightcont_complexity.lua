-- ARKHER SYSTEM VB.0489 :: Lighting Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0489"
	S.key = "arkher.conttime.lightcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lightcont.world_memory_stream" }
	S.tags = { "vb", "lightcont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.lightcont.complexity_budget", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
