-- ARKHER SYSTEM N.0264 :: Shield Effect Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0264"
	S.key = "arkher.vfx.shieldfx.ribbon_and_trail"
	S.name = "Shield Effect Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.shieldfx.force_field" }
	S.tags = { "n", "shieldfx", "ribbon", "vfx" }
	S.description = "Shield Effect Ribbon And Trail: trail points, tapering, beams and decimation for the Shield Effect subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.shieldfx.ribbon_and_trail", maxPoints = 16, lifetime = 1.10, minDistance = 0.40, width = 0.80 })
		inst.system = S
		inst.ctx = ctx
