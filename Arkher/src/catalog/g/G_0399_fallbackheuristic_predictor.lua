-- ARKHER SYSTEM G.0399 :: Fallback Heuristic Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0399"
	S.key = "arkher.neural.fallbackheuristic.quality_predictor"
	S.name = "Fallback Heuristic Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.fallbackheuristic.weight_codec" }
	S.tags = { "g", "fallbackheuristic", "predictor", "neural" }
	S.description = "Fallback Heuristic Quality Predictor: predicted quality and cost of a setting for the Fallback Heuristic subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.fallbackheuristic.quality_predictor", method = "markov", alpha = 0.37, window = 67 })
		inst.system = S
		inst.ctx = ctx
