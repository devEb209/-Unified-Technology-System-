-- ARKHER SYSTEM G.0435 :: Model Versioning Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0435"
	S.key = "arkher.neural.modelversion.inference_core"
	S.name = "Model Versioning Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "modelversion", "inference", "neural" }
	S.description = "Model Versioning Inference Core: dense network forward pass and training for the Model Versioning subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.modelversion.inference_core", seed = 6747 })
		inst.system = S
		inst.ctx = ctx
