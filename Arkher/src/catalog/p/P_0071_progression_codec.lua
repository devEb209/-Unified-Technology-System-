-- ARKHER SYSTEM P.0071 :: Progression Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0071"
	S.key = "arkher.play.progression.save_codec"
	S.name = "Progression Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Progression"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.progression.content_registry" }
	S.tags = { "p", "progression", "codec", "play" }
	S.description = "Progression Save Codec: persistence, diffing and checksum of gameplay state for the Progression subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.progression.save_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
