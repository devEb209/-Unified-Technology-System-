-- ARKHER SYSTEM VD.0391 :: Memory Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0391"
	S.key = "arkher.contsim.memorycont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memorycont.coherence_guard" }
	S.tags = { "vd", "memorycont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.memorycont.neural_field", dims = 24, hidden = 20, seed = 42983 })
		inst.system = S
		inst.ctx = ctx
