-- ARKHER SYSTEM K.0473 :: Formation Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0473"
	S.key = "arkher.npc.formation.social_relations"
	S.name = "Formation Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.formation.crowd_steering" }
	S.tags = { "k", "formation", "society", "npc" }
	S.description = "Formation Social Relations: affinity, factions, reputation and gossip for the Formation subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.formation.social_relations", decayRate = 0.008, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
