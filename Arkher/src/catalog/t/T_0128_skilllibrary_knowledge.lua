-- ARKHER SYSTEM T.0128 :: Skill Library Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0128"
	S.key = "arkher.ai.skilllibrary.semantic_knowledge"
	S.name = "Skill Library Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.skilllibrary.intent_understanding" }
	S.tags = { "t", "skilllibrary", "knowledge", "ai" }
	S.description = "Skill Library Semantic Knowledge: typed entities, weighted relations and inferred closure for the Skill Library subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.skilllibrary.semantic_knowledge", dims = 16 })
		inst.system = S
		inst.ctx = ctx
