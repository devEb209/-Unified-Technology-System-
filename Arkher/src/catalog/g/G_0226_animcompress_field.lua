-- ARKHER SYSTEM G.0226 :: Animation Compression Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0226"
	S.key = "arkher.neural.animcompress.feature_extraction"
	S.name = "Animation Compression Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.animcompress.inference_core" }
	S.tags = { "g", "animcompress", "field", "neural" }
	S.description = "Animation Compression Feature Extraction: signal features feeding the model for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.animcompress.feature_extraction", seed = 20357, frequency = 0.0132, octaves = 4, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
