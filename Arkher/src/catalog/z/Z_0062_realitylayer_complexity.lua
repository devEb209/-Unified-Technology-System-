-- ARKHER SYSTEM Z.0062 :: Reality Layer Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0062"
	S.key = "arkher.origin.realitylayer.complexity_governance"
	S.name = "Reality Layer Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.reality_layering" }
	S.tags = { "z", "realitylayer", "complexity", "origin" }
	S.description = "Reality Layer Complexity Governance: measured scene cost turned into per-subsystem directives for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.realitylayer.complexity_governance", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
