-- ARKHER SYSTEM K.0689 :: NPC Debug Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0689"
	S.key = "arkher.npc.npcdebug.drive_system"
	S.name = "NPC Debug Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcdebug.memory" }
	S.tags = { "k", "npcdebug", "need", "npc" }
	S.description = "NPC Debug Drive System: drives that decay, turn urgent and get satisfied for the NPC Debug subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.npcdebug.drive_system" })
		inst.system = S
		inst.ctx = ctx
