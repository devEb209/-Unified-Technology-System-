-- ARKHER SYSTEM VC.0008 :: World Grid Cell World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0008"
	S.key = "arkher.contneural.worldcell.world_memory_stream"
	S.name = "World Grid Cell World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldcell.neural_field" }
	S.tags = { "vc", "worldcell", "worldmemory", "contneural" }
	S.description = "World Grid Cell World Memory Stream: world memory continuum over epochs for the World Grid Cell subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.worldcell.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
