-- ARKHER SYSTEM K.0372 :: Utility Selection Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0372"
	S.key = "arkher.npc.utilityselection.goal_planner"
	S.name = "Utility Selection Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.utilityselection.utility_reasoning" }
	S.tags = { "k", "utilityselection", "planner", "npc" }
	S.description = "Utility Selection Goal Planner: backward GOAP planning to reach a goal state for the Utility Selection subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.utilityselection.goal_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
