-- ARKHER SYSTEM R.0150 :: Delta Compression Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0150"
	S.key = "arkher.net.deltacompression.serialization_codec"
	S.name = "Delta Compression Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.deltacompression.bandwidth_budget" }
	S.tags = { "r", "deltacompression", "codec", "net" }
	S.description = "Delta Compression Serialization Codec: compact encoding, diffing and checksum of payloads for the Delta Compression subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.deltacompression.serialization_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
