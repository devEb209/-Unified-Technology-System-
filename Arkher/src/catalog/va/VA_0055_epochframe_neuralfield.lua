-- ARKHER SYSTEM VA.0055 :: Epoch Frame Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0055"
	S.key = "arkher.contworld.epochframe.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.epochframe.coherence_guard" }
	S.tags = { "va", "epochframe", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.epochframe.neural_field", dims = 16, hidden = 12, seed = 9969 })
		inst.system = S
		inst.ctx = ctx
