-- ARKHER SYSTEM VC.0143 :: Fidelity Band Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0143"
	S.key = "arkher.contneural.fidelityband.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.fidelityband.simulation_fabric" }
	S.tags = { "vc", "fidelityband", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.fidelityband.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
