-- ARKHER SYSTEM T.0032 :: Task Decomposition Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0032"
	S.key = "arkher.ai.decomposition.self_critique"
	S.name = "Task Decomposition Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.decomposition.plan_workflow" }
	S.tags = { "t", "decomposition", "critic", "ai" }
	S.description = "Task Decomposition Self Critique: weighted evaluation of the result against declared criteria for the Task Decomposition subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.decomposition.self_critique", passMark = 0.73, reviseMark = 0.48, seed = 98718 })
		inst.system = S
		inst.ctx = ctx
