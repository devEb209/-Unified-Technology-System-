-- ARKHER SYSTEM E.0402 :: Texture Atlas Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0402"
	S.key = "arkher.material.atlas.analysis"
	S.name = "Texture Atlas Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.atlas.instance_cache" }
	S.tags = { "e", "atlas", "analyzer", "material" }
	S.description = "Texture Atlas Analysis: cost, redundancy and outlier analysis for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.atlas.analysis", window = 71, buckets = 11, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
