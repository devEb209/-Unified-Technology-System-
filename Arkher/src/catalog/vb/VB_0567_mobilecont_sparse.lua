-- ARKHER SYSTEM VB.0567 :: Mobile Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0567"
	S.key = "arkher.conttime.mobilecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.mobilecont.epoch_clock" }
	S.tags = { "vb", "mobilecont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.mobilecont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
