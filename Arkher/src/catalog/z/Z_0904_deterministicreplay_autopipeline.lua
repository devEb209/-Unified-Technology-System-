-- ARKHER SYSTEM Z.0904 :: Deterministic Replay Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0904"
	S.key = "arkher.origin.deterministicreplay.autonomous_pipeline"
	S.name = "Deterministic Replay Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deterministicreplay.simulation_fabric" }
	S.tags = { "z", "deterministicreplay", "autopipeline", "origin" }
	S.description = "Deterministic Replay Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Deterministic Replay subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.deterministicreplay.autonomous_pipeline", maxIterations = 7 })
		inst.system = S
		inst.ctx = ctx
