-- ARKHER SYSTEM T.0660 :: Multi Agent Coordination Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0660"
	S.key = "arkher.ai.multiagent.semantic_knowledge"
	S.name = "Multi Agent Coordination Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.multiagent.intent_understanding" }
	S.tags = { "t", "multiagent", "knowledge", "ai" }
	S.description = "Multi Agent Coordination Semantic Knowledge: typed entities, weighted relations and inferred closure for the Multi Agent Coordination subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.multiagent.semantic_knowledge", dims = 32 })
		inst.system = S
		inst.ctx = ctx
