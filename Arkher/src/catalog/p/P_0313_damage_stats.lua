-- ARKHER SYSTEM P.0313 :: Damage Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0313"
	S.key = "arkher.play.damage.attributes"
	S.name = "Damage Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Damage"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "damage", "stats", "play" }
	S.description = "Damage Attributes: base values, layered modifiers and derived statistics for the Damage subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.damage.attributes" })
		inst.system = S
		inst.ctx = ctx
