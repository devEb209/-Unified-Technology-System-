-- ARKHER SYSTEM VB.0507 :: Material Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0507"
	S.key = "arkher.conttime.materialcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.materialcont.epoch_clock" }
	S.tags = { "vb", "materialcont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.materialcont.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
