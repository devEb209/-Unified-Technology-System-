-- ARKHER SYSTEM Z.0344 :: Device Aware Fidelity Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0344"
	S.key = "arkher.origin.deviceaware.autonomous_pipeline"
	S.name = "Device Aware Fidelity Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.simulation_fabric" }
	S.tags = { "z", "deviceaware", "autopipeline", "origin" }
	S.description = "Device Aware Fidelity Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.deviceaware.autonomous_pipeline", maxIterations = 7 })
		inst.system = S
		inst.ctx = ctx
