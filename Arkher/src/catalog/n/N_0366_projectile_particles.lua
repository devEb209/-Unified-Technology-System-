-- ARKHER SYSTEM N.0366 :: Projectile Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0366"
	S.key = "arkher.vfx.projectile.particle_simulation"
	S.name = "Projectile Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Projectile"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.projectile.emission" }
	S.tags = { "n", "projectile", "particles", "vfx" }
	S.description = "Projectile Particle Simulation: pooled integration of position, velocity, colour and life for the Projectile subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.projectile.particle_simulation", capacity = 576, drag = 0.12, bounce = 0.07, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
