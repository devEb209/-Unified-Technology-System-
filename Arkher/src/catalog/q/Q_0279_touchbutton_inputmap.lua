-- ARKHER SYSTEM Q.0279 :: Touch Button Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0279"
	S.key = "arkher.ui.touchbutton.input_mapping"
	S.name = "Touch Button Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Touch Button"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.touchbutton.widget_tree" }
	S.tags = { "q", "touchbutton", "inputmap", "ui" }
	S.description = "Touch Button Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Touch Button subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.touchbutton.input_mapping", device = "touch", holdTime = 0.26, deadzone = 0.16 })
		inst.system = S
		inst.ctx = ctx
