-- ARKHER SYSTEM G.0020 :: Temporal Reconstruction Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0020"
	S.key = "arkher.neural.temporalrecon.weight_codec"
	S.name = "Temporal Reconstruction Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.temporalrecon.model_registry" }
	S.tags = { "g", "temporalrecon", "codec", "neural" }
	S.description = "Temporal Reconstruction Weight Codec: weight serialization and quantized transport for the Temporal Reconstruction subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.temporalrecon.weight_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
