-- ARKHER SYSTEM L.0295 :: Water Cycle Streaming
...
return function(A)
	...
	local S = {}
	S.id = "L.0295"
	S.key = "arkher.sim.watercycle.streaming"
	S.name = "Water Cycle Streaming"
	S.category = "L"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.watercycle.state_codec" }
	S.tags = { "l", "watercycle", "streamer", "sim" }
	S.description = "Water Cycle Streaming: distance-driven residency of simulated regions for the Water Cycle subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.sim.watercycle.streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
