-- ARKHER SYSTEM VA.0548 :: World Fabric World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0548"
	S.key = "arkher.contworld.worldfabric.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldfabric.neural_field" }
	S.tags = { "va", "worldfabric", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.worldfabric.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
