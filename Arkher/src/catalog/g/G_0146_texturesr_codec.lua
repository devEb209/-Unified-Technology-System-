-- ARKHER SYSTEM G.0146 :: Texture Super Resolution Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0146"
	S.key = "arkher.neural.texturesr.weight_codec"
	S.name = "Texture Super Resolution Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.texturesr.model_registry" }
	S.tags = { "g", "texturesr", "codec", "neural" }
	S.description = "Texture Super Resolution Weight Codec: weight serialization and quantized transport for the Texture Super Resolution subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.texturesr.weight_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
