-- ARKHER SYSTEM O.0158 :: Forest Audio Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0158"
	S.key = "arkher.audio.forestaudio.mixer_bus"
	S.name = "Forest Audio Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Forest Audio"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.forestaudio.dsp_chain" }
	S.tags = { "o", "forestaudio", "mixer", "audio" }
	S.description = "Forest Audio Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Forest Audio subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.forestaudio.mixer_bus", maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
