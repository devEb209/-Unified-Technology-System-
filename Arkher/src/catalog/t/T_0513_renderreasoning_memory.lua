-- ARKHER SYSTEM T.0513 :: Render Reasoning Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0513"
	S.key = "arkher.ai.renderreasoning.working_memory"
	S.name = "Render Reasoning Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.renderreasoning.outcome_prediction" }
	S.tags = { "t", "renderreasoning", "memory", "ai" }
	S.description = "Render Reasoning Working Memory: decaying, consolidating recall of what the agent learned for the Render Reasoning subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.renderreasoning.working_memory", capacity = 69, decayRate = 0.065, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
