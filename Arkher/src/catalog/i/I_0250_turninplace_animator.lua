-- ARKHER SYSTEM I.0250 :: Turn In Place Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0250"
	S.key = "arkher.anim.turninplace.layered_blending"
	S.name = "Turn In Place Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.turninplace.clip_sampling" }
	S.tags = { "i", "turninplace", "animator", "anim" }
	S.description = "Turn In Place Layered Blending: layers, crossfades, masks and blend trees for the Turn In Place subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.turninplace.layered_blending", budget = 9 })
		inst.system = S
		inst.ctx = ctx
