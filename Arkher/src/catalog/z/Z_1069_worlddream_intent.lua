-- ARKHER SYSTEM Z.1069 :: World Dream State Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.1069"
	S.key = "arkher.origin.worlddream.intent_bridge"
	S.name = "World Dream State Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.semantic_graph" }
	S.tags = { "z", "worlddream", "intent", "origin" }
	S.description = "World Dream State Intent Bridge: natural language control surface for the technology for the World Dream State subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.worlddream.intent_bridge", minConfidence = 0.33 })
		inst.system = S
		inst.ctx = ctx
