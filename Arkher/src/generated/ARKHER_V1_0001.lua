--!strict
-- Frostbite Frosty — ANIMATION Node_Flow #0001
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Frostbite Frosty — ANIMATION Node_Flow #0001", size=Vector2.new(640, 440), pos=UDim2.fromOffset(113, 97), parent=parent, icon="◐"})
