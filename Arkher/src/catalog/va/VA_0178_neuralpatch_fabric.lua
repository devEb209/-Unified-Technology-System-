-- ARKHER SYSTEM VA.0178 :: Neural Patch Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0178"
	S.key = "arkher.contworld.neuralpatch.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.neuralpatch.complexity_budget" }
	S.tags = { "va", "neuralpatch", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.neuralpatch.simulation_fabric", budgetMs = 4.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
