-- ARKHER SYSTEM Z.0502 :: Economic Emergence Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0502"
	S.key = "arkher.origin.economicemergence.complexity_governance"
	S.name = "Economic Emergence Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.economicemergence.reality_layering" }
	S.tags = { "z", "economicemergence", "complexity", "origin" }
	S.description = "Economic Emergence Complexity Governance: measured scene cost turned into per-subsystem directives for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.economicemergence.complexity_governance", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
