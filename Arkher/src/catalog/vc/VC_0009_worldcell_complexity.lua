-- ARKHER SYSTEM VC.0009 :: World Grid Cell Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0009"
	S.key = "arkher.contneural.worldcell.complexity_budget"
	S.name = "World Grid Cell Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldcell.world_memory_stream" }
	S.tags = { "vc", "worldcell", "complexity", "contneural" }
	S.description = "World Grid Cell Complexity Budget: complexity budgeting for the continuum for the World Grid Cell subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.worldcell.complexity_budget", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
