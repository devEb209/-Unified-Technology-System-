--!strict
-- Google Maps — CORE Node_Flow #0226
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Google Maps — CORE Node_Flow #0226", size=Vector2.new(640, 440), pos=UDim2.fromOffset(238, 282), parent=parent, icon="✥"})
