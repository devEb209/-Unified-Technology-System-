-- ARKHER SYSTEM VB.0373 :: Dialogue Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0373"
	S.key = "arkher.conttime.dialoguecont.infinite_grid"
	S.name = "Dialogue Continuum Infinite Grid"
	S.category = "VB"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "dialoguecont", "continuum", "conttime" }
	S.description = "Dialogue Continuum Infinite Grid: seamless paging of the infinite world grid for the Dialogue Continuum subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.dialoguecont.infinite_grid", cellSize = 96, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
