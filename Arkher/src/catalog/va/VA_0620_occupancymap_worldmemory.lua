-- ARKHER SYSTEM VA.0620 :: Occupancy Map World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0620"
	S.key = "arkher.contworld.occupancymap.world_memory_stream"
	S.name = "Occupancy Map World Memory Stream"
	S.category = "VA"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.occupancymap.neural_field" }
	S.tags = { "va", "occupancymap", "worldmemory", "contworld" }
	S.description = "Occupancy Map World Memory Stream: world memory continuum over epochs for the Occupancy Map subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.occupancymap.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
