-- ARKHER SYSTEM E.0035 :: Albedo Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0035"
	S.key = "arkher.material.albedo.procedural_detail"
	S.name = "Albedo Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Albedo"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.albedo.texture_sampling" }
	S.tags = { "e", "albedo", "field", "material" }
	S.description = "Albedo Procedural Detail: coherent noise detail driving the surface for the Albedo subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.albedo.procedural_detail", seed = 32176, frequency = 0.0080, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
