-- ARKHER SYSTEM T.0108 :: Context Memory Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0108"
	S.key = "arkher.ai.contextmemory.utility_selection"
	S.name = "Context Memory Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.contextmemory.working_memory" }
	S.tags = { "t", "contextmemory", "utility", "ai" }
	S.description = "Context Memory Utility Selection: scored choice between competing courses of action for the Context Memory subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.contextmemory.utility_selection", momentum = 0.17 })
		inst.system = S
		inst.ctx = ctx
