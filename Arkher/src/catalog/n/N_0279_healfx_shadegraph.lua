-- ARKHER SYSTEM N.0279 :: Heal Effect Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0279"
	S.key = "arkher.vfx.healfx.effect_graph"
	S.name = "Heal Effect Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Heal Effect"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.healfx.curve_authoring" }
	S.tags = { "n", "healfx", "shadegraph", "vfx" }
	S.description = "Heal Effect Effect Graph: node graph describing how the effect is shaded for the Heal Effect subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.healfx.effect_graph" })
		inst.system = S
		inst.ctx = ctx
