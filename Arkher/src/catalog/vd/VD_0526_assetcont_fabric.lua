-- ARKHER SYSTEM VD.0526 :: Asset Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0526"
	S.key = "arkher.contsim.assetcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.assetcont.complexity_budget" }
	S.tags = { "vd", "assetcont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.assetcont.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
