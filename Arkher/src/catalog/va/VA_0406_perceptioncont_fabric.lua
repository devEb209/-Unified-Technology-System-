-- ARKHER SYSTEM VA.0406 :: Perception Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0406"
	S.key = "arkher.contworld.perceptioncont.simulation_fabric"
	S.name = "Perception Continuum Simulation Fabric"
	S.category = "VA"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.perceptioncont.complexity_budget" }
	S.tags = { "va", "perceptioncont", "fabric", "contworld" }
	S.description = "Perception Continuum Simulation Fabric: fabric stepping the continuum domains for the Perception Continuum subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.perceptioncont.simulation_fabric", budgetMs = 1.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
