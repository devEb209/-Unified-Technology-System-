-- ARKHER SYSTEM VA.0528 :: Asset Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0528"
	S.key = "arkher.contworld.assetcont.emergence_continuum"
	S.name = "Asset Continuum Emergence Continuum"
	S.category = "VA"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.assetcont.reality_continuum" }
	S.tags = { "va", "assetcont", "emergence", "contworld" }
	S.description = "Asset Continuum Emergence Continuum: emergence detection over the continuum for the Asset Continuum subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.assetcont.emergence_continuum", windowSize = 5, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
