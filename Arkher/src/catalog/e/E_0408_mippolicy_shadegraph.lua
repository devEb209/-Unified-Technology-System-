-- ARKHER SYSTEM E.0408 :: Mip Policy Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0408"
	S.key = "arkher.material.mippolicy.shading_graph"
	S.name = "Mip Policy Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Mip Policy"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.mippolicy.layer_composition" }
	S.tags = { "e", "mippolicy", "shadegraph", "material" }
	S.description = "Mip Policy Shading Graph: node graph evaluated and compiled to Luau for the Mip Policy subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.mippolicy.shading_graph" })
		inst.system = S
		inst.ctx = ctx
