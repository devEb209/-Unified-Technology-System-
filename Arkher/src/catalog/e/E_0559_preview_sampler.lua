-- ARKHER SYSTEM E.0559 :: Material Preview Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0559"
	S.key = "arkher.material.preview.texture_sampling"
	S.name = "Material Preview Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.preview.shading_graph" }
	S.tags = { "e", "preview", "sampler", "material" }
	S.description = "Material Preview Texture Sampling: atlas packing, mip chain and filtered sampling for the Material Preview subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.preview.texture_sampling", atlasSize = 192, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
