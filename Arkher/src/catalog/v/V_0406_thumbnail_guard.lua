-- ARKHER SYSTEM V.0406 :: Thumbnail Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0406"
	S.key = "arkher.asset.thumbnail.validation_guard"
	S.name = "Thumbnail Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.thumbnail.size_budget" }
	S.tags = { "v", "thumbnail", "guard", "asset" }
	S.description = "Thumbnail Validation Guard: rate limiting and capability checks on the import path for the Thumbnail subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.thumbnail.validation_guard", algorithm = "leaky", capacity = 148, refillPerSec = 13, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
