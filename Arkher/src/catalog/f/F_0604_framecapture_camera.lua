-- ARKHER SYSTEM F.0604 :: Frame Capture View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0604"
	S.key = "arkher.render.framecapture.view_and_culling"
	S.name = "Frame Capture View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framecapture.frame_graph" }
	S.tags = { "f", "framecapture", "camera", "render" }
	S.description = "Frame Capture View And Culling: view state, frustum culling and screen-size LOD for the Frame Capture subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.framecapture.view_and_culling", width = 828, height = 1260, fov = 1.0500, far = 1400 })
		inst.system = S
		inst.ctx = ctx
