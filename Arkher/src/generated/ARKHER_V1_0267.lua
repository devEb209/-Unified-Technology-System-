--!strict
-- OpenWeather — ANIMATION Mixer #0267
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="OpenWeather — ANIMATION Mixer #0267", size=Vector2.new(600, 460), pos=UDim2.fromOffset(371, 199), parent=parent, icon="⛰"})
