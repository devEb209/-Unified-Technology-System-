-- ARKHER SYSTEM K.0429 :: Pathfinding Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0429"
	S.key = "arkher.npc.pathfinding.navigation"
	S.name = "Pathfinding Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.pathfinding.goal_planner" }
	S.tags = { "k", "pathfinding", "navgraph", "npc" }
	S.description = "Pathfinding Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Pathfinding subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.pathfinding.navigation", width = 24, height = 24, cellSize = 2 })
		inst.system = S
		inst.ctx = ctx
