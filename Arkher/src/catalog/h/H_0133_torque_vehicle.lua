-- ARKHER SYSTEM H.0133 :: Torque Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0133"
	S.key = "arkher.physics.torque.vehicle"
	S.name = "Torque Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Torque"
	S.aspect = "Vehicle"
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.torque.character_motion" }
	S.tags = { "h", "torque", "vehicle", "physics" }
	S.description = "Torque Vehicle: suspension, drivetrain, steering and tire friction for the Torque subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.torque.vehicle", mass = 900, wheelbase = 3.20, track = 1.60, maxRpm = 6600 })
		inst.system = S
		inst.ctx = ctx
