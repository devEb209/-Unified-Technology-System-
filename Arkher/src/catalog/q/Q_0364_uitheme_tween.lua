-- ARKHER SYSTEM Q.0364 :: Theme Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0364"
	S.key = "arkher.ui.uitheme.transition"
	S.name = "Theme Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Theme"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uitheme.input_mapping" }
	S.tags = { "q", "uitheme", "tween", "ui" }
	S.description = "Theme Transition: eased, delayed, looped and sequenced motion for the Theme subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.uitheme.transition", timeScale = 1.12 })
		inst.system = S
		inst.ctx = ctx
