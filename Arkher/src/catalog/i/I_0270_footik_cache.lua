-- ARKHER SYSTEM I.0270 :: Foot Placement IK Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0270"
	S.key = "arkher.anim.footik.pose_cache"
	S.name = "Foot Placement IK Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.footik.playback_pipeline" }
	S.tags = { "i", "footik", "cache", "anim" }
	S.description = "Foot Placement IK Pose Cache: reuse of sampled poses across frames and instances for the Foot Placement IK subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.footik.pose_cache", policy = "lfu", capacity = 505, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
