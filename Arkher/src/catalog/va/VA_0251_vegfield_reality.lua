-- ARKHER SYSTEM VA.0251 :: Vegetation Field Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0251"
	S.key = "arkher.contworld.vegfield.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vegfield.simulation_fabric" }
	S.tags = { "va", "vegfield", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.vegfield.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
