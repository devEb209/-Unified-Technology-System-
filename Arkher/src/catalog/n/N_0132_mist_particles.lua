-- ARKHER SYSTEM N.0132 :: Waterfall Mist Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0132"
	S.key = "arkher.vfx.mist.particle_simulation"
	S.name = "Waterfall Mist Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.mist.emission" }
	S.tags = { "n", "mist", "particles", "vfx" }
	S.description = "Waterfall Mist Particle Simulation: pooled integration of position, velocity, colour and life for the Waterfall Mist subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.mist.particle_simulation", capacity = 384, drag = 0.21, bounce = 0.06, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
