-- ARKHER SYSTEM I.0269 :: Foot Placement IK Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0269"
	S.key = "arkher.anim.footik.playback_pipeline"
	S.name = "Foot Placement IK Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.footik.event_ledger" }
	S.tags = { "i", "footik", "pipeline", "anim" }
	S.description = "Foot Placement IK Playback Pipeline: ordered sample, blend, ik and output stages for the Foot Placement IK subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.footik.playback_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
