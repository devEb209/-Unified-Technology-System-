-- ARKHER SYSTEM R.0246 :: Area Of Interest Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0246"
	S.key = "arkher.net.areaofinterest.serialization_codec"
	S.name = "Area Of Interest Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.areaofinterest.bandwidth_budget" }
	S.tags = { "r", "areaofinterest", "codec", "net" }
	S.description = "Area Of Interest Serialization Codec: compact encoding, diffing and checksum of payloads for the Area Of Interest subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.areaofinterest.serialization_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
