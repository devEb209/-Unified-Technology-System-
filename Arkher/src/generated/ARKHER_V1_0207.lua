--!strict
-- Nuke Nodal — ANIMATION Mixer #0207
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Nuke Nodal — ANIMATION Mixer #0207", size=Vector2.new(600, 460), pos=UDim2.fromOffset(391, 219), parent=parent, icon="🛰"})
