-- ARKHER SYSTEM VC.0307 :: Weather Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0307"
	S.key = "arkher.contneural.weathercont.neural_field"
	S.name = "Weather Continuum Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.weathercont.coherence_guard" }
	S.tags = { "vc", "weathercont", "neuralfield", "contneural" }
	S.description = "Weather Continuum Neural Field: neural field encoding and reconstruction for the Weather Continuum subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.weathercont.neural_field", dims = 12, hidden = 8, seed = 80804 })
		inst.system = S
		inst.ctx = ctx
