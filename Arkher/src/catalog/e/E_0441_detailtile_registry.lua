-- ARKHER SYSTEM E.0441 :: Detail Tiling Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0441"
	S.key = "arkher.material.detailtile.variant_registry"
	S.name = "Detail Tiling Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.detailtile.procedural_detail" }
	S.tags = { "e", "detailtile", "registry", "material" }
	S.description = "Detail Tiling Variant Registry: named variants and their lifecycle for the Detail Tiling subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.detailtile.variant_registry" })
		inst.system = S
		inst.ctx = ctx
