-- ARKHER SYSTEM E.0567 :: Material Preview Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0567"
	S.key = "arkher.material.preview.analysis"
	S.name = "Material Preview Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.preview.instance_cache" }
	S.tags = { "e", "preview", "analyzer", "material" }
	S.description = "Material Preview Analysis: cost, redundancy and outlier analysis for the Material Preview subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.preview.analysis", window = 66, buckets = 18, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
