-- ARKHER SYSTEM O.0112 :: Ambience Bed Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0112"
	S.key = "arkher.audio.ambiencebed.music_sequencer"
	S.name = "Ambience Bed Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Ambience Bed"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.ambiencebed.spatialization" }
	S.tags = { "o", "ambiencebed", "sequencer", "audio" }
	S.description = "Ambience Bed Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Ambience Bed subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.ambiencebed.music_sequencer", bpm = 90, beatsPerBar = 4, intensity = 0.38 })
		inst.system = S
		inst.ctx = ctx
