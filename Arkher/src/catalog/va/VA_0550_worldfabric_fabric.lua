-- ARKHER SYSTEM VA.0550 :: World Fabric Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0550"
	S.key = "arkher.contworld.worldfabric.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldfabric.complexity_budget" }
	S.tags = { "va", "worldfabric", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.worldfabric.simulation_fabric", budgetMs = 4.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
