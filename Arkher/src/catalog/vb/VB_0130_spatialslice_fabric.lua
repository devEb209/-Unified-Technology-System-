-- ARKHER SYSTEM VB.0130 :: Spatial Slice Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0130"
	S.key = "arkher.conttime.spatialslice.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.spatialslice.complexity_budget" }
	S.tags = { "vb", "spatialslice", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.spatialslice.simulation_fabric", budgetMs = 3.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
