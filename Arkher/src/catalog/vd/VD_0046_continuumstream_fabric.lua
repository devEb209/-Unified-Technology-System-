-- ARKHER SYSTEM VD.0046 :: Continuum Stream Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0046"
	S.key = "arkher.contsim.continuumstream.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.continuumstream.complexity_budget" }
	S.tags = { "vd", "continuumstream", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.continuumstream.simulation_fabric", budgetMs = 1.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
