-- ARKHER SYSTEM Z.0977 :: Generation Migration Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0977"
	S.key = "arkher.origin.generationmigration.behaviour_analysis"
	S.name = "Generation Migration Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.governance_policy" }
	S.tags = { "z", "generationmigration", "analyzer", "origin" }
	S.description = "Generation Migration Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.generationmigration.behaviour_analysis", window = 171, buckets = 19, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
