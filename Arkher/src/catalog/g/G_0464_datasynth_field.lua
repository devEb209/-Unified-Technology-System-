-- ARKHER SYSTEM G.0464 :: Training Data Synthesis Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0464"
	S.key = "arkher.neural.datasynth.feature_extraction"
	S.name = "Training Data Synthesis Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.datasynth.inference_core" }
	S.tags = { "g", "datasynth", "field", "neural" }
	S.description = "Training Data Synthesis Feature Extraction: signal features feeding the model for the Training Data Synthesis subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.datasynth.feature_extraction", seed = 43379, frequency = 0.0088, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
