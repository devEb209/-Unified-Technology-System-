-- ARKHER SYSTEM E.0125 :: Emissive Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0125"
	S.key = "arkher.material.emissive.procedural_detail"
	S.name = "Emissive Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Emissive"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.emissive.texture_sampling" }
	S.tags = { "e", "emissive", "field", "material" }
	S.description = "Emissive Procedural Detail: coherent noise detail driving the surface for the Emissive subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.emissive.procedural_detail", seed = 48294, frequency = 0.0075, octaves = 5, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
