-- ARKHER SYSTEM T.0640 :: Confidence Estimation Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0640"
	S.key = "arkher.ai.confidence.utility_selection"
	S.name = "Confidence Estimation Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.confidence.working_memory" }
	S.tags = { "t", "confidence", "utility", "ai" }
	S.description = "Confidence Estimation Utility Selection: scored choice between competing courses of action for the Confidence Estimation subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.confidence.utility_selection", momentum = 0.17 })
		inst.system = S
		inst.ctx = ctx
