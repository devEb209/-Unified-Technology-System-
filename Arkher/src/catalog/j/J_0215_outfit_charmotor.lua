-- ARKHER SYSTEM J.0215 :: Outfit Composition Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0215"
	S.key = "arkher.character.outfit.locomotion"
	S.name = "Outfit Composition Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.outfit.physical_response" }
	S.tags = { "j", "outfit", "charmotor", "character" }
	S.description = "Outfit Composition Locomotion: capsule locomotion driving the character for the Outfit Composition subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.outfit.locomotion", radius = 0.54, height = 1.99, maxSpeed = 7.90, jumpHeight = 1.50, stepOffset = 0.34 })
		inst.system = S
		inst.ctx = ctx
