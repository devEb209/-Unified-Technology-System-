-- ARKHER SYSTEM F.0253 :: Exposure Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0253"
	S.key = "arkher.render.exposure.frame_graph"
	S.name = "Exposure Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Exposure"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "exposure", "framegraph", "render" }
	S.description = "Exposure Frame Graph: declared passes, culling, ordering and aliasing for the Exposure subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.exposure.frame_graph", budgetMs = 6.00 })
		inst.system = S
		inst.ctx = ctx
