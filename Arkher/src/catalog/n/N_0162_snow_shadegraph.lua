-- ARKHER SYSTEM N.0162 :: Snow Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0162"
	S.key = "arkher.vfx.snow.effect_graph"
	S.name = "Snow Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Snow"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.snow.curve_authoring" }
	S.tags = { "n", "snow", "shadegraph", "vfx" }
	S.description = "Snow Effect Graph: node graph describing how the effect is shaded for the Snow subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.snow.effect_graph" })
		inst.system = S
		inst.ctx = ctx
