-- ARKHER SYSTEM VC.0318 :: Ecology Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0318"
	S.key = "arkher.contneural.ecologycont.coherence_guard"
	S.name = "Ecology Continuum Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.ecologycont.persistent_state" }
	S.tags = { "vc", "ecologycont", "coherence", "contneural" }
	S.description = "Ecology Continuum Coherence Guard: seam coherence and drift supervision for the Ecology Continuum subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.ecologycont.coherence_guard", window = 49, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
