-- ARKHER SYSTEM T.0570 :: Pipeline Automation Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0570"
	S.key = "arkher.ai.pipelineautomation.utility_selection"
	S.name = "Pipeline Automation Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.pipelineautomation.working_memory" }
	S.tags = { "t", "pipelineautomation", "utility", "ai" }
	S.description = "Pipeline Automation Utility Selection: scored choice between competing courses of action for the Pipeline Automation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.pipelineautomation.utility_selection", momentum = 0.04 })
		inst.system = S
		inst.ctx = ctx
