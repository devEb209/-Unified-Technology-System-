-- ARKHER SYSTEM H.0152 :: Linear Damping Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0152"
	S.key = "arkher.physics.lineardamping.analysis"
	S.name = "Linear Damping Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.lineardamping.result_cache" }
	S.tags = { "h", "lineardamping", "analyzer", "physics" }
	S.description = "Linear Damping Analysis: energy, jitter and cost analysis of the simulation for the Linear Damping subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.lineardamping.analysis", window = 236, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
