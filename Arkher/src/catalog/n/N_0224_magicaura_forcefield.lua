-- ARKHER SYSTEM N.0224 :: Magic Aura Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0224"
	S.key = "arkher.vfx.magicaura.force_field"
	S.name = "Magic Aura Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Magic Aura"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.magicaura.particle_simulation" }
	S.tags = { "n", "magicaura", "forcefield", "vfx" }
	S.description = "Magic Aura Force Field: wind, attraction, vortex, drag and curl turbulence for the Magic Aura subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.magicaura.force_field", seed = 28256 })
		inst.system = S
		inst.ctx = ctx
