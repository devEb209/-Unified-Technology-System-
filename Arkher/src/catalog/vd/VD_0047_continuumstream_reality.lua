-- ARKHER SYSTEM VD.0047 :: Continuum Stream Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0047"
	S.key = "arkher.contsim.continuumstream.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.continuumstream.simulation_fabric" }
	S.tags = { "vd", "continuumstream", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.continuumstream.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
