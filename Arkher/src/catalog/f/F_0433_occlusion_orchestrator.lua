-- ARKHER SYSTEM F.0433 :: Occlusion Culling Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0433"
	S.key = "arkher.render.occlusion.orchestration"
	S.name = "Occlusion Culling Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.occlusion.frame_analysis" }
	S.tags = { "f", "occlusion", "orchestrator", "render" }
	S.description = "Occlusion Culling Orchestration: frame lifecycle orchestration for the Occlusion Culling subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.occlusion.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
