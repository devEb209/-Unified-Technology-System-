-- ARKHER SYSTEM G.0100 :: Adaptive Sharpening Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0100"
	S.key = "arkher.neural.adaptivesharpen.feature_extraction"
	S.name = "Adaptive Sharpening Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.adaptivesharpen.inference_core" }
	S.tags = { "g", "adaptivesharpen", "field", "neural" }
	S.description = "Adaptive Sharpening Feature Extraction: signal features feeding the model for the Adaptive Sharpening subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.adaptivesharpen.feature_extraction", seed = 78417, frequency = 0.0083, octaves = 4, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
