-- ARKHER SYSTEM I.0319 :: Spine Bend Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0319"
	S.key = "arkher.anim.spinebend.compression_codec"
	S.name = "Spine Bend Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Spine Bend"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.spinebend.retarget_graph" }
	S.tags = { "i", "spinebend", "codec", "anim" }
	S.description = "Spine Bend Compression Codec: curve compression and quantized transport for the Spine Bend subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.spinebend.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
