-- ARKHER SYSTEM Z.0390 :: Thermal Aware Simulation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0390"
	S.key = "arkher.origin.thermalaware.self_critique"
	S.name = "Thermal Aware Simulation Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.intent_bridge" }
	S.tags = { "z", "thermalaware", "critic", "origin" }
	S.description = "Thermal Aware Simulation Self Critique: weighted judgement of the technology's own output for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.thermalaware.self_critique", passMark = 0.76, reviseMark = 0.41, seed = 24981 })
		inst.system = S
		inst.ctx = ctx
