-- ARKHER SYSTEM N.0105 :: Blood Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0105"
	S.key = "arkher.vfx.blood.emission"
	S.name = "Blood Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Blood"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "blood", "emitter", "vfx" }
	S.description = "Blood Emission: shaped, rate and burst emission of new particles for the Blood subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.blood.emission", shape = "point", rate = 47, speed = 3.70, life = 3.50, budget = 576, seed = 51087 })
		inst.system = S
		inst.ctx = ctx
