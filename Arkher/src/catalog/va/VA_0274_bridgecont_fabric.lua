-- ARKHER SYSTEM VA.0274 :: Bridge Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0274"
	S.key = "arkher.contworld.bridgecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.bridgecont.complexity_budget" }
	S.tags = { "va", "bridgecont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.bridgecont.simulation_fabric", budgetMs = 4.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
