-- ARKHER SYSTEM L.0027 :: Region Fidelity Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0027"
	S.key = "arkher.sim.regionfidelity.aggregate_cache"
	S.name = "Region Fidelity Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.regionfidelity.fidelity_policy" }
	S.tags = { "l", "regionfidelity", "cache", "sim" }
	S.description = "Region Fidelity Aggregate Cache: reuse of expensive aggregate computations for the Region Fidelity subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.regionfidelity.aggregate_cache", policy = "ttl", capacity = 435, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
