-- ARKHER SYSTEM W.0251 :: Dissolve Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0251"
	S.key = "arkher.cine.dissolve.sequence_analysis"
	S.name = "Dissolve Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dissolve"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dissolve.frame_budget" }
	S.tags = { "w", "dissolve", "analyzer", "cine" }
	S.description = "Dissolve Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Dissolve subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.dissolve.sequence_analysis", window = 208, buckets = 8, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
