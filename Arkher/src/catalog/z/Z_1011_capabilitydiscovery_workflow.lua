-- ARKHER SYSTEM Z.1011 :: Capability Discovery Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.1011"
	S.key = "arkher.origin.capabilitydiscovery.adaptive_workflow"
	S.name = "Capability Discovery Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.self_critique" }
	S.tags = { "z", "capabilitydiscovery", "workflow", "origin" }
	S.description = "Capability Discovery Adaptive Workflow: verified, retryable, reversible execution plans for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.capabilitydiscovery.adaptive_workflow", maxRetries = 1, budget = 100 })
		inst.system = S
		inst.ctx = ctx
