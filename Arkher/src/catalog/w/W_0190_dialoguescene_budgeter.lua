-- ARKHER SYSTEM W.0190 :: Dialogue Scene Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0190"
	S.key = "arkher.cine.dialoguescene.frame_budget"
	S.name = "Dialogue Scene Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dialoguescene.event_ledger" }
	S.tags = { "w", "dialoguescene", "budgeter", "cine" }
	S.description = "Dialogue Scene Frame Budget: per-frame cost budget for the cinematic systems for the Dialogue Scene subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.dialoguescene.frame_budget", total = 74, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
