-- ARKHER SYSTEM Q.0199 :: Minimap Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0199"
	S.key = "arkher.ui.minimap.localization_registry"
	S.name = "Minimap Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Minimap"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.minimap.theme_composition" }
	S.tags = { "q", "minimap", "registry", "ui" }
	S.description = "Minimap Localization Registry: catalogue of strings, plurals and locale metadata for the Minimap subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.minimap.localization_registry" })
		inst.system = S
		inst.ctx = ctx
