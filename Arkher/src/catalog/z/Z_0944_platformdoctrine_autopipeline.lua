-- ARKHER SYSTEM Z.0944 :: Platform Abstraction Doctrine Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0944"
	S.key = "arkher.origin.platformdoctrine.autonomous_pipeline"
	S.name = "Platform Abstraction Doctrine Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.platformdoctrine.simulation_fabric" }
	S.tags = { "z", "platformdoctrine", "autopipeline", "origin" }
	S.description = "Platform Abstraction Doctrine Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Platform Abstraction Doctrine subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.platformdoctrine.autonomous_pipeline", maxIterations = 10 })
		inst.system = S
		inst.ctx = ctx
