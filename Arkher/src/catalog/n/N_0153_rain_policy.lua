-- ARKHER SYSTEM N.0153 :: Rain Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0153"
	S.key = "arkher.vfx.rain.quality_policy"
	S.name = "Rain Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Rain"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.rain.result_cache" }
	S.tags = { "n", "rain", "policy", "vfx" }
	S.description = "Rain Quality Policy: distance and device driven fidelity bands for the Rain subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.rain.quality_policy", algorithm = "roundrobin", starvationGuard = 48 })
		inst.system = S
		inst.ctx = ctx
