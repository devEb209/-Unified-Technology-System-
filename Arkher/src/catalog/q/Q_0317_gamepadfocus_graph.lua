-- ARKHER SYSTEM Q.0317 :: Gamepad Focus Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0317"
	S.key = "arkher.ui.gamepadfocus.navigation_graph"
	S.name = "Gamepad Focus Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.gamepadfocus.transition" }
	S.tags = { "q", "gamepadfocus", "graph", "ui" }
	S.description = "Gamepad Focus Navigation Graph: screens, routes and shortest path between them for the Gamepad Focus subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.gamepadfocus.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
