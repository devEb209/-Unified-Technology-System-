-- ARKHER SYSTEM W.0162 :: Cutscene Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0162"
	S.key = "arkher.cine.cutscene.playback_orchestrator"
	S.name = "Cutscene Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Cutscene"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cutscene.cut_policy" }
	S.tags = { "w", "cutscene", "orchestrator", "cine" }
	S.description = "Cutscene Playback Orchestrator: the state machine that drives a cinematic from start to end for the Cutscene subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.cutscene.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
