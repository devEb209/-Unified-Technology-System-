-- ARKHER SYSTEM Q.0352 :: Responsive Breakpoint Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0352"
	S.key = "arkher.ui.breakpoint.transition"
	S.name = "Responsive Breakpoint Transition"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.breakpoint.input_mapping" }
	S.tags = { "q", "breakpoint", "tween", "ui" }
	S.description = "Responsive Breakpoint Transition: eased, delayed, looped and sequenced motion for the Responsive Breakpoint subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.breakpoint.transition", timeScale = 1.09 })
		inst.system = S
		inst.ctx = ctx
