-- ARKHER SYSTEM VC.0428 :: Navigation Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0428"
	S.key = "arkher.contneural.navcont.world_memory_stream"
	S.name = "Navigation Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.navcont.neural_field" }
	S.tags = { "vc", "navcont", "worldmemory", "contneural" }
	S.description = "Navigation Continuum World Memory Stream: world memory continuum over epochs for the Navigation Continuum subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.navcont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
