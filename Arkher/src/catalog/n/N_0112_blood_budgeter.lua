-- ARKHER SYSTEM N.0112 :: Blood Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0112"
	S.key = "arkher.vfx.blood.spawn_budget"
	S.name = "Blood Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Blood"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.blood.effect_composition" }
	S.tags = { "n", "blood", "budgeter", "vfx" }
	S.description = "Blood Spawn Budget: global particle budget shared by every live effect for the Blood subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.blood.spawn_budget", total = 445, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
