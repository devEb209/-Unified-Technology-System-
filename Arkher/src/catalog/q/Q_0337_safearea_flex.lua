-- ARKHER SYSTEM Q.0337 :: Safe Area Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0337"
	S.key = "arkher.ui.safearea.responsive_layout"
	S.name = "Safe Area Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Safe Area"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "safearea", "flex", "ui" }
	S.description = "Safe Area Responsive Layout: flex solving with safe areas, weights and breakpoints for the Safe Area subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.safearea.responsive_layout", width = 510, height = 904, scale = 1.11 })
		inst.system = S
		inst.ctx = ctx
