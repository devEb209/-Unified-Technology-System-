-- ARKHER SYSTEM VB.0586 :: Thermal Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0586"
	S.key = "arkher.conttime.thermalcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.thermalcont.complexity_budget" }
	S.tags = { "vb", "thermalcont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.thermalcont.simulation_fabric", budgetMs = 2.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
