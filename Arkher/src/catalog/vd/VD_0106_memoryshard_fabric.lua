-- ARKHER SYSTEM VD.0106 :: Memory Shard Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0106"
	S.key = "arkher.contsim.memoryshard.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memoryshard.complexity_budget" }
	S.tags = { "vd", "memoryshard", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.memoryshard.simulation_fabric", budgetMs = 3.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
