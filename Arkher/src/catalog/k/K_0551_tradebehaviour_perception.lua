-- ARKHER SYSTEM K.0551 :: Trade Behaviour Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0551"
	S.key = "arkher.npc.tradebehaviour.perception"
	S.name = "Trade Behaviour Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.tradebehaviour.emotion" }
	S.tags = { "k", "tradebehaviour", "perception", "npc" }
	S.description = "Trade Behaviour Perception: sight, hearing and bounded attention for the Trade Behaviour subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.tradebehaviour.perception", sightRange = 25, hearingRange = 20, attentionSlots = 3, fov = 1.920 })
		inst.system = S
		inst.ctx = ctx
