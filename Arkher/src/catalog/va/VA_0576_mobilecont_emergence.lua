-- ARKHER SYSTEM VA.0576 :: Mobile Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0576"
	S.key = "arkher.contworld.mobilecont.emergence_continuum"
	S.name = "Mobile Continuum Emergence Continuum"
	S.category = "VA"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.mobilecont.reality_continuum" }
	S.tags = { "va", "mobilecont", "emergence", "contworld" }
	S.description = "Mobile Continuum Emergence Continuum: emergence detection over the continuum for the Mobile Continuum subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.mobilecont.emergence_continuum", windowSize = 6, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
