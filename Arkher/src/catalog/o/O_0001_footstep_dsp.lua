-- ARKHER SYSTEM O.0001 :: Footstep DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0001"
	S.key = "arkher.audio.footstep.dsp_chain"
	S.name = "Footstep DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Footstep"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "footstep", "dsp", "audio" }
	S.description = "Footstep DSP Chain: biquad filtering, delay, envelope and soft clipping for the Footstep subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.footstep.dsp_chain", sampleRate = 22050, filter = "highpass", cutoff = 5400, q = 0.670 })
		inst.system = S
		inst.ctx = ctx
