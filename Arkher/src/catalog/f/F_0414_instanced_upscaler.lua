-- ARKHER SYSTEM F.0414 :: Instanced Draw Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0414"
	S.key = "arkher.render.instanced.adaptive_resolution"
	S.name = "Instanced Draw Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.instanced.temporal_resolve" }
	S.tags = { "f", "instanced", "upscaler", "render" }
	S.description = "Instanced Draw Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Instanced Draw subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.instanced.adaptive_resolution", targetMs = 14.10, index = 3, sharpness = 0.35 })
		inst.system = S
		inst.ctx = ctx
