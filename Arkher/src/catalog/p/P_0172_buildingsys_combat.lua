-- ARKHER SYSTEM P.0172 :: Building Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0172"
	S.key = "arkher.play.buildingsys.combat_resolution"
	S.name = "Building Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Building"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.buildingsys.objectives" }
	S.tags = { "p", "buildingsys", "combat", "play" }
	S.description = "Building Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Building subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.buildingsys.combat_resolution", seed = 277, armourK = 130, critMultiplier = 1.60 })
		inst.system = S
		inst.ctx = ctx
