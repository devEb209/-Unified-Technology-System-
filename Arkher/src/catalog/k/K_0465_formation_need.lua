-- ARKHER SYSTEM K.0465 :: Formation Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0465"
	S.key = "arkher.npc.formation.drive_system"
	S.name = "Formation Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.formation.memory" }
	S.tags = { "k", "formation", "need", "npc" }
	S.description = "Formation Drive System: drives that decay, turn urgent and get satisfied for the Formation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.formation.drive_system" })
		inst.system = S
		inst.ctx = ctx
