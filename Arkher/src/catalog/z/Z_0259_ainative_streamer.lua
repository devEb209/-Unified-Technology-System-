-- ARKHER SYSTEM Z.0259 :: AI Native Engine Architecture Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0259"
	S.key = "arkher.origin.ainative.residency_streaming"
	S.name = "AI Native Engine Architecture Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.ainative.budget_governor" }
	S.tags = { "z", "ainative", "streamer", "origin" }
	S.description = "AI Native Engine Architecture Residency Streaming: distance-driven residency of the technology's workload for the AI Native Engine Architecture subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.ainative.residency_streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
