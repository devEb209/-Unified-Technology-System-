-- ARKHER SYSTEM VC.0400 :: Perception Continuum Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VC.0400"
	S.key = "arkher.contneural.perceptioncont.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.perceptioncont.sparse_residency" }
	S.tags = { "vc", "perceptioncont", "multiscale", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contneural.perceptioncont.multi-scale_fidelity", levels = 4, baseTriangles = 120000 })
		inst.system = S
		inst.ctx = ctx
