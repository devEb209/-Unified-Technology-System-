-- ARKHER SYSTEM VD.0217 :: Terrain Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0217"
	S.key = "arkher.contsim.terraincont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "terraincont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.terraincont.infinite_grid", cellSize = 128, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
