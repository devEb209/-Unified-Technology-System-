-- ARKHER SYSTEM Z.1000 :: Engine Self Model Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.1000"
	S.key = "arkher.origin.engineselfmodel.orchestration"
	S.name = "Engine Self Model Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.engineselfmodel.residency_streaming" }
	S.tags = { "z", "engineselfmodel", "orchestrator", "origin" }
	S.description = "Engine Self Model Orchestration: lifecycle and phase orchestration of the technology for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.engineselfmodel.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
