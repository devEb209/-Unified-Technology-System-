-- ARKHER SYSTEM V.0284 :: Impostor Asset Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0284"
	S.key = "arkher.asset.impostorasset.compression_codec"
	S.name = "Impostor Asset Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.impostorasset.streaming_residency" }
	S.tags = { "v", "impostorasset", "codec", "asset" }
	S.description = "Impostor Asset Compression Codec: compact encoding, diffing and checksum of asset payloads for the Impostor Asset subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.impostorasset.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
