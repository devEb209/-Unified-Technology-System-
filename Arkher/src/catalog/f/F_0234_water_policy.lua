-- ARKHER SYSTEM F.0234 :: Water Rendering Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0234"
	S.key = "arkher.render.water.render_policy"
	S.name = "Water Rendering Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.water.draw_budget" }
	S.tags = { "f", "water", "policy", "render" }
	S.description = "Water Rendering Render Policy: device tier rules for the frame for the Water Rendering subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.water.render_policy", algorithm = "edf", starvationGuard = 45 })
		inst.system = S
		inst.ctx = ctx
