--!strict
-- Gaea Nodes — ANIMATION Node_Flow #0091
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Gaea Nodes — ANIMATION Node_Flow #0091", size=Vector2.new(640, 440), pos=UDim2.fromOffset(483, 327), parent=parent, icon="●"})
