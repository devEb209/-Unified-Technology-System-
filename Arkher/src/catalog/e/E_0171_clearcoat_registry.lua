-- ARKHER SYSTEM E.0171 :: Clear Coat Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0171"
	S.key = "arkher.material.clearcoat.variant_registry"
	S.name = "Clear Coat Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Clear Coat"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.clearcoat.procedural_detail" }
	S.tags = { "e", "clearcoat", "registry", "material" }
	S.description = "Clear Coat Variant Registry: named variants and their lifecycle for the Clear Coat subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.clearcoat.variant_registry" })
		inst.system = S
		inst.ctx = ctx
