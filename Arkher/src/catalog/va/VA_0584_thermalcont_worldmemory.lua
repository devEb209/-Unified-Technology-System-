-- ARKHER SYSTEM VA.0584 :: Thermal Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0584"
	S.key = "arkher.contworld.thermalcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.thermalcont.neural_field" }
	S.tags = { "va", "thermalcont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.thermalcont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
