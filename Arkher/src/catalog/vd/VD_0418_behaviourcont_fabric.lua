-- ARKHER SYSTEM VD.0418 :: Behaviour Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0418"
	S.key = "arkher.contsim.behaviourcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.behaviourcont.complexity_budget" }
	S.tags = { "vd", "behaviourcont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.behaviourcont.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
