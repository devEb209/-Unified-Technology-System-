-- ARKHER SYSTEM VC.0298 :: Climate Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0298"
	S.key = "arkher.contneural.climatecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.climatecont.complexity_budget" }
	S.tags = { "vc", "climatecont", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.climatecont.simulation_fabric", budgetMs = 2.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
