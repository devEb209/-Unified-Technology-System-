-- ARKHER SYSTEM F.0027 :: Depth Prepass Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0027"
	S.key = "arkher.render.depthprepass.orchestration"
	S.name = "Depth Prepass Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.depthprepass.frame_analysis" }
	S.tags = { "f", "depthprepass", "orchestrator", "render" }
	S.description = "Depth Prepass Orchestration: frame lifecycle orchestration for the Depth Prepass subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.depthprepass.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
