-- ARKHER SYSTEM R.0126 :: Reliable Channel Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0126"
	S.key = "arkher.net.reliablechannel.serialization_codec"
	S.name = "Reliable Channel Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reliablechannel.bandwidth_budget" }
	S.tags = { "r", "reliablechannel", "codec", "net" }
	S.description = "Reliable Channel Serialization Codec: compact encoding, diffing and checksum of payloads for the Reliable Channel subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.reliablechannel.serialization_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
