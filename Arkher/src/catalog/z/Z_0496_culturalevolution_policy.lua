-- ARKHER SYSTEM Z.0496 :: Cultural Evolution Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0496"
	S.key = "arkher.origin.culturalevolution.governance_policy"
	S.name = "Cultural Evolution Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.signal_composition" }
	S.tags = { "z", "culturalevolution", "policy", "origin" }
	S.description = "Cultural Evolution Governance Policy: ordered rules governing when the technology may act for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.culturalevolution.governance_policy", algorithm = "edf", starvationGuard = 45 })
		inst.system = S
		inst.ctx = ctx
