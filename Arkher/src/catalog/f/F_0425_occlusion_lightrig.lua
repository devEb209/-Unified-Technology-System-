-- ARKHER SYSTEM F.0425 :: Occlusion Culling Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0425"
	S.key = "arkher.render.occlusion.lighting_rig"
	S.name = "Occlusion Culling Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.occlusion.geometry_virtualization" }
	S.tags = { "f", "occlusion", "lightrig", "render" }
	S.description = "Occlusion Culling Lighting Rig: light clustering, importance and cascades for the Occlusion Culling subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.occlusion.lighting_rig", maxActive = 10 })
		inst.system = S
		inst.ctx = ctx
