-- ARKHER SYSTEM I.0022 :: Bone Hierarchy Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0022"
	S.key = "arkher.anim.bonehierarchy.playback_pipeline"
	S.name = "Bone Hierarchy Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.bonehierarchy.event_ledger" }
	S.tags = { "i", "bonehierarchy", "pipeline", "anim" }
	S.description = "Bone Hierarchy Playback Pipeline: ordered sample, blend, ik and output stages for the Bone Hierarchy subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.bonehierarchy.playback_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
