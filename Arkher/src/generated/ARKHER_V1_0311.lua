--!strict
-- Cinema4D — ANIMATION Node_Flow #0311
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Cinema4D — ANIMATION Node_Flow #0311", size=Vector2.new(680, 440), pos=UDim2.fromOffset(143, 167), parent=parent, icon="◆"})
