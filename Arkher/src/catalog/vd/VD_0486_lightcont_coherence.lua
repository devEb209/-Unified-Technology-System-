-- ARKHER SYSTEM VD.0486 :: Lighting Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0486"
	S.key = "arkher.contsim.lightcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lightcont.persistent_state" }
	S.tags = { "vd", "lightcont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.lightcont.coherence_guard", window = 49, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
