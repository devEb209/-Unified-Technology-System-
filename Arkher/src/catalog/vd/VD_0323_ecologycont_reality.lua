-- ARKHER SYSTEM VD.0323 :: Ecology Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0323"
	S.key = "arkher.contsim.ecologycont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.ecologycont.simulation_fabric" }
	S.tags = { "vd", "ecologycont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.ecologycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
