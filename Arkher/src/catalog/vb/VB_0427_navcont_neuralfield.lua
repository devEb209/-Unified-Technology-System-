-- ARKHER SYSTEM VB.0427 :: Navigation Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0427"
	S.key = "arkher.conttime.navcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.navcont.coherence_guard" }
	S.tags = { "vb", "navcont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.navcont.neural_field", dims = 24, hidden = 20, seed = 44847 })
		inst.system = S
		inst.ctx = ctx
