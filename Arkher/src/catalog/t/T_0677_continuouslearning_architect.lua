-- ARKHER SYSTEM T.0677 :: Continuous Learning World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0677"
	S.key = "arkher.ai.continuouslearning.world_architect"
	S.name = "Continuous Learning World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.continuouslearning.self_critique" }
	S.tags = { "t", "continuouslearning", "architect", "ai" }
	S.description = "Continuous Learning World Architect: composition of a whole world plan with conserved budgets for the Continuous Learning subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.continuouslearning.world_architect", budget = 800, seed = 8312 })
		inst.system = S
		inst.ctx = ctx
