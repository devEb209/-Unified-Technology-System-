--!strict
-- NASA SRTM — ANIMATION Stack #0025
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="NASA SRTM — ANIMATION Stack #0025", size=Vector2.new(640, 420), pos=UDim2.fromOffset(425, 245), parent=parent, icon="●"})
