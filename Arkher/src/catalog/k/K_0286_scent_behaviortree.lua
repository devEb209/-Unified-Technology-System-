-- ARKHER SYSTEM K.0286 :: Scent Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0286"
	S.key = "arkher.npc.scent.reactive_behaviour"
	S.name = "Scent Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.scent.perception" }
	S.tags = { "k", "scent", "behaviortree", "npc" }
	S.description = "Scent Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Scent subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.scent.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
