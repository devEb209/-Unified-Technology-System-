-- ARKHER SYSTEM E.0019 :: Surface Definition Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0019"
	S.key = "arkher.material.surfacedef.texture_sampling"
	S.name = "Surface Definition Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.surfacedef.shading_graph" }
	S.tags = { "e", "surfacedef", "sampler", "material" }
	S.description = "Surface Definition Texture Sampling: atlas packing, mip chain and filtered sampling for the Surface Definition subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.surfacedef.texture_sampling", atlasSize = 128, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
