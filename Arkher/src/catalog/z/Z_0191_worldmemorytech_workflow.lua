-- ARKHER SYSTEM Z.0191 :: World Memory Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0191"
	S.key = "arkher.origin.worldmemorytech.adaptive_workflow"
	S.name = "World Memory Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldmemorytech.self_critique" }
	S.tags = { "z", "worldmemorytech", "workflow", "origin" }
	S.description = "World Memory Adaptive Workflow: verified, retryable, reversible execution plans for the World Memory subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.worldmemorytech.adaptive_workflow", maxRetries = 1, budget = 40 })
		inst.system = S
		inst.ctx = ctx
