--!strict
-- Maya Shelf — CORE Node_Flow #0116
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Maya Shelf — CORE Node_Flow #0116", size=Vector2.new(680, 440), pos=UDim2.fromOffset(408, 232), parent=parent, icon="⚑"})
