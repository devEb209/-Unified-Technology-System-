-- ARKHER SYSTEM VA.0320 :: Ecology Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0320"
	S.key = "arkher.contworld.ecologycont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.ecologycont.neural_field" }
	S.tags = { "va", "ecologycont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.ecologycont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
