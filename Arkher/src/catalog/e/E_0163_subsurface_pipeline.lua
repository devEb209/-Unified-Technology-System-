-- ARKHER SYSTEM E.0163 :: Subsurface Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0163"
	S.key = "arkher.material.subsurface.authoring_pipeline"
	S.name = "Subsurface Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Subsurface"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.subsurface.analysis" }
	S.tags = { "e", "subsurface", "pipeline", "material" }
	S.description = "Subsurface Authoring Pipeline: ordered authoring and bake stages for the Subsurface subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.subsurface.authoring_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
