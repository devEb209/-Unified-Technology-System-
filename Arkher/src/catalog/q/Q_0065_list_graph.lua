-- ARKHER SYSTEM Q.0065 :: List Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0065"
	S.key = "arkher.ui.list.navigation_graph"
	S.name = "List Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "List"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.list.transition" }
	S.tags = { "q", "list", "graph", "ui" }
	S.description = "List Navigation Graph: screens, routes and shortest path between them for the List subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.list.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
