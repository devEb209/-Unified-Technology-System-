-- ARKHER SYSTEM F.0022 :: Depth Prepass Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0022"
	S.key = "arkher.render.depthprepass.adaptive_resolution"
	S.name = "Depth Prepass Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.depthprepass.temporal_resolve" }
	S.tags = { "f", "depthprepass", "upscaler", "render" }
	S.description = "Depth Prepass Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Depth Prepass subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.depthprepass.adaptive_resolution", targetMs = 12.10, index = 4, sharpness = 0.23 })
		inst.system = S
		inst.ctx = ctx
