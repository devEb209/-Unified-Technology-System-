-- ARKHER SYSTEM N.0030 :: Fire Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0030"
	S.key = "arkher.vfx.fire.ribbon_and_trail"
	S.name = "Fire Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fire"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fire.force_field" }
	S.tags = { "n", "fire", "ribbon", "vfx" }
	S.description = "Fire Ribbon And Trail: trail points, tapering, beams and decimation for the Fire subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.fire.ribbon_and_trail", maxPoints = 48, lifetime = 2.30, minDistance = 0.50, width = 1.20 })
		inst.system = S
		inst.ctx = ctx
