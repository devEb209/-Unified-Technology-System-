-- ARKHER SYSTEM P.0014 :: Attribute Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0014"
	S.key = "arkher.play.attribute.inventory"
	S.name = "Attribute Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Attribute"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.attribute.attributes" }
	S.tags = { "p", "attribute", "inventory", "play" }
	S.description = "Attribute Inventory: slots, stacking, weight, equipment and crafting for the Attribute subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.attribute.inventory", slots = 28, maxWeight = 120 })
		inst.system = S
		inst.ctx = ctx
