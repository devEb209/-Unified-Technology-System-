-- ARKHER SYSTEM N.0011 :: Spark Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0011"
	S.key = "arkher.vfx.spark.spatial_index"
	S.name = "Spark Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spark"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spark.quality_policy" }
	S.tags = { "n", "spark", "index", "vfx" }
	S.description = "Spark Spatial Index: spatial acceleration of effect queries and culling for the Spark subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.spark.spatial_index", mode = "hash", cellSize = 64 })
		inst.system = S
		inst.ctx = ctx
