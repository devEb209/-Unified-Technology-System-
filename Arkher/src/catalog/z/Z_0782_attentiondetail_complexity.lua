-- ARKHER SYSTEM Z.0782 :: Attention Driven Detail Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0782"
	S.key = "arkher.origin.attentiondetail.complexity_governance"
	S.name = "Attention Driven Detail Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.reality_layering" }
	S.tags = { "z", "attentiondetail", "complexity", "origin" }
	S.description = "Attention Driven Detail Complexity Governance: measured scene cost turned into per-subsystem directives for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.attentiondetail.complexity_governance", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
