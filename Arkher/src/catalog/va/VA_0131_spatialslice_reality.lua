-- ARKHER SYSTEM VA.0131 :: Spatial Slice Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0131"
	S.key = "arkher.contworld.spatialslice.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.spatialslice.simulation_fabric" }
	S.tags = { "va", "spatialslice", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.spatialslice.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
