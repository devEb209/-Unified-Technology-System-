-- ARKHER SYSTEM VB.0201 :: Architect District Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0201"
	S.key = "arkher.conttime.architectdistrict.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.architectdistrict.world_memory_stream" }
	S.tags = { "vb", "architectdistrict", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.architectdistrict.complexity_budget", targetMs = 19.0 })
		inst.system = S
		inst.ctx = ctx
