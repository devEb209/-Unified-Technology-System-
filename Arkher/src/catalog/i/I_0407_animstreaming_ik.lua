-- ARKHER SYSTEM I.0407 :: Animation Streaming Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0407"
	S.key = "arkher.anim.animstreaming.inverse_kinematics"
	S.name = "Animation Streaming Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animstreaming.layered_blending" }
	S.tags = { "i", "animstreaming", "ik", "anim" }
	S.description = "Animation Streaming Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Animation Streaming subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.animstreaming.inverse_kinematics", iterations = 11, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
