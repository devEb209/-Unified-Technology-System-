-- ARKHER SYSTEM E.0466 :: Material Instance Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0466"
	S.key = "arkher.material.instance.definition"
	S.name = "Material Instance Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "instance", "material", "material" }
	S.description = "Material Instance Definition: layered PBR definition resolved into parameters for the Material Instance subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.instance.definition", texelBudget = 1835008 })
		inst.system = S
		inst.ctx = ctx
