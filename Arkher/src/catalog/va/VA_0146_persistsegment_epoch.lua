-- ARKHER SYSTEM VA.0146 :: Persistence Segment Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0146"
	S.key = "arkher.contworld.persistsegment.epoch_clock"
	S.name = "Persistence Segment Epoch Clock"
	S.category = "VA"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.persistsegment.infinite_grid" }
	S.tags = { "va", "persistsegment", "epoch", "contworld" }
	S.description = "Persistence Segment Epoch Clock: deterministic epoch timeline with catch-up for the Persistence Segment subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.persistsegment.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
