-- ARKHER SYSTEM P.0040 :: Ability Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0040"
	S.key = "arkher.play.ability.combat_resolution"
	S.name = "Ability Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ability"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ability.objectives" }
	S.tags = { "p", "ability", "combat", "play" }
	S.description = "Ability Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Ability subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.ability.combat_resolution", seed = 13914, armourK = 100, critMultiplier = 2.10 })
		inst.system = S
		inst.ctx = ctx
