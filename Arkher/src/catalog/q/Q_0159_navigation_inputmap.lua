-- ARKHER SYSTEM Q.0159 :: Navigation Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0159"
	S.key = "arkher.ui.navigation.input_mapping"
	S.name = "Navigation Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Navigation"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.navigation.widget_tree" }
	S.tags = { "q", "navigation", "inputmap", "ui" }
	S.description = "Navigation Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Navigation subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.navigation.input_mapping", device = "keyboard", holdTime = 0.27, deadzone = 0.12 })
		inst.system = S
		inst.ctx = ctx
