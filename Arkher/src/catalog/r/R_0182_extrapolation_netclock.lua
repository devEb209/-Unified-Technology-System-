-- ARKHER SYSTEM R.0182 :: Extrapolation Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0182"
	S.key = "arkher.net.extrapolation.time_sync"
	S.name = "Extrapolation Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.extrapolation.replication" }
	S.tags = { "r", "extrapolation", "netclock", "net" }
	S.description = "Extrapolation Time Sync: offset estimation, outlier rejection and jitter buffering for the Extrapolation subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.extrapolation.time_sync", tickRate = 30, bufferDelay = 0.070, maxSamples = 21 })
		inst.system = S
		inst.ctx = ctx
