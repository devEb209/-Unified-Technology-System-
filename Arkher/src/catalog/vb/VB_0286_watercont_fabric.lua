-- ARKHER SYSTEM VB.0286 :: Water Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0286"
	S.key = "arkher.conttime.watercont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.watercont.complexity_budget" }
	S.tags = { "vb", "watercont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.watercont.simulation_fabric", budgetMs = 2.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
