-- ARKHER SYSTEM G.0132 :: Detail Synthesis Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0132"
	S.key = "arkher.neural.detailsynth.weight_codec"
	S.name = "Detail Synthesis Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detailsynth.model_registry" }
	S.tags = { "g", "detailsynth", "codec", "neural" }
	S.description = "Detail Synthesis Weight Codec: weight serialization and quantized transport for the Detail Synthesis subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.detailsynth.weight_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
