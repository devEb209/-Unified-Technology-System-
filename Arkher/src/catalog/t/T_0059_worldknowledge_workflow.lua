-- ARKHER SYSTEM T.0059 :: World Knowledge Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0059"
	S.key = "arkher.ai.worldknowledge.plan_workflow"
	S.name = "World Knowledge Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.worldknowledge.semantic_knowledge" }
	S.tags = { "t", "worldknowledge", "workflow", "ai" }
	S.description = "World Knowledge Plan Workflow: dependency-ordered plans that verify, retry and roll back for the World Knowledge subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.worldknowledge.plan_workflow", maxRetries = 2, budget = 50 })
		inst.system = S
		inst.ctx = ctx
