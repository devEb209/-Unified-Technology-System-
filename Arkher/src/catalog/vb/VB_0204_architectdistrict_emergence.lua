-- ARKHER SYSTEM VB.0204 :: Architect District Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0204"
	S.key = "arkher.conttime.architectdistrict.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.architectdistrict.reality_continuum" }
	S.tags = { "vb", "architectdistrict", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.architectdistrict.emergence_continuum", windowSize = 6, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
