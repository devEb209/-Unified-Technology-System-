-- ARKHER SYSTEM VB.0338 :: Society Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0338"
	S.key = "arkher.conttime.societycont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.societycont.infinite_grid" }
	S.tags = { "vb", "societycont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.societycont.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
