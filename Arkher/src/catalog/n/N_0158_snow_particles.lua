-- ARKHER SYSTEM N.0158 :: Snow Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0158"
	S.key = "arkher.vfx.snow.particle_simulation"
	S.name = "Snow Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Snow"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.snow.emission" }
	S.tags = { "n", "snow", "particles", "vfx" }
	S.description = "Snow Particle Simulation: pooled integration of position, velocity, colour and life for the Snow subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.snow.particle_simulation", capacity = 448, drag = 0.14, bounce = 0.19, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
