-- ARKHER SYSTEM G.0101 :: Adaptive Sharpening Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0101"
	S.key = "arkher.neural.adaptivesharpen.temporal_history"
	S.name = "Adaptive Sharpening Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.adaptivesharpen.feature_extraction" }
	S.tags = { "g", "adaptivesharpen", "temporal", "neural" }
	S.description = "Adaptive Sharpening Temporal History: history buffers reused across frames for the Adaptive Sharpening subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.adaptivesharpen.temporal_history", feedback = 0.81, phase = 8 })
		inst.system = S
		inst.ctx = ctx
