-- ARKHER SYSTEM T.0273 :: Level Design Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0273"
	S.key = "arkher.ai.leveldesign.decision_policy"
	S.name = "Level Design Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.leveldesign.reasoning_graph" }
	S.tags = { "t", "leveldesign", "policy", "ai" }
	S.description = "Level Design Decision Policy: ordered rules deciding what the agent does next for the Level Design subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.leveldesign.decision_policy", algorithm = "roundrobin", starvationGuard = 60 })
		inst.system = S
		inst.ctx = ctx
