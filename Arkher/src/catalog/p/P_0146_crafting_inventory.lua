-- ARKHER SYSTEM P.0146 :: Crafting Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0146"
	S.key = "arkher.play.crafting.inventory"
	S.name = "Crafting Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Crafting"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.crafting.attributes" }
	S.tags = { "p", "crafting", "inventory", "play" }
	S.description = "Crafting Inventory: slots, stacking, weight, equipment and crafting for the Crafting subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.crafting.inventory", slots = 12, maxWeight = 40 })
		inst.system = S
		inst.ctx = ctx
