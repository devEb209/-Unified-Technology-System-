-- ARKHER SYSTEM VD.0034 :: Zone Chunk Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0034"
	S.key = "arkher.contsim.zonechunk.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.zonechunk.complexity_budget" }
	S.tags = { "vd", "zonechunk", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.zonechunk.simulation_fabric", budgetMs = 2.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
