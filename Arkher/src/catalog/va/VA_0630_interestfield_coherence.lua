-- ARKHER SYSTEM VA.0630 :: Interest Field Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0630"
	S.key = "arkher.contworld.interestfield.coherence_guard"
	S.name = "Interest Field Coherence Guard"
	S.category = "VA"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.interestfield.persistent_state" }
	S.tags = { "va", "interestfield", "coherence", "contworld" }
	S.description = "Interest Field Coherence Guard: seam coherence and drift supervision for the Interest Field subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.interestfield.coherence_guard", window = 93, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
