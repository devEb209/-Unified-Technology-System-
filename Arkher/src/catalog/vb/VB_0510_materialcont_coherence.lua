-- ARKHER SYSTEM VB.0510 :: Material Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0510"
	S.key = "arkher.conttime.materialcont.coherence_guard"
	S.name = "Material Continuum Coherence Guard"
	S.category = "VB"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.materialcont.persistent_state" }
	S.tags = { "vb", "materialcont", "coherence", "conttime" }
	S.description = "Material Continuum Coherence Guard: seam coherence and drift supervision for the Material Continuum subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.materialcont.coherence_guard", window = 94, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
