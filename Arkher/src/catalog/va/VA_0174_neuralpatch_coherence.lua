-- ARKHER SYSTEM VA.0174 :: Neural Patch Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0174"
	S.key = "arkher.contworld.neuralpatch.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.neuralpatch.persistent_state" }
	S.tags = { "va", "neuralpatch", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.neuralpatch.coherence_guard", window = 87, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
