-- ARKHER SYSTEM R.0189 :: Extrapolation Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0189"
	S.key = "arkher.net.extrapolation.session_registry"
	S.name = "Extrapolation Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.extrapolation.rate_guard" }
	S.tags = { "r", "extrapolation", "registry", "net" }
	S.description = "Extrapolation Session Registry: catalogue of sessions, players and their metadata for the Extrapolation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.extrapolation.session_registry" })
		inst.system = S
		inst.ctx = ctx
