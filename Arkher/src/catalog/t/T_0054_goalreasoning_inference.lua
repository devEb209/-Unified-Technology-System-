-- ARKHER SYSTEM T.0054 :: Goal Reasoning Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0054"
	S.key = "arkher.ai.goalreasoning.model_inference"
	S.name = "Goal Reasoning Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.goalreasoning.action_planner" }
	S.tags = { "t", "goalreasoning", "inference", "ai" }
	S.description = "Goal Reasoning Model Inference: quantized inference with batching and budget for the Goal Reasoning subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.goalreasoning.model_inference", seed = 10297 })
		inst.system = S
		inst.ctx = ctx
