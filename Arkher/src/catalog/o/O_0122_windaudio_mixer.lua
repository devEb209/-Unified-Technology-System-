-- ARKHER SYSTEM O.0122 :: Wind Audio Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0122"
	S.key = "arkher.audio.windaudio.mixer_bus"
	S.name = "Wind Audio Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Wind Audio"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.windaudio.dsp_chain" }
	S.tags = { "o", "windaudio", "mixer", "audio" }
	S.description = "Wind Audio Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Wind Audio subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.windaudio.mixer_bus", maxVoices = 56 })
		inst.system = S
		inst.ctx = ctx
