-- ARKHER SYSTEM F.0355 :: Temporal Accumulation Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0355"
	S.key = "arkher.render.temporalaccum.lighting_rig"
	S.name = "Temporal Accumulation Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.temporalaccum.geometry_virtualization" }
	S.tags = { "f", "temporalaccum", "lightrig", "render" }
	S.description = "Temporal Accumulation Lighting Rig: light clustering, importance and cascades for the Temporal Accumulation subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.temporalaccum.lighting_rig", maxActive = 11 })
		inst.system = S
		inst.ctx = ctx
