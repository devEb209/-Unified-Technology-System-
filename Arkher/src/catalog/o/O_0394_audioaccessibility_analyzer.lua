-- ARKHER SYSTEM O.0394 :: Accessibility Audio Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0394"
	S.key = "arkher.audio.audioaccessibility.analysis"
	S.name = "Accessibility Audio Analysis"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audioaccessibility.playback_policy" }
	S.tags = { "o", "audioaccessibility", "analyzer", "audio" }
	S.description = "Accessibility Audio Analysis: loudness, headroom and masking analysis for the Accessibility Audio subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.audioaccessibility.analysis", window = 230, buckets = 14, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
