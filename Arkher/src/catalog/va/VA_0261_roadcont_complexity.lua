-- ARKHER SYSTEM VA.0261 :: Road Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0261"
	S.key = "arkher.contworld.roadcont.complexity_budget"
	S.name = "Road Continuum Complexity Budget"
	S.category = "VA"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.roadcont.world_memory_stream" }
	S.tags = { "va", "roadcont", "complexity", "contworld" }
	S.description = "Road Continuum Complexity Budget: complexity budgeting for the continuum for the Road Continuum subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.roadcont.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
