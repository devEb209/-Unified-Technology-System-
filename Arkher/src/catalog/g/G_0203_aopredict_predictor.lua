-- ARKHER SYSTEM G.0203 :: Ambient Occlusion Prediction Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0203"
	S.key = "arkher.neural.aopredict.quality_predictor"
	S.name = "Ambient Occlusion Prediction Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.aopredict.weight_codec" }
	S.tags = { "g", "aopredict", "predictor", "neural" }
	S.description = "Ambient Occlusion Prediction Quality Predictor: predicted quality and cost of a setting for the Ambient Occlusion Prediction subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.aopredict.quality_predictor", method = "markov", alpha = 0.42, window = 88 })
		inst.system = S
		inst.ctx = ctx
