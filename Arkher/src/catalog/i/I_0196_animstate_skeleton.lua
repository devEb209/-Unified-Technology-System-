-- ARKHER SYSTEM I.0196 :: State Machine Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0196"
	S.key = "arkher.anim.animstate.skeleton"
	S.name = "State Machine Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "animstate", "skeleton", "anim" }
	S.description = "State Machine Skeleton: bone hierarchy, bind pose and world resolution for the State Machine subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.animstate.skeleton" })
		inst.system = S
		inst.ctx = ctx
