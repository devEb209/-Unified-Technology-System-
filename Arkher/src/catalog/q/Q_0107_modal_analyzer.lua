-- ARKHER SYSTEM Q.0107 :: Modal Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0107"
	S.key = "arkher.ui.modal.usability_analysis"
	S.name = "Modal Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Modal"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.modal.frame_budget" }
	S.tags = { "q", "modal", "analyzer", "ui" }
	S.description = "Modal Usability Analysis: reachability, latency and abandonment analysis for the Modal subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.modal.usability_analysis", window = 165, buckets = 17, threshold = 4.70 })
		inst.system = S
		inst.ctx = ctx
