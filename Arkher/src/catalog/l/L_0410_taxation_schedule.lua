-- ARKHER SYSTEM L.0410 :: Taxation Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0410"
	S.key = "arkher.sim.taxation.calendar"
	S.name = "Taxation Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.taxation.society" }
	S.tags = { "l", "taxation", "schedule", "sim" }
	S.description = "Taxation Calendar: hours, days and seasons driving the region for the Taxation subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.taxation.calendar", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
