-- ARKHER SYSTEM O.0358 :: Creature Audio Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0358"
	S.key = "arkher.audio.creatureaudio.analysis"
	S.name = "Creature Audio Analysis"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.creatureaudio.playback_policy" }
	S.tags = { "o", "creatureaudio", "analyzer", "audio" }
	S.description = "Creature Audio Analysis: loudness, headroom and masking analysis for the Creature Audio subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.creatureaudio.analysis", window = 146, buckets = 10, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
