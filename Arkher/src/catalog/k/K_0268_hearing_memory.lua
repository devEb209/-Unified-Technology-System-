-- ARKHER SYSTEM K.0268 :: Hearing Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0268"
	S.key = "arkher.npc.hearing.memory"
	S.name = "Hearing Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hearing.mind_network" }
	S.tags = { "k", "hearing", "memory", "npc" }
	S.description = "Hearing Memory: episodic memory with decay, recall and consolidation for the Hearing subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.hearing.memory", capacity = 125, decayRate = 0.065, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
