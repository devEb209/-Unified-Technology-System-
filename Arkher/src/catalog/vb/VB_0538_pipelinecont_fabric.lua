-- ARKHER SYSTEM VB.0538 :: Pipeline Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0538"
	S.key = "arkher.conttime.pipelinecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.pipelinecont.complexity_budget" }
	S.tags = { "vb", "pipelinecont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.pipelinecont.simulation_fabric", budgetMs = 1.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
