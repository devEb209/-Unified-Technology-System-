-- ARKHER SYSTEM Z.0437 :: Offline World Progression Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0437"
	S.key = "arkher.origin.offlineprogression.behaviour_analysis"
	S.name = "Offline World Progression Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.governance_policy" }
	S.tags = { "z", "offlineprogression", "analyzer", "origin" }
	S.description = "Offline World Progression Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.offlineprogression.behaviour_analysis", window = 172, buckets = 8, threshold = 4.40 })
		inst.system = S
		inst.ctx = ctx
