-- ARKHER SYSTEM VC.0526 :: Asset Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0526"
	S.key = "arkher.contneural.assetcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.assetcont.complexity_budget" }
	S.tags = { "vc", "assetcont", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.assetcont.simulation_fabric", budgetMs = 1.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
