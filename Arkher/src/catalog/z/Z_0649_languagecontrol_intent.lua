-- ARKHER SYSTEM Z.0649 :: Natural Language Engine Control Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0649"
	S.key = "arkher.origin.languagecontrol.intent_bridge"
	S.name = "Natural Language Engine Control Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.languagecontrol.semantic_graph" }
	S.tags = { "z", "languagecontrol", "intent", "origin" }
	S.description = "Natural Language Engine Control Intent Bridge: natural language control surface for the technology for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.languagecontrol.intent_bridge", minConfidence = 0.44 })
		inst.system = S
		inst.ctx = ctx
