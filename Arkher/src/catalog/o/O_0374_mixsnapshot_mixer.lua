-- ARKHER SYSTEM O.0374 :: Mix Snapshot Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0374"
	S.key = "arkher.audio.mixsnapshot.mixer_bus"
	S.name = "Mix Snapshot Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mix Snapshot"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mixsnapshot.dsp_chain" }
	S.tags = { "o", "mixsnapshot", "mixer", "audio" }
	S.description = "Mix Snapshot Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Mix Snapshot subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.mixsnapshot.mixer_bus", maxVoices = 48 })
		inst.system = S
		inst.ctx = ctx
