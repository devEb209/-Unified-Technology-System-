-- ARKHER SYSTEM J.0039 :: Skin Definition Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0039"
	S.key = "arkher.character.skindef.locomotion"
	S.name = "Skin Definition Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.skindef.physical_response" }
	S.tags = { "j", "skindef", "charmotor", "character" }
	S.description = "Skin Definition Locomotion: capsule locomotion driving the character for the Skin Definition subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.skindef.locomotion", radius = 0.47, height = 1.72, maxSpeed = 9.20, jumpHeight = 1.60, stepOffset = 0.47 })
		inst.system = S
		inst.ctx = ctx
