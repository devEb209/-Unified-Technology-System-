-- ARKHER SYSTEM H.0553 :: Cloth Simulation Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0553"
	S.key = "arkher.physics.cloth.vehicle"
	S.name = "Cloth Simulation Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.cloth.character_motion" }
	S.tags = { "h", "cloth", "vehicle", "physics" }
	S.description = "Cloth Simulation Vehicle: suspension, drivetrain, steering and tire friction for the Cloth Simulation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.cloth.vehicle", mass = 2100, wheelbase = 2.60, track = 1.80, maxRpm = 6000 })
		inst.system = S
		inst.ctx = ctx
