-- ARKHER SYSTEM T.0286 :: Balance Tuning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0286"
	S.key = "arkher.ai.balancetuning.reasoning_graph"
	S.name = "Balance Tuning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.balancetuning.world_architect" }
	S.tags = { "t", "balancetuning", "graph", "ai" }
	S.description = "Balance Tuning Reasoning Graph: relationship modelling and shortest-path reasoning for the Balance Tuning subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.balancetuning.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
