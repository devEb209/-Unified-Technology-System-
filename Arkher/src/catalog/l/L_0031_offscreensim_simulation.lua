-- ARKHER SYSTEM L.0031 :: Offscreen Simulation Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0031"
	S.key = "arkher.sim.offscreensim.simulation_core"
	S.name = "Offscreen Simulation Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "offscreensim", "simulation", "sim" }
	S.description = "Offscreen Simulation Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Offscreen Simulation subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.offscreensim.simulation_core", fullRadius = 200, reducedRadius = 1200, budget = 94 })
		inst.system = S
		inst.ctx = ctx
