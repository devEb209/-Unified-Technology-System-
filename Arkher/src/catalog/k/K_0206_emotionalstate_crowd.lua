-- ARKHER SYSTEM K.0206 :: Emotional State Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0206"
	S.key = "arkher.npc.emotionalstate.crowd_steering"
	S.name = "Emotional State Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.emotionalstate.navigation" }
	S.tags = { "k", "emotionalstate", "crowd", "npc" }
	S.description = "Emotional State Crowd Steering: local avoidance, cohesion and arrival at scale for the Emotional State subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.emotionalstate.crowd_steering", radius = 0.65, maxSpeed = 5.50, cellSize = 7 })
		inst.system = S
		inst.ctx = ctx
