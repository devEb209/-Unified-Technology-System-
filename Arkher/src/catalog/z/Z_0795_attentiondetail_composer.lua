-- ARKHER SYSTEM Z.0795 :: Attention Driven Detail Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0795"
	S.key = "arkher.origin.attentiondetail.signal_composition"
	S.name = "Attention Driven Detail Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.telemetry_ledger" }
	S.tags = { "z", "attentiondetail", "composer", "origin" }
	S.description = "Attention Driven Detail Signal Composition: blending of the technology's input signals into one output for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.attentiondetail.signal_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
