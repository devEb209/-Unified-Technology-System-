-- ARKHER SYSTEM Q.0262 :: Settings Screen Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0262"
	S.key = "arkher.ui.settingsscreen.frame_budget"
	S.name = "Settings Screen Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.settingsscreen.accessibility_policy" }
	S.tags = { "q", "settingsscreen", "budgeter", "ui" }
	S.description = "Settings Screen Frame Budget: per-frame layout and draw budget for the interface for the Settings Screen subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.settingsscreen.frame_budget", total = 330, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
