-- ARKHER SYSTEM P.0130 :: Loot Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0130"
	S.key = "arkher.play.loot.content_registry"
	S.name = "Loot Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Loot"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.loot.difficulty_controller" }
	S.tags = { "p", "loot", "registry", "play" }
	S.description = "Loot Content Registry: catalogue of the definitions this loop instantiates for the Loot subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.loot.content_registry" })
		inst.system = S
		inst.ctx = ctx
