-- ARKHER SYSTEM Z.0032 :: Predictive Optimization Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0032"
	S.key = "arkher.origin.predictiveopt.predictive_optimization"
	S.name = "Predictive Optimization Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.adaptive_workflow" }
	S.tags = { "z", "predictiveopt", "predictor", "origin" }
	S.description = "Predictive Optimization Predictive Optimization: forecast-driven optimization before the cost is paid for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.predictiveopt.predictive_optimization", method = "ema", alpha = 0.48, window = 38 })
		inst.system = S
		inst.ctx = ctx
