-- ARKHER SYSTEM G.0345 :: Inference Scheduler Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0345"
	S.key = "arkher.neural.inferencesched.result_cache"
	S.name = "Inference Scheduler Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.inferencesched.compute_budget" }
	S.tags = { "g", "inferencesched", "cache", "neural" }
	S.description = "Inference Scheduler Result Cache: cached inference results keyed by input for the Inference Scheduler subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.inferencesched.result_cache", policy = "ttl", capacity = 128, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
