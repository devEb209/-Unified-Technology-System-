-- ARKHER SYSTEM VB.0214 :: Biome Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0214"
	S.key = "arkher.conttime.biomecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.biomecont.complexity_budget" }
	S.tags = { "vb", "biomecont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.biomecont.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
