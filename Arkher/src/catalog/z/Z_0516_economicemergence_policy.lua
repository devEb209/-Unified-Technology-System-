-- ARKHER SYSTEM Z.0516 :: Economic Emergence Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0516"
	S.key = "arkher.origin.economicemergence.governance_policy"
	S.name = "Economic Emergence Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.economicemergence.signal_composition" }
	S.tags = { "z", "economicemergence", "policy", "origin" }
	S.description = "Economic Emergence Governance Policy: ordered rules governing when the technology may act for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.economicemergence.governance_policy", algorithm = "lottery", starvationGuard = 39 })
		inst.system = S
		inst.ctx = ctx
