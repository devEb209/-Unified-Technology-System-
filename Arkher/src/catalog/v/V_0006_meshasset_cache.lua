-- ARKHER SYSTEM V.0006 :: Mesh Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0006"
	S.key = "arkher.asset.meshasset.content_cache"
	S.name = "Mesh Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.meshasset.dependency_graph" }
	S.tags = { "v", "meshasset", "cache", "asset" }
	S.description = "Mesh Content Cache: reuse of already cooked results for the Mesh subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.meshasset.content_cache", policy = "lru", capacity = 210, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
