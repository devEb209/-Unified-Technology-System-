-- ARKHER SYSTEM VA.0197 :: Architect District Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0197"
	S.key = "arkher.contworld.architectdistrict.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.architectdistrict.multi-scale_fidelity" }
	S.tags = { "va", "architectdistrict", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.architectdistrict.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
