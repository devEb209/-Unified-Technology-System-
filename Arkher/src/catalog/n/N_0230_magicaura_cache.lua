-- ARKHER SYSTEM N.0230 :: Magic Aura Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0230"
	S.key = "arkher.vfx.magicaura.result_cache"
	S.name = "Magic Aura Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Magic Aura"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.magicaura.spawn_budget" }
	S.tags = { "n", "magicaura", "cache", "vfx" }
	S.description = "Magic Aura Result Cache: reuse of expensive effect evaluations for the Magic Aura subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.magicaura.result_cache", policy = "ttl", capacity = 163, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
