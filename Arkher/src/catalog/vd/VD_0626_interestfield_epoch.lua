-- ARKHER SYSTEM VD.0626 :: Interest Field Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0626"
	S.key = "arkher.contsim.interestfield.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.interestfield.infinite_grid" }
	S.tags = { "vd", "interestfield", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.interestfield.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
