-- ARKHER SYSTEM Z.0358 :: Device Aware Fidelity Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0358"
	S.key = "arkher.origin.deviceaware.budget_governor"
	S.name = "Device Aware Fidelity Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.behaviour_analysis" }
	S.tags = { "z", "deviceaware", "budgeter", "origin" }
	S.description = "Device Aware Fidelity Budget Governor: allocation of a scarce resource across the technology's consumers for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.deviceaware.budget_governor", total = 305, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
