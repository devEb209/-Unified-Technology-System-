-- ARKHER SYSTEM G.0097 :: Ghosting Suppression Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0097"
	S.key = "arkher.neural.ghosting.sampling_graph"
	S.name = "Ghosting Suppression Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ghosting.training_ledger" }
	S.tags = { "g", "ghosting", "graph", "neural" }
	S.description = "Ghosting Suppression Sampling Graph: dependency graph of sampling stages for the Ghosting Suppression subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.ghosting.sampling_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
