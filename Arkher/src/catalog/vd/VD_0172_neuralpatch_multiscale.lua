-- ARKHER SYSTEM VD.0172 :: Neural Patch Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0172"
	S.key = "arkher.contsim.neuralpatch.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.neuralpatch.sparse_residency" }
	S.tags = { "vd", "neuralpatch", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.neuralpatch.multi-scale_fidelity", levels = 6, baseTriangles = 60000 })
		inst.system = S
		inst.ctx = ctx
