-- ARKHER SYSTEM K.0049 :: Reward Model Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0049"
	S.key = "arkher.npc.rewardmodel.utility_reasoning"
	S.name = "Reward Model Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.rewardmodel.reactive_behaviour" }
	S.tags = { "k", "rewardmodel", "utility", "npc" }
	S.description = "Reward Model Utility Reasoning: scored option selection with response curves for the Reward Model subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.rewardmodel.utility_reasoning", momentum = 0.10 })
		inst.system = S
		inst.ctx = ctx
