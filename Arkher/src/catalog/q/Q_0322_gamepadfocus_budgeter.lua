-- ARKHER SYSTEM Q.0322 :: Gamepad Focus Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0322"
	S.key = "arkher.ui.gamepadfocus.frame_budget"
	S.name = "Gamepad Focus Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.gamepadfocus.accessibility_policy" }
	S.tags = { "q", "gamepadfocus", "budgeter", "ui" }
	S.description = "Gamepad Focus Frame Budget: per-frame layout and draw budget for the interface for the Gamepad Focus subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.gamepadfocus.frame_budget", total = 104, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
