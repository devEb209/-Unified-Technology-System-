...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="RE ImGui — CORE Node_Flow #0196", size=Vector2.new(640, 440), pos=UDim2.fromOffset(248, 292), parent=parent, icon="✈"})
