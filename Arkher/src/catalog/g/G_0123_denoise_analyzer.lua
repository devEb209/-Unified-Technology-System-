-- ARKHER SYSTEM G.0123 :: Denoising Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0123"
	S.key = "arkher.neural.denoise.error_analysis"
	S.name = "Denoising Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.denoise.heuristic_policy" }
	S.tags = { "g", "denoise", "analyzer", "neural" }
	S.description = "Denoising Error Analysis: residual and drift analysis for the Denoising subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.denoise.error_analysis", window = 66, buckets = 14, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
