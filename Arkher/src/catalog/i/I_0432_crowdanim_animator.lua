-- ARKHER SYSTEM I.0432 :: Crowd Animation Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0432"
	S.key = "arkher.anim.crowdanim.layered_blending"
	S.name = "Crowd Animation Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crowdanim.clip_sampling" }
	S.tags = { "i", "crowdanim", "animator", "anim" }
	S.description = "Crowd Animation Layered Blending: layers, crossfades, masks and blend trees for the Crowd Animation subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.crowdanim.layered_blending", budget = 15 })
		inst.system = S
		inst.ctx = ctx
