-- ARKHER SYSTEM V.0344 :: Patch Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0344"
	S.key = "arkher.asset.patch.compression_codec"
	S.name = "Patch Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.patch.streaming_residency" }
	S.tags = { "v", "patch", "codec", "asset" }
	S.description = "Patch Compression Codec: compact encoding, diffing and checksum of asset payloads for the Patch subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.patch.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
