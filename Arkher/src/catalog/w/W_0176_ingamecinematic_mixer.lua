-- ARKHER SYSTEM W.0176 :: In Game Cinematic Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0176"
	S.key = "arkher.cine.ingamecinematic.cinematic_mix"
	S.name = "In Game Cinematic Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.ingamecinematic.motion_tween" }
	S.tags = { "w", "ingamecinematic", "mixer", "cine" }
	S.description = "In Game Cinematic Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the In Game Cinematic subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.ingamecinematic.cinematic_mix", maxVoices = 24 })
		inst.system = S
		inst.ctx = ctx
