-- ARKHER SYSTEM Z.0760 :: World Compression Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0760"
	S.key = "arkher.origin.worldcompression.orchestration"
	S.name = "World Compression Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.residency_streaming" }
	S.tags = { "z", "worldcompression", "orchestrator", "origin" }
	S.description = "World Compression Orchestration: lifecycle and phase orchestration of the technology for the World Compression subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.worldcompression.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
