-- ARKHER SYSTEM H.0501 :: Slider Joint Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0501"
	S.key = "arkher.physics.sliderjoint.result_cache"
	S.name = "Slider Joint Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Slider Joint"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sliderjoint.simulation_policy" }
	S.tags = { "h", "sliderjoint", "cache", "physics" }
	S.description = "Slider Joint Result Cache: reuse of expensive simulation and query results for the Slider Joint subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.sliderjoint.result_cache", policy = "lfu", capacity = 287, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
