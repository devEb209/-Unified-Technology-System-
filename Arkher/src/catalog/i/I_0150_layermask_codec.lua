-- ARKHER SYSTEM I.0150 :: Layer Mask Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0150"
	S.key = "arkher.anim.layermask.compression_codec"
	S.name = "Layer Mask Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Layer Mask"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.layermask.retarget_graph" }
	S.tags = { "i", "layermask", "codec", "anim" }
	S.description = "Layer Mask Compression Codec: curve compression and quantized transport for the Layer Mask subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.layermask.compression_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
