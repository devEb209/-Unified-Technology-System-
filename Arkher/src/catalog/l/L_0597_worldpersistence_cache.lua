-- ARKHER SYSTEM L.0597 :: World Persistence Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0597"
	S.key = "arkher.sim.worldpersistence.aggregate_cache"
	S.name = "World Persistence Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldpersistence.fidelity_policy" }
	S.tags = { "l", "worldpersistence", "cache", "sim" }
	S.description = "World Persistence Aggregate Cache: reuse of expensive aggregate computations for the World Persistence subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.worldpersistence.aggregate_cache", policy = "lru", capacity = 243, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
