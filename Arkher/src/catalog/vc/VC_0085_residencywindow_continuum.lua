-- ARKHER SYSTEM VC.0085 :: Residency Window Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0085"
	S.key = "arkher.contneural.residencywindow.infinite_grid"
	S.name = "Residency Window Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "residencywindow", "continuum", "contneural" }
	S.description = "Residency Window Infinite Grid: seamless paging of the infinite world grid for the Residency Window subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.residencywindow.infinite_grid", cellSize = 224, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
