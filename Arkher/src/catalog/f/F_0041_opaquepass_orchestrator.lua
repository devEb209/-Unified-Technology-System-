-- ARKHER SYSTEM F.0041 :: Opaque Pass Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0041"
	S.key = "arkher.render.opaquepass.orchestration"
	S.name = "Opaque Pass Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Opaque Pass"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.opaquepass.frame_analysis" }
	S.tags = { "f", "opaquepass", "orchestrator", "render" }
	S.description = "Opaque Pass Orchestration: frame lifecycle orchestration for the Opaque Pass subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.opaquepass.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
