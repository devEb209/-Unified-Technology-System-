-- ARKHER SYSTEM Z.0242 :: AI Native Engine Architecture Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0242"
	S.key = "arkher.origin.ainative.complexity_governance"
	S.name = "AI Native Engine Architecture Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.ainative.reality_layering" }
	S.tags = { "z", "ainative", "complexity", "origin" }
	S.description = "AI Native Engine Architecture Complexity Governance: measured scene cost turned into per-subsystem directives for the AI Native Engine Architecture subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.ainative.complexity_governance", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
