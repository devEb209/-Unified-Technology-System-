-- ARKHER SYSTEM L.0198 :: Predation Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0198"
	S.key = "arkher.sim.predation.economy"
	S.name = "Predation Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.predation.ecology" }
	S.tags = { "l", "predation", "economy", "sim" }
	S.description = "Predation Economy: stock, production, demand, price discovery and trade for the Predation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.predation.economy", elasticity = 0.19 })
		inst.system = S
		inst.ctx = ctx
