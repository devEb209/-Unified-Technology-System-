-- ARKHER SYSTEM Z.0458 :: Player Absence Simulation Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0458"
	S.key = "arkher.origin.playerabsence.budget_governor"
	S.name = "Player Absence Simulation Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.behaviour_analysis" }
	S.tags = { "z", "playerabsence", "budgeter", "origin" }
	S.description = "Player Absence Simulation Budget Governor: allocation of a scarce resource across the technology's consumers for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.playerabsence.budget_governor", total = 317, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
