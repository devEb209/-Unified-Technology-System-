-- ARKHER SYSTEM J.0094 :: Expression Set Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0094"
	S.key = "arkher.character.expression.locomotion"
	S.name = "Expression Set Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.expression.physical_response" }
	S.tags = { "j", "expression", "charmotor", "character" }
	S.description = "Expression Set Locomotion: capsule locomotion driving the character for the Expression Set subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.expression.locomotion", radius = 0.45, height = 1.90, maxSpeed = 9.00, jumpHeight = 1.40, stepOffset = 0.45 })
		inst.system = S
		inst.ctx = ctx
