-- ARKHER SYSTEM Z.0503 :: Economic Emergence Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0503"
	S.key = "arkher.origin.economicemergence.simulation_fabric"
	S.name = "Economic Emergence Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.economicemergence.complexity_governance" }
	S.tags = { "z", "economicemergence", "fabric", "origin" }
	S.description = "Economic Emergence Simulation Fabric: every simulation domain stepped under one budgeted clock for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.economicemergence.simulation_fabric", budgetMs = 2.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
