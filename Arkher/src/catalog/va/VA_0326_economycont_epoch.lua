-- ARKHER SYSTEM VA.0326 :: Economy Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0326"
	S.key = "arkher.contworld.economycont.epoch_clock"
	S.name = "Economy Continuum Epoch Clock"
	S.category = "VA"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.economycont.infinite_grid" }
	S.tags = { "va", "economycont", "epoch", "contworld" }
	S.description = "Economy Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Economy Continuum subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.economycont.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
