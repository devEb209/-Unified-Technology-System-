-- ARKHER SYSTEM VB.0232 :: City Continuum Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0232"
	S.key = "arkher.conttime.citycont.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.citycont.sparse_residency" }
	S.tags = { "vb", "citycont", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.citycont.multi-scale_fidelity", levels = 5, baseTriangles = 165000 })
		inst.system = S
		inst.ctx = ctx
