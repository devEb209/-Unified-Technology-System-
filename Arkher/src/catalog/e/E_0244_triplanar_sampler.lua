-- ARKHER SYSTEM E.0244 :: Triplanar Projection Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0244"
	S.key = "arkher.material.triplanar.texture_sampling"
	S.name = "Triplanar Projection Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.triplanar.shading_graph" }
	S.tags = { "e", "triplanar", "sampler", "material" }
	S.description = "Triplanar Projection Texture Sampling: atlas packing, mip chain and filtered sampling for the Triplanar Projection subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.triplanar.texture_sampling", atlasSize = 192, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
