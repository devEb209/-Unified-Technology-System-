-- ARKHER SYSTEM P.0251 :: Objective Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0251"
	S.key = "arkher.play.objective.save_codec"
	S.name = "Objective Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Objective"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.objective.content_registry" }
	S.tags = { "p", "objective", "codec", "play" }
	S.description = "Objective Save Codec: persistence, diffing and checksum of gameplay state for the Objective subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.objective.save_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
