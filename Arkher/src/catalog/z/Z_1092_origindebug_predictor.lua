-- ARKHER SYSTEM Z.1092 :: Original Tech Debug Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.1092"
	S.key = "arkher.origin.origindebug.predictive_optimization"
	S.name = "Original Tech Debug Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.origindebug.adaptive_workflow" }
	S.tags = { "z", "origindebug", "predictor", "origin" }
	S.description = "Original Tech Debug Predictive Optimization: forecast-driven optimization before the cost is paid for the Original Tech Debug subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.origindebug.predictive_optimization", method = "markov", alpha = 0.29, window = 91 })
		inst.system = S
		inst.ctx = ctx
