-- ARKHER SYSTEM Z.0803 :: Perceptual Budgeting Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0803"
	S.key = "arkher.origin.perceptualbudget.simulation_fabric"
	S.name = "Perceptual Budgeting Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.perceptualbudget.complexity_governance" }
	S.tags = { "z", "perceptualbudget", "fabric", "origin" }
	S.description = "Perceptual Budgeting Simulation Fabric: every simulation domain stepped under one budgeted clock for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.perceptualbudget.simulation_fabric", budgetMs = 2.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
