-- ARKHER SYSTEM H.0257 :: Narrowphase Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0257"
	S.key = "arkher.physics.narrowphase.query"
	S.name = "Narrowphase Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Narrowphase"
	S.aspect = "Query"
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.narrowphase.constraint_solver" }
	S.tags = { "h", "narrowphase", "raycaster", "physics" }
	S.description = "Narrowphase Query: rays, sweeps and overlaps against the simulation for the Narrowphase subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.narrowphase.query", cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
