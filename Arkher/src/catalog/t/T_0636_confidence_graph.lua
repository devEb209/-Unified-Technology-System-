-- ARKHER SYSTEM T.0636 :: Confidence Estimation Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0636"
	S.key = "arkher.ai.confidence.reasoning_graph"
	S.name = "Confidence Estimation Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.confidence.world_architect" }
	S.tags = { "t", "confidence", "graph", "ai" }
	S.description = "Confidence Estimation Reasoning Graph: relationship modelling and shortest-path reasoning for the Confidence Estimation subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.confidence.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
