-- ARKHER SYSTEM O.0154 :: Water Audio Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0154"
	S.key = "arkher.audio.wateraudio.analysis"
	S.name = "Water Audio Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Water Audio"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.wateraudio.playback_policy" }
	S.tags = { "o", "wateraudio", "analyzer", "audio" }
	S.description = "Water Audio Analysis: loudness, headroom and masking analysis for the Water Audio subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.wateraudio.analysis", window = 179, buckets = 15, threshold = 2.10 })
		inst.system = S
		inst.ctx = ctx
