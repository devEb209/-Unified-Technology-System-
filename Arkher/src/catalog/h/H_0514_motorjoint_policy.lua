-- ARKHER SYSTEM H.0514 :: Motorized Joint Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0514"
	S.key = "arkher.physics.motorjoint.simulation_policy"
	S.name = "Motorized Joint Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.motorjoint.budget_governor" }
	S.tags = { "h", "motorjoint", "policy", "physics" }
	S.description = "Motorized Joint Simulation Policy: device tier rules for substeps, iterations and sleep for the Motorized Joint subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.motorjoint.simulation_policy", algorithm = "edf", starvationGuard = 25 })
		inst.system = S
		inst.ctx = ctx
