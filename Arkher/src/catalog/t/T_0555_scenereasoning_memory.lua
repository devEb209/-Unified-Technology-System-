-- ARKHER SYSTEM T.0555 :: Scene Reasoning Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0555"
	S.key = "arkher.ai.scenereasoning.working_memory"
	S.name = "Scene Reasoning Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.scenereasoning.outcome_prediction" }
	S.tags = { "t", "scenereasoning", "memory", "ai" }
	S.description = "Scene Reasoning Working Memory: decaying, consolidating recall of what the agent learned for the Scene Reasoning subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.scenereasoning.working_memory", capacity = 107, decayRate = 0.055, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
