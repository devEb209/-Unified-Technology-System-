-- ARKHER SYSTEM F.0536 :: Decal Rendering Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0536"
	S.key = "arkher.render.decalrender.geometry_virtualization"
	S.name = "Decal Rendering Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.decalrender.visibility_set" }
	S.tags = { "f", "decalrender", "impostor", "render" }
	S.description = "Decal Rendering Geometry Virtualization: impostor and HLOD synthesis under a budget for the Decal Rendering subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.decalrender.geometry_virtualization", atlasSlots = 48, viewCount = 8, errorThreshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
