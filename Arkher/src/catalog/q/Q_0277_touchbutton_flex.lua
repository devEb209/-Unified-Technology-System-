-- ARKHER SYSTEM Q.0277 :: Touch Button Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0277"
	S.key = "arkher.ui.touchbutton.responsive_layout"
	S.name = "Touch Button Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Touch Button"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "touchbutton", "flex", "ui" }
	S.description = "Touch Button Responsive Layout: flex solving with safe areas, weights and breakpoints for the Touch Button subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.touchbutton.responsive_layout", width = 570, height = 964, scale = 1.12 })
		inst.system = S
		inst.ctx = ctx
