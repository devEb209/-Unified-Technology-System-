-- ARKHER SYSTEM E.0545 :: Physical Response Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0545"
	S.key = "arkher.material.physicalresponse.procedural_detail"
	S.name = "Physical Response Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.physicalresponse.texture_sampling" }
	S.tags = { "e", "physicalresponse", "field", "material" }
	S.description = "Physical Response Procedural Detail: coherent noise detail driving the surface for the Physical Response subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.physicalresponse.procedural_detail", seed = 21724, frequency = 0.0050, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
