-- ARKHER SYSTEM VB.0047 :: Continuum Stream Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0047"
	S.key = "arkher.conttime.continuumstream.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.continuumstream.simulation_fabric" }
	S.tags = { "vb", "continuumstream", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.continuumstream.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
