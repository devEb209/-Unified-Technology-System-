-- ARKHER SYSTEM E.0305 :: Dust Accumulation Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0305"
	S.key = "arkher.material.dust.procedural_detail"
	S.name = "Dust Accumulation Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Dust Accumulation"
	S.aspect = "Procedural Detail"
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.dust.texture_sampling" }
	S.tags = { "e", "dust", "field", "material" }
	S.description = "Dust Accumulation Procedural Detail: coherent noise detail driving the surface for the Dust Accumulation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.dust.procedural_detail", seed = 89067, frequency = 0.0107, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
		...
		function inst.integrate(engine)
			...
			inst.engine = engine
			if engine.bus then
				engine.bus:subscribe("arkher.material.dust.*", function(payload) inst.lastSignal = payload end)
			end
