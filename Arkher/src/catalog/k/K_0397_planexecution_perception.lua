-- ARKHER SYSTEM K.0397 :: Plan Execution Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0397"
	S.key = "arkher.npc.planexecution.perception"
	S.name = "Plan Execution Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.planexecution.emotion" }
	S.tags = { "k", "planexecution", "perception", "npc" }
	S.description = "Plan Execution Perception: sight, hearing and bounded attention for the Plan Execution subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.planexecution.perception", sightRange = 35, hearingRange = 12, attentionSlots = 5, fov = 1.780 })
		inst.system = S
		inst.ctx = ctx
