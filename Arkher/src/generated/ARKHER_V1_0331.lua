--!strict
-- 3dsMax Stack — ANIMATION Node_Flow #0331
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="3dsMax Stack — ANIMATION Node_Flow #0331", size=Vector2.new(640, 440), pos=UDim2.fromOffset(403, 247), parent=parent, icon="◐"})
