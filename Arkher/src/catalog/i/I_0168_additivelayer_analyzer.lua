-- ARKHER SYSTEM I.0168 :: Additive Layer Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0168"
	S.key = "arkher.anim.additivelayer.analysis"
	S.name = "Additive Layer Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.additivelayer.quality_policy" }
	S.tags = { "i", "additivelayer", "analyzer", "anim" }
	S.description = "Additive Layer Analysis: pop, drift and cost analysis of playback for the Additive Layer subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.additivelayer.analysis", window = 241, buckets = 13, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
