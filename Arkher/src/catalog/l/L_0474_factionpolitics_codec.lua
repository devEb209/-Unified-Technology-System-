-- ARKHER SYSTEM L.0474 :: Faction Politics State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0474"
	S.key = "arkher.sim.factionpolitics.state_codec"
	S.name = "Faction Politics State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.factionpolitics.history_ledger" }
	S.tags = { "l", "factionpolitics", "codec", "sim" }
	S.description = "Faction Politics State Codec: persistence, diffing and checksum of the world state for the Faction Politics subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.factionpolitics.state_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
