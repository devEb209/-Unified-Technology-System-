-- ARKHER SYSTEM VC.0422 :: Navigation Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0422"
	S.key = "arkher.contneural.navcont.epoch_clock"
	S.name = "Navigation Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.navcont.infinite_grid" }
	S.tags = { "vc", "navcont", "epoch", "contneural" }
	S.description = "Navigation Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Navigation Continuum subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.navcont.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
