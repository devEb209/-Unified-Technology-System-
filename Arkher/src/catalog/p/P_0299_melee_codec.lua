-- ARKHER SYSTEM P.0299 :: Melee Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0299"
	S.key = "arkher.play.melee.save_codec"
	S.name = "Melee Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Melee"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.melee.content_registry" }
	S.tags = { "p", "melee", "codec", "play" }
	S.description = "Melee Save Codec: persistence, diffing and checksum of gameplay state for the Melee subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.melee.save_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
