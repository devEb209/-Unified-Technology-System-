-- ARKHER SYSTEM F.0065 :: Shadow Pass Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0065"
	S.key = "arkher.render.shadowpass.draw_budget"
	S.name = "Shadow Pass Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Shadow Pass"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.shadowpass.adaptive_resolution" }
	S.tags = { "f", "shadowpass", "budgeter", "render" }
	S.description = "Shadow Pass Draw Budget: draw call and triangle budget allocation for the Shadow Pass subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.shadowpass.draw_budget", total = 175, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
