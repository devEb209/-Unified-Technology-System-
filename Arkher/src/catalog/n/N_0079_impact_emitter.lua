-- ARKHER SYSTEM N.0079 :: Impact Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0079"
	S.key = "arkher.vfx.impact.emission"
	S.name = "Impact Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Impact"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "impact", "emitter", "vfx" }
	S.description = "Impact Emission: shaped, rate and burst emission of new particles for the Impact subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.impact.emission", shape = "cone", rate = 20, speed = 5.00, life = 0.80, budget = 384, seed = 42420 })
		inst.system = S
		inst.ctx = ctx
