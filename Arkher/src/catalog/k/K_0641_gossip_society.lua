-- ARKHER SYSTEM K.0641 :: Gossip Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0641"
	S.key = "arkher.npc.gossip.social_relations"
	S.name = "Gossip Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.gossip.crowd_steering" }
	S.tags = { "k", "gossip", "society", "npc" }
	S.description = "Gossip Social Relations: affinity, factions, reputation and gossip for the Gossip subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.gossip.social_relations", decayRate = 0.014, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
