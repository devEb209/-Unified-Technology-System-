-- ARKHER SYSTEM V.0237 :: Data Table Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0237"
	S.key = "arkher.asset.datatable.size_budget"
	S.name = "Data Table Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.datatable.compression_codec" }
	S.tags = { "v", "datatable", "budgeter", "asset" }
	S.description = "Data Table Size Budget: byte budget shared between competing asset classes for the Data Table subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.datatable.size_budget", total = 314, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
