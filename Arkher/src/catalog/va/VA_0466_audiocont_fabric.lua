-- ARKHER SYSTEM VA.0466 :: Audio Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0466"
	S.key = "arkher.contworld.audiocont.simulation_fabric"
	S.name = "Audio Continuum Simulation Fabric"
	S.category = "VA"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.audiocont.complexity_budget" }
	S.tags = { "va", "audiocont", "fabric", "contworld" }
	S.description = "Audio Continuum Simulation Fabric: fabric stepping the continuum domains for the Audio Continuum subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.audiocont.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
