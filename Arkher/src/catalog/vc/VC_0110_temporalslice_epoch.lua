-- ARKHER SYSTEM VC.0110 :: Temporal Slice Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0110"
	S.key = "arkher.contneural.temporalslice.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.temporalslice.infinite_grid" }
	S.tags = { "vc", "temporalslice", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.temporalslice.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
