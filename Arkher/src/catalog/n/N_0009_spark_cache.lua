-- ARKHER SYSTEM N.0009 :: Spark Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0009"
	S.key = "arkher.vfx.spark.result_cache"
	S.name = "Spark Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spark"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spark.spawn_budget" }
	S.tags = { "n", "spark", "cache", "vfx" }
	S.description = "Spark Result Cache: reuse of expensive effect evaluations for the Spark subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.spark.result_cache", policy = "lfu", capacity = 105, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
