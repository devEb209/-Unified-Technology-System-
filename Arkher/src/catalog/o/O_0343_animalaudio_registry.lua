-- ARKHER SYSTEM O.0343 :: Animal Audio Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0343"
	S.key = "arkher.audio.animalaudio.asset_registry"
	S.name = "Animal Audio Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Animal Audio"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.animalaudio.streaming" }
	S.tags = { "o", "animalaudio", "registry", "audio" }
	S.description = "Animal Audio Asset Registry: catalogue of sounds, variations and metadata for the Animal Audio subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.animalaudio.asset_registry" })
		inst.system = S
		inst.ctx = ctx
