-- ARKHER SYSTEM Z.0695 :: Auto Test Synthesis Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0695"
	S.key = "arkher.origin.autotest.signal_composition"
	S.name = "Auto Test Synthesis Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autotest.telemetry_ledger" }
	S.tags = { "z", "autotest", "composer", "origin" }
	S.description = "Auto Test Synthesis Signal Composition: blending of the technology's input signals into one output for the Auto Test Synthesis subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.autotest.signal_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
