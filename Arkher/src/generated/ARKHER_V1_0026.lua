...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Fairlight — CORE Node_Flow #0026", size=Vector2.new(680, 440), pos=UDim2.fromOffset(438, 262), parent=parent, icon="◤"})
