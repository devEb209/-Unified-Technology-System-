-- ARKHER SYSTEM L.0291 :: Water Cycle Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0291"
	S.key = "arkher.sim.watercycle.region_graph"
	S.name = "Water Cycle Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.watercycle.calendar" }
	S.tags = { "l", "watercycle", "graph", "sim" }
	S.description = "Water Cycle Region Graph: connectivity, components and shortest path between places for the Water Cycle subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.watercycle.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
