-- ARKHER SYSTEM K.0159 :: Safety Drive Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0159"
	S.key = "arkher.npc.safetydrive.perception"
	S.name = "Safety Drive Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.safetydrive.emotion" }
	S.tags = { "k", "safetydrive", "perception", "npc" }
	S.description = "Safety Drive Perception: sight, hearing and bounded attention for the Safety Drive subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.safetydrive.perception", sightRange = 35, hearingRange = 28, attentionSlots = 5, fov = 1.700 })
		inst.system = S
		inst.ctx = ctx
