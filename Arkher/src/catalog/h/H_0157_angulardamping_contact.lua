-- ARKHER SYSTEM H.0157 :: Angular Damping Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0157"
	S.key = "arkher.physics.angulardamping.contact_generation"
	S.name = "Angular Damping Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.angulardamping.collision_shape" }
	S.tags = { "h", "angulardamping", "contact", "physics" }
	S.description = "Angular Damping Contact Generation: narrow-phase manifolds with normal, depth and point for the Angular Damping subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.angulardamping.contact_generation", slop = 0.0070, maxManifolds = 157 })
		inst.system = S
		inst.ctx = ctx
