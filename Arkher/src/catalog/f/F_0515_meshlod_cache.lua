-- ARKHER SYSTEM F.0515 :: Mesh LOD Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0515"
	S.key = "arkher.render.meshlod.pass_cache"
	S.name = "Mesh LOD Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Mesh LOD"
	S.aspect = "Pass Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.meshlod.render_policy" }
	S.tags = { "f", "meshlod", "cache", "render" }
	S.description = "Mesh LOD Pass Cache: reuse of pass results across frames for the Mesh LOD subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.meshlod.pass_cache", policy = "lru", capacity = 368, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
