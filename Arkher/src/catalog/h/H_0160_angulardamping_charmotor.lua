-- ARKHER SYSTEM H.0160 :: Angular Damping Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0160"
	S.key = "arkher.physics.angulardamping.character_motion"
	S.name = "Angular Damping Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.angulardamping.query" }
	S.tags = { "h", "angulardamping", "charmotor", "physics" }
	S.description = "Angular Damping Character Motion: capsule move-and-slide with slopes, steps and jumps for the Angular Damping subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.angulardamping.character_motion", radius = 0.43, height = 1.88, maxSpeed = 8.80, jumpHeight = 1.20, stepOffset = 0.43 })
		inst.system = S
		inst.ctx = ctx
