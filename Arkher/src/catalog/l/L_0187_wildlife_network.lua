-- ARKHER SYSTEM L.0187 :: Wildlife Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0187"
	S.key = "arkher.sim.wildlife.route_network"
	S.name = "Wildlife Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wildlife.region_graph" }
	S.tags = { "l", "wildlife", "network", "sim" }
	S.description = "Wildlife Route Network: roads, rivers and routes between settlements for the Wildlife subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.wildlife.route_network" })
		inst.system = S
		inst.ctx = ctx
