-- ARKHER SYSTEM VD.0328 :: Economy Continuum Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0328"
	S.key = "arkher.contsim.economycont.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.economycont.sparse_residency" }
	S.tags = { "vd", "economycont", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.economycont.multi-scale_fidelity", levels = 5, baseTriangles = 165000 })
		inst.system = S
		inst.ctx = ctx
