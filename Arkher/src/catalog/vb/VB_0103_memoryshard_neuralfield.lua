-- ARKHER SYSTEM VB.0103 :: Memory Shard Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0103"
	S.key = "arkher.conttime.memoryshard.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memoryshard.coherence_guard" }
	S.tags = { "vb", "memoryshard", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.memoryshard.neural_field", dims = 12, hidden = 8, seed = 77680 })
		inst.system = S
		inst.ctx = ctx
