-- ARKHER SYSTEM G.0080 :: Disocclusion Handling Heuristic Policy
...
return function(A)
	...
	local S = {}
	S.id = "G.0080"
	S.key = "arkher.neural.disocclusion.heuristic_policy"
	S.name = "Disocclusion Handling Heuristic Policy"
	S.category = "G"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.disocclusion.result_cache" }
	S.tags = { "g", "disocclusion", "policy", "neural" }
	S.description = "Disocclusion Handling Heuristic Policy: rule fallback when the model is unavailable for the Disocclusion Handling subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.neural.disocclusion.heuristic_policy", algorithm = "wfq", starvationGuard = 62 })
		inst.system = S
		inst.ctx = ctx
