-- ARKHER SYSTEM VC.0196 :: Architect District Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VC.0196"
	S.key = "arkher.contneural.architectdistrict.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.architectdistrict.sparse_residency" }
	S.tags = { "vc", "architectdistrict", "multiscale", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contneural.architectdistrict.multi-scale_fidelity", levels = 4, baseTriangles = 135000 })
		inst.system = S
		inst.ctx = ctx
