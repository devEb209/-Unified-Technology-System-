-- ARKHER SYSTEM G.0431 :: Confidence Gating Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0431"
	S.key = "arkher.neural.confidence.error_analysis"
	S.name = "Confidence Gating Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.confidence.heuristic_policy" }
	S.tags = { "g", "confidence", "analyzer", "neural" }
	S.description = "Confidence Gating Error Analysis: residual and drift analysis for the Confidence Gating subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.confidence.error_analysis", window = 93, buckets = 9, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
