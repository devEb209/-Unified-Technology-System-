-- ARKHER SYSTEM Z.0756 :: World Compression Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0756"
	S.key = "arkher.origin.worldcompression.governance_policy"
	S.name = "World Compression Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.signal_composition" }
	S.tags = { "z", "worldcompression", "policy", "origin" }
	S.description = "World Compression Governance Policy: ordered rules governing when the technology may act for the World Compression subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.worldcompression.governance_policy", algorithm = "edf", starvationGuard = 25 })
		inst.system = S
		inst.ctx = ctx
