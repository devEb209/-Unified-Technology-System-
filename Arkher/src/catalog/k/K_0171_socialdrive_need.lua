-- ARKHER SYSTEM K.0171 :: Social Drive Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0171"
	S.key = "arkher.npc.socialdrive.drive_system"
	S.name = "Social Drive Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.socialdrive.memory" }
	S.tags = { "k", "socialdrive", "need", "npc" }
	S.description = "Social Drive Drive System: drives that decay, turn urgent and get satisfied for the Social Drive subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.socialdrive.drive_system" })
		inst.system = S
		inst.ctx = ctx
