-- ARKHER SYSTEM Z.0162 :: Self Analyzing Project Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0162"
	S.key = "arkher.origin.selfanalyzing.complexity_governance"
	S.name = "Self Analyzing Project Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.reality_layering" }
	S.tags = { "z", "selfanalyzing", "complexity", "origin" }
	S.description = "Self Analyzing Project Complexity Governance: measured scene cost turned into per-subsystem directives for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.selfanalyzing.complexity_governance", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
