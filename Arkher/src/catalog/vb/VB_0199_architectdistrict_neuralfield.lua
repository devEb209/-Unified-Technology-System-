-- ARKHER SYSTEM VB.0199 :: Architect District Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0199"
	S.key = "arkher.conttime.architectdistrict.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.architectdistrict.coherence_guard" }
	S.tags = { "vb", "architectdistrict", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.architectdistrict.neural_field", dims = 20, hidden = 16, seed = 12486 })
		inst.system = S
		inst.ctx = ctx
