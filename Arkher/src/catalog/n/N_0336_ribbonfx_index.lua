-- ARKHER SYSTEM N.0336 :: Ribbon Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0336"
	S.key = "arkher.vfx.ribbonfx.spatial_index"
	S.name = "Ribbon Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Ribbon"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.ribbonfx.quality_policy" }
	S.tags = { "n", "ribbonfx", "index", "vfx" }
	S.description = "Ribbon Spatial Index: spatial acceleration of effect queries and culling for the Ribbon subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.ribbonfx.spatial_index", mode = "hash", cellSize = 96 })
		inst.system = S
		inst.ctx = ctx
