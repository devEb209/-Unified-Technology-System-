-- ARKHER SYSTEM T.0242 :: Dialogue Generation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0242"
	S.key = "arkher.ai.dialoguegeneration.self_critique"
	S.name = "Dialogue Generation Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.dialoguegeneration.plan_workflow" }
	S.tags = { "t", "dialoguegeneration", "critic", "ai" }
	S.description = "Dialogue Generation Self Critique: weighted evaluation of the result against declared criteria for the Dialogue Generation subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.dialoguegeneration.self_critique", passMark = 0.80, reviseMark = 0.45, seed = 55105 })
		inst.system = S
		inst.ctx = ctx
