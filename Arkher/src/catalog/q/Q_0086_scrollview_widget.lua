-- ARKHER SYSTEM Q.0086 :: Scroll View Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0086"
	S.key = "arkher.ui.scrollview.widget_tree"
	S.name = "Scroll View Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Scroll View"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.scrollview.responsive_layout" }
	S.tags = { "q", "scrollview", "widget", "ui" }
	S.description = "Scroll View Widget Tree: retained widget nodes, properties, bindings and rendering for the Scroll View subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.scrollview.widget_tree", theme = "light", scale = 1.04 })
		inst.system = S
		inst.ctx = ctx
