-- ARKHER SYSTEM G.0405 :: Fallback Heuristic Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0405"
	S.key = "arkher.neural.fallbackheuristic.sampling_graph"
	S.name = "Fallback Heuristic Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.fallbackheuristic.training_ledger" }
	S.tags = { "g", "fallbackheuristic", "graph", "neural" }
	S.description = "Fallback Heuristic Sampling Graph: dependency graph of sampling stages for the Fallback Heuristic subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.fallbackheuristic.sampling_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
