-- ARKHER SYSTEM E.0248 :: Triplanar Projection Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0248"
	S.key = "arkher.material.triplanar.streaming"
	S.name = "Triplanar Projection Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.triplanar.parameter_budget" }
	S.tags = { "e", "triplanar", "streamer", "material" }
	S.description = "Triplanar Projection Streaming: residency and demand-driven texture streaming for the Triplanar Projection subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.triplanar.streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
