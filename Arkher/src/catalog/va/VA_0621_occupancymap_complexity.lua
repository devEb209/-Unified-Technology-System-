-- ARKHER SYSTEM VA.0621 :: Occupancy Map Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0621"
	S.key = "arkher.contworld.occupancymap.complexity_budget"
	S.name = "Occupancy Map Complexity Budget"
	S.category = "VA"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.occupancymap.world_memory_stream" }
	S.tags = { "va", "occupancymap", "complexity", "contworld" }
	S.description = "Occupancy Map Complexity Budget: complexity budgeting for the continuum for the Occupancy Map subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.occupancymap.complexity_budget", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
