-- ARKHER SYSTEM Z.0732 :: Knowledge Distillation Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0732"
	S.key = "arkher.origin.distillation.predictive_optimization"
	S.name = "Knowledge Distillation Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.distillation.adaptive_workflow" }
	S.tags = { "z", "distillation", "predictor", "origin" }
	S.description = "Knowledge Distillation Predictive Optimization: forecast-driven optimization before the cost is paid for the Knowledge Distillation subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.distillation.predictive_optimization", method = "ema", alpha = 0.44, window = 98 })
		inst.system = S
		inst.ctx = ctx
