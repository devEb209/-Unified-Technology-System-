-- ARKHER SYSTEM R.0002 :: Session Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0002"
	S.key = "arkher.net.session.time_sync"
	S.name = "Session Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Session"
	S.aspect = "Time Sync"
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.session.replication" }
	S.tags = { "r", "session", "netclock", "net" }
	S.description = "Session Time Sync: offset estimation, outlier rejection and jitter buffering for the Session subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.session.time_sync", tickRate = 30, bufferDelay = 0.110, maxSamples = 21 })
		inst.system = S
		inst.ctx = ctx
