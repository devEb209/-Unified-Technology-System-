-- ARKHER SYSTEM T.0021 :: Prompt Understanding Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0021"
	S.key = "arkher.ai.prompt.decision_policy"
	S.name = "Prompt Understanding Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.prompt.reasoning_graph" }
	S.tags = { "t", "prompt", "policy", "ai" }
	S.description = "Prompt Understanding Decision Policy: ordered rules deciding what the agent does next for the Prompt Understanding subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.prompt.decision_policy", algorithm = "lottery", starvationGuard = 55 })
		inst.system = S
		inst.ctx = ctx
