-- ARKHER SYSTEM VB.0022 :: Region Tile Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0022"
	S.key = "arkher.conttime.regiontile.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.regiontile.complexity_budget" }
	S.tags = { "vb", "regiontile", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.regiontile.simulation_fabric", budgetMs = 1.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
