-- ARKHER SYSTEM Z.0792 :: Attention Driven Detail Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0792"
	S.key = "arkher.origin.attentiondetail.predictive_optimization"
	S.name = "Attention Driven Detail Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.adaptive_workflow" }
	S.tags = { "z", "attentiondetail", "predictor", "origin" }
	S.description = "Attention Driven Detail Predictive Optimization: forecast-driven optimization before the cost is paid for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.attentiondetail.predictive_optimization", method = "linear", alpha = 0.21, window = 99 })
		inst.system = S
		inst.ctx = ctx
