-- ARKHER SYSTEM Q.0041 :: Label Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0041"
	S.key = "arkher.ui.label.navigation_graph"
	S.name = "Label Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Label"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.label.transition" }
	S.tags = { "q", "label", "graph", "ui" }
	S.description = "Label Navigation Graph: screens, routes and shortest path between them for the Label subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.label.navigation_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
