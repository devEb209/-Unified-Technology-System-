-- ARKHER SYSTEM N.0354 :: Laser Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0354"
	S.key = "arkher.vfx.laser.force_field"
	S.name = "Laser Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Laser"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.laser.particle_simulation" }
	S.tags = { "n", "laser", "forcefield", "vfx" }
	S.description = "Laser Force Field: wind, attraction, vortex, drag and curl turbulence for the Laser subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.laser.force_field", seed = 9902 })
		inst.system = S
		inst.ctx = ctx
