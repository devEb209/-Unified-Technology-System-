-- ARKHER SYSTEM I.0465 :: Procedural Animation Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0465"
	S.key = "arkher.anim.proceduralanim.pose_cache"
	S.name = "Procedural Animation Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.proceduralanim.playback_pipeline" }
	S.tags = { "i", "proceduralanim", "cache", "anim" }
	S.description = "Procedural Animation Pose Cache: reuse of sampled poses across frames and instances for the Procedural Animation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.proceduralanim.pose_cache", policy = "lfu", capacity = 301, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
