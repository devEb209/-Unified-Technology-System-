-- ARKHER SYSTEM VB.0164 :: Coherence Seam World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0164"
	S.key = "arkher.conttime.coherenceseam.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.coherenceseam.neural_field" }
	S.tags = { "vb", "coherenceseam", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.coherenceseam.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
