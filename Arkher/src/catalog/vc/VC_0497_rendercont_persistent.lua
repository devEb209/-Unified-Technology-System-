-- ARKHER SYSTEM VC.0497 :: Rendering Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0497"
	S.key = "arkher.contneural.rendercont.persistent_state"
	S.name = "Rendering Continuum Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.rendercont.multi-scale_fidelity" }
	S.tags = { "vc", "rendercont", "persistent", "contneural" }
	S.description = "Rendering Continuum Persistent State: epoch-stamped persistent history and rollback for the Rendering Continuum subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.rendercont.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
