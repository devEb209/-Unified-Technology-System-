-- ARKHER SYSTEM H.0508 :: Motorized Joint Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0508"
	S.key = "arkher.physics.motorjoint.constraint_solver"
	S.name = "Motorized Joint Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.motorjoint.contact_generation" }
	S.tags = { "h", "motorjoint", "constraint", "physics" }
	S.description = "Motorized Joint Constraint Solver: sequential impulses, friction, joints and warm starting for the Motorized Joint subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.motorjoint.constraint_solver", iterations = 12, baumgarte = 0.18, warmStart = true })
		inst.system = S
		inst.ctx = ctx
