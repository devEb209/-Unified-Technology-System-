-- ARKHER SYSTEM Q.0050 :: Icon Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0050"
	S.key = "arkher.ui.icon.widget_tree"
	S.name = "Icon Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Icon"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.icon.responsive_layout" }
	S.tags = { "q", "icon", "widget", "ui" }
	S.description = "Icon Widget Tree: retained widget nodes, properties, bindings and rendering for the Icon subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.icon.widget_tree", theme = "dark", scale = 1.11 })
		inst.system = S
		inst.ctx = ctx
