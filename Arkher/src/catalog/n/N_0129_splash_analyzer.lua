-- ARKHER SYSTEM N.0129 :: Water Splash Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0129"
	S.key = "arkher.vfx.splash.analysis"
	S.name = "Water Splash Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Water Splash"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.splash.spatial_index" }
	S.tags = { "n", "splash", "analyzer", "vfx" }
	S.description = "Water Splash Analysis: cost, overdraw and stability analysis of the effect for the Water Splash subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.splash.analysis", window = 193, buckets = 13, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
