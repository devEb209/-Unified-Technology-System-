-- ARKHER SYSTEM W.0349 :: Subtitle Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0349"
	S.key = "arkher.cine.subtitle.sequence_timeline"
	S.name = "Subtitle Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Subtitle"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "subtitle", "timeline", "cine" }
	S.description = "Subtitle Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Subtitle subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.subtitle.sequence_timeline", duration = 7.0, rate = 1.15 })
		inst.system = S
		inst.ctx = ctx
