-- ARKHER SYSTEM VA.0119 :: Temporal Slice Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0119"
	S.key = "arkher.contworld.temporalslice.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.temporalslice.simulation_fabric" }
	S.tags = { "va", "temporalslice", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.temporalslice.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
