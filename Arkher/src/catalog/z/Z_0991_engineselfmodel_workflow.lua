-- ARKHER SYSTEM Z.0991 :: Engine Self Model Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0991"
	S.key = "arkher.origin.engineselfmodel.adaptive_workflow"
	S.name = "Engine Self Model Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.engineselfmodel.self_critique" }
	S.tags = { "z", "engineselfmodel", "workflow", "origin" }
	S.description = "Engine Self Model Adaptive Workflow: verified, retryable, reversible execution plans for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.engineselfmodel.adaptive_workflow", maxRetries = 3, budget = 90 })
		inst.system = S
		inst.ctx = ctx
