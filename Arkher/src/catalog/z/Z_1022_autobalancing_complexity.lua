-- ARKHER SYSTEM Z.1022 :: Autonomous Balancing Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.1022"
	S.key = "arkher.origin.autobalancing.complexity_governance"
	S.name = "Autonomous Balancing Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autobalancing.reality_layering" }
	S.tags = { "z", "autobalancing", "complexity", "origin" }
	S.description = "Autonomous Balancing Complexity Governance: measured scene cost turned into per-subsystem directives for the Autonomous Balancing subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.autobalancing.complexity_governance", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
