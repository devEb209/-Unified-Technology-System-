-- ARKHER SYSTEM G.0485 :: Evaluation Harness Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0485"
	S.key = "arkher.neural.evalharness.result_cache"
	S.name = "Evaluation Harness Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.evalharness.compute_budget" }
	S.tags = { "g", "evalharness", "cache", "neural" }
	S.description = "Evaluation Harness Result Cache: cached inference results keyed by input for the Evaluation Harness subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.evalharness.result_cache", policy = "lru", capacity = 86, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
