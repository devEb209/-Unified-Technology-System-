-- ARKHER SYSTEM T.0043 :: Goal Reasoning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0043"
	S.key = "arkher.ai.goalreasoning.intent_understanding"
	S.name = "Goal Reasoning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "goalreasoning", "intent", "ai" }
	S.description = "Goal Reasoning Intent Understanding: natural language turned into an actionable, scored intent for the Goal Reasoning subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.goalreasoning.intent_understanding", minConfidence = 0.36 })
		inst.system = S
		inst.ctx = ctx
