-- ARKHER SYSTEM VD.0403 :: Perception Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0403"
	S.key = "arkher.contsim.perceptioncont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.perceptioncont.coherence_guard" }
	S.tags = { "vd", "perceptioncont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.perceptioncont.neural_field", dims = 24, hidden = 20, seed = 29255 })
		inst.system = S
		inst.ctx = ctx
