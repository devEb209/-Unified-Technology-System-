-- ARKHER SYSTEM W.0034 :: Scene Cut Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0034"
	S.key = "arkher.cine.scenecut.frame_budget"
	S.name = "Scene Cut Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Scene Cut"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.scenecut.event_ledger" }
	S.tags = { "w", "scenecut", "budgeter", "cine" }
	S.description = "Scene Cut Frame Budget: per-frame cost budget for the cinematic systems for the Scene Cut subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.scenecut.frame_budget", total = 74, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
