-- ARKHER SYSTEM F.0456 :: Frustum Culling Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0456"
	S.key = "arkher.render.frustum.adaptive_resolution"
	S.name = "Frustum Culling Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.frustum.temporal_resolve" }
	S.tags = { "f", "frustum", "upscaler", "render" }
	S.description = "Frustum Culling Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Frustum Culling subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.frustum.adaptive_resolution", targetMs = 12.10, index = 4, sharpness = 0.21 })
		inst.system = S
		inst.ctx = ctx
