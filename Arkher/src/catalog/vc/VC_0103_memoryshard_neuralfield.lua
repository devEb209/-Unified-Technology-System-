-- ARKHER SYSTEM VC.0103 :: Memory Shard Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0103"
	S.key = "arkher.contneural.memoryshard.neural_field"
	S.name = "Memory Shard Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memoryshard.coherence_guard" }
	S.tags = { "vc", "memoryshard", "neuralfield", "contneural" }
	S.description = "Memory Shard Neural Field: neural field encoding and reconstruction for the Memory Shard subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.memoryshard.neural_field", dims = 24, hidden = 20, seed = 73507 })
		inst.system = S
		inst.ctx = ctx
