-- ARKHER SYSTEM VA.0566 :: Mobile Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0566"
	S.key = "arkher.contworld.mobilecont.epoch_clock"
	S.name = "Mobile Continuum Epoch Clock"
	S.category = "VA"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.mobilecont.infinite_grid" }
	S.tags = { "va", "mobilecont", "epoch", "contworld" }
	S.description = "Mobile Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Mobile Continuum subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.mobilecont.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
