-- ARKHER SYSTEM Z.1071 :: World Dream State Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.1071"
	S.key = "arkher.origin.worlddream.adaptive_workflow"
	S.name = "World Dream State Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.self_critique" }
	S.tags = { "z", "worlddream", "workflow", "origin" }
	S.description = "World Dream State Adaptive Workflow: verified, retryable, reversible execution plans for the World Dream State subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.worlddream.adaptive_workflow", maxRetries = 2, budget = 140 })
		inst.system = S
		inst.ctx = ctx
