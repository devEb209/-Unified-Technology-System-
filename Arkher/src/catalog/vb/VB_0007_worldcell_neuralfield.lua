-- ARKHER SYSTEM VB.0007 :: World Grid Cell Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0007"
	S.key = "arkher.conttime.worldcell.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldcell.coherence_guard" }
	S.tags = { "vb", "worldcell", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.worldcell.neural_field", dims = 20, hidden = 16, seed = 74110 })
		inst.system = S
		inst.ctx = ctx
