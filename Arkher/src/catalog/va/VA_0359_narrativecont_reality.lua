-- ARKHER SYSTEM VA.0359 :: Narrative Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0359"
	S.key = "arkher.contworld.narrativecont.reality_continuum"
	S.name = "Narrative Continuum Reality Continuum"
	S.category = "VA"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.narrativecont.simulation_fabric" }
	S.tags = { "va", "narrativecont", "reality", "contworld" }
	S.description = "Narrative Continuum Reality Continuum: stacked reality layers of the continuum for the Narrative Continuum subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.narrativecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
