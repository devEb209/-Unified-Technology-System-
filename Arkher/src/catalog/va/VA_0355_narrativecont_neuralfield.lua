-- ARKHER SYSTEM VA.0355 :: Narrative Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0355"
	S.key = "arkher.contworld.narrativecont.neural_field"
	S.name = "Narrative Continuum Neural Field"
	S.category = "VA"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.narrativecont.coherence_guard" }
	S.tags = { "va", "narrativecont", "neuralfield", "contworld" }
	S.description = "Narrative Continuum Neural Field: neural field encoding and reconstruction for the Narrative Continuum subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.narrativecont.neural_field", dims = 24, hidden = 20, seed = 99699 })
		inst.system = S
		inst.ctx = ctx
