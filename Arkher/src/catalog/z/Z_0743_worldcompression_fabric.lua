-- ARKHER SYSTEM Z.0743 :: World Compression Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0743"
	S.key = "arkher.origin.worldcompression.simulation_fabric"
	S.name = "World Compression Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.complexity_governance" }
	S.tags = { "z", "worldcompression", "fabric", "origin" }
	S.description = "World Compression Simulation Fabric: every simulation domain stepped under one budgeted clock for the World Compression subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.worldcompression.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
