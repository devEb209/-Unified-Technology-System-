-- ARKHER SYSTEM Z.1065 :: World Dream State World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.1065"
	S.key = "arkher.origin.worlddream.world_memory"
	S.name = "World Dream State World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.autonomous_pipeline" }
	S.tags = { "z", "worlddream", "worldmemory", "origin" }
	S.description = "World Dream State World Memory: epoch-stamped persistent history with compaction and checkpoints for the World Dream State subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.worlddream.world_memory", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
