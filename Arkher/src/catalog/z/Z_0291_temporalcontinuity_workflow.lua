-- ARKHER SYSTEM Z.0291 :: Temporal Continuity Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0291"
	S.key = "arkher.origin.temporalcontinuity.adaptive_workflow"
	S.name = "Temporal Continuity Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.temporalcontinuity.self_critique" }
	S.tags = { "z", "temporalcontinuity", "workflow", "origin" }
	S.description = "Temporal Continuity Adaptive Workflow: verified, retryable, reversible execution plans for the Temporal Continuity subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.temporalcontinuity.adaptive_workflow", maxRetries = 3, budget = 90 })
		inst.system = S
		inst.ctx = ctx
