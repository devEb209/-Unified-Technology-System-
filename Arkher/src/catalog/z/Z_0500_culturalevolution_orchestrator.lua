-- ARKHER SYSTEM Z.0500 :: Cultural Evolution Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0500"
	S.key = "arkher.origin.culturalevolution.orchestration"
	S.name = "Cultural Evolution Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.residency_streaming" }
	S.tags = { "z", "culturalevolution", "orchestrator", "origin" }
	S.description = "Cultural Evolution Orchestration: lifecycle and phase orchestration of the technology for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.culturalevolution.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
