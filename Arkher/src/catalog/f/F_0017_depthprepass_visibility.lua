-- ARKHER SYSTEM F.0017 :: Depth Prepass Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0017"
	S.key = "arkher.render.depthprepass.visibility_set"
	S.name = "Depth Prepass Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.depthprepass.view_and_culling" }
	S.tags = { "f", "depthprepass", "visibility", "render" }
	S.description = "Depth Prepass Visibility Set: cell, portal and occluder visibility for the Depth Prepass subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.depthprepass.visibility_set", maxDepth = 2 })
		inst.system = S
		inst.ctx = ctx
