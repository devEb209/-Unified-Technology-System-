-- ARKHER SYSTEM L.0166 :: Livestock Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0166"
	S.key = "arkher.sim.livestock.simulation_core"
	S.name = "Livestock Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "livestock", "simulation", "sim" }
	S.description = "Livestock Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Livestock subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.livestock.simulation_core", fullRadius = 200, reducedRadius = 600, budget = 88 })
		inst.system = S
		inst.ctx = ctx
