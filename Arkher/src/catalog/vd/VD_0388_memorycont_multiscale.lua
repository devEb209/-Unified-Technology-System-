-- ARKHER SYSTEM VD.0388 :: Memory Continuum Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0388"
	S.key = "arkher.contsim.memorycont.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memorycont.sparse_residency" }
	S.tags = { "vd", "memorycont", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.memorycont.multi-scale_fidelity", levels = 4, baseTriangles = 120000 })
		inst.system = S
		inst.ctx = ctx
