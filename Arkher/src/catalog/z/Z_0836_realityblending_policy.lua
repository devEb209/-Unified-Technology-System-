-- ARKHER SYSTEM Z.0836 :: Reality Blending Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0836"
	S.key = "arkher.origin.realityblending.governance_policy"
	S.name = "Reality Blending Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.signal_composition" }
	S.tags = { "z", "realityblending", "policy", "origin" }
	S.description = "Reality Blending Governance Policy: ordered rules governing when the technology may act for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.realityblending.governance_policy", algorithm = "edf", starvationGuard = 45 })
		inst.system = S
		inst.ctx = ctx
