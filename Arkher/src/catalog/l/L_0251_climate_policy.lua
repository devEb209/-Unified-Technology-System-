-- ARKHER SYSTEM L.0251 :: Climate Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0251"
	S.key = "arkher.sim.climate.fidelity_policy"
	S.name = "Climate Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.climate.streaming" }
	S.tags = { "l", "climate", "policy", "sim" }
	S.description = "Climate Fidelity Policy: rules that pick full, cohort or statistical simulation for the Climate subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.climate.fidelity_policy", algorithm = "lottery", starvationGuard = 47 })
		inst.system = S
		inst.ctx = ctx
