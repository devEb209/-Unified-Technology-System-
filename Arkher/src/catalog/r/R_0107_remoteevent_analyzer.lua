-- ARKHER SYSTEM R.0107 :: Remote Event Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0107"
	S.key = "arkher.net.remoteevent.latency_analysis"
	S.name = "Remote Event Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Remote Event"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remoteevent.audit_ledger" }
	S.tags = { "r", "remoteevent", "analyzer", "net" }
	S.description = "Remote Event Latency Analysis: round trip, jitter and loss analysis for the Remote Event subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.remoteevent.latency_analysis", window = 245, buckets = 17, threshold = 4.70 })
		inst.system = S
		inst.ctx = ctx
