-- ARKHER SYSTEM VB.0465 :: Audio Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0465"
	S.key = "arkher.conttime.audiocont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.audiocont.world_memory_stream" }
	S.tags = { "vb", "audiocont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.audiocont.complexity_budget", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
