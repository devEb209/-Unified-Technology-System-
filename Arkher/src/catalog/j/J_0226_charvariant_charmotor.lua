-- ARKHER SYSTEM J.0226 :: Character Variant Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0226"
	S.key = "arkher.character.charvariant.locomotion"
	S.name = "Character Variant Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.charvariant.physical_response" }
	S.tags = { "j", "charvariant", "charmotor", "character" }
	S.description = "Character Variant Locomotion: capsule locomotion driving the character for the Character Variant subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.charvariant.locomotion", radius = 0.50, height = 1.75, maxSpeed = 9.50, jumpHeight = 1.90, stepOffset = 0.50 })
		inst.system = S
		inst.ctx = ctx
