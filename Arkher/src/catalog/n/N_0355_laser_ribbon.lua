-- ARKHER SYSTEM N.0355 :: Laser Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0355"
	S.key = "arkher.vfx.laser.ribbon_and_trail"
	S.name = "Laser Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Laser"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.laser.force_field" }
	S.tags = { "n", "laser", "ribbon", "vfx" }
	S.description = "Laser Ribbon And Trail: trail points, tapering, beams and decimation for the Laser subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.laser.ribbon_and_trail", maxPoints = 48, lifetime = 1.50, minDistance = 0.10, width = 1.20 })
		inst.system = S
		inst.ctx = ctx
