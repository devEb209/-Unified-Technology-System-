-- ARKHER SYSTEM O.0291 :: UI Sound Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0291"
	S.key = "arkher.audio.uisound.spatialization"
	S.name = "UI Sound Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "UI Sound"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.uisound.mixer_bus" }
	S.tags = { "o", "uisound", "spatialaudio", "audio" }
	S.description = "UI Sound Spatialization: distance attenuation, panning, occlusion and doppler for the UI Sound subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.uisound.spatialization", model = "inverse", refDistance = 6, maxDistance = 180, rolloff = 0.95, maxVoices = 24 })
		inst.system = S
		inst.ctx = ctx
