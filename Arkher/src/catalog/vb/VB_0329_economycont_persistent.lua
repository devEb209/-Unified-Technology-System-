-- ARKHER SYSTEM VB.0329 :: Economy Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0329"
	S.key = "arkher.conttime.economycont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.economycont.multi-scale_fidelity" }
	S.tags = { "vb", "economycont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.economycont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
