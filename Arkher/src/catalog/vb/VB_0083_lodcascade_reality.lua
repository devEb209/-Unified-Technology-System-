-- ARKHER SYSTEM VB.0083 :: LOD Cascade Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0083"
	S.key = "arkher.conttime.lodcascade.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lodcascade.simulation_fabric" }
	S.tags = { "vb", "lodcascade", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.lodcascade.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
