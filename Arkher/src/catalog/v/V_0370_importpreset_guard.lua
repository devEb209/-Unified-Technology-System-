-- ARKHER SYSTEM V.0370 :: Import Preset Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0370"
	S.key = "arkher.asset.importpreset.validation_guard"
	S.name = "Import Preset Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.importpreset.size_budget" }
	S.tags = { "v", "importpreset", "guard", "asset" }
	S.description = "Import Preset Validation Guard: rate limiting and capability checks on the import path for the Import Preset subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.importpreset.validation_guard", algorithm = "sliding", capacity = 154, refillPerSec = 39, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
