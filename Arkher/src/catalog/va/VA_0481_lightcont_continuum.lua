-- ARKHER SYSTEM VA.0481 :: Lighting Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0481"
	S.key = "arkher.contworld.lightcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "lightcont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.lightcont.infinite_grid", cellSize = 128, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
