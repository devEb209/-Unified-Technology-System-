-- ARKHER SYSTEM VB.0070 :: Sparse Page Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0070"
	S.key = "arkher.conttime.sparsepage.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.sparsepage.complexity_budget" }
	S.tags = { "vb", "sparsepage", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.sparsepage.simulation_fabric", budgetMs = 2.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
