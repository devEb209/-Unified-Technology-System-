-- ARKHER SYSTEM VC.0348 :: Society Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0348"
	S.key = "arkher.contneural.societycont.emergence_continuum"
	S.name = "Society Continuum Emergence Continuum"
	S.category = "VC"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.societycont.reality_continuum" }
	S.tags = { "vc", "societycont", "emergence", "contneural" }
	S.description = "Society Continuum Emergence Continuum: emergence detection over the continuum for the Society Continuum subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.societycont.emergence_continuum", windowSize = 4, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
