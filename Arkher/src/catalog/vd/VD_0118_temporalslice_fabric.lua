-- ARKHER SYSTEM VD.0118 :: Temporal Slice Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0118"
	S.key = "arkher.contsim.temporalslice.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.temporalslice.complexity_budget" }
	S.tags = { "vd", "temporalslice", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.temporalslice.simulation_fabric", budgetMs = 3.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
