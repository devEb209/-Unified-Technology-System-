-- ARKHER SYSTEM VC.0619 :: Occupancy Map Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0619"
	S.key = "arkher.contneural.occupancymap.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.occupancymap.coherence_guard" }
	S.tags = { "vc", "occupancymap", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.occupancymap.neural_field", dims = 16, hidden = 12, seed = 18557 })
		inst.system = S
		inst.ctx = ctx
