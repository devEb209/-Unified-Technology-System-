-- ARKHER SYSTEM F.0449 :: Frustum Culling Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0449"
	S.key = "arkher.render.frustum.frame_graph"
	S.name = "Frustum Culling Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "frustum", "framegraph", "render" }
	S.description = "Frustum Culling Frame Graph: declared passes, culling, ordering and aliasing for the Frustum Culling subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.frustum.frame_graph", budgetMs = 12.00 })
		inst.system = S
		inst.ctx = ctx
