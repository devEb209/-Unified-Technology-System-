-- ARKHER SYSTEM P.0236 :: Quest Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0236"
	S.key = "arkher.play.questsys.balance_analysis"
	S.name = "Quest Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Quest"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.questsys.event_ledger" }
	S.tags = { "p", "questsys", "analyzer", "play" }
	S.description = "Quest Balance Analysis: distribution, outlier and pacing analysis for the Quest subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.questsys.balance_analysis", window = 157, buckets = 9, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
