-- ARKHER SYSTEM VC.0370 :: Quest Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0370"
	S.key = "arkher.contneural.questcont.simulation_fabric"
	S.name = "Quest Continuum Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.questcont.complexity_budget" }
	S.tags = { "vc", "questcont", "fabric", "contneural" }
	S.description = "Quest Continuum Simulation Fabric: fabric stepping the continuum domains for the Quest Continuum subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.questcont.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
