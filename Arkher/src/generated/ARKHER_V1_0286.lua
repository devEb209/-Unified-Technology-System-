--!strict
-- Terragen Sky — CORE Node_Flow #0286
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Terragen Sky — CORE Node_Flow #0286", size=Vector2.new(640, 440), pos=UDim2.fromOffset(218, 262), parent=parent, icon="⬣"})
