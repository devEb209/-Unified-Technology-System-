-- ARKHER SYSTEM T.0429 :: Mobile Reasoning Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0429"
	S.key = "arkher.ai.mobilereasoning.working_memory"
	S.name = "Mobile Reasoning Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.mobilereasoning.outcome_prediction" }
	S.tags = { "t", "mobilereasoning", "memory", "ai" }
	S.description = "Mobile Reasoning Working Memory: decaying, consolidating recall of what the agent learned for the Mobile Reasoning subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.mobilereasoning.working_memory", capacity = 96, decayRate = 0.030, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
