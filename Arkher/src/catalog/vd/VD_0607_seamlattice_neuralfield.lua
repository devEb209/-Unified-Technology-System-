-- ARKHER SYSTEM VD.0607 :: Seam Lattice Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0607"
	S.key = "arkher.contsim.seamlattice.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.seamlattice.coherence_guard" }
	S.tags = { "vd", "seamlattice", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.seamlattice.neural_field", dims = 12, hidden = 8, seed = 49832 })
		inst.system = S
		inst.ctx = ctx
