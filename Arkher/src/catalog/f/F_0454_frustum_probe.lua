-- ARKHER SYSTEM F.0454 :: Frustum Culling Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0454"
	S.key = "arkher.render.frustum.probe_volume"
	S.name = "Frustum Culling Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.frustum.lighting_rig" }
	S.tags = { "f", "frustum", "probe", "render" }
	S.description = "Frustum Culling Probe Volume: irradiance probes encoded in spherical harmonics for the Frustum Culling subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.frustum.probe_volume", spacing = 32 })
		inst.system = S
		inst.ctx = ctx
