-- ARKHER SYSTEM Q.0161 :: Navigation Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0161"
	S.key = "arkher.ui.navigation.navigation_graph"
	S.name = "Navigation Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Navigation"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.navigation.transition" }
	S.tags = { "q", "navigation", "graph", "ui" }
	S.description = "Navigation Navigation Graph: screens, routes and shortest path between them for the Navigation subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.navigation.navigation_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
