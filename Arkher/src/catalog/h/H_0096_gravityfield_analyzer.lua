-- ARKHER SYSTEM H.0096 :: Gravity Field Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0096"
	S.key = "arkher.physics.gravityfield.analysis"
	S.name = "Gravity Field Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.gravityfield.result_cache" }
	S.tags = { "h", "gravityfield", "analyzer", "physics" }
	S.description = "Gravity Field Analysis: energy, jitter and cost analysis of the simulation for the Gravity Field subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.gravityfield.analysis", window = 140, buckets = 12, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
