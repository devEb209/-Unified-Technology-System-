-- ARKHER SYSTEM F.0567 :: UI Rendering Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0567"
	S.key = "arkher.render.uirender.temporal_resolve"
	S.name = "UI Rendering Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "UI Rendering"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.uirender.probe_volume" }
	S.tags = { "f", "uirender", "temporal", "render" }
	S.description = "UI Rendering Temporal Resolve: history reprojection with neighbourhood clamping for the UI Rendering subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.uirender.temporal_resolve", feedback = 0.84, phase = 8 })
		inst.system = S
		inst.ctx = ctx
