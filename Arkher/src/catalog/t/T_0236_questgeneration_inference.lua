-- ARKHER SYSTEM T.0236 :: Quest Generation Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0236"
	S.key = "arkher.ai.questgeneration.model_inference"
	S.name = "Quest Generation Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.questgeneration.action_planner" }
	S.tags = { "t", "questgeneration", "inference", "ai" }
	S.description = "Quest Generation Model Inference: quantized inference with batching and budget for the Quest Generation subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.questgeneration.model_inference", seed = 90591 })
		inst.system = S
		inst.ctx = ctx
