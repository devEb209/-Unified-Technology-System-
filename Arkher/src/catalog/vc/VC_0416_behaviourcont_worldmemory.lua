-- ARKHER SYSTEM VC.0416 :: Behaviour Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0416"
	S.key = "arkher.contneural.behaviourcont.world_memory_stream"
	S.name = "Behaviour Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.behaviourcont.neural_field" }
	S.tags = { "vc", "behaviourcont", "worldmemory", "contneural" }
	S.description = "Behaviour Continuum World Memory Stream: world memory continuum over epochs for the Behaviour Continuum subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.behaviourcont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
