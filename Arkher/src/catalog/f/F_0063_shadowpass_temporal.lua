-- ARKHER SYSTEM F.0063 :: Shadow Pass Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0063"
	S.key = "arkher.render.shadowpass.temporal_resolve"
	S.name = "Shadow Pass Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Shadow Pass"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.shadowpass.probe_volume" }
	S.tags = { "f", "shadowpass", "temporal", "render" }
	S.description = "Shadow Pass Temporal Resolve: history reprojection with neighbourhood clamping for the Shadow Pass subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.shadowpass.temporal_resolve", feedback = 0.90, phase = 8 })
		inst.system = S
		inst.ctx = ctx
