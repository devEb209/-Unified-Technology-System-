-- ARKHER SYSTEM R.0172 :: Interpolation Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0172"
	S.key = "arkher.net.interpolation.transport_graph"
	S.name = "Interpolation Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.interpolation.prediction_and_reconciliation" }
	S.tags = { "r", "interpolation", "network", "net" }
	S.description = "Interpolation Transport Graph: topology, capacity and routing between endpoints for the Interpolation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.interpolation.transport_graph" })
		inst.system = S
		inst.ctx = ctx
