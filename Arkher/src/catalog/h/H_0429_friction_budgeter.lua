-- ARKHER SYSTEM H.0429 :: Friction Model Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0429"
	S.key = "arkher.physics.friction.budget_governor"
	S.name = "Friction Model Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.friction.broadphase_index" }
	S.tags = { "h", "friction", "budgeter", "physics" }
	S.description = "Friction Model Budget Governor: simulation time budget allocation across islands for the Friction Model subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.friction.budget_governor", total = 247, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
