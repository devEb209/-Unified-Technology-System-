-- ARKHER SYSTEM Z.0538 :: Migration Dynamics Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0538"
	S.key = "arkher.origin.migrationdynamics.budget_governor"
	S.name = "Migration Dynamics Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.migrationdynamics.behaviour_analysis" }
	S.tags = { "z", "migrationdynamics", "budgeter", "origin" }
	S.description = "Migration Dynamics Budget Governor: allocation of a scarce resource across the technology's consumers for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.migrationdynamics.budget_governor", total = 158, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
