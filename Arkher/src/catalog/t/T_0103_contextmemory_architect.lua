-- ARKHER SYSTEM T.0103 :: Context Memory World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0103"
	S.key = "arkher.ai.contextmemory.world_architect"
	S.name = "Context Memory World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.contextmemory.self_critique" }
	S.tags = { "t", "contextmemory", "architect", "ai" }
	S.description = "Context Memory World Architect: composition of a whole world plan with conserved budgets for the Context Memory subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.contextmemory.world_architect", budget = 1400, seed = 72218 })
		inst.system = S
		inst.ctx = ctx
