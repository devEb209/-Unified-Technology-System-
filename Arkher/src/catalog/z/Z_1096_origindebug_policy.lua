-- ARKHER SYSTEM Z.1096 :: Original Tech Debug Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.1096"
	S.key = "arkher.origin.origindebug.governance_policy"
	S.name = "Original Tech Debug Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.origindebug.signal_composition" }
	S.tags = { "z", "origindebug", "policy", "origin" }
	S.description = "Original Tech Debug Governance Policy: ordered rules governing when the technology may act for the Original Tech Debug subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.origindebug.governance_policy", algorithm = "lottery", starvationGuard = 59 })
		inst.system = S
		inst.ctx = ctx
