-- ARKHER SYSTEM K.0164 :: Safety Drive Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0164"
	S.key = "arkher.npc.safetydrive.crowd_steering"
	S.name = "Safety Drive Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.safetydrive.navigation" }
	S.tags = { "k", "safetydrive", "crowd", "npc" }
	S.description = "Safety Drive Crowd Steering: local avoidance, cohesion and arrival at scale for the Safety Drive subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.safetydrive.crowd_steering", radius = 0.70, maxSpeed = 4.60, cellSize = 10 })
		inst.system = S
		inst.ctx = ctx
