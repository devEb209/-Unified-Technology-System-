-- ARKHER SYSTEM G.0050 :: Frame Interpolation Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0050"
	S.key = "arkher.neural.frameinterp.compute_budget"
	S.name = "Frame Interpolation Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.frameinterp.quality_predictor" }
	S.tags = { "g", "frameinterp", "budgeter", "neural" }
	S.description = "Frame Interpolation Compute Budget: inference time budget allocation for the Frame Interpolation subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.frameinterp.compute_budget", total = 205, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
