-- ARKHER SYSTEM E.0503 :: Shader Graph Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0503"
	S.key = "arkher.material.shadergraph.streaming"
	S.name = "Shader Graph Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Shader Graph"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.shadergraph.parameter_budget" }
	S.tags = { "e", "shadergraph", "streamer", "material" }
	S.description = "Shader Graph Streaming: residency and demand-driven texture streaming for the Shader Graph subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.shadergraph.streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
