-- ARKHER SYSTEM G.0397 :: Fallback Heuristic Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0397"
	S.key = "arkher.neural.fallbackheuristic.model_registry"
	S.name = "Fallback Heuristic Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.fallbackheuristic.reconstruction" }
	S.tags = { "g", "fallbackheuristic", "registry", "neural" }
	S.description = "Fallback Heuristic Model Registry: named models and their lifecycle for the Fallback Heuristic subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.fallbackheuristic.model_registry" })
		inst.system = S
		inst.ctx = ctx
