-- ARKHER SYSTEM H.0379 :: Collision Filter Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0379"
	S.key = "arkher.physics.collisionfilter.body_dynamics"
	S.name = "Collision Filter Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "collisionfilter", "rigidbody", "physics" }
	S.description = "Collision Filter Body Dynamics: integration, impulses, damping and sleeping of a body for the Collision Filter subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.collisionfilter.body_dynamics", mass = 25.00, radius = 0.50, restitution = 0.44, friction = 0.44, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
