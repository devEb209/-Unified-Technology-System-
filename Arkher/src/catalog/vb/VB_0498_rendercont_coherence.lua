-- ARKHER SYSTEM VB.0498 :: Rendering Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0498"
	S.key = "arkher.conttime.rendercont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.rendercont.persistent_state" }
	S.tags = { "vb", "rendercont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.rendercont.coherence_guard", window = 133, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
