-- ARKHER SYSTEM E.0057 :: Roughness Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0057"
	S.key = "arkher.material.roughness.analysis"
	S.name = "Roughness Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Roughness"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.roughness.instance_cache" }
	S.tags = { "e", "roughness", "analyzer", "material" }
	S.description = "Roughness Analysis: cost, redundancy and outlier analysis for the Roughness subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.roughness.analysis", window = 107, buckets = 19, threshold = 4.90 })
		inst.system = S
		inst.ctx = ctx
