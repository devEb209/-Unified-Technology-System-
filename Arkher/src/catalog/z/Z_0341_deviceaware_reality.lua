-- ARKHER SYSTEM Z.0341 :: Device Aware Fidelity Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0341"
	S.key = "arkher.origin.deviceaware.reality_layering"
	S.name = "Device Aware Fidelity Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "deviceaware", "reality", "origin" }
	S.description = "Device Aware Fidelity Reality Layering: stacked authored, simulated, proposed and player realities for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.deviceaware.reality_layering" })
		inst.system = S
		inst.ctx = ctx
