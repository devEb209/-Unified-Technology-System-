-- ARKHER SYSTEM T.0285 :: Balance Tuning World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0285"
	S.key = "arkher.ai.balancetuning.world_architect"
	S.name = "Balance Tuning World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.balancetuning.self_critique" }
	S.tags = { "t", "balancetuning", "architect", "ai" }
	S.description = "Balance Tuning World Architect: composition of a whole world plan with conserved budgets for the Balance Tuning subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.balancetuning.world_architect", budget = 700, seed = 96381 })
		inst.system = S
		inst.ctx = ctx
