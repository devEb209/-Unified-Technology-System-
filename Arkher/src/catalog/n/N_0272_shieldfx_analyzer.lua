-- ARKHER SYSTEM N.0272 :: Shield Effect Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0272"
	S.key = "arkher.vfx.shieldfx.analysis"
	S.name = "Shield Effect Analysis"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.shieldfx.spatial_index" }
	S.tags = { "n", "shieldfx", "analyzer", "vfx" }
	S.description = "Shield Effect Analysis: cost, overdraw and stability analysis of the effect for the Shield Effect subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.shieldfx.analysis", window = 216, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
