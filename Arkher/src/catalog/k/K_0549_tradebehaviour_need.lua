-- ARKHER SYSTEM K.0549 :: Trade Behaviour Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0549"
	S.key = "arkher.npc.tradebehaviour.drive_system"
	S.name = "Trade Behaviour Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.tradebehaviour.memory" }
	S.tags = { "k", "tradebehaviour", "need", "npc" }
	S.description = "Trade Behaviour Drive System: drives that decay, turn urgent and get satisfied for the Trade Behaviour subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.tradebehaviour.drive_system" })
		inst.system = S
		inst.ctx = ctx
