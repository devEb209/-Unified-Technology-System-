-- ARKHER SYSTEM N.0274 :: Heal Effect Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0274"
	S.key = "arkher.vfx.healfx.emission"
	S.name = "Heal Effect Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Heal Effect"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "healfx", "emitter", "vfx" }
	S.description = "Heal Effect Emission: shaped, rate and burst emission of new particles for the Heal Effect subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.healfx.emission", shape = "sphere", rate = 53, speed = 4.30, life = 1.10, budget = 448, seed = 51213 })
		inst.system = S
		inst.ctx = ctx
