-- ARKHER SYSTEM I.0135 :: Animation Layer Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0135"
	S.key = "arkher.anim.animlayer.physical_blend"
	S.name = "Animation Layer Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlayer.inverse_kinematics" }
	S.tags = { "i", "animlayer", "ragdoll", "anim" }
	S.description = "Animation Layer Physical Blend: physical bones blended against the animated pose for the Animation Layer subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.animlayer.physical_blend", blendSpeed = 3.90 })
		inst.system = S
		inst.ctx = ctx
