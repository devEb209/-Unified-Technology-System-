-- ARKHER SYSTEM F.0423 :: Occlusion Culling Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0423"
	S.key = "arkher.render.occlusion.visibility_set"
	S.name = "Occlusion Culling Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.occlusion.view_and_culling" }
	S.tags = { "f", "occlusion", "visibility", "render" }
	S.description = "Occlusion Culling Visibility Set: cell, portal and occluder visibility for the Occlusion Culling subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.occlusion.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
