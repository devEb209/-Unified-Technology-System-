-- ARKHER SYSTEM V.0212 :: Level Asset Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0212"
	S.key = "arkher.asset.levelasset.compression_codec"
	S.name = "Level Asset Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.levelasset.streaming_residency" }
	S.tags = { "v", "levelasset", "codec", "asset" }
	S.description = "Level Asset Compression Codec: compact encoding, diffing and checksum of asset payloads for the Level Asset subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.levelasset.compression_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
