-- ARKHER SYSTEM K.0332 :: Curiosity Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0332"
	S.key = "arkher.npc.curiosity.crowd_steering"
	S.name = "Curiosity Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.curiosity.navigation" }
	S.tags = { "k", "curiosity", "crowd", "npc" }
	S.description = "Curiosity Crowd Steering: local avoidance, cohesion and arrival at scale for the Curiosity subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.curiosity.crowd_steering", radius = 0.70, maxSpeed = 3.60, cellSize = 6 })
		inst.system = S
		inst.ctx = ctx
