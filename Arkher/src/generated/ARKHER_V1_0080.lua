...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="D-O15 S620 — CORE Stack #0080", size=Vector2.new(680, 420), pos=UDim2.fromOffset(340, 140), parent=parent, icon="◆"})
