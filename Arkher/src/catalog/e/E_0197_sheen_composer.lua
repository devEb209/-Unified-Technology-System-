-- ARKHER SYSTEM E.0197 :: Sheen Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0197"
	S.key = "arkher.material.sheen.layer_composition"
	S.name = "Sheen Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Sheen"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.sheen.definition" }
	S.tags = { "e", "sheen", "composer", "material" }
	S.description = "Sheen Layer Composition: ordered layer composition with blend rules for the Sheen subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.sheen.layer_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
