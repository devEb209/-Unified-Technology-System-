-- ARKHER SYSTEM E.0407 :: Mip Policy Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0407"
	S.key = "arkher.material.mippolicy.layer_composition"
	S.name = "Mip Policy Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Mip Policy"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.mippolicy.definition" }
	S.tags = { "e", "mippolicy", "composer", "material" }
	S.description = "Mip Policy Layer Composition: ordered layer composition with blend rules for the Mip Policy subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.mippolicy.layer_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
