-- ARKHER SYSTEM H.0046 :: Mass Properties Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0046"
	S.key = "arkher.physics.massproperties.constraint_solver"
	S.name = "Mass Properties Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.massproperties.contact_generation" }
	S.tags = { "h", "massproperties", "constraint", "physics" }
	S.description = "Mass Properties Constraint Solver: sequential impulses, friction, joints and warm starting for the Mass Properties subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.massproperties.constraint_solver", iterations = 6, baumgarte = 0.12, warmStart = true })
		inst.system = S
		inst.ctx = ctx
