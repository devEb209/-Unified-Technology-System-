-- ARKHER SYSTEM T.0410 :: Device Reasoning Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0410"
	S.key = "arkher.ai.devicereasoning.self_critique"
	S.name = "Device Reasoning Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.devicereasoning.plan_workflow" }
	S.tags = { "t", "devicereasoning", "critic", "ai" }
	S.description = "Device Reasoning Self Critique: weighted evaluation of the result against declared criteria for the Device Reasoning subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.devicereasoning.self_critique", passMark = 0.78, reviseMark = 0.43, seed = 92213 })
		inst.system = S
		inst.ctx = ctx
