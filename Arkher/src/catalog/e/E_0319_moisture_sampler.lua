-- ARKHER SYSTEM E.0319 :: Moisture Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0319"
	S.key = "arkher.material.moisture.texture_sampling"
	S.name = "Moisture Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Moisture"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.moisture.shading_graph" }
	S.tags = { "e", "moisture", "sampler", "material" }
	S.description = "Moisture Texture Sampling: atlas packing, mip chain and filtered sampling for the Moisture subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.moisture.texture_sampling", atlasSize = 256, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
