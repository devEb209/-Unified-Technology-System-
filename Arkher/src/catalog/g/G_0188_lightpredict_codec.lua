-- ARKHER SYSTEM G.0188 :: Light Transport Prediction Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0188"
	S.key = "arkher.neural.lightpredict.weight_codec"
	S.name = "Light Transport Prediction Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.lightpredict.model_registry" }
	S.tags = { "g", "lightpredict", "codec", "neural" }
	S.description = "Light Transport Prediction Weight Codec: weight serialization and quantized transport for the Light Transport Prediction subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.lightpredict.weight_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
