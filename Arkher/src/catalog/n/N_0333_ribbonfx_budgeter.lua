-- ARKHER SYSTEM N.0333 :: Ribbon Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0333"
	S.key = "arkher.vfx.ribbonfx.spawn_budget"
	S.name = "Ribbon Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Ribbon"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.ribbonfx.effect_composition" }
	S.tags = { "n", "ribbonfx", "budgeter", "vfx" }
	S.description = "Ribbon Spawn Budget: global particle budget shared by every live effect for the Ribbon subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.ribbonfx.spawn_budget", total = 207, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
