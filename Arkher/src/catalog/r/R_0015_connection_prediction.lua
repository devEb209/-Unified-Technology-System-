-- ARKHER SYSTEM R.0015 :: Connection Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0015"
	S.key = "arkher.net.connection.prediction_and_reconciliation"
	S.name = "Connection Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Connection"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.connection.time_sync" }
	S.tags = { "r", "connection", "prediction", "net" }
	S.description = "Connection Prediction And Reconciliation: client simulation, correction and input replay for the Connection subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.connection.prediction_and_reconciliation", errorThreshold = 0.075, smoothing = 17.0, maxInputs = 80 })
		inst.system = S
		inst.ctx = ctx
