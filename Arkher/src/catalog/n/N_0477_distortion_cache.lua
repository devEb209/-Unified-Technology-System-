-- ARKHER SYSTEM N.0477 :: Distortion Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0477"
	S.key = "arkher.vfx.distortion.result_cache"
	S.name = "Distortion Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Distortion"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.distortion.spawn_budget" }
	S.tags = { "n", "distortion", "cache", "vfx" }
	S.description = "Distortion Result Cache: reuse of expensive effect evaluations for the Distortion subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.distortion.result_cache", policy = "lfu", capacity = 192, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
