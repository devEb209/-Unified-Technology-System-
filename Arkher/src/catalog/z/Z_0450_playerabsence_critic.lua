-- ARKHER SYSTEM Z.0450 :: Player Absence Simulation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0450"
	S.key = "arkher.origin.playerabsence.self_critique"
	S.name = "Player Absence Simulation Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.intent_bridge" }
	S.tags = { "z", "playerabsence", "critic", "origin" }
	S.description = "Player Absence Simulation Self Critique: weighted judgement of the technology's own output for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.playerabsence.self_critique", passMark = 0.79, reviseMark = 0.49, seed = 37719 })
		inst.system = S
		inst.ctx = ctx
