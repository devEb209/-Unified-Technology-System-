-- ARKHER SYSTEM VD.0090 :: Residency Window Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0090"
	S.key = "arkher.contsim.residencywindow.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.residencywindow.persistent_state" }
	S.tags = { "vd", "residencywindow", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.residencywindow.coherence_guard", window = 90, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
