-- ARKHER SYSTEM Z.1016 :: Capability Discovery Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.1016"
	S.key = "arkher.origin.capabilitydiscovery.governance_policy"
	S.name = "Capability Discovery Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.signal_composition" }
	S.tags = { "z", "capabilitydiscovery", "policy", "origin" }
	S.description = "Capability Discovery Governance Policy: ordered rules governing when the technology may act for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.capabilitydiscovery.governance_policy", algorithm = "wfq", starvationGuard = 50 })
		inst.system = S
		inst.ctx = ctx
