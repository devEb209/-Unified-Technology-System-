-- ARKHER SYSTEM W.0082 :: Dolly Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0082"
	S.key = "arkher.cine.dolly.frame_budget"
	S.name = "Dolly Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dolly"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dolly.event_ledger" }
	S.tags = { "w", "dolly", "budgeter", "cine" }
	S.description = "Dolly Frame Budget: per-frame cost budget for the cinematic systems for the Dolly subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.dolly.frame_budget", total = 324, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
