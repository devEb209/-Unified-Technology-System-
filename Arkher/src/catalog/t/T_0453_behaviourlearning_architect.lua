-- ARKHER SYSTEM T.0453 :: Behaviour Learning World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0453"
	S.key = "arkher.ai.behaviourlearning.world_architect"
	S.name = "Behaviour Learning World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.behaviourlearning.self_critique" }
	S.tags = { "t", "behaviourlearning", "architect", "ai" }
	S.description = "Behaviour Learning World Architect: composition of a whole world plan with conserved budgets for the Behaviour Learning subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.behaviourlearning.world_architect", budget = 600, seed = 12410 })
		inst.system = S
		inst.ctx = ctx
