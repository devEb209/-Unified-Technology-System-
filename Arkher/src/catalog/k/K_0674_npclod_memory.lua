-- ARKHER SYSTEM K.0674 :: NPC LOD Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0674"
	S.key = "arkher.npc.npclod.memory"
	S.name = "NPC LOD Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npclod.mind_network" }
	S.tags = { "k", "npclod", "memory", "npc" }
	S.description = "NPC LOD Memory: episodic memory with decay, recall and consolidation for the NPC LOD subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.npclod.memory", capacity = 75, decayRate = 0.045, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
