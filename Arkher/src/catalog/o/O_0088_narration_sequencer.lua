-- ARKHER SYSTEM O.0088 :: Narration Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0088"
	S.key = "arkher.audio.narration.music_sequencer"
	S.name = "Narration Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Narration"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.narration.spatialization" }
	S.tags = { "o", "narration", "sequencer", "audio" }
	S.description = "Narration Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Narration subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.narration.music_sequencer", bpm = 110, beatsPerBar = 4, intensity = 0.32 })
		inst.system = S
		inst.ctx = ctx
