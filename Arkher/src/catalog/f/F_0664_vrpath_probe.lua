-- ARKHER SYSTEM F.0664 :: VR Stereo Path Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0664"
	S.key = "arkher.render.vrpath.probe_volume"
	S.name = "VR Stereo Path Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.vrpath.lighting_rig" }
	S.tags = { "f", "vrpath", "probe", "render" }
	S.description = "VR Stereo Path Probe Volume: irradiance probes encoded in spherical harmonics for the VR Stereo Path subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.vrpath.probe_volume", spacing = 16 })
		inst.system = S
		inst.ctx = ctx
