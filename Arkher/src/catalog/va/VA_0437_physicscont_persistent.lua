-- ARKHER SYSTEM VA.0437 :: Physics Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0437"
	S.key = "arkher.contworld.physicscont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.physicscont.multi-scale_fidelity" }
	S.tags = { "va", "physicscont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.physicscont.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
