--!strict
-- Terragen Sky — ANIMATION Stack #0145
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Terragen Sky — ANIMATION Stack #0145", size=Vector2.new(640, 420), pos=UDim2.fromOffset(385, 205), parent=parent, icon="⚙"})
