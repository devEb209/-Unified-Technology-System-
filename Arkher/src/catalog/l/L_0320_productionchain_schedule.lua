-- ARKHER SYSTEM L.0320 :: Production Chain Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0320"
	S.key = "arkher.sim.productionchain.calendar"
	S.name = "Production Chain Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.productionchain.society" }
	S.tags = { "l", "productionchain", "schedule", "sim" }
	S.description = "Production Chain Calendar: hours, days and seasons driving the region for the Production Chain subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.productionchain.calendar", startHour = 6 })
		inst.system = S
		inst.ctx = ctx
