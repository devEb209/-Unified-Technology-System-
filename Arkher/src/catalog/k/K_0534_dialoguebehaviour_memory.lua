-- ARKHER SYSTEM K.0534 :: Dialogue Behaviour Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0534"
	S.key = "arkher.npc.dialoguebehaviour.memory"
	S.name = "Dialogue Behaviour Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dialoguebehaviour.mind_network" }
	S.tags = { "k", "dialoguebehaviour", "memory", "npc" }
	S.description = "Dialogue Behaviour Memory: episodic memory with decay, recall and consolidation for the Dialogue Behaviour subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.dialoguebehaviour.memory", capacity = 89, decayRate = 0.055, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
