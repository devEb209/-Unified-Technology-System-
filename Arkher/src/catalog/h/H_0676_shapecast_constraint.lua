-- ARKHER SYSTEM H.0676 :: Shapecast Query Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0676"
	S.key = "arkher.physics.shapecast.constraint_solver"
	S.name = "Shapecast Query Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.shapecast.contact_generation" }
	S.tags = { "h", "shapecast", "constraint", "physics" }
	S.description = "Shapecast Query Constraint Solver: sequential impulses, friction, joints and warm starting for the Shapecast Query subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.shapecast.constraint_solver", iterations = 10, baumgarte = 0.26, warmStart = true })
		inst.system = S
		inst.ctx = ctx
