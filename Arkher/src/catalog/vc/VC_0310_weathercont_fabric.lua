-- ARKHER SYSTEM VC.0310 :: Weather Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0310"
	S.key = "arkher.contneural.weathercont.simulation_fabric"
	S.name = "Weather Continuum Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.weathercont.complexity_budget" }
	S.tags = { "vc", "weathercont", "fabric", "contneural" }
	S.description = "Weather Continuum Simulation Fabric: fabric stepping the continuum domains for the Weather Continuum subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.weathercont.simulation_fabric", budgetMs = 4.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
