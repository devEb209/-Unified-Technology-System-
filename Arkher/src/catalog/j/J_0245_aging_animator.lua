-- ARKHER SYSTEM J.0245 :: Aging Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0245"
	S.key = "arkher.character.aging.blend_controller"
	S.name = "Aging Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.aging.motion_set" }
	S.tags = { "j", "aging", "animator", "character" }
	S.description = "Aging Blend Controller: layered playback driving the character for the Aging subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.aging.blend_controller", budget = 9 })
		inst.system = S
		inst.ctx = ctx
