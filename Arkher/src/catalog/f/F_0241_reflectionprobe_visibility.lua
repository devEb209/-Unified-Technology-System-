-- ARKHER SYSTEM F.0241 :: Reflection Probe Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0241"
	S.key = "arkher.render.reflectionprobe.visibility_set"
	S.name = "Reflection Probe Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.reflectionprobe.view_and_culling" }
	S.tags = { "f", "reflectionprobe", "visibility", "render" }
	S.description = "Reflection Probe Visibility Set: cell, portal and occluder visibility for the Reflection Probe subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.reflectionprobe.visibility_set", maxDepth = 4 })
		inst.system = S
		inst.ctx = ctx
