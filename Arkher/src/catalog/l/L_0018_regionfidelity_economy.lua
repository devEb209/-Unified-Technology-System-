-- ARKHER SYSTEM L.0018 :: Region Fidelity Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0018"
	S.key = "arkher.sim.regionfidelity.economy"
	S.name = "Region Fidelity Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.regionfidelity.ecology" }
	S.tags = { "l", "regionfidelity", "economy", "sim" }
	S.description = "Region Fidelity Economy: stock, production, demand, price discovery and trade for the Region Fidelity subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.regionfidelity.economy", elasticity = 0.33 })
		inst.system = S
		inst.ctx = ctx
