-- ARKHER SYSTEM G.0220 :: Reflection Prediction Heuristic Policy
...
return function(A)
	...
	local S = {}
	S.id = "G.0220"
	S.key = "arkher.neural.reflectpredict.heuristic_policy"
	S.name = "Reflection Prediction Heuristic Policy"
	S.category = "G"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.reflectpredict.result_cache" }
	S.tags = { "g", "reflectpredict", "policy", "neural" }
	S.description = "Reflection Prediction Heuristic Policy: rule fallback when the model is unavailable for the Reflection Prediction subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.neural.reflectpredict.heuristic_policy", algorithm = "roundrobin", starvationGuard = 56 })
		inst.system = S
		inst.ctx = ctx
