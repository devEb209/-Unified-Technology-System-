-- ARKHER SYSTEM N.0368 :: Projectile Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0368"
	S.key = "arkher.vfx.projectile.ribbon_and_trail"
	S.name = "Projectile Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Projectile"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.projectile.force_field" }
	S.tags = { "n", "projectile", "ribbon", "vfx" }
	S.description = "Projectile Ribbon And Trail: trail points, tapering, beams and decimation for the Projectile subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.projectile.ribbon_and_trail", maxPoints = 56, lifetime = 2.00, minDistance = 0.35, width = 1.30 })
		inst.system = S
		inst.ctx = ctx
