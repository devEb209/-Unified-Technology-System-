--!strict
-- Source2 Hammer — CORE Mixer #0082
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Source2 Hammer — CORE Mixer #0082", size=Vector2.new(640, 460), pos=UDim2.fromOffset(366, 174), parent=parent, icon="◨"})
...
Components.Slider(right, "Rate", 0,3000,600, function(v) local s=game:GetService("Selection"):Get()[1]; if s then s:SetAttribute("ARKHER_Rate"..82, v) end end)
