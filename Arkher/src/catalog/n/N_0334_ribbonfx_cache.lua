-- ARKHER SYSTEM N.0334 :: Ribbon Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0334"
	S.key = "arkher.vfx.ribbonfx.result_cache"
	S.name = "Ribbon Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Ribbon"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.ribbonfx.spawn_budget" }
	S.tags = { "n", "ribbonfx", "cache", "vfx" }
	S.description = "Ribbon Result Cache: reuse of expensive effect evaluations for the Ribbon subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.ribbonfx.result_cache", policy = "lfu", capacity = 159, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
