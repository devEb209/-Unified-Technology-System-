-- ARKHER SYSTEM E.0053 :: Roughness Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0053"
	S.key = "arkher.material.roughness.streaming"
	S.name = "Roughness Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Roughness"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.roughness.parameter_budget" }
	S.tags = { "e", "roughness", "streamer", "material" }
	S.description = "Roughness Streaming: residency and demand-driven texture streaming for the Roughness subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.roughness.streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
