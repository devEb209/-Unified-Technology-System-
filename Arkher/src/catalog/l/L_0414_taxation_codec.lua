-- ARKHER SYSTEM L.0414 :: Taxation State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0414"
	S.key = "arkher.sim.taxation.state_codec"
	S.name = "Taxation State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.taxation.history_ledger" }
	S.tags = { "l", "taxation", "codec", "sim" }
	S.description = "Taxation State Codec: persistence, diffing and checksum of the world state for the Taxation subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.taxation.state_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
