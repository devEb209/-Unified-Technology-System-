-- ARKHER SYSTEM G.0192 :: Light Transport Prediction Heuristic Policy
...
return function(A)
	...
	local S = {}
	S.id = "G.0192"
	S.key = "arkher.neural.lightpredict.heuristic_policy"
	S.name = "Light Transport Prediction Heuristic Policy"
	S.category = "G"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.lightpredict.result_cache" }
	S.tags = { "g", "lightpredict", "policy", "neural" }
	S.description = "Light Transport Prediction Heuristic Policy: rule fallback when the model is unavailable for the Light Transport Prediction subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.neural.lightpredict.heuristic_policy", algorithm = "lottery", starvationGuard = 27 })
		inst.system = S
		inst.ctx = ctx
