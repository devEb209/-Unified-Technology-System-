-- ARKHER SYSTEM L.0319 :: Production Chain Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0319"
	S.key = "arkher.sim.productionchain.society"
	S.name = "Production Chain Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.productionchain.economy" }
	S.tags = { "l", "productionchain", "society", "sim" }
	S.description = "Production Chain Society: relations, factions, reputation and cohesion of the region for the Production Chain subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.productionchain.society", decayRate = 0.011, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
