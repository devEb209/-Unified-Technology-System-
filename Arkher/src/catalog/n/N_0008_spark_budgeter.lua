-- ARKHER SYSTEM N.0008 :: Spark Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0008"
	S.key = "arkher.vfx.spark.spawn_budget"
	S.name = "Spark Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spark"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spark.effect_composition" }
	S.tags = { "n", "spark", "budgeter", "vfx" }
	S.description = "Spark Spawn Budget: global particle budget shared by every live effect for the Spark subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.spark.spawn_budget", total = 193, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
