-- ARKHER SYSTEM R.0239 :: Interest Management Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0239"
	S.key = "arkher.net.interestmanagement.latency_analysis"
	S.name = "Interest Management Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.interestmanagement.audit_ledger" }
	S.tags = { "r", "interestmanagement", "analyzer", "net" }
	S.description = "Interest Management Latency Analysis: round trip, jitter and loss analysis for the Interest Management subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.interestmanagement.latency_analysis", window = 86, buckets = 14, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
