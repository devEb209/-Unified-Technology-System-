-- ARKHER SYSTEM W.0041 :: Establishing Shot Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0041"
	S.key = "arkher.cine.establishing.cut_policy"
	S.name = "Establishing Shot Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.establishing.shot_composition" }
	S.tags = { "w", "establishing", "policy", "cine" }
	S.description = "Establishing Shot Cut Policy: rules deciding when the sequence cuts and to what for the Establishing Shot subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.establishing.cut_policy", algorithm = "wfq", starvationGuard = 50 })
		inst.system = S
		inst.ctx = ctx
