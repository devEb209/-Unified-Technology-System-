-- ARKHER SYSTEM K.0059 :: Episodic Memory Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0059"
	S.key = "arkher.npc.episodicmemory.drive_system"
	S.name = "Episodic Memory Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.episodicmemory.memory" }
	S.tags = { "k", "episodicmemory", "need", "npc" }
	S.description = "Episodic Memory Drive System: drives that decay, turn urgent and get satisfied for the Episodic Memory subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.episodicmemory.drive_system" })
		inst.system = S
		inst.ctx = ctx
