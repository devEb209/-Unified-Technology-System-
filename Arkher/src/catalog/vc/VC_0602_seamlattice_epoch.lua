-- ARKHER SYSTEM VC.0602 :: Seam Lattice Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0602"
	S.key = "arkher.contneural.seamlattice.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.seamlattice.infinite_grid" }
	S.tags = { "vc", "seamlattice", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.seamlattice.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
