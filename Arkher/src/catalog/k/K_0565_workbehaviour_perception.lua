-- ARKHER SYSTEM K.0565 :: Work Behaviour Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0565"
	S.key = "arkher.npc.workbehaviour.perception"
	S.name = "Work Behaviour Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workbehaviour.emotion" }
	S.tags = { "k", "workbehaviour", "perception", "npc" }
	S.description = "Work Behaviour Perception: sight, hearing and bounded attention for the Work Behaviour subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.workbehaviour.perception", sightRange = 25, hearingRange = 12, attentionSlots = 3, fov = 1.600 })
		inst.system = S
		inst.ctx = ctx
