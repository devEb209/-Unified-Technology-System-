-- ARKHER SYSTEM R.0129 :: Reliable Channel Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0129"
	S.key = "arkher.net.reliablechannel.session_registry"
	S.name = "Reliable Channel Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reliablechannel.rate_guard" }
	S.tags = { "r", "reliablechannel", "registry", "net" }
	S.description = "Reliable Channel Session Registry: catalogue of sessions, players and their metadata for the Reliable Channel subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.reliablechannel.session_registry" })
		inst.system = S
		inst.ctx = ctx
