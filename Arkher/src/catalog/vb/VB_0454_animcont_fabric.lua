-- ARKHER SYSTEM VB.0454 :: Animation Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0454"
	S.key = "arkher.conttime.animcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.animcont.complexity_budget" }
	S.tags = { "vb", "animcont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.animcont.simulation_fabric", budgetMs = 4.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
