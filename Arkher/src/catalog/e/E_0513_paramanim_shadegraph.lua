-- ARKHER SYSTEM E.0513 :: Parameter Animation Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0513"
	S.key = "arkher.material.paramanim.shading_graph"
	S.name = "Parameter Animation Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.paramanim.layer_composition" }
	S.tags = { "e", "paramanim", "shadegraph", "material" }
	S.description = "Parameter Animation Shading Graph: node graph evaluated and compiled to Luau for the Parameter Animation subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.paramanim.shading_graph" })
		inst.system = S
		inst.ctx = ctx
