-- ARKHER SYSTEM V.0134 :: Icon Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0134"
	S.key = "arkher.asset.iconasset.bundling"
	S.name = "Icon Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.iconasset.import" }
	S.tags = { "v", "iconasset", "bundler", "asset" }
	S.description = "Icon Bundling: size-bounded packing, manifests and delta patches for the Icon subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.iconasset.bundling", maxBundleBytes = 524288 })
		inst.system = S
		inst.ctx = ctx
