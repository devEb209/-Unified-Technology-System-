-- ARKHER SYSTEM K.0531 :: Combat Behaviour Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0531"
	S.key = "arkher.npc.combatbehaviour.thinking_budget"
	S.name = "Combat Behaviour Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.combatbehaviour.daily_schedule" }
	S.tags = { "k", "combatbehaviour", "budgeter", "npc" }
	S.description = "Combat Behaviour Thinking Budget: allocation of per-frame thinking time across NPCs for the Combat Behaviour subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.combatbehaviour.thinking_budget", total = 184, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
