-- ARKHER SYSTEM VC.0306 :: Weather Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0306"
	S.key = "arkher.contneural.weathercont.coherence_guard"
	S.name = "Weather Continuum Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.weathercont.persistent_state" }
	S.tags = { "vc", "weathercont", "coherence", "contneural" }
	S.description = "Weather Continuum Coherence Guard: seam coherence and drift supervision for the Weather Continuum subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.weathercont.coherence_guard", window = 111, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
