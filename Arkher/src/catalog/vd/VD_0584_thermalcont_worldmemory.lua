-- ARKHER SYSTEM VD.0584 :: Thermal Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0584"
	S.key = "arkher.contsim.thermalcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.thermalcont.neural_field" }
	S.tags = { "vd", "thermalcont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.thermalcont.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
