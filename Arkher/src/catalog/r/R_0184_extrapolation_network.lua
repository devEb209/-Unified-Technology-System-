-- ARKHER SYSTEM R.0184 :: Extrapolation Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0184"
	S.key = "arkher.net.extrapolation.transport_graph"
	S.name = "Extrapolation Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.extrapolation.prediction_and_reconciliation" }
	S.tags = { "r", "extrapolation", "network", "net" }
	S.description = "Extrapolation Transport Graph: topology, capacity and routing between endpoints for the Extrapolation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.extrapolation.transport_graph" })
		inst.system = S
		inst.ctx = ctx
