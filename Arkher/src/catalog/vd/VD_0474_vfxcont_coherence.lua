-- ARKHER SYSTEM VD.0474 :: VFX Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0474"
	S.key = "arkher.contsim.vfxcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vfxcont.persistent_state" }
	S.tags = { "vd", "vfxcont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.vfxcont.coherence_guard", window = 95, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
