-- ARKHER SYSTEM T.0279 :: Level Design Learning Analysis
...
return function(A)
	...
	local S = {}
	S.id = "T.0279"
	S.key = "arkher.ai.leveldesign.learning_analysis"
	S.name = "Level Design Learning Analysis"
	S.category = "T"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.leveldesign.model_inference" }
	S.tags = { "t", "leveldesign", "analyzer", "ai" }
	S.description = "Level Design Learning Analysis: trend, anomaly and improvement analysis of the agent for the Level Design subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ai.leveldesign.learning_analysis", window = 179, buckets = 19, threshold = 3.10 })
		inst.system = S
		inst.ctx = ctx
