-- ARKHER SYSTEM Z.0949 :: Platform Abstraction Doctrine Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0949"
	S.key = "arkher.origin.platformdoctrine.intent_bridge"
	S.name = "Platform Abstraction Doctrine Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.platformdoctrine.semantic_graph" }
	S.tags = { "z", "platformdoctrine", "intent", "origin" }
	S.description = "Platform Abstraction Doctrine Intent Bridge: natural language control surface for the technology for the Platform Abstraction Doctrine subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.platformdoctrine.intent_bridge", minConfidence = 0.30 })
		inst.system = S
		inst.ctx = ctx
