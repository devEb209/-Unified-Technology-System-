-- ARKHER SYSTEM VB.0591 :: Horizon Span Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0591"
	S.key = "arkher.conttime.horizonspan.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.horizonspan.epoch_clock" }
	S.tags = { "vb", "horizonspan", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.horizonspan.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
