-- ARKHER SYSTEM VA.0403 :: Perception Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0403"
	S.key = "arkher.contworld.perceptioncont.neural_field"
	S.name = "Perception Continuum Neural Field"
	S.category = "VA"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.perceptioncont.coherence_guard" }
	S.tags = { "va", "perceptioncont", "neuralfield", "contworld" }
	S.description = "Perception Continuum Neural Field: neural field encoding and reconstruction for the Perception Continuum subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.perceptioncont.neural_field", dims = 12, hidden = 8, seed = 56596 })
		inst.system = S
		inst.ctx = ctx
