-- ARKHER SYSTEM J.0113 :: Gaze Behaviour Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0113"
	S.key = "arkher.character.gaze.blend_controller"
	S.name = "Gaze Behaviour Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gaze.motion_set" }
	S.tags = { "j", "gaze", "animator", "character" }
	S.description = "Gaze Behaviour Blend Controller: layered playback driving the character for the Gaze Behaviour subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.gaze.blend_controller", budget = 14 })
		inst.system = S
		inst.ctx = ctx
