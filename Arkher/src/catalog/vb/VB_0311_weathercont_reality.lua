-- ARKHER SYSTEM VB.0311 :: Weather Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0311"
	S.key = "arkher.conttime.weathercont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.weathercont.simulation_fabric" }
	S.tags = { "vb", "weathercont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.weathercont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
