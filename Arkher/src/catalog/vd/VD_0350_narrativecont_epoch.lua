-- ARKHER SYSTEM VD.0350 :: Narrative Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0350"
	S.key = "arkher.contsim.narrativecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.narrativecont.infinite_grid" }
	S.tags = { "vd", "narrativecont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.narrativecont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
