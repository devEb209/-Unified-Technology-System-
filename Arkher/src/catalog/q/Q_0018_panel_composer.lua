-- ARKHER SYSTEM Q.0018 :: Panel Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0018"
	S.key = "arkher.ui.panel.theme_composition"
	S.name = "Panel Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Panel"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.panel.navigation_graph" }
	S.tags = { "q", "panel", "composer", "ui" }
	S.description = "Panel Theme Composition: blending of theme signals into the final appearance for the Panel subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.panel.theme_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
