-- ARKHER SYSTEM Z.0380 :: Mobile First Governor Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0380"
	S.key = "arkher.origin.mobilefirst.orchestration"
	S.name = "Mobile First Governor Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.residency_streaming" }
	S.tags = { "z", "mobilefirst", "orchestrator", "origin" }
	S.description = "Mobile First Governor Orchestration: lifecycle and phase orchestration of the technology for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.mobilefirst.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
