-- ARKHER SYSTEM H.0359 :: Trigger Volume Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0359"
	S.key = "arkher.physics.trigger.budget_governor"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.trigger.broadphase_index" }
	S.tags = { "h", "trigger", "budgeter", "physics" }
	S.description = "Trigger Volume Budget Governor: simulation time budget allocation across islands for the Trigger Volume subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.trigger.budget_governor", total = 157, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
