-- ARKHER SYSTEM E.0320 :: Moisture Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0320"
	S.key = "arkher.material.moisture.procedural_detail"
	S.name = "Moisture Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Moisture"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.moisture.texture_sampling" }
	S.tags = { "e", "moisture", "field", "material" }
	S.description = "Moisture Procedural Detail: coherent noise detail driving the surface for the Moisture subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.moisture.procedural_detail", seed = 64767, frequency = 0.0057, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
		...
		function inst.integrate(engine)
			...
			inst.engine = engine
			if engine.bus then
				engine.bus:subscribe("arkher.material.moisture.*", function(payload) inst.lastSignal = payload end)
			end
