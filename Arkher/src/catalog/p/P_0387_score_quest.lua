-- ARKHER SYSTEM P.0387 :: Score Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0387"
	S.key = "arkher.play.score.objectives"
	S.name = "Score Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Score"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.score.inventory" }
	S.tags = { "p", "score", "quest", "play" }
	S.description = "Score Objectives: objectives, prerequisites, progress and rewards for the Score subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.score.objectives" })
		inst.system = S
		inst.ctx = ctx
