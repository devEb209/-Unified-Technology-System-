-- ARKHER SYSTEM T.0365 :: Review Critic Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0365"
	S.key = "arkher.ai.reviewcritic.intent_understanding"
	S.name = "Review Critic Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "reviewcritic", "intent", "ai" }
	S.description = "Review Critic Intent Understanding: natural language turned into an actionable, scored intent for the Review Critic subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.reviewcritic.intent_understanding", minConfidence = 0.44 })
		inst.system = S
		inst.ctx = ctx
