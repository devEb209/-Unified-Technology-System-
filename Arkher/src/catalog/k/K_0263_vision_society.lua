-- ARKHER SYSTEM K.0263 :: Vision Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0263"
	S.key = "arkher.npc.vision.social_relations"
	S.name = "Vision Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.vision.crowd_steering" }
	S.tags = { "k", "vision", "society", "npc" }
	S.description = "Vision Social Relations: affinity, factions, reputation and gossip for the Vision subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.vision.social_relations", decayRate = 0.011, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
