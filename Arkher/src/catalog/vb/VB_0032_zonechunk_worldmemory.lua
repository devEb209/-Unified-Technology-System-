-- ARKHER SYSTEM VB.0032 :: Zone Chunk World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0032"
	S.key = "arkher.conttime.zonechunk.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.zonechunk.neural_field" }
	S.tags = { "vb", "zonechunk", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.zonechunk.world_memory_stream", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
