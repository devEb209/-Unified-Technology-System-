-- ARKHER SYSTEM Q.0302 :: Haptics Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0302"
	S.key = "arkher.ui.haptics.widget_tree"
	S.name = "Haptics Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Haptics"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.haptics.responsive_layout" }
	S.tags = { "q", "haptics", "widget", "ui" }
	S.description = "Haptics Widget Tree: retained widget nodes, properties, bindings and rendering for the Haptics subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.haptics.widget_tree", theme = "light", scale = 0.78 })
		inst.system = S
		inst.ctx = ctx
