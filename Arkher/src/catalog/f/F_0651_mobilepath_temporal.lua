-- ARKHER SYSTEM F.0651 :: Mobile Fast Path Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0651"
	S.key = "arkher.render.mobilepath.temporal_resolve"
	S.name = "Mobile Fast Path Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.mobilepath.probe_volume" }
	S.tags = { "f", "mobilepath", "temporal", "render" }
	S.description = "Mobile Fast Path Temporal Resolve: history reprojection with neighbourhood clamping for the Mobile Fast Path subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.mobilepath.temporal_resolve", feedback = 0.80, phase = 8 })
		inst.system = S
		inst.ctx = ctx
