-- ARKHER SYSTEM Z.0306 :: Causality Ledger Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0306"
	S.key = "arkher.origin.causality.emergence_detection"
	S.name = "Causality Ledger Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.world_memory" }
	S.tags = { "z", "causality", "emergence", "origin" }
	S.description = "Causality Ledger Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.causality.emergence_detection", windowSize = 4, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
