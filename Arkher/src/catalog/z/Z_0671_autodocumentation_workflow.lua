-- ARKHER SYSTEM Z.0671 :: Auto Documentation Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0671"
	S.key = "arkher.origin.autodocumentation.adaptive_workflow"
	S.name = "Auto Documentation Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.self_critique" }
	S.tags = { "z", "autodocumentation", "workflow", "origin" }
	S.description = "Auto Documentation Adaptive Workflow: verified, retryable, reversible execution plans for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.autodocumentation.adaptive_workflow", maxRetries = 2, budget = 110 })
		inst.system = S
		inst.ctx = ctx
