-- ARKHER SYSTEM VB.0253 :: Road Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0253"
	S.key = "arkher.conttime.roadcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "roadcont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.roadcont.infinite_grid", cellSize = 224, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
