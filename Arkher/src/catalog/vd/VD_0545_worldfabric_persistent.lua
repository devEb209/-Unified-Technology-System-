-- ARKHER SYSTEM VD.0545 :: World Fabric Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0545"
	S.key = "arkher.contsim.worldfabric.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldfabric.multi-scale_fidelity" }
	S.tags = { "vd", "worldfabric", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.worldfabric.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
