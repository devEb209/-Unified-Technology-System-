-- ARKHER SYSTEM Z.0580 :: Collective Behaviour Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0580"
	S.key = "arkher.origin.collectivebehaviour.orchestration"
	S.name = "Collective Behaviour Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.collectivebehaviour.residency_streaming" }
	S.tags = { "z", "collectivebehaviour", "orchestrator", "origin" }
	S.description = "Collective Behaviour Orchestration: lifecycle and phase orchestration of the technology for the Collective Behaviour subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.collectivebehaviour.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
