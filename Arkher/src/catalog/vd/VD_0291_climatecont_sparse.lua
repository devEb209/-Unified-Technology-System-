-- ARKHER SYSTEM VD.0291 :: Climate Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0291"
	S.key = "arkher.contsim.climatecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.climatecont.epoch_clock" }
	S.tags = { "vd", "climatecont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.climatecont.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
