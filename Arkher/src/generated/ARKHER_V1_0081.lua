--!strict
-- Godot4 — ANIMATION Node_Flow #0081
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Godot4 — ANIMATION Node_Flow #0081", size=Vector2.new(600, 440), pos=UDim2.fromOffset(353, 157), parent=parent, icon="▶"})
