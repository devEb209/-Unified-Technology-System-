-- ARKHER SYSTEM H.0627 :: Character Controller Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0627"
	S.key = "arkher.physics.charactercontroller.result_cache"
	S.name = "Character Controller Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.charactercontroller.simulation_policy" }
	S.tags = { "h", "charactercontroller", "cache", "physics" }
	S.description = "Character Controller Result Cache: reuse of expensive simulation and query results for the Character Controller subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.charactercontroller.result_cache", policy = "lru", capacity = 116, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
