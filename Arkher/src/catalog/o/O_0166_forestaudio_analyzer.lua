-- ARKHER SYSTEM O.0166 :: Forest Audio Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0166"
	S.key = "arkher.audio.forestaudio.analysis"
	S.name = "Forest Audio Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Forest Audio"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.forestaudio.playback_policy" }
	S.tags = { "o", "forestaudio", "analyzer", "audio" }
	S.description = "Forest Audio Analysis: loudness, headroom and masking analysis for the Forest Audio subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.forestaudio.analysis", window = 114, buckets = 14, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
