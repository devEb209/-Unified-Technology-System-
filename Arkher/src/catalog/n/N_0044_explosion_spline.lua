-- ARKHER SYSTEM N.0044 :: Explosion Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0044"
	S.key = "arkher.vfx.explosion.curve_authoring"
	S.name = "Explosion Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Explosion"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.explosion.ribbon_and_trail" }
	S.tags = { "n", "explosion", "spline", "vfx" }
	S.description = "Explosion Curve Authoring: authored curves driving the effect over its life for the Explosion subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.explosion.curve_authoring", tension = 0.58, closed = false })
		inst.system = S
		inst.ctx = ctx
