-- ARKHER SYSTEM L.0007 :: Living World Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0007"
	S.key = "arkher.sim.livingworld.route_network"
	S.name = "Living World Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.livingworld.region_graph" }
	S.tags = { "l", "livingworld", "network", "sim" }
	S.description = "Living World Route Network: roads, rivers and routes between settlements for the Living World subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.livingworld.route_network" })
		inst.system = S
		inst.ctx = ctx
