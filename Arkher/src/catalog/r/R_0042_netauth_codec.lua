-- ARKHER SYSTEM R.0042 :: Authentication Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0042"
	S.key = "arkher.net.netauth.serialization_codec"
	S.name = "Authentication Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netauth.bandwidth_budget" }
	S.tags = { "r", "netauth", "codec", "net" }
	S.description = "Authentication Serialization Codec: compact encoding, diffing and checksum of payloads for the Authentication subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.netauth.serialization_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
