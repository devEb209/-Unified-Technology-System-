-- ARKHER SYSTEM H.0571 :: Soft Body Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0571"
	S.key = "arkher.physics.softbody.result_cache"
	S.name = "Soft Body Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Soft Body"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.softbody.simulation_policy" }
	S.tags = { "h", "softbody", "cache", "physics" }
	S.description = "Soft Body Result Cache: reuse of expensive simulation and query results for the Soft Body subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.softbody.result_cache", policy = "lfu", capacity = 203, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
