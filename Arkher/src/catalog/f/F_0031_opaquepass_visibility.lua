-- ARKHER SYSTEM F.0031 :: Opaque Pass Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0031"
	S.key = "arkher.render.opaquepass.visibility_set"
	S.name = "Opaque Pass Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Opaque Pass"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.opaquepass.view_and_culling" }
	S.tags = { "f", "opaquepass", "visibility", "render" }
	S.description = "Opaque Pass Visibility Set: cell, portal and occluder visibility for the Opaque Pass subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.opaquepass.visibility_set", maxDepth = 2 })
		inst.system = S
		inst.ctx = ctx
