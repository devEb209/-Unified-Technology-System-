-- ARKHER SYSTEM VD.0104 :: Memory Shard World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0104"
	S.key = "arkher.contsim.memoryshard.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memoryshard.neural_field" }
	S.tags = { "vd", "memoryshard", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.memoryshard.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
