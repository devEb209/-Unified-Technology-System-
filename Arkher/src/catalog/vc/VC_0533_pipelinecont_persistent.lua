-- ARKHER SYSTEM VC.0533 :: Pipeline Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0533"
	S.key = "arkher.contneural.pipelinecont.persistent_state"
	S.name = "Pipeline Continuum Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.pipelinecont.multi-scale_fidelity" }
	S.tags = { "vc", "pipelinecont", "persistent", "contneural" }
	S.description = "Pipeline Continuum Persistent State: epoch-stamped persistent history and rollback for the Pipeline Continuum subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.pipelinecont.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
