-- ARKHER SYSTEM P.0332 :: Status Effect Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0332"
	S.key = "arkher.play.statuseffect.balance_analysis"
	S.name = "Status Effect Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.statuseffect.event_ledger" }
	S.tags = { "p", "statuseffect", "analyzer", "play" }
	S.description = "Status Effect Balance Analysis: distribution, outlier and pacing analysis for the Status Effect subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.statuseffect.balance_analysis", window = 170, buckets = 14, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
