-- ARKHER SYSTEM N.0515 :: Effect Debug Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0515"
	S.key = "arkher.vfx.fxdebug.spawn_budget"
	S.name = "Effect Debug Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Effect Debug"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fxdebug.effect_composition" }
	S.tags = { "n", "fxdebug", "budgeter", "vfx" }
	S.description = "Effect Debug Spawn Budget: global particle budget shared by every live effect for the Effect Debug subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.fxdebug.spawn_budget", total = 400, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
