-- ARKHER SYSTEM L.0365 :: Trade Route Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0365"
	S.key = "arkher.sim.traderoute.calendar"
	S.name = "Trade Route Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.traderoute.society" }
	S.tags = { "l", "traderoute", "schedule", "sim" }
	S.description = "Trade Route Calendar: hours, days and seasons driving the region for the Trade Route subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.traderoute.calendar", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
