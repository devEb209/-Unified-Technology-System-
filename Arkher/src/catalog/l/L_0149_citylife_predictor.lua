-- ARKHER SYSTEM L.0149 :: City Life Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0149"
	S.key = "arkher.sim.citylife.forecast"
	S.name = "City Life Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.citylife.analysis" }
	S.tags = { "l", "citylife", "predictor", "sim" }
	S.description = "City Life Forecast: prediction of the region's next state for the City Life subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.citylife.forecast", method = "ema", alpha = 0.33, window = 95 })
		inst.system = S
		inst.ctx = ctx
