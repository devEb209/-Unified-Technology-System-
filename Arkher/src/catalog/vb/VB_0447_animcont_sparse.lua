-- ARKHER SYSTEM VB.0447 :: Animation Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0447"
	S.key = "arkher.conttime.animcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.animcont.epoch_clock" }
	S.tags = { "vb", "animcont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.animcont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
