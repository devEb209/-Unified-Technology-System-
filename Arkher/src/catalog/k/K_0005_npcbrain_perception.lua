-- ARKHER SYSTEM K.0005 :: NPC Brain Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0005"
	S.key = "arkher.npc.npcbrain.perception"
	S.name = "NPC Brain Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcbrain.emotion" }
	S.tags = { "k", "npcbrain", "perception", "npc" }
	S.description = "NPC Brain Perception: sight, hearing and bounded attention for the NPC Brain subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.npcbrain.perception", sightRange = 35, hearingRange = 12, attentionSlots = 5, fov = 1.780 })
		inst.system = S
		inst.ctx = ctx
