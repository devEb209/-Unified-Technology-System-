-- ARKHER SYSTEM I.0155 :: Layer Mask Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0155"
	S.key = "arkher.anim.layermask.analysis"
	S.name = "Layer Mask Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Layer Mask"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.layermask.quality_policy" }
	S.tags = { "i", "layermask", "analyzer", "anim" }
	S.description = "Layer Mask Analysis: pop, drift and cost analysis of playback for the Layer Mask subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.layermask.analysis", window = 119, buckets = 11, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
