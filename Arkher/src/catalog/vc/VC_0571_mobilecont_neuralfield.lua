-- ARKHER SYSTEM VC.0571 :: Mobile Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0571"
	S.key = "arkher.contneural.mobilecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.mobilecont.coherence_guard" }
	S.tags = { "vc", "mobilecont", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.mobilecont.neural_field", dims = 20, hidden = 16, seed = 21290 })
		inst.system = S
		inst.ctx = ctx
