-- ARKHER SYSTEM T.0603 :: Safety Alignment Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0603"
	S.key = "arkher.ai.safetyalignment.intent_understanding"
	S.name = "Safety Alignment Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "safetyalignment", "intent", "ai" }
	S.description = "Safety Alignment Intent Understanding: natural language turned into an actionable, scored intent for the Safety Alignment subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.safetyalignment.intent_understanding", minConfidence = 0.34 })
		inst.system = S
		inst.ctx = ctx
