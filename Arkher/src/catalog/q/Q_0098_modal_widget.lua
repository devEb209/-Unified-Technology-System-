-- ARKHER SYSTEM Q.0098 :: Modal Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0098"
	S.key = "arkher.ui.modal.widget_tree"
	S.name = "Modal Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Modal"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.modal.responsive_layout" }
	S.tags = { "q", "modal", "widget", "ui" }
	S.description = "Modal Widget Tree: retained widget nodes, properties, bindings and rendering for the Modal subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.modal.widget_tree", theme = "light", scale = 1.10 })
		inst.system = S
		inst.ctx = ctx
