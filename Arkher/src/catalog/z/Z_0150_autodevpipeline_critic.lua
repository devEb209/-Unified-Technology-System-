-- ARKHER SYSTEM Z.0150 :: Autonomous Development Pipeline Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0150"
	S.key = "arkher.origin.autodevpipeline.self_critique"
	S.name = "Autonomous Development Pipeline Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodevpipeline.intent_bridge" }
	S.tags = { "z", "autodevpipeline", "critic", "origin" }
	S.description = "Autonomous Development Pipeline Self Critique: weighted judgement of the technology's own output for the Autonomous Development Pipeline subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.autodevpipeline.self_critique", passMark = 0.71, reviseMark = 0.41, seed = 15331 })
		inst.system = S
		inst.ctx = ctx
