-- ARKHER SYSTEM Z.0940 :: Universal Interop Layer Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0940"
	S.key = "arkher.origin.interop.orchestration"
	S.name = "Universal Interop Layer Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.interop.residency_streaming" }
	S.tags = { "z", "interop", "orchestrator", "origin" }
	S.description = "Universal Interop Layer Orchestration: lifecycle and phase orchestration of the technology for the Universal Interop Layer subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.interop.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
