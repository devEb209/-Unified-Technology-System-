-- ARKHER SYSTEM Z.0775 :: Semantic LOD Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0775"
	S.key = "arkher.origin.semanticlod.signal_composition"
	S.name = "Semantic LOD Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticlod.telemetry_ledger" }
	S.tags = { "z", "semanticlod", "composer", "origin" }
	S.description = "Semantic LOD Signal Composition: blending of the technology's input signals into one output for the Semantic LOD subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.semanticlod.signal_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
