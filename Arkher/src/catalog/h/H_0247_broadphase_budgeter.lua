-- ARKHER SYSTEM H.0247 :: Broadphase Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0247"
	S.key = "arkher.physics.broadphase.budget_governor"
	S.name = "Broadphase Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Broadphase"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.broadphase.broadphase_index" }
	S.tags = { "h", "broadphase", "budgeter", "physics" }
	S.description = "Broadphase Budget Governor: simulation time budget allocation across islands for the Broadphase subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.broadphase.budget_governor", total = 453, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
