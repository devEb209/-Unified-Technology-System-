-- ARKHER SYSTEM T.0388 :: Refactoring Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0388"
	S.key = "arkher.ai.refactoring.utility_selection"
	S.name = "Refactoring Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.refactoring.working_memory" }
	S.tags = { "t", "refactoring", "utility", "ai" }
	S.description = "Refactoring Utility Selection: scored choice between competing courses of action for the Refactoring subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.refactoring.utility_selection", momentum = 0.17 })
		inst.system = S
		inst.ctx = ctx
