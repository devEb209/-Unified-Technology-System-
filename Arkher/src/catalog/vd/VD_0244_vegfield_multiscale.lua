-- ARKHER SYSTEM VD.0244 :: Vegetation Field Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0244"
	S.key = "arkher.contsim.vegfield.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vegfield.sparse_residency" }
	S.tags = { "vd", "vegfield", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.vegfield.multi-scale_fidelity", levels = 6, baseTriangles = 60000 })
		inst.system = S
		inst.ctx = ctx
