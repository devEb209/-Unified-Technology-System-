-- ARKHER SYSTEM VB.0441 :: Physics Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0441"
	S.key = "arkher.conttime.physicscont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.physicscont.world_memory_stream" }
	S.tags = { "vb", "physicscont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.physicscont.complexity_budget", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
