-- ARKHER SYSTEM T.0160 :: Code Generation Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0160"
	S.key = "arkher.ai.codegeneration.reasoning_graph"
	S.name = "Code Generation Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.codegeneration.world_architect" }
	S.tags = { "t", "codegeneration", "graph", "ai" }
	S.description = "Code Generation Reasoning Graph: relationship modelling and shortest-path reasoning for the Code Generation subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.codegeneration.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
