-- ARKHER SYSTEM Q.0203 :: Minimap Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0203"
	S.key = "arkher.ui.minimap.usability_analysis"
	S.name = "Minimap Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Minimap"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.minimap.frame_budget" }
	S.tags = { "q", "minimap", "analyzer", "ui" }
	S.description = "Minimap Usability Analysis: reachability, latency and abandonment analysis for the Minimap subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.minimap.usability_analysis", window = 88, buckets = 16, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
