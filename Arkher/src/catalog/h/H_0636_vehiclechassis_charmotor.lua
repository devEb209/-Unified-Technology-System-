-- ARKHER SYSTEM H.0636 :: Vehicle Chassis Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0636"
	S.key = "arkher.physics.vehiclechassis.character_motion"
	S.name = "Vehicle Chassis Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.vehiclechassis.query" }
	S.tags = { "h", "vehiclechassis", "charmotor", "physics" }
	S.description = "Vehicle Chassis Character Motion: capsule move-and-slide with slopes, steps and jumps for the Vehicle Chassis subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.vehiclechassis.character_motion", radius = 0.50, height = 1.75, maxSpeed = 9.50, jumpHeight = 1.90, stepOffset = 0.50 })
		inst.system = S
		inst.ctx = ctx
