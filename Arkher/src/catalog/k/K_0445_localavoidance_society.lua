-- ARKHER SYSTEM K.0445 :: Local Avoidance Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0445"
	S.key = "arkher.npc.localavoidance.social_relations"
	S.name = "Local Avoidance Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.localavoidance.crowd_steering" }
	S.tags = { "k", "localavoidance", "society", "npc" }
	S.description = "Local Avoidance Social Relations: affinity, factions, reputation and gossip for the Local Avoidance subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.localavoidance.social_relations", decayRate = 0.008, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
