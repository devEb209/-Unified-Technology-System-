-- ARKHER SYSTEM F.0306 :: Bloom Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0306"
	S.key = "arkher.render.bloom.frame_analysis"
	S.name = "Bloom Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Bloom"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.bloom.pass_cache" }
	S.tags = { "f", "bloom", "analyzer", "render" }
	S.description = "Bloom Frame Analysis: per-pass cost analysis and outlier detection for the Bloom subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.bloom.frame_analysis", window = 246, buckets = 10, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
