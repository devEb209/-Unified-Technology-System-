-- ARKHER SYSTEM N.0453 :: Screen Effect Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0453"
	S.key = "arkher.vfx.screenfx.spatial_index"
	S.name = "Screen Effect Spatial Index"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.screenfx.quality_policy" }
	S.tags = { "n", "screenfx", "index", "vfx" }
	S.description = "Screen Effect Spatial Index: spatial acceleration of effect queries and culling for the Screen Effect subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.screenfx.spatial_index", mode = "hash", cellSize = 56 })
		inst.system = S
		inst.ctx = ctx
