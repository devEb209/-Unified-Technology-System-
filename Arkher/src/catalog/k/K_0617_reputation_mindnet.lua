-- ARKHER SYSTEM K.0617 :: Reputation Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0617"
	S.key = "arkher.npc.reputation.mind_network"
	S.name = "Reputation Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "reputation", "mindnet", "npc" }
	S.description = "Reputation Mind Network: the learned policy that turns perception into a decision for the Reputation subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.reputation.mind_network", inputs = 8, hidden = 7, seed = 12018, learningRate = 0.090, exploration = 0.030 })
		inst.system = S
		inst.ctx = ctx
