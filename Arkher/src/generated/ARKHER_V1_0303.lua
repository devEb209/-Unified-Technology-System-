--!strict
-- CryEngine Qt — ANIMATION Map #0303
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="CryEngine Qt — ANIMATION Map #0303", size=Vector2.new(600, 480), pos=UDim2.fromOffset(439, 291), parent=parent, icon="♪"})
