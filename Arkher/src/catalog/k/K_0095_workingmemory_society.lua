-- ARKHER SYSTEM K.0095 :: Working Memory Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0095"
	S.key = "arkher.npc.workingmemory.social_relations"
	S.name = "Working Memory Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workingmemory.crowd_steering" }
	S.tags = { "k", "workingmemory", "society", "npc" }
	S.description = "Working Memory Social Relations: affinity, factions, reputation and gossip for the Working Memory subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.workingmemory.social_relations", decayRate = 0.011, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
