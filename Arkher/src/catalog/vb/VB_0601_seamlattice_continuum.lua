-- ARKHER SYSTEM VB.0601 :: Seam Lattice Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0601"
	S.key = "arkher.conttime.seamlattice.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "seamlattice", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.seamlattice.infinite_grid", cellSize = 128, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
