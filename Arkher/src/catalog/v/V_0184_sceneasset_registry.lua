-- ARKHER SYSTEM V.0184 :: Scene Asset Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0184"
	S.key = "arkher.asset.sceneasset.asset_registry"
	S.name = "Scene Asset Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.sceneasset.cook_pipeline" }
	S.tags = { "v", "sceneasset", "registry", "asset" }
	S.description = "Scene Asset Asset Registry: catalogue of every asset, its tags and its metadata for the Scene Asset subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.sceneasset.asset_registry" })
		inst.system = S
		inst.ctx = ctx
