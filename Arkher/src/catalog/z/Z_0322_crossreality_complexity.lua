-- ARKHER SYSTEM Z.0322 :: Cross Reality Sync Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0322"
	S.key = "arkher.origin.crossreality.complexity_governance"
	S.name = "Cross Reality Sync Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.reality_layering" }
	S.tags = { "z", "crossreality", "complexity", "origin" }
	S.description = "Cross Reality Sync Complexity Governance: measured scene cost turned into per-subsystem directives for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.crossreality.complexity_governance", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
