-- ARKHER SYSTEM E.0003 :: Material Library Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0003"
	S.key = "arkher.material.library.shading_graph"
	S.name = "Material Library Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.library.layer_composition" }
	S.tags = { "e", "library", "shadegraph", "material" }
	S.description = "Material Library Shading Graph: node graph evaluated and compiled to Luau for the Material Library subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.library.shading_graph" })
		inst.system = S
		inst.ctx = ctx
