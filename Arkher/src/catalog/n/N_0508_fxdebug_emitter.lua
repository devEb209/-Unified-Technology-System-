-- ARKHER SYSTEM N.0508 :: Effect Debug Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0508"
	S.key = "arkher.vfx.fxdebug.emission"
	S.name = "Effect Debug Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Effect Debug"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "fxdebug", "emitter", "vfx" }
	S.description = "Effect Debug Emission: shaped, rate and burst emission of new particles for the Effect Debug subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.fxdebug.emission", shape = "box", rate = 50, speed = 4.00, life = 0.80, budget = 256, seed = 4770 })
		inst.system = S
		inst.ctx = ctx
