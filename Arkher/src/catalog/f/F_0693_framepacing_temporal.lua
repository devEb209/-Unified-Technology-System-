-- ARKHER SYSTEM F.0693 :: Frame Pacing Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0693"
	S.key = "arkher.render.framepacing.temporal_resolve"
	S.name = "Frame Pacing Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Frame Pacing"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepacing.probe_volume" }
	S.tags = { "f", "framepacing", "temporal", "render" }
	S.description = "Frame Pacing Temporal Resolve: history reprojection with neighbourhood clamping for the Frame Pacing subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.framepacing.temporal_resolve", feedback = 0.80, phase = 8 })
		inst.system = S
		inst.ctx = ctx
