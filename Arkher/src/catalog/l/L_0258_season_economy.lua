-- ARKHER SYSTEM L.0258 :: Season Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0258"
	S.key = "arkher.sim.season.economy"
	S.name = "Season Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.season.ecology" }
	S.tags = { "l", "season", "economy", "sim" }
	S.description = "Season Economy: stock, production, demand, price discovery and trade for the Season subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.season.economy", elasticity = 0.37 })
		inst.system = S
		inst.ctx = ctx
