-- ARKHER SYSTEM VC.0503 :: Rendering Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0503"
	S.key = "arkher.contneural.rendercont.reality_continuum"
	S.name = "Rendering Continuum Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.rendercont.simulation_fabric" }
	S.tags = { "vc", "rendercont", "reality", "contneural" }
	S.description = "Rendering Continuum Reality Continuum: stacked reality layers of the continuum for the Rendering Continuum subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.rendercont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
