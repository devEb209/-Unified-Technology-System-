-- ARKHER SYSTEM VD.0367 :: Quest Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0367"
	S.key = "arkher.contsim.questcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.questcont.coherence_guard" }
	S.tags = { "vd", "questcont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.questcont.neural_field", dims = 16, hidden = 12, seed = 68901 })
		inst.system = S
		inst.ctx = ctx
