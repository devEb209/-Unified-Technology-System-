-- ARKHER SYSTEM F.0087 :: Contact Shadows Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0087"
	S.key = "arkher.render.contact.visibility_set"
	S.name = "Contact Shadows Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.contact.view_and_culling" }
	S.tags = { "f", "contact", "visibility", "render" }
	S.description = "Contact Shadows Visibility Set: cell, portal and occluder visibility for the Contact Shadows subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.contact.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
