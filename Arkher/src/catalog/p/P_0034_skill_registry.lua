-- ARKHER SYSTEM P.0034 :: Skill Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0034"
	S.key = "arkher.play.skill.content_registry"
	S.name = "Skill Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Skill"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.skill.difficulty_controller" }
	S.tags = { "p", "skill", "registry", "play" }
	S.description = "Skill Content Registry: catalogue of the definitions this loop instantiates for the Skill subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.skill.content_registry" })
		inst.system = S
		inst.ctx = ctx
