-- ARKHER SYSTEM Z.1003 :: Capability Discovery Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.1003"
	S.key = "arkher.origin.capabilitydiscovery.simulation_fabric"
	S.name = "Capability Discovery Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.complexity_governance" }
	S.tags = { "z", "capabilitydiscovery", "fabric", "origin" }
	S.description = "Capability Discovery Simulation Fabric: every simulation domain stepped under one budgeted clock for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.capabilitydiscovery.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
