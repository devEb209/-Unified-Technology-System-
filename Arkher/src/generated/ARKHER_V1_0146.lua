...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="USGS DEM — CORE Node_Flow #0146", size=Vector2.new(680, 440), pos=UDim2.fromOffset(398, 222), parent=parent, icon="◆"})
