-- ARKHER SYSTEM VA.0603 :: Seam Lattice Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0603"
	S.key = "arkher.contworld.seamlattice.sparse_residency"
	S.name = "Seam Lattice Sparse Residency"
	S.category = "VA"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.seamlattice.epoch_clock" }
	S.tags = { "va", "seamlattice", "sparse", "contworld" }
	S.description = "Seam Lattice Sparse Residency: sparse page residency with eviction and compression for the Seam Lattice subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.seamlattice.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
