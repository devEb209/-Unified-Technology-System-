-- ARKHER SYSTEM J.0309 :: Character Streaming Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0309"
	S.key = "arkher.character.characterstreaming.rig_definition"
	S.name = "Character Streaming Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "characterstreaming", "skeleton", "character" }
	S.description = "Character Streaming Rig Definition: character rig definition and bone budget for the Character Streaming subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.characterstreaming.rig_definition" })
		inst.system = S
		inst.ctx = ctx
