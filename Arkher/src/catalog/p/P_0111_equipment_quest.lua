-- ARKHER SYSTEM P.0111 :: Equipment Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0111"
	S.key = "arkher.play.equipment.objectives"
	S.name = "Equipment Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Equipment"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.equipment.inventory" }
	S.tags = { "p", "equipment", "quest", "play" }
	S.description = "Equipment Objectives: objectives, prerequisites, progress and rewards for the Equipment subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.equipment.objectives" })
		inst.system = S
		inst.ctx = ctx
