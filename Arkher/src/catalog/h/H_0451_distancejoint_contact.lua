-- ARKHER SYSTEM H.0451 :: Distance Joint Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0451"
	S.key = "arkher.physics.distancejoint.contact_generation"
	S.name = "Distance Joint Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.distancejoint.collision_shape" }
	S.tags = { "h", "distancejoint", "contact", "physics" }
	S.description = "Distance Joint Contact Generation: narrow-phase manifolds with normal, depth and point for the Distance Joint subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.distancejoint.contact_generation", slop = 0.0090, maxManifolds = 129 })
		inst.system = S
		inst.ctx = ctx
