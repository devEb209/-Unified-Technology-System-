-- ARKHER SYSTEM VB.0244 :: Vegetation Field Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0244"
	S.key = "arkher.conttime.vegfield.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vegfield.sparse_residency" }
	S.tags = { "vb", "vegfield", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.vegfield.multi-scale_fidelity", levels = 4, baseTriangles = 105000 })
		inst.system = S
		inst.ctx = ctx
