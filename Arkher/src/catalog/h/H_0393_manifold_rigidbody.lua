-- ARKHER SYSTEM H.0393 :: Contact Manifold Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0393"
	S.key = "arkher.physics.manifold.body_dynamics"
	S.name = "Contact Manifold Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "manifold", "rigidbody", "physics" }
	S.description = "Contact Manifold Body Dynamics: integration, impulses, damping and sleeping of a body for the Contact Manifold subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.manifold.body_dynamics", mass = 37.00, radius = 1.10, restitution = 0.36, friction = 0.46, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
