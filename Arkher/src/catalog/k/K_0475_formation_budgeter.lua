-- ARKHER SYSTEM K.0475 :: Formation Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0475"
	S.key = "arkher.npc.formation.thinking_budget"
	S.name = "Formation Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.formation.daily_schedule" }
	S.tags = { "k", "formation", "budgeter", "npc" }
	S.description = "Formation Thinking Budget: allocation of per-frame thinking time across NPCs for the Formation subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.formation.thinking_budget", total = 309, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
