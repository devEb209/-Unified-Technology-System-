-- ARKHER SYSTEM N.0291 :: Buff Effect Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0291"
	S.key = "arkher.vfx.bufffx.curve_authoring"
	S.name = "Buff Effect Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Buff Effect"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.bufffx.ribbon_and_trail" }
	S.tags = { "n", "bufffx", "spline", "vfx" }
	S.description = "Buff Effect Curve Authoring: authored curves driving the effect over its life for the Buff Effect subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.bufffx.curve_authoring", tension = 0.49, closed = false })
		inst.system = S
		inst.ctx = ctx
