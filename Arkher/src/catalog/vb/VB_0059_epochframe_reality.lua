-- ARKHER SYSTEM VB.0059 :: Epoch Frame Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0059"
	S.key = "arkher.conttime.epochframe.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.epochframe.simulation_fabric" }
	S.tags = { "vb", "epochframe", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.epochframe.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
