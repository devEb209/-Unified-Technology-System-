-- ARKHER SYSTEM VB.0241 :: Vegetation Field Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0241"
	S.key = "arkher.conttime.vegfield.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "vegfield", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.vegfield.infinite_grid", cellSize = 224, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
