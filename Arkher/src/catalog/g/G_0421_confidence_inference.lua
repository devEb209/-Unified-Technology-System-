-- ARKHER SYSTEM G.0421 :: Confidence Gating Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0421"
	S.key = "arkher.neural.confidence.inference_core"
	S.name = "Confidence Gating Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "confidence", "inference", "neural" }
	S.description = "Confidence Gating Inference Core: dense network forward pass and training for the Confidence Gating subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.confidence.inference_core", seed = 87686 })
		inst.system = S
		inst.ctx = ctx
