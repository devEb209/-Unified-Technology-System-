-- ARKHER SYSTEM F.0107 :: Ambient Occlusion Pass Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0107"
	S.key = "arkher.render.aopass.draw_budget"
	S.name = "Ambient Occlusion Pass Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.aopass.adaptive_resolution" }
	S.tags = { "f", "aopass", "budgeter", "render" }
	S.description = "Ambient Occlusion Pass Draw Budget: draw call and triangle budget allocation for the Ambient Occlusion Pass subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.aopass.draw_budget", total = 245, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
