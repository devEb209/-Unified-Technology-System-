-- ARKHER SYSTEM N.0051 :: Explosion Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0051"
	S.key = "arkher.vfx.explosion.analysis"
	S.name = "Explosion Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Explosion"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.explosion.spatial_index" }
	S.tags = { "n", "explosion", "analyzer", "vfx" }
	S.description = "Explosion Analysis: cost, overdraw and stability analysis of the effect for the Explosion subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.explosion.analysis", window = 86, buckets = 10, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
