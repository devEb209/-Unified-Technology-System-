-- ARKHER SYSTEM K.0398 :: Plan Execution Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0398"
	S.key = "arkher.npc.planexecution.reactive_behaviour"
	S.name = "Plan Execution Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.planexecution.perception" }
	S.tags = { "k", "planexecution", "behaviortree", "npc" }
	S.description = "Plan Execution Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Plan Execution subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.planexecution.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
