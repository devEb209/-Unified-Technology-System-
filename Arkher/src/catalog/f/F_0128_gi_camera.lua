-- ARKHER SYSTEM F.0128 :: Global Illumination View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0128"
	S.key = "arkher.render.gi.view_and_culling"
	S.name = "Global Illumination View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.gi.frame_graph" }
	S.tags = { "f", "gi", "camera", "render" }
	S.description = "Global Illumination View And Culling: view state, frustum culling and screen-size LOD for the Global Illumination subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.gi.view_and_culling", width = 1084, height = 900, fov = 1.0700, far = 1400 })
		inst.system = S
		inst.ctx = ctx
