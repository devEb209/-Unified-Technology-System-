-- ARKHER SYSTEM F.0048 :: Transparent Pass Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0048"
	S.key = "arkher.render.transparentpass.probe_volume"
	S.name = "Transparent Pass Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.transparentpass.lighting_rig" }
	S.tags = { "f", "transparentpass", "probe", "render" }
	S.description = "Transparent Pass Probe Volume: irradiance probes encoded in spherical harmonics for the Transparent Pass subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.transparentpass.probe_volume", spacing = 24 })
		inst.system = S
		inst.ctx = ctx
