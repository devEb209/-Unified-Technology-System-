-- ARKHER SYSTEM E.0258 :: UV Mapping Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0258"
	S.key = "arkher.material.uvmap.shading_graph"
	S.name = "UV Mapping Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "UV Mapping"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.uvmap.layer_composition" }
	S.tags = { "e", "uvmap", "shadegraph", "material" }
	S.description = "UV Mapping Shading Graph: node graph evaluated and compiled to Luau for the UV Mapping subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.uvmap.shading_graph" })
		inst.system = S
		inst.ctx = ctx
