-- ARKHER SYSTEM VB.0124 :: Spatial Slice Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0124"
	S.key = "arkher.conttime.spatialslice.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.spatialslice.sparse_residency" }
	S.tags = { "vb", "spatialslice", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.spatialslice.multi-scale_fidelity", levels = 4, baseTriangles = 75000 })
		inst.system = S
		inst.ctx = ctx
