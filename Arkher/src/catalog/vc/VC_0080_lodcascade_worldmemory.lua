-- ARKHER SYSTEM VC.0080 :: LOD Cascade World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0080"
	S.key = "arkher.contneural.lodcascade.world_memory_stream"
	S.name = "LOD Cascade World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lodcascade.neural_field" }
	S.tags = { "vc", "lodcascade", "worldmemory", "contneural" }
	S.description = "LOD Cascade World Memory Stream: world memory continuum over epochs for the LOD Cascade subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.lodcascade.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
