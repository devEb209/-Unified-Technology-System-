-- ARKHER SYSTEM W.0284 :: Depth Of Field Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0284"
	S.key = "arkher.cine.depthoffield.cinematic_mix"
	S.name = "Depth Of Field Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.depthoffield.motion_tween" }
	S.tags = { "w", "depthoffield", "mixer", "cine" }
	S.description = "Depth Of Field Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.depthoffield.cinematic_mix", maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
