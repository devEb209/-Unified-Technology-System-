-- ARKHER SYSTEM VD.0253 :: Road Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0253"
	S.key = "arkher.contsim.roadcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "roadcont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.roadcont.infinite_grid", cellSize = 224, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
