-- ARKHER SYSTEM H.0395 :: Contact Manifold Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0395"
	S.key = "arkher.physics.manifold.contact_generation"
	S.name = "Contact Manifold Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.manifold.collision_shape" }
	S.tags = { "h", "manifold", "contact", "physics" }
	S.description = "Contact Manifold Contact Generation: narrow-phase manifolds with normal, depth and point for the Contact Manifold subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.manifold.contact_generation", slop = 0.0070, maxManifolds = 200 })
		inst.system = S
		inst.ctx = ctx
