-- ARKHER SYSTEM K.0447 :: Local Avoidance Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0447"
	S.key = "arkher.npc.localavoidance.thinking_budget"
	S.name = "Local Avoidance Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.localavoidance.daily_schedule" }
	S.tags = { "k", "localavoidance", "budgeter", "npc" }
	S.description = "Local Avoidance Thinking Budget: allocation of per-frame thinking time across NPCs for the Local Avoidance subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.localavoidance.thinking_budget", total = 113, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
