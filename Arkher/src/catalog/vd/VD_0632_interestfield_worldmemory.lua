-- ARKHER SYSTEM VD.0632 :: Interest Field World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0632"
	S.key = "arkher.contsim.interestfield.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.interestfield.neural_field" }
	S.tags = { "vd", "interestfield", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.interestfield.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
