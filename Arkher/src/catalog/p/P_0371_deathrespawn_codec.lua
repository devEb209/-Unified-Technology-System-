-- ARKHER SYSTEM P.0371 :: Death And Respawn Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0371"
	S.key = "arkher.play.deathrespawn.save_codec"
	S.name = "Death And Respawn Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.deathrespawn.content_registry" }
	S.tags = { "p", "deathrespawn", "codec", "play" }
	S.description = "Death And Respawn Save Codec: persistence, diffing and checksum of gameplay state for the Death And Respawn subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.deathrespawn.save_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
