-- ARKHER SYSTEM Q.0338 :: Safe Area Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0338"
	S.key = "arkher.ui.safearea.widget_tree"
	S.name = "Safe Area Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Safe Area"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.safearea.responsive_layout" }
	S.tags = { "q", "safearea", "widget", "ui" }
	S.description = "Safe Area Widget Tree: retained widget nodes, properties, bindings and rendering for the Safe Area subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.safearea.widget_tree", theme = "light", scale = 1.04 })
		inst.system = S
		inst.ctx = ctx
