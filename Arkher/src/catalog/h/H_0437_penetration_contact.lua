-- ARKHER SYSTEM H.0437 :: Penetration Recovery Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0437"
	S.key = "arkher.physics.penetration.contact_generation"
	S.name = "Penetration Recovery Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.penetration.collision_shape" }
	S.tags = { "h", "penetration", "contact", "physics" }
	S.description = "Penetration Recovery Contact Generation: narrow-phase manifolds with normal, depth and point for the Penetration Recovery subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.penetration.contact_generation", slop = 0.0080, maxManifolds = 454 })
		inst.system = S
		inst.ctx = ctx
