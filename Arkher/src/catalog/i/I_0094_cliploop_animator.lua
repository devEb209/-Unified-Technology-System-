-- ARKHER SYSTEM I.0094 :: Clip Looping Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0094"
	S.key = "arkher.anim.cliploop.layered_blending"
	S.name = "Clip Looping Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Looping"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.cliploop.clip_sampling" }
	S.tags = { "i", "cliploop", "animator", "anim" }
	S.description = "Clip Looping Layered Blending: layers, crossfades, masks and blend trees for the Clip Looping subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.cliploop.layered_blending", budget = 12 })
		inst.system = S
		inst.ctx = ctx
