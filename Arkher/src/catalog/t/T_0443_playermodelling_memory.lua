-- ARKHER SYSTEM T.0443 :: Player Modelling Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0443"
	S.key = "arkher.ai.playermodelling.working_memory"
	S.name = "Player Modelling Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.playermodelling.outcome_prediction" }
	S.tags = { "t", "playermodelling", "memory", "ai" }
	S.description = "Player Modelling Working Memory: decaying, consolidating recall of what the agent learned for the Player Modelling subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.playermodelling.working_memory", capacity = 89, decayRate = 0.035, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
