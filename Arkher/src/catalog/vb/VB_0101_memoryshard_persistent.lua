-- ARKHER SYSTEM VB.0101 :: Memory Shard Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0101"
	S.key = "arkher.conttime.memoryshard.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memoryshard.multi-scale_fidelity" }
	S.tags = { "vb", "memoryshard", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.memoryshard.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
