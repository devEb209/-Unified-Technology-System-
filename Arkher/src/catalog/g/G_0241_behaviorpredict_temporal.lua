-- ARKHER SYSTEM G.0241 :: Behaviour Prediction Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0241"
	S.key = "arkher.neural.behaviorpredict.temporal_history"
	S.name = "Behaviour Prediction Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.behaviorpredict.feature_extraction" }
	S.tags = { "g", "behaviorpredict", "temporal", "neural" }
	S.description = "Behaviour Prediction Temporal History: history buffers reused across frames for the Behaviour Prediction subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.behaviorpredict.temporal_history", feedback = 0.91, phase = 8 })
		inst.system = S
		inst.ctx = ctx
