-- ARKHER SYSTEM Z.0507 :: Economic Emergence World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0507"
	S.key = "arkher.origin.economicemergence.world_architect"
	S.name = "Economic Emergence World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.economicemergence.emergence_detection" }
	S.tags = { "z", "economicemergence", "architect", "origin" }
	S.description = "Economic Emergence World Architect: hierarchical world composition with conserved budgets for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.economicemergence.world_architect", budget = 1200, seed = 95376 })
		inst.system = S
		inst.ctx = ctx
