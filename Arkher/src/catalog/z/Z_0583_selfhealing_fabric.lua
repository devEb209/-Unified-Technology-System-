-- ARKHER SYSTEM Z.0583 :: Self Healing Systems Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0583"
	S.key = "arkher.origin.selfhealing.simulation_fabric"
	S.name = "Self Healing Systems Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfhealing.complexity_governance" }
	S.tags = { "z", "selfhealing", "fabric", "origin" }
	S.description = "Self Healing Systems Simulation Fabric: every simulation domain stepped under one budgeted clock for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.selfhealing.simulation_fabric", budgetMs = 1.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
