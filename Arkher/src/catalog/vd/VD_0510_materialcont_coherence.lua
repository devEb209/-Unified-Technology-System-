-- ARKHER SYSTEM VD.0510 :: Material Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0510"
	S.key = "arkher.contsim.materialcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.materialcont.persistent_state" }
	S.tags = { "vd", "materialcont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.materialcont.coherence_guard", window = 116, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
