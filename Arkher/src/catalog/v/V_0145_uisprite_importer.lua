-- ARKHER SYSTEM V.0145 :: UI Sprite Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0145"
	S.key = "arkher.asset.uisprite.import"
	S.name = "UI Sprite Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "uisprite", "importer", "asset" }
	S.description = "UI Sprite Import: validation, normalization, hashing and deduplication of incoming content for the UI Sprite subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.uisprite.import", unitScale = 1.00 })
		inst.system = S
		inst.ctx = ctx
