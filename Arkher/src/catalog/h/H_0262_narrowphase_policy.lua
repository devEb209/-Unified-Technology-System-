-- ARKHER SYSTEM H.0262 :: Narrowphase Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0262"
	S.key = "arkher.physics.narrowphase.simulation_policy"
	S.name = "Narrowphase Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Narrowphase"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.narrowphase.budget_governor" }
	S.tags = { "h", "narrowphase", "policy", "physics" }
	S.description = "Narrowphase Simulation Policy: device tier rules for substeps, iterations and sleep for the Narrowphase subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.narrowphase.simulation_policy", algorithm = "edf", starvationGuard = 21 })
		inst.system = S
		inst.ctx = ctx
