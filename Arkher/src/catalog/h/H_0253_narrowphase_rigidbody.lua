-- ARKHER SYSTEM H.0253 :: Narrowphase Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0253"
	S.key = "arkher.physics.narrowphase.body_dynamics"
	S.name = "Narrowphase Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Narrowphase"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "narrowphase", "rigidbody", "physics" }
	S.description = "Narrowphase Body Dynamics: integration, impulses, damping and sleeping of a body for the Narrowphase subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.narrowphase.body_dynamics", mass = 24.00, radius = 0.45, restitution = 0.23, friction = 0.63, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
