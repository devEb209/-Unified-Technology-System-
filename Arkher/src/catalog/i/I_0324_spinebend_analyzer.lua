-- ARKHER SYSTEM I.0324 :: Spine Bend Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0324"
	S.key = "arkher.anim.spinebend.analysis"
	S.name = "Spine Bend Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Spine Bend"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.spinebend.quality_policy" }
	S.tags = { "i", "spinebend", "analyzer", "anim" }
	S.description = "Spine Bend Analysis: pop, drift and cost analysis of playback for the Spine Bend subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.spinebend.analysis", window = 183, buckets = 19, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
