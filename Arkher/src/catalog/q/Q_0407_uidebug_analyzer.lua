-- ARKHER SYSTEM Q.0407 :: UI Debug Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0407"
	S.key = "arkher.ui.uidebug.usability_analysis"
	S.name = "UI Debug Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "UI Debug"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uidebug.frame_budget" }
	S.tags = { "q", "uidebug", "analyzer", "ui" }
	S.description = "UI Debug Usability Analysis: reachability, latency and abandonment analysis for the UI Debug subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.uidebug.usability_analysis", window = 166, buckets = 10, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
