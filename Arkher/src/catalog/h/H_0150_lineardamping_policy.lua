-- ARKHER SYSTEM H.0150 :: Linear Damping Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0150"
	S.key = "arkher.physics.lineardamping.simulation_policy"
	S.name = "Linear Damping Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.lineardamping.budget_governor" }
	S.tags = { "h", "lineardamping", "policy", "physics" }
	S.description = "Linear Damping Simulation Policy: device tier rules for substeps, iterations and sleep for the Linear Damping subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.lineardamping.simulation_policy", algorithm = "wfq", starvationGuard = 30 })
		inst.system = S
		inst.ctx = ctx
