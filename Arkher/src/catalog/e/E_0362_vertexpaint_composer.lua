-- ARKHER SYSTEM E.0362 :: Vertex Painting Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0362"
	S.key = "arkher.material.vertexpaint.layer_composition"
	S.name = "Vertex Painting Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.vertexpaint.definition" }
	S.tags = { "e", "vertexpaint", "composer", "material" }
	S.description = "Vertex Painting Layer Composition: ordered layer composition with blend rules for the Vertex Painting subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.vertexpaint.layer_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
