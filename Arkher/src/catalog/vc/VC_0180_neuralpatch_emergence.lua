-- ARKHER SYSTEM VC.0180 :: Neural Patch Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0180"
	S.key = "arkher.contneural.neuralpatch.emergence_continuum"
	S.name = "Neural Patch Emergence Continuum"
	S.category = "VC"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.neuralpatch.reality_continuum" }
	S.tags = { "vc", "neuralpatch", "emergence", "contneural" }
	S.description = "Neural Patch Emergence Continuum: emergence detection over the continuum for the Neural Patch subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.neuralpatch.emergence_continuum", windowSize = 5, threshold = 1.60, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
