-- ARKHER SYSTEM K.0219 :: Mood Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0219"
	S.key = "arkher.npc.mood.navigation"
	S.name = "Mood Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.mood.goal_planner" }
	S.tags = { "k", "mood", "navgraph", "npc" }
	S.description = "Mood Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Mood subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.mood.navigation", width = 40, height = 40, cellSize = 4 })
		inst.system = S
		inst.ctx = ctx
