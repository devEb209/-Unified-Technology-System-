-- ARKHER SYSTEM R.0068 :: Entity Replication Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0068"
	S.key = "arkher.net.entityreplication.rate_guard"
	S.name = "Entity Replication Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.entityreplication.interest_streaming" }
	S.tags = { "r", "entityreplication", "guard", "net" }
	S.description = "Entity Replication Rate Guard: token-bucket protection against floods and abuse for the Entity Replication subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.entityreplication.rate_guard", algorithm = "token", capacity = 47, refillPerSec = 32, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
