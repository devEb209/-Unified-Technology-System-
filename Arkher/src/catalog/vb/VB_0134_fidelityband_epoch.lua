-- ARKHER SYSTEM VB.0134 :: Fidelity Band Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0134"
	S.key = "arkher.conttime.fidelityband.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.fidelityband.infinite_grid" }
	S.tags = { "vb", "fidelityband", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.fidelityband.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
