-- ARKHER SYSTEM N.0417 :: Foliage Motion Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0417"
	S.key = "arkher.vfx.foliagemotion.emission"
	S.name = "Foliage Motion Emission"
	S.category = "N"
	S.family = "VFX"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "foliagemotion", "emitter", "vfx" }
	S.description = "Foliage Motion Emission: shaped, rate and burst emission of new particles for the Foliage Motion subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.foliagemotion.emission", shape = "cone", rate = 72, speed = 4.20, life = 3.00, budget = 384, seed = 83452 })
		inst.system = S
		inst.ctx = ctx
