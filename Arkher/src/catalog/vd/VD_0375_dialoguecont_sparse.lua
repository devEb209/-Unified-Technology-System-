-- ARKHER SYSTEM VD.0375 :: Dialogue Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0375"
	S.key = "arkher.contsim.dialoguecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.dialoguecont.epoch_clock" }
	S.tags = { "vd", "dialoguecont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.dialoguecont.sparse_residency", capacity = 512, pageBytes = 5120 })
		inst.system = S
		inst.ctx = ctx
