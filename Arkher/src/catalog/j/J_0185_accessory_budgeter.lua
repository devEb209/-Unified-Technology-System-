-- ARKHER SYSTEM J.0185 :: Accessory Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0185"
	S.key = "arkher.character.accessory.budget_governor"
	S.name = "Accessory Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.accessory.variant_registry" }
	S.tags = { "j", "accessory", "budgeter", "character" }
	S.description = "Accessory Budget Governor: per-character cost allocation in a crowd for the Accessory subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.accessory.budget_governor", total = 447, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
