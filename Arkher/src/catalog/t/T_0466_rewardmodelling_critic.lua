-- ARKHER SYSTEM T.0466 :: Reward Modelling Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0466"
	S.key = "arkher.ai.rewardmodelling.self_critique"
	S.name = "Reward Modelling Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.rewardmodelling.plan_workflow" }
	S.tags = { "t", "rewardmodelling", "critic", "ai" }
	S.description = "Reward Modelling Self Critique: weighted evaluation of the result against declared criteria for the Reward Modelling subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.rewardmodelling.self_critique", passMark = 0.81, reviseMark = 0.46, seed = 3386 })
		inst.system = S
		inst.ctx = ctx
