-- ARKHER SYSTEM VA.0624 :: Occupancy Map Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0624"
	S.key = "arkher.contworld.occupancymap.emergence_continuum"
	S.name = "Occupancy Map Emergence Continuum"
	S.category = "VA"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.occupancymap.reality_continuum" }
	S.tags = { "va", "occupancymap", "emergence", "contworld" }
	S.description = "Occupancy Map Emergence Continuum: emergence detection over the continuum for the Occupancy Map subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.occupancymap.emergence_continuum", windowSize = 4, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
