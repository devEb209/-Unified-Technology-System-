-- ARKHER SYSTEM N.0516 :: Effect Debug Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0516"
	S.key = "arkher.vfx.fxdebug.result_cache"
	S.name = "Effect Debug Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Effect Debug"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fxdebug.spawn_budget" }
	S.tags = { "n", "fxdebug", "cache", "vfx" }
	S.description = "Effect Debug Result Cache: reuse of expensive effect evaluations for the Effect Debug subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.fxdebug.result_cache", policy = "lru", capacity = 116, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
