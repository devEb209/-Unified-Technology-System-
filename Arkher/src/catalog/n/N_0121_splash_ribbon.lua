-- ARKHER SYSTEM N.0121 :: Water Splash Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0121"
	S.key = "arkher.vfx.splash.ribbon_and_trail"
	S.name = "Water Splash Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Water Splash"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.splash.force_field" }
	S.tags = { "n", "splash", "ribbon", "vfx" }
	S.description = "Water Splash Ribbon And Trail: trail points, tapering, beams and decimation for the Water Splash subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.splash.ribbon_and_trail", maxPoints = 16, lifetime = 1.30, minDistance = 0.50, width = 0.20 })
		inst.system = S
		inst.ctx = ctx
