-- ARKHER SYSTEM VD.0379 :: Dialogue Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0379"
	S.key = "arkher.contsim.dialoguecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.dialoguecont.coherence_guard" }
	S.tags = { "vd", "dialoguecont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.dialoguecont.neural_field", dims = 24, hidden = 20, seed = 30811 })
		inst.system = S
		inst.ctx = ctx
