-- ARKHER SYSTEM Q.0015 :: Panel Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0015"
	S.key = "arkher.ui.panel.input_mapping"
	S.name = "Panel Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Panel"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.panel.widget_tree" }
	S.tags = { "q", "panel", "inputmap", "ui" }
	S.description = "Panel Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Panel subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.panel.input_mapping", device = "gamepad", holdTime = 0.31, deadzone = 0.11 })
		inst.system = S
		inst.ctx = ctx
