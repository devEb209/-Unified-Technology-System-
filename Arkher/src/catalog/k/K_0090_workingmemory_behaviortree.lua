-- ARKHER SYSTEM K.0090 :: Working Memory Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0090"
	S.key = "arkher.npc.workingmemory.reactive_behaviour"
	S.name = "Working Memory Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workingmemory.perception" }
	S.tags = { "k", "workingmemory", "behaviortree", "npc" }
	S.description = "Working Memory Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Working Memory subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.workingmemory.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
