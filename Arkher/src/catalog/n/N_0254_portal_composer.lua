-- ARKHER SYSTEM N.0254 :: Portal Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0254"
	S.key = "arkher.vfx.portal.effect_composition"
	S.name = "Portal Effect Composition"
	S.category = "N"
	S.family = "VFX"
	S.area = "Portal"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.portal.effect_graph" }
	S.tags = { "n", "portal", "composer", "vfx" }
	S.description = "Portal Effect Composition: blending of several effect signals into one output for the Portal subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.portal.effect_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
