-- ARKHER SYSTEM O.0295 :: UI Sound Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0295"
	S.key = "arkher.audio.uisound.asset_registry"
	S.name = "UI Sound Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "UI Sound"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.uisound.streaming" }
	S.tags = { "o", "uisound", "registry", "audio" }
	S.description = "UI Sound Asset Registry: catalogue of sounds, variations and metadata for the UI Sound subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.uisound.asset_registry" })
		inst.system = S
		inst.ctx = ctx
