-- ARKHER SYSTEM F.0061 :: Shadow Pass Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0061"
	S.key = "arkher.render.shadowpass.lighting_rig"
	S.name = "Shadow Pass Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Shadow Pass"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.shadowpass.geometry_virtualization" }
	S.tags = { "f", "shadowpass", "lightrig", "render" }
	S.description = "Shadow Pass Lighting Rig: light clustering, importance and cascades for the Shadow Pass subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.shadowpass.lighting_rig", maxActive = 7 })
		inst.system = S
		inst.ctx = ctx
