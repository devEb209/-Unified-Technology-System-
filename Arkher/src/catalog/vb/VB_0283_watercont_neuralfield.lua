-- ARKHER SYSTEM VB.0283 :: Water Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0283"
	S.key = "arkher.conttime.watercont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.watercont.coherence_guard" }
	S.tags = { "vb", "watercont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.watercont.neural_field", dims = 12, hidden = 8, seed = 86356 })
		inst.system = S
		inst.ctx = ctx
