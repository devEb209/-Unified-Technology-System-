-- ARKHER SYSTEM R.0092 :: Property Replication Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0092"
	S.key = "arkher.net.propertyreplication.rate_guard"
	S.name = "Property Replication Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.propertyreplication.interest_streaming" }
	S.tags = { "r", "propertyreplication", "guard", "net" }
	S.description = "Property Replication Rate Guard: token-bucket protection against floods and abuse for the Property Replication subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.propertyreplication.rate_guard", algorithm = "token", capacity = 183, refillPerSec = 8, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
