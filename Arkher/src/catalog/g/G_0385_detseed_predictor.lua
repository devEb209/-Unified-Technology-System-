-- ARKHER SYSTEM G.0385 :: Deterministic Seeding Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0385"
	S.key = "arkher.neural.detseed.quality_predictor"
	S.name = "Deterministic Seeding Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detseed.weight_codec" }
	S.tags = { "g", "detseed", "predictor", "neural" }
	S.description = "Deterministic Seeding Quality Predictor: predicted quality and cost of a setting for the Deterministic Seeding subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.detseed.quality_predictor", method = "markov", alpha = 0.45, window = 91 })
		inst.system = S
		inst.ctx = ctx
