-- ARKHER SYSTEM G.0044 :: Frame Interpolation Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0044"
	S.key = "arkher.neural.frameinterp.feature_extraction"
	S.name = "Frame Interpolation Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.frameinterp.inference_core" }
	S.tags = { "g", "frameinterp", "field", "neural" }
	S.description = "Frame Interpolation Feature Extraction: signal features feeding the model for the Frame Interpolation subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.frameinterp.feature_extraction", seed = 30414, frequency = 0.0075, octaves = 5, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
