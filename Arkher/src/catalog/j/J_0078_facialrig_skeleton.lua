-- ARKHER SYSTEM J.0078 :: Facial Rig Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0078"
	S.key = "arkher.character.facialrig.rig_definition"
	S.name = "Facial Rig Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "facialrig", "skeleton", "character" }
	S.description = "Facial Rig Rig Definition: character rig definition and bone budget for the Facial Rig subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.facialrig.rig_definition" })
		inst.system = S
		inst.ctx = ctx
