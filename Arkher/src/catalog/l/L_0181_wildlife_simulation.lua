-- ARKHER SYSTEM L.0181 :: Wildlife Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0181"
	S.key = "arkher.sim.wildlife.simulation_core"
	S.name = "Wildlife Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "wildlife", "simulation", "sim" }
	S.description = "Wildlife Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Wildlife subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.wildlife.simulation_core", fullRadius = 160, reducedRadius = 700, budget = 33 })
		inst.system = S
		inst.ctx = ctx
