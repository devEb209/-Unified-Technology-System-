-- ARKHER SYSTEM L.0275 :: Day Night Cycle Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0275"
	S.key = "arkher.sim.daynight.calendar"
	S.name = "Day Night Cycle Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.daynight.society" }
	S.tags = { "l", "daynight", "schedule", "sim" }
	S.description = "Day Night Cycle Calendar: hours, days and seasons driving the region for the Day Night Cycle subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.daynight.calendar", startHour = 8 })
		inst.system = S
		inst.ctx = ctx
