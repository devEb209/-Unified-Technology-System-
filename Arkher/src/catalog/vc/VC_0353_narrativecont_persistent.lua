-- ARKHER SYSTEM VC.0353 :: Narrative Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0353"
	S.key = "arkher.contneural.narrativecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.narrativecont.multi-scale_fidelity" }
	S.tags = { "vc", "narrativecont", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.narrativecont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
