-- ARKHER SYSTEM O.0125 :: Wind Audio Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0125"
	S.key = "arkher.audio.windaudio.voice_budget"
	S.name = "Wind Audio Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Wind Audio"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.windaudio.music_sequencer" }
	S.tags = { "o", "windaudio", "budgeter", "audio" }
	S.description = "Wind Audio Voice Budget: voice slots allocated by priority and audibility for the Wind Audio subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.windaudio.voice_budget", total = 365, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
