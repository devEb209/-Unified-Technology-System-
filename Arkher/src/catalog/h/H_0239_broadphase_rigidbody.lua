-- ARKHER SYSTEM H.0239 :: Broadphase Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0239"
	S.key = "arkher.physics.broadphase.body_dynamics"
	S.name = "Broadphase Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Broadphase"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "broadphase", "rigidbody", "physics" }
	S.description = "Broadphase Body Dynamics: integration, impulses, damping and sleeping of a body for the Broadphase subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.broadphase.body_dynamics", mass = 14.00, radius = 0.95, restitution = 0.33, friction = 0.63, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
