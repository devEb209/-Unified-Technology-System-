-- ARKHER SYSTEM Q.0149 :: Tab Bar Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0149"
	S.key = "arkher.ui.tabbar.navigation_graph"
	S.name = "Tab Bar Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tab Bar"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.tabbar.transition" }
	S.tags = { "q", "tabbar", "graph", "ui" }
	S.description = "Tab Bar Navigation Graph: screens, routes and shortest path between them for the Tab Bar subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.tabbar.navigation_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
