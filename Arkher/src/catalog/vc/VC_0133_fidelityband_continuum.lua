-- ARKHER SYSTEM VC.0133 :: Fidelity Band Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0133"
	S.key = "arkher.contneural.fidelityband.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "fidelityband", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.fidelityband.infinite_grid", cellSize = 160, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
