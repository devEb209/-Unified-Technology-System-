-- ARKHER SYSTEM P.0094 :: Level Up Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0094"
	S.key = "arkher.play.levelup.content_registry"
	S.name = "Level Up Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Level Up"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.levelup.difficulty_controller" }
	S.tags = { "p", "levelup", "registry", "play" }
	S.description = "Level Up Content Registry: catalogue of the definitions this loop instantiates for the Level Up subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.levelup.content_registry" })
		inst.system = S
		inst.ctx = ctx
