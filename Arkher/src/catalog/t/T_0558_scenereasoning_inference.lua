-- ARKHER SYSTEM T.0558 :: Scene Reasoning Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0558"
	S.key = "arkher.ai.scenereasoning.model_inference"
	S.name = "Scene Reasoning Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.scenereasoning.action_planner" }
	S.tags = { "t", "scenereasoning", "inference", "ai" }
	S.description = "Scene Reasoning Model Inference: quantized inference with batching and budget for the Scene Reasoning subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.scenereasoning.model_inference", seed = 35054 })
		inst.system = S
		inst.ctx = ctx
