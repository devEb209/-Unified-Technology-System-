-- ARKHER SYSTEM G.0503 :: Neural Debug Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0503"
	S.key = "arkher.neural.neuraldebug.sampling_graph"
	S.name = "Neural Debug Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuraldebug.training_ledger" }
	S.tags = { "g", "neuraldebug", "graph", "neural" }
	S.description = "Neural Debug Sampling Graph: dependency graph of sampling stages for the Neural Debug subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.neuraldebug.sampling_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
