-- ARKHER SYSTEM VB.0429 :: Navigation Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0429"
	S.key = "arkher.conttime.navcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.navcont.world_memory_stream" }
	S.tags = { "vb", "navcont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.navcont.complexity_budget", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
