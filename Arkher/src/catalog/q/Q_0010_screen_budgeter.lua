-- ARKHER SYSTEM Q.0010 :: Screen Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0010"
	S.key = "arkher.ui.screen.frame_budget"
	S.name = "Screen Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Screen"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.screen.accessibility_policy" }
	S.tags = { "q", "screen", "budgeter", "ui" }
	S.description = "Screen Frame Budget: per-frame layout and draw budget for the interface for the Screen subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.screen.frame_budget", total = 108, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
