-- ARKHER SYSTEM F.0085 :: Contact Shadows Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0085"
	S.key = "arkher.render.contact.frame_graph"
	S.name = "Contact Shadows Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "contact", "framegraph", "render" }
	S.description = "Contact Shadows Frame Graph: declared passes, culling, ordering and aliasing for the Contact Shadows subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.contact.frame_graph", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
