-- ARKHER SYSTEM N.0002 :: Spark Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0002"
	S.key = "arkher.vfx.spark.particle_simulation"
	S.name = "Spark Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spark"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spark.emission" }
	S.tags = { "n", "spark", "particles", "vfx" }
	S.description = "Spark Particle Simulation: pooled integration of position, velocity, colour and life for the Spark subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.spark.particle_simulation", capacity = 128, drag = 0.21, bounce = 0.26, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
