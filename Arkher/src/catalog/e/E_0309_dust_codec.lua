-- ARKHER SYSTEM E.0309 :: Dust Accumulation Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0309"
	S.key = "arkher.material.dust.compression_codec"
	S.name = "Dust Accumulation Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.dust.streaming" }
	S.tags = { "e", "dust", "codec", "material" }
	S.description = "Dust Accumulation Compression Codec: serialization and compression of material data for the Dust Accumulation subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.dust.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
