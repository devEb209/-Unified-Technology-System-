-- ARKHER SYSTEM L.0392 :: Wealth Distribution Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0392"
	S.key = "arkher.sim.wealth.ecology"
	S.name = "Wealth Distribution Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wealth.simulation_core" }
	S.tags = { "l", "wealth", "ecology", "sim" }
	S.description = "Wealth Distribution Ecology: populations, predation, harvesting and carrying capacity for the Wealth Distribution subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.wealth.ecology" })
		inst.system = S
		inst.ctx = ctx
