-- ARKHER SYSTEM V.0350 :: Manifest Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0350"
	S.key = "arkher.asset.assetmanifest.bundling"
	S.name = "Manifest Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetmanifest.import" }
	S.tags = { "v", "assetmanifest", "bundler", "asset" }
	S.description = "Manifest Bundling: size-bounded packing, manifests and delta patches for the Manifest subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.assetmanifest.bundling", maxBundleBytes = 1048576 })
		inst.system = S
		inst.ctx = ctx
