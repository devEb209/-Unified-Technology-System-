-- ARKHER SYSTEM VA.0635 :: Interest Field Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0635"
	S.key = "arkher.contworld.interestfield.reality_continuum"
	S.name = "Interest Field Reality Continuum"
	S.category = "VA"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.interestfield.simulation_fabric" }
	S.tags = { "va", "interestfield", "reality", "contworld" }
	S.description = "Interest Field Reality Continuum: stacked reality layers of the continuum for the Interest Field subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.interestfield.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
