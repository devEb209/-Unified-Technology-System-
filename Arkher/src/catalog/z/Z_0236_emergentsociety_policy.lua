-- ARKHER SYSTEM Z.0236 :: Emergent Society Framework Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0236"
	S.key = "arkher.origin.emergentsociety.governance_policy"
	S.name = "Emergent Society Framework Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentsociety.signal_composition" }
	S.tags = { "z", "emergentsociety", "policy", "origin" }
	S.description = "Emergent Society Framework Governance Policy: ordered rules governing when the technology may act for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.emergentsociety.governance_policy", algorithm = "roundrobin", starvationGuard = 16 })
		inst.system = S
		inst.ctx = ctx
