-- ARKHER SYSTEM VD.0457 :: Audio Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0457"
	S.key = "arkher.contsim.audiocont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "audiocont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.audiocont.infinite_grid", cellSize = 192, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
