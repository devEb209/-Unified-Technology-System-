-- ARKHER SYSTEM VA.0047 :: Continuum Stream Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0047"
	S.key = "arkher.contworld.continuumstream.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.continuumstream.simulation_fabric" }
	S.tags = { "va", "continuumstream", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.continuumstream.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
