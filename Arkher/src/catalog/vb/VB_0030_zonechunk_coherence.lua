-- ARKHER SYSTEM VB.0030 :: Zone Chunk Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0030"
	S.key = "arkher.conttime.zonechunk.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.zonechunk.persistent_state" }
	S.tags = { "vb", "zonechunk", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.zonechunk.coherence_guard", window = 78, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
