-- ARKHER SYSTEM W.0219 :: Transition Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0219"
	S.key = "arkher.cine.cinetransition.colour_grade"
	S.name = "Transition Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Transition"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinetransition.camera_rig" }
	S.tags = { "w", "cinetransition", "grade", "cine" }
	S.description = "Transition Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Transition subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.cinetransition.colour_grade", exposure = 0.09, contrast = 1.14, saturation = 1.19, toneMap = "filmic" })
		inst.system = S
		inst.ctx = ctx
