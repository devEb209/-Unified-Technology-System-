-- ARKHER SYSTEM VC.0512 :: Material Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0512"
	S.key = "arkher.contneural.materialcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.materialcont.neural_field" }
	S.tags = { "vc", "materialcont", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.materialcont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
