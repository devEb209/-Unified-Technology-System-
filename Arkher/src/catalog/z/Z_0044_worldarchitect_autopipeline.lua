-- ARKHER SYSTEM Z.0044 :: Singularity World Architect Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0044"
	S.key = "arkher.origin.worldarchitect.autonomous_pipeline"
	S.name = "Singularity World Architect Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.simulation_fabric" }
	S.tags = { "z", "worldarchitect", "autopipeline", "origin" }
	S.description = "Singularity World Architect Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.worldarchitect.autonomous_pipeline", maxIterations = 4 })
		inst.system = S
		inst.ctx = ctx
