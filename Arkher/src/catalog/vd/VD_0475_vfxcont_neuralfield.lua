-- ARKHER SYSTEM VD.0475 :: VFX Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0475"
	S.key = "arkher.contsim.vfxcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vfxcont.coherence_guard" }
	S.tags = { "vd", "vfxcont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.vfxcont.neural_field", dims = 16, hidden = 12, seed = 91897 })
		inst.system = S
		inst.ctx = ctx
