-- ARKHER SYSTEM F.0235 :: Water Rendering Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0235"
	S.key = "arkher.render.water.pass_cache"
	S.name = "Water Rendering Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.water.render_policy" }
	S.tags = { "f", "water", "cache", "render" }
	S.description = "Water Rendering Pass Cache: reuse of pass results across frames for the Water Rendering subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.water.pass_cache", policy = "lfu", capacity = 495, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
