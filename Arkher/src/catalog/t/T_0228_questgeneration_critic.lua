-- ARKHER SYSTEM T.0228 :: Quest Generation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0228"
	S.key = "arkher.ai.questgeneration.self_critique"
	S.name = "Quest Generation Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.questgeneration.plan_workflow" }
	S.tags = { "t", "questgeneration", "critic", "ai" }
	S.description = "Quest Generation Self Critique: weighted evaluation of the result against declared criteria for the Quest Generation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.questgeneration.self_critique", passMark = 0.72, reviseMark = 0.47, seed = 43907 })
		inst.system = S
		inst.ctx = ctx
