-- ARKHER SYSTEM N.0357 :: Laser Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0357"
	S.key = "arkher.vfx.laser.effect_graph"
	S.name = "Laser Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Laser"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.laser.curve_authoring" }
	S.tags = { "n", "laser", "shadegraph", "vfx" }
	S.description = "Laser Effect Graph: node graph describing how the effect is shaded for the Laser subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.laser.effect_graph" })
		inst.system = S
		inst.ctx = ctx
