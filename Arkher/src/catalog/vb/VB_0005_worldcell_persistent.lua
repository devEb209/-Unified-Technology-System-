-- ARKHER SYSTEM VB.0005 :: World Grid Cell Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0005"
	S.key = "arkher.conttime.worldcell.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldcell.multi-scale_fidelity" }
	S.tags = { "vb", "worldcell", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.worldcell.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
