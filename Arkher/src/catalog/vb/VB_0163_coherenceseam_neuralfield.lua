-- ARKHER SYSTEM VB.0163 :: Coherence Seam Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0163"
	S.key = "arkher.conttime.coherenceseam.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.coherenceseam.coherence_guard" }
	S.tags = { "vb", "coherenceseam", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.coherenceseam.neural_field", dims = 20, hidden = 16, seed = 29250 })
		inst.system = S
		inst.ctx = ctx
