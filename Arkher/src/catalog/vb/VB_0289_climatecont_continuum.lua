-- ARKHER SYSTEM VB.0289 :: Climate Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0289"
	S.key = "arkher.conttime.climatecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "climatecont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.climatecont.infinite_grid", cellSize = 224, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
