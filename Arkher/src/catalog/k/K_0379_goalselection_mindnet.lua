-- ARKHER SYSTEM K.0379 :: Goal Selection Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0379"
	S.key = "arkher.npc.goalselection.mind_network"
	S.name = "Goal Selection Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "goalselection", "mindnet", "npc" }
	S.description = "Goal Selection Mind Network: the learned policy that turns perception into a decision for the Goal Selection subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.goalselection.mind_network", inputs = 8, hidden = 6, seed = 27042, learningRate = 0.060, exploration = 0.030 })
		inst.system = S
		inst.ctx = ctx
