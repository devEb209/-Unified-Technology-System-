-- ARKHER SYSTEM H.0081 :: Center Of Mass Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0081"
	S.key = "arkher.physics.centerofmass.result_cache"
	S.name = "Center Of Mass Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.centerofmass.simulation_policy" }
	S.tags = { "h", "centerofmass", "cache", "physics" }
	S.description = "Center Of Mass Result Cache: reuse of expensive simulation and query results for the Center Of Mass subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.centerofmass.result_cache", policy = "lru", capacity = 172, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
