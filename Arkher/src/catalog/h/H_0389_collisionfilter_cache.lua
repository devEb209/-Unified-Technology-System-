-- ARKHER SYSTEM H.0389 :: Collision Filter Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0389"
	S.key = "arkher.physics.collisionfilter.result_cache"
	S.name = "Collision Filter Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.collisionfilter.simulation_policy" }
	S.tags = { "h", "collisionfilter", "cache", "physics" }
	S.description = "Collision Filter Result Cache: reuse of expensive simulation and query results for the Collision Filter subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.collisionfilter.result_cache", policy = "lru", capacity = 222, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
