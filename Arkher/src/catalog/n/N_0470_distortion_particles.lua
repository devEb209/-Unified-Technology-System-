-- ARKHER SYSTEM N.0470 :: Distortion Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0470"
	S.key = "arkher.vfx.distortion.particle_simulation"
	S.name = "Distortion Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Distortion"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.distortion.emission" }
	S.tags = { "n", "distortion", "particles", "vfx" }
	S.description = "Distortion Particle Simulation: pooled integration of position, velocity, colour and life for the Distortion subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.distortion.particle_simulation", capacity = 192, drag = 0.14, bounce = 0.29, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
