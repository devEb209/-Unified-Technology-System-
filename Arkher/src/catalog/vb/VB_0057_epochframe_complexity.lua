-- ARKHER SYSTEM VB.0057 :: Epoch Frame Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0057"
	S.key = "arkher.conttime.epochframe.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.epochframe.world_memory_stream" }
	S.tags = { "vb", "epochframe", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.epochframe.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
