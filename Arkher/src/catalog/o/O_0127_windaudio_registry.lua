-- ARKHER SYSTEM O.0127 :: Wind Audio Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0127"
	S.key = "arkher.audio.windaudio.asset_registry"
	S.name = "Wind Audio Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Wind Audio"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.windaudio.streaming" }
	S.tags = { "o", "windaudio", "registry", "audio" }
	S.description = "Wind Audio Asset Registry: catalogue of sounds, variations and metadata for the Wind Audio subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.windaudio.asset_registry" })
		inst.system = S
		inst.ctx = ctx
