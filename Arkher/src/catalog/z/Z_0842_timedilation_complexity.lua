-- ARKHER SYSTEM Z.0842 :: Simulation Time Dilation Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0842"
	S.key = "arkher.origin.timedilation.complexity_governance"
	S.name = "Simulation Time Dilation Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.reality_layering" }
	S.tags = { "z", "timedilation", "complexity", "origin" }
	S.description = "Simulation Time Dilation Complexity Governance: measured scene cost turned into per-subsystem directives for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.timedilation.complexity_governance", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
