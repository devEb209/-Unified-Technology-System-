-- ARKHER SYSTEM VD.0550 :: World Fabric Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0550"
	S.key = "arkher.contsim.worldfabric.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldfabric.complexity_budget" }
	S.tags = { "vd", "worldfabric", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.worldfabric.simulation_fabric", budgetMs = 2.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
