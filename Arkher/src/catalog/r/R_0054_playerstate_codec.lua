-- ARKHER SYSTEM R.0054 :: Player State Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0054"
	S.key = "arkher.net.playerstate.serialization_codec"
	S.name = "Player State Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Player State"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.playerstate.bandwidth_budget" }
	S.tags = { "r", "playerstate", "codec", "net" }
	S.description = "Player State Serialization Codec: compact encoding, diffing and checksum of payloads for the Player State subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.playerstate.serialization_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
