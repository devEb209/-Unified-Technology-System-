-- ARKHER SYSTEM W.0049 :: Close Up Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0049"
	S.key = "arkher.cine.closeup.sequence_timeline"
	S.name = "Close Up Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Close Up"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "closeup", "timeline", "cine" }
	S.description = "Close Up Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Close Up subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.closeup.sequence_timeline", duration = 9.0, rate = 0.93 })
		inst.system = S
		inst.ctx = ctx
