-- ARKHER SYSTEM T.0380 :: Refactoring Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0380"
	S.key = "arkher.ai.refactoring.semantic_knowledge"
	S.name = "Refactoring Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.refactoring.intent_understanding" }
	S.tags = { "t", "refactoring", "knowledge", "ai" }
	S.description = "Refactoring Semantic Knowledge: typed entities, weighted relations and inferred closure for the Refactoring subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.refactoring.semantic_knowledge", dims = 40 })
		inst.system = S
		inst.ctx = ctx
