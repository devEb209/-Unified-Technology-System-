-- ARKHER SYSTEM P.0219 :: Currency Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0219"
	S.key = "arkher.play.currency.objectives"
	S.name = "Currency Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Currency"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.currency.inventory" }
	S.tags = { "p", "currency", "quest", "play" }
	S.description = "Currency Objectives: objectives, prerequisites, progress and rewards for the Currency subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.currency.objectives" })
		inst.system = S
		inst.ctx = ctx
