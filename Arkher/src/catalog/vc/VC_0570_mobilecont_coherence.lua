-- ARKHER SYSTEM VC.0570 :: Mobile Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0570"
	S.key = "arkher.contneural.mobilecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.mobilecont.persistent_state" }
	S.tags = { "vc", "mobilecont", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.mobilecont.coherence_guard", window = 134, threshold = 0.10 })
		inst.system = S
		inst.ctx = ctx
