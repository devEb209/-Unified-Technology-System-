-- ARKHER SYSTEM Z.0223 :: Emergent Society Framework Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0223"
	S.key = "arkher.origin.emergentsociety.simulation_fabric"
	S.name = "Emergent Society Framework Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentsociety.complexity_governance" }
	S.tags = { "z", "emergentsociety", "fabric", "origin" }
	S.description = "Emergent Society Framework Simulation Fabric: every simulation domain stepped under one budgeted clock for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.emergentsociety.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
