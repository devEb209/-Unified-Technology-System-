-- ARKHER SYSTEM G.0142 :: Texture Super Resolution Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0142"
	S.key = "arkher.neural.texturesr.feature_extraction"
	S.name = "Texture Super Resolution Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.texturesr.inference_core" }
	S.tags = { "g", "texturesr", "field", "neural" }
	S.description = "Texture Super Resolution Feature Extraction: signal features feeding the model for the Texture Super Resolution subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.texturesr.feature_extraction", seed = 16757, frequency = 0.0132, octaves = 4, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
