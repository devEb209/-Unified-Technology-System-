...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Terragen Sky — CORE Map #0098", size=Vector2.new(680, 480), pos=UDim2.fromOffset(174, 186), parent=parent, icon="☷"})
