-- ARKHER SYSTEM VD.0345 :: Society Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0345"
	S.key = "arkher.contsim.societycont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.societycont.world_memory_stream" }
	S.tags = { "vd", "societycont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.societycont.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
