-- ARKHER SYSTEM Z.0409 :: Battery Aware Pipeline Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0409"
	S.key = "arkher.origin.batteryaware.intent_bridge"
	S.name = "Battery Aware Pipeline Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.batteryaware.semantic_graph" }
	S.tags = { "z", "batteryaware", "intent", "origin" }
	S.description = "Battery Aware Pipeline Intent Bridge: natural language control surface for the technology for the Battery Aware Pipeline subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.batteryaware.intent_bridge", minConfidence = 0.43 })
		inst.system = S
		inst.ctx = ctx
