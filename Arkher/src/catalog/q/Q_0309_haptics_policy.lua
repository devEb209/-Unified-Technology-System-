-- ARKHER SYSTEM Q.0309 :: Haptics Accessibility Policy
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0309"
	S.key = "arkher.ui.haptics.accessibility_policy"
	S.name = "Haptics Accessibility Policy"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Haptics"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.haptics.interaction_ledger" }
	S.tags = { "q", "haptics", "policy", "ui" }
	S.description = "Haptics Accessibility Policy: rules enforcing contrast, target size and motion limits for the Haptics subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ui.haptics.accessibility_policy", algorithm = "wfq", starvationGuard = 30 })
		inst.system = S
		inst.ctx = ctx
