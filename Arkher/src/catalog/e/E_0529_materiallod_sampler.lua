-- ARKHER SYSTEM E.0529 :: Material LOD Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0529"
	S.key = "arkher.material.materiallod.texture_sampling"
	S.name = "Material LOD Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Material LOD"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.materiallod.shading_graph" }
	S.tags = { "e", "materiallod", "sampler", "material" }
	S.description = "Material LOD Texture Sampling: atlas packing, mip chain and filtered sampling for the Material LOD subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.materiallod.texture_sampling", atlasSize = 256, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
