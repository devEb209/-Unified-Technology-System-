-- ARKHER SYSTEM Q.0030 :: Button Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0030"
	S.key = "arkher.ui.button.theme_composition"
	S.name = "Button Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Button"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.button.navigation_graph" }
	S.tags = { "q", "button", "composer", "ui" }
	S.description = "Button Theme Composition: blending of theme signals into the final appearance for the Button subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.button.theme_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
