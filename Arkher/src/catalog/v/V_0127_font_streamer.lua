-- ARKHER SYSTEM V.0127 :: Font Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0127"
	S.key = "arkher.asset.font.streaming_residency"
	S.name = "Font Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.font.content_cache" }
	S.tags = { "v", "font", "streamer", "asset" }
	S.description = "Font Streaming Residency: distance-driven load and unload of asset payloads for the Font subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.font.streaming_residency", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
