-- ARKHER SYSTEM F.0130 :: Global Illumination Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0130"
	S.key = "arkher.render.gi.geometry_virtualization"
	S.name = "Global Illumination Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.gi.visibility_set" }
	S.tags = { "f", "gi", "impostor", "render" }
	S.description = "Global Illumination Geometry Virtualization: impostor and HLOD synthesis under a budget for the Global Illumination subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.gi.geometry_virtualization", atlasSlots = 112, viewCount = 8, errorThreshold = 3.30 })
		inst.system = S
		inst.ctx = ctx
