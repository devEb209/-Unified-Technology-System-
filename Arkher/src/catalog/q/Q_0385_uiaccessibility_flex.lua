-- ARKHER SYSTEM Q.0385 :: Accessibility Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0385"
	S.key = "arkher.ui.uiaccessibility.responsive_layout"
	S.name = "Accessibility Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "uiaccessibility", "flex", "ui" }
	S.description = "Accessibility Responsive Layout: flex solving with safe areas, weights and breakpoints for the Accessibility subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.uiaccessibility.responsive_layout", width = 450, height = 904, scale = 0.91 })
		inst.system = S
		inst.ctx = ctx
