-- ARKHER SYSTEM VD.0181 :: Simulation Domain Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0181"
	S.key = "arkher.contsim.simdomain.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "simdomain", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.simdomain.infinite_grid", cellSize = 96, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
