-- ARKHER SYSTEM L.0289 :: Water Cycle Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0289"
	S.key = "arkher.sim.watercycle.society"
	S.name = "Water Cycle Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.watercycle.economy" }
	S.tags = { "l", "watercycle", "society", "sim" }
	S.description = "Water Cycle Society: relations, factions, reputation and cohesion of the region for the Water Cycle subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.watercycle.society", decayRate = 0.012, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
