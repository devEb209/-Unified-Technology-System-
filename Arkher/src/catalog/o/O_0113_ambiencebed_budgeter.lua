-- ARKHER SYSTEM O.0113 :: Ambience Bed Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0113"
	S.key = "arkher.audio.ambiencebed.voice_budget"
	S.name = "Ambience Bed Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Ambience Bed"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.ambiencebed.music_sequencer" }
	S.tags = { "o", "ambiencebed", "budgeter", "audio" }
	S.description = "Ambience Bed Voice Budget: voice slots allocated by priority and audibility for the Ambience Bed subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.ambiencebed.voice_budget", total = 250, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
