-- ARKHER SYSTEM W.0406 :: Cinematic Debug Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0406"
	S.key = "arkher.cine.cinedebug.frame_budget"
	S.name = "Cinematic Debug Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinedebug.event_ledger" }
	S.tags = { "w", "cinedebug", "budgeter", "cine" }
	S.description = "Cinematic Debug Frame Budget: per-frame cost budget for the cinematic systems for the Cinematic Debug subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.cinedebug.frame_budget", total = 141, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
