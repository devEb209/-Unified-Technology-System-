-- ARKHER SYSTEM Q.0377 :: Localization Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0377"
	S.key = "arkher.ui.localization.navigation_graph"
	S.name = "Localization Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Localization"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.localization.transition" }
	S.tags = { "q", "localization", "graph", "ui" }
	S.description = "Localization Navigation Graph: screens, routes and shortest path between them for the Localization subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.localization.navigation_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
