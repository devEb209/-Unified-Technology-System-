-- ARKHER SYSTEM I.0264 :: Foot Placement IK Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0264"
	S.key = "arkher.anim.footik.inverse_kinematics"
	S.name = "Foot Placement IK Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.footik.layered_blending" }
	S.tags = { "i", "footik", "ik", "anim" }
	S.description = "Foot Placement IK Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Foot Placement IK subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.footik.inverse_kinematics", iterations = 10, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
