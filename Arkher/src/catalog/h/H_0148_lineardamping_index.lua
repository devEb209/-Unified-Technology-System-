-- ARKHER SYSTEM H.0148 :: Linear Damping Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0148"
	S.key = "arkher.physics.lineardamping.broadphase_index"
	S.name = "Linear Damping Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.lineardamping.vehicle" }
	S.tags = { "h", "lineardamping", "index", "physics" }
	S.description = "Linear Damping Broadphase Index: spatial acceleration of candidate pair finding for the Linear Damping subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.lineardamping.broadphase_index", mode = "hash", cellSize = 88 })
		inst.system = S
		inst.ctx = ctx
