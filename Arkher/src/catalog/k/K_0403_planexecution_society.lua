-- ARKHER SYSTEM K.0403 :: Plan Execution Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0403"
	S.key = "arkher.npc.planexecution.social_relations"
	S.name = "Plan Execution Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.planexecution.crowd_steering" }
	S.tags = { "k", "planexecution", "society", "npc" }
	S.description = "Plan Execution Social Relations: affinity, factions, reputation and gossip for the Plan Execution subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.planexecution.social_relations", decayRate = 0.010, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
