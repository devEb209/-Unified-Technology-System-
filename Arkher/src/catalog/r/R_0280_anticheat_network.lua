-- ARKHER SYSTEM R.0280 :: Anti Cheat Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0280"
	S.key = "arkher.net.anticheat.transport_graph"
	S.name = "Anti Cheat Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Anti Cheat"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.anticheat.prediction_and_reconciliation" }
	S.tags = { "r", "anticheat", "network", "net" }
	S.description = "Anti Cheat Transport Graph: topology, capacity and routing between endpoints for the Anti Cheat subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.anticheat.transport_graph" })
		inst.system = S
		inst.ctx = ctx
