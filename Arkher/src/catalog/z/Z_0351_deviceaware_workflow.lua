-- ARKHER SYSTEM Z.0351 :: Device Aware Fidelity Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0351"
	S.key = "arkher.origin.deviceaware.adaptive_workflow"
	S.name = "Device Aware Fidelity Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.self_critique" }
	S.tags = { "z", "deviceaware", "workflow", "origin" }
	S.description = "Device Aware Fidelity Adaptive Workflow: verified, retryable, reversible execution plans for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.deviceaware.adaptive_workflow", maxRetries = 1, budget = 70 })
		inst.system = S
		inst.ctx = ctx
