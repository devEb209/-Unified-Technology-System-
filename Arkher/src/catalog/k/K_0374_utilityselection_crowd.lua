-- ARKHER SYSTEM K.0374 :: Utility Selection Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0374"
	S.key = "arkher.npc.utilityselection.crowd_steering"
	S.name = "Utility Selection Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.utilityselection.navigation" }
	S.tags = { "k", "utilityselection", "crowd", "npc" }
	S.description = "Utility Selection Crowd Steering: local avoidance, cohesion and arrival at scale for the Utility Selection subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.utilityselection.crowd_steering", radius = 0.45, maxSpeed = 5.10, cellSize = 9 })
		inst.system = S
		inst.ctx = ctx
