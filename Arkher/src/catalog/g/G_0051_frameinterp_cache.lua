-- ARKHER SYSTEM G.0051 :: Frame Interpolation Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0051"
	S.key = "arkher.neural.frameinterp.result_cache"
	S.name = "Frame Interpolation Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.frameinterp.compute_budget" }
	S.tags = { "g", "frameinterp", "cache", "neural" }
	S.description = "Frame Interpolation Result Cache: cached inference results keyed by input for the Frame Interpolation subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.frameinterp.result_cache", policy = "lfu", capacity = 441, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
