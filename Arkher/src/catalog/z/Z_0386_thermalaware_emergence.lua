-- ARKHER SYSTEM Z.0386 :: Thermal Aware Simulation Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0386"
	S.key = "arkher.origin.thermalaware.emergence_detection"
	S.name = "Thermal Aware Simulation Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.world_memory" }
	S.tags = { "z", "thermalaware", "emergence", "origin" }
	S.description = "Thermal Aware Simulation Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.thermalaware.emergence_detection", windowSize = 5, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
