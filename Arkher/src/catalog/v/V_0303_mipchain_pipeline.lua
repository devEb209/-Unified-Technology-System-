-- ARKHER SYSTEM V.0303 :: Mip Chain Cook Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "V.0303"
	S.key = "arkher.asset.mipchain.cook_pipeline"
	S.name = "Mip Chain Cook Pipeline"
	S.category = "V"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.mipchain.bundling" }
	S.tags = { "v", "mipchain", "pipeline", "asset" }
	S.description = "Mip Chain Cook Pipeline: staged cooking with isolation and retries for the Mip Chain subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.asset.mipchain.cook_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
