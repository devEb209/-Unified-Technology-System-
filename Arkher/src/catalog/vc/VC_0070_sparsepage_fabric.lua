-- ARKHER SYSTEM VC.0070 :: Sparse Page Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0070"
	S.key = "arkher.contneural.sparsepage.simulation_fabric"
	S.name = "Sparse Page Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.sparsepage.complexity_budget" }
	S.tags = { "vc", "sparsepage", "fabric", "contneural" }
	S.description = "Sparse Page Simulation Fabric: fabric stepping the continuum domains for the Sparse Page subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.sparsepage.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
