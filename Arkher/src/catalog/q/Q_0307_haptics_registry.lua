-- ARKHER SYSTEM Q.0307 :: Haptics Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0307"
	S.key = "arkher.ui.haptics.localization_registry"
	S.name = "Haptics Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Haptics"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.haptics.theme_composition" }
	S.tags = { "q", "haptics", "registry", "ui" }
	S.description = "Haptics Localization Registry: catalogue of strings, plurals and locale metadata for the Haptics subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.haptics.localization_registry" })
		inst.system = S
		inst.ctx = ctx
