-- ARKHER SYSTEM G.0134 :: Detail Synthesis Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0134"
	S.key = "arkher.neural.detailsynth.compute_budget"
	S.name = "Detail Synthesis Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detailsynth.quality_predictor" }
	S.tags = { "g", "detailsynth", "budgeter", "neural" }
	S.description = "Detail Synthesis Compute Budget: inference time budget allocation for the Detail Synthesis subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.detailsynth.compute_budget", total = 273, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
