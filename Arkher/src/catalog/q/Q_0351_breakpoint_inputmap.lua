-- ARKHER SYSTEM Q.0351 :: Responsive Breakpoint Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0351"
	S.key = "arkher.ui.breakpoint.input_mapping"
	S.name = "Responsive Breakpoint Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.breakpoint.widget_tree" }
	S.tags = { "q", "breakpoint", "inputmap", "ui" }
	S.description = "Responsive Breakpoint Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Responsive Breakpoint subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.breakpoint.input_mapping", device = "keyboard", holdTime = 0.32, deadzone = 0.12 })
		inst.system = S
		inst.ctx = ctx
