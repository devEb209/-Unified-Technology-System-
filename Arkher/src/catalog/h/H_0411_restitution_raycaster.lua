-- ARKHER SYSTEM H.0411 :: Restitution Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0411"
	S.key = "arkher.physics.restitution.query"
	S.name = "Restitution Query"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Restitution"
	S.aspect = "Query"
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.restitution.constraint_solver" }
	S.tags = { "h", "restitution", "raycaster", "physics" }
	S.description = "Restitution Query: rays, sweeps and overlaps against the simulation for the Restitution subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.restitution.query", cellSize = 8 })
		inst.system = S
		inst.ctx = ctx
