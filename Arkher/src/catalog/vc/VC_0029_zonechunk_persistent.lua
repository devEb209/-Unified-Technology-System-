-- ARKHER SYSTEM VC.0029 :: Zone Chunk Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0029"
	S.key = "arkher.contneural.zonechunk.persistent_state"
	S.name = "Zone Chunk Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.zonechunk.multi-scale_fidelity" }
	S.tags = { "vc", "zonechunk", "persistent", "contneural" }
	S.description = "Zone Chunk Persistent State: epoch-stamped persistent history and rollback for the Zone Chunk subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.zonechunk.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
