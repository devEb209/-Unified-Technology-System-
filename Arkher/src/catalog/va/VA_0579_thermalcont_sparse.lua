-- ARKHER SYSTEM VA.0579 :: Thermal Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0579"
	S.key = "arkher.contworld.thermalcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.thermalcont.epoch_clock" }
	S.tags = { "va", "thermalcont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.thermalcont.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
