-- ARKHER SYSTEM K.0318 :: Threat Assessment Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0318"
	S.key = "arkher.npc.threatassessment.crowd_steering"
	S.name = "Threat Assessment Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.threatassessment.navigation" }
	S.tags = { "k", "threatassessment", "crowd", "npc" }
	S.description = "Threat Assessment Crowd Steering: local avoidance, cohesion and arrival at scale for the Threat Assessment subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.threatassessment.crowd_steering", radius = 0.55, maxSpeed = 3.30, cellSize = 9 })
		inst.system = S
		inst.ctx = ctx
