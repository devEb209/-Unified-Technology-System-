-- ARKHER SYSTEM VB.0093 :: Residency Window Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0093"
	S.key = "arkher.conttime.residencywindow.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.residencywindow.world_memory_stream" }
	S.tags = { "vb", "residencywindow", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.residencywindow.complexity_budget", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
