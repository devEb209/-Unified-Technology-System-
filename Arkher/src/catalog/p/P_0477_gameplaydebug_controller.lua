-- ARKHER SYSTEM P.0477 :: Gameplay Debug Difficulty Controller
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0477"
	S.key = "arkher.play.gameplaydebug.difficulty_controller"
	S.name = "Gameplay Debug Difficulty Controller"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "controller"
	S.version = "1.0.0"
	S.deps = { "arkher.play.gameplaydebug.balance_analysis" }
	S.tags = { "p", "gameplaydebug", "controller", "play" }
	S.description = "Gameplay Debug Difficulty Controller: closed-loop tuning toward a target challenge for the Gameplay Debug subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("controller", { id = "arkher.play.gameplaydebug.difficulty_controller", mode = "pid", target = 0.640, kp = 0.390, ki = 0.040, kd = 0.050, min = 0.05, max = 1.0, initial = 0.54, deadband = 0.01 })
		inst.system = S
		inst.ctx = ctx
