-- ARKHER SYSTEM E.0369 :: Vertex Painting Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0369"
	S.key = "arkher.material.vertexpaint.compression_codec"
	S.name = "Vertex Painting Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.vertexpaint.streaming" }
	S.tags = { "e", "vertexpaint", "codec", "material" }
	S.description = "Vertex Painting Compression Codec: serialization and compression of material data for the Vertex Painting subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.vertexpaint.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
