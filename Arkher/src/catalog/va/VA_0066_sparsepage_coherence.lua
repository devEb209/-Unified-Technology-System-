-- ARKHER SYSTEM VA.0066 :: Sparse Page Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0066"
	S.key = "arkher.contworld.sparsepage.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.sparsepage.persistent_state" }
	S.tags = { "va", "sparsepage", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.sparsepage.coherence_guard", window = 53, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
