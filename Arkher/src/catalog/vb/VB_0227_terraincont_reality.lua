-- ARKHER SYSTEM VB.0227 :: Terrain Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0227"
	S.key = "arkher.conttime.terraincont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.terraincont.simulation_fabric" }
	S.tags = { "vb", "terraincont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.terraincont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
