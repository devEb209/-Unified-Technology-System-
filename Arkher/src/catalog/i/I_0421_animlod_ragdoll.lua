-- ARKHER SYSTEM I.0421 :: Animation LOD Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0421"
	S.key = "arkher.anim.animlod.physical_blend"
	S.name = "Animation LOD Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlod.inverse_kinematics" }
	S.tags = { "i", "animlod", "ragdoll", "anim" }
	S.description = "Animation LOD Physical Blend: physical bones blended against the animated pose for the Animation LOD subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.animlod.physical_blend", blendSpeed = 2.90 })
		inst.system = S
		inst.ctx = ctx
