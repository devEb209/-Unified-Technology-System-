-- ARKHER SYSTEM VC.0478 :: VFX Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0478"
	S.key = "arkher.contneural.vfxcont.simulation_fabric"
	S.name = "VFX Continuum Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vfxcont.complexity_budget" }
	S.tags = { "vc", "vfxcont", "fabric", "contneural" }
	S.description = "VFX Continuum Simulation Fabric: fabric stepping the continuum domains for the VFX Continuum subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.vfxcont.simulation_fabric", budgetMs = 4.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
