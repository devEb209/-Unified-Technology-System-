-- ARKHER SYSTEM VB.0086 :: Residency Window Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0086"
	S.key = "arkher.conttime.residencywindow.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.residencywindow.infinite_grid" }
	S.tags = { "vb", "residencywindow", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.residencywindow.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
