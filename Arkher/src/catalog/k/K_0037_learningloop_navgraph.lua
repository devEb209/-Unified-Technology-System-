-- ARKHER SYSTEM K.0037 :: Learning Loop Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0037"
	S.key = "arkher.npc.learningloop.navigation"
	S.name = "Learning Loop Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.learningloop.goal_planner" }
	S.tags = { "k", "learningloop", "navgraph", "npc" }
	S.description = "Learning Loop Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Learning Loop subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.learningloop.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
