-- ARKHER SYSTEM Z.0849 :: Simulation Time Dilation Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0849"
	S.key = "arkher.origin.timedilation.intent_bridge"
	S.name = "Simulation Time Dilation Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.semantic_graph" }
	S.tags = { "z", "timedilation", "intent", "origin" }
	S.description = "Simulation Time Dilation Intent Bridge: natural language control surface for the technology for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.timedilation.intent_bridge", minConfidence = 0.43 })
		inst.system = S
		inst.ctx = ctx
