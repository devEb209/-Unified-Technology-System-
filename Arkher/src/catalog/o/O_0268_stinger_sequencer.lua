-- ARKHER SYSTEM O.0268 :: Stinger Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0268"
	S.key = "arkher.audio.stinger.music_sequencer"
	S.name = "Stinger Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Stinger"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.stinger.spatialization" }
	S.tags = { "o", "stinger", "sequencer", "audio" }
	S.description = "Stinger Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Stinger subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.stinger.music_sequencer", bpm = 100, beatsPerBar = 4, intensity = 0.55 })
		inst.system = S
		inst.ctx = ctx
