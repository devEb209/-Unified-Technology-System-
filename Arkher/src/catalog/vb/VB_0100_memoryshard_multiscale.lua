-- ARKHER SYSTEM VB.0100 :: Memory Shard Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0100"
	S.key = "arkher.conttime.memoryshard.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memoryshard.sparse_residency" }
	S.tags = { "vb", "memoryshard", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.memoryshard.multi-scale_fidelity", levels = 4, baseTriangles = 75000 })
		inst.system = S
		inst.ctx = ctx
