-- ARKHER SYSTEM VA.0469 :: VFX Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0469"
	S.key = "arkher.contworld.vfxcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "vfxcont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.vfxcont.infinite_grid", cellSize = 224, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
