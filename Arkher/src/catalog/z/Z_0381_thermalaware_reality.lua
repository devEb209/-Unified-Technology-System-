-- ARKHER SYSTEM Z.0381 :: Thermal Aware Simulation Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0381"
	S.key = "arkher.origin.thermalaware.reality_layering"
	S.name = "Thermal Aware Simulation Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "thermalaware", "reality", "origin" }
	S.description = "Thermal Aware Simulation Reality Layering: stacked authored, simulated, proposed and player realities for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.thermalaware.reality_layering" })
		inst.system = S
		inst.ctx = ctx
