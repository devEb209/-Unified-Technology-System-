-- ARKHER SYSTEM E.0565 :: Material Preview Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0565"
	S.key = "arkher.material.preview.quality_policy"
	S.name = "Material Preview Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.preview.compression_codec" }
	S.tags = { "e", "preview", "policy", "material" }
	S.description = "Material Preview Quality Policy: device tier rules for the surface for the Material Preview subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.preview.quality_policy", algorithm = "edf", starvationGuard = 53 })
		inst.system = S
		inst.ctx = ctx
