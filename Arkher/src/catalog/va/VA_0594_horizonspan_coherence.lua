-- ARKHER SYSTEM VA.0594 :: Horizon Span Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0594"
	S.key = "arkher.contworld.horizonspan.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.horizonspan.persistent_state" }
	S.tags = { "va", "horizonspan", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.horizonspan.coherence_guard", window = 72, threshold = 0.14 })
		inst.system = S
		inst.ctx = ctx
