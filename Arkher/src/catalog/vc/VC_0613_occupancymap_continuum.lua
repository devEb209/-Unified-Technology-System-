-- ARKHER SYSTEM VC.0613 :: Occupancy Map Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0613"
	S.key = "arkher.contneural.occupancymap.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "occupancymap", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.occupancymap.infinite_grid", cellSize = 64, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
