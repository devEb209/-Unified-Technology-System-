-- ARKHER SYSTEM N.0457 :: Camera Shake Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0457"
	S.key = "arkher.vfx.camerashake.particle_simulation"
	S.name = "Camera Shake Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Camera Shake"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.camerashake.emission" }
	S.tags = { "n", "camerashake", "particles", "vfx" }
	S.description = "Camera Shake Particle Simulation: pooled integration of position, velocity, colour and life for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.camerashake.particle_simulation", capacity = 128, drag = 0.05, bounce = 0.00, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
