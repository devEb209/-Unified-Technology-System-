-- ARKHER SYSTEM K.0035 :: Learning Loop Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0035"
	S.key = "arkher.npc.learningloop.utility_reasoning"
	S.name = "Learning Loop Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.learningloop.reactive_behaviour" }
	S.tags = { "k", "learningloop", "utility", "npc" }
	S.description = "Learning Loop Utility Reasoning: scored option selection with response curves for the Learning Loop subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.learningloop.utility_reasoning", momentum = 0.09 })
		inst.system = S
		inst.ctx = ctx
