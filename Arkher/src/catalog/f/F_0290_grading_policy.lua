-- ARKHER SYSTEM F.0290 :: Color Grading Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0290"
	S.key = "arkher.render.grading.render_policy"
	S.name = "Color Grading Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.grading.draw_budget" }
	S.tags = { "f", "grading", "policy", "render" }
	S.description = "Color Grading Render Policy: device tier rules for the frame for the Color Grading subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.grading.render_policy", algorithm = "roundrobin", starvationGuard = 40 })
		inst.system = S
		inst.ctx = ctx
