-- ARKHER SYSTEM E.0042 :: Albedo Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0042"
	S.key = "arkher.material.albedo.analysis"
	S.name = "Albedo Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Albedo"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.albedo.instance_cache" }
	S.tags = { "e", "albedo", "analyzer", "material" }
	S.description = "Albedo Analysis: cost, redundancy and outlier analysis for the Albedo subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.albedo.analysis", window = 106, buckets = 14, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
