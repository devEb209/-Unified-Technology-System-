-- ARKHER SYSTEM L.0124 :: Village Life Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0124"
	S.key = "arkher.sim.villagelife.society"
	S.name = "Village Life Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.villagelife.economy" }
	S.tags = { "l", "villagelife", "society", "sim" }
	S.description = "Village Life Society: relations, factions, reputation and cohesion of the region for the Village Life subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.villagelife.society", decayRate = 0.011, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
