-- ARKHER SYSTEM VB.0343 :: Society Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0343"
	S.key = "arkher.conttime.societycont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.societycont.coherence_guard" }
	S.tags = { "vb", "societycont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.societycont.neural_field", dims = 12, hidden = 8, seed = 99604 })
		inst.system = S
		inst.ctx = ctx
