-- ARKHER SYSTEM H.0219 :: Fixed Timestep Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0219"
	S.key = "arkher.physics.fixedstep.budget_governor"
	S.name = "Fixed Timestep Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.fixedstep.broadphase_index" }
	S.tags = { "h", "fixedstep", "budgeter", "physics" }
	S.description = "Fixed Timestep Budget Governor: simulation time budget allocation across islands for the Fixed Timestep subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.fixedstep.budget_governor", total = 142, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
