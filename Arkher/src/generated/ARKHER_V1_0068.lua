...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="CryEngine Qt — CORE Map #0068", size=Vector2.new(680, 480), pos=UDim2.fromOffset(184, 196), parent=parent, icon="⬣"})
