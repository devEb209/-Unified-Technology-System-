-- ARKHER SYSTEM Z.0829 :: Reality Blending Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0829"
	S.key = "arkher.origin.realityblending.intent_bridge"
	S.name = "Reality Blending Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.semantic_graph" }
	S.tags = { "z", "realityblending", "intent", "origin" }
	S.description = "Reality Blending Intent Bridge: natural language control surface for the technology for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.realityblending.intent_bridge", minConfidence = 0.39 })
		inst.system = S
		inst.ctx = ctx
