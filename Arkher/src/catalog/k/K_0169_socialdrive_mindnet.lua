-- ARKHER SYSTEM K.0169 :: Social Drive Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0169"
	S.key = "arkher.npc.socialdrive.mind_network"
	S.name = "Social Drive Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "socialdrive", "mindnet", "npc" }
	S.description = "Social Drive Mind Network: the learned policy that turns perception into a decision for the Social Drive subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.socialdrive.mind_network", inputs = 9, hidden = 4, seed = 78335, learningRate = 0.075, exploration = 0.055 })
		inst.system = S
		inst.ctx = ctx
