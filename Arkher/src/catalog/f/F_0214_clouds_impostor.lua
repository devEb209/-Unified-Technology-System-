-- ARKHER SYSTEM F.0214 :: Cloud Rendering Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0214"
	S.key = "arkher.render.clouds.geometry_virtualization"
	S.name = "Cloud Rendering Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.clouds.visibility_set" }
	S.tags = { "f", "clouds", "impostor", "render" }
	S.description = "Cloud Rendering Geometry Virtualization: impostor and HLOD synthesis under a budget for the Cloud Rendering subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.clouds.geometry_virtualization", atlasSlots = 96, viewCount = 8, errorThreshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
