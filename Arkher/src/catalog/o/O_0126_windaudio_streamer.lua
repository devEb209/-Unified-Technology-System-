-- ARKHER SYSTEM O.0126 :: Wind Audio Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0126"
	S.key = "arkher.audio.windaudio.streaming"
	S.name = "Wind Audio Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Wind Audio"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.windaudio.voice_budget" }
	S.tags = { "o", "windaudio", "streamer", "audio" }
	S.description = "Wind Audio Streaming: distance-driven residency of audio assets for the Wind Audio subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.windaudio.streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
