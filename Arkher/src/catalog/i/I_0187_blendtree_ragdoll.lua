-- ARKHER SYSTEM I.0187 :: Blend Tree Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0187"
	S.key = "arkher.anim.blendtree.physical_blend"
	S.name = "Blend Tree Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Blend Tree"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.blendtree.inverse_kinematics" }
	S.tags = { "i", "blendtree", "ragdoll", "anim" }
	S.description = "Blend Tree Physical Blend: physical bones blended against the animated pose for the Blend Tree subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.blendtree.physical_blend", blendSpeed = 5.70 })
		inst.system = S
		inst.ctx = ctx
