-- ARKHER SYSTEM V.0381 :: Cook Target Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0381"
	S.key = "arkher.asset.cooktarget.size_budget"
	S.name = "Cook Target Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.cooktarget.compression_codec" }
	S.tags = { "v", "cooktarget", "budgeter", "asset" }
	S.description = "Cook Target Size Budget: byte budget shared between competing asset classes for the Cook Target subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.cooktarget.size_budget", total = 428, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
