-- ARKHER SYSTEM VC.0327 :: Economy Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0327"
	S.key = "arkher.contneural.economycont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.economycont.epoch_clock" }
	S.tags = { "vc", "economycont", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.economycont.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
