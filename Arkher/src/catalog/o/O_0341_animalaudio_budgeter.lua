-- ARKHER SYSTEM O.0341 :: Animal Audio Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0341"
	S.key = "arkher.audio.animalaudio.voice_budget"
	S.name = "Animal Audio Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Animal Audio"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.animalaudio.music_sequencer" }
	S.tags = { "o", "animalaudio", "budgeter", "audio" }
	S.description = "Animal Audio Voice Budget: voice slots allocated by priority and audibility for the Animal Audio subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.animalaudio.voice_budget", total = 323, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
