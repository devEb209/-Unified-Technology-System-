-- ARKHER SYSTEM L.0074 :: Population Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0074"
	S.key = "arkher.sim.population.forecast"
	S.name = "Population Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.population.analysis" }
	S.tags = { "l", "population", "predictor", "sim" }
	S.description = "Population Forecast: prediction of the region's next state for the Population subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.population.forecast", method = "ema", alpha = 0.35, window = 65 })
		inst.system = S
		inst.ctx = ctx
