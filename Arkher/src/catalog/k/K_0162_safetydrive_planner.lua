-- ARKHER SYSTEM K.0162 :: Safety Drive Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0162"
	S.key = "arkher.npc.safetydrive.goal_planner"
	S.name = "Safety Drive Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.safetydrive.utility_reasoning" }
	S.tags = { "k", "safetydrive", "planner", "npc" }
	S.description = "Safety Drive Goal Planner: backward GOAP planning to reach a goal state for the Safety Drive subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.safetydrive.goal_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
