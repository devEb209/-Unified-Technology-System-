-- ARKHER SYSTEM I.0063 :: Animation Clip Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0063"
	S.key = "arkher.anim.animclip.quality_policy"
	S.name = "Animation Clip Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animclip.pose_cache" }
	S.tags = { "i", "animclip", "policy", "anim" }
	S.description = "Animation Clip Quality Policy: device tier rules for rate, bones and solvers for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.animclip.quality_policy", algorithm = "edf", starvationGuard = 37 })
		inst.system = S
		inst.ctx = ctx
