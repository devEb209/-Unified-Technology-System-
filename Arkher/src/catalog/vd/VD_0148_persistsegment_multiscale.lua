-- ARKHER SYSTEM VD.0148 :: Persistence Segment Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0148"
	S.key = "arkher.contsim.persistsegment.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.persistsegment.sparse_residency" }
	S.tags = { "vd", "persistsegment", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.persistsegment.multi-scale_fidelity", levels = 5, baseTriangles = 165000 })
		inst.system = S
		inst.ctx = ctx
