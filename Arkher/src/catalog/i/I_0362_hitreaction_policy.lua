-- ARKHER SYSTEM I.0362 :: Hit Reaction Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0362"
	S.key = "arkher.anim.hitreaction.quality_policy"
	S.name = "Hit Reaction Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Hit Reaction"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.hitreaction.pose_cache" }
	S.tags = { "i", "hitreaction", "policy", "anim" }
	S.description = "Hit Reaction Quality Policy: device tier rules for rate, bones and solvers for the Hit Reaction subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.hitreaction.quality_policy", algorithm = "edf", starvationGuard = 41 })
		inst.system = S
		inst.ctx = ctx
