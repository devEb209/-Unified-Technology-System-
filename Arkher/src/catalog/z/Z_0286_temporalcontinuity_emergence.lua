-- ARKHER SYSTEM Z.0286 :: Temporal Continuity Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0286"
	S.key = "arkher.origin.temporalcontinuity.emergence_detection"
	S.name = "Temporal Continuity Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.temporalcontinuity.world_memory" }
	S.tags = { "z", "temporalcontinuity", "emergence", "origin" }
	S.description = "Temporal Continuity Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Temporal Continuity subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.temporalcontinuity.emergence_detection", windowSize = 5, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
