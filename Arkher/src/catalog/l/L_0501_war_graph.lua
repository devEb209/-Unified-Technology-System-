-- ARKHER SYSTEM L.0501 :: War Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0501"
	S.key = "arkher.sim.war.region_graph"
	S.name = "War Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.war.calendar" }
	S.tags = { "l", "war", "graph", "sim" }
	S.description = "War Region Graph: connectivity, components and shortest path between places for the War subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.war.region_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
