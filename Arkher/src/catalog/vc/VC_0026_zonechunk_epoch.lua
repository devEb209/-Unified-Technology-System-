-- ARKHER SYSTEM VC.0026 :: Zone Chunk Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0026"
	S.key = "arkher.contneural.zonechunk.epoch_clock"
	S.name = "Zone Chunk Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.zonechunk.infinite_grid" }
	S.tags = { "vc", "zonechunk", "epoch", "contneural" }
	S.description = "Zone Chunk Epoch Clock: deterministic epoch timeline with catch-up for the Zone Chunk subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.zonechunk.epoch_clock", tickRate = 30, budget = 6, capacity = 128 })
		inst.system = S
		inst.ctx = ctx
