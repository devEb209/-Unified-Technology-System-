-- ARKHER SYSTEM VA.0017 :: Region Tile Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0017"
	S.key = "arkher.contworld.regiontile.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.regiontile.multi-scale_fidelity" }
	S.tags = { "va", "regiontile", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.regiontile.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
