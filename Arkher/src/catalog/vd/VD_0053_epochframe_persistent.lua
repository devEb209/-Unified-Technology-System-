-- ARKHER SYSTEM VD.0053 :: Epoch Frame Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VD.0053"
	S.key = "arkher.contsim.epochframe.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.epochframe.multi-scale_fidelity" }
	S.tags = { "vd", "epochframe", "persistent", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contsim.epochframe.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
