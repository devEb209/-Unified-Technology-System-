-- ARKHER SYSTEM K.0032 :: Learning Loop Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0032"
	S.key = "arkher.npc.learningloop.emotion"
	S.name = "Learning Loop Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.learningloop.drive_system" }
	S.tags = { "k", "learningloop", "emotion", "npc" }
	S.description = "Learning Loop Emotion: appraisal of events into valence, arousal and mood for the Learning Loop subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.learningloop.emotion", inertia = 0.90, decayRate = 0.25, baselineArousal = 0.25 })
		inst.system = S
		inst.ctx = ctx
