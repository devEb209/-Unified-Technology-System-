-- ARKHER SYSTEM K.0036 :: Learning Loop Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0036"
	S.key = "arkher.npc.learningloop.goal_planner"
	S.name = "Learning Loop Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.learningloop.utility_reasoning" }
	S.tags = { "k", "learningloop", "planner", "npc" }
	S.description = "Learning Loop Goal Planner: backward GOAP planning to reach a goal state for the Learning Loop subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.learningloop.goal_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
