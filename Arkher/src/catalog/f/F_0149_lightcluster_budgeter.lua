-- ARKHER SYSTEM F.0149 :: Light Clustering Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0149"
	S.key = "arkher.render.lightcluster.draw_budget"
	S.name = "Light Clustering Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.lightcluster.adaptive_resolution" }
	S.tags = { "f", "lightcluster", "budgeter", "render" }
	S.description = "Light Clustering Draw Budget: draw call and triangle budget allocation for the Light Clustering subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.lightcluster.draw_budget", total = 449, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
