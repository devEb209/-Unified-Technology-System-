-- ARKHER SYSTEM VB.0528 :: Asset Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0528"
	S.key = "arkher.conttime.assetcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.assetcont.reality_continuum" }
	S.tags = { "vb", "assetcont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.assetcont.emergence_continuum", windowSize = 4, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
