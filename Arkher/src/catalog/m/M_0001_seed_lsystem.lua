-- ARKHER SYSTEM M.0001 :: Seed Grammar
...
return function(A)
	...
	local S = {}
	S.id = "M.0001"
	S.key = "arkher.proc.seed.grammar"
	S.name = "Seed Grammar"
	S.category = "M"
	S.family = "PROCEDURAL"
	S.area = "Seed"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "m", "seed", "lsystem", "proc" }
	S.description = "Seed Grammar: rewriting grammar interpreted into geometry for the Seed subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lsystem", { id = "arkher.proc.seed.grammar", axiom = "F", angle = 21, step = 6.0 })
		inst.system = S
		inst.ctx = ctx
