-- ARKHER SYSTEM L.0482 :: Diplomacy Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0482"
	S.key = "arkher.sim.diplomacy.ecology"
	S.name = "Diplomacy Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.diplomacy.simulation_core" }
	S.tags = { "l", "diplomacy", "ecology", "sim" }
	S.description = "Diplomacy Ecology: populations, predation, harvesting and carrying capacity for the Diplomacy subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.diplomacy.ecology" })
		inst.system = S
		inst.ctx = ctx
