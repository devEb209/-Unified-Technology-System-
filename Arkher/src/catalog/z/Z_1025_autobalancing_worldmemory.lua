-- ARKHER SYSTEM Z.1025 :: Autonomous Balancing World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.1025"
	S.key = "arkher.origin.autobalancing.world_memory"
	S.name = "Autonomous Balancing World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autobalancing.autonomous_pipeline" }
	S.tags = { "z", "autobalancing", "worldmemory", "origin" }
	S.description = "Autonomous Balancing World Memory: epoch-stamped persistent history with compaction and checkpoints for the Autonomous Balancing subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.autobalancing.world_memory", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
