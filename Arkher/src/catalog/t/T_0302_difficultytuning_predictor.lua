-- ARKHER SYSTEM T.0302 :: Difficulty Tuning Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0302"
	S.key = "arkher.ai.difficultytuning.outcome_prediction"
	S.name = "Difficulty Tuning Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.difficultytuning.decision_policy" }
	S.tags = { "t", "difficultytuning", "predictor", "ai" }
	S.description = "Difficulty Tuning Outcome Prediction: forecasting the result before the work is done for the Difficulty Tuning subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.difficultytuning.outcome_prediction", method = "ema", alpha = 0.33, window = 71 })
		inst.system = S
		inst.ctx = ctx
