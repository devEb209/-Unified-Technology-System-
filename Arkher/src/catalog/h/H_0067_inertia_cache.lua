-- ARKHER SYSTEM H.0067 :: Inertia Tensor Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0067"
	S.key = "arkher.physics.inertia.result_cache"
	S.name = "Inertia Tensor Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.inertia.simulation_policy" }
	S.tags = { "h", "inertia", "cache", "physics" }
	S.description = "Inertia Tensor Result Cache: reuse of expensive simulation and query results for the Inertia Tensor subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.inertia.result_cache", policy = "ttl", capacity = 290, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
