-- ARKHER SYSTEM VC.0250 :: Vegetation Field Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0250"
	S.key = "arkher.contneural.vegfield.simulation_fabric"
	S.name = "Vegetation Field Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vegfield.complexity_budget" }
	S.tags = { "vc", "vegfield", "fabric", "contneural" }
	S.description = "Vegetation Field Simulation Fabric: fabric stepping the continuum domains for the Vegetation Field subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.vegfield.simulation_fabric", budgetMs = 2.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
