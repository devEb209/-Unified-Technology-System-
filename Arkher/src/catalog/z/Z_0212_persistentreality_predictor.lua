-- ARKHER SYSTEM Z.0212 :: Persistent Reality State Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0212"
	S.key = "arkher.origin.persistentreality.predictive_optimization"
	S.name = "Persistent Reality State Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.adaptive_workflow" }
	S.tags = { "z", "persistentreality", "predictor", "origin" }
	S.description = "Persistent Reality State Predictive Optimization: forecast-driven optimization before the cost is paid for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.persistentreality.predictive_optimization", method = "markov", alpha = 0.25, window = 55 })
		inst.system = S
		inst.ctx = ctx
