-- ARKHER SYSTEM F.0082 :: Cascade Shadows Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0082"
	S.key = "arkher.render.cascades.frame_analysis"
	S.name = "Cascade Shadows Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.cascades.pass_cache" }
	S.tags = { "f", "cascades", "analyzer", "render" }
	S.description = "Cascade Shadows Frame Analysis: per-pass cost analysis and outlier detection for the Cascade Shadows subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.cascades.frame_analysis", window = 240, buckets = 12, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
