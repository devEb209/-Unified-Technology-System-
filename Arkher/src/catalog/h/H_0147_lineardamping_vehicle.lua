-- ARKHER SYSTEM H.0147 :: Linear Damping Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0147"
	S.key = "arkher.physics.lineardamping.vehicle"
	S.name = "Linear Damping Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.lineardamping.character_motion" }
	S.tags = { "h", "lineardamping", "vehicle", "physics" }
	S.description = "Linear Damping Vehicle: suspension, drivetrain, steering and tire friction for the Linear Damping subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.lineardamping.vehicle", mass = 1900, wheelbase = 2.60, track = 1.80, maxRpm = 6000 })
		inst.system = S
		inst.ctx = ctx
