-- ARKHER SYSTEM E.0175 :: Clear Coat Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0175"
	S.key = "arkher.material.clearcoat.quality_policy"
	S.name = "Clear Coat Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Clear Coat"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.clearcoat.compression_codec" }
	S.tags = { "e", "clearcoat", "policy", "material" }
	S.description = "Clear Coat Quality Policy: device tier rules for the surface for the Clear Coat subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.clearcoat.quality_policy", algorithm = "wfq", starvationGuard = 50 })
		inst.system = S
		inst.ctx = ctx
