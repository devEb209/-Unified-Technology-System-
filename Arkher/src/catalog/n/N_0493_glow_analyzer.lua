-- ARKHER SYSTEM N.0493 :: Glow Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0493"
	S.key = "arkher.vfx.glow.analysis"
	S.name = "Glow Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Glow"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.glow.spatial_index" }
	S.tags = { "n", "glow", "analyzer", "vfx" }
	S.description = "Glow Analysis: cost, overdraw and stability analysis of the effect for the Glow subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.glow.analysis", window = 230, buckets = 14, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
