-- ARKHER SYSTEM T.0301 :: Difficulty Tuning Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0301"
	S.key = "arkher.ai.difficultytuning.decision_policy"
	S.name = "Difficulty Tuning Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.difficultytuning.reasoning_graph" }
	S.tags = { "t", "difficultytuning", "policy", "ai" }
	S.description = "Difficulty Tuning Decision Policy: ordered rules deciding what the agent does next for the Difficulty Tuning subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.difficultytuning.decision_policy", algorithm = "lottery", starvationGuard = 31 })
		inst.system = S
		inst.ctx = ctx
