-- ARKHER SYSTEM VC.0230 :: City Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0230"
	S.key = "arkher.contneural.citycont.epoch_clock"
	S.name = "City Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.citycont.infinite_grid" }
	S.tags = { "vc", "citycont", "epoch", "contneural" }
	S.description = "City Continuum Epoch Clock: deterministic epoch timeline with catch-up for the City Continuum subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.citycont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
