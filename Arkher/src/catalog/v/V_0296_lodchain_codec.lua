-- ARKHER SYSTEM V.0296 :: LOD Chain Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0296"
	S.key = "arkher.asset.lodchain.compression_codec"
	S.name = "LOD Chain Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.lodchain.streaming_residency" }
	S.tags = { "v", "lodchain", "codec", "asset" }
	S.description = "LOD Chain Compression Codec: compact encoding, diffing and checksum of asset payloads for the LOD Chain subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.lodchain.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
