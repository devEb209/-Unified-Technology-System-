-- ARKHER SYSTEM F.0391 :: Sharpening Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0391"
	S.key = "arkher.render.sharpening.orchestration"
	S.name = "Sharpening Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sharpening"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sharpening.frame_analysis" }
	S.tags = { "f", "sharpening", "orchestrator", "render" }
	S.description = "Sharpening Orchestration: frame lifecycle orchestration for the Sharpening subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.sharpening.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
