-- ARKHER SYSTEM N.0262 :: Shield Effect Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0262"
	S.key = "arkher.vfx.shieldfx.particle_simulation"
	S.name = "Shield Effect Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.shieldfx.emission" }
	S.tags = { "n", "shieldfx", "particles", "vfx" }
	S.description = "Shield Effect Particle Simulation: pooled integration of position, velocity, colour and life for the Shield Effect subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.shieldfx.particle_simulation", capacity = 448, drag = 0.06, bounce = 0.21, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
