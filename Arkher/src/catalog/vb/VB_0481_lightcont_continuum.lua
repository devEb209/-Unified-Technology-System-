-- ARKHER SYSTEM VB.0481 :: Lighting Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0481"
	S.key = "arkher.conttime.lightcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "lightcont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.lightcont.infinite_grid", cellSize = 64, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
