-- ARKHER SYSTEM Q.0142 :: Menu Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0142"
	S.key = "arkher.ui.menu.frame_budget"
	S.name = "Menu Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Menu"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.menu.accessibility_policy" }
	S.tags = { "q", "menu", "budgeter", "ui" }
	S.description = "Menu Frame Budget: per-frame layout and draw budget for the interface for the Menu subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.menu.frame_budget", total = 158, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
