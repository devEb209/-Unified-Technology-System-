-- ARKHER SYSTEM O.0235 :: Adaptive Music Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0235"
	S.key = "arkher.audio.adaptivemusic.asset_registry"
	S.name = "Adaptive Music Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.adaptivemusic.streaming" }
	S.tags = { "o", "adaptivemusic", "registry", "audio" }
	S.description = "Adaptive Music Asset Registry: catalogue of sounds, variations and metadata for the Adaptive Music subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.adaptivemusic.asset_registry" })
		inst.system = S
		inst.ctx = ctx
