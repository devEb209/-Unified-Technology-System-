-- ARKHER SYSTEM I.0327 :: Ragdoll Blend Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0327"
	S.key = "arkher.anim.ragdollblend.clip_sampling"
	S.name = "Ragdoll Blend Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.ragdollblend.skeleton" }
	S.tags = { "i", "ragdollblend", "clip", "anim" }
	S.description = "Ragdoll Blend Clip Sampling: keyframe tracks sampled, retimed and evented for the Ragdoll Blend subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.ragdollblend.clip_sampling", duration = 2.80, loop = false })
		inst.system = S
		inst.ctx = ctx
