-- ARKHER SYSTEM K.0561 :: Work Behaviour Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0561"
	S.key = "arkher.npc.workbehaviour.mind_network"
	S.name = "Work Behaviour Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "workbehaviour", "mindnet", "npc" }
	S.description = "Work Behaviour Mind Network: the learned policy that turns perception into a decision for the Work Behaviour subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.workbehaviour.mind_network", inputs = 6, hidden = 8, seed = 3624, learningRate = 0.070, exploration = 0.020 })
		inst.system = S
		inst.ctx = ctx
