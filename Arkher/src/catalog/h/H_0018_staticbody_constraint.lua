-- ARKHER SYSTEM H.0018 :: Static Body Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0018"
	S.key = "arkher.physics.staticbody.constraint_solver"
	S.name = "Static Body Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Static Body"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.staticbody.contact_generation" }
	S.tags = { "h", "staticbody", "constraint", "physics" }
	S.description = "Static Body Constraint Solver: sequential impulses, friction, joints and warm starting for the Static Body subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.staticbody.constraint_solver", iterations = 10, baumgarte = 0.26, warmStart = true })
		inst.system = S
		inst.ctx = ctx
