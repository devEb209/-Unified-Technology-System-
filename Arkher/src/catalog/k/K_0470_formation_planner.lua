-- ARKHER SYSTEM K.0470 :: Formation Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0470"
	S.key = "arkher.npc.formation.goal_planner"
	S.name = "Formation Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.formation.utility_reasoning" }
	S.tags = { "k", "formation", "planner", "npc" }
	S.description = "Formation Goal Planner: backward GOAP planning to reach a goal state for the Formation subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.formation.goal_planner", maxDepth = 8 })
		inst.system = S
		inst.ctx = ctx
