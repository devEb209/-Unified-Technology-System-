-- ARKHER SYSTEM J.0310 :: Character Streaming Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0310"
	S.key = "arkher.character.characterstreaming.motion_set"
	S.name = "Character Streaming Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterstreaming.rig_definition" }
	S.tags = { "j", "characterstreaming", "clip", "character" }
	S.description = "Character Streaming Motion Set: the clips a character owns and how they sample for the Character Streaming subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.characterstreaming.motion_set", duration = 1.50, loop = true })
		inst.system = S
		inst.ctx = ctx
