-- ARKHER SYSTEM F.0260 :: Exposure Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0260"
	S.key = "arkher.render.exposure.adaptive_resolution"
	S.name = "Exposure Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Exposure"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.exposure.temporal_resolve" }
	S.tags = { "f", "exposure", "upscaler", "render" }
	S.description = "Exposure Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Exposure subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.exposure.adaptive_resolution", targetMs = 12.10, index = 4, sharpness = 0.55 })
		inst.system = S
		inst.ctx = ctx
