-- ARKHER SYSTEM I.0079 :: Curve Interpolation Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0079"
	S.key = "arkher.anim.curveinterp.skeleton"
	S.name = "Curve Interpolation Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "curveinterp", "skeleton", "anim" }
	S.description = "Curve Interpolation Skeleton: bone hierarchy, bind pose and world resolution for the Curve Interpolation subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.curveinterp.skeleton" })
		inst.system = S
		inst.ctx = ctx
