-- ARKHER SYSTEM VC.0197 :: Architect District Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0197"
	S.key = "arkher.contneural.architectdistrict.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.architectdistrict.multi-scale_fidelity" }
	S.tags = { "vc", "architectdistrict", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.architectdistrict.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
