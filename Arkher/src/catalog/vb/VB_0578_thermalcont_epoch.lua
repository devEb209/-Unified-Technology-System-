-- ARKHER SYSTEM VB.0578 :: Thermal Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0578"
	S.key = "arkher.conttime.thermalcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.thermalcont.infinite_grid" }
	S.tags = { "vb", "thermalcont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.thermalcont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
