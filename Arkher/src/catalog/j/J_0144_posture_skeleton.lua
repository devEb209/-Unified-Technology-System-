-- ARKHER SYSTEM J.0144 :: Posture Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0144"
	S.key = "arkher.character.posture.rig_definition"
	S.name = "Posture Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "posture", "skeleton", "character" }
	S.description = "Posture Rig Definition: character rig definition and bone budget for the Posture subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.posture.rig_definition" })
		inst.system = S
		inst.ctx = ctx
