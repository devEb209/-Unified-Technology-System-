-- ARKHER SYSTEM VC.0529 :: Pipeline Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0529"
	S.key = "arkher.contneural.pipelinecont.infinite_grid"
	S.name = "Pipeline Continuum Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "pipelinecont", "continuum", "contneural" }
	S.description = "Pipeline Continuum Infinite Grid: seamless paging of the infinite world grid for the Pipeline Continuum subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.pipelinecont.infinite_grid", cellSize = 160, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
