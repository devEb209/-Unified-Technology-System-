-- ARKHER SYSTEM E.0471 :: Material Instance Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0471"
	S.key = "arkher.material.instance.variant_registry"
	S.name = "Material Instance Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.instance.procedural_detail" }
	S.tags = { "e", "instance", "registry", "material" }
	S.description = "Material Instance Variant Registry: named variants and their lifecycle for the Material Instance subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.instance.variant_registry" })
		inst.system = S
		inst.ctx = ctx
