-- ARKHER SYSTEM I.0482 :: Morph Target Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0482"
	S.key = "arkher.anim.morphtarget.skeleton"
	S.name = "Morph Target Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Morph Target"
	S.aspect = "Skeleton"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "morphtarget", "skeleton", "anim" }
	S.description = "Morph Target Skeleton: bone hierarchy, bind pose and world resolution for the Morph Target subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.morphtarget.skeleton" })
		inst.system = S
		inst.ctx = ctx
