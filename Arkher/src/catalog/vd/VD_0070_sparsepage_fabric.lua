-- ARKHER SYSTEM VD.0070 :: Sparse Page Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0070"
	S.key = "arkher.contsim.sparsepage.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.sparsepage.complexity_budget" }
	S.tags = { "vd", "sparsepage", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.sparsepage.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
