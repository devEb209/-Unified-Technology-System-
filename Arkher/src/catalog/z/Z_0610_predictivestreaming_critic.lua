-- ARKHER SYSTEM Z.0610 :: Predictive Streaming Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0610"
	S.key = "arkher.origin.predictivestreaming.self_critique"
	S.name = "Predictive Streaming Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictivestreaming.intent_bridge" }
	S.tags = { "z", "predictivestreaming", "critic", "origin" }
	S.description = "Predictive Streaming Self Critique: weighted judgement of the technology's own output for the Predictive Streaming subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.predictivestreaming.self_critique", passMark = 0.76, reviseMark = 0.46, seed = 97896 })
		inst.system = S
		inst.ctx = ctx
