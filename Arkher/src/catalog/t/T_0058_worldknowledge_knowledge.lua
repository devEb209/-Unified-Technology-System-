-- ARKHER SYSTEM T.0058 :: World Knowledge Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0058"
	S.key = "arkher.ai.worldknowledge.semantic_knowledge"
	S.name = "World Knowledge Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.worldknowledge.intent_understanding" }
	S.tags = { "t", "worldknowledge", "knowledge", "ai" }
	S.description = "World Knowledge Semantic Knowledge: typed entities, weighted relations and inferred closure for the World Knowledge subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.worldknowledge.semantic_knowledge", dims = 16 })
		inst.system = S
		inst.ctx = ctx
