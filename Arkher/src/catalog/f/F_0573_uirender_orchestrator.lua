-- ARKHER SYSTEM F.0573 :: UI Rendering Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0573"
	S.key = "arkher.render.uirender.orchestration"
	S.name = "UI Rendering Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "UI Rendering"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.uirender.frame_analysis" }
	S.tags = { "f", "uirender", "orchestrator", "render" }
	S.description = "UI Rendering Orchestration: frame lifecycle orchestration for the UI Rendering subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.uirender.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
