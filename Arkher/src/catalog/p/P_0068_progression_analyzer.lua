-- ARKHER SYSTEM P.0068 :: Progression Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0068"
	S.key = "arkher.play.progression.balance_analysis"
	S.name = "Progression Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Progression"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.progression.event_ledger" }
	S.tags = { "p", "progression", "analyzer", "play" }
	S.description = "Progression Balance Analysis: distribution, outlier and pacing analysis for the Progression subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.progression.balance_analysis", window = 140, buckets = 16, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
