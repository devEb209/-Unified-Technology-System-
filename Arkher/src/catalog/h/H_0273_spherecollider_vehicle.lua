-- ARKHER SYSTEM H.0273 :: Sphere Collider Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0273"
	S.key = "arkher.physics.spherecollider.vehicle"
	S.name = "Sphere Collider Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.spherecollider.character_motion" }
	S.tags = { "h", "spherecollider", "vehicle", "physics" }
	S.description = "Sphere Collider Vehicle: suspension, drivetrain, steering and tire friction for the Sphere Collider subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.spherecollider.vehicle", mass = 900, wheelbase = 2.20, track = 1.80, maxRpm = 5600 })
		inst.system = S
		inst.ctx = ctx
