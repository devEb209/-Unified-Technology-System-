-- ARKHER SYSTEM O.0038 :: Impact Sound Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0038"
	S.key = "arkher.audio.impactsound.mixer_bus"
	S.name = "Impact Sound Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Impact Sound"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.impactsound.dsp_chain" }
	S.tags = { "o", "impactsound", "mixer", "audio" }
	S.description = "Impact Sound Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Impact Sound subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.impactsound.mixer_bus", maxVoices = 40 })
		inst.system = S
		inst.ctx = ctx
