-- ARKHER SYSTEM VC.0148 :: Persistence Segment Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VC.0148"
	S.key = "arkher.contneural.persistsegment.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.persistsegment.sparse_residency" }
	S.tags = { "vc", "persistsegment", "multiscale", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contneural.persistsegment.multi-scale_fidelity", levels = 4, baseTriangles = 60000 })
		inst.system = S
		inst.ctx = ctx
