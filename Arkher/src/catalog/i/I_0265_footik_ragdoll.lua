-- ARKHER SYSTEM I.0265 :: Foot Placement IK Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0265"
	S.key = "arkher.anim.footik.physical_blend"
	S.name = "Foot Placement IK Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.footik.inverse_kinematics" }
	S.tags = { "i", "footik", "ragdoll", "anim" }
	S.description = "Foot Placement IK Physical Blend: physical bones blended against the animated pose for the Foot Placement IK subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.footik.physical_blend", blendSpeed = 4.80 })
		inst.system = S
		inst.ctx = ctx
