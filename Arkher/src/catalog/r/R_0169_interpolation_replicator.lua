-- ARKHER SYSTEM R.0169 :: Interpolation Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0169"
	S.key = "arkher.net.interpolation.replication"
	S.name = "Interpolation Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "interpolation", "replicator", "net" }
	S.description = "Interpolation Replication: authoritative entity state, interest and delta snapshots for the Interpolation subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.interpolation.replication", mtu = 1650, interestRadius = 400, fullEvery = 105 })
		inst.system = S
		inst.ctx = ctx
