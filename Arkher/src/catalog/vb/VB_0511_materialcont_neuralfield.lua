-- ARKHER SYSTEM VB.0511 :: Material Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0511"
	S.key = "arkher.conttime.materialcont.neural_field"
	S.name = "Material Continuum Neural Field"
	S.category = "VB"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.materialcont.coherence_guard" }
	S.tags = { "vb", "materialcont", "neuralfield", "conttime" }
	S.description = "Material Continuum Neural Field: neural field encoding and reconstruction for the Material Continuum subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.materialcont.neural_field", dims = 24, hidden = 20, seed = 76931 })
		inst.system = S
		inst.ctx = ctx
