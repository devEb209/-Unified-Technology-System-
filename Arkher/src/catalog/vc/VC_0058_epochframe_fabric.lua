-- ARKHER SYSTEM VC.0058 :: Epoch Frame Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0058"
	S.key = "arkher.contneural.epochframe.simulation_fabric"
	S.name = "Epoch Frame Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.epochframe.complexity_budget" }
	S.tags = { "vc", "epochframe", "fabric", "contneural" }
	S.description = "Epoch Frame Simulation Fabric: fabric stepping the continuum domains for the Epoch Frame subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.epochframe.simulation_fabric", budgetMs = 3.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
