-- ARKHER SYSTEM O.0397 :: Mobile Audio DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0397"
	S.key = "arkher.audio.mobileaudio.dsp_chain"
	S.name = "Mobile Audio DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mobile Audio"
	S.aspect = "DSP Chain"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "mobileaudio", "dsp", "audio" }
	S.description = "Mobile Audio DSP Chain: biquad filtering, delay, envelope and soft clipping for the Mobile Audio subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.mobileaudio.dsp_chain", sampleRate = 22050, filter = "highpass", cutoff = 3000, q = 0.590 })
		inst.system = S
		inst.ctx = ctx
