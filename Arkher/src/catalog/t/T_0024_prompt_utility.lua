-- ARKHER SYSTEM T.0024 :: Prompt Understanding Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0024"
	S.key = "arkher.ai.prompt.utility_selection"
	S.name = "Prompt Understanding Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.prompt.working_memory" }
	S.tags = { "t", "prompt", "utility", "ai" }
	S.description = "Prompt Understanding Utility Selection: scored choice between competing courses of action for the Prompt Understanding subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.prompt.utility_selection", momentum = 0.08 })
		inst.system = S
		inst.ctx = ctx
