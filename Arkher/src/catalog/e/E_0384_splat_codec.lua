-- ARKHER SYSTEM E.0384 :: Terrain Splat Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0384"
	S.key = "arkher.material.splat.compression_codec"
	S.name = "Terrain Splat Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.splat.streaming" }
	S.tags = { "e", "splat", "codec", "material" }
	S.description = "Terrain Splat Compression Codec: serialization and compression of material data for the Terrain Splat subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.splat.compression_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
