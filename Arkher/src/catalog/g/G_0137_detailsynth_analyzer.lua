-- ARKHER SYSTEM G.0137 :: Detail Synthesis Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0137"
	S.key = "arkher.neural.detailsynth.error_analysis"
	S.name = "Detail Synthesis Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detailsynth.heuristic_policy" }
	S.tags = { "g", "detailsynth", "analyzer", "neural" }
	S.description = "Detail Synthesis Error Analysis: residual and drift analysis for the Detail Synthesis subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.detailsynth.error_analysis", window = 205, buckets = 13, threshold = 3.70 })
		inst.system = S
		inst.ctx = ctx
