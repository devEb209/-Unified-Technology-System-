-- ARKHER SYSTEM P.0322 :: Damage Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0322"
	S.key = "arkher.play.damage.content_registry"
	S.name = "Damage Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Damage"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.damage.difficulty_controller" }
	S.tags = { "p", "damage", "registry", "play" }
	S.description = "Damage Content Registry: catalogue of the definitions this loop instantiates for the Damage subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.damage.content_registry" })
		inst.system = S
		inst.ctx = ctx
