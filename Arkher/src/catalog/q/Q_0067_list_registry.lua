-- ARKHER SYSTEM Q.0067 :: List Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0067"
	S.key = "arkher.ui.list.localization_registry"
	S.name = "List Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "List"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.list.theme_composition" }
	S.tags = { "q", "list", "registry", "ui" }
	S.description = "List Localization Registry: catalogue of strings, plurals and locale metadata for the List subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.list.localization_registry" })
		inst.system = S
		inst.ctx = ctx
