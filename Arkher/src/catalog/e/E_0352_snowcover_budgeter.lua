-- ARKHER SYSTEM E.0352 :: Snow Cover Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0352"
	S.key = "arkher.material.snowcover.parameter_budget"
	S.name = "Snow Cover Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Snow Cover"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.snowcover.variant_registry" }
	S.tags = { "e", "snowcover", "budgeter", "material" }
	S.description = "Snow Cover Parameter Budget: texel and layer budget allocation for the Snow Cover subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.snowcover.parameter_budget", total = 371, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
