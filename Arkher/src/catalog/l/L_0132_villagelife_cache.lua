-- ARKHER SYSTEM L.0132 :: Village Life Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0132"
	S.key = "arkher.sim.villagelife.aggregate_cache"
	S.name = "Village Life Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.villagelife.fidelity_policy" }
	S.tags = { "l", "villagelife", "cache", "sim" }
	S.description = "Village Life Aggregate Cache: reuse of expensive aggregate computations for the Village Life subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.villagelife.aggregate_cache", policy = "ttl", capacity = 431, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
