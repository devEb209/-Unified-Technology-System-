-- ARKHER SYSTEM L.0257 :: Season Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0257"
	S.key = "arkher.sim.season.ecology"
	S.name = "Season Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.season.simulation_core" }
	S.tags = { "l", "season", "ecology", "sim" }
	S.description = "Season Ecology: populations, predation, harvesting and carrying capacity for the Season subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.season.ecology" })
		inst.system = S
		inst.ctx = ctx
