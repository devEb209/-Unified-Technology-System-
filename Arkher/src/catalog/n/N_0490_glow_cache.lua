-- ARKHER SYSTEM N.0490 :: Glow Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0490"
	S.key = "arkher.vfx.glow.result_cache"
	S.name = "Glow Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Glow"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.glow.spawn_budget" }
	S.tags = { "n", "glow", "cache", "vfx" }
	S.description = "Glow Result Cache: reuse of expensive effect evaluations for the Glow subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.glow.result_cache", policy = "lru", capacity = 236, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
