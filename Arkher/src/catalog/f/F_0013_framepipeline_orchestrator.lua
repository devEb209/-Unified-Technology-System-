-- ARKHER SYSTEM F.0013 :: Frame Pipeline Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0013"
	S.key = "arkher.render.framepipeline.orchestration"
	S.name = "Frame Pipeline Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepipeline.frame_analysis" }
	S.tags = { "f", "framepipeline", "orchestrator", "render" }
	S.description = "Frame Pipeline Orchestration: frame lifecycle orchestration for the Frame Pipeline subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.framepipeline.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
