-- ARKHER SYSTEM I.0485 :: Morph Target Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0485"
	S.key = "arkher.anim.morphtarget.inverse_kinematics"
	S.name = "Morph Target Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Morph Target"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.morphtarget.layered_blending" }
	S.tags = { "i", "morphtarget", "ik", "anim" }
	S.description = "Morph Target Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Morph Target subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.morphtarget.inverse_kinematics", iterations = 12, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
