-- ARKHER SYSTEM J.0117 :: Gaze Behaviour Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0117"
	S.key = "arkher.character.gaze.appearance_composer"
	S.name = "Gaze Behaviour Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gaze.locomotion" }
	S.tags = { "j", "gaze", "composer", "character" }
	S.description = "Gaze Behaviour Appearance Composer: composition of appearance slots into a look for the Gaze Behaviour subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.gaze.appearance_composer", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
