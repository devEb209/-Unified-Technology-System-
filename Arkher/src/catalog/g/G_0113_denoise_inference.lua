-- ARKHER SYSTEM G.0113 :: Denoising Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0113"
	S.key = "arkher.neural.denoise.inference_core"
	S.name = "Denoising Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "denoise", "inference", "neural" }
	S.description = "Denoising Inference Core: dense network forward pass and training for the Denoising subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.denoise.inference_core", seed = 88012 })
		inst.system = S
		inst.ctx = ctx
