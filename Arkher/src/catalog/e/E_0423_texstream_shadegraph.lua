-- ARKHER SYSTEM E.0423 :: Texture Streaming Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0423"
	S.key = "arkher.material.texstream.shading_graph"
	S.name = "Texture Streaming Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.texstream.layer_composition" }
	S.tags = { "e", "texstream", "shadegraph", "material" }
	S.description = "Texture Streaming Shading Graph: node graph evaluated and compiled to Luau for the Texture Streaming subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.texstream.shading_graph" })
		inst.system = S
		inst.ctx = ctx
