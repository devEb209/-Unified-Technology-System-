-- ARKHER SYSTEM I.0249 :: Turn In Place Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0249"
	S.key = "arkher.anim.turninplace.clip_sampling"
	S.name = "Turn In Place Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.turninplace.skeleton" }
	S.tags = { "i", "turninplace", "clip", "anim" }
	S.description = "Turn In Place Clip Sampling: keyframe tracks sampled, retimed and evented for the Turn In Place subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.turninplace.clip_sampling", duration = 1.80, loop = true })
		inst.system = S
		inst.ctx = ctx
