-- ARKHER SYSTEM E.0138 :: Opacity Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0138"
	S.key = "arkher.material.opacity.shading_graph"
	S.name = "Opacity Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Opacity"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.opacity.layer_composition" }
	S.tags = { "e", "opacity", "shadegraph", "material" }
	S.description = "Opacity Shading Graph: node graph evaluated and compiled to Luau for the Opacity subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.opacity.shading_graph" })
		inst.system = S
		inst.ctx = ctx
