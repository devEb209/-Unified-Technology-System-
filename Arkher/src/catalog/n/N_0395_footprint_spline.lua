-- ARKHER SYSTEM N.0395 :: Footprint Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0395"
	S.key = "arkher.vfx.footprint.curve_authoring"
	S.name = "Footprint Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Footprint"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.footprint.ribbon_and_trail" }
	S.tags = { "n", "footprint", "spline", "vfx" }
	S.description = "Footprint Curve Authoring: authored curves driving the effect over its life for the Footprint subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.footprint.curve_authoring", tension = 0.52, closed = false })
		inst.system = S
		inst.ctx = ctx
