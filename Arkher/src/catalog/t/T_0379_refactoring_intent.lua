-- ARKHER SYSTEM T.0379 :: Refactoring Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0379"
	S.key = "arkher.ai.refactoring.intent_understanding"
	S.name = "Refactoring Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "refactoring", "intent", "ai" }
	S.description = "Refactoring Intent Understanding: natural language turned into an actionable, scored intent for the Refactoring subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.refactoring.intent_understanding", minConfidence = 0.36 })
		inst.system = S
		inst.ctx = ctx
