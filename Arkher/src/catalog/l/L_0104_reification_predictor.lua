-- ARKHER SYSTEM L.0104 :: Reification Forecast
...
return function(A)
	...
	local S = {}
	S.id = "L.0104"
	S.key = "arkher.sim.reification.forecast"
	S.name = "Reification Forecast"
	S.category = "L"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.reification.analysis" }
	S.tags = { "l", "reification", "predictor", "sim" }
	S.description = "Reification Forecast: prediction of the region's next state for the Reification subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.sim.reification.forecast", method = "markov", alpha = 0.24, window = 118 })
		inst.system = S
		inst.ctx = ctx
