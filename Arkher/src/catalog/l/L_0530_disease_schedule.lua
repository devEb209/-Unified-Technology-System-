-- ARKHER SYSTEM L.0530 :: Disease Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0530"
	S.key = "arkher.sim.disease.calendar"
	S.name = "Disease Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.disease.society" }
	S.tags = { "l", "disease", "schedule", "sim" }
	S.description = "Disease Calendar: hours, days and seasons driving the region for the Disease subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.disease.calendar", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
