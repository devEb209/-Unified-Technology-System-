-- ARKHER SYSTEM J.0030 :: Body Proportions Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0030"
	S.key = "arkher.character.proportions.variant_registry"
	S.name = "Body Proportions Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.proportions.appearance_composer" }
	S.tags = { "j", "proportions", "registry", "character" }
	S.description = "Body Proportions Variant Registry: named character variants and their lifecycle for the Body Proportions subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.proportions.variant_registry" })
		inst.system = S
		inst.ctx = ctx
