-- ARKHER SYSTEM E.0481 :: Material Variant Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0481"
	S.key = "arkher.material.variant.definition"
	S.name = "Material Variant Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "variant", "material", "material" }
	S.description = "Material Variant Definition: layered PBR definition resolved into parameters for the Material Variant subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.variant.definition", texelBudget = 1310720 })
		inst.system = S
		inst.ctx = ctx
