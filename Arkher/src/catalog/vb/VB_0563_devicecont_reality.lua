-- ARKHER SYSTEM VB.0563 :: Device Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0563"
	S.key = "arkher.conttime.devicecont.reality_continuum"
	S.name = "Device Continuum Reality Continuum"
	S.category = "VB"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.devicecont.simulation_fabric" }
	S.tags = { "vb", "devicecont", "reality", "conttime" }
	S.description = "Device Continuum Reality Continuum: stacked reality layers of the continuum for the Device Continuum subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.devicecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
