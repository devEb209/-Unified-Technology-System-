-- ARKHER SYSTEM P.0140 :: Rarity Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0140"
	S.key = "arkher.play.rarity.balance_analysis"
	S.name = "Rarity Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Rarity"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.rarity.event_ledger" }
	S.tags = { "p", "rarity", "analyzer", "play" }
	S.description = "Rarity Balance Analysis: distribution, outlier and pacing analysis for the Rarity subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.rarity.balance_analysis", window = 49, buckets = 9, threshold = 2.10 })
		inst.system = S
		inst.ctx = ctx
