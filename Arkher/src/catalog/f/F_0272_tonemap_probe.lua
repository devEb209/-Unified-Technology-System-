-- ARKHER SYSTEM F.0272 :: Tonemapping Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0272"
	S.key = "arkher.render.tonemap.probe_volume"
	S.name = "Tonemapping Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Tonemapping"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.tonemap.lighting_rig" }
	S.tags = { "f", "tonemap", "probe", "render" }
	S.description = "Tonemapping Probe Volume: irradiance probes encoded in spherical harmonics for the Tonemapping subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.tonemap.probe_volume", spacing = 40 })
		inst.system = S
		inst.ctx = ctx
