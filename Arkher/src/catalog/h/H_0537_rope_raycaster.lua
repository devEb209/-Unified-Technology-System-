-- ARKHER SYSTEM H.0537 :: Rope Simulation Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0537"
	S.key = "arkher.physics.rope.query"
	S.name = "Rope Simulation Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rope.constraint_solver" }
	S.tags = { "h", "rope", "raycaster", "physics" }
	S.description = "Rope Simulation Query: rays, sweeps and overlaps against the simulation for the Rope Simulation subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.rope.query", cellSize = 16 })
		inst.system = S
		inst.ctx = ctx
