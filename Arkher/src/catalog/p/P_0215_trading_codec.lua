-- ARKHER SYSTEM P.0215 :: Trading Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0215"
	S.key = "arkher.play.trading.save_codec"
	S.name = "Trading Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Trading"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.trading.content_registry" }
	S.tags = { "p", "trading", "codec", "play" }
	S.description = "Trading Save Codec: persistence, diffing and checksum of gameplay state for the Trading subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.trading.save_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
