-- ARKHER SYSTEM VC.0394 :: Memory Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0394"
	S.key = "arkher.contneural.memorycont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memorycont.complexity_budget" }
	S.tags = { "vc", "memorycont", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.memorycont.simulation_fabric", budgetMs = 4.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
