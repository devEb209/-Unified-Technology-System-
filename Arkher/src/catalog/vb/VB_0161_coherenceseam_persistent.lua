-- ARKHER SYSTEM VB.0161 :: Coherence Seam Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0161"
	S.key = "arkher.conttime.coherenceseam.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.coherenceseam.multi-scale_fidelity" }
	S.tags = { "vb", "coherenceseam", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.coherenceseam.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
