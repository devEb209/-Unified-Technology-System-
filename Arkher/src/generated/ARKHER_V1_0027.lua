--!strict
-- UE5/6 Nanite — ANIMATION Mixer #0027
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="UE5/6 Nanite — ANIMATION Mixer #0027", size=Vector2.new(600, 460), pos=UDim2.fromOffset(451, 279), parent=parent, icon="◣"})
