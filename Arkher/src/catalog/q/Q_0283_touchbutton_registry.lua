-- ARKHER SYSTEM Q.0283 :: Touch Button Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0283"
	S.key = "arkher.ui.touchbutton.localization_registry"
	S.name = "Touch Button Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Touch Button"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.touchbutton.theme_composition" }
	S.tags = { "q", "touchbutton", "registry", "ui" }
	S.description = "Touch Button Localization Registry: catalogue of strings, plurals and locale metadata for the Touch Button subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.touchbutton.localization_registry" })
		inst.system = S
		inst.ctx = ctx
