...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Physics Chaos — CORE Map #0228", size=Vector2.new(600, 480), pos=UDim2.fromOffset(264, 316), parent=parent, icon="⤢"})
