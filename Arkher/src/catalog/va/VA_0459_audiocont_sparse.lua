-- ARKHER SYSTEM VA.0459 :: Audio Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0459"
	S.key = "arkher.contworld.audiocont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.audiocont.epoch_clock" }
	S.tags = { "va", "audiocont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.audiocont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
