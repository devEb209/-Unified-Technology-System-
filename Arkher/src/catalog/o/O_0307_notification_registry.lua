-- ARKHER SYSTEM O.0307 :: Notification Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0307"
	S.key = "arkher.audio.notification.asset_registry"
	S.name = "Notification Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Notification"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.notification.streaming" }
	S.tags = { "o", "notification", "registry", "audio" }
	S.description = "Notification Asset Registry: catalogue of sounds, variations and metadata for the Notification subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.notification.asset_registry" })
		inst.system = S
		inst.ctx = ctx
