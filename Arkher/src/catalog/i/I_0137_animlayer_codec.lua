-- ARKHER SYSTEM I.0137 :: Animation Layer Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0137"
	S.key = "arkher.anim.animlayer.compression_codec"
	S.name = "Animation Layer Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlayer.retarget_graph" }
	S.tags = { "i", "animlayer", "codec", "anim" }
	S.description = "Animation Layer Compression Codec: curve compression and quantized transport for the Animation Layer subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.animlayer.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
