-- ARKHER SYSTEM J.0307 :: Crowd Instance Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0307"
	S.key = "arkher.character.crowdinstance.streaming"
	S.name = "Crowd Instance Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.crowdinstance.budget_governor" }
	S.tags = { "j", "crowdinstance", "streamer", "character" }
	S.description = "Crowd Instance Streaming: distance-driven residency of character data for the Crowd Instance subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.crowdinstance.streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
