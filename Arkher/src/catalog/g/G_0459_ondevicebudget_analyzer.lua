-- ARKHER SYSTEM G.0459 :: On Device Budget Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0459"
	S.key = "arkher.neural.ondevicebudget.error_analysis"
	S.name = "On Device Budget Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ondevicebudget.heuristic_policy" }
	S.tags = { "g", "ondevicebudget", "analyzer", "neural" }
	S.description = "On Device Budget Error Analysis: residual and drift analysis for the On Device Budget subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.ondevicebudget.error_analysis", window = 247, buckets = 11, threshold = 2.90 })
		inst.system = S
		inst.ctx = ctx
