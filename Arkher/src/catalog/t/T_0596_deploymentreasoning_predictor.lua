-- ARKHER SYSTEM T.0596 :: Deployment Reasoning Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0596"
	S.key = "arkher.ai.deploymentreasoning.outcome_prediction"
	S.name = "Deployment Reasoning Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.deploymentreasoning.decision_policy" }
	S.tags = { "t", "deploymentreasoning", "predictor", "ai" }
	S.description = "Deployment Reasoning Outcome Prediction: forecasting the result before the work is done for the Deployment Reasoning subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.deploymentreasoning.outcome_prediction", method = "ema", alpha = 0.29, window = 59 })
		inst.system = S
		inst.ctx = ctx
