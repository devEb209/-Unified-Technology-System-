-- ARKHER SYSTEM W.0187 :: Dialogue Scene Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0187"
	S.key = "arkher.cine.dialoguescene.motion_tween"
	S.name = "Dialogue Scene Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dialoguescene.playback_orchestrator" }
	S.tags = { "w", "dialoguescene", "tween", "cine" }
	S.description = "Dialogue Scene Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Dialogue Scene subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.dialoguescene.motion_tween", timeScale = 1.01 })
		inst.system = S
		inst.ctx = ctx
