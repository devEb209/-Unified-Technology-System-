-- ARKHER SYSTEM E.0070 :: Metalness Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0070"
	S.key = "arkher.material.metalness.quality_policy"
	S.name = "Metalness Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Metalness"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.metalness.compression_codec" }
	S.tags = { "e", "metalness", "policy", "material" }
	S.description = "Metalness Quality Policy: device tier rules for the surface for the Metalness subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.metalness.quality_policy", algorithm = "lottery", starvationGuard = 47 })
		inst.system = S
		inst.ctx = ctx
