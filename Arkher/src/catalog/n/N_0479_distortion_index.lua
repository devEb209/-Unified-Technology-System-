-- ARKHER SYSTEM N.0479 :: Distortion Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0479"
	S.key = "arkher.vfx.distortion.spatial_index"
	S.name = "Distortion Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Distortion"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.distortion.quality_policy" }
	S.tags = { "n", "distortion", "index", "vfx" }
	S.description = "Distortion Spatial Index: spatial acceleration of effect queries and culling for the Distortion subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.distortion.spatial_index", mode = "hash", cellSize = 96 })
		inst.system = S
		inst.ctx = ctx
