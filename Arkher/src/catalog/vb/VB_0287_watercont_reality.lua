-- ARKHER SYSTEM VB.0287 :: Water Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0287"
	S.key = "arkher.conttime.watercont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.watercont.simulation_fabric" }
	S.tags = { "vb", "watercont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.watercont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
