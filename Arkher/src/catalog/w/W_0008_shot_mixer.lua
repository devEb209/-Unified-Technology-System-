-- ARKHER SYSTEM W.0008 :: Shot Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0008"
	S.key = "arkher.cine.shot.cinematic_mix"
	S.name = "Shot Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Shot"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.shot.motion_tween" }
	S.tags = { "w", "shot", "mixer", "cine" }
	S.description = "Shot Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Shot subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.shot.cinematic_mix", maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
