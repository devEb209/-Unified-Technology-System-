-- ARKHER SYSTEM W.0289 :: Motion Blur Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0289"
	S.key = "arkher.cine.cinemotionblur.sequence_timeline"
	S.name = "Motion Blur Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Motion Blur"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "cinemotionblur", "timeline", "cine" }
	S.description = "Motion Blur Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.cinemotionblur.sequence_timeline", duration = 11.0, rate = 1.19 })
		inst.system = S
		inst.ctx = ctx
