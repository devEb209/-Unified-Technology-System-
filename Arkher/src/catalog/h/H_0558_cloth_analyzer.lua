-- ARKHER SYSTEM H.0558 :: Cloth Simulation Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0558"
	S.key = "arkher.physics.cloth.analysis"
	S.name = "Cloth Simulation Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.cloth.result_cache" }
	S.tags = { "h", "cloth", "analyzer", "physics" }
	S.description = "Cloth Simulation Analysis: energy, jitter and cost analysis of the simulation for the Cloth Simulation subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.cloth.analysis", window = 157, buckets = 17, threshold = 2.90 })
		inst.system = S
		inst.ctx = ctx
