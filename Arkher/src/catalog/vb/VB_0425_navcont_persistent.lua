-- ARKHER SYSTEM VB.0425 :: Navigation Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0425"
	S.key = "arkher.conttime.navcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.navcont.multi-scale_fidelity" }
	S.tags = { "vb", "navcont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.navcont.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
