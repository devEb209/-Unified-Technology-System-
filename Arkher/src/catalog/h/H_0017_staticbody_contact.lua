-- ARKHER SYSTEM H.0017 :: Static Body Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0017"
	S.key = "arkher.physics.staticbody.contact_generation"
	S.name = "Static Body Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Static Body"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.staticbody.collision_shape" }
	S.tags = { "h", "staticbody", "contact", "physics" }
	S.description = "Static Body Contact Generation: narrow-phase manifolds with normal, depth and point for the Static Body subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.staticbody.contact_generation", slop = 0.0070, maxManifolds = 456 })
		inst.system = S
		inst.ctx = ctx
