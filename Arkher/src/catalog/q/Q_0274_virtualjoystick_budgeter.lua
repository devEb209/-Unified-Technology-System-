-- ARKHER SYSTEM Q.0274 :: Virtual Joystick Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0274"
	S.key = "arkher.ui.virtualjoystick.frame_budget"
	S.name = "Virtual Joystick Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.virtualjoystick.accessibility_policy" }
	S.tags = { "q", "virtualjoystick", "budgeter", "ui" }
	S.description = "Virtual Joystick Frame Budget: per-frame layout and draw budget for the interface for the Virtual Joystick subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.virtualjoystick.frame_budget", total = 459, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
