-- ARKHER SYSTEM T.0064 :: World Knowledge Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0064"
	S.key = "arkher.ai.worldknowledge.outcome_prediction"
	S.name = "World Knowledge Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.worldknowledge.decision_policy" }
	S.tags = { "t", "worldknowledge", "predictor", "ai" }
	S.description = "World Knowledge Outcome Prediction: forecasting the result before the work is done for the World Knowledge subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.worldknowledge.outcome_prediction", method = "markov", alpha = 0.36, window = 58 })
		inst.system = S
		inst.ctx = ctx
