-- ARKHER SYSTEM I.0457 :: Procedural Animation Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0457"
	S.key = "arkher.anim.proceduralanim.clip_sampling"
	S.name = "Procedural Animation Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.proceduralanim.skeleton" }
	S.tags = { "i", "proceduralanim", "clip", "anim" }
	S.description = "Procedural Animation Clip Sampling: keyframe tracks sampled, retimed and evented for the Procedural Animation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.proceduralanim.clip_sampling", duration = 2.50, loop = true })
		inst.system = S
		inst.ctx = ctx
