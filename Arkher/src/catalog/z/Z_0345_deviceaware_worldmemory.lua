-- ARKHER SYSTEM Z.0345 :: Device Aware Fidelity World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0345"
	S.key = "arkher.origin.deviceaware.world_memory"
	S.name = "Device Aware Fidelity World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.autonomous_pipeline" }
	S.tags = { "z", "deviceaware", "worldmemory", "origin" }
	S.description = "Device Aware Fidelity World Memory: epoch-stamped persistent history with compaction and checkpoints for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.deviceaware.world_memory", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
