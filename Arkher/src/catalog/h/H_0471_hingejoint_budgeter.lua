-- ARKHER SYSTEM H.0471 :: Hinge Joint Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0471"
	S.key = "arkher.physics.hingejoint.budget_governor"
	S.name = "Hinge Joint Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Hinge Joint"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.hingejoint.broadphase_index" }
	S.tags = { "h", "hingejoint", "budgeter", "physics" }
	S.description = "Hinge Joint Budget Governor: simulation time budget allocation across islands for the Hinge Joint subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.hingejoint.budget_governor", total = 154, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
