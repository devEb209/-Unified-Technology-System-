-- ARKHER SYSTEM J.0040 :: Skin Definition Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0040"
	S.key = "arkher.character.skindef.appearance_composer"
	S.name = "Skin Definition Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.skindef.locomotion" }
	S.tags = { "j", "skindef", "composer", "character" }
	S.description = "Skin Definition Appearance Composer: composition of appearance slots into a look for the Skin Definition subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.skindef.appearance_composer", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
