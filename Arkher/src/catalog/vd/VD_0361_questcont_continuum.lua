-- ARKHER SYSTEM VD.0361 :: Quest Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0361"
	S.key = "arkher.contsim.questcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "questcont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.questcont.infinite_grid", cellSize = 192, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
