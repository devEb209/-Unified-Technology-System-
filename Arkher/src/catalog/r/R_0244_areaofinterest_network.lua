-- ARKHER SYSTEM R.0244 :: Area Of Interest Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0244"
	S.key = "arkher.net.areaofinterest.transport_graph"
	S.name = "Area Of Interest Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.areaofinterest.prediction_and_reconciliation" }
	S.tags = { "r", "areaofinterest", "network", "net" }
	S.description = "Area Of Interest Transport Graph: topology, capacity and routing between endpoints for the Area Of Interest subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.areaofinterest.transport_graph" })
		inst.system = S
		inst.ctx = ctx
