-- ARKHER SYSTEM P.0290 :: Melee Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0290"
	S.key = "arkher.play.melee.inventory"
	S.name = "Melee Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Melee"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.melee.attributes" }
	S.tags = { "p", "melee", "inventory", "play" }
	S.description = "Melee Inventory: slots, stacking, weight, equipment and crafting for the Melee subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.melee.inventory", slots = 12, maxWeight = 40 })
		inst.system = S
		inst.ctx = ctx
