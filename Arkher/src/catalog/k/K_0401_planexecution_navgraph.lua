-- ARKHER SYSTEM K.0401 :: Plan Execution Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0401"
	S.key = "arkher.npc.planexecution.navigation"
	S.name = "Plan Execution Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.planexecution.goal_planner" }
	S.tags = { "k", "planexecution", "navgraph", "npc" }
	S.description = "Plan Execution Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Plan Execution subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.planexecution.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
