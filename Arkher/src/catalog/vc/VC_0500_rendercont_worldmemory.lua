-- ARKHER SYSTEM VC.0500 :: Rendering Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0500"
	S.key = "arkher.contneural.rendercont.world_memory_stream"
	S.name = "Rendering Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.rendercont.neural_field" }
	S.tags = { "vc", "rendercont", "worldmemory", "contneural" }
	S.description = "Rendering Continuum World Memory Stream: world memory continuum over epochs for the Rendering Continuum subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.rendercont.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
