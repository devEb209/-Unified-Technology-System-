-- ARKHER SYSTEM N.0201 :: Cloud Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0201"
	S.key = "arkher.vfx.cloud.effect_graph"
	S.name = "Cloud Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloud"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.cloud.curve_authoring" }
	S.tags = { "n", "cloud", "shadegraph", "vfx" }
	S.description = "Cloud Effect Graph: node graph describing how the effect is shaded for the Cloud subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.cloud.effect_graph" })
		inst.system = S
		inst.ctx = ctx
