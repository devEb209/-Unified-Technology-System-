-- ARKHER SYSTEM O.0412 :: Audio Debug Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0412"
	S.key = "arkher.audio.audiodebug.music_sequencer"
	S.name = "Audio Debug Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Audio Debug"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiodebug.spatialization" }
	S.tags = { "o", "audiodebug", "sequencer", "audio" }
	S.description = "Audio Debug Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Audio Debug subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.audiodebug.music_sequencer", bpm = 150, beatsPerBar = 4, intensity = 0.60 })
		inst.system = S
		inst.ctx = ctx
