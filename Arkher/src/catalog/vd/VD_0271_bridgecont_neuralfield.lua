-- ARKHER SYSTEM VD.0271 :: Bridge Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0271"
	S.key = "arkher.contsim.bridgecont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.bridgecont.coherence_guard" }
	S.tags = { "vd", "bridgecont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.bridgecont.neural_field", dims = 12, hidden = 8, seed = 20280 })
		inst.system = S
		inst.ctx = ctx
