-- ARKHER SYSTEM W.0245 :: Dissolve Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0245"
	S.key = "arkher.cine.dissolve.cut_policy"
	S.name = "Dissolve Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dissolve"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dissolve.shot_composition" }
	S.tags = { "w", "dissolve", "policy", "cine" }
	S.description = "Dissolve Cut Policy: rules deciding when the sequence cuts and to what for the Dissolve subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.dissolve.cut_policy", algorithm = "edf", starvationGuard = 61 })
		inst.system = S
		inst.ctx = ctx
