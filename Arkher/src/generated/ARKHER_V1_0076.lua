...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Cinema4D — CORE Node_Flow #0076", size=Vector2.new(640, 440), pos=UDim2.fromOffset(288, 332), parent=parent, icon="≡"})
