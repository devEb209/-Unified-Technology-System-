-- ARKHER SYSTEM F.0496 :: HLOD Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0496"
	S.key = "arkher.render.hlod.probe_volume"
	S.name = "HLOD Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "HLOD"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.hlod.lighting_rig" }
	S.tags = { "f", "hlod", "probe", "render" }
	S.description = "HLOD Probe Volume: irradiance probes encoded in spherical harmonics for the HLOD subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.hlod.probe_volume", spacing = 8 })
		inst.system = S
		inst.ctx = ctx
