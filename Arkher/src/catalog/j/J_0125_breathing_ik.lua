-- ARKHER SYSTEM J.0125 :: Breathing Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0125"
	S.key = "arkher.character.breathing.look_and_reach"
	S.name = "Breathing Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.breathing.blend_controller" }
	S.tags = { "j", "breathing", "ik", "character" }
	S.description = "Breathing Look And Reach: look-at, reach and foot placement for the character for the Breathing subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.breathing.look_and_reach", iterations = 9, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
