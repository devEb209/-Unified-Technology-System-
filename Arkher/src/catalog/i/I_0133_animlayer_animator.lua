-- ARKHER SYSTEM I.0133 :: Animation Layer Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0133"
	S.key = "arkher.anim.animlayer.layered_blending"
	S.name = "Animation Layer Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlayer.clip_sampling" }
	S.tags = { "i", "animlayer", "animator", "anim" }
	S.description = "Animation Layer Layered Blending: layers, crossfades, masks and blend trees for the Animation Layer subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.animlayer.layered_blending", budget = 7 })
		inst.system = S
		inst.ctx = ctx
