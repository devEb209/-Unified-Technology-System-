-- ARKHER SYSTEM E.0379 :: Terrain Splat Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0379"
	S.key = "arkher.material.splat.texture_sampling"
	S.name = "Terrain Splat Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.splat.shading_graph" }
	S.tags = { "e", "splat", "sampler", "material" }
	S.description = "Terrain Splat Texture Sampling: atlas packing, mip chain and filtered sampling for the Terrain Splat subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.splat.texture_sampling", atlasSize = 192, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
