-- ARKHER SYSTEM H.0670 :: Raycast Query Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0670"
	S.key = "arkher.physics.raycast.analysis"
	S.name = "Raycast Query Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.raycast.result_cache" }
	S.tags = { "h", "raycast", "analyzer", "physics" }
	S.description = "Raycast Query Analysis: energy, jitter and cost analysis of the simulation for the Raycast Query subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.raycast.analysis", window = 68, buckets = 12, threshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
