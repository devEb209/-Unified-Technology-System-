-- ARKHER SYSTEM F.0145 :: Light Clustering Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0145"
	S.key = "arkher.render.lightcluster.lighting_rig"
	S.name = "Light Clustering Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.lightcluster.geometry_virtualization" }
	S.tags = { "f", "lightcluster", "lightrig", "render" }
	S.description = "Light Clustering Lighting Rig: light clustering, importance and cascades for the Light Clustering subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.lightcluster.lighting_rig", maxActive = 12 })
		inst.system = S
		inst.ctx = ctx
