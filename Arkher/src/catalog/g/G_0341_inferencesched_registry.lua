-- ARKHER SYSTEM G.0341 :: Inference Scheduler Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0341"
	S.key = "arkher.neural.inferencesched.model_registry"
	S.name = "Inference Scheduler Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.inferencesched.reconstruction" }
	S.tags = { "g", "inferencesched", "registry", "neural" }
	S.description = "Inference Scheduler Model Registry: named models and their lifecycle for the Inference Scheduler subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.inferencesched.model_registry" })
		inst.system = S
		inst.ctx = ctx
