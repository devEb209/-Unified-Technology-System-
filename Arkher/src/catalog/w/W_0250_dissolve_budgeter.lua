-- ARKHER SYSTEM W.0250 :: Dissolve Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0250"
	S.key = "arkher.cine.dissolve.frame_budget"
	S.name = "Dissolve Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dissolve"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.dissolve.event_ledger" }
	S.tags = { "w", "dissolve", "budgeter", "cine" }
	S.description = "Dissolve Frame Budget: per-frame cost budget for the cinematic systems for the Dissolve subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.dissolve.frame_budget", total = 381, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
