-- ARKHER SYSTEM G.0037 :: Spatial Reconstruction Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0037"
	S.key = "arkher.neural.spatialrecon.result_cache"
	S.name = "Spatial Reconstruction Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.spatialrecon.compute_budget" }
	S.tags = { "g", "spatialrecon", "cache", "neural" }
	S.description = "Spatial Reconstruction Result Cache: cached inference results keyed by input for the Spatial Reconstruction subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.spatialrecon.result_cache", policy = "ttl", capacity = 243, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
