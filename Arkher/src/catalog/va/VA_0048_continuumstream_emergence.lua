-- ARKHER SYSTEM VA.0048 :: Continuum Stream Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0048"
	S.key = "arkher.contworld.continuumstream.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.continuumstream.reality_continuum" }
	S.tags = { "va", "continuumstream", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.continuumstream.emergence_continuum", windowSize = 6, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
