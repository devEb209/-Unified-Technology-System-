-- ARKHER SYSTEM Z.0348 :: Device Aware Fidelity Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0348"
	S.key = "arkher.origin.deviceaware.semantic_graph"
	S.name = "Device Aware Fidelity Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.world_architect" }
	S.tags = { "z", "deviceaware", "knowledge", "origin" }
	S.description = "Device Aware Fidelity Semantic Graph: typed entities and inferred relations of the technology itself for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.deviceaware.semantic_graph", dims = 48 })
		inst.system = S
		inst.ctx = ctx
