-- ARKHER SYSTEM VA.0152 :: Persistence Segment World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0152"
	S.key = "arkher.contworld.persistsegment.world_memory_stream"
	S.name = "Persistence Segment World Memory Stream"
	S.category = "VA"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.persistsegment.neural_field" }
	S.tags = { "va", "persistsegment", "worldmemory", "contworld" }
	S.description = "Persistence Segment World Memory Stream: world memory continuum over epochs for the Persistence Segment subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.persistsegment.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
