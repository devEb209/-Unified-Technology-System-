-- ARKHER SYSTEM R.0038 :: Authentication Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0038"
	S.key = "arkher.net.netauth.time_sync"
	S.name = "Authentication Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.netauth.replication" }
	S.tags = { "r", "netauth", "netclock", "net" }
	S.description = "Authentication Time Sync: offset estimation, outlier rejection and jitter buffering for the Authentication subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.netauth.time_sync", tickRate = 40, bufferDelay = 0.100, maxSamples = 18 })
		inst.system = S
		inst.ctx = ctx
