-- ARKHER SYSTEM Z.0505 :: Economic Emergence World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0505"
	S.key = "arkher.origin.economicemergence.world_memory"
	S.name = "Economic Emergence World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.economicemergence.autonomous_pipeline" }
	S.tags = { "z", "economicemergence", "worldmemory", "origin" }
	S.description = "Economic Emergence World Memory: epoch-stamped persistent history with compaction and checkpoints for the Economic Emergence subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.economicemergence.world_memory", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
