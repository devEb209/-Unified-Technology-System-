-- ARKHER SYSTEM T.0166 :: Code Generation Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0166"
	S.key = "arkher.ai.codegeneration.model_inference"
	S.name = "Code Generation Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.codegeneration.action_planner" }
	S.tags = { "t", "codegeneration", "inference", "ai" }
	S.description = "Code Generation Model Inference: quantized inference with batching and budget for the Code Generation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.codegeneration.model_inference", seed = 90479 })
		inst.system = S
		inst.ctx = ctx
