-- ARKHER SYSTEM V.0150 :: UI Sprite Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0150"
	S.key = "arkher.asset.uisprite.content_cache"
	S.name = "UI Sprite Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.uisprite.dependency_graph" }
	S.tags = { "v", "uisprite", "cache", "asset" }
	S.description = "UI Sprite Content Cache: reuse of already cooked results for the UI Sprite subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.uisprite.content_cache", policy = "ttl", capacity = 315, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
