-- ARKHER SYSTEM E.0263 :: UV Mapping Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0263"
	S.key = "arkher.material.uvmap.streaming"
	S.name = "UV Mapping Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "UV Mapping"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.uvmap.parameter_budget" }
	S.tags = { "e", "uvmap", "streamer", "material" }
	S.description = "UV Mapping Streaming: residency and demand-driven texture streaming for the UV Mapping subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.uvmap.streaming", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
