-- ARKHER SYSTEM VD.0409 :: Behaviour Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0409"
	S.key = "arkher.contsim.behaviourcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "behaviourcont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.behaviourcont.infinite_grid", cellSize = 64, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
