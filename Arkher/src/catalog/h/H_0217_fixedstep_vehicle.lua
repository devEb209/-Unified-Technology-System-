-- ARKHER SYSTEM H.0217 :: Fixed Timestep Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0217"
	S.key = "arkher.physics.fixedstep.vehicle"
	S.name = "Fixed Timestep Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.fixedstep.character_motion" }
	S.tags = { "h", "fixedstep", "vehicle", "physics" }
	S.description = "Fixed Timestep Vehicle: suspension, drivetrain, steering and tire friction for the Fixed Timestep subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.fixedstep.vehicle", mass = 1100, wheelbase = 2.20, track = 1.40, maxRpm = 5600 })
		inst.system = S
		inst.ctx = ctx
