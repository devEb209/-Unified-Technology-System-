-- ARKHER SYSTEM F.0531 :: Geometry Streaming Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0531"
	S.key = "arkher.render.geostream.orchestration"
	S.name = "Geometry Streaming Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.geostream.frame_analysis" }
	S.tags = { "f", "geostream", "orchestrator", "render" }
	S.description = "Geometry Streaming Orchestration: frame lifecycle orchestration for the Geometry Streaming subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.geostream.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
