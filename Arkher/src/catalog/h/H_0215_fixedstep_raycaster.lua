-- ARKHER SYSTEM H.0215 :: Fixed Timestep Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0215"
	S.key = "arkher.physics.fixedstep.query"
	S.name = "Fixed Timestep Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.fixedstep.constraint_solver" }
	S.tags = { "h", "fixedstep", "raycaster", "physics" }
	S.description = "Fixed Timestep Query: rays, sweeps and overlaps against the simulation for the Fixed Timestep subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.fixedstep.query", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
