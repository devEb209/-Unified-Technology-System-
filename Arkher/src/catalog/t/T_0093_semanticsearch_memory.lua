-- ARKHER SYSTEM T.0093 :: Semantic Search Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0093"
	S.key = "arkher.ai.semanticsearch.working_memory"
	S.name = "Semantic Search Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.semanticsearch.outcome_prediction" }
	S.tags = { "t", "semanticsearch", "memory", "ai" }
	S.description = "Semantic Search Working Memory: decaying, consolidating recall of what the agent learned for the Semantic Search subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.semanticsearch.working_memory", capacity = 111, decayRate = 0.065, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
