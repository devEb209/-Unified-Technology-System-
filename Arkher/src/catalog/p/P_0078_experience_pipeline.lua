-- ARKHER SYSTEM P.0078 :: Experience Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0078"
	S.key = "arkher.play.experience.rule_pipeline"
	S.name = "Experience Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Experience"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.experience.state_machine" }
	S.tags = { "p", "experience", "pipeline", "play" }
	S.description = "Experience Rule Pipeline: ordered rules applied to every gameplay event for the Experience subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.experience.rule_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
