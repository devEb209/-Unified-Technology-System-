-- ARKHER SYSTEM VD.0141 :: Fidelity Band Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0141"
	S.key = "arkher.contsim.fidelityband.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.fidelityband.world_memory_stream" }
	S.tags = { "vd", "fidelityband", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.fidelityband.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
