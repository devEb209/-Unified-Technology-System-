-- ARKHER SYSTEM VB.0600 :: Horizon Span Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0600"
	S.key = "arkher.conttime.horizonspan.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.horizonspan.reality_continuum" }
	S.tags = { "vb", "horizonspan", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.horizonspan.emergence_continuum", windowSize = 6, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
