-- ARKHER SYSTEM VA.0318 :: Ecology Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0318"
	S.key = "arkher.contworld.ecologycont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.ecologycont.persistent_state" }
	S.tags = { "va", "ecologycont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.ecologycont.coherence_guard", window = 136, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
