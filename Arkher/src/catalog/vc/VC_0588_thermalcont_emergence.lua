-- ARKHER SYSTEM VC.0588 :: Thermal Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0588"
	S.key = "arkher.contneural.thermalcont.emergence_continuum"
	S.name = "Thermal Continuum Emergence Continuum"
	S.category = "VC"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.thermalcont.reality_continuum" }
	S.tags = { "vc", "thermalcont", "emergence", "contneural" }
	S.description = "Thermal Continuum Emergence Continuum: emergence detection over the continuum for the Thermal Continuum subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.thermalcont.emergence_continuum", windowSize = 6, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
