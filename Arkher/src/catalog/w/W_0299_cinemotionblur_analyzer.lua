-- ARKHER SYSTEM W.0299 :: Motion Blur Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0299"
	S.key = "arkher.cine.cinemotionblur.sequence_analysis"
	S.name = "Motion Blur Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Motion Blur"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinemotionblur.frame_budget" }
	S.tags = { "w", "cinemotionblur", "analyzer", "cine" }
	S.description = "Motion Blur Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.cinemotionblur.sequence_analysis", window = 141, buckets = 9, threshold = 3.30 })
		inst.system = S
		inst.ctx = ctx
