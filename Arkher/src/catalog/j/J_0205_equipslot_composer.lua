-- ARKHER SYSTEM J.0205 :: Equipment Slot Appearance Composer
...
return function(A)
	...
	local S = {}
	S.id = "J.0205"
	S.key = "arkher.character.equipslot.appearance_composer"
	S.name = "Equipment Slot Appearance Composer"
	S.category = "J"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.equipslot.locomotion" }
	S.tags = { "j", "equipslot", "composer", "character" }
	S.description = "Equipment Slot Appearance Composer: composition of appearance slots into a look for the Equipment Slot subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.character.equipslot.appearance_composer", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
