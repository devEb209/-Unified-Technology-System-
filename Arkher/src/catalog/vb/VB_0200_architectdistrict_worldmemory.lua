-- ARKHER SYSTEM VB.0200 :: Architect District World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0200"
	S.key = "arkher.conttime.architectdistrict.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.architectdistrict.neural_field" }
	S.tags = { "vb", "architectdistrict", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.architectdistrict.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
