-- ARKHER SYSTEM T.0447 :: Player Modelling Learning Analysis
...
return function(A)
	...
	local S = {}
	S.id = "T.0447"
	S.key = "arkher.ai.playermodelling.learning_analysis"
	S.name = "Player Modelling Learning Analysis"
	S.category = "T"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.playermodelling.model_inference" }
	S.tags = { "t", "playermodelling", "analyzer", "ai" }
	S.description = "Player Modelling Learning Analysis: trend, anomaly and improvement analysis of the agent for the Player Modelling subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ai.playermodelling.learning_analysis", window = 143, buckets = 11, threshold = 3.50 })
		inst.system = S
		inst.ctx = ctx
