-- ARKHER SYSTEM O.0327 :: Engine Audio Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0327"
	S.key = "arkher.audio.engineaudio.spatialization"
	S.name = "Engine Audio Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Engine Audio"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.engineaudio.mixer_bus" }
	S.tags = { "o", "engineaudio", "spatialaudio", "audio" }
	S.description = "Engine Audio Spatialization: distance attenuation, panning, occlusion and doppler for the Engine Audio subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.engineaudio.spatialization", model = "inverse", refDistance = 6, maxDistance = 220, rolloff = 0.97, maxVoices = 24 })
		inst.system = S
		inst.ctx = ctx
