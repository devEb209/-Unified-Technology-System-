-- ARKHER SYSTEM P.0231 :: Quest Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0231"
	S.key = "arkher.play.questsys.objectives"
	S.name = "Quest Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Quest"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.questsys.inventory" }
	S.tags = { "p", "questsys", "quest", "play" }
	S.description = "Quest Objectives: objectives, prerequisites, progress and rewards for the Quest subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.questsys.objectives" })
		inst.system = S
		inst.ctx = ctx
