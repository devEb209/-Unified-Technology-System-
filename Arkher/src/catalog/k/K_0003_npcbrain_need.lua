-- ARKHER SYSTEM K.0003 :: NPC Brain Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0003"
	S.key = "arkher.npc.npcbrain.drive_system"
	S.name = "NPC Brain Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcbrain.memory" }
	S.tags = { "k", "npcbrain", "need", "npc" }
	S.description = "NPC Brain Drive System: drives that decay, turn urgent and get satisfied for the NPC Brain subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.npcbrain.drive_system" })
		inst.system = S
		inst.ctx = ctx
