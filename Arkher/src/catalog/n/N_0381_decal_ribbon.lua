-- ARKHER SYSTEM N.0381 :: Decal Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0381"
	S.key = "arkher.vfx.decal.ribbon_and_trail"
	S.name = "Decal Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Decal"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.decal.force_field" }
	S.tags = { "n", "decal", "ribbon", "vfx" }
	S.description = "Decal Ribbon And Trail: trail points, tapering, beams and decimation for the Decal subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.decal.ribbon_and_trail", maxPoints = 16, lifetime = 2.30, minDistance = 0.50, width = 0.80 })
		inst.system = S
		inst.ctx = ctx
