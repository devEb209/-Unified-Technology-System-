-- ARKHER SYSTEM Z.0225 :: Emergent Society Framework World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0225"
	S.key = "arkher.origin.emergentsociety.world_memory"
	S.name = "Emergent Society Framework World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentsociety.autonomous_pipeline" }
	S.tags = { "z", "emergentsociety", "worldmemory", "origin" }
	S.description = "Emergent Society Framework World Memory: epoch-stamped persistent history with compaction and checkpoints for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.emergentsociety.world_memory", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
