-- ARKHER SYSTEM P.0287 :: Combat Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0287"
	S.key = "arkher.play.combatsys.save_codec"
	S.name = "Combat Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Combat"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.combatsys.content_registry" }
	S.tags = { "p", "combatsys", "codec", "play" }
	S.description = "Combat Save Codec: persistence, diffing and checksum of gameplay state for the Combat subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.combatsys.save_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
