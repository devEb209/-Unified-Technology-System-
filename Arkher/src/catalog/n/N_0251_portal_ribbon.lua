-- ARKHER SYSTEM N.0251 :: Portal Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0251"
	S.key = "arkher.vfx.portal.ribbon_and_trail"
	S.name = "Portal Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Portal"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.portal.force_field" }
	S.tags = { "n", "portal", "ribbon", "vfx" }
	S.description = "Portal Ribbon And Trail: trail points, tapering, beams and decimation for the Portal subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.portal.ribbon_and_trail", maxPoints = 56, lifetime = 2.20, minDistance = 0.45, width = 0.70 })
		inst.system = S
		inst.ctx = ctx
