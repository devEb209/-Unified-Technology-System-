-- ARKHER SYSTEM N.0480 :: Distortion Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0480"
	S.key = "arkher.vfx.distortion.analysis"
	S.name = "Distortion Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Distortion"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.distortion.spatial_index" }
	S.tags = { "n", "distortion", "analyzer", "vfx" }
	S.description = "Distortion Analysis: cost, overdraw and stability analysis of the effect for the Distortion subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.distortion.analysis", window = 92, buckets = 8, threshold = 4.40 })
		inst.system = S
		inst.ctx = ctx
