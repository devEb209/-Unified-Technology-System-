-- ARKHER SYSTEM F.0475 :: Distance Culling Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0475"
	S.key = "arkher.render.distanceculling.orchestration"
	S.name = "Distance Culling Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.distanceculling.frame_analysis" }
	S.tags = { "f", "distanceculling", "orchestrator", "render" }
	S.description = "Distance Culling Orchestration: frame lifecycle orchestration for the Distance Culling subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.distanceculling.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
