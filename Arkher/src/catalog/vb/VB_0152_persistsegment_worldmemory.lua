-- ARKHER SYSTEM VB.0152 :: Persistence Segment World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0152"
	S.key = "arkher.conttime.persistsegment.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.persistsegment.neural_field" }
	S.tags = { "vb", "persistsegment", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.persistsegment.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
