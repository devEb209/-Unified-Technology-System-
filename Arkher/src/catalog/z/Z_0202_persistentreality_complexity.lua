-- ARKHER SYSTEM Z.0202 :: Persistent Reality State Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0202"
	S.key = "arkher.origin.persistentreality.complexity_governance"
	S.name = "Persistent Reality State Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.reality_layering" }
	S.tags = { "z", "persistentreality", "complexity", "origin" }
	S.description = "Persistent Reality State Complexity Governance: measured scene cost turned into per-subsystem directives for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.persistentreality.complexity_governance", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
