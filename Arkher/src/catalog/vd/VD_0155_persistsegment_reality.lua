-- ARKHER SYSTEM VD.0155 :: Persistence Segment Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0155"
	S.key = "arkher.contsim.persistsegment.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.persistsegment.simulation_fabric" }
	S.tags = { "vd", "persistsegment", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.persistsegment.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
