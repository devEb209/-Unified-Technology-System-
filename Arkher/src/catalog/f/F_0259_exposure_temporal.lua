-- ARKHER SYSTEM F.0259 :: Exposure Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0259"
	S.key = "arkher.render.exposure.temporal_resolve"
	S.name = "Exposure Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Exposure"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.exposure.probe_volume" }
	S.tags = { "f", "exposure", "temporal", "render" }
	S.description = "Exposure Temporal Resolve: history reprojection with neighbourhood clamping for the Exposure subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.exposure.temporal_resolve", feedback = 0.91, phase = 8 })
		inst.system = S
		inst.ctx = ctx
