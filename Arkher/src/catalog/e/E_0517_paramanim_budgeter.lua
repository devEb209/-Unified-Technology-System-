-- ARKHER SYSTEM E.0517 :: Parameter Animation Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0517"
	S.key = "arkher.material.paramanim.parameter_budget"
	S.name = "Parameter Animation Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.paramanim.variant_registry" }
	S.tags = { "e", "paramanim", "budgeter", "material" }
	S.description = "Parameter Animation Parameter Budget: texel and layer budget allocation for the Parameter Animation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.paramanim.parameter_budget", total = 162, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
