-- ARKHER SYSTEM Q.0169 :: Head Up Display Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0169"
	S.key = "arkher.ui.hud.responsive_layout"
	S.name = "Head Up Display Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "hud", "flex", "ui" }
	S.description = "Head Up Display Responsive Layout: flex solving with safe areas, weights and breakpoints for the Head Up Display subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.hud.responsive_layout", width = 390, height = 964, scale = 0.97 })
		inst.system = S
		inst.ctx = ctx
