-- ARKHER SYSTEM W.0398 :: Cinematic Debug Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0398"
	S.key = "arkher.cine.cinedebug.camera_rig"
	S.name = "Cinematic Debug Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinedebug.sequence_timeline" }
	S.tags = { "w", "cinedebug", "camerarig", "cine" }
	S.description = "Cinematic Debug Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Cinematic Debug subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.cinedebug.camera_rig", fov = 0.99, focus = 9.0, aperture = 5.9, smoothing = 11.0, distance = 11, height = 5 })
		inst.system = S
		inst.ctx = ctx
