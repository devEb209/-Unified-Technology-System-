-- ARKHER SYSTEM P.0010 :: Player Character Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0010"
	S.key = "arkher.play.playercharacter.content_registry"
	S.name = "Player Character Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.playercharacter.difficulty_controller" }
	S.tags = { "p", "playercharacter", "registry", "play" }
	S.description = "Player Character Content Registry: catalogue of the definitions this loop instantiates for the Player Character subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.playercharacter.content_registry" })
		inst.system = S
		inst.ctx = ctx
