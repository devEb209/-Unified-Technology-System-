-- ARKHER SYSTEM G.0005 :: Neural Upscaling Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0005"
	S.key = "arkher.neural.neuralupscale.model_registry"
	S.name = "Neural Upscaling Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuralupscale.reconstruction" }
	S.tags = { "g", "neuralupscale", "registry", "neural" }
	S.description = "Neural Upscaling Model Registry: named models and their lifecycle for the Neural Upscaling subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.neuralupscale.model_registry" })
		inst.system = S
		inst.ctx = ctx
