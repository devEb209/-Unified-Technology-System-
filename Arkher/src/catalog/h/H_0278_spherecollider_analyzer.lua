-- ARKHER SYSTEM H.0278 :: Sphere Collider Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0278"
	S.key = "arkher.physics.spherecollider.analysis"
	S.name = "Sphere Collider Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.spherecollider.result_cache" }
	S.tags = { "h", "spherecollider", "analyzer", "physics" }
	S.description = "Sphere Collider Analysis: energy, jitter and cost analysis of the simulation for the Sphere Collider subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.spherecollider.analysis", window = 56, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
