-- ARKHER SYSTEM L.0159 :: Agriculture State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0159"
	S.key = "arkher.sim.agriculture.state_codec"
	S.name = "Agriculture State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.agriculture.history_ledger" }
	S.tags = { "l", "agriculture", "codec", "sim" }
	S.description = "Agriculture State Codec: persistence, diffing and checksum of the world state for the Agriculture subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.agriculture.state_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
