-- ARKHER SYSTEM H.0442 :: Penetration Recovery Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0442"
	S.key = "arkher.physics.penetration.broadphase_index"
	S.name = "Penetration Recovery Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.penetration.vehicle" }
	S.tags = { "h", "penetration", "index", "physics" }
	S.description = "Penetration Recovery Broadphase Index: spatial acceleration of candidate pair finding for the Penetration Recovery subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.penetration.broadphase_index", mode = "hash", cellSize = 48 })
		inst.system = S
		inst.ctx = ctx
