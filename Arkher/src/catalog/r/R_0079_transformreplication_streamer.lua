-- ARKHER SYSTEM R.0079 :: Transform Replication Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0079"
	S.key = "arkher.net.transformreplication.interest_streaming"
	S.name = "Transform Replication Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.transformreplication.serialization_codec" }
	S.tags = { "r", "transformreplication", "streamer", "net" }
	S.description = "Transform Replication Interest Streaming: distance-driven residency of replicated content for the Transform Replication subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.transformreplication.interest_streaming", radius = 440, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
