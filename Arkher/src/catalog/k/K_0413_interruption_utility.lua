-- ARKHER SYSTEM K.0413 :: Interruption Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0413"
	S.key = "arkher.npc.interruption.utility_reasoning"
	S.name = "Interruption Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.interruption.reactive_behaviour" }
	S.tags = { "k", "interruption", "utility", "npc" }
	S.description = "Interruption Utility Reasoning: scored option selection with response curves for the Interruption subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.interruption.utility_reasoning", momentum = 0.08 })
		inst.system = S
		inst.ctx = ctx
