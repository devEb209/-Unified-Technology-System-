-- ARKHER SYSTEM Z.0063 :: Reality Layer Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0063"
	S.key = "arkher.origin.realitylayer.simulation_fabric"
	S.name = "Reality Layer Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realitylayer.complexity_governance" }
	S.tags = { "z", "realitylayer", "fabric", "origin" }
	S.description = "Reality Layer Simulation Fabric: every simulation domain stepped under one budgeted clock for the Reality Layer subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.realitylayer.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
