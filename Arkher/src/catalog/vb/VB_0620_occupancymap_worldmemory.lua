-- ARKHER SYSTEM VB.0620 :: Occupancy Map World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0620"
	S.key = "arkher.conttime.occupancymap.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.occupancymap.neural_field" }
	S.tags = { "vb", "occupancymap", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.occupancymap.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
