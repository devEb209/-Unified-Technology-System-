-- ARKHER SYSTEM F.0150 :: Light Clustering Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0150"
	S.key = "arkher.render.lightcluster.render_policy"
	S.name = "Light Clustering Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.lightcluster.draw_budget" }
	S.tags = { "f", "lightcluster", "policy", "render" }
	S.description = "Light Clustering Render Policy: device tier rules for the frame for the Light Clustering subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.lightcluster.render_policy", algorithm = "edf", starvationGuard = 29 })
		inst.system = S
		inst.ctx = ctx
