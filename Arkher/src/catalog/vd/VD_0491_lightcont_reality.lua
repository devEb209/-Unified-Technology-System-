-- ARKHER SYSTEM VD.0491 :: Lighting Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0491"
	S.key = "arkher.contsim.lightcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lightcont.simulation_fabric" }
	S.tags = { "vd", "lightcont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.lightcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
