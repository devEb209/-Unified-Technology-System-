-- ARKHER SYSTEM V.0198 :: Terrain Asset Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0198"
	S.key = "arkher.asset.terrainasset.content_cache"
	S.name = "Terrain Asset Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.terrainasset.dependency_graph" }
	S.tags = { "v", "terrainasset", "cache", "asset" }
	S.description = "Terrain Asset Content Cache: reuse of already cooked results for the Terrain Asset subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.terrainasset.content_cache", policy = "ttl", capacity = 501, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
