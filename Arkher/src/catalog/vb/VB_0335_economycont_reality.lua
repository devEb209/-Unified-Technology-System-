-- ARKHER SYSTEM VB.0335 :: Economy Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0335"
	S.key = "arkher.conttime.economycont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.economycont.simulation_fabric" }
	S.tags = { "vb", "economycont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.economycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
