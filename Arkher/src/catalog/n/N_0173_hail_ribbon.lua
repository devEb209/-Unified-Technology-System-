-- ARKHER SYSTEM N.0173 :: Hail Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0173"
	S.key = "arkher.vfx.hail.ribbon_and_trail"
	S.name = "Hail Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Hail"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.hail.force_field" }
	S.tags = { "n", "hail", "ribbon", "vfx" }
	S.description = "Hail Ribbon And Trail: trail points, tapering, beams and decimation for the Hail subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.hail.ribbon_and_trail", maxPoints = 16, lifetime = 0.70, minDistance = 0.20, width = 0.80 })
		inst.system = S
		inst.ctx = ctx
