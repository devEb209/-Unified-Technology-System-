-- ARKHER SYSTEM F.0646 :: Mobile Fast Path View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0646"
	S.key = "arkher.render.mobilepath.view_and_culling"
	S.name = "Mobile Fast Path View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.mobilepath.frame_graph" }
	S.tags = { "f", "mobilepath", "camera", "render" }
	S.description = "Mobile Fast Path View And Culling: view state, frustum culling and screen-size LOD for the Mobile Fast Path subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.mobilepath.view_and_culling", width = 956, height = 1260, fov = 1.0100, far = 1800 })
		inst.system = S
		inst.ctx = ctx
