-- ARKHER SYSTEM O.0270 :: Stinger Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0270"
	S.key = "arkher.audio.stinger.streaming"
	S.name = "Stinger Streaming"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Stinger"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.stinger.voice_budget" }
	S.tags = { "o", "stinger", "streamer", "audio" }
	S.description = "Stinger Streaming: distance-driven residency of audio assets for the Stinger subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.stinger.streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
