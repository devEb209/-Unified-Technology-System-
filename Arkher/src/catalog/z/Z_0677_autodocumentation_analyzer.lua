-- ARKHER SYSTEM Z.0677 :: Auto Documentation Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0677"
	S.key = "arkher.origin.autodocumentation.behaviour_analysis"
	S.name = "Auto Documentation Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.governance_policy" }
	S.tags = { "z", "autodocumentation", "analyzer", "origin" }
	S.description = "Auto Documentation Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.autodocumentation.behaviour_analysis", window = 60, buckets = 12, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
