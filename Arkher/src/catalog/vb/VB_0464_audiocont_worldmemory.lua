-- ARKHER SYSTEM VB.0464 :: Audio Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0464"
	S.key = "arkher.conttime.audiocont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.audiocont.neural_field" }
	S.tags = { "vb", "audiocont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.audiocont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
