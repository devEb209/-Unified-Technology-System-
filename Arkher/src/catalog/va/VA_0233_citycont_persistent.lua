-- ARKHER SYSTEM VA.0233 :: City Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0233"
	S.key = "arkher.contworld.citycont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.citycont.multi-scale_fidelity" }
	S.tags = { "va", "citycont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.citycont.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
