-- ARKHER SYSTEM W.0211 :: Montage Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0211"
	S.key = "arkher.cine.montage.motion_tween"
	S.name = "Montage Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Montage"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.montage.playback_orchestrator" }
	S.tags = { "w", "montage", "tween", "cine" }
	S.description = "Montage Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Montage subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.montage.motion_tween", timeScale = 0.90 })
		inst.system = S
		inst.ctx = ctx
