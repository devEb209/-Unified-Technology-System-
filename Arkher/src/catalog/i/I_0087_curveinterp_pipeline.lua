-- ARKHER SYSTEM I.0087 :: Curve Interpolation Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0087"
	S.key = "arkher.anim.curveinterp.playback_pipeline"
	S.name = "Curve Interpolation Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.curveinterp.event_ledger" }
	S.tags = { "i", "curveinterp", "pipeline", "anim" }
	S.description = "Curve Interpolation Playback Pipeline: ordered sample, blend, ik and output stages for the Curve Interpolation subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.curveinterp.playback_pipeline", budgetMs = 2.00 })
		inst.system = S
		inst.ctx = ctx
