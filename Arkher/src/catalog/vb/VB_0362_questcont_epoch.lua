-- ARKHER SYSTEM VB.0362 :: Quest Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0362"
	S.key = "arkher.conttime.questcont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.questcont.infinite_grid" }
	S.tags = { "vb", "questcont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.questcont.epoch_clock", tickRate = 20, budget = 9, capacity = 224 })
		inst.system = S
		inst.ctx = ctx
