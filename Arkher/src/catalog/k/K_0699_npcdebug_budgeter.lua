-- ARKHER SYSTEM K.0699 :: NPC Debug Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0699"
	S.key = "arkher.npc.npcdebug.thinking_budget"
	S.name = "NPC Debug Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcdebug.daily_schedule" }
	S.tags = { "k", "npcdebug", "budgeter", "npc" }
	S.description = "NPC Debug Thinking Budget: allocation of per-frame thinking time across NPCs for the NPC Debug subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.npcdebug.thinking_budget", total = 346, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
