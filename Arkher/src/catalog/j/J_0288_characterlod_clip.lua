-- ARKHER SYSTEM J.0288 :: Character LOD Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0288"
	S.key = "arkher.character.characterlod.motion_set"
	S.name = "Character LOD Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterlod.rig_definition" }
	S.tags = { "j", "characterlod", "clip", "character" }
	S.description = "Character LOD Motion Set: the clips a character owns and how they sample for the Character LOD subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.characterlod.motion_set", duration = 1.80, loop = false })
		inst.system = S
		inst.ctx = ctx
