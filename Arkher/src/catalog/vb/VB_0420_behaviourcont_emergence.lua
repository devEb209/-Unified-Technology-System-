-- ARKHER SYSTEM VB.0420 :: Behaviour Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0420"
	S.key = "arkher.conttime.behaviourcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.behaviourcont.reality_continuum" }
	S.tags = { "vb", "behaviourcont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.behaviourcont.emergence_continuum", windowSize = 6, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
