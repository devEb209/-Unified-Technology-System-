-- ARKHER SYSTEM P.0121 :: Loot Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0121"
	S.key = "arkher.play.loot.attributes"
	S.name = "Loot Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Loot"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "loot", "stats", "play" }
	S.description = "Loot Attributes: base values, layered modifiers and derived statistics for the Loot subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.loot.attributes" })
		inst.system = S
		inst.ctx = ctx
