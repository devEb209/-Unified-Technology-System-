-- ARKHER SYSTEM VA.0487 :: Lighting Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0487"
	S.key = "arkher.contworld.lightcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lightcont.coherence_guard" }
	S.tags = { "va", "lightcont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.lightcont.neural_field", dims = 24, hidden = 20, seed = 91243 })
		inst.system = S
		inst.ctx = ctx
