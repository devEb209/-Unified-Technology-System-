-- ARKHER SYSTEM K.0369 :: Utility Selection Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0369"
	S.key = "arkher.npc.utilityselection.perception"
	S.name = "Utility Selection Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.utilityselection.emotion" }
	S.tags = { "k", "utilityselection", "perception", "npc" }
	S.description = "Utility Selection Perception: sight, hearing and bounded attention for the Utility Selection subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.utilityselection.perception", sightRange = 30, hearingRange = 24, attentionSlots = 4, fov = 1.770 })
		inst.system = S
		inst.ctx = ctx
