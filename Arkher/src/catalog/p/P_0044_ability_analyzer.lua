-- ARKHER SYSTEM P.0044 :: Ability Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0044"
	S.key = "arkher.play.ability.balance_analysis"
	S.name = "Ability Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ability"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ability.event_ledger" }
	S.tags = { "p", "ability", "analyzer", "play" }
	S.description = "Ability Balance Analysis: distribution, outlier and pacing analysis for the Ability subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.ability.balance_analysis", window = 116, buckets = 8, threshold = 3.80 })
		inst.system = S
		inst.ctx = ctx
