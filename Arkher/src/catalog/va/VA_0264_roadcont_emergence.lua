-- ARKHER SYSTEM VA.0264 :: Road Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0264"
	S.key = "arkher.contworld.roadcont.emergence_continuum"
	S.name = "Road Continuum Emergence Continuum"
	S.category = "VA"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.roadcont.reality_continuum" }
	S.tags = { "va", "roadcont", "emergence", "contworld" }
	S.description = "Road Continuum Emergence Continuum: emergence detection over the continuum for the Road Continuum subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.roadcont.emergence_continuum", windowSize = 5, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
