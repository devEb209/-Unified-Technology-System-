-- ARKHER SYSTEM G.0086 :: Ghosting Suppression Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0086"
	S.key = "arkher.neural.ghosting.feature_extraction"
	S.name = "Ghosting Suppression Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ghosting.inference_core" }
	S.tags = { "g", "ghosting", "field", "neural" }
	S.description = "Ghosting Suppression Feature Extraction: signal features feeding the model for the Ghosting Suppression subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.ghosting.feature_extraction", seed = 24511, frequency = 0.0118, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
