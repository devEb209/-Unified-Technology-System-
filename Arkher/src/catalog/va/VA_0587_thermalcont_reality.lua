-- ARKHER SYSTEM VA.0587 :: Thermal Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0587"
	S.key = "arkher.contworld.thermalcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.thermalcont.simulation_fabric" }
	S.tags = { "va", "thermalcont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.thermalcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
