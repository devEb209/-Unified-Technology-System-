-- ARKHER SYSTEM VA.0237 :: City Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0237"
	S.key = "arkher.contworld.citycont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.citycont.world_memory_stream" }
	S.tags = { "va", "citycont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.citycont.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
