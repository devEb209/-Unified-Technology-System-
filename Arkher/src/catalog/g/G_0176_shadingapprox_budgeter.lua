-- ARKHER SYSTEM G.0176 :: Shading Approximation Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0176"
	S.key = "arkher.neural.shadingapprox.compute_budget"
	S.name = "Shading Approximation Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.shadingapprox.quality_predictor" }
	S.tags = { "g", "shadingapprox", "budgeter", "neural" }
	S.description = "Shading Approximation Compute Budget: inference time budget allocation for the Shading Approximation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.shadingapprox.compute_budget", total = 408, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
