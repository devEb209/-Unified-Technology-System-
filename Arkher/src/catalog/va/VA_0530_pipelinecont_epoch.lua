-- ARKHER SYSTEM VA.0530 :: Pipeline Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0530"
	S.key = "arkher.contworld.pipelinecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.pipelinecont.infinite_grid" }
	S.tags = { "va", "pipelinecont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.pipelinecont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
