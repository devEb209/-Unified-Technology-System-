-- ARKHER SYSTEM Z.0744 :: World Compression Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0744"
	S.key = "arkher.origin.worldcompression.autonomous_pipeline"
	S.name = "World Compression Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldcompression.simulation_fabric" }
	S.tags = { "z", "worldcompression", "autopipeline", "origin" }
	S.description = "World Compression Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the World Compression subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.worldcompression.autonomous_pipeline", maxIterations = 6 })
		inst.system = S
		inst.ctx = ctx
