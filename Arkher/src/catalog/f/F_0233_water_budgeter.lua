-- ARKHER SYSTEM F.0233 :: Water Rendering Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0233"
	S.key = "arkher.render.water.draw_budget"
	S.name = "Water Rendering Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.water.adaptive_resolution" }
	S.tags = { "f", "water", "budgeter", "render" }
	S.description = "Water Rendering Draw Budget: draw call and triangle budget allocation for the Water Rendering subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.water.draw_budget", total = 284, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
