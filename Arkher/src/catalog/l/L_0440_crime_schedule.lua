-- ARKHER SYSTEM L.0440 :: Crime Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0440"
	S.key = "arkher.sim.crime.calendar"
	S.name = "Crime Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.crime.society" }
	S.tags = { "l", "crime", "schedule", "sim" }
	S.description = "Crime Calendar: hours, days and seasons driving the region for the Crime subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.crime.calendar", startHour = 6 })
		inst.system = S
		inst.ctx = ctx
