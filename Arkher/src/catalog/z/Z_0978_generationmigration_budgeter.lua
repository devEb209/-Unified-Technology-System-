-- ARKHER SYSTEM Z.0978 :: Generation Migration Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0978"
	S.key = "arkher.origin.generationmigration.budget_governor"
	S.name = "Generation Migration Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.generationmigration.behaviour_analysis" }
	S.tags = { "z", "generationmigration", "budgeter", "origin" }
	S.description = "Generation Migration Budget Governor: allocation of a scarce resource across the technology's consumers for the Generation Migration subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.generationmigration.budget_governor", total = 240, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
