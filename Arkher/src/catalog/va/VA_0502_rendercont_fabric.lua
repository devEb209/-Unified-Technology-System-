-- ARKHER SYSTEM VA.0502 :: Rendering Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0502"
	S.key = "arkher.contworld.rendercont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.rendercont.complexity_budget" }
	S.tags = { "va", "rendercont", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.rendercont.simulation_fabric", budgetMs = 3.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
