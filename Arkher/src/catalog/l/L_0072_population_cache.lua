-- ARKHER SYSTEM L.0072 :: Population Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0072"
	S.key = "arkher.sim.population.aggregate_cache"
	S.name = "Population Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.population.fidelity_policy" }
	S.tags = { "l", "population", "cache", "sim" }
	S.description = "Population Aggregate Cache: reuse of expensive aggregate computations for the Population subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.population.aggregate_cache", policy = "lru", capacity = 81, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
