-- ARKHER SYSTEM P.0458 :: Tutorial Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0458"
	S.key = "arkher.play.tutorial.inventory"
	S.name = "Tutorial Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Tutorial"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.tutorial.attributes" }
	S.tags = { "p", "tutorial", "inventory", "play" }
	S.description = "Tutorial Inventory: slots, stacking, weight, equipment and crafting for the Tutorial subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.tutorial.inventory", slots = 40, maxWeight = 150 })
		inst.system = S
		inst.ctx = ctx
