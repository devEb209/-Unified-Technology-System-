-- ARKHER SYSTEM I.0166 :: Additive Layer Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0166"
	S.key = "arkher.anim.additivelayer.pose_cache"
	S.name = "Additive Layer Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.additivelayer.playback_pipeline" }
	S.tags = { "i", "additivelayer", "cache", "anim" }
	S.description = "Additive Layer Pose Cache: reuse of sampled poses across frames and instances for the Additive Layer subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.additivelayer.pose_cache", policy = "lfu", capacity = 192, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
