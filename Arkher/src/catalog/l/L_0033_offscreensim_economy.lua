-- ARKHER SYSTEM L.0033 :: Offscreen Simulation Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0033"
	S.key = "arkher.sim.offscreensim.economy"
	S.name = "Offscreen Simulation Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.offscreensim.ecology" }
	S.tags = { "l", "offscreensim", "economy", "sim" }
	S.description = "Offscreen Simulation Economy: stock, production, demand, price discovery and trade for the Offscreen Simulation subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.offscreensim.economy", elasticity = 0.34 })
		inst.system = S
		inst.ctx = ctx
