-- ARKHER SYSTEM G.0160 :: Geometry Detail Prediction Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0160"
	S.key = "arkher.neural.geodetail.weight_codec"
	S.name = "Geometry Detail Prediction Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.geodetail.model_registry" }
	S.tags = { "g", "geodetail", "codec", "neural" }
	S.description = "Geometry Detail Prediction Weight Codec: weight serialization and quantized transport for the Geometry Detail Prediction subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.geodetail.weight_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
