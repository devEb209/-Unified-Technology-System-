-- ARKHER SYSTEM H.0030 :: Kinematic Body Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0030"
	S.key = "arkher.physics.kinematicbody.collision_shape"
	S.name = "Kinematic Body Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.kinematicbody.body_dynamics" }
	S.tags = { "h", "kinematicbody", "collider", "physics" }
	S.description = "Kinematic Body Collision Shape: shape bounds, support mapping and closest points for the Kinematic Body subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.kinematicbody.collision_shape", shape = "sphere", radius = 1.00, height = 1.80, layer = "character" })
		inst.system = S
		inst.ctx = ctx
