-- ARKHER SYSTEM F.0330 :: Motion Blur Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0330"
	S.key = "arkher.render.motionblur.adaptive_resolution"
	S.name = "Motion Blur Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Motion Blur"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.motionblur.temporal_resolve" }
	S.tags = { "f", "motionblur", "upscaler", "render" }
	S.description = "Motion Blur Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Motion Blur subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.motionblur.adaptive_resolution", targetMs = 14.10, index = 3, sharpness = 0.45 })
		inst.system = S
		inst.ctx = ctx
