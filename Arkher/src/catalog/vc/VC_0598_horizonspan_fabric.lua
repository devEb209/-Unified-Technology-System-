-- ARKHER SYSTEM VC.0598 :: Horizon Span Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0598"
	S.key = "arkher.contneural.horizonspan.simulation_fabric"
	S.name = "Horizon Span Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.horizonspan.complexity_budget" }
	S.tags = { "vc", "horizonspan", "fabric", "contneural" }
	S.description = "Horizon Span Simulation Fabric: fabric stepping the continuum domains for the Horizon Span subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.horizonspan.simulation_fabric", budgetMs = 2.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
