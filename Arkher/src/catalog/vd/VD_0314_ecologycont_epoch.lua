-- ARKHER SYSTEM VD.0314 :: Ecology Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0314"
	S.key = "arkher.contsim.ecologycont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.ecologycont.infinite_grid" }
	S.tags = { "vd", "ecologycont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.ecologycont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
