-- ARKHER SYSTEM G.0157 :: Geometry Detail Prediction Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0157"
	S.key = "arkher.neural.geodetail.temporal_history"
	S.name = "Geometry Detail Prediction Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.geodetail.feature_extraction" }
	S.tags = { "g", "geodetail", "temporal", "neural" }
	S.description = "Geometry Detail Prediction Temporal History: history buffers reused across frames for the Geometry Detail Prediction subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.geodetail.temporal_history", feedback = 0.84, phase = 8 })
		inst.system = S
		inst.ctx = ctx
