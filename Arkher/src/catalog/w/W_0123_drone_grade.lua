-- ARKHER SYSTEM W.0123 :: Drone Shot Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0123"
	S.key = "arkher.cine.drone.colour_grade"
	S.name = "Drone Shot Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Drone Shot"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.drone.camera_rig" }
	S.tags = { "w", "drone", "grade", "cine" }
	S.description = "Drone Shot Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Drone Shot subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.drone.colour_grade", exposure = -0.01, contrast = 1.04, saturation = 1.19, toneMap = "filmic" })
		inst.system = S
		inst.ctx = ctx
