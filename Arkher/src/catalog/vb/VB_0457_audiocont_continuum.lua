-- ARKHER SYSTEM VB.0457 :: Audio Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0457"
	S.key = "arkher.conttime.audiocont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "audiocont", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.audiocont.infinite_grid", cellSize = 160, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
