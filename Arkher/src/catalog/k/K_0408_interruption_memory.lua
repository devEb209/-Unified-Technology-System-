-- ARKHER SYSTEM K.0408 :: Interruption Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0408"
	S.key = "arkher.npc.interruption.memory"
	S.name = "Interruption Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.interruption.mind_network" }
	S.tags = { "k", "interruption", "memory", "npc" }
	S.description = "Interruption Memory: episodic memory with decay, recall and consolidation for the Interruption subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.interruption.memory", capacity = 127, decayRate = 0.055, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
