-- ARKHER SYSTEM Z.0491 :: Cultural Evolution Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0491"
	S.key = "arkher.origin.culturalevolution.adaptive_workflow"
	S.name = "Cultural Evolution Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.culturalevolution.self_critique" }
	S.tags = { "z", "culturalevolution", "workflow", "origin" }
	S.description = "Cultural Evolution Adaptive Workflow: verified, retryable, reversible execution plans for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.culturalevolution.adaptive_workflow", maxRetries = 2, budget = 50 })
		inst.system = S
		inst.ctx = ctx
