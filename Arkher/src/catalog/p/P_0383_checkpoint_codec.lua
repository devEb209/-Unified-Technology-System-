-- ARKHER SYSTEM P.0383 :: Checkpoint Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0383"
	S.key = "arkher.play.checkpoint.save_codec"
	S.name = "Checkpoint Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Checkpoint"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.checkpoint.content_registry" }
	S.tags = { "p", "checkpoint", "codec", "play" }
	S.description = "Checkpoint Save Codec: persistence, diffing and checksum of gameplay state for the Checkpoint subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.checkpoint.save_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
