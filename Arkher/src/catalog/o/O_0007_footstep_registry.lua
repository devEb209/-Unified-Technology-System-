-- ARKHER SYSTEM O.0007 :: Footstep Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0007"
	S.key = "arkher.audio.footstep.asset_registry"
	S.name = "Footstep Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Footstep"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.footstep.streaming" }
	S.tags = { "o", "footstep", "registry", "audio" }
	S.description = "Footstep Asset Registry: catalogue of sounds, variations and metadata for the Footstep subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.footstep.asset_registry" })
		inst.system = S
		inst.ctx = ctx
