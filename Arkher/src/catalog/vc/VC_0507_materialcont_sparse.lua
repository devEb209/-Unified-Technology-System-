-- ARKHER SYSTEM VC.0507 :: Material Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0507"
	S.key = "arkher.contneural.materialcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.materialcont.epoch_clock" }
	S.tags = { "vc", "materialcont", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.materialcont.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
