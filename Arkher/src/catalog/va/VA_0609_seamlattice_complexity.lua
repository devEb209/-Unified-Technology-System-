-- ARKHER SYSTEM VA.0609 :: Seam Lattice Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0609"
	S.key = "arkher.contworld.seamlattice.complexity_budget"
	S.name = "Seam Lattice Complexity Budget"
	S.category = "VA"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.seamlattice.world_memory_stream" }
	S.tags = { "va", "seamlattice", "complexity", "contworld" }
	S.description = "Seam Lattice Complexity Budget: complexity budgeting for the continuum for the Seam Lattice subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.seamlattice.complexity_budget", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
