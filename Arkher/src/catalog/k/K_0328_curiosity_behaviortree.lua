-- ARKHER SYSTEM K.0328 :: Curiosity Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0328"
	S.key = "arkher.npc.curiosity.reactive_behaviour"
	S.name = "Curiosity Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.curiosity.perception" }
	S.tags = { "k", "curiosity", "behaviortree", "npc" }
	S.description = "Curiosity Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Curiosity subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.curiosity.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
