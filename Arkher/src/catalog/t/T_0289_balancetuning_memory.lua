-- ARKHER SYSTEM T.0289 :: Balance Tuning Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0289"
	S.key = "arkher.ai.balancetuning.working_memory"
	S.name = "Balance Tuning Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.balancetuning.outcome_prediction" }
	S.tags = { "t", "balancetuning", "memory", "ai" }
	S.description = "Balance Tuning Working Memory: decaying, consolidating recall of what the agent learned for the Balance Tuning subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.balancetuning.working_memory", capacity = 101, decayRate = 0.035, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
