-- ARKHER SYSTEM Z.0665 :: Auto Documentation World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0665"
	S.key = "arkher.origin.autodocumentation.world_memory"
	S.name = "Auto Documentation World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.autonomous_pipeline" }
	S.tags = { "z", "autodocumentation", "worldmemory", "origin" }
	S.description = "Auto Documentation World Memory: epoch-stamped persistent history with compaction and checkpoints for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.autodocumentation.world_memory", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
