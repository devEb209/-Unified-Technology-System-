-- ARKHER SYSTEM W.0055 :: Close Up Motion Tween
...
return function(A)
	...
	local S = {}
	S.id = "W.0055"
	S.key = "arkher.cine.closeup.motion_tween"
	S.name = "Close Up Motion Tween"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Close Up"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.closeup.playback_orchestrator" }
	S.tags = { "w", "closeup", "tween", "cine" }
	S.description = "Close Up Motion Tween: eased, delayed and sequenced motion of cinematic properties for the Close Up subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.cine.closeup.motion_tween", timeScale = 0.92 })
		inst.system = S
		inst.ctx = ctx
