-- ARKHER SYSTEM N.0489 :: Glow Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0489"
	S.key = "arkher.vfx.glow.spawn_budget"
	S.name = "Glow Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Glow"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.glow.effect_composition" }
	S.tags = { "n", "glow", "budgeter", "vfx" }
	S.description = "Glow Spawn Budget: global particle budget shared by every live effect for the Glow subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.glow.spawn_budget", total = 168, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
