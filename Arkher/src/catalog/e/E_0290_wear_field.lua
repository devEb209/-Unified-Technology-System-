-- ARKHER SYSTEM E.0290 :: Wear And Tear Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0290"
	S.key = "arkher.material.wear.procedural_detail"
	S.name = "Wear And Tear Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Wear And Tear"
	S.aspect = "Procedural Detail"
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.wear.texture_sampling" }
	S.tags = { "e", "wear", "field", "material" }
	S.description = "Wear And Tear Procedural Detail: coherent noise detail driving the surface for the Wear And Tear subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.wear.procedural_detail", seed = 83252, frequency = 0.0070, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
		...
		function inst.integrate(engine)
			...
			inst.engine = engine
			if engine.bus then
				engine.bus:subscribe("arkher.material.wear.*", function(payload) inst.lastSignal = payload end)
			end
