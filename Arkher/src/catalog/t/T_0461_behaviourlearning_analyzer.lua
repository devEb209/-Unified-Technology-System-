-- ARKHER SYSTEM T.0461 :: Behaviour Learning Learning Analysis
...
return function(A)
	...
	local S = {}
	S.id = "T.0461"
	S.key = "arkher.ai.behaviourlearning.learning_analysis"
	S.name = "Behaviour Learning Learning Analysis"
	S.category = "T"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.behaviourlearning.model_inference" }
	S.tags = { "t", "behaviourlearning", "analyzer", "ai" }
	S.description = "Behaviour Learning Learning Analysis: trend, anomaly and improvement analysis of the agent for the Behaviour Learning subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ai.behaviourlearning.learning_analysis", window = 54, buckets = 14, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
