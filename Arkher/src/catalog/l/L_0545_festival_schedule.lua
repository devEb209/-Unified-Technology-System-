-- ARKHER SYSTEM L.0545 :: Festival Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0545"
	S.key = "arkher.sim.festival.calendar"
	S.name = "Festival Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.festival.society" }
	S.tags = { "l", "festival", "schedule", "sim" }
	S.description = "Festival Calendar: hours, days and seasons driving the region for the Festival subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.festival.calendar", startHour = 8 })
		inst.system = S
		inst.ctx = ctx
