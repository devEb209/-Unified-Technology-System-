-- ARKHER SYSTEM VA.0163 :: Coherence Seam Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0163"
	S.key = "arkher.contworld.coherenceseam.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.coherenceseam.coherence_guard" }
	S.tags = { "va", "coherenceseam", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.coherenceseam.neural_field", dims = 12, hidden = 8, seed = 21096 })
		inst.system = S
		inst.ctx = ctx
