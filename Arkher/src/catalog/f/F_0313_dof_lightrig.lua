-- ARKHER SYSTEM F.0313 :: Depth Of Field Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0313"
	S.key = "arkher.render.dof.lighting_rig"
	S.name = "Depth Of Field Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.dof.geometry_virtualization" }
	S.tags = { "f", "dof", "lightrig", "render" }
	S.description = "Depth Of Field Lighting Rig: light clustering, importance and cascades for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.dof.lighting_rig", maxActive = 9 })
		inst.system = S
		inst.ctx = ctx
