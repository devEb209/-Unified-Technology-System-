-- ARKHER SYSTEM VB.0189 :: Simulation Domain Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0189"
	S.key = "arkher.conttime.simdomain.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.simdomain.world_memory_stream" }
	S.tags = { "vb", "simdomain", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.simdomain.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
