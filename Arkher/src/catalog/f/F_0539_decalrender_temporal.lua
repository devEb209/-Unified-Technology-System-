-- ARKHER SYSTEM F.0539 :: Decal Rendering Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0539"
	S.key = "arkher.render.decalrender.temporal_resolve"
	S.name = "Decal Rendering Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.decalrender.probe_volume" }
	S.tags = { "f", "decalrender", "temporal", "render" }
	S.description = "Decal Rendering Temporal Resolve: history reprojection with neighbourhood clamping for the Decal Rendering subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.decalrender.temporal_resolve", feedback = 0.86, phase = 8 })
		inst.system = S
		inst.ctx = ctx
