-- ARKHER SYSTEM VC.0067 :: Sparse Page Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0067"
	S.key = "arkher.contneural.sparsepage.neural_field"
	S.name = "Sparse Page Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.sparsepage.coherence_guard" }
	S.tags = { "vc", "sparsepage", "neuralfield", "contneural" }
	S.description = "Sparse Page Neural Field: neural field encoding and reconstruction for the Sparse Page subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.sparsepage.neural_field", dims = 16, hidden = 12, seed = 82893 })
		inst.system = S
		inst.ctx = ctx
