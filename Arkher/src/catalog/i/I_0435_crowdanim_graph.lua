-- ARKHER SYSTEM I.0435 :: Crowd Animation Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0435"
	S.key = "arkher.anim.crowdanim.retarget_graph"
	S.name = "Crowd Animation Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.crowdanim.physical_blend" }
	S.tags = { "i", "crowdanim", "graph", "anim" }
	S.description = "Crowd Animation Retarget Graph: bone mapping and retarget path resolution for the Crowd Animation subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.crowdanim.retarget_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
