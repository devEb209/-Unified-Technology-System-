-- ARKHER SYSTEM E.0076 :: Normal Detail Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0076"
	S.key = "arkher.material.normaldetail.definition"
	S.name = "Normal Detail Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "normaldetail", "material", "material" }
	S.description = "Normal Detail Definition: layered PBR definition resolved into parameters for the Normal Detail subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.normaldetail.definition", texelBudget = 1572864 })
		inst.system = S
		inst.ctx = ctx
