-- ARKHER SYSTEM O.0296 :: UI Sound Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0296"
	S.key = "arkher.audio.uisound.compression_codec"
	S.name = "UI Sound Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "UI Sound"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.uisound.asset_registry" }
	S.tags = { "o", "uisound", "codec", "audio" }
	S.description = "UI Sound Compression Codec: payload encoding of audio state and events for the UI Sound subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.uisound.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
