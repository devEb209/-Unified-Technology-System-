-- ARKHER SYSTEM F.0399 :: Draw Call Batching Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0399"
	S.key = "arkher.render.batching.temporal_resolve"
	S.name = "Draw Call Batching Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.batching.probe_volume" }
	S.tags = { "f", "batching", "temporal", "render" }
	S.description = "Draw Call Batching Temporal Resolve: history reprojection with neighbourhood clamping for the Draw Call Batching subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.batching.temporal_resolve", feedback = 0.92, phase = 8 })
		inst.system = S
		inst.ctx = ctx
