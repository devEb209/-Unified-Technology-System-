-- ARKHER SYSTEM F.0292 :: Color Grading Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0292"
	S.key = "arkher.render.grading.frame_analysis"
	S.name = "Color Grading Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.grading.pass_cache" }
	S.tags = { "f", "grading", "analyzer", "render" }
	S.description = "Color Grading Frame Analysis: per-pass cost analysis and outlier detection for the Color Grading subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.grading.frame_analysis", window = 207, buckets = 19, threshold = 4.90 })
		inst.system = S
		inst.ctx = ctx
