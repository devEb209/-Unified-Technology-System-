-- ARKHER SYSTEM Z.1067 :: World Dream State World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.1067"
	S.key = "arkher.origin.worlddream.world_architect"
	S.name = "World Dream State World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.emergence_detection" }
	S.tags = { "z", "worlddream", "architect", "origin" }
	S.description = "World Dream State World Architect: hierarchical world composition with conserved budgets for the World Dream State subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.worlddream.world_architect", budget = 800, seed = 31432 })
		inst.system = S
		inst.ctx = ctx
