-- ARKHER SYSTEM H.0132 :: Torque Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0132"
	S.key = "arkher.physics.torque.character_motion"
	S.name = "Torque Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Torque"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.torque.query" }
	S.tags = { "h", "torque", "charmotor", "physics" }
	S.description = "Torque Character Motion: capsule move-and-slide with slopes, steps and jumps for the Torque subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.torque.character_motion", radius = 0.35, height = 1.60, maxSpeed = 8.00, jumpHeight = 1.60, stepOffset = 0.35 })
		inst.system = S
		inst.ctx = ctx
