-- ARKHER SYSTEM L.0267 :: Season Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0267"
	S.key = "arkher.sim.season.aggregate_cache"
	S.name = "Season Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.season.fidelity_policy" }
	S.tags = { "l", "season", "cache", "sim" }
	S.description = "Season Aggregate Cache: reuse of expensive aggregate computations for the Season subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.season.aggregate_cache", policy = "ttl", capacity = 149, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
