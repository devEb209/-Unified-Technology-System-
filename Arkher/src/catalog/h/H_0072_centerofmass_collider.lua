-- ARKHER SYSTEM H.0072 :: Center Of Mass Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0072"
	S.key = "arkher.physics.centerofmass.collision_shape"
	S.name = "Center Of Mass Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.centerofmass.body_dynamics" }
	S.tags = { "h", "centerofmass", "collider", "physics" }
	S.description = "Center Of Mass Collision Shape: shape bounds, support mapping and closest points for the Center Of Mass subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.centerofmass.collision_shape", shape = "box", radius = 0.80, height = 1.60, layer = "default" })
		inst.system = S
		inst.ctx = ctx
