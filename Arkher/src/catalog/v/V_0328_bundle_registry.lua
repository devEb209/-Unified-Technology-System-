-- ARKHER SYSTEM V.0328 :: Bundle Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0328"
	S.key = "arkher.asset.bundle.asset_registry"
	S.name = "Bundle Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.bundle.cook_pipeline" }
	S.tags = { "v", "bundle", "registry", "asset" }
	S.description = "Bundle Asset Registry: catalogue of every asset, its tags and its metadata for the Bundle subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.bundle.asset_registry" })
		inst.system = S
		inst.ctx = ctx
