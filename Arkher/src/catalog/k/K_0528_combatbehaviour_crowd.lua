-- ARKHER SYSTEM K.0528 :: Combat Behaviour Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0528"
	S.key = "arkher.npc.combatbehaviour.crowd_steering"
	S.name = "Combat Behaviour Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.combatbehaviour.navigation" }
	S.tags = { "k", "combatbehaviour", "crowd", "npc" }
	S.description = "Combat Behaviour Crowd Steering: local avoidance, cohesion and arrival at scale for the Combat Behaviour subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.combatbehaviour.crowd_steering", radius = 0.60, maxSpeed = 5.40, cellSize = 6 })
		inst.system = S
		inst.ctx = ctx
