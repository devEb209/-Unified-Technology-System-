-- ARKHER SYSTEM VA.0142 :: Fidelity Band Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0142"
	S.key = "arkher.contworld.fidelityband.simulation_fabric"
	S.name = "Fidelity Band Simulation Fabric"
	S.category = "VA"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.fidelityband.complexity_budget" }
	S.tags = { "va", "fidelityband", "fabric", "contworld" }
	S.description = "Fidelity Band Simulation Fabric: fabric stepping the continuum domains for the Fidelity Band subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.fidelityband.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
