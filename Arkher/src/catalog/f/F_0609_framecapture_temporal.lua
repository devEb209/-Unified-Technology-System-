-- ARKHER SYSTEM F.0609 :: Frame Capture Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0609"
	S.key = "arkher.render.framecapture.temporal_resolve"
	S.name = "Frame Capture Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framecapture.probe_volume" }
	S.tags = { "f", "framecapture", "temporal", "render" }
	S.description = "Frame Capture Temporal Resolve: history reprojection with neighbourhood clamping for the Frame Capture subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.framecapture.temporal_resolve", feedback = 0.84, phase = 8 })
		inst.system = S
		inst.ctx = ctx
