-- ARKHER SYSTEM VC.0305 :: Weather Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0305"
	S.key = "arkher.contneural.weathercont.persistent_state"
	S.name = "Weather Continuum Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.weathercont.multi-scale_fidelity" }
	S.tags = { "vc", "weathercont", "persistent", "contneural" }
	S.description = "Weather Continuum Persistent State: epoch-stamped persistent history and rollback for the Weather Continuum subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.weathercont.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
