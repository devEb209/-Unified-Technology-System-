-- ARKHER SYSTEM H.0607 :: Explosion Force Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0607"
	S.key = "arkher.physics.explosion.query"
	S.name = "Explosion Force Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.explosion.constraint_solver" }
	S.tags = { "h", "explosion", "raycaster", "physics" }
	S.description = "Explosion Force Query: rays, sweeps and overlaps against the simulation for the Explosion Force subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.explosion.query", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
