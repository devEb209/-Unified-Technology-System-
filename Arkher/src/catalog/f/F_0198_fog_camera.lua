-- ARKHER SYSTEM F.0198 :: Fog View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0198"
	S.key = "arkher.render.fog.view_and_culling"
	S.name = "Fog View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Fog"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.fog.frame_graph" }
	S.tags = { "f", "fog", "camera", "render" }
	S.description = "Fog View And Culling: view state, frustum culling and screen-size LOD for the Fog subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.fog.view_and_culling", width = 828, height = 720, fov = 0.9000, far = 1600 })
		inst.system = S
		inst.ctx = ctx
