-- ARKHER SYSTEM I.0167 :: Additive Layer Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0167"
	S.key = "arkher.anim.additivelayer.quality_policy"
	S.name = "Additive Layer Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.additivelayer.pose_cache" }
	S.tags = { "i", "additivelayer", "policy", "anim" }
	S.description = "Additive Layer Quality Policy: device tier rules for rate, bones and solvers for the Additive Layer subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.additivelayer.quality_policy", algorithm = "wfq", starvationGuard = 62 })
		inst.system = S
		inst.ctx = ctx
