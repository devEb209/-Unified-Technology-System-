-- ARKHER SYSTEM T.0138 :: Skill Library Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0138"
	S.key = "arkher.ai.skilllibrary.model_inference"
	S.name = "Skill Library Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.skilllibrary.action_planner" }
	S.tags = { "t", "skilllibrary", "inference", "ai" }
	S.description = "Skill Library Model Inference: quantized inference with batching and budget for the Skill Library subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.skilllibrary.model_inference", seed = 46377 })
		inst.system = S
		inst.ctx = ctx
