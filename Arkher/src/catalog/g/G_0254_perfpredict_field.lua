-- ARKHER SYSTEM G.0254 :: Performance Prediction Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0254"
	S.key = "arkher.neural.perfpredict.feature_extraction"
	S.name = "Performance Prediction Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perfpredict.inference_core" }
	S.tags = { "g", "perfpredict", "field", "neural" }
	S.description = "Performance Prediction Feature Extraction: signal features feeding the model for the Performance Prediction subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.perfpredict.feature_extraction", seed = 66513, frequency = 0.0123, octaves = 4, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
