-- ARKHER SYSTEM E.0017 :: Surface Definition Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0017"
	S.key = "arkher.material.surfacedef.layer_composition"
	S.name = "Surface Definition Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.surfacedef.definition" }
	S.tags = { "e", "surfacedef", "composer", "material" }
	S.description = "Surface Definition Layer Composition: ordered layer composition with blend rules for the Surface Definition subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.surfacedef.layer_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
