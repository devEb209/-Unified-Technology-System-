-- ARKHER SYSTEM H.0492 :: Slider Joint Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0492"
	S.key = "arkher.physics.sliderjoint.collision_shape"
	S.name = "Slider Joint Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Slider Joint"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sliderjoint.body_dynamics" }
	S.tags = { "h", "sliderjoint", "collider", "physics" }
	S.description = "Slider Joint Collision Shape: shape bounds, support mapping and closest points for the Slider Joint subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.sliderjoint.collision_shape", shape = "box", radius = 0.50, height = 1.30, layer = "world" })
		inst.system = S
		inst.ctx = ctx
