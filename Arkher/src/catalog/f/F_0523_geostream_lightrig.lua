-- ARKHER SYSTEM F.0523 :: Geometry Streaming Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0523"
	S.key = "arkher.render.geostream.lighting_rig"
	S.name = "Geometry Streaming Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.geostream.geometry_virtualization" }
	S.tags = { "f", "geostream", "lightrig", "render" }
	S.description = "Geometry Streaming Lighting Rig: light clustering, importance and cascades for the Geometry Streaming subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.geostream.lighting_rig", maxActive = 12 })
		inst.system = S
		inst.ctx = ctx
