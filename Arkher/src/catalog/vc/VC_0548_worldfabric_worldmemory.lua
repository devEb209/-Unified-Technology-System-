-- ARKHER SYSTEM VC.0548 :: World Fabric World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0548"
	S.key = "arkher.contneural.worldfabric.world_memory_stream"
	S.name = "World Fabric World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldfabric.neural_field" }
	S.tags = { "vc", "worldfabric", "worldmemory", "contneural" }
	S.description = "World Fabric World Memory Stream: world memory continuum over epochs for the World Fabric subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.worldfabric.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
