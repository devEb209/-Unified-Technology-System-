-- ARKHER SYSTEM L.0234 :: Weather State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0234"
	S.key = "arkher.sim.weather.state_codec"
	S.name = "Weather State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.weather.history_ledger" }
	S.tags = { "l", "weather", "codec", "sim" }
	S.description = "Weather State Codec: persistence, diffing and checksum of the world state for the Weather subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.weather.state_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
