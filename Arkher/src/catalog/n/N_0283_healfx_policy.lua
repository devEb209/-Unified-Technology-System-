-- ARKHER SYSTEM N.0283 :: Heal Effect Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0283"
	S.key = "arkher.vfx.healfx.quality_policy"
	S.name = "Heal Effect Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Heal Effect"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.healfx.result_cache" }
	S.tags = { "n", "healfx", "policy", "vfx" }
	S.description = "Heal Effect Quality Policy: distance and device driven fidelity bands for the Heal Effect subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.healfx.quality_policy", algorithm = "roundrobin", starvationGuard = 16 })
		inst.system = S
		inst.ctx = ctx
