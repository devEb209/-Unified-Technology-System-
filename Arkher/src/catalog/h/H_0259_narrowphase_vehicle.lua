-- ARKHER SYSTEM H.0259 :: Narrowphase Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0259"
	S.key = "arkher.physics.narrowphase.vehicle"
	S.name = "Narrowphase Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Narrowphase"
	S.aspect = "Vehicle"
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.narrowphase.character_motion" }
	S.tags = { "h", "narrowphase", "vehicle", "physics" }
	S.description = "Narrowphase Vehicle: suspension, drivetrain, steering and tire friction for the Narrowphase subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.narrowphase.vehicle", mass = 1100, wheelbase = 2.20, track = 1.40, maxRpm = 5600 })
		inst.system = S
		inst.ctx = ctx
