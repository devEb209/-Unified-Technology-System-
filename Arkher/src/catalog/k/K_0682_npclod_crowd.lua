-- ARKHER SYSTEM K.0682 :: NPC LOD Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0682"
	S.key = "arkher.npc.npclod.crowd_steering"
	S.name = "NPC LOD Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npclod.navigation" }
	S.tags = { "k", "npclod", "crowd", "npc" }
	S.description = "NPC LOD Crowd Steering: local avoidance, cohesion and arrival at scale for the NPC LOD subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.npclod.crowd_steering", radius = 0.40, maxSpeed = 3.00, cellSize = 6 })
		inst.system = S
		inst.ctx = ctx
