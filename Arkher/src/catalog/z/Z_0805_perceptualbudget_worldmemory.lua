-- ARKHER SYSTEM Z.0805 :: Perceptual Budgeting World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0805"
	S.key = "arkher.origin.perceptualbudget.world_memory"
	S.name = "Perceptual Budgeting World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.perceptualbudget.autonomous_pipeline" }
	S.tags = { "z", "perceptualbudget", "worldmemory", "origin" }
	S.description = "Perceptual Budgeting World Memory: epoch-stamped persistent history with compaction and checkpoints for the Perceptual Budgeting subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.perceptualbudget.world_memory", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
