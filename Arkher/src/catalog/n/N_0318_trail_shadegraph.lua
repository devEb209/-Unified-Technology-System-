-- ARKHER SYSTEM N.0318 :: Trail Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0318"
	S.key = "arkher.vfx.trail.effect_graph"
	S.name = "Trail Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Trail"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.trail.curve_authoring" }
	S.tags = { "n", "trail", "shadegraph", "vfx" }
	S.description = "Trail Effect Graph: node graph describing how the effect is shaded for the Trail subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.trail.effect_graph" })
		inst.system = S
		inst.ctx = ctx
