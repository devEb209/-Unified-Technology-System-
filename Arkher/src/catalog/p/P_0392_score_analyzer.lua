-- ARKHER SYSTEM P.0392 :: Score Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0392"
	S.key = "arkher.play.score.balance_analysis"
	S.name = "Score Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Score"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.score.event_ledger" }
	S.tags = { "p", "score", "analyzer", "play" }
	S.description = "Score Balance Analysis: distribution, outlier and pacing analysis for the Score subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.score.balance_analysis", window = 96, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
