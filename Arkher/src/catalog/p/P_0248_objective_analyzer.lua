-- ARKHER SYSTEM P.0248 :: Objective Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0248"
	S.key = "arkher.play.objective.balance_analysis"
	S.name = "Objective Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Objective"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.objective.event_ledger" }
	S.tags = { "p", "objective", "analyzer", "play" }
	S.description = "Objective Balance Analysis: distribution, outlier and pacing analysis for the Objective subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.objective.balance_analysis", window = 220, buckets = 12, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
