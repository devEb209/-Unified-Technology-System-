-- ARKHER SYSTEM G.0117 :: Denoising Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0117"
	S.key = "arkher.neural.denoise.model_registry"
	S.name = "Denoising Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.denoise.reconstruction" }
	S.tags = { "g", "denoise", "registry", "neural" }
	S.description = "Denoising Model Registry: named models and their lifecycle for the Denoising subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.denoise.model_registry" })
		inst.system = S
		inst.ctx = ctx
