-- ARKHER SYSTEM E.0153 :: Subsurface Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0153"
	S.key = "arkher.material.subsurface.shading_graph"
	S.name = "Subsurface Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Subsurface"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.subsurface.layer_composition" }
	S.tags = { "e", "subsurface", "shadegraph", "material" }
	S.description = "Subsurface Shading Graph: node graph evaluated and compiled to Luau for the Subsurface subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.subsurface.shading_graph" })
		inst.system = S
		inst.ctx = ctx
