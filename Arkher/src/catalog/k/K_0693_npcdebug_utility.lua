-- ARKHER SYSTEM K.0693 :: NPC Debug Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0693"
	S.key = "arkher.npc.npcdebug.utility_reasoning"
	S.name = "NPC Debug Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npcdebug.reactive_behaviour" }
	S.tags = { "k", "npcdebug", "utility", "npc" }
	S.description = "NPC Debug Utility Reasoning: scored option selection with response curves for the NPC Debug subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.npcdebug.utility_reasoning", momentum = 0.11 })
		inst.system = S
		inst.ctx = ctx
