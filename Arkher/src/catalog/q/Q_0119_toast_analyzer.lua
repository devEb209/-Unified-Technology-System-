-- ARKHER SYSTEM Q.0119 :: Toast Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0119"
	S.key = "arkher.ui.toast.usability_analysis"
	S.name = "Toast Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Toast"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.toast.frame_budget" }
	S.tags = { "q", "toast", "analyzer", "ui" }
	S.description = "Toast Usability Analysis: reachability, latency and abandonment analysis for the Toast subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.toast.usability_analysis", window = 242, buckets = 18, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
