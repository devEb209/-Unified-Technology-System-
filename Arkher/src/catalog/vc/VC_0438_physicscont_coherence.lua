-- ARKHER SYSTEM VC.0438 :: Physics Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0438"
	S.key = "arkher.contneural.physicscont.coherence_guard"
	S.name = "Physics Continuum Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.physicscont.persistent_state" }
	S.tags = { "vc", "physicscont", "coherence", "contneural" }
	S.description = "Physics Continuum Coherence Guard: seam coherence and drift supervision for the Physics Continuum subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.physicscont.coherence_guard", window = 77, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
