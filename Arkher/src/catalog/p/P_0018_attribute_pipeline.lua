-- ARKHER SYSTEM P.0018 :: Attribute Rule Pipeline
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0018"
	S.key = "arkher.play.attribute.rule_pipeline"
	S.name = "Attribute Rule Pipeline"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Attribute"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.play.attribute.state_machine" }
	S.tags = { "p", "attribute", "pipeline", "play" }
	S.description = "Attribute Rule Pipeline: ordered rules applied to every gameplay event for the Attribute subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.play.attribute.rule_pipeline", budgetMs = 8.00 })
		inst.system = S
		inst.ctx = ctx
