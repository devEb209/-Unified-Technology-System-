-- ARKHER SYSTEM G.0295 :: Model Registry Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0295"
	S.key = "arkher.neural.modelregistry.inference_core"
	S.name = "Model Registry Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "modelregistry", "inference", "neural" }
	S.description = "Model Registry Inference Core: dense network forward pass and training for the Model Registry subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.modelregistry.inference_core", seed = 80029 })
		inst.system = S
		inst.ctx = ctx
