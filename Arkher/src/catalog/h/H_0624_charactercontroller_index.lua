-- ARKHER SYSTEM H.0624 :: Character Controller Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0624"
	S.key = "arkher.physics.charactercontroller.broadphase_index"
	S.name = "Character Controller Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.charactercontroller.vehicle" }
	S.tags = { "h", "charactercontroller", "index", "physics" }
	S.description = "Character Controller Broadphase Index: spatial acceleration of candidate pair finding for the Character Controller subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.charactercontroller.broadphase_index", mode = "hash", cellSize = 80 })
		inst.system = S
		inst.ctx = ctx
