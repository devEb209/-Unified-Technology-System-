-- ARKHER SYSTEM VA.0479 :: VFX Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0479"
	S.key = "arkher.contworld.vfxcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vfxcont.simulation_fabric" }
	S.tags = { "va", "vfxcont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.vfxcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
