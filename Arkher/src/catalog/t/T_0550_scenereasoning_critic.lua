-- ARKHER SYSTEM T.0550 :: Scene Reasoning Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0550"
	S.key = "arkher.ai.scenereasoning.self_critique"
	S.name = "Scene Reasoning Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.scenereasoning.plan_workflow" }
	S.tags = { "t", "scenereasoning", "critic", "ai" }
	S.description = "Scene Reasoning Self Critique: weighted evaluation of the result against declared criteria for the Scene Reasoning subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.scenereasoning.self_critique", passMark = 0.77, reviseMark = 0.42, seed = 8602 })
		inst.system = S
		inst.ctx = ctx
