--!strict
-- WorldMachine Tiled — ANIMATION Node_Flow #0071
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="WorldMachine Tiled — ANIMATION Node_Flow #0071", size=Vector2.new(680, 440), pos=UDim2.fromOffset(223, 247), parent=parent, icon="✎"})
