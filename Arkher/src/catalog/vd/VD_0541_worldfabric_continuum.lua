-- ARKHER SYSTEM VD.0541 :: World Fabric Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0541"
	S.key = "arkher.contsim.worldfabric.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "worldfabric", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.worldfabric.infinite_grid", cellSize = 192, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
