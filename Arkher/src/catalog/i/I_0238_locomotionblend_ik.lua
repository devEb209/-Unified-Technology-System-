-- ARKHER SYSTEM I.0238 :: Locomotion Blend Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0238"
	S.key = "arkher.anim.locomotionblend.inverse_kinematics"
	S.name = "Locomotion Blend Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.locomotionblend.layered_blending" }
	S.tags = { "i", "locomotionblend", "ik", "anim" }
	S.description = "Locomotion Blend Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Locomotion Blend subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.locomotionblend.inverse_kinematics", iterations = 6, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
