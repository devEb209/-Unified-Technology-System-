-- ARKHER SYSTEM V.0040 :: Normal Map Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0040"
	S.key = "arkher.asset.normalmap.asset_registry"
	S.name = "Normal Map Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.normalmap.cook_pipeline" }
	S.tags = { "v", "normalmap", "registry", "asset" }
	S.description = "Normal Map Asset Registry: catalogue of every asset, its tags and its metadata for the Normal Map subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.normalmap.asset_registry" })
		inst.system = S
		inst.ctx = ctx
