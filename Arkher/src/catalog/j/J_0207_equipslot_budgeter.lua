-- ARKHER SYSTEM J.0207 :: Equipment Slot Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0207"
	S.key = "arkher.character.equipslot.budget_governor"
	S.name = "Equipment Slot Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.equipslot.variant_registry" }
	S.tags = { "j", "equipslot", "budgeter", "character" }
	S.description = "Equipment Slot Budget Governor: per-character cost allocation in a crowd for the Equipment Slot subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.equipslot.budget_governor", total = 321, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
