-- ARKHER SYSTEM VD.0006 :: World Grid Cell Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0006"
	S.key = "arkher.contsim.worldcell.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldcell.persistent_state" }
	S.tags = { "vd", "worldcell", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.worldcell.coherence_guard", window = 141, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
