-- ARKHER SYSTEM F.0635 :: Memory Aliasing Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0635"
	S.key = "arkher.render.memaliasing.lighting_rig"
	S.name = "Memory Aliasing Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.memaliasing.geometry_virtualization" }
	S.tags = { "f", "memaliasing", "lightrig", "render" }
	S.description = "Memory Aliasing Lighting Rig: light clustering, importance and cascades for the Memory Aliasing subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.memaliasing.lighting_rig", maxActive = 11 })
		inst.system = S
		inst.ctx = ctx
