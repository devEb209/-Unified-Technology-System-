-- ARKHER SYSTEM N.0492 :: Glow Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0492"
	S.key = "arkher.vfx.glow.spatial_index"
	S.name = "Glow Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Glow"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.glow.quality_policy" }
	S.tags = { "n", "glow", "index", "vfx" }
	S.description = "Glow Spatial Index: spatial acceleration of effect queries and culling for the Glow subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.glow.spatial_index", mode = "hash", cellSize = 32 })
		inst.system = S
		inst.ctx = ctx
