-- ARKHER SYSTEM F.0517 :: Mesh LOD Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0517"
	S.key = "arkher.render.meshlod.orchestration"
	S.name = "Mesh LOD Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Mesh LOD"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.meshlod.frame_analysis" }
	S.tags = { "f", "meshlod", "orchestrator", "render" }
	S.description = "Mesh LOD Orchestration: frame lifecycle orchestration for the Mesh LOD subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.meshlod.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
