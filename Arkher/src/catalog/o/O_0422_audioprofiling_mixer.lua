-- ARKHER SYSTEM O.0422 :: Audio Profiling Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0422"
	S.key = "arkher.audio.audioprofiling.mixer_bus"
	S.name = "Audio Profiling Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audioprofiling.dsp_chain" }
	S.tags = { "o", "audioprofiling", "mixer", "audio" }
	S.description = "Audio Profiling Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Audio Profiling subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.audioprofiling.mixer_bus", maxVoices = 24 })
		inst.system = S
		inst.ctx = ctx
