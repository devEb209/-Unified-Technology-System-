-- ARKHER SYSTEM VC.0083 :: LOD Cascade Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0083"
	S.key = "arkher.contneural.lodcascade.reality_continuum"
	S.name = "LOD Cascade Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lodcascade.simulation_fabric" }
	S.tags = { "vc", "lodcascade", "reality", "contneural" }
	S.description = "LOD Cascade Reality Continuum: stacked reality layers of the continuum for the LOD Cascade subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.lodcascade.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
