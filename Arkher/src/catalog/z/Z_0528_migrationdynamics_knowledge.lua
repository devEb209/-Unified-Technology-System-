-- ARKHER SYSTEM Z.0528 :: Migration Dynamics Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0528"
	S.key = "arkher.origin.migrationdynamics.semantic_graph"
	S.name = "Migration Dynamics Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.migrationdynamics.world_architect" }
	S.tags = { "z", "migrationdynamics", "knowledge", "origin" }
	S.description = "Migration Dynamics Semantic Graph: typed entities and inferred relations of the technology itself for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.migrationdynamics.semantic_graph", dims = 16 })
		inst.system = S
		inst.ctx = ctx
