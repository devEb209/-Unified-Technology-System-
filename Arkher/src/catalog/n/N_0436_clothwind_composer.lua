-- ARKHER SYSTEM N.0436 :: Cloth Wind Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0436"
	S.key = "arkher.vfx.clothwind.effect_composition"
	S.name = "Cloth Wind Effect Composition"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloth Wind"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.clothwind.effect_graph" }
	S.tags = { "n", "clothwind", "composer", "vfx" }
	S.description = "Cloth Wind Effect Composition: blending of several effect signals into one output for the Cloth Wind subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.clothwind.effect_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
