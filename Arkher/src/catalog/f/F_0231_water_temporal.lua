-- ARKHER SYSTEM F.0231 :: Water Rendering Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0231"
	S.key = "arkher.render.water.temporal_resolve"
	S.name = "Water Rendering Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.water.probe_volume" }
	S.tags = { "f", "water", "temporal", "render" }
	S.description = "Water Rendering Temporal Resolve: history reprojection with neighbourhood clamping for the Water Rendering subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.water.temporal_resolve", feedback = 0.89, phase = 8 })
		inst.system = S
		inst.ctx = ctx
