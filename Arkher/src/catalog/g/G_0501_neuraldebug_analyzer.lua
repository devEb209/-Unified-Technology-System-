-- ARKHER SYSTEM G.0501 :: Neural Debug Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0501"
	S.key = "arkher.neural.neuraldebug.error_analysis"
	S.name = "Neural Debug Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuraldebug.heuristic_policy" }
	S.tags = { "g", "neuraldebug", "analyzer", "neural" }
	S.description = "Neural Debug Error Analysis: residual and drift analysis for the Neural Debug subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.neuraldebug.error_analysis", window = 118, buckets = 10, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
