...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="ESA WorldCover — CORE Map #0018", size=Vector2.new(600, 480), pos=UDim2.fromOffset(334, 126), parent=parent, icon="☀"})
