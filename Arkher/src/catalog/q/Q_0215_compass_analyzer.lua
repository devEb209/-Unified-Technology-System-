-- ARKHER SYSTEM Q.0215 :: Compass Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0215"
	S.key = "arkher.ui.compass.usability_analysis"
	S.name = "Compass Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Compass"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.compass.frame_budget" }
	S.tags = { "q", "compass", "analyzer", "ui" }
	S.description = "Compass Usability Analysis: reachability, latency and abandonment analysis for the Compass subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.compass.usability_analysis", window = 127, buckets = 11, threshold = 2.90 })
		inst.system = S
		inst.ctx = ctx
