-- ARKHER SYSTEM L.0557 :: World Event Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0557"
	S.key = "arkher.sim.worldevent.ecology"
	S.name = "World Event Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldevent.simulation_core" }
	S.tags = { "l", "worldevent", "ecology", "sim" }
	S.description = "World Event Ecology: populations, predation, harvesting and carrying capacity for the World Event subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.worldevent.ecology" })
		inst.system = S
		inst.ctx = ctx
