-- ARKHER SYSTEM F.0050 :: Transparent Pass Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0050"
	S.key = "arkher.render.transparentpass.adaptive_resolution"
	S.name = "Transparent Pass Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.transparentpass.temporal_resolve" }
	S.tags = { "f", "transparentpass", "upscaler", "render" }
	S.description = "Transparent Pass Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Transparent Pass subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.transparentpass.adaptive_resolution", targetMs = 16.10, index = 5, sharpness = 0.21 })
		inst.system = S
		inst.ctx = ctx
