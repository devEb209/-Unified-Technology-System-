-- ARKHER SYSTEM G.0305 :: Model Registry Error Analysis
...
return function(A)
	...
	local S = {}
	S.id = "G.0305"
	S.key = "arkher.neural.modelregistry.error_analysis"
	S.name = "Model Registry Error Analysis"
	S.category = "G"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelregistry.heuristic_policy" }
	S.tags = { "g", "modelregistry", "analyzer", "neural" }
	S.description = "Model Registry Error Analysis: residual and drift analysis for the Model Registry subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.neural.modelregistry.error_analysis", window = 125, buckets = 13, threshold = 3.70 })
		inst.system = S
		inst.ctx = ctx
