-- ARKHER SYSTEM O.0206 :: Occlusion Zone Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0206"
	S.key = "arkher.audio.occlusionzone.mixer_bus"
	S.name = "Occlusion Zone Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.occlusionzone.dsp_chain" }
	S.tags = { "o", "occlusionzone", "mixer", "audio" }
	S.description = "Occlusion Zone Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Occlusion Zone subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.occlusionzone.mixer_bus", maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
