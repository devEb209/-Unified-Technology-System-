-- ARKHER SYSTEM R.0113 :: Remote Function Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0113"
	S.key = "arkher.net.remotefunction.bandwidth_budget"
	S.name = "Remote Function Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remotefunction.transport_graph" }
	S.tags = { "r", "remotefunction", "budgeter", "net" }
	S.description = "Remote Function Bandwidth Budget: bytes per second shared between competing streams for the Remote Function subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.remotefunction.bandwidth_budget", total = 377, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
