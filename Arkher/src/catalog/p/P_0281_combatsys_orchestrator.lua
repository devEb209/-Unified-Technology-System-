-- ARKHER SYSTEM P.0281 :: Combat State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0281"
	S.key = "arkher.play.combatsys.state_machine"
	S.name = "Combat State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Combat"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.combatsys.combat_resolution" }
	S.tags = { "p", "combatsys", "orchestrator", "play" }
	S.description = "Combat State Machine: the phase machine that drives this gameplay loop for the Combat subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.combatsys.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
