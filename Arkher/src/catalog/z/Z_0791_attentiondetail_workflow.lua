-- ARKHER SYSTEM Z.0791 :: Attention Driven Detail Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0791"
	S.key = "arkher.origin.attentiondetail.adaptive_workflow"
	S.name = "Attention Driven Detail Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.self_critique" }
	S.tags = { "z", "attentiondetail", "workflow", "origin" }
	S.description = "Attention Driven Detail Adaptive Workflow: verified, retryable, reversible execution plans for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.attentiondetail.adaptive_workflow", maxRetries = 3, budget = 90 })
		inst.system = S
		inst.ctx = ctx
