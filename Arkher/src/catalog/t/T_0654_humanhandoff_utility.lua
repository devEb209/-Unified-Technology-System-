-- ARKHER SYSTEM T.0654 :: Human Handoff Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0654"
	S.key = "arkher.ai.humanhandoff.utility_selection"
	S.name = "Human Handoff Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.humanhandoff.working_memory" }
	S.tags = { "t", "humanhandoff", "utility", "ai" }
	S.description = "Human Handoff Utility Selection: scored choice between competing courses of action for the Human Handoff subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.humanhandoff.utility_selection", momentum = 0.12 })
		inst.system = S
		inst.ctx = ctx
