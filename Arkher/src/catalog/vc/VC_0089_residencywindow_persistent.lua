-- ARKHER SYSTEM VC.0089 :: Residency Window Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0089"
	S.key = "arkher.contneural.residencywindow.persistent_state"
	S.name = "Residency Window Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.residencywindow.multi-scale_fidelity" }
	S.tags = { "vc", "residencywindow", "persistent", "contneural" }
	S.description = "Residency Window Persistent State: epoch-stamped persistent history and rollback for the Residency Window subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.residencywindow.persistent_state", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
