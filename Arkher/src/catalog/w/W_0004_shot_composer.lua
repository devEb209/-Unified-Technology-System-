-- ARKHER SYSTEM W.0004 :: Shot Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0004"
	S.key = "arkher.cine.shot.shot_composition"
	S.name = "Shot Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Shot"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.shot.colour_grade" }
	S.tags = { "w", "shot", "composer", "cine" }
	S.description = "Shot Shot Composition: blending of the signals that make up the final shot for the Shot subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.shot.shot_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
