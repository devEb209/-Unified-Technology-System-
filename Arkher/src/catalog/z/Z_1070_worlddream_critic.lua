-- ARKHER SYSTEM Z.1070 :: World Dream State Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.1070"
	S.key = "arkher.origin.worlddream.self_critique"
	S.name = "World Dream State Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worlddream.intent_bridge" }
	S.tags = { "z", "worlddream", "critic", "origin" }
	S.description = "World Dream State Self Critique: weighted judgement of the technology's own output for the World Dream State subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.worlddream.self_critique", passMark = 0.76, reviseMark = 0.46, seed = 26196 })
		inst.system = S
		inst.ctx = ctx
