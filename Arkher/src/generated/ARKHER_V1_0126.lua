--!strict
-- OpenWeather — CORE Node_Flow #0126
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="OpenWeather — CORE Node_Flow #0126", size=Vector2.new(600, 440), pos=UDim2.fromOffset(138, 142), parent=parent, icon="◣"})
