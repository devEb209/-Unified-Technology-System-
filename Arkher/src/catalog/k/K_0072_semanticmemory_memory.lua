-- ARKHER SYSTEM K.0072 :: Semantic Memory Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0072"
	S.key = "arkher.npc.semanticmemory.memory"
	S.name = "Semantic Memory Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.semanticmemory.mind_network" }
	S.tags = { "k", "semanticmemory", "memory", "npc" }
	S.description = "Semantic Memory Memory: episodic memory with decay, recall and consolidation for the Semantic Memory subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.semanticmemory.memory", capacity = 126, decayRate = 0.030, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
