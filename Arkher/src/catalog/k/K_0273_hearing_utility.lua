-- ARKHER SYSTEM K.0273 :: Hearing Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0273"
	S.key = "arkher.npc.hearing.utility_reasoning"
	S.name = "Hearing Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hearing.reactive_behaviour" }
	S.tags = { "k", "hearing", "utility", "npc" }
	S.description = "Hearing Utility Reasoning: scored option selection with response curves for the Hearing subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.hearing.utility_reasoning", momentum = 0.12 })
		inst.system = S
		inst.ctx = ctx
