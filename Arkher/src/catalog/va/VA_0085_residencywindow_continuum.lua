-- ARKHER SYSTEM VA.0085 :: Residency Window Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0085"
	S.key = "arkher.contworld.residencywindow.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "residencywindow", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.residencywindow.infinite_grid", cellSize = 192, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
