-- ARKHER SYSTEM VD.0010 :: World Grid Cell Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0010"
	S.key = "arkher.contsim.worldcell.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.worldcell.complexity_budget" }
	S.tags = { "vd", "worldcell", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.worldcell.simulation_fabric", budgetMs = 2.0, starvationLimit = 5 })
		inst.system = S
		inst.ctx = ctx
