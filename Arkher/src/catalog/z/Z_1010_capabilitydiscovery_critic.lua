-- ARKHER SYSTEM Z.1010 :: Capability Discovery Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.1010"
	S.key = "arkher.origin.capabilitydiscovery.self_critique"
	S.name = "Capability Discovery Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.capabilitydiscovery.intent_bridge" }
	S.tags = { "z", "capabilitydiscovery", "critic", "origin" }
	S.description = "Capability Discovery Self Critique: weighted judgement of the technology's own output for the Capability Discovery subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.capabilitydiscovery.self_critique", passMark = 0.74, reviseMark = 0.44, seed = 13504 })
		inst.system = S
		inst.ctx = ctx
