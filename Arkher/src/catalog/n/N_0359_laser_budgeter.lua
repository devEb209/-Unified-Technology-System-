-- ARKHER SYSTEM N.0359 :: Laser Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0359"
	S.key = "arkher.vfx.laser.spawn_budget"
	S.name = "Laser Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Laser"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.laser.effect_composition" }
	S.tags = { "n", "laser", "budgeter", "vfx" }
	S.description = "Laser Spawn Budget: global particle budget shared by every live effect for the Laser subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.laser.spawn_budget", total = 267, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
