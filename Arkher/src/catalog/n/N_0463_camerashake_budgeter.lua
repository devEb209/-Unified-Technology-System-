-- ARKHER SYSTEM N.0463 :: Camera Shake Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0463"
	S.key = "arkher.vfx.camerashake.spawn_budget"
	S.name = "Camera Shake Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Camera Shake"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.camerashake.effect_composition" }
	S.tags = { "n", "camerashake", "budgeter", "vfx" }
	S.description = "Camera Shake Spawn Budget: global particle budget shared by every live effect for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.camerashake.spawn_budget", total = 162, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
