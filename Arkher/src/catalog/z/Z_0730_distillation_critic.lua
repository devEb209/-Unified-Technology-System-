-- ARKHER SYSTEM Z.0730 :: Knowledge Distillation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0730"
	S.key = "arkher.origin.distillation.self_critique"
	S.name = "Knowledge Distillation Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.distillation.intent_bridge" }
	S.tags = { "z", "distillation", "critic", "origin" }
	S.description = "Knowledge Distillation Self Critique: weighted judgement of the technology's own output for the Knowledge Distillation subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.distillation.self_critique", passMark = 0.79, reviseMark = 0.49, seed = 97779 })
		inst.system = S
		inst.ctx = ctx
