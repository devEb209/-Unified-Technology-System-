-- ARKHER SYSTEM VA.0309 :: Weather Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0309"
	S.key = "arkher.contworld.weathercont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.weathercont.world_memory_stream" }
	S.tags = { "va", "weathercont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.weathercont.complexity_budget", targetMs = 22.0 })
		inst.system = S
		inst.ctx = ctx
