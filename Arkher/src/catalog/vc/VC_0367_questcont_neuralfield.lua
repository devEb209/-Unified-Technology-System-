-- ARKHER SYSTEM VC.0367 :: Quest Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0367"
	S.key = "arkher.contneural.questcont.neural_field"
	S.name = "Quest Continuum Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.questcont.coherence_guard" }
	S.tags = { "vc", "questcont", "neuralfield", "contneural" }
	S.description = "Quest Continuum Neural Field: neural field encoding and reconstruction for the Quest Continuum subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.questcont.neural_field", dims = 20, hidden = 16, seed = 9018 })
		inst.system = S
		inst.ctx = ctx
