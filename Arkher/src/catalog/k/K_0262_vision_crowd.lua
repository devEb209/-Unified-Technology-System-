-- ARKHER SYSTEM K.0262 :: Vision Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0262"
	S.key = "arkher.npc.vision.crowd_steering"
	S.name = "Vision Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.vision.navigation" }
	S.tags = { "k", "vision", "crowd", "npc" }
	S.description = "Vision Crowd Steering: local avoidance, cohesion and arrival at scale for the Vision subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.vision.crowd_steering", radius = 0.55, maxSpeed = 3.30, cellSize = 9 })
		inst.system = S
		inst.ctx = ctx
