-- ARKHER SYSTEM P.0225 :: Currency Difficulty Controller
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0225"
	S.key = "arkher.play.currency.difficulty_controller"
	S.name = "Currency Difficulty Controller"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Currency"
	...
	S.kit = "controller"
	S.version = "1.0.0"
	S.deps = { "arkher.play.currency.balance_analysis" }
	S.tags = { "p", "currency", "controller", "play" }
	S.description = "Currency Difficulty Controller: closed-loop tuning toward a target challenge for the Currency subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("controller", { id = "arkher.play.currency.difficulty_controller", mode = "pid", target = 0.760, kp = 0.310, ki = 0.080, kd = 0.020, min = 0.05, max = 1.0, initial = 0.66, deadband = 0.01 })
		inst.system = S
		inst.ctx = ctx
