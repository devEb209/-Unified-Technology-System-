-- ARKHER SYSTEM Z.0922 :: Universal Interop Layer Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0922"
	S.key = "arkher.origin.interop.complexity_governance"
	S.name = "Universal Interop Layer Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.interop.reality_layering" }
	S.tags = { "z", "interop", "complexity", "origin" }
	S.description = "Universal Interop Layer Complexity Governance: measured scene cost turned into per-subsystem directives for the Universal Interop Layer subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.interop.complexity_governance", targetMs = 11.0 })
		inst.system = S
		inst.ctx = ctx
