-- ARKHER SYSTEM VD.0212 :: Biome Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0212"
	S.key = "arkher.contsim.biomecont.world_memory_stream"
	S.name = "Biome Continuum World Memory Stream"
	S.category = "VD"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.biomecont.neural_field" }
	S.tags = { "vd", "biomecont", "worldmemory", "contsim" }
	S.description = "Biome Continuum World Memory Stream: world memory continuum over epochs for the Biome Continuum subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.biomecont.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
