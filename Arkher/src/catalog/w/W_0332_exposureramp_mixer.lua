-- ARKHER SYSTEM W.0332 :: Exposure Ramp Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0332"
	S.key = "arkher.cine.exposureramp.cinematic_mix"
	S.name = "Exposure Ramp Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.exposureramp.motion_tween" }
	S.tags = { "w", "exposureramp", "mixer", "cine" }
	S.description = "Exposure Ramp Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Exposure Ramp subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.exposureramp.cinematic_mix", maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
