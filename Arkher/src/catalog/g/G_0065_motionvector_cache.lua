-- ARKHER SYSTEM G.0065 :: Motion Vector Estimation Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0065"
	S.key = "arkher.neural.motionvector.result_cache"
	S.name = "Motion Vector Estimation Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.motionvector.compute_budget" }
	S.tags = { "g", "motionvector", "cache", "neural" }
	S.description = "Motion Vector Estimation Result Cache: cached inference results keyed by input for the Motion Vector Estimation subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.motionvector.result_cache", policy = "lfu", capacity = 118, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
