-- ARKHER SYSTEM G.0398 :: Fallback Heuristic Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0398"
	S.key = "arkher.neural.fallbackheuristic.weight_codec"
	S.name = "Fallback Heuristic Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.fallbackheuristic.model_registry" }
	S.tags = { "g", "fallbackheuristic", "codec", "neural" }
	S.description = "Fallback Heuristic Weight Codec: weight serialization and quantized transport for the Fallback Heuristic subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.fallbackheuristic.weight_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
