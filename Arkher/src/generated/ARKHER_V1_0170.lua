...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Cinema4D — CORE Stack #0170", size=Vector2.new(680, 420), pos=UDim2.fromOffset(310, 110), parent=parent, icon="✎"})
