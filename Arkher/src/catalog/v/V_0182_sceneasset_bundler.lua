-- ARKHER SYSTEM V.0182 :: Scene Asset Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0182"
	S.key = "arkher.asset.sceneasset.bundling"
	S.name = "Scene Asset Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.sceneasset.import" }
	S.tags = { "v", "sceneasset", "bundler", "asset" }
	S.description = "Scene Asset Bundling: size-bounded packing, manifests and delta patches for the Scene Asset subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.sceneasset.bundling", maxBundleBytes = 1179648 })
		inst.system = S
		inst.ctx = ctx
