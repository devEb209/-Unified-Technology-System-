-- ARKHER SYSTEM L.0418 :: Taxation Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0418"
	S.key = "arkher.sim.taxation.analysis"
	S.name = "Taxation Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.taxation.aggregate_cache" }
	S.tags = { "l", "taxation", "analyzer", "sim" }
	S.description = "Taxation Analysis: trend, anomaly and stability analysis of the world for the Taxation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.taxation.analysis", window = 124, buckets = 12, threshold = 3.60 })
		inst.system = S
		inst.ctx = ctx
