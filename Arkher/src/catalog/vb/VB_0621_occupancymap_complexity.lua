-- ARKHER SYSTEM VB.0621 :: Occupancy Map Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0621"
	S.key = "arkher.conttime.occupancymap.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.occupancymap.world_memory_stream" }
	S.tags = { "vb", "occupancymap", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.occupancymap.complexity_budget", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
