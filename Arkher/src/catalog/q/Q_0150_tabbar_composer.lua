-- ARKHER SYSTEM Q.0150 :: Tab Bar Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0150"
	S.key = "arkher.ui.tabbar.theme_composition"
	S.name = "Tab Bar Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tab Bar"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.tabbar.navigation_graph" }
	S.tags = { "q", "tabbar", "composer", "ui" }
	S.description = "Tab Bar Theme Composition: blending of theme signals into the final appearance for the Tab Bar subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.tabbar.theme_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
