-- ARKHER SYSTEM R.0003 :: Session Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0003"
	S.key = "arkher.net.session.prediction_and_reconciliation"
	S.name = "Session Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Session"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.session.time_sync" }
	S.tags = { "r", "session", "prediction", "net" }
	S.description = "Session Prediction And Reconciliation: client simulation, correction and input replay for the Session subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.session.prediction_and_reconciliation", errorThreshold = 0.045, smoothing = 11.0, maxInputs = 160 })
		inst.system = S
		inst.ctx = ctx
