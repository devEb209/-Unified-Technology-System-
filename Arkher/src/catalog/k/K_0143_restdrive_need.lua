-- ARKHER SYSTEM K.0143 :: Rest Drive Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0143"
	S.key = "arkher.npc.restdrive.drive_system"
	S.name = "Rest Drive Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.restdrive.memory" }
	S.tags = { "k", "restdrive", "need", "npc" }
	S.description = "Rest Drive Drive System: drives that decay, turn urgent and get satisfied for the Rest Drive subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.restdrive.drive_system" })
		inst.system = S
		inst.ctx = ctx
