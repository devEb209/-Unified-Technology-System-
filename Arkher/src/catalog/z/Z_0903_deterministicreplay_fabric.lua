-- ARKHER SYSTEM Z.0903 :: Deterministic Replay Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0903"
	S.key = "arkher.origin.deterministicreplay.simulation_fabric"
	S.name = "Deterministic Replay Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deterministicreplay.complexity_governance" }
	S.tags = { "z", "deterministicreplay", "fabric", "origin" }
	S.description = "Deterministic Replay Simulation Fabric: every simulation domain stepped under one budgeted clock for the Deterministic Replay subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.deterministicreplay.simulation_fabric", budgetMs = 2.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
