-- ARKHER SYSTEM VC.0562 :: Device Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0562"
	S.key = "arkher.contneural.devicecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.devicecont.complexity_budget" }
	S.tags = { "vc", "devicecont", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.devicecont.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
