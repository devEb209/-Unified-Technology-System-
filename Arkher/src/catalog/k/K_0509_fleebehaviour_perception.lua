-- ARKHER SYSTEM K.0509 :: Flee Behaviour Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0509"
	S.key = "arkher.npc.fleebehaviour.perception"
	S.name = "Flee Behaviour Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.fleebehaviour.emotion" }
	S.tags = { "k", "fleebehaviour", "perception", "npc" }
	S.description = "Flee Behaviour Perception: sight, hearing and bounded attention for the Flee Behaviour subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.fleebehaviour.perception", sightRange = 60, hearingRange = 32, attentionSlots = 6, fov = 1.830 })
		inst.system = S
		inst.ctx = ctx
