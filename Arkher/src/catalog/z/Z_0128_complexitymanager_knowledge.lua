-- ARKHER SYSTEM Z.0128 :: Dynamic Complexity Manager Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0128"
	S.key = "arkher.origin.complexitymanager.semantic_graph"
	S.name = "Dynamic Complexity Manager Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.world_architect" }
	S.tags = { "z", "complexitymanager", "knowledge", "origin" }
	S.description = "Dynamic Complexity Manager Semantic Graph: typed entities and inferred relations of the technology itself for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.complexitymanager.semantic_graph", dims = 40 })
		inst.system = S
		inst.ctx = ctx
