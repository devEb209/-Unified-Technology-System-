-- ARKHER SYSTEM VD.0366 :: Quest Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0366"
	S.key = "arkher.contsim.questcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.questcont.persistent_state" }
	S.tags = { "vd", "questcont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.questcont.coherence_guard", window = 83, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
