-- ARKHER SYSTEM K.0303 :: Attention Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0303"
	S.key = "arkher.npc.attention.navigation"
	S.name = "Attention Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.attention.goal_planner" }
	S.tags = { "k", "attention", "navgraph", "npc" }
	S.description = "Attention Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Attention subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.attention.navigation", width = 24, height = 24, cellSize = 2 })
		inst.system = S
		inst.ctx = ctx
