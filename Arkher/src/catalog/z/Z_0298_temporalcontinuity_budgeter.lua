-- ARKHER SYSTEM Z.0298 :: Temporal Continuity Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0298"
	S.key = "arkher.origin.temporalcontinuity.budget_governor"
	S.name = "Temporal Continuity Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.temporalcontinuity.behaviour_analysis" }
	S.tags = { "z", "temporalcontinuity", "budgeter", "origin" }
	S.description = "Temporal Continuity Budget Governor: allocation of a scarce resource across the technology's consumers for the Temporal Continuity subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.temporalcontinuity.budget_governor", total = 438, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
