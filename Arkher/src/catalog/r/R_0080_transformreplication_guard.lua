-- ARKHER SYSTEM R.0080 :: Transform Replication Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0080"
	S.key = "arkher.net.transformreplication.rate_guard"
	S.name = "Transform Replication Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.transformreplication.interest_streaming" }
	S.tags = { "r", "transformreplication", "guard", "net" }
	S.description = "Transform Replication Rate Guard: token-bucket protection against floods and abuse for the Transform Replication subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.transformreplication.rate_guard", algorithm = "leaky", capacity = 60, refillPerSec = 25, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
