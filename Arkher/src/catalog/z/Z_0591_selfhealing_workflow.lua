-- ARKHER SYSTEM Z.0591 :: Self Healing Systems Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0591"
	S.key = "arkher.origin.selfhealing.adaptive_workflow"
	S.name = "Self Healing Systems Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfhealing.self_critique" }
	S.tags = { "z", "selfhealing", "workflow", "origin" }
	S.description = "Self Healing Systems Adaptive Workflow: verified, retryable, reversible execution plans for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.selfhealing.adaptive_workflow", maxRetries = 1, budget = 100 })
		inst.system = S
		inst.ctx = ctx
