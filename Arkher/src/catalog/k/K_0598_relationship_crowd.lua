-- ARKHER SYSTEM K.0598 :: Relationship Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0598"
	S.key = "arkher.npc.relationship.crowd_steering"
	S.name = "Relationship Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.relationship.navigation" }
	S.tags = { "k", "relationship", "crowd", "npc" }
	S.description = "Relationship Crowd Steering: local avoidance, cohesion and arrival at scale for the Relationship subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.relationship.crowd_steering", radius = 0.85, maxSpeed = 4.90, cellSize = 7 })
		inst.system = S
		inst.ctx = ctx
