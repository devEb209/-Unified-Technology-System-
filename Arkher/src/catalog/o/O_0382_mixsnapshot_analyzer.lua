-- ARKHER SYSTEM O.0382 :: Mix Snapshot Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0382"
	S.key = "arkher.audio.mixsnapshot.analysis"
	S.name = "Mix Snapshot Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mix Snapshot"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mixsnapshot.playback_policy" }
	S.tags = { "o", "mixsnapshot", "analyzer", "audio" }
	S.description = "Mix Snapshot Analysis: loudness, headroom and masking analysis for the Mix Snapshot subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.mixsnapshot.analysis", window = 134, buckets = 14, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
