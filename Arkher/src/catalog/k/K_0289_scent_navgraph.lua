-- ARKHER SYSTEM K.0289 :: Scent Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0289"
	S.key = "arkher.npc.scent.navigation"
	S.name = "Scent Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.scent.goal_planner" }
	S.tags = { "k", "scent", "navgraph", "npc" }
	S.description = "Scent Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Scent subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.scent.navigation", width = 24, height = 24, cellSize = 2 })
		inst.system = S
		inst.ctx = ctx
