...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="NASA SRTM — CORE Mixer #0072", size=Vector2.new(600, 460), pos=UDim2.fromOffset(236, 264), parent=parent, icon="♪"})
