-- ARKHER SYSTEM K.0550 :: Trade Behaviour Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0550"
	S.key = "arkher.npc.tradebehaviour.emotion"
	S.name = "Trade Behaviour Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.tradebehaviour.drive_system" }
	S.tags = { "k", "tradebehaviour", "emotion", "npc" }
	S.description = "Trade Behaviour Emotion: appraisal of events into valence, arousal and mood for the Trade Behaviour subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.tradebehaviour.emotion", inertia = 0.93, decayRate = 0.38, baselineArousal = 0.28 })
		inst.system = S
		inst.ctx = ctx
