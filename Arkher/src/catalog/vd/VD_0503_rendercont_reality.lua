-- ARKHER SYSTEM VD.0503 :: Rendering Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0503"
	S.key = "arkher.contsim.rendercont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.rendercont.simulation_fabric" }
	S.tags = { "vd", "rendercont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.rendercont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
