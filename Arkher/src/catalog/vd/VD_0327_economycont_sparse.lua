-- ARKHER SYSTEM VD.0327 :: Economy Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0327"
	S.key = "arkher.contsim.economycont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.economycont.epoch_clock" }
	S.tags = { "vd", "economycont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.economycont.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
