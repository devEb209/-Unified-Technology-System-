-- ARKHER SYSTEM VA.0628 :: Interest Field Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VA.0628"
	S.key = "arkher.contworld.interestfield.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.interestfield.sparse_residency" }
	S.tags = { "va", "interestfield", "multiscale", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contworld.interestfield.multi-scale_fidelity", levels = 6, baseTriangles = 135000 })
		inst.system = S
		inst.ctx = ctx
