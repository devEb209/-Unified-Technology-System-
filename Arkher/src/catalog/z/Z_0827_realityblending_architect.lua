-- ARKHER SYSTEM Z.0827 :: Reality Blending World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0827"
	S.key = "arkher.origin.realityblending.world_architect"
	S.name = "Reality Blending World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.emergence_detection" }
	S.tags = { "z", "realityblending", "architect", "origin" }
	S.description = "Reality Blending World Architect: hierarchical world composition with conserved budgets for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.realityblending.world_architect", budget = 800, seed = 15272 })
		inst.system = S
		inst.ctx = ctx
