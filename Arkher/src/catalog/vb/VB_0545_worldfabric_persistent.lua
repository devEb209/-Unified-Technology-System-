-- ARKHER SYSTEM VB.0545 :: World Fabric Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0545"
	S.key = "arkher.conttime.worldfabric.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldfabric.multi-scale_fidelity" }
	S.tags = { "vb", "worldfabric", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.worldfabric.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
