-- ARKHER SYSTEM Z.0925 :: Universal Interop Layer World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0925"
	S.key = "arkher.origin.interop.world_memory"
	S.name = "Universal Interop Layer World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.interop.autonomous_pipeline" }
	S.tags = { "z", "interop", "worldmemory", "origin" }
	S.description = "Universal Interop Layer World Memory: epoch-stamped persistent history with compaction and checkpoints for the Universal Interop Layer subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.interop.world_memory", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
