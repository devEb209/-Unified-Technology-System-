-- ARKHER SYSTEM VA.0162 :: Coherence Seam Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0162"
	S.key = "arkher.contworld.coherenceseam.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.coherenceseam.persistent_state" }
	S.tags = { "va", "coherenceseam", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.coherenceseam.coherence_guard", window = 138, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
