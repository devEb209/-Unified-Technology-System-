-- ARKHER SYSTEM F.0341 :: Antialiasing Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0341"
	S.key = "arkher.render.antialiasing.lighting_rig"
	S.name = "Antialiasing Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Antialiasing"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.antialiasing.geometry_virtualization" }
	S.tags = { "f", "antialiasing", "lightrig", "render" }
	S.description = "Antialiasing Lighting Rig: light clustering, importance and cascades for the Antialiasing subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.antialiasing.lighting_rig", maxActive = 10 })
		inst.system = S
		inst.ctx = ctx
