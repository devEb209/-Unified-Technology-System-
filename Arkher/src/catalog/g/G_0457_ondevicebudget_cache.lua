-- ARKHER SYSTEM G.0457 :: On Device Budget Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0457"
	S.key = "arkher.neural.ondevicebudget.result_cache"
	S.name = "On Device Budget Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ondevicebudget.compute_budget" }
	S.tags = { "g", "ondevicebudget", "cache", "neural" }
	S.description = "On Device Budget Result Cache: cached inference results keyed by input for the On Device Budget subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.ondevicebudget.result_cache", policy = "lru", capacity = 143, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
