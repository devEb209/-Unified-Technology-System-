-- ARKHER SYSTEM VC.0166 :: Coherence Seam Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0166"
	S.key = "arkher.contneural.coherenceseam.simulation_fabric"
	S.name = "Coherence Seam Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.coherenceseam.complexity_budget" }
	S.tags = { "vc", "coherenceseam", "fabric", "contneural" }
	S.description = "Coherence Seam Simulation Fabric: fabric stepping the continuum domains for the Coherence Seam subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.coherenceseam.simulation_fabric", budgetMs = 2.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
