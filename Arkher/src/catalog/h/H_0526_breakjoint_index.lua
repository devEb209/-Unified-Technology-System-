-- ARKHER SYSTEM H.0526 :: Breakable Joint Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0526"
	S.key = "arkher.physics.breakjoint.broadphase_index"
	S.name = "Breakable Joint Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.breakjoint.vehicle" }
	S.tags = { "h", "breakjoint", "index", "physics" }
	S.description = "Breakable Joint Broadphase Index: spatial acceleration of candidate pair finding for the Breakable Joint subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.breakjoint.broadphase_index", mode = "hash", cellSize = 80 })
		inst.system = S
		inst.ctx = ctx
