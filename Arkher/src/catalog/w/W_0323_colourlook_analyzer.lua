-- ARKHER SYSTEM W.0323 :: Colour Look Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0323"
	S.key = "arkher.cine.colourlook.sequence_analysis"
	S.name = "Colour Look Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Colour Look"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.colourlook.frame_budget" }
	S.tags = { "w", "colourlook", "analyzer", "cine" }
	S.description = "Colour Look Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Colour Look subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.colourlook.sequence_analysis", window = 235, buckets = 15, threshold = 2.70 })
		inst.system = S
		inst.ctx = ctx
