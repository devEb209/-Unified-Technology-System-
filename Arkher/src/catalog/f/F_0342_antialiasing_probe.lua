-- ARKHER SYSTEM F.0342 :: Antialiasing Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0342"
	S.key = "arkher.render.antialiasing.probe_volume"
	S.name = "Antialiasing Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Antialiasing"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.antialiasing.lighting_rig" }
	S.tags = { "f", "antialiasing", "probe", "render" }
	S.description = "Antialiasing Probe Volume: irradiance probes encoded in spherical harmonics for the Antialiasing subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.antialiasing.probe_volume", spacing = 8 })
		inst.system = S
		inst.ctx = ctx
