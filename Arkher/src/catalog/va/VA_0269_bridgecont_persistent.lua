-- ARKHER SYSTEM VA.0269 :: Bridge Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0269"
	S.key = "arkher.contworld.bridgecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.bridgecont.multi-scale_fidelity" }
	S.tags = { "va", "bridgecont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.bridgecont.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
