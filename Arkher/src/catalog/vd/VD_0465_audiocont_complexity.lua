-- ARKHER SYSTEM VD.0465 :: Audio Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0465"
	S.key = "arkher.contsim.audiocont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.audiocont.world_memory_stream" }
	S.tags = { "vd", "audiocont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.audiocont.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
