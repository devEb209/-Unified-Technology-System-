-- ARKHER SYSTEM J.0108 :: Lip Sync Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0108"
	S.key = "arkher.character.lipsync.budget_governor"
	S.name = "Lip Sync Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.lipsync.variant_registry" }
	S.tags = { "j", "lipsync", "budgeter", "character" }
	S.description = "Lip Sync Budget Governor: per-character cost allocation in a crowd for the Lip Sync subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.lipsync.budget_governor", total = 404, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
