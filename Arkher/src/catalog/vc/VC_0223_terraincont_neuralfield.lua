-- ARKHER SYSTEM VC.0223 :: Terrain Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0223"
	S.key = "arkher.contneural.terraincont.neural_field"
	S.name = "Terrain Continuum Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.terraincont.coherence_guard" }
	S.tags = { "vc", "terraincont", "neuralfield", "contneural" }
	S.description = "Terrain Continuum Neural Field: neural field encoding and reconstruction for the Terrain Continuum subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.terraincont.neural_field", dims = 24, hidden = 20, seed = 32831 })
		inst.system = S
		inst.ctx = ctx
