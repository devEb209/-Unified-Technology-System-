-- ARKHER SYSTEM VD.0613 :: Occupancy Map Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0613"
	S.key = "arkher.contsim.occupancymap.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "occupancymap", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.occupancymap.infinite_grid", cellSize = 224, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
