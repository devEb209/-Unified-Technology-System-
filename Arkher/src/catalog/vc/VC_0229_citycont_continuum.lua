-- ARKHER SYSTEM VC.0229 :: City Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0229"
	S.key = "arkher.contneural.citycont.infinite_grid"
	S.name = "City Continuum Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "citycont", "continuum", "contneural" }
	S.description = "City Continuum Infinite Grid: seamless paging of the infinite world grid for the City Continuum subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.citycont.infinite_grid", cellSize = 192, radius = 400, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
