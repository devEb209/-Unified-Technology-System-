-- ARKHER SYSTEM V.0163 :: Particle Asset Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0163"
	S.key = "arkher.asset.particleasset.streaming_residency"
	S.name = "Particle Asset Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.particleasset.content_cache" }
	S.tags = { "v", "particleasset", "streamer", "asset" }
	S.description = "Particle Asset Streaming Residency: distance-driven load and unload of asset payloads for the Particle Asset subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.particleasset.streaming_residency", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
