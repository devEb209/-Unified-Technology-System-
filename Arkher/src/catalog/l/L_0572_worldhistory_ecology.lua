-- ARKHER SYSTEM L.0572 :: World History Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0572"
	S.key = "arkher.sim.worldhistory.ecology"
	S.name = "World History Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldhistory.simulation_core" }
	S.tags = { "l", "worldhistory", "ecology", "sim" }
	S.description = "World History Ecology: populations, predation, harvesting and carrying capacity for the World History subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.worldhistory.ecology" })
		inst.system = S
		inst.ctx = ctx
