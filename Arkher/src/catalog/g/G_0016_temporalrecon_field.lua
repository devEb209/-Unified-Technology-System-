-- ARKHER SYSTEM G.0016 :: Temporal Reconstruction Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0016"
	S.key = "arkher.neural.temporalrecon.feature_extraction"
	S.name = "Temporal Reconstruction Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.temporalrecon.inference_core" }
	S.tags = { "g", "temporalrecon", "field", "neural" }
	S.description = "Temporal Reconstruction Feature Extraction: signal features feeding the model for the Temporal Reconstruction subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.temporalrecon.feature_extraction", seed = 17770, frequency = 0.0065, octaves = 5, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
