-- ARKHER SYSTEM VD.0363 :: Quest Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0363"
	S.key = "arkher.contsim.questcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.questcont.epoch_clock" }
	S.tags = { "vd", "questcont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.questcont.sparse_residency", capacity = 768, pageBytes = 7168 })
		inst.system = S
		inst.ctx = ctx
