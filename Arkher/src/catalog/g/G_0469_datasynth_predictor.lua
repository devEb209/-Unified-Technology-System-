-- ARKHER SYSTEM G.0469 :: Training Data Synthesis Quality Predictor
...
return function(A)
	...
	local S = {}
	S.id = "G.0469"
	S.key = "arkher.neural.datasynth.quality_predictor"
	S.name = "Training Data Synthesis Quality Predictor"
	S.category = "G"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.datasynth.weight_codec" }
	S.tags = { "g", "datasynth", "predictor", "neural" }
	S.description = "Training Data Synthesis Quality Predictor: predicted quality and cost of a setting for the Training Data Synthesis subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.neural.datasynth.quality_predictor", method = "markov", alpha = 0.20, window = 106 })
		inst.system = S
		inst.ctx = ctx
