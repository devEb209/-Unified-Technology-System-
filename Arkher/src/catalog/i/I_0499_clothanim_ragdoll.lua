-- ARKHER SYSTEM I.0499 :: Cloth Animation Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0499"
	S.key = "arkher.anim.clothanim.physical_blend"
	S.name = "Cloth Animation Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.clothanim.inverse_kinematics" }
	S.tags = { "i", "clothanim", "ragdoll", "anim" }
	S.description = "Cloth Animation Physical Blend: physical bones blended against the animated pose for the Cloth Animation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.clothanim.physical_blend", blendSpeed = 3.30 })
		inst.system = S
		inst.ctx = ctx
