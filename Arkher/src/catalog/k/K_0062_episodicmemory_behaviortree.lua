-- ARKHER SYSTEM K.0062 :: Episodic Memory Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0062"
	S.key = "arkher.npc.episodicmemory.reactive_behaviour"
	S.name = "Episodic Memory Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.episodicmemory.perception" }
	S.tags = { "k", "episodicmemory", "behaviortree", "npc" }
	S.description = "Episodic Memory Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Episodic Memory subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.episodicmemory.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
