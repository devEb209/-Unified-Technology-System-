-- ARKHER SYSTEM F.0036 :: Opaque Pass Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0036"
	S.key = "arkher.render.opaquepass.adaptive_resolution"
	S.name = "Opaque Pass Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Opaque Pass"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.opaquepass.temporal_resolve" }
	S.tags = { "f", "opaquepass", "upscaler", "render" }
	S.description = "Opaque Pass Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Opaque Pass subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.opaquepass.adaptive_resolution", targetMs = 15.10, index = 4, sharpness = 0.26 })
		inst.system = S
		inst.ctx = ctx
