-- ARKHER SYSTEM N.0174 :: Hail Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0174"
	S.key = "arkher.vfx.hail.curve_authoring"
	S.name = "Hail Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Hail"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.hail.ribbon_and_trail" }
	S.tags = { "n", "hail", "spline", "vfx" }
	S.description = "Hail Curve Authoring: authored curves driving the effect over its life for the Hail subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.hail.curve_authoring", tension = 0.43, closed = false })
		inst.system = S
		inst.ctx = ctx
