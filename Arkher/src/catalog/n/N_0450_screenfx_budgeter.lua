-- ARKHER SYSTEM N.0450 :: Screen Effect Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0450"
	S.key = "arkher.vfx.screenfx.spawn_budget"
	S.name = "Screen Effect Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.screenfx.effect_composition" }
	S.tags = { "n", "screenfx", "budgeter", "vfx" }
	S.description = "Screen Effect Spawn Budget: global particle budget shared by every live effect for the Screen Effect subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.screenfx.spawn_budget", total = 265, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
