-- ARKHER SYSTEM O.0393 :: Accessibility Audio Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0393"
	S.key = "arkher.audio.audioaccessibility.playback_policy"
	S.name = "Accessibility Audio Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audioaccessibility.compression_codec" }
	S.tags = { "o", "audioaccessibility", "policy", "audio" }
	S.description = "Accessibility Audio Playback Policy: rules choosing what may be heard right now for the Accessibility Audio subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.audioaccessibility.playback_policy", algorithm = "edf", starvationGuard = 53 })
		inst.system = S
		inst.ctx = ctx
