-- ARKHER SYSTEM J.0261 :: Damage State Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0261"
	S.key = "arkher.character.damagestate.variant_registry"
	S.name = "Damage State Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.damagestate.appearance_composer" }
	S.tags = { "j", "damagestate", "registry", "character" }
	S.description = "Damage State Variant Registry: named character variants and their lifecycle for the Damage State subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.damagestate.variant_registry" })
		inst.system = S
		inst.ctx = ctx
