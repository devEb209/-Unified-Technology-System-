-- ARKHER SYSTEM K.0079 :: Semantic Memory Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0079"
	S.key = "arkher.npc.semanticmemory.navigation"
	S.name = "Semantic Memory Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.semanticmemory.goal_planner" }
	S.tags = { "k", "semanticmemory", "navgraph", "npc" }
	S.description = "Semantic Memory Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Semantic Memory subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.semanticmemory.navigation", width = 32, height = 32, cellSize = 3 })
		inst.system = S
		inst.ctx = ctx
