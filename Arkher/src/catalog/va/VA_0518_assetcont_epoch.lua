-- ARKHER SYSTEM VA.0518 :: Asset Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0518"
	S.key = "arkher.contworld.assetcont.epoch_clock"
	S.name = "Asset Continuum Epoch Clock"
	S.category = "VA"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.assetcont.infinite_grid" }
	S.tags = { "va", "assetcont", "epoch", "contworld" }
	S.description = "Asset Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Asset Continuum subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.assetcont.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
