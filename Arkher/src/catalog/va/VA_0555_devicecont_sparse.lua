-- ARKHER SYSTEM VA.0555 :: Device Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0555"
	S.key = "arkher.contworld.devicecont.sparse_residency"
	S.name = "Device Continuum Sparse Residency"
	S.category = "VA"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.devicecont.epoch_clock" }
	S.tags = { "va", "devicecont", "sparse", "contworld" }
	S.description = "Device Continuum Sparse Residency: sparse page residency with eviction and compression for the Device Continuum subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.devicecont.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
