-- ARKHER SYSTEM E.0184 :: Anisotropy Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0184"
	S.key = "arkher.material.anisotropy.texture_sampling"
	S.name = "Anisotropy Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Anisotropy"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.anisotropy.shading_graph" }
	S.tags = { "e", "anisotropy", "sampler", "material" }
	S.description = "Anisotropy Texture Sampling: atlas packing, mip chain and filtered sampling for the Anisotropy subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.anisotropy.texture_sampling", atlasSize = 256, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
