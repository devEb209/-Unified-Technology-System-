-- ARKHER SYSTEM T.0394 :: Performance Reasoning Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0394"
	S.key = "arkher.ai.performancereasoning.semantic_knowledge"
	S.name = "Performance Reasoning Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.performancereasoning.intent_understanding" }
	S.tags = { "t", "performancereasoning", "knowledge", "ai" }
	S.description = "Performance Reasoning Semantic Knowledge: typed entities, weighted relations and inferred closure for the Performance Reasoning subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.performancereasoning.semantic_knowledge", dims = 24 })
		inst.system = S
		inst.ctx = ctx
