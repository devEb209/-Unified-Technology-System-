-- ARKHER SYSTEM Q.0330 :: Keyboard Focus Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0330"
	S.key = "arkher.ui.keyboardfocus.theme_composition"
	S.name = "Keyboard Focus Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.keyboardfocus.navigation_graph" }
	S.tags = { "q", "keyboardfocus", "composer", "ui" }
	S.description = "Keyboard Focus Theme Composition: blending of theme signals into the final appearance for the Keyboard Focus subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.keyboardfocus.theme_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
