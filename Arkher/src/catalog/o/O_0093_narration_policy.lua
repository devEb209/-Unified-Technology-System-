-- ARKHER SYSTEM O.0093 :: Narration Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0093"
	S.key = "arkher.audio.narration.playback_policy"
	S.name = "Narration Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Narration"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.narration.compression_codec" }
	S.tags = { "o", "narration", "policy", "audio" }
	S.description = "Narration Playback Policy: rules choosing what may be heard right now for the Narration subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.narration.playback_policy", algorithm = "lottery", starvationGuard = 19 })
		inst.system = S
		inst.ctx = ctx
