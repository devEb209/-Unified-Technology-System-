-- ARKHER SYSTEM J.0134 :: Blinking Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0134"
	S.key = "arkher.character.blinking.motion_set"
	S.name = "Blinking Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.blinking.rig_definition" }
	S.tags = { "j", "blinking", "clip", "character" }
	S.description = "Blinking Motion Set: the clips a character owns and how they sample for the Blinking subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.blinking.motion_set", duration = 2.50, loop = true })
		inst.system = S
		inst.ctx = ctx
