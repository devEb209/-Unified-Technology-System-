-- ARKHER SYSTEM P.0243 :: Objective Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0243"
	S.key = "arkher.play.objective.objectives"
	S.name = "Objective Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Objective"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.objective.inventory" }
	S.tags = { "p", "objective", "quest", "play" }
	S.description = "Objective Objectives: objectives, prerequisites, progress and rewards for the Objective subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.objective.objectives" })
		inst.system = S
		inst.ctx = ctx
