-- ARKHER SYSTEM VD.0078 :: LOD Cascade Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0078"
	S.key = "arkher.contsim.lodcascade.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lodcascade.persistent_state" }
	S.tags = { "vd", "lodcascade", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.lodcascade.coherence_guard", window = 132, threshold = 0.12 })
		inst.system = S
		inst.ctx = ctx
