-- ARKHER SYSTEM F.0558 :: Particle Rendering Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0558"
	S.key = "arkher.render.particlerender.frame_analysis"
	S.name = "Particle Rendering Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.particlerender.pass_cache" }
	S.tags = { "f", "particlerender", "analyzer", "render" }
	S.description = "Particle Rendering Frame Analysis: per-pass cost analysis and outlier detection for the Particle Rendering subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.particlerender.frame_analysis", window = 64, buckets = 16, threshold = 4.60 })
		inst.system = S
		inst.ctx = ctx
