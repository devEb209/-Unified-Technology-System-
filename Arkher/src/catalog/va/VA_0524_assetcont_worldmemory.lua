-- ARKHER SYSTEM VA.0524 :: Asset Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0524"
	S.key = "arkher.contworld.assetcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.assetcont.neural_field" }
	S.tags = { "va", "assetcont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.assetcont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
