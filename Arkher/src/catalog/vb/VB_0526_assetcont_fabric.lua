-- ARKHER SYSTEM VB.0526 :: Asset Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0526"
	S.key = "arkher.conttime.assetcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.assetcont.complexity_budget" }
	S.tags = { "vb", "assetcont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.assetcont.simulation_fabric", budgetMs = 2.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
