-- ARKHER SYSTEM K.0381 :: Goal Selection Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0381"
	S.key = "arkher.npc.goalselection.drive_system"
	S.name = "Goal Selection Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.goalselection.memory" }
	S.tags = { "k", "goalselection", "need", "npc" }
	S.description = "Goal Selection Drive System: drives that decay, turn urgent and get satisfied for the Goal Selection subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.goalselection.drive_system" })
		inst.system = S
		inst.ctx = ctx
