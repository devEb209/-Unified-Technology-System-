-- ARKHER SYSTEM K.0230 :: Personality Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0230"
	S.key = "arkher.npc.personality.reactive_behaviour"
	S.name = "Personality Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.personality.perception" }
	S.tags = { "k", "personality", "behaviortree", "npc" }
	S.description = "Personality Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Personality subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.personality.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
