-- ARKHER SYSTEM V.0388 :: Platform Variant Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0388"
	S.key = "arkher.asset.platformvariant.asset_registry"
	S.name = "Platform Variant Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.platformvariant.cook_pipeline" }
	S.tags = { "v", "platformvariant", "registry", "asset" }
	S.description = "Platform Variant Asset Registry: catalogue of every asset, its tags and its metadata for the Platform Variant subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.platformvariant.asset_registry" })
		inst.system = S
		inst.ctx = ctx
