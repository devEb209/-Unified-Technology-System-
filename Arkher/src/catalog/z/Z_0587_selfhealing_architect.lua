-- ARKHER SYSTEM Z.0587 :: Self Healing Systems World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0587"
	S.key = "arkher.origin.selfhealing.world_architect"
	S.name = "Self Healing Systems World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfhealing.emergence_detection" }
	S.tags = { "z", "selfhealing", "architect", "origin" }
	S.description = "Self Healing Systems World Architect: hierarchical world composition with conserved budgets for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.selfhealing.world_architect", budget = 1500, seed = 71409 })
		inst.system = S
		inst.ctx = ctx
