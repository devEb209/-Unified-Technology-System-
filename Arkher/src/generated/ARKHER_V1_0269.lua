--!strict
-- Godot4 — ANIMATION Profiler #0269
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Godot4 — ANIMATION Profiler #0269", size=Vector2.new(680, 500), pos=UDim2.fromOffset(397, 233), parent=parent, icon="✎"})
