-- ARKHER SYSTEM N.0118 :: Water Splash Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0118"
	S.key = "arkher.vfx.splash.emission"
	S.name = "Water Splash Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Water Splash"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "splash", "emitter", "vfx" }
	S.description = "Water Splash Emission: shaped, rate and burst emission of new particles for the Water Splash subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.splash.emission", shape = "cone", rate = 48, speed = 3.80, life = 3.60, budget = 128, seed = 64768 })
		inst.system = S
		inst.ctx = ctx
