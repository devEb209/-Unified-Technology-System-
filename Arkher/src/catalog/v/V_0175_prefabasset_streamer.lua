-- ARKHER SYSTEM V.0175 :: Prefab Asset Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0175"
	S.key = "arkher.asset.prefabasset.streaming_residency"
	S.name = "Prefab Asset Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.prefabasset.content_cache" }
	S.tags = { "v", "prefabasset", "streamer", "asset" }
	S.description = "Prefab Asset Streaming Residency: distance-driven load and unload of asset payloads for the Prefab Asset subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.prefabasset.streaming_residency", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
