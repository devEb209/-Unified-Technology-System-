-- ARKHER SYSTEM P.0339 :: Cooldown Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0339"
	S.key = "arkher.play.cooldown.objectives"
	S.name = "Cooldown Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Cooldown"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.cooldown.inventory" }
	S.tags = { "p", "cooldown", "quest", "play" }
	S.description = "Cooldown Objectives: objectives, prerequisites, progress and rewards for the Cooldown subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.cooldown.objectives" })
		inst.system = S
		inst.ctx = ctx
