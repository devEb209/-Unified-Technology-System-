-- ARKHER SYSTEM VB.0479 :: VFX Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0479"
	S.key = "arkher.conttime.vfxcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vfxcont.simulation_fabric" }
	S.tags = { "vb", "vfxcont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.vfxcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
