-- ARKHER SYSTEM K.0370 :: Utility Selection Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0370"
	S.key = "arkher.npc.utilityselection.reactive_behaviour"
	S.name = "Utility Selection Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.utilityselection.perception" }
	S.tags = { "k", "utilityselection", "behaviortree", "npc" }
	S.description = "Utility Selection Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Utility Selection subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.utilityselection.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
