-- ARKHER SYSTEM VC.0124 :: Spatial Slice Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VC.0124"
	S.key = "arkher.contneural.spatialslice.multi-scale_fidelity"
	S.name = "Spatial Slice Multi-Scale Fidelity"
	S.category = "VC"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.spatialslice.sparse_residency" }
	S.tags = { "vc", "spatialslice", "multiscale", "contneural" }
	S.description = "Spatial Slice Multi-Scale Fidelity: distance-driven multi-scale level selection for the Spatial Slice subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contneural.spatialslice.multi-scale_fidelity", levels = 5, baseTriangles = 120000 })
		inst.system = S
		inst.ctx = ctx
