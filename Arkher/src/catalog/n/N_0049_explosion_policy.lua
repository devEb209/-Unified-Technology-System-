-- ARKHER SYSTEM N.0049 :: Explosion Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0049"
	S.key = "arkher.vfx.explosion.quality_policy"
	S.name = "Explosion Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Explosion"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.explosion.result_cache" }
	S.tags = { "n", "explosion", "policy", "vfx" }
	S.description = "Explosion Quality Policy: distance and device driven fidelity bands for the Explosion subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.explosion.quality_policy", algorithm = "wfq", starvationGuard = 18 })
		inst.system = S
		inst.ctx = ctx
