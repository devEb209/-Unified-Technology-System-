-- ARKHER SYSTEM T.0133 :: Skill Library Decision Policy
...
return function(A)
	...
	local S = {}
	S.id = "T.0133"
	S.key = "arkher.ai.skilllibrary.decision_policy"
	S.name = "Skill Library Decision Policy"
	S.category = "T"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.skilllibrary.reasoning_graph" }
	S.tags = { "t", "skilllibrary", "policy", "ai" }
	S.description = "Skill Library Decision Policy: ordered rules deciding what the agent does next for the Skill Library subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.ai.skilllibrary.decision_policy", algorithm = "wfq", starvationGuard = 38 })
		inst.system = S
		inst.ctx = ctx
