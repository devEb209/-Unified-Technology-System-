-- ARKHER SYSTEM R.0344 :: Reconnection Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0344"
	S.key = "arkher.net.reconnection.rate_guard"
	S.name = "Reconnection Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Reconnection"
	S.aspect = "Rate Guard"
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reconnection.interest_streaming" }
	S.tags = { "r", "reconnection", "guard", "net" }
	S.description = "Reconnection Rate Guard: token-bucket protection against floods and abuse for the Reconnection subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.reconnection.rate_guard", algorithm = "token", capacity = 119, refillPerSec = 44, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
