-- ARKHER SYSTEM VA.0589 :: Horizon Span Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0589"
	S.key = "arkher.contworld.horizonspan.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "horizonspan", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.horizonspan.infinite_grid", cellSize = 128, radius = 880, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
