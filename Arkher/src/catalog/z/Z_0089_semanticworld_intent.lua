-- ARKHER SYSTEM Z.0089 :: Semantic World Graph Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0089"
	S.key = "arkher.origin.semanticworld.intent_bridge"
	S.name = "Semantic World Graph Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticworld.semantic_graph" }
	S.tags = { "z", "semanticworld", "intent", "origin" }
	S.description = "Semantic World Graph Intent Bridge: natural language control surface for the technology for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.semanticworld.intent_bridge", minConfidence = 0.39 })
		inst.system = S
		inst.ctx = ctx
