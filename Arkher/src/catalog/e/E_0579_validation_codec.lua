-- ARKHER SYSTEM E.0579 :: Material Validation Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0579"
	S.key = "arkher.material.validation.compression_codec"
	S.name = "Material Validation Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.validation.streaming" }
	S.tags = { "e", "validation", "codec", "material" }
	S.description = "Material Validation Compression Codec: serialization and compression of material data for the Material Validation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.validation.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
