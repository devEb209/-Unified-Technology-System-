-- ARKHER SYSTEM K.0255 :: Vision Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0255"
	S.key = "arkher.npc.vision.drive_system"
	S.name = "Vision Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.vision.memory" }
	S.tags = { "k", "vision", "need", "npc" }
	S.description = "Vision Drive System: drives that decay, turn urgent and get satisfied for the Vision subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.vision.drive_system" })
		inst.system = S
		inst.ctx = ctx
