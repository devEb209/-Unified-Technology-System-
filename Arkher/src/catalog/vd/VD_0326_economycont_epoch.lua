-- ARKHER SYSTEM VD.0326 :: Economy Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0326"
	S.key = "arkher.contsim.economycont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.economycont.infinite_grid" }
	S.tags = { "vd", "economycont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.economycont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
