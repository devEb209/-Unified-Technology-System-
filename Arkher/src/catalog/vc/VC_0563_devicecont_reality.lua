-- ARKHER SYSTEM VC.0563 :: Device Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0563"
	S.key = "arkher.contneural.devicecont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.devicecont.simulation_fabric" }
	S.tags = { "vc", "devicecont", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.devicecont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
