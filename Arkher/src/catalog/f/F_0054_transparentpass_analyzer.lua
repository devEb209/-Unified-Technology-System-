-- ARKHER SYSTEM F.0054 :: Transparent Pass Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0054"
	S.key = "arkher.render.transparentpass.frame_analysis"
	S.name = "Transparent Pass Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.transparentpass.pass_cache" }
	S.tags = { "f", "transparentpass", "analyzer", "render" }
	S.description = "Transparent Pass Frame Analysis: per-pass cost analysis and outlier detection for the Transparent Pass subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.transparentpass.frame_analysis", window = 58, buckets = 10, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
