-- ARKHER SYSTEM VC.0523 :: Asset Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0523"
	S.key = "arkher.contneural.assetcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.assetcont.coherence_guard" }
	S.tags = { "vc", "assetcont", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.assetcont.neural_field", dims = 20, hidden = 16, seed = 6878 })
		inst.system = S
		inst.ctx = ctx
