-- ARKHER SYSTEM V.0178 :: Prefab Asset Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0178"
	S.key = "arkher.asset.prefabasset.validation_guard"
	S.name = "Prefab Asset Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.prefabasset.size_budget" }
	S.tags = { "v", "prefabasset", "guard", "asset" }
	S.description = "Prefab Asset Validation Guard: rate limiting and capability checks on the import path for the Prefab Asset subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.prefabasset.validation_guard", algorithm = "sliding", capacity = 180, refillPerSec = 45, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
