-- ARKHER SYSTEM Z.0823 :: Reality Blending Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0823"
	S.key = "arkher.origin.realityblending.simulation_fabric"
	S.name = "Reality Blending Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.complexity_governance" }
	S.tags = { "z", "realityblending", "fabric", "origin" }
	S.description = "Reality Blending Simulation Fabric: every simulation domain stepped under one budgeted clock for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.realityblending.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
