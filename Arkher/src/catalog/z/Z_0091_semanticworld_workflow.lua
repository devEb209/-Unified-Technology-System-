-- ARKHER SYSTEM Z.0091 :: Semantic World Graph Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0091"
	S.key = "arkher.origin.semanticworld.adaptive_workflow"
	S.name = "Semantic World Graph Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.semanticworld.self_critique" }
	S.tags = { "z", "semanticworld", "workflow", "origin" }
	S.description = "Semantic World Graph Adaptive Workflow: verified, retryable, reversible execution plans for the Semantic World Graph subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.semanticworld.adaptive_workflow", maxRetries = 1, budget = 70 })
		inst.system = S
		inst.ctx = ctx
