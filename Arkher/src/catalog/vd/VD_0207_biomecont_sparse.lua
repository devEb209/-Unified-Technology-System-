-- ARKHER SYSTEM VD.0207 :: Biome Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0207"
	S.key = "arkher.contsim.biomecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.biomecont.epoch_clock" }
	S.tags = { "vd", "biomecont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.biomecont.sparse_residency", capacity = 256, pageBytes = 3072 })
		inst.system = S
		inst.ctx = ctx
