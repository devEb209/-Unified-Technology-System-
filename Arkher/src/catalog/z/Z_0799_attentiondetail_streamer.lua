-- ARKHER SYSTEM Z.0799 :: Attention Driven Detail Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0799"
	S.key = "arkher.origin.attentiondetail.residency_streaming"
	S.name = "Attention Driven Detail Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.budget_governor" }
	S.tags = { "z", "attentiondetail", "streamer", "origin" }
	S.description = "Attention Driven Detail Residency Streaming: distance-driven residency of the technology's workload for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.attentiondetail.residency_streaming", radius = 320, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
