-- ARKHER SYSTEM VA.0006 :: World Grid Cell Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0006"
	S.key = "arkher.contworld.worldcell.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldcell.persistent_state" }
	S.tags = { "va", "worldcell", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.worldcell.coherence_guard", window = 90, threshold = 0.14 })
		inst.system = S
		inst.ctx = ctx
