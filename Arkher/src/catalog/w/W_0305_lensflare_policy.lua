-- ARKHER SYSTEM W.0305 :: Lens Flare Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0305"
	S.key = "arkher.cine.lensflare.cut_policy"
	S.name = "Lens Flare Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Lens Flare"
	S.aspect = "Cut Policy"
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.lensflare.shot_composition" }
	S.tags = { "w", "lensflare", "policy", "cine" }
	S.description = "Lens Flare Cut Policy: rules deciding when the sequence cuts and to what for the Lens Flare subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.lensflare.cut_policy", algorithm = "lottery", starvationGuard = 35 })
		inst.system = S
		inst.ctx = ctx
