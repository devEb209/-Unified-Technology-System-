-- ARKHER SYSTEM H.0319 :: Mesh Collider Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0319"
	S.key = "arkher.physics.meshcollider.result_cache"
	S.name = "Mesh Collider Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.meshcollider.simulation_policy" }
	S.tags = { "h", "meshcollider", "cache", "physics" }
	S.description = "Mesh Collider Result Cache: reuse of expensive simulation and query results for the Mesh Collider subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.meshcollider.result_cache", policy = "lfu", capacity = 137, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
