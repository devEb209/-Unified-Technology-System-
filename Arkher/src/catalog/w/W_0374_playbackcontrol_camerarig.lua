-- ARKHER SYSTEM W.0374 :: Playback Control Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0374"
	S.key = "arkher.cine.playbackcontrol.camera_rig"
	S.name = "Playback Control Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.playbackcontrol.sequence_timeline" }
	S.tags = { "w", "playbackcontrol", "camerarig", "cine" }
	S.description = "Playback Control Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Playback Control subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.playbackcontrol.camera_rig", fov = 1.08, focus = 16.0, aperture = 4.4, smoothing = 12.0, distance = 18, height = 2 })
		inst.system = S
		inst.ctx = ctx
