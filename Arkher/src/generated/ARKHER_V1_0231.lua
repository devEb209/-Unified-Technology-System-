--!strict
-- Marvelous — ANIMATION Node_Flow #0231
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Marvelous — ANIMATION Node_Flow #0231", size=Vector2.new(600, 440), pos=UDim2.fromOffset(303, 107), parent=parent, icon="⬢"})
