-- ARKHER SYSTEM VD.0225 :: Terrain Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0225"
	S.key = "arkher.contsim.terraincont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.terraincont.world_memory_stream" }
	S.tags = { "vd", "terraincont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.terraincont.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
