-- ARKHER SYSTEM VC.0551 :: World Fabric Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0551"
	S.key = "arkher.contneural.worldfabric.reality_continuum"
	S.name = "World Fabric Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldfabric.simulation_fabric" }
	S.tags = { "vc", "worldfabric", "reality", "contneural" }
	S.description = "World Fabric Reality Continuum: stacked reality layers of the continuum for the World Fabric subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.worldfabric.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
