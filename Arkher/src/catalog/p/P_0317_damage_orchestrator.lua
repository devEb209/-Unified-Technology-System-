-- ARKHER SYSTEM P.0317 :: Damage State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0317"
	S.key = "arkher.play.damage.state_machine"
	S.name = "Damage State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Damage"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.damage.combat_resolution" }
	S.tags = { "p", "damage", "orchestrator", "play" }
	S.description = "Damage State Machine: the phase machine that drives this gameplay loop for the Damage subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.damage.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
