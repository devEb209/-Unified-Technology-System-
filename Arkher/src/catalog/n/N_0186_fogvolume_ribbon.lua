-- ARKHER SYSTEM N.0186 :: Fog Volume Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0186"
	S.key = "arkher.vfx.fogvolume.ribbon_and_trail"
	S.name = "Fog Volume Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fog Volume"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fogvolume.force_field" }
	S.tags = { "n", "fogvolume", "ribbon", "vfx" }
	S.description = "Fog Volume Ribbon And Trail: trail points, tapering, beams and decimation for the Fog Volume subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.fogvolume.ribbon_and_trail", maxPoints = 16, lifetime = 1.30, minDistance = 0.50, width = 0.20 })
		inst.system = S
		inst.ctx = ctx
