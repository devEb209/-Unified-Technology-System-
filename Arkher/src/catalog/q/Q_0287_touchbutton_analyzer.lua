-- ARKHER SYSTEM Q.0287 :: Touch Button Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0287"
	S.key = "arkher.ui.touchbutton.usability_analysis"
	S.name = "Touch Button Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Touch Button"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.touchbutton.frame_budget" }
	S.tags = { "q", "touchbutton", "analyzer", "ui" }
	S.description = "Touch Button Usability Analysis: reachability, latency and abandonment analysis for the Touch Button subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.touchbutton.usability_analysis", window = 62, buckets = 14, threshold = 4.40 })
		inst.system = S
		inst.ctx = ctx
