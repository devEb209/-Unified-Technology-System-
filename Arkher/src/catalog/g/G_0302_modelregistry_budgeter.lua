-- ARKHER SYSTEM G.0302 :: Model Registry Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0302"
	S.key = "arkher.neural.modelregistry.compute_budget"
	S.name = "Model Registry Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelregistry.quality_predictor" }
	S.tags = { "g", "modelregistry", "budgeter", "neural" }
	S.description = "Model Registry Compute Budget: inference time budget allocation for the Model Registry subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.modelregistry.compute_budget", total = 249, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
