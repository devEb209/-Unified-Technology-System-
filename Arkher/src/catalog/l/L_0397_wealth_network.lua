-- ARKHER SYSTEM L.0397 :: Wealth Distribution Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0397"
	S.key = "arkher.sim.wealth.route_network"
	S.name = "Wealth Distribution Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wealth.region_graph" }
	S.tags = { "l", "wealth", "network", "sim" }
	S.description = "Wealth Distribution Route Network: roads, rivers and routes between settlements for the Wealth Distribution subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.wealth.route_network" })
		inst.system = S
		inst.ctx = ctx
