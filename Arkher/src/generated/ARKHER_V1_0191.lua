--!strict
-- Mixamo — ANIMATION Node_Flow #0191
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Mixamo — ANIMATION Node_Flow #0191", size=Vector2.new(680, 440), pos=UDim2.fromOffset(183, 207), parent=parent, icon="◤"})
