-- ARKHER SYSTEM G.0494 :: Neural Debug Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0494"
	S.key = "arkher.neural.neuraldebug.reconstruction"
	S.name = "Neural Debug Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuraldebug.temporal_history" }
	S.tags = { "g", "neuraldebug", "upscaler", "neural" }
	S.description = "Neural Debug Reconstruction: resolution ladder and image reconstruction for the Neural Debug subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.neuraldebug.reconstruction", targetMs = 13.10, index = 5, sharpness = 0.40 })
		inst.system = S
		inst.ctx = ctx
