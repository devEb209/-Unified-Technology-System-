-- ARKHER SYSTEM VD.0054 :: Epoch Frame Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0054"
	S.key = "arkher.contsim.epochframe.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.epochframe.persistent_state" }
	S.tags = { "vd", "epochframe", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.epochframe.coherence_guard", window = 82, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
