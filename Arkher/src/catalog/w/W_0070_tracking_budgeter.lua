-- ARKHER SYSTEM W.0070 :: Tracking Shot Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0070"
	S.key = "arkher.cine.tracking.frame_budget"
	S.name = "Tracking Shot Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.tracking.event_ledger" }
	S.tags = { "w", "tracking", "budgeter", "cine" }
	S.description = "Tracking Shot Frame Budget: per-frame cost budget for the cinematic systems for the Tracking Shot subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.tracking.frame_budget", total = 377, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
