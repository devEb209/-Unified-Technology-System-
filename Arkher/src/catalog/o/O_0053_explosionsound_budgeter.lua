-- ARKHER SYSTEM O.0053 :: Explosion Sound Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0053"
	S.key = "arkher.audio.explosionsound.voice_budget"
	S.name = "Explosion Sound Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.explosionsound.music_sequencer" }
	S.tags = { "o", "explosionsound", "budgeter", "audio" }
	S.description = "Explosion Sound Voice Budget: voice slots allocated by priority and audibility for the Explosion Sound subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.explosionsound.voice_budget", total = 158, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
