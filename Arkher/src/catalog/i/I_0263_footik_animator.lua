-- ARKHER SYSTEM I.0263 :: Foot Placement IK Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0263"
	S.key = "arkher.anim.footik.layered_blending"
	S.name = "Foot Placement IK Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.footik.clip_sampling" }
	S.tags = { "i", "footik", "animator", "anim" }
	S.description = "Foot Placement IK Layered Blending: layers, crossfades, masks and blend trees for the Foot Placement IK subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.footik.layered_blending", budget = 6 })
		inst.system = S
		inst.ctx = ctx
