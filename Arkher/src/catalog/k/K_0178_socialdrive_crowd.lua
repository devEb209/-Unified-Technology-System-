-- ARKHER SYSTEM K.0178 :: Social Drive Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0178"
	S.key = "arkher.npc.socialdrive.crowd_steering"
	S.name = "Social Drive Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.socialdrive.navigation" }
	S.tags = { "k", "socialdrive", "crowd", "npc" }
	S.description = "Social Drive Crowd Steering: local avoidance, cohesion and arrival at scale for the Social Drive subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.socialdrive.crowd_steering", radius = 0.55, maxSpeed = 5.30, cellSize = 11 })
		inst.system = S
		inst.ctx = ctx
