-- ARKHER SYSTEM F.0585 :: Debug Visualization Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0585"
	S.key = "arkher.render.debugvis.pass_cache"
	S.name = "Debug Visualization Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.debugvis.render_policy" }
	S.tags = { "f", "debugvis", "cache", "render" }
	S.description = "Debug Visualization Pass Cache: reuse of pass results across frames for the Debug Visualization subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.debugvis.pass_cache", policy = "lfu", capacity = 473, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
