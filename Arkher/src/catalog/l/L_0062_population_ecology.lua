-- ARKHER SYSTEM L.0062 :: Population Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0062"
	S.key = "arkher.sim.population.ecology"
	S.name = "Population Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.population.simulation_core" }
	S.tags = { "l", "population", "ecology", "sim" }
	S.description = "Population Ecology: populations, predation, harvesting and carrying capacity for the Population subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.population.ecology" })
		inst.system = S
		inst.ctx = ctx
