-- ARKHER SYSTEM T.0261 :: Narrative Design Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0261"
	S.key = "arkher.ai.narrativedesign.working_memory"
	S.name = "Narrative Design Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.narrativedesign.outcome_prediction" }
	S.tags = { "t", "narrativedesign", "memory", "ai" }
	S.description = "Narrative Design Working Memory: decaying, consolidating recall of what the agent learned for the Narrative Design subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.narrativedesign.working_memory", capacity = 111, decayRate = 0.035, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
