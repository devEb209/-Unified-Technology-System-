-- ARKHER SYSTEM VC.0253 :: Road Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0253"
	S.key = "arkher.contneural.roadcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "roadcont", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.roadcont.infinite_grid", cellSize = 192, radius = 560, horizon = 2624 })
		inst.system = S
		inst.ctx = ctx
