-- ARKHER SYSTEM H.0516 :: Motorized Joint Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0516"
	S.key = "arkher.physics.motorjoint.analysis"
	S.name = "Motorized Joint Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.motorjoint.result_cache" }
	S.tags = { "h", "motorjoint", "analyzer", "physics" }
	S.description = "Motorized Joint Analysis: energy, jitter and cost analysis of the simulation for the Motorized Joint subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.motorjoint.analysis", window = 170, buckets = 18, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
