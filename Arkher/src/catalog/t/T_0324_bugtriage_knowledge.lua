-- ARKHER SYSTEM T.0324 :: Bug Triage Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0324"
	S.key = "arkher.ai.bugtriage.semantic_knowledge"
	S.name = "Bug Triage Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.bugtriage.intent_understanding" }
	S.tags = { "t", "bugtriage", "knowledge", "ai" }
	S.description = "Bug Triage Semantic Knowledge: typed entities, weighted relations and inferred closure for the Bug Triage subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.bugtriage.semantic_knowledge", dims = 32 })
		inst.system = S
		inst.ctx = ctx
