-- ARKHER SYSTEM VD.0229 :: City Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0229"
	S.key = "arkher.contsim.citycont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "citycont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.citycont.infinite_grid", cellSize = 224, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
