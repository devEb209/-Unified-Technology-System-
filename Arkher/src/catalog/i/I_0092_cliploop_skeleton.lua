-- ARKHER SYSTEM I.0092 :: Clip Looping Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0092"
	S.key = "arkher.anim.cliploop.skeleton"
	S.name = "Clip Looping Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Looping"
	S.aspect = "Skeleton"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "cliploop", "skeleton", "anim" }
	S.description = "Clip Looping Skeleton: bone hierarchy, bind pose and world resolution for the Clip Looping subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.cliploop.skeleton" })
		inst.system = S
		inst.ctx = ctx
