-- ARKHER SYSTEM G.0164 :: Geometry Detail Prediction Heuristic Policy
...
return function(A)
	...
	local S = {}
	S.id = "G.0164"
	S.key = "arkher.neural.geodetail.heuristic_policy"
	S.name = "Geometry Detail Prediction Heuristic Policy"
	S.category = "G"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.geodetail.result_cache" }
	S.tags = { "g", "geodetail", "policy", "neural" }
	S.description = "Geometry Detail Prediction Heuristic Policy: rule fallback when the model is unavailable for the Geometry Detail Prediction subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.neural.geodetail.heuristic_policy", algorithm = "wfq", starvationGuard = 58 })
		inst.system = S
		inst.ctx = ctx
