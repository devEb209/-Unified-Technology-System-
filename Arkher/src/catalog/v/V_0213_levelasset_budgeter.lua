-- ARKHER SYSTEM V.0213 :: Level Asset Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0213"
	S.key = "arkher.asset.levelasset.size_budget"
	S.name = "Level Asset Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.levelasset.compression_codec" }
	S.tags = { "v", "levelasset", "budgeter", "asset" }
	S.description = "Level Asset Size Budget: byte budget shared between competing asset classes for the Level Asset subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.levelasset.size_budget", total = 140, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
