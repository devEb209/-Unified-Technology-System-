-- ARKHER SYSTEM Z.0460 :: Player Absence Simulation Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0460"
	S.key = "arkher.origin.playerabsence.orchestration"
	S.name = "Player Absence Simulation Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.residency_streaming" }
	S.tags = { "z", "playerabsence", "orchestrator", "origin" }
	S.description = "Player Absence Simulation Orchestration: lifecycle and phase orchestration of the technology for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.playerabsence.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
