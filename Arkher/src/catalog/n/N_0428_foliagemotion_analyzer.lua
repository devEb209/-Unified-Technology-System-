-- ARKHER SYSTEM N.0428 :: Foliage Motion Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0428"
	S.key = "arkher.vfx.foliagemotion.analysis"
	S.name = "Foliage Motion Analysis"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.foliagemotion.spatial_index" }
	S.tags = { "n", "foliagemotion", "analyzer", "vfx" }
	S.description = "Foliage Motion Analysis: cost, overdraw and stability analysis of the effect for the Foliage Motion subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.foliagemotion.analysis", window = 79, buckets = 11, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
