-- ARKHER SYSTEM Z.1035 :: Autonomous Balancing Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.1035"
	S.key = "arkher.origin.autobalancing.signal_composition"
	S.name = "Autonomous Balancing Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autobalancing.telemetry_ledger" }
	S.tags = { "z", "autobalancing", "composer", "origin" }
	S.description = "Autonomous Balancing Signal Composition: blending of the technology's input signals into one output for the Autonomous Balancing subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.autobalancing.signal_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
