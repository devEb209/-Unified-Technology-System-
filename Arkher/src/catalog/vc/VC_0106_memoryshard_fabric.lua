-- ARKHER SYSTEM VC.0106 :: Memory Shard Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0106"
	S.key = "arkher.contneural.memoryshard.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.memoryshard.complexity_budget" }
	S.tags = { "vc", "memoryshard", "fabric", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.memoryshard.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
