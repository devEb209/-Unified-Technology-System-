-- ARKHER SYSTEM VC.0494 :: Rendering Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0494"
	S.key = "arkher.contneural.rendercont.epoch_clock"
	S.name = "Rendering Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.rendercont.infinite_grid" }
	S.tags = { "vc", "rendercont", "epoch", "contneural" }
	S.description = "Rendering Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Rendering Continuum subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.rendercont.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
