-- ARKHER SYSTEM Z.0385 :: Thermal Aware Simulation World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0385"
	S.key = "arkher.origin.thermalaware.world_memory"
	S.name = "Thermal Aware Simulation World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.thermalaware.autonomous_pipeline" }
	S.tags = { "z", "thermalaware", "worldmemory", "origin" }
	S.description = "Thermal Aware Simulation World Memory: epoch-stamped persistent history with compaction and checkpoints for the Thermal Aware Simulation subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.thermalaware.world_memory", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
