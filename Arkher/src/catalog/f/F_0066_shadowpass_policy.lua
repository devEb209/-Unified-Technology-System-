-- ARKHER SYSTEM F.0066 :: Shadow Pass Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0066"
	S.key = "arkher.render.shadowpass.render_policy"
	S.name = "Shadow Pass Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Shadow Pass"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.shadowpass.draw_budget" }
	S.tags = { "f", "shadowpass", "policy", "render" }
	S.description = "Shadow Pass Render Policy: device tier rules for the frame for the Shadow Pass subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.shadowpass.render_policy", algorithm = "edf", starvationGuard = 61 })
		inst.system = S
		inst.ctx = ctx
