-- ARKHER SYSTEM V.0177 :: Prefab Asset Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0177"
	S.key = "arkher.asset.prefabasset.size_budget"
	S.name = "Prefab Asset Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.prefabasset.compression_codec" }
	S.tags = { "v", "prefabasset", "budgeter", "asset" }
	S.description = "Prefab Asset Size Budget: byte budget shared between competing asset classes for the Prefab Asset subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.prefabasset.size_budget", total = 232, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
