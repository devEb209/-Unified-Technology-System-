-- ARKHER SYSTEM Q.0023 :: Panel Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0023"
	S.key = "arkher.ui.panel.usability_analysis"
	S.name = "Panel Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Panel"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.panel.frame_budget" }
	S.tags = { "q", "panel", "analyzer", "ui" }
	S.description = "Panel Usability Analysis: reachability, latency and abandonment analysis for the Panel subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.panel.usability_analysis", window = 58, buckets = 14, threshold = 2.00 })
		inst.system = S
		inst.ctx = ctx
