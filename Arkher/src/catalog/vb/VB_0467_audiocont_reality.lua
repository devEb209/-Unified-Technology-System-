-- ARKHER SYSTEM VB.0467 :: Audio Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0467"
	S.key = "arkher.conttime.audiocont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.audiocont.simulation_fabric" }
	S.tags = { "vb", "audiocont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.audiocont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
