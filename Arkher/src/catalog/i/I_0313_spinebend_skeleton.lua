-- ARKHER SYSTEM I.0313 :: Spine Bend Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0313"
	S.key = "arkher.anim.spinebend.skeleton"
	S.name = "Spine Bend Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Spine Bend"
	S.aspect = "Skeleton"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "spinebend", "skeleton", "anim" }
	S.description = "Spine Bend Skeleton: bone hierarchy, bind pose and world resolution for the Spine Bend subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.spinebend.skeleton" })
		inst.system = S
		inst.ctx = ctx
