-- ARKHER SYSTEM F.0034 :: Opaque Pass Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0034"
	S.key = "arkher.render.opaquepass.probe_volume"
	S.name = "Opaque Pass Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Opaque Pass"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.opaquepass.lighting_rig" }
	S.tags = { "f", "opaquepass", "probe", "render" }
	S.description = "Opaque Pass Probe Volume: irradiance probes encoded in spherical harmonics for the Opaque Pass subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.opaquepass.probe_volume", spacing = 24 })
		inst.system = S
		inst.ctx = ctx
