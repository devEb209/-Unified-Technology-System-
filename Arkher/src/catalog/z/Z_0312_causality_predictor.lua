-- ARKHER SYSTEM Z.0312 :: Causality Ledger Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0312"
	S.key = "arkher.origin.causality.predictive_optimization"
	S.name = "Causality Ledger Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.adaptive_workflow" }
	S.tags = { "z", "causality", "predictor", "origin" }
	S.description = "Causality Ledger Predictive Optimization: forecast-driven optimization before the cost is paid for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.causality.predictive_optimization", method = "linear", alpha = 0.14, window = 84 })
		inst.system = S
		inst.ctx = ctx
