-- ARKHER SYSTEM E.0177 :: Clear Coat Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0177"
	S.key = "arkher.material.clearcoat.analysis"
	S.name = "Clear Coat Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Clear Coat"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.clearcoat.instance_cache" }
	S.tags = { "e", "clearcoat", "analyzer", "material" }
	S.description = "Clear Coat Analysis: cost, redundancy and outlier analysis for the Clear Coat subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.clearcoat.analysis", window = 221, buckets = 13, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
