-- ARKHER SYSTEM VC.0192 :: Simulation Domain Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0192"
	S.key = "arkher.contneural.simdomain.emergence_continuum"
	S.name = "Simulation Domain Emergence Continuum"
	S.category = "VC"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.simdomain.reality_continuum" }
	S.tags = { "vc", "simdomain", "emergence", "contneural" }
	S.description = "Simulation Domain Emergence Continuum: emergence detection over the continuum for the Simulation Domain subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.simdomain.emergence_continuum", windowSize = 4, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
