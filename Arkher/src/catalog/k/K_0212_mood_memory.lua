-- ARKHER SYSTEM K.0212 :: Mood Memory
...
return function(A)
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.mood.mind_network" }
	S.tags = { "k", "mood", "memory", "npc" }
	S.description = "Mood Memory: episodic memory with decay, recall and consolidation for the Mood subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.mood.memory", capacity = 91, decayRate = 0.065, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
