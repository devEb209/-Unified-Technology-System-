-- ARKHER SYSTEM H.0040 :: Kinematic Body Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0040"
	S.key = "arkher.physics.kinematicbody.analysis"
	S.name = "Kinematic Body Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.kinematicbody.result_cache" }
	S.tags = { "h", "kinematicbody", "analyzer", "physics" }
	S.description = "Kinematic Body Analysis: energy, jitter and cost analysis of the simulation for the Kinematic Body subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.kinematicbody.analysis", window = 233, buckets = 9, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
