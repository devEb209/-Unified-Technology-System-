-- ARKHER SYSTEM F.0629 :: Render Target Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0629"
	S.key = "arkher.render.rendertarget.orchestration"
	S.name = "Render Target Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.rendertarget.frame_analysis" }
	S.tags = { "f", "rendertarget", "orchestrator", "render" }
	S.description = "Render Target Orchestration: frame lifecycle orchestration for the Render Target subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.rendertarget.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
