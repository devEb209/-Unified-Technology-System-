-- ARKHER SYSTEM O.0181 :: Interior Audio DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0181"
	S.key = "arkher.audio.interioraudio.dsp_chain"
	S.name = "Interior Audio DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "interioraudio", "dsp", "audio" }
	S.description = "Interior Audio DSP Chain: biquad filtering, delay, envelope and soft clipping for the Interior Audio subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.interioraudio.dsp_chain", sampleRate = 22050, filter = "notch", cutoff = 4800, q = 0.650 })
		inst.system = S
		inst.ctx = ctx
