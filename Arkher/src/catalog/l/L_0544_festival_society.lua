-- ARKHER SYSTEM L.0544 :: Festival Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0544"
	S.key = "arkher.sim.festival.society"
	S.name = "Festival Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.festival.economy" }
	S.tags = { "l", "festival", "society", "sim" }
	S.description = "Festival Society: relations, factions, reputation and cohesion of the region for the Festival subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.festival.society", decayRate = 0.013, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
