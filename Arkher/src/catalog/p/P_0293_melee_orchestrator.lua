-- ARKHER SYSTEM P.0293 :: Melee State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0293"
	S.key = "arkher.play.melee.state_machine"
	S.name = "Melee State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Melee"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.melee.combat_resolution" }
	S.tags = { "p", "melee", "orchestrator", "play" }
	S.description = "Melee State Machine: the phase machine that drives this gameplay loop for the Melee subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.melee.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
