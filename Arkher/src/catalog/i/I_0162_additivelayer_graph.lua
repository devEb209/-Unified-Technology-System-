-- ARKHER SYSTEM I.0162 :: Additive Layer Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0162"
	S.key = "arkher.anim.additivelayer.retarget_graph"
	S.name = "Additive Layer Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.additivelayer.physical_blend" }
	S.tags = { "i", "additivelayer", "graph", "anim" }
	S.description = "Additive Layer Retarget Graph: bone mapping and retarget path resolution for the Additive Layer subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.additivelayer.retarget_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
