-- ARKHER SYSTEM H.0277 :: Sphere Collider Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0277"
	S.key = "arkher.physics.spherecollider.result_cache"
	S.name = "Sphere Collider Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.spherecollider.simulation_policy" }
	S.tags = { "h", "spherecollider", "cache", "physics" }
	S.description = "Sphere Collider Result Cache: reuse of expensive simulation and query results for the Sphere Collider subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.spherecollider.result_cache", policy = "lru", capacity = 257, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
