-- ARKHER SYSTEM E.0038 :: Albedo Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0038"
	S.key = "arkher.material.albedo.streaming"
	S.name = "Albedo Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Albedo"
	S.aspect = "Streaming"
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.albedo.parameter_budget" }
	S.tags = { "e", "albedo", "streamer", "material" }
	S.description = "Albedo Streaming: residency and demand-driven texture streaming for the Albedo subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.albedo.streaming", radius = 320, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
