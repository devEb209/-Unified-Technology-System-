--!strict
-- Substance Layers — CORE Node_Flow #0016
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Substance Layers — CORE Node_Flow #0016", size=Vector2.new(640, 440), pos=UDim2.fromOffset(308, 92), parent=parent, icon="◨"})
