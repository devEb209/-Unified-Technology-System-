-- ARKHER SYSTEM H.0456 :: Distance Joint Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0456"
	S.key = "arkher.physics.distancejoint.broadphase_index"
	S.name = "Distance Joint Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.distancejoint.vehicle" }
	S.tags = { "h", "distancejoint", "index", "physics" }
	S.description = "Distance Joint Broadphase Index: spatial acceleration of candidate pair finding for the Distance Joint subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.distancejoint.broadphase_index", mode = "hash", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
