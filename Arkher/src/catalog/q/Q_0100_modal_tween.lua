-- ARKHER SYSTEM Q.0100 :: Modal Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0100"
	S.key = "arkher.ui.modal.transition"
	S.name = "Modal Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Modal"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.modal.input_mapping" }
	S.tags = { "q", "modal", "tween", "ui" }
	S.description = "Modal Transition: eased, delayed, looped and sequenced motion for the Modal subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.modal.transition", timeScale = 1.10 })
		inst.system = S
		inst.ctx = ctx
