...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Godot4 — ANIMATION Stack #0175", size=Vector2.new(640, 420), pos=UDim2.fromOffset(375, 195), parent=parent, icon="≡"})
