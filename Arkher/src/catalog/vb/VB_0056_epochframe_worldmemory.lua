-- ARKHER SYSTEM VB.0056 :: Epoch Frame World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0056"
	S.key = "arkher.conttime.epochframe.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.epochframe.neural_field" }
	S.tags = { "vb", "epochframe", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.epochframe.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
