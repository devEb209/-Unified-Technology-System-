-- ARKHER SYSTEM VB.0589 :: Horizon Span Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0589"
	S.key = "arkher.conttime.horizonspan.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "horizonspan", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.horizonspan.infinite_grid", cellSize = 192, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
