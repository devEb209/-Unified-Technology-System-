-- ARKHER SYSTEM V.0001 :: Mesh Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0001"
	S.key = "arkher.asset.meshasset.import"
	S.name = "Mesh Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "meshasset", "importer", "asset" }
	S.description = "Mesh Import: validation, normalization, hashing and deduplication of incoming content for the Mesh subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.meshasset.import", unitScale = 1.00 })
		inst.system = S
		inst.ctx = ctx
