-- ARKHER SYSTEM VD.0455 :: Animation Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0455"
	S.key = "arkher.contsim.animcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.animcont.simulation_fabric" }
	S.tags = { "vd", "animcont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.animcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
