-- ARKHER SYSTEM H.0213 :: Fixed Timestep Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0213"
	S.key = "arkher.physics.fixedstep.contact_generation"
	S.name = "Fixed Timestep Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.fixedstep.collision_shape" }
	S.tags = { "h", "fixedstep", "contact", "physics" }
	S.description = "Fixed Timestep Contact Generation: narrow-phase manifolds with normal, depth and point for the Fixed Timestep subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.fixedstep.contact_generation", slop = 0.0090, maxManifolds = 175 })
		inst.system = S
		inst.ctx = ctx
