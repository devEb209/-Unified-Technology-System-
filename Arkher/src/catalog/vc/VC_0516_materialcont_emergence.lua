-- ARKHER SYSTEM VC.0516 :: Material Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0516"
	S.key = "arkher.contneural.materialcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.materialcont.reality_continuum" }
	S.tags = { "vc", "materialcont", "emergence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.materialcont.emergence_continuum", windowSize = 5, threshold = 1.40, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
