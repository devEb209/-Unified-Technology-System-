-- ARKHER SYSTEM N.0005 :: Spark Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0005"
	S.key = "arkher.vfx.spark.curve_authoring"
	S.name = "Spark Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spark"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spark.ribbon_and_trail" }
	S.tags = { "n", "spark", "spline", "vfx" }
	S.description = "Spark Curve Authoring: authored curves driving the effect over its life for the Spark subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.spark.curve_authoring", tension = 0.41, closed = false })
		inst.system = S
		inst.ctx = ctx
