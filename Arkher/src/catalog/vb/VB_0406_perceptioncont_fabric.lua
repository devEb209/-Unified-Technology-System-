-- ARKHER SYSTEM VB.0406 :: Perception Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0406"
	S.key = "arkher.conttime.perceptioncont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.perceptioncont.complexity_budget" }
	S.tags = { "vb", "perceptioncont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.perceptioncont.simulation_fabric", budgetMs = 2.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
