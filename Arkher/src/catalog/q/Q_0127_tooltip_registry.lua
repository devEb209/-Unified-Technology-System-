-- ARKHER SYSTEM Q.0127 :: Tooltip Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0127"
	S.key = "arkher.ui.tooltip.localization_registry"
	S.name = "Tooltip Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tooltip"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.tooltip.theme_composition" }
	S.tags = { "q", "tooltip", "registry", "ui" }
	S.description = "Tooltip Localization Registry: catalogue of strings, plurals and locale metadata for the Tooltip subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.tooltip.localization_registry" })
		inst.system = S
		inst.ctx = ctx
