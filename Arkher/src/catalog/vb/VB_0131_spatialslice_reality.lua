-- ARKHER SYSTEM VB.0131 :: Spatial Slice Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0131"
	S.key = "arkher.conttime.spatialslice.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.spatialslice.simulation_fabric" }
	S.tags = { "vb", "spatialslice", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.spatialslice.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
