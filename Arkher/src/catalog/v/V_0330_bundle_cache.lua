-- ARKHER SYSTEM V.0330 :: Bundle Content Cache
...
return function(A)
	...
	local S = {}
	S.id = "V.0330"
	S.key = "arkher.asset.bundle.content_cache"
	S.name = "Bundle Content Cache"
	S.category = "V"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.bundle.dependency_graph" }
	S.tags = { "v", "bundle", "cache", "asset" }
	S.description = "Bundle Content Cache: reuse of already cooked results for the Bundle subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.asset.bundle.content_cache", policy = "lru", capacity = 122, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
