-- ARKHER SYSTEM E.0168 :: Clear Coat Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0168"
	S.key = "arkher.material.clearcoat.shading_graph"
	S.name = "Clear Coat Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Clear Coat"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.clearcoat.layer_composition" }
	S.tags = { "e", "clearcoat", "shadegraph", "material" }
	S.description = "Clear Coat Shading Graph: node graph evaluated and compiled to Luau for the Clear Coat subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.clearcoat.shading_graph" })
		inst.system = S
		inst.ctx = ctx
