-- ARKHER SYSTEM I.0089 :: Curve Interpolation Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0089"
	S.key = "arkher.anim.curveinterp.quality_policy"
	S.name = "Curve Interpolation Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.curveinterp.pose_cache" }
	S.tags = { "i", "curveinterp", "policy", "anim" }
	S.description = "Curve Interpolation Quality Policy: device tier rules for rate, bones and solvers for the Curve Interpolation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.curveinterp.quality_policy", algorithm = "roundrobin", starvationGuard = 52 })
		inst.system = S
		inst.ctx = ctx
