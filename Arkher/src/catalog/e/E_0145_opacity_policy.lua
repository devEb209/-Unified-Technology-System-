-- ARKHER SYSTEM E.0145 :: Opacity Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0145"
	S.key = "arkher.material.opacity.quality_policy"
	S.name = "Opacity Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Opacity"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.opacity.compression_codec" }
	S.tags = { "e", "opacity", "policy", "material" }
	S.description = "Opacity Quality Policy: device tier rules for the surface for the Opacity subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.opacity.quality_policy", algorithm = "roundrobin", starvationGuard = 28 })
		inst.system = S
		inst.ctx = ctx
