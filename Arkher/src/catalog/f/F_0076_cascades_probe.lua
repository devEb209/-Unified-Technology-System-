-- ARKHER SYSTEM F.0076 :: Cascade Shadows Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0076"
	S.key = "arkher.render.cascades.probe_volume"
	S.name = "Cascade Shadows Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.cascades.lighting_rig" }
	S.tags = { "f", "cascades", "probe", "render" }
	S.description = "Cascade Shadows Probe Volume: irradiance probes encoded in spherical harmonics for the Cascade Shadows subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.cascades.probe_volume", spacing = 8 })
		inst.system = S
		inst.ctx = ctx
