-- ARKHER SYSTEM Z.0175 :: Self Analyzing Project Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0175"
	S.key = "arkher.origin.selfanalyzing.signal_composition"
	S.name = "Self Analyzing Project Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfanalyzing.telemetry_ledger" }
	S.tags = { "z", "selfanalyzing", "composer", "origin" }
	S.description = "Self Analyzing Project Signal Composition: blending of the technology's input signals into one output for the Self Analyzing Project subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.selfanalyzing.signal_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
