-- ARKHER SYSTEM R.0242 :: Area Of Interest Time Sync
...
return function(A)
	...
	local S = {}
	S.id = "R.0242"
	S.key = "arkher.net.areaofinterest.time_sync"
	S.name = "Area Of Interest Time Sync"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "netclock"
	S.version = "1.0.0"
	S.deps = { "arkher.net.areaofinterest.replication" }
	S.tags = { "r", "areaofinterest", "netclock", "net" }
	S.description = "Area Of Interest Time Sync: offset estimation, outlier rejection and jitter buffering for the Area Of Interest subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("netclock", { id = "arkher.net.areaofinterest.time_sync", tickRate = 20, bufferDelay = 0.060, maxSamples = 16 })
		inst.system = S
		inst.ctx = ctx
