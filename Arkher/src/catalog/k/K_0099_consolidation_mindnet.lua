-- ARKHER SYSTEM K.0099 :: Memory Consolidation Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0099"
	S.key = "arkher.npc.consolidation.mind_network"
	S.name = "Memory Consolidation Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "consolidation", "mindnet", "npc" }
	S.description = "Memory Consolidation Mind Network: the learned policy that turns perception into a decision for the Memory Consolidation subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.consolidation.mind_network", inputs = 6, hidden = 5, seed = 52656, learningRate = 0.080, exploration = 0.020 })
		inst.system = S
		inst.ctx = ctx
