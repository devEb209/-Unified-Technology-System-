-- ARKHER SYSTEM VA.0205 :: Biome Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0205"
	S.key = "arkher.contworld.biomecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "biomecont", "continuum", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.biomecont.infinite_grid", cellSize = 64, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
