-- ARKHER SYSTEM V.0022 :: Skeletal Mesh Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0022"
	S.key = "arkher.asset.skeletalmesh.validation_guard"
	S.name = "Skeletal Mesh Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.skeletalmesh.size_budget" }
	S.tags = { "v", "skeletalmesh", "guard", "asset" }
	S.description = "Skeletal Mesh Validation Guard: rate limiting and capability checks on the import path for the Skeletal Mesh subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.skeletalmesh.validation_guard", algorithm = "token", capacity = 116, refillPerSec = 41, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
