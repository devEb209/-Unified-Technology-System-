-- ARKHER SYSTEM N.0027 :: Fire Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0027"
	S.key = "arkher.vfx.fire.emission"
	S.name = "Fire Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fire"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "fire", "emitter", "vfx" }
	S.description = "Fire Emission: shaped, rate and burst emission of new particles for the Fire subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.fire.emission", shape = "point", rate = 55, speed = 6.50, life = 1.30, budget = 320, seed = 36995 })
		inst.system = S
		inst.ctx = ctx
