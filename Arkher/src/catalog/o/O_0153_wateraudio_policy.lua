-- ARKHER SYSTEM O.0153 :: Water Audio Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0153"
	S.key = "arkher.audio.wateraudio.playback_policy"
	S.name = "Water Audio Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Water Audio"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.wateraudio.compression_codec" }
	S.tags = { "o", "wateraudio", "policy", "audio" }
	S.description = "Water Audio Playback Policy: rules choosing what may be heard right now for the Water Audio subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.wateraudio.playback_policy", algorithm = "lottery", starvationGuard = 51 })
		inst.system = S
		inst.ctx = ctx
