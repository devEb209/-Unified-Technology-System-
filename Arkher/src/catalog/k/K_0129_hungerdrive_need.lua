-- ARKHER SYSTEM K.0129 :: Hunger Drive Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0129"
	S.key = "arkher.npc.hungerdrive.drive_system"
	S.name = "Hunger Drive Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hungerdrive.memory" }
	S.tags = { "k", "hungerdrive", "need", "npc" }
	S.description = "Hunger Drive Drive System: drives that decay, turn urgent and get satisfied for the Hunger Drive subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.hungerdrive.drive_system" })
		inst.system = S
		inst.ctx = ctx
