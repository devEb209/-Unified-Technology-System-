-- ARKHER SYSTEM K.0285 :: Scent Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0285"
	S.key = "arkher.npc.scent.perception"
	S.name = "Scent Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.scent.emotion" }
	S.tags = { "k", "scent", "perception", "npc" }
	S.description = "Scent Perception: sight, hearing and bounded attention for the Scent subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.scent.perception", sightRange = 35, hearingRange = 20, attentionSlots = 5, fov = 1.780 })
		inst.system = S
		inst.ctx = ctx
