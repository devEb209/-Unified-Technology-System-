-- ARKHER SYSTEM F.0081 :: Cascade Shadows Pass Cache
...
return function(A)
	...
	local S = {}
	S.id = "F.0081"
	S.key = "arkher.render.cascades.pass_cache"
	S.name = "Cascade Shadows Pass Cache"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.render.cascades.render_policy" }
	S.tags = { "f", "cascades", "cache", "render" }
	S.description = "Cascade Shadows Pass Cache: reuse of pass results across frames for the Cascade Shadows subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.render.cascades.pass_cache", policy = "lru", capacity = 447, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
