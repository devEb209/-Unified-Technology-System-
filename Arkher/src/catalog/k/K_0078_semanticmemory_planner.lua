-- ARKHER SYSTEM K.0078 :: Semantic Memory Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0078"
	S.key = "arkher.npc.semanticmemory.goal_planner"
	S.name = "Semantic Memory Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.semanticmemory.utility_reasoning" }
	S.tags = { "k", "semanticmemory", "planner", "npc" }
	S.description = "Semantic Memory Goal Planner: backward GOAP planning to reach a goal state for the Semantic Memory subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.semanticmemory.goal_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
