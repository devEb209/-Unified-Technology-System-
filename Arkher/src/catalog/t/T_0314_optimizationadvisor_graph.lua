-- ARKHER SYSTEM T.0314 :: Optimization Advisor Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0314"
	S.key = "arkher.ai.optimizationadvisor.reasoning_graph"
	S.name = "Optimization Advisor Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.optimizationadvisor.world_architect" }
	S.tags = { "t", "optimizationadvisor", "graph", "ai" }
	S.description = "Optimization Advisor Reasoning Graph: relationship modelling and shortest-path reasoning for the Optimization Advisor subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.optimizationadvisor.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
