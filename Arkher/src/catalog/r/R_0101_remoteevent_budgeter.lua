-- ARKHER SYSTEM R.0101 :: Remote Event Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0101"
	S.key = "arkher.net.remoteevent.bandwidth_budget"
	S.name = "Remote Event Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Remote Event"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remoteevent.transport_graph" }
	S.tags = { "r", "remoteevent", "budgeter", "net" }
	S.description = "Remote Event Bandwidth Budget: bytes per second shared between competing streams for the Remote Event subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.remoteevent.bandwidth_budget", total = 236, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
