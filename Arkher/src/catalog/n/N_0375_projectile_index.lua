-- ARKHER SYSTEM N.0375 :: Projectile Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0375"
	S.key = "arkher.vfx.projectile.spatial_index"
	S.name = "Projectile Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Projectile"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.projectile.quality_policy" }
	S.tags = { "n", "projectile", "index", "vfx" }
	S.description = "Projectile Spatial Index: spatial acceleration of effect queries and culling for the Projectile subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.projectile.spatial_index", mode = "hash", cellSize = 40 })
		inst.system = S
		inst.ctx = ctx
