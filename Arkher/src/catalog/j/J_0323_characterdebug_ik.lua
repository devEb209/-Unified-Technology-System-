-- ARKHER SYSTEM J.0323 :: Character Debug Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0323"
	S.key = "arkher.character.characterdebug.look_and_reach"
	S.name = "Character Debug Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterdebug.blend_controller" }
	S.tags = { "j", "characterdebug", "ik", "character" }
	S.description = "Character Debug Look And Reach: look-at, reach and foot placement for the character for the Character Debug subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.characterdebug.look_and_reach", iterations = 7, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
