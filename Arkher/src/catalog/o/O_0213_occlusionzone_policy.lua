-- ARKHER SYSTEM O.0213 :: Occlusion Zone Playback Policy
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0213"
	S.key = "arkher.audio.occlusionzone.playback_policy"
	S.name = "Occlusion Zone Playback Policy"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.occlusionzone.compression_codec" }
	S.tags = { "o", "occlusionzone", "policy", "audio" }
	S.description = "Occlusion Zone Playback Policy: rules choosing what may be heard right now for the Occlusion Zone subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.audio.occlusionzone.playback_policy", algorithm = "roundrobin", starvationGuard = 48 })
		inst.system = S
		inst.ctx = ctx
