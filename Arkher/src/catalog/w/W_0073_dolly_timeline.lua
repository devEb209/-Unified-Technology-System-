-- ARKHER SYSTEM W.0073 :: Dolly Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0073"
	S.key = "arkher.cine.dolly.sequence_timeline"
	S.name = "Dolly Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Dolly"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "dolly", "timeline", "cine" }
	S.description = "Dolly Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Dolly subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.dolly.sequence_timeline", duration = 4.0, rate = 0.80 })
		inst.system = S
		inst.ctx = ctx
