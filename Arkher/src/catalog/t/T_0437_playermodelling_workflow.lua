-- ARKHER SYSTEM T.0437 :: Player Modelling Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0437"
	S.key = "arkher.ai.playermodelling.plan_workflow"
	S.name = "Player Modelling Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.playermodelling.semantic_knowledge" }
	S.tags = { "t", "playermodelling", "workflow", "ai" }
	S.description = "Player Modelling Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Player Modelling subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.playermodelling.plan_workflow", maxRetries = 3, budget = 90 })
		inst.system = S
		inst.ctx = ctx
