-- ARKHER SYSTEM O.0255 :: Exploration Music Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0255"
	S.key = "arkher.audio.explorationmusic.spatialization"
	S.name = "Exploration Music Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.explorationmusic.mixer_bus" }
	S.tags = { "o", "explorationmusic", "spatialaudio", "audio" }
	S.description = "Exploration Music Spatialization: distance attenuation, panning, occlusion and doppler for the Exploration Music subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.explorationmusic.spatialization", model = "inverse", refDistance = 3, maxDistance = 160, rolloff = 0.94, maxVoices = 12 })
		inst.system = S
		inst.ctx = ctx
