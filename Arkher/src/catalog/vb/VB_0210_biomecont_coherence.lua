-- ARKHER SYSTEM VB.0210 :: Biome Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0210"
	S.key = "arkher.conttime.biomecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.biomecont.persistent_state" }
	S.tags = { "vb", "biomecont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.biomecont.coherence_guard", window = 108, threshold = 0.14 })
		inst.system = S
		inst.ctx = ctx
