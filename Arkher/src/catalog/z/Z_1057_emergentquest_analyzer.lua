-- ARKHER SYSTEM Z.1057 :: Emergent Quest Generation Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.1057"
	S.key = "arkher.origin.emergentquest.behaviour_analysis"
	S.name = "Emergent Quest Generation Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentquest.governance_policy" }
	S.tags = { "z", "emergentquest", "analyzer", "origin" }
	S.description = "Emergent Quest Generation Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Emergent Quest Generation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.emergentquest.behaviour_analysis", window = 221, buckets = 17, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
