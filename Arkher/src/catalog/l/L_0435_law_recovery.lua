-- ARKHER SYSTEM L.0435 :: Law Recovery
...
return function(A)
	...
	S.kit = "recovery"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.law.forecast" }
	S.tags = { "l", "law", "recovery", "sim" }
	S.description = "Law Recovery: checkpoint and rollback of the persistent world for the Law subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("recovery", { id = "arkher.sim.law.recovery", maxSnapshots = 4, strategy = "rollback" })
		inst.system = S
		inst.ctx = ctx
