-- ARKHER SYSTEM Z.1081 :: Original Tech Debug Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.1081"
	S.key = "arkher.origin.origindebug.reality_layering"
	S.name = "Original Tech Debug Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "origindebug", "reality", "origin" }
	S.description = "Original Tech Debug Reality Layering: stacked authored, simulated, proposed and player realities for the Original Tech Debug subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.origindebug.reality_layering" })
		inst.system = S
		inst.ctx = ctx
