-- ARKHER SYSTEM VA.0312 :: Weather Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0312"
	S.key = "arkher.contworld.weathercont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.weathercont.reality_continuum" }
	S.tags = { "va", "weathercont", "emergence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contworld.weathercont.emergence_continuum", windowSize = 7, threshold = 1.30, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
