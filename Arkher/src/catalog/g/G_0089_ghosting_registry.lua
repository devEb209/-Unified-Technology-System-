-- ARKHER SYSTEM G.0089 :: Ghosting Suppression Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0089"
	S.key = "arkher.neural.ghosting.model_registry"
	S.name = "Ghosting Suppression Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.ghosting.reconstruction" }
	S.tags = { "g", "ghosting", "registry", "neural" }
	S.description = "Ghosting Suppression Model Registry: named models and their lifecycle for the Ghosting Suppression subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.ghosting.model_registry" })
		inst.system = S
		inst.ctx = ctx
