-- ARKHER SYSTEM R.0063 :: Entity Replication Prediction And Reconciliation
...
return function(A)
	...
	local S = {}
	S.id = "R.0063"
	S.key = "arkher.net.entityreplication.prediction_and_reconciliation"
	S.name = "Entity Replication Prediction And Reconciliation"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "prediction"
	S.version = "1.0.0"
	S.deps = { "arkher.net.entityreplication.time_sync" }
	S.tags = { "r", "entityreplication", "prediction", "net" }
	S.description = "Entity Replication Prediction And Reconciliation: client simulation, correction and input replay for the Entity Replication subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("prediction", { id = "arkher.net.entityreplication.prediction_and_reconciliation", errorThreshold = 0.035, smoothing = 9.0, maxInputs = 160 })
		inst.system = S
		inst.ctx = ctx
