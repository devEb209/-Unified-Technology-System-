-- ARKHER SYSTEM P.0209 :: Trading State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0209"
	S.key = "arkher.play.trading.state_machine"
	S.name = "Trading State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Trading"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.trading.combat_resolution" }
	S.tags = { "p", "trading", "orchestrator", "play" }
	S.description = "Trading State Machine: the phase machine that drives this gameplay loop for the Trading subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.trading.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
