-- ARKHER SYSTEM VA.0198 :: Architect District Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0198"
	S.key = "arkher.contworld.architectdistrict.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.architectdistrict.persistent_state" }
	S.tags = { "va", "architectdistrict", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.architectdistrict.coherence_guard", window = 69, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
