-- ARKHER SYSTEM Z.0896 :: Sparse World Representation Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0896"
	S.key = "arkher.origin.sparseworld.governance_policy"
	S.name = "Sparse World Representation Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.signal_composition" }
	S.tags = { "z", "sparseworld", "policy", "origin" }
	S.description = "Sparse World Representation Governance Policy: ordered rules governing when the technology may act for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.sparseworld.governance_policy", algorithm = "edf", starvationGuard = 33 })
		inst.system = S
		inst.ctx = ctx
