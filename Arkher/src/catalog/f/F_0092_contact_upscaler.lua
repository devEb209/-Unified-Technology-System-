-- ARKHER SYSTEM F.0092 :: Contact Shadows Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0092"
	S.key = "arkher.render.contact.adaptive_resolution"
	S.name = "Contact Shadows Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.contact.temporal_resolve" }
	S.tags = { "f", "contact", "upscaler", "render" }
	S.description = "Contact Shadows Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Contact Shadows subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.contact.adaptive_resolution", targetMs = 14.10, index = 3, sharpness = 0.43 })
		inst.system = S
		inst.ctx = ctx
