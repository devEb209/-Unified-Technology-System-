-- ARKHER SYSTEM VB.0391 :: Memory Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0391"
	S.key = "arkher.conttime.memorycont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memorycont.coherence_guard" }
	S.tags = { "vb", "memorycont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.memorycont.neural_field", dims = 20, hidden = 16, seed = 12354 })
		inst.system = S
		inst.ctx = ctx
