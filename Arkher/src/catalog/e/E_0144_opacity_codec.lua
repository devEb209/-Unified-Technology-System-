-- ARKHER SYSTEM E.0144 :: Opacity Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0144"
	S.key = "arkher.material.opacity.compression_codec"
	S.name = "Opacity Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Opacity"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.opacity.streaming" }
	S.tags = { "e", "opacity", "codec", "material" }
	S.description = "Opacity Compression Codec: serialization and compression of material data for the Opacity subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.opacity.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
