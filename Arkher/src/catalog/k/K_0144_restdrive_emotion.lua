-- ARKHER SYSTEM K.0144 :: Rest Drive Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0144"
	S.key = "arkher.npc.restdrive.emotion"
	S.name = "Rest Drive Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.restdrive.drive_system" }
	S.tags = { "k", "restdrive", "emotion", "npc" }
	S.description = "Rest Drive Emotion: appraisal of events into valence, arousal and mood for the Rest Drive subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.restdrive.emotion", inertia = 0.75, decayRate = 0.30, baselineArousal = 0.10 })
		inst.system = S
		inst.ctx = ctx
