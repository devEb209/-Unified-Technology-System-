-- ARKHER SYSTEM N.0038 :: Fire Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0038"
	S.key = "arkher.vfx.fire.analysis"
	S.name = "Fire Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fire"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fire.spatial_index" }
	S.tags = { "n", "fire", "analyzer", "vfx" }
	S.description = "Fire Analysis: cost, overdraw and stability analysis of the effect for the Fire subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.fire.analysis", window = 153, buckets = 13, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
