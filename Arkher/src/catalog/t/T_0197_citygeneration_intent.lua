-- ARKHER SYSTEM T.0197 :: City Generation Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0197"
	S.key = "arkher.ai.citygeneration.intent_understanding"
	S.name = "City Generation Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "citygeneration", "intent", "ai" }
	S.description = "City Generation Intent Understanding: natural language turned into an actionable, scored intent for the City Generation subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.citygeneration.intent_understanding", minConfidence = 0.43 })
		inst.system = S
		inst.ctx = ctx
