-- ARKHER SYSTEM VD.0621 :: Occupancy Map Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0621"
	S.key = "arkher.contsim.occupancymap.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.occupancymap.world_memory_stream" }
	S.tags = { "vd", "occupancymap", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.occupancymap.complexity_budget", targetMs = 19.0 })
		inst.system = S
		inst.ctx = ctx
