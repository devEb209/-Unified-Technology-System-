-- ARKHER SYSTEM VB.0012 :: World Grid Cell Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0012"
	S.key = "arkher.conttime.worldcell.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldcell.reality_continuum" }
	S.tags = { "vb", "worldcell", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.worldcell.emergence_continuum", windowSize = 4, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
