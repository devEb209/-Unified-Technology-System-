-- ARKHER SYSTEM N.0003 :: Spark Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0003"
	S.key = "arkher.vfx.spark.force_field"
	S.name = "Spark Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spark"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spark.particle_simulation" }
	S.tags = { "n", "spark", "forcefield", "vfx" }
	S.description = "Spark Force Field: wind, attraction, vortex, drag and curl turbulence for the Spark subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.spark.force_field", seed = 71901 })
		inst.system = S
		inst.ctx = ctx
