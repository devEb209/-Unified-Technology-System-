-- ARKHER SYSTEM O.0415 :: Audio Debug Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0415"
	S.key = "arkher.audio.audiodebug.asset_registry"
	S.name = "Audio Debug Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Audio Debug"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.audiodebug.streaming" }
	S.tags = { "o", "audiodebug", "registry", "audio" }
	S.description = "Audio Debug Asset Registry: catalogue of sounds, variations and metadata for the Audio Debug subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.audiodebug.asset_registry" })
		inst.system = S
		inst.ctx = ctx
