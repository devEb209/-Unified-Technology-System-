-- ARKHER SYSTEM VA.0509 :: Material Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0509"
	S.key = "arkher.contworld.materialcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.materialcont.multi-scale_fidelity" }
	S.tags = { "va", "materialcont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.materialcont.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
