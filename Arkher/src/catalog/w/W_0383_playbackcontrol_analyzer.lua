-- ARKHER SYSTEM W.0383 :: Playback Control Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0383"
	S.key = "arkher.cine.playbackcontrol.sequence_analysis"
	S.name = "Playback Control Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.playbackcontrol.frame_budget" }
	S.tags = { "w", "playbackcontrol", "analyzer", "cine" }
	S.description = "Playback Control Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Playback Control subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.playbackcontrol.sequence_analysis", window = 220, buckets = 8, threshold = 3.20 })
		inst.system = S
		inst.ctx = ctx
