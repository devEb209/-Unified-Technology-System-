-- ARKHER SYSTEM N.0446 :: Screen Effect Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0446"
	S.key = "arkher.vfx.screenfx.ribbon_and_trail"
	S.name = "Screen Effect Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.screenfx.force_field" }
	S.tags = { "n", "screenfx", "ribbon", "vfx" }
	S.description = "Screen Effect Ribbon And Trail: trail points, tapering, beams and decimation for the Screen Effect subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.screenfx.ribbon_and_trail", maxPoints = 24, lifetime = 1.80, minDistance = 0.25, width = 0.30 })
		inst.system = S
		inst.ctx = ctx
