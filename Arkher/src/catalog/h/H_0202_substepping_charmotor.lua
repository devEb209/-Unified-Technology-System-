-- ARKHER SYSTEM H.0202 :: Substepping Character Motion
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0202"
	S.key = "arkher.physics.substepping.character_motion"
	S.name = "Substepping Character Motion"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Substepping"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.substepping.query" }
	S.tags = { "h", "substepping", "charmotor", "physics" }
	S.description = "Substepping Character Motion: capsule move-and-slide with slopes, steps and jumps for the Substepping subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.physics.substepping.character_motion", radius = 0.44, height = 1.89, maxSpeed = 6.90, jumpHeight = 1.70, stepOffset = 0.54 })
		inst.system = S
		inst.ctx = ctx
