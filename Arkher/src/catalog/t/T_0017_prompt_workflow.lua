-- ARKHER SYSTEM T.0017 :: Prompt Understanding Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0017"
	S.key = "arkher.ai.prompt.plan_workflow"
	S.name = "Prompt Understanding Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.prompt.semantic_knowledge" }
	S.tags = { "t", "prompt", "workflow", "ai" }
	S.description = "Prompt Understanding Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Prompt Understanding subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.prompt.plan_workflow", maxRetries = 1, budget = 130 })
		inst.system = S
		inst.ctx = ctx
