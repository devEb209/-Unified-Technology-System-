-- ARKHER SYSTEM VB.0270 :: Bridge Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0270"
	S.key = "arkher.conttime.bridgecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.bridgecont.persistent_state" }
	S.tags = { "vb", "bridgecont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.bridgecont.coherence_guard", window = 63, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
