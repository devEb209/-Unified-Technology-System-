-- ARKHER SYSTEM VA.0093 :: Residency Window Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0093"
	S.key = "arkher.contworld.residencywindow.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.residencywindow.world_memory_stream" }
	S.tags = { "va", "residencywindow", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.residencywindow.complexity_budget", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
