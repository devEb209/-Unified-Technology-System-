-- ARKHER SYSTEM J.0067 :: Teeth Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0067"
	S.key = "arkher.character.teeth.rig_definition"
	S.name = "Teeth Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "teeth", "skeleton", "character" }
	S.description = "Teeth Rig Definition: character rig definition and bone budget for the Teeth subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.teeth.rig_definition" })
		inst.system = S
		inst.ctx = ctx
