-- ARKHER SYSTEM Z.0051 :: Singularity World Architect Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0051"
	S.key = "arkher.origin.worldarchitect.adaptive_workflow"
	S.name = "Singularity World Architect Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.self_critique" }
	S.tags = { "z", "worldarchitect", "workflow", "origin" }
	S.description = "Singularity World Architect Adaptive Workflow: verified, retryable, reversible execution plans for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.worldarchitect.adaptive_workflow", maxRetries = 1, budget = 130 })
		inst.system = S
		inst.ctx = ctx
