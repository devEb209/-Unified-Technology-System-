-- ARKHER SYSTEM T.0200 :: City Generation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0200"
	S.key = "arkher.ai.citygeneration.self_critique"
	S.name = "City Generation Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.citygeneration.plan_workflow" }
	S.tags = { "t", "citygeneration", "critic", "ai" }
	S.description = "City Generation Self Critique: weighted evaluation of the result against declared criteria for the City Generation subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.citygeneration.self_critique", passMark = 0.76, reviseMark = 0.46, seed = 84906 })
		inst.system = S
		inst.ctx = ctx
