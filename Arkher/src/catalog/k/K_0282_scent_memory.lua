-- ARKHER SYSTEM K.0282 :: Scent Memory
...
return function(A)
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.scent.mind_network" }
	S.tags = { "k", "scent", "memory", "npc" }
	S.description = "Scent Memory: episodic memory with decay, recall and consolidation for the Scent subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.scent.memory", capacity = 55, decayRate = 0.065, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
