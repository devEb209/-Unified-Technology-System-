-- ARKHER SYSTEM Z.0132 :: Dynamic Complexity Manager Predictive Optimization
...
return function(A)
	...
	local S = {}
	S.id = "Z.0132"
	S.key = "arkher.origin.complexitymanager.predictive_optimization"
	S.name = "Dynamic Complexity Manager Predictive Optimization"
	S.category = "Z"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.complexitymanager.adaptive_workflow" }
	S.tags = { "z", "complexitymanager", "predictor", "origin" }
	S.description = "Dynamic Complexity Manager Predictive Optimization: forecast-driven optimization before the cost is paid for the Dynamic Complexity Manager subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.origin.complexitymanager.predictive_optimization", method = "markov", alpha = 0.12, window = 82 })
		inst.system = S
		inst.ctx = ctx
