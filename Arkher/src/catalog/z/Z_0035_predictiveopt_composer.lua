-- ARKHER SYSTEM Z.0035 :: Predictive Optimization Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0035"
	S.key = "arkher.origin.predictiveopt.signal_composition"
	S.name = "Predictive Optimization Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.predictiveopt.telemetry_ledger" }
	S.tags = { "z", "predictiveopt", "composer", "origin" }
	S.description = "Predictive Optimization Signal Composition: blending of the technology's input signals into one output for the Predictive Optimization subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.predictiveopt.signal_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
