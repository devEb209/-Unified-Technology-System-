-- ARKHER SYSTEM Q.0367 :: Theme Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0367"
	S.key = "arkher.ui.uitheme.localization_registry"
	S.name = "Theme Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Theme"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uitheme.theme_composition" }
	S.tags = { "q", "uitheme", "registry", "ui" }
	S.description = "Theme Localization Registry: catalogue of strings, plurals and locale metadata for the Theme subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.uitheme.localization_registry" })
		inst.system = S
		inst.ctx = ctx
