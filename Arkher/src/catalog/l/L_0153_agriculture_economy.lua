-- ARKHER SYSTEM L.0153 :: Agriculture Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0153"
	S.key = "arkher.sim.agriculture.economy"
	S.name = "Agriculture Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.agriculture.ecology" }
	S.tags = { "l", "agriculture", "economy", "sim" }
	S.description = "Agriculture Economy: stock, production, demand, price discovery and trade for the Agriculture subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.agriculture.economy", elasticity = 0.22 })
		inst.system = S
		inst.ctx = ctx
