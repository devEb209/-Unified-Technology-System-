-- ARKHER SYSTEM T.0129 :: Skill Library Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0129"
	S.key = "arkher.ai.skilllibrary.plan_workflow"
	S.name = "Skill Library Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.skilllibrary.semantic_knowledge" }
	S.tags = { "t", "skilllibrary", "workflow", "ai" }
	S.description = "Skill Library Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Skill Library subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.skilllibrary.plan_workflow", maxRetries = 1, budget = 130 })
		inst.system = S
		inst.ctx = ctx
