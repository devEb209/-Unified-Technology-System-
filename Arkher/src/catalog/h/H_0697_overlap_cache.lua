-- ARKHER SYSTEM H.0697 :: Overlap Query Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0697"
	S.key = "arkher.physics.overlap.result_cache"
	S.name = "Overlap Query Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.overlap.simulation_policy" }
	S.tags = { "h", "overlap", "cache", "physics" }
	S.description = "Overlap Query Result Cache: reuse of expensive simulation and query results for the Overlap Query subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.overlap.result_cache", policy = "ttl", capacity = 495, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
