-- ARKHER SYSTEM Z.0340 :: Cross Reality Sync Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "Z.0340"
	S.key = "arkher.origin.crossreality.orchestration"
	S.name = "Cross Reality Sync Orchestration"
	S.category = "Z"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.residency_streaming" }
	S.tags = { "z", "crossreality", "orchestrator", "origin" }
	S.description = "Cross Reality Sync Orchestration: lifecycle and phase orchestration of the technology for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.origin.crossreality.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
