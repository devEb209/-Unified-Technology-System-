-- ARKHER SYSTEM E.0483 :: Material Variant Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0483"
	S.key = "arkher.material.variant.shading_graph"
	S.name = "Material Variant Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.variant.layer_composition" }
	S.tags = { "e", "variant", "shadegraph", "material" }
	S.description = "Material Variant Shading Graph: node graph evaluated and compiled to Luau for the Material Variant subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.variant.shading_graph" })
		inst.system = S
		inst.ctx = ctx
