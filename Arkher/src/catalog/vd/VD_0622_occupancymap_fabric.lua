-- ARKHER SYSTEM VD.0622 :: Occupancy Map Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0622"
	S.key = "arkher.contsim.occupancymap.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.occupancymap.complexity_budget" }
	S.tags = { "vd", "occupancymap", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.occupancymap.simulation_fabric", budgetMs = 3.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
