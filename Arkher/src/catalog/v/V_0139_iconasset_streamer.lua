-- ARKHER SYSTEM V.0139 :: Icon Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0139"
	S.key = "arkher.asset.iconasset.streaming_residency"
	S.name = "Icon Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.iconasset.content_cache" }
	S.tags = { "v", "iconasset", "streamer", "asset" }
	S.description = "Icon Streaming Residency: distance-driven load and unload of asset payloads for the Icon subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.iconasset.streaming_residency", radius = 520, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
