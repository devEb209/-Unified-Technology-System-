-- ARKHER SYSTEM VB.0574 :: Mobile Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0574"
	S.key = "arkher.conttime.mobilecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.mobilecont.complexity_budget" }
	S.tags = { "vb", "mobilecont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.mobilecont.simulation_fabric", budgetMs = 3.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
