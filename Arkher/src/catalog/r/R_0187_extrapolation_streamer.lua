-- ARKHER SYSTEM R.0187 :: Extrapolation Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0187"
	S.key = "arkher.net.extrapolation.interest_streaming"
	S.name = "Extrapolation Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.extrapolation.serialization_codec" }
	S.tags = { "r", "extrapolation", "streamer", "net" }
	S.description = "Extrapolation Interest Streaming: distance-driven residency of replicated content for the Extrapolation subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.extrapolation.interest_streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
