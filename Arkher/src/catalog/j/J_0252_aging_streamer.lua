-- ARKHER SYSTEM J.0252 :: Aging Streaming
...
return function(A)
	...
	local S = {}
	S.id = "J.0252"
	S.key = "arkher.character.aging.streaming"
	S.name = "Aging Streaming"
	S.category = "J"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.character.aging.budget_governor" }
	S.tags = { "j", "aging", "streamer", "character" }
	S.description = "Aging Streaming: distance-driven residency of character data for the Aging subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.character.aging.streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
