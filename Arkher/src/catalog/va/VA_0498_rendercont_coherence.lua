-- ARKHER SYSTEM VA.0498 :: Rendering Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0498"
	S.key = "arkher.contworld.rendercont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.rendercont.persistent_state" }
	S.tags = { "va", "rendercont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.rendercont.coherence_guard", window = 85, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
