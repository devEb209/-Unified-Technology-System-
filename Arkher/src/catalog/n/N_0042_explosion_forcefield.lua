-- ARKHER SYSTEM N.0042 :: Explosion Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0042"
	S.key = "arkher.vfx.explosion.force_field"
	S.name = "Explosion Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Explosion"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.explosion.particle_simulation" }
	S.tags = { "n", "explosion", "forcefield", "vfx" }
	S.description = "Explosion Force Field: wind, attraction, vortex, drag and curl turbulence for the Explosion subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.explosion.force_field", seed = 12721 })
		inst.system = S
		inst.ctx = ctx
