-- ARKHER SYSTEM O.0269 :: Stinger Voice Budget
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0269"
	S.key = "arkher.audio.stinger.voice_budget"
	S.name = "Stinger Voice Budget"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Stinger"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.stinger.music_sequencer" }
	S.tags = { "o", "stinger", "budgeter", "audio" }
	S.description = "Stinger Voice Budget: voice slots allocated by priority and audibility for the Stinger subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.audio.stinger.voice_budget", total = 181, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
