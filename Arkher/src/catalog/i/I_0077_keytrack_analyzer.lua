-- ARKHER SYSTEM I.0077 :: Keyframe Track Analysis
...
return function(A)
	...
	local S = {}
	S.id = "I.0077"
	S.key = "arkher.anim.keytrack.analysis"
	S.name = "Keyframe Track Analysis"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.keytrack.quality_policy" }
	S.tags = { "i", "keytrack", "analyzer", "anim" }
	S.description = "Keyframe Track Analysis: pop, drift and cost analysis of playback for the Keyframe Track subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.anim.keytrack.analysis", window = 115, buckets = 11, threshold = 4.70 })
		inst.system = S
		inst.ctx = ctx
