-- ARKHER SYSTEM N.0290 :: Buff Effect Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0290"
	S.key = "arkher.vfx.bufffx.ribbon_and_trail"
	S.name = "Buff Effect Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Buff Effect"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.bufffx.force_field" }
	S.tags = { "n", "bufffx", "ribbon", "vfx" }
	S.description = "Buff Effect Ribbon And Trail: trail points, tapering, beams and decimation for the Buff Effect subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.bufffx.ribbon_and_trail", maxPoints = 40, lifetime = 2.00, minDistance = 0.35, width = 0.50 })
		inst.system = S
		inst.ctx = ctx
