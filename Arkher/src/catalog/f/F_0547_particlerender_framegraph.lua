-- ARKHER SYSTEM F.0547 :: Particle Rendering Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0547"
	S.key = "arkher.render.particlerender.frame_graph"
	S.name = "Particle Rendering Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "particlerender", "framegraph", "render" }
	S.description = "Particle Rendering Frame Graph: declared passes, culling, ordering and aliasing for the Particle Rendering subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.particlerender.frame_graph", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
