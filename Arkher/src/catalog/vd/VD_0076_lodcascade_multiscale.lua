-- ARKHER SYSTEM VD.0076 :: LOD Cascade Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0076"
	S.key = "arkher.contsim.lodcascade.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lodcascade.sparse_residency" }
	S.tags = { "vd", "lodcascade", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.lodcascade.multi-scale_fidelity", levels = 6, baseTriangles = 60000 })
		inst.system = S
		inst.ctx = ctx
