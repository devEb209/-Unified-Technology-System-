-- ARKHER SYSTEM VA.0581 :: Thermal Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0581"
	S.key = "arkher.contworld.thermalcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.thermalcont.multi-scale_fidelity" }
	S.tags = { "va", "thermalcont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.thermalcont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
