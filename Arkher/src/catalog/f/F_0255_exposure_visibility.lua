-- ARKHER SYSTEM F.0255 :: Exposure Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0255"
	S.key = "arkher.render.exposure.visibility_set"
	S.name = "Exposure Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Exposure"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.exposure.view_and_culling" }
	S.tags = { "f", "exposure", "visibility", "render" }
	S.description = "Exposure Visibility Set: cell, portal and occluder visibility for the Exposure subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.exposure.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
