-- ARKHER SYSTEM G.0075 :: Disocclusion Handling Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0075"
	S.key = "arkher.neural.disocclusion.model_registry"
	S.name = "Disocclusion Handling Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.disocclusion.reconstruction" }
	S.tags = { "g", "disocclusion", "registry", "neural" }
	S.description = "Disocclusion Handling Model Registry: named models and their lifecycle for the Disocclusion Handling subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.disocclusion.model_registry" })
		inst.system = S
		inst.ctx = ctx
