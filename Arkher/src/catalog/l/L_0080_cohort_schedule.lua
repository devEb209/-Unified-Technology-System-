-- ARKHER SYSTEM L.0080 :: Cohort Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0080"
	S.key = "arkher.sim.cohort.calendar"
	S.name = "Cohort Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.cohort.society" }
	S.tags = { "l", "cohort", "schedule", "sim" }
	S.description = "Cohort Calendar: hours, days and seasons driving the region for the Cohort subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.cohort.calendar", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
