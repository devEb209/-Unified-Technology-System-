-- ARKHER SYSTEM V.0250 :: Localization Asset Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0250"
	S.key = "arkher.asset.localizationasset.validation_guard"
	S.name = "Localization Asset Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.localizationasset.size_budget" }
	S.tags = { "v", "localizationasset", "guard", "asset" }
	S.description = "Localization Asset Validation Guard: rate limiting and capability checks on the import path for the Localization Asset subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.localizationasset.validation_guard", algorithm = "leaky", capacity = 60, refillPerSec = 25, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
