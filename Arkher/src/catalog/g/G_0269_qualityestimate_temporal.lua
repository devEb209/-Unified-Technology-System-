-- ARKHER SYSTEM G.0269 :: Quality Estimation Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0269"
	S.key = "arkher.neural.qualityestimate.temporal_history"
	S.name = "Quality Estimation Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.qualityestimate.feature_extraction" }
	S.tags = { "g", "qualityestimate", "temporal", "neural" }
	S.description = "Quality Estimation Temporal History: history buffers reused across frames for the Quality Estimation subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.qualityestimate.temporal_history", feedback = 0.90, phase = 8 })
		inst.system = S
		inst.ctx = ctx
