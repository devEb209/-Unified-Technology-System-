-- ARKHER SYSTEM VB.0261 :: Road Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0261"
	S.key = "arkher.conttime.roadcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.roadcont.world_memory_stream" }
	S.tags = { "vb", "roadcont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.roadcont.complexity_budget", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
