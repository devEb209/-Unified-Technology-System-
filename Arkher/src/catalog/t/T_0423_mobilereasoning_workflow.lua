-- ARKHER SYSTEM T.0423 :: Mobile Reasoning Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0423"
	S.key = "arkher.ai.mobilereasoning.plan_workflow"
	S.name = "Mobile Reasoning Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.mobilereasoning.semantic_knowledge" }
	S.tags = { "t", "mobilereasoning", "workflow", "ai" }
	S.description = "Mobile Reasoning Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Mobile Reasoning subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.mobilereasoning.plan_workflow", maxRetries = 2, budget = 50 })
		inst.system = S
		inst.ctx = ctx
