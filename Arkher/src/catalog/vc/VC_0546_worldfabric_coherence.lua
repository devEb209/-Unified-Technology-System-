-- ARKHER SYSTEM VC.0546 :: World Fabric Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0546"
	S.key = "arkher.contneural.worldfabric.coherence_guard"
	S.name = "World Fabric Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.worldfabric.persistent_state" }
	S.tags = { "vc", "worldfabric", "coherence", "contneural" }
	S.description = "World Fabric Coherence Guard: seam coherence and drift supervision for the World Fabric subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.worldfabric.coherence_guard", window = 75, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
