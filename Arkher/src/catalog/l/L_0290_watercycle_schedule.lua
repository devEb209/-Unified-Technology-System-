-- ARKHER SYSTEM L.0290 :: Water Cycle Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0290"
	S.key = "arkher.sim.watercycle.calendar"
	S.name = "Water Cycle Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.watercycle.society" }
	S.tags = { "l", "watercycle", "schedule", "sim" }
	S.description = "Water Cycle Calendar: hours, days and seasons driving the region for the Water Cycle subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.watercycle.calendar", startHour = 9 })
		inst.system = S
		inst.ctx = ctx
