-- ARKHER SYSTEM VA.0424 :: Navigation Continuum Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VA.0424"
	S.key = "arkher.contworld.navcont.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.navcont.sparse_residency" }
	S.tags = { "va", "navcont", "multiscale", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contworld.navcont.multi-scale_fidelity", levels = 4, baseTriangles = 165000 })
		inst.system = S
		inst.ctx = ctx
