-- ARKHER SYSTEM T.0401 :: Performance Reasoning Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0401"
	S.key = "arkher.ai.performancereasoning.working_memory"
	S.name = "Performance Reasoning Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.performancereasoning.outcome_prediction" }
	S.tags = { "t", "performancereasoning", "memory", "ai" }
	S.description = "Performance Reasoning Working Memory: decaying, consolidating recall of what the agent learned for the Performance Reasoning subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.performancereasoning.working_memory", capacity = 82, decayRate = 0.020, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
