-- ARKHER SYSTEM L.0532 :: Disease Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0532"
	S.key = "arkher.sim.disease.route_network"
	S.name = "Disease Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.disease.region_graph" }
	S.tags = { "l", "disease", "network", "sim" }
	S.description = "Disease Route Network: roads, rivers and routes between settlements for the Disease subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.disease.route_network" })
		inst.system = S
		inst.ctx = ctx
