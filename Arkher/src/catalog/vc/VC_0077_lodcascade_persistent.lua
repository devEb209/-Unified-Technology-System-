-- ARKHER SYSTEM VC.0077 :: LOD Cascade Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0077"
	S.key = "arkher.contneural.lodcascade.persistent_state"
	S.name = "LOD Cascade Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lodcascade.multi-scale_fidelity" }
	S.tags = { "vc", "lodcascade", "persistent", "contneural" }
	S.description = "LOD Cascade Persistent State: epoch-stamped persistent history and rollback for the LOD Cascade subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.lodcascade.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
