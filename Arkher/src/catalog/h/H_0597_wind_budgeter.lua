-- ARKHER SYSTEM H.0597 :: Wind Force Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0597"
	S.key = "arkher.physics.wind.budget_governor"
	S.name = "Wind Force Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Wind Force"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.wind.broadphase_index" }
	S.tags = { "h", "wind", "budgeter", "physics" }
	S.description = "Wind Force Budget Governor: simulation time budget allocation across islands for the Wind Force subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.wind.budget_governor", total = 392, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
