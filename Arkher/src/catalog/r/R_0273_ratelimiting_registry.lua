-- ARKHER SYSTEM R.0273 :: Rate Limiting Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0273"
	S.key = "arkher.net.ratelimiting.session_registry"
	S.name = "Rate Limiting Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.ratelimiting.rate_guard" }
	S.tags = { "r", "ratelimiting", "registry", "net" }
	S.description = "Rate Limiting Session Registry: catalogue of sessions, players and their metadata for the Rate Limiting subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.ratelimiting.session_registry" })
		inst.system = S
		inst.ctx = ctx
