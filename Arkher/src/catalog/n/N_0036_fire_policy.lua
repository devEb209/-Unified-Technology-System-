-- ARKHER SYSTEM N.0036 :: Fire Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0036"
	S.key = "arkher.vfx.fire.quality_policy"
	S.name = "Fire Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fire"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fire.result_cache" }
	S.tags = { "n", "fire", "policy", "vfx" }
	S.description = "Fire Quality Policy: distance and device driven fidelity bands for the Fire subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.fire.quality_policy", algorithm = "roundrobin", starvationGuard = 16 })
		inst.system = S
		inst.ctx = ctx
