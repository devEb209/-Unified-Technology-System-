-- ARKHER SYSTEM VD.0243 :: Vegetation Field Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0243"
	S.key = "arkher.contsim.vegfield.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.vegfield.epoch_clock" }
	S.tags = { "vd", "vegfield", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.vegfield.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
