-- ARKHER SYSTEM VC.0082 :: LOD Cascade Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VC.0082"
	S.key = "arkher.contneural.lodcascade.simulation_fabric"
	S.name = "LOD Cascade Simulation Fabric"
	S.category = "VC"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lodcascade.complexity_budget" }
	S.tags = { "vc", "lodcascade", "fabric", "contneural" }
	S.description = "LOD Cascade Simulation Fabric: fabric stepping the continuum domains for the LOD Cascade subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contneural.lodcascade.simulation_fabric", budgetMs = 1.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
