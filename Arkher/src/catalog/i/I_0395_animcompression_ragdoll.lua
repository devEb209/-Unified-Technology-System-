-- ARKHER SYSTEM I.0395 :: Animation Compression Physical Blend
...
return function(A)
	...
	local S = {}
	S.id = "I.0395"
	S.key = "arkher.anim.animcompression.physical_blend"
	S.name = "Animation Compression Physical Blend"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animcompression.inverse_kinematics" }
	S.tags = { "i", "animcompression", "ragdoll", "anim" }
	S.description = "Animation Compression Physical Blend: physical bones blended against the animated pose for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.anim.animcompression.physical_blend", blendSpeed = 2.30 })
		inst.system = S
		inst.ctx = ctx
