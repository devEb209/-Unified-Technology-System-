-- ARKHER SYSTEM H.0554 :: Cloth Simulation Broadphase Index
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0554"
	S.key = "arkher.physics.cloth.broadphase_index"
	S.name = "Cloth Simulation Broadphase Index"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.cloth.vehicle" }
	S.tags = { "h", "cloth", "index", "physics" }
	S.description = "Cloth Simulation Broadphase Index: spatial acceleration of candidate pair finding for the Cloth Simulation subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.physics.cloth.broadphase_index", mode = "hash", cellSize = 16 })
		inst.system = S
		inst.ctx = ctx
