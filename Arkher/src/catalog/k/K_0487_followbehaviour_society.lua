-- ARKHER SYSTEM K.0487 :: Follow Behaviour Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0487"
	S.key = "arkher.npc.followbehaviour.social_relations"
	S.name = "Follow Behaviour Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.followbehaviour.crowd_steering" }
	S.tags = { "k", "followbehaviour", "society", "npc" }
	S.description = "Follow Behaviour Social Relations: affinity, factions, reputation and gossip for the Follow Behaviour subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.followbehaviour.social_relations", decayRate = 0.014, gossipReach = 3 })
		inst.system = S
		inst.ctx = ctx
