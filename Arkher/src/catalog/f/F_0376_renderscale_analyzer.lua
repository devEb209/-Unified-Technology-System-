-- ARKHER SYSTEM F.0376 :: Render Scale Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0376"
	S.key = "arkher.render.renderscale.frame_analysis"
	S.name = "Render Scale Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Render Scale"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.renderscale.pass_cache" }
	S.tags = { "f", "renderscale", "analyzer", "render" }
	S.description = "Render Scale Frame Analysis: per-pass cost analysis and outlier detection for the Render Scale subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.renderscale.frame_analysis", window = 114, buckets = 14, threshold = 2.60 })
		inst.system = S
		inst.ctx = ctx
