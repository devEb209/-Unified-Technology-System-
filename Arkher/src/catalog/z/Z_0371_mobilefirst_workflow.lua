-- ARKHER SYSTEM Z.0371 :: Mobile First Governor Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0371"
	S.key = "arkher.origin.mobilefirst.adaptive_workflow"
	S.name = "Mobile First Governor Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.self_critique" }
	S.tags = { "z", "mobilefirst", "workflow", "origin" }
	S.description = "Mobile First Governor Adaptive Workflow: verified, retryable, reversible execution plans for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.mobilefirst.adaptive_workflow", maxRetries = 3, budget = 60 })
		inst.system = S
		inst.ctx = ctx
