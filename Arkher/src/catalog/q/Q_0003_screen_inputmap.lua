-- ARKHER SYSTEM Q.0003 :: Screen Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0003"
	S.key = "arkher.ui.screen.input_mapping"
	S.name = "Screen Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Screen"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.screen.widget_tree" }
	S.tags = { "q", "screen", "inputmap", "ui" }
	S.description = "Screen Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Screen subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.screen.input_mapping", device = "touch", holdTime = 0.32, deadzone = 0.22 })
		inst.system = S
		inst.ctx = ctx
