-- ARKHER SYSTEM H.0590 :: Wind Force Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0590"
	S.key = "arkher.physics.wind.collision_shape"
	S.name = "Wind Force Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Wind Force"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.wind.body_dynamics" }
	S.tags = { "h", "wind", "collider", "physics" }
	S.description = "Wind Force Collision Shape: shape bounds, support mapping and closest points for the Wind Force subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.wind.collision_shape", shape = "sphere", radius = 1.90, height = 1.50, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
