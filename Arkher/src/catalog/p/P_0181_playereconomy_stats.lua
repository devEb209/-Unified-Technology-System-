-- ARKHER SYSTEM P.0181 :: Economy Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0181"
	S.key = "arkher.play.playereconomy.attributes"
	S.name = "Economy Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Economy"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "playereconomy", "stats", "play" }
	S.description = "Economy Attributes: base values, layered modifiers and derived statistics for the Economy subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.playereconomy.attributes" })
		inst.system = S
		inst.ctx = ctx
