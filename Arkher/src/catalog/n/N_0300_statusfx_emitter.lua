-- ARKHER SYSTEM N.0300 :: Status Effect Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0300"
	S.key = "arkher.vfx.statusfx.emission"
	S.name = "Status Effect Emission"
	S.category = "N"
	S.family = "VFX"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "statusfx", "emitter", "vfx" }
	S.description = "Status Effect Emission: shaped, rate and burst emission of new particles for the Status Effect subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.statusfx.emission", shape = "box", rate = 22, speed = 5.20, life = 1.00, budget = 512, seed = 38702 })
		inst.system = S
		inst.ctx = ctx
