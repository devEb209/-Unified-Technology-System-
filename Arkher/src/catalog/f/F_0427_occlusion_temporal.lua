-- ARKHER SYSTEM F.0427 :: Occlusion Culling Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0427"
	S.key = "arkher.render.occlusion.temporal_resolve"
	S.name = "Occlusion Culling Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.occlusion.probe_volume" }
	S.tags = { "f", "occlusion", "temporal", "render" }
	S.description = "Occlusion Culling Temporal Resolve: history reprojection with neighbourhood clamping for the Occlusion Culling subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.occlusion.temporal_resolve", feedback = 0.94, phase = 8 })
		inst.system = S
		inst.ctx = ctx
