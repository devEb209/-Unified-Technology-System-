-- ARKHER SYSTEM VD.0568 :: Mobile Continuum Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0568"
	S.key = "arkher.contsim.mobilecont.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.mobilecont.sparse_residency" }
	S.tags = { "vd", "mobilecont", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.mobilecont.multi-scale_fidelity", levels = 6, baseTriangles = 90000 })
		inst.system = S
		inst.ctx = ctx
