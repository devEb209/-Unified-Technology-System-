-- ARKHER SYSTEM F.0549 :: Particle Rendering Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0549"
	S.key = "arkher.render.particlerender.visibility_set"
	S.name = "Particle Rendering Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.particlerender.view_and_culling" }
	S.tags = { "f", "particlerender", "visibility", "render" }
	S.description = "Particle Rendering Visibility Set: cell, portal and occluder visibility for the Particle Rendering subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.particlerender.visibility_set", maxDepth = 3 })
		inst.system = S
		inst.ctx = ctx
