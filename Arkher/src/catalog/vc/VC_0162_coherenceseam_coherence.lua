-- ARKHER SYSTEM VC.0162 :: Coherence Seam Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0162"
	S.key = "arkher.contneural.coherenceseam.coherence_guard"
	S.name = "Coherence Seam Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.coherenceseam.persistent_state" }
	S.tags = { "vc", "coherenceseam", "coherence", "contneural" }
	S.description = "Coherence Seam Coherence Guard: seam coherence and drift supervision for the Coherence Seam subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.coherenceseam.coherence_guard", window = 94, threshold = 0.10 })
		inst.system = S
		inst.ctx = ctx
