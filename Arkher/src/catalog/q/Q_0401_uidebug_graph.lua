-- ARKHER SYSTEM Q.0401 :: UI Debug Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0401"
	S.key = "arkher.ui.uidebug.navigation_graph"
	S.name = "UI Debug Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "UI Debug"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uidebug.transition" }
	S.tags = { "q", "uidebug", "graph", "ui" }
	S.description = "UI Debug Navigation Graph: screens, routes and shortest path between them for the UI Debug subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.uidebug.navigation_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
