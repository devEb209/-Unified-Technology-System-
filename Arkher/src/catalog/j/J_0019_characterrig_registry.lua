-- ARKHER SYSTEM J.0019 :: Character Rig Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0019"
	S.key = "arkher.character.characterrig.variant_registry"
	S.name = "Character Rig Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterrig.appearance_composer" }
	S.tags = { "j", "characterrig", "registry", "character" }
	S.description = "Character Rig Variant Registry: named character variants and their lifecycle for the Character Rig subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.characterrig.variant_registry" })
		inst.system = S
		inst.ctx = ctx
