-- ARKHER SYSTEM G.0439 :: Model Versioning Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0439"
	S.key = "arkher.neural.modelversion.model_registry"
	S.name = "Model Versioning Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.modelversion.reconstruction" }
	S.tags = { "g", "modelversion", "registry", "neural" }
	S.description = "Model Versioning Model Registry: named models and their lifecycle for the Model Versioning subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.modelversion.model_registry" })
		inst.system = S
		inst.ctx = ctx
