-- ARKHER SYSTEM W.0287 :: Depth Of Field Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0287"
	S.key = "arkher.cine.depthoffield.sequence_analysis"
	S.name = "Depth Of Field Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.depthoffield.frame_budget" }
	S.tags = { "w", "depthoffield", "analyzer", "cine" }
	S.description = "Depth Of Field Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.depthoffield.sequence_analysis", window = 126, buckets = 10, threshold = 2.80 })
		inst.system = S
		inst.ctx = ctx
