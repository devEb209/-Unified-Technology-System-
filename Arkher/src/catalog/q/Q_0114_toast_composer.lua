-- ARKHER SYSTEM Q.0114 :: Toast Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0114"
	S.key = "arkher.ui.toast.theme_composition"
	S.name = "Toast Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Toast"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.toast.navigation_graph" }
	S.tags = { "q", "toast", "composer", "ui" }
	S.description = "Toast Theme Composition: blending of theme signals into the final appearance for the Toast subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.toast.theme_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
