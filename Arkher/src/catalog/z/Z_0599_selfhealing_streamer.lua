-- ARKHER SYSTEM Z.0599 :: Self Healing Systems Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0599"
	S.key = "arkher.origin.selfhealing.residency_streaming"
	S.name = "Self Healing Systems Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.selfhealing.budget_governor" }
	S.tags = { "z", "selfhealing", "streamer", "origin" }
	S.description = "Self Healing Systems Residency Streaming: distance-driven residency of the technology's workload for the Self Healing Systems subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.selfhealing.residency_streaming", radius = 360, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
