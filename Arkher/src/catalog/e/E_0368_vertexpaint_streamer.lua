-- ARKHER SYSTEM E.0368 :: Vertex Painting Streaming
...
return function(A)
	...
	local S = {}
	S.id = "E.0368"
	S.key = "arkher.material.vertexpaint.streaming"
	S.name = "Vertex Painting Streaming"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.vertexpaint.parameter_budget" }
	S.tags = { "e", "vertexpaint", "streamer", "material" }
	S.description = "Vertex Painting Streaming: residency and demand-driven texture streaming for the Vertex Painting subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.material.vertexpaint.streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
