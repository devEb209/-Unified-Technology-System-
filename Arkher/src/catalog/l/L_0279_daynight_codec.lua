-- ARKHER SYSTEM L.0279 :: Day Night Cycle State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0279"
	S.key = "arkher.sim.daynight.state_codec"
	S.name = "Day Night Cycle State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.daynight.history_ledger" }
	S.tags = { "l", "daynight", "codec", "sim" }
	S.description = "Day Night Cycle State Codec: persistence, diffing and checksum of the world state for the Day Night Cycle subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.daynight.state_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
