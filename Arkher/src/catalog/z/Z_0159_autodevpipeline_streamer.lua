-- ARKHER SYSTEM Z.0159 :: Autonomous Development Pipeline Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0159"
	S.key = "arkher.origin.autodevpipeline.residency_streaming"
	S.name = "Autonomous Development Pipeline Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodevpipeline.budget_governor" }
	S.tags = { "z", "autodevpipeline", "streamer", "origin" }
	S.description = "Autonomous Development Pipeline Residency Streaming: distance-driven residency of the technology's workload for the Autonomous Development Pipeline subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.autodevpipeline.residency_streaming", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
