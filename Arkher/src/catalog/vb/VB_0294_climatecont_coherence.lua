-- ARKHER SYSTEM VB.0294 :: Climate Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0294"
	S.key = "arkher.conttime.climatecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.climatecont.persistent_state" }
	S.tags = { "vb", "climatecont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.climatecont.coherence_guard", window = 49, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
