-- ARKHER SYSTEM VC.0153 :: Persistence Segment Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0153"
	S.key = "arkher.contneural.persistsegment.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.persistsegment.world_memory_stream" }
	S.tags = { "vc", "persistsegment", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.persistsegment.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
