-- ARKHER SYSTEM VB.0521 :: Asset Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0521"
	S.key = "arkher.conttime.assetcont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.assetcont.multi-scale_fidelity" }
	S.tags = { "vb", "assetcont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.assetcont.persistent_state", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
