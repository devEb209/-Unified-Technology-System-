-- ARKHER SYSTEM H.0446 :: Penetration Recovery Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0446"
	S.key = "arkher.physics.penetration.analysis"
	S.name = "Penetration Recovery Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.penetration.result_cache" }
	S.tags = { "h", "penetration", "analyzer", "physics" }
	S.description = "Penetration Recovery Analysis: energy, jitter and cost analysis of the simulation for the Penetration Recovery subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.penetration.analysis", window = 51, buckets = 11, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
