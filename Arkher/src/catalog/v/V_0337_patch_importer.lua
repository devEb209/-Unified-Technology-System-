-- ARKHER SYSTEM V.0337 :: Patch Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0337"
	S.key = "arkher.asset.patch.import"
	S.name = "Patch Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "patch", "importer", "asset" }
	S.description = "Patch Import: validation, normalization, hashing and deduplication of incoming content for the Patch subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.patch.import", unitScale = 1.00 })
		inst.system = S
		inst.ctx = ctx
