-- ARKHER SYSTEM O.0134 :: Rain Audio Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0134"
	S.key = "arkher.audio.rainaudio.mixer_bus"
	S.name = "Rain Audio Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Rain Audio"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.rainaudio.dsp_chain" }
	S.tags = { "o", "rainaudio", "mixer", "audio" }
	S.description = "Rain Audio Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Rain Audio subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.rainaudio.mixer_bus", maxVoices = 24 })
		inst.system = S
		inst.ctx = ctx
