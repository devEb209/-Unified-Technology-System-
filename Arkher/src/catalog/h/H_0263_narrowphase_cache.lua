-- ARKHER SYSTEM H.0263 :: Narrowphase Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0263"
	S.key = "arkher.physics.narrowphase.result_cache"
	S.name = "Narrowphase Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Narrowphase"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.narrowphase.simulation_policy" }
	S.tags = { "h", "narrowphase", "cache", "physics" }
	S.description = "Narrowphase Result Cache: reuse of expensive simulation and query results for the Narrowphase subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.narrowphase.result_cache", policy = "ttl", capacity = 380, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
