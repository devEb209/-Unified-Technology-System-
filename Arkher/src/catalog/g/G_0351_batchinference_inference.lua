-- ARKHER SYSTEM G.0351 :: Batch Inference Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0351"
	S.key = "arkher.neural.batchinference.inference_core"
	S.name = "Batch Inference Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "batchinference", "inference", "neural" }
	S.description = "Batch Inference Inference Core: dense network forward pass and training for the Batch Inference subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.batchinference.inference_core", seed = 41333 })
		inst.system = S
		inst.ctx = ctx
