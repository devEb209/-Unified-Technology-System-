-- ARKHER SYSTEM Z.0357 :: Device Aware Fidelity Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0357"
	S.key = "arkher.origin.deviceaware.behaviour_analysis"
	S.name = "Device Aware Fidelity Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.governance_policy" }
	S.tags = { "z", "deviceaware", "analyzer", "origin" }
	S.description = "Device Aware Fidelity Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.deviceaware.behaviour_analysis", window = 222, buckets = 18, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
