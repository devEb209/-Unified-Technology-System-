-- ARKHER SYSTEM W.0206 :: Montage Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0206"
	S.key = "arkher.cine.montage.camera_rig"
	S.name = "Montage Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Montage"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.montage.sequence_timeline" }
	S.tags = { "w", "montage", "camerarig", "cine" }
	S.description = "Montage Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Montage subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.montage.camera_rig", fov = 0.98, focus = 12.0, aperture = 5.4, smoothing = 10.0, distance = 14, height = 4 })
		inst.system = S
		inst.ctx = ctx
