-- ARKHER SYSTEM F.0071 :: Cascade Shadows Frame Graph
...
return function(A)
	...
	local S = {}
	S.id = "F.0071"
	S.key = "arkher.render.cascades.frame_graph"
	S.name = "Cascade Shadows Frame Graph"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "f", "cascades", "framegraph", "render" }
	S.description = "Cascade Shadows Frame Graph: declared passes, culling, ordering and aliasing for the Cascade Shadows subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("framegraph", { id = "arkher.render.cascades.frame_graph", budgetMs = 13.00 })
		inst.system = S
		inst.ctx = ctx
