-- ARKHER SYSTEM R.0285 :: Anti Cheat Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0285"
	S.key = "arkher.net.anticheat.session_registry"
	S.name = "Anti Cheat Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Anti Cheat"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.anticheat.rate_guard" }
	S.tags = { "r", "anticheat", "registry", "net" }
	S.description = "Anti Cheat Session Registry: catalogue of sessions, players and their metadata for the Anti Cheat subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.anticheat.session_registry" })
		inst.system = S
		inst.ctx = ctx
