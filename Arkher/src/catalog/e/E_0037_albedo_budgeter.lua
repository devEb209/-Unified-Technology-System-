-- ARKHER SYSTEM E.0037 :: Albedo Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0037"
	S.key = "arkher.material.albedo.parameter_budget"
	S.name = "Albedo Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Albedo"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.albedo.variant_registry" }
	S.tags = { "e", "albedo", "budgeter", "material" }
	S.description = "Albedo Parameter Budget: texel and layer budget allocation for the Albedo subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.albedo.parameter_budget", total = 399, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
