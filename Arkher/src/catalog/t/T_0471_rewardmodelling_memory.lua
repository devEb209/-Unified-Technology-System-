-- ARKHER SYSTEM T.0471 :: Reward Modelling Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0471"
	S.key = "arkher.ai.rewardmodelling.working_memory"
	S.name = "Reward Modelling Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.rewardmodelling.outcome_prediction" }
	S.tags = { "t", "rewardmodelling", "memory", "ai" }
	S.description = "Reward Modelling Working Memory: decaying, consolidating recall of what the agent learned for the Reward Modelling subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.rewardmodelling.working_memory", capacity = 61, decayRate = 0.045, consolidateAt = 3 })
		inst.system = S
		inst.ctx = ctx
