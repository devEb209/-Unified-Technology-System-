-- ARKHER SYSTEM VB.0382 :: Dialogue Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0382"
	S.key = "arkher.conttime.dialoguecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.dialoguecont.complexity_budget" }
	S.tags = { "vb", "dialoguecont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.dialoguecont.simulation_fabric", budgetMs = 2.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
