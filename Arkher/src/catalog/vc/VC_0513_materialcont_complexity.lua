-- ARKHER SYSTEM VC.0513 :: Material Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0513"
	S.key = "arkher.contneural.materialcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.materialcont.world_memory_stream" }
	S.tags = { "vc", "materialcont", "complexity", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.materialcont.complexity_budget", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
