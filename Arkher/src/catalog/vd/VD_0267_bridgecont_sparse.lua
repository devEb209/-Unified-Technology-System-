-- ARKHER SYSTEM VD.0267 :: Bridge Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0267"
	S.key = "arkher.contsim.bridgecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.bridgecont.epoch_clock" }
	S.tags = { "vd", "bridgecont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.bridgecont.sparse_residency", capacity = 640, pageBytes = 6144 })
		inst.system = S
		inst.ctx = ctx
