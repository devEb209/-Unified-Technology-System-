-- ARKHER SYSTEM K.0298 :: Attention Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0298"
	S.key = "arkher.npc.attention.emotion"
	S.name = "Attention Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.attention.drive_system" }
	S.tags = { "k", "attention", "emotion", "npc" }
	S.description = "Attention Emotion: appraisal of events into valence, arousal and mood for the Attention subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.attention.emotion", inertia = 0.92, decayRate = 0.27, baselineArousal = 0.27 })
		inst.system = S
		inst.ctx = ctx
