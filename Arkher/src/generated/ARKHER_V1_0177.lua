--!strict
-- ZBrush SubTool — ANIMATION Mixer #0177
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="ZBrush SubTool — ANIMATION Mixer #0177", size=Vector2.new(600, 460), pos=UDim2.fromOffset(401, 229), parent=parent, icon="▣"})
