-- ARKHER SYSTEM J.0023 :: Body Proportions Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0023"
	S.key = "arkher.character.proportions.rig_definition"
	S.name = "Body Proportions Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "proportions", "skeleton", "character" }
	S.description = "Body Proportions Rig Definition: character rig definition and bone budget for the Body Proportions subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.proportions.rig_definition" })
		inst.system = S
		inst.ctx = ctx
