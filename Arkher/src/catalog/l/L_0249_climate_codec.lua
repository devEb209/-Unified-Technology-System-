-- ARKHER SYSTEM L.0249 :: Climate State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0249"
	S.key = "arkher.sim.climate.state_codec"
	S.name = "Climate State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.climate.history_ledger" }
	S.tags = { "l", "climate", "codec", "sim" }
	S.description = "Climate State Codec: persistence, diffing and checksum of the world state for the Climate subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.climate.state_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
