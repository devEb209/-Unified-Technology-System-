-- ARKHER SYSTEM F.0382 :: Sharpening Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0382"
	S.key = "arkher.render.sharpening.geometry_virtualization"
	S.name = "Sharpening Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Sharpening"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.sharpening.visibility_set" }
	S.tags = { "f", "sharpening", "impostor", "render" }
	S.description = "Sharpening Geometry Virtualization: impostor and HLOD synthesis under a budget for the Sharpening subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.sharpening.geometry_virtualization", atlasSlots = 64, viewCount = 8, errorThreshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
