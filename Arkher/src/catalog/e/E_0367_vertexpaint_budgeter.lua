-- ARKHER SYSTEM E.0367 :: Vertex Painting Parameter Budget
...
return function(A)
	...
	local S = {}
	S.id = "E.0367"
	S.key = "arkher.material.vertexpaint.parameter_budget"
	S.name = "Vertex Painting Parameter Budget"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.material.vertexpaint.variant_registry" }
	S.tags = { "e", "vertexpaint", "budgeter", "material" }
	S.description = "Vertex Painting Parameter Budget: texel and layer budget allocation for the Vertex Painting subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.material.vertexpaint.parameter_budget", total = 290, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
