-- ARKHER SYSTEM O.0175 :: City Audio Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0175"
	S.key = "arkher.audio.cityaudio.asset_registry"
	S.name = "City Audio Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "City Audio"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.cityaudio.streaming" }
	S.tags = { "o", "cityaudio", "registry", "audio" }
	S.description = "City Audio Asset Registry: catalogue of sounds, variations and metadata for the City Audio subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.cityaudio.asset_registry" })
		inst.system = S
		inst.ctx = ctx
