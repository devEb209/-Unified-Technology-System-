-- ARKHER SYSTEM W.0054 :: Close Up Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0054"
	S.key = "arkher.cine.closeup.playback_orchestrator"
	S.name = "Close Up Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Close Up"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.closeup.cut_policy" }
	S.tags = { "w", "closeup", "orchestrator", "cine" }
	S.description = "Close Up Playback Orchestrator: the state machine that drives a cinematic from start to end for the Close Up subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.closeup.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
