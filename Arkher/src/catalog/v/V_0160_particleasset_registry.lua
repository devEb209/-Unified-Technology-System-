-- ARKHER SYSTEM V.0160 :: Particle Asset Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0160"
	S.key = "arkher.asset.particleasset.asset_registry"
	S.name = "Particle Asset Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.particleasset.cook_pipeline" }
	S.tags = { "v", "particleasset", "registry", "asset" }
	S.description = "Particle Asset Asset Registry: catalogue of every asset, its tags and its metadata for the Particle Asset subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.particleasset.asset_registry" })
		inst.system = S
		inst.ctx = ctx
