-- ARKHER SYSTEM J.0082 :: Facial Rig Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0082"
	S.key = "arkher.character.facialrig.physical_response"
	S.name = "Facial Rig Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.facialrig.look_and_reach" }
	S.tags = { "j", "facialrig", "ragdoll", "character" }
	S.description = "Facial Rig Physical Response: physical reaction, ragdoll and recovery for the Facial Rig subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.facialrig.physical_response", blendSpeed = 2.50 })
		inst.system = S
		inst.ctx = ctx
