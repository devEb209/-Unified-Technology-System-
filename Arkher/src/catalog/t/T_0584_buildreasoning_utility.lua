-- ARKHER SYSTEM T.0584 :: Build Reasoning Utility Selection
...
return function(A)
	...
	local S = {}
	S.id = "T.0584"
	S.key = "arkher.ai.buildreasoning.utility_selection"
	S.name = "Build Reasoning Utility Selection"
	S.category = "T"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.buildreasoning.working_memory" }
	S.tags = { "t", "buildreasoning", "utility", "ai" }
	S.description = "Build Reasoning Utility Selection: scored choice between competing courses of action for the Build Reasoning subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.ai.buildreasoning.utility_selection", momentum = 0.16 })
		inst.system = S
		inst.ctx = ctx
