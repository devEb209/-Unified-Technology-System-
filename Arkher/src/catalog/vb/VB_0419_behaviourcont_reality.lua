-- ARKHER SYSTEM VB.0419 :: Behaviour Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0419"
	S.key = "arkher.conttime.behaviourcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.behaviourcont.simulation_fabric" }
	S.tags = { "vb", "behaviourcont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.behaviourcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
