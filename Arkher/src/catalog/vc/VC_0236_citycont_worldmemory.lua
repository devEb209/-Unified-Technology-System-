-- ARKHER SYSTEM VC.0236 :: City Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0236"
	S.key = "arkher.contneural.citycont.world_memory_stream"
	S.name = "City Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.citycont.neural_field" }
	S.tags = { "vc", "citycont", "worldmemory", "contneural" }
	S.description = "City Continuum World Memory Stream: world memory continuum over epochs for the City Continuum subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.citycont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
