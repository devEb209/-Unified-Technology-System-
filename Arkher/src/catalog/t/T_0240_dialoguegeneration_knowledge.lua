-- ARKHER SYSTEM T.0240 :: Dialogue Generation Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0240"
	S.key = "arkher.ai.dialoguegeneration.semantic_knowledge"
	S.name = "Dialogue Generation Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.dialoguegeneration.intent_understanding" }
	S.tags = { "t", "dialoguegeneration", "knowledge", "ai" }
	S.description = "Dialogue Generation Semantic Knowledge: typed entities, weighted relations and inferred closure for the Dialogue Generation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.dialoguegeneration.semantic_knowledge", dims = 40 })
		inst.system = S
		inst.ctx = ctx
