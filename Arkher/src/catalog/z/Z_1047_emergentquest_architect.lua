-- ARKHER SYSTEM Z.1047 :: Emergent Quest Generation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.1047"
	S.key = "arkher.origin.emergentquest.world_architect"
	S.name = "Emergent Quest Generation World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentquest.emergence_detection" }
	S.tags = { "z", "emergentquest", "architect", "origin" }
	S.description = "Emergent Quest Generation World Architect: hierarchical world composition with conserved budgets for the Emergent Quest Generation subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.emergentquest.world_architect", budget = 1100, seed = 91365 })
		inst.system = S
		inst.ctx = ctx
