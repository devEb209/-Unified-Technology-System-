-- ARKHER SYSTEM O.0202 :: Reverb Zone Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0202"
	S.key = "arkher.audio.reverbzone.analysis"
	S.name = "Reverb Zone Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Reverb Zone"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.reverbzone.playback_policy" }
	S.tags = { "o", "reverbzone", "analyzer", "audio" }
	S.description = "Reverb Zone Analysis: loudness, headroom and masking analysis for the Reverb Zone subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.reverbzone.analysis", window = 104, buckets = 16, threshold = 4.60 })
		inst.system = S
		inst.ctx = ctx
