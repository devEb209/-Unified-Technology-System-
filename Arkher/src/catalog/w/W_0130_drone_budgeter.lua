-- ARKHER SYSTEM W.0130 :: Drone Shot Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0130"
	S.key = "arkher.cine.drone.frame_budget"
	S.name = "Drone Shot Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Drone Shot"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.drone.event_ledger" }
	S.tags = { "w", "drone", "budgeter", "cine" }
	S.description = "Drone Shot Frame Budget: per-frame cost budget for the cinematic systems for the Drone Shot subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.drone.frame_budget", total = 89, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
