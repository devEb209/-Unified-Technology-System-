-- ARKHER SYSTEM VA.0035 :: Zone Chunk Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0035"
	S.key = "arkher.contworld.zonechunk.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.zonechunk.simulation_fabric" }
	S.tags = { "va", "zonechunk", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.zonechunk.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
