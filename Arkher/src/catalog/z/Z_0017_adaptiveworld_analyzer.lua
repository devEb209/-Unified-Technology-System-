-- ARKHER SYSTEM Z.0017 :: Adaptive World Intelligence Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0017"
	S.key = "arkher.origin.adaptiveworld.behaviour_analysis"
	S.name = "Adaptive World Intelligence Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.adaptiveworld.governance_policy" }
	S.tags = { "z", "adaptiveworld", "analyzer", "origin" }
	S.description = "Adaptive World Intelligence Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Adaptive World Intelligence subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.adaptiveworld.behaviour_analysis", window = 158, buckets = 10, threshold = 4.00 })
		inst.system = S
		inst.ctx = ctx
