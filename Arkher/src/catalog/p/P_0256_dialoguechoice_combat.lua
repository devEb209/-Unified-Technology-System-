-- ARKHER SYSTEM P.0256 :: Dialogue Choice Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0256"
	S.key = "arkher.play.dialoguechoice.combat_resolution"
	S.name = "Dialogue Choice Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.dialoguechoice.objectives" }
	S.tags = { "p", "dialoguechoice", "combat", "play" }
	S.description = "Dialogue Choice Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Dialogue Choice subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.dialoguechoice.combat_resolution", seed = 55990, armourK = 140, critMultiplier = 2.50 })
		inst.system = S
		inst.ctx = ctx
