-- ARKHER SYSTEM V.0281 :: Impostor Asset Dependency Graph
...
return function(A)
	...
	local S = {}
	S.id = "V.0281"
	S.key = "arkher.asset.impostorasset.dependency_graph"
	S.name = "Impostor Asset Dependency Graph"
	S.category = "V"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.impostorasset.asset_registry" }
	S.tags = { "v", "impostorasset", "graph", "asset" }
	S.description = "Impostor Asset Dependency Graph: what references what, and in which order it must be built for the Impostor Asset subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.asset.impostorasset.dependency_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
