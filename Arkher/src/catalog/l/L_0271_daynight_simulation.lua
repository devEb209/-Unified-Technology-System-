-- ARKHER SYSTEM L.0271 :: Day Night Cycle Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0271"
	S.key = "arkher.sim.daynight.simulation_core"
	S.name = "Day Night Cycle Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "daynight", "simulation", "sim" }
	S.description = "Day Night Cycle Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Day Night Cycle subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.daynight.simulation_core", fullRadius = 160, reducedRadius = 700, budget = 57 })
		inst.system = S
		inst.ctx = ctx
