-- ARKHER SYSTEM VA.0080 :: LOD Cascade World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0080"
	S.key = "arkher.contworld.lodcascade.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lodcascade.neural_field" }
	S.tags = { "va", "lodcascade", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.lodcascade.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
