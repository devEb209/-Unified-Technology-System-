-- ARKHER SYSTEM VD.0322 :: Ecology Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0322"
	S.key = "arkher.contsim.ecologycont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.ecologycont.complexity_budget" }
	S.tags = { "vd", "ecologycont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.ecologycont.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
