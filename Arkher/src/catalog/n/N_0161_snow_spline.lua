-- ARKHER SYSTEM N.0161 :: Snow Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0161"
	S.key = "arkher.vfx.snow.curve_authoring"
	S.name = "Snow Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Snow"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.snow.ribbon_and_trail" }
	S.tags = { "n", "snow", "spline", "vfx" }
	S.description = "Snow Curve Authoring: authored curves driving the effect over its life for the Snow subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.snow.curve_authoring", tension = 0.36, closed = false })
		inst.system = S
		inst.ctx = ctx
