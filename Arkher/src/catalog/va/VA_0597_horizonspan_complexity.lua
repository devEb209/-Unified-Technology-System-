-- ARKHER SYSTEM VA.0597 :: Horizon Span Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0597"
	S.key = "arkher.contworld.horizonspan.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.horizonspan.world_memory_stream" }
	S.tags = { "va", "horizonspan", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.horizonspan.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
