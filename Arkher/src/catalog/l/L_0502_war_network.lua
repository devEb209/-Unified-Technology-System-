-- ARKHER SYSTEM L.0502 :: War Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0502"
	S.key = "arkher.sim.war.route_network"
	S.name = "War Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.war.region_graph" }
	S.tags = { "l", "war", "network", "sim" }
	S.description = "War Route Network: roads, rivers and routes between settlements for the War subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.war.route_network" })
		inst.system = S
		inst.ctx = ctx
