-- ARKHER SYSTEM VB.0490 :: Lighting Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0490"
	S.key = "arkher.conttime.lightcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lightcont.complexity_budget" }
	S.tags = { "vb", "lightcont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.lightcont.simulation_fabric", budgetMs = 2.5, starvationLimit = 6 })
		inst.system = S
		inst.ctx = ctx
