-- ARKHER SYSTEM K.0235 :: Personality Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0235"
	S.key = "arkher.npc.personality.social_relations"
	S.name = "Personality Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.personality.crowd_steering" }
	S.tags = { "k", "personality", "society", "npc" }
	S.description = "Personality Social Relations: affinity, factions, reputation and gossip for the Personality subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.personality.social_relations", decayRate = 0.008, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
