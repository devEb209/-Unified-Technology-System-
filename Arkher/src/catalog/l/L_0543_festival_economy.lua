-- ARKHER SYSTEM L.0543 :: Festival Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0543"
	S.key = "arkher.sim.festival.economy"
	S.name = "Festival Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.festival.ecology" }
	S.tags = { "l", "festival", "economy", "sim" }
	S.description = "Festival Economy: stock, production, demand, price discovery and trade for the Festival subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.festival.economy", elasticity = 0.20 })
		inst.system = S
		inst.ctx = ctx
