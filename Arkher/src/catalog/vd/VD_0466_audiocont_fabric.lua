-- ARKHER SYSTEM VD.0466 :: Audio Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VD.0466"
	S.key = "arkher.contsim.audiocont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.audiocont.complexity_budget" }
	S.tags = { "vd", "audiocont", "fabric", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contsim.audiocont.simulation_fabric", budgetMs = 3.0, starvationLimit = 7 })
		inst.system = S
		inst.ctx = ctx
