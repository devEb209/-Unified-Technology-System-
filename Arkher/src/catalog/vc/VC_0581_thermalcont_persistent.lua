-- ARKHER SYSTEM VC.0581 :: Thermal Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0581"
	S.key = "arkher.contneural.thermalcont.persistent_state"
	S.name = "Thermal Continuum Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.thermalcont.multi-scale_fidelity" }
	S.tags = { "vc", "thermalcont", "persistent", "contneural" }
	S.description = "Thermal Continuum Persistent State: epoch-stamped persistent history and rollback for the Thermal Continuum subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.thermalcont.persistent_state", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
