-- ARKHER SYSTEM T.0523 :: Audio Reasoning World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0523"
	S.key = "arkher.ai.audioreasoning.world_architect"
	S.name = "Audio Reasoning World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.audioreasoning.self_critique" }
	S.tags = { "t", "audioreasoning", "architect", "ai" }
	S.description = "Audio Reasoning World Architect: composition of a whole world plan with conserved budgets for the Audio Reasoning subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.audioreasoning.world_architect", budget = 800, seed = 34772 })
		inst.system = S
		inst.ctx = ctx
