-- ARKHER SYSTEM H.0086 :: Gravity Field Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0086"
	S.key = "arkher.physics.gravityfield.collision_shape"
	S.name = "Gravity Field Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.gravityfield.body_dynamics" }
	S.tags = { "h", "gravityfield", "collider", "physics" }
	S.description = "Gravity Field Collision Shape: shape bounds, support mapping and closest points for the Gravity Field subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.gravityfield.collision_shape", shape = "box", radius = 2.60, height = 2.20, layer = "character" })
		inst.system = S
		inst.ctx = ctx
