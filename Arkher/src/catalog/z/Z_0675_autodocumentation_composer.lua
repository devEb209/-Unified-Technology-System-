-- ARKHER SYSTEM Z.0675 :: Auto Documentation Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0675"
	S.key = "arkher.origin.autodocumentation.signal_composition"
	S.name = "Auto Documentation Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodocumentation.telemetry_ledger" }
	S.tags = { "z", "autodocumentation", "composer", "origin" }
	S.description = "Auto Documentation Signal Composition: blending of the technology's input signals into one output for the Auto Documentation subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.autodocumentation.signal_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
