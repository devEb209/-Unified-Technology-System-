-- ARKHER SYSTEM VD.0259 :: Road Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0259"
	S.key = "arkher.contsim.roadcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.roadcont.coherence_guard" }
	S.tags = { "vd", "roadcont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.roadcont.neural_field", dims = 16, hidden = 12, seed = 78429 })
		inst.system = S
		inst.ctx = ctx
