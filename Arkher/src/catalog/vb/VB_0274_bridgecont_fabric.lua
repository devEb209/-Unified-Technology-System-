-- ARKHER SYSTEM VB.0274 :: Bridge Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0274"
	S.key = "arkher.conttime.bridgecont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.bridgecont.complexity_budget" }
	S.tags = { "vb", "bridgecont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.bridgecont.simulation_fabric", budgetMs = 3.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
