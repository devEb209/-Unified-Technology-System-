-- ARKHER SYSTEM K.0310 :: Threat Assessment Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0310"
	S.key = "arkher.npc.threatassessment.memory"
	S.name = "Threat Assessment Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.threatassessment.mind_network" }
	S.tags = { "k", "threatassessment", "memory", "npc" }
	S.description = "Threat Assessment Memory: episodic memory with decay, recall and consolidation for the Threat Assessment subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.threatassessment.memory", capacity = 63, decayRate = 0.065, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
