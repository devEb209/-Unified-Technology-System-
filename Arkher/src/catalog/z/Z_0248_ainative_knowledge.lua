-- ARKHER SYSTEM Z.0248 :: AI Native Engine Architecture Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0248"
	S.key = "arkher.origin.ainative.semantic_graph"
	S.name = "AI Native Engine Architecture Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.ainative.world_architect" }
	S.tags = { "z", "ainative", "knowledge", "origin" }
	S.description = "AI Native Engine Architecture Semantic Graph: typed entities and inferred relations of the technology itself for the AI Native Engine Architecture subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.ainative.semantic_graph", dims = 16 })
		inst.system = S
		inst.ctx = ctx
