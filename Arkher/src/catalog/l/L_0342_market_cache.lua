-- ARKHER SYSTEM L.0342 :: Market Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0342"
	S.key = "arkher.sim.market.aggregate_cache"
	S.name = "Market Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.market.fidelity_policy" }
	S.tags = { "l", "market", "cache", "sim" }
	S.description = "Market Aggregate Cache: reuse of expensive aggregate computations for the Market subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.market.aggregate_cache", policy = "lru", capacity = 510, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
