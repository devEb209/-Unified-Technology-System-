-- ARKHER SYSTEM N.0119 :: Water Splash Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0119"
	S.key = "arkher.vfx.splash.particle_simulation"
	S.name = "Water Splash Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	S.area = "Water Splash"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.splash.emission" }
	S.tags = { "n", "splash", "particles", "vfx" }
	S.description = "Water Splash Particle Simulation: pooled integration of position, velocity, colour and life for the Water Splash subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.splash.particle_simulation", capacity = 128, drag = 0.17, bounce = 0.32, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
