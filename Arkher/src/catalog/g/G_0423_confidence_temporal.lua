-- ARKHER SYSTEM G.0423 :: Confidence Gating Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0423"
	S.key = "arkher.neural.confidence.temporal_history"
	S.name = "Confidence Gating Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.confidence.feature_extraction" }
	S.tags = { "g", "confidence", "temporal", "neural" }
	S.description = "Confidence Gating Temporal History: history buffers reused across frames for the Confidence Gating subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.confidence.temporal_history", feedback = 0.94, phase = 8 })
		inst.system = S
		inst.ctx = ctx
