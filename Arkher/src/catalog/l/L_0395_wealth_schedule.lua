-- ARKHER SYSTEM L.0395 :: Wealth Distribution Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0395"
	S.key = "arkher.sim.wealth.calendar"
	S.name = "Wealth Distribution Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wealth.society" }
	S.tags = { "l", "wealth", "schedule", "sim" }
	S.description = "Wealth Distribution Calendar: hours, days and seasons driving the region for the Wealth Distribution subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.wealth.calendar", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
