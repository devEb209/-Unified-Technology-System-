-- ARKHER SYSTEM E.0340 :: Rust Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0340"
	S.key = "arkher.material.rust.quality_policy"
	S.name = "Rust Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Rust"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.rust.compression_codec" }
	S.tags = { "e", "rust", "policy", "material" }
	S.description = "Rust Quality Policy: device tier rules for the surface for the Rust subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.rust.quality_policy", algorithm = "roundrobin", starvationGuard = 60 })
		inst.system = S
		inst.ctx = ctx
