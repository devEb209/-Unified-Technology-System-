-- ARKHER SYSTEM H.0669 :: Raycast Query Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0669"
	S.key = "arkher.physics.raycast.result_cache"
	S.name = "Raycast Query Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.raycast.simulation_policy" }
	S.tags = { "h", "raycast", "cache", "physics" }
	S.description = "Raycast Query Result Cache: reuse of expensive simulation and query results for the Raycast Query subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.raycast.result_cache", policy = "ttl", capacity = 377, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
