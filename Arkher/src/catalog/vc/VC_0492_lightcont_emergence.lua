-- ARKHER SYSTEM VC.0492 :: Lighting Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0492"
	S.key = "arkher.contneural.lightcont.emergence_continuum"
	S.name = "Lighting Continuum Emergence Continuum"
	S.category = "VC"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lightcont.reality_continuum" }
	S.tags = { "vc", "lightcont", "emergence", "contneural" }
	S.description = "Lighting Continuum Emergence Continuum: emergence detection over the continuum for the Lighting Continuum subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.lightcont.emergence_continuum", windowSize = 6, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
