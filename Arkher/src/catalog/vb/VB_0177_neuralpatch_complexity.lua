-- ARKHER SYSTEM VB.0177 :: Neural Patch Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0177"
	S.key = "arkher.conttime.neuralpatch.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.neuralpatch.world_memory_stream" }
	S.tags = { "vb", "neuralpatch", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.neuralpatch.complexity_budget", targetMs = 14.0 })
		inst.system = S
		inst.ctx = ctx
