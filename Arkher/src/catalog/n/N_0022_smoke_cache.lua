-- ARKHER SYSTEM N.0022 :: Smoke Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0022"
	S.key = "arkher.vfx.smoke.result_cache"
	S.name = "Smoke Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Smoke"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.smoke.spawn_budget" }
	S.tags = { "n", "smoke", "cache", "vfx" }
	S.description = "Smoke Result Cache: reuse of expensive effect evaluations for the Smoke subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.smoke.result_cache", policy = "ttl", capacity = 302, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
