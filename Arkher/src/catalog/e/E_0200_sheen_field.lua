-- ARKHER SYSTEM E.0200 :: Sheen Procedural Detail
...
return function(A)
	...
	local S = {}
	S.id = "E.0200"
	S.key = "arkher.material.sheen.procedural_detail"
	S.name = "Sheen Procedural Detail"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Sheen"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.material.sheen.texture_sampling" }
	S.tags = { "e", "sheen", "field", "material" }
	S.description = "Sheen Procedural Detail: coherent noise detail driving the surface for the Sheen subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.material.sheen.procedural_detail", seed = 22008, frequency = 0.0060, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
