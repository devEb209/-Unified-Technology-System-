-- ARKHER SYSTEM Z.0908 :: Deterministic Replay Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0908"
	S.key = "arkher.origin.deterministicreplay.semantic_graph"
	S.name = "Deterministic Replay Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deterministicreplay.world_architect" }
	S.tags = { "z", "deterministicreplay", "knowledge", "origin" }
	S.description = "Deterministic Replay Semantic Graph: typed entities and inferred relations of the technology itself for the Deterministic Replay subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.deterministicreplay.semantic_graph", dims = 32 })
		inst.system = S
		inst.ctx = ctx
