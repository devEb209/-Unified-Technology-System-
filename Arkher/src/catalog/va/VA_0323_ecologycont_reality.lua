-- ARKHER SYSTEM VA.0323 :: Ecology Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VA.0323"
	S.key = "arkher.contworld.ecologycont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.ecologycont.simulation_fabric" }
	S.tags = { "va", "ecologycont", "reality", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contworld.ecologycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
