-- ARKHER SYSTEM Z.0536 :: Migration Dynamics Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0536"
	S.key = "arkher.origin.migrationdynamics.governance_policy"
	S.name = "Migration Dynamics Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.migrationdynamics.signal_composition" }
	S.tags = { "z", "migrationdynamics", "policy", "origin" }
	S.description = "Migration Dynamics Governance Policy: ordered rules governing when the technology may act for the Migration Dynamics subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.migrationdynamics.governance_policy", algorithm = "edf", starvationGuard = 25 })
		inst.system = S
		inst.ctx = ctx
