-- ARKHER SYSTEM VD.0483 :: Lighting Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0483"
	S.key = "arkher.contsim.lightcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lightcont.epoch_clock" }
	S.tags = { "vd", "lightcont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.lightcont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
