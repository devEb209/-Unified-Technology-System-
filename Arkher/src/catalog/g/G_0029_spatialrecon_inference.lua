-- ARKHER SYSTEM G.0029 :: Spatial Reconstruction Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0029"
	S.key = "arkher.neural.spatialrecon.inference_core"
	S.name = "Spatial Reconstruction Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "spatialrecon", "inference", "neural" }
	S.description = "Spatial Reconstruction Inference Core: dense network forward pass and training for the Spatial Reconstruction subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.spatialrecon.inference_core", seed = 97872 })
		inst.system = S
		inst.ctx = ctx
