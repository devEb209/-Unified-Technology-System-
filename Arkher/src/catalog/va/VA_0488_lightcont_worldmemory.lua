-- ARKHER SYSTEM VA.0488 :: Lighting Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0488"
	S.key = "arkher.contworld.lightcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.lightcont.neural_field" }
	S.tags = { "va", "lightcont", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.lightcont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
