-- ARKHER SYSTEM K.0307 :: Attention Thinking Budget
...
return function(A)
	...
	local S = {}
	S.id = "K.0307"
	S.key = "arkher.npc.attention.thinking_budget"
	S.name = "Attention Thinking Budget"
	S.category = "K"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.attention.daily_schedule" }
	S.tags = { "k", "attention", "budgeter", "npc" }
	S.description = "Attention Thinking Budget: allocation of per-frame thinking time across NPCs for the Attention subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.npc.attention.thinking_budget", total = 127, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
