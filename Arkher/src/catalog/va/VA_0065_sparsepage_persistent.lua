-- ARKHER SYSTEM VA.0065 :: Sparse Page Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0065"
	S.key = "arkher.contworld.sparsepage.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.sparsepage.multi-scale_fidelity" }
	S.tags = { "va", "sparsepage", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.sparsepage.persistent_state", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
