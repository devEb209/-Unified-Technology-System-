-- ARKHER SYSTEM VC.0092 :: Residency Window World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0092"
	S.key = "arkher.contneural.residencywindow.world_memory_stream"
	S.name = "Residency Window World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.residencywindow.neural_field" }
	S.tags = { "vc", "residencywindow", "worldmemory", "contneural" }
	S.description = "Residency Window World Memory Stream: world memory continuum over epochs for the Residency Window subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.residencywindow.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
