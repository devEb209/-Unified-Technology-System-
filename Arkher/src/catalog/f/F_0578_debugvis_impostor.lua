-- ARKHER SYSTEM F.0578 :: Debug Visualization Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0578"
	S.key = "arkher.render.debugvis.geometry_virtualization"
	S.name = "Debug Visualization Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.debugvis.visibility_set" }
	S.tags = { "f", "debugvis", "impostor", "render" }
	S.description = "Debug Visualization Geometry Virtualization: impostor and HLOD synthesis under a budget for the Debug Visualization subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.debugvis.geometry_virtualization", atlasSlots = 32, viewCount = 8, errorThreshold = 1.00 })
		inst.system = S
		inst.ctx = ctx
