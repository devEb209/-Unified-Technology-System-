-- ARKHER SYSTEM W.0154 :: Point Of View Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0154"
	S.key = "arkher.cine.pointofview.frame_budget"
	S.name = "Point Of View Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.pointofview.event_ledger" }
	S.tags = { "w", "pointofview", "budgeter", "cine" }
	S.description = "Point Of View Frame Budget: per-frame cost budget for the cinematic systems for the Point Of View subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.pointofview.frame_budget", total = 236, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
