-- ARKHER SYSTEM Q.0183 :: Health Bar Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0183"
	S.key = "arkher.ui.healthbar.input_mapping"
	S.name = "Health Bar Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Health Bar"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.healthbar.widget_tree" }
	S.tags = { "q", "healthbar", "inputmap", "ui" }
	S.description = "Health Bar Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Health Bar subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.healthbar.input_mapping", device = "gamepad", holdTime = 0.36, deadzone = 0.11 })
		inst.system = S
		inst.ctx = ctx
