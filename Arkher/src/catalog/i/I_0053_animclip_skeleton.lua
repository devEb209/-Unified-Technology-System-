-- ARKHER SYSTEM I.0053 :: Animation Clip Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0053"
	S.key = "arkher.anim.animclip.skeleton"
	S.name = "Animation Clip Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "animclip", "skeleton", "anim" }
	S.description = "Animation Clip Skeleton: bone hierarchy, bind pose and world resolution for the Animation Clip subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.animclip.skeleton" })
		inst.system = S
		inst.ctx = ctx
