-- ARKHER SYSTEM Z.0310 :: Causality Ledger Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0310"
	S.key = "arkher.origin.causality.self_critique"
	S.name = "Causality Ledger Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.causality.intent_bridge" }
	S.tags = { "z", "causality", "critic", "origin" }
	S.description = "Causality Ledger Self Critique: weighted judgement of the technology's own output for the Causality Ledger subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.causality.self_critique", passMark = 0.79, reviseMark = 0.44, seed = 52134 })
		inst.system = S
		inst.ctx = ctx
