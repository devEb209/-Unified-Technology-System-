-- ARKHER SYSTEM VD.0616 :: Occupancy Map Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0616"
	S.key = "arkher.contsim.occupancymap.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.occupancymap.sparse_residency" }
	S.tags = { "vd", "occupancymap", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.occupancymap.multi-scale_fidelity", levels = 5, baseTriangles = 135000 })
		inst.system = S
		inst.ctx = ctx
