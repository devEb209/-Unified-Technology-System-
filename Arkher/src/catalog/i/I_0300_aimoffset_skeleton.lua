-- ARKHER SYSTEM I.0300 :: Aim Offset Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0300"
	S.key = "arkher.anim.aimoffset.skeleton"
	S.name = "Aim Offset Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Aim Offset"
	S.aspect = "Skeleton"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "aimoffset", "skeleton", "anim" }
	S.description = "Aim Offset Skeleton: bone hierarchy, bind pose and world resolution for the Aim Offset subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.aimoffset.skeleton" })
		inst.system = S
		inst.ctx = ctx
