-- ARKHER SYSTEM K.0264 :: Vision Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0264"
	S.key = "arkher.npc.vision.daily_schedule"
	S.name = "Vision Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.vision.social_relations" }
	S.tags = { "k", "vision", "schedule", "npc" }
	S.description = "Vision Daily Schedule: hour-by-hour routine with priority interruptions for the Vision subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.vision.daily_schedule", startHour = 8 })
		inst.system = S
		inst.ctx = ctx
