-- ARKHER SYSTEM VA.0398 :: Perception Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0398"
	S.key = "arkher.contworld.perceptioncont.epoch_clock"
	S.name = "Perception Continuum Epoch Clock"
	S.category = "VA"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.perceptioncont.infinite_grid" }
	S.tags = { "va", "perceptioncont", "epoch", "contworld" }
	S.description = "Perception Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Perception Continuum subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.perceptioncont.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
