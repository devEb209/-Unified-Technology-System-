-- ARKHER SYSTEM R.0139 :: Unreliable Channel Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0139"
	S.key = "arkher.net.unreliablechannel.interest_streaming"
	S.name = "Unreliable Channel Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.unreliablechannel.serialization_codec" }
	S.tags = { "r", "unreliablechannel", "streamer", "net" }
	S.description = "Unreliable Channel Interest Streaming: distance-driven residency of replicated content for the Unreliable Channel subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.unreliablechannel.interest_streaming", radius = 240, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
