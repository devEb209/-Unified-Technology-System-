-- ARKHER SYSTEM Z.0783 :: Attention Driven Detail Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0783"
	S.key = "arkher.origin.attentiondetail.simulation_fabric"
	S.name = "Attention Driven Detail Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.complexity_governance" }
	S.tags = { "z", "attentiondetail", "fabric", "origin" }
	S.description = "Attention Driven Detail Simulation Fabric: every simulation domain stepped under one budgeted clock for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.attentiondetail.simulation_fabric", budgetMs = 1.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
