-- ARKHER SYSTEM J.0133 :: Blinking Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0133"
	S.key = "arkher.character.blinking.rig_definition"
	S.name = "Blinking Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "blinking", "skeleton", "character" }
	S.description = "Blinking Rig Definition: character rig definition and bone budget for the Blinking subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.blinking.rig_definition" })
		inst.system = S
		inst.ctx = ctx
