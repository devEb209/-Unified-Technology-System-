-- ARKHER SYSTEM VD.0507 :: Material Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VD.0507"
	S.key = "arkher.contsim.materialcont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.materialcont.epoch_clock" }
	S.tags = { "vd", "materialcont", "sparse", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contsim.materialcont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
