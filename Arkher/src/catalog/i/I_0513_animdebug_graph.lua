-- ARKHER SYSTEM I.0513 :: Animation Debug Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0513"
	S.key = "arkher.anim.animdebug.retarget_graph"
	S.name = "Animation Debug Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animdebug.physical_blend" }
	S.tags = { "i", "animdebug", "graph", "anim" }
	S.description = "Animation Debug Retarget Graph: bone mapping and retarget path resolution for the Animation Debug subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.animdebug.retarget_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
