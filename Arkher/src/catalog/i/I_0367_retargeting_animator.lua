-- ARKHER SYSTEM I.0367 :: Retargeting Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0367"
	S.key = "arkher.anim.retargeting.layered_blending"
	S.name = "Retargeting Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Retargeting"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.retargeting.clip_sampling" }
	S.tags = { "i", "retargeting", "animator", "anim" }
	S.description = "Retargeting Layered Blending: layers, crossfades, masks and blend trees for the Retargeting subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.retargeting.layered_blending", budget = 14 })
		inst.system = S
		inst.ctx = ctx
