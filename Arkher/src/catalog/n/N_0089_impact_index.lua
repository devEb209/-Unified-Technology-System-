-- ARKHER SYSTEM N.0089 :: Impact Spatial Index
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0089"
	S.key = "arkher.vfx.impact.spatial_index"
	S.name = "Impact Spatial Index"
	S.category = "N"
	S.family = "VFX"
	S.area = "Impact"
	...
	S.kit = "index"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.impact.quality_policy" }
	S.tags = { "n", "impact", "index", "vfx" }
	S.description = "Impact Spatial Index: spatial acceleration of effect queries and culling for the Impact subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("index", { id = "arkher.vfx.impact.spatial_index", mode = "hash", cellSize = 96 })
		inst.system = S
		inst.ctx = ctx
