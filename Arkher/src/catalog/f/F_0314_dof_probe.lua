-- ARKHER SYSTEM F.0314 :: Depth Of Field Probe Volume
...
return function(A)
	...
	local S = {}
	S.id = "F.0314"
	S.key = "arkher.render.dof.probe_volume"
	S.name = "Depth Of Field Probe Volume"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "probe"
	S.version = "1.0.0"
	S.deps = { "arkher.render.dof.lighting_rig" }
	S.tags = { "f", "dof", "probe", "render" }
	S.description = "Depth Of Field Probe Volume: irradiance probes encoded in spherical harmonics for the Depth Of Field subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("probe", { id = "arkher.render.dof.probe_volume", spacing = 24 })
		inst.system = S
		inst.ctx = ctx
