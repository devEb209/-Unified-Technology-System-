-- ARKHER SYSTEM L.0552 :: Festival Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0552"
	S.key = "arkher.sim.festival.aggregate_cache"
	S.name = "Festival Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.festival.fidelity_policy" }
	S.tags = { "l", "festival", "cache", "sim" }
	S.description = "Festival Aggregate Cache: reuse of expensive aggregate computations for the Festival subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.festival.aggregate_cache", policy = "lru", capacity = 144, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
