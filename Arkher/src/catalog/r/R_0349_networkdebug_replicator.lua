-- ARKHER SYSTEM R.0349 :: Network Debug Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0349"
	S.key = "arkher.net.networkdebug.replication"
	S.name = "Network Debug Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "networkdebug", "replicator", "net" }
	S.description = "Network Debug Replication: authoritative entity state, interest and delta snapshots for the Network Debug subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.networkdebug.replication", mtu = 600, interestRadius = 360, fullEvery = 30 })
		inst.system = S
		inst.ctx = ctx
