-- ARKHER SYSTEM V.0208 :: Level Asset Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0208"
	S.key = "arkher.asset.levelasset.asset_registry"
	S.name = "Level Asset Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.levelasset.cook_pipeline" }
	S.tags = { "v", "levelasset", "registry", "asset" }
	S.description = "Level Asset Asset Registry: catalogue of every asset, its tags and its metadata for the Level Asset subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.levelasset.asset_registry" })
		inst.system = S
		inst.ctx = ctx
