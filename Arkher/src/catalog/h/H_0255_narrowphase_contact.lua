-- ARKHER SYSTEM H.0255 :: Narrowphase Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0255"
	S.key = "arkher.physics.narrowphase.contact_generation"
	S.name = "Narrowphase Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Narrowphase"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.narrowphase.collision_shape" }
	S.tags = { "h", "narrowphase", "contact", "physics" }
	S.description = "Narrowphase Contact Generation: narrow-phase manifolds with normal, depth and point for the Narrowphase subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 200,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.narrowphase.contact_generation", slop = 0.0050, maxManifolds = 309 })
		inst.system = S
		inst.ctx = ctx
