-- ARKHER SYSTEM VC.0161 :: Coherence Seam Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0161"
	S.key = "arkher.contneural.coherenceseam.persistent_state"
	S.name = "Coherence Seam Persistent State"
	S.category = "VC"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.coherenceseam.multi-scale_fidelity" }
	S.tags = { "vc", "coherenceseam", "persistent", "contneural" }
	S.description = "Coherence Seam Persistent State: epoch-stamped persistent history and rollback for the Coherence Seam subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.coherenceseam.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
