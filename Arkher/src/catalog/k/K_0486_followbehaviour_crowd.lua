-- ARKHER SYSTEM K.0486 :: Follow Behaviour Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0486"
	S.key = "arkher.npc.followbehaviour.crowd_steering"
	S.name = "Follow Behaviour Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.followbehaviour.navigation" }
	S.tags = { "k", "followbehaviour", "crowd", "npc" }
	S.description = "Follow Behaviour Crowd Steering: local avoidance, cohesion and arrival at scale for the Follow Behaviour subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.followbehaviour.crowd_steering", radius = 0.70, maxSpeed = 3.60, cellSize = 6 })
		inst.system = S
		inst.ctx = ctx
