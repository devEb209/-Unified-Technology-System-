-- ARKHER SYSTEM O.0040 :: Impact Sound Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0040"
	S.key = "arkher.audio.impactsound.music_sequencer"
	S.name = "Impact Sound Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Impact Sound"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.impactsound.spatialization" }
	S.tags = { "o", "impactsound", "sequencer", "audio" }
	S.description = "Impact Sound Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Impact Sound subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.impactsound.music_sequencer", bpm = 120, beatsPerBar = 4, intensity = 0.41 })
		inst.system = S
		inst.ctx = ctx
