-- ARKHER SYSTEM J.0273 :: Wetness Response Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "J.0273"
	S.key = "arkher.character.wetnessresponse.budget_governor"
	S.name = "Wetness Response Budget Governor"
	S.category = "J"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.character.wetnessresponse.variant_registry" }
	S.tags = { "j", "wetnessresponse", "budgeter", "character" }
	S.description = "Wetness Response Budget Governor: per-character cost allocation in a crowd for the Wetness Response subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.character.wetnessresponse.budget_governor", total = 168, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
