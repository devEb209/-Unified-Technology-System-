-- ARKHER SYSTEM VD.0369 :: Quest Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0369"
	S.key = "arkher.contsim.questcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.questcont.world_memory_stream" }
	S.tags = { "vd", "questcont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.questcont.complexity_budget", targetMs = 12.0 })
		inst.system = S
		inst.ctx = ctx
