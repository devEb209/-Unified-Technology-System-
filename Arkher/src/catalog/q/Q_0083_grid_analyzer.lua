-- ARKHER SYSTEM Q.0083 :: Grid Usability Analysis
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0083"
	S.key = "arkher.ui.grid.usability_analysis"
	S.name = "Grid Usability Analysis"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Grid"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.grid.frame_budget" }
	S.tags = { "q", "grid", "analyzer", "ui" }
	S.description = "Grid Usability Analysis: reachability, latency and abandonment analysis for the Grid subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.ui.grid.usability_analysis", window = 232, buckets = 12, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
