-- ARKHER SYSTEM L.0472 :: Faction Politics Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0472"
	S.key = "arkher.sim.factionpolitics.route_network"
	S.name = "Faction Politics Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.factionpolitics.region_graph" }
	S.tags = { "l", "factionpolitics", "network", "sim" }
	S.description = "Faction Politics Route Network: roads, rivers and routes between settlements for the Faction Politics subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.factionpolitics.route_network" })
		inst.system = S
		inst.ctx = ctx
