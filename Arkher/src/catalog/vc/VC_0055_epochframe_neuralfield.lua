-- ARKHER SYSTEM VC.0055 :: Epoch Frame Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0055"
	S.key = "arkher.contneural.epochframe.neural_field"
	S.name = "Epoch Frame Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.epochframe.coherence_guard" }
	S.tags = { "vc", "epochframe", "neuralfield", "contneural" }
	S.description = "Epoch Frame Neural Field: neural field encoding and reconstruction for the Epoch Frame subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.epochframe.neural_field", dims = 24, hidden = 20, seed = 90023 })
		inst.system = S
		inst.ctx = ctx
