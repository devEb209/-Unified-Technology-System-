-- ARKHER SYSTEM V.0128 :: Font Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0128"
	S.key = "arkher.asset.font.compression_codec"
	S.name = "Font Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.font.streaming_residency" }
	S.tags = { "v", "font", "codec", "asset" }
	S.description = "Font Compression Codec: compact encoding, diffing and checksum of asset payloads for the Font subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.font.compression_codec", format = "rle", quantBits = 14 })
		inst.system = S
		inst.ctx = ctx
