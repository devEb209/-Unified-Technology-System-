-- ARKHER SYSTEM VC.0270 :: Bridge Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0270"
	S.key = "arkher.contneural.bridgecont.coherence_guard"
	S.name = "Bridge Continuum Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.bridgecont.persistent_state" }
	S.tags = { "vc", "bridgecont", "coherence", "contneural" }
	S.description = "Bridge Continuum Coherence Guard: seam coherence and drift supervision for the Bridge Continuum subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.bridgecont.coherence_guard", window = 141, threshold = 0.11 })
		inst.system = S
		inst.ctx = ctx
