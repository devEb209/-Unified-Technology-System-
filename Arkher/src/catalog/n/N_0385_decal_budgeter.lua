-- ARKHER SYSTEM N.0385 :: Decal Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0385"
	S.key = "arkher.vfx.decal.spawn_budget"
	S.name = "Decal Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Decal"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.decal.effect_composition" }
	S.tags = { "n", "decal", "budgeter", "vfx" }
	S.description = "Decal Spawn Budget: global particle budget shared by every live effect for the Decal subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.decal.spawn_budget", total = 400, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
