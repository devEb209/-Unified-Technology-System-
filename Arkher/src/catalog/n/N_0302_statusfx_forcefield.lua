-- ARKHER SYSTEM N.0302 :: Status Effect Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0302"
	S.key = "arkher.vfx.statusfx.force_field"
	S.name = "Status Effect Force Field"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.statusfx.particle_simulation" }
	S.tags = { "n", "statusfx", "forcefield", "vfx" }
	S.description = "Status Effect Force Field: wind, attraction, vortex, drag and curl turbulence for the Status Effect subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.statusfx.force_field", seed = 27277 })
		inst.system = S
		inst.ctx = ctx
