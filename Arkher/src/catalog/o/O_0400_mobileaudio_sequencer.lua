-- ARKHER SYSTEM O.0400 :: Mobile Audio Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0400"
	S.key = "arkher.audio.mobileaudio.music_sequencer"
	S.name = "Mobile Audio Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Mobile Audio"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.mobileaudio.spatialization" }
	S.tags = { "o", "mobileaudio", "sequencer", "audio" }
	S.description = "Mobile Audio Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Mobile Audio subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.mobileaudio.music_sequencer", bpm = 100, beatsPerBar = 4, intensity = 0.63 })
		inst.system = S
		inst.ctx = ctx
