-- ARKHER SYSTEM P.0092 :: Level Up Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0092"
	S.key = "arkher.play.levelup.balance_analysis"
	S.name = "Level Up Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Level Up"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.levelup.event_ledger" }
	S.tags = { "p", "levelup", "analyzer", "play" }
	S.description = "Level Up Balance Analysis: distribution, outlier and pacing analysis for the Level Up subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.levelup.balance_analysis", window = 196, buckets = 12, threshold = 4.80 })
		inst.system = S
		inst.ctx = ctx
