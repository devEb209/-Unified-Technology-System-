-- ARKHER SYSTEM K.0418 :: Interruption Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0418"
	S.key = "arkher.npc.interruption.daily_schedule"
	S.name = "Interruption Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.interruption.social_relations" }
	S.tags = { "k", "interruption", "schedule", "npc" }
	S.description = "Interruption Daily Schedule: hour-by-hour routine with priority interruptions for the Interruption subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.interruption.daily_schedule", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
