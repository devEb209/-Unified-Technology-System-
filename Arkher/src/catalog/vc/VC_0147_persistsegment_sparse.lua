-- ARKHER SYSTEM VC.0147 :: Persistence Segment Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0147"
	S.key = "arkher.contneural.persistsegment.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.persistsegment.epoch_clock" }
	S.tags = { "vc", "persistsegment", "sparse", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.persistsegment.sparse_residency", capacity = 896, pageBytes = 8192 })
		inst.system = S
		inst.ctx = ctx
