-- ARKHER SYSTEM Z.0875 :: Multi Scale Simulation Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.0875"
	S.key = "arkher.origin.multiscale.signal_composition"
	S.name = "Multi Scale Simulation Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.multiscale.telemetry_ledger" }
	S.tags = { "z", "multiscale", "composer", "origin" }
	S.description = "Multi Scale Simulation Signal Composition: blending of the technology's input signals into one output for the Multi Scale Simulation subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.multiscale.signal_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
