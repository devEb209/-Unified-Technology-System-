-- ARKHER SYSTEM Z.0108 :: Universal Simulation Fabric Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0108"
	S.key = "arkher.origin.simfabric.semantic_graph"
	S.name = "Universal Simulation Fabric Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.simfabric.world_architect" }
	S.tags = { "z", "simfabric", "knowledge", "origin" }
	S.description = "Universal Simulation Fabric Semantic Graph: typed entities and inferred relations of the technology itself for the Universal Simulation Fabric subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.simfabric.semantic_graph", dims = 32 })
		inst.system = S
		inst.ctx = ctx
