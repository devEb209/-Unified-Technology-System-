-- ARKHER SYSTEM P.0315 :: Damage Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0315"
	S.key = "arkher.play.damage.objectives"
	S.name = "Damage Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Damage"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.damage.inventory" }
	S.tags = { "p", "damage", "quest", "play" }
	S.description = "Damage Objectives: objectives, prerequisites, progress and rewards for the Damage subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.damage.objectives" })
		inst.system = S
		inst.ctx = ctx
