-- ARKHER SYSTEM Z.0190 :: World Memory Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0190"
	S.key = "arkher.origin.worldmemorytech.self_critique"
	S.name = "World Memory Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldmemorytech.intent_bridge" }
	S.tags = { "z", "worldmemorytech", "critic", "origin" }
	S.description = "World Memory Self Critique: weighted judgement of the technology's own output for the World Memory subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.worldmemorytech.self_critique", passMark = 0.75, reviseMark = 0.40, seed = 23120 })
		inst.system = S
		inst.ctx = ctx
