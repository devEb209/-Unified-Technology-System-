-- ARKHER SYSTEM F.0652 :: Mobile Fast Path Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0652"
	S.key = "arkher.render.mobilepath.adaptive_resolution"
	S.name = "Mobile Fast Path Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.mobilepath.temporal_resolve" }
	S.tags = { "f", "mobilepath", "upscaler", "render" }
	S.description = "Mobile Fast Path Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Mobile Fast Path subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.mobilepath.adaptive_resolution", targetMs = 12.10, index = 4, sharpness = 0.43 })
		inst.system = S
		inst.ctx = ctx
