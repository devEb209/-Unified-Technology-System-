-- ARKHER SYSTEM F.0394 :: Draw Call Batching View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0394"
	S.key = "arkher.render.batching.view_and_culling"
	S.name = "Draw Call Batching View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.batching.frame_graph" }
	S.tags = { "f", "batching", "camera", "render" }
	S.description = "Draw Call Batching View And Culling: view state, frustum culling and screen-size LOD for the Draw Call Batching subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.batching.view_and_culling", width = 956, height = 1080, fov = 0.9600, far = 1200 })
		inst.system = S
		inst.ctx = ctx
