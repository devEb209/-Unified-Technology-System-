-- ARKHER SYSTEM T.0176 :: Asset Generation Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0176"
	S.key = "arkher.ai.assetgeneration.outcome_prediction"
	S.name = "Asset Generation Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.assetgeneration.decision_policy" }
	S.tags = { "t", "assetgeneration", "predictor", "ai" }
	S.description = "Asset Generation Outcome Prediction: forecasting the result before the work is done for the Asset Generation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.assetgeneration.outcome_prediction", method = "ema", alpha = 0.21, window = 83 })
		inst.system = S
		inst.ctx = ctx
