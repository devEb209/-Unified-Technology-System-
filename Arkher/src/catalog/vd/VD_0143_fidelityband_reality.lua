-- ARKHER SYSTEM VD.0143 :: Fidelity Band Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0143"
	S.key = "arkher.contsim.fidelityband.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.fidelityband.simulation_fabric" }
	S.tags = { "vd", "fidelityband", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.fidelityband.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
