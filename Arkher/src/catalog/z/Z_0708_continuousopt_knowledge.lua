-- ARKHER SYSTEM Z.0708 :: Continuous Self Optimization Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0708"
	S.key = "arkher.origin.continuousopt.semantic_graph"
	S.name = "Continuous Self Optimization Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.world_architect" }
	S.tags = { "z", "continuousopt", "knowledge", "origin" }
	S.description = "Continuous Self Optimization Semantic Graph: typed entities and inferred relations of the technology itself for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.continuousopt.semantic_graph", dims = 16 })
		inst.system = S
		inst.ctx = ctx
