-- ARKHER SYSTEM VA.0295 :: Climate Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0295"
	S.key = "arkher.contworld.climatecont.neural_field"
	S.name = "Climate Continuum Neural Field"
	S.category = "VA"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.climatecont.coherence_guard" }
	S.tags = { "va", "climatecont", "neuralfield", "contworld" }
	S.description = "Climate Continuum Neural Field: neural field encoding and reconstruction for the Climate Continuum subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.climatecont.neural_field", dims = 20, hidden = 16, seed = 41074 })
		inst.system = S
		inst.ctx = ctx
