-- ARKHER SYSTEM V.0094 :: Audio Clip Validation Guard
...
return function(A)
	...
	local S = {}
	S.id = "V.0094"
	S.key = "arkher.asset.audioclip.validation_guard"
	S.name = "Audio Clip Validation Guard"
	S.category = "V"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.audioclip.size_budget" }
	S.tags = { "v", "audioclip", "guard", "asset" }
	S.description = "Audio Clip Validation Guard: rate limiting and capability checks on the import path for the Audio Clip subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.asset.audioclip.validation_guard", algorithm = "token", capacity = 121, refillPerSec = 26, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
