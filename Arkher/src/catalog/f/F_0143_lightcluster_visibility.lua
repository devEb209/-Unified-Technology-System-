-- ARKHER SYSTEM F.0143 :: Light Clustering Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0143"
	S.key = "arkher.render.lightcluster.visibility_set"
	S.name = "Light Clustering Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.lightcluster.view_and_culling" }
	S.tags = { "f", "lightcluster", "visibility", "render" }
	S.description = "Light Clustering Visibility Set: cell, portal and occluder visibility for the Light Clustering subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.lightcluster.visibility_set", maxDepth = 4 })
		inst.system = S
		inst.ctx = ctx
