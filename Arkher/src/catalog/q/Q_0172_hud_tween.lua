-- ARKHER SYSTEM Q.0172 :: Head Up Display Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0172"
	S.key = "arkher.ui.hud.transition"
	S.name = "Head Up Display Transition"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.hud.input_mapping" }
	S.tags = { "q", "hud", "tween", "ui" }
	S.description = "Head Up Display Transition: eased, delayed, looped and sequenced motion for the Head Up Display subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.hud.transition", timeScale = 1.01 })
		inst.system = S
		inst.ctx = ctx
