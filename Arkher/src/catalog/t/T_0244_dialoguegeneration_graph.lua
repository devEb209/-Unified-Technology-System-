-- ARKHER SYSTEM T.0244 :: Dialogue Generation Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0244"
	S.key = "arkher.ai.dialoguegeneration.reasoning_graph"
	S.name = "Dialogue Generation Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.dialoguegeneration.world_architect" }
	S.tags = { "t", "dialoguegeneration", "graph", "ai" }
	S.description = "Dialogue Generation Reasoning Graph: relationship modelling and shortest-path reasoning for the Dialogue Generation subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.dialoguegeneration.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
