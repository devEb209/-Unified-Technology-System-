-- ARKHER SYSTEM K.0491 :: Patrol Route Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0491"
	S.key = "arkher.npc.patrolroute.mind_network"
	S.name = "Patrol Route Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "patrolroute", "mindnet", "npc" }
	S.description = "Patrol Route Mind Network: the learned policy that turns perception into a decision for the Patrol Route subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.patrolroute.mind_network", inputs = 6, hidden = 4, seed = 7100, learningRate = 0.050, exploration = 0.040 })
		inst.system = S
		inst.ctx = ctx
