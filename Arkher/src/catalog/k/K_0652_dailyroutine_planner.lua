-- ARKHER SYSTEM K.0652 :: Daily Routine Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0652"
	S.key = "arkher.npc.dailyroutine.goal_planner"
	S.name = "Daily Routine Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dailyroutine.utility_reasoning" }
	S.tags = { "k", "dailyroutine", "planner", "npc" }
	S.description = "Daily Routine Goal Planner: backward GOAP planning to reach a goal state for the Daily Routine subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.dailyroutine.goal_planner", maxDepth = 8 })
		inst.system = S
		inst.ctx = ctx
