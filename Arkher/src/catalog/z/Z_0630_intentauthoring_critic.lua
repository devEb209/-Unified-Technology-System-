-- ARKHER SYSTEM Z.0630 :: Intent Driven Authoring Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0630"
	S.key = "arkher.origin.intentauthoring.self_critique"
	S.name = "Intent Driven Authoring Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.intentauthoring.intent_bridge" }
	S.tags = { "z", "intentauthoring", "critic", "origin" }
	S.description = "Intent Driven Authoring Self Critique: weighted judgement of the technology's own output for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.intentauthoring.self_critique", passMark = 0.81, reviseMark = 0.41, seed = 20381 })
		inst.system = S
		inst.ctx = ctx
