-- ARKHER SYSTEM T.0134 :: Skill Library Outcome Prediction
...
return function(A)
	...
	local S = {}
	S.id = "T.0134"
	S.key = "arkher.ai.skilllibrary.outcome_prediction"
	S.name = "Skill Library Outcome Prediction"
	S.category = "T"
	...
	S.kit = "predictor"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.skilllibrary.decision_policy" }
	S.tags = { "t", "skilllibrary", "predictor", "ai" }
	S.description = "Skill Library Outcome Prediction: forecasting the result before the work is done for the Skill Library subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("predictor", { id = "arkher.ai.skilllibrary.outcome_prediction", method = "ema", alpha = 0.24, window = 62 })
		inst.system = S
		inst.ctx = ctx
