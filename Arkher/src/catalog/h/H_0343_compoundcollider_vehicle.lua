-- ARKHER SYSTEM H.0343 :: Compound Collider Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0343"
	S.key = "arkher.physics.compoundcollider.vehicle"
	S.name = "Compound Collider Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.compoundcollider.character_motion" }
	S.tags = { "h", "compoundcollider", "vehicle", "physics" }
	S.description = "Compound Collider Vehicle: suspension, drivetrain, steering and tire friction for the Compound Collider subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.compoundcollider.vehicle", mass = 2100, wheelbase = 2.40, track = 1.60, maxRpm = 5800 })
		inst.system = S
		inst.ctx = ctx
