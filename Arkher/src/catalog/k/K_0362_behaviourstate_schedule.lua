-- ARKHER SYSTEM K.0362 :: Behaviour State Machine Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0362"
	S.key = "arkher.npc.behaviourstate.daily_schedule"
	S.name = "Behaviour State Machine Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourstate.social_relations" }
	S.tags = { "k", "behaviourstate", "schedule", "npc" }
	S.description = "Behaviour State Machine Daily Schedule: hour-by-hour routine with priority interruptions for the Behaviour State Machine subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.behaviourstate.daily_schedule", startHour = 10 })
		inst.system = S
		inst.ctx = ctx
