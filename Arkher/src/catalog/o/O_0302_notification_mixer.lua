-- ARKHER SYSTEM O.0302 :: Notification Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0302"
	S.key = "arkher.audio.notification.mixer_bus"
	S.name = "Notification Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Notification"
	S.aspect = "Mixer Bus"
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.notification.dsp_chain" }
	S.tags = { "o", "notification", "mixer", "audio" }
	S.description = "Notification Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Notification subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.notification.mixer_bus", maxVoices = 16 })
		inst.system = S
		inst.ctx = ctx
