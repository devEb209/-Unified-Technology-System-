-- ARKHER SYSTEM VA.0303 :: Weather Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0303"
	S.key = "arkher.contworld.weathercont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.weathercont.epoch_clock" }
	S.tags = { "va", "weathercont", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.weathercont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
