-- ARKHER SYSTEM F.0502 :: HLOD Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0502"
	S.key = "arkher.render.hlod.frame_analysis"
	S.name = "HLOD Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "HLOD"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.hlod.pass_cache" }
	S.tags = { "f", "hlod", "analyzer", "render" }
	S.description = "HLOD Frame Analysis: per-pass cost analysis and outlier detection for the HLOD subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.hlod.frame_analysis", window = 223, buckets = 15, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
