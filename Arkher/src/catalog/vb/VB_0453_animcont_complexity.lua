-- ARKHER SYSTEM VB.0453 :: Animation Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0453"
	S.key = "arkher.conttime.animcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.animcont.world_memory_stream" }
	S.tags = { "vb", "animcont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.animcont.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
