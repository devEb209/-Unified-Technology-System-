-- ARKHER SYSTEM N.0250 :: Portal Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0250"
	S.key = "arkher.vfx.portal.force_field"
	S.name = "Portal Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Portal"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.portal.particle_simulation" }
	S.tags = { "n", "portal", "forcefield", "vfx" }
	S.description = "Portal Force Field: wind, attraction, vortex, drag and curl turbulence for the Portal subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.portal.force_field", seed = 19976 })
		inst.system = S
		inst.ctx = ctx
