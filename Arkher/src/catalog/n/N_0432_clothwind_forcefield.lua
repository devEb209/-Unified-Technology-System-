-- ARKHER SYSTEM N.0432 :: Cloth Wind Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0432"
	S.key = "arkher.vfx.clothwind.force_field"
	S.name = "Cloth Wind Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Cloth Wind"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.clothwind.particle_simulation" }
	S.tags = { "n", "clothwind", "forcefield", "vfx" }
	S.description = "Cloth Wind Force Field: wind, attraction, vortex, drag and curl turbulence for the Cloth Wind subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.clothwind.force_field", seed = 79853 })
		inst.system = S
		inst.ctx = ctx
