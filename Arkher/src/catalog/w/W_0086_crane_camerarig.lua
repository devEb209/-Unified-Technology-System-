-- ARKHER SYSTEM W.0086 :: Crane Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0086"
	S.key = "arkher.cine.crane.camera_rig"
	S.name = "Crane Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Crane"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.crane.sequence_timeline" }
	S.tags = { "w", "crane", "camerarig", "cine" }
	S.description = "Crane Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Crane subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.crane.camera_rig", fov = 1.10, focus = 18.0, aperture = 5.4, smoothing = 10.0, distance = 20, height = 4 })
		inst.system = S
		inst.ctx = ctx
