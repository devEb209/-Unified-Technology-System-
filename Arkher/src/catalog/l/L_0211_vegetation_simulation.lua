-- ARKHER SYSTEM L.0211 :: Vegetation Simulation Core
...
return function(A)
	...
	local S = {}
	S.id = "L.0211"
	S.key = "arkher.sim.vegetation.simulation_core"
	S.name = "Vegetation Simulation Core"
	S.category = "L"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "l", "vegetation", "simulation", "sim" }
	S.description = "Vegetation Simulation Core: observer-driven fidelity, catch-up and aggregate state for the Vegetation subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("simulation", { id = "arkher.sim.vegetation.simulation_core", fullRadius = 280, reducedRadius = 800, budget = 114 })
		inst.system = S
		inst.ctx = ctx
