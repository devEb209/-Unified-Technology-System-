-- ARKHER SYSTEM VC.0599 :: Horizon Span Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0599"
	S.key = "arkher.contneural.horizonspan.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.horizonspan.simulation_fabric" }
	S.tags = { "vc", "horizonspan", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.horizonspan.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
