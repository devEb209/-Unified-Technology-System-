-- ARKHER SYSTEM O.0226 :: Music Bed Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0226"
	S.key = "arkher.audio.musicbed.analysis"
	S.name = "Music Bed Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Music Bed"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.musicbed.playback_policy" }
	S.tags = { "o", "musicbed", "analyzer", "audio" }
	S.description = "Music Bed Analysis: loudness, headroom and masking analysis for the Music Bed subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.musicbed.analysis", window = 211, buckets = 19, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
