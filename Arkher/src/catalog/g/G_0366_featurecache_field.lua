-- ARKHER SYSTEM G.0366 :: Feature Cache Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0366"
	S.key = "arkher.neural.featurecache.feature_extraction"
	S.name = "Feature Cache Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.featurecache.inference_core" }
	S.tags = { "g", "featurecache", "field", "neural" }
	S.description = "Feature Cache Feature Extraction: signal features feeding the model for the Feature Cache subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.featurecache.feature_extraction", seed = 98636, frequency = 0.0130, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
