--!strict
-- DaVinci Pages — ANIMATION Node_Flow #0281
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="DaVinci Pages — ANIMATION Node_Flow #0281", size=Vector2.new(680, 440), pos=UDim2.fromOffset(153, 177), parent=parent, icon="⚑"})
