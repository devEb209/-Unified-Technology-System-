-- ARKHER SYSTEM P.0401 :: Match State Machine
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0401"
	S.key = "arkher.play.match.state_machine"
	S.name = "Match State Machine"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Match"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.play.match.combat_resolution" }
	S.tags = { "p", "match", "orchestrator", "play" }
	S.description = "Match State Machine: the phase machine that drives this gameplay loop for the Match subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.play.match.state_machine", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
