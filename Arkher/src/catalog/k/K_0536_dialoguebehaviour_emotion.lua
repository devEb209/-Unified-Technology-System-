-- ARKHER SYSTEM K.0536 :: Dialogue Behaviour Emotion
...
return function(A)
	...
	local S = {}
	S.id = "K.0536"
	S.key = "arkher.npc.dialoguebehaviour.emotion"
	S.name = "Dialogue Behaviour Emotion"
	S.category = "K"
	...
	S.kit = "emotion"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dialoguebehaviour.drive_system" }
	S.tags = { "k", "dialoguebehaviour", "emotion", "npc" }
	S.description = "Dialogue Behaviour Emotion: appraisal of events into valence, arousal and mood for the Dialogue Behaviour subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emotion", { id = "arkher.npc.dialoguebehaviour.emotion", inertia = 0.90, decayRate = 0.45, baselineArousal = 0.25 })
		inst.system = S
		inst.ctx = ctx
