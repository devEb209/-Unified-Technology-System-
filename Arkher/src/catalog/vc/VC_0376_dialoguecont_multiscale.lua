-- ARKHER SYSTEM VC.0376 :: Dialogue Continuum Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VC.0376"
	S.key = "arkher.contneural.dialoguecont.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.dialoguecont.sparse_residency" }
	S.tags = { "vc", "dialoguecont", "multiscale", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contneural.dialoguecont.multi-scale_fidelity", levels = 6, baseTriangles = 150000 })
		inst.system = S
		inst.ctx = ctx
