-- ARKHER SYSTEM F.0129 :: Global Illumination Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0129"
	S.key = "arkher.render.gi.visibility_set"
	S.name = "Global Illumination Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.gi.view_and_culling" }
	S.tags = { "f", "gi", "visibility", "render" }
	S.description = "Global Illumination Visibility Set: cell, portal and occluder visibility for the Global Illumination subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.gi.visibility_set", maxDepth = 4 })
		inst.system = S
		inst.ctx = ctx
