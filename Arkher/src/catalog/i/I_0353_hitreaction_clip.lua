-- ARKHER SYSTEM I.0353 :: Hit Reaction Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0353"
	S.key = "arkher.anim.hitreaction.clip_sampling"
	S.name = "Hit Reaction Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Hit Reaction"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.hitreaction.skeleton" }
	S.tags = { "i", "hitreaction", "clip", "anim" }
	S.description = "Hit Reaction Clip Sampling: keyframe tracks sampled, retimed and evented for the Hit Reaction subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.hitreaction.clip_sampling", duration = 1.60, loop = true })
		inst.system = S
		inst.ctx = ctx
