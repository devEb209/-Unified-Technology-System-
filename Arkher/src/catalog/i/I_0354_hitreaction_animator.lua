-- ARKHER SYSTEM I.0354 :: Hit Reaction Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0354"
	S.key = "arkher.anim.hitreaction.layered_blending"
	S.name = "Hit Reaction Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Hit Reaction"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.hitreaction.clip_sampling" }
	S.tags = { "i", "hitreaction", "animator", "anim" }
	S.description = "Hit Reaction Layered Blending: layers, crossfades, masks and blend trees for the Hit Reaction subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.hitreaction.layered_blending", budget = 12 })
		inst.system = S
		inst.ctx = ctx
