-- ARKHER SYSTEM T.0620 :: Explainability Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0620"
	S.key = "arkher.ai.explainability.self_critique"
	S.name = "Explainability Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.explainability.plan_workflow" }
	S.tags = { "t", "explainability", "critic", "ai" }
	S.description = "Explainability Self Critique: weighted evaluation of the result against declared criteria for the Explainability subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.explainability.self_critique", passMark = 0.83, reviseMark = 0.43, seed = 23713 })
		inst.system = S
		inst.ctx = ctx
