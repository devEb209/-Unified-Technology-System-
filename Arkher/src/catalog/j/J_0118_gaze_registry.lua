-- ARKHER SYSTEM J.0118 :: Gaze Behaviour Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0118"
	S.key = "arkher.character.gaze.variant_registry"
	S.name = "Gaze Behaviour Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gaze.appearance_composer" }
	S.tags = { "j", "gaze", "registry", "character" }
	S.description = "Gaze Behaviour Variant Registry: named character variants and their lifecycle for the Gaze Behaviour subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.gaze.variant_registry" })
		inst.system = S
		inst.ctx = ctx
