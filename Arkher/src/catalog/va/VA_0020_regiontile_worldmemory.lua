-- ARKHER SYSTEM VA.0020 :: Region Tile World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0020"
	S.key = "arkher.contworld.regiontile.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.regiontile.neural_field" }
	S.tags = { "va", "regiontile", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.regiontile.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
