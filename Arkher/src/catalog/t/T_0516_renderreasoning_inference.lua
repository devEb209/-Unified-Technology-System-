-- ARKHER SYSTEM T.0516 :: Render Reasoning Model Inference
...
return function(A)
	...
	local S = {}
	S.id = "T.0516"
	S.key = "arkher.ai.renderreasoning.model_inference"
	S.name = "Render Reasoning Model Inference"
	S.category = "T"
	...
	S.kit = "inference"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.renderreasoning.action_planner" }
	S.tags = { "t", "renderreasoning", "inference", "ai" }
	S.description = "Render Reasoning Model Inference: quantized inference with batching and budget for the Render Reasoning subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.ai.renderreasoning.model_inference", seed = 18305 })
		inst.system = S
		inst.ctx = ctx
