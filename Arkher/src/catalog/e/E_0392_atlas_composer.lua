-- ARKHER SYSTEM E.0392 :: Texture Atlas Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0392"
	S.key = "arkher.material.atlas.layer_composition"
	S.name = "Texture Atlas Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.atlas.definition" }
	S.tags = { "e", "atlas", "composer", "material" }
	S.description = "Texture Atlas Layer Composition: ordered layer composition with blend rules for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.atlas.layer_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
