-- ARKHER SYSTEM VD.0504 :: Rendering Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0504"
	S.key = "arkher.contsim.rendercont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.rendercont.reality_continuum" }
	S.tags = { "vd", "rendercont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.rendercont.emergence_continuum", windowSize = 6, threshold = 1.50, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
