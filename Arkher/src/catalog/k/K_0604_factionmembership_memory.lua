-- ARKHER SYSTEM K.0604 :: Faction Membership Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0604"
	S.key = "arkher.npc.factionmembership.memory"
	S.name = "Faction Membership Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.factionmembership.mind_network" }
	S.tags = { "k", "factionmembership", "memory", "npc" }
	S.description = "Faction Membership Memory: episodic memory with decay, recall and consolidation for the Faction Membership subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.factionmembership.memory", capacity = 124, decayRate = 0.060, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
