-- ARKHER SYSTEM T.0060 :: World Knowledge Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0060"
	S.key = "arkher.ai.worldknowledge.self_critique"
	S.name = "World Knowledge Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.worldknowledge.plan_workflow" }
	S.tags = { "t", "worldknowledge", "critic", "ai" }
	S.description = "World Knowledge Self Critique: weighted evaluation of the result against declared criteria for the World Knowledge subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.worldknowledge.self_critique", passMark = 0.73, reviseMark = 0.48, seed = 10878 })
		inst.system = S
		inst.ctx = ctx
