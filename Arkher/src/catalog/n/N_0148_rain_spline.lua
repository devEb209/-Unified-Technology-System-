-- ARKHER SYSTEM N.0148 :: Rain Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0148"
	S.key = "arkher.vfx.rain.curve_authoring"
	S.name = "Rain Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Rain"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.rain.ribbon_and_trail" }
	S.tags = { "n", "rain", "spline", "vfx" }
	S.description = "Rain Curve Authoring: authored curves driving the effect over its life for the Rain subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.rain.curve_authoring", tension = 0.69, closed = false })
		inst.system = S
		inst.ctx = ctx
