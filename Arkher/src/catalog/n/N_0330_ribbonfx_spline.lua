-- ARKHER SYSTEM N.0330 :: Ribbon Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0330"
	S.key = "arkher.vfx.ribbonfx.curve_authoring"
	S.name = "Ribbon Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Ribbon"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.ribbonfx.ribbon_and_trail" }
	S.tags = { "n", "ribbonfx", "spline", "vfx" }
	S.description = "Ribbon Curve Authoring: authored curves driving the effect over its life for the Ribbon subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.ribbonfx.curve_authoring", tension = 0.58, closed = false })
		inst.system = S
		inst.ctx = ctx
