-- ARKHER SYSTEM VB.0342 :: Society Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0342"
	S.key = "arkher.conttime.societycont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.societycont.persistent_state" }
	S.tags = { "vb", "societycont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.societycont.coherence_guard", window = 133, threshold = 0.17 })
		inst.system = S
		inst.ctx = ctx
