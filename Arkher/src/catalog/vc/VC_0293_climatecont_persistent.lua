-- ARKHER SYSTEM VC.0293 :: Climate Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0293"
	S.key = "arkher.contneural.climatecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.climatecont.multi-scale_fidelity" }
	S.tags = { "vc", "climatecont", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.climatecont.persistent_state", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
