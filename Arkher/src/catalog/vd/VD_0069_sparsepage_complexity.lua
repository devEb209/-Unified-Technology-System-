-- ARKHER SYSTEM VD.0069 :: Sparse Page Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0069"
	S.key = "arkher.contsim.sparsepage.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.sparsepage.world_memory_stream" }
	S.tags = { "vd", "sparsepage", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.sparsepage.complexity_budget", targetMs = 20.0 })
		inst.system = S
		inst.ctx = ctx
