-- ARKHER SYSTEM G.0047 :: Frame Interpolation Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0047"
	S.key = "arkher.neural.frameinterp.model_registry"
	S.name = "Frame Interpolation Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.frameinterp.reconstruction" }
	S.tags = { "g", "frameinterp", "registry", "neural" }
	S.description = "Frame Interpolation Model Registry: named models and their lifecycle for the Frame Interpolation subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.frameinterp.model_registry" })
		inst.system = S
		inst.ctx = ctx
