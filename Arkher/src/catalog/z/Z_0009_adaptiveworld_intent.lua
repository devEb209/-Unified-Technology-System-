-- ARKHER SYSTEM Z.0009 :: Adaptive World Intelligence Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0009"
	S.key = "arkher.origin.adaptiveworld.intent_bridge"
	S.name = "Adaptive World Intelligence Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.adaptiveworld.semantic_graph" }
	S.tags = { "z", "adaptiveworld", "intent", "origin" }
	S.description = "Adaptive World Intelligence Intent Bridge: natural language control surface for the technology for the Adaptive World Intelligence subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.adaptiveworld.intent_bridge", minConfidence = 0.44 })
		inst.system = S
		inst.ctx = ctx
