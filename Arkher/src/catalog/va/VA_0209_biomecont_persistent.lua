-- ARKHER SYSTEM VA.0209 :: Biome Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0209"
	S.key = "arkher.contworld.biomecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.biomecont.multi-scale_fidelity" }
	S.tags = { "va", "biomecont", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.biomecont.persistent_state", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
