-- ARKHER SYSTEM K.0246 :: Temperament Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0246"
	S.key = "arkher.npc.temperament.goal_planner"
	S.name = "Temperament Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.temperament.utility_reasoning" }
	S.tags = { "k", "temperament", "planner", "npc" }
	S.description = "Temperament Goal Planner: backward GOAP planning to reach a goal state for the Temperament subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.temperament.goal_planner", maxDepth = 6 })
		inst.system = S
		inst.ctx = ctx
