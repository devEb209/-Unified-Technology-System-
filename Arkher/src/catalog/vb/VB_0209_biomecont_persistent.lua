-- ARKHER SYSTEM VB.0209 :: Biome Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VB.0209"
	S.key = "arkher.conttime.biomecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.biomecont.multi-scale_fidelity" }
	S.tags = { "vb", "biomecont", "persistent", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.conttime.biomecont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
