-- ARKHER SYSTEM O.0243 :: Combat Music Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0243"
	S.key = "arkher.audio.combatmusic.spatialization"
	S.name = "Combat Music Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Combat Music"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.combatmusic.mixer_bus" }
	S.tags = { "o", "combatmusic", "spatialaudio", "audio" }
	S.description = "Combat Music Spatialization: distance attenuation, panning, occlusion and doppler for the Combat Music subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.combatmusic.spatialization", model = "exponential", refDistance = 8, maxDistance = 100, rolloff = 0.91, maxVoices = 32 })
		inst.system = S
		inst.ctx = ctx
