-- ARKHER SYSTEM W.0389 :: Preview Render Cut Policy
...
return function(A)
	...
	local S = {}
	S.id = "W.0389"
	S.key = "arkher.cine.previewrender.cut_policy"
	S.name = "Preview Render Cut Policy"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.previewrender.shot_composition" }
	S.tags = { "w", "previewrender", "policy", "cine" }
	S.description = "Preview Render Cut Policy: rules deciding when the sequence cuts and to what for the Preview Render subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.cine.previewrender.cut_policy", algorithm = "wfq", starvationGuard = 18 })
		inst.system = S
		inst.ctx = ctx
