-- ARKHER SYSTEM N.0308 :: Status Effect Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0308"
	S.key = "arkher.vfx.statusfx.result_cache"
	S.name = "Status Effect Result Cache"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.statusfx.spawn_budget" }
	S.tags = { "n", "statusfx", "cache", "vfx" }
	S.description = "Status Effect Result Cache: reuse of expensive effect evaluations for the Status Effect subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.statusfx.result_cache", policy = "ttl", capacity = 487, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
