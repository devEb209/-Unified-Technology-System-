-- ARKHER SYSTEM H.0179 :: Sleeping Result Cache
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0179"
	S.key = "arkher.physics.sleeping.result_cache"
	S.name = "Sleeping Result Cache"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Sleeping"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sleeping.simulation_policy" }
	S.tags = { "h", "sleeping", "cache", "physics" }
	S.description = "Sleeping Result Cache: reuse of expensive simulation and query results for the Sleeping subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.physics.sleeping.result_cache", policy = "ttl", capacity = 353, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
