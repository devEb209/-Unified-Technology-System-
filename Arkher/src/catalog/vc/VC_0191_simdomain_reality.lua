-- ARKHER SYSTEM VC.0191 :: Simulation Domain Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0191"
	S.key = "arkher.contneural.simdomain.reality_continuum"
	S.name = "Simulation Domain Reality Continuum"
	S.category = "VC"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.simdomain.simulation_fabric" }
	S.tags = { "vc", "simdomain", "reality", "contneural" }
	S.description = "Simulation Domain Reality Continuum: stacked reality layers of the continuum for the Simulation Domain subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.simdomain.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
