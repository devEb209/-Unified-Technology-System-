-- ARKHER SYSTEM F.0612 :: Frame Capture Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0612"
	S.key = "arkher.render.framecapture.render_policy"
	S.name = "Frame Capture Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framecapture.draw_budget" }
	S.tags = { "f", "framecapture", "policy", "render" }
	S.description = "Frame Capture Render Policy: device tier rules for the frame for the Frame Capture subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 400,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.framecapture.render_policy", algorithm = "wfq", starvationGuard = 22 })
		inst.system = S
		inst.ctx = ctx
