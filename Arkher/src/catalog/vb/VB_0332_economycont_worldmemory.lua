-- ARKHER SYSTEM VB.0332 :: Economy Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0332"
	S.key = "arkher.conttime.economycont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.economycont.neural_field" }
	S.tags = { "vb", "economycont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.economycont.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
