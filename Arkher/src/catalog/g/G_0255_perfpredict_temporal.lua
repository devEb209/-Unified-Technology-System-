-- ARKHER SYSTEM G.0255 :: Performance Prediction Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0255"
	S.key = "arkher.neural.perfpredict.temporal_history"
	S.name = "Performance Prediction Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perfpredict.feature_extraction" }
	S.tags = { "g", "perfpredict", "temporal", "neural" }
	S.description = "Performance Prediction Temporal History: history buffers reused across frames for the Performance Prediction subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.perfpredict.temporal_history", feedback = 0.87, phase = 8 })
		inst.system = S
		inst.ctx = ctx
