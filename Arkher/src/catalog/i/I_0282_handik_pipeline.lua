-- ARKHER SYSTEM I.0282 :: Hand Placement IK Playback Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "I.0282"
	S.key = "arkher.anim.handik.playback_pipeline"
	S.name = "Hand Placement IK Playback Pipeline"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.handik.event_ledger" }
	S.tags = { "i", "handik", "pipeline", "anim" }
	S.description = "Hand Placement IK Playback Pipeline: ordered sample, blend, ik and output stages for the Hand Placement IK subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.anim.handik.playback_pipeline", budgetMs = 5.00 })
		inst.system = S
		inst.ctx = ctx
