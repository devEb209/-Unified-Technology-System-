-- ARKHER SYSTEM R.0105 :: Remote Event Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0105"
	S.key = "arkher.net.remoteevent.session_registry"
	S.name = "Remote Event Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Remote Event"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remoteevent.rate_guard" }
	S.tags = { "r", "remoteevent", "registry", "net" }
	S.description = "Remote Event Session Registry: catalogue of sessions, players and their metadata for the Remote Event subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.remoteevent.session_registry" })
		inst.system = S
		inst.ctx = ctx
