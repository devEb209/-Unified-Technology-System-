-- ARKHER SYSTEM Z.0285 :: Temporal Continuity World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0285"
	S.key = "arkher.origin.temporalcontinuity.world_memory"
	S.name = "Temporal Continuity World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.temporalcontinuity.autonomous_pipeline" }
	S.tags = { "z", "temporalcontinuity", "worldmemory", "origin" }
	S.description = "Temporal Continuity World Memory: epoch-stamped persistent history with compaction and checkpoints for the Temporal Continuity subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.temporalcontinuity.world_memory", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
