-- ARKHER SYSTEM H.0261 :: Narrowphase Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0261"
	S.key = "arkher.physics.narrowphase.budget_governor"
	S.name = "Narrowphase Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Narrowphase"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.narrowphase.broadphase_index" }
	S.tags = { "h", "narrowphase", "budgeter", "physics" }
	S.description = "Narrowphase Budget Governor: simulation time budget allocation across islands for the Narrowphase subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.narrowphase.budget_governor", total = 309, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
