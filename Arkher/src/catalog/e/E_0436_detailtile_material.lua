-- ARKHER SYSTEM E.0436 :: Detail Tiling Definition
...
return function(A)
	...
	local S = {}
	S.id = "E.0436"
	S.key = "arkher.material.detailtile.definition"
	S.name = "Detail Tiling Definition"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "e", "detailtile", "material", "material" }
	S.description = "Detail Tiling Definition: layered PBR definition resolved into parameters for the Detail Tiling subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("material", { id = "arkher.material.detailtile.definition", texelBudget = 1310720 })
		inst.system = S
		inst.ctx = ctx
