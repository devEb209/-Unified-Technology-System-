-- ARKHER SYSTEM G.0338 :: Inference Scheduler Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0338"
	S.key = "arkher.neural.inferencesched.feature_extraction"
	S.name = "Inference Scheduler Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.inferencesched.inference_core" }
	S.tags = { "g", "inferencesched", "field", "neural" }
	S.description = "Inference Scheduler Feature Extraction: signal features feeding the model for the Inference Scheduler subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.inferencesched.feature_extraction", seed = 82252, frequency = 0.0070, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
