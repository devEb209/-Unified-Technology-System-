-- ARKHER SYSTEM VD.0554 :: Device Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0554"
	S.key = "arkher.contsim.devicecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.devicecont.infinite_grid" }
	S.tags = { "vd", "devicecont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.devicecont.epoch_clock", tickRate = 20, budget = 5, capacity = 96 })
		inst.system = S
		inst.ctx = ctx
