-- ARKHER SYSTEM E.0325 :: Moisture Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0325"
	S.key = "arkher.material.moisture.quality_policy"
	S.name = "Moisture Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Moisture"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.moisture.compression_codec" }
	S.tags = { "e", "moisture", "policy", "material" }
	S.description = "Moisture Quality Policy: device tier rules for the surface for the Moisture subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.moisture.quality_policy", algorithm = "wfq", starvationGuard = 62 })
		inst.system = S
		inst.ctx = ctx
