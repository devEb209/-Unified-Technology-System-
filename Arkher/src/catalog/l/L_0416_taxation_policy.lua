-- ARKHER SYSTEM L.0416 :: Taxation Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0416"
	S.key = "arkher.sim.taxation.fidelity_policy"
	S.name = "Taxation Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.taxation.streaming" }
	S.tags = { "l", "taxation", "policy", "sim" }
	S.description = "Taxation Fidelity Policy: rules that pick full, cohort or statistical simulation for the Taxation subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.taxation.fidelity_policy", algorithm = "roundrobin", starvationGuard = 36 })
		inst.system = S
		inst.ctx = ctx
