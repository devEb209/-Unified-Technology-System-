-- ARKHER SYSTEM Z.0846 :: Simulation Time Dilation Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0846"
	S.key = "arkher.origin.timedilation.emergence_detection"
	S.name = "Simulation Time Dilation Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.timedilation.world_memory" }
	S.tags = { "z", "timedilation", "emergence", "origin" }
	S.description = "Simulation Time Dilation Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Simulation Time Dilation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 560,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.timedilation.emergence_detection", windowSize = 6, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
