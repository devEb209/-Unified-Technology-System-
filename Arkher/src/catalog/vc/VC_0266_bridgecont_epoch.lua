-- ARKHER SYSTEM VC.0266 :: Bridge Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0266"
	S.key = "arkher.contneural.bridgecont.epoch_clock"
	S.name = "Bridge Continuum Epoch Clock"
	S.category = "VC"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.bridgecont.infinite_grid" }
	S.tags = { "vc", "bridgecont", "epoch", "contneural" }
	S.description = "Bridge Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Bridge Continuum subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.bridgecont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
