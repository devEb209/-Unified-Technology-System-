-- ARKHER SYSTEM VA.0007 :: World Grid Cell Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0007"
	S.key = "arkher.contworld.worldcell.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.worldcell.coherence_guard" }
	S.tags = { "va", "worldcell", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.worldcell.neural_field", dims = 16, hidden = 12, seed = 67801 })
		inst.system = S
		inst.ctx = ctx
