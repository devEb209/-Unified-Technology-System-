-- ARKHER SYSTEM Z.0189 :: World Memory Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0189"
	S.key = "arkher.origin.worldmemorytech.intent_bridge"
	S.name = "World Memory Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldmemorytech.semantic_graph" }
	S.tags = { "z", "worldmemorytech", "intent", "origin" }
	S.description = "World Memory Intent Bridge: natural language control surface for the technology for the World Memory subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.worldmemorytech.intent_bridge", minConfidence = 0.35 })
		inst.system = S
		inst.ctx = ctx
