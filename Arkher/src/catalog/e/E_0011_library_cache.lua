-- ARKHER SYSTEM E.0011 :: Material Library Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0011"
	S.key = "arkher.material.library.instance_cache"
	S.name = "Material Library Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.library.quality_policy" }
	S.tags = { "e", "library", "cache", "material" }
	S.description = "Material Library Instance Cache: resolved-parameter cache keyed by context for the Material Library subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.library.instance_cache", policy = "lfu", capacity = 68, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
