-- ARKHER SYSTEM J.0255 :: Damage State Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0255"
	S.key = "arkher.character.damagestate.motion_set"
	S.name = "Damage State Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.damagestate.rig_definition" }
	S.tags = { "j", "damagestate", "clip", "character" }
	S.description = "Damage State Motion Set: the clips a character owns and how they sample for the Damage State subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.damagestate.motion_set", duration = 0.70, loop = true })
		inst.system = S
		inst.ctx = ctx
