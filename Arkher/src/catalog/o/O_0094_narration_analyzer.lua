-- ARKHER SYSTEM O.0094 :: Narration Analysis
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0094"
	S.key = "arkher.audio.narration.analysis"
	S.name = "Narration Analysis"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Narration"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.narration.playback_policy" }
	S.tags = { "o", "narration", "analyzer", "audio" }
	S.description = "Narration Analysis: loudness, headroom and masking analysis for the Narration subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.audio.narration.analysis", window = 48, buckets = 12, threshold = 3.00 })
		inst.system = S
		inst.ctx = ctx
