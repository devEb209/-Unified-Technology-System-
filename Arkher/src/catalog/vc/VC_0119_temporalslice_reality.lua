-- ARKHER SYSTEM VC.0119 :: Temporal Slice Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0119"
	S.key = "arkher.contneural.temporalslice.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.temporalslice.simulation_fabric" }
	S.tags = { "vc", "temporalslice", "reality", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contneural.temporalslice.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
