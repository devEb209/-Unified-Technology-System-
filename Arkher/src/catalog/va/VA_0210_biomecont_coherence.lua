-- ARKHER SYSTEM VA.0210 :: Biome Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0210"
	S.key = "arkher.contworld.biomecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.biomecont.persistent_state" }
	S.tags = { "va", "biomecont", "coherence", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.biomecont.coherence_guard", window = 87, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
