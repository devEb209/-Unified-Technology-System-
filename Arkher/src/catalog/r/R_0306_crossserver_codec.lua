-- ARKHER SYSTEM R.0306 :: Cross Server Serialization Codec
...
return function(A)
	...
	local S = {}
	S.id = "R.0306"
	S.key = "arkher.net.crossserver.serialization_codec"
	S.name = "Cross Server Serialization Codec"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Cross Server"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.net.crossserver.bandwidth_budget" }
	S.tags = { "r", "crossserver", "codec", "net" }
	S.description = "Cross Server Serialization Codec: compact encoding, diffing and checksum of payloads for the Cross Server subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.net.crossserver.serialization_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
