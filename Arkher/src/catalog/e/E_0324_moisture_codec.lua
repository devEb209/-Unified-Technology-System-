-- ARKHER SYSTEM E.0324 :: Moisture Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0324"
	S.key = "arkher.material.moisture.compression_codec"
	S.name = "Moisture Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Moisture"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.moisture.streaming" }
	S.tags = { "e", "moisture", "codec", "material" }
	S.description = "Moisture Compression Codec: serialization and compression of material data for the Moisture subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.moisture.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
