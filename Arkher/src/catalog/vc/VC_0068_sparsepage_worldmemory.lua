-- ARKHER SYSTEM VC.0068 :: Sparse Page World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0068"
	S.key = "arkher.contneural.sparsepage.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.sparsepage.neural_field" }
	S.tags = { "vc", "sparsepage", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.sparsepage.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
