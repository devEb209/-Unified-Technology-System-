-- ARKHER SYSTEM W.0313 :: Colour Look Sequence Timeline
...
return function(A)
	...
	local S = {}
	S.id = "W.0313"
	S.key = "arkher.cine.colourlook.sequence_timeline"
	S.name = "Colour Look Sequence Timeline"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Colour Look"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "w", "colourlook", "timeline", "cine" }
	S.description = "Colour Look Sequence Timeline: keyframed tracks, clips and events on a scrubable playhead for the Colour Look subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("timeline", { id = "arkher.cine.colourlook.sequence_timeline", duration = 8.0, rate = 1.16 })
		inst.system = S
		inst.ctx = ctx
