-- ARKHER SYSTEM VC.0372 :: Quest Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0372"
	S.key = "arkher.contneural.questcont.emergence_continuum"
	S.name = "Quest Continuum Emergence Continuum"
	S.category = "VC"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.questcont.reality_continuum" }
	S.tags = { "vc", "questcont", "emergence", "contneural" }
	S.description = "Quest Continuum Emergence Continuum: emergence detection over the continuum for the Quest Continuum subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.questcont.emergence_continuum", windowSize = 6, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
