-- ARKHER SYSTEM Z.0951 :: Platform Abstraction Doctrine Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0951"
	S.key = "arkher.origin.platformdoctrine.adaptive_workflow"
	S.name = "Platform Abstraction Doctrine Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.platformdoctrine.self_critique" }
	S.tags = { "z", "platformdoctrine", "workflow", "origin" }
	S.description = "Platform Abstraction Doctrine Adaptive Workflow: verified, retryable, reversible execution plans for the Platform Abstraction Doctrine subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.platformdoctrine.adaptive_workflow", maxRetries = 3, budget = 90 })
		inst.system = S
		inst.ctx = ctx
