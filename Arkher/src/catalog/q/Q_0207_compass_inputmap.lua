-- ARKHER SYSTEM Q.0207 :: Compass Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0207"
	S.key = "arkher.ui.compass.input_mapping"
	S.name = "Compass Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Compass"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.compass.widget_tree" }
	S.tags = { "q", "compass", "inputmap", "ui" }
	S.description = "Compass Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Compass subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.compass.input_mapping", device = "gamepad", holdTime = 0.26, deadzone = 0.11 })
		inst.system = S
		inst.ctx = ctx
