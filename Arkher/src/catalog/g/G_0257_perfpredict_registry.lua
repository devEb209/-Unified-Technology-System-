-- ARKHER SYSTEM G.0257 :: Performance Prediction Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0257"
	S.key = "arkher.neural.perfpredict.model_registry"
	S.name = "Performance Prediction Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perfpredict.reconstruction" }
	S.tags = { "g", "perfpredict", "registry", "neural" }
	S.description = "Performance Prediction Model Registry: named models and their lifecycle for the Performance Prediction subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.perfpredict.model_registry" })
		inst.system = S
		inst.ctx = ctx
