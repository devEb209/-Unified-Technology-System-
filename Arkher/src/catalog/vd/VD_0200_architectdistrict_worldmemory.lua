-- ARKHER SYSTEM VD.0200 :: Architect District World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0200"
	S.key = "arkher.contsim.architectdistrict.world_memory_stream"
	S.name = "Architect District World Memory Stream"
	S.category = "VD"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.architectdistrict.neural_field" }
	S.tags = { "vd", "architectdistrict", "worldmemory", "contsim" }
	S.description = "Architect District World Memory Stream: world memory continuum over epochs for the Architect District subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.architectdistrict.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
