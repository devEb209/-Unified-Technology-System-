-- ARKHER SYSTEM VB.0263 :: Road Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0263"
	S.key = "arkher.conttime.roadcont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.roadcont.simulation_fabric" }
	S.tags = { "vb", "roadcont", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.roadcont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
