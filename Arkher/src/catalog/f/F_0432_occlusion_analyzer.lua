-- ARKHER SYSTEM F.0432 :: Occlusion Culling Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0432"
	S.key = "arkher.render.occlusion.frame_analysis"
	S.name = "Occlusion Culling Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.occlusion.pass_cache" }
	S.tags = { "f", "occlusion", "analyzer", "render" }
	S.description = "Occlusion Culling Frame Analysis: per-pass cost analysis and outlier detection for the Occlusion Culling subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.occlusion.frame_analysis", window = 147, buckets = 15, threshold = 3.90 })
		inst.system = S
		inst.ctx = ctx
