-- ARKHER SYSTEM N.0235 :: Spell Cast Emission
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0235"
	S.key = "arkher.vfx.spellcast.emission"
	S.name = "Spell Cast Emission"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spell Cast"
	S.aspect = "Emission"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "n", "spellcast", "emitter", "vfx" }
	S.description = "Spell Cast Emission: shaped, rate and burst emission of new particles for the Spell Cast subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emitter", { id = "arkher.vfx.spellcast.emission", shape = "point", rate = 43, speed = 5.30, life = 3.10, budget = 576, seed = 56783 })
		inst.system = S
		inst.ctx = ctx
