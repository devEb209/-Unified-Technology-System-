-- ARKHER SYSTEM Z.0142 :: Autonomous Development Pipeline Complexity Governance
...
return function(A)
	...
	local S = {}
	S.id = "Z.0142"
	S.key = "arkher.origin.autodevpipeline.complexity_governance"
	S.name = "Autonomous Development Pipeline Complexity Governance"
	S.category = "Z"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodevpipeline.reality_layering" }
	S.tags = { "z", "autodevpipeline", "complexity", "origin" }
	S.description = "Autonomous Development Pipeline Complexity Governance: measured scene cost turned into per-subsystem directives for the Autonomous Development Pipeline subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.origin.autodevpipeline.complexity_governance", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
