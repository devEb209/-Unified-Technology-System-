-- ARKHER SYSTEM T.0309 :: Optimization Advisor Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0309"
	S.key = "arkher.ai.optimizationadvisor.intent_understanding"
	S.name = "Optimization Advisor Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "optimizationadvisor", "intent", "ai" }
	S.description = "Optimization Advisor Intent Understanding: natural language turned into an actionable, scored intent for the Optimization Advisor subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.optimizationadvisor.intent_understanding", minConfidence = 0.34 })
		inst.system = S
		inst.ctx = ctx
