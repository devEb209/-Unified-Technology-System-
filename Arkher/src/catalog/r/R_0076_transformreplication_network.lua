-- ARKHER SYSTEM R.0076 :: Transform Replication Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0076"
	S.key = "arkher.net.transformreplication.transport_graph"
	S.name = "Transform Replication Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.transformreplication.prediction_and_reconciliation" }
	S.tags = { "r", "transformreplication", "network", "net" }
	S.description = "Transform Replication Transport Graph: topology, capacity and routing between endpoints for the Transform Replication subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.transformreplication.transport_graph" })
		inst.system = S
		inst.ctx = ctx
