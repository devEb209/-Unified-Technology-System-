-- ARKHER SYSTEM VB.0537 :: Pipeline Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0537"
	S.key = "arkher.conttime.pipelinecont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.pipelinecont.world_memory_stream" }
	S.tags = { "vb", "pipelinecont", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.pipelinecont.complexity_budget", targetMs = 21.0 })
		inst.system = S
		inst.ctx = ctx
