-- ARKHER SYSTEM N.0346 :: Beam Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0346"
	S.key = "arkher.vfx.beam.spawn_budget"
	S.name = "Beam Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Beam"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.beam.effect_composition" }
	S.tags = { "n", "beam", "budgeter", "vfx" }
	S.description = "Beam Spawn Budget: global particle budget shared by every live effect for the Beam subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 400,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.beam.spawn_budget", total = 122, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
