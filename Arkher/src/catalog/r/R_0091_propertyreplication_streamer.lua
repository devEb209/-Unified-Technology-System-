-- ARKHER SYSTEM R.0091 :: Property Replication Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0091"
	S.key = "arkher.net.propertyreplication.interest_streaming"
	S.name = "Property Replication Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.propertyreplication.serialization_codec" }
	S.tags = { "r", "propertyreplication", "streamer", "net" }
	S.description = "Property Replication Interest Streaming: distance-driven residency of replicated content for the Property Replication subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.propertyreplication.interest_streaming", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
