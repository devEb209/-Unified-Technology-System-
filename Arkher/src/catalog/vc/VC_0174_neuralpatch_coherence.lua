-- ARKHER SYSTEM VC.0174 :: Neural Patch Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0174"
	S.key = "arkher.contneural.neuralpatch.coherence_guard"
	S.name = "Neural Patch Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.neuralpatch.persistent_state" }
	S.tags = { "vc", "neuralpatch", "coherence", "contneural" }
	S.description = "Neural Patch Coherence Guard: seam coherence and drift supervision for the Neural Patch subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.neuralpatch.coherence_guard", window = 133, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
