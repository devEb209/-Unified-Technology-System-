-- ARKHER SYSTEM K.0611 :: Faction Membership Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0611"
	S.key = "arkher.npc.factionmembership.navigation"
	S.name = "Faction Membership Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.factionmembership.goal_planner" }
	S.tags = { "k", "factionmembership", "navgraph", "npc" }
	S.description = "Faction Membership Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Faction Membership subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.factionmembership.navigation", width = 40, height = 40, cellSize = 4 })
		inst.system = S
		inst.ctx = ctx
