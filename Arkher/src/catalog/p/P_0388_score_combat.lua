-- ARKHER SYSTEM P.0388 :: Score Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0388"
	S.key = "arkher.play.score.combat_resolution"
	S.name = "Score Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Score"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.score.objectives" }
	S.tags = { "p", "score", "combat", "play" }
	S.description = "Score Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Score subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.score.combat_resolution", seed = 92599, armourK = 150, critMultiplier = 2.20 })
		inst.system = S
		inst.ctx = ctx
