-- ARKHER SYSTEM VB.0054 :: Epoch Frame Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0054"
	S.key = "arkher.conttime.epochframe.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.epochframe.persistent_state" }
	S.tags = { "vb", "epochframe", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.epochframe.coherence_guard", window = 115, threshold = 0.15 })
		inst.system = S
		inst.ctx = ctx
