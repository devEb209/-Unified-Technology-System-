-- ARKHER SYSTEM Z.0229 :: Emergent Society Framework Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0229"
	S.key = "arkher.origin.emergentsociety.intent_bridge"
	S.name = "Emergent Society Framework Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentsociety.semantic_graph" }
	S.tags = { "z", "emergentsociety", "intent", "origin" }
	S.description = "Emergent Society Framework Intent Bridge: natural language control surface for the technology for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.emergentsociety.intent_bridge", minConfidence = 0.37 })
		inst.system = S
		inst.ctx = ctx
