-- ARKHER SYSTEM Z.0237 :: Emergent Society Framework Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0237"
	S.key = "arkher.origin.emergentsociety.behaviour_analysis"
	S.name = "Emergent Society Framework Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentsociety.governance_policy" }
	S.tags = { "z", "emergentsociety", "analyzer", "origin" }
	S.description = "Emergent Society Framework Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.emergentsociety.behaviour_analysis", window = 200, buckets = 16, threshold = 2.20 })
		inst.system = S
		inst.ctx = ctx
