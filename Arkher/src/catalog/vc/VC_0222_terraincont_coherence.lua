-- ARKHER SYSTEM VC.0222 :: Terrain Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0222"
	S.key = "arkher.contneural.terraincont.coherence_guard"
	S.name = "Terrain Continuum Coherence Guard"
	S.category = "VC"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.terraincont.persistent_state" }
	S.tags = { "vc", "terraincont", "coherence", "contneural" }
	S.description = "Terrain Continuum Coherence Guard: seam coherence and drift supervision for the Terrain Continuum subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.terraincont.coherence_guard", window = 66, threshold = 0.14 })
		inst.system = S
		inst.ctx = ctx
