-- ARKHER SYSTEM J.0320 :: Character Debug Rig Definition
...
return function(A)
	...
	local S = {}
	S.id = "J.0320"
	S.key = "arkher.character.characterdebug.rig_definition"
	S.name = "Character Debug Rig Definition"
	S.category = "J"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "j", "characterdebug", "skeleton", "character" }
	S.description = "Character Debug Rig Definition: character rig definition and bone budget for the Character Debug subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.character.characterdebug.rig_definition" })
		inst.system = S
		inst.ctx = ctx
