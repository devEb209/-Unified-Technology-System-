-- ARKHER SYSTEM VC.0377 :: Dialogue Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0377"
	S.key = "arkher.contneural.dialoguecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.dialoguecont.multi-scale_fidelity" }
	S.tags = { "vc", "dialoguecont", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.dialoguecont.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
