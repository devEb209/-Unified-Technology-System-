-- ARKHER SYSTEM K.0404 :: Plan Execution Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0404"
	S.key = "arkher.npc.planexecution.daily_schedule"
	S.name = "Plan Execution Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.planexecution.social_relations" }
	S.tags = { "k", "planexecution", "schedule", "npc" }
	S.description = "Plan Execution Daily Schedule: hour-by-hour routine with priority interruptions for the Plan Execution subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.planexecution.daily_schedule", startHour = 6 })
		inst.system = S
		inst.ctx = ctx
