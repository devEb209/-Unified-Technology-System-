-- ARKHER SYSTEM G.0085 :: Ghosting Suppression Inference Core
...
return function(A)
	...
	local S = {}
	S.id = "G.0085"
	S.key = "arkher.neural.ghosting.inference_core"
	S.name = "Ghosting Suppression Inference Core"
	S.category = "G"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "g", "ghosting", "inference", "neural" }
	S.description = "Ghosting Suppression Inference Core: dense network forward pass and training for the Ghosting Suppression subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inference", { id = "arkher.neural.ghosting.inference_core", seed = 20436 })
		inst.system = S
		inst.ctx = ctx
