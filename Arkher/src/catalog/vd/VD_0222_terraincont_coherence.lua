-- ARKHER SYSTEM VD.0222 :: Terrain Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0222"
	S.key = "arkher.contsim.terraincont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.terraincont.persistent_state" }
	S.tags = { "vd", "terraincont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.terraincont.coherence_guard", window = 71, threshold = 0.09 })
		inst.system = S
		inst.ctx = ctx
