-- ARKHER SYSTEM T.0536 :: Animation Reasoning Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0536"
	S.key = "arkher.ai.animationreasoning.self_critique"
	S.name = "Animation Reasoning Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.animationreasoning.plan_workflow" }
	S.tags = { "t", "animationreasoning", "critic", "ai" }
	S.description = "Animation Reasoning Self Critique: weighted evaluation of the result against declared criteria for the Animation Reasoning subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.animationreasoning.self_critique", passMark = 0.70, reviseMark = 0.40, seed = 52260 })
		inst.system = S
		inst.ctx = ctx
