-- ARKHER SYSTEM J.0292 :: Character LOD Locomotion
...
return function(A)
	...
	local S = {}
	S.id = "J.0292"
	S.key = "arkher.character.characterlod.locomotion"
	S.name = "Character LOD Locomotion"
	S.category = "J"
	...
	S.kit = "charmotor"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterlod.physical_response" }
	S.tags = { "j", "characterlod", "charmotor", "character" }
	S.description = "Character LOD Locomotion: capsule locomotion driving the character for the Character LOD subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("charmotor", { id = "arkher.character.characterlod.locomotion", radius = 0.49, height = 1.94, maxSpeed = 7.40, jumpHeight = 2.20, stepOffset = 0.29 })
		inst.system = S
		inst.ctx = ctx
