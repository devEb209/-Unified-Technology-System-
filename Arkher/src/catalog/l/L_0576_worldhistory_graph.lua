-- ARKHER SYSTEM L.0576 :: World History Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0576"
	S.key = "arkher.sim.worldhistory.region_graph"
	S.name = "World History Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldhistory.calendar" }
	S.tags = { "l", "worldhistory", "graph", "sim" }
	S.description = "World History Region Graph: connectivity, components and shortest path between places for the World History subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.worldhistory.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
