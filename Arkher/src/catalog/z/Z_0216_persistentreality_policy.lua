-- ARKHER SYSTEM Z.0216 :: Persistent Reality State Governance Policy
...
return function(A)
	...
	local S = {}
	S.id = "Z.0216"
	S.key = "arkher.origin.persistentreality.governance_policy"
	S.name = "Persistent Reality State Governance Policy"
	S.category = "Z"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.persistentreality.signal_composition" }
	S.tags = { "z", "persistentreality", "policy", "origin" }
	S.description = "Persistent Reality State Governance Policy: ordered rules governing when the technology may act for the Persistent Reality State subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.origin.persistentreality.governance_policy", algorithm = "lottery", starvationGuard = 47 })
		inst.system = S
		inst.ctx = ctx
