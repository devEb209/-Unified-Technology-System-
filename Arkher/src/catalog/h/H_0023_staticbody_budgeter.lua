-- ARKHER SYSTEM H.0023 :: Static Body Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0023"
	S.key = "arkher.physics.staticbody.budget_governor"
	S.name = "Static Body Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Static Body"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.staticbody.broadphase_index" }
	S.tags = { "h", "staticbody", "budgeter", "physics" }
	S.description = "Static Body Budget Governor: simulation time budget allocation across islands for the Static Body subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.staticbody.budget_governor", total = 141, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
