-- ARKHER SYSTEM G.0419 :: Drift Detection Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0419"
	S.key = "arkher.neural.drift.sampling_graph"
	S.name = "Drift Detection Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.drift.training_ledger" }
	S.tags = { "g", "drift", "graph", "neural" }
	S.description = "Drift Detection Sampling Graph: dependency graph of sampling stages for the Drift Detection subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.drift.sampling_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
