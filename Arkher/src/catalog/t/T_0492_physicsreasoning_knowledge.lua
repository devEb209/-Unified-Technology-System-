-- ARKHER SYSTEM T.0492 :: Physics Reasoning Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0492"
	S.key = "arkher.ai.physicsreasoning.semantic_knowledge"
	S.name = "Physics Reasoning Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.physicsreasoning.intent_understanding" }
	S.tags = { "t", "physicsreasoning", "knowledge", "ai" }
	S.description = "Physics Reasoning Semantic Knowledge: typed entities, weighted relations and inferred closure for the Physics Reasoning subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.physicsreasoning.semantic_knowledge", dims = 24 })
		inst.system = S
		inst.ctx = ctx
