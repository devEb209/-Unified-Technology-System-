-- ARKHER SYSTEM W.0155 :: Point Of View Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0155"
	S.key = "arkher.cine.pointofview.sequence_analysis"
	S.name = "Point Of View Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.pointofview.frame_budget" }
	S.tags = { "w", "pointofview", "analyzer", "cine" }
	S.description = "Point Of View Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Point Of View subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.pointofview.sequence_analysis", window = 140, buckets = 12, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
