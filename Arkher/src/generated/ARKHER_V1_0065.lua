--!strict
-- ESA WorldCover — ANIMATION Stack #0065
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="ESA WorldCover — ANIMATION Stack #0065", size=Vector2.new(680, 420), pos=UDim2.fromOffset(145, 145), parent=parent, icon="☷"})
