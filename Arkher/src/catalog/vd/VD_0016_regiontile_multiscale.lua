-- ARKHER SYSTEM VD.0016 :: Region Tile Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0016"
	S.key = "arkher.contsim.regiontile.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.regiontile.sparse_residency" }
	S.tags = { "vd", "regiontile", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.regiontile.multi-scale_fidelity", levels = 4, baseTriangles = 90000 })
		inst.system = S
		inst.ctx = ctx
