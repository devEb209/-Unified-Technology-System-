-- ARKHER SYSTEM VA.0098 :: Memory Shard Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0098"
	S.key = "arkher.contworld.memoryshard.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memoryshard.infinite_grid" }
	S.tags = { "va", "memoryshard", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.memoryshard.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
