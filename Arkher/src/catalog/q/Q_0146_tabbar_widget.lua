-- ARKHER SYSTEM Q.0146 :: Tab Bar Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0146"
	S.key = "arkher.ui.tabbar.widget_tree"
	S.name = "Tab Bar Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tab Bar"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.tabbar.responsive_layout" }
	S.tags = { "q", "tabbar", "widget", "ui" }
	S.description = "Tab Bar Widget Tree: retained widget nodes, properties, bindings and rendering for the Tab Bar subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.tabbar.widget_tree", theme = "light", scale = 1.02 })
		inst.system = S
		inst.ctx = ctx
