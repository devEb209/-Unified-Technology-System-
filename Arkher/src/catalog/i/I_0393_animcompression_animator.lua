-- ARKHER SYSTEM I.0393 :: Animation Compression Layered Blending
...
return function(A)
	...
	local S = {}
	S.id = "I.0393"
	S.key = "arkher.anim.animcompression.layered_blending"
	S.name = "Animation Compression Layered Blending"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animcompression.clip_sampling" }
	S.tags = { "i", "animcompression", "animator", "anim" }
	S.description = "Animation Compression Layered Blending: layers, crossfades, masks and blend trees for the Animation Compression subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.anim.animcompression.layered_blending", budget = 12 })
		inst.system = S
		inst.ctx = ctx
