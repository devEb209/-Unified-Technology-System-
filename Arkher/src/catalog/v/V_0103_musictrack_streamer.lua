-- ARKHER SYSTEM V.0103 :: Music Track Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0103"
	S.key = "arkher.asset.musictrack.streaming_residency"
	S.name = "Music Track Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.musictrack.content_cache" }
	S.tags = { "v", "musictrack", "streamer", "asset" }
	S.description = "Music Track Streaming Residency: distance-driven load and unload of asset payloads for the Music Track subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.musictrack.streaming_residency", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
