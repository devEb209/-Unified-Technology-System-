-- ARKHER SYSTEM K.0599 :: Relationship Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0599"
	S.key = "arkher.npc.relationship.social_relations"
	S.name = "Relationship Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.relationship.crowd_steering" }
	S.tags = { "k", "relationship", "society", "npc" }
	S.description = "Relationship Social Relations: affinity, factions, reputation and gossip for the Relationship subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.relationship.social_relations", decayRate = 0.013, gossipReach = 4 })
		inst.system = S
		inst.ctx = ctx
