-- ARKHER SYSTEM I.0345 :: Physical Animation Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0345"
	S.key = "arkher.anim.physanim.compression_codec"
	S.name = "Physical Animation Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.physanim.retarget_graph" }
	S.tags = { "i", "physanim", "codec", "anim" }
	S.description = "Physical Animation Compression Codec: curve compression and quantized transport for the Physical Animation subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.physanim.compression_codec", format = "json", quantBits = 15 })
		inst.system = S
		inst.ctx = ctx
