-- ARKHER SYSTEM VB.0037 :: Continuum Stream Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0037"
	S.key = "arkher.conttime.continuumstream.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "continuumstream", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.continuumstream.infinite_grid", cellSize = 224, radius = 640, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
