-- ARKHER SYSTEM W.0159 :: Cutscene Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0159"
	S.key = "arkher.cine.cutscene.colour_grade"
	S.name = "Cutscene Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Cutscene"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cutscene.camera_rig" }
	S.tags = { "w", "cutscene", "grade", "cine" }
	S.description = "Cutscene Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Cutscene subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.cutscene.colour_grade", exposure = -0.02, contrast = 1.03, saturation = 0.93, toneMap = "reinhard" })
		inst.system = S
		inst.ctx = ctx
