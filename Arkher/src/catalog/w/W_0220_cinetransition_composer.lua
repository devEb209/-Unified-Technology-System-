-- ARKHER SYSTEM W.0220 :: Transition Shot Composition
...
return function(A)
	...
	local S = {}
	S.id = "W.0220"
	S.key = "arkher.cine.cinetransition.shot_composition"
	S.name = "Transition Shot Composition"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Transition"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.cinetransition.colour_grade" }
	S.tags = { "w", "cinetransition", "composer", "cine" }
	S.description = "Transition Shot Composition: blending of the signals that make up the final shot for the Transition subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.cine.cinetransition.shot_composition", mode = "overlay" })
		inst.system = S
		inst.ctx = ctx
