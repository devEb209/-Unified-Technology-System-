-- ARKHER SYSTEM P.0404 :: Match Balance Analysis
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0404"
	S.key = "arkher.play.match.balance_analysis"
	S.name = "Match Balance Analysis"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Match"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.play.match.event_ledger" }
	S.tags = { "p", "match", "analyzer", "play" }
	S.description = "Match Balance Analysis: distribution, outlier and pacing analysis for the Match subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.play.match.balance_analysis", window = 174, buckets = 10, threshold = 4.60 })
		inst.system = S
		inst.ctx = ctx
