-- ARKHER SYSTEM O.0067 :: Voice Line Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0067"
	S.key = "arkher.audio.voiceline.asset_registry"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.voiceline.streaming" }
	S.tags = { "o", "voiceline", "registry", "audio" }
	S.description = "Voice Line Asset Registry: catalogue of sounds, variations and metadata for the Voice Line subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.voiceline.asset_registry" })
		inst.system = S
		inst.ctx = ctx
