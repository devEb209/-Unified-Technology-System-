-- ARKHER SYSTEM K.0051 :: Reward Model Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0051"
	S.key = "arkher.npc.rewardmodel.navigation"
	S.name = "Reward Model Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.rewardmodel.goal_planner" }
	S.tags = { "k", "rewardmodel", "navgraph", "npc" }
	S.description = "Reward Model Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Reward Model subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.rewardmodel.navigation", width = 24, height = 24, cellSize = 2 })
		inst.system = S
		inst.ctx = ctx
