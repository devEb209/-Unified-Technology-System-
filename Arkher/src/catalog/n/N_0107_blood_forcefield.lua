-- ARKHER SYSTEM N.0107 :: Blood Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0107"
	S.key = "arkher.vfx.blood.force_field"
	S.name = "Blood Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Blood"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.blood.particle_simulation" }
	S.tags = { "n", "blood", "forcefield", "vfx" }
	S.description = "Blood Force Field: wind, attraction, vortex, drag and curl turbulence for the Blood subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.blood.force_field", seed = 90863 })
		inst.system = S
		inst.ctx = ctx
