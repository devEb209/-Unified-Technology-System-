-- ARKHER SYSTEM VC.0194 :: Architect District Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0194"
	S.key = "arkher.contneural.architectdistrict.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.architectdistrict.infinite_grid" }
	S.tags = { "vc", "architectdistrict", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.architectdistrict.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
