-- ARKHER SYSTEM Z.0998 :: Engine Self Model Budget Governor
...
return function(A)
	...
	local S = {}
	S.id = "Z.0998"
	S.key = "arkher.origin.engineselfmodel.budget_governor"
	S.name = "Engine Self Model Budget Governor"
	S.category = "Z"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.engineselfmodel.behaviour_analysis" }
	S.tags = { "z", "engineselfmodel", "budgeter", "origin" }
	S.description = "Engine Self Model Budget Governor: allocation of a scarce resource across the technology's consumers for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 440,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.origin.engineselfmodel.budget_governor", total = 91, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
