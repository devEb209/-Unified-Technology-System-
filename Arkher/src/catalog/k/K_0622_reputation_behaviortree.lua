-- ARKHER SYSTEM K.0622 :: Reputation Reactive Behaviour
...
return function(A)
	...
	local S = {}
	S.id = "K.0622"
	S.key = "arkher.npc.reputation.reactive_behaviour"
	S.name = "Reputation Reactive Behaviour"
	S.category = "K"
	...
	S.kit = "behaviortree"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.reputation.perception" }
	S.tags = { "k", "reputation", "behaviortree", "npc" }
	S.description = "Reputation Reactive Behaviour: sequences, selectors, decorators and cooldowns for the Reputation subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 240,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("behaviortree", { id = "arkher.npc.reputation.reactive_behaviour" })
		inst.system = S
		inst.ctx = ctx
