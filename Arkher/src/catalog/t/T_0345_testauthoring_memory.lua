-- ARKHER SYSTEM T.0345 :: Test Authoring Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0345"
	S.key = "arkher.ai.testauthoring.working_memory"
	S.name = "Test Authoring Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.testauthoring.outcome_prediction" }
	S.tags = { "t", "testauthoring", "memory", "ai" }
	S.description = "Test Authoring Working Memory: decaying, consolidating recall of what the agent learned for the Test Authoring subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.testauthoring.working_memory", capacity = 91, decayRate = 0.055, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
