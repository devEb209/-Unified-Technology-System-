-- ARKHER SYSTEM V.0218 :: Script Asset Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0218"
	S.key = "arkher.asset.scriptasset.bundling"
	S.name = "Script Asset Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.scriptasset.import" }
	S.tags = { "v", "scriptasset", "bundler", "asset" }
	S.description = "Script Asset Bundling: size-bounded packing, manifests and delta patches for the Script Asset subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.scriptasset.bundling", maxBundleBytes = 524288 })
		inst.system = S
		inst.ctx = ctx
