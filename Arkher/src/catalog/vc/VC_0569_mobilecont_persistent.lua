-- ARKHER SYSTEM VC.0569 :: Mobile Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0569"
	S.key = "arkher.contneural.mobilecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.mobilecont.multi-scale_fidelity" }
	S.tags = { "vc", "mobilecont", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.mobilecont.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
