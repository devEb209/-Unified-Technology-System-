-- ARKHER SYSTEM T.0089 :: Semantic Search World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0089"
	S.key = "arkher.ai.semanticsearch.world_architect"
	S.name = "Semantic Search World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.semanticsearch.self_critique" }
	S.tags = { "t", "semanticsearch", "architect", "ai" }
	S.description = "Semantic Search World Architect: composition of a whole world plan with conserved budgets for the Semantic Search subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 200,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.semanticsearch.world_architect", budget = 900, seed = 48253 })
		inst.system = S
		inst.ctx = ctx
