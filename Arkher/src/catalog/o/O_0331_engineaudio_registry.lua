-- ARKHER SYSTEM O.0331 :: Engine Audio Asset Registry
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0331"
	S.key = "arkher.audio.engineaudio.asset_registry"
	S.name = "Engine Audio Asset Registry"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Engine Audio"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.engineaudio.streaming" }
	S.tags = { "o", "engineaudio", "registry", "audio" }
	S.description = "Engine Audio Asset Registry: catalogue of sounds, variations and metadata for the Engine Audio subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.audio.engineaudio.asset_registry" })
		inst.system = S
		inst.ctx = ctx
