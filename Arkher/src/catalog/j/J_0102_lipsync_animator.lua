-- ARKHER SYSTEM J.0102 :: Lip Sync Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0102"
	S.key = "arkher.character.lipsync.blend_controller"
	S.name = "Lip Sync Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.lipsync.motion_set" }
	S.tags = { "j", "lipsync", "animator", "character" }
	S.description = "Lip Sync Blend Controller: layered playback driving the character for the Lip Sync subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.lipsync.blend_controller", budget = 5 })
		inst.system = S
		inst.ctx = ctx
