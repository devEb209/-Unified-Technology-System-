-- ARKHER SYSTEM VB.0478 :: VFX Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VB.0478"
	S.key = "arkher.conttime.vfxcont.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.vfxcont.complexity_budget" }
	S.tags = { "vb", "vfxcont", "fabric", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.conttime.vfxcont.simulation_fabric", budgetMs = 4.0, starvationLimit = 11 })
		inst.system = S
		inst.ctx = ctx
