-- ARKHER SYSTEM VA.0057 :: Epoch Frame Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0057"
	S.key = "arkher.contworld.epochframe.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.epochframe.world_memory_stream" }
	S.tags = { "va", "epochframe", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.epochframe.complexity_budget", targetMs = 17.0 })
		inst.system = S
		inst.ctx = ctx
