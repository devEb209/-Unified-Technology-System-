-- ARKHER SYSTEM Z.0937 :: Universal Interop Layer Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0937"
	S.key = "arkher.origin.interop.behaviour_analysis"
	S.name = "Universal Interop Layer Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.interop.governance_policy" }
	S.tags = { "z", "interop", "analyzer", "origin" }
	S.description = "Universal Interop Layer Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Universal Interop Layer subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.interop.behaviour_analysis", window = 142, buckets = 14, threshold = 4.40 })
		inst.system = S
		inst.ctx = ctx
