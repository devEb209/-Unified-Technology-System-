-- ARKHER SYSTEM G.0382 :: Deterministic Seeding Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0382"
	S.key = "arkher.neural.detseed.reconstruction"
	S.name = "Deterministic Seeding Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.detseed.temporal_history" }
	S.tags = { "g", "detseed", "upscaler", "neural" }
	S.description = "Deterministic Seeding Reconstruction: resolution ladder and image reconstruction for the Deterministic Seeding subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.detseed.reconstruction", targetMs = 14.10, index = 3, sharpness = 0.39 })
		inst.system = S
		inst.ctx = ctx
