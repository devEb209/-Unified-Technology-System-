-- ARKHER SYSTEM H.0572 :: Soft Body Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0572"
	S.key = "arkher.physics.softbody.analysis"
	S.name = "Soft Body Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Soft Body"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.softbody.result_cache" }
	S.tags = { "h", "softbody", "analyzer", "physics" }
	S.description = "Soft Body Analysis: energy, jitter and cost analysis of the simulation for the Soft Body subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.softbody.analysis", window = 139, buckets = 11, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
