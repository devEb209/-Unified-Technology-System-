...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Rokoko — ANIMATION Stack #0265", size=Vector2.new(640, 420), pos=UDim2.fromOffset(345, 165), parent=parent, icon="◐"})
