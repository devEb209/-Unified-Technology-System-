-- ARKHER SYSTEM Q.0341 :: Safe Area Navigation Graph
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0341"
	S.key = "arkher.ui.safearea.navigation_graph"
	S.name = "Safe Area Navigation Graph"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Safe Area"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.safearea.transition" }
	S.tags = { "q", "safearea", "graph", "ui" }
	S.description = "Safe Area Navigation Graph: screens, routes and shortest path between them for the Safe Area subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ui.safearea.navigation_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
