-- ARKHER SYSTEM O.0028 :: Weapon Sound Music Sequencer
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0028"
	S.key = "arkher.audio.weaponsound.music_sequencer"
	S.name = "Weapon Sound Music Sequencer"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Weapon Sound"
	...
	S.kit = "sequencer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.weaponsound.spatialization" }
	S.tags = { "o", "weaponsound", "sequencer", "audio" }
	S.description = "Weapon Sound Music Sequencer: musical time, sections, stems, cues and quantized transitions for the Weapon Sound subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sequencer", { id = "arkher.audio.weaponsound.music_sequencer", bpm = 130, beatsPerBar = 4, intensity = 0.58 })
		inst.system = S
		inst.ctx = ctx
