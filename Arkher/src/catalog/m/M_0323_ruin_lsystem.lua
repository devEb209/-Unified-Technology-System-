-- ARKHER SYSTEM M.0323 :: Ruin Grammar
...
return function(A)
	...
	local S = {}
	S.id = "M.0323"
	S.key = "arkher.proc.ruin.grammar"
	S.name = "Ruin Grammar"
	S.category = "M"
	S.family = "PROCEDURAL"
	S.area = "Ruin"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "m", "ruin", "lsystem", "proc" }
	S.description = "Ruin Grammar: rewriting grammar interpreted into geometry for the Ruin subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lsystem", { id = "arkher.proc.ruin.grammar", axiom = "F", angle = 33, step = 7.0 })
		inst.system = S
		inst.ctx = ctx
