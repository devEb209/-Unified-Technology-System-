-- ARKHER SYSTEM K.0506 :: Flee Behaviour Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0506"
	S.key = "arkher.npc.fleebehaviour.memory"
	S.name = "Flee Behaviour Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.fleebehaviour.mind_network" }
	S.tags = { "k", "fleebehaviour", "memory", "npc" }
	S.description = "Flee Behaviour Memory: episodic memory with decay, recall and consolidation for the Flee Behaviour subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.fleebehaviour.memory", capacity = 67, decayRate = 0.035, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
