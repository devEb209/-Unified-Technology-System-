-- ARKHER SYSTEM VB.0351 :: Narrative Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0351"
	S.key = "arkher.conttime.narrativecont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.narrativecont.epoch_clock" }
	S.tags = { "vb", "narrativecont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.narrativecont.sparse_residency", capacity = 384, pageBytes = 4096 })
		inst.system = S
		inst.ctx = ctx
