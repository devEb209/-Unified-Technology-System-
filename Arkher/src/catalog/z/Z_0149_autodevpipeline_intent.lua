-- ARKHER SYSTEM Z.0149 :: Autonomous Development Pipeline Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0149"
	S.key = "arkher.origin.autodevpipeline.intent_bridge"
	S.name = "Autonomous Development Pipeline Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodevpipeline.semantic_graph" }
	S.tags = { "z", "autodevpipeline", "intent", "origin" }
	S.description = "Autonomous Development Pipeline Intent Bridge: natural language control surface for the technology for the Autonomous Development Pipeline subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.autodevpipeline.intent_bridge", minConfidence = 0.36 })
		inst.system = S
		inst.ctx = ctx
