-- ARKHER SYSTEM R.0329 :: Matchmaking Transport Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0329"
	S.key = "arkher.net.matchmakingtransport.bandwidth_budget"
	S.name = "Matchmaking Transport Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.matchmakingtransport.transport_graph" }
	S.tags = { "r", "matchmakingtransport", "budgeter", "net" }
	S.description = "Matchmaking Transport Bandwidth Budget: bytes per second shared between competing streams for the Matchmaking Transport subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.matchmakingtransport.bandwidth_budget", total = 368, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
