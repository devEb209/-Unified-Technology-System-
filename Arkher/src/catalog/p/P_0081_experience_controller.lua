-- ARKHER SYSTEM P.0081 :: Experience Difficulty Controller
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0081"
	S.key = "arkher.play.experience.difficulty_controller"
	S.name = "Experience Difficulty Controller"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Experience"
	...
	S.kit = "controller"
	S.version = "1.0.0"
	S.deps = { "arkher.play.experience.balance_analysis" }
	S.tags = { "p", "experience", "controller", "play" }
	S.description = "Experience Difficulty Controller: closed-loop tuning toward a target challenge for the Experience subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("controller", { id = "arkher.play.experience.difficulty_controller", mode = "pid", target = 0.540, kp = 0.390, ki = 0.040, kd = 0.050, min = 0.05, max = 1.0, initial = 0.44, deadband = 0.01 })
		inst.system = S
		inst.ctx = ctx
