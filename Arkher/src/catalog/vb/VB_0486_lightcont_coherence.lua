-- ARKHER SYSTEM VB.0486 :: Lighting Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0486"
	S.key = "arkher.conttime.lightcont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.lightcont.persistent_state" }
	S.tags = { "vb", "lightcont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.lightcont.coherence_guard", window = 129, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
