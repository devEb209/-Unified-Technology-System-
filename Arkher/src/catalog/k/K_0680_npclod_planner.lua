-- ARKHER SYSTEM K.0680 :: NPC LOD Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0680"
	S.key = "arkher.npc.npclod.goal_planner"
	S.name = "NPC LOD Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.npclod.utility_reasoning" }
	S.tags = { "k", "npclod", "planner", "npc" }
	S.description = "NPC LOD Goal Planner: backward GOAP planning to reach a goal state for the NPC LOD subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.npclod.goal_planner", maxDepth = 9 })
		inst.system = S
		inst.ctx = ctx
