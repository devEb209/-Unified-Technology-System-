-- ARKHER SYSTEM W.0338 :: Camera Shake Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0338"
	S.key = "arkher.cine.camerashake.camera_rig"
	S.name = "Camera Shake Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Camera Shake"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.camerashake.sequence_timeline" }
	S.tags = { "w", "camerashake", "camerarig", "cine" }
	S.description = "Camera Shake Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.camerashake.camera_rig", fov = 1.00, focus = 18.0, aperture = 6.4, smoothing = 8.0, distance = 20, height = 6 })
		inst.system = S
		inst.ctx = ctx
