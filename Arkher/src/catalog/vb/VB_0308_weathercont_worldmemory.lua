-- ARKHER SYSTEM VB.0308 :: Weather Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0308"
	S.key = "arkher.conttime.weathercont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.weathercont.neural_field" }
	S.tags = { "vb", "weathercont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.weathercont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
