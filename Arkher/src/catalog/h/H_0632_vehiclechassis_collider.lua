-- ARKHER SYSTEM H.0632 :: Vehicle Chassis Collision Shape
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0632"
	S.key = "arkher.physics.vehiclechassis.collision_shape"
	S.name = "Vehicle Chassis Collision Shape"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "collider"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.vehiclechassis.body_dynamics" }
	S.tags = { "h", "vehiclechassis", "collider", "physics" }
	S.description = "Vehicle Chassis Collision Shape: shape bounds, support mapping and closest points for the Vehicle Chassis subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("collider", { id = "arkher.physics.vehiclechassis.collision_shape", shape = "box", radius = 2.30, height = 1.90, layer = "vehicle" })
		inst.system = S
		inst.ctx = ctx
