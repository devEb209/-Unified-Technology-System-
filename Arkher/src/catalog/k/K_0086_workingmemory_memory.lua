-- ARKHER SYSTEM K.0086 :: Working Memory Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0086"
	S.key = "arkher.npc.workingmemory.memory"
	S.name = "Working Memory Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.workingmemory.mind_network" }
	S.tags = { "k", "workingmemory", "memory", "npc" }
	S.description = "Working Memory Memory: episodic memory with decay, recall and consolidation for the Working Memory subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.workingmemory.memory", capacity = 79, decayRate = 0.035, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
