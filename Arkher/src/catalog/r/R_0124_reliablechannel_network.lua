-- ARKHER SYSTEM R.0124 :: Reliable Channel Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0124"
	S.key = "arkher.net.reliablechannel.transport_graph"
	S.name = "Reliable Channel Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reliablechannel.prediction_and_reconciliation" }
	S.tags = { "r", "reliablechannel", "network", "net" }
	S.description = "Reliable Channel Transport Graph: topology, capacity and routing between endpoints for the Reliable Channel subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.reliablechannel.transport_graph" })
		inst.system = S
		inst.ctx = ctx
