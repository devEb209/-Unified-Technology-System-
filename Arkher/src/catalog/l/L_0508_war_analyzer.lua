-- ARKHER SYSTEM L.0508 :: War Analysis
...
return function(A)
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.war.aggregate_cache" }
	S.tags = { "l", "war", "analyzer", "sim" }
	S.description = "War Analysis: trend, anomaly and stability analysis of the world for the War subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.war.analysis", window = 215, buckets = 15, threshold = 2.70 })
		inst.system = S
		inst.ctx = ctx
