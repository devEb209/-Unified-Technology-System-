-- ARKHER SYSTEM Q.0304 :: Haptics Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0304"
	S.key = "arkher.ui.haptics.transition"
	S.name = "Haptics Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Haptics"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.haptics.input_mapping" }
	S.tags = { "q", "haptics", "tween", "ui" }
	S.description = "Haptics Transition: eased, delayed, looped and sequenced motion for the Haptics subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.haptics.transition", timeScale = 0.98 })
		inst.system = S
		inst.ctx = ctx
