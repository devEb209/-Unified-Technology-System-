-- ARKHER SYSTEM E.0049 :: Roughness Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0049"
	S.key = "arkher.material.roughness.texture_sampling"
	S.name = "Roughness Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Roughness"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.roughness.shading_graph" }
	S.tags = { "e", "roughness", "sampler", "material" }
	S.description = "Roughness Texture Sampling: atlas packing, mip chain and filtered sampling for the Roughness subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 440,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.roughness.texture_sampling", atlasSize = 320, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
