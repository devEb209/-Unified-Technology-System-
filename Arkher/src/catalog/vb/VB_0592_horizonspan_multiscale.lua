-- ARKHER SYSTEM VB.0592 :: Horizon Span Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VB.0592"
	S.key = "arkher.conttime.horizonspan.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.horizonspan.sparse_residency" }
	S.tags = { "vb", "horizonspan", "multiscale", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.conttime.horizonspan.multi-scale_fidelity", levels = 6, baseTriangles = 150000 })
		inst.system = S
		inst.ctx = ctx
