-- ARKHER SYSTEM VD.0223 :: Terrain Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0223"
	S.key = "arkher.contsim.terraincont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.terraincont.coherence_guard" }
	S.tags = { "vd", "terraincont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.terraincont.neural_field", dims = 12, hidden = 8, seed = 66368 })
		inst.system = S
		inst.ctx = ctx
