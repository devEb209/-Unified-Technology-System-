-- ARKHER SYSTEM T.0477 :: Simulation Reasoning Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0477"
	S.key = "arkher.ai.simulationreasoning.intent_understanding"
	S.name = "Simulation Reasoning Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "simulationreasoning", "intent", "ai" }
	S.description = "Simulation Reasoning Intent Understanding: natural language turned into an actionable, scored intent for the Simulation Reasoning subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.simulationreasoning.intent_understanding", minConfidence = 0.43 })
		inst.system = S
		inst.ctx = ctx
