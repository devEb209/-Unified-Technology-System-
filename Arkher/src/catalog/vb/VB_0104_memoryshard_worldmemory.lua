-- ARKHER SYSTEM VB.0104 :: Memory Shard World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0104"
	S.key = "arkher.conttime.memoryshard.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.memoryshard.neural_field" }
	S.tags = { "vb", "memoryshard", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.memoryshard.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
