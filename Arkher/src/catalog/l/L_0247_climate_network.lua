-- ARKHER SYSTEM L.0247 :: Climate Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0247"
	S.key = "arkher.sim.climate.route_network"
	S.name = "Climate Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.climate.region_graph" }
	S.tags = { "l", "climate", "network", "sim" }
	S.description = "Climate Route Network: roads, rivers and routes between settlements for the Climate subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.climate.route_network" })
		inst.system = S
		inst.ctx = ctx
