-- ARKHER SYSTEM J.0156 :: Gesture Motion Set
...
return function(A)
	...
	local S = {}
	S.id = "J.0156"
	S.key = "arkher.character.gesture.motion_set"
	S.name = "Gesture Motion Set"
	S.category = "J"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.character.gesture.rig_definition" }
	S.tags = { "j", "gesture", "clip", "character" }
	S.description = "Gesture Motion Set: the clips a character owns and how they sample for the Gesture subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.character.gesture.motion_set", duration = 2.80, loop = true })
		inst.system = S
		inst.ctx = ctx
