-- ARKHER SYSTEM Z.1028 :: Autonomous Balancing Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.1028"
	S.key = "arkher.origin.autobalancing.semantic_graph"
	S.name = "Autonomous Balancing Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autobalancing.world_architect" }
	S.tags = { "z", "autobalancing", "knowledge", "origin" }
	S.description = "Autonomous Balancing Semantic Graph: typed entities and inferred relations of the technology itself for the Autonomous Balancing subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.autobalancing.semantic_graph", dims = 40 })
		inst.system = S
		inst.ctx = ctx
