-- ARKHER SYSTEM R.0235 :: Interest Management Interest Streaming
...
return function(A)
	...
	local S = {}
	S.id = "R.0235"
	S.key = "arkher.net.interestmanagement.interest_streaming"
	S.name = "Interest Management Interest Streaming"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.interestmanagement.serialization_codec" }
	S.tags = { "r", "interestmanagement", "streamer", "net" }
	S.description = "Interest Management Interest Streaming: distance-driven residency of replicated content for the Interest Management subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 480,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.net.interestmanagement.interest_streaming", radius = 480, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
