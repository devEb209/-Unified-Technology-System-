-- ARKHER SYSTEM VB.0356 :: Narrative Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0356"
	S.key = "arkher.conttime.narrativecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.narrativecont.neural_field" }
	S.tags = { "vb", "narrativecont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.narrativecont.world_memory_stream", capacity = 96 })
		inst.system = S
		inst.ctx = ctx
