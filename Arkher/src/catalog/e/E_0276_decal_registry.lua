-- ARKHER SYSTEM E.0276 :: Decal Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0276"
	S.key = "arkher.material.decal.variant_registry"
	S.name = "Decal Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Decal"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.decal.procedural_detail" }
	S.tags = { "e", "decal", "registry", "material" }
	S.description = "Decal Variant Registry: named variants and their lifecycle for the Decal subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.decal.variant_registry" })
		inst.system = S
		inst.ctx = ctx
