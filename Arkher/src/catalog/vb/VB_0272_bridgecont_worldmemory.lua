-- ARKHER SYSTEM VB.0272 :: Bridge Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0272"
	S.key = "arkher.conttime.bridgecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.bridgecont.neural_field" }
	S.tags = { "vb", "bridgecont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.bridgecont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
