-- ARKHER SYSTEM K.0290 :: Scent Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0290"
	S.key = "arkher.npc.scent.crowd_steering"
	S.name = "Scent Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.scent.navigation" }
	S.tags = { "k", "scent", "crowd", "npc" }
	S.description = "Scent Crowd Steering: local avoidance, cohesion and arrival at scale for the Scent subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.scent.crowd_steering", radius = 0.85, maxSpeed = 5.90, cellSize = 11 })
		inst.system = S
		inst.ctx = ctx
