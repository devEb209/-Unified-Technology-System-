-- ARKHER SYSTEM K.0325 :: Curiosity Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0325"
	S.key = "arkher.npc.curiosity.drive_system"
	S.name = "Curiosity Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.curiosity.memory" }
	S.tags = { "k", "curiosity", "need", "npc" }
	S.description = "Curiosity Drive System: drives that decay, turn urgent and get satisfied for the Curiosity subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.curiosity.drive_system" })
		inst.system = S
		inst.ctx = ctx
