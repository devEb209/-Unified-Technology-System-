-- ARKHER SYSTEM G.0186 :: Light Transport Prediction Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0186"
	S.key = "arkher.neural.lightpredict.reconstruction"
	S.name = "Light Transport Prediction Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.lightpredict.temporal_history" }
	S.tags = { "g", "lightpredict", "upscaler", "neural" }
	S.description = "Light Transport Prediction Reconstruction: resolution ladder and image reconstruction for the Light Transport Prediction subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.lightpredict.reconstruction", targetMs = 12.10, index = 4, sharpness = 0.57 })
		inst.system = S
		inst.ctx = ctx
