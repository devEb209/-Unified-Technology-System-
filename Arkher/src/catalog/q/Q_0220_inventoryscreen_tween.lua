-- ARKHER SYSTEM Q.0220 :: Inventory Screen Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0220"
	S.key = "arkher.ui.inventoryscreen.transition"
	S.name = "Inventory Screen Transition"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.inventoryscreen.input_mapping" }
	S.tags = { "q", "inventoryscreen", "tween", "ui" }
	S.description = "Inventory Screen Transition: eased, delayed, looped and sequenced motion for the Inventory Screen subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 200,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.inventoryscreen.transition", timeScale = 1.11 })
		inst.system = S
		inst.ctx = ctx
