-- ARKHER SYSTEM VD.0024 :: Region Tile Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0024"
	S.key = "arkher.contsim.regiontile.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.regiontile.reality_continuum" }
	S.tags = { "vd", "regiontile", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.regiontile.emergence_continuum", windowSize = 4, threshold = 1.60, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
