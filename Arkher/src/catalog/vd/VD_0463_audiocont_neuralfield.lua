-- ARKHER SYSTEM VD.0463 :: Audio Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0463"
	S.key = "arkher.contsim.audiocont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.audiocont.coherence_guard" }
	S.tags = { "vd", "audiocont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.audiocont.neural_field", dims = 12, hidden = 8, seed = 94476 })
		inst.system = S
		inst.ctx = ctx
