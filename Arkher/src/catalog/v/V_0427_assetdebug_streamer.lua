-- ARKHER SYSTEM V.0427 :: Asset Debug Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0427"
	S.key = "arkher.asset.assetdebug.streaming_residency"
	S.name = "Asset Debug Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetdebug.content_cache" }
	S.tags = { "v", "assetdebug", "streamer", "asset" }
	S.description = "Asset Debug Streaming Residency: distance-driven load and unload of asset payloads for the Asset Debug subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.assetdebug.streaming_residency", radius = 560, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
