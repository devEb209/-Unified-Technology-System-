-- ARKHER SYSTEM Q.0379 :: Localization Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0379"
	S.key = "arkher.ui.localization.localization_registry"
	S.name = "Localization Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Localization"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.localization.theme_composition" }
	S.tags = { "q", "localization", "registry", "ui" }
	S.description = "Localization Localization Registry: catalogue of strings, plurals and locale metadata for the Localization subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.localization.localization_registry" })
		inst.system = S
		inst.ctx = ctx
