-- ARKHER SYSTEM F.0509 :: Mesh LOD Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0509"
	S.key = "arkher.render.meshlod.lighting_rig"
	S.name = "Mesh LOD Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Mesh LOD"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.meshlod.geometry_virtualization" }
	S.tags = { "f", "meshlod", "lightrig", "render" }
	S.description = "Mesh LOD Lighting Rig: light clustering, importance and cascades for the Mesh LOD subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.meshlod.lighting_rig", maxActive = 12 })
		inst.system = S
		inst.ctx = ctx
