-- ARKHER SYSTEM P.0063 :: Progression Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0063"
	S.key = "arkher.play.progression.objectives"
	S.name = "Progression Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Progression"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.progression.inventory" }
	S.tags = { "p", "progression", "quest", "play" }
	S.description = "Progression Objectives: objectives, prerequisites, progress and rewards for the Progression subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.progression.objectives" })
		inst.system = S
		inst.ctx = ctx
