-- ARKHER SYSTEM VD.0347 :: Society Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0347"
	S.key = "arkher.contsim.societycont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.societycont.simulation_fabric" }
	S.tags = { "vd", "societycont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.societycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
