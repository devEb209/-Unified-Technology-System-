-- ARKHER SYSTEM G.0314 :: Weight Quantization Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0314"
	S.key = "arkher.neural.quantization.weight_codec"
	S.name = "Weight Quantization Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.quantization.model_registry" }
	S.tags = { "g", "quantization", "codec", "neural" }
	S.description = "Weight Quantization Weight Codec: weight serialization and quantized transport for the Weight Quantization subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 160,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.quantization.weight_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
