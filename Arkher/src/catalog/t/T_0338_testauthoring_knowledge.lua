-- ARKHER SYSTEM T.0338 :: Test Authoring Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0338"
	S.key = "arkher.ai.testauthoring.semantic_knowledge"
	S.name = "Test Authoring Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.testauthoring.intent_understanding" }
	S.tags = { "t", "testauthoring", "knowledge", "ai" }
	S.description = "Test Authoring Semantic Knowledge: typed entities, weighted relations and inferred closure for the Test Authoring subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.testauthoring.semantic_knowledge", dims = 48 })
		inst.system = S
		inst.ctx = ctx
