-- ARKHER SYSTEM VC.0483 :: Lighting Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VC.0483"
	S.key = "arkher.contneural.lightcont.sparse_residency"
	S.name = "Lighting Continuum Sparse Residency"
	S.category = "VC"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lightcont.epoch_clock" }
	S.tags = { "vc", "lightcont", "sparse", "contneural" }
	S.description = "Lighting Continuum Sparse Residency: sparse page residency with eviction and compression for the Lighting Continuum subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contneural.lightcont.sparse_residency", capacity = 256, pageBytes = 3072 })
		inst.system = S
		inst.ctx = ctx
