--!strict
-- Cascadeur — ANIMATION Mixer #0117
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Cascadeur — ANIMATION Mixer #0117", size=Vector2.new(600, 460), pos=UDim2.fromOffset(421, 249), parent=parent, icon="☀"})
