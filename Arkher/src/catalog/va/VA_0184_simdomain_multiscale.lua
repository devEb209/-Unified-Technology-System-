-- ARKHER SYSTEM VA.0184 :: Simulation Domain Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VA.0184"
	S.key = "arkher.contworld.simdomain.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.simdomain.sparse_residency" }
	S.tags = { "va", "simdomain", "multiscale", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contworld.simdomain.multi-scale_fidelity", levels = 6, baseTriangles = 120000 })
		inst.system = S
		inst.ctx = ctx
