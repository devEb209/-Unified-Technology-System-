-- ARKHER SYSTEM VA.0606 :: Seam Lattice Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VA.0606"
	S.key = "arkher.contworld.seamlattice.coherence_guard"
	S.name = "Seam Lattice Coherence Guard"
	S.category = "VA"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.seamlattice.persistent_state" }
	S.tags = { "va", "seamlattice", "coherence", "contworld" }
	S.description = "Seam Lattice Coherence Guard: seam coherence and drift supervision for the Seam Lattice subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contworld.seamlattice.coherence_guard", window = 140, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
