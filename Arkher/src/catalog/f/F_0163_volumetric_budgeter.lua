-- ARKHER SYSTEM F.0163 :: Volumetric Light Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0163"
	S.key = "arkher.render.volumetric.draw_budget"
	S.name = "Volumetric Light Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.volumetric.adaptive_resolution" }
	S.tags = { "f", "volumetric", "budgeter", "render" }
	S.description = "Volumetric Light Draw Budget: draw call and triangle budget allocation for the Volumetric Light subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.volumetric.draw_budget", total = 164, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
