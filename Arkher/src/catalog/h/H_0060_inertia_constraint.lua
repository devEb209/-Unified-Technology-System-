-- ARKHER SYSTEM H.0060 :: Inertia Tensor Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0060"
	S.key = "arkher.physics.inertia.constraint_solver"
	S.name = "Inertia Tensor Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.inertia.contact_generation" }
	S.tags = { "h", "inertia", "constraint", "physics" }
	S.description = "Inertia Tensor Constraint Solver: sequential impulses, friction, joints and warm starting for the Inertia Tensor subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.inertia.constraint_solver", iterations = 7, baumgarte = 0.13, warmStart = true })
		inst.system = S
		inst.ctx = ctx
