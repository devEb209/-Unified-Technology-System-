-- ARKHER SYSTEM E.0341 :: Rust Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0341"
	S.key = "arkher.material.rust.instance_cache"
	S.name = "Rust Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Rust"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.rust.quality_policy" }
	S.tags = { "e", "rust", "cache", "material" }
	S.description = "Rust Instance Cache: resolved-parameter cache keyed by context for the Rust subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.rust.instance_cache", policy = "ttl", capacity = 160, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
