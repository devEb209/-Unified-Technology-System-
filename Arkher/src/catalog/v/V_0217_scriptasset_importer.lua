-- ARKHER SYSTEM V.0217 :: Script Asset Import
...
return function(A)
	...
	local S = {}
	S.id = "V.0217"
	S.key = "arkher.asset.scriptasset.import"
	S.name = "Script Asset Import"
	S.category = "V"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "v", "scriptasset", "importer", "asset" }
	S.description = "Script Asset Import: validation, normalization, hashing and deduplication of incoming content for the Script Asset subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("importer", { id = "arkher.asset.scriptasset.import", unitScale = 1.00 })
		inst.system = S
		inst.ctx = ctx
