-- ARKHER SYSTEM T.0499 :: Physics Reasoning Working Memory
...
return function(A)
	...
	local S = {}
	S.id = "T.0499"
	S.key = "arkher.ai.physicsreasoning.working_memory"
	S.name = "Physics Reasoning Working Memory"
	S.category = "T"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.physicsreasoning.outcome_prediction" }
	S.tags = { "t", "physicsreasoning", "memory", "ai" }
	S.description = "Physics Reasoning Working Memory: decaying, consolidating recall of what the agent learned for the Physics Reasoning subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.ai.physicsreasoning.working_memory", capacity = 83, decayRate = 0.025, consolidateAt = 5 })
		inst.system = S
		inst.ctx = ctx
