-- ARKHER SYSTEM VB.0403 :: Perception Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0403"
	S.key = "arkher.conttime.perceptioncont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.perceptioncont.coherence_guard" }
	S.tags = { "vb", "perceptioncont", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.perceptioncont.neural_field", dims = 24, hidden = 20, seed = 11175 })
		inst.system = S
		inst.ctx = ctx
