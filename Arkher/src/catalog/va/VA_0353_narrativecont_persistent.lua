-- ARKHER SYSTEM VA.0353 :: Narrative Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0353"
	S.key = "arkher.contworld.narrativecont.persistent_state"
	S.name = "Narrative Continuum Persistent State"
	S.category = "VA"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.narrativecont.multi-scale_fidelity" }
	S.tags = { "va", "narrativecont", "persistent", "contworld" }
	S.description = "Narrative Continuum Persistent State: epoch-stamped persistent history and rollback for the Narrative Continuum subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.narrativecont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
