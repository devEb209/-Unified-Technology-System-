-- ARKHER SYSTEM N.0329 :: Ribbon Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0329"
	S.key = "arkher.vfx.ribbonfx.ribbon_and_trail"
	S.name = "Ribbon Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Ribbon"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.ribbonfx.force_field" }
	S.tags = { "n", "ribbonfx", "ribbon", "vfx" }
	S.description = "Ribbon Ribbon And Trail: trail points, tapering, beams and decimation for the Ribbon subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.ribbonfx.ribbon_and_trail", maxPoints = 40, lifetime = 1.40, minDistance = 0.55, width = 1.10 })
		inst.system = S
		inst.ctx = ctx
