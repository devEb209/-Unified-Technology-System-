-- ARKHER SYSTEM Z.0183 :: World Memory Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0183"
	S.key = "arkher.origin.worldmemorytech.simulation_fabric"
	S.name = "World Memory Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldmemorytech.complexity_governance" }
	S.tags = { "z", "worldmemorytech", "fabric", "origin" }
	S.description = "World Memory Simulation Fabric: every simulation domain stepped under one budgeted clock for the World Memory subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.worldmemorytech.simulation_fabric", budgetMs = 2.5, starvationLimit = 8 })
		inst.system = S
		inst.ctx = ctx
