-- ARKHER SYSTEM R.0112 :: Remote Function Transport Graph
...
return function(A)
	...
	local S = {}
	S.id = "R.0112"
	S.key = "arkher.net.remotefunction.transport_graph"
	S.name = "Remote Function Transport Graph"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.net.remotefunction.prediction_and_reconciliation" }
	S.tags = { "r", "remotefunction", "network", "net" }
	S.description = "Remote Function Transport Graph: topology, capacity and routing between endpoints for the Remote Function subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.net.remotefunction.transport_graph" })
		inst.system = S
		inst.ctx = ctx
