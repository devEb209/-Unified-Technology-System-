-- ARKHER SYSTEM Z.0379 :: Mobile First Governor Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0379"
	S.key = "arkher.origin.mobilefirst.residency_streaming"
	S.name = "Mobile First Governor Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.mobilefirst.budget_governor" }
	S.tags = { "z", "mobilefirst", "streamer", "origin" }
	S.description = "Mobile First Governor Residency Streaming: distance-driven residency of the technology's workload for the Mobile First Governor subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 160,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.mobilefirst.residency_streaming", radius = 160, chunkSize = 32, maxPerFrame = 1 })
		inst.system = S
		inst.ctx = ctx
