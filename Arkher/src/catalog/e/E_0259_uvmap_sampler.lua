-- ARKHER SYSTEM E.0259 :: UV Mapping Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0259"
	S.key = "arkher.material.uvmap.texture_sampling"
	S.name = "UV Mapping Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "UV Mapping"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.uvmap.shading_graph" }
	S.tags = { "e", "uvmap", "sampler", "material" }
	S.description = "UV Mapping Texture Sampling: atlas packing, mip chain and filtered sampling for the UV Mapping subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.uvmap.texture_sampling", atlasSize = 128, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
