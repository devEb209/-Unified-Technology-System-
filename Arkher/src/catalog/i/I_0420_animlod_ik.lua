-- ARKHER SYSTEM I.0420 :: Animation LOD Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0420"
	S.key = "arkher.anim.animlod.inverse_kinematics"
	S.name = "Animation LOD Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.animlod.layered_blending" }
	S.tags = { "i", "animlod", "ik", "anim" }
	S.description = "Animation LOD Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Animation LOD subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.animlod.inverse_kinematics", iterations = 13, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
