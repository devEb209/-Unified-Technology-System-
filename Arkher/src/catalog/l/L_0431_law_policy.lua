-- ARKHER SYSTEM L.0431 :: Law Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0431"
	S.key = "arkher.sim.law.fidelity_policy"
	S.name = "Law Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.law.streaming" }
	S.tags = { "l", "law", "policy", "sim" }
	S.description = "Law Fidelity Policy: rules that pick full, cohort or statistical simulation for the Law subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.law.fidelity_policy", algorithm = "lottery", starvationGuard = 39 })
		inst.system = S
		inst.ctx = ctx
