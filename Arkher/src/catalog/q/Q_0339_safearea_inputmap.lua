-- ARKHER SYSTEM Q.0339 :: Safe Area Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0339"
	S.key = "arkher.ui.safearea.input_mapping"
	S.name = "Safe Area Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Safe Area"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.safearea.widget_tree" }
	S.tags = { "q", "safearea", "inputmap", "ui" }
	S.description = "Safe Area Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Safe Area subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.safearea.input_mapping", device = "gamepad", holdTime = 0.26, deadzone = 0.11 })
		inst.system = S
		inst.ctx = ctx
