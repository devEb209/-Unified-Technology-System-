-- ARKHER SYSTEM K.0248 :: Temperament Crowd Steering
...
return function(A)
	...
	local S = {}
	S.id = "K.0248"
	S.key = "arkher.npc.temperament.crowd_steering"
	S.name = "Temperament Crowd Steering"
	S.category = "K"
	...
	S.kit = "crowd"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.temperament.navigation" }
	S.tags = { "k", "temperament", "crowd", "npc" }
	S.description = "Temperament Crowd Steering: local avoidance, cohesion and arrival at scale for the Temperament subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("crowd", { id = "arkher.npc.temperament.crowd_steering", radius = 0.45, maxSpeed = 4.10, cellSize = 11 })
		inst.system = S
		inst.ctx = ctx
