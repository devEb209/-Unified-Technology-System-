-- ARKHER SYSTEM P.0448 :: Difficulty Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0448"
	S.key = "arkher.play.difficulty.combat_resolution"
	S.name = "Difficulty Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Difficulty"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.difficulty.objectives" }
	S.tags = { "p", "difficulty", "combat", "play" }
	S.description = "Difficulty Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Difficulty subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.difficulty.combat_resolution", seed = 5362, armourK = 100, critMultiplier = 2.50 })
		inst.system = S
		inst.ctx = ctx
