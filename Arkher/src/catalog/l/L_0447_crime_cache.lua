-- ARKHER SYSTEM L.0447 :: Crime Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0447"
	S.key = "arkher.sim.crime.aggregate_cache"
	S.name = "Crime Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.crime.fidelity_policy" }
	S.tags = { "l", "crime", "cache", "sim" }
	S.description = "Crime Aggregate Cache: reuse of expensive aggregate computations for the Crime subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.crime.aggregate_cache", policy = "lfu", capacity = 428, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
