-- ARKHER SYSTEM F.0628 :: Render Target Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0628"
	S.key = "arkher.render.rendertarget.frame_analysis"
	S.name = "Render Target Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.rendertarget.pass_cache" }
	S.tags = { "f", "rendertarget", "analyzer", "render" }
	S.description = "Render Target Frame Analysis: per-pass cost analysis and outlier detection for the Render Target subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.rendertarget.frame_analysis", window = 194, buckets = 18, threshold = 3.60 })
		inst.system = S
		inst.ctx = ctx
