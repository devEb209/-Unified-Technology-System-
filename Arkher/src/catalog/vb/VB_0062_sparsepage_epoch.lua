-- ARKHER SYSTEM VB.0062 :: Sparse Page Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0062"
	S.key = "arkher.conttime.sparsepage.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.sparsepage.infinite_grid" }
	S.tags = { "vb", "sparsepage", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.sparsepage.epoch_clock", tickRate = 40, budget = 7, capacity = 160 })
		inst.system = S
		inst.ctx = ctx
