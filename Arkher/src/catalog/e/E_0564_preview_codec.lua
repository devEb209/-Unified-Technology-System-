-- ARKHER SYSTEM E.0564 :: Material Preview Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "E.0564"
	S.key = "arkher.material.preview.compression_codec"
	S.name = "Material Preview Compression Codec"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.material.preview.streaming" }
	S.tags = { "e", "preview", "codec", "material" }
	S.description = "Material Preview Compression Codec: serialization and compression of material data for the Material Preview subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.material.preview.compression_codec", format = "binary", quantBits = 12 })
		inst.system = S
		inst.ctx = ctx
