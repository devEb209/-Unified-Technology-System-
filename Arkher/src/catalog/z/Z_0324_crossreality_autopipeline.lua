-- ARKHER SYSTEM Z.0324 :: Cross Reality Sync Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0324"
	S.key = "arkher.origin.crossreality.autonomous_pipeline"
	S.name = "Cross Reality Sync Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.simulation_fabric" }
	S.tags = { "z", "crossreality", "autopipeline", "origin" }
	S.description = "Cross Reality Sync Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 160,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.crossreality.autonomous_pipeline", maxIterations = 4 })
		inst.system = S
		inst.ctx = ctx
