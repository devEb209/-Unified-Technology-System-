-- ARKHER SYSTEM E.0520 :: Parameter Animation Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "E.0520"
	S.key = "arkher.material.paramanim.quality_policy"
	S.name = "Parameter Animation Quality Policy"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.material.paramanim.compression_codec" }
	S.tags = { "e", "paramanim", "policy", "material" }
	S.description = "Parameter Animation Quality Policy: device tier rules for the surface for the Parameter Animation subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.material.paramanim.quality_policy", algorithm = "edf", starvationGuard = 37 })
		inst.system = S
		inst.ctx = ctx
