-- ARKHER SYSTEM F.0563 :: UI Rendering Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0563"
	S.key = "arkher.render.uirender.visibility_set"
	S.name = "UI Rendering Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "UI Rendering"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.uirender.view_and_culling" }
	S.tags = { "f", "uirender", "visibility", "render" }
	S.description = "UI Rendering Visibility Set: cell, portal and occluder visibility for the UI Rendering subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 480,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.uirender.visibility_set", maxDepth = 4 })
		inst.system = S
		inst.ctx = ctx
