-- ARKHER SYSTEM L.0097 :: Reification Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0097"
	S.key = "arkher.sim.reification.route_network"
	S.name = "Reification Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.reification.region_graph" }
	S.tags = { "l", "reification", "network", "sim" }
	S.description = "Reification Route Network: roads, rivers and routes between settlements for the Reification subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.reification.route_network" })
		inst.system = S
		inst.ctx = ctx
