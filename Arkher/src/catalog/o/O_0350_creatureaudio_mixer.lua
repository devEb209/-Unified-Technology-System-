-- ARKHER SYSTEM O.0350 :: Creature Audio Mixer Bus
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0350"
	S.key = "arkher.audio.creatureaudio.mixer_bus"
	S.name = "Creature Audio Mixer Bus"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.creatureaudio.dsp_chain" }
	S.tags = { "o", "creatureaudio", "mixer", "audio" }
	S.description = "Creature Audio Mixer Bus: hierarchical buses, gain, mute, solo, ducking and voice stealing for the Creature Audio subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.audio.creatureaudio.mixer_bus", maxVoices = 56 })
		inst.system = S
		inst.ctx = ctx
