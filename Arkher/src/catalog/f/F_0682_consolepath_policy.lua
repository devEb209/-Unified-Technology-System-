-- ARKHER SYSTEM F.0682 :: Console Path Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0682"
	S.key = "arkher.render.consolepath.render_policy"
	S.name = "Console Path Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Console Path"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.consolepath.draw_budget" }
	S.tags = { "f", "consolepath", "policy", "render" }
	S.description = "Console Path Render Policy: device tier rules for the frame for the Console Path subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.consolepath.render_policy", algorithm = "lottery", starvationGuard = 55 })
		inst.system = S
		inst.ctx = ctx
