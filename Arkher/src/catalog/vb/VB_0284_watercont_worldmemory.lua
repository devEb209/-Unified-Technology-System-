-- ARKHER SYSTEM VB.0284 :: Water Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0284"
	S.key = "arkher.conttime.watercont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.watercont.neural_field" }
	S.tags = { "vb", "watercont", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.watercont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
