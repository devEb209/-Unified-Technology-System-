-- ARKHER SYSTEM I.0297 :: Look At IK Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0297"
	S.key = "arkher.anim.lookatik.quality_policy"
	S.name = "Look At IK Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Look At IK"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.lookatik.pose_cache" }
	S.tags = { "i", "lookatik", "policy", "anim" }
	S.description = "Look At IK Quality Policy: device tier rules for rate, bones and solvers for the Look At IK subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 600,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.lookatik.quality_policy", algorithm = "lottery", starvationGuard = 27 })
		inst.system = S
		inst.ctx = ctx
