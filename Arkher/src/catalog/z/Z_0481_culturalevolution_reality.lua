-- ARKHER SYSTEM Z.0481 :: Cultural Evolution Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0481"
	S.key = "arkher.origin.culturalevolution.reality_layering"
	S.name = "Cultural Evolution Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "culturalevolution", "reality", "origin" }
	S.description = "Cultural Evolution Reality Layering: stacked authored, simulated, proposed and player realities for the Cultural Evolution subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.culturalevolution.reality_layering" })
		inst.system = S
		inst.ctx = ctx
