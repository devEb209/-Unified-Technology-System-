-- ARKHER SYSTEM VD.0630 :: Interest Field Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0630"
	S.key = "arkher.contsim.interestfield.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.interestfield.persistent_state" }
	S.tags = { "vd", "interestfield", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.interestfield.coherence_guard", window = 58, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
