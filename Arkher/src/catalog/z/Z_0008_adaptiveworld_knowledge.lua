-- ARKHER SYSTEM Z.0008 :: Adaptive World Intelligence Semantic Graph
...
return function(A)
	...
	local S = {}
	S.id = "Z.0008"
	S.key = "arkher.origin.adaptiveworld.semantic_graph"
	S.name = "Adaptive World Intelligence Semantic Graph"
	S.category = "Z"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.adaptiveworld.world_architect" }
	S.tags = { "z", "adaptiveworld", "knowledge", "origin" }
	S.description = "Adaptive World Intelligence Semantic Graph: typed entities and inferred relations of the technology itself for the Adaptive World Intelligence subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.origin.adaptiveworld.semantic_graph", dims = 48 })
		inst.system = S
		inst.ctx = ctx
