-- ARKHER SYSTEM H.0205 :: Substepping Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0205"
	S.key = "arkher.physics.substepping.budget_governor"
	S.name = "Substepping Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Substepping"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.substepping.broadphase_index" }
	S.tags = { "h", "substepping", "budgeter", "physics" }
	S.description = "Substepping Budget Governor: simulation time budget allocation across islands for the Substepping subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.substepping.budget_governor", total = 384, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
