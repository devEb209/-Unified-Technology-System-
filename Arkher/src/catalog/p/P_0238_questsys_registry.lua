-- ARKHER SYSTEM P.0238 :: Quest Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0238"
	S.key = "arkher.play.questsys.content_registry"
	S.name = "Quest Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Quest"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.questsys.difficulty_controller" }
	S.tags = { "p", "questsys", "registry", "play" }
	S.description = "Quest Content Registry: catalogue of the definitions this loop instantiates for the Quest subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.questsys.content_registry" })
		inst.system = S
		inst.ctx = ctx
