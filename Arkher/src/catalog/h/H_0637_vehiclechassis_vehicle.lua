-- ARKHER SYSTEM H.0637 :: Vehicle Chassis Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0637"
	S.key = "arkher.physics.vehiclechassis.vehicle"
	S.name = "Vehicle Chassis Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.vehiclechassis.character_motion" }
	S.tags = { "h", "vehiclechassis", "vehicle", "physics" }
	S.description = "Vehicle Chassis Vehicle: suspension, drivetrain, steering and tire friction for the Vehicle Chassis subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 480,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.vehiclechassis.vehicle", mass = 900, wheelbase = 3.00, track = 1.40, maxRpm = 6400 })
		inst.system = S
		inst.ctx = ctx
