-- ARKHER SYSTEM F.0176 :: Atmosphere Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0176"
	S.key = "arkher.render.atmosphere.adaptive_resolution"
	S.name = "Atmosphere Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Atmosphere"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.atmosphere.temporal_resolve" }
	S.tags = { "f", "atmosphere", "upscaler", "render" }
	S.description = "Atmosphere Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Atmosphere subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.atmosphere.adaptive_resolution", targetMs = 11.10, index = 3, sharpness = 0.20 })
		inst.system = S
		inst.ctx = ctx
