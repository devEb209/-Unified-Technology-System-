-- ARKHER SYSTEM VC.0209 :: Biome Continuum Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VC.0209"
	S.key = "arkher.contneural.biomecont.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.biomecont.multi-scale_fidelity" }
	S.tags = { "vc", "biomecont", "persistent", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contneural.biomecont.persistent_state", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
