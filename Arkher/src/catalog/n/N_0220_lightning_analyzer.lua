-- ARKHER SYSTEM N.0220 :: Lightning Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0220"
	S.key = "arkher.vfx.lightning.analysis"
	S.name = "Lightning Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Lightning"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.lightning.spatial_index" }
	S.tags = { "n", "lightning", "analyzer", "vfx" }
	S.description = "Lightning Analysis: cost, overdraw and stability analysis of the effect for the Lightning subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.lightning.analysis", window = 170, buckets = 18, threshold = 4.20 })
		inst.system = S
		inst.ctx = ctx
