-- ARKHER SYSTEM R.0023 :: Connection Latency Analysis
...
return function(A)
	...
	local S = {}
	S.id = "R.0023"
	S.key = "arkher.net.connection.latency_analysis"
	S.name = "Connection Latency Analysis"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Connection"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.net.connection.audit_ledger" }
	S.tags = { "r", "connection", "analyzer", "net" }
	S.description = "Connection Latency Analysis: round trip, jitter and loss analysis for the Connection subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.net.connection.latency_analysis", window = 191, buckets = 11, threshold = 2.30 })
		inst.system = S
		inst.ctx = ctx
