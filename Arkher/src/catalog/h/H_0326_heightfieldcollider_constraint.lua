-- ARKHER SYSTEM H.0326 :: Heightfield Collider Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0326"
	S.key = "arkher.physics.heightfieldcollider.constraint_solver"
	S.name = "Heightfield Collider Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.heightfieldcollider.contact_generation" }
	S.tags = { "h", "heightfieldcollider", "constraint", "physics" }
	S.description = "Heightfield Collider Constraint Solver: sequential impulses, friction, joints and warm starting for the Heightfield Collider subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.heightfieldcollider.constraint_solver", iterations = 4, baumgarte = 0.20, warmStart = true })
		inst.system = S
		inst.ctx = ctx
