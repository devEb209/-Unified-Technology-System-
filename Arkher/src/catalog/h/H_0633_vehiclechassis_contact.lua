-- ARKHER SYSTEM H.0633 :: Vehicle Chassis Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0633"
	S.key = "arkher.physics.vehiclechassis.contact_generation"
	S.name = "Vehicle Chassis Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.vehiclechassis.collision_shape" }
	S.tags = { "h", "vehiclechassis", "contact", "physics" }
	S.description = "Vehicle Chassis Contact Generation: narrow-phase manifolds with normal, depth and point for the Vehicle Chassis subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.vehiclechassis.contact_generation", slop = 0.0090, maxManifolds = 377 })
		inst.system = S
		inst.ctx = ctx
