-- ARKHER SYSTEM R.0345 :: Reconnection Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0345"
	S.key = "arkher.net.reconnection.session_registry"
	S.name = "Reconnection Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Reconnection"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.reconnection.rate_guard" }
	S.tags = { "r", "reconnection", "registry", "net" }
	S.description = "Reconnection Session Registry: catalogue of sessions, players and their metadata for the Reconnection subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 280,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.reconnection.session_registry" })
		inst.system = S
		inst.ctx = ctx
