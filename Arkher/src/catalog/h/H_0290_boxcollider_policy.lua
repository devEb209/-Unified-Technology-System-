-- ARKHER SYSTEM H.0290 :: Box Collider Simulation Policy
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0290"
	S.key = "arkher.physics.boxcollider.simulation_policy"
	S.name = "Box Collider Simulation Policy"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Box Collider"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.boxcollider.budget_governor" }
	S.tags = { "h", "boxcollider", "policy", "physics" }
	S.description = "Box Collider Simulation Policy: device tier rules for substeps, iterations and sleep for the Box Collider subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.physics.boxcollider.simulation_policy", algorithm = "lottery", starvationGuard = 51 })
		inst.system = S
		inst.ctx = ctx
