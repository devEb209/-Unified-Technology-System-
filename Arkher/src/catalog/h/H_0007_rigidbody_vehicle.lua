-- ARKHER SYSTEM H.0007 :: Rigid Body Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0007"
	S.key = "arkher.physics.rigidbody.vehicle"
	S.name = "Rigid Body Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Rigid Body"
	S.aspect = "Vehicle"
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.rigidbody.character_motion" }
	S.tags = { "h", "rigidbody", "vehicle", "physics" }
	S.description = "Rigid Body Vehicle: suspension, drivetrain, steering and tire friction for the Rigid Body subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.rigidbody.vehicle", mass = 1800, wheelbase = 2.30, track = 1.90, maxRpm = 5700 })
		inst.system = S
		inst.ctx = ctx
