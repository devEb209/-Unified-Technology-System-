-- ARKHER SYSTEM E.0268 :: UV Mapping Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0268"
	S.key = "arkher.material.uvmap.authoring_pipeline"
	S.name = "UV Mapping Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "UV Mapping"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.uvmap.analysis" }
	S.tags = { "e", "uvmap", "pipeline", "material" }
	S.description = "UV Mapping Authoring Pipeline: ordered authoring and bake stages for the UV Mapping subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 360,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.uvmap.authoring_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
