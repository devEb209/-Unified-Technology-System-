-- ARKHER SYSTEM G.0061 :: Motion Vector Estimation Model Registry
...
return function(A)
	...
	local S = {}
	S.id = "G.0061"
	S.key = "arkher.neural.motionvector.model_registry"
	S.name = "Motion Vector Estimation Model Registry"
	S.category = "G"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.motionvector.reconstruction" }
	S.tags = { "g", "motionvector", "registry", "neural" }
	S.description = "Motion Vector Estimation Model Registry: named models and their lifecycle for the Motion Vector Estimation subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.neural.motionvector.model_registry" })
		inst.system = S
		inst.ctx = ctx
