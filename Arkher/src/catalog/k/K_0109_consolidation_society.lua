-- ARKHER SYSTEM K.0109 :: Memory Consolidation Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0109"
	S.key = "arkher.npc.consolidation.social_relations"
	S.name = "Memory Consolidation Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.consolidation.crowd_steering" }
	S.tags = { "k", "consolidation", "society", "npc" }
	S.description = "Memory Consolidation Social Relations: affinity, factions, reputation and gossip for the Memory Consolidation subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 160,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.consolidation.social_relations", decayRate = 0.005, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
