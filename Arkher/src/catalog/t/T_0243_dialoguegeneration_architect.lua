-- ARKHER SYSTEM T.0243 :: Dialogue Generation World Architect
...
return function(A)
	...
	local S = {}
	S.id = "T.0243"
	S.key = "arkher.ai.dialoguegeneration.world_architect"
	S.name = "Dialogue Generation World Architect"
	S.category = "T"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.dialoguegeneration.self_critique" }
	S.tags = { "t", "dialoguegeneration", "architect", "ai" }
	S.description = "Dialogue Generation World Architect: composition of a whole world plan with conserved budgets for the Dialogue Generation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.ai.dialoguegeneration.world_architect", budget = 1200, seed = 60236 })
		inst.system = S
		inst.ctx = ctx
