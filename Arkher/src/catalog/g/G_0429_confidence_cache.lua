-- ARKHER SYSTEM G.0429 :: Confidence Gating Result Cache
...
return function(A)
	...
	local S = {}
	S.id = "G.0429"
	S.key = "arkher.neural.confidence.result_cache"
	S.name = "Confidence Gating Result Cache"
	S.category = "G"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.confidence.compute_budget" }
	S.tags = { "g", "confidence", "cache", "neural" }
	S.description = "Confidence Gating Result Cache: cached inference results keyed by input for the Confidence Gating subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.neural.confidence.result_cache", policy = "ttl", capacity = 484, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
