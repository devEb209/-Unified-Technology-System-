-- ARKHER SYSTEM Q.0390 :: Accessibility Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0390"
	S.key = "arkher.ui.uiaccessibility.theme_composition"
	S.name = "Accessibility Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.uiaccessibility.navigation_graph" }
	S.tags = { "q", "uiaccessibility", "composer", "ui" }
	S.description = "Accessibility Theme Composition: blending of theme signals into the final appearance for the Accessibility subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.uiaccessibility.theme_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
