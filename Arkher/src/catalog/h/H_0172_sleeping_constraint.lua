-- ARKHER SYSTEM H.0172 :: Sleeping Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0172"
	S.key = "arkher.physics.sleeping.constraint_solver"
	S.name = "Sleeping Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Sleeping"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sleeping.contact_generation" }
	S.tags = { "h", "sleeping", "constraint", "physics" }
	S.description = "Sleeping Constraint Solver: sequential impulses, friction, joints and warm starting for the Sleeping subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.sleeping.constraint_solver", iterations = 7, baumgarte = 0.23, warmStart = true })
		inst.system = S
		inst.ctx = ctx
