-- ARKHER SYSTEM N.0342 :: Beam Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0342"
	S.key = "arkher.vfx.beam.ribbon_and_trail"
	S.name = "Beam Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Beam"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.beam.force_field" }
	S.tags = { "n", "beam", "ribbon", "vfx" }
	S.description = "Beam Ribbon And Trail: trail points, tapering, beams and decimation for the Beam subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.61,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.beam.ribbon_and_trail", maxPoints = 40, lifetime = 0.60, minDistance = 0.15, width = 1.10 })
		inst.system = S
		inst.ctx = ctx
