-- ARKHER SYSTEM T.0655 :: Human Handoff Action Planner
...
return function(A)
	...
	local S = {}
	S.id = "T.0655"
	S.key = "arkher.ai.humanhandoff.action_planner"
	S.name = "Human Handoff Action Planner"
	S.category = "T"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.humanhandoff.utility_selection" }
	S.tags = { "t", "humanhandoff", "planner", "ai" }
	S.description = "Human Handoff Action Planner: goal-oriented action planning over preconditions for the Human Handoff subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.ai.humanhandoff.action_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
