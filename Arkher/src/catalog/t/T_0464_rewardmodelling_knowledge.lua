-- ARKHER SYSTEM T.0464 :: Reward Modelling Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0464"
	S.key = "arkher.ai.rewardmodelling.semantic_knowledge"
	S.name = "Reward Modelling Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.rewardmodelling.intent_understanding" }
	S.tags = { "t", "rewardmodelling", "knowledge", "ai" }
	S.description = "Reward Modelling Semantic Knowledge: typed entities, weighted relations and inferred closure for the Reward Modelling subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.rewardmodelling.semantic_knowledge", dims = 48 })
		inst.system = S
		inst.ctx = ctx
