-- ARKHER SYSTEM O.0159 :: Forest Audio Spatialization
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0159"
	S.key = "arkher.audio.forestaudio.spatialization"
	S.name = "Forest Audio Spatialization"
	S.category = "O"
	S.family = "AUDIO"
	S.area = "Forest Audio"
	...
	S.kit = "spatialaudio"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.forestaudio.mixer_bus" }
	S.tags = { "o", "forestaudio", "spatialaudio", "audio" }
	S.description = "Forest Audio Spatialization: distance attenuation, panning, occlusion and doppler for the Forest Audio subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spatialaudio", { id = "arkher.audio.forestaudio.spatialization", model = "linear", refDistance = 7, maxDistance = 200, rolloff = 1.16, maxVoices = 28 })
		inst.system = S
		inst.ctx = ctx
