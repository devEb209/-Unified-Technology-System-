-- ARKHER SYSTEM G.0078 :: Disocclusion Handling Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0078"
	S.key = "arkher.neural.disocclusion.compute_budget"
	S.name = "Disocclusion Handling Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.disocclusion.quality_predictor" }
	S.tags = { "g", "disocclusion", "budgeter", "neural" }
	S.description = "Disocclusion Handling Compute Budget: inference time budget allocation for the Disocclusion Handling subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.disocclusion.compute_budget", total = 230, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
