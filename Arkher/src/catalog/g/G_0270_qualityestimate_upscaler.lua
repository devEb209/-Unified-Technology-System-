-- ARKHER SYSTEM G.0270 :: Quality Estimation Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0270"
	S.key = "arkher.neural.qualityestimate.reconstruction"
	S.name = "Quality Estimation Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.qualityestimate.temporal_history" }
	S.tags = { "g", "qualityestimate", "upscaler", "neural" }
	S.description = "Quality Estimation Reconstruction: resolution ladder and image reconstruction for the Quality Estimation subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.qualityestimate.reconstruction", targetMs = 14.10, index = 3, sharpness = 0.57 })
		inst.system = S
		inst.ctx = ctx
