-- ARKHER SYSTEM VC.0453 :: Animation Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0453"
	S.key = "arkher.contneural.animcont.complexity_budget"
	S.name = "Animation Continuum Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.animcont.world_memory_stream" }
	S.tags = { "vc", "animcont", "complexity", "contneural" }
	S.description = "Animation Continuum Complexity Budget: complexity budgeting for the continuum for the Animation Continuum subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.animcont.complexity_budget", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
