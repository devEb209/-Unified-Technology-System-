-- ARKHER SYSTEM N.0086 :: Impact Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0086"
	S.key = "arkher.vfx.impact.spawn_budget"
	S.name = "Impact Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Impact"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.impact.effect_composition" }
	S.tags = { "n", "impact", "budgeter", "vfx" }
	S.description = "Impact Spawn Budget: global particle budget shared by every live effect for the Impact subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.impact.spawn_budget", total = 452, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
