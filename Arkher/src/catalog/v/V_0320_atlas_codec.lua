-- ARKHER SYSTEM V.0320 :: Texture Atlas Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "V.0320"
	S.key = "arkher.asset.atlas.compression_codec"
	S.name = "Texture Atlas Compression Codec"
	S.category = "V"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.atlas.streaming_residency" }
	S.tags = { "v", "atlas", "codec", "asset" }
	S.description = "Texture Atlas Compression Codec: compact encoding, diffing and checksum of asset payloads for the Texture Atlas subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.asset.atlas.compression_codec", format = "quantized", quantBits = 13 })
		inst.system = S
		inst.ctx = ctx
