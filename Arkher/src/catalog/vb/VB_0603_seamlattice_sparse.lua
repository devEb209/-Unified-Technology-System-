-- ARKHER SYSTEM VB.0603 :: Seam Lattice Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0603"
	S.key = "arkher.conttime.seamlattice.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.seamlattice.epoch_clock" }
	S.tags = { "vb", "seamlattice", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.seamlattice.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
