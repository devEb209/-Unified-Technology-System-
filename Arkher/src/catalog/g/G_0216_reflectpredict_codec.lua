-- ARKHER SYSTEM G.0216 :: Reflection Prediction Weight Codec
...
return function(A)
	...
	local S = {}
	S.id = "G.0216"
	S.key = "arkher.neural.reflectpredict.weight_codec"
	S.name = "Reflection Prediction Weight Codec"
	S.category = "G"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.reflectpredict.model_registry" }
	S.tags = { "g", "reflectpredict", "codec", "neural" }
	S.description = "Reflection Prediction Weight Codec: weight serialization and quantized transport for the Reflection Prediction subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.neural.reflectpredict.weight_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
