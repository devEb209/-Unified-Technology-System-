-- ARKHER SYSTEM Z.0826 :: Reality Blending Emergence Detection
...
return function(A)
	...
	local S = {}
	S.id = "Z.0826"
	S.key = "arkher.origin.realityblending.emergence_detection"
	S.name = "Reality Blending Emergence Detection"
	S.category = "Z"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.realityblending.world_memory" }
	S.tags = { "z", "realityblending", "emergence", "origin" }
	S.description = "Reality Blending Emergence Detection: co-occurrence lift that names behaviour nobody scripted for the Reality Blending subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.origin.realityblending.emergence_detection", windowSize = 4, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
