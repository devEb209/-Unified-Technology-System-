--!strict
-- Neural DLSS — ANIMATION Mixer #0147
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Neural DLSS — ANIMATION Mixer #0147", size=Vector2.new(600, 460), pos=UDim2.fromOffset(411, 239), parent=parent, icon="▶"})
