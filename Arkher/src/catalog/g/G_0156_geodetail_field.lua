-- ARKHER SYSTEM G.0156 :: Geometry Detail Prediction Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0156"
	S.key = "arkher.neural.geodetail.feature_extraction"
	S.name = "Geometry Detail Prediction Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.geodetail.inference_core" }
	S.tags = { "g", "geodetail", "field", "neural" }
	S.description = "Geometry Detail Prediction Feature Extraction: signal features feeding the model for the Geometry Detail Prediction subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 320,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.geodetail.feature_extraction", seed = 72628, frequency = 0.0110, octaves = 3, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
