-- ARKHER SYSTEM N.0087 :: Impact Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0087"
	S.key = "arkher.vfx.impact.result_cache"
	S.name = "Impact Result Cache"
	S.category = "N"
	S.family = "VFX"
	S.area = "Impact"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.impact.spawn_budget" }
	S.tags = { "n", "impact", "cache", "vfx" }
	S.description = "Impact Result Cache: reuse of expensive effect evaluations for the Impact subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.impact.result_cache", policy = "lru", capacity = 323, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
