-- ARKHER SYSTEM V.0254 :: Video Asset Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0254"
	S.key = "arkher.asset.videoasset.bundling"
	S.name = "Video Asset Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.videoasset.import" }
	S.tags = { "v", "videoasset", "bundler", "asset" }
	S.description = "Video Asset Bundling: size-bounded packing, manifests and delta patches for the Video Asset subsystem."
	S.params = {
		backlogLimit = 9,
		baseRadius = 520,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.videoasset.bundling", maxBundleBytes = 393216 })
		inst.system = S
		inst.ctx = ctx
