-- ARKHER SYSTEM VB.0547 :: World Fabric Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0547"
	S.key = "arkher.conttime.worldfabric.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.worldfabric.coherence_guard" }
	S.tags = { "vb", "worldfabric", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.worldfabric.neural_field", dims = 12, hidden = 8, seed = 16236 })
		inst.system = S
		inst.ctx = ctx
