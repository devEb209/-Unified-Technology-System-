--!strict
-- Creation2 — ANIMATION Mixer #0297
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Creation2 — ANIMATION Mixer #0297", size=Vector2.new(600, 460), pos=UDim2.fromOffset(361, 189), parent=parent, icon="⬢"})
