-- ARKHER SYSTEM V.0345 :: Patch Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0345"
	S.key = "arkher.asset.patch.size_budget"
	S.name = "Patch Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.patch.compression_codec" }
	S.tags = { "v", "patch", "budgeter", "asset" }
	S.description = "Patch Size Budget: byte budget shared between competing asset classes for the Patch subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 360,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.patch.size_budget", total = 165, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
