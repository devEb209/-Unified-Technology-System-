-- ARKHER SYSTEM L.0318 :: Production Chain Economy
...
return function(A)
	...
	local S = {}
	S.id = "L.0318"
	S.key = "arkher.sim.productionchain.economy"
	S.name = "Production Chain Economy"
	S.category = "L"
	...
	S.kit = "economy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.productionchain.ecology" }
	S.tags = { "l", "productionchain", "economy", "sim" }
	S.description = "Production Chain Economy: stock, production, demand, price discovery and trade for the Production Chain subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("economy", { id = "arkher.sim.productionchain.economy", elasticity = 0.19 })
		inst.system = S
		inst.ctx = ctx
