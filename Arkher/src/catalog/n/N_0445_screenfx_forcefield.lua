-- ARKHER SYSTEM N.0445 :: Screen Effect Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0445"
	S.key = "arkher.vfx.screenfx.force_field"
	S.name = "Screen Effect Force Field"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.screenfx.particle_simulation" }
	S.tags = { "n", "screenfx", "forcefield", "vfx" }
	S.description = "Screen Effect Force Field: wind, attraction, vortex, drag and curl turbulence for the Screen Effect subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.screenfx.force_field", seed = 61991 })
		inst.system = S
		inst.ctx = ctx
