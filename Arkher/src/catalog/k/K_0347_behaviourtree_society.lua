-- ARKHER SYSTEM K.0347 :: Behaviour Tree Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0347"
	S.key = "arkher.npc.behaviourtree.social_relations"
	S.name = "Behaviour Tree Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.behaviourtree.crowd_steering" }
	S.tags = { "k", "behaviourtree", "society", "npc" }
	S.description = "Behaviour Tree Social Relations: affinity, factions, reputation and gossip for the Behaviour Tree subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.behaviourtree.social_relations", decayRate = 0.010, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
