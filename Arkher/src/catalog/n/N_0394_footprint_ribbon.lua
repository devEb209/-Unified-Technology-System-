-- ARKHER SYSTEM N.0394 :: Footprint Ribbon And Trail
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0394"
	S.key = "arkher.vfx.footprint.ribbon_and_trail"
	S.name = "Footprint Ribbon And Trail"
	S.category = "N"
	S.family = "VFX"
	S.area = "Footprint"
	...
	S.kit = "ribbon"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.footprint.force_field" }
	S.tags = { "n", "footprint", "ribbon", "vfx" }
	S.description = "Footprint Ribbon And Trail: trail points, tapering, beams and decimation for the Footprint subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ribbon", { id = "arkher.vfx.footprint.ribbon_and_trail", maxPoints = 16, lifetime = 2.30, minDistance = 0.50, width = 0.80 })
		inst.system = S
		inst.ctx = ctx
