-- ARKHER SYSTEM I.0290 :: Look At IK Inverse Kinematics
...
return function(A)
	...
	local S = {}
	S.id = "I.0290"
	S.key = "arkher.anim.lookatik.inverse_kinematics"
	S.name = "Look At IK Inverse Kinematics"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Look At IK"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.lookatik.layered_blending" }
	S.tags = { "i", "lookatik", "ik", "anim" }
	S.description = "Look At IK Inverse Kinematics: two-bone, FABRIK and constrained look-at solving for the Look At IK subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.anim.lookatik.inverse_kinematics", iterations = 5, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
