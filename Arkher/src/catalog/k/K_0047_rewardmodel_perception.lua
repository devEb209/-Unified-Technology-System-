-- ARKHER SYSTEM K.0047 :: Reward Model Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0047"
	S.key = "arkher.npc.rewardmodel.perception"
	S.name = "Reward Model Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.rewardmodel.emotion" }
	S.tags = { "k", "rewardmodel", "perception", "npc" }
	S.description = "Reward Model Perception: sight, hearing and bounded attention for the Reward Model subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.rewardmodel.perception", sightRange = 35, hearingRange = 20, attentionSlots = 5, fov = 1.780 })
		inst.system = S
		inst.ctx = ctx
