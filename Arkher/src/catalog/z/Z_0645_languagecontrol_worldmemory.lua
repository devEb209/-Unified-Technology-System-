-- ARKHER SYSTEM Z.0645 :: Natural Language Engine Control World Memory
...
return function(A)
	...
	local S = {}
	S.id = "Z.0645"
	S.key = "arkher.origin.languagecontrol.world_memory"
	S.name = "Natural Language Engine Control World Memory"
	S.category = "Z"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.languagecontrol.autonomous_pipeline" }
	S.tags = { "z", "languagecontrol", "worldmemory", "origin" }
	S.description = "Natural Language Engine Control World Memory: epoch-stamped persistent history with compaction and checkpoints for the Natural Language Engine Control subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.origin.languagecontrol.world_memory", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
