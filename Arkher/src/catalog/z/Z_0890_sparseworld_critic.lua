-- ARKHER SYSTEM Z.0890 :: Sparse World Representation Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0890"
	S.key = "arkher.origin.sparseworld.self_critique"
	S.name = "Sparse World Representation Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.sparseworld.intent_bridge" }
	S.tags = { "z", "sparseworld", "critic", "origin" }
	S.description = "Sparse World Representation Self Critique: weighted judgement of the technology's own output for the Sparse World Representation subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.sparseworld.self_critique", passMark = 0.78, reviseMark = 0.43, seed = 30533 })
		inst.system = S
		inst.ctx = ctx
