-- ARKHER SYSTEM E.0132 :: Emissive Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0132"
	S.key = "arkher.material.emissive.analysis"
	S.name = "Emissive Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Emissive"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.emissive.instance_cache" }
	S.tags = { "e", "emissive", "analyzer", "material" }
	S.description = "Emissive Analysis: cost, redundancy and outlier analysis for the Emissive subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.emissive.analysis", window = 111, buckets = 15, threshold = 3.30 })
		inst.system = S
		inst.ctx = ctx
