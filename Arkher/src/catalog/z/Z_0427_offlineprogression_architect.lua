-- ARKHER SYSTEM Z.0427 :: Offline World Progression World Architect
...
return function(A)
	...
	local S = {}
	S.id = "Z.0427"
	S.key = "arkher.origin.offlineprogression.world_architect"
	S.name = "Offline World Progression World Architect"
	S.category = "Z"
	...
	S.kit = "architect"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.offlineprogression.emergence_detection" }
	S.tags = { "z", "offlineprogression", "architect", "origin" }
	S.description = "Offline World Progression World Architect: hierarchical world composition with conserved budgets for the Offline World Progression subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("architect", { id = "arkher.origin.offlineprogression.world_architect", budget = 1400, seed = 49438 })
		inst.system = S
		inst.ctx = ctx
