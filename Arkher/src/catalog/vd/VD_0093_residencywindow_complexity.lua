-- ARKHER SYSTEM VD.0093 :: Residency Window Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0093"
	S.key = "arkher.contsim.residencywindow.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.residencywindow.world_memory_stream" }
	S.tags = { "vd", "residencywindow", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.residencywindow.complexity_budget", targetMs = 18.0 })
		inst.system = S
		inst.ctx = ctx
