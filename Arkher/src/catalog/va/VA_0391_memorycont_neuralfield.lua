-- ARKHER SYSTEM VA.0391 :: Memory Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0391"
	S.key = "arkher.contworld.memorycont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.memorycont.coherence_guard" }
	S.tags = { "va", "memorycont", "neuralfield", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.memorycont.neural_field", dims = 20, hidden = 16, seed = 10310 })
		inst.system = S
		inst.ctx = ctx
