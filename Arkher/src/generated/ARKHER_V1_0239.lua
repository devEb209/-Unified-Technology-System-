--!strict
-- Terragen Sky — ANIMATION Profiler #0239
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="Terragen Sky — ANIMATION Profiler #0239", size=Vector2.new(680, 500), pos=UDim2.fromOffset(407, 243), parent=parent, icon="⬢"})
