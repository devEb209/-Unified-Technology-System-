-- ARKHER SYSTEM L.0537 :: Disease Aggregate Cache
...
return function(A)
	...
	local S = {}
	S.id = "L.0537"
	S.key = "arkher.sim.disease.aggregate_cache"
	S.name = "Disease Aggregate Cache"
	S.category = "L"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.disease.fidelity_policy" }
	S.tags = { "l", "disease", "cache", "sim" }
	S.description = "Disease Aggregate Cache: reuse of expensive aggregate computations for the Disease subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.sim.disease.aggregate_cache", policy = "lru", capacity = 118, ttl = 1 })
		inst.system = S
		inst.ctx = ctx
