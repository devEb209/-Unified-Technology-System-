-- ARKHER SYSTEM VA.0622 :: Occupancy Map Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0622"
	S.key = "arkher.contworld.occupancymap.simulation_fabric"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.occupancymap.complexity_budget" }
	S.tags = { "va", "occupancymap", "fabric", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.occupancymap.simulation_fabric", budgetMs = 3.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
