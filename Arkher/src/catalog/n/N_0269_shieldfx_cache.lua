-- ARKHER SYSTEM N.0269 :: Shield Effect Result Cache
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0269"
	S.key = "arkher.vfx.shieldfx.result_cache"
	S.name = "Shield Effect Result Cache"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.shieldfx.spawn_budget" }
	S.tags = { "n", "shieldfx", "cache", "vfx" }
	S.description = "Shield Effect Result Cache: reuse of expensive effect evaluations for the Shield Effect subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.vfx.shieldfx.result_cache", policy = "lru", capacity = 431, ttl = 0 })
		inst.system = S
		inst.ctx = ctx
