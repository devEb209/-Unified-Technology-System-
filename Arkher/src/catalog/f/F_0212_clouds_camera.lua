-- ARKHER SYSTEM F.0212 :: Cloud Rendering View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0212"
	S.key = "arkher.render.clouds.view_and_culling"
	S.name = "Cloud Rendering View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.clouds.frame_graph" }
	S.tags = { "f", "clouds", "camera", "render" }
	S.description = "Cloud Rendering View And Culling: view state, frustum culling and screen-size LOD for the Cloud Rendering subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.clouds.view_and_culling", width = 828, height = 1080, fov = 1.0000, far = 1600 })
		inst.system = S
		inst.ctx = ctx
