--!strict
-- ZBrush SubTool — ANIMATION Map #0083
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="ZBrush SubTool — ANIMATION Map #0083", size=Vector2.new(680, 480), pos=UDim2.fromOffset(379, 191), parent=parent, icon="⚑"})
