-- ARKHER SYSTEM L.0470 :: Faction Politics Calendar
...
return function(A)
	...
	local S = {}
	S.id = "L.0470"
	S.key = "arkher.sim.factionpolitics.calendar"
	S.name = "Faction Politics Calendar"
	S.category = "L"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.factionpolitics.society" }
	S.tags = { "l", "factionpolitics", "schedule", "sim" }
	S.description = "Faction Politics Calendar: hours, days and seasons driving the region for the Faction Politics subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.sim.factionpolitics.calendar", startHour = 11 })
		inst.system = S
		inst.ctx = ctx
