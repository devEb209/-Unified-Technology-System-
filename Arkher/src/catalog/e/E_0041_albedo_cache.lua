-- ARKHER SYSTEM E.0041 :: Albedo Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0041"
	S.key = "arkher.material.albedo.instance_cache"
	S.name = "Albedo Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Albedo"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.albedo.quality_policy" }
	S.tags = { "e", "albedo", "cache", "material" }
	S.description = "Albedo Instance Cache: resolved-parameter cache keyed by context for the Albedo subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.albedo.instance_cache", policy = "lru", capacity = 99, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
