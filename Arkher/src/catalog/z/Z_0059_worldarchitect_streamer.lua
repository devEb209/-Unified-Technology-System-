-- ARKHER SYSTEM Z.0059 :: Singularity World Architect Residency Streaming
...
return function(A)
	...
	local S = {}
	S.id = "Z.0059"
	S.key = "arkher.origin.worldarchitect.residency_streaming"
	S.name = "Singularity World Architect Residency Streaming"
	S.category = "Z"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.worldarchitect.budget_governor" }
	S.tags = { "z", "worldarchitect", "streamer", "origin" }
	S.description = "Singularity World Architect Residency Streaming: distance-driven residency of the technology's workload for the Singularity World Architect subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 600,
		baseWeight = 0.63,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.origin.worldarchitect.residency_streaming", radius = 600, chunkSize = 128, maxPerFrame = 4 })
		inst.system = S
		inst.ctx = ctx
