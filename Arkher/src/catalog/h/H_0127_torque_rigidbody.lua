-- ARKHER SYSTEM H.0127 :: Torque Body Dynamics
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0127"
	S.key = "arkher.physics.torque.body_dynamics"
	S.name = "Torque Body Dynamics"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Torque"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "h", "torque", "rigidbody", "physics" }
	S.description = "Torque Body Dynamics: integration, impulses, damping and sleeping of a body for the Torque subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("rigidbody", { id = "arkher.physics.torque.body_dynamics", mass = 20.00, radius = 1.25, restitution = 0.39, friction = 0.49, gravityScale = 1 })
		inst.system = S
		inst.ctx = ctx
