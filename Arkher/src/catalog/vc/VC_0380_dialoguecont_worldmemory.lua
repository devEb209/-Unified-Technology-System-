-- ARKHER SYSTEM VC.0380 :: Dialogue Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0380"
	S.key = "arkher.contneural.dialoguecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.dialoguecont.neural_field" }
	S.tags = { "vc", "dialoguecont", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.dialoguecont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
