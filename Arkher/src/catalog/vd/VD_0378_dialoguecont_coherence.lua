-- ARKHER SYSTEM VD.0378 :: Dialogue Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0378"
	S.key = "arkher.contsim.dialoguecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.dialoguecont.persistent_state" }
	S.tags = { "vd", "dialoguecont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.dialoguecont.coherence_guard", window = 80, threshold = 0.14 })
		inst.system = S
		inst.ctx = ctx
