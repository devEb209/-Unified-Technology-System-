-- ARKHER SYSTEM Z.0621 :: Intent Driven Authoring Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0621"
	S.key = "arkher.origin.intentauthoring.reality_layering"
	S.name = "Intent Driven Authoring Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "intentauthoring", "reality", "origin" }
	S.description = "Intent Driven Authoring Reality Layering: stacked authored, simulated, proposed and player realities for the Intent Driven Authoring subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.intentauthoring.reality_layering" })
		inst.system = S
		inst.ctx = ctx
