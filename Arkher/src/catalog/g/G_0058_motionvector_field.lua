-- ARKHER SYSTEM G.0058 :: Motion Vector Estimation Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0058"
	S.key = "arkher.neural.motionvector.feature_extraction"
	S.name = "Motion Vector Estimation Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.motionvector.inference_core" }
	S.tags = { "g", "motionvector", "field", "neural" }
	S.description = "Motion Vector Estimation Feature Extraction: signal features feeding the model for the Motion Vector Estimation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.motionvector.feature_extraction", seed = 89222, frequency = 0.0095, octaves = 5, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
