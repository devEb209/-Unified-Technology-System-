-- ARKHER SYSTEM T.0353 :: Documentation Writer Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0353"
	S.key = "arkher.ai.documentationwriter.plan_workflow"
	S.name = "Documentation Writer Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.documentationwriter.semantic_knowledge" }
	S.tags = { "t", "documentationwriter", "workflow", "ai" }
	S.description = "Documentation Writer Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Documentation Writer subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.documentationwriter.plan_workflow", maxRetries = 3, budget = 120 })
		inst.system = S
		inst.ctx = ctx
