-- ARKHER SYSTEM I.0101 :: Clip Looping Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0101"
	S.key = "arkher.anim.cliploop.pose_cache"
	S.name = "Clip Looping Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Looping"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.cliploop.playback_pipeline" }
	S.tags = { "i", "cliploop", "cache", "anim" }
	S.description = "Clip Looping Pose Cache: reuse of sampled poses across frames and instances for the Clip Looping subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 400,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.cliploop.pose_cache", policy = "lru", capacity = 210, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
