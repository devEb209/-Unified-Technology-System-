-- ARKHER SYSTEM P.0015 :: Attribute Objectives
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0015"
	S.key = "arkher.play.attribute.objectives"
	S.name = "Attribute Objectives"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Attribute"
	S.aspect = "Objectives"
	S.kit = "quest"
	S.version = "1.0.0"
	S.deps = { "arkher.play.attribute.inventory" }
	S.tags = { "p", "attribute", "quest", "play" }
	S.description = "Attribute Objectives: objectives, prerequisites, progress and rewards for the Attribute subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("quest", { id = "arkher.play.attribute.objectives" })
		inst.system = S
		inst.ctx = ctx
