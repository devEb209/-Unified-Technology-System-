-- ARKHER SYSTEM W.0266 :: Letterbox Camera Rig
...
return function(A)
	...
	local S = {}
	S.id = "W.0266"
	S.key = "arkher.cine.letterbox.camera_rig"
	S.name = "Letterbox Camera Rig"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Letterbox"
	S.aspect = "Camera Rig"
	S.kit = "camerarig"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.letterbox.sequence_timeline" }
	S.tags = { "w", "letterbox", "camerarig", "cine" }
	S.description = "Letterbox Camera Rig: dolly, orbit, crane and handheld camera with focus and shake for the Letterbox subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camerarig", { id = "arkher.cine.letterbox.camera_rig", fov = 0.92, focus = 8.0, aperture = 2.4, smoothing = 12.0, distance = 10, height = 4 })
		inst.system = S
		inst.ctx = ctx
