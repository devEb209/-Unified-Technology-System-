-- ARKHER SYSTEM R.0309 :: Cross Server Session Registry
...
return function(A)
	...
	local S = {}
	S.id = "R.0309"
	S.key = "arkher.net.crossserver.session_registry"
	S.name = "Cross Server Session Registry"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Cross Server"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.net.crossserver.rate_guard" }
	S.tags = { "r", "crossserver", "registry", "net" }
	S.description = "Cross Server Session Registry: catalogue of sessions, players and their metadata for the Cross Server subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 480,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.net.crossserver.session_registry" })
		inst.system = S
		inst.ctx = ctx
