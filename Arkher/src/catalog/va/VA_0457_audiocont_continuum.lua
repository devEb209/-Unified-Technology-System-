-- ARKHER SYSTEM VA.0457 :: Audio Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VA.0457"
	S.key = "arkher.contworld.audiocont.infinite_grid"
	S.name = "Audio Continuum Infinite Grid"
	S.category = "VA"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "va", "audiocont", "continuum", "contworld" }
	S.description = "Audio Continuum Infinite Grid: seamless paging of the infinite world grid for the Audio Continuum subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contworld.audiocont.infinite_grid", cellSize = 64, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
