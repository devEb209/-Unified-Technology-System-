-- ARKHER SYSTEM E.0312 :: Dust Accumulation Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0312"
	S.key = "arkher.material.dust.analysis"
	S.name = "Dust Accumulation Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.dust.instance_cache" }
	S.tags = { "e", "dust", "analyzer", "material" }
	S.description = "Dust Accumulation Analysis: cost, redundancy and outlier analysis for the Dust Accumulation subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.dust.analysis", window = 72, buckets = 12, threshold = 2.40 })
		inst.system = S
		inst.ctx = ctx
