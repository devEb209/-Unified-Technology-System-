-- ARKHER SYSTEM L.0463 :: Justice Analysis
...
return function(A)
	...
	local S = {}
	S.id = "L.0463"
	S.key = "arkher.sim.justice.analysis"
	S.name = "Justice Analysis"
	S.category = "L"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.justice.aggregate_cache" }
	S.tags = { "l", "justice", "analyzer", "sim" }
	S.description = "Justice Analysis: trend, anomaly and stability analysis of the world for the Justice subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.sim.justice.analysis", window = 224, buckets = 16, threshold = 4.60 })
		inst.system = S
		inst.ctx = ctx
