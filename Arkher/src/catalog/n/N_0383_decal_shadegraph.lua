-- ARKHER SYSTEM N.0383 :: Decal Effect Graph
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0383"
	S.key = "arkher.vfx.decal.effect_graph"
	S.name = "Decal Effect Graph"
	S.category = "N"
	S.family = "VFX"
	S.area = "Decal"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.decal.curve_authoring" }
	S.tags = { "n", "decal", "shadegraph", "vfx" }
	S.description = "Decal Effect Graph: node graph describing how the effect is shaded for the Decal subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.vfx.decal.effect_graph" })
		inst.system = S
		inst.ctx = ctx
