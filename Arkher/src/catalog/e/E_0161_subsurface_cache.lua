-- ARKHER SYSTEM E.0161 :: Subsurface Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0161"
	S.key = "arkher.material.subsurface.instance_cache"
	S.name = "Subsurface Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Subsurface"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.subsurface.quality_policy" }
	S.tags = { "e", "subsurface", "cache", "material" }
	S.description = "Subsurface Instance Cache: resolved-parameter cache keyed by context for the Subsurface subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.subsurface.instance_cache", policy = "lfu", capacity = 83, ttl = 3 })
		inst.system = S
		inst.ctx = ctx
