-- ARKHER SYSTEM VB.0143 :: Fidelity Band Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0143"
	S.key = "arkher.conttime.fidelityband.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.fidelityband.simulation_fabric" }
	S.tags = { "vb", "fidelityband", "reality", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.conttime.fidelityband.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
