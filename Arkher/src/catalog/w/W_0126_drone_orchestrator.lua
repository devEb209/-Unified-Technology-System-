-- ARKHER SYSTEM W.0126 :: Drone Shot Playback Orchestrator
...
return function(A)
	...
	local S = {}
	S.id = "W.0126"
	S.key = "arkher.cine.drone.playback_orchestrator"
	S.name = "Drone Shot Playback Orchestrator"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Drone Shot"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.drone.cut_policy" }
	S.tags = { "w", "drone", "orchestrator", "cine" }
	S.description = "Drone Shot Playback Orchestrator: the state machine that drives a cinematic from start to end for the Drone Shot subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.cine.drone.playback_orchestrator", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
