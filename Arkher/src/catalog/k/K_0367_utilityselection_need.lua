-- ARKHER SYSTEM K.0367 :: Utility Selection Drive System
...
return function(A)
	...
	local S = {}
	S.id = "K.0367"
	S.key = "arkher.npc.utilityselection.drive_system"
	S.name = "Utility Selection Drive System"
	S.category = "K"
	...
	S.kit = "need"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.utilityselection.memory" }
	S.tags = { "k", "utilityselection", "need", "npc" }
	S.description = "Utility Selection Drive System: drives that decay, turn urgent and get satisfied for the Utility Selection subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("need", { id = "arkher.npc.utilityselection.drive_system" })
		inst.system = S
		inst.ctx = ctx
