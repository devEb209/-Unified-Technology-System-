-- ARKHER SYSTEM I.0254 :: Turn In Place Compression Codec
...
return function(A)
	...
	local S = {}
	S.id = "I.0254"
	S.key = "arkher.anim.turninplace.compression_codec"
	S.name = "Turn In Place Compression Codec"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.turninplace.retarget_graph" }
	S.tags = { "i", "turninplace", "codec", "anim" }
	S.description = "Turn In Place Compression Codec: curve compression and quantized transport for the Turn In Place subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.6,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.anim.turninplace.compression_codec", format = "rle", quantBits = 10 })
		inst.system = S
		inst.ctx = ctx
