-- ARKHER SYSTEM G.0265 :: Performance Prediction Sampling Graph
...
return function(A)
	...
	local S = {}
	S.id = "G.0265"
	S.key = "arkher.neural.perfpredict.sampling_graph"
	S.name = "Performance Prediction Sampling Graph"
	S.category = "G"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.perfpredict.training_ledger" }
	S.tags = { "g", "perfpredict", "graph", "neural" }
	S.description = "Performance Prediction Sampling Graph: dependency graph of sampling stages for the Performance Prediction subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.neural.perfpredict.sampling_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
