-- ARKHER SYSTEM VC.0074 :: LOD Cascade Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VC.0074"
	S.key = "arkher.contneural.lodcascade.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lodcascade.infinite_grid" }
	S.tags = { "vc", "lodcascade", "epoch", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contneural.lodcascade.epoch_clock", tickRate = 10, budget = 8, capacity = 192 })
		inst.system = S
		inst.ctx = ctx
