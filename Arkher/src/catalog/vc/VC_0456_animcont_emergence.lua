-- ARKHER SYSTEM VC.0456 :: Animation Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0456"
	S.key = "arkher.contneural.animcont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.animcont.reality_continuum" }
	S.tags = { "vc", "animcont", "emergence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.animcont.emergence_continuum", windowSize = 4, threshold = 1.20, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
