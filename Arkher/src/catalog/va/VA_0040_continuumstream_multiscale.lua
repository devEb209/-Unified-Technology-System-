-- ARKHER SYSTEM VA.0040 :: Continuum Stream Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VA.0040"
	S.key = "arkher.contworld.continuumstream.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.continuumstream.sparse_residency" }
	S.tags = { "va", "continuumstream", "multiscale", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contworld.continuumstream.multi-scale_fidelity", levels = 6, baseTriangles = 150000 })
		inst.system = S
		inst.ctx = ctx
