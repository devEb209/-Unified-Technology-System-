-- ARKHER SYSTEM VB.0128 :: Spatial Slice World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VB.0128"
	S.key = "arkher.conttime.spatialslice.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.spatialslice.neural_field" }
	S.tags = { "vb", "spatialslice", "worldmemory", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.conttime.spatialslice.world_memory_stream", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
