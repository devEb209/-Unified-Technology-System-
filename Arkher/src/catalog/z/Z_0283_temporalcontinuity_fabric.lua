-- ARKHER SYSTEM Z.0283 :: Temporal Continuity Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0283"
	S.key = "arkher.origin.temporalcontinuity.simulation_fabric"
	S.name = "Temporal Continuity Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.temporalcontinuity.complexity_governance" }
	S.tags = { "z", "temporalcontinuity", "fabric", "origin" }
	S.description = "Temporal Continuity Simulation Fabric: every simulation domain stepped under one budgeted clock for the Temporal Continuity subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.temporalcontinuity.simulation_fabric", budgetMs = 2.5, starvationLimit = 10 })
		inst.system = S
		inst.ctx = ctx
