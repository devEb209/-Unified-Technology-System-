--!strict
-- D-O15 S620 — ANIMATION Node_Flow #0221
...
function M.new(parent: Instance)
    local win=BaseWindow.new({title="D-O15 S620 — ANIMATION Node_Flow #0221", size=Vector2.new(680, 440), pos=UDim2.fromOffset(173, 197), parent=parent, icon="◉"})
