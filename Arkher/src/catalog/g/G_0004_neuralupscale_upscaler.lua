-- ARKHER SYSTEM G.0004 :: Neural Upscaling Reconstruction
...
return function(A)
	...
	local S = {}
	S.id = "G.0004"
	S.key = "arkher.neural.neuralupscale.reconstruction"
	S.name = "Neural Upscaling Reconstruction"
	S.category = "G"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuralupscale.temporal_history" }
	S.tags = { "g", "neuralupscale", "upscaler", "neural" }
	S.description = "Neural Upscaling Reconstruction: resolution ladder and image reconstruction for the Neural Upscaling subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.neural.neuralupscale.reconstruction", targetMs = 14.10, index = 3, sharpness = 0.53 })
		inst.system = S
		inst.ctx = ctx
