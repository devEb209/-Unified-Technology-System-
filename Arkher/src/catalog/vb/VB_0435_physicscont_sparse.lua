-- ARKHER SYSTEM VB.0435 :: Physics Continuum Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VB.0435"
	S.key = "arkher.conttime.physicscont.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.physicscont.epoch_clock" }
	S.tags = { "vb", "physicscont", "sparse", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.conttime.physicscont.sparse_residency", capacity = 1024, pageBytes = 9216 })
		inst.system = S
		inst.ctx = ctx
