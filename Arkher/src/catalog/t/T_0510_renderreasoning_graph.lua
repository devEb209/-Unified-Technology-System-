-- ARKHER SYSTEM T.0510 :: Render Reasoning Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0510"
	S.key = "arkher.ai.renderreasoning.reasoning_graph"
	S.name = "Render Reasoning Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.renderreasoning.world_architect" }
	S.tags = { "t", "renderreasoning", "graph", "ai" }
	S.description = "Render Reasoning Reasoning Graph: relationship modelling and shortest-path reasoning for the Render Reasoning subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 280,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.renderreasoning.reasoning_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
