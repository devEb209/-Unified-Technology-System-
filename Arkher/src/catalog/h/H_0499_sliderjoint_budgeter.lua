-- ARKHER SYSTEM H.0499 :: Slider Joint Budget Governor
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0499"
	S.key = "arkher.physics.sliderjoint.budget_governor"
	S.name = "Slider Joint Budget Governor"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Slider Joint"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.sliderjoint.broadphase_index" }
	S.tags = { "h", "sliderjoint", "budgeter", "physics" }
	S.description = "Slider Joint Budget Governor: simulation time budget allocation across islands for the Slider Joint subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.physics.sliderjoint.budget_governor", total = 194, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
