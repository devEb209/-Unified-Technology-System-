-- ARKHER SYSTEM P.0386 :: Score Inventory
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0386"
	S.key = "arkher.play.score.inventory"
	S.name = "Score Inventory"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Score"
	S.aspect = "Inventory"
	S.kit = "inventory"
	S.version = "1.0.0"
	S.deps = { "arkher.play.score.attributes" }
	S.tags = { "p", "score", "inventory", "play" }
	S.description = "Score Inventory: slots, stacking, weight, equipment and crafting for the Score subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inventory", { id = "arkher.play.score.inventory", slots = 12, maxWeight = 40 })
		inst.system = S
		inst.ctx = ctx
