-- ARKHER SYSTEM VA.0572 :: Mobile Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0572"
	S.key = "arkher.contworld.mobilecont.world_memory_stream"
	S.name = "Mobile Continuum World Memory Stream"
	S.category = "VA"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.mobilecont.neural_field" }
	S.tags = { "va", "mobilecont", "worldmemory", "contworld" }
	S.description = "Mobile Continuum World Memory Stream: world memory continuum over epochs for the Mobile Continuum subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.mobilecont.world_memory_stream", capacity = 288 })
		inst.system = S
		inst.ctx = ctx
