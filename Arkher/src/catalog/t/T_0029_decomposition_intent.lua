-- ARKHER SYSTEM T.0029 :: Task Decomposition Intent Understanding
...
return function(A)
	...
	local S = {}
	S.id = "T.0029"
	S.key = "arkher.ai.decomposition.intent_understanding"
	S.name = "Task Decomposition Intent Understanding"
	S.category = "T"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "t", "decomposition", "intent", "ai" }
	S.description = "Task Decomposition Intent Understanding: natural language turned into an actionable, scored intent for the Task Decomposition subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.ai.decomposition.intent_understanding", minConfidence = 0.37 })
		inst.system = S
		inst.ctx = ctx
