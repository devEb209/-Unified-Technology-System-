-- ARKHER SYSTEM I.0375 :: Retargeting Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0375"
	S.key = "arkher.anim.retargeting.quality_policy"
	S.name = "Retargeting Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Retargeting"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.retargeting.pose_cache" }
	S.tags = { "i", "retargeting", "policy", "anim" }
	S.description = "Retargeting Quality Policy: device tier rules for rate, bones and solvers for the Retargeting subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.retargeting.quality_policy", algorithm = "roundrobin", starvationGuard = 56 })
		inst.system = S
		inst.ctx = ctx
