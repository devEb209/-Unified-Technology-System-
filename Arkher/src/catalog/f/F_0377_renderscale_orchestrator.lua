-- ARKHER SYSTEM F.0377 :: Render Scale Orchestration
...
return function(A)
	...
	local S = {}
	S.id = "F.0377"
	S.key = "arkher.render.renderscale.orchestration"
	S.name = "Render Scale Orchestration"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Render Scale"
	...
	S.kit = "orchestrator"
	S.version = "1.0.0"
	S.deps = { "arkher.render.renderscale.frame_analysis" }
	S.tags = { "f", "renderscale", "orchestrator", "render" }
	S.description = "Render Scale Orchestration: frame lifecycle orchestration for the Render Scale subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 240,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("orchestrator", { id = "arkher.render.renderscale.orchestration", states = { "idle", "warmup", "active", "degraded", "recovering", "halted" } })
		inst.system = S
		inst.ctx = ctx
