-- ARKHER SYSTEM K.0333 :: Curiosity Social Relations
...
return function(A)
	...
	local S = {}
	S.id = "K.0333"
	S.key = "arkher.npc.curiosity.social_relations"
	S.name = "Curiosity Social Relations"
	S.category = "K"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.curiosity.crowd_steering" }
	S.tags = { "k", "curiosity", "society", "npc" }
	S.description = "Curiosity Social Relations: affinity, factions, reputation and gossip for the Curiosity subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 600,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.npc.curiosity.social_relations", decayRate = 0.014, gossipReach = 5 })
		inst.system = S
		inst.ctx = ctx
