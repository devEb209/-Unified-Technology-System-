-- ARKHER SYSTEM H.0651 :: Wheel Suspension Vehicle
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0651"
	S.key = "arkher.physics.suspension.vehicle"
	S.name = "Wheel Suspension Vehicle"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "vehicle"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.suspension.character_motion" }
	S.tags = { "h", "suspension", "vehicle", "physics" }
	S.description = "Wheel Suspension Vehicle: suspension, drivetrain, steering and tire friction for the Wheel Suspension subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 560,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("vehicle", { id = "arkher.physics.suspension.vehicle", mass = 1500, wheelbase = 3.20, track = 1.60, maxRpm = 6600 })
		inst.system = S
		inst.ctx = ctx
