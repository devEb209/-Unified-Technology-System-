-- ARKHER SYSTEM N.0255 :: Portal Spawn Budget
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0255"
	S.key = "arkher.vfx.portal.spawn_budget"
	S.name = "Portal Spawn Budget"
	S.category = "N"
	S.family = "VFX"
	S.area = "Portal"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.portal.effect_composition" }
	S.tags = { "n", "portal", "budgeter", "vfx" }
	S.description = "Portal Spawn Budget: global particle budget shared by every live effect for the Portal subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.vfx.portal.spawn_budget", total = 83, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
