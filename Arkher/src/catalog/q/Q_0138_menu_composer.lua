-- ARKHER SYSTEM Q.0138 :: Menu Theme Composition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0138"
	S.key = "arkher.ui.menu.theme_composition"
	S.name = "Menu Theme Composition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Menu"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.menu.navigation_graph" }
	S.tags = { "q", "menu", "composer", "ui" }
	S.description = "Menu Theme Composition: blending of theme signals into the final appearance for the Menu subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 560,
		baseWeight = 0.66,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.ui.menu.theme_composition", mode = "max" })
		inst.system = S
		inst.ctx = ctx
