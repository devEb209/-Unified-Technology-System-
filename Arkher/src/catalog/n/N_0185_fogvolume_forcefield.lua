-- ARKHER SYSTEM N.0185 :: Fog Volume Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0185"
	S.key = "arkher.vfx.fogvolume.force_field"
	S.name = "Fog Volume Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fog Volume"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fogvolume.particle_simulation" }
	S.tags = { "n", "fogvolume", "forcefield", "vfx" }
	S.description = "Fog Volume Force Field: wind, attraction, vortex, drag and curl turbulence for the Fog Volume subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.fogvolume.force_field", seed = 7678 })
		inst.system = S
		inst.ctx = ctx
