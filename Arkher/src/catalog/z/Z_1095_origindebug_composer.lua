-- ARKHER SYSTEM Z.1095 :: Original Tech Debug Signal Composition
...
return function(A)
	...
	local S = {}
	S.id = "Z.1095"
	S.key = "arkher.origin.origindebug.signal_composition"
	S.name = "Original Tech Debug Signal Composition"
	S.category = "Z"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.origindebug.telemetry_ledger" }
	S.tags = { "z", "origindebug", "composer", "origin" }
	S.description = "Original Tech Debug Signal Composition: blending of the technology's input signals into one output for the Original Tech Debug subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.origin.origindebug.signal_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
