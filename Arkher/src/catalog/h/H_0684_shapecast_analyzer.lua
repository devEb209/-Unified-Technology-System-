-- ARKHER SYSTEM H.0684 :: Shapecast Query Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0684"
	S.key = "arkher.physics.shapecast.analysis"
	S.name = "Shapecast Query Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.shapecast.result_cache" }
	S.tags = { "h", "shapecast", "analyzer", "physics" }
	S.description = "Shapecast Query Analysis: energy, jitter and cost analysis of the simulation for the Shapecast Query subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 480,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.shapecast.analysis", window = 244, buckets = 16, threshold = 4.60 })
		inst.system = S
		inst.ctx = ctx
