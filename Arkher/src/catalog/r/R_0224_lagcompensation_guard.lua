-- ARKHER SYSTEM R.0224 :: Lag Compensation Rate Guard
...
return function(A)
	...
	local S = {}
	S.id = "R.0224"
	S.key = "arkher.net.lagcompensation.rate_guard"
	S.name = "Lag Compensation Rate Guard"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.kit = "guard"
	S.version = "1.0.0"
	S.deps = { "arkher.net.lagcompensation.interest_streaming" }
	S.tags = { "r", "lagcompensation", "guard", "net" }
	S.description = "Lag Compensation Rate Guard: token-bucket protection against floods and abuse for the Lag Compensation subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("guard", { id = "arkher.net.lagcompensation.rate_guard", algorithm = "token", capacity = 59, refillPerSec = 44, windowSec = 1 })
		inst.system = S
		inst.ctx = ctx
