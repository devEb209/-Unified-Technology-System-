-- ARKHER SYSTEM VD.0206 :: Biome Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0206"
	S.key = "arkher.contsim.biomecont.epoch_clock"
	S.name = "Biome Continuum Epoch Clock"
	S.category = "VD"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.biomecont.infinite_grid" }
	S.tags = { "vd", "biomecont", "epoch", "contsim" }
	S.description = "Biome Continuum Epoch Clock: deterministic epoch timeline with catch-up for the Biome Continuum subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.biomecont.epoch_clock", tickRate = 10, budget = 4, capacity = 64 })
		inst.system = S
		inst.ctx = ctx
