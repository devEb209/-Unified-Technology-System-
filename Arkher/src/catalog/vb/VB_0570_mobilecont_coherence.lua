-- ARKHER SYSTEM VB.0570 :: Mobile Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VB.0570"
	S.key = "arkher.conttime.mobilecont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.mobilecont.persistent_state" }
	S.tags = { "vb", "mobilecont", "coherence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.conttime.mobilecont.coherence_guard", window = 62, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
