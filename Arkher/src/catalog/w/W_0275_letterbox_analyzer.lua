-- ARKHER SYSTEM W.0275 :: Letterbox Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0275"
	S.key = "arkher.cine.letterbox.sequence_analysis"
	S.name = "Letterbox Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Letterbox"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.letterbox.frame_budget" }
	S.tags = { "w", "letterbox", "analyzer", "cine" }
	S.description = "Letterbox Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Letterbox subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.letterbox.sequence_analysis", window = 182, buckets = 10, threshold = 3.40 })
		inst.system = S
		inst.ctx = ctx
