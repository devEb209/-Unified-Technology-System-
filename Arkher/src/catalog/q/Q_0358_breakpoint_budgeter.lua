-- ARKHER SYSTEM Q.0358 :: Responsive Breakpoint Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0358"
	S.key = "arkher.ui.breakpoint.frame_budget"
	S.name = "Responsive Breakpoint Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.breakpoint.accessibility_policy" }
	S.tags = { "q", "breakpoint", "budgeter", "ui" }
	S.description = "Responsive Breakpoint Frame Budget: per-frame layout and draw budget for the interface for the Responsive Breakpoint subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.breakpoint.frame_budget", total = 351, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
