-- ARKHER SYSTEM H.0074 :: Center Of Mass Constraint Solver
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0074"
	S.key = "arkher.physics.centerofmass.constraint_solver"
	S.name = "Center Of Mass Constraint Solver"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "constraint"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.centerofmass.contact_generation" }
	S.tags = { "h", "centerofmass", "constraint", "physics" }
	S.description = "Center Of Mass Constraint Solver: sequential impulses, friction, joints and warm starting for the Center Of Mass subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("constraint", { id = "arkher.physics.centerofmass.constraint_solver", iterations = 13, baumgarte = 0.19, warmStart = true })
		inst.system = S
		inst.ctx = ctx
