-- ARKHER SYSTEM VD.0628 :: Interest Field Multi-Scale Fidelity
...
return function(A)
	...
	local S = {}
	S.id = "VD.0628"
	S.key = "arkher.contsim.interestfield.multi-scale_fidelity"
	...
	S.kit = "multiscale"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.interestfield.sparse_residency" }
	S.tags = { "vd", "interestfield", "multiscale", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("multiscale", { id = "arkher.contsim.interestfield.multi-scale_fidelity", levels = 5, baseTriangles = 165000 })
		inst.system = S
		inst.ctx = ctx
