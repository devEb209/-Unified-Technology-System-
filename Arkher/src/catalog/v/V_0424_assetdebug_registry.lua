-- ARKHER SYSTEM V.0424 :: Asset Debug Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0424"
	S.key = "arkher.asset.assetdebug.asset_registry"
	S.name = "Asset Debug Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetdebug.cook_pipeline" }
	S.tags = { "v", "assetdebug", "registry", "asset" }
	S.description = "Asset Debug Asset Registry: catalogue of every asset, its tags and its metadata for the Asset Debug subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.assetdebug.asset_registry" })
		inst.system = S
		inst.ctx = ctx
