-- ARKHER SYSTEM K.0537 :: Dialogue Behaviour Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0537"
	S.key = "arkher.npc.dialoguebehaviour.perception"
	S.name = "Dialogue Behaviour Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.dialoguebehaviour.emotion" }
	S.tags = { "k", "dialoguebehaviour", "perception", "npc" }
	S.description = "Dialogue Behaviour Perception: sight, hearing and bounded attention for the Dialogue Behaviour subsystem."
	S.params = {
		backlogLimit = 38,
		baseRadius = 560,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.dialoguebehaviour.perception", sightRange = 55, hearingRange = 28, attentionSlots = 5, fov = 1.900 })
		inst.system = S
		inst.ctx = ctx
