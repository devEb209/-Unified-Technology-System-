-- ARKHER SYSTEM O.0056 :: Explosion Sound Compression Codec
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0056"
	S.key = "arkher.audio.explosionsound.compression_codec"
	S.name = "Explosion Sound Compression Codec"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.explosionsound.asset_registry" }
	S.tags = { "o", "explosionsound", "codec", "audio" }
	S.description = "Explosion Sound Compression Codec: payload encoding of audio state and events for the Explosion Sound subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.audio.explosionsound.compression_codec", format = "json", quantBits = 11 })
		inst.system = S
		inst.ctx = ctx
