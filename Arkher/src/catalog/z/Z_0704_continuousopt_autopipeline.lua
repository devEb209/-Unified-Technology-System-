-- ARKHER SYSTEM Z.0704 :: Continuous Self Optimization Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0704"
	S.key = "arkher.origin.continuousopt.autonomous_pipeline"
	S.name = "Continuous Self Optimization Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.continuousopt.simulation_fabric" }
	S.tags = { "z", "continuousopt", "autopipeline", "origin" }
	S.description = "Continuous Self Optimization Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Continuous Self Optimization subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.continuousopt.autonomous_pipeline", maxIterations = 9 })
		inst.system = S
		inst.ctx = ctx
