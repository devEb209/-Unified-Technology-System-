-- ARKHER SYSTEM VC.0607 :: Seam Lattice Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0607"
	S.key = "arkher.contneural.seamlattice.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.seamlattice.coherence_guard" }
	S.tags = { "vc", "seamlattice", "neuralfield", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.seamlattice.neural_field", dims = 16, hidden = 12, seed = 22021 })
		inst.system = S
		inst.ctx = ctx
