-- ARKHER SYSTEM P.0393 :: Score Difficulty Controller
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0393"
	S.key = "arkher.play.score.difficulty_controller"
	S.name = "Score Difficulty Controller"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Score"
	...
	S.kit = "controller"
	S.version = "1.0.0"
	S.deps = { "arkher.play.score.balance_analysis" }
	S.tags = { "p", "score", "controller", "play" }
	S.description = "Score Difficulty Controller: closed-loop tuning toward a target challenge for the Score subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 400,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("controller", { id = "arkher.play.score.difficulty_controller", mode = "pid", target = 0.600, kp = 0.250, ki = 0.080, kd = 0.010, min = 0.05, max = 1.0, initial = 0.50, deadband = 0.01 })
		inst.system = S
		inst.ctx = ctx
