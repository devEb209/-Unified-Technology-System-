-- ARKHER SYSTEM Z.0444 :: Player Absence Simulation Autonomous Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "Z.0444"
	S.key = "arkher.origin.playerabsence.autonomous_pipeline"
	S.name = "Player Absence Simulation Autonomous Pipeline"
	S.category = "Z"
	...
	S.kit = "autopipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.playerabsence.simulation_fabric" }
	S.tags = { "z", "playerabsence", "autopipeline", "origin" }
	S.description = "Player Absence Simulation Autonomous Pipeline: the project analysing and repairing itself, with measured gain for the Player Absence Simulation subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.77,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("autopipeline", { id = "arkher.origin.playerabsence.autonomous_pipeline", maxIterations = 7 })
		inst.system = S
		inst.ctx = ctx
