-- ARKHER SYSTEM H.0523 :: Breakable Joint Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0523"
	S.key = "arkher.physics.breakjoint.query"
	S.name = "Breakable Joint Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.breakjoint.constraint_solver" }
	S.tags = { "h", "breakjoint", "raycaster", "physics" }
	S.description = "Breakable Joint Query: rays, sweeps and overlaps against the simulation for the Breakable Joint subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.breakjoint.query", cellSize = 48 })
		inst.system = S
		inst.ctx = ctx
