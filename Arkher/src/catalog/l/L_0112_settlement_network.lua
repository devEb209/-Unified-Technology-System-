-- ARKHER SYSTEM L.0112 :: Settlement Route Network
...
return function(A)
	...
	local S = {}
	S.id = "L.0112"
	S.key = "arkher.sim.settlement.route_network"
	S.name = "Settlement Route Network"
	S.category = "L"
	...
	S.kit = "network"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.settlement.region_graph" }
	S.tags = { "l", "settlement", "network", "sim" }
	S.description = "Settlement Route Network: roads, rivers and routes between settlements for the Settlement subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 480,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("network", { id = "arkher.sim.settlement.route_network" })
		inst.system = S
		inst.ctx = ctx
