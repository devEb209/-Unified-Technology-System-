-- ARKHER SYSTEM W.0118 :: Orbit Frame Budget
...
return function(A)
	...
	local S = {}
	S.id = "W.0118"
	S.key = "arkher.cine.orbit.frame_budget"
	S.name = "Orbit Frame Budget"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Orbit"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.orbit.event_ledger" }
	S.tags = { "w", "orbit", "budgeter", "cine" }
	S.description = "Orbit Frame Budget: per-frame cost budget for the cinematic systems for the Orbit subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 160,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.cine.orbit.frame_budget", total = 348, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
