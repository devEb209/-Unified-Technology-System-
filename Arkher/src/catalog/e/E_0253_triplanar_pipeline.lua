-- ARKHER SYSTEM E.0253 :: Triplanar Projection Authoring Pipeline
...
return function(A)
	...
	local S = {}
	S.id = "E.0253"
	S.key = "arkher.material.triplanar.authoring_pipeline"
	S.name = "Triplanar Projection Authoring Pipeline"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "pipeline"
	S.version = "1.0.0"
	S.deps = { "arkher.material.triplanar.analysis" }
	S.tags = { "e", "triplanar", "pipeline", "material" }
	S.description = "Triplanar Projection Authoring Pipeline: ordered authoring and bake stages for the Triplanar Projection subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("pipeline", { id = "arkher.material.triplanar.authoring_pipeline", budgetMs = 4.00 })
		inst.system = S
		inst.ctx = ctx
