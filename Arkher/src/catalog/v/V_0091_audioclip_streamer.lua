-- ARKHER SYSTEM V.0091 :: Audio Clip Streaming Residency
...
return function(A)
	...
	local S = {}
	S.id = "V.0091"
	S.key = "arkher.asset.audioclip.streaming_residency"
	S.name = "Audio Clip Streaming Residency"
	S.category = "V"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.audioclip.content_cache" }
	S.tags = { "v", "audioclip", "streamer", "asset" }
	S.description = "Audio Clip Streaming Residency: distance-driven load and unload of asset payloads for the Audio Clip subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.asset.audioclip.streaming_residency", radius = 400, chunkSize = 96, maxPerFrame = 3 })
		inst.system = S
		inst.ctx = ctx
