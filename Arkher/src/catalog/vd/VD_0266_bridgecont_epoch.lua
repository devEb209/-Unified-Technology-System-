-- ARKHER SYSTEM VD.0266 :: Bridge Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VD.0266"
	S.key = "arkher.contsim.bridgecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.bridgecont.infinite_grid" }
	S.tags = { "vd", "bridgecont", "epoch", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contsim.bridgecont.epoch_clock", tickRate = 30, budget = 10, capacity = 256 })
		inst.system = S
		inst.ctx = ctx
