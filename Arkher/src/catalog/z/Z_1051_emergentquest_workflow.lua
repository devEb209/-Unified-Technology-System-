-- ARKHER SYSTEM Z.1051 :: Emergent Quest Generation Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.1051"
	S.key = "arkher.origin.emergentquest.adaptive_workflow"
	S.name = "Emergent Quest Generation Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentquest.self_critique" }
	S.tags = { "z", "emergentquest", "workflow", "origin" }
	S.description = "Emergent Quest Generation Adaptive Workflow: verified, retryable, reversible execution plans for the Emergent Quest Generation subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 600,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.emergentquest.adaptive_workflow", maxRetries = 3, budget = 150 })
		inst.system = S
		inst.ctx = ctx
