-- ARKHER SYSTEM K.0415 :: Interruption Navigation
...
return function(A)
	...
	local S = {}
	S.id = "K.0415"
	S.key = "arkher.npc.interruption.navigation"
	S.name = "Interruption Navigation"
	S.category = "K"
	...
	S.kit = "navgraph"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.interruption.goal_planner" }
	S.tags = { "k", "interruption", "navgraph", "npc" }
	S.description = "Interruption Navigation: grid pathfinding, smoothing, line of sight and flow fields for the Interruption subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("navgraph", { id = "arkher.npc.interruption.navigation", width = 24, height = 24, cellSize = 2 })
		inst.system = S
		inst.ctx = ctx
