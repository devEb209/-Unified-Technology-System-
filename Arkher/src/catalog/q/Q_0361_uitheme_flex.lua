-- ARKHER SYSTEM Q.0361 :: Theme Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0361"
	S.key = "arkher.ui.uitheme.responsive_layout"
	S.name = "Theme Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Theme"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "uitheme", "flex", "ui" }
	S.description = "Theme Responsive Layout: flex solving with safe areas, weights and breakpoints for the Theme subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.uitheme.responsive_layout", width = 630, height = 1084, scale = 0.99 })
		inst.system = S
		inst.ctx = ctx
