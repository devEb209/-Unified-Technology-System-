-- ARKHER SYSTEM VC.0404 :: Perception Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0404"
	S.key = "arkher.contneural.perceptioncont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.perceptioncont.neural_field" }
	S.tags = { "vc", "perceptioncont", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.perceptioncont.world_memory_stream", capacity = 160 })
		inst.system = S
		inst.ctx = ctx
