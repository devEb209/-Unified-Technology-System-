-- ARKHER SYSTEM R.0217 :: Lag Compensation Replication
...
return function(A)
	...
	local S = {}
	S.id = "R.0217"
	S.key = "arkher.net.lagcompensation.replication"
	S.name = "Lag Compensation Replication"
	S.category = "R"
	S.family = "NETWORKING"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "r", "lagcompensation", "replicator", "net" }
	S.description = "Lag Compensation Replication: authoritative entity state, interest and delta snapshots for the Lag Compensation subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.56,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("replicator", { id = "arkher.net.lagcompensation.replication", mtu = 1200, interestRadius = 360, fullEvery = 90 })
		inst.system = S
		inst.ctx = ctx
