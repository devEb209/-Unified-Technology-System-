-- ARKHER SYSTEM VA.0526 :: Asset Continuum Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "VA.0526"
	S.key = "arkher.contworld.assetcont.simulation_fabric"
	S.name = "Asset Continuum Simulation Fabric"
	S.category = "VA"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.assetcont.complexity_budget" }
	S.tags = { "va", "assetcont", "fabric", "contworld" }
	S.description = "Asset Continuum Simulation Fabric: fabric stepping the continuum domains for the Asset Continuum subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.contworld.assetcont.simulation_fabric", budgetMs = 3.0, starvationLimit = 9 })
		inst.system = S
		inst.ctx = ctx
