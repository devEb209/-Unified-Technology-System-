-- ARKHER SYSTEM Z.0151 :: Autonomous Development Pipeline Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0151"
	S.key = "arkher.origin.autodevpipeline.adaptive_workflow"
	S.name = "Autonomous Development Pipeline Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.autodevpipeline.self_critique" }
	S.tags = { "z", "autodevpipeline", "workflow", "origin" }
	S.description = "Autonomous Development Pipeline Adaptive Workflow: verified, retryable, reversible execution plans for the Autonomous Development Pipeline subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 440,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.autodevpipeline.adaptive_workflow", maxRetries = 2, budget = 110 })
		inst.system = S
		inst.ctx = ctx
