-- ARKHER SYSTEM VD.0498 :: Rendering Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0498"
	S.key = "arkher.contsim.rendercont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.rendercont.persistent_state" }
	S.tags = { "vd", "rendercont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.rendercont.coherence_guard", window = 53, threshold = 0.13 })
		inst.system = S
		inst.ctx = ctx
