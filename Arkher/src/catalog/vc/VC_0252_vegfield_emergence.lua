-- ARKHER SYSTEM VC.0252 :: Vegetation Field Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VC.0252"
	S.key = "arkher.contneural.vegfield.emergence_continuum"
	S.name = "Vegetation Field Emergence Continuum"
	S.category = "VC"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.vegfield.reality_continuum" }
	S.tags = { "vc", "vegfield", "emergence", "contneural" }
	S.description = "Vegetation Field Emergence Continuum: emergence detection over the continuum for the Vegetation Field subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contneural.vegfield.emergence_continuum", windowSize = 4, threshold = 1.30, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
