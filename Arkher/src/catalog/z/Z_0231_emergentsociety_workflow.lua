-- ARKHER SYSTEM Z.0231 :: Emergent Society Framework Adaptive Workflow
...
return function(A)
	...
	local S = {}
	S.id = "Z.0231"
	S.key = "arkher.origin.emergentsociety.adaptive_workflow"
	S.name = "Emergent Society Framework Adaptive Workflow"
	S.category = "Z"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.emergentsociety.self_critique" }
	S.tags = { "z", "emergentsociety", "workflow", "origin" }
	S.description = "Emergent Society Framework Adaptive Workflow: verified, retryable, reversible execution plans for the Emergent Society Framework subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.origin.emergentsociety.adaptive_workflow", maxRetries = 2, budget = 80 })
		inst.system = S
		inst.ctx = ctx
