-- ARKHER SYSTEM Q.0099 :: Modal Input Mapping
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0099"
	S.key = "arkher.ui.modal.input_mapping"
	S.name = "Modal Input Mapping"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Modal"
	...
	S.kit = "inputmap"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.modal.widget_tree" }
	S.tags = { "q", "modal", "inputmap", "ui" }
	S.description = "Modal Input Mapping: one action bound to touch, gamepad, keyboard and mouse for the Modal subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 480,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("inputmap", { id = "arkher.ui.modal.input_mapping", device = "keyboard", holdTime = 0.25, deadzone = 0.15 })
		inst.system = S
		inst.ctx = ctx
