-- ARKHER SYSTEM G.0353 :: Batch Inference Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0353"
	S.key = "arkher.neural.batchinference.temporal_history"
	S.name = "Batch Inference Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.batchinference.feature_extraction" }
	S.tags = { "g", "batchinference", "temporal", "neural" }
	S.description = "Batch Inference Temporal History: history buffers reused across frames for the Batch Inference subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 360,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.batchinference.temporal_history", feedback = 0.91, phase = 8 })
		inst.system = S
		inst.ctx = ctx
