-- ARKHER SYSTEM T.0647 :: Human Handoff Plan Workflow
...
return function(A)
	...
	local S = {}
	S.id = "T.0647"
	S.key = "arkher.ai.humanhandoff.plan_workflow"
	S.name = "Human Handoff Plan Workflow"
	S.category = "T"
	...
	S.kit = "workflow"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.humanhandoff.semantic_knowledge" }
	S.tags = { "t", "humanhandoff", "workflow", "ai" }
	S.description = "Human Handoff Plan Workflow: dependency-ordered plans that verify, retry and roll back for the Human Handoff subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.8,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("workflow", { id = "arkher.ai.humanhandoff.plan_workflow", maxRetries = 2, budget = 80 })
		inst.system = S
		inst.ctx = ctx
