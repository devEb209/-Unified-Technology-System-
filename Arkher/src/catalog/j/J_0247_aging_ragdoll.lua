-- ARKHER SYSTEM J.0247 :: Aging Physical Response
...
return function(A)
	...
	local S = {}
	S.id = "J.0247"
	S.key = "arkher.character.aging.physical_response"
	S.name = "Aging Physical Response"
	S.category = "J"
	...
	S.kit = "ragdoll"
	S.version = "1.0.0"
	S.deps = { "arkher.character.aging.look_and_reach" }
	S.tags = { "j", "aging", "ragdoll", "character" }
	S.description = "Aging Physical Response: physical reaction, ragdoll and recovery for the Aging subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 240,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ragdoll", { id = "arkher.character.aging.physical_response", blendSpeed = 3.40 })
		inst.system = S
		inst.ctx = ctx
