-- ARKHER SYSTEM O.0054 :: Explosion Sound Streaming
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0054"
	S.key = "arkher.audio.explosionsound.streaming"
	S.name = "Explosion Sound Streaming"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.kit = "streamer"
	S.version = "1.0.0"
	S.deps = { "arkher.audio.explosionsound.voice_budget" }
	S.tags = { "o", "explosionsound", "streamer", "audio" }
	S.description = "Explosion Sound Streaming: distance-driven residency of audio assets for the Explosion Sound subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("streamer", { id = "arkher.audio.explosionsound.streaming", radius = 200, chunkSize = 64, maxPerFrame = 2 })
		inst.system = S
		inst.ctx = ctx
