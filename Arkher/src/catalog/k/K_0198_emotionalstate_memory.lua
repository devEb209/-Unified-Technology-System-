-- ARKHER SYSTEM K.0198 :: Emotional State Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0198"
	S.key = "arkher.npc.emotionalstate.memory"
	S.name = "Emotional State Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.emotionalstate.mind_network" }
	S.tags = { "k", "emotionalstate", "memory", "npc" }
	S.description = "Emotional State Memory: episodic memory with decay, recall and consolidation for the Emotional State subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.emotionalstate.memory", capacity = 80, decayRate = 0.040, consolidateAt = 2 })
		inst.system = S
		inst.ctx = ctx
