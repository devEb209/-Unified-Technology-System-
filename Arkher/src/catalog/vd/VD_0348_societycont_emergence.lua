-- ARKHER SYSTEM VD.0348 :: Society Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0348"
	S.key = "arkher.contsim.societycont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.societycont.reality_continuum" }
	S.tags = { "vd", "societycont", "emergence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.contsim.societycont.emergence_continuum", windowSize = 6, threshold = 1.40, minCount = 2 })
		inst.system = S
		inst.ctx = ctx
