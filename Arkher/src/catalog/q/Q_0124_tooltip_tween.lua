-- ARKHER SYSTEM Q.0124 :: Tooltip Transition
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0124"
	S.key = "arkher.ui.tooltip.transition"
	S.name = "Tooltip Transition"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Tooltip"
	S.aspect = "Transition"
	S.kit = "tween"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.tooltip.input_mapping" }
	S.tags = { "q", "tooltip", "tween", "ui" }
	S.description = "Tooltip Transition: eased, delayed, looped and sequenced motion for the Tooltip subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("tween", { id = "arkher.ui.tooltip.transition", timeScale = 0.92 })
		inst.system = S
		inst.ctx = ctx
