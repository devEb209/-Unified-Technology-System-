-- ARKHER SYSTEM G.0367 :: Feature Cache Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0367"
	S.key = "arkher.neural.featurecache.temporal_history"
	S.name = "Feature Cache Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.featurecache.feature_extraction" }
	S.tags = { "g", "featurecache", "temporal", "neural" }
	S.description = "Feature Cache Temporal History: history buffers reused across frames for the Feature Cache subsystem."
	S.params = {
		backlogLimit = 14,
		baseRadius = 400,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.featurecache.temporal_history", feedback = 0.86, phase = 8 })
		inst.system = S
		inst.ctx = ctx
