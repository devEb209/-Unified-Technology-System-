-- ARKHER SYSTEM E.0047 :: Roughness Layer Composition
...
return function(A)
	...
	local S = {}
	S.id = "E.0047"
	S.key = "arkher.material.roughness.layer_composition"
	S.name = "Roughness Layer Composition"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Roughness"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.roughness.definition" }
	S.tags = { "e", "roughness", "composer", "material" }
	S.description = "Roughness Layer Composition: ordered layer composition with blend rules for the Roughness subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.material.roughness.layer_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
