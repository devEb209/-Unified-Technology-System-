-- ARKHER SYSTEM VD.0265 :: Bridge Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VD.0265"
	S.key = "arkher.contsim.bridgecont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vd", "bridgecont", "continuum", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contsim.bridgecont.infinite_grid", cellSize = 160, radius = 800, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
