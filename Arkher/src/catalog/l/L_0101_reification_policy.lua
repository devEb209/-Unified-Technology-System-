-- ARKHER SYSTEM L.0101 :: Reification Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0101"
	S.key = "arkher.sim.reification.fidelity_policy"
	S.name = "Reification Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.reification.streaming" }
	S.tags = { "l", "reification", "policy", "sim" }
	S.description = "Reification Fidelity Policy: rules that pick full, cohort or statistical simulation for the Reification subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.reification.fidelity_policy", algorithm = "lottery", starvationGuard = 39 })
		inst.system = S
		inst.ctx = ctx
