-- ARKHER SYSTEM N.0317 :: Trail Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0317"
	S.key = "arkher.vfx.trail.curve_authoring"
	S.name = "Trail Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Trail"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.trail.ribbon_and_trail" }
	S.tags = { "n", "trail", "spline", "vfx" }
	S.description = "Trail Curve Authoring: authored curves driving the effect over its life for the Trail subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.trail.curve_authoring", tension = 0.64, closed = false })
		inst.system = S
		inst.ctx = ctx
