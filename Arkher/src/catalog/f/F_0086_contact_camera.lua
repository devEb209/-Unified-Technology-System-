-- ARKHER SYSTEM F.0086 :: Contact Shadows View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0086"
	S.key = "arkher.render.contact.view_and_culling"
	S.name = "Contact Shadows View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.contact.frame_graph" }
	S.tags = { "f", "contact", "camera", "render" }
	S.description = "Contact Shadows View And Culling: view state, frustum culling and screen-size LOD for the Contact Shadows subsystem."
	S.params = {
		backlogLimit = 31,
		baseRadius = 440,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.contact.view_and_culling", width = 1212, height = 1260, fov = 1.1300, far = 1400 })
		inst.system = S
		inst.ctx = ctx
