-- ARKHER SYSTEM E.0289 :: Wear And Tear Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0289"
	S.key = "arkher.material.wear.texture_sampling"
	S.name = "Wear And Tear Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.wear.shading_graph" }
	S.tags = { "e", "wear", "sampler", "material" }
	S.description = "Wear And Tear Texture Sampling: atlas packing, mip chain and filtered sampling for the Wear And Tear subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 280,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.wear.texture_sampling", atlasSize = 320, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
