-- ARKHER SYSTEM P.0466 :: Tutorial Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0466"
	S.key = "arkher.play.tutorial.content_registry"
	S.name = "Tutorial Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Tutorial"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.tutorial.difficulty_controller" }
	S.tags = { "p", "tutorial", "registry", "play" }
	S.description = "Tutorial Content Registry: catalogue of the definitions this loop instantiates for the Tutorial subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.tutorial.content_registry" })
		inst.system = S
		inst.ctx = ctx
