-- ARKHER SYSTEM E.0576 :: Material Validation Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0576"
	S.key = "arkher.material.validation.variant_registry"
	S.name = "Material Validation Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.validation.procedural_detail" }
	S.tags = { "e", "validation", "registry", "material" }
	S.description = "Material Validation Variant Registry: named variants and their lifecycle for the Material Validation subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.validation.variant_registry" })
		inst.system = S
		inst.ctx = ctx
