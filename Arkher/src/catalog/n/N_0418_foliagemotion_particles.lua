-- ARKHER SYSTEM N.0418 :: Foliage Motion Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0418"
	S.key = "arkher.vfx.foliagemotion.particle_simulation"
	S.name = "Foliage Motion Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.foliagemotion.emission" }
	S.tags = { "n", "foliagemotion", "particles", "vfx" }
	S.description = "Foliage Motion Particle Simulation: pooled integration of position, velocity, colour and life for the Foliage Motion subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.foliagemotion.particle_simulation", capacity = 128, drag = 0.09, bounce = 0.34, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
