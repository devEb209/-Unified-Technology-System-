-- ARKHER SYSTEM G.0492 :: Neural Debug Feature Extraction
...
return function(A)
	...
	local S = {}
	S.id = "G.0492"
	S.key = "arkher.neural.neuraldebug.feature_extraction"
	S.name = "Neural Debug Feature Extraction"
	S.category = "G"
	...
	S.kit = "field"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.neuraldebug.inference_core" }
	S.tags = { "g", "neuraldebug", "field", "neural" }
	S.description = "Neural Debug Feature Extraction: signal features feeding the model for the Neural Debug subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 600,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("field", { id = "arkher.neural.neuraldebug.feature_extraction", seed = 78107, frequency = 0.0107, octaves = 6, gain = 0.5, lacunarity = 2.0 })
		inst.system = S
		inst.ctx = ctx
