-- ARKHER SYSTEM VB.0554 :: Device Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VB.0554"
	S.key = "arkher.conttime.devicecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.devicecont.infinite_grid" }
	S.tags = { "vb", "devicecont", "epoch", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.conttime.devicecont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
