-- ARKHER SYSTEM L.0334 :: Market Society
...
return function(A)
	...
	local S = {}
	S.id = "L.0334"
	S.key = "arkher.sim.market.society"
	S.name = "Market Society"
	S.category = "L"
	...
	S.kit = "society"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.market.economy" }
	S.tags = { "l", "market", "society", "sim" }
	S.description = "Market Society: relations, factions, reputation and cohesion of the region for the Market subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("society", { id = "arkher.sim.market.society", decayRate = 0.007, gossipReach = 2 })
		inst.system = S
		inst.ctx = ctx
