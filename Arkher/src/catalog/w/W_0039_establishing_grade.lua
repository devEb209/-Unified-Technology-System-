-- ARKHER SYSTEM W.0039 :: Establishing Shot Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0039"
	S.key = "arkher.cine.establishing.colour_grade"
	S.name = "Establishing Shot Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.establishing.camera_rig" }
	S.tags = { "w", "establishing", "grade", "cine" }
	S.description = "Establishing Shot Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Establishing Shot subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 520,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.establishing.colour_grade", exposure = -0.06, contrast = 0.99, saturation = 0.89, toneMap = "reinhard" })
		inst.system = S
		inst.ctx = ctx
