-- ARKHER SYSTEM Z.0901 :: Deterministic Replay Reality Layering
...
return function(A)
	...
	local S = {}
	S.id = "Z.0901"
	S.key = "arkher.origin.deterministicreplay.reality_layering"
	S.name = "Deterministic Replay Reality Layering"
	S.category = "Z"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "z", "deterministicreplay", "reality", "origin" }
	S.description = "Deterministic Replay Reality Layering: stacked authored, simulated, proposed and player realities for the Deterministic Replay subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.origin.deterministicreplay.reality_layering" })
		inst.system = S
		inst.ctx = ctx
