-- ARKHER SYSTEM I.0105 :: Clip Events Skeleton
...
return function(A)
	...
	local S = {}
	S.id = "I.0105"
	S.key = "arkher.anim.clipevents.skeleton"
	S.name = "Clip Events Skeleton"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Clip Events"
	S.aspect = "Skeleton"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "i", "clipevents", "skeleton", "anim" }
	S.description = "Clip Events Skeleton: bone hierarchy, bind pose and world resolution for the Clip Events subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("skeleton", { id = "arkher.anim.clipevents.skeleton" })
		inst.system = S
		inst.ctx = ctx
