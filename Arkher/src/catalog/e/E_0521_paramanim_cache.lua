-- ARKHER SYSTEM E.0521 :: Parameter Animation Instance Cache
...
return function(A)
	...
	local S = {}
	S.id = "E.0521"
	S.key = "arkher.material.paramanim.instance_cache"
	S.name = "Parameter Animation Instance Cache"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.material.paramanim.quality_policy" }
	S.tags = { "e", "paramanim", "cache", "material" }
	S.description = "Parameter Animation Instance Cache: resolved-parameter cache keyed by context for the Parameter Animation subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.material.paramanim.instance_cache", policy = "lfu", capacity = 80, ttl = 2 })
		inst.system = S
		inst.ctx = ctx
