-- ARKHER SYSTEM W.0092 :: Crane Cinematic Mix
...
return function(A)
	...
	local S = {}
	S.id = "W.0092"
	S.key = "arkher.cine.crane.cinematic_mix"
	S.name = "Crane Cinematic Mix"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Crane"
	...
	S.kit = "mixer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.crane.motion_tween" }
	S.tags = { "w", "crane", "mixer", "cine" }
	S.description = "Crane Cinematic Mix: bus routing and ducking for the cinematic soundtrack for the Crane subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 360,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mixer", { id = "arkher.cine.crane.cinematic_mix", maxVoices = 56 })
		inst.system = S
		inst.ctx = ctx
