-- ARKHER SYSTEM P.0124 :: Loot Combat Resolution
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0124"
	S.key = "arkher.play.loot.combat_resolution"
	S.name = "Loot Combat Resolution"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Loot"
	...
	S.kit = "combat"
	S.version = "1.0.0"
	S.deps = { "arkher.play.loot.objectives" }
	S.tags = { "p", "loot", "combat", "play" }
	S.description = "Loot Combat Resolution: accuracy, mitigation, criticals, statuses and death for the Loot subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("combat", { id = "arkher.play.loot.combat_resolution", seed = 44028, armourK = 120, critMultiplier = 1.50 })
		inst.system = S
		inst.ctx = ctx
