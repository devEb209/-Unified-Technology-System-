-- ARKHER SYSTEM VC.0517 :: Asset Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0517"
	S.key = "arkher.contneural.assetcont.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "assetcont", "continuum", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.assetcont.infinite_grid", cellSize = 128, radius = 720, horizon = 1600 })
		inst.system = S
		inst.ctx = ctx
