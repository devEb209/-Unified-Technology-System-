-- ARKHER SYSTEM G.0024 :: Temporal Reconstruction Heuristic Policy
...
return function(A)
	...
	local S = {}
	S.id = "G.0024"
	S.key = "arkher.neural.temporalrecon.heuristic_policy"
	S.name = "Temporal Reconstruction Heuristic Policy"
	S.category = "G"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.temporalrecon.result_cache" }
	S.tags = { "g", "temporalrecon", "policy", "neural" }
	S.description = "Temporal Reconstruction Heuristic Policy: rule fallback when the model is unavailable for the Temporal Reconstruction subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.neural.temporalrecon.heuristic_policy", algorithm = "edf", starvationGuard = 49 })
		inst.system = S
		inst.ctx = ctx
