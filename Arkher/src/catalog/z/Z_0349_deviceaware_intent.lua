-- ARKHER SYSTEM Z.0349 :: Device Aware Fidelity Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0349"
	S.key = "arkher.origin.deviceaware.intent_bridge"
	S.name = "Device Aware Fidelity Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.deviceaware.semantic_graph" }
	S.tags = { "z", "deviceaware", "intent", "origin" }
	S.description = "Device Aware Fidelity Intent Bridge: natural language control surface for the technology for the Device Aware Fidelity subsystem."
	S.params = {
		backlogLimit = 20,
		baseRadius = 320,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.deviceaware.intent_bridge", minConfidence = 0.37 })
		inst.system = S
		inst.ctx = ctx
