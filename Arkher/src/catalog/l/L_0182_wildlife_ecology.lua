-- ARKHER SYSTEM L.0182 :: Wildlife Ecology
...
return function(A)
	...
	local S = {}
	S.id = "L.0182"
	S.key = "arkher.sim.wildlife.ecology"
	S.name = "Wildlife Ecology"
	S.category = "L"
	...
	S.kit = "ecology"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.wildlife.simulation_core" }
	S.tags = { "l", "wildlife", "ecology", "sim" }
	S.description = "Wildlife Ecology: populations, predation, harvesting and carrying capacity for the Wildlife subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 280,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ecology", { id = "arkher.sim.wildlife.ecology" })
		inst.system = S
		inst.ctx = ctx
