-- ARKHER SYSTEM VC.0321 :: Ecology Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VC.0321"
	S.key = "arkher.contneural.ecologycont.complexity_budget"
	S.name = "Ecology Continuum Complexity Budget"
	S.category = "VC"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.ecologycont.world_memory_stream" }
	S.tags = { "vc", "ecologycont", "complexity", "contneural" }
	S.description = "Ecology Continuum Complexity Budget: complexity budgeting for the continuum for the Ecology Continuum subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 240,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contneural.ecologycont.complexity_budget", targetMs = 13.0 })
		inst.system = S
		inst.ctx = ctx
