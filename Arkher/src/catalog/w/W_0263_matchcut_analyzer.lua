-- ARKHER SYSTEM W.0263 :: Match Cut Sequence Analysis
...
return function(A)
	...
	local S = {}
	S.id = "W.0263"
	S.key = "arkher.cine.matchcut.sequence_analysis"
	S.name = "Match Cut Sequence Analysis"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Match Cut"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.matchcut.frame_budget" }
	S.tags = { "w", "matchcut", "analyzer", "cine" }
	S.description = "Match Cut Sequence Analysis: pacing, coverage and cut-rhythm analysis for the Match Cut subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.cine.matchcut.sequence_analysis", window = 243, buckets = 15, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
