-- ARKHER SYSTEM N.0301 :: Status Effect Particle Simulation
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0301"
	S.key = "arkher.vfx.statusfx.particle_simulation"
	S.name = "Status Effect Particle Simulation"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "particles"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.statusfx.emission" }
	S.tags = { "n", "statusfx", "particles", "vfx" }
	S.description = "Status Effect Particle Simulation: pooled integration of position, velocity, colour and life for the Status Effect subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("particles", { id = "arkher.vfx.statusfx.particle_simulation", capacity = 128, drag = 0.09, bounce = 0.14, groundY = 0 })
		inst.system = S
		inst.ctx = ctx
