-- ARKHER SYSTEM VC.0188 :: Simulation Domain World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0188"
	S.key = "arkher.contneural.simdomain.world_memory_stream"
	S.name = "Simulation Domain World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.simdomain.neural_field" }
	S.tags = { "vc", "simdomain", "worldmemory", "contneural" }
	S.description = "Simulation Domain World Memory Stream: world memory continuum over epochs for the Simulation Domain subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 480,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.simdomain.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
