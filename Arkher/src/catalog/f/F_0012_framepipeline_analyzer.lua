-- ARKHER SYSTEM F.0012 :: Frame Pipeline Frame Analysis
...
return function(A)
	...
	local S = {}
	S.id = "F.0012"
	S.key = "arkher.render.framepipeline.frame_analysis"
	S.name = "Frame Pipeline Frame Analysis"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.render.framepipeline.pass_cache" }
	S.tags = { "f", "framepipeline", "analyzer", "render" }
	S.description = "Frame Pipeline Frame Analysis: per-pass cost analysis and outlier detection for the Frame Pipeline subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 160,
		baseWeight = 0.64,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.render.framepipeline.frame_analysis", window = 212, buckets = 8, threshold = 4.40 })
		inst.system = S
		inst.ctx = ctx
