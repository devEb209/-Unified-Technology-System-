-- ARKHER SYSTEM VC.0577 :: Thermal Continuum Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VC.0577"
	S.key = "arkher.contneural.thermalcont.infinite_grid"
	S.name = "Thermal Continuum Infinite Grid"
	S.category = "VC"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vc", "thermalcont", "continuum", "contneural" }
	S.description = "Thermal Continuum Infinite Grid: seamless paging of the infinite world grid for the Thermal Continuum subsystem."
	S.params = {
		backlogLimit = 33,
		baseRadius = 200,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.contneural.thermalcont.infinite_grid", cellSize = 96, radius = 480, horizon = 2112 })
		inst.system = S
		inst.ctx = ctx
