-- ARKHER SYSTEM VB.0157 :: Coherence Seam Infinite Grid
...
return function(A)
	...
	local S = {}
	S.id = "VB.0157"
	S.key = "arkher.conttime.coherenceseam.infinite_grid"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "vb", "coherenceseam", "continuum", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("continuum", { id = "arkher.conttime.coherenceseam.infinite_grid", cellSize = 96, radius = 960, horizon = 3136 })
		inst.system = S
		inst.ctx = ctx
