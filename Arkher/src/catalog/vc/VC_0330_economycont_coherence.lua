-- ARKHER SYSTEM VC.0330 :: Economy Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VC.0330"
	S.key = "arkher.contneural.economycont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.economycont.persistent_state" }
	S.tags = { "vc", "economycont", "coherence", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contneural.economycont.coherence_guard", window = 130, threshold = 0.08 })
		inst.system = S
		inst.ctx = ctx
