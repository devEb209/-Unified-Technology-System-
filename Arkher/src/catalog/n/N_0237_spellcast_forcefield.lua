-- ARKHER SYSTEM N.0237 :: Spell Cast Force Field
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0237"
	S.key = "arkher.vfx.spellcast.force_field"
	S.name = "Spell Cast Force Field"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spell Cast"
	...
	S.kit = "forcefield"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spellcast.particle_simulation" }
	S.tags = { "n", "spellcast", "forcefield", "vfx" }
	S.description = "Spell Cast Force Field: wind, attraction, vortex, drag and curl turbulence for the Spell Cast subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 480,
		baseWeight = 0.86,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("forcefield", { id = "arkher.vfx.spellcast.force_field", seed = 8336 })
		inst.system = S
		inst.ctx = ctx
