-- ARKHER SYSTEM VA.0350 :: Narrative Continuum Epoch Clock
...
return function(A)
	...
	local S = {}
	S.id = "VA.0350"
	S.key = "arkher.contworld.narrativecont.epoch_clock"
	...
	S.kit = "epoch"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.narrativecont.infinite_grid" }
	S.tags = { "va", "narrativecont", "epoch", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("epoch", { id = "arkher.contworld.narrativecont.epoch_clock", tickRate = 40, budget = 11, capacity = 288 })
		inst.system = S
		inst.ctx = ctx
