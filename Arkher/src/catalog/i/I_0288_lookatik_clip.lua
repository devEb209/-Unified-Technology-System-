-- ARKHER SYSTEM I.0288 :: Look At IK Clip Sampling
...
return function(A)
	...
	local S = {}
	S.id = "I.0288"
	S.key = "arkher.anim.lookatik.clip_sampling"
	S.name = "Look At IK Clip Sampling"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Look At IK"
	...
	S.kit = "clip"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.lookatik.skeleton" }
	S.tags = { "i", "lookatik", "clip", "anim" }
	S.description = "Look At IK Clip Sampling: keyframe tracks sampled, retimed and evented for the Look At IK subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("clip", { id = "arkher.anim.lookatik.clip_sampling", duration = 1.60, loop = true })
		inst.system = S
		inst.ctx = ctx
