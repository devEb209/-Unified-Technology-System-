-- ARKHER SYSTEM T.0494 :: Physics Reasoning Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0494"
	S.key = "arkher.ai.physicsreasoning.self_critique"
	S.name = "Physics Reasoning Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.physicsreasoning.plan_workflow" }
	S.tags = { "t", "physicsreasoning", "critic", "ai" }
	S.description = "Physics Reasoning Self Critique: weighted evaluation of the result against declared criteria for the Physics Reasoning subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.physicsreasoning.self_critique", passMark = 0.70, reviseMark = 0.45, seed = 62955 })
		inst.system = S
		inst.ctx = ctx
