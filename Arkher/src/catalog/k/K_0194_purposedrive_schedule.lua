-- ARKHER SYSTEM K.0194 :: Purpose Drive Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0194"
	S.key = "arkher.npc.purposedrive.daily_schedule"
	S.name = "Purpose Drive Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.purposedrive.social_relations" }
	S.tags = { "k", "purposedrive", "schedule", "npc" }
	S.description = "Purpose Drive Daily Schedule: hour-by-hour routine with priority interruptions for the Purpose Drive subsystem."
	S.params = {
		backlogLimit = 35,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.purposedrive.daily_schedule", startHour = 7 })
		inst.system = S
		inst.ctx = ctx
