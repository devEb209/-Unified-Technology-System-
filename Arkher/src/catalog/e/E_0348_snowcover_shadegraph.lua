-- ARKHER SYSTEM E.0348 :: Snow Cover Shading Graph
...
return function(A)
	...
	local S = {}
	S.id = "E.0348"
	S.key = "arkher.material.snowcover.shading_graph"
	S.name = "Snow Cover Shading Graph"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Snow Cover"
	...
	S.kit = "shadegraph"
	S.version = "1.0.0"
	S.deps = { "arkher.material.snowcover.layer_composition" }
	S.tags = { "e", "snowcover", "shadegraph", "material" }
	S.description = "Snow Cover Shading Graph: node graph evaluated and compiled to Luau for the Snow Cover subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("shadegraph", { id = "arkher.material.snowcover.shading_graph" })
		inst.system = S
		inst.ctx = ctx
