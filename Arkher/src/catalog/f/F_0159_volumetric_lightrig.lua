-- ARKHER SYSTEM F.0159 :: Volumetric Light Lighting Rig
...
return function(A)
	...
	local S = {}
	S.id = "F.0159"
	S.key = "arkher.render.volumetric.lighting_rig"
	S.name = "Volumetric Light Lighting Rig"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "lightrig"
	S.version = "1.0.0"
	S.deps = { "arkher.render.volumetric.geometry_virtualization" }
	S.tags = { "f", "volumetric", "lightrig", "render" }
	S.description = "Volumetric Light Lighting Rig: light clustering, importance and cascades for the Volumetric Light subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 560,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("lightrig", { id = "arkher.render.volumetric.lighting_rig", maxActive = 11 })
		inst.system = S
		inst.ctx = ctx
