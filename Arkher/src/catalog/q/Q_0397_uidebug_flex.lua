-- ARKHER SYSTEM Q.0397 :: UI Debug Responsive Layout
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0397"
	S.key = "arkher.ui.uidebug.responsive_layout"
	S.name = "UI Debug Responsive Layout"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "UI Debug"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "q", "uidebug", "flex", "ui" }
	S.description = "UI Debug Responsive Layout: flex solving with safe areas, weights and breakpoints for the UI Debug subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("flex", { id = "arkher.ui.uidebug.responsive_layout", width = 510, height = 964, scale = 0.92 })
		inst.system = S
		inst.ctx = ctx
