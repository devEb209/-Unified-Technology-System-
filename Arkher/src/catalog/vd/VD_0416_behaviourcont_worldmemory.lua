-- ARKHER SYSTEM VD.0416 :: Behaviour Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0416"
	S.key = "arkher.contsim.behaviourcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.behaviourcont.neural_field" }
	S.tags = { "vd", "behaviourcont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.behaviourcont.world_memory_stream", capacity = 224 })
		inst.system = S
		inst.ctx = ctx
