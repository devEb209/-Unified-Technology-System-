-- ARKHER SYSTEM VD.0441 :: Physics Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VD.0441"
	S.key = "arkher.contsim.physicscont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.physicscont.world_memory_stream" }
	S.tags = { "vd", "physicscont", "complexity", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contsim.physicscont.complexity_budget", targetMs = 15.0 })
		inst.system = S
		inst.ctx = ctx
