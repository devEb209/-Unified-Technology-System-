-- ARKHER SYSTEM K.0021 :: Neural Policy Utility Reasoning
...
return function(A)
	...
	local S = {}
	S.id = "K.0021"
	S.key = "arkher.npc.neuralpolicy.utility_reasoning"
	S.name = "Neural Policy Utility Reasoning"
	S.category = "K"
	...
	S.kit = "utility"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.neuralpolicy.reactive_behaviour" }
	S.tags = { "k", "neuralpolicy", "utility", "npc" }
	S.description = "Neural Policy Utility Reasoning: scored option selection with response curves for the Neural Policy subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("utility", { id = "arkher.npc.neuralpolicy.utility_reasoning", momentum = 0.09 })
		inst.system = S
		inst.ctx = ctx
