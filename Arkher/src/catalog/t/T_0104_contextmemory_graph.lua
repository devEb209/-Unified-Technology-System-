-- ARKHER SYSTEM T.0104 :: Context Memory Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0104"
	S.key = "arkher.ai.contextmemory.reasoning_graph"
	S.name = "Context Memory Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.contextmemory.world_architect" }
	S.tags = { "t", "contextmemory", "graph", "ai" }
	S.description = "Context Memory Reasoning Graph: relationship modelling and shortest-path reasoning for the Context Memory subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 400,
		baseWeight = 0.68,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.contextmemory.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
