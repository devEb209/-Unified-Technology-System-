-- ARKHER SYSTEM K.0117 :: Forgetting Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0117"
	S.key = "arkher.npc.forgetting.perception"
	S.name = "Forgetting Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.forgetting.emotion" }
	S.tags = { "k", "forgetting", "perception", "npc" }
	S.description = "Forgetting Perception: sight, hearing and bounded attention for the Forgetting subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.forgetting.perception", sightRange = 40, hearingRange = 24, attentionSlots = 6, fov = 1.710 })
		inst.system = S
		inst.ctx = ctx
