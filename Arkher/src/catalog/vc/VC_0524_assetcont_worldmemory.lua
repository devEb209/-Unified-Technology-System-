-- ARKHER SYSTEM VC.0524 :: Asset Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0524"
	S.key = "arkher.contneural.assetcont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.assetcont.neural_field" }
	S.tags = { "vc", "assetcont", "worldmemory", "contneural" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.assetcont.world_memory_stream", capacity = 64 })
		inst.system = S
		inst.ctx = ctx
