-- ARKHER SYSTEM F.0037 :: Opaque Pass Draw Budget
...
return function(A)
	...
	local S = {}
	S.id = "F.0037"
	S.key = "arkher.render.opaquepass.draw_budget"
	S.name = "Opaque Pass Draw Budget"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Opaque Pass"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.render.opaquepass.adaptive_resolution" }
	S.tags = { "f", "opaquepass", "budgeter", "render" }
	S.description = "Opaque Pass Draw Budget: draw call and triangle budget allocation for the Opaque Pass subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 360,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.render.opaquepass.draw_budget", total = 157, strategy = "waterfill" })
		inst.system = S
		inst.ctx = ctx
