-- ARKHER SYSTEM G.0031 :: Spatial Reconstruction Temporal History
...
return function(A)
	...
	local S = {}
	S.id = "G.0031"
	S.key = "arkher.neural.spatialrecon.temporal_history"
	S.name = "Spatial Reconstruction Temporal History"
	S.category = "G"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.spatialrecon.feature_extraction" }
	S.tags = { "g", "spatialrecon", "temporal", "neural" }
	S.description = "Spatial Reconstruction Temporal History: history buffers reused across frames for the Spatial Reconstruction subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.51,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.neural.spatialrecon.temporal_history", feedback = 0.86, phase = 8 })
		inst.system = S
		inst.ctx = ctx
