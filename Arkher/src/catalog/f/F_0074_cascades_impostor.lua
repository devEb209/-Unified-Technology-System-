-- ARKHER SYSTEM F.0074 :: Cascade Shadows Geometry Virtualization
...
return function(A)
	...
	local S = {}
	S.id = "F.0074"
	S.key = "arkher.render.cascades.geometry_virtualization"
	S.name = "Cascade Shadows Geometry Virtualization"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "impostor"
	S.version = "1.0.0"
	S.deps = { "arkher.render.cascades.visibility_set" }
	S.tags = { "f", "cascades", "impostor", "render" }
	S.description = "Cascade Shadows Geometry Virtualization: impostor and HLOD synthesis under a budget for the Cascade Shadows subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("impostor", { id = "arkher.render.cascades.geometry_virtualization", atlasSlots = 112, viewCount = 8, errorThreshold = 1.50 })
		inst.system = S
		inst.ctx = ctx
