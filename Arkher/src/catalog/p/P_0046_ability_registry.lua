-- ARKHER SYSTEM P.0046 :: Ability Content Registry
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0046"
	S.key = "arkher.play.ability.content_registry"
	S.name = "Ability Content Registry"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Ability"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.play.ability.difficulty_controller" }
	S.tags = { "p", "ability", "registry", "play" }
	S.description = "Ability Content Registry: catalogue of the definitions this loop instantiates for the Ability subsystem."
	S.params = {
		backlogLimit = 43,
		baseRadius = 280,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.play.ability.content_registry" })
		inst.system = S
		inst.ctx = ctx
