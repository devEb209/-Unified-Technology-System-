-- ARKHER SYSTEM N.0278 :: Heal Effect Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0278"
	S.key = "arkher.vfx.healfx.curve_authoring"
	S.name = "Heal Effect Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	S.area = "Heal Effect"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.healfx.ribbon_and_trail" }
	S.tags = { "n", "healfx", "spline", "vfx" }
	S.description = "Heal Effect Curve Authoring: authored curves driving the effect over its life for the Heal Effect subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.healfx.curve_authoring", tension = 0.37, closed = false })
		inst.system = S
		inst.ctx = ctx
