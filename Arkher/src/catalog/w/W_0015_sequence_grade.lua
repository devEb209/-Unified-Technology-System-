-- ARKHER SYSTEM W.0015 :: Sequence Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0015"
	S.key = "arkher.cine.sequence.colour_grade"
	S.name = "Sequence Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Sequence"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.sequence.camera_rig" }
	S.tags = { "w", "sequence", "grade", "cine" }
	S.description = "Sequence Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Sequence subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.92,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.sequence.colour_grade", exposure = 0.07, contrast = 1.12, saturation = 1.02, toneMap = "filmic" })
		inst.system = S
		inst.ctx = ctx
