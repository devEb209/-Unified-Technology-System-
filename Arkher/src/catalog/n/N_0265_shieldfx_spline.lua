-- ARKHER SYSTEM N.0265 :: Shield Effect Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0265"
	S.key = "arkher.vfx.shieldfx.curve_authoring"
	S.name = "Shield Effect Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.shieldfx.ribbon_and_trail" }
	S.tags = { "n", "shieldfx", "spline", "vfx" }
	S.description = "Shield Effect Curve Authoring: authored curves driving the effect over its life for the Shield Effect subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 400,
		baseWeight = 0.82,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.shieldfx.curve_authoring", tension = 0.37, closed = false })
		inst.system = S
		inst.ctx = ctx
