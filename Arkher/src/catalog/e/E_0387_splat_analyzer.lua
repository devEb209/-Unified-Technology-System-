-- ARKHER SYSTEM E.0387 :: Terrain Splat Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0387"
	S.key = "arkher.material.splat.analysis"
	S.name = "Terrain Splat Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.splat.instance_cache" }
	S.tags = { "e", "splat", "analyzer", "material" }
	S.description = "Terrain Splat Analysis: cost, redundancy and outlier analysis for the Terrain Splat subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 600,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.splat.analysis", window = 183, buckets = 19, threshold = 2.50 })
		inst.system = S
		inst.ctx = ctx
