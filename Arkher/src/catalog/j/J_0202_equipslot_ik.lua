-- ARKHER SYSTEM J.0202 :: Equipment Slot Look And Reach
...
return function(A)
	...
	local S = {}
	S.id = "J.0202"
	S.key = "arkher.character.equipslot.look_and_reach"
	S.name = "Equipment Slot Look And Reach"
	S.category = "J"
	...
	S.kit = "ik"
	S.version = "1.0.0"
	S.deps = { "arkher.character.equipslot.blend_controller" }
	S.tags = { "j", "equipslot", "ik", "character" }
	S.description = "Equipment Slot Look And Reach: look-at, reach and foot placement for the character for the Equipment Slot subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("ik", { id = "arkher.character.equipslot.look_and_reach", iterations = 14, tolerance = 0.0010 })
		inst.system = S
		inst.ctx = ctx
