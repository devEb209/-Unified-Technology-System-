-- ARKHER SYSTEM L.0294 :: Water Cycle State Codec
...
return function(A)
	...
	local S = {}
	S.id = "L.0294"
	S.key = "arkher.sim.watercycle.state_codec"
	S.name = "Water Cycle State Codec"
	S.category = "L"
	...
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.watercycle.history_ledger" }
	S.tags = { "l", "watercycle", "codec", "sim" }
	S.description = "Water Cycle State Codec: persistence, diffing and checksum of the world state for the Water Cycle subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.84,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.sim.watercycle.state_codec", format = "binary", quantBits = 8 })
		inst.system = S
		inst.ctx = ctx
