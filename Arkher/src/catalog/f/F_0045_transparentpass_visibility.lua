-- ARKHER SYSTEM F.0045 :: Transparent Pass Visibility Set
...
return function(A)
	...
	local S = {}
	S.id = "F.0045"
	S.key = "arkher.render.transparentpass.visibility_set"
	S.name = "Transparent Pass Visibility Set"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "visibility"
	S.version = "1.0.0"
	S.deps = { "arkher.render.transparentpass.view_and_culling" }
	S.tags = { "f", "transparentpass", "visibility", "render" }
	S.description = "Transparent Pass Visibility Set: cell, portal and occluder visibility for the Transparent Pass subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 160,
		baseWeight = 0.54,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("visibility", { id = "arkher.render.transparentpass.visibility_set", maxDepth = 2 })
		inst.system = S
		inst.ctx = ctx
