-- ARKHER SYSTEM VA.0248 :: Vegetation Field World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VA.0248"
	S.key = "arkher.contworld.vegfield.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vegfield.neural_field" }
	S.tags = { "va", "vegfield", "worldmemory", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contworld.vegfield.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
