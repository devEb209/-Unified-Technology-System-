-- ARKHER SYSTEM K.0176 :: Social Drive Goal Planner
...
return function(A)
	...
	local S = {}
	S.id = "K.0176"
	S.key = "arkher.npc.socialdrive.goal_planner"
	S.name = "Social Drive Goal Planner"
	S.category = "K"
	...
	S.kit = "planner"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.socialdrive.utility_reasoning" }
	S.tags = { "k", "socialdrive", "planner", "npc" }
	S.description = "Social Drive Goal Planner: backward GOAP planning to reach a goal state for the Social Drive subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.85,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("planner", { id = "arkher.npc.socialdrive.goal_planner", maxDepth = 7 })
		inst.system = S
		inst.ctx = ctx
