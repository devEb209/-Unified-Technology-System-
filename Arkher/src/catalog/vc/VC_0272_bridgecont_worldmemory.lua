-- ARKHER SYSTEM VC.0272 :: Bridge Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VC.0272"
	S.key = "arkher.contneural.bridgecont.world_memory_stream"
	S.name = "Bridge Continuum World Memory Stream"
	S.category = "VC"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.bridgecont.neural_field" }
	S.tags = { "vc", "bridgecont", "worldmemory", "contneural" }
	S.description = "Bridge Continuum World Memory Stream: world memory continuum over epochs for the Bridge Continuum subsystem."
	S.params = {
		backlogLimit = 34,
		baseRadius = 240,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contneural.bridgecont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
