-- ARKHER SYSTEM P.0153 :: Crafting Difficulty Controller
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0153"
	S.key = "arkher.play.crafting.difficulty_controller"
	S.name = "Crafting Difficulty Controller"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Crafting"
	...
	S.kit = "controller"
	S.version = "1.0.0"
	S.deps = { "arkher.play.crafting.balance_analysis" }
	S.tags = { "p", "crafting", "controller", "play" }
	S.description = "Crafting Difficulty Controller: closed-loop tuning toward a target challenge for the Crafting subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("controller", { id = "arkher.play.crafting.difficulty_controller", mode = "hysteresis", target = 0.590, kp = 0.340, ki = 0.020, kd = 0.050, min = 0.05, max = 1.0, initial = 0.49, deadband = 0.01 })
		inst.system = S
		inst.ctx = ctx
