-- ARKHER SYSTEM T.0618 :: Explainability Semantic Knowledge
...
return function(A)
	...
	local S = {}
	S.id = "T.0618"
	S.key = "arkher.ai.explainability.semantic_knowledge"
	S.name = "Explainability Semantic Knowledge"
	S.category = "T"
	...
	S.kit = "knowledge"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.explainability.intent_understanding" }
	S.tags = { "t", "explainability", "knowledge", "ai" }
	S.description = "Explainability Semantic Knowledge: typed entities, weighted relations and inferred closure for the Explainability subsystem."
	S.params = {
		backlogLimit = 16,
		baseRadius = 320,
		baseWeight = 0.58,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("knowledge", { id = "arkher.ai.explainability.semantic_knowledge", dims = 40 })
		inst.system = S
		inst.ctx = ctx
