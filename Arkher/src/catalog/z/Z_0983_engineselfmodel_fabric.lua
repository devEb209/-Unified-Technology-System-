-- ARKHER SYSTEM Z.0983 :: Engine Self Model Simulation Fabric
...
return function(A)
	...
	local S = {}
	S.id = "Z.0983"
	S.key = "arkher.origin.engineselfmodel.simulation_fabric"
	S.name = "Engine Self Model Simulation Fabric"
	S.category = "Z"
	...
	S.kit = "fabric"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.engineselfmodel.complexity_governance" }
	S.tags = { "z", "engineselfmodel", "fabric", "origin" }
	S.description = "Engine Self Model Simulation Fabric: every simulation domain stepped under one budgeted clock for the Engine Self Model subsystem."
	S.params = {
		backlogLimit = 8,
		baseRadius = 320,
		baseWeight = 0.9,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("fabric", { id = "arkher.origin.engineselfmodel.simulation_fabric", budgetMs = 3.5, starvationLimit = 4 })
		inst.system = S
		inst.ctx = ctx
