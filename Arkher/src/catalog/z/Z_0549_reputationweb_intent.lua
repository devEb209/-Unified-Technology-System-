-- ARKHER SYSTEM Z.0549 :: Reputation Web Intent Bridge
...
return function(A)
	...
	local S = {}
	S.id = "Z.0549"
	S.key = "arkher.origin.reputationweb.intent_bridge"
	S.name = "Reputation Web Intent Bridge"
	S.category = "Z"
	...
	S.kit = "intent"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.reputationweb.semantic_graph" }
	S.tags = { "z", "reputationweb", "intent", "origin" }
	S.description = "Reputation Web Intent Bridge: natural language control surface for the technology for the Reputation Web subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 520,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("intent", { id = "arkher.origin.reputationweb.intent_bridge", minConfidence = 0.39 })
		inst.system = S
		inst.ctx = ctx
