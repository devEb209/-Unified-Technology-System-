-- ARKHER SYSTEM N.0244 :: Spell Cast Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0244"
	S.key = "arkher.vfx.spellcast.quality_policy"
	S.name = "Spell Cast Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Spell Cast"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.spellcast.result_cache" }
	S.tags = { "n", "spellcast", "policy", "vfx" }
	S.description = "Spell Cast Quality Policy: distance and device driven fidelity bands for the Spell Cast subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 560,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.spellcast.quality_policy", algorithm = "wfq", starvationGuard = 38 })
		inst.system = S
		inst.ctx = ctx
