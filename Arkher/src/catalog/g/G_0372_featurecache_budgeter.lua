-- ARKHER SYSTEM G.0372 :: Feature Cache Compute Budget
...
return function(A)
	...
	local S = {}
	S.id = "G.0372"
	S.key = "arkher.neural.featurecache.compute_budget"
	S.name = "Feature Cache Compute Budget"
	S.category = "G"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.neural.featurecache.quality_predictor" }
	S.tags = { "g", "featurecache", "budgeter", "neural" }
	S.description = "Feature Cache Compute Budget: inference time budget allocation for the Feature Cache subsystem."
	S.params = {
		backlogLimit = 19,
		baseRadius = 280,
		baseWeight = 0.91,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.neural.featurecache.compute_budget", total = 351, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
