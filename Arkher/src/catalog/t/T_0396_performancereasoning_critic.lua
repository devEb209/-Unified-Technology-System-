-- ARKHER SYSTEM T.0396 :: Performance Reasoning Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "T.0396"
	S.key = "arkher.ai.performancereasoning.self_critique"
	S.name = "Performance Reasoning Self Critique"
	S.category = "T"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.performancereasoning.plan_workflow" }
	S.tags = { "t", "performancereasoning", "critic", "ai" }
	S.description = "Performance Reasoning Self Critique: weighted evaluation of the result against declared criteria for the Performance Reasoning subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 560,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.ai.performancereasoning.self_critique", passMark = 0.74, reviseMark = 0.44, seed = 5074 })
		inst.system = S
		inst.ctx = ctx
