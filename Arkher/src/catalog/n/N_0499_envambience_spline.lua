-- ARKHER SYSTEM N.0499 :: Environment Ambience Curve Authoring
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0499"
	S.key = "arkher.vfx.envambience.curve_authoring"
	S.name = "Environment Ambience Curve Authoring"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "spline"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.envambience.ribbon_and_trail" }
	S.tags = { "n", "envambience", "spline", "vfx" }
	S.description = "Environment Ambience Curve Authoring: authored curves driving the effect over its life for the Environment Ambience subsystem."
	S.params = {
		backlogLimit = 42,
		baseRadius = 240,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("spline", { id = "arkher.vfx.envambience.curve_authoring", tension = 0.69, closed = false })
		inst.system = S
		inst.ctx = ctx
