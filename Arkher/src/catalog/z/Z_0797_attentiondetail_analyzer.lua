-- ARKHER SYSTEM Z.0797 :: Attention Driven Detail Behaviour Analysis
...
return function(A)
	...
	local S = {}
	S.id = "Z.0797"
	S.key = "arkher.origin.attentiondetail.behaviour_analysis"
	S.name = "Attention Driven Detail Behaviour Analysis"
	S.category = "Z"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.attentiondetail.governance_policy" }
	S.tags = { "z", "attentiondetail", "analyzer", "origin" }
	S.description = "Attention Driven Detail Behaviour Analysis: trend, anomaly and forecast analysis of the technology for the Attention Driven Detail subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 520,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.origin.attentiondetail.behaviour_analysis", window = 229, buckets = 17, threshold = 4.10 })
		inst.system = S
		inst.ctx = ctx
