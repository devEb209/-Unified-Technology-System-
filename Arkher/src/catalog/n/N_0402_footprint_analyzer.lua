-- ARKHER SYSTEM N.0402 :: Footprint Analysis
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0402"
	S.key = "arkher.vfx.footprint.analysis"
	S.name = "Footprint Analysis"
	S.category = "N"
	S.family = "VFX"
	S.area = "Footprint"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.footprint.spatial_index" }
	S.tags = { "n", "footprint", "analyzer", "vfx" }
	S.description = "Footprint Analysis: cost, overdraw and stability analysis of the effect for the Footprint subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 360,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.vfx.footprint.analysis", window = 81, buckets = 13, threshold = 4.30 })
		inst.system = S
		inst.ctx = ctx
