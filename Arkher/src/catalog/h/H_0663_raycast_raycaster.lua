-- ARKHER SYSTEM H.0663 :: Raycast Query Query
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0663"
	S.key = "arkher.physics.raycast.query"
	S.name = "Raycast Query Query"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "raycaster"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.raycast.constraint_solver" }
	S.tags = { "h", "raycast", "raycaster", "physics" }
	S.description = "Raycast Query Query: rays, sweeps and overlaps against the simulation for the Raycast Query subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("raycaster", { id = "arkher.physics.raycast.query", cellSize = 32 })
		inst.system = S
		inst.ctx = ctx
