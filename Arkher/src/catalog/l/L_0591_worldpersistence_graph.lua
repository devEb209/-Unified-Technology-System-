-- ARKHER SYSTEM L.0591 :: World Persistence Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0591"
	S.key = "arkher.sim.worldpersistence.region_graph"
	S.name = "World Persistence Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.worldpersistence.calendar" }
	S.tags = { "l", "worldpersistence", "graph", "sim" }
	S.description = "World Persistence Region Graph: connectivity, components and shortest path between places for the World Persistence subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.worldpersistence.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
