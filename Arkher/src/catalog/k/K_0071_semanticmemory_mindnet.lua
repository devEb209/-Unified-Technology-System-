-- ARKHER SYSTEM K.0071 :: Semantic Memory Mind Network
...
return function(A)
	...
	local S = {}
	S.id = "K.0071"
	S.key = "arkher.npc.semanticmemory.mind_network"
	S.name = "Semantic Memory Mind Network"
	S.category = "K"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "k", "semanticmemory", "mindnet", "npc" }
	S.description = "Semantic Memory Mind Network: the learned policy that turns perception into a decision for the Semantic Memory subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 320,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("mindnet", { id = "arkher.npc.semanticmemory.mind_network", inputs = 6, hidden = 8, seed = 19444, learningRate = 0.070, exploration = 0.040 })
		inst.system = S
		inst.ctx = ctx
