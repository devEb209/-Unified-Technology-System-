-- ARKHER SYSTEM Z.0330 :: Cross Reality Sync Self Critique
...
return function(A)
	...
	local S = {}
	S.id = "Z.0330"
	S.key = "arkher.origin.crossreality.self_critique"
	S.name = "Cross Reality Sync Self Critique"
	S.category = "Z"
	...
	S.kit = "critic"
	S.version = "1.0.0"
	S.deps = { "arkher.origin.crossreality.intent_bridge" }
	S.tags = { "z", "crossreality", "critic", "origin" }
	S.description = "Cross Reality Sync Self Critique: weighted judgement of the technology's own output for the Cross Reality Sync subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 240,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("critic", { id = "arkher.origin.crossreality.self_critique", passMark = 0.72, reviseMark = 0.42, seed = 72122 })
		inst.system = S
		inst.ctx = ctx
