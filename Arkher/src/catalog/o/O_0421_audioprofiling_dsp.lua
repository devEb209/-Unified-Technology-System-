-- ARKHER SYSTEM O.0421 :: Audio Profiling DSP Chain
-- Category O - AUDIO
...
return function(A)
	...
	local S = {}
	S.id = "O.0421"
	S.key = "arkher.audio.audioprofiling.dsp_chain"
	S.name = "Audio Profiling DSP Chain"
	S.category = "O"
	S.family = "AUDIO"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "o", "audioprofiling", "dsp", "audio" }
	S.description = "Audio Profiling DSP Chain: biquad filtering, delay, envelope and soft clipping for the Audio Profiling subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.99,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("dsp", { id = "arkher.audio.audioprofiling.dsp_chain", sampleRate = 22050, filter = "highpass", cutoff = 3000, q = 0.790 })
		inst.system = S
		inst.ctx = ctx
