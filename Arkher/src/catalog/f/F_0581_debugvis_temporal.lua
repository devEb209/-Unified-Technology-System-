-- ARKHER SYSTEM F.0581 :: Debug Visualization Temporal Resolve
...
return function(A)
	...
	local S = {}
	S.id = "F.0581"
	S.key = "arkher.render.debugvis.temporal_resolve"
	S.name = "Debug Visualization Temporal Resolve"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "temporal"
	S.version = "1.0.0"
	S.deps = { "arkher.render.debugvis.probe_volume" }
	S.tags = { "f", "debugvis", "temporal", "render" }
	S.description = "Debug Visualization Temporal Resolve: history reprojection with neighbourhood clamping for the Debug Visualization subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("temporal", { id = "arkher.render.debugvis.temporal_resolve", feedback = 0.92, phase = 8 })
		inst.system = S
		inst.ctx = ctx
