-- ARKHER SYSTEM VD.0380 :: Dialogue Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0380"
	S.key = "arkher.contsim.dialoguecont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.dialoguecont.neural_field" }
	S.tags = { "vd", "dialoguecont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.dialoguecont.world_memory_stream", capacity = 128 })
		inst.system = S
		inst.ctx = ctx
