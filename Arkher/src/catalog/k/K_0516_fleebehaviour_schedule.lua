-- ARKHER SYSTEM K.0516 :: Flee Behaviour Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0516"
	S.key = "arkher.npc.fleebehaviour.daily_schedule"
	S.name = "Flee Behaviour Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.fleebehaviour.social_relations" }
	S.tags = { "k", "fleebehaviour", "schedule", "npc" }
	S.description = "Flee Behaviour Daily Schedule: hour-by-hour routine with priority interruptions for the Flee Behaviour subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 280,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.fleebehaviour.daily_schedule", startHour = 9 })
		inst.system = S
		inst.ctx = ctx
