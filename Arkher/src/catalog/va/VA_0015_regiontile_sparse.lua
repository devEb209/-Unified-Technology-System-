-- ARKHER SYSTEM VA.0015 :: Region Tile Sparse Residency
...
return function(A)
	...
	local S = {}
	S.id = "VA.0015"
	S.key = "arkher.contworld.regiontile.sparse_residency"
	...
	S.kit = "sparse"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.regiontile.epoch_clock" }
	S.tags = { "va", "regiontile", "sparse", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sparse", { id = "arkher.contworld.regiontile.sparse_residency", capacity = 128, pageBytes = 2048 })
		inst.system = S
		inst.ctx = ctx
