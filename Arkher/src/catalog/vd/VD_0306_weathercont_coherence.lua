-- ARKHER SYSTEM VD.0306 :: Weather Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0306"
	S.key = "arkher.contsim.weathercont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.weathercont.persistent_state" }
	S.tags = { "vd", "weathercont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.weathercont.coherence_guard", window = 68, threshold = 0.10 })
		inst.system = S
		inst.ctx = ctx
