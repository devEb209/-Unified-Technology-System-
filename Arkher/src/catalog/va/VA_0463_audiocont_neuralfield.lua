-- ARKHER SYSTEM VA.0463 :: Audio Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VA.0463"
	S.key = "arkher.contworld.audiocont.neural_field"
	S.name = "Audio Continuum Neural Field"
	S.category = "VA"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.audiocont.coherence_guard" }
	S.tags = { "va", "audiocont", "neuralfield", "contworld" }
	S.description = "Audio Continuum Neural Field: neural field encoding and reconstruction for the Audio Continuum subsystem."
	S.params = {
		backlogLimit = 32,
		baseRadius = 320,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contworld.audiocont.neural_field", dims = 12, hidden = 8, seed = 13024 })
		inst.system = S
		inst.ctx = ctx
