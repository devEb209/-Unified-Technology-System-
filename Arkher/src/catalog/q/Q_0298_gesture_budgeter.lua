-- ARKHER SYSTEM Q.0298 :: Gesture Frame Budget
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0298"
	S.key = "arkher.ui.gesture.frame_budget"
	S.name = "Gesture Frame Budget"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Gesture"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.gesture.accessibility_policy" }
	S.tags = { "q", "gesture", "budgeter", "ui" }
	S.description = "Gesture Frame Budget: per-frame layout and draw budget for the interface for the Gesture subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.87,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.ui.gesture.frame_budget", total = 197, strategy = "proportional" })
		inst.system = S
		inst.ctx = ctx
