-- ARKHER SYSTEM F.0268 :: Tonemapping View And Culling
...
return function(A)
	...
	local S = {}
	S.id = "F.0268"
	S.key = "arkher.render.tonemap.view_and_culling"
	S.name = "Tonemapping View And Culling"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Tonemapping"
	...
	S.kit = "camera"
	S.version = "1.0.0"
	S.deps = { "arkher.render.tonemap.frame_graph" }
	S.tags = { "f", "tonemap", "camera", "render" }
	S.description = "Tonemapping View And Culling: view state, frustum culling and screen-size LOD for the Tonemapping subsystem."
	S.params = {
		backlogLimit = 27,
		baseRadius = 440,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("camera", { id = "arkher.render.tonemap.view_and_culling", width = 1340, height = 1260, fov = 1.0900, far = 1400 })
		inst.system = S
		inst.ctx = ctx
