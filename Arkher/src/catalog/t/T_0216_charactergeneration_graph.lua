-- ARKHER SYSTEM T.0216 :: Character Generation Reasoning Graph
...
return function(A)
	...
	local S = {}
	S.id = "T.0216"
	S.key = "arkher.ai.charactergeneration.reasoning_graph"
	S.name = "Character Generation Reasoning Graph"
	S.category = "T"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.ai.charactergeneration.world_architect" }
	S.tags = { "t", "charactergeneration", "graph", "ai" }
	S.description = "Character Generation Reasoning Graph: relationship modelling and shortest-path reasoning for the Character Generation subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.ai.charactergeneration.reasoning_graph", directed = true })
		inst.system = S
		inst.ctx = ctx
