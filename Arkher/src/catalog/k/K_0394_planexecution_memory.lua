-- ARKHER SYSTEM K.0394 :: Plan Execution Memory
...
return function(A)
	...
	local S = {}
	S.id = "K.0394"
	S.key = "arkher.npc.planexecution.memory"
	S.name = "Plan Execution Memory"
	S.category = "K"
	...
	S.kit = "memory"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.planexecution.mind_network" }
	S.tags = { "k", "planexecution", "memory", "npc" }
	S.description = "Plan Execution Memory: episodic memory with decay, recall and consolidation for the Plan Execution subsystem."
	S.params = {
		backlogLimit = 18,
		baseRadius = 560,
		baseWeight = 0.7,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("memory", { id = "arkher.npc.planexecution.memory", capacity = 90, decayRate = 0.020, consolidateAt = 4 })
		inst.system = S
		inst.ctx = ctx
