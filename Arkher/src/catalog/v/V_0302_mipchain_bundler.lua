-- ARKHER SYSTEM V.0302 :: Mip Chain Bundling
...
return function(A)
	...
	local S = {}
	S.id = "V.0302"
	S.key = "arkher.asset.mipchain.bundling"
	S.name = "Mip Chain Bundling"
	S.category = "V"
	...
	S.kit = "bundler"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.mipchain.import" }
	S.tags = { "v", "mipchain", "bundler", "asset" }
	S.description = "Mip Chain Bundling: size-bounded packing, manifests and delta patches for the Mip Chain subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.79,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("bundler", { id = "arkher.asset.mipchain.bundling", maxBundleBytes = 917504 })
		inst.system = S
		inst.ctx = ctx
