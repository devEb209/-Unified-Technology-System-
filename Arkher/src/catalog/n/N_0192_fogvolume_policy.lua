-- ARKHER SYSTEM N.0192 :: Fog Volume Quality Policy
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0192"
	S.key = "arkher.vfx.fogvolume.quality_policy"
	S.name = "Fog Volume Quality Policy"
	S.category = "N"
	S.family = "VFX"
	S.area = "Fog Volume"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.fogvolume.result_cache" }
	S.tags = { "n", "fogvolume", "policy", "vfx" }
	S.description = "Fog Volume Quality Policy: distance and device driven fidelity bands for the Fog Volume subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.97,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.vfx.fogvolume.quality_policy", algorithm = "edf", starvationGuard = 49 })
		inst.system = S
		inst.ctx = ctx
