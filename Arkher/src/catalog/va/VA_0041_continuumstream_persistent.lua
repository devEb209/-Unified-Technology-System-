-- ARKHER SYSTEM VA.0041 :: Continuum Stream Persistent State
...
return function(A)
	...
	local S = {}
	S.id = "VA.0041"
	S.key = "arkher.contworld.continuumstream.persistent_state"
	...
	S.kit = "persistent"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.continuumstream.multi-scale_fidelity" }
	S.tags = { "va", "continuumstream", "persistent", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("persistent", { id = "arkher.contworld.continuumstream.persistent_state", capacity = 256 })
		inst.system = S
		inst.ctx = ctx
