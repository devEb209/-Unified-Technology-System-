-- ARKHER SYSTEM F.0416 :: Instanced Draw Render Policy
...
return function(A)
	...
	local S = {}
	S.id = "F.0416"
	S.key = "arkher.render.instanced.render_policy"
	S.name = "Instanced Draw Render Policy"
	S.category = "F"
	S.family = "RENDERING"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.render.instanced.draw_budget" }
	S.tags = { "f", "instanced", "policy", "render" }
	S.description = "Instanced Draw Render Policy: device tier rules for the frame for the Instanced Draw subsystem."
	S.params = {
		backlogLimit = 22,
		baseRadius = 400,
		baseWeight = 0.74,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.render.instanced.render_policy", algorithm = "wfq", starvationGuard = 22 })
		inst.system = S
		inst.ctx = ctx
