-- ARKHER SYSTEM K.0201 :: Emotional State Perception
...
return function(A)
	...
	local S = {}
	S.id = "K.0201"
	S.key = "arkher.npc.emotionalstate.perception"
	S.name = "Emotional State Perception"
	S.category = "K"
	...
	S.kit = "perception"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.emotionalstate.emotion" }
	S.tags = { "k", "emotionalstate", "perception", "npc" }
	S.description = "Emotional State Perception: sight, hearing and bounded attention for the Emotional State subsystem."
	S.params = {
		backlogLimit = 36,
		baseRadius = 160,
		baseWeight = 0.98,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("perception", { id = "arkher.npc.emotionalstate.perception", sightRange = 45, hearingRange = 12, attentionSlots = 3, fov = 1.880 })
		inst.system = S
		inst.ctx = ctx
