-- ARKHER SYSTEM H.0194 :: Island Solver Analysis
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0194"
	S.key = "arkher.physics.island.analysis"
	S.name = "Island Solver Analysis"
	S.category = "H"
	S.family = "PHYSICS"
	...
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.island.result_cache" }
	S.tags = { "h", "island", "analyzer", "physics" }
	S.description = "Island Solver Analysis: energy, jitter and cost analysis of the simulation for the Island Solver subsystem."
	S.params = {
		backlogLimit = 44,
		baseRadius = 320,
		baseWeight = 0.96,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.physics.island.analysis", window = 244, buckets = 12, threshold = 3.60 })
		inst.system = S
		inst.ctx = ctx
