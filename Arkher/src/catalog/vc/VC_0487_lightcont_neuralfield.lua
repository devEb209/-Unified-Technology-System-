-- ARKHER SYSTEM VC.0487 :: Lighting Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VC.0487"
	S.key = "arkher.contneural.lightcont.neural_field"
	S.name = "Lighting Continuum Neural Field"
	S.category = "VC"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contneural.lightcont.coherence_guard" }
	S.tags = { "vc", "lightcont", "neuralfield", "contneural" }
	S.description = "Lighting Continuum Neural Field: neural field encoding and reconstruction for the Lighting Continuum subsystem."
	S.params = {
		backlogLimit = 26,
		baseRadius = 400,
		baseWeight = 0.88,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contneural.lightcont.neural_field", dims = 20, hidden = 16, seed = 61338 })
		inst.system = S
		inst.ctx = ctx
