-- ARKHER SYSTEM VD.0395 :: Memory Continuum Reality Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VD.0395"
	S.key = "arkher.contsim.memorycont.reality_continuum"
	...
	S.kit = "reality"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.memorycont.simulation_fabric" }
	S.tags = { "vd", "memorycont", "reality", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("reality", { id = "arkher.contsim.memorycont.reality_continuum" })
		inst.system = S
		inst.ctx = ctx
