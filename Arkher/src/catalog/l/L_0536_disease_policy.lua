-- ARKHER SYSTEM L.0536 :: Disease Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0536"
	S.key = "arkher.sim.disease.fidelity_policy"
	S.name = "Disease Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.disease.streaming" }
	S.tags = { "l", "disease", "policy", "sim" }
	S.description = "Disease Fidelity Policy: rules that pick full, cohort or statistical simulation for the Disease subsystem."
	S.params = {
		backlogLimit = 47,
		baseRadius = 280,
		baseWeight = 0.69,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.disease.fidelity_policy", algorithm = "lottery", starvationGuard = 31 })
		inst.system = S
		inst.ctx = ctx
