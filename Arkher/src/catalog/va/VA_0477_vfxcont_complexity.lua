-- ARKHER SYSTEM VA.0477 :: VFX Continuum Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VA.0477"
	S.key = "arkher.contworld.vfxcont.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.contworld.vfxcont.world_memory_stream" }
	S.tags = { "va", "vfxcont", "complexity", "contworld" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.contworld.vfxcont.complexity_budget", targetMs = 16.0 })
		inst.system = S
		inst.ctx = ctx
