-- ARKHER SYSTEM H.0577 :: Buoyancy Contact Generation
-- Category H - PHYSICS
...
return function(A)
	...
	local S = {}
	S.id = "H.0577"
	S.key = "arkher.physics.buoyancy.contact_generation"
	S.name = "Buoyancy Contact Generation"
	S.category = "H"
	S.family = "PHYSICS"
	S.area = "Buoyancy"
	...
	S.kit = "contact"
	S.version = "1.0.0"
	S.deps = { "arkher.physics.buoyancy.collision_shape" }
	S.tags = { "h", "buoyancy", "contact", "physics" }
	S.description = "Buoyancy Contact Generation: narrow-phase manifolds with normal, depth and point for the Buoyancy subsystem."
	S.params = {
		backlogLimit = 15,
		baseRadius = 440,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("contact", { id = "arkher.physics.buoyancy.contact_generation", slop = 0.0070, maxManifolds = 399 })
		inst.system = S
		inst.ctx = ctx
