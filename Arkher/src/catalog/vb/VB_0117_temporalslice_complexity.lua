-- ARKHER SYSTEM VB.0117 :: Temporal Slice Complexity Budget
...
return function(A)
	...
	local S = {}
	S.id = "VB.0117"
	S.key = "arkher.conttime.temporalslice.complexity_budget"
	...
	S.kit = "complexity"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.temporalslice.world_memory_stream" }
	S.tags = { "vb", "temporalslice", "complexity", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("complexity", { id = "arkher.conttime.temporalslice.complexity_budget", targetMs = 19.0 })
		inst.system = S
		inst.ctx = ctx
