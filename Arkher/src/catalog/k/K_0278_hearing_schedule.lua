-- ARKHER SYSTEM K.0278 :: Hearing Daily Schedule
...
return function(A)
	...
	local S = {}
	S.id = "K.0278"
	S.key = "arkher.npc.hearing.daily_schedule"
	S.name = "Hearing Daily Schedule"
	S.category = "K"
	...
	S.kit = "schedule"
	S.version = "1.0.0"
	S.deps = { "arkher.npc.hearing.social_relations" }
	S.tags = { "k", "hearing", "schedule", "npc" }
	S.description = "Hearing Daily Schedule: hour-by-hour routine with priority interruptions for the Hearing subsystem."
	S.params = {
		backlogLimit = 21,
		baseRadius = 520,
		baseWeight = 0.83,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("schedule", { id = "arkher.npc.hearing.daily_schedule", startHour = 9 })
		inst.system = S
		inst.ctx = ctx
