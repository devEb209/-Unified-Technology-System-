-- ARKHER SYSTEM W.0339 :: Camera Shake Colour Grade
...
return function(A)
	...
	local S = {}
	S.id = "W.0339"
	S.key = "arkher.cine.camerashake.colour_grade"
	S.name = "Camera Shake Colour Grade"
	S.category = "W"
	S.family = "CINEMATIC"
	S.area = "Camera Shake"
	...
	S.kit = "grade"
	S.version = "1.0.0"
	S.deps = { "arkher.cine.camerashake.camera_rig" }
	S.tags = { "w", "camerashake", "grade", "cine" }
	S.description = "Camera Shake Colour Grade: exposure, contrast, saturation, white balance and tone mapping for the Camera Shake subsystem."
	S.params = {
		backlogLimit = 29,
		baseRadius = 200,
		baseWeight = 0.81,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("grade", { id = "arkher.cine.camerashake.colour_grade", exposure = -0.14, contrast = 0.91, saturation = 1.01, toneMap = "reinhard" })
		inst.system = S
		inst.ctx = ctx
