-- ARKHER SYSTEM E.0304 :: Dust Accumulation Texture Sampling
...
return function(A)
	...
	local S = {}
	S.id = "E.0304"
	S.key = "arkher.material.dust.texture_sampling"
	S.name = "Dust Accumulation Texture Sampling"
	S.category = "E"
	S.family = "MATERIALS"
	...
	S.kit = "sampler"
	S.version = "1.0.0"
	S.deps = { "arkher.material.dust.shading_graph" }
	S.tags = { "e", "dust", "sampler", "material" }
	S.description = "Dust Accumulation Texture Sampling: atlas packing, mip chain and filtered sampling for the Dust Accumulation subsystem."
	S.params = {
		backlogLimit = 28,
		baseRadius = 320,
		baseWeight = 0.5,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("sampler", { id = "arkher.material.dust.texture_sampling", atlasSize = 128, maxSide = 32 })
		inst.system = S
		inst.ctx = ctx
