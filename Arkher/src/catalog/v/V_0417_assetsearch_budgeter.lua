-- ARKHER SYSTEM V.0417 :: Asset Search Size Budget
...
return function(A)
	...
	local S = {}
	S.id = "V.0417"
	S.key = "arkher.asset.assetsearch.size_budget"
	S.name = "Asset Search Size Budget"
	S.category = "V"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.assetsearch.compression_codec" }
	S.tags = { "v", "assetsearch", "budgeter", "asset" }
	S.description = "Asset Search Size Budget: byte budget shared between competing asset classes for the Asset Search subsystem."
	S.params = {
		backlogLimit = 24,
		baseRadius = 320,
		baseWeight = 0.76,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.asset.assetsearch.size_budget", total = 236, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
