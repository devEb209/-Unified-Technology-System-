-- ARKHER SYSTEM Q.0290 :: Gesture Widget Tree
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0290"
	S.key = "arkher.ui.gesture.widget_tree"
	S.name = "Gesture Widget Tree"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Gesture"
	...
	S.kit = "widget"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.gesture.responsive_layout" }
	S.tags = { "q", "gesture", "widget", "ui" }
	S.description = "Gesture Widget Tree: retained widget nodes, properties, bindings and rendering for the Gesture subsystem."
	S.params = {
		backlogLimit = 46,
		baseRadius = 240,
		baseWeight = 0.78,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("widget", { id = "arkher.ui.gesture.widget_tree", theme = "highcontrast", scale = 1.03 })
		inst.system = S
		inst.ctx = ctx
