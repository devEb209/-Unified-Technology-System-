-- ARKHER SYSTEM VB.0216 :: Biome Continuum Emergence Continuum
...
return function(A)
	...
	local S = {}
	S.id = "VB.0216"
	S.key = "arkher.conttime.biomecont.emergence_continuum"
	...
	S.kit = "emergence"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.biomecont.reality_continuum" }
	S.tags = { "vb", "biomecont", "emergence", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("emergence", { id = "arkher.conttime.biomecont.emergence_continuum", windowSize = 5, threshold = 1.50, minCount = 3 })
		inst.system = S
		inst.ctx = ctx
