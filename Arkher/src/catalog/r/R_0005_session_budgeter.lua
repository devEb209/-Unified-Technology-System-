-- ARKHER SYSTEM R.0005 :: Session Bandwidth Budget
...
return function(A)
	...
	local S = {}
	S.id = "R.0005"
	S.key = "arkher.net.session.bandwidth_budget"
	S.name = "Session Bandwidth Budget"
	S.category = "R"
	S.family = "NETWORKING"
	S.area = "Session"
	...
	S.kit = "budgeter"
	S.version = "1.0.0"
	S.deps = { "arkher.net.session.transport_graph" }
	S.tags = { "r", "session", "budgeter", "net" }
	S.description = "Session Bandwidth Budget: bytes per second shared between competing streams for the Session subsystem."
	S.params = {
		backlogLimit = 10,
		baseRadius = 560,
		baseWeight = 0.72,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("budgeter", { id = "arkher.net.session.bandwidth_budget", total = 182, strategy = "priority" })
		inst.system = S
		inst.ctx = ctx
