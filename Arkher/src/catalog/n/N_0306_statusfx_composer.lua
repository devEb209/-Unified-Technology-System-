-- ARKHER SYSTEM N.0306 :: Status Effect Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0306"
	S.key = "arkher.vfx.statusfx.effect_composition"
	S.name = "Status Effect Effect Composition"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.statusfx.effect_graph" }
	S.tags = { "n", "statusfx", "composer", "vfx" }
	S.description = "Status Effect Effect Composition: blending of several effect signals into one output for the Status Effect subsystem."
	S.params = {
		backlogLimit = 12,
		baseRadius = 480,
		baseWeight = 0.94,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.statusfx.effect_composition", mode = "alpha" })
		inst.system = S
		inst.ctx = ctx
