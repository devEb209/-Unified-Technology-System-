-- ARKHER SYSTEM VB.0091 :: Residency Window Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VB.0091"
	S.key = "arkher.conttime.residencywindow.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.conttime.residencywindow.coherence_guard" }
	S.tags = { "vb", "residencywindow", "neuralfield", "conttime" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.conttime.residencywindow.neural_field", dims = 16, hidden = 12, seed = 20985 })
		inst.system = S
		inst.ctx = ctx
