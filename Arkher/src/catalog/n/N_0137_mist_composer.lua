-- ARKHER SYSTEM N.0137 :: Waterfall Mist Effect Composition
-- Category N - VFX
...
return function(A)
	...
	local S = {}
	S.id = "N.0137"
	S.key = "arkher.vfx.mist.effect_composition"
	S.name = "Waterfall Mist Effect Composition"
	S.category = "N"
	S.family = "VFX"
	...
	S.kit = "composer"
	S.version = "1.0.0"
	S.deps = { "arkher.vfx.mist.effect_graph" }
	S.tags = { "n", "mist", "composer", "vfx" }
	S.description = "Waterfall Mist Effect Composition: blending of several effect signals into one output for the Waterfall Mist subsystem."
	S.params = {
		backlogLimit = 45,
		baseRadius = 200,
		baseWeight = 0.67,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("composer", { id = "arkher.vfx.mist.effect_composition", mode = "add" })
		inst.system = S
		inst.ctx = ctx
