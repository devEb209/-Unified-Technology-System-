-- ARKHER SYSTEM J.0327 :: Character Debug Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "J.0327"
	S.key = "arkher.character.characterdebug.variant_registry"
	S.name = "Character Debug Variant Registry"
	S.category = "J"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.character.characterdebug.appearance_composer" }
	S.tags = { "j", "characterdebug", "registry", "character" }
	S.description = "Character Debug Variant Registry: named character variants and their lifecycle for the Character Debug subsystem."
	S.params = {
		backlogLimit = 25,
		baseRadius = 520,
		baseWeight = 0.57,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.character.characterdebug.variant_registry" })
		inst.system = S
		inst.ctx = ctx
