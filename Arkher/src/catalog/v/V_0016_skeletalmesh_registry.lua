-- ARKHER SYSTEM V.0016 :: Skeletal Mesh Asset Registry
...
return function(A)
	...
	local S = {}
	S.id = "V.0016"
	S.key = "arkher.asset.skeletalmesh.asset_registry"
	S.name = "Skeletal Mesh Asset Registry"
	S.category = "V"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.asset.skeletalmesh.cook_pipeline" }
	S.tags = { "v", "skeletalmesh", "registry", "asset" }
	S.description = "Skeletal Mesh Asset Registry: catalogue of every asset, its tags and its metadata for the Skeletal Mesh subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.55,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.asset.skeletalmesh.asset_registry" })
		inst.system = S
		inst.ctx = ctx
