-- ARKHER SYSTEM L.0356 :: Price Discovery Fidelity Policy
...
return function(A)
	...
	local S = {}
	S.id = "L.0356"
	S.key = "arkher.sim.pricediscovery.fidelity_policy"
	S.name = "Price Discovery Fidelity Policy"
	S.category = "L"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.pricediscovery.streaming" }
	S.tags = { "l", "pricediscovery", "policy", "sim" }
	S.description = "Price Discovery Fidelity Policy: rules that pick full, cohort or statistical simulation for the Price Discovery subsystem."
	S.params = {
		backlogLimit = 17,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.sim.pricediscovery.fidelity_policy", algorithm = "edf", starvationGuard = 17 })
		inst.system = S
		inst.ctx = ctx
