-- ARKHER SYSTEM P.0095 :: Level Up Save Codec
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0095"
	S.key = "arkher.play.levelup.save_codec"
	S.name = "Level Up Save Codec"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Level Up"
	S.aspect = "Save Codec"
	S.kit = "codec"
	S.version = "1.0.0"
	S.deps = { "arkher.play.levelup.content_registry" }
	S.tags = { "p", "levelup", "codec", "play" }
	S.description = "Level Up Save Codec: persistence, diffing and checksum of gameplay state for the Level Up subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 200,
		baseWeight = 0.93,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("codec", { id = "arkher.play.levelup.save_codec", format = "quantized", quantBits = 9 })
		inst.system = S
		inst.ctx = ctx
