-- ARKHER SYSTEM VD.0342 :: Society Continuum Coherence Guard
...
return function(A)
	...
	local S = {}
	S.id = "VD.0342"
	S.key = "arkher.contsim.societycont.coherence_guard"
	...
	S.kit = "coherence"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.societycont.persistent_state" }
	S.tags = { "vd", "societycont", "coherence", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("coherence", { id = "arkher.contsim.societycont.coherence_guard", window = 92, threshold = 0.16 })
		inst.system = S
		inst.ctx = ctx
