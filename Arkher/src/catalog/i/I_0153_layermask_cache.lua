-- ARKHER SYSTEM I.0153 :: Layer Mask Pose Cache
...
return function(A)
	...
	local S = {}
	S.id = "I.0153"
	S.key = "arkher.anim.layermask.pose_cache"
	S.name = "Layer Mask Pose Cache"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Layer Mask"
	S.aspect = "Pose Cache"
	S.kit = "cache"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.layermask.playback_pipeline" }
	S.tags = { "i", "layermask", "cache", "anim" }
	S.description = "Layer Mask Pose Cache: reuse of sampled poses across frames and instances for the Layer Mask subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 360,
		baseWeight = 0.89,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("cache", { id = "arkher.anim.layermask.pose_cache", policy = "ttl", capacity = 69, ttl = 4 })
		inst.system = S
		inst.ctx = ctx
