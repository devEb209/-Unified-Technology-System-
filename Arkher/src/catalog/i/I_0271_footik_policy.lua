-- ARKHER SYSTEM I.0271 :: Foot Placement IK Quality Policy
...
return function(A)
	...
	local S = {}
	S.id = "I.0271"
	S.key = "arkher.anim.footik.quality_policy"
	S.name = "Foot Placement IK Quality Policy"
	S.category = "I"
	S.family = "ANIMATION"
	...
	S.kit = "policy"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.footik.pose_cache" }
	S.tags = { "i", "footik", "policy", "anim" }
	S.description = "Foot Placement IK Quality Policy: device tier rules for rate, bones and solvers for the Foot Placement IK subsystem."
	S.params = {
		backlogLimit = 30,
		baseRadius = 240,
		baseWeight = 0.62,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("policy", { id = "arkher.anim.footik.quality_policy", algorithm = "wfq", starvationGuard = 54 })
		inst.system = S
		inst.ctx = ctx
