-- ARKHER SYSTEM P.0445 :: Difficulty Attributes
-- Category P - GAMEPLAY
...
return function(A)
	...
	local S = {}
	S.id = "P.0445"
	S.key = "arkher.play.difficulty.attributes"
	S.name = "Difficulty Attributes"
	S.category = "P"
	S.family = "GAMEPLAY"
	S.area = "Difficulty"
	S.aspect = "Attributes"
	...
	S.version = "1.0.0"
	S.deps = {  }
	S.tags = { "p", "difficulty", "stats", "play" }
	S.description = "Difficulty Attributes: base values, layered modifiers and derived statistics for the Difficulty subsystem."
	S.params = {
		backlogLimit = 13,
		baseRadius = 520,
		baseWeight = 0.65,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("stats", { id = "arkher.play.difficulty.attributes" })
		inst.system = S
		inst.ctx = ctx
