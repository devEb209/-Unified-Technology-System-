-- ARKHER SYSTEM Q.0187 :: Health Bar Localization Registry
-- Category Q - UI / UX
...
return function(A)
	...
	local S = {}
	S.id = "Q.0187"
	S.key = "arkher.ui.healthbar.localization_registry"
	S.name = "Health Bar Localization Registry"
	S.category = "Q"
	S.family = "UI / UX"
	S.area = "Health Bar"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.ui.healthbar.theme_composition" }
	S.tags = { "q", "healthbar", "registry", "ui" }
	S.description = "Health Bar Localization Registry: catalogue of strings, plurals and locale metadata for the Health Bar subsystem."
	S.params = {
		backlogLimit = 41,
		baseRadius = 520,
		baseWeight = 0.73,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.ui.healthbar.localization_registry" })
		inst.system = S
		inst.ctx = ctx
