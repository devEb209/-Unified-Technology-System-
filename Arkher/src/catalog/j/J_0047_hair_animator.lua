-- ARKHER SYSTEM J.0047 :: Hair Blend Controller
...
return function(A)
	...
	local S = {}
	S.id = "J.0047"
	S.key = "arkher.character.hair.blend_controller"
	S.name = "Hair Blend Controller"
	S.category = "J"
	...
	S.kit = "animator"
	S.version = "1.0.0"
	S.deps = { "arkher.character.hair.motion_set" }
	S.tags = { "j", "hair", "animator", "character" }
	S.description = "Hair Blend Controller: layered playback driving the character for the Hair subsystem."
	S.params = {
		backlogLimit = 39,
		baseRadius = 600,
		baseWeight = 0.71,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("animator", { id = "arkher.character.hair.blend_controller", budget = 15 })
		inst.system = S
		inst.ctx = ctx
