-- ARKHER SYSTEM I.0045 :: Pose Buffer Retarget Graph
...
return function(A)
	...
	local S = {}
	S.id = "I.0045"
	S.key = "arkher.anim.posebuffer.retarget_graph"
	S.name = "Pose Buffer Retarget Graph"
	S.category = "I"
	S.family = "ANIMATION"
	S.area = "Pose Buffer"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.anim.posebuffer.physical_blend" }
	S.tags = { "i", "posebuffer", "graph", "anim" }
	S.description = "Pose Buffer Retarget Graph: bone mapping and retarget path resolution for the Pose Buffer subsystem."
	S.params = {
		backlogLimit = 37,
		baseRadius = 200,
		baseWeight = 0.59,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.anim.posebuffer.retarget_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
