-- ARKHER SYSTEM VD.0487 :: Lighting Continuum Neural Field
...
return function(A)
	...
	local S = {}
	S.id = "VD.0487"
	S.key = "arkher.contsim.lightcont.neural_field"
	...
	S.kit = "neuralfield"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.lightcont.coherence_guard" }
	S.tags = { "vd", "lightcont", "neuralfield", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("neuralfield", { id = "arkher.contsim.lightcont.neural_field", dims = 24, hidden = 20, seed = 71523 })
		inst.system = S
		inst.ctx = ctx
