-- ARKHER SYSTEM L.0531 :: Disease Region Graph
...
return function(A)
	...
	local S = {}
	S.id = "L.0531"
	S.key = "arkher.sim.disease.region_graph"
	S.name = "Disease Region Graph"
	S.category = "L"
	...
	S.kit = "graph"
	S.version = "1.0.0"
	S.deps = { "arkher.sim.disease.calendar" }
	S.tags = { "l", "disease", "graph", "sim" }
	S.description = "Disease Region Graph: connectivity, components and shortest path between places for the Disease subsystem."
	S.params = {
		backlogLimit = 11,
		baseRadius = 440,
		baseWeight = 0.53,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("graph", { id = "arkher.sim.disease.region_graph", directed = false })
		inst.system = S
		inst.ctx = ctx
