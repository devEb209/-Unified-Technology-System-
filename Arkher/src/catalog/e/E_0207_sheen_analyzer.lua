-- ARKHER SYSTEM E.0207 :: Sheen Analysis
...
return function(A)
	...
	local S = {}
	S.id = "E.0207"
	S.key = "arkher.material.sheen.analysis"
	S.name = "Sheen Analysis"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Sheen"
	S.aspect = "Analysis"
	S.kit = "analyzer"
	S.version = "1.0.0"
	S.deps = { "arkher.material.sheen.instance_cache" }
	S.tags = { "e", "sheen", "analyzer", "material" }
	S.description = "Sheen Analysis: cost, redundancy and outlier analysis for the Sheen subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 440,
		baseWeight = 0.95,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("analyzer", { id = "arkher.material.sheen.analysis", window = 143, buckets = 15, threshold = 4.50 })
		inst.system = S
		inst.ctx = ctx
