-- ARKHER SYSTEM F.0064 :: Shadow Pass Adaptive Resolution
...
return function(A)
	...
	local S = {}
	S.id = "F.0064"
	S.key = "arkher.render.shadowpass.adaptive_resolution"
	S.name = "Shadow Pass Adaptive Resolution"
	S.category = "F"
	S.family = "RENDERING"
	S.area = "Shadow Pass"
	...
	S.kit = "upscaler"
	S.version = "1.0.0"
	S.deps = { "arkher.render.shadowpass.temporal_resolve" }
	S.tags = { "f", "shadowpass", "upscaler", "render" }
	S.description = "Shadow Pass Adaptive Resolution: render-scale ladder and edge-aware reconstruction for the Shadow Pass subsystem."
	S.params = {
		backlogLimit = 40,
		baseRadius = 320,
		baseWeight = 0.52,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("upscaler", { id = "arkher.render.shadowpass.adaptive_resolution", targetMs = 15.10, index = 4, sharpness = 0.52 })
		inst.system = S
		inst.ctx = ctx
