-- ARKHER SYSTEM VD.0320 :: Ecology Continuum World Memory Stream
...
return function(A)
	...
	local S = {}
	S.id = "VD.0320"
	S.key = "arkher.contsim.ecologycont.world_memory_stream"
	...
	S.kit = "worldmemory"
	S.version = "1.0.0"
	S.deps = { "arkher.contsim.ecologycont.neural_field" }
	S.tags = { "vd", "ecologycont", "worldmemory", "contsim" }
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("worldmemory", { id = "arkher.contsim.ecologycont.world_memory_stream", capacity = 192 })
		inst.system = S
		inst.ctx = ctx
