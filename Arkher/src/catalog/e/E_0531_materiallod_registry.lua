-- ARKHER SYSTEM E.0531 :: Material LOD Variant Registry
...
return function(A)
	...
	local S = {}
	S.id = "E.0531"
	S.key = "arkher.material.materiallod.variant_registry"
	S.name = "Material LOD Variant Registry"
	S.category = "E"
	S.family = "MATERIALS"
	S.area = "Material LOD"
	...
	S.kit = "registry"
	S.version = "1.0.0"
	S.deps = { "arkher.material.materiallod.procedural_detail" }
	S.tags = { "e", "materiallod", "registry", "material" }
	S.description = "Material LOD Variant Registry: named variants and their lifecycle for the Material LOD subsystem."
	S.params = {
		backlogLimit = 23,
		baseRadius = 280,
		baseWeight = 0.75,
	...
	function S.create(ctx)
		ctx = ctx or {}
		local inst = Kits.create("registry", { id = "arkher.material.materiallod.variant_registry" })
		inst.system = S
		inst.ctx = ctx
